...
LDFLAGS_PROJ_VERSION=-X $(PROJECT)/$(VERSION_PATH)=$(PROVIDER_VERSION) -X github.com/hashicorp/terraform-provider-google-beta/version.ProviderVersion=$(PROVIDER_VERSION)
LDFLAGS_UPSTREAM_VERSION=-X github.com/hashicorp/terraform-provider-google-beta/version.ProviderVersion=v$(PROVIDER_VERSION)
LDFLAGS_EXTRAS=
