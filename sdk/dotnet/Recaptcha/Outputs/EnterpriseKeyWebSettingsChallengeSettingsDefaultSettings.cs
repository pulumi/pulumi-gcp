...
namespace Pulumi.Gcp.Recaptcha.Outputs
{
    ...
    [OutputType]
    public sealed class EnterpriseKeyWebSettingsChallengeSettingsDefaultSettings
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EnterpriseKeyWebSettingsChallengeSettingsDefaultSettings(double scoreThreshold)
        {
