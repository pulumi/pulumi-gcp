...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpoint(string? forwardingRule)
        {
