...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint(string? forwardingRule)
        {
