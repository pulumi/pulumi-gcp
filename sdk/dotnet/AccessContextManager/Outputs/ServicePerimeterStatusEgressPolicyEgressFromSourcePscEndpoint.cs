...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpoint(string? forwardingRule)
        {
