...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint(string? forwardingRule)
        {
