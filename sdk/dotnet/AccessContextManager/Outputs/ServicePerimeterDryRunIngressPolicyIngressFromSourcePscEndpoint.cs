...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimeterDryRunIngressPolicyIngressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimeterDryRunIngressPolicyIngressFromSourcePscEndpoint(string? forwardingRule)
        {
