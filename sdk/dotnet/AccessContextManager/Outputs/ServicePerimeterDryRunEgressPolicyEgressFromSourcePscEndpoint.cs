...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimeterDryRunEgressPolicyEgressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimeterDryRunEgressPolicyEgressFromSourcePscEndpoint(string? forwardingRule)
        {
