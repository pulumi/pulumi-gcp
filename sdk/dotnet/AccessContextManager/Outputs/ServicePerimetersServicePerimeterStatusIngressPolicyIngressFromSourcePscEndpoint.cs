...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpoint(string? forwardingRule)
        {
