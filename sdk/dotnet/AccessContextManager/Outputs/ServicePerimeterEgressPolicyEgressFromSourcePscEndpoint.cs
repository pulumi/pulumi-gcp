...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimeterEgressPolicyEgressFromSourcePscEndpoint(string? forwardingRule)
        {
