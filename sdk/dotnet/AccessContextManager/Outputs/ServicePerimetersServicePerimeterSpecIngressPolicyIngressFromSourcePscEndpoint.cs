...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimetersServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint(string? forwardingRule)
        {
