...
namespace Pulumi.Gcp.AccessContextManager.Outputs
{
    ...
    [OutputType]
    public sealed class ServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ServicePerimeterSpecIngressPolicyIngressFromSourcePscEndpoint(string? forwardingRule)
        {
