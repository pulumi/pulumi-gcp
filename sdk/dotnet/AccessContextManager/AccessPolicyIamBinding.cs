...
namespace Pulumi.Gcp.AccessContextManager
{
    ...
    ///  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
    /// </summary>
    [GcpResourceType("gcp:accesscontextmanager/accessPolicyIamBinding:AccessPolicyIamBinding")]
    public partial class AccessPolicyIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.AccessPolicyIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public AccessPolicyIamBinding(string name, AccessPolicyIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:accesscontextmanager/accessPolicyIamBinding:AccessPolicyIamBinding", name, args ?? new AccessPolicyIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccessPolicyIamBinding(string name, Input<string> id, AccessPolicyIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:accesscontextmanager/accessPolicyIamBinding:AccessPolicyIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccessPolicyIamBinding Get(string name, Input<string> id, AccessPolicyIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new AccessPolicyIamBinding(name, id, state, options);
        }
    }

    public sealed class AccessPolicyIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AccessPolicyIamBindingConditionArgs>? Condition { get; set; }
        ...
        public AccessPolicyIamBindingArgs()
        {
        }
        public static new AccessPolicyIamBindingArgs Empty => new AccessPolicyIamBindingArgs();
    }

    public sealed class AccessPolicyIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AccessPolicyIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public AccessPolicyIamBindingState()
        {
        }
        public static new AccessPolicyIamBindingState Empty => new AccessPolicyIamBindingState();
    }
}
