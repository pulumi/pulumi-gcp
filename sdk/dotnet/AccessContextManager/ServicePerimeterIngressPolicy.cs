...
namespace Pulumi.Gcp.AccessContextManager
{
    ...
    public partial class ServicePerimeterIngressPolicy : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("ingressFrom")]
        public Output<Outputs.ServicePerimeterIngressPolicyIngressFrom?> IngressFrom { get; private set; } = null!;
        ...
        /// </summary>
        [Output("ingressTo")]
        public Output<Outputs.ServicePerimeterIngressPolicyIngressTo?> IngressTo { get; private set; } = null!;
        ...
        public ServicePerimeterIngressPolicy(string name, ServicePerimeterIngressPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:accesscontextmanager/servicePerimeterIngressPolicy:ServicePerimeterIngressPolicy", name, args ?? new ServicePerimeterIngressPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServicePerimeterIngressPolicy(string name, Input<string> id, ServicePerimeterIngressPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:accesscontextmanager/servicePerimeterIngressPolicy:ServicePerimeterIngressPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ServicePerimeterIngressPolicy Get(string name, Input<string> id, ServicePerimeterIngressPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new ServicePerimeterIngressPolicy(name, id, state, options);
        }
    }

    public sealed class ServicePerimeterIngressPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Defines the conditions on the source of a request causing this `IngressPolicy`
        /// to apply.
        ...
        /// </summary>
        [Input("ingressFrom")]
        public Input<Inputs.ServicePerimeterIngressPolicyIngressFromArgs>? IngressFrom { get; set; }
        ...
        /// </summary>
        [Input("ingressTo")]
        public Input<Inputs.ServicePerimeterIngressPolicyIngressToArgs>? IngressTo { get; set; }
        ...
        public static new ServicePerimeterIngressPolicyArgs Empty => new ServicePerimeterIngressPolicyArgs();
    }
    ...
    public sealed class ServicePerimeterIngressPolicyState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("ingressFrom")]
        public Input<Inputs.ServicePerimeterIngressPolicyIngressFromGetArgs>? IngressFrom { get; set; }
        ...
        /// </summary>
        [Input("ingressTo")]
        public Input<Inputs.ServicePerimeterIngressPolicyIngressToGetArgs>? IngressTo { get; set; }
        ...
        public static new ServicePerimeterIngressPolicyState Empty => new ServicePerimeterIngressPolicyState();
    }
}
