...
namespace Pulumi.Gcp.AccessContextManager.Inputs
{
    ...
    public sealed class ServicePerimeterDryRunIngressPolicyIngressFromGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("sources")]
        private InputList<Inputs.ServicePerimeterDryRunIngressPolicyIngressFromSourceGetArgs>? _sources;

        /// <summary>
        /// Sources that this `IngressPolicy` authorizes access from.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.ServicePerimeterDryRunIngressPolicyIngressFromSourceGetArgs> Sources
        {
            get => _sources ?? (_sources = new InputList<Inputs.ServicePerimeterDryRunIngressPolicyIngressFromSourceGetArgs>());
            set => _sources = value;
        }
