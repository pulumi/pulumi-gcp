...
namespace Pulumi.Gcp.AccessContextManager.Inputs
{
    ...
    public sealed class ServicePerimeterDryRunEgressPolicyEgressFromGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("sources")]
        private InputList<Inputs.ServicePerimeterDryRunEgressPolicyEgressFromSourceGetArgs>? _sources;

        /// <summary>
        /// Sources that this EgressPolicy authorizes access from.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.ServicePerimeterDryRunEgressPolicyEgressFromSourceGetArgs> Sources
        {
            get => _sources ?? (_sources = new InputList<Inputs.ServicePerimeterDryRunEgressPolicyEgressFromSourceGetArgs>());
            set => _sources = value;
        }
