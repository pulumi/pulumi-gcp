...
namespace Pulumi.Gcp.AccessContextManager.Inputs
{
    ...
    public sealed class ServicePerimeterDryRunEgressPolicyEgressFromArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("sources")]
        private InputList<Inputs.ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs>? _sources;

        /// <summary>
        /// Sources that this EgressPolicy authorizes access from.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs> Sources
        {
            get => _sources ?? (_sources = new InputList<Inputs.ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs>());
            set => _sources = value;
        }
