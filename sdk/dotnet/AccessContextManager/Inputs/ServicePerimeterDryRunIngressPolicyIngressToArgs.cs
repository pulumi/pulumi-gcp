...
namespace Pulumi.Gcp.AccessContextManager.Inputs
{
    ...
    {
        [Input("operations")]
        private InputList<Inputs.ServicePerimeterDryRunIngressPolicyIngressToOperationArgs>? _operations;
        ...
        /// </summary>
        public InputList<Inputs.ServicePerimeterDryRunIngressPolicyIngressToOperationArgs> Operations
        {
            get => _operations ?? (_operations = new InputList<Inputs.ServicePerimeterDryRunIngressPolicyIngressToOperationArgs>());
