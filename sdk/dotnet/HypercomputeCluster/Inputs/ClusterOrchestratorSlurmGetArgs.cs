...
namespace Pulumi.Gcp.HypercomputeCluster.Inputs
{
    ...
    public sealed class ClusterOrchestratorSlurmGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.ClusterOrchestratorSlurmLoginNodesGetArgs> LoginNodes { get; set; } = null!;

        [Input("nodeSets", required: true)]
        private InputList<Inputs.ClusterOrchestratorSlurmNodeSetGetArgs>? _nodeSets;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.ClusterOrchestratorSlurmNodeSetGetArgs> NodeSets
        {
            get => _nodeSets ?? (_nodeSets = new InputList<Inputs.ClusterOrchestratorSlurmNodeSetGetArgs>());
            set => _nodeSets = value;
        }

        [Input("partitions", required: true)]
        private InputList<Inputs.ClusterOrchestratorSlurmPartitionGetArgs>? _partitions;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.ClusterOrchestratorSlurmPartitionGetArgs> Partitions
        {
            get => _partitions ?? (_partitions = new InputList<Inputs.ClusterOrchestratorSlurmPartitionGetArgs>());
        ...
        public ClusterOrchestratorSlurmGetArgs()
        {
        }
        public static new ClusterOrchestratorSlurmGetArgs Empty => new ClusterOrchestratorSlurmGetArgs();
    }
}
