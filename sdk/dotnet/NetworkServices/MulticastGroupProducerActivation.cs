...
namespace Pulumi.Gcp.NetworkServices
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:networkservices/multicastGroupProducerActivation:MulticastGroupProducerActivation")]
    public partial class MulticastGroupProducerActivation : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("multicastGroupProducerActivationId")]
        public Output<string> MulticastGroupProducerActivationId { get; private set; } = null!;
        ...
        /// </summary>
        [Output("multicastProducerAssociation")]
        public Output<string> MulticastProducerAssociation { get; private set; } = null!;
        ...
        /// </summary>
        [Output("states")]
        public Output<ImmutableArray<Outputs.MulticastGroupProducerActivationState>> States { get; private set; } = null!;
        ...
        public MulticastGroupProducerActivation(string name, MulticastGroupProducerActivationArgs args, CustomResourceOptions? options = null)
            : base("gcp:networkservices/multicastGroupProducerActivation:MulticastGroupProducerActivation", name, args ?? new MulticastGroupProducerActivationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MulticastGroupProducerActivation(string name, Input<string> id, MulticastGroupProducerActivationState? state = null, CustomResourceOptions? options = null)
            : base("gcp:networkservices/multicastGroupProducerActivation:MulticastGroupProducerActivation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MulticastGroupProducerActivation Get(string name, Input<string> id, MulticastGroupProducerActivationState? state = null, CustomResourceOptions? options = null)
        {
            return new MulticastGroupProducerActivation(name, id, state, options);
        }
    }

    public sealed class MulticastGroupProducerActivationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An optional text description of the multicast group producer activation.
        /// </summary>
        ...
        /// exceed 48 characters.
        /// </summary>
        [Input("multicastGroupProducerActivationId", required: true)]
        public Input<string> MulticastGroupProducerActivationId { get; set; } = null!;
        ...
        /// `projects/*/locations/*/multicastProducerAssociations/*`.
        /// </summary>
        [Input("multicastProducerAssociation", required: true)]
        public Input<string> MulticastProducerAssociation { get; set; } = null!;
        ...
        public MulticastGroupProducerActivationArgs()
        {
        }
        public static new MulticastGroupProducerActivationArgs Empty => new MulticastGroupProducerActivationArgs();
    }

    public sealed class MulticastGroupProducerActivationState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The timestamp when the multicast group producer activation was created.
        /// </summary>
        ...
        /// exceed 48 characters.
        /// </summary>
        [Input("multicastGroupProducerActivationId")]
        public Input<string>? MulticastGroupProducerActivationId { get; set; }
        ...
        /// `projects/*/locations/*/multicastProducerAssociations/*`.
        /// </summary>
        [Input("multicastProducerAssociation")]
        public Input<string>? MulticastProducerAssociation { get; set; }
        ...
        [Input("states")]
        private InputList<Inputs.MulticastGroupProducerActivationStateGetArgs>? _states;
        ...
        /// INACTIVE
        /// </summary>
        public InputList<Inputs.MulticastGroupProducerActivationStateGetArgs> States
        {
            get => _states ?? (_states = new InputList<Inputs.MulticastGroupProducerActivationStateGetArgs>());
            set => _states = value;
        }
        ...
        public MulticastGroupProducerActivationState()
        {
        }
        public static new MulticastGroupProducerActivationState Empty => new MulticastGroupProducerActivationState();
    }
}
