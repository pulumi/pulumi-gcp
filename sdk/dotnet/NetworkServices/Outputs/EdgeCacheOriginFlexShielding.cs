...
namespace Pulumi.Gcp.NetworkServices.Outputs
{
    ...
    [OutputType]
    public sealed class EdgeCacheOriginFlexShielding
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string? FlexShieldingRegions;

        [OutputConstructor]
        private EdgeCacheOriginFlexShielding(string? flexShieldingRegions)
        {
