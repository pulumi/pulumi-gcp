...
namespace Pulumi.Gcp.NetworkServices.Inputs
{
    ...
    public sealed class HttpRouteRuleMatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("headers")]
        private InputList<Inputs.HttpRouteRuleMatchHeaderArgs>? _headers;

        /// <summary>
        /// Specifies a list of HTTP request headers to match against.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.HttpRouteRuleMatchHeaderArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.HttpRouteRuleMatchHeaderArgs>());
            set => _headers = value;
        }
        ...
        private InputList<Inputs.HttpRouteRuleMatchQueryParameterArgs>? _queryParameters;

        /// <summary>
        /// Specifies a list of query parameters to match against.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.HttpRouteRuleMatchQueryParameterArgs> QueryParameters
        {
            get => _queryParameters ?? (_queryParameters = new InputList<Inputs.HttpRouteRuleMatchQueryParameterArgs>());
