...
namespace Pulumi.Gcp.NetworkServices.Inputs
{
    ...
    public sealed class EdgeCacheServiceRoutingPathMatcherRouteRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("headerAction")]
        public Input<Inputs.EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionArgs>? HeaderAction { get; set; }

        [Input("matchRules", required: true)]
        private InputList<Inputs.EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleArgs>? _matchRules;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleArgs> MatchRules
        {
            get => _matchRules ?? (_matchRules = new InputList<Inputs.EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleArgs>());
        ...
        /// </summary>
        [Input("urlRedirect")]
        public Input<Inputs.EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirectArgs>? UrlRedirect { get; set; }

        public EdgeCacheServiceRoutingPathMatcherRouteRuleArgs()
        {
        }
        public static new EdgeCacheServiceRoutingPathMatcherRouteRuleArgs Empty => new EdgeCacheServiceRoutingPathMatcherRouteRuleArgs();
    }
}
