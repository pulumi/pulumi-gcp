...
namespace Pulumi.Gcp.NetworkServices.Inputs
{
    ...
    public sealed class HttpRouteRuleMatchHeaderArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("rangeMatch")]
        public Input<Inputs.HttpRouteRuleMatchHeaderRangeMatchArgs>? RangeMatch { get; set; }
        ...
        public HttpRouteRuleMatchHeaderArgs()
        {
        }
        public static new HttpRouteRuleMatchHeaderArgs Empty => new HttpRouteRuleMatchHeaderArgs();
    }
}
