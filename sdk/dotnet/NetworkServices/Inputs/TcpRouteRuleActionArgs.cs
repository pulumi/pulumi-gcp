...
namespace Pulumi.Gcp.NetworkServices.Inputs
{
    ...
    public sealed class TcpRouteRuleActionArgs : global::Pulumi.ResourceArgs
    {
        [Input("destinations")]
        private InputList<Inputs.TcpRouteRuleActionDestinationArgs>? _destinations;

        /// <summary>
        /// The destination services to which traffic should be forwarded. At least one destination service is required.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.TcpRouteRuleActionDestinationArgs> Destinations
        {
            get => _destinations ?? (_destinations = new InputList<Inputs.TcpRouteRuleActionDestinationArgs>());
        ...
        public TcpRouteRuleActionArgs()
        {
        }
        public static new TcpRouteRuleActionArgs Empty => new TcpRouteRuleActionArgs();
    }
}
