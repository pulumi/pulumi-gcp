...
namespace Pulumi.Gcp.BigTable
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:bigtable/appProfile:AppProfile")]
    public partial class AppProfile : global::Pulumi.CustomResource
    {
        ...
        public AppProfile(string name, AppProfileArgs args, CustomResourceOptions? options = null)
            : base("gcp:bigtable/appProfile:AppProfile", name, args ?? new AppProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AppProfile(string name, Input<string> id, AppProfileState? state = null, CustomResourceOptions? options = null)
            : base("gcp:bigtable/appProfile:AppProfile", name, state, MakeResourceOptions(options, id))
        {
        }
