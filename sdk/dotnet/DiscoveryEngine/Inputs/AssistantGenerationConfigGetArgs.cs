...
namespace Pulumi.Gcp.DiscoveryEngine.Inputs
{
    ...
    public sealed class AssistantGenerationConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.AssistantGenerationConfigSystemInstructionGetArgs>? SystemInstruction { get; set; }

        public AssistantGenerationConfigGetArgs()
        {
        }
        public static new AssistantGenerationConfigGetArgs Empty => new AssistantGenerationConfigGetArgs();
    }
}
