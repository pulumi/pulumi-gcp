...
namespace Pulumi.Gcp.CloudDeploy.Inputs
{
    ...
    public sealed class TargetExecutionConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("defaultPool")]
        public Input<Inputs.TargetExecutionConfigDefaultPoolArgs>? DefaultPool { get; set; }
        ...
        /// </summary>
        [Input("privatePool")]
        public Input<Inputs.TargetExecutionConfigPrivatePoolArgs>? PrivatePool { get; set; }
