...
namespace Pulumi.Gcp.CloudDeploy.Inputs
{
    ...
    public sealed class DeployPolicyRuleRolloutRestrictionArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions")]
        ...
        /// </summary>
        [Input("timeWindows")]
        public Input<Inputs.DeployPolicyRuleRolloutRestrictionTimeWindowsArgs>? TimeWindows { get; set; }

        public DeployPolicyRuleRolloutRestrictionArgs()
        {
        }
        public static new DeployPolicyRuleRolloutRestrictionArgs Empty => new DeployPolicyRuleRolloutRestrictionArgs();
    }
}
