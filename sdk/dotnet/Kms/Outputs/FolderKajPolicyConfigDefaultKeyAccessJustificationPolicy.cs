...
namespace Pulumi.Gcp.Kms.Outputs
{
    ...
    [OutputType]
    public sealed class FolderKajPolicyConfigDefaultKeyAccessJustificationPolicy
    {
        /// <summary>
        ...
        [OutputConstructor]
        private FolderKajPolicyConfigDefaultKeyAccessJustificationPolicy(ImmutableArray<string> allowedAccessReasons)
        {
