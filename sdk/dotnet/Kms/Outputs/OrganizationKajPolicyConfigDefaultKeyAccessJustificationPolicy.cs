...
namespace Pulumi.Gcp.Kms.Outputs
{
    ...
    [OutputType]
    public sealed class OrganizationKajPolicyConfigDefaultKeyAccessJustificationPolicy
    {
        /// <summary>
        ...
        [OutputConstructor]
        private OrganizationKajPolicyConfigDefaultKeyAccessJustificationPolicy(ImmutableArray<string> allowedAccessReasons)
        {
