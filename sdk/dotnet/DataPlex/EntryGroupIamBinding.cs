...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/entryGroupIamBinding:EntryGroupIamBinding")]
    public partial class EntryGroupIamBinding : global::Pulumi.CustomResource
    {
        ...
        public EntryGroupIamBinding(string name, EntryGroupIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/entryGroupIamBinding:EntryGroupIamBinding", name, args ?? new EntryGroupIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EntryGroupIamBinding(string name, Input<string> id, EntryGroupIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/entryGroupIamBinding:EntryGroupIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
