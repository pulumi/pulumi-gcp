...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/dataProductIamMember:DataProductIamMember")]
    public partial class DataProductIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.DataProductIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public DataProductIamMember(string name, DataProductIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/dataProductIamMember:DataProductIamMember", name, args ?? new DataProductIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataProductIamMember(string name, Input<string> id, DataProductIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/dataProductIamMember:DataProductIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataProductIamMember Get(string name, Input<string> id, DataProductIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new DataProductIamMember(name, id, state, options);
        }
    }

    public sealed class DataProductIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.DataProductIamMemberConditionArgs>? Condition { get; set; }
        ...
        public DataProductIamMemberArgs()
        {
        }
        public static new DataProductIamMemberArgs Empty => new DataProductIamMemberArgs();
    }

    public sealed class DataProductIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.DataProductIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public DataProductIamMemberState()
        {
        }
        public static new DataProductIamMemberState Empty => new DataProductIamMemberState();
    }
}
