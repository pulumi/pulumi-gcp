...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/glossaryIamBinding:GlossaryIamBinding")]
    public partial class GlossaryIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.GlossaryIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public GlossaryIamBinding(string name, GlossaryIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/glossaryIamBinding:GlossaryIamBinding", name, args ?? new GlossaryIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlossaryIamBinding(string name, Input<string> id, GlossaryIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/glossaryIamBinding:GlossaryIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GlossaryIamBinding Get(string name, Input<string> id, GlossaryIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new GlossaryIamBinding(name, id, state, options);
        }
    }

    public sealed class GlossaryIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.GlossaryIamBindingConditionArgs>? Condition { get; set; }
        ...
        public GlossaryIamBindingArgs()
        {
        }
        public static new GlossaryIamBindingArgs Empty => new GlossaryIamBindingArgs();
    }

    public sealed class GlossaryIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.GlossaryIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public GlossaryIamBindingState()
        {
        }
        public static new GlossaryIamBindingState Empty => new GlossaryIamBindingState();
    }
}
