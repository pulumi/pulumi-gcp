...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/taskIamPolicy:TaskIamPolicy")]
    public partial class TaskIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public TaskIamPolicy(string name, TaskIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/taskIamPolicy:TaskIamPolicy", name, args ?? new TaskIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TaskIamPolicy(string name, Input<string> id, TaskIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/taskIamPolicy:TaskIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TaskIamPolicy Get(string name, Input<string> id, TaskIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new TaskIamPolicy(name, id, state, options);
        }
    }

    public sealed class TaskIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The lake in which the task will be created in.
        /// Used to find the parent resource to bind the IAM policy to
        ...
        public TaskIamPolicyArgs()
        {
        }
        public static new TaskIamPolicyArgs Empty => new TaskIamPolicyArgs();
    }

    public sealed class TaskIamPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Computed) The etag of the IAM policy.
        /// </summary>
        ...
        public TaskIamPolicyState()
        {
        }
        public static new TaskIamPolicyState Empty => new TaskIamPolicyState();
    }
}
