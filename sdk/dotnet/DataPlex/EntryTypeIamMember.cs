...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/entryTypeIamMember:EntryTypeIamMember")]
    public partial class EntryTypeIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.EntryTypeIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public EntryTypeIamMember(string name, EntryTypeIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/entryTypeIamMember:EntryTypeIamMember", name, args ?? new EntryTypeIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EntryTypeIamMember(string name, Input<string> id, EntryTypeIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/entryTypeIamMember:EntryTypeIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static EntryTypeIamMember Get(string name, Input<string> id, EntryTypeIamMemberState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.EntryTypeIamMemberConditionArgs>? Condition { get; set; }
    ...
    public sealed class EntryTypeIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.EntryTypeIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public EntryTypeIamMemberState()
        {
        }
        public static new EntryTypeIamMemberState Empty => new EntryTypeIamMemberState();
    }
}
