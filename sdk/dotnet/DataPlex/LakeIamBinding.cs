...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/lakeIamBinding:LakeIamBinding")]
    public partial class LakeIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.LakeIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public LakeIamBinding(string name, LakeIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/lakeIamBinding:LakeIamBinding", name, args ?? new LakeIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LakeIamBinding(string name, Input<string> id, LakeIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/lakeIamBinding:LakeIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LakeIamBinding Get(string name, Input<string> id, LakeIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new LakeIamBinding(name, id, state, options);
        }
    }

    public sealed class LakeIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.LakeIamBindingConditionArgs>? Condition { get; set; }
        ...
        public LakeIamBindingArgs()
        {
        }
        public static new LakeIamBindingArgs Empty => new LakeIamBindingArgs();
    }

    public sealed class LakeIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.LakeIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public LakeIamBindingState()
        {
        }
        public static new LakeIamBindingState Empty => new LakeIamBindingState();
    }
}
