...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/datascanIamBinding:DatascanIamBinding")]
    public partial class DatascanIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.DatascanIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public DatascanIamBinding(string name, DatascanIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/datascanIamBinding:DatascanIamBinding", name, args ?? new DatascanIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatascanIamBinding(string name, Input<string> id, DatascanIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/datascanIamBinding:DatascanIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatascanIamBinding Get(string name, Input<string> id, DatascanIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new DatascanIamBinding(name, id, state, options);
        }
    }

    public sealed class DatascanIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.DatascanIamBindingConditionArgs>? Condition { get; set; }
        ...
        public DatascanIamBindingArgs()
        {
        }
        public static new DatascanIamBindingArgs Empty => new DatascanIamBindingArgs();
    }

    public sealed class DatascanIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.DatascanIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public DatascanIamBindingState()
        {
        }
        public static new DatascanIamBindingState Empty => new DatascanIamBindingState();
    }
}
