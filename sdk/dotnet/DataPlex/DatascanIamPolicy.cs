...
namespace Pulumi.Gcp.DataPlex
{
    ...
    public partial class DatascanIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public DatascanIamPolicy(string name, DatascanIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/datascanIamPolicy:DatascanIamPolicy", name, args ?? new DatascanIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatascanIamPolicy(string name, Input<string> id, DatascanIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/datascanIamPolicy:DatascanIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatascanIamPolicy Get(string name, Input<string> id, DatascanIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class DatascanIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DatascanIamPolicyArgs()
        {
        }
        public static new DatascanIamPolicyArgs Empty => new DatascanIamPolicyArgs();
    }
    ...
    public sealed class DatascanIamPolicyState : global::Pulumi.ResourceArgs
    {
        ...
        public DatascanIamPolicyState()
        {
        }
        public static new DatascanIamPolicyState Empty => new DatascanIamPolicyState();
    }
}
