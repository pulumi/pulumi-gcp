...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/glossaryIamMember:GlossaryIamMember")]
    public partial class GlossaryIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.GlossaryIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public GlossaryIamMember(string name, GlossaryIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/glossaryIamMember:GlossaryIamMember", name, args ?? new GlossaryIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GlossaryIamMember(string name, Input<string> id, GlossaryIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/glossaryIamMember:GlossaryIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GlossaryIamMember Get(string name, Input<string> id, GlossaryIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new GlossaryIamMember(name, id, state, options);
        }
    }

    public sealed class GlossaryIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.GlossaryIamMemberConditionArgs>? Condition { get; set; }
        ...
        public GlossaryIamMemberArgs()
        {
        }
        public static new GlossaryIamMemberArgs Empty => new GlossaryIamMemberArgs();
    }

    public sealed class GlossaryIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.GlossaryIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public GlossaryIamMemberState()
        {
        }
        public static new GlossaryIamMemberState Empty => new GlossaryIamMemberState();
    }
}
