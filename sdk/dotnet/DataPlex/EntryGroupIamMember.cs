...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/entryGroupIamMember:EntryGroupIamMember")]
    public partial class EntryGroupIamMember : global::Pulumi.CustomResource
    {
        ...
        public EntryGroupIamMember(string name, EntryGroupIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/entryGroupIamMember:EntryGroupIamMember", name, args ?? new EntryGroupIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EntryGroupIamMember(string name, Input<string> id, EntryGroupIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/entryGroupIamMember:EntryGroupIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class EntryGroupIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        ...
        public static new EntryGroupIamMemberState Empty => new EntryGroupIamMemberState();
    }
}
