...
namespace Pulumi.Gcp.DataPlex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:dataplex/dataProductIamBinding:DataProductIamBinding")]
    public partial class DataProductIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.DataProductIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public DataProductIamBinding(string name, DataProductIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:dataplex/dataProductIamBinding:DataProductIamBinding", name, args ?? new DataProductIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataProductIamBinding(string name, Input<string> id, DataProductIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:dataplex/dataProductIamBinding:DataProductIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataProductIamBinding Get(string name, Input<string> id, DataProductIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new DataProductIamBinding(name, id, state, options);
        }
    }

    public sealed class DataProductIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.DataProductIamBindingConditionArgs>? Condition { get; set; }
        ...
        public DataProductIamBindingArgs()
        {
        }
        public static new DataProductIamBindingArgs Empty => new DataProductIamBindingArgs();
    }

    public sealed class DataProductIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.DataProductIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public DataProductIamBindingState()
        {
        }
        public static new DataProductIamBindingState Empty => new DataProductIamBindingState();
    }
}
