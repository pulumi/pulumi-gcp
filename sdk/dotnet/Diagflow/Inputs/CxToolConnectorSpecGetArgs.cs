...
namespace Pulumi.Gcp.Diagflow.Inputs
{
    ...
    public sealed class CxToolConnectorSpecGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions", required: true)]
        private InputList<Inputs.CxToolConnectorSpecActionGetArgs>? _actions;

        /// <summary>
        /// Actions for the tool to use.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.CxToolConnectorSpecActionGetArgs> Actions
        {
            get => _actions ?? (_actions = new InputList<Inputs.CxToolConnectorSpecActionGetArgs>());
            set => _actions = value;
        }
        ...
        public Input<Inputs.CxToolConnectorSpecEndUserAuthConfigGetArgs>? EndUserAuthConfig { get; set; }
        ...
        public CxToolConnectorSpecGetArgs()
        {
        }
        public static new CxToolConnectorSpecGetArgs Empty => new CxToolConnectorSpecGetArgs();
    }
}
