...
namespace Pulumi.Gcp.Diagflow.Inputs
{
    ...
    public sealed class CxPageKnowledgeConnectorSettingsArgs : global::Pulumi.ResourceArgs
    {
        [Input("dataStoreConnections")]
        private InputList<Inputs.CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs>? _dataStoreConnections;

        /// <summary>
        /// Optional. List of related data store connections.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs> DataStoreConnections
        {
            get => _dataStoreConnections ?? (_dataStoreConnections = new InputList<Inputs.CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs>());
        ...
        public Input<Inputs.CxPageKnowledgeConnectorSettingsTriggerFulfillmentArgs>? TriggerFulfillment { get; set; }

        public CxPageKnowledgeConnectorSettingsArgs()
        {
        }
        public static new CxPageKnowledgeConnectorSettingsArgs Empty => new CxPageKnowledgeConnectorSettingsArgs();
    }
}
