...
namespace Pulumi.Gcp.Diagflow.Inputs
{
    ...
    public sealed class EnvironmentTextToSpeechSettingsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigArgs>? _synthesizeSpeechConfigs;

        /// <summary>
        /// Configuration of how speech should be synthesized, mapping from language to SynthesizeSpeechConfig.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigArgs> SynthesizeSpeechConfigs
        {
            get => _synthesizeSpeechConfigs ?? (_synthesizeSpeechConfigs = new InputList<Inputs.EnvironmentTextToSpeechSettingsSynthesizeSpeechConfigArgs>());
            set => _synthesizeSpeechConfigs = value;
        }

        public EnvironmentTextToSpeechSettingsArgs()
        {
        }
        public static new EnvironmentTextToSpeechSettingsArgs Empty => new EnvironmentTextToSpeechSettingsArgs();
    }
}
