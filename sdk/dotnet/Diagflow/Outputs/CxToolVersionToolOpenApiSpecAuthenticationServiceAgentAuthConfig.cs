...
namespace Pulumi.Gcp.Diagflow.Outputs
{
    ...
    [OutputType]
    public sealed class CxToolVersionToolOpenApiSpecAuthenticationServiceAgentAuthConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private CxToolVersionToolOpenApiSpecAuthenticationServiceAgentAuthConfig(string? serviceAgentAuth)
        {
