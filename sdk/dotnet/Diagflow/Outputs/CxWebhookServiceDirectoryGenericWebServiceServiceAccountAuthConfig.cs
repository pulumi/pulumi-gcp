...
namespace Pulumi.Gcp.Diagflow.Outputs
{
    ...
    [OutputType]
    public sealed class CxWebhookServiceDirectoryGenericWebServiceServiceAccountAuthConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private CxWebhookServiceDirectoryGenericWebServiceServiceAccountAuthConfig(string serviceAccount)
        {
