...
namespace Pulumi.Gcp.Diagflow.Outputs
{
    ...
    [OutputType]
    public sealed class CxAgentPersonalizationSettings
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string? DefaultEndUserMetadata;

        [OutputConstructor]
        private CxAgentPersonalizationSettings(string? defaultEndUserMetadata)
        {
