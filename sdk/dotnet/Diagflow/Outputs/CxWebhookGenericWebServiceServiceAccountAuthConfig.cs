...
namespace Pulumi.Gcp.Diagflow.Outputs
{
    ...
    [OutputType]
    public sealed class CxWebhookGenericWebServiceServiceAccountAuthConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private CxWebhookGenericWebServiceServiceAccountAuthConfig(string serviceAccount)
        {
