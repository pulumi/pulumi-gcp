...
namespace Pulumi.Gcp.Diagflow.Outputs
{
    ...
    [OutputType]
    public sealed class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfigSections
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigQueryConfigSections(ImmutableArray<string> sectionTypes)
        {
