...
namespace Pulumi.Gcp.Container.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterNodePoolNodeConfigKubeletConfigCrashLoopBackOff
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterNodePoolNodeConfigKubeletConfigCrashLoopBackOff(string? maxContainerRestartPeriod)
        {
