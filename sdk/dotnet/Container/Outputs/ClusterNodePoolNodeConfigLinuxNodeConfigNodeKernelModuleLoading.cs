...
namespace Pulumi.Gcp.Container.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading(string? policy)
        {
            Policy = policy;
        }
    }
