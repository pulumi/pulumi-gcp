...
namespace Pulumi.Gcp.Container.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterNodeConfigKubeletConfigCrashLoopBackOff
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterNodeConfigKubeletConfigCrashLoopBackOff(string? maxContainerRestartPeriod)
        {
