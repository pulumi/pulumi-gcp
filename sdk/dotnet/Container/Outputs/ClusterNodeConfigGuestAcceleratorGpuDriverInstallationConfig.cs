...
namespace Pulumi.Gcp.Container.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterNodeConfigGuestAcceleratorGpuDriverInstallationConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterNodeConfigGuestAcceleratorGpuDriverInstallationConfig(string gpuDriverVersion)
        {
