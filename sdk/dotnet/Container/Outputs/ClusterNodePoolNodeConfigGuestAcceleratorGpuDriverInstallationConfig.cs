...
namespace Pulumi.Gcp.Container.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterNodePoolNodeConfigGuestAcceleratorGpuDriverInstallationConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterNodePoolNodeConfigGuestAcceleratorGpuDriverInstallationConfig(string gpuDriverVersion)
        {
