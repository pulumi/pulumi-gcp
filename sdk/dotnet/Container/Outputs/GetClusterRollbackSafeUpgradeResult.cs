...
namespace Pulumi.Gcp.Container.Outputs
{
    ...
    [OutputType]
    public sealed class GetClusterRollbackSafeUpgradeResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string ControlPlaneSoakDuration;

        [OutputConstructor]
        private GetClusterRollbackSafeUpgradeResult(string controlPlaneSoakDuration)
        {
