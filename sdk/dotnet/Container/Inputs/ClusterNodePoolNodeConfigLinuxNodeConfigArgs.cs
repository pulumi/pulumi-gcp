...
namespace Pulumi.Gcp.Container.Inputs
{
    ...
    public sealed class ClusterNodePoolNodeConfigLinuxNodeConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ClusterNodePoolNodeConfigLinuxNodeConfigAccurateTimeConfigArgs>? AccurateTimeConfig { get; set; }
        ...
        public Input<Inputs.ClusterNodePoolNodeConfigLinuxNodeConfigCustomNodeInitArgs>? CustomNodeInit { get; set; }

        /// <summary>
        /// Amounts for 2M and 1G hugepages. Structure is documented below.
        /// </summary>
        [Input("hugepagesConfig")]
        public Input<Inputs.ClusterNodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs>? HugepagesConfig { get; set; }

        /// <summary>
        /// Settings for kernel module loading. Structure is documented below.
        /// </summary>
        [Input("nodeKernelModuleLoading")]
        public Input<Inputs.ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoadingArgs>? NodeKernelModuleLoading { get; set; }

        /// <summary>
        /// Swap configuration for the node. Structure is documented below.
        /// </summary>
        [Input("swapConfig")]
        public Input<Inputs.ClusterNodePoolNodeConfigLinuxNodeConfigSwapConfigArgs>? SwapConfig { get; set; }
