...
namespace Pulumi.Gcp.Container.Inputs
{
    ...
    public sealed class ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostArgs : global::Pulumi.ResourceArgs
    {
        [Input("capabilities")]
        ...
        {
            get => _cas ?? (_cas = new InputList<Inputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostCaArgs>());
            set => _cas = value;
        }
        ...
        {
            get => _clients ?? (_clients = new InputList<Inputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostClientArgs>());
            set => _clients = value;
        }
        ...
        {
            get => _headers ?? (_headers = new InputList<Inputs.ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostHeaderArgs>());
            set => _headers = value;
        }
        ...
        public ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostArgs()
        {
        }
        public static new ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostArgs Empty => new ClusterNodePoolDefaultsNodeConfigDefaultsContainerdConfigRegistryHostHostArgs();
    }
}
