...
namespace Pulumi.Gcp.Container.Inputs
{
    ...
    public sealed class ClusterMaintenancePolicyRecurringMaintenanceWindowGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies the initial date when the recurring window can start.
        /// </summary>
        [Input("delayUntil")]
        public Input<Inputs.ClusterMaintenancePolicyRecurringMaintenanceWindowDelayUntilGetArgs>? DelayUntil { get; set; }
        ...
        public Input<Inputs.ClusterMaintenancePolicyRecurringMaintenanceWindowWindowStartTimeGetArgs> WindowStartTime { get; set; } = null!;

        public ClusterMaintenancePolicyRecurringMaintenanceWindowGetArgs()
        {
        }
        public static new ClusterMaintenancePolicyRecurringMaintenanceWindowGetArgs Empty => new ClusterMaintenancePolicyRecurringMaintenanceWindowGetArgs();
    }
}
