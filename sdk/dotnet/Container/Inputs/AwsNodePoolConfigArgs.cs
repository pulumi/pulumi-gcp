...
namespace Pulumi.Gcp.Container.Inputs
{
    ...
    public sealed class AwsNodePoolConfigArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AwsNodePoolConfigConfigEncryptionArgs> ConfigEncryption { get; set; } = null!;
        ...
        /// </summary>
        [Input("proxyConfig")]
        public Input<Inputs.AwsNodePoolConfigProxyConfigArgs>? ProxyConfig { get; set; }

        /// <summary>
        /// Optional. Template for the root volume provisioned for node pool nodes. Volumes will be provisioned in the availability zone assigned to the node pool subnet. When unspecified, it defaults to 32 GiB with the GP2 volume type.
        /// </summary>
        [Input("rootVolume")]
        public Input<Inputs.AwsNodePoolConfigRootVolumeArgs>? RootVolume { get; set; }
        ...
        /// </summary>
        [Input("sshConfig")]
        public Input<Inputs.AwsNodePoolConfigSshConfigArgs>? SshConfig { get; set; }
        ...
        [Input("taints")]
        private InputList<Inputs.AwsNodePoolConfigTaintArgs>? _taints;

        /// <summary>
        /// Optional. The initial taints assigned to nodes of this node pool.
        /// </summary>
        public InputList<Inputs.AwsNodePoolConfigTaintArgs> Taints
        {
            get => _taints ?? (_taints = new InputList<Inputs.AwsNodePoolConfigTaintArgs>());
            set => _taints = value;
        }
