...
namespace Pulumi.Gcp.Firebase.Inputs
{
    ...
    public sealed class RemoteConfigRemoteConfigVersionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Output)
        ...
        [Input("updateUsers")]
        private InputList<Inputs.RemoteConfigRemoteConfigVersionUpdateUserGetArgs>? _updateUsers;
        ...
        /// </summary>
        public InputList<Inputs.RemoteConfigRemoteConfigVersionUpdateUserGetArgs> UpdateUsers
        {
            get => _updateUsers ?? (_updateUsers = new InputList<Inputs.RemoteConfigRemoteConfigVersionUpdateUserGetArgs>());
        ...
        public RemoteConfigRemoteConfigVersionGetArgs()
        {
        }
        public static new RemoteConfigRemoteConfigVersionGetArgs Empty => new RemoteConfigRemoteConfigVersionGetArgs();
    }
}
