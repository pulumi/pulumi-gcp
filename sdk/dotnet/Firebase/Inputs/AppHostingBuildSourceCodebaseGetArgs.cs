...
namespace Pulumi.Gcp.Firebase.Inputs
{
    ...
    public sealed class AppHostingBuildSourceCodebaseGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("authors")]
        private InputList<Inputs.AppHostingBuildSourceCodebaseAuthorGetArgs>? _authors;
        ...
        /// </summary>
        public InputList<Inputs.AppHostingBuildSourceCodebaseAuthorGetArgs> Authors
        {
            get => _authors ?? (_authors = new InputList<Inputs.AppHostingBuildSourceCodebaseAuthorGetArgs>());
            set => _authors = value;
        }
        ...
        public AppHostingBuildSourceCodebaseGetArgs()
        {
        }
        public static new AppHostingBuildSourceCodebaseGetArgs Empty => new AppHostingBuildSourceCodebaseGetArgs();
    }
}
