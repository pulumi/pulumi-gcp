...
namespace Pulumi.Gcp.Firebase.Inputs
{
    ...
    public sealed class RemoteConfigRemoteConfigConditionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("tagColor")]
        public Input<string>? TagColor { get; set; }

        public RemoteConfigRemoteConfigConditionArgs()
        {
        }
        public static new RemoteConfigRemoteConfigConditionArgs Empty => new RemoteConfigRemoteConfigConditionArgs();
    }
}
