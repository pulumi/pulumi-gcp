...
namespace Pulumi.Gcp.Chronicle.Inputs
{
    ...
    public sealed class FeedDetailsQualysVmSettingsAuthenticationArgs : global::Pulumi.ResourceArgs
    {
        [Input("secret")]
        ...
        public FeedDetailsQualysVmSettingsAuthenticationArgs()
        {
        }
        public static new FeedDetailsQualysVmSettingsAuthenticationArgs Empty => new FeedDetailsQualysVmSettingsAuthenticationArgs();
    }
}
