...
namespace Pulumi.Gcp.Chronicle.Inputs
{
    ...
    public sealed class FeedDetailsCloudPassageSettingsAuthenticationArgs : global::Pulumi.ResourceArgs
    {
        [Input("secret")]
        ...
        public FeedDetailsCloudPassageSettingsAuthenticationArgs()
        {
        }
        public static new FeedDetailsCloudPassageSettingsAuthenticationArgs Empty => new FeedDetailsCloudPassageSettingsAuthenticationArgs();
    }
}
