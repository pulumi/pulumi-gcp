...
namespace Pulumi.Gcp.Chronicle.Inputs
{
    ...
    public sealed class FeedDetailsFoxItStixSettingsSslArgs : global::Pulumi.ResourceArgs
    {
        [Input("encodedPrivateKey")]
        private Input<string>? _encodedPrivateKey;
        ...
        /// </summary>
        public Input<string>? EncodedPrivateKey
        {
            get => _encodedPrivateKey;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _encodedPrivateKey = Output.Tuple<Input<string>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        public FeedDetailsFoxItStixSettingsSslArgs()
        {
        }
        public static new FeedDetailsFoxItStixSettingsSslArgs Empty => new FeedDetailsFoxItStixSettingsSslArgs();
    }
}
