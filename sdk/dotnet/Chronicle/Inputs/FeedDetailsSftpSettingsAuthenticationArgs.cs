...
namespace Pulumi.Gcp.Chronicle.Inputs
{
    ...
    public sealed class FeedDetailsSftpSettingsAuthenticationArgs : global::Pulumi.ResourceArgs
    {
        [Input("password")]
        ...
        public FeedDetailsSftpSettingsAuthenticationArgs()
        {
        }
        public static new FeedDetailsSftpSettingsAuthenticationArgs Empty => new FeedDetailsSftpSettingsAuthenticationArgs();
    }
}
