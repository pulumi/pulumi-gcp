...
namespace Pulumi.Gcp.BackupDisasterRecovery.Outputs
{
    ...
    [OutputType]
    public sealed class RestoreWorkloadComputeInstanceRestorePropertiesDiskGuestOsFeature
    {
        /// <summary>
        ...
        [OutputConstructor]
        private RestoreWorkloadComputeInstanceRestorePropertiesDiskGuestOsFeature(string? type)
        {
            Type = type;
        }
    }
