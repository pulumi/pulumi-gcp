...
namespace Pulumi.Gcp.Eventarc
{
    ...
    /// </summary>
    [GcpResourceType("gcp:eventarc/pipelineIamMember:PipelineIamMember")]
    public partial class PipelineIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.PipelineIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public PipelineIamMember(string name, PipelineIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:eventarc/pipelineIamMember:PipelineIamMember", name, args ?? new PipelineIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineIamMember(string name, Input<string> id, PipelineIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:eventarc/pipelineIamMember:PipelineIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PipelineIamMember Get(string name, Input<string> id, PipelineIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new PipelineIamMember(name, id, state, options);
        }
    }

    public sealed class PipelineIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.PipelineIamMemberConditionArgs>? Condition { get; set; }
        ...
        public PipelineIamMemberArgs()
        {
        }
        public static new PipelineIamMemberArgs Empty => new PipelineIamMemberArgs();
    }

    public sealed class PipelineIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.PipelineIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public PipelineIamMemberState()
        {
        }
        public static new PipelineIamMemberState Empty => new PipelineIamMemberState();
    }
}
