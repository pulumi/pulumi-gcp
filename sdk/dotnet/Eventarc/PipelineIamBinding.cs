...
namespace Pulumi.Gcp.Eventarc
{
    ...
    /// </summary>
    [GcpResourceType("gcp:eventarc/pipelineIamBinding:PipelineIamBinding")]
    public partial class PipelineIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.PipelineIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public PipelineIamBinding(string name, PipelineIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:eventarc/pipelineIamBinding:PipelineIamBinding", name, args ?? new PipelineIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PipelineIamBinding(string name, Input<string> id, PipelineIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:eventarc/pipelineIamBinding:PipelineIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PipelineIamBinding Get(string name, Input<string> id, PipelineIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new PipelineIamBinding(name, id, state, options);
        }
    }

    public sealed class PipelineIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.PipelineIamBindingConditionArgs>? Condition { get; set; }
        ...
        public PipelineIamBindingArgs()
        {
        }
        public static new PipelineIamBindingArgs Empty => new PipelineIamBindingArgs();
    }

    public sealed class PipelineIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.PipelineIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public PipelineIamBindingState()
        {
        }
        public static new PipelineIamBindingState Empty => new PipelineIamBindingState();
    }
}
