...
namespace Pulumi.Gcp.Eventarc.Inputs
{
    ...
    public sealed class MessageBusLoggingConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public MessageBusLoggingConfigGetArgs()
        {
        }
        public static new MessageBusLoggingConfigGetArgs Empty => new MessageBusLoggingConfigGetArgs();
    }
}
