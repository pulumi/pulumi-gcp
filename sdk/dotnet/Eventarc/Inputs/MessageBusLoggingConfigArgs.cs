...
namespace Pulumi.Gcp.Eventarc.Inputs
{
    ...
    public sealed class MessageBusLoggingConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public MessageBusLoggingConfigArgs()
        {
        }
        public static new MessageBusLoggingConfigArgs Empty => new MessageBusLoggingConfigArgs();
    }
}
