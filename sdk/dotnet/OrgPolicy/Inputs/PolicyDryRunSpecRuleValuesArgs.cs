...
namespace Pulumi.Gcp.OrgPolicy.Inputs
{
    ...
    public sealed class PolicyDryRunSpecRuleValuesArgs : global::Pulumi.ResourceArgs
    {
        [Input("allowedValues")]
        ...
        public PolicyDryRunSpecRuleValuesArgs()
        {
        }
        public static new PolicyDryRunSpecRuleValuesArgs Empty => new PolicyDryRunSpecRuleValuesArgs();
    }
}
