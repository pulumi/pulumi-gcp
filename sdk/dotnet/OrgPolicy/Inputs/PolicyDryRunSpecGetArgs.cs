...
namespace Pulumi.Gcp.OrgPolicy.Inputs
{
    ...
    public sealed class PolicyDryRunSpecGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Output)
        ...
        [Input("rules")]
        private InputList<Inputs.PolicyDryRunSpecRuleGetArgs>? _rules;

        /// <summary>
        /// In policies for boolean constraints, the following requirements apply: - There must be one and only one policy rule where condition is unset. - Boolean policy rules with conditions must set `Enforced` to the opposite of the policy rule without a condition. - During policy evaluation, policy rules with conditions that are true for a target resource take precedence.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.PolicyDryRunSpecRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.PolicyDryRunSpecRuleGetArgs>());
            set => _rules = value;
        }
        ...
        public PolicyDryRunSpecGetArgs()
        {
        }
        public static new PolicyDryRunSpecGetArgs Empty => new PolicyDryRunSpecGetArgs();
    }
}
