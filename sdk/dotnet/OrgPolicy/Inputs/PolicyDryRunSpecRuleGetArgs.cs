...
namespace Pulumi.Gcp.OrgPolicy.Inputs
{
    ...
    public sealed class PolicyDryRunSpecRuleGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("condition")]
        public Input<Inputs.PolicyDryRunSpecRuleConditionGetArgs>? Condition { get; set; }
        ...
        /// </summary>
        [Input("values")]
        public Input<Inputs.PolicyDryRunSpecRuleValuesGetArgs>? Values { get; set; }

        public PolicyDryRunSpecRuleGetArgs()
        {
        }
        public static new PolicyDryRunSpecRuleGetArgs Empty => new PolicyDryRunSpecRuleGetArgs();
    }
}
