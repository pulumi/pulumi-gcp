...
namespace Pulumi.Gcp.OrgPolicy.Inputs
{
    ...
    public sealed class PolicyDryRunSpecRuleValuesGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("allowedValues")]
        ...
        public PolicyDryRunSpecRuleValuesGetArgs()
        {
        }
        public static new PolicyDryRunSpecRuleValuesGetArgs Empty => new PolicyDryRunSpecRuleValuesGetArgs();
    }
}
