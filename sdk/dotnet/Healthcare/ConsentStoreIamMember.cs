...
namespace Pulumi.Gcp.Healthcare
{
    ...
    ///  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
    /// </summary>
    [GcpResourceType("gcp:healthcare/consentStoreIamMember:ConsentStoreIamMember")]
    public partial class ConsentStoreIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.ConsentStoreIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public ConsentStoreIamMember(string name, ConsentStoreIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:healthcare/consentStoreIamMember:ConsentStoreIamMember", name, args ?? new ConsentStoreIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsentStoreIamMember(string name, Input<string> id, ConsentStoreIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:healthcare/consentStoreIamMember:ConsentStoreIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConsentStoreIamMember Get(string name, Input<string> id, ConsentStoreIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new ConsentStoreIamMember(name, id, state, options);
        }
    }

    public sealed class ConsentStoreIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.ConsentStoreIamMemberConditionArgs>? Condition { get; set; }
        ...
        public static new ConsentStoreIamMemberArgs Empty => new ConsentStoreIamMemberArgs();
    }

    public sealed class ConsentStoreIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.ConsentStoreIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public static new ConsentStoreIamMemberState Empty => new ConsentStoreIamMemberState();
    }
}
