...
namespace Pulumi.Gcp.Healthcare.Inputs
{
    ...
    public sealed class PipelineJobReconciliationPipelineJobArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.PipelineJobReconciliationPipelineJobMergeConfigArgs> MergeConfig { get; set; } = null!;

        public PipelineJobReconciliationPipelineJobArgs()
        {
        }
        public static new PipelineJobReconciliationPipelineJobArgs Empty => new PipelineJobReconciliationPipelineJobArgs();
    }
}
