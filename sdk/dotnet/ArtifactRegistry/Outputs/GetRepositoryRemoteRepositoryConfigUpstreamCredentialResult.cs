...
namespace Pulumi.Gcp.ArtifactRegistry.Outputs
{
    ...
    public sealed class GetRepositoryRemoteRepositoryConfigUpstreamCredentialResult
    {
        ...
        [OutputConstructor]
        private GetRepositoryRemoteRepositoryConfigUpstreamCredentialResult(ImmutableArray<Outputs.GetRepositoryRemoteRepositoryConfigUpstreamCredentialUsernamePasswordCredentialResult> usernamePasswordCredentials)
        {
