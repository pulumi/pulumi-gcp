...
namespace Pulumi.Gcp.Compute
{
    ...
    public partial class CaExternalAccountKey : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("macKey")]
        public Output<string> MacKey { get; private set; } = null!;
    ...
    public sealed class CaExternalAccountKeyState : global::Pulumi.ResourceArgs
    {
        ...
        /// **Note**: This property is sensitive and will not be displayed in the plan.
        /// </summary>
        [Obsolete(@"`B64MacKey` is deprecated and will be removed in a future major release. Use `MacKey` instead.")]
        ...
        /// **Note**: This property is sensitive and will not be displayed in the plan.
        /// </summary>
        [Obsolete(@"`B64urlMacKey` is deprecated and will be removed in a future major release. Use `MacKey` instead.")]
        ...
        /// **Note**: This property is sensitive and will not be displayed in the plan.
        /// </summary>
        public Input<string>? MacKey
        {
            get => _macKey;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _macKey = Output.Tuple<Input<string>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
