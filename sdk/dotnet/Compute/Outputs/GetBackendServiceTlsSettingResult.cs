...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class GetBackendServiceTlsSettingResult
    {
        /// <summary>
        ...
        /// subjectAltNames.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetBackendServiceTlsSettingSubjectAltNameResult> SubjectAltNames;

        [OutputConstructor]
        private GetBackendServiceTlsSettingResult(
            string authenticationConfig,

            string sni,

            ImmutableArray<Outputs.GetBackendServiceTlsSettingSubjectAltNameResult> subjectAltNames)
        {
