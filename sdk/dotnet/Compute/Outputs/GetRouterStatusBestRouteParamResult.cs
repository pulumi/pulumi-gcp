...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class GetRouterStatusBestRouteParamResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetRouterStatusBestRouteParamResult(ImmutableDictionary<string, string> resourceManagerTags)
        {
