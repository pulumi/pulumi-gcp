...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class RegionResizeRequestStatusLastAttempt
    {
        /// <summary>
        /// (Output)
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.RegionResizeRequestStatusLastAttemptError> Errors;

        [OutputConstructor]
        private RegionResizeRequestStatusLastAttempt(ImmutableArray<Outputs.RegionResizeRequestStatusLastAttemptError> errors)
        {
            Errors = errors;
        }
    }
