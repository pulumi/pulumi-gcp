...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class GetInstanceGroupManagerInstanceLifecyclePolicyOnRepairResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetInstanceGroupManagerInstanceLifecyclePolicyOnRepairResult(string allowChangingZone)
        {
