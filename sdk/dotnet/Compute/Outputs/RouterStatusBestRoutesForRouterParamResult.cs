...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class RouterStatusBestRoutesForRouterParamResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private RouterStatusBestRoutesForRouterParamResult(ImmutableDictionary<string, string> resourceManagerTags)
        {
