...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class GetRegionBackendServiceParamResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetRegionBackendServiceParamResult(ImmutableDictionary<string, string> resourceManagerTags)
        {
