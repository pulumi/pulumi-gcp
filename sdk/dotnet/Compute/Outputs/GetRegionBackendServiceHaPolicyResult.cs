...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class GetRegionBackendServiceHaPolicyResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetRegionBackendServiceHaPolicyLeaderResult> Leaders;

        [OutputConstructor]
        private GetRegionBackendServiceHaPolicyResult(
            string fastIpMove,

            ImmutableArray<Outputs.GetRegionBackendServiceHaPolicyLeaderResult> leaders)
        {
