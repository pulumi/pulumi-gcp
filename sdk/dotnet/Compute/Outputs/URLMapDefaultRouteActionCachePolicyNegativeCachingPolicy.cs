...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class URLMapDefaultRouteActionCachePolicyNegativeCachingPolicy
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.URLMapDefaultRouteActionCachePolicyNegativeCachingPolicyTtl? Ttl;

        [OutputConstructor]
        private URLMapDefaultRouteActionCachePolicyNegativeCachingPolicy(
            int? code,

            Outputs.URLMapDefaultRouteActionCachePolicyNegativeCachingPolicyTtl? ttl)
        {
            Code = code;
            Ttl = ttl;
        }
