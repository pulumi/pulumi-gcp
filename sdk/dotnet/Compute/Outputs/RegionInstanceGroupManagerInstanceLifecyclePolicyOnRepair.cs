...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class RegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair
    {
        /// <summary>
        ...
        [OutputConstructor]
        private RegionInstanceGroupManagerInstanceLifecyclePolicyOnRepair(string? allowChangingZone)
        {
