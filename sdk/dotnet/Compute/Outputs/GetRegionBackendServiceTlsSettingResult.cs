...
namespace Pulumi.Gcp.Compute.Outputs
{
    ...
    [OutputType]
    public sealed class GetRegionBackendServiceTlsSettingResult
    {
        /// <summary>
        ...
        /// subjectAltNames.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetRegionBackendServiceTlsSettingSubjectAltNameResult> SubjectAltNames;

        [OutputConstructor]
        private GetRegionBackendServiceTlsSettingResult(
            string authenticationConfig,

            string sni,

            ImmutableArray<Outputs.GetRegionBackendServiceTlsSettingSubjectAltNameResult> subjectAltNames)
        {
