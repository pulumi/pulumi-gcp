...
namespace Pulumi.Gcp.Compute
{
    ...
    /// </summary>
    [GcpResourceType("gcp:compute/snapshotIamBinding:SnapshotIamBinding")]
    public partial class SnapshotIamBinding : Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.SnapshotIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public SnapshotIamBinding(string name, SnapshotIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:compute/snapshotIamBinding:SnapshotIamBinding", name, args ?? new SnapshotIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotIamBinding(string name, Input<string> id, SnapshotIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:compute/snapshotIamBinding:SnapshotIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SnapshotIamBinding Get(string name, Input<string> id, SnapshotIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new SnapshotIamBinding(name, id, state, options);
        }
    }

    public sealed class SnapshotIamBindingArgs : Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.SnapshotIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class SnapshotIamBindingState : Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.SnapshotIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public SnapshotIamBindingState()
        {
        }
    }
}
