...
namespace Pulumi.Gcp.Compute
{
    ...
    /// </summary>
    [GcpResourceType("gcp:compute/networkFirewallPolicyIamBinding:NetworkFirewallPolicyIamBinding")]
    public partial class NetworkFirewallPolicyIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.NetworkFirewallPolicyIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public NetworkFirewallPolicyIamBinding(string name, NetworkFirewallPolicyIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:compute/networkFirewallPolicyIamBinding:NetworkFirewallPolicyIamBinding", name, args ?? new NetworkFirewallPolicyIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NetworkFirewallPolicyIamBinding(string name, Input<string> id, NetworkFirewallPolicyIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:compute/networkFirewallPolicyIamBinding:NetworkFirewallPolicyIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NetworkFirewallPolicyIamBinding Get(string name, Input<string> id, NetworkFirewallPolicyIamBindingState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.NetworkFirewallPolicyIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class NetworkFirewallPolicyIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.NetworkFirewallPolicyIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public NetworkFirewallPolicyIamBindingState()
        {
        }
        public static new NetworkFirewallPolicyIamBindingState Empty => new NetworkFirewallPolicyIamBindingState();
    }
}
