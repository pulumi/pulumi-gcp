...
namespace Pulumi.Gcp.Compute.Inputs
{
    ...
    public sealed class URLMapDefaultRouteActionWeightedBackendServiceHeaderActionGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.URLMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddGetArgs> RequestHeadersToAdds
        {
            get => _requestHeadersToAdds ?? (_requestHeadersToAdds = new InputList<Inputs.URLMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddGetArgs>());
        ...
        private InputList<Inputs.URLMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddGetArgs>? _responseHeadersToAdds;

        /// <summary>
        /// Headers to add the response prior to sending the response back to the client.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.URLMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddGetArgs> ResponseHeadersToAdds
        {
            get => _responseHeadersToAdds ?? (_responseHeadersToAdds = new InputList<Inputs.URLMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddGetArgs>());
