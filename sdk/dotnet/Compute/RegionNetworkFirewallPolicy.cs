...
namespace Pulumi.Gcp.Compute
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:compute/regionNetworkFirewallPolicy:RegionNetworkFirewallPolicy")]
    public partial class RegionNetworkFirewallPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public RegionNetworkFirewallPolicy(string name, RegionNetworkFirewallPolicyArgs? args = null, CustomResourceOptions? options = null)
            : base("gcp:compute/regionNetworkFirewallPolicy:RegionNetworkFirewallPolicy", name, args ?? new RegionNetworkFirewallPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionNetworkFirewallPolicy(string name, Input<string> id, RegionNetworkFirewallPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:compute/regionNetworkFirewallPolicy:RegionNetworkFirewallPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionNetworkFirewallPolicy Get(string name, Input<string> id, RegionNetworkFirewallPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new RegionNetworkFirewallPolicy(name, id, state, options);
        }
    }

    public sealed class RegionNetworkFirewallPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An optional description of this resource. Provide this property when you create the resource.
        /// </summary>
        ...
        public static new RegionNetworkFirewallPolicyArgs Empty => new RegionNetworkFirewallPolicyArgs();
    }

    public sealed class RegionNetworkFirewallPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Creation timestamp in RFC3339 text format.
        /// </summary>
        ...
        /// The unique identifier for the resource. This identifier is defined by the server.
        /// </summary>
        [Input("regionNetworkFirewallPolicyId")]
        public Input<string>? RegionNetworkFirewallPolicyId { get; set; }
        ...
        public RegionNetworkFirewallPolicyState()
        {
        }
        public static new RegionNetworkFirewallPolicyState Empty => new RegionNetworkFirewallPolicyState();
    }
}
