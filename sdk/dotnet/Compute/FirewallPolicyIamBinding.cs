...
namespace Pulumi.Gcp.Compute
{
    ...
    ///  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
    /// </summary>
    [GcpResourceType("gcp:compute/firewallPolicyIamBinding:FirewallPolicyIamBinding")]
    public partial class FirewallPolicyIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.FirewallPolicyIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public FirewallPolicyIamBinding(string name, FirewallPolicyIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:compute/firewallPolicyIamBinding:FirewallPolicyIamBinding", name, args ?? new FirewallPolicyIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FirewallPolicyIamBinding(string name, Input<string> id, FirewallPolicyIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:compute/firewallPolicyIamBinding:FirewallPolicyIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FirewallPolicyIamBinding Get(string name, Input<string> id, FirewallPolicyIamBindingState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.FirewallPolicyIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class FirewallPolicyIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.FirewallPolicyIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public FirewallPolicyIamBindingState()
        {
        }
        public static new FirewallPolicyIamBindingState Empty => new FirewallPolicyIamBindingState();
    }
}
