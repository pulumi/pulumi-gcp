...
namespace Pulumi.Gcp.Compute
{
    public static partial class Invokes
    {
        ...
        public static Task<GetDefaultServiceAccountResult> GetDefaultServiceAccount(GetDefaultServiceAccountArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDefaultServiceAccountResult>("gcp:compute/getDefaultServiceAccount:getDefaultServiceAccount", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetDefaultServiceAccountArgs : Pulumi.ResourceArgs
    {
        /// <summary>
