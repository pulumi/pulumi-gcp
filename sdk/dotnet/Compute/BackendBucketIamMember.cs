...
namespace Pulumi.Gcp.Compute
{
    ...
    public partial class BackendBucketIamMember : global::Pulumi.CustomResource
    {
        ...
        public BackendBucketIamMember(string name, BackendBucketIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:compute/backendBucketIamMember:BackendBucketIamMember", name, args ?? new BackendBucketIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackendBucketIamMember(string name, Input<string> id, BackendBucketIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:compute/backendBucketIamMember:BackendBucketIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BackendBucketIamMember Get(string name, Input<string> id, BackendBucketIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new BackendBucketIamMember(name, id, state, options);
        }
    }
