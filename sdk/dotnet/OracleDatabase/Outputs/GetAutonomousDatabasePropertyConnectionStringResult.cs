...
namespace Pulumi.Gcp.OracleDatabase.Outputs
{
    ...
    [OutputType]
    public sealed class GetAutonomousDatabasePropertyConnectionStringResult
    {
        /// <summary>
        /// A list of all connection strings that can be used to connect to the
        /// Autonomous Database.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAutonomousDatabasePropertyConnectionStringAllConnectionStringResult> AllConnectionStrings;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAutonomousDatabasePropertyConnectionStringProfileResult> Profiles;

        [OutputConstructor]
        private GetAutonomousDatabasePropertyConnectionStringResult(
            ImmutableArray<Outputs.GetAutonomousDatabasePropertyConnectionStringAllConnectionStringResult> allConnectionStrings,
            ...
            ImmutableArray<Outputs.GetAutonomousDatabasePropertyConnectionStringProfileResult> profiles)
        {
