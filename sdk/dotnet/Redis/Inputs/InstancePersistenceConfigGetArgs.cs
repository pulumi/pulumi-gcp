...
namespace Pulumi.Gcp.Redis.Inputs
{
    ...
    public sealed class InstancePersistenceConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("rdbSnapshotPeriod", required: true)]
        public Input<string> RdbSnapshotPeriod { get; set; } = null!;
        ...
        public InstancePersistenceConfigGetArgs()
        {
        }
        public static new InstancePersistenceConfigGetArgs Empty => new InstancePersistenceConfigGetArgs();
    }
}
