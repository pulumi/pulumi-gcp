...
namespace Pulumi.Gcp.Ces.Outputs
{
    ...
    [OutputType]
    public sealed class AppVersionSnapshotAppAudioProcessingConfigBargeInConfig
    {
        /// <summary>
        /// (Output)
        ...
        [OutputConstructor]
        private AppVersionSnapshotAppAudioProcessingConfigBargeInConfig(bool? bargeInAwareness)
        {
