...
namespace Pulumi.Gcp.Ces.Outputs
{
    ...
    [OutputType]
    public sealed class AppVersionSnapshotAppLoggingSettingMetricAnalysisSetting
    {
        /// <summary>
        /// (Output)
        ...
        [OutputConstructor]
        private AppVersionSnapshotAppLoggingSettingMetricAnalysisSetting(bool? llmMetricsOptedOut)
        {
