...
namespace Pulumi.Gcp.Ces.Outputs
{
    ...
    [OutputType]
    public sealed class AppVersionSnapshotGuardrailLlmPromptSecurityDefaultSetting
    {
        /// <summary>
        /// (Output)
        ...
        [OutputConstructor]
        private AppVersionSnapshotGuardrailLlmPromptSecurityDefaultSetting(string? defaultPromptTemplate)
        {
