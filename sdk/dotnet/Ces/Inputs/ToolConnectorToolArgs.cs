...
namespace Pulumi.Gcp.Ces.Inputs
{
    ...
    public sealed class ToolConnectorToolArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions")]
        private InputList<Inputs.ToolConnectorToolActionArgs>? _actions;
        ...
        /// </summary>
        public InputList<Inputs.ToolConnectorToolActionArgs> Actions
        {
            get => _actions ?? (_actions = new InputList<Inputs.ToolConnectorToolActionArgs>());
            set => _actions = value;
        }
        ...
        public ToolConnectorToolArgs()
        {
        }
        public static new ToolConnectorToolArgs Empty => new ToolConnectorToolArgs();
    }
}
