...
namespace Pulumi.Gcp.Ces.Inputs
{
    ...
    public sealed class DeploymentWhatsappCredentialsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("authCode")]
        ...
        /// </summary>
        [Input("businessAccountId", required: true)]
        public Input<string> BusinessAccountId { get; set; } = null!;
        ...
        /// </summary>
        public Input<string>? PinWo
        {
            get => _pinWo;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _pinWo = Output.Tuple<Input<string>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        /// </summary>
        [Input("pinWoVersion")]
        public Input<string>? PinWoVersion { get; set; }
        ...
        public DeploymentWhatsappCredentialsGetArgs()
        {
        }
        public static new DeploymentWhatsappCredentialsGetArgs Empty => new DeploymentWhatsappCredentialsGetArgs();
    }
}
