...
namespace Pulumi.Gcp.Ces.Inputs
{
    ...
    public sealed class AgentRemoteDialogflowAgentGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The
        ...
        /// </summary>
        [Input("respectResponseInterruptionSettings")]
        public Input<bool>? RespectResponseInterruptionSettings { get; set; }

        public AgentRemoteDialogflowAgentGetArgs()
        {
        }
        public static new AgentRemoteDialogflowAgentGetArgs Empty => new AgentRemoteDialogflowAgentGetArgs();
    }
}
