...
namespace Pulumi.Gcp.DocumentAiWarehouse
{
    ...
    /// 
    ///     var example = new Gcp.DocumentAiWarehouse.Location("example", new()
    ///     {
    ///         Location = "us",
    ...
    /// </summary>
    [GcpResourceType("gcp:documentaiwarehouse/location:Location")]
    public partial class Location : global::Pulumi.CustomResource
    {
        ...
        public Location(string name, LocationArgs args, CustomResourceOptions? options = null)
            : base("gcp:documentaiwarehouse/location:Location", name, args ?? new LocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Location(string name, Input<string> id, LocationState? state = null, CustomResourceOptions? options = null)
            : base("gcp:documentaiwarehouse/location:Location", name, state, MakeResourceOptions(options, id))
        {
        }
