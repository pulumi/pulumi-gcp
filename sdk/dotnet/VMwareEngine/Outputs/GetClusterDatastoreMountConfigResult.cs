...
namespace Pulumi.Gcp.VMwareEngine.Outputs
{
    ...
    [OutputType]
    public sealed class GetClusterDatastoreMountConfigResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetClusterDatastoreMountConfigDatastoreNetworkResult> DatastoreNetworks;
        /// <summary>
        /// File share name.
        /// </summary>
        ...
        [OutputConstructor]
        private GetClusterDatastoreMountConfigResult(
            string accessMode,

            string datastore,

            ImmutableArray<Outputs.GetClusterDatastoreMountConfigDatastoreNetworkResult> datastoreNetworks,
            ...
            ImmutableArray<string> servers)
        {
            ...
            Datastore = datastore;
            DatastoreNetworks = datastoreNetworks;
            FileShare = fileShare;
