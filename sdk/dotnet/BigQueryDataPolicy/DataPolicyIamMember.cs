...
namespace Pulumi.Gcp.BigQueryDataPolicy
{
    ...
    /// </summary>
    [GcpResourceType("gcp:bigquerydatapolicy/dataPolicyIamMember:DataPolicyIamMember")]
    public partial class DataPolicyIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.DataPolicyIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public DataPolicyIamMember(string name, DataPolicyIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:bigquerydatapolicy/dataPolicyIamMember:DataPolicyIamMember", name, args ?? new DataPolicyIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataPolicyIamMember(string name, Input<string> id, DataPolicyIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:bigquerydatapolicy/dataPolicyIamMember:DataPolicyIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataPolicyIamMember Get(string name, Input<string> id, DataPolicyIamMemberState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.DataPolicyIamMemberConditionArgs>? Condition { get; set; }
    ...
    public sealed class DataPolicyIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.DataPolicyIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public DataPolicyIamMemberState()
        {
        }
        public static new DataPolicyIamMemberState Empty => new DataPolicyIamMemberState();
    }
}
