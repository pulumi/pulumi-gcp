...
namespace Pulumi.Gcp.CloudRunV2
{
    ...
    /// </summary>
    [GcpResourceType("gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding")]
    public partial class WorkerPoolIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.WorkerPoolIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public WorkerPoolIamBinding(string name, WorkerPoolIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding", name, args ?? new WorkerPoolIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkerPoolIamBinding(string name, Input<string> id, WorkerPoolIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkerPoolIamBinding Get(string name, Input<string> id, WorkerPoolIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new WorkerPoolIamBinding(name, id, state, options);
        }
    }

    public sealed class WorkerPoolIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.WorkerPoolIamBindingConditionArgs>? Condition { get; set; }
        ...
        public WorkerPoolIamBindingArgs()
        {
        }
        public static new WorkerPoolIamBindingArgs Empty => new WorkerPoolIamBindingArgs();
    }

    public sealed class WorkerPoolIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.WorkerPoolIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public WorkerPoolIamBindingState()
        {
        }
        public static new WorkerPoolIamBindingState Empty => new WorkerPoolIamBindingState();
    }
}
