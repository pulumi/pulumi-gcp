...
namespace Pulumi.Gcp.CloudRunV2.Inputs
{
    ...
    public sealed class WorkerPoolTemplateArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        [Input("containers")]
        private InputList<Inputs.WorkerPoolTemplateContainerArgs>? _containers;

        /// <summary>
        /// Holds the containers that define the unit of execution for this WorkerPool.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.WorkerPoolTemplateContainerArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.WorkerPoolTemplateContainerArgs>());
        ...
        /// </summary>
        [Input("nodeSelector")]
        public Input<Inputs.WorkerPoolTemplateNodeSelectorArgs>? NodeSelector { get; set; }
        ...
        [Input("volumes")]
        private InputList<Inputs.WorkerPoolTemplateVolumeArgs>? _volumes;

        /// <summary>
        /// A list of Volumes to make available to containers.
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.WorkerPoolTemplateVolumeArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.WorkerPoolTemplateVolumeArgs>());
            set => _volumes = value;
        }
        ...
        /// </summary>
        [Input("vpcAccess")]
        public Input<Inputs.WorkerPoolTemplateVpcAccessArgs>? VpcAccess { get; set; }

        public WorkerPoolTemplateArgs()
        {
        }
        public static new WorkerPoolTemplateArgs Empty => new WorkerPoolTemplateArgs();
    }
}
