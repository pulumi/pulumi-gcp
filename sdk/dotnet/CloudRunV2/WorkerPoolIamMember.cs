...
namespace Pulumi.Gcp.CloudRunV2
{
    ...
    /// </summary>
    [GcpResourceType("gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember")]
    public partial class WorkerPoolIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.WorkerPoolIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public WorkerPoolIamMember(string name, WorkerPoolIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember", name, args ?? new WorkerPoolIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkerPoolIamMember(string name, Input<string> id, WorkerPoolIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkerPoolIamMember Get(string name, Input<string> id, WorkerPoolIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new WorkerPoolIamMember(name, id, state, options);
        }
    }

    public sealed class WorkerPoolIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.WorkerPoolIamMemberConditionArgs>? Condition { get; set; }
        ...
        public WorkerPoolIamMemberArgs()
        {
        }
        public static new WorkerPoolIamMemberArgs Empty => new WorkerPoolIamMemberArgs();
    }

    public sealed class WorkerPoolIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.WorkerPoolIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public WorkerPoolIamMemberState()
        {
        }
        public static new WorkerPoolIamMemberState Empty => new WorkerPoolIamMemberState();
    }
}
