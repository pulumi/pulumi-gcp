...
namespace Pulumi.Gcp.CloudRunV2
{
    ...
    /// </summary>
    [GcpResourceType("gcp:cloudrunv2/jobIamBinding:JobIamBinding")]
    public partial class JobIamBinding : global::Pulumi.CustomResource
    {
        ...
        public JobIamBinding(string name, JobIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/jobIamBinding:JobIamBinding", name, args ?? new JobIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamBinding(string name, Input<string> id, JobIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/jobIamBinding:JobIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
