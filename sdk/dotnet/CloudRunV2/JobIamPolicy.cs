...
namespace Pulumi.Gcp.CloudRunV2
{
    ...
    /// </summary>
    [GcpResourceType("gcp:cloudrunv2/jobIamPolicy:JobIamPolicy")]
    public partial class JobIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public JobIamPolicy(string name, JobIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/jobIamPolicy:JobIamPolicy", name, args ?? new JobIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JobIamPolicy(string name, Input<string> id, JobIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/jobIamPolicy:JobIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
