...
namespace Pulumi.Gcp.CloudRunV2
{
    ...
    /// </summary>
    [GcpResourceType("gcp:cloudrunv2/serviceIamPolicy:ServiceIamPolicy")]
    public partial class ServiceIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public ServiceIamPolicy(string name, ServiceIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/serviceIamPolicy:ServiceIamPolicy", name, args ?? new ServiceIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIamPolicy(string name, Input<string> id, ServiceIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:cloudrunv2/serviceIamPolicy:ServiceIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
