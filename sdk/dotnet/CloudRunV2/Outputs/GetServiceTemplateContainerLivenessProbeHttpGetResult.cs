...
namespace Pulumi.Gcp.CloudRunV2.Outputs
{
    ...
    public sealed class GetServiceTemplateContainerLivenessProbeHttpGetResult
    {
        ...
        [OutputConstructor]
        private GetServiceTemplateContainerLivenessProbeHttpGetResult(
            ImmutableArray<Outputs.GetServiceTemplateContainerLivenessProbeHttpGetHttpHeaderResult> httpHeaders,
