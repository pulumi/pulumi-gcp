...
namespace Pulumi.Gcp.SecretManager
{
    ...
    /// </summary>
    [GcpResourceType("gcp:secretmanager/regionalSecretIamBinding:RegionalSecretIamBinding")]
    public partial class RegionalSecretIamBinding : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.RegionalSecretIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        /// `gcp.secretmanager.RegionalSecretIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `Condition` block (or one has no condition). Note that custom roles must be of the format
        ...
        public RegionalSecretIamBinding(string name, RegionalSecretIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:secretmanager/regionalSecretIamBinding:RegionalSecretIamBinding", name, args ?? new RegionalSecretIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegionalSecretIamBinding(string name, Input<string> id, RegionalSecretIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:secretmanager/regionalSecretIamBinding:RegionalSecretIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RegionalSecretIamBinding Get(string name, Input<string> id, RegionalSecretIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new RegionalSecretIamBinding(name, id, state, options);
        }
    }

    public sealed class RegionalSecretIamBindingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.RegionalSecretIamBindingConditionArgs>? Condition { get; set; }
        ...
        public RegionalSecretIamBindingArgs()
        {
        }
        public static new RegionalSecretIamBindingArgs Empty => new RegionalSecretIamBindingArgs();
    }

    public sealed class RegionalSecretIamBindingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.RegionalSecretIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public RegionalSecretIamBindingState()
        {
        }
        public static new RegionalSecretIamBindingState Empty => new RegionalSecretIamBindingState();
    }
}
