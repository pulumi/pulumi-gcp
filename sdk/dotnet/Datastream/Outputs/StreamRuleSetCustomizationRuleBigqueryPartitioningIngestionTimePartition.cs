...
namespace Pulumi.Gcp.Datastream.Outputs
{
    ...
    [OutputType]
    public sealed class StreamRuleSetCustomizationRuleBigqueryPartitioningIngestionTimePartition
    {
        /// <summary>
        ...
        [OutputConstructor]
        private StreamRuleSetCustomizationRuleBigqueryPartitioningIngestionTimePartition(string? partitioningTimeGranularity)
        {
