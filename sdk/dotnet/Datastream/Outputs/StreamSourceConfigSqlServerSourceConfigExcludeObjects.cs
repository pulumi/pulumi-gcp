...
namespace Pulumi.Gcp.Datastream.Outputs
{
    ...
    public sealed class StreamSourceConfigSqlServerSourceConfigExcludeObjects
    {
        ...
        [OutputConstructor]
        private StreamSourceConfigSqlServerSourceConfigExcludeObjects(ImmutableArray<Outputs.StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchema> schemas)
        {
            Schemas = schemas;
        }
    }
