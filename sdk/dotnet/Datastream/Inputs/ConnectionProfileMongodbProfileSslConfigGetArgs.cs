...
namespace Pulumi.Gcp.Datastream.Inputs
{
    ...
    public sealed class ConnectionProfileMongodbProfileSslConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("caCertificate")]
        ...
        [Input("secretManagerStoredClientKey")]
        private Input<string>? _secretManagerStoredClientKey;
        ...
        /// **Note**: This property is sensitive and will not be displayed in the plan.
        /// </summary>
        public Input<string>? SecretManagerStoredClientKey
        {
            get => _secretManagerStoredClientKey;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _secretManagerStoredClientKey = Output.Tuple<Input<string>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }

        public ConnectionProfileMongodbProfileSslConfigGetArgs()
        {
        }
        public static new ConnectionProfileMongodbProfileSslConfigGetArgs Empty => new ConnectionProfileMongodbProfileSslConfigGetArgs();
    }
}
