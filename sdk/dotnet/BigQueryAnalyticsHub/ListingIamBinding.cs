...
namespace Pulumi.Gcp.BigQueryAnalyticsHub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:bigqueryanalyticshub/listingIamBinding:ListingIamBinding")]
    public partial class ListingIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.ListingIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public ListingIamBinding(string name, ListingIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:bigqueryanalyticshub/listingIamBinding:ListingIamBinding", name, args ?? new ListingIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ListingIamBinding(string name, Input<string> id, ListingIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:bigqueryanalyticshub/listingIamBinding:ListingIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ListingIamBinding Get(string name, Input<string> id, ListingIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new ListingIamBinding(name, id, state, options);
        }
    }

    public sealed class ListingIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.ListingIamBindingConditionArgs>? Condition { get; set; }
        ...
        public ListingIamBindingArgs()
        {
        }
        public static new ListingIamBindingArgs Empty => new ListingIamBindingArgs();
    }

    public sealed class ListingIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.ListingIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public ListingIamBindingState()
        {
        }
        public static new ListingIamBindingState Empty => new ListingIamBindingState();
    }
}
