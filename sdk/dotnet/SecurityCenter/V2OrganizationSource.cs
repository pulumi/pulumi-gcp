...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    public partial class V2OrganizationSource : global::Pulumi.CustomResource
    {
        ...
        public V2OrganizationSource(string name, V2OrganizationSourceArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSource:V2OrganizationSource", name, args ?? new V2OrganizationSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private V2OrganizationSource(string name, Input<string> id, V2OrganizationSourceState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSource:V2OrganizationSource", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V2OrganizationSource Get(string name, Input<string> id, V2OrganizationSourceState? state = null, CustomResourceOptions? options = null)
        {
            return new V2OrganizationSource(name, id, state, options);
        }
    }

    public sealed class V2OrganizationSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The description of the source (max of 1024 characters).
        /// </summary>
        ...
        public V2OrganizationSourceArgs()
        {
        }
        public static new V2OrganizationSourceArgs Empty => new V2OrganizationSourceArgs();
    }

    public sealed class V2OrganizationSourceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The description of the source (max of 1024 characters).
        /// </summary>
        ...
        public V2OrganizationSourceState()
        {
        }
        public static new V2OrganizationSourceState Empty => new V2OrganizationSourceState();
    }
}
