...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    public partial class V2OrganizationSourceIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.V2OrganizationSourceIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public V2OrganizationSourceIamMember(string name, V2OrganizationSourceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSourceIamMember:V2OrganizationSourceIamMember", name, args ?? new V2OrganizationSourceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private V2OrganizationSourceIamMember(string name, Input<string> id, V2OrganizationSourceIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSourceIamMember:V2OrganizationSourceIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V2OrganizationSourceIamMember Get(string name, Input<string> id, V2OrganizationSourceIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new V2OrganizationSourceIamMember(name, id, state, options);
        }
    }

    public sealed class V2OrganizationSourceIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.V2OrganizationSourceIamMemberConditionArgs>? Condition { get; set; }
        ...
        public V2OrganizationSourceIamMemberArgs()
        {
        }
        public static new V2OrganizationSourceIamMemberArgs Empty => new V2OrganizationSourceIamMemberArgs();
    }

    public sealed class V2OrganizationSourceIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.V2OrganizationSourceIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public V2OrganizationSourceIamMemberState()
        {
        }
        public static new V2OrganizationSourceIamMemberState Empty => new V2OrganizationSourceIamMemberState();
    }
}
