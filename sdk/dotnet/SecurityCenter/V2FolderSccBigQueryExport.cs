...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:securitycenter/v2FolderSccBigQueryExport:V2FolderSccBigQueryExport")]
    public partial class V2FolderSccBigQueryExport : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public V2FolderSccBigQueryExport(string name, V2FolderSccBigQueryExportArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2FolderSccBigQueryExport:V2FolderSccBigQueryExport", name, args ?? new V2FolderSccBigQueryExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private V2FolderSccBigQueryExport(string name, Input<string> id, V2FolderSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2FolderSccBigQueryExport:V2FolderSccBigQueryExport", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V2FolderSccBigQueryExport Get(string name, Input<string> id, V2FolderSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
        {
            return new V2FolderSccBigQueryExport(name, id, state, options);
        }
    }

    public sealed class V2FolderSccBigQueryExportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.  It must consist of only lowercase letters,
        /// numbers, and hyphens, must start with a letter, must end with either a letter or a number,
        ...
        public V2FolderSccBigQueryExportArgs()
        {
        }
        public static new V2FolderSccBigQueryExportArgs Empty => new V2FolderSccBigQueryExportArgs();
    }

    public sealed class V2FolderSccBigQueryExportState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.  It must consist of only lowercase letters,
        /// numbers, and hyphens, must start with a letter, must end with either a letter or a number,
        ...
        public V2FolderSccBigQueryExportState()
        {
        }
        public static new V2FolderSccBigQueryExportState Empty => new V2FolderSccBigQueryExportState();
    }
}
