...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    /// 
    /// ```sh
    ///  $ pulumi import gcp:securitycenter/instanceIamBinding:InstanceIamBinding When using the [`terraform import` command](https://developer.hashicorp.com/terraform/cli/commands/import), Instance can be imported using one of the formats above. For example
    /// ```
    /// 
    /// ```sh
