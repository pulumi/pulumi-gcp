...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:securitycenter/projectSccBigQueryExport:ProjectSccBigQueryExport")]
    public partial class ProjectSccBigQueryExport : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ProjectSccBigQueryExport(string name, ProjectSccBigQueryExportArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/projectSccBigQueryExport:ProjectSccBigQueryExport", name, args ?? new ProjectSccBigQueryExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectSccBigQueryExport(string name, Input<string> id, ProjectSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/projectSccBigQueryExport:ProjectSccBigQueryExport", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProjectSccBigQueryExport Get(string name, Input<string> id, ProjectSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
        {
            return new ProjectSccBigQueryExport(name, id, state, options);
        }
    }

    public sealed class ProjectSccBigQueryExportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.
        /// </summary>
        ...
        public ProjectSccBigQueryExportArgs()
        {
        }
        public static new ProjectSccBigQueryExportArgs Empty => new ProjectSccBigQueryExportArgs();
    }

    public sealed class ProjectSccBigQueryExportState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.
        /// </summary>
        ...
        public ProjectSccBigQueryExportState()
        {
        }
        public static new ProjectSccBigQueryExportState Empty => new ProjectSccBigQueryExportState();
    }
}
