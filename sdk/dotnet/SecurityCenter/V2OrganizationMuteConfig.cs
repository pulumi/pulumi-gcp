...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:securitycenter/v2OrganizationMuteConfig:V2OrganizationMuteConfig")]
    public partial class V2OrganizationMuteConfig : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public V2OrganizationMuteConfig(string name, V2OrganizationMuteConfigArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationMuteConfig:V2OrganizationMuteConfig", name, args ?? new V2OrganizationMuteConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private V2OrganizationMuteConfig(string name, Input<string> id, V2OrganizationMuteConfigState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationMuteConfig:V2OrganizationMuteConfig", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V2OrganizationMuteConfig Get(string name, Input<string> id, V2OrganizationMuteConfigState? state = null, CustomResourceOptions? options = null)
        {
            return new V2OrganizationMuteConfig(name, id, state, options);
        }
    }

    public sealed class V2OrganizationMuteConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A description of the mute config.
        /// </summary>
        ...
        public V2OrganizationMuteConfigArgs()
        {
        }
        public static new V2OrganizationMuteConfigArgs Empty => new V2OrganizationMuteConfigArgs();
    }

    public sealed class V2OrganizationMuteConfigState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The time at which the mute config was created. This field is set by
        /// the server and will be ignored if provided on config creation.
        ...
        public V2OrganizationMuteConfigState()
        {
        }
        public static new V2OrganizationMuteConfigState Empty => new V2OrganizationMuteConfigState();
    }
}
