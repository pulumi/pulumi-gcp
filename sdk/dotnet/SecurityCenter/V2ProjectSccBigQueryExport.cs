...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:securitycenter/v2ProjectSccBigQueryExport:V2ProjectSccBigQueryExport")]
    public partial class V2ProjectSccBigQueryExport : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public V2ProjectSccBigQueryExport(string name, V2ProjectSccBigQueryExportArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2ProjectSccBigQueryExport:V2ProjectSccBigQueryExport", name, args ?? new V2ProjectSccBigQueryExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private V2ProjectSccBigQueryExport(string name, Input<string> id, V2ProjectSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2ProjectSccBigQueryExport:V2ProjectSccBigQueryExport", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V2ProjectSccBigQueryExport Get(string name, Input<string> id, V2ProjectSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
        {
            return new V2ProjectSccBigQueryExport(name, id, state, options);
        }
    }

    public sealed class V2ProjectSccBigQueryExportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.
        /// 
        ...
        public V2ProjectSccBigQueryExportArgs()
        {
        }
        public static new V2ProjectSccBigQueryExportArgs Empty => new V2ProjectSccBigQueryExportArgs();
    }

    public sealed class V2ProjectSccBigQueryExportState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.
        /// 
        ...
        public V2ProjectSccBigQueryExportState()
        {
        }
        public static new V2ProjectSccBigQueryExportState Empty => new V2ProjectSccBigQueryExportState();
    }
}
