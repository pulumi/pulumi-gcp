...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:securitycenter/managementOrganizationSecurityHealthAnalyticsCustomModule:ManagementOrganizationSecurityHealthAnalyticsCustomModule")]
    public partial class ManagementOrganizationSecurityHealthAnalyticsCustomModule : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("customConfig")]
        public Output<Outputs.ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfig?> CustomConfig { get; private set; } = null!;
        ...
        public ManagementOrganizationSecurityHealthAnalyticsCustomModule(string name, ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/managementOrganizationSecurityHealthAnalyticsCustomModule:ManagementOrganizationSecurityHealthAnalyticsCustomModule", name, args ?? new ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ManagementOrganizationSecurityHealthAnalyticsCustomModule(string name, Input<string> id, ManagementOrganizationSecurityHealthAnalyticsCustomModuleState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/managementOrganizationSecurityHealthAnalyticsCustomModule:ManagementOrganizationSecurityHealthAnalyticsCustomModule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ManagementOrganizationSecurityHealthAnalyticsCustomModule Get(string name, Input<string> id, ManagementOrganizationSecurityHealthAnalyticsCustomModuleState? state = null, CustomResourceOptions? options = null)
        {
            return new ManagementOrganizationSecurityHealthAnalyticsCustomModule(name, id, state, options);
        }
    }

    public sealed class ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The user specified custom configuration for the module.
        /// Structure is documented below.
        /// </summary>
        [Input("customConfig")]
        public Input<Inputs.ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs>? CustomConfig { get; set; }
        ...
        public ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs()
        {
        }
        public static new ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs Empty => new ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs();
    }

    public sealed class ManagementOrganizationSecurityHealthAnalyticsCustomModuleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// If empty, indicates that the custom module was created in the organization, folder,
        /// or project in which you are viewing the custom module. Otherwise, AncestorModule
        ...
        /// </summary>
        [Input("customConfig")]
        public Input<Inputs.ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigGetArgs>? CustomConfig { get; set; }
        ...
        public ManagementOrganizationSecurityHealthAnalyticsCustomModuleState()
        {
        }
        public static new ManagementOrganizationSecurityHealthAnalyticsCustomModuleState Empty => new ManagementOrganizationSecurityHealthAnalyticsCustomModuleState();
    }
}
