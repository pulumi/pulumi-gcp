...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:securitycenter/v2OrganizationSccBigQueryExport:V2OrganizationSccBigQueryExport")]
    public partial class V2OrganizationSccBigQueryExport : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public V2OrganizationSccBigQueryExport(string name, V2OrganizationSccBigQueryExportArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSccBigQueryExport:V2OrganizationSccBigQueryExport", name, args ?? new V2OrganizationSccBigQueryExportArgs(), MakeResourceOptions(options, ""))
        {
        }

        private V2OrganizationSccBigQueryExport(string name, Input<string> id, V2OrganizationSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSccBigQueryExport:V2OrganizationSccBigQueryExport", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V2OrganizationSccBigQueryExport Get(string name, Input<string> id, V2OrganizationSccBigQueryExportState? state = null, CustomResourceOptions? options = null)
        {
            return new V2OrganizationSccBigQueryExport(name, id, state, options);
        }
    }

    public sealed class V2OrganizationSccBigQueryExportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.
        /// 
        ...
        public V2OrganizationSccBigQueryExportArgs()
        {
        }
        public static new V2OrganizationSccBigQueryExportArgs Empty => new V2OrganizationSccBigQueryExportArgs();
    }

    public sealed class V2OrganizationSccBigQueryExportState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// This must be unique within the organization.
        /// 
        ...
        public V2OrganizationSccBigQueryExportState()
        {
        }
        public static new V2OrganizationSccBigQueryExportState Empty => new V2OrganizationSccBigQueryExportState();
    }
}
