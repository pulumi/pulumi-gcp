...
namespace Pulumi.Gcp.SecurityCenter
{
    ...
    ///  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
    /// </summary>
    [GcpResourceType("gcp:securitycenter/v2OrganizationSourceIamBinding:V2OrganizationSourceIamBinding")]
    public partial class V2OrganizationSourceIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.V2OrganizationSourceIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public V2OrganizationSourceIamBinding(string name, V2OrganizationSourceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSourceIamBinding:V2OrganizationSourceIamBinding", name, args ?? new V2OrganizationSourceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private V2OrganizationSourceIamBinding(string name, Input<string> id, V2OrganizationSourceIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securitycenter/v2OrganizationSourceIamBinding:V2OrganizationSourceIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static V2OrganizationSourceIamBinding Get(string name, Input<string> id, V2OrganizationSourceIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new V2OrganizationSourceIamBinding(name, id, state, options);
        }
    }

    public sealed class V2OrganizationSourceIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.V2OrganizationSourceIamBindingConditionArgs>? Condition { get; set; }
        ...
        public V2OrganizationSourceIamBindingArgs()
        {
        }
        public static new V2OrganizationSourceIamBindingArgs Empty => new V2OrganizationSourceIamBindingArgs();
    }

    public sealed class V2OrganizationSourceIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.V2OrganizationSourceIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public V2OrganizationSourceIamBindingState()
        {
        }
        public static new V2OrganizationSourceIamBindingState Empty => new V2OrganizationSourceIamBindingState();
    }
}
