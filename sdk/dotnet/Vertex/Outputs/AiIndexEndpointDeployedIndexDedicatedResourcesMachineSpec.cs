...
namespace Pulumi.Gcp.Vertex.Outputs
{
    ...
    [OutputType]
    public sealed class AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpec
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpec(string? machineType)
        {
