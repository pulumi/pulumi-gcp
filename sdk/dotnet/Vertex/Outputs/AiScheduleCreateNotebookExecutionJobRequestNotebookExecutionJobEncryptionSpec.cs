...
namespace Pulumi.Gcp.Vertex.Outputs
{
    ...
    [OutputType]
    public sealed class AiScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobEncryptionSpec
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AiScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobEncryptionSpec(string kmsKeyName)
        {
