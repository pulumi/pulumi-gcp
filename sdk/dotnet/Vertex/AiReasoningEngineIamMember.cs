...
namespace Pulumi.Gcp.Vertex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:vertex/aiReasoningEngineIamMember:AiReasoningEngineIamMember")]
    public partial class AiReasoningEngineIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.AiReasoningEngineIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public AiReasoningEngineIamMember(string name, AiReasoningEngineIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiReasoningEngineIamMember:AiReasoningEngineIamMember", name, args ?? new AiReasoningEngineIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AiReasoningEngineIamMember(string name, Input<string> id, AiReasoningEngineIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiReasoningEngineIamMember:AiReasoningEngineIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AiReasoningEngineIamMember Get(string name, Input<string> id, AiReasoningEngineIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new AiReasoningEngineIamMember(name, id, state, options);
        }
    }

    public sealed class AiReasoningEngineIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiReasoningEngineIamMemberConditionArgs>? Condition { get; set; }
        ...
        public AiReasoningEngineIamMemberArgs()
        {
        }
        public static new AiReasoningEngineIamMemberArgs Empty => new AiReasoningEngineIamMemberArgs();
    }

    public sealed class AiReasoningEngineIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiReasoningEngineIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public AiReasoningEngineIamMemberState()
        {
        }
        public static new AiReasoningEngineIamMemberState Empty => new AiReasoningEngineIamMemberState();
    }
}
