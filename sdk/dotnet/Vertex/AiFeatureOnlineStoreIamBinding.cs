...
namespace Pulumi.Gcp.Vertex
{
    ...
    public partial class AiFeatureOnlineStoreIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.AiFeatureOnlineStoreIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public AiFeatureOnlineStoreIamBinding(string name, AiFeatureOnlineStoreIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiFeatureOnlineStoreIamBinding:AiFeatureOnlineStoreIamBinding", name, args ?? new AiFeatureOnlineStoreIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AiFeatureOnlineStoreIamBinding(string name, Input<string> id, AiFeatureOnlineStoreIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiFeatureOnlineStoreIamBinding:AiFeatureOnlineStoreIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AiFeatureOnlineStoreIamBinding Get(string name, Input<string> id, AiFeatureOnlineStoreIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new AiFeatureOnlineStoreIamBinding(name, id, state, options);
        }
    }

    public sealed class AiFeatureOnlineStoreIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiFeatureOnlineStoreIamBindingConditionArgs>? Condition { get; set; }
        ...
        public AiFeatureOnlineStoreIamBindingArgs()
        {
        }
        public static new AiFeatureOnlineStoreIamBindingArgs Empty => new AiFeatureOnlineStoreIamBindingArgs();
    }

    public sealed class AiFeatureOnlineStoreIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiFeatureOnlineStoreIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public AiFeatureOnlineStoreIamBindingState()
        {
        }
        public static new AiFeatureOnlineStoreIamBindingState Empty => new AiFeatureOnlineStoreIamBindingState();
    }
}
