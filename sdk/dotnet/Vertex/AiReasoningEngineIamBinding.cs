...
namespace Pulumi.Gcp.Vertex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:vertex/aiReasoningEngineIamBinding:AiReasoningEngineIamBinding")]
    public partial class AiReasoningEngineIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.AiReasoningEngineIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public AiReasoningEngineIamBinding(string name, AiReasoningEngineIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiReasoningEngineIamBinding:AiReasoningEngineIamBinding", name, args ?? new AiReasoningEngineIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AiReasoningEngineIamBinding(string name, Input<string> id, AiReasoningEngineIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiReasoningEngineIamBinding:AiReasoningEngineIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AiReasoningEngineIamBinding Get(string name, Input<string> id, AiReasoningEngineIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new AiReasoningEngineIamBinding(name, id, state, options);
        }
    }

    public sealed class AiReasoningEngineIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiReasoningEngineIamBindingConditionArgs>? Condition { get; set; }
        ...
        public AiReasoningEngineIamBindingArgs()
        {
        }
        public static new AiReasoningEngineIamBindingArgs Empty => new AiReasoningEngineIamBindingArgs();
    }

    public sealed class AiReasoningEngineIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiReasoningEngineIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public AiReasoningEngineIamBindingState()
        {
        }
        public static new AiReasoningEngineIamBindingState Empty => new AiReasoningEngineIamBindingState();
    }
}
