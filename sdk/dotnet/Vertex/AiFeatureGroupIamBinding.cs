...
namespace Pulumi.Gcp.Vertex
{
    ...
    /// </summary>
    [GcpResourceType("gcp:vertex/aiFeatureGroupIamBinding:AiFeatureGroupIamBinding")]
    public partial class AiFeatureGroupIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.AiFeatureGroupIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public AiFeatureGroupIamBinding(string name, AiFeatureGroupIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiFeatureGroupIamBinding:AiFeatureGroupIamBinding", name, args ?? new AiFeatureGroupIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AiFeatureGroupIamBinding(string name, Input<string> id, AiFeatureGroupIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:vertex/aiFeatureGroupIamBinding:AiFeatureGroupIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AiFeatureGroupIamBinding Get(string name, Input<string> id, AiFeatureGroupIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new AiFeatureGroupIamBinding(name, id, state, options);
        }
    }

    public sealed class AiFeatureGroupIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiFeatureGroupIamBindingConditionArgs>? Condition { get; set; }
        ...
        public AiFeatureGroupIamBindingArgs()
        {
        }
        public static new AiFeatureGroupIamBindingArgs Empty => new AiFeatureGroupIamBindingArgs();
    }

    public sealed class AiFeatureGroupIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AiFeatureGroupIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public AiFeatureGroupIamBindingState()
        {
        }
        public static new AiFeatureGroupIamBindingState Empty => new AiFeatureGroupIamBindingState();
    }
}
