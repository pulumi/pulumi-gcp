...
namespace Pulumi.Gcp.Vertex.Inputs
{
    ...
    public sealed class AiEndpointWithModelGardenDeploymentEndpointConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.AiEndpointWithModelGardenDeploymentEndpointConfigPrivateServiceConnectConfigArgs>? PrivateServiceConnectConfig { get; set; }

        public AiEndpointWithModelGardenDeploymentEndpointConfigArgs()
        {
        }
        public static new AiEndpointWithModelGardenDeploymentEndpointConfigArgs Empty => new AiEndpointWithModelGardenDeploymentEndpointConfigArgs();
    }
}
