...
namespace Pulumi.Gcp.ContainerAnalysis
{
    ...
    /// </summary>
    [GcpResourceType("gcp:containeranalysis/noteIamMember:NoteIamMember")]
    public partial class NoteIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.NoteIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public NoteIamMember(string name, NoteIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:containeranalysis/noteIamMember:NoteIamMember", name, args ?? new NoteIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NoteIamMember(string name, Input<string> id, NoteIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:containeranalysis/noteIamMember:NoteIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NoteIamMember Get(string name, Input<string> id, NoteIamMemberState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.NoteIamMemberConditionArgs>? Condition { get; set; }
    ...
    public sealed class NoteIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.NoteIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public NoteIamMemberState()
        {
        }
        public static new NoteIamMemberState Empty => new NoteIamMemberState();
    }
}
