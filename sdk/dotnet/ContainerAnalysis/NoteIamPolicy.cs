...
namespace Pulumi.Gcp.ContainerAnalysis
{
    ...
    public partial class NoteIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public NoteIamPolicy(string name, NoteIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:containeranalysis/noteIamPolicy:NoteIamPolicy", name, args ?? new NoteIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NoteIamPolicy(string name, Input<string> id, NoteIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:containeranalysis/noteIamPolicy:NoteIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NoteIamPolicy Get(string name, Input<string> id, NoteIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new NoteIamPolicy(name, id, state, options);
        }
    }

    public sealed class NoteIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Used to find the parent resource to bind the IAM policy to
        /// </summary>
        ...
        public static new NoteIamPolicyArgs Empty => new NoteIamPolicyArgs();
    }

    public sealed class NoteIamPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Computed) The etag of the IAM policy.
        /// </summary>
        ...
        public NoteIamPolicyState()
        {
        }
        public static new NoteIamPolicyState Empty => new NoteIamPolicyState();
    }
}
