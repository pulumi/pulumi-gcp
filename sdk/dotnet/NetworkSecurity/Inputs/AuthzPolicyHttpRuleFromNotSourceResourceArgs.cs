...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyHttpRuleFromNotSourceResourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AuthzPolicyHttpRuleFromNotSourceResourceIamServiceAccountArgs>? IamServiceAccount { get; set; }
        ...
        /// </summary>
        [Input("tagValueIdSet")]
        public Input<Inputs.AuthzPolicyHttpRuleFromNotSourceResourceTagValueIdSetArgs>? TagValueIdSet { get; set; }
