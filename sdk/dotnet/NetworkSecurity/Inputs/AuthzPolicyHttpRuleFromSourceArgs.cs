...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyHttpRuleFromSourceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleFromSourcePrincipalArgs> Principals
        {
            get => _principals ?? (_principals = new InputList<Inputs.AuthzPolicyHttpRuleFromSourcePrincipalArgs>());
            set => _principals = value;
        }

        [Input("resources")]
        private InputList<Inputs.AuthzPolicyHttpRuleFromSourceResourceArgs>? _resources;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleFromSourceResourceArgs> Resources
        {
            get => _resources ?? (_resources = new InputList<Inputs.AuthzPolicyHttpRuleFromSourceResourceArgs>());
