...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    {
        [Input("ipBlocks")]
        private InputList<Inputs.AuthzPolicyHttpRuleFromSourceIpBlockGetArgs>? _ipBlocks;
        ...
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleFromSourceIpBlockGetArgs> IpBlocks
        {
            get => _ipBlocks ?? (_ipBlocks = new InputList<Inputs.AuthzPolicyHttpRuleFromSourceIpBlockGetArgs>());
            set => _ipBlocks = value;
        }
