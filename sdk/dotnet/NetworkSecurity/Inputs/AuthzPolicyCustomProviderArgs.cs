...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyCustomProviderArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AuthzPolicyCustomProviderAuthzExtensionArgs>? AuthzExtension { get; set; }
        ...
        /// </summary>
        [Input("cloudIap")]
        public Input<Inputs.AuthzPolicyCustomProviderCloudIapArgs>? CloudIap { get; set; }
