...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyNetworkRuleFromNotSourcePrincipalGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("principal")]
        public Input<Inputs.AuthzPolicyNetworkRuleFromNotSourcePrincipalPrincipalGetArgs>? Principal { get; set; }
        ...
        public AuthzPolicyNetworkRuleFromNotSourcePrincipalGetArgs()
        {
        }
        public static new AuthzPolicyNetworkRuleFromNotSourcePrincipalGetArgs Empty => new AuthzPolicyNetworkRuleFromNotSourcePrincipalGetArgs();
    }
}
