...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyHttpRuleFromSourceResourceGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AuthzPolicyHttpRuleFromSourceResourceIamServiceAccountGetArgs>? IamServiceAccount { get; set; }
        ...
        /// </summary>
        [Input("tagValueIdSet")]
        public Input<Inputs.AuthzPolicyHttpRuleFromSourceResourceTagValueIdSetGetArgs>? TagValueIdSet { get; set; }
