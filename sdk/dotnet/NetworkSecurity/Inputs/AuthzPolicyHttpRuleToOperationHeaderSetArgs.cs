...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    {
        [Input("headers")]
        private InputList<Inputs.AuthzPolicyHttpRuleToOperationHeaderSetHeaderArgs>? _headers;
        ...
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleToOperationHeaderSetHeaderArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.AuthzPolicyHttpRuleToOperationHeaderSetHeaderArgs>());
            set => _headers = value;
        }
