...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyHttpRuleToNotOperationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("headerSet")]
        public Input<Inputs.AuthzPolicyHttpRuleToNotOperationHeaderSetArgs>? HeaderSet { get; set; }

        [Input("hosts")]
        private InputList<Inputs.AuthzPolicyHttpRuleToNotOperationHostArgs>? _hosts;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleToNotOperationHostArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.AuthzPolicyHttpRuleToNotOperationHostArgs>());
            set => _hosts = value;
        }
        ...
        [Input("paths")]
        private InputList<Inputs.AuthzPolicyHttpRuleToNotOperationPathArgs>? _paths;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleToNotOperationPathArgs> Paths
        {
            get => _paths ?? (_paths = new InputList<Inputs.AuthzPolicyHttpRuleToNotOperationPathArgs>());
            set => _paths = value;
        }

        public AuthzPolicyHttpRuleToNotOperationArgs()
        {
        }
        public static new AuthzPolicyHttpRuleToNotOperationArgs Empty => new AuthzPolicyHttpRuleToNotOperationArgs();
    }
}
