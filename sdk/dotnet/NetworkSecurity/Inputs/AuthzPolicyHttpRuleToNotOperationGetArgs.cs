...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyHttpRuleToNotOperationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("headerSet")]
        public Input<Inputs.AuthzPolicyHttpRuleToNotOperationHeaderSetGetArgs>? HeaderSet { get; set; }

        [Input("hosts")]
        private InputList<Inputs.AuthzPolicyHttpRuleToNotOperationHostGetArgs>? _hosts;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleToNotOperationHostGetArgs> Hosts
        {
            get => _hosts ?? (_hosts = new InputList<Inputs.AuthzPolicyHttpRuleToNotOperationHostGetArgs>());
            set => _hosts = value;
        }
        ...
        [Input("paths")]
        private InputList<Inputs.AuthzPolicyHttpRuleToNotOperationPathGetArgs>? _paths;
        ...
        /// Structure is documented below.
        /// </summary>
        public InputList<Inputs.AuthzPolicyHttpRuleToNotOperationPathGetArgs> Paths
        {
            get => _paths ?? (_paths = new InputList<Inputs.AuthzPolicyHttpRuleToNotOperationPathGetArgs>());
            set => _paths = value;
        }

        public AuthzPolicyHttpRuleToNotOperationGetArgs()
        {
        }
        public static new AuthzPolicyHttpRuleToNotOperationGetArgs Empty => new AuthzPolicyHttpRuleToNotOperationGetArgs();
    }
}
