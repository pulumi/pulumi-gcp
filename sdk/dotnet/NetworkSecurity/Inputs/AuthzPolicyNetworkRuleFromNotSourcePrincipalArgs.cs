...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyNetworkRuleFromNotSourcePrincipalArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("principal")]
        public Input<Inputs.AuthzPolicyNetworkRuleFromNotSourcePrincipalPrincipalArgs>? Principal { get; set; }
        ...
        public AuthzPolicyNetworkRuleFromNotSourcePrincipalArgs()
        {
        }
        public static new AuthzPolicyNetworkRuleFromNotSourcePrincipalArgs Empty => new AuthzPolicyNetworkRuleFromNotSourcePrincipalArgs();
    }
}
