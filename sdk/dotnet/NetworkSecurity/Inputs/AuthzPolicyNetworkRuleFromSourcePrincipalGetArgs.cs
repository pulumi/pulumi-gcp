...
namespace Pulumi.Gcp.NetworkSecurity.Inputs
{
    ...
    public sealed class AuthzPolicyNetworkRuleFromSourcePrincipalGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("principal")]
        public Input<Inputs.AuthzPolicyNetworkRuleFromSourcePrincipalPrincipalGetArgs>? Principal { get; set; }
        ...
        public AuthzPolicyNetworkRuleFromSourcePrincipalGetArgs()
        {
        }
        public static new AuthzPolicyNetworkRuleFromSourcePrincipalGetArgs Empty => new AuthzPolicyNetworkRuleFromSourcePrincipalGetArgs();
    }
}
