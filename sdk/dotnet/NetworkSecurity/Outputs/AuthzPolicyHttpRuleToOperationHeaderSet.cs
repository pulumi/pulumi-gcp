...
namespace Pulumi.Gcp.NetworkSecurity.Outputs
{
    ...
    [OutputType]
    public sealed class AuthzPolicyHttpRuleToOperationHeaderSet
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.AuthzPolicyHttpRuleToOperationHeaderSetHeader> Headers;

        [OutputConstructor]
        private AuthzPolicyHttpRuleToOperationHeaderSet(ImmutableArray<Outputs.AuthzPolicyHttpRuleToOperationHeaderSetHeader> headers)
        {
            Headers = headers;
        }
    }
