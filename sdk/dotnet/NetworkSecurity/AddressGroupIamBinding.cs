...
namespace Pulumi.Gcp.NetworkSecurity
{
    ...
    /// </summary>
    [GcpResourceType("gcp:networksecurity/addressGroupIamBinding:AddressGroupIamBinding")]
    public partial class AddressGroupIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.AddressGroupIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public AddressGroupIamBinding(string name, AddressGroupIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:networksecurity/addressGroupIamBinding:AddressGroupIamBinding", name, args ?? new AddressGroupIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AddressGroupIamBinding(string name, Input<string> id, AddressGroupIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:networksecurity/addressGroupIamBinding:AddressGroupIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AddressGroupIamBinding Get(string name, Input<string> id, AddressGroupIamBindingState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.AddressGroupIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class AddressGroupIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.AddressGroupIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public AddressGroupIamBindingState()
        {
        }
        public static new AddressGroupIamBindingState Empty => new AddressGroupIamBindingState();
    }
}
