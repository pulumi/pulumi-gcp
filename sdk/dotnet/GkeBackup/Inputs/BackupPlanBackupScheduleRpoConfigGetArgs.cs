...
namespace Pulumi.Gcp.GkeBackup.Inputs
{
    ...
    public sealed class BackupPlanBackupScheduleRpoConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("exclusionWindows")]
        private InputList<Inputs.BackupPlanBackupScheduleRpoConfigExclusionWindowGetArgs>? _exclusionWindows;
        ...
        /// </summary>
        public InputList<Inputs.BackupPlanBackupScheduleRpoConfigExclusionWindowGetArgs> ExclusionWindows
        {
            get => _exclusionWindows ?? (_exclusionWindows = new InputList<Inputs.BackupPlanBackupScheduleRpoConfigExclusionWindowGetArgs>());
        ...
        public BackupPlanBackupScheduleRpoConfigGetArgs()
        {
        }
        public static new BackupPlanBackupScheduleRpoConfigGetArgs Empty => new BackupPlanBackupScheduleRpoConfigGetArgs();
    }
}
