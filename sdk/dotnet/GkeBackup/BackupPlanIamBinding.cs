...
namespace Pulumi.Gcp.GkeBackup
{
    ...
    /// </summary>
    [GcpResourceType("gcp:gkebackup/backupPlanIamBinding:BackupPlanIamBinding")]
    public partial class BackupPlanIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.BackupPlanIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public BackupPlanIamBinding(string name, BackupPlanIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:gkebackup/backupPlanIamBinding:BackupPlanIamBinding", name, args ?? new BackupPlanIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupPlanIamBinding(string name, Input<string> id, BackupPlanIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:gkebackup/backupPlanIamBinding:BackupPlanIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static BackupPlanIamBinding Get(string name, Input<string> id, BackupPlanIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new BackupPlanIamBinding(name, id, state, options);
        }
    }

    public sealed class BackupPlanIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.BackupPlanIamBindingConditionArgs>? Condition { get; set; }
        ...
        public BackupPlanIamBindingArgs()
        {
        }
        public static new BackupPlanIamBindingArgs Empty => new BackupPlanIamBindingArgs();
    }

    public sealed class BackupPlanIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.BackupPlanIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public BackupPlanIamBindingState()
        {
        }
        public static new BackupPlanIamBindingState Empty => new BackupPlanIamBindingState();
    }
}
