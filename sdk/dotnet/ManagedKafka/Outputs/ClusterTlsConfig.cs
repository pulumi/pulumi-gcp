...
namespace Pulumi.Gcp.ManagedKafka.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterTlsConfig
    {
        /// <summary>
        ...
        /// </summary>
        public readonly string? SslPrincipalMappingRules;
        /// <summary>
        /// The configuration of the broker truststore. If specified, clients can use mTLS for authentication.
        /// Structure is documented below.
        /// </summary>
        public readonly Outputs.ClusterTlsConfigTrustConfig? TrustConfig;

        [OutputConstructor]
        private ClusterTlsConfig(
            string? sslPrincipalMappingRules,

            Outputs.ClusterTlsConfigTrustConfig? trustConfig)
        {
