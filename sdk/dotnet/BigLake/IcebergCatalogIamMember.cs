...
namespace Pulumi.Gcp.BigLake
{
    ...
    /// </summary>
    [GcpResourceType("gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember")]
    public partial class IcebergCatalogIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.IcebergCatalogIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public IcebergCatalogIamMember(string name, IcebergCatalogIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember", name, args ?? new IcebergCatalogIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IcebergCatalogIamMember(string name, Input<string> id, IcebergCatalogIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IcebergCatalogIamMember Get(string name, Input<string> id, IcebergCatalogIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new IcebergCatalogIamMember(name, id, state, options);
        }
    }

    public sealed class IcebergCatalogIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.IcebergCatalogIamMemberConditionArgs>? Condition { get; set; }
        ...
        public IcebergCatalogIamMemberArgs()
        {
        }
        public static new IcebergCatalogIamMemberArgs Empty => new IcebergCatalogIamMemberArgs();
    }

    public sealed class IcebergCatalogIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.IcebergCatalogIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public IcebergCatalogIamMemberState()
        {
        }
        public static new IcebergCatalogIamMemberState Empty => new IcebergCatalogIamMemberState();
    }
}
