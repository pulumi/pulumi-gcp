...
namespace Pulumi.Gcp.BigLake
{
    ...
    /// </summary>
    [GcpResourceType("gcp:biglake/hiveDatabaseIamPolicy:HiveDatabaseIamPolicy")]
    public partial class HiveDatabaseIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public HiveDatabaseIamPolicy(string name, HiveDatabaseIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:biglake/hiveDatabaseIamPolicy:HiveDatabaseIamPolicy", name, args ?? new HiveDatabaseIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HiveDatabaseIamPolicy(string name, Input<string> id, HiveDatabaseIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:biglake/hiveDatabaseIamPolicy:HiveDatabaseIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HiveDatabaseIamPolicy Get(string name, Input<string> id, HiveDatabaseIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new HiveDatabaseIamPolicy(name, id, state, options);
        }
    }

    public sealed class HiveDatabaseIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Hive catalog where the database to create is located.
        /// Used to find the parent resource to bind the IAM policy to
        ...
        public HiveDatabaseIamPolicyArgs()
        {
        }
        public static new HiveDatabaseIamPolicyArgs Empty => new HiveDatabaseIamPolicyArgs();
    }

    public sealed class HiveDatabaseIamPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Hive catalog where the database to create is located.
        /// Used to find the parent resource to bind the IAM policy to
        ...
        public HiveDatabaseIamPolicyState()
        {
        }
        public static new HiveDatabaseIamPolicyState Empty => new HiveDatabaseIamPolicyState();
    }
}
