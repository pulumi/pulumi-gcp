...
namespace Pulumi.Gcp.BigLake
{
    ...
    /// </summary>
    [GcpResourceType("gcp:biglake/icebergTableIamPolicy:IcebergTableIamPolicy")]
    public partial class IcebergTableIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IcebergTableIamPolicy(string name, IcebergTableIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:biglake/icebergTableIamPolicy:IcebergTableIamPolicy", name, args ?? new IcebergTableIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IcebergTableIamPolicy(string name, Input<string> id, IcebergTableIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:biglake/icebergTableIamPolicy:IcebergTableIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IcebergTableIamPolicy Get(string name, Input<string> id, IcebergTableIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new IcebergTableIamPolicy(name, id, state, options);
        }
    }

    public sealed class IcebergTableIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the IcebergCatalog.
        /// Used to find the parent resource to bind the IAM policy to
        ...
        public IcebergTableIamPolicyArgs()
        {
        }
        public static new IcebergTableIamPolicyArgs Empty => new IcebergTableIamPolicyArgs();
    }

    public sealed class IcebergTableIamPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the IcebergCatalog.
        /// Used to find the parent resource to bind the IAM policy to
        ...
        public IcebergTableIamPolicyState()
        {
        }
        public static new IcebergTableIamPolicyState Empty => new IcebergTableIamPolicyState();
    }
}
