...
namespace Pulumi.Gcp.BigLake
{
    ...
    /// </summary>
    [GcpResourceType("gcp:biglake/hiveCatalogIamPolicy:HiveCatalogIamPolicy")]
    public partial class HiveCatalogIamPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public HiveCatalogIamPolicy(string name, HiveCatalogIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:biglake/hiveCatalogIamPolicy:HiveCatalogIamPolicy", name, args ?? new HiveCatalogIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HiveCatalogIamPolicy(string name, Input<string> id, HiveCatalogIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:biglake/hiveCatalogIamPolicy:HiveCatalogIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HiveCatalogIamPolicy Get(string name, Input<string> id, HiveCatalogIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new HiveCatalogIamPolicy(name, id, state, options);
        }
    }

    public sealed class HiveCatalogIamPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Used to find the parent resource to bind the IAM policy to
        /// </summary>
        ...
        public HiveCatalogIamPolicyArgs()
        {
        }
        public static new HiveCatalogIamPolicyArgs Empty => new HiveCatalogIamPolicyArgs();
    }

    public sealed class HiveCatalogIamPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Computed) The etag of the IAM policy.
        /// </summary>
        ...
        public HiveCatalogIamPolicyState()
        {
        }
        public static new HiveCatalogIamPolicyState Empty => new HiveCatalogIamPolicyState();
    }
}
