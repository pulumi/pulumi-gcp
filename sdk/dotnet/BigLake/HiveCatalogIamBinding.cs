...
namespace Pulumi.Gcp.BigLake
{
    ...
    /// </summary>
    [GcpResourceType("gcp:biglake/hiveCatalogIamBinding:HiveCatalogIamBinding")]
    public partial class HiveCatalogIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.HiveCatalogIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public HiveCatalogIamBinding(string name, HiveCatalogIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:biglake/hiveCatalogIamBinding:HiveCatalogIamBinding", name, args ?? new HiveCatalogIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HiveCatalogIamBinding(string name, Input<string> id, HiveCatalogIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:biglake/hiveCatalogIamBinding:HiveCatalogIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HiveCatalogIamBinding Get(string name, Input<string> id, HiveCatalogIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new HiveCatalogIamBinding(name, id, state, options);
        }
    }

    public sealed class HiveCatalogIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.HiveCatalogIamBindingConditionArgs>? Condition { get; set; }
        ...
        public HiveCatalogIamBindingArgs()
        {
        }
        public static new HiveCatalogIamBindingArgs Empty => new HiveCatalogIamBindingArgs();
    }

    public sealed class HiveCatalogIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.HiveCatalogIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public HiveCatalogIamBindingState()
        {
        }
        public static new HiveCatalogIamBindingState Empty => new HiveCatalogIamBindingState();
    }
}
