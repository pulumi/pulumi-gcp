...
namespace Pulumi.Gcp.DocumentAi
{
    /// <summary>
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:documentai/schema:Schema")]
    public partial class Schema : global::Pulumi.CustomResource
    {
        ...
        public Schema(string name, SchemaArgs args, CustomResourceOptions? options = null)
            : base("gcp:documentai/schema:Schema", name, args ?? new SchemaArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Schema(string name, Input<string> id, SchemaState? state = null, CustomResourceOptions? options = null)
            : base("gcp:documentai/schema:Schema", name, state, MakeResourceOptions(options, id))
        {
        }
