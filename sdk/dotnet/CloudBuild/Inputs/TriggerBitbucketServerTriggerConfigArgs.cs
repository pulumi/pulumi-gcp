...
namespace Pulumi.Gcp.CloudBuild.Inputs
{
    ...
    public sealed class TriggerBitbucketServerTriggerConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("pullRequest")]
        public Input<Inputs.TriggerBitbucketServerTriggerConfigPullRequestArgs>? PullRequest { get; set; }
        ...
        /// </summary>
        [Input("push")]
        public Input<Inputs.TriggerBitbucketServerTriggerConfigPushArgs>? Push { get; set; }
        ...
        public TriggerBitbucketServerTriggerConfigArgs()
        {
        }
        public static new TriggerBitbucketServerTriggerConfigArgs Empty => new TriggerBitbucketServerTriggerConfigArgs();
    }
}
