...
namespace Pulumi.Gcp.CloudBuild.Inputs
{
    ...
    public sealed class TriggerBuildOptionsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("volumes")]
        private InputList<Inputs.TriggerBuildOptionsVolumeArgs>? _volumes;
        ...
        /// </summary>
        public InputList<Inputs.TriggerBuildOptionsVolumeArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.TriggerBuildOptionsVolumeArgs>());
            set => _volumes = value;
        }
        ...
        public static new TriggerBuildOptionsArgs Empty => new TriggerBuildOptionsArgs();
    }
}
