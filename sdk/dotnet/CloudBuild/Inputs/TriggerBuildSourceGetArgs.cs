...
namespace Pulumi.Gcp.CloudBuild.Inputs
{
    ...
    public sealed class TriggerBuildSourceGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("repoSource")]
        public Input<Inputs.TriggerBuildSourceRepoSourceGetArgs>? RepoSource { get; set; }
        ...
        /// </summary>
        [Input("storageSource")]
        public Input<Inputs.TriggerBuildSourceStorageSourceGetArgs>? StorageSource { get; set; }
