...
namespace Pulumi.Gcp.DatabaseMigrationService
{
    ...
    ///     });
    /// 
    ///     var defaultPrivateConnection = new Gcp.DatabaseMigrationService.PrivateConnection("defaultPrivateConnection", new()
    ///     {
    ///         DisplayName = "dbms_pc",
    ...
    ///         {
    ///             VpcName = defaultNetwork.Apply(getNetworkResult =&gt; getNetworkResult.Id),
    ///             Subnet = "10.0.0.0/29",
    ///         },
    ///     });
    /// 
    ...
    /// 
    /// ```sh
    ///  $ pulumi import gcp:databasemigrationservice/privateConnection:PrivateConnection When using the [`terraform import` command](https://developer.hashicorp.com/terraform/cli/commands/import), PrivateConnection can be imported using one of the formats above. For example
    /// ```
    /// 
    /// ```sh
