...
namespace Pulumi.Gcp.Transcoder.Inputs
{
    ...
    public sealed class JobConfigMuxStreamGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.JobConfigMuxStreamSegmentSettingsGetArgs>? SegmentSettings { get; set; }

        public JobConfigMuxStreamGetArgs()
        {
        }
        public static new JobConfigMuxStreamGetArgs Empty => new JobConfigMuxStreamGetArgs();
    }
}
