...
namespace Pulumi.Gcp.Transcoder.Inputs
{
    ...
    public sealed class JobConfigEditListArgs : global::Pulumi.ResourceArgs
    {
        [Input("inputs")]
        ...
        public JobConfigEditListArgs()
        {
        }
        public static new JobConfigEditListArgs Empty => new JobConfigEditListArgs();
    }
}
