...
namespace Pulumi.Gcp.CloudBuildV2
{
    ...
    /// </summary>
    [GcpResourceType("gcp:cloudbuildv2/connectionIAMBinding:ConnectionIAMBinding")]
    public partial class ConnectionIAMBinding : global::Pulumi.CustomResource
    {
        ...
        public ConnectionIAMBinding(string name, ConnectionIAMBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:cloudbuildv2/connectionIAMBinding:ConnectionIAMBinding", name, args ?? new ConnectionIAMBindingArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ConnectionIAMBinding(string name, Input<string> id, ConnectionIAMBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:cloudbuildv2/connectionIAMBinding:ConnectionIAMBinding", name, state, MakeResourceOptions(options, id))
        {
        }
