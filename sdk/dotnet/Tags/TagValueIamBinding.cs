...
namespace Pulumi.Gcp.Tags
{
    ...
    ///  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
    /// </summary>
    [GcpResourceType("gcp:tags/tagValueIamBinding:TagValueIamBinding")]
    public partial class TagValueIamBinding : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.TagValueIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public TagValueIamBinding(string name, TagValueIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:tags/tagValueIamBinding:TagValueIamBinding", name, args ?? new TagValueIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagValueIamBinding(string name, Input<string> id, TagValueIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:tags/tagValueIamBinding:TagValueIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TagValueIamBinding Get(string name, Input<string> id, TagValueIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new TagValueIamBinding(name, id, state, options);
        }
    }

    public sealed class TagValueIamBindingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.TagValueIamBindingConditionArgs>? Condition { get; set; }
        ...
        public static new TagValueIamBindingArgs Empty => new TagValueIamBindingArgs();
    }

    public sealed class TagValueIamBindingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.TagValueIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public static new TagValueIamBindingState Empty => new TagValueIamBindingState();
    }
}
