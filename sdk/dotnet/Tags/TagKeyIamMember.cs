...
namespace Pulumi.Gcp.Tags
{
    ...
    /// </summary>
    [GcpResourceType("gcp:tags/tagKeyIamMember:TagKeyIamMember")]
    public partial class TagKeyIamMember : Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.TagKeyIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public TagKeyIamMember(string name, TagKeyIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:tags/tagKeyIamMember:TagKeyIamMember", name, args ?? new TagKeyIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagKeyIamMember(string name, Input<string> id, TagKeyIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:tags/tagKeyIamMember:TagKeyIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TagKeyIamMember Get(string name, Input<string> id, TagKeyIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new TagKeyIamMember(name, id, state, options);
        }
    }

    public sealed class TagKeyIamMemberArgs : Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.TagKeyIamMemberConditionArgs>? Condition { get; set; }
    ...
    public sealed class TagKeyIamMemberState : Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.TagKeyIamMemberConditionGetArgs>? Condition { get; set; }
