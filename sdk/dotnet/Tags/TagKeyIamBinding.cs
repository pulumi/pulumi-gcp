...
namespace Pulumi.Gcp.Tags
{
    ...
    /// </summary>
    [GcpResourceType("gcp:tags/tagKeyIamBinding:TagKeyIamBinding")]
    public partial class TagKeyIamBinding : Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.TagKeyIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public TagKeyIamBinding(string name, TagKeyIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:tags/tagKeyIamBinding:TagKeyIamBinding", name, args ?? new TagKeyIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TagKeyIamBinding(string name, Input<string> id, TagKeyIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:tags/tagKeyIamBinding:TagKeyIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TagKeyIamBinding Get(string name, Input<string> id, TagKeyIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new TagKeyIamBinding(name, id, state, options);
        }
    }

    public sealed class TagKeyIamBindingArgs : Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.TagKeyIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class TagKeyIamBindingState : Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.TagKeyIamBindingConditionGetArgs>? Condition { get; set; }
