...
namespace Pulumi.Gcp.Endpoints
{
    ...
    public partial class ServiceIamMember : Pulumi.CustomResource
    {
        ...
        public ServiceIamMember(string name, ServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:endpoints/serviceIamMember:ServiceIamMember", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class ServiceIamMemberConditionArgs : Pulumi.ResourceArgs
    {
        [Input("description")]
    ...
    public sealed class ServiceIamMemberConditionGetArgs : Pulumi.ResourceArgs
    {
        [Input("description")]
        public Input<string>? Description { get; set; }
