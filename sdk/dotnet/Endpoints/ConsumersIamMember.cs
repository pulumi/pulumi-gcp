...
namespace Pulumi.Gcp.Endpoints
{
    ...
    /// </summary>
    [GcpResourceType("gcp:endpoints/consumersIamMember:ConsumersIamMember")]
    public partial class ConsumersIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        ...
        public ConsumersIamMember(string name, ConsumersIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:endpoints/consumersIamMember:ConsumersIamMember", name, args ?? new ConsumersIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ConsumersIamMember(string name, Input<string> id, ConsumersIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:endpoints/consumersIamMember:ConsumersIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ConsumersIamMember Get(string name, Input<string> id, ConsumersIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new ConsumersIamMember(name, id, state, options);
        }
    }

    public sealed class ConsumersIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        ...
        public ConsumersIamMemberArgs()
        {
        }
        public static new ConsumersIamMemberArgs Empty => new ConsumersIamMemberArgs();
    }

    public sealed class ConsumersIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        ...
        public ConsumersIamMemberState()
        {
        }
        public static new ConsumersIamMemberState Empty => new ConsumersIamMemberState();
    }
}
