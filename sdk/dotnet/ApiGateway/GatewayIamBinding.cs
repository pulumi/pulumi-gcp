...
namespace Pulumi.Gcp.ApiGateway
{
    ...
    /// </summary>
    [GcpResourceType("gcp:apigateway/gatewayIamBinding:GatewayIamBinding")]
    public partial class GatewayIamBinding : Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.GatewayIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public GatewayIamBinding(string name, GatewayIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:apigateway/gatewayIamBinding:GatewayIamBinding", name, args ?? new GatewayIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayIamBinding(string name, Input<string> id, GatewayIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:apigateway/gatewayIamBinding:GatewayIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GatewayIamBinding Get(string name, Input<string> id, GatewayIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new GatewayIamBinding(name, id, state, options);
        }
    }

    public sealed class GatewayIamBindingArgs : Pulumi.ResourceArgs
    {
        [Input("condition")]
    ...
    public sealed class GatewayIamBindingState : Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.GatewayIamBindingConditionGetArgs>? Condition { get; set; }
