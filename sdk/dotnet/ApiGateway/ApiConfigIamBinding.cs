...
namespace Pulumi.Gcp.ApiGateway
{
    ...
    public partial class ApiConfigIamBinding : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class ApiConfigIamBindingArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The API to attach the config to.
        /// Used to find the parent resource to bind the IAM policy to
    ...
    public sealed class ApiConfigIamBindingState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The API to attach the config to.
        /// Used to find the parent resource to bind the IAM policy to
