...
namespace Pulumi.Gcp.CloudFunctionsV2
{
    ...
    /// </summary>
    [GcpResourceType("gcp:cloudfunctionsv2/functionIamPolicy:FunctionIamPolicy")]
    public partial class FunctionIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public FunctionIamPolicy(string name, FunctionIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:cloudfunctionsv2/functionIamPolicy:FunctionIamPolicy", name, args ?? new FunctionIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private FunctionIamPolicy(string name, Input<string> id, FunctionIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:cloudfunctionsv2/functionIamPolicy:FunctionIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
