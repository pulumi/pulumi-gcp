...
namespace Pulumi.Gcp.CloudFunctionsV2.Outputs
{
    ...
    [OutputType]
    public sealed class FunctionServiceConfigSecretVolume
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.FunctionServiceConfigSecretVolumeVersion> Versions;
        ...
        private FunctionServiceConfigSecretVolume(
            ...
            ImmutableArray<Outputs.FunctionServiceConfigSecretVolumeVersion> versions)
        {
            MountPath = mountPath;
            ProjectId = projectId;
            Secret = secret;
