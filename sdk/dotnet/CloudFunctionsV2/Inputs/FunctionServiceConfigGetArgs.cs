...
namespace Pulumi.Gcp.CloudFunctionsV2.Inputs
{
    ...
    public sealed class FunctionServiceConfigGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("directVpcEgress")]
        public Input<string>? DirectVpcEgress { get; set; }

        [Input("directVpcNetworkInterfaces")]
        ...
        /// </summary>
        public InputList<Inputs.FunctionServiceConfigDirectVpcNetworkInterfaceGetArgs> DirectVpcNetworkInterfaces
        {
            get => _directVpcNetworkInterfaces ?? (_directVpcNetworkInterfaces = new InputList<Inputs.FunctionServiceConfigDirectVpcNetworkInterfaceGetArgs>());
            set => _directVpcNetworkInterfaces = value;
        }
