...
namespace Pulumi.Gcp.Iap
{
    ...
    /// </summary>
    [GcpResourceType("gcp:iap/agentRegistryIamBinding:AgentRegistryIamBinding")]
    public partial class AgentRegistryIamBinding : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.AgentRegistryIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public AgentRegistryIamBinding(string name, AgentRegistryIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:iap/agentRegistryIamBinding:AgentRegistryIamBinding", name, args ?? new AgentRegistryIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentRegistryIamBinding(string name, Input<string> id, AgentRegistryIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iap/agentRegistryIamBinding:AgentRegistryIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AgentRegistryIamBinding Get(string name, Input<string> id, AgentRegistryIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new AgentRegistryIamBinding(name, id, state, options);
        }
    }

    public sealed class AgentRegistryIamBindingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.AgentRegistryIamBindingConditionArgs>? Condition { get; set; }
        ...
        public AgentRegistryIamBindingArgs()
        {
        }
        public static new AgentRegistryIamBindingArgs Empty => new AgentRegistryIamBindingArgs();
    }

    public sealed class AgentRegistryIamBindingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.AgentRegistryIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public AgentRegistryIamBindingState()
        {
        }
        public static new AgentRegistryIamBindingState Empty => new AgentRegistryIamBindingState();
    }
}
