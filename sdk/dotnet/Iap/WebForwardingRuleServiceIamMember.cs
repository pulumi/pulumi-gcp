...
namespace Pulumi.Gcp.Iap
{
    ...
    /// </summary>
    [GcpResourceType("gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember")]
    public partial class WebForwardingRuleServiceIamMember : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.WebForwardingRuleServiceIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public WebForwardingRuleServiceIamMember(string name, WebForwardingRuleServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember", name, args ?? new WebForwardingRuleServiceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebForwardingRuleServiceIamMember(string name, Input<string> id, WebForwardingRuleServiceIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WebForwardingRuleServiceIamMember Get(string name, Input<string> id, WebForwardingRuleServiceIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new WebForwardingRuleServiceIamMember(name, id, state, options);
        }
    }

    public sealed class WebForwardingRuleServiceIamMemberArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.WebForwardingRuleServiceIamMemberConditionArgs>? Condition { get; set; }
        ...
        public WebForwardingRuleServiceIamMemberArgs()
        {
        }
        public static new WebForwardingRuleServiceIamMemberArgs Empty => new WebForwardingRuleServiceIamMemberArgs();
    }

    public sealed class WebForwardingRuleServiceIamMemberState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.WebForwardingRuleServiceIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public WebForwardingRuleServiceIamMemberState()
        {
        }
        public static new WebForwardingRuleServiceIamMemberState Empty => new WebForwardingRuleServiceIamMemberState();
    }
}
