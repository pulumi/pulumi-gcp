...
namespace Pulumi.Gcp.Iap
{
    ...
    /// </summary>
    [GcpResourceType("gcp:iap/locationWebIamMember:LocationWebIamMember")]
    public partial class LocationWebIamMember : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.LocationWebIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public LocationWebIamMember(string name, LocationWebIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:iap/locationWebIamMember:LocationWebIamMember", name, args ?? new LocationWebIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocationWebIamMember(string name, Input<string> id, LocationWebIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iap/locationWebIamMember:LocationWebIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocationWebIamMember Get(string name, Input<string> id, LocationWebIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new LocationWebIamMember(name, id, state, options);
        }
    }

    public sealed class LocationWebIamMemberArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.LocationWebIamMemberConditionArgs>? Condition { get; set; }
        ...
        public LocationWebIamMemberArgs()
        {
        }
        public static new LocationWebIamMemberArgs Empty => new LocationWebIamMemberArgs();
    }

    public sealed class LocationWebIamMemberState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.LocationWebIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public LocationWebIamMemberState()
        {
        }
        public static new LocationWebIamMemberState Empty => new LocationWebIamMemberState();
    }
}
