...
namespace Pulumi.Gcp.Iap
{
    ...
    /// </summary>
    [GcpResourceType("gcp:iap/locationWebIamBinding:LocationWebIamBinding")]
    public partial class LocationWebIamBinding : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.LocationWebIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public LocationWebIamBinding(string name, LocationWebIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:iap/locationWebIamBinding:LocationWebIamBinding", name, args ?? new LocationWebIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocationWebIamBinding(string name, Input<string> id, LocationWebIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iap/locationWebIamBinding:LocationWebIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocationWebIamBinding Get(string name, Input<string> id, LocationWebIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new LocationWebIamBinding(name, id, state, options);
        }
    }

    public sealed class LocationWebIamBindingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.LocationWebIamBindingConditionArgs>? Condition { get; set; }
        ...
        public LocationWebIamBindingArgs()
        {
        }
        public static new LocationWebIamBindingArgs Empty => new LocationWebIamBindingArgs();
    }

    public sealed class LocationWebIamBindingState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.LocationWebIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public LocationWebIamBindingState()
        {
        }
        public static new LocationWebIamBindingState Empty => new LocationWebIamBindingState();
    }
}
