...
namespace Pulumi.Gcp.Iap
{
    ...
    public partial class TunnelIamMember : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.TunnelIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public TunnelIamMember(string name, TunnelIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:iap/tunnelIamMember:TunnelIamMember", name, args ?? new TunnelIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TunnelIamMember(string name, Input<string> id, TunnelIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iap/tunnelIamMember:TunnelIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TunnelIamMember Get(string name, Input<string> id, TunnelIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new TunnelIamMember(name, id, state, options);
        }
    }

    public sealed class TunnelIamMemberArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.TunnelIamMemberConditionArgs>? Condition { get; set; }
        ...
        public static new TunnelIamMemberArgs Empty => new TunnelIamMemberArgs();
    }

    public sealed class TunnelIamMemberState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.TunnelIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public static new TunnelIamMemberState Empty => new TunnelIamMemberState();
    }
}
