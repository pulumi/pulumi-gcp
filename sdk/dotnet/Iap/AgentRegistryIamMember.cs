...
namespace Pulumi.Gcp.Iap
{
    ...
    /// </summary>
    [GcpResourceType("gcp:iap/agentRegistryIamMember:AgentRegistryIamMember")]
    public partial class AgentRegistryIamMember : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.AgentRegistryIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public AgentRegistryIamMember(string name, AgentRegistryIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:iap/agentRegistryIamMember:AgentRegistryIamMember", name, args ?? new AgentRegistryIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AgentRegistryIamMember(string name, Input<string> id, AgentRegistryIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iap/agentRegistryIamMember:AgentRegistryIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AgentRegistryIamMember Get(string name, Input<string> id, AgentRegistryIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new AgentRegistryIamMember(name, id, state, options);
        }
    }

    public sealed class AgentRegistryIamMemberArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.AgentRegistryIamMemberConditionArgs>? Condition { get; set; }
        ...
        public AgentRegistryIamMemberArgs()
        {
        }
        public static new AgentRegistryIamMemberArgs Empty => new AgentRegistryIamMemberArgs();
    }

    public sealed class AgentRegistryIamMemberState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.AgentRegistryIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public AgentRegistryIamMemberState()
        {
        }
        public static new AgentRegistryIamMemberState Empty => new AgentRegistryIamMemberState();
    }
}
