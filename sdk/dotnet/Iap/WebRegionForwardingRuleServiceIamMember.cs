...
namespace Pulumi.Gcp.Iap
{
    ...
    /// </summary>
    [GcpResourceType("gcp:iap/webRegionForwardingRuleServiceIamMember:WebRegionForwardingRuleServiceIamMember")]
    public partial class WebRegionForwardingRuleServiceIamMember : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("condition")]
        public Output<Outputs.WebRegionForwardingRuleServiceIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public WebRegionForwardingRuleServiceIamMember(string name, WebRegionForwardingRuleServiceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:iap/webRegionForwardingRuleServiceIamMember:WebRegionForwardingRuleServiceIamMember", name, args ?? new WebRegionForwardingRuleServiceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WebRegionForwardingRuleServiceIamMember(string name, Input<string> id, WebRegionForwardingRuleServiceIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iap/webRegionForwardingRuleServiceIamMember:WebRegionForwardingRuleServiceIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WebRegionForwardingRuleServiceIamMember Get(string name, Input<string> id, WebRegionForwardingRuleServiceIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new WebRegionForwardingRuleServiceIamMember(name, id, state, options);
        }
    }

    public sealed class WebRegionForwardingRuleServiceIamMemberArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.WebRegionForwardingRuleServiceIamMemberConditionArgs>? Condition { get; set; }
        ...
        public WebRegionForwardingRuleServiceIamMemberArgs()
        {
        }
        public static new WebRegionForwardingRuleServiceIamMemberArgs Empty => new WebRegionForwardingRuleServiceIamMemberArgs();
    }

    public sealed class WebRegionForwardingRuleServiceIamMemberState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        /// </summary>
        [Input("condition")]
        public Input<Inputs.WebRegionForwardingRuleServiceIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public WebRegionForwardingRuleServiceIamMemberState()
        {
        }
        public static new WebRegionForwardingRuleServiceIamMemberState Empty => new WebRegionForwardingRuleServiceIamMemberState();
    }
}
