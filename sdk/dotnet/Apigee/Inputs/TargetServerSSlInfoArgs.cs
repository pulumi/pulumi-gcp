...
namespace Pulumi.Gcp.Apigee.Inputs
{
    ...
    public sealed class TargetServerSSlInfoArgs : global::Pulumi.ResourceArgs
    {
        [Input("ciphers")]
        ...
        /// </summary>
        [Input("commonName")]
        public Input<Inputs.TargetServerSSlInfoCommonNameArgs>? CommonName { get; set; }
        ...
        public TargetServerSSlInfoArgs()
        {
        }
        public static new TargetServerSSlInfoArgs Empty => new TargetServerSSlInfoArgs();
    }
}
