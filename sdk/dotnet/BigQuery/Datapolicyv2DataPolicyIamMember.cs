...
namespace Pulumi.Gcp.BigQuery
{
    ...
    /// </summary>
    [GcpResourceType("gcp:bigquery/datapolicyv2DataPolicyIamMember:Datapolicyv2DataPolicyIamMember")]
    public partial class Datapolicyv2DataPolicyIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.Datapolicyv2DataPolicyIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public Datapolicyv2DataPolicyIamMember(string name, Datapolicyv2DataPolicyIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:bigquery/datapolicyv2DataPolicyIamMember:Datapolicyv2DataPolicyIamMember", name, args ?? new Datapolicyv2DataPolicyIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Datapolicyv2DataPolicyIamMember(string name, Input<string> id, Datapolicyv2DataPolicyIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:bigquery/datapolicyv2DataPolicyIamMember:Datapolicyv2DataPolicyIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Datapolicyv2DataPolicyIamMember Get(string name, Input<string> id, Datapolicyv2DataPolicyIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new Datapolicyv2DataPolicyIamMember(name, id, state, options);
        }
    }

    public sealed class Datapolicyv2DataPolicyIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.Datapolicyv2DataPolicyIamMemberConditionArgs>? Condition { get; set; }
        ...
        public Datapolicyv2DataPolicyIamMemberArgs()
        {
        }
        public static new Datapolicyv2DataPolicyIamMemberArgs Empty => new Datapolicyv2DataPolicyIamMemberArgs();
    }

    public sealed class Datapolicyv2DataPolicyIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.Datapolicyv2DataPolicyIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public Datapolicyv2DataPolicyIamMemberState()
        {
        }
        public static new Datapolicyv2DataPolicyIamMemberState Empty => new Datapolicyv2DataPolicyIamMemberState();
    }
}
