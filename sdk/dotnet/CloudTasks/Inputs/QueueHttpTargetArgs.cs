...
namespace Pulumi.Gcp.CloudTasks.Inputs
{
    ...
    public sealed class QueueHttpTargetArgs : global::Pulumi.ResourceArgs
    {
        [Input("headerOverrides")]
        private InputList<Inputs.QueueHttpTargetHeaderOverrideArgs>? _headerOverrides;
        ...
        /// </summary>
        public InputList<Inputs.QueueHttpTargetHeaderOverrideArgs> HeaderOverrides
        {
            get => _headerOverrides ?? (_headerOverrides = new InputList<Inputs.QueueHttpTargetHeaderOverrideArgs>());
        ...
        /// </summary>
        [Input("oauthToken")]
        public Input<Inputs.QueueHttpTargetOauthTokenArgs>? OauthToken { get; set; }
        ...
        /// </summary>
        [Input("oidcToken")]
        public Input<Inputs.QueueHttpTargetOidcTokenArgs>? OidcToken { get; set; }
        ...
        /// </summary>
        [Input("uriOverride")]
        public Input<Inputs.QueueHttpTargetUriOverrideArgs>? UriOverride { get; set; }

        public QueueHttpTargetArgs()
        {
        }
        public static new QueueHttpTargetArgs Empty => new QueueHttpTargetArgs();
    }
}
