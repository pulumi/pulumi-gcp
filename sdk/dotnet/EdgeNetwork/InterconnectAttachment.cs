...
namespace Pulumi.Gcp.EdgeNetwork
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:edgenetwork/interconnectAttachment:InterconnectAttachment")]
    public partial class InterconnectAttachment : global::Pulumi.CustomResource
    {
        ...
        public InterconnectAttachment(string name, InterconnectAttachmentArgs args, CustomResourceOptions? options = null)
            : base("gcp:edgenetwork/interconnectAttachment:InterconnectAttachment", name, args ?? new InterconnectAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InterconnectAttachment(string name, Input<string> id, InterconnectAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("gcp:edgenetwork/interconnectAttachment:InterconnectAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
