...
namespace Pulumi.Gcp.Organizations
{
    ...
    /// </summary>
    [GcpResourceType("gcp:organizations/serviceIdentity:ServiceIdentity")]
    public partial class ServiceIdentity : global::Pulumi.CustomResource
    {
        ...
        public ServiceIdentity(string name, ServiceIdentityArgs args, CustomResourceOptions? options = null)
            : base("gcp:organizations/serviceIdentity:ServiceIdentity", name, args ?? new ServiceIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServiceIdentity(string name, Input<string> id, ServiceIdentityState? state = null, CustomResourceOptions? options = null)
            : base("gcp:organizations/serviceIdentity:ServiceIdentity", name, state, MakeResourceOptions(options, id))
        {
        }
