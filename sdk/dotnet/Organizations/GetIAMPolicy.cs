...
namespace Pulumi.Gcp.Organizations
{
    public static partial class Invokes
    {
        ...
        public static Task<GetIAMPolicyResult> GetIAMPolicy(GetIAMPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIAMPolicyResult>("gcp:organizations/getIAMPolicy:getIAMPolicy", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetIAMPolicyArgs : Pulumi.ResourceArgs
    {
        [Input("auditConfigs")]
        private InputList<Inputs.GetIAMPolicyAuditConfigsArgs>? _auditConfigs;

        /// <summary>
        /// A nested configuration block that defines logging additional configuration for your project.
        /// </summary>
        public InputList<Inputs.GetIAMPolicyAuditConfigsArgs> AuditConfigs
        {
            get => _auditConfigs ?? (_auditConfigs = new InputList<Inputs.GetIAMPolicyAuditConfigsArgs>());
            set => _auditConfigs = value;
        }

        [Input("bindings", required: true)]
        private InputList<Inputs.GetIAMPolicyBindingsArgs>? _bindings;
        ...
        /// </summary>
        public InputList<Inputs.GetIAMPolicyBindingsArgs> Bindings
        {
            get => _bindings ?? (_bindings = new InputList<Inputs.GetIAMPolicyBindingsArgs>());
            set => _bindings = value;
        }
    ...
    public sealed class GetIAMPolicyAuditConfigsArgs : Pulumi.ResourceArgs
    {
        [Input("auditLogConfigs", required: true)]
        private InputList<GetIAMPolicyAuditConfigsAuditLogConfigsArgs>? _auditLogConfigs;

        /// <summary>
        /// A nested block that defines the operations you'd like to log.
        /// </summary>
        public InputList<GetIAMPolicyAuditConfigsAuditLogConfigsArgs> AuditLogConfigs
        {
            get => _auditLogConfigs ?? (_auditLogConfigs = new InputList<GetIAMPolicyAuditConfigsAuditLogConfigsArgs>());
    ...
    public sealed class GetIAMPolicyAuditConfigsAuditLogConfigsArgs : Pulumi.ResourceArgs
    {
