...
namespace Pulumi.Gcp.Colab
{
    ...
    /// </summary>
    [GcpResourceType("gcp:colab/runtimeTemplateIamBinding:RuntimeTemplateIamBinding")]
    public partial class RuntimeTemplateIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.RuntimeTemplateIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public RuntimeTemplateIamBinding(string name, RuntimeTemplateIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:colab/runtimeTemplateIamBinding:RuntimeTemplateIamBinding", name, args ?? new RuntimeTemplateIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuntimeTemplateIamBinding(string name, Input<string> id, RuntimeTemplateIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:colab/runtimeTemplateIamBinding:RuntimeTemplateIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RuntimeTemplateIamBinding Get(string name, Input<string> id, RuntimeTemplateIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new RuntimeTemplateIamBinding(name, id, state, options);
        }
    }

    public sealed class RuntimeTemplateIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.RuntimeTemplateIamBindingConditionArgs>? Condition { get; set; }
        ...
        public RuntimeTemplateIamBindingArgs()
        {
        }
        public static new RuntimeTemplateIamBindingArgs Empty => new RuntimeTemplateIamBindingArgs();
    }

    public sealed class RuntimeTemplateIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.RuntimeTemplateIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public RuntimeTemplateIamBindingState()
        {
        }
        public static new RuntimeTemplateIamBindingState Empty => new RuntimeTemplateIamBindingState();
    }
}
