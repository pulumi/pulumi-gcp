...
namespace Pulumi.Gcp.Colab.Outputs
{
    ...
    [OutputType]
    public sealed class ScheduleCreatePipelineJobRequestPipelineJobTemplateMetadata
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ScheduleCreatePipelineJobRequestPipelineJobTemplateMetadata(string? version)
        {
            Version = version;
        }
    }
