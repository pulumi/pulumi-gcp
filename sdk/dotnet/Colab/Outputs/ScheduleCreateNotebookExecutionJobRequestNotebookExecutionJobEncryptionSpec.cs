...
namespace Pulumi.Gcp.Colab.Outputs
{
    ...
    [OutputType]
    public sealed class ScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobEncryptionSpec
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobEncryptionSpec(string kmsKeyName)
        {
