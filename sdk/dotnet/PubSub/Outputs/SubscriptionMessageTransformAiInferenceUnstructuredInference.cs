...
namespace Pulumi.Gcp.PubSub.Outputs
{
    ...
    [OutputType]
    public sealed class SubscriptionMessageTransformAiInferenceUnstructuredInference
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SubscriptionMessageTransformAiInferenceUnstructuredInference(ImmutableDictionary<string, string>? parameters)
        {
