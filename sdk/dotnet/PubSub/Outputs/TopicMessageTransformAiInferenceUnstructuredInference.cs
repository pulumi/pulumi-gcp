...
namespace Pulumi.Gcp.PubSub.Outputs
{
    ...
    [OutputType]
    public sealed class TopicMessageTransformAiInferenceUnstructuredInference
    {
        /// <summary>
        ...
        [OutputConstructor]
        private TopicMessageTransformAiInferenceUnstructuredInference(ImmutableDictionary<string, string>? parameters)
        {
