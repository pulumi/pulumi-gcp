...
namespace Pulumi.Gcp.PubSub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:pubsub/schemaIamBinding:SchemaIamBinding")]
    public partial class SchemaIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.SchemaIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public SchemaIamBinding(string name, SchemaIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:pubsub/schemaIamBinding:SchemaIamBinding", name, args ?? new SchemaIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaIamBinding(string name, Input<string> id, SchemaIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:pubsub/schemaIamBinding:SchemaIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SchemaIamBinding Get(string name, Input<string> id, SchemaIamBindingState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.SchemaIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class SchemaIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.SchemaIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public SchemaIamBindingState()
        {
        }
        public static new SchemaIamBindingState Empty => new SchemaIamBindingState();
    }
}
