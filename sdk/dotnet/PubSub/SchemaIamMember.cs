...
namespace Pulumi.Gcp.PubSub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:pubsub/schemaIamMember:SchemaIamMember")]
    public partial class SchemaIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.SchemaIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public SchemaIamMember(string name, SchemaIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:pubsub/schemaIamMember:SchemaIamMember", name, args ?? new SchemaIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaIamMember(string name, Input<string> id, SchemaIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:pubsub/schemaIamMember:SchemaIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SchemaIamMember Get(string name, Input<string> id, SchemaIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new SchemaIamMember(name, id, state, options);
        }
    }

    public sealed class SchemaIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        ...
        public SchemaIamMemberArgs()
        {
        }
        public static new SchemaIamMemberArgs Empty => new SchemaIamMemberArgs();
    }

    public sealed class SchemaIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.SchemaIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public SchemaIamMemberState()
        {
        }
        public static new SchemaIamMemberState Empty => new SchemaIamMemberState();
    }
}
