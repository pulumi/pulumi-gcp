...
namespace Pulumi.Gcp.PubSub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:pubsub/schemaIamPolicy:SchemaIamPolicy")]
    public partial class SchemaIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public SchemaIamPolicy(string name, SchemaIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:pubsub/schemaIamPolicy:SchemaIamPolicy", name, args ?? new SchemaIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchemaIamPolicy(string name, Input<string> id, SchemaIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:pubsub/schemaIamPolicy:SchemaIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static SchemaIamPolicy Get(string name, Input<string> id, SchemaIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new SchemaIamPolicy(name, id, state, options);
        }
    }
    ...
    public sealed class SchemaIamPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Computed) The etag of the IAM policy.
        /// </summary>
        ...
        public SchemaIamPolicyState()
        {
        }
        public static new SchemaIamPolicyState Empty => new SchemaIamPolicyState();
    }
}
