...
namespace Pulumi.Gcp.PubSub.Inputs
{
    ...
    public sealed class SubscriptionMessageTransformArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("javascriptUdf")]
        public Input<Inputs.SubscriptionMessageTransformJavascriptUdfArgs>? JavascriptUdf { get; set; }

        public SubscriptionMessageTransformArgs()
        {
        }
        public static new SubscriptionMessageTransformArgs Empty => new SubscriptionMessageTransformArgs();
    }
}
