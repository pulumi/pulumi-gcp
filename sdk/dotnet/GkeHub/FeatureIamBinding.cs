...
namespace Pulumi.Gcp.GkeHub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:gkehub/featureIamBinding:FeatureIamBinding")]
    public partial class FeatureIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.FeatureIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public FeatureIamBinding(string name, FeatureIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:gkehub/featureIamBinding:FeatureIamBinding", name, args ?? new FeatureIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FeatureIamBinding(string name, Input<string> id, FeatureIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:gkehub/featureIamBinding:FeatureIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FeatureIamBinding Get(string name, Input<string> id, FeatureIamBindingState? state = null, CustomResourceOptions? options = null)
        {
            return new FeatureIamBinding(name, id, state, options);
        }
    }

    public sealed class FeatureIamBindingArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.FeatureIamBindingConditionArgs>? Condition { get; set; }
        ...
        public FeatureIamBindingArgs()
        {
        }
        public static new FeatureIamBindingArgs Empty => new FeatureIamBindingArgs();
    }

    public sealed class FeatureIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.FeatureIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public FeatureIamBindingState()
        {
        }
        public static new FeatureIamBindingState Empty => new FeatureIamBindingState();
    }
}
