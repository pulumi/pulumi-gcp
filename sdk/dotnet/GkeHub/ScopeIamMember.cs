...
namespace Pulumi.Gcp.GkeHub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:gkehub/scopeIamMember:ScopeIamMember")]
    public partial class ScopeIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.ScopeIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public ScopeIamMember(string name, ScopeIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:gkehub/scopeIamMember:ScopeIamMember", name, args ?? new ScopeIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeIamMember(string name, Input<string> id, ScopeIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:gkehub/scopeIamMember:ScopeIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ScopeIamMember Get(string name, Input<string> id, ScopeIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new ScopeIamMember(name, id, state, options);
        }
    }

    public sealed class ScopeIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.ScopeIamMemberConditionArgs>? Condition { get; set; }
        ...
        public ScopeIamMemberArgs()
        {
        }
        public static new ScopeIamMemberArgs Empty => new ScopeIamMemberArgs();
    }

    public sealed class ScopeIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.ScopeIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public ScopeIamMemberState()
        {
        }
        public static new ScopeIamMemberState Empty => new ScopeIamMemberState();
    }
}
