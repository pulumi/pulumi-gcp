...
namespace Pulumi.Gcp.GkeHub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:gkehub/membershipIamBinding:MembershipIamBinding")]
    public partial class MembershipIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.MembershipIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public MembershipIamBinding(string name, MembershipIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:gkehub/membershipIamBinding:MembershipIamBinding", name, args ?? new MembershipIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipIamBinding(string name, Input<string> id, MembershipIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:gkehub/membershipIamBinding:MembershipIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MembershipIamBinding Get(string name, Input<string> id, MembershipIamBindingState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.MembershipIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class MembershipIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.MembershipIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public MembershipIamBindingState()
        {
        }
        public static new MembershipIamBindingState Empty => new MembershipIamBindingState();
    }
}
