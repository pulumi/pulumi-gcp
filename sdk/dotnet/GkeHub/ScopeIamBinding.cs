...
namespace Pulumi.Gcp.GkeHub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:gkehub/scopeIamBinding:ScopeIamBinding")]
    public partial class ScopeIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.ScopeIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public ScopeIamBinding(string name, ScopeIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:gkehub/scopeIamBinding:ScopeIamBinding", name, args ?? new ScopeIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScopeIamBinding(string name, Input<string> id, ScopeIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:gkehub/scopeIamBinding:ScopeIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ScopeIamBinding Get(string name, Input<string> id, ScopeIamBindingState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.ScopeIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class ScopeIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.ScopeIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public ScopeIamBindingState()
        {
        }
        public static new ScopeIamBindingState Empty => new ScopeIamBindingState();
    }
}
