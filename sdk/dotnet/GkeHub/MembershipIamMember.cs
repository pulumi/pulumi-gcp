...
namespace Pulumi.Gcp.GkeHub
{
    ...
    /// </summary>
    [GcpResourceType("gcp:gkehub/membershipIamMember:MembershipIamMember")]
    public partial class MembershipIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.MembershipIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public MembershipIamMember(string name, MembershipIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:gkehub/membershipIamMember:MembershipIamMember", name, args ?? new MembershipIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MembershipIamMember(string name, Input<string> id, MembershipIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:gkehub/membershipIamMember:MembershipIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MembershipIamMember Get(string name, Input<string> id, MembershipIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new MembershipIamMember(name, id, state, options);
        }
    }

    public sealed class MembershipIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        ...
        public MembershipIamMemberArgs()
        {
        }
        public static new MembershipIamMemberArgs Empty => new MembershipIamMemberArgs();
    }

    public sealed class MembershipIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.MembershipIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public MembershipIamMemberState()
        {
        }
        public static new MembershipIamMemberState Empty => new MembershipIamMemberState();
    }
}
