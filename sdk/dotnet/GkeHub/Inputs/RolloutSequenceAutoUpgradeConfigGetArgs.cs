...
namespace Pulumi.Gcp.GkeHub.Inputs
{
    ...
    public sealed class RolloutSequenceAutoUpgradeConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.RolloutSequenceAutoUpgradeConfigRolloutCreationScopeGetArgs>? RolloutCreationScope { get; set; }

        public RolloutSequenceAutoUpgradeConfigGetArgs()
        {
        }
        public static new RolloutSequenceAutoUpgradeConfigGetArgs Empty => new RolloutSequenceAutoUpgradeConfigGetArgs();
    }
}
