...
namespace Pulumi.Gcp.GkeHub.Inputs
{
    ...
    public sealed class RolloutSequenceAutoUpgradeConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("rolloutCreationScope")]
        public Input<Inputs.RolloutSequenceAutoUpgradeConfigRolloutCreationScopeArgs>? RolloutCreationScope { get; set; }

        public RolloutSequenceAutoUpgradeConfigArgs()
        {
        }
        public static new RolloutSequenceAutoUpgradeConfigArgs Empty => new RolloutSequenceAutoUpgradeConfigArgs();
    }
}
