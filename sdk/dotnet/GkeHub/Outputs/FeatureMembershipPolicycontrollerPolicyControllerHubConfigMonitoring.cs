...
namespace Pulumi.Gcp.GkeHub.Outputs
{
    ...
    [OutputType]
    public sealed class FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoring
    {
        /// <summary>
        ...
        [OutputConstructor]
        private FeatureMembershipPolicycontrollerPolicyControllerHubConfigMonitoring(ImmutableArray<string> backends)
        {
            Backends = backends;
        }
    }
