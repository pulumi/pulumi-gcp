...
namespace Pulumi.Gcp.Iam.Inputs
{
    ...
    public sealed class WorkloadIdentityPoolInlineCertificateIssuanceConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("caPools")]
        private InputMap<string>? _caPools;
        ...
        /// </summary>
        public InputMap<string> CaPools
        {
            get => _caPools ?? (_caPools = new InputMap<string>());
            set => _caPools = value;
        }
        ...
        /// </summary>
        [Input("useDefaultSharedCa")]
        public Input<bool>? UseDefaultSharedCa { get; set; }

        public WorkloadIdentityPoolInlineCertificateIssuanceConfigGetArgs()
        {
        }
        public static new WorkloadIdentityPoolInlineCertificateIssuanceConfigGetArgs Empty => new WorkloadIdentityPoolInlineCertificateIssuanceConfigGetArgs();
    }
}
