...
namespace Pulumi.Gcp.Iam.Outputs
{
    ...
    [OutputType]
    public sealed class WorkforcePoolProviderExtendedAttributesOauth2ClientQueryParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WorkforcePoolProviderExtendedAttributesOauth2ClientQueryParameters(string? filter)
        {
            Filter = filter;
        }
    }
