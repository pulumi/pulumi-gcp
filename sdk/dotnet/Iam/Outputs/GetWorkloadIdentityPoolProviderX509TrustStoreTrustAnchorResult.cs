...
namespace Pulumi.Gcp.Iam.Outputs
{
    ...
    [OutputType]
    public sealed class GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetWorkloadIdentityPoolProviderX509TrustStoreTrustAnchorResult(string pemCertificate)
        {
