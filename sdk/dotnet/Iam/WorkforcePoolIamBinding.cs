...
namespace Pulumi.Gcp.Iam
{
    ...
    ///  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
    /// </summary>
    [GcpResourceType("gcp:iam/workforcePoolIamBinding:WorkforcePoolIamBinding")]
    public partial class WorkforcePoolIamBinding : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.WorkforcePoolIamBindingCondition?> Condition { get; private set; } = null!;
        ...
        public WorkforcePoolIamBinding(string name, WorkforcePoolIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:iam/workforcePoolIamBinding:WorkforcePoolIamBinding", name, args ?? new WorkforcePoolIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkforcePoolIamBinding(string name, Input<string> id, WorkforcePoolIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iam/workforcePoolIamBinding:WorkforcePoolIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkforcePoolIamBinding Get(string name, Input<string> id, WorkforcePoolIamBindingState? state = null, CustomResourceOptions? options = null)
        {
    ...
    {
        [Input("condition")]
        public Input<Inputs.WorkforcePoolIamBindingConditionArgs>? Condition { get; set; }
    ...
    public sealed class WorkforcePoolIamBindingState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.WorkforcePoolIamBindingConditionGetArgs>? Condition { get; set; }
        ...
        public WorkforcePoolIamBindingState()
        {
        }
        public static new WorkforcePoolIamBindingState Empty => new WorkforcePoolIamBindingState();
    }
}
