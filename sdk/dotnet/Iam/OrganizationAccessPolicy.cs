...
namespace Pulumi.Gcp.Iam
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:iam/organizationAccessPolicy:OrganizationAccessPolicy")]
    public partial class OrganizationAccessPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("details")]
        public Output<Outputs.OrganizationAccessPolicyDetails?> Details { get; private set; } = null!;
        ...
        public OrganizationAccessPolicy(string name, OrganizationAccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:iam/organizationAccessPolicy:OrganizationAccessPolicy", name, args ?? new OrganizationAccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OrganizationAccessPolicy(string name, Input<string> id, OrganizationAccessPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iam/organizationAccessPolicy:OrganizationAccessPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static OrganizationAccessPolicy Get(string name, Input<string> id, OrganizationAccessPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new OrganizationAccessPolicy(name, id, state, options);
        }
    }

    public sealed class OrganizationAccessPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID to use for the access policy, which
        /// will become the final component of the access policy's
        ...
        /// </summary>
        [Input("details")]
        public Input<Inputs.OrganizationAccessPolicyDetailsArgs>? Details { get; set; }
        ...
        public OrganizationAccessPolicyArgs()
        {
        }
        public static new OrganizationAccessPolicyArgs Empty => new OrganizationAccessPolicyArgs();
    }

    public sealed class OrganizationAccessPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID to use for the access policy, which
        /// will become the final component of the access policy's
        ...
        /// </summary>
        [Input("details")]
        public Input<Inputs.OrganizationAccessPolicyDetailsGetArgs>? Details { get; set; }
        ...
        public OrganizationAccessPolicyState()
        {
        }
        public static new OrganizationAccessPolicyState Empty => new OrganizationAccessPolicyState();
    }
}
