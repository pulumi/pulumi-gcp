...
namespace Pulumi.Gcp.Iam
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:iam/projectAccessPolicy:ProjectAccessPolicy")]
    public partial class ProjectAccessPolicy : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("details")]
        public Output<Outputs.ProjectAccessPolicyDetails?> Details { get; private set; } = null!;
        ...
        public ProjectAccessPolicy(string name, ProjectAccessPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:iam/projectAccessPolicy:ProjectAccessPolicy", name, args ?? new ProjectAccessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectAccessPolicy(string name, Input<string> id, ProjectAccessPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iam/projectAccessPolicy:ProjectAccessPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProjectAccessPolicy Get(string name, Input<string> id, ProjectAccessPolicyState? state = null, CustomResourceOptions? options = null)
        {
            return new ProjectAccessPolicy(name, id, state, options);
        }
    }

    public sealed class ProjectAccessPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID to use for the access policy, which
        /// will become the final component of the access policy's
        ...
        /// </summary>
        [Input("details")]
        public Input<Inputs.ProjectAccessPolicyDetailsArgs>? Details { get; set; }
        ...
        public ProjectAccessPolicyArgs()
        {
        }
        public static new ProjectAccessPolicyArgs Empty => new ProjectAccessPolicyArgs();
    }

    public sealed class ProjectAccessPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID to use for the access policy, which
        /// will become the final component of the access policy's
        ...
        /// </summary>
        [Input("details")]
        public Input<Inputs.ProjectAccessPolicyDetailsGetArgs>? Details { get; set; }
        ...
        public ProjectAccessPolicyState()
        {
        }
        public static new ProjectAccessPolicyState Empty => new ProjectAccessPolicyState();
    }
}
