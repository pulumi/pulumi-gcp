...
namespace Pulumi.Gcp.Iam
{
    ...
    ///  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
    /// </summary>
    [GcpResourceType("gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember")]
    public partial class WorkforcePoolIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.WorkforcePoolIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public WorkforcePoolIamMember(string name, WorkforcePoolIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember", name, args ?? new WorkforcePoolIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private WorkforcePoolIamMember(string name, Input<string> id, WorkforcePoolIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static WorkforcePoolIamMember Get(string name, Input<string> id, WorkforcePoolIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new WorkforcePoolIamMember(name, id, state, options);
        }
    }

    public sealed class WorkforcePoolIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.WorkforcePoolIamMemberConditionArgs>? Condition { get; set; }
        ...
        public WorkforcePoolIamMemberArgs()
        {
        }
        public static new WorkforcePoolIamMemberArgs Empty => new WorkforcePoolIamMemberArgs();
    }

    public sealed class WorkforcePoolIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.WorkforcePoolIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public WorkforcePoolIamMemberState()
        {
        }
        public static new WorkforcePoolIamMemberState Empty => new WorkforcePoolIamMemberState();
    }
}
