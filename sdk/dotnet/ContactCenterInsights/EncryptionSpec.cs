...
namespace Pulumi.Gcp.ContactCenterInsights
{
    ...
    /// ```
    /// </summary>
    [GcpResourceType("gcp:contactcenterinsights/encryptionSpec:EncryptionSpec")]
    public partial class EncryptionSpec : global::Pulumi.CustomResource
    {
        ...
        public EncryptionSpec(string name, EncryptionSpecArgs args, CustomResourceOptions? options = null)
            : base("gcp:contactcenterinsights/encryptionSpec:EncryptionSpec", name, args ?? new EncryptionSpecArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EncryptionSpec(string name, Input<string> id, EncryptionSpecState? state = null, CustomResourceOptions? options = null)
            : base("gcp:contactcenterinsights/encryptionSpec:EncryptionSpec", name, state, MakeResourceOptions(options, id))
        {
        }
