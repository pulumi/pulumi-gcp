...
namespace Pulumi.Gcp.OsConfig.Outputs
{
    ...
    [OutputType]
    public sealed class V2PolicyOrchestratorForFolderOrchestratedResource
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload? OsPolicyAssignmentV1Payload;

        [OutputConstructor]
        private V2PolicyOrchestratorForFolderOrchestratedResource(
            string? id,

            Outputs.V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload? osPolicyAssignmentV1Payload)
        {
            Id = id;
