...
namespace Pulumi.Gcp.OsConfig.Outputs
{
    ...
    [OutputType]
    public sealed class V2PolicyOrchestratorOrchestratedResource
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1Payload? OsPolicyAssignmentV1Payload;

        [OutputConstructor]
        private V2PolicyOrchestratorOrchestratedResource(
            string? id,

            Outputs.V2PolicyOrchestratorOrchestratedResourceOsPolicyAssignmentV1Payload? osPolicyAssignmentV1Payload)
        {
            Id = id;
