...
namespace Pulumi.Gcp.NetworkConnectivity
{
    ...
    /// </summary>
    [GcpResourceType("gcp:networkconnectivity/hubIamPolicy:HubIamPolicy")]
    public partial class HubIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public HubIamPolicy(string name, HubIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:networkconnectivity/hubIamPolicy:HubIamPolicy", name, args ?? new HubIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubIamPolicy(string name, Input<string> id, HubIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:networkconnectivity/hubIamPolicy:HubIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HubIamPolicy Get(string name, Input<string> id, HubIamPolicyState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class HubIamPolicyState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Computed) The etag of the IAM policy.
        /// </summary>
        ...
        public HubIamPolicyState()
        {
        }
        public static new HubIamPolicyState Empty => new HubIamPolicyState();
    }
}
