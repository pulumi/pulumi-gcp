...
namespace Pulumi.Gcp.NetworkConnectivity
{
    ...
    /// </summary>
    [GcpResourceType("gcp:networkconnectivity/hubIamMember:HubIamMember")]
    public partial class HubIamMember : global::Pulumi.CustomResource
    {
        [Output("condition")]
        public Output<Outputs.HubIamMemberCondition?> Condition { get; private set; } = null!;
        ...
        public HubIamMember(string name, HubIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:networkconnectivity/hubIamMember:HubIamMember", name, args ?? new HubIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HubIamMember(string name, Input<string> id, HubIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:networkconnectivity/hubIamMember:HubIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static HubIamMember Get(string name, Input<string> id, HubIamMemberState? state = null, CustomResourceOptions? options = null)
        {
            return new HubIamMember(name, id, state, options);
        }
    }

    public sealed class HubIamMemberArgs : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.HubIamMemberConditionArgs>? Condition { get; set; }
        ...
        public HubIamMemberArgs()
        {
        }
        public static new HubIamMemberArgs Empty => new HubIamMemberArgs();
    }

    public sealed class HubIamMemberState : global::Pulumi.ResourceArgs
    {
        [Input("condition")]
        public Input<Inputs.HubIamMemberConditionGetArgs>? Condition { get; set; }
        ...
        public HubIamMemberState()
        {
        }
        public static new HubIamMemberState Empty => new HubIamMemberState();
    }
}
