...
namespace Pulumi.Gcp.Folder
{
    public static partial class Invokes
    {
        ...
        public static Task<GetOrganizationPolicyResult> GetOrganizationPolicy(GetOrganizationPolicyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationPolicyResult>("gcp:folder/getOrganizationPolicy:getOrganizationPolicy", args ?? ResourceArgs.Empty, options.WithVersion());
    }
