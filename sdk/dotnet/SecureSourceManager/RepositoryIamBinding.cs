...
namespace Pulumi.Gcp.SecureSourceManager
{
    ...
    /// </summary>
    [GcpResourceType("gcp:securesourcemanager/repositoryIamBinding:RepositoryIamBinding")]
    public partial class RepositoryIamBinding : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamBinding(string name, RepositoryIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/repositoryIamBinding:RepositoryIamBinding", name, args ?? new RepositoryIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private RepositoryIamBinding(string name, Input<string> id, RepositoryIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/repositoryIamBinding:RepositoryIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
