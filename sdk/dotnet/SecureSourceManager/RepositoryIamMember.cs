...
namespace Pulumi.Gcp.SecureSourceManager
{
    ...
    /// </summary>
    [GcpResourceType("gcp:securesourcemanager/repositoryIamMember:RepositoryIamMember")]
    public partial class RepositoryIamMember : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamMember(string name, RepositoryIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/repositoryIamMember:RepositoryIamMember", name, args ?? new RepositoryIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private RepositoryIamMember(string name, Input<string> id, RepositoryIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/repositoryIamMember:RepositoryIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
