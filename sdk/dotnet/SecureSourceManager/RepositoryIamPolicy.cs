...
namespace Pulumi.Gcp.SecureSourceManager
{
    ...
    /// </summary>
    [GcpResourceType("gcp:securesourcemanager/repositoryIamPolicy:RepositoryIamPolicy")]
    public partial class RepositoryIamPolicy : global::Pulumi.CustomResource
    {
        ...
        public RepositoryIamPolicy(string name, RepositoryIamPolicyArgs args, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/repositoryIamPolicy:RepositoryIamPolicy", name, args ?? new RepositoryIamPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private RepositoryIamPolicy(string name, Input<string> id, RepositoryIamPolicyState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/repositoryIamPolicy:RepositoryIamPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
