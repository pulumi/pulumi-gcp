...
{
    [GcpResourceType("gcp:securesourcemanager/instanceIamMember:InstanceIamMember")]
    public partial class InstanceIamMember : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamMember(string name, InstanceIamMemberArgs args, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/instanceIamMember:InstanceIamMember", name, args ?? new InstanceIamMemberArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InstanceIamMember(string name, Input<string> id, InstanceIamMemberState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/instanceIamMember:InstanceIamMember", name, state, MakeResourceOptions(options, id))
        {
        }
