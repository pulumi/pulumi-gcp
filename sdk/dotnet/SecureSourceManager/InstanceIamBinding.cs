...
{
    [GcpResourceType("gcp:securesourcemanager/instanceIamBinding:InstanceIamBinding")]
    public partial class InstanceIamBinding : global::Pulumi.CustomResource
    {
        ...
        public InstanceIamBinding(string name, InstanceIamBindingArgs args, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/instanceIamBinding:InstanceIamBinding", name, args ?? new InstanceIamBindingArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InstanceIamBinding(string name, Input<string> id, InstanceIamBindingState? state = null, CustomResourceOptions? options = null)
            : base("gcp:securesourcemanager/instanceIamBinding:InstanceIamBinding", name, state, MakeResourceOptions(options, id))
        {
        }
