...
public final class ProjectBucketConfigIndexConfig {
    ...
    public static Builder builder(ProjectBucketConfigIndexConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ProjectBucketConfigIndexConfig defaults) {
        ...
        public Builder fieldPath(String fieldPath) {
            if (fieldPath == null) {
              throw new MissingRequiredPropertyException("ProjectBucketConfigIndexConfig", "fieldPath");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ProjectBucketConfigIndexConfig", "type");
            }
            this.type = type;
            return this;
        }
