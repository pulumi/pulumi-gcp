...
@CustomType
public final class CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessagePlayAudio {
    /**
     * @return (Output)
    ...
    private CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessagePlayAudio() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessagePlayAudio defaults) {
    ...
    public static final class Builder {
        ...
        private String audioUri;
        public Builder() {}
        public Builder(CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessagePlayAudio defaults) {
        ...
        public Builder audioUri(String audioUri) {
            if (audioUri == null) {
              throw new MissingRequiredPropertyException("CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessagePlayAudio", "audioUri");
            }
