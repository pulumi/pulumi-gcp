 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/machineImageIamBinding:MachineImageIamBinding editor &#34;projects/{{project}}/global/machineImages/{{machine_image}} roles/compute.admin user:jane{@literal @}example.com&#34;
 * ```
 * 
