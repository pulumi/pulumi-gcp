...
public final class AssistantState extends com.pulumi.resources.ResourceArgs {

    public static final AssistantState Empty = new AssistantState();

    /**
     * The unique id of the assistant.
     * 
     */
    @Import(name="assistantId")
    private @Nullable Output<String> assistantId;

    /**
     * @return The unique id of the assistant.
     * 
     */
    public Optional<Output<String>> assistantId() {
    ...
    public static Builder builder(AssistantState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AssistantState defaults) {
            $ = new AssistantState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder assistantId(@Nullable Output<String> assistantId) {
        ...
        /**
         * @param name Resource name of the assistant.
         * Format:
         * `projects/{project}/locations/{location}/collections/{collection}/engines/{engine}/assistants/{assistant}`
         * It must be a UTF-8 encoded string with a length limit of 1024 characters.
         * 
