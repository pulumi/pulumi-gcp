...
@CustomType
public final class WebRegionBackendServiceIamMemberCondition {
    /**
    ...
    private WebRegionBackendServiceIamMemberCondition() {}
    /**
     * @return An optional description of the expression. This is a longer text which describes the expression, e.g. when hovered over it in a UI.
     * 
     * &gt; **Warning:** Terraform considers the `role` and condition contents (`title`+`description`+`expression`) as the
    ...
    public static Builder builder(WebRegionBackendServiceIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(WebRegionBackendServiceIamMemberCondition defaults) {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("WebRegionBackendServiceIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("WebRegionBackendServiceIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
