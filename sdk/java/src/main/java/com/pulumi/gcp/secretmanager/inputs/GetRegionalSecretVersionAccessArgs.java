...
public final class GetRegionalSecretVersionAccessArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static Builder builder(GetRegionalSecretVersionAccessArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRegionalSecretVersionAccessArgs();
        }
        ...
        public GetRegionalSecretVersionAccessArgs build() {
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("GetRegionalSecretVersionAccessArgs", "secret");
            }
            return $;
        }
    }
