    ...
    public static final class Builder {
        ...
        public Builder enhancedQueryInsightsEnabled(Boolean enhancedQueryInsightsEnabled) {
            if (enhancedQueryInsightsEnabled == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingInsightsConfig", "enhancedQueryInsightsEnabled");
            }
        ...
        public Builder queryInsightsEnabled(Boolean queryInsightsEnabled) {
            if (queryInsightsEnabled == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingInsightsConfig", "queryInsightsEnabled");
            }
        ...
        public Builder queryPlansPerMinute(Integer queryPlansPerMinute) {
            if (queryPlansPerMinute == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingInsightsConfig", "queryPlansPerMinute");
            }
        ...
        public Builder queryStringLength(Integer queryStringLength) {
            if (queryStringLength == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingInsightsConfig", "queryStringLength");
            }
        ...
        public Builder recordApplicationTags(Boolean recordApplicationTags) {
            if (recordApplicationTags == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingInsightsConfig", "recordApplicationTags");
            }
        ...
        public Builder recordClientAddress(Boolean recordClientAddress) {
            if (recordClientAddress == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingInsightsConfig", "recordClientAddress");
            }
