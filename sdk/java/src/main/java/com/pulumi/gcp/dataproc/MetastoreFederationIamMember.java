...
import com.pulumi.gcp.dataproc.inputs.MetastoreFederationIamMemberState;
import com.pulumi.gcp.dataproc.outputs.MetastoreFederationIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataproc/metastoreFederationIamMember:MetastoreFederationIamMember editor &#34;projects/{{project}}/locations/{{location}}/federations/{{federation_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class MetastoreFederationIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public MetastoreFederationIamMember(java.lang.String name) {
        this(name, MetastoreFederationIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MetastoreFederationIamMember(java.lang.String name, MetastoreFederationIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetastoreFederationIamMember(java.lang.String name, MetastoreFederationIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreFederationIamMember:MetastoreFederationIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetastoreFederationIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreFederationIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreFederationIamMember:MetastoreFederationIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static MetastoreFederationIamMemberArgs makeArgs(MetastoreFederationIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MetastoreFederationIamMemberArgs.Empty : args;
    }
     ...
     */
    public static MetastoreFederationIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreFederationIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
