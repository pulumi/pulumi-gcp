...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgApt {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgApt", "name");
            }
            this.name = name;
            return this;
        }
        public OsPolicyAssignmentOsPolicyResourceGroupResourcePkgApt build() {
            final var _resultValue = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgApt();
