...
public class ConsumersIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public ConsumersIamMember(String name) {
     ...
     */
    public static ConsumersIamMember get(String name, Output<String> id, @Nullable ConsumersIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
