...
public final class GetClusterReleaseChannel {
    /**
     * @return The selected release channel. Accepted values are:
     * * UNSPECIFIED: Not set.
    ...
    public static final class Builder {
        ...
        public Builder channel(String channel) {
            if (channel == null) {
              throw new MissingRequiredPropertyException("GetClusterReleaseChannel", "channel");
            }
            this.channel = channel;
            return this;
        }
        public GetClusterReleaseChannel build() {
            final var _resultValue = new GetClusterReleaseChannel();
