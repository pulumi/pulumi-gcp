    ...
    public static final class Builder {
        ...
        public FunctionIamPolicyArgs build() {
            if ($.cloudFunction == null) {
                throw new MissingRequiredPropertyException("FunctionIamPolicyArgs", "cloudFunction");
            }
            if ($.policyData == null) {
                throw new MissingRequiredPropertyException("FunctionIamPolicyArgs", "policyData");
            }
            return $;
        }
    }
