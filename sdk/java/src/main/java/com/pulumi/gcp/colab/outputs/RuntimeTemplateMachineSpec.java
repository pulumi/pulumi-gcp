...
@CustomType
public final class RuntimeTemplateMachineSpec {
    /**
    ...
    public static Builder builder(RuntimeTemplateMachineSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String machineType;
        public Builder() {}
        public Builder(RuntimeTemplateMachineSpec defaults) {
        ...
        public RuntimeTemplateMachineSpec build() {
            final var _resultValue = new RuntimeTemplateMachineSpec();
