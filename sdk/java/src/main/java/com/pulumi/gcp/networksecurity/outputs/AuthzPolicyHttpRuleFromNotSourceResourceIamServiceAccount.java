...
@CustomType
public final class AuthzPolicyHttpRuleFromNotSourceResourceIamServiceAccount {
    /**
    ...
    public static Builder builder(AuthzPolicyHttpRuleFromNotSourceResourceIamServiceAccount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleFromNotSourceResourceIamServiceAccount defaults) {
        ...
        public AuthzPolicyHttpRuleFromNotSourceResourceIamServiceAccount build() {
            final var _resultValue = new AuthzPolicyHttpRuleFromNotSourceResourceIamServiceAccount();
