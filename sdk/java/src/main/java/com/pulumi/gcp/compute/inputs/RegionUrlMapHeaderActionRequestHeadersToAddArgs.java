...
public final class RegionUrlMapHeaderActionRequestHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionUrlMapHeaderActionRequestHeadersToAddArgs Empty = new RegionUrlMapHeaderActionRequestHeadersToAddArgs();
    ...
    private RegionUrlMapHeaderActionRequestHeadersToAddArgs() {}

    private RegionUrlMapHeaderActionRequestHeadersToAddArgs(RegionUrlMapHeaderActionRequestHeadersToAddArgs $) {
    ...
    public static Builder builder(RegionUrlMapHeaderActionRequestHeadersToAddArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapHeaderActionRequestHeadersToAddArgs();
        }

        public Builder(RegionUrlMapHeaderActionRequestHeadersToAddArgs defaults) {
            $ = new RegionUrlMapHeaderActionRequestHeadersToAddArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionUrlMapHeaderActionRequestHeadersToAddArgs build() {
            return $;
        }
    }
