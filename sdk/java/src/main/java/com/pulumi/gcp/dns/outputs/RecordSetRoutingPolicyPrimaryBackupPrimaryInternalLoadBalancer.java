...
@CustomType
public final class RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer {
    /**
    ...
    public static Builder builder(RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String region;
        public Builder() {}
        public Builder(RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer defaults) {
        ...
        public Builder ipAddress(String ipAddress) {
            if (ipAddress == null) {
              throw new MissingRequiredPropertyException("RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer", "ipAddress");
            }
        ...
        public Builder ipProtocol(String ipProtocol) {
            if (ipProtocol == null) {
              throw new MissingRequiredPropertyException("RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer", "ipProtocol");
            }
        ...
        public Builder networkUrl(String networkUrl) {
            if (networkUrl == null) {
              throw new MissingRequiredPropertyException("RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer", "networkUrl");
            }
        ...
        public Builder port(String port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder project(String project) {
            if (project == null) {
              throw new MissingRequiredPropertyException("RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer", "project");
            }
        ...
        public RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer build() {
            final var _resultValue = new RecordSetRoutingPolicyPrimaryBackupPrimaryInternalLoadBalancer();
