...
public final class ClusterControlPlaneEncryptionKmsStatusArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterControlPlaneEncryptionKmsStatusArgs() {}

    private ClusterControlPlaneEncryptionKmsStatusArgs(ClusterControlPlaneEncryptionKmsStatusArgs $) {
        this.code = $.code;
    ...
    public static Builder builder(ClusterControlPlaneEncryptionKmsStatusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterControlPlaneEncryptionKmsStatusArgs();
        }

        public Builder(ClusterControlPlaneEncryptionKmsStatusArgs defaults) {
            $ = new ClusterControlPlaneEncryptionKmsStatusArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterControlPlaneEncryptionKmsStatusArgs build() {
            return $;
        }
    }
