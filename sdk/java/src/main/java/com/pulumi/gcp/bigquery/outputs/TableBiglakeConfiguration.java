...
public final class TableBiglakeConfiguration {
    ...
    public static Builder builder(TableBiglakeConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private String tableFormat;
        public Builder() {}
        public Builder(TableBiglakeConfiguration defaults) {
        ...
        public Builder connectionId(String connectionId) {
            if (connectionId == null) {
              throw new MissingRequiredPropertyException("TableBiglakeConfiguration", "connectionId");
            }
        ...
        public Builder fileFormat(String fileFormat) {
            if (fileFormat == null) {
              throw new MissingRequiredPropertyException("TableBiglakeConfiguration", "fileFormat");
            }
        ...
        public Builder storageUri(String storageUri) {
            if (storageUri == null) {
              throw new MissingRequiredPropertyException("TableBiglakeConfiguration", "storageUri");
            }
        ...
        public Builder tableFormat(String tableFormat) {
            if (tableFormat == null) {
              throw new MissingRequiredPropertyException("TableBiglakeConfiguration", "tableFormat");
            }
            this.tableFormat = tableFormat;
            return this;
        }
        public TableBiglakeConfiguration build() {
            final var _resultValue = new TableBiglakeConfiguration();
