...
public final class ManagementProjectSecurityHealthAnalyticsCustomModuleState extends com.pulumi.resources.ResourceArgs {

    public static final ManagementProjectSecurityHealthAnalyticsCustomModuleState Empty = new ManagementProjectSecurityHealthAnalyticsCustomModuleState();
    ...
    private ManagementProjectSecurityHealthAnalyticsCustomModuleState() {}

    private ManagementProjectSecurityHealthAnalyticsCustomModuleState(ManagementProjectSecurityHealthAnalyticsCustomModuleState $) {
    ...
    public static Builder builder(ManagementProjectSecurityHealthAnalyticsCustomModuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagementProjectSecurityHealthAnalyticsCustomModuleState();
        }

        public Builder(ManagementProjectSecurityHealthAnalyticsCustomModuleState defaults) {
            $ = new ManagementProjectSecurityHealthAnalyticsCustomModuleState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name The resource name of the custom module. Its format is &#34;projects/{project}/locations/{location}/securityHealthAnalyticsCustomModules/{securityHealthAnalyticsCustomModule}&#34;.
         * The id {securityHealthAnalyticsCustomModule} is server-generated and is not user settable. It will be a numeric id containing 1-20 digits.
         * 
         * @return builder
         * 
        ...
        public ManagementProjectSecurityHealthAnalyticsCustomModuleState build() {
            return $;
        }
    }
