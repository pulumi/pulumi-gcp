...
@CustomType
public final class TcpRouteRuleActionDestination {
    /**
    ...
    public static Builder builder(TcpRouteRuleActionDestination defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer weight;
        public Builder() {}
        public Builder(TcpRouteRuleActionDestination defaults) {
