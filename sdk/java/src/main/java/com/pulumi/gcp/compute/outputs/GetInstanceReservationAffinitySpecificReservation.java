...
public final class GetInstanceReservationAffinitySpecificReservation {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetInstanceReservationAffinitySpecificReservation", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetInstanceReservationAffinitySpecificReservation", "values");
            }
            this.values = values;
            return this;
        }
