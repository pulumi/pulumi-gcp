...
import com.pulumi.gcp.dataplex.inputs.GlossaryIamBindingState;
import com.pulumi.gcp.dataplex.outputs.GlossaryIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/glossaryIamBinding:GlossaryIamBinding editor &#34;projects/{{project}}/locations/{{location}}/glossaries/{{glossary_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataplex/glossaryIamBinding:GlossaryIamBinding")
public class GlossaryIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={GlossaryIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ GlossaryIamBindingCondition> condition;

    public Output<Optional<GlossaryIamBindingCondition>> condition() {
     ...
     */
    public GlossaryIamBinding(java.lang.String name) {
        this(name, GlossaryIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GlossaryIamBinding(java.lang.String name, GlossaryIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GlossaryIamBinding(java.lang.String name, GlossaryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/glossaryIamBinding:GlossaryIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GlossaryIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable GlossaryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/glossaryIamBinding:GlossaryIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static GlossaryIamBindingArgs makeArgs(GlossaryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GlossaryIamBindingArgs.Empty : args;
    }
     ...
     */
    public static GlossaryIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable GlossaryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
