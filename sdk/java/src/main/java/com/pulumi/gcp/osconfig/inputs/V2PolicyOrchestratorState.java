...
import com.pulumi.gcp.osconfig.inputs.V2PolicyOrchestratorOrchestrationStateArgs;
...
public final class V2PolicyOrchestratorState extends com.pulumi.resources.ResourceArgs {

    public static final V2PolicyOrchestratorState Empty = new V2PolicyOrchestratorState();
    ...
    private @Nullable Output<V2PolicyOrchestratorOrchestratedResourceArgs> orchestratedResource;
     ...
     * 
     */
    public Optional<Output<V2PolicyOrchestratorOrchestratedResourceArgs>> orchestratedResource() {
    ...
    private @Nullable Output<List<V2PolicyOrchestratorOrchestrationStateArgs>> orchestrationStates;
     ...
     * 
     */
    public Optional<Output<List<V2PolicyOrchestratorOrchestrationStateArgs>>> orchestrationStates() {
    ...
    private V2PolicyOrchestratorState() {}

    private V2PolicyOrchestratorState(V2PolicyOrchestratorState $) {
        this.action = $.action;
    ...
    public static Builder builder(V2PolicyOrchestratorState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2PolicyOrchestratorState();
        }

        public Builder(V2PolicyOrchestratorState defaults) {
            $ = new V2PolicyOrchestratorState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder orchestratedResource(@Nullable Output<V2PolicyOrchestratorOrchestratedResourceArgs> orchestratedResource) {
         ...
         * 
         */
        public Builder orchestrationStates(@Nullable Output<List<V2PolicyOrchestratorOrchestrationStateArgs>> orchestrationStates) {
         ...
         * 
         */
        public Builder orchestrationStates(List<V2PolicyOrchestratorOrchestrationStateArgs> orchestrationStates) {
         ...
         * 
         */
        public Builder orchestrationStates(V2PolicyOrchestratorOrchestrationStateArgs... orchestrationStates) {
        ...
        public V2PolicyOrchestratorState build() {
            return $;
        }
    }
