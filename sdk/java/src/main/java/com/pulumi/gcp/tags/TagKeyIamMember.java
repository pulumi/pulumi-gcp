...
import com.pulumi.gcp.tags.inputs.TagKeyIamMemberState;
import com.pulumi.gcp.tags.outputs.TagKeyIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:tags/tagKeyIamMember:TagKeyIamMember editor &#34;tagKeys/{{tag_key}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TagKeyIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={TagKeyIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ TagKeyIamMemberCondition> condition;

    public Output<Optional<TagKeyIamMemberCondition>> condition() {
     ...
     */
    public TagKeyIamMember(java.lang.String name) {
     ...
     */
    public TagKeyIamMember(java.lang.String name, TagKeyIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TagKeyIamMember(java.lang.String name, TagKeyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:tags/tagKeyIamMember:TagKeyIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TagKeyIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable TagKeyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:tags/tagKeyIamMember:TagKeyIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static TagKeyIamMemberArgs makeArgs(TagKeyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TagKeyIamMemberArgs.Empty : args;
    }
     ...
     */
    public static TagKeyIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable TagKeyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
