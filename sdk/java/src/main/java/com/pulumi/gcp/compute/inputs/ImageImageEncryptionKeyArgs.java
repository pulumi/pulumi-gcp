...
public final class ImageImageEncryptionKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final ImageImageEncryptionKeyArgs Empty = new ImageImageEncryptionKeyArgs();
    ...
    public static Builder builder(ImageImageEncryptionKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ImageImageEncryptionKeyArgs();
        }

        public Builder(ImageImageEncryptionKeyArgs defaults) {
            $ = new ImageImageEncryptionKeyArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param kmsKeySelfLink The self link of the encryption key that is stored in Google Cloud
         * KMS.
         * 
         * @return builder
         * 
