...
@CustomType
public final class ClusterSecretSyncConfigRotationConfig {
    /**
    ...
    public static Builder builder(ClusterSecretSyncConfigRotationConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rotationInterval;
        public Builder() {}
        public Builder(ClusterSecretSyncConfigRotationConfig defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("ClusterSecretSyncConfigRotationConfig", "enabled");
            }
        ...
        public ClusterSecretSyncConfigRotationConfig build() {
            final var _resultValue = new ClusterSecretSyncConfigRotationConfig();
