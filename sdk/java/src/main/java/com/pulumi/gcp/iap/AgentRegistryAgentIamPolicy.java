...
import com.pulumi.gcp.iap.inputs.AgentRegistryAgentIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryAgentIamPolicy:AgentRegistryAgentIamPolicy")
public class AgentRegistryAgentIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AgentRegistryAgentIamPolicy(java.lang.String name) {
        this(name, AgentRegistryAgentIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryAgentIamPolicy(java.lang.String name, AgentRegistryAgentIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryAgentIamPolicy(java.lang.String name, AgentRegistryAgentIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryAgentIamPolicy:AgentRegistryAgentIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryAgentIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryAgentIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryAgentIamPolicy:AgentRegistryAgentIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryAgentIamPolicyArgs makeArgs(AgentRegistryAgentIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryAgentIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryAgentIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryAgentIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
