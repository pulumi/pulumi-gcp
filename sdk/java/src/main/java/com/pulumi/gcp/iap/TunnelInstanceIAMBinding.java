 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/tunnelInstanceIAMBinding:TunnelInstanceIAMBinding editor &#34;projects/{{project}}/iap_tunnel/zones/{{zone}}/instances/{{tunnel_instance}} roles/iap.tunnelResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TunnelInstanceIAMBinding extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={TunnelInstanceIAMBindingCondition.class}, tree="[0]")
     ...
     */
    public TunnelInstanceIAMBinding(java.lang.String name) {
     ...
     */
    public TunnelInstanceIAMBinding(java.lang.String name, TunnelInstanceIAMBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TunnelInstanceIAMBinding(java.lang.String name, TunnelInstanceIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelInstanceIAMBinding:TunnelInstanceIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TunnelInstanceIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelInstanceIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelInstanceIAMBinding:TunnelInstanceIAMBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TunnelInstanceIAMBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelInstanceIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
