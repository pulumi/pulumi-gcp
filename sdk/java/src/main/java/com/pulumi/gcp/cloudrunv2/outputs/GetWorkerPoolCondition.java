...
@CustomType
public final class GetWorkerPoolCondition {
    /**
    ...
    private GetWorkerPoolCondition() {}
    /**
     * @return A reason for the execution condition.
     * 
     */
    ...
    public static Builder builder(GetWorkerPoolCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetWorkerPoolCondition defaults) {
        ...
        public Builder executionReason(String executionReason) {
            if (executionReason == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "executionReason");
            }
        ...
        public Builder lastTransitionTime(String lastTransitionTime) {
            if (lastTransitionTime == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "lastTransitionTime");
            }
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "message");
            }
        ...
        public Builder reason(String reason) {
            if (reason == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "reason");
            }
            this.reason = reason;
            return this;
        }
        ...
        public Builder revisionReason(String revisionReason) {
            if (revisionReason == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "revisionReason");
            }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "severity");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolCondition", "type");
            }
            this.type = type;
            return this;
        }
        public GetWorkerPoolCondition build() {
            final var _resultValue = new GetWorkerPoolCondition();
