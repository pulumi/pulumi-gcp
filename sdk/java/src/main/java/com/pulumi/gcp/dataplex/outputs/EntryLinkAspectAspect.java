...
@CustomType
public final class EntryLinkAspectAspect {
    /**
     * @return (Output)
    ...
    public static Builder builder(EntryLinkAspectAspect defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updateTime;
        public Builder() {}
        public Builder(EntryLinkAspectAspect defaults) {
        ...
        public Builder data(String data) {
            if (data == null) {
              throw new MissingRequiredPropertyException("EntryLinkAspectAspect", "data");
            }
            this.data = data;
            return this;
        }
        ...
        public EntryLinkAspectAspect build() {
            final var _resultValue = new EntryLinkAspectAspect();
