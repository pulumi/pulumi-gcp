...
@CustomType
public final class HostingCustomDomainCertVerificationDnsDiscoveredRecord {
    /**
    ...
    private HostingCustomDomainCertVerificationDnsDiscoveredRecord() {}
    /**
     * @return The domain name the record pertains to, e.g. `foo.bar.com.`.
     * 
     */
    ...
    public static Builder builder(HostingCustomDomainCertVerificationDnsDiscoveredRecord defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(HostingCustomDomainCertVerificationDnsDiscoveredRecord defaults) {
