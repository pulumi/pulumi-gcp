...
@CustomType
public final class InstanceDenyMaintenancePeriodEndDate {
    /**
    ...
    public static Builder builder(InstanceDenyMaintenancePeriodEndDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(InstanceDenyMaintenancePeriodEndDate defaults) {
        ...
        public InstanceDenyMaintenancePeriodEndDate build() {
            final var _resultValue = new InstanceDenyMaintenancePeriodEndDate();
