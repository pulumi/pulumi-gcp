...
@CustomType
public final class DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionEnumTypeOptions {
    /**
    ...
    public static Builder builder(DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionEnumTypeOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validationCheckDisabled;
        public Builder() {}
        public Builder(DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionEnumTypeOptions defaults) {
        ...
        public Builder possibleValues(List<String> possibleValues) {
            if (possibleValues == null) {
              throw new MissingRequiredPropertyException("DocumentAiWarehouseDocumentSchemaPropertyDefinitionPropertyTypeOptionsPropertyDefinitionEnumTypeOptions", "possibleValues");
            }
