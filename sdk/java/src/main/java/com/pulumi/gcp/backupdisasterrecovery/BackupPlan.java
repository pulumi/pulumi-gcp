...
import com.pulumi.gcp.backupdisasterrecovery.outputs.BackupPlanComputeInstanceBackupPlanProperties;
import com.pulumi.gcp.backupdisasterrecovery.outputs.BackupPlanDiskBackupPlanProperties;
...
public class BackupPlan extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<BackupPlanBackupRule>> backupRules;
     ...
     * 
     */
    public Output<Optional<List<BackupPlanBackupRule>>> backupRules() {
        return Codegen.optional(this.backupRules);
    }
    /**
     ...
     * 
     */
    @Export(name="computeInstanceBackupPlanProperties", refs={BackupPlanComputeInstanceBackupPlanProperties.class}, tree="[0]")
    private Output</* @Nullable */ BackupPlanComputeInstanceBackupPlanProperties> computeInstanceBackupPlanProperties;
     ...
     * 
     */
    public Output<Optional<BackupPlanComputeInstanceBackupPlanProperties>> computeInstanceBackupPlanProperties() {
        return Codegen.optional(this.computeInstanceBackupPlanProperties);
    }
    /**
     ...
     * 
     */
    @Export(name="diskBackupPlanProperties", refs={BackupPlanDiskBackupPlanProperties.class}, tree="[0]")
    private Output</* @Nullable */ BackupPlanDiskBackupPlanProperties> diskBackupPlanProperties;
     ...
     * 
     */
    public Output<Optional<BackupPlanDiskBackupPlanProperties>> diskBackupPlanProperties() {
        return Codegen.optional(this.diskBackupPlanProperties);
    }
    /**
