...
@CustomType
public final class ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading {
    /**
    ...
    private ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading() {}
    /**
     * @return Possible kernel module loading policies.
     * Accepted values are:
     * * `POLICY_UNSPECIFIED`: Default if unset. GKE selects the image based on node type. For CPU and TPU nodes, the image will not allow loading external kernel modules. For GPU nodes, the image will allow loading any module, whether it is signed or not.
    ...
    public static Builder builder(ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading defaults) {
    ...
    public static final class Builder {
        private @Nullable String policy;
        public Builder() {}
        public Builder(ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading defaults) {
        ...
        public ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading build() {
            final var _resultValue = new ClusterNodeConfigLinuxNodeConfigNodeKernelModuleLoading();
