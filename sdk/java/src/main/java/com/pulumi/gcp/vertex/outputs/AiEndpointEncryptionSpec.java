...
@CustomType
public final class AiEndpointEncryptionSpec {
    /**
    ...
    private AiEndpointEncryptionSpec() {}
    /**
     * @return Required. The Cloud KMS resource identifier of the customer managed encryption key used to protect a resource. Has the form: `projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key`. The key needs to be in the same region as where the compute resource is created.
     * 
     */
    ...
    public static Builder builder(AiEndpointEncryptionSpec defaults) {
    ...
    public static final class Builder {
        private String kmsKeyName;
        public Builder() {}
        public Builder(AiEndpointEncryptionSpec defaults) {
        ...
        public Builder kmsKeyName(String kmsKeyName) {
            if (kmsKeyName == null) {
              throw new MissingRequiredPropertyException("AiEndpointEncryptionSpec", "kmsKeyName");
            }
