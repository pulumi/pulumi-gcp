...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcsArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcsArgs", "bucket");
            }
            if ($.object == null) {
                throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcsArgs", "object");
            }
            return $;
        }
    }
