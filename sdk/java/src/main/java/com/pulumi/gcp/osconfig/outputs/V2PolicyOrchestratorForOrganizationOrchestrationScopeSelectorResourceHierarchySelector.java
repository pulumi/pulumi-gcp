...
@CustomType
public final class V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector {
    /**
    ...
    public static Builder builder(V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedProjects;
        public Builder() {}
        public Builder(V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector defaults) {
        ...
        public V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector build() {
            final var _resultValue = new V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector();
