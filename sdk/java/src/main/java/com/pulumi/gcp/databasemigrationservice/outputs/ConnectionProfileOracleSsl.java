...
@CustomType
public final class ConnectionProfileOracleSsl {
    /**
    ...
    public static Builder builder(ConnectionProfileOracleSsl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(ConnectionProfileOracleSsl defaults) {
        ...
        public Builder caCertificate(String caCertificate) {
            if (caCertificate == null) {
              throw new MissingRequiredPropertyException("ConnectionProfileOracleSsl", "caCertificate");
            }
