...
public final class AssetIamMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("AssetIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("AssetIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public AssetIamMemberCondition build() {
            final var _resultValue = new AssetIamMemberCondition();
