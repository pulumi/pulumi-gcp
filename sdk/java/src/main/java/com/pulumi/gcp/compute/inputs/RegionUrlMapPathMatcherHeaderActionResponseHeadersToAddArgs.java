...
public final class RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs Empty = new RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs();
    ...
    private RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs() {}

    private RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs(RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs $) {
    ...
    public static Builder builder(RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs();
        }

        public Builder(RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs defaults) {
            $ = new RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionUrlMapPathMatcherHeaderActionResponseHeadersToAddArgs build() {
            return $;
        }
    }
