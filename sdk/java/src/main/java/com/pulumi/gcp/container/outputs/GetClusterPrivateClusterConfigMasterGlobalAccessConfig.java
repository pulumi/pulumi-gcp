...
public final class GetClusterPrivateClusterConfigMasterGlobalAccessConfig {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetClusterPrivateClusterConfigMasterGlobalAccessConfig", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public GetClusterPrivateClusterConfigMasterGlobalAccessConfig build() {
            final var _resultValue = new GetClusterPrivateClusterConfigMasterGlobalAccessConfig();
