...
import com.pulumi.gcp.dataplex.inputs.GlossaryIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/glossaryIamPolicy:GlossaryIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/glossaries/{{glossary_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataplex/glossaryIamPolicy:GlossaryIamPolicy")
public class GlossaryIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public GlossaryIamPolicy(java.lang.String name) {
        this(name, GlossaryIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GlossaryIamPolicy(java.lang.String name, GlossaryIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GlossaryIamPolicy(java.lang.String name, GlossaryIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/glossaryIamPolicy:GlossaryIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GlossaryIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable GlossaryIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/glossaryIamPolicy:GlossaryIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static GlossaryIamPolicyArgs makeArgs(GlossaryIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GlossaryIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static GlossaryIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable GlossaryIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
