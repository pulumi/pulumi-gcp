...
import com.pulumi.gcp.sql.outputs.GetDatabaseInstancesInstanceSettingPerformanceCaptureConfig;
import com.pulumi.gcp.sql.outputs.GetDatabaseInstancesInstanceSettingReadPoolAutoScaleConfig;
...
public final class GetDatabaseInstancesInstanceSetting {
     ...
     * 
     */
    private List<GetDatabaseInstancesInstanceSettingPerformanceCaptureConfig> performanceCaptureConfigs;
    /**
     ...
     * 
     */
    private List<GetDatabaseInstancesInstanceSettingReadPoolAutoScaleConfig> readPoolAutoScaleConfigs;
    /**
     * @return The acceptable replication lag, in seconds, after which a read replica recreates itself. The lag must persist for at least five minutes before recreation is triggered. This is a replica level field, and must be between 300 seconds (five minutes) and 31536000 seconds (one year).
     * 
     */
    private Integer replicationLagMaxSeconds;
    /**
     ...
     * 
     */
    public List<GetDatabaseInstancesInstanceSettingFinalBackupConfig> finalBackupConfigs() {
        return this.finalBackupConfigs;
    }
    /**
     * @return Configuration of Query Insights.
     * 
     ...
     * 
     */
    public List<GetDatabaseInstancesInstanceSettingPerformanceCaptureConfig> performanceCaptureConfigs() {
     ...
     * 
     */
    public List<GetDatabaseInstancesInstanceSettingReadPoolAutoScaleConfig> readPoolAutoScaleConfigs() {
     ...
     * 
     */
    public Integer replicationLagMaxSeconds() {
    ...
    public static final class Builder {
        ...
        public Builder finalBackupConfigs(List<GetDatabaseInstancesInstanceSettingFinalBackupConfig> finalBackupConfigs) {
            ...
            this.finalBackupConfigs = finalBackupConfigs;
            return this;
        }
        public Builder finalBackupConfigs(GetDatabaseInstancesInstanceSettingFinalBackupConfig... finalBackupConfigs) {
            return finalBackupConfigs(List.of(finalBackupConfigs));
        }
        @CustomType.Setter
        ...
        @CustomType.Setter
        public Builder performanceCaptureConfigs(List<GetDatabaseInstancesInstanceSettingPerformanceCaptureConfig> performanceCaptureConfigs) {
            if (performanceCaptureConfigs == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstancesInstanceSetting", "performanceCaptureConfigs");
            }
            this.performanceCaptureConfigs = performanceCaptureConfigs;
            return this;
        }
        public Builder performanceCaptureConfigs(GetDatabaseInstancesInstanceSettingPerformanceCaptureConfig... performanceCaptureConfigs) {
        ...
        @CustomType.Setter
        public Builder readPoolAutoScaleConfigs(List<GetDatabaseInstancesInstanceSettingReadPoolAutoScaleConfig> readPoolAutoScaleConfigs) {
            if (readPoolAutoScaleConfigs == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstancesInstanceSetting", "readPoolAutoScaleConfigs");
            }
            this.readPoolAutoScaleConfigs = readPoolAutoScaleConfigs;
            return this;
        }
        public Builder readPoolAutoScaleConfigs(GetDatabaseInstancesInstanceSettingReadPoolAutoScaleConfig... readPoolAutoScaleConfigs) {
        ...
        public Builder replicationLagMaxSeconds(Integer replicationLagMaxSeconds) {
            if (replicationLagMaxSeconds == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstancesInstanceSetting", "replicationLagMaxSeconds");
            }
