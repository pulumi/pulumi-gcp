...
public final class CertificateConfigSubjectConfigSubject {
    ...
    public static final class Builder {
        ...
        public Builder commonName(String commonName) {
            if (commonName == null) {
              throw new MissingRequiredPropertyException("CertificateConfigSubjectConfigSubject", "commonName");
            }
        ...
        public CertificateConfigSubjectConfigSubject build() {
            final var _resultValue = new CertificateConfigSubjectConfigSubject();
