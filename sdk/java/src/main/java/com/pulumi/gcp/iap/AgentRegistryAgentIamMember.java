...
import com.pulumi.gcp.iap.inputs.AgentRegistryAgentIamMemberState;
import com.pulumi.gcp.iap.outputs.AgentRegistryAgentIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryAgentIamMember:AgentRegistryAgentIamMember")
public class AgentRegistryAgentIamMember extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="condition", refs={AgentRegistryAgentIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ AgentRegistryAgentIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<AgentRegistryAgentIamMemberCondition>> condition() {
     ...
     */
    public AgentRegistryAgentIamMember(java.lang.String name) {
        this(name, AgentRegistryAgentIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryAgentIamMember(java.lang.String name, AgentRegistryAgentIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryAgentIamMember(java.lang.String name, AgentRegistryAgentIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryAgentIamMember:AgentRegistryAgentIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryAgentIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryAgentIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryAgentIamMember:AgentRegistryAgentIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryAgentIamMemberArgs makeArgs(AgentRegistryAgentIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryAgentIamMemberArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryAgentIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryAgentIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
