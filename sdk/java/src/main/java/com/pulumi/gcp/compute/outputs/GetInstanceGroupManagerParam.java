...
@CustomType
public final class GetInstanceGroupManagerParam {
    /**
    ...
    public static Builder builder(GetInstanceGroupManagerParam defaults) {
    ...
    public static final class Builder {
        ...
        public GetInstanceGroupManagerParam build() {
            final var _resultValue = new GetInstanceGroupManagerParam();
