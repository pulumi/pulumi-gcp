...
@CustomType
public final class RegionUrlMapHeaderActionResponseHeadersToAdd {
    /**
    ...
    public static Builder builder(RegionUrlMapHeaderActionResponseHeadersToAdd defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean replace;
        public Builder() {}
        public Builder(RegionUrlMapHeaderActionResponseHeadersToAdd defaults) {
        ...
        public RegionUrlMapHeaderActionResponseHeadersToAdd build() {
            final var _resultValue = new RegionUrlMapHeaderActionResponseHeadersToAdd();
