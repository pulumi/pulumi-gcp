...
public final class URLMapPathMatcherRouteRuleHeaderActionArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<List<URLMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddArgs>>> requestHeadersToAdds() {
     ...
     * 
     */
    public Optional<Output<List<URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs>>> responseHeadersToAdds() {
    ...
    private URLMapPathMatcherRouteRuleHeaderActionArgs(URLMapPathMatcherRouteRuleHeaderActionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherRouteRuleHeaderActionArgs();
        }

        public Builder(URLMapPathMatcherRouteRuleHeaderActionArgs defaults) {
            $ = new URLMapPathMatcherRouteRuleHeaderActionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requestHeadersToAdds(List<URLMapPathMatcherRouteRuleHeaderActionRequestHeadersToAddArgs> requestHeadersToAdds) {
         ...
         * 
         */
        public Builder responseHeadersToAdds(List<URLMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs> responseHeadersToAdds) {
