...
@CustomType
public final class CertificateConfigX509ConfigNameConstraints {
    /**
    ...
    public static Builder builder(CertificateConfigX509ConfigNameConstraints defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> permittedUris;
        public Builder() {}
        public Builder(CertificateConfigX509ConfigNameConstraints defaults) {
        ...
        public Builder critical(Boolean critical) {
            if (critical == null) {
              throw new MissingRequiredPropertyException("CertificateConfigX509ConfigNameConstraints", "critical");
            }
        ...
        public CertificateConfigX509ConfigNameConstraints build() {
            final var _resultValue = new CertificateConfigX509ConfigNameConstraints();
