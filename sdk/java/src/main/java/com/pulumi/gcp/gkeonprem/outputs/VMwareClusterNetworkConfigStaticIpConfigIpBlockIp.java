...
public final class VMwareClusterNetworkConfigStaticIpConfigIpBlockIp {
    ...
    public static Builder builder(VMwareClusterNetworkConfigStaticIpConfigIpBlockIp defaults) {
    ...
    public static final class Builder {
        ...
        public Builder ip(String ip) {
            if (ip == null) {
              throw new MissingRequiredPropertyException("VMwareClusterNetworkConfigStaticIpConfigIpBlockIp", "ip");
            }
            this.ip = ip;
            return this;
        }
