...
import com.pulumi.gcp.iam.inputs.WorkloadIdentityPoolIamMemberState;
import com.pulumi.gcp.iam.outputs.WorkloadIdentityPoolIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iam/workloadIdentityPoolIamMember:WorkloadIdentityPoolIamMember editor &#34;projects/{{project}}/locations/global/workloadIdentityPools/{{workload_identity_pool_id}} roles/iam.workloadIdentityPoolViewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iam/workloadIdentityPoolIamMember:WorkloadIdentityPoolIamMember")
public class WorkloadIdentityPoolIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={WorkloadIdentityPoolIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ WorkloadIdentityPoolIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<WorkloadIdentityPoolIamMemberCondition>> condition() {
     ...
     */
    public WorkloadIdentityPoolIamMember(java.lang.String name) {
        this(name, WorkloadIdentityPoolIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WorkloadIdentityPoolIamMember(java.lang.String name, WorkloadIdentityPoolIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkloadIdentityPoolIamMember(java.lang.String name, WorkloadIdentityPoolIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iam/workloadIdentityPoolIamMember:WorkloadIdentityPoolIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WorkloadIdentityPoolIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable WorkloadIdentityPoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iam/workloadIdentityPoolIamMember:WorkloadIdentityPoolIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static WorkloadIdentityPoolIamMemberArgs makeArgs(WorkloadIdentityPoolIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WorkloadIdentityPoolIamMemberArgs.Empty : args;
    }
     ...
     */
    public static WorkloadIdentityPoolIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkloadIdentityPoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
