...
import com.pulumi.gcp.dataproc.inputs.ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigAttachedDiskConfigArgs;
...
public final class ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs Empty = new ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs();
    ...
    private @Nullable Output<List<ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigAttachedDiskConfigArgs>> attachedDiskConfigs;

    /**
     * @return Attached disk configuration.
     * 
     */
    public Optional<Output<List<ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigAttachedDiskConfigArgs>>> attachedDiskConfigs() {
    ...
    private ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs() {}

    private ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs(ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs $) {
    ...
    public static Builder builder(ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs();
        }

        public Builder(ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs defaults) {
            $ = new ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder attachedDiskConfigs(@Nullable Output<List<ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigAttachedDiskConfigArgs>> attachedDiskConfigs) {
         ...
         * 
         */
        public Builder attachedDiskConfigs(List<ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigAttachedDiskConfigArgs> attachedDiskConfigs) {
         ...
         * 
         */
        public Builder attachedDiskConfigs(ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigAttachedDiskConfigArgs... attachedDiskConfigs) {
            return attachedDiskConfigs(List.of(attachedDiskConfigs));
        }

        /**
         * @param bootDiskProvisionedIops Indicates how many IOPS to provision for the disk.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param bootDiskProvisionedThroughput Indicates how much throughput to provision for the disk.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param localSsdInterface Interface type of local SSDs (no Local SSDs or NVMe).
         * 
         * @return builder
         * 
         */
        ...
        public ClusterClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListDiskConfigArgs build() {
            return $;
        }
    }
