...
import com.pulumi.gcp.biglake.inputs.HiveDatabaseIamBindingState;
import com.pulumi.gcp.biglake.outputs.HiveDatabaseIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveDatabaseIamBinding:HiveDatabaseIamBinding")
public class HiveDatabaseIamBinding extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={HiveDatabaseIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ HiveDatabaseIamBindingCondition> condition;

    public Output<Optional<HiveDatabaseIamBindingCondition>> condition() {
     ...
     */
    public HiveDatabaseIamBinding(java.lang.String name) {
        this(name, HiveDatabaseIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveDatabaseIamBinding(java.lang.String name, HiveDatabaseIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveDatabaseIamBinding(java.lang.String name, HiveDatabaseIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveDatabaseIamBinding:HiveDatabaseIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveDatabaseIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable HiveDatabaseIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveDatabaseIamBinding:HiveDatabaseIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveDatabaseIamBindingArgs makeArgs(HiveDatabaseIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveDatabaseIamBindingArgs.Empty : args;
    }
     ...
     */
    public static HiveDatabaseIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveDatabaseIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
