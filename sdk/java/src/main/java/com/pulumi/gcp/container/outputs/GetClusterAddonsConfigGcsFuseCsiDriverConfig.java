...
public final class GetClusterAddonsConfigGcsFuseCsiDriverConfig {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetClusterAddonsConfigGcsFuseCsiDriverConfig", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public GetClusterAddonsConfigGcsFuseCsiDriverConfig build() {
            final var _resultValue = new GetClusterAddonsConfigGcsFuseCsiDriverConfig();
