...
import com.pulumi.gcp.compute.inputs.NetworkFirewallPolicyIamBindingState;
import com.pulumi.gcp.compute.outputs.NetworkFirewallPolicyIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:compute/networkFirewallPolicyIamBinding:NetworkFirewallPolicyIamBinding")
public class NetworkFirewallPolicyIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={NetworkFirewallPolicyIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ NetworkFirewallPolicyIamBindingCondition> condition;

    public Output<Optional<NetworkFirewallPolicyIamBindingCondition>> condition() {
     ...
     */
    public NetworkFirewallPolicyIamBinding(java.lang.String name) {
        this(name, NetworkFirewallPolicyIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public NetworkFirewallPolicyIamBinding(java.lang.String name, NetworkFirewallPolicyIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NetworkFirewallPolicyIamBinding(java.lang.String name, NetworkFirewallPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/networkFirewallPolicyIamBinding:NetworkFirewallPolicyIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NetworkFirewallPolicyIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkFirewallPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/networkFirewallPolicyIamBinding:NetworkFirewallPolicyIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static NetworkFirewallPolicyIamBindingArgs makeArgs(NetworkFirewallPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NetworkFirewallPolicyIamBindingArgs.Empty : args;
    }
     ...
     */
    public static NetworkFirewallPolicyIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkFirewallPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new NetworkFirewallPolicyIamBinding(name, id, state, options);
    }
}
