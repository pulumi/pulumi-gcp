 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrun/iamPolicy:IamPolicy editor &#34;projects/{{project}}/locations/{{location}}/services/{{service}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class IamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public IamPolicy(java.lang.String name, IamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrun/iamPolicy:IamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable IamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrun/iamPolicy:IamPolicy", name, state, makeResourceOptions(options, id), false);
    }
