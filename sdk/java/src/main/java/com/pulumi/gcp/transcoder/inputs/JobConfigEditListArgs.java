...
public final class JobConfigEditListArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobConfigEditListArgs Empty = new JobConfigEditListArgs();
    ...
    private JobConfigEditListArgs() {}

    private JobConfigEditListArgs(JobConfigEditListArgs $) {
        this.inputs = $.inputs;
        this.key = $.key;
    ...
    public static Builder builder(JobConfigEditListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobConfigEditListArgs();
        }

        public Builder(JobConfigEditListArgs defaults) {
            $ = new JobConfigEditListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobConfigEditListArgs build() {
            return $;
        }
    }
