...
public final class CxPageEntryFulfillmentMessagePlayAudioArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxPageEntryFulfillmentMessagePlayAudioArgs Empty = new CxPageEntryFulfillmentMessagePlayAudioArgs();
    ...
    private CxPageEntryFulfillmentMessagePlayAudioArgs() {}

    private CxPageEntryFulfillmentMessagePlayAudioArgs(CxPageEntryFulfillmentMessagePlayAudioArgs $) {
    ...
    public static Builder builder(CxPageEntryFulfillmentMessagePlayAudioArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageEntryFulfillmentMessagePlayAudioArgs();
        }

        public Builder(CxPageEntryFulfillmentMessagePlayAudioArgs defaults) {
            $ = new CxPageEntryFulfillmentMessagePlayAudioArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CxPageEntryFulfillmentMessagePlayAudioArgs build() {
            if ($.audioUri == null) {
                throw new MissingRequiredPropertyException("CxPageEntryFulfillmentMessagePlayAudioArgs", "audioUri");
            }
            return $;
        }
    }
