...
public final class PreventionInspectTemplateInspectConfigInfoTypeSensitivityScore {
    ...
    public static final class Builder {
        ...
        public Builder score(String score) {
            if (score == null) {
              throw new MissingRequiredPropertyException("PreventionInspectTemplateInspectConfigInfoTypeSensitivityScore", "score");
            }
            this.score = score;
            return this;
        }
        public PreventionInspectTemplateInspectConfigInfoTypeSensitivityScore build() {
            final var _resultValue = new PreventionInspectTemplateInspectConfigInfoTypeSensitivityScore();
