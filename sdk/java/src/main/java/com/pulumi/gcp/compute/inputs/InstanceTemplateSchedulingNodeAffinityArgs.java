...
public final class InstanceTemplateSchedulingNodeAffinityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public InstanceTemplateSchedulingNodeAffinityArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("InstanceTemplateSchedulingNodeAffinityArgs", "key");
            }
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("InstanceTemplateSchedulingNodeAffinityArgs", "operator");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("InstanceTemplateSchedulingNodeAffinityArgs", "values");
            }
            return $;
        }
    }
