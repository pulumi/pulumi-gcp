...
@CustomType
public final class CxToolVersionToolDataStoreSpecDataStoreConnection {
    /**
    ...
    private CxToolVersionToolDataStoreSpecDataStoreConnection() {}
    /**
     * @return The full name of the referenced data store. Formats: projects/{project}/locations/{location}/collections/{collection}/dataStores/{dataStore} projects/{project}/locations/{location}/dataStores/{dataStore}
     * 
     */
    ...
    public static Builder builder(CxToolVersionToolDataStoreSpecDataStoreConnection defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String documentProcessingMode;
        public Builder() {}
        public Builder(CxToolVersionToolDataStoreSpecDataStoreConnection defaults) {
        ...
        public CxToolVersionToolDataStoreSpecDataStoreConnection build() {
            final var _resultValue = new CxToolVersionToolDataStoreSpecDataStoreConnection();
