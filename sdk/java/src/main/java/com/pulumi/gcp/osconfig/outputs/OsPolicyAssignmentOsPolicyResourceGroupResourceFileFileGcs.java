...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcs {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcs", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcs", "object");
            }
            this.object = object;
            return this;
        }
        public OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcs build() {
            final var _resultValue = new OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcs();
