...
import com.pulumi.gcp.ces.inputs.ToolConnectorToolArgs;
...
import com.pulumi.gcp.ces.inputs.ToolMcpToolArgs;
...
public final class ToolState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="connectorTools")
    private @Nullable Output<List<ToolConnectorToolArgs>> connectorTools;
     ...
     * 
     */
    public Optional<Output<List<ToolConnectorToolArgs>>> connectorTools() {
        return Optional.ofNullable(this.connectorTools);
    }
     ...
     * 
     */
    @Import(name="mcpTools")
    private @Nullable Output<List<ToolMcpToolArgs>> mcpTools;
     ...
     * 
     */
    public Optional<Output<List<ToolMcpToolArgs>>> mcpTools() {
        return Optional.ofNullable(this.mcpTools);
    }
     ...
     * 
     */
    @Import(name="remoteAgentTools")
    private @Nullable Output<List<ToolRemoteAgentToolArgs>> remoteAgentTools;
     ...
     * 
     */
    public Optional<Output<List<ToolRemoteAgentToolArgs>>> remoteAgentTools() {
        return Optional.ofNullable(this.remoteAgentTools);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder connectorTools(@Nullable Output<List<ToolConnectorToolArgs>> connectorTools) {
         ...
         * 
         */
        public Builder connectorTools(List<ToolConnectorToolArgs> connectorTools) {
            return connectorTools(Output.of(connectorTools));
        }
         ...
         * 
         */
        public Builder connectorTools(ToolConnectorToolArgs... connectorTools) {
            return connectorTools(List.of(connectorTools));
        }
         ...
         * 
         */
        public Builder mcpTools(@Nullable Output<List<ToolMcpToolArgs>> mcpTools) {
            $.mcpTools = mcpTools;
            return this;
        }
         ...
         * 
         */
        public Builder mcpTools(List<ToolMcpToolArgs> mcpTools) {
            return mcpTools(Output.of(mcpTools));
        }
         ...
         * 
         */
        public Builder mcpTools(ToolMcpToolArgs... mcpTools) {
            return mcpTools(List.of(mcpTools));
        }
         ...
         * 
         */
        public Builder remoteAgentTools(@Nullable Output<List<ToolRemoteAgentToolArgs>> remoteAgentTools) {
         ...
         * 
         */
        public Builder remoteAgentTools(List<ToolRemoteAgentToolArgs> remoteAgentTools) {
            return remoteAgentTools(Output.of(remoteAgentTools));
        }
         ...
         * 
         */
        public Builder remoteAgentTools(ToolRemoteAgentToolArgs... remoteAgentTools) {
            return remoteAgentTools(List.of(remoteAgentTools));
        }
