...
public class ScopeIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public ScopeIamMember(String name) {
     ...
     */
    public ScopeIamMember(String name, ScopeIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ScopeIamMember(String name, ScopeIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/scopeIamMember:ScopeIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private ScopeIamMember(String name, Output<String> id, @Nullable ScopeIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/scopeIamMember:ScopeIamMember", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ScopeIamMember get(String name, Output<String> id, @Nullable ScopeIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
