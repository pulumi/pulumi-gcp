...
public final class NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs extends com.pulumi.resources.ResourceArgs {

    public static final NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs Empty = new NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs();
    ...
    private NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs() {}

    private NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs(NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs $) {
    ...
    public static Builder builder(NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs();
        }

        public Builder(NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs defaults) {
            $ = new NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param imagefsAvailable Defines grace period for the imagefs.available soft eviction threshold
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param imagefsInodesFree Defines grace period for the imagefs.inodesFree soft eviction threshold.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param memoryAvailable Defines grace period for the memory.available soft eviction threshold.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodefsAvailable Defines grace period for the nodefs.available soft eviction threshold.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodefsInodesFree Defines grace period for the nodefs.inodesFree soft eviction threshold.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param pidAvailable Defines grace period for the pid.available soft eviction threshold.
         * 
         * @return builder
         * 
         */
        ...
        public NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs build() {
            return $;
        }
    }
