...
public class GlobalForwardingRule extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="externalManagedBackendBucketMigrationState", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> externalManagedBackendBucketMigrationState;
     ...
     * 
     */
    public Output<Optional<String>> externalManagedBackendBucketMigrationState() {
        return Codegen.optional(this.externalManagedBackendBucketMigrationState);
    }
    /**
     ...
     * 
     */
    @Export(name="externalManagedBackendBucketMigrationTestingPercentage", refs={Double.class}, tree="[0]")
    private Output</* @Nullable */ Double> externalManagedBackendBucketMigrationTestingPercentage;
     ...
     * 
     */
    public Output<Optional<Double>> externalManagedBackendBucketMigrationTestingPercentage() {
        return Codegen.optional(this.externalManagedBackendBucketMigrationTestingPercentage);
    }
    /**
