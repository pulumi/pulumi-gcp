...
import com.pulumi.gcp.compute.inputs.InstantSnapshotIamMemberState;
import com.pulumi.gcp.compute.outputs.InstantSnapshotIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/instantSnapshotIamMember:InstantSnapshotIamMember editor &#34;projects/{{project}}/zones/{{zone}}/instantSnapshots/{{instant_snapshot}} roles/compute.storageAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/instantSnapshotIamMember:InstantSnapshotIamMember")
public class InstantSnapshotIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={InstantSnapshotIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ InstantSnapshotIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<InstantSnapshotIamMemberCondition>> condition() {
    ...
    /**
     * @return A reference to the zone where the disk is located. Used to find the parent resource to bind the IAM policy to. If not specified,
     * the value will be parsed from the identifier of the parent resource. If no zone is provided in the parent identifier and no
     * zone is specified, it is taken from the provider configuration.
     * 
     */
     ...
     */
    public InstantSnapshotIamMember(java.lang.String name) {
        this(name, InstantSnapshotIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InstantSnapshotIamMember(java.lang.String name, InstantSnapshotIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstantSnapshotIamMember(java.lang.String name, InstantSnapshotIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instantSnapshotIamMember:InstantSnapshotIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InstantSnapshotIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable InstantSnapshotIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instantSnapshotIamMember:InstantSnapshotIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static InstantSnapshotIamMemberArgs makeArgs(InstantSnapshotIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InstantSnapshotIamMemberArgs.Empty : args;
    }
     ...
     */
    public static InstantSnapshotIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable InstantSnapshotIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
