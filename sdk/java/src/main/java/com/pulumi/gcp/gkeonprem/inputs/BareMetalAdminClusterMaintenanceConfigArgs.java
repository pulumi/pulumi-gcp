...
public final class BareMetalAdminClusterMaintenanceConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final BareMetalAdminClusterMaintenanceConfigArgs Empty = new BareMetalAdminClusterMaintenanceConfigArgs();
    ...
    private BareMetalAdminClusterMaintenanceConfigArgs() {}

    private BareMetalAdminClusterMaintenanceConfigArgs(BareMetalAdminClusterMaintenanceConfigArgs $) {
    ...
    public static Builder builder(BareMetalAdminClusterMaintenanceConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BareMetalAdminClusterMaintenanceConfigArgs();
        }

        public Builder(BareMetalAdminClusterMaintenanceConfigArgs defaults) {
            $ = new BareMetalAdminClusterMaintenanceConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BareMetalAdminClusterMaintenanceConfigArgs build() {
            if ($.maintenanceAddressCidrBlocks == null) {
                throw new MissingRequiredPropertyException("BareMetalAdminClusterMaintenanceConfigArgs", "maintenanceAddressCidrBlocks");
            }
            return $;
        }
    }
