 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/zoneIamBinding:ZoneIamBinding editor &#34;projects/{{project}}/locations/{{location}}/lakes/{{lake}}/zones/{{zone}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class ZoneIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public ZoneIamBinding(java.lang.String name) {
     ...
     */
    public ZoneIamBinding(java.lang.String name, ZoneIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ZoneIamBinding(java.lang.String name, ZoneIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/zoneIamBinding:ZoneIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ZoneIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable ZoneIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/zoneIamBinding:ZoneIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static ZoneIamBindingArgs makeArgs(ZoneIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ZoneIamBindingArgs.Empty : args;
    }
     ...
     */
    public static ZoneIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable ZoneIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
