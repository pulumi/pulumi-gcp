 ...
 * 
 * ```sh
 * $ pulumi import gcp:gkehub/membershipIamBinding:MembershipIamBinding editor &#34;projects/{{project}}/locations/{{location}}/memberships/{{membership_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
