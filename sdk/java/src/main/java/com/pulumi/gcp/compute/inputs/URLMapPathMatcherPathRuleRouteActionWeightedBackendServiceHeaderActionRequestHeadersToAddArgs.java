...
public final class URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs build() {
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs", "headerName");
            }
            if ($.headerValue == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs", "headerValue");
            }
            if ($.replace == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs", "replace");
            }
            return $;
        }
    }
