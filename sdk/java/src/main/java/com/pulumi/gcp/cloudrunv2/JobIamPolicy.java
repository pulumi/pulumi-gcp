...
public class JobIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public JobIamPolicy(java.lang.String name, JobIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/jobIamPolicy:JobIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private JobIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable JobIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/jobIamPolicy:JobIamPolicy", name, state, makeResourceOptions(options, id), false);
    }
