    ...
    public static final class Builder {
        ...
        public Builder threadsPerCore(Integer threadsPerCore) {
            if (threadsPerCore == null) {
              throw new MissingRequiredPropertyException("ClusterNodePoolNodeConfigAdvancedMachineFeatures", "threadsPerCore");
            }
            this.threadsPerCore = threadsPerCore;
            return this;
        }
        public ClusterNodePoolNodeConfigAdvancedMachineFeatures build() {
            final var _resultValue = new ClusterNodePoolNodeConfigAdvancedMachineFeatures();
