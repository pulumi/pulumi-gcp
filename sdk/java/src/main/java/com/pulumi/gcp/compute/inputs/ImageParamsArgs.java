...
public final class ImageParamsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ImageParamsArgs Empty = new ImageParamsArgs();
    ...
    private ImageParamsArgs() {}

    private ImageParamsArgs(ImageParamsArgs $) {
    ...
    public static Builder builder(ImageParamsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ImageParamsArgs defaults) {
            $ = new ImageParamsArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param resourceManagerTags Resource manager tags to be bound to the image. Tag keys and values have the
         * same definition as resource manager tags. Keys and values can be either in numeric format,
         * such as tagKeys/{tag_key_id} and tagValues/{tag_value_id} or in namespaced format such as
         * {org_id|projectId}/{tag_key_short_name} and {tag_value_short_name}. The field is ignored when empty.
         * The field is immutable and causes resource replacement when mutated. This field is only
