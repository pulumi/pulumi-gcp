...
@CustomType
public final class ServiceTemplateVolumeEmptyDir {
    /**
    ...
    private ServiceTemplateVolumeEmptyDir() {}
    /**
     * @return The different types of medium supported for EmptyDir.
     * Default value is `MEMORY`.
     * Possible values are: `MEMORY`.
    ...
    public static Builder builder(ServiceTemplateVolumeEmptyDir defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sizeLimit;
        public Builder() {}
        public Builder(ServiceTemplateVolumeEmptyDir defaults) {
        ...
        public ServiceTemplateVolumeEmptyDir build() {
            final var _resultValue = new ServiceTemplateVolumeEmptyDir();
