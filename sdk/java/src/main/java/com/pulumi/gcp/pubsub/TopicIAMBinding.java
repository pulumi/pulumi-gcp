 ...
 * 
 * ```sh
 * $ pulumi import gcp:pubsub/topicIAMBinding:TopicIAMBinding editor &#34;projects/{{project}}/topics/{{topic}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TopicIAMBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={TopicIAMBindingCondition.class}, tree="[0]")
     ...
     */
    public TopicIAMBinding(java.lang.String name) {
     ...
     */
    public TopicIAMBinding(java.lang.String name, TopicIAMBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TopicIAMBinding(java.lang.String name, TopicIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/topicIAMBinding:TopicIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TopicIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable TopicIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/topicIAMBinding:TopicIAMBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TopicIAMBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable TopicIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
