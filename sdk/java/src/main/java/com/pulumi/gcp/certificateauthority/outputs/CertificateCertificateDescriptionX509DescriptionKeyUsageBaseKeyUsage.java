...
@CustomType
public final class CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsage {
    /**
    ...
    public static Builder builder(CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsage defaults) {
        ...
        public Builder keyEncipherment(@Nullable Boolean keyEncipherment) {
            this.keyEncipherment = keyEncipherment;
            return this;
        }        public CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsage build() {
            return new CertificateCertificateDescriptionX509DescriptionKeyUsageBaseKeyUsage(certSign, contentCommitment, crlSign, dataEncipherment, decipherOnly, digitalSignature, encipherOnly, keyAgreement, keyEncipherment);
        }
    }
}
