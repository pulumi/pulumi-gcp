...
import com.pulumi.gcp.compute.outputs.RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config;
...
@CustomType
public final class RegionNetworkPolicyTrafficClassificationRuleMatch {
    /**
     ...
     * 
     */
    private List<RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config> layer4Configs;
    /**
    ...
    private RegionNetworkPolicyTrafficClassificationRuleMatch() {}
    /**
     * @return CIDR IP address range. Maximum number of destination CIDR IP ranges allowed is 5000.
     * 
     */
     ...
     * 
     */
    public List<RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config> layer4Configs() {
    ...
    public static Builder builder(RegionNetworkPolicyTrafficClassificationRuleMatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> srcIpRanges;
        public Builder() {}
        public Builder(RegionNetworkPolicyTrafficClassificationRuleMatch defaults) {
        ...
        @CustomType.Setter
        public Builder layer4Configs(List<RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config> layer4Configs) {
            if (layer4Configs == null) {
              throw new MissingRequiredPropertyException("RegionNetworkPolicyTrafficClassificationRuleMatch", "layer4Configs");
            }
            this.layer4Configs = layer4Configs;
            return this;
        }
        public Builder layer4Configs(RegionNetworkPolicyTrafficClassificationRuleMatchLayer4Config... layer4Configs) {
        ...
        public RegionNetworkPolicyTrafficClassificationRuleMatch build() {
            final var _resultValue = new RegionNetworkPolicyTrafficClassificationRuleMatch();
