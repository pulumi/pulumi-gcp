...
public final class HealthCheckHttpsHealthCheckArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HealthCheckHttpsHealthCheckArgs(HealthCheckHttpsHealthCheckArgs $) {
        this.host = $.host;
        this.port = $.port;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HealthCheckHttpsHealthCheckArgs();
        }

        public Builder(HealthCheckHttpsHealthCheckArgs defaults) {
            $ = new HealthCheckHttpsHealthCheckArgs(Objects.requireNonNull(defaults));
        }
