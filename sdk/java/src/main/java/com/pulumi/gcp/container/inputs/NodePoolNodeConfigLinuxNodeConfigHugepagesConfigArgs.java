...
public final class NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs Empty = new NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs();
    ...
    private NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs() {}

    private NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs(NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs $) {
    ...
    public static Builder builder(NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs();
        }

        public Builder(NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs defaults) {
            $ = new NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NodePoolNodeConfigLinuxNodeConfigHugepagesConfigArgs build() {
            return $;
        }
    }
