...
@CustomType
public final class CxPageTransitionRouteTriggerFulfillmentSetParameterAction {
    /**
    ...
    private CxPageTransitionRouteTriggerFulfillmentSetParameterAction() {}
    /**
     * @return Display name of the parameter.
     * 
     */
    ...
    public static Builder builder(CxPageTransitionRouteTriggerFulfillmentSetParameterAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(CxPageTransitionRouteTriggerFulfillmentSetParameterAction defaults) {
