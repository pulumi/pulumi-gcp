...
public final class WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs(WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs();
        }

        public Builder(WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs defaults) {
            $ = new WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs(Objects.requireNonNull(defaults));
        }
