...
import com.pulumi.gcp.compute.outputs.URLMapPathMatcherDefaultRouteActionCachePolicyCacheKeyPolicy;
import com.pulumi.gcp.compute.outputs.URLMapPathMatcherDefaultRouteActionCachePolicyClientTtl;
import com.pulumi.gcp.compute.outputs.URLMapPathMatcherDefaultRouteActionCachePolicyDefaultTtl;
import com.pulumi.gcp.compute.outputs.URLMapPathMatcherDefaultRouteActionCachePolicyMaxTtl;
import com.pulumi.gcp.compute.outputs.URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy;
import com.pulumi.gcp.compute.outputs.URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale;
...
@CustomType
public final class URLMapPathMatcherDefaultRouteActionCachePolicy {
    /**
     ...
     * 
     */
    private @Nullable URLMapPathMatcherDefaultRouteActionCachePolicyCacheKeyPolicy cacheKeyPolicy;
    /**
     ...
     * 
     */
    private @Nullable URLMapPathMatcherDefaultRouteActionCachePolicyClientTtl clientTtl;
    /**
     ...
     * 
     */
    private @Nullable URLMapPathMatcherDefaultRouteActionCachePolicyDefaultTtl defaultTtl;
    /**
     ...
     * 
     */
    private @Nullable URLMapPathMatcherDefaultRouteActionCachePolicyMaxTtl maxTtl;
    /**
     ...
     * 
     */
    private @Nullable List<URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy> negativeCachingPolicies;
    /**
     ...
     * 
     */
    private @Nullable URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale serveWhileStale;

    private URLMapPathMatcherDefaultRouteActionCachePolicy() {}
    /**
     * @return Bypass the cache when the specified request headers are matched by name,
     * e.g. Pragma or Authorization headers. Values are case-insensitive. Up to 5
     * header names can be specified. The cache is bypassed for all cacheMode
     ...
     * 
     */
    public Optional<URLMapPathMatcherDefaultRouteActionCachePolicyCacheKeyPolicy> cacheKeyPolicy() {
     ...
     * 
     */
    public Optional<URLMapPathMatcherDefaultRouteActionCachePolicyClientTtl> clientTtl() {
     ...
     * 
     */
    public Optional<URLMapPathMatcherDefaultRouteActionCachePolicyDefaultTtl> defaultTtl() {
     ...
     * 
     */
    public Optional<URLMapPathMatcherDefaultRouteActionCachePolicyMaxTtl> maxTtl() {
     ...
     * 
     */
    public List<URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy> negativeCachingPolicies() {
     ...
     * 
     */
    public Optional<URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale> serveWhileStale() {
    ...
    public static Builder builder(URLMapPathMatcherDefaultRouteActionCachePolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale serveWhileStale;
        public Builder() {}
        public Builder(URLMapPathMatcherDefaultRouteActionCachePolicy defaults) {
        ...
        @CustomType.Setter
        public Builder cacheKeyPolicy(@Nullable URLMapPathMatcherDefaultRouteActionCachePolicyCacheKeyPolicy cacheKeyPolicy) {
        ...
        @CustomType.Setter
        public Builder clientTtl(@Nullable URLMapPathMatcherDefaultRouteActionCachePolicyClientTtl clientTtl) {

            this.clientTtl = clientTtl;
            return this;
        }
        @CustomType.Setter
        public Builder defaultTtl(@Nullable URLMapPathMatcherDefaultRouteActionCachePolicyDefaultTtl defaultTtl) {

            this.defaultTtl = defaultTtl;
            return this;
        }
        @CustomType.Setter
        public Builder maxTtl(@Nullable URLMapPathMatcherDefaultRouteActionCachePolicyMaxTtl maxTtl) {
        ...
        @CustomType.Setter
        public Builder negativeCachingPolicies(@Nullable List<URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy> negativeCachingPolicies) {

            this.negativeCachingPolicies = negativeCachingPolicies;
            return this;
        }
        public Builder negativeCachingPolicies(URLMapPathMatcherDefaultRouteActionCachePolicyNegativeCachingPolicy... negativeCachingPolicies) {
        ...
        @CustomType.Setter
        public Builder serveWhileStale(@Nullable URLMapPathMatcherDefaultRouteActionCachePolicyServeWhileStale serveWhileStale) {

            this.serveWhileStale = serveWhileStale;
            return this;
        }
        public URLMapPathMatcherDefaultRouteActionCachePolicy build() {
            final var _resultValue = new URLMapPathMatcherDefaultRouteActionCachePolicy();
