 ...
 * 
 * ```sh
 * $ pulumi import gcp:dns/dnsManagedZoneIamBinding:DnsManagedZoneIamBinding editor &#34;projects/{{project}}/managedZones/{{managed_zone}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class DnsManagedZoneIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public DnsManagedZoneIamBinding(java.lang.String name) {
     ...
     */
    public DnsManagedZoneIamBinding(java.lang.String name, DnsManagedZoneIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DnsManagedZoneIamBinding(java.lang.String name, DnsManagedZoneIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dns/dnsManagedZoneIamBinding:DnsManagedZoneIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DnsManagedZoneIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable DnsManagedZoneIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dns/dnsManagedZoneIamBinding:DnsManagedZoneIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static DnsManagedZoneIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable DnsManagedZoneIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
