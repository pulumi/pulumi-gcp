...
public final class GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig {
    ...
    public static Builder builder(GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder enableTableAnnotation(Boolean enableTableAnnotation) {
            if (enableTableAnnotation == null) {
              throw new MissingRequiredPropertyException("GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig", "enableTableAnnotation");
            }
        ...
        public Builder excludeHtmlClasses(List<String> excludeHtmlClasses) {
            if (excludeHtmlClasses == null) {
              throw new MissingRequiredPropertyException("GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig", "excludeHtmlClasses");
            }
        ...
        public Builder excludeHtmlElements(List<String> excludeHtmlElements) {
            if (excludeHtmlElements == null) {
              throw new MissingRequiredPropertyException("GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig", "excludeHtmlElements");
            }
        ...
        public Builder excludeHtmlIds(List<String> excludeHtmlIds) {
            if (excludeHtmlIds == null) {
              throw new MissingRequiredPropertyException("GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig", "excludeHtmlIds");
            }
        ...
        public Builder structuredContentTypes(List<String> structuredContentTypes) {
            if (structuredContentTypes == null) {
              throw new MissingRequiredPropertyException("GetDataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfig", "structuredContentTypes");
            }
