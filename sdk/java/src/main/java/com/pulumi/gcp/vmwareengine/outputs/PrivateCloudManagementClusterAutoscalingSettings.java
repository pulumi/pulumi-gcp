...
import com.pulumi.gcp.vmwareengine.outputs.PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy;
...
@CustomType
public final class PrivateCloudManagementClusterAutoscalingSettings {
    /**
     ...
     * 
     */
    private List<PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy> autoscalingPolicies;
    /**
     ...
     * 
     */
    public List<PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy> autoscalingPolicies() {
    ...
    public static Builder builder(PrivateCloudManagementClusterAutoscalingSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minClusterNodeCount;
        public Builder() {}
        public Builder(PrivateCloudManagementClusterAutoscalingSettings defaults) {
        ...
        @CustomType.Setter
        public Builder autoscalingPolicies(List<PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy> autoscalingPolicies) {
            if (autoscalingPolicies == null) {
              throw new MissingRequiredPropertyException("PrivateCloudManagementClusterAutoscalingSettings", "autoscalingPolicies");
            }
            this.autoscalingPolicies = autoscalingPolicies;
            return this;
        }
        public Builder autoscalingPolicies(PrivateCloudManagementClusterAutoscalingSettingsAutoscalingPolicy... autoscalingPolicies) {
        ...
        public PrivateCloudManagementClusterAutoscalingSettings build() {
            final var _resultValue = new PrivateCloudManagementClusterAutoscalingSettings();
