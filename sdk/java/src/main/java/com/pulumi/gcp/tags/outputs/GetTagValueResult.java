...
public final class GetTagValueResult {
    ...
    public static final class Builder {
        ...
        public Builder createTime(String createTime) {
            if (createTime == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "createTime");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder namespacedName(String namespacedName) {
            if (namespacedName == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "namespacedName");
            }
        ...
        public Builder parent(String parent) {
            if (parent == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "parent");
            }
            this.parent = parent;
            return this;
        }
        ...
        public Builder shortName(String shortName) {
            if (shortName == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "shortName");
            }
        ...
        public Builder updateTime(String updateTime) {
            if (updateTime == null) {
              throw new MissingRequiredPropertyException("GetTagValueResult", "updateTime");
            }
