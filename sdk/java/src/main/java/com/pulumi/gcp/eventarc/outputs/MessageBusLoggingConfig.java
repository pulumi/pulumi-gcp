...
@CustomType
public final class MessageBusLoggingConfig {
    /**
    ...
    private MessageBusLoggingConfig() {}
    /**
     * @return Optional. The minimum severity of logs that will be sent to Stackdriver/Platform
     * Telemetry. Logs at severitiy ≥ this value will be sent, unless it is NONE.
     * Possible values are: `NONE`, `DEBUG`, `INFO`, `NOTICE`, `WARNING`, `ERROR`, `CRITICAL`, `ALERT`, `EMERGENCY`.
    ...
    public static Builder builder(MessageBusLoggingConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable String logSeverity;
        public Builder() {}
        public Builder(MessageBusLoggingConfig defaults) {
        ...
        public MessageBusLoggingConfig build() {
            final var _resultValue = new MessageBusLoggingConfig();
