...
import com.pulumi.gcp.biglake.inputs.IcebergNamespaceIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/icebergNamespaceIamPolicy:IcebergNamespaceIamPolicy")
public class IcebergNamespaceIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public IcebergNamespaceIamPolicy(java.lang.String name) {
        this(name, IcebergNamespaceIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IcebergNamespaceIamPolicy(java.lang.String name, IcebergNamespaceIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IcebergNamespaceIamPolicy(java.lang.String name, IcebergNamespaceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergNamespaceIamPolicy:IcebergNamespaceIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IcebergNamespaceIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergNamespaceIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergNamespaceIamPolicy:IcebergNamespaceIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static IcebergNamespaceIamPolicyArgs makeArgs(IcebergNamespaceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IcebergNamespaceIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static IcebergNamespaceIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergNamespaceIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
