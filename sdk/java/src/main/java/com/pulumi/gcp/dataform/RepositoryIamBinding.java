...
import com.pulumi.gcp.dataform.RepositoryIamBindingArgs;
import com.pulumi.gcp.dataform.inputs.RepositoryIamBindingState;
import com.pulumi.gcp.dataform.outputs.RepositoryIamBindingCondition;
import java.lang.String;
import java.util.List;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="gcp:dataform/repositoryIamBinding:RepositoryIamBinding")
public class RepositoryIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public RepositoryIamBinding(String name, RepositoryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataform/repositoryIamBinding:RepositoryIamBinding", name, args == null ? RepositoryIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
