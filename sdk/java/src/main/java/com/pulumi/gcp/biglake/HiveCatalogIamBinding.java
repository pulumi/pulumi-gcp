...
import com.pulumi.gcp.biglake.inputs.HiveCatalogIamBindingState;
import com.pulumi.gcp.biglake.outputs.HiveCatalogIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveCatalogIamBinding:HiveCatalogIamBinding")
public class HiveCatalogIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={HiveCatalogIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ HiveCatalogIamBindingCondition> condition;

    public Output<Optional<HiveCatalogIamBindingCondition>> condition() {
     ...
     */
    public HiveCatalogIamBinding(java.lang.String name) {
        this(name, HiveCatalogIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveCatalogIamBinding(java.lang.String name, HiveCatalogIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveCatalogIamBinding(java.lang.String name, HiveCatalogIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveCatalogIamBinding:HiveCatalogIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveCatalogIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable HiveCatalogIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveCatalogIamBinding:HiveCatalogIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveCatalogIamBindingArgs makeArgs(HiveCatalogIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveCatalogIamBindingArgs.Empty : args;
    }
     ...
     */
    public static HiveCatalogIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveCatalogIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new HiveCatalogIamBinding(name, id, state, options);
    }
}
