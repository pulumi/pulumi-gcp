...
public final class RegionInstanceGroupManagerAutoHealingPolicies {
    ...
    public static final class Builder {
        ...
        public Builder healthCheck(String healthCheck) {
            if (healthCheck == null) {
              throw new MissingRequiredPropertyException("RegionInstanceGroupManagerAutoHealingPolicies", "healthCheck");
            }
        ...
        public Builder initialDelaySec(Integer initialDelaySec) {
            if (initialDelaySec == null) {
              throw new MissingRequiredPropertyException("RegionInstanceGroupManagerAutoHealingPolicies", "initialDelaySec");
            }
