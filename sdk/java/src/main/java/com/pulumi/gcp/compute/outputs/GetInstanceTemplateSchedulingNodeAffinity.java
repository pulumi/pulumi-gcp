...
public final class GetInstanceTemplateSchedulingNodeAffinity {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateSchedulingNodeAffinity", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateSchedulingNodeAffinity", "operator");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateSchedulingNodeAffinity", "values");
            }
            this.values = values;
            return this;
        }
