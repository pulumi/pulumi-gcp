...
public final class GetScopeIamPolicyResult {
    ...
    public static final class Builder {
        ...
        public Builder etag(String etag) {
            if (etag == null) {
              throw new MissingRequiredPropertyException("GetScopeIamPolicyResult", "etag");
            }
            this.etag = etag;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetScopeIamPolicyResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder policyData(String policyData) {
            if (policyData == null) {
              throw new MissingRequiredPropertyException("GetScopeIamPolicyResult", "policyData");
            }
        ...
        public Builder project(String project) {
            if (project == null) {
              throw new MissingRequiredPropertyException("GetScopeIamPolicyResult", "project");
            }
        ...
        public Builder scopeId(String scopeId) {
            if (scopeId == null) {
              throw new MissingRequiredPropertyException("GetScopeIamPolicyResult", "scopeId");
            }
