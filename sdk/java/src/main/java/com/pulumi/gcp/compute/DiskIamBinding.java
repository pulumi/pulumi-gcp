 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/diskIamBinding:DiskIamBinding editor &#34;projects/{{project}}/zones/{{zone}}/disks/{{disk}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class DiskIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={DiskIamBindingCondition.class}, tree="[0]")
     ...
     */
    public DiskIamBinding(java.lang.String name) {
     ...
     */
    public DiskIamBinding(java.lang.String name, DiskIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DiskIamBinding(java.lang.String name, DiskIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/diskIamBinding:DiskIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DiskIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable DiskIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/diskIamBinding:DiskIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static DiskIamBindingArgs makeArgs(DiskIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DiskIamBindingArgs.Empty : args;
    }
     ...
     */
    public static DiskIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable DiskIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
