...
public final class InstanceTemplateNetworkInterfaceAliasIpRange {
    ...
    public static final class Builder {
        ...
        public Builder ipCidrRange(String ipCidrRange) {
            if (ipCidrRange == null) {
              throw new MissingRequiredPropertyException("InstanceTemplateNetworkInterfaceAliasIpRange", "ipCidrRange");
            }
        ...
        public InstanceTemplateNetworkInterfaceAliasIpRange build() {
            final var _resultValue = new InstanceTemplateNetworkInterfaceAliasIpRange();
