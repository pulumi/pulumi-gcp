...
public final class PreventionInspectTemplateInspectConfigCustomInfoTypeInfoType {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PreventionInspectTemplateInspectConfigCustomInfoTypeInfoType", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public PreventionInspectTemplateInspectConfigCustomInfoTypeInfoType build() {
            final var _resultValue = new PreventionInspectTemplateInspectConfigCustomInfoTypeInfoType();
