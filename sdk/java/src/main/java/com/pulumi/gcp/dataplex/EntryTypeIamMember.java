...
import com.pulumi.gcp.dataplex.inputs.EntryTypeIamMemberState;
import com.pulumi.gcp.dataplex.outputs.EntryTypeIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/entryTypeIamMember:EntryTypeIamMember editor &#34;projects/{{project}}/locations/{{location}}/entryTypes/{{entry_type_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataplex/entryTypeIamMember:EntryTypeIamMember")
public class EntryTypeIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={EntryTypeIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ EntryTypeIamMemberCondition> condition;

    public Output<Optional<EntryTypeIamMemberCondition>> condition() {
     ...
     */
    public EntryTypeIamMember(java.lang.String name) {
        this(name, EntryTypeIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public EntryTypeIamMember(java.lang.String name, EntryTypeIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EntryTypeIamMember(java.lang.String name, EntryTypeIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/entryTypeIamMember:EntryTypeIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private EntryTypeIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable EntryTypeIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/entryTypeIamMember:EntryTypeIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static EntryTypeIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable EntryTypeIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new EntryTypeIamMember(name, id, state, options);
    }
}
