...
public class EntryTypeIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public EntryTypeIamMember(String name) {
     ...
     */
    public EntryTypeIamMember(String name, EntryTypeIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static EntryTypeIamMember get(String name, Output<String> id, @Nullable EntryTypeIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
