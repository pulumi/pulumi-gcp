...
public final class RegionUrlMapHeaderActionResponseHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionUrlMapHeaderActionResponseHeadersToAddArgs Empty = new RegionUrlMapHeaderActionResponseHeadersToAddArgs();
    ...
    private RegionUrlMapHeaderActionResponseHeadersToAddArgs() {}

    private RegionUrlMapHeaderActionResponseHeadersToAddArgs(RegionUrlMapHeaderActionResponseHeadersToAddArgs $) {
    ...
    public static Builder builder(RegionUrlMapHeaderActionResponseHeadersToAddArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapHeaderActionResponseHeadersToAddArgs();
        }

        public Builder(RegionUrlMapHeaderActionResponseHeadersToAddArgs defaults) {
            $ = new RegionUrlMapHeaderActionResponseHeadersToAddArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionUrlMapHeaderActionResponseHeadersToAddArgs build() {
            return $;
        }
    }
