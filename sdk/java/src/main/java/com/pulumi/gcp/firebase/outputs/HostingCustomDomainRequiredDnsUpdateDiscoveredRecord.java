...
@CustomType
public final class HostingCustomDomainRequiredDnsUpdateDiscoveredRecord {
    /**
    ...
    private HostingCustomDomainRequiredDnsUpdateDiscoveredRecord() {}
    /**
     * @return The domain name the record pertains to, e.g. `foo.bar.com.`.
     * 
     */
    ...
    public static Builder builder(HostingCustomDomainRequiredDnsUpdateDiscoveredRecord defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(HostingCustomDomainRequiredDnsUpdateDiscoveredRecord defaults) {
        ...
        public HostingCustomDomainRequiredDnsUpdateDiscoveredRecord build() {
            final var _resultValue = new HostingCustomDomainRequiredDnsUpdateDiscoveredRecord();
