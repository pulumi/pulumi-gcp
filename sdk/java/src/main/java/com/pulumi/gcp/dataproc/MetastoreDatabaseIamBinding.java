...
import com.pulumi.gcp.dataproc.inputs.MetastoreDatabaseIamBindingState;
import com.pulumi.gcp.dataproc.outputs.MetastoreDatabaseIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataproc/metastoreDatabaseIamBinding:MetastoreDatabaseIamBinding editor &#34;projects/{{project}}/locations/{{location}}/services/{{serviceId}}/databases/{{database}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataproc/metastoreDatabaseIamBinding:MetastoreDatabaseIamBinding")
public class MetastoreDatabaseIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={MetastoreDatabaseIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ MetastoreDatabaseIamBindingCondition> condition;

    public Output<Optional<MetastoreDatabaseIamBindingCondition>> condition() {
     ...
     */
    public MetastoreDatabaseIamBinding(java.lang.String name) {
        this(name, MetastoreDatabaseIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MetastoreDatabaseIamBinding(java.lang.String name, MetastoreDatabaseIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetastoreDatabaseIamBinding(java.lang.String name, MetastoreDatabaseIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreDatabaseIamBinding:MetastoreDatabaseIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetastoreDatabaseIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreDatabaseIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreDatabaseIamBinding:MetastoreDatabaseIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static MetastoreDatabaseIamBindingArgs makeArgs(MetastoreDatabaseIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MetastoreDatabaseIamBindingArgs.Empty : args;
    }
     ...
     */
    public static MetastoreDatabaseIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreDatabaseIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
