...
@CustomType
public final class CxFlowKnowledgeConnectorSettingsDataStoreConnection {
    /**
    ...
    public static Builder builder(CxFlowKnowledgeConnectorSettingsDataStoreConnection defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String documentProcessingMode;
        public Builder() {}
        public Builder(CxFlowKnowledgeConnectorSettingsDataStoreConnection defaults) {
        ...
        public CxFlowKnowledgeConnectorSettingsDataStoreConnection build() {
            final var _resultValue = new CxFlowKnowledgeConnectorSettingsDataStoreConnection();
