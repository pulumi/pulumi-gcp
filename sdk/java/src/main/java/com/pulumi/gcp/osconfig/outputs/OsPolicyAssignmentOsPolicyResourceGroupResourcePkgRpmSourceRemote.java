...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemote {
    ...
    public static final class Builder {
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemote", "uri");
            }
            this.uri = uri;
            return this;
        }
        public OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemote build() {
            final var _resultValue = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceRemote();
