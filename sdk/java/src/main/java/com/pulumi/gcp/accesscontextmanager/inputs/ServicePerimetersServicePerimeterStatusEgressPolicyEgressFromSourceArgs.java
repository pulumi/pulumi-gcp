...
import com.pulumi.gcp.accesscontextmanager.inputs.ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpointArgs;
...
public final class ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpointArgs> pscEndpoint;
     ...
     * 
     */
    public Optional<Output<ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpointArgs>> pscEndpoint() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder pscEndpoint(@Nullable Output<ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpointArgs> pscEndpoint) {
         ...
         * 
         */
        public Builder pscEndpoint(ServicePerimetersServicePerimeterStatusEgressPolicyEgressFromSourcePscEndpointArgs pscEndpoint) {
