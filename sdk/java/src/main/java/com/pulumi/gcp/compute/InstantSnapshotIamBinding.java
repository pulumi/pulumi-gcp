...
import com.pulumi.gcp.compute.inputs.InstantSnapshotIamBindingState;
import com.pulumi.gcp.compute.outputs.InstantSnapshotIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/instantSnapshotIamBinding:InstantSnapshotIamBinding editor &#34;projects/{{project}}/zones/{{zone}}/instantSnapshots/{{instant_snapshot}} roles/compute.storageAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/instantSnapshotIamBinding:InstantSnapshotIamBinding")
public class InstantSnapshotIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={InstantSnapshotIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ InstantSnapshotIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<InstantSnapshotIamBindingCondition>> condition() {
     ...
     */
    public InstantSnapshotIamBinding(java.lang.String name) {
        this(name, InstantSnapshotIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InstantSnapshotIamBinding(java.lang.String name, InstantSnapshotIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstantSnapshotIamBinding(java.lang.String name, InstantSnapshotIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instantSnapshotIamBinding:InstantSnapshotIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InstantSnapshotIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable InstantSnapshotIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instantSnapshotIamBinding:InstantSnapshotIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static InstantSnapshotIamBindingArgs makeArgs(InstantSnapshotIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InstantSnapshotIamBindingArgs.Empty : args;
    }
     ...
     */
    public static InstantSnapshotIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable InstantSnapshotIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
