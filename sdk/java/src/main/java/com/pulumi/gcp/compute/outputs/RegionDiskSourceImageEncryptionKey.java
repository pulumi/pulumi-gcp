...
@CustomType
public final class RegionDiskSourceImageEncryptionKey {
    /**
    ...
    private RegionDiskSourceImageEncryptionKey() {}
    /**
     * @return The name of the encryption key that is stored in Google Cloud KMS.
     * 
     */
    ...
    public static Builder builder(RegionDiskSourceImageEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sha256;
        public Builder() {}
        public Builder(RegionDiskSourceImageEncryptionKey defaults) {
        ...
        public RegionDiskSourceImageEncryptionKey build() {
            final var _resultValue = new RegionDiskSourceImageEncryptionKey();
