...
@CustomType
public final class GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim {
    /**
    ...
    private GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim() {}
    /**
     * @return Defines percentage of minimum reclaim for imagefs.available.
     * 
     */
    ...
    public static Builder builder(GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim defaults) {
    ...
    public static final class Builder {
        ...
        private String pidAvailable;
        public Builder() {}
        public Builder(GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim defaults) {
        ...
        public Builder imagefsAvailable(String imagefsAvailable) {
            if (imagefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim", "imagefsAvailable");
            }
        ...
        public Builder imagefsInodesFree(String imagefsInodesFree) {
            if (imagefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim", "imagefsInodesFree");
            }
        ...
        public Builder memoryAvailable(String memoryAvailable) {
            if (memoryAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim", "memoryAvailable");
            }
        ...
        public Builder nodefsAvailable(String nodefsAvailable) {
            if (nodefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim", "nodefsAvailable");
            }
        ...
        public Builder nodefsInodesFree(String nodefsInodesFree) {
            if (nodefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim", "nodefsInodesFree");
            }
        ...
        public Builder pidAvailable(String pidAvailable) {
            if (pidAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim", "pidAvailable");
            }
            this.pidAvailable = pidAvailable;
            return this;
        }
        public GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim build() {
            final var _resultValue = new GetClusterNodeConfigKubeletConfigEvictionMinimumReclaim();
