...
import com.pulumi.gcp.compute.inputs.BackendBucketIamMemberState;
import com.pulumi.gcp.compute.outputs.BackendBucketIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/backendBucketIamMember:BackendBucketIamMember editor &#34;projects/{{project}}/global/backendBuckets/{{backend_bucket}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class BackendBucketIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public BackendBucketIamMember(java.lang.String name) {
        this(name, BackendBucketIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public BackendBucketIamMember(java.lang.String name, BackendBucketIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BackendBucketIamMember(java.lang.String name, BackendBucketIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/backendBucketIamMember:BackendBucketIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BackendBucketIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable BackendBucketIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/backendBucketIamMember:BackendBucketIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static BackendBucketIamMemberArgs makeArgs(BackendBucketIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BackendBucketIamMemberArgs.Empty : args;
    }
     ...
     */
    public static BackendBucketIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable BackendBucketIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
