...
import com.pulumi.gcp.networkservices.outputs.MulticastConsumerAssociationState;
 ...
 * 
 */
@ResourceType(type="gcp:networkservices/multicastConsumerAssociation:MulticastConsumerAssociation")
public class MulticastConsumerAssociation extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="multicastConsumerAssociationId", refs={String.class}, tree="[0]")
    ...
    private Output<String> placementPolicy;
     ...
     * 
     */
    public Output<String> placementPolicy() {
     ...
     * 
     */
    @Export(name="states", refs={List.class,MulticastConsumerAssociationState.class}, tree="[0,1]")
    private Output<List<MulticastConsumerAssociationState>> states;
     ...
     * 
     */
    public Output<List<MulticastConsumerAssociationState>> states() {
        return this.states;
    }
    /**
     ...
     */
    public MulticastConsumerAssociation(java.lang.String name) {
        this(name, MulticastConsumerAssociationArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MulticastConsumerAssociation(java.lang.String name, MulticastConsumerAssociationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MulticastConsumerAssociation(java.lang.String name, MulticastConsumerAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networkservices/multicastConsumerAssociation:MulticastConsumerAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MulticastConsumerAssociation(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.gcp.networkservices.inputs.MulticastConsumerAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networkservices/multicastConsumerAssociation:MulticastConsumerAssociation", name, state, makeResourceOptions(options, id), false);
    }

    private static MulticastConsumerAssociationArgs makeArgs(MulticastConsumerAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MulticastConsumerAssociationArgs.Empty : args;
    }
     ...
     */
    public static MulticastConsumerAssociation get(java.lang.String name, Output<java.lang.String> id, @Nullable com.pulumi.gcp.networkservices.inputs.MulticastConsumerAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
