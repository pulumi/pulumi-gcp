...
public final class RegionUrlMapPathMatcherDefaultUrlRedirectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionUrlMapPathMatcherDefaultUrlRedirectArgs(RegionUrlMapPathMatcherDefaultUrlRedirectArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapPathMatcherDefaultUrlRedirectArgs();
        }

        public Builder(RegionUrlMapPathMatcherDefaultUrlRedirectArgs defaults) {
            $ = new RegionUrlMapPathMatcherDefaultUrlRedirectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionUrlMapPathMatcherDefaultUrlRedirectArgs build() {
            if ($.stripQuery == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherDefaultUrlRedirectArgs", "stripQuery");
            }
            return $;
        }
    }
