...
public final class RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs(RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs();
        }

        public Builder(RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs defaults) {
            $ = new RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs build() {
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs", "headerName");
            }
            if ($.headerValue == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs", "headerValue");
            }
            if ($.replace == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleHeaderActionResponseHeadersToAddArgs", "replace");
            }
            return $;
        }
    }
