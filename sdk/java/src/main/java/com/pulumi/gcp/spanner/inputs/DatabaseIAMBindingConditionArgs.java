...
public final class DatabaseIAMBindingConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DatabaseIAMBindingConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("DatabaseIAMBindingConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("DatabaseIAMBindingConditionArgs", "title");
            }
            return $;
        }
    }
