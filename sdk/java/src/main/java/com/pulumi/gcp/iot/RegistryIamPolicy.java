...
import com.pulumi.gcp.iot.inputs.RegistryIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:iot/registryIamPolicy:RegistryIamPolicy")
public class RegistryIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public RegistryIamPolicy(String name) {
        this(name, RegistryIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RegistryIamPolicy(String name, RegistryIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RegistryIamPolicy(String name, RegistryIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iot/registryIamPolicy:RegistryIamPolicy", name, args == null ? RegistryIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegistryIamPolicy(String name, Output<String> id, @Nullable RegistryIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iot/registryIamPolicy:RegistryIamPolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegistryIamPolicy get(String name, Output<String> id, @Nullable RegistryIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
