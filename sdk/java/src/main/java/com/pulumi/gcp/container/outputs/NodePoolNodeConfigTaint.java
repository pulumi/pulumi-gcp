...
public final class NodePoolNodeConfigTaint {
    ...
    public static final class Builder {
        ...
        public Builder effect(String effect) {
            if (effect == null) {
              throw new MissingRequiredPropertyException("NodePoolNodeConfigTaint", "effect");
            }
            this.effect = effect;
            return this;
        }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("NodePoolNodeConfigTaint", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("NodePoolNodeConfigTaint", "value");
            }
            this.value = value;
            return this;
        }
