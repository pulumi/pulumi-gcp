...
public final class EntitlementApprovalWorkflowManualApprovalsStepApprovers {
    ...
    public static Builder builder(EntitlementApprovalWorkflowManualApprovalsStepApprovers defaults) {
    ...
    public static final class Builder {
        private List<String> principals;
        public Builder() {}
        public Builder(EntitlementApprovalWorkflowManualApprovalsStepApprovers defaults) {
        ...
        public Builder principals(List<String> principals) {
            if (principals == null) {
              throw new MissingRequiredPropertyException("EntitlementApprovalWorkflowManualApprovalsStepApprovers", "principals");
            }
        ...
        public EntitlementApprovalWorkflowManualApprovalsStepApprovers build() {
            final var _resultValue = new EntitlementApprovalWorkflowManualApprovalsStepApprovers();
