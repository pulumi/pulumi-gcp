...
import com.pulumi.gcp.compute.inputs.InstantSnapshotIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/instantSnapshotIamPolicy:InstantSnapshotIamPolicy editor &#34;projects/{{project}}/zones/{{zone}}/instantSnapshots/{{instant_snapshot}} roles/compute.storageAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/instantSnapshotIamPolicy:InstantSnapshotIamPolicy")
public class InstantSnapshotIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public InstantSnapshotIamPolicy(java.lang.String name) {
     ...
     */
    public InstantSnapshotIamPolicy(java.lang.String name, InstantSnapshotIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstantSnapshotIamPolicy(java.lang.String name, InstantSnapshotIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instantSnapshotIamPolicy:InstantSnapshotIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InstantSnapshotIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable InstantSnapshotIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instantSnapshotIamPolicy:InstantSnapshotIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static InstantSnapshotIamPolicyArgs makeArgs(InstantSnapshotIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InstantSnapshotIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static InstantSnapshotIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable InstantSnapshotIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
