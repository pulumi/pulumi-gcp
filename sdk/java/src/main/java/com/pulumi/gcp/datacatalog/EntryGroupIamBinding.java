 ...
 * 
 * ```sh
 * $ pulumi import gcp:datacatalog/entryGroupIamBinding:EntryGroupIamBinding editor &#34;projects/{{project}}/locations/{{region}}/entryGroups/{{entry_group}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
