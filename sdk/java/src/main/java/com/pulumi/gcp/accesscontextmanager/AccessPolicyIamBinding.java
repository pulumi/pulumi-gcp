 ...
 * 
 * ```sh
 * $ pulumi import gcp:accesscontextmanager/accessPolicyIamBinding:AccessPolicyIamBinding editor &#34;accessPolicies/{{access_policy}} roles/accesscontextmanager.policyAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class AccessPolicyIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccessPolicyIamBinding(java.lang.String name) {
     ...
     */
    public AccessPolicyIamBinding(java.lang.String name, AccessPolicyIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccessPolicyIamBinding(java.lang.String name, AccessPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:accesscontextmanager/accessPolicyIamBinding:AccessPolicyIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AccessPolicyIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AccessPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:accesscontextmanager/accessPolicyIamBinding:AccessPolicyIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AccessPolicyIamBindingArgs makeArgs(AccessPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AccessPolicyIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AccessPolicyIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AccessPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
