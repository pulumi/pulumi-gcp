 ...
 * 
 * ```sh
 * $ pulumi import gcp:secretmanager/secretIamMember:SecretIamMember editor &#34;projects/{{project}}/secrets/{{secret_id}} roles/secretmanager.secretAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class SecretIamMember extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={SecretIamMemberCondition.class}, tree="[0]")
     ...
     */
    public SecretIamMember(java.lang.String name) {
     ...
     */
    public SecretIamMember(java.lang.String name, SecretIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SecretIamMember(java.lang.String name, SecretIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:secretmanager/secretIamMember:SecretIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SecretIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable SecretIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:secretmanager/secretIamMember:SecretIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SecretIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable SecretIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
