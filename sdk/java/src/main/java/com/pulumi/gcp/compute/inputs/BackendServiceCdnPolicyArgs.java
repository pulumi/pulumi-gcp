...
public final class BackendServiceCdnPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<BackendServiceCdnPolicyCacheKeyPolicyArgs> cacheKeyPolicy;
     ...
     * 
     */
    public Optional<Output<BackendServiceCdnPolicyCacheKeyPolicyArgs>> cacheKeyPolicy() {
    ...
    private @Nullable Output<List<BackendServiceCdnPolicyNegativeCachingPolicyArgs>> negativeCachingPolicies;
     ...
     * 
     */
    public Optional<Output<List<BackendServiceCdnPolicyNegativeCachingPolicyArgs>>> negativeCachingPolicies() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder cacheKeyPolicy(@Nullable Output<BackendServiceCdnPolicyCacheKeyPolicyArgs> cacheKeyPolicy) {
         ...
         * 
         */
        public Builder cacheKeyPolicy(BackendServiceCdnPolicyCacheKeyPolicyArgs cacheKeyPolicy) {
         ...
         * 
         */
        public Builder negativeCachingPolicies(@Nullable Output<List<BackendServiceCdnPolicyNegativeCachingPolicyArgs>> negativeCachingPolicies) {
         ...
         * 
         */
        public Builder negativeCachingPolicies(List<BackendServiceCdnPolicyNegativeCachingPolicyArgs> negativeCachingPolicies) {
