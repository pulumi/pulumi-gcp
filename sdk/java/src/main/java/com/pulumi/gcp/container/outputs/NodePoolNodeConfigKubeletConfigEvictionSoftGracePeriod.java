...
@CustomType
public final class NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod {
    /**
    ...
    public static Builder builder(NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String pidAvailable;
        public Builder() {}
        public Builder(NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod defaults) {
        ...
        public NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod build() {
            final var _resultValue = new NodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod();
