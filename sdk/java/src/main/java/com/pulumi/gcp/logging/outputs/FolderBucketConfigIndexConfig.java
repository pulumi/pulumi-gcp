...
public final class FolderBucketConfigIndexConfig {
    ...
    public static final class Builder {
        ...
        public Builder fieldPath(String fieldPath) {
            if (fieldPath == null) {
              throw new MissingRequiredPropertyException("FolderBucketConfigIndexConfig", "fieldPath");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("FolderBucketConfigIndexConfig", "type");
            }
            this.type = type;
            return this;
        }
