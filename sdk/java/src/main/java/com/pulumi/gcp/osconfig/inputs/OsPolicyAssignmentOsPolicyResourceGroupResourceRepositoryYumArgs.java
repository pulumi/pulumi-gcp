...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs(OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs();
        }

        public Builder(OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs defaults) {
            $ = new OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs build() {
            if ($.baseUrl == null) {
                throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs", "baseUrl");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYumArgs", "id");
            }
            return $;
        }
    }
