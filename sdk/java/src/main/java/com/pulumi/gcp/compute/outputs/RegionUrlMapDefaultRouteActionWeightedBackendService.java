...
import com.pulumi.gcp.compute.outputs.RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction;
...
@CustomType
public final class RegionUrlMapDefaultRouteActionWeightedBackendService {
    /**
     ...
     * 
     */
    private @Nullable RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction headerAction;
    /**
    ...
    private RegionUrlMapDefaultRouteActionWeightedBackendService() {}
    /**
     * @return The full or partial URL to the default BackendService resource. Before forwarding the request to backendService, the load balancer applies any relevant headerActions specified as part of this backendServiceWeight.
     * 
     */
     ...
     * 
     */
    public Optional<RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction> headerAction() {
    ...
    public static Builder builder(RegionUrlMapDefaultRouteActionWeightedBackendService defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer weight;
        public Builder() {}
        public Builder(RegionUrlMapDefaultRouteActionWeightedBackendService defaults) {
