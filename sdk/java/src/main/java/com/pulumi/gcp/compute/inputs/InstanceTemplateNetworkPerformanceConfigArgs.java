...
public final class InstanceTemplateNetworkPerformanceConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceTemplateNetworkPerformanceConfigArgs(InstanceTemplateNetworkPerformanceConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceTemplateNetworkPerformanceConfigArgs();
        }

        public Builder(InstanceTemplateNetworkPerformanceConfigArgs defaults) {
            $ = new InstanceTemplateNetworkPerformanceConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceTemplateNetworkPerformanceConfigArgs build() {
            if ($.totalEgressBandwidthTier == null) {
                throw new MissingRequiredPropertyException("InstanceTemplateNetworkPerformanceConfigArgs", "totalEgressBandwidthTier");
            }
            return $;
        }
    }
