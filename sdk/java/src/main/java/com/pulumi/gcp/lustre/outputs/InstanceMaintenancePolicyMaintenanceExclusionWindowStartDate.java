...
@CustomType
public final class InstanceMaintenancePolicyMaintenanceExclusionWindowStartDate {
    /**
    ...
    private InstanceMaintenancePolicyMaintenanceExclusionWindowStartDate() {}
    /**
     * @return Day of a month. Must be from 1 to 31 and valid for the year and month.
     * 
     */
    ...
    public static Builder builder(InstanceMaintenancePolicyMaintenanceExclusionWindowStartDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(InstanceMaintenancePolicyMaintenanceExclusionWindowStartDate defaults) {
        ...
        public InstanceMaintenancePolicyMaintenanceExclusionWindowStartDate build() {
            final var _resultValue = new InstanceMaintenancePolicyMaintenanceExclusionWindowStartDate();
