...
public final class GuestPoliciesRecipeUpdateStepArchiveExtraction {
    ...
    public static final class Builder {
        ...
        public Builder artifactId(String artifactId) {
            if (artifactId == null) {
              throw new MissingRequiredPropertyException("GuestPoliciesRecipeUpdateStepArchiveExtraction", "artifactId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GuestPoliciesRecipeUpdateStepArchiveExtraction", "type");
            }
            this.type = type;
            return this;
        }
