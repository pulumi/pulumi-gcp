...
public class AddressGroupIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public AddressGroupIamPolicy(String name) {
     ...
     */
    public static AddressGroupIamPolicy get(String name, Output<String> id, @Nullable AddressGroupIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
