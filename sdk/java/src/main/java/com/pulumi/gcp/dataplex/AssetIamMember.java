...
public class AssetIamMember extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="condition", type=AssetIamMemberCondition.class, parameters={})
     ...
     */
    public AssetIamMember(String name) {
     ...
     */
    public static AssetIamMember get(String name, Output<String> id, @Nullable AssetIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
