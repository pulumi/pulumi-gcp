...
public final class ServiceTemplateVolumeCloudSqlInstance {
    ...
    public static Builder builder(ServiceTemplateVolumeCloudSqlInstance defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> instances;
        public Builder() {}
        public Builder(ServiceTemplateVolumeCloudSqlInstance defaults) {
        ...
        public ServiceTemplateVolumeCloudSqlInstance build() {
            final var _resultValue = new ServiceTemplateVolumeCloudSqlInstance();
