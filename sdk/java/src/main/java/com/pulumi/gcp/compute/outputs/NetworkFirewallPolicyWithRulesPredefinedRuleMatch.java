...
import com.pulumi.gcp.compute.outputs.NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config;
import com.pulumi.gcp.compute.outputs.NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag;
...
@CustomType
public final class NetworkFirewallPolicyWithRulesPredefinedRuleMatch {
    /**
     ...
     * 
     */
    private @Nullable List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config> layer4Configs;
    /**
     ...
     * 
     */
    private @Nullable List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag> srcSecureTags;
    /**
     * @return Names of Network Threat Intelligence lists.
     ...
     * 
     */
    public List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config> layer4Configs() {
     ...
     * 
     */
    public List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag> srcSecureTags() {
    ...
    public static Builder builder(NetworkFirewallPolicyWithRulesPredefinedRuleMatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> srcThreatIntelligences;
        public Builder() {}
        public Builder(NetworkFirewallPolicyWithRulesPredefinedRuleMatch defaults) {
        ...
        @CustomType.Setter
        public Builder layer4Configs(@Nullable List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config> layer4Configs) {

            this.layer4Configs = layer4Configs;
            return this;
        }
        public Builder layer4Configs(NetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config... layer4Configs) {
        ...
        @CustomType.Setter
        public Builder srcSecureTags(@Nullable List<NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag> srcSecureTags) {

            this.srcSecureTags = srcSecureTags;
            return this;
        }
        public Builder srcSecureTags(NetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag... srcSecureTags) {
        ...
        public NetworkFirewallPolicyWithRulesPredefinedRuleMatch build() {
            final var _resultValue = new NetworkFirewallPolicyWithRulesPredefinedRuleMatch();
