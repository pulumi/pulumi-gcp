...
@CustomType
public final class InstanceMaintenanceWindowStartTime {
    /**
    ...
    public static Builder builder(InstanceMaintenanceWindowStartTime defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer seconds;
        public Builder() {}
        public Builder(InstanceMaintenanceWindowStartTime defaults) {
        ...
        public InstanceMaintenanceWindowStartTime build() {
            final var _resultValue = new InstanceMaintenanceWindowStartTime();
