...
public final class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs Empty = new FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs();
    ...
    private @Nullable Output<List<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigArgs>> deploymentConfigs;
     ...
     * 
     */
    public Optional<Output<List<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigArgs>>> deploymentConfigs() {
     ...
     * 
     */
    @Import(name="installSpec", required=true)
    private Output<String> installSpec;
     ...
     * 
     */
    public Output<String> installSpec() {
    ...
    private @Nullable Output<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoringArgs> monitoring;
     ...
     * 
     */
    public Optional<Output<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoringArgs>> monitoring() {
    ...
    private @Nullable Output<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentArgs> policyContent;
     ...
     * 
     */
    public Optional<Output<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentArgs>> policyContent() {
    ...
    private FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs() {}

    private FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs(FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs $) {
    ...
    public static Builder builder(FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs();
        }

        public Builder(FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs defaults) {
            $ = new FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param auditIntervalSeconds Interval for Policy Controller Audit scans (in seconds). When set to 0, this disables audit functionality altogether.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param constraintViolationLimit The maximum number of audit violations to be stored in a constraint. If not set, the internal default of 20 will be used.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder deploymentConfigs(@Nullable Output<List<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigArgs>> deploymentConfigs) {
         ...
         * 
         */
        public Builder deploymentConfigs(List<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigArgs> deploymentConfigs) {
         ...
         * 
         */
        public Builder deploymentConfigs(FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigArgs... deploymentConfigs) {
        ...
        /**
         * @param installSpec Configures the mode of the Policy Controller installation
         * Possible values are: `INSTALL_SPEC_UNSPECIFIED`, `INSTALL_SPEC_NOT_INSTALLED`, `INSTALL_SPEC_ENABLED`, `INSTALL_SPEC_SUSPENDED`, `INSTALL_SPEC_DETACHED`.
         * 
         * @return builder
         * 
         */
        public Builder installSpec(Output<String> installSpec) {
         ...
         * 
         */
        public Builder monitoring(@Nullable Output<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoringArgs> monitoring) {
         ...
         * 
         */
        public Builder monitoring(FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoringArgs monitoring) {
            return monitoring(Output.of(monitoring));
        }

        /**
         * @param mutationEnabled Enables the ability to mutate resources using Policy Controller.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder policyContent(@Nullable Output<FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentArgs> policyContent) {
         ...
         * 
         */
        public Builder policyContent(FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentArgs policyContent) {
