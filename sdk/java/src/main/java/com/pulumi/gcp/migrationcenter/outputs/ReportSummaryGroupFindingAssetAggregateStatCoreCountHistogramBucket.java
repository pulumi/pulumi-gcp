...
@CustomType
public final class ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket {
    /**
     * @return (Output)
    ...
    public static Builder builder(ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String upperBound;
        public Builder() {}
        public Builder(ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket defaults) {
        ...
        public ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket build() {
            final var _resultValue = new ReportSummaryGroupFindingAssetAggregateStatCoreCountHistogramBucket();
