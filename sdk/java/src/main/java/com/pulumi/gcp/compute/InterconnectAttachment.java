...
public class InterconnectAttachment extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="l2Forwarding", refs={InterconnectAttachmentL2Forwarding.class}, tree="[0]")
    private Output</* @Nullable */ InterconnectAttachmentL2Forwarding> l2Forwarding;
     ...
     * 
     */
    public Output<Optional<InterconnectAttachmentL2Forwarding>> l2Forwarding() {
        return Codegen.optional(this.l2Forwarding);
    }
    /**
     ...
     */
    public InterconnectAttachment(java.lang.String name, @Nullable InterconnectAttachmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InterconnectAttachment(java.lang.String name, @Nullable InterconnectAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private static InterconnectAttachmentArgs makeArgs(@Nullable InterconnectAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
