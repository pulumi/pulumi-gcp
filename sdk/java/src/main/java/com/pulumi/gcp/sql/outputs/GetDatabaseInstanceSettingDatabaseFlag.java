...
public final class GetDatabaseInstanceSettingDatabaseFlag {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingDatabaseFlag", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingDatabaseFlag", "value");
            }
            this.value = value;
            return this;
        }
        public GetDatabaseInstanceSettingDatabaseFlag build() {
            final var _resultValue = new GetDatabaseInstanceSettingDatabaseFlag();
