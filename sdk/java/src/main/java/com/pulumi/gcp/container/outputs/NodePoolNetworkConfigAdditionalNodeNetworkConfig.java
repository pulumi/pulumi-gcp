...
@CustomType
public final class NodePoolNetworkConfigAdditionalNodeNetworkConfig {
    /**
    ...
    public static Builder builder(NodePoolNetworkConfigAdditionalNodeNetworkConfig defaults) {
