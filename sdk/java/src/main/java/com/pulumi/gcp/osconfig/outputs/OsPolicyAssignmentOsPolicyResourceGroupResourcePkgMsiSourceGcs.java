...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceGcs {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceGcs", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceGcs", "object");
            }
            this.object = object;
            return this;
        }
        public OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceGcs build() {
            final var _resultValue = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceGcs();
