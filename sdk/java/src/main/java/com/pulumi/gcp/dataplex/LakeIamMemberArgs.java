...
public final class LakeIamMemberArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LakeIamMemberArgs build() {
            if ($.lake == null) {
                throw new MissingRequiredPropertyException("LakeIamMemberArgs", "lake");
            }
            if ($.member == null) {
                throw new MissingRequiredPropertyException("LakeIamMemberArgs", "member");
            }
            if ($.role == null) {
                throw new MissingRequiredPropertyException("LakeIamMemberArgs", "role");
            }
            return $;
        }
    }
