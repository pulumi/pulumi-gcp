...
public final class URLMapPathMatcherPathRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public URLMapPathMatcherPathRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs build() {
            if ($.seconds == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherPathRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs", "seconds");
            }
            return $;
        }
    }
