...
@CustomType
public final class CxFlowTransitionRouteTriggerFulfillmentMessageOutputAudioText {
    /**
     * @return (Output)
    ...
    private CxFlowTransitionRouteTriggerFulfillmentMessageOutputAudioText() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxFlowTransitionRouteTriggerFulfillmentMessageOutputAudioText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String text;
        public Builder() {}
        public Builder(CxFlowTransitionRouteTriggerFulfillmentMessageOutputAudioText defaults) {
