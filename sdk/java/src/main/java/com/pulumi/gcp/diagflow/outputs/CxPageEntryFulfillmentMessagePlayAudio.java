...
@CustomType
public final class CxPageEntryFulfillmentMessagePlayAudio {
    /**
     * @return (Output)
    ...
    public static Builder builder(CxPageEntryFulfillmentMessagePlayAudio defaults) {
    ...
    public static final class Builder {
        ...
        private String audioUri;
        public Builder() {}
        public Builder(CxPageEntryFulfillmentMessagePlayAudio defaults) {
        ...
        public Builder audioUri(String audioUri) {
            if (audioUri == null) {
              throw new MissingRequiredPropertyException("CxPageEntryFulfillmentMessagePlayAudio", "audioUri");
            }
