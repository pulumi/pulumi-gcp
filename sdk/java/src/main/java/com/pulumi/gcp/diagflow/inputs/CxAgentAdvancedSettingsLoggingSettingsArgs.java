...
public final class CxAgentAdvancedSettingsLoggingSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxAgentAdvancedSettingsLoggingSettingsArgs Empty = new CxAgentAdvancedSettingsLoggingSettingsArgs();
    ...
    private CxAgentAdvancedSettingsLoggingSettingsArgs() {}

    private CxAgentAdvancedSettingsLoggingSettingsArgs(CxAgentAdvancedSettingsLoggingSettingsArgs $) {
    ...
    public static Builder builder(CxAgentAdvancedSettingsLoggingSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxAgentAdvancedSettingsLoggingSettingsArgs();
        }

        public Builder(CxAgentAdvancedSettingsLoggingSettingsArgs defaults) {
            $ = new CxAgentAdvancedSettingsLoggingSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CxAgentAdvancedSettingsLoggingSettingsArgs build() {
            return $;
        }
    }
