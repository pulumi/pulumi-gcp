...
import com.pulumi.gcp.kms.inputs.EkmConnectionIamMemberState;
import com.pulumi.gcp.kms.outputs.EkmConnectionIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:kms/ekmConnectionIamMember:EkmConnectionIamMember editor &#34;projects/{{project}}/locations/{{location}}/ekmConnections/{{ekm_connection}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:kms/ekmConnectionIamMember:EkmConnectionIamMember")
public class EkmConnectionIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={EkmConnectionIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ EkmConnectionIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<EkmConnectionIamMemberCondition>> condition() {
     ...
     */
    public EkmConnectionIamMember(java.lang.String name) {
        this(name, EkmConnectionIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public EkmConnectionIamMember(java.lang.String name, EkmConnectionIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EkmConnectionIamMember(java.lang.String name, EkmConnectionIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:kms/ekmConnectionIamMember:EkmConnectionIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private EkmConnectionIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable EkmConnectionIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:kms/ekmConnectionIamMember:EkmConnectionIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static EkmConnectionIamMemberArgs makeArgs(EkmConnectionIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? EkmConnectionIamMemberArgs.Empty : args;
    }
     ...
     */
    public static EkmConnectionIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable EkmConnectionIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new EkmConnectionIamMember(name, id, state, options);
    }
}
