...
public final class SubnetworkIAMMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("SubnetworkIAMMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("SubnetworkIAMMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public SubnetworkIAMMemberCondition build() {
            final var _resultValue = new SubnetworkIAMMemberCondition();
