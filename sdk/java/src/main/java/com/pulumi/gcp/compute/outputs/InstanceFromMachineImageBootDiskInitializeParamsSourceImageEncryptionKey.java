...
@CustomType
public final class InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey {
    /**
    ...
    private InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey() {}
    /**
     * @return The self link of the encryption key that is stored in Google Cloud KMS. Only one of kms_key_self_link, rsa_encrypted_key and raw_key may be set.
     * 
     */
    ...
    public static Builder builder(InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sha256;
        public Builder() {}
        public Builder(InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey defaults) {
        ...
        public InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey build() {
            final var _resultValue = new InstanceFromMachineImageBootDiskInitializeParamsSourceImageEncryptionKey();
