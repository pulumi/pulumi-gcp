...
public final class RegionUrlMapDefaultRouteActionTimeoutArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionUrlMapDefaultRouteActionTimeoutArgs Empty = new RegionUrlMapDefaultRouteActionTimeoutArgs();
    ...
    private RegionUrlMapDefaultRouteActionTimeoutArgs() {}

    private RegionUrlMapDefaultRouteActionTimeoutArgs(RegionUrlMapDefaultRouteActionTimeoutArgs $) {
        this.nanos = $.nanos;
    ...
    public static Builder builder(RegionUrlMapDefaultRouteActionTimeoutArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapDefaultRouteActionTimeoutArgs();
        }

        public Builder(RegionUrlMapDefaultRouteActionTimeoutArgs defaults) {
            $ = new RegionUrlMapDefaultRouteActionTimeoutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionUrlMapDefaultRouteActionTimeoutArgs build() {
            return $;
        }
    }
