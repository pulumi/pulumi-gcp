...
public final class RegionResizeRequestRequestedRunDurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionResizeRequestRequestedRunDurationArgs Empty = new RegionResizeRequestRequestedRunDurationArgs();
    ...
    private RegionResizeRequestRequestedRunDurationArgs(RegionResizeRequestRequestedRunDurationArgs $) {
        this.nanos = $.nanos;
    ...
    public static Builder builder(RegionResizeRequestRequestedRunDurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionResizeRequestRequestedRunDurationArgs();
        }

        public Builder(RegionResizeRequestRequestedRunDurationArgs defaults) {
            $ = new RegionResizeRequestRequestedRunDurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionResizeRequestRequestedRunDurationArgs build() {
            if ($.seconds == null) {
                throw new MissingRequiredPropertyException("RegionResizeRequestRequestedRunDurationArgs", "seconds");
            }
            return $;
        }
    }
