...
@CustomType
public final class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio {
    /**
     * @return (Output)
    ...
    public static Builder builder(CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio defaults) {
    ...
    public static final class Builder {
        ...
        private String audioUri;
        public Builder() {}
        public Builder(CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio defaults) {
        ...
        public Builder audioUri(String audioUri) {
            if (audioUri == null) {
              throw new MissingRequiredPropertyException("CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio", "audioUri");
            }
            this.audioUri = audioUri;
            return this;
        }
        public CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio build() {
            final var _resultValue = new CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessagePlayAudio();
