...
public final class ApiIamBindingState extends com.pulumi.resources.ResourceArgs {
    ...
    private ApiIamBindingState(ApiIamBindingState $) {
        this.api = $.api;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiIamBindingState();
        }

        public Builder(ApiIamBindingState defaults) {
            $ = new ApiIamBindingState(Objects.requireNonNull(defaults));
        }
