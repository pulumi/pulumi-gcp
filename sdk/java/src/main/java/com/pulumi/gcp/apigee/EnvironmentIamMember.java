 ...
 * 
 * ```sh
 * $ pulumi import gcp:apigee/environmentIamMember:EnvironmentIamMember editor &#34;{{org_id}}/environments/{{environment}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class EnvironmentIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public EnvironmentIamMember(java.lang.String name) {
     ...
     */
    public EnvironmentIamMember(java.lang.String name, EnvironmentIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EnvironmentIamMember(java.lang.String name, EnvironmentIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:apigee/environmentIamMember:EnvironmentIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private EnvironmentIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable EnvironmentIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:apigee/environmentIamMember:EnvironmentIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static EnvironmentIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable EnvironmentIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
