...
@CustomType
public final class InstancePartitionAutoscalingConfigAutoscalingLimits {
    /**
     * @return Specifies maximum number of nodes allocated to the instance partition. If set, this number
     * should be greater than or equal to min_nodes.
     * 
     */
    private @Nullable Integer maxNodes;
    /**
     * @return Specifies maximum number of processing units allocated to the instance partition.
    ...
    /**
     * @return Specifies number of nodes allocated to the instance partition. If set, this number
     * should be greater than or equal to 1.
     * 
     */
    private @Nullable Integer minNodes;
    /**
     * @return Specifies minimum number of processing units allocated to the instance partition.
     * If set, this number should be multiples of 1000.
     * 
     */
    private @Nullable Integer minProcessingUnits;

    private InstancePartitionAutoscalingConfigAutoscalingLimits() {}
    /**
     * @return Specifies maximum number of nodes allocated to the instance partition. If set, this number
     * should be greater than or equal to min_nodes.
     * 
    ...
    public static Builder builder(InstancePartitionAutoscalingConfigAutoscalingLimits defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minProcessingUnits;
        public Builder() {}
        public Builder(InstancePartitionAutoscalingConfigAutoscalingLimits defaults) {
        ...
        public InstancePartitionAutoscalingConfigAutoscalingLimits build() {
            final var _resultValue = new InstancePartitionAutoscalingConfigAutoscalingLimits();
