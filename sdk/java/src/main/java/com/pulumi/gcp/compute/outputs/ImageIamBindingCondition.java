...
@CustomType
public final class ImageIamBindingCondition {
    /**
    ...
    private ImageIamBindingCondition() {}
    /**
     * @return An optional description of the expression. This is a longer text which describes the expression, e.g. when hovered over it in a UI.
     * 
     * &gt; **Warning:** This provider considers the `role` and condition contents (`title`+`description`+`expression`) as the
    ...
    public static Builder builder(ImageIamBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(ImageIamBindingCondition defaults) {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("ImageIamBindingCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("ImageIamBindingCondition", "title");
            }
            this.title = title;
            return this;
        }
