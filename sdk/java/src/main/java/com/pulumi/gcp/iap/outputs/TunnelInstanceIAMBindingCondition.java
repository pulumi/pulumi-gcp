...
public final class TunnelInstanceIAMBindingCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("TunnelInstanceIAMBindingCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("TunnelInstanceIAMBindingCondition", "title");
            }
            this.title = title;
            return this;
        }
