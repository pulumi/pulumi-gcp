...
public final class RegionInstanceGroupManagerNamedPort {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("RegionInstanceGroupManagerNamedPort", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("RegionInstanceGroupManagerNamedPort", "port");
            }
            this.port = port;
            return this;
        }
