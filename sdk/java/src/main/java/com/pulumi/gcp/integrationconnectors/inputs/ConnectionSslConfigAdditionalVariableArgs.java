...
public final class ConnectionSslConfigAdditionalVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConnectionSslConfigAdditionalVariableArgs Empty = new ConnectionSslConfigAdditionalVariableArgs();
     ...
     * 
     */
    public Optional<Output<ConnectionSslConfigAdditionalVariableEncryptionKeyValueArgs>> encryptionKeyValue() {
    ...
    private @Nullable Output<ConnectionSslConfigAdditionalVariableSecretValueArgs> secretValue;
     ...
     * 
     */
    public Optional<Output<ConnectionSslConfigAdditionalVariableSecretValueArgs>> secretValue() {
    ...
    private ConnectionSslConfigAdditionalVariableArgs() {}

    private ConnectionSslConfigAdditionalVariableArgs(ConnectionSslConfigAdditionalVariableArgs $) {
    ...
    public static Builder builder(ConnectionSslConfigAdditionalVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectionSslConfigAdditionalVariableArgs();
        }

        public Builder(ConnectionSslConfigAdditionalVariableArgs defaults) {
            $ = new ConnectionSslConfigAdditionalVariableArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder encryptionKeyValue(@Nullable Output<ConnectionSslConfigAdditionalVariableEncryptionKeyValueArgs> encryptionKeyValue) {
         ...
         * 
         */
        public Builder encryptionKeyValue(ConnectionSslConfigAdditionalVariableEncryptionKeyValueArgs encryptionKeyValue) {
         ...
         * 
         */
        public Builder secretValue(@Nullable Output<ConnectionSslConfigAdditionalVariableSecretValueArgs> secretValue) {
         ...
         * 
         */
        public Builder secretValue(ConnectionSslConfigAdditionalVariableSecretValueArgs secretValue) {
        ...
        public ConnectionSslConfigAdditionalVariableArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("ConnectionSslConfigAdditionalVariableArgs", "key");
            }
            return $;
        }
    }
