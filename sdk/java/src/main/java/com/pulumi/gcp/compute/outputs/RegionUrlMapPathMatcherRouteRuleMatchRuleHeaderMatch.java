...
public final class RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatch {
    ...
    public static final class Builder {
        ...
        public Builder headerName(String headerName) {
            if (headerName == null) {
              throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatch", "headerName");
            }
        ...
        public RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatch build() {
            final var _resultValue = new RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatch();
