...
import com.pulumi.gcp.dataproc.inputs.MetastoreTableIamBindingState;
import com.pulumi.gcp.dataproc.outputs.MetastoreTableIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataproc/metastoreTableIamBinding:MetastoreTableIamBinding editor &#34;projects/{{project}}/locations/{{location}}/services/{{serviceId}}/databases/{{databaseId}}/tables/{{table}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataproc/metastoreTableIamBinding:MetastoreTableIamBinding")
public class MetastoreTableIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={MetastoreTableIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ MetastoreTableIamBindingCondition> condition;

    public Output<Optional<MetastoreTableIamBindingCondition>> condition() {
     ...
     */
    public MetastoreTableIamBinding(java.lang.String name) {
        this(name, MetastoreTableIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MetastoreTableIamBinding(java.lang.String name, MetastoreTableIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetastoreTableIamBinding(java.lang.String name, MetastoreTableIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreTableIamBinding:MetastoreTableIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetastoreTableIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreTableIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreTableIamBinding:MetastoreTableIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static MetastoreTableIamBindingArgs makeArgs(MetastoreTableIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MetastoreTableIamBindingArgs.Empty : args;
    }
     ...
     */
    public static MetastoreTableIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreTableIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
