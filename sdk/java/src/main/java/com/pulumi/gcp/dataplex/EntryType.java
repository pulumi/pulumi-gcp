...
public class EntryType extends com.pulumi.resources.CustomResource {
     ...
     */
    public EntryType(String name, @Nullable EntryTypeArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EntryType(String name, @Nullable EntryTypeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/entryType:EntryType", name, args == null ? EntryTypeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private EntryType(String name, Output<String> id, @Nullable EntryTypeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/entryType:EntryType", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static EntryType get(String name, Output<String> id, @Nullable EntryTypeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
