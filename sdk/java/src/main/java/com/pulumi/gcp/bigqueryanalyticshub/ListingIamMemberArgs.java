...
public final class ListingIamMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final ListingIamMemberArgs Empty = new ListingIamMemberArgs();
    ...
    private ListingIamMemberArgs() {}

    private ListingIamMemberArgs(ListingIamMemberArgs $) {
    ...
    public static Builder builder(ListingIamMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListingIamMemberArgs();
        }

        public Builder(ListingIamMemberArgs defaults) {
            $ = new ListingIamMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ListingIamMemberArgs build() {
            if ($.dataExchangeId == null) {
                throw new MissingRequiredPropertyException("ListingIamMemberArgs", "dataExchangeId");
            }
            if ($.listingId == null) {
                throw new MissingRequiredPropertyException("ListingIamMemberArgs", "listingId");
            }
            if ($.member == null) {
                throw new MissingRequiredPropertyException("ListingIamMemberArgs", "member");
            }
            if ($.role == null) {
                throw new MissingRequiredPropertyException("ListingIamMemberArgs", "role");
            }
            return $;
        }
    }
