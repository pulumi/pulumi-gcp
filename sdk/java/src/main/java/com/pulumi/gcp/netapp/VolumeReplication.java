...
public class VolumeReplication extends com.pulumi.resources.CustomResource {
     ...
     */
    public VolumeReplication(String name) {
     ...
     */
    public static VolumeReplication get(String name, Output<String> id, @Nullable VolumeReplicationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
