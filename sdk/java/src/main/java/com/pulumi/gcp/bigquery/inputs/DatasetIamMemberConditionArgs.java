...
public final class DatasetIamMemberConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DatasetIamMemberConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("DatasetIamMemberConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("DatasetIamMemberConditionArgs", "title");
            }
            return $;
        }
    }
