...
@CustomType
public final class GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl {
    /**
    ...
    private GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl() {}
    /**
     * @return Oracle Application Express (APEX) URL.
     * 
     */
    ...
    public static Builder builder(GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl defaults) {
    ...
    public static final class Builder {
        ...
        private String sqlDevWebUri;
        public Builder() {}
        public Builder(GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl defaults) {
        ...
        public Builder apexUri(String apexUri) {
            if (apexUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "apexUri");
            }
        ...
        public Builder databaseTransformsUri(String databaseTransformsUri) {
            if (databaseTransformsUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "databaseTransformsUri");
            }
        ...
        public Builder graphStudioUri(String graphStudioUri) {
            if (graphStudioUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "graphStudioUri");
            }
        ...
        public Builder machineLearningNotebookUri(String machineLearningNotebookUri) {
            if (machineLearningNotebookUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "machineLearningNotebookUri");
            }
        ...
        public Builder machineLearningUserManagementUri(String machineLearningUserManagementUri) {
            if (machineLearningUserManagementUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "machineLearningUserManagementUri");
            }
        ...
        public Builder mongoDbUri(String mongoDbUri) {
            if (mongoDbUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "mongoDbUri");
            }
        ...
        public Builder ordsUri(String ordsUri) {
            if (ordsUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "ordsUri");
            }
        ...
        public Builder sqlDevWebUri(String sqlDevWebUri) {
            if (sqlDevWebUri == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl", "sqlDevWebUri");
            }
            this.sqlDevWebUri = sqlDevWebUri;
            return this;
        }
        public GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl build() {
            final var _resultValue = new GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl();
