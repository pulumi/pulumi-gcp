...
import com.pulumi.gcp.dataplex.inputs.GlossaryIamMemberState;
import com.pulumi.gcp.dataplex.outputs.GlossaryIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/glossaryIamMember:GlossaryIamMember editor &#34;projects/{{project}}/locations/{{location}}/glossaries/{{glossary_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataplex/glossaryIamMember:GlossaryIamMember")
public class GlossaryIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={GlossaryIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ GlossaryIamMemberCondition> condition;

    public Output<Optional<GlossaryIamMemberCondition>> condition() {
     ...
     */
    public GlossaryIamMember(java.lang.String name) {
        this(name, GlossaryIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GlossaryIamMember(java.lang.String name, GlossaryIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GlossaryIamMember(java.lang.String name, GlossaryIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/glossaryIamMember:GlossaryIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GlossaryIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable GlossaryIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/glossaryIamMember:GlossaryIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static GlossaryIamMemberArgs makeArgs(GlossaryIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GlossaryIamMemberArgs.Empty : args;
    }
     ...
     */
    public static GlossaryIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable GlossaryIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
