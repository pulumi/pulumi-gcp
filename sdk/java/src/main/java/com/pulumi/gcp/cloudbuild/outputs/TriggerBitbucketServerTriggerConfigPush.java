...
public final class TriggerBitbucketServerTriggerConfigPush {
    ...
    public static Builder builder(TriggerBitbucketServerTriggerConfigPush defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tag;
        public Builder() {}
        public Builder(TriggerBitbucketServerTriggerConfigPush defaults) {
        ...
        public TriggerBitbucketServerTriggerConfigPush build() {
            final var _resultValue = new TriggerBitbucketServerTriggerConfigPush();
