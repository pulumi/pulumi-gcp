...
@CustomType
public final class NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig {
    /**
    ...
    private NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig() {}
    /**
     * @return Defines whether the instance has integrity monitoring enabled. Enables monitoring and attestation of the boot integrity of the instance. The attestation is performed against the integrity policy baseline. This baseline is initially derived from the implicitly trusted boot image when the instance is created. Enabled by default.
     * 
     */
    ...
    public static Builder builder(NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean enableVtpm;
        public Builder() {}
        public Builder(NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig defaults) {
        ...
        public NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig build() {
            final var _resultValue = new NotebookExecutionCustomEnvironmentSpecShieldedInstanceConfig();
