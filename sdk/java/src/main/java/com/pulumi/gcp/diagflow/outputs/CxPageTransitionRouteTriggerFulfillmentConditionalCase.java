...
@CustomType
public final class CxPageTransitionRouteTriggerFulfillmentConditionalCase {
    /**
    ...
    private CxPageTransitionRouteTriggerFulfillmentConditionalCase() {}
    /**
     * @return A JSON encoded list of cascading if-else conditions. Cases are mutually exclusive. The first one with a matching condition is selected, all the rest ignored.
     * See [Case](https://cloud.google.com/dialogflow/cx/docs/reference/rest/v3/Fulfillment#case) for the schema.
     * 
    ...
    public static Builder builder(CxPageTransitionRouteTriggerFulfillmentConditionalCase defaults) {
    ...
    public static final class Builder {
        private @Nullable String cases;
        public Builder() {}
        public Builder(CxPageTransitionRouteTriggerFulfillmentConditionalCase defaults) {
