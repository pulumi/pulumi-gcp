...
public final class ServiceBinaryAuthorizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceBinaryAuthorizationArgs Empty = new ServiceBinaryAuthorizationArgs();
    ...
    private ServiceBinaryAuthorizationArgs() {}

    private ServiceBinaryAuthorizationArgs(ServiceBinaryAuthorizationArgs $) {
    ...
    public static Builder builder(ServiceBinaryAuthorizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceBinaryAuthorizationArgs();
        }

        public Builder(ServiceBinaryAuthorizationArgs defaults) {
            $ = new ServiceBinaryAuthorizationArgs(Objects.requireNonNull(defaults));
        }
