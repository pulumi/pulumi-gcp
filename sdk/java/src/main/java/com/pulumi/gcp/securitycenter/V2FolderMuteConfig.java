...
import com.pulumi.gcp.securitycenter.inputs.V2FolderMuteConfigState;
 ...
 * 
 */
@ResourceType(type="gcp:securitycenter/v2FolderMuteConfig:V2FolderMuteConfig")
public class V2FolderMuteConfig extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public V2FolderMuteConfig(java.lang.String name) {
        this(name, V2FolderMuteConfigArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public V2FolderMuteConfig(java.lang.String name, V2FolderMuteConfigArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public V2FolderMuteConfig(java.lang.String name, V2FolderMuteConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2FolderMuteConfig:V2FolderMuteConfig", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private V2FolderMuteConfig(java.lang.String name, Output<java.lang.String> id, @Nullable V2FolderMuteConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2FolderMuteConfig:V2FolderMuteConfig", name, state, makeResourceOptions(options, id), false);
    }

    private static V2FolderMuteConfigArgs makeArgs(V2FolderMuteConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? V2FolderMuteConfigArgs.Empty : args;
    }
     ...
     */
    public static V2FolderMuteConfig get(java.lang.String name, Output<java.lang.String> id, @Nullable V2FolderMuteConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
