...
@CustomType
public final class ReportSummaryGroupFindingPreferenceSetFindingMachinePreferenceVmwareEnginePreference {
    /**
     * @return (Output)
    ...
    private ReportSummaryGroupFindingPreferenceSetFindingMachinePreferenceVmwareEnginePreference() {}
    /**
     * @return (Output)
     * Commitment plan to consider when calculating costs for virtual machine
     * insights and recommendations.
    ...
    public static Builder builder(ReportSummaryGroupFindingPreferenceSetFindingMachinePreferenceVmwareEnginePreference defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double storageDeduplicationCompressionRatio;
        public Builder() {}
        public Builder(ReportSummaryGroupFindingPreferenceSetFindingMachinePreferenceVmwareEnginePreference defaults) {
        ...
        public ReportSummaryGroupFindingPreferenceSetFindingMachinePreferenceVmwareEnginePreference build() {
            final var _resultValue = new ReportSummaryGroupFindingPreferenceSetFindingMachinePreferenceVmwareEnginePreference();
