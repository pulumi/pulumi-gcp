...
import com.pulumi.gcp.networksecurity.AddressGroupIamMemberArgs;
import com.pulumi.gcp.networksecurity.inputs.AddressGroupIamMemberState;
import com.pulumi.gcp.networksecurity.outputs.AddressGroupIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:networksecurity/addressGroupIamMember:AddressGroupIamMember editor &#34;projects/{{project}}/locations/{{location}}/addressGroups/{{project_address_group}} roles/compute.networkAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:networksecurity/addressGroupIamMember:AddressGroupIamMember")
public class AddressGroupIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={AddressGroupIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ AddressGroupIamMemberCondition> condition;

    public Output<Optional<AddressGroupIamMemberCondition>> condition() {
