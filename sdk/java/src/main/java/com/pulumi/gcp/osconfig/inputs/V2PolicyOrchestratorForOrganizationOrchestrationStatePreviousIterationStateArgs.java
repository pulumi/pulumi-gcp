...
import com.pulumi.gcp.osconfig.inputs.V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateErrorArgs;
...
public final class V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs Empty = new V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs();
     ...
     */
    @Import(name="error")
    private @Nullable Output<V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateErrorArgs> error;
     ...
     * 
     */
    public Optional<Output<V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateErrorArgs>> error() {
    ...
    private V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs() {}

    private V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs(V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs $) {
        this.error = $.error;
    ...
    public static Builder builder(V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs();
        }

        public Builder(V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs defaults) {
            $ = new V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder error(@Nullable Output<V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateErrorArgs> error) {
            $.error = error;
            return this;
        }
         ...
         * 
         */
        public Builder error(V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateErrorArgs error) {
        ...
        public V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateArgs build() {
            return $;
        }
    }
