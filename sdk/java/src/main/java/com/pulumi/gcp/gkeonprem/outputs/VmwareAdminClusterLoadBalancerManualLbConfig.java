...
public final class VmwareAdminClusterLoadBalancerManualLbConfig {
     ...
     * 
     */
    private @Nullable Integer addonsNodePort;
    /**
     ...
     * 
     */
    public Optional<Integer> addonsNodePort() {
    ...
    public static Builder builder(VmwareAdminClusterLoadBalancerManualLbConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer konnectivityServerNodePort;
        public Builder() {}
        public Builder(VmwareAdminClusterLoadBalancerManualLbConfig defaults) {
    	      Objects.requireNonNull(defaults);
    	      this.addonsNodePort = defaults.addonsNodePort;
        ...
        @CustomType.Setter
        public Builder addonsNodePort(@Nullable Integer addonsNodePort) {
        ...
        public VmwareAdminClusterLoadBalancerManualLbConfig build() {
            final var _resultValue = new VmwareAdminClusterLoadBalancerManualLbConfig();
            _resultValue.addonsNodePort = addonsNodePort;
