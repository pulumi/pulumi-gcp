...
public class SubscriptionIAMBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public SubscriptionIAMBinding(java.lang.String name) {
     ...
     */
    public SubscriptionIAMBinding(java.lang.String name, SubscriptionIAMBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SubscriptionIAMBinding(java.lang.String name, SubscriptionIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/subscriptionIAMBinding:SubscriptionIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SubscriptionIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable SubscriptionIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/subscriptionIAMBinding:SubscriptionIAMBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SubscriptionIAMBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable SubscriptionIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
