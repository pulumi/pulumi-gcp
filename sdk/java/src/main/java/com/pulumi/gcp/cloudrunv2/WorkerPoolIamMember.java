...
import com.pulumi.gcp.cloudrunv2.inputs.WorkerPoolIamMemberState;
import com.pulumi.gcp.cloudrunv2.outputs.WorkerPoolIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember editor &#34;projects/{{project}}/locations/{{location}}/workerPools/{{worker_pool}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember")
public class WorkerPoolIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={WorkerPoolIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ WorkerPoolIamMemberCondition> condition;

    public Output<Optional<WorkerPoolIamMemberCondition>> condition() {
     ...
     */
    public WorkerPoolIamMember(java.lang.String name) {
        this(name, WorkerPoolIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WorkerPoolIamMember(java.lang.String name, WorkerPoolIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkerPoolIamMember(java.lang.String name, WorkerPoolIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WorkerPoolIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable WorkerPoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/workerPoolIamMember:WorkerPoolIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static WorkerPoolIamMemberArgs makeArgs(WorkerPoolIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WorkerPoolIamMemberArgs.Empty : args;
    }
     ...
     */
    public static WorkerPoolIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkerPoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
