...
public final class ApplicationUrlDispatchRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ApplicationUrlDispatchRuleArgs(ApplicationUrlDispatchRuleArgs $) {
        this.domain = $.domain;
        this.path = $.path;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationUrlDispatchRuleArgs();
        }

        public Builder(ApplicationUrlDispatchRuleArgs defaults) {
            $ = new ApplicationUrlDispatchRuleArgs(Objects.requireNonNull(defaults));
        }
