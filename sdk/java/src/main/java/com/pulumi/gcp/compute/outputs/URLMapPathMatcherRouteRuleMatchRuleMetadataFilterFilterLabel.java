...
public final class URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabel {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabel", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabel", "value");
            }
            this.value = value;
            return this;
        }
        public URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabel build() {
            final var _resultValue = new URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabel();
