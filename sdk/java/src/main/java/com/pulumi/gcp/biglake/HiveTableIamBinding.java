...
import com.pulumi.gcp.biglake.inputs.HiveTableIamBindingState;
import com.pulumi.gcp.biglake.outputs.HiveTableIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveTableIamBinding:HiveTableIamBinding")
public class HiveTableIamBinding extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={HiveTableIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ HiveTableIamBindingCondition> condition;

    public Output<Optional<HiveTableIamBindingCondition>> condition() {
     ...
     */
    public HiveTableIamBinding(java.lang.String name) {
        this(name, HiveTableIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveTableIamBinding(java.lang.String name, HiveTableIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveTableIamBinding(java.lang.String name, HiveTableIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveTableIamBinding:HiveTableIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveTableIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable HiveTableIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveTableIamBinding:HiveTableIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveTableIamBindingArgs makeArgs(HiveTableIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveTableIamBindingArgs.Empty : args;
    }
     ...
     */
    public static HiveTableIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveTableIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
