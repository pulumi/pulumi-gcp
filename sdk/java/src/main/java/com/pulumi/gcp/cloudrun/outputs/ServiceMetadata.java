...
public final class ServiceMetadata {
     ...
     * 
     */
    private @Nullable Map<String,String> terraformLabels;
    /**
     * @return (Output)
    ...
    public Map<String,String> terraformLabels() {
        return this.terraformLabels == null ? Map.of() : this.terraformLabels;
    }
    /**
     * @return (Output)
     * UID is a unique id generated by the server on successful creation of a resource and is not
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder terraformLabels(@Nullable Map<String,String> terraformLabels) {
