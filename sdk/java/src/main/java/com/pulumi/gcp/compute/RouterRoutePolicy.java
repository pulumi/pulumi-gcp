...
public class RouterRoutePolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public RouterRoutePolicy(String name) {
     ...
     */
    public RouterRoutePolicy(String name, RouterRoutePolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/routerRoutePolicy:RouterRoutePolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private RouterRoutePolicy(String name, Output<String> id, @Nullable RouterRoutePolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/routerRoutePolicy:RouterRoutePolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RouterRoutePolicy get(String name, Output<String> id, @Nullable RouterRoutePolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
