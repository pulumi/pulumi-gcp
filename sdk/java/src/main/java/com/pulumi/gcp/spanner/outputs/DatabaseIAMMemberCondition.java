...
public final class DatabaseIAMMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("DatabaseIAMMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("DatabaseIAMMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
