...
@CustomType
public final class DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate {
    /**
    ...
    private DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate() {}
    /**
     * @return Day of a month. Must be from 1 to 31 and valid for the year and month, or 0 to specify a year by itself or a year and month where the day isn&#39;t significant.
     * 
     */
    ...
    public static Builder builder(DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate defaults) {
        ...
        public DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate build() {
            final var _resultValue = new DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDate();
