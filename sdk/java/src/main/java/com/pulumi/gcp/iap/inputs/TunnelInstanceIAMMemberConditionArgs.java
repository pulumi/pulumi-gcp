...
public final class TunnelInstanceIAMMemberConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TunnelInstanceIAMMemberConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("TunnelInstanceIAMMemberConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("TunnelInstanceIAMMemberConditionArgs", "title");
            }
            return $;
        }
    }
