...
public final class OrganizationSinkExclusionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public OrganizationSinkExclusionArgs build() {
            if ($.filter == null) {
                throw new MissingRequiredPropertyException("OrganizationSinkExclusionArgs", "filter");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OrganizationSinkExclusionArgs", "name");
            }
            return $;
        }
    }
