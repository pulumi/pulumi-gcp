...
import com.pulumi.gcp.apigee.inputs.ApiMetaDataArgs;
...
public final class ApiState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ApiMetaDataArgs>> metaDatas;
     ...
     * 
     */
    public Optional<Output<List<ApiMetaDataArgs>>> metaDatas() {
    ...
    public static final class Builder {
        ...
        /**
         * @param latestRevisionId The id of the most recently created revision for this API proxy.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param md5hash (Computed) Base 64 MD5 hash of the uploaded data. It is speculative as remote does not return hash of the bundle. Remote changes are detected using returned last_modified timestamp.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder metaDatas(@Nullable Output<List<ApiMetaDataArgs>> metaDatas) {
            $.metaDatas = metaDatas;
            return this;
        }
         ...
         * 
         */
        public Builder metaDatas(List<ApiMetaDataArgs> metaDatas) {
         ...
         * 
         */
        public Builder metaDatas(ApiMetaDataArgs... metaDatas) {
        ...
        /**
         * @param revisions A list of revisions of this API proxy.
         * 
         * @return builder
         * 
         */
