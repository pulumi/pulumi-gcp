 ...
 * 
 * ```sh
 * $ pulumi import gcp:servicedirectory/namespaceIamBinding:NamespaceIamBinding editor &#34;projects/{{project}}/locations/{{location}}/namespaces/{{namespace_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class NamespaceIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public NamespaceIamBinding(java.lang.String name) {
     ...
     */
    public NamespaceIamBinding(java.lang.String name, NamespaceIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NamespaceIamBinding(java.lang.String name, NamespaceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:servicedirectory/namespaceIamBinding:NamespaceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NamespaceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable NamespaceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:servicedirectory/namespaceIamBinding:NamespaceIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static NamespaceIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable NamespaceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
