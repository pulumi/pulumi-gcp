...
@CustomType
public final class FutureReservationAutoCreatedReservationsDuration {
    /**
    ...
    private FutureReservationAutoCreatedReservationsDuration() {}
    /**
     * @return Span of time that&#39;s a fraction of a second at nanosecond resolution. Durations less than one second are represented with a 0 seconds field and a positive nanos field. Must be from 0 to 999,999,999 inclusive.
     * 
     */
    ...
    public static Builder builder(FutureReservationAutoCreatedReservationsDuration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seconds;
        public Builder() {}
        public Builder(FutureReservationAutoCreatedReservationsDuration defaults) {
        ...
        public FutureReservationAutoCreatedReservationsDuration build() {
            final var _resultValue = new FutureReservationAutoCreatedReservationsDuration();
