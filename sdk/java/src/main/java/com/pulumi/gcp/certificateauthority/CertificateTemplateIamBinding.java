...
public class CertificateTemplateIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public CertificateTemplateIamBinding(String name) {
     ...
     */
    public static CertificateTemplateIamBinding get(String name, Output<String> id, @Nullable CertificateTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
