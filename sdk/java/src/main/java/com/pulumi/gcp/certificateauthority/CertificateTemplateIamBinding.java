...
import com.pulumi.gcp.certificateauthority.inputs.CertificateTemplateIamBindingState;
import com.pulumi.gcp.certificateauthority.outputs.CertificateTemplateIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:certificateauthority/certificateTemplateIamBinding:CertificateTemplateIamBinding editor &#34;projects/{{project}}/locations/{{location}}/certificateTemplates/{{certificate_template}} roles/privateca.templateUser user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:certificateauthority/certificateTemplateIamBinding:CertificateTemplateIamBinding")
public class CertificateTemplateIamBinding extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    public Output<Optional<CertificateTemplateIamBindingCondition>> condition() {
     ...
     */
    public CertificateTemplateIamBinding(java.lang.String name) {
        this(name, CertificateTemplateIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public CertificateTemplateIamBinding(java.lang.String name, CertificateTemplateIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CertificateTemplateIamBinding(java.lang.String name, CertificateTemplateIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/certificateTemplateIamBinding:CertificateTemplateIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CertificateTemplateIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable CertificateTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/certificateTemplateIamBinding:CertificateTemplateIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CertificateTemplateIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable CertificateTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
