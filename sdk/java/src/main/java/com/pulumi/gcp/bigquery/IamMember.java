 ...
 * 
 * ```sh
 * $ pulumi import gcp:bigquery/iamMember:IamMember editor &#34;projects/{{project}}/datasets/{{dataset_id}}/tables/{{table_id}} roles/bigquery.dataOwner user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class IamMember extends com.pulumi.resources.CustomResource {
    ...
    public IamMember(java.lang.String name, IamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/iamMember:IamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IamMember(java.lang.String name, Output<java.lang.String> id, @Nullable IamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/iamMember:IamMember", name, state, makeResourceOptions(options, id), false);
    }
