 ...
 * 
 * ```sh
 * $ pulumi import gcp:datacatalog/tagTemplateIamBinding:TagTemplateIamBinding editor &#34;projects/{{project}}/locations/{{region}}/tagTemplates/{{tag_template}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TagTemplateIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public TagTemplateIamBinding(java.lang.String name) {
     ...
     */
    public TagTemplateIamBinding(java.lang.String name, TagTemplateIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TagTemplateIamBinding(java.lang.String name, TagTemplateIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/tagTemplateIamBinding:TagTemplateIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TagTemplateIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable TagTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/tagTemplateIamBinding:TagTemplateIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TagTemplateIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable TagTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
