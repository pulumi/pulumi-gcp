...
import com.pulumi.gcp.iap.inputs.WebCloudRunServiceIamBindingState;
import com.pulumi.gcp.iap.outputs.WebCloudRunServiceIamBindingCondition;
 ...
 * ```sh
 * $ terraform import google_iap_web_cloud_run_service_iam_member.editor &#34;projects/{{project}}/iap_web/cloud_run-{{location}}/services/{{web_cloud_run_service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/webCloudRunServiceIamBinding:WebCloudRunServiceIamBinding")
public class WebCloudRunServiceIamBinding extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="condition", refs={WebCloudRunServiceIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ WebCloudRunServiceIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<WebCloudRunServiceIamBindingCondition>> condition() {
     ...
     * `gcp.iap.WebCloudRunServiceIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
     ...
     */
    public WebCloudRunServiceIamBinding(java.lang.String name) {
        this(name, WebCloudRunServiceIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebCloudRunServiceIamBinding(java.lang.String name, WebCloudRunServiceIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebCloudRunServiceIamBinding(java.lang.String name, WebCloudRunServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webCloudRunServiceIamBinding:WebCloudRunServiceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebCloudRunServiceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable WebCloudRunServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webCloudRunServiceIamBinding:WebCloudRunServiceIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static WebCloudRunServiceIamBindingArgs makeArgs(WebCloudRunServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebCloudRunServiceIamBindingArgs.Empty : args;
    }
     ...
     */
    public static WebCloudRunServiceIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable WebCloudRunServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new WebCloudRunServiceIamBinding(name, id, state, options);
    }
}
