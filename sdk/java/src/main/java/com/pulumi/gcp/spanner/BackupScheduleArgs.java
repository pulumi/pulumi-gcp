...
public final class BackupScheduleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BackupScheduleArgs build() {
            if ($.database == null) {
                throw new MissingRequiredPropertyException("BackupScheduleArgs", "database");
            }
            if ($.instance == null) {
                throw new MissingRequiredPropertyException("BackupScheduleArgs", "instance");
            }
            if ($.retentionDuration == null) {
                throw new MissingRequiredPropertyException("BackupScheduleArgs", "retentionDuration");
            }
            return $;
        }
    }
