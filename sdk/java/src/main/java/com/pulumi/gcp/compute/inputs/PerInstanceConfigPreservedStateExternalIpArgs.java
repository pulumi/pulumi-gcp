...
public final class PerInstanceConfigPreservedStateExternalIpArgs extends com.pulumi.resources.ResourceArgs {

    public static final PerInstanceConfigPreservedStateExternalIpArgs Empty = new PerInstanceConfigPreservedStateExternalIpArgs();
    ...
    private @Nullable Output<PerInstanceConfigPreservedStateExternalIpIpAddressArgs> ipAddress;
     ...
     * 
     */
    public Optional<Output<PerInstanceConfigPreservedStateExternalIpIpAddressArgs>> ipAddress() {
        return Optional.ofNullable(this.ipAddress);
    }

    private PerInstanceConfigPreservedStateExternalIpArgs() {}

    private PerInstanceConfigPreservedStateExternalIpArgs(PerInstanceConfigPreservedStateExternalIpArgs $) {
    ...
    public static Builder builder(PerInstanceConfigPreservedStateExternalIpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PerInstanceConfigPreservedStateExternalIpArgs();
        }

        public Builder(PerInstanceConfigPreservedStateExternalIpArgs defaults) {
            $ = new PerInstanceConfigPreservedStateExternalIpArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder ipAddress(@Nullable Output<PerInstanceConfigPreservedStateExternalIpIpAddressArgs> ipAddress) {
            $.ipAddress = ipAddress;
            return this;
        }
         ...
         * 
         */
        public Builder ipAddress(PerInstanceConfigPreservedStateExternalIpIpAddressArgs ipAddress) {
