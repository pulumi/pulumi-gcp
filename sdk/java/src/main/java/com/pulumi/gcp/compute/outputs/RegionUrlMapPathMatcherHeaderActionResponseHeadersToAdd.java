...
@CustomType
public final class RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd {
    /**
    ...
    private RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd() {}
    /**
     * @return The name of the header.
     * 
     */
    ...
    public static Builder builder(RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean replace;
        public Builder() {}
        public Builder(RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd defaults) {
        ...
        public RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd build() {
            final var _resultValue = new RegionUrlMapPathMatcherHeaderActionResponseHeadersToAdd();
