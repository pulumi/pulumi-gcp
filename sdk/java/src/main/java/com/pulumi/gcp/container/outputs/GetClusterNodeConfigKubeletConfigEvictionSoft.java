...
@CustomType
public final class GetClusterNodeConfigKubeletConfigEvictionSoft {
    /**
    ...
    private GetClusterNodeConfigKubeletConfigEvictionSoft() {}
    /**
     * @return Defines percentage of soft eviction threshold for imagefs.available.
     * 
     */
    ...
    public static Builder builder(GetClusterNodeConfigKubeletConfigEvictionSoft defaults) {
    ...
    public static final class Builder {
        ...
        private String pidAvailable;
        public Builder() {}
        public Builder(GetClusterNodeConfigKubeletConfigEvictionSoft defaults) {
        ...
        public Builder imagefsAvailable(String imagefsAvailable) {
            if (imagefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionSoft", "imagefsAvailable");
            }
        ...
        public Builder imagefsInodesFree(String imagefsInodesFree) {
            if (imagefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionSoft", "imagefsInodesFree");
            }
        ...
        public Builder memoryAvailable(String memoryAvailable) {
            if (memoryAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionSoft", "memoryAvailable");
            }
        ...
        public Builder nodefsAvailable(String nodefsAvailable) {
            if (nodefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionSoft", "nodefsAvailable");
            }
        ...
        public Builder nodefsInodesFree(String nodefsInodesFree) {
            if (nodefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionSoft", "nodefsInodesFree");
            }
        ...
        public Builder pidAvailable(String pidAvailable) {
            if (pidAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigKubeletConfigEvictionSoft", "pidAvailable");
            }
            this.pidAvailable = pidAvailable;
            return this;
        }
        public GetClusterNodeConfigKubeletConfigEvictionSoft build() {
            final var _resultValue = new GetClusterNodeConfigKubeletConfigEvictionSoft();
