...
@CustomType
public final class AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue {
    /**
    ...
    private AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue() {}
    /**
     * @return The input string must have the substring specified here. Note: empty contains match is not allowed, please use regex instead.
     * Examples:
     * * abc matches the value xyz.abc.def
    ...
    public static Builder builder(AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue defaults) {
        ...
        public AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue build() {
            final var _resultValue = new AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderValue();
