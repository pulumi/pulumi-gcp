...
public final class DataObjectState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="dataObjectId")
    private @Nullable Output<String> dataObjectId;
     ...
     * 
     */
    public Optional<Output<String>> dataObjectId() {
        return Optional.ofNullable(this.dataObjectId);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder dataObjectId(@Nullable Output<String> dataObjectId) {
