    ...
    public static final class Builder {
        ...
        public Builder retainedBackups(Integer retainedBackups) {
            if (retainedBackups == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingBackupConfigurationBackupRetentionSetting", "retainedBackups");
            }
        ...
        public Builder retentionUnit(String retentionUnit) {
            if (retentionUnit == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingBackupConfigurationBackupRetentionSetting", "retentionUnit");
            }
            this.retentionUnit = retentionUnit;
            return this;
        }
        public GetDatabaseInstanceSettingBackupConfigurationBackupRetentionSetting build() {
            final var _resultValue = new GetDatabaseInstanceSettingBackupConfigurationBackupRetentionSetting();
