...
public class MetastoreServiceIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", type=MetastoreServiceIamMemberCondition.class, parameters={})
    ...
    public MetastoreServiceIamMember(String name, MetastoreServiceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreServiceIamMember:MetastoreServiceIamMember", name, args == null ? MetastoreServiceIamMemberArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
