...
import com.pulumi.gcp.bigquery.inputs.Datapolicyv2DataPolicyIamMemberState;
import com.pulumi.gcp.bigquery.outputs.Datapolicyv2DataPolicyIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:bigquery/datapolicyv2DataPolicyIamMember:Datapolicyv2DataPolicyIamMember editor &#34;projects/{{project}}/locations/{{location}}/dataPolicies/{{data_policy_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:bigquery/datapolicyv2DataPolicyIamMember:Datapolicyv2DataPolicyIamMember")
public class Datapolicyv2DataPolicyIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={Datapolicyv2DataPolicyIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ Datapolicyv2DataPolicyIamMemberCondition> condition;

    public Output<Optional<Datapolicyv2DataPolicyIamMemberCondition>> condition() {
     ...
     */
    public Datapolicyv2DataPolicyIamMember(java.lang.String name) {
        this(name, Datapolicyv2DataPolicyIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Datapolicyv2DataPolicyIamMember(java.lang.String name, Datapolicyv2DataPolicyIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Datapolicyv2DataPolicyIamMember(java.lang.String name, Datapolicyv2DataPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/datapolicyv2DataPolicyIamMember:Datapolicyv2DataPolicyIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Datapolicyv2DataPolicyIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable Datapolicyv2DataPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/datapolicyv2DataPolicyIamMember:Datapolicyv2DataPolicyIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static Datapolicyv2DataPolicyIamMemberArgs makeArgs(Datapolicyv2DataPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? Datapolicyv2DataPolicyIamMemberArgs.Empty : args;
    }
     ...
     */
    public static Datapolicyv2DataPolicyIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable Datapolicyv2DataPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Datapolicyv2DataPolicyIamMember(name, id, state, options);
    }
}
