...
@CustomType
public final class CxFlowTransitionRouteTriggerFulfillmentSetParameterAction {
    /**
    ...
    private CxFlowTransitionRouteTriggerFulfillmentSetParameterAction() {}
    /**
     * @return Display name of the parameter.
     * 
     */
    ...
    public static Builder builder(CxFlowTransitionRouteTriggerFulfillmentSetParameterAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(CxFlowTransitionRouteTriggerFulfillmentSetParameterAction defaults) {
