...
public final class NodePoolNetworkConfigNetworkPerformanceConfig {
    ...
    public static Builder builder(NodePoolNetworkConfigNetworkPerformanceConfig defaults) {
    ...
    public static final class Builder {
        private String totalEgressBandwidthTier;
        public Builder() {}
        public Builder(NodePoolNetworkConfigNetworkPerformanceConfig defaults) {
        ...
        public Builder totalEgressBandwidthTier(String totalEgressBandwidthTier) {
            if (totalEgressBandwidthTier == null) {
              throw new MissingRequiredPropertyException("NodePoolNetworkConfigNetworkPerformanceConfig", "totalEgressBandwidthTier");
            }
            this.totalEgressBandwidthTier = totalEgressBandwidthTier;
            return this;
        }
        public NodePoolNetworkConfigNetworkPerformanceConfig build() {
            final var _resultValue = new NodePoolNetworkConfigNetworkPerformanceConfig();
