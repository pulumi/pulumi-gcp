 ...
 * 
 * ```sh
 * $ pulumi import gcp:pubsub/topicIAMMember:TopicIAMMember editor &#34;projects/{{project}}/topics/{{topic}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TopicIAMMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={TopicIAMMemberCondition.class}, tree="[0]")
     ...
     */
    public TopicIAMMember(java.lang.String name) {
     ...
     */
    public TopicIAMMember(java.lang.String name, TopicIAMMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TopicIAMMember(java.lang.String name, TopicIAMMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/topicIAMMember:TopicIAMMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TopicIAMMember(java.lang.String name, Output<java.lang.String> id, @Nullable TopicIAMMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/topicIAMMember:TopicIAMMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TopicIAMMember get(java.lang.String name, Output<java.lang.String> id, @Nullable TopicIAMMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
