...
import com.pulumi.gcp.bigqueryanalyticshub.DataExchanceIamMemberArgs;
import com.pulumi.gcp.bigqueryanalyticshub.inputs.DataExchanceIamMemberState;
import com.pulumi.gcp.bigqueryanalyticshub.outputs.DataExchanceIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:bigqueryanalyticshub/dataExchanceIamMember:DataExchanceIamMember")
public class DataExchanceIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", type=DataExchanceIamMemberCondition.class, parameters={})
    private Output</* @Nullable */ DataExchanceIamMemberCondition> condition;

    public Output<Optional<DataExchanceIamMemberCondition>> condition() {
     ...
     */
    public DataExchanceIamMember(String name) {
        this(name, DataExchanceIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DataExchanceIamMember(String name, DataExchanceIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataExchanceIamMember(String name, DataExchanceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigqueryanalyticshub/dataExchanceIamMember:DataExchanceIamMember", name, args == null ? DataExchanceIamMemberArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DataExchanceIamMember(String name, Output<String> id, @Nullable DataExchanceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigqueryanalyticshub/dataExchanceIamMember:DataExchanceIamMember", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DataExchanceIamMember get(String name, Output<String> id, @Nullable DataExchanceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
