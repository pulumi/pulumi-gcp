...
public class CaPoolIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public CaPoolIamMember(java.lang.String name) {
     ...
     */
    public CaPoolIamMember(java.lang.String name, CaPoolIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CaPoolIamMember(java.lang.String name, CaPoolIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/caPoolIamMember:CaPoolIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CaPoolIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable CaPoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/caPoolIamMember:CaPoolIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CaPoolIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable CaPoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
