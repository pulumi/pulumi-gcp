...
import com.pulumi.gcp.securesourcemanager.InstanceIamBindingArgs;
import com.pulumi.gcp.securesourcemanager.inputs.InstanceIamBindingState;
import com.pulumi.gcp.securesourcemanager.outputs.InstanceIamBindingCondition;
import java.lang.String;
import java.util.List;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="gcp:securesourcemanager/instanceIamBinding:InstanceIamBinding")
public class InstanceIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public InstanceIamBinding(String name, InstanceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securesourcemanager/instanceIamBinding:InstanceIamBinding", name, args == null ? InstanceIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private InstanceIamBinding(String name, Output<String> id, @Nullable InstanceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securesourcemanager/instanceIamBinding:InstanceIamBinding", name, state, makeResourceOptions(options, id));
    }
