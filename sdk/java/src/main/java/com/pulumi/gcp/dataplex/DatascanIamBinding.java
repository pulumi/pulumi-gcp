 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/datascanIamBinding:DatascanIamBinding editor &#34;projects/{{project}}/locations/{{location}}/dataScans/{{data_scan_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
