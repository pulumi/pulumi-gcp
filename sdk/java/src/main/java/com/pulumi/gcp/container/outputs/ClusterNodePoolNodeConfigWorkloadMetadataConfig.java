...
public final class ClusterNodePoolNodeConfigWorkloadMetadataConfig {
    ...
    public static final class Builder {
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("ClusterNodePoolNodeConfigWorkloadMetadataConfig", "mode");
            }
            this.mode = mode;
            return this;
        }
        public ClusterNodePoolNodeConfigWorkloadMetadataConfig build() {
            final var _resultValue = new ClusterNodePoolNodeConfigWorkloadMetadataConfig();
