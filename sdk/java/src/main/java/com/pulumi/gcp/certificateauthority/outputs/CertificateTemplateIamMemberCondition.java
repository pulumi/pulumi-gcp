...
public final class CertificateTemplateIamMemberCondition {
    ...
    public static Builder builder(CertificateTemplateIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(CertificateTemplateIamMemberCondition defaults) {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("CertificateTemplateIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("CertificateTemplateIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
