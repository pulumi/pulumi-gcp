...
public final class ProjectAutokeyConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectAutokeyConfigArgs Empty = new ProjectAutokeyConfigArgs();
    ...
    private ProjectAutokeyConfigArgs() {}

    private ProjectAutokeyConfigArgs(ProjectAutokeyConfigArgs $) {
    ...
    public static Builder builder(ProjectAutokeyConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectAutokeyConfigArgs();
        }

        public Builder(ProjectAutokeyConfigArgs defaults) {
            $ = new ProjectAutokeyConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectAutokeyConfigArgs build() {
            return $;
        }
    }
