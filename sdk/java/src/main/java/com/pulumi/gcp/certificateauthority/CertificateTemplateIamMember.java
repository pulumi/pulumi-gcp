 ...
 * 
 * ```sh
 * $ pulumi import gcp:certificateauthority/certificateTemplateIamMember:CertificateTemplateIamMember editor &#34;projects/{{project}}/locations/{{location}}/certificateTemplates/{{certificate_template}} roles/privateca.templateUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class CertificateTemplateIamMember extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={CertificateTemplateIamMemberCondition.class}, tree="[0]")
     ...
     */
    public CertificateTemplateIamMember(java.lang.String name) {
     ...
     */
    public CertificateTemplateIamMember(java.lang.String name, CertificateTemplateIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CertificateTemplateIamMember(java.lang.String name, CertificateTemplateIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/certificateTemplateIamMember:CertificateTemplateIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CertificateTemplateIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable CertificateTemplateIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/certificateTemplateIamMember:CertificateTemplateIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static CertificateTemplateIamMemberArgs makeArgs(CertificateTemplateIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CertificateTemplateIamMemberArgs.Empty : args;
    }
     ...
     */
    public static CertificateTemplateIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable CertificateTemplateIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
