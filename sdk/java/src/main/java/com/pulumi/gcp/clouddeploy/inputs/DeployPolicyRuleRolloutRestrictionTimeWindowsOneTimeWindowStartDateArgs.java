...
public final class DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs Empty = new DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs();
    ...
    private DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs() {}

    private DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs(DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs $) {
        this.day = $.day;
        this.month = $.month;
        this.year = $.year;
    }
    ...
    public static Builder builder(DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs();
        }

        public Builder(DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs defaults) {
            $ = new DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeployPolicyRuleRolloutRestrictionTimeWindowsOneTimeWindowStartDateArgs build() {
            return $;
        }
    }
