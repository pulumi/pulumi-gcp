...
import com.pulumi.gcp.biglake.inputs.IcebergCatalogIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:biglake/icebergCatalogIamPolicy:IcebergCatalogIamPolicy editor &#34;projects/{{project}}/catalogs/{{iceberg_catalog}} roles/biglake.editor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:biglake/icebergCatalogIamPolicy:IcebergCatalogIamPolicy")
public class IcebergCatalogIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public IcebergCatalogIamPolicy(java.lang.String name) {
        this(name, IcebergCatalogIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IcebergCatalogIamPolicy(java.lang.String name, IcebergCatalogIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IcebergCatalogIamPolicy(java.lang.String name, IcebergCatalogIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergCatalogIamPolicy:IcebergCatalogIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IcebergCatalogIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergCatalogIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergCatalogIamPolicy:IcebergCatalogIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static IcebergCatalogIamPolicyArgs makeArgs(IcebergCatalogIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IcebergCatalogIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static IcebergCatalogIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergCatalogIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
