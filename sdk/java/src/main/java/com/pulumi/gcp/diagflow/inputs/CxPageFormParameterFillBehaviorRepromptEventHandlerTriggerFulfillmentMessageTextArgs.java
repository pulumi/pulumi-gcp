...
public final class CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs Empty = new CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs();
    ...
    private CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs() {}

    private CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs $) {
    ...
    public static Builder builder(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs();
        }

        public Builder(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs defaults) {
            $ = new CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageTextArgs build() {
            return $;
        }
    }
