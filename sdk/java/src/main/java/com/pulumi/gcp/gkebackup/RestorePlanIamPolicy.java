...
import com.pulumi.gcp.gkebackup.inputs.RestorePlanIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:gkebackup/restorePlanIamPolicy:RestorePlanIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/restorePlans/{{restore_plan}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class RestorePlanIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public RestorePlanIamPolicy(java.lang.String name) {
        this(name, RestorePlanIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RestorePlanIamPolicy(java.lang.String name, RestorePlanIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RestorePlanIamPolicy(java.lang.String name, RestorePlanIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/restorePlanIamPolicy:RestorePlanIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RestorePlanIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable RestorePlanIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/restorePlanIamPolicy:RestorePlanIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static RestorePlanIamPolicyArgs makeArgs(RestorePlanIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RestorePlanIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static RestorePlanIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable RestorePlanIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
