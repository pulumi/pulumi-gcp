...
@CustomType
public final class RegionInstanceTemplateServiceAccount {
    /**
    ...
    public static Builder builder(RegionInstanceTemplateServiceAccount defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> scopes;
        public Builder() {}
        public Builder(RegionInstanceTemplateServiceAccount defaults) {
        ...
        public Builder scopes(List<String> scopes) {
            if (scopes == null) {
              throw new MissingRequiredPropertyException("RegionInstanceTemplateServiceAccount", "scopes");
            }
            this.scopes = scopes;
            return this;
        }
