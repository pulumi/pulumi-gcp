...
import com.pulumi.gcp.cloudrunv2.inputs.ServiceIamBindingState;
import com.pulumi.gcp.cloudrunv2.outputs.ServiceIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrunv2/serviceIamBinding:ServiceIamBinding editor &#34;projects/{{project}}/locations/{{location}}/services/{{service}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudrunv2/serviceIamBinding:ServiceIamBinding")
public class ServiceIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={ServiceIamBindingCondition.class}, tree="[0]")
    ...
    public ServiceIamBinding(java.lang.String name, ServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamBinding:ServiceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ServiceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamBinding:ServiceIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static ServiceIamBindingArgs makeArgs(ServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ServiceIamBindingArgs.Empty : args;
    }
     ...
     */
    public static ServiceIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
