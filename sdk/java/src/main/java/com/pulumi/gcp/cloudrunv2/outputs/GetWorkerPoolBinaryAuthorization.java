...
@CustomType
public final class GetWorkerPoolBinaryAuthorization {
    /**
    ...
    private GetWorkerPoolBinaryAuthorization() {}
    /**
     * @return If present, indicates to use Breakglass using this justification. If useDefault is False, then it must be empty. For more information on breakglass, see https://cloud.google.com/binary-authorization/docs/using-breakglass
     * 
     */
    ...
    public static Builder builder(GetWorkerPoolBinaryAuthorization defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean useDefault;
        public Builder() {}
        public Builder(GetWorkerPoolBinaryAuthorization defaults) {
        ...
        public Builder breakglassJustification(String breakglassJustification) {
            if (breakglassJustification == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolBinaryAuthorization", "breakglassJustification");
            }
        ...
        public Builder policy(String policy) {
            if (policy == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolBinaryAuthorization", "policy");
            }
            this.policy = policy;
            return this;
        }
        ...
        public Builder useDefault(Boolean useDefault) {
            if (useDefault == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolBinaryAuthorization", "useDefault");
            }
            this.useDefault = useDefault;
            return this;
        }
        public GetWorkerPoolBinaryAuthorization build() {
            final var _resultValue = new GetWorkerPoolBinaryAuthorization();
