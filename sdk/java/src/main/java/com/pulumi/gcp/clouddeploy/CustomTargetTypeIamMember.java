...
public class CustomTargetTypeIamMember extends com.pulumi.resources.CustomResource {
    ...
    public CustomTargetTypeIamMember(String name, CustomTargetTypeIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:clouddeploy/customTargetTypeIamMember:CustomTargetTypeIamMember", name, args == null ? CustomTargetTypeIamMemberArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
