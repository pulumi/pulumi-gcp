...
import com.pulumi.gcp.kms.inputs.EkmConnectionIamBindingState;
import com.pulumi.gcp.kms.outputs.EkmConnectionIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:kms/ekmConnectionIamBinding:EkmConnectionIamBinding editor &#34;projects/{{project}}/locations/{{location}}/ekmConnections/{{ekm_connection}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:kms/ekmConnectionIamBinding:EkmConnectionIamBinding")
public class EkmConnectionIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={EkmConnectionIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ EkmConnectionIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<EkmConnectionIamBindingCondition>> condition() {
     ...
     */
    public EkmConnectionIamBinding(java.lang.String name) {
        this(name, EkmConnectionIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public EkmConnectionIamBinding(java.lang.String name, EkmConnectionIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EkmConnectionIamBinding(java.lang.String name, EkmConnectionIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:kms/ekmConnectionIamBinding:EkmConnectionIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private EkmConnectionIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable EkmConnectionIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:kms/ekmConnectionIamBinding:EkmConnectionIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static EkmConnectionIamBindingArgs makeArgs(EkmConnectionIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? EkmConnectionIamBindingArgs.Empty : args;
    }
     ...
     */
    public static EkmConnectionIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable EkmConnectionIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new EkmConnectionIamBinding(name, id, state, options);
    }
}
