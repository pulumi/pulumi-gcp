...
public final class BackendServiceIamMemberArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BackendServiceIamMemberArgs build() {
            if ($.member == null) {
                throw new MissingRequiredPropertyException("BackendServiceIamMemberArgs", "member");
            }
            if ($.role == null) {
                throw new MissingRequiredPropertyException("BackendServiceIamMemberArgs", "role");
            }
            return $;
        }
    }
