...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsArgs", "bucket");
            }
            if ($.object == null) {
                throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileGcsArgs", "object");
            }
            return $;
        }
    }
