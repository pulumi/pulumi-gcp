...
public final class AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs Empty = new AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs();
    ...
    private AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs() {}

    private AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs(AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs $) {
    ...
    public static Builder builder(AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs();
        }

        public Builder(AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs defaults) {
            $ = new AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityConditionArgs(Objects.requireNonNull(defaults));
        }
