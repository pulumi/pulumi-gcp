...
public final class LogViewIamBindingArgs extends com.pulumi.resources.ResourceArgs {

    public static final LogViewIamBindingArgs Empty = new LogViewIamBindingArgs();
    ...
    private LogViewIamBindingArgs() {}

    private LogViewIamBindingArgs(LogViewIamBindingArgs $) {
        this.bucket = $.bucket;
    ...
    public static Builder builder(LogViewIamBindingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogViewIamBindingArgs();
        }

        public Builder(LogViewIamBindingArgs defaults) {
            $ = new LogViewIamBindingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LogViewIamBindingArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("LogViewIamBindingArgs", "bucket");
            }
            if ($.members == null) {
                throw new MissingRequiredPropertyException("LogViewIamBindingArgs", "members");
            }
            if ($.parent == null) {
                throw new MissingRequiredPropertyException("LogViewIamBindingArgs", "parent");
            }
            if ($.role == null) {
                throw new MissingRequiredPropertyException("LogViewIamBindingArgs", "role");
            }
            return $;
        }
    }
