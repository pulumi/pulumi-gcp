...
public final class URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelArgs", "name");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherRouteRuleMatchRuleMetadataFilterFilterLabelArgs", "value");
            }
            return $;
        }
    }
