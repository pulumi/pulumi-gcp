 ...
 *             .applicationId("tf-test-example-application_2234")
 ...
 *             .location("us-central1")
 *             .insightsConfigId("tf-test-ic-apphub-_29225")
 *             .project(project.projectId())
 ...
 *             .location("us-central1")
 *             .insightsConfigId("tf-test-ic-projects-_82591")
 *             .project(project.projectId())
 *             .annotations(Map.ofEntries(
 *             ))
 *             .labels(Map.ofEntries(
