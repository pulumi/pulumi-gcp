...
import com.pulumi.gcp.compute.outputs.RegionNetworkFirewallPolicyWithRulesRuleMatchLayer4Config;
import com.pulumi.gcp.compute.outputs.RegionNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag;
...
@CustomType
public final class RegionNetworkFirewallPolicyWithRulesRuleMatch {
    /**
     ...
     * 
     */
    private List<RegionNetworkFirewallPolicyWithRulesRuleMatchLayer4Config> layer4Configs;
    /**
     ...
     * 
     */
    public List<RegionNetworkFirewallPolicyWithRulesRuleMatchLayer4Config> layer4Configs() {
    ...
    public static Builder builder(RegionNetworkFirewallPolicyWithRulesRuleMatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> srcThreatIntelligences;
        public Builder() {}
        public Builder(RegionNetworkFirewallPolicyWithRulesRuleMatch defaults) {
        ...
        @CustomType.Setter
        public Builder layer4Configs(List<RegionNetworkFirewallPolicyWithRulesRuleMatchLayer4Config> layer4Configs) {
            if (layer4Configs == null) {
              throw new MissingRequiredPropertyException("RegionNetworkFirewallPolicyWithRulesRuleMatch", "layer4Configs");
            }
            this.layer4Configs = layer4Configs;
            return this;
        }
        public Builder layer4Configs(RegionNetworkFirewallPolicyWithRulesRuleMatchLayer4Config... layer4Configs) {
        ...
        @CustomType.Setter
        public Builder srcSecureTags(@Nullable List<RegionNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag> srcSecureTags) {

            this.srcSecureTags = srcSecureTags;
            return this;
        }
        public Builder srcSecureTags(RegionNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag... srcSecureTags) {
        ...
        public RegionNetworkFirewallPolicyWithRulesRuleMatch build() {
            final var _resultValue = new RegionNetworkFirewallPolicyWithRulesRuleMatch();
