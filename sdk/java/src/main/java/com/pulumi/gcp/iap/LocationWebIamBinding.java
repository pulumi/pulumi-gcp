...
import com.pulumi.gcp.iap.inputs.LocationWebIamBindingState;
import com.pulumi.gcp.iap.outputs.LocationWebIamBindingCondition;
 ...
 * ```sh
 * $ terraform import google_iap_location_web_iam_member.editor &#34;projects/{{project}}/locations/{{location}}/iap_web roles/iap.egressor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/locationWebIamBinding:LocationWebIamBinding")
public class LocationWebIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={LocationWebIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ LocationWebIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<LocationWebIamBindingCondition>> condition() {
     ...
     */
    public LocationWebIamBinding(java.lang.String name) {
        this(name, LocationWebIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocationWebIamBinding(java.lang.String name, LocationWebIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocationWebIamBinding(java.lang.String name, LocationWebIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/locationWebIamBinding:LocationWebIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocationWebIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable LocationWebIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/locationWebIamBinding:LocationWebIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static LocationWebIamBindingArgs makeArgs(LocationWebIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocationWebIamBindingArgs.Empty : args;
    }
     ...
     */
    public static LocationWebIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable LocationWebIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocationWebIamBinding(name, id, state, options);
    }
}
