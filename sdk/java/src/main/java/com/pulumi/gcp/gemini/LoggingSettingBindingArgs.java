...
public final class LoggingSettingBindingArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoggingSettingBindingArgs Empty = new LoggingSettingBindingArgs();
    ...
    private LoggingSettingBindingArgs() {}

    private LoggingSettingBindingArgs(LoggingSettingBindingArgs $) {
        this.labels = $.labels;
    ...
    public static Builder builder(LoggingSettingBindingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoggingSettingBindingArgs();
        }

        public Builder(LoggingSettingBindingArgs defaults) {
            $ = new LoggingSettingBindingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoggingSettingBindingArgs build() {
            if ($.loggingSettingId == null) {
                throw new MissingRequiredPropertyException("LoggingSettingBindingArgs", "loggingSettingId");
            }
            if ($.settingBindingId == null) {
                throw new MissingRequiredPropertyException("LoggingSettingBindingArgs", "settingBindingId");
            }
            if ($.target == null) {
                throw new MissingRequiredPropertyException("LoggingSettingBindingArgs", "target");
            }
            return $;
        }
    }
