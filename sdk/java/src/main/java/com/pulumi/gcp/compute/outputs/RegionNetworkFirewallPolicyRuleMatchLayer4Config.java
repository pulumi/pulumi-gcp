...
@CustomType
public final class RegionNetworkFirewallPolicyRuleMatchLayer4Config {
    /**
    ...
    private RegionNetworkFirewallPolicyRuleMatchLayer4Config() {}
    /**
     * @return The IP protocol to which this rule applies. The protocol type is required when creating a firewall rule.
     * This value can either be one of the following well known protocol strings (tcp, udp, icmp, esp, ah, ipip, sctp), or the IP protocol number.
     * 
    ...
    public static Builder builder(RegionNetworkFirewallPolicyRuleMatchLayer4Config defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ports;
        public Builder() {}
        public Builder(RegionNetworkFirewallPolicyRuleMatchLayer4Config defaults) {
        ...
        public Builder ipProtocol(String ipProtocol) {
            if (ipProtocol == null) {
              throw new MissingRequiredPropertyException("RegionNetworkFirewallPolicyRuleMatchLayer4Config", "ipProtocol");
            }
