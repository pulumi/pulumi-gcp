...
public final class InstanceFromMachineImageGuestAccelerator {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("InstanceFromMachineImageGuestAccelerator", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("InstanceFromMachineImageGuestAccelerator", "type");
            }
            this.type = type;
            return this;
        }
