...
public final class KeyRingIAMMemberConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public KeyRingIAMMemberConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("KeyRingIAMMemberConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("KeyRingIAMMemberConditionArgs", "title");
            }
            return $;
        }
    }
