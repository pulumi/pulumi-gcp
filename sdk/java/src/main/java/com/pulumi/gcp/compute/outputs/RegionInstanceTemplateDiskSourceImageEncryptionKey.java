...
@CustomType
public final class RegionInstanceTemplateDiskSourceImageEncryptionKey {
    /**
    ...
    public static Builder builder(RegionInstanceTemplateDiskSourceImageEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rsaEncryptedKey;
        public Builder() {}
        public Builder(RegionInstanceTemplateDiskSourceImageEncryptionKey defaults) {
        ...
        public RegionInstanceTemplateDiskSourceImageEncryptionKey build() {
            final var _resultValue = new RegionInstanceTemplateDiskSourceImageEncryptionKey();
