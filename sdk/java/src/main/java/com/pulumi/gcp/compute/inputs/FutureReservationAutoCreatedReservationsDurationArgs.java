...
public final class FutureReservationAutoCreatedReservationsDurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final FutureReservationAutoCreatedReservationsDurationArgs Empty = new FutureReservationAutoCreatedReservationsDurationArgs();
    ...
    private FutureReservationAutoCreatedReservationsDurationArgs() {}

    private FutureReservationAutoCreatedReservationsDurationArgs(FutureReservationAutoCreatedReservationsDurationArgs $) {
        this.nanos = $.nanos;
    ...
    public static Builder builder(FutureReservationAutoCreatedReservationsDurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FutureReservationAutoCreatedReservationsDurationArgs();
        }

        public Builder(FutureReservationAutoCreatedReservationsDurationArgs defaults) {
            $ = new FutureReservationAutoCreatedReservationsDurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FutureReservationAutoCreatedReservationsDurationArgs build() {
            return $;
        }
    }
