...
public final class ServiceState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param autogenerateRevisionName If set to &#39;true&#39;, the revision name (template.metadata.name) will be omitted and autogenerated by Cloud Run. This cannot
         * be set to &#39;true&#39; while &#39;template.metadata.name&#39; is also set. (For legacy support, if &#39;template.metadata.name&#39; is unset
         * in state while this field is set to false, the revision name will still autogenerate.)
         * 
         * @return builder
        ...
        /**
         * @param metadata Metadata associated with this Service, including name, namespace, labels, and annotations.
         * 
         * @return builder
         * 
         */
