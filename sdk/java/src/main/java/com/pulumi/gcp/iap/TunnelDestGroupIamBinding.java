...
import com.pulumi.gcp.iap.inputs.TunnelDestGroupIamBindingState;
import com.pulumi.gcp.iap.outputs.TunnelDestGroupIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/tunnelDestGroupIamBinding:TunnelDestGroupIamBinding editor &#34;projects/{{project}}/iap_tunnel/locations/{{region}}/destGroups/{{dest_group}} roles/iap.tunnelResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/tunnelDestGroupIamBinding:TunnelDestGroupIamBinding")
public class TunnelDestGroupIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={TunnelDestGroupIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ TunnelDestGroupIamBindingCondition> condition;
     ...
     */
    public TunnelDestGroupIamBinding(java.lang.String name) {
        this(name, TunnelDestGroupIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TunnelDestGroupIamBinding(java.lang.String name, TunnelDestGroupIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TunnelDestGroupIamBinding(java.lang.String name, TunnelDestGroupIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelDestGroupIamBinding:TunnelDestGroupIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TunnelDestGroupIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelDestGroupIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelDestGroupIamBinding:TunnelDestGroupIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TunnelDestGroupIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelDestGroupIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
