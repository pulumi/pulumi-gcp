...
public class TunnelDestGroupIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public TunnelDestGroupIamBinding(String name) {
     ...
     */
    public TunnelDestGroupIamBinding(String name, TunnelDestGroupIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static TunnelDestGroupIamBinding get(String name, Output<String> id, @Nullable TunnelDestGroupIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
