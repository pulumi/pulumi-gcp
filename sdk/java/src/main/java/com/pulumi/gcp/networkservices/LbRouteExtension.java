...
import com.pulumi.gcp.networkservices.LbRouteExtensionArgs;
import com.pulumi.gcp.networkservices.inputs.LbRouteExtensionState;
import com.pulumi.gcp.networkservices.outputs.LbRouteExtensionExtensionChain;
 ...
 * 
 */
@ResourceType(type="gcp:networkservices/lbRouteExtension:LbRouteExtension")
public class LbRouteExtension extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="extensionChains", refs={List.class,LbRouteExtensionExtensionChain.class}, tree="[0,1]")
    private Output<List<LbRouteExtensionExtensionChain>> extensionChains;
     ...
     * 
     */
    public Output<List<LbRouteExtensionExtensionChain>> extensionChains() {
