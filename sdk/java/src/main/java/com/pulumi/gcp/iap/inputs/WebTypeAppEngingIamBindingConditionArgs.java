...
public final class WebTypeAppEngingIamBindingConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WebTypeAppEngingIamBindingConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("WebTypeAppEngingIamBindingConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("WebTypeAppEngingIamBindingConditionArgs", "title");
            }
            return $;
        }
    }
