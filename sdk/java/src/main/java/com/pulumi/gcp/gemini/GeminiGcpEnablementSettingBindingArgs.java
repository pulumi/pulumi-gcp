...
public final class GeminiGcpEnablementSettingBindingArgs extends com.pulumi.resources.ResourceArgs {

    public static final GeminiGcpEnablementSettingBindingArgs Empty = new GeminiGcpEnablementSettingBindingArgs();
    ...
    private GeminiGcpEnablementSettingBindingArgs() {}

    private GeminiGcpEnablementSettingBindingArgs(GeminiGcpEnablementSettingBindingArgs $) {
    ...
    public static Builder builder(GeminiGcpEnablementSettingBindingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GeminiGcpEnablementSettingBindingArgs();
        }

        public Builder(GeminiGcpEnablementSettingBindingArgs defaults) {
            $ = new GeminiGcpEnablementSettingBindingArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param geminiGcpEnablementSettingId Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
         * 
         * @return builder
         * 
         */
        ...
        public GeminiGcpEnablementSettingBindingArgs build() {
            if ($.geminiGcpEnablementSettingId == null) {
                throw new MissingRequiredPropertyException("GeminiGcpEnablementSettingBindingArgs", "geminiGcpEnablementSettingId");
            }
            if ($.settingBindingId == null) {
                throw new MissingRequiredPropertyException("GeminiGcpEnablementSettingBindingArgs", "settingBindingId");
            }
            if ($.target == null) {
                throw new MissingRequiredPropertyException("GeminiGcpEnablementSettingBindingArgs", "target");
            }
            return $;
        }
    }
