...
public final class ClusterAddonsConfigGcePersistentDiskCsiDriverConfig {
    ...
    private ClusterAddonsConfigGcePersistentDiskCsiDriverConfig() {}
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("ClusterAddonsConfigGcePersistentDiskCsiDriverConfig", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public ClusterAddonsConfigGcePersistentDiskCsiDriverConfig build() {
            final var _resultValue = new ClusterAddonsConfigGcePersistentDiskCsiDriverConfig();
