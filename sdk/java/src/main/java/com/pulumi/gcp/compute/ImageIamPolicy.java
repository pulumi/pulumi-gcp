 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/imageIamPolicy:ImageIamPolicy editor &#34;projects/{{project}}/global/images/{{image}} roles/compute.imageUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class ImageIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public ImageIamPolicy(java.lang.String name) {
     ...
     */
    public ImageIamPolicy(java.lang.String name, ImageIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ImageIamPolicy(java.lang.String name, ImageIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/imageIamPolicy:ImageIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ImageIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable ImageIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/imageIamPolicy:ImageIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static ImageIamPolicyArgs makeArgs(ImageIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ImageIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static ImageIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable ImageIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
