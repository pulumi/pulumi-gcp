...
@CustomType
public final class VmwareAdminClusterVcenter {
    /**
     ...
     * 
     */
    private @Nullable String dataDisk;
    /**
     ...
     * 
     */
    public Optional<String> dataDisk() {
    ...
    public static Builder builder(VmwareAdminClusterVcenter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String storagePolicyName;
        public Builder() {}
        public Builder(VmwareAdminClusterVcenter defaults) {
        ...
        @CustomType.Setter
        public Builder dataDisk(@Nullable String dataDisk) {
        ...
        public VmwareAdminClusterVcenter build() {
            final var _resultValue = new VmwareAdminClusterVcenter();
