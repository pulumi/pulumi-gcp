...
public final class SecretIamMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("SecretIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("SecretIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public SecretIamMemberCondition build() {
            final var _resultValue = new SecretIamMemberCondition();
