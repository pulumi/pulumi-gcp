...
public final class RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs build() {
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs", "headerName");
            }
            if ($.headerValue == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs", "headerValue");
            }
            if ($.replace == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs", "replace");
            }
            return $;
        }
    }
