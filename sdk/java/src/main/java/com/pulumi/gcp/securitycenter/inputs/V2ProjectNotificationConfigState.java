...
public final class V2ProjectNotificationConfigState extends com.pulumi.resources.ResourceArgs {

    public static final V2ProjectNotificationConfigState Empty = new V2ProjectNotificationConfigState();
    ...
    private @Nullable Output<V2ProjectNotificationConfigStreamingConfigArgs> streamingConfig;
     ...
     * 
     */
    public Optional<Output<V2ProjectNotificationConfigStreamingConfigArgs>> streamingConfig() {
        return Optional.ofNullable(this.streamingConfig);
    }

    private V2ProjectNotificationConfigState() {}

    private V2ProjectNotificationConfigState(V2ProjectNotificationConfigState $) {
    ...
    public static Builder builder(V2ProjectNotificationConfigState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2ProjectNotificationConfigState();
        }

        public Builder(V2ProjectNotificationConfigState defaults) {
            $ = new V2ProjectNotificationConfigState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder streamingConfig(@Nullable Output<V2ProjectNotificationConfigStreamingConfigArgs> streamingConfig) {
        ...
        public V2ProjectNotificationConfigState build() {
            return $;
        }
    }
