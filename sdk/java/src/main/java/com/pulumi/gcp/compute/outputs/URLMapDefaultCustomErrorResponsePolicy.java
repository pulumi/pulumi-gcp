...
import com.pulumi.gcp.compute.outputs.URLMapDefaultCustomErrorResponsePolicyErrorResponseRule;
...
@CustomType
public final class URLMapDefaultCustomErrorResponsePolicy {
    /**
     ...
     * 
     */
    private @Nullable List<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule> errorResponseRules;
    /**
     ...
     * 
     */
    public List<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule> errorResponseRules() {
    ...
    public static Builder builder(URLMapDefaultCustomErrorResponsePolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String errorService;
        public Builder() {}
        public Builder(URLMapDefaultCustomErrorResponsePolicy defaults) {
        ...
        @CustomType.Setter
        public Builder errorResponseRules(@Nullable List<URLMapDefaultCustomErrorResponsePolicyErrorResponseRule> errorResponseRules) {

            this.errorResponseRules = errorResponseRules;
            return this;
        }
        public Builder errorResponseRules(URLMapDefaultCustomErrorResponsePolicyErrorResponseRule... errorResponseRules) {
        ...
        public URLMapDefaultCustomErrorResponsePolicy build() {
            final var _resultValue = new URLMapDefaultCustomErrorResponsePolicy();
