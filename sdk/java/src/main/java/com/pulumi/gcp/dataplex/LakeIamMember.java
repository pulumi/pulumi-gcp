...
public class LakeIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={LakeIamMemberCondition.class}, tree="[0]")
     ...
     */
    public LakeIamMember(java.lang.String name) {
     ...
     */
    public LakeIamMember(java.lang.String name, LakeIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LakeIamMember(java.lang.String name, LakeIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/lakeIamMember:LakeIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LakeIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable LakeIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/lakeIamMember:LakeIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static LakeIamMemberArgs makeArgs(LakeIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LakeIamMemberArgs.Empty : args;
    }
     ...
     */
    public static LakeIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable LakeIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
