...
public class MembershipIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public MembershipIamPolicy(String name, MembershipIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/membershipIamPolicy:MembershipIamPolicy", name, args == null ? MembershipIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MembershipIamPolicy(String name, Output<String> id, @Nullable MembershipIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/membershipIamPolicy:MembershipIamPolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static MembershipIamPolicy get(String name, Output<String> id, @Nullable MembershipIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
