...
public final class GetRegionalParameterVersionArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRegionalParameterVersionArgs Empty = new GetRegionalParameterVersionArgs();
    ...
    private GetRegionalParameterVersionArgs() {}

    private GetRegionalParameterVersionArgs(GetRegionalParameterVersionArgs $) {
    ...
    public static Builder builder(GetRegionalParameterVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRegionalParameterVersionArgs();
        }

        public Builder(GetRegionalParameterVersionArgs defaults) {
            $ = new GetRegionalParameterVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRegionalParameterVersionArgs build() {
            if ($.parameter == null) {
                throw new MissingRequiredPropertyException("GetRegionalParameterVersionArgs", "parameter");
            }
            if ($.parameterVersionId == null) {
                throw new MissingRequiredPropertyException("GetRegionalParameterVersionArgs", "parameterVersionId");
            }
            return $;
        }
    }
