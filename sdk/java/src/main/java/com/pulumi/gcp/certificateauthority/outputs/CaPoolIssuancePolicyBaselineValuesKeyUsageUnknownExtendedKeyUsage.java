...
public final class CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsage {
    ...
    private CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsage() {}
    /**
     * @return An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder objectIdPaths(List<Integer> objectIdPaths) {
            if (objectIdPaths == null) {
              throw new MissingRequiredPropertyException("CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsage", "objectIdPaths");
            }
