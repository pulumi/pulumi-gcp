...
import com.pulumi.gcp.oracledatabase.inputs.GoldengateConnectionAssignmentState;
import com.pulumi.gcp.oracledatabase.outputs.GoldengateConnectionAssignmentProperties;
 ...
 * 
 */
@ResourceType(type="gcp:oracledatabase/goldengateConnectionAssignment:GoldengateConnectionAssignment")
public class GoldengateConnectionAssignment extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="goldengateConnectionAssignmentId", refs={String.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="properties", refs={GoldengateConnectionAssignmentProperties.class}, tree="[0]")
    private Output<GoldengateConnectionAssignmentProperties> properties;
     ...
     * 
     */
    public Output<GoldengateConnectionAssignmentProperties> properties() {
     ...
     */
    public GoldengateConnectionAssignment(java.lang.String name) {
        this(name, GoldengateConnectionAssignmentArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GoldengateConnectionAssignment(java.lang.String name, GoldengateConnectionAssignmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GoldengateConnectionAssignment(java.lang.String name, GoldengateConnectionAssignmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:oracledatabase/goldengateConnectionAssignment:GoldengateConnectionAssignment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GoldengateConnectionAssignment(java.lang.String name, Output<java.lang.String> id, @Nullable GoldengateConnectionAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:oracledatabase/goldengateConnectionAssignment:GoldengateConnectionAssignment", name, state, makeResourceOptions(options, id), false);
    }

    private static GoldengateConnectionAssignmentArgs makeArgs(GoldengateConnectionAssignmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GoldengateConnectionAssignmentArgs.Empty : args;
    }
     ...
     */
    public static GoldengateConnectionAssignment get(java.lang.String name, Output<java.lang.String> id, @Nullable GoldengateConnectionAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
