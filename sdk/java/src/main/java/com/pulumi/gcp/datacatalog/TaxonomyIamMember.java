...
public class TaxonomyIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={TaxonomyIamMemberCondition.class}, tree="[0]")
     ...
     */
    public TaxonomyIamMember(java.lang.String name) {
     ...
     */
    public TaxonomyIamMember(java.lang.String name, TaxonomyIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TaxonomyIamMember(java.lang.String name, TaxonomyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/taxonomyIamMember:TaxonomyIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TaxonomyIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable TaxonomyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/taxonomyIamMember:TaxonomyIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TaxonomyIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable TaxonomyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
