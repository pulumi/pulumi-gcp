...
public class TaxonomyIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public static TaxonomyIamMember get(String name, Output<String> id, @Nullable TaxonomyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
