...
@CustomType
public final class ApiProductOperationGroupOperationConfigQuota {
    /**
    ...
    public static Builder builder(ApiProductOperationGroupOperationConfigQuota defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeUnit;
        public Builder() {}
        public Builder(ApiProductOperationGroupOperationConfigQuota defaults) {
        ...
        public ApiProductOperationGroupOperationConfigQuota build() {
            final var _resultValue = new ApiProductOperationGroupOperationConfigQuota();
