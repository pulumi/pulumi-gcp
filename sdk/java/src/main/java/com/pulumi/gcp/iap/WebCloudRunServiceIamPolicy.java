...
import com.pulumi.gcp.iap.inputs.WebCloudRunServiceIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webCloudRunServiceIamPolicy:WebCloudRunServiceIamPolicy editor &#34;projects/{{project}}/iap_web/cloud_run-{{location}}/services/{{web_cloud_run_service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/webCloudRunServiceIamPolicy:WebCloudRunServiceIamPolicy")
public class WebCloudRunServiceIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public WebCloudRunServiceIamPolicy(java.lang.String name) {
        this(name, WebCloudRunServiceIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebCloudRunServiceIamPolicy(java.lang.String name, WebCloudRunServiceIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebCloudRunServiceIamPolicy(java.lang.String name, WebCloudRunServiceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webCloudRunServiceIamPolicy:WebCloudRunServiceIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebCloudRunServiceIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable WebCloudRunServiceIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webCloudRunServiceIamPolicy:WebCloudRunServiceIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static WebCloudRunServiceIamPolicyArgs makeArgs(WebCloudRunServiceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebCloudRunServiceIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static WebCloudRunServiceIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable WebCloudRunServiceIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
