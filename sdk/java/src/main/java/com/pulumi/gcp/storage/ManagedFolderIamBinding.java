...
public class ManagedFolderIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public ManagedFolderIamBinding(String name, ManagedFolderIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:storage/managedFolderIamBinding:ManagedFolderIamBinding", name, args == null ? ManagedFolderIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
