...
public final class GetWorkstationIamPolicyArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetWorkstationIamPolicyArgs Empty = new GetWorkstationIamPolicyArgs();
    ...
    private GetWorkstationIamPolicyArgs() {}

    private GetWorkstationIamPolicyArgs(GetWorkstationIamPolicyArgs $) {
    ...
    public static Builder builder(GetWorkstationIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetWorkstationIamPolicyArgs();
        }

        public Builder(GetWorkstationIamPolicyArgs defaults) {
            $ = new GetWorkstationIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetWorkstationIamPolicyArgs build() {
            if ($.workstationClusterId == null) {
                throw new MissingRequiredPropertyException("GetWorkstationIamPolicyArgs", "workstationClusterId");
            }
            if ($.workstationConfigId == null) {
                throw new MissingRequiredPropertyException("GetWorkstationIamPolicyArgs", "workstationConfigId");
            }
            if ($.workstationId == null) {
                throw new MissingRequiredPropertyException("GetWorkstationIamPolicyArgs", "workstationId");
            }
            return $;
        }
    }
