...
public final class ServiceTemplateContainerEnvValueSourceSecretKeyRef {
    ...
    public static Builder builder(ServiceTemplateContainerEnvValueSourceSecretKeyRef defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(ServiceTemplateContainerEnvValueSourceSecretKeyRef defaults) {
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("ServiceTemplateContainerEnvValueSourceSecretKeyRef", "secret");
            }
            this.secret = secret;
            return this;
        }
        ...
        public ServiceTemplateContainerEnvValueSourceSecretKeyRef build() {
            final var _resultValue = new ServiceTemplateContainerEnvValueSourceSecretKeyRef();
