...
import com.pulumi.gcp.dataplex.inputs.EntryGroupIamMemberConditionArgs;
...
public final class EntryGroupIamMemberArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EntryGroupIamMemberArgs(EntryGroupIamMemberArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EntryGroupIamMemberArgs();
        }

        public Builder(EntryGroupIamMemberArgs defaults) {
            $ = new EntryGroupIamMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EntryGroupIamMemberArgs build() {
            if ($.entryGroupId == null) {
                throw new MissingRequiredPropertyException("EntryGroupIamMemberArgs", "entryGroupId");
            }
            if ($.member == null) {
