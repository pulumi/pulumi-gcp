...
@CustomType
public final class AuthzPolicyHttpRuleToNotOperationPath {
    /**
    ...
    private AuthzPolicyHttpRuleToNotOperationPath() {}
    /**
     * @return The input string must have the substring specified here. Note: empty contains match is not allowed, please use regex instead.
     * Examples:
     * * abc matches the value xyz.abc.def
    ...
    public static Builder builder(AuthzPolicyHttpRuleToNotOperationPath defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleToNotOperationPath defaults) {
        ...
        public AuthzPolicyHttpRuleToNotOperationPath build() {
            final var _resultValue = new AuthzPolicyHttpRuleToNotOperationPath();
