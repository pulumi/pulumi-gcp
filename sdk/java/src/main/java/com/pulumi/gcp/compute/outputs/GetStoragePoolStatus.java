...
@CustomType
public final class GetStoragePoolStatus {
    /**
    ...
    /**
     * @return Sum of all the disks&#39; provisioned IOPS, minus some amount that is allowed per disk that is not counted towards pool&#39;s IOPS capacity. For more information, see https://cloud.google.com/compute/docs/disks/storage-pools.
     * 
     */
    ...
    public static Builder builder(GetStoragePoolStatus defaults) {
    ...
    public static final class Builder {
        ...
        private String totalProvisionedDiskThroughput;
        public Builder() {}
        public Builder(GetStoragePoolStatus defaults) {
        ...
        public Builder diskCount(String diskCount) {
            if (diskCount == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "diskCount");
            }
        ...
        public Builder lastResizeTimestamp(String lastResizeTimestamp) {
            if (lastResizeTimestamp == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "lastResizeTimestamp");
            }
        ...
        public Builder maxTotalProvisionedDiskCapacityGb(String maxTotalProvisionedDiskCapacityGb) {
            if (maxTotalProvisionedDiskCapacityGb == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "maxTotalProvisionedDiskCapacityGb");
            }
        ...
        public Builder poolUsedCapacityBytes(String poolUsedCapacityBytes) {
            if (poolUsedCapacityBytes == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "poolUsedCapacityBytes");
            }
        ...
        public Builder poolUsedIops(String poolUsedIops) {
            if (poolUsedIops == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "poolUsedIops");
            }
        ...
        public Builder poolUsedThroughput(String poolUsedThroughput) {
            if (poolUsedThroughput == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "poolUsedThroughput");
            }
        ...
        public Builder poolUserWrittenBytes(String poolUserWrittenBytes) {
            if (poolUserWrittenBytes == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "poolUserWrittenBytes");
            }
        ...
        public Builder totalProvisionedDiskCapacityGb(String totalProvisionedDiskCapacityGb) {
            if (totalProvisionedDiskCapacityGb == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "totalProvisionedDiskCapacityGb");
            }
        ...
        public Builder totalProvisionedDiskIops(String totalProvisionedDiskIops) {
            if (totalProvisionedDiskIops == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "totalProvisionedDiskIops");
            }
        ...
        public Builder totalProvisionedDiskThroughput(String totalProvisionedDiskThroughput) {
            if (totalProvisionedDiskThroughput == null) {
              throw new MissingRequiredPropertyException("GetStoragePoolStatus", "totalProvisionedDiskThroughput");
            }
            this.totalProvisionedDiskThroughput = totalProvisionedDiskThroughput;
            return this;
        }
        public GetStoragePoolStatus build() {
            final var _resultValue = new GetStoragePoolStatus();
