...
public final class ConnectionBitbucketDataCenterConfigAuthorizerCredential {
    ...
    public static Builder builder(ConnectionBitbucketDataCenterConfigAuthorizerCredential defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String username;
        public Builder() {}
        public Builder(ConnectionBitbucketDataCenterConfigAuthorizerCredential defaults) {
        ...
        public Builder userTokenSecretVersion(String userTokenSecretVersion) {
            if (userTokenSecretVersion == null) {
              throw new MissingRequiredPropertyException("ConnectionBitbucketDataCenterConfigAuthorizerCredential", "userTokenSecretVersion");
            }
        ...
        public ConnectionBitbucketDataCenterConfigAuthorizerCredential build() {
            final var _resultValue = new ConnectionBitbucketDataCenterConfigAuthorizerCredential();
