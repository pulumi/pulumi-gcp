...
public final class V2VmNetworkConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2VmNetworkConfigArgs Empty = new V2VmNetworkConfigArgs();
    ...
    private V2VmNetworkConfigArgs() {}

    private V2VmNetworkConfigArgs(V2VmNetworkConfigArgs $) {
    ...
    public static Builder builder(V2VmNetworkConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2VmNetworkConfigArgs();
        }

        public Builder(V2VmNetworkConfigArgs defaults) {
            $ = new V2VmNetworkConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2VmNetworkConfigArgs build() {
            return $;
        }
    }
