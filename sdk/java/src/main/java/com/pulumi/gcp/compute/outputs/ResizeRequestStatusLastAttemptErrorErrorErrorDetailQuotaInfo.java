...
@CustomType
public final class ResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo {
    /**
     * @return (Output)
    ...
    public static Builder builder(ResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rolloutStatus;
        public Builder() {}
        public Builder(ResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo defaults) {
        ...
        public ResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo build() {
            final var _resultValue = new ResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo();
