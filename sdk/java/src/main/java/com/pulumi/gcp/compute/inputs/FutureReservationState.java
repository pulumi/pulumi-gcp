...
public final class FutureReservationState extends com.pulumi.resources.ResourceArgs {

    public static final FutureReservationState Empty = new FutureReservationState();
    ...
    private @Nullable Output<List<FutureReservationStatusArgs>> statuses;
     ...
     * 
     */
    public Optional<Output<List<FutureReservationStatusArgs>>> statuses() {
    ...
    private FutureReservationState() {}

    private FutureReservationState(FutureReservationState $) {
    ...
    public static Builder builder(FutureReservationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FutureReservationState();
        }

        public Builder(FutureReservationState defaults) {
            $ = new FutureReservationState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param creationTimestamp The creation timestamp for this future reservation in RFC3339 text format.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param statuses [Output only] Status of the Future Reservation
         * Structure is documented below.
         * 
         * @return builder
         * 
         */
        public Builder statuses(@Nullable Output<List<FutureReservationStatusArgs>> statuses) {
            $.statuses = statuses;
            return this;
        }
         ...
         * 
         */
        public Builder statuses(List<FutureReservationStatusArgs> statuses) {
         ...
         * 
         */
        public Builder statuses(FutureReservationStatusArgs... statuses) {
        ...
        public FutureReservationState build() {
            return $;
        }
    }
