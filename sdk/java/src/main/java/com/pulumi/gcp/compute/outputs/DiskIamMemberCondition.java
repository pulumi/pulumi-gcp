...
public final class DiskIamMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("DiskIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("DiskIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public DiskIamMemberCondition build() {
            final var _resultValue = new DiskIamMemberCondition();
