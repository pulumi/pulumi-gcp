...
import com.pulumi.gcp.cloudrunv2.inputs.WorkerPoolIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrunv2/workerPoolIamPolicy:WorkerPoolIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/workerPools/{{worker_pool}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudrunv2/workerPoolIamPolicy:WorkerPoolIamPolicy")
public class WorkerPoolIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public WorkerPoolIamPolicy(java.lang.String name) {
        this(name, WorkerPoolIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WorkerPoolIamPolicy(java.lang.String name, WorkerPoolIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkerPoolIamPolicy(java.lang.String name, WorkerPoolIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/workerPoolIamPolicy:WorkerPoolIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WorkerPoolIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable WorkerPoolIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/workerPoolIamPolicy:WorkerPoolIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static WorkerPoolIamPolicyArgs makeArgs(WorkerPoolIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WorkerPoolIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static WorkerPoolIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkerPoolIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
