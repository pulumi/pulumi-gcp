...
public final class EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAddArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAddArgs build() {
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAddArgs", "headerName");
            }
            if ($.headerValue == null) {
                throw new MissingRequiredPropertyException("EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAddArgs", "headerValue");
            }
            return $;
        }
    }
