...
import com.pulumi.gcp.transcoder.outputs.JobConfigOverlayAnimationAnimationFadeXy;
...
@CustomType
public final class JobConfigOverlayAnimationAnimationFade {
    /**
     ...
     * 
     */
    private @Nullable JobConfigOverlayAnimationAnimationFadeXy xy;

    private JobConfigOverlayAnimationAnimationFade() {}
    /**
     * @return The time to end the fade animation, in seconds.
     * 
     */
     ...
     * 
     */
    public Optional<JobConfigOverlayAnimationAnimationFadeXy> xy() {
    ...
    public static Builder builder(JobConfigOverlayAnimationAnimationFade defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable JobConfigOverlayAnimationAnimationFadeXy xy;
        public Builder() {}
        public Builder(JobConfigOverlayAnimationAnimationFade defaults) {
        ...
        public Builder fadeType(String fadeType) {
            if (fadeType == null) {
              throw new MissingRequiredPropertyException("JobConfigOverlayAnimationAnimationFade", "fadeType");
            }
        ...
        @CustomType.Setter
        public Builder xy(@Nullable JobConfigOverlayAnimationAnimationFadeXy xy) {

            this.xy = xy;
            return this;
        }
        public JobConfigOverlayAnimationAnimationFade build() {
            final var _resultValue = new JobConfigOverlayAnimationAnimationFade();
