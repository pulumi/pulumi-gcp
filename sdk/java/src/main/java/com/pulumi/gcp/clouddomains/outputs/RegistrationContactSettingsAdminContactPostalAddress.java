...
@CustomType
public final class RegistrationContactSettingsAdminContactPostalAddress {
    /**
    ...
    private RegistrationContactSettingsAdminContactPostalAddress() {}
    /**
     * @return Unstructured address lines describing the lower levels of an address.
     * Because values in addressLines do not have type information and may sometimes contain multiple values in a single
     * field (e.g. &#34;Austin, TX&#34;), it is important that the line order is clear. The order of address lines should be
    ...
    public static Builder builder(RegistrationContactSettingsAdminContactPostalAddress defaults) {
    ...
    public static final class Builder {
        ...
        private String regionCode;
        public Builder() {}
        public Builder(RegistrationContactSettingsAdminContactPostalAddress defaults) {
        ...
        public Builder regionCode(String regionCode) {
            if (regionCode == null) {
              throw new MissingRequiredPropertyException("RegistrationContactSettingsAdminContactPostalAddress", "regionCode");
            }
            this.regionCode = regionCode;
            return this;
        }
        public RegistrationContactSettingsAdminContactPostalAddress build() {
            final var _resultValue = new RegistrationContactSettingsAdminContactPostalAddress();
