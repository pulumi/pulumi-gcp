 ...
 * 
 * ```sh
 * $ pulumi import gcp:servicedirectory/namespaceIamMember:NamespaceIamMember editor &#34;projects/{{project}}/locations/{{location}}/namespaces/{{namespace_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class NamespaceIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public NamespaceIamMember(java.lang.String name) {
     ...
     */
    public NamespaceIamMember(java.lang.String name, NamespaceIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NamespaceIamMember(java.lang.String name, NamespaceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:servicedirectory/namespaceIamMember:NamespaceIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NamespaceIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable NamespaceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:servicedirectory/namespaceIamMember:NamespaceIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static NamespaceIamMemberArgs makeArgs(NamespaceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NamespaceIamMemberArgs.Empty : args;
    }
     ...
     */
    public static NamespaceIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable NamespaceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
