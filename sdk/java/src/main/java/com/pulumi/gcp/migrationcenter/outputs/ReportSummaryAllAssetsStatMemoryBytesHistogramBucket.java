...
@CustomType
public final class ReportSummaryAllAssetsStatMemoryBytesHistogramBucket {
    /**
     * @return (Output)
    ...
    public static Builder builder(ReportSummaryAllAssetsStatMemoryBytesHistogramBucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String upperBound;
        public Builder() {}
        public Builder(ReportSummaryAllAssetsStatMemoryBytesHistogramBucket defaults) {
        ...
        public ReportSummaryAllAssetsStatMemoryBytesHistogramBucket build() {
            final var _resultValue = new ReportSummaryAllAssetsStatMemoryBytesHistogramBucket();
