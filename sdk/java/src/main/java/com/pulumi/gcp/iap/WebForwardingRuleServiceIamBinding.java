...
import com.pulumi.gcp.iap.inputs.WebForwardingRuleServiceIamBindingState;
import com.pulumi.gcp.iap.outputs.WebForwardingRuleServiceIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webForwardingRuleServiceIamBinding:WebForwardingRuleServiceIamBinding editor &#34;projects/{{project}}/iap_web/forwarding_rule/services/{{web_forwarding_rule_service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/webForwardingRuleServiceIamBinding:WebForwardingRuleServiceIamBinding")
public class WebForwardingRuleServiceIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={WebForwardingRuleServiceIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ WebForwardingRuleServiceIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<WebForwardingRuleServiceIamBindingCondition>> condition() {
     ...
     */
    public WebForwardingRuleServiceIamBinding(java.lang.String name) {
        this(name, WebForwardingRuleServiceIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebForwardingRuleServiceIamBinding(java.lang.String name, WebForwardingRuleServiceIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebForwardingRuleServiceIamBinding(java.lang.String name, WebForwardingRuleServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webForwardingRuleServiceIamBinding:WebForwardingRuleServiceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebForwardingRuleServiceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable WebForwardingRuleServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webForwardingRuleServiceIamBinding:WebForwardingRuleServiceIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static WebForwardingRuleServiceIamBindingArgs makeArgs(WebForwardingRuleServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebForwardingRuleServiceIamBindingArgs.Empty : args;
    }
     ...
     */
    public static WebForwardingRuleServiceIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable WebForwardingRuleServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
