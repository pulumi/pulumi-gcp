...
public final class CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio {
    ...
    public static final class Builder {
        ...
        public Builder audioUri(String audioUri) {
            if (audioUri == null) {
              throw new MissingRequiredPropertyException("CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio", "audioUri");
            }
            this.audioUri = audioUri;
            return this;
        }
        public CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio build() {
            final var _resultValue = new CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio();
