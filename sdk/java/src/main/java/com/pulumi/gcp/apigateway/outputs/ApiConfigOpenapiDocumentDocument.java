...
public final class ApiConfigOpenapiDocumentDocument {
    ...
    public static final class Builder {
        ...
        public Builder contents(String contents) {
            if (contents == null) {
              throw new MissingRequiredPropertyException("ApiConfigOpenapiDocumentDocument", "contents");
            }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("ApiConfigOpenapiDocumentDocument", "path");
            }
            this.path = path;
            return this;
        }
