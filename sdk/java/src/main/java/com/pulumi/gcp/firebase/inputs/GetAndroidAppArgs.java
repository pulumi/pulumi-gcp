...
public final class GetAndroidAppArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The appId of name of the Firebase androidApp.
     * 
     * ***
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param appId The appId of name of the Firebase androidApp.
         * 
         * ***
         * 
         * @return builder
        ...
        public GetAndroidAppArgs build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("GetAndroidAppArgs", "appId");
            }
            return $;
        }
    }
