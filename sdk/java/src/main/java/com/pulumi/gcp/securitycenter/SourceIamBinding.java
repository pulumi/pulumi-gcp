...
public class SourceIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public SourceIamBinding(String name) {
     ...
     */
    public SourceIamBinding(String name, SourceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/sourceIamBinding:SourceIamBinding", name, args == null ? SourceIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SourceIamBinding(String name, Output<String> id, @Nullable SourceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/sourceIamBinding:SourceIamBinding", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static SourceIamBinding get(String name, Output<String> id, @Nullable SourceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
