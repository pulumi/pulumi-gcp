...
import com.pulumi.gcp.iap.inputs.TunnelIamBindingState;
import com.pulumi.gcp.iap.outputs.TunnelIamBindingCondition;
 ...
 * ```sh
 * $ terraform import google_iap_tunnel_iam_member.editor &#34;projects/{{project}}/iap_tunnel roles/iap.tunnelResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TunnelIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={TunnelIamBindingCondition.class}, tree="[0]")
     ...
     * 
     */
    public Output<Optional<TunnelIamBindingCondition>> condition() {
     ...
     * `gcp.iap.TunnelIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
     ...
     */
    public TunnelIamBinding(java.lang.String name) {
     ...
     */
    public TunnelIamBinding(java.lang.String name, TunnelIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TunnelIamBinding(java.lang.String name, TunnelIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelIamBinding:TunnelIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TunnelIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelIamBinding:TunnelIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static TunnelIamBindingArgs makeArgs(TunnelIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TunnelIamBindingArgs.Empty : args;
    }
     ...
     */
    public static TunnelIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
