...
import com.pulumi.gcp.diagflow.outputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig;
...
@CustomType
public final class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig {
    /**
     ...
     * 
     */
    private @Nullable List<ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig> featureConfigs;
    /**
     ...
     * 
     */
    public List<ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig> featureConfigs() {
    ...
    public static Builder builder(ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean groupSuggestionResponses;
        public Builder() {}
        public Builder(ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig defaults) {
        ...
        @CustomType.Setter
        public Builder featureConfigs(@Nullable List<ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig> featureConfigs) {

            this.featureConfigs = featureConfigs;
            return this;
        }
        public Builder featureConfigs(ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfig... featureConfigs) {
        ...
        public ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig build() {
            final var _resultValue = new ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfig();
