...
public final class EntryLinkAspectAspectArgs extends com.pulumi.resources.ResourceArgs {

    public static final EntryLinkAspectAspectArgs Empty = new EntryLinkAspectAspectArgs();
    ...
    private EntryLinkAspectAspectArgs() {}

    private EntryLinkAspectAspectArgs(EntryLinkAspectAspectArgs $) {
    ...
    public static Builder builder(EntryLinkAspectAspectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EntryLinkAspectAspectArgs();
        }

        public Builder(EntryLinkAspectAspectArgs defaults) {
            $ = new EntryLinkAspectAspectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EntryLinkAspectAspectArgs build() {
            if ($.data == null) {
                throw new MissingRequiredPropertyException("EntryLinkAspectAspectArgs", "data");
            }
            return $;
        }
    }
