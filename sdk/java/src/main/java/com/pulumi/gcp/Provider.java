...
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    @Export(name="agentIdentityCustomEndpoint", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> agentIdentityCustomEndpoint;

    public Output<Optional<String>> agentIdentityCustomEndpoint() {
        return Codegen.optional(this.agentIdentityCustomEndpoint);
    }
    ...
    @Export(name="agenticApplicationsCustomEndpoint", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> agenticApplicationsCustomEndpoint;

    public Output<Optional<String>> agenticApplicationsCustomEndpoint() {
        return Codegen.optional(this.agenticApplicationsCustomEndpoint);
    }
    ...
    public Output<Optional<String>> biglakeIcebergCustomEndpoint() {
        return Codegen.optional(this.biglakeIcebergCustomEndpoint);
    }
    ...
    @Export(name="cesCustomEndpoint", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> cesCustomEndpoint;

    public Output<Optional<String>> cesCustomEndpoint() {
        return Codegen.optional(this.cesCustomEndpoint);
    }
    ...
    @Export(name="cloudSupportCustomEndpoint", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> cloudSupportCustomEndpoint;

    public Output<Optional<String>> cloudSupportCustomEndpoint() {
        return Codegen.optional(this.cloudSupportCustomEndpoint);
    }
    ...
    @Export(name="configCustomEndpoint", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> configCustomEndpoint;

    public Output<Optional<String>> configCustomEndpoint() {
        return Codegen.optional(this.configCustomEndpoint);
    }
    ...
    @Export(name="firebaseAiLogicCustomEndpoint", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> firebaseAiLogicCustomEndpoint;

    public Output<Optional<String>> firebaseAiLogicCustomEndpoint() {
        return Codegen.optional(this.firebaseAiLogicCustomEndpoint);
    }
    ...
    @Export(name="workloadIdentityCustomEndpoint", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> workloadIdentityCustomEndpoint;

    public Output<Optional<String>> workloadIdentityCustomEndpoint() {
        return Codegen.optional(this.workloadIdentityCustomEndpoint);
    }
