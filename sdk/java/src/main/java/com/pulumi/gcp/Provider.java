...
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    @Export(name="dataPipelineCustomEndpoint", type=String.class, parameters={})
    ...
    @Export(name="edgenetworkCustomEndpoint", type=String.class, parameters={})
    ...
    @Export(name="storageInsightsCustomEndpoint", type=String.class, parameters={})
    ...
    @Export(name="tpuV2CustomEndpoint", type=String.class, parameters={})
