...
import com.pulumi.gcp.beyondcorp.inputs.ApplicationIamMemberState;
import com.pulumi.gcp.beyondcorp.outputs.ApplicationIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:beyondcorp/applicationIamMember:ApplicationIamMember editor &#34;projects/{{project}}/locations/global/securityGateways/{{security_gateways_id}}/applications/{{application_id}} roles/beyondcorp.securityGatewayUser user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:beyondcorp/applicationIamMember:ApplicationIamMember")
public class ApplicationIamMember extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="condition", refs={ApplicationIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ ApplicationIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<ApplicationIamMemberCondition>> condition() {
     ...
     */
    public ApplicationIamMember(java.lang.String name) {
        this(name, ApplicationIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ApplicationIamMember(java.lang.String name, ApplicationIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ApplicationIamMember(java.lang.String name, ApplicationIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/applicationIamMember:ApplicationIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ApplicationIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable ApplicationIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/applicationIamMember:ApplicationIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static ApplicationIamMemberArgs makeArgs(ApplicationIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ApplicationIamMemberArgs.Empty : args;
    }
     ...
     */
    public static ApplicationIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable ApplicationIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
