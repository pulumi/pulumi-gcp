...
public final class URLMapHeaderActionRequestHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapHeaderActionRequestHeadersToAddArgs(URLMapHeaderActionRequestHeadersToAddArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapHeaderActionRequestHeadersToAddArgs();
        }

        public Builder(URLMapHeaderActionRequestHeadersToAddArgs defaults) {
            $ = new URLMapHeaderActionRequestHeadersToAddArgs(Objects.requireNonNull(defaults));
        }
