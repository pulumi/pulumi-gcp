...
@CustomType
public final class JobTemplateConfigManifest {
    /**
    ...
    public static Builder builder(JobTemplateConfigManifest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(JobTemplateConfigManifest defaults) {
        ...
        public JobTemplateConfigManifest build() {
            final var _resultValue = new JobTemplateConfigManifest();
