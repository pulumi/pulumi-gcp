 ...
 * 
 * ```sh
 * $ pulumi import gcp:storage/bucketIAMBinding:BucketIAMBinding editor &#34;b/{{bucket}} roles/storage.objectViewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class BucketIAMBinding extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={BucketIAMBindingCondition.class}, tree="[0]")
     ...
     */
    public BucketIAMBinding(java.lang.String name) {
     ...
     */
    public BucketIAMBinding(java.lang.String name, BucketIAMBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BucketIAMBinding(java.lang.String name, BucketIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:storage/bucketIAMBinding:BucketIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BucketIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable BucketIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:storage/bucketIAMBinding:BucketIAMBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static BucketIAMBindingArgs makeArgs(BucketIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BucketIAMBindingArgs.Empty : args;
    }
     ...
     */
    public static BucketIAMBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable BucketIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
