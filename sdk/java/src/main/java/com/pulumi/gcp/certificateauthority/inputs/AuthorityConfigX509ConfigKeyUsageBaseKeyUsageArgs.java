...
public final class AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs Empty = new AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs();
    ...
    private AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs() {}

    private AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs(AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs $) {
    ...
    public static Builder builder(AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs();
        }

        public Builder(AuthorityConfigX509ConfigKeyUsageBaseKeyUsageArgs defaults) {
