...
public final class RegionBackendServiceCircuitBreakersConnectTimeoutArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RegionBackendServiceCircuitBreakersConnectTimeoutArgs(RegionBackendServiceCircuitBreakersConnectTimeoutArgs $) {
        this.nanos = $.nanos;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionBackendServiceCircuitBreakersConnectTimeoutArgs();
        }

        public Builder(RegionBackendServiceCircuitBreakersConnectTimeoutArgs defaults) {
            $ = new RegionBackendServiceCircuitBreakersConnectTimeoutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionBackendServiceCircuitBreakersConnectTimeoutArgs build() {
            if ($.seconds == null) {
                throw new MissingRequiredPropertyException("RegionBackendServiceCircuitBreakersConnectTimeoutArgs", "seconds");
            }
            return $;
        }
    }
