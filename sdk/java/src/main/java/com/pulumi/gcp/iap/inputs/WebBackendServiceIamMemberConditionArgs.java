...
public final class WebBackendServiceIamMemberConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WebBackendServiceIamMemberConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("WebBackendServiceIamMemberConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("WebBackendServiceIamMemberConditionArgs", "title");
            }
            return $;
        }
    }
