...
import com.pulumi.gcp.compute.outputs.NetworkFirewallPolicyWithRulesRuleMatchLayer4Config;
import com.pulumi.gcp.compute.outputs.NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag;
...
public final class NetworkFirewallPolicyWithRulesRuleMatch {
     ...
     * 
     */
    private List<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config> layer4Configs;
    /**
     ...
     * 
     */
    public List<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config> layer4Configs() {
    ...
    public static Builder builder(NetworkFirewallPolicyWithRulesRuleMatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> srcThreatIntelligences;
        public Builder() {}
        public Builder(NetworkFirewallPolicyWithRulesRuleMatch defaults) {
        ...
        @CustomType.Setter
        public Builder layer4Configs(List<NetworkFirewallPolicyWithRulesRuleMatchLayer4Config> layer4Configs) {
            if (layer4Configs == null) {
              throw new MissingRequiredPropertyException("NetworkFirewallPolicyWithRulesRuleMatch", "layer4Configs");
            }
            this.layer4Configs = layer4Configs;
            return this;
        }
        public Builder layer4Configs(NetworkFirewallPolicyWithRulesRuleMatchLayer4Config... layer4Configs) {
        ...
        @CustomType.Setter
        public Builder srcSecureTags(@Nullable List<NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag> srcSecureTags) {

            this.srcSecureTags = srcSecureTags;
            return this;
        }
        public Builder srcSecureTags(NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag... srcSecureTags) {
        ...
        public NetworkFirewallPolicyWithRulesRuleMatch build() {
            final var _resultValue = new NetworkFirewallPolicyWithRulesRuleMatch();
