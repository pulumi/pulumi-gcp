...
public final class RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs extends com.pulumi.resources.ResourceArgs {

    public static final RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs Empty = new RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs();
    ...
    private RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs() {}

    private RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs(RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs $) {
    ...
    public static Builder builder(RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs();
        }

        public Builder(RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs defaults) {
            $ = new RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs build() {
            if ($.ipAddress == null) {
                throw new MissingRequiredPropertyException("RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs", "ipAddress");
            }
            if ($.ipProtocol == null) {
                throw new MissingRequiredPropertyException("RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs", "ipProtocol");
            }
            if ($.loadBalancerType == null) {
                throw new MissingRequiredPropertyException("RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs", "loadBalancerType");
            }
            if ($.networkUrl == null) {
                throw new MissingRequiredPropertyException("RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs", "networkUrl");
            }
            if ($.port == null) {
                throw new MissingRequiredPropertyException("RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs", "port");
            }
            if ($.project == null) {
                throw new MissingRequiredPropertyException("RecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancerArgs", "project");
            }
            return $;
        }
    }
