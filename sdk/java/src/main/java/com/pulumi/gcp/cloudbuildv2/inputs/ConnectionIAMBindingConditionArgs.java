...
public final class ConnectionIAMBindingConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ConnectionIAMBindingConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("ConnectionIAMBindingConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("ConnectionIAMBindingConditionArgs", "title");
            }
            return $;
        }
    }
