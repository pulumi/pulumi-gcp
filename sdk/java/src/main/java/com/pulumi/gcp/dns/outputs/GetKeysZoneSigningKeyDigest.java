...
public final class GetKeysZoneSigningKeyDigest {
    ...
    public static final class Builder {
        ...
        public Builder digest(String digest) {
            if (digest == null) {
              throw new MissingRequiredPropertyException("GetKeysZoneSigningKeyDigest", "digest");
            }
            this.digest = digest;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetKeysZoneSigningKeyDigest", "type");
            }
            this.type = type;
            return this;
        }
