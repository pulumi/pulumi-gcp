 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/appEngineServiceIamBinding:AppEngineServiceIamBinding editor &#34;projects/{{project}}/iap_web/appengine-{{appId}}/services/{{service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
