...
@CustomType
public final class VMwareNodePoolStatusCondition {
    /**
     * @return (Output)
    ...
    public static Builder builder(VMwareNodePoolStatusCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(VMwareNodePoolStatusCondition defaults) {
