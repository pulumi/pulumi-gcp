...
public final class LicenseConfigEndDateArgs extends com.pulumi.resources.ResourceArgs {

    public static final LicenseConfigEndDateArgs Empty = new LicenseConfigEndDateArgs();
    ...
    private LicenseConfigEndDateArgs() {}

    private LicenseConfigEndDateArgs(LicenseConfigEndDateArgs $) {
        this.day = $.day;
        this.month = $.month;
        this.year = $.year;
    }
    ...
    public static Builder builder(LicenseConfigEndDateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LicenseConfigEndDateArgs();
        }

        public Builder(LicenseConfigEndDateArgs defaults) {
            $ = new LicenseConfigEndDateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LicenseConfigEndDateArgs build() {
            return $;
        }
    }
