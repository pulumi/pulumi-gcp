...
import com.pulumi.gcp.securitycenter.inputs.V2FolderSccBigQueryExportState;
 ...
 * 
 */
@ResourceType(type="gcp:securitycenter/v2FolderSccBigQueryExport:V2FolderSccBigQueryExport")
public class V2FolderSccBigQueryExport extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public V2FolderSccBigQueryExport(java.lang.String name) {
        this(name, V2FolderSccBigQueryExportArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public V2FolderSccBigQueryExport(java.lang.String name, V2FolderSccBigQueryExportArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public V2FolderSccBigQueryExport(java.lang.String name, V2FolderSccBigQueryExportArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2FolderSccBigQueryExport:V2FolderSccBigQueryExport", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private V2FolderSccBigQueryExport(java.lang.String name, Output<java.lang.String> id, @Nullable V2FolderSccBigQueryExportState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2FolderSccBigQueryExport:V2FolderSccBigQueryExport", name, state, makeResourceOptions(options, id), false);
    }

    private static V2FolderSccBigQueryExportArgs makeArgs(V2FolderSccBigQueryExportArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? V2FolderSccBigQueryExportArgs.Empty : args;
    }
     ...
     */
    public static V2FolderSccBigQueryExport get(java.lang.String name, Output<java.lang.String> id, @Nullable V2FolderSccBigQueryExportState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new V2FolderSccBigQueryExport(name, id, state, options);
    }
}
