...
public class DatabaseIAMBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public DatabaseIAMBinding(java.lang.String name) {
     ...
     */
    public DatabaseIAMBinding(java.lang.String name, DatabaseIAMBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DatabaseIAMBinding(java.lang.String name, DatabaseIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:spanner/databaseIAMBinding:DatabaseIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DatabaseIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable DatabaseIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:spanner/databaseIAMBinding:DatabaseIAMBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static DatabaseIAMBindingArgs makeArgs(DatabaseIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DatabaseIAMBindingArgs.Empty : args;
    }
     ...
     */
    public static DatabaseIAMBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable DatabaseIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
