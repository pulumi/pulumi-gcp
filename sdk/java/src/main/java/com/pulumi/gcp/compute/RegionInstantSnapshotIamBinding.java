...
import com.pulumi.gcp.compute.inputs.RegionInstantSnapshotIamBindingState;
import com.pulumi.gcp.compute.outputs.RegionInstantSnapshotIamBindingCondition;
 ...
 * ```sh
 * $ terraform import google_compute_region_instant_snapshot_iam_member.editor &#34;projects/{{project}}/regions/{{region}}/instantSnapshots/{{region_instant_snapshot}} roles/compute.storageAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/regionInstantSnapshotIamBinding:RegionInstantSnapshotIamBinding")
public class RegionInstantSnapshotIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={RegionInstantSnapshotIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ RegionInstantSnapshotIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<RegionInstantSnapshotIamBindingCondition>> condition() {
     ...
     */
    public RegionInstantSnapshotIamBinding(java.lang.String name) {
        this(name, RegionInstantSnapshotIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RegionInstantSnapshotIamBinding(java.lang.String name, RegionInstantSnapshotIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RegionInstantSnapshotIamBinding(java.lang.String name, RegionInstantSnapshotIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionInstantSnapshotIamBinding:RegionInstantSnapshotIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RegionInstantSnapshotIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable RegionInstantSnapshotIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionInstantSnapshotIamBinding:RegionInstantSnapshotIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static RegionInstantSnapshotIamBindingArgs makeArgs(RegionInstantSnapshotIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RegionInstantSnapshotIamBindingArgs.Empty : args;
    }
     ...
     */
    public static RegionInstantSnapshotIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable RegionInstantSnapshotIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RegionInstantSnapshotIamBinding(name, id, state, options);
    }
}
