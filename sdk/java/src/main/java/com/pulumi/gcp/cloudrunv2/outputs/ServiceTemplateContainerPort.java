...
@CustomType
public final class ServiceTemplateContainerPort {
    /**
    ...
    private ServiceTemplateContainerPort() {}
    /**
     * @return Port number the container listens on. This must be a valid TCP port number, 0 &lt; containerPort &lt; 65536.
     * 
     */
    ...
    public static Builder builder(ServiceTemplateContainerPort defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(ServiceTemplateContainerPort defaults) {
