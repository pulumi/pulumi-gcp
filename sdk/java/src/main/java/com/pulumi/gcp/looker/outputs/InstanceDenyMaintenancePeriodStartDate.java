...
@CustomType
public final class InstanceDenyMaintenancePeriodStartDate {
    /**
    ...
    public static Builder builder(InstanceDenyMaintenancePeriodStartDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(InstanceDenyMaintenancePeriodStartDate defaults) {
        ...
        public InstanceDenyMaintenancePeriodStartDate build() {
            final var _resultValue = new InstanceDenyMaintenancePeriodStartDate();
