...
@CustomType
public final class MetastoreServiceMetadataIntegrationDataCatalogConfig {
    /**
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("MetastoreServiceMetadataIntegrationDataCatalogConfig", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public MetastoreServiceMetadataIntegrationDataCatalogConfig build() {
            final var _resultValue = new MetastoreServiceMetadataIntegrationDataCatalogConfig();
