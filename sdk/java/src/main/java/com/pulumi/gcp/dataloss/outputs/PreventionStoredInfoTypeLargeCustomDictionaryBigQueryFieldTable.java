...
public final class PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldTable {
    ...
    public static final class Builder {
        ...
        public Builder datasetId(String datasetId) {
            if (datasetId == null) {
              throw new MissingRequiredPropertyException("PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldTable", "datasetId");
            }
        ...
        public Builder projectId(String projectId) {
            if (projectId == null) {
              throw new MissingRequiredPropertyException("PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldTable", "projectId");
            }
        ...
        public Builder tableId(String tableId) {
            if (tableId == null) {
              throw new MissingRequiredPropertyException("PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldTable", "tableId");
            }
