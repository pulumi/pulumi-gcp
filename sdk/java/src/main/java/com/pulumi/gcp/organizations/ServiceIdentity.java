...
import com.pulumi.gcp.organizations.inputs.ServiceIdentityState;
 ...
 * 
 */
@ResourceType(type="gcp:organizations/serviceIdentity:ServiceIdentity")
public class ServiceIdentity extends com.pulumi.resources.CustomResource {
    ...
    public ServiceIdentity(java.lang.String name, ServiceIdentityArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:organizations/serviceIdentity:ServiceIdentity", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ServiceIdentity(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceIdentityState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:organizations/serviceIdentity:ServiceIdentity", name, state, makeResourceOptions(options, id), false);
    }
