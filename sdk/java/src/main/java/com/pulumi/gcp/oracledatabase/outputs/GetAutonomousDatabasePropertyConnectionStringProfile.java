...
@CustomType
public final class GetAutonomousDatabasePropertyConnectionStringProfile {
    /**
    ...
    private GetAutonomousDatabasePropertyConnectionStringProfile() {}
    /**
     * @return The current consumer group being used by the connection.
     *  Possible values:
     *  CONSUMER_GROUP_UNSPECIFIED
    ...
    public static Builder builder(GetAutonomousDatabasePropertyConnectionStringProfile defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(GetAutonomousDatabasePropertyConnectionStringProfile defaults) {
        ...
        public Builder consumerGroup(String consumerGroup) {
            if (consumerGroup == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "consumerGroup");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "displayName");
            }
        ...
        public Builder hostFormat(String hostFormat) {
            if (hostFormat == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "hostFormat");
            }
        ...
        public Builder isRegional(Boolean isRegional) {
            if (isRegional == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "isRegional");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "protocol");
            }
        ...
        public Builder sessionMode(String sessionMode) {
            if (sessionMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "sessionMode");
            }
        ...
        public Builder syntaxFormat(String syntaxFormat) {
            if (syntaxFormat == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "syntaxFormat");
            }
        ...
        public Builder tlsAuthentication(String tlsAuthentication) {
            if (tlsAuthentication == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "tlsAuthentication");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePropertyConnectionStringProfile", "value");
            }
            this.value = value;
            return this;
        }
        public GetAutonomousDatabasePropertyConnectionStringProfile build() {
            final var _resultValue = new GetAutonomousDatabasePropertyConnectionStringProfile();
