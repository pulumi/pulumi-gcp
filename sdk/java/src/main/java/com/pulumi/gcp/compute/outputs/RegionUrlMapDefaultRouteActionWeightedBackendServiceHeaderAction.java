...
import com.pulumi.gcp.compute.outputs.RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd;
import com.pulumi.gcp.compute.outputs.RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd;
...
@CustomType
public final class RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction {
    /**
     * @return Headers to add to a matching request before forwarding the request to the backendService.
     * Structure is documented below.
     * 
     */
    private @Nullable List<RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd> requestHeadersToAdds;
    /**
     ...
     * 
     */
    private @Nullable List<RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd> responseHeadersToAdds;
    /**
    ...
    private RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction() {}
    /**
     * @return Headers to add to a matching request before forwarding the request to the backendService.
     * Structure is documented below.
     * 
     */
    public List<RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd> requestHeadersToAdds() {
     ...
     * 
     */
    public List<RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd> responseHeadersToAdds() {
    ...
    public static Builder builder(RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> responseHeadersToRemoves;
        public Builder() {}
        public Builder(RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction defaults) {
        ...
        @CustomType.Setter
        public Builder requestHeadersToAdds(@Nullable List<RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd> requestHeadersToAdds) {

            this.requestHeadersToAdds = requestHeadersToAdds;
            return this;
        }
        public Builder requestHeadersToAdds(RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd... requestHeadersToAdds) {
        ...
        @CustomType.Setter
        public Builder responseHeadersToAdds(@Nullable List<RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd> responseHeadersToAdds) {

            this.responseHeadersToAdds = responseHeadersToAdds;
            return this;
        }
        public Builder responseHeadersToAdds(RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd... responseHeadersToAdds) {
