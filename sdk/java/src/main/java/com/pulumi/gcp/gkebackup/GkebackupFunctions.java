...
public final class GkebackupFunctions {
     ...
     * 
     */
    public static Output<GetBackupPlanIamPolicyResult> getBackupPlanIamPolicy(GetBackupPlanIamPolicyArgs args, InvokeOutputOptions options) {
        return Deployment.getInstance().invoke("gcp:gkebackup/getBackupPlanIamPolicy:getBackupPlanIamPolicy", TypeShape.of(GetBackupPlanIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Retrieves the current IAM policy data for backupplan
     ...
     * 
     */
    public static Output<GetRestorePlanIamPolicyResult> getRestorePlanIamPolicy(GetRestorePlanIamPolicyArgs args, InvokeOutputOptions options) {
        return Deployment.getInstance().invoke("gcp:gkebackup/getRestorePlanIamPolicy:getRestorePlanIamPolicy", TypeShape.of(GetRestorePlanIamPolicyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Retrieves the current IAM policy data for restoreplan
