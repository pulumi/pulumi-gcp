 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudfunctions/functionIamMember:FunctionIamMember editor &#34;projects/{{project}}/locations/{{region}}/functions/{{cloud_function}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class FunctionIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public FunctionIamMember(java.lang.String name) {
     ...
     */
    public FunctionIamMember(java.lang.String name, FunctionIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FunctionIamMember(java.lang.String name, FunctionIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudfunctions/functionIamMember:FunctionIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FunctionIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudfunctions/functionIamMember:FunctionIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static FunctionIamMemberArgs makeArgs(FunctionIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FunctionIamMemberArgs.Empty : args;
    }
     ...
     */
    public static FunctionIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
