...
import com.pulumi.gcp.iap.inputs.WebForwardingRuleServiceIamMemberState;
import com.pulumi.gcp.iap.outputs.WebForwardingRuleServiceIamMemberCondition;
 ...
 * }
 * </pre>
<<<<<<< HEAD:sdk/java/src/main/java/com/pulumi/gcp/iap/WebForwardingRuleServiceIamMember.java
 * &lt;!--End PulumiCodeChooser --&gt;
 * ## gcp.iap.WebForwardingRuleServiceIamBinding
=======
 * ## gcp.beyondcorp.ApplicationIamBinding
>>>>>>> master:sdk/java/src/main/java/com/pulumi/gcp/beyondcorp/ApplicationIamMember.java
 * 
 * <pre>
 * {@code
 * package generated_program;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember editor &#34;projects/{{project}}/iap_web/forwarding_rule/services/{{web_forwarding_rule_service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember")
public class WebForwardingRuleServiceIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={WebForwardingRuleServiceIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ WebForwardingRuleServiceIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<WebForwardingRuleServiceIamMemberCondition>> condition() {
     ...
     */
    public WebForwardingRuleServiceIamMember(java.lang.String name) {
        this(name, WebForwardingRuleServiceIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebForwardingRuleServiceIamMember(java.lang.String name, WebForwardingRuleServiceIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebForwardingRuleServiceIamMember(java.lang.String name, WebForwardingRuleServiceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebForwardingRuleServiceIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable WebForwardingRuleServiceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webForwardingRuleServiceIamMember:WebForwardingRuleServiceIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static WebForwardingRuleServiceIamMemberArgs makeArgs(WebForwardingRuleServiceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebForwardingRuleServiceIamMemberArgs.Empty : args;
    }
     ...
     */
    public static WebForwardingRuleServiceIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable WebForwardingRuleServiceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new WebForwardingRuleServiceIamMember(name, id, state, options);
    }
}
