...
public final class BackendServiceIamBindingConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BackendServiceIamBindingConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("BackendServiceIamBindingConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("BackendServiceIamBindingConditionArgs", "title");
            }
            return $;
        }
    }
