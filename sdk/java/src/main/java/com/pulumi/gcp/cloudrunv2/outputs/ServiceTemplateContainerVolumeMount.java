...
public final class ServiceTemplateContainerVolumeMount {
    ...
    public static Builder builder(ServiceTemplateContainerVolumeMount defaults) {
    ...
    public static final class Builder {
        ...
        public Builder mountPath(String mountPath) {
            if (mountPath == null) {
              throw new MissingRequiredPropertyException("ServiceTemplateContainerVolumeMount", "mountPath");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ServiceTemplateContainerVolumeMount", "name");
            }
            this.name = name;
            return this;
        }
