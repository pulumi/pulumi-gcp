...
public final class GuestPoliciesRecipeUpdateStepArchiveExtractionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GuestPoliciesRecipeUpdateStepArchiveExtractionArgs build() {
            if ($.artifactId == null) {
                throw new MissingRequiredPropertyException("GuestPoliciesRecipeUpdateStepArchiveExtractionArgs", "artifactId");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GuestPoliciesRecipeUpdateStepArchiveExtractionArgs", "type");
            }
            return $;
        }
    }
