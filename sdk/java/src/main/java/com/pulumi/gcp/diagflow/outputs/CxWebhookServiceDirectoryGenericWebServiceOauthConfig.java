...
@CustomType
public final class CxWebhookServiceDirectoryGenericWebServiceOauthConfig {
    /**
    ...
    public static Builder builder(CxWebhookServiceDirectoryGenericWebServiceOauthConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String tokenEndpoint;
        public Builder() {}
        public Builder(CxWebhookServiceDirectoryGenericWebServiceOauthConfig defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("CxWebhookServiceDirectoryGenericWebServiceOauthConfig", "clientId");
            }
        ...
        public Builder tokenEndpoint(String tokenEndpoint) {
            if (tokenEndpoint == null) {
              throw new MissingRequiredPropertyException("CxWebhookServiceDirectoryGenericWebServiceOauthConfig", "tokenEndpoint");
            }
            this.tokenEndpoint = tokenEndpoint;
            return this;
        }
        public CxWebhookServiceDirectoryGenericWebServiceOauthConfig build() {
            final var _resultValue = new CxWebhookServiceDirectoryGenericWebServiceOauthConfig();
