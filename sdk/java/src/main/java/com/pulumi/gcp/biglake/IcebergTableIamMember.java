...
import com.pulumi.gcp.biglake.inputs.IcebergTableIamMemberState;
import com.pulumi.gcp.biglake.outputs.IcebergTableIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/icebergTableIamMember:IcebergTableIamMember")
public class IcebergTableIamMember extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={IcebergTableIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ IcebergTableIamMemberCondition> condition;

    public Output<Optional<IcebergTableIamMemberCondition>> condition() {
     ...
     */
    public IcebergTableIamMember(java.lang.String name) {
        this(name, IcebergTableIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IcebergTableIamMember(java.lang.String name, IcebergTableIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IcebergTableIamMember(java.lang.String name, IcebergTableIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergTableIamMember:IcebergTableIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IcebergTableIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergTableIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergTableIamMember:IcebergTableIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static IcebergTableIamMemberArgs makeArgs(IcebergTableIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IcebergTableIamMemberArgs.Empty : args;
    }
     ...
     */
    public static IcebergTableIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergTableIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
