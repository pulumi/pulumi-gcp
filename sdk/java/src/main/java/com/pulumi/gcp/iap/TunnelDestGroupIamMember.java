 ...
 * ```sh
 * $ terraform import google_iap_tunnel_dest_group_iam_member.editor &#34;projects/{{project}}/iap_tunnel/locations/{{region}}/destGroups/{{dest_group}} roles/iap.tunnelResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
