...
public final class GetBackendServiceConsistentHashHttpCookyTtl {
    ...
    public static final class Builder {
        ...
        public Builder nanos(Integer nanos) {
            if (nanos == null) {
              throw new MissingRequiredPropertyException("GetBackendServiceConsistentHashHttpCookyTtl", "nanos");
            }
            this.nanos = nanos;
            return this;
        }
        ...
        public Builder seconds(Integer seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("GetBackendServiceConsistentHashHttpCookyTtl", "seconds");
            }
            this.seconds = seconds;
            return this;
        }
        public GetBackendServiceConsistentHashHttpCookyTtl build() {
            final var _resultValue = new GetBackendServiceConsistentHashHttpCookyTtl();
