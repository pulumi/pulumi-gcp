...
@CustomType
public final class GetInstanceBootDiskInitializeParamSourceImageEncryptionKey {
    /**
    ...
    private GetInstanceBootDiskInitializeParamSourceImageEncryptionKey() {}
    /**
     * @return The self link of the encryption key that is stored in Google Cloud KMS. Only one of kms_key_self_link, rsa_encrypted_key and raw_key may be set.
     * 
     */
    ...
    public static Builder builder(GetInstanceBootDiskInitializeParamSourceImageEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private String sha256;
        public Builder() {}
        public Builder(GetInstanceBootDiskInitializeParamSourceImageEncryptionKey defaults) {
        ...
        public Builder kmsKeySelfLink(String kmsKeySelfLink) {
            if (kmsKeySelfLink == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceImageEncryptionKey", "kmsKeySelfLink");
            }
        ...
        public Builder kmsKeyServiceAccount(String kmsKeyServiceAccount) {
            if (kmsKeyServiceAccount == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceImageEncryptionKey", "kmsKeyServiceAccount");
            }
        ...
        public Builder rawKey(String rawKey) {
            if (rawKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceImageEncryptionKey", "rawKey");
            }
            this.rawKey = rawKey;
            return this;
        }
        ...
        public Builder rsaEncryptedKey(String rsaEncryptedKey) {
            if (rsaEncryptedKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceImageEncryptionKey", "rsaEncryptedKey");
            }
        ...
        public Builder sha256(String sha256) {
            if (sha256 == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceImageEncryptionKey", "sha256");
            }
            this.sha256 = sha256;
            return this;
        }
        public GetInstanceBootDiskInitializeParamSourceImageEncryptionKey build() {
            final var _resultValue = new GetInstanceBootDiskInitializeParamSourceImageEncryptionKey();
