...
import com.pulumi.gcp.dataproc.inputs.MetastoreTableIamMemberState;
import com.pulumi.gcp.dataproc.outputs.MetastoreTableIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataproc/metastoreTableIamMember:MetastoreTableIamMember editor &#34;projects/{{project}}/locations/{{location}}/services/{{serviceId}}/databases/{{databaseId}}/tables/{{table}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataproc/metastoreTableIamMember:MetastoreTableIamMember")
public class MetastoreTableIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={MetastoreTableIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ MetastoreTableIamMemberCondition> condition;
     ...
     */
    public MetastoreTableIamMember(java.lang.String name) {
        this(name, MetastoreTableIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MetastoreTableIamMember(java.lang.String name, MetastoreTableIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetastoreTableIamMember(java.lang.String name, MetastoreTableIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreTableIamMember:MetastoreTableIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetastoreTableIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreTableIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreTableIamMember:MetastoreTableIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static MetastoreTableIamMemberArgs makeArgs(MetastoreTableIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MetastoreTableIamMemberArgs.Empty : args;
    }
     ...
     */
    public static MetastoreTableIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreTableIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
