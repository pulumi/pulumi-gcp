...
@CustomType
public final class AppEngineVersionIamMemberCondition {
    /**
    ...
    public static Builder builder(AppEngineVersionIamMemberCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(AppEngineVersionIamMemberCondition defaults) {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("AppEngineVersionIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("AppEngineVersionIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public AppEngineVersionIamMemberCondition build() {
            final var _resultValue = new AppEngineVersionIamMemberCondition();
