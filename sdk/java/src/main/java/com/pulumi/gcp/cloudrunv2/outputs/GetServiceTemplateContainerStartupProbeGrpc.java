...
public final class GetServiceTemplateContainerStartupProbeGrpc {
    ...
    public static final class Builder {
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetServiceTemplateContainerStartupProbeGrpc", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder service(String service) {
            if (service == null) {
              throw new MissingRequiredPropertyException("GetServiceTemplateContainerStartupProbeGrpc", "service");
            }
