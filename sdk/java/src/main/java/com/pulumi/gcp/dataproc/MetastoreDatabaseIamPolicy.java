...
import com.pulumi.gcp.dataproc.inputs.MetastoreDatabaseIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataproc/metastoreDatabaseIamPolicy:MetastoreDatabaseIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/services/{{serviceId}}/databases/{{database}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataproc/metastoreDatabaseIamPolicy:MetastoreDatabaseIamPolicy")
public class MetastoreDatabaseIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public MetastoreDatabaseIamPolicy(java.lang.String name) {
        this(name, MetastoreDatabaseIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MetastoreDatabaseIamPolicy(java.lang.String name, MetastoreDatabaseIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetastoreDatabaseIamPolicy(java.lang.String name, MetastoreDatabaseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreDatabaseIamPolicy:MetastoreDatabaseIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetastoreDatabaseIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreDatabaseIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreDatabaseIamPolicy:MetastoreDatabaseIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static MetastoreDatabaseIamPolicyArgs makeArgs(MetastoreDatabaseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MetastoreDatabaseIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static MetastoreDatabaseIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreDatabaseIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new MetastoreDatabaseIamPolicy(name, id, state, options);
    }
}
