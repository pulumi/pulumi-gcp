...
@CustomType
public final class AccessLevelConditionVpcNetworkSourceVpcSubnetwork {
    /**
    ...
    public static Builder builder(AccessLevelConditionVpcNetworkSourceVpcSubnetwork defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> vpcIpSubnetworks;
        public Builder() {}
        public Builder(AccessLevelConditionVpcNetworkSourceVpcSubnetwork defaults) {
        ...
        public Builder network(String network) {
            if (network == null) {
              throw new MissingRequiredPropertyException("AccessLevelConditionVpcNetworkSourceVpcSubnetwork", "network");
            }
