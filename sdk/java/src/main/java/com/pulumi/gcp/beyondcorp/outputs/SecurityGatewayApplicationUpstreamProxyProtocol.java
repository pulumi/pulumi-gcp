...
import com.pulumi.gcp.beyondcorp.outputs.SecurityGatewayApplicationUpstreamProxyProtocolContextualHeaders;
...
@CustomType
public final class SecurityGatewayApplicationUpstreamProxyProtocol {
    /**
     ...
     * 
     */
    private @Nullable SecurityGatewayApplicationUpstreamProxyProtocolContextualHeaders contextualHeaders;
    /**
    ...
    private SecurityGatewayApplicationUpstreamProxyProtocol() {}
    /**
     * @return The configuration for the proxy.
     * 
     */
     ...
     * 
     */
    public Optional<SecurityGatewayApplicationUpstreamProxyProtocolContextualHeaders> contextualHeaders() {
    ...
    public static Builder builder(SecurityGatewayApplicationUpstreamProxyProtocol defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> metadataHeaders;
        public Builder() {}
        public Builder(SecurityGatewayApplicationUpstreamProxyProtocol defaults) {
        ...
        @CustomType.Setter
        public Builder contextualHeaders(@Nullable SecurityGatewayApplicationUpstreamProxyProtocolContextualHeaders contextualHeaders) {
        ...
        public SecurityGatewayApplicationUpstreamProxyProtocol build() {
            final var _resultValue = new SecurityGatewayApplicationUpstreamProxyProtocol();
