...
public final class ClusterNodePoolNodeConfigKubeletConfig {
     ...
     * 
     */
    private @Nullable ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod evictionSoftGracePeriod;
    /**
     ...
     * 
     */
    public Optional<ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim> evictionMinimumReclaim() {
     ...
     * 
     */
    public Optional<ClusterNodePoolNodeConfigKubeletConfigEvictionSoft> evictionSoft() {
     ...
     * 
     */
    public Optional<ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod> evictionSoftGracePeriod() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder evictionMinimumReclaim(@Nullable ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim evictionMinimumReclaim) {

            this.evictionMinimumReclaim = evictionMinimumReclaim;
            return this;
        }
        @CustomType.Setter
        public Builder evictionSoft(@Nullable ClusterNodePoolNodeConfigKubeletConfigEvictionSoft evictionSoft) {

            this.evictionSoft = evictionSoft;
            return this;
        }
        @CustomType.Setter
        public Builder evictionSoftGracePeriod(@Nullable ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod evictionSoftGracePeriod) {
