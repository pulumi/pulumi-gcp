...
@CustomType
public final class RegionHealthCheckGrpcTlsHealthCheck {
    /**
    ...
    private RegionHealthCheckGrpcTlsHealthCheck() {}
    /**
     * @return The gRPC service name for the health check.
     * The value of grpcServiceName has the following meanings by convention:
     * * Empty serviceName means the overall status of all services at the backend.
    ...
    public static Builder builder(RegionHealthCheckGrpcTlsHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String portSpecification;
        public Builder() {}
        public Builder(RegionHealthCheckGrpcTlsHealthCheck defaults) {
        ...
        public RegionHealthCheckGrpcTlsHealthCheck build() {
            final var _resultValue = new RegionHealthCheckGrpcTlsHealthCheck();
