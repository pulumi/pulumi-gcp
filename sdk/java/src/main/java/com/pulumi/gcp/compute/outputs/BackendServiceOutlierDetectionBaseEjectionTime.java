...
public final class BackendServiceOutlierDetectionBaseEjectionTime {
    ...
    public static final class Builder {
        ...
        public Builder seconds(Integer seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("BackendServiceOutlierDetectionBaseEjectionTime", "seconds");
            }
            this.seconds = seconds;
            return this;
        }
        public BackendServiceOutlierDetectionBaseEjectionTime build() {
            final var _resultValue = new BackendServiceOutlierDetectionBaseEjectionTime();
