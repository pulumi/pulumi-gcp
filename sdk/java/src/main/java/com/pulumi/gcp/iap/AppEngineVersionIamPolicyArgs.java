...
public final class AppEngineVersionIamPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AppEngineVersionIamPolicyArgs build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("AppEngineVersionIamPolicyArgs", "appId");
            }
            if ($.policyData == null) {
                throw new MissingRequiredPropertyException("AppEngineVersionIamPolicyArgs", "policyData");
            }
            if ($.service == null) {
                throw new MissingRequiredPropertyException("AppEngineVersionIamPolicyArgs", "service");
            }
            if ($.versionId == null) {
                throw new MissingRequiredPropertyException("AppEngineVersionIamPolicyArgs", "versionId");
            }
            return $;
        }
    }
