...
@CustomType
public final class ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim {
    /**
    ...
    private ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim() {}
    /**
     * @return Defines percentage of minimum reclaim for imagefs.available. The value must be a percentage no more than `&#34;10%&#34;`, such as `&#34;5%&#34;`.
     * 
     */
    ...
    public static Builder builder(ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String pidAvailable;
        public Builder() {}
        public Builder(ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim defaults) {
        ...
        public ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim build() {
            final var _resultValue = new ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim();
