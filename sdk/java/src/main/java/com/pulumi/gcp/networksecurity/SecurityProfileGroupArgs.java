...
public final class SecurityProfileGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(SecurityProfileGroupArgs defaults) {
