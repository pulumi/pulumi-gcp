...
@CustomType
public final class ReportSummaryAllAssetsStatCoreCountHistogramBucket {
    /**
     * @return (Output)
    ...
    public static Builder builder(ReportSummaryAllAssetsStatCoreCountHistogramBucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String upperBound;
        public Builder() {}
        public Builder(ReportSummaryAllAssetsStatCoreCountHistogramBucket defaults) {
        ...
        public ReportSummaryAllAssetsStatCoreCountHistogramBucket build() {
            final var _resultValue = new ReportSummaryAllAssetsStatCoreCountHistogramBucket();
