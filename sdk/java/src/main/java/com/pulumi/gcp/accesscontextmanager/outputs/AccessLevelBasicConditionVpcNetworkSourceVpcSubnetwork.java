...
@CustomType
public final class AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork {
    /**
    ...
    private AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork() {}
    /**
     * @return Required. Network name to be allowed by this Access Level. Networks of foreign organizations requires `compute.network.get` permission to be granted to caller.
     * 
     */
    ...
    public static Builder builder(AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> vpcIpSubnetworks;
        public Builder() {}
        public Builder(AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork defaults) {
        ...
        public AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork build() {
            final var _resultValue = new AccessLevelBasicConditionVpcNetworkSourceVpcSubnetwork();
