...
@CustomType
public final class RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd {
    /**
    ...
    private RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd() {}
    /**
     * @return The name of the header.
     * 
     */
    ...
    public static Builder builder(RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean replace;
        public Builder() {}
        public Builder(RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd defaults) {
        ...
        public RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd build() {
            final var _resultValue = new RegionUrlMapPathMatcherHeaderActionRequestHeadersToAdd();
