...
public final class RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs Empty = new RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs();
    ...
    private @Nullable Output<List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs>> requestHeadersToAdds;
     ...
     * 
     */
    public Optional<Output<List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs>>> requestHeadersToAdds() {
    ...
    private @Nullable Output<List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddArgs>> responseHeadersToAdds;
     ...
     * 
     */
    public Optional<Output<List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddArgs>>> responseHeadersToAdds() {
    ...
    private RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs() {}

    private RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs $) {
    ...
    public static Builder builder(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs();
        }

        public Builder(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs defaults) {
            $ = new RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder requestHeadersToAdds(@Nullable Output<List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs>> requestHeadersToAdds) {
         ...
         * 
         */
        public Builder requestHeadersToAdds(List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs> requestHeadersToAdds) {
         ...
         * 
         */
        public Builder requestHeadersToAdds(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAddArgs... requestHeadersToAdds) {
         ...
         * 
         */
        public Builder responseHeadersToAdds(@Nullable Output<List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddArgs>> responseHeadersToAdds) {
         ...
         * 
         */
        public Builder responseHeadersToAdds(List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddArgs> responseHeadersToAdds) {
         ...
         * 
         */
        public Builder responseHeadersToAdds(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAddArgs... responseHeadersToAdds) {
        ...
        public RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionArgs build() {
            return $;
        }
    }
