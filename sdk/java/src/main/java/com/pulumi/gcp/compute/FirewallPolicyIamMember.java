...
import com.pulumi.gcp.compute.inputs.FirewallPolicyIamMemberState;
import com.pulumi.gcp.compute.outputs.FirewallPolicyIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:compute/firewallPolicyIamMember:FirewallPolicyIamMember")
public class FirewallPolicyIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={FirewallPolicyIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ FirewallPolicyIamMemberCondition> condition;

    public Output<Optional<FirewallPolicyIamMemberCondition>> condition() {
     ...
     */
    public FirewallPolicyIamMember(java.lang.String name) {
        this(name, FirewallPolicyIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FirewallPolicyIamMember(java.lang.String name, FirewallPolicyIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FirewallPolicyIamMember(java.lang.String name, FirewallPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/firewallPolicyIamMember:FirewallPolicyIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FirewallPolicyIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable FirewallPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/firewallPolicyIamMember:FirewallPolicyIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static FirewallPolicyIamMemberArgs makeArgs(FirewallPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FirewallPolicyIamMemberArgs.Empty : args;
    }
     ...
     */
    public static FirewallPolicyIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable FirewallPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
