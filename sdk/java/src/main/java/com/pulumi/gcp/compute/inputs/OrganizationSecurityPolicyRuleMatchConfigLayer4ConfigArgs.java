...
public final class OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs(OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs();
        }

        public Builder(OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs defaults) {
            $ = new OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs build() {
            if ($.ipProtocol == null) {
                throw new MissingRequiredPropertyException("OrganizationSecurityPolicyRuleMatchConfigLayer4ConfigArgs", "ipProtocol");
            }
            return $;
        }
    }
