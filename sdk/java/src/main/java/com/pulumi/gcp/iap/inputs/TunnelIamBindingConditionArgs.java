...
public final class TunnelIamBindingConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TunnelIamBindingConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("TunnelIamBindingConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("TunnelIamBindingConditionArgs", "title");
            }
            return $;
        }
    }
