 ...
 * 
 * ```sh
 * $ pulumi import gcp:datacatalog/policyTagIamBinding:PolicyTagIamBinding editor &#34;{{policy_tag}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class PolicyTagIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public PolicyTagIamBinding(java.lang.String name) {
     ...
     */
    public PolicyTagIamBinding(java.lang.String name, PolicyTagIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PolicyTagIamBinding(java.lang.String name, PolicyTagIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/policyTagIamBinding:PolicyTagIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PolicyTagIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyTagIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/policyTagIamBinding:PolicyTagIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static PolicyTagIamBindingArgs makeArgs(PolicyTagIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PolicyTagIamBindingArgs.Empty : args;
    }
     ...
     */
    public static PolicyTagIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyTagIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
