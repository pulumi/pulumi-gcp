...
import com.pulumi.gcp.compute.outputs.ResizeRequestStatusErrorErrorErrorDetail;
...
public final class ResizeRequestStatusErrorError {
     ...
     * 
     */
    public List<ResizeRequestStatusErrorErrorErrorDetail> errorDetails() {
    ...
    public static Builder builder(ResizeRequestStatusErrorError defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String message;
        public Builder() {}
        public Builder(ResizeRequestStatusErrorError defaults) {
        ...
        @CustomType.Setter
        public Builder errorDetails(@Nullable List<ResizeRequestStatusErrorErrorErrorDetail> errorDetails) {

            this.errorDetails = errorDetails;
            return this;
        }
        public Builder errorDetails(ResizeRequestStatusErrorErrorErrorDetail... errorDetails) {
        ...
        public ResizeRequestStatusErrorError build() {
            final var _resultValue = new ResizeRequestStatusErrorError();
