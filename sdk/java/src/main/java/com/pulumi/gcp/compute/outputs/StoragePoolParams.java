...
@CustomType
public final class StoragePoolParams {
    /**
    ...
    public static Builder builder(StoragePoolParams defaults) {
    ...
    public static final class Builder {
        private @Nullable Map<String,String> resourceManagerTags;
        public Builder() {}
        public Builder(StoragePoolParams defaults) {
        ...
        public StoragePoolParams build() {
            final var _resultValue = new StoragePoolParams();
