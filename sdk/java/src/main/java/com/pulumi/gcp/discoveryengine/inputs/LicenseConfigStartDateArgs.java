...
public final class LicenseConfigStartDateArgs extends com.pulumi.resources.ResourceArgs {

    public static final LicenseConfigStartDateArgs Empty = new LicenseConfigStartDateArgs();
    ...
    private LicenseConfigStartDateArgs() {}

    private LicenseConfigStartDateArgs(LicenseConfigStartDateArgs $) {
        this.day = $.day;
        this.month = $.month;
        this.year = $.year;
    }
    ...
    public static Builder builder(LicenseConfigStartDateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LicenseConfigStartDateArgs();
        }

        public Builder(LicenseConfigStartDateArgs defaults) {
            $ = new LicenseConfigStartDateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LicenseConfigStartDateArgs build() {
            return $;
        }
    }
