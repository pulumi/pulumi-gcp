...
@CustomType
public final class NetworkFirewallPolicyRuleTargetSecureTag {
    /**
    ...
    private NetworkFirewallPolicyRuleTargetSecureTag() {}
    /**
     * @return Name of the secure tag, created with TagManager&#39;s TagValue API. @pattern tagValues/[0-9]+
     * 
     */
    ...
    public static Builder builder(NetworkFirewallPolicyRuleTargetSecureTag defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(NetworkFirewallPolicyRuleTargetSecureTag defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("NetworkFirewallPolicyRuleTargetSecureTag", "name");
            }
            this.name = name;
            return this;
        }
