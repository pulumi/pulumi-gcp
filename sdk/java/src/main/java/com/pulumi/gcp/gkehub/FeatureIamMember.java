...
import com.pulumi.gcp.gkehub.inputs.FeatureIamMemberState;
import com.pulumi.gcp.gkehub.outputs.FeatureIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:gkehub/featureIamMember:FeatureIamMember editor &#34;projects/{{project}}/locations/{{location}}/features/{{feature}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:gkehub/featureIamMember:FeatureIamMember")
public class FeatureIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={FeatureIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ FeatureIamMemberCondition> condition;

    public Output<Optional<FeatureIamMemberCondition>> condition() {
     ...
     */
    public FeatureIamMember(java.lang.String name) {
        this(name, FeatureIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FeatureIamMember(java.lang.String name, FeatureIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FeatureIamMember(java.lang.String name, FeatureIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/featureIamMember:FeatureIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FeatureIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable FeatureIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/featureIamMember:FeatureIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static FeatureIamMemberArgs makeArgs(FeatureIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FeatureIamMemberArgs.Empty : args;
    }
     ...
     */
    public static FeatureIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable FeatureIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
