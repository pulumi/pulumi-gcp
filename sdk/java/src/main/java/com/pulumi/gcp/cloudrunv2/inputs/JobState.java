...
public final class JobState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Whether Terraform will be prevented from destroying the job. Defaults to true.
     * When a`terraform destroy` or `pulumi up` would delete the job,
     * the command will fail if this field is not set to false in Terraform state.
     * When the field is set to true or unset in Terraform state, a `pulumi up`
     * or `terraform destroy` that would delete the job will fail.
    ...
    public static final class Builder {
        ...
        /**
         * @param deletionProtection Whether Terraform will be prevented from destroying the job. Defaults to true.
         * When a`terraform destroy` or `pulumi up` would delete the job,
         * the command will fail if this field is not set to false in Terraform state.
         * When the field is set to true or unset in Terraform state, a `pulumi up`
         * or `terraform destroy` that would delete the job will fail.
