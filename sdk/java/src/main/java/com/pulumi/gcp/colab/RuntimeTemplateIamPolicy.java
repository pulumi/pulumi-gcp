...
import com.pulumi.gcp.colab.inputs.RuntimeTemplateIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:colab/runtimeTemplateIamPolicy:RuntimeTemplateIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/notebookRuntimeTemplates/{{runtime_template}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:colab/runtimeTemplateIamPolicy:RuntimeTemplateIamPolicy")
public class RuntimeTemplateIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public RuntimeTemplateIamPolicy(java.lang.String name) {
        this(name, RuntimeTemplateIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RuntimeTemplateIamPolicy(java.lang.String name, RuntimeTemplateIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RuntimeTemplateIamPolicy(java.lang.String name, RuntimeTemplateIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:colab/runtimeTemplateIamPolicy:RuntimeTemplateIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RuntimeTemplateIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable RuntimeTemplateIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:colab/runtimeTemplateIamPolicy:RuntimeTemplateIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static RuntimeTemplateIamPolicyArgs makeArgs(RuntimeTemplateIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RuntimeTemplateIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static RuntimeTemplateIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable RuntimeTemplateIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
