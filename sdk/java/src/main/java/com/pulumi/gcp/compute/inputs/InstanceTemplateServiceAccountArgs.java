...
public final class InstanceTemplateServiceAccountArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceTemplateServiceAccountArgs(InstanceTemplateServiceAccountArgs $) {
        this.email = $.email;
        this.scopes = $.scopes;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceTemplateServiceAccountArgs();
        }

        public Builder(InstanceTemplateServiceAccountArgs defaults) {
            $ = new InstanceTemplateServiceAccountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceTemplateServiceAccountArgs build() {
            if ($.scopes == null) {
                throw new MissingRequiredPropertyException("InstanceTemplateServiceAccountArgs", "scopes");
            }
            return $;
        }
    }
