...
@CustomType
public final class ListingSubscriptionLinkedDatasetMap {
    /**
     * @return (Output)
    ...
    public static Builder builder(ListingSubscriptionLinkedDatasetMap defaults) {
    ...
    public static final class Builder {
        ...
        public Builder resourceName(String resourceName) {
            if (resourceName == null) {
              throw new MissingRequiredPropertyException("ListingSubscriptionLinkedDatasetMap", "resourceName");
            }
