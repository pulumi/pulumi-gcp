...
public final class GetJobTemplateTemplateContainerPort {
    ...
    public static Builder builder(GetJobTemplateTemplateContainerPort defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetJobTemplateTemplateContainerPort defaults) {
        ...
        public Builder containerPort(Integer containerPort) {
            if (containerPort == null) {
              throw new MissingRequiredPropertyException("GetJobTemplateTemplateContainerPort", "containerPort");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetJobTemplateTemplateContainerPort", "name");
            }
            this.name = name;
            return this;
        }
