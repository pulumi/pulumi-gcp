...
@CustomType
public final class GetInstanceTemplateDiskSourceImageEncryptionKey {
    /**
    ...
    public static Builder builder(GetInstanceTemplateDiskSourceImageEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private String rsaEncryptedKey;
        public Builder() {}
        public Builder(GetInstanceTemplateDiskSourceImageEncryptionKey defaults) {
        ...
        public Builder kmsKeySelfLink(String kmsKeySelfLink) {
            if (kmsKeySelfLink == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceImageEncryptionKey", "kmsKeySelfLink");
            }
        ...
        public Builder kmsKeyServiceAccount(String kmsKeyServiceAccount) {
            if (kmsKeyServiceAccount == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceImageEncryptionKey", "kmsKeyServiceAccount");
            }
        ...
        public Builder rawKey(String rawKey) {
            if (rawKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceImageEncryptionKey", "rawKey");
            }
            this.rawKey = rawKey;
            return this;
        }
        ...
        public Builder rsaEncryptedKey(String rsaEncryptedKey) {
            if (rsaEncryptedKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceImageEncryptionKey", "rsaEncryptedKey");
            }
            this.rsaEncryptedKey = rsaEncryptedKey;
            return this;
        }
        public GetInstanceTemplateDiskSourceImageEncryptionKey build() {
            final var _resultValue = new GetInstanceTemplateDiskSourceImageEncryptionKey();
