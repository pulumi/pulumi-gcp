...
public final class JobConfigMuxStreamArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobConfigMuxStreamArgs Empty = new JobConfigMuxStreamArgs();
    ...
    private @Nullable Output<JobConfigMuxStreamSegmentSettingsArgs> segmentSettings;
     ...
     * 
     */
    public Optional<Output<JobConfigMuxStreamSegmentSettingsArgs>> segmentSettings() {
        return Optional.ofNullable(this.segmentSettings);
    }

    private JobConfigMuxStreamArgs() {}

    private JobConfigMuxStreamArgs(JobConfigMuxStreamArgs $) {
    ...
    public static Builder builder(JobConfigMuxStreamArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobConfigMuxStreamArgs();
        }

        public Builder(JobConfigMuxStreamArgs defaults) {
            $ = new JobConfigMuxStreamArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder segmentSettings(@Nullable Output<JobConfigMuxStreamSegmentSettingsArgs> segmentSettings) {
         ...
         * 
         */
        public Builder segmentSettings(JobConfigMuxStreamSegmentSettingsArgs segmentSettings) {
            return segmentSettings(Output.of(segmentSettings));
        }

        public JobConfigMuxStreamArgs build() {
            return $;
        }
    }
