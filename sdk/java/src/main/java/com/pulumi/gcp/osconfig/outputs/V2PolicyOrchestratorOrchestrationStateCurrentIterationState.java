...
import com.pulumi.gcp.osconfig.outputs.V2PolicyOrchestratorOrchestrationStateCurrentIterationStateError;
...
@CustomType
public final class V2PolicyOrchestratorOrchestrationStateCurrentIterationState {
    /**
     ...
     * 
     */
    private @Nullable V2PolicyOrchestratorOrchestrationStateCurrentIterationStateError error;
    /**
     * @return (Output)
    ...
    private V2PolicyOrchestratorOrchestrationStateCurrentIterationState() {}
    /**
     * @return The `Status` type defines a logical error model that is suitable for
     * different programming environments, including REST APIs and RPC APIs. It is
     * used by [gRPC](https://github.com/grpc). Each `Status` message contains
     ...
     * 
     */
    public Optional<V2PolicyOrchestratorOrchestrationStateCurrentIterationStateError> error() {
    ...
    public static Builder builder(V2PolicyOrchestratorOrchestrationStateCurrentIterationState defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(V2PolicyOrchestratorOrchestrationStateCurrentIterationState defaults) {
        ...
        @CustomType.Setter
        public Builder error(@Nullable V2PolicyOrchestratorOrchestrationStateCurrentIterationStateError error) {
        ...
        public V2PolicyOrchestratorOrchestrationStateCurrentIterationState build() {
            final var _resultValue = new V2PolicyOrchestratorOrchestrationStateCurrentIterationState();
