...
import com.pulumi.gcp.vertex.inputs.AiFeatureGroupIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:vertex/aiFeatureGroupIamPolicy:AiFeatureGroupIamPolicy editor &#34;projects/{{project}}/locations/{{region}}/featureGroups/{{feature_group}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:vertex/aiFeatureGroupIamPolicy:AiFeatureGroupIamPolicy")
public class AiFeatureGroupIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AiFeatureGroupIamPolicy(java.lang.String name) {
        this(name, AiFeatureGroupIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AiFeatureGroupIamPolicy(java.lang.String name, AiFeatureGroupIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AiFeatureGroupIamPolicy(java.lang.String name, AiFeatureGroupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiFeatureGroupIamPolicy:AiFeatureGroupIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AiFeatureGroupIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable AiFeatureGroupIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiFeatureGroupIamPolicy:AiFeatureGroupIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static AiFeatureGroupIamPolicyArgs makeArgs(AiFeatureGroupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AiFeatureGroupIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static AiFeatureGroupIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable AiFeatureGroupIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
