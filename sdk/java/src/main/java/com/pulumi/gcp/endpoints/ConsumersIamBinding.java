 ...
 * 
 * ```sh
 * $ pulumi import gcp:endpoints/consumersIamBinding:ConsumersIamBinding editor &#34;services/{{service_name}}/consumers/{{consumer_project}} roles/servicemanagement.serviceController user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class ConsumersIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public ConsumersIamBinding(String name, ConsumersIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:endpoints/consumersIamBinding:ConsumersIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
