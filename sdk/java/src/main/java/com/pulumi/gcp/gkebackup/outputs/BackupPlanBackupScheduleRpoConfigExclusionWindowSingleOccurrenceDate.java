...
@CustomType
public final class BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDate {
    /**
    ...
    public static Builder builder(BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDate defaults) {
        ...
        public BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDate build() {
            final var _resultValue = new BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDate();
