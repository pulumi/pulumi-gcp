 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webTypeAppEngingIamBinding:WebTypeAppEngingIamBinding editor &#34;projects/{{project}}/iap_web/appengine-{{appId}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class WebTypeAppEngingIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public WebTypeAppEngingIamBinding(java.lang.String name) {
     ...
     */
    public WebTypeAppEngingIamBinding(java.lang.String name, WebTypeAppEngingIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebTypeAppEngingIamBinding(java.lang.String name, WebTypeAppEngingIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webTypeAppEngingIamBinding:WebTypeAppEngingIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebTypeAppEngingIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable WebTypeAppEngingIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webTypeAppEngingIamBinding:WebTypeAppEngingIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static WebTypeAppEngingIamBindingArgs makeArgs(WebTypeAppEngingIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebTypeAppEngingIamBindingArgs.Empty : args;
    }
     ...
     */
    public static WebTypeAppEngingIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable WebTypeAppEngingIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
