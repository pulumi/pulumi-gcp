...
@CustomType
public final class CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText {
    /**
     * @return (Output)
    ...
    public static Builder builder(CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String text;
        public Builder() {}
        public Builder(CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText defaults) {
        ...
        public CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText build() {
            final var _resultValue = new CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText();
