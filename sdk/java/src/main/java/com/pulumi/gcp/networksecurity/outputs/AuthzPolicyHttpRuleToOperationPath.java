...
@CustomType
public final class AuthzPolicyHttpRuleToOperationPath {
    /**
    ...
    private AuthzPolicyHttpRuleToOperationPath() {}
    /**
     * @return The input string must have the substring specified here. Note: empty contains match is not allowed, please use regex instead.
     * Examples:
     * * abc matches the value xyz.abc.def
    ...
    public static Builder builder(AuthzPolicyHttpRuleToOperationPath defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleToOperationPath defaults) {
        ...
        public AuthzPolicyHttpRuleToOperationPath build() {
            final var _resultValue = new AuthzPolicyHttpRuleToOperationPath();
