...
public final class SecurityPolicyRuleRateLimitOptionsRateLimitThreshold {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("SecurityPolicyRuleRateLimitOptionsRateLimitThreshold", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder intervalSec(Integer intervalSec) {
            if (intervalSec == null) {
              throw new MissingRequiredPropertyException("SecurityPolicyRuleRateLimitOptionsRateLimitThreshold", "intervalSec");
            }
            this.intervalSec = intervalSec;
            return this;
        }
        public SecurityPolicyRuleRateLimitOptionsRateLimitThreshold build() {
            final var _resultValue = new SecurityPolicyRuleRateLimitOptionsRateLimitThreshold();
