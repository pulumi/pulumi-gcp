...
import com.pulumi.gcp.biglake.inputs.HiveDatabaseIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveDatabaseIamPolicy:HiveDatabaseIamPolicy")
public class HiveDatabaseIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public HiveDatabaseIamPolicy(java.lang.String name) {
        this(name, HiveDatabaseIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveDatabaseIamPolicy(java.lang.String name, HiveDatabaseIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveDatabaseIamPolicy(java.lang.String name, HiveDatabaseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveDatabaseIamPolicy:HiveDatabaseIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveDatabaseIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable HiveDatabaseIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveDatabaseIamPolicy:HiveDatabaseIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveDatabaseIamPolicyArgs makeArgs(HiveDatabaseIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveDatabaseIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static HiveDatabaseIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveDatabaseIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
