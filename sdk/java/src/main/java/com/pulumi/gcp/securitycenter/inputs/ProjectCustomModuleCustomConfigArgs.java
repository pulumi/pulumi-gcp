...
public final class ProjectCustomModuleCustomConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectCustomModuleCustomConfigArgs Empty = new ProjectCustomModuleCustomConfigArgs();
    ...
    private @Nullable Output<ProjectCustomModuleCustomConfigCustomOutputArgs> customOutput;
     ...
     * 
     */
    public Optional<Output<ProjectCustomModuleCustomConfigCustomOutputArgs>> customOutput() {
    ...
    private Output<ProjectCustomModuleCustomConfigPredicateArgs> predicate;
     ...
     * 
     */
    public Output<ProjectCustomModuleCustomConfigPredicateArgs> predicate() {
    ...
    private Output<ProjectCustomModuleCustomConfigResourceSelectorArgs> resourceSelector;
     ...
     * 
     */
    public Output<ProjectCustomModuleCustomConfigResourceSelectorArgs> resourceSelector() {
    ...
    private ProjectCustomModuleCustomConfigArgs() {}

    private ProjectCustomModuleCustomConfigArgs(ProjectCustomModuleCustomConfigArgs $) {
    ...
    public static Builder builder(ProjectCustomModuleCustomConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectCustomModuleCustomConfigArgs();
        }

        public Builder(ProjectCustomModuleCustomConfigArgs defaults) {
            $ = new ProjectCustomModuleCustomConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customOutput(@Nullable Output<ProjectCustomModuleCustomConfigCustomOutputArgs> customOutput) {
         ...
         * 
         */
        public Builder customOutput(ProjectCustomModuleCustomConfigCustomOutputArgs customOutput) {
         ...
         * 
         */
        public Builder predicate(Output<ProjectCustomModuleCustomConfigPredicateArgs> predicate) {
            $.predicate = predicate;
            return this;
        }
         ...
         * 
         */
        public Builder predicate(ProjectCustomModuleCustomConfigPredicateArgs predicate) {
         ...
         * 
         */
        public Builder resourceSelector(Output<ProjectCustomModuleCustomConfigResourceSelectorArgs> resourceSelector) {
         ...
         * 
         */
        public Builder resourceSelector(ProjectCustomModuleCustomConfigResourceSelectorArgs resourceSelector) {
        ...
        public ProjectCustomModuleCustomConfigArgs build() {
            if ($.predicate == null) {
                throw new MissingRequiredPropertyException("ProjectCustomModuleCustomConfigArgs", "predicate");
            }
            if ($.recommendation == null) {
                throw new MissingRequiredPropertyException("ProjectCustomModuleCustomConfigArgs", "recommendation");
            }
            if ($.resourceSelector == null) {
                throw new MissingRequiredPropertyException("ProjectCustomModuleCustomConfigArgs", "resourceSelector");
            }
            if ($.severity == null) {
                throw new MissingRequiredPropertyException("ProjectCustomModuleCustomConfigArgs", "severity");
            }
            return $;
        }
    }
