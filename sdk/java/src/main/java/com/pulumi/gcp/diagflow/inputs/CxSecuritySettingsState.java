...
public final class CxSecuritySettingsState extends com.pulumi.resources.ResourceArgs {

    public static final CxSecuritySettingsState Empty = new CxSecuritySettingsState();
    ...
    private CxSecuritySettingsState() {}

    private CxSecuritySettingsState(CxSecuritySettingsState $) {
    ...
    public static Builder builder(CxSecuritySettingsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxSecuritySettingsState();
        }

        public Builder(CxSecuritySettingsState defaults) {
            $ = new CxSecuritySettingsState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name The unique identifier of the settings.
         * Format: projects/&lt;Project ID&gt;/locations/&lt;Location ID&gt;/securitySettings/&lt;Security Settings ID&gt;.
         * 
         * @return builder
         * 
        ...
        public CxSecuritySettingsState build() {
            return $;
        }
    }
