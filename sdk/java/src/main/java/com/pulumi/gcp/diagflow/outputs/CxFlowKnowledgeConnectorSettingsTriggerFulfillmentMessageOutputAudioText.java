...
@CustomType
public final class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText {
    /**
     * @return (Output)
    ...
    private CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String text;
        public Builder() {}
        public Builder(CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText defaults) {
        ...
        public CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText build() {
            final var _resultValue = new CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageOutputAudioText();
