...
@CustomType
public final class ClusterNodeConfigReservationAffinity {
    /**
    ...
    private ClusterNodeConfigReservationAffinity() {}
    /**
     * @return The type of reservation consumption
     * Accepted values are:
     * 
    ...
    public static Builder builder(ClusterNodeConfigReservationAffinity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(ClusterNodeConfigReservationAffinity defaults) {
        ...
        public Builder consumeReservationType(String consumeReservationType) {
            if (consumeReservationType == null) {
              throw new MissingRequiredPropertyException("ClusterNodeConfigReservationAffinity", "consumeReservationType");
            }
