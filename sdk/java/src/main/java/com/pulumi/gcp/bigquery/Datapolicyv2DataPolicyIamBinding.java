...
import com.pulumi.gcp.bigquery.inputs.Datapolicyv2DataPolicyIamBindingState;
import com.pulumi.gcp.bigquery.outputs.Datapolicyv2DataPolicyIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:bigquery/datapolicyv2DataPolicyIamBinding:Datapolicyv2DataPolicyIamBinding editor &#34;projects/{{project}}/locations/{{location}}/dataPolicies/{{data_policy_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:bigquery/datapolicyv2DataPolicyIamBinding:Datapolicyv2DataPolicyIamBinding")
public class Datapolicyv2DataPolicyIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={Datapolicyv2DataPolicyIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ Datapolicyv2DataPolicyIamBindingCondition> condition;

    public Output<Optional<Datapolicyv2DataPolicyIamBindingCondition>> condition() {
     ...
     */
    public Datapolicyv2DataPolicyIamBinding(java.lang.String name) {
        this(name, Datapolicyv2DataPolicyIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public Datapolicyv2DataPolicyIamBinding(java.lang.String name, Datapolicyv2DataPolicyIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Datapolicyv2DataPolicyIamBinding(java.lang.String name, Datapolicyv2DataPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/datapolicyv2DataPolicyIamBinding:Datapolicyv2DataPolicyIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Datapolicyv2DataPolicyIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable Datapolicyv2DataPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/datapolicyv2DataPolicyIamBinding:Datapolicyv2DataPolicyIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static Datapolicyv2DataPolicyIamBindingArgs makeArgs(Datapolicyv2DataPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? Datapolicyv2DataPolicyIamBindingArgs.Empty : args;
    }
     ...
     */
    public static Datapolicyv2DataPolicyIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable Datapolicyv2DataPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
