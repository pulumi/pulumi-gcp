...
@CustomType
public final class LicenseConfigStartDate {
    /**
    ...
    public static Builder builder(LicenseConfigStartDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(LicenseConfigStartDate defaults) {
        ...
        public LicenseConfigStartDate build() {
            final var _resultValue = new LicenseConfigStartDate();
