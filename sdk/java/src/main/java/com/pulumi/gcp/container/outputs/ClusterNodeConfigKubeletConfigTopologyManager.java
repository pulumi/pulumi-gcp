...
@CustomType
public final class ClusterNodeConfigKubeletConfigTopologyManager {
    /**
    ...
    public static Builder builder(ClusterNodeConfigKubeletConfigTopologyManager defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scope;
        public Builder() {}
        public Builder(ClusterNodeConfigKubeletConfigTopologyManager defaults) {
        ...
        public ClusterNodeConfigKubeletConfigTopologyManager build() {
            final var _resultValue = new ClusterNodeConfigKubeletConfigTopologyManager();
