...
@CustomType
public final class ServiceStatusTraffic {
    /**
    ...
    public static Builder builder(ServiceStatusTraffic defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String url;
        public Builder() {}
        public Builder(ServiceStatusTraffic defaults) {
        ...
        public ServiceStatusTraffic build() {
            final var _resultValue = new ServiceStatusTraffic();
