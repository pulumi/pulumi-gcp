...
public final class BillingAccountSinkExclusionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BillingAccountSinkExclusionArgs build() {
            if ($.filter == null) {
                throw new MissingRequiredPropertyException("BillingAccountSinkExclusionArgs", "filter");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("BillingAccountSinkExclusionArgs", "name");
            }
            return $;
        }
    }
