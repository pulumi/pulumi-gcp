...
import com.pulumi.gcp.networkconnectivity.inputs.HubIamMemberState;
import com.pulumi.gcp.networkconnectivity.outputs.HubIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:networkconnectivity/hubIamMember:HubIamMember")
public class HubIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={HubIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ HubIamMemberCondition> condition;

    public Output<Optional<HubIamMemberCondition>> condition() {
     ...
     */
    public HubIamMember(java.lang.String name) {
        this(name, HubIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HubIamMember(java.lang.String name, HubIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HubIamMember(java.lang.String name, HubIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networkconnectivity/hubIamMember:HubIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HubIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable HubIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networkconnectivity/hubIamMember:HubIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static HubIamMemberArgs makeArgs(HubIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HubIamMemberArgs.Empty : args;
    }
     ...
     */
    public static HubIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable HubIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
