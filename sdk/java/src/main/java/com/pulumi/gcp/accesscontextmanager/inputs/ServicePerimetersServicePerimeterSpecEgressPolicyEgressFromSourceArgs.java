...
import com.pulumi.gcp.accesscontextmanager.inputs.ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpointArgs;
...
public final class ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpointArgs> pscEndpoint;
     ...
     * 
     */
    public Optional<Output<ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpointArgs>> pscEndpoint() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder pscEndpoint(@Nullable Output<ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpointArgs> pscEndpoint) {
         ...
         * 
         */
        public Builder pscEndpoint(ServicePerimetersServicePerimeterSpecEgressPolicyEgressFromSourcePscEndpointArgs pscEndpoint) {
