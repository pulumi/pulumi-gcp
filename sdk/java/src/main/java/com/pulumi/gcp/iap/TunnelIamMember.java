 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/tunnelIamMember:TunnelIamMember editor &#34;projects/{{project}}/iap_tunnel roles/iap.tunnelResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TunnelIamMember extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={TunnelIamMemberCondition.class}, tree="[0]")
     ...
     */
    public TunnelIamMember(java.lang.String name) {
     ...
     */
    public TunnelIamMember(java.lang.String name, TunnelIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TunnelIamMember(java.lang.String name, TunnelIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelIamMember:TunnelIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TunnelIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelIamMember:TunnelIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static TunnelIamMemberArgs makeArgs(TunnelIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TunnelIamMemberArgs.Empty : args;
    }
     ...
     */
    public static TunnelIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
