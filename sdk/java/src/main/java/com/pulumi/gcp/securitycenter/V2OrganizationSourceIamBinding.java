...
import com.pulumi.gcp.securitycenter.inputs.V2OrganizationSourceIamBindingState;
import com.pulumi.gcp.securitycenter.outputs.V2OrganizationSourceIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:securitycenter/v2OrganizationSourceIamBinding:V2OrganizationSourceIamBinding editor &#34;organizations/{{organization}}/sources/{{source}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:securitycenter/v2OrganizationSourceIamBinding:V2OrganizationSourceIamBinding")
public class V2OrganizationSourceIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={V2OrganizationSourceIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ V2OrganizationSourceIamBindingCondition> condition;

    public Output<Optional<V2OrganizationSourceIamBindingCondition>> condition() {
     ...
     */
    public V2OrganizationSourceIamBinding(java.lang.String name) {
        this(name, V2OrganizationSourceIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public V2OrganizationSourceIamBinding(java.lang.String name, V2OrganizationSourceIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public V2OrganizationSourceIamBinding(java.lang.String name, V2OrganizationSourceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2OrganizationSourceIamBinding:V2OrganizationSourceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private V2OrganizationSourceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable V2OrganizationSourceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2OrganizationSourceIamBinding:V2OrganizationSourceIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static V2OrganizationSourceIamBindingArgs makeArgs(V2OrganizationSourceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? V2OrganizationSourceIamBindingArgs.Empty : args;
    }
     ...
     */
    public static V2OrganizationSourceIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable V2OrganizationSourceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
