...
@CustomType
public final class ConnectionSslConfigClientCertificate {
    /**
    ...
    private ConnectionSslConfigClientCertificate() {}
    /**
     * @return Secret version of Secret Value for Config variable.
     * 
     */
    ...
    public static Builder builder(ConnectionSslConfigClientCertificate defaults) {
    ...
    public static final class Builder {
        private String secretVersion;
        public Builder() {}
        public Builder(ConnectionSslConfigClientCertificate defaults) {
        ...
        public ConnectionSslConfigClientCertificate build() {
            final var _resultValue = new ConnectionSslConfigClientCertificate();
