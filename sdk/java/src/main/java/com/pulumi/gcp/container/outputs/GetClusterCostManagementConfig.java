...
public final class GetClusterCostManagementConfig {
    ...
    public static Builder builder(GetClusterCostManagementConfig defaults) {
    ...
    public static final class Builder {
        private Boolean enabled;
        public Builder() {}
        public Builder(GetClusterCostManagementConfig defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetClusterCostManagementConfig", "enabled");
            }
