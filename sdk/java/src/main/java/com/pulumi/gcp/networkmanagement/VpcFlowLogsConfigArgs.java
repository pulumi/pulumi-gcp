...
public final class VpcFlowLogsConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final VpcFlowLogsConfigArgs Empty = new VpcFlowLogsConfigArgs();
    ...
    private VpcFlowLogsConfigArgs() {}

    private VpcFlowLogsConfigArgs(VpcFlowLogsConfigArgs $) {
    ...
    public static Builder builder(VpcFlowLogsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpcFlowLogsConfigArgs();
        }

        public Builder(VpcFlowLogsConfigArgs defaults) {
            $ = new VpcFlowLogsConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VpcFlowLogsConfigArgs build() {
            if ($.location == null) {
                throw new MissingRequiredPropertyException("VpcFlowLogsConfigArgs", "location");
            }
            if ($.vpcFlowLogsConfigId == null) {
                throw new MissingRequiredPropertyException("VpcFlowLogsConfigArgs", "vpcFlowLogsConfigId");
            }
            return $;
        }
    }
