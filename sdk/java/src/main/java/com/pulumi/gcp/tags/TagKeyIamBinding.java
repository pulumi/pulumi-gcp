 ...
 * 
 * ```sh
 * $ pulumi import gcp:tags/tagKeyIamBinding:TagKeyIamBinding editor &#34;tagKeys/{{tag_key}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TagKeyIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={TagKeyIamBindingCondition.class}, tree="[0]")
     ...
     */
    public TagKeyIamBinding(java.lang.String name) {
     ...
     */
    public TagKeyIamBinding(java.lang.String name, TagKeyIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TagKeyIamBinding(java.lang.String name, TagKeyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:tags/tagKeyIamBinding:TagKeyIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TagKeyIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable TagKeyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:tags/tagKeyIamBinding:TagKeyIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TagKeyIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable TagKeyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
