 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webTypeComputeIamBinding:WebTypeComputeIamBinding editor &#34;projects/{{project}}/iap_web/compute roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class WebTypeComputeIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public WebTypeComputeIamBinding(java.lang.String name) {
     ...
     */
    public WebTypeComputeIamBinding(java.lang.String name, WebTypeComputeIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebTypeComputeIamBinding(java.lang.String name, WebTypeComputeIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webTypeComputeIamBinding:WebTypeComputeIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebTypeComputeIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable WebTypeComputeIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webTypeComputeIamBinding:WebTypeComputeIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static WebTypeComputeIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable WebTypeComputeIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
