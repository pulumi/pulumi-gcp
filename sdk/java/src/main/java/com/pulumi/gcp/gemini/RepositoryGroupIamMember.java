...
import com.pulumi.gcp.gemini.inputs.RepositoryGroupIamMemberState;
import com.pulumi.gcp.gemini.outputs.RepositoryGroupIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:gemini/repositoryGroupIamMember:RepositoryGroupIamMember editor &#34;projects/{{project}}/locations/{{location}}/codeRepositoryIndexes/{{code_repository_index}}/repositoryGroups/{{repository_group_id}} roles/cloudaicompanion.repositoryGroupsUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class RepositoryGroupIamMember extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="condition", refs={RepositoryGroupIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ RepositoryGroupIamMemberCondition> condition;

    public Output<Optional<RepositoryGroupIamMemberCondition>> condition() {
     ...
     */
    public RepositoryGroupIamMember(java.lang.String name) {
        this(name, RepositoryGroupIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RepositoryGroupIamMember(java.lang.String name, RepositoryGroupIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RepositoryGroupIamMember(java.lang.String name, RepositoryGroupIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/repositoryGroupIamMember:RepositoryGroupIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RepositoryGroupIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryGroupIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/repositoryGroupIamMember:RepositoryGroupIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static RepositoryGroupIamMemberArgs makeArgs(RepositoryGroupIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RepositoryGroupIamMemberArgs.Empty : args;
    }
     ...
     */
    public static RepositoryGroupIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryGroupIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
