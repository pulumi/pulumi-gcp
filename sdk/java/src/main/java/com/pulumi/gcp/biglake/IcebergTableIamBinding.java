...
import com.pulumi.gcp.biglake.inputs.IcebergTableIamBindingState;
import com.pulumi.gcp.biglake.outputs.IcebergTableIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/icebergTableIamBinding:IcebergTableIamBinding")
public class IcebergTableIamBinding extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={IcebergTableIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ IcebergTableIamBindingCondition> condition;

    public Output<Optional<IcebergTableIamBindingCondition>> condition() {
     ...
     */
    public IcebergTableIamBinding(java.lang.String name) {
        this(name, IcebergTableIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IcebergTableIamBinding(java.lang.String name, IcebergTableIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IcebergTableIamBinding(java.lang.String name, IcebergTableIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergTableIamBinding:IcebergTableIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IcebergTableIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergTableIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergTableIamBinding:IcebergTableIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static IcebergTableIamBindingArgs makeArgs(IcebergTableIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IcebergTableIamBindingArgs.Empty : args;
    }
     ...
     */
    public static IcebergTableIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergTableIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new IcebergTableIamBinding(name, id, state, options);
    }
}
