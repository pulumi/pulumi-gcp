...
@CustomType
public final class PreventionContentPolicyInspectConfigRuleSetRuleHotwordRuleProximity {
    /**
    ...
    public static Builder builder(PreventionContentPolicyInspectConfigRuleSetRuleHotwordRuleProximity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer windowBefore;
        public Builder() {}
        public Builder(PreventionContentPolicyInspectConfigRuleSetRuleHotwordRuleProximity defaults) {
        ...
        public PreventionContentPolicyInspectConfigRuleSetRuleHotwordRuleProximity build() {
            final var _resultValue = new PreventionContentPolicyInspectConfigRuleSetRuleHotwordRuleProximity();
