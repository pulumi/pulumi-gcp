...
public final class NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs extends com.pulumi.resources.ResourceArgs {

    public static final NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs Empty = new NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs();
    ...
    private NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs() {}

    private NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs(NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs $) {
    ...
    public static Builder builder(NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs();
        }

        public Builder(NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs defaults) {
            $ = new NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param imagefsAvailable Defines percentage of minimum reclaim for imagefs.available.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param imagefsInodesFree Defines percentage of minimum reclaim for imagefs.inodesFree.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param memoryAvailable Defines percentage of minimum reclaim for memory.available.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodefsAvailable Defines percentage of minimum reclaim for nodefs.available.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param nodefsInodesFree Defines percentage of minimum reclaim for nodefs.inodesFree.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param pidAvailable Defines percentage of minimum reclaim for pid.available.
         * 
         * @return builder
         * 
         */
        ...
        public NodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs build() {
            return $;
        }
    }
