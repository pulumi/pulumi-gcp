...
public final class UnitKindInputVariableMappingToArgs extends com.pulumi.resources.ResourceArgs {

    public static final UnitKindInputVariableMappingToArgs Empty = new UnitKindInputVariableMappingToArgs();
    ...
    private UnitKindInputVariableMappingToArgs() {}

    private UnitKindInputVariableMappingToArgs(UnitKindInputVariableMappingToArgs $) {
    ...
    public static Builder builder(UnitKindInputVariableMappingToArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UnitKindInputVariableMappingToArgs();
        }

        public Builder(UnitKindInputVariableMappingToArgs defaults) {
            $ = new UnitKindInputVariableMappingToArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UnitKindInputVariableMappingToArgs build() {
            if ($.dependency == null) {
                throw new MissingRequiredPropertyException("UnitKindInputVariableMappingToArgs", "dependency");
            }
            if ($.inputVariable == null) {
                throw new MissingRequiredPropertyException("UnitKindInputVariableMappingToArgs", "inputVariable");
            }
            return $;
        }
    }
