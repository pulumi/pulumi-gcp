 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webIamBinding:WebIamBinding editor &#34;projects/{{project}}/iap_web roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class WebIamBinding extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={WebIamBindingCondition.class}, tree="[0]")
     ...
     */
    public WebIamBinding(java.lang.String name) {
     ...
     */
    public WebIamBinding(java.lang.String name, WebIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebIamBinding(java.lang.String name, WebIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webIamBinding:WebIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable WebIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webIamBinding:WebIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static WebIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable WebIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
