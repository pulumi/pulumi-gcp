    ...
    public static final class Builder {
        ...
        public MachineImageIamMemberArgs build() {
            if ($.machineImage == null) {
                throw new MissingRequiredPropertyException("MachineImageIamMemberArgs", "machineImage");
            }
            if ($.member == null) {
                throw new MissingRequiredPropertyException("MachineImageIamMemberArgs", "member");
            }
            if ($.role == null) {
                throw new MissingRequiredPropertyException("MachineImageIamMemberArgs", "role");
            }
            return $;
        }
    }
