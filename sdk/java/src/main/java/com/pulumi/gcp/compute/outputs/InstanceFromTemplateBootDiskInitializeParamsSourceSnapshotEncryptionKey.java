...
@CustomType
public final class InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey {
    /**
    ...
    private InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey() {}
    /**
     * @return The self link of the encryption key that is stored in Google Cloud KMS. Only one of kms_key_self_link, rsaEncryptedKey and rawKey may be set.
     * 
     */
    ...
    public static Builder builder(InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sha256;
        public Builder() {}
        public Builder(InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey defaults) {
        ...
        public InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey build() {
            final var _resultValue = new InstanceFromTemplateBootDiskInitializeParamsSourceSnapshotEncryptionKey();
