...
@CustomType
public final class InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate {
    /**
    ...
    public static Builder builder(InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate defaults) {
        ...
        public InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate build() {
            final var _resultValue = new InstanceMaintenancePolicyMaintenanceExclusionWindowEndDate();
