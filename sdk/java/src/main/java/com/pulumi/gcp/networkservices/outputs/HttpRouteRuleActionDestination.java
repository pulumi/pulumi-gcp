...
@CustomType
public final class HttpRouteRuleActionDestination {
    /**
    ...
    private HttpRouteRuleActionDestination() {}
    /**
     * @return The URL of a BackendService to route traffic to.
     * 
     */
    ...
    public static Builder builder(HttpRouteRuleActionDestination defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer weight;
        public Builder() {}
        public Builder(HttpRouteRuleActionDestination defaults) {
