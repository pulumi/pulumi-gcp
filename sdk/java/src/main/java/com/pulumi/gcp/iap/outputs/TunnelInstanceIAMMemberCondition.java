...
public final class TunnelInstanceIAMMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("TunnelInstanceIAMMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("TunnelInstanceIAMMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public TunnelInstanceIAMMemberCondition build() {
            final var _resultValue = new TunnelInstanceIAMMemberCondition();
