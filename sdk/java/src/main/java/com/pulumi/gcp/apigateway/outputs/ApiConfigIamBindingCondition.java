...
public final class ApiConfigIamBindingCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("ApiConfigIamBindingCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("ApiConfigIamBindingCondition", "title");
            }
            this.title = title;
            return this;
        }
        public ApiConfigIamBindingCondition build() {
            final var _resultValue = new ApiConfigIamBindingCondition();
