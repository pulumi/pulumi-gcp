...
import com.pulumi.gcp.iap.inputs.WebRegionForwardingRuleServiceIamBindingState;
import com.pulumi.gcp.iap.outputs.WebRegionForwardingRuleServiceIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webRegionForwardingRuleServiceIamBinding:WebRegionForwardingRuleServiceIamBinding editor &#34;projects/{{project}}/iap_web/forwarding_rule-{{region}}/services/{{web_region_forwarding_rule_service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/webRegionForwardingRuleServiceIamBinding:WebRegionForwardingRuleServiceIamBinding")
public class WebRegionForwardingRuleServiceIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={WebRegionForwardingRuleServiceIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ WebRegionForwardingRuleServiceIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<WebRegionForwardingRuleServiceIamBindingCondition>> condition() {
     ...
     */
    public WebRegionForwardingRuleServiceIamBinding(java.lang.String name) {
        this(name, WebRegionForwardingRuleServiceIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebRegionForwardingRuleServiceIamBinding(java.lang.String name, WebRegionForwardingRuleServiceIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebRegionForwardingRuleServiceIamBinding(java.lang.String name, WebRegionForwardingRuleServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webRegionForwardingRuleServiceIamBinding:WebRegionForwardingRuleServiceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebRegionForwardingRuleServiceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable WebRegionForwardingRuleServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webRegionForwardingRuleServiceIamBinding:WebRegionForwardingRuleServiceIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static WebRegionForwardingRuleServiceIamBindingArgs makeArgs(WebRegionForwardingRuleServiceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebRegionForwardingRuleServiceIamBindingArgs.Empty : args;
    }
     ...
     */
    public static WebRegionForwardingRuleServiceIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable WebRegionForwardingRuleServiceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new WebRegionForwardingRuleServiceIamBinding(name, id, state, options);
    }
}
