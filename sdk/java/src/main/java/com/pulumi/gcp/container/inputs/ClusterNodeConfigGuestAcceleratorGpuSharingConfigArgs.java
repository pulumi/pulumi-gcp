...
public final class ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs Empty = new ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs();
    ...
    private ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs() {}

    private ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs(ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs $) {
    ...
    public static Builder builder(ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs();
        }

        public Builder(ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs defaults) {
            $ = new ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs build() {
            if ($.gpuSharingStrategy == null) {
                throw new MissingRequiredPropertyException("ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs", "gpuSharingStrategy");
            }
            if ($.maxSharedClientsPerGpu == null) {
                throw new MissingRequiredPropertyException("ClusterNodeConfigGuestAcceleratorGpuSharingConfigArgs", "maxSharedClientsPerGpu");
            }
            return $;
        }
    }
