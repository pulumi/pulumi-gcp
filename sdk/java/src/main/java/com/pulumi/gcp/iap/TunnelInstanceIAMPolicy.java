 ...
 * ```sh
 * $ terraform import google_iap_tunnel_instance_iam_member.editor &#34;projects/{{project}}/iap_tunnel/zones/{{zone}}/instances/{{tunnel_instance}} roles/iap.tunnelResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
