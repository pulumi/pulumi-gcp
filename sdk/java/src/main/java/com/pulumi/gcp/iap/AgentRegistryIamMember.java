...
import com.pulumi.gcp.iap.inputs.AgentRegistryIamMemberState;
import com.pulumi.gcp.iap.outputs.AgentRegistryIamMemberCondition;
 ...
 * ```sh
 * $ terraform import google_iap_agent_registry_iam_member.editor &#34;projects/{{project}}/locations/{{location}}/iap_web/agentRegistry roles/iap.egressor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryIamMember:AgentRegistryIamMember")
public class AgentRegistryIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={AgentRegistryIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ AgentRegistryIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<AgentRegistryIamMemberCondition>> condition() {
     ...
     * `gcp.iap.AgentRegistryIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
     ...
     */
    public AgentRegistryIamMember(java.lang.String name) {
        this(name, AgentRegistryIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryIamMember(java.lang.String name, AgentRegistryIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryIamMember(java.lang.String name, AgentRegistryIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryIamMember:AgentRegistryIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryIamMember:AgentRegistryIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryIamMemberArgs makeArgs(AgentRegistryIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryIamMemberArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new AgentRegistryIamMember(name, id, state, options);
    }
}
