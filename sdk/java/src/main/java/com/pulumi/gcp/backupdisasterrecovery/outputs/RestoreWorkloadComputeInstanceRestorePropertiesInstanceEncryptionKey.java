...
@CustomType
public final class RestoreWorkloadComputeInstanceRestorePropertiesInstanceEncryptionKey {
    /**
     * @return (Optional)
     * 
     */
    ...
    public static Builder builder(RestoreWorkloadComputeInstanceRestorePropertiesInstanceEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rsaEncryptedKey;
        public Builder() {}
        public Builder(RestoreWorkloadComputeInstanceRestorePropertiesInstanceEncryptionKey defaults) {
        ...
        public RestoreWorkloadComputeInstanceRestorePropertiesInstanceEncryptionKey build() {
            final var _resultValue = new RestoreWorkloadComputeInstanceRestorePropertiesInstanceEncryptionKey();
