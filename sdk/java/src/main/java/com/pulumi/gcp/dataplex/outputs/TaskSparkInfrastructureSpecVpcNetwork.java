...
@CustomType
public final class TaskSparkInfrastructureSpecVpcNetwork {
    /**
    ...
    public static Builder builder(TaskSparkInfrastructureSpecVpcNetwork defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subNetwork;
        public Builder() {}
        public Builder(TaskSparkInfrastructureSpecVpcNetwork defaults) {
