...
@CustomType
public final class VMwareClusterFleet {
    /**
     * @return (Output)
    ...
    public static Builder builder(VMwareClusterFleet defaults) {
    ...
    public static final class Builder {
        private @Nullable String membership;
        public Builder() {}
        public Builder(VMwareClusterFleet defaults) {
