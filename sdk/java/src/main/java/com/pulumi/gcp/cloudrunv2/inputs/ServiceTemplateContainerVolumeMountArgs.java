...
public final class ServiceTemplateContainerVolumeMountArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceTemplateContainerVolumeMountArgs Empty = new ServiceTemplateContainerVolumeMountArgs();
    ...
    private ServiceTemplateContainerVolumeMountArgs() {}

    private ServiceTemplateContainerVolumeMountArgs(ServiceTemplateContainerVolumeMountArgs $) {
    ...
    public static Builder builder(ServiceTemplateContainerVolumeMountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ServiceTemplateContainerVolumeMountArgs defaults) {
            $ = new ServiceTemplateContainerVolumeMountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceTemplateContainerVolumeMountArgs build() {
            if ($.mountPath == null) {
                throw new MissingRequiredPropertyException("ServiceTemplateContainerVolumeMountArgs", "mountPath");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ServiceTemplateContainerVolumeMountArgs", "name");
            }
            return $;
        }
    }
