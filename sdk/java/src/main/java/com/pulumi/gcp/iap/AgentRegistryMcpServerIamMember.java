...
import com.pulumi.gcp.iap.inputs.AgentRegistryMcpServerIamMemberState;
import com.pulumi.gcp.iap.outputs.AgentRegistryMcpServerIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryMcpServerIamMember:AgentRegistryMcpServerIamMember")
public class AgentRegistryMcpServerIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={AgentRegistryMcpServerIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ AgentRegistryMcpServerIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<AgentRegistryMcpServerIamMemberCondition>> condition() {
     ...
     */
    public AgentRegistryMcpServerIamMember(java.lang.String name) {
        this(name, AgentRegistryMcpServerIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryMcpServerIamMember(java.lang.String name, AgentRegistryMcpServerIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryMcpServerIamMember(java.lang.String name, AgentRegistryMcpServerIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryMcpServerIamMember:AgentRegistryMcpServerIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryMcpServerIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryMcpServerIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryMcpServerIamMember:AgentRegistryMcpServerIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryMcpServerIamMemberArgs makeArgs(AgentRegistryMcpServerIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryMcpServerIamMemberArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryMcpServerIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryMcpServerIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
