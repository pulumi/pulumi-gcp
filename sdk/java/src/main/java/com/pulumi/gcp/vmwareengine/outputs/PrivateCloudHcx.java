...
@CustomType
public final class PrivateCloudHcx {
    /**
    ...
    public static Builder builder(PrivateCloudHcx defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(PrivateCloudHcx defaults) {
        ...
        public PrivateCloudHcx build() {
            final var _resultValue = new PrivateCloudHcx();
