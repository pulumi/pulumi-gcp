...
public final class BackendServiceOutlierDetectionInterval {
    ...
    public static final class Builder {
        ...
        public Builder seconds(Integer seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("BackendServiceOutlierDetectionInterval", "seconds");
            }
            this.seconds = seconds;
            return this;
        }
        public BackendServiceOutlierDetectionInterval build() {
            final var _resultValue = new BackendServiceOutlierDetectionInterval();
