...
import com.pulumi.gcp.dataplex.inputs.AspectTypeIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/aspectTypeIamPolicy:AspectTypeIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/aspectTypes/{{aspect_type_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataplex/aspectTypeIamPolicy:AspectTypeIamPolicy")
public class AspectTypeIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AspectTypeIamPolicy(java.lang.String name) {
        this(name, AspectTypeIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AspectTypeIamPolicy(java.lang.String name, AspectTypeIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AspectTypeIamPolicy(java.lang.String name, AspectTypeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/aspectTypeIamPolicy:AspectTypeIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AspectTypeIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable AspectTypeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/aspectTypeIamPolicy:AspectTypeIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static AspectTypeIamPolicyArgs makeArgs(AspectTypeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AspectTypeIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static AspectTypeIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable AspectTypeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
