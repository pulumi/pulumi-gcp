...
public class AspectTypeIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public AspectTypeIamPolicy(String name) {
     ...
     */
    public AspectTypeIamPolicy(String name, AspectTypeIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AspectTypeIamPolicy(String name, AspectTypeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/aspectTypeIamPolicy:AspectTypeIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private AspectTypeIamPolicy(String name, Output<String> id, @Nullable AspectTypeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/aspectTypeIamPolicy:AspectTypeIamPolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AspectTypeIamPolicy get(String name, Output<String> id, @Nullable AspectTypeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
