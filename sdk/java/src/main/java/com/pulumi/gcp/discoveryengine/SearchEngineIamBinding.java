...
import com.pulumi.gcp.discoveryengine.inputs.SearchEngineIamBindingState;
import com.pulumi.gcp.discoveryengine.outputs.SearchEngineIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:discoveryengine/searchEngineIamBinding:SearchEngineIamBinding")
public class SearchEngineIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * The collection ID.
    ...
    @Export(name="condition", refs={SearchEngineIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ SearchEngineIamBindingCondition> condition;

    public Output<Optional<SearchEngineIamBindingCondition>> condition() {
     ...
     */
    public SearchEngineIamBinding(java.lang.String name) {
        this(name, SearchEngineIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SearchEngineIamBinding(java.lang.String name, SearchEngineIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SearchEngineIamBinding(java.lang.String name, SearchEngineIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:discoveryengine/searchEngineIamBinding:SearchEngineIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SearchEngineIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable SearchEngineIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:discoveryengine/searchEngineIamBinding:SearchEngineIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static SearchEngineIamBindingArgs makeArgs(SearchEngineIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SearchEngineIamBindingArgs.Empty : args;
    }
     ...
     */
    public static SearchEngineIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable SearchEngineIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SearchEngineIamBinding(name, id, state, options);
    }
}
