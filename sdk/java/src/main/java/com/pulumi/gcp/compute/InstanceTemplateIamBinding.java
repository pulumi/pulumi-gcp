...
import com.pulumi.gcp.compute.inputs.InstanceTemplateIamBindingState;
import com.pulumi.gcp.compute.outputs.InstanceTemplateIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/instanceTemplateIamBinding:InstanceTemplateIamBinding editor &#34;projects/{{project}}/global/instanceTemplates/{{instance_template}} roles/compute.instanceAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/instanceTemplateIamBinding:InstanceTemplateIamBinding")
public class InstanceTemplateIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={InstanceTemplateIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ InstanceTemplateIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<InstanceTemplateIamBindingCondition>> condition() {
     ...
     */
    public InstanceTemplateIamBinding(java.lang.String name) {
        this(name, InstanceTemplateIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InstanceTemplateIamBinding(java.lang.String name, InstanceTemplateIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstanceTemplateIamBinding(java.lang.String name, InstanceTemplateIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instanceTemplateIamBinding:InstanceTemplateIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InstanceTemplateIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instanceTemplateIamBinding:InstanceTemplateIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static InstanceTemplateIamBindingArgs makeArgs(InstanceTemplateIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InstanceTemplateIamBindingArgs.Empty : args;
    }
     ...
     */
    public static InstanceTemplateIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new InstanceTemplateIamBinding(name, id, state, options);
    }
}
