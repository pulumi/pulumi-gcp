 ...
 * 
 * ```sh
 * $ pulumi import gcp:datacatalog/policyTagIamMember:PolicyTagIamMember editor &#34;{{policy_tag}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class PolicyTagIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public PolicyTagIamMember(java.lang.String name) {
     ...
     */
    public PolicyTagIamMember(java.lang.String name, PolicyTagIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PolicyTagIamMember(java.lang.String name, PolicyTagIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/policyTagIamMember:PolicyTagIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PolicyTagIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyTagIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:datacatalog/policyTagIamMember:PolicyTagIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static PolicyTagIamMemberArgs makeArgs(PolicyTagIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PolicyTagIamMemberArgs.Empty : args;
    }
     ...
     */
    public static PolicyTagIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyTagIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
