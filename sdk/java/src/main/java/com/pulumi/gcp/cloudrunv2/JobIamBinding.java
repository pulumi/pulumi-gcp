...
import com.pulumi.gcp.cloudrunv2.inputs.JobIamBindingState;
import com.pulumi.gcp.cloudrunv2.outputs.JobIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrunv2/jobIamBinding:JobIamBinding editor &#34;projects/{{project}}/locations/{{location}}/jobs/{{job}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudrunv2/jobIamBinding:JobIamBinding")
public class JobIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public JobIamBinding(java.lang.String name, JobIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/jobIamBinding:JobIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private JobIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable JobIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/jobIamBinding:JobIamBinding", name, state, makeResourceOptions(options, id), false);
    }
