...
import com.pulumi.gcp.vertex.inputs.AiReasoningEngineIamBindingState;
import com.pulumi.gcp.vertex.outputs.AiReasoningEngineIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:vertex/aiReasoningEngineIamBinding:AiReasoningEngineIamBinding")
public class AiReasoningEngineIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={AiReasoningEngineIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ AiReasoningEngineIamBindingCondition> condition;

    public Output<Optional<AiReasoningEngineIamBindingCondition>> condition() {
     ...
     * 
     */
    @Export(name="reasoningEngine", refs={String.class}, tree="[0]")
     ...
     */
    public AiReasoningEngineIamBinding(java.lang.String name) {
        this(name, AiReasoningEngineIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AiReasoningEngineIamBinding(java.lang.String name, AiReasoningEngineIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AiReasoningEngineIamBinding(java.lang.String name, AiReasoningEngineIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiReasoningEngineIamBinding:AiReasoningEngineIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AiReasoningEngineIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AiReasoningEngineIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiReasoningEngineIamBinding:AiReasoningEngineIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AiReasoningEngineIamBindingArgs makeArgs(AiReasoningEngineIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AiReasoningEngineIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AiReasoningEngineIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AiReasoningEngineIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new AiReasoningEngineIamBinding(name, id, state, options);
    }
}
