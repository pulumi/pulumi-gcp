...
@CustomType
public final class JobConfigEditList {
    /**
    ...
    public static Builder builder(JobConfigEditList defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startTimeOffset;
        public Builder() {}
        public Builder(JobConfigEditList defaults) {
        ...
        public JobConfigEditList build() {
            final var _resultValue = new JobConfigEditList();
