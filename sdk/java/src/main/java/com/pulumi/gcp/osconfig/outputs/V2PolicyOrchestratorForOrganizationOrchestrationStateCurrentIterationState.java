...
import com.pulumi.gcp.osconfig.outputs.V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError;
...
@CustomType
public final class V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState {
    /**
     ...
     * 
     */
    private @Nullable V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError error;
    /**
     * @return (Output)
    ...
    private V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState() {}
    /**
     * @return The `Status` type defines a logical error model that is suitable for
     * different programming environments, including REST APIs and RPC APIs. It is
     * used by [gRPC](https://github.com/grpc). Each `Status` message contains
     ...
     * 
     */
    public Optional<V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError> error() {
    ...
    public static Builder builder(V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState defaults) {
        ...
        @CustomType.Setter
        public Builder error(@Nullable V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError error) {
        ...
        public V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState build() {
            final var _resultValue = new V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState();
