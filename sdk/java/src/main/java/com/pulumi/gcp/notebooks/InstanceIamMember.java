 ...
 * 
 * ```sh
 * $ pulumi import gcp:notebooks/instanceIamMember:InstanceIamMember editor &#34;projects/{{project}}/locations/{{location}}/instances/{{instance_name}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class InstanceIamMember extends com.pulumi.resources.CustomResource {
    ...
    public InstanceIamMember(java.lang.String name, InstanceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:notebooks/instanceIamMember:InstanceIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InstanceIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:notebooks/instanceIamMember:InstanceIamMember", name, state, makeResourceOptions(options, id), false);
    }
