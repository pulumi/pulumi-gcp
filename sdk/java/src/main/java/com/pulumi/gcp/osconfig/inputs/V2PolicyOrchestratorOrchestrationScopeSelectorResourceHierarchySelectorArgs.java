...
public final class V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs Empty = new V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs();
    ...
    private V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs() {}

    private V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs(V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs $) {
    ...
    public static Builder builder(V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs();
        }

        public Builder(V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs defaults) {
            $ = new V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelectorArgs build() {
            return $;
        }
    }
