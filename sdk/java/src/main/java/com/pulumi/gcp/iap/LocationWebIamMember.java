...
import com.pulumi.gcp.iap.inputs.LocationWebIamMemberState;
import com.pulumi.gcp.iap.outputs.LocationWebIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:iap/locationWebIamMember:LocationWebIamMember")
public class LocationWebIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={LocationWebIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ LocationWebIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<LocationWebIamMemberCondition>> condition() {
     ...
     */
    public LocationWebIamMember(java.lang.String name) {
        this(name, LocationWebIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocationWebIamMember(java.lang.String name, LocationWebIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocationWebIamMember(java.lang.String name, LocationWebIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/locationWebIamMember:LocationWebIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocationWebIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable LocationWebIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/locationWebIamMember:LocationWebIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static LocationWebIamMemberArgs makeArgs(LocationWebIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocationWebIamMemberArgs.Empty : args;
    }
     ...
     */
    public static LocationWebIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable LocationWebIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
