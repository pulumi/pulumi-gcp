...
@CustomType
public final class BareMetalNodePoolNodePoolConfigNodeConfig {
    /**
    ...
    private BareMetalNodePoolNodePoolConfigNodeConfig() {}
    /**
     * @return The map of Kubernetes labels (key/value pairs) to be applied to
     * each node. These will added in addition to any default label(s)
     * that Kubernetes may apply to the node. In case of conflict in
    ...
    public static Builder builder(BareMetalNodePoolNodePoolConfigNodeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String nodeIp;
        public Builder() {}
        public Builder(BareMetalNodePoolNodePoolConfigNodeConfig defaults) {
