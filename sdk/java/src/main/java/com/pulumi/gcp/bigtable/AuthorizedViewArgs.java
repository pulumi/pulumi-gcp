...
public final class AuthorizedViewArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AuthorizedViewArgs() {}

    private AuthorizedViewArgs(AuthorizedViewArgs $) {
    ...
    public static Builder builder(AuthorizedViewArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuthorizedViewArgs();
        }

        public Builder(AuthorizedViewArgs defaults) {
        ...
        public AuthorizedViewArgs build() {
            if ($.instanceName == null) {
                throw new MissingRequiredPropertyException("AuthorizedViewArgs", "instanceName");
            }
            if ($.tableName == null) {
                throw new MissingRequiredPropertyException("AuthorizedViewArgs", "tableName");
            }
            return $;
        }
    }
