...
public final class PreventionContentPolicyInspectConfigLimitsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PreventionContentPolicyInspectConfigLimitsArgs Empty = new PreventionContentPolicyInspectConfigLimitsArgs();
    ...
    private @Nullable Output<List<PreventionContentPolicyInspectConfigLimitsMaxFindingsPerInfoTypeArgs>> maxFindingsPerInfoTypes;
     ...
     * 
     */
    public Optional<Output<List<PreventionContentPolicyInspectConfigLimitsMaxFindingsPerInfoTypeArgs>>> maxFindingsPerInfoTypes() {
    ...
    private PreventionContentPolicyInspectConfigLimitsArgs() {}

    private PreventionContentPolicyInspectConfigLimitsArgs(PreventionContentPolicyInspectConfigLimitsArgs $) {
    ...
    public static Builder builder(PreventionContentPolicyInspectConfigLimitsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreventionContentPolicyInspectConfigLimitsArgs();
        }

        public Builder(PreventionContentPolicyInspectConfigLimitsArgs defaults) {
            $ = new PreventionContentPolicyInspectConfigLimitsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder maxFindingsPerInfoTypes(@Nullable Output<List<PreventionContentPolicyInspectConfigLimitsMaxFindingsPerInfoTypeArgs>> maxFindingsPerInfoTypes) {
         ...
         * 
         */
        public Builder maxFindingsPerInfoTypes(List<PreventionContentPolicyInspectConfigLimitsMaxFindingsPerInfoTypeArgs> maxFindingsPerInfoTypes) {
         ...
         * 
         */
        public Builder maxFindingsPerInfoTypes(PreventionContentPolicyInspectConfigLimitsMaxFindingsPerInfoTypeArgs... maxFindingsPerInfoTypes) {
        ...
        public PreventionContentPolicyInspectConfigLimitsArgs build() {
            if ($.maxFindingsPerItem == null) {
                throw new MissingRequiredPropertyException("PreventionContentPolicyInspectConfigLimitsArgs", "maxFindingsPerItem");
            }
            if ($.maxFindingsPerRequest == null) {
                throw new MissingRequiredPropertyException("PreventionContentPolicyInspectConfigLimitsArgs", "maxFindingsPerRequest");
            }
            return $;
        }
    }
