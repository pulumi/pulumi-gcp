...
public final class GetClusterNodePoolNodeConfigTaint {
    ...
    public static final class Builder {
        ...
        public Builder effect(String effect) {
            if (effect == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigTaint", "effect");
            }
            this.effect = effect;
            return this;
        }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigTaint", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigTaint", "value");
            }
            this.value = value;
            return this;
        }
        public GetClusterNodePoolNodeConfigTaint build() {
            final var _resultValue = new GetClusterNodePoolNodeConfigTaint();
