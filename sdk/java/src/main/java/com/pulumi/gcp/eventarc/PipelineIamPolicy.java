...
import com.pulumi.gcp.eventarc.inputs.PipelineIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:eventarc/pipelineIamPolicy:PipelineIamPolicy")
public class PipelineIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public PipelineIamPolicy(java.lang.String name) {
        this(name, PipelineIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public PipelineIamPolicy(java.lang.String name, PipelineIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PipelineIamPolicy(java.lang.String name, PipelineIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:eventarc/pipelineIamPolicy:PipelineIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PipelineIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:eventarc/pipelineIamPolicy:PipelineIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static PipelineIamPolicyArgs makeArgs(PipelineIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PipelineIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static PipelineIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
