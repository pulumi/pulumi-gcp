...
import com.pulumi.gcp.vertex.inputs.AiReasoningEngineIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:vertex/aiReasoningEngineIamPolicy:AiReasoningEngineIamPolicy")
public class AiReasoningEngineIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AiReasoningEngineIamPolicy(java.lang.String name) {
        this(name, AiReasoningEngineIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AiReasoningEngineIamPolicy(java.lang.String name, AiReasoningEngineIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AiReasoningEngineIamPolicy(java.lang.String name, AiReasoningEngineIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiReasoningEngineIamPolicy:AiReasoningEngineIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AiReasoningEngineIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable AiReasoningEngineIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiReasoningEngineIamPolicy:AiReasoningEngineIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static AiReasoningEngineIamPolicyArgs makeArgs(AiReasoningEngineIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AiReasoningEngineIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static AiReasoningEngineIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable AiReasoningEngineIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
