...
public final class NetworkEndpointGroupState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkEndpointGroupState();
        }

        public Builder(NetworkEndpointGroupState defaults) {
            $ = new NetworkEndpointGroupState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param size Number of network endpoints in the network endpoint group.
         * 
         * @return builder
         * 
         */
