...
public class ConnectionIAMPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ConnectionIAMPolicy(java.lang.String name, ConnectionIAMPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudbuildv2/connectionIAMPolicy:ConnectionIAMPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ConnectionIAMPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable ConnectionIAMPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudbuildv2/connectionIAMPolicy:ConnectionIAMPolicy", name, state, makeResourceOptions(options, id), false);
    }
