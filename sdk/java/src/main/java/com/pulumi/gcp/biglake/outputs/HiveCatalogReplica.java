...
@CustomType
public final class HiveCatalogReplica {
    /**
     * @return (Output)
    ...
    public static Builder builder(HiveCatalogReplica defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(HiveCatalogReplica defaults) {
        ...
        public HiveCatalogReplica build() {
            final var _resultValue = new HiveCatalogReplica();
