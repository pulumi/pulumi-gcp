...
public final class UnitOutputVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final UnitOutputVariableArgs Empty = new UnitOutputVariableArgs();
    ...
    private UnitOutputVariableArgs() {}

    private UnitOutputVariableArgs(UnitOutputVariableArgs $) {
        this.type = $.type;
        this.value = $.value;
    ...
    public static Builder builder(UnitOutputVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UnitOutputVariableArgs();
        }

        public Builder(UnitOutputVariableArgs defaults) {
            $ = new UnitOutputVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UnitOutputVariableArgs build() {
            if ($.variable == null) {
                throw new MissingRequiredPropertyException("UnitOutputVariableArgs", "variable");
            }
            return $;
        }
    }
