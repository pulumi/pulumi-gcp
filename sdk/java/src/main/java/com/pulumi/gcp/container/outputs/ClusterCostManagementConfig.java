...
public final class ClusterCostManagementConfig {
    ...
    public static Builder builder(ClusterCostManagementConfig defaults) {
    ...
    public static final class Builder {
        private Boolean enabled;
        public Builder() {}
        public Builder(ClusterCostManagementConfig defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("ClusterCostManagementConfig", "enabled");
            }
