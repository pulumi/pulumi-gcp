...
public final class NodePoolNodeConfigFastSocket {
    ...
    public static Builder builder(NodePoolNodeConfigFastSocket defaults) {
    ...
    public static final class Builder {
        private Boolean enabled;
        public Builder() {}
        public Builder(NodePoolNodeConfigFastSocket defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("NodePoolNodeConfigFastSocket", "enabled");
            }
