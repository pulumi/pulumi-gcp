...
@CustomType
public final class GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey {
    /**
    ...
    private GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey() {}
    /**
     * @return The self link of the encryption key that is stored in Google Cloud KMS. Only one of kms_key_self_link, rsa_encrypted_key and raw_key may be set.
     * 
     */
    ...
    public static Builder builder(GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private String sha256;
        public Builder() {}
        public Builder(GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey defaults) {
        ...
        public Builder kmsKeySelfLink(String kmsKeySelfLink) {
            if (kmsKeySelfLink == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey", "kmsKeySelfLink");
            }
        ...
        public Builder kmsKeyServiceAccount(String kmsKeyServiceAccount) {
            if (kmsKeyServiceAccount == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey", "kmsKeyServiceAccount");
            }
        ...
        public Builder rawKey(String rawKey) {
            if (rawKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey", "rawKey");
            }
            this.rawKey = rawKey;
            return this;
        }
        ...
        public Builder rsaEncryptedKey(String rsaEncryptedKey) {
            if (rsaEncryptedKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey", "rsaEncryptedKey");
            }
        ...
        public Builder sha256(String sha256) {
            if (sha256 == null) {
              throw new MissingRequiredPropertyException("GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey", "sha256");
            }
            this.sha256 = sha256;
            return this;
        }
        public GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey build() {
            final var _resultValue = new GetInstanceBootDiskInitializeParamSourceSnapshotEncryptionKey();
