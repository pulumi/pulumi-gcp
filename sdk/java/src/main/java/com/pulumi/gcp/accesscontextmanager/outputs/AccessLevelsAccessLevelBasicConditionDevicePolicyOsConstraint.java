...
public final class AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint {
    ...
    public static final class Builder {
        ...
        public Builder osType(String osType) {
            if (osType == null) {
              throw new MissingRequiredPropertyException("AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint", "osType");
            }
            this.osType = osType;
            return this;
        }
        public AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint build() {
            final var _resultValue = new AccessLevelsAccessLevelBasicConditionDevicePolicyOsConstraint();
