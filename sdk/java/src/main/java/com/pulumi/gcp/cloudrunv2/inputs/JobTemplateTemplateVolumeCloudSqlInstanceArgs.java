...
public final class JobTemplateTemplateVolumeCloudSqlInstanceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private JobTemplateTemplateVolumeCloudSqlInstanceArgs() {}

    private JobTemplateTemplateVolumeCloudSqlInstanceArgs(JobTemplateTemplateVolumeCloudSqlInstanceArgs $) {
    ...
    public static Builder builder(JobTemplateTemplateVolumeCloudSqlInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTemplateTemplateVolumeCloudSqlInstanceArgs();
        }

        public Builder(JobTemplateTemplateVolumeCloudSqlInstanceArgs defaults) {
            $ = new JobTemplateTemplateVolumeCloudSqlInstanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTemplateTemplateVolumeCloudSqlInstanceArgs build() {
            return $;
        }
    }
