...
@CustomType
public final class CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudio {
    /**
     * @return (Output)
    ...
    public static Builder builder(CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudio defaults) {
    ...
    public static final class Builder {
        ...
        private String audioUri;
        public Builder() {}
        public Builder(CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudio defaults) {
        ...
        public Builder audioUri(String audioUri) {
            if (audioUri == null) {
              throw new MissingRequiredPropertyException("CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudio", "audioUri");
            }
