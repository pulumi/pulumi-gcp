...
public final class GetClusterNodeConfigGuestAcceleratorGpuSharingConfig {
    ...
    public static Builder builder(GetClusterNodeConfigGuestAcceleratorGpuSharingConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maxSharedClientsPerGpu;
        public Builder() {}
        public Builder(GetClusterNodeConfigGuestAcceleratorGpuSharingConfig defaults) {
        ...
        public Builder gpuSharingStrategy(String gpuSharingStrategy) {
            if (gpuSharingStrategy == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigGuestAcceleratorGpuSharingConfig", "gpuSharingStrategy");
            }
        ...
        public Builder maxSharedClientsPerGpu(Integer maxSharedClientsPerGpu) {
            if (maxSharedClientsPerGpu == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigGuestAcceleratorGpuSharingConfig", "maxSharedClientsPerGpu");
            }
            this.maxSharedClientsPerGpu = maxSharedClientsPerGpu;
            return this;
        }
        public GetClusterNodeConfigGuestAcceleratorGpuSharingConfig build() {
            final var _resultValue = new GetClusterNodeConfigGuestAcceleratorGpuSharingConfig();
