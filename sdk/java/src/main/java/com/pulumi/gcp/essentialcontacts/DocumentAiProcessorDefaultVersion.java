 ...
 *             .version(processorDocumentAiProcessor.id().apply(id -&gt; String.format(&#34;%s/processorVersions/pretrained-next&#34;, id)))
 *             .build());
 * 
 *     }
 * }
...
public class DocumentAiProcessorDefaultVersion extends com.pulumi.resources.CustomResource {
    ...
    public DocumentAiProcessorDefaultVersion(String name, DocumentAiProcessorDefaultVersionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:essentialcontacts/documentAiProcessorDefaultVersion:DocumentAiProcessorDefaultVersion", name, args == null ? DocumentAiProcessorDefaultVersionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
