...
@CustomType
public final class JobTemplateConfigAdBreak {
    /**
    ...
    private JobTemplateConfigAdBreak() {}
    /**
     * @return Start time in seconds for the ad break, relative to the output file timeline
     * 
     */
    ...
    public static Builder builder(JobTemplateConfigAdBreak defaults) {
    ...
    public static final class Builder {
        private @Nullable String startTimeOffset;
        public Builder() {}
        public Builder(JobTemplateConfigAdBreak defaults) {
        ...
        public JobTemplateConfigAdBreak build() {
            final var _resultValue = new JobTemplateConfigAdBreak();
