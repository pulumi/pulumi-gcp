...
@CustomType
public final class ClusterNodePoolNodeConfigKubeletConfigEvictionSoft {
    /**
    ...
    private ClusterNodePoolNodeConfigKubeletConfigEvictionSoft() {}
    /**
     * @return Defines percentage of soft eviction threshold for imagefs.available. The value must be a percentage between `15%` and `50%`, such as `&#34;20%&#34;`.
     * 
     */
    ...
    public static Builder builder(ClusterNodePoolNodeConfigKubeletConfigEvictionSoft defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String pidAvailable;
        public Builder() {}
        public Builder(ClusterNodePoolNodeConfigKubeletConfigEvictionSoft defaults) {
        ...
        public ClusterNodePoolNodeConfigKubeletConfigEvictionSoft build() {
            final var _resultValue = new ClusterNodePoolNodeConfigKubeletConfigEvictionSoft();
