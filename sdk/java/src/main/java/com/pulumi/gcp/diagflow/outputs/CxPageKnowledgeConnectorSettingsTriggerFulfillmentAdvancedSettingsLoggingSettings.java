...
@CustomType
public final class CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings {
    /**
    ...
    private CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings() {}
    /**
     * @return Enables consent-based end-user input redaction, if true, a pre-defined session parameter **$session.params.conversation-redaction** will be used to determine if the utterance should be redacted.
     * 
     */
    ...
    public static Builder builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean enableStackdriverLogging;
        public Builder() {}
        public Builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings defaults) {
        ...
        public CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings build() {
            final var _resultValue = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsLoggingSettings();
