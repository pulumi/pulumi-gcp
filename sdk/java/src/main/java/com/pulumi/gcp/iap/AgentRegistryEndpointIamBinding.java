...
import com.pulumi.gcp.iap.inputs.AgentRegistryEndpointIamBindingState;
import com.pulumi.gcp.iap.outputs.AgentRegistryEndpointIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryEndpointIamBinding:AgentRegistryEndpointIamBinding")
public class AgentRegistryEndpointIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={AgentRegistryEndpointIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ AgentRegistryEndpointIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<AgentRegistryEndpointIamBindingCondition>> condition() {
     ...
     */
    public AgentRegistryEndpointIamBinding(java.lang.String name) {
        this(name, AgentRegistryEndpointIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryEndpointIamBinding(java.lang.String name, AgentRegistryEndpointIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryEndpointIamBinding(java.lang.String name, AgentRegistryEndpointIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryEndpointIamBinding:AgentRegistryEndpointIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryEndpointIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryEndpointIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryEndpointIamBinding:AgentRegistryEndpointIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryEndpointIamBindingArgs makeArgs(AgentRegistryEndpointIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryEndpointIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryEndpointIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryEndpointIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
