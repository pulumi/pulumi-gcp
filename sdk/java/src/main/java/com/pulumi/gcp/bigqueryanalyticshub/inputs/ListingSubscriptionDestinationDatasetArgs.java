...
public final class ListingSubscriptionDestinationDatasetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ListingSubscriptionDestinationDatasetArgs Empty = new ListingSubscriptionDestinationDatasetArgs();
    ...
    private Output<ListingSubscriptionDestinationDatasetDatasetReferenceArgs> datasetReference;
     ...
     * 
     */
    public Output<ListingSubscriptionDestinationDatasetDatasetReferenceArgs> datasetReference() {
    ...
    public static Builder builder(ListingSubscriptionDestinationDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ListingSubscriptionDestinationDatasetArgs();
        }

        public Builder(ListingSubscriptionDestinationDatasetArgs defaults) {
            $ = new ListingSubscriptionDestinationDatasetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder datasetReference(Output<ListingSubscriptionDestinationDatasetDatasetReferenceArgs> datasetReference) {
         ...
         * 
         */
        public Builder datasetReference(ListingSubscriptionDestinationDatasetDatasetReferenceArgs datasetReference) {
        ...
        public ListingSubscriptionDestinationDatasetArgs build() {
            if ($.datasetReference == null) {
                throw new MissingRequiredPropertyException("ListingSubscriptionDestinationDatasetArgs", "datasetReference");
            }
            if ($.location == null) {
                throw new MissingRequiredPropertyException("ListingSubscriptionDestinationDatasetArgs", "location");
            }
            return $;
        }
    }
