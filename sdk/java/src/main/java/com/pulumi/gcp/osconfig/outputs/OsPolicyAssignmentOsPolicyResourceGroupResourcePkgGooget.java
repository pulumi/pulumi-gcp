...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgGooget {
    ...
    private OsPolicyAssignmentOsPolicyResourceGroupResourcePkgGooget() {}
    /**
     * @return Package name.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgGooget", "name");
            }
            this.name = name;
            return this;
        }
