...
import com.pulumi.gcp.container.outputs.ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig;
...
public final class ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig {
    ...
    public static Builder builder(ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean enabled;
        public Builder() {}
        public Builder(ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig defaults) {
        ...
        @CustomType.Setter
        public Builder certificateAuthorityDomainConfigs(@Nullable List<ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig> certificateAuthorityDomainConfigs) {

            this.certificateAuthorityDomainConfigs = certificateAuthorityDomainConfigs;
            return this;
        }
        public Builder certificateAuthorityDomainConfigs(ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig... certificateAuthorityDomainConfigs) {
            return certificateAuthorityDomainConfigs(List.of(certificateAuthorityDomainConfigs));
        }
        @CustomType.Setter
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig build() {
            final var _resultValue = new ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig();
