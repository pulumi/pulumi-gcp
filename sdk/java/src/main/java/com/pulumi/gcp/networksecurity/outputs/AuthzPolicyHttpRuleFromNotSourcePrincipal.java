...
import com.pulumi.gcp.networksecurity.outputs.AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal;
...
@CustomType
public final class AuthzPolicyHttpRuleFromNotSourcePrincipal {
    /**
     ...
     * 
     */
    private @Nullable AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal principal;
    /**
    ...
    private AuthzPolicyHttpRuleFromNotSourcePrincipal() {}
    /**
     * @return (Optional, Deprecated)
     * The input string must have the substring specified here. Note: empty contains match is not allowed, please use regex instead.
     * Examples:
     ...
     * 
     */
    public Optional<AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal> principal() {
    ...
    public static Builder builder(AuthzPolicyHttpRuleFromNotSourcePrincipal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleFromNotSourcePrincipal defaults) {
        ...
        @CustomType.Setter
        public Builder principal(@Nullable AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal principal) {
        ...
        public AuthzPolicyHttpRuleFromNotSourcePrincipal build() {
            final var _resultValue = new AuthzPolicyHttpRuleFromNotSourcePrincipal();
