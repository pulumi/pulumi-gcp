...
import com.pulumi.gcp.biglake.inputs.HiveTableIamMemberState;
import com.pulumi.gcp.biglake.outputs.HiveTableIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveTableIamMember:HiveTableIamMember")
public class HiveTableIamMember extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={HiveTableIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ HiveTableIamMemberCondition> condition;

    public Output<Optional<HiveTableIamMemberCondition>> condition() {
     ...
     */
    public HiveTableIamMember(java.lang.String name) {
        this(name, HiveTableIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveTableIamMember(java.lang.String name, HiveTableIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveTableIamMember(java.lang.String name, HiveTableIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveTableIamMember:HiveTableIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveTableIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable HiveTableIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveTableIamMember:HiveTableIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveTableIamMemberArgs makeArgs(HiveTableIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveTableIamMemberArgs.Empty : args;
    }
     ...
     */
    public static HiveTableIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveTableIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
