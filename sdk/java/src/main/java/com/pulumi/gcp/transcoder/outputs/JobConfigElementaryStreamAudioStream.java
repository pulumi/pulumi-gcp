...
@CustomType
public final class JobConfigElementaryStreamAudioStream {
    /**
    ...
    private JobConfigElementaryStreamAudioStream() {}
    /**
     * @return Audio bitrate in bits per second.
     * 
     */
    ...
    public static Builder builder(JobConfigElementaryStreamAudioStream defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer sampleRateHertz;
        public Builder() {}
        public Builder(JobConfigElementaryStreamAudioStream defaults) {
        ...
        public Builder bitrateBps(Integer bitrateBps) {
            if (bitrateBps == null) {
              throw new MissingRequiredPropertyException("JobConfigElementaryStreamAudioStream", "bitrateBps");
            }
        ...
        public JobConfigElementaryStreamAudioStream build() {
            final var _resultValue = new JobConfigElementaryStreamAudioStream();
