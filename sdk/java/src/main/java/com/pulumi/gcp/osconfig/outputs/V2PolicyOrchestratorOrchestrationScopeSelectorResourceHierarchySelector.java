...
@CustomType
public final class V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelector {
    /**
    ...
    public static Builder builder(V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedProjects;
        public Builder() {}
        public Builder(V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelector defaults) {
        ...
        public V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelector build() {
            final var _resultValue = new V2PolicyOrchestratorOrchestrationScopeSelectorResourceHierarchySelector();
