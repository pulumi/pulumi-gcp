...
public final class GetDataExchangeIamPolicyArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDataExchangeIamPolicyArgs Empty = new GetDataExchangeIamPolicyArgs();
    ...
    private GetDataExchangeIamPolicyArgs() {}

    private GetDataExchangeIamPolicyArgs(GetDataExchangeIamPolicyArgs $) {
    ...
    public static Builder builder(GetDataExchangeIamPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDataExchangeIamPolicyArgs();
        }

        public Builder(GetDataExchangeIamPolicyArgs defaults) {
            $ = new GetDataExchangeIamPolicyArgs(Objects.requireNonNull(defaults));
        }
