...
public final class InstanceFromTemplateNetworkInterfaceIpv6AccessConfig {
    ...
    public static final class Builder {
        ...
        public Builder networkTier(String networkTier) {
            if (networkTier == null) {
              throw new MissingRequiredPropertyException("InstanceFromTemplateNetworkInterfaceIpv6AccessConfig", "networkTier");
            }
        ...
        public InstanceFromTemplateNetworkInterfaceIpv6AccessConfig build() {
            final var _resultValue = new InstanceFromTemplateNetworkInterfaceIpv6AccessConfig();
