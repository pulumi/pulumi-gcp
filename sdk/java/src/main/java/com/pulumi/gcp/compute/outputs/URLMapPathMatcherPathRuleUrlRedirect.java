...
public final class URLMapPathMatcherPathRuleUrlRedirect {
    ...
    public static final class Builder {
        ...
        public Builder stripQuery(Boolean stripQuery) {
            if (stripQuery == null) {
              throw new MissingRequiredPropertyException("URLMapPathMatcherPathRuleUrlRedirect", "stripQuery");
            }
            this.stripQuery = stripQuery;
            return this;
        }
        public URLMapPathMatcherPathRuleUrlRedirect build() {
            final var _resultValue = new URLMapPathMatcherPathRuleUrlRedirect();
