...
public final class GetRouterStatusBestRoutesForRouter {
    ...
    public static final class Builder {
        ...
        public Builder tags(String... tags) {
            ...
            return new GetRouterStatusBestRoutesForRouter(description, destRange, name, network, nextHopGateway, nextHopIlb, nextHopInstance, nextHopInstanceZone, nextHopIp, nextHopNetwork, nextHopVpnTunnel, priority, project, selfLink, tags);
        }
    }
}
