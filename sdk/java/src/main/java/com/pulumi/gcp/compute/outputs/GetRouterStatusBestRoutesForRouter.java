...
import com.pulumi.gcp.compute.outputs.GetRouterStatusBestRoutesForRouterAsPath;
import com.pulumi.gcp.compute.outputs.GetRouterStatusBestRoutesForRouterParam;
import com.pulumi.gcp.compute.outputs.GetRouterStatusBestRoutesForRouterWarning;
...
@CustomType
public final class GetRouterStatusBestRoutesForRouter {
    private List<GetRouterStatusBestRoutesForRouterAsPath> asPaths;
    /**
     ...
     * 
     */
    private List<GetRouterStatusBestRoutesForRouterParam> params;
    /**
     ...
     * 
     */
    private List<GetRouterStatusBestRoutesForRouterWarning> warnings;

    private GetRouterStatusBestRoutesForRouter() {}
    public List<GetRouterStatusBestRoutesForRouterAsPath> asPaths() {
        return this.asPaths;
    }
    /**
     * @return Creation timestamp in RFC3339 text format.
     ...
     * 
     */
    public List<GetRouterStatusBestRoutesForRouterParam> params() {
        return this.params;
    }
    /**
     * @return The priority of this route. Priority is used to break ties in cases
     ...
     * 
     */
    public List<GetRouterStatusBestRoutesForRouterWarning> warnings() {
    ...
    public static Builder builder(GetRouterStatusBestRoutesForRouter defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetRouterStatusBestRoutesForRouterWarning> warnings;
        public Builder() {}
        public Builder(GetRouterStatusBestRoutesForRouter defaults) {
        ...
        @CustomType.Setter
        public Builder asPaths(List<GetRouterStatusBestRoutesForRouterAsPath> asPaths) {
            if (asPaths == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "asPaths");
            }
            this.asPaths = asPaths;
            return this;
        }
        public Builder asPaths(GetRouterStatusBestRoutesForRouterAsPath... asPaths) {
            return asPaths(List.of(asPaths));
        }
        @CustomType.Setter
        public Builder creationTimestamp(String creationTimestamp) {
            if (creationTimestamp == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "creationTimestamp");
            }
        ...
        public Builder deletionPolicy(String deletionPolicy) {
            if (deletionPolicy == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "deletionPolicy");
            }
        ...
        public Builder nextHopHub(String nextHopHub) {
            if (nextHopHub == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "nextHopHub");
            }
        ...
        public Builder nextHopInterRegionCost(String nextHopInterRegionCost) {
            if (nextHopInterRegionCost == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "nextHopInterRegionCost");
            }
        ...
        public Builder nextHopMed(String nextHopMed) {
            if (nextHopMed == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "nextHopMed");
            }
        ...
        public Builder nextHopOrigin(String nextHopOrigin) {
            if (nextHopOrigin == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "nextHopOrigin");
            }
        ...
        public Builder nextHopPeering(String nextHopPeering) {
            if (nextHopPeering == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "nextHopPeering");
            }
        ...
        @CustomType.Setter
        public Builder params(List<GetRouterStatusBestRoutesForRouterParam> params) {
            if (params == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "params");
            }
            this.params = params;
            return this;
        }
        public Builder params(GetRouterStatusBestRoutesForRouterParam... params) {
        ...
        public Builder routeStatus(String routeStatus) {
            if (routeStatus == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "routeStatus");
            }
        ...
        public Builder routeType(String routeType) {
            if (routeType == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "routeType");
            }
        ...
        @CustomType.Setter
        public Builder warnings(List<GetRouterStatusBestRoutesForRouterWarning> warnings) {
            if (warnings == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRoutesForRouter", "warnings");
            }
            this.warnings = warnings;
            return this;
        }
        public Builder warnings(GetRouterStatusBestRoutesForRouterWarning... warnings) {
            return warnings(List.of(warnings));
        }
        public GetRouterStatusBestRoutesForRouter build() {
            final var _resultValue = new GetRouterStatusBestRoutesForRouter();
