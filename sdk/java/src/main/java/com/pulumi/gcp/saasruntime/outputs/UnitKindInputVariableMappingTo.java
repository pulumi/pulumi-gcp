...
@CustomType
public final class UnitKindInputVariableMappingTo {
    /**
    ...
    private UnitKindInputVariableMappingTo() {}
    /**
     * @return Alias of the dependency that the inputVariable will pass its value to
     * 
     */
    ...
    public static Builder builder(UnitKindInputVariableMappingTo defaults) {
    ...
    public static final class Builder {
        ...
        private String inputVariable;
        public Builder() {}
        public Builder(UnitKindInputVariableMappingTo defaults) {
        ...
        public Builder dependency(String dependency) {
            if (dependency == null) {
              throw new MissingRequiredPropertyException("UnitKindInputVariableMappingTo", "dependency");
            }
        ...
        public Builder inputVariable(String inputVariable) {
            if (inputVariable == null) {
              throw new MissingRequiredPropertyException("UnitKindInputVariableMappingTo", "inputVariable");
            }
            this.inputVariable = inputVariable;
            return this;
        }
        public UnitKindInputVariableMappingTo build() {
            final var _resultValue = new UnitKindInputVariableMappingTo();
