    ...
    public static final class Builder {
        ...
        public Builder adminCredentialSecretName(String adminCredentialSecretName) {
            if (adminCredentialSecretName == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingActiveDirectoryConfig", "adminCredentialSecretName");
            }
        ...
        public Builder dnsServers(List<String> dnsServers) {
            if (dnsServers == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingActiveDirectoryConfig", "dnsServers");
            }
        ...
        public Builder domain(String domain) {
            if (domain == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingActiveDirectoryConfig", "domain");
            }
            this.domain = domain;
            return this;
        }
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingActiveDirectoryConfig", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder organizationalUnit(String organizationalUnit) {
            if (organizationalUnit == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstanceSettingActiveDirectoryConfig", "organizationalUnit");
            }
