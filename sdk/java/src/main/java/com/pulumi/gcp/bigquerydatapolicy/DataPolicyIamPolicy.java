 ...
 * 
 * ```sh
 * $ pulumi import gcp:bigquerydatapolicy/dataPolicyIamPolicy:DataPolicyIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/dataPolicies/{{data_policy_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class DataPolicyIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public DataPolicyIamPolicy(java.lang.String name) {
     ...
     */
    public DataPolicyIamPolicy(java.lang.String name, DataPolicyIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataPolicyIamPolicy(java.lang.String name, DataPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquerydatapolicy/dataPolicyIamPolicy:DataPolicyIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DataPolicyIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable DataPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquerydatapolicy/dataPolicyIamPolicy:DataPolicyIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static DataPolicyIamPolicyArgs makeArgs(DataPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DataPolicyIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static DataPolicyIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable DataPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
