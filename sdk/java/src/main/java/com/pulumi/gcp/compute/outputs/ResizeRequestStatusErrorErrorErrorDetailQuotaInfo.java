...
@CustomType
public final class ResizeRequestStatusErrorErrorErrorDetailQuotaInfo {
    /**
     * @return (Output)
    ...
    private ResizeRequestStatusErrorErrorErrorDetailQuotaInfo() {}
    /**
     * @return (Output)
     * The map holding related quota dimensions
     * 
    ...
    public static Builder builder(ResizeRequestStatusErrorErrorErrorDetailQuotaInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rolloutStatus;
        public Builder() {}
        public Builder(ResizeRequestStatusErrorErrorErrorDetailQuotaInfo defaults) {
        ...
        public ResizeRequestStatusErrorErrorErrorDetailQuotaInfo build() {
            final var _resultValue = new ResizeRequestStatusErrorErrorErrorDetailQuotaInfo();
