 ...
 * 
 * ```sh
 * $ pulumi import gcp:artifactregistry/repositoryIamMember:RepositoryIamMember editor &#34;projects/{{project}}/locations/{{location}}/repositories/{{repository}} roles/artifactregistry.reader user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class RepositoryIamMember extends com.pulumi.resources.CustomResource {
    ...
    public RepositoryIamMember(java.lang.String name, RepositoryIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:artifactregistry/repositoryIamMember:RepositoryIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RepositoryIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:artifactregistry/repositoryIamMember:RepositoryIamMember", name, state, makeResourceOptions(options, id), false);
    }
