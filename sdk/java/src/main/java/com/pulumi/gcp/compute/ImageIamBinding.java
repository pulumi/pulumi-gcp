...
import com.pulumi.gcp.compute.inputs.ImageIamBindingState;
import com.pulumi.gcp.compute.outputs.ImageIamBindingCondition;
 ...
 * ```sh
 * $ terraform import google_compute_image_iam_member.editor &#34;projects/{{project}}/global/images/{{image}} roles/compute.imageUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class ImageIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={ImageIamBindingCondition.class}, tree="[0]")
     ...
     * 
     */
    public Output<Optional<ImageIamBindingCondition>> condition() {
     ...
     * `gcp.compute.ImageIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
     ...
     */
    public ImageIamBinding(java.lang.String name) {
     ...
     */
    public ImageIamBinding(java.lang.String name, ImageIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ImageIamBinding(java.lang.String name, ImageIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/imageIamBinding:ImageIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ImageIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable ImageIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/imageIamBinding:ImageIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ImageIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable ImageIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
