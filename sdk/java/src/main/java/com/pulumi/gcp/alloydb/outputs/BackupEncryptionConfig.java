...
@CustomType
public final class BackupEncryptionConfig {
    /**
    ...
    private BackupEncryptionConfig() {}
    /**
     * @return The fully-qualified resource name of the KMS key. Each Cloud KMS key is regionalized and has the following format: projects/[PROJECT]/locations/[REGION]/keyRings/[RING]/cryptoKeys/[KEY_NAME].
     * 
     */
    ...
    public static Builder builder(BackupEncryptionConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable String kmsKeyName;
        public Builder() {}
        public Builder(BackupEncryptionConfig defaults) {
