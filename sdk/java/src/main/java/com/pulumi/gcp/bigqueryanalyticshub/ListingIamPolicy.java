...
public class ListingIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public ListingIamPolicy(java.lang.String name) {
     ...
     */
    public ListingIamPolicy(java.lang.String name, ListingIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ListingIamPolicy(java.lang.String name, ListingIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigqueryanalyticshub/listingIamPolicy:ListingIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ListingIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable ListingIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigqueryanalyticshub/listingIamPolicy:ListingIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static ListingIamPolicyArgs makeArgs(ListingIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ListingIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static ListingIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable ListingIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
