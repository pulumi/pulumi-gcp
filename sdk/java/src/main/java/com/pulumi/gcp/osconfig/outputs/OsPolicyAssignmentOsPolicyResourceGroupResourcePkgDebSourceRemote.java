...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceRemote {
    ...
    public static final class Builder {
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceRemote", "uri");
            }
            this.uri = uri;
            return this;
        }
        public OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceRemote build() {
            final var _resultValue = new OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceRemote();
