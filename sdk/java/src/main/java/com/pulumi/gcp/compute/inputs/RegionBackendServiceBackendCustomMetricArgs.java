...
public final class RegionBackendServiceBackendCustomMetricArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionBackendServiceBackendCustomMetricArgs Empty = new RegionBackendServiceBackendCustomMetricArgs();
    ...
    private RegionBackendServiceBackendCustomMetricArgs() {}

    private RegionBackendServiceBackendCustomMetricArgs(RegionBackendServiceBackendCustomMetricArgs $) {
        this.dryRun = $.dryRun;
    ...
    public static Builder builder(RegionBackendServiceBackendCustomMetricArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionBackendServiceBackendCustomMetricArgs();
        }

        public Builder(RegionBackendServiceBackendCustomMetricArgs defaults) {
            $ = new RegionBackendServiceBackendCustomMetricArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionBackendServiceBackendCustomMetricArgs build() {
            if ($.dryRun == null) {
                throw new MissingRequiredPropertyException("RegionBackendServiceBackendCustomMetricArgs", "dryRun");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("RegionBackendServiceBackendCustomMetricArgs", "name");
            }
            return $;
        }
    }
