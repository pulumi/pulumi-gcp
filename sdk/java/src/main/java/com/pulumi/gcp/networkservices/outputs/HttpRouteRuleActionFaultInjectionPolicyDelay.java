...
@CustomType
public final class HttpRouteRuleActionFaultInjectionPolicyDelay {
    /**
    ...
    public static Builder builder(HttpRouteRuleActionFaultInjectionPolicyDelay defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer percentage;
        public Builder() {}
        public Builder(HttpRouteRuleActionFaultInjectionPolicyDelay defaults) {
