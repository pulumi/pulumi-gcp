...
import com.pulumi.gcp.dataproc.inputs.MetastoreTableIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataproc/metastoreTableIamPolicy:MetastoreTableIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/services/{{serviceId}}/databases/{{databaseId}}/tables/{{table}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:dataproc/metastoreTableIamPolicy:MetastoreTableIamPolicy")
public class MetastoreTableIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public MetastoreTableIamPolicy(java.lang.String name) {
        this(name, MetastoreTableIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MetastoreTableIamPolicy(java.lang.String name, MetastoreTableIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MetastoreTableIamPolicy(java.lang.String name, MetastoreTableIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreTableIamPolicy:MetastoreTableIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MetastoreTableIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreTableIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/metastoreTableIamPolicy:MetastoreTableIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static MetastoreTableIamPolicyArgs makeArgs(MetastoreTableIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MetastoreTableIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static MetastoreTableIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable MetastoreTableIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
