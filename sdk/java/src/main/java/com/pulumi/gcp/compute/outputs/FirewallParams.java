...
@CustomType
public final class FirewallParams {
    /**
    ...
    public static Builder builder(FirewallParams defaults) {
    ...
    public static final class Builder {
        private @Nullable Map<String,String> resourceManagerTags;
        public Builder() {}
        public Builder(FirewallParams defaults) {
        ...
        public FirewallParams build() {
            final var _resultValue = new FirewallParams();
