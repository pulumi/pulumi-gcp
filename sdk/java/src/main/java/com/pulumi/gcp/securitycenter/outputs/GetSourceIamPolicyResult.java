...
@CustomType
public final class GetSourceIamPolicyResult {
    /**
    ...
    /**
     * @return (Required only by `gcp.securitycenter.SourceIamPolicy`) The policy data generated by
    ...
    public static Builder builder(GetSourceIamPolicyResult defaults) {
    ...
    public static final class Builder {
        ...
        private String source;
        public Builder() {}
        public Builder(GetSourceIamPolicyResult defaults) {
        ...
        public GetSourceIamPolicyResult build() {
            final var _resultValue = new GetSourceIamPolicyResult();
