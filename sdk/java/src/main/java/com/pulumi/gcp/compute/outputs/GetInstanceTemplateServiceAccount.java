...
public final class GetInstanceTemplateServiceAccount {
    ...
    public static final class Builder {
        ...
        public Builder email(String email) {
            if (email == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateServiceAccount", "email");
            }
            this.email = email;
            return this;
        }
        ...
        public Builder scopes(List<String> scopes) {
            if (scopes == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateServiceAccount", "scopes");
            }
            this.scopes = scopes;
            return this;
        }
