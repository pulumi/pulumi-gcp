...
import com.pulumi.gcp.vertex.inputs.AiFeatureGroupIamBindingState;
import com.pulumi.gcp.vertex.outputs.AiFeatureGroupIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:vertex/aiFeatureGroupIamBinding:AiFeatureGroupIamBinding")
public class AiFeatureGroupIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={AiFeatureGroupIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ AiFeatureGroupIamBindingCondition> condition;

    public Output<Optional<AiFeatureGroupIamBindingCondition>> condition() {
     ...
     */
    public AiFeatureGroupIamBinding(java.lang.String name) {
        this(name, AiFeatureGroupIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AiFeatureGroupIamBinding(java.lang.String name, AiFeatureGroupIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AiFeatureGroupIamBinding(java.lang.String name, AiFeatureGroupIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiFeatureGroupIamBinding:AiFeatureGroupIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AiFeatureGroupIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AiFeatureGroupIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiFeatureGroupIamBinding:AiFeatureGroupIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AiFeatureGroupIamBindingArgs makeArgs(AiFeatureGroupIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AiFeatureGroupIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AiFeatureGroupIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AiFeatureGroupIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new AiFeatureGroupIamBinding(name, id, state, options);
    }
}
