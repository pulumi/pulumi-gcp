...
public class WorkstationIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public WorkstationIamPolicy(String name) {
     ...
     */
    public WorkstationIamPolicy(String name, WorkstationIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:workstations/workstationIamPolicy:WorkstationIamPolicy", name, args == null ? WorkstationIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private WorkstationIamPolicy(String name, Output<String> id, @Nullable WorkstationIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:workstations/workstationIamPolicy:WorkstationIamPolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static WorkstationIamPolicy get(String name, Output<String> id, @Nullable WorkstationIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
