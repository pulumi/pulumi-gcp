...
public final class ClusterIAMMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("ClusterIAMMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("ClusterIAMMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public ClusterIAMMemberCondition build() {
            final var _resultValue = new ClusterIAMMemberCondition();
