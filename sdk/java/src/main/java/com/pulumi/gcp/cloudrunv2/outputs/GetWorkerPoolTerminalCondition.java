...
@CustomType
public final class GetWorkerPoolTerminalCondition {
    /**
    ...
    /**
     * @return A common (workerPool-level) reason for this condition.
     * 
     */
    ...
    private GetWorkerPoolTerminalCondition() {}
    /**
     * @return A reason for the execution condition.
     * 
     */
    ...
    public static Builder builder(GetWorkerPoolTerminalCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetWorkerPoolTerminalCondition defaults) {
        ...
        public Builder executionReason(String executionReason) {
            if (executionReason == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "executionReason");
            }
        ...
        public Builder lastTransitionTime(String lastTransitionTime) {
            if (lastTransitionTime == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "lastTransitionTime");
            }
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "message");
            }
        ...
        public Builder reason(String reason) {
            if (reason == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "reason");
            }
            this.reason = reason;
            return this;
        }
        ...
        public Builder revisionReason(String revisionReason) {
            if (revisionReason == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "revisionReason");
            }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "severity");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWorkerPoolTerminalCondition", "type");
            }
            this.type = type;
            return this;
        }
        public GetWorkerPoolTerminalCondition build() {
            final var _resultValue = new GetWorkerPoolTerminalCondition();
