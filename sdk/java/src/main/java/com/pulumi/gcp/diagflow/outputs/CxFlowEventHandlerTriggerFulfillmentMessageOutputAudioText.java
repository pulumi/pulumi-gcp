...
@CustomType
public final class CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText {
    /**
     * @return (Output)
    ...
    private CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String text;
        public Builder() {}
        public Builder(CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText defaults) {
        ...
        public CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText build() {
            final var _resultValue = new CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText();
