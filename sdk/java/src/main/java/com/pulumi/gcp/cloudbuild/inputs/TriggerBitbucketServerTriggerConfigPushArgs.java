...
public final class TriggerBitbucketServerTriggerConfigPushArgs extends com.pulumi.resources.ResourceArgs {

    public static final TriggerBitbucketServerTriggerConfigPushArgs Empty = new TriggerBitbucketServerTriggerConfigPushArgs();
    ...
    private TriggerBitbucketServerTriggerConfigPushArgs() {}

    private TriggerBitbucketServerTriggerConfigPushArgs(TriggerBitbucketServerTriggerConfigPushArgs $) {
        this.branch = $.branch;
    ...
    public static Builder builder(TriggerBitbucketServerTriggerConfigPushArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TriggerBitbucketServerTriggerConfigPushArgs();
        }

        public Builder(TriggerBitbucketServerTriggerConfigPushArgs defaults) {
            $ = new TriggerBitbucketServerTriggerConfigPushArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TriggerBitbucketServerTriggerConfigPushArgs build() {
            return $;
        }
    }
