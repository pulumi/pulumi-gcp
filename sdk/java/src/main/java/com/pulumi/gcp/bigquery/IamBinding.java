 ...
 * 
 * ```sh
 * $ pulumi import gcp:bigquery/iamBinding:IamBinding editor &#34;projects/{{project}}/datasets/{{dataset_id}}/tables/{{table_id}} roles/bigquery.dataOwner user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class IamBinding extends com.pulumi.resources.CustomResource {
    ...
    public IamBinding(java.lang.String name, IamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/iamBinding:IamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable IamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/iamBinding:IamBinding", name, state, makeResourceOptions(options, id), false);
    }
