 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudfunctionsv2/functionIamBinding:FunctionIamBinding editor &#34;projects/{{project}}/locations/{{location}}/functions/{{cloud_function}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class FunctionIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public FunctionIamBinding(java.lang.String name) {
     ...
     */
    public FunctionIamBinding(java.lang.String name, FunctionIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FunctionIamBinding(java.lang.String name, FunctionIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudfunctionsv2/functionIamBinding:FunctionIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FunctionIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudfunctionsv2/functionIamBinding:FunctionIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FunctionIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
