...
@CustomType
public final class GetDatabaseInstancesInstancePointInTimeRestoreContext {
    /**
    ...
    private GetDatabaseInstancesInstancePointInTimeRestoreContext() {}
    /**
     * @return The name of the allocated IP range for the internal IP Cloud SQL instance. For example: &#34;google-managed-services-default&#34;. If you set this, then Cloud SQL creates the IP address for the cloned instance in the allocated range. This range must comply with [RFC 1035](https://tools.ietf.org/html/rfc1035) standards. Specifically, the name must be 1-63 characters long and match the regular expression a-z?.
     * 
     */
    ...
    public static Builder builder(GetDatabaseInstancesInstancePointInTimeRestoreContext defaults) {
    ...
    public static final class Builder {
        ...
        public Builder allocatedIpRange(String allocatedIpRange) {
            if (allocatedIpRange == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstancesInstancePointInTimeRestoreContext", "allocatedIpRange");
            }
        ...
        public Builder datasource(String datasource) {
            if (datasource == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstancesInstancePointInTimeRestoreContext", "datasource");
            }
        ...
        public Builder pointInTime(String pointInTime) {
            if (pointInTime == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstancesInstancePointInTimeRestoreContext", "pointInTime");
            }
        ...
        public Builder preferredZone(String preferredZone) {
            if (preferredZone == null) {
              throw new MissingRequiredPropertyException("GetDatabaseInstancesInstancePointInTimeRestoreContext", "preferredZone");
            }
        ...
        public GetDatabaseInstancesInstancePointInTimeRestoreContext build() {
            final var _resultValue = new GetDatabaseInstancesInstancePointInTimeRestoreContext();
