...
public final class ConnectionEventingConfigAdditionalVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConnectionEventingConfigAdditionalVariableArgs Empty = new ConnectionEventingConfigAdditionalVariableArgs();
    ...
    private @Nullable Output<ConnectionEventingConfigAdditionalVariableEncryptionKeyValueArgs> encryptionKeyValue;
     ...
     * 
     */
    public Optional<Output<ConnectionEventingConfigAdditionalVariableEncryptionKeyValueArgs>> encryptionKeyValue() {
    ...
    private @Nullable Output<ConnectionEventingConfigAdditionalVariableSecretValueArgs> secretValue;
     ...
     * 
     */
    public Optional<Output<ConnectionEventingConfigAdditionalVariableSecretValueArgs>> secretValue() {
    ...
    private ConnectionEventingConfigAdditionalVariableArgs() {}

    private ConnectionEventingConfigAdditionalVariableArgs(ConnectionEventingConfigAdditionalVariableArgs $) {
    ...
    public static Builder builder(ConnectionEventingConfigAdditionalVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectionEventingConfigAdditionalVariableArgs();
        }

        public Builder(ConnectionEventingConfigAdditionalVariableArgs defaults) {
            $ = new ConnectionEventingConfigAdditionalVariableArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder encryptionKeyValue(@Nullable Output<ConnectionEventingConfigAdditionalVariableEncryptionKeyValueArgs> encryptionKeyValue) {
         ...
         * 
         */
        public Builder encryptionKeyValue(ConnectionEventingConfigAdditionalVariableEncryptionKeyValueArgs encryptionKeyValue) {
         ...
         * 
         */
        public Builder secretValue(@Nullable Output<ConnectionEventingConfigAdditionalVariableSecretValueArgs> secretValue) {
         ...
         * 
         */
        public Builder secretValue(ConnectionEventingConfigAdditionalVariableSecretValueArgs secretValue) {
        ...
        public ConnectionEventingConfigAdditionalVariableArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("ConnectionEventingConfigAdditionalVariableArgs", "key");
            }
            return $;
        }
    }
