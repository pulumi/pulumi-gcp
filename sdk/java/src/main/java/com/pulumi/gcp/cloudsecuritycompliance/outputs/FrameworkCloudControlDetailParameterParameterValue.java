...
@CustomType
public final class FrameworkCloudControlDetailParameterParameterValue {
    /**
     ...
     * 
     */
    public Optional<FrameworkCloudControlDetailParameterParameterValueStringListValue> stringListValue() {
    ...
    public static Builder builder(FrameworkCloudControlDetailParameterParameterValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String stringValue;
        public Builder() {}
        public Builder(FrameworkCloudControlDetailParameterParameterValue defaults) {
        ...
        @CustomType.Setter
        public Builder stringListValue(@Nullable FrameworkCloudControlDetailParameterParameterValueStringListValue stringListValue) {
        ...
        public FrameworkCloudControlDetailParameterParameterValue build() {
