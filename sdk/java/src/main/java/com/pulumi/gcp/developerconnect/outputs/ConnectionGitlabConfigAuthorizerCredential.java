...
@CustomType
public final class ConnectionGitlabConfigAuthorizerCredential {
    /**
    ...
    public static Builder builder(ConnectionGitlabConfigAuthorizerCredential defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String username;
        public Builder() {}
        public Builder(ConnectionGitlabConfigAuthorizerCredential defaults) {
        ...
        public Builder userTokenSecretVersion(String userTokenSecretVersion) {
            if (userTokenSecretVersion == null) {
              throw new MissingRequiredPropertyException("ConnectionGitlabConfigAuthorizerCredential", "userTokenSecretVersion");
            }
        ...
        public ConnectionGitlabConfigAuthorizerCredential build() {
            final var _resultValue = new ConnectionGitlabConfigAuthorizerCredential();
