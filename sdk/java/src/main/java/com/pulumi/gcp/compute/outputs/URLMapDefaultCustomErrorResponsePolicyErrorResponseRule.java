...
@CustomType
public final class URLMapDefaultCustomErrorResponsePolicyErrorResponseRule {
    /**
    ...
    private URLMapDefaultCustomErrorResponsePolicyErrorResponseRule() {}
    /**
     * @return Valid values include:
     * - A number between 400 and 599: For example 401 or 503, in which case the load balancer applies the policy if the error code exactly matches this value.
     * - 5xx: Load Balancer will apply the policy if the backend service responds with any response code in the range of 500 to 599.
    ...
    public static Builder builder(URLMapDefaultCustomErrorResponsePolicyErrorResponseRule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String path;
        public Builder() {}
        public Builder(URLMapDefaultCustomErrorResponsePolicyErrorResponseRule defaults) {
        ...
        public URLMapDefaultCustomErrorResponsePolicyErrorResponseRule build() {
            final var _resultValue = new URLMapDefaultCustomErrorResponsePolicyErrorResponseRule();
