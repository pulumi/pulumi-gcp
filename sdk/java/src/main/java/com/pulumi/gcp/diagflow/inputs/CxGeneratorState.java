...
public final class CxGeneratorState extends com.pulumi.resources.ResourceArgs {

    public static final CxGeneratorState Empty = new CxGeneratorState();
    ...
    private @Nullable Output<CxGeneratorPromptTextArgs> promptText;
     ...
     * 
     */
    public Optional<Output<CxGeneratorPromptTextArgs>> promptText() {
        return Optional.ofNullable(this.promptText);
    }

    private CxGeneratorState() {}

    private CxGeneratorState(CxGeneratorState $) {
    ...
    public static Builder builder(CxGeneratorState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxGeneratorState();
        }

        public Builder(CxGeneratorState defaults) {
            $ = new CxGeneratorState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name The unique identifier of the Generator.
         * Format: projects/&lt;Project ID&gt;/locations/&lt;Location ID&gt;/agents/&lt;Agent ID&gt;/generators/&lt;Generator ID&gt;.
         * 
         * @return builder
         * 
         ...
         * 
         */
        public Builder promptText(@Nullable Output<CxGeneratorPromptTextArgs> promptText) {
