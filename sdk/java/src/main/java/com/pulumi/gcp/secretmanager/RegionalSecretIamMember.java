...
import com.pulumi.gcp.secretmanager.inputs.RegionalSecretIamMemberState;
import com.pulumi.gcp.secretmanager.outputs.RegionalSecretIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:secretmanager/regionalSecretIamMember:RegionalSecretIamMember editor &#34;projects/{{project}}/locations/{{location}}/secrets/{{secret_id}} roles/secretmanager.secretAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:secretmanager/regionalSecretIamMember:RegionalSecretIamMember")
public class RegionalSecretIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={RegionalSecretIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ RegionalSecretIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<RegionalSecretIamMemberCondition>> condition() {
     ...
     */
    public RegionalSecretIamMember(java.lang.String name) {
        this(name, RegionalSecretIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RegionalSecretIamMember(java.lang.String name, RegionalSecretIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RegionalSecretIamMember(java.lang.String name, RegionalSecretIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:secretmanager/regionalSecretIamMember:RegionalSecretIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RegionalSecretIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable RegionalSecretIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:secretmanager/regionalSecretIamMember:RegionalSecretIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static RegionalSecretIamMemberArgs makeArgs(RegionalSecretIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RegionalSecretIamMemberArgs.Empty : args;
    }
     ...
     */
    public static RegionalSecretIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable RegionalSecretIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
