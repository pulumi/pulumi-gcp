 ...
 * 
 * ```sh
 * $ pulumi import gcp:certificateauthority/certificateTemplateIamPolicy:CertificateTemplateIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/certificateTemplates/{{certificate_template}} roles/privateca.templateUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class CertificateTemplateIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public CertificateTemplateIamPolicy(java.lang.String name) {
     ...
     */
    public CertificateTemplateIamPolicy(java.lang.String name, CertificateTemplateIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CertificateTemplateIamPolicy(java.lang.String name, CertificateTemplateIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/certificateTemplateIamPolicy:CertificateTemplateIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CertificateTemplateIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable CertificateTemplateIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:certificateauthority/certificateTemplateIamPolicy:CertificateTemplateIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static CertificateTemplateIamPolicyArgs makeArgs(CertificateTemplateIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CertificateTemplateIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static CertificateTemplateIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable CertificateTemplateIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
