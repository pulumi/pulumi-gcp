...
public class LogViewIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public LogViewIamBinding(String name) {
     ...
     */
    public LogViewIamBinding(String name, LogViewIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static LogViewIamBinding get(String name, Output<String> id, @Nullable LogViewIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
