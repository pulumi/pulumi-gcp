...
import com.pulumi.gcp.osconfig.inputs.V2PolicyOrchestratorOrchestrationStatePreviousIterationStateErrorArgs;
...
public final class V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs Empty = new V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs();
     ...
     */
    @Import(name="error")
    private @Nullable Output<V2PolicyOrchestratorOrchestrationStatePreviousIterationStateErrorArgs> error;
     ...
     * 
     */
    public Optional<Output<V2PolicyOrchestratorOrchestrationStatePreviousIterationStateErrorArgs>> error() {
    ...
    private V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs() {}

    private V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs(V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs $) {
        this.error = $.error;
    ...
    public static Builder builder(V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs();
        }

        public Builder(V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs defaults) {
            $ = new V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder error(@Nullable Output<V2PolicyOrchestratorOrchestrationStatePreviousIterationStateErrorArgs> error) {
            $.error = error;
            return this;
        }
         ...
         * 
         */
        public Builder error(V2PolicyOrchestratorOrchestrationStatePreviousIterationStateErrorArgs error) {
        ...
        public V2PolicyOrchestratorOrchestrationStatePreviousIterationStateArgs build() {
            return $;
        }
    }
