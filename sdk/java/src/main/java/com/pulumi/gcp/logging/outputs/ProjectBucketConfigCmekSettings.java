...
@CustomType
public final class ProjectBucketConfigCmekSettings {
    /**
    ...
    private ProjectBucketConfigCmekSettings() {}
    /**
     * @return The resource name for the configured Cloud KMS key.
     * KMS key name format:
     * `&#39;projects/[PROJECT_ID]/locations/[LOCATION]/keyRings/[KEYRING]/cryptoKeys/[KEY]&#39;`
    ...
    public static Builder builder(ProjectBucketConfigCmekSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String serviceAccountId;
        public Builder() {}
        public Builder(ProjectBucketConfigCmekSettings defaults) {
        ...
        public Builder kmsKeyName(String kmsKeyName) {
            if (kmsKeyName == null) {
              throw new MissingRequiredPropertyException("ProjectBucketConfigCmekSettings", "kmsKeyName");
            }
