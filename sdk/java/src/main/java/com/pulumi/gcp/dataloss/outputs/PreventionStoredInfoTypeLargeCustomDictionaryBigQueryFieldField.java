...
public final class PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldField {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldField", "name");
            }
            this.name = name;
            return this;
        }
        public PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldField build() {
            final var _resultValue = new PreventionStoredInfoTypeLargeCustomDictionaryBigQueryFieldField();
