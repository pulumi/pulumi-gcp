...
@CustomType
public final class LicenseConfigEndDate {
    /**
    ...
    public static Builder builder(LicenseConfigEndDate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer year;
        public Builder() {}
        public Builder(LicenseConfigEndDate defaults) {
        ...
        public LicenseConfigEndDate build() {
            final var _resultValue = new LicenseConfigEndDate();
