...
import com.pulumi.gcp.iam.inputs.WorkforcePoolIamMemberState;
import com.pulumi.gcp.iam.outputs.WorkforcePoolIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember editor &#34;locations/{{location}}/workforcePools/{{workforce_pool_id}} roles/iam.workforcePoolViewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember")
public class WorkforcePoolIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={WorkforcePoolIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ WorkforcePoolIamMemberCondition> condition;

    public Output<Optional<WorkforcePoolIamMemberCondition>> condition() {
     ...
     */
    public WorkforcePoolIamMember(java.lang.String name) {
        this(name, WorkforcePoolIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WorkforcePoolIamMember(java.lang.String name, WorkforcePoolIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkforcePoolIamMember(java.lang.String name, WorkforcePoolIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WorkforcePoolIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable WorkforcePoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static WorkforcePoolIamMemberArgs makeArgs(WorkforcePoolIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WorkforcePoolIamMemberArgs.Empty : args;
    }
     ...
     */
    public static WorkforcePoolIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkforcePoolIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new WorkforcePoolIamMember(name, id, state, options);
    }
}
