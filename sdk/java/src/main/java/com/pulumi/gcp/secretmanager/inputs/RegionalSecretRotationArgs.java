...
public final class RegionalSecretRotationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionalSecretRotationArgs Empty = new RegionalSecretRotationArgs();
    ...
    private RegionalSecretRotationArgs() {}

    private RegionalSecretRotationArgs(RegionalSecretRotationArgs $) {
    ...
    public static Builder builder(RegionalSecretRotationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionalSecretRotationArgs();
        }

        public Builder(RegionalSecretRotationArgs defaults) {
            $ = new RegionalSecretRotationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param rotationPeriod The Duration between rotation notifications. Must be in seconds and at least 3600s (1h)
         * and at most 3153600000s (100 years). If rotationPeriod is set, `nextRotationTime` must
         * be set. `nextRotationTime` will be advanced by this period when the service
         * automatically sends rotation notifications.
         * 
        ...
        public RegionalSecretRotationArgs build() {
            return $;
        }
    }
