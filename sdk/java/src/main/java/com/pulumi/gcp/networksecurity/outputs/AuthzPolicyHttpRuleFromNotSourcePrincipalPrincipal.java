...
@CustomType
public final class AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal {
    /**
    ...
    private AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal() {}
    /**
     * @return The input string must have the substring specified here. Note: empty contains match is not allowed, please use regex instead.
     * Examples:
     * * abc matches the value xyz.abc.def
    ...
    public static Builder builder(AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal defaults) {
        ...
        public AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal build() {
            final var _resultValue = new AuthzPolicyHttpRuleFromNotSourcePrincipalPrincipal();
