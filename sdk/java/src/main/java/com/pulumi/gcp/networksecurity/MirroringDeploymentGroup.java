...
public class MirroringDeploymentGroup extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="connectedEndpointGroups", refs={List.class,MirroringDeploymentGroupConnectedEndpointGroup.class}, tree="[0,1]")
     ...
     * 
     */
    public Output<List<MirroringDeploymentGroupConnectedEndpointGroup>> connectedEndpointGroups() {
     ...
     */
    public MirroringDeploymentGroup(java.lang.String name) {
        this(name, MirroringDeploymentGroupArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public MirroringDeploymentGroup(java.lang.String name, MirroringDeploymentGroupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MirroringDeploymentGroup(java.lang.String name, MirroringDeploymentGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networksecurity/mirroringDeploymentGroup:MirroringDeploymentGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MirroringDeploymentGroup(java.lang.String name, Output<java.lang.String> id, @Nullable MirroringDeploymentGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networksecurity/mirroringDeploymentGroup:MirroringDeploymentGroup", name, state, makeResourceOptions(options, id), false);
    }

    private static MirroringDeploymentGroupArgs makeArgs(MirroringDeploymentGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MirroringDeploymentGroupArgs.Empty : args;
    }
     ...
     */
    public static MirroringDeploymentGroup get(java.lang.String name, Output<java.lang.String> id, @Nullable MirroringDeploymentGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
