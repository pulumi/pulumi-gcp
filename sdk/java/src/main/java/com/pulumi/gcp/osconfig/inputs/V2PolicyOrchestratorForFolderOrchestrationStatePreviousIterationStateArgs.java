...
import com.pulumi.gcp.osconfig.inputs.V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateErrorArgs;
...
public final class V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs Empty = new V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs();
     ...
     */
    @Import(name="errors")
    private @Nullable Output<List<V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateErrorArgs>> errors;
     ...
     * 
     */
    public Optional<Output<List<V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateErrorArgs>>> errors() {
    ...
    private V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs() {}

    private V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs(V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs $) {
        this.errors = $.errors;
    ...
    public static Builder builder(V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs();
        }

        public Builder(V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs defaults) {
            $ = new V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder errors(@Nullable Output<List<V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateErrorArgs>> errors) {
            $.errors = errors;
            return this;
        }
         ...
         * 
         */
        public Builder errors(List<V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateErrorArgs> errors) {
         ...
         * 
         */
        public Builder errors(V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateErrorArgs... errors) {
        ...
        public V2PolicyOrchestratorForFolderOrchestrationStatePreviousIterationStateArgs build() {
            return $;
        }
    }
