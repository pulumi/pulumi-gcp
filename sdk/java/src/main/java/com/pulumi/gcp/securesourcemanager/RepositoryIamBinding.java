...
import com.pulumi.gcp.securesourcemanager.inputs.RepositoryIamBindingState;
import com.pulumi.gcp.securesourcemanager.outputs.RepositoryIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:securesourcemanager/repositoryIamBinding:RepositoryIamBinding editor &#34;projects/{{project}}/locations/{{location}}/repositories/{{repository_id}} roles/securesourcemanager.repoAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:securesourcemanager/repositoryIamBinding:RepositoryIamBinding")
public class RepositoryIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public RepositoryIamBinding(String name, RepositoryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securesourcemanager/repositoryIamBinding:RepositoryIamBinding", name, args == null ? RepositoryIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private RepositoryIamBinding(String name, Output<String> id, @Nullable RepositoryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securesourcemanager/repositoryIamBinding:RepositoryIamBinding", name, state, makeResourceOptions(options, id));
    }
