...
public final class InstanceTemplateDiskSourceImageEncryptionKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceTemplateDiskSourceImageEncryptionKeyArgs Empty = new InstanceTemplateDiskSourceImageEncryptionKeyArgs();
    ...
    private InstanceTemplateDiskSourceImageEncryptionKeyArgs() {}

    private InstanceTemplateDiskSourceImageEncryptionKeyArgs(InstanceTemplateDiskSourceImageEncryptionKeyArgs $) {
    ...
    public static Builder builder(InstanceTemplateDiskSourceImageEncryptionKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceTemplateDiskSourceImageEncryptionKeyArgs();
        }

        public Builder(InstanceTemplateDiskSourceImageEncryptionKeyArgs defaults) {
            $ = new InstanceTemplateDiskSourceImageEncryptionKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param rsaEncryptedKey Specifies an RFC 4648 base64 encoded, RSA-wrapped 2048-bit [customer-supplied encryption key](https://cloud.google.com/compute/docs/disks/customer-supplied-encryption) to decrypt the given image. Only one of `kmsKeySelfLink`, `rsaEncryptedKey` and `rawKey`
         * may be set.
         * 
         * @return builder
         * 
        ...
        public InstanceTemplateDiskSourceImageEncryptionKeyArgs build() {
            return $;
        }
    }
