...
import com.pulumi.gcp.container.inputs.ClusterNodeConfigTaintConfigArgs;
import com.pulumi.gcp.container.inputs.ClusterNodeConfigWindowsNodeConfigArgs;
...
public final class ClusterNodeConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ClusterNodeConfigContainerdConfigArgs> containerdConfig;

    /**
     * @return Parameters to customize containerd runtime. Structure is documented below.
     * 
     */
    public Optional<Output<ClusterNodeConfigContainerdConfigArgs>> containerdConfig() {
    ...
    private @Nullable Output<ClusterNodeConfigTaintConfigArgs> taintConfig;

    /**
     * @return Taint configuration for the node pool. Structure is documented below.
     * 
     */
    public Optional<Output<ClusterNodeConfigTaintConfigArgs>> taintConfig() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder containerdConfig(@Nullable Output<ClusterNodeConfigContainerdConfigArgs> containerdConfig) {
         ...
         * 
         */
        public Builder containerdConfig(ClusterNodeConfigContainerdConfigArgs containerdConfig) {
         ...
         * 
         */
        public Builder taintConfig(@Nullable Output<ClusterNodeConfigTaintConfigArgs> taintConfig) {
         ...
         * 
         */
        public Builder taintConfig(ClusterNodeConfigTaintConfigArgs taintConfig) {
         ...
         * 
         */
        public Builder windowsNodeConfig(@Nullable Output<ClusterNodeConfigWindowsNodeConfigArgs> windowsNodeConfig) {
         ...
         * 
         */
        public Builder windowsNodeConfig(ClusterNodeConfigWindowsNodeConfigArgs windowsNodeConfig) {
