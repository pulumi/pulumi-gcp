...
import com.pulumi.gcp.bigquery.inputs.RoutineIamMemberState;
import com.pulumi.gcp.bigquery.outputs.RoutineIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:bigquery/routineIamMember:RoutineIamMember")
public class RoutineIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={RoutineIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ RoutineIamMemberCondition> condition;

    public Output<Optional<RoutineIamMemberCondition>> condition() {
     ...
     */
    public RoutineIamMember(java.lang.String name) {
        this(name, RoutineIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RoutineIamMember(java.lang.String name, RoutineIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RoutineIamMember(java.lang.String name, RoutineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/routineIamMember:RoutineIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RoutineIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable RoutineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigquery/routineIamMember:RoutineIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static RoutineIamMemberArgs makeArgs(RoutineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RoutineIamMemberArgs.Empty : args;
    }
     ...
     */
    public static RoutineIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable RoutineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RoutineIamMember(name, id, state, options);
    }
}
