...
public final class GetParameterVersionPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetParameterVersionPlainArgs Empty = new GetParameterVersionPlainArgs();
    ...
    private GetParameterVersionPlainArgs() {}

    private GetParameterVersionPlainArgs(GetParameterVersionPlainArgs $) {
    ...
    public static Builder builder(GetParameterVersionPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetParameterVersionPlainArgs();
        }

        public Builder(GetParameterVersionPlainArgs defaults) {
            $ = new GetParameterVersionPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetParameterVersionPlainArgs build() {
            if ($.parameter == null) {
                throw new MissingRequiredPropertyException("GetParameterVersionPlainArgs", "parameter");
            }
            if ($.parameterVersionId == null) {
                throw new MissingRequiredPropertyException("GetParameterVersionPlainArgs", "parameterVersionId");
            }
            return $;
        }
    }
