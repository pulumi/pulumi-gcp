...
@CustomType
public final class InstancePeriodicExportConfigStartTime {
    /**
    ...
    private InstancePeriodicExportConfigStartTime() {}
    /**
     * @return Hours of day in 24 hour format. Should be from 0 to 23.
     * 
     */
    ...
    public static Builder builder(InstancePeriodicExportConfigStartTime defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer seconds;
        public Builder() {}
        public Builder(InstancePeriodicExportConfigStartTime defaults) {
        ...
        public InstancePeriodicExportConfigStartTime build() {
            final var _resultValue = new InstancePeriodicExportConfigStartTime();
