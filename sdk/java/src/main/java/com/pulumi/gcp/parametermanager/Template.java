...
import com.pulumi.gcp.parametermanager.TemplateArgs;
import com.pulumi.gcp.parametermanager.inputs.TemplateState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.gcp.parametermanager.Template;
 * import com.pulumi.gcp.parametermanager.TemplateArgs;
 ...
 * 
 *     public static void stack(Context ctx) {
 *         var template_with_format = new Template("template-with-format", TemplateArgs.builder()
 *             .templateId("template")
 ...
 * 
 *     public static void stack(Context ctx) {
 *         var template_with_labels = new Template("template-with-labels", TemplateArgs.builder()
 *             .templateId("template")
 ...
 * 
 */
@ResourceType(type="gcp:parametermanager/template:Template")
public class Template extends com.pulumi.resources.CustomResource {
    ...
    public Template(java.lang.String name, TemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:parametermanager/template:Template", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Template(java.lang.String name, Output<java.lang.String> id, @Nullable TemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:parametermanager/template:Template", name, state, makeResourceOptions(options, id), false);
    }
