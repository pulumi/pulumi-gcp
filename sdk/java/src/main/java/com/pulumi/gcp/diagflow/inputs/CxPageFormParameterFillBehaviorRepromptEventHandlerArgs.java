...
public final class CxPageFormParameterFillBehaviorRepromptEventHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxPageFormParameterFillBehaviorRepromptEventHandlerArgs Empty = new CxPageFormParameterFillBehaviorRepromptEventHandlerArgs();
    ...
    private @Nullable Output<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentArgs> triggerFulfillment;
     ...
     * 
     */
    public Optional<Output<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentArgs>> triggerFulfillment() {
        return Optional.ofNullable(this.triggerFulfillment);
    }

    private CxPageFormParameterFillBehaviorRepromptEventHandlerArgs() {}

    private CxPageFormParameterFillBehaviorRepromptEventHandlerArgs(CxPageFormParameterFillBehaviorRepromptEventHandlerArgs $) {
        this.event = $.event;
        this.name = $.name;
    ...
    public static Builder builder(CxPageFormParameterFillBehaviorRepromptEventHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageFormParameterFillBehaviorRepromptEventHandlerArgs();
        }

        public Builder(CxPageFormParameterFillBehaviorRepromptEventHandlerArgs defaults) {
            $ = new CxPageFormParameterFillBehaviorRepromptEventHandlerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder triggerFulfillment(@Nullable Output<CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentArgs> triggerFulfillment) {
         ...
         * 
         */
        public Builder triggerFulfillment(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentArgs triggerFulfillment) {
            return triggerFulfillment(Output.of(triggerFulfillment));
        }

        public CxPageFormParameterFillBehaviorRepromptEventHandlerArgs build() {
            return $;
        }
    }
