...
@CustomType
public final class BareMetalAdminClusterValidationCheckStatusResult {
    /**
     * @return (Output)
    ...
    public static Builder builder(BareMetalAdminClusterValidationCheckStatusResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String reason;
        public Builder() {}
        public Builder(BareMetalAdminClusterValidationCheckStatusResult defaults) {
