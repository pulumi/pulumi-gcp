...
@CustomType
public final class ListingSubscriptionLinkedResource {
    /**
     * @return (Output)
    ...
    public static Builder builder(ListingSubscriptionLinkedResource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String listing;
        public Builder() {}
        public Builder(ListingSubscriptionLinkedResource defaults) {
        ...
        public ListingSubscriptionLinkedResource build() {
            final var _resultValue = new ListingSubscriptionLinkedResource();
