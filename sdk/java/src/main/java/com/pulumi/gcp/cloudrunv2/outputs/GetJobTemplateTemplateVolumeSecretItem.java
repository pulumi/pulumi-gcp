...
public final class GetJobTemplateTemplateVolumeSecretItem {
    ...
    public static final class Builder {
        ...
        public Builder mode(Integer mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetJobTemplateTemplateVolumeSecretItem", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetJobTemplateTemplateVolumeSecretItem", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetJobTemplateTemplateVolumeSecretItem", "version");
            }
