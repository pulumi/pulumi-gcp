...
public final class RouterNamedSetElementArgs extends com.pulumi.resources.ResourceArgs {

    public static final RouterNamedSetElementArgs Empty = new RouterNamedSetElementArgs();
    ...
    private RouterNamedSetElementArgs() {}

    private RouterNamedSetElementArgs(RouterNamedSetElementArgs $) {
    ...
    public static Builder builder(RouterNamedSetElementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RouterNamedSetElementArgs();
        }

        public Builder(RouterNamedSetElementArgs defaults) {
            $ = new RouterNamedSetElementArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RouterNamedSetElementArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("RouterNamedSetElementArgs", "expression");
            }
            return $;
        }
    }
