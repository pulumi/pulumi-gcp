...
public final class CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs Empty = new CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs();
    ...
    private CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs() {}

    private CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs(CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs $) {
    ...
    public static Builder builder(CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs();
        }

        public Builder(CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs defaults) {
            $ = new CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs build() {
            if ($.audioUri == null) {
                throw new MissingRequiredPropertyException("CxFlowTransitionRouteTriggerFulfillmentMessagePlayAudioArgs", "audioUri");
            }
            return $;
        }
    }
