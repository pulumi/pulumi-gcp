...
import com.pulumi.gcp.dataplex.inputs.AssetIamBindingState;
import com.pulumi.gcp.dataplex.outputs.AssetIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/assetIamBinding:AssetIamBinding editor &#34;projects/{{project}}/locations/{{location}}/lakes/{{lake}}/zones/{{dataplex_zone}}/assets/{{asset}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class AssetIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public AssetIamBinding(java.lang.String name) {
        this(name, AssetIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AssetIamBinding(java.lang.String name, AssetIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AssetIamBinding(java.lang.String name, AssetIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/assetIamBinding:AssetIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AssetIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AssetIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/assetIamBinding:AssetIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AssetIamBindingArgs makeArgs(AssetIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AssetIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AssetIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AssetIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
