...
public class AssetIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public AssetIamBinding(String name) {
     ...
     */
    public AssetIamBinding(String name, AssetIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AssetIamBinding(String name, AssetIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/assetIamBinding:AssetIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private AssetIamBinding(String name, Output<String> id, @Nullable AssetIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/assetIamBinding:AssetIamBinding", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AssetIamBinding get(String name, Output<String> id, @Nullable AssetIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
