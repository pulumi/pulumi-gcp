...
public final class BillingAccountSinkExclusion {
    ...
    public static final class Builder {
        ...
        public Builder filter(String filter) {
            if (filter == null) {
              throw new MissingRequiredPropertyException("BillingAccountSinkExclusion", "filter");
            }
            this.filter = filter;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("BillingAccountSinkExclusion", "name");
            }
            this.name = name;
            return this;
        }
