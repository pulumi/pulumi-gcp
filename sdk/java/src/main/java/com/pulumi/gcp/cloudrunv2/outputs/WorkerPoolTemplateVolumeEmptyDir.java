...
@CustomType
public final class WorkerPoolTemplateVolumeEmptyDir {
    /**
    ...
    public static Builder builder(WorkerPoolTemplateVolumeEmptyDir defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sizeLimit;
        public Builder() {}
        public Builder(WorkerPoolTemplateVolumeEmptyDir defaults) {
        ...
        public WorkerPoolTemplateVolumeEmptyDir build() {
            final var _resultValue = new WorkerPoolTemplateVolumeEmptyDir();
