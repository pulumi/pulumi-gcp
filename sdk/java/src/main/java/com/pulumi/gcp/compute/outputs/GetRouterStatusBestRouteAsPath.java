...
@CustomType
public final class GetRouterStatusBestRouteAsPath {
    /**
    ...
    private GetRouterStatusBestRouteAsPath() {}
    /**
     * @return The AS numbers of the AS Path.
     * 
     */
    ...
    public static Builder builder(GetRouterStatusBestRouteAsPath defaults) {
    ...
    public static final class Builder {
        ...
        private String pathSegmentType;
        public Builder() {}
        public Builder(GetRouterStatusBestRouteAsPath defaults) {
        ...
        public Builder asLists(List<Integer> asLists) {
            if (asLists == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRouteAsPath", "asLists");
            }
        ...
        public Builder pathSegmentType(String pathSegmentType) {
            if (pathSegmentType == null) {
              throw new MissingRequiredPropertyException("GetRouterStatusBestRouteAsPath", "pathSegmentType");
            }
            this.pathSegmentType = pathSegmentType;
            return this;
        }
        public GetRouterStatusBestRouteAsPath build() {
            final var _resultValue = new GetRouterStatusBestRouteAsPath();
