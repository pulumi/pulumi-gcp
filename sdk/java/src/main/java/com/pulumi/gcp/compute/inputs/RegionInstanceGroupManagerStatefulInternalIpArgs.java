...
public final class RegionInstanceGroupManagerStatefulInternalIpArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionInstanceGroupManagerStatefulInternalIpArgs Empty = new RegionInstanceGroupManagerStatefulInternalIpArgs();
    ...
    private RegionInstanceGroupManagerStatefulInternalIpArgs() {}

    private RegionInstanceGroupManagerStatefulInternalIpArgs(RegionInstanceGroupManagerStatefulInternalIpArgs $) {
    ...
    public static Builder builder(RegionInstanceGroupManagerStatefulInternalIpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionInstanceGroupManagerStatefulInternalIpArgs();
        }

        public Builder(RegionInstanceGroupManagerStatefulInternalIpArgs defaults) {
            $ = new RegionInstanceGroupManagerStatefulInternalIpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionInstanceGroupManagerStatefulInternalIpArgs build() {
            return $;
        }
    }
