...
public final class WebTypeAppEngingIamMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("WebTypeAppEngingIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("WebTypeAppEngingIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public WebTypeAppEngingIamMemberCondition build() {
            final var _resultValue = new WebTypeAppEngingIamMemberCondition();
