...
import com.pulumi.gcp.compute.inputs.StoragePoolIamBindingState;
import com.pulumi.gcp.compute.outputs.StoragePoolIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/storagePoolIamBinding:StoragePoolIamBinding editor &#34;projects/{{project}}/zones/{{zone}}/storagePools/{{storage_pool}} roles/compute.viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/storagePoolIamBinding:StoragePoolIamBinding")
public class StoragePoolIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={StoragePoolIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ StoragePoolIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<StoragePoolIamBindingCondition>> condition() {
     ...
     */
    public StoragePoolIamBinding(java.lang.String name) {
        this(name, StoragePoolIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public StoragePoolIamBinding(java.lang.String name, StoragePoolIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StoragePoolIamBinding(java.lang.String name, StoragePoolIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/storagePoolIamBinding:StoragePoolIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StoragePoolIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable StoragePoolIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/storagePoolIamBinding:StoragePoolIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static StoragePoolIamBindingArgs makeArgs(StoragePoolIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? StoragePoolIamBindingArgs.Empty : args;
    }
     ...
     */
    public static StoragePoolIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable StoragePoolIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new StoragePoolIamBinding(name, id, state, options);
    }
}
