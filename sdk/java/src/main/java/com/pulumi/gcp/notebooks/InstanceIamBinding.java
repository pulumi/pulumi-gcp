...
import com.pulumi.gcp.notebooks.inputs.InstanceIamBindingState;
import com.pulumi.gcp.notebooks.outputs.InstanceIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:notebooks/instanceIamBinding:InstanceIamBinding editor &#34;projects/{{project}}/locations/{{location}}/instances/{{instance_name}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class InstanceIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public InstanceIamBinding(java.lang.String name, InstanceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:notebooks/instanceIamBinding:InstanceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InstanceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:notebooks/instanceIamBinding:InstanceIamBinding", name, state, makeResourceOptions(options, id), false);
    }
