...
import com.pulumi.gcp.vertex.inputs.AiReasoningEngineIamMemberState;
import com.pulumi.gcp.vertex.outputs.AiReasoningEngineIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:vertex/aiReasoningEngineIamMember:AiReasoningEngineIamMember")
public class AiReasoningEngineIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={AiReasoningEngineIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ AiReasoningEngineIamMemberCondition> condition;

    public Output<Optional<AiReasoningEngineIamMemberCondition>> condition() {
     ...
     */
    public AiReasoningEngineIamMember(java.lang.String name) {
        this(name, AiReasoningEngineIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AiReasoningEngineIamMember(java.lang.String name, AiReasoningEngineIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AiReasoningEngineIamMember(java.lang.String name, AiReasoningEngineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiReasoningEngineIamMember:AiReasoningEngineIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AiReasoningEngineIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable AiReasoningEngineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiReasoningEngineIamMember:AiReasoningEngineIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static AiReasoningEngineIamMemberArgs makeArgs(AiReasoningEngineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AiReasoningEngineIamMemberArgs.Empty : args;
    }
     ...
     */
    public static AiReasoningEngineIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable AiReasoningEngineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
