...
@CustomType
public final class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText {
    /**
     * @return (Output)
    ...
    public static Builder builder(CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> texts;
        public Builder() {}
        public Builder(CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText defaults) {
        ...
        public CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText build() {
            final var _resultValue = new CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageText();
