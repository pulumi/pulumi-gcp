 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webRegionBackendServiceIamPolicy:WebRegionBackendServiceIamPolicy editor &#34;projects/{{project}}/iap_web/compute-{{region}}/services/{{web_region_backend_service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class WebRegionBackendServiceIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public WebRegionBackendServiceIamPolicy(java.lang.String name) {
     ...
     */
    public WebRegionBackendServiceIamPolicy(java.lang.String name, WebRegionBackendServiceIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebRegionBackendServiceIamPolicy(java.lang.String name, WebRegionBackendServiceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webRegionBackendServiceIamPolicy:WebRegionBackendServiceIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebRegionBackendServiceIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable WebRegionBackendServiceIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webRegionBackendServiceIamPolicy:WebRegionBackendServiceIamPolicy", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static WebRegionBackendServiceIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable WebRegionBackendServiceIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
