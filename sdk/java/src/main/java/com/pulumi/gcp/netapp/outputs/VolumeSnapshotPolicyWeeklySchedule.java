...
@CustomType
public final class VolumeSnapshotPolicyWeeklySchedule {
    /**
    ...
    public static Builder builder(VolumeSnapshotPolicyWeeklySchedule defaults) {
    ...
    public static final class Builder {
        ...
        private Integer snapshotsToKeep;
        public Builder() {}
        public Builder(VolumeSnapshotPolicyWeeklySchedule defaults) {
        ...
        public Builder snapshotsToKeep(Integer snapshotsToKeep) {
            if (snapshotsToKeep == null) {
              throw new MissingRequiredPropertyException("VolumeSnapshotPolicyWeeklySchedule", "snapshotsToKeep");
            }
            this.snapshotsToKeep = snapshotsToKeep;
            return this;
        }
        public VolumeSnapshotPolicyWeeklySchedule build() {
            final var _resultValue = new VolumeSnapshotPolicyWeeklySchedule();
