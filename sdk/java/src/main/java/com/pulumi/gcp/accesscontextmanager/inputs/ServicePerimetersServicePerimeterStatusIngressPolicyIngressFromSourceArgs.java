...
import com.pulumi.gcp.accesscontextmanager.inputs.ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpointArgs;
...
public final class ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpointArgs> pscEndpoint;
     ...
     * 
     */
    public Optional<Output<ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpointArgs>> pscEndpoint() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder pscEndpoint(@Nullable Output<ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpointArgs> pscEndpoint) {
         ...
         * 
         */
        public Builder pscEndpoint(ServicePerimetersServicePerimeterStatusIngressPolicyIngressFromSourcePscEndpointArgs pscEndpoint) {
