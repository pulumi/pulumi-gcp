...
public final class PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsTableReferenceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsTableReferenceArgs build() {
            if ($.datasetId == null) {
                throw new MissingRequiredPropertyException("PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsTableReferenceArgs", "datasetId");
            }
            if ($.projectId == null) {
                throw new MissingRequiredPropertyException("PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsTableReferenceArgs", "projectId");
            }
            if ($.tableId == null) {
                throw new MissingRequiredPropertyException("PreventionJobTriggerInspectJobStorageConfigBigQueryOptionsTableReferenceArgs", "tableId");
            }
            return $;
        }
    }
