 ...
 * 
 * ```sh
 * $ pulumi import gcp:sourcerepo/repositoryIamBinding:RepositoryIamBinding editor &#34;projects/{{project}}/topics/{{topic}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
