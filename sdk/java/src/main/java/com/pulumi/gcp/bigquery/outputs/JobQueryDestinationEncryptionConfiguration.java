...
public final class JobQueryDestinationEncryptionConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder kmsKeyName(String kmsKeyName) {
            if (kmsKeyName == null) {
              throw new MissingRequiredPropertyException("JobQueryDestinationEncryptionConfiguration", "kmsKeyName");
            }
        ...
        public JobQueryDestinationEncryptionConfiguration build() {
            final var _resultValue = new JobQueryDestinationEncryptionConfiguration();
