...
import com.pulumi.gcp.iam.inputs.OrganizationsPolicyBindingConditionArgs;
...
public final class OrganizationsPolicyBindingState extends com.pulumi.resources.ResourceArgs {

    public static final OrganizationsPolicyBindingState Empty = new OrganizationsPolicyBindingState();
    ...
    private @Nullable Output<OrganizationsPolicyBindingConditionArgs> condition;
     ...
     * 
     */
    public Optional<Output<OrganizationsPolicyBindingConditionArgs>> condition() {
     ...
     */
    @Import(name="target")
    private @Nullable Output<OrganizationsPolicyBindingTargetArgs> target;
     ...
     * 
     */
    public Optional<Output<OrganizationsPolicyBindingTargetArgs>> target() {
    ...
    private OrganizationsPolicyBindingState() {}

    private OrganizationsPolicyBindingState(OrganizationsPolicyBindingState $) {
    ...
    public static Builder builder(OrganizationsPolicyBindingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrganizationsPolicyBindingState();
        }

        public Builder(OrganizationsPolicyBindingState defaults) {
            $ = new OrganizationsPolicyBindingState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder condition(@Nullable Output<OrganizationsPolicyBindingConditionArgs> condition) {
            $.condition = condition;
            return this;
        }
         ...
         * 
         */
        public Builder condition(OrganizationsPolicyBindingConditionArgs condition) {
        ...
        /**
         * @param organization The parent organization of the Policy Binding.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder target(@Nullable Output<OrganizationsPolicyBindingTargetArgs> target) {
            $.target = target;
            return this;
        }
         ...
         * 
         */
        public Builder target(OrganizationsPolicyBindingTargetArgs target) {
        ...
        public OrganizationsPolicyBindingState build() {
            return $;
        }
    }
