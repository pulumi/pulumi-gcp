...
import com.pulumi.gcp.colab.inputs.RuntimeTemplateIamBindingState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:colab/runtimeTemplateIamBinding:RuntimeTemplateIamBinding editor &#34;projects/{{project}}/locations/{{location}}/notebookRuntimeTemplates/{{runtime_template}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:colab/runtimeTemplateIamBinding:RuntimeTemplateIamBinding")
public class RuntimeTemplateIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={RuntimeTemplateIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ RuntimeTemplateIamBindingCondition> condition;

    public Output<Optional<RuntimeTemplateIamBindingCondition>> condition() {
     ...
     */
    public RuntimeTemplateIamBinding(java.lang.String name) {
        this(name, RuntimeTemplateIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RuntimeTemplateIamBinding(java.lang.String name, RuntimeTemplateIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RuntimeTemplateIamBinding(java.lang.String name, RuntimeTemplateIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:colab/runtimeTemplateIamBinding:RuntimeTemplateIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RuntimeTemplateIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable RuntimeTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:colab/runtimeTemplateIamBinding:RuntimeTemplateIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static RuntimeTemplateIamBindingArgs makeArgs(RuntimeTemplateIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RuntimeTemplateIamBindingArgs.Empty : args;
    }
     ...
     */
    public static RuntimeTemplateIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable RuntimeTemplateIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
