...
@CustomType
public final class RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd {
    /**
    ...
    private RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd() {}
    /**
     * @return The name of the header.
     * 
     */
    ...
    public static Builder builder(RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean replace;
        public Builder() {}
        public Builder(RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd defaults) {
        ...
        public RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd build() {
            final var _resultValue = new RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd();
