...
public final class JobTemplateConfigOverlayAnimationAnimationFadeArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTemplateConfigOverlayAnimationAnimationFadeArgs Empty = new JobTemplateConfigOverlayAnimationAnimationFadeArgs();
     ...
     */
    @Import(name="xy")
    private @Nullable Output<JobTemplateConfigOverlayAnimationAnimationFadeXyArgs> xy;
     ...
     * 
     */
    public Optional<Output<JobTemplateConfigOverlayAnimationAnimationFadeXyArgs>> xy() {
        return Optional.ofNullable(this.xy);
    }

    private JobTemplateConfigOverlayAnimationAnimationFadeArgs() {}

    private JobTemplateConfigOverlayAnimationAnimationFadeArgs(JobTemplateConfigOverlayAnimationAnimationFadeArgs $) {
    ...
    public static Builder builder(JobTemplateConfigOverlayAnimationAnimationFadeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTemplateConfigOverlayAnimationAnimationFadeArgs();
        }

        public Builder(JobTemplateConfigOverlayAnimationAnimationFadeArgs defaults) {
            $ = new JobTemplateConfigOverlayAnimationAnimationFadeArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder xy(@Nullable Output<JobTemplateConfigOverlayAnimationAnimationFadeXyArgs> xy) {
            $.xy = xy;
            return this;
        }
         ...
         * 
         */
        public Builder xy(JobTemplateConfigOverlayAnimationAnimationFadeXyArgs xy) {
            return xy(Output.of(xy));
        }

        public JobTemplateConfigOverlayAnimationAnimationFadeArgs build() {
            if ($.fadeType == null) {
                throw new MissingRequiredPropertyException("JobTemplateConfigOverlayAnimationAnimationFadeArgs", "fadeType");
            }
            return $;
        }
    }
