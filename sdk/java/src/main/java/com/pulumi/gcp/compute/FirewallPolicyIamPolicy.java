...
import com.pulumi.gcp.compute.inputs.FirewallPolicyIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:compute/firewallPolicyIamPolicy:FirewallPolicyIamPolicy")
public class FirewallPolicyIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public FirewallPolicyIamPolicy(java.lang.String name) {
     ...
     */
    public FirewallPolicyIamPolicy(java.lang.String name, FirewallPolicyIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FirewallPolicyIamPolicy(java.lang.String name, FirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/firewallPolicyIamPolicy:FirewallPolicyIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FirewallPolicyIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable FirewallPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/firewallPolicyIamPolicy:FirewallPolicyIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static FirewallPolicyIamPolicyArgs makeArgs(FirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FirewallPolicyIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static FirewallPolicyIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable FirewallPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
