...
@CustomType
public final class InstanceFromMachineImageInstanceEncryptionKey {
    /**
    ...
    public static Builder builder(InstanceFromMachineImageInstanceEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sha256;
        public Builder() {}
        public Builder(InstanceFromMachineImageInstanceEncryptionKey defaults) {
        ...
        public InstanceFromMachineImageInstanceEncryptionKey build() {
            final var _resultValue = new InstanceFromMachineImageInstanceEncryptionKey();
