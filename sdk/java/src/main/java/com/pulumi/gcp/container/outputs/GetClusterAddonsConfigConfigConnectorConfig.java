...
public final class GetClusterAddonsConfigConfigConnectorConfig {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetClusterAddonsConfigConfigConnectorConfig", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public GetClusterAddonsConfigConfigConnectorConfig build() {
            final var _resultValue = new GetClusterAddonsConfigConfigConnectorConfig();
