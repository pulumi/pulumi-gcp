...
@CustomType
public final class BackendServiceMaxStreamDuration {
    /**
    ...
    public static Builder builder(BackendServiceMaxStreamDuration defaults) {
    ...
    public static final class Builder {
        ...
        private String seconds;
        public Builder() {}
        public Builder(BackendServiceMaxStreamDuration defaults) {
        ...
        public Builder seconds(String seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("BackendServiceMaxStreamDuration", "seconds");
            }
            this.seconds = seconds;
            return this;
        }
        public BackendServiceMaxStreamDuration build() {
            final var _resultValue = new BackendServiceMaxStreamDuration();
