...
import com.pulumi.gcp.gemini.inputs.GeminiGcpEnablementSettingBindingState;
 ...
 * 
 */
@ResourceType(type="gcp:gemini/geminiGcpEnablementSettingBinding:GeminiGcpEnablementSettingBinding")
public class GeminiGcpEnablementSettingBinding extends com.pulumi.resources.CustomResource {
    /**
     * Create time stamp.
     * 
     */
     ...
     */
    public GeminiGcpEnablementSettingBinding(java.lang.String name) {
        this(name, GeminiGcpEnablementSettingBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public GeminiGcpEnablementSettingBinding(java.lang.String name, GeminiGcpEnablementSettingBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GeminiGcpEnablementSettingBinding(java.lang.String name, GeminiGcpEnablementSettingBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/geminiGcpEnablementSettingBinding:GeminiGcpEnablementSettingBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GeminiGcpEnablementSettingBinding(java.lang.String name, Output<java.lang.String> id, @Nullable GeminiGcpEnablementSettingBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/geminiGcpEnablementSettingBinding:GeminiGcpEnablementSettingBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static GeminiGcpEnablementSettingBindingArgs makeArgs(GeminiGcpEnablementSettingBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GeminiGcpEnablementSettingBindingArgs.Empty : args;
    }
     ...
     */
    public static GeminiGcpEnablementSettingBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable GeminiGcpEnablementSettingBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
