...
@CustomType
public final class ServiceTemplateContainerPorts {
    /**
    ...
    public static Builder builder(ServiceTemplateContainerPorts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(ServiceTemplateContainerPorts defaults) {
        ...
        public ServiceTemplateContainerPorts build() {
            final var _resultValue = new ServiceTemplateContainerPorts();
