 ...
 * 
 * ```sh
 * $ pulumi import gcp:iam/workforcePoolIamBinding:WorkforcePoolIamBinding editor &#34;locations/{{location}}/workforcePools/{{workforce_pool_id}} roles/iam.workforcePoolViewer user:jane{@literal @}example.com&#34;
 * ```
 * 
