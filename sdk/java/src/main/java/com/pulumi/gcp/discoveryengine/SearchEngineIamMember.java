...
import com.pulumi.gcp.discoveryengine.inputs.SearchEngineIamMemberState;
import com.pulumi.gcp.discoveryengine.outputs.SearchEngineIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:discoveryengine/searchEngineIamMember:SearchEngineIamMember")
public class SearchEngineIamMember extends com.pulumi.resources.CustomResource {
    /**
     * The collection ID.
    ...
    @Export(name="condition", refs={SearchEngineIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ SearchEngineIamMemberCondition> condition;

    public Output<Optional<SearchEngineIamMemberCondition>> condition() {
     ...
     */
    public SearchEngineIamMember(java.lang.String name) {
        this(name, SearchEngineIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SearchEngineIamMember(java.lang.String name, SearchEngineIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SearchEngineIamMember(java.lang.String name, SearchEngineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:discoveryengine/searchEngineIamMember:SearchEngineIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SearchEngineIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable SearchEngineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:discoveryengine/searchEngineIamMember:SearchEngineIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static SearchEngineIamMemberArgs makeArgs(SearchEngineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SearchEngineIamMemberArgs.Empty : args;
    }
     ...
     */
    public static SearchEngineIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable SearchEngineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SearchEngineIamMember(name, id, state, options);
    }
}
