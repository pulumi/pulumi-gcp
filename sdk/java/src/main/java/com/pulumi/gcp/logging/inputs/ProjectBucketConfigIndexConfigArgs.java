...
public final class ProjectBucketConfigIndexConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ProjectBucketConfigIndexConfigArgs build() {
            if ($.fieldPath == null) {
                throw new MissingRequiredPropertyException("ProjectBucketConfigIndexConfigArgs", "fieldPath");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ProjectBucketConfigIndexConfigArgs", "type");
            }
            return $;
        }
    }
