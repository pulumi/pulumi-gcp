 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webTypeAppEngingIamMember:WebTypeAppEngingIamMember editor &#34;projects/{{project}}/iap_web/appengine-{{appId}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class WebTypeAppEngingIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public WebTypeAppEngingIamMember(java.lang.String name) {
     ...
     */
    public WebTypeAppEngingIamMember(java.lang.String name, WebTypeAppEngingIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebTypeAppEngingIamMember(java.lang.String name, WebTypeAppEngingIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webTypeAppEngingIamMember:WebTypeAppEngingIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebTypeAppEngingIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable WebTypeAppEngingIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webTypeAppEngingIamMember:WebTypeAppEngingIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static WebTypeAppEngingIamMemberArgs makeArgs(WebTypeAppEngingIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebTypeAppEngingIamMemberArgs.Empty : args;
    }
     ...
     */
    public static WebTypeAppEngingIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable WebTypeAppEngingIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
