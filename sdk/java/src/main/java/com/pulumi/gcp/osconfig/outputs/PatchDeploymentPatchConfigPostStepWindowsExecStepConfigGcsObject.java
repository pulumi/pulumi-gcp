...
public final class PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder generationNumber(String generationNumber) {
            if (generationNumber == null) {
              throw new MissingRequiredPropertyException("PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject", "generationNumber");
            }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject", "object");
            }
            this.object = object;
            return this;
        }
