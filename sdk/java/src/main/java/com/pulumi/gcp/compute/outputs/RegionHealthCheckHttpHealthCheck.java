...
public final class RegionHealthCheckHttpHealthCheck {
    ...
    public static Builder builder(RegionHealthCheckHttpHealthCheck defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegionHealthCheckHttpHealthCheck defaults) {
        ...
        public Builder response(@Nullable String response) {
            this.response = response;
            return this;
        }        public RegionHealthCheckHttpHealthCheck build() {
            return new RegionHealthCheckHttpHealthCheck(host, port, portName, portSpecification, proxyHeader, requestPath, response);
        }
    }
}
