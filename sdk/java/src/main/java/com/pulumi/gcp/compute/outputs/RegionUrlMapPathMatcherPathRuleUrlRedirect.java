...
public final class RegionUrlMapPathMatcherPathRuleUrlRedirect {
    ...
    public static final class Builder {
        ...
        public Builder stripQuery(Boolean stripQuery) {
            if (stripQuery == null) {
              throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherPathRuleUrlRedirect", "stripQuery");
            }
            this.stripQuery = stripQuery;
            return this;
        }
        public RegionUrlMapPathMatcherPathRuleUrlRedirect build() {
            final var _resultValue = new RegionUrlMapPathMatcherPathRuleUrlRedirect();
