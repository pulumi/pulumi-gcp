...
import com.pulumi.gcp.osconfig.outputs.V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError;
...
@CustomType
public final class V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState {
    /**
     ...
     * 
     */
    private @Nullable V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError error;
    /**
     * @return (Output)
     ...
     * 
     */
    public Optional<V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError> error() {
    ...
    public static Builder builder(V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState defaults) {
        ...
        @CustomType.Setter
        public Builder error(@Nullable V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationStateError error) {
        ...
        public V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState build() {
            final var _resultValue = new V2PolicyOrchestratorForOrganizationOrchestrationStatePreviousIterationState();
