...
public final class InstanceNetworkInterfaceIpv6AccessConfig {
    ...
    public static final class Builder {
        ...
        public Builder networkTier(String networkTier) {
            if (networkTier == null) {
              throw new MissingRequiredPropertyException("InstanceNetworkInterfaceIpv6AccessConfig", "networkTier");
            }
        ...
        public InstanceNetworkInterfaceIpv6AccessConfig build() {
            final var _resultValue = new InstanceNetworkInterfaceIpv6AccessConfig();
