...
import com.pulumi.gcp.eventarc.inputs.PipelineIamBindingState;
import com.pulumi.gcp.eventarc.outputs.PipelineIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:eventarc/pipelineIamBinding:PipelineIamBinding")
public class PipelineIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={PipelineIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ PipelineIamBindingCondition> condition;

    public Output<Optional<PipelineIamBindingCondition>> condition() {
     ...
     */
    public PipelineIamBinding(java.lang.String name) {
        this(name, PipelineIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public PipelineIamBinding(java.lang.String name, PipelineIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PipelineIamBinding(java.lang.String name, PipelineIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:eventarc/pipelineIamBinding:PipelineIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PipelineIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:eventarc/pipelineIamBinding:PipelineIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static PipelineIamBindingArgs makeArgs(PipelineIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PipelineIamBindingArgs.Empty : args;
    }
     ...
     */
    public static PipelineIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new PipelineIamBinding(name, id, state, options);
    }
}
