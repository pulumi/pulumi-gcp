...
public final class SecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("SecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri", "operator");
            }
        ...
        public SecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri build() {
            final var _resultValue = new SecurityPolicyRulePreconfiguredWafConfigExclusionRequestUri();
