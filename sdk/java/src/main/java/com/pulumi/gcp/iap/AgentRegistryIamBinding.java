...
import com.pulumi.gcp.iap.inputs.AgentRegistryIamBindingState;
import com.pulumi.gcp.iap.outputs.AgentRegistryIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryIamBinding:AgentRegistryIamBinding")
public class AgentRegistryIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={AgentRegistryIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ AgentRegistryIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<AgentRegistryIamBindingCondition>> condition() {
     ...
     */
    public AgentRegistryIamBinding(java.lang.String name) {
        this(name, AgentRegistryIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryIamBinding(java.lang.String name, AgentRegistryIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryIamBinding(java.lang.String name, AgentRegistryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryIamBinding:AgentRegistryIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryIamBinding:AgentRegistryIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryIamBindingArgs makeArgs(AgentRegistryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new AgentRegistryIamBinding(name, id, state, options);
    }
}
