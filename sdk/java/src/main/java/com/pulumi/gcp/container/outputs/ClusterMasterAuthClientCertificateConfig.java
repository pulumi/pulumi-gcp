    ...
    public static final class Builder {
        ...
        public Builder issueClientCertificate(Boolean issueClientCertificate) {
            if (issueClientCertificate == null) {
              throw new MissingRequiredPropertyException("ClusterMasterAuthClientCertificateConfig", "issueClientCertificate");
            }
            this.issueClientCertificate = issueClientCertificate;
            return this;
        }
        public ClusterMasterAuthClientCertificateConfig build() {
            final var _resultValue = new ClusterMasterAuthClientCertificateConfig();
