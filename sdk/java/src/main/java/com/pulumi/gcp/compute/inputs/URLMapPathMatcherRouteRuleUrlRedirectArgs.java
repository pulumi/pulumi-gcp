...
public final class URLMapPathMatcherRouteRuleUrlRedirectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapPathMatcherRouteRuleUrlRedirectArgs(URLMapPathMatcherRouteRuleUrlRedirectArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherRouteRuleUrlRedirectArgs();
        }

        public Builder(URLMapPathMatcherRouteRuleUrlRedirectArgs defaults) {
            $ = new URLMapPathMatcherRouteRuleUrlRedirectArgs(Objects.requireNonNull(defaults));
        }
