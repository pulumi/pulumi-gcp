 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/subnetworkIAMBinding:SubnetworkIAMBinding editor &#34;projects/{{project}}/regions/{{region}}/subnetworks/{{subnetwork}} roles/compute.networkUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class SubnetworkIAMBinding extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={SubnetworkIAMBindingCondition.class}, tree="[0]")
     ...
     * 
     */
    public Output<Optional<SubnetworkIAMBindingCondition>> condition() {
     ...
     */
    public SubnetworkIAMBinding(java.lang.String name) {
        this(name, SubnetworkIAMBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SubnetworkIAMBinding(java.lang.String name, SubnetworkIAMBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SubnetworkIAMBinding(java.lang.String name, SubnetworkIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/subnetworkIAMBinding:SubnetworkIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SubnetworkIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable SubnetworkIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/subnetworkIAMBinding:SubnetworkIAMBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SubnetworkIAMBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable SubnetworkIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
