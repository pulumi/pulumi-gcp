...
public final class AuthorityConfigX509ConfigNameConstraints {
    ...
    public static final class Builder {
        ...
        public Builder critical(Boolean critical) {
            if (critical == null) {
              throw new MissingRequiredPropertyException("AuthorityConfigX509ConfigNameConstraints", "critical");
            }
        ...
        public AuthorityConfigX509ConfigNameConstraints build() {
            final var _resultValue = new AuthorityConfigX509ConfigNameConstraints();
