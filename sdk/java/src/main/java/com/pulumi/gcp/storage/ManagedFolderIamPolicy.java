 ...
 * 
 * ```sh
 * $ pulumi import gcp:storage/managedFolderIamPolicy:ManagedFolderIamPolicy editor &#34;b/{{bucket}}/managedFolders/{{managed_folder}} roles/storage.objectViewer user:jane{@literal @}example.com&#34;
 * ```
 * 
