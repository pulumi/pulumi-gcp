...
import com.pulumi.gcp.compute.outputs.GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range;
...
public final class GetRegionInstanceTemplateNetworkInterface {
    ...
    /**
     * @return An array of alias IPv6 ranges for this network interface. Can only be specified for network interfaces on subnet-mode networks.
     * 
     */
    private List<GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range> aliasIpv6Ranges;
    /**
     ...
     * 
     */
    public List<GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range> aliasIpv6Ranges() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder aliasIpv6Ranges(List<GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range> aliasIpv6Ranges) {
            if (aliasIpv6Ranges == null) {
              throw new MissingRequiredPropertyException("GetRegionInstanceTemplateNetworkInterface", "aliasIpv6Ranges");
            }
            this.aliasIpv6Ranges = aliasIpv6Ranges;
            return this;
        }
        public Builder aliasIpv6Ranges(GetRegionInstanceTemplateNetworkInterfaceAliasIpv6Range... aliasIpv6Ranges) {
            return aliasIpv6Ranges(List.of(aliasIpv6Ranges));
        }
        @CustomType.Setter
        public Builder igmpQuery(String igmpQuery) {
            if (igmpQuery == null) {
              throw new MissingRequiredPropertyException("GetRegionInstanceTemplateNetworkInterface", "igmpQuery");
            }
