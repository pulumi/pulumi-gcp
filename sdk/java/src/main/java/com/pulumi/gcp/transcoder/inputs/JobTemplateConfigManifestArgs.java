...
public final class JobTemplateConfigManifestArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTemplateConfigManifestArgs Empty = new JobTemplateConfigManifestArgs();
    ...
    private JobTemplateConfigManifestArgs() {}

    private JobTemplateConfigManifestArgs(JobTemplateConfigManifestArgs $) {
    ...
    public static Builder builder(JobTemplateConfigManifestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTemplateConfigManifestArgs();
        }

        public Builder(JobTemplateConfigManifestArgs defaults) {
            $ = new JobTemplateConfigManifestArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobTemplateConfigManifestArgs build() {
            return $;
        }
    }
