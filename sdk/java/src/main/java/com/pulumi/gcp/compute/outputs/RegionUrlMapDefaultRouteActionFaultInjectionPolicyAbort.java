...
@CustomType
public final class RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort {
    /**
    ...
    private RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort() {}
    /**
     * @return The HTTP status code used to abort the request.
     * The value must be between 200 and 599 inclusive.
     * 
    ...
    public static Builder builder(RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double percentage;
        public Builder() {}
        public Builder(RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort defaults) {
        ...
        public RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort build() {
            final var _resultValue = new RegionUrlMapDefaultRouteActionFaultInjectionPolicyAbort();
