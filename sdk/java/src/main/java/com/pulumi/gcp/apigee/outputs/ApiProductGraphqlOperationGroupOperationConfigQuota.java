...
@CustomType
public final class ApiProductGraphqlOperationGroupOperationConfigQuota {
    /**
    ...
    public static Builder builder(ApiProductGraphqlOperationGroupOperationConfigQuota defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeUnit;
        public Builder() {}
        public Builder(ApiProductGraphqlOperationGroupOperationConfigQuota defaults) {
        ...
        public ApiProductGraphqlOperationGroupOperationConfigQuota build() {
            final var _resultValue = new ApiProductGraphqlOperationGroupOperationConfigQuota();
