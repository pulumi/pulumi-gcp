...
import com.pulumi.gcp.iap.inputs.LocationWebIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:iap/locationWebIamPolicy:LocationWebIamPolicy")
public class LocationWebIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocationWebIamPolicy(java.lang.String name) {
        this(name, LocationWebIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocationWebIamPolicy(java.lang.String name, LocationWebIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocationWebIamPolicy(java.lang.String name, LocationWebIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/locationWebIamPolicy:LocationWebIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocationWebIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable LocationWebIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/locationWebIamPolicy:LocationWebIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static LocationWebIamPolicyArgs makeArgs(LocationWebIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocationWebIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static LocationWebIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable LocationWebIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
