 ...
 * 
 * ```sh
 * $ pulumi import gcp:dns/dnsManagedZoneIamMember:DnsManagedZoneIamMember editor &#34;projects/{{project}}/managedZones/{{managed_zone}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
