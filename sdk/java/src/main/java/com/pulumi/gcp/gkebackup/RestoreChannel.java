...
import com.pulumi.gcp.gkebackup.inputs.RestoreChannelState;
 ...
 * 
 */
@ResourceType(type="gcp:gkebackup/restoreChannel:RestoreChannel")
public class RestoreChannel extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public RestoreChannel(java.lang.String name) {
        this(name, RestoreChannelArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RestoreChannel(java.lang.String name, RestoreChannelArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RestoreChannel(java.lang.String name, RestoreChannelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/restoreChannel:RestoreChannel", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RestoreChannel(java.lang.String name, Output<java.lang.String> id, @Nullable RestoreChannelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/restoreChannel:RestoreChannel", name, state, makeResourceOptions(options, id), false);
    }

    private static RestoreChannelArgs makeArgs(RestoreChannelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RestoreChannelArgs.Empty : args;
    }
     ...
     */
    public static RestoreChannel get(java.lang.String name, Output<java.lang.String> id, @Nullable RestoreChannelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
