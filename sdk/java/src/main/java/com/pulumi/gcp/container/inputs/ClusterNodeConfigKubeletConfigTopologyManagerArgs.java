...
public final class ClusterNodeConfigKubeletConfigTopologyManagerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterNodeConfigKubeletConfigTopologyManagerArgs Empty = new ClusterNodeConfigKubeletConfigTopologyManagerArgs();
    ...
    private ClusterNodeConfigKubeletConfigTopologyManagerArgs() {}

    private ClusterNodeConfigKubeletConfigTopologyManagerArgs(ClusterNodeConfigKubeletConfigTopologyManagerArgs $) {
        this.policy = $.policy;
        this.scope = $.scope;
    }
    ...
    public static Builder builder(ClusterNodeConfigKubeletConfigTopologyManagerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterNodeConfigKubeletConfigTopologyManagerArgs();
        }

        public Builder(ClusterNodeConfigKubeletConfigTopologyManagerArgs defaults) {
            $ = new ClusterNodeConfigKubeletConfigTopologyManagerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterNodeConfigKubeletConfigTopologyManagerArgs build() {
            return $;
        }
    }
