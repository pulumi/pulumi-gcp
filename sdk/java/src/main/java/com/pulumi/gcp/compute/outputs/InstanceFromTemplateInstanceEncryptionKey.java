...
@CustomType
public final class InstanceFromTemplateInstanceEncryptionKey {
    /**
    ...
    public static Builder builder(InstanceFromTemplateInstanceEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sha256;
        public Builder() {}
        public Builder(InstanceFromTemplateInstanceEncryptionKey defaults) {
        ...
        public InstanceFromTemplateInstanceEncryptionKey build() {
            final var _resultValue = new InstanceFromTemplateInstanceEncryptionKey();
