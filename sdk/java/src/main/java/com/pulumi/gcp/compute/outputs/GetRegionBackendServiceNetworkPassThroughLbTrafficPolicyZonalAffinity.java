...
@CustomType
public final class GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity {
    /**
    ...
    private GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity() {}
    /**
     * @return This field indicates whether zonal affinity is enabled or not. Default value: &#34;ZONAL_AFFINITY_DISABLED&#34; Possible values: [&#34;ZONAL_AFFINITY_DISABLED&#34;, &#34;ZONAL_AFFINITY_SPILL_CROSS_ZONE&#34;, &#34;ZONAL_AFFINITY_STAY_WITHIN_ZONE&#34;]
     * 
     */
    ...
    public static Builder builder(GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity defaults) {
    ...
    public static final class Builder {
        ...
        private Double spilloverRatio;
        public Builder() {}
        public Builder(GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity defaults) {
        ...
        public Builder spillover(String spillover) {
            if (spillover == null) {
              throw new MissingRequiredPropertyException("GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity", "spillover");
            }
        ...
        public Builder spilloverRatio(Double spilloverRatio) {
            if (spilloverRatio == null) {
              throw new MissingRequiredPropertyException("GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity", "spilloverRatio");
            }
            this.spilloverRatio = spilloverRatio;
            return this;
        }
        public GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity build() {
            final var _resultValue = new GetRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity();
