...
public final class InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs Empty = new InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs();
    ...
    private InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs() {}

    private InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs(InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs $) {
        this.day = $.day;
        this.month = $.month;
        this.year = $.year;
    }
    ...
    public static Builder builder(InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs();
        }

        public Builder(InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs defaults) {
            $ = new InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceMaintenancePolicyMaintenanceExclusionWindowEndDateArgs build() {
            return $;
        }
    }
