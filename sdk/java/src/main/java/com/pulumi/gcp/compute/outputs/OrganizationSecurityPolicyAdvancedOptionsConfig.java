...
import com.pulumi.gcp.compute.outputs.OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfig;
...
@CustomType
public final class OrganizationSecurityPolicyAdvancedOptionsConfig {
    /**
     * @return Custom JSON parsing configurations.
     * Structure is documented below.
     * 
     */
    private @Nullable OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfig jsonCustomConfig;
    /**
     ...
     * 
     */
    public Optional<OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfig> jsonCustomConfig() {
    ...
    public static Builder builder(OrganizationSecurityPolicyAdvancedOptionsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> userIpRequestHeaders;
        public Builder() {}
        public Builder(OrganizationSecurityPolicyAdvancedOptionsConfig defaults) {
        ...
        @CustomType.Setter
        public Builder jsonCustomConfig(@Nullable OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfig jsonCustomConfig) {
        ...
        public OrganizationSecurityPolicyAdvancedOptionsConfig build() {
            final var _resultValue = new OrganizationSecurityPolicyAdvancedOptionsConfig();
