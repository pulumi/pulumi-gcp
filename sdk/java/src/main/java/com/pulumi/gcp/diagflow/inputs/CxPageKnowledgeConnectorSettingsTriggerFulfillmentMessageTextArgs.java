...
public final class CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs Empty = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs();
    ...
    private CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs() {}

    private CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs $) {
    ...
    public static Builder builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs();
        }

        public Builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs defaults) {
            $ = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageTextArgs build() {
            return $;
        }
    }
