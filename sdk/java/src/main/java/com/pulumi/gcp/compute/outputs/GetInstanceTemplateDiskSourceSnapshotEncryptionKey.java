    ...
    public static final class Builder {
        ...
        public Builder kmsKeySelfLink(String kmsKeySelfLink) {
            if (kmsKeySelfLink == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceSnapshotEncryptionKey", "kmsKeySelfLink");
            }
        ...
        public Builder kmsKeyServiceAccount(String kmsKeyServiceAccount) {
            if (kmsKeyServiceAccount == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceSnapshotEncryptionKey", "kmsKeyServiceAccount");
            }
        ...
        public Builder rawKey(String rawKey) {
            if (rawKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceSnapshotEncryptionKey", "rawKey");
            }
            this.rawKey = rawKey;
            return this;
        }
        ...
        public Builder rsaEncryptedKey(String rsaEncryptedKey) {
            if (rsaEncryptedKey == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateDiskSourceSnapshotEncryptionKey", "rsaEncryptedKey");
            }
