 ...
 * 
 * ```sh
 * $ pulumi import gcp:dataplex/entryTypeIamBinding:EntryTypeIamBinding editor &#34;projects/{{project}}/locations/{{location}}/entryTypes/{{entry_type_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
