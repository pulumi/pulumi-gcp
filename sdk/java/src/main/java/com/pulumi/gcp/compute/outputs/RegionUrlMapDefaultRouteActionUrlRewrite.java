...
@CustomType
public final class RegionUrlMapDefaultRouteActionUrlRewrite {
    /**
    ...
    public static Builder builder(RegionUrlMapDefaultRouteActionUrlRewrite defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String pathPrefixRewrite;
        public Builder() {}
        public Builder(RegionUrlMapDefaultRouteActionUrlRewrite defaults) {
