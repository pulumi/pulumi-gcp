...
@CustomType
public final class BareMetalAdminClusterFleet {
    /**
     * @return (Output)
    ...
    private BareMetalAdminClusterFleet() {}
    /**
     * @return (Output)
     * The name of the managed Hub Membership resource associated to this cluster.
     * Membership names are formatted as
    ...
    public static Builder builder(BareMetalAdminClusterFleet defaults) {
    ...
    public static final class Builder {
        private @Nullable String membership;
        public Builder() {}
        public Builder(BareMetalAdminClusterFleet defaults) {
