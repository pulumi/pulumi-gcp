...
@CustomType
public final class ResizeRequestRequestedRunDuration {
    /**
    ...
    private ResizeRequestRequestedRunDuration() {}
    /**
     * @return Span of time that&#39;s a fraction of a second at nanosecond resolution. Durations less than one second are represented with a 0 seconds field and a positive nanos field. Must be from 0 to 999,999,999 inclusive.
     * 
     */
    ...
    public static Builder builder(ResizeRequestRequestedRunDuration defaults) {
    ...
    public static final class Builder {
        ...
        private String seconds;
        public Builder() {}
        public Builder(ResizeRequestRequestedRunDuration defaults) {
        ...
        public Builder seconds(String seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("ResizeRequestRequestedRunDuration", "seconds");
            }
            this.seconds = seconds;
            return this;
        }
        public ResizeRequestRequestedRunDuration build() {
            final var _resultValue = new ResizeRequestRequestedRunDuration();
