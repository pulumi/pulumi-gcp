...
import com.pulumi.gcp.cloudrunv2.inputs.WorkerPoolTemplateContainerLivenessProbeGrpcArgs;
import com.pulumi.gcp.cloudrunv2.inputs.WorkerPoolTemplateContainerLivenessProbeHttpGetArgs;
import com.pulumi.gcp.cloudrunv2.inputs.WorkerPoolTemplateContainerLivenessProbeTcpSocketArgs;
...
public final class WorkerPoolTemplateContainerLivenessProbeArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkerPoolTemplateContainerLivenessProbeArgs Empty = new WorkerPoolTemplateContainerLivenessProbeArgs();
     ...
     */
    @Import(name="grpc")
    private @Nullable Output<WorkerPoolTemplateContainerLivenessProbeGrpcArgs> grpc;
     ...
     * 
     */
    public Optional<Output<WorkerPoolTemplateContainerLivenessProbeGrpcArgs>> grpc() {
     ...
     */
    @Import(name="httpGet")
    private @Nullable Output<WorkerPoolTemplateContainerLivenessProbeHttpGetArgs> httpGet;
     ...
     * 
     */
    public Optional<Output<WorkerPoolTemplateContainerLivenessProbeHttpGetArgs>> httpGet() {
    ...
    private @Nullable Output<WorkerPoolTemplateContainerLivenessProbeTcpSocketArgs> tcpSocket;
     ...
     * 
     */
    public Optional<Output<WorkerPoolTemplateContainerLivenessProbeTcpSocketArgs>> tcpSocket() {
    ...
    private WorkerPoolTemplateContainerLivenessProbeArgs() {}

    private WorkerPoolTemplateContainerLivenessProbeArgs(WorkerPoolTemplateContainerLivenessProbeArgs $) {
    ...
    public static Builder builder(WorkerPoolTemplateContainerLivenessProbeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkerPoolTemplateContainerLivenessProbeArgs();
        }

        public Builder(WorkerPoolTemplateContainerLivenessProbeArgs defaults) {
            $ = new WorkerPoolTemplateContainerLivenessProbeArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder grpc(@Nullable Output<WorkerPoolTemplateContainerLivenessProbeGrpcArgs> grpc) {
            $.grpc = grpc;
            return this;
        }
         ...
         * 
         */
        public Builder grpc(WorkerPoolTemplateContainerLivenessProbeGrpcArgs grpc) {
         ...
         * 
         */
        public Builder httpGet(@Nullable Output<WorkerPoolTemplateContainerLivenessProbeHttpGetArgs> httpGet) {
            $.httpGet = httpGet;
            return this;
        }
         ...
         * 
         */
        public Builder httpGet(WorkerPoolTemplateContainerLivenessProbeHttpGetArgs httpGet) {
         ...
         * 
         */
        public Builder tcpSocket(@Nullable Output<WorkerPoolTemplateContainerLivenessProbeTcpSocketArgs> tcpSocket) {
            $.tcpSocket = tcpSocket;
            return this;
        }
         ...
         * 
         */
        public Builder tcpSocket(WorkerPoolTemplateContainerLivenessProbeTcpSocketArgs tcpSocket) {
        ...
        public WorkerPoolTemplateContainerLivenessProbeArgs build() {
            return $;
        }
    }
