...
public class SnapshotIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public SnapshotIamMember(String name) {
     ...
     */
    public SnapshotIamMember(String name, SnapshotIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SnapshotIamMember(String name, SnapshotIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/snapshotIamMember:SnapshotIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private SnapshotIamMember(String name, Output<String> id, @Nullable SnapshotIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/snapshotIamMember:SnapshotIamMember", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static SnapshotIamMember get(String name, Output<String> id, @Nullable SnapshotIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
