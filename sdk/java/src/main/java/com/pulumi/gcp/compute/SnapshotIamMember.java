...
import com.pulumi.gcp.compute.inputs.SnapshotIamMemberState;
import com.pulumi.gcp.compute.outputs.SnapshotIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/snapshotIamMember:SnapshotIamMember editor &#34;projects/{{project}}/global/snapshots/{{snapshot}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/snapshotIamMember:SnapshotIamMember")
public class SnapshotIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={SnapshotIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ SnapshotIamMemberCondition> condition;

    public Output<Optional<SnapshotIamMemberCondition>> condition() {
     ...
     */
    public SnapshotIamMember(java.lang.String name) {
        this(name, SnapshotIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SnapshotIamMember(java.lang.String name, SnapshotIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SnapshotIamMember(java.lang.String name, SnapshotIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/snapshotIamMember:SnapshotIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SnapshotIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable SnapshotIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/snapshotIamMember:SnapshotIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static SnapshotIamMemberArgs makeArgs(SnapshotIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SnapshotIamMemberArgs.Empty : args;
    }
     ...
     */
    public static SnapshotIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable SnapshotIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
