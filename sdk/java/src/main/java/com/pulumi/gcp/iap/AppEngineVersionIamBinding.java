...
public class AppEngineVersionIamBinding extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={AppEngineVersionIamBindingCondition.class}, tree="[0]")
     ...
     */
    public AppEngineVersionIamBinding(java.lang.String name) {
     ...
     */
    public AppEngineVersionIamBinding(java.lang.String name, AppEngineVersionIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AppEngineVersionIamBinding(java.lang.String name, AppEngineVersionIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/appEngineVersionIamBinding:AppEngineVersionIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AppEngineVersionIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AppEngineVersionIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/appEngineVersionIamBinding:AppEngineVersionIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AppEngineVersionIamBindingArgs makeArgs(AppEngineVersionIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AppEngineVersionIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AppEngineVersionIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AppEngineVersionIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
