...
import com.pulumi.gcp.networkconnectivity.inputs.HubIamBindingState;
import com.pulumi.gcp.networkconnectivity.outputs.HubIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:networkconnectivity/hubIamBinding:HubIamBinding")
public class HubIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={HubIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ HubIamBindingCondition> condition;

    public Output<Optional<HubIamBindingCondition>> condition() {
     ...
     */
    public HubIamBinding(java.lang.String name) {
        this(name, HubIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HubIamBinding(java.lang.String name, HubIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HubIamBinding(java.lang.String name, HubIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networkconnectivity/hubIamBinding:HubIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HubIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable HubIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:networkconnectivity/hubIamBinding:HubIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static HubIamBindingArgs makeArgs(HubIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HubIamBindingArgs.Empty : args;
    }
     ...
     */
    public static HubIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable HubIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
