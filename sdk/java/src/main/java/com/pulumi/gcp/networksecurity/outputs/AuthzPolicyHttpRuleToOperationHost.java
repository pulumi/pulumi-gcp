...
@CustomType
public final class AuthzPolicyHttpRuleToOperationHost {
    /**
    ...
    public static Builder builder(AuthzPolicyHttpRuleToOperationHost defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleToOperationHost defaults) {
        ...
        public AuthzPolicyHttpRuleToOperationHost build() {
            final var _resultValue = new AuthzPolicyHttpRuleToOperationHost();
