...
@CustomType
public final class RegionInstanceGroupManagerStatefulInternalIp {
    /**
    ...
    public static Builder builder(RegionInstanceGroupManagerStatefulInternalIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String interfaceName;
        public Builder() {}
        public Builder(RegionInstanceGroupManagerStatefulInternalIp defaults) {
        ...
        public RegionInstanceGroupManagerStatefulInternalIp build() {
            final var _resultValue = new RegionInstanceGroupManagerStatefulInternalIp();
