...
import com.pulumi.gcp.cloudrunv2.inputs.WorkerPoolIamBindingState;
import com.pulumi.gcp.cloudrunv2.outputs.WorkerPoolIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding editor &#34;projects/{{project}}/locations/{{location}}/workerPools/{{worker_pool}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding")
public class WorkerPoolIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={WorkerPoolIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ WorkerPoolIamBindingCondition> condition;

    public Output<Optional<WorkerPoolIamBindingCondition>> condition() {
     ...
     */
    public WorkerPoolIamBinding(java.lang.String name) {
        this(name, WorkerPoolIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WorkerPoolIamBinding(java.lang.String name, WorkerPoolIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkerPoolIamBinding(java.lang.String name, WorkerPoolIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WorkerPoolIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable WorkerPoolIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static WorkerPoolIamBindingArgs makeArgs(WorkerPoolIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WorkerPoolIamBindingArgs.Empty : args;
    }
     ...
     */
    public static WorkerPoolIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkerPoolIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new WorkerPoolIamBinding(name, id, state, options);
    }
}
