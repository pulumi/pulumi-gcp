...
import com.pulumi.gcp.oracledatabase.outputs.GetExascaleDbStorageVaultProperty;
...
public final class GetExascaleDbStorageVaultResult {
    ...
    private List<GetExascaleDbStorageVaultProperty> properties;
    ...
    public List<GetExascaleDbStorageVaultProperty> properties() {
    ...
    public static final class Builder {
        ...
        public Builder createTime(String createTime) {
            if (createTime == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "createTime");
            }
        ...
        public Builder deletionPolicy(String deletionPolicy) {
            if (deletionPolicy == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "deletionPolicy");
            }
        ...
        public Builder deletionProtection(Boolean deletionProtection) {
            if (deletionProtection == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "deletionProtection");
            }
        ...
        public Builder effectiveLabels(Map<String,String> effectiveLabels) {
            if (effectiveLabels == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "effectiveLabels");
            }
        ...
        public Builder entitlementId(String entitlementId) {
            if (entitlementId == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "entitlementId");
            }
        ...
        public Builder exadataInfrastructure(String exadataInfrastructure) {
            if (exadataInfrastructure == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "exadataInfrastructure");
            }
        ...
        public Builder gcpOracleZone(String gcpOracleZone) {
            if (gcpOracleZone == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "gcpOracleZone");
            }
        ...
        public Builder labels(Map<String,String> labels) {
            if (labels == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "labels");
            }
            this.labels = labels;
            return this;
        }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "location");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder properties(List<GetExascaleDbStorageVaultProperty> properties) {
            if (properties == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "properties");
            }
            this.properties = properties;
            return this;
        }
        public Builder properties(GetExascaleDbStorageVaultProperty... properties) {
            return properties(List.of(properties));
        }
        @CustomType.Setter
        public Builder pulumiLabels(Map<String,String> pulumiLabels) {
            if (pulumiLabels == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultResult", "pulumiLabels");
            }
