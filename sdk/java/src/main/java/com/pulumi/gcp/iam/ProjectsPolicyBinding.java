...
import com.pulumi.gcp.iam.inputs.ProjectsPolicyBindingState;
import com.pulumi.gcp.iam.outputs.ProjectsPolicyBindingCondition;
import com.pulumi.gcp.iam.outputs.ProjectsPolicyBindingTarget;
 ...
 * 
 */
@ResourceType(type="gcp:iam/projectsPolicyBinding:ProjectsPolicyBinding")
public class ProjectsPolicyBinding extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="condition", refs={ProjectsPolicyBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ ProjectsPolicyBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<ProjectsPolicyBindingCondition>> condition() {
     ...
     * 
     */
    @Export(name="target", refs={ProjectsPolicyBindingTarget.class}, tree="[0]")
    private Output<ProjectsPolicyBindingTarget> target;
     ...
     * 
     */
    public Output<ProjectsPolicyBindingTarget> target() {
        return this.target;
    }
    /**
     ...
     */
    public ProjectsPolicyBinding(java.lang.String name) {
        this(name, ProjectsPolicyBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ProjectsPolicyBinding(java.lang.String name, ProjectsPolicyBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectsPolicyBinding(java.lang.String name, ProjectsPolicyBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iam/projectsPolicyBinding:ProjectsPolicyBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectsPolicyBinding(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectsPolicyBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iam/projectsPolicyBinding:ProjectsPolicyBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectsPolicyBindingArgs makeArgs(ProjectsPolicyBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectsPolicyBindingArgs.Empty : args;
    }
     ...
     */
    public static ProjectsPolicyBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectsPolicyBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
