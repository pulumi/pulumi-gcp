...
public final class ServiceTemplateVolumeGcsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceTemplateVolumeGcsArgs Empty = new ServiceTemplateVolumeGcsArgs();
    ...
    private ServiceTemplateVolumeGcsArgs() {}
    ...
    public static Builder builder(ServiceTemplateVolumeGcsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceTemplateVolumeGcsArgs();
        }

        public Builder(ServiceTemplateVolumeGcsArgs defaults) {
            $ = new ServiceTemplateVolumeGcsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceTemplateVolumeGcsArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("ServiceTemplateVolumeGcsArgs", "bucket");
            }
            return $;
        }
    }
