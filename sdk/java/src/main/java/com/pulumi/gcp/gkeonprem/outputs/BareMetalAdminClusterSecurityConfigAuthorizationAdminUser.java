...
public final class BareMetalAdminClusterSecurityConfigAuthorizationAdminUser {
    ...
    public static final class Builder {
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("BareMetalAdminClusterSecurityConfigAuthorizationAdminUser", "username");
            }
            this.username = username;
            return this;
        }
        public BareMetalAdminClusterSecurityConfigAuthorizationAdminUser build() {
            final var _resultValue = new BareMetalAdminClusterSecurityConfigAuthorizationAdminUser();
