...
public final class PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleDictionaryWordList {
    ...
    public static final class Builder {
        ...
        public Builder words(List<String> words) {
            if (words == null) {
              throw new MissingRequiredPropertyException("PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleDictionaryWordList", "words");
            }
            this.words = words;
            return this;
        }
        ...
        public PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleDictionaryWordList build() {
            final var _resultValue = new PreventionInspectTemplateInspectConfigRuleSetRuleExclusionRuleDictionaryWordList();
