...
public final class URLMapPathMatcherHeaderActionRequestHeadersToAddArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public URLMapPathMatcherHeaderActionRequestHeadersToAddArgs build() {
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherHeaderActionRequestHeadersToAddArgs", "headerName");
            }
            if ($.headerValue == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherHeaderActionRequestHeadersToAddArgs", "headerValue");
            }
            if ($.replace == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherHeaderActionRequestHeadersToAddArgs", "replace");
            }
            return $;
        }
    }
