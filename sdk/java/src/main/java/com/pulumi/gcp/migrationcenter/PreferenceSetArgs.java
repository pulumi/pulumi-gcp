...
public final class PreferenceSetArgs extends com.pulumi.resources.ResourceArgs {

    public static final PreferenceSetArgs Empty = new PreferenceSetArgs();
     ...
     * 
     */
    @Import(name="preferenceSetId", required=true)
    ...
    private PreferenceSetArgs() {}

    private PreferenceSetArgs(PreferenceSetArgs $) {
    ...
    public static Builder builder(PreferenceSetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PreferenceSetArgs();
        }

        public Builder(PreferenceSetArgs defaults) {
            $ = new PreferenceSetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder preferenceSetId(Output<String> preferenceSetId) {
        ...
        public PreferenceSetArgs build() {
            if ($.location == null) {
                throw new MissingRequiredPropertyException("PreferenceSetArgs", "location");
            }
            if ($.preferenceSetId == null) {
                throw new MissingRequiredPropertyException("PreferenceSetArgs", "preferenceSetId");
            }
            return $;
        }
    }
