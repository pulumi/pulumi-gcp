...
public final class ApiProductState extends com.pulumi.resources.ResourceArgs {

    public static final ApiProductState Empty = new ApiProductState();
    ...
    private ApiProductState() {}

    private ApiProductState(ApiProductState $) {
    ...
    public static Builder builder(ApiProductState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApiProductState defaults) {
            $ = new ApiProductState(Objects.requireNonNull(defaults));
        }
