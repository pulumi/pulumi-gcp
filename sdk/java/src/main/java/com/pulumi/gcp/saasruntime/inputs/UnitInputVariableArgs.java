...
public final class UnitInputVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final UnitInputVariableArgs Empty = new UnitInputVariableArgs();
    ...
    private UnitInputVariableArgs() {}

    private UnitInputVariableArgs(UnitInputVariableArgs $) {
        this.type = $.type;
        this.value = $.value;
    ...
    public static Builder builder(UnitInputVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UnitInputVariableArgs();
        }

        public Builder(UnitInputVariableArgs defaults) {
            $ = new UnitInputVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UnitInputVariableArgs build() {
            if ($.variable == null) {
                throw new MissingRequiredPropertyException("UnitInputVariableArgs", "variable");
            }
            return $;
        }
    }
