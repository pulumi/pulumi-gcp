...
import com.pulumi.gcp.iot.inputs.RegistryIamBindingState;
import com.pulumi.gcp.iot.outputs.RegistryIamBindingCondition;
...
public class RegistryIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public RegistryIamBinding(String name) {
        this(name, RegistryIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RegistryIamBinding(String name, RegistryIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RegistryIamBinding(String name, RegistryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iot/registryIamBinding:RegistryIamBinding", name, args == null ? RegistryIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private RegistryIamBinding(String name, Output<String> id, @Nullable RegistryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iot/registryIamBinding:RegistryIamBinding", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegistryIamBinding get(String name, Output<String> id, @Nullable RegistryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
