...
public final class InstanceDenyMaintenancePeriodStartDateArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceDenyMaintenancePeriodStartDateArgs Empty = new InstanceDenyMaintenancePeriodStartDateArgs();
    ...
    private InstanceDenyMaintenancePeriodStartDateArgs() {}

    private InstanceDenyMaintenancePeriodStartDateArgs(InstanceDenyMaintenancePeriodStartDateArgs $) {
        this.day = $.day;
        this.month = $.month;
        this.year = $.year;
    }
    ...
    public static Builder builder(InstanceDenyMaintenancePeriodStartDateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceDenyMaintenancePeriodStartDateArgs();
        }

        public Builder(InstanceDenyMaintenancePeriodStartDateArgs defaults) {
            $ = new InstanceDenyMaintenancePeriodStartDateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceDenyMaintenancePeriodStartDateArgs build() {
            return $;
        }
    }
