...
@CustomType
public final class RouterStatusBestRoutesForRouterAsPath {
    /**
    ...
    private RouterStatusBestRoutesForRouterAsPath() {}
    /**
     * @return The AS numbers of the AS Path.
     * 
     */
    ...
    public static Builder builder(RouterStatusBestRoutesForRouterAsPath defaults) {
    ...
    public static final class Builder {
        ...
        private String pathSegmentType;
        public Builder() {}
        public Builder(RouterStatusBestRoutesForRouterAsPath defaults) {
        ...
        public Builder asLists(List<Integer> asLists) {
            if (asLists == null) {
              throw new MissingRequiredPropertyException("RouterStatusBestRoutesForRouterAsPath", "asLists");
            }
        ...
        public Builder pathSegmentType(String pathSegmentType) {
            if (pathSegmentType == null) {
              throw new MissingRequiredPropertyException("RouterStatusBestRoutesForRouterAsPath", "pathSegmentType");
            }
            this.pathSegmentType = pathSegmentType;
            return this;
        }
        public RouterStatusBestRoutesForRouterAsPath build() {
            final var _resultValue = new RouterStatusBestRoutesForRouterAsPath();
