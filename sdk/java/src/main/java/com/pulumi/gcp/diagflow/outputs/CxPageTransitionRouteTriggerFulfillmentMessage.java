...
import com.pulumi.gcp.diagflow.outputs.CxPageTransitionRouteTriggerFulfillmentMessageConversationSuccess;
import com.pulumi.gcp.diagflow.outputs.CxPageTransitionRouteTriggerFulfillmentMessageLiveAgentHandoff;
import com.pulumi.gcp.diagflow.outputs.CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText;
import com.pulumi.gcp.diagflow.outputs.CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio;
import com.pulumi.gcp.diagflow.outputs.CxPageTransitionRouteTriggerFulfillmentMessageTelephonyTransferCall;
...
public final class CxPageTransitionRouteTriggerFulfillmentMessage {
     ...
     * 
     */
    private @Nullable CxPageTransitionRouteTriggerFulfillmentMessageConversationSuccess conversationSuccess;
    /**
     ...
     * 
     */
    private @Nullable CxPageTransitionRouteTriggerFulfillmentMessageLiveAgentHandoff liveAgentHandoff;
    /**
     ...
     * 
     */
    private @Nullable CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText outputAudioText;
    /**
     ...
     * 
     */
    private @Nullable CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio playAudio;
    /**
     ...
     * 
     */
    private @Nullable CxPageTransitionRouteTriggerFulfillmentMessageTelephonyTransferCall telephonyTransferCall;
    /**
     ...
     * 
     */
    public Optional<CxPageTransitionRouteTriggerFulfillmentMessageConversationSuccess> conversationSuccess() {
     ...
     * 
     */
    public Optional<CxPageTransitionRouteTriggerFulfillmentMessageLiveAgentHandoff> liveAgentHandoff() {
     ...
     * 
     */
    public Optional<CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText> outputAudioText() {
     ...
     * 
     */
    public Optional<CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio> playAudio() {
     ...
     * 
     */
    public Optional<CxPageTransitionRouteTriggerFulfillmentMessageTelephonyTransferCall> telephonyTransferCall() {
    ...
    public static final class Builder {
        ...
        public CxPageTransitionRouteTriggerFulfillmentMessage build() {
            final var _resultValue = new CxPageTransitionRouteTriggerFulfillmentMessage();
