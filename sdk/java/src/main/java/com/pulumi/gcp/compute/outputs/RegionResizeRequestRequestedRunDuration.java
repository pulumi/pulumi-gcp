...
@CustomType
public final class RegionResizeRequestRequestedRunDuration {
    /**
    ...
    public static Builder builder(RegionResizeRequestRequestedRunDuration defaults) {
    ...
    public static final class Builder {
        ...
        private String seconds;
        public Builder() {}
        public Builder(RegionResizeRequestRequestedRunDuration defaults) {
        ...
        public Builder seconds(String seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("RegionResizeRequestRequestedRunDuration", "seconds");
            }
            this.seconds = seconds;
            return this;
        }
        public RegionResizeRequestRequestedRunDuration build() {
            final var _resultValue = new RegionResizeRequestRequestedRunDuration();
