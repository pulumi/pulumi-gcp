...
import com.pulumi.gcp.securitycenter.inputs.V2OrganizationSccBigQueryExportsState;
 ...
 * 
 */
@ResourceType(type="gcp:securitycenter/v2OrganizationSccBigQueryExports:V2OrganizationSccBigQueryExports")
public class V2OrganizationSccBigQueryExports extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public V2OrganizationSccBigQueryExports(java.lang.String name) {
        this(name, V2OrganizationSccBigQueryExportsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public V2OrganizationSccBigQueryExports(java.lang.String name, V2OrganizationSccBigQueryExportsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public V2OrganizationSccBigQueryExports(java.lang.String name, V2OrganizationSccBigQueryExportsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2OrganizationSccBigQueryExports:V2OrganizationSccBigQueryExports", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private V2OrganizationSccBigQueryExports(java.lang.String name, Output<java.lang.String> id, @Nullable V2OrganizationSccBigQueryExportsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:securitycenter/v2OrganizationSccBigQueryExports:V2OrganizationSccBigQueryExports", name, state, makeResourceOptions(options, id), false);
    }

    private static V2OrganizationSccBigQueryExportsArgs makeArgs(V2OrganizationSccBigQueryExportsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? V2OrganizationSccBigQueryExportsArgs.Empty : args;
    }
     ...
     */
    public static V2OrganizationSccBigQueryExports get(java.lang.String name, Output<java.lang.String> id, @Nullable V2OrganizationSccBigQueryExportsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
