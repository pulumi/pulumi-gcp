...
@CustomType
public final class AzureNodePoolManagement {
    /**
    ...
    private AzureNodePoolManagement() {}
    /**
     * @return Optional. Whether or not the nodes will be automatically repaired.
     * 
     */
    ...
    public static Builder builder(AzureNodePoolManagement defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean autoRepair;
        public Builder() {}
        public Builder(AzureNodePoolManagement defaults) {
