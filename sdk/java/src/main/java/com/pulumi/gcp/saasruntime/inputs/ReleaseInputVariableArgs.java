...
public final class ReleaseInputVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReleaseInputVariableArgs Empty = new ReleaseInputVariableArgs();
    ...
    private ReleaseInputVariableArgs() {}

    private ReleaseInputVariableArgs(ReleaseInputVariableArgs $) {
        this.type = $.type;
        this.value = $.value;
    ...
    public static Builder builder(ReleaseInputVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReleaseInputVariableArgs();
        }

        public Builder(ReleaseInputVariableArgs defaults) {
            $ = new ReleaseInputVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReleaseInputVariableArgs build() {
            if ($.variable == null) {
                throw new MissingRequiredPropertyException("ReleaseInputVariableArgs", "variable");
            }
            return $;
        }
    }
