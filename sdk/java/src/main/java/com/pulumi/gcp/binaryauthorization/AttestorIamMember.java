 ...
 * 
 * ```sh
 * $ pulumi import gcp:binaryauthorization/attestorIamMember:AttestorIamMember editor &#34;projects/{{project}}/attestors/{{attestor}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class AttestorIamMember extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AttestorIamMember(java.lang.String name) {
     ...
     */
    public AttestorIamMember(java.lang.String name, AttestorIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AttestorIamMember(java.lang.String name, AttestorIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:binaryauthorization/attestorIamMember:AttestorIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AttestorIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable AttestorIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:binaryauthorization/attestorIamMember:AttestorIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static AttestorIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable AttestorIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
