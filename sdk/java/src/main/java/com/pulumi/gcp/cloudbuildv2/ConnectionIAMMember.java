...
import com.pulumi.gcp.cloudbuildv2.inputs.ConnectionIAMMemberState;
import com.pulumi.gcp.cloudbuildv2.outputs.ConnectionIAMMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudbuildv2/connectionIAMMember:ConnectionIAMMember editor &#34;projects/{{project}}/locations/{{location}}/connections/{{connection}} roles/cloudbuild.connectionViewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudbuildv2/connectionIAMMember:ConnectionIAMMember")
public class ConnectionIAMMember extends com.pulumi.resources.CustomResource {
    ...
    public ConnectionIAMMember(java.lang.String name, ConnectionIAMMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudbuildv2/connectionIAMMember:ConnectionIAMMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ConnectionIAMMember(java.lang.String name, Output<java.lang.String> id, @Nullable ConnectionIAMMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudbuildv2/connectionIAMMember:ConnectionIAMMember", name, state, makeResourceOptions(options, id), false);
    }
