...
import com.pulumi.gcp.beyondcorp.inputs.SecurityGatewayIamMemberState;
import com.pulumi.gcp.beyondcorp.outputs.SecurityGatewayIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:beyondcorp/securityGatewayIamMember:SecurityGatewayIamMember editor &#34;projects/{{project}}/locations/{{location}}/securityGateways/{{security_gateway_id}} roles/beyondcorp.securityGatewayUser user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:beyondcorp/securityGatewayIamMember:SecurityGatewayIamMember")
public class SecurityGatewayIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={SecurityGatewayIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ SecurityGatewayIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<SecurityGatewayIamMemberCondition>> condition() {
     ...
     */
    public SecurityGatewayIamMember(java.lang.String name) {
        this(name, SecurityGatewayIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SecurityGatewayIamMember(java.lang.String name, SecurityGatewayIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SecurityGatewayIamMember(java.lang.String name, SecurityGatewayIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayIamMember:SecurityGatewayIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SecurityGatewayIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayIamMember:SecurityGatewayIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static SecurityGatewayIamMemberArgs makeArgs(SecurityGatewayIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SecurityGatewayIamMemberArgs.Empty : args;
    }
     ...
     */
    public static SecurityGatewayIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SecurityGatewayIamMember(name, id, state, options);
    }
}
