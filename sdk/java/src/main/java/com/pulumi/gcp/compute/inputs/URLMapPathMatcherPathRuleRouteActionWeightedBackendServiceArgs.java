    ...
    public static final class Builder {
        ...
        public URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs build() {
            if ($.backendService == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs", "backendService");
            }
            if ($.weight == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherPathRuleRouteActionWeightedBackendServiceArgs", "weight");
            }
            return $;
        }
    }
