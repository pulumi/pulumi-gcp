    ...
    public static final class Builder {
        ...
        public Builder pluginInstance(String pluginInstance) {
            if (pluginInstance == null) {
              throw new MissingRequiredPropertyException("ClientTlsPolicyServerValidationCaCertificateProviderInstance", "pluginInstance");
            }
            this.pluginInstance = pluginInstance;
            return this;
        }
        public ClientTlsPolicyServerValidationCaCertificateProviderInstance build() {
            final var _resultValue = new ClientTlsPolicyServerValidationCaCertificateProviderInstance();
