...
public final class FolderFeedConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FolderFeedConditionArgs(FolderFeedConditionArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FolderFeedConditionArgs();
        }

        public Builder(FolderFeedConditionArgs defaults) {
            $ = new FolderFeedConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FolderFeedConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("FolderFeedConditionArgs", "expression");
            }
            return $;
        }
    }
