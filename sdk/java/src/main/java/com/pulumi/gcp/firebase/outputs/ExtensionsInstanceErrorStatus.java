...
@CustomType
public final class ExtensionsInstanceErrorStatus {
    /**
    ...
    public static Builder builder(ExtensionsInstanceErrorStatus defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String message;
        public Builder() {}
        public Builder(ExtensionsInstanceErrorStatus defaults) {
