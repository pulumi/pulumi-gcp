...
public final class GetNpmPackageArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetNpmPackageArgs Empty = new GetNpmPackageArgs();
    ...
    private GetNpmPackageArgs() {}

    private GetNpmPackageArgs(GetNpmPackageArgs $) {
    ...
    public static Builder builder(GetNpmPackageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetNpmPackageArgs();
        }

        public Builder(GetNpmPackageArgs defaults) {
            $ = new GetNpmPackageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetNpmPackageArgs build() {
            if ($.location == null) {
                throw new MissingRequiredPropertyException("GetNpmPackageArgs", "location");
            }
            if ($.packageName == null) {
                throw new MissingRequiredPropertyException("GetNpmPackageArgs", "packageName");
            }
            if ($.repositoryId == null) {
                throw new MissingRequiredPropertyException("GetNpmPackageArgs", "repositoryId");
            }
            return $;
        }
    }
