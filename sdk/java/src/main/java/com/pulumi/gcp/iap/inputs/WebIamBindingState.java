...
public final class WebIamBindingState extends com.pulumi.resources.ResourceArgs {
    ...
    private WebIamBindingState(WebIamBindingState $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebIamBindingState();
        }

        public Builder(WebIamBindingState defaults) {
            $ = new WebIamBindingState(Objects.requireNonNull(defaults));
        }
