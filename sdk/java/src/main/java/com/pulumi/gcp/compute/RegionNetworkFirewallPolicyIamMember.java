...
import com.pulumi.gcp.compute.inputs.RegionNetworkFirewallPolicyIamMemberState;
import com.pulumi.gcp.compute.outputs.RegionNetworkFirewallPolicyIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:compute/regionNetworkFirewallPolicyIamMember:RegionNetworkFirewallPolicyIamMember")
public class RegionNetworkFirewallPolicyIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={RegionNetworkFirewallPolicyIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ RegionNetworkFirewallPolicyIamMemberCondition> condition;

    public Output<Optional<RegionNetworkFirewallPolicyIamMemberCondition>> condition() {
     ...
     */
    public RegionNetworkFirewallPolicyIamMember(java.lang.String name) {
        this(name, RegionNetworkFirewallPolicyIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RegionNetworkFirewallPolicyIamMember(java.lang.String name, RegionNetworkFirewallPolicyIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RegionNetworkFirewallPolicyIamMember(java.lang.String name, RegionNetworkFirewallPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionNetworkFirewallPolicyIamMember:RegionNetworkFirewallPolicyIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RegionNetworkFirewallPolicyIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable RegionNetworkFirewallPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionNetworkFirewallPolicyIamMember:RegionNetworkFirewallPolicyIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static RegionNetworkFirewallPolicyIamMemberArgs makeArgs(RegionNetworkFirewallPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RegionNetworkFirewallPolicyIamMemberArgs.Empty : args;
    }
     ...
     */
    public static RegionNetworkFirewallPolicyIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable RegionNetworkFirewallPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RegionNetworkFirewallPolicyIamMember(name, id, state, options);
    }
}
