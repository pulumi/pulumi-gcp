...
@CustomType
public final class PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeDictionaryWordList {
    /**
    ...
    private PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeDictionaryWordList() {}
    /**
     * @return Words or phrases defining the dictionary. The dictionary must contain at least one
     * phrase and every phrase must contain at least 2 characters that are letters or digits.
     * 
    ...
    public static Builder builder(PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeDictionaryWordList defaults) {
    ...
    public static final class Builder {
        private List<String> words;
        public Builder() {}
        public Builder(PreventionJobTriggerInspectJobInspectConfigCustomInfoTypeDictionaryWordList defaults) {
