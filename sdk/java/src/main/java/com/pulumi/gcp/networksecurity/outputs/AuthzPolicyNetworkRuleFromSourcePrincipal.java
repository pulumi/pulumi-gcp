...
import com.pulumi.gcp.networksecurity.outputs.AuthzPolicyNetworkRuleFromSourcePrincipalPrincipal;
...
@CustomType
public final class AuthzPolicyNetworkRuleFromSourcePrincipal {
    /**
     ...
     * 
     */
    private @Nullable AuthzPolicyNetworkRuleFromSourcePrincipalPrincipal principal;
    /**
     ...
     * 
     */
    public Optional<AuthzPolicyNetworkRuleFromSourcePrincipalPrincipal> principal() {
    ...
    public static Builder builder(AuthzPolicyNetworkRuleFromSourcePrincipal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String principalSelector;
        public Builder() {}
        public Builder(AuthzPolicyNetworkRuleFromSourcePrincipal defaults) {
        ...
        @CustomType.Setter
        public Builder principal(@Nullable AuthzPolicyNetworkRuleFromSourcePrincipalPrincipal principal) {
        ...
        public AuthzPolicyNetworkRuleFromSourcePrincipal build() {
            final var _resultValue = new AuthzPolicyNetworkRuleFromSourcePrincipal();
