...
import com.pulumi.gcp.cloudquota.outputs.GetSQuotaInfosQuotaInfoDimensionsInfo;
import com.pulumi.gcp.cloudquota.outputs.GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility;
...
@CustomType
public final class GetSQuotaInfosQuotaInfo {
    /**
     ...
     * 
     */
    private List<GetSQuotaInfosQuotaInfoDimensionsInfo> dimensionsInfos;
    /**
     ...
     * 
     */
    private List<GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility> quotaIncreaseEligibilities;
    /**
    ...
    private GetSQuotaInfosQuotaInfo() {}
    /**
     * @return (Output) The container type of the QuotaInfo.
     * 
     */
     ...
     * 
     */
    public List<GetSQuotaInfosQuotaInfoDimensionsInfo> dimensionsInfos() {
     ...
     * 
     */
    public List<GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility> quotaIncreaseEligibilities() {
    ...
    public static Builder builder(GetSQuotaInfosQuotaInfo defaults) {
    ...
    public static final class Builder {
        ...
        private String serviceRequestQuotaUri;
        public Builder() {}
        public Builder(GetSQuotaInfosQuotaInfo defaults) {
        ...
        public Builder containerType(String containerType) {
            if (containerType == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "containerType");
            }
        ...
        public Builder dimensions(List<String> dimensions) {
            if (dimensions == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "dimensions");
            }
        ...
        @CustomType.Setter
        public Builder dimensionsInfos(List<GetSQuotaInfosQuotaInfoDimensionsInfo> dimensionsInfos) {
            if (dimensionsInfos == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "dimensionsInfos");
            }
            this.dimensionsInfos = dimensionsInfos;
            return this;
        }
        public Builder dimensionsInfos(GetSQuotaInfosQuotaInfoDimensionsInfo... dimensionsInfos) {
            return dimensionsInfos(List.of(dimensionsInfos));
        }
        @CustomType.Setter
        public Builder isConcurrent(Boolean isConcurrent) {
            if (isConcurrent == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "isConcurrent");
            }
        ...
        public Builder isFixed(Boolean isFixed) {
            if (isFixed == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "isFixed");
            }
        ...
        public Builder isPrecise(Boolean isPrecise) {
            if (isPrecise == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "isPrecise");
            }
        ...
        public Builder metric(String metric) {
            if (metric == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "metric");
            }
            this.metric = metric;
            return this;
        }
        ...
        public Builder metricDisplayName(String metricDisplayName) {
            if (metricDisplayName == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "metricDisplayName");
            }
        ...
        public Builder metricUnit(String metricUnit) {
            if (metricUnit == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "metricUnit");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder quotaDisplayName(String quotaDisplayName) {
            if (quotaDisplayName == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "quotaDisplayName");
            }
        ...
        public Builder quotaId(String quotaId) {
            if (quotaId == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "quotaId");
            }
            this.quotaId = quotaId;
            return this;
        }
        @CustomType.Setter
        public Builder quotaIncreaseEligibilities(List<GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility> quotaIncreaseEligibilities) {
            if (quotaIncreaseEligibilities == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "quotaIncreaseEligibilities");
            }
            this.quotaIncreaseEligibilities = quotaIncreaseEligibilities;
            return this;
        }
        public Builder quotaIncreaseEligibilities(GetSQuotaInfosQuotaInfoQuotaIncreaseEligibility... quotaIncreaseEligibilities) {
        ...
        public Builder refreshInterval(String refreshInterval) {
            if (refreshInterval == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "refreshInterval");
            }
        ...
        public Builder service(String service) {
            if (service == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "service");
            }
        ...
        public Builder serviceRequestQuotaUri(String serviceRequestQuotaUri) {
            if (serviceRequestQuotaUri == null) {
              throw new MissingRequiredPropertyException("GetSQuotaInfosQuotaInfo", "serviceRequestQuotaUri");
            }
            this.serviceRequestQuotaUri = serviceRequestQuotaUri;
            return this;
        }
        public GetSQuotaInfosQuotaInfo build() {
            final var _resultValue = new GetSQuotaInfosQuotaInfo();
