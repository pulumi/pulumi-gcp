...
@CustomType
public final class HttpRouteRuleActionResponseHeaderModifier {
    /**
    ...
    public static Builder builder(HttpRouteRuleActionResponseHeaderModifier defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> set;
        public Builder() {}
        public Builder(HttpRouteRuleActionResponseHeaderModifier defaults) {
