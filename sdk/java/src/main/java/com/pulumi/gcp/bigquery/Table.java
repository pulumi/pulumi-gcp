...
public class Table extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="generatedSchemaColumns", refs={String.class}, tree="[0]")
    private Output<String> generatedSchemaColumns;

    /**
     * @return (Output-only) A list of autogenerated schema fields.
     * 
     */
    public Output<String> generatedSchemaColumns() {
        return this.generatedSchemaColumns;
    }
    @Export(name="ignoreAutoGeneratedSchema", refs={Boolean.class}, tree="[0]")
    private Output</* @Nullable */ Boolean> ignoreAutoGeneratedSchema;

    public Output<Optional<Boolean>> ignoreAutoGeneratedSchema() {
        return Codegen.optional(this.ignoreAutoGeneratedSchema);
    }
    /**
