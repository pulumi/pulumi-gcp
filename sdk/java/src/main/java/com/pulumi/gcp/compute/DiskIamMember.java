 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/diskIamMember:DiskIamMember editor &#34;projects/{{project}}/zones/{{zone}}/disks/{{disk}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class DiskIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={DiskIamMemberCondition.class}, tree="[0]")
     ...
     */
    public DiskIamMember(java.lang.String name) {
        this(name, DiskIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DiskIamMember(java.lang.String name, DiskIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DiskIamMember(java.lang.String name, DiskIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/diskIamMember:DiskIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DiskIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable DiskIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/diskIamMember:DiskIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static DiskIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable DiskIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
