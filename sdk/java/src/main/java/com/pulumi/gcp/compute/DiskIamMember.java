...
public class DiskIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public DiskIamMember(String name) {
     ...
     */
    public DiskIamMember(String name, DiskIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static DiskIamMember get(String name, Output<String> id, @Nullable DiskIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
