...
public final class PreventionJobTriggerInspectJobActionSaveFindingsOutputConfigTable {
    ...
    public static final class Builder {
        ...
        public Builder datasetId(String datasetId) {
            if (datasetId == null) {
              throw new MissingRequiredPropertyException("PreventionJobTriggerInspectJobActionSaveFindingsOutputConfigTable", "datasetId");
            }
        ...
        public Builder projectId(String projectId) {
            if (projectId == null) {
              throw new MissingRequiredPropertyException("PreventionJobTriggerInspectJobActionSaveFindingsOutputConfigTable", "projectId");
            }
