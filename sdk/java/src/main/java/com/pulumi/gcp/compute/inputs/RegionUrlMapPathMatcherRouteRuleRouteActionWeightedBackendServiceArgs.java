...
public final class RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionArgs>> headerAction() {
    ...
    private RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs(RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs();
        }

        public Builder(RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs defaults) {
            $ = new RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headerAction(RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionArgs headerAction) {
        ...
        public RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs build() {
            if ($.backendService == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs", "backendService");
            }
            if ($.weight == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceArgs", "weight");
            }
            return $;
        }
    }
