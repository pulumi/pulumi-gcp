 ...
 *                     .resourceLink(primary.id().apply(id -&gt; String.format(&#34;//container.googleapis.com/%s&#34;, id)))
 *                     .build())
 *                 .build())
 *             .membershipId(&#34;basic&#34;)
 *             .build());
 ...
 *                 .issuer(primary.id().apply(id -&gt; String.format(&#34;https://container.googleapis.com/v1/%s&#34;, id)))
 *                 .build())
 *             .build());
 * 
 *     }
