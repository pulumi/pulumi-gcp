...
import com.pulumi.gcp.accesscontextmanager.inputs.ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs;
...
public final class ServicePerimeterDryRunEgressPolicyEgressFromArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServicePerimeterDryRunEgressPolicyEgressFromArgs Empty = new ServicePerimeterDryRunEgressPolicyEgressFromArgs();
     ...
     */
    @Import(name="sources")
    private @Nullable Output<List<ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs>> sources;
     ...
     * 
     */
    public Optional<Output<List<ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs>>> sources() {
        return Optional.ofNullable(this.sources);
    }

    private ServicePerimeterDryRunEgressPolicyEgressFromArgs() {}

    private ServicePerimeterDryRunEgressPolicyEgressFromArgs(ServicePerimeterDryRunEgressPolicyEgressFromArgs $) {
    ...
    public static Builder builder(ServicePerimeterDryRunEgressPolicyEgressFromArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServicePerimeterDryRunEgressPolicyEgressFromArgs();
        }

        public Builder(ServicePerimeterDryRunEgressPolicyEgressFromArgs defaults) {
            $ = new ServicePerimeterDryRunEgressPolicyEgressFromArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sources(@Nullable Output<List<ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs>> sources) {
            $.sources = sources;
            return this;
        }
         ...
         * 
         */
        public Builder sources(List<ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs> sources) {
         ...
         * 
         */
        public Builder sources(ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs... sources) {
            return sources(List.of(sources));
        }

        public ServicePerimeterDryRunEgressPolicyEgressFromArgs build() {
            return $;
        }
    }
