...
@CustomType
public final class GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim {
    /**
    ...
    private GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim() {}
    /**
     * @return Defines percentage of minimum reclaim for imagefs.available.
     * 
     */
    ...
    public static Builder builder(GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim defaults) {
    ...
    public static final class Builder {
        ...
        private String pidAvailable;
        public Builder() {}
        public Builder(GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim defaults) {
        ...
        public Builder imagefsAvailable(String imagefsAvailable) {
            if (imagefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim", "imagefsAvailable");
            }
        ...
        public Builder imagefsInodesFree(String imagefsInodesFree) {
            if (imagefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim", "imagefsInodesFree");
            }
        ...
        public Builder memoryAvailable(String memoryAvailable) {
            if (memoryAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim", "memoryAvailable");
            }
        ...
        public Builder nodefsAvailable(String nodefsAvailable) {
            if (nodefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim", "nodefsAvailable");
            }
        ...
        public Builder nodefsInodesFree(String nodefsInodesFree) {
            if (nodefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim", "nodefsInodesFree");
            }
        ...
        public Builder pidAvailable(String pidAvailable) {
            if (pidAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim", "pidAvailable");
            }
            this.pidAvailable = pidAvailable;
            return this;
        }
        public GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim build() {
            final var _resultValue = new GetClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaim();
