...
@CustomType
public final class GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod {
    /**
    ...
    private GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod() {}
    /**
     * @return Defines grace period for the imagefs.available soft eviction threshold
     * 
     */
    ...
    public static Builder builder(GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod defaults) {
    ...
    public static final class Builder {
        ...
        private String pidAvailable;
        public Builder() {}
        public Builder(GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod defaults) {
        ...
        public Builder imagefsAvailable(String imagefsAvailable) {
            if (imagefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod", "imagefsAvailable");
            }
        ...
        public Builder imagefsInodesFree(String imagefsInodesFree) {
            if (imagefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod", "imagefsInodesFree");
            }
        ...
        public Builder memoryAvailable(String memoryAvailable) {
            if (memoryAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod", "memoryAvailable");
            }
        ...
        public Builder nodefsAvailable(String nodefsAvailable) {
            if (nodefsAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod", "nodefsAvailable");
            }
        ...
        public Builder nodefsInodesFree(String nodefsInodesFree) {
            if (nodefsInodesFree == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod", "nodefsInodesFree");
            }
        ...
        public Builder pidAvailable(String pidAvailable) {
            if (pidAvailable == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod", "pidAvailable");
            }
            this.pidAvailable = pidAvailable;
            return this;
        }
        public GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod build() {
            final var _resultValue = new GetClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriod();
