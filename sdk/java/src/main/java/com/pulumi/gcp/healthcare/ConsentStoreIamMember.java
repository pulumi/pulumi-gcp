 ...
 * 
 * ```sh
 * $ pulumi import gcp:healthcare/consentStoreIamMember:ConsentStoreIamMember editor &#34;{{dataset}}/consentStores/{{consent_store}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class ConsentStoreIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public ConsentStoreIamMember(java.lang.String name) {
     ...
     */
    public ConsentStoreIamMember(java.lang.String name, ConsentStoreIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ConsentStoreIamMember(java.lang.String name, ConsentStoreIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:healthcare/consentStoreIamMember:ConsentStoreIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ConsentStoreIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable ConsentStoreIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:healthcare/consentStoreIamMember:ConsentStoreIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ConsentStoreIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable ConsentStoreIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
