...
public class FunctionIamMember extends com.pulumi.resources.CustomResource {
    ...
    public FunctionIamMember(java.lang.String name, FunctionIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudfunctionsv2/functionIamMember:FunctionIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private FunctionIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudfunctionsv2/functionIamMember:FunctionIamMember", name, state, makeResourceOptions(options, id), false);
    }
