...
import com.pulumi.gcp.compute.outputs.GetRegionBackendServiceTlsSettingSubjectAltName;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetRegionBackendServiceTlsSetting {
    /**
     ...
     * 
     */
    private List<GetRegionBackendServiceTlsSettingSubjectAltName> subjectAltNames;

    private GetRegionBackendServiceTlsSetting() {}
    /**
     * @return Reference to the BackendAuthenticationConfig resource from the networksecurity.googleapis.com namespace.
     * Can be used in authenticating TLS connections to the backend, as specified by the authenticationMode field.
     * Can only be specified if authenticationMode is not NONE.
     ...
     * 
     */
    public List<GetRegionBackendServiceTlsSettingSubjectAltName> subjectAltNames() {
    ...
    public static Builder builder(GetRegionBackendServiceTlsSetting defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetRegionBackendServiceTlsSettingSubjectAltName> subjectAltNames;
        public Builder() {}
        public Builder(GetRegionBackendServiceTlsSetting defaults) {
        ...
        public Builder authenticationConfig(String authenticationConfig) {
            if (authenticationConfig == null) {
              throw new MissingRequiredPropertyException("GetRegionBackendServiceTlsSetting", "authenticationConfig");
            }
        ...
        public Builder sni(String sni) {
            if (sni == null) {
              throw new MissingRequiredPropertyException("GetRegionBackendServiceTlsSetting", "sni");
            }
            this.sni = sni;
            return this;
        }
        @CustomType.Setter
        public Builder subjectAltNames(List<GetRegionBackendServiceTlsSettingSubjectAltName> subjectAltNames) {
            if (subjectAltNames == null) {
              throw new MissingRequiredPropertyException("GetRegionBackendServiceTlsSetting", "subjectAltNames");
            }
            this.subjectAltNames = subjectAltNames;
            return this;
        }
        public Builder subjectAltNames(GetRegionBackendServiceTlsSettingSubjectAltName... subjectAltNames) {
            return subjectAltNames(List.of(subjectAltNames));
        }
        public GetRegionBackendServiceTlsSetting build() {
            final var _resultValue = new GetRegionBackendServiceTlsSetting();
