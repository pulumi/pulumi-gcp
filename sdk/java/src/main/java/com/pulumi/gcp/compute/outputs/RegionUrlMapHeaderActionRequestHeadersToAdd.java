...
@CustomType
public final class RegionUrlMapHeaderActionRequestHeadersToAdd {
    /**
    ...
    private RegionUrlMapHeaderActionRequestHeadersToAdd() {}
    /**
     * @return The name of the header.
     * 
     */
    ...
    public static Builder builder(RegionUrlMapHeaderActionRequestHeadersToAdd defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean replace;
        public Builder() {}
        public Builder(RegionUrlMapHeaderActionRequestHeadersToAdd defaults) {
        ...
        public RegionUrlMapHeaderActionRequestHeadersToAdd build() {
            final var _resultValue = new RegionUrlMapHeaderActionRequestHeadersToAdd();
