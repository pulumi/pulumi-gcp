 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/instanceIAMBinding:InstanceIAMBinding editor &#34;projects/{{project}}/zones/{{zone}}/instances/{{instance}} roles/compute.osLogin user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class InstanceIAMBinding extends com.pulumi.resources.CustomResource {
    ...
    public InstanceIAMBinding(java.lang.String name, InstanceIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instanceIAMBinding:InstanceIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InstanceIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instanceIAMBinding:InstanceIAMBinding", name, state, makeResourceOptions(options, id), false);
    }
