...
@CustomType
public final class GetClusterNodePoolNodeConfigBootDisk {
    /**
    ...
    private GetClusterNodePoolNodeConfigBootDisk() {}
    /**
     * @return Type of the disk attached to each node. Such as pd-standard, pd-balanced or pd-ssd
     * 
     */
    ...
    public static Builder builder(GetClusterNodePoolNodeConfigBootDisk defaults) {
    ...
    public static final class Builder {
        ...
        private Integer sizeGb;
        public Builder() {}
        public Builder(GetClusterNodePoolNodeConfigBootDisk defaults) {
        ...
        public Builder diskType(String diskType) {
            if (diskType == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigBootDisk", "diskType");
            }
        ...
        public Builder provisionedIops(Integer provisionedIops) {
            if (provisionedIops == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigBootDisk", "provisionedIops");
            }
        ...
        public Builder provisionedThroughput(Integer provisionedThroughput) {
            if (provisionedThroughput == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigBootDisk", "provisionedThroughput");
            }
        ...
        public Builder sizeGb(Integer sizeGb) {
            if (sizeGb == null) {
              throw new MissingRequiredPropertyException("GetClusterNodePoolNodeConfigBootDisk", "sizeGb");
            }
            this.sizeGb = sizeGb;
            return this;
        }
        public GetClusterNodePoolNodeConfigBootDisk build() {
            final var _resultValue = new GetClusterNodePoolNodeConfigBootDisk();
