...
import com.pulumi.gcp.dataplex.inputs.DataProductIamMemberState;
import com.pulumi.gcp.dataplex.outputs.DataProductIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:dataplex/dataProductIamMember:DataProductIamMember")
public class DataProductIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={DataProductIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ DataProductIamMemberCondition> condition;

    public Output<Optional<DataProductIamMemberCondition>> condition() {
     ...
     */
    public DataProductIamMember(java.lang.String name) {
        this(name, DataProductIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DataProductIamMember(java.lang.String name, DataProductIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataProductIamMember(java.lang.String name, DataProductIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/dataProductIamMember:DataProductIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DataProductIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable DataProductIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/dataProductIamMember:DataProductIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static DataProductIamMemberArgs makeArgs(DataProductIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DataProductIamMemberArgs.Empty : args;
    }
     ...
     */
    public static DataProductIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable DataProductIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
