...
public final class InstanceDenyMaintenancePeriodEndDateArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceDenyMaintenancePeriodEndDateArgs Empty = new InstanceDenyMaintenancePeriodEndDateArgs();
    ...
    private InstanceDenyMaintenancePeriodEndDateArgs() {}

    private InstanceDenyMaintenancePeriodEndDateArgs(InstanceDenyMaintenancePeriodEndDateArgs $) {
        this.day = $.day;
        this.month = $.month;
        this.year = $.year;
    }
    ...
    public static Builder builder(InstanceDenyMaintenancePeriodEndDateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceDenyMaintenancePeriodEndDateArgs();
        }

        public Builder(InstanceDenyMaintenancePeriodEndDateArgs defaults) {
            $ = new InstanceDenyMaintenancePeriodEndDateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceDenyMaintenancePeriodEndDateArgs build() {
            return $;
        }
    }
