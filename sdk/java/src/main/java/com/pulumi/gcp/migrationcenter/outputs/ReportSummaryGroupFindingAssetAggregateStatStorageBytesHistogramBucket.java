...
@CustomType
public final class ReportSummaryGroupFindingAssetAggregateStatStorageBytesHistogramBucket {
    /**
     * @return (Output)
    ...
    private ReportSummaryGroupFindingAssetAggregateStatStorageBytesHistogramBucket() {}
    /**
     * @return (Output)
     * Count of items in the bucket.
     * 
    ...
    public static Builder builder(ReportSummaryGroupFindingAssetAggregateStatStorageBytesHistogramBucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String upperBound;
        public Builder() {}
        public Builder(ReportSummaryGroupFindingAssetAggregateStatStorageBytesHistogramBucket defaults) {
        ...
        public ReportSummaryGroupFindingAssetAggregateStatStorageBytesHistogramBucket build() {
            final var _resultValue = new ReportSummaryGroupFindingAssetAggregateStatStorageBytesHistogramBucket();
