...
public final class PerInstanceConfigPreservedStateDisk {
    ...
    public static final class Builder {
        ...
        public Builder deviceName(String deviceName) {
            if (deviceName == null) {
              throw new MissingRequiredPropertyException("PerInstanceConfigPreservedStateDisk", "deviceName");
            }
        ...
        public Builder source(String source) {
            if (source == null) {
              throw new MissingRequiredPropertyException("PerInstanceConfigPreservedStateDisk", "source");
            }
            this.source = source;
            return this;
        }
