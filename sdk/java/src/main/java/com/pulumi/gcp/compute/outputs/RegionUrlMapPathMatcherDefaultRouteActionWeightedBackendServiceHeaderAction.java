...
import com.pulumi.gcp.compute.outputs.RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd;
import com.pulumi.gcp.compute.outputs.RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd;
...
@CustomType
public final class RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction {
    /**
     * @return Headers to add to a matching request before forwarding the request to the backendService.
     * Structure is documented below.
     * 
     */
    private @Nullable List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd> requestHeadersToAdds;
    /**
     ...
     * 
     */
    private @Nullable List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd> responseHeadersToAdds;
    /**
    ...
    private RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction() {}
    /**
     * @return Headers to add to a matching request before forwarding the request to the backendService.
     * Structure is documented below.
     * 
     */
    public List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd> requestHeadersToAdds() {
     ...
     * 
     */
    public List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd> responseHeadersToAdds() {
    ...
    public static Builder builder(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> responseHeadersToRemoves;
        public Builder() {}
        public Builder(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction defaults) {
        ...
        @CustomType.Setter
        public Builder requestHeadersToAdds(@Nullable List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd> requestHeadersToAdds) {

            this.requestHeadersToAdds = requestHeadersToAdds;
            return this;
        }
        public Builder requestHeadersToAdds(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd... requestHeadersToAdds) {
        ...
        @CustomType.Setter
        public Builder responseHeadersToAdds(@Nullable List<RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd> responseHeadersToAdds) {

            this.responseHeadersToAdds = responseHeadersToAdds;
            return this;
        }
        public Builder responseHeadersToAdds(RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd... responseHeadersToAdds) {
        ...
        public RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction build() {
            final var _resultValue = new RegionUrlMapPathMatcherDefaultRouteActionWeightedBackendServiceHeaderAction();
