...
public final class JobTemplateTemplateVolumeSecretArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTemplateTemplateVolumeSecretArgs Empty = new JobTemplateTemplateVolumeSecretArgs();
     ...
     */
    @Import(name="items")
    private @Nullable Output<List<JobTemplateTemplateVolumeSecretItemArgs>> items;
     ...
     * 
     */
    public Optional<Output<List<JobTemplateTemplateVolumeSecretItemArgs>>> items() {
    ...
    private JobTemplateTemplateVolumeSecretArgs() {}

    private JobTemplateTemplateVolumeSecretArgs(JobTemplateTemplateVolumeSecretArgs $) {
    ...
    public static Builder builder(JobTemplateTemplateVolumeSecretArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTemplateTemplateVolumeSecretArgs();
        }

        public Builder(JobTemplateTemplateVolumeSecretArgs defaults) {
            $ = new JobTemplateTemplateVolumeSecretArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder items(@Nullable Output<List<JobTemplateTemplateVolumeSecretItemArgs>> items) {
            $.items = items;
            return this;
        }
         ...
         * 
         */
        public Builder items(List<JobTemplateTemplateVolumeSecretItemArgs> items) {
         ...
         * 
         */
        public Builder items(JobTemplateTemplateVolumeSecretItemArgs... items) {
        ...
        public JobTemplateTemplateVolumeSecretArgs build() {
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("JobTemplateTemplateVolumeSecretArgs", "secret");
            }
            return $;
        }
    }
