...
public final class InstanceTemplateSchedulingNodeAffinity {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("InstanceTemplateSchedulingNodeAffinity", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("InstanceTemplateSchedulingNodeAffinity", "operator");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("InstanceTemplateSchedulingNodeAffinity", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public InstanceTemplateSchedulingNodeAffinity build() {
            final var _resultValue = new InstanceTemplateSchedulingNodeAffinity();
