...
public final class InstanceIAMMemberConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public InstanceIAMMemberConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("InstanceIAMMemberConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("InstanceIAMMemberConditionArgs", "title");
            }
            return $;
        }
    }
