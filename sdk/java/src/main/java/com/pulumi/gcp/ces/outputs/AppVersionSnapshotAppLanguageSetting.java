...
@CustomType
public final class AppVersionSnapshotAppLanguageSetting {
    /**
     * @return (Output)
    ...
    public static Builder builder(AppVersionSnapshotAppLanguageSetting defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> supportedLanguageCodes;
        public Builder() {}
        public Builder(AppVersionSnapshotAppLanguageSetting defaults) {
        ...
        public AppVersionSnapshotAppLanguageSetting build() {
            final var _resultValue = new AppVersionSnapshotAppLanguageSetting();
