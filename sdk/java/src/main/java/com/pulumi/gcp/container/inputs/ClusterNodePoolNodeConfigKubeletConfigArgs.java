...
import com.pulumi.gcp.container.inputs.ClusterNodePoolNodeConfigKubeletConfigMemoryManagerArgs;
import com.pulumi.gcp.container.inputs.ClusterNodePoolNodeConfigKubeletConfigTopologyManagerArgs;
...
public final class ClusterNodePoolNodeConfigKubeletConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs> evictionMinimumReclaim;
     ...
     * 
     */
    public Optional<Output<ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs>> evictionMinimumReclaim() {
    ...
    private @Nullable Output<ClusterNodePoolNodeConfigKubeletConfigEvictionSoftArgs> evictionSoft;
     ...
     * 
     */
    public Optional<Output<ClusterNodePoolNodeConfigKubeletConfigEvictionSoftArgs>> evictionSoft() {
    ...
    private @Nullable Output<ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs> evictionSoftGracePeriod;
     ...
     * 
     */
    public Optional<Output<ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs>> evictionSoftGracePeriod() {
    ...
    private @Nullable Output<ClusterNodePoolNodeConfigKubeletConfigMemoryManagerArgs> memoryManager;
     ...
     * 
     */
    public Optional<Output<ClusterNodePoolNodeConfigKubeletConfigMemoryManagerArgs>> memoryManager() {
    ...
    private @Nullable Output<ClusterNodePoolNodeConfigKubeletConfigTopologyManagerArgs> topologyManager;

    /**
     * @return These settings control the kubelet&#39;s [Topology Manager policy](https://kubernetes.io/docs/tasks/administer-cluster/topology-manager/#topology-manager-policies), which coordinates the set of components responsible for performance optimizations related to CPU isolation, memory, and device locality. Structure is documented below.
     * 
     */
    public Optional<Output<ClusterNodePoolNodeConfigKubeletConfigTopologyManagerArgs>> topologyManager() {
    ...
    public static final class Builder {
        ...
        /**
         * @param evictionMaxPodGracePeriodSeconds Defines the maximum allowed grace period (in seconds) to use when terminating pods in response to a soft eviction threshold being met. The integer must be positive and not exceed 300.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder evictionMinimumReclaim(@Nullable Output<ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs> evictionMinimumReclaim) {
         ...
         * 
         */
        public Builder evictionMinimumReclaim(ClusterNodePoolNodeConfigKubeletConfigEvictionMinimumReclaimArgs evictionMinimumReclaim) {
         ...
         * 
         */
        public Builder evictionSoft(@Nullable Output<ClusterNodePoolNodeConfigKubeletConfigEvictionSoftArgs> evictionSoft) {
         ...
         * 
         */
        public Builder evictionSoft(ClusterNodePoolNodeConfigKubeletConfigEvictionSoftArgs evictionSoft) {
         ...
         * 
         */
        public Builder evictionSoftGracePeriod(@Nullable Output<ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs> evictionSoftGracePeriod) {
         ...
         * 
         */
        public Builder evictionSoftGracePeriod(ClusterNodePoolNodeConfigKubeletConfigEvictionSoftGracePeriodArgs evictionSoftGracePeriod) {
        ...
        /**
         * @param maxParallelImagePulls Set the maximum number of image pulls in parallel. The integer must be between 2 and 5, inclusive.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder memoryManager(@Nullable Output<ClusterNodePoolNodeConfigKubeletConfigMemoryManagerArgs> memoryManager) {
         ...
         * 
         */
        public Builder memoryManager(ClusterNodePoolNodeConfigKubeletConfigMemoryManagerArgs memoryManager) {
         ...
         * 
         */
        public Builder topologyManager(@Nullable Output<ClusterNodePoolNodeConfigKubeletConfigTopologyManagerArgs> topologyManager) {
         ...
         * 
         */
        public Builder topologyManager(ClusterNodePoolNodeConfigKubeletConfigTopologyManagerArgs topologyManager) {
