...
import com.pulumi.gcp.biglake.inputs.HiveCatalogIamMemberState;
import com.pulumi.gcp.biglake.outputs.HiveCatalogIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveCatalogIamMember:HiveCatalogIamMember")
public class HiveCatalogIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={HiveCatalogIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ HiveCatalogIamMemberCondition> condition;

    public Output<Optional<HiveCatalogIamMemberCondition>> condition() {
     ...
     */
    public HiveCatalogIamMember(java.lang.String name) {
        this(name, HiveCatalogIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveCatalogIamMember(java.lang.String name, HiveCatalogIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveCatalogIamMember(java.lang.String name, HiveCatalogIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveCatalogIamMember:HiveCatalogIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveCatalogIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable HiveCatalogIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveCatalogIamMember:HiveCatalogIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveCatalogIamMemberArgs makeArgs(HiveCatalogIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveCatalogIamMemberArgs.Empty : args;
    }
     ...
     */
    public static HiveCatalogIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveCatalogIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new HiveCatalogIamMember(name, id, state, options);
    }
}
