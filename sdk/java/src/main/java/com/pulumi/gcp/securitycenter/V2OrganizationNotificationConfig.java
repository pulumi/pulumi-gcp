...
public class V2OrganizationNotificationConfig extends com.pulumi.resources.CustomResource {
     ...
     */
    public V2OrganizationNotificationConfig(String name) {
     ...
     */
    public static V2OrganizationNotificationConfig get(String name, Output<String> id, @Nullable V2OrganizationNotificationConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
