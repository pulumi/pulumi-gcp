 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/subnetworkIAMMember:SubnetworkIAMMember editor &#34;projects/{{project}}/regions/{{region}}/subnetworks/{{subnetwork}} roles/compute.networkUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class SubnetworkIAMMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public SubnetworkIAMMember(java.lang.String name) {
     ...
     */
    public SubnetworkIAMMember(java.lang.String name, SubnetworkIAMMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SubnetworkIAMMember(java.lang.String name, SubnetworkIAMMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/subnetworkIAMMember:SubnetworkIAMMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SubnetworkIAMMember(java.lang.String name, Output<java.lang.String> id, @Nullable SubnetworkIAMMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/subnetworkIAMMember:SubnetworkIAMMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SubnetworkIAMMember get(java.lang.String name, Output<java.lang.String> id, @Nullable SubnetworkIAMMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
