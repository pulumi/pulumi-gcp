...
@CustomType
public final class NetworkFirewallPolicyRuleMatchLayer4Config {
    /**
    ...
    private NetworkFirewallPolicyRuleMatchLayer4Config() {}
    /**
     * @return The IP protocol to which this rule applies. The protocol type is required when creating a firewall rule.
     * This value can either be one of the following well known protocol strings (tcp, udp, icmp, esp, ah, ipip, sctp), or the IP protocol number.
     * 
    ...
    public static Builder builder(NetworkFirewallPolicyRuleMatchLayer4Config defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> ports;
        public Builder() {}
        public Builder(NetworkFirewallPolicyRuleMatchLayer4Config defaults) {
        ...
        public Builder ipProtocol(String ipProtocol) {
            if (ipProtocol == null) {
              throw new MissingRequiredPropertyException("NetworkFirewallPolicyRuleMatchLayer4Config", "ipProtocol");
            }
