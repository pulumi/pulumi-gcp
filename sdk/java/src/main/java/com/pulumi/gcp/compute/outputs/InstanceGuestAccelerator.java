...
public final class InstanceGuestAccelerator {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("InstanceGuestAccelerator", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("InstanceGuestAccelerator", "type");
            }
            this.type = type;
            return this;
        }
        public InstanceGuestAccelerator build() {
            final var _resultValue = new InstanceGuestAccelerator();
