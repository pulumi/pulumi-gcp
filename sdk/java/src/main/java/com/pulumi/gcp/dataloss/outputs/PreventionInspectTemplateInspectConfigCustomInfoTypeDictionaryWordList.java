...
public final class PreventionInspectTemplateInspectConfigCustomInfoTypeDictionaryWordList {
    ...
    private PreventionInspectTemplateInspectConfigCustomInfoTypeDictionaryWordList() {}
    /**
     * @return Words or phrases defining the dictionary. The dictionary must contain at least one
     * phrase and every phrase must contain at least 2 characters that are letters or digits.
     * 
    ...
    public static final class Builder {
        ...
        public Builder words(List<String> words) {
            if (words == null) {
              throw new MissingRequiredPropertyException("PreventionInspectTemplateInspectConfigCustomInfoTypeDictionaryWordList", "words");
            }
            this.words = words;
            return this;
        }
