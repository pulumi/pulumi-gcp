...
public final class GetIAMPolicyBindingConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetIAMPolicyBindingConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("GetIAMPolicyBindingConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("GetIAMPolicyBindingConditionArgs", "title");
            }
            return $;
        }
    }
