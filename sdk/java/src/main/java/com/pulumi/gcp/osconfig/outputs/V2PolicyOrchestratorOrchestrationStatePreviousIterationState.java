...
import com.pulumi.gcp.osconfig.outputs.V2PolicyOrchestratorOrchestrationStatePreviousIterationStateError;
...
@CustomType
public final class V2PolicyOrchestratorOrchestrationStatePreviousIterationState {
    /**
     ...
     * 
     */
    private @Nullable V2PolicyOrchestratorOrchestrationStatePreviousIterationStateError error;
    /**
     * @return (Output)
    ...
    private V2PolicyOrchestratorOrchestrationStatePreviousIterationState() {}
    /**
     * @return The `Status` type defines a logical error model that is suitable for
     * different programming environments, including REST APIs and RPC APIs. It is
     * used by [gRPC](https://github.com/grpc). Each `Status` message contains
     ...
     * 
     */
    public Optional<V2PolicyOrchestratorOrchestrationStatePreviousIterationStateError> error() {
    ...
    public static Builder builder(V2PolicyOrchestratorOrchestrationStatePreviousIterationState defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(V2PolicyOrchestratorOrchestrationStatePreviousIterationState defaults) {
        ...
        @CustomType.Setter
        public Builder error(@Nullable V2PolicyOrchestratorOrchestrationStatePreviousIterationStateError error) {
        ...
        public V2PolicyOrchestratorOrchestrationStatePreviousIterationState build() {
            final var _resultValue = new V2PolicyOrchestratorOrchestrationStatePreviousIterationState();
