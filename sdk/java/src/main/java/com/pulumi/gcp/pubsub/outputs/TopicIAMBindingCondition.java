...
public final class TopicIAMBindingCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("TopicIAMBindingCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("TopicIAMBindingCondition", "title");
            }
            this.title = title;
            return this;
        }
        public TopicIAMBindingCondition build() {
            final var _resultValue = new TopicIAMBindingCondition();
