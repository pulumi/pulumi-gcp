...
public final class WorkstationIamBindingCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("WorkstationIamBindingCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("WorkstationIamBindingCondition", "title");
            }
            this.title = title;
            return this;
        }
        public WorkstationIamBindingCondition build() {
            final var _resultValue = new WorkstationIamBindingCondition();
