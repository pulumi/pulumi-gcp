...
import com.pulumi.gcp.eventarc.inputs.PipelineIamMemberState;
import com.pulumi.gcp.eventarc.outputs.PipelineIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:eventarc/pipelineIamMember:PipelineIamMember")
public class PipelineIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={PipelineIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ PipelineIamMemberCondition> condition;

    public Output<Optional<PipelineIamMemberCondition>> condition() {
     ...
     */
    public PipelineIamMember(java.lang.String name) {
        this(name, PipelineIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public PipelineIamMember(java.lang.String name, PipelineIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PipelineIamMember(java.lang.String name, PipelineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:eventarc/pipelineIamMember:PipelineIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PipelineIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:eventarc/pipelineIamMember:PipelineIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static PipelineIamMemberArgs makeArgs(PipelineIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PipelineIamMemberArgs.Empty : args;
    }
     ...
     */
    public static PipelineIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable PipelineIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new PipelineIamMember(name, id, state, options);
    }
}
