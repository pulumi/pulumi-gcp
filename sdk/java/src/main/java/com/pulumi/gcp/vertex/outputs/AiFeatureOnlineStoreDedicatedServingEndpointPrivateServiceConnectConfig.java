...
@CustomType
public final class AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig {
    /**
    ...
    public static Builder builder(AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> projectAllowlists;
        public Builder() {}
        public Builder(AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig defaults) {
        ...
        public Builder enablePrivateServiceConnect(Boolean enablePrivateServiceConnect) {
            if (enablePrivateServiceConnect == null) {
              throw new MissingRequiredPropertyException("AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig", "enablePrivateServiceConnect");
            }
        ...
        public AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig build() {
            final var _resultValue = new AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfig();
