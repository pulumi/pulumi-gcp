...
import com.pulumi.gcp.beyondcorp.inputs.SecurityGatewayApplicationIamBindingState;
import com.pulumi.gcp.beyondcorp.outputs.SecurityGatewayApplicationIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:beyondcorp/securityGatewayApplicationIamBinding:SecurityGatewayApplicationIamBinding editor &#34;projects/{{project}}/locations/global/securityGateways/{{security_gateway_id}}/applications/{{application_id}} roles/beyondcorp.securityGatewayUser user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:beyondcorp/securityGatewayApplicationIamBinding:SecurityGatewayApplicationIamBinding")
public class SecurityGatewayApplicationIamBinding extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="condition", refs={SecurityGatewayApplicationIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ SecurityGatewayApplicationIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<SecurityGatewayApplicationIamBindingCondition>> condition() {
     ...
     */
    public SecurityGatewayApplicationIamBinding(java.lang.String name) {
        this(name, SecurityGatewayApplicationIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SecurityGatewayApplicationIamBinding(java.lang.String name, SecurityGatewayApplicationIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SecurityGatewayApplicationIamBinding(java.lang.String name, SecurityGatewayApplicationIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayApplicationIamBinding:SecurityGatewayApplicationIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SecurityGatewayApplicationIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayApplicationIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayApplicationIamBinding:SecurityGatewayApplicationIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static SecurityGatewayApplicationIamBindingArgs makeArgs(SecurityGatewayApplicationIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SecurityGatewayApplicationIamBindingArgs.Empty : args;
    }
     ...
     */
    public static SecurityGatewayApplicationIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayApplicationIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
