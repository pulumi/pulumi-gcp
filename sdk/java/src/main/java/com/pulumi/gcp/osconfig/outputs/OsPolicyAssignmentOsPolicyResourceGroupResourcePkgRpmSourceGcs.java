...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcs {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcs", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpmSourceGcs", "object");
            }
            this.object = object;
            return this;
        }
