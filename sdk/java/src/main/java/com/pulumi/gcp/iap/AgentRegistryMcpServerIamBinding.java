...
import com.pulumi.gcp.iap.inputs.AgentRegistryMcpServerIamBindingState;
import com.pulumi.gcp.iap.outputs.AgentRegistryMcpServerIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryMcpServerIamBinding:AgentRegistryMcpServerIamBinding")
public class AgentRegistryMcpServerIamBinding extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={AgentRegistryMcpServerIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ AgentRegistryMcpServerIamBindingCondition> condition;
     ...
     * 
     */
    public Output<Optional<AgentRegistryMcpServerIamBindingCondition>> condition() {
     ...
     * 
     */
    @Export(name="mcpServerId", refs={String.class}, tree="[0]")
     ...
     */
    public AgentRegistryMcpServerIamBinding(java.lang.String name) {
        this(name, AgentRegistryMcpServerIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryMcpServerIamBinding(java.lang.String name, AgentRegistryMcpServerIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryMcpServerIamBinding(java.lang.String name, AgentRegistryMcpServerIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryMcpServerIamBinding:AgentRegistryMcpServerIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryMcpServerIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryMcpServerIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryMcpServerIamBinding:AgentRegistryMcpServerIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryMcpServerIamBindingArgs makeArgs(AgentRegistryMcpServerIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryMcpServerIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryMcpServerIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryMcpServerIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
