...
import com.pulumi.gcp.compute.outputs.URLMapPathMatcherDefaultCustomErrorResponsePolicyErrorResponseRule;
...
@CustomType
public final class URLMapPathMatcherDefaultCustomErrorResponsePolicy {
    /**
     ...
     * 
     */
    public List<URLMapPathMatcherDefaultCustomErrorResponsePolicyErrorResponseRule> errorResponseRules() {
    ...
    public static Builder builder(URLMapPathMatcherDefaultCustomErrorResponsePolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String errorService;
        public Builder() {}
        public Builder(URLMapPathMatcherDefaultCustomErrorResponsePolicy defaults) {
        ...
        @CustomType.Setter
        public Builder errorResponseRules(@Nullable List<URLMapPathMatcherDefaultCustomErrorResponsePolicyErrorResponseRule> errorResponseRules) {

            this.errorResponseRules = errorResponseRules;
            return this;
        }
        public Builder errorResponseRules(URLMapPathMatcherDefaultCustomErrorResponsePolicyErrorResponseRule... errorResponseRules) {
        ...
        public URLMapPathMatcherDefaultCustomErrorResponsePolicy build() {
            final var _resultValue = new URLMapPathMatcherDefaultCustomErrorResponsePolicy();
