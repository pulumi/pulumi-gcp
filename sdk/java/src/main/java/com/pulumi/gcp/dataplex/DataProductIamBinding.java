...
import com.pulumi.gcp.dataplex.inputs.DataProductIamBindingState;
import com.pulumi.gcp.dataplex.outputs.DataProductIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:dataplex/dataProductIamBinding:DataProductIamBinding")
public class DataProductIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={DataProductIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ DataProductIamBindingCondition> condition;

    public Output<Optional<DataProductIamBindingCondition>> condition() {
     ...
     */
    public DataProductIamBinding(java.lang.String name) {
        this(name, DataProductIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DataProductIamBinding(java.lang.String name, DataProductIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataProductIamBinding(java.lang.String name, DataProductIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/dataProductIamBinding:DataProductIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DataProductIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable DataProductIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/dataProductIamBinding:DataProductIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static DataProductIamBindingArgs makeArgs(DataProductIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DataProductIamBindingArgs.Empty : args;
    }
     ...
     */
    public static DataProductIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable DataProductIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
