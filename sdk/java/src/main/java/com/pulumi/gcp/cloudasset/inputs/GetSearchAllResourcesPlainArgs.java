...
public final class GetSearchAllResourcesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSearchAllResourcesPlainArgs Empty = new GetSearchAllResourcesPlainArgs();
    ...
    private GetSearchAllResourcesPlainArgs() {}

    private GetSearchAllResourcesPlainArgs(GetSearchAllResourcesPlainArgs $) {
    ...
    public static Builder builder(GetSearchAllResourcesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSearchAllResourcesPlainArgs();
        }

        public Builder(GetSearchAllResourcesPlainArgs defaults) {
            $ = new GetSearchAllResourcesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSearchAllResourcesPlainArgs build() {
            if ($.scope == null) {
                throw new MissingRequiredPropertyException("GetSearchAllResourcesPlainArgs", "scope");
            }
            return $;
        }
    }
