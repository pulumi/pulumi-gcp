...
public class ClusterIAMBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public ClusterIAMBinding(java.lang.String name) {
     ...
     */
    public ClusterIAMBinding(java.lang.String name, ClusterIAMBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ClusterIAMBinding(java.lang.String name, ClusterIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/clusterIAMBinding:ClusterIAMBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ClusterIAMBinding(java.lang.String name, Output<java.lang.String> id, @Nullable ClusterIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/clusterIAMBinding:ClusterIAMBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static ClusterIAMBindingArgs makeArgs(ClusterIAMBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ClusterIAMBindingArgs.Empty : args;
    }
     ...
     */
    public static ClusterIAMBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable ClusterIAMBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
