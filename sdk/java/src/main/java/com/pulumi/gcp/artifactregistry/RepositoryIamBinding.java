 ...
 * 
 * ```sh
 * $ pulumi import gcp:artifactregistry/repositoryIamBinding:RepositoryIamBinding editor &#34;projects/{{project}}/locations/{{location}}/repositories/{{repository}} roles/artifactregistry.reader user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class RepositoryIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public RepositoryIamBinding(java.lang.String name, RepositoryIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:artifactregistry/repositoryIamBinding:RepositoryIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RepositoryIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:artifactregistry/repositoryIamBinding:RepositoryIamBinding", name, state, makeResourceOptions(options, id), false);
    }
