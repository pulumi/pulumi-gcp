...
public final class ApiConfigGrpcServiceSource {
    ...
    public static final class Builder {
        ...
        public Builder contents(String contents) {
            if (contents == null) {
              throw new MissingRequiredPropertyException("ApiConfigGrpcServiceSource", "contents");
            }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("ApiConfigGrpcServiceSource", "path");
            }
            this.path = path;
            return this;
        }
