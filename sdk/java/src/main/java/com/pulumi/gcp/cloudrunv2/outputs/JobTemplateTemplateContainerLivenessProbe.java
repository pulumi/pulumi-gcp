...
import com.pulumi.gcp.cloudrunv2.outputs.JobTemplateTemplateContainerLivenessProbeHttpGet;
import com.pulumi.gcp.cloudrunv2.outputs.JobTemplateTemplateContainerLivenessProbeTcpSocket;
...
@CustomType
public final class JobTemplateTemplateContainerLivenessProbe {
    /**
     ...
     * 
     */
    private @Nullable JobTemplateTemplateContainerLivenessProbeHttpGet httpGet;
    /**
     ...
     * 
     */
    private @Nullable JobTemplateTemplateContainerLivenessProbeTcpSocket tcpSocket;
    /**
    ...
    private JobTemplateTemplateContainerLivenessProbe() {}
    /**
     * @return Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1.
     * 
     */
     ...
     * 
     */
    public Optional<JobTemplateTemplateContainerLivenessProbeHttpGet> httpGet() {
     ...
     * 
     */
    public Optional<JobTemplateTemplateContainerLivenessProbeTcpSocket> tcpSocket() {
    ...
    public static Builder builder(JobTemplateTemplateContainerLivenessProbe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer timeoutSeconds;
        public Builder() {}
        public Builder(JobTemplateTemplateContainerLivenessProbe defaults) {
        ...
        @CustomType.Setter
        public Builder httpGet(@Nullable JobTemplateTemplateContainerLivenessProbeHttpGet httpGet) {
        ...
        @CustomType.Setter
        public Builder tcpSocket(@Nullable JobTemplateTemplateContainerLivenessProbeTcpSocket tcpSocket) {
        ...
        public JobTemplateTemplateContainerLivenessProbe build() {
            final var o = new JobTemplateTemplateContainerLivenessProbe();
