...
import com.pulumi.gcp.compute.inputs.FirewallPolicyIamBindingState;
import com.pulumi.gcp.compute.outputs.FirewallPolicyIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:compute/firewallPolicyIamBinding:FirewallPolicyIamBinding")
public class FirewallPolicyIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={FirewallPolicyIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ FirewallPolicyIamBindingCondition> condition;

    public Output<Optional<FirewallPolicyIamBindingCondition>> condition() {
     ...
     */
    public FirewallPolicyIamBinding(java.lang.String name) {
        this(name, FirewallPolicyIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FirewallPolicyIamBinding(java.lang.String name, FirewallPolicyIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FirewallPolicyIamBinding(java.lang.String name, FirewallPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/firewallPolicyIamBinding:FirewallPolicyIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FirewallPolicyIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable FirewallPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/firewallPolicyIamBinding:FirewallPolicyIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static FirewallPolicyIamBindingArgs makeArgs(FirewallPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FirewallPolicyIamBindingArgs.Empty : args;
    }
     ...
     */
    public static FirewallPolicyIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable FirewallPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new FirewallPolicyIamBinding(name, id, state, options);
    }
}
