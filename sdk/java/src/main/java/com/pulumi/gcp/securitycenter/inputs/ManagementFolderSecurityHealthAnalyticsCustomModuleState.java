...
public final class ManagementFolderSecurityHealthAnalyticsCustomModuleState extends com.pulumi.resources.ResourceArgs {

    public static final ManagementFolderSecurityHealthAnalyticsCustomModuleState Empty = new ManagementFolderSecurityHealthAnalyticsCustomModuleState();
    ...
    private ManagementFolderSecurityHealthAnalyticsCustomModuleState() {}

    private ManagementFolderSecurityHealthAnalyticsCustomModuleState(ManagementFolderSecurityHealthAnalyticsCustomModuleState $) {
    ...
    public static Builder builder(ManagementFolderSecurityHealthAnalyticsCustomModuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagementFolderSecurityHealthAnalyticsCustomModuleState();
        }

        public Builder(ManagementFolderSecurityHealthAnalyticsCustomModuleState defaults) {
            $ = new ManagementFolderSecurityHealthAnalyticsCustomModuleState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name The resource name of the custom module. Its format is &#34;folders/{folder}/locations/{location}/securityHealthAnalyticsCustomModules/{securityHealthAnalyticsCustomModule}&#34;.
         * The id {securityHealthAnalyticsCustomModule} is server-generated and is not user settable. It will be a numeric id containing 1-20 digits.
         * 
         * @return builder
         * 
        ...
        public ManagementFolderSecurityHealthAnalyticsCustomModuleState build() {
            return $;
        }
    }
