...
public final class AlertPolicyConditionConditionAbsentTriggerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AlertPolicyConditionConditionAbsentTriggerArgs(AlertPolicyConditionConditionAbsentTriggerArgs $) {
        this.count = $.count;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertPolicyConditionConditionAbsentTriggerArgs();
        }

        public Builder(AlertPolicyConditionConditionAbsentTriggerArgs defaults) {
            $ = new AlertPolicyConditionConditionAbsentTriggerArgs(Objects.requireNonNull(defaults));
        }
