...
public final class ConnectionSslConfigAdditionalVariableEncryptionKeyValue {
    ...
    public static Builder builder(ConnectionSslConfigAdditionalVariableEncryptionKeyValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(ConnectionSslConfigAdditionalVariableEncryptionKeyValue defaults) {
