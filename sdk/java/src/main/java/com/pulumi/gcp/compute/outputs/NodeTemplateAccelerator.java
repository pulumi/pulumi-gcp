...
@CustomType
public final class NodeTemplateAccelerator {
    /**
    ...
    private NodeTemplateAccelerator() {}
    /**
     * @return The number of the guest accelerator cards exposed to this
     * node template.
     * 
    ...
    public static Builder builder(NodeTemplateAccelerator defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String acceleratorType;
        public Builder() {}
        public Builder(NodeTemplateAccelerator defaults) {
        ...
        public NodeTemplateAccelerator build() {
            final var _resultValue = new NodeTemplateAccelerator();
