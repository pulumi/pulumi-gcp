...
import com.pulumi.gcp.compute.inputs.SnapshotIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/snapshotIamPolicy:SnapshotIamPolicy editor &#34;projects/{{project}}/global/snapshots/{{snapshot}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:compute/snapshotIamPolicy:SnapshotIamPolicy")
public class SnapshotIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public SnapshotIamPolicy(java.lang.String name) {
     ...
     */
    public SnapshotIamPolicy(java.lang.String name, SnapshotIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SnapshotIamPolicy(java.lang.String name, SnapshotIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/snapshotIamPolicy:SnapshotIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SnapshotIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable SnapshotIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/snapshotIamPolicy:SnapshotIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static SnapshotIamPolicyArgs makeArgs(SnapshotIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SnapshotIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static SnapshotIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable SnapshotIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
