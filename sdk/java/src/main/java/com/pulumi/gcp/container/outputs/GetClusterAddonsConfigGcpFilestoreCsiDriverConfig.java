...
public final class GetClusterAddonsConfigGcpFilestoreCsiDriverConfig {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetClusterAddonsConfigGcpFilestoreCsiDriverConfig", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public GetClusterAddonsConfigGcpFilestoreCsiDriverConfig build() {
            final var _resultValue = new GetClusterAddonsConfigGcpFilestoreCsiDriverConfig();
