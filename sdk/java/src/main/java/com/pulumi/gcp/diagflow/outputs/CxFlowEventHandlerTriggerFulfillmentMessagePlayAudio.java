...
@CustomType
public final class CxFlowEventHandlerTriggerFulfillmentMessagePlayAudio {
    /**
     * @return (Output)
    ...
    public static Builder builder(CxFlowEventHandlerTriggerFulfillmentMessagePlayAudio defaults) {
    ...
    public static final class Builder {
        ...
        private String audioUri;
        public Builder() {}
        public Builder(CxFlowEventHandlerTriggerFulfillmentMessagePlayAudio defaults) {
        ...
        public Builder audioUri(String audioUri) {
            if (audioUri == null) {
              throw new MissingRequiredPropertyException("CxFlowEventHandlerTriggerFulfillmentMessagePlayAudio", "audioUri");
            }
