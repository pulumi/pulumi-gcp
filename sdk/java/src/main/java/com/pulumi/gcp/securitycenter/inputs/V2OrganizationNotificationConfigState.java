...
public final class V2OrganizationNotificationConfigState extends com.pulumi.resources.ResourceArgs {

    public static final V2OrganizationNotificationConfigState Empty = new V2OrganizationNotificationConfigState();
    ...
    private @Nullable Output<V2OrganizationNotificationConfigStreamingConfigArgs> streamingConfig;
     ...
     * 
     */
    public Optional<Output<V2OrganizationNotificationConfigStreamingConfigArgs>> streamingConfig() {
        return Optional.ofNullable(this.streamingConfig);
    }

    private V2OrganizationNotificationConfigState() {}

    private V2OrganizationNotificationConfigState(V2OrganizationNotificationConfigState $) {
    ...
    public static Builder builder(V2OrganizationNotificationConfigState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2OrganizationNotificationConfigState();
        }

        public Builder(V2OrganizationNotificationConfigState defaults) {
            $ = new V2OrganizationNotificationConfigState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder streamingConfig(@Nullable Output<V2OrganizationNotificationConfigStreamingConfigArgs> streamingConfig) {
        ...
        public V2OrganizationNotificationConfigState build() {
            return $;
        }
    }
