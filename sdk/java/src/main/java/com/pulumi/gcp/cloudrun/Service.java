...
public class Service extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return If set to &#39;true&#39;, the revision name (template.metadata.name) will be omitted and autogenerated by Cloud Run. This cannot
     * be set to &#39;true&#39; while &#39;template.metadata.name&#39; is also set. (For legacy support, if &#39;template.metadata.name&#39; is unset
     * in state while this field is set to false, the revision name will still autogenerate.)
     * 
     */
    ...
    /**
     * @return Metadata associated with this Service, including name, namespace, labels, and annotations.
     * 
     */
    ...
    public Service(String name, ServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrun/service:Service", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
