...
public class ScopeIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public ScopeIamPolicy(String name) {
     ...
     */
    public ScopeIamPolicy(String name, ScopeIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static ScopeIamPolicy get(String name, Output<String> id, @Nullable ScopeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
