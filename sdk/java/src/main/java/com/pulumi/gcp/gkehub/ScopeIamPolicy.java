...
import com.pulumi.gcp.gkehub.inputs.ScopeIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:gkehub/scopeIamPolicy:ScopeIamPolicy editor &#34;projects/{{project}}/locations/global/scopes/{{scope_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:gkehub/scopeIamPolicy:ScopeIamPolicy")
public class ScopeIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ScopeIamPolicy(java.lang.String name) {
        this(name, ScopeIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ScopeIamPolicy(java.lang.String name, ScopeIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ScopeIamPolicy(java.lang.String name, ScopeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/scopeIamPolicy:ScopeIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ScopeIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable ScopeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkehub/scopeIamPolicy:ScopeIamPolicy", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ScopeIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable ScopeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
