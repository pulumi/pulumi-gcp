 ...
 * 
 * ```sh
 * $ pulumi import gcp:containeranalysis/noteIamMember:NoteIamMember editor &#34;projects/{{project}}/notes/{{note}} roles/containeranalysis.notes.occurrences.viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class NoteIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={NoteIamMemberCondition.class}, tree="[0]")
     ...
     */
    public NoteIamMember(java.lang.String name) {
     ...
     */
    public NoteIamMember(java.lang.String name, NoteIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NoteIamMember(java.lang.String name, NoteIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:containeranalysis/noteIamMember:NoteIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NoteIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable NoteIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:containeranalysis/noteIamMember:NoteIamMember", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static NoteIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable NoteIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
