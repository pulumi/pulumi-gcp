...
import com.pulumi.gcp.compute.inputs.RegionNetworkFirewallPolicyIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:compute/regionNetworkFirewallPolicyIamPolicy:RegionNetworkFirewallPolicyIamPolicy")
public class RegionNetworkFirewallPolicyIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return The region of this resource. Used to find the parent resource to bind the IAM policy to. If not specified,
     * the value will be parsed from the identifier of the parent resource. If no region is provided in the parent identifier and no
     * region is specified, it is taken from the provider configuration.
     * 
     */
     ...
     */
    public RegionNetworkFirewallPolicyIamPolicy(java.lang.String name) {
     ...
     */
    public RegionNetworkFirewallPolicyIamPolicy(java.lang.String name, RegionNetworkFirewallPolicyIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RegionNetworkFirewallPolicyIamPolicy(java.lang.String name, RegionNetworkFirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionNetworkFirewallPolicyIamPolicy:RegionNetworkFirewallPolicyIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RegionNetworkFirewallPolicyIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable RegionNetworkFirewallPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionNetworkFirewallPolicyIamPolicy:RegionNetworkFirewallPolicyIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static RegionNetworkFirewallPolicyIamPolicyArgs makeArgs(RegionNetworkFirewallPolicyIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RegionNetworkFirewallPolicyIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static RegionNetworkFirewallPolicyIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable RegionNetworkFirewallPolicyIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
