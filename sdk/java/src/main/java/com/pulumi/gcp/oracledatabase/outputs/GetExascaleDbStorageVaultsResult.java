...
import com.pulumi.gcp.oracledatabase.outputs.GetExascaleDbStorageVaultsExascaleDbStorageVault;
...
public final class GetExascaleDbStorageVaultsResult {
    /**
     * @return A list of ExascaleDbStorageVaults. See gcp.oracledatabase.ExascaleDbStorageVault resource for details of the available attributes.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultsResult", "location");
            }
