 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudtasks/queueIamBinding:QueueIamBinding editor &#34;projects/{{project}}/locations/{{location}}/queues/{{queue}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class QueueIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={QueueIamBindingCondition.class}, tree="[0]")
     ...
     */
    public QueueIamBinding(java.lang.String name) {
     ...
     */
    public QueueIamBinding(java.lang.String name, QueueIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public QueueIamBinding(java.lang.String name, QueueIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudtasks/queueIamBinding:QueueIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private QueueIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable QueueIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudtasks/queueIamBinding:QueueIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static QueueIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable QueueIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
