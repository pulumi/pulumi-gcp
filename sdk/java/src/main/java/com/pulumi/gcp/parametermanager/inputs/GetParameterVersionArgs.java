...
public final class GetParameterVersionArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetParameterVersionArgs Empty = new GetParameterVersionArgs();
    ...
    private GetParameterVersionArgs() {}

    private GetParameterVersionArgs(GetParameterVersionArgs $) {
    ...
    public static Builder builder(GetParameterVersionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetParameterVersionArgs();
        }

        public Builder(GetParameterVersionArgs defaults) {
            $ = new GetParameterVersionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetParameterVersionArgs build() {
            if ($.parameter == null) {
                throw new MissingRequiredPropertyException("GetParameterVersionArgs", "parameter");
            }
            if ($.parameterVersionId == null) {
                throw new MissingRequiredPropertyException("GetParameterVersionArgs", "parameterVersionId");
            }
            return $;
        }
    }
