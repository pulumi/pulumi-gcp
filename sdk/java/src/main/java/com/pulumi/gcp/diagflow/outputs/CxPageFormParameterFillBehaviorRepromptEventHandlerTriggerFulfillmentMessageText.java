...
@CustomType
public final class CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageText {
    /**
     * @return (Output)
    ...
    private CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageText() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> texts;
        public Builder() {}
        public Builder(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessageText defaults) {
