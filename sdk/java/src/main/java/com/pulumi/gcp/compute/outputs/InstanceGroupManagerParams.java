...
@CustomType
public final class InstanceGroupManagerParams {
    /**
    ...
    public static Builder builder(InstanceGroupManagerParams defaults) {
    ...
    public static final class Builder {
        ...
        public InstanceGroupManagerParams build() {
            final var _resultValue = new InstanceGroupManagerParams();
