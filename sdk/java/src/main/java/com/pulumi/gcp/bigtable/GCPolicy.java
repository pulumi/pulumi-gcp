...
public class GCPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public GCPolicy(java.lang.String name) {
     ...
     */
    public GCPolicy(java.lang.String name, GCPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public GCPolicy(java.lang.String name, GCPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigtable/gCPolicy:GCPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private GCPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable GCPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:bigtable/gCPolicy:GCPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static GCPolicyArgs makeArgs(GCPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? GCPolicyArgs.Empty : args;
    }
     ...
     */
    public static GCPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable GCPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
