...
@CustomType
public final class RouterStatusBestRouteAsPath {
    /**
    ...
    private RouterStatusBestRouteAsPath() {}
    /**
     * @return The AS numbers of the AS Path.
     * 
     */
    ...
    public static Builder builder(RouterStatusBestRouteAsPath defaults) {
    ...
    public static final class Builder {
        ...
        private String pathSegmentType;
        public Builder() {}
        public Builder(RouterStatusBestRouteAsPath defaults) {
        ...
        public Builder asLists(List<Integer> asLists) {
            if (asLists == null) {
              throw new MissingRequiredPropertyException("RouterStatusBestRouteAsPath", "asLists");
            }
        ...
        public Builder pathSegmentType(String pathSegmentType) {
            if (pathSegmentType == null) {
              throw new MissingRequiredPropertyException("RouterStatusBestRouteAsPath", "pathSegmentType");
            }
            this.pathSegmentType = pathSegmentType;
            return this;
        }
        public RouterStatusBestRouteAsPath build() {
            final var _resultValue = new RouterStatusBestRouteAsPath();
