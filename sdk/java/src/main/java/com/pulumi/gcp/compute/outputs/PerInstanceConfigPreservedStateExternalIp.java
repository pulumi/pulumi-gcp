...
import com.pulumi.gcp.compute.outputs.PerInstanceConfigPreservedStateExternalIpIpAddress;
...
@CustomType
public final class PerInstanceConfigPreservedStateExternalIp {
    /**
     ...
     * 
     */
    private @Nullable PerInstanceConfigPreservedStateExternalIpIpAddress ipAddress;

    private PerInstanceConfigPreservedStateExternalIp() {}
    /**
     * @return These stateful IPs will never be released during autohealing, update or VM instance recreate operations. This flag is used to configure if the IP reservation should be deleted after it is no longer used by the group, e.g. when the given instance or the whole group is deleted.
     * Default value is `NEVER`.
     * Possible values are: `NEVER`, `ON_PERMANENT_INSTANCE_DELETION`.
     ...
     * 
     */
    public Optional<PerInstanceConfigPreservedStateExternalIpIpAddress> ipAddress() {
    ...
    public static Builder builder(PerInstanceConfigPreservedStateExternalIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable PerInstanceConfigPreservedStateExternalIpIpAddress ipAddress;
        public Builder() {}
        public Builder(PerInstanceConfigPreservedStateExternalIp defaults) {
        ...
        public Builder interfaceName(String interfaceName) {
            if (interfaceName == null) {
              throw new MissingRequiredPropertyException("PerInstanceConfigPreservedStateExternalIp", "interfaceName");
            }
            this.interfaceName = interfaceName;
            return this;
        }
        @CustomType.Setter
        public Builder ipAddress(@Nullable PerInstanceConfigPreservedStateExternalIpIpAddress ipAddress) {
