...
public final class TableState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="generatedSchemaColumns")
    private @Nullable Output<String> generatedSchemaColumns;

    /**
     * @return (Output-only) A list of autogenerated schema fields.
     * 
     */
    public Optional<Output<String>> generatedSchemaColumns() {
        return Optional.ofNullable(this.generatedSchemaColumns);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param generatedSchemaColumns (Output-only) A list of autogenerated schema fields.
         * 
         * @return builder
         * 
         */
        public Builder generatedSchemaColumns(@Nullable Output<String> generatedSchemaColumns) {
        ...
        public Builder generatedSchemaColumns(String generatedSchemaColumns) {
            return generatedSchemaColumns(Output.of(generatedSchemaColumns));
        }
