...
public final class ApiProductOperationGroupOperationConfigQuotaArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiProductOperationGroupOperationConfigQuotaArgs Empty = new ApiProductOperationGroupOperationConfigQuotaArgs();
    ...
    private ApiProductOperationGroupOperationConfigQuotaArgs() {}

    private ApiProductOperationGroupOperationConfigQuotaArgs(ApiProductOperationGroupOperationConfigQuotaArgs $) {
    ...
    public static Builder builder(ApiProductOperationGroupOperationConfigQuotaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiProductOperationGroupOperationConfigQuotaArgs();
        }

        public Builder(ApiProductOperationGroupOperationConfigQuotaArgs defaults) {
            $ = new ApiProductOperationGroupOperationConfigQuotaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiProductOperationGroupOperationConfigQuotaArgs build() {
            return $;
        }
    }
