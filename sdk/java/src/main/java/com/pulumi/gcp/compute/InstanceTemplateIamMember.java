...
import com.pulumi.gcp.compute.inputs.InstanceTemplateIamMemberState;
import com.pulumi.gcp.compute.outputs.InstanceTemplateIamMemberCondition;
 ...
 * ```sh
 * $ terraform import google_compute_instance_template_iam_member.editor &#34;projects/{{project}}/global/instanceTemplates/{{instance_template}} roles/compute.instanceAdmin user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class InstanceTemplateIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={InstanceTemplateIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ InstanceTemplateIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<InstanceTemplateIamMemberCondition>> condition() {
     ...
     * `gcp.compute.InstanceTemplateIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
     ...
     */
    public InstanceTemplateIamMember(java.lang.String name) {
        this(name, InstanceTemplateIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InstanceTemplateIamMember(java.lang.String name, InstanceTemplateIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InstanceTemplateIamMember(java.lang.String name, InstanceTemplateIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instanceTemplateIamMember:InstanceTemplateIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InstanceTemplateIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceTemplateIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/instanceTemplateIamMember:InstanceTemplateIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static InstanceTemplateIamMemberArgs makeArgs(InstanceTemplateIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? InstanceTemplateIamMemberArgs.Empty : args;
    }
     ...
     */
    public static InstanceTemplateIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceTemplateIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new InstanceTemplateIamMember(name, id, state, options);
    }
}
