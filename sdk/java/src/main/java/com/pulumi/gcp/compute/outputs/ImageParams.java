...
public final class ImageParams {
    /**
     * @return Resource manager tags to be bound to the image. Tag keys and values have the
    ...
    public static Builder builder(ImageParams defaults) {
    ...
    public static final class Builder {
        private @Nullable Map<String,String> resourceManagerTags;
        public Builder() {}
        public Builder(ImageParams defaults) {
        ...
        public ImageParams build() {
            final var _resultValue = new ImageParams();
