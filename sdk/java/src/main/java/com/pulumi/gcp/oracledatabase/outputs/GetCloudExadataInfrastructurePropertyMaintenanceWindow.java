...
@CustomType
public final class GetCloudExadataInfrastructurePropertyMaintenanceWindow {
    /**
    ...
    private GetCloudExadataInfrastructurePropertyMaintenanceWindow() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each
     * database server patching operation. Custom action timeout is in minutes and
     * valid value is between 15 to 120 (inclusive).
    ...
    public static Builder builder(GetCloudExadataInfrastructurePropertyMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(GetCloudExadataInfrastructurePropertyMaintenanceWindow defaults) {
        ...
        public Builder customActionTimeoutMins(Integer customActionTimeoutMins) {
            if (customActionTimeoutMins == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "customActionTimeoutMins");
            }
        ...
        public Builder daysOfWeeks(List<String> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "daysOfWeeks");
            }
        ...
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder leadTimeWeek(Integer leadTimeWeek) {
            if (leadTimeWeek == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "leadTimeWeek");
            }
        ...
        public Builder months(List<String> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "months");
            }
            this.months = months;
            return this;
        }
        ...
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "preference");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructurePropertyMaintenanceWindow", "weeksOfMonths");
            }
        ...
        public GetCloudExadataInfrastructurePropertyMaintenanceWindow build() {
            final var _resultValue = new GetCloudExadataInfrastructurePropertyMaintenanceWindow();
