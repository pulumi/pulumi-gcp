...
@CustomType
public final class ClusterRestoreContinuousBackupSource {
    /**
    ...
    public static Builder builder(ClusterRestoreContinuousBackupSource defaults) {
    ...
    public static final class Builder {
        ...
        private String pointInTime;
        public Builder() {}
        public Builder(ClusterRestoreContinuousBackupSource defaults) {
