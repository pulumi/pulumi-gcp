...
@CustomType
public final class CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessagePlayAudio {
    /**
     * @return (Output)
    ...
    public static Builder builder(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessagePlayAudio defaults) {
    ...
    public static final class Builder {
        ...
        private String audioUri;
        public Builder() {}
        public Builder(CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessagePlayAudio defaults) {
