...
@CustomType
public final class RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo {
    /**
     * @return (Output)
    ...
    public static Builder builder(RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rolloutStatus;
        public Builder() {}
        public Builder(RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo defaults) {
        ...
        public RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo build() {
            final var _resultValue = new RegionResizeRequestStatusLastAttemptErrorErrorErrorDetailQuotaInfo();
