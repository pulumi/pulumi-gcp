    ...
    public static final class Builder {
        ...
        public Builder localSsdCount(Integer localSsdCount) {
            if (localSsdCount == null) {
              throw new MissingRequiredPropertyException("GetClusterNodeConfigEphemeralStorageConfig", "localSsdCount");
            }
            this.localSsdCount = localSsdCount;
            return this;
        }
        public GetClusterNodeConfigEphemeralStorageConfig build() {
            final var _resultValue = new GetClusterNodeConfigEphemeralStorageConfig();
