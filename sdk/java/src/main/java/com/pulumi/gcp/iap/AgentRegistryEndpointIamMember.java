...
import com.pulumi.gcp.iap.inputs.AgentRegistryEndpointIamMemberState;
import com.pulumi.gcp.iap.outputs.AgentRegistryEndpointIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:iap/agentRegistryEndpointIamMember:AgentRegistryEndpointIamMember")
public class AgentRegistryEndpointIamMember extends com.pulumi.resources.CustomResource {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     * 
     */
    @Export(name="condition", refs={AgentRegistryEndpointIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ AgentRegistryEndpointIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<AgentRegistryEndpointIamMemberCondition>> condition() {
     ...
     */
    public AgentRegistryEndpointIamMember(java.lang.String name) {
        this(name, AgentRegistryEndpointIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AgentRegistryEndpointIamMember(java.lang.String name, AgentRegistryEndpointIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AgentRegistryEndpointIamMember(java.lang.String name, AgentRegistryEndpointIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryEndpointIamMember:AgentRegistryEndpointIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AgentRegistryEndpointIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryEndpointIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/agentRegistryEndpointIamMember:AgentRegistryEndpointIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static AgentRegistryEndpointIamMemberArgs makeArgs(AgentRegistryEndpointIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AgentRegistryEndpointIamMemberArgs.Empty : args;
    }
     ...
     */
    public static AgentRegistryEndpointIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable AgentRegistryEndpointIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
