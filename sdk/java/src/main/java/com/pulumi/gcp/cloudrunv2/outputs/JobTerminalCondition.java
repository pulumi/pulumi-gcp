...
@CustomType
public final class JobTerminalCondition {
    /**
     * @return (Output)
    ...
    public static Builder builder(JobTerminalCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(JobTerminalCondition defaults) {
        ...
        public JobTerminalCondition build() {
            final var _resultValue = new JobTerminalCondition();
