...
@CustomType
public final class RegionBackendServiceIamMemberCondition {
    /**
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("RegionBackendServiceIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("RegionBackendServiceIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public RegionBackendServiceIamMemberCondition build() {
            final var _resultValue = new RegionBackendServiceIamMemberCondition();
