...
@CustomType
public final class PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues {
    /**
    ...
    public static Builder builder(PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> deniedValues;
        public Builder() {}
        public Builder(PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues defaults) {
        ...
        public PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues build() {
            final var _resultValue = new PosturePolicySetPolicyConstraintOrgPolicyConstraintPolicyRuleValues();
