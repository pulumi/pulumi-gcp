...
import com.pulumi.gcp.gemini.inputs.RepositoryGroupIamBindingState;
import com.pulumi.gcp.gemini.outputs.RepositoryGroupIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:gemini/repositoryGroupIamBinding:RepositoryGroupIamBinding editor &#34;projects/{{project}}/locations/{{location}}/codeRepositoryIndexes/{{code_repository_index}}/repositoryGroups/{{repository_group_id}} roles/cloudaicompanion.repositoryGroupsUser user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:gemini/repositoryGroupIamBinding:RepositoryGroupIamBinding")
public class RepositoryGroupIamBinding extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={RepositoryGroupIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ RepositoryGroupIamBindingCondition> condition;

    public Output<Optional<RepositoryGroupIamBindingCondition>> condition() {
     ...
     */
    public RepositoryGroupIamBinding(java.lang.String name) {
        this(name, RepositoryGroupIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RepositoryGroupIamBinding(java.lang.String name, RepositoryGroupIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RepositoryGroupIamBinding(java.lang.String name, RepositoryGroupIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/repositoryGroupIamBinding:RepositoryGroupIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RepositoryGroupIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryGroupIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/repositoryGroupIamBinding:RepositoryGroupIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static RepositoryGroupIamBindingArgs makeArgs(RepositoryGroupIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RepositoryGroupIamBindingArgs.Empty : args;
    }
     ...
     */
    public static RepositoryGroupIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable RepositoryGroupIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
