...
public final class NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs Empty = new NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs();
    ...
    private NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs() {}

    private NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs(NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs $) {
    ...
    public static Builder builder(NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs();
        }

        public Builder(NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs defaults) {
            $ = new NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs build() {
            if ($.ipProtocol == null) {
                throw new MissingRequiredPropertyException("NetworkFirewallPolicyPacketMirroringRuleMatchLayer4ConfigArgs", "ipProtocol");
            }
            return $;
        }
    }
