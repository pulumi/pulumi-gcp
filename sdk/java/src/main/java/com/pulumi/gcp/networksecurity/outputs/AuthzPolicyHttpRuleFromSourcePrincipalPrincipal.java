...
@CustomType
public final class AuthzPolicyHttpRuleFromSourcePrincipalPrincipal {
    /**
    ...
    private AuthzPolicyHttpRuleFromSourcePrincipalPrincipal() {}
    /**
     * @return The input string must have the substring specified here. Note: empty contains match is not allowed, please use regex instead.
     * Examples:
     * * abc matches the value xyz.abc.def
    ...
    public static Builder builder(AuthzPolicyHttpRuleFromSourcePrincipalPrincipal defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String suffix;
        public Builder() {}
        public Builder(AuthzPolicyHttpRuleFromSourcePrincipalPrincipal defaults) {
        ...
        public AuthzPolicyHttpRuleFromSourcePrincipalPrincipal build() {
            final var _resultValue = new AuthzPolicyHttpRuleFromSourcePrincipalPrincipal();
