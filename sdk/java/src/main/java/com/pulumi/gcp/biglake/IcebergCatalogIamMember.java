...
import com.pulumi.gcp.biglake.inputs.IcebergCatalogIamMemberState;
import com.pulumi.gcp.biglake.outputs.IcebergCatalogIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember editor &#34;projects/{{project}}/catalogs/{{iceberg_catalog}} roles/biglake.editor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember")
public class IcebergCatalogIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={IcebergCatalogIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ IcebergCatalogIamMemberCondition> condition;

    public Output<Optional<IcebergCatalogIamMemberCondition>> condition() {
     ...
     */
    public IcebergCatalogIamMember(java.lang.String name) {
        this(name, IcebergCatalogIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IcebergCatalogIamMember(java.lang.String name, IcebergCatalogIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IcebergCatalogIamMember(java.lang.String name, IcebergCatalogIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IcebergCatalogIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergCatalogIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static IcebergCatalogIamMemberArgs makeArgs(IcebergCatalogIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IcebergCatalogIamMemberArgs.Empty : args;
    }
     ...
     */
    public static IcebergCatalogIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergCatalogIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new IcebergCatalogIamMember(name, id, state, options);
    }
}
