...
public class FeatureIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public FeatureIamBinding(String name) {
     ...
     */
    public FeatureIamBinding(String name, FeatureIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FeatureIamBinding get(String name, Output<String> id, @Nullable FeatureIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
