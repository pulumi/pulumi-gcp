...
public final class ReleaseOutputVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReleaseOutputVariableArgs Empty = new ReleaseOutputVariableArgs();
    ...
    private ReleaseOutputVariableArgs() {}

    private ReleaseOutputVariableArgs(ReleaseOutputVariableArgs $) {
        this.type = $.type;
        this.value = $.value;
    ...
    public static Builder builder(ReleaseOutputVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReleaseOutputVariableArgs();
        }

        public Builder(ReleaseOutputVariableArgs defaults) {
            $ = new ReleaseOutputVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReleaseOutputVariableArgs build() {
            if ($.variable == null) {
                throw new MissingRequiredPropertyException("ReleaseOutputVariableArgs", "variable");
            }
            return $;
        }
    }
