...
public final class Hl7StoreIamBindingCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("Hl7StoreIamBindingCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("Hl7StoreIamBindingCondition", "title");
            }
            this.title = title;
            return this;
        }
        public Hl7StoreIamBindingCondition build() {
            final var _resultValue = new Hl7StoreIamBindingCondition();
