...
public final class InstanceTemplateSchedulingOnInstanceStopAction {
    ...
    public static Builder builder(InstanceTemplateSchedulingOnInstanceStopAction defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean discardLocalSsd;
        public Builder() {}
        public Builder(InstanceTemplateSchedulingOnInstanceStopAction defaults) {
        ...
        public InstanceTemplateSchedulingOnInstanceStopAction build() {
            final var _resultValue = new InstanceTemplateSchedulingOnInstanceStopAction();
