 ...
 * 
 * ```sh
 * $ pulumi import gcp:compute/subnetworkIAMPolicy:SubnetworkIAMPolicy editor &#34;projects/{{project}}/regions/{{region}}/subnetworks/{{subnetwork}} roles/compute.networkUser user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class SubnetworkIAMPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public SubnetworkIAMPolicy(java.lang.String name) {
     ...
     */
    public SubnetworkIAMPolicy(java.lang.String name, SubnetworkIAMPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SubnetworkIAMPolicy(java.lang.String name, SubnetworkIAMPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/subnetworkIAMPolicy:SubnetworkIAMPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SubnetworkIAMPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable SubnetworkIAMPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/subnetworkIAMPolicy:SubnetworkIAMPolicy", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SubnetworkIAMPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable SubnetworkIAMPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
