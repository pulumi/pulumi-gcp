...
@CustomType
public final class CxPageEntryFulfillmentMessageOutputAudioText {
    /**
     * @return (Output)
    ...
    private CxPageEntryFulfillmentMessageOutputAudioText() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxPageEntryFulfillmentMessageOutputAudioText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String text;
        public Builder() {}
        public Builder(CxPageEntryFulfillmentMessageOutputAudioText defaults) {
        ...
        public CxPageEntryFulfillmentMessageOutputAudioText build() {
            final var _resultValue = new CxPageEntryFulfillmentMessageOutputAudioText();
