 ...
 * 
 * ```sh
 * $ pulumi import gcp:servicedirectory/serviceIamBinding:ServiceIamBinding editor &#34;projects/{{project}}/locations/{{location}}/namespaces/{{namespace_id}}/services/{{service_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
