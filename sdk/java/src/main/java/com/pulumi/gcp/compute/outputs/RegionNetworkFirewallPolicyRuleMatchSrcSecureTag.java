...
public final class RegionNetworkFirewallPolicyRuleMatchSrcSecureTag {
    ...
    public static Builder builder(RegionNetworkFirewallPolicyRuleMatchSrcSecureTag defaults) {
    ...
    public static final class Builder {
        ...
        public RegionNetworkFirewallPolicyRuleMatchSrcSecureTag build() {
            final var _resultValue = new RegionNetworkFirewallPolicyRuleMatchSrcSecureTag();
