...
@CustomType
public final class ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading {
    /**
    ...
    private ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading() {}
    /**
     * @return Possible kernel module loading policies.
     * Accepted values are:
     * * `POLICY_UNSPECIFIED`: Default if unset. GKE selects the image based on node type. For CPU and TPU nodes, the image will not allow loading external kernel modules. For GPU nodes, the image will allow loading any module, whether it is signed or not.
    ...
    public static Builder builder(ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading defaults) {
    ...
    public static final class Builder {
        private @Nullable String policy;
        public Builder() {}
        public Builder(ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading defaults) {
        ...
        public ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading build() {
            final var _resultValue = new ClusterNodePoolNodeConfigLinuxNodeConfigNodeKernelModuleLoading();
