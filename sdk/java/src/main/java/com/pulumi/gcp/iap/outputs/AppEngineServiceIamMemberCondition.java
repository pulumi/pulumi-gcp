...
public final class AppEngineServiceIamMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("AppEngineServiceIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("AppEngineServiceIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public AppEngineServiceIamMemberCondition build() {
            final var _resultValue = new AppEngineServiceIamMemberCondition();
