...
@CustomType
public final class AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityCondition {
    /**
    ...
    public static Builder builder(AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String title;
        public Builder() {}
        public Builder(AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityCondition defaults) {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("AccessBoundaryPolicyRuleAccessBoundaryRuleAvailabilityCondition", "expression");
            }
