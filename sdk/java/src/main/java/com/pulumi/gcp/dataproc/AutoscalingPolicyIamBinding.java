...
public class AutoscalingPolicyIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public AutoscalingPolicyIamBinding(String name, AutoscalingPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataproc/autoscalingPolicyIamBinding:AutoscalingPolicyIamBinding", name, args == null ? AutoscalingPolicyIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
