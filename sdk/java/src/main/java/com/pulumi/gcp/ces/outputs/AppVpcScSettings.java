...
@CustomType
public final class AppVpcScSettings {
    /**
    ...
    public static Builder builder(AppVpcScSettings defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> allowedOrigins;
        public Builder() {}
        public Builder(AppVpcScSettings defaults) {
        ...
        public AppVpcScSettings build() {
            final var _resultValue = new AppVpcScSettings();
