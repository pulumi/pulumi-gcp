...
import com.pulumi.gcp.gemini.inputs.LoggingSettingBindingState;
 ...
 * 
 */
@ResourceType(type="gcp:gemini/loggingSettingBinding:LoggingSettingBinding")
public class LoggingSettingBinding extends com.pulumi.resources.CustomResource {
    /**
     * Create time stamp.
     * 
     */
     ...
     */
    public LoggingSettingBinding(java.lang.String name) {
        this(name, LoggingSettingBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LoggingSettingBinding(java.lang.String name, LoggingSettingBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LoggingSettingBinding(java.lang.String name, LoggingSettingBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/loggingSettingBinding:LoggingSettingBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LoggingSettingBinding(java.lang.String name, Output<java.lang.String> id, @Nullable LoggingSettingBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gemini/loggingSettingBinding:LoggingSettingBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static LoggingSettingBindingArgs makeArgs(LoggingSettingBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LoggingSettingBindingArgs.Empty : args;
    }
     ...
     */
    public static LoggingSettingBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable LoggingSettingBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
