...
public final class ClusterNodeConfigTaint {
    ...
    public static final class Builder {
        ...
        public Builder effect(String effect) {
            if (effect == null) {
              throw new MissingRequiredPropertyException("ClusterNodeConfigTaint", "effect");
            }
            this.effect = effect;
            return this;
        }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("ClusterNodeConfigTaint", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("ClusterNodeConfigTaint", "value");
            }
            this.value = value;
            return this;
        }
        public ClusterNodeConfigTaint build() {
            final var _resultValue = new ClusterNodeConfigTaint();
