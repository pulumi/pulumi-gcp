...
import com.pulumi.gcp.oracledatabase.outputs.GetCloudExadataInfrastructuresCloudExadataInfrastructure;
...
public final class GetCloudExadataInfrastructuresResult {
    ...
    public static final class Builder {
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructuresResult", "location");
            }
