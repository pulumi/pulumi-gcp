...
public final class GetRegionBackendServiceIamPolicyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetRegionBackendServiceIamPolicyArgs(GetRegionBackendServiceIamPolicyArgs $) {
        this.name = $.name;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRegionBackendServiceIamPolicyArgs();
        }

        public Builder(GetRegionBackendServiceIamPolicyArgs defaults) {
            $ = new GetRegionBackendServiceIamPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRegionBackendServiceIamPolicyArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetRegionBackendServiceIamPolicyArgs", "name");
            }
            return $;
        }
    }
