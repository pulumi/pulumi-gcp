...
public class ProjectDefaultConfig extends com.pulumi.resources.CustomResource {
     ...
     */
    public ProjectDefaultConfig(java.lang.String name) {
     ...
     */
    public ProjectDefaultConfig(java.lang.String name, @Nullable ProjectDefaultConfigArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ProjectDefaultConfig(java.lang.String name, @Nullable ProjectDefaultConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:identityplatform/projectDefaultConfig:ProjectDefaultConfig", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProjectDefaultConfig(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectDefaultConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:identityplatform/projectDefaultConfig:ProjectDefaultConfig", name, state, makeResourceOptions(options, id), false);
    }

    private static ProjectDefaultConfigArgs makeArgs(@Nullable ProjectDefaultConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ProjectDefaultConfigArgs.Empty : args;
    }
     ...
     */
    public static ProjectDefaultConfig get(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectDefaultConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
