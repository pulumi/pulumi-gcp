...
@CustomType
public final class CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig {
    /**
    ...
    private CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig() {}
    /**
     * @return Optional. The API key. If the `secretVersionForApiKey`` field is set, this field will be ignored.
     * **Note**: This property is sensitive and will not be displayed in the plan.
     * 
    ...
    public static Builder builder(CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String secretVersionForApiKey;
        public Builder() {}
        public Builder(CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig defaults) {
        ...
        public Builder keyName(String keyName) {
            if (keyName == null) {
              throw new MissingRequiredPropertyException("CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig", "keyName");
            }
        ...
        public Builder requestLocation(String requestLocation) {
            if (requestLocation == null) {
              throw new MissingRequiredPropertyException("CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig", "requestLocation");
            }
        ...
        public CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig build() {
            final var _resultValue = new CxToolVersionToolOpenApiSpecAuthenticationApiKeyConfig();
