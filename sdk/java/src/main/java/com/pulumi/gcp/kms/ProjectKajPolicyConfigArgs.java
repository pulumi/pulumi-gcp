...
public final class ProjectKajPolicyConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProjectKajPolicyConfigArgs Empty = new ProjectKajPolicyConfigArgs();
    ...
    private ProjectKajPolicyConfigArgs() {}

    private ProjectKajPolicyConfigArgs(ProjectKajPolicyConfigArgs $) {
    ...
    public static Builder builder(ProjectKajPolicyConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProjectKajPolicyConfigArgs();
        }

        public Builder(ProjectKajPolicyConfigArgs defaults) {
            $ = new ProjectKajPolicyConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProjectKajPolicyConfigArgs build() {
            return $;
        }
    }
