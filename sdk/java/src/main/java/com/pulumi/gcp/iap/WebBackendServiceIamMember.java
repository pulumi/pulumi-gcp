 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/webBackendServiceIamMember:WebBackendServiceIamMember editor &#34;projects/{{project}}/iap_web/compute/services/{{web_backend_service}} roles/iap.httpsResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class WebBackendServiceIamMember extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="condition", refs={WebBackendServiceIamMemberCondition.class}, tree="[0]")
     ...
     */
    public WebBackendServiceIamMember(java.lang.String name) {
     ...
     */
    public WebBackendServiceIamMember(java.lang.String name, WebBackendServiceIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebBackendServiceIamMember(java.lang.String name, WebBackendServiceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webBackendServiceIamMember:WebBackendServiceIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebBackendServiceIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable WebBackendServiceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/webBackendServiceIamMember:WebBackendServiceIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static WebBackendServiceIamMemberArgs makeArgs(WebBackendServiceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebBackendServiceIamMemberArgs.Empty : args;
    }
     ...
     */
    public static WebBackendServiceIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable WebBackendServiceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
