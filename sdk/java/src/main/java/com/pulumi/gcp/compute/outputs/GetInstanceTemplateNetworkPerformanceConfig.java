    ...
    public static final class Builder {
        ...
        public Builder totalEgressBandwidthTier(String totalEgressBandwidthTier) {
            if (totalEgressBandwidthTier == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateNetworkPerformanceConfig", "totalEgressBandwidthTier");
            }
            this.totalEgressBandwidthTier = totalEgressBandwidthTier;
            return this;
        }
        public GetInstanceTemplateNetworkPerformanceConfig build() {
            final var _resultValue = new GetInstanceTemplateNetworkPerformanceConfig();
