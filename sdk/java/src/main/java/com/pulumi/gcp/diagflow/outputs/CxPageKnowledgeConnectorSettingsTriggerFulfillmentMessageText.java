...
@CustomType
public final class CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageText {
    /**
     * @return (Output)
    ...
    private CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageText() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> texts;
        public Builder() {}
        public Builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageText defaults) {
        ...
        public CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageText build() {
            final var _resultValue = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageText();
