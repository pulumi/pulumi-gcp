...
public final class WorkerPoolTemplateVolumeSecretArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkerPoolTemplateVolumeSecretArgs Empty = new WorkerPoolTemplateVolumeSecretArgs();
     ...
     */
    @Import(name="items")
    private @Nullable Output<List<WorkerPoolTemplateVolumeSecretItemArgs>> items;
     ...
     * 
     */
    public Optional<Output<List<WorkerPoolTemplateVolumeSecretItemArgs>>> items() {
    ...
    private WorkerPoolTemplateVolumeSecretArgs() {}

    private WorkerPoolTemplateVolumeSecretArgs(WorkerPoolTemplateVolumeSecretArgs $) {
    ...
    public static Builder builder(WorkerPoolTemplateVolumeSecretArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkerPoolTemplateVolumeSecretArgs();
        }

        public Builder(WorkerPoolTemplateVolumeSecretArgs defaults) {
            $ = new WorkerPoolTemplateVolumeSecretArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder items(@Nullable Output<List<WorkerPoolTemplateVolumeSecretItemArgs>> items) {
            $.items = items;
            return this;
        }
         ...
         * 
         */
        public Builder items(List<WorkerPoolTemplateVolumeSecretItemArgs> items) {
         ...
         * 
         */
        public Builder items(WorkerPoolTemplateVolumeSecretItemArgs... items) {
        ...
        public WorkerPoolTemplateVolumeSecretArgs build() {
            if ($.secret == null) {
                throw new MissingRequiredPropertyException("WorkerPoolTemplateVolumeSecretArgs", "secret");
            }
            return $;
        }
    }
