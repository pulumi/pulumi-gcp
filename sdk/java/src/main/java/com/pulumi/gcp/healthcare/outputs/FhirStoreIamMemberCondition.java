...
public final class FhirStoreIamMemberCondition {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("FhirStoreIamMemberCondition", "expression");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("FhirStoreIamMemberCondition", "title");
            }
            this.title = title;
            return this;
        }
        public FhirStoreIamMemberCondition build() {
            final var _resultValue = new FhirStoreIamMemberCondition();
