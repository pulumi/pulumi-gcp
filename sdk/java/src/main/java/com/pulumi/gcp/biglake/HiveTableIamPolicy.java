...
import com.pulumi.gcp.biglake.inputs.HiveTableIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveTableIamPolicy:HiveTableIamPolicy")
public class HiveTableIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public HiveTableIamPolicy(java.lang.String name) {
        this(name, HiveTableIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveTableIamPolicy(java.lang.String name, HiveTableIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveTableIamPolicy(java.lang.String name, HiveTableIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveTableIamPolicy:HiveTableIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveTableIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable HiveTableIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveTableIamPolicy:HiveTableIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveTableIamPolicyArgs makeArgs(HiveTableIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveTableIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static HiveTableIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveTableIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
