...
@CustomType
public final class BatchSparkBatch {
    /**
    ...
    public static Builder builder(BatchSparkBatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String mainJarFileUri;
        public Builder() {}
        public Builder(BatchSparkBatch defaults) {
        ...
        public BatchSparkBatch build() {
            final var _resultValue = new BatchSparkBatch();
