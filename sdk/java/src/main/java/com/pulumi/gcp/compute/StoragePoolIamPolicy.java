...
import com.pulumi.gcp.compute.inputs.StoragePoolIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:compute/storagePoolIamPolicy:StoragePoolIamPolicy")
public class StoragePoolIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public StoragePoolIamPolicy(java.lang.String name) {
        this(name, StoragePoolIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public StoragePoolIamPolicy(java.lang.String name, StoragePoolIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StoragePoolIamPolicy(java.lang.String name, StoragePoolIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/storagePoolIamPolicy:StoragePoolIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StoragePoolIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable StoragePoolIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/storagePoolIamPolicy:StoragePoolIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static StoragePoolIamPolicyArgs makeArgs(StoragePoolIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? StoragePoolIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static StoragePoolIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable StoragePoolIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new StoragePoolIamPolicy(name, id, state, options);
    }
}
