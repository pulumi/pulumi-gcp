...
public final class BackendServiceIamMemberConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BackendServiceIamMemberConditionArgs build() {
            if ($.expression == null) {
                throw new MissingRequiredPropertyException("BackendServiceIamMemberConditionArgs", "expression");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("BackendServiceIamMemberConditionArgs", "title");
            }
            return $;
        }
    }
