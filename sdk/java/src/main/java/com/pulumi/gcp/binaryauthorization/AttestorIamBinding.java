 ...
 * 
 * ```sh
 * $ pulumi import gcp:binaryauthorization/attestorIamBinding:AttestorIamBinding editor &#34;projects/{{project}}/attestors/{{attestor}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class AttestorIamBinding extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="condition", refs={AttestorIamBindingCondition.class}, tree="[0]")
     ...
     */
    public AttestorIamBinding(java.lang.String name) {
     ...
     */
    public AttestorIamBinding(java.lang.String name, AttestorIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AttestorIamBinding(java.lang.String name, AttestorIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:binaryauthorization/attestorIamBinding:AttestorIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AttestorIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable AttestorIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:binaryauthorization/attestorIamBinding:AttestorIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static AttestorIamBindingArgs makeArgs(AttestorIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AttestorIamBindingArgs.Empty : args;
    }
     ...
     */
    public static AttestorIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable AttestorIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
