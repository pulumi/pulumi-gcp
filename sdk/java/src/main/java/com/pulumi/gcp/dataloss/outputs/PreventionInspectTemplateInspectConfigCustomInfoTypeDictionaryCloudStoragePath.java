...
public final class PreventionInspectTemplateInspectConfigCustomInfoTypeDictionaryCloudStoragePath {
    ...
    public static final class Builder {
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("PreventionInspectTemplateInspectConfigCustomInfoTypeDictionaryCloudStoragePath", "path");
            }
            this.path = path;
            return this;
        }
        public PreventionInspectTemplateInspectConfigCustomInfoTypeDictionaryCloudStoragePath build() {
            final var _resultValue = new PreventionInspectTemplateInspectConfigCustomInfoTypeDictionaryCloudStoragePath();
