...
public final class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs", "object");
            }
            this.object = object;
            return this;
        }
        public OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs build() {
            final var _resultValue = new OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs();
