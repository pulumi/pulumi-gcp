...
import com.pulumi.gcp.biglake.inputs.HiveDatabaseIamMemberState;
import com.pulumi.gcp.biglake.outputs.HiveDatabaseIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveDatabaseIamMember:HiveDatabaseIamMember")
public class HiveDatabaseIamMember extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={HiveDatabaseIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ HiveDatabaseIamMemberCondition> condition;

    public Output<Optional<HiveDatabaseIamMemberCondition>> condition() {
     ...
     */
    public HiveDatabaseIamMember(java.lang.String name) {
        this(name, HiveDatabaseIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveDatabaseIamMember(java.lang.String name, HiveDatabaseIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveDatabaseIamMember(java.lang.String name, HiveDatabaseIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveDatabaseIamMember:HiveDatabaseIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveDatabaseIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable HiveDatabaseIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveDatabaseIamMember:HiveDatabaseIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveDatabaseIamMemberArgs makeArgs(HiveDatabaseIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveDatabaseIamMemberArgs.Empty : args;
    }
     ...
     */
    public static HiveDatabaseIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveDatabaseIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
