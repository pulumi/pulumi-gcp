...
import com.pulumi.gcp.beyondcorp.inputs.SecurityGatewayIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:beyondcorp/securityGatewayIamPolicy:SecurityGatewayIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/securityGateways/{{security_gateway_id}} roles/beyondcorp.securityGatewayUser user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:beyondcorp/securityGatewayIamPolicy:SecurityGatewayIamPolicy")
public class SecurityGatewayIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public SecurityGatewayIamPolicy(java.lang.String name) {
        this(name, SecurityGatewayIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SecurityGatewayIamPolicy(java.lang.String name, SecurityGatewayIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SecurityGatewayIamPolicy(java.lang.String name, SecurityGatewayIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayIamPolicy:SecurityGatewayIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SecurityGatewayIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayIamPolicy:SecurityGatewayIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static SecurityGatewayIamPolicyArgs makeArgs(SecurityGatewayIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SecurityGatewayIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static SecurityGatewayIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
