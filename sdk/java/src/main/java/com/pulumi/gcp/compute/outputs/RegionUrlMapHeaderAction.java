...
import com.pulumi.gcp.compute.outputs.RegionUrlMapHeaderActionRequestHeadersToAdd;
import com.pulumi.gcp.compute.outputs.RegionUrlMapHeaderActionResponseHeadersToAdd;
...
@CustomType
public final class RegionUrlMapHeaderAction {
    /**
     * @return Headers to add to a matching request before forwarding the request to the backendService.
     * Structure is documented below.
     * 
     */
    private @Nullable List<RegionUrlMapHeaderActionRequestHeadersToAdd> requestHeadersToAdds;
    /**
     ...
     * 
     */
    private @Nullable List<RegionUrlMapHeaderActionResponseHeadersToAdd> responseHeadersToAdds;
    /**
     ...
     * 
     */
    public List<RegionUrlMapHeaderActionRequestHeadersToAdd> requestHeadersToAdds() {
     ...
     * 
     */
    public List<RegionUrlMapHeaderActionResponseHeadersToAdd> responseHeadersToAdds() {
    ...
    public static Builder builder(RegionUrlMapHeaderAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> responseHeadersToRemoves;
        public Builder() {}
        public Builder(RegionUrlMapHeaderAction defaults) {
        ...
        @CustomType.Setter
        public Builder requestHeadersToAdds(@Nullable List<RegionUrlMapHeaderActionRequestHeadersToAdd> requestHeadersToAdds) {

            this.requestHeadersToAdds = requestHeadersToAdds;
            return this;
        }
        public Builder requestHeadersToAdds(RegionUrlMapHeaderActionRequestHeadersToAdd... requestHeadersToAdds) {
        ...
        @CustomType.Setter
        public Builder responseHeadersToAdds(@Nullable List<RegionUrlMapHeaderActionResponseHeadersToAdd> responseHeadersToAdds) {

            this.responseHeadersToAdds = responseHeadersToAdds;
            return this;
        }
        public Builder responseHeadersToAdds(RegionUrlMapHeaderActionResponseHeadersToAdd... responseHeadersToAdds) {
        ...
        public RegionUrlMapHeaderAction build() {
            final var _resultValue = new RegionUrlMapHeaderAction();
