...
import com.pulumi.gcp.biglake.inputs.IcebergCatalogIamBindingState;
import com.pulumi.gcp.biglake.outputs.IcebergCatalogIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:biglake/icebergCatalogIamBinding:IcebergCatalogIamBinding editor &#34;projects/{{project}}/catalogs/{{iceberg_catalog}} roles/biglake.editor user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:biglake/icebergCatalogIamBinding:IcebergCatalogIamBinding")
public class IcebergCatalogIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={IcebergCatalogIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ IcebergCatalogIamBindingCondition> condition;

    public Output<Optional<IcebergCatalogIamBindingCondition>> condition() {
     ...
     */
    public IcebergCatalogIamBinding(java.lang.String name) {
        this(name, IcebergCatalogIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IcebergCatalogIamBinding(java.lang.String name, IcebergCatalogIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IcebergCatalogIamBinding(java.lang.String name, IcebergCatalogIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergCatalogIamBinding:IcebergCatalogIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IcebergCatalogIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergCatalogIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergCatalogIamBinding:IcebergCatalogIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static IcebergCatalogIamBindingArgs makeArgs(IcebergCatalogIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IcebergCatalogIamBindingArgs.Empty : args;
    }
     ...
     */
    public static IcebergCatalogIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergCatalogIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
