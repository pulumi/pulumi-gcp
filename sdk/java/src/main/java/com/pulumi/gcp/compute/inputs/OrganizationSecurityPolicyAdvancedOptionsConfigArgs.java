...
public final class OrganizationSecurityPolicyAdvancedOptionsConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final OrganizationSecurityPolicyAdvancedOptionsConfigArgs Empty = new OrganizationSecurityPolicyAdvancedOptionsConfigArgs();
    ...
    private @Nullable Output<OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfigArgs> jsonCustomConfig;

    /**
     * @return Custom JSON parsing configurations.
     * Structure is documented below.
     * 
     */
    public Optional<Output<OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfigArgs>> jsonCustomConfig() {
    ...
    /**
     * @return An optional list of case-insensitive request header names to use for resolving the client source IP address.
     * 
     */
    ...
    private OrganizationSecurityPolicyAdvancedOptionsConfigArgs() {}

    private OrganizationSecurityPolicyAdvancedOptionsConfigArgs(OrganizationSecurityPolicyAdvancedOptionsConfigArgs $) {
    ...
    public static Builder builder(OrganizationSecurityPolicyAdvancedOptionsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrganizationSecurityPolicyAdvancedOptionsConfigArgs();
        }

        public Builder(OrganizationSecurityPolicyAdvancedOptionsConfigArgs defaults) {
            $ = new OrganizationSecurityPolicyAdvancedOptionsConfigArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param jsonCustomConfig Custom JSON parsing configurations.
         * Structure is documented below.
         * 
         * @return builder
         * 
         */
        public Builder jsonCustomConfig(@Nullable Output<OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfigArgs> jsonCustomConfig) {
         ...
         * 
         */
        public Builder jsonCustomConfig(OrganizationSecurityPolicyAdvancedOptionsConfigJsonCustomConfigArgs jsonCustomConfig) {
        ...
        /**
         * @param userIpRequestHeaders An optional list of case-insensitive request header names to use for resolving the client source IP address.
         * 
         * @return builder
         * 
         */
        ...
        public OrganizationSecurityPolicyAdvancedOptionsConfigArgs build() {
            return $;
        }
    }
