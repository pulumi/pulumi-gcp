...
import com.pulumi.gcp.compute.inputs.RegionNetworkFirewallPolicyIamBindingState;
import com.pulumi.gcp.compute.outputs.RegionNetworkFirewallPolicyIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:compute/regionNetworkFirewallPolicyIamBinding:RegionNetworkFirewallPolicyIamBinding")
public class RegionNetworkFirewallPolicyIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={RegionNetworkFirewallPolicyIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ RegionNetworkFirewallPolicyIamBindingCondition> condition;

    public Output<Optional<RegionNetworkFirewallPolicyIamBindingCondition>> condition() {
     ...
     */
    public RegionNetworkFirewallPolicyIamBinding(java.lang.String name) {
        this(name, RegionNetworkFirewallPolicyIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RegionNetworkFirewallPolicyIamBinding(java.lang.String name, RegionNetworkFirewallPolicyIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RegionNetworkFirewallPolicyIamBinding(java.lang.String name, RegionNetworkFirewallPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionNetworkFirewallPolicyIamBinding:RegionNetworkFirewallPolicyIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RegionNetworkFirewallPolicyIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable RegionNetworkFirewallPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/regionNetworkFirewallPolicyIamBinding:RegionNetworkFirewallPolicyIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static RegionNetworkFirewallPolicyIamBindingArgs makeArgs(RegionNetworkFirewallPolicyIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RegionNetworkFirewallPolicyIamBindingArgs.Empty : args;
    }
     ...
     */
    public static RegionNetworkFirewallPolicyIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable RegionNetworkFirewallPolicyIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RegionNetworkFirewallPolicyIamBinding(name, id, state, options);
    }
}
