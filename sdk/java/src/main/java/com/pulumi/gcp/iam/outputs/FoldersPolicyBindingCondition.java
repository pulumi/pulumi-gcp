...
@CustomType
public final class FoldersPolicyBindingCondition {
    /**
    ...
    public static Builder builder(FoldersPolicyBindingCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String title;
        public Builder() {}
        public Builder(FoldersPolicyBindingCondition defaults) {
        ...
        public FoldersPolicyBindingCondition build() {
            final var _resultValue = new FoldersPolicyBindingCondition();
