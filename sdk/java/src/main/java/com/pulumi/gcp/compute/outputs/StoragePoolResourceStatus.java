...
public final class StoragePoolResourceStatus {
    ...
    public static Builder builder(StoragePoolResourceStatus defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String totalProvisionedDiskThroughput;
        public Builder() {}
        public Builder(StoragePoolResourceStatus defaults) {
        ...
        public StoragePoolResourceStatus build() {
            final var _resultValue = new StoragePoolResourceStatus();
