...
import com.pulumi.gcp.workbench.InstanceIamBindingArgs;
import com.pulumi.gcp.workbench.inputs.InstanceIamBindingState;
import com.pulumi.gcp.workbench.outputs.InstanceIamBindingCondition;
import java.lang.String;
import java.util.List;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="gcp:workbench/instanceIamBinding:InstanceIamBinding")
public class InstanceIamBinding extends com.pulumi.resources.CustomResource {
    ...
    public InstanceIamBinding(String name, InstanceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:workbench/instanceIamBinding:InstanceIamBinding", name, args == null ? InstanceIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
