...
public final class CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs Empty = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs();
    ...
    private CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs() {}

    private CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs $) {
    ...
    public static Builder builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs();
        }

        public Builder(CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs defaults) {
            $ = new CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CxPageKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs build() {
            return $;
        }
    }
