...
public class EntryTypeIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public EntryTypeIamPolicy(String name) {
     ...
     */
    public EntryTypeIamPolicy(String name, EntryTypeIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EntryTypeIamPolicy(String name, EntryTypeIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/entryTypeIamPolicy:EntryTypeIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private EntryTypeIamPolicy(String name, Output<String> id, @Nullable EntryTypeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:dataplex/entryTypeIamPolicy:EntryTypeIamPolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static EntryTypeIamPolicy get(String name, Output<String> id, @Nullable EntryTypeIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
