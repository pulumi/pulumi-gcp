...
public final class JobTemplateTemplateContainerVolumeMount {
    ...
    public static Builder builder(JobTemplateTemplateContainerVolumeMount defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subPath;
        public Builder() {}
        public Builder(JobTemplateTemplateContainerVolumeMount defaults) {
        ...
        public Builder mountPath(String mountPath) {
            if (mountPath == null) {
              throw new MissingRequiredPropertyException("JobTemplateTemplateContainerVolumeMount", "mountPath");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("JobTemplateTemplateContainerVolumeMount", "name");
            }
            this.name = name;
            return this;
        }
