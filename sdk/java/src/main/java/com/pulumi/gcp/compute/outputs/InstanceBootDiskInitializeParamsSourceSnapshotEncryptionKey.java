...
@CustomType
public final class InstanceBootDiskInitializeParamsSourceSnapshotEncryptionKey {
    /**
    ...
    public static Builder builder(InstanceBootDiskInitializeParamsSourceSnapshotEncryptionKey defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sha256;
        public Builder() {}
        public Builder(InstanceBootDiskInitializeParamsSourceSnapshotEncryptionKey defaults) {
        ...
        public InstanceBootDiskInitializeParamsSourceSnapshotEncryptionKey build() {
            final var _resultValue = new InstanceBootDiskInitializeParamsSourceSnapshotEncryptionKey();
