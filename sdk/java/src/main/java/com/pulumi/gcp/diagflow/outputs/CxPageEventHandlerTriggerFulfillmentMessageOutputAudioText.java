...
@CustomType
public final class CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText {
    /**
     * @return (Output)
    ...
    private CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText() {}
    /**
     * @return (Output)
     * Whether the playback of this message can be interrupted by the end user&#39;s speech and the client can then starts the next Dialogflow request.
     * 
    ...
    public static Builder builder(CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String text;
        public Builder() {}
        public Builder(CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText defaults) {
        ...
        public CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText build() {
            final var _resultValue = new CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText();
