...
import com.pulumi.gcp.accesscontextmanager.outputs.ServicePerimeterDryRunEgressPolicyEgressFromSource;
...
@CustomType
public final class ServicePerimeterDryRunEgressPolicyEgressFrom {
    /**
     ...
     * 
     */
    private @Nullable List<ServicePerimeterDryRunEgressPolicyEgressFromSource> sources;
     ...
     * 
     */
    public List<ServicePerimeterDryRunEgressPolicyEgressFromSource> sources() {
    ...
    public static Builder builder(ServicePerimeterDryRunEgressPolicyEgressFrom defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<ServicePerimeterDryRunEgressPolicyEgressFromSource> sources;
        public Builder() {}
        public Builder(ServicePerimeterDryRunEgressPolicyEgressFrom defaults) {
        ...
        @CustomType.Setter
        public Builder sources(@Nullable List<ServicePerimeterDryRunEgressPolicyEgressFromSource> sources) {

            this.sources = sources;
            return this;
        }
        public Builder sources(ServicePerimeterDryRunEgressPolicyEgressFromSource... sources) {
            return sources(List.of(sources));
        }
        public ServicePerimeterDryRunEgressPolicyEgressFrom build() {
            final var _resultValue = new ServicePerimeterDryRunEgressPolicyEgressFrom();
