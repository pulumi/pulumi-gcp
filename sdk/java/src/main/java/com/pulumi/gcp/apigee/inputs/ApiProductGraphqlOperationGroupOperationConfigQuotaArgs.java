...
public final class ApiProductGraphqlOperationGroupOperationConfigQuotaArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiProductGraphqlOperationGroupOperationConfigQuotaArgs Empty = new ApiProductGraphqlOperationGroupOperationConfigQuotaArgs();
    ...
    private ApiProductGraphqlOperationGroupOperationConfigQuotaArgs() {}

    private ApiProductGraphqlOperationGroupOperationConfigQuotaArgs(ApiProductGraphqlOperationGroupOperationConfigQuotaArgs $) {
    ...
    public static Builder builder(ApiProductGraphqlOperationGroupOperationConfigQuotaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiProductGraphqlOperationGroupOperationConfigQuotaArgs();
        }

        public Builder(ApiProductGraphqlOperationGroupOperationConfigQuotaArgs defaults) {
            $ = new ApiProductGraphqlOperationGroupOperationConfigQuotaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiProductGraphqlOperationGroupOperationConfigQuotaArgs build() {
            return $;
        }
    }
