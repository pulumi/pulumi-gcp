...
import com.pulumi.gcp.clouddeploy.TargetIamBindingArgs;
import com.pulumi.gcp.clouddeploy.inputs.TargetIamBindingState;
import com.pulumi.gcp.clouddeploy.outputs.TargetIamBindingCondition;
import java.lang.String;
import java.util.List;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="gcp:clouddeploy/targetIamBinding:TargetIamBinding")
public class TargetIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={TargetIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ TargetIamBindingCondition> condition;

    public Output<Optional<TargetIamBindingCondition>> condition() {
    ...
    public TargetIamBinding(String name, TargetIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:clouddeploy/targetIamBinding:TargetIamBinding", name, args == null ? TargetIamBindingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
