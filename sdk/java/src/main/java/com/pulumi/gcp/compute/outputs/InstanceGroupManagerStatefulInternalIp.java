...
@CustomType
public final class InstanceGroupManagerStatefulInternalIp {
    /**
    ...
    public static Builder builder(InstanceGroupManagerStatefulInternalIp defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String interfaceName;
        public Builder() {}
        public Builder(InstanceGroupManagerStatefulInternalIp defaults) {
        ...
        public InstanceGroupManagerStatefulInternalIp build() {
            final var _resultValue = new InstanceGroupManagerStatefulInternalIp();
