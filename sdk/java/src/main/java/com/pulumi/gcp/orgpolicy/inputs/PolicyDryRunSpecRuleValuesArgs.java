...
public final class PolicyDryRunSpecRuleValuesArgs extends com.pulumi.resources.ResourceArgs {

    public static final PolicyDryRunSpecRuleValuesArgs Empty = new PolicyDryRunSpecRuleValuesArgs();
    ...
    private PolicyDryRunSpecRuleValuesArgs() {}

    private PolicyDryRunSpecRuleValuesArgs(PolicyDryRunSpecRuleValuesArgs $) {
    ...
    public static Builder builder(PolicyDryRunSpecRuleValuesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyDryRunSpecRuleValuesArgs();
        }

        public Builder(PolicyDryRunSpecRuleValuesArgs defaults) {
            $ = new PolicyDryRunSpecRuleValuesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyDryRunSpecRuleValuesArgs build() {
            return $;
        }
    }
