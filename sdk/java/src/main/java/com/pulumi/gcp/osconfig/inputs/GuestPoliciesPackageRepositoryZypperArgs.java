...
public final class GuestPoliciesPackageRepositoryZypperArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return A one word, unique name for this repository. This is the repo id in the zypper config file and also the displayName
     * if displayName is omitted. This id is also used as the unique identifier when checking for guest policy conflicts.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param id A one word, unique name for this repository. This is the repo id in the zypper config file and also the displayName
         * if displayName is omitted. This id is also used as the unique identifier when checking for guest policy conflicts.
         * 
         * @return builder
         * 
        ...
        public GuestPoliciesPackageRepositoryZypperArgs build() {
            if ($.baseUrl == null) {
                throw new MissingRequiredPropertyException("GuestPoliciesPackageRepositoryZypperArgs", "baseUrl");
            }
            if ($.id == null) {
                throw new MissingRequiredPropertyException("GuestPoliciesPackageRepositoryZypperArgs", "id");
            }
            return $;
        }
    }
