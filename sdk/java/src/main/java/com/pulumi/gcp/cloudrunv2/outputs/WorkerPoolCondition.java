...
@CustomType
public final class WorkerPoolCondition {
    /**
     * @return (Output)
    ...
    public static Builder builder(WorkerPoolCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(WorkerPoolCondition defaults) {
        ...
        public WorkerPoolCondition build() {
            final var _resultValue = new WorkerPoolCondition();
