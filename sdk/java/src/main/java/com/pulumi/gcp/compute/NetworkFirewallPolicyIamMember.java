...
import com.pulumi.gcp.compute.inputs.NetworkFirewallPolicyIamMemberState;
import com.pulumi.gcp.compute.outputs.NetworkFirewallPolicyIamMemberCondition;
 ...
 * 
 */
@ResourceType(type="gcp:compute/networkFirewallPolicyIamMember:NetworkFirewallPolicyIamMember")
public class NetworkFirewallPolicyIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={NetworkFirewallPolicyIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ NetworkFirewallPolicyIamMemberCondition> condition;

    public Output<Optional<NetworkFirewallPolicyIamMemberCondition>> condition() {
     ...
     */
    public NetworkFirewallPolicyIamMember(java.lang.String name) {
        this(name, NetworkFirewallPolicyIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public NetworkFirewallPolicyIamMember(java.lang.String name, NetworkFirewallPolicyIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NetworkFirewallPolicyIamMember(java.lang.String name, NetworkFirewallPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/networkFirewallPolicyIamMember:NetworkFirewallPolicyIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NetworkFirewallPolicyIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkFirewallPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:compute/networkFirewallPolicyIamMember:NetworkFirewallPolicyIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static NetworkFirewallPolicyIamMemberArgs makeArgs(NetworkFirewallPolicyIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NetworkFirewallPolicyIamMemberArgs.Empty : args;
    }
     ...
     */
    public static NetworkFirewallPolicyIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkFirewallPolicyIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
