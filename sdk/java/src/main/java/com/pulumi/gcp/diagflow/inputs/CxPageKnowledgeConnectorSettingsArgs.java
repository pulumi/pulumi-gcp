...
public final class CxPageKnowledgeConnectorSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CxPageKnowledgeConnectorSettingsArgs Empty = new CxPageKnowledgeConnectorSettingsArgs();
    ...
    private @Nullable Output<List<CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs>> dataStoreConnections;
     ...
     * 
     */
    public Optional<Output<List<CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs>>> dataStoreConnections() {
    ...
    private @Nullable Output<CxPageKnowledgeConnectorSettingsTriggerFulfillmentArgs> triggerFulfillment;
     ...
     * 
     */
    public Optional<Output<CxPageKnowledgeConnectorSettingsTriggerFulfillmentArgs>> triggerFulfillment() {
        return Optional.ofNullable(this.triggerFulfillment);
    }

    private CxPageKnowledgeConnectorSettingsArgs() {}

    private CxPageKnowledgeConnectorSettingsArgs(CxPageKnowledgeConnectorSettingsArgs $) {
    ...
    public static Builder builder(CxPageKnowledgeConnectorSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CxPageKnowledgeConnectorSettingsArgs();
        }

        public Builder(CxPageKnowledgeConnectorSettingsArgs defaults) {
            $ = new CxPageKnowledgeConnectorSettingsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dataStoreConnections(@Nullable Output<List<CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs>> dataStoreConnections) {
         ...
         * 
         */
        public Builder dataStoreConnections(List<CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs> dataStoreConnections) {
         ...
         * 
         */
        public Builder dataStoreConnections(CxPageKnowledgeConnectorSettingsDataStoreConnectionArgs... dataStoreConnections) {
         ...
         * 
         */
        public Builder triggerFulfillment(@Nullable Output<CxPageKnowledgeConnectorSettingsTriggerFulfillmentArgs> triggerFulfillment) {
         ...
         * 
         */
        public Builder triggerFulfillment(CxPageKnowledgeConnectorSettingsTriggerFulfillmentArgs triggerFulfillment) {
            return triggerFulfillment(Output.of(triggerFulfillment));
        }

        public CxPageKnowledgeConnectorSettingsArgs build() {
            return $;
        }
    }
