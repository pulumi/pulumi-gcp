...
import com.pulumi.gcp.transcoder.inputs.JobConfigElementaryStreamVideoStreamH264HlgArgs;
import com.pulumi.gcp.transcoder.inputs.JobConfigElementaryStreamVideoStreamH264SdrArgs;
...
public final class JobConfigElementaryStreamVideoStreamH264Args extends com.pulumi.resources.ResourceArgs {

    public static final JobConfigElementaryStreamVideoStreamH264Args Empty = new JobConfigElementaryStreamVideoStreamH264Args();
     ...
     */
    @Import(name="hlg")
    private @Nullable Output<JobConfigElementaryStreamVideoStreamH264HlgArgs> hlg;

    /**
     * @return HLG color format setting for H264.
     * 
     */
    public Optional<Output<JobConfigElementaryStreamVideoStreamH264HlgArgs>> hlg() {
     ...
     */
    @Import(name="sdr")
    private @Nullable Output<JobConfigElementaryStreamVideoStreamH264SdrArgs> sdr;

    /**
     * @return SDR color format setting for H264.
     * 
     */
    public Optional<Output<JobConfigElementaryStreamVideoStreamH264SdrArgs>> sdr() {
    ...
    private JobConfigElementaryStreamVideoStreamH264Args() {}

    private JobConfigElementaryStreamVideoStreamH264Args(JobConfigElementaryStreamVideoStreamH264Args $) {
    ...
    public static Builder builder(JobConfigElementaryStreamVideoStreamH264Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobConfigElementaryStreamVideoStreamH264Args();
        }

        public Builder(JobConfigElementaryStreamVideoStreamH264Args defaults) {
            $ = new JobConfigElementaryStreamVideoStreamH264Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder hlg(@Nullable Output<JobConfigElementaryStreamVideoStreamH264HlgArgs> hlg) {
            $.hlg = hlg;
            return this;
        }
         ...
         * 
         */
        public Builder hlg(JobConfigElementaryStreamVideoStreamH264HlgArgs hlg) {
         ...
         * 
         */
        public Builder sdr(@Nullable Output<JobConfigElementaryStreamVideoStreamH264SdrArgs> sdr) {
            $.sdr = sdr;
            return this;
        }
         ...
         * 
         */
        public Builder sdr(JobConfigElementaryStreamVideoStreamH264SdrArgs sdr) {
        ...
        public JobConfigElementaryStreamVideoStreamH264Args build() {
            if ($.bitrateBps == null) {
                throw new MissingRequiredPropertyException("JobConfigElementaryStreamVideoStreamH264Args", "bitrateBps");
            }
            if ($.frameRate == null) {
                throw new MissingRequiredPropertyException("JobConfigElementaryStreamVideoStreamH264Args", "frameRate");
            }
            return $;
        }
    }
