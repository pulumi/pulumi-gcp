...
public class ServiceIamMember extends com.pulumi.resources.CustomResource {
    ...
    public ServiceIamMember(java.lang.String name, ServiceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamMember:ServiceIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ServiceIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable ServiceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamMember:ServiceIamMember", name, state, makeResourceOptions(options, id), false);
    }
