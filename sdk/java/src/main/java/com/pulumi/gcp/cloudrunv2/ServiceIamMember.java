...
import com.pulumi.gcp.cloudrunv2.inputs.ServiceIamMemberState;
import com.pulumi.gcp.cloudrunv2.outputs.ServiceIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrunv2/serviceIamMember:ServiceIamMember editor &#34;projects/{{project}}/locations/{{location}}/services/{{service}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudrunv2/serviceIamMember:ServiceIamMember")
public class ServiceIamMember extends com.pulumi.resources.CustomResource {
    ...
    public ServiceIamMember(String name, ServiceIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamMember:ServiceIamMember", name, args == null ? ServiceIamMemberArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ServiceIamMember(String name, Output<String> id, @Nullable ServiceIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamMember:ServiceIamMember", name, state, makeResourceOptions(options, id));
    }
