...
public final class GetExascaleDbStorageVaultsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static Builder builder(GetExascaleDbStorageVaultsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExascaleDbStorageVaultsPlainArgs();
        }
        ...
        public GetExascaleDbStorageVaultsPlainArgs build() {
            if ($.location == null) {
                throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultsPlainArgs", "location");
            }
            return $;
        }
    }
