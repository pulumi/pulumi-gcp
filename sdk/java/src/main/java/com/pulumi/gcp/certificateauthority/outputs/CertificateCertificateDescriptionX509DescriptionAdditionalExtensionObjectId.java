...
@CustomType
public final class CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectId {
    /**
    ...
    private CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectId(@CustomType.Parameter("objectIdPaths") @Nullable List<Integer> objectIdPaths) {
    ...
    public static Builder builder(CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectId defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectId defaults) {
        ...
        public Builder objectIdPaths(Integer... objectIdPaths) {
            ...
            return new CertificateCertificateDescriptionX509DescriptionAdditionalExtensionObjectId(objectIdPaths);
        }
    }
}
