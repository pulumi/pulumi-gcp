...
public class BackupPlanIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public BackupPlanIamPolicy(String name, BackupPlanIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/backupPlanIamPolicy:BackupPlanIamPolicy", name, args == null ? BackupPlanIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
