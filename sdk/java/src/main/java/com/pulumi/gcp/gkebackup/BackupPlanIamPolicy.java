...
import com.pulumi.gcp.gkebackup.inputs.BackupPlanIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:gkebackup/backupPlanIamPolicy:BackupPlanIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/backupPlans/{{backup_plan}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:gkebackup/backupPlanIamPolicy:BackupPlanIamPolicy")
public class BackupPlanIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public BackupPlanIamPolicy(java.lang.String name) {
     ...
     */
    public BackupPlanIamPolicy(java.lang.String name, BackupPlanIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BackupPlanIamPolicy(java.lang.String name, BackupPlanIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/backupPlanIamPolicy:BackupPlanIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BackupPlanIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable BackupPlanIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/backupPlanIamPolicy:BackupPlanIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static BackupPlanIamPolicyArgs makeArgs(BackupPlanIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BackupPlanIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static BackupPlanIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable BackupPlanIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
