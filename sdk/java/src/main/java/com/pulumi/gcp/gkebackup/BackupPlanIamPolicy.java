...
public class BackupPlanIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public BackupPlanIamPolicy(String name, BackupPlanIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/backupPlanIamPolicy:BackupPlanIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private BackupPlanIamPolicy(String name, Output<String> id, @Nullable BackupPlanIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:gkebackup/backupPlanIamPolicy:BackupPlanIamPolicy", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static BackupPlanIamPolicy get(String name, Output<String> id, @Nullable BackupPlanIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
