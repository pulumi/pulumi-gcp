...
@CustomType
public final class BillingAccountBucketConfigIndexConfig {
    /**
    ...
    public static Builder builder(BillingAccountBucketConfigIndexConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(BillingAccountBucketConfigIndexConfig defaults) {
        ...
        public Builder fieldPath(String fieldPath) {
            if (fieldPath == null) {
              throw new MissingRequiredPropertyException("BillingAccountBucketConfigIndexConfig", "fieldPath");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("BillingAccountBucketConfigIndexConfig", "type");
            }
            this.type = type;
            return this;
        }
