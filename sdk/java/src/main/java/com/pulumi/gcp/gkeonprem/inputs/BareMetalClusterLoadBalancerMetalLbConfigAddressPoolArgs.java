...
public final class BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs extends com.pulumi.resources.ResourceArgs {

    public static final BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs Empty = new BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs();
    ...
    private BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs() {}

    private BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs(BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs $) {
    ...
    public static Builder builder(BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs();
        }

        public Builder(BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs defaults) {
            $ = new BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs build() {
            if ($.addresses == null) {
                throw new MissingRequiredPropertyException("BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs", "addresses");
            }
            if ($.pool == null) {
                throw new MissingRequiredPropertyException("BareMetalClusterLoadBalancerMetalLbConfigAddressPoolArgs", "pool");
            }
            return $;
        }
    }
