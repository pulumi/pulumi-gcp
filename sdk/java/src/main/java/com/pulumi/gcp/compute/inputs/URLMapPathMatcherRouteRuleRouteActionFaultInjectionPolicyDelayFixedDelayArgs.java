...
public final class URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs $) {
        this.nanos = $.nanos;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs();
        }

        public Builder(URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs defaults) {
            $ = new URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs build() {
            if ($.seconds == null) {
                throw new MissingRequiredPropertyException("URLMapPathMatcherRouteRuleRouteActionFaultInjectionPolicyDelayFixedDelayArgs", "seconds");
            }
            return $;
        }
    }
