...
@CustomType
public final class CxPageFormParameterFillBehaviorInitialPromptFulfillmentSetParameterAction {
    /**
    ...
    private CxPageFormParameterFillBehaviorInitialPromptFulfillmentSetParameterAction() {}
    /**
     * @return Display name of the parameter.
     * 
     */
    ...
    public static Builder builder(CxPageFormParameterFillBehaviorInitialPromptFulfillmentSetParameterAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(CxPageFormParameterFillBehaviorInitialPromptFulfillmentSetParameterAction defaults) {
