...
@CustomType
public final class CxAgentAdvancedSettingsLoggingSettings {
    /**
    ...
    public static Builder builder(CxAgentAdvancedSettingsLoggingSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean enableStackdriverLogging;
        public Builder() {}
        public Builder(CxAgentAdvancedSettingsLoggingSettings defaults) {
        ...
        public CxAgentAdvancedSettingsLoggingSettings build() {
            final var _resultValue = new CxAgentAdvancedSettingsLoggingSettings();
