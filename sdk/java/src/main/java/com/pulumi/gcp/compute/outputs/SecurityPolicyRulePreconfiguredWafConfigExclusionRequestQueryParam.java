...
@CustomType
public final class SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam {
    /**
    ...
    public static Builder builder(SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam defaults) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("SecurityPolicyRulePreconfiguredWafConfigExclusionRequestQueryParam", "operator");
            }
