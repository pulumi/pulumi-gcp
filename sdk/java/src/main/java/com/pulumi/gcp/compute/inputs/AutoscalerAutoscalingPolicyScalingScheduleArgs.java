...
public final class AutoscalerAutoscalingPolicyScalingScheduleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AutoscalerAutoscalingPolicyScalingScheduleArgs build() {
            if ($.durationSec == null) {
                throw new MissingRequiredPropertyException("AutoscalerAutoscalingPolicyScalingScheduleArgs", "durationSec");
            }
            if ($.minRequiredReplicas == null) {
                throw new MissingRequiredPropertyException("AutoscalerAutoscalingPolicyScalingScheduleArgs", "minRequiredReplicas");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("AutoscalerAutoscalingPolicyScalingScheduleArgs", "name");
            }
            if ($.schedule == null) {
                throw new MissingRequiredPropertyException("AutoscalerAutoscalingPolicyScalingScheduleArgs", "schedule");
            }
            return $;
        }
    }
