...
import com.pulumi.gcp.vertex.inputs.AiFeatureOnlineStoreIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:vertex/aiFeatureOnlineStoreIamPolicy:AiFeatureOnlineStoreIamPolicy editor &#34;projects/{{project}}/locations/{{region}}/featureOnlineStores/{{feature_online_store}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:vertex/aiFeatureOnlineStoreIamPolicy:AiFeatureOnlineStoreIamPolicy")
public class AiFeatureOnlineStoreIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AiFeatureOnlineStoreIamPolicy(java.lang.String name) {
        this(name, AiFeatureOnlineStoreIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AiFeatureOnlineStoreIamPolicy(java.lang.String name, AiFeatureOnlineStoreIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AiFeatureOnlineStoreIamPolicy(java.lang.String name, AiFeatureOnlineStoreIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiFeatureOnlineStoreIamPolicy:AiFeatureOnlineStoreIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AiFeatureOnlineStoreIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable AiFeatureOnlineStoreIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:vertex/aiFeatureOnlineStoreIamPolicy:AiFeatureOnlineStoreIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static AiFeatureOnlineStoreIamPolicyArgs makeArgs(AiFeatureOnlineStoreIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AiFeatureOnlineStoreIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static AiFeatureOnlineStoreIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable AiFeatureOnlineStoreIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
