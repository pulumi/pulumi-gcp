...
@CustomType
public final class CxToolVersionToolOpenApiSpecAuthenticationBearerTokenConfig {
    /**
    ...
    public static Builder builder(CxToolVersionToolOpenApiSpecAuthenticationBearerTokenConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String token;
        public Builder() {}
        public Builder(CxToolVersionToolOpenApiSpecAuthenticationBearerTokenConfig defaults) {
        ...
        public CxToolVersionToolOpenApiSpecAuthenticationBearerTokenConfig build() {
            final var _resultValue = new CxToolVersionToolOpenApiSpecAuthenticationBearerTokenConfig();
