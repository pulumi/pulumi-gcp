...
import com.pulumi.gcp.colab.inputs.RuntimeTemplateIamMemberState;
import com.pulumi.gcp.colab.outputs.RuntimeTemplateIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:colab/runtimeTemplateIamMember:RuntimeTemplateIamMember editor &#34;projects/{{project}}/locations/{{location}}/notebookRuntimeTemplates/{{runtime_template}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:colab/runtimeTemplateIamMember:RuntimeTemplateIamMember")
public class RuntimeTemplateIamMember extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={RuntimeTemplateIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ RuntimeTemplateIamMemberCondition> condition;

    public Output<Optional<RuntimeTemplateIamMemberCondition>> condition() {
     ...
     * 
     */
    @Export(name="runtimeTemplate", refs={String.class}, tree="[0]")
     ...
     */
    public RuntimeTemplateIamMember(java.lang.String name) {
        this(name, RuntimeTemplateIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RuntimeTemplateIamMember(java.lang.String name, RuntimeTemplateIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RuntimeTemplateIamMember(java.lang.String name, RuntimeTemplateIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:colab/runtimeTemplateIamMember:RuntimeTemplateIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RuntimeTemplateIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable RuntimeTemplateIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:colab/runtimeTemplateIamMember:RuntimeTemplateIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static RuntimeTemplateIamMemberArgs makeArgs(RuntimeTemplateIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RuntimeTemplateIamMemberArgs.Empty : args;
    }
     ...
     */
    public static RuntimeTemplateIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable RuntimeTemplateIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RuntimeTemplateIamMember(name, id, state, options);
    }
}
