...
public final class AuthorityConfigX509ConfigPolicyId {
    ...
    private AuthorityConfigX509ConfigPolicyId() {}
    /**
     * @return An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder objectIdPaths(List<Integer> objectIdPaths) {
            if (objectIdPaths == null) {
              throw new MissingRequiredPropertyException("AuthorityConfigX509ConfigPolicyId", "objectIdPaths");
            }
        ...
        public AuthorityConfigX509ConfigPolicyId build() {
            final var _resultValue = new AuthorityConfigX509ConfigPolicyId();
