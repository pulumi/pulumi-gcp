...
public final class InstanceGroupManagerNamedPortArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public InstanceGroupManagerNamedPortArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("InstanceGroupManagerNamedPortArgs", "name");
            }
            if ($.port == null) {
                throw new MissingRequiredPropertyException("InstanceGroupManagerNamedPortArgs", "port");
            }
            return $;
        }
    }
