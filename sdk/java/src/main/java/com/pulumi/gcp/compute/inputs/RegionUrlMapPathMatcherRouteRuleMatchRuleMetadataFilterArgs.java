    ...
    public static final class Builder {
        ...
        public RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilterArgs build() {
            if ($.filterLabels == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilterArgs", "filterLabels");
            }
            if ($.filterMatchCriteria == null) {
                throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilterArgs", "filterMatchCriteria");
            }
            return $;
        }
    }
