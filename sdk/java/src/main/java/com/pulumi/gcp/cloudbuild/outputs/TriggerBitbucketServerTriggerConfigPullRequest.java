...
public final class TriggerBitbucketServerTriggerConfigPullRequest {
    ...
    public static Builder builder(TriggerBitbucketServerTriggerConfigPullRequest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean invertRegex;
        public Builder() {}
        public Builder(TriggerBitbucketServerTriggerConfigPullRequest defaults) {
        ...
        public Builder branch(String branch) {
            if (branch == null) {
              throw new MissingRequiredPropertyException("TriggerBitbucketServerTriggerConfigPullRequest", "branch");
            }
            this.branch = branch;
            return this;
        }
        ...
        public TriggerBitbucketServerTriggerConfigPullRequest build() {
            final var _resultValue = new TriggerBitbucketServerTriggerConfigPullRequest();
