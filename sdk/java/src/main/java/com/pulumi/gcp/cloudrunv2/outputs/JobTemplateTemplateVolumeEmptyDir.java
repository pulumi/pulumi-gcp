...
@CustomType
public final class JobTemplateTemplateVolumeEmptyDir {
    /**
    ...
    private JobTemplateTemplateVolumeEmptyDir() {}
    /**
     * @return The different types of medium supported for EmptyDir.
     * Default value is `MEMORY`.
     * Possible values are: `MEMORY`.
    ...
    public static Builder builder(JobTemplateTemplateVolumeEmptyDir defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sizeLimit;
        public Builder() {}
        public Builder(JobTemplateTemplateVolumeEmptyDir defaults) {
