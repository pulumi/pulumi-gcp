...
public final class GetJobCondition {
    ...
    public static Builder builder(GetJobCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetJobCondition defaults) {
        ...
        public Builder executionReason(String executionReason) {
            if (executionReason == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "executionReason");
            }
        ...
        public Builder lastTransitionTime(String lastTransitionTime) {
            if (lastTransitionTime == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "lastTransitionTime");
            }
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "message");
            }
        ...
        public Builder reason(String reason) {
            if (reason == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "reason");
            }
            this.reason = reason;
            return this;
        }
        ...
        public Builder revisionReason(String revisionReason) {
            if (revisionReason == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "revisionReason");
            }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "severity");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetJobCondition", "type");
            }
            this.type = type;
            return this;
        }
