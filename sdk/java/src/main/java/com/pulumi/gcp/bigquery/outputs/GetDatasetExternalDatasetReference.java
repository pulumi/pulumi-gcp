...
public final class GetDatasetExternalDatasetReference {
    ...
    public static Builder builder(GetDatasetExternalDatasetReference defaults) {
    ...
    public static final class Builder {
        ...
        private String externalSource;
        public Builder() {}
        public Builder(GetDatasetExternalDatasetReference defaults) {
        ...
        public GetDatasetExternalDatasetReference build() {
            final var _resultValue = new GetDatasetExternalDatasetReference();
