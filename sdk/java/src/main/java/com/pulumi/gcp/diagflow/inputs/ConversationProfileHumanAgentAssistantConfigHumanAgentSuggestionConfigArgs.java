...
import com.pulumi.gcp.diagflow.inputs.ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigArgs;
...
public final class ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs Empty = new ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs();
    ...
    private @Nullable Output<List<ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigArgs>> featureConfigs;
     ...
     * 
     */
    public Optional<Output<List<ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigArgs>>> featureConfigs() {
    ...
    private ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs() {}

    private ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs(ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs $) {
    ...
    public static Builder builder(ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs();
        }

        public Builder(ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs defaults) {
            $ = new ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder featureConfigs(@Nullable Output<List<ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigArgs>> featureConfigs) {
         ...
         * 
         */
        public Builder featureConfigs(List<ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigArgs> featureConfigs) {
         ...
         * 
         */
        public Builder featureConfigs(ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigFeatureConfigArgs... featureConfigs) {
        ...
        public ConversationProfileHumanAgentAssistantConfigHumanAgentSuggestionConfigArgs build() {
            return $;
        }
    }
