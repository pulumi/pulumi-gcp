...
@CustomType
public final class PrivateCloudNsx {
    /**
    ...
    public static Builder builder(PrivateCloudNsx defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(PrivateCloudNsx defaults) {
        ...
        public PrivateCloudNsx build() {
            final var _resultValue = new PrivateCloudNsx();
