 ...
 * 
 * ```sh
 * $ pulumi import gcp:servicedirectory/namespaceIamPolicy:NamespaceIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/namespaces/{{namespace_id}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
