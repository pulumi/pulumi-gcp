...
public final class URLMapPathMatcherHeaderActionRequestHeadersToAdd {
    ...
    public static final class Builder {
        ...
        public Builder headerName(String headerName) {
            if (headerName == null) {
              throw new MissingRequiredPropertyException("URLMapPathMatcherHeaderActionRequestHeadersToAdd", "headerName");
            }
        ...
        public Builder headerValue(String headerValue) {
            if (headerValue == null) {
              throw new MissingRequiredPropertyException("URLMapPathMatcherHeaderActionRequestHeadersToAdd", "headerValue");
            }
        ...
        public Builder replace(Boolean replace) {
            if (replace == null) {
              throw new MissingRequiredPropertyException("URLMapPathMatcherHeaderActionRequestHeadersToAdd", "replace");
            }
