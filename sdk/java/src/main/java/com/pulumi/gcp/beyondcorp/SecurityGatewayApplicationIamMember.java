...
import com.pulumi.gcp.beyondcorp.inputs.SecurityGatewayApplicationIamMemberState;
import com.pulumi.gcp.beyondcorp.outputs.SecurityGatewayApplicationIamMemberCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:beyondcorp/securityGatewayApplicationIamMember:SecurityGatewayApplicationIamMember editor &#34;projects/{{project}}/locations/global/securityGateways/{{security_gateway_id}}/applications/{{application_id}} roles/beyondcorp.securityGatewayUser user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:beyondcorp/securityGatewayApplicationIamMember:SecurityGatewayApplicationIamMember")
public class SecurityGatewayApplicationIamMember extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="condition", refs={SecurityGatewayApplicationIamMemberCondition.class}, tree="[0]")
    private Output</* @Nullable */ SecurityGatewayApplicationIamMemberCondition> condition;
     ...
     * 
     */
    public Output<Optional<SecurityGatewayApplicationIamMemberCondition>> condition() {
     ...
     */
    public SecurityGatewayApplicationIamMember(java.lang.String name) {
        this(name, SecurityGatewayApplicationIamMemberArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SecurityGatewayApplicationIamMember(java.lang.String name, SecurityGatewayApplicationIamMemberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SecurityGatewayApplicationIamMember(java.lang.String name, SecurityGatewayApplicationIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayApplicationIamMember:SecurityGatewayApplicationIamMember", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SecurityGatewayApplicationIamMember(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayApplicationIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:beyondcorp/securityGatewayApplicationIamMember:SecurityGatewayApplicationIamMember", name, state, makeResourceOptions(options, id), false);
    }

    private static SecurityGatewayApplicationIamMemberArgs makeArgs(SecurityGatewayApplicationIamMemberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SecurityGatewayApplicationIamMemberArgs.Empty : args;
    }
     ...
     */
    public static SecurityGatewayApplicationIamMember get(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGatewayApplicationIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SecurityGatewayApplicationIamMember(name, id, state, options);
    }
}
