...
import com.pulumi.gcp.cloudrunv2.inputs.ServiceIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:cloudrunv2/serviceIamPolicy:ServiceIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/services/{{service}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:cloudrunv2/serviceIamPolicy:ServiceIamPolicy")
public class ServiceIamPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ServiceIamPolicy(String name, ServiceIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamPolicy:ServiceIamPolicy", name, args == null ? ServiceIamPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ServiceIamPolicy(String name, Output<String> id, @Nullable ServiceIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:cloudrunv2/serviceIamPolicy:ServiceIamPolicy", name, state, makeResourceOptions(options, id));
    }
