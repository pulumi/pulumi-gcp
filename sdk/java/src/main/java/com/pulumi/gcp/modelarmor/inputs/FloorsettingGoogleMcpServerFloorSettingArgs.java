...
public final class FloorsettingGoogleMcpServerFloorSettingArgs extends com.pulumi.resources.ResourceArgs {

    public static final FloorsettingGoogleMcpServerFloorSettingArgs Empty = new FloorsettingGoogleMcpServerFloorSettingArgs();
    ...
    private FloorsettingGoogleMcpServerFloorSettingArgs() {}

    private FloorsettingGoogleMcpServerFloorSettingArgs(FloorsettingGoogleMcpServerFloorSettingArgs $) {
    ...
    public static Builder builder(FloorsettingGoogleMcpServerFloorSettingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FloorsettingGoogleMcpServerFloorSettingArgs();
        }

        public Builder(FloorsettingGoogleMcpServerFloorSettingArgs defaults) {
            $ = new FloorsettingGoogleMcpServerFloorSettingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FloorsettingGoogleMcpServerFloorSettingArgs build() {
            return $;
        }
    }
