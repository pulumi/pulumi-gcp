...
public final class GetInstanceTemplateGuestAccelerator {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateGuestAccelerator", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetInstanceTemplateGuestAccelerator", "type");
            }
            this.type = type;
            return this;
        }
        public GetInstanceTemplateGuestAccelerator build() {
            final var _resultValue = new GetInstanceTemplateGuestAccelerator();
