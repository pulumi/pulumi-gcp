...
@CustomType
public final class ReportSummaryAllAssetsStatStorageBytesHistogramBucket {
    /**
     * @return (Output)
    ...
    public static Builder builder(ReportSummaryAllAssetsStatStorageBytesHistogramBucket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String upperBound;
        public Builder() {}
        public Builder(ReportSummaryAllAssetsStatStorageBytesHistogramBucket defaults) {
        ...
        public ReportSummaryAllAssetsStatStorageBytesHistogramBucket build() {
            final var _resultValue = new ReportSummaryAllAssetsStatStorageBytesHistogramBucket();
