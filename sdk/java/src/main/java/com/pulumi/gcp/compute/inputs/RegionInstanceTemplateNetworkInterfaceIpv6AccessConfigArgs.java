...
public final class RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs Empty = new RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs();
    ...
    private RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs() {}
    ...
    public static Builder builder(RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs();
        }

        public Builder(RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs defaults) {
            $ = new RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs build() {
            if ($.networkTier == null) {
                throw new MissingRequiredPropertyException("RegionInstanceTemplateNetworkInterfaceIpv6AccessConfigArgs", "networkTier");
            }
            return $;
        }
    }
