...
import com.pulumi.gcp.networksecurity.inputs.AuthzPolicyHttpRuleFromSourcePrincipalPrincipalArgs;
...
public final class AuthzPolicyHttpRuleFromSourcePrincipalArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<AuthzPolicyHttpRuleFromSourcePrincipalPrincipalArgs> principal;
     ...
     * 
     */
    public Optional<Output<AuthzPolicyHttpRuleFromSourcePrincipalPrincipalArgs>> principal() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder principal(@Nullable Output<AuthzPolicyHttpRuleFromSourcePrincipalPrincipalArgs> principal) {
            $.principal = principal;
            return this;
        }
         ...
         * 
         */
        public Builder principal(AuthzPolicyHttpRuleFromSourcePrincipalPrincipalArgs principal) {
