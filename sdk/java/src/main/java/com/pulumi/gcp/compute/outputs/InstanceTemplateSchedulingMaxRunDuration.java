...
@CustomType
public final class InstanceTemplateSchedulingMaxRunDuration {
    /**
    ...
    private InstanceTemplateSchedulingMaxRunDuration() {}
    /**
     * @return Span of time that&#39;s a fraction of a second at nanosecond
     * resolution. Durations less than one second are represented with a 0
     * `seconds` field and a positive `nanos` field. Must be from 0 to
    ...
    public static Builder builder(InstanceTemplateSchedulingMaxRunDuration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer seconds;
        public Builder() {}
        public Builder(InstanceTemplateSchedulingMaxRunDuration defaults) {
        ...
        public Builder seconds(Integer seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("InstanceTemplateSchedulingMaxRunDuration", "seconds");
            }
