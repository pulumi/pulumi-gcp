...
public class ManagedFolderIamMember extends com.pulumi.resources.CustomResource {
     ...
     */
    public ManagedFolderIamMember(String name) {
     ...
     */
    public static ManagedFolderIamMember get(String name, Output<String> id, @Nullable ManagedFolderIamMemberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
