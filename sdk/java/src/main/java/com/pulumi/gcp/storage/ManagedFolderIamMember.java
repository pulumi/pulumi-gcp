 ...
 * 
 * ```sh
 * $ pulumi import gcp:storage/managedFolderIamMember:ManagedFolderIamMember editor &#34;b/{{bucket}}/managedFolders/{{managed_folder}} roles/storage.objectViewer user:jane{@literal @}example.com&#34;
 * ```
 * 
