...
public final class AttestorIamBindingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AttestorIamBindingArgs build() {
            if ($.attestor == null) {
                throw new MissingRequiredPropertyException("AttestorIamBindingArgs", "attestor");
            }
            if ($.members == null) {
                throw new MissingRequiredPropertyException("AttestorIamBindingArgs", "members");
            }
            if ($.role == null) {
                throw new MissingRequiredPropertyException("AttestorIamBindingArgs", "role");
            }
            return $;
        }
    }
