...
public final class RegionUrlMapPathMatcherRouteRuleRouteActionTimeout {
    ...
    public static final class Builder {
        ...
        public Builder seconds(String seconds) {
            if (seconds == null) {
              throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherRouteRuleRouteActionTimeout", "seconds");
            }
            this.seconds = seconds;
            return this;
        }
        public RegionUrlMapPathMatcherRouteRuleRouteActionTimeout build() {
            final var _resultValue = new RegionUrlMapPathMatcherRouteRuleRouteActionTimeout();
