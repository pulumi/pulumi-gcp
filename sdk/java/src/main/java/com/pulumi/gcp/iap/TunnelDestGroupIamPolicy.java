...
import com.pulumi.gcp.iap.inputs.TunnelDestGroupIamPolicyState;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:iap/tunnelDestGroupIamPolicy:TunnelDestGroupIamPolicy editor &#34;projects/{{project}}/iap_tunnel/locations/{{region}}/destGroups/{{dest_group}} roles/iap.tunnelResourceAccessor user:jane{@literal @}example.com&#34;
 * ```
 * 
...
public class TunnelDestGroupIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public TunnelDestGroupIamPolicy(java.lang.String name) {
        this(name, TunnelDestGroupIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public TunnelDestGroupIamPolicy(java.lang.String name, TunnelDestGroupIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TunnelDestGroupIamPolicy(java.lang.String name, TunnelDestGroupIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelDestGroupIamPolicy:TunnelDestGroupIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TunnelDestGroupIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelDestGroupIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:iap/tunnelDestGroupIamPolicy:TunnelDestGroupIamPolicy", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TunnelDestGroupIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable TunnelDestGroupIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new TunnelDestGroupIamPolicy(name, id, state, options);
    }
}
