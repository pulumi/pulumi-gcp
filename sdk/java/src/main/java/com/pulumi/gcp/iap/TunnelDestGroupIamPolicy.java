...
public class TunnelDestGroupIamPolicy extends com.pulumi.resources.CustomResource {
     ...
     */
    public TunnelDestGroupIamPolicy(String name) {
     ...
     */
    public TunnelDestGroupIamPolicy(String name, TunnelDestGroupIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static TunnelDestGroupIamPolicy get(String name, Output<String> id, @Nullable TunnelDestGroupIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
