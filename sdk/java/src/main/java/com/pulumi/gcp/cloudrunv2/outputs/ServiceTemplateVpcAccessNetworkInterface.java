...
@CustomType
public final class ServiceTemplateVpcAccessNetworkInterface {
    /**
    ...
    private ServiceTemplateVpcAccessNetworkInterface() {}
    /**
     * @return The VPC network that the Cloud Run resource will be able to send traffic to. At least one of network or subnetwork must be specified. If both
     * network and subnetwork are specified, the given VPC subnetwork must belong to the given VPC network. If network is not specified, it will be
     * looked up from the subnetwork.
    ...
    public static Builder builder(ServiceTemplateVpcAccessNetworkInterface defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> tags;
        public Builder() {}
        public Builder(ServiceTemplateVpcAccessNetworkInterface defaults) {
