...
public final class RegionUrlMapDefaultRouteActionUrlRewriteArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionUrlMapDefaultRouteActionUrlRewriteArgs Empty = new RegionUrlMapDefaultRouteActionUrlRewriteArgs();
    ...
    private RegionUrlMapDefaultRouteActionUrlRewriteArgs() {}

    private RegionUrlMapDefaultRouteActionUrlRewriteArgs(RegionUrlMapDefaultRouteActionUrlRewriteArgs $) {
    ...
    public static Builder builder(RegionUrlMapDefaultRouteActionUrlRewriteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionUrlMapDefaultRouteActionUrlRewriteArgs();
        }

        public Builder(RegionUrlMapDefaultRouteActionUrlRewriteArgs defaults) {
            $ = new RegionUrlMapDefaultRouteActionUrlRewriteArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionUrlMapDefaultRouteActionUrlRewriteArgs build() {
            return $;
        }
    }
