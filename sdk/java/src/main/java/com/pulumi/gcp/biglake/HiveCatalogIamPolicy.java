...
import com.pulumi.gcp.biglake.inputs.HiveCatalogIamPolicyState;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/hiveCatalogIamPolicy:HiveCatalogIamPolicy")
public class HiveCatalogIamPolicy extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public HiveCatalogIamPolicy(java.lang.String name) {
        this(name, HiveCatalogIamPolicyArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public HiveCatalogIamPolicy(java.lang.String name, HiveCatalogIamPolicyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HiveCatalogIamPolicy(java.lang.String name, HiveCatalogIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveCatalogIamPolicy:HiveCatalogIamPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HiveCatalogIamPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable HiveCatalogIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/hiveCatalogIamPolicy:HiveCatalogIamPolicy", name, state, makeResourceOptions(options, id), false);
    }

    private static HiveCatalogIamPolicyArgs makeArgs(HiveCatalogIamPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HiveCatalogIamPolicyArgs.Empty : args;
    }
     ...
     */
    public static HiveCatalogIamPolicy get(java.lang.String name, Output<java.lang.String> id, @Nullable HiveCatalogIamPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new HiveCatalogIamPolicy(name, id, state, options);
    }
}
