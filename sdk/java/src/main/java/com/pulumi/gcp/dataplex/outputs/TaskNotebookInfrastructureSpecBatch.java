...
@CustomType
public final class TaskNotebookInfrastructureSpecBatch {
    /**
    ...
    private TaskNotebookInfrastructureSpecBatch() {}
    /**
     * @return Total number of job executors. Executor Count should be between 2 and 100. [Default=2]
     * 
     */
    ...
    public static Builder builder(TaskNotebookInfrastructureSpecBatch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maxExecutorsCount;
        public Builder() {}
        public Builder(TaskNotebookInfrastructureSpecBatch defaults) {
