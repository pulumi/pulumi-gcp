...
import com.pulumi.gcp.pubsub.inputs.SchemaIamBindingState;
import com.pulumi.gcp.pubsub.outputs.SchemaIamBindingCondition;
 ...
 * 
 * ```sh
 * $ pulumi import gcp:pubsub/schemaIamBinding:SchemaIamBinding editor &#34;projects/{{project}}/schemas/{{schema}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
 ...
 * 
 */
@ResourceType(type="gcp:pubsub/schemaIamBinding:SchemaIamBinding")
public class SchemaIamBinding extends com.pulumi.resources.CustomResource {
    @Export(name="condition", refs={SchemaIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ SchemaIamBindingCondition> condition;

    public Output<Optional<SchemaIamBindingCondition>> condition() {
     ...
     */
    public SchemaIamBinding(java.lang.String name) {
        this(name, SchemaIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SchemaIamBinding(java.lang.String name, SchemaIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SchemaIamBinding(java.lang.String name, SchemaIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/schemaIamBinding:SchemaIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SchemaIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable SchemaIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:pubsub/schemaIamBinding:SchemaIamBinding", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SchemaIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable SchemaIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new SchemaIamBinding(name, id, state, options);
    }
}
