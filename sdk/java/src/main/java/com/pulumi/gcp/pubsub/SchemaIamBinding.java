...
public class SchemaIamBinding extends com.pulumi.resources.CustomResource {
     ...
     */
    public SchemaIamBinding(String name) {
     ...
     */
    public SchemaIamBinding(String name, SchemaIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static SchemaIamBinding get(String name, Output<String> id, @Nullable SchemaIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
