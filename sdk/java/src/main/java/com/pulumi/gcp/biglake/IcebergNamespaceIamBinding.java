...
import com.pulumi.gcp.biglake.inputs.IcebergNamespaceIamBindingState;
import com.pulumi.gcp.biglake.outputs.IcebergNamespaceIamBindingCondition;
 ...
 * 
 */
@ResourceType(type="gcp:biglake/icebergNamespaceIamBinding:IcebergNamespaceIamBinding")
public class IcebergNamespaceIamBinding extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="condition", refs={IcebergNamespaceIamBindingCondition.class}, tree="[0]")
    private Output</* @Nullable */ IcebergNamespaceIamBindingCondition> condition;

    public Output<Optional<IcebergNamespaceIamBindingCondition>> condition() {
     ...
     */
    public IcebergNamespaceIamBinding(java.lang.String name) {
        this(name, IcebergNamespaceIamBindingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public IcebergNamespaceIamBinding(java.lang.String name, IcebergNamespaceIamBindingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IcebergNamespaceIamBinding(java.lang.String name, IcebergNamespaceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergNamespaceIamBinding:IcebergNamespaceIamBinding", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IcebergNamespaceIamBinding(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergNamespaceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("gcp:biglake/icebergNamespaceIamBinding:IcebergNamespaceIamBinding", name, state, makeResourceOptions(options, id), false);
    }

    private static IcebergNamespaceIamBindingArgs makeArgs(IcebergNamespaceIamBindingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IcebergNamespaceIamBindingArgs.Empty : args;
    }
     ...
     */
    public static IcebergNamespaceIamBinding get(java.lang.String name, Output<java.lang.String> id, @Nullable IcebergNamespaceIamBindingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
