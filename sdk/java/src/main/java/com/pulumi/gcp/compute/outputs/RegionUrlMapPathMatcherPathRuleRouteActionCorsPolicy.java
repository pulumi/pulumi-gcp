...
public final class RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy {
    ...
    public static final class Builder {
        ...
        public Builder disabled(Boolean disabled) {
            if (disabled == null) {
              throw new MissingRequiredPropertyException("RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy", "disabled");
            }
        ...
        public RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy build() {
            final var _resultValue = new RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy();
