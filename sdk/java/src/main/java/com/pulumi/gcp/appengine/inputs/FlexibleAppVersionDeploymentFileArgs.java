...
public final class FlexibleAppVersionDeploymentFileArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public FlexibleAppVersionDeploymentFileArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("FlexibleAppVersionDeploymentFileArgs", "name");
            }
            if ($.sourceUrl == null) {
                throw new MissingRequiredPropertyException("FlexibleAppVersionDeploymentFileArgs", "sourceUrl");
            }
            return $;
        }
    }
