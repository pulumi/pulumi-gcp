 ...
 * 
 * ```sh
 * $ pulumi import gcp:notebooks/runtimeIamPolicy:RuntimeIamPolicy editor &#34;projects/{{project}}/locations/{{location}}/runtimes/{{runtime_name}} roles/viewer user:jane{@literal @}example.com&#34;
 * ```
 * 
