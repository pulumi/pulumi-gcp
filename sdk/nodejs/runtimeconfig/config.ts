...
export class Config extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: ConfigArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ConfigArgs | ConfigState, opts?: pulumi.ResourceOptions) {
