 ...
 */
export class WorkerPoolIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkerPoolIamBindingState, opts?: pulumi.CustomResourceOptions): WorkerPoolIamBinding {
        return new WorkerPoolIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding';

    /**
     * Returns true if the given object is an instance of WorkerPoolIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WorkerPoolIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.cloudrunv2.WorkerPoolIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: WorkerPoolIamBindingArgs | WorkerPoolIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WorkerPoolIamBindingState | undefined;
            ...
            const args = argsOrState as WorkerPoolIamBindingArgs | undefined;
...
export interface WorkerPoolIamBindingState {
    condition?: pulumi.Input<inputs.cloudrunv2.WorkerPoolIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
