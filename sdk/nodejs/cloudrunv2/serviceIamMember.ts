...
export class ServiceIamMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp:cloudrunv2/serviceIamMember:ServiceIamMember';
    ...
    declare public readonly condition: pulumi.Output<outputs.cloudrunv2.ServiceIamMemberCondition | undefined>;
    /**
