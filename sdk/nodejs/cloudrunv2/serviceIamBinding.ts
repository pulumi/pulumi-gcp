...
export class ServiceIamBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp:cloudrunv2/serviceIamBinding:ServiceIamBinding';
    ...
    declare public readonly condition: pulumi.Output<outputs.cloudrunv2.ServiceIamBindingCondition | undefined>;
    /**
