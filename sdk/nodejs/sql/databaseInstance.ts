...
export interface DatabaseInstanceState {
    ...
    readonly ipAddresses?: pulumi.Input<{ ipAddress?: pulumi.Input<string>, timeToRetire?: pulumi.Input<string> }[]>;
    /**
     * The name of the instance that will act as
     * the master in the replication setup. Note, this requires the master to have
     * `binary_log_enabled` set, as well as existing backups.
     ...
     * configuration is detailed below.
     */
    readonly settings?: pulumi.Input<{ activationPolicy?: pulumi.Input<string>, authorizedGaeApplications?: pulumi.Input<pulumi.Input<string>[]>, availabilityType?: pulumi.Input<string>, backupConfiguration?: pulumi.Input<{ binaryLogEnabled?: pulumi.Input<boolean>, enabled?: pulumi.Input<boolean>, startTime?: pulumi.Input<string> }>, crashSafeReplication?: pulumi.Input<boolean>, databaseFlags?: pulumi.Input<{ name?: pulumi.Input<string>, value?: pulumi.Input<string> }[]>, diskAutoresize?: pulumi.Input<boolean>, diskSize?: pulumi.Input<number>, diskType?: pulumi.Input<string>, ipConfiguration?: pulumi.Input<{ authorizedNetworks?: pulumi.Input<{ expirationTime?: pulumi.Input<string>, name?: pulumi.Input<string>, value?: pulumi.Input<string> }[]>, ipv4Enabled?: pulumi.Input<boolean>, requireSsl?: pulumi.Input<boolean> }>, locationPreference?: pulumi.Input<{ followGaeApplication?: pulumi.Input<string>, zone?: pulumi.Input<string> }>, maintenanceWindow?: pulumi.Input<{ day?: pulumi.Input<number>, hour?: pulumi.Input<number>, updateTrack?: pulumi.Input<string> }>, pricingPlan?: pulumi.Input<string>, replicationType?: pulumi.Input<string>, tier: pulumi.Input<string>, version?: pulumi.Input<number> }>;
}
