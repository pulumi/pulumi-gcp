 ...
 */
export class AgentRegistryEndpointIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentRegistryEndpointIamMemberState, opts?: pulumi.CustomResourceOptions): AgentRegistryEndpointIamMember {
        return new AgentRegistryEndpointIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/agentRegistryEndpointIamMember:AgentRegistryEndpointIamMember';

    /**
     * Returns true if the given object is an instance of AgentRegistryEndpointIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentRegistryEndpointIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentRegistryEndpointIamMember.__pulumiType;
    }
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.AgentRegistryEndpointIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AgentRegistryEndpointIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AgentRegistryEndpointIamMemberArgs | AgentRegistryEndpointIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AgentRegistryEndpointIamMemberState | undefined;
            ...
            const args = argsOrState as AgentRegistryEndpointIamMemberArgs | undefined;
        ...
        super(AgentRegistryEndpointIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AgentRegistryEndpointIamMemberState {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.AgentRegistryEndpointIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface AgentRegistryEndpointIamMemberArgs {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
