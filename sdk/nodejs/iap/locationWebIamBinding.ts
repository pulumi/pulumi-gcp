 ...
 */
export class LocationWebIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocationWebIamBindingState, opts?: pulumi.CustomResourceOptions): LocationWebIamBinding {
        return new LocationWebIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/locationWebIamBinding:LocationWebIamBinding';

    /**
     * Returns true if the given object is an instance of LocationWebIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocationWebIamBinding {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.LocationWebIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LocationWebIamBindingArgs | LocationWebIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocationWebIamBindingState | undefined;
            ...
            const args = argsOrState as LocationWebIamBindingArgs | undefined;
...
export interface LocationWebIamBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.LocationWebIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
