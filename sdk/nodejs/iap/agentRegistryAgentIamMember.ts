 ...
 */
export class AgentRegistryAgentIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentRegistryAgentIamMemberState, opts?: pulumi.CustomResourceOptions): AgentRegistryAgentIamMember {
        return new AgentRegistryAgentIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/agentRegistryAgentIamMember:AgentRegistryAgentIamMember';

    /**
     * Returns true if the given object is an instance of AgentRegistryAgentIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentRegistryAgentIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentRegistryAgentIamMember.__pulumiType;
    }
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.AgentRegistryAgentIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AgentRegistryAgentIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AgentRegistryAgentIamMemberArgs | AgentRegistryAgentIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AgentRegistryAgentIamMemberState | undefined;
            ...
            const args = argsOrState as AgentRegistryAgentIamMemberArgs | undefined;
        ...
        super(AgentRegistryAgentIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AgentRegistryAgentIamMemberState {
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.AgentRegistryAgentIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface AgentRegistryAgentIamMemberArgs {
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
