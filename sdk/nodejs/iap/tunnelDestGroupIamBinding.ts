 ...
 */
export class TunnelDestGroupIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TunnelDestGroupIamBindingState, opts?: pulumi.CustomResourceOptions): TunnelDestGroupIamBinding {
        return new TunnelDestGroupIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/tunnelDestGroupIamBinding:TunnelDestGroupIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is TunnelDestGroupIamBinding {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.TunnelDestGroupIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    declare public readonly destGroup: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: TunnelDestGroupIamBindingArgs | TunnelDestGroupIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TunnelDestGroupIamBindingState | undefined;
            ...
            const args = argsOrState as TunnelDestGroupIamBindingArgs | undefined;
