 ...
 */
export class LocationWebIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocationWebIamPolicyState, opts?: pulumi.CustomResourceOptions): LocationWebIamPolicy {
        return new LocationWebIamPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/locationWebIamPolicy:LocationWebIamPolicy';

    /**
     * Returns true if the given object is an instance of LocationWebIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocationWebIamPolicy {
    ...
    constructor(name: string, argsOrState?: LocationWebIamPolicyArgs | LocationWebIamPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocationWebIamPolicyState | undefined;
            resourceInputs["etag"] = state?.etag;
            resourceInputs["location"] = state?.location;
            resourceInputs["policyData"] = state?.policyData;
            resourceInputs["project"] = state?.project;
        } else {
            const args = argsOrState as LocationWebIamPolicyArgs | undefined;
