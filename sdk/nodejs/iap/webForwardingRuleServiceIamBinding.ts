 ...
 */
export class WebForwardingRuleServiceIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebForwardingRuleServiceIamBindingState, opts?: pulumi.CustomResourceOptions): WebForwardingRuleServiceIamBinding {
        return new WebForwardingRuleServiceIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/webForwardingRuleServiceIamBinding:WebForwardingRuleServiceIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is WebForwardingRuleServiceIamBinding {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.WebForwardingRuleServiceIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: WebForwardingRuleServiceIamBindingArgs | WebForwardingRuleServiceIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WebForwardingRuleServiceIamBindingState | undefined;
            ...
            const args = argsOrState as WebForwardingRuleServiceIamBindingArgs | undefined;
