 ...
 */
export class AgentRegistryIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentRegistryIamPolicyState, opts?: pulumi.CustomResourceOptions): AgentRegistryIamPolicy {
        return new AgentRegistryIamPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/agentRegistryIamPolicy:AgentRegistryIamPolicy';

    /**
     * Returns true if the given object is an instance of AgentRegistryIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentRegistryIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentRegistryIamPolicy.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AgentRegistryIamPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AgentRegistryIamPolicyArgs | AgentRegistryIamPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AgentRegistryIamPolicyState | undefined;
            resourceInputs["etag"] = state?.etag;
            resourceInputs["location"] = state?.location;
            resourceInputs["policyData"] = state?.policyData;
            resourceInputs["project"] = state?.project;
        } else {
            const args = argsOrState as AgentRegistryIamPolicyArgs | undefined;
        ...
        super(AgentRegistryIamPolicy.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AgentRegistryIamPolicyState {
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface AgentRegistryIamPolicyArgs {
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
