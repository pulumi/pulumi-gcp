 ...
 */
export class AgentRegistryEndpointIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentRegistryEndpointIamBindingState, opts?: pulumi.CustomResourceOptions): AgentRegistryEndpointIamBinding {
        return new AgentRegistryEndpointIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/agentRegistryEndpointIamBinding:AgentRegistryEndpointIamBinding';

    /**
     * Returns true if the given object is an instance of AgentRegistryEndpointIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentRegistryEndpointIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentRegistryEndpointIamBinding.__pulumiType;
    }
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.AgentRegistryEndpointIamBindingCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AgentRegistryEndpointIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AgentRegistryEndpointIamBindingArgs | AgentRegistryEndpointIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AgentRegistryEndpointIamBindingState | undefined;
            ...
            const args = argsOrState as AgentRegistryEndpointIamBindingArgs | undefined;
        ...
        super(AgentRegistryEndpointIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AgentRegistryEndpointIamBindingState {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.AgentRegistryEndpointIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface AgentRegistryEndpointIamBindingArgs {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
