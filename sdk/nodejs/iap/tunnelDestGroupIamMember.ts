...
export class TunnelDestGroupIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TunnelDestGroupIamMemberState, opts?: pulumi.CustomResourceOptions): TunnelDestGroupIamMember {
        return new TunnelDestGroupIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/tunnelDestGroupIamMember:TunnelDestGroupIamMember';

    /**
     * Returns true if the given object is an instance of TunnelDestGroupIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TunnelDestGroupIamMember {
     ...
     */
    public readonly condition!: pulumi.Output<outputs.iap.TunnelDestGroupIamMemberCondition | undefined>;
    ...
    constructor(name: string, argsOrState?: TunnelDestGroupIamMemberArgs | TunnelDestGroupIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TunnelDestGroupIamMemberState | undefined;
            ...
            const args = argsOrState as TunnelDestGroupIamMemberArgs | undefined;
        ...
        super(TunnelDestGroupIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
