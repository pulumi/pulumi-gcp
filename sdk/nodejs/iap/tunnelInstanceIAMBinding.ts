...
export class TunnelInstanceIAMBinding extends pulumi.CustomResource {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.TunnelInstanceIAMBindingCondition | undefined>;
    /**
...
export interface TunnelInstanceIAMBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.TunnelInstanceIAMBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
