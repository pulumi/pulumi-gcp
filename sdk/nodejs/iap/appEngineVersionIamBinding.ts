...
export class AppEngineVersionIamBinding extends pulumi.CustomResource {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.AppEngineVersionIamBindingCondition | undefined>;
    /**
...
export interface AppEngineVersionIamBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.AppEngineVersionIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
