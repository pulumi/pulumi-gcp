 ...
 */
export class WebRegionForwardingRuleServiceIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebRegionForwardingRuleServiceIamMemberState, opts?: pulumi.CustomResourceOptions): WebRegionForwardingRuleServiceIamMember {
        return new WebRegionForwardingRuleServiceIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/webRegionForwardingRuleServiceIamMember:WebRegionForwardingRuleServiceIamMember';
     ...
     */
    public static isInstance(obj: any): obj is WebRegionForwardingRuleServiceIamMember {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.WebRegionForwardingRuleServiceIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: WebRegionForwardingRuleServiceIamMemberArgs | WebRegionForwardingRuleServiceIamMemberState, opts?: pulumi.CustomResourceOptions) {
...
export interface WebRegionForwardingRuleServiceIamMemberState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.WebRegionForwardingRuleServiceIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
