 ...
 */
export class WebCloudRunServiceIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebCloudRunServiceIamMemberState, opts?: pulumi.CustomResourceOptions): WebCloudRunServiceIamMember {
        return new WebCloudRunServiceIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/webCloudRunServiceIamMember:WebCloudRunServiceIamMember';
     ...
     */
    public static isInstance(obj: any): obj is WebCloudRunServiceIamMember {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.WebCloudRunServiceIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: WebCloudRunServiceIamMemberArgs | WebCloudRunServiceIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WebCloudRunServiceIamMemberState | undefined;
            ...
            const args = argsOrState as WebCloudRunServiceIamMemberArgs | undefined;
