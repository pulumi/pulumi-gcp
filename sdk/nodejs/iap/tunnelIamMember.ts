...
export class TunnelIamMember extends pulumi.CustomResource {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.TunnelIamMemberCondition | undefined>;
    /**
...
export interface TunnelIamMemberState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.TunnelIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
