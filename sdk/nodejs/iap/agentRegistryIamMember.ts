 ...
 */
export class AgentRegistryIamMember extends pulumi.CustomResource {
    /**
     * Get an existing AgentRegistryIamMember resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AgentRegistryIamMemberState, opts?: pulumi.CustomResourceOptions): AgentRegistryIamMember {
        return new AgentRegistryIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iap/agentRegistryIamMember:AgentRegistryIamMember';

    /**
     * Returns true if the given object is an instance of AgentRegistryIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AgentRegistryIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AgentRegistryIamMember.__pulumiType;
    }
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.iap.AgentRegistryIamMemberCondition | undefined>;
    /**
    ...
    /**
     * Create a AgentRegistryIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AgentRegistryIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AgentRegistryIamMemberArgs | AgentRegistryIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AgentRegistryIamMemberState | undefined;
            ...
            const args = argsOrState as AgentRegistryIamMemberArgs | undefined;
        ...
        super(AgentRegistryIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AgentRegistryIamMemberState {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.AgentRegistryIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface AgentRegistryIamMemberArgs {
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
