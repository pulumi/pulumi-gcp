...
export class InstanceIAMBinding extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: InstanceIAMBindingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: InstanceIAMBindingArgs | InstanceIAMBindingState, opts?: pulumi.ResourceOptions) {
