...
export class DatabaseIAMBinding extends pulumi.CustomResource {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.spanner.DatabaseIAMBindingCondition | undefined>;
    /**
...
export interface DatabaseIAMBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.spanner.DatabaseIAMBindingCondition | undefined>;
    /**
     * The name of the Spanner database.
     */
