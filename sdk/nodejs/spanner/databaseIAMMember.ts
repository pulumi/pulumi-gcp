...
export class DatabaseIAMMember extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: DatabaseIAMMemberArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DatabaseIAMMemberArgs | DatabaseIAMMemberState, opts?: pulumi.ResourceOptions) {
