...
export class DatabaseIAMPolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: DatabaseIAMPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DatabaseIAMPolicyArgs | DatabaseIAMPolicyState, opts?: pulumi.ResourceOptions) {
