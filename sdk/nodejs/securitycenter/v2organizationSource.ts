 ...
 * ```
 */
export class V2OrganizationSource extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V2OrganizationSourceState, opts?: pulumi.CustomResourceOptions): V2OrganizationSource {
        return new V2OrganizationSource(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:securitycenter/v2OrganizationSource:V2OrganizationSource';

    /**
     * Returns true if the given object is an instance of V2OrganizationSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is V2OrganizationSource {
    ...
    constructor(name: string, argsOrState?: V2OrganizationSourceArgs | V2OrganizationSourceState, opts?: pulumi.CustomResourceOptions) {
