...
export class ProjectCustomModule extends pulumi.CustomResource {
     ...
     */
    public readonly customConfig!: pulumi.Output<outputs.securitycenter.ProjectCustomModuleCustomConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: ProjectCustomModuleArgs | ProjectCustomModuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ProjectCustomModule.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
