 ...
 * ```
 */
export class V2ProjectSccBigQueryExport extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V2ProjectSccBigQueryExportState, opts?: pulumi.CustomResourceOptions): V2ProjectSccBigQueryExport {
        return new V2ProjectSccBigQueryExport(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:securitycenter/v2ProjectSccBigQueryExport:V2ProjectSccBigQueryExport';
     ...
     */
    public static isInstance(obj: any): obj is V2ProjectSccBigQueryExport {
    ...
    constructor(name: string, argsOrState?: V2ProjectSccBigQueryExportArgs | V2ProjectSccBigQueryExportState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as V2ProjectSccBigQueryExportState | undefined;
            ...
            const args = argsOrState as V2ProjectSccBigQueryExportArgs | undefined;
