 ...
 * ```
 */
export class V2OrganizationSccBigQueryExports extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V2OrganizationSccBigQueryExportsState, opts?: pulumi.CustomResourceOptions): V2OrganizationSccBigQueryExports {
        return new V2OrganizationSccBigQueryExports(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:securitycenter/v2OrganizationSccBigQueryExports:V2OrganizationSccBigQueryExports';
     ...
     */
    public static isInstance(obj: any): obj is V2OrganizationSccBigQueryExports {
    ...
    constructor(name: string, argsOrState?: V2OrganizationSccBigQueryExportsArgs | V2OrganizationSccBigQueryExportsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as V2OrganizationSccBigQueryExportsState | undefined;
            ...
            const args = argsOrState as V2OrganizationSccBigQueryExportsArgs | undefined;
