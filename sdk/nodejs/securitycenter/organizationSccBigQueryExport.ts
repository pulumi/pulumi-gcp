 ...
 * ```
 */
export class OrganizationSccBigQueryExport extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrganizationSccBigQueryExportState, opts?: pulumi.CustomResourceOptions): OrganizationSccBigQueryExport {
        return new OrganizationSccBigQueryExport(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:securitycenter/organizationSccBigQueryExport:OrganizationSccBigQueryExport';
     ...
     */
    public static isInstance(obj: any): obj is OrganizationSccBigQueryExport {
    ...
    constructor(name: string, argsOrState?: OrganizationSccBigQueryExportArgs | OrganizationSccBigQueryExportState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OrganizationSccBigQueryExportState | undefined;
            ...
            const args = argsOrState as OrganizationSccBigQueryExportArgs | undefined;
