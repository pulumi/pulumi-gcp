 ...
 * ```
 */
export class ManagementProjectSecurityHealthAnalyticsCustomModule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementProjectSecurityHealthAnalyticsCustomModuleState, opts?: pulumi.CustomResourceOptions): ManagementProjectSecurityHealthAnalyticsCustomModule {
        return new ManagementProjectSecurityHealthAnalyticsCustomModule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:securitycenter/managementProjectSecurityHealthAnalyticsCustomModule:ManagementProjectSecurityHealthAnalyticsCustomModule';
     ...
     */
    public static isInstance(obj: any): obj is ManagementProjectSecurityHealthAnalyticsCustomModule {
     ...
     */
    declare public readonly customConfig: pulumi.Output<outputs.securitycenter.ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfig | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagementProjectSecurityHealthAnalyticsCustomModuleArgs | ManagementProjectSecurityHealthAnalyticsCustomModuleState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagementProjectSecurityHealthAnalyticsCustomModuleState | undefined;
            ...
            const args = argsOrState as ManagementProjectSecurityHealthAnalyticsCustomModuleArgs | undefined;
...
export interface ManagementProjectSecurityHealthAnalyticsCustomModuleState {
     ...
     * Structure is documented below.
     */
    customConfig?: pulumi.Input<inputs.securitycenter.ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfig | undefined>;
    /**
     * The display name of the Security Health Analytics custom module. This
     * display name becomes the finding category for all findings that are
     * returned by this custom module. The display name must be between 1 and
