 ...
 * ```
 */
export class ManagementFolderSecurityHealthAnalyticsCustomModule extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementFolderSecurityHealthAnalyticsCustomModuleState, opts?: pulumi.CustomResourceOptions): ManagementFolderSecurityHealthAnalyticsCustomModule {
        return new ManagementFolderSecurityHealthAnalyticsCustomModule(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:securitycenter/managementFolderSecurityHealthAnalyticsCustomModule:ManagementFolderSecurityHealthAnalyticsCustomModule';
     ...
     */
    public static isInstance(obj: any): obj is ManagementFolderSecurityHealthAnalyticsCustomModule {
     ...
     */
    public readonly customConfig!: pulumi.Output<outputs.securitycenter.ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfig | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagementFolderSecurityHealthAnalyticsCustomModuleArgs | ManagementFolderSecurityHealthAnalyticsCustomModuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as ManagementFolderSecurityHealthAnalyticsCustomModuleArgs | undefined;
