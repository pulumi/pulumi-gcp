...
export class InstanceIamMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp:securitycenter/instanceIamMember:InstanceIamMember';
    ...
    declare public readonly condition: pulumi.Output<outputs.securitycenter.InstanceIamMemberCondition | undefined>;
