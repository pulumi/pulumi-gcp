...
export class HubIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HubIamBindingState, opts?: pulumi.CustomResourceOptions): HubIamBinding {
        return new HubIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:networkconnectivity/hubIamBinding:HubIamBinding';
    ...
    declare public readonly condition: pulumi.Output<outputs.networkconnectivity.HubIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: HubIamBindingArgs | HubIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HubIamBindingState | undefined;
            ...
            const args = argsOrState as HubIamBindingArgs | undefined;
