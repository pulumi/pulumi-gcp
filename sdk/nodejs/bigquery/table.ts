...
export interface TableState {
     ...
     * Specifies the configuration of a BigLake managed table. Structure is documented below
     */
    biglakeConfiguration?: pulumi.Input<inputs.bigquery.TableBiglakeConfiguration | undefined>;
    /**
     * Specifies column names to use for data clustering.
     * Up to four top-level columns are allowed, and should be specified in
     * descending priority order.
     */
    clusterings?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * The time when this table was created, in milliseconds since the epoch.
     */
     ...
     * is transparent to the user.  Structure is documented below.
     */
    encryptionConfiguration?: pulumi.Input<inputs.bigquery.TableEncryptionConfiguration | undefined>;
    /**
     * A hash of the resource.
     */
     ...
     * compatible table. Structure is documented below.
     */
    externalCatalogTableOptions?: pulumi.Input<inputs.bigquery.TableExternalCatalogTableOptions | undefined>;
    /**
     * Describes the data format,
     * location, and other properties of a table stored outside of BigQuery.
     * By defining these properties, the data source can then be queried as
     * if it were a standard BigQuery table. Structure is documented below.
     */
    externalDataConfiguration?: pulumi.Input<inputs.bigquery.TableExternalDataConfiguration | undefined>;
    /**
     * A descriptive name for the table.
     */
     ...
     * (Output-only) A list of autogenerated schema fields.
     */
    generatedSchemaColumns?: pulumi.Input<string | undefined>;
    /**
     * If true, Terraform will prevent columns added by the server(e.g. hive partitioned columns) in schema from showing diff.
     */
    ignoreAutoGeneratedSchema?: pulumi.Input<boolean | undefined>;
    /**
     * A list of fields which would act non-authoritative for each column in schema.
     * **NOTE:** Right now only `dataPolicies` field is supported(others might be supported in the future). It means that any `dataPolicies` updated outside terraform will be ignored if this option is used.
     * If there is no policy in config for a column but there are in live state, the policy will persist.
     ...
     * like `description` for a column will keep behaving as they are(authoritatively).
     */
    ignoreSchemaChanges?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * A mapping of labels to assign to the resource.
     *
     * **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
     ...
     * Structure is documented below.
     */
    materializedView?: pulumi.Input<inputs.bigquery.TableMaterializedView | undefined>;
    /**
     * The maximum staleness of data that could be
     * returned when the table (or stale MV) is queried. Staleness encoded as a
     * string encoding of [SQL IntervalValue
     * type](https://cloud.google.com/bigquery/docs/reference/standard-sql/data-types#interval_type).
     */
    maxStaleness?: pulumi.Input<string | undefined>;
    /**
     * The size of this table in bytes, excluding any data in the streaming buffer.
     */
    numBytes?: pulumi.Input<number | undefined>;
    /**
     * The number of bytes in the table that are considered "long-term storage".
     */
    numLongTermBytes?: pulumi.Input<number | undefined>;
    /**
     * The number of rows of data in this table, excluding any data in the streaming buffer.
     */
    numRows?: pulumi.Input<number | undefined>;
    /**
     * The ID of the project in which the resource belongs. If it
     * is not provided, the provider project is used.
     */
     ...
     * partitioning for this table. Structure is documented below.
     */
    rangePartitioning?: pulumi.Input<inputs.bigquery.TableRangePartitioning | undefined>;
    /**
     * If set to true, queries over this table
     * require a partition filter that can be used for partition elimination to be
     * specified.
     ...
     * type definition in field schema. Structure is documented below.
     */
    schemaForeignTypeInfo?: pulumi.Input<inputs.bigquery.TableSchemaForeignTypeInfo | undefined>;
    /**
     * The URI of the created resource.
     */
     ...
     * Structure is documented below.
     */
    tableConstraints?: pulumi.Input<inputs.bigquery.TableTableConstraints | undefined>;
    /**
     * A unique ID for the resource.
     * Changing this forces a new resource to be created.
     */
     ...
     * View sets the optional parameter "view": Specifies the view that determines which table information is returned. By default, basic table information and storage statistics (STORAGE_STATS) are returned. Possible values: TABLE_METADATA_VIEW_UNSPECIFIED, BASIC, STORAGE_STATS, FULL
     */
    tableMetadataView?: pulumi.Input<string | undefined>;
    /**
     * Replication info of a table created
     * using "AS REPLICA" DDL like:
     * `CREATE MATERIALIZED VIEW mv1 AS REPLICA OF srcMv`.
     * Structure is documented below.
     */
    tableReplicationInfo?: pulumi.Input<inputs.bigquery.TableTableReplicationInfo | undefined>;
    /**
     * If specified, configures time-based
     * partitioning for this table. Structure is documented below.
     */
    timePartitioning?: pulumi.Input<inputs.bigquery.TableTimePartitioning | undefined>;
    /**
     * Describes the table type.
     */
     ...
     * Structure is documented below.
     */
    view?: pulumi.Input<inputs.bigquery.TableView | undefined>;
}
