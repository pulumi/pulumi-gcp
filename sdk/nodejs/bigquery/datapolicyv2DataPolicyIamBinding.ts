...
export class Datapolicyv2DataPolicyIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Datapolicyv2DataPolicyIamBindingState, opts?: pulumi.CustomResourceOptions): Datapolicyv2DataPolicyIamBinding {
        return new Datapolicyv2DataPolicyIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:bigquery/datapolicyv2DataPolicyIamBinding:Datapolicyv2DataPolicyIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is Datapolicyv2DataPolicyIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.bigquery.Datapolicyv2DataPolicyIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: Datapolicyv2DataPolicyIamBindingArgs | Datapolicyv2DataPolicyIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Datapolicyv2DataPolicyIamBindingState | undefined;
            ...
            const args = argsOrState as Datapolicyv2DataPolicyIamBindingArgs | undefined;
