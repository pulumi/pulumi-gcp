 ...
 */
export class RoutineIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RoutineIamMemberState, opts?: pulumi.CustomResourceOptions): RoutineIamMember {
        return new RoutineIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:bigquery/routineIamMember:RoutineIamMember';

    /**
     * Returns true if the given object is an instance of RoutineIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RoutineIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RoutineIamMember.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.bigquery.RoutineIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: RoutineIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RoutineIamMemberArgs | RoutineIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RoutineIamMemberState | undefined;
            ...
            const args = argsOrState as RoutineIamMemberArgs | undefined;
        ...
        super(RoutineIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RoutineIamMemberState {
    condition?: pulumi.Input<inputs.bigquery.RoutineIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface RoutineIamMemberArgs {
    condition?: pulumi.Input<inputs.bigquery.RoutineIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
