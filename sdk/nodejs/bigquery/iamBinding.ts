...
export class IamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.bigquery.IamBindingCondition | undefined>;
    /**
...
export interface IamBindingState {
    condition?: pulumi.Input<inputs.bigquery.IamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
