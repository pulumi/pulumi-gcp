...
export class Dataset extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: DatasetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DatasetArgs | DatasetState, opts?: pulumi.ResourceOptions) {
