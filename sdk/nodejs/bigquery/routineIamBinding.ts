 ...
 */
export class RoutineIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RoutineIamBindingState, opts?: pulumi.CustomResourceOptions): RoutineIamBinding {
        return new RoutineIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:bigquery/routineIamBinding:RoutineIamBinding';

    /**
     * Returns true if the given object is an instance of RoutineIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RoutineIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RoutineIamBinding.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.bigquery.RoutineIamBindingCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: RoutineIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RoutineIamBindingArgs | RoutineIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RoutineIamBindingState | undefined;
            ...
            const args = argsOrState as RoutineIamBindingArgs | undefined;
        ...
        super(RoutineIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RoutineIamBindingState {
    condition?: pulumi.Input<inputs.bigquery.RoutineIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface RoutineIamBindingArgs {
    condition?: pulumi.Input<inputs.bigquery.RoutineIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
