...
export class FunctionIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.cloudfunctions.FunctionIamBindingCondition | undefined>;
    /**
...
export interface FunctionIamBindingState {
    ...
    condition?: pulumi.Input<inputs.cloudfunctions.FunctionIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
