 ...
 * ```
 */
export class GeminiGcpEnablementSettingBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GeminiGcpEnablementSettingBindingState, opts?: pulumi.CustomResourceOptions): GeminiGcpEnablementSettingBinding {
        return new GeminiGcpEnablementSettingBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:gemini/geminiGcpEnablementSettingBinding:GeminiGcpEnablementSettingBinding';
     ...
     */
    public static isInstance(obj: any): obj is GeminiGcpEnablementSettingBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GeminiGcpEnablementSettingBinding.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: GeminiGcpEnablementSettingBindingArgs | GeminiGcpEnablementSettingBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GeminiGcpEnablementSettingBindingState | undefined;
            ...
            const args = argsOrState as GeminiGcpEnablementSettingBindingArgs | undefined;
        ...
        super(GeminiGcpEnablementSettingBinding.__pulumiType, name, resourceInputs, opts);
    }
}
