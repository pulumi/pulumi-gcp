 ...
 */
export class RepositoryGroupIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryGroupIamBindingState, opts?: pulumi.CustomResourceOptions): RepositoryGroupIamBinding {
        return new RepositoryGroupIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:gemini/repositoryGroupIamBinding:RepositoryGroupIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is RepositoryGroupIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.gemini.RepositoryGroupIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RepositoryGroupIamBindingArgs | RepositoryGroupIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RepositoryGroupIamBindingState | undefined;
            ...
            const args = argsOrState as RepositoryGroupIamBindingArgs | undefined;
