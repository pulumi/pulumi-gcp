 ...
 */
export class ListingIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ListingIamMemberState, opts?: pulumi.CustomResourceOptions): ListingIamMember {
        return new ListingIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:bigqueryanalyticshub/listingIamMember:ListingIamMember';

    /**
     * Returns true if the given object is an instance of ListingIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ListingIamMember {
    ...
    public readonly condition!: pulumi.Output<outputs.bigqueryanalyticshub.ListingIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ListingIamMemberArgs | ListingIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ListingIamMemberState | undefined;
            ...
            const args = argsOrState as ListingIamMemberArgs | undefined;
        ...
        super(ListingIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
