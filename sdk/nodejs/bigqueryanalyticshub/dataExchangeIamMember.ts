 ...
 */
export class DataExchangeIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataExchangeIamMemberState, opts?: pulumi.CustomResourceOptions): DataExchangeIamMember {
        return new DataExchangeIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:bigqueryanalyticshub/dataExchangeIamMember:DataExchangeIamMember';

    /**
     * Returns true if the given object is an instance of DataExchangeIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataExchangeIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.bigqueryanalyticshub.DataExchangeIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: DataExchangeIamMemberArgs | DataExchangeIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataExchangeIamMemberState | undefined;
            ...
            const args = argsOrState as DataExchangeIamMemberArgs | undefined;
...
export interface DataExchangeIamMemberState {
    condition?: pulumi.Input<inputs.bigqueryanalyticshub.DataExchangeIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
