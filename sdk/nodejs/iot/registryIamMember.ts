...
export class RegistryIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryIamMemberState, opts?: pulumi.CustomResourceOptions): RegistryIamMember {
        return new RegistryIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iot/registryIamMember:RegistryIamMember';
    ...
    public readonly condition!: pulumi.Output<outputs.iot.RegistryIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RegistryIamMemberArgs | RegistryIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegistryIamMemberState | undefined;
            ...
            const args = argsOrState as RegistryIamMemberArgs | undefined;
 ...
 */
export interface RegistryIamMemberState {
    condition?: pulumi.Input<inputs.iot.RegistryIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
