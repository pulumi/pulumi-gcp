...
export class WorkforcePoolIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkforcePoolIamBindingState, opts?: pulumi.CustomResourceOptions): WorkforcePoolIamBinding {
        return new WorkforcePoolIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:iam/workforcePoolIamBinding:WorkforcePoolIamBinding';

    /**
     * Returns true if the given object is an instance of WorkforcePoolIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WorkforcePoolIamBinding {
    ...
    constructor(name: string, argsOrState?: WorkforcePoolIamBindingArgs | WorkforcePoolIamBindingState, opts?: pulumi.CustomResourceOptions) {
