 ...
 */
export class RuntimeTemplateIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RuntimeTemplateIamMemberState, opts?: pulumi.CustomResourceOptions): RuntimeTemplateIamMember {
        return new RuntimeTemplateIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:colab/runtimeTemplateIamMember:RuntimeTemplateIamMember';

    /**
     * Returns true if the given object is an instance of RuntimeTemplateIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RuntimeTemplateIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.colab.RuntimeTemplateIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RuntimeTemplateIamMemberArgs | RuntimeTemplateIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RuntimeTemplateIamMemberState | undefined;
            ...
            const args = argsOrState as RuntimeTemplateIamMemberArgs | undefined;
...
export interface RuntimeTemplateIamMemberState {
    condition?: pulumi.Input<inputs.colab.RuntimeTemplateIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
