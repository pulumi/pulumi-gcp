...
export class FeatureIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FeatureIamMemberState, opts?: pulumi.CustomResourceOptions): FeatureIamMember {
        return new FeatureIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:gkehub/featureIamMember:FeatureIamMember';
    ...
    public readonly condition!: pulumi.Output<outputs.gkehub.FeatureIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: FeatureIamMemberArgs | FeatureIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FeatureIamMemberState | undefined;
            ...
            const args = argsOrState as FeatureIamMemberArgs | undefined;
        ...
        super(FeatureIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
