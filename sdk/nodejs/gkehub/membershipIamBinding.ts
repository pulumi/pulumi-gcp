...
export class MembershipIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.gkehub.MembershipIamBindingCondition | undefined>;
    /**
...
export interface MembershipIamBindingState {
    condition?: pulumi.Input<inputs.gkehub.MembershipIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
