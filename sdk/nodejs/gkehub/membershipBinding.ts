 ...
 *     membershipId: "tf-test-membership_64134",
 *     endpoint: {
 *         gkeCluster: {
 ...
 *     dependsOn: [primary],
 * });
 * const scope = new gcp.gkehub.Scope("scope", {scopeId: "tf-test-scope_67762"});
 * const membershipBinding = new gcp.gkehub.MembershipBinding("membership_binding", {
 *     membershipBindingId: "tf-test-membership-binding_44154",
 *     scope: scope.name,
