...
export class FeatureIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FeatureIamBindingState, opts?: pulumi.CustomResourceOptions): FeatureIamBinding {
        return new FeatureIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:gkehub/featureIamBinding:FeatureIamBinding';
    ...
    public readonly condition!: pulumi.Output<outputs.gkehub.FeatureIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: FeatureIamBindingArgs | FeatureIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FeatureIamBindingState | undefined;
            ...
            const args = argsOrState as FeatureIamBindingArgs | undefined;
        ...
        super(FeatureIamBinding.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
