...
export class ScopeIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScopeIamBindingState, opts?: pulumi.CustomResourceOptions): ScopeIamBinding {
        return new ScopeIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:gkehub/scopeIamBinding:ScopeIamBinding';
    ...
    public readonly condition!: pulumi.Output<outputs.gkehub.ScopeIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ScopeIamBindingArgs | ScopeIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ScopeIamBindingState | undefined;
            ...
            const args = argsOrState as ScopeIamBindingArgs | undefined;
        ...
        super(ScopeIamBinding.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
