...
export class ScopeIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScopeIamMemberState, opts?: pulumi.CustomResourceOptions): ScopeIamMember {
        return new ScopeIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:gkehub/scopeIamMember:ScopeIamMember';
    ...
    public readonly condition!: pulumi.Output<outputs.gkehub.ScopeIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ScopeIamMemberArgs | ScopeIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ScopeIamMemberState | undefined;
            ...
            const args = argsOrState as ScopeIamMemberArgs | undefined;
        ...
        super(ScopeIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
