...
export class AiFeatureGroup extends pulumi.CustomResource {
     ...
     */
    public readonly bigQuery!: pulumi.Output<outputs.vertex.AiFeatureGroupBigQuery | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AiFeatureGroupArgs | AiFeatureGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(AiFeatureGroup.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
