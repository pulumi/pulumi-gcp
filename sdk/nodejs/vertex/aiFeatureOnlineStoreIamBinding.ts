 ...
 */
export class AiFeatureOnlineStoreIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureOnlineStoreIamBindingState, opts?: pulumi.CustomResourceOptions): AiFeatureOnlineStoreIamBinding {
        return new AiFeatureOnlineStoreIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:vertex/aiFeatureOnlineStoreIamBinding:AiFeatureOnlineStoreIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is AiFeatureOnlineStoreIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.vertex.AiFeatureOnlineStoreIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AiFeatureOnlineStoreIamBindingArgs | AiFeatureOnlineStoreIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AiFeatureOnlineStoreIamBindingState | undefined;
            ...
            const args = argsOrState as AiFeatureOnlineStoreIamBindingArgs | undefined;
