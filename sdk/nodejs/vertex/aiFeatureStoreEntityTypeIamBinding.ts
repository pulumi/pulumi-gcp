...
export class AiFeatureStoreEntityTypeIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.vertex.AiFeatureStoreEntityTypeIamBindingCondition | undefined>;
    /**
...
export interface AiFeatureStoreEntityTypeIamBindingState {
    condition?: pulumi.Input<inputs.vertex.AiFeatureStoreEntityTypeIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
