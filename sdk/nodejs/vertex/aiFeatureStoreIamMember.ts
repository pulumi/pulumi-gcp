...
export class AiFeatureStoreIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.vertex.AiFeatureStoreIamMemberCondition | undefined>;
    /**
...
export interface AiFeatureStoreIamMemberState {
    condition?: pulumi.Input<inputs.vertex.AiFeatureStoreIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
