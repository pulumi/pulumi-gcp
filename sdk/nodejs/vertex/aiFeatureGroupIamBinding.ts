...
export class AiFeatureGroupIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.vertex.AiFeatureGroupIamBindingCondition | undefined>;
    /**
...
export interface AiFeatureGroupIamBindingState {
    condition?: pulumi.Input<inputs.vertex.AiFeatureGroupIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
     ...
     * Used to find the parent resource to bind the IAM policy to
     */
    featureGroup?: pulumi.Input<string | undefined>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
     * * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
