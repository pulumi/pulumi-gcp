 ...
 */
export class AiFeatureOnlineStoreFeatureviewIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureOnlineStoreFeatureviewIamBindingState, opts?: pulumi.CustomResourceOptions): AiFeatureOnlineStoreFeatureviewIamBinding {
        return new AiFeatureOnlineStoreFeatureviewIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:vertex/aiFeatureOnlineStoreFeatureviewIamBinding:AiFeatureOnlineStoreFeatureviewIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is AiFeatureOnlineStoreFeatureviewIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.vertex.AiFeatureOnlineStoreFeatureviewIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AiFeatureOnlineStoreFeatureviewIamBindingArgs | AiFeatureOnlineStoreFeatureviewIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AiFeatureOnlineStoreFeatureviewIamBindingState | undefined;
            ...
            const args = argsOrState as AiFeatureOnlineStoreFeatureviewIamBindingArgs | undefined;
