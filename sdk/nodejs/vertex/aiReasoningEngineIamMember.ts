 ...
 */
export class AiReasoningEngineIamMember extends pulumi.CustomResource {
    /**
     * Get an existing AiReasoningEngineIamMember resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiReasoningEngineIamMemberState, opts?: pulumi.CustomResourceOptions): AiReasoningEngineIamMember {
        return new AiReasoningEngineIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:vertex/aiReasoningEngineIamMember:AiReasoningEngineIamMember';

    /**
     * Returns true if the given object is an instance of AiReasoningEngineIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AiReasoningEngineIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AiReasoningEngineIamMember.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.vertex.AiReasoningEngineIamMemberCondition | undefined>;
    /**
    ...
    /**
     * Create a AiReasoningEngineIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AiReasoningEngineIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AiReasoningEngineIamMemberArgs | AiReasoningEngineIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AiReasoningEngineIamMemberState | undefined;
            ...
            const args = argsOrState as AiReasoningEngineIamMemberArgs | undefined;
        ...
        super(AiReasoningEngineIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AiReasoningEngineIamMemberState {
    condition?: pulumi.Input<inputs.vertex.AiReasoningEngineIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface AiReasoningEngineIamMemberArgs {
    condition?: pulumi.Input<inputs.vertex.AiReasoningEngineIamMemberCondition | undefined>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
