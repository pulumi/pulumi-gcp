 ...
 */
export class SchemaIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SchemaIamBindingState, opts?: pulumi.CustomResourceOptions): SchemaIamBinding {
        return new SchemaIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:pubsub/schemaIamBinding:SchemaIamBinding';

    /**
     * Returns true if the given object is an instance of SchemaIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SchemaIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.pubsub.SchemaIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SchemaIamBindingArgs | SchemaIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SchemaIamBindingState | undefined;
            ...
            const args = argsOrState as SchemaIamBindingArgs | undefined;
...
export interface SchemaIamBindingState {
    condition?: pulumi.Input<inputs.pubsub.SchemaIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
