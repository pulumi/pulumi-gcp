...
export class TopicIAMBinding extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: TopicIAMBindingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TopicIAMBindingArgs | TopicIAMBindingState, opts?: pulumi.ResourceOptions) {
