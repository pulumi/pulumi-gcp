...
export class SubscriptionIAMPolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: SubscriptionIAMPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SubscriptionIAMPolicyArgs | SubscriptionIAMPolicyState, opts?: pulumi.ResourceOptions) {
