...
export class TopicIAMMember extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: TopicIAMMemberArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TopicIAMMemberArgs | TopicIAMMemberState, opts?: pulumi.ResourceOptions) {
