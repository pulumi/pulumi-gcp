...
export class SchemaIamMember extends pulumi.CustomResource {
    ...
    public readonly condition!: pulumi.Output<outputs.pubsub.SchemaIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SchemaIamMemberArgs | SchemaIamMemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SchemaIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
