...
export class ServicePerimeterDryRunIngressPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly ingressFrom: pulumi.Output<outputs.accesscontextmanager.ServicePerimeterDryRunIngressPolicyIngressFrom | undefined>;
    /**
     * Defines the conditions on the `ApiOperation` and request destination that cause
     * this `IngressPolicy` to apply.
     * Structure is documented below.
     */
    declare public readonly ingressTo: pulumi.Output<outputs.accesscontextmanager.ServicePerimeterDryRunIngressPolicyIngressTo | undefined>;
    /**
