...
export class AccessPolicyIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.accesscontextmanager.AccessPolicyIamMemberCondition | undefined>;
    /**
...
export interface AccessPolicyIamMemberState {
    condition?: pulumi.Input<inputs.accesscontextmanager.AccessPolicyIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
