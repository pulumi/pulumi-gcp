...
export class InstanceIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.notebooks.InstanceIamMemberCondition | undefined>;
    /**
...
export interface InstanceIamMemberState {
    condition?: pulumi.Input<inputs.notebooks.InstanceIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
