...
export class RuntimeIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RuntimeIamMemberState, opts?: pulumi.CustomResourceOptions): RuntimeIamMember {
        return new RuntimeIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:notebooks/runtimeIamMember:RuntimeIamMember';
    ...
    public readonly condition!: pulumi.Output<outputs.notebooks.RuntimeIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RuntimeIamMemberArgs | RuntimeIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RuntimeIamMemberState | undefined;
            ...
            const args = argsOrState as RuntimeIamMemberArgs | undefined;
        ...
        super(RuntimeIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
