...
export class UsageExportBucket extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: UsageExportBucketArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UsageExportBucketArgs | UsageExportBucketState, opts?: pulumi.ResourceOptions) {
