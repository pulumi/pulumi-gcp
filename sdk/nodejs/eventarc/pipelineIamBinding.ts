 ...
 */
export class PipelineIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing PipelineIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PipelineIamBindingState, opts?: pulumi.CustomResourceOptions): PipelineIamBinding {
        return new PipelineIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:eventarc/pipelineIamBinding:PipelineIamBinding';

    /**
     * Returns true if the given object is an instance of PipelineIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PipelineIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PipelineIamBinding.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.eventarc.PipelineIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a PipelineIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: PipelineIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: PipelineIamBindingArgs | PipelineIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PipelineIamBindingState | undefined;
            ...
            const args = argsOrState as PipelineIamBindingArgs | undefined;
        ...
        super(PipelineIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface PipelineIamBindingState {
    condition?: pulumi.Input<inputs.eventarc.PipelineIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface PipelineIamBindingArgs {
    condition?: pulumi.Input<inputs.eventarc.PipelineIamBindingCondition | undefined>;
    /**
     * Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122. Used to find the parent resource to bind the IAM policy to. If not specified,
     * the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
