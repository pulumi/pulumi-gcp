...
export class PolicyTagIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.datacatalog.PolicyTagIamBindingCondition | undefined>;
    /**
...
export interface PolicyTagIamBindingState {
    condition?: pulumi.Input<inputs.datacatalog.PolicyTagIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
