 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export class FirewallPolicyIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallPolicyIamMemberState, opts?: pulumi.CustomResourceOptions): FirewallPolicyIamMember {
        return new FirewallPolicyIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/firewallPolicyIamMember:FirewallPolicyIamMember';

    /**
     * Returns true if the given object is an instance of FirewallPolicyIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FirewallPolicyIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FirewallPolicyIamMember.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.compute.FirewallPolicyIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: FirewallPolicyIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FirewallPolicyIamMemberArgs | FirewallPolicyIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FirewallPolicyIamMemberState | undefined;
            ...
            const args = argsOrState as FirewallPolicyIamMemberArgs | undefined;
        ...
        super(FirewallPolicyIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FirewallPolicyIamMemberState {
    condition?: pulumi.Input<inputs.compute.FirewallPolicyIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface FirewallPolicyIamMemberArgs {
    condition?: pulumi.Input<inputs.compute.FirewallPolicyIamMemberCondition | undefined>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
