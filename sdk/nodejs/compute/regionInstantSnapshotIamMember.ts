...
export class RegionInstantSnapshotIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionInstantSnapshotIamMemberState, opts?: pulumi.CustomResourceOptions): RegionInstantSnapshotIamMember {
        return new RegionInstantSnapshotIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/regionInstantSnapshotIamMember:RegionInstantSnapshotIamMember';
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.RegionInstantSnapshotIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RegionInstantSnapshotIamMemberArgs | RegionInstantSnapshotIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegionInstantSnapshotIamMemberState | undefined;
            ...
            const args = argsOrState as RegionInstantSnapshotIamMemberArgs | undefined;
