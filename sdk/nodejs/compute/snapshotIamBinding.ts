...
export class SnapshotIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.compute.SnapshotIamBindingCondition | undefined>;
    /**
...
export interface SnapshotIamBindingState {
    condition?: pulumi.Input<inputs.compute.SnapshotIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
