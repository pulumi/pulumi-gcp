...
export class TargetPool extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: TargetPoolArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TargetPoolArgs | TargetPoolState, opts?: pulumi.ResourceOptions) {
