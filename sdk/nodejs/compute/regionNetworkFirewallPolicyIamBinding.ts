 ...
 */
export class RegionNetworkFirewallPolicyIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing RegionNetworkFirewallPolicyIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionNetworkFirewallPolicyIamBindingState, opts?: pulumi.CustomResourceOptions): RegionNetworkFirewallPolicyIamBinding {
        return new RegionNetworkFirewallPolicyIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/regionNetworkFirewallPolicyIamBinding:RegionNetworkFirewallPolicyIamBinding';

    /**
     * Returns true if the given object is an instance of RegionNetworkFirewallPolicyIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RegionNetworkFirewallPolicyIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RegionNetworkFirewallPolicyIamBinding.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.compute.RegionNetworkFirewallPolicyIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a RegionNetworkFirewallPolicyIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RegionNetworkFirewallPolicyIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RegionNetworkFirewallPolicyIamBindingArgs | RegionNetworkFirewallPolicyIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegionNetworkFirewallPolicyIamBindingState | undefined;
            ...
            const args = argsOrState as RegionNetworkFirewallPolicyIamBindingArgs | undefined;
        ...
        super(RegionNetworkFirewallPolicyIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RegionNetworkFirewallPolicyIamBindingState {
    condition?: pulumi.Input<inputs.compute.RegionNetworkFirewallPolicyIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface RegionNetworkFirewallPolicyIamBindingArgs {
    condition?: pulumi.Input<inputs.compute.RegionNetworkFirewallPolicyIamBindingCondition | undefined>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
