...
export class TargetTCPProxy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: TargetTCPProxyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TargetTCPProxyArgs | TargetTCPProxyState, opts?: pulumi.ResourceOptions) {
