 ...
 */
export class RegionNetworkFirewallPolicyIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionNetworkFirewallPolicyIamMemberState, opts?: pulumi.CustomResourceOptions): RegionNetworkFirewallPolicyIamMember {
        return new RegionNetworkFirewallPolicyIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/regionNetworkFirewallPolicyIamMember:RegionNetworkFirewallPolicyIamMember';

    /**
     * Returns true if the given object is an instance of RegionNetworkFirewallPolicyIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RegionNetworkFirewallPolicyIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RegionNetworkFirewallPolicyIamMember.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.compute.RegionNetworkFirewallPolicyIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: RegionNetworkFirewallPolicyIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RegionNetworkFirewallPolicyIamMemberArgs | RegionNetworkFirewallPolicyIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegionNetworkFirewallPolicyIamMemberState | undefined;
            ...
            const args = argsOrState as RegionNetworkFirewallPolicyIamMemberArgs | undefined;
        ...
        super(RegionNetworkFirewallPolicyIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RegionNetworkFirewallPolicyIamMemberState {
    condition?: pulumi.Input<inputs.compute.RegionNetworkFirewallPolicyIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface RegionNetworkFirewallPolicyIamMemberArgs {
    condition?: pulumi.Input<inputs.compute.RegionNetworkFirewallPolicyIamMemberCondition | undefined>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
