...
export class HaVpnGateway extends pulumi.CustomResource {
     ...
     */
    declare public readonly gatewayIpVersion: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly vpnInterfaces: pulumi.Output<outputs.compute.HaVpnGatewayVpnInterface[]>;
