...
export class SubnetworkIAMBinding extends pulumi.CustomResource {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.SubnetworkIAMBindingCondition | undefined>;
    /**
...
export interface SubnetworkIAMBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.compute.SubnetworkIAMBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
