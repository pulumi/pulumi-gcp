...
export class NetworkPeering extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: NetworkPeeringArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NetworkPeeringArgs | NetworkPeeringState, opts?: pulumi.ResourceOptions) {
