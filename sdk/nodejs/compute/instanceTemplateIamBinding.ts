 ...
 */
export class InstanceTemplateIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstanceTemplateIamBindingState, opts?: pulumi.CustomResourceOptions): InstanceTemplateIamBinding {
        return new InstanceTemplateIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/instanceTemplateIamBinding:InstanceTemplateIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is InstanceTemplateIamBinding {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.InstanceTemplateIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstanceTemplateIamBindingArgs | InstanceTemplateIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InstanceTemplateIamBindingState | undefined;
            ...
            const args = argsOrState as InstanceTemplateIamBindingArgs | undefined;
