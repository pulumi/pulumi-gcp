...
export class StoragePoolIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StoragePoolIamMemberState, opts?: pulumi.CustomResourceOptions): StoragePoolIamMember {
        return new StoragePoolIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/storagePoolIamMember:StoragePoolIamMember';
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.StoragePoolIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StoragePoolIamMemberArgs | StoragePoolIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StoragePoolIamMemberState | undefined;
            ...
            const args = argsOrState as StoragePoolIamMemberArgs | undefined;
