...
export class StoragePoolIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StoragePoolIamBindingState, opts?: pulumi.CustomResourceOptions): StoragePoolIamBinding {
        return new StoragePoolIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/storagePoolIamBinding:StoragePoolIamBinding';
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.StoragePoolIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: StoragePoolIamBindingArgs | StoragePoolIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StoragePoolIamBindingState | undefined;
            ...
            const args = argsOrState as StoragePoolIamBindingArgs | undefined;
