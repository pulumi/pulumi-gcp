...
export class InstanceTemplate extends pulumi.CustomResource {
     ...
     */
    public readonly networkInterfaces: pulumi.Output<{ accessConfigs?: { assignedNatIp: string, natIp: string }[], address: string, aliasIpRanges?: { ipCidrRange: string, subnetworkRangeName?: string }[], network: string, networkIp: string, subnetwork: string, subnetworkProject: string }[] | undefined>;
    /**
     ...
     */
    constructor(name: string, args: InstanceTemplateArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: InstanceTemplateArgs | InstanceTemplateState, opts?: pulumi.ResourceOptions) {
