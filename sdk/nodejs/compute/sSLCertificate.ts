...
export class SSLCertificate extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: SSLCertificateArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SSLCertificateArgs | SSLCertificateState, opts?: pulumi.ResourceOptions) {
