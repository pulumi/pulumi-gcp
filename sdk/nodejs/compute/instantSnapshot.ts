...
export class InstantSnapshot extends pulumi.CustomResource {
     ...
     */
    declare public readonly params: pulumi.Output<outputs.compute.InstantSnapshotParams | undefined>;
    /**
...
export interface InstantSnapshotState {
     ...
     * Structure is documented below.
     */
    params?: pulumi.Input<inputs.compute.InstantSnapshotParams | undefined>;
    /**
     * The ID of the project in which the resource belongs.
     * If it is not provided, the provider project is used.
     */
