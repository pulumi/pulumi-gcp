...
export class BackendServiceIamMember extends pulumi.CustomResource {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.BackendServiceIamMemberCondition | undefined>;
    /**
     ...
     * `gcp.compute.BackendServiceIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
...
export interface BackendServiceIamMemberState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.compute.BackendServiceIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
