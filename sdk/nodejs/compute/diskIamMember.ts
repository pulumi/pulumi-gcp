...
export class DiskIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.compute.DiskIamMemberCondition | undefined>;
    /**
...
export interface DiskIamMemberState {
    condition?: pulumi.Input<inputs.compute.DiskIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
