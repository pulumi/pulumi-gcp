 ...
 */
export class InstantSnapshotIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstantSnapshotIamBindingState, opts?: pulumi.CustomResourceOptions): InstantSnapshotIamBinding {
        return new InstantSnapshotIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/instantSnapshotIamBinding:InstantSnapshotIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is InstantSnapshotIamBinding {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.InstantSnapshotIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InstantSnapshotIamBindingArgs | InstantSnapshotIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InstantSnapshotIamBindingState | undefined;
            ...
            const args = argsOrState as InstantSnapshotIamBindingArgs | undefined;
...
export interface InstantSnapshotIamBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.compute.InstantSnapshotIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
