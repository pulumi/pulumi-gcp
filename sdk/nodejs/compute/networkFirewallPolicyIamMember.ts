...
export class NetworkFirewallPolicyIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallPolicyIamMemberState, opts?: pulumi.CustomResourceOptions): NetworkFirewallPolicyIamMember {
        return new NetworkFirewallPolicyIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/networkFirewallPolicyIamMember:NetworkFirewallPolicyIamMember';
    ...
    declare public readonly condition: pulumi.Output<outputs.compute.NetworkFirewallPolicyIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NetworkFirewallPolicyIamMemberArgs | NetworkFirewallPolicyIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as NetworkFirewallPolicyIamMemberState | undefined;
            ...
            const args = argsOrState as NetworkFirewallPolicyIamMemberArgs | undefined;
 ...
 */
export interface NetworkFirewallPolicyIamMemberState {
    condition?: pulumi.Input<inputs.compute.NetworkFirewallPolicyIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
