...
export class SnapshotIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SnapshotIamMemberState, opts?: pulumi.CustomResourceOptions): SnapshotIamMember {
        return new SnapshotIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/snapshotIamMember:SnapshotIamMember';
    ...
    declare public readonly condition: pulumi.Output<outputs.compute.SnapshotIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SnapshotIamMemberArgs | SnapshotIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SnapshotIamMemberState | undefined;
            ...
            const args = argsOrState as SnapshotIamMemberArgs | undefined;
