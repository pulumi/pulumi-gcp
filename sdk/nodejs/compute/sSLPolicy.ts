...
export class SSLPolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: SSLPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SSLPolicyArgs | SSLPolicyState, opts?: pulumi.ResourceOptions) {
