...
export class RegionInstantSnapshotIamPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionInstantSnapshotIamPolicyState, opts?: pulumi.CustomResourceOptions): RegionInstantSnapshotIamPolicy {
        return new RegionInstantSnapshotIamPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/regionInstantSnapshotIamPolicy:RegionInstantSnapshotIamPolicy';
    ...
    constructor(name: string, argsOrState?: RegionInstantSnapshotIamPolicyArgs | RegionInstantSnapshotIamPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegionInstantSnapshotIamPolicyState | undefined;
            ...
            const args = argsOrState as RegionInstantSnapshotIamPolicyArgs | undefined;
