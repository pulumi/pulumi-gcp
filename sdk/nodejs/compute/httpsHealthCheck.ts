...
export class HttpsHealthCheck extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: HttpsHealthCheckArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: HttpsHealthCheckArgs | HttpsHealthCheckState, opts?: pulumi.ResourceOptions) {
