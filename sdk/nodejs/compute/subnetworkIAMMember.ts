...
export class SubnetworkIAMMember extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: SubnetworkIAMMemberArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SubnetworkIAMMemberArgs | SubnetworkIAMMemberState, opts?: pulumi.ResourceOptions) {
