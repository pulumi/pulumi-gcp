...
export class RegionInstantSnapshotIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionInstantSnapshotIamBindingState, opts?: pulumi.CustomResourceOptions): RegionInstantSnapshotIamBinding {
        return new RegionInstantSnapshotIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:compute/regionInstantSnapshotIamBinding:RegionInstantSnapshotIamBinding';
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.compute.RegionInstantSnapshotIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RegionInstantSnapshotIamBindingArgs | RegionInstantSnapshotIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegionInstantSnapshotIamBindingState | undefined;
            ...
            const args = argsOrState as RegionInstantSnapshotIamBindingArgs | undefined;
