...
export class RouterPeer extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: RouterPeerArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RouterPeerArgs | RouterPeerState, opts?: pulumi.ResourceOptions) {
