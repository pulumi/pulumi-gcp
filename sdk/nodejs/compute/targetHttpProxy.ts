...
export class TargetHttpProxy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: TargetHttpProxyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TargetHttpProxyArgs | TargetHttpProxyState, opts?: pulumi.ResourceOptions) {
