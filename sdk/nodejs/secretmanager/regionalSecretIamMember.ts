 ...
 */
export class RegionalSecretIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionalSecretIamMemberState, opts?: pulumi.CustomResourceOptions): RegionalSecretIamMember {
        return new RegionalSecretIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:secretmanager/regionalSecretIamMember:RegionalSecretIamMember';

    /**
     * Returns true if the given object is an instance of RegionalSecretIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RegionalSecretIamMember {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.secretmanager.RegionalSecretIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RegionalSecretIamMemberArgs | RegionalSecretIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegionalSecretIamMemberState | undefined;
            ...
            const args = argsOrState as RegionalSecretIamMemberArgs | undefined;
