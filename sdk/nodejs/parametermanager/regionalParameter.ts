 ...
 * import * as gcp from "@pulumi/gcp";
 *
 * const regional_parameter_with_tags = new gcp.parametermanager.RegionalParameter("regional-parameter-with-tags", {
 *     location: "us-central1",
 *     parameterId: "regional_parameter",
 *     tags: {
...
export class RegionalParameter extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly policyMembers: pulumi.Output<outputs.parametermanager.RegionalParameterPolicyMember[]>;
    /**
