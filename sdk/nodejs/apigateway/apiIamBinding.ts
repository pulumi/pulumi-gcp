...
export class ApiIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.apigateway.ApiIamBindingCondition | undefined>;
    /**
...
export interface ApiIamBindingState {
    ...
    condition?: pulumi.Input<inputs.apigateway.ApiIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
