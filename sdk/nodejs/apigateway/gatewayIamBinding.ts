...
export class GatewayIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.apigateway.GatewayIamBindingCondition | undefined>;
    /**
...
export interface GatewayIamBindingState {
    condition?: pulumi.Input<inputs.apigateway.GatewayIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
