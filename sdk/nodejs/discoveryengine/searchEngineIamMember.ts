 ...
 */
export class SearchEngineIamMember extends pulumi.CustomResource {
    /**
     * Get an existing SearchEngineIamMember resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SearchEngineIamMemberState, opts?: pulumi.CustomResourceOptions): SearchEngineIamMember {
        return new SearchEngineIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:discoveryengine/searchEngineIamMember:SearchEngineIamMember';

    /**
     * Returns true if the given object is an instance of SearchEngineIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SearchEngineIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SearchEngineIamMember.__pulumiType;
    }
    ...
    declare public readonly condition: pulumi.Output<outputs.discoveryengine.SearchEngineIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    ...
    /**
     * Create a SearchEngineIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SearchEngineIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SearchEngineIamMemberArgs | SearchEngineIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SearchEngineIamMemberState | undefined;
            ...
            const args = argsOrState as SearchEngineIamMemberArgs | undefined;
        ...
        super(SearchEngineIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SearchEngineIamMemberState {
    /**
     * The collection ID.
     * Used to find the parent resource to bind the IAM policy to
     */
    collectionId?: pulumi.Input<string | undefined>;
    condition?: pulumi.Input<inputs.discoveryengine.SearchEngineIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface SearchEngineIamMemberArgs {
    /**
     * The collection ID.
     * Used to find the parent resource to bind the IAM policy to
     */
