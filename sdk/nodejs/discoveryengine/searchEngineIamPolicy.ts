 ...
 */
export class SearchEngineIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SearchEngineIamPolicyState, opts?: pulumi.CustomResourceOptions): SearchEngineIamPolicy {
        return new SearchEngineIamPolicy(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:discoveryengine/searchEngineIamPolicy:SearchEngineIamPolicy';

    /**
     * Returns true if the given object is an instance of SearchEngineIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SearchEngineIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SearchEngineIamPolicy.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: SearchEngineIamPolicyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: SearchEngineIamPolicyArgs | SearchEngineIamPolicyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SearchEngineIamPolicyState | undefined;
            ...
            const args = argsOrState as SearchEngineIamPolicyArgs | undefined;
        ...
        super(SearchEngineIamPolicy.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface SearchEngineIamPolicyState {
    /**
     * The collection ID.
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface SearchEngineIamPolicyArgs {
    /**
     * The collection ID.
     * Used to find the parent resource to bind the IAM policy to
     */
