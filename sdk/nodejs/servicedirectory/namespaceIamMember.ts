...
export class NamespaceIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.servicedirectory.NamespaceIamMemberCondition | undefined>;
    /**
...
export interface NamespaceIamMemberState {
    condition?: pulumi.Input<inputs.servicedirectory.NamespaceIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
