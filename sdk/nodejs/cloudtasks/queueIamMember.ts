...
export class QueueIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: QueueIamMemberState, opts?: pulumi.CustomResourceOptions): QueueIamMember {
        return new QueueIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:cloudtasks/queueIamMember:QueueIamMember';
    ...
    public readonly condition!: pulumi.Output<outputs.cloudtasks.QueueIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: QueueIamMemberArgs | QueueIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as QueueIamMemberState | undefined;
            ...
            const args = argsOrState as QueueIamMemberArgs | undefined;
        ...
        super(QueueIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
