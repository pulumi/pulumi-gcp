...
export class ServiceIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.endpoints.ServiceIamBindingCondition | undefined>;
    /**
...
export interface ServiceIamBindingState {
    condition?: pulumi.Input<inputs.endpoints.ServiceIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
