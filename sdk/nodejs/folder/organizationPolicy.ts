...
export class OrganizationPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly booleanPolicy: pulumi.Output<outputs.folder.OrganizationPolicyBooleanPolicy | undefined>;
    /**
     ...
     */
    declare public readonly listPolicy: pulumi.Output<outputs.folder.OrganizationPolicyListPolicy | undefined>;
    /**
     ...
     */
    declare public readonly restorePolicy: pulumi.Output<outputs.folder.OrganizationPolicyRestorePolicy | undefined>;
    /**
...
export interface OrganizationPolicyState {
     ...
     * A boolean policy is a constraint that is either enforced or not. Structure is documented below.
     */
    booleanPolicy?: pulumi.Input<inputs.folder.OrganizationPolicyBooleanPolicy | undefined>;
    /**
     * The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://docs.cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
     *
     * - - -
     ...
     * can also be used to allow or deny all values. Structure is documented below.
     */
    listPolicy?: pulumi.Input<inputs.folder.OrganizationPolicyListPolicy | undefined>;
    /**
     * A restore policy is a constraint to restore the default policy. Structure is documented below.
     *
     * > **Note:** If none of [`booleanPolicy`, `listPolicy`, `restorePolicy`] are defined the policy for a given constraint will
     * effectively be unset. This is represented in the UI as the constraint being 'Inherited'.
     */
    restorePolicy?: pulumi.Input<inputs.folder.OrganizationPolicyRestorePolicy | undefined>;
    /**
     * (Computed) The timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds, representing when the variable was last updated. Example: "2016-10-09T12:33:37.578138407Z".
     */
