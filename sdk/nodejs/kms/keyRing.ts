...
export class KeyRing extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: KeyRingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: KeyRingArgs | KeyRingState, opts?: pulumi.ResourceOptions) {
