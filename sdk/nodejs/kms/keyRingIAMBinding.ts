...
export class KeyRingIAMBinding extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: KeyRingIAMBindingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: KeyRingIAMBindingArgs | KeyRingIAMBindingState, opts?: pulumi.ResourceOptions) {
