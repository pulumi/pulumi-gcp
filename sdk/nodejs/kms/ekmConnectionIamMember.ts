 ...
 */
export class EkmConnectionIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EkmConnectionIamMemberState, opts?: pulumi.CustomResourceOptions): EkmConnectionIamMember {
        return new EkmConnectionIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:kms/ekmConnectionIamMember:EkmConnectionIamMember';

    /**
     * Returns true if the given object is an instance of EkmConnectionIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EkmConnectionIamMember {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.kms.EkmConnectionIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EkmConnectionIamMemberArgs | EkmConnectionIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EkmConnectionIamMemberState | undefined;
            ...
            const args = argsOrState as EkmConnectionIamMemberArgs | undefined;
