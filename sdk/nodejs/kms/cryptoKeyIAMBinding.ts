...
export class CryptoKeyIAMBinding extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: CryptoKeyIAMBindingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: CryptoKeyIAMBindingArgs | CryptoKeyIAMBindingState, opts?: pulumi.ResourceOptions) {
