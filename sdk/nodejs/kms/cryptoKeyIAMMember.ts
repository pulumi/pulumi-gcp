...
export class CryptoKeyIAMMember extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: CryptoKeyIAMMemberArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: CryptoKeyIAMMemberArgs | CryptoKeyIAMMemberState, opts?: pulumi.ResourceOptions) {
