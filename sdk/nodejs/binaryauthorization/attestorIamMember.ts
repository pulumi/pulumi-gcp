...
export class AttestorIamMember extends pulumi.CustomResource {
     ...
     */
    declare public readonly attestor: pulumi.Output<string>;
    declare public readonly condition: pulumi.Output<outputs.binaryauthorization.AttestorIamMemberCondition | undefined>;
    /**
