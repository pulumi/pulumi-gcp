...
export class RestorePlanIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.gkebackup.RestorePlanIamMemberCondition | undefined>;
    /**
...
export interface RestorePlanIamMemberState {
    condition?: pulumi.Input<inputs.gkebackup.RestorePlanIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
