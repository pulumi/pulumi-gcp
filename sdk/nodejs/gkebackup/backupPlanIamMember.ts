 ...
 */
export class BackupPlanIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackupPlanIamMemberState, opts?: pulumi.CustomResourceOptions): BackupPlanIamMember {
        return new BackupPlanIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:gkebackup/backupPlanIamMember:BackupPlanIamMember';

    /**
     * Returns true if the given object is an instance of BackupPlanIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is BackupPlanIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.gkebackup.BackupPlanIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: BackupPlanIamMemberArgs | BackupPlanIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BackupPlanIamMemberState | undefined;
            ...
            const args = argsOrState as BackupPlanIamMemberArgs | undefined;
...
export interface BackupPlanIamMemberState {
    condition?: pulumi.Input<inputs.gkebackup.BackupPlanIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
