...
export class DataPolicyIamBinding extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.bigquerydatapolicy.DataPolicyIamBindingCondition | undefined>;
    /**
...
export interface DataPolicyIamBindingState {
    condition?: pulumi.Input<inputs.bigquerydatapolicy.DataPolicyIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
