...
export class FunctionIamBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp:cloudfunctionsv2/functionIamBinding:FunctionIamBinding';
    ...
    declare public readonly condition: pulumi.Output<outputs.cloudfunctionsv2.FunctionIamBindingCondition | undefined>;
    /**
...
export interface FunctionIamBindingState {
     ...
     * Used to find the parent resource to bind the IAM policy to
     */
    cloudFunction?: pulumi.Input<string | undefined>;
    condition?: pulumi.Input<inputs.cloudfunctionsv2.FunctionIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
