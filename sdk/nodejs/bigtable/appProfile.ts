...
export class AppProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp:bigtable/appProfile:AppProfile';
...
export interface AppProfileState {
     ...
     * Structure is documented below.
     */
    singleClusterRouting?: pulumi.Input<inputs.bigtable.AppProfileSingleClusterRouting | undefined>;
    /**
     * The standard options used for isolating this app profile's traffic from other use cases.
     * Structure is documented below.
     */
    standardIsolation?: pulumi.Input<inputs.bigtable.AppProfileStandardIsolation | undefined>;
}
