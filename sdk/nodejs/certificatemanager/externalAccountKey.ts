 ...
 *
 * const prod = new gcp.certificatemanager.ExternalAccountKey("prod", {project: "my-project-name"});
 * ```
 *
 * ## Import
 *
 ...
 */
export class ExternalAccountKey extends pulumi.CustomResource {
    /**
     * Get an existing ExternalAccountKey resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExternalAccountKeyState, opts?: pulumi.CustomResourceOptions): ExternalAccountKey {
        return new ExternalAccountKey(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:certificatemanager/externalAccountKey:ExternalAccountKey';

    /**
     * Returns true if the given object is an instance of ExternalAccountKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ExternalAccountKey {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ExternalAccountKey.__pulumiType;
    }
    ...
    /**
     * Create a ExternalAccountKey resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: ExternalAccountKeyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ExternalAccountKeyArgs | ExternalAccountKeyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ExternalAccountKeyState | undefined;
            ...
            const args = argsOrState as ExternalAccountKeyArgs | undefined;
        ...
        super(ExternalAccountKey.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ExternalAccountKey resources.
 */
export interface ExternalAccountKeyState {
    /**
     * Base64-URL-encoded HS256 key. It is generated by the PublicCertificateAuthorityService
     * when the ExternalAccountKey is created.
     * **Note**: This property is sensitive and will not be displayed in the plan.
...
/**
 * The set of arguments for constructing a ExternalAccountKey resource.
 */
export interface ExternalAccountKeyArgs {
    /**
     * Location for the externalAccountKey. Currently only `global` is supported.
     */
    location?: pulumi.Input<string>;
