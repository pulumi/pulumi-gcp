...
export class TcpRoute extends pulumi.CustomResource {
     ...
     */
    declare public readonly rules: pulumi.Output<outputs.networkservices.TcpRouteRule[]>;
    /**
...
export interface TcpRouteState {
     ...
     * Structure is documented below.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.networkservices.TcpRouteRule>[] | undefined>;
    /**
     * Server-defined URL of this resource.
     */
