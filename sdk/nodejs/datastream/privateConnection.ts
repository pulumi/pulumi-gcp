...
export class PrivateConnection extends pulumi.CustomResource {
     ...
     * Structure is documented below.
     */
    public readonly pscInterfaceConfig!: pulumi.Output<outputs.datastream.PrivateConnectionPscInterfaceConfig | undefined>;
    /**
     ...
     * Structure is documented below.
     */
    public readonly vpcPeeringConfig!: pulumi.Output<outputs.datastream.PrivateConnectionVpcPeeringConfig | undefined>;
    ...
    constructor(name: string, argsOrState?: PrivateConnectionArgs | PrivateConnectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["pscInterfaceConfig"] = state ? state.pscInterfaceConfig : undefined;
            ...
            resourceInputs["pscInterfaceConfig"] = args ? args.pscInterfaceConfig : undefined;
