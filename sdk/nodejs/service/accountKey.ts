 ...
 * 
 * const google_service_account_myaccount = new gcp.service.Account("myaccount", {
 *     accountId: "myaccount",
 *     displayName: "My Service Account",
 * });
 * const google_service_account_key_mykey = new gcp.service.AccountKey("mykey", {
 *     publicKeyType: "TYPE_X509_PEM_FILE",
 *     serviceAccountId: google_service_account_myaccount.name,
 * });
 * ```
 */
export class AccountKey extends pulumi.CustomResource {
    /**
     * Get an existing AccountKey resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountKeyState, opts?: pulumi.CustomResourceOptions): AccountKey {
        return new AccountKey(name, <any>state, { ...opts, id: id });
    }
    ...
    /**
     * Create a AccountKey resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AccountKeyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccountKeyArgs | AccountKeyState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state: AccountKeyState = argsOrState as AccountKeyState | undefined;
            ...
            const args = argsOrState as AccountKeyArgs | undefined;
        ...
        super("gcp:service/accountKey:AccountKey", name, inputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering AccountKey resources.
 */
...
/**
 * The set of arguments for constructing a AccountKey resource.
 */
export interface AccountKeyArgs {
    /**
     * The algorithm used to generate the key. KEY_ALG_RSA_2048 is the default algorithm.
     * Valid values are listed at
     * [ServiceAccountPrivateKeyType](https://cloud.google.com/iam/reference/rest/v1/projects.serviceAccounts.keys#ServiceAccountKeyAlgorithm)
