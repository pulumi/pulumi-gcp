 ...
 */
export class MetastoreTableIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetastoreTableIamMemberState, opts?: pulumi.CustomResourceOptions): MetastoreTableIamMember {
        return new MetastoreTableIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataproc/metastoreTableIamMember:MetastoreTableIamMember';

    /**
     * Returns true if the given object is an instance of MetastoreTableIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MetastoreTableIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataproc.MetastoreTableIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MetastoreTableIamMemberArgs | MetastoreTableIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetastoreTableIamMemberState | undefined;
            ...
            const args = argsOrState as MetastoreTableIamMemberArgs | undefined;
...
export interface MetastoreTableIamMemberState {
    condition?: pulumi.Input<inputs.dataproc.MetastoreTableIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
