 ...
 */
export class MetastoreTableIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetastoreTableIamBindingState, opts?: pulumi.CustomResourceOptions): MetastoreTableIamBinding {
        return new MetastoreTableIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataproc/metastoreTableIamBinding:MetastoreTableIamBinding';

    /**
     * Returns true if the given object is an instance of MetastoreTableIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MetastoreTableIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataproc.MetastoreTableIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MetastoreTableIamBindingArgs | MetastoreTableIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetastoreTableIamBindingState | undefined;
            ...
            const args = argsOrState as MetastoreTableIamBindingArgs | undefined;
