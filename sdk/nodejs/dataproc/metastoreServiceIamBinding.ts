 ...
 */
export class MetastoreServiceIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetastoreServiceIamBindingState, opts?: pulumi.CustomResourceOptions): MetastoreServiceIamBinding {
        return new MetastoreServiceIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataproc/metastoreServiceIamBinding:MetastoreServiceIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is MetastoreServiceIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataproc.MetastoreServiceIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MetastoreServiceIamBindingArgs | MetastoreServiceIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetastoreServiceIamBindingState | undefined;
            ...
            const args = argsOrState as MetastoreServiceIamBindingArgs | undefined;
...
export interface MetastoreServiceIamBindingState {
    condition?: pulumi.Input<inputs.dataproc.MetastoreServiceIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
