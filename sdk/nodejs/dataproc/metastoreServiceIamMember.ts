 ...
 */
export class MetastoreServiceIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetastoreServiceIamMemberState, opts?: pulumi.CustomResourceOptions): MetastoreServiceIamMember {
        return new MetastoreServiceIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataproc/metastoreServiceIamMember:MetastoreServiceIamMember';
     ...
     */
    public static isInstance(obj: any): obj is MetastoreServiceIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataproc.MetastoreServiceIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MetastoreServiceIamMemberArgs | MetastoreServiceIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetastoreServiceIamMemberState | undefined;
            ...
            const args = argsOrState as MetastoreServiceIamMemberArgs | undefined;
...
export interface MetastoreServiceIamMemberState {
    condition?: pulumi.Input<inputs.dataproc.MetastoreServiceIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
