 ...
 * ```
 */
export function getMetastoreTableIamPolicy(args: GetMetastoreTableIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetMetastoreTableIamPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("gcp:dataproc/getMetastoreTableIamPolicy:getMetastoreTableIamPolicy", {
 ...
 */
export interface GetMetastoreTableIamPolicyResult {
 ...
 * ```
 */
export function getMetastoreTableIamPolicyOutput(args: GetMetastoreTableIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMetastoreTableIamPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("gcp:dataproc/getMetastoreTableIamPolicy:getMetastoreTableIamPolicy", {
        "databaseId": args.databaseId,
        "location": args.location,
        "project": args.project,
        "serviceId": args.serviceId,
