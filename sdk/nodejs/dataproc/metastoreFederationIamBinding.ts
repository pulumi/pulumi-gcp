 ...
 */
export class MetastoreFederationIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetastoreFederationIamBindingState, opts?: pulumi.CustomResourceOptions): MetastoreFederationIamBinding {
        return new MetastoreFederationIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataproc/metastoreFederationIamBinding:MetastoreFederationIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is MetastoreFederationIamBinding {
    ...
    public readonly condition!: pulumi.Output<outputs.dataproc.MetastoreFederationIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: MetastoreFederationIamBindingArgs | MetastoreFederationIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MetastoreFederationIamBindingState | undefined;
            ...
            const args = argsOrState as MetastoreFederationIamBindingArgs | undefined;
        ...
        super(MetastoreFederationIamBinding.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
