...
export class AddressGroupIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AddressGroupIamBindingState, opts?: pulumi.CustomResourceOptions): AddressGroupIamBinding {
        return new AddressGroupIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:networksecurity/addressGroupIamBinding:AddressGroupIamBinding';
    ...
    declare public readonly condition: pulumi.Output<outputs.networksecurity.AddressGroupIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AddressGroupIamBindingArgs | AddressGroupIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AddressGroupIamBindingState | undefined;
            ...
            const args = argsOrState as AddressGroupIamBindingArgs | undefined;
