...
export interface MirroringEndpointGroupAssociationState {
     ...
     * Structure is documented below.
     */
    locations?: pulumi.Input<pulumi.Input<inputs.networksecurity.MirroringEndpointGroupAssociationLocation>[] | undefined>;
    /**
     * (Deprecated)
     * The list of locations where the association is present. This information
     * is retrieved from the linked endpoint group, and not configured as part
     ...
     * @deprecated `locationsDetails` is deprecated and will be removed in a future major release. Use `locations` instead.
     */
    locationsDetails?: pulumi.Input<pulumi.Input<inputs.networksecurity.MirroringEndpointGroupAssociationLocationsDetail>[] | undefined>;
    /**
     * The endpoint group that this association is connected to, for example:
     * `projects/123456789/locations/global/mirroringEndpointGroups/my-eg`.
     * See https://google.aip.dev/124.
     */
    mirroringEndpointGroup?: pulumi.Input<string | undefined>;
    /**
     * The ID to use for the new association, which will become the final
     * component of the endpoint group's resource name. If not provided, the
     * server will generate a unique ID.
     */
    mirroringEndpointGroupAssociationId?: pulumi.Input<string | undefined>;
    /**
     * The resource name of this endpoint group association, for example:
     * `projects/123456789/locations/global/mirroringEndpointGroupAssociations/my-eg-association`.
     * See https://google.aip.dev/122 for more details.
