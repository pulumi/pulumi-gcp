 ...
 * ```
 */
export class MirroringEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MirroringEndpointState, opts?: pulumi.CustomResourceOptions): MirroringEndpoint {
        return new MirroringEndpoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:networksecurity/mirroringEndpoint:MirroringEndpoint';

    /**
     * Returns true if the given object is an instance of MirroringEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MirroringEndpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === MirroringEndpoint.__pulumiType;
    }
     ...
     */
    declare public readonly mirroringEndpointId: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: MirroringEndpointArgs | MirroringEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["mirroringEndpointId"] = state?.mirroringEndpointId;
            ...
            const args = argsOrState as MirroringEndpointArgs | undefined;
            ...
            resourceInputs["mirroringEndpointId"] = args?.mirroringEndpointId;
        ...
        super(MirroringEndpoint.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface MirroringEndpointState {
     ...
     * component of the endpoint's resource name.
     */
    mirroringEndpointId?: pulumi.Input<string | undefined>;
    /**
     * The resource name of this endpoint, for example:
     * `projects/123456789/locations/us-central1-a/mirroringEndpoints/my-endpoint`.
     * See https://google.aip.dev/122 for more details.
