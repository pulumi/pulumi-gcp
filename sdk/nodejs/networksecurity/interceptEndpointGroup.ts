...
export class InterceptEndpointGroup extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly associations: pulumi.Output<outputs.networksecurity.InterceptEndpointGroupAssociation[]>;
    /**
     * The endpoint group's view of a connected deployment group.
     * Structure is documented below.
     */
    declare public /*out*/ readonly connectedDeploymentGroups: pulumi.Output<outputs.networksecurity.InterceptEndpointGroupConnectedDeploymentGroup[]>;
    /**
     ...
     */
    declare public readonly interceptDeploymentGroup: pulumi.Output<string>;
    /**
     * The ID to use for the endpoint group, which will become the final component
     * of the endpoint group's resource name.
     */
    declare public readonly interceptEndpointGroupId: pulumi.Output<string>;
    /**
...
export interface InterceptEndpointGroupState {
     ...
     * Structure is documented below.
     */
    associations?: pulumi.Input<pulumi.Input<inputs.networksecurity.InterceptEndpointGroupAssociation>[] | undefined>;
    /**
     * The endpoint group's view of a connected deployment group.
     * Structure is documented below.
     */
    connectedDeploymentGroups?: pulumi.Input<pulumi.Input<inputs.networksecurity.InterceptEndpointGroupConnectedDeploymentGroup>[] | undefined>;
    /**
     * The timestamp when the resource was created.
     * See https://google.aip.dev/148#timestamps.
     */
     ...
     * See https://google.aip.dev/124.
     */
    interceptDeploymentGroup?: pulumi.Input<string | undefined>;
    /**
     * The ID to use for the endpoint group, which will become the final component
     * of the endpoint group's resource name.
     */
    interceptEndpointGroupId?: pulumi.Input<string | undefined>;
    /**
     * Labels are key/value pairs that help to organize and filter resources.
     * **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
     * Please refer to the field `effectiveLabels` for all of the labels present on the resource.
