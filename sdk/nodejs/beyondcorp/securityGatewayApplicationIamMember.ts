 ...
 */
export class SecurityGatewayApplicationIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityGatewayApplicationIamMemberState, opts?: pulumi.CustomResourceOptions): SecurityGatewayApplicationIamMember {
        return new SecurityGatewayApplicationIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:beyondcorp/securityGatewayApplicationIamMember:SecurityGatewayApplicationIamMember';
     ...
     */
    public static isInstance(obj: any): obj is SecurityGatewayApplicationIamMember {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.beyondcorp.SecurityGatewayApplicationIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SecurityGatewayApplicationIamMemberArgs | SecurityGatewayApplicationIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecurityGatewayApplicationIamMemberState | undefined;
            ...
            const args = argsOrState as SecurityGatewayApplicationIamMemberArgs | undefined;
