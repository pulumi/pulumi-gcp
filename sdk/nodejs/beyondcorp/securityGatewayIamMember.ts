 ...
 */
export class SecurityGatewayIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityGatewayIamMemberState, opts?: pulumi.CustomResourceOptions): SecurityGatewayIamMember {
        return new SecurityGatewayIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:beyondcorp/securityGatewayIamMember:SecurityGatewayIamMember';

    /**
     * Returns true if the given object is an instance of SecurityGatewayIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SecurityGatewayIamMember {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.beyondcorp.SecurityGatewayIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SecurityGatewayIamMemberArgs | SecurityGatewayIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecurityGatewayIamMemberState | undefined;
            ...
            const args = argsOrState as SecurityGatewayIamMemberArgs | undefined;
