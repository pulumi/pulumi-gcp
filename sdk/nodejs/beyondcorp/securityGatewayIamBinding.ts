 ...
 */
export class SecurityGatewayIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityGatewayIamBindingState, opts?: pulumi.CustomResourceOptions): SecurityGatewayIamBinding {
        return new SecurityGatewayIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:beyondcorp/securityGatewayIamBinding:SecurityGatewayIamBinding';
     ...
     */
    public static isInstance(obj: any): obj is SecurityGatewayIamBinding {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.beyondcorp.SecurityGatewayIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SecurityGatewayIamBindingArgs | SecurityGatewayIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SecurityGatewayIamBindingState | undefined;
            ...
            const args = argsOrState as SecurityGatewayIamBindingArgs | undefined;
