 ...
 */
export class HiveCatalogIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HiveCatalogIamMemberState, opts?: pulumi.CustomResourceOptions): HiveCatalogIamMember {
        return new HiveCatalogIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/hiveCatalogIamMember:HiveCatalogIamMember';

    /**
     * Returns true if the given object is an instance of HiveCatalogIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HiveCatalogIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HiveCatalogIamMember.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.biglake.HiveCatalogIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: HiveCatalogIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HiveCatalogIamMemberArgs | HiveCatalogIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HiveCatalogIamMemberState | undefined;
            ...
            const args = argsOrState as HiveCatalogIamMemberArgs | undefined;
        ...
        super(HiveCatalogIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface HiveCatalogIamMemberState {
    condition?: pulumi.Input<inputs.biglake.HiveCatalogIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface HiveCatalogIamMemberArgs {
    condition?: pulumi.Input<inputs.biglake.HiveCatalogIamMemberCondition | undefined>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
