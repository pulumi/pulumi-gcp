 ...
 */
export class HiveDatabaseIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HiveDatabaseIamMemberState, opts?: pulumi.CustomResourceOptions): HiveDatabaseIamMember {
        return new HiveDatabaseIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/hiveDatabaseIamMember:HiveDatabaseIamMember';

    /**
     * Returns true if the given object is an instance of HiveDatabaseIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HiveDatabaseIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HiveDatabaseIamMember.__pulumiType;
    }
    ...
    declare public readonly condition: pulumi.Output<outputs.biglake.HiveDatabaseIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: HiveDatabaseIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HiveDatabaseIamMemberArgs | HiveDatabaseIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HiveDatabaseIamMemberState | undefined;
            ...
            const args = argsOrState as HiveDatabaseIamMemberArgs | undefined;
        ...
        super(HiveDatabaseIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface HiveDatabaseIamMemberState {
    /**
     * Hive catalog where the database to create is located.
     * Used to find the parent resource to bind the IAM policy to
     */
    catalog?: pulumi.Input<string | undefined>;
    condition?: pulumi.Input<inputs.biglake.HiveDatabaseIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface HiveDatabaseIamMemberArgs {
    /**
     * Hive catalog where the database to create is located.
     * Used to find the parent resource to bind the IAM policy to
     */
