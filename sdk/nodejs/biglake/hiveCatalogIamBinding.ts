 ...
 */
export class HiveCatalogIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing HiveCatalogIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HiveCatalogIamBindingState, opts?: pulumi.CustomResourceOptions): HiveCatalogIamBinding {
        return new HiveCatalogIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/hiveCatalogIamBinding:HiveCatalogIamBinding';

    /**
     * Returns true if the given object is an instance of HiveCatalogIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HiveCatalogIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HiveCatalogIamBinding.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.biglake.HiveCatalogIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a HiveCatalogIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: HiveCatalogIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HiveCatalogIamBindingArgs | HiveCatalogIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HiveCatalogIamBindingState | undefined;
            ...
            const args = argsOrState as HiveCatalogIamBindingArgs | undefined;
        ...
        super(HiveCatalogIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface HiveCatalogIamBindingState {
    condition?: pulumi.Input<inputs.biglake.HiveCatalogIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface HiveCatalogIamBindingArgs {
    condition?: pulumi.Input<inputs.biglake.HiveCatalogIamBindingCondition | undefined>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
