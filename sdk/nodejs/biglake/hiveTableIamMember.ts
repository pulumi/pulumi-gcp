 ...
 */
export class HiveTableIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HiveTableIamMemberState, opts?: pulumi.CustomResourceOptions): HiveTableIamMember {
        return new HiveTableIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/hiveTableIamMember:HiveTableIamMember';

    /**
     * Returns true if the given object is an instance of HiveTableIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HiveTableIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.biglake.HiveTableIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: HiveTableIamMemberArgs | HiveTableIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HiveTableIamMemberState | undefined;
            ...
            const args = argsOrState as HiveTableIamMemberArgs | undefined;
