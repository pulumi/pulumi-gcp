 ...
 */
export class IcebergTableIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing IcebergTableIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergTableIamBindingState, opts?: pulumi.CustomResourceOptions): IcebergTableIamBinding {
        return new IcebergTableIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/icebergTableIamBinding:IcebergTableIamBinding';

    /**
     * Returns true if the given object is an instance of IcebergTableIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IcebergTableIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IcebergTableIamBinding.__pulumiType;
    }
    ...
    declare public readonly condition: pulumi.Output<outputs.biglake.IcebergTableIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a IcebergTableIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IcebergTableIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IcebergTableIamBindingArgs | IcebergTableIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IcebergTableIamBindingState | undefined;
            ...
            const args = argsOrState as IcebergTableIamBindingArgs | undefined;
        ...
        super(IcebergTableIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IcebergTableIamBindingState {
    /**
     * The name of the IcebergCatalog.
     * Used to find the parent resource to bind the IAM policy to
     */
    catalog?: pulumi.Input<string | undefined>;
    condition?: pulumi.Input<inputs.biglake.IcebergTableIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface IcebergTableIamBindingArgs {
    /**
     * The name of the IcebergCatalog.
     * Used to find the parent resource to bind the IAM policy to
     */
