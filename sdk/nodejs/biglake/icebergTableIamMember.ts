 ...
 */
export class IcebergTableIamMember extends pulumi.CustomResource {
    /**
     * Get an existing IcebergTableIamMember resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergTableIamMemberState, opts?: pulumi.CustomResourceOptions): IcebergTableIamMember {
        return new IcebergTableIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/icebergTableIamMember:IcebergTableIamMember';

    /**
     * Returns true if the given object is an instance of IcebergTableIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IcebergTableIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IcebergTableIamMember.__pulumiType;
    }
    ...
    declare public readonly condition: pulumi.Output<outputs.biglake.IcebergTableIamMemberCondition | undefined>;
    /**
    ...
    /**
     * Create a IcebergTableIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IcebergTableIamMemberArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IcebergTableIamMemberArgs | IcebergTableIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IcebergTableIamMemberState | undefined;
            ...
            const args = argsOrState as IcebergTableIamMemberArgs | undefined;
        ...
        super(IcebergTableIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface IcebergTableIamMemberState {
    /**
     * The name of the IcebergCatalog.
     * Used to find the parent resource to bind the IAM policy to
     */
    catalog?: pulumi.Input<string | undefined>;
    condition?: pulumi.Input<inputs.biglake.IcebergTableIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
