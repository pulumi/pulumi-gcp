 ...
 */
export class HiveDatabaseIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HiveDatabaseIamBindingState, opts?: pulumi.CustomResourceOptions): HiveDatabaseIamBinding {
        return new HiveDatabaseIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/hiveDatabaseIamBinding:HiveDatabaseIamBinding';

    /**
     * Returns true if the given object is an instance of HiveDatabaseIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HiveDatabaseIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HiveDatabaseIamBinding.__pulumiType;
    }
    ...
    declare public readonly condition: pulumi.Output<outputs.biglake.HiveDatabaseIamBindingCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: HiveDatabaseIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: HiveDatabaseIamBindingArgs | HiveDatabaseIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as HiveDatabaseIamBindingState | undefined;
            ...
            const args = argsOrState as HiveDatabaseIamBindingArgs | undefined;
        ...
        super(HiveDatabaseIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface HiveDatabaseIamBindingState {
    /**
     * Hive catalog where the database to create is located.
     * Used to find the parent resource to bind the IAM policy to
     */
    catalog?: pulumi.Input<string | undefined>;
    condition?: pulumi.Input<inputs.biglake.HiveDatabaseIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface HiveDatabaseIamBindingArgs {
    /**
     * Hive catalog where the database to create is located.
     * Used to find the parent resource to bind the IAM policy to
     */
