 ...
 */
export class IcebergNamespaceIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergNamespaceIamMemberState, opts?: pulumi.CustomResourceOptions): IcebergNamespaceIamMember {
        return new IcebergNamespaceIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/icebergNamespaceIamMember:IcebergNamespaceIamMember';
     ...
     */
    public static isInstance(obj: any): obj is IcebergNamespaceIamMember {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IcebergNamespaceIamMember.__pulumiType;
    }
    ...
    declare public readonly condition: pulumi.Output<outputs.biglake.IcebergNamespaceIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: IcebergNamespaceIamMemberArgs | IcebergNamespaceIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IcebergNamespaceIamMemberState | undefined;
            ...
            const args = argsOrState as IcebergNamespaceIamMemberArgs | undefined;
        ...
        super(IcebergNamespaceIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
