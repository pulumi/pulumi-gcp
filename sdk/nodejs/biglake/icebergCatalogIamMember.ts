 ...
 */
export class IcebergCatalogIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergCatalogIamMemberState, opts?: pulumi.CustomResourceOptions): IcebergCatalogIamMember {
        return new IcebergCatalogIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:biglake/icebergCatalogIamMember:IcebergCatalogIamMember';

    /**
     * Returns true if the given object is an instance of IcebergCatalogIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IcebergCatalogIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.biglake.IcebergCatalogIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: IcebergCatalogIamMemberArgs | IcebergCatalogIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IcebergCatalogIamMemberState | undefined;
            ...
            const args = argsOrState as IcebergCatalogIamMemberArgs | undefined;
