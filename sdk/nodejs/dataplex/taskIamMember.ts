...
export class TaskIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataplex.TaskIamMemberCondition | undefined>;
    /**
...
export interface TaskIamMemberState {
    condition?: pulumi.Input<inputs.dataplex.TaskIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
