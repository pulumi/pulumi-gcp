 ...
 */
export class TaskIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TaskIamBindingState, opts?: pulumi.CustomResourceOptions): TaskIamBinding {
        return new TaskIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataplex/taskIamBinding:TaskIamBinding';

    /**
     * Returns true if the given object is an instance of TaskIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TaskIamBinding {
    ...
    constructor(name: string, argsOrState?: TaskIamBindingArgs | TaskIamBindingState, opts?: pulumi.CustomResourceOptions) {
...
export interface TaskIamBindingState {
    condition?: pulumi.Input<inputs.dataplex.TaskIamBindingCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
