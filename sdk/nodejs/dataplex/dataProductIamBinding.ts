 ...
 */
export class DataProductIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataProductIamBindingState, opts?: pulumi.CustomResourceOptions): DataProductIamBinding {
        return new DataProductIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataplex/dataProductIamBinding:DataProductIamBinding';

    /**
     * Returns true if the given object is an instance of DataProductIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataProductIamBinding {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataProductIamBinding.__pulumiType;
    }

    declare public readonly condition: pulumi.Output<outputs.dataplex.DataProductIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a DataProductIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DataProductIamBindingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DataProductIamBindingArgs | DataProductIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataProductIamBindingState | undefined;
            ...
            const args = argsOrState as DataProductIamBindingArgs | undefined;
        ...
        super(DataProductIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DataProductIamBindingState {
    condition?: pulumi.Input<inputs.dataplex.DataProductIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface DataProductIamBindingArgs {
    condition?: pulumi.Input<inputs.dataplex.DataProductIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
