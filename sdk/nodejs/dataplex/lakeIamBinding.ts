...
export class LakeIamBinding extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LakeIamBindingState, opts?: pulumi.CustomResourceOptions): LakeIamBinding {
        return new LakeIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataplex/lakeIamBinding:LakeIamBinding';
    ...
    declare public readonly condition: pulumi.Output<outputs.dataplex.LakeIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LakeIamBindingArgs | LakeIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LakeIamBindingState | undefined;
            ...
            const args = argsOrState as LakeIamBindingArgs | undefined;
