 ...
 *         principal: {
 *             googleGroup: "tf-test-analysts-_55438@example.com",
 *         },
 *     }],
 * });
 ...
 *     project: "my-project-name",
 *     location: "us-central1",
 *     dataProductId: "tf-test-dp-_49082",
 ...
 * const exampleDataset = new gcp.bigquery.Dataset("example", {
 *     project: "my-project-name",
 *     datasetId: "tf_test_dataset__60365",
 *     location: "us-central1",
 * });
 * const exampleDataAsset = new gcp.dataplex.DataAsset("example", {
 *     project: "my-project-name",
...
export interface DataAssetState {
     ...
     * Structure is documented below.
     */
    accessGroupConfigs?: pulumi.Input<pulumi.Input<inputs.dataplex.DataAssetAccessGroupConfig>[] | undefined>;
    /**
     * The ID of the data asset.
     */
