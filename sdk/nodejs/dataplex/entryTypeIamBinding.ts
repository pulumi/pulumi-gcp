 ...
 */
export class EntryTypeIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EntryTypeIamBindingState, opts?: pulumi.CustomResourceOptions): EntryTypeIamBinding {
        return new EntryTypeIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataplex/entryTypeIamBinding:EntryTypeIamBinding';

    /**
     * Returns true if the given object is an instance of EntryTypeIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EntryTypeIamBinding {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataplex.EntryTypeIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EntryTypeIamBindingArgs | EntryTypeIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as EntryTypeIamBindingState | undefined;
            ...
            const args = argsOrState as EntryTypeIamBindingArgs | undefined;
...
export interface EntryTypeIamBindingState {
    condition?: pulumi.Input<inputs.dataplex.EntryTypeIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    entryTypeId?: pulumi.Input<string | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
