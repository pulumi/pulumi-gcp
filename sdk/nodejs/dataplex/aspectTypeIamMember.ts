...
export class AspectTypeIamMember extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AspectTypeIamMemberState, opts?: pulumi.CustomResourceOptions): AspectTypeIamMember {
        return new AspectTypeIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataplex/aspectTypeIamMember:AspectTypeIamMember';
    ...
    constructor(name: string, argsOrState?: AspectTypeIamMemberArgs | AspectTypeIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AspectTypeIamMemberState | undefined;
            ...
            const args = argsOrState as AspectTypeIamMemberArgs | undefined;
        ...
        super(AspectTypeIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
