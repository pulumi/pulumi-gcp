 ...
 *     glossaryId: "tf-test-glossary_9106",
 ...
 *     location: "us-central1",
 *     termId: "tf-test-term-basic_27169",
 * });
 * ```
...
export class GlossaryTerm extends pulumi.CustomResource {
     ...
     */
    public readonly termId!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GlossaryTermArgs | GlossaryTermState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["termId"] = state ? state.termId : undefined;
            ...
            resourceInputs["termId"] = args ? args.termId : undefined;
