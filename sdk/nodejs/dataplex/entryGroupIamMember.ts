...
export class EntryGroupIamMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'gcp:dataplex/entryGroupIamMember:EntryGroupIamMember';
    ...
    public readonly condition!: pulumi.Output<outputs.dataplex.EntryGroupIamMemberCondition | undefined>;
    ...
    constructor(name: string, argsOrState?: EntryGroupIamMemberArgs | EntryGroupIamMemberState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EntryGroupIamMember.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
