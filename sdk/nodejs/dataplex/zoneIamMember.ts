...
export class ZoneIamMember extends pulumi.CustomResource {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataplex.ZoneIamMemberCondition | undefined>;
    /**
...
export interface ZoneIamMemberState {
    condition?: pulumi.Input<inputs.dataplex.ZoneIamMemberCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
