 ...
 */
export class GlossaryIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GlossaryIamMemberState, opts?: pulumi.CustomResourceOptions): GlossaryIamMember {
        return new GlossaryIamMember(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:dataplex/glossaryIamMember:GlossaryIamMember';

    /**
     * Returns true if the given object is an instance of GlossaryIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GlossaryIamMember {
    ...
    declare public readonly condition: pulumi.Output<outputs.dataplex.GlossaryIamMemberCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GlossaryIamMemberArgs | GlossaryIamMemberState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GlossaryIamMemberState | undefined;
            ...
            const args = argsOrState as GlossaryIamMemberArgs | undefined;
...
export interface GlossaryIamMemberState {
    condition?: pulumi.Input<inputs.dataplex.GlossaryIamMemberCondition | undefined>;
    /**
     * (Computed) The etag of the IAM policy.
     */
