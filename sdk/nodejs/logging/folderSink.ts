...
export class FolderSink extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: FolderSinkArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: FolderSinkArgs | FolderSinkState, opts?: pulumi.ResourceOptions) {
