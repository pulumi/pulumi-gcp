 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export class LogViewIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogViewIamBindingState, opts?: pulumi.CustomResourceOptions): LogViewIamBinding {
        return new LogViewIamBinding(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'gcp:logging/logViewIamBinding:LogViewIamBinding';

    /**
     * Returns true if the given object is an instance of LogViewIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LogViewIamBinding {
     ...
     */
    declare public readonly condition: pulumi.Output<outputs.logging.LogViewIamBindingCondition | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LogViewIamBindingArgs | LogViewIamBindingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LogViewIamBindingState | undefined;
            ...
            const args = argsOrState as LogViewIamBindingArgs | undefined;
