...
export class BillingAccountSink extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: BillingAccountSinkArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BillingAccountSinkArgs | BillingAccountSinkState, opts?: pulumi.ResourceOptions) {
