...
export class BucketACL extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: BucketACLArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BucketACLArgs | BucketACLState, opts?: pulumi.ResourceOptions) {
