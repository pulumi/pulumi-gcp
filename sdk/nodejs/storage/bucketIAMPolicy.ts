...
export class BucketIAMPolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: BucketIAMPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BucketIAMPolicyArgs | BucketIAMPolicyState, opts?: pulumi.ResourceOptions) {
