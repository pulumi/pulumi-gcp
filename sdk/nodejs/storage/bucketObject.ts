...
export class BucketObject extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: BucketObjectArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BucketObjectArgs | BucketObjectState, opts?: pulumi.ResourceOptions) {
