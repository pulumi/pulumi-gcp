...
export class ApiHubInstance extends pulumi.CustomResource {
     ...
     * are `/a-z[0-9]-_/`.
     */
    declare public readonly apiHubInstanceId: pulumi.Output<string | undefined>;
    /**
     * Available configurations to provision an ApiHub Instance.
     * Structure is documented below.
     */
    declare public readonly config: pulumi.Output<outputs.apihub.ApiHubInstanceConfig>;
    /**
    ...
    constructor(name: string, argsOrState?: ApiHubInstanceArgs | ApiHubInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["apiHubInstanceId"] = state?.apiHubInstanceId;
            ...
            resourceInputs["apiHubInstanceId"] = args?.apiHubInstanceId;
