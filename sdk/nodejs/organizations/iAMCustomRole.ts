...
export class IAMCustomRole extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: IAMCustomRoleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: IAMCustomRoleArgs | IAMCustomRoleState, opts?: pulumi.ResourceOptions) {
