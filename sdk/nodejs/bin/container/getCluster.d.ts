...
export interface GetClusterResult {
    ...
    readonly masterAuthorizedNetworksConfigs: {
        cidrBlocks: {
            cidrBlock: string;
            displayName: string;
        }[];
    ...
    readonly networkPolicies: {
        enabled: boolean;
        provider: string;
    }[];
    readonly nodeConfigs: {
        diskSizeGb: number;
        diskType: string;
        guestAccelerators: {
            count: number;
    ...
    readonly podSecurityPolicyConfigs: {
        enabled: boolean;
    }[];
    readonly privateCluster: boolean;
    readonly privateClusterConfigs: {
