 ...
 * ```
 */
export declare class ObjectAccessControl extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectAccessControlState, opts?: pulumi.CustomResourceOptions): ObjectAccessControl;
