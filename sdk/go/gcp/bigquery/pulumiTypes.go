...
// DatasetAccessInput is an input type that accepts DatasetAccessArgs and DatasetAccessOutput values.
// You can construct a concrete instance of `DatasetAccessInput` via:
//
// 		 DatasetAccessArgs{...}
//
