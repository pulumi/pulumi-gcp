...
func LookupDatasetIamPolicyOutput(ctx *pulumi.Context, args LookupDatasetIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupDatasetIamPolicyResultOutput {
	...
	return ctx.InvokeOutput("gcp:bigquery/getDatasetIamPolicy:getDatasetIamPolicy", args, LookupDatasetIamPolicyResultOutput{}, options).(LookupDatasetIamPolicyResultOutput)
}
