...
type Table struct {
	...
	GeneratedSchemaColumns    pulumi.StringOutput  `pulumi:"generatedSchemaColumns"`
	IgnoreAutoGeneratedSchema pulumi.BoolPtrOutput `pulumi:"ignoreAutoGeneratedSchema"`
...
type TableState struct {
	...
	// (Output-only) A list of autogenerated schema fields.
	GeneratedSchemaColumns    pulumi.StringPtrInput
	IgnoreAutoGeneratedSchema pulumi.BoolPtrInput
	// A list of fields which should be ignored for each column in schema.
	// **NOTE:** Right now only `dataPolicies` field is supported. We might support others in the future.
...
// (Output-only) A list of autogenerated schema fields.
func (o TableOutput) GeneratedSchemaColumns() pulumi.StringOutput {
	return o.ApplyT(func(v *Table) pulumi.StringOutput { return v.GeneratedSchemaColumns }).(pulumi.StringOutput)
}

func (o TableOutput) IgnoreAutoGeneratedSchema() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Table) pulumi.BoolPtrOutput { return v.IgnoreAutoGeneratedSchema }).(pulumi.BoolPtrOutput)
}
