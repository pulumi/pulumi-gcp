...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerConfigScalingConfigArrayInput)(nil)).Elem(), GameServerConfigScalingConfigArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerConfigScalingConfigScheduleInput)(nil)).Elem(), GameServerConfigScalingConfigScheduleArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerConfigScalingConfigScheduleArrayInput)(nil)).Elem(), GameServerConfigScalingConfigScheduleArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerConfigScalingConfigSelectorInput)(nil)).Elem(), GameServerConfigScalingConfigSelectorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerConfigScalingConfigSelectorArrayInput)(nil)).Elem(), GameServerConfigScalingConfigSelectorArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerDeploymentRolloutGameServerConfigOverrideInput)(nil)).Elem(), GameServerDeploymentRolloutGameServerConfigOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerDeploymentRolloutGameServerConfigOverrideArrayInput)(nil)).Elem(), GameServerDeploymentRolloutGameServerConfigOverrideArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerDeploymentRolloutGameServerConfigOverrideRealmsSelectorInput)(nil)).Elem(), GameServerDeploymentRolloutGameServerConfigOverrideRealmsSelectorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GameServerDeploymentRolloutGameServerConfigOverrideRealmsSelectorPtrInput)(nil)).Elem(), GameServerDeploymentRolloutGameServerConfigOverrideRealmsSelectorArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetGameServerDeploymentRolloutGameServerConfigOverrideInput)(nil)).Elem(), GetGameServerDeploymentRolloutGameServerConfigOverrideArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetGameServerDeploymentRolloutGameServerConfigOverrideArrayInput)(nil)).Elem(), GetGameServerDeploymentRolloutGameServerConfigOverrideArray{})
