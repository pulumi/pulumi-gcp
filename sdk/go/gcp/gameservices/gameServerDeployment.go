...
// Human readable description of the game server deployment.
func (o GameServerDeploymentOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GameServerDeployment) pulumi.StringPtrOutput { return v.Description }).(pulumi.StringPtrOutput)
}
...
// Location of the Deployment.
func (o GameServerDeploymentOutput) Location() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GameServerDeployment) pulumi.StringPtrOutput { return v.Location }).(pulumi.StringPtrOutput)
}
