...
func (o LookupConfigIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupConfigIamPolicyResult] {
	return pulumix.Output[LookupConfigIamPolicyResult]{
