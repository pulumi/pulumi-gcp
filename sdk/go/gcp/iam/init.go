...
func (m *module) Construct(ctx *pulumi.Context, name, typ, urn string) (r pulumi.Resource, err error) {
	...
	case "gcp:iam/workforcePoolProviderScimToken:WorkforcePoolProviderScimToken":
		r = &WorkforcePoolProviderScimToken{}
	...
	case "gcp:iam/workloadIdentityPoolManagedIdentity:WorkloadIdentityPoolManagedIdentity":
		r = &WorkloadIdentityPoolManagedIdentity{}
...
func init() {
	...
	pulumi.RegisterResourceModule(
		"gcp",
		"iam/workforcePoolProviderScimToken",
		&module{version},
	)
	pulumi.RegisterResourceModule(
		"gcp",
	...
	pulumi.RegisterResourceModule(
		"gcp",
		"iam/workloadIdentityPoolManagedIdentity",
		&module{version},
	)
	pulumi.RegisterResourceModule(
		"gcp",
		"iam/workloadIdentityPoolNamespace",
		&module{version},
	)
	pulumi.RegisterResourceModule(
		"gcp",
