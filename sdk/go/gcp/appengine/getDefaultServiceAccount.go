...
func GetDefaultServiceAccountOutput(ctx *pulumi.Context, args GetDefaultServiceAccountOutputArgs, opts ...pulumi.InvokeOption) GetDefaultServiceAccountResultOutput {
	...
	return ctx.InvokeOutput("gcp:appengine/getDefaultServiceAccount:getDefaultServiceAccount", args, GetDefaultServiceAccountResultOutput{}, options).(GetDefaultServiceAccountResultOutput)
}
