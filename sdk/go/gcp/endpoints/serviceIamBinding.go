...
// import (
//
//	"github.com/pulumi/pulumi-gcp/sdk/v10/go/gcp/endpoints"
...
// Used to find the parent resource to bind the IAM policy to
func (o ServiceIamBindingOutput) ServiceName() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceIamBinding) pulumi.StringOutput { return v.ServiceName }).(pulumi.StringOutput)
}
