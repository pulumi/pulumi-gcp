...
func (o LookupRegionalSecretResultOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v LookupRegionalSecretResult) string { return v.DeletionPolicy }).(pulumi.StringOutput)
}
