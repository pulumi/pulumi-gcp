...
func (o LookupNamespaceIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupNamespaceIamPolicyResult] {
	return pulumix.Output[LookupNamespaceIamPolicyResult]{
