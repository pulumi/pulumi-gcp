...
func LookupServiceIamPolicyOutput(ctx *pulumi.Context, args LookupServiceIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupServiceIamPolicyResultOutput {
	...
	return ctx.InvokeOutput("gcp:servicedirectory/getServiceIamPolicy:getServiceIamPolicy", args, LookupServiceIamPolicyResultOutput{}, options).(LookupServiceIamPolicyResultOutput)
}
