...
func (o LookupAutokeyConfigResultOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAutokeyConfigResult) string { return v.DeletionPolicy }).(pulumi.StringOutput)
}
...
func (o LookupAutokeyConfigResultOutput) KeyProjectResolutionMode() pulumi.StringOutput {
	return o.ApplyT(func(v LookupAutokeyConfigResult) string { return v.KeyProjectResolutionMode }).(pulumi.StringOutput)
}
