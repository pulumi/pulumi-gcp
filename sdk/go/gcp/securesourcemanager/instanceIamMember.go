...
func NewInstanceIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:securesourcemanager/instanceIamMember:InstanceIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamMember(ctx *pulumi.Context,
	...
	var resource InstanceIamMember
	err := ctx.ReadResource("gcp:securesourcemanager/instanceIamMember:InstanceIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o InstanceIamMemberOutput) InstanceId() pulumi.StringOutput {
	return o.ApplyT(func(v *InstanceIamMember) pulumi.StringOutput { return v.InstanceId }).(pulumi.StringOutput)
}
