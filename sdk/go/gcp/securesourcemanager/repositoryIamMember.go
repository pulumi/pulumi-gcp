...
func NewRepositoryIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:securesourcemanager/repositoryIamMember:RepositoryIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepositoryIamMember(ctx *pulumi.Context,
	...
	var resource RepositoryIamMember
	err := ctx.ReadResource("gcp:securesourcemanager/repositoryIamMember:RepositoryIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Used to find the parent resource to bind the IAM policy to
func (o RepositoryIamMemberOutput) RepositoryId() pulumi.StringOutput {
	return o.ApplyT(func(v *RepositoryIamMember) pulumi.StringOutput { return v.RepositoryId }).(pulumi.StringOutput)
}
