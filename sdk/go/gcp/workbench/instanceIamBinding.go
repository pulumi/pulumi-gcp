...
func NewInstanceIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:workbench/instanceIamBinding:InstanceIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceIamBinding(ctx *pulumi.Context,
	...
	var resource InstanceIamBinding
	err := ctx.ReadResource("gcp:workbench/instanceIamBinding:InstanceIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
