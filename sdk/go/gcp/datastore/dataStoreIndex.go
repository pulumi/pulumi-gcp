...
// create a `firestore.Database` resource with `locationId` set
...
// The index id.
func (o DataStoreIndexOutput) IndexId() pulumi.StringOutput {
	return o.ApplyT(func(v *DataStoreIndex) pulumi.StringOutput { return v.IndexId }).(pulumi.StringOutput)
}
...
// The ID of the project in which the resource belongs.
// If it is not provided, the provider project is used.
func (o DataStoreIndexOutput) Project() pulumi.StringOutput {
	return o.ApplyT(func(v *DataStoreIndex) pulumi.StringOutput { return v.Project }).(pulumi.StringOutput)
}

// An ordered list of properties to index on.
// Structure is documented below.
func (o DataStoreIndexOutput) Properties() DataStoreIndexPropertyArrayOutput {
	return o.ApplyT(func(v *DataStoreIndex) DataStoreIndexPropertyArrayOutput { return v.Properties }).(DataStoreIndexPropertyArrayOutput)
}
