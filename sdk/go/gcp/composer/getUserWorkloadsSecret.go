...
func (o LookupUserWorkloadsSecretResultOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v LookupUserWorkloadsSecretResult) string { return v.DeletionPolicy }).(pulumi.StringOutput)
}
