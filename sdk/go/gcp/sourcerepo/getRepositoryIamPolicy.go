...
// import (
//
//	"github.com/pulumi/pulumi-gcp/sdk/v10/go/gcp/sourcerepo"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func LookupRepositoryIamPolicyOutput(ctx *pulumi.Context, args LookupRepositoryIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupRepositoryIamPolicyResultOutput {
	...
	return ctx.InvokeOutput("gcp:sourcerepo/getRepositoryIamPolicy:getRepositoryIamPolicy", args, LookupRepositoryIamPolicyResultOutput{}, options).(LookupRepositoryIamPolicyResultOutput)
}
