...
func LookupServiceIamPolicyOutput(ctx *pulumi.Context, args LookupServiceIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupServiceIamPolicyResultOutput {
	...
	return ctx.InvokeOutput("gcp:cloudrunv2/getServiceIamPolicy:getServiceIamPolicy", args, LookupServiceIamPolicyResultOutput{}, options).(LookupServiceIamPolicyResultOutput)
}
