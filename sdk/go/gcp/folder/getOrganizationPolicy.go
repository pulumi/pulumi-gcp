...
func LookupOrganizationPolicyOutput(ctx *pulumi.Context, args LookupOrganizationPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupOrganizationPolicyResultOutput {
	...
	return ctx.InvokeOutput("gcp:folder/getOrganizationPolicy:getOrganizationPolicy", args, LookupOrganizationPolicyResultOutput{}, options).(LookupOrganizationPolicyResultOutput)
}
