...
//
// ***
func (o OrganizationPolicyOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v *OrganizationPolicy) pulumi.StringOutput { return v.DeletionPolicy }).(pulumi.StringOutput)
}
