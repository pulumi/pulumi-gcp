...
// management without updating or deleting the resource in the API.
// When set to "DELETE", deleting the resource is permitted.
func (o AiReasoningEngineOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v *AiReasoningEngine) pulumi.StringOutput { return v.DeletionPolicy }).(pulumi.StringOutput)
}
