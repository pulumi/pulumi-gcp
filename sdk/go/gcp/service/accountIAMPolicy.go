...
func NewAccountIAMPolicy(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	s, err := ctx.RegisterResource("gcp:service/accountIAMPolicy:AccountIAMPolicy", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetAccountIAMPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("gcp:service/accountIAMPolicy:AccountIAMPolicy", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AccountIAMPolicy{s: s}, nil
...
func (r *AccountIAMPolicy) ServiceAccountId() *pulumi.StringOutput {
