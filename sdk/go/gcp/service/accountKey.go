...
// NewAccountKey registers a new resource with the given unique name, arguments, and options.
func NewAccountKey(ctx *pulumi.Context,
	name string, args *AccountKeyArgs, opts ...pulumi.ResourceOpt) (*AccountKey, error) {
	...
	s, err := ctx.RegisterResource("gcp:service/accountKey:AccountKey", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AccountKey{s: s}, nil
}

// GetAccountKey gets an existing AccountKey resource's state with the given name, ID, and optional
// state properties that are used to uniquely qualify the lookup (nil if not required).
func GetAccountKey(ctx *pulumi.Context,
	name string, id pulumi.ID, state *AccountKeyState, opts ...pulumi.ResourceOpt) (*AccountKey, error) {
	inputs := make(map[string]interface{})
	if state != nil {
	...
	s, err := ctx.ReadResource("gcp:service/accountKey:AccountKey", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AccountKey{s: s}, nil
...
func (r *AccountKey) URN() *pulumi.URNOutput {
	return r.s.URN()
}

// ID is this resource's unique identifier assigned by its provider.
func (r *AccountKey) ID() *pulumi.IDOutput {
	return r.s.ID()
}
...
// (only used on create)
func (r *AccountKey) KeyAlgorithm() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["keyAlgorithm"])
}

// The name used for this key pair
func (r *AccountKey) Name() *pulumi.StringOutput {
...
// in Vault.
func (r *AccountKey) PgpKey() *pulumi.StringOutput {
...
// `pgp_key` is provided.
func (r *AccountKey) PrivateKey() *pulumi.StringOutput {
...
func (r *AccountKey) PrivateKeyEncrypted() *pulumi.StringOutput {
...
func (r *AccountKey) PrivateKeyFingerprint() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["privateKeyFingerprint"])
}

// The output format of the private key. TYPE_GOOGLE_CREDENTIALS_FILE is the default output format.
func (r *AccountKey) PrivateKeyType() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["privateKeyType"])
}

// The public key, base64 encoded
func (r *AccountKey) PublicKey() *pulumi.StringOutput {
	return (*pulumi.StringOutput)(r.s.State["publicKey"])
}

// The output format of the public key requested. X509_PEM is the default output format.
func (r *AccountKey) PublicKeyType() *pulumi.StringOutput {
