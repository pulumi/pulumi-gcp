...
// VolumeBlockDeviceInput is an input type that accepts VolumeBlockDeviceArgs and VolumeBlockDeviceOutput values.
// You can construct a concrete instance of `VolumeBlockDeviceInput` via:
//
//	VolumeBlockDeviceArgs{...}
type VolumeBlockDeviceInput interface {
	pulumi.Input

	ToVolumeBlockDeviceOutput() VolumeBlockDeviceOutput
	ToVolumeBlockDeviceOutputWithContext(context.Context) VolumeBlockDeviceOutput
}

type VolumeBlockDeviceArgs struct {
	// A list of host groups that identify hosts that can mount the block volume.
	// Format:
	// `projects/{project_id}/locations/{location}/hostGroups/{host_group_id}`
	// This field can be updated after the block device is created.
...
func (VolumeBlockDeviceArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeBlockDevice)(nil)).Elem()
}

func (i VolumeBlockDeviceArgs) ToVolumeBlockDeviceOutput() VolumeBlockDeviceOutput {
	return i.ToVolumeBlockDeviceOutputWithContext(context.Background())
}

func (i VolumeBlockDeviceArgs) ToVolumeBlockDeviceOutputWithContext(ctx context.Context) VolumeBlockDeviceOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeBlockDeviceOutput)
}

// VolumeBlockDeviceArrayInput is an input type that accepts VolumeBlockDeviceArray and VolumeBlockDeviceArrayOutput values.
// You can construct a concrete instance of `VolumeBlockDeviceArrayInput` via:
//
//	VolumeBlockDeviceArray{ VolumeBlockDeviceArgs{...} }
type VolumeBlockDeviceArrayInput interface {
	pulumi.Input

	ToVolumeBlockDeviceArrayOutput() VolumeBlockDeviceArrayOutput
	ToVolumeBlockDeviceArrayOutputWithContext(context.Context) VolumeBlockDeviceArrayOutput
}

type VolumeBlockDeviceArray []VolumeBlockDeviceInput

func (VolumeBlockDeviceArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]VolumeBlockDevice)(nil)).Elem()
}

func (i VolumeBlockDeviceArray) ToVolumeBlockDeviceArrayOutput() VolumeBlockDeviceArrayOutput {
	return i.ToVolumeBlockDeviceArrayOutputWithContext(context.Background())
}

func (i VolumeBlockDeviceArray) ToVolumeBlockDeviceArrayOutputWithContext(ctx context.Context) VolumeBlockDeviceArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeBlockDeviceArrayOutput)
}

type VolumeBlockDeviceOutput struct{ *pulumi.OutputState }

func (VolumeBlockDeviceOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeBlockDevice)(nil)).Elem()
}

func (o VolumeBlockDeviceOutput) ToVolumeBlockDeviceOutput() VolumeBlockDeviceOutput {
	return o
}

func (o VolumeBlockDeviceOutput) ToVolumeBlockDeviceOutputWithContext(ctx context.Context) VolumeBlockDeviceOutput {
	return o
}
...
// `projects/{project_id}/locations/{location}/hostGroups/{host_group_id}`
// This field can be updated after the block device is created.
func (o VolumeBlockDeviceOutput) HostGroups() pulumi.StringArrayOutput {
	return o.ApplyT(func(v VolumeBlockDevice) []string { return v.HostGroups }).(pulumi.StringArrayOutput)
}

// (Output)
// Device identifier of the Block volume. This represents lunSerialNumber
// for ISCSI volumes
func (o VolumeBlockDeviceOutput) Identifier() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeBlockDevice) *string { return v.Identifier }).(pulumi.StringPtrOutput)
}
...
//     and the following special characters: "-", "_", "}", "{", ".".
//   - Spaces are not allowed.
func (o VolumeBlockDeviceOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeBlockDevice) *string { return v.Name }).(pulumi.StringPtrOutput)
}

// The OS type of the volume.
// This field can't be changed after the block device is created.
// Possible values are: `LINUX`, `WINDOWS`, `ESXI`.
func (o VolumeBlockDeviceOutput) OsType() pulumi.StringOutput {
	return o.ApplyT(func(v VolumeBlockDevice) string { return v.OsType }).(pulumi.StringOutput)
}
...
// The block device's size is system-managed and will be set to match
// the parent Volume's `capacityGib`.
func (o VolumeBlockDeviceOutput) SizeGib() pulumi.IntPtrOutput {
	return o.ApplyT(func(v VolumeBlockDevice) *int { return v.SizeGib }).(pulumi.IntPtrOutput)
}

type VolumeBlockDeviceArrayOutput struct{ *pulumi.OutputState }

func (VolumeBlockDeviceArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]VolumeBlockDevice)(nil)).Elem()
}

func (o VolumeBlockDeviceArrayOutput) ToVolumeBlockDeviceArrayOutput() VolumeBlockDeviceArrayOutput {
	return o
}

func (o VolumeBlockDeviceArrayOutput) ToVolumeBlockDeviceArrayOutputWithContext(ctx context.Context) VolumeBlockDeviceArrayOutput {
	return o
}

func (o VolumeBlockDeviceArrayOutput) Index(i pulumi.IntInput) VolumeBlockDeviceOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) VolumeBlockDevice {
		return vs[0].([]VolumeBlockDevice)[vs[1].(int)]
	}).(VolumeBlockDeviceOutput)
}

type VolumeCacheParameters struct {
	// Optional. Configuration of the cache volume.
	// Structure is documented below.
	CacheConfig *VolumeCacheParametersCacheConfig `pulumi:"cacheConfig"`
	// (Output)
	...
	EnableGlobalFileLock *bool `pulumi:"enableGlobalFileLock"`
	// (Output)
	...
	PeeringCommandExpiryTime *string `pulumi:"peeringCommandExpiryTime"`
	// (Output)
	// Detailed description of the current cache state.
	StateDetails *string `pulumi:"stateDetails"`
}

// VolumeCacheParametersInput is an input type that accepts VolumeCacheParametersArgs and VolumeCacheParametersOutput values.
// You can construct a concrete instance of `VolumeCacheParametersInput` via:
//
//	VolumeCacheParametersArgs{...}
type VolumeCacheParametersInput interface {
	pulumi.Input

	ToVolumeCacheParametersOutput() VolumeCacheParametersOutput
	ToVolumeCacheParametersOutputWithContext(context.Context) VolumeCacheParametersOutput
}

type VolumeCacheParametersArgs struct {
	// Optional. Configuration of the cache volume.
	// Structure is documented below.
	CacheConfig VolumeCacheParametersCacheConfigPtrInput `pulumi:"cacheConfig"`
	// (Output)
	// State of the cache volume indicating the peering status.
	CacheState pulumi.StringPtrInput `pulumi:"cacheState"`
	// (Output)
	// Copy-paste-able commands to be used on user's ONTAP to accept peering requests.
	Command pulumi.StringPtrInput `pulumi:"command"`
	// Optional. Field indicating whether cache volume as global file lock enabled.
	EnableGlobalFileLock pulumi.BoolPtrInput `pulumi:"enableGlobalFileLock"`
	// (Output)
	// Temporary passphrase generated to accept cluster peering command.
	...
	// Optional. Expiration time for the peering command to be executed on user's ONTAP. A timestamp in RFC3339 UTC "Zulu" format. Examples: "2023-06-22T09:13:01.617Z".
	PeeringCommandExpiryTime pulumi.StringPtrInput `pulumi:"peeringCommandExpiryTime"`
	// (Output)
	// Detailed description of the current cache state.
	StateDetails pulumi.StringPtrInput `pulumi:"stateDetails"`
}

func (VolumeCacheParametersArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeCacheParameters)(nil)).Elem()
}

func (i VolumeCacheParametersArgs) ToVolumeCacheParametersOutput() VolumeCacheParametersOutput {
	return i.ToVolumeCacheParametersOutputWithContext(context.Background())
}

func (i VolumeCacheParametersArgs) ToVolumeCacheParametersOutputWithContext(ctx context.Context) VolumeCacheParametersOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeCacheParametersOutput)
}

func (i VolumeCacheParametersArgs) ToVolumeCacheParametersPtrOutput() VolumeCacheParametersPtrOutput {
	return i.ToVolumeCacheParametersPtrOutputWithContext(context.Background())
}

func (i VolumeCacheParametersArgs) ToVolumeCacheParametersPtrOutputWithContext(ctx context.Context) VolumeCacheParametersPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeCacheParametersOutput).ToVolumeCacheParametersPtrOutputWithContext(ctx)
}

// VolumeCacheParametersPtrInput is an input type that accepts VolumeCacheParametersArgs, VolumeCacheParametersPtr and VolumeCacheParametersPtrOutput values.
// You can construct a concrete instance of `VolumeCacheParametersPtrInput` via:
//
//	        VolumeCacheParametersArgs{...}
//
//	or:
//
//	        nil
type VolumeCacheParametersPtrInput interface {
	pulumi.Input

	ToVolumeCacheParametersPtrOutput() VolumeCacheParametersPtrOutput
	ToVolumeCacheParametersPtrOutputWithContext(context.Context) VolumeCacheParametersPtrOutput
}

type volumeCacheParametersPtrType VolumeCacheParametersArgs

func VolumeCacheParametersPtr(v *VolumeCacheParametersArgs) VolumeCacheParametersPtrInput {
	return (*volumeCacheParametersPtrType)(v)
}

func (*volumeCacheParametersPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeCacheParameters)(nil)).Elem()
}

func (i *volumeCacheParametersPtrType) ToVolumeCacheParametersPtrOutput() VolumeCacheParametersPtrOutput {
	return i.ToVolumeCacheParametersPtrOutputWithContext(context.Background())
}

func (i *volumeCacheParametersPtrType) ToVolumeCacheParametersPtrOutputWithContext(ctx context.Context) VolumeCacheParametersPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeCacheParametersPtrOutput)
}

type VolumeCacheParametersOutput struct{ *pulumi.OutputState }

func (VolumeCacheParametersOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeCacheParameters)(nil)).Elem()
}

func (o VolumeCacheParametersOutput) ToVolumeCacheParametersOutput() VolumeCacheParametersOutput {
	return o
}

func (o VolumeCacheParametersOutput) ToVolumeCacheParametersOutputWithContext(ctx context.Context) VolumeCacheParametersOutput {
	return o
}

func (o VolumeCacheParametersOutput) ToVolumeCacheParametersPtrOutput() VolumeCacheParametersPtrOutput {
	return o.ToVolumeCacheParametersPtrOutputWithContext(context.Background())
}

func (o VolumeCacheParametersOutput) ToVolumeCacheParametersPtrOutputWithContext(ctx context.Context) VolumeCacheParametersPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v VolumeCacheParameters) *VolumeCacheParameters {
		return &v
	}).(VolumeCacheParametersPtrOutput)
}

// Optional. Configuration of the cache volume.
// Structure is documented below.
func (o VolumeCacheParametersOutput) CacheConfig() VolumeCacheParametersCacheConfigPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *VolumeCacheParametersCacheConfig { return v.CacheConfig }).(VolumeCacheParametersCacheConfigPtrOutput)
}

// (Output)
// State of the cache volume indicating the peering status.
func (o VolumeCacheParametersOutput) CacheState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.CacheState }).(pulumi.StringPtrOutput)
}

// (Output)
// Copy-paste-able commands to be used on user's ONTAP to accept peering requests.
func (o VolumeCacheParametersOutput) Command() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.Command }).(pulumi.StringPtrOutput)
}

// Optional. Field indicating whether cache volume as global file lock enabled.
func (o VolumeCacheParametersOutput) EnableGlobalFileLock() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *bool { return v.EnableGlobalFileLock }).(pulumi.BoolPtrOutput)
}

// (Output)
// Temporary passphrase generated to accept cluster peering command.
func (o VolumeCacheParametersOutput) Passphrase() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.Passphrase }).(pulumi.StringPtrOutput)
}

// Required. Name of the origin volume's ONTAP cluster.
func (o VolumeCacheParametersOutput) PeerClusterName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.PeerClusterName }).(pulumi.StringPtrOutput)
}

// Required. List of IC LIF addresses of the origin volume's ONTAP cluster.
func (o VolumeCacheParametersOutput) PeerIpAddresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v VolumeCacheParameters) []string { return v.PeerIpAddresses }).(pulumi.StringArrayOutput)
}

// Required. Name of the origin volume's SVM.
func (o VolumeCacheParametersOutput) PeerSvmName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.PeerSvmName }).(pulumi.StringPtrOutput)
}

// Required. Name of the origin volume for the cache volume.
func (o VolumeCacheParametersOutput) PeerVolumeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.PeerVolumeName }).(pulumi.StringPtrOutput)
}

// Optional. Expiration time for the peering command to be executed on user's ONTAP. A timestamp in RFC3339 UTC "Zulu" format. Examples: "2023-06-22T09:13:01.617Z".
func (o VolumeCacheParametersOutput) PeeringCommandExpiryTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.PeeringCommandExpiryTime }).(pulumi.StringPtrOutput)
}

// (Output)
// Detailed description of the current cache state.
func (o VolumeCacheParametersOutput) StateDetails() pulumi.StringPtrOutput {
	return o.ApplyT(func(v VolumeCacheParameters) *string { return v.StateDetails }).(pulumi.StringPtrOutput)
}

type VolumeCacheParametersPtrOutput struct{ *pulumi.OutputState }

func (VolumeCacheParametersPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeCacheParameters)(nil)).Elem()
}

func (o VolumeCacheParametersPtrOutput) ToVolumeCacheParametersPtrOutput() VolumeCacheParametersPtrOutput {
	return o
}

func (o VolumeCacheParametersPtrOutput) ToVolumeCacheParametersPtrOutputWithContext(ctx context.Context) VolumeCacheParametersPtrOutput {
	return o
}

func (o VolumeCacheParametersPtrOutput) Elem() VolumeCacheParametersOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) VolumeCacheParameters {
		if v != nil {
			return *v
		}
		var ret VolumeCacheParameters
		return ret
	}).(VolumeCacheParametersOutput)
}

// Optional. Configuration of the cache volume.
// Structure is documented below.
func (o VolumeCacheParametersPtrOutput) CacheConfig() VolumeCacheParametersCacheConfigPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *VolumeCacheParametersCacheConfig {
		if v == nil {
			return nil
		}
		return v.CacheConfig
	}).(VolumeCacheParametersCacheConfigPtrOutput)
}

// (Output)
// State of the cache volume indicating the peering status.
func (o VolumeCacheParametersPtrOutput) CacheState() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
		return v.CacheState
...
// (Output)
// Copy-paste-able commands to be used on user's ONTAP to accept peering requests.
func (o VolumeCacheParametersPtrOutput) Command() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
...
// Optional. Field indicating whether cache volume as global file lock enabled.
func (o VolumeCacheParametersPtrOutput) EnableGlobalFileLock() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *bool {
		if v == nil {
			return nil
		}
		return v.EnableGlobalFileLock
	}).(pulumi.BoolPtrOutput)
}

// (Output)
// Temporary passphrase generated to accept cluster peering command.
func (o VolumeCacheParametersPtrOutput) Passphrase() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
...
// Required. Name of the origin volume's ONTAP cluster.
func (o VolumeCacheParametersPtrOutput) PeerClusterName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
...
// Required. List of IC LIF addresses of the origin volume's ONTAP cluster.
func (o VolumeCacheParametersPtrOutput) PeerIpAddresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) []string {
		if v == nil {
			return nil
		}
...
// Required. Name of the origin volume's SVM.
func (o VolumeCacheParametersPtrOutput) PeerSvmName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
...
// Required. Name of the origin volume for the cache volume.
func (o VolumeCacheParametersPtrOutput) PeerVolumeName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
...
// Optional. Expiration time for the peering command to be executed on user's ONTAP. A timestamp in RFC3339 UTC "Zulu" format. Examples: "2023-06-22T09:13:01.617Z".
func (o VolumeCacheParametersPtrOutput) PeeringCommandExpiryTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
		return v.PeeringCommandExpiryTime
	}).(pulumi.StringPtrOutput)
}

// (Output)
// Detailed description of the current cache state.
func (o VolumeCacheParametersPtrOutput) StateDetails() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParameters) *string {
		if v == nil {
			return nil
		}
...
type VolumeCacheParametersCacheConfig struct {
	// Optional. Flag indicating whether a CIFS change notification is enabled for the FlexCache volume.
	CifsChangeNotifyEnabled *bool `pulumi:"cifsChangeNotifyEnabled"`
}

// VolumeCacheParametersCacheConfigInput is an input type that accepts VolumeCacheParametersCacheConfigArgs and VolumeCacheParametersCacheConfigOutput values.
// You can construct a concrete instance of `VolumeCacheParametersCacheConfigInput` via:
//
//	VolumeCacheParametersCacheConfigArgs{...}
type VolumeCacheParametersCacheConfigInput interface {
	pulumi.Input

	ToVolumeCacheParametersCacheConfigOutput() VolumeCacheParametersCacheConfigOutput
	ToVolumeCacheParametersCacheConfigOutputWithContext(context.Context) VolumeCacheParametersCacheConfigOutput
}

type VolumeCacheParametersCacheConfigArgs struct {
	// Optional. Flag indicating whether a CIFS change notification is enabled for the FlexCache volume.
	CifsChangeNotifyEnabled pulumi.BoolPtrInput `pulumi:"cifsChangeNotifyEnabled"`
}

func (VolumeCacheParametersCacheConfigArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeCacheParametersCacheConfig)(nil)).Elem()
}

func (i VolumeCacheParametersCacheConfigArgs) ToVolumeCacheParametersCacheConfigOutput() VolumeCacheParametersCacheConfigOutput {
	return i.ToVolumeCacheParametersCacheConfigOutputWithContext(context.Background())
}

func (i VolumeCacheParametersCacheConfigArgs) ToVolumeCacheParametersCacheConfigOutputWithContext(ctx context.Context) VolumeCacheParametersCacheConfigOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeCacheParametersCacheConfigOutput)
}

func (i VolumeCacheParametersCacheConfigArgs) ToVolumeCacheParametersCacheConfigPtrOutput() VolumeCacheParametersCacheConfigPtrOutput {
	return i.ToVolumeCacheParametersCacheConfigPtrOutputWithContext(context.Background())
}

func (i VolumeCacheParametersCacheConfigArgs) ToVolumeCacheParametersCacheConfigPtrOutputWithContext(ctx context.Context) VolumeCacheParametersCacheConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeCacheParametersCacheConfigOutput).ToVolumeCacheParametersCacheConfigPtrOutputWithContext(ctx)
}

// VolumeCacheParametersCacheConfigPtrInput is an input type that accepts VolumeCacheParametersCacheConfigArgs, VolumeCacheParametersCacheConfigPtr and VolumeCacheParametersCacheConfigPtrOutput values.
// You can construct a concrete instance of `VolumeCacheParametersCacheConfigPtrInput` via:
//
//	        VolumeCacheParametersCacheConfigArgs{...}
//
//	or:
//
//	        nil
type VolumeCacheParametersCacheConfigPtrInput interface {
	pulumi.Input

	ToVolumeCacheParametersCacheConfigPtrOutput() VolumeCacheParametersCacheConfigPtrOutput
	ToVolumeCacheParametersCacheConfigPtrOutputWithContext(context.Context) VolumeCacheParametersCacheConfigPtrOutput
}

type volumeCacheParametersCacheConfigPtrType VolumeCacheParametersCacheConfigArgs

func VolumeCacheParametersCacheConfigPtr(v *VolumeCacheParametersCacheConfigArgs) VolumeCacheParametersCacheConfigPtrInput {
	return (*volumeCacheParametersCacheConfigPtrType)(v)
}

func (*volumeCacheParametersCacheConfigPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeCacheParametersCacheConfig)(nil)).Elem()
}

func (i *volumeCacheParametersCacheConfigPtrType) ToVolumeCacheParametersCacheConfigPtrOutput() VolumeCacheParametersCacheConfigPtrOutput {
	return i.ToVolumeCacheParametersCacheConfigPtrOutputWithContext(context.Background())
}

func (i *volumeCacheParametersCacheConfigPtrType) ToVolumeCacheParametersCacheConfigPtrOutputWithContext(ctx context.Context) VolumeCacheParametersCacheConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(VolumeCacheParametersCacheConfigPtrOutput)
}

type VolumeCacheParametersCacheConfigOutput struct{ *pulumi.OutputState }

func (VolumeCacheParametersCacheConfigOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VolumeCacheParametersCacheConfig)(nil)).Elem()
}

func (o VolumeCacheParametersCacheConfigOutput) ToVolumeCacheParametersCacheConfigOutput() VolumeCacheParametersCacheConfigOutput {
	return o
}

func (o VolumeCacheParametersCacheConfigOutput) ToVolumeCacheParametersCacheConfigOutputWithContext(ctx context.Context) VolumeCacheParametersCacheConfigOutput {
	return o
}

func (o VolumeCacheParametersCacheConfigOutput) ToVolumeCacheParametersCacheConfigPtrOutput() VolumeCacheParametersCacheConfigPtrOutput {
	return o.ToVolumeCacheParametersCacheConfigPtrOutputWithContext(context.Background())
}

func (o VolumeCacheParametersCacheConfigOutput) ToVolumeCacheParametersCacheConfigPtrOutputWithContext(ctx context.Context) VolumeCacheParametersCacheConfigPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v VolumeCacheParametersCacheConfig) *VolumeCacheParametersCacheConfig {
		return &v
	}).(VolumeCacheParametersCacheConfigPtrOutput)
}

// Optional. Flag indicating whether a CIFS change notification is enabled for the FlexCache volume.
func (o VolumeCacheParametersCacheConfigOutput) CifsChangeNotifyEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v VolumeCacheParametersCacheConfig) *bool { return v.CifsChangeNotifyEnabled }).(pulumi.BoolPtrOutput)
}

type VolumeCacheParametersCacheConfigPtrOutput struct{ *pulumi.OutputState }

func (VolumeCacheParametersCacheConfigPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VolumeCacheParametersCacheConfig)(nil)).Elem()
}

func (o VolumeCacheParametersCacheConfigPtrOutput) ToVolumeCacheParametersCacheConfigPtrOutput() VolumeCacheParametersCacheConfigPtrOutput {
	return o
}

func (o VolumeCacheParametersCacheConfigPtrOutput) ToVolumeCacheParametersCacheConfigPtrOutputWithContext(ctx context.Context) VolumeCacheParametersCacheConfigPtrOutput {
	return o
}

func (o VolumeCacheParametersCacheConfigPtrOutput) Elem() VolumeCacheParametersCacheConfigOutput {
	return o.ApplyT(func(v *VolumeCacheParametersCacheConfig) VolumeCacheParametersCacheConfig {
		if v != nil {
			return *v
		}
		var ret VolumeCacheParametersCacheConfig
		return ret
	}).(VolumeCacheParametersCacheConfigOutput)
}

// Optional. Flag indicating whether a CIFS change notification is enabled for the FlexCache volume.
func (o VolumeCacheParametersCacheConfigPtrOutput) CifsChangeNotifyEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *VolumeCacheParametersCacheConfig) *bool {
		if v == nil {
			return nil
		}
		return v.CifsChangeNotifyEnabled
	}).(pulumi.BoolPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBlockDeviceInput)(nil)).Elem(), VolumeBlockDeviceArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeBlockDeviceArrayInput)(nil)).Elem(), VolumeBlockDeviceArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeCacheParametersInput)(nil)).Elem(), VolumeCacheParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeCacheParametersPtrInput)(nil)).Elem(), VolumeCacheParametersArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeCacheParametersCacheConfigInput)(nil)).Elem(), VolumeCacheParametersCacheConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*VolumeCacheParametersCacheConfigPtrInput)(nil)).Elem(), VolumeCacheParametersCacheConfigArgs{})
	...
	pulumi.RegisterOutputType(VolumeBlockDeviceOutput{})
	pulumi.RegisterOutputType(VolumeBlockDeviceArrayOutput{})
	pulumi.RegisterOutputType(VolumeCacheParametersOutput{})
	pulumi.RegisterOutputType(VolumeCacheParametersPtrOutput{})
	pulumi.RegisterOutputType(VolumeCacheParametersCacheConfigOutput{})
	pulumi.RegisterOutputType(VolumeCacheParametersCacheConfigPtrOutput{})
