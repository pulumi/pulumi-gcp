...
//				ScopeId: pulumi.String("tf-test-scope_9723"),
//			})
//			if err != nil {
//				return err
//			}
//			_, err = gkehub.NewScopeRbacRoleBinding(ctx, "scope_rbac_role_binding", &gkehub.ScopeRbacRoleBindingArgs{
//				ScopeRbacRoleBindingId: pulumi.String("tf-test-scope-rbac-role-binding_22061"),
...
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			scope, err := gkehub.NewScope(ctx, "scope", &gkehub.ScopeArgs{
//				ScopeId: pulumi.String("tf-test-scope_60461"),
//			})
//			if err != nil {
//				return err
//			}
...
//			}
//			_, err = gkehub.NewScopeRbacRoleBinding(ctx, "scope_rbac_role_binding", &gkehub.ScopeRbacRoleBindingArgs{
//				ScopeRbacRoleBindingId: pulumi.String("tf-test-scope-rbac-role-binding_45397"),
//				ScopeId:                scope.ScopeId,
//				User:                   pulumi.String("test-email@gmail.com"),
//				Role: &gkehub.ScopeRbacRoleBindingRoleArgs{
