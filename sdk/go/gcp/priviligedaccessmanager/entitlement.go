...
func NewEntitlement(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:priviligedaccessmanager/entitlement:Entitlement", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntitlement(ctx *pulumi.Context,
	...
	var resource Entitlement
	err := ctx.ReadResource("gcp:priviligedaccessmanager/entitlement:Entitlement", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
