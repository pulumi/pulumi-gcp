...
func (i LakeIamBindingArray) ToOutput(ctx context.Context) pulumix.Output[[]*LakeIamBinding] {
	return pulumix.Output[[]*LakeIamBinding]{
		OutputState: i.ToLakeIamBindingArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i LakeIamBindingMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*LakeIamBinding] {
	return pulumix.Output[map[string]*LakeIamBinding]{
		OutputState: i.ToLakeIamBindingMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o LakeIamBindingArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*LakeIamBinding] {
	return pulumix.Output[[]*LakeIamBinding]{
		OutputState: o.OutputState,
	}
}
...
func (o LakeIamBindingMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*LakeIamBinding] {
	return pulumix.Output[map[string]*LakeIamBinding]{
		OutputState: o.OutputState,
	}
}
