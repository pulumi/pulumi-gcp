...
// * `dataplex.EntryGroupIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the entrygroup are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
// * `dataplex.EntryGroupIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the entrygroup are preserved. Members added outside of Terraform will **not** be detected as drift.
//
...
func NewEntryGroupIamMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:dataplex/entryGroupIamMember:EntryGroupIamMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroupIamMember(ctx *pulumi.Context,
	...
	var resource EntryGroupIamMember
	err := ctx.ReadResource("gcp:dataplex/entryGroupIamMember:EntryGroupIamMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o EntryGroupIamMemberOutput) EntryGroupId() pulumi.StringOutput {
	return o.ApplyT(func(v *EntryGroupIamMember) pulumi.StringOutput { return v.EntryGroupId }).(pulumi.StringOutput)
}
...
// the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
// location is specified, it is taken from the provider configuration.
func (o EntryGroupIamMemberOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *EntryGroupIamMember) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}
