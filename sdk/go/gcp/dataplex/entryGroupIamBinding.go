...
func NewEntryGroupIamBinding(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:dataplex/entryGroupIamBinding:EntryGroupIamBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEntryGroupIamBinding(ctx *pulumi.Context,
	...
	var resource EntryGroupIamBinding
	err := ctx.ReadResource("gcp:dataplex/entryGroupIamBinding:EntryGroupIamBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Used to find the parent resource to bind the IAM policy to
func (o EntryGroupIamBindingOutput) EntryGroupId() pulumi.StringOutput {
	return o.ApplyT(func(v *EntryGroupIamBinding) pulumi.StringOutput { return v.EntryGroupId }).(pulumi.StringOutput)
}
...
// the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
// location is specified, it is taken from the provider configuration.
func (o EntryGroupIamBindingOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *EntryGroupIamBinding) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}
