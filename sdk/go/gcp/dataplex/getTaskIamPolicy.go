...
func (o LookupTaskIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupTaskIamPolicyResult] {
	return pulumix.Output[LookupTaskIamPolicyResult]{
