...
func NewServiceIdentity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:organizations/serviceIdentity:ServiceIdentity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceIdentity(ctx *pulumi.Context,
	...
	var resource ServiceIdentity
	err := ctx.ReadResource("gcp:organizations/serviceIdentity:ServiceIdentity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The organization in which the resource belongs.
func (o ServiceIdentityOutput) Organization() pulumi.StringOutput {
	return o.ApplyT(func(v *ServiceIdentity) pulumi.StringOutput { return v.Organization }).(pulumi.StringOutput)
}
