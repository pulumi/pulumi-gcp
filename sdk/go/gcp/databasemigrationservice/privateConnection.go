...
//				return err
//			}
//			_, err = databasemigrationservice.NewPrivateConnection(ctx, "defaultPrivateConnection", &databasemigrationservice.PrivateConnectionArgs{
...
//					VpcName: *pulumi.String(defaultNetwork.Id),
...
func NewPrivateConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("gcp:databasemigrationservice/privateConnection:PrivateConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrivateConnection(ctx *pulumi.Context,
	...
	var resource PrivateConnection
	err := ctx.ReadResource("gcp:databasemigrationservice/privateConnection:PrivateConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
