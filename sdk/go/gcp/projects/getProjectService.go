...
func (o GetProjectServiceResultOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v GetProjectServiceResult) string { return v.DeletionPolicy }).(pulumi.StringOutput)
}
