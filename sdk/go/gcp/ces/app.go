...
//							Defs:                 pulumi.String(pulumi.String(json0)),
//							AnyOf:                pulumi.String(pulumi.String(json1)),
//							Default:              pulumi.String(pulumi.String(json2)),
//							PrefixItems:          pulumi.String(pulumi.String(json3)),
//							AdditionalProperties: pulumi.String(pulumi.String(json4)),
//							Properties:           pulumi.String(pulumi.String(json5)),
//							Items:                pulumi.String(pulumi.String(json6)),
//						},
//					},
//				},
