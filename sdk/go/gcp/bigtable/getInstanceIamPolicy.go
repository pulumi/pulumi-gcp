...
func LookupInstanceIamPolicyOutput(ctx *pulumi.Context, args LookupInstanceIamPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupInstanceIamPolicyResultOutput {
	...
	return ctx.InvokeOutput("gcp:bigtable/getInstanceIamPolicy:getInstanceIamPolicy", args, LookupInstanceIamPolicyResultOutput{}, options).(LookupInstanceIamPolicyResultOutput)
}
