...
func LookupCloudExadataInfrastructureOutput(ctx *pulumi.Context, args LookupCloudExadataInfrastructureOutputArgs, opts ...pulumi.InvokeOption) LookupCloudExadataInfrastructureResultOutput {
	...
	return ctx.InvokeOutput("gcp:oracledatabase/getCloudExadataInfrastructure:getCloudExadataInfrastructure", args, LookupCloudExadataInfrastructureResultOutput{}, options).(LookupCloudExadataInfrastructureResultOutput)
}
...
func (o LookupCloudExadataInfrastructureResultOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCloudExadataInfrastructureResult) string { return v.DeletionPolicy }).(pulumi.StringOutput)
}
