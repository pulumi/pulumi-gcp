...
func LookupCloudVmClusterOutput(ctx *pulumi.Context, args LookupCloudVmClusterOutputArgs, opts ...pulumi.InvokeOption) LookupCloudVmClusterResultOutput {
	...
	return ctx.InvokeOutput("gcp:oracledatabase/getCloudVmCluster:getCloudVmCluster", args, LookupCloudVmClusterResultOutput{}, options).(LookupCloudVmClusterResultOutput)
}
...
func (o LookupCloudVmClusterResultOutput) DeletionPolicy() pulumi.StringOutput {
	return o.ApplyT(func(v LookupCloudVmClusterResult) string { return v.DeletionPolicy }).(pulumi.StringOutput)
}
