...
func NewWebTypeAppEngingIamBinding(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	s, err := ctx.RegisterResource("gcp:iap/webTypeAppEngingIamBinding:WebTypeAppEngingIamBinding", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &WebTypeAppEngingIamBinding{s: s}, nil
}
...
func GetWebTypeAppEngingIamBinding(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("gcp:iap/webTypeAppEngingIamBinding:WebTypeAppEngingIamBinding", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &WebTypeAppEngingIamBinding{s: s}, nil
