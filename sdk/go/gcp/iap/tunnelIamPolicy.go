...
func (i *TunnelIamPolicy) ToOutput(ctx context.Context) pulumix.Output[*TunnelIamPolicy] {
	return pulumix.Output[*TunnelIamPolicy]{
		OutputState: i.ToTunnelIamPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (i TunnelIamPolicyArray) ToOutput(ctx context.Context) pulumix.Output[[]*TunnelIamPolicy] {
	return pulumix.Output[[]*TunnelIamPolicy]{
		OutputState: i.ToTunnelIamPolicyArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i TunnelIamPolicyMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*TunnelIamPolicy] {
	return pulumix.Output[map[string]*TunnelIamPolicy]{
		OutputState: i.ToTunnelIamPolicyMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o TunnelIamPolicyOutput) ToOutput(ctx context.Context) pulumix.Output[*TunnelIamPolicy] {
	return pulumix.Output[*TunnelIamPolicy]{
...
func (o TunnelIamPolicyArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*TunnelIamPolicy] {
	return pulumix.Output[[]*TunnelIamPolicy]{
		OutputState: o.OutputState,
	}
}
...
func (o TunnelIamPolicyMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*TunnelIamPolicy] {
	return pulumix.Output[map[string]*TunnelIamPolicy]{
		OutputState: o.OutputState,
	}
}
