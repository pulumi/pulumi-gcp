...
func (o LookupWebTypeComputeIamPolicyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupWebTypeComputeIamPolicyResult] {
	return pulumix.Output[LookupWebTypeComputeIamPolicyResult]{
