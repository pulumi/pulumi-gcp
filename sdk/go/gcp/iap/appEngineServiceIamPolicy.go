...
func NewAppEngineServiceIamPolicy(ctx *pulumi.Context,
	...
	inputs["etag"] = nil
	s, err := ctx.RegisterResource("gcp:iap/appEngineServiceIamPolicy:AppEngineServiceIamPolicy", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AppEngineServiceIamPolicy{s: s}, nil
}
...
func GetAppEngineServiceIamPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("gcp:iap/appEngineServiceIamPolicy:AppEngineServiceIamPolicy", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AppEngineServiceIamPolicy{s: s}, nil
