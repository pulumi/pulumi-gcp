...
func (i *CaExternalAccountKey) ToOutput(ctx context.Context) pulumix.Output[*CaExternalAccountKey] {
	return pulumix.Output[*CaExternalAccountKey]{
		OutputState: i.ToCaExternalAccountKeyOutputWithContext(ctx).OutputState,
	}
}
...
func (i CaExternalAccountKeyArray) ToOutput(ctx context.Context) pulumix.Output[[]*CaExternalAccountKey] {
	return pulumix.Output[[]*CaExternalAccountKey]{
		OutputState: i.ToCaExternalAccountKeyArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i CaExternalAccountKeyMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*CaExternalAccountKey] {
	return pulumix.Output[map[string]*CaExternalAccountKey]{
		OutputState: i.ToCaExternalAccountKeyMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o CaExternalAccountKeyOutput) ToOutput(ctx context.Context) pulumix.Output[*CaExternalAccountKey] {
	return pulumix.Output[*CaExternalAccountKey]{
...
func (o CaExternalAccountKeyArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*CaExternalAccountKey] {
	return pulumix.Output[[]*CaExternalAccountKey]{
		OutputState: o.OutputState,
	}
}
...
func (o CaExternalAccountKeyMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*CaExternalAccountKey] {
	return pulumix.Output[map[string]*CaExternalAccountKey]{
		OutputState: o.OutputState,
	}
}
