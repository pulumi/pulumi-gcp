...
type InterconnectAttachment struct {
	...
	L2Forwarding InterconnectAttachmentL2ForwardingPtrOutput `pulumi:"l2Forwarding"`
...
type interconnectAttachmentState struct {
	...
	// L2 Interconnect Attachment related configuration.
	// Structure is documented below.
	L2Forwarding *InterconnectAttachmentL2Forwarding `pulumi:"l2Forwarding"`
	// A fingerprint for the labels being applied to this Interconnect, which is essentially a hash
	// of the labels set used for optimistic locking. The fingerprint is initially generated by
	// Compute Engine and changes after every request to modify or update labels.
	// You must always provide an up-to-date fingerprint hash in order to update or change labels,
...
type InterconnectAttachmentState struct {
	...
	// L2 Interconnect Attachment related configuration.
	// Structure is documented below.
	L2Forwarding InterconnectAttachmentL2ForwardingPtrInput
	// A fingerprint for the labels being applied to this Interconnect, which is essentially a hash
	// of the labels set used for optimistic locking. The fingerprint is initially generated by
	// Compute Engine and changes after every request to modify or update labels.
	// You must always provide an up-to-date fingerprint hash in order to update or change labels,
...
// L2 Interconnect Attachment related configuration.
// Structure is documented below.
func (o InterconnectAttachmentOutput) L2Forwarding() InterconnectAttachmentL2ForwardingPtrOutput {
	return o.ApplyT(func(v *InterconnectAttachment) InterconnectAttachmentL2ForwardingPtrOutput { return v.L2Forwarding }).(InterconnectAttachmentL2ForwardingPtrOutput)
}
...
// automatically connect the Interconnect to the network & region within which the
// Cloud Router is configured.
func (o InterconnectAttachmentOutput) Router() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InterconnectAttachment) pulumi.StringPtrOutput { return v.Router }).(pulumi.StringPtrOutput)
}
