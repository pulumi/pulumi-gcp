...
class DomainMappingMetadata(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "effectiveAnnotations":
            ...
            suggest = "self_link"
        elif key == "terraformLabels":
            suggest = "terraform_labels"
    ...
    def __init__(__self__, *,
                 ...
                 terraform_labels: Optional[Mapping[str, str]] = None,
        ...
        :param Mapping[str, str] terraform_labels: (Output)
    ...
    def terraform_labels(self) -> Optional[Mapping[str, str]]:
        """
        (Output)
        The combination of labels configured directly on the resource
        and default labels configured on the provider.
...
class GetServiceMetadataResult(dict):
    def __init__(__self__, *,
                 ...
                 self_link: str,
                 terraform_labels: Mapping[str, str],
                 uid: str):
    ...
    def _configure(
        ...
        if effective_annotations is None:
            raise TypeError("Missing 'effective_annotations' argument")
        if effective_labels is None and 'effectiveLabels' in kwargs:
            effective_labels = kwargs['effectiveLabels']
        if effective_labels is None:
            raise TypeError("Missing 'effective_labels' argument")
        ...
        if terraform_labels is None and 'terraformLabels' in kwargs:
            terraform_labels = kwargs['terraformLabels']
        if terraform_labels is None:
            raise TypeError("Missing 'terraform_labels' argument")
        if uid is None:
