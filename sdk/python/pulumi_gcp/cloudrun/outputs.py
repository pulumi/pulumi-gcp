...
class DomainMappingMetadata(dict):
    ...
    def __init__(__self__, *,
                 ...
                 effective_annotations: Optional[Mapping[str, builtins.str]] = None,
                 effective_labels: Optional[Mapping[str, builtins.str]] = None,
                 generation: Optional[builtins.int] = None,
                 labels: Optional[Mapping[str, builtins.str]] = None,
                 pulumi_labels: Optional[Mapping[str, builtins.str]] = None,
                 resource_version: Optional[builtins.str] = None,
                 self_link: Optional[builtins.str] = None,
                 uid: Optional[builtins.str] = None):
        """
        :param builtins.str namespace: In Cloud Run the namespace must be equal to either the
               project ID or project number.
        :param Mapping[str, builtins.str] annotations: Annotations is a key value map stored with a resource that
        ...
        :param Mapping[str, builtins.str] labels: Map of string keys and values that can be used to organize and categorize
               (scope and select) objects. May match selectors of replication controllers
               and routes.
               More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param Mapping[str, builtins.str] pulumi_labels: (Output)
               The combination of labels configured directly on the resource
               and default labels configured on the provider.
        :param builtins.str resource_version: (Output)
        ...
        :param builtins.str self_link: (Output)
    ...
    def effective_annotations(self) -> Optional[Mapping[str, builtins.str]]:
        return pulumi.get(self, "effective_annotations")

    @property
    @pulumi.getter(name="effectiveLabels")
    def effective_labels(self) -> Optional[Mapping[str, builtins.str]]:
        """
        (Output)
        All of labels (key/value pairs) present on the resource in GCP, including the labels configured through Pulumi, other clients and services.
        """
    ...
    def pulumi_labels(self) -> Optional[Mapping[str, builtins.str]]:
        """
        (Output)
        The combination of labels configured directly on the resource
        and default labels configured on the provider.
...
class DomainMappingSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 force_override: Optional[builtins.bool] = None):
        """
        :param builtins.str route_name: The name of the Cloud Run Service that this DomainMapping applies to.
    ...
    def force_override(self) -> Optional[builtins.bool]:
        """
...
class DomainMappingStatus(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mapped_route_name: Optional[builtins.str] = None,
        ...
        :param builtins.str mapped_route_name: (Output)
               The name of the route that the mapping currently points to.
        :param builtins.int observed_generation: (Output)
    ...
    def mapped_route_name(self) -> Optional[builtins.str]:
        """
        (Output)
        The name of the route that the mapping currently points to.
        """
...
class DomainMappingStatusResourceRecord(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str name: Name should be a [verified](https://support.google.com/webmasters/answer/9008080) domain
        :param builtins.str rrdata: (Output)
...
class ServiceStatus(dict):
    ...
    def __init__(__self__, *,
                 ...
                 latest_created_revision_name: Optional[builtins.str] = None,
                 latest_ready_revision_name: Optional[builtins.str] = None,
                 observed_generation: Optional[builtins.int] = None,
        ...
        :param Sequence['ServiceStatusConditionArgs'] conditions: (Output)
               ...
               Structure is documented below.
        :param builtins.str latest_created_revision_name: (Output)
               From ConfigurationStatus. LatestCreatedRevisionName is the last revision that was created
               from this Service's Configuration. It might not be ready yet, for that use
               LatestReadyRevisionName.
        :param builtins.str latest_ready_revision_name: (Output)
    ...
    def latest_created_revision_name(self) -> Optional[builtins.str]:
        """
        (Output)
        From ConfigurationStatus. LatestCreatedRevisionName is the last revision that was created
        from this Service's Configuration. It might not be ready yet, for that use
    ...
    def latest_ready_revision_name(self) -> Optional[builtins.str]:
        """
        (Output)
        From ConfigurationStatus. LatestReadyRevisionName holds the name of the latest Revision
        stamped out from this Service's Configuration that has had its "Ready" condition become
...
class ServiceStatusTraffic(dict):
    ...
    def __init__(__self__, *,
                 ...
                 url: Optional[builtins.str] = None):
        """
        :param builtins.bool latest_revision: LatestRevision may be optionally provided to indicate that the latest ready
               Revision of the Configuration should be used for this traffic target. When
               provided LatestRevision must be true if RevisionName is empty; it must be
               false when RevisionName is non-empty.
        :param builtins.int percent: Percent specifies percent of the traffic to this Revision or Configuration.
        :param builtins.str revision_name: RevisionName of a specific revision to which to send this portion of traffic.
        :param builtins.str tag: Tag is optionally used to expose a dedicated url for referencing this target exclusively.
        :param builtins.str url: (Output)
               URL displays the URL for accessing tagged traffic targets. URL is displayed in status,
               and is disallowed on spec. URL must contain a scheme (e.g. http://) and a hostname,
               but may not contain anything else (e.g. basic auth, url path, etc.)
...
class ServiceTemplateMetadata(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] labels: Map of string keys and values that can be used to organize and categorize
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param builtins.str name: Name must be unique within a Google Cloud project and region.
...
class ServiceTemplateSpec(dict):
    ...
    def __init__(__self__, *,
                 container_concurrency: Optional[builtins.int] = None,
                 ...
                 serving_state: Optional[builtins.str] = None,
                 timeout_seconds: Optional[builtins.int] = None,
                 volumes: Optional[Sequence['outputs.ServiceTemplateSpecVolume']] = None):
        """
        :param builtins.int container_concurrency: ContainerConcurrency specifies the maximum allowed in-flight (concurrent)
        ...
        :param Sequence['ServiceTemplateSpecContainerArgs'] containers: Containers defines the unit of execution for this Revision.
               Structure is documented below.
        :param Mapping[str, builtins.str] node_selector: Node Selector describes the hardware requirements of the resources.
        ...
        :param builtins.str service_account_name: Email address of the IAM service account associated with the revision of the
               service. The service account represents the identity of the running revision,
               and determines what permissions the revision has. If not provided, the revision
               will use the project's default service account.
        :param builtins.str serving_state: (Output, Deprecated)
        ...
        :param builtins.int timeout_seconds: TimeoutSeconds holds the max duration the instance is allowed for responding to a request.
    ...
    def container_concurrency(self) -> Optional[builtins.int]:
        """
    ...
    def serving_state(self) -> Optional[builtins.str]:
        """
        (Output, Deprecated)
        ServingState holds a value describing the state the resources
        are in for this Revision.
...
class ServiceTemplateSpecContainer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str image: Docker image name. This is most often a reference to a container located
               in the container registry, such as gcr.io/cloudrun/hello
        :param Sequence[builtins.str] args: Arguments to the entrypoint.
               The docker image's CMD is used if this is not provided.
        :param Sequence[builtins.str] commands: Entrypoint array. Not executed within a shell.
        ...
        :param Sequence['ServiceTemplateSpecContainerVolumeMountArgs'] volume_mounts: Volume to mount into the container's filesystem.
               ...
               Structure is documented below.
        :param builtins.str working_dir: (Optional, Deprecated)
...
class ServiceTemplateSpecContainerEnv(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str value: Defaults to "".
...
class ServiceTemplateSpecContainerEnvFrom(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ServiceTemplateSpecContainerEnvFromConfigMapRefArgs' config_map_ref: The ConfigMap to select from.
               Structure is documented below.
        :param builtins.str prefix: An optional identifier to prepend to each key in the ConfigMap.
...
class ServiceTemplateSpecContainerEnvFromConfigMapRef(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceArgs' local_object_reference: The ConfigMap to select from.
               Structure is documented below.
        :param builtins.bool optional: Specify whether the ConfigMap must be defined
        """
...
class ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReference(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: Name of the referent.
        """
        pulumi.set(__self__, "name", name)
...
class ServiceTemplateSpecContainerEnvFromSecretRef(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceArgs' local_object_reference: The Secret to select from.
               Structure is documented below.
        :param builtins.bool optional: Specify whether the Secret must be defined
        """
        if local_object_reference is not None:
            pulumi.set(__self__, "local_object_reference", local_object_reference)
        if optional is not None:
...
class ServiceTemplateSpecContainerEnvValueFromSecretKeyRef(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str key: A Cloud Secret Manager secret version. Must be 'latest' for the latest
               version or an integer for a specific version.
        :param builtins.str name: The name of the secret in Cloud Secret Manager. By default, the secret is assumed to be in the same project.
...
class ServiceTemplateSpecContainerPort(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int container_port: Port number the container listens on. This must be a valid port number (between 1 and 65535). Defaults to "8080".
        :param builtins.str name: If specified, used to specify which protocol to use. Allowed values are "http1" (HTTP/1) and "h2c" (HTTP/2 end-to-end). Defaults to "http1".
        :param builtins.str protocol: Protocol for port. Must be "TCP". Defaults to "TCP".
        """
...
class ServiceTemplateSpecContainerResources(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] limits: Limits describes the maximum amount of compute resources allowed.
               The values of the map is string form of the 'quantity' k8s type:
               https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go
        :param Mapping[str, builtins.str] requests: Requests describes the minimum amount of compute resources required.
...
class ServiceTemplateSpecVolumeCsi(dict):
    ...
    def __init__(__self__, *,
                 ...
                 volume_attributes: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str driver: Unique name representing the type of file system to be created. Cloud Run supports the following values:
               * gcsfuse.run.googleapis.com: Mount a Google Cloud Storage bucket using GCSFuse. This driver requires the
               run.googleapis.com/execution-environment annotation to be unset or set to "gen2"
        :param builtins.bool read_only: If true, all mounts created from this volume will be read-only.
        :param Mapping[str, builtins.str] volume_attributes: Driver-specific attributes. The following options are supported for available drivers:
    ...
    def volume_attributes(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ServiceTemplateSpecVolumeEmptyDir(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str medium: The medium on which the data is stored. The default is "" which means to use the node's default medium. Must be an empty string (default) or Memory.
...
class ServiceTemplateSpecVolumeSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str secret_name: The name of the secret in Cloud Secret Manager. By default, the secret
               ...
               annotation.
        :param builtins.int default_mode: Mode bits to use on created files by default. Must be a value between 0000
...
class ServiceTemplateSpecVolumeSecretItem(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The Cloud Secret Manager secret version.
               Can be 'latest' for the latest value or an integer for a specific version.
        :param builtins.str path: The relative path of the file to map the key to.
               May not be an absolute path.
               May not contain the path element '..'.
               May not start with the string '..'.
        :param builtins.int mode: Mode bits to use on this file, must be a value between 0000 and 0777. If
...
class GetServiceMetadataResult(dict):
    def __init__(__self__, *,
                 ...
                 uid: builtins.str):
        """
        :param builtins.int generation: A sequence number representing a specific generation of the desired state.
        :param Mapping[str, builtins.str] labels: Map of string keys and values that can be used to organize and categorize
               (scope and select) objects. May match selectors of replication controllers
               and routes.
        ...
        :param Mapping[str, builtins.str] pulumi_labels: The combination of labels configured directly on the resource
                and default labels configured on the provider.
        :param builtins.str resource_version: An opaque value that represents the internal version of this object that
               can be used by clients to determine when objects have changed. May be used
               for optimistic concurrency, change detection, and the watch operation on a
               resource or set of resources. They may only be valid for a
               particular resource or set of resources.
        :param builtins.str self_link: SelfLink is a URL representing this object.
        :param builtins.str uid: UID is a unique id generated by the server on successful creation of a resource and is not
               allowed to change on PUT operations.
        """
        pulumi.set(__self__, "annotations", annotations)
        pulumi.set(__self__, "effective_annotations", effective_annotations)
...
class GetServiceStatusResult(dict):
    def __init__(__self__, *,
                 ...
                 latest_created_revision_name: builtins.str,
                 latest_ready_revision_name: builtins.str,
        ...
        :param builtins.str latest_created_revision_name: From ConfigurationStatus. LatestCreatedRevisionName is the last revision that was created
               from this Service's Configuration. It might not be ready yet, for that use
               LatestReadyRevisionName.
        :param builtins.str latest_ready_revision_name: From ConfigurationStatus. LatestReadyRevisionName holds the name of the latest Revision
               stamped out from this Service's Configuration that has had its "Ready" condition become
               "True".
        :param builtins.int observed_generation: ObservedGeneration is the 'Generation' of the Route that was last processed by the
               controller.
        ...
        :param Sequence['GetServiceStatusTrafficArgs'] traffics: Traffic specifies how to distribute traffic over a collection of Knative Revisions
               and Configurations
        :param builtins.str url: From RouteStatus. URL holds the url that will distribute traffic over the provided traffic
    ...
    @property
    @pulumi.getter(name="observedGeneration")
    def observed_generation(self) -> builtins.int:
        """
        ObservedGeneration is the 'Generation' of the Route that was last processed by the
        controller.
...
class GetServiceStatusConditionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str reason: One-word CamelCase reason for the condition's current status.
        :param builtins.str status: Status of the condition, one of True, False, Unknown.
        :param builtins.str type: Type of domain mapping condition.
        """
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "reason", reason)
        pulumi.set(__self__, "status", status)
...
class GetServiceStatusTrafficResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str revision_name: RevisionName of a specific revision to which to send this portion of traffic.
        :param builtins.str tag: Tag is optionally used to expose a dedicated url for referencing this target exclusively.
        :param builtins.str url: URL displays the URL for accessing tagged traffic targets. URL is displayed in status,
               and is disallowed on spec. URL must contain a scheme (e.g. http://) and a hostname,
               but may not contain anything else (e.g. basic auth, url path, etc.)
        """
        pulumi.set(__self__, "latest_revision", latest_revision)
    ...
    @property
    @pulumi.getter(name="latestRevision")
    def latest_revision(self) -> builtins.bool:
        """
        LatestRevision may be optionally provided to indicate that the latest ready
        Revision of the Configuration should be used for this traffic target. When
        provided LatestRevision must be true if RevisionName is empty; it must be
...
class GetServiceTemplateSpecResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str service_account_name: Email address of the IAM service account associated with the revision of the
               ...
               and determines what permissions the revision has. If not provided, the revision
               will use the project's default service account.
        :param builtins.str serving_state: ServingState holds a value describing the state the resources
               are in for this Revision.
               It is expected
               that the system will manipulate this based on routability and load.
        :param builtins.int timeout_seconds: TimeoutSeconds holds the max duration the instance is allowed for responding to a request.
    ...
    @property
    @pulumi.getter(name="containerConcurrency")
    def container_concurrency(self) -> builtins.int:
        """
        ContainerConcurrency specifies the maximum allowed in-flight (concurrent)
        requests per container of the Revision. If not specified or 0, defaults to 80 when
        requested CPU >= 1 and defaults to 1 when requested CPU < 1.
...
class GetServiceTemplateSpecContainerResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['GetServiceTemplateSpecContainerVolumeMountArgs'] volume_mounts: Volume to mount into the container's filesystem.
               Only supports SecretVolumeSources.
        :param builtins.str working_dir: Container's working directory.
               If not specified, the container runtime's default will be used, which
               might be configured in the container image.
        """
        pulumi.set(__self__, "args", args)
...
class GetServiceTemplateSpecVolumeCsiResult(dict):
    def __init__(__self__, *,
                 ...
                 volume_attributes: Mapping[str, builtins.str]):
        """
        :param builtins.str driver: Unique name representing the type of file system to be created. Cloud Run supports the following values:
                 * gcsfuse.run.googleapis.com: Mount a Google Cloud Storage bucket using GCSFuse. This driver requires the
                   run.googleapis.com/execution-environment annotation to be unset or set to "gen2"
    ...
    @property
    @pulumi.getter(name="volumeAttributes")
    def volume_attributes(self) -> Mapping[str, builtins.str]:
        """
        Driver-specific attributes. The following options are supported for available drivers:
          * gcsfuse.run.googleapis.com
            * bucketName: The name of the Cloud Storage Bucket that backs this volume. The Cloud Run Service identity must have access to this bucket.
