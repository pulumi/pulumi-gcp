...
class IamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The location of the cloud run instance. eg us-central1 Used to find the parent resource to bind the IAM policy to. If not specified,
...
class IamPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:cloudrun/iamPolicy:IamPolicy"
    ...
    def get(resource_name: str,
            ...
            policy_data: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None) -> 'IamPolicy':
        """
