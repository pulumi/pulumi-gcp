...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] autogenerate_revision_name: If set to 'true', the revision name (template.metadata.name) will be omitted and autogenerated by Cloud Run. This cannot
...
class Service(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:cloudrun/service:Service"
