...
if not MYPY:
    class DomainMappingMetadataArgsDict(TypedDict):
        ...
        **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration.
        ...
        """
        effective_annotations: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        effective_labels: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        (Output)
        ...
        **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
        ...
        """
        pulumi_labels: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        (Output)
...
class DomainMappingMetadataArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] namespace: In Cloud Run the namespace must be equal to either the
               project ID or project number.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations is a key value map stored with a resource that
               may be set by external tools to store and retrieve arbitrary metadata.
               More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations
               **Note**: The Cloud Run API may add additional annotations that were not provided in your config.
               If the provider plan shows a diff where a server-side annotation is added, you can add it to your config
        ...
        :param pulumi.Input[builtins.int] generation: (Output)
               A sequence number representing a specific generation of the desired state.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Map of string keys and values that can be used to organize and categorize
               (scope and select) objects. May match selectors of replication controllers
               and routes.
               More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] pulumi_labels: (Output)
               The combination of labels configured directly on the resource
               and default labels configured on the provider.
        :param pulumi.Input[builtins.str] resource_version: (Output)
               An opaque value that represents the internal version of this object that
               can be used by clients to determine when objects have changed. May be used
               for optimistic concurrency, change detection, and the watch operation on a
               resource or set of resources. They may only be valid for a
               ...
               More info:
               https://git.k8s.io/community/contributors/devel/api-conventions.md#concurrency-control-and-consistency
        :param pulumi.Input[builtins.str] self_link: (Output)
               SelfLink is a URL representing this object.
...
if not MYPY:
    class DomainMappingSpecArgsDict(TypedDict):
        route_name: pulumi.Input[builtins.str]
        """
        The name of the Cloud Run Service that this DomainMapping applies to.
        The route must exist.
        """
        certificate_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DomainMappingSpecArgs:
    def __init__(__self__, *,
                 ...
                 force_override: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] route_name: The name of the Cloud Run Service that this DomainMapping applies to.
               The route must exist.
    ...
    def route_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the Cloud Run Service that this DomainMapping applies to.
        The route must exist.
        """
    ...
    @route_name.setter
    def route_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "route_name", value)

    @property
    @pulumi.getter(name="certificateMode")
    def certificate_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The mode of the certificate.
        Default value is `AUTOMATIC`.
        Possible values are: `NONE`, `AUTOMATIC`.
    ...
    def force_override(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If set, the mapping will override any mapping set before this spec was set.
        It is recommended that the user leaves this empty to receive an error
        warning about a potential conflict and only set it once the respective UI
    ...
    def force_override(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DomainMappingStatusArgsDict(TypedDict):
        ...
        """
        mapped_route_name: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class DomainMappingStatusArgs:
    def __init__(__self__, *,
                 ...
                 mapped_route_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainMappingStatusConditionArgs']]] conditions: (Output)
               ...
               of the DomainMapping.
               Structure is documented below.
        :param pulumi.Input[builtins.str] mapped_route_name: (Output)
               The name of the route that the mapping currently points to.
        :param pulumi.Input[builtins.int] observed_generation: (Output)
               ObservedGeneration is the 'Generation' of the DomainMapping that
               was last processed by the controller.
    ...
    def mapped_route_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The name of the route that the mapping currently points to.
        """
    ...
    def mapped_route_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainMappingStatusResourceRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rrdata: (Output)
               Data for this record. Values vary by record type, as defined in RFC 1035
               (section 5) and RFC 1034 (section 3.6.1).
        :param pulumi.Input[builtins.str] type: Resource record type. Example: `AAAA`.
               Possible values are: `A`, `AAAA`, `CNAME`.
...
if not MYPY:
    class ServiceStatusArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        latest_created_revision_name: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        ...
        """
        latest_ready_revision_name: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class ServiceStatusArgs:
    def __init__(__self__, *,
                 ...
                 latest_created_revision_name: Optional[pulumi.Input[builtins.str]] = None,
                 latest_ready_revision_name: Optional[pulumi.Input[builtins.str]] = None,
                 observed_generation: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServiceStatusConditionArgs']]] conditions: (Output)
               Array of observed Service Conditions, indicating the current ready state of the service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] latest_created_revision_name: (Output)
               From ConfigurationStatus. LatestCreatedRevisionName is the last revision that was created
               from this Service's Configuration. It might not be ready yet, for that use
               LatestReadyRevisionName.
        :param pulumi.Input[builtins.str] latest_ready_revision_name: (Output)
               From ConfigurationStatus. LatestReadyRevisionName holds the name of the latest Revision
               stamped out from this Service's Configuration that has had its "Ready" condition become
               "True".
        :param pulumi.Input[builtins.int] observed_generation: (Output)
    ...
    def latest_created_revision_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        From ConfigurationStatus. LatestCreatedRevisionName is the last revision that was created
        from this Service's Configuration. It might not be ready yet, for that use
    ...
    def latest_created_revision_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "latest_created_revision_name", value)

    @property
    @pulumi.getter(name="latestReadyRevisionName")
    def latest_ready_revision_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        From ConfigurationStatus. LatestReadyRevisionName holds the name of the latest Revision
        stamped out from this Service's Configuration that has had its "Ready" condition become
    ...
    def latest_ready_revision_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceStatusTrafficArgs:
    def __init__(__self__, *,
                 ...
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] latest_revision: LatestRevision may be optionally provided to indicate that the latest ready
               Revision of the Configuration should be used for this traffic target. When
               provided LatestRevision must be true if RevisionName is empty; it must be
               false when RevisionName is non-empty.
        :param pulumi.Input[builtins.int] percent: Percent specifies percent of the traffic to this Revision or Configuration.
        :param pulumi.Input[builtins.str] revision_name: RevisionName of a specific revision to which to send this portion of traffic.
        :param pulumi.Input[builtins.str] tag: Tag is optionally used to expose a dedicated url for referencing this target exclusively.
        :param pulumi.Input[builtins.str] url: (Output)
               URL displays the URL for accessing tagged traffic targets. URL is displayed in status,
               and is disallowed on spec. URL must contain a scheme (e.g. http://) and a hostname,
               but may not contain anything else (e.g. basic auth, url path, etc.)
...
if not MYPY:
    class ServiceTemplateSpecArgsDict(TypedDict):
        container_concurrency: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        serving_state: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output, Deprecated)
...
class ServiceTemplateSpecArgs:
    def __init__(__self__, *,
                 container_concurrency: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 serving_state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] container_concurrency: ContainerConcurrency specifies the maximum allowed in-flight (concurrent)
               requests per container of the Revision. If not specified or 0, defaults to 80 when
               requested CPU >= 1 and defaults to 1 when requested CPU < 1.
        :param pulumi.Input[Sequence[pulumi.Input['ServiceTemplateSpecContainerArgs']]] containers: Containers defines the unit of execution for this Revision.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] node_selector: Node Selector describes the hardware requirements of the resources.
               Use the following node selector keys to configure features on a Revision:
               - `run.googleapis.com/accelerator` sets the [type of GPU](https://cloud.google.com/run/docs/configuring/services/gpu) required by the Revision to run.
        :param pulumi.Input[builtins.str] service_account_name: Email address of the IAM service account associated with the revision of the
               service. The service account represents the identity of the running revision,
               and determines what permissions the revision has. If not provided, the revision
               will use the project's default service account.
        :param pulumi.Input[builtins.str] serving_state: (Output, Deprecated)
               ServingState holds a value describing the state the resources
               are in for this Revision.
               It is expected
               that the system will manipulate this based on routability and load.
               ...
               > **Warning:** `serving_state` is deprecated and will be removed in a future major release. This field is not supported by the Cloud Run API.
        :param pulumi.Input[builtins.int] timeout_seconds: TimeoutSeconds holds the max duration the instance is allowed for responding to a request.
    ...
    def container_concurrency(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        ContainerConcurrency specifies the maximum allowed in-flight (concurrent)
        requests per container of the Revision. If not specified or 0, defaults to 80 when
        requested CPU >= 1 and defaults to 1 when requested CPU < 1.
    ...
    def container_concurrency(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def serving_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output, Deprecated)
        ServingState holds a value describing the state the resources
        are in for this Revision.
    ...
    def serving_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceTemplateSpecContainerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] image: Docker image name. This is most often a reference to a container located
               in the container registry, such as gcr.io/cloudrun/hello
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: Arguments to the entrypoint.
               The docker image's CMD is used if this is not provided.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commands: Entrypoint array. Not executed within a shell.
               The docker image's ENTRYPOINT is used if this is not provided.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServiceTemplateSpecContainerVolumeMountArgs']]] volume_mounts: Volume to mount into the container's filesystem.
               Only supports SecretVolumeSources.
               Structure is documented below.
        :param pulumi.Input[builtins.str] working_dir: (Optional, Deprecated)
               Container's working directory.
               If not specified, the container runtime's default will be used, which
               might be configured in the container image.
...
class ServiceTemplateSpecContainerEnvArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: Defaults to "".
...
class ServiceTemplateSpecContainerEnvFromArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServiceTemplateSpecContainerEnvFromConfigMapRefArgs'] config_map_ref: The ConfigMap to select from.
               Structure is documented below.
        :param pulumi.Input[builtins.str] prefix: An optional identifier to prepend to each key in the ConfigMap.
...
class ServiceTemplateSpecContainerEnvFromConfigMapRefArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceArgs'] local_object_reference: The ConfigMap to select from.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] optional: Specify whether the ConfigMap must be defined
        """
...
class ServiceTemplateSpecContainerEnvFromSecretRefArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceArgs'] local_object_reference: The Secret to select from.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] optional: Specify whether the Secret must be defined
        """
        if local_object_reference is not None:
            pulumi.set(__self__, "local_object_reference", local_object_reference)
        if optional is not None:
...
class ServiceTemplateSpecContainerEnvValueFromSecretKeyRefArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: A Cloud Secret Manager secret version. Must be 'latest' for the latest
               version or an integer for a specific version.
        :param pulumi.Input[builtins.str] name: The name of the secret in Cloud Secret Manager. By default, the secret is assumed to be in the same project.
               If the secret is in another project, you must define an alias.
               An alias definition has the form:
               {alias}:projects/{project-id|project-number}/secrets/{secret-name}.
               If multiple alias definitions are needed, they must be separated by commas.
...
class ServiceTemplateSpecContainerPortArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] container_port: Port number the container listens on. This must be a valid port number (between 1 and 65535). Defaults to "8080".
        :param pulumi.Input[builtins.str] name: If specified, used to specify which protocol to use. Allowed values are "http1" (HTTP/1) and "h2c" (HTTP/2 end-to-end). Defaults to "http1".
        :param pulumi.Input[builtins.str] protocol: Protocol for port. Must be "TCP". Defaults to "TCP".
        """
...
class ServiceTemplateSpecContainerResourcesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] limits: Limits describes the maximum amount of compute resources allowed.
               The values of the map is string form of the 'quantity' k8s type:
               https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] requests: Requests describes the minimum amount of compute resources required.
               If Requests is omitted for a container, it defaults to Limits if that is
               explicitly specified, otherwise to an implementation-defined value.
               The values of the map is string form of the 'quantity' k8s type:
               https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/apimachinery/pkg/api/resource/quantity.go
...
if not MYPY:
    class ServiceTemplateSpecVolumeCsiArgsDict(TypedDict):
        ...
        * gcsfuse.run.googleapis.com: Mount a Google Cloud Storage bucket using GCSFuse. This driver requires the
        ...
        """
        volume_attributes: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ServiceTemplateSpecVolumeCsiArgs:
    def __init__(__self__, *,
                 ...
                 volume_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] driver: Unique name representing the type of file system to be created. Cloud Run supports the following values:
               * gcsfuse.run.googleapis.com: Mount a Google Cloud Storage bucket using GCSFuse. This driver requires the
               run.googleapis.com/execution-environment annotation to be unset or set to "gen2"
        :param pulumi.Input[builtins.bool] read_only: If true, all mounts created from this volume will be read-only.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] volume_attributes: Driver-specific attributes. The following options are supported for available drivers:
               * gcsfuse.run.googleapis.com
               * bucketName: The name of the Cloud Storage Bucket that backs this volume. The Cloud Run Service identity must have access to this bucket.
        """
    ...
    def volume_attributes(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Driver-specific attributes. The following options are supported for available drivers:
        * gcsfuse.run.googleapis.com
        * bucketName: The name of the Cloud Storage Bucket that backs this volume. The Cloud Run Service identity must have access to this bucket.
    ...
    def volume_attributes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class ServiceTemplateSpecVolumeEmptyDirArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] medium: The medium on which the data is stored. The default is "" which means to use the node's default medium. Must be an empty string (default) or Memory.
...
class ServiceTemplateSpecVolumeSecretArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] secret_name: The name of the secret in Cloud Secret Manager. By default, the secret
               is assumed to be in the same project.
               If the secret is in another project, you must define an alias.
               An alias definition has the form:
               {alias}:projects/{project-id|project-number}/secrets/{secret-name}.
               ...
               The alias definitions must be set on the run.googleapis.com/secrets
               annotation.
        :param pulumi.Input[builtins.int] default_mode: Mode bits to use on created files by default. Must be a value between 0000
               and 0777. Defaults to 0644. Directories within the path are not affected by
               this setting. This might be in conflict with other options that affect the
               file mode, like fsGroup, and the result can be other mode bits set.
...
class ServiceTemplateSpecVolumeSecretItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The Cloud Secret Manager secret version.
               Can be 'latest' for the latest value or an integer for a specific version.
        :param pulumi.Input[builtins.str] path: The relative path of the file to map the key to.
               May not be an absolute path.
               May not contain the path element '..'.
               May not start with the string '..'.
        :param pulumi.Input[builtins.int] mode: Mode bits to use on this file, must be a value between 0000 and 0777. If
               not specified, the volume defaultMode will be used. This might be in
               conflict with other options that affect the file mode, like fsGroup, and
               the result can be other mode bits set.
        """
