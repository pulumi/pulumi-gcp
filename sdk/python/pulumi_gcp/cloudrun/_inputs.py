...
__all__ = [
    ...
    'ServiceTemplateSpecContainerReadinessProbeGrpcArgsDict',
    'ServiceTemplateSpecContainerReadinessProbeHttpGetArgs',
    'ServiceTemplateSpecContainerReadinessProbeHttpGetArgsDict',
...
class DomainMappingMetadataArgsDict(TypedDict):
    ...
    **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration.
    ...
    """
    effective_annotations: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
    (Output)
    All of annotations (key/value pairs) present on the resource in GCP, including the annotations configured through Terraform, other clients and services.
    """
    effective_labels: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
    (Output)
    ...
    **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
    ...
    """
    pulumi_labels: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class DomainMappingMetadataArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] namespace: In Cloud Run the namespace must be equal to either the
               project ID or project number.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] annotations: Annotations is a key value map stored with a resource that
               may be set by external tools to store and retrieve arbitrary metadata.
               More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations
               **Note**: The Cloud Run API may add additional annotations that were not provided in your config.
               If the provider plan shows a diff where a server-side annotation is added, you can add it to your config
               ...
               **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration.
               Please refer to the field `effective_annotations` for all of the annotations present on the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] effective_annotations: (Output)
               All of annotations (key/value pairs) present on the resource in GCP, including the annotations configured through Terraform, other clients and services.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] effective_labels: (Output)
               All of labels (key/value pairs) present on the resource in GCP, including the labels configured through Pulumi, other clients and services.
        :param pulumi.Input[_builtins.int] generation: (Output)
               A sequence number representing a specific generation of the desired state.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Map of string keys and values that can be used to organize and categorize
               (scope and select) objects. May match selectors of replication controllers
               and routes.
               More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
                and default labels configured on the provider.
        :param pulumi.Input[_builtins.str] resource_version: (Output)
               An opaque value that represents the internal version of this object that
               can be used by clients to determine when objects have changed. May be used
               for optimistic concurrency, change detection, and the watch operation on a
               resource or set of resources. They may only be valid for a
               ...
               More info:
               https://git.k8s.io/community/contributors/devel/api-conventions.md#concurrency-control-and-consistency
        :param pulumi.Input[_builtins.str] self_link: (Output)
               SelfLink is a URL representing this object.
...
class DomainMappingSpecArgsDict(TypedDict):
    ...
    """
    force_override: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class DomainMappingSpecArgs:
    def __init__(__self__, *,
                 ...
                 force_override: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] route_name: The name of the Cloud Run Service that this DomainMapping applies to.
               The route must exist.
        :param pulumi.Input[_builtins.str] certificate_mode: The mode of the certificate.
               Default value is `AUTOMATIC`.
               Possible values are: `NONE`, `AUTOMATIC`.
        :param pulumi.Input[_builtins.bool] force_override: If set, the mapping will override any mapping set before this spec was set.
               It is recommended that the user leaves this empty to receive an error
               warning about a potential conflict and only set it once the respective UI
               has given such a warning.
        """
    ...
    def force_override(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set, the mapping will override any mapping set before this spec was set.
        It is recommended that the user leaves this empty to receive an error
        warning about a potential conflict and only set it once the respective UI
    ...
    def force_override(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "force_override", value)


class DomainMappingStatusArgsDict(TypedDict):
    conditions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusConditionArgsDict']]]]]
    """
    (Output)
    ...
    """
    mapped_route_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
    ...
    """
    resource_records: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusResourceRecordArgsDict']]]]]
    """
...
class DomainMappingStatusArgs:
    def __init__(__self__, *,
                 conditions: pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusConditionArgs']]]] = None,
                 mapped_route_name: pulumi.Input[Optional[_builtins.str]] = None,
                 observed_generation: pulumi.Input[Optional[_builtins.int]] = None,
                 resource_records: pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusResourceRecordArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['DomainMappingStatusConditionArgs']]] conditions: (Output)
               Array of observed DomainMappingConditions, indicating the current state
               of the DomainMapping.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] mapped_route_name: (Output)
               The name of the route that the mapping currently points to.
        :param pulumi.Input[_builtins.int] observed_generation: (Output)
               ObservedGeneration is the 'Generation' of the DomainMapping that
               was last processed by the controller.
    ...
    @_builtins.property
    @pulumi.getter
    def conditions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusConditionArgs']]]]:
        """
        (Output)
        Array of observed DomainMappingConditions, indicating the current state
        of the DomainMapping.
    ...
    @conditions.setter
    def conditions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusConditionArgs']]]]):
        pulumi.set(self, "conditions", value)

    @_builtins.property
    @pulumi.getter(name="mappedRouteName")
    def mapped_route_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        The name of the route that the mapping currently points to.
        """
    ...
    def mapped_route_name(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def resource_records(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusResourceRecordArgs']]]]:
        """
        The resource records required to configure this domain mapping. These
        records must be added to the domain's DNS configuration in order to
        serve the application via this domain mapping.
    ...
    def resource_records(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainMappingStatusResourceRecordArgs']]]]):
...
class DomainMappingStatusResourceRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] rrdata: (Output)
               Data for this record. Values vary by record type, as defined in RFC 1035
               (section 5) and RFC 1034 (section 3.6.1).
        :param pulumi.Input[_builtins.str] type: Resource record type. Example: `AAAA`.
               Possible values are: `A`, `AAAA`, `CNAME`.
...
class ServiceStatusArgsDict(TypedDict):
    conditions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusConditionArgsDict']]]]]
    """
    (Output)
    Array of observed Service Conditions, indicating the current ready state of the service.
    Structure is documented below.
    """
    latest_created_revision_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
    ...
    """
    latest_ready_revision_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
    ...
    """
    traffics: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusTrafficArgsDict']]]]]
    """
...
class ServiceStatusArgs:
    def __init__(__self__, *,
                 conditions: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusConditionArgs']]]] = None,
                 latest_created_revision_name: pulumi.Input[Optional[_builtins.str]] = None,
                 latest_ready_revision_name: pulumi.Input[Optional[_builtins.str]] = None,
                 observed_generation: pulumi.Input[Optional[_builtins.int]] = None,
                 traffics: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusTrafficArgs']]]] = None,
                 url: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['ServiceStatusConditionArgs']]] conditions: (Output)
               Array of observed Service Conditions, indicating the current ready state of the service.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] latest_created_revision_name: (Output)
               From ConfigurationStatus. LatestCreatedRevisionName is the last revision that was created
               from this Service's Configuration. It might not be ready yet, for that use
               LatestReadyRevisionName.
        :param pulumi.Input[_builtins.str] latest_ready_revision_name: (Output)
               From ConfigurationStatus. LatestReadyRevisionName holds the name of the latest Revision
               stamped out from this Service's Configuration that has had its "Ready" condition become
               "True".
        :param pulumi.Input[_builtins.int] observed_generation: (Output)
    ...
    @_builtins.property
    @pulumi.getter
    def conditions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusConditionArgs']]]]:
        """
        (Output)
        Array of observed Service Conditions, indicating the current ready state of the service.
        Structure is documented below.
    ...
    @conditions.setter
    def conditions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusConditionArgs']]]]):
        pulumi.set(self, "conditions", value)

    @_builtins.property
    @pulumi.getter(name="latestCreatedRevisionName")
    def latest_created_revision_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        From ConfigurationStatus. LatestCreatedRevisionName is the last revision that was created
        from this Service's Configuration. It might not be ready yet, for that use
    ...
    def latest_created_revision_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "latest_created_revision_name", value)

    @_builtins.property
    @pulumi.getter(name="latestReadyRevisionName")
    def latest_ready_revision_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        From ConfigurationStatus. LatestReadyRevisionName holds the name of the latest Revision
        stamped out from this Service's Configuration that has had its "Ready" condition become
    ...
    def latest_ready_revision_name(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def traffics(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusTrafficArgs']]]]:
        """
        Traffic specifies how to distribute traffic over a collection of Knative Revisions
        and Configurations
        Structure is documented below.
    ...
    @traffics.setter
    def traffics(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceStatusTrafficArgs']]]]):
...
class ServiceStatusTrafficArgs:
    def __init__(__self__, *,
                 ...
                 url: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.bool] latest_revision: LatestRevision may be optionally provided to indicate that the latest ready
               Revision of the Configuration should be used for this traffic target. When
               provided LatestRevision must be true if RevisionName is empty; it must be
               false when RevisionName is non-empty.
        :param pulumi.Input[_builtins.int] percent: Percent specifies percent of the traffic to this Revision or Configuration.
        :param pulumi.Input[_builtins.str] revision_name: RevisionName of a specific revision to which to send this portion of traffic.
        :param pulumi.Input[_builtins.str] tag: Tag is optionally used to expose a dedicated url for referencing this target exclusively.
        :param pulumi.Input[_builtins.str] url: (Output)
               URL displays the URL for accessing tagged traffic targets. URL is displayed in status,
               and is disallowed on spec. URL must contain a scheme (e.g. http://) and a hostname,
               but may not contain anything else (e.g. basic auth, url path, etc.)
...
class ServiceTemplateArgsDict(TypedDict):
    metadata: NotRequired[pulumi.Input[Optional['ServiceTemplateMetadataArgsDict']]]
    """
    ...
    Structure is documented below.
    """
    spec: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecArgsDict']]]
    """
...
class ServiceTemplateArgs:
    def __init__(__self__, *,
                 metadata: pulumi.Input[Optional['ServiceTemplateMetadataArgs']] = None,
                 spec: pulumi.Input[Optional['ServiceTemplateSpecArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def metadata(self) -> pulumi.Input[Optional['ServiceTemplateMetadataArgs']]:
        """
        Optional metadata for this Revision, including labels and annotations.
        Name will be generated by the Configuration. To set minimum instances
        for this revision, use the "autoscaling.knative.dev/minScale" annotation
    ...
    @metadata.setter
    def metadata(self, value: pulumi.Input[Optional['ServiceTemplateMetadataArgs']]):
        pulumi.set(self, "metadata", value)

    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['ServiceTemplateSpecArgs']]:
        """
        RevisionSpec holds the desired state of the Revision (from the client).
        Structure is documented below.
        """
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['ServiceTemplateSpecArgs']]):
...
class ServiceTemplateSpecArgsDict(TypedDict):
    ...
    """
    containers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerArgsDict']]]]]
    """
    ...
    """
    serving_state: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output, Deprecated)
    ...
    """
    volumes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeArgsDict']]]]]
    """
...
class ServiceTemplateSpecArgs:
    def __init__(__self__, *,
                 ...
                 containers: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerArgs']]]] = None,
                 ...
                 serving_state: pulumi.Input[Optional[_builtins.str]] = None,
                 timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 volumes: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeArgs']]]] = None):
        """
        :param pulumi.Input[_builtins.int] container_concurrency: ContainerConcurrency specifies the maximum allowed in-flight (concurrent)
               requests per container of the Revision. If not specified or 0, defaults to 80 when
               requested CPU >= 1 and defaults to 1 when requested CPU < 1.
        :param pulumi.Input[Sequence[pulumi.Input['ServiceTemplateSpecContainerArgs']]] containers: Containers defines the unit of execution for this Revision.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] node_selector: Node Selector describes the hardware requirements of the resources.
               Use the following node selector keys to configure features on a Revision:
               - `run.googleapis.com/accelerator` sets the [type of GPU](https://cloud.google.com/run/docs/configuring/services/gpu) required by the Revision to run.
        :param pulumi.Input[_builtins.str] service_account_name: Email address of the IAM service account associated with the revision of the
               service. The service account represents the identity of the running revision,
               and determines what permissions the revision has. If not provided, the revision
               will use the project's default service account.
        :param pulumi.Input[_builtins.str] serving_state: (Output, Deprecated)
               ServingState holds a value describing the state the resources
               are in for this Revision.
               It is expected
               that the system will manipulate this based on routability and load.
               ...
               > **Warning:** `serving_state` is deprecated and will be removed in a future major release. This field is not supported by the Cloud Run API.
        :param pulumi.Input[_builtins.int] timeout_seconds: TimeoutSeconds holds the max duration the instance is allowed for responding to a request.
    ...
    @_builtins.property
    @pulumi.getter
    def containers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerArgs']]]]:
        """
        Containers defines the unit of execution for this Revision.
        Structure is documented below.
        """
    ...
    @containers.setter
    def containers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerArgs']]]]):
    ...
    def serving_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output, Deprecated)
        ServingState holds a value describing the state the resources
        are in for this Revision.
    ...
    def serving_state(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def volumes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeArgs']]]]:
        """
        Volume represents a named volume in a container.
        Structure is documented below.
        """
    ...
    @volumes.setter
    def volumes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeArgs']]]]):
...
class ServiceTemplateSpecContainerArgsDict(TypedDict):
    ...
    """
    env_froms: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvFromArgsDict']]]]]
    """
    (Optional, Deprecated)
    ...
    """
    envs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvArgsDict']]]]]
    """
    List of environment variables to set in the container.
    Structure is documented below.
    """
    liveness_probe: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeArgsDict']]]
    """
    ...
    """
    ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerPortArgsDict']]]]]
    """
    List of open ports in the container.
    Structure is documented below.
    """
    readiness_probe: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeArgsDict']]]
    """
    Periodic probe of container readiness.
    Structure is documented below.
    """
    resources: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerResourcesArgsDict']]]
    """
    ...
    Structure is documented below.
    """
    volume_mounts: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerVolumeMountArgsDict']]]]]
    """
...
class ServiceTemplateSpecContainerArgs:
    def __init__(__self__, *,
                 ...
                 env_froms: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvFromArgs']]]] = None,
                 envs: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvArgs']]]] = None,
                 liveness_probe: pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        """
        :param pulumi.Input[_builtins.str] image: Docker image name. This is most often a reference to a container located
               in the container registry, such as gcr.io/cloudrun/hello
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] args: Arguments to the entrypoint.
               The docker image's CMD is used if this is not provided.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] commands: Entrypoint array. Not executed within a shell.
               The docker image's ENTRYPOINT is used if this is not provided.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServiceTemplateSpecContainerPortArgs']]] ports: List of open ports in the container.
               Structure is documented below.
        :param pulumi.Input['ServiceTemplateSpecContainerReadinessProbeArgs'] readiness_probe: Periodic probe of container readiness.
               Structure is documented below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServiceTemplateSpecContainerVolumeMountArgs']]] volume_mounts: Volume to mount into the container's filesystem.
               Only supports SecretVolumeSources.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] working_dir: (Optional, Deprecated)
               Container's working directory.
               If not specified, the container runtime's default will be used, which
               might be configured in the container image.
    ...
    def env_froms(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvFromArgs']]]]:
        """
        (Optional, Deprecated)
        List of sources to populate environment variables in the container.
        All invalid keys will be reported as an event when the container is starting.
    ...
    @env_froms.setter
    def env_froms(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvFromArgs']]]]):
        pulumi.set(self, "env_froms", value)

    @_builtins.property
    @pulumi.getter
    def envs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvArgs']]]]:
        """
        List of environment variables to set in the container.
        Structure is documented below.
        """
    ...
    @envs.setter
    def envs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerEnvArgs']]]]):
        pulumi.set(self, "envs", value)

    @_builtins.property
    @pulumi.getter(name="livenessProbe")
    def liveness_probe(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeArgs']]:
        """
        Periodic probe of container liveness. Container will be restarted if the probe fails. More info:
        https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
        Structure is documented below.
    ...
    def liveness_probe(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def ports(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerPortArgs']]]]:
        """
        List of open ports in the container.
        Structure is documented below.
        """
    ...
    @ports.setter
    def ports(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerPortArgs']]]]):
        pulumi.set(self, "ports", value)

    @_builtins.property
    @pulumi.getter(name="readinessProbe")
    def readiness_probe(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeArgs']]:
        """
        Periodic probe of container readiness.
        Structure is documented below.
        """
    ...
    def readiness_probe(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeArgs']]):
        pulumi.set(self, "readiness_probe", value)

    @_builtins.property
    @pulumi.getter
    def resources(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerResourcesArgs']]:
        """
        Compute Resources required by this container. Used to set values such as max memory
        Structure is documented below.
        """
    ...
    def startup_probe(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeArgs']]:
        """
        Startup probe of application within the container.
        All other probes are disabled if a startup probe is provided, until it
        succeeds. Container will not be added to service endpoints if the probe fails.
    ...
    def startup_probe(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeArgs']]):
        pulumi.set(self, "startup_probe", value)

    @_builtins.property
    @pulumi.getter(name="volumeMounts")
    def volume_mounts(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerVolumeMountArgs']]]]:
        """
        Volume to mount into the container's filesystem.
        Only supports SecretVolumeSources.
        Structure is documented below.
    ...
    def volume_mounts(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerVolumeMountArgs']]]]):
...
class ServiceTemplateSpecContainerEnvArgsDict(TypedDict):
    ...
    Defaults to "".
    """
    value_from: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerEnvValueFromArgsDict']]]
    """
...
class ServiceTemplateSpecContainerEnvArgs:
    def __init__(__self__, *,
                 ...
                 value_from: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvValueFromArgs']] = None):
        """
        :param pulumi.Input[_builtins.str] name: Name of the environment variable.
        :param pulumi.Input[_builtins.str] value: Defaults to "".
    ...
    def value_from(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerEnvValueFromArgs']]:
        """
        Source for the environment variable's value. Only supports secret_key_ref.
        Structure is documented below.
        """
    ...
    @value_from.setter
    def value_from(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvValueFromArgs']]):
        pulumi.set(self, "value_from", value)


class ServiceTemplateSpecContainerEnvFromArgsDict(TypedDict):
    config_map_ref: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefArgsDict']]]
    """
    ...
    """
    secret_ref: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefArgsDict']]]
    """
...
class ServiceTemplateSpecContainerEnvFromArgs:
    def __init__(__self__, *,
                 config_map_ref: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefArgs']] = None,
                 prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 secret_ref: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefArgs']] = None):
        """
        :param pulumi.Input['ServiceTemplateSpecContainerEnvFromConfigMapRefArgs'] config_map_ref: The ConfigMap to select from.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] prefix: An optional identifier to prepend to each key in the ConfigMap.
    ...
    def config_map_ref(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefArgs']]:
        """
        The ConfigMap to select from.
        Structure is documented below.
        """
    ...
    def config_map_ref(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefArgs']]):
    ...
    def secret_ref(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefArgs']]:
        """
        The Secret to select from.
        Structure is documented below.
        """
    ...
    @secret_ref.setter
    def secret_ref(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefArgs']]):
        pulumi.set(self, "secret_ref", value)


class ServiceTemplateSpecContainerEnvFromConfigMapRefArgsDict(TypedDict):
    local_object_reference: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceArgsDict']]]
    """
    The ConfigMap to select from.
    Structure is documented below.
    """
...
class ServiceTemplateSpecContainerEnvFromConfigMapRefArgs:
    def __init__(__self__, *,
                 local_object_reference: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceArgs']] = None,
        ...
        :param pulumi.Input['ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceArgs'] local_object_reference: The ConfigMap to select from.
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] optional: Specify whether the ConfigMap must be defined
        """
    ...
    def local_object_reference(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceArgs']]:
        """
        The ConfigMap to select from.
        Structure is documented below.
        """
    ...
    def local_object_reference(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromConfigMapRefLocalObjectReferenceArgs']]):
...
class ServiceTemplateSpecContainerEnvFromSecretRefArgsDict(TypedDict):
    local_object_reference: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceArgsDict']]]
    """
    The Secret to select from.
    Structure is documented below.
    """
...
class ServiceTemplateSpecContainerEnvFromSecretRefArgs:
    def __init__(__self__, *,
                 local_object_reference: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceArgs']] = None,
                 optional: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input['ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceArgs'] local_object_reference: The Secret to select from.
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] optional: Specify whether the Secret must be defined
        """
        if local_object_reference is not None:
            pulumi.set(__self__, "local_object_reference", local_object_reference)
        if optional is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="localObjectReference")
    def local_object_reference(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceArgs']]:
        """
        The Secret to select from.
        Structure is documented below.
        """
    ...
    @local_object_reference.setter
    def local_object_reference(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerEnvFromSecretRefLocalObjectReferenceArgs']]):
        pulumi.set(self, "local_object_reference", value)
...
class ServiceTemplateSpecContainerEnvValueFromSecretKeyRefArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] key: A Cloud Secret Manager secret version. Must be 'latest' for the latest
               version or an integer for a specific version.
        :param pulumi.Input[_builtins.str] name: The name of the secret in Cloud Secret Manager. By default, the secret is assumed to be in the same project.
               If the secret is in another project, you must define an alias.
               An alias definition has the form:
               {alias}:projects/{project-id|project-number}/secrets/{secret-name}.
               If multiple alias definitions are needed, they must be separated by commas.
...
class ServiceTemplateSpecContainerLivenessProbeArgsDict(TypedDict):
    ...
    """
    grpc: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeGrpcArgsDict']]]
    """
    GRPC specifies an action involving a GRPC port.
    Structure is documented below.
    """
    http_get: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeHttpGetArgsDict']]]
    """
...
class ServiceTemplateSpecContainerLivenessProbeArgs:
    def __init__(__self__, *,
                 ...
                 grpc: pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeGrpcArgs']] = None,
                 http_get: pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeHttpGetArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def grpc(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeGrpcArgs']]:
        """
        GRPC specifies an action involving a GRPC port.
        Structure is documented below.
        """
    ...
    @grpc.setter
    def grpc(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeGrpcArgs']]):
        pulumi.set(self, "grpc", value)

    @_builtins.property
    @pulumi.getter(name="httpGet")
    def http_get(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeHttpGetArgs']]:
        """
        HttpGet specifies the http request to perform.
        Structure is documented below.
        """
    ...
    @http_get.setter
    def http_get(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerLivenessProbeHttpGetArgs']]):
...
class ServiceTemplateSpecContainerLivenessProbeHttpGetArgsDict(TypedDict):
    http_headers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerLivenessProbeHttpGetHttpHeaderArgsDict']]]]]
    """
...
class ServiceTemplateSpecContainerLivenessProbeHttpGetArgs:
    def __init__(__self__, *,
                 http_headers: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerLivenessProbeHttpGetHttpHeaderArgs']]]] = None,
    ...
    def http_headers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerLivenessProbeHttpGetHttpHeaderArgs']]]]:
        """
        Custom headers to set in the request. HTTP allows repeated headers.
        Structure is documented below.
        """
    ...
    @http_headers.setter
    def http_headers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerLivenessProbeHttpGetHttpHeaderArgs']]]]):
...
class ServiceTemplateSpecContainerPortArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] container_port: Port number the container listens on. This must be a valid port number (between 1 and 65535). Defaults to "8080".
        :param pulumi.Input[_builtins.str] name: If specified, used to specify which protocol to use. Allowed values are "http1" (HTTP/1) and "h2c" (HTTP/2 end-to-end). Defaults to "http1".
        :param pulumi.Input[_builtins.str] protocol: Protocol for port. Must be "TCP". Defaults to "TCP".
        """
...
class ServiceTemplateSpecContainerReadinessProbeArgsDict(TypedDict):
    ...
    """
    grpc: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeGrpcArgsDict']]]
    """
    GRPC specifies an action involving a GRPC port.
    Structure is documented below.
    """
    http_get: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeHttpGetArgsDict']]]
    """
    HttpGet specifies the http request to perform.
    Structure is documented below.
    """
...
class ServiceTemplateSpecContainerReadinessProbeArgs:
    def __init__(__self__, *,
                 failure_threshold: pulumi.Input[Optional[_builtins.int]] = None,
                 grpc: pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeGrpcArgs']] = None,
                 http_get: pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeHttpGetArgs']] = None,
                 period_seconds: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.int] failure_threshold: Minimum consecutive failures for the probe to be considered failed after
               having succeeded. Defaults to 3.
        :param pulumi.Input['ServiceTemplateSpecContainerReadinessProbeGrpcArgs'] grpc: GRPC specifies an action involving a GRPC port.
               Structure is documented below.
        :param pulumi.Input['ServiceTemplateSpecContainerReadinessProbeHttpGetArgs'] http_get: HttpGet specifies the http request to perform.
               Structure is documented below.
        :param pulumi.Input[_builtins.int] period_seconds: How often (in seconds) to perform the probe.
               Default to 10 seconds.
    ...
    @_builtins.property
    @pulumi.getter
    def grpc(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeGrpcArgs']]:
        """
        GRPC specifies an action involving a GRPC port.
        Structure is documented below.
        """
    ...
    @grpc.setter
    def grpc(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeGrpcArgs']]):
        pulumi.set(self, "grpc", value)

    @_builtins.property
    @pulumi.getter(name="httpGet")
    def http_get(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeHttpGetArgs']]:
        """
        HttpGet specifies the http request to perform.
        Structure is documented below.
        """
    ...
    @http_get.setter
    def http_get(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerReadinessProbeHttpGetArgs']]):
        pulumi.set(self, "http_get", value)
...
class ServiceTemplateSpecContainerStartupProbeArgsDict(TypedDict):
    ...
    having succeeded. Defaults to 3. Minimum value is 1.
    """
    grpc: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeGrpcArgsDict']]]
    """
    GRPC specifies an action involving a GRPC port.
    Structure is documented below.
    """
    http_get: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeHttpGetArgsDict']]]
    """
    HttpGet specifies the http request to perform.
    Structure is documented below.
    """
    ...
    """
    tcp_socket: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeTcpSocketArgsDict']]]
    """
...
class ServiceTemplateSpecContainerStartupProbeArgs:
    def __init__(__self__, *,
                 failure_threshold: pulumi.Input[Optional[_builtins.int]] = None,
                 grpc: pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeGrpcArgs']] = None,
                 http_get: pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeHttpGetArgs']] = None,
                 initial_delay_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 period_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 tcp_socket: pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeTcpSocketArgs']] = None,
                 timeout_seconds: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.int] failure_threshold: Minimum consecutive failures for the probe to be considered failed after
               having succeeded. Defaults to 3. Minimum value is 1.
    ...
    @_builtins.property
    @pulumi.getter
    def grpc(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeGrpcArgs']]:
        """
        GRPC specifies an action involving a GRPC port.
        Structure is documented below.
        """
    ...
    @grpc.setter
    def grpc(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeGrpcArgs']]):
        pulumi.set(self, "grpc", value)

    @_builtins.property
    @pulumi.getter(name="httpGet")
    def http_get(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeHttpGetArgs']]:
        """
        HttpGet specifies the http request to perform.
        Structure is documented below.
        """
    ...
    @http_get.setter
    def http_get(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeHttpGetArgs']]):
        pulumi.set(self, "http_get", value)
    ...
    def tcp_socket(self) -> pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeTcpSocketArgs']]:
        """
        TcpSocket specifies an action involving a TCP port.
        Structure is documented below.
        """
    ...
    @tcp_socket.setter
    def tcp_socket(self, value: pulumi.Input[Optional['ServiceTemplateSpecContainerStartupProbeTcpSocketArgs']]):
...
class ServiceTemplateSpecContainerStartupProbeHttpGetArgsDict(TypedDict):
    http_headers: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeaderArgsDict']]]]]
    """
    Custom headers to set in the request. HTTP allows repeated headers.
    Structure is documented below.
    """
...
class ServiceTemplateSpecContainerStartupProbeHttpGetArgs:
    def __init__(__self__, *,
                 http_headers: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeaderArgs']]]] = None,
                 path: pulumi.Input[Optional[_builtins.str]] = None,
                 port: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="httpHeaders")
    def http_headers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeaderArgs']]]]:
        """
        Custom headers to set in the request. HTTP allows repeated headers.
        Structure is documented below.
        """
    ...
    @http_headers.setter
    def http_headers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecContainerStartupProbeHttpGetHttpHeaderArgs']]]]):
        pulumi.set(self, "http_headers", value)
...
class ServiceTemplateSpecVolumeArgsDict(TypedDict):
    ...
    Volume's name.
    """
    csi: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecVolumeCsiArgsDict']]]
    """
    A filesystem specified by the Container Storage Interface (CSI).
    Structure is documented below.
    """
    empty_dir: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecVolumeEmptyDirArgsDict']]]
    """
    Ephemeral storage which can be backed by real disks (HD, SSD), network storage or memory (i.e. tmpfs). For now only in memory (tmpfs) is supported. It is ephemeral in the sense that when the sandbox is taken down, the data is destroyed with it (it does not persist across sandbox runs).
    Structure is documented below.
    """
    nfs: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecVolumeNfsArgsDict']]]
    """
    A filesystem backed by a Network File System share. This filesystem requires the
    run.googleapis.com/execution-environment annotation to be unset or set to "gen2"
    Structure is documented below.
    """
    secret: NotRequired[pulumi.Input[Optional['ServiceTemplateSpecVolumeSecretArgsDict']]]
    """
...
class ServiceTemplateSpecVolumeArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[_builtins.str],
                 csi: pulumi.Input[Optional['ServiceTemplateSpecVolumeCsiArgs']] = None,
                 empty_dir: pulumi.Input[Optional['ServiceTemplateSpecVolumeEmptyDirArgs']] = None,
                 nfs: pulumi.Input[Optional['ServiceTemplateSpecVolumeNfsArgs']] = None,
                 secret: pulumi.Input[Optional['ServiceTemplateSpecVolumeSecretArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def csi(self) -> pulumi.Input[Optional['ServiceTemplateSpecVolumeCsiArgs']]:
        """
        A filesystem specified by the Container Storage Interface (CSI).
        Structure is documented below.
        """
    ...
    @csi.setter
    def csi(self, value: pulumi.Input[Optional['ServiceTemplateSpecVolumeCsiArgs']]):
        pulumi.set(self, "csi", value)

    @_builtins.property
    @pulumi.getter(name="emptyDir")
    def empty_dir(self) -> pulumi.Input[Optional['ServiceTemplateSpecVolumeEmptyDirArgs']]:
        """
        Ephemeral storage which can be backed by real disks (HD, SSD), network storage or memory (i.e. tmpfs). For now only in memory (tmpfs) is supported. It is ephemeral in the sense that when the sandbox is taken down, the data is destroyed with it (it does not persist across sandbox runs).
        Structure is documented below.
        """
    ...
    @empty_dir.setter
    def empty_dir(self, value: pulumi.Input[Optional['ServiceTemplateSpecVolumeEmptyDirArgs']]):
        pulumi.set(self, "empty_dir", value)

    @_builtins.property
    @pulumi.getter
    def nfs(self) -> pulumi.Input[Optional['ServiceTemplateSpecVolumeNfsArgs']]:
        """
        A filesystem backed by a Network File System share. This filesystem requires the
        run.googleapis.com/execution-environment annotation to be unset or set to "gen2"
        Structure is documented below.
    ...
    @nfs.setter
    def nfs(self, value: pulumi.Input[Optional['ServiceTemplateSpecVolumeNfsArgs']]):
        pulumi.set(self, "nfs", value)

    @_builtins.property
    @pulumi.getter
    def secret(self) -> pulumi.Input[Optional['ServiceTemplateSpecVolumeSecretArgs']]:
        """
        The secret's value will be presented as the content of a file whose
        name is defined in the item path. If no items are defined, the name of
        the file is the secret_name.
    ...
    @secret.setter
    def secret(self, value: pulumi.Input[Optional['ServiceTemplateSpecVolumeSecretArgs']]):
...
class ServiceTemplateSpecVolumeCsiArgsDict(TypedDict):
    ...
    * gcsfuse.run.googleapis.com: Mount a Google Cloud Storage bucket using GCSFuse. This driver requires the
    ...
    """
    volume_attributes: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class ServiceTemplateSpecVolumeCsiArgs:
    def __init__(__self__, *,
                 ...
                 volume_attributes: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        :param pulumi.Input[_builtins.str] driver: Unique name representing the type of file system to be created. Cloud Run supports the following values:
               * gcsfuse.run.googleapis.com: Mount a Google Cloud Storage bucket using GCSFuse. This driver requires the
                 run.googleapis.com/execution-environment annotation to be unset or set to "gen2"
        :param pulumi.Input[_builtins.bool] read_only: If true, all mounts created from this volume will be read-only.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] volume_attributes: Driver-specific attributes. The following options are supported for available drivers:
               * gcsfuse.run.googleapis.com
               * bucketName: The name of the Cloud Storage Bucket that backs this volume. The Cloud Run Service identity must have access to this bucket.
        """
    ...
    def volume_attributes(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Driver-specific attributes. The following options are supported for available drivers:
        * gcsfuse.run.googleapis.com
        * bucketName: The name of the Cloud Storage Bucket that backs this volume. The Cloud Run Service identity must have access to this bucket.
    ...
    def volume_attributes(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class ServiceTemplateSpecVolumeEmptyDirArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] medium: The medium on which the data is stored. The default is "" which means to use the node's default medium. Must be an empty string (default) or Memory.
...
class ServiceTemplateSpecVolumeNfsArgs:
    def __init__(__self__, *,
                 ...
                 read_only: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] path: Path exported by the NFS server
        :param pulumi.Input[_builtins.str] server: IP address or hostname of the NFS server
        :param pulumi.Input[_builtins.bool] read_only: If true, mount the NFS volume as read only in all mounts. Defaults to false.
        """
        pulumi.set(__self__, "path", path)
...
class ServiceTemplateSpecVolumeSecretArgsDict(TypedDict):
    ...
    """
    items: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeSecretItemArgsDict']]]]]
    """
...
class ServiceTemplateSpecVolumeSecretArgs:
    def __init__(__self__, *,
                 ...
                 items: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeSecretItemArgs']]]] = None):
        """
        :param pulumi.Input[_builtins.str] secret_name: The name of the secret in Cloud Secret Manager. By default, the secret
               is assumed to be in the same project.
               If the secret is in another project, you must define an alias.
               An alias definition has the form:
               {alias}:projects/{project-id|project-number}/secrets/{secret-name}.
               ...
               The alias definitions must be set on the run.googleapis.com/secrets
               annotation.
        :param pulumi.Input[_builtins.int] default_mode: Mode bits to use on created files by default. Must be a value between 0000
               and 0777. Defaults to 0644. Directories within the path are not affected by
               this setting. This might be in conflict with other options that affect the
               file mode, like fsGroup, and the result can be other mode bits set.
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeSecretItemArgs']]]]:
        """
        If unspecified, the volume will expose a file whose name is the
        secret_name.
        If specified, the key will be used as the version to fetch from Cloud
    ...
    @items.setter
    def items(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceTemplateSpecVolumeSecretItemArgs']]]]):
...
class ServiceTemplateSpecVolumeSecretItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] key: The Cloud Secret Manager secret version.
               Can be 'latest' for the latest value or an integer for a specific version.
        :param pulumi.Input[_builtins.str] path: The relative path of the file to map the key to.
               May not be an absolute path.
               May not contain the path element '..'.
               May not start with the string '..'.
        :param pulumi.Input[_builtins.int] mode: Mode bits to use on this file, must be a value between 0000 and 0777. If
               not specified, the volume defaultMode will be used. This might be in
               conflict with other options that affect the file mode, like fsGroup, and
               the result can be other mode bits set.
        """
