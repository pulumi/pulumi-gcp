...
__all__ = [
    ...
    'ConnectionConfigurationAssetArgsDict',
    'ConnectionConfigurationAuthenticationArgs',
    'ConnectionConfigurationAuthenticationArgsDict',
    'ConnectionConfigurationAuthenticationUsernamePasswordArgs',
    'ConnectionConfigurationAuthenticationUsernamePasswordArgsDict',
    'ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgs',
    'ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgsDict',
    'ConnectionConfigurationEndpointArgs',
    'ConnectionConfigurationEndpointArgsDict',
    'ConnectionConfigurationNetworkArgs',
    'ConnectionConfigurationNetworkArgsDict',
    'ConnectionConfigurationNetworkPrivateServiceConnectArgs',
    'ConnectionConfigurationNetworkPrivateServiceConnectArgsDict',
    ...
    'RoutineIamBindingConditionArgsDict',
    'RoutineIamMemberConditionArgs',
    'RoutineIamMemberConditionArgsDict',
...
class AppProfileDataBoostIsolationReadOnlyArgs:
    def __init__(__self__, *,
                 compute_billing_owner: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] compute_billing_owner: The Compute Billing Owner for this Data Boost App Profile.
               Possible values are: `HOST_PAYS`.
        """
...
class AppProfileStandardIsolationArgs:
    def __init__(__self__, *,
                 priority: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] priority: The priority of requests sent using this app profile.
               Possible values are: `PRIORITY_LOW`, `PRIORITY_MEDIUM`, `PRIORITY_HIGH`.
        """
...
class BiReservationPreferredTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] table_id: The ID of the table in the above dataset.
        """
...
class ConnectionAzureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] client_id: (Output)
               The client id of the Azure Active Directory Application.
        :param pulumi.Input[_builtins.str] federated_application_client_id: The Azure Application (client) ID where the federated credentials will be hosted.
        :param pulumi.Input[_builtins.str] identity: (Output)
               A unique Google-owned and Google-generated identity for the Connection. This identity will be used to access the user's Azure Active Directory Application.
        :param pulumi.Input[_builtins.str] object_id: (Output)
               The object id of the Azure Active Directory Application.
        :param pulumi.Input[_builtins.str] redirect_uri: (Output)
               The URL user will be redirected to after granting consent during connection setup.
        """
...
class ConnectionCloudSpannerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_parallelism: Allows setting max parallelism per query when executing on Spanner independent compute resources. If unspecified, default values of parallelism are chosen that are dependent on the Cloud Spanner instance configuration. `useParallelism` and `useDataBoost` must be set when setting max parallelism.
        :param pulumi.Input[_builtins.bool] use_data_boost: If set, the request will be executed via Spanner independent compute resources. `use_parallelism` must be set when using data boost.
        :param pulumi.Input[_builtins.bool] use_parallelism: If parallelism should be used when reading from Cloud Spanner.
        :param pulumi.Input[_builtins.bool] use_serverless_analytics: (Optional, Deprecated)
               If the serverless analytics service should be used to read data from Cloud Spanner. `useParallelism` must be set when using serverless analytics.
...
class ConnectionCloudSqlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: Cloud SQL instance ID in the form project:location:instance.
        :param pulumi.Input[_builtins.str] type: Type of the Cloud SQL database.
               Possible values are: `DATABASE_TYPE_UNSPECIFIED`, `POSTGRES`, `MYSQL`.
        :param pulumi.Input[_builtins.str] service_account_id: (Output)
               When the connection is used in the context of an operation in BigQuery, this service account will serve as the identity being used for connecting to the CloudSQL instance specified in this connection.
        """
...
class ConnectionCloudSqlCredentialArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: Password for database.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[_builtins.str] username: Username for database.
        """
...
class ConnectionConfigurationArgsDict(TypedDict):
    asset: pulumi.Input['ConnectionConfigurationAssetArgsDict']
    """
...
class ConnectionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConnectionConfigurationAssetArgs'] asset: Asset configuration for the connector.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] connector_id: The ID of the connector. Possible values include `google-alloydb`, `google-cloudsql-mysql`,
               `google-cloudsql-postgres`, and other connector IDs supported by the BigQuery Connector framework.
        :param pulumi.Input['ConnectionConfigurationAuthenticationArgs'] authentication: Authentication configuration for the connector.
               Structure is documented below.
        :param pulumi.Input['ConnectionConfigurationEndpointArgs'] endpoint: Endpoint configuration for the connector.
               Structure is documented below.
        :param pulumi.Input['ConnectionConfigurationNetworkArgs'] network: Network configuration for the connector.
               Structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def asset(self) -> pulumi.Input['ConnectionConfigurationAssetArgs']:
        """
        Asset configuration for the connector.
        Structure is documented below.
        """
    ...
    @asset.setter
    def asset(self, value: pulumi.Input['ConnectionConfigurationAssetArgs']):
...
class ConnectionConfigurationAuthenticationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_account: (Output)
               Output only. The service account used for authenticating with the connector.
        :param pulumi.Input['ConnectionConfigurationAuthenticationUsernamePasswordArgs'] username_password: Username/password authentication configuration.
               Structure is documented below.
        """
...
class ConnectionConfigurationAuthenticationUsernamePasswordArgsDict(TypedDict):
    password: pulumi.Input['ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgsDict']
    """
...
@pulumi.input_type
class ConnectionConfigurationAuthenticationUsernamePasswordArgs:
    def __init__(__self__, *,
                 password: pulumi.Input['ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgs'],
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input['ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgs'] password: Password configuration for the connector.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] username: Username for the connector.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
    ...
    @_builtins.property
    @pulumi.getter
    def password(self) -> pulumi.Input['ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgs']:
        """
        Password configuration for the connector.
        Structure is documented below.
        """
    ...
    @password.setter
    def password(self, value: pulumi.Input['ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgs']):
        pulumi.set(self, "password", value)
...
class ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgsDict(TypedDict):
...
class ConnectionConfigurationAuthenticationUsernamePasswordPasswordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] plaintext: The plaintext password.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[_builtins.str] secret_type: (Output)
               Output only. The type of the secret.
        """
...
class ConnectionConfigurationNetworkPrivateServiceConnectArgsDict(TypedDict):
...
@pulumi.input_type
class ConnectionConfigurationNetworkPrivateServiceConnectArgs:
    def __init__(__self__, *,
                 network_attachment: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] network_attachment: The resource name of a network attachment in the format of
               `projects/{project}/regions/{region}/networkAttachments/{networkAttachment}`.
        """
...
class DataTransferConfigEmailPreferencesArgs:
    def __init__(__self__, *,
                 enable_failure_email: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enable_failure_email: If true, email notifications will be sent on transfer run failures.
        """
...
class DataTransferConfigEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] kms_key_name: The name of the KMS key used for encrypting BigQuery data.
        """
...
class DataTransferConfigScheduleOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] disable_auto_scheduling: If true, automatic scheduling of data transfer runs for this
               ...
               scheduling is disabled, the TransferConfig.schedule field will
               be ignored.
        :param pulumi.Input[_builtins.str] end_time: Defines time to stop scheduling transfer runs. A transfer run cannot be
               scheduled at or after the end time. The end time can be changed at any
               moment. The time when a data transfer can be triggered manually is not
               limited by this option.
        :param pulumi.Input[_builtins.str] start_time: Specifies time to start scheduling transfer runs. The first run will be
               scheduled at or after the start time according to a recurrence pattern
               defined in the schedule string. The start time can be changed at any
               moment. The time when a data transfer can be triggered manually is not
               limited by this option.
...
class DatasetAccessAuthorizedDatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DatasetAccessAuthorizedDatasetDatasetArgs'] dataset: The dataset this entry applies to
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] target_types: Which resources in the dataset this entry applies to. Currently, only views are supported,
               but additional target types may be added in the future. Possible values: VIEWS
        """
        pulumi.set(__self__, "dataset", dataset)
...
class DatasetAccessAuthorizedDatasetDatasetArgs:
    def __init__(__self__, *,
                 ...
                 project_id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project containing this table.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
        pulumi.set(__self__, "project_id", project_id)
...
class DatasetAccessConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description of the expression. This is a longer text which describes the expression,
               e.g. when hovered over it in a UI.
        :param pulumi.Input[_builtins.str] location: String indicating the location of the expression for error reporting, e.g. a file
               name and a position in the file.
        :param pulumi.Input[_builtins.str] title: Title for the expression, i.e. a short string describing its purpose.
               This can be used e.g. in UIs which allow to enter the expression.
        """
        pulumi.set(__self__, "expression", expression)
        if description is not None:
...
class DatasetAccessRoutineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project containing this table.
        :param pulumi.Input[_builtins.str] routine_id: The ID of the routine. The ID must contain only letters (a-z,
               A-Z), numbers (0-9), or underscores (_). The maximum length
               is 256 characters.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
class DatasetAccessViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project containing this table.
        :param pulumi.Input[_builtins.str] table_id: The ID of the table. The ID must contain only letters (a-z,
               A-Z), numbers (0-9), or underscores (_). The maximum length
               is 1,024 characters.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
class DatasetDefaultEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] kms_key_name: Describes the Cloud KMS encryption key that will be used to protect destination
               BigQuery table. The BigQuery Service Account associated with your project requires
               access to this encryption key.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
...
class DatasetExternalCatalogDatasetOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] default_storage_location_uri: The storage location URI for all tables in the dataset. Equivalent to hive metastore's
               database locationUri. Maximum length of 1024 characters.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: A map of key value pairs defining the parameters and properties of the open source schema.
               Maximum size of 2Mib.
        """
...
class DatasetExternalDatasetReferenceArgs:
    def __init__(__self__, *,
                 ...
                 external_source: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] connection: The connection id that is used to access the externalSource.
               Format: projects/{projectId}/locations/{locationId}/connections/{connectionId}
        :param pulumi.Input[_builtins.str] external_source: External source that backs this dataset.
        """
...
class JobCopyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['JobCopyDestinationTableArgs'] destination_table: The destination table.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] write_disposition: Specifies the action that occurs if the destination table already exists. The following values are supported:
               WRITE_TRUNCATE: If the table already exists, BigQuery overwrites the table data and uses the schema from the query result.
               WRITE_APPEND: If the table already exists, BigQuery appends the data to the table.
               WRITE_EMPTY: If the table already exists and contains data, a 'duplicate' error is returned in the job result.
               Each action is atomic and only occurs if BigQuery is able to complete the job successfully.
...
class JobExtractArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] compression: The compression type to use for exported files. Possible values include GZIP, DEFLATE, SNAPPY, and NONE.
               The default value is NONE. DEFLATE and SNAPPY are only supported for Avro.
        :param pulumi.Input[_builtins.str] destination_format: The exported file format. Possible values include CSV, NEWLINE_DELIMITED_JSON and AVRO for tables and SAVED_MODEL for models.
               The default value for tables is CSV. Tables with nested or repeated fields cannot be exported as CSV.
               The default value for models is SAVED_MODEL.
        :param pulumi.Input[_builtins.str] field_delimiter: When extracting data in CSV format, this defines the delimiter to use between fields in the exported data.
               Default is ','
        :param pulumi.Input[_builtins.bool] print_header: Whether to print out a header row in the results. Default is true.
        ...
        :param pulumi.Input['JobExtractSourceTableArgs'] source_table: A reference to the table being exported.
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] use_avro_logical_types: Whether to use logical types when extracting to AVRO format.
        """
    ...
    def destination_uris(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of fully-qualified Google Cloud Storage URIs where the extracted table should be written.
        """
    ...
    def destination_uris(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class JobExtractSourceModelArgs:
    def __init__(__self__, *,
                 ...
                 project_id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] dataset_id: The ID of the dataset containing this model.
        :param pulumi.Input[_builtins.str] model_id: The ID of the model.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project containing this model.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
class JobLoadArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['JobLoadDestinationTableArgs'] destination_table: The destination table to load the data into.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_uris: The fully-qualified URIs that point to your data in Google Cloud.
               For Google Cloud Storage URIs: Each URI can contain one '\\*' wildcard character
               and it must come after the 'bucket' name. Size limits related to load jobs apply
               to external data sources. For Google Cloud Bigtable URIs: Exactly one URI can be
               specified and it has be a fully specified and valid HTTPS URL for a Google Cloud Bigtable table.
               For Google Cloud Datastore backups: Exactly one URI can be specified. Also, the '\\*' wildcard character is not allowed.
        :param pulumi.Input[_builtins.bool] allow_jagged_rows: Accept rows that are missing trailing optional columns. The missing values are treated as nulls.
               If false, records with missing trailing columns are treated as bad records, and if there are too many bad records,
               an invalid error is returned in the job result. The default value is false. Only applicable to CSV, ignored for other formats.
        :param pulumi.Input[_builtins.bool] allow_quoted_newlines: Indicates if BigQuery should allow quoted data sections that contain newline characters in a CSV file.
               The default value is false.
        :param pulumi.Input[_builtins.bool] autodetect: Indicates if we should automatically infer the options and schema for CSV and JSON sources.
        :param pulumi.Input[_builtins.str] create_disposition: Specifies whether the job is allowed to create new tables. The following values are supported:
               CREATE_IF_NEEDED: If the table does not exist, BigQuery creates the table.
               CREATE_NEVER: The table must already exist. If it does not, a 'notFound' error is returned in the job result.
               Creation, truncation and append actions occur as one atomic update upon job completion
        ...
        :param pulumi.Input['JobLoadDestinationEncryptionConfigurationArgs'] destination_encryption_configuration: Custom encryption configuration (e.g., Cloud KMS keys)
               Structure is documented below.
        :param pulumi.Input[_builtins.str] encoding: The character encoding of the data. The supported values are UTF-8 or ISO-8859-1.
               The default value is UTF-8. BigQuery decodes the data after the raw, binary data
               has been split using the values of the quote and fieldDelimiter properties.
        :param pulumi.Input[_builtins.str] field_delimiter: The separator for fields in a CSV file. The separator can be any ISO-8859-1 single-byte character.
               To use a character in the range 128-255, you must encode the character as UTF8. BigQuery converts
               the string to ISO-8859-1 encoding, and then uses the first byte of the encoded string to split the
               data in its raw, binary state. BigQuery also supports the escape sequence "\\t" to specify a tab separator.
               The default value is a comma (',').
        :param pulumi.Input[_builtins.bool] ignore_unknown_values: Indicates if BigQuery should allow extra values that are not represented in the table schema.
               If true, the extra values are ignored. If false, records with extra columns are treated as bad records,
               and if there are too many bad records, an invalid error is returned in the job result.
               The default value is false. The sourceFormat property determines what BigQuery treats as an extra value:
               CSV: Trailing columns
               JSON: Named values that don't match any column names
        :param pulumi.Input[_builtins.str] json_extension: If sourceFormat is set to newline-delimited JSON, indicates whether it should be processed as a JSON variant such as GeoJSON.
               For a sourceFormat other than JSON, omit this field. If the sourceFormat is newline-delimited JSON: - for newline-delimited
               GeoJSON: set to GEOJSON.
        ...
        :param pulumi.Input['JobLoadParquetOptionsArgs'] parquet_options: Parquet Options for load and make external tables.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] projection_fields: If sourceFormat is set to "DATASTORE_BACKUP", indicates which entity properties to load into BigQuery from a Cloud Datastore backup.
               Property names are case sensitive and must be top-level properties. If no properties are specified, BigQuery loads all properties.
               If any named property isn't found in the Cloud Datastore backup, an invalid error is returned in the job result.
        :param pulumi.Input[_builtins.str] quote: The value that is used to quote data sections in a CSV file. BigQuery converts the string to ISO-8859-1 encoding,
               and then uses the first byte of the encoded string to split the data in its raw, binary state.
               The default value is a double-quote ('"'). If your data does not contain quoted sections, set the property value to an empty string.
               If your data contains quoted newline characters, you must also set the allowQuotedNewlines property to true.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] schema_update_options: Allows the schema of the destination table to be updated as a side effect of the load job if a schema is autodetected or
               supplied in the job configuration. Schema update options are supported in two cases: when writeDisposition is WRITE_APPEND;
               when writeDisposition is WRITE_TRUNCATE and the destination table is a partition of a table, specified by partition decorators.
               For normal tables, WRITE_TRUNCATE will always overwrite the schema. One or more of the following values are specified:
               ALLOW_FIELD_ADDITION: allow adding a nullable field to the schema.
               ALLOW_FIELD_RELAXATION: allow relaxing a required field in the original schema to nullable.
        :param pulumi.Input[_builtins.int] skip_leading_rows: The number of rows at the top of a CSV file that BigQuery will skip when loading the data.
               The default value is 0. This property is useful if you have header rows in the file that should be skipped.
               When autodetect is on, the behavior is the following:
               skipLeadingRows unspecified - Autodetect tries to detect headers in the first row. If they are not detected,
               the row is read as data. Otherwise data is read starting from the second row.
               ...
               skipLeadingRows = N > 0 - Autodetect skips N-1 rows and tries to detect headers in row N. If headers are not detected,
               row N is just skipped. Otherwise row N is used to extract column names for the detected schema.
        :param pulumi.Input[_builtins.str] source_format: The format of the data files. For CSV files, specify "CSV". For datastore backups, specify "DATASTORE_BACKUP".
               For newline-delimited JSON, specify "NEWLINE_DELIMITED_JSON". For Avro, specify "AVRO". For parquet, specify "PARQUET".
               For orc, specify "ORC". [Beta] For Bigtable, specify "BIGTABLE".
               The default value is CSV.
    ...
    @source_uris.setter
    def source_uris(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class JobLoadTimePartitioningArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The only type supported is DAY, which will generate one partition per day. Providing an empty string used to cause an error,
               but in OnePlatform the field will be treated as unset.
        :param pulumi.Input[_builtins.str] expiration_ms: Number of milliseconds for which to keep the storage for a partition. A wrapper is used here because 0 is an invalid value.
        :param pulumi.Input[_builtins.str] field: If not set, the table is partitioned by pseudo column '_PARTITIONTIME'; if set, the table is partitioned by this field.
               The field must be a top-level TIMESTAMP or DATE field. Its mode must be NULLABLE or REQUIRED.
               A wrapper is used here because an empty string is an invalid value.
        """
        pulumi.set(__self__, "type", type)
...
class JobQueryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['JobQueryDestinationTableArgs'] destination_table: Describes the table where the query results should be stored.
               ...
               For queries that produce anonymous (cached) results, this field will be populated by BigQuery.
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] flatten_results: If true and query uses legacy SQL dialect, flattens all nested and repeated fields in the query results.
               allowLargeResults must be true if this is set to false. For standard SQL queries, this flag is ignored and results are never flattened.
        :param pulumi.Input[_builtins.int] maximum_billing_tier: Limits the billing tier for this job. Queries that have resource usage beyond this tier will fail (without incurring a charge).
               If unspecified, this will be set to your project default.
        :param pulumi.Input[_builtins.str] maximum_bytes_billed: Limits the bytes billed for this job. Queries that will have bytes billed beyond this limit will fail (without incurring a charge).
               If unspecified, this will be set to your project default.
        :param pulumi.Input[_builtins.str] parameter_mode: Standard SQL only. Set to POSITIONAL to use positional (?) query parameters or to NAMED to use named (@myparam) query parameters in this query.
        :param pulumi.Input[_builtins.str] priority: Specifies a priority for the query.
               Default value is `INTERACTIVE`.
               Possible values are: `INTERACTIVE`, `BATCH`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] schema_update_options: Allows the schema of the destination table to be updated as a side effect of the query job.
               Schema update options are supported in two cases: when writeDisposition is WRITE_APPEND;
               when writeDisposition is WRITE_TRUNCATE and the destination table is a partition of a table,
               specified by partition decorators. For normal tables, WRITE_TRUNCATE will always overwrite the schema.
               One or more of the following values are specified:
        ...
        :param pulumi.Input['JobQueryScriptOptionsArgs'] script_options: Options controlling the execution of scripts.
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] use_legacy_sql: Specifies whether to use BigQuery's legacy SQL dialect for this query. The default value is true.
               If set to false, the query will use BigQuery's standard SQL.
        :param pulumi.Input[_builtins.bool] use_query_cache: Whether to look for the result in the query cache. The query cache is a best-effort cache that will be flushed whenever
               tables in the query are modified. Moreover, the query cache is only available when a query does not have a destination table specified.
               The default value is true.
...
class JobQueryScriptOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] key_result_statement: Determines which statement in the script represents the "key result",
               used to populate the schema and query results of the script job.
               Possible values are: `LAST`, `FIRST_SELECT`.
        :param pulumi.Input[_builtins.str] statement_byte_budget: Limit on the number of bytes billed per statement. Exceeding this budget results in an error.
        :param pulumi.Input[_builtins.str] statement_timeout_ms: Timeout period for each statement in a script.
        """
...
class JobQueryUserDefinedFunctionResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] inline_code: An inline resource that contains code for a user-defined function (UDF).
               Providing a inline code resource is equivalent to providing a URI for a file containing the same code.
        :param pulumi.Input[_builtins.str] resource_uri: A code resource to load from a Google Cloud Storage URI (gs://bucket/path).
        """
...
class JobStatusErrorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] reason: A short error code that summarizes the error.
        """
        if location is not None:
            pulumi.set(__self__, "location", location)
...
class ReservationAutoscaleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] current_slots: (Output)
               The slot capacity added to this reservation when autoscale happens. Will be between [0, max_slots].
        :param pulumi.Input[_builtins.int] max_slots: Number of slots to be scaled when needed.
        """
...
class ReservationReplicationStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ReservationReplicationStatusErrorArgs']]] errors: (Output)
               ...
               secondary. This field is only available if the replication has not succeeded since.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] last_error_time: (Output)
               The time at which the last error was encountered while trying to replicate changes from
               the primary to the secondary. This field is only available if the replication has not
               succeeded since.
        :param pulumi.Input[_builtins.str] last_replication_time: (Output)
               A timestamp corresponding to the last change on the primary that was successfully
               replicated to the secondary.
        """
        if errors is not None:
...
class RoutineExternalRuntimeOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] container_cpu: Amount of CPU provisioned for a Python UDF container instance. For more
               information, see [Configure container limits for Python
               UDFs](https://cloud.google.com/bigquery/docs/user-defined-functions-python#configure-container-limits)
        :param pulumi.Input[_builtins.str] container_memory: Amount of memory provisioned for a Python UDF container instance. Format:
               {number}{unit} where unit is one of "M", "G", "Mi" and "Gi" (e.g. 1G,
               512Mi). If not specified, the default value is 512Mi. For more information,
               see [Configure container limits for Python
               UDFs](https://cloud.google.com/bigquery/docs/user-defined-functions-python#configure-container-limits)
        ...
        :param pulumi.Input[_builtins.str] runtime_connection: Fully qualified name of the connection whose service account will be used
               to execute the code in the container. Format:
               `"projects/{project_id}/locations/{location_id}/connections/{connection_id}"`
        :param pulumi.Input[_builtins.str] runtime_version: Language runtime version. Example: `python-3.11`.
        """
...
class RoutineIamBindingConditionArgsDict(TypedDict):
    expression: pulumi.Input[_builtins.str]
    title: pulumi.Input[_builtins.str]
    description: NotRequired[pulumi.Input[Optional[_builtins.str]]]

@pulumi.input_type
class RoutineIamBindingConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[_builtins.str],
                 title: pulumi.Input[_builtins.str],
                 description: pulumi.Input[Optional[_builtins.str]] = None):
...
class RoutineIamMemberConditionArgsDict(TypedDict):
    expression: pulumi.Input[_builtins.str]
    title: pulumi.Input[_builtins.str]
    description: NotRequired[pulumi.Input[Optional[_builtins.str]]]

@pulumi.input_type
class RoutineIamMemberConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[_builtins.str],
                 title: pulumi.Input[_builtins.str],
                 description: pulumi.Input[Optional[_builtins.str]] = None):
...
class RoutinePythonOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] entry_point: The name of the function defined in Python code as the entry point when the
               Python UDF is invoked.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] packages: A list of Python package names along with versions to be installed.
               Example: ["pandas>=2.1", "google-cloud-translate==3.11"]. For more
               information, see [Use third-party
               packages](https://cloud.google.com/bigquery/docs/user-defined-functions-python#third-party-packages).
        """
...
class RoutineRemoteFunctionOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection: Fully qualified name of the user-provided connection object which holds
               the authentication information to send requests to the remote service.
               Format: "projects/{projectId}/locations/{locationId}/connections/{connectionId}"
        :param pulumi.Input[_builtins.str] endpoint: Endpoint of the user-provided remote service, e.g.
               `https://us-east1-my_gcf_project.cloudfunctions.net/remote_add`
        :param pulumi.Input[_builtins.str] max_batching_rows: Max number of rows in each batch sent to the remote service. If absent or if 0,
               BigQuery dynamically decides the number of rows in a batch.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] user_defined_context: User-defined context as a set of key/value pairs, which will be sent as function
               invocation context together with batched arguments in the requests to the remote
               service. The total number of bytes of keys and values must be less than 8KB.
               An object containing a list of "key": value pairs. Example:
               `{ "name": "wrench", "mass": "1.3kg", "count": "3" }`.
...
class RoutineSparkOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection: Fully qualified name of the user-provided Spark connection object.
               Format: "projects/{projectId}/locations/{locationId}/connections/{connectionId}"
        :param pulumi.Input[_builtins.str] container_image: Custom container image for the runtime environment.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] file_uris: Files to be placed in the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] jar_uris: JARs to include on the driver and executor CLASSPATH. For more information about Apache Spark, see Apache Spark.
        :param pulumi.Input[_builtins.str] main_class: The fully qualified name of a class in jarUris, for example, com.example.wordcount.
               Exactly one of mainClass and main_jar_uri field should be set for Java/Scala language type.
        :param pulumi.Input[_builtins.str] main_file_uri: The main file/jar URI of the Spark application.
               Exactly one of the definitionBody field and the mainFileUri field must be set for Python.
               Exactly one of mainClass and mainFileUri field should be set for Java/Scala language type.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] properties: Configuration properties as a set of key/value pairs, which will be passed on to the Spark application.
               For more information, see Apache Spark and the procedure option list.
               An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] py_file_uris: Python files to be placed on the PYTHONPATH for PySpark application. Supported file types: .py, .egg, and .zip. For more information about Apache Spark, see Apache Spark.
        :param pulumi.Input[_builtins.str] runtime_version: Runtime version. If not specified, the default runtime version is used.
        """
...
class TableBiglakeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 table_format: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] connection_id: The connection specifying the credentials to be used to
               read and write to external storage, such as Cloud Storage. The connection_id can
               have the form "&lt;project\\_id&gt;.&lt;location\\_id&gt;.&lt;connection\\_id&gt;" or
               projects/&lt;project\\_id&gt;/locations/&lt;location\\_id&gt;/connections/&lt;connection\\_id&gt;".
        :param pulumi.Input[_builtins.str] file_format: The file format the table data is stored in.
        :param pulumi.Input[_builtins.str] storage_uri: The fully qualified location prefix of the external folder where table data
               is stored. The '*' wildcard character is not allowed. The URI should be in the format "gs://bucket/path_to_table/"
        :param pulumi.Input[_builtins.str] table_format: The table format the metadata only snapshots are stored in.
        """
...
class TableEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key_name: The self link or full name of a key which should be used to
               ...
               `bigquery_get_default_service_account` datasource and the
               `kms.CryptoKeyIAMBinding` resource.
        :param pulumi.Input[_builtins.str] kms_key_version: The self link or full name of the kms key version used to encrypt this table.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
        if kms_key_version is not None:
            pulumi.set(__self__, "kms_key_version", kms_key_version)
...
class TableExternalCatalogTableOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection_id: The connection specifying the credentials to be
               ...
               connection_id can have the form `<project_id>.<location_id>.<connection_id>`
               or `projects/<project_id>/locations/<location_id>/connections/<connection_id>`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: A map of key value pairs defining the parameters and
               properties of the open source table. Corresponds with hive meta store table
               parameters. Maximum size of 4Mib.
...
class TableExternalCatalogTableOptionsStorageDescriptorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] input_format: Specifies the fully qualified class name of the
               InputFormat (e.g. "org.apache.hadoop.hive.ql.io.orc.OrcInputFormat"). The
               maximum length is 128 characters.
        :param pulumi.Input[_builtins.str] location_uri: The physical location of the table (e.g.
               'gs://spark-dataproc-data/pangea-data/case_sensitive/' or
               'gs://spark-dataproc-data/pangea-data/*'). The maximum length is 2056 bytes.
        :param pulumi.Input[_builtins.str] output_format: Specifies the fully qualified class name of the
               OutputFormat (e.g. "org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat"). The
               maximum length is 128 characters.
...
class TableExternalCatalogTableOptionsStorageDescriptorSerdeInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] serialization_library: Specifies a fully-qualified class name of
               ...
               between table representation and the underlying low-level input and output
               format structures. The maximum length is 256 characters.
        :param pulumi.Input[_builtins.str] name: Name of the SerDe. The maximum length is 256 characters.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: Key-value pairs that define the initialization
               parameters for the serialization library. Maximum size 10 Kib.
        """
...
class TableExternalDataConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] autodetect: Let BigQuery try to autodetect the schema
               and format of the table.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_uris: A list of the fully-qualified URIs that point to
               your data in Google Cloud.
        ...
        :param pulumi.Input['TableExternalDataConfigurationBigtableOptionsArgs'] bigtable_options: Additional properties to set if
               `source_format` is set to "BIGTABLE". Structure is documented below.
        :param pulumi.Input[_builtins.str] compression: The compression type of the data source.
               Valid values are "NONE" or "GZIP".
        :param pulumi.Input[_builtins.str] connection_id: The connection specifying the credentials to be used to read
               external storage, such as Azure Blob, Cloud Storage, or S3. The `connection_id` can have
               the form `{{project}}.{{location}}.{{connection_id}}`
               or `projects/{{project}}/locations/{{location}}/connections/{{connection_id}}`.
        ...
        :param pulumi.Input['TableExternalDataConfigurationHivePartitioningOptionsArgs'] hive_partitioning_options: When set, configures hive partitioning
               ...
               partitioning on an unsupported format will lead to an error, as will providing
               an invalid specification. Structure is documented below.
        :param pulumi.Input[_builtins.bool] ignore_unknown_values: Indicates if BigQuery should
               allow extra values that are not represented in the table schema.
               If true, the extra values are ignored. If false, records with
               extra columns are treated as bad records, and if there are too
               many bad records, an invalid error is returned in the job result.
               The default value is false.
        :param pulumi.Input[_builtins.str] json_extension: Used to indicate that a JSON variant, rather than normal JSON, is being used as the sourceFormat. This should only be used in combination with the `JSON` source format. Valid values are: `GEOJSON`.
        :param pulumi.Input['TableExternalDataConfigurationJsonOptionsArgs'] json_options: Additional properties to set if
               `source_format` is set to "JSON". Structure is documented below.
        :param pulumi.Input[_builtins.int] max_bad_records: The maximum number of bad records that
               BigQuery can ignore when reading data.
        :param pulumi.Input[_builtins.str] metadata_cache_mode: Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source. Valid values are `AUTOMATIC` and `MANUAL`.
        :param pulumi.Input[_builtins.str] object_metadata: Object Metadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the sourceUris. If `object_metadata` is set, `source_format` should be omitted.
        :param pulumi.Input['TableExternalDataConfigurationParquetOptionsArgs'] parquet_options: Additional properties to set if
               `source_format` is set to "PARQUET". Structure is documented below.
        :param pulumi.Input[_builtins.str] reference_file_schema_uri: When creating an external table, the user can provide a reference file with the table schema. This is enabled for the following formats: AVRO, PARQUET, ORC.
        :param pulumi.Input[_builtins.str] schema: A JSON schema for the external table. Schema is required
               for CSV and JSON formats if autodetect is not on. Schema is disallowed
               for Google Cloud Bigtable, Cloud Datastore backups, Avro, Iceberg, ORC and Parquet formats.
               ~>**NOTE:** Because this field expects a JSON string, any changes to the
               string will create a diff, even if the JSON itself hasn't changed.
               ...
               table schema must be specified using the top-level `schema` field
               documented above.
        :param pulumi.Input[_builtins.str] source_format: The data format. Please see sourceFormat under
               [ExternalDataConfiguration](https://cloud.google.com/bigquery/docs/reference/rest/v2/tables#externaldataconfiguration)
               in Bigquery's public API documentation for supported formats. To use "GOOGLE_SHEETS"
               the `scopes` must include "https://www.googleapis.com/auth/drive.readonly".
        """
...
class TableExternalDataConfigurationAvroOptionsArgs:
    def __init__(__self__, *,
                 use_avro_logical_types: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] use_avro_logical_types: If is set to true, indicates whether
               to interpret logical types as the corresponding BigQuery data type
               (for example, TIMESTAMP), instead of using the raw type (for example, INTEGER).
        """
        pulumi.set(__self__, "use_avro_logical_types", use_avro_logical_types)
...
class TableExternalDataConfigurationBigtableOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] output_column_families_as_json: If field is true, then each column family will be read as a single JSON column. Otherwise they are read as a repeated cell structure containing timestamp/value tuples. The default value is false.
        :param pulumi.Input[_builtins.bool] read_rowkey_as_string: If field is true, then the rowkey column families will be read and converted to string. Otherwise they are read with BYTES type values and users need to manually cast them with CAST if necessary. The default value is false.
        """
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] family_id: Identifier of the column family.
        :param pulumi.Input[_builtins.bool] only_read_latest: If this is set only the latest version of value are exposed for all columns in this column family. This can be overridden for a specific column by listing that column in 'columns' and specifying a different setting for that column.
        :param pulumi.Input[_builtins.str] type: The type to convert the value in cells of this column family. The values are expected to be encoded using HBase Bytes.toBytes function when using the BINARY encoding value. Following BigQuery types are allowed (case-sensitive): "BYTES", "STRING", "INTEGER", "FLOAT", "BOOLEAN", "JSON". Default type is BYTES. This can be overridden for a specific column by listing that column in 'columns' and specifying a type for it.
        """
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyColumnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] only_read_latest: If this is set, only the latest version of value in this column are exposed. 'onlyReadLatest' can also be set at the column family level. However, the setting at this level takes precedence if 'onlyReadLatest' is set at both levels.
        :param pulumi.Input[_builtins.str] qualifier_encoded: Qualifier of the column. Columns in the parent column family that has this exact qualifier are exposed as . field. If the qualifier is valid UTF-8 string, it can be specified in the qualifierString field. Otherwise, a base-64 encoded value must be set to qualifierEncoded. The column field name is the same as the column qualifier. However, if the qualifier is not a valid BigQuery field identifier i.e. does not match [a-zA-Z][a-zA-Z0-9_]*, a valid identifier must be provided as fieldName.
        :param pulumi.Input[_builtins.str] qualifier_string: Qualifier string.
        :param pulumi.Input[_builtins.str] type: The type to convert the value in cells of this column. The values are expected to be encoded using HBase Bytes.toBytes function when using the BINARY encoding value. Following BigQuery types are allowed (case-sensitive): "BYTES", "STRING", "INTEGER", "FLOAT", "BOOLEAN", "JSON", Default type is "BYTES". 'type' can also be set at the column family level. However, the setting at this level takes precedence if 'type' is set at both levels.
        """
        if encoding is not None:
            pulumi.set(__self__, "encoding", encoding)
...
class TableExternalDataConfigurationCsvOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] allow_quoted_newlines: Indicates if BigQuery should allow
               quoted data sections that contain newline characters in a CSV file.
               The default value is false.
        :param pulumi.Input[_builtins.str] encoding: The character encoding of the data. The supported
               values are UTF-8 or ISO-8859-1.
...
class TableExternalDataConfigurationGoogleSheetsOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] range: Range of a sheet to query from. Only used when
               ...
               Typical format: "sheet_name!top_left_cell_id:bottom_right_cell_id"
               For example: "sheet1!A1:B20"
        :param pulumi.Input[_builtins.int] skip_leading_rows: The number of rows at the top of the sheet
               that BigQuery will skip when reading the data. At least one of `range` or
               `skip_leading_rows` must be set.
        """
...
class TableExternalDataConfigurationHivePartitioningOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] require_partition_filter: If set to true, queries over this table
               require a partition filter that can be used for partition elimination to be
               specified.
        :param pulumi.Input[_builtins.str] source_uri_prefix: When hive partition detection is requested,
               a common for all source uris must be required. The prefix must end immediately
               before the partition key encoding begins. For example, consider files following
               this data layout. `gs://bucket/path_to_table/dt=2019-06-01/country=USA/id=7/file.avro`
               `gs://bucket/path_to_table/dt=2019-05-31/country=CA/id=3/file.avro` When hive
...
class TableMaterializedViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] allow_non_incremental_definition: Allow non incremental materialized view definition.
               The default value is false.
        :param pulumi.Input[_builtins.bool] enable_refresh: Specifies whether to use BigQuery's automatic refresh for this materialized view when the base table is updated.
               The default value is true.
        :param pulumi.Input[_builtins.int] refresh_interval_ms: The maximum frequency at which this materialized view will be refreshed.
               The default value is 1800000
        """
        pulumi.set(__self__, "query", query)
...
class TableRangePartitioningArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] field: The field used to determine how to create a range-based
               partition.
...
class TableRangePartitioningRangeArgs:
    def __init__(__self__, *,
                 ...
                 start: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] end: End of the range partitioning, exclusive.
        :param pulumi.Input[_builtins.int] interval: The width of each range within the partition.
        :param pulumi.Input[_builtins.int] start: Start of the range partitioning, inclusive.
        """
...
class TableSchemaForeignTypeInfoArgs:
    def __init__(__self__, *,
                 type_system: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] type_system: Specifies the system which defines the foreign data
               type.
        """
...
class TableTableConstraintsForeignKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TableTableConstraintsForeignKeyReferencedTableArgs'] referenced_table: The table that holds the primary key
               and is referenced by this foreign key.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] name: Set only if the foreign key constraint is named.
        """
...
class TableTableConstraintsForeignKeyColumnReferencesArgs:
    def __init__(__self__, *,
                 ...
                 referencing_column: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] referenced_column: The column in the primary key that are
               referenced by the referencingColumn
        :param pulumi.Input[_builtins.str] referencing_column: The column that composes the foreign key.
        """
...
class TableTableConstraintsForeignKeyReferencedTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[_builtins.str] project_id: The ID of the project containing this table.
        :param pulumi.Input[_builtins.str] table_id: The ID of the table. The ID must contain only
               letters (a-z, A-Z), numbers (0-9), or underscores (_). The maximum
               length is 1,024 characters. Certain operations allow suffixing of
               the table ID with a partition decorator, such as
               sample_table$20190123.
...
class TableTableConstraintsPrimaryKeyArgs:
    def __init__(__self__, *,
                 columns: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] columns: The columns that are composed of the primary key constraint.
        """
        pulumi.set(__self__, "columns", columns)
...
class TableTableReplicationInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_table_id: The ID of the source materialized view.
        :param pulumi.Input[_builtins.int] replication_interval_ms: The interval at which the source
               materialized view is polled for updates. The default is 300000.
        """
...
class TableTimePartitioningArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The supported types are DAY, HOUR, MONTH, and YEAR,
               which will generate one partition per day, hour, month, and year, respectively.
        :param pulumi.Input[_builtins.int] expiration_ms: Number of milliseconds for which to keep the
               storage for a partition.
        :param pulumi.Input[_builtins.str] field: The field used to determine how to create a time-based
               partition. If time-based partitioning is enabled without this value, the
               table is partitioned based on the load time.
        :param pulumi.Input[_builtins.bool] require_partition_filter: If set to true, queries over this table
               require a partition filter that can be used for partition elimination to be
