...
if not MYPY:
    class BiReservationPreferredTableArgsDict(TypedDict):
        ...
        """
        table_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BiReservationPreferredTableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset in the above project.
        :param pulumi.Input[builtins.str] project_id: The assigned project ID of the project.
        :param pulumi.Input[builtins.str] table_id: The ID of the table in the above dataset.
        """
...
if not MYPY:
    class ConnectionAwsAccessRoleArgsDict(TypedDict):
        iam_role_id: pulumi.Input[builtins.str]
        """
...
class ConnectionAwsAccessRoleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] iam_role_id: The user’s AWS IAM Role that trusts the Google-owned AWS IAM user Connection.
        :param pulumi.Input[builtins.str] identity: (Output)
               A unique Google-owned and Google-generated identity for the Connection. This identity will be used to access the user's AWS IAM Role.
        """
    ...
    def iam_role_id(self) -> pulumi.Input[builtins.str]:
        """
        The user’s AWS IAM Role that trusts the Google-owned AWS IAM user Connection.
        """
    ...
    @iam_role_id.setter
    def iam_role_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ConnectionAzureArgsDict(TypedDict):
        customer_tenant_id: pulumi.Input[builtins.str]
        """
        ...
        """
        federated_application_client_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionAzureArgs:
    def __init__(__self__, *,
                 ...
                 federated_application_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input[builtins.str]] = None,
                 object_id: Optional[pulumi.Input[builtins.str]] = None,
                 redirect_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] customer_tenant_id: The id of customer's directory that host the data.
        :param pulumi.Input[builtins.str] application: (Output)
               The name of the Azure Active Directory Application.
        :param pulumi.Input[builtins.str] client_id: (Output)
               The client id of the Azure Active Directory Application.
        :param pulumi.Input[builtins.str] federated_application_client_id: The Azure Application (client) ID where the federated credentials will be hosted.
        :param pulumi.Input[builtins.str] identity: (Output)
               A unique Google-owned and Google-generated identity for the Connection. This identity will be used to access the user's Azure Active Directory Application.
        :param pulumi.Input[builtins.str] object_id: (Output)
               The object id of the Azure Active Directory Application.
        :param pulumi.Input[builtins.str] redirect_uri: (Output)
               The URL user will be redirected to after granting consent during connection setup.
        """
    ...
    def customer_tenant_id(self) -> pulumi.Input[builtins.str]:
        """
        The id of customer's directory that host the data.
        """
    ...
    def customer_tenant_id(self, value: pulumi.Input[builtins.str]):
    ...
    def federated_application_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Azure Application (client) ID where the federated credentials will be hosted.
        """
    ...
    def federated_application_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectionCloudResourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] service_account_id: (Output)
               The account ID of the service created for the purpose of this connection.
        """
...
if not MYPY:
    class ConnectionCloudSpannerArgsDict(TypedDict):
        ...
        """
        database_role: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        use_data_boost: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        use_parallelism: NotRequired[pulumi.Input[builtins.bool]]
        """
        If parallelism should be used when reading from Cloud Spanner.
        """
        use_serverless_analytics: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Optional, Deprecated)
...
class ConnectionCloudSpannerArgs:
    def __init__(__self__, *,
                 database: pulumi.Input[builtins.str],
                 database_role: Optional[pulumi.Input[builtins.str]] = None,
                 max_parallelism: Optional[pulumi.Input[builtins.int]] = None,
                 use_data_boost: Optional[pulumi.Input[builtins.bool]] = None,
                 use_parallelism: Optional[pulumi.Input[builtins.bool]] = None,
                 use_serverless_analytics: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] database: Cloud Spanner database in the form `project/instance/database'.
        :param pulumi.Input[builtins.str] database_role: Cloud Spanner database role for fine-grained access control. The Cloud Spanner admin should have provisioned the database role with appropriate permissions, such as `SELECT` and `INSERT`. Other users should only use roles provided by their Cloud Spanner admins. The database role name must start with a letter, and can only contain letters, numbers, and underscores. For more details, see https://cloud.google.com/spanner/docs/fgac-about.
        :param pulumi.Input[builtins.int] max_parallelism: Allows setting max parallelism per query when executing on Spanner independent compute resources. If unspecified, default values of parallelism are chosen that are dependent on the Cloud Spanner instance configuration. `useParallelism` and `useDataBoost` must be set when setting max parallelism.
        :param pulumi.Input[builtins.bool] use_data_boost: If set, the request will be executed via Spanner independent compute resources. `use_parallelism` must be set when using data boost.
        :param pulumi.Input[builtins.bool] use_parallelism: If parallelism should be used when reading from Cloud Spanner.
        :param pulumi.Input[builtins.bool] use_serverless_analytics: (Optional, Deprecated)
               If the serverless analytics service should be used to read data from Cloud Spanner. `useParallelism` must be set when using serverless analytics.
    ...
    def database_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Cloud Spanner database role for fine-grained access control. The Cloud Spanner admin should have provisioned the database role with appropriate permissions, such as `SELECT` and `INSERT`. Other users should only use roles provided by their Cloud Spanner admins. The database role name must start with a letter, and can only contain letters, numbers, and underscores. For more details, see https://cloud.google.com/spanner/docs/fgac-about.
        """
    ...
    def database_role(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_data_boost(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If set, the request will be executed via Spanner independent compute resources. `use_parallelism` must be set when using data boost.
        """
    ...
    def use_data_boost(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_data_boost", value)

    @property
    @pulumi.getter(name="useParallelism")
    def use_parallelism(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If parallelism should be used when reading from Cloud Spanner.
        """
    ...
    def use_parallelism(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def use_serverless_analytics(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Optional, Deprecated)
        If the serverless analytics service should be used to read data from Cloud Spanner. `useParallelism` must be set when using serverless analytics.
    ...
    def use_serverless_analytics(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ConnectionCloudSqlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: Cloud SQL instance ID in the form project:location:instance.
        :param pulumi.Input[builtins.str] type: Type of the Cloud SQL database.
               Possible values are: `DATABASE_TYPE_UNSPECIFIED`, `POSTGRES`, `MYSQL`.
        :param pulumi.Input[builtins.str] service_account_id: (Output)
               When the connection is used in the context of an operation in BigQuery, this service account will serve as the identity being used for connecting to the CloudSQL instance specified in this connection.
        """
...
class ConnectionCloudSqlCredentialArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] password: Password for database.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.str] username: Username for database.
        """
...
class ConnectionSparkMetastoreServiceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] metastore_service: Resource name of an existing Dataproc Metastore service in the form of projects/[projectId]/locations/[region]/services/[serviceId].
        """
...
class ConnectionSparkSparkHistoryServerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dataproc_cluster: Resource name of an existing Dataproc Cluster to act as a Spark History Server for the connection if the form of projects/[projectId]/regions/[region]/clusters/[cluster_name].
        """
...
if not MYPY:
    class DataTransferConfigEmailPreferencesArgsDict(TypedDict):
        enable_failure_email: pulumi.Input[builtins.bool]
        """
...
class DataTransferConfigEmailPreferencesArgs:
    def __init__(__self__, *,
                 enable_failure_email: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enable_failure_email: If true, email notifications will be sent on transfer run failures.
        """
        pulumi.set(__self__, "enable_failure_email", enable_failure_email)

    @property
    @pulumi.getter(name="enableFailureEmail")
    def enable_failure_email(self) -> pulumi.Input[builtins.bool]:
        """
        If true, email notifications will be sent on transfer run failures.
        """
    ...
    def enable_failure_email(self, value: pulumi.Input[builtins.bool]):
...
class DataTransferConfigEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: The name of the KMS key used for encrypting BigQuery data.
        """
...
if not MYPY:
    class DataTransferConfigScheduleOptionsArgsDict(TypedDict):
        disable_auto_scheduling: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DataTransferConfigScheduleOptionsArgs:
    def __init__(__self__, *,
                 disable_auto_scheduling: Optional[pulumi.Input[builtins.bool]] = None,
                 end_time: Optional[pulumi.Input[builtins.str]] = None,
                 start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] disable_auto_scheduling: If true, automatic scheduling of data transfer runs for this
               configuration will be disabled. The runs can be started on ad-hoc
               basis using transferConfigs.startManualRuns API. When automatic
               scheduling is disabled, the TransferConfig.schedule field will
               be ignored.
        :param pulumi.Input[builtins.str] end_time: Defines time to stop scheduling transfer runs. A transfer run cannot be
               scheduled at or after the end time. The end time can be changed at any
               moment. The time when a data transfer can be triggered manually is not
               limited by this option.
        :param pulumi.Input[builtins.str] start_time: Specifies time to start scheduling transfer runs. The first run will be
               scheduled at or after the start time according to a recurrence pattern
               defined in the schedule string. The start time can be changed at any
               moment. The time when a data transfer can be triggered manually is not
               limited by this option.
    ...
    def disable_auto_scheduling(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, automatic scheduling of data transfer runs for this
        configuration will be disabled. The runs can be started on ad-hoc
        basis using transferConfigs.startManualRuns API. When automatic
    ...
    def disable_auto_scheduling(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DataTransferConfigSensitiveParamsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] secret_access_key: The Secret Access Key of the AWS account transferring data from.
        """
...
if not MYPY:
    class DatasetAccessArgsDict(TypedDict):
        ...
        """
        group_by_email: NotRequired[pulumi.Input[builtins.str]]
        """
        An email address of a Google Group to grant access to.
        """
        iam_member: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        special_group: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        * `allAuthenticatedUsers`: All authenticated BigQuery users.
        """
        user_by_email: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatasetAccessArgs:
    def __init__(__self__, *,
                 ...
                 group_by_email: Optional[pulumi.Input[builtins.str]] = None,
                 iam_member: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None,
                 routine: Optional[pulumi.Input['DatasetAccessRoutineArgs']] = None,
                 special_group: Optional[pulumi.Input[builtins.str]] = None,
                 user_by_email: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['DatasetAccessDatasetArgs'] dataset: Grants all resources of particular types in a particular dataset read access to the current dataset.
               Structure is documented below.
        :param pulumi.Input[builtins.str] domain: A domain to grant access to. Any users signed in with the
               domain specified will be granted the specified access
        :param pulumi.Input[builtins.str] group_by_email: An email address of a Google Group to grant access to.
        :param pulumi.Input[builtins.str] iam_member: Some other type of member that appears in the IAM Policy but isn't a user,
               group, domain, or special group. For example: `allUsers`
        :param pulumi.Input[builtins.str] role: Describes the rights granted to the user specified by the other
               member of the access object. Basic, predefined, and custom roles
               are supported. Predefined roles that have equivalent basic roles
               are swapped by the API to their basic counterparts. See
               [official docs](https://cloud.google.com/bigquery/docs/access-control).
        :param pulumi.Input['DatasetAccessRoutineArgs'] routine: A routine from a different dataset to grant access to. Queries
               ...
               needs to be granted again via an update operation.
               Structure is documented below.
        :param pulumi.Input[builtins.str] special_group: A special group to grant access to. Possible values include:
               * `projectOwners`: Owners of the enclosing project.
               * `projectReaders`: Readers of the enclosing project.
               * `projectWriters`: Writers of the enclosing project.
               * `allAuthenticatedUsers`: All authenticated BigQuery users.
        :param pulumi.Input[builtins.str] user_by_email: An email address of a user to grant access to. For example:
               fred@example.com
    ...
    def group_by_email(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An email address of a Google Group to grant access to.
        """
    ...
    def group_by_email(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_by_email", value)

    @property
    @pulumi.getter(name="iamMember")
    def iam_member(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Some other type of member that appears in the IAM Policy but isn't a user,
        group, domain, or special group. For example: `allUsers`
        """
    ...
    @iam_member.setter
    def iam_member(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def special_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A special group to grant access to. Possible values include:
        * `projectOwners`: Owners of the enclosing project.
        * `projectReaders`: Readers of the enclosing project.
    ...
    def special_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "special_group", value)

    @property
    @pulumi.getter(name="userByEmail")
    def user_by_email(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An email address of a user to grant access to. For example:
        fred@example.com
        """
    ...
    def user_by_email(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DatasetAccessAuthorizedDatasetArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        target_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class DatasetAccessAuthorizedDatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DatasetAccessAuthorizedDatasetDatasetArgs'] dataset: The dataset this entry applies to
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_types: Which resources in the dataset this entry applies to. Currently, only views are supported,
               but additional target types may be added in the future. Possible values: VIEWS
        """
        pulumi.set(__self__, "dataset", dataset)
    ...
    def target_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Which resources in the dataset this entry applies to. Currently, only views are supported,
        but additional target types may be added in the future. Possible values: VIEWS
        """
    ...
    @target_types.setter
    def target_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class DatasetAccessAuthorizedDatasetDatasetArgs:
    def __init__(__self__, *,
                 ...
                 project_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[builtins.str] project_id: The ID of the project containing this table.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
        pulumi.set(__self__, "project_id", project_id)
...
class DatasetAccessConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the expression. This is a longer text which describes the expression,
               e.g. when hovered over it in a UI.
        :param pulumi.Input[builtins.str] location: String indicating the location of the expression for error reporting, e.g. a file
               name and a position in the file.
...
if not MYPY:
    class DatasetAccessRoutineArgsDict(TypedDict):
        ...
        The ID of the project containing this table.
        """
        routine_id: pulumi.Input[builtins.str]
        """
...
class DatasetAccessRoutineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[builtins.str] project_id: The ID of the project containing this table.
        :param pulumi.Input[builtins.str] routine_id: The ID of the routine. The ID must contain only letters (a-z,
               A-Z), numbers (0-9), or underscores (_). The maximum length
               is 256 characters.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
    ...
    def routine_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the routine. The ID must contain only letters (a-z,
        A-Z), numbers (0-9), or underscores (_). The maximum length
        is 256 characters.
    ...
    @routine_id.setter
    def routine_id(self, value: pulumi.Input[builtins.str]):
...
class DatasetAccessViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[builtins.str] project_id: The ID of the project containing this table.
        :param pulumi.Input[builtins.str] table_id: The ID of the table. The ID must contain only letters (a-z,
               A-Z), numbers (0-9), or underscores (_). The maximum length
               is 1,024 characters.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
class DatasetDefaultEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: Describes the Cloud KMS encryption key that will be used to protect destination
               BigQuery table. The BigQuery Service Account associated with your project requires
               access to this encryption key.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
...
if not MYPY:
    class DatasetExternalCatalogDatasetOptionsArgsDict(TypedDict):
        default_storage_location_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatasetExternalCatalogDatasetOptionsArgs:
    def __init__(__self__, *,
                 default_storage_location_uri: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] default_storage_location_uri: The storage location URI for all tables in the dataset. Equivalent to hive metastore's
               database locationUri. Maximum length of 1024 characters.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of key value pairs defining the parameters and properties of the open source schema.
               Maximum size of 2Mib.
        """
    ...
    def default_storage_location_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The storage location URI for all tables in the dataset. Equivalent to hive metastore's
        database locationUri. Maximum length of 1024 characters.
        """
    ...
    def default_storage_location_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DatasetExternalDatasetReferenceArgsDict(TypedDict):
        connection: pulumi.Input[builtins.str]
        """
        The connection id that is used to access the externalSource.
        Format: projects/{projectId}/locations/{locationId}/connections/{connectionId}
        """
        external_source: pulumi.Input[builtins.str]
        """
...
class DatasetExternalDatasetReferenceArgs:
    def __init__(__self__, *,
                 ...
                 external_source: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] connection: The connection id that is used to access the externalSource.
               Format: projects/{projectId}/locations/{locationId}/connections/{connectionId}
        :param pulumi.Input[builtins.str] external_source: External source that backs this dataset.
        """
    ...
    @property
    @pulumi.getter
    def connection(self) -> pulumi.Input[builtins.str]:
        """
        The connection id that is used to access the externalSource.
        Format: projects/{projectId}/locations/{locationId}/connections/{connectionId}
        """
    ...
    @connection.setter
    def connection(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "connection", value)

    @property
    @pulumi.getter(name="externalSource")
    def external_source(self) -> pulumi.Input[builtins.str]:
        """
        External source that backs this dataset.
        """
    ...
    def external_source(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class JobCopyArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        create_disposition: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        write_disposition: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobCopyArgs:
    def __init__(__self__, *,
                 ...
                 create_disposition: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 write_disposition: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['JobCopySourceTableArgs']]] source_tables: Source tables to copy.
               Structure is documented below.
        :param pulumi.Input[builtins.str] create_disposition: Specifies whether the job is allowed to create new tables. The following values are supported:
               CREATE_IF_NEEDED: If the table does not exist, BigQuery creates the table.
               CREATE_NEVER: The table must already exist. If it does not, a 'notFound' error is returned in the job result.
               Creation, truncation and append actions occur as one atomic update upon job completion
               Default value is `CREATE_IF_NEEDED`.
        ...
        :param pulumi.Input['JobCopyDestinationTableArgs'] destination_table: The destination table.
               Structure is documented below.
        :param pulumi.Input[builtins.str] write_disposition: Specifies the action that occurs if the destination table already exists. The following values are supported:
               WRITE_TRUNCATE: If the table already exists, BigQuery overwrites the table data and uses the schema from the query result.
               WRITE_APPEND: If the table already exists, BigQuery appends the data to the table.
               WRITE_EMPTY: If the table already exists and contains data, a 'duplicate' error is returned in the job result.
               Each action is atomic and only occurs if BigQuery is able to complete the job successfully.
    ...
    def create_disposition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether the job is allowed to create new tables. The following values are supported:
        CREATE_IF_NEEDED: If the table does not exist, BigQuery creates the table.
        CREATE_NEVER: The table must already exist. If it does not, a 'notFound' error is returned in the job result.
    ...
    def create_disposition(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def write_disposition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the action that occurs if the destination table already exists. The following values are supported:
        WRITE_TRUNCATE: If the table already exists, BigQuery overwrites the table data and uses the schema from the query result.
        WRITE_APPEND: If the table already exists, BigQuery appends the data to the table.
    ...
    def write_disposition(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class JobCopyDestinationEncryptionConfigurationArgsDict(TypedDict):
        ...
        """
        kms_key_version: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class JobCopyDestinationEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_name: Describes the Cloud KMS encryption key that will be used to protect destination BigQuery table.
               The BigQuery Service Account associated with your project requires access to this encryption key.
        :param pulumi.Input[builtins.str] kms_key_version: (Output)
               Describes the Cloud KMS encryption key version used to protect destination BigQuery table.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
...
class JobCopyDestinationTableArgs:
    def __init__(__self__, *,
                 ...
                 project_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] table_id: The table. Can be specified `{{table_id}}` if `project_id` and `dataset_id` are also set,
               or of the form `projects/{{project}}/datasets/{{dataset_id}}/tables/{{table_id}}` if not.
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[builtins.str] project_id: The ID of the project containing this table.
        """
...
if not MYPY:
    class JobExtractArgsDict(TypedDict):
        destination_uris: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        A list of fully-qualified Google Cloud Storage URIs where the extracted table should be written.
        """
        compression: NotRequired[pulumi.Input[builtins.str]]
        """
        The compression type to use for exported files. Possible values include GZIP, DEFLATE, SNAPPY, and NONE.
        The default value is NONE. DEFLATE and SNAPPY are only supported for Avro.
        """
        destination_format: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        use_avro_logical_types: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class JobExtractArgs:
    def __init__(__self__, *,
                 ...
                 destination_format: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 use_avro_logical_types: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destination_uris: A list of fully-qualified Google Cloud Storage URIs where the extracted table should be written.
        :param pulumi.Input[builtins.str] compression: The compression type to use for exported files. Possible values include GZIP, DEFLATE, SNAPPY, and NONE.
               The default value is NONE. DEFLATE and SNAPPY are only supported for Avro.
        :param pulumi.Input[builtins.str] destination_format: The exported file format. Possible values include CSV, NEWLINE_DELIMITED_JSON and AVRO for tables and SAVED_MODEL for models.
               The default value for tables is CSV. Tables with nested or repeated fields cannot be exported as CSV.
               The default value for models is SAVED_MODEL.
        :param pulumi.Input[builtins.str] field_delimiter: When extracting data in CSV format, this defines the delimiter to use between fields in the exported data.
               Default is ','
        :param pulumi.Input[builtins.bool] print_header: Whether to print out a header row in the results. Default is true.
        ...
        :param pulumi.Input['JobExtractSourceTableArgs'] source_table: A reference to the table being exported.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] use_avro_logical_types: Whether to use logical types when extracting to AVRO format.
        """
    ...
    def destination_uris(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of fully-qualified Google Cloud Storage URIs where the extracted table should be written.
        """
    ...
    def destination_uris(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def destination_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The exported file format. Possible values include CSV, NEWLINE_DELIMITED_JSON and AVRO for tables and SAVED_MODEL for models.
        The default value for tables is CSV. Tables with nested or repeated fields cannot be exported as CSV.
        The default value for models is SAVED_MODEL.
    ...
    def destination_format(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_avro_logical_types(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to use logical types when extracting to AVRO format.
        """
    ...
    def use_avro_logical_types(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class JobLoadArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        source_uris: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        allow_jagged_rows: NotRequired[pulumi.Input[builtins.bool]]
        """
        Accept rows that are missing trailing optional columns. The missing values are treated as nulls.
        If false, records with missing trailing columns are treated as bad records, and if there are too many bad records,
        an invalid error is returned in the job result. The default value is false. Only applicable to CSV, ignored for other formats.
        """
        allow_quoted_newlines: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates if BigQuery should allow quoted data sections that contain newline characters in a CSV file.
        The default value is false.
        """
        autodetect: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        ignore_unknown_values: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        json_extension: NotRequired[pulumi.Input[builtins.str]]
        """
        If sourceFormat is set to newline-delimited JSON, indicates whether it should be processed as a JSON variant such as GeoJSON.
        For a sourceFormat other than JSON, omit this field. If the sourceFormat is newline-delimited JSON: - for newline-delimited
        GeoJSON: set to GEOJSON.
        """
        max_bad_records: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum number of bad records that BigQuery can ignore when running the job. If the number of bad records exceeds this value,
        an invalid error is returned in the job result. The default value is 0, which requires that all records are valid.
        """
        null_marker: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        projection_fields: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        schema_update_options: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        skip_leading_rows: NotRequired[pulumi.Input[builtins.int]]
        """
...
class JobLoadArgs:
    def __init__(__self__, *,
                 ...
                 source_uris: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 allow_jagged_rows: Optional[pulumi.Input[builtins.bool]] = None,
                 allow_quoted_newlines: Optional[pulumi.Input[builtins.bool]] = None,
                 autodetect: Optional[pulumi.Input[builtins.bool]] = None,
                 create_disposition: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 field_delimiter: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_unknown_values: Optional[pulumi.Input[builtins.bool]] = None,
                 json_extension: Optional[pulumi.Input[builtins.str]] = None,
                 max_bad_records: Optional[pulumi.Input[builtins.int]] = None,
                 null_marker: Optional[pulumi.Input[builtins.str]] = None,
                 parquet_options: Optional[pulumi.Input['JobLoadParquetOptionsArgs']] = None,
                 projection_fields: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 quote: Optional[pulumi.Input[builtins.str]] = None,
                 schema_update_options: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 skip_leading_rows: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input['JobLoadDestinationTableArgs'] destination_table: The destination table to load the data into.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_uris: The fully-qualified URIs that point to your data in Google Cloud.
               For Google Cloud Storage URIs: Each URI can contain one '\\*' wildcard character
               and it must come after the 'bucket' name. Size limits related to load jobs apply
               to external data sources. For Google Cloud Bigtable URIs: Exactly one URI can be
               specified and it has be a fully specified and valid HTTPS URL for a Google Cloud Bigtable table.
               For Google Cloud Datastore backups: Exactly one URI can be specified. Also, the '\\*' wildcard character is not allowed.
        :param pulumi.Input[builtins.bool] allow_jagged_rows: Accept rows that are missing trailing optional columns. The missing values are treated as nulls.
               If false, records with missing trailing columns are treated as bad records, and if there are too many bad records,
               an invalid error is returned in the job result. The default value is false. Only applicable to CSV, ignored for other formats.
        :param pulumi.Input[builtins.bool] allow_quoted_newlines: Indicates if BigQuery should allow quoted data sections that contain newline characters in a CSV file.
               The default value is false.
        :param pulumi.Input[builtins.bool] autodetect: Indicates if we should automatically infer the options and schema for CSV and JSON sources.
        :param pulumi.Input[builtins.str] create_disposition: Specifies whether the job is allowed to create new tables. The following values are supported:
               CREATE_IF_NEEDED: If the table does not exist, BigQuery creates the table.
               CREATE_NEVER: The table must already exist. If it does not, a 'notFound' error is returned in the job result.
               Creation, truncation and append actions occur as one atomic update upon job completion
        ...
        :param pulumi.Input['JobLoadDestinationEncryptionConfigurationArgs'] destination_encryption_configuration: Custom encryption configuration (e.g., Cloud KMS keys)
               Structure is documented below.
        :param pulumi.Input[builtins.str] encoding: The character encoding of the data. The supported values are UTF-8 or ISO-8859-1.
               The default value is UTF-8. BigQuery decodes the data after the raw, binary data
               has been split using the values of the quote and fieldDelimiter properties.
        :param pulumi.Input[builtins.str] field_delimiter: The separator for fields in a CSV file. The separator can be any ISO-8859-1 single-byte character.
               To use a character in the range 128-255, you must encode the character as UTF8. BigQuery converts
               the string to ISO-8859-1 encoding, and then uses the first byte of the encoded string to split the
               data in its raw, binary state. BigQuery also supports the escape sequence "\\t" to specify a tab separator.
               The default value is a comma (',').
        :param pulumi.Input[builtins.bool] ignore_unknown_values: Indicates if BigQuery should allow extra values that are not represented in the table schema.
               If true, the extra values are ignored. If false, records with extra columns are treated as bad records,
               and if there are too many bad records, an invalid error is returned in the job result.
               The default value is false. The sourceFormat property determines what BigQuery treats as an extra value:
               CSV: Trailing columns
               JSON: Named values that don't match any column names
        :param pulumi.Input[builtins.str] json_extension: If sourceFormat is set to newline-delimited JSON, indicates whether it should be processed as a JSON variant such as GeoJSON.
               For a sourceFormat other than JSON, omit this field. If the sourceFormat is newline-delimited JSON: - for newline-delimited
               GeoJSON: set to GEOJSON.
        :param pulumi.Input[builtins.int] max_bad_records: The maximum number of bad records that BigQuery can ignore when running the job. If the number of bad records exceeds this value,
               an invalid error is returned in the job result. The default value is 0, which requires that all records are valid.
        :param pulumi.Input[builtins.str] null_marker: Specifies a string that represents a null value in a CSV file. The default value is the empty string. If you set this
               property to a custom value, BigQuery throws an error if an
               empty string is present for all data types except for STRING and BYTE. For STRING and BYTE columns, BigQuery interprets the empty string as
               an empty value.
        :param pulumi.Input['JobLoadParquetOptionsArgs'] parquet_options: Parquet Options for load and make external tables.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] projection_fields: If sourceFormat is set to "DATASTORE_BACKUP", indicates which entity properties to load into BigQuery from a Cloud Datastore backup.
               Property names are case sensitive and must be top-level properties. If no properties are specified, BigQuery loads all properties.
               If any named property isn't found in the Cloud Datastore backup, an invalid error is returned in the job result.
        :param pulumi.Input[builtins.str] quote: The value that is used to quote data sections in a CSV file. BigQuery converts the string to ISO-8859-1 encoding,
               and then uses the first byte of the encoded string to split the data in its raw, binary state.
               The default value is a double-quote ('"'). If your data does not contain quoted sections, set the property value to an empty string.
               If your data contains quoted newline characters, you must also set the allowQuotedNewlines property to true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schema_update_options: Allows the schema of the destination table to be updated as a side effect of the load job if a schema is autodetected or
               supplied in the job configuration. Schema update options are supported in two cases: when writeDisposition is WRITE_APPEND;
               when writeDisposition is WRITE_TRUNCATE and the destination table is a partition of a table, specified by partition decorators.
               For normal tables, WRITE_TRUNCATE will always overwrite the schema. One or more of the following values are specified:
               ALLOW_FIELD_ADDITION: allow adding a nullable field to the schema.
               ALLOW_FIELD_RELAXATION: allow relaxing a required field in the original schema to nullable.
        :param pulumi.Input[builtins.int] skip_leading_rows: The number of rows at the top of a CSV file that BigQuery will skip when loading the data.
               The default value is 0. This property is useful if you have header rows in the file that should be skipped.
               When autodetect is on, the behavior is the following:
               skipLeadingRows unspecified - Autodetect tries to detect headers in the first row. If they are not detected,
               the row is read as data. Otherwise data is read starting from the second row.
               ...
               skipLeadingRows = N > 0 - Autodetect skips N-1 rows and tries to detect headers in row N. If headers are not detected,
               row N is just skipped. Otherwise row N is used to extract column names for the detected schema.
        :param pulumi.Input[builtins.str] source_format: The format of the data files. For CSV files, specify "CSV". For datastore backups, specify "DATASTORE_BACKUP".
               For newline-delimited JSON, specify "NEWLINE_DELIMITED_JSON". For Avro, specify "AVRO". For parquet, specify "PARQUET".
               For orc, specify "ORC". [Beta] For Bigtable, specify "BIGTABLE".
               The default value is CSV.
    ...
    def source_uris(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The fully-qualified URIs that point to your data in Google Cloud.
        For Google Cloud Storage URIs: Each URI can contain one '\\*' wildcard character
        and it must come after the 'bucket' name. Size limits related to load jobs apply
    ...
    @source_uris.setter
    def source_uris(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "source_uris", value)

    @property
    @pulumi.getter(name="allowJaggedRows")
    def allow_jagged_rows(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Accept rows that are missing trailing optional columns. The missing values are treated as nulls.
        If false, records with missing trailing columns are treated as bad records, and if there are too many bad records,
        an invalid error is returned in the job result. The default value is false. Only applicable to CSV, ignored for other formats.
    ...
    def allow_jagged_rows(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_jagged_rows", value)

    @property
    @pulumi.getter(name="allowQuotedNewlines")
    def allow_quoted_newlines(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates if BigQuery should allow quoted data sections that contain newline characters in a CSV file.
        The default value is false.
        """
    ...
    def allow_quoted_newlines(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_quoted_newlines", value)

    @property
    @pulumi.getter
    def autodetect(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates if we should automatically infer the options and schema for CSV and JSON sources.
        """
    ...
    @autodetect.setter
    def autodetect(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ignore_unknown_values(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates if BigQuery should allow extra values that are not represented in the table schema.
        If true, the extra values are ignored. If false, records with extra columns are treated as bad records,
        and if there are too many bad records, an invalid error is returned in the job result.
    ...
    def ignore_unknown_values(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ignore_unknown_values", value)

    @property
    @pulumi.getter(name="jsonExtension")
    def json_extension(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If sourceFormat is set to newline-delimited JSON, indicates whether it should be processed as a JSON variant such as GeoJSON.
        For a sourceFormat other than JSON, omit this field. If the sourceFormat is newline-delimited JSON: - for newline-delimited
        GeoJSON: set to GEOJSON.
    ...
    def json_extension(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "json_extension", value)

    @property
    @pulumi.getter(name="maxBadRecords")
    def max_bad_records(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of bad records that BigQuery can ignore when running the job. If the number of bad records exceeds this value,
        an invalid error is returned in the job result. The default value is 0, which requires that all records are valid.
        """
    ...
    def max_bad_records(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_bad_records", value)

    @property
    @pulumi.getter(name="nullMarker")
    def null_marker(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies a string that represents a null value in a CSV file. The default value is the empty string. If you set this
        property to a custom value, BigQuery throws an error if an
        empty string is present for all data types except for STRING and BYTE. For STRING and BYTE columns, BigQuery interprets the empty string as
    ...
    @null_marker.setter
    def null_marker(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def projection_fields(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        If sourceFormat is set to "DATASTORE_BACKUP", indicates which entity properties to load into BigQuery from a Cloud Datastore backup.
        Property names are case sensitive and must be top-level properties. If no properties are specified, BigQuery loads all properties.
        If any named property isn't found in the Cloud Datastore backup, an invalid error is returned in the job result.
    ...
    def projection_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def schema_update_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Allows the schema of the destination table to be updated as a side effect of the load job if a schema is autodetected or
        supplied in the job configuration. Schema update options are supported in two cases: when writeDisposition is WRITE_APPEND;
        when writeDisposition is WRITE_TRUNCATE and the destination table is a partition of a table, specified by partition decorators.
    ...
    def schema_update_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "schema_update_options", value)

    @property
    @pulumi.getter(name="skipLeadingRows")
    def skip_leading_rows(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of rows at the top of a CSV file that BigQuery will skip when loading the data.
        The default value is 0. This property is useful if you have header rows in the file that should be skipped.
        When autodetect is on, the behavior is the following:
    ...
    def skip_leading_rows(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class JobLoadParquetOptionsArgsDict(TypedDict):
        enable_list_inference: NotRequired[pulumi.Input[builtins.bool]]
        """
        If sourceFormat is set to PARQUET, indicates whether to use schema inference specifically for Parquet LIST logical type.
        """
        enum_as_string: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class JobLoadParquetOptionsArgs:
    def __init__(__self__, *,
                 enable_list_inference: Optional[pulumi.Input[builtins.bool]] = None,
                 enum_as_string: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_list_inference: If sourceFormat is set to PARQUET, indicates whether to use schema inference specifically for Parquet LIST logical type.
        :param pulumi.Input[builtins.bool] enum_as_string: If sourceFormat is set to PARQUET, indicates whether to infer Parquet ENUM logical type as STRING instead of BYTES by default.
        """
    ...
    def enable_list_inference(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If sourceFormat is set to PARQUET, indicates whether to use schema inference specifically for Parquet LIST logical type.
        """
    ...
    def enable_list_inference(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_list_inference", value)

    @property
    @pulumi.getter(name="enumAsString")
    def enum_as_string(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If sourceFormat is set to PARQUET, indicates whether to infer Parquet ENUM logical type as STRING instead of BYTES by default.
        """
    ...
    def enum_as_string(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class JobLoadTimePartitioningArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The only type supported is DAY, which will generate one partition per day. Providing an empty string used to cause an error,
               but in OnePlatform the field will be treated as unset.
        :param pulumi.Input[builtins.str] expiration_ms: Number of milliseconds for which to keep the storage for a partition. A wrapper is used here because 0 is an invalid value.
        :param pulumi.Input[builtins.str] field: If not set, the table is partitioned by pseudo column '_PARTITIONTIME'; if set, the table is partitioned by this field.
               The field must be a top-level TIMESTAMP or DATE field. Its mode must be NULLABLE or REQUIRED.
               A wrapper is used here because an empty string is an invalid value.
        """
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class JobQueryArgsDict(TypedDict):
        ...
        *NOTE*: queries containing [DML language](https://cloud.google.com/bigquery/docs/reference/standard-sql/data-manipulation-language)
        ...
        """
        allow_large_results: NotRequired[pulumi.Input[builtins.bool]]
        """
        If true and query uses legacy SQL dialect, allows the query to produce arbitrarily large result tables at a slight cost in performance.
        Requires destinationTable to be set. For standard SQL queries, this flag is ignored and large results are always allowed.
        However, you must still set destinationTable when result size exceeds the allowed maximum response size.
        """
        continuous: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        Structure is documented below.
        """
        flatten_results: NotRequired[pulumi.Input[builtins.bool]]
        """
        If true and query uses legacy SQL dialect, flattens all nested and repeated fields in the query results.
        allowLargeResults must be true if this is set to false. For standard SQL queries, this flag is ignored and results are never flattened.
        """
        maximum_billing_tier: NotRequired[pulumi.Input[builtins.int]]
        """
        Limits the billing tier for this job. Queries that have resource usage beyond this tier will fail (without incurring a charge).
        If unspecified, this will be set to your project default.
        """
        maximum_bytes_billed: NotRequired[pulumi.Input[builtins.str]]
        """
        Limits the bytes billed for this job. Queries that will have bytes billed beyond this limit will fail (without incurring a charge).
        If unspecified, this will be set to your project default.
        """
        parameter_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        use_legacy_sql: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether to use BigQuery's legacy SQL dialect for this query. The default value is true.
        If set to false, the query will use BigQuery's standard SQL.
        """
        use_query_cache: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class JobQueryArgs:
    def __init__(__self__, *,
                 query: pulumi.Input[builtins.str],
                 allow_large_results: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 flatten_results: Optional[pulumi.Input[builtins.bool]] = None,
                 maximum_billing_tier: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_bytes_billed: Optional[pulumi.Input[builtins.str]] = None,
                 parameter_mode: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.str]] = None,
                 schema_update_options: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 script_options: Optional[pulumi.Input['JobQueryScriptOptionsArgs']] = None,
                 use_legacy_sql: Optional[pulumi.Input[builtins.bool]] = None,
                 use_query_cache: Optional[pulumi.Input[builtins.bool]] = None,
                 user_defined_function_resources: Optional[pulumi.Input[Sequence[pulumi.Input['JobQueryUserDefinedFunctionResourceArgs']]]] = None,
                 write_disposition: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] query: SQL query text to execute. The useLegacySql field can be used to indicate whether the query uses legacy SQL or standard SQL.
               *NOTE*: queries containing [DML language](https://cloud.google.com/bigquery/docs/reference/standard-sql/data-manipulation-language)
               (`DELETE`, `UPDATE`, `MERGE`, `INSERT`) must specify `create_disposition = ""` and `write_disposition = ""`.
        :param pulumi.Input[builtins.bool] allow_large_results: If true and query uses legacy SQL dialect, allows the query to produce arbitrarily large result tables at a slight cost in performance.
               Requires destinationTable to be set. For standard SQL queries, this flag is ignored and large results are always allowed.
               However, you must still set destinationTable when result size exceeds the allowed maximum response size.
        :param pulumi.Input[builtins.bool] continuous: Whether to run the query as continuous or a regular query.
        :param pulumi.Input[builtins.str] create_disposition: Specifies whether the job is allowed to create new tables. The following values are supported:
               CREATE_IF_NEEDED: If the table does not exist, BigQuery creates the table.
               CREATE_NEVER: The table must already exist. If it does not, a 'notFound' error is returned in the job result.
               Creation, truncation and append actions occur as one atomic update upon job completion
        ...
        :param pulumi.Input['JobQueryDestinationTableArgs'] destination_table: Describes the table where the query results should be stored.
               ...
               For queries that produce anonymous (cached) results, this field will be populated by BigQuery.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] flatten_results: If true and query uses legacy SQL dialect, flattens all nested and repeated fields in the query results.
               allowLargeResults must be true if this is set to false. For standard SQL queries, this flag is ignored and results are never flattened.
        :param pulumi.Input[builtins.int] maximum_billing_tier: Limits the billing tier for this job. Queries that have resource usage beyond this tier will fail (without incurring a charge).
               If unspecified, this will be set to your project default.
        :param pulumi.Input[builtins.str] maximum_bytes_billed: Limits the bytes billed for this job. Queries that will have bytes billed beyond this limit will fail (without incurring a charge).
               If unspecified, this will be set to your project default.
        :param pulumi.Input[builtins.str] parameter_mode: Standard SQL only. Set to POSITIONAL to use positional (?) query parameters or to NAMED to use named (@myparam) query parameters in this query.
        :param pulumi.Input[builtins.str] priority: Specifies a priority for the query.
               Default value is `INTERACTIVE`.
               Possible values are: `INTERACTIVE`, `BATCH`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schema_update_options: Allows the schema of the destination table to be updated as a side effect of the query job.
               Schema update options are supported in two cases: when writeDisposition is WRITE_APPEND;
               when writeDisposition is WRITE_TRUNCATE and the destination table is a partition of a table,
               specified by partition decorators. For normal tables, WRITE_TRUNCATE will always overwrite the schema.
               One or more of the following values are specified:
        ...
        :param pulumi.Input['JobQueryScriptOptionsArgs'] script_options: Options controlling the execution of scripts.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] use_legacy_sql: Specifies whether to use BigQuery's legacy SQL dialect for this query. The default value is true.
               If set to false, the query will use BigQuery's standard SQL.
        :param pulumi.Input[builtins.bool] use_query_cache: Whether to look for the result in the query cache. The query cache is a best-effort cache that will be flushed whenever
               tables in the query are modified. Moreover, the query cache is only available when a query does not have a destination table specified.
               The default value is true.
    ...
    def allow_large_results(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true and query uses legacy SQL dialect, allows the query to produce arbitrarily large result tables at a slight cost in performance.
        Requires destinationTable to be set. For standard SQL queries, this flag is ignored and large results are always allowed.
        However, you must still set destinationTable when result size exceeds the allowed maximum response size.
    ...
    def allow_large_results(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def flatten_results(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true and query uses legacy SQL dialect, flattens all nested and repeated fields in the query results.
        allowLargeResults must be true if this is set to false. For standard SQL queries, this flag is ignored and results are never flattened.
        """
    ...
    def flatten_results(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "flatten_results", value)

    @property
    @pulumi.getter(name="maximumBillingTier")
    def maximum_billing_tier(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Limits the billing tier for this job. Queries that have resource usage beyond this tier will fail (without incurring a charge).
        If unspecified, this will be set to your project default.
        """
    ...
    def maximum_billing_tier(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_billing_tier", value)

    @property
    @pulumi.getter(name="maximumBytesBilled")
    def maximum_bytes_billed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Limits the bytes billed for this job. Queries that will have bytes billed beyond this limit will fail (without incurring a charge).
        If unspecified, this will be set to your project default.
        """
    ...
    def maximum_bytes_billed(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "maximum_bytes_billed", value)

    @property
    @pulumi.getter(name="parameterMode")
    def parameter_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Standard SQL only. Set to POSITIONAL to use positional (?) query parameters or to NAMED to use named (@myparam) query parameters in this query.
        """
    ...
    def parameter_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_legacy_sql(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use BigQuery's legacy SQL dialect for this query. The default value is true.
        If set to false, the query will use BigQuery's standard SQL.
        """
    ...
    def use_legacy_sql(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_legacy_sql", value)

    @property
    @pulumi.getter(name="useQueryCache")
    def use_query_cache(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to look for the result in the query cache. The query cache is a best-effort cache that will be flushed whenever
        tables in the query are modified. Moreover, the query cache is only available when a query does not have a destination table specified.
        The default value is true.
    ...
    def use_query_cache(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class JobQueryDefaultDatasetArgs:
    def __init__(__self__, *,
                 ...
                 project_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] dataset_id: The dataset. Can be specified `{{dataset_id}}` if `project_id` is also set,
               or of the form `projects/{{project}}/datasets/{{dataset_id}}` if not.
        :param pulumi.Input[builtins.str] project_id: The ID of the project containing this table.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
if not MYPY:
    class JobQueryScriptOptionsArgsDict(TypedDict):
        key_result_statement: NotRequired[pulumi.Input[builtins.str]]
        """
        Determines which statement in the script represents the "key result",
        used to populate the schema and query results of the script job.
        Possible values are: `LAST`, `FIRST_SELECT`.
        """
        statement_byte_budget: NotRequired[pulumi.Input[builtins.str]]
        """
        Limit on the number of bytes billed per statement. Exceeding this budget results in an error.
        """
        statement_timeout_ms: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobQueryScriptOptionsArgs:
    def __init__(__self__, *,
                 key_result_statement: Optional[pulumi.Input[builtins.str]] = None,
                 statement_byte_budget: Optional[pulumi.Input[builtins.str]] = None,
                 statement_timeout_ms: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key_result_statement: Determines which statement in the script represents the "key result",
               used to populate the schema and query results of the script job.
               Possible values are: `LAST`, `FIRST_SELECT`.
        :param pulumi.Input[builtins.str] statement_byte_budget: Limit on the number of bytes billed per statement. Exceeding this budget results in an error.
        :param pulumi.Input[builtins.str] statement_timeout_ms: Timeout period for each statement in a script.
        """
    ...
    def key_result_statement(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines which statement in the script represents the "key result",
        used to populate the schema and query results of the script job.
        Possible values are: `LAST`, `FIRST_SELECT`.
    ...
    def key_result_statement(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "key_result_statement", value)

    @property
    @pulumi.getter(name="statementByteBudget")
    def statement_byte_budget(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Limit on the number of bytes billed per statement. Exceeding this budget results in an error.
        """
    ...
    def statement_byte_budget(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "statement_byte_budget", value)

    @property
    @pulumi.getter(name="statementTimeoutMs")
    def statement_timeout_ms(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Timeout period for each statement in a script.
        """
    ...
    def statement_timeout_ms(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "statement_timeout_ms", value)


if not MYPY:
    class JobQueryUserDefinedFunctionResourceArgsDict(TypedDict):
        inline_code: NotRequired[pulumi.Input[builtins.str]]
        """
        An inline resource that contains code for a user-defined function (UDF).
        Providing a inline code resource is equivalent to providing a URI for a file containing the same code.
        """
        resource_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobQueryUserDefinedFunctionResourceArgs:
    def __init__(__self__, *,
                 inline_code: Optional[pulumi.Input[builtins.str]] = None,
                 resource_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] inline_code: An inline resource that contains code for a user-defined function (UDF).
               Providing a inline code resource is equivalent to providing a URI for a file containing the same code.
        :param pulumi.Input[builtins.str] resource_uri: A code resource to load from a Google Cloud Storage URI (gs://bucket/path).
        """
    ...
    def inline_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An inline resource that contains code for a user-defined function (UDF).
        Providing a inline code resource is equivalent to providing a URI for a file containing the same code.
        """
    ...
    @inline_code.setter
    def inline_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ReservationAutoscaleArgsDict(TypedDict):
        current_slots: NotRequired[pulumi.Input[builtins.int]]
        """
        (Output)
        The slot capacity added to this reservation when autoscale happens. Will be between [0, max_slots].
        """
        max_slots: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ReservationAutoscaleArgs:
    def __init__(__self__, *,
                 current_slots: Optional[pulumi.Input[builtins.int]] = None,
                 max_slots: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] current_slots: (Output)
               The slot capacity added to this reservation when autoscale happens. Will be between [0, max_slots].
        :param pulumi.Input[builtins.int] max_slots: Number of slots to be scaled when needed.
        """
    ...
    def current_slots(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Output)
        The slot capacity added to this reservation when autoscale happens. Will be between [0, max_slots].
        """
    ...
    def current_slots(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "current_slots", value)

    @property
    @pulumi.getter(name="maxSlots")
    def max_slots(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of slots to be scaled when needed.
        """
    ...
    @max_slots.setter
    def max_slots(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ReservationReplicationStatusArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        last_error_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        ...
        succeeded since.
        """
        last_replication_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class ReservationReplicationStatusArgs:
    def __init__(__self__, *,
                 ...
                 last_error_time: Optional[pulumi.Input[builtins.str]] = None,
                 last_replication_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['ReservationReplicationStatusErrorArgs']]] errors: (Output)
               The last error encountered while trying to replicate changes from the primary to the
               secondary. This field is only available if the replication has not succeeded since.
               Structure is documented below.
        :param pulumi.Input[builtins.str] last_error_time: (Output)
               The time at which the last error was encountered while trying to replicate changes from
               the primary to the secondary. This field is only available if the replication has not
               succeeded since.
        :param pulumi.Input[builtins.str] last_replication_time: (Output)
               A timestamp corresponding to the last change on the primary that was successfully
               replicated to the secondary.
        """
        if errors is not None:
    ...
    def last_error_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The time at which the last error was encountered while trying to replicate changes from
        the primary to the secondary. This field is only available if the replication has not
    ...
    def last_error_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_error_time", value)

    @property
    @pulumi.getter(name="lastReplicationTime")
    def last_replication_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        A timestamp corresponding to the last change on the primary that was successfully
        replicated to the secondary.
    ...
    def last_replication_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RoutineArgumentArgsDict(TypedDict):
        argument_kind: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RoutineArgumentArgs:
    def __init__(__self__, *,
                 argument_kind: Optional[pulumi.Input[builtins.str]] = None,
                 data_type: Optional[pulumi.Input[builtins.str]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] argument_kind: Defaults to FIXED_TYPE.
               Default value is `FIXED_TYPE`.
               Possible values are: `FIXED_TYPE`, `ANY_TYPE`.
        :param pulumi.Input[builtins.str] data_type: A JSON schema for the data type. Required unless argumentKind = ANY_TYPE.
               ~>**NOTE**: Because this field expects a JSON string, any changes to the string
               will create a diff, even if the JSON itself hasn't changed. If the API returns
               a different value for the same schema, e.g. it switched the order of values
               or replaced STRUCT field type with RECORD field type, we currently cannot
               suppress the recurring diff this causes. As a workaround, we recommend using
               the schema as returned by the API.
        :param pulumi.Input[builtins.str] mode: Specifies whether the argument is input or output. Can be set for procedures only.
               Possible values are: `IN`, `OUT`, `INOUT`.
        :param pulumi.Input[builtins.str] name: The name of this argument. Can be absent for function return argument.
        """
    ...
    def argument_kind(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defaults to FIXED_TYPE.
        Default value is `FIXED_TYPE`.
        Possible values are: `FIXED_TYPE`, `ANY_TYPE`.
    ...
    def argument_kind(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RoutineRemoteFunctionOptionsArgsDict(TypedDict):
        ...
        """
        max_batching_rows: NotRequired[pulumi.Input[builtins.str]]
        """
        Max number of rows in each batch sent to the remote service. If absent or if 0,
        BigQuery dynamically decides the number of rows in a batch.
        """
        user_defined_context: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class RoutineRemoteFunctionOptionsArgs:
    def __init__(__self__, *,
                 ...
                 max_batching_rows: Optional[pulumi.Input[builtins.str]] = None,
                 user_defined_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] connection: Fully qualified name of the user-provided connection object which holds
               the authentication information to send requests to the remote service.
               Format: "projects/{projectId}/locations/{locationId}/connections/{connectionId}"
        :param pulumi.Input[builtins.str] endpoint: Endpoint of the user-provided remote service, e.g.
               `https://us-east1-my_gcf_project.cloudfunctions.net/remote_add`
        :param pulumi.Input[builtins.str] max_batching_rows: Max number of rows in each batch sent to the remote service. If absent or if 0,
               BigQuery dynamically decides the number of rows in a batch.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] user_defined_context: User-defined context as a set of key/value pairs, which will be sent as function
               invocation context together with batched arguments in the requests to the remote
               service. The total number of bytes of keys and values must be less than 8KB.
               An object containing a list of "key": value pairs. Example:
               `{ "name": "wrench", "mass": "1.3kg", "count": "3" }`.
    ...
    def max_batching_rows(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Max number of rows in each batch sent to the remote service. If absent or if 0,
        BigQuery dynamically decides the number of rows in a batch.
        """
    ...
    def max_batching_rows(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_batching_rows", value)

    @property
    @pulumi.getter(name="userDefinedContext")
    def user_defined_context(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        User-defined context as a set of key/value pairs, which will be sent as function
        invocation context together with batched arguments in the requests to the remote
        service. The total number of bytes of keys and values must be less than 8KB.
    ...
    def user_defined_context(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "user_defined_context", value)


if not MYPY:
    class RoutineSparkOptionsArgsDict(TypedDict):
        archive_uris: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        file_uris: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Files to be placed in the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        """
        jar_uris: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        main_file_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        py_file_uris: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RoutineSparkOptionsArgs:
    def __init__(__self__, *,
                 archive_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 connection: Optional[pulumi.Input[builtins.str]] = None,
                 container_image: Optional[pulumi.Input[builtins.str]] = None,
                 file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 jar_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 main_class: Optional[pulumi.Input[builtins.str]] = None,
                 main_file_uri: Optional[pulumi.Input[builtins.str]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 py_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 runtime_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: Archive files to be extracted into the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        :param pulumi.Input[builtins.str] connection: Fully qualified name of the user-provided Spark connection object.
               Format: "projects/{projectId}/locations/{locationId}/connections/{connectionId}"
        :param pulumi.Input[builtins.str] container_image: Custom container image for the runtime environment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: Files to be placed in the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_uris: JARs to include on the driver and executor CLASSPATH. For more information about Apache Spark, see Apache Spark.
        :param pulumi.Input[builtins.str] main_class: The fully qualified name of a class in jarUris, for example, com.example.wordcount.
               Exactly one of mainClass and main_jar_uri field should be set for Java/Scala language type.
        :param pulumi.Input[builtins.str] main_file_uri: The main file/jar URI of the Spark application.
               Exactly one of the definitionBody field and the mainFileUri field must be set for Python.
               Exactly one of mainClass and mainFileUri field should be set for Java/Scala language type.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: Configuration properties as a set of key/value pairs, which will be passed on to the Spark application.
               For more information, see Apache Spark and the procedure option list.
               An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] py_file_uris: Python files to be placed on the PYTHONPATH for PySpark application. Supported file types: .py, .egg, and .zip. For more information about Apache Spark, see Apache Spark.
        :param pulumi.Input[builtins.str] runtime_version: Runtime version. If not specified, the default runtime version is used.
        """
    ...
    def archive_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Archive files to be extracted into the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        """
    ...
    @archive_uris.setter
    def archive_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def file_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Files to be placed in the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        """
    ...
    @file_uris.setter
    def file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "file_uris", value)

    @property
    @pulumi.getter(name="jarUris")
    def jar_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        JARs to include on the driver and executor CLASSPATH. For more information about Apache Spark, see Apache Spark.
        """
    ...
    @jar_uris.setter
    def jar_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def main_file_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The main file/jar URI of the Spark application.
        Exactly one of the definitionBody field and the mainFileUri field must be set for Python.
        Exactly one of mainClass and mainFileUri field should be set for Java/Scala language type.
    ...
    def main_file_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def py_file_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Python files to be placed on the PYTHONPATH for PySpark application. Supported file types: .py, .egg, and .zip. For more information about Apache Spark, see Apache Spark.
        """
    ...
    @py_file_uris.setter
    def py_file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class TableBiglakeConfigurationArgsDict(TypedDict):
        ...
        """
        table_format: pulumi.Input[builtins.str]
        """
...
class TableBiglakeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 table_format: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] connection_id: The connection specifying the credentials to be used to
               read and write to external storage, such as Cloud Storage. The connection_id can
               have the form "&lt;project\\_id&gt;.&lt;location\\_id&gt;.&lt;connection\\_id&gt;" or
               projects/&lt;project\\_id&gt;/locations/&lt;location\\_id&gt;/connections/&lt;connection\\_id&gt;".
        :param pulumi.Input[builtins.str] file_format: The file format the table data is stored in.
        :param pulumi.Input[builtins.str] storage_uri: The fully qualified location prefix of the external folder where table data
               is stored. The '*' wildcard character is not allowed. The URI should be in the format "gs://bucket/path_to_table/"
        :param pulumi.Input[builtins.str] table_format: The table format the metadata only snapshots are stored in.
        """
    ...
    def table_format(self) -> pulumi.Input[builtins.str]:
        """
        The table format the metadata only snapshots are stored in.
        """
    ...
    @table_format.setter
    def table_format(self, value: pulumi.Input[builtins.str]):
...
class TableEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] kms_key_name: The self link or full name of a key which should be used to
               encrypt this table.  Note that the default bigquery service account will need to have
               encrypt/decrypt permissions on this key - you may want to see the
               `bigquery_get_default_service_account` datasource and the
               `kms.CryptoKeyIAMBinding` resource.
        :param pulumi.Input[builtins.str] kms_key_version: The self link or full name of the kms key version used to encrypt this table.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
        if kms_key_version is not None:
            pulumi.set(__self__, "kms_key_version", kms_key_version)
...
class TableExternalCatalogTableOptionsStorageDescriptorArgs:
    def __init__(__self__, *,
                 input_format: Optional[pulumi.Input[builtins.str]] = None,
                 location_uri: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @input_format.setter
    def input_format(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @location_uri.setter
    def location_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TableExternalCatalogTableOptionsStorageDescriptorSerdeInfoArgs:
    ...
    def serialization_library(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class TableExternalDataConfigurationArgsDict(TypedDict):
        autodetect: pulumi.Input[builtins.bool]
        """
        ...
        """
        file_set_spec_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        metadata_cache_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        object_metadata: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        reference_file_schema_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TableExternalDataConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 file_set_spec_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 max_bad_records: Optional[pulumi.Input[builtins.int]] = None,
                 metadata_cache_mode: Optional[pulumi.Input[builtins.str]] = None,
                 object_metadata: Optional[pulumi.Input[builtins.str]] = None,
                 parquet_options: Optional[pulumi.Input['TableExternalDataConfigurationParquetOptionsArgs']] = None,
                 reference_file_schema_uri: Optional[pulumi.Input[builtins.str]] = None,
                 schema: Optional[pulumi.Input[builtins.str]] = None,
                 source_format: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] autodetect: Let BigQuery try to autodetect the schema
               and format of the table.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_uris: A list of the fully-qualified URIs that point to
               your data in Google Cloud.
        ...
        :param pulumi.Input['TableExternalDataConfigurationBigtableOptionsArgs'] bigtable_options: Additional properties to set if
               `source_format` is set to "BIGTABLE". Structure is documented below.
        :param pulumi.Input[builtins.str] compression: The compression type of the data source.
               Valid values are "NONE" or "GZIP".
        :param pulumi.Input[builtins.str] connection_id: The connection specifying the credentials to be used to read
               external storage, such as Azure Blob, Cloud Storage, or S3. The `connection_id` can have
               the form `{{project}}.{{location}}.{{connection_id}}`
               or `projects/{{project}}/locations/{{location}}/connections/{{connection_id}}`.
        ...
        :param pulumi.Input['TableExternalDataConfigurationCsvOptionsArgs'] csv_options: Additional properties to set if
               `source_format` is set to "CSV". Structure is documented below.
        :param pulumi.Input[builtins.str] file_set_spec_type: Specifies how source URIs are interpreted for constructing the file set to load.
               By default source URIs are expanded against the underlying storage.
               Other options include specifying manifest files. Only applicable to object storage systems. Docs
        ...
        :param pulumi.Input['TableExternalDataConfigurationHivePartitioningOptionsArgs'] hive_partitioning_options: When set, configures hive partitioning
               ...
               partitioning on an unsupported format will lead to an error, as will providing
               an invalid specification. Structure is documented below.
        :param pulumi.Input[builtins.bool] ignore_unknown_values: Indicates if BigQuery should
               allow extra values that are not represented in the table schema.
               If true, the extra values are ignored. If false, records with
               extra columns are treated as bad records, and if there are too
               many bad records, an invalid error is returned in the job result.
               The default value is false.
        :param pulumi.Input[builtins.str] json_extension: Used to indicate that a JSON variant, rather than normal JSON, is being used as the sourceFormat. This should only be used in combination with the `JSON` source format. Valid values are: `GEOJSON`.
        :param pulumi.Input['TableExternalDataConfigurationJsonOptionsArgs'] json_options: Additional properties to set if
               `source_format` is set to "JSON". Structure is documented below.
        :param pulumi.Input[builtins.int] max_bad_records: The maximum number of bad records that
               BigQuery can ignore when reading data.
        :param pulumi.Input[builtins.str] metadata_cache_mode: Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source. Valid values are `AUTOMATIC` and `MANUAL`.
        :param pulumi.Input[builtins.str] object_metadata: Object Metadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the sourceUris. If `object_metadata` is set, `source_format` should be omitted.
        :param pulumi.Input['TableExternalDataConfigurationParquetOptionsArgs'] parquet_options: Additional properties to set if
               `source_format` is set to "PARQUET". Structure is documented below.
        :param pulumi.Input[builtins.str] reference_file_schema_uri: When creating an external table, the user can provide a reference file with the table schema. This is enabled for the following formats: AVRO, PARQUET, ORC.
        :param pulumi.Input[builtins.str] schema: A JSON schema for the external table. Schema is required
               for CSV and JSON formats if autodetect is not on. Schema is disallowed
               for Google Cloud Bigtable, Cloud Datastore backups, Avro, Iceberg, ORC and Parquet formats.
               ~>**NOTE:** Because this field expects a JSON string, any changes to the
               string will create a diff, even if the JSON itself hasn't changed.
               ...
               table schema must be specified using the top-level `schema` field
               documented above.
        :param pulumi.Input[builtins.str] source_format: The data format. Please see sourceFormat under
               [ExternalDataConfiguration](https://cloud.google.com/bigquery/docs/reference/rest/v2/tables#externaldataconfiguration)
               in Bigquery's public API documentation for supported formats. To use "GOOGLE_SHEETS"
               the `scopes` must include "https://www.googleapis.com/auth/drive.readonly".
        """
    ...
    @property
    @pulumi.getter
    def autodetect(self) -> pulumi.Input[builtins.bool]:
        """
        Let BigQuery try to autodetect the schema
        and format of the table.
        """
    ...
    @autodetect.setter
    def autodetect(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "autodetect", value)
    ...
    def file_set_spec_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies how source URIs are interpreted for constructing the file set to load.
        By default source URIs are expanded against the underlying storage.
        Other options include specifying manifest files. Only applicable to object storage systems. Docs
    ...
    def file_set_spec_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def metadata_cache_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source. Valid values are `AUTOMATIC` and `MANUAL`.
        """
    ...
    def metadata_cache_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "metadata_cache_mode", value)

    @property
    @pulumi.getter(name="objectMetadata")
    def object_metadata(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Object Metadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the sourceUris. If `object_metadata` is set, `source_format` should be omitted.
        """
    ...
    def object_metadata(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reference_file_schema_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When creating an external table, the user can provide a reference file with the table schema. This is enabled for the following formats: AVRO, PARQUET, ORC.
        """
    ...
    def reference_file_schema_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TableExternalDataConfigurationAvroOptionsArgsDict(TypedDict):
        use_avro_logical_types: pulumi.Input[builtins.bool]
        """
...
class TableExternalDataConfigurationAvroOptionsArgs:
    def __init__(__self__, *,
                 use_avro_logical_types: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] use_avro_logical_types: If is set to true, indicates whether
               to interpret logical types as the corresponding BigQuery data type
               (for example, TIMESTAMP), instead of using the raw type (for example, INTEGER).
        """
        pulumi.set(__self__, "use_avro_logical_types", use_avro_logical_types)
    ...
    @property
    @pulumi.getter(name="useAvroLogicalTypes")
    def use_avro_logical_types(self) -> pulumi.Input[builtins.bool]:
        """
        If is set to true, indicates whether
        to interpret logical types as the corresponding BigQuery data type
        (for example, TIMESTAMP), instead of using the raw type (for example, INTEGER).
    ...
    @use_avro_logical_types.setter
    def use_avro_logical_types(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "use_avro_logical_types", value)
...
if not MYPY:
    class TableExternalDataConfigurationBigtableOptionsArgsDict(TypedDict):
        ...
        """
        ignore_unspecified_column_families: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        output_column_families_as_json: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        read_rowkey_as_string: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class TableExternalDataConfigurationBigtableOptionsArgs:
    def __init__(__self__, *,
                 ...
                 ignore_unspecified_column_families: Optional[pulumi.Input[builtins.bool]] = None,
                 output_column_families_as_json: Optional[pulumi.Input[builtins.bool]] = None,
                 read_rowkey_as_string: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] ignore_unspecified_column_families: If field is true, then the column families that are not specified in columnFamilies list are not exposed in the table schema. Otherwise, they are read with BYTES type values. The default value is false.
        :param pulumi.Input[builtins.bool] output_column_families_as_json: If field is true, then each column family will be read as a single JSON column. Otherwise they are read as a repeated cell structure containing timestamp/value tuples. The default value is false.
        :param pulumi.Input[builtins.bool] read_rowkey_as_string: If field is true, then the rowkey column families will be read and converted to string. Otherwise they are read with BYTES type values and users need to manually cast them with CAST if necessary. The default value is false.
        """
    ...
    def ignore_unspecified_column_families(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If field is true, then the column families that are not specified in columnFamilies list are not exposed in the table schema. Otherwise, they are read with BYTES type values. The default value is false.
        """
    ...
    def ignore_unspecified_column_families(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ignore_unspecified_column_families", value)

    @property
    @pulumi.getter(name="outputColumnFamiliesAsJson")
    def output_column_families_as_json(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If field is true, then each column family will be read as a single JSON column. Otherwise they are read as a repeated cell structure containing timestamp/value tuples. The default value is false.
        """
    ...
    def output_column_families_as_json(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "output_column_families_as_json", value)

    @property
    @pulumi.getter(name="readRowkeyAsString")
    def read_rowkey_as_string(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If field is true, then the rowkey column families will be read and converted to string. Otherwise they are read with BYTES type values and users need to manually cast them with CAST if necessary. The default value is false.
        """
    ...
    def read_rowkey_as_string(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class TableExternalDataConfigurationBigtableOptionsColumnFamilyArgsDict(TypedDict):
        ...
        """
        family_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Identifier of the column family.
        """
        only_read_latest: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyArgs:
    def __init__(__self__, *,
                 ...
                 encoding: Optional[pulumi.Input[builtins.str]] = None,
                 family_id: Optional[pulumi.Input[builtins.str]] = None,
                 only_read_latest: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] encoding: The encoding of the values when the type is not STRING. Acceptable encoding values are: TEXT - indicates values are alphanumeric text strings. BINARY - indicates values are encoded using HBase Bytes.toBytes family of functions. This can be overridden for a specific column by listing that column in 'columns' and specifying an encoding for it.
        :param pulumi.Input[builtins.str] family_id: Identifier of the column family.
        :param pulumi.Input[builtins.bool] only_read_latest: If this is set only the latest version of value are exposed for all columns in this column family. This can be overridden for a specific column by listing that column in 'columns' and specifying a different setting for that column.
        :param pulumi.Input[builtins.str] type: The type to convert the value in cells of this column family. The values are expected to be encoded using HBase Bytes.toBytes function when using the BINARY encoding value. Following BigQuery types are allowed (case-sensitive): "BYTES", "STRING", "INTEGER", "FLOAT", "BOOLEAN", "JSON". Default type is BYTES. This can be overridden for a specific column by listing that column in 'columns' and specifying a type for it.
        """
    ...
    def family_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Identifier of the column family.
        """
    ...
    @family_id.setter
    def family_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "family_id", value)

    @property
    @pulumi.getter(name="onlyReadLatest")
    def only_read_latest(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If this is set only the latest version of value are exposed for all columns in this column family. This can be overridden for a specific column by listing that column in 'columns' and specifying a different setting for that column.
        """
    ...
    def only_read_latest(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class TableExternalDataConfigurationBigtableOptionsColumnFamilyColumnArgsDict(TypedDict):
        ...
        """
        qualifier_encoded: NotRequired[pulumi.Input[builtins.str]]
        """
        Qualifier of the column. Columns in the parent column family that has this exact qualifier are exposed as . field. If the qualifier is valid UTF-8 string, it can be specified in the qualifierString field. Otherwise, a base-64 encoded value must be set to qualifierEncoded. The column field name is the same as the column qualifier. However, if the qualifier is not a valid BigQuery field identifier i.e. does not match [a-zA-Z][a-zA-Z0-9_]*, a valid identifier must be provided as fieldName.
        """
        qualifier_string: NotRequired[pulumi.Input[builtins.str]]
        """
        Qualifier string.
        """
        type: NotRequired[pulumi.Input[builtins.str]]
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyColumnArgs:
    def __init__(__self__, *,
                 ...
                 only_read_latest: Optional[pulumi.Input[builtins.bool]] = None,
                 qualifier_encoded: Optional[pulumi.Input[builtins.str]] = None,
                 qualifier_string: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] encoding: The encoding of the values when the type is not STRING. Acceptable encoding values are: TEXT - indicates values are alphanumeric text strings. BINARY - indicates values are encoded using HBase Bytes.toBytes family of functions. 'encoding' can also be set at the column family level. However, the setting at this level takes precedence if 'encoding' is set at both levels.
        :param pulumi.Input[builtins.str] field_name: If the qualifier is not a valid BigQuery field identifier i.e. does not match [a-zA-Z][a-zA-Z0-9_]*, a valid identifier must be provided as the column field name and is used as field name in queries.
        :param pulumi.Input[builtins.bool] only_read_latest: If this is set, only the latest version of value in this column are exposed. 'onlyReadLatest' can also be set at the column family level. However, the setting at this level takes precedence if 'onlyReadLatest' is set at both levels.
        :param pulumi.Input[builtins.str] qualifier_encoded: Qualifier of the column. Columns in the parent column family that has this exact qualifier are exposed as . field. If the qualifier is valid UTF-8 string, it can be specified in the qualifierString field. Otherwise, a base-64 encoded value must be set to qualifierEncoded. The column field name is the same as the column qualifier. However, if the qualifier is not a valid BigQuery field identifier i.e. does not match [a-zA-Z][a-zA-Z0-9_]*, a valid identifier must be provided as fieldName.
        :param pulumi.Input[builtins.str] qualifier_string: Qualifier string.
        :param pulumi.Input[builtins.str] type: The type to convert the value in cells of this column. The values are expected to be encoded using HBase Bytes.toBytes function when using the BINARY encoding value. Following BigQuery types are allowed (case-sensitive): "BYTES", "STRING", "INTEGER", "FLOAT", "BOOLEAN", "JSON", Default type is "BYTES". 'type' can also be set at the column family level. However, the setting at this level takes precedence if 'type' is set at both levels.
        """
        if encoding is not None:
            pulumi.set(__self__, "encoding", encoding)
    ...
    def qualifier_encoded(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Qualifier of the column. Columns in the parent column family that has this exact qualifier are exposed as . field. If the qualifier is valid UTF-8 string, it can be specified in the qualifierString field. Otherwise, a base-64 encoded value must be set to qualifierEncoded. The column field name is the same as the column qualifier. However, if the qualifier is not a valid BigQuery field identifier i.e. does not match [a-zA-Z][a-zA-Z0-9_]*, a valid identifier must be provided as fieldName.
        """
    ...
    def qualifier_encoded(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "qualifier_encoded", value)

    @property
    @pulumi.getter(name="qualifierString")
    def qualifier_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Qualifier string.
        """
    ...
    def qualifier_string(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TableExternalDataConfigurationCsvOptionsArgsDict(TypedDict):
        quote: pulumi.Input[builtins.str]
        """
...
class TableExternalDataConfigurationCsvOptionsArgs:
    def __init__(__self__, *,
                 ...
                 skip_leading_rows: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] quote: The value that is used to quote data sections in a
               CSV file. If your data does not contain quoted sections, set the
               property value to an empty string. If your data contains quoted newline
               characters, you must also set the `allow_quoted_newlines` property to true.
               The API-side default is `"`, specified in the provider escaped as `\\"`. Due to
               limitations with default values, this value is required to be
               explicitly set.
        :param pulumi.Input[builtins.bool] allow_jagged_rows: Indicates if BigQuery should accept rows
               that are missing trailing optional columns.
        :param pulumi.Input[builtins.bool] allow_quoted_newlines: Indicates if BigQuery should allow
               quoted data sections that contain newline characters in a CSV file.
               The default value is false.
        :param pulumi.Input[builtins.str] encoding: The character encoding of the data. The supported
               values are UTF-8 or ISO-8859-1.
        :param pulumi.Input[builtins.str] field_delimiter: The separator for fields in a CSV file.
        :param pulumi.Input[builtins.int] skip_leading_rows: The number of rows at the top of a CSV
               file that BigQuery will skip when reading the data.
        """
        pulumi.set(__self__, "quote", quote)
        if allow_jagged_rows is not None:
    ...
    @property
    @pulumi.getter
    def quote(self) -> pulumi.Input[builtins.str]:
        """
        The value that is used to quote data sections in a
        CSV file. If your data does not contain quoted sections, set the
        property value to an empty string. If your data contains quoted newline
    ...
    @quote.setter
    def quote(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "quote", value)
...
class TableExternalDataConfigurationGoogleSheetsOptionsArgs:
    def __init__(__self__, *,
                 ...
                 skip_leading_rows: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] range: Range of a sheet to query from. Only used when
               non-empty. At least one of `range` or `skip_leading_rows` must be set.
               Typical format: "sheet_name!top_left_cell_id:bottom_right_cell_id"
               For example: "sheet1!A1:B20"
        :param pulumi.Input[builtins.int] skip_leading_rows: The number of rows at the top of the sheet
               that BigQuery will skip when reading the data. At least one of `range` or
               `skip_leading_rows` must be set.
        """
...
if not MYPY:
    class TableExternalDataConfigurationHivePartitioningOptionsArgsDict(TypedDict):
        ...
        * CUSTOM: when set to `CUSTOM`, you must encode the partition key schema within the `source_uri_prefix` by setting `source_uri_prefix` to `gs://bucket/path_to_table/{key1:TYPE1}/{key2:TYPE2}/{key3:TYPE3}`.
        """
        require_partition_filter: NotRequired[pulumi.Input[builtins.bool]]
        """
        If set to true, queries over this table
        require a partition filter that can be used for partition elimination to be
        specified.
        """
        source_uri_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TableExternalDataConfigurationHivePartitioningOptionsArgs:
    def __init__(__self__, *,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 require_partition_filter: Optional[pulumi.Input[builtins.bool]] = None,
                 source_uri_prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] mode: When set, what mode of hive partitioning to use when
               reading data. The following modes are supported.
               * AUTO: automatically infer partition key name(s) and type(s).
               * STRINGS: automatically infer partition key name(s). All types are
               Not all storage formats support hive partitioning. Requesting hive
               ...
               Currently supported formats are: JSON, CSV, ORC, Avro and Parquet.
               * CUSTOM: when set to `CUSTOM`, you must encode the partition key schema within the `source_uri_prefix` by setting `source_uri_prefix` to `gs://bucket/path_to_table/{key1:TYPE1}/{key2:TYPE2}/{key3:TYPE3}`.
        :param pulumi.Input[builtins.bool] require_partition_filter: If set to true, queries over this table
               require a partition filter that can be used for partition elimination to be
               specified.
        :param pulumi.Input[builtins.str] source_uri_prefix: When hive partition detection is requested,
               a common for all source uris must be required. The prefix must end immediately
               before the partition key encoding begins. For example, consider files following
               this data layout. `gs://bucket/path_to_table/dt=2019-06-01/country=USA/id=7/file.avro`
               `gs://bucket/path_to_table/dt=2019-05-31/country=CA/id=3/file.avro` When hive
    ...
    def require_partition_filter(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If set to true, queries over this table
        require a partition filter that can be used for partition elimination to be
        specified.
    ...
    def require_partition_filter(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_partition_filter", value)

    @property
    @pulumi.getter(name="sourceUriPrefix")
    def source_uri_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When hive partition detection is requested,
        a common for all source uris must be required. The prefix must end immediately
        before the partition key encoding begins. For example, consider files following
    ...
    def source_uri_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TableExternalDataConfigurationJsonOptionsArgs:
    def __init__(__self__, *,
                 encoding: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] encoding: The character encoding of the data. The supported values are UTF-8, UTF-16BE, UTF-16LE, UTF-32BE, and UTF-32LE. The default value is UTF-8.
        """
        if encoding is not None:
            pulumi.set(__self__, "encoding", encoding)
...
class TableExternalDataConfigurationParquetOptionsArgs:
    def __init__(__self__, *,
                 ...
                 enum_as_string: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_list_inference: Indicates whether to use schema inference specifically for Parquet LIST logical type.
        :param pulumi.Input[builtins.bool] enum_as_string: Indicates whether to infer Parquet ENUM logical type as STRING instead of BYTES by default.
        """
        if enable_list_inference is not None:
            pulumi.set(__self__, "enable_list_inference", enable_list_inference)
        if enum_as_string is not None:
...
if not MYPY:
    class TableMaterializedViewArgsDict(TypedDict):
        ...
        """
        allow_non_incremental_definition: NotRequired[pulumi.Input[builtins.bool]]
        """
        Allow non incremental materialized view definition.
        The default value is false.
        """
        enable_refresh: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether to use BigQuery's automatic refresh for this materialized view when the base table is updated.
        The default value is true.
        """
        refresh_interval_ms: NotRequired[pulumi.Input[builtins.int]]
        """
...
class TableMaterializedViewArgs:
    def __init__(__self__, *,
                 query: pulumi.Input[builtins.str],
                 allow_non_incremental_definition: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_refresh: Optional[pulumi.Input[builtins.bool]] = None,
                 refresh_interval_ms: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] query: A query whose result is persisted.
        :param pulumi.Input[builtins.bool] allow_non_incremental_definition: Allow non incremental materialized view definition.
               The default value is false.
        :param pulumi.Input[builtins.bool] enable_refresh: Specifies whether to use BigQuery's automatic refresh for this materialized view when the base table is updated.
               The default value is true.
        :param pulumi.Input[builtins.int] refresh_interval_ms: The maximum frequency at which this materialized view will be refreshed.
               The default value is 1800000
        """
        pulumi.set(__self__, "query", query)
    ...
    def allow_non_incremental_definition(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Allow non incremental materialized view definition.
        The default value is false.
        """
    ...
    def allow_non_incremental_definition(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_non_incremental_definition", value)

    @property
    @pulumi.getter(name="enableRefresh")
    def enable_refresh(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to use BigQuery's automatic refresh for this materialized view when the base table is updated.
        The default value is true.
        """
    ...
    def enable_refresh(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_refresh", value)

    @property
    @pulumi.getter(name="refreshIntervalMs")
    def refresh_interval_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum frequency at which this materialized view will be refreshed.
        The default value is 1800000
        """
    ...
    def refresh_interval_ms(self, value: Optional[pulumi.Input[builtins.int]]):
...
class TableRangePartitioningArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] field: The field used to determine how to create a range-based
               partition.
...
class TableRangePartitioningRangeArgs:
    def __init__(__self__, *,
                 ...
                 start: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] end: End of the range partitioning, exclusive.
        :param pulumi.Input[builtins.int] interval: The width of each range within the partition.
        :param pulumi.Input[builtins.int] start: Start of the range partitioning, inclusive.
        """
...
class TableSchemaForeignTypeInfoArgs:
    ...
    @type_system.setter
    def type_system(self, value: pulumi.Input[builtins.str]):
...
class TableTableConstraintsForeignKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TableTableConstraintsForeignKeyReferencedTableArgs'] referenced_table: The table that holds the primary key
               and is referenced by this foreign key.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: Set only if the foreign key constraint is named.
        """
...
if not MYPY:
    class TableTableConstraintsForeignKeyColumnReferencesArgsDict(TypedDict):
        referenced_column: pulumi.Input[builtins.str]
        """
        The column in the primary key that are
        referenced by the referencingColumn
        """
        referencing_column: pulumi.Input[builtins.str]
        """
...
class TableTableConstraintsForeignKeyColumnReferencesArgs:
    def __init__(__self__, *,
                 ...
                 referencing_column: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] referenced_column: The column in the primary key that are
               referenced by the referencingColumn
        :param pulumi.Input[builtins.str] referencing_column: The column that composes the foreign key.
        """
    ...
    def referenced_column(self) -> pulumi.Input[builtins.str]:
        """
        The column in the primary key that are
        referenced by the referencingColumn
        """
    ...
    def referenced_column(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "referenced_column", value)

    @property
    @pulumi.getter(name="referencingColumn")
    def referencing_column(self) -> pulumi.Input[builtins.str]:
        """
        The column that composes the foreign key.
        """
    ...
    def referencing_column(self, value: pulumi.Input[builtins.str]):
...
class TableTableConstraintsForeignKeyReferencedTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset containing this table.
        :param pulumi.Input[builtins.str] project_id: The ID of the project containing this table.
        :param pulumi.Input[builtins.str] table_id: The ID of the table. The ID must contain only
               letters (a-z, A-Z), numbers (0-9), or underscores (_). The maximum
               length is 1,024 characters. Certain operations allow suffixing of
               the table ID with a partition decorator, such as
               sample_table$20190123.
...
class TableTableConstraintsPrimaryKeyArgs:
    def __init__(__self__, *,
                 columns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] columns: The columns that are composed of the primary key constraint.
        """
        pulumi.set(__self__, "columns", columns)
...
if not MYPY:
    class TableTableReplicationInfoArgsDict(TypedDict):
        source_dataset_id: pulumi.Input[builtins.str]
        """
        The ID of the source dataset.
        """
        source_project_id: pulumi.Input[builtins.str]
        """
        The ID of the source project.
        """
        source_table_id: pulumi.Input[builtins.str]
        """
        The ID of the source materialized view.
        """
        replication_interval_ms: NotRequired[pulumi.Input[builtins.int]]
        """
...
class TableTableReplicationInfoArgs:
    def __init__(__self__, *,
                 ...
                 source_project_id: pulumi.Input[builtins.str],
                 source_table_id: pulumi.Input[builtins.str],
                 replication_interval_ms: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] source_dataset_id: The ID of the source dataset.
        :param pulumi.Input[builtins.str] source_project_id: The ID of the source project.
        :param pulumi.Input[builtins.str] source_table_id: The ID of the source materialized view.
        :param pulumi.Input[builtins.int] replication_interval_ms: The interval at which the source
               materialized view is polled for updates. The default is 300000.
        """
    ...
    def source_dataset_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the source dataset.
        """
    ...
    def source_dataset_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_dataset_id", value)

    @property
    @pulumi.getter(name="sourceProjectId")
    def source_project_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the source project.
        """
    ...
    def source_project_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_project_id", value)

    @property
    @pulumi.getter(name="sourceTableId")
    def source_table_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the source materialized view.
        """
    ...
    def source_table_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_table_id", value)

    @property
    @pulumi.getter(name="replicationIntervalMs")
    def replication_interval_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The interval at which the source
        materialized view is polled for updates. The default is 300000.
        """
    ...
    def replication_interval_ms(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class TableTimePartitioningArgsDict(TypedDict):
        ...
        """
        expiration_ms: NotRequired[pulumi.Input[builtins.int]]
        """
...
class TableTimePartitioningArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 expiration_ms: Optional[pulumi.Input[builtins.int]] = None,
                 field: Optional[pulumi.Input[builtins.str]] = None,
                 require_partition_filter: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] type: The supported types are DAY, HOUR, MONTH, and YEAR,
               which will generate one partition per day, hour, month, and year, respectively.
        :param pulumi.Input[builtins.int] expiration_ms: Number of milliseconds for which to keep the
               storage for a partition.
        :param pulumi.Input[builtins.str] field: The field used to determine how to create a time-based
               partition. If time-based partitioning is enabled without this value, the
               table is partitioned based on the load time.
        :param pulumi.Input[builtins.bool] require_partition_filter: If set to true, queries over this table
               require a partition filter that can be used for partition elimination to be
    ...
    @property
    @pulumi.getter(name="expirationMs")
    def expiration_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of milliseconds for which to keep the
        storage for a partition.
        """
    ...
    @expiration_ms.setter
    def expiration_ms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "expiration_ms", value)
...
class TableViewArgs:
    def __init__(__self__, *,
                 ...
                 use_legacy_sql: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] query: A query that BigQuery executes when the view is referenced.
        :param pulumi.Input[builtins.bool] use_legacy_sql: Specifies whether to use BigQuery's legacy SQL for this view.
               The default value is true. If set to false, the view will use BigQuery's standard SQL.
        """
        pulumi.set(__self__, "query", query)
        if use_legacy_sql is not None:
