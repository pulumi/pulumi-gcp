...
class _DatasetAccessState:
    def __init__(__self__, *,
                 api_updated_member: Optional[pulumi.Input[builtins.bool]] = None,
                 authorized_dataset: Optional[pulumi.Input['DatasetAccessAuthorizedDatasetArgs']] = None,
                 condition: Optional[pulumi.Input['DatasetAccessConditionArgs']] = None,
        ...
        :param pulumi.Input[builtins.bool] api_updated_member: If true, represents that that the iam_member in the config was translated to a different member type by the API, and is
    ...
    def api_updated_member(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def api_updated_member(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DatasetAccess(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="apiUpdatedMember")
    def api_updated_member(self) -> pulumi.Output[builtins.bool]:
        """
        If true, represents that that the iam_member in the config was translated to a different member type by the API, and is
        stored in state as a different member type
        """
    ...
    @property
    @pulumi.getter(name="groupByEmail")
    def group_by_email(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An email address of a Google Group to grant access to.
        """
        return pulumi.get(self, "group_by_email")
    ...
    @property
    @pulumi.getter(name="iamMember")
    def iam_member(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Some other type of member that appears in the IAM Policy but isn't a user,
        group, domain, or special group. For example: `allUsers`
        """
    ...
    @property
    @pulumi.getter(name="specialGroup")
    def special_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A special group to grant access to. Possible values include:
        * `projectOwners`: Owners of the enclosing project.
        * `projectReaders`: Readers of the enclosing project.
    ...
    @property
    @pulumi.getter(name="userByEmail")
    def user_by_email(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An email address of a user to grant access to. For example:
        fred@example.com
        """
