...
class ConnectionIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['ConnectionIamBindingConditionArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['ConnectionIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['ConnectionIamBindingConditionArgs']]):
...
@pulumi.type_token("gcp:bigquery/connectionIamBinding:ConnectionIamBinding")
class ConnectionIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['ConnectionIamBindingConditionArgs', 'ConnectionIamBindingConditionArgsDict', 'outputs.ConnectionIamBindingCondition']]] = None,
                 connection_id: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `bigquery.ConnectionIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the connection are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `bigquery.ConnectionIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the connection are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'ConnectionIamBinding':
        """
