...
def get_connection_iam_policy(connection_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The geographic location where the connection should reside.
...
def get_connection_iam_policy_output(connection_id: Optional[pulumi.Input[_builtins.str]] = None,
