...
def get_connection_iam_policy(connection_id: Optional[builtins.str] = None,
...
def get_connection_iam_policy_output(connection_id: Optional[pulumi.Input[builtins.str]] = None,
