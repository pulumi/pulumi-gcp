...
class RoutineArgs:
    def __init__(__self__, *,
                 ...
                 definition_body: pulumi.Input[builtins.str],
                 routine_id: pulumi.Input[builtins.str],
                 routine_type: pulumi.Input[builtins.str],
                 arguments: Optional[pulumi.Input[Sequence[pulumi.Input['RoutineArgumentArgs']]]] = None,
                 data_governance_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 determinism_level: Optional[pulumi.Input[builtins.str]] = None,
                 imported_libraries: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset containing this routine
        :param pulumi.Input[builtins.str] definition_body: The body of the routine. For functions, this is the expression in the AS clause.
        ...
        :param pulumi.Input[builtins.str] data_governance_type: If set to DATA_MASKING, the function is validated and made available as a masking function. For more information, see https://cloud.google.com/bigquery/docs/user-defined-functions#custom-mask
               Possible values are: `DATA_MASKING`.
        :param pulumi.Input[builtins.str] description: The description of the routine if defined.
        :param pulumi.Input[builtins.str] determinism_level: The determinism level of the JavaScript UDF if defined.
               Possible values are: `DETERMINISM_LEVEL_UNSPECIFIED`, `DETERMINISTIC`, `NOT_DETERMINISTIC`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] imported_libraries: Optional. If language = "JAVASCRIPT", this field stores the path of the
               imported JAVASCRIPT libraries.
        :param pulumi.Input[builtins.str] language: The language of the routine.
        ...
        :param pulumi.Input['RoutineRemoteFunctionOptionsArgs'] remote_function_options: Remote function specific options.
               Structure is documented below.
        :param pulumi.Input[builtins.str] return_table_type: Optional. Can be set only if routineType = "TABLE_VALUED_FUNCTION".
               If absent, the return table type is inferred from definitionBody at query time in each query
               that references this routine. If present, then the columns in the evaluated table result will
               be cast to match the column types specificed in return table type, at query time.
        :param pulumi.Input[builtins.str] return_type: A JSON schema for the return type. Optional if language = "SQL"; required otherwise.
    ...
    def definition_body(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def definition_body(self, value: pulumi.Input[builtins.str]):
    ...
    def routine_type(self) -> pulumi.Input[builtins.str]:
        """
        The type of routine.
        Possible values are: `SCALAR_FUNCTION`, `PROCEDURE`, `TABLE_VALUED_FUNCTION`.
        """
    ...
    @routine_type.setter
    def routine_type(self, value: pulumi.Input[builtins.str]):
    ...
    def data_governance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_governance_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def determinism_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def determinism_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "determinism_level", value)

    @property
    @pulumi.getter(name="importedLibraries")
    def imported_libraries(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def imported_libraries(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def return_table_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def return_table_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RoutineState:
    def __init__(__self__, *,
                 ...
                 definition_body: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 determinism_level: Optional[pulumi.Input[builtins.str]] = None,
                 imported_libraries: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 language: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RoutineArgumentArgs']]] arguments: Input/output argument of a function or a stored procedure.
               Structure is documented below.
        :param pulumi.Input[builtins.int] creation_time: The time when this routine was created, in milliseconds since the
               epoch.
        :param pulumi.Input[builtins.str] data_governance_type: If set to DATA_MASKING, the function is validated and made available as a masking function. For more information, see https://cloud.google.com/bigquery/docs/user-defined-functions#custom-mask
               Possible values are: `DATA_MASKING`.
        :param pulumi.Input[builtins.str] dataset_id: The ID of the dataset containing this routine
        ...
        :param pulumi.Input[builtins.str] language: The language of the routine.
               Possible values are: `SQL`, `JAVASCRIPT`, `PYTHON`, `JAVA`, `SCALA`.
        :param pulumi.Input[builtins.int] last_modified_time: The time when this routine was modified, in milliseconds since the
               epoch.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input['RoutineRemoteFunctionOptionsArgs'] remote_function_options: Remote function specific options.
    ...
    @property
    @pulumi.getter(name="definitionBody")
    def definition_body(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The body of the routine. For functions, this is the expression in the AS clause.
        If language=SQL, it is the substring inside (but excluding) the parentheses.
    ...
    @definition_body.setter
    def definition_body(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "definition_body", value)
    ...
    @property
    @pulumi.getter(name="routineId")
    def routine_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the the routine. The ID must contain only letters (a-z, A-Z), numbers (0-9), or underscores (_). The maximum length is 256 characters.
        """
        return pulumi.get(self, "routine_id")
    ...
    @routine_id.setter
    def routine_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "routine_id", value)

    @property
    @pulumi.getter(name="routineType")
    def routine_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of routine.
        Possible values are: `SCALAR_FUNCTION`, `PROCEDURE`, `TABLE_VALUED_FUNCTION`.
        """
...
class Routine(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataGovernanceType")
    def data_governance_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If set to DATA_MASKING, the function is validated and made available as a masking function. For more information, see https://cloud.google.com/bigquery/docs/user-defined-functions#custom-mask
        Possible values are: `DATA_MASKING`.
        """
    ...
    @property
    @pulumi.getter(name="definitionBody")
    def definition_body(self) -> pulumi.Output[builtins.str]:
        """
        The body of the routine. For functions, this is the expression in the AS clause.
        If language=SQL, it is the substring inside (but excluding) the parentheses.
    ...
    @property
    @pulumi.getter(name="determinismLevel")
    def determinism_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The determinism level of the JavaScript UDF if defined.
        Possible values are: `DETERMINISM_LEVEL_UNSPECIFIED`, `DETERMINISTIC`, `NOT_DETERMINISTIC`.
        """
    ...
    @property
    @pulumi.getter(name="importedLibraries")
    def imported_libraries(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Optional. If language = "JAVASCRIPT", this field stores the path of the
        imported JAVASCRIPT libraries.
        """
    ...
    @property
    @pulumi.getter(name="returnTableType")
    def return_table_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional. Can be set only if routineType = "TABLE_VALUED_FUNCTION".
        If absent, the return table type is inferred from definitionBody at query time in each query
        that references this routine. If present, then the columns in the evaluated table result will
    ...
    @property
    @pulumi.getter(name="returnType")
    def return_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A JSON schema for the return type. Optional if language = "SQL"; required otherwise.
        If absent, the return type is inferred from definitionBody at query time in each query
        that references this routine. If present, then the evaluated result will be cast to
    ...
    @property
    @pulumi.getter(name="routineId")
    def routine_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the the routine. The ID must contain only letters (a-z, A-Z), numbers (0-9), or underscores (_). The maximum length is 256 characters.
        """
        return pulumi.get(self, "routine_id")
    ...
    @property
    @pulumi.getter(name="routineType")
    def routine_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of routine.
        Possible values are: `SCALAR_FUNCTION`, `PROCEDURE`, `TABLE_VALUED_FUNCTION`.
        """
