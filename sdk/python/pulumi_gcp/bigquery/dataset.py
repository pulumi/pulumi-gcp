...
class DatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] default_collation: Defines the default collation specification of future tables created
        ...
        :param pulumi.Input['DatasetDefaultEncryptionConfigurationArgs'] default_encryption_configuration: The default encryption key for all tables in the dataset. Once this property is set,
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.int] default_partition_expiration_ms: The default partition expiration for all partitioned tables in
        ...
        :param pulumi.Input[_builtins.int] default_table_expiration_ms: The default lifetime of all tables in the dataset, in milliseconds.
        ...
        :param pulumi.Input[_builtins.str] max_time_travel_hours: Defines the time travel window in hours. The value can be from 48 to 168 hours (2 to 7 days).
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] resource_tags: The tags attached to this table. Tag keys are globally unique. Tag key is expected to be
               ...
               for more details.
        :param pulumi.Input[_builtins.str] storage_billing_model: Specifies the storage billing model for the dataset.
...
class _DatasetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels associated with this dataset. You can use these to
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.int] last_modified_time: The date when this dataset or any of its tables was last modified, in
...
class Dataset(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="defaultPartitionExpirationMs")
    def default_partition_expiration_ms(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The default partition expiration for all partitioned tables in
        the dataset, in milliseconds.
        Once this property is set, all newly-created partitioned tables in
