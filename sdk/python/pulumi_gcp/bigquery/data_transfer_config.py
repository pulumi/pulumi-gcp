...
class DataTransferConfigArgs:
    def __init__(__self__, *,
                 ...
                 data_refresh_window_days: Optional[pulumi.Input[builtins.int]] = None,
                 destination_dataset_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 notification_pubsub_topic: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] data_source_id: The data source id. Cannot be changed once the transfer config is created.
        :param pulumi.Input[builtins.str] display_name: The user specified display name for the transfer config.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] params: Parameters specific to each data source. For more information see the bq tab in the 'Setting up a data transfer'
        ...
        :param pulumi.Input[builtins.str] destination_dataset_id: The BigQuery target dataset id.
        :param pulumi.Input[builtins.bool] disabled: When set to true, no runs are scheduled for a given transfer.
        ...
        :param pulumi.Input[builtins.str] notification_pubsub_topic: Pub/Sub topic where notifications will be sent after transfer runs
        ...
        :param pulumi.Input['DataTransferConfigSensitiveParamsArgs'] sensitive_params: Different parameters are configured primarily using the the `params` field on this
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] service_account_name: Service account email. If this field is set, transfer config will
    ...
    def data_refresh_window_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def data_refresh_window_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_refresh_window_days", value)

    @property
    @pulumi.getter(name="destinationDatasetId")
    def destination_dataset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def destination_dataset_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def notification_pubsub_topic(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def notification_pubsub_topic(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DataTransferConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The geographic location where the transfer config should reside.
               Examples: US, EU, asia-northeast1. The default value is US.
        :param pulumi.Input[builtins.str] name: The resource name of the transfer config. Transfer config names have the
...
class DataTransferConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `{{name}}`
        ...
        :param pulumi.Input[Union['DataTransferConfigScheduleOptionsArgs', 'DataTransferConfigScheduleOptionsArgsDict']] schedule_options: Options customizing the data transfer schedule.
               Structure is documented below.
        :param pulumi.Input[Union['DataTransferConfigSensitiveParamsArgs', 'DataTransferConfigSensitiveParamsArgsDict']] sensitive_params: Different parameters are configured primarily using the the `params` field on this
               resource. This block contains the parameters which contain secrets or passwords so that they can be marked
               sensitive and hidden from plan output. The name of the field, eg: secret_access_key, will be the key
               in the `params` map in the api request.
               Credentials may not be specified in both locations and will cause an error. Changing from one location
    ...
    def get(resource_name: str,
            ...
            schedule_options: Optional[pulumi.Input[Union['DataTransferConfigScheduleOptionsArgs', 'DataTransferConfigScheduleOptionsArgsDict']]] = None,
            sensitive_params: Optional[pulumi.Input[Union['DataTransferConfigSensitiveParamsArgs', 'DataTransferConfigSensitiveParamsArgsDict']]] = None,
            service_account_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DataTransferConfig':
        """
    ...
    @property
    @pulumi.getter(name="dataRefreshWindowDays")
    def data_refresh_window_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of days to look back to automatically refresh the data.
        For example, if dataRefreshWindowDays = 10, then every day BigQuery
        reingests data for [today-10, today-1], rather than ingesting data for
    ...
    @property
    @pulumi.getter(name="destinationDatasetId")
    def destination_dataset_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The BigQuery target dataset id.
        """
        return pulumi.get(self, "destination_dataset_id")
    ...
    @property
    @pulumi.getter(name="notificationPubsubTopic")
    def notification_pubsub_topic(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Pub/Sub topic where notifications will be sent after transfer runs
        associated with this transfer config finish.
        """
    ...
    @property
    @pulumi.getter
    def params(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Parameters specific to each data source. For more information see the bq tab in the 'Setting up a data transfer'
        section for each data source. For example the parameters for Cloud Storage transfers are listed here:
        https://cloud.google.com/bigquery-transfer/docs/cloud-storage-transfer#bq
