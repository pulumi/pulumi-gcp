...
class TableArgs:
    def __init__(__self__, *,
                 ...
                 clusterings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 table_metadata_view: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dataset_id: The dataset ID to create the table in.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] clusterings: Specifies column names to use for data clustering.
        ...
        :param pulumi.Input[builtins.str] description: The field description.
        ...
        :param pulumi.Input[builtins.int] expiration_time: The time when this table expires, in
        ...
        :param pulumi.Input[builtins.str] max_staleness: The maximum staleness of data that could be
        ...
        :param pulumi.Input[builtins.bool] require_partition_filter: If set to true, queries over this table
               ...
               specified.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] resource_tags: The tags attached to this table. Tag keys are
    ...
    @property
    @pulumi.getter
    def clusterings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @clusterings.setter
    def clusterings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def max_staleness(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def max_staleness(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def table_metadata_view(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def table_metadata_view(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TableState:
    def __init__(__self__, *,
                 ...
                 materialized_view: Optional[pulumi.Input['TableMaterializedViewArgs']] = None,
                 max_staleness: Optional[pulumi.Input[builtins.str]] = None,
                 num_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 num_long_term_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 num_rows: Optional[pulumi.Input[builtins.int]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] clusterings: Specifies column names to use for data clustering.
               Up to four top-level columns are allowed, and should be specified in
               descending priority order.
        :param pulumi.Input[builtins.int] creation_time: The time when this table was created, in milliseconds since the epoch.
        :param pulumi.Input[builtins.str] dataset_id: The dataset ID to create the table in.
               Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] deletion_protection: Whether or not to allow the provider to destroy the instance. Unless this field is set to false
               in state, a `=destroy` or `=update` that would delete the instance will fail.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A mapping of labels to assign to the resource.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field 'effective_labels' for all of the labels present on the resource.
        :param pulumi.Input[builtins.int] last_modified_time: The time when this table was last modified, in milliseconds since the epoch.
        :param pulumi.Input[builtins.str] location: The geographic location where the table resides. This value is inherited from the dataset.
        :param pulumi.Input['TableMaterializedViewArgs'] materialized_view: If specified, configures this table as a materialized view.
               Structure is documented below.
        :param pulumi.Input[builtins.str] max_staleness: The maximum staleness of data that could be
               returned when the table (or stale MV) is queried. Staleness encoded as a
               string encoding of [SQL IntervalValue
               type](https://cloud.google.com/bigquery/docs/reference/standard-sql/data-types#interval_type).
        :param pulumi.Input[builtins.int] num_bytes: The size of this table in bytes, excluding any data in the streaming buffer.
        :param pulumi.Input[builtins.int] num_long_term_bytes: The number of bytes in the table that are considered "long-term storage".
        :param pulumi.Input[builtins.int] num_rows: The number of rows of data in this table, excluding any data in the streaming buffer.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs. If it
               is not provided, the provider project is used.
        ...
        :param pulumi.Input['TableTimePartitioningArgs'] time_partitioning: If specified, configures time-based
               partitioning for this table. Structure is documented below.
        :param pulumi.Input[builtins.str] type: Describes the table type.
        :param pulumi.Input['TableViewArgs'] view: If specified, configures this table as a view.
               Structure is documented below.
        """
        if biglake_configuration is not None:
    ...
    def num_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @num_bytes.setter
    def num_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_bytes", value)

    @property
    @pulumi.getter(name="numLongTermBytes")
    def num_long_term_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_long_term_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_long_term_bytes", value)

    @property
    @pulumi.getter(name="numRows")
    def num_rows(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @num_rows.setter
    def num_rows(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Table(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def clusterings(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies column names to use for data clustering.
        Up to four top-level columns are allowed, and should be specified in
        descending priority order.
    ...
    @property
    @pulumi.getter(name="expirationTime")
    def expiration_time(self) -> pulumi.Output[builtins.int]:
        """
        The time when this table expires, in
        milliseconds since the epoch. If not present, the table will persist
        indefinitely. Expired tables will be deleted and their storage
    ...
    @property
    @pulumi.getter(name="maxStaleness")
    def max_staleness(self) -> pulumi.Output[builtins.str]:
        """
        The maximum staleness of data that could be
        returned when the table (or stale MV) is queried. Staleness encoded as a
        string encoding of [SQL IntervalValue
    ...
    @property
    @pulumi.getter(name="numBytes")
    def num_bytes(self) -> pulumi.Output[builtins.int]:
        """
        The size of this table in bytes, excluding any data in the streaming buffer.
        """
        return pulumi.get(self, "num_bytes")
    ...
    @property
    @pulumi.getter(name="numLongTermBytes")
    def num_long_term_bytes(self) -> pulumi.Output[builtins.int]:
        """
        The number of bytes in the table that are considered "long-term storage".
        """
        return pulumi.get(self, "num_long_term_bytes")
    ...
    @property
    @pulumi.getter(name="numRows")
    def num_rows(self) -> pulumi.Output[builtins.int]:
        """
        The number of rows of data in this table, excluding any data in the streaming buffer.
        """
        return pulumi.get(self, "num_rows")
    ...
    @property
    @pulumi.getter(name="requirePartitionFilter")
    def require_partition_filter(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to true, queries over this table
        require a partition filter that can be used for partition elimination to be
        specified.
    ...
    @property
    @pulumi.getter(name="tableMetadataView")
    def table_metadata_view(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        View sets the optional parameter "view": Specifies the view that determines which table information is returned. By
        default, basic table information and storage statistics (STORAGE_STATS) are returned. Possible values:
        TABLE_METADATA_VIEW_UNSPECIFIED, BASIC, STORAGE_STATS, FULL
