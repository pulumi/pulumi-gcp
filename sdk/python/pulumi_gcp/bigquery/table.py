...
class TableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] deletion_protection: Whether Terraform will be prevented from destroying the table.
        ...
        :param pulumi.Input[_builtins.bool] ignore_auto_generated_schema: If true, Terraform will prevent columns added by the server(e.g. hive partitioned columns) in schema from showing diff.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ignore_schema_changes: A list of fields which would act non-authoritative for each column in schema.
