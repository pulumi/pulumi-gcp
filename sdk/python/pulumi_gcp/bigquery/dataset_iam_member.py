...
class DatasetIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['DatasetIamMemberConditionArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['DatasetIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['DatasetIamMemberConditionArgs']]):
...
class DatasetIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['DatasetIamMemberConditionArgs', 'DatasetIamMemberConditionArgsDict', 'outputs.DatasetIamMemberCondition']]] = None,
                 dataset_id: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `bigquery.DatasetIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the dataset are preserved.
        ...
        :param pulumi.Input[Union['DatasetIamMemberConditionArgs', 'DatasetIamMemberConditionArgsDict', 'outputs.DatasetIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] dataset_id: The dataset ID.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
    ...
    def get(resource_name: str,
            ...
            member: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'DatasetIamMember':
        """
