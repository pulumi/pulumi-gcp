...
__all__ = [
    ...
    'RoutineArgument',
    'RoutineArgumentTableType',
    'RoutineArgumentTableTypeColumn',
    'RoutineExternalRuntimeOptions',
    'RoutineIamBindingCondition',
    'RoutineIamMemberCondition',
...
class BiReservationPreferredTable(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dataset_id: The ID of the dataset in the above project.
        :param _builtins.str project_id: The assigned project ID of the project.
        :param _builtins.str table_id: The ID of the table in the above dataset.
        """
...
class ConnectionAwsAccessRole(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str iam_role_id: The user’s AWS IAM Role that trusts the Google-owned AWS IAM user Connection.
        :param _builtins.str identity: (Output)
...
class ConnectionAzure(dict):
    ...
    def __init__(__self__, *,
                 ...
                 federated_application_client_id: Optional[_builtins.str] = None,
                 identity: Optional[_builtins.str] = None,
                 object_id: Optional[_builtins.str] = None,
                 redirect_uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str customer_tenant_id: The id of customer's directory that host the data.
        :param _builtins.str application: (Output)
               The name of the Azure Active Directory Application.
        :param _builtins.str client_id: (Output)
               The client id of the Azure Active Directory Application.
        :param _builtins.str federated_application_client_id: The Azure Application (client) ID where the federated credentials will be hosted.
        :param _builtins.str identity: (Output)
               A unique Google-owned and Google-generated identity for the Connection. This identity will be used to access the user's Azure Active Directory Application.
        :param _builtins.str object_id: (Output)
               The object id of the Azure Active Directory Application.
        :param _builtins.str redirect_uri: (Output)
...
class ConnectionCloudSpanner(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_data_boost: Optional[_builtins.bool] = None,
                 use_parallelism: Optional[_builtins.bool] = None,
                 use_serverless_analytics: Optional[_builtins.bool] = None):
        """
        :param _builtins.str database: Cloud Spanner database in the form `project/instance/database'.
        :param _builtins.str database_role: Cloud Spanner database role for fine-grained access control. The Cloud Spanner admin should have provisioned the database role with appropriate permissions, such as `SELECT` and `INSERT`. Other users should only use roles provided by their Cloud Spanner admins. The database role name must start with a letter, and can only contain letters, numbers, and underscores. For more details, see https://cloud.google.com/spanner/docs/fgac-about.
        :param _builtins.int max_parallelism: Allows setting max parallelism per query when executing on Spanner independent compute resources. If unspecified, default values of parallelism are chosen that are dependent on the Cloud Spanner instance configuration. `useParallelism` and `useDataBoost` must be set when setting max parallelism.
        :param _builtins.bool use_data_boost: If set, the request will be executed via Spanner independent compute resources. `use_parallelism` must be set when using data boost.
        :param _builtins.bool use_parallelism: If parallelism should be used when reading from Cloud Spanner.
        :param _builtins.bool use_serverless_analytics: (Optional, Deprecated)
...
class ConnectionCloudSql(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str instance_id: Cloud SQL instance ID in the form project:location:instance.
        :param _builtins.str type: Type of the Cloud SQL database.
...
class ConnectionSparkMetastoreServiceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str metastore_service: Resource name of an existing Dataproc Metastore service in the form of projects/[projectId]/locations/[region]/services/[serviceId].
        """
...
class ConnectionSparkSparkHistoryServerConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dataproc_cluster: Resource name of an existing Dataproc Cluster to act as a Spark History Server for the connection if the form of projects/[projectId]/regions/[region]/clusters/[cluster_name].
        """
...
class DataTransferConfigEmailPreferences(dict):
    ...
    def __init__(__self__, *,
                 enable_failure_email: _builtins.bool):
        """
        :param _builtins.bool enable_failure_email: If true, email notifications will be sent on transfer run failures.
        """
...
class DataTransferConfigEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str kms_key_name: The name of the KMS key used for encrypting BigQuery data.
        """
...
class DataTransferConfigScheduleOptions(dict):
    ...
    def __init__(__self__, *,
                 disable_auto_scheduling: Optional[_builtins.bool] = None,
                 end_time: Optional[_builtins.str] = None,
                 start_time: Optional[_builtins.str] = None):
        """
        :param _builtins.bool disable_auto_scheduling: If true, automatic scheduling of data transfer runs for this
               configuration will be disabled. The runs can be started on ad-hoc
               basis using transferConfigs.startManualRuns API. When automatic
               scheduling is disabled, the TransferConfig.schedule field will
               be ignored.
        :param _builtins.str end_time: Defines time to stop scheduling transfer runs. A transfer run cannot be
               scheduled at or after the end time. The end time can be changed at any
               moment. The time when a data transfer can be triggered manually is not
               limited by this option.
        :param _builtins.str start_time: Specifies time to start scheduling transfer runs. The first run will be
...
class DatasetAccess(dict):
    ...
    def __init__(__self__, *,
                 ...
                 group_by_email: Optional[_builtins.str] = None,
                 iam_member: Optional[_builtins.str] = None,
                 role: Optional[_builtins.str] = None,
                 routine: Optional['outputs.DatasetAccessRoutine'] = None,
                 special_group: Optional[_builtins.str] = None,
                 user_by_email: Optional[_builtins.str] = None,
        ...
        :param 'DatasetAccessDatasetArgs' dataset: Grants all resources of particular types in a particular dataset read access to the current dataset.
               Structure is documented below.
        :param _builtins.str domain: A domain to grant access to. Any users signed in with the
               domain specified will be granted the specified access
        :param _builtins.str group_by_email: An email address of a Google Group to grant access to.
        :param _builtins.str iam_member: Some other type of member that appears in the IAM Policy but isn't a user,
               group, domain, or special group. For example: `allUsers`
        :param _builtins.str role: Describes the rights granted to the user specified by the other
        ...
        :param 'DatasetAccessRoutineArgs' routine: A routine from a different dataset to grant access to. Queries
               ...
               Structure is documented below.
        :param _builtins.str special_group: A special group to grant access to. Possible values include:
               * `projectOwners`: Owners of the enclosing project.
               * `projectReaders`: Readers of the enclosing project.
               * `projectWriters`: Writers of the enclosing project.
               * `allAuthenticatedUsers`: All authenticated BigQuery users.
        :param _builtins.str user_by_email: An email address of a user to grant access to. For example:
               fred@example.com
...
class DatasetAccessAuthorizedDataset(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'DatasetAccessAuthorizedDatasetDatasetArgs' dataset: The dataset this entry applies to
               Structure is documented below.
        :param Sequence[_builtins.str] target_types: Which resources in the dataset this entry applies to. Currently, only views are supported,
...
class DatasetAccessAuthorizedDatasetDataset(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dataset_id: The ID of the dataset containing this table.
        :param _builtins.str project_id: The ID of the project containing this table.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
        pulumi.set(__self__, "project_id", project_id)
...
class DatasetAccessRoutine(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str dataset_id: The ID of the dataset containing this table.
        :param _builtins.str project_id: The ID of the project containing this table.
        :param _builtins.str routine_id: The ID of the routine. The ID must contain only letters (a-z,
...
class DatasetAccessView(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str dataset_id: The ID of the dataset containing this table.
        :param _builtins.str project_id: The ID of the project containing this table.
        :param _builtins.str table_id: The ID of the table. The ID must contain only letters (a-z,
               A-Z), numbers (0-9), or underscores (_). The maximum length
               is 1,024 characters.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
class DatasetDefaultEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 kms_key_name: _builtins.str):
        """
        :param _builtins.str kms_key_name: Describes the Cloud KMS encryption key that will be used to protect destination
...
class DatasetExternalCatalogDatasetOptions(dict):
    ...
    def __init__(__self__, *,
                 default_storage_location_uri: Optional[_builtins.str] = None,
                 parameters: Optional[Mapping[str, _builtins.str]] = None):
        """
        :param _builtins.str default_storage_location_uri: The storage location URI for all tables in the dataset. Equivalent to hive metastore's
               database locationUri. Maximum length of 1024 characters.
        :param Mapping[str, _builtins.str] parameters: A map of key value pairs defining the parameters and properties of the open source schema.
...
class DatasetExternalDatasetReference(dict):
    ...
    def __init__(__self__, *,
                 ...
                 external_source: _builtins.str):
        """
        :param _builtins.str connection: The connection id that is used to access the externalSource.
               Format: projects/{projectId}/locations/{locationId}/connections/{connectionId}
        :param _builtins.str external_source: External source that backs this dataset.
        """
...
class JobCopy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 write_disposition: Optional[_builtins.str] = None):
        """
        ...
        :param 'JobCopyDestinationTableArgs' destination_table: The destination table.
               Structure is documented below.
        :param _builtins.str write_disposition: Specifies the action that occurs if the destination table already exists. The following values are supported:
...
class JobCopyDestinationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str kms_key_name: Describes the Cloud KMS encryption key that will be used to protect destination BigQuery table.
...
class JobCopyDestinationTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 project_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str table_id: The table. Can be specified `{{table_id}}` if `project_id` and `dataset_id` are also set,
...
class JobExtract(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_format: Optional[_builtins.str] = None,
                 ...
                 use_avro_logical_types: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] destination_uris: A list of fully-qualified Google Cloud Storage URIs where the extracted table should be written.
        :param _builtins.str compression: The compression type to use for exported files. Possible values include GZIP, DEFLATE, SNAPPY, and NONE.
               The default value is NONE. DEFLATE and SNAPPY are only supported for Avro.
        :param _builtins.str destination_format: The exported file format. Possible values include CSV, NEWLINE_DELIMITED_JSON and AVRO for tables and SAVED_MODEL for models.
               The default value for tables is CSV. Tables with nested or repeated fields cannot be exported as CSV.
               The default value for models is SAVED_MODEL.
        :param _builtins.str field_delimiter: When extracting data in CSV format, this defines the delimiter to use between fields in the exported data.
               Default is ','
        :param _builtins.bool print_header: Whether to print out a header row in the results. Default is true.
        ...
        :param 'JobExtractSourceTableArgs' source_table: A reference to the table being exported.
               Structure is documented below.
        :param _builtins.bool use_avro_logical_types: Whether to use logical types when extracting to AVRO format.
        """
...
class JobExtractSourceModel(dict):
    ...
    def __init__(__self__, *,
                 ...
                 project_id: _builtins.str):
        """
        :param _builtins.str dataset_id: The ID of the dataset containing this model.
        :param _builtins.str model_id: The ID of the model.
        :param _builtins.str project_id: The ID of the project containing this model.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
class JobLoad(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_jagged_rows: Optional[_builtins.bool] = None,
                 allow_quoted_newlines: Optional[_builtins.bool] = None,
                 autodetect: Optional[_builtins.bool] = None,
                 create_disposition: Optional[_builtins.str] = None,
                 ...
                 field_delimiter: Optional[_builtins.str] = None,
                 ignore_unknown_values: Optional[_builtins.bool] = None,
                 json_extension: Optional[_builtins.str] = None,
                 max_bad_records: Optional[_builtins.int] = None,
                 null_marker: Optional[_builtins.str] = None,
                 parquet_options: Optional['outputs.JobLoadParquetOptions'] = None,
                 projection_fields: Optional[Sequence[_builtins.str]] = None,
                 quote: Optional[_builtins.str] = None,
                 schema_update_options: Optional[Sequence[_builtins.str]] = None,
        ...
        :param 'JobLoadDestinationTableArgs' destination_table: The destination table to load the data into.
               Structure is documented below.
        :param Sequence[_builtins.str] source_uris: The fully-qualified URIs that point to your data in Google Cloud.
               For Google Cloud Storage URIs: Each URI can contain one '\\*' wildcard character
               and it must come after the 'bucket' name. Size limits related to load jobs apply
               to external data sources. For Google Cloud Bigtable URIs: Exactly one URI can be
               specified and it has be a fully specified and valid HTTPS URL for a Google Cloud Bigtable table.
               For Google Cloud Datastore backups: Exactly one URI can be specified. Also, the '\\*' wildcard character is not allowed.
        :param _builtins.bool allow_jagged_rows: Accept rows that are missing trailing optional columns. The missing values are treated as nulls.
               If false, records with missing trailing columns are treated as bad records, and if there are too many bad records,
               an invalid error is returned in the job result. The default value is false. Only applicable to CSV, ignored for other formats.
        :param _builtins.bool allow_quoted_newlines: Indicates if BigQuery should allow quoted data sections that contain newline characters in a CSV file.
               The default value is false.
        :param _builtins.bool autodetect: Indicates if we should automatically infer the options and schema for CSV and JSON sources.
        :param _builtins.str create_disposition: Specifies whether the job is allowed to create new tables. The following values are supported:
               CREATE_IF_NEEDED: If the table does not exist, BigQuery creates the table.
               CREATE_NEVER: The table must already exist. If it does not, a 'notFound' error is returned in the job result.
               Creation, truncation and append actions occur as one atomic update upon job completion
        ...
        :param _builtins.str field_delimiter: The separator for fields in a CSV file. The separator can be any ISO-8859-1 single-byte character.
               To use a character in the range 128-255, you must encode the character as UTF8. BigQuery converts
               the string to ISO-8859-1 encoding, and then uses the first byte of the encoded string to split the
               data in its raw, binary state. BigQuery also supports the escape sequence "\\t" to specify a tab separator.
               The default value is a comma (',').
        :param _builtins.bool ignore_unknown_values: Indicates if BigQuery should allow extra values that are not represented in the table schema.
               If true, the extra values are ignored. If false, records with extra columns are treated as bad records,
               and if there are too many bad records, an invalid error is returned in the job result.
               The default value is false. The sourceFormat property determines what BigQuery treats as an extra value:
               CSV: Trailing columns
               JSON: Named values that don't match any column names
        :param _builtins.str json_extension: If sourceFormat is set to newline-delimited JSON, indicates whether it should be processed as a JSON variant such as GeoJSON.
        ...
        :param 'JobLoadParquetOptionsArgs' parquet_options: Parquet Options for load and make external tables.
               Structure is documented below.
        :param Sequence[_builtins.str] projection_fields: If sourceFormat is set to "DATASTORE_BACKUP", indicates which entity properties to load into BigQuery from a Cloud Datastore backup.
               Property names are case sensitive and must be top-level properties. If no properties are specified, BigQuery loads all properties.
               If any named property isn't found in the Cloud Datastore backup, an invalid error is returned in the job result.
        :param _builtins.str quote: The value that is used to quote data sections in a CSV file. BigQuery converts the string to ISO-8859-1 encoding,
               and then uses the first byte of the encoded string to split the data in its raw, binary state.
               The default value is a double-quote ('"'). If your data does not contain quoted sections, set the property value to an empty string.
               If your data contains quoted newline characters, you must also set the allowQuotedNewlines property to true.
        :param Sequence[_builtins.str] schema_update_options: Allows the schema of the destination table to be updated as a side effect of the load job if a schema is autodetected or
               supplied in the job configuration. Schema update options are supported in two cases: when writeDisposition is WRITE_APPEND;
               when writeDisposition is WRITE_TRUNCATE and the destination table is a partition of a table, specified by partition decorators.
               For normal tables, WRITE_TRUNCATE will always overwrite the schema. One or more of the following values are specified:
               ALLOW_FIELD_ADDITION: allow adding a nullable field to the schema.
               ALLOW_FIELD_RELAXATION: allow relaxing a required field in the original schema to nullable.
        :param _builtins.int skip_leading_rows: The number of rows at the top of a CSV file that BigQuery will skip when loading the data.
        ...
        :param _builtins.str source_format: The format of the data files. For CSV files, specify "CSV". For datastore backups, specify "DATASTORE_BACKUP".
...
class JobLoadParquetOptions(dict):
    ...
    def __init__(__self__, *,
                 enable_list_inference: Optional[_builtins.bool] = None,
                 enum_as_string: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool enable_list_inference: If sourceFormat is set to PARQUET, indicates whether to use schema inference specifically for Parquet LIST logical type.
        :param _builtins.bool enum_as_string: If sourceFormat is set to PARQUET, indicates whether to infer Parquet ENUM logical type as STRING instead of BYTES by default.
        """
...
class JobLoadTimePartitioning(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: The only type supported is DAY, which will generate one partition per day. Providing an empty string used to cause an error,
               but in OnePlatform the field will be treated as unset.
        :param _builtins.str expiration_ms: Number of milliseconds for which to keep the storage for a partition. A wrapper is used here because 0 is an invalid value.
        :param _builtins.str field: If not set, the table is partitioned by pseudo column '_PARTITIONTIME'; if set, the table is partitioned by this field.
...
class JobQuery(dict):
    ...
    def __init__(__self__, *,
                 ...
                 flatten_results: Optional[_builtins.bool] = None,
                 maximum_billing_tier: Optional[_builtins.int] = None,
                 maximum_bytes_billed: Optional[_builtins.str] = None,
                 ...
                 use_legacy_sql: Optional[_builtins.bool] = None,
                 ...
                 write_disposition: Optional[_builtins.str] = None):
        """
        :param _builtins.str query: SQL query text to execute. The useLegacySql field can be used to indicate whether the query uses legacy SQL or standard SQL.
        ...
        :param 'JobQueryDestinationTableArgs' destination_table: Describes the table where the query results should be stored.
               ...
               Structure is documented below.
        :param _builtins.bool flatten_results: If true and query uses legacy SQL dialect, flattens all nested and repeated fields in the query results.
               allowLargeResults must be true if this is set to false. For standard SQL queries, this flag is ignored and results are never flattened.
        :param _builtins.int maximum_billing_tier: Limits the billing tier for this job. Queries that have resource usage beyond this tier will fail (without incurring a charge).
               If unspecified, this will be set to your project default.
        :param _builtins.str maximum_bytes_billed: Limits the bytes billed for this job. Queries that will have bytes billed beyond this limit will fail (without incurring a charge).
               If unspecified, this will be set to your project default.
        :param _builtins.str parameter_mode: Standard SQL only. Set to POSITIONAL to use positional (?) query parameters or to NAMED to use named (@myparam) query parameters in this query.
        :param _builtins.str priority: Specifies a priority for the query.
               Default value is `INTERACTIVE`.
               Possible values are: `INTERACTIVE`, `BATCH`.
        :param Sequence[_builtins.str] schema_update_options: Allows the schema of the destination table to be updated as a side effect of the query job.
        ...
        :param 'JobQueryScriptOptionsArgs' script_options: Options controlling the execution of scripts.
               Structure is documented below.
        :param _builtins.bool use_legacy_sql: Specifies whether to use BigQuery's legacy SQL dialect for this query. The default value is true.
               If set to false, the query will use BigQuery's standard SQL.
        :param _builtins.bool use_query_cache: Whether to look for the result in the query cache. The query cache is a best-effort cache that will be flushed whenever
...
class JobQueryDefaultDataset(dict):
    ...
    def __init__(__self__, *,
                 ...
                 project_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str dataset_id: The dataset. Can be specified `{{dataset_id}}` if `project_id` is also set,
...
class JobQueryScriptOptions(dict):
    ...
    def __init__(__self__, *,
                 key_result_statement: Optional[_builtins.str] = None,
                 statement_byte_budget: Optional[_builtins.str] = None,
                 statement_timeout_ms: Optional[_builtins.str] = None):
        """
        :param _builtins.str key_result_statement: Determines which statement in the script represents the "key result",
               used to populate the schema and query results of the script job.
               Possible values are: `LAST`, `FIRST_SELECT`.
        :param _builtins.str statement_byte_budget: Limit on the number of bytes billed per statement. Exceeding this budget results in an error.
        :param _builtins.str statement_timeout_ms: Timeout period for each statement in a script.
        """
...
class JobQueryUserDefinedFunctionResource(dict):
    ...
    def __init__(__self__, *,
                 inline_code: Optional[_builtins.str] = None,
                 resource_uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str inline_code: An inline resource that contains code for a user-defined function (UDF).
               Providing a inline code resource is equivalent to providing a URI for a file containing the same code.
        :param _builtins.str resource_uri: A code resource to load from a Google Cloud Storage URI (gs://bucket/path).
        """
...
class JobStatusError(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str location: The geographic location of the job. The default value is US.
        :param _builtins.str message: A human-readable description of the error.
        :param _builtins.str reason: A short error code that summarizes the error.
        """
        if location is not None:
            pulumi.set(__self__, "location", location)
...
class ReservationAutoscale(dict):
    ...
    def __init__(__self__, *,
                 current_slots: Optional[_builtins.int] = None,
                 max_slots: Optional[_builtins.int] = None):
        """
        :param _builtins.int current_slots: (Output)
               The slot capacity added to this reservation when autoscale happens. Will be between [0, max_slots].
        :param _builtins.int max_slots: Number of slots to be scaled when needed.
        """
...
class ReservationReplicationStatus(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_error_time: Optional[_builtins.str] = None,
                 last_replication_time: Optional[_builtins.str] = None):
        """
        :param Sequence['ReservationReplicationStatusErrorArgs'] errors: (Output)
               ...
               Structure is documented below.
        :param _builtins.str last_error_time: (Output)
               ...
               succeeded since.
        :param _builtins.str last_replication_time: (Output)
...
class RoutineArgument(dict):
    ...
    def __init__(__self__, *,
                 argument_kind: Optional[_builtins.str] = None,
                 data_type: Optional[_builtins.str] = None,
                 mode: Optional[_builtins.str] = None,
                 name: Optional[_builtins.str] = None,
                 table_type: Optional['outputs.RoutineArgumentTableType'] = None):
        """
        :param _builtins.str argument_kind: Defaults to FIXED_TYPE.
               Default value is `FIXED_TYPE`.
               Possible values are: `FIXED_TYPE`, `ANY_TYPE`, `FIXED_TABLE`.
        :param _builtins.str data_type: A JSON schema for the data type. Required unless argumentKind = ANY_TYPE.
        ...
        :param _builtins.str mode: Specifies whether the argument is input or output. Can be set for procedures only.
               Possible values are: `IN`, `OUT`, `INOUT`.
        :param _builtins.str name: The name of this argument. Can be absent for function return argument.
        :param 'RoutineArgumentTableTypeArgs' table_type: If argumentKind is FIXED_TABLE, a schema for the table type.
               Structure is documented below.
        """
    ...
    def table_type(self) -> Optional['outputs.RoutineArgumentTableType']:
        """
...
@pulumi.output_type
class RoutineArgumentTableType(dict):
    def __init__(__self__, *,
                 columns: Optional[Sequence['outputs.RoutineArgumentTableTypeColumn']] = None):
        """
        :param Sequence['RoutineArgumentTableTypeColumnArgs'] columns: The columns in the table type.
               Structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def columns(self) -> Optional[Sequence['outputs.RoutineArgumentTableTypeColumn']]:
        """
...
@pulumi.output_type
class RoutineArgumentTableTypeColumn(dict):
    def __init__(__self__, *,
                 name: Optional[_builtins.str] = None,
                 type: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name of the column.
        :param _builtins.str type: A JSON schema for the data type of the column. Required unless argumentKind = ANY_TYPE.
               ~>**NOTE**: Because this field expects a JSON string, any changes to the string
               will create a diff, even if the JSON itself hasn't changed. If the API returns
               a different value for the same schema, e.g. it switched the order of values
               or replaced STRUCT field type with RECORD field type, we currently cannot
...
class RoutineExternalRuntimeOptions(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "containerRequestConcurrency":
            suggest = "container_request_concurrency"
    ...
    def __init__(__self__, *,
                 ...
                 container_request_concurrency: Optional[_builtins.str] = None,
        ...
        :param _builtins.str container_memory: Amount of memory provisioned for a Python UDF container instance. Format:
               ...
               UDFs](https://cloud.google.com/bigquery/docs/user-defined-functions-python#configure-container-limits)
        :param _builtins.str container_request_concurrency: Maximum number of concurrent requests per Python UDF container instance. For more
               information, see [Configure container limits for Python
               UDFs](https://cloud.google.com/bigquery/docs/user-defined-functions-python#configure-container-limits)
    ...
    def container_request_concurrency(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class RoutineIamBindingCondition(dict):
    def __init__(__self__, *,
                 expression: _builtins.str,
                 title: _builtins.str,
                 description: Optional[_builtins.str] = None):
...
@pulumi.output_type
class RoutineIamMemberCondition(dict):
    def __init__(__self__, *,
                 expression: _builtins.str,
                 title: _builtins.str,
                 description: Optional[_builtins.str] = None):
...
class RoutineRemoteFunctionOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_batching_rows: Optional[_builtins.str] = None,
                 user_defined_context: Optional[Mapping[str, _builtins.str]] = None):
        """
        :param _builtins.str connection: Fully qualified name of the user-provided connection object which holds
               the authentication information to send requests to the remote service.
               Format: "projects/{projectId}/locations/{locationId}/connections/{connectionId}"
        :param _builtins.str endpoint: Endpoint of the user-provided remote service, e.g.
               `https://us-east1-my_gcf_project.cloudfunctions.net/remote_add`
        :param _builtins.str max_batching_rows: Max number of rows in each batch sent to the remote service. If absent or if 0,
               BigQuery dynamically decides the number of rows in a batch.
        :param Mapping[str, _builtins.str] user_defined_context: User-defined context as a set of key/value pairs, which will be sent as function
...
class RoutineSparkOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 jar_uris: Optional[Sequence[_builtins.str]] = None,
                 main_class: Optional[_builtins.str] = None,
                 main_file_uri: Optional[_builtins.str] = None,
                 properties: Optional[Mapping[str, _builtins.str]] = None,
                 py_file_uris: Optional[Sequence[_builtins.str]] = None,
                 runtime_version: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] archive_uris: Archive files to be extracted into the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        :param _builtins.str connection: Fully qualified name of the user-provided Spark connection object.
               Format: "projects/{projectId}/locations/{locationId}/connections/{connectionId}"
        :param _builtins.str container_image: Custom container image for the runtime environment.
        :param Sequence[_builtins.str] file_uris: Files to be placed in the working directory of each executor. For more information about Apache Spark, see Apache Spark.
        :param Sequence[_builtins.str] jar_uris: JARs to include on the driver and executor CLASSPATH. For more information about Apache Spark, see Apache Spark.
        :param _builtins.str main_class: The fully qualified name of a class in jarUris, for example, com.example.wordcount.
               Exactly one of mainClass and main_jar_uri field should be set for Java/Scala language type.
        :param _builtins.str main_file_uri: The main file/jar URI of the Spark application.
               Exactly one of the definitionBody field and the mainFileUri field must be set for Python.
               Exactly one of mainClass and mainFileUri field should be set for Java/Scala language type.
        :param Mapping[str, _builtins.str] properties: Configuration properties as a set of key/value pairs, which will be passed on to the Spark application.
               For more information, see Apache Spark and the procedure option list.
               An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param Sequence[_builtins.str] py_file_uris: Python files to be placed on the PYTHONPATH for PySpark application. Supported file types: .py, .egg, and .zip. For more information about Apache Spark, see Apache Spark.
        :param _builtins.str runtime_version: Runtime version. If not specified, the default runtime version is used.
        """
...
class TableBiglakeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str connection_id: The connection specifying the credentials to be used to
        ...
        :param _builtins.str file_format: The file format the table data is stored in.
        :param _builtins.str storage_uri: The fully qualified location prefix of the external folder where table data
               is stored. The '*' wildcard character is not allowed. The URI should be in the format "gs://bucket/path_to_table/"
        :param _builtins.str table_format: The table format the metadata only snapshots are stored in.
        """
...
class TableEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_version: Optional[_builtins.str] = None):
        """
        :param _builtins.str kms_key_name: The self link or full name of a key which should be used to
               encrypt this table.  Note that the default bigquery service account will need to have
               encrypt/decrypt permissions on this key - you may want to see the
               `bigquery_get_default_service_account` datasource and the
               `kms.CryptoKeyIAMBinding` resource.
        :param _builtins.str kms_key_version: The self link or full name of the kms key version used to encrypt this table.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
        if kms_key_version is not None:
            pulumi.set(__self__, "kms_key_version", kms_key_version)
...
class TableExternalCatalogTableOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str connection_id: The connection specifying the credentials to be
        ...
        :param Mapping[str, _builtins.str] parameters: A map of key value pairs defining the parameters and
...
class TableExternalCatalogTableOptionsStorageDescriptor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str input_format: Specifies the fully qualified class name of the
               InputFormat (e.g. "org.apache.hadoop.hive.ql.io.orc.OrcInputFormat"). The
               maximum length is 128 characters.
        :param _builtins.str location_uri: The physical location of the table (e.g.
               'gs://spark-dataproc-data/pangea-data/case_sensitive/' or
               'gs://spark-dataproc-data/pangea-data/*'). The maximum length is 2056 bytes.
        :param _builtins.str output_format: Specifies the fully qualified class name of the
...
class TableExternalCatalogTableOptionsStorageDescriptorSerdeInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parameters: Optional[Mapping[str, _builtins.str]] = None):
        """
        :param _builtins.str serialization_library: Specifies a fully-qualified class name of
        ...
        :param _builtins.str name: Name of the SerDe. The maximum length is 256 characters.
        :param Mapping[str, _builtins.str] parameters: Key-value pairs that define the initialization
...
class TableExternalDataConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_bad_records: Optional[_builtins.int] = None,
                 metadata_cache_mode: Optional[_builtins.str] = None,
                 object_metadata: Optional[_builtins.str] = None,
                 parquet_options: Optional['outputs.TableExternalDataConfigurationParquetOptions'] = None,
                 reference_file_schema_uri: Optional[_builtins.str] = None,
                 schema: Optional[_builtins.str] = None,
                 source_format: Optional[_builtins.str] = None):
        """
        :param _builtins.bool autodetect: Let BigQuery try to autodetect the schema
               and format of the table.
        :param Sequence[_builtins.str] source_uris: A list of the fully-qualified URIs that point to
        ...
        :param _builtins.str compression: The compression type of the data source.
               Valid values are "NONE" or "GZIP".
        :param _builtins.str connection_id: The connection specifying the credentials to be used to read
        ...
        :param _builtins.bool ignore_unknown_values: Indicates if BigQuery should
               allow extra values that are not represented in the table schema.
               If true, the extra values are ignored. If false, records with
               extra columns are treated as bad records, and if there are too
               many bad records, an invalid error is returned in the job result.
               The default value is false.
        :param _builtins.str json_extension: Used to indicate that a JSON variant, rather than normal JSON, is being used as the sourceFormat. This should only be used in combination with the `JSON` source format. Valid values are: `GEOJSON`.
        ...
        :param _builtins.int max_bad_records: The maximum number of bad records that
               BigQuery can ignore when reading data.
        :param _builtins.str metadata_cache_mode: Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source. Valid values are `AUTOMATIC` and `MANUAL`.
        :param _builtins.str object_metadata: Object Metadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the sourceUris. If `object_metadata` is set, `source_format` should be omitted.
        ...
        :param _builtins.str reference_file_schema_uri: When creating an external table, the user can provide a reference file with the table schema. This is enabled for the following formats: AVRO, PARQUET, ORC.
        :param _builtins.str schema: A JSON schema for the external table. Schema is required
               ...
               table schema must be specified using the top-level `schema` field
               documented above.
        :param _builtins.str source_format: The data format. Please see sourceFormat under
...
class TableExternalDataConfigurationAvroOptions(dict):
    ...
    def __init__(__self__, *,
                 use_avro_logical_types: _builtins.bool):
        """
        :param _builtins.bool use_avro_logical_types: If is set to true, indicates whether
...
class TableExternalDataConfigurationBigtableOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ignore_unspecified_column_families: Optional[_builtins.bool] = None,
                 output_column_families_as_json: Optional[_builtins.bool] = None,
                 read_rowkey_as_string: Optional[_builtins.bool] = None):
        """
        ...
        :param _builtins.bool ignore_unspecified_column_families: If field is true, then the column families that are not specified in columnFamilies list are not exposed in the table schema. Otherwise, they are read with BYTES type values. The default value is false.
        :param _builtins.bool output_column_families_as_json: If field is true, then each column family will be read as a single JSON column. Otherwise they are read as a repeated cell structure containing timestamp/value tuples. The default value is false.
        :param _builtins.bool read_rowkey_as_string: If field is true, then the rowkey column families will be read and converted to string. Otherwise they are read with BYTES type values and users need to manually cast them with CAST if necessary. The default value is false.
        """
...
class TableExternalDataConfigurationBigtableOptionsColumnFamily(dict):
    ...
    def __init__(__self__, *,
                 ...
                 encoding: Optional[_builtins.str] = None,
                 family_id: Optional[_builtins.str] = None,
                 only_read_latest: Optional[_builtins.bool] = None,
                 type: Optional[_builtins.str] = None):
        """
        ...
        :param _builtins.str encoding: The encoding of the values when the type is not STRING. Acceptable encoding values are: TEXT - indicates values are alphanumeric text strings. BINARY - indicates values are encoded using HBase Bytes.toBytes family of functions. This can be overridden for a specific column by listing that column in 'columns' and specifying an encoding for it.
        :param _builtins.str family_id: Identifier of the column family.
        :param _builtins.bool only_read_latest: If this is set only the latest version of value are exposed for all columns in this column family. This can be overridden for a specific column by listing that column in 'columns' and specifying a different setting for that column.
        :param _builtins.str type: The type to convert the value in cells of this column family. The values are expected to be encoded using HBase Bytes.toBytes function when using the BINARY encoding value. Following BigQuery types are allowed (case-sensitive): "BYTES", "STRING", "INTEGER", "FLOAT", "BOOLEAN", "JSON". Default type is BYTES. This can be overridden for a specific column by listing that column in 'columns' and specifying a type for it.
        """
        if columns is not None:
            pulumi.set(__self__, "columns", columns)
        if encoding is not None:
...
class TableExternalDataConfigurationBigtableOptionsColumnFamilyColumn(dict):
    ...
    def __init__(__self__, *,
                 ...
                 only_read_latest: Optional[_builtins.bool] = None,
                 qualifier_encoded: Optional[_builtins.str] = None,
                 qualifier_string: Optional[_builtins.str] = None,
                 type: Optional[_builtins.str] = None):
        """
        :param _builtins.str encoding: The encoding of the values when the type is not STRING. Acceptable encoding values are: TEXT - indicates values are alphanumeric text strings. BINARY - indicates values are encoded using HBase Bytes.toBytes family of functions. 'encoding' can also be set at the column family level. However, the setting at this level takes precedence if 'encoding' is set at both levels.
        :param _builtins.str field_name: If the qualifier is not a valid BigQuery field identifier i.e. does not match [a-zA-Z][a-zA-Z0-9_]*, a valid identifier must be provided as the column field name and is used as field name in queries.
        :param _builtins.bool only_read_latest: If this is set, only the latest version of value in this column are exposed. 'onlyReadLatest' can also be set at the column family level. However, the setting at this level takes precedence if 'onlyReadLatest' is set at both levels.
        :param _builtins.str qualifier_encoded: Qualifier of the column. Columns in the parent column family that has this exact qualifier are exposed as . field. If the qualifier is valid UTF-8 string, it can be specified in the qualifierString field. Otherwise, a base-64 encoded value must be set to qualifierEncoded. The column field name is the same as the column qualifier. However, if the qualifier is not a valid BigQuery field identifier i.e. does not match [a-zA-Z][a-zA-Z0-9_]*, a valid identifier must be provided as fieldName.
        :param _builtins.str qualifier_string: Qualifier string.
...
class TableExternalDataConfigurationCsvOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool allow_quoted_newlines: Indicates if BigQuery should allow
               quoted data sections that contain newline characters in a CSV file.
               The default value is false.
        :param _builtins.str encoding: The character encoding of the data. The supported
...
class TableExternalDataConfigurationGoogleSheetsOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 skip_leading_rows: Optional[_builtins.int] = None):
        """
        :param _builtins.str range: Range of a sheet to query from. Only used when
               non-empty. At least one of `range` or `skip_leading_rows` must be set.
               Typical format: "sheet_name!top_left_cell_id:bottom_right_cell_id"
               For example: "sheet1!A1:B20"
        :param _builtins.int skip_leading_rows: The number of rows at the top of the sheet
...
class TableExternalDataConfigurationHivePartitioningOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_uri_prefix: Optional[_builtins.str] = None):
        """
        :param _builtins.str mode: When set, what mode of hive partitioning to use when
        ...
        :param _builtins.bool require_partition_filter: If set to true, queries over this table
               ...
               specified.
        :param _builtins.str source_uri_prefix: When hive partition detection is requested,
...
class TableExternalDataConfigurationJsonOptions(dict):
    def __init__(__self__, *,
                 encoding: Optional[_builtins.str] = None):
        """
        :param _builtins.str encoding: The character encoding of the data. The supported values are UTF-8, UTF-16BE, UTF-16LE, UTF-32BE, and UTF-32LE. The default value is UTF-8.
        """
        if encoding is not None:
            pulumi.set(__self__, "encoding", encoding)
...
class TableExternalDataConfigurationParquetOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enum_as_string: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool enable_list_inference: Indicates whether to use schema inference specifically for Parquet LIST logical type.
        :param _builtins.bool enum_as_string: Indicates whether to infer Parquet ENUM logical type as STRING instead of BYTES by default.
        """
        if enable_list_inference is not None:
            pulumi.set(__self__, "enable_list_inference", enable_list_inference)
        if enum_as_string is not None:
...
class TableMaterializedView(dict):
    ...
    def __init__(__self__, *,
                 query: _builtins.str,
                 allow_non_incremental_definition: Optional[_builtins.bool] = None,
                 enable_refresh: Optional[_builtins.bool] = None,
                 refresh_interval_ms: Optional[_builtins.int] = None):
        """
        :param _builtins.str query: A query whose result is persisted.
        :param _builtins.bool allow_non_incremental_definition: Allow non incremental materialized view definition.
               The default value is false.
        :param _builtins.bool enable_refresh: Specifies whether to use BigQuery's automatic refresh for this materialized view when the base table is updated.
               The default value is true.
        :param _builtins.int refresh_interval_ms: The maximum frequency at which this materialized view will be refreshed.
...
class TableRangePartitioning(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str field: The field used to determine how to create a range-based
               partition.
...
class TableRangePartitioningRange(dict):
    def __init__(__self__, *,
                 ...
                 start: _builtins.int):
        """
        :param _builtins.int end: End of the range partitioning, exclusive.
        :param _builtins.int interval: The width of each range within the partition.
        :param _builtins.int start: Start of the range partitioning, inclusive.
        """
...
class TableSchemaForeignTypeInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type_system: Specifies the system which defines the foreign data
               type.
        """
...
class TableTableConstraintsForeignKey(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'TableTableConstraintsForeignKeyReferencedTableArgs' referenced_table: The table that holds the primary key
               ...
               Structure is documented below.
        :param _builtins.str name: Set only if the foreign key constraint is named.
        """
...
class TableTableConstraintsForeignKeyColumnReferences(dict):
    ...
    def __init__(__self__, *,
                 referenced_column: _builtins.str,
                 referencing_column: _builtins.str):
        """
        :param _builtins.str referenced_column: The column in the primary key that are
               referenced by the referencingColumn
        :param _builtins.str referencing_column: The column that composes the foreign key.
        """
...
class TableTableConstraintsForeignKeyReferencedTable(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str dataset_id: The ID of the dataset containing this table.
        :param _builtins.str project_id: The ID of the project containing this table.
        :param _builtins.str table_id: The ID of the table. The ID must contain only
...
class TableTableConstraintsPrimaryKey(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] columns: The columns that are composed of the primary key constraint.
        """
        pulumi.set(__self__, "columns", columns)
...
class TableTableReplicationInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replication_interval_ms: Optional[_builtins.int] = None):
        """
        :param _builtins.str source_dataset_id: The ID of the source dataset.
        :param _builtins.str source_project_id: The ID of the source project.
        :param _builtins.str source_table_id: The ID of the source materialized view.
        :param _builtins.int replication_interval_ms: The interval at which the source
...
class TableTimePartitioning(dict):
    ...
    def __init__(__self__, *,
                 type: _builtins.str,
                 expiration_ms: Optional[_builtins.int] = None,
                 field: Optional[_builtins.str] = None,
                 require_partition_filter: Optional[_builtins.bool] = None):
        """
        :param _builtins.str type: The supported types are DAY, HOUR, MONTH, and YEAR,
               which will generate one partition per day, hour, month, and year, respectively.
        :param _builtins.int expiration_ms: Number of milliseconds for which to keep the
               storage for a partition.
        :param _builtins.str field: The field used to determine how to create a time-based
...
class GetDatasetsDatasetResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str friendly_name: The friendly name of the dataset.
        :param Mapping[str, _builtins.str] labels: User-provided dataset labels, in key/value pairs.
        :param _builtins.str location: The geographic location of the dataset.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
...
class GetTableBiglakeConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 table_format: _builtins.str):
        """
        :param _builtins.str connection_id: The connection specifying the credentials to be used to read and write to external storage, such as Cloud Storage. The connection_id can have the form "&lt;project\\_id&gt;.&lt;location\\_id&gt;.&lt;connection\\_id&gt;" or "projects/&lt;project\\_id&gt;/locations/&lt;location\\_id&gt;/connections/&lt;connection\\_id&gt;".
        :param _builtins.str file_format: The file format the data is stored in.
        :param _builtins.str storage_uri: The fully qualified location prefix of the external folder where table data is stored. The '*' wildcard character is not allowed. The URI should be in the format "gs://bucket/path_to_table/"
        :param _builtins.str table_format: The table format the metadata only snapshots are stored in.
        """
        pulumi.set(__self__, "connection_id", connection_id)
        pulumi.set(__self__, "file_format", file_format)
...
class GetTableExternalCatalogTableOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str connection_id: The connection specifying the credentials to be used to read external storage, such as Azure Blob, Cloud Storage, or S3. The connection is needed to read the open source table from BigQuery Engine. The connection_id can have the form <project_id>.<location_id>.<connection_id> or projects/<project_id>/locations/<location_id>/connections/<connection_id>.
        :param Mapping[str, _builtins.str] parameters: A map of key value pairs defining the parameters and properties of the open source table. Corresponds with hive meta store table parameters. Maximum size of 4Mib.
...
class GetTableExternalCatalogTableOptionStorageDescriptorResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str input_format: Specifies the fully qualified class name of the InputFormat (e.g. "org.apache.hadoop.hive.ql.io.orc.OrcInputFormat"). The maximum length is 128 characters.
        :param _builtins.str location_uri: The physical location of the table (e.g. 'gs://spark-dataproc-data/pangea-data/case_sensitive/' or 'gs://spark-dataproc-data/pangea-data/*'). The maximum length is 2056 bytes.
        :param _builtins.str output_format: Specifies the fully qualified class name of the OutputFormat (e.g. "org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat"). The maximum length is 128 characters.
...
class GetTableExternalCatalogTableOptionStorageDescriptorSerdeInfoResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Name of the SerDe. The maximum length is 256 characters.
        :param Mapping[str, _builtins.str] parameters: Key-value pairs that define the initialization parameters for the serialization library. Maximum size 10 Kib.
        :param _builtins.str serialization_library: Specifies a fully-qualified class name of the serialization library that is responsible for the translation of data between table representation and the underlying low-level input and output format structures. The maximum length is 256 characters.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "parameters", parameters)
        pulumi.set(__self__, "serialization_library", serialization_library)
...
class GetTableExternalDataConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 source_uris: Sequence[_builtins.str]):
        """
        :param _builtins.bool autodetect: Let BigQuery try to autodetect the schema and format of the table.
        ...
        :param _builtins.bool ignore_unknown_values: Indicates if BigQuery should allow extra values that are not represented in the table schema. If true, the extra values are ignored. If false, records with extra columns are treated as bad records, and if there are too many bad records, an invalid error is returned in the job result. The default value is false.
        :param _builtins.str json_extension: Load option to be used together with sourceFormat newline-delimited JSON to indicate that a variant of JSON is being loaded. To load newline-delimited GeoJSON, specify GEOJSON (and sourceFormat must be set to NEWLINE_DELIMITED_JSON).
        ...
        :param _builtins.int max_bad_records: The maximum number of bad records that BigQuery can ignore when reading data.
        :param _builtins.str metadata_cache_mode: Metadata Cache Mode for the table. Set this to enable caching of metadata from external data source.
        :param _builtins.str object_metadata: Object Metadata is used to create Object Tables. Object Tables contain a listing of objects (with their metadata) found at the sourceUris. If ObjectMetadata is set, sourceFormat should be omitted.
        ...
        :param _builtins.str reference_file_schema_uri: When creating an external table, the user can provide a reference file with the table schema. This is enabled for the following formats: AVRO, PARQUET, ORC.
        :param _builtins.str schema: A JSON schema for the external table. Schema is required for CSV and JSON formats and is disallowed for Google Cloud Bigtable, Cloud Datastore backups, and Avro formats when using external tables.
        :param _builtins.str source_format: Please see sourceFormat under ExternalDataConfiguration in Bigquery's public API documentation (https://cloud.google.com/bigquery/docs/reference/rest/v2/tables#externaldataconfiguration) for supported formats. To use "GOOGLE_SHEETS" the scopes must include "googleapis.com/auth/drive.readonly".
        :param Sequence[_builtins.str] source_uris: A list of the fully-qualified URIs that point to your data in Google Cloud.
        """
        pulumi.set(__self__, "autodetect", autodetect)
        pulumi.set(__self__, "avro_options", avro_options)
        pulumi.set(__self__, "bigtable_options", bigtable_options)
...
class GetTableExternalDataConfigurationAvroOptionResult(dict):
    def __init__(__self__, *,
                 use_avro_logical_types: _builtins.bool):
        """
        :param _builtins.bool use_avro_logical_types: If sourceFormat is set to "AVRO", indicates whether to interpret logical types as the corresponding BigQuery data type (for example, TIMESTAMP), instead of using the raw type (for example, INTEGER).
        """
        pulumi.set(__self__, "use_avro_logical_types", use_avro_logical_types)
...
class GetTableExternalDataConfigurationGoogleSheetsOptionResult(dict):
    def __init__(__self__, *,
                 ...
                 skip_leading_rows: _builtins.int):
        """
        :param _builtins.str range: Range of a sheet to query from. Only used when non-empty. At least one of range or skip_leading_rows must be set. Typical format: "sheet_name!top_left_cell_id:bottom_right_cell_id" For example: "sheet1!A1:B20
        :param _builtins.int skip_leading_rows: The number of rows at the top of the sheet that BigQuery will skip when reading the data. At least one of range or skip_leading_rows must be set.
        """
        pulumi.set(__self__, "range", range)
        pulumi.set(__self__, "skip_leading_rows", skip_leading_rows)
...
class GetTableExternalDataConfigurationHivePartitioningOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str mode: When set, what mode of hive partitioning to use when reading data.
        :param _builtins.bool require_partition_filter: If set to true, queries over this table require a partition filter that can be used for partition elimination to be specified.
        :param _builtins.str source_uri_prefix: When hive partition detection is requested, a common for all source uris must be required. The prefix must end immediately before the partition key encoding begins.
        """
        pulumi.set(__self__, "mode", mode)
        pulumi.set(__self__, "require_partition_filter", require_partition_filter)
        pulumi.set(__self__, "source_uri_prefix", source_uri_prefix)
...
class GetTableMaterializedViewResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_non_incremental_definition: Allow non incremental materialized view definition. The default value is false.
        :param _builtins.bool enable_refresh: Specifies if BigQuery should automatically refresh materialized view when the base table is updated. The default is true.
        :param _builtins.str query: A query whose result is persisted.
        :param _builtins.int refresh_interval_ms: Specifies maximum frequency at which this materialized view will be refreshed. The default is 1800000.
        """
        pulumi.set(__self__, "allow_non_incremental_definition", allow_non_incremental_definition)
        pulumi.set(__self__, "enable_refresh", enable_refresh)
        pulumi.set(__self__, "query", query)
...
class GetTableRangePartitioningResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str field: The field used to determine how to create a range-based partition.
...
class GetTableSchemaForeignTypeInfoResult(dict):
    def __init__(__self__, *,
                 type_system: _builtins.str):
        """
        :param _builtins.str type_system: Specifies the system which defines the foreign data type.
        """
        pulumi.set(__self__, "type_system", type_system)
...
class GetTableTableConstraintForeignKeyColumnReferenceResult(dict):
    def __init__(__self__, *,
                 ...
                 referencing_column: _builtins.str):
        """
        :param _builtins.str referenced_column: The column in the primary key that are referenced by the referencingColumn.
        :param _builtins.str referencing_column: The column that composes the foreign key.
        """
        pulumi.set(__self__, "referenced_column", referenced_column)
        pulumi.set(__self__, "referencing_column", referencing_column)
...
class GetTableTableConstraintForeignKeyReferencedTableResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str dataset_id: The dataset ID.
        :param _builtins.str project_id: The ID of the project containing this table.
        :param _builtins.str table_id: The table ID.
        """
        pulumi.set(__self__, "dataset_id", dataset_id)
        pulumi.set(__self__, "project_id", project_id)
        pulumi.set(__self__, "table_id", table_id)
...
class GetTableTableReplicationInfoResult(dict):
    def __init__(__self__, *,
                 ...
                 source_table_id: _builtins.str):
        """
        :param _builtins.int replication_interval_ms: The interval at which the source materialized view is polled for updates. The default is 300000.
        :param _builtins.str source_dataset_id: The ID of the source dataset.
        :param _builtins.str source_project_id: The ID of the source project.
        :param _builtins.str source_table_id: The ID of the source materialized view.
        """
...
class GetTableTimePartitioningResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.int expiration_ms: Number of milliseconds for which to keep the storage for a partition.
        :param _builtins.str field: The field used to determine how to create a time-based partition. If time-based partitioning is enabled without this value, the table is partitioned based on the load time.
        :param _builtins.bool require_partition_filter: If set to true, queries over this table require a partition filter that can be used for partition elimination to be specified.
        :param _builtins.str type: The supported types are DAY, HOUR, MONTH, and YEAR, which will generate one partition per day, hour, month, and year, respectively.
        """
        pulumi.set(__self__, "expiration_ms", expiration_ms)
        pulumi.set(__self__, "field", field)
        pulumi.set(__self__, "require_partition_filter", require_partition_filter)
...
class GetTablesTableResult(dict):
    def __init__(__self__, *,
                 ...
                 table_id: _builtins.str):
        """
        :param Mapping[str, _builtins.str] labels: User-provided table labels, in key/value pairs.
        :param _builtins.str table_id: The name of the table.
        """
        pulumi.set(__self__, "labels", labels)
        pulumi.set(__self__, "table_id", table_id)
