...
class IamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] table_id: Used to find the parent resource to bind the IAM policy to
...
class IamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `bigquery.IamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the table are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `bigquery.IamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the table are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            policy_data: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            table_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'IamPolicy':
        """
