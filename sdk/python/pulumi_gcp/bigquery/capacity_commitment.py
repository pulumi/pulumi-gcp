...
class CapacityCommitmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] renewal_plan: The plan this capacity commitment is converted to after commitmentEndTime passes. Once the plan is changed, committed period is extended according to commitment plan. Only applicable for some commitment plans.
        """
...
class _CapacityCommitmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The geographic location where the transfer config should reside.
               Examples: US, EU, asia-northeast1. The default value is US.
        :param pulumi.Input[_builtins.str] name: The resource name of the capacity commitment, e.g., projects/myproject/locations/US/capacityCommitments/123
        :param pulumi.Input[_builtins.str] plan: Capacity commitment plan. Valid values are at https://cloud.google.com/bigquery/docs/reference/reservations/rpc/google.cloud.bigquery.reservation.v1#commitmentplan
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] renewal_plan: The plan this capacity commitment is converted to after commitmentEndTime passes. Once the plan is changed, committed period is extended according to commitment plan. Only applicable for some commitment plans.
        :param pulumi.Input[_builtins.int] slot_count: Number of slots in this commitment.
        :param pulumi.Input[_builtins.str] state: State of the commitment
        """
        if capacity_commitment_id is not None:
            pulumi.set(__self__, "capacity_commitment_id", capacity_commitment_id)
...
class CapacityCommitment(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="enforceSingleAdminProjectPerOrg")
    def enforce_single_admin_project_per_org(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        If true, fail the request if another project in the organization has a capacity commitment.
        """
        return pulumi.get(self, "enforce_single_admin_project_per_org")
