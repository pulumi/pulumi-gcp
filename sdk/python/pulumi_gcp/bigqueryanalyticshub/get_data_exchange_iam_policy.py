...
def get_data_exchange_iam_policy(data_exchange_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_exchange_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The name of the location this data exchange.
...
def get_data_exchange_iam_policy_output(data_exchange_id: Optional[pulumi.Input[_builtins.str]] = None,
