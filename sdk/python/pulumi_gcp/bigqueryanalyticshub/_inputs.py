...
class ListingBigqueryDatasetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dataset: Resource name of the dataset source for this listing. e.g. projects/myproject/datasets/123
...
class ListingDataProviderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of the data provider.
        :param pulumi.Input[builtins.str] primary_contact: Email or URL of the data provider.
        """
...
class ListingPublisherArgs:
    def __init__(__self__, *,
                 ...
                 primary_contact: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Name of the listing publisher.
        :param pulumi.Input[builtins.str] primary_contact: Email or URL of the listing publisher.
        """
        pulumi.set(__self__, "name", name)
        if primary_contact is not None:
            pulumi.set(__self__, "primary_contact", primary_contact)
...
if not MYPY:
    class ListingRestrictedExportConfigArgsDict(TypedDict):
        ...
        """
        restrict_direct_table_access: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Output)
        If true, restrict direct table access(read api/tabledata.list) on linked table.
        """
        restrict_query_result: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ListingRestrictedExportConfigArgs:
    def __init__(__self__, *,
                 ...
                 restrict_direct_table_access: Optional[pulumi.Input[builtins.bool]] = None,
                 restrict_query_result: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: If true, enable restricted export.
        :param pulumi.Input[builtins.bool] restrict_direct_table_access: (Output)
               If true, restrict direct table access(read api/tabledata.list) on linked table.
        :param pulumi.Input[builtins.bool] restrict_query_result: If true, restrict export of query result derived from restricted linked dataset table.
        """
    ...
    def restrict_direct_table_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Output)
        If true, restrict direct table access(read api/tabledata.list) on linked table.
        """
    ...
    def restrict_direct_table_access(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "restrict_direct_table_access", value)

    @property
    @pulumi.getter(name="restrictQueryResult")
    def restrict_query_result(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, restrict export of query result derived from restricted linked dataset table.
        """
    ...
    def restrict_query_result(self, value: Optional[pulumi.Input[builtins.bool]]):
