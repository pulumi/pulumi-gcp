...
__all__ = ['DataExchangeIamMemberArgs', 'DataExchangeIamMember']

@pulumi.input_type
class DataExchangeIamMemberArgs:
    def __init__(__self__, *,
                 data_exchange_id: pulumi.Input[_builtins.str],
                 member: pulumi.Input[_builtins.str],
                 role: pulumi.Input[_builtins.str],
                 condition: pulumi.Input[Optional['DataExchangeIamMemberConditionArgs']] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a DataExchangeIamMember resource.

        :param pulumi.Input[_builtins.str] data_exchange_id: Used to find the parent resource to bind the IAM policy to
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['DataExchangeIamMemberConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['DataExchangeIamMemberConditionArgs']]):
...
@pulumi.input_type
class _DataExchangeIamMemberState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['DataExchangeIamMemberConditionArgs']] = None,
...
@pulumi.type_token("gcp:bigqueryanalyticshub/dataExchangeIamMember:DataExchangeIamMember")
class DataExchangeIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['DataExchangeIamMemberConditionArgs', 'DataExchangeIamMemberConditionArgsDict', 'outputs.DataExchangeIamMemberCondition']]] = None,
                 data_exchange_id: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `bigqueryanalyticshub.DataExchangeIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the dataexchange are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `bigqueryanalyticshub.DataExchangeIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the dataexchange are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def __init__(__self__,
        ...
        * {{data_exchange_id}}
        ...
        :param str resource_name: The name of the resource.
        :param DataExchangeIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataExchangeIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataExchangeIamMemberArgs.__new__(DataExchangeIamMemberArgs)
        ...
        super(DataExchangeIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            member: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'DataExchangeIamMember':
        """
        ...
        __props__ = _DataExchangeIamMemberState.__new__(_DataExchangeIamMemberState)
        ...
        __props__.__dict__["project"] = project
        __props__.__dict__["role"] = role
        return DataExchangeIamMember(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.DataExchangeIamMemberCondition']]:
        return pulumi.get(self, "condition")
