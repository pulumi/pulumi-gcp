...
def get_listing_iam_policy(data_exchange_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_exchange_id: The ID of the data exchange. Must contain only Unicode letters, numbers (0-9), underscores (_). Should not use characters that require URL-escaping, or characters outside of ASCII, spaces. Used to find the parent resource to bind the IAM policy to
    :param _builtins.str listing_id: Used to find the parent resource to bind the IAM policy to
...
def get_listing_iam_policy_output(data_exchange_id: pulumi.Input[Optional[_builtins.str]] = None,
