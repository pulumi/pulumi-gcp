...
def get_listing_iam_policy(data_exchange_id: Optional[builtins.str] = None,
...
def get_listing_iam_policy_output(data_exchange_id: Optional[pulumi.Input[builtins.str]] = None,
