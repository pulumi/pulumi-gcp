...
if not MYPY:
    class AlertPolicyAlertStrategyArgsDict(TypedDict):
        auto_close: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        notification_prompts: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AlertPolicyAlertStrategyArgs:
    def __init__(__self__, *,
                 auto_close: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 notification_prompts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 notification_rate_limit: Optional[pulumi.Input['AlertPolicyAlertStrategyNotificationRateLimitArgs']] = None):
        """
        :param pulumi.Input[builtins.str] auto_close: If an alert policy that was active has no data for this long, any open incidents will close.
        :param pulumi.Input[Sequence[pulumi.Input['AlertPolicyAlertStrategyNotificationChannelStrategyArgs']]] notification_channel_strategies: Control over how the notification channels in `notification_channels`
               are notified when this alert fires, on a per-channel basis.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_prompts: Control when notifications will be sent out.
               Each value may be one of: `NOTIFICATION_PROMPT_UNSPECIFIED`, `OPENED`, `CLOSED`.
    ...
    def auto_close(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If an alert policy that was active has no data for this long, any open incidents will close.
        """
    ...
    @auto_close.setter
    def auto_close(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def notification_prompts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Control when notifications will be sent out.
        Each value may be one of: `NOTIFICATION_PROMPT_UNSPECIFIED`, `OPENED`, `CLOSED`.
        """
    ...
    def notification_prompts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AlertPolicyAlertStrategyNotificationChannelStrategyArgsDict(TypedDict):
        notification_channel_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        renotify_interval: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AlertPolicyAlertStrategyNotificationChannelStrategyArgs:
    def __init__(__self__, *,
                 notification_channel_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 renotify_interval: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_channel_names: The notification channels that these settings apply to. Each of these
               correspond to the name field in one of the NotificationChannel objects
               referenced in the notification_channels field of this AlertPolicy. The format is
               `projects/[PROJECT_ID_OR_NUMBER]/notificationChannels/[CHANNEL_ID]`
        :param pulumi.Input[builtins.str] renotify_interval: The frequency at which to send reminder notifications for open incidents.
        """
    ...
    def notification_channel_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The notification channels that these settings apply to. Each of these
        correspond to the name field in one of the NotificationChannel objects
        referenced in the notification_channels field of this AlertPolicy. The format is
    ...
    def notification_channel_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "notification_channel_names", value)

    @property
    @pulumi.getter(name="renotifyInterval")
    def renotify_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The frequency at which to send reminder notifications for open incidents.
        """
    ...
    def renotify_interval(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertPolicyAlertStrategyNotificationRateLimitArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] period: Not more than one notification per period.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example "60.5s".
        """
...
class AlertPolicyConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] display_name: A short name or phrase used to identify the
               condition in dashboards, notifications, and
               incidents. To avoid confusion, don't use the same
               display name for multiple conditions in the same
               policy.
...
class AlertPolicyConditionConditionAbsentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] duration: The amount of time that a time series must
               fail to report new data to be considered
               failing. Currently, only values that are a
               multiple of a minute--e.g. 60s, 120s, or 300s
               --are supported.
        :param pulumi.Input[Sequence[pulumi.Input['AlertPolicyConditionConditionAbsentAggregationArgs']]] aggregations: Specifies the alignment of data points in
               ...
               order specified.
               Structure is documented below.
        :param pulumi.Input[builtins.str] filter: A filter that identifies which time series
               should be compared with the threshold.The
               filter is similar to the one that is
               specified in the
               MetricService.ListTimeSeries request (that
...
if not MYPY:
    class AlertPolicyConditionConditionAbsentAggregationArgsDict(TypedDict):
        alignment_period: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        cross_series_reducer: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        group_by_fields: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        ignored.
        """
        per_series_aligner: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AlertPolicyConditionConditionAbsentAggregationArgs:
    def __init__(__self__, *,
                 alignment_period: Optional[pulumi.Input[builtins.str]] = None,
                 cross_series_reducer: Optional[pulumi.Input[builtins.str]] = None,
                 group_by_fields: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 per_series_aligner: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] alignment_period: The alignment period for per-time
               series alignment. If present,
               alignmentPeriod must be at least
               60 seconds. After per-time series
               alignment, each time series will
               ...
               this field must be defined;
               otherwise an error is returned.
        :param pulumi.Input[builtins.str] cross_series_reducer: The approach to be used to combine
               time series. Not all reducer
               functions may be applied to all
               time series, depending on the
               metric type and the value type of
               ...
               returned.
               Possible values are: `REDUCE_NONE`, `REDUCE_MEAN`, `REDUCE_MIN`, `REDUCE_MAX`, `REDUCE_SUM`, `REDUCE_STDDEV`, `REDUCE_COUNT`, `REDUCE_COUNT_TRUE`, `REDUCE_COUNT_FALSE`, `REDUCE_FRACTION_TRUE`, `REDUCE_PERCENTILE_99`, `REDUCE_PERCENTILE_95`, `REDUCE_PERCENTILE_50`, `REDUCE_PERCENTILE_05`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_by_fields: The set of fields to preserve when
               crossSeriesReducer is specified.
               The groupByFields determine how
               the time series are partitioned
               into subsets prior to applying the
               ...
               is not defined, this field is
               ignored.
        :param pulumi.Input[builtins.str] per_series_aligner: The approach to be used to align
               individual time series. Not all
               alignment functions may be applied
               to all time series, depending on
               the metric type and value type of
    ...
    def alignment_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The alignment period for per-time
        series alignment. If present,
        alignmentPeriod must be at least
    ...
    def alignment_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alignment_period", value)

    @property
    @pulumi.getter(name="crossSeriesReducer")
    def cross_series_reducer(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The approach to be used to combine
        time series. Not all reducer
        functions may be applied to all
    ...
    def cross_series_reducer(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def per_series_aligner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The approach to be used to align
        individual time series. Not all
        alignment functions may be applied
    ...
    def per_series_aligner(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertPolicyConditionConditionAbsentTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] count: The absolute number of time series
               that must fail the predicate for the
               condition to be triggered.
        :param pulumi.Input[builtins.float] percent: The percentage of time series that
               must fail the predicate for the
               condition to be triggered.
        """
...
if not MYPY:
    class AlertPolicyConditionConditionMatchedLogArgsDict(TypedDict):
        ...
        A logs-based filter.
        """
        label_extractors: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class AlertPolicyConditionConditionMatchedLogArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] filter: A logs-based filter.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] label_extractors: A map from a label key to an extractor expression, which is used to
               extract the value for this label key. Each entry in this map is
               a specification for how data should be extracted from log entries that
               match filter. Each combination of extracted values is treated as
               a separate rule for the purposes of triggering notifications.
...
if not MYPY:
    class AlertPolicyConditionConditionMonitoringQueryLanguageArgsDict(TypedDict):
        ...
        """
        evaluation_missing_data: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AlertPolicyConditionConditionMonitoringQueryLanguageArgs:
    def __init__(__self__, *,
                 duration: pulumi.Input[builtins.str],
                 query: pulumi.Input[builtins.str],
                 evaluation_missing_data: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] duration: The amount of time that a time series must
               ...
               that unhealthy states are detected and
               alerted on quickly.
        :param pulumi.Input[builtins.str] query: Monitoring Query Language query that outputs a boolean stream.
        :param pulumi.Input[builtins.str] evaluation_missing_data: A condition control that determines how
               metric-threshold conditions are evaluated when
               data stops arriving.
               Possible values are: `EVALUATION_MISSING_DATA_INACTIVE`, `EVALUATION_MISSING_DATA_ACTIVE`, `EVALUATION_MISSING_DATA_NO_OP`.
    ...
    def evaluation_missing_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A condition control that determines how
        metric-threshold conditions are evaluated when
        data stops arriving.
    ...
    def evaluation_missing_data(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AlertPolicyConditionConditionPrometheusQueryLanguageArgsDict(TypedDict):
        ...
        """
        alert_rule: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        disable_metric_validation: NotRequired[pulumi.Input[builtins.bool]]
        ...
        """
        rule_group: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AlertPolicyConditionConditionPrometheusQueryLanguageArgs:
    def __init__(__self__, *,
                 query: pulumi.Input[builtins.str],
                 alert_rule: Optional[pulumi.Input[builtins.str]] = None,
                 disable_metric_validation: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 rule_group: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] query: The PromQL expression to evaluate. Every evaluation cycle this
               expression is evaluated at the current time, and all resultant time
               series become pending/firing alerts. This field must not be empty.
        :param pulumi.Input[builtins.str] alert_rule: The alerting rule name of this alert in the corresponding Prometheus
               configuration file.
               Some external tools may require this field to be populated correctly
               in order to refer to the original Prometheus configuration file.
               The rule group name and the alert name are necessary to update the
               ...
               This field is optional. If this field is not empty, then it must be a
               valid Prometheus label name.
        :param pulumi.Input[builtins.str] duration: Alerts are considered firing once their PromQL expression evaluated
               to be "true" for this long. Alerts whose PromQL expression was not
               evaluated to be "true" for long enough are considered pending. The
               default value is zero. Must be zero or positive.
        :param pulumi.Input[builtins.str] evaluation_interval: How often this rule should be evaluated. Must be a positive multiple
               of 30 seconds or missing. The default value is 30 seconds. If this
               PrometheusQueryLanguageCondition was generated from a Prometheus
               alerting rule, then this value should be taken from the enclosing
               rule group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels to add to or overwrite in the PromQL query result. Label names
               must be valid.
               Label values can be templatized by using variables. The only available
               variable names are the names of the labels in the PromQL result,
               although label names beginning with \\_\\_ (two "\\_") are reserved for
               internal use. "labels" may be empty. This field is intended to be used
               for organizing and identifying the AlertPolicy.
        :param pulumi.Input[builtins.str] rule_group: The rule group name of this alert in the corresponding Prometheus
               configuration file.
               Some external tools may require this field to be populated correctly
               in order to refer to the original Prometheus configuration file.
               The rule group name and the alert name are necessary to update the
    ...
    def alert_rule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The alerting rule name of this alert in the corresponding Prometheus
        configuration file.
        Some external tools may require this field to be populated correctly
    ...
    @alert_rule.setter
    def alert_rule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_rule", value)

    @property
    @pulumi.getter(name="disableMetricValidation")
    def disable_metric_validation(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "disable_metric_validation")

    @disable_metric_validation.setter
    def disable_metric_validation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def rule_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The rule group name of this alert in the corresponding Prometheus
        configuration file.
        Some external tools may require this field to be populated correctly
    ...
    @rule_group.setter
    def rule_group(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertPolicyConditionConditionSqlArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] query: The Log Analytics SQL query to run, as a string.  The query must
               conform to the required shape. Specifically, the query must not try to
               filter the input by time.  A filter will automatically be applied
               to filter the input so that the query receives all rows received
               since the last time the query was run.
...
if not MYPY:
    class AlertPolicyConditionConditionSqlDailyArgsDict(TypedDict):
        periodicity: pulumi.Input[builtins.int]
        """
...
class AlertPolicyConditionConditionSqlDailyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] periodicity: The number of days between runs. Must be greater than or equal
               to 1 day and less than or equal to 30 days.
    ...
    @property
    @pulumi.getter
    def periodicity(self) -> pulumi.Input[builtins.int]:
        """
        The number of days between runs. Must be greater than or equal
        to 1 day and less than or equal to 30 days.
        """
    ...
    @periodicity.setter
    def periodicity(self, value: pulumi.Input[builtins.int]):
...
class AlertPolicyConditionConditionSqlDailyExecutionTimeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] hours: Hours of a day in 24 hour format. Must be greater than or equal
               to 0 and typically must be less than or equal to 23. An API may
               choose to allow the value "24:00:00" for scenarios like business
               closing time.
        :param pulumi.Input[builtins.int] minutes: Minutes of an hour. Must be greater than or equal to 0 and
               less than or equal to 59.
        :param pulumi.Input[builtins.int] nanos: Fractions of seconds, in nanoseconds. Must be greater than or
               equal to 0 and less than or equal to 999,999,999.
        :param pulumi.Input[builtins.int] seconds: Seconds of a minute. Must be greater than or equal to 0 and
               typically must be less than or equal to 59. An API may allow the
               value 60 if it allows leap-seconds.
        """
...
if not MYPY:
    class AlertPolicyConditionConditionSqlHourlyArgsDict(TypedDict):
        ...
        """
        minute_offset: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AlertPolicyConditionConditionSqlHourlyArgs:
    def __init__(__self__, *,
                 periodicity: pulumi.Input[builtins.int],
                 minute_offset: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] periodicity: Number of hours between runs. The interval must be greater than or
               equal to 1 hour and less than or equal to 48 hours.
        :param pulumi.Input[builtins.int] minute_offset: The number of minutes after the hour (in UTC) to run the query.
               Must be greater than or equal to 0 minutes and less than or equal to
               59 minutes.  If left unspecified, then an arbitrary offset is used.
        """
        pulumi.set(__self__, "periodicity", periodicity)
    ...
    def minute_offset(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes after the hour (in UTC) to run the query.
        Must be greater than or equal to 0 minutes and less than or equal to
        59 minutes.  If left unspecified, then an arbitrary offset is used.
    ...
    def minute_offset(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AlertPolicyConditionConditionSqlMinutesArgs:
    def __init__(__self__, *,
                 periodicity: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] periodicity: Number of minutes between runs. The interval must be greater than or
               equal to 5 minutes and less than or equal to 1440 minutes.
        """
        pulumi.set(__self__, "periodicity", periodicity)
...
class AlertPolicyConditionConditionSqlRowCountTestArgs:
    def __init__(__self__, *,
                 ...
                 threshold: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] comparison: The comparison to apply between the time
               series (indicated by filter and aggregation)
               and the threshold (indicated by
               threshold_value). The comparison is applied
               on each time series, with the time series on
               ...
               COMPARISON_GT are supported currently.
               Possible values are: `COMPARISON_GT`, `COMPARISON_GE`, `COMPARISON_LT`, `COMPARISON_LE`, `COMPARISON_EQ`, `COMPARISON_NE`.
        :param pulumi.Input[builtins.int] threshold: The value against which to compare the row count.
        """
...
if not MYPY:
    class AlertPolicyConditionConditionThresholdArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        denominator_filter: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        threshold_value: NotRequired[pulumi.Input[builtins.float]]
        """
...
class AlertPolicyConditionConditionThresholdArgs:
    def __init__(__self__, *,
                 ...
                 denominator_filter: Optional[pulumi.Input[builtins.str]] = None,
                 evaluation_missing_data: Optional[pulumi.Input[builtins.str]] = None,
                 filter: Optional[pulumi.Input[builtins.str]] = None,
                 forecast_options: Optional[pulumi.Input['AlertPolicyConditionConditionThresholdForecastOptionsArgs']] = None,
                 threshold_value: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AlertPolicyConditionConditionThresholdDenominatorAggregationArgs']]] denominator_aggregations: Specifies the alignment of data points in
               ...
               method when debugging this field.
               Structure is documented below.
        :param pulumi.Input[builtins.str] denominator_filter: A filter that identifies a time series that
               should be used as the denominator of a ratio
               that will be compared with the threshold. If
               a denominator_filter is specified, the time
               series specified by the filter field will be
        ...
        :param pulumi.Input['AlertPolicyConditionConditionThresholdForecastOptionsArgs'] forecast_options: When this field is present, the `MetricThreshold`
               ...
               timeseries against the threshold.
               Structure is documented below.
        :param pulumi.Input[builtins.float] threshold_value: A value against which to compare the time
               series.
    ...
    def denominator_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A filter that identifies a time series that
        should be used as the denominator of a ratio
        that will be compared with the threshold. If
    ...
    def denominator_filter(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def threshold_value(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        A value against which to compare the time
        series.
        """
    ...
    def threshold_value(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class AlertPolicyConditionConditionThresholdForecastOptionsArgsDict(TypedDict):
        forecast_horizon: pulumi.Input[builtins.str]
        """
...
class AlertPolicyConditionConditionThresholdForecastOptionsArgs:
    def __init__(__self__, *,
                 forecast_horizon: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] forecast_horizon: The length of time into the future to forecast
               whether a timeseries will violate the threshold.
               If the predicted value is found to violate the
               threshold, and the violation is observed in all
               forecasts made for the Configured `duration`,
    ...
    def forecast_horizon(self) -> pulumi.Input[builtins.str]:
        """
        The length of time into the future to forecast
        whether a timeseries will violate the threshold.
        If the predicted value is found to violate the
    ...
    def forecast_horizon(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AlertPolicyCreationRecordArgsDict(TypedDict):
        mutate_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        When the change occurred.
        """
        mutated_by: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AlertPolicyCreationRecordArgs:
    def __init__(__self__, *,
                 mutate_time: Optional[pulumi.Input[builtins.str]] = None,
                 mutated_by: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] mutate_time: (Output)
               When the change occurred.
        :param pulumi.Input[builtins.str] mutated_by: (Output)
               The email address of the user making the change.
        """
    ...
    def mutate_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        When the change occurred.
        """
    ...
    @mutate_time.setter
    def mutate_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mutate_time", value)

    @property
    @pulumi.getter(name="mutatedBy")
    def mutated_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The email address of the user making the change.
        """
    ...
    @mutated_by.setter
    def mutated_by(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertPolicyDocumentationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content: The text of the documentation, interpreted according to mimeType.
               The content may not exceed 8,192 Unicode characters and may not
               exceed more than 10,240 bytes when encoded in UTF-8 format,
               whichever is smaller.
        :param pulumi.Input[Sequence[pulumi.Input['AlertPolicyDocumentationLinkArgs']]] links: Links to content such as playbooks, repositories, and other resources. This field can contain up to 3 entries.
               Structure is documented below.
        :param pulumi.Input[builtins.str] mime_type: The format of the content field. Presently, only the value
               "text/markdown" is supported.
        :param pulumi.Input[builtins.str] subject: The subject line of the notification. The subject line may not
               exceed 10,240 bytes. In notifications generated by this policy the contents
               of the subject line after variable expansion will be truncated to 255 bytes
               or shorter at the latest UTF-8 character boundary.
        """
...
class AlertPolicyDocumentationLinkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] display_name: A short display name for the link. The display name must not be empty or exceed 63 characters. Example: "playbook".
        :param pulumi.Input[builtins.str] url: The url of a webpage. A url can be templatized by using variables in the path or the query parameters. The total length of a URL should not exceed 2083 characters before and after variable expansion. Example: "https://my_domain.com/playbook?name=${resource.name}".
        """
...
class CustomServiceTelemetryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] resource_name: The full name of the resource that defines this service.
               Formatted as described in
               https://cloud.google.com/apis/design/resource_names.
        """
...
class GenericServiceBasicServiceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] service_labels: Labels that specify the resource that emits the monitoring data
               which is used for SLO reporting of this `Service`.
        :param pulumi.Input[builtins.str] service_type: The type of service that this basic service defines, e.g.
               APP_ENGINE service type
        """
...
class MetricDescriptorLabelArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The key for this label. The key must not exceed 100 characters. The first character of the key must be an upper- or lower-case letter, the remaining characters must be letters, digits or underscores, and the key must match the regular expression [a-zA-Z][a-zA-Z0-9_]*
...
if not MYPY:
    class MetricDescriptorMetadataArgsDict(TypedDict):
        ingest_delay: NotRequired[pulumi.Input[builtins.str]]
        """
        The delay of data points caused by ingestion. Data points older than this age are guaranteed to be ingested and available to be read, excluding data loss due to errors. In `[duration format](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf?&_ga=2.264881487.1507873253.1593446723-935052455.1591817775#google.protobuf.Duration)`.
        """
        sample_period: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MetricDescriptorMetadataArgs:
    def __init__(__self__, *,
                 ingest_delay: Optional[pulumi.Input[builtins.str]] = None,
                 sample_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ingest_delay: The delay of data points caused by ingestion. Data points older than this age are guaranteed to be ingested and available to be read, excluding data loss due to errors. In `[duration format](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf?&_ga=2.264881487.1507873253.1593446723-935052455.1591817775#google.protobuf.Duration)`.
        :param pulumi.Input[builtins.str] sample_period: The sampling period of metric data points. For metrics which are written periodically, consecutive data points are stored at this time interval, excluding data loss due to errors. Metrics with a higher granularity have a smaller sampling period. In `[duration format](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf?&_ga=2.264881487.1507873253.1593446723-935052455.1591817775#google.protobuf.Duration)`.
        """
    ...
    def ingest_delay(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The delay of data points caused by ingestion. Data points older than this age are guaranteed to be ingested and available to be read, excluding data loss due to errors. In `[duration format](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf?&_ga=2.264881487.1507873253.1593446723-935052455.1591817775#google.protobuf.Duration)`.
        """
    ...
    @ingest_delay.setter
    def ingest_delay(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingest_delay", value)

    @property
    @pulumi.getter(name="samplePeriod")
    def sample_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The sampling period of metric data points. For metrics which are written periodically, consecutive data points are stored at this time interval, excluding data loss due to errors. Metrics with a higher granularity have a smaller sampling period. In `[duration format](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf?&_ga=2.264881487.1507873253.1593446723-935052455.1591817775#google.protobuf.Duration)`.
        """
    ...
    def sample_period(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NotificationChannelSensitiveLabelsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] auth_token: An authorization token for a notification channel. Channel types that support this field include: slack
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.str] password: An password for a notification channel. Channel types that support this field include: webhook_basicauth
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.str] service_key: An servicekey token for a notification channel. Channel types that support this field include: pagerduty
               **Note**: This property is sensitive and will not be displayed in the plan.
        """
...
class SloBasicSliArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SloBasicSliLatencyArgs'] latency: Parameters for a latency threshold SLI.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: An optional set of locations to which this SLI is relevant.
               Telemetry from other locations will not be used to calculate
               performance for this SLI. If omitted, this SLI applies to all
               locations in which the Service has activity. For service types
               that don't support breaking down by location, setting this
               field will result in an error.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] methods: An optional set of RPCs to which this SLI is relevant.
               Telemetry from other methods will not be used to calculate
               performance for this SLI. If omitted, this SLI applies to all
               the Service's methods. For service types that don't support
               breaking down by method, setting this field will result in an
               error.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] versions: The set of API versions to which this SLI is relevant.
               Telemetry from other API versions will not be used to
               calculate performance for this SLI. If omitted,
               this SLI applies to all API versions. For service types
               that don't support breaking down by version, setting this
...
class SloBasicSliAvailabilityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether an availability SLI is enabled or not. Must be set to `true. Defaults to `true`.
        """
...
class SloBasicSliLatencyArgs:
    def __init__(__self__, *,
                 threshold: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] threshold: A duration string, e.g. 10s.
               Good service is defined to be the count of requests made to
               this service that return in no more than threshold.
        """
        pulumi.set(__self__, "threshold", threshold)
...
if not MYPY:
    class SloRequestBasedSliDistributionCutArgsDict(TypedDict):
        distribution_filter: pulumi.Input[builtins.str]
        """
...
class SloRequestBasedSliDistributionCutArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] distribution_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
               aggregating values to quantify the good service provided.
               Must have ValueType = DISTRIBUTION and
               MetricKind = DELTA or MetricKind = CUMULATIVE.
    ...
    def distribution_filter(self) -> pulumi.Input[builtins.str]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        aggregating values to quantify the good service provided.
        Must have ValueType = DISTRIBUTION and
    ...
    def distribution_filter(self, value: pulumi.Input[builtins.str]):
...
class SloRequestBasedSliDistributionCutRangeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] max: max value for the range (inclusive). If not given,
               will be set to "infinity", defining an open range
               ">= range.min"
        :param pulumi.Input[builtins.float] min: Min value for the range (inclusive). If not given,
               will be set to "-infinity", defining an open range
               "< range.max"
        """
        if max is not None:
...
if not MYPY:
    class SloRequestBasedSliGoodTotalRatioArgsDict(TypedDict):
        bad_service_filter: NotRequired[pulumi.Input[builtins.str]]
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        ...
        """
        good_service_filter: NotRequired[pulumi.Input[builtins.str]]
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        ...
        must have MetricKind = DELTA or MetricKind = CUMULATIVE.
        """
        total_service_filter: NotRequired[pulumi.Input[builtins.str]]
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
...
class SloRequestBasedSliGoodTotalRatioArgs:
    def __init__(__self__, *,
                 bad_service_filter: Optional[pulumi.Input[builtins.str]] = None,
                 good_service_filter: Optional[pulumi.Input[builtins.str]] = None,
                 total_service_filter: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bad_service_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
               quantifying bad service provided, either demanded service that
               was not provided or demanded service that was of inadequate
               quality. Exactly two of
               good, bad, or total service filter must be defined (where
               ...
               Must have ValueType = DOUBLE or ValueType = INT64 and
               must have MetricKind = DELTA or MetricKind = CUMULATIVE.
        :param pulumi.Input[builtins.str] good_service_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
               quantifying good service provided. Exactly two of
               good, bad, or total service filter must be defined (where
               good + bad = total is assumed)
               Must have ValueType = DOUBLE or ValueType = INT64 and
               must have MetricKind = DELTA or MetricKind = CUMULATIVE.
        :param pulumi.Input[builtins.str] total_service_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
               quantifying total demanded service. Exactly two of
               good, bad, or total service filter must be defined (where
               good + bad = total is assumed)
               Must have ValueType = DOUBLE or ValueType = INT64 and
    ...
    def bad_service_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        quantifying bad service provided, either demanded service that
        was not provided or demanded service that was of inadequate
    ...
    def bad_service_filter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bad_service_filter", value)

    @property
    @pulumi.getter(name="goodServiceFilter")
    def good_service_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        quantifying good service provided. Exactly two of
        good, bad, or total service filter must be defined (where
    ...
    def good_service_filter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "good_service_filter", value)

    @property
    @pulumi.getter(name="totalServiceFilter")
    def total_service_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        quantifying total demanded service. Exactly two of
        good, bad, or total service filter must be defined (where
    ...
    def total_service_filter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_service_filter", value)


if not MYPY:
    class SloWindowsBasedSliArgsDict(TypedDict):
        good_bad_metric_filter: NotRequired[pulumi.Input[builtins.str]]
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        ...
        Structure is documented below.
        """
        window_period: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SloWindowsBasedSliArgs:
    def __init__(__self__, *,
                 good_bad_metric_filter: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 window_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] good_bad_metric_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
               with ValueType = BOOL. The window is good if any true values
               appear in the window. One of `good_bad_metric_filter`,
               `good_total_ratio_threshold`, `metric_mean_in_range`,
               `metric_sum_in_range` must be set for `windows_based_sli`.
        ...
        :param pulumi.Input['SloWindowsBasedSliMetricSumInRangeArgs'] metric_sum_in_range: Criterion that describes a window as good if the metric's value
               ...
               `metric_sum_in_range` must be set for `windows_based_sli`.
               Structure is documented below.
        :param pulumi.Input[builtins.str] window_period: Duration over which window quality is evaluated, given as a
               duration string "{X}s" representing X seconds. Must be an
               integer fraction of a day and at least 60s.
        """
    ...
    def good_bad_metric_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        with ValueType = BOOL. The window is good if any true values
        appear in the window. One of `good_bad_metric_filter`,
    ...
    def good_bad_metric_filter(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def window_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Duration over which window quality is evaluated, given as a
        duration string "{X}s" representing X seconds. Must be an
        integer fraction of a day and at least 60s.
    ...
    def window_period(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SloWindowsBasedSliGoodTotalRatioThresholdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SloWindowsBasedSliGoodTotalRatioThresholdPerformanceArgs'] performance: Request-based SLI to evaluate to judge window quality.
               Structure is documented below.
        :param pulumi.Input[builtins.float] threshold: If window performance >= threshold, the window is counted
               as good.
        """
...
if not MYPY:
    class SloWindowsBasedSliMetricMeanInRangeArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        time_series: pulumi.Input[builtins.str]
        """
...
class SloWindowsBasedSliMetricMeanInRangeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SloWindowsBasedSliMetricMeanInRangeRangeArgs'] range: Range of numerical values. The computed good_service
               ...
               good service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] time_series: A [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
               specifying the TimeSeries to use for evaluating window
               The provided TimeSeries must have ValueType = INT64 or
               ValueType = DOUBLE and MetricKind = GAUGE. Mean value `X`
               should satisfy `range.min <= X <= range.max`
    ...
    def time_series(self) -> pulumi.Input[builtins.str]:
        """
        A [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        specifying the TimeSeries to use for evaluating window
        The provided TimeSeries must have ValueType = INT64 or
    ...
    @time_series.setter
    def time_series(self, value: pulumi.Input[builtins.str]):
...
class UptimeCheckConfigContentMatcherArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content: String or regex content to match (max 1024 bytes)
        :param pulumi.Input['UptimeCheckConfigContentMatcherJsonPathMatcherArgs'] json_path_matcher: Information needed to perform a JSONPath content match. Used for `ContentMatcherOption::MATCHES_JSON_PATH` and `ContentMatcherOption::NOT_MATCHES_JSON_PATH`.
               Structure is documented below.
        :param pulumi.Input[builtins.str] matcher: The type of content matcher that will be applied to the server output, compared to the content string when the check is run.
               Default value is `CONTAINS_STRING`.
               Possible values are: `CONTAINS_STRING`, `NOT_CONTAINS_STRING`, `MATCHES_REGEX`, `NOT_MATCHES_REGEX`, `MATCHES_JSON_PATH`, `NOT_MATCHES_JSON_PATH`.
        """
        pulumi.set(__self__, "content", content)
...
if not MYPY:
    class UptimeCheckConfigContentMatcherJsonPathMatcherArgsDict(TypedDict):
        ...
        """
        json_matcher: NotRequired[pulumi.Input[builtins.str]]
        """
...
class UptimeCheckConfigContentMatcherJsonPathMatcherArgs:
    def __init__(__self__, *,
                 json_path: pulumi.Input[builtins.str],
                 json_matcher: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] json_path: JSONPath within the response output pointing to the expected `ContentMatcher::content` to match against.
        :param pulumi.Input[builtins.str] json_matcher: Options to perform JSONPath content matching.
               Default value is `EXACT_MATCH`.
               Possible values are: `EXACT_MATCH`, `REGEX_MATCH`.
        """
    ...
    def json_matcher(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Options to perform JSONPath content matching.
        Default value is `EXACT_MATCH`.
        Possible values are: `EXACT_MATCH`, `REGEX_MATCH`.
    ...
    @json_matcher.setter
    def json_matcher(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class UptimeCheckConfigHttpCheckArgsDict(TypedDict):
        ...
        """
        custom_content_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        mask_headers: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        validate_ssl: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class UptimeCheckConfigHttpCheckArgs:
    def __init__(__self__, *,
                 ...
                 custom_content_type: Optional[pulumi.Input[builtins.str]] = None,
                 headers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 mask_headers: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input['UptimeCheckConfigHttpCheckAuthInfoArgs'] auth_info: The authentication information using username and password. Optional when creating an HTTP check; defaults to empty. Do not use with other authentication fields.
               Structure is documented below.
        :param pulumi.Input[builtins.str] body: The request body associated with the HTTP POST request. If `content_type` is `URL_ENCODED`, the body passed in must be URL-encoded. Users can provide a `Content-Length` header via the `headers` field or the API will do so. If the `request_method` is `GET` and `body` is not empty, the API will return an error. The maximum byte size is 1 megabyte. Note - As with all bytes fields JSON representations are base64 encoded. e.g. `foo=bar` in URL-encoded form is `foo%3Dbar` and in base64 encoding is `Zm9vJTI1M0RiYXI=`.
        :param pulumi.Input[builtins.str] content_type: The content type to use for the check.
               Possible values are: `TYPE_UNSPECIFIED`, `URL_ENCODED`, `USER_PROVIDED`.
        :param pulumi.Input[builtins.str] custom_content_type: A user provided content type header to use for the check. The invalid configurations outlined in the `content_type` field apply to custom_content_type`, as well as the following 1. `content_type` is `URL_ENCODED` and `custom_content_type` is set. 2. `content_type` is `USER_PROVIDED` and `custom_content_type` is not set.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: The list of headers to send as part of the uptime check request. If two headers have the same key and different values, they should be entered as a single header, with the value being a comma-separated list of all the desired values as described in [RFC 2616 (page 31)](https://www.w3.org/Protocols/rfc2616/rfc2616.txt). Entering two separate headers with the same key in a Create call will cause the first to be overwritten by the second. The maximum number of headers allowed is 100.
        :param pulumi.Input[builtins.bool] mask_headers: Boolean specifying whether to encrypt the header information. Encryption should be specified for any headers related to authentication that you do not wish to be seen when retrieving the configuration. The server will be responsible for encrypting the headers. On Get/List calls, if `mask_headers` is set to `true` then the headers will be obscured with `******`.
        :param pulumi.Input[builtins.str] path: The path to the page to run the check against. Will be combined with the host (specified within the MonitoredResource) and port to construct the full URL. If the provided path does not begin with `/`, a `/` will be prepended automatically. Optional (defaults to `/`).
        :param pulumi.Input['UptimeCheckConfigHttpCheckPingConfigArgs'] ping_config: Contains information needed to add pings to an HTTP check.
               Structure is documented below.
        :param pulumi.Input[builtins.int] port: The port to the page to run the check against. Will be combined with `host` (specified within the `monitored_resource`) and path to construct the full URL. Optional (defaults to 80 without SSL, or 443 with SSL).
        :param pulumi.Input[builtins.str] request_method: The HTTP request method to use for the check. If set to `METHOD_UNSPECIFIED` then `request_method` defaults to `GET`.
               Default value is `GET`.
               Possible values are: `METHOD_UNSPECIFIED`, `GET`, `POST`.
        :param pulumi.Input['UptimeCheckConfigHttpCheckServiceAgentAuthenticationArgs'] service_agent_authentication: The authentication information using the Monitoring Service Agent. Optional when creating an HTTPS check; defaults to empty. Do not use with other authentication fields.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] use_ssl: If true, use HTTPS instead of HTTP to run the check.
        :param pulumi.Input[builtins.bool] validate_ssl: Boolean specifying whether to include SSL certificate validation as a part of the Uptime check. Only applies to checks where `monitored_resource` is set to `uptime_url`. If `use_ssl` is `false`, setting `validate_ssl` to `true` has no effect.
        """
    ...
    def custom_content_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A user provided content type header to use for the check. The invalid configurations outlined in the `content_type` field apply to custom_content_type`, as well as the following 1. `content_type` is `URL_ENCODED` and `custom_content_type` is set. 2. `content_type` is `USER_PROVIDED` and `custom_content_type` is not set.
        """
    ...
    def custom_content_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mask_headers(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Boolean specifying whether to encrypt the header information. Encryption should be specified for any headers related to authentication that you do not wish to be seen when retrieving the configuration. The server will be responsible for encrypting the headers. On Get/List calls, if `mask_headers` is set to `true` then the headers will be obscured with `******`.
        """
    ...
    @mask_headers.setter
    def mask_headers(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class UptimeCheckConfigHttpCheckAcceptedResponseStatusCodeArgsDict(TypedDict):
        status_class: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        status_value: NotRequired[pulumi.Input[builtins.int]]
        """
...
class UptimeCheckConfigHttpCheckAcceptedResponseStatusCodeArgs:
    def __init__(__self__, *,
                 status_class: Optional[pulumi.Input[builtins.str]] = None,
                 status_value: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] status_class: A class of status codes to accept.
               Possible values are: `STATUS_CLASS_1XX`, `STATUS_CLASS_2XX`, `STATUS_CLASS_3XX`, `STATUS_CLASS_4XX`, `STATUS_CLASS_5XX`, `STATUS_CLASS_ANY`.
        :param pulumi.Input[builtins.int] status_value: A status code to accept.
        """
    ...
    def status_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A class of status codes to accept.
        Possible values are: `STATUS_CLASS_1XX`, `STATUS_CLASS_2XX`, `STATUS_CLASS_3XX`, `STATUS_CLASS_4XX`, `STATUS_CLASS_5XX`, `STATUS_CLASS_ANY`.
        """
    ...
    @status_class.setter
    def status_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "status_class", value)

    @property
    @pulumi.getter(name="statusValue")
    def status_value(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        A status code to accept.
        """
    ...
    @status_value.setter
    def status_value(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class UptimeCheckConfigHttpCheckPingConfigArgsDict(TypedDict):
        pings_count: pulumi.Input[builtins.int]
        """
...
class UptimeCheckConfigHttpCheckPingConfigArgs:
    def __init__(__self__, *,
                 pings_count: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] pings_count: Number of ICMP pings. A maximum of 3 ICMP pings is currently supported.
        """
        pulumi.set(__self__, "pings_count", pings_count)

    @property
    @pulumi.getter(name="pingsCount")
    def pings_count(self) -> pulumi.Input[builtins.int]:
        """
        Number of ICMP pings. A maximum of 3 ICMP pings is currently supported.
        """
    ...
    @pings_count.setter
    def pings_count(self, value: pulumi.Input[builtins.int]):
...
class UptimeCheckConfigHttpCheckServiceAgentAuthenticationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of authentication to use.
               Possible values are: `SERVICE_AGENT_AUTHENTICATION_TYPE_UNSPECIFIED`, `OIDC_TOKEN`.
        """
        if type is not None:
...
class UptimeCheckConfigMonitoredResourceArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Values for all of the labels listed in the associated monitored resource descriptor. For example, Compute Engine VM instances use the labels `project_id`, `instance_id`, and `zone`.
        :param pulumi.Input[builtins.str] type: The monitored resource type. This field must match the type field of a [`MonitoredResourceDescriptor`](https://cloud.google.com/monitoring/api/ref_v3/rest/v3/projects.monitoredResourceDescriptors#MonitoredResourceDescriptor) object. For example, the type of a Compute Engine VM instance is `gce_instance`. For a list of types, see [Monitoring resource types](https://cloud.google.com/monitoring/api/resources) and [Logging resource types](https://cloud.google.com/logging/docs/api/v2/resource-list).
        """
        pulumi.set(__self__, "labels", labels)
        pulumi.set(__self__, "type", type)
...
class UptimeCheckConfigResourceGroupArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] group_id: The group of resources being monitored. Should be the `name` of a group
        :param pulumi.Input[builtins.str] resource_type: The resource type of the group members.
               Possible values are: `RESOURCE_TYPE_UNSPECIFIED`, `INSTANCE`, `AWS_ELB_LOAD_BALANCER`.
        """
...
class UptimeCheckConfigTcpCheckArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] port: The port to the page to run the check against. Will be combined with host (specified within the `monitored_resource`) to construct the full URL.
