...
class MetricDescriptorArgs:
    def __init__(__self__, *,
                 ...
                 labels: pulumi.Input[Optional[Sequence[pulumi.Input['MetricDescriptorLabelArgs']]]] = None,
                 launch_stage: pulumi.Input[Optional[_builtins.str]] = None,
                 metadata: pulumi.Input[Optional['MetricDescriptorMetadataArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] value_type: Whether the measurement is an integer, a floating-point number, etc. Some combinations of metricKind and valueType might not be supported.
        ...
        :param pulumi.Input[_builtins.str] unit: The units in which the metric value is reported. It is only applicable if the
    ...
    @_builtins.property
    @pulumi.getter
    def labels(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MetricDescriptorLabelArgs']]]]:
        """
    ...
    @labels.setter
    def labels(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MetricDescriptorLabelArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def metadata(self) -> pulumi.Input[Optional['MetricDescriptorMetadataArgs']]:
        """
    ...
    @metadata.setter
    def metadata(self, value: pulumi.Input[Optional['MetricDescriptorMetadataArgs']]):
...
class _MetricDescriptorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] metric_kind: Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metricKind and valueType might not be supported.
               Possible values are: `METRIC_KIND_UNSPECIFIED`, `GAUGE`, `DELTA`, `CUMULATIVE`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] monitored_resource_types: If present, then a time series, which is identified partially by a metric type and a MonitoredResourceDescriptor, that is associated with this metric type can only be associated with one of the monitored resource types listed here. This field allows time series to be associated with the intersection of this metric type and the monitored resource types in this list.
        :param pulumi.Input[_builtins.str] name: The resource name of the metric descriptor.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] type: The metric type, including its DNS name prefix. The type is not URL-encoded. All service defined metrics must be prefixed with the service name, in the format of {service name}/{relative metric name}, such as cloudsql.googleapis.com/database/cpu/utilization. The relative metric name must have only upper and lower-case letters, digits, '/' and underscores '_' are allowed. Additionally, the maximum number of characters allowed for the relative_metric_name is 100. All user-defined metric types have the DNS name custom.googleapis.com, external.googleapis.com, or logging.googleapis.com/user/.
        :param pulumi.Input[_builtins.str] unit: The units in which the metric value is reported. It is only applicable if the
    ...
    @_builtins.property
    @pulumi.getter(name="metricKind")
    def metric_kind(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Whether the metric records instantaneous values, changes to a value, etc. Some combinations of metricKind and valueType might not be supported.
        Possible values are: `METRIC_KIND_UNSPECIFIED`, `GAUGE`, `DELTA`, `CUMULATIVE`.
        """
    ...
    @metric_kind.setter
    def metric_kind(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "metric_kind", value)

    @_builtins.property
    @pulumi.getter(name="monitoredResourceTypes")
    def monitored_resource_types(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def monitored_resource_types(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class MetricDescriptor(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: pulumi.Input[Optional[_builtins.str]] = None,
            unit: pulumi.Input[Optional[_builtins.str]] = None,
            value_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'MetricDescriptor':
        """
