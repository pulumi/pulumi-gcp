...
class GetAppEngineServiceResult:
    ...
    """
    def __init__(__self__, deletion_policy=None, display_name=None, id=None, module_id=None, name=None, project=None, service_id=None, telemetries=None, user_labels=None):
...
def get_app_engine_service(module_id: Optional[_builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param _builtins.str module_id: The ID of the App Engine module underlying this
...
def get_app_engine_service_output(module_id: pulumi.Input[Optional[_builtins.str]] = None,
