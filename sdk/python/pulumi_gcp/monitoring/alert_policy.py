...
class AlertPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_channels: Identifies the notification channels to which notifications should be
        ...
        :param pulumi.Input[builtins.str] severity: The severity of an alert policy indicates how important incidents generated
