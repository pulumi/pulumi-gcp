...
class AlertPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AlertPolicyDocumentationArgs'] documentation: Documentation that is included with notifications and incidents related
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] enabled: Whether or not the policy is enabled. The default is true.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notification_channels: Identifies the notification channels to which notifications should be
        ...
        :param pulumi.Input[_builtins.str] severity: The severity of an alert policy indicates how important incidents generated
...
class _AlertPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AlertPolicyDocumentationArgs'] documentation: Documentation that is included with notifications and incidents related
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] enabled: Whether or not the policy is enabled. The default is true.
        :param pulumi.Input[_builtins.str] name: The unique resource name for this policy.
