...
class AlertPolicyArgs:
    def __init__(__self__, *,
                 combiner: pulumi.Input[builtins.str],
                 ...
                 notification_channels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] combiner: How to combine the results of multiple conditions to
        ...
        :param pulumi.Input[builtins.str] display_name: A short name or phrase used to identify the policy in
        ...
        :param pulumi.Input['AlertPolicyDocumentationArgs'] documentation: Documentation that is included with notifications and incidents related to this policy. Best practice is for the
               ...
               documentation.
        :param pulumi.Input[builtins.bool] enabled: Whether or not the policy is enabled. The default is true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_channels: Identifies the notification channels to which notifications should be sent when incidents are opened or closed or when
        ...
        :param pulumi.Input[builtins.str] severity: The severity of an alert policy indicates how important incidents generated by that policy are. The severity level will
               be displayed on the Incident detail page and in notifications. Possible values: ["CRITICAL", "ERROR", "WARNING"]
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] user_labels: This field is intended to be used for organizing and identifying the AlertPolicy objects.The field can contain up to 64
    ...
    @property
    @pulumi.getter
    def combiner(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @combiner.setter
    def combiner(self, value: pulumi.Input[builtins.str]):
    ...
    def notification_channels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def notification_channels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AlertPolicyState:
    def __init__(__self__, *,
                 alert_strategy: Optional[pulumi.Input['AlertPolicyAlertStrategyArgs']] = None,
                 combiner: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['AlertPolicyDocumentationArgs'] documentation: Documentation that is included with notifications and incidents related to this policy. Best practice is for the
               ...
               documentation.
        :param pulumi.Input[builtins.bool] enabled: Whether or not the policy is enabled. The default is true.
        :param pulumi.Input[builtins.str] name: The unique resource name for this policy.
    ...
    @property
    @pulumi.getter
    def combiner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        How to combine the results of multiple conditions to
        determine if an incident should be opened.
        Possible values are: `AND`, `OR`, `AND_WITH_MATCHING_RESOURCE`.
    ...
    @combiner.setter
    def combiner(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "combiner", value)
...
class AlertPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            severity: Optional[pulumi.Input[builtins.str]] = None,
            user_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'AlertPolicy':
        """
    ...
    @property
    @pulumi.getter
    def combiner(self) -> pulumi.Output[builtins.str]:
        """
        How to combine the results of multiple conditions to
        determine if an incident should be opened.
        Possible values are: `AND`, `OR`, `AND_WITH_MATCHING_RESOURCE`.
    ...
    @property
    @pulumi.getter(name="notificationChannels")
    def notification_channels(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Identifies the notification channels to which notifications should be sent when incidents are opened or closed or when
        new violations occur on an already opened incident. Each element of this array corresponds to the name field in each of
        the NotificationChannel objects that are returned from the notificationChannels.list method. The syntax of the entries
