...
class SloArgs:
    def __init__(__self__, *,
                 goal: pulumi.Input[builtins.float],
                 ...
                 rolling_period_days: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] calendar_period: A calendar period, semantically "since the start of the current
               <calendarPeriod>".
               Possible values are: `DAY`, `WEEK`, `FORTNIGHT`, `MONTH`.
        :param pulumi.Input[builtins.str] display_name: Name used for UI elements listing this SLO.
    ...
    @property
    @pulumi.getter
    def goal(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @goal.setter
    def goal(self, value: pulumi.Input[builtins.float]):
    ...
    def rolling_period_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def rolling_period_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _SloState:
    def __init__(__self__, *,
                 ...
                 calendar_period: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 goal: Optional[pulumi.Input[builtins.float]] = None,
    ...
    @property
    @pulumi.getter
    def goal(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The fraction of service that must be good in order for this objective
        to be met. 0 < goal <= 0.999
        """
    ...
    @goal.setter
    def goal(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "goal", value)
...
class Slo(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="calendarPeriod")
    def calendar_period(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A calendar period, semantically "since the start of the current
        <calendarPeriod>".
        Possible values are: `DAY`, `WEEK`, `FORTNIGHT`, `MONTH`.
    ...
    @property
    @pulumi.getter
    def goal(self) -> pulumi.Output[builtins.float]:
        """
        The fraction of service that must be good in order for this objective
        to be met. 0 < goal <= 0.999
        """
    ...
    @property
    @pulumi.getter(name="rollingPeriodDays")
    def rolling_period_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        A rolling time period, semantically "in the past X days".
        Must be between 1 to 30 days, inclusive.
        """
