...
class SloArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SloRequestBasedSliArgs'] request_based_sli: A request-based SLI defines a SLI for which atomic units of
               ...
               `basic_sli`, `request_based_sli`, `windows_based_sli`
               Structure is documented below.
        :param pulumi.Input[_builtins.int] rolling_period_days: A rolling time period, semantically "in the past X days".
               Must be between 1 to 30 days, inclusive.
        :param pulumi.Input[_builtins.str] slo_id: The id to use for this ServiceLevelObjective. If omitted, an id will be generated instead.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] user_labels: This field is intended to be used for organizing and identifying the AlertPolicy
    ...
    @goal.setter
    def goal(self, value: pulumi.Input[_builtins.float]):
