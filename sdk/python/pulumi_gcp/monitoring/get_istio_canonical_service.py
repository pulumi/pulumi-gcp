...
def get_istio_canonical_service(canonical_service: Optional[builtins.str] = None,
                                canonical_service_namespace: Optional[builtins.str] = None,
                                mesh_uid: Optional[builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param builtins.str canonical_service: The name of the canonical service underlying this service.
           Corresponds to the destination_canonical_service_name metric label in label in Istio metrics.
           
           - - -
           
           Other optional fields include:
    :param builtins.str canonical_service_namespace: The namespace of the canonical service underlying this service.
           Corresponds to the destination_canonical_service_namespace metric label in Istio metrics.
    :param builtins.str mesh_uid: Identifier for the mesh in which this Istio service is defined.
...
def get_istio_canonical_service_output(canonical_service: Optional[pulumi.Input[builtins.str]] = None,
                                       canonical_service_namespace: Optional[pulumi.Input[builtins.str]] = None,
                                       mesh_uid: Optional[pulumi.Input[builtins.str]] = None,
