...
class AlertPolicyConditionConditionSqlRowCountTest(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str comparison: The comparison to apply between the time series
...
@pulumi.output_type
class SnoozeCriteria(dict):
    def __init__(__self__, *,
                 filter: Optional[_builtins.str] = None,
                 policies: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str filter: When you define a snooze, you can also define a filter for that snooze.
        ...
        :param Sequence[_builtins.str] policies: The specific AlertPolicy names for the alert that should be snoozed.
...
class SnoozeInterval(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SnoozeInterval. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SnoozeInterval.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str end_time: The end of the time interval.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and
               up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and
               "2014-10-02T15:01:23.045123456Z".
        :param _builtins.str start_time: The beginning of the time interval. The default value for the start time
