...
class AlertPolicyAlertStrategy(dict):
    ...
    def __init__(__self__, *,
                 auto_close: Optional[builtins.str] = None,
                 notification_channel_strategies: Optional[Sequence['outputs.AlertPolicyAlertStrategyNotificationChannelStrategy']] = None,
                 notification_prompts: Optional[Sequence[builtins.str]] = None,
                 notification_rate_limit: Optional['outputs.AlertPolicyAlertStrategyNotificationRateLimit'] = None):
        """
        :param builtins.str auto_close: If an alert policy that was active has no data for this long, any open incidents will close.
        ...
        :param Sequence[builtins.str] notification_prompts: Control when notifications will be sent out.
    ...
    def auto_close(self) -> Optional[builtins.str]:
        """
    ...
    def notification_prompts(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AlertPolicyAlertStrategyNotificationChannelStrategy(dict):
    ...
    def __init__(__self__, *,
                 notification_channel_names: Optional[Sequence[builtins.str]] = None,
                 renotify_interval: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] notification_channel_names: The notification channels that these settings apply to. Each of these
               correspond to the name field in one of the NotificationChannel objects
               referenced in the notification_channels field of this AlertPolicy. The format is
               `projects/[PROJECT_ID_OR_NUMBER]/notificationChannels/[CHANNEL_ID]`
        :param builtins.str renotify_interval: The frequency at which to send reminder notifications for open incidents.
        """
    ...
    def notification_channel_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def renotify_interval(self) -> Optional[builtins.str]:
        """
...
class AlertPolicyAlertStrategyNotificationRateLimit(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str period: Not more than one notification per period.
...
class AlertPolicyCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str display_name: A short name or phrase used to identify the
...
class AlertPolicyConditionConditionAbsent(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str duration: The amount of time that a time series must
        ...
        :param Sequence['AlertPolicyConditionConditionAbsentAggregationArgs'] aggregations: Specifies the alignment of data points in
               ...
               order specified.
               Structure is documented below.
        :param builtins.str filter: A filter that identifies which time series
...
class AlertPolicyConditionConditionAbsentAggregation(dict):
    ...
    def __init__(__self__, *,
                 alignment_period: Optional[builtins.str] = None,
                 cross_series_reducer: Optional[builtins.str] = None,
                 group_by_fields: Optional[Sequence[builtins.str]] = None,
                 per_series_aligner: Optional[builtins.str] = None):
        """
        :param builtins.str alignment_period: The alignment period for per-time
        ...
        :param builtins.str cross_series_reducer: The approach to be used to combine
        ...
        :param Sequence[builtins.str] group_by_fields: The set of fields to preserve when
               crossSeriesReducer is specified.
               ...
               ignored.
        :param builtins.str per_series_aligner: The approach to be used to align
    ...
    def alignment_period(self) -> Optional[builtins.str]:
        """
    ...
    def cross_series_reducer(self) -> Optional[builtins.str]:
        """
    ...
    def per_series_aligner(self) -> Optional[builtins.str]:
        """
...
class AlertPolicyConditionConditionAbsentTrigger(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The absolute number of time series
               that must fail the predicate for the
               condition to be triggered.
        :param builtins.float percent: The percentage of time series that
...
class AlertPolicyConditionConditionMatchedLog(dict):
    ...
    def __init__(__self__, *,
                 filter: builtins.str,
                 label_extractors: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str filter: A logs-based filter.
        :param Mapping[str, builtins.str] label_extractors: A map from a label key to an extractor expression, which is used to
    ...
    def label_extractors(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class AlertPolicyConditionConditionMonitoringQueryLanguage(dict):
    ...
    def __init__(__self__, *,
                 duration: builtins.str,
                 query: builtins.str,
                 evaluation_missing_data: Optional[builtins.str] = None,
        ...
        :param builtins.str duration: The amount of time that a time series must
               ...
               alerted on quickly.
        :param builtins.str query: Monitoring Query Language query that outputs a boolean stream.
        :param builtins.str evaluation_missing_data: A condition control that determines how
    ...
    def evaluation_missing_data(self) -> Optional[builtins.str]:
        """
...
class AlertPolicyConditionConditionPrometheusQueryLanguage(dict):
    ...
    def __init__(__self__, *,
                 query: builtins.str,
                 alert_rule: Optional[builtins.str] = None,
                 disable_metric_validation: Optional[builtins.bool] = None,
                 duration: Optional[builtins.str] = None,
                 evaluation_interval: Optional[builtins.str] = None,
                 labels: Optional[Mapping[str, builtins.str]] = None,
                 rule_group: Optional[builtins.str] = None):
        """
        :param builtins.str query: The PromQL expression to evaluate. Every evaluation cycle this
               expression is evaluated at the current time, and all resultant time
               series become pending/firing alerts. This field must not be empty.
        :param builtins.str alert_rule: The alerting rule name of this alert in the corresponding Prometheus
               configuration file.
        ...
        :param builtins.str duration: Alerts are considered firing once their PromQL expression evaluated
               to be "true" for this long. Alerts whose PromQL expression was not
               evaluated to be "true" for long enough are considered pending. The
               default value is zero. Must be zero or positive.
        :param builtins.str evaluation_interval: How often this rule should be evaluated. Must be a positive multiple
               of 30 seconds or missing. The default value is 30 seconds. If this
               PrometheusQueryLanguageCondition was generated from a Prometheus
               alerting rule, then this value should be taken from the enclosing
               rule group.
        :param Mapping[str, builtins.str] labels: Labels to add to or overwrite in the PromQL query result. Label names
               must be valid.
        ...
        :param builtins.str rule_group: The rule group name of this alert in the corresponding Prometheus
               configuration file.
               Some external tools may require this field to be populated correctly
               in order to refer to the original Prometheus configuration file.
               The rule group name and the alert name are necessary to update the
    ...
    def alert_rule(self) -> Optional[builtins.str]:
        """
    ...
    def disable_metric_validation(self) -> Optional[builtins.bool]:
    ...
    def rule_group(self) -> Optional[builtins.str]:
        """
...
class AlertPolicyConditionConditionSql(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str query: The Log Analytics SQL query to run, as a string.  The query must
...
class AlertPolicyConditionConditionSqlDaily(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int periodicity: The number of days between runs. Must be greater than or equal
    ...
    @property
    @pulumi.getter
    def periodicity(self) -> builtins.int:
        """
...
class AlertPolicyConditionConditionSqlDailyExecutionTime(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int hours: Hours of a day in 24 hour format. Must be greater than or equal
               to 0 and typically must be less than or equal to 23. An API may
               choose to allow the value "24:00:00" for scenarios like business
               closing time.
        :param builtins.int minutes: Minutes of an hour. Must be greater than or equal to 0 and
               less than or equal to 59.
        :param builtins.int nanos: Fractions of seconds, in nanoseconds. Must be greater than or
               equal to 0 and less than or equal to 999,999,999.
        :param builtins.int seconds: Seconds of a minute. Must be greater than or equal to 0 and
...
class AlertPolicyConditionConditionSqlHourly(dict):
    ...
    def __init__(__self__, *,
                 periodicity: builtins.int,
                 minute_offset: Optional[builtins.int] = None):
        """
        :param builtins.int periodicity: Number of hours between runs. The interval must be greater than or
               equal to 1 hour and less than or equal to 48 hours.
        :param builtins.int minute_offset: The number of minutes after the hour (in UTC) to run the query.
    ...
    def minute_offset(self) -> Optional[builtins.int]:
        """
...
class AlertPolicyConditionConditionSqlMinutes(dict):
    def __init__(__self__, *,
                 periodicity: builtins.int):
        """
        :param builtins.int periodicity: Number of minutes between runs. The interval must be greater than or
...
class AlertPolicyConditionConditionSqlRowCountTest(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str comparison: The comparison to apply between the time
        ...
        :param builtins.int threshold: The value against which to compare the row count.
        """
...
class AlertPolicyConditionConditionThreshold(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['AlertPolicyConditionConditionThresholdDenominatorAggregationArgs'] denominator_aggregations: Specifies the alignment of data points in
               ...
               Structure is documented below.
        :param builtins.str denominator_filter: A filter that identifies a time series that
        ...
        :param 'AlertPolicyConditionConditionThresholdForecastOptionsArgs' forecast_options: When this field is present, the `MetricThreshold`
               ...
               Structure is documented below.
        :param builtins.float threshold_value: A value against which to compare the time
               series.
    ...
    def denominator_filter(self) -> Optional[builtins.str]:
        """
    ...
    def threshold_value(self) -> Optional[builtins.float]:
        """
...
class AlertPolicyConditionConditionThresholdForecastOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str forecast_horizon: The length of time into the future to forecast
...
class AlertPolicyCreationRecord(dict):
    ...
    def __init__(__self__, *,
                 mutate_time: Optional[builtins.str] = None,
                 mutated_by: Optional[builtins.str] = None):
        """
        :param builtins.str mutate_time: (Output)
               When the change occurred.
        :param builtins.str mutated_by: (Output)
    ...
    def mutate_time(self) -> Optional[builtins.str]:
        """
        (Output)
        When the change occurred.
        """
    ...
    def mutated_by(self) -> Optional[builtins.str]:
        """
        (Output)
        The email address of the user making the change.
        """
...
class AlertPolicyDocumentation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content: The text of the documentation, interpreted according to mimeType.
        ...
        :param Sequence['AlertPolicyDocumentationLinkArgs'] links: Links to content such as playbooks, repositories, and other resources. This field can contain up to 3 entries.
               Structure is documented below.
        :param builtins.str mime_type: The format of the content field. Presently, only the value
               "text/markdown" is supported.
        :param builtins.str subject: The subject line of the notification. The subject line may not
...
class AlertPolicyDocumentationLink(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str display_name: A short display name for the link. The display name must not be empty or exceed 63 characters. Example: "playbook".
        :param builtins.str url: The url of a webpage. A url can be templatized by using variables in the path or the query parameters. The total length of a URL should not exceed 2083 characters before and after variable expansion. Example: "https://my_domain.com/playbook?name=${resource.name}".
        """
...
class CustomServiceTelemetry(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_name: The full name of the resource that defines this service.
...
class GenericServiceBasicService(dict):
    ...
    def __init__(__self__, *,
                 service_labels: Optional[Mapping[str, builtins.str]] = None,
                 service_type: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] service_labels: Labels that specify the resource that emits the monitoring data
               which is used for SLO reporting of this `Service`.
        :param builtins.str service_type: The type of service that this basic service defines, e.g.
    ...
    def service_labels(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class MetricDescriptorLabel(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The key for this label. The key must not exceed 100 characters. The first character of the key must be an upper- or lower-case letter, the remaining characters must be letters, digits or underscores, and the key must match the regular expression [a-zA-Z][a-zA-Z0-9_]*
...
class MetricDescriptorMetadata(dict):
    ...
    def __init__(__self__, *,
                 ingest_delay: Optional[builtins.str] = None,
                 sample_period: Optional[builtins.str] = None):
        """
        :param builtins.str ingest_delay: The delay of data points caused by ingestion. Data points older than this age are guaranteed to be ingested and available to be read, excluding data loss due to errors. In `[duration format](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf?&_ga=2.264881487.1507873253.1593446723-935052455.1591817775#google.protobuf.Duration)`.
        :param builtins.str sample_period: The sampling period of metric data points. For metrics which are written periodically, consecutive data points are stored at this time interval, excluding data loss due to errors. Metrics with a higher granularity have a smaller sampling period. In `[duration format](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf?&_ga=2.264881487.1507873253.1593446723-935052455.1591817775#google.protobuf.Duration)`.
        """
    ...
    def ingest_delay(self) -> Optional[builtins.str]:
        """
    ...
    def sample_period(self) -> Optional[builtins.str]:
        """
...
class NotificationChannelSensitiveLabels(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str auth_token: An authorization token for a notification channel. Channel types that support this field include: slack
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param builtins.str password: An password for a notification channel. Channel types that support this field include: webhook_basicauth
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param builtins.str service_key: An servicekey token for a notification channel. Channel types that support this field include: pagerduty
               **Note**: This property is sensitive and will not be displayed in the plan.
        """
...
class SloBasicSli(dict):
    def __init__(__self__, *,
        ...
        :param 'SloBasicSliLatencyArgs' latency: Parameters for a latency threshold SLI.
               Structure is documented below.
        :param Sequence[builtins.str] locations: An optional set of locations to which this SLI is relevant.
               Telemetry from other locations will not be used to calculate
               performance for this SLI. If omitted, this SLI applies to all
               locations in which the Service has activity. For service types
               that don't support breaking down by location, setting this
               field will result in an error.
        :param Sequence[builtins.str] methods: An optional set of RPCs to which this SLI is relevant.
               Telemetry from other methods will not be used to calculate
               performance for this SLI. If omitted, this SLI applies to all
               the Service's methods. For service types that don't support
               breaking down by method, setting this field will result in an
               error.
        :param Sequence[builtins.str] versions: The set of API versions to which this SLI is relevant.
...
class SloBasicSliAvailability(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether an availability SLI is enabled or not. Must be set to `true. Defaults to `true`.
        """
...
class SloBasicSliLatency(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str threshold: A duration string, e.g. 10s.
...
class SloRequestBasedSliDistributionCut(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str distribution_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
...
class SloRequestBasedSliDistributionCutRange(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float max: max value for the range (inclusive). If not given,
               will be set to "infinity", defining an open range
               ">= range.min"
        :param builtins.float min: Min value for the range (inclusive). If not given,
               will be set to "-infinity", defining an open range
               "< range.max"
        """
        if max is not None:
...
class SloRequestBasedSliGoodTotalRatio(dict):
    ...
    def __init__(__self__, *,
                 bad_service_filter: Optional[builtins.str] = None,
                 good_service_filter: Optional[builtins.str] = None,
                 total_service_filter: Optional[builtins.str] = None):
        """
        :param builtins.str bad_service_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        ...
        :param builtins.str good_service_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
               quantifying good service provided. Exactly two of
               good, bad, or total service filter must be defined (where
               good + bad = total is assumed)
               Must have ValueType = DOUBLE or ValueType = INT64 and
               must have MetricKind = DELTA or MetricKind = CUMULATIVE.
        :param builtins.str total_service_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
    ...
    def bad_service_filter(self) -> Optional[builtins.str]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        quantifying bad service provided, either demanded service that
        was not provided or demanded service that was of inadequate
    ...
    def good_service_filter(self) -> Optional[builtins.str]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        quantifying good service provided. Exactly two of
        good, bad, or total service filter must be defined (where
    ...
    def total_service_filter(self) -> Optional[builtins.str]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        quantifying total demanded service. Exactly two of
        good, bad, or total service filter must be defined (where
...
class SloWindowsBasedSli(dict):
    ...
    def __init__(__self__, *,
                 good_bad_metric_filter: Optional[builtins.str] = None,
                 ...
                 window_period: Optional[builtins.str] = None):
        """
        :param builtins.str good_bad_metric_filter: A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        ...
        :param 'SloWindowsBasedSliMetricSumInRangeArgs' metric_sum_in_range: Criterion that describes a window as good if the metric's value
               ...
               `metric_sum_in_range` must be set for `windows_based_sli`.
               Structure is documented below.
        :param builtins.str window_period: Duration over which window quality is evaluated, given as a
    ...
    def good_bad_metric_filter(self) -> Optional[builtins.str]:
        """
        A TimeSeries [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
        with ValueType = BOOL. The window is good if any true values
        appear in the window. One of `good_bad_metric_filter`,
    ...
    def window_period(self) -> Optional[builtins.str]:
        """
...
class SloWindowsBasedSliGoodTotalRatioThreshold(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SloWindowsBasedSliGoodTotalRatioThresholdPerformanceArgs' performance: Request-based SLI to evaluate to judge window quality.
               Structure is documented below.
        :param builtins.float threshold: If window performance >= threshold, the window is counted
               as good.
        """
...
class SloWindowsBasedSliMetricMeanInRange(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SloWindowsBasedSliMetricMeanInRangeRangeArgs' range: Range of numerical values. The computed good_service
               ...
               good service.
               Structure is documented below.
        :param builtins.str time_series: A [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
...
class UptimeCheckConfigContentMatcher(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content: String or regex content to match (max 1024 bytes)
        :param 'UptimeCheckConfigContentMatcherJsonPathMatcherArgs' json_path_matcher: Information needed to perform a JSONPath content match. Used for `ContentMatcherOption::MATCHES_JSON_PATH` and `ContentMatcherOption::NOT_MATCHES_JSON_PATH`.
               Structure is documented below.
        :param builtins.str matcher: The type of content matcher that will be applied to the server output, compared to the content string when the check is run.
...
class UptimeCheckConfigContentMatcherJsonPathMatcher(dict):
    ...
    def __init__(__self__, *,
                 ...
                 json_matcher: Optional[builtins.str] = None):
        """
        :param builtins.str json_path: JSONPath within the response output pointing to the expected `ContentMatcher::content` to match against.
        :param builtins.str json_matcher: Options to perform JSONPath content matching.
    ...
    def json_matcher(self) -> Optional[builtins.str]:
        """
...
class UptimeCheckConfigHttpCheck(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_content_type: Optional[builtins.str] = None,
                 headers: Optional[Mapping[str, builtins.str]] = None,
                 mask_headers: Optional[builtins.bool] = None,
                 ...
                 validate_ssl: Optional[builtins.bool] = None):
        """
        ...
        :param 'UptimeCheckConfigHttpCheckAuthInfoArgs' auth_info: The authentication information using username and password. Optional when creating an HTTP check; defaults to empty. Do not use with other authentication fields.
               Structure is documented below.
        :param builtins.str body: The request body associated with the HTTP POST request. If `content_type` is `URL_ENCODED`, the body passed in must be URL-encoded. Users can provide a `Content-Length` header via the `headers` field or the API will do so. If the `request_method` is `GET` and `body` is not empty, the API will return an error. The maximum byte size is 1 megabyte. Note - As with all bytes fields JSON representations are base64 encoded. e.g. `foo=bar` in URL-encoded form is `foo%3Dbar` and in base64 encoding is `Zm9vJTI1M0RiYXI=`.
        :param builtins.str content_type: The content type to use for the check.
               Possible values are: `TYPE_UNSPECIFIED`, `URL_ENCODED`, `USER_PROVIDED`.
        :param builtins.str custom_content_type: A user provided content type header to use for the check. The invalid configurations outlined in the `content_type` field apply to custom_content_type`, as well as the following 1. `content_type` is `URL_ENCODED` and `custom_content_type` is set. 2. `content_type` is `USER_PROVIDED` and `custom_content_type` is not set.
        :param Mapping[str, builtins.str] headers: The list of headers to send as part of the uptime check request. If two headers have the same key and different values, they should be entered as a single header, with the value being a comma-separated list of all the desired values as described in [RFC 2616 (page 31)](https://www.w3.org/Protocols/rfc2616/rfc2616.txt). Entering two separate headers with the same key in a Create call will cause the first to be overwritten by the second. The maximum number of headers allowed is 100.
        :param builtins.bool mask_headers: Boolean specifying whether to encrypt the header information. Encryption should be specified for any headers related to authentication that you do not wish to be seen when retrieving the configuration. The server will be responsible for encrypting the headers. On Get/List calls, if `mask_headers` is set to `true` then the headers will be obscured with `******`.
        :param builtins.str path: The path to the page to run the check against. Will be combined with the host (specified within the MonitoredResource) and port to construct the full URL. If the provided path does not begin with `/`, a `/` will be prepended automatically. Optional (defaults to `/`).
        :param 'UptimeCheckConfigHttpCheckPingConfigArgs' ping_config: Contains information needed to add pings to an HTTP check.
               Structure is documented below.
        :param builtins.int port: The port to the page to run the check against. Will be combined with `host` (specified within the `monitored_resource`) and path to construct the full URL. Optional (defaults to 80 without SSL, or 443 with SSL).
        :param builtins.str request_method: The HTTP request method to use for the check. If set to `METHOD_UNSPECIFIED` then `request_method` defaults to `GET`.
        ...
        :param 'UptimeCheckConfigHttpCheckServiceAgentAuthenticationArgs' service_agent_authentication: The authentication information using the Monitoring Service Agent. Optional when creating an HTTPS check; defaults to empty. Do not use with other authentication fields.
               Structure is documented below.
        :param builtins.bool use_ssl: If true, use HTTPS instead of HTTP to run the check.
        :param builtins.bool validate_ssl: Boolean specifying whether to include SSL certificate validation as a part of the Uptime check. Only applies to checks where `monitored_resource` is set to `uptime_url`. If `use_ssl` is `false`, setting `validate_ssl` to `true` has no effect.
        """
    ...
    def custom_content_type(self) -> Optional[builtins.str]:
        """
    ...
    def mask_headers(self) -> Optional[builtins.bool]:
        """
    ...
    def validate_ssl(self) -> Optional[builtins.bool]:
        """
...
class UptimeCheckConfigHttpCheckAcceptedResponseStatusCode(dict):
    ...
    def __init__(__self__, *,
                 status_class: Optional[builtins.str] = None,
                 status_value: Optional[builtins.int] = None):
        """
        :param builtins.str status_class: A class of status codes to accept.
        ...
        :param builtins.int status_value: A status code to accept.
        """
    ...
    def status_class(self) -> Optional[builtins.str]:
        """
    ...
    def status_value(self) -> Optional[builtins.int]:
        """
...
class UptimeCheckConfigHttpCheckPingConfig(dict):
    ...
    def __init__(__self__, *,
                 pings_count: builtins.int):
        """
        :param builtins.int pings_count: Number of ICMP pings. A maximum of 3 ICMP pings is currently supported.
        """
        pulumi.set(__self__, "pings_count", pings_count)

    @property
    @pulumi.getter(name="pingsCount")
    def pings_count(self) -> builtins.int:
        """
...
class UptimeCheckConfigHttpCheckServiceAgentAuthentication(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of authentication to use.
...
class UptimeCheckConfigMonitoredResource(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Mapping[str, builtins.str] labels: Values for all of the labels listed in the associated monitored resource descriptor. For example, Compute Engine VM instances use the labels `project_id`, `instance_id`, and `zone`.
        :param builtins.str type: The monitored resource type. This field must match the type field of a [`MonitoredResourceDescriptor`](https://cloud.google.com/monitoring/api/ref_v3/rest/v3/projects.monitoredResourceDescriptors#MonitoredResourceDescriptor) object. For example, the type of a Compute Engine VM instance is `gce_instance`. For a list of types, see [Monitoring resource types](https://cloud.google.com/monitoring/api/resources) and [Logging resource types](https://cloud.google.com/logging/docs/api/v2/resource-list).
        """
        pulumi.set(__self__, "labels", labels)
        pulumi.set(__self__, "type", type)
...
class UptimeCheckConfigResourceGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str group_id: The group of resources being monitored. Should be the `name` of a group
        :param builtins.str resource_type: The resource type of the group members.
...
class UptimeCheckConfigSyntheticMonitorCloudFunctionV2(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: A unique resource name for this UptimeCheckConfig. The format is `projects/[PROJECT_ID]/uptimeCheckConfigs/[UPTIME_CHECK_ID]`.
        """
        pulumi.set(__self__, "name", name)
...
class UptimeCheckConfigTcpCheck(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int port: The port to the page to run the check against. Will be combined with host (specified within the `monitored_resource`) to construct the full URL.
...
class GetUptimeCheckIPsUptimeCheckIpResult(dict):
    def __init__(__self__, *,
                 ...
                 region: builtins.str):
        """
        :param builtins.str ip_address: The IP address from which the Uptime check originates. This is a fully specified IP address
               ...
               IPv4 or IPv6 format.
        :param builtins.str location: A more specific location within the region that typically encodes a particular city/town/metro
               (and its containing state/province or country) within the broader umbrella region category.
        :param builtins.str region: A broad region category in which the IP address is located.
        """
