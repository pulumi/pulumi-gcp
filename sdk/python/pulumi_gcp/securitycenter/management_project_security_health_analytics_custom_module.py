...
class _ManagementProjectSecurityHealthAnalyticsCustomModuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Location ID of the parent organization. If not provided, 'global' will be used as the default location.
        :param pulumi.Input[_builtins.str] name: The resource name of the custom module. Its format is "projects/{project}/locations/{location}/securityHealthAnalyticsCustomModules/{securityHealthAnalyticsCustomModule}".
