...
class FolderCustomModuleArgs:
    def __init__(__self__, *,
                 ...
                 enablement_state: pulumi.Input[builtins.str],
    ...
    def enablement_state(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def enablement_state(self, value: pulumi.Input[builtins.str]):
...
class _FolderCustomModuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The resource name of the custom module. Its format is "folders/{folder_id}/securityHealthAnalyticsSettings/customModules/{customModule}".
...
class FolderCustomModule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            last_editor: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'FolderCustomModule':
        """
    ...
    @property
    @pulumi.getter(name="enablementState")
    def enablement_state(self) -> pulumi.Output[builtins.str]:
        """
        The enablement state of the custom module.
        Possible values are: `ENABLED`, `DISABLED`.
        """
