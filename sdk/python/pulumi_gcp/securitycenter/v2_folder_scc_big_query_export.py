...
class V2FolderSccBigQueryExportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The BigQuery export configuration is stored in this location. If not provided, Use global as default.
        """
...
class V2FolderSccBigQueryExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            principal: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'V2FolderSccBigQueryExport':
        """
