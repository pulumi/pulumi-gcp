...
class FolderSccBigQueryExportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The description of the export (max of 1024 characters).
...
class _FolderSccBigQueryExportState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] big_query_export_id: This must be unique within the organization.
        :param pulumi.Input[_builtins.str] create_time: The time at which the BigQuery export was created.
        ...
        :param pulumi.Input[_builtins.str] update_time: The most recent time at which the BigQuery export was updated.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
               Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
...
class FolderSccBigQueryExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            principal: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'FolderSccBigQueryExport':
        """
