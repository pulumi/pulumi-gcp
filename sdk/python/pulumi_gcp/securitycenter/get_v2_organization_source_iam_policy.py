...
def get_v2_organization_source_iam_policy(organization: Optional[builtins.str] = None,
...
def get_v2_organization_source_iam_policy_output(organization: Optional[pulumi.Input[builtins.str]] = None,
