...
class V2FolderMuteConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] folder: The folder whose Cloud Security Command Center the Mute
               Config lives in.
        ...
        :param pulumi.Input[_builtins.str] location: location Id is provided by folder. If not provided, Use global as default.
        """
...
@pulumi.type_token("gcp:securitycenter/v2FolderMuteConfig:V2FolderMuteConfig")
class V2FolderMuteConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'V2FolderMuteConfig':
        """
