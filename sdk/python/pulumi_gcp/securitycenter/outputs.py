...
class FolderCustomModuleCustomConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str recommendation: An explanation of the recommended steps that security teams can take to resolve
...
class FolderCustomModuleCustomConfigCustomOutputPropertyValueExpression(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str description: Description of the expression. This is a longer text which describes the
               expression, e.g. when hovered over it in a UI.
        :param builtins.str location: String indicating the location of the expression for error reporting, e.g. a
               file name and a position in the file.
        :param builtins.str title: Title for the expression, i.e. a short string describing its purpose. This can
...
class FolderNotificationConfigStreamingConfig(dict):
    def __init__(__self__, *,
                 filter: builtins.str):
        """
        :param builtins.str filter: Expression that defines the filter to apply across create/update
...
class InstanceIamBindingCondition(dict):
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None):
        """
        :param builtins.str description: An optional description of the instance.
        """
        pulumi.set(__self__, "expression", expression)
        pulumi.set(__self__, "title", title)
        if description is not None:
...
class SourceIamBindingCondition(dict):
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None):
        """
        :param builtins.str description: The description of the source (max of 1024 characters).
        """
        pulumi.set(__self__, "expression", expression)
        pulumi.set(__self__, "title", title)
        if description is not None:
