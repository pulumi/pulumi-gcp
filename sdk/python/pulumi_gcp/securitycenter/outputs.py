...
class FolderCustomModuleCustomConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str recommendation: An explanation of the recommended steps that security teams can take to resolve
        ...
        :param 'FolderCustomModuleCustomConfigResourceSelectorArgs' resource_selector: The resource types that the custom module operates on. Each custom module
               ...
               Structure is documented below.
        :param _builtins.str severity: The severity to assign to findings generated by the module.
        ...
        :param 'FolderCustomModuleCustomConfigCustomOutputArgs' custom_output: Custom output properties.
               Structure is documented below.
        :param _builtins.str description: Text that describes the vulnerability or misconfiguration that the custom
...
class FolderCustomModuleCustomConfigCustomOutputProperty(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Name of the property for the custom output.
...
class FolderCustomModuleCustomConfigCustomOutputPropertyValueExpression(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str description: Description of the expression. This is a longer text which describes the
               expression, e.g. when hovered over it in a UI.
        :param _builtins.str location: String indicating the location of the expression for error reporting, e.g. a
               file name and a position in the file.
        :param _builtins.str title: Title for the expression, i.e. a short string describing its purpose. This can
...
class FolderCustomModuleCustomConfigResourceSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] resource_types: The resource types to run the detector on.
        """
...
class FolderNotificationConfigStreamingConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str filter: Expression that defines the filter to apply across create/update
...
class InstanceIamBindingCondition(dict):
    def __init__(__self__, *,
                 ...
                 description: Optional[_builtins.str] = None):
        """
        :param _builtins.str description: An optional description of the instance.
        """
        pulumi.set(__self__, "expression", expression)
        pulumi.set(__self__, "title", title)
        if description is not None:
...
class SourceIamBindingCondition(dict):
    def __init__(__self__, *,
                 ...
                 description: Optional[_builtins.str] = None):
        """
        :param _builtins.str description: The description of the source (max of 1024 characters).
        """
        pulumi.set(__self__, "expression", expression)
        pulumi.set(__self__, "title", title)
        if description is not None:
