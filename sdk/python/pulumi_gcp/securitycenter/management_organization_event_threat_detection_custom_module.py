...
class ManagementOrganizationEventThreatDetectionCustomModuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Immutable. Type for the module. e.g. CONFIGURABLE_BAD_IP.
        """
...
class _ManagementOrganizationEventThreatDetectionCustomModuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Location ID of the parent organization. Only global is supported at the moment.
        :param pulumi.Input[_builtins.str] name: The resource name of the Event Threat Detection custom module.
...
class ManagementOrganizationEventThreatDetectionCustomModule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'ManagementOrganizationEventThreatDetectionCustomModule':
        """
