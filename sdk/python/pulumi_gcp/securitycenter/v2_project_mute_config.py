...
class V2ProjectMuteConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: location Id is provided by project. If not provided, Use global as default.
...
@pulumi.type_token("gcp:securitycenter/v2ProjectMuteConfig:V2ProjectMuteConfig")
class V2ProjectMuteConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'V2ProjectMuteConfig':
        """
