...
class _OrganizationCustomModuleState:
    def __init__(__self__, *,
                 ...
                 custom_config: pulumi.Input[Optional['OrganizationCustomModuleCustomConfigArgs']] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="customConfig")
    def custom_config(self) -> pulumi.Input[Optional['OrganizationCustomModuleCustomConfigArgs']]:
        """
        The user specified custom configuration for the module.
        Structure is documented below.
        """
    ...
    @custom_config.setter
    def custom_config(self, value: pulumi.Input[Optional['OrganizationCustomModuleCustomConfigArgs']]):
        pulumi.set(self, "custom_config", value)
...
class OrganizationCustomModule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_config: pulumi.Input[Optional[Union['OrganizationCustomModuleCustomConfigArgs', 'OrganizationCustomModuleCustomConfigArgsDict', 'outputs.OrganizationCustomModuleCustomConfig']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 enablement_state: pulumi.Input[Optional[_builtins.str]] = None,
                 organization: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{organization}}/{{name}}`
        ...
        :param pulumi.Input[Union['OrganizationCustomModuleCustomConfigArgs', 'OrganizationCustomModuleCustomConfigArgsDict', 'outputs.OrganizationCustomModuleCustomConfig']] custom_config: The user specified custom configuration for the module.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            organization: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'OrganizationCustomModule':
        """
