...
class _OrganizationCustomModuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The resource name of the custom module. Its format is "organizations/{org_id}/securityHealthAnalyticsSettings/customModules/{customModule}".
...
class OrganizationCustomModule(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:securitycenter/organizationCustomModule:OrganizationCustomModule"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            organization: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationCustomModule':
        """
