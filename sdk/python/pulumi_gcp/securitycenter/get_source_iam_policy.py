...
def get_source_iam_policy(organization: Optional[builtins.str] = None,
    ...
    :param builtins.str source: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_source_iam_policy_output(organization: Optional[pulumi.Input[builtins.str]] = None,
