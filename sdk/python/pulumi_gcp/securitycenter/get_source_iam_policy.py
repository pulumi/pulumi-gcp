...
def get_source_iam_policy(organization: Optional[_builtins.str] = None,
    ...
    :param _builtins.str source: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
