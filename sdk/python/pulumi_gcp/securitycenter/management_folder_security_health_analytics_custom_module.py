...
class ManagementFolderSecurityHealthAnalyticsCustomModuleArgs:
    def __init__(__self__, *,
                 ...
                 custom_config: pulumi.Input[Optional['ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigArgs']] = None,
    ...
    def custom_config(self) -> pulumi.Input[Optional['ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigArgs']]:
        """
    ...
    def custom_config(self, value: pulumi.Input[Optional['ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigArgs']]):
...
class _ManagementFolderSecurityHealthAnalyticsCustomModuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Location ID of the parent organization. If not provided, 'global' will be used as the default location.
        :param pulumi.Input[_builtins.str] name: The resource name of the custom module. Its format is "folders/{folder}/locations/{location}/securityHealthAnalyticsCustomModules/{securityHealthAnalyticsCustomModule}".
...
@pulumi.type_token("gcp:securitycenter/managementFolderSecurityHealthAnalyticsCustomModule:ManagementFolderSecurityHealthAnalyticsCustomModule")
class ManagementFolderSecurityHealthAnalyticsCustomModule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 custom_config: pulumi.Input[Optional[Union['ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigArgs', 'ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigArgsDict', 'outputs.ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfig']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 enablement_state: pulumi.Input[Optional[_builtins.str]] = None,
                 folder: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{folder}}/{{location}}/{{name}}`
        ...
        :param pulumi.Input[Union['ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigArgs', 'ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfigArgsDict', 'outputs.ManagementFolderSecurityHealthAnalyticsCustomModuleCustomConfig']] custom_config: The user specified custom configuration for the module.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
    ...
    def get(resource_name: str,
            ...
            location: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'ManagementFolderSecurityHealthAnalyticsCustomModule':
        """
