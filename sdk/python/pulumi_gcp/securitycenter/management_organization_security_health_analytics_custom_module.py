...
class ManagementOrganizationSecurityHealthAnalyticsCustomModuleArgs:
    ...
    def custom_config(self) -> pulumi.Input[Optional['ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs']]:
        """
...
class _ManagementOrganizationSecurityHealthAnalyticsCustomModuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Location ID of the parent organization. If not provided, 'global' will be used as the default location.
        :param pulumi.Input[_builtins.str] name: The resource name of the custom module. Its format is "organizations/{organization}/locations/{location}/securityHealthAnalyticsCustomModules/{securityHealthAnalyticsCustomModule}".
...
class ManagementOrganizationSecurityHealthAnalyticsCustomModule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_config: pulumi.Input[Optional[Union['ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs', 'ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgsDict', 'outputs.ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfig']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 enablement_state: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{organization}}/{{location}}/{{name}}`
        ...
        :param pulumi.Input[Union['ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgs', 'ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfigArgsDict', 'outputs.ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfig']] custom_config: The user specified custom configuration for the module.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            organization: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'ManagementOrganizationSecurityHealthAnalyticsCustomModule':
        """
