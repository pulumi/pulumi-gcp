...
if not MYPY:
    class FolderCustomModuleCustomConfigArgsDict(TypedDict):
        ...
        """
        recommendation: pulumi.Input[builtins.str]
        """
...
class FolderCustomModuleCustomConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FolderCustomModuleCustomConfigPredicateArgs'] predicate: The CEL expression to evaluate to produce findings. When the expression evaluates
               to true against a resource, a finding is generated.
               Structure is documented below.
        :param pulumi.Input[builtins.str] recommendation: An explanation of the recommended steps that security teams can take to resolve
               the detected issue. This explanation is returned with each finding generated by
               this module in the nextSteps property of the finding JSON.
        :param pulumi.Input['FolderCustomModuleCustomConfigResourceSelectorArgs'] resource_selector: The resource types that the custom module operates on. Each custom module
               can specify up to 5 resource types.
               Structure is documented below.
        :param pulumi.Input[builtins.str] severity: The severity to assign to findings generated by the module.
               Possible values are: `CRITICAL`, `HIGH`, `MEDIUM`, `LOW`.
        :param pulumi.Input['FolderCustomModuleCustomConfigCustomOutputArgs'] custom_output: Custom output properties.
               Structure is documented below.
        :param pulumi.Input[builtins.str] description: Text that describes the vulnerability or misconfiguration that the custom
               module detects. This explanation is returned with each finding instance to
               help investigators understand the detected issue. The text must be enclosed in quotation marks.
        """
    ...
    @property
    @pulumi.getter
    def recommendation(self) -> pulumi.Input[builtins.str]:
        """
        An explanation of the recommended steps that security teams can take to resolve
        the detected issue. This explanation is returned with each finding generated by
        this module in the nextSteps property of the finding JSON.
    ...
    def recommendation(self, value: pulumi.Input[builtins.str]):
...
class FolderCustomModuleCustomConfigCustomOutputPropertyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of the property for the custom output.
...
class FolderCustomModuleCustomConfigCustomOutputPropertyValueExpressionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the expression. This is a longer text which describes the
               expression, e.g. when hovered over it in a UI.
        :param pulumi.Input[builtins.str] location: String indicating the location of the expression for error reporting, e.g. a
               file name and a position in the file.
        :param pulumi.Input[builtins.str] title: Title for the expression, i.e. a short string describing its purpose. This can
               be used e.g. in UIs which allow to enter the expression.
        """
