...
class _ProjectCustomModuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The resource name of the custom module. Its format is "projects/{project}/securityHealthAnalyticsSettings/customModules/{customModule}".
...
class ProjectCustomModule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'ProjectCustomModule':
        """
