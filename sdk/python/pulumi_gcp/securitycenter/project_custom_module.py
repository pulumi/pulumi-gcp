...
class _ProjectCustomModuleState:
    ...
    @_builtins.property
    @pulumi.getter(name="customConfig")
    def custom_config(self) -> pulumi.Input[Optional['ProjectCustomModuleCustomConfigArgs']]:
        """
        The user specified custom configuration for the module.
        Structure is documented below.
        """
...
class ProjectCustomModule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'ProjectCustomModule':
        """
