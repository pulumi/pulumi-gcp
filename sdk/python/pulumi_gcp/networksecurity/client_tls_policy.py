...
class ClientTlsPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Set of label tags associated with the ClientTlsPolicy resource.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClientTlsPolicyServerValidationCaArgs']]] server_validation_cas: Defines the mechanism to obtain the Certificate Authority certificate to validate the server certificate. If empty, client does not validate the server certificate.
               Structure is documented below.
        :param pulumi.Input[builtins.str] sni: Server Name Indication string to present to the server during TLS handshake. E.g: "secure.example.com".
        """
...
class _ClientTlsPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClientTlsPolicyClientCertificateArgs'] client_certificate: Defines a mechanism to provision client identity (public and private keys) for peer to peer authentication. The presence of this dictates mTLS.
               Structure is documented below.
        :param pulumi.Input[builtins.str] create_time: Time the ClientTlsPolicy was created in UTC.
        :param pulumi.Input[builtins.str] description: A free-text description of the resource. Max length 1024 characters.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClientTlsPolicyServerValidationCaArgs']]] server_validation_cas: Defines the mechanism to obtain the Certificate Authority certificate to validate the server certificate. If empty, client does not validate the server certificate.
               Structure is documented below.
        :param pulumi.Input[builtins.str] sni: Server Name Indication string to present to the server during TLS handshake. E.g: "secure.example.com".
        :param pulumi.Input[builtins.str] update_time: Time the ClientTlsPolicy was updated in UTC.
        """
        if client_certificate is not None:
            pulumi.set(__self__, "client_certificate", client_certificate)
...
class ClientTlsPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server_validation_cas: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClientTlsPolicyServerValidationCaArgs', 'ClientTlsPolicyServerValidationCaArgsDict']]]]] = None,
            sni: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientTlsPolicy':
        """
    ...
    @property
    @pulumi.getter
    def sni(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Server Name Indication string to present to the server during TLS handshake. E.g: "secure.example.com".
        """
        return pulumi.get(self, "sni")
