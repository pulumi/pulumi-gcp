...
class InterceptDeploymentGroupArgs:
    def __init__(__self__, *,
                 intercept_deployment_group_id: pulumi.Input[_builtins.str],
    ...
    def intercept_deployment_group_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def intercept_deployment_group_id(self, value: pulumi.Input[_builtins.str]):
...
class _InterceptDeploymentGroupState:
    def __init__(__self__, *,
                 connected_endpoint_groups: pulumi.Input[Optional[Sequence[pulumi.Input['InterceptDeploymentGroupConnectedEndpointGroupArgs']]]] = None,
                 create_time: pulumi.Input[Optional[_builtins.str]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 effective_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 intercept_deployment_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 locations: pulumi.Input[Optional[Sequence[pulumi.Input['InterceptDeploymentGroupLocationArgs']]]] = None,
    ...
    def connected_endpoint_groups(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InterceptDeploymentGroupConnectedEndpointGroupArgs']]]]:
        """
    ...
    def connected_endpoint_groups(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InterceptDeploymentGroupConnectedEndpointGroupArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="interceptDeploymentGroupId")
    def intercept_deployment_group_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ID to use for the new deployment group, which will become the final
        component of the deployment group's resource name.
        """
    ...
    @intercept_deployment_group_id.setter
    def intercept_deployment_group_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "intercept_deployment_group_id", value)
    ...
    @_builtins.property
    @pulumi.getter
    def locations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InterceptDeploymentGroupLocationArgs']]]]:
        """
    ...
    @locations.setter
    def locations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InterceptDeploymentGroupLocationArgs']]]]):
...
@pulumi.type_token("gcp:networksecurity/interceptDeploymentGroup:InterceptDeploymentGroup")
class InterceptDeploymentGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            connected_endpoint_groups: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InterceptDeploymentGroupConnectedEndpointGroupArgs', 'InterceptDeploymentGroupConnectedEndpointGroupArgsDict', 'outputs.InterceptDeploymentGroupConnectedEndpointGroup']]]]] = None,
            create_time: pulumi.Input[Optional[_builtins.str]] = None,
            deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            effective_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            ...
            labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            location: pulumi.Input[Optional[_builtins.str]] = None,
            locations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InterceptDeploymentGroupLocationArgs', 'InterceptDeploymentGroupLocationArgsDict', 'outputs.InterceptDeploymentGroupLocation']]]]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            network: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            reconciling: pulumi.Input[Optional[_builtins.bool]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'InterceptDeploymentGroup':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InterceptDeploymentGroupConnectedEndpointGroupArgs', 'InterceptDeploymentGroupConnectedEndpointGroupArgsDict', 'outputs.InterceptDeploymentGroupConnectedEndpointGroup']]]] connected_endpoint_groups: The list of endpoint groups that are connected to this resource.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] create_time: The timestamp when the resource was created.
               See https://google.aip.dev/148#timestamps.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels are key/value pairs that help to organize and filter resources.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The cloud location of the deployment group, currently restricted to `global`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InterceptDeploymentGroupLocationArgs', 'InterceptDeploymentGroupLocationArgsDict', 'outputs.InterceptDeploymentGroupLocation']]]] locations: The list of locations where the deployment group is present.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] name: (Output)
               The connected endpoint group's resource name, for example:
               `projects/123456789/locations/global/interceptEndpointGroups/my-eg`.
    ...
    @_builtins.property
    @pulumi.getter(name="interceptDeploymentGroupId")
    def intercept_deployment_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID to use for the new deployment group, which will become the final
        component of the deployment group's resource name.
        """
