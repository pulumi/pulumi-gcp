...
class MirroringEndpointGroupArgs:
    def __init__(__self__, *,
                 ...
                 mirroring_endpoint_group_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] mirroring_deployment_group: The deployment group that this DIRECT endpoint group is connected to, for example:
    ...
    def mirroring_endpoint_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def mirroring_endpoint_group_id(self, value: pulumi.Input[builtins.str]):
...
class _MirroringEndpointGroupState:
    def __init__(__self__, *,
                 ...
                 mirroring_endpoint_group_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="mirroringEndpointGroupId")
    def mirroring_endpoint_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID to use for the endpoint group, which will become the final component
        of the endpoint group's resource name.
    ...
    @mirroring_endpoint_group_id.setter
    def mirroring_endpoint_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirroring_endpoint_group_id", value)
...
class MirroringEndpointGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reconciling: Optional[pulumi.Input[builtins.bool]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'MirroringEndpointGroup':
        """
    ...
    @property
    @pulumi.getter(name="mirroringEndpointGroupId")
    def mirroring_endpoint_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID to use for the endpoint group, which will become the final component
        of the endpoint group's resource name.
