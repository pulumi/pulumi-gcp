...
class ServerTlsPolicyArgs:
    def __init__(__self__, *,
                 allow_open: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_open: This field applies only for Traffic Director policies. It is must be set to false for external HTTPS load balancer policies.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Set of label tags associated with the ServerTlsPolicy resource.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] location: The location of the server tls policy.
        ...
        :param pulumi.Input[builtins.str] name: Name of the ServerTlsPolicy resource.
    ...
    def allow_open(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @allow_open.setter
    def allow_open(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ServerTlsPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] allow_open: This field applies only for Traffic Director policies. It is must be set to false for external HTTPS load balancer policies.
               Determines if server allows plaintext connections. If set to true, server allows plain text connections. By default, it is set to false. This setting is not exclusive of other encryption modes. For example, if allowOpen and mtlsPolicy are set, server allows both plain text and mTLS connections. See documentation of other encryption modes to confirm compatibility.
               Consider using it if you wish to upgrade in place your deployment to TLS while having mixed TLS and non-TLS traffic reaching port :80.
        :param pulumi.Input[builtins.str] create_time: Time the ServerTlsPolicy was created in UTC.
        :param pulumi.Input[builtins.str] description: A free-text description of the resource. Max length 1024 characters.
        ...
        :param pulumi.Input['ServerTlsPolicyServerCertificateArgs'] server_certificate: Defines a mechanism to provision client identity (public and private keys) for peer to peer authentication. The presence of this dictates mTLS.
               Structure is documented below.
        :param pulumi.Input[builtins.str] update_time: Time the ServerTlsPolicy was updated in UTC.
        """
        if allow_open is not None:
            pulumi.set(__self__, "allow_open", allow_open)
...
@pulumi.type_token("gcp:networksecurity/serverTlsPolicy:ServerTlsPolicy")
class ServerTlsPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            server_certificate: Optional[pulumi.Input[Union['ServerTlsPolicyServerCertificateArgs', 'ServerTlsPolicyServerCertificateArgsDict']]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerTlsPolicy':
        """
    ...
    @property
    @pulumi.getter(name="allowOpen")
    def allow_open(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        This field applies only for Traffic Director policies. It is must be set to false for external HTTPS load balancer policies.
        Determines if server allows plaintext connections. If set to true, server allows plain text connections. By default, it is set to false. This setting is not exclusive of other encryption modes. For example, if allowOpen and mtlsPolicy are set, server allows both plain text and mTLS connections. See documentation of other encryption modes to confirm compatibility.
        Consider using it if you wish to upgrade in place your deployment to TLS while having mixed TLS and non-TLS traffic reaching port :80.
