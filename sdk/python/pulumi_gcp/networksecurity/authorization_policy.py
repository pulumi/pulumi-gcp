...
class AuthorizationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The action to take when a rule match is found. Possible values are "ALLOW" or "DENY".
               Possible values are: `ALLOW`, `DENY`.
        :param pulumi.Input[builtins.str] description: A free-text description of the resource. Max length 1024 characters.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Set of label tags associated with the AuthorizationPolicy resource.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] location: The location of the authorization policy.
               The default value is `global`.
        :param pulumi.Input[builtins.str] name: Name of the AuthorizationPolicy resource.
...
class _AuthorizationPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The action to take when a rule match is found. Possible values are "ALLOW" or "DENY".
               Possible values are: `ALLOW`, `DENY`.
        :param pulumi.Input[builtins.str] create_time: Time the AuthorizationPolicy was created in UTC.
        :param pulumi.Input[builtins.str] description: A free-text description of the resource. Max length 1024 characters.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AuthorizationPolicyRuleArgs']]] rules: List of rules to match. Note that at least one of the rules must match in order for the action specified in the 'action' field to be taken.
               A rule is a match if there is a matching source and destination. If left blank, the action specified in the action field will be applied on every request.
               Structure is documented below.
        :param pulumi.Input[builtins.str] update_time: Time the AuthorizationPolicy was updated in UTC.
        """
...
class AuthorizationPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AuthorizationPolicyRuleArgs', 'AuthorizationPolicyRuleArgsDict']]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthorizationPolicy':
        """
