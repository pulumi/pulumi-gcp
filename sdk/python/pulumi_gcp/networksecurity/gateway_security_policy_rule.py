...
class GatewaySecurityPolicyRuleArgs:
    def __init__(__self__, *,
                 basic_profile: pulumi.Input[builtins.str],
                 enabled: pulumi.Input[builtins.bool],
                 gateway_security_policy: pulumi.Input[builtins.str],
                 location: pulumi.Input[builtins.str],
                 priority: pulumi.Input[builtins.int],
                 session_matcher: pulumi.Input[builtins.str],
                 application_matcher: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 tls_inspection_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a GatewaySecurityPolicyRule resource.
        :param pulumi.Input[builtins.str] basic_profile: Profile which tells what the primitive action should be. Possible values are: * ALLOW * DENY.
               Possible values are: `BASIC_PROFILE_UNSPECIFIED`, `ALLOW`, `DENY`.
        :param pulumi.Input[builtins.bool] enabled: Whether the rule is enforced.
        :param pulumi.Input[builtins.str] gateway_security_policy: The name of the gatewat security policy this rule belongs to.
               
               
               - - -
        :param pulumi.Input[builtins.str] location: The location of the gateway security policy.
        :param pulumi.Input[builtins.int] priority: Priority of the rule. Lower number corresponds to higher precedence.
        :param pulumi.Input[builtins.str] session_matcher: CEL expression for matching on session criteria.
        :param pulumi.Input[builtins.str] application_matcher: CEL expression for matching on L7/application level criteria.
        :param pulumi.Input[builtins.str] description: Free-text description of the resource.
        :param pulumi.Input[builtins.str] name: Name of the resource. ame is the full resource name so projects/{project}/locations/{location}/gatewaySecurityPolicies/{gateway_security_policy}/rules/{rule}
               rule should match the pattern: (^a-z?$).
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.bool] tls_inspection_enabled: Flag to enable TLS inspection of traffic matching on. Can only be true if the
    ...
    def basic_profile(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def basic_profile(self, value: pulumi.Input[builtins.str]):
    ...
    def gateway_security_policy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def gateway_security_policy(self, value: pulumi.Input[builtins.str]):
    ...
    def session_matcher(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def session_matcher(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "session_matcher", value)

    @property
    @pulumi.getter(name="applicationMatcher")
    def application_matcher(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_matcher(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tls_inspection_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def tls_inspection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _GatewaySecurityPolicyRuleState:
    def __init__(__self__, *,
                 application_matcher: Optional[pulumi.Input[builtins.str]] = None,
                 basic_profile: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 session_matcher: Optional[pulumi.Input[builtins.str]] = None,
                 tls_inspection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="basicProfile")
    def basic_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Profile which tells what the primitive action should be. Possible values are: * ALLOW * DENY.
        Possible values are: `BASIC_PROFILE_UNSPECIFIED`, `ALLOW`, `DENY`.
        """
    ...
    @basic_profile.setter
    def basic_profile(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "basic_profile", value)
    ...
    @property
    @pulumi.getter(name="sessionMatcher")
    def session_matcher(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        CEL expression for matching on session criteria.
        """
        return pulumi.get(self, "session_matcher")
    ...
    @session_matcher.setter
    def session_matcher(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "session_matcher", value)
...
class GatewaySecurityPolicyRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            session_matcher: Optional[pulumi.Input[builtins.str]] = None,
            tls_inspection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewaySecurityPolicyRule':
        """
    ...
    @property
    @pulumi.getter(name="applicationMatcher")
    def application_matcher(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        CEL expression for matching on L7/application level criteria.
        """
        return pulumi.get(self, "application_matcher")
    ...
    @property
    @pulumi.getter(name="basicProfile")
    def basic_profile(self) -> pulumi.Output[builtins.str]:
        """
        Profile which tells what the primitive action should be. Possible values are: * ALLOW * DENY.
        Possible values are: `BASIC_PROFILE_UNSPECIFIED`, `ALLOW`, `DENY`.
        """
    ...
    @property
    @pulumi.getter(name="gatewaySecurityPolicy")
    def gateway_security_policy(self) -> pulumi.Output[builtins.str]:
        """
        The name of the gatewat security policy this rule belongs to.
    ...
    @property
    @pulumi.getter(name="sessionMatcher")
    def session_matcher(self) -> pulumi.Output[builtins.str]:
        """
        CEL expression for matching on session criteria.
        """
        return pulumi.get(self, "session_matcher")
    ...
    @property
    @pulumi.getter(name="tlsInspectionEnabled")
    def tls_inspection_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag to enable TLS inspection of traffic matching on. Can only be true if the
        parent GatewaySecurityPolicy references a TLSInspectionConfig.
        """
