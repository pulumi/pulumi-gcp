...
def get_address_group_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The location of the gateway security policy.
...
def get_address_group_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
