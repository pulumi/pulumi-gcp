...
class MirroringDeploymentArgs:
    def __init__(__self__, *,
                 ...
                 mirroring_deployment_group: pulumi.Input[builtins.str],
                 mirroring_deployment_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MirroringDeployment resource.
        :param pulumi.Input[builtins.str] forwarding_rule: The regional forwarding rule that fronts the mirroring collectors, for
        ...
        :param pulumi.Input[builtins.str] mirroring_deployment_group: The deployment group that this deployment is a part of, for example:
    ...
    def mirroring_deployment_group(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def mirroring_deployment_group(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "mirroring_deployment_group", value)

    @property
    @pulumi.getter(name="mirroringDeploymentId")
    def mirroring_deployment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def mirroring_deployment_id(self, value: pulumi.Input[builtins.str]):
...
class _MirroringDeploymentState:
    def __init__(__self__, *,
                 ...
                 mirroring_deployment_group: Optional[pulumi.Input[builtins.str]] = None,
                 mirroring_deployment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="mirroringDeploymentGroup")
    def mirroring_deployment_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The deployment group that this deployment is a part of, for example:
        `projects/123456789/locations/global/mirroringDeploymentGroups/my-dg`.
        See https://google.aip.dev/124.
    ...
    @mirroring_deployment_group.setter
    def mirroring_deployment_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirroring_deployment_group", value)

    @property
    @pulumi.getter(name="mirroringDeploymentId")
    def mirroring_deployment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID to use for the new deployment, which will become the final
        component of the deployment's resource name.
    ...
    @mirroring_deployment_id.setter
    def mirroring_deployment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirroring_deployment_id", value)
...
class MirroringDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reconciling: Optional[pulumi.Input[builtins.bool]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'MirroringDeployment':
        """
    ...
    @property
    @pulumi.getter(name="mirroringDeploymentGroup")
    def mirroring_deployment_group(self) -> pulumi.Output[builtins.str]:
        """
        The deployment group that this deployment is a part of, for example:
        `projects/123456789/locations/global/mirroringDeploymentGroups/my-dg`.
        See https://google.aip.dev/124.
    ...
    @property
    @pulumi.getter(name="mirroringDeploymentId")
    def mirroring_deployment_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID to use for the new deployment, which will become the final
        component of the deployment's resource name.
