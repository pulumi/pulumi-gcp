...
class InterceptDeploymentArgs:
    def __init__(__self__, *,
                 ...
                 intercept_deployment_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] intercept_deployment_group: The deployment group that this deployment is a part of, for example:
               `projects/123456789/locations/global/interceptDeploymentGroups/my-dg`.
               See https://google.aip.dev/124.
        :param pulumi.Input[_builtins.str] intercept_deployment_id: The ID to use for the new deployment, which will become the final
               component of the deployment's resource name.
        :param pulumi.Input[_builtins.str] location: The cloud location of the deployment, e.g. `us-central1-a` or `asia-south1-b`.
    ...
    def intercept_deployment_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def intercept_deployment_id(self, value: pulumi.Input[_builtins.str]):
...
class _InterceptDeploymentState:
    def __init__(__self__, *,
                 ...
                 intercept_deployment_id: Optional[pulumi.Input[_builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels are key/value pairs that help to organize and filter resources.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The cloud location of the deployment, e.g. `us-central1-a` or `asia-south1-b`.
        :param pulumi.Input[_builtins.str] name: The resource name of this deployment, for example:
    ...
    @_builtins.property
    @pulumi.getter(name="interceptDeploymentId")
    def intercept_deployment_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The ID to use for the new deployment, which will become the final
        component of the deployment's resource name.
        """
    ...
    @intercept_deployment_id.setter
    def intercept_deployment_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "intercept_deployment_id", value)
...
class InterceptDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reconciling: Optional[pulumi.Input[_builtins.bool]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'InterceptDeployment':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="interceptDeploymentId")
    def intercept_deployment_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID to use for the new deployment, which will become the final
        component of the deployment's resource name.
        """
