...
class _InterceptDeploymentState:
    def __init__(__self__, *,
                 ...
                 intercept_deployment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="interceptDeploymentId")
    def intercept_deployment_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ID to use for the new deployment, which will become the final
        component of the deployment's resource name.
        """
    ...
    @intercept_deployment_id.setter
    def intercept_deployment_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "intercept_deployment_id", value)
...
class InterceptDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reconciling: pulumi.Input[Optional[_builtins.bool]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'InterceptDeployment':
        """
