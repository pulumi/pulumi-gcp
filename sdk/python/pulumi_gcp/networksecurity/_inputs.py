...
class AuthorizationPolicyRuleDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hosts: List of host names to match. Matched against the ":authority" header in http requests. At least one host should match. Each host can be an exact match, or a prefix match (example "mydomain.*") or a suffix match (example "*.myorg.com") or a presence (any) match "*".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] methods: A list of HTTP methods to match. At least one method should match. Should not be set for gRPC services.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] ports: List of destination ports to match. At least one port should match.
...
if not MYPY:
    class AuthorizationPolicyRuleDestinationHttpHeaderMatchArgsDict(TypedDict):
        ...
        """
        regex_match: pulumi.Input[builtins.str]
        """
...
class AuthorizationPolicyRuleDestinationHttpHeaderMatchArgs:
    def __init__(__self__, *,
                 ...
                 regex_match: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] header_name: The name of the HTTP header to match. For matching against the HTTP request's authority, use a headerMatch with the header name ":authority". For matching a request's method, use the headerName ":method".
        :param pulumi.Input[builtins.str] regex_match: The value of the header must match the regular expression specified in regexMatch. For regular expression grammar, please see: en.cppreference.com/w/cpp/regex/ecmascript For matching against a port specified in the HTTP request, use a headerMatch with headerName set to Host and a regular expression that satisfies the RFC2616 Host header's port specifier.
        """
    ...
    def regex_match(self) -> pulumi.Input[builtins.str]:
        """
        The value of the header must match the regular expression specified in regexMatch. For regular expression grammar, please see: en.cppreference.com/w/cpp/regex/ecmascript For matching against a port specified in the HTTP request, use a headerMatch with headerName set to Host and a regular expression that satisfies the RFC2616 Host header's port specifier.
        """
    ...
    @regex_match.setter
    def regex_match(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "regex_match", value)


if not MYPY:
    class AuthorizationPolicyRuleSourceArgsDict(TypedDict):
        ip_blocks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AuthorizationPolicyRuleSourceArgs:
    def __init__(__self__, *,
                 ip_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 principals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_blocks: List of CIDR ranges to match based on source IP address. At least one IP block should match. Single IP (e.g., "1.2.3.4") and CIDR (e.g., "1.2.3.0/24") are supported. Authorization based on source IP alone should be avoided.
               The IP addresses of any load balancers or proxies should be considered untrusted.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] principals: List of peer identities to match for authorization. At least one principal should match. Each peer can be an exact match, or a prefix match (example, "namespace/*") or a suffix match (example, "*/service-account") or a presence match "*".
               Authorization based on the principal name without certificate validation (configured by ServerTlsPolicy resource) is considered insecure.
        """
    ...
    def ip_blocks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of CIDR ranges to match based on source IP address. At least one IP block should match. Single IP (e.g., "1.2.3.4") and CIDR (e.g., "1.2.3.0/24") are supported. Authorization based on source IP alone should be avoided.
        The IP addresses of any load balancers or proxies should be considered untrusted.
        """
    ...
    @ip_blocks.setter
    def ip_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AuthzPolicyCustomProviderAuthzExtensionArgs:
    def __init__(__self__, *,
                 resources: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: A list of references to authorization extensions that will be invoked for requests matching this policy. Limited to 1 custom provider.
        """
...
class AuthzPolicyCustomProviderCloudIapArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Enable Cloud IAP at the AuthzPolicy level.
        """
...
if not MYPY:
    class AuthzPolicyHttpRuleArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        when: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AuthzPolicyHttpRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AuthzPolicyHttpRuleToArgs'] to: Describes properties of one or more targets of a request
               Structure is documented below.
        :param pulumi.Input[builtins.str] when: CEL expression that describes the conditions to be satisfied for the action. The result of the CEL expression is ANDed with the from and to. Refer to the CEL language reference for a list of available attributes.
        """
...
class AuthzPolicyHttpRuleFromNotSourcePrincipalArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] contains: The input string must have the substring specified here. Note: empty contains match is not allowed, please use regex instead.
               Examples:
               * abc matches the value xyz.abc.def
        :param pulumi.Input[builtins.str] exact: The input string must match exactly the string specified here.
               Examples:
               * abc only matches the value abc.
        :param pulumi.Input[builtins.bool] ignore_case: If true, indicates the exact/prefix/suffix/contains matching should be case insensitive. For example, the matcher data will match both input string Data and data if set to true.
        :param pulumi.Input[builtins.str] prefix: The input string must have the prefix specified here. Note: empty prefix is not allowed, please use regex instead.
               Examples:
               * abc matches the value abc.xyz
        :param pulumi.Input[builtins.str] suffix: The input string must have the suffix specified here. Note: empty prefix is not allowed, please use regex instead.
               Examples:
               * abc matches the value xyz.abc
        """
...
class AuthzPolicyHttpRuleFromNotSourceResourceTagValueIdSetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ids: A list of resource tag value permanent IDs to match against the resource manager tags value associated with the source VM of a request. The match follows AND semantics which means all the ids must match.
               Limited to 5 matches.
        """
        if ids is not None:
...
class AuthzPolicyHttpRuleToNotOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AuthzPolicyHttpRuleToNotOperationHostArgs']]] hosts: A list of HTTP Hosts to match against. The match can be one of exact, prefix, suffix, or contains (substring match). Matches are always case sensitive unless the ignoreCase is set.
               Limited to 5 matches.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] methods: A list of HTTP methods to match against. Each entry must be a valid HTTP method name (GET, PUT, POST, HEAD, PATCH, DELETE, OPTIONS). It only allows exact match and is always case sensitive.
...
class AuthzPolicyHttpRuleToNotOperationHeaderSetHeaderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the header in the request.
...
class AuthzPolicyTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] load_balancing_scheme: All gateways and forwarding rules referenced by this policy and extensions must share the same load balancing scheme.
               For more information, refer to [Backend services overview](https://cloud.google.com/load-balancing/docs/backend-service).
               Possible values are: `INTERNAL_MANAGED`, `EXTERNAL_MANAGED`, `INTERNAL_SELF_MANAGED`.
...
if not MYPY:
    class ClientTlsPolicyClientCertificateCertificateProviderInstanceArgsDict(TypedDict):
        plugin_instance: pulumi.Input[builtins.str]
        """
...
class ClientTlsPolicyClientCertificateCertificateProviderInstanceArgs:
    def __init__(__self__, *,
                 plugin_instance: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] plugin_instance: Plugin instance name, used to locate and load CertificateProvider instance configuration. Set to "google_cloud_private_spiffe" to use Certificate Authority Service certificate provider instance.
        """
        pulumi.set(__self__, "plugin_instance", plugin_instance)

    @property
    @pulumi.getter(name="pluginInstance")
    def plugin_instance(self) -> pulumi.Input[builtins.str]:
        """
        Plugin instance name, used to locate and load CertificateProvider instance configuration. Set to "google_cloud_private_spiffe" to use Certificate Authority Service certificate provider instance.
        """
    ...
    def plugin_instance(self, value: pulumi.Input[builtins.str]):
...
class ClientTlsPolicyClientCertificateGrpcEndpointArgs:
    def __init__(__self__, *,
                 target_uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] target_uri: The target URI of the gRPC endpoint. Only UDS path is supported, and should start with "unix:".
        """
...
class SecurityProfileCustomInterceptProfileArgs:
    def __init__(__self__, *,
                 intercept_endpoint_group: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] intercept_endpoint_group: The Intercept Endpoint Group to which matching traffic should be intercepted.
               Format: projects/{project_id}/locations/global/interceptEndpointGroups/{endpoint_group_id}
        """
...
class SecurityProfileCustomMirroringProfileArgs:
    def __init__(__self__, *,
                 mirroring_endpoint_group: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] mirroring_endpoint_group: The Mirroring Endpoint Group to which matching traffic should be mirrored.
               Format: projects/{project_id}/locations/global/mirroringEndpointGroups/{endpoint_group_id}
        """
...
class SecurityProfileThreatPreventionProfileAntivirusOverrideArgs:
    def __init__(__self__, *,
                 ...
                 protocol: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] action: Threat action override. For some threat types, only a subset of actions applies.
               Possible values are: `ALERT`, `ALLOW`, `DEFAULT_ACTION`, `DENY`.
        :param pulumi.Input[builtins.str] protocol: Required protocol to match.
               Possible values are: `SMTP`, `SMB`, `POP3`, `IMAP`, `HTTP2`, `HTTP`, `FTP`.
        """
...
class SecurityProfileThreatPreventionProfileSeverityOverrideArgs:
    def __init__(__self__, *,
                 ...
                 severity: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] action: Threat action override.
               Possible values are: `ALERT`, `ALLOW`, `DEFAULT_ACTION`, `DENY`.
        :param pulumi.Input[builtins.str] severity: Severity level to match.
               Possible values are: `CRITICAL`, `HIGH`, `INFORMATIONAL`, `LOW`, `MEDIUM`.
        """
        pulumi.set(__self__, "action", action)
...
if not MYPY:
    class SecurityProfileThreatPreventionProfileThreatOverrideArgsDict(TypedDict):
        ...
        Possible values are: `ALERT`, `ALLOW`, `DEFAULT_ACTION`, `DENY`.
        """
        threat_id: pulumi.Input[builtins.str]
        """
...
class SecurityProfileThreatPreventionProfileThreatOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: Threat action.
               Possible values are: `ALERT`, `ALLOW`, `DEFAULT_ACTION`, `DENY`.
        :param pulumi.Input[builtins.str] threat_id: Vendor-specific ID of a threat to override.
    ...
    def threat_id(self) -> pulumi.Input[builtins.str]:
        """
        Vendor-specific ID of a threat to override.
        """
    ...
    @threat_id.setter
    def threat_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ServerTlsPolicyMtlsPolicyArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        client_validation_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        client_validation_trust_config: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServerTlsPolicyMtlsPolicyArgs:
    def __init__(__self__, *,
                 ...
                 client_validation_mode: Optional[pulumi.Input[builtins.str]] = None,
                 client_validation_trust_config: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['ServerTlsPolicyMtlsPolicyClientValidationCaArgs']]] client_validation_cas: Required if the policy is to be used with Traffic Director. For external HTTPS load balancers it must be empty.
               Defines the mechanism to obtain the Certificate Authority certificate to validate the client certificate.
               Structure is documented below.
        :param pulumi.Input[builtins.str] client_validation_mode: When the client presents an invalid certificate or no certificate to the load balancer, the clientValidationMode specifies how the client connection is handled.
               Required if the policy is to be used with the external HTTPS load balancing. For Traffic Director it must be empty.
               Possible values are: `CLIENT_VALIDATION_MODE_UNSPECIFIED`, `ALLOW_INVALID_OR_MISSING_CLIENT_CERT`, `REJECT_INVALID`.
        :param pulumi.Input[builtins.str] client_validation_trust_config: Reference to the TrustConfig from certificatemanager.googleapis.com namespace.
               If specified, the chain validation will be performed against certificates configured in the given TrustConfig.
               Allowed only if the policy is to be used with external HTTPS load balancers.
        """
    ...
    def client_validation_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When the client presents an invalid certificate or no certificate to the load balancer, the clientValidationMode specifies how the client connection is handled.
        Required if the policy is to be used with the external HTTPS load balancing. For Traffic Director it must be empty.
        Possible values are: `CLIENT_VALIDATION_MODE_UNSPECIFIED`, `ALLOW_INVALID_OR_MISSING_CLIENT_CERT`, `REJECT_INVALID`.
    ...
    def client_validation_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_validation_mode", value)

    @property
    @pulumi.getter(name="clientValidationTrustConfig")
    def client_validation_trust_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Reference to the TrustConfig from certificatemanager.googleapis.com namespace.
        If specified, the chain validation will be performed against certificates configured in the given TrustConfig.
        Allowed only if the policy is to be used with external HTTPS load balancers.
    ...
    def client_validation_trust_config(self, value: Optional[pulumi.Input[builtins.str]]):
