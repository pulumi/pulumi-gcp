...
class UrlListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Short name of the UrlList resource to be created.
...
class _UrlListState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] update_time: Output only. Time when the security policy was updated.
               A timestamp in RFC3339 UTC 'Zulu' format, with nanosecond resolution and up to nine fractional digits.
               Examples: '2014-10-02T15:01:23Z' and '2014-10-02T15:01:23.045123456Z'.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] values: FQDNs and URLs.
        """
...
class UrlList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None,
            values: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'UrlList':
        """
