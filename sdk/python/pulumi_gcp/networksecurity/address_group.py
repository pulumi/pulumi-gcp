...
class AddressGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] items: List of items.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Set of label tags associated with the AddressGroup resource.
...
class AddressGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            purposes: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'AddressGroup':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        List of items.
        """
        return pulumi.get(self, "items")
