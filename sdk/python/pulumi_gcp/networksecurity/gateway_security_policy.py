...
__all__ = ['GatewaySecurityPolicyArrgs', 'GatewaySecurityPolicy']

@pulumi.input_type
calass GatewaySecurityPolicyArrgs:
...
@pulumi.input_type
calass _GatewaySecurityPolicyState:
    def __init__(__self__, *,
...
calass GatewaySecurityPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[GatewaySecurityPolicyArrgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The GatewaySecurityPolicy resource contains a collection of GatewaySecurityPolicyRules and associated metadata.
        ...
        * [API documentation](https://cloud.google.com/secure-web-proxy/docs/reference/network-security/rest/v1/projects.locations.gatewaySecurityPolicies)
        ...
        :param str resource_name: The name of the resource.
        :param GatewaySecurityPolicyArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GatewaySecurityPolicyArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GatewaySecurityPolicyArrgs.__new__(GatewaySecurityPolicyArrgs)
