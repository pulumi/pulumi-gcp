...
def get_iam_policy(data_policy_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The name of the location of the data policy.
...
def get_iam_policy_output(data_policy_id: Optional[pulumi.Input[_builtins.str]] = None,
