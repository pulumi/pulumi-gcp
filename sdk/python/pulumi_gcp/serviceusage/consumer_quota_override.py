...
class ConsumerQuotaOverrideArgs:
    def __init__(__self__, *,
                 limit: pulumi.Input[builtins.str],
                 metric: pulumi.Input[builtins.str],
                 override_value: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] dimensions: If this map is nonempty, then this override applies only to specific values for dimensions defined in the limit unit.
        :param pulumi.Input[builtins.bool] force: If the new quota would decrease the existing quota by more than 10%, the request is rejected.
    ...
    @property
    @pulumi.getter
    def limit(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @limit.setter
    def limit(self, value: pulumi.Input[builtins.str]):
    ...
    def override_value(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def override_value(self, value: pulumi.Input[builtins.str]):
...
class _ConsumerQuotaOverrideState:
    def __init__(__self__, *,
                 ...
                 override_value: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="overrideValue")
    def override_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The overriding quota limit value. Can be any nonnegative integer, or -1 (unlimited quota).
        """
        return pulumi.get(self, "override_value")
    ...
    @override_value.setter
    def override_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "override_value", value)
...
class ConsumerQuotaOverride(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            override_value: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None) -> 'ConsumerQuotaOverride':
        """
    ...
    @property
    @pulumi.getter
    def limit(self) -> pulumi.Output[builtins.str]:
        """
        The limit on the metric, e.g. `/project/region`.
        > Make sure that `limit` is in a format that doesn't start with `1/` or contain curly braces.
        E.g. use `/project/user` instead of `1/{project}/{user}`.
    ...
    @property
    @pulumi.getter(name="overrideValue")
    def override_value(self) -> pulumi.Output[builtins.str]:
        """
        The overriding quota limit value. Can be any nonnegative integer, or -1 (unlimited quota).
        """
        return pulumi.get(self, "override_value")
