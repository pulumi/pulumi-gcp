...
def get_regional_parameter_version(location: Optional[builtins.str] = None,
    ...
    :param builtins.str project: The project for retrieving the Regional Parameter Version. If it's not specified, 
...
def get_regional_parameter_version_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
