...
class ParameterArgs:
    def __init__(__self__, *,
                 parameter_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] kms_key: The resource name of the Cloud KMS CryptoKey used to encrypt parameter version payload. Format
               `projects/{{project}}/locations/global/keyRings/{{key_ring}}/cryptoKeys/{{crypto_key}}`
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to this Parameter.
    ...
    @parameter_id.setter
    def parameter_id(self, value: pulumi.Input[_builtins.str]):
...
class _ParameterState:
    ...
    @parameter_id.setter
    def parameter_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "parameter_id", value)

    @_builtins.property
    @pulumi.getter(name="policyMembers")
    def policy_members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ParameterPolicyMemberArgs']]]]:
        """
    ...
    def policy_members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ParameterPolicyMemberArgs']]]]):
