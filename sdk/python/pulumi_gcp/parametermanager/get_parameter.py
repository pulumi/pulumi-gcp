...
def get_parameter(parameter_id: Optional[builtins.str] = None,
    ...
    :param builtins.str parameter_id: The name of the parameter.
...
def get_parameter_output(parameter_id: Optional[pulumi.Input[builtins.str]] = None,
