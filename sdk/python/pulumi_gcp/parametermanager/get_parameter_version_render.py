...
def get_parameter_version_render(parameter: Optional[_builtins.str] = None,
...
def get_parameter_version_render_output(parameter: Optional[pulumi.Input[_builtins.str]] = None,
