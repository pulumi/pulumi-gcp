...
def get_parameter_version_render(parameter: Optional[builtins.str] = None,
...
def get_parameter_version_render_output(parameter: Optional[pulumi.Input[builtins.str]] = None,
