...
def get_regional_parameter_version_render(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: Location of Parameter Manager regional Parameter resource.
    ...
    :param _builtins.str project: The project for retrieving the Regional Parameter Version. If it's not
