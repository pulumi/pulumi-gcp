...
def get_parameter_version(parameter: Optional[builtins.str] = None,
    ...
    :param builtins.str parameter: The parameter for obtaining the Parameter Version.
    ...
    :param builtins.str parameter_version_id: The version of the parameter to get.
    :param builtins.str project: The project for retrieving the Parameter Version. If it's not specified, 
...
def get_parameter_version_output(parameter: Optional[pulumi.Input[builtins.str]] = None,
