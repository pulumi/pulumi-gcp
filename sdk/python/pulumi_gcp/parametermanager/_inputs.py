...
class ParameterPolicyMemberArgsDict(TypedDict):
    iam_policy_name_principal: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
    ...
    """
    iam_policy_uid_principal: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
...
class ParameterPolicyMemberArgs:
    def __init__(__self__, *,
                 iam_policy_name_principal: pulumi.Input[Optional[_builtins.str]] = None,
                 iam_policy_uid_principal: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] iam_policy_name_principal: (Output)
               IAM policy binding member referring to a Google Cloud resource by user-assigned name. If a
               resource is deleted and recreated with the same name, the binding will be applicable to the
               new resource. Format:
               `principal://parametermanager.googleapis.com/projects/{{project}}/name/locations/global/parameters/{{parameter_id}}`
        :param pulumi.Input[_builtins.str] iam_policy_uid_principal: (Output)
               IAM policy binding member referring to a Google Cloud resource by system-assigned unique identifier.
               If a resource is deleted and recreated with the same name, the binding will not be applicable to the
               new resource. Format:
               `principal://parametermanager.googleapis.com/projects/{{project}}/uid/locations/global/parameters/{{uid}}`
    ...
    def iam_policy_name_principal(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        IAM policy binding member referring to a Google Cloud resource by user-assigned name. If a
        resource is deleted and recreated with the same name, the binding will be applicable to the
    ...
    def iam_policy_name_principal(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "iam_policy_name_principal", value)

    @_builtins.property
    @pulumi.getter(name="iamPolicyUidPrincipal")
    def iam_policy_uid_principal(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        IAM policy binding member referring to a Google Cloud resource by system-assigned unique identifier.
        If a resource is deleted and recreated with the same name, the binding will not be applicable to the
    ...
    def iam_policy_uid_principal(self, value: pulumi.Input[Optional[_builtins.str]]):
