...
class ParameterPolicyMemberArgs:
    def __init__(__self__, *,
                 iam_policy_name_principal: Optional[pulumi.Input[_builtins.str]] = None,
                 iam_policy_uid_principal: Optional[pulumi.Input[_builtins.str]] = None):
        """
    ...
    def iam_policy_name_principal(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def iam_policy_uid_principal(self, value: Optional[pulumi.Input[_builtins.str]]):
