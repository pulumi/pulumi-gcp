...
class RegionalParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key: The resource name of the Cloud KMS CryptoKey used to encrypt regional parameter version payload. Format
               `projects/{{project}}/locations/{{location}}/keyRings/{{key_ring}}/cryptoKeys/{{crypto_key}}`
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to this regional Parameter.
...
class _RegionalParameterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to this regional Parameter.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location of the regional parameter. eg us-central1
        :param pulumi.Input[_builtins.str] name: The resource name of the regional Parameter. Format:
    ...
    def policy_members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RegionalParameterPolicyMemberArgs']]]]:
        """
    ...
    def policy_members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RegionalParameterPolicyMemberArgs']]]]):
...
class RegionalParameter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] name: The resource name of the regional Parameter. Format:
               `projects/{{project}}/locations/{{location}}/parameters/{{parameter_id}}`
        :param pulumi.Input[_builtins.str] parameter_id: This must be unique within the project.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RegionalParameterPolicyMemberArgs', 'RegionalParameterPolicyMemberArgsDict', 'outputs.RegionalParameterPolicyMember']]]] policy_members: An object containing a unique resource identity tied to the regional parameter.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
