...
class PreventionDiscoveryConfigArgs:
    def __init__(__self__, *,
                 ...
                 inspect_templates: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input['PreventionDiscoveryConfigOrgConfigArgs'] org_config: A nested object resource.
               Structure is documented below.
        :param pulumi.Input[builtins.str] status: Required. A status for this configuration
    ...
    def inspect_templates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def inspect_templates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _PreventionDiscoveryConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PreventionDiscoveryConfigActionArgs']]] actions: Actions to execute at the completion of scanning
               Structure is documented below.
        :param pulumi.Input[builtins.str] create_time: Output only. The creation timestamp of a DiscoveryConfig.
        :param pulumi.Input[builtins.str] display_name: Display Name (max 1000 Chars)
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PreventionDiscoveryConfigTargetArgs']]] targets: Target to match against for determining what to scan and how frequently
               Structure is documented below.
        :param pulumi.Input[builtins.str] update_time: Output only. The last update timestamp of a DiscoveryConfig.
        """
        if actions is not None:
            pulumi.set(__self__, "actions", actions)
...
class PreventionDiscoveryConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PreventionDiscoveryConfigTargetArgs', 'PreventionDiscoveryConfigTargetArgsDict']]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'PreventionDiscoveryConfig':
        """
    ...
    @property
    @pulumi.getter(name="inspectTemplates")
    def inspect_templates(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Detection logic for profile generation
        """
        return pulumi.get(self, "inspect_templates")
