...
class PreventionDeidentifyTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] parent: The parent of the template in any of the following formats:
               * `projects/{{project}}`
...
class _PreventionDeidentifyTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The creation timestamp of an deidentifyTemplate. Set by the server.
        :param pulumi.Input['PreventionDeidentifyTemplateDeidentifyConfigArgs'] deidentify_config: Configuration of the deidentify template
               Structure is documented below.
        :param pulumi.Input[builtins.str] description: A description of the template.
        :param pulumi.Input[builtins.str] display_name: User set display name of the template.
        :param pulumi.Input[builtins.str] name: The resource name of the template. Set by the server.
        :param pulumi.Input[builtins.str] parent: The parent of the template in any of the following formats:
               * `projects/{{project}}`
               * `projects/{{project}}/locations/{{location}}`
               * `organizations/{{organization_id}}`
...
class PreventionDeidentifyTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent: Optional[pulumi.Input[builtins.str]] = None,
            template_id: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'PreventionDeidentifyTemplate':
        """
