...
def get_backup(backup_vault_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project: The Google Cloud Project in which the Backup belongs.
    """
    __args__ = dict()
...
def get_backup_output(backup_vault_id: Optional[pulumi.Input[builtins.str]] = None,
