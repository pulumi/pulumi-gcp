...
def get_backup_plan_association(backup_plan_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str backup_plan_association_id: The id of Backupplan association resource.
           
           - - -
    :param builtins.str location: The location in which the Backupplan association resource belongs.
    """
    __args__ = dict()
...
def get_backup_plan_association_output(backup_plan_association_id: Optional[pulumi.Input[builtins.str]] = None,
