...
class BackupPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 backup_plan_id: pulumi.Input[Optional[_builtins.str]] = None,
                 backup_rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BackupPlanBackupRuleArgs', 'BackupPlanBackupRuleArgsDict']]]]] = None,
                 backup_vault: pulumi.Input[Optional[_builtins.str]] = None,
                 compute_instance_backup_plan_properties: pulumi.Input[Optional[Union['BackupPlanComputeInstanceBackupPlanPropertiesArgs', 'BackupPlanComputeInstanceBackupPlanPropertiesArgsDict']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 disk_backup_plan_properties: pulumi.Input[Optional[Union['BackupPlanDiskBackupPlanPropertiesArgs', 'BackupPlanDiskBackupPlanPropertiesArgsDict']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 log_retention_days: pulumi.Input[Optional[_builtins.int]] = None,
                 max_custom_on_demand_retention_days: pulumi.Input[Optional[_builtins.int]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{location}}/{{backup_plan_id}}`
        ...
        :param pulumi.Input[_builtins.str] backup_plan_id: The ID of the backup plan
        :param pulumi.Input[Sequence[pulumi.Input[Union['BackupPlanBackupRuleArgs', 'BackupPlanBackupRuleArgsDict']]]] backup_rules: The backup rules for this `BackupPlan`.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] backup_vault: Backup vault where the backups gets stored using this Backup plan.
        :param pulumi.Input[Union['BackupPlanComputeInstanceBackupPlanPropertiesArgs', 'BackupPlanComputeInstanceBackupPlanPropertiesArgsDict']] compute_instance_backup_plan_properties: Defines optional compute instance related properties for backups generated by this plan.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
               ...
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] description: The description allows for additional details about `BackupPlan` and its use cases to be provided.
        :param pulumi.Input[Union['BackupPlanDiskBackupPlanPropertiesArgs', 'BackupPlanDiskBackupPlanPropertiesArgsDict']] disk_backup_plan_properties: Defines optional disk related properties for backups generated by this plan.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] location: The location for the backup plan
        :param pulumi.Input[_builtins.int] log_retention_days: This is only applicable for CloudSql resource. Days for which logs will be stored. This value should be greater than or equal to minimum enforced log retention duration of the backup vault.
        :param pulumi.Input[_builtins.int] max_custom_on_demand_retention_days: The maximum number of days for which an on-demand backup taken with custom retention can be retained.
