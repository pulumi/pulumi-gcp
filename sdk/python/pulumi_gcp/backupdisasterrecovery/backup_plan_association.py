...
class BackupPlanAssociationArgs:
    def __init__(__self__, *,
                 backup_plan: pulumi.Input[builtins.str],
                 backup_plan_association_id: pulumi.Input[builtins.str],
    ...
    @backup_plan.setter
    def backup_plan(self, value: pulumi.Input[builtins.str]):
    ...
    def backup_plan_association_id(self, value: pulumi.Input[builtins.str]):
...
class _BackupPlanAssociationState:
    def __init__(__self__, *,
                 backup_plan: Optional[pulumi.Input[builtins.str]] = None,
                 backup_plan_association_id: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 data_source: Optional[pulumi.Input[builtins.str]] = None,
                 last_successful_backup_consistency_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] location: The location for the backupplan association
        :param pulumi.Input[builtins.str] name: The name of backup plan association resource created
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] resource: The resource for which BPA needs to be created
        :param pulumi.Input[builtins.str] resource_type: The resource type of workload on which backupplan is applied
    ...
    @backup_plan.setter
    def backup_plan(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "backup_plan", value)
    ...
    @backup_plan_association_id.setter
    def backup_plan_association_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "backup_plan_association_id", value)
    ...
    def last_successful_backup_consistency_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_successful_backup_consistency_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackupPlanAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPlanAssociation':
        """
    ...
    @property
    @pulumi.getter(name="lastSuccessfulBackupConsistencyTime")
    def last_successful_backup_consistency_time(self) -> pulumi.Output[builtins.str]:
        """
        The point in time when the last successful backup was captured from the source
        """
        return pulumi.get(self, "last_successful_backup_consistency_time")
