...
class ManagementServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of management server (management console).
...
class _ManagementServerState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input['ManagementServerNetworkArgs']]]] = None,
                 oauth2_client_id: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def oauth2_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oauth2_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagementServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            oauth2_client_id: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagementServer':
        """
    ...
    @property
    @pulumi.getter(name="oauth2ClientId")
    def oauth2_client_id(self) -> pulumi.Output[builtins.str]:
        """
        The oauth2ClientId of management console.
        """
        return pulumi.get(self, "oauth2_client_id")
