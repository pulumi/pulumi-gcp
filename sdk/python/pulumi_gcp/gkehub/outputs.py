...
class FeatureFleetDefaultMemberConfigConfigmanagement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 management: Optional[builtins.str] = None,
        ...
        :param 'FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncArgs' config_sync: ConfigSync configuration for the cluster
               Structure is documented below.
        :param builtins.str management: Set this field to MANAGEMENT_AUTOMATIC to enable Config Sync auto-upgrades, and set this field to MANAGEMENT_MANUAL or MANAGEMENT_UNSPECIFIED to disable Config Sync auto-upgrades.
               Possible values are: `MANAGEMENT_UNSPECIFIED`, `MANAGEMENT_AUTOMATIC`, `MANAGEMENT_MANUAL`.
        :param builtins.str version: Version of Config Sync installed
        """
    ...
    @property
    @pulumi.getter
    def management(self) -> Optional[builtins.str]:
        """
...
class FeatureFleetDefaultMemberConfigConfigmanagementConfigSync(dict):
    ...
    def __init__(__self__, *,
                 ...
                 prevent_drift: Optional[builtins.bool] = None,
        ...
        :param 'FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGitArgs' git: Git repo configuration for the cluster
               Structure is documented below.
        :param builtins.str metrics_gcp_service_account_email: The Email of the Google Cloud Service Account (GSA) used for exporting Config Sync metrics to Cloud Monitoring. The GSA should have the Monitoring Metric Writer(roles/monitoring.metricWriter) IAM role. The Kubernetes ServiceAccount `default` in the namespace `config-management-monitoring` should be bound to the GSA.
        :param 'FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOciArgs' oci: OCI repo configuration for the cluster
               Structure is documented below.
        :param builtins.bool prevent_drift: Set to true to enable the Config Sync admission webhook to prevent drifts. If set to `false`, disables the Config Sync admission webhook and does not prevent drifts.
    ...
    def metrics_gcp_service_account_email(self) -> Optional[builtins.str]:
        """
    ...
    def prevent_drift(self) -> Optional[builtins.bool]:
        """
...
class FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGit(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gcp_service_account_email: Optional[builtins.str] = None,
                 https_proxy: Optional[builtins.str] = None,
                 policy_dir: Optional[builtins.str] = None,
                 sync_branch: Optional[builtins.str] = None,
                 sync_repo: Optional[builtins.str] = None,
                 sync_rev: Optional[builtins.str] = None,
                 sync_wait_secs: Optional[builtins.str] = None):
        """
        :param builtins.str secret_type: Type of secret configured for access to the Git repo
        :param builtins.str gcp_service_account_email: The Google Cloud Service Account Email used for auth when secretType is gcpServiceAccount
        :param builtins.str https_proxy: URL for the HTTPS Proxy to be used when communicating with the Git repo
        :param builtins.str policy_dir: The path within the Git repository that represents the top level of the repo to sync
        :param builtins.str sync_branch: The branch of the repository to sync from. Default: master
        :param builtins.str sync_repo: The URL of the Git repository to use as the source of truth
        :param builtins.str sync_rev: Git revision (tag or hash) to check out. Default HEAD
        :param builtins.str sync_wait_secs: Period in seconds between consecutive syncs. Default: 15
        """
    ...
    def gcp_service_account_email(self) -> Optional[builtins.str]:
        """
    ...
    def policy_dir(self) -> Optional[builtins.str]:
        """
    ...
    def sync_branch(self) -> Optional[builtins.str]:
        """
    ...
    def sync_repo(self) -> Optional[builtins.str]:
        """
    ...
    def sync_rev(self) -> Optional[builtins.str]:
        """
    ...
    def sync_wait_secs(self) -> Optional[builtins.str]:
        """
...
class FeatureFleetDefaultMemberConfigConfigmanagementConfigSyncOci(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_type: Type of secret configured for access to the Git repo
        :param builtins.str gcp_service_account_email: The Google Cloud Service Account Email used for auth when secretType is gcpServiceAccount
        :param builtins.str policy_dir: The absolute path of the directory that contains the local resources. Default: the root directory of the image
        :param builtins.str sync_repo: The OCI image repository URL for the package to sync from
        :param builtins.str sync_wait_secs: Period in seconds between consecutive syncs. Default: 15
        :param builtins.str version: (Optional, Deprecated)
               Version of Config Sync installed
...
class FeatureFleetDefaultMemberConfigMesh(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str management: Whether to automatically manage Service Mesh
               Possible values are: `MANAGEMENT_UNSPECIFIED`, `MANAGEMENT_AUTOMATIC`, `MANAGEMENT_MANUAL`.
        """
        pulumi.set(__self__, "management", management)
...
class FeatureFleetDefaultMemberConfigPolicycontroller(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigArgs' policy_controller_hub_config: Configuration of Policy Controller
               Structure is documented below.
        :param builtins.str version: Configures the version of Policy Controller
        """
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 audit_interval_seconds: Optional[builtins.int] = None,
                 constraint_violation_limit: Optional[builtins.int] = None,
                 ...
                 exemptable_namespaces: Optional[Sequence[builtins.str]] = None,
                 log_denies_enabled: Optional[builtins.bool] = None,
                 monitoring: Optional['outputs.FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoring'] = None,
                 mutation_enabled: Optional[builtins.bool] = None,
                 ...
                 referential_rules_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str install_spec: Configures the mode of the Policy Controller installation
        ...
        :param builtins.int audit_interval_seconds: Interval for Policy Controller Audit scans (in seconds). When set to 0, this disables audit functionality altogether.
        :param builtins.int constraint_violation_limit: The maximum number of audit violations to be stored in a constraint. If not set, the internal default of 20 will be used.
        :param Sequence['FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigArgs'] deployment_configs: Map of deployment configs to deployments ("admission", "audit", "mutation").
               Structure is documented below.
        :param Sequence[builtins.str] exemptable_namespaces: The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster.
        :param builtins.bool log_denies_enabled: Logs all denies and dry run failures.
        :param 'FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoringArgs' monitoring: Monitoring specifies the configuration of monitoring Policy Controller.
               Structure is documented below.
        :param builtins.bool mutation_enabled: Enables the ability to mutate resources using Policy Controller.
        :param 'FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentArgs' policy_content: Specifies the desired policy content on the cluster.
               Structure is documented below.
        :param builtins.bool referential_rules_enabled: Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
        """
    ...
    def audit_interval_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def constraint_violation_limit(self) -> Optional[builtins.int]:
        """
    ...
    def exemptable_namespaces(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def log_denies_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def mutation_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def referential_rules_enabled(self) -> Optional[builtins.bool]:
        """
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str component: The identifier for this object. Format specified above.
        :param 'FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourcesArgs' container_resources: Container resource requirements.
               Structure is documented below.
        :param builtins.str pod_affinity: Pod affinity configuration.
        ...
        :param Sequence['FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigPodTolerationArgs'] pod_tolerations: Pod tolerations of node taints.
               Structure is documented below.
        :param builtins.int replica_count: Pod replica count.
        """
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigContainerResourcesLimits(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cpu: CPU requirement expressed in Kubernetes resource units.
        :param builtins.str memory: Memory requirement expressed in Kubernetes resource units.
        """
        if cpu is not None:
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigDeploymentConfigPodToleration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str effect: Matches a taint effect.
        :param builtins.str key: Matches a taint key (not necessarily unique).
        :param builtins.str operator: Matches a taint operator.
        :param builtins.str value: Matches a taint value.
        """
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoring(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] backends: Specifies the list of backends Policy Controller will export to. An empty list would effectively disable metrics export.
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentBundle(dict):
    ...
    def __init__(__self__, *,
                 bundle: builtins.str,
                 exempted_namespaces: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str bundle: The identifier for this object. Format specified above.
        :param Sequence[builtins.str] exempted_namespaces: The set of namespaces to be exempted from the bundle.
        """
    ...
    def exempted_namespaces(self) -> Optional[Sequence[builtins.str]]:
        """
...
class FeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary(dict):
    def __init__(__self__, *,
                 installation: Optional[builtins.str] = None):
        """
        :param builtins.str installation: Configures the manner in which the template library is installed on the cluster.
    ...
    @property
    @pulumi.getter
    def installation(self) -> Optional[builtins.str]:
        """
...
class FeatureMembershipConfigmanagementBinauthz(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Whether binauthz is enabled in this cluster.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class FeatureMembershipConfigmanagementConfigSync(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool prevent_drift: Supported from Config Sync versions 1.10.0 onwards. Set to `true` to enable the Config Sync admission webhook to prevent drifts. If set to `false`, disables the Config Sync admission webhook and does not prevent drifts.
        :param builtins.str source_format: Specifies whether the Config Sync Repo is in "hierarchical" or "unstructured" mode.
    ...
    def stop_syncing(self) -> Optional[builtins.bool]:
        """
...
class FeatureMembershipConfigmanagementConfigSyncGit(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sync_wait_secs: Optional[builtins.str] = None):
        """
        :param builtins.str gcp_service_account_email: The GCP Service Account Email used for auth when secretType is gcpServiceAccount.
        :param builtins.str https_proxy: URL for the HTTPS proxy to be used when communicating with the Git repo.
        :param builtins.str policy_dir: The path within the Git repository that represents the top level of the repo to sync. Default: the root directory of the repository.
        :param builtins.str secret_type: Type of secret configured for access to the Git repo.
        :param builtins.str sync_branch: The branch of the repository to sync from. Default: master.
        :param builtins.str sync_repo: The URL of the Git repository to use as the source of truth.
        :param builtins.str sync_rev: Git revision (tag or hash) to check out. Default HEAD.
...
class FeatureMembershipConfigmanagementConfigSyncOci(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sync_wait_secs: Optional[builtins.str] = None):
        """
        :param builtins.str gcp_service_account_email: The GCP Service Account Email used for auth when secret_type is gcpserviceaccount.
        :param builtins.str policy_dir: The absolute path of the directory that contains the local resources. Default: the root directory of the image.
        :param builtins.str secret_type: Type of secret configured for access to the OCI Image. Must be one of gcenode, gcpserviceaccount or none.
        :param builtins.str sync_repo: The OCI image repository URL for the package to sync from. e.g. LOCATION-docker.pkg.dev/PROJECT_ID/REPOSITORY_NAME/PACKAGE_NAME.
        :param builtins.str sync_wait_secs: Period in seconds(int64 format) between consecutive syncs. Default: 15.
        """
        if gcp_service_account_email is not None:
            pulumi.set(__self__, "gcp_service_account_email", gcp_service_account_email)
        if policy_dir is not None:
...
class FeatureMembershipConfigmanagementHierarchyController(dict):
    ...
    def __init__(__self__, *,
                 enable_hierarchical_resource_quota: Optional[builtins.bool] = None,
                 enable_pod_tree_labels: Optional[builtins.bool] = None,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_hierarchical_resource_quota: Whether hierarchical resource quota is enabled in this cluster.
        :param builtins.bool enable_pod_tree_labels: Whether pod tree labels are enabled in this cluster.
        :param builtins.bool enabled: Whether Hierarchy Controller is enabled in this cluster.
        """
    ...
    def enable_hierarchical_resource_quota(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_pod_tree_labels(self) -> Optional[builtins.bool]:
        """
...
class FeatureMembershipConfigmanagementPolicyController(dict):
    ...
    def __init__(__self__, *,
                 audit_interval_seconds: Optional[builtins.str] = None,
                 enabled: Optional[builtins.bool] = None,
                 exemptable_namespaces: Optional[Sequence[builtins.str]] = None,
                 log_denies_enabled: Optional[builtins.bool] = None,
                 ...
                 mutation_enabled: Optional[builtins.bool] = None,
                 referential_rules_enabled: Optional[builtins.bool] = None,
                 template_library_installed: Optional[builtins.bool] = None):
        """
        :param builtins.str audit_interval_seconds: Sets the interval for Policy Controller Audit Scans (in seconds). When set to 0, this disables audit functionality altogether.
        :param builtins.bool enabled: Enables the installation of Policy Controller. If false, the rest of PolicyController fields take no effect.
        :param Sequence[builtins.str] exemptable_namespaces: The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster.
        :param builtins.bool log_denies_enabled: Logs all denies and dry run failures.
        ...
        :param builtins.bool mutation_enabled: Enables mutation in policy controller. If true, mutation CRDs, webhook, and controller deployment will be deployed to the cluster.
        :param builtins.bool referential_rules_enabled: Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
        :param builtins.bool template_library_installed: Installs the default template library along with Policy Controller.
        """
        if audit_interval_seconds is not None:
            pulumi.set(__self__, "audit_interval_seconds", audit_interval_seconds)
        if enabled is not None:
    ...
    @property
    @pulumi.getter(name="auditIntervalSeconds")
    def audit_interval_seconds(self) -> Optional[builtins.str]:
        """
    ...
    def template_library_installed(self) -> Optional[builtins.bool]:
        """
...
class FeatureMembershipConfigmanagementPolicyControllerMonitoring(dict):
    def __init__(__self__, *,
                 backends: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] backends: Specifies the list of backends Policy Controller will export to. Must be one of `CLOUD_MONITORING` or `PROMETHEUS`. Defaults to [`CLOUD_MONITORING`, `PROMETHEUS`]. Specifying an empty value `[]` disables metrics export.
        """
        if backends is not None:
            pulumi.set(__self__, "backends", backends)
...
class FeatureMembershipMesh(dict):
    ...
    def __init__(__self__, *,
                 control_plane: Optional[builtins.str] = None,
                 management: Optional[builtins.str] = None):
        """
        :param builtins.str control_plane: **DEPRECATED** Whether to automatically manage Service Mesh control planes. Possible values: CONTROL_PLANE_MANAGEMENT_UNSPECIFIED, AUTOMATIC, MANUAL
        :param builtins.str management: Whether to automatically manage Service Mesh. Can either be `MANAGEMENT_AUTOMATIC` or `MANAGEMENT_MANUAL`.
        """
    ...
    def control_plane(self) -> Optional[builtins.str]:
        """
...
class FeatureMembershipPolicycontroller(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str version: Version of Policy Controller to install. Defaults to the latest version.
        """
        pulumi.set(__self__, "policy_controller_hub_config", policy_controller_hub_config)
        if version is not None:
            pulumi.set(__self__, "version", version)
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exemptable_namespaces: Optional[Sequence[builtins.str]] = None,
                 install_spec: Optional[builtins.str] = None,
                 log_denies_enabled: Optional[builtins.bool] = None,
                 ...
                 referential_rules_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.int audit_interval_seconds: Sets the interval for Policy Controller Audit Scans (in seconds). When set to 0, this disables audit functionality altogether.
        :param builtins.int constraint_violation_limit: The maximum number of audit violations to be stored in a constraint. If not set, the  default of 20 will be used.
        ...
        :param Sequence[builtins.str] exemptable_namespaces: The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster.
        :param builtins.str install_spec: Configures the mode of the Policy Controller installation. Must be one of `INSTALL_SPEC_NOT_INSTALLED`, `INSTALL_SPEC_ENABLED`, `INSTALL_SPEC_SUSPENDED` or `INSTALL_SPEC_DETACHED`.
        :param builtins.bool log_denies_enabled: Logs all denies and dry run failures.
    ...
    @property
    @pulumi.getter(name="installSpec")
    def install_spec(self) -> Optional[builtins.str]:
        """
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfigDeploymentConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replica_count: Optional[builtins.int] = None):
        """
        :param builtins.str component_name: The name of the component. One of `admission` `audit` or `mutation`
        ...
        :param builtins.str pod_affinity: Pod affinity configuration. Possible values: AFFINITY_UNSPECIFIED, NO_AFFINITY, ANTI_AFFINITY
...
class FeatureMembershipPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibrary(dict):
    def __init__(__self__, *,
                 installation: Optional[builtins.str] = None):
        """
        :param builtins.str installation: Configures the manner in which the template library is installed on the cluster. Must be one of `ALL`, `NOT_INSTALLED` or `INSTALLATION_UNSPECIFIED`. Defaults to `ALL`.
        """
        if installation is not None:
            pulumi.set(__self__, "installation", installation)
...
class FeatureResourceState(dict):
    ...
    def __init__(__self__, *,
                 has_resources: Optional[builtins.bool] = None,
                 state: Optional[builtins.str] = None):
        """
        :param builtins.bool has_resources: (Output)
    ...
    def has_resources(self) -> Optional[builtins.bool]:
        """
        (Output)
        Whether this Feature has outstanding resources that need to be cleaned up before it can be disabled.
        """
...
class FeatureSpecClusterupgrade(dict):
    ...
    def __init__(__self__, *,
                 upstream_fleets: Sequence[builtins.str],
        ...
        """
        :param Sequence[builtins.str] upstream_fleets: Specified if other fleet should be considered as a source of upgrades. Currently, at most one upstream fleet is allowed. The fleet name should be either fleet project number or id.
    ...
    def upstream_fleets(self) -> Sequence[builtins.str]:
        """
...
class FeatureSpecClusterupgradeGkeUpgradeOverridePostConditions(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str soaking: Amount of time to "soak" after a rollout has been finished before marking it COMPLETE. Cannot exceed 30 days.
        """
...
class FeatureSpecFleetobservabilityLoggingConfigDefaultConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str mode: Specified if fleet logging feature is enabled.
...
class FeatureSpecMulticlusteringress(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str config_membership: Fully-qualified Membership name which hosts the MultiClusterIngress CRD. Example: `projects/foo-proj/locations/global/memberships/bar`
        """
...
class FleetDefaultClusterConfigBinaryAuthorizationConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str evaluation_mode: Mode of operation for binauthz policy evaluation.
...
class FleetDefaultClusterConfigBinaryAuthorizationConfigPolicyBinding(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The relative resource name of the binauthz platform policy to audit. GKE
...
class FleetDefaultClusterConfigSecurityPostureConfig(dict):
    ...
    def __init__(__self__, *,
                 mode: Optional[builtins.str] = None,
                 vulnerability_mode: Optional[builtins.str] = None):
        """
        :param builtins.str mode: Sets which mode to use for Security Posture features.
               Possible values are: `DISABLED`, `BASIC`, `ENTERPRISE`.
        :param builtins.str vulnerability_mode: Sets which mode to use for vulnerability scanning.
    ...
    def vulnerability_mode(self) -> Optional[builtins.str]:
        """
...
class GetFeatureFleetDefaultMemberConfigConfigmanagementResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str management: Set this field to MANAGEMENT_AUTOMATIC to enable Config Sync auto-upgrades, and set this field to MANAGEMENT_MANUAL or MANAGEMENT_UNSPECIFIED to disable Config Sync auto-upgrades. Possible values: ["MANAGEMENT_UNSPECIFIED", "MANAGEMENT_AUTOMATIC", "MANAGEMENT_MANUAL"]
        :param builtins.str version: Version of Config Sync installed
        """
...
class GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncResult(dict):
    ...
    @property
    @pulumi.getter(name="preventDrift")
    def prevent_drift(self) -> builtins.bool:
        """
        Set to true to enable the Config Sync admission webhook to prevent drifts. If set to 'false', disables the Config Sync admission webhook and does not prevent drifts.
        """
        return pulumi.get(self, "prevent_drift")
...
class GetFeatureFleetDefaultMemberConfigConfigmanagementConfigSyncGitResult(dict):
    def __init__(__self__, *,
                 ...
                 policy_dir: builtins.str,
                 secret_type: builtins.str,
                 sync_branch: builtins.str,
                 sync_repo: builtins.str,
                 sync_rev: builtins.str,
                 sync_wait_secs: builtins.str):
        """
        :param builtins.str gcp_service_account_email: The Google Cloud Service Account Email used for auth when secretType is gcpServiceAccount
        :param builtins.str https_proxy: URL for the HTTPS Proxy to be used when communicating with the Git repo
        :param builtins.str policy_dir: The path within the Git repository that represents the top level of the repo to sync
...
class GetFeatureFleetDefaultMemberConfigMeshResult(dict):
    def __init__(__self__, *,
                 management: builtins.str):
        """
        :param builtins.str management: Whether to automatically manage Service Mesh Possible values: ["MANAGEMENT_UNSPECIFIED", "MANAGEMENT_AUTOMATIC", "MANAGEMENT_MANUAL"]
        """
        pulumi.set(__self__, "management", management)
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigResult(dict):
    def __init__(__self__, *,
                 audit_interval_seconds: builtins.int,
                 constraint_violation_limit: builtins.int,
                 ...
                 referential_rules_enabled: builtins.bool):
        """
        :param builtins.int audit_interval_seconds: Interval for Policy Controller Audit scans (in seconds). When set to 0, this disables audit functionality altogether.
        :param builtins.int constraint_violation_limit: The maximum number of audit violations to be stored in a constraint. If not set, the internal default of 20 will be used.
        ...
        :param Sequence[builtins.str] exemptable_namespaces: The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster.
        :param builtins.str install_spec: Configures the mode of the Policy Controller installation Possible values: ["INSTALL_SPEC_UNSPECIFIED", "INSTALL_SPEC_NOT_INSTALLED", "INSTALL_SPEC_ENABLED", "INSTALL_SPEC_SUSPENDED", "INSTALL_SPEC_DETACHED"]
        :param builtins.bool log_denies_enabled: Logs all denies and dry run failures.
    ...
    @property
    @pulumi.getter(name="auditIntervalSeconds")
    def audit_interval_seconds(self) -> builtins.int:
        """
        Interval for Policy Controller Audit scans (in seconds). When set to 0, this disables audit functionality altogether.
        """
        return pulumi.get(self, "audit_interval_seconds")
    ...
    @property
    @pulumi.getter(name="constraintViolationLimit")
    def constraint_violation_limit(self) -> builtins.int:
        """
        The maximum number of audit violations to be stored in a constraint. If not set, the internal default of 20 will be used.
        """
        return pulumi.get(self, "constraint_violation_limit")
    ...
    @property
    @pulumi.getter(name="exemptableNamespaces")
    def exemptable_namespaces(self) -> Sequence[builtins.str]:
        """
        The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster.
        """
        return pulumi.get(self, "exemptable_namespaces")
    ...
    @property
    @pulumi.getter(name="logDeniesEnabled")
    def log_denies_enabled(self) -> builtins.bool:
        """
        Logs all denies and dry run failures.
        """
        return pulumi.get(self, "log_denies_enabled")
    ...
    @property
    @pulumi.getter(name="mutationEnabled")
    def mutation_enabled(self) -> builtins.bool:
        """
        Enables the ability to mutate resources using Policy Controller.
        """
        return pulumi.get(self, "mutation_enabled")
    ...
    @property
    @pulumi.getter(name="referentialRulesEnabled")
    def referential_rules_enabled(self) -> builtins.bool:
        """
        Enables the ability to use Constraint Templates that reference to objects other than the object currently being evaluated.
        """
        return pulumi.get(self, "referential_rules_enabled")
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigMonitoringResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] backends: Specifies the list of backends Policy Controller will export to. An empty list would effectively disable metrics export. Possible values: ["MONITORING_BACKEND_UNSPECIFIED", "PROMETHEUS", "CLOUD_MONITORING"]
        """
        pulumi.set(__self__, "backends", backends)
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentBundleResult(dict):
    def __init__(__self__, *,
                 bundle: builtins.str,
                 exempted_namespaces: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] exempted_namespaces: The set of namespaces to be exempted from the bundle.
        """
        pulumi.set(__self__, "bundle", bundle)
    ...
    @property
    @pulumi.getter(name="exemptedNamespaces")
    def exempted_namespaces(self) -> Sequence[builtins.str]:
        """
        The set of namespaces to be exempted from the bundle.
        """
        return pulumi.get(self, "exempted_namespaces")
...
class GetFeatureFleetDefaultMemberConfigPolicycontrollerPolicyControllerHubConfigPolicyContentTemplateLibraryResult(dict):
    def __init__(__self__, *,
                 installation: builtins.str):
        """
        :param builtins.str installation: Configures the manner in which the template library is installed on the cluster. Possible values: ["INSTALLATION_UNSPECIFIED", "NOT_INSTALLED", "ALL"]
        """
        pulumi.set(__self__, "installation", installation)
...
class GetFeatureResourceStateResult(dict):
    def __init__(__self__, *,
                 has_resources: builtins.bool,
                 state: builtins.str):
        """
        :param builtins.bool has_resources: Whether this Feature has outstanding resources that need to be cleaned up before it can be disabled.
        :param builtins.str state: The current state of the Feature resource in the Hub API.
        """
        pulumi.set(__self__, "has_resources", has_resources)
        pulumi.set(__self__, "state", state)
...
class GetFeatureSpecFleetobservabilityLoggingConfigDefaultConfigResult(dict):
    def __init__(__self__, *,
                 mode: builtins.str):
        """
        :param builtins.str mode: Specified if fleet logging feature is enabled. Possible values: ["MODE_UNSPECIFIED", "COPY", "MOVE"]
        """
        pulumi.set(__self__, "mode", mode)
...
class GetFeatureStateStateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str code: The high-level, machine-readable status of this Feature.
        :param builtins.str description: A human-readable description of the current status.
        :param builtins.str update_time: The time this status and any related Feature-specific details were updated. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z"
        """
        pulumi.set(__self__, "code", code)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "update_time", update_time)
...
class GetMembershipBindingStateResult(dict):
    def __init__(__self__, *,
                 code: builtins.str):
        """
        :param builtins.str code: Code describes the state of a MembershipBinding resource.
        """
        pulumi.set(__self__, "code", code)
