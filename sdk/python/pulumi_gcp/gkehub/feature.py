...
class FeatureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: GCP labels for this Feature.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] name: The full, unique name of this Feature resource
...
class _FeatureState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Output only. When the Feature resource was created.
        :param pulumi.Input[builtins.str] delete_time: Output only. When the Feature resource was deleted.
...
class Feature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Feature':
        """
