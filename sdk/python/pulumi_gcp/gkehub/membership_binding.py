...
class MembershipBindingArgs:
    def __init__(__self__, *,
                 ...
                 membership_binding_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] location: Location of the membership
               ...
               - - -
        :param pulumi.Input[builtins.str] membership_binding_id: The client-provided identifier of the membership binding.
        :param pulumi.Input[builtins.str] membership_id: Id of the membership
        :param pulumi.Input[builtins.str] scope: A Workspace resource name in the format
               `projects/*/locations/*/scopes/*`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels for this Membership binding.
    ...
    def membership_binding_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def membership_binding_id(self, value: pulumi.Input[builtins.str]):
...
class _MembershipBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Time the MembershipBinding was created in UTC.
        :param pulumi.Input[builtins.str] delete_time: Time the MembershipBinding was deleted in UTC.
        ...
        :param pulumi.Input[builtins.str] membership_binding_id: The client-provided identifier of the membership binding.
        :param pulumi.Input[builtins.str] membership_id: Id of the membership
        :param pulumi.Input[builtins.str] name: The resource name for the membershipbinding itself
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        ...
        :param pulumi.Input[builtins.str] update_time: Time the MembershipBinding was updated in UTC.
        """
    ...
    @property
    @pulumi.getter(name="membershipBindingId")
    def membership_binding_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The client-provided identifier of the membership binding.
        """
        return pulumi.get(self, "membership_binding_id")
    ...
    @membership_binding_id.setter
    def membership_binding_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "membership_binding_id", value)
...
class MembershipBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'MembershipBinding':
        """
    ...
    @property
    @pulumi.getter(name="membershipBindingId")
    def membership_binding_id(self) -> pulumi.Output[builtins.str]:
        """
        The client-provided identifier of the membership binding.
        """
        return pulumi.get(self, "membership_binding_id")
