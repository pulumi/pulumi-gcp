...
def get_membership_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: Location of the membership.
           The default value is `global`.
           Used to find the parent resource to bind the IAM policy to. If not specified,
           the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
           location is specified, it is taken from the provider configuration.
    :param _builtins.str membership_id: Used to find the parent resource to bind the IAM policy to
...
def get_membership_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
