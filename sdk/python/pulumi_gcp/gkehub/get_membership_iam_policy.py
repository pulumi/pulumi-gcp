...
def get_membership_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: Location of the membership.
...
def get_membership_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
