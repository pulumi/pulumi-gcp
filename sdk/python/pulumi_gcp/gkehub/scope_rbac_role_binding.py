...
class ScopeRbacRoleBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * How-to Guides
        ...
        scope = gcp.gkehub.Scope("scope", scope_id="tf-test-scope_59033")
        scope_rbac_role_binding = gcp.gkehub.ScopeRbacRoleBinding("scope_rbac_role_binding",
            scope_rbac_role_binding_id="tf-test-scope-rbac-role-binding_32081",
        ...
        scope = gcp.gkehub.Scope("scope", scope_id="tf-test-scope_10393")
        ...
        scope_rbac_role_binding = gcp.gkehub.ScopeRbacRoleBinding("scope_rbac_role_binding",
            scope_rbac_role_binding_id="tf-test-scope-rbac-role-binding_33052",
            scope_id=scope.scope_id,
            user="test-email@gmail.com",
            role={
