...
def get_feature_iam_policy(location: Optional[_builtins.str] = None,
...
def get_feature_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
