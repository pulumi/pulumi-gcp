...
@pulumi.output_type
calass GetFeatureIamPolicyResult:
    """
...
calass AwaitableGetFeatureIamPolicyResult(GetFeatureIamPolicyResult):
...
def get_feature_iam_policy(location: Optional[str] = None,
