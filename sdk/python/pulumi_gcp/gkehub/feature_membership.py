...
class FeatureMembershipArgs:
    def __init__(__self__, *,
                 ...
                 membership: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] feature: The name of the feature
        :param pulumi.Input[builtins.str] location: The location of the feature
        :param pulumi.Input[builtins.str] membership: The name of the membership
        ...
        :param pulumi.Input[builtins.str] membership_location: The location of the membership, for example, "us-central1". Default is "global".
        ...
        :param pulumi.Input[builtins.str] project: The project of the feature
        """
    ...
    @property
    @pulumi.getter
    def membership(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @membership.setter
    def membership(self, value: pulumi.Input[builtins.str]):
...
class FeatureMembership(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mesh: Optional[pulumi.Input[Union['FeatureMembershipMeshArgs', 'FeatureMembershipMeshArgsDict']]] = None,
            policycontroller: Optional[pulumi.Input[Union['FeatureMembershipPolicycontrollerArgs', 'FeatureMembershipPolicycontrollerArgsDict']]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'FeatureMembership':
        """
    ...
    @property
    @pulumi.getter
    def feature(self) -> pulumi.Output[builtins.str]:
        """
        The name of the feature
        """
        return pulumi.get(self, "feature")
    ...
    @property
    @pulumi.getter
    def membership(self) -> pulumi.Output[builtins.str]:
        """
        The name of the membership
        """
        return pulumi.get(self, "membership")
    ...
    @property
    @pulumi.getter(name="membershipLocation")
    def membership_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The location of the membership, for example, "us-central1". Default is "global".
        """
        return pulumi.get(self, "membership_location")
