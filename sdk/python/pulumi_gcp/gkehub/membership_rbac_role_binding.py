...
class MembershipRbacRoleBindingArgs:
    def __init__(__self__, *,
                 ...
                 membership_rbac_role_binding_id: pulumi.Input[builtins.str],
    ...
    def membership_rbac_role_binding_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def membership_rbac_role_binding_id(self, value: pulumi.Input[builtins.str]):
...
class _MembershipRbacRoleBindingState:
    def __init__(__self__, *,
                 ...
                 membership_rbac_role_binding_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="membershipRbacRoleBindingId")
    def membership_rbac_role_binding_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The client-provided identifier of the RBAC Role Binding.
        """
        return pulumi.get(self, "membership_rbac_role_binding_id")
    ...
    @membership_rbac_role_binding_id.setter
    def membership_rbac_role_binding_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "membership_rbac_role_binding_id", value)
...
@pulumi.type_token("gcp:gkehub/membershipRbacRoleBinding:MembershipRbacRoleBinding")
class MembershipRbacRoleBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        membership = gcp.gkehub.Membership("membership",
            membership_id="tf-test-membership_75413",
            endpoint={
                "gke_cluster": {
        ...
        membership_rbac_role_binding = gcp.gkehub.MembershipRbacRoleBinding("membership_rbac_role_binding",
            membership_rbac_role_binding_id="tf-test-membership-rbac-role-binding_55138",
    ...
    def get(resource_name: str,
            ...
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None) -> 'MembershipRbacRoleBinding':
        """
    ...
    @property
    @pulumi.getter(name="membershipRbacRoleBindingId")
    def membership_rbac_role_binding_id(self) -> pulumi.Output[builtins.str]:
        """
        The client-provided identifier of the RBAC Role Binding.
        """
        return pulumi.get(self, "membership_rbac_role_binding_id")
