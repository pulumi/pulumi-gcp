...
class BareMetalAdminClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bare_metal_version: A human readable description of this Bare Metal Admin Cluster.
...
class _BareMetalAdminClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A human readable description of this Bare Metal Admin Cluster.
        :param pulumi.Input[builtins.str] endpoint: The IP address name of Bare Metal Admin Cluster's API server.
        ...
        :param pulumi.Input['BareMetalAdminClusterLoadBalancerArgs'] load_balancer: Specifies the load balancer configuration.
               Structure is documented below.
        :param pulumi.Input[builtins.str] local_name: The object name of the Bare Metal Admin Cluster custom resource on the
        ...
        :param pulumi.Input['BareMetalAdminClusterProxyArgs'] proxy: Specifies the cluster proxy configuration.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] reconciling: If set, there are currently changes in flight to the Bare Metal Admin Cluster.
        :param pulumi.Input['BareMetalAdminClusterSecurityConfigArgs'] security_config: Specifies the security related settings for the Bare Metal User Cluster.
               Structure is documented below.
        ...
        :param pulumi.Input['BareMetalAdminClusterStorageArgs'] storage: Specifies the cluster storage configuration.
               Structure is documented below.
        :param pulumi.Input[builtins.str] uid: The unique identifier of the Bare Metal Admin Cluster.
...
class BareMetalAdminCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="bareMetalVersion")
    def bare_metal_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A human readable description of this Bare Metal Admin Cluster.
        """
        return pulumi.get(self, "bare_metal_version")
