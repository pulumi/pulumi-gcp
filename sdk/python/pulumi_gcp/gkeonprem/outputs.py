...
class BareMetalAdminClusterClusterOperations(dict):
    ...
    def __init__(__self__, *,
                 enable_application_logs: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool enable_application_logs: Whether collection of application logs/metrics should be enabled (in addition to system logs/metrics).
        """
...
class BareMetalAdminClusterControlPlaneApiServerArg(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str argument: The argument name as it appears on the API Server command line please make sure to remove the leading dashes.
        :param _builtins.str value: The value of the arg as it will be passed to the API Server command line.
        """
...
class BareMetalAdminClusterLoadBalancerManualLbConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Whether manual load balancing is enabled.
        """
...
class BareMetalAdminClusterLoadBalancerPortConfig(dict):
    ...
    def __init__(__self__, *,
                 control_plane_load_balancer_port: _builtins.int):
        """
        :param _builtins.int control_plane_load_balancer_port: The port that control plane hosted load balancers will listen on.
        """
...
class BareMetalAdminClusterLoadBalancerVipConfig(dict):
    ...
    def __init__(__self__, *,
                 control_plane_vip: _builtins.str):
        """
        :param _builtins.str control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this Bare Metal Admin Cluster.
        """
...
class BareMetalAdminClusterMaintenanceConfig(dict):
    ...
    def __init__(__self__, *,
                 maintenance_address_cidr_blocks: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] maintenance_address_cidr_blocks: All IPv4 address from these ranges will be placed into maintenance mode.
...
class BareMetalAdminClusterNetworkConfigIslandModeCidr(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] pod_address_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        :param Sequence[_builtins.str] service_address_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        """
...
class BareMetalAdminClusterNodeAccessConfig(dict):
    ...
    def __init__(__self__, *,
                 login_user: Optional[_builtins.str] = None):
        """
        :param _builtins.str login_user: LoginUser is the user name used to access node machines.
...
class BareMetalAdminClusterNodeConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int max_pods_per_node: The maximum number of pods a node can run. The size of the CIDR range
...
class BareMetalAdminClusterProxy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str uri: Specifies the address of your proxy server.
               For Example: http://domain
               WARNING: Do not provide credentials in the format
               of http://(username:password@)domain these will be rejected by the server.
        :param Sequence[_builtins.str] no_proxies: A list of IPs, hostnames, and domains that should skip the proxy.
...
class BareMetalAdminClusterStorageLvpNodeMountsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str path: The host machine path.
        :param _builtins.str storage_class: The StorageClass name that PVs will be created with.
        """
...
class BareMetalAdminClusterStorageLvpShareConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 shared_path_pv_count: Optional[_builtins.int] = None):
        """
        :param 'BareMetalAdminClusterStorageLvpShareConfigLvpConfigArgs' lvp_config: Defines the machine path and storage class for the LVP Share.
               Structure is documented below.
        :param _builtins.int shared_path_pv_count: The number of subdirectories to create under path.
        """
...
class BareMetalAdminClusterValidationCheck(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str options: (Output)
               Options used for the validation check.
        :param _builtins.str scenario: (Output)
...
class BareMetalAdminClusterValidationCheckStatusResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str description: A human readable description of this Bare Metal Admin Cluster.
...
class BareMetalClusterBinaryAuthorization(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str evaluation_mode: Mode of operation for binauthz policy evaluation. If unspecified,
...
class BareMetalClusterLoadBalancerBgpLbConfigAddressPool(dict):
    ...
    def __init__(__self__, *,
                 ...
                 manual_assign: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] addresses: The addresses that are part of this pool. Each address must be either in the CIDR form (1.2.3.0/24) or range form (1.2.3.1-1.2.3.5).
        :param _builtins.str pool: The name of the address pool.
        :param _builtins.bool avoid_buggy_ips: If true, avoid using IPs ending in .0 or .255.
...
class BareMetalClusterLoadBalancerBgpLbConfigBgpPeerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 control_plane_nodes: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.int asn: BGP autonomous system number (ASN) for the network that contains the
               external peer device.
        :param _builtins.str ip_address: The IP address of the external peer device.
        :param Sequence[_builtins.str] control_plane_nodes: The IP address of the control plane node that connects to the external
               peer.
...
class BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 serialize_image_pulls_disabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.int registry_burst: The maximum size of bursty pulls, temporarily allows pulls to burst to this
               number, while still not exceeding registry_pull_qps.
               The value must not be a negative number.
               Updating this field may impact scalability by changing the amount of
               traffic produced by image pulls.
               Defaults to 10.
        :param _builtins.int registry_pull_qps: The limit of registry pulls per second.
               Setting this value to 0 means no limit.
               Updating this field may impact scalability by changing the amount of
               traffic produced by image pulls.
               Defaults to 5.
        :param _builtins.bool serialize_image_pulls_disabled: Prevents the Kubelet from pulling multiple images at a time.
...
class BareMetalClusterLoadBalancerVipConfig(dict):
    ...
    def __init__(__self__, *,
                 control_plane_vip: _builtins.str,
                 ingress_vip: _builtins.str):
        """
        :param _builtins.str control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this Bare Metal User Cluster.
        :param _builtins.str ingress_vip: The VIP which you previously set aside for ingress traffic into this Bare Metal User Cluster.
        """
        pulumi.set(__self__, "control_plane_vip", control_plane_vip)
...
class BareMetalClusterNetworkConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool advanced_networking: Enables the use of advanced Anthos networking features, such as Bundled
...
class BareMetalClusterNetworkConfigMultipleNetworkInterfacesConfig(dict):
    def __init__(__self__, *,
                 enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool enabled: Whether to enable multiple network interfaces for your pods.
               When set network_config.advanced_networking is automatically
               set to true.
        """
        if enabled is not None:
...
class BareMetalClusterNetworkConfigSrIovConfig(dict):
    def __init__(__self__, *,
                 enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool enabled: Whether to install the SR-IOV operator.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class BareMetalClusterNodeConfig(dict):
    ...
    def __init__(__self__, *,
                 container_runtime: Optional[_builtins.str] = None,
                 max_pods_per_node: Optional[_builtins.int] = None):
        """
        :param _builtins.str container_runtime: The available runtimes that can be used to run containers in a Bare Metal User Cluster.
...
class BareMetalClusterOsEnvironmentConfig(dict):
    ...
    def __init__(__self__, *,
                 package_repo_excluded: _builtins.bool):
        """
        :param _builtins.bool package_repo_excluded: Whether the package repo should not be included when initializing
               bare metal machines.
        """
...
class BareMetalClusterUpgradePolicy(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str policy: Specifies which upgrade policy to use.
...
class BareMetalClusterValidationCheckStatusResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str category: (Output)
               The category of the validation.
        :param _builtins.str description: A human readable description of this Bare Metal User Cluster.
        :param _builtins.str details: (Output)
               Detailed failure information, which might be unformatted.
        :param _builtins.str options: (Output)
               Options used for the validation check.
...
class BareMetalNodePoolStatusCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str last_transition_time: (Output)
               Last time the condition transit from one status to another.
        :param _builtins.str message: Human-readable message indicating details about last transition.
        :param _builtins.str reason: Machine-readable message indicating details about last transition.
        :param _builtins.str state: (Output)
               The lifecycle state of the condition.
        :param _builtins.str type: Type of the condition.
               (e.g., ClusterRunning, NodePoolRunning or ServerSidePreflightReady)
...
class VMwareClusterAntiAffinityGroups(dict):
    ...
    def __init__(__self__, *,
                 aag_config_disabled: _builtins.bool):
        """
        :param _builtins.bool aag_config_disabled: Spread nodes across at least three physical hosts (requires at least three
               hosts).
               Enabled by default.
        """
...
class VMwareClusterAutoRepairConfig(dict):
    def __init__(__self__, *,
                 enabled: _builtins.bool):
        """
        :param _builtins.bool enabled: Whether auto repair is enabled.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class VMwareClusterControlPlaneNode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cpus: Optional[_builtins.int] = None,
        ...
        :param 'VMwareClusterControlPlaneNodeAutoResizeConfigArgs' auto_resize_config: AutoResizeConfig provides auto resizing configurations.
               Structure is documented below.
        :param _builtins.int cpus: The number of CPUs for each admin cluster node that serve as control planes
               for this VMware User Cluster. (default: 4 CPUs)
        :param _builtins.int memory: The megabytes of memory for each admin cluster node that serves as a
               control plane for this VMware User Cluster (default: 8192 MB memory).
        :param _builtins.int replicas: The number of control plane nodes for this VMware User Cluster.
               (default: 1 replica).
...
class VMwareClusterControlPlaneNodeAutoResizeConfig(dict):
    def __init__(__self__, *,
                 enabled: _builtins.bool):
        """
        :param _builtins.bool enabled: Whether to enable control plane node auto resizing.
...
class VMwareClusterControlPlaneNodeVsphereConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str datastore: The Vsphere datastore used by the Control Plane Node.
        :param _builtins.str storage_policy_name: The Vsphere storage policy used by the control plane Node.
        """
...
class VMwareClusterDataplaneV2(dict):
    ...
    def __init__(__self__, *,
                 advanced_networking: Optional[_builtins.bool] = None,
                 dataplane_v2_enabled: Optional[_builtins.bool] = None,
                 windows_dataplane_v2_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool advanced_networking: Enable advanced networking which requires dataplane_v2_enabled to be set true.
        :param _builtins.bool dataplane_v2_enabled: Enables Dataplane V2.
        :param _builtins.bool windows_dataplane_v2_enabled: Enable Dataplane V2 for clusters with Windows nodes.
        """
        if advanced_networking is not None:
            pulumi.set(__self__, "advanced_networking", advanced_networking)
...
class VMwareClusterLoadBalancerF5Config(dict):
    ...
    def __init__(__self__, *,
                 ...
                 snat_pool: Optional[_builtins.str] = None):
        """
        :param _builtins.str address: The load balancer's IP address.
        :param _builtins.str partition: he preexisting partition to be used by the load balancer. T
               his partition is usually created for the admin cluster for example:
               'my-f5-admin-partition'.
        :param _builtins.str snat_pool: The pool name. Only necessary, if using SNAT.
        """
...
class VMwareClusterLoadBalancerManualLbConfig(dict):
    ...
    def __init__(__self__, *,
                 control_plane_node_port: Optional[_builtins.int] = None,
                 ingress_http_node_port: Optional[_builtins.int] = None,
                 ingress_https_node_port: Optional[_builtins.int] = None,
                 konnectivity_server_node_port: Optional[_builtins.int] = None):
        """
        :param _builtins.int control_plane_node_port: NodePort for control plane service. The Kubernetes API server in the admin
               cluster is implemented as a Service of type NodePort (ex. 30968).
        :param _builtins.int ingress_http_node_port: NodePort for ingress service's http. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 32527).
        :param _builtins.int ingress_https_node_port: NodePort for ingress service's https. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 30139).
        :param _builtins.int konnectivity_server_node_port: NodePort for konnectivity server service running as a sidecar in each
...
class VMwareClusterLoadBalancerMetalLbConfigAddressPool(dict):
    ...
    def __init__(__self__, *,
                 ...
                 manual_assign: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] addresses: The addresses that are part of this pool. Each address
...
class VMwareClusterLoadBalancerVipConfig(dict):
    ...
    def __init__(__self__, *,
                 control_plane_vip: Optional[_builtins.str] = None,
                 ingress_vip: Optional[_builtins.str] = None):
        """
        :param _builtins.str control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this cluster.
        :param _builtins.str ingress_vip: The VIP which you previously set aside for ingress traffic into this cluster.
...
class VMwareClusterNetworkConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vcenter_network: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] pod_address_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges.
               Only a single range is supported. This field cannot be changed after creation.
        :param Sequence[_builtins.str] service_address_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address
        ...
        :param 'VMwareClusterNetworkConfigStaticIpConfigArgs' static_ip_config: Configuration settings for a static IP configuration.
               Structure is documented below.
        :param _builtins.str vcenter_network: vcenter_network specifies vCenter network name. Inherited from the admin cluster.
        """
        pulumi.set(__self__, "pod_address_cidr_blocks", pod_address_cidr_blocks)
        pulumi.set(__self__, "service_address_cidr_blocks", service_address_cidr_blocks)
...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str gateway: The network gateway used by the VMware User Cluster.
        :param Sequence['VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpArgs'] ips: The node's network configurations used by the VMware User Cluster.
               Structure is documented below.
        :param _builtins.str netmask: The netmask used by the VMware User Cluster.
        """
...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIp(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str hostname: Hostname of the machine. VM's name will be used if this field is empty.
        :param _builtins.str ip: IP could be an IP address (like 1.2.3.4) or a CIDR (like 1.2.3.0/24).
        """
...
class VMwareClusterNetworkConfigDhcpIpConfig(dict):
    def __init__(__self__, *,
                 enabled: _builtins.bool):
        """
        :param _builtins.bool enabled: enabled is a flag to mark if DHCP IP allocation is
...
class VMwareClusterNetworkConfigHostConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] dns_search_domains: DNS search domains.
        ...
        :param Sequence[_builtins.str] ntp_servers: NTP servers.
        """
...
class VMwareClusterStorage(dict):
    ...
    def __init__(__self__, *,
                 vsphere_csi_disabled: _builtins.bool):
        """
        :param _builtins.bool vsphere_csi_disabled: Whether or not to deploy vSphere CSI components in the VMware User Cluster.
               Enabled by default.
        """
...
class VMwareClusterUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool control_plane_only: Controls whether the upgrade applies to the control plane only.
        """
...
class VMwareClusterValidationCheckStatusResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str category: (Output)
               The category of the validation.
        :param _builtins.str description: A human readable description of this VMware User Cluster.
        :param _builtins.str details: (Output)
               Detailed failure information, which might be unformatted.
        :param _builtins.str options: (Output)
               Options used for the validation check.
...
class VMwareClusterVcenter(dict):
    ...
    def __init__(__self__, *,
                 address: Optional[_builtins.str] = None,
                 ca_cert_data: Optional[_builtins.str] = None,
        ...
        :param _builtins.str ca_cert_data: Contains the vCenter CA certificate public key for SSL verification.
        :param _builtins.str cluster: The name of the vCenter cluster for the user cluster.
        :param _builtins.str datacenter: The name of the vCenter datacenter for the user cluster.
        :param _builtins.str datastore: The name of the vCenter datastore for the user cluster.
        :param _builtins.str folder: The name of the vCenter folder for the user cluster.
        :param _builtins.str resource_pool: The name of the vCenter resource pool for the user cluster.
        :param _builtins.str storage_policy_name: The name of the vCenter storage policy for the user cluster.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class VMwareNodePoolConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cpus: Optional[_builtins.int] = None,
                 enable_load_balancer: Optional[_builtins.bool] = None,
        ...
        """
        :param _builtins.str image_type: The OS image to be used for each node in a node pool.
               Currently `cos`, `cos_cgv2`, `ubuntu`, `ubuntu_cgv2`, `ubuntu_containerd` and `windows` are supported.
        :param _builtins.int boot_disk_size_gb: VMware disk size to be used during creation.
        :param _builtins.int cpus: The number of CPUs for each node in the node pool.
        :param _builtins.bool enable_load_balancer: Allow node pool traffic to be load balanced. Only works for clusters with
               MetalLB load balancers.
        :param _builtins.str image: The OS image name in vCenter, only valid when using Windows.
        :param Mapping[str, _builtins.str] labels: The map of Kubernetes labels (key/value pairs) to be applied to each node.
               These will added in addition to any default label(s) that
               Kubernetes may apply to the node.
               In case of conflict in label keys, the applied set may differ depending on
               the Kubernetes version -- it's best to assume the behavior is undefined
               and conflicts should be avoided.
        :param _builtins.int memory_mb: The megabytes of memory for each node in the node pool.
        :param _builtins.int replicas: The number of nodes in the node pool.
...
class VMwareNodePoolConfigVsphereConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str datastore: The name of the vCenter datastore. Inherited from the user cluster.
        :param Sequence[_builtins.str] host_groups: Vsphere host groups to apply to all VMs in the node pool
...
class VMwareNodePoolConfigVsphereConfigTag(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str category: The Vsphere tag category.
        :param _builtins.str tag: The Vsphere tag name.
        """
        if category is not None:
            pulumi.set(__self__, "category", category)
        if tag is not None:
...
class VMwareNodePoolNodePoolAutoscaling(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int max_replicas: Maximum number of replicas in the NodePool.
        :param _builtins.int min_replicas: Minimum number of replicas in the NodePool.
        """
...
class VmwareAdminClusterAddonNodeAutoResizeConfig(dict):
    def __init__(__self__, *,
                 enabled: _builtins.bool):
        """
        :param _builtins.bool enabled: Whether to enable controle plane node auto resizing.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class VmwareAdminClusterControlPlaneNode(dict):
    def __init__(__self__, *,
                 ...
                 replicas: Optional[_builtins.int] = None):
        """
        :param _builtins.int cpus: The number of vCPUs for the control-plane node of the admin cluster.
        :param _builtins.int memory: The number of mebibytes of memory for the control-plane node of the admin cluster.
        :param _builtins.int replicas: The number of control plane nodes for this VMware admin cluster.
        """
        if cpus is not None:
            pulumi.set(__self__, "cpus", cpus)
        if memory is not None:
...
class VmwareAdminClusterLoadBalancerManualLbConfig(dict):
    ...
    def __init__(__self__, *,
                 addons_node_port: Optional[_builtins.int] = None,
                 control_plane_node_port: Optional[_builtins.int] = None,
                 ingress_http_node_port: Optional[_builtins.int] = None,
                 ingress_https_node_port: Optional[_builtins.int] = None,
                 konnectivity_server_node_port: Optional[_builtins.int] = None):
        """
        :param _builtins.int addons_node_port: NodePort for add-ons server in the admin cluster.
        :param _builtins.int control_plane_node_port: NodePort for control plane service. The Kubernetes API server in the admin
               cluster is implemented as a Service of type NodePort (ex. 30968).
        :param _builtins.int ingress_http_node_port: NodePort for ingress service's http. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 32527).
...
class VmwareAdminClusterLoadBalancerMetalLbConfig(dict):
    def __init__(__self__, *,
                 enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool enabled: Metal LB is enabled.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class VmwareAdminClusterLoadBalancerVipConfig(dict):
    ...
    def __init__(__self__, *,
                 control_plane_vip: _builtins.str,
                 addons_vip: Optional[_builtins.str] = None):
        """
        :param _builtins.str control_plane_vip: The VIP which you previously set aside for the Kubernetes
               API of this VMware Admin Cluster.
        :param _builtins.str addons_vip: The VIP to configure the load balancer for add-ons.
...
class VmwareAdminClusterNetworkConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'VmwareAdminClusterNetworkConfigStaticIpConfigArgs' static_ip_config: Configuration settings for a static IP configuration.
               Structure is documented below.
        :param _builtins.str vcenter_network: vcenter_network specifies vCenter network name.
        """
        pulumi.set(__self__, "pod_address_cidr_blocks", pod_address_cidr_blocks)
        pulumi.set(__self__, "service_address_cidr_blocks", service_address_cidr_blocks)
        if dhcp_ip_config is not None:
...
class VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlock(dict):
    def __init__(__self__, *,
                 ...
                 netmask: _builtins.str):
        """
        :param _builtins.str gateway: The network gateway used by the VMware Admin Cluster.
        :param Sequence['VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockIpArgs'] ips: The node's network configurations used by the VMware Admin Cluster.
               Structure is documented below.
        :param _builtins.str netmask: The netmask used by the VMware Admin Cluster.
        """
        pulumi.set(__self__, "gateway", gateway)
        pulumi.set(__self__, "ips", ips)
        pulumi.set(__self__, "netmask", netmask)
...
class VmwareAdminClusterPlatformConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 required_platform_version: Optional[_builtins.str] = None,
        ...
        :param Sequence['VmwareAdminClusterPlatformConfigBundleArgs'] bundles: (Output)
               ...
               Structure is documented below.
        :param _builtins.str platform_version: (Output)
               The platform version e.g. 1.13.2.
        :param _builtins.str required_platform_version: The required platform version e.g. 1.13.1.
...
class VmwareAdminClusterPlatformConfigBundle(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['VmwareAdminClusterPlatformConfigBundleStatusArgs'] statuses: ResourceStatus representing detailed cluster state.
               Structure is documented below.
        :param _builtins.str version: The version of the bundle.
        """
        if statuses is not None:
            pulumi.set(__self__, "statuses", statuses)
...
class VmwareAdminClusterPrivateRegistryConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: The registry address.
        :param _builtins.str ca_cert: The CA certificate public key for private registry.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class VmwareAdminClusterVcenter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ca_cert_data: Optional[_builtins.str] = None,
                 cluster: Optional[_builtins.str] = None,
                 data_disk: Optional[_builtins.str] = None,
                 datacenter: Optional[_builtins.str] = None,
                 datastore: Optional[_builtins.str] = None,
                 folder: Optional[_builtins.str] = None,
                 resource_pool: Optional[_builtins.str] = None,
                 storage_policy_name: Optional[_builtins.str] = None):
        """
        :param _builtins.str address: The vCenter IP address.
        :param _builtins.str ca_cert_data: Contains the vCenter CA certificate public key for SSL verification.
        :param _builtins.str cluster: The name of the vCenter cluster for the admin cluster.
        :param _builtins.str data_disk: The name of the virtual machine disk (VMDK) for the admin cluster.
        :param _builtins.str datacenter: The name of the vCenter datacenter for the admin cluster.
        :param _builtins.str datastore: The name of the vCenter datastore for the admin cluster.
        :param _builtins.str folder: The name of the vCenter folder for the admin cluster.
        :param _builtins.str resource_pool: The name of the vCenter resource pool for the admin cluster.
        :param _builtins.str storage_policy_name: The name of the vCenter storage policy for the user cluster.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
