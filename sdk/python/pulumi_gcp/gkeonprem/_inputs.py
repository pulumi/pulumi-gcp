...
__all__ = [
    ...
    'BareMetalAdminClusterLoadBalancerBgpLbConfigArgsDict',
...
class BareMetalAdminClusterControlPlaneApiServerArgArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] argument: The argument name as it appears on the API Server command line please make sure to remove the leading dashes.
        :param pulumi.Input[_builtins.str] value: The value of the arg as it will be passed to the API Server command line.
        """
...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to nodes of this node pool.
               ...
               Example:
               { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs']]] node_configs: Structure is documented below.
        :param pulumi.Input[_builtins.str] operating_system: The available Operating Systems to be run in a Node.
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigTaintArgs']]] taints: Structure is documented below.
        """
...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to nodes of this node pool.
               ...
               Example:
               { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[_builtins.str] node_ip: (Optional)
        """
        if labels is not None:
            pulumi.set(__self__, "labels", labels)
...
class BareMetalAdminClusterLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BareMetalAdminClusterLoadBalancerVipConfigArgs'] vip_config: Specified the Bare Metal Load Balancer Config
               Structure is documented below.
        :param pulumi.Input['BareMetalAdminClusterLoadBalancerBgpLbConfigArgs'] bgp_lb_config: A nested object resource.
               Structure is documented below.
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigArgsDict: TypeAlias = Mapping[str, Any]
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterLoadBalancerBgpLbConfigAddressPoolArgs']]] address_pools: a list of non-overlapping IP pools used
               by load balancer typed services.
               Structure is documented below.
        :param pulumi.Input[_builtins.int] asn: BGP autonomous system number (ASN) of the cluster.
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs']]] bgp_peer_configs: BGP autonomous system number (ASN) of the cluster.
               Structure is documented below.
        :param pulumi.Input['BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgs'] load_balancer_node_pool_config: A nested object resource.
               Structure is documented below.
        """
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigAddressPoolArgsDict: TypeAlias = Mapping[str, Any]
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigAddressPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] avoid_buggy_ips: This avoids buggy consumer devices mistakenly
               dropping IPv4 traffic for those special IP addresses.
        :param pulumi.Input[_builtins.bool] manual_assign: If true, prevent IP addresses from being automatically assigned.
        :param pulumi.Input[_builtins.str] pool: (Optional)
        """
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigArgsDict: TypeAlias = Mapping[str, Any]
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] control_plane_nodes: The IP address of the control plane node that
               connects to the external peer.
        :param pulumi.Input[_builtins.str] ip_address: (Optional)
        """
        if asn is not None:
            pulumi.set(__self__, "asn", asn)
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgsDict: TypeAlias = Mapping[str, Any]
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to nodes of this node pool.
               ...
               Example:
               { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgs']]] node_configs: Structure is documented below.
        :param pulumi.Input[_builtins.str] operating_system: The available Operating Systems to be run in a Node.
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgs']]] taints: Structure is documented below.
        """
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgsDict: TypeAlias = Mapping[str, Any]
...
class BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] serialize_image_pulls_disabled: (Optional)
        """
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigNodeConfigArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    BareMetalAdminClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigTaintArgsDict: TypeAlias = Mapping[str, Any]
...
class BareMetalAdminClusterLoadBalancerManualLbConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether manual load balancing is enabled.
        """
...
class BareMetalAdminClusterLoadBalancerPortConfigArgs:
    def __init__(__self__, *,
                 control_plane_load_balancer_port: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] control_plane_load_balancer_port: The port that control plane hosted load balancers will listen on.
        """
...
class BareMetalAdminClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *,
                 control_plane_vip: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this Bare Metal Admin Cluster.
        """
...
class BareMetalAdminClusterMaintenanceConfigArgs:
    def __init__(__self__, *,
                 maintenance_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] maintenance_address_cidr_blocks: All IPv4 address from these ranges will be placed into maintenance mode.
               Nodes in maintenance mode will be cordoned and drained. When both of these
               are true, the "baremetal.cluster.gke.io/maintenance" annotation will be set
               on the node resource.
        """
    ...
    def maintenance_address_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        All IPv4 address from these ranges will be placed into maintenance mode.
        Nodes in maintenance mode will be cordoned and drained. When both of these
        are true, the "baremetal.cluster.gke.io/maintenance" annotation will be set
    ...
    def maintenance_address_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class BareMetalAdminClusterNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BareMetalAdminClusterNetworkConfigIslandModeCidrArgs'] island_mode_cidr: A nested object resource.
               Structure is documented below.
        :param pulumi.Input['BareMetalAdminClusterNetworkConfigMultipleNetworkInterfacesConfigArgs'] multiple_network_interfaces_config: Configuration for multiple network interfaces.
               Structure is documented below.
        """
...
class BareMetalAdminClusterNetworkConfigIslandModeCidrArgs:
    def __init__(__self__, *,
                 ...
                 service_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] pod_address_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] service_address_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        """
    ...
    def pod_address_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        """
    ...
    def pod_address_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "pod_address_cidr_blocks", value)

    @_builtins.property
    @pulumi.getter(name="serviceAddressCidrBlocks")
    def service_address_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        All services in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        """
    ...
    def service_address_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
if not MYPY:
    ...
    BareMetalAdminClusterNetworkConfigMultipleNetworkInterfacesConfigArgsDict: TypeAlias = Mapping[str, Any]
...
class BareMetalAdminClusterProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] uri: Specifies the address of your proxy server.
               ...
               WARNING: Do not provide credentials in the format
               of http://(username:password@)domain these will be rejected by the server.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] no_proxies: A list of IPs, hostnames, and domains that should skip the proxy.
               For example: ["127.0.0.1", "example.com", ".corp", "localhost"].
        """
...
class BareMetalAdminClusterSecurityConfigAuthorizationAdminUserArgs:
    def __init__(__self__, *,
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] username: The name of the user, e.g. `my-gcp-id@gmail.com`.
        """
...
class BareMetalAdminClusterStorageLvpNodeMountsConfigArgs:
    def __init__(__self__, *,
                 ...
                 storage_class: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] path: The host machine path.
        :param pulumi.Input[_builtins.str] storage_class: The StorageClass name that PVs will be created with.
        """
...
class BareMetalAdminClusterStorageLvpShareConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BareMetalAdminClusterStorageLvpShareConfigLvpConfigArgs'] lvp_config: Defines the machine path and storage class for the LVP Share.
               Structure is documented below.
        :param pulumi.Input[_builtins.int] shared_path_pv_count: The number of subdirectories to create under path.
        """
...
class BareMetalAdminClusterValidationCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] options: (Output)
               Options used for the validation check.
        :param pulumi.Input[_builtins.str] scenario: (Output)
               The scenario when the preflight checks were run..
...
class BareMetalClusterLoadBalancerBgpLbConfigAddressPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] avoid_buggy_ips: If true, avoid using IPs ending in .0 or .255.
               This avoids buggy consumer devices mistakenly dropping IPv4 traffic for those special IP addresses.
        :param pulumi.Input[_builtins.bool] manual_assign: If true, prevent IP addresses from being automatically assigned.
        """
        pulumi.set(__self__, "addresses", addresses)
...
class BareMetalClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] asn: BGP autonomous system number (ASN) for the network that contains the
               external peer device.
        :param pulumi.Input[_builtins.str] ip_address: The IP address of the external peer device.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] control_plane_nodes: The IP address of the control plane node that connects to the external
               peer.
               If you don't specify any control plane nodes, all control plane nodes
               can connect to the external peer. If you specify one or more IP addresses,
               only the nodes specified participate in peering sessions.
...
class BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] registry_burst: The maximum size of bursty pulls, temporarily allows pulls to burst to this
               ...
               traffic produced by image pulls.
               Defaults to 10.
        :param pulumi.Input[_builtins.int] registry_pull_qps: The limit of registry pulls per second.
               Setting this value to 0 means no limit.
               Updating this field may impact scalability by changing the amount of
               traffic produced by image pulls.
               Defaults to 5.
        :param pulumi.Input[_builtins.bool] serialize_image_pulls_disabled: Prevents the Kubelet from pulling multiple images at a time.
               We recommend *not* changing the default value on nodes that run docker
               daemon with version  < 1.9 or an Another Union File System (Aufs) storage
               backend. Issue https://github.com/kubernetes/kubernetes/issues/10959 has
               more details.
...
class BareMetalClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *,
                 ...
                 ingress_vip: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this Bare Metal User Cluster.
        :param pulumi.Input[_builtins.str] ingress_vip: The VIP which you previously set aside for ingress traffic into this Bare Metal User Cluster.
        """
        pulumi.set(__self__, "control_plane_vip", control_plane_vip)
...
class BareMetalClusterOsEnvironmentConfigArgs:
    def __init__(__self__, *,
                 package_repo_excluded: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] package_repo_excluded: Whether the package repo should not be included when initializing
               bare metal machines.
        """
...
class BareMetalNodePoolStatusConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] last_transition_time: (Output)
               Last time the condition transit from one status to another.
        :param pulumi.Input[_builtins.str] message: Human-readable message indicating details about last transition.
        :param pulumi.Input[_builtins.str] reason: Machine-readable message indicating details about last transition.
        :param pulumi.Input[_builtins.str] state: (Output)
               The lifecycle state of the condition.
        :param pulumi.Input[_builtins.str] type: Type of the condition.
               (e.g., ClusterRunning, NodePoolRunning or ServerSidePreflightReady)
...
class VMwareClusterAntiAffinityGroupsArgs:
    def __init__(__self__, *,
                 aag_config_disabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] aag_config_disabled: Spread nodes across at least three physical hosts (requires at least three
               hosts).
               Enabled by default.
        """
...
class VMwareClusterAutoRepairConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether auto repair is enabled.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class VMwareClusterControlPlaneNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VMwareClusterControlPlaneNodeAutoResizeConfigArgs'] auto_resize_config: AutoResizeConfig provides auto resizing configurations.
               Structure is documented below.
        :param pulumi.Input[_builtins.int] cpus: The number of CPUs for each admin cluster node that serve as control planes
               for this VMware User Cluster. (default: 4 CPUs)
        :param pulumi.Input[_builtins.int] memory: The megabytes of memory for each admin cluster node that serves as a
               control plane for this VMware User Cluster (default: 8192 MB memory).
        :param pulumi.Input[_builtins.int] replicas: The number of control plane nodes for this VMware User Cluster.
               (default: 1 replica).
...
class VMwareClusterControlPlaneNodeAutoResizeConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether to enable control plane node auto resizing.
...
class VMwareClusterDataplaneV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] windows_dataplane_v2_enabled: Enable Dataplane V2 for clusters with Windows nodes.
        """
        if advanced_networking is not None:
            pulumi.set(__self__, "advanced_networking", advanced_networking)
...
class VMwareClusterLoadBalancerF5ConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] partition: he preexisting partition to be used by the load balancer. T
               his partition is usually created for the admin cluster for example:
               'my-f5-admin-partition'.
        :param pulumi.Input[_builtins.str] snat_pool: The pool name. Only necessary, if using SNAT.
        """
...
class VMwareClusterLoadBalancerManualLbConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] control_plane_node_port: NodePort for control plane service. The Kubernetes API server in the admin
               cluster is implemented as a Service of type NodePort (ex. 30968).
        :param pulumi.Input[_builtins.int] ingress_http_node_port: NodePort for ingress service's http. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 32527).
        :param pulumi.Input[_builtins.int] ingress_https_node_port: NodePort for ingress service's https. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 30139).
        :param pulumi.Input[_builtins.int] konnectivity_server_node_port: NodePort for konnectivity server service running as a sidecar in each
               kube-apiserver pod (ex. 30564).
        """
...
class VMwareClusterNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] pod_address_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges.
               Only a single range is supported. This field cannot be changed after creation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] service_address_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address
               from these ranges. Only a single range is supported.. This field
               cannot be changed after creation.
        ...
        :param pulumi.Input['VMwareClusterNetworkConfigStaticIpConfigArgs'] static_ip_config: Configuration settings for a static IP configuration.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] vcenter_network: vcenter_network specifies vCenter network name. Inherited from the admin cluster.
        """
        pulumi.set(__self__, "pod_address_cidr_blocks", pod_address_cidr_blocks)
        pulumi.set(__self__, "service_address_cidr_blocks", service_address_cidr_blocks)
...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpArgs']]] ips: The node's network configurations used by the VMware User Cluster.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] netmask: The netmask used by the VMware User Cluster.
        """
...
class VMwareClusterNetworkConfigDhcpIpConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: enabled is a flag to mark if DHCP IP allocation is
               used for VMware user clusters.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class VMwareClusterNetworkConfigHostConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ntp_servers: NTP servers.
        """
...
class VMwareClusterStorageArgs:
    def __init__(__self__, *,
                 vsphere_csi_disabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] vsphere_csi_disabled: Whether or not to deploy vSphere CSI components in the VMware User Cluster.
               Enabled by default.
        """
...
class VMwareClusterVcenterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cluster: The name of the vCenter cluster for the user cluster.
        :param pulumi.Input[_builtins.str] datacenter: The name of the vCenter datacenter for the user cluster.
        :param pulumi.Input[_builtins.str] datastore: The name of the vCenter datastore for the user cluster.
        :param pulumi.Input[_builtins.str] folder: The name of the vCenter folder for the user cluster.
        :param pulumi.Input[_builtins.str] resource_pool: The name of the vCenter resource pool for the user cluster.
        :param pulumi.Input[_builtins.str] storage_policy_name: The name of the vCenter storage policy for the user cluster.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class VMwareNodePoolConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] image_type: The OS image to be used for each node in a node pool.
               Currently `cos`, `cos_cgv2`, `ubuntu`, `ubuntu_cgv2`, `ubuntu_containerd` and `windows` are supported.
        :param pulumi.Input[_builtins.int] boot_disk_size_gb: VMware disk size to be used during creation.
        :param pulumi.Input[_builtins.int] cpus: The number of CPUs for each node in the node pool.
        :param pulumi.Input[_builtins.bool] enable_load_balancer: Allow node pool traffic to be load balanced. Only works for clusters with
               MetalLB load balancers.
        :param pulumi.Input[_builtins.str] image: The OS image name in vCenter, only valid when using Windows.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The map of Kubernetes labels (key/value pairs) to be applied to each node.
               These will added in addition to any default label(s) that
               Kubernetes may apply to the node.
               In case of conflict in label keys, the applied set may differ depending on
               the Kubernetes version -- it's best to assume the behavior is undefined
               and conflicts should be avoided.
        :param pulumi.Input[_builtins.int] memory_mb: The megabytes of memory for each node in the node pool.
        :param pulumi.Input[_builtins.int] replicas: The number of nodes in the node pool.
...
class VMwareNodePoolNodePoolAutoscalingArgs:
    def __init__(__self__, *,
                 ...
                 min_replicas: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] max_replicas: Maximum number of replicas in the NodePool.
        :param pulumi.Input[_builtins.int] min_replicas: Minimum number of replicas in the NodePool.
        """
...
class VmwareAdminClusterAddonNodeAutoResizeConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether to enable controle plane node auto resizing.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class VmwareAdminClusterControlPlaneNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] replicas: The number of control plane nodes for this VMware admin cluster.
        """
        if cpus is not None:
            pulumi.set(__self__, "cpus", cpus)
        if memory is not None:
...
class VmwareAdminClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] control_plane_vip: The VIP which you previously set aside for the Kubernetes
               API of this VMware Admin Cluster.
        :param pulumi.Input[_builtins.str] addons_vip: The VIP to configure the load balancer for add-ons.
...
class VmwareAdminClusterNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VmwareAdminClusterNetworkConfigStaticIpConfigArgs'] static_ip_config: Configuration settings for a static IP configuration.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] vcenter_network: vcenter_network specifies vCenter network name.
        """
        pulumi.set(__self__, "pod_address_cidr_blocks", pod_address_cidr_blocks)
        pulumi.set(__self__, "service_address_cidr_blocks", service_address_cidr_blocks)
        if dhcp_ip_config is not None:
...
class VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockArgs:
    def __init__(__self__, *,
                 ...
                 netmask: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] gateway: The network gateway used by the VMware Admin Cluster.
        :param pulumi.Input[Sequence[pulumi.Input['VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockIpArgs']]] ips: The node's network configurations used by the VMware Admin Cluster.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] netmask: The netmask used by the VMware Admin Cluster.
        """
        pulumi.set(__self__, "gateway", gateway)
        pulumi.set(__self__, "ips", ips)
        pulumi.set(__self__, "netmask", netmask)
...
class VmwareAdminClusterPlatformConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VmwareAdminClusterPlatformConfigBundleArgs']]] bundles: (Output)
               The list of bundles installed in the admin cluster.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] platform_version: (Output)
               The platform version e.g. 1.13.2.
        :param pulumi.Input[_builtins.str] required_platform_version: The required platform version e.g. 1.13.1.
               If the current platform version is lower than the target version,
               the platform version will be updated to the target version.
               If the target version is not installed in the platform
               (bundle versions), download the target version bundle.
...
class VmwareAdminClusterPlatformConfigBundleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VmwareAdminClusterPlatformConfigBundleStatusArgs']]] statuses: ResourceStatus representing detailed cluster state.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] version: The version of the bundle.
        """
        if statuses is not None:
            pulumi.set(__self__, "statuses", statuses)
...
class VmwareAdminClusterVcenterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ca_cert_data: Contains the vCenter CA certificate public key for SSL verification.
        :param pulumi.Input[_builtins.str] cluster: The name of the vCenter cluster for the admin cluster.
        :param pulumi.Input[_builtins.str] data_disk: The name of the virtual machine disk (VMDK) for the admin cluster.
        :param pulumi.Input[_builtins.str] datacenter: The name of the vCenter datacenter for the admin cluster.
        :param pulumi.Input[_builtins.str] datastore: The name of the vCenter datastore for the admin cluster.
        :param pulumi.Input[_builtins.str] folder: The name of the vCenter folder for the admin cluster.
        :param pulumi.Input[_builtins.str] resource_pool: The name of the vCenter resource pool for the admin cluster.
        :param pulumi.Input[_builtins.str] storage_policy_name: The name of the vCenter storage policy for the user cluster.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
