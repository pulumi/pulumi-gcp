...
if not MYPY:
    class BareMetalAdminClusterClusterOperationsArgsDict(TypedDict):
        enable_application_logs: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BareMetalAdminClusterClusterOperationsArgs:
    def __init__(__self__, *,
                 enable_application_logs: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_application_logs: Whether collection of application logs/metrics should be enabled (in addition to system logs/metrics).
        """
    ...
    def enable_application_logs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether collection of application logs/metrics should be enabled (in addition to system logs/metrics).
        """
    ...
    def enable_application_logs(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BareMetalAdminClusterControlPlaneApiServerArgArgsDict(TypedDict):
        argument: pulumi.Input[builtins.str]
        """
...
class BareMetalAdminClusterControlPlaneApiServerArgArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] argument: The argument name as it appears on the API Server command line please make sure to remove the leading dashes.
        :param pulumi.Input[builtins.str] value: The value of the arg as it will be passed to the API Server command line.
        """
    ...
    @property
    @pulumi.getter
    def argument(self) -> pulumi.Input[builtins.str]:
        """
        The argument name as it appears on the API Server command line please make sure to remove the leading dashes.
        """
    ...
    @argument.setter
    def argument(self, value: pulumi.Input[builtins.str]):
...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The map of Kubernetes labels (key/value pairs) to be applied to
               each node. These will added in addition to any default label(s)
               that Kubernetes may apply to the node. In case of conflict in
               label keys, the applied set may differ depending on the Kubernetes
               version -- it's best to assume the behavior is undefined and
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs']]] node_configs: The list of machine addresses in the Bare Metal Node Pool.
               Structure is documented below.
        :param pulumi.Input[builtins.str] operating_system: Specifies the nodes operating system (default: LINUX).
...
class BareMetalAdminClusterControlPlaneControlPlaneNodePoolConfigNodePoolConfigNodeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The map of Kubernetes labels (key/value pairs) to be applied to
               ...
               An object containing a list of "key": value pairs.
               For example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[builtins.str] node_ip: The default IPv4 address for SSH access and Kubernetes node.
               Example: 192.168.0.1
        """
        if labels is not None:
            pulumi.set(__self__, "labels", labels)
...
class BareMetalAdminClusterLoadBalancerManualLbConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether manual load balancing is enabled.
        """
...
if not MYPY:
    class BareMetalAdminClusterLoadBalancerPortConfigArgsDict(TypedDict):
        control_plane_load_balancer_port: pulumi.Input[builtins.int]
        """
...
class BareMetalAdminClusterLoadBalancerPortConfigArgs:
    def __init__(__self__, *,
                 control_plane_load_balancer_port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] control_plane_load_balancer_port: The port that control plane hosted load balancers will listen on.
        """
    ...
    def control_plane_load_balancer_port(self) -> pulumi.Input[builtins.int]:
        """
        The port that control plane hosted load balancers will listen on.
        """
...
class BareMetalAdminClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *,
                 control_plane_vip: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this Bare Metal Admin Cluster.
        """
        pulumi.set(__self__, "control_plane_vip", control_plane_vip)

    @property
    @pulumi.getter(name="controlPlaneVip")
    def control_plane_vip(self) -> pulumi.Input[builtins.str]:
        """
        The VIP which you previously set aside for the Kubernetes API of this Bare Metal Admin Cluster.
        """
    ...
    def control_plane_vip(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "control_plane_vip", value)


if not MYPY:
    class BareMetalAdminClusterMaintenanceConfigArgsDict(TypedDict):
        maintenance_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class BareMetalAdminClusterMaintenanceConfigArgs:
    def __init__(__self__, *,
                 maintenance_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] maintenance_address_cidr_blocks: All IPv4 address from these ranges will be placed into maintenance mode.
               Nodes in maintenance mode will be cordoned and drained. When both of these
               are true, the "baremetal.cluster.gke.io/maintenance" annotation will be set
               on the node resource.
        """
    ...
    def maintenance_address_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        All IPv4 address from these ranges will be placed into maintenance mode.
        Nodes in maintenance mode will be cordoned and drained. When both of these
        are true, the "baremetal.cluster.gke.io/maintenance" annotation will be set
    ...
    def maintenance_address_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class BareMetalAdminClusterNetworkConfigIslandModeCidrArgs:
    def __init__(__self__, *,
                 ...
                 service_address_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pod_address_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_address_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address from these ranges. This field cannot be changed after creation.
        """
...
if not MYPY:
    class BareMetalAdminClusterNodeAccessConfigArgsDict(TypedDict):
        login_user: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BareMetalAdminClusterNodeAccessConfigArgs:
    def __init__(__self__, *,
                 login_user: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] login_user: LoginUser is the user name used to access node machines.
               It defaults to "root" if not set.
        """
    ...
    def login_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        LoginUser is the user name used to access node machines.
        It defaults to "root" if not set.
        """
    ...
    @login_user.setter
    def login_user(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BareMetalAdminClusterNodeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_pods_per_node: The maximum number of pods a node can run. The size of the CIDR range
               assigned to the node will be derived from this parameter.
        """
...
if not MYPY:
    class BareMetalAdminClusterProxyArgsDict(TypedDict):
        ...
        """
        no_proxies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BareMetalAdminClusterProxyArgs:
    def __init__(__self__, *,
                 uri: pulumi.Input[builtins.str],
                 no_proxies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] uri: Specifies the address of your proxy server.
               For Example: http://domain
               WARNING: Do not provide credentials in the format
               of http://(username:password@)domain these will be rejected by the server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] no_proxies: A list of IPs, hostnames, and domains that should skip the proxy.
               For example: ["127.0.0.1", "example.com", ".corp", "localhost"].
        """
    ...
    def no_proxies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of IPs, hostnames, and domains that should skip the proxy.
        For example: ["127.0.0.1", "example.com", ".corp", "localhost"].
        """
    ...
    @no_proxies.setter
    def no_proxies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BareMetalAdminClusterStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalAdminClusterStatusConditionArgs']]] conditions: (Output)
               ResourceConditions provide a standard mechanism for higher-level status reporting from admin cluster controller.
               Structure is documented below.
        :param pulumi.Input[builtins.str] error_message: (Output)
               Human-friendly representation of the error message from the admin cluster
               controller. The error message can be temporary as the admin cluster
               controller creates a cluster or node pool. If the error message persists
               for a longer period of time, it can be used to surface error message to
...
if not MYPY:
    class BareMetalAdminClusterStorageLvpShareConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        shared_path_pv_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class BareMetalAdminClusterStorageLvpShareConfigArgs:
    def __init__(__self__, *,
                 ...
                 shared_path_pv_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input['BareMetalAdminClusterStorageLvpShareConfigLvpConfigArgs'] lvp_config: Defines the machine path and storage class for the LVP Share.
               Structure is documented below.
        :param pulumi.Input[builtins.int] shared_path_pv_count: The number of subdirectories to create under path.
        """
    ...
    def shared_path_pv_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of subdirectories to create under path.
        """
    ...
    def shared_path_pv_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class BareMetalAdminClusterValidationCheckArgsDict(TypedDict):
        options: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Options used for the validation check.
        """
        scenario: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class BareMetalAdminClusterValidationCheckArgs:
    def __init__(__self__, *,
                 ...
                 scenario: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] options: (Output)
               Options used for the validation check.
        :param pulumi.Input[builtins.str] scenario: (Output)
               The scenario when the preflight checks were run..
    ...
    @property
    @pulumi.getter
    def scenario(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The scenario when the preflight checks were run..
        """
    ...
    @scenario.setter
    def scenario(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BareMetalAdminClusterValidationCheckStatusResultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] category: (Output)
               The category of the validation.
        :param pulumi.Input[builtins.str] description: A human readable description of this Bare Metal Admin Cluster.
...
class BareMetalClusterBinaryAuthorizationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] evaluation_mode: Mode of operation for binauthz policy evaluation. If unspecified,
               defaults to DISABLED.
               Possible values are: `DISABLED`, `PROJECT_SINGLETON_POLICY_ENFORCE`.
        """
...
class BareMetalClusterLoadBalancerBgpLbConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BareMetalClusterLoadBalancerBgpLbConfigAddressPoolArgs']]] address_pools: AddressPools is a list of non-overlapping IP pools used by load balancer
               ...
               IngressVIP must be included in the pools.
               Structure is documented below.
        :param pulumi.Input[builtins.int] asn: BGP autonomous system number (ASN) of the cluster.
               This field can be updated after cluster creation.
...
if not MYPY:
    class BareMetalClusterLoadBalancerBgpLbConfigAddressPoolArgsDict(TypedDict):
        ...
        """
        avoid_buggy_ips: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BareMetalClusterLoadBalancerBgpLbConfigAddressPoolArgs:
    ...
    def avoid_buggy_ips(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, avoid using IPs ending in .0 or .255.
        This avoids buggy consumer devices mistakenly dropping IPv4 traffic for those special IP addresses.
        """
    ...
    def avoid_buggy_ips(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BareMetalClusterLoadBalancerBgpLbConfigBgpPeerConfigArgsDict(TypedDict):
        ...
        """
        control_plane_nodes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BareMetalClusterLoadBalancerBgpLbConfigBgpPeerConfigArgs:
    def __init__(__self__, *,
                 asn: pulumi.Input[builtins.int],
                 ip_address: pulumi.Input[builtins.str],
                 control_plane_nodes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.int] asn: BGP autonomous system number (ASN) for the network that contains the
               external peer device.
        :param pulumi.Input[builtins.str] ip_address: The IP address of the external peer device.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] control_plane_nodes: The IP address of the control plane node that connects to the external
               peer.
               If you don't specify any control plane nodes, all control plane nodes
               can connect to the external peer. If you specify one or more IP addresses,
               only the nodes specified participate in peering sessions.
    ...
    def control_plane_nodes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The IP address of the control plane node that connects to the external
        peer.
        If you don't specify any control plane nodes, all control plane nodes
    ...
    def control_plane_nodes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgsDict(TypedDict):
        ...
        Defaults to 5.
        """
        serialize_image_pulls_disabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BareMetalClusterLoadBalancerBgpLbConfigLoadBalancerNodePoolConfigNodePoolConfigKubeletConfigArgs:
    def __init__(__self__, *,
                 ...
                 serialize_image_pulls_disabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] registry_burst: The maximum size of bursty pulls, temporarily allows pulls to burst to this
               number, while still not exceeding registry_pull_qps.
               The value must not be a negative number.
               Updating this field may impact scalability by changing the amount of
               traffic produced by image pulls.
               Defaults to 10.
        :param pulumi.Input[builtins.int] registry_pull_qps: The limit of registry pulls per second.
               Setting this value to 0 means no limit.
               Updating this field may impact scalability by changing the amount of
               traffic produced by image pulls.
               Defaults to 5.
        :param pulumi.Input[builtins.bool] serialize_image_pulls_disabled: Prevents the Kubelet from pulling multiple images at a time.
               We recommend *not* changing the default value on nodes that run docker
               daemon with version  < 1.9 or an Another Union File System (Aufs) storage
               backend. Issue https://github.com/kubernetes/kubernetes/issues/10959 has
               more details.
    ...
    def serialize_image_pulls_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Prevents the Kubelet from pulling multiple images at a time.
        We recommend *not* changing the default value on nodes that run docker
        daemon with version  < 1.9 or an Another Union File System (Aufs) storage
    ...
    def serialize_image_pulls_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BareMetalClusterLoadBalancerVipConfigArgsDict(TypedDict):
        ...
        """
        ingress_vip: pulumi.Input[builtins.str]
        """
...
class BareMetalClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *,
                 ...
                 ingress_vip: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this Bare Metal User Cluster.
        :param pulumi.Input[builtins.str] ingress_vip: The VIP which you previously set aside for ingress traffic into this Bare Metal User Cluster.
        """
        pulumi.set(__self__, "control_plane_vip", control_plane_vip)
    ...
    def ingress_vip(self) -> pulumi.Input[builtins.str]:
        """
        The VIP which you previously set aside for ingress traffic into this Bare Metal User Cluster.
        """
    ...
    @ingress_vip.setter
    def ingress_vip(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class BareMetalClusterNetworkConfigArgsDict(TypedDict):
        advanced_networking: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BareMetalClusterNetworkConfigArgs:
    def __init__(__self__, *,
                 advanced_networking: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] advanced_networking: Enables the use of advanced Anthos networking features, such as Bundled
               Load Balancing with BGP or the egress NAT gateway.
               Setting configuration for advanced networking features will automatically
               set this flag.
    ...
    def advanced_networking(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables the use of advanced Anthos networking features, such as Bundled
        Load Balancing with BGP or the egress NAT gateway.
        Setting configuration for advanced networking features will automatically
    ...
    def advanced_networking(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BareMetalClusterNetworkConfigMultipleNetworkInterfacesConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable multiple network interfaces for your pods.
               When set network_config.advanced_networking is automatically
               set to true.
        """
...
class BareMetalClusterNetworkConfigSrIovConfigArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to install the SR-IOV operator.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class BareMetalClusterNodeConfigArgsDict(TypedDict):
        container_runtime: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BareMetalClusterNodeConfigArgs:
    def __init__(__self__, *,
                 ...
                 max_pods_per_node: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] container_runtime: The available runtimes that can be used to run containers in a Bare Metal User Cluster.
               Possible values are: `CONTAINER_RUNTIME_UNSPECIFIED`, `DOCKER`, `CONTAINERD`.
        :param pulumi.Input[builtins.int] max_pods_per_node: The maximum number of pods a node can run. The size of the CIDR range
               assigned to the node will be derived from this parameter.
        """
...
if not MYPY:
    class BareMetalClusterOsEnvironmentConfigArgsDict(TypedDict):
        package_repo_excluded: pulumi.Input[builtins.bool]
        """
...
class BareMetalClusterOsEnvironmentConfigArgs:
    def __init__(__self__, *,
                 package_repo_excluded: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] package_repo_excluded: Whether the package repo should not be included when initializing
               bare metal machines.
        """
    ...
    def package_repo_excluded(self) -> pulumi.Input[builtins.bool]:
        """
        Whether the package repo should not be included when initializing
        bare metal machines.
        """
    ...
    def package_repo_excluded(self, value: pulumi.Input[builtins.bool]):
...
class BareMetalClusterUpgradePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] policy: Specifies which upgrade policy to use.
               Possible values are: `SERIAL`, `CONCURRENT`.
        """
...
class BareMetalNodePoolStatusConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] last_transition_time: (Output)
               Last time the condition transit from one status to another.
        :param pulumi.Input[builtins.str] message: Human-readable message indicating details about last transition.
        :param pulumi.Input[builtins.str] reason: Machine-readable message indicating details about last transition.
        :param pulumi.Input[builtins.str] state: (Output)
               The lifecycle state of the condition.
        :param pulumi.Input[builtins.str] type: Type of the condition.
               (e.g., ClusterRunning, NodePoolRunning or ServerSidePreflightReady)
...
if not MYPY:
    class VMwareClusterAntiAffinityGroupsArgsDict(TypedDict):
        aag_config_disabled: pulumi.Input[builtins.bool]
        """
...
class VMwareClusterAntiAffinityGroupsArgs:
    def __init__(__self__, *,
                 aag_config_disabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] aag_config_disabled: Spread nodes across at least three physical hosts (requires at least three
               hosts).
               Enabled by default.
        """
    ...
    def aag_config_disabled(self) -> pulumi.Input[builtins.bool]:
        """
        Spread nodes across at least three physical hosts (requires at least three
        hosts).
        Enabled by default.
    ...
    def aag_config_disabled(self, value: pulumi.Input[builtins.bool]):
...
class VMwareClusterAutoRepairConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether auto repair is enabled.
        """
        pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class VMwareClusterControlPlaneNodeArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        cpus: NotRequired[pulumi.Input[builtins.int]]
        """
...
class VMwareClusterControlPlaneNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VMwareClusterControlPlaneNodeAutoResizeConfigArgs'] auto_resize_config: AutoResizeConfig provides auto resizing configurations.
               Structure is documented below.
        :param pulumi.Input[builtins.int] cpus: The number of CPUs for each admin cluster node that serve as control planes
               for this VMware User Cluster. (default: 4 CPUs)
        :param pulumi.Input[builtins.int] memory: The megabytes of memory for each admin cluster node that serves as a
               control plane for this VMware User Cluster (default: 8192 MB memory).
        :param pulumi.Input[builtins.int] replicas: The number of control plane nodes for this VMware User Cluster.
               (default: 1 replica).
...
class VMwareClusterControlPlaneNodeAutoResizeConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable control plane node auto resizing.
...
if not MYPY:
    class VMwareClusterControlPlaneNodeVsphereConfigArgsDict(TypedDict):
        ...
        """
        storage_policy_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VMwareClusterControlPlaneNodeVsphereConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] datastore: The Vsphere datastore used by the Control Plane Node.
        :param pulumi.Input[builtins.str] storage_policy_name: The Vsphere storage policy used by the control plane Node.
        """
    ...
    def storage_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Vsphere storage policy used by the control plane Node.
        """
    ...
    def storage_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class VMwareClusterDataplaneV2ArgsDict(TypedDict):
        ...
        """
        dataplane_v2_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables Dataplane V2.
        """
        windows_dataplane_v2_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VMwareClusterDataplaneV2Args:
    def __init__(__self__, *,
                 advanced_networking: Optional[pulumi.Input[builtins.bool]] = None,
                 dataplane_v2_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 windows_dataplane_v2_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] advanced_networking: Enable advanced networking which requires dataplane_v2_enabled to be set true.
        :param pulumi.Input[builtins.bool] dataplane_v2_enabled: Enables Dataplane V2.
        :param pulumi.Input[builtins.bool] windows_dataplane_v2_enabled: Enable Dataplane V2 for clusters with Windows nodes.
        """
        if advanced_networking is not None:
            pulumi.set(__self__, "advanced_networking", advanced_networking)
    ...
    def dataplane_v2_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables Dataplane V2.
        """
    ...
    def dataplane_v2_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "dataplane_v2_enabled", value)

    @property
    @pulumi.getter(name="windowsDataplaneV2Enabled")
    def windows_dataplane_v2_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable Dataplane V2 for clusters with Windows nodes.
        """
    ...
    def windows_dataplane_v2_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class VMwareClusterLoadBalancerF5ConfigArgsDict(TypedDict):
        ...
        """
        partition: NotRequired[pulumi.Input[builtins.str]]
        """
        he preexisting partition to be used by the load balancer. T
        his partition is usually created for the admin cluster for example:
        'my-f5-admin-partition'.
        """
        snat_pool: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VMwareClusterLoadBalancerF5ConfigArgs:
    def __init__(__self__, *,
                 ...
                 snat_pool: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] address: The load balancer's IP address.
        :param pulumi.Input[builtins.str] partition: he preexisting partition to be used by the load balancer. T
               his partition is usually created for the admin cluster for example:
               'my-f5-admin-partition'.
        :param pulumi.Input[builtins.str] snat_pool: The pool name. Only necessary, if using SNAT.
        """
    ...
    def snat_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The pool name. Only necessary, if using SNAT.
        """
    ...
    @snat_pool.setter
    def snat_pool(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "snat_pool", value)


if not MYPY:
    class VMwareClusterLoadBalancerManualLbConfigArgsDict(TypedDict):
        control_plane_node_port: NotRequired[pulumi.Input[builtins.int]]
        """
        NodePort for control plane service. The Kubernetes API server in the admin
        cluster is implemented as a Service of type NodePort (ex. 30968).
        """
        ingress_http_node_port: NotRequired[pulumi.Input[builtins.int]]
        """
        NodePort for ingress service's http. The ingress service in the admin
        cluster is implemented as a Service of type NodePort (ex. 32527).
        """
        ingress_https_node_port: NotRequired[pulumi.Input[builtins.int]]
        """
        NodePort for ingress service's https. The ingress service in the admin
        cluster is implemented as a Service of type NodePort (ex. 30139).
        """
        konnectivity_server_node_port: NotRequired[pulumi.Input[builtins.int]]
        """
...
class VMwareClusterLoadBalancerManualLbConfigArgs:
    def __init__(__self__, *,
                 control_plane_node_port: Optional[pulumi.Input[builtins.int]] = None,
                 ingress_http_node_port: Optional[pulumi.Input[builtins.int]] = None,
                 ingress_https_node_port: Optional[pulumi.Input[builtins.int]] = None,
                 konnectivity_server_node_port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] control_plane_node_port: NodePort for control plane service. The Kubernetes API server in the admin
               cluster is implemented as a Service of type NodePort (ex. 30968).
        :param pulumi.Input[builtins.int] ingress_http_node_port: NodePort for ingress service's http. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 32527).
        :param pulumi.Input[builtins.int] ingress_https_node_port: NodePort for ingress service's https. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 30139).
        :param pulumi.Input[builtins.int] konnectivity_server_node_port: NodePort for konnectivity server service running as a sidecar in each
               kube-apiserver pod (ex. 30564).
        """
    ...
    def control_plane_node_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        NodePort for control plane service. The Kubernetes API server in the admin
        cluster is implemented as a Service of type NodePort (ex. 30968).
        """
    ...
    def control_plane_node_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "control_plane_node_port", value)

    @property
    @pulumi.getter(name="ingressHttpNodePort")
    def ingress_http_node_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        NodePort for ingress service's http. The ingress service in the admin
        cluster is implemented as a Service of type NodePort (ex. 32527).
        """
    ...
    def ingress_http_node_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ingress_http_node_port", value)

    @property
    @pulumi.getter(name="ingressHttpsNodePort")
    def ingress_https_node_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        NodePort for ingress service's https. The ingress service in the admin
        cluster is implemented as a Service of type NodePort (ex. 30139).
        """
    ...
    def ingress_https_node_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ingress_https_node_port", value)

    @property
    @pulumi.getter(name="konnectivityServerNodePort")
    def konnectivity_server_node_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        NodePort for konnectivity server service running as a sidecar in each
        kube-apiserver pod (ex. 30564).
        """
    ...
    def konnectivity_server_node_port(self, value: Optional[pulumi.Input[builtins.int]]):
...
class VMwareClusterLoadBalancerMetalLbConfigAddressPoolArgs:
    def __init__(__self__, *,
                 ...
                 manual_assign: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] addresses: The addresses that are part of this pool. Each address
               must be either in the CIDR form (1.2.3.0/24) or range
               form (1.2.3.1-1.2.3.5).
        :param pulumi.Input[builtins.str] pool: The name of the address pool.
        :param pulumi.Input[builtins.bool] avoid_buggy_ips: If true, avoid using IPs ending in .0 or .255.
...
if not MYPY:
    class VMwareClusterLoadBalancerVipConfigArgsDict(TypedDict):
        control_plane_vip: NotRequired[pulumi.Input[builtins.str]]
        """
        The VIP which you previously set aside for the Kubernetes API of this cluster.
        """
        ingress_vip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VMwareClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *,
                 control_plane_vip: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_vip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] control_plane_vip: The VIP which you previously set aside for the Kubernetes API of this cluster.
        :param pulumi.Input[builtins.str] ingress_vip: The VIP which you previously set aside for ingress traffic into this cluster.
    ...
    @property
    @pulumi.getter(name="controlPlaneVip")
    def control_plane_vip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The VIP which you previously set aside for the Kubernetes API of this cluster.
        """
        return pulumi.get(self, "control_plane_vip")
    ...
    @control_plane_vip.setter
    def control_plane_vip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "control_plane_vip", value)

    @property
    @pulumi.getter(name="ingressVip")
    def ingress_vip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The VIP which you previously set aside for ingress traffic into this cluster.
    ...
    @ingress_vip.setter
    def ingress_vip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingress_vip", value)
...
if not MYPY:
    class VMwareClusterNetworkConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        vcenter_network: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VMwareClusterNetworkConfigArgs:
    def __init__(__self__, *,
                 ...
                 vcenter_network: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pod_address_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these ranges.
               Only a single range is supported. This field cannot be changed after creation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_address_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address
               from these ranges. Only a single range is supported.. This field
               cannot be changed after creation.
        ...
        :param pulumi.Input['VMwareClusterNetworkConfigStaticIpConfigArgs'] static_ip_config: Configuration settings for a static IP configuration.
               Structure is documented below.
        :param pulumi.Input[builtins.str] vcenter_network: vcenter_network specifies vCenter network name. Inherited from the admin cluster.
        """
        pulumi.set(__self__, "pod_address_cidr_blocks", pod_address_cidr_blocks)
        pulumi.set(__self__, "service_address_cidr_blocks", service_address_cidr_blocks)
    ...
    def vcenter_network(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        vcenter_network specifies vCenter network name. Inherited from the admin cluster.
        """
    ...
    def vcenter_network(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] gateway: The network gateway used by the VMware User Cluster.
        :param pulumi.Input[Sequence[pulumi.Input['VMwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpArgs']]] ips: The node's network configurations used by the VMware User Cluster.
               Structure is documented below.
        :param pulumi.Input[builtins.str] netmask: The netmask used by the VMware User Cluster.
        """
...
class VMwareClusterNetworkConfigDhcpIpConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: enabled is a flag to mark if DHCP IP allocation is
               used for VMware user clusters.
        """
        pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class VMwareClusterNetworkConfigHostConfigArgsDict(TypedDict):
        dns_search_domains: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        DNS search domains.
...
class VMwareClusterNetworkConfigHostConfigArgs:
    def __init__(__self__, *,
                 dns_search_domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_search_domains: DNS search domains.
               
               <a name="nested_network_config_control_plane_v2_config"></a>The `control_plane_v2_config` block supports:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: DNS servers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ntp_servers: NTP servers.
        """
    ...
    def dns_search_domains(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        DNS search domains.
    ...
    def dns_search_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class VMwareClusterStorageArgsDict(TypedDict):
        vsphere_csi_disabled: pulumi.Input[builtins.bool]
        """
...
class VMwareClusterStorageArgs:
    def __init__(__self__, *,
                 vsphere_csi_disabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] vsphere_csi_disabled: Whether or not to deploy vSphere CSI components in the VMware User Cluster.
               Enabled by default.
        """
    ...
    def vsphere_csi_disabled(self) -> pulumi.Input[builtins.bool]:
        """
        Whether or not to deploy vSphere CSI components in the VMware User Cluster.
        Enabled by default.
        """
    ...
    def vsphere_csi_disabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "vsphere_csi_disabled", value)


if not MYPY:
    class VMwareClusterUpgradePolicyArgsDict(TypedDict):
        control_plane_only: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VMwareClusterUpgradePolicyArgs:
    def __init__(__self__, *,
                 control_plane_only: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] control_plane_only: Controls whether the upgrade applies to the control plane only.
        """
    ...
    def control_plane_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Controls whether the upgrade applies to the control plane only.
        """
    ...
    def control_plane_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class VMwareClusterVcenterArgsDict(TypedDict):
        ...
        """
        ca_cert_data: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VMwareClusterVcenterArgs:
    def __init__(__self__, *,
                 address: Optional[pulumi.Input[builtins.str]] = None,
                 ca_cert_data: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] address: (Output)
               The vCenter IP address.
        :param pulumi.Input[builtins.str] ca_cert_data: Contains the vCenter CA certificate public key for SSL verification.
        :param pulumi.Input[builtins.str] cluster: The name of the vCenter cluster for the user cluster.
        :param pulumi.Input[builtins.str] datacenter: The name of the vCenter datacenter for the user cluster.
        :param pulumi.Input[builtins.str] datastore: The name of the vCenter datastore for the user cluster.
        :param pulumi.Input[builtins.str] folder: The name of the vCenter folder for the user cluster.
        :param pulumi.Input[builtins.str] resource_pool: The name of the vCenter resource pool for the user cluster.
        :param pulumi.Input[builtins.str] storage_policy_name: The name of the vCenter storage policy for the user cluster.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
    ...
    def ca_cert_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Contains the vCenter CA certificate public key for SSL verification.
        """
    ...
    @ca_cert_data.setter
    def ca_cert_data(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class VMwareNodePoolConfigArgsDict(TypedDict):
        image_type: pulumi.Input[builtins.str]
        """
        ...
        """
        enable_load_balancer: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VMwareNodePoolConfigArgs:
    def __init__(__self__, *,
                 ...
                 cpus: Optional[pulumi.Input[builtins.int]] = None,
                 enable_load_balancer: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] image_type: The OS image to be used for each node in a node pool.
               Currently `cos`, `cos_cgv2`, `ubuntu`, `ubuntu_cgv2`, `ubuntu_containerd` and `windows` are supported.
        :param pulumi.Input[builtins.int] boot_disk_size_gb: VMware disk size to be used during creation.
        :param pulumi.Input[builtins.int] cpus: The number of CPUs for each node in the node pool.
        :param pulumi.Input[builtins.bool] enable_load_balancer: Allow node pool traffic to be load balanced. Only works for clusters with
               MetalLB load balancers.
        :param pulumi.Input[builtins.str] image: The OS image name in vCenter, only valid when using Windows.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The map of Kubernetes labels (key/value pairs) to be applied to each node.
               These will added in addition to any default label(s) that
               Kubernetes may apply to the node.
               In case of conflict in label keys, the applied set may differ depending on
               the Kubernetes version -- it's best to assume the behavior is undefined
               and conflicts should be avoided.
        :param pulumi.Input[builtins.int] memory_mb: The megabytes of memory for each node in the node pool.
        :param pulumi.Input[builtins.int] replicas: The number of nodes in the node pool.
    ...
    def image_type(self) -> pulumi.Input[builtins.str]:
        """
        The OS image to be used for each node in a node pool.
        Currently `cos`, `cos_cgv2`, `ubuntu`, `ubuntu_cgv2`, `ubuntu_containerd` and `windows` are supported.
        """
    ...
    @image_type.setter
    def image_type(self, value: pulumi.Input[builtins.str]):
    ...
    def enable_load_balancer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Allow node pool traffic to be load balanced. Only works for clusters with
        MetalLB load balancers.
        """
    ...
    def enable_load_balancer(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class VMwareNodePoolConfigTaintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: Key associated with the effect.
        :param pulumi.Input[builtins.str] value: Value associated with the effect.
        :param pulumi.Input[builtins.str] effect: Available taint effects.
               Possible values are: `EFFECT_UNSPECIFIED`, `NO_SCHEDULE`, `PREFER_NO_SCHEDULE`, `NO_EXECUTE`.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class VMwareNodePoolConfigVsphereConfigArgsDict(TypedDict):
        ...
        """
        host_groups: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class VMwareNodePoolConfigVsphereConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] datastore: The name of the vCenter datastore. Inherited from the user cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] host_groups: Vsphere host groups to apply to all VMs in the node pool
...
if not MYPY:
    class VMwareNodePoolNodePoolAutoscalingArgsDict(TypedDict):
        ...
        """
        min_replicas: pulumi.Input[builtins.int]
        """
...
class VMwareNodePoolNodePoolAutoscalingArgs:
    def __init__(__self__, *,
                 ...
                 min_replicas: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_replicas: Maximum number of replicas in the NodePool.
        :param pulumi.Input[builtins.int] min_replicas: Minimum number of replicas in the NodePool.
        """
    ...
    def min_replicas(self) -> pulumi.Input[builtins.int]:
        """
        Minimum number of replicas in the NodePool.
        """
    ...
    @min_replicas.setter
    def min_replicas(self, value: pulumi.Input[builtins.int]):
...
class VmwareAdminClusterAddonNodeAutoResizeConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable controle plane node auto resizing.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class VmwareAdminClusterControlPlaneNodeArgs:
    def __init__(__self__, *,
                 ...
                 replicas: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] cpus: The number of vCPUs for the control-plane node of the admin cluster.
        :param pulumi.Input[builtins.int] memory: The number of mebibytes of memory for the control-plane node of the admin cluster.
        :param pulumi.Input[builtins.int] replicas: The number of control plane nodes for this VMware admin cluster.
        """
        if cpus is not None:
            pulumi.set(__self__, "cpus", cpus)
        if memory is not None:
...
if not MYPY:
    class VmwareAdminClusterLoadBalancerManualLbConfigArgsDict(TypedDict):
        addons_node_port: NotRequired[pulumi.Input[builtins.int]]
        """
...
class VmwareAdminClusterLoadBalancerManualLbConfigArgs:
    def __init__(__self__, *,
                 addons_node_port: Optional[pulumi.Input[builtins.int]] = None,
                 control_plane_node_port: Optional[pulumi.Input[builtins.int]] = None,
                 ingress_http_node_port: Optional[pulumi.Input[builtins.int]] = None,
                 ingress_https_node_port: Optional[pulumi.Input[builtins.int]] = None,
                 konnectivity_server_node_port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] addons_node_port: NodePort for add-ons server in the admin cluster.
        :param pulumi.Input[builtins.int] control_plane_node_port: NodePort for control plane service. The Kubernetes API server in the admin
               cluster is implemented as a Service of type NodePort (ex. 30968).
        :param pulumi.Input[builtins.int] ingress_http_node_port: NodePort for ingress service's http. The ingress service in the admin
               cluster is implemented as a Service of type NodePort (ex. 32527).
    ...
    def addons_node_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        NodePort for add-ons server in the admin cluster.
        """
    ...
    def addons_node_port(self, value: Optional[pulumi.Input[builtins.int]]):
...
class VmwareAdminClusterLoadBalancerMetalLbConfigArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Metal LB is enabled.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class VmwareAdminClusterLoadBalancerVipConfigArgsDict(TypedDict):
        ...
        """
        addons_vip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VmwareAdminClusterLoadBalancerVipConfigArgs:
    def __init__(__self__, *,
                 control_plane_vip: pulumi.Input[builtins.str],
                 addons_vip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] control_plane_vip: The VIP which you previously set aside for the Kubernetes
               API of this VMware Admin Cluster.
        :param pulumi.Input[builtins.str] addons_vip: The VIP to configure the load balancer for add-ons.
    ...
    def addons_vip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The VIP to configure the load balancer for add-ons.
    ...
    @addons_vip.setter
    def addons_vip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VmwareAdminClusterNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['VmwareAdminClusterNetworkConfigStaticIpConfigArgs'] static_ip_config: Configuration settings for a static IP configuration.
               Structure is documented below.
        :param pulumi.Input[builtins.str] vcenter_network: vcenter_network specifies vCenter network name.
        """
        pulumi.set(__self__, "pod_address_cidr_blocks", pod_address_cidr_blocks)
        pulumi.set(__self__, "service_address_cidr_blocks", service_address_cidr_blocks)
        if dhcp_ip_config is not None:
...
class VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockArgs:
    def __init__(__self__, *,
                 ...
                 netmask: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] gateway: The network gateway used by the VMware Admin Cluster.
        :param pulumi.Input[Sequence[pulumi.Input['VmwareAdminClusterNetworkConfigHaControlPlaneConfigControlPlaneIpBlockIpArgs']]] ips: The node's network configurations used by the VMware Admin Cluster.
               Structure is documented below.
        :param pulumi.Input[builtins.str] netmask: The netmask used by the VMware Admin Cluster.
        """
        pulumi.set(__self__, "gateway", gateway)
        pulumi.set(__self__, "ips", ips)
        pulumi.set(__self__, "netmask", netmask)
...
if not MYPY:
    class VmwareAdminClusterPlatformConfigArgsDict(TypedDict):
        ...
        """
        required_platform_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VmwareAdminClusterPlatformConfigArgs:
    def __init__(__self__, *,
                 ...
                 required_platform_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VmwareAdminClusterPlatformConfigBundleArgs']]] bundles: (Output)
               The list of bundles installed in the admin cluster.
               Structure is documented below.
        :param pulumi.Input[builtins.str] platform_version: (Output)
               The platform version e.g. 1.13.2.
        :param pulumi.Input[builtins.str] required_platform_version: The required platform version e.g. 1.13.1.
               If the current platform version is lower than the target version,
               the platform version will be updated to the target version.
               If the target version is not installed in the platform
               (bundle versions), download the target version bundle.
    ...
    def required_platform_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The required platform version e.g. 1.13.1.
        If the current platform version is lower than the target version,
        the platform version will be updated to the target version.
    ...
    def required_platform_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VmwareAdminClusterPlatformConfigBundleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VmwareAdminClusterPlatformConfigBundleStatusArgs']]] statuses: ResourceStatus representing detailed cluster state.
               Structure is documented below.
        :param pulumi.Input[builtins.str] version: The version of the bundle.
        """
        if statuses is not None:
            pulumi.set(__self__, "statuses", statuses)
...
if not MYPY:
    class VmwareAdminClusterVcenterArgsDict(TypedDict):
        ...
        """
        data_disk: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VmwareAdminClusterVcenterArgs:
    def __init__(__self__, *,
                 ...
                 ca_cert_data: Optional[pulumi.Input[builtins.str]] = None,
                 cluster: Optional[pulumi.Input[builtins.str]] = None,
                 data_disk: Optional[pulumi.Input[builtins.str]] = None,
                 datacenter: Optional[pulumi.Input[builtins.str]] = None,
                 datastore: Optional[pulumi.Input[builtins.str]] = None,
                 folder: Optional[pulumi.Input[builtins.str]] = None,
                 resource_pool: Optional[pulumi.Input[builtins.str]] = None,
                 storage_policy_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] address: The vCenter IP address.
        :param pulumi.Input[builtins.str] ca_cert_data: Contains the vCenter CA certificate public key for SSL verification.
        :param pulumi.Input[builtins.str] cluster: The name of the vCenter cluster for the admin cluster.
        :param pulumi.Input[builtins.str] data_disk: The name of the virtual machine disk (VMDK) for the admin cluster.
        :param pulumi.Input[builtins.str] datacenter: The name of the vCenter datacenter for the admin cluster.
        :param pulumi.Input[builtins.str] datastore: The name of the vCenter datastore for the admin cluster.
        :param pulumi.Input[builtins.str] folder: The name of the vCenter folder for the admin cluster.
        :param pulumi.Input[builtins.str] resource_pool: The name of the vCenter resource pool for the admin cluster.
        :param pulumi.Input[builtins.str] storage_policy_name: The name of the vCenter storage policy for the user cluster.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
    ...
    def data_disk(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the virtual machine disk (VMDK) for the admin cluster.
        """
    ...
    @data_disk.setter
    def data_disk(self, value: Optional[pulumi.Input[builtins.str]]):
