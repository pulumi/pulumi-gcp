...
class VMwareNodePoolArgs:
    def __init__(__self__, *,
                 ...
                 vmware_cluster: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] vmware_cluster: The cluster this node pool belongs to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Annotations on the node Pool. This field has the same restrictions as Kubernetes annotations. The total size of all keys
        ...
        :param pulumi.Input[builtins.str] display_name: The display name for the node pool.
        :param pulumi.Input[builtins.str] name: The vmware node pool name.
    ...
    def vmware_cluster(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vmware_cluster(self, value: pulumi.Input[builtins.str]):
...
class _VMwareNodePoolState:
    def __init__(__self__, *,
                 ...
                 vmware_cluster: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: The vmware node pool name.
        :param pulumi.Input['VMwareNodePoolNodePoolAutoscalingArgs'] node_pool_autoscaling: Node Pool autoscaling config for the node pool.
        :param pulumi.Input[builtins.str] on_prem_version: Anthos version for the node pool. Defaults to the user cluster version.
        :param pulumi.Input[builtins.bool] reconciling: If set, there are currently changes in flight to the node pool.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VMwareNodePoolStatusArgs']]] statuses: ResourceStatus representing detailed cluster state.
               Structure is documented below.
        :param pulumi.Input[builtins.str] uid: The unique identifier of the node pool.
    ...
    @property
    @pulumi.getter(name="vmwareCluster")
    def vmware_cluster(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The cluster this node pool belongs to.
        """
        return pulumi.get(self, "vmware_cluster")
    ...
    @vmware_cluster.setter
    def vmware_cluster(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vmware_cluster", value)
...
class VMwareNodePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            vmware_cluster: Optional[pulumi.Input[builtins.str]] = None) -> 'VMwareNodePool':
        """
    ...
    @property
    @pulumi.getter(name="onPremVersion")
    def on_prem_version(self) -> pulumi.Output[builtins.str]:
        """
        Anthos version for the node pool. Defaults to the user cluster version.
        """
        return pulumi.get(self, "on_prem_version")
    ...
    @property
    @pulumi.getter(name="vmwareCluster")
    def vmware_cluster(self) -> pulumi.Output[builtins.str]:
        """
        The cluster this node pool belongs to.
        """
        return pulumi.get(self, "vmware_cluster")
