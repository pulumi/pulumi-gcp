...
class MetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] label_extractors: A map from a label key string to an extractor expression which is used to extract data from a log
        ...
        :param pulumi.Input['MetricMetricDescriptorArgs'] metric_descriptor: The optional metric descriptor associated with the logs-based metric.
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.str] name: The client-assigned metric identifier. Examples - "error_count", "nginx/requests".
        ...
        :param pulumi.Input[_builtins.str] value_extractor: A valueExtractor is required when using a distribution logs-based metric to extract the values to
