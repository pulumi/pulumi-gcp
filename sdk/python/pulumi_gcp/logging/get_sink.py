...
def get_sink(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The identifier for the resource. 
           Examples:
...
def get_sink_output(id: Optional[pulumi.Input[builtins.str]] = None,
