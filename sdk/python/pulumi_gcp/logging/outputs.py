...
class BillingAccountBucketConfigCmekSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_version_name: Optional[builtins.str] = None,
        ...
        :param builtins.str kms_key_version_name: The CryptoKeyVersion resource name for the configured Cloud KMS key.
               KMS key name format:
               "projects/[PROJECT_ID]/locations/[LOCATION]/keyRings/[KEYRING]/cryptoKeys/[KEY]/cryptoKeyVersions/[VERSION]"
               For example:
               "projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key/cryptoKeyVersions/1"
               This is a read-only field used to convey the specific configured CryptoKeyVersion of kms_key that has been configured. It will be populated in cases where the CMEK settings are bound to a single key version.
        :param builtins.str name: The resource name of the bucket. For example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id"
        :param builtins.str service_account_id: The service account associated with a project for which CMEK will apply.
    ...
    def kms_key_version_name(self) -> Optional[builtins.str]:
        """
...
class BillingAccountBucketConfigIndexConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str field_path: The LogEntry field path to index.
        ...
        :param builtins.str type: The type of data in this index. Allowed types include `INDEX_TYPE_UNSPECIFIED`, `INDEX_TYPE_STRING` and `INDEX_TYPE_INTEGER`.
        """
...
class BillingAccountSinkBigqueryOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool use_partitioned_tables: Whether to use [BigQuery's partition tables](https://cloud.google.com/bigquery/docs/partitioned-tables).
    ...
    def use_partitioned_tables(self) -> builtins.bool:
        """
...
class BillingAccountSinkExclusion(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str filter: An advanced logs filter that matches the log entries to be excluded. By using the sample function, you can exclude less than 100% of the matching log entries. See [Advanced Log Filters](https://cloud.google.com/logging/docs/view/advanced_filters) for information on how to
               write a filter.
        :param builtins.str name: A client-assigned identifier, such as `load-balancer-exclusion`. Identifiers are limited to 100 characters and can include only letters, digits, underscores, hyphens, and periods. First character has to be alphanumeric.
        :param builtins.str description: A description of this exclusion.
        :param builtins.bool disabled: If set to True, then this exclusion is disabled and it does not exclude any log entries.
        """
...
class FolderBucketConfigCmekSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_version_name: The CryptoKeyVersion resource name for the configured Cloud KMS key.
               ...
               "projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key/cryptoKeyVersions/1"
               This is a read-only field used to convey the specific configured CryptoKeyVersion of kms_key that has been configured. It will be populated in cases where the CMEK settings are bound to a single key version.
        :param builtins.str name: The resource name of the bucket. For example: "folders/my-folder-id/locations/my-location/buckets/my-bucket-id"
        :param builtins.str service_account_id: The service account associated with a project for which CMEK will apply.
               Before enabling CMEK for a logging bucket, you must first assign the cloudkms.cryptoKeyEncrypterDecrypter role to the service account associated with the project for which CMEK will apply. Use [v2.getCmekSettings](https://cloud.google.com/logging/docs/reference/v2/rest/v2/TopLevel/getCmekSettings#google.logging.v2.ConfigServiceV2.GetCmekSettings) to obtain the service account ID.
               See [Enabling CMEK for Logging Buckets](https://cloud.google.com/logging/docs/routing/managed-encryption-storage) for more information.
        """
...
class LinkedDatasetBigqueryDataset(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dataset_id: (Output)
...
class MetricBucketOptionsExplicitBuckets(dict):
    def __init__(__self__, *,
                 bounds: Sequence[builtins.float]):
        """
        :param Sequence[builtins.float] bounds: The values must be monotonically increasing.
        """
        pulumi.set(__self__, "bounds", bounds)

    @property
    @pulumi.getter
    def bounds(self) -> Sequence[builtins.float]:
        """
...
class MetricBucketOptionsExponentialBuckets(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.float growth_factor: Must be greater than 1.
        :param builtins.int num_finite_buckets: Must be greater than 0.
        :param builtins.float scale: Must be greater than 0.
        """
    ...
    def growth_factor(self) -> builtins.float:
        """
    ...
    def num_finite_buckets(self) -> builtins.int:
        """
...
class MetricBucketOptionsLinearBuckets(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int num_finite_buckets: Must be greater than 0.
        :param builtins.float offset: Lower bound of the first bucket.
        :param builtins.float width: Must be greater than 0.
        """
        pulumi.set(__self__, "num_finite_buckets", num_finite_buckets)
...
class MetricMetricDescriptor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metric_kind: Whether the metric records instantaneous values, changes to a value, etc.
               Some combinations of metricKind and valueType might not be supported.
               For counter metrics, set this to DELTA.
               Possible values are: `DELTA`, `GAUGE`, `CUMULATIVE`.
        :param builtins.str value_type: Whether the measurement is an integer, a floating-point number, etc.
               Some combinations of metricKind and valueType might not be supported.
               For counter metrics, set this to INT64.
               Possible values are: `BOOL`, `INT64`, `DOUBLE`, `STRING`, `DISTRIBUTION`, `MONEY`.
        :param builtins.str display_name: A concise name for the metric, which can be displayed in user interfaces. Use sentence case
        ...
        :param Sequence['MetricMetricDescriptorLabelArgs'] labels: The set of labels that can be used to describe a specific instance of this metric type. For
               ...
               Structure is documented below.
        :param builtins.str unit: The unit in which the metric value is reported. It is only applicable if the valueType is
...
class MetricMetricDescriptorLabel(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str description: A human-readable description for the label.
        :param builtins.str value_type: The type of data that can be assigned to the label.
...
class OrganizationBucketConfigCmekSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_version_name: The CryptoKeyVersion resource name for the configured Cloud KMS key.
               ...
               "projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key/cryptoKeyVersions/1"
               This is a read-only field used to convey the specific configured CryptoKeyVersion of kms_key that has been configured. It will be populated in cases where the CMEK settings are bound to a single key version.
        :param builtins.str name: The resource name of the bucket. For example: "organizations/my-organization-id/locations/my-location/buckets/my-bucket-id"
        :param builtins.str service_account_id: The service account associated with a project for which CMEK will apply.
               Before enabling CMEK for a logging bucket, you must first assign the cloudkms.cryptoKeyEncrypterDecrypter role to the service account associated with the project for which CMEK will apply. Use [v2.getCmekSettings](https://cloud.google.com/logging/docs/reference/v2/rest/v2/TopLevel/getCmekSettings#google.logging.v2.ConfigServiceV2.GetCmekSettings) to obtain the service account ID.
               See [Enabling CMEK for Logging Buckets](https://cloud.google.com/logging/docs/routing/managed-encryption-storage) for more information.
        """
...
class ProjectBucketConfigCmekSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_version_name: The CryptoKeyVersion resource name for the configured Cloud KMS key.
               ...
               "projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key/cryptoKeyVersions/1"
               This is a read-only field used to convey the specific configured CryptoKeyVersion of kms_key that has been configured. It will be populated in cases where the CMEK settings are bound to a single key version.
        :param builtins.str name: The resource name of the CMEK settings.
        :param builtins.str service_account_id: The service account associated with a project for which CMEK will apply.
               Before enabling CMEK for a logging bucket, you must first assign the cloudkms.cryptoKeyEncrypterDecrypter role to the service account associated with the project for which CMEK will apply. Use [v2.getCmekSettings](https://cloud.google.com/logging/docs/reference/v2/rest/v2/TopLevel/getCmekSettings#google.logging.v2.ConfigServiceV2.GetCmekSettings) to obtain the service account ID.
               See [Enabling CMEK for Logging Buckets](https://cloud.google.com/logging/docs/routing/managed-encryption-storage) for more information.
        """
...
class GetSinkBigqueryOptionResult(dict):
    def __init__(__self__, *,
                 use_partitioned_tables: builtins.bool):
        """
        :param builtins.bool use_partitioned_tables: Whether [BigQuery's partition tables](https://cloud.google.com/bigquery/docs/partitioned-tables) are used.
        """
        pulumi.set(__self__, "use_partitioned_tables", use_partitioned_tables)
...
class GetSinkExclusionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: A description of this exclusion.
        :param builtins.bool disabled: Whether this exclusion is disabled and it does not exclude any log entries.
        :param builtins.str filter: An advanced logs filter that matches the log entries to be excluded.
        :param builtins.str name: A client-assigned identifier, such as `load-balancer-exclusion`.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "disabled", disabled)
        pulumi.set(__self__, "filter", filter)
