...
def get_project_settings(project: Optional[_builtins.str] = None,
    ...
    * [Configure default settings for organizations and folders](https://cloud.google.com/logging/docs/default-settings).
    ...
    :param _builtins.str project: The ID of the project for which to retrieve settings.
    """
    __args__ = dict()
...
def get_project_settings_output(project: Optional[pulumi.Input[_builtins.str]] = None,
