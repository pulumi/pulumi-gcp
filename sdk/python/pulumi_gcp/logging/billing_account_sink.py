...
class BillingAccountSinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] billing_account: The billing account exported to the sink.
        :param pulumi.Input[builtins.str] destination: The destination of the sink (or, in other words, where logs are written to). Can be a
...
class BillingAccountSink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            filter: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            writer_identity: Optional[pulumi.Input[builtins.str]] = None) -> 'BillingAccountSink':
        """
