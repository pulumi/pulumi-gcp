...
class LinkedDatasetArgs:
    ...
    def bigquery_datasets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LinkedDatasetBigqueryDatasetArgs']]]]:
        """
    ...
    def bigquery_datasets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LinkedDatasetBigqueryDatasetArgs']]]]):
...
class _LinkedDatasetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] link_id: The id of the linked dataset.
        :param pulumi.Input[_builtins.str] location: The location of the linked dataset.
        :param pulumi.Input[_builtins.str] name: The resource name of the linked dataset. The name can have up to 100 characters. A valid link id
...
class LinkedDataset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bigquery_datasets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LinkedDatasetBigqueryDatasetArgs', 'LinkedDatasetBigqueryDatasetArgsDict', 'outputs.LinkedDatasetBigqueryDataset']]]]] = None,
                 bucket: pulumi.Input[Optional[_builtins.str]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 link_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{parent}}/locations/{{location}}/buckets/{{bucket}}/links/{{link_id}}`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['LinkedDatasetBigqueryDatasetArgs', 'LinkedDatasetBigqueryDatasetArgsDict', 'outputs.LinkedDatasetBigqueryDataset']]]] bigquery_datasets: The information of a BigQuery Dataset. When a link is created, a BigQuery dataset is created along
               with it, in the same project as the LogBucket it's linked to. This dataset will also have BigQuery
               Views corresponding to the LogViews in the bucket.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] bucket: The bucket to which the linked dataset is attached.
    ...
    def get(resource_name: str,
            ...
            location: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            parent: pulumi.Input[Optional[_builtins.str]] = None) -> 'LinkedDataset':
        """
