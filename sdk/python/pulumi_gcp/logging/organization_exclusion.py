...
class OrganizationExclusionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] filter: The filter to apply when excluding logs. Only log entries that match the filter are excluded.
               ...
               write a filter.
        :param pulumi.Input[_builtins.str] org_id: The organization to create the exclusion in.
...
class OrganizationExclusion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            filter: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            org_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'OrganizationExclusion':
        """
