...
def get_folder_settings(folder: Optional[builtins.str] = None,
    ...
    * [Configure default settings for organizations and folders](https://cloud.google.com/logging/docs/default-settings).
    ...
    :param builtins.str folder: The ID of the folder for which to retrieve settings.
    """
    __args__ = dict()
...
def get_folder_settings_output(folder: Optional[pulumi.Input[builtins.str]] = None,
