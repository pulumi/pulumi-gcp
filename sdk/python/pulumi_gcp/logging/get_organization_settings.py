...
def get_organization_settings(organization: Optional[builtins.str] = None,
    ...
    * [Configure default settings for organizations and folders](https://cloud.google.com/logging/docs/default-settings).
    ...
    :param builtins.str organization: The ID of the organization for which to retrieve settings.
    """
    __args__ = dict()
...
def get_organization_settings_output(organization: Optional[pulumi.Input[builtins.str]] = None,
