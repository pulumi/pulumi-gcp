...
class LogViewIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: Optional[pulumi.Input['LogViewIamBindingConditionArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LogViewIamBinding resource.
        :param pulumi.Input[builtins.str] bucket: The bucket of the resource Used to find the parent resource to bind the IAM policy to
        ...
        :param pulumi.Input[builtins.str] parent: The parent of the resource. Used to find the parent resource to bind the IAM policy to
        ...
        :param pulumi.Input[builtins.str] location: The location of the resource. The supported locations are: global, us-central1, us-east1, us-west1, asia-east1, europe-west1. Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input['LogViewIamBindingConditionArgs']]):
...
class LogViewIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bucket: Optional[pulumi.Input[builtins.str]] = None,
                 condition: Optional[pulumi.Input[Union['LogViewIamBindingConditionArgs', 'LogViewIamBindingConditionArgsDict']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LogViewIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LogViewIamBindingArgs.__new__(LogViewIamBindingArgs)
        ...
        super(LogViewIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            parent: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'LogViewIamBinding':
        """
        ...
        __props__ = _LogViewIamBindingState.__new__(_LogViewIamBindingState)
        ...
        __props__.__dict__["parent"] = parent
        __props__.__dict__["role"] = role
        return LogViewIamBinding(resource_name, opts=opts, __props__=__props__)
