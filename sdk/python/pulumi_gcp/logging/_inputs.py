...
if not MYPY:
    class BillingAccountBucketConfigCmekSettingsArgsDict(TypedDict):
        ...
        """
        kms_key_version_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BillingAccountBucketConfigCmekSettingsArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str],
                 kms_key_version_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kms_key_name: The resource name for the configured Cloud KMS key.
               ...
               The Cloud KMS key used by the bucket can be updated by changing the kmsKeyName to a new valid key name. Encryption operations that are in progress will be completed with the key that was in use when they started. Decryption operations will be completed using the key that was used at the time of encryption unless access to that key has been revoked.
               See [Enabling CMEK for Logging Buckets](https://cloud.google.com/logging/docs/routing/managed-encryption-storage) for more information.
        :param pulumi.Input[builtins.str] kms_key_version_name: The CryptoKeyVersion resource name for the configured Cloud KMS key.
               KMS key name format:
               "projects/[PROJECT_ID]/locations/[LOCATION]/keyRings/[KEYRING]/cryptoKeys/[KEY]/cryptoKeyVersions/[VERSION]"
               For example:
               "projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key/cryptoKeyVersions/1"
               This is a read-only field used to convey the specific configured CryptoKeyVersion of kms_key that has been configured. It will be populated in cases where the CMEK settings are bound to a single key version.
        :param pulumi.Input[builtins.str] name: The resource name of the bucket. For example: "projects/my-project-id/locations/my-location/buckets/my-bucket-id"
        :param pulumi.Input[builtins.str] service_account_id: The service account associated with a project for which CMEK will apply.
               Before enabling CMEK for a logging bucket, you must first assign the cloudkms.cryptoKeyEncrypterDecrypter role to the service account associated with the project for which CMEK will apply. Use [v2.getCmekSettings](https://cloud.google.com/logging/docs/reference/v2/rest/v2/TopLevel/getCmekSettings#google.logging.v2.ConfigServiceV2.GetCmekSettings) to obtain the service account ID.
               See [Enabling CMEK for Logging Buckets](https://cloud.google.com/logging/docs/routing/managed-encryption-storage) for more information.
        """
    ...
    def kms_key_version_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CryptoKeyVersion resource name for the configured Cloud KMS key.
        KMS key name format:
        "projects/[PROJECT_ID]/locations/[LOCATION]/keyRings/[KEYRING]/cryptoKeys/[KEY]/cryptoKeyVersions/[VERSION]"
    ...
    def kms_key_version_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BillingAccountBucketConfigIndexConfigArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] field_path: The LogEntry field path to index.
               Note that some paths are automatically indexed, and other paths are not eligible for indexing. See [indexing documentation](https://cloud.google.com/logging/docs/analyze/custom-index) for details.
        :param pulumi.Input[builtins.str] type: The type of data in this index. Allowed types include `INDEX_TYPE_UNSPECIFIED`, `INDEX_TYPE_STRING` and `INDEX_TYPE_INTEGER`.
        """
...
if not MYPY:
    class BillingAccountSinkBigqueryOptionsArgsDict(TypedDict):
        use_partitioned_tables: pulumi.Input[builtins.bool]
        """
...
class BillingAccountSinkBigqueryOptionsArgs:
    def __init__(__self__, *,
                 use_partitioned_tables: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] use_partitioned_tables: Whether to use [BigQuery's partition tables](https://cloud.google.com/bigquery/docs/partitioned-tables).
               By default, Logging creates dated tables based on the log entries' timestamps, e.g. syslog_20170523. With partitioned
               tables, the date suffix is no longer present and [special query syntax](https://cloud.google.com/bigquery/docs/querying-partitioned-tables)
               has to be used instead. In both cases, tables are sharded based on UTC timezone.
        """
    ...
    def use_partitioned_tables(self) -> pulumi.Input[builtins.bool]:
        """
        Whether to use [BigQuery's partition tables](https://cloud.google.com/bigquery/docs/partitioned-tables).
        By default, Logging creates dated tables based on the log entries' timestamps, e.g. syslog_20170523. With partitioned
        tables, the date suffix is no longer present and [special query syntax](https://cloud.google.com/bigquery/docs/querying-partitioned-tables)
    ...
    def use_partitioned_tables(self, value: pulumi.Input[builtins.bool]):
...
class BillingAccountSinkExclusionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] filter: An advanced logs filter that matches the log entries to be excluded. By using the sample function, you can exclude less than 100% of the matching log entries. See [Advanced Log Filters](https://cloud.google.com/logging/docs/view/advanced_filters) for information on how to
               write a filter.
        :param pulumi.Input[builtins.str] name: A client-assigned identifier, such as `load-balancer-exclusion`. Identifiers are limited to 100 characters and can include only letters, digits, underscores, hyphens, and periods. First character has to be alphanumeric.
        :param pulumi.Input[builtins.str] description: A description of this exclusion.
        :param pulumi.Input[builtins.bool] disabled: If set to True, then this exclusion is disabled and it does not exclude any log entries.
        """
...
class FolderBucketConfigCmekSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kms_key_version_name: The CryptoKeyVersion resource name for the configured Cloud KMS key.
               ...
               "projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key/cryptoKeyVersions/1"
               This is a read-only field used to convey the specific configured CryptoKeyVersion of kms_key that has been configured. It will be populated in cases where the CMEK settings are bound to a single key version.
        :param pulumi.Input[builtins.str] name: The resource name of the bucket. For example: "folders/my-folder-id/locations/my-location/buckets/my-bucket-id"
        :param pulumi.Input[builtins.str] service_account_id: The service account associated with a project for which CMEK will apply.
               Before enabling CMEK for a logging bucket, you must first assign the cloudkms.cryptoKeyEncrypterDecrypter role to the service account associated with the project for which CMEK will apply. Use [v2.getCmekSettings](https://cloud.google.com/logging/docs/reference/v2/rest/v2/TopLevel/getCmekSettings#google.logging.v2.ConfigServiceV2.GetCmekSettings) to obtain the service account ID.
               See [Enabling CMEK for Logging Buckets](https://cloud.google.com/logging/docs/routing/managed-encryption-storage) for more information.
        """
...
class LinkedDatasetBigqueryDatasetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dataset_id: (Output)
               Output only. The full resource name of the BigQuery dataset. The DATASET_ID will match the ID
               of the link, so the link must match the naming restrictions of BigQuery datasets
               (alphanumeric characters and underscores only). The dataset will have a resource path of
               "bigquery.googleapis.com/projects/[PROJECT_ID]/datasets/[DATASET_ID]"
...
if not MYPY:
    class MetricBucketOptionsExplicitBucketsArgsDict(TypedDict):
        bounds: pulumi.Input[Sequence[pulumi.Input[builtins.float]]]
        """
...
class MetricBucketOptionsExplicitBucketsArgs:
    def __init__(__self__, *,
                 bounds: pulumi.Input[Sequence[pulumi.Input[builtins.float]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.float]]] bounds: The values must be monotonically increasing.
        """
        pulumi.set(__self__, "bounds", bounds)

    @property
    @pulumi.getter
    def bounds(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.float]]]:
        """
        The values must be monotonically increasing.
        """
    ...
    @bounds.setter
    def bounds(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.float]]]):
...
if not MYPY:
    class MetricBucketOptionsExponentialBucketsArgsDict(TypedDict):
        ...
        """
        num_finite_buckets: pulumi.Input[builtins.int]
        """
        Must be greater than 0.
        """
        scale: pulumi.Input[builtins.float]
        """
        Must be greater than 0.
        """
elif False:
...
class MetricBucketOptionsExponentialBucketsArgs:
    def __init__(__self__, *,
                 ...
                 scale: pulumi.Input[builtins.float]):
        """
        :param pulumi.Input[builtins.float] growth_factor: Must be greater than 1.
        :param pulumi.Input[builtins.int] num_finite_buckets: Must be greater than 0.
        :param pulumi.Input[builtins.float] scale: Must be greater than 0.
        """
    ...
    def num_finite_buckets(self) -> pulumi.Input[builtins.int]:
        """
        Must be greater than 0.
        """
    ...
    def num_finite_buckets(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "num_finite_buckets", value)

    @property
    @pulumi.getter
    def scale(self) -> pulumi.Input[builtins.float]:
        """
        Must be greater than 0.
        """
    ...
    @scale.setter
    def scale(self, value: pulumi.Input[builtins.float]):
...
if not MYPY:
    class MetricBucketOptionsLinearBucketsArgsDict(TypedDict):
        ...
        Must be greater than 0.
        """
        offset: pulumi.Input[builtins.float]
        """
...
class MetricBucketOptionsLinearBucketsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] num_finite_buckets: Must be greater than 0.
        :param pulumi.Input[builtins.float] offset: Lower bound of the first bucket.
        :param pulumi.Input[builtins.float] width: Must be greater than 0.
        """
        pulumi.set(__self__, "num_finite_buckets", num_finite_buckets)
    ...
    @property
    @pulumi.getter
    def offset(self) -> pulumi.Input[builtins.float]:
        """
        Lower bound of the first bucket.
        """
    ...
    @offset.setter
    def offset(self, value: pulumi.Input[builtins.float]):
...
class MetricMetricDescriptorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] metric_kind: Whether the metric records instantaneous values, changes to a value, etc.
               Some combinations of metricKind and valueType might not be supported.
               For counter metrics, set this to DELTA.
               Possible values are: `DELTA`, `GAUGE`, `CUMULATIVE`.
        :param pulumi.Input[builtins.str] value_type: Whether the measurement is an integer, a floating-point number, etc.
               Some combinations of metricKind and valueType might not be supported.
               For counter metrics, set this to INT64.
               Possible values are: `BOOL`, `INT64`, `DOUBLE`, `STRING`, `DISTRIBUTION`, `MONEY`.
        :param pulumi.Input[builtins.str] display_name: A concise name for the metric, which can be displayed in user interfaces. Use sentence case
               without an ending period, for example "Request count". This field is optional but it is
               recommended to be set for any metrics associated with user-visible concepts, such as Quota.
        :param pulumi.Input[Sequence[pulumi.Input['MetricMetricDescriptorLabelArgs']]] labels: The set of labels that can be used to describe a specific instance of this metric type. For
               ...
               or just for responses that failed.
               Structure is documented below.
        :param pulumi.Input[builtins.str] unit: The unit in which the metric value is reported. It is only applicable if the valueType is
               `INT64`, `DOUBLE`, or `DISTRIBUTION`. The supported units are a subset of
               [The Unified Code for Units of Measure](http://unitsofmeasure.org/ucum.html) standard
        """
    ...
    @metric_kind.setter
    def metric_kind(self, value: pulumi.Input[builtins.str]):
...
class MetricMetricDescriptorLabelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A human-readable description for the label.
        :param pulumi.Input[builtins.str] value_type: The type of data that can be assigned to the label.
               Default value is `STRING`.
               Possible values are: `BOOL`, `INT64`, `STRING`.
        """
...
class ProjectBucketConfigCmekSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kms_key_version_name: The CryptoKeyVersion resource name for the configured Cloud KMS key.
               ...
               "projects/my-project/locations/us-central1/keyRings/my-ring/cryptoKeys/my-key/cryptoKeyVersions/1"
               This is a read-only field used to convey the specific configured CryptoKeyVersion of kms_key that has been configured. It will be populated in cases where the CMEK settings are bound to a single key version.
        :param pulumi.Input[builtins.str] name: The resource name of the CMEK settings.
        :param pulumi.Input[builtins.str] service_account_id: The service account associated with a project for which CMEK will apply.
               Before enabling CMEK for a logging bucket, you must first assign the cloudkms.cryptoKeyEncrypterDecrypter role to the service account associated with the project for which CMEK will apply. Use [v2.getCmekSettings](https://cloud.google.com/logging/docs/reference/v2/rest/v2/TopLevel/getCmekSettings#google.logging.v2.ConfigServiceV2.GetCmekSettings) to obtain the service account ID.
               See [Enabling CMEK for Logging Buckets](https://cloud.google.com/logging/docs/routing/managed-encryption-storage) for more information.
        """
