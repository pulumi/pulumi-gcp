...
class FolderBucketConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] folder: The parent resource that contains the logging bucket.
...
class FolderBucketConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            retention_days: Optional[pulumi.Input[builtins.int]] = None) -> 'FolderBucketConfig':
        """
