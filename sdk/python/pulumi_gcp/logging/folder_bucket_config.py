...
class FolderBucketConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bucket_id: pulumi.Input[Optional[_builtins.str]] = None,
                 cmek_settings: pulumi.Input[Optional[Union['FolderBucketConfigCmekSettingsArgs', 'FolderBucketConfigCmekSettingsArgsDict', 'outputs.FolderBucketConfigCmekSettings']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 folder: pulumi.Input[Optional[_builtins.str]] = None,
                 index_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FolderBucketConfigIndexConfigArgs', 'FolderBucketConfigIndexConfigArgsDict', 'outputs.FolderBucketConfigIndexConfig']]]]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 retention_days: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        """
        ...
        * `folders/{{folder}}/locations/{{location}}/buckets/{{bucket_id}}`
        ...
        :param pulumi.Input[_builtins.str] bucket_id: The name of the logging bucket. Logging automatically creates two log buckets: `_Required` and `_Default`.
        :param pulumi.Input[Union['FolderBucketConfigCmekSettingsArgs', 'FolderBucketConfigCmekSettingsArgsDict', 'outputs.FolderBucketConfigCmekSettings']] cmek_settings: The CMEK settings of the log bucket. If present, new log entries written to this log bucket are encrypted using the CMEK key provided in this configuration. If a log bucket has CMEK settings, the CMEK settings cannot be disabled later by updating the log bucket. Changing the KMS key is allowed.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to "DELETE".
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
               When set to "ABANDON", the command will remove the resource from Terraform
        ...
        :param pulumi.Input[_builtins.str] description: Describes this bucket.
        :param pulumi.Input[_builtins.str] folder: The parent resource that contains the logging bucket.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FolderBucketConfigIndexConfigArgs', 'FolderBucketConfigIndexConfigArgsDict', 'outputs.FolderBucketConfigIndexConfig']]]] index_configs: A list of indexed fields and related configuration data. Structure is documented below.
        :param pulumi.Input[_builtins.str] location: The location of the bucket.
        :param pulumi.Input[_builtins.int] retention_days: Logs will be retained by default for this amount of time, after which they will automatically be deleted. The minimum retention period is 1 day. If this value is set to zero at bucket creation time, the default time of 30 days will be used. Bucket retention can not be increased on buckets outside of projects.
        """
        ...
