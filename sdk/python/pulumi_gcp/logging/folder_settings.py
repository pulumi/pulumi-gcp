...
class FolderSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_location: The storage location that Cloud Logging will use to create new resources when a location is needed but not explicitly provided.
        """
...
class _FolderSettingsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] logging_service_account_id: The service account for the given container. Sinks use this service account as their writerIdentity if no custom service account is provided.
...
class FolderSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            logging_service_account_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            storage_location: Optional[pulumi.Input[_builtins.str]] = None) -> 'FolderSettings':
        """
