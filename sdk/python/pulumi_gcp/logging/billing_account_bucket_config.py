...
@pulumi.type_token("gcp:logging/billingAccountBucketConfig:BillingAccountBucketConfig")
class BillingAccountBucketConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 billing_account: pulumi.Input[Optional[_builtins.str]] = None,
                 bucket_id: pulumi.Input[Optional[_builtins.str]] = None,
                 cmek_settings: pulumi.Input[Optional[Union['BillingAccountBucketConfigCmekSettingsArgs', 'BillingAccountBucketConfigCmekSettingsArgsDict', 'outputs.BillingAccountBucketConfigCmekSettings']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 index_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BillingAccountBucketConfigIndexConfigArgs', 'BillingAccountBucketConfigIndexConfigArgsDict', 'outputs.BillingAccountBucketConfigIndexConfig']]]]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 retention_days: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        """
        ...
        * `billingAccounts/{{billingAccount}}/locations/{{location}}/buckets/{{bucket_id}}`
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to "DELETE".
               ...
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] description: Describes this bucket.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BillingAccountBucketConfigIndexConfigArgs', 'BillingAccountBucketConfigIndexConfigArgsDict', 'outputs.BillingAccountBucketConfigIndexConfig']]]] index_configs: A list of indexed fields and related configuration data. Structure is documented below.
        :param pulumi.Input[_builtins.str] location: The location of the bucket.
        :param pulumi.Input[_builtins.int] retention_days: Logs will be retained by default for this amount of time, after which they will automatically be deleted. The minimum retention period is 1 day. If this value is set to zero at bucket creation time, the default time of 30 days will be used. Bucket retention can not be increased on buckets outside of projects.
        """
        ...
