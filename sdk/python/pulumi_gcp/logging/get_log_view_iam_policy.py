...
def get_log_view_iam_policy(bucket: Optional[_builtins.str] = None,
    ...
    :param _builtins.str bucket: The bucket of the resource Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location of the resource. The supported locations are: global, us-central1, us-east1, us-west1, asia-east1, europe-west1. Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    :param _builtins.str parent: The parent of the resource. Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
