...
class ProjectExclusionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project: The project to create the exclusion in. If omitted, the project associated with the provider is
               used.
        """
...
class ProjectExclusion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * How-to Guides
        ...
        > You can specify exclusions for log sinks created by terraform by using the exclusions field of `logging.ProjectSink`
    ...
    def get(resource_name: str,
            ...
            filter: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None) -> 'ProjectExclusion':
        """
