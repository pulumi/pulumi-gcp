...
__all__ = [
    'project_from_id',
    'project_from_id_output',
]

def project_from_id(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke_single('gcp:index/projectFromId:projectFromId', __args__, opts=opts).value

    return __ret__
def project_from_id_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output_single('gcp:index/projectFromId:projectFromId', __args__, opts=opts)
    return __ret__
