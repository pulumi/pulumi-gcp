...
class WorkflowArgs:
    def __init__(__self__, *,
                 call_log_level: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 execution_history_level: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 source_contents: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 user_env_vars: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Workflow resource.
        :param pulumi.Input[builtins.str] call_log_level: Describes the level of platform logging to apply to calls and call responses during
        ...
        :param pulumi.Input[builtins.str] crypto_key_name: The KMS key used to encrypt workflow and execution data.
               Format: projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}
        :param pulumi.Input[builtins.str] description: Description of the workflow provided by the user. Must be at most 1000 unicode characters long.
        :param pulumi.Input[builtins.str] execution_history_level: Describes the level of execution history to be stored for this workflow. This configuration
        ...
        :param pulumi.Input[builtins.str] region: The region of the workflow.
        :param pulumi.Input[builtins.str] service_account: Name of the service account associated with the latest workflow version. This service
        ...
        :param pulumi.Input[builtins.str] source_contents: Workflow code to be executed. The size limit is 128KB.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of resource manager tags. Resource manager tag keys and values have the same definition
               as resource manager tags. Keys must be in the format tagKeys/{tag_key_id}, and values are in
               the format tagValues/456. The field is ignored (both PUT & PATCH) when empty.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] user_env_vars: User-defined environment variables associated with this workflow revision. This map has a maximum length of 20. Each string can take up to 4KiB. Keys cannot be empty strings and cannot start with "GOOGLE" or "WORKFLOWS".
        """
    ...
    def call_log_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def call_log_level(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def execution_history_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def execution_history_level(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_contents(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_contents(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_env_vars(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_env_vars(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _WorkflowState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] call_log_level: Describes the level of platform logging to apply to calls and call responses during
               ...
               the execution level takes precedence.
               Possible values are: `CALL_LOG_LEVEL_UNSPECIFIED`, `LOG_ALL_CALLS`, `LOG_ERRORS_ONLY`, `LOG_NONE`.
        :param pulumi.Input[builtins.str] create_time: The timestamp of when the workflow was created in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        :param pulumi.Input[builtins.str] crypto_key_name: The KMS key used to encrypt workflow and execution data.
               Format: projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}
        :param pulumi.Input[builtins.str] description: Description of the workflow provided by the user. Must be at most 1000 unicode characters long.
        ...
        :param pulumi.Input[builtins.str] region: The region of the workflow.
        :param pulumi.Input[builtins.str] revision_id: The revision of the workflow. A new one is generated if the service account or source contents is changed.
        :param pulumi.Input[builtins.str] service_account: Name of the service account associated with the latest workflow version. This service
               account represents the identity of the workflow and determines what permissions the workflow has.
               Format: projects/{project}/serviceAccounts/{account} or {account}.
               Using - as a wildcard for the {project} or not providing one at all will infer the project from the account.
               ...
               Modifying this field for an existing workflow results in a new workflow revision.
        :param pulumi.Input[builtins.str] source_contents: Workflow code to be executed. The size limit is 128KB.
        :param pulumi.Input[builtins.str] state: State of the workflow deployment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of resource manager tags. Resource manager tag keys and values have the same definition
               as resource manager tags. Keys must be in the format tagKeys/{tag_key_id}, and values are in
               the format tagValues/456. The field is ignored (both PUT & PATCH) when empty.
        :param pulumi.Input[builtins.str] update_time: The timestamp of when the workflow was last updated in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] user_env_vars: User-defined environment variables associated with this workflow revision. This map has a maximum length of 20. Each string can take up to 4KiB. Keys cannot be empty strings and cannot start with "GOOGLE" or "WORKFLOWS".
        """
        if call_log_level is not None:
            pulumi.set(__self__, "call_log_level", call_log_level)
...
class Workflow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            user_env_vars: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Workflow':
        """
    ...
    @property
    @pulumi.getter(name="callLogLevel")
    def call_log_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Describes the level of platform logging to apply to calls and call responses during
        executions of this workflow. If both the workflow and the execution specify a logging level,
        the execution level takes precedence.
    ...
    @property
    @pulumi.getter(name="executionHistoryLevel")
    def execution_history_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Describes the level of execution history to be stored for this workflow. This configuration
        determines how much information about workflow executions is preserved. If not specified,
        defaults to EXECUTION_HISTORY_LEVEL_UNSPECIFIED.
    ...
    @property
    @pulumi.getter(name="sourceContents")
    def source_contents(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Workflow code to be executed. The size limit is 128KB.
        """
        return pulumi.get(self, "source_contents")
    ...
    @property
    @pulumi.getter(name="userEnvVars")
    def user_env_vars(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        User-defined environment variables associated with this workflow revision. This map has a maximum length of 20. Each string can take up to 4KiB. Keys cannot be empty strings and cannot start with "GOOGLE" or "WORKFLOWS".
        """
        return pulumi.get(self, "user_env_vars")
