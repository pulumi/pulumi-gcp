...
class GetAccountIdTokenResult:
    ...
    def include_email(self) -> Optional[builtins.bool]:
    ...
    def target_service_account(self) -> Optional[builtins.str]:
...
def get_account_id_token(delegates: Optional[Sequence[builtins.str]] = None,
                         include_email: Optional[builtins.bool] = None,
                         target_audience: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] delegates: Delegate chain of approvals needed to perform full impersonation. Specify the fully qualified service account name.   Used only when using impersonation mode.
    :param builtins.bool include_email: Include the verified email in the claim. Used only when using impersonation mode.
    :param builtins.str target_audience: The audience claim for the `id_token`.
    :param builtins.str target_service_account: The email of the service account being impersonated.  Used only when using impersonation mode.
    """
    __args__ = dict()
...
def get_account_id_token_output(delegates: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                include_email: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                target_audience: Optional[pulumi.Input[builtins.str]] = None,
                                target_service_account: Optional[pulumi.Input[Optional[builtins.str]]] = None,
