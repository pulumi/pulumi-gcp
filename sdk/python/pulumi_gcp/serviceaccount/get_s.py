...
def get_s(prefix: Optional[_builtins.str] = None,
    ...
    :param _builtins.str prefix: A prefix for filtering. It's applied with the `account_id`.
    :param _builtins.str project: The ID of the project. If it is not provided, the provider project is used.
    :param _builtins.str regex: A regular expression for filtering. It's applied with the `email`. Further information about the syntax can be found [here](https://github.com/google/re2/wiki/Syntax).
    """
    __args__ = dict()
