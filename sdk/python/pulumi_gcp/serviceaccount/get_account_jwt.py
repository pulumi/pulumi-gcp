...
def get_account_jwt(delegates: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] delegates: Delegate chain of approvals needed to perform full impersonation. Specify the fully qualified service account name.
    :param builtins.int expires_in: Number of seconds until the JWT expires. If set and non-zero an `exp` claim will be added to the payload derived from the current timestamp plus expires_in seconds.
    :param builtins.str payload: The JSON-encoded JWT claims set to include in the self-signed JWT.
    :param builtins.str target_service_account: The email of the service account that will sign the JWT.
    """
    __args__ = dict()
...
def get_account_jwt_output(delegates: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                           expires_in: Optional[pulumi.Input[Optional[builtins.int]]] = None,
