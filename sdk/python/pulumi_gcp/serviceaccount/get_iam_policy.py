...
def get_iam_policy(service_account_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_account_id: The fully-qualified name of the service account to apply policy to.
    """
    __args__ = dict()
...
def get_iam_policy_output(service_account_id: Optional[pulumi.Input[_builtins.str]] = None,
