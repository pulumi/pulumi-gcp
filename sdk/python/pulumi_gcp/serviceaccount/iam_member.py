...
class IAMMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['IAMMemberConditionArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] service_account_id: The fully-qualified name of the service account to apply policy to.
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['IAMMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['IAMMemberConditionArgs']]):
...
class _IAMMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['IAMMemberConditionArgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] etag: (Computed) The etag of the service account IAM policy.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
               * **allAuthenticatedUsers**: A special identifier that represents anyone who is authenticated with a Google account or a service account.
...
class IAMMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['IAMMemberConditionArgs', 'IAMMemberConditionArgsDict', 'outputs.IAMMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 service_account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        * `serviceaccount.IAMMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the service account are preserved.
        ...
        :param pulumi.Input[Union['IAMMemberConditionArgs', 'IAMMemberConditionArgsDict', 'outputs.IAMMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="gcp:serviceAccount/iAMMember:IAMMember")])
    ...
    def get(resource_name: str,
            ...
            member: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            service_account_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'IAMMember':
        """
