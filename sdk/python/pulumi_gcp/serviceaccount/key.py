...
class KeyArgs:
    def __init__(__self__, *,
                 ...
                 public_key_data: Optional[pulumi.Input[builtins.str]] = None,
                 public_key_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Key resource.
        :param pulumi.Input[builtins.str] service_account_id: The Service account id of the Key. This can be a string in the format
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] keepers: Arbitrary map of values that, when changed, will trigger a new key to be generated.
        :param pulumi.Input[builtins.str] key_algorithm: The algorithm used to generate the key. KEY_ALG_RSA_2048 is the default algorithm.
               Valid values are listed at
               [ServiceAccountPrivateKeyType](https://cloud.google.com/iam/reference/rest/v1/projects.serviceAccounts.keys#ServiceAccountKeyAlgorithm)
               (only used on create)
        :param pulumi.Input[builtins.str] private_key_type: The output format of the private key. TYPE_GOOGLE_CREDENTIALS_FILE is the default output format.
        :param pulumi.Input[builtins.str] public_key_data: Public key data to create a service account key for given service account. The expected format for this field is a base64 encoded X509_PEM and it conflicts with `public_key_type` and `private_key_type`.
        :param pulumi.Input[builtins.str] public_key_type: The output format of the public key requested. TYPE_X509_PEM_FILE is the default output format.
        """
    ...
    def public_key_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "public_key_data", value)

    @property
    @pulumi.getter(name="publicKeyType")
    def public_key_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KeyState:
    def __init__(__self__, *,
                 ...
                 valid_after: Optional[pulumi.Input[builtins.str]] = None,
                 valid_before: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] key_algorithm: The algorithm used to generate the key. KEY_ALG_RSA_2048 is the default algorithm.
               ...
               [ServiceAccountPrivateKeyType](https://cloud.google.com/iam/reference/rest/v1/projects.serviceAccounts.keys#ServiceAccountKeyAlgorithm)
               (only used on create)
        :param pulumi.Input[builtins.str] name: The name used for this key pair
        :param pulumi.Input[builtins.str] private_key: The private key in JSON format, base64 encoded. This is what you normally get as a file when creating
               service account keys through the CLI or web console. This is only populated when creating a new key.
        :param pulumi.Input[builtins.str] private_key_type: The output format of the private key. TYPE_GOOGLE_CREDENTIALS_FILE is the default output format.
        :param pulumi.Input[builtins.str] public_key: The public key, base64 encoded
        :param pulumi.Input[builtins.str] public_key_data: Public key data to create a service account key for given service account. The expected format for this field is a base64 encoded X509_PEM and it conflicts with `public_key_type` and `private_key_type`.
        :param pulumi.Input[builtins.str] public_key_type: The output format of the public key requested. TYPE_X509_PEM_FILE is the default output format.
        :param pulumi.Input[builtins.str] service_account_id: The Service account id of the Key. This can be a string in the format
               `{ACCOUNT}` or `projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT}`. If the `{ACCOUNT}`-only syntax is used, either
               ...
               syntax is used, the `{ACCOUNT}` specified can be the full email address of the service account or the service account's
               unique id. Substituting `-` as a wildcard for the `{PROJECT_ID}` will infer the project from the account.
        :param pulumi.Input[builtins.str] valid_after: The key can be used after this timestamp. A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] valid_before: The key can be used before this timestamp.
    ...
    def valid_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @valid_after.setter
    def valid_after(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "valid_after", value)

    @property
    @pulumi.getter(name="validBefore")
    def valid_before(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @valid_before.setter
    def valid_before(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Key(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_account_id: Optional[pulumi.Input[builtins.str]] = None,
            valid_after: Optional[pulumi.Input[builtins.str]] = None,
            valid_before: Optional[pulumi.Input[builtins.str]] = None) -> 'Key':
        """
    ...
    @property
    @pulumi.getter(name="privateKeyType")
    def private_key_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The output format of the private key. TYPE_GOOGLE_CREDENTIALS_FILE is the default output format.
        """
        return pulumi.get(self, "private_key_type")
    ...
    @property
    @pulumi.getter(name="publicKeyData")
    def public_key_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Public key data to create a service account key for given service account. The expected format for this field is a base64 encoded X509_PEM and it conflicts with `public_key_type` and `private_key_type`.
        """
        return pulumi.get(self, "public_key_data")
    ...
    @property
    @pulumi.getter(name="publicKeyType")
    def public_key_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The output format of the public key requested. TYPE_X509_PEM_FILE is the default output format.
        """
        return pulumi.get(self, "public_key_type")
    ...
    @property
    @pulumi.getter(name="validAfter")
    def valid_after(self) -> pulumi.Output[builtins.str]:
        """
        The key can be used after this timestamp. A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
        """
        return pulumi.get(self, "valid_after")
    ...
    @property
    @pulumi.getter(name="validBefore")
    def valid_before(self) -> pulumi.Output[builtins.str]:
        """
        The key can be used before this timestamp.
        A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
        """
