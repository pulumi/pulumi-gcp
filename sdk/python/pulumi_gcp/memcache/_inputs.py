...
class InstanceMaintenancePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] create_time: (Output)
               ...
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits
        :param pulumi.Input[_builtins.str] description: Optional. Description of what this policy is for.
               Create/Update methods return INVALID_ARGUMENT if the
               length is greater than 512.
...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] day: Required. The day of week that maintenance updates occur.
               ...
               - SUNDAY: Sunday
               Possible values are: `DAY_OF_WEEK_UNSPECIFIED`, `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        :param pulumi.Input[_builtins.str] duration: Required. The length of the maintenance window, ranging from 3 hours to 8 hours.
               A duration in seconds with up to nine fractional digits,
               terminated by 's'. Example: "3.5s".
...
class InstanceMaintenanceScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] end_time: (Output)
               ...
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits.
        :param pulumi.Input[_builtins.str] schedule_deadline_time: (Output)
               Output only. The deadline that the maintenance schedule start time
               can not go beyond, including reschedule.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits.
...
class InstanceMemcacheNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] host: (Output)
               Hostname or IP address of the Memcached node used by the clients to connect to the Memcached server on this node.
        :param pulumi.Input[_builtins.str] node_id: (Output)
               Identifier of the Memcached node. The node id does not include project or location like the Memcached instance name.
...
class InstanceMemcacheParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] id: (Output)
               This is a unique ID associated with this set of parameters.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] params: User-defined set of parameters to use in the memcache process.
        """
        if id is not None:
...
class InstanceNodeConfigArgs:
    def __init__(__self__, *,
                 ...
                 memory_size_mb: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] cpu_count: Number of CPUs per node.
        :param pulumi.Input[_builtins.int] memory_size_mb: Memory size in Mebibytes for each memcache node.
        """
