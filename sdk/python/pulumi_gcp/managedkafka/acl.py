...
class _AclState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] acl_id: The ID to use for the acl, which will become the final component of the acl's name. The structure of `aclId` defines the Resource Pattern (resource_type, resource_name, pattern_type) of the acl. `aclId` is structured like one of the following:
               ...
               For acls on all resources of a given type (i.e. the wildcard literal '*''): `allTopics` (represents `topic/*`) `allConsumerGroups` (represents `consumerGroup/*`) `allTransactionalIds` (represents `transactionalId/*`).
        :param pulumi.Input[_builtins.str] cluster: The cluster name.
        :param pulumi.Input[_builtins.str] etag: `etag` is used for concurrency control. An `etag` is returned in the
        ...
        :param pulumi.Input[_builtins.str] location: ID of the location of the Kafka resource. See https://cloud.google.com/managed-kafka/docs/locations for a list of supported locations.
        :param pulumi.Input[_builtins.str] name: The name of the acl. The `ACL_ID` segment is used when connecting directly to the cluster. Must be in the format `projects/PROJECT_ID/locations/LOCATION/clusters/CLUSTER_ID/acls/ACL_ID`.
        :param pulumi.Input[_builtins.str] pattern_type: The acl pattern type derived from the name. One of: LITERAL, PREFIXED.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] resource_name: The acl resource name derived from the name. For cluster resource_type, this is always "kafka-cluster". Can be the wildcard literal "*".
        :param pulumi.Input[_builtins.str] resource_type: The acl resource type derived from the name. One of: CLUSTER, TOPIC, GROUP, TRANSACTIONAL_ID.
        """
...
class Acl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] resource_name_: The acl resource name derived from the name. For cluster resource_type, this is always "kafka-cluster". Can be the wildcard literal "*".
        :param pulumi.Input[_builtins.str] resource_type: The acl resource type derived from the name. One of: CLUSTER, TOPIC, GROUP, TRANSACTIONAL_ID.
        """
