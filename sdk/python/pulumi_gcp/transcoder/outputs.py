...
class JobConfigAdBreak(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str start_time_offset: Start time in seconds for the ad break, relative to the output file timeline
        """
...
class JobConfigEditList(dict):
    ...
    def __init__(__self__, *,
                 inputs: Optional[Sequence[_builtins.str]] = None,
                 key: Optional[_builtins.str] = None,
                 start_time_offset: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] inputs: List of values identifying files that should be used in this atom.
        :param _builtins.str key: A unique key for this atom.
        :param _builtins.str start_time_offset: Start time in seconds for the atom, relative to the input file timeline. The default is `0s`.
        """
        if inputs is not None:
            pulumi.set(__self__, "inputs", inputs)
        if key is not None:
...
class JobConfigElementaryStreamAudioStream(dict):
    ...
    def __init__(__self__, *,
                 ...
                 channel_count: Optional[_builtins.int] = None,
                 channel_layouts: Optional[Sequence[_builtins.str]] = None,
                 codec: Optional[_builtins.str] = None,
                 sample_rate_hertz: Optional[_builtins.int] = None):
        """
        :param _builtins.int bitrate_bps: Audio bitrate in bits per second.
        :param _builtins.int channel_count: Number of audio channels. The default is `2`.
        :param Sequence[_builtins.str] channel_layouts: A list of channel names specifying layout of the audio channels. The default is ["fl", "fr"].
        :param _builtins.str codec: The codec for this audio stream. The default is `aac`.
        :param _builtins.int sample_rate_hertz: The audio sample rate in Hertz. The default is `48000`.
        """
...
class JobConfigElementaryStreamVideoStreamH264(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crf_level: Optional[_builtins.int] = None,
                 entropy_coder: Optional[_builtins.str] = None,
                 gop_duration: Optional[_builtins.str] = None,
                 height_pixels: Optional[_builtins.int] = None,
                 hlg: Optional['outputs.JobConfigElementaryStreamVideoStreamH264Hlg'] = None,
                 pixel_format: Optional[_builtins.str] = None,
                 ...
                 vbv_fullness_bits: Optional[_builtins.int] = None,
                 vbv_size_bits: Optional[_builtins.int] = None,
                 width_pixels: Optional[_builtins.int] = None):
        """
        :param _builtins.int bitrate_bps: The video bitrate in bits per second.
        :param _builtins.int frame_rate: The target video frame rate in frames per second (FPS).
        :param _builtins.int crf_level: Target CRF level. The default is '21'.
        :param _builtins.str entropy_coder: The entropy coder to use. The default is 'cabac'.
        :param _builtins.str gop_duration: Select the GOP size based on the specified duration. The default is '3s'.
        :param _builtins.int height_pixels: The height of the video in pixels.
        :param 'JobConfigElementaryStreamVideoStreamH264HlgArgs' hlg: HLG color format setting for H264.
        :param _builtins.str pixel_format: Pixel format to use. The default is 'yuv420p'.
        :param _builtins.str preset: Enforces the specified codec preset. The default is 'veryfast'.
        :param _builtins.str profile: Enforces the specified codec profile.
        :param _builtins.str rate_control_mode: Specify the mode. The default is 'vbr'.
        :param 'JobConfigElementaryStreamVideoStreamH264SdrArgs' sdr: SDR color format setting for H264.
        :param _builtins.int vbv_fullness_bits: Initial fullness of the Video Buffering Verifier (VBV) buffer in bits.
        :param _builtins.int vbv_size_bits: Size of the Video Buffering Verifier (VBV) buffer in bits.
        :param _builtins.int width_pixels: The width of the video in pixels.
        """
        pulumi.set(__self__, "bitrate_bps", bitrate_bps)
...
class JobConfigEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: Identifier for this set of encryption options.
...
class JobConfigEncryptionMpegCenc(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str scheme: Specify the encryption scheme.
        """
...
class JobConfigEncryptionSecretManagerKeySource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str secret_version: The name of the Secret Version containing the encryption key in the following format: projects/{project}/secrets/{secret_id}/versions/{version_number}.
        """
...
class JobConfigInput(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: A unique key for this input. Must be specified when using advanced mapping and edit lists.
        :param _builtins.str uri: URI of the media. Input files must be at least 5 seconds in duration and stored in Cloud Storage (for example, gs://bucket/inputs/file.mp4).
...
class JobConfigManifest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mux_streams: Optional[Sequence[_builtins.str]] = None,
                 type: Optional[_builtins.str] = None):
        """
        :param _builtins.str file_name: The name of the generated file. The default is `manifest`.
        :param Sequence[_builtins.str] mux_streams: List of user supplied MuxStream.key values that should appear in this manifest.
        :param _builtins.str type: Type of the manifest.
...
class JobConfigMuxStream(dict):
    ...
    def __init__(__self__, *,
                 ...
                 elementary_streams: Optional[Sequence[_builtins.str]] = None,
                 encryption_id: Optional[_builtins.str] = None,
                 file_name: Optional[_builtins.str] = None,
                 key: Optional[_builtins.str] = None,
                 segment_settings: Optional['outputs.JobConfigMuxStreamSegmentSettings'] = None):
        """
        :param _builtins.str container: The container format. The default is `mp4`.
        :param Sequence[_builtins.str] elementary_streams: List of ElementaryStream.key values multiplexed in this stream.
        :param _builtins.str encryption_id: Identifier of the encryption configuration to use.
        :param _builtins.str file_name: The name of the generated file.
        :param _builtins.str key: A unique key for this multiplexed stream.
...
class JobConfigMuxStreamSegmentSettings(dict):
    ...
    def __init__(__self__, *,
                 segment_duration: Optional[_builtins.str] = None):
        """
        :param _builtins.str segment_duration: Duration of the segments in seconds. The default is `6.0s`.
        """
...
class JobConfigOutput(dict):
    def __init__(__self__, *,
                 uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str uri: URI for the output file(s). For example, gs://my-bucket/outputs/.
        """
        if uri is not None:
            pulumi.set(__self__, "uri", uri)
...
class JobConfigOverlayAnimationAnimationFade(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str fade_type: Required. Type of fade animation: `FADE_IN` or `FADE_OUT`.
...
class JobConfigOverlayAnimationAnimationFadeXy(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.float x: Normalized x coordinate.
        :param _builtins.float y: Normalized y coordinate.
        """
        if x is not None:
...
class JobConfigOverlayImage(dict):
    def __init__(__self__, *,
                 uri: _builtins.str):
        """
        :param _builtins.str uri: URI of the image in Cloud Storage. For example, gs://bucket/inputs/image.png.
        """
        pulumi.set(__self__, "uri", uri)
...
class JobConfigPubsubDestination(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str topic: The name of the Pub/Sub topic to publish job completion notification to. For example: projects/{project}/topics/{topic}.
        """
