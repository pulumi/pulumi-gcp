...
class MigrationJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dump_type: The type of the data dump. Supported for MySQL to CloudSQL for MySQL
               migrations only.
    ...
    def migration_job_id(self, value: pulumi.Input[_builtins.str]):
