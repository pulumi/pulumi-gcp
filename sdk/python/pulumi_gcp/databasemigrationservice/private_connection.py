...
class PrivateConnectionArgs:
    ...
    def private_connection_id(self) -> pulumi.Input[builtins.str]:
        """
...
class _PrivateConnectionState:
    ...
    @property
    @pulumi.getter(name="privateConnectionId")
    def private_connection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The private connectivity identifier.
        """
        return pulumi.get(self, "private_connection_id")
    ...
    @private_connection_id.setter
    def private_connection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_connection_id", value)
...
class PrivateConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="privateConnectionId")
    def private_connection_id(self) -> pulumi.Output[builtins.str]:
        """
        The private connectivity identifier.
        """
        return pulumi.get(self, "private_connection_id")
