...
__all__ = [
    ...
    'MigrationJobObjectsConfigSourceObjectsConfig',
...
class ConnectionProfileAlloydb(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cluster_id: Required. The AlloyDB cluster ID that this connection profile is associated with.
...
class ConnectionProfileAlloydbSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ConnectionProfileAlloydbSettingsInitialUserArgs' initial_user: Required. Input only. Initial user to setup during cluster creation.
               Structure is documented below.
        :param _builtins.str vpc_network: Required. The resource link for the VPC network in which cluster resources are created and from which they are accessible via Private IP. The network must belong to the same project as the cluster.
               It is specified in the form: 'projects/{project_number}/global/networks/{network_id}'. This is required to create a cluster.
        :param Mapping[str, _builtins.str] labels: Labels for the AlloyDB cluster created by DMS.
...
class ConnectionProfileAlloydbSettingsPrimaryInstanceSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 database_flags: Optional[Mapping[str, _builtins.str]] = None,
                 labels: Optional[Mapping[str, _builtins.str]] = None,
                 private_ip: Optional[_builtins.str] = None):
        """
        :param _builtins.str id: The database username.
        :param 'ConnectionProfileAlloydbSettingsPrimaryInstanceSettingsMachineConfigArgs' machine_config: Configuration for the machines that host the underlying database engine.
               Structure is documented below.
        :param Mapping[str, _builtins.str] database_flags: Database flags to pass to AlloyDB when DMS is creating the AlloyDB cluster and instances. See the AlloyDB documentation for how these can be used.
        :param Mapping[str, _builtins.str] labels: Labels for the AlloyDB primary instance created by DMS.
        :param _builtins.str private_ip: (Output)
...
class ConnectionProfileCloudsql(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cloud_sql_id: (Output)
               Output only. The Cloud SQL instance ID that this connection profile is associated with.
        :param _builtins.str private_ip: (Output)
               Output only. The Cloud SQL database instance's private IP.
        :param _builtins.str public_ip: (Output)
...
class ConnectionProfileCloudsqlSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_storage_increase: Optional[_builtins.bool] = None,
                 cmek_key_name: Optional[_builtins.str] = None,
                 collation: Optional[_builtins.str] = None,
                 data_disk_size_gb: Optional[_builtins.str] = None,
                 ...
                 root_password_set: Optional[_builtins.bool] = None,
                 storage_auto_resize_limit: Optional[_builtins.str] = None,
                 tier: Optional[_builtins.str] = None,
                 user_labels: Optional[Mapping[str, _builtins.str]] = None,
                 zone: Optional[_builtins.str] = None):
        """
        :param _builtins.str source_id: The Database Migration Service source connection profile ID, in the format: projects/my_project_name/locations/us-central1/connectionProfiles/connection_profile_ID
        :param _builtins.str activation_policy: The activation policy specifies when the instance is activated; it is applicable only when the instance state is 'RUNNABLE'.
               Possible values are: `ALWAYS`, `NEVER`.
        :param _builtins.bool auto_storage_increase: If you enable this setting, Cloud SQL checks your available storage every 30 seconds. If the available storage falls below a threshold size, Cloud SQL automatically adds additional storage capacity.
               If the available storage repeatedly falls below the threshold size, Cloud SQL continues to add storage until it reaches the maximum of 30 TB.
        :param _builtins.str cmek_key_name: The KMS key name used for the csql instance.
        :param _builtins.str collation: The Cloud SQL default instance level collation.
        :param _builtins.str data_disk_size_gb: The storage capacity available to the database, in GB. The minimum (and default) size is 10GB.
        :param _builtins.str data_disk_type: The type of storage.
               Possible values are: `PD_SSD`, `PD_HDD`.
        :param Mapping[str, _builtins.str] database_flags: The database flags passed to the Cloud SQL instance at startup.
        :param _builtins.str database_version: The database engine type and version.
               Currently supported values located at https://cloud.google.com/database-migration/docs/reference/rest/v1/projects.locations.connectionProfiles#sqldatabaseversion
        :param _builtins.str edition: The edition of the given Cloud SQL instance.
        ...
        :param 'ConnectionProfileCloudsqlSettingsIpConfigArgs' ip_config: The settings for IP Management. This allows to enable or disable the instance IP and manage which external networks can connect to the instance. The IPv4 address cannot be disabled.
               Structure is documented below.
        :param _builtins.str root_password: Input only. Initial root password.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param _builtins.bool root_password_set: (Output)
               Output only. Indicates If this connection profile root password is stored.
        :param _builtins.str storage_auto_resize_limit: The maximum size to which storage capacity can be automatically increased. The default value is 0, which specifies that there is no limit.
        :param _builtins.str tier: The tier (or machine type) for this instance, for example: db-n1-standard-1 (MySQL instances) or db-custom-1-3840 (PostgreSQL instances).
               For more information, see https://cloud.google.com/sql/docs/mysql/instance-settings
        :param Mapping[str, _builtins.str] user_labels: The resource labels for a Cloud SQL instance to use to annotate any related underlying resources such as Compute Engine VMs.
        :param _builtins.str zone: The Google Cloud Platform zone where your Cloud SQL datdabse instance is located.
        """
...
class ConnectionProfileCloudsqlSettingsIpConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_ipv4: Optional[_builtins.bool] = None,
                 private_network: Optional[_builtins.str] = None,
                 require_ssl: Optional[_builtins.bool] = None):
        """
        :param Sequence['ConnectionProfileCloudsqlSettingsIpConfigAuthorizedNetworkArgs'] authorized_networks: The list of external networks that are allowed to connect to the instance using the IP.
               Structure is documented below.
        :param _builtins.bool enable_ipv4: Whether the instance should be assigned an IPv4 address or not.
        :param _builtins.str private_network: The resource link for the VPC network from which the Cloud SQL instance is accessible for private IP. For example, projects/myProject/global/networks/default.
               This setting can be updated, but it cannot be removed after it is set.
        :param _builtins.bool require_ssl: Whether SSL connections over IP should be enforced or not.
        """
...
class ConnectionProfileCloudsqlSettingsIpConfigAuthorizedNetwork(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str value: The allowlisted value for the access control list.
        :param _builtins.str expire_time: The time when this access control entry expires in RFC 3339 format.
        :param _builtins.str label: A label to identify this entry.
        :param _builtins.str ttl: Input only. The time-to-leave of this access control entry.
        """
...
class ConnectionProfileMysqlSsl(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ca_certificate: Input only. The x509 PEM-encoded certificate of the CA that signed the source database server's certificate.
               The replica will use this certificate to verify it's connecting to the right host.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param _builtins.str client_certificate: Input only. The x509 PEM-encoded certificate that will be used by the replica to authenticate against the source database server.
               If this field is used then the 'clientKey' field is mandatory
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param _builtins.str client_key: Input only. The unencrypted PKCS#1 or PKCS#8 PEM-encoded private key associated with the Client Certificate.
...
class ConnectionProfileOracle(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str database_service: Required. Database service for the Oracle connection.
        :param _builtins.str host: Required. The IP or hostname of the source Oracle database.
        :param _builtins.str password: Required. Input only. The password for the user that Database Migration Service will be using to connect to the database.
               This field is not returned on request, and the value is encrypted when stored in Database Migration Service.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param _builtins.int port: Required. The network port of the source Oracle database.
        :param _builtins.str username: Required. The username that Database Migration Service will use to connect to the database. The value is encrypted when stored in Database Migration Service.
...
class ConnectionProfileOracleForwardSshConnectivity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str hostname: Required. Hostname for the SSH tunnel.
        :param _builtins.int port: Port for the SSH tunnel, default value is 22.
        :param _builtins.str username: Required. Username for the SSH tunnel.
        :param _builtins.str password: Input only. SSH password. Only one of `password` and `private_key` can be configured.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param _builtins.str private_key: Input only. SSH private key. Only one of `password` and `private_key` can be configured.
               **Note**: This property is sensitive and will not be displayed in the plan.
        """
...
class MigrationJobDumpFlagsDumpFlag(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the flag
        :param _builtins.str value: The vale of the flag
        """
        if name is not None:
...
@pulumi.output_type
class MigrationJobObjectsConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "sourceObjectsConfig":
            suggest = "source_objects_config"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MigrationJobObjectsConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MigrationJobObjectsConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 source_objects_config: Optional['outputs.MigrationJobObjectsConfigSourceObjectsConfig'] = None):
        """
        :param 'MigrationJobObjectsConfigSourceObjectsConfigArgs' source_objects_config: Configuration for the source objects to be migrated.
               Structure is documented below.
        """
    ...
    def source_objects_config(self) -> Optional['outputs.MigrationJobObjectsConfigSourceObjectsConfig']:
        """
...
@pulumi.output_type
class MigrationJobObjectsConfigSourceObjectsConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "objectConfigs":
            suggest = "object_configs"
        elif key == "objectsSelectionType":
            suggest = "objects_selection_type"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MigrationJobObjectsConfigSourceObjectsConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MigrationJobObjectsConfigSourceObjectsConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 object_configs: Optional[Sequence['outputs.MigrationJobObjectsConfigSourceObjectsConfigObjectConfig']] = None,
                 objects_selection_type: Optional[_builtins.str] = None):
        """
        :param Sequence['MigrationJobObjectsConfigSourceObjectsConfigObjectConfigArgs'] object_configs: The list of objects to migrate. Should only be set when
               `objectsSelectionType` is `SPECIFIED_OBJECTS`.
               Structure is documented below.
        :param _builtins.str objects_selection_type: The objects selection type of the migration job. When set to
    ...
    def object_configs(self) -> Optional[Sequence['outputs.MigrationJobObjectsConfigSourceObjectsConfigObjectConfig']]:
        """
    ...
    def objects_selection_type(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class MigrationJobObjectsConfigSourceObjectsConfigObjectConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MigrationJobObjectsConfigSourceObjectsConfigObjectConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MigrationJobObjectsConfigSourceObjectsConfigObjectConfig.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 object_identifier: Optional['outputs.MigrationJobObjectsConfigSourceObjectsConfigObjectConfigObjectIdentifier'] = None):
        """
        :param 'MigrationJobObjectsConfigSourceObjectsConfigObjectConfigObjectIdentifierArgs' object_identifier: The identifier of the migration job object.
               Structure is documented below.
        """
    ...
    def object_identifier(self) -> Optional['outputs.MigrationJobObjectsConfigSourceObjectsConfigObjectConfigObjectIdentifier']:
        """
...
@pulumi.output_type
class MigrationJobObjectsConfigSourceObjectsConfigObjectConfigObjectIdentifier(dict):
    def __init__(__self__, *,
                 type: _builtins.str,
                 database: Optional[_builtins.str] = None,
        ...
        """
        :param _builtins.str type: The category of the migration job object: `DATABASE`,
               `SCHEMA`, or `TABLE`.
               Possible values are: `DATABASE`, `SCHEMA`, `TABLE`.
        :param _builtins.str database: The database name. Required only if the object uses
               a database name as part of its unique identifier.
        :param _builtins.str schema: The schema name. Required only if the object uses
               a schema name as part of its unique identifier.
        :param _builtins.str table: The table name. Required only if the object is a level
...
class MigrationJobPerformanceConfig(dict):
    ...
    def __init__(__self__, *,
                 dump_parallel_level: Optional[_builtins.str] = None):
        """
        :param _builtins.str dump_parallel_level: Initial dump parallelism level.
...
class MigrationJobReverseSshConnectivity(dict):
    ...
    def __init__(__self__, *,
                 vm: Optional[_builtins.str] = None,
                 vm_ip: Optional[_builtins.str] = None,
                 vm_port: Optional[_builtins.int] = None,
                 vpc: Optional[_builtins.str] = None):
        """
        :param _builtins.str vm: The name of the virtual machine (Compute Engine) used as the bastion server
               for the SSH tunnel.
        :param _builtins.str vm_ip: The IP of the virtual machine (Compute Engine) used as the bastion server
               for the SSH tunnel.
        :param _builtins.int vm_port: The forwarding port of the virtual machine (Compute Engine) used as the
               bastion server for the SSH tunnel.
        :param _builtins.str vpc: The name of the VPC to peer with the Cloud SQL private network.
        """
        if vm is not None:
...
class MigrationJobVpcPeeringConnectivity(dict):
    def __init__(__self__, *,
                 vpc: Optional[_builtins.str] = None):
        """
        :param _builtins.str vpc: The name of the VPC network to peer with the Cloud SQL private network.
        """
        if vpc is not None:
            pulumi.set(__self__, "vpc", vpc)
...
class PrivateConnectionVpcPeeringConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str vpc_name: Fully qualified name of the VPC that Database Migration Service will peer to.
