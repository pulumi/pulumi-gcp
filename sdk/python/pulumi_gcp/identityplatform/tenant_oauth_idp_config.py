...
class TenantOauthIdpConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] tenant: The name of the tenant where this OIDC IDP configuration resource exists
...
class TenantOauthIdpConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            tenant: Optional[pulumi.Input[builtins.str]] = None) -> 'TenantOauthIdpConfig':
        """
