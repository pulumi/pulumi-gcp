...
class TenantArgs:
    def __init__(__self__, *,
                 ...
                 allow_password_signup: Optional[pulumi.Input[builtins.bool]] = None,
                 client: Optional[pulumi.Input['TenantClientArgs']] = None,
                 disable_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_email_link_signin: Optional[pulumi.Input[builtins.bool]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Tenant resource.
        :param pulumi.Input[builtins.str] display_name: Human friendly display name of the tenant.
               
               
               - - -
        :param pulumi.Input[builtins.bool] allow_password_signup: Whether to allow email/password user authentication.
        ...
        :param pulumi.Input[builtins.bool] disable_auth: Whether authentication is disabled for the tenant. If true, the users under
               the disabled tenant are not allowed to sign-in. Admins of the disabled tenant
               are not able to manage its users.
        :param pulumi.Input[builtins.bool] enable_email_link_signin: Whether to enable email link user authentication.
    ...
    def allow_password_signup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_password_signup(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def disable_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @disable_auth.setter
    def disable_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_auth", value)

    @property
    @pulumi.getter(name="enableEmailLinkSignin")
    def enable_email_link_signin(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_email_link_signin(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _TenantState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Human friendly display name of the tenant.
               ...
               - - -
        :param pulumi.Input[builtins.bool] enable_email_link_signin: Whether to enable email link user authentication.
        :param pulumi.Input[builtins.str] name: The name of the tenant that is generated by the server
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        """
        if allow_password_signup is not None:
...
class Tenant(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enable_email_link_signin: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'Tenant':
        """
    ...
    @property
    @pulumi.getter(name="allowPasswordSignup")
    def allow_password_signup(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to allow email/password user authentication.
        """
        return pulumi.get(self, "allow_password_signup")
    ...
    @property
    @pulumi.getter(name="disableAuth")
    def disable_auth(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether authentication is disabled for the tenant. If true, the users under
        the disabled tenant are not allowed to sign-in. Admins of the disabled tenant
        are not able to manage its users.
    ...
    @property
    @pulumi.getter(name="enableEmailLinkSignin")
    def enable_email_link_signin(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable email link user authentication.
        """
        return pulumi.get(self, "enable_email_link_signin")
