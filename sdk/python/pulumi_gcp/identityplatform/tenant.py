...
class TenantArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_email_link_signin: Whether to enable email link user authentication.
...
class _TenantState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: Human friendly display name of the tenant.
        :param pulumi.Input[_builtins.bool] enable_email_link_signin: Whether to enable email link user authentication.
        :param pulumi.Input[_builtins.str] name: The name of the tenant that is generated by the server
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        """
        if allow_password_signup is not None:
