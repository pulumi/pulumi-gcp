...
class _DefaultSupportedIdpConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] idp_id: ID of the IDP. Possible values include:
               ...
               * `twitter.com`
               * `yahoo.com`
        :param pulumi.Input[builtins.str] name: The name of the DefaultSupportedIdpConfig resource
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        """
...
class DefaultSupportedIdpConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            idp_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'DefaultSupportedIdpConfig':
        """
