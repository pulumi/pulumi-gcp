...
class TenantDefaultSupportedIdpConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_secret: OAuth client secret
               ...
               - - -
        :param pulumi.Input[builtins.str] idp_id: ID of the IDP. Possible values include:
               * `apple.com`
               * `facebook.com`
               * `gc.apple.com`
               * `github.com`
               ...
               * `twitter.com`
               * `yahoo.com`
        :param pulumi.Input[builtins.str] tenant: The name of the tenant where this DefaultSupportedIdpConfig resource exists
        :param pulumi.Input[builtins.bool] enabled: If this IDP allows the user to sign in
...
class _TenantDefaultSupportedIdpConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] idp_id: ID of the IDP. Possible values include:
               ...
               * `twitter.com`
               * `yahoo.com`
        :param pulumi.Input[builtins.str] name: The name of the default supported IDP config resource
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] tenant: The name of the tenant where this DefaultSupportedIdpConfig resource exists
        """
...
class TenantDefaultSupportedIdpConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            tenant: Optional[pulumi.Input[builtins.str]] = None) -> 'TenantDefaultSupportedIdpConfig':
        """
