...
class KmsconfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the CMEK policy.
...
class _KmsconfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instructions: Access to the key needs to be granted. The instructions contain gcloud commands to run to grant access.
...
class Kmsconfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            service_account: Optional[pulumi.Input[_builtins.str]] = None) -> 'Kmsconfig':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cryptoKeyName")
    def crypto_key_name(self) -> pulumi.Output[_builtins.str]:
        """
        Resource name of the KMS key to use. Only regional keys are supported. Format: `projects/{{project}}/locations/{{location}}/keyRings/{{key_ring}}/cryptoKeys/{{key}}`.
        """
        return pulumi.get(self, "crypto_key_name")
