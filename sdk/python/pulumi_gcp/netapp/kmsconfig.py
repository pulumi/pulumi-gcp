...
class KmsconfigArgs:
    def __init__(__self__, *,
                 crypto_key_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] crypto_key_name: Resource name of the KMS key to use. Only regional keys are supported. Format: `projects/{{project}}/locations/{{location}}/keyRings/{{key_ring}}/cryptoKeys/{{key}}`.
        :param pulumi.Input[builtins.str] location: Name of the policy location. CMEK policies apply to the whole region.
        :param pulumi.Input[builtins.str] description: Description for the CMEK policy.
    ...
    def crypto_key_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def crypto_key_name(self, value: pulumi.Input[builtins.str]):
...
class _KmsconfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instructions: Access to the key needs to be granted. The instructions contain gcloud commands to run to grant access.
        ...
        :param pulumi.Input[builtins.str] service_account: The Service account which needs to have access to the  provided KMS key.
        """
...
class Kmsconfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            service_account: Optional[pulumi.Input[builtins.str]] = None) -> 'Kmsconfig':
        """
    ...
    @property
    @pulumi.getter(name="cryptoKeyName")
    def crypto_key_name(self) -> pulumi.Output[builtins.str]:
        """
        Resource name of the KMS key to use. Only regional keys are supported. Format: `projects/{{project}}/locations/{{location}}/keyRings/{{key_ring}}/cryptoKeys/{{key}}`.
        """
        return pulumi.get(self, "crypto_key_name")
    ...
    @property
    @pulumi.getter
    def instructions(self) -> pulumi.Output[builtins.str]:
        """
        Access to the key needs to be granted. The instructions contain gcloud commands to run to grant access.
        To make the policy work, a CMEK policy check is required, which verifies key access.
        """
