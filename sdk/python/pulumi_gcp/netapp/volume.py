...
class VolumeArgs:
    def __init__(__self__, *,
                 ...
                 multiple_endpoints: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 restore_parameters: Optional[pulumi.Input['VolumeRestoreParametersArgs']] = None,
                 restricted_actions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 security_style: Optional[pulumi.Input[builtins.str]] = None,
                 smb_settings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 snapshot_directory: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 unix_permissions: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Volume resource.
        :param pulumi.Input[builtins.str] capacity_gib: Capacity of the volume (in GiB).
        :param pulumi.Input[builtins.str] location: Name of the pool location. Usually a region name, expect for some STANDARD service level pools which require a zone name.
        ...
        :param pulumi.Input[builtins.str] share_name: Share name (SMB) or export path (NFS) of the volume. Needs to be unique per location.
        :param pulumi.Input[builtins.str] storage_pool: Name of the storage pool to create the volume in. Pool needs enough spare capacity to accommodate the volume.
        :param pulumi.Input['VolumeBackupConfigArgs'] backup_config: Backup configuration for the volume.
               Structure is documented below.
        :param pulumi.Input[builtins.str] deletion_policy: Policy to determine if the volume should be deleted forcefully.
        ...
        :param pulumi.Input[builtins.bool] large_capacity: Optional. Flag indicating if the volume will be a large capacity volume or a regular volume.
        ...
        :param pulumi.Input['VolumeRestoreParametersArgs'] restore_parameters: Used to create this volume from a snapshot (= cloning) or an backup.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] restricted_actions: List of actions that are restricted on this volume.
               Each value may be one of: `DELETE`.
        :param pulumi.Input[builtins.str] security_style: Security Style of the Volume. Use UNIX to use UNIX or NFSV4 ACLs for file permissions.
               Use NTFS to use NTFS ACLs for file permissions. Can only be set for volumes which use SMB together with NFS as protocol.
               Possible values are: `NTFS`, `UNIX`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] smb_settings: Settings for volumes with SMB access.
               Each value may be one of: `ENCRYPT_DATA`, `BROWSABLE`, `CHANGE_NOTIFY`, `NON_BROWSABLE`, `OPLOCKS`, `SHOW_SNAPSHOT`, `SHOW_PREVIOUS_VERSIONS`, `ACCESS_BASED_ENUMERATION`, `CONTINUOUSLY_AVAILABLE`.
        :param pulumi.Input[builtins.bool] snapshot_directory: If enabled, a NFS volume will contain a read-only .snapshot directory which provides access to each of the volume's snapshots. Will enable "Previous Versions" support for SMB.
        ...
        :param pulumi.Input['VolumeTieringPolicyArgs'] tiering_policy: Tiering policy for the volume.
               Structure is documented below.
        :param pulumi.Input[builtins.str] unix_permissions: Unix permission the mount point will be created with. Default is 0770. Applicable for UNIX security style volumes only.
        """
    ...
    def kerberos_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def kerberos_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def large_capacity(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def large_capacity(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "large_capacity", value)

    @property
    @pulumi.getter(name="multipleEndpoints")
    def multiple_endpoints(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def multiple_endpoints(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def restricted_actions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def restricted_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def smb_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @smb_settings.setter
    def smb_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "smb_settings", value)

    @property
    @pulumi.getter(name="snapshotDirectory")
    def snapshot_directory(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def snapshot_directory(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def unix_permissions(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unix_permissions(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VolumeState:
    def __init__(__self__, *,
                 ...
                 cold_tier_size_gib: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 psa_range: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 storage_pool: Optional[pulumi.Input[builtins.str]] = None,
                 tiering_policy: Optional[pulumi.Input['VolumeTieringPolicyArgs']] = None,
                 unix_permissions: Optional[pulumi.Input[builtins.str]] = None,
                 used_gib: Optional[pulumi.Input[builtins.str]] = None,
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Volume resources.
        :param pulumi.Input[builtins.str] active_directory: Reports the resource name of the Active Directory policy being used. Inherited from storage pool.
        :param pulumi.Input['VolumeBackupConfigArgs'] backup_config: Backup configuration for the volume.
               Structure is documented below.
        :param pulumi.Input[builtins.str] capacity_gib: Capacity of the volume (in GiB).
        :param pulumi.Input[builtins.str] cold_tier_size_gib: Output only. Size of the volume cold tier data in GiB.
        :param pulumi.Input[builtins.str] create_time: Create time of the volume. A timestamp in RFC3339 UTC "Zulu" format. Examples: "2023-06-22T09:13:01.617Z".
        :param pulumi.Input[builtins.str] deletion_policy: Policy to determine if the volume should be deleted forcefully.
               Volumes may have nested snapshot resources. Deleting such a volume will fail.
               Setting this parameter to FORCE will delete volumes including nested snapshots.
               Possible values: DEFAULT, FORCE.
        ...
        :param pulumi.Input[builtins.str] encryption_type: Reports the data-at-rest encryption type of the volume. Inherited from storage pool.
        :param pulumi.Input['VolumeExportPolicyArgs'] export_policy: Export policy of the volume for NFSV3 and/or NFSV4.1 access.
               Structure is documented below.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels as key value pairs. Example: `{ "owner": "Bob", "department": "finance", "purpose": "testing" }`.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.bool] large_capacity: Optional. Flag indicating if the volume will be a large capacity volume or a regular volume.
        :param pulumi.Input[builtins.bool] ldap_enabled: Flag indicating if the volume is NFS LDAP enabled or not. Inherited from storage pool.
        :param pulumi.Input[builtins.str] location: Name of the pool location. Usually a region name, expect for some STANDARD service level pools which require a zone name.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocols: The protocol of the volume. Allowed combinations are `['NFSV3']`, `['NFSV4']`, `['SMB']`, `['NFSV3', 'NFSV4']`, `['SMB', 'NFSV3']` and `['SMB', 'NFSV4']`.
               Each value may be one of: `NFSV3`, `NFSV4`, `SMB`.
        :param pulumi.Input[builtins.str] psa_range: Name of the Private Service Access allocated range. Inherited from storage pool.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
               and default labels configured on the provider.
        :param pulumi.Input[builtins.str] replica_zone: Specifies the replica zone for regional volume.
        :param pulumi.Input['VolumeRestoreParametersArgs'] restore_parameters: Used to create this volume from a snapshot (= cloning) or an backup.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] restricted_actions: List of actions that are restricted on this volume.
               Each value may be one of: `DELETE`.
        :param pulumi.Input[builtins.str] security_style: Security Style of the Volume. Use UNIX to use UNIX or NFSV4 ACLs for file permissions.
               Use NTFS to use NTFS ACLs for file permissions. Can only be set for volumes which use SMB together with NFS as protocol.
               Possible values are: `NTFS`, `UNIX`.
        :param pulumi.Input[builtins.str] service_level: Service level of the volume. Inherited from storage pool. Supported values are : PREMIUM, EXTREME, STANDARD, FLEX.
        :param pulumi.Input[builtins.str] share_name: Share name (SMB) or export path (NFS) of the volume. Needs to be unique per location.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] smb_settings: Settings for volumes with SMB access.
               Each value may be one of: `ENCRYPT_DATA`, `BROWSABLE`, `CHANGE_NOTIFY`, `NON_BROWSABLE`, `OPLOCKS`, `SHOW_SNAPSHOT`, `SHOW_PREVIOUS_VERSIONS`, `ACCESS_BASED_ENUMERATION`, `CONTINUOUSLY_AVAILABLE`.
        :param pulumi.Input[builtins.bool] snapshot_directory: If enabled, a NFS volume will contain a read-only .snapshot directory which provides access to each of the volume's snapshots. Will enable "Previous Versions" support for SMB.
        ...
        :param pulumi.Input[builtins.str] state_details: State details of the volume.
        :param pulumi.Input[builtins.str] storage_pool: Name of the storage pool to create the volume in. Pool needs enough spare capacity to accommodate the volume.
        :param pulumi.Input['VolumeTieringPolicyArgs'] tiering_policy: Tiering policy for the volume.
               Structure is documented below.
        :param pulumi.Input[builtins.str] unix_permissions: Unix permission the mount point will be created with. Default is 0770. Applicable for UNIX security style volumes only.
        :param pulumi.Input[builtins.str] used_gib: Used capacity of the volume (in GiB). This is computed periodically and it does not represent the realtime usage.
        :param pulumi.Input[builtins.str] zone: Specifies the active zone for regional volume.
        """
    ...
    def cold_tier_size_gib(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cold_tier_size_gib(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def has_replication(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def psa_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @psa_range.setter
    def psa_range(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="storagePool")
    def storage_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the storage pool to create the volume in. Pool needs enough spare capacity to accommodate the volume.
        """
        return pulumi.get(self, "storage_pool")
    ...
    @storage_pool.setter
    def storage_pool(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_pool", value)
    ...
    def used_gib(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @used_gib.setter
    def used_gib(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Volume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            unix_permissions: Optional[pulumi.Input[builtins.str]] = None,
            used_gib: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Volume':
        """
    ...
    @property
    @pulumi.getter(name="activeDirectory")
    def active_directory(self) -> pulumi.Output[builtins.str]:
        """
        Reports the resource name of the Active Directory policy being used. Inherited from storage pool.
        """
        return pulumi.get(self, "active_directory")
    ...
    @property
    @pulumi.getter(name="coldTierSizeGib")
    def cold_tier_size_gib(self) -> pulumi.Output[builtins.str]:
        """
        Output only. Size of the volume cold tier data in GiB.
        """
        return pulumi.get(self, "cold_tier_size_gib")
    ...
    @property
    @pulumi.getter(name="hasReplication")
    def has_replication(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the volume is part of a volume replication relationship.
        """
        return pulumi.get(self, "has_replication")
    ...
    @property
    @pulumi.getter(name="kerberosEnabled")
    def kerberos_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag indicating if the volume is a kerberos volume or not, export policy rules control kerberos security modes (krb5, krb5i, krb5p).
        """
        return pulumi.get(self, "kerberos_enabled")
    ...
    @property
    @pulumi.getter(name="kmsConfig")
    def kms_config(self) -> pulumi.Output[builtins.str]:
        """
        Reports the CMEK policy resurce name being used for volume encryption. Inherited from storage pool.
        """
        return pulumi.get(self, "kms_config")
    ...
    @property
    @pulumi.getter(name="largeCapacity")
    def large_capacity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Optional. Flag indicating if the volume will be a large capacity volume or a regular volume.
        """
        return pulumi.get(self, "large_capacity")
    ...
    @property
    @pulumi.getter(name="ldapEnabled")
    def ldap_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Flag indicating if the volume is NFS LDAP enabled or not. Inherited from storage pool.
        """
        return pulumi.get(self, "ldap_enabled")
    ...
    @property
    @pulumi.getter(name="multipleEndpoints")
    def multiple_endpoints(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Optional. Flag indicating if the volume will have an IP address per node for volumes supporting multiple IP endpoints.
        Only the volume with largeCapacity will be allowed to have multiple endpoints.
        """
    ...
    @property
    @pulumi.getter(name="psaRange")
    def psa_range(self) -> pulumi.Output[builtins.str]:
        """
        Name of the Private Service Access allocated range. Inherited from storage pool.
        """
        return pulumi.get(self, "psa_range")
    ...
    @property
    @pulumi.getter(name="replicaZone")
    def replica_zone(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the replica zone for regional volume.
        """
        return pulumi.get(self, "replica_zone")
    ...
    @property
    @pulumi.getter(name="restrictedActions")
    def restricted_actions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of actions that are restricted on this volume.
        Each value may be one of: `DELETE`.
        """
    ...
    @property
    @pulumi.getter(name="smbSettings")
    def smb_settings(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Settings for volumes with SMB access.
        Each value may be one of: `ENCRYPT_DATA`, `BROWSABLE`, `CHANGE_NOTIFY`, `NON_BROWSABLE`, `OPLOCKS`, `SHOW_SNAPSHOT`, `SHOW_PREVIOUS_VERSIONS`, `ACCESS_BASED_ENUMERATION`, `CONTINUOUSLY_AVAILABLE`.
        """
    ...
    @property
    @pulumi.getter(name="snapshotDirectory")
    def snapshot_directory(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If enabled, a NFS volume will contain a read-only .snapshot directory which provides access to each of the volume's snapshots. Will enable "Previous Versions" support for SMB.
        """
        return pulumi.get(self, "snapshot_directory")
    ...
    @property
    @pulumi.getter(name="storagePool")
    def storage_pool(self) -> pulumi.Output[builtins.str]:
        """
        Name of the storage pool to create the volume in. Pool needs enough spare capacity to accommodate the volume.
        """
        return pulumi.get(self, "storage_pool")
    ...
    @property
    @pulumi.getter(name="unixPermissions")
    def unix_permissions(self) -> pulumi.Output[builtins.str]:
        """
        Unix permission the mount point will be created with. Default is 0770. Applicable for UNIX security style volumes only.
        """
        return pulumi.get(self, "unix_permissions")
    ...
    @property
    @pulumi.getter(name="usedGib")
    def used_gib(self) -> pulumi.Output[builtins.str]:
        """
        Used capacity of the volume (in GiB). This is computed periodically and it does not represent the realtime usage.
        """
        return pulumi.get(self, "used_gib")
