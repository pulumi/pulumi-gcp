...
class VolumeSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: Name of the snapshot location. Snapshots are child resources of volumes and live in the same location.
        :param pulumi.Input[builtins.str] volume_name: The name of the volume to create the snapshot in.
        :param pulumi.Input[builtins.str] description: Description for the snapshot.
        ...
        :param pulumi.Input[builtins.str] name: The name of the snapshot.
...
class _VolumeSnapshotState:
    def __init__(__self__, *,
                 ...
                 used_bytes: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] used_bytes: Storage used to store blocks unique to this snapshot.
        :param pulumi.Input[builtins.str] volume_name: The name of the volume to create the snapshot in.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    def used_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @used_bytes.setter
    def used_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class VolumeSnapshot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            used_bytes: Optional[pulumi.Input[builtins.int]] = None,
            volume_name: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeSnapshot':
        """
    ...
    @property
    @pulumi.getter(name="usedBytes")
    def used_bytes(self) -> pulumi.Output[builtins.int]:
        """
        Storage used to store blocks unique to this snapshot.
        """
        return pulumi.get(self, "used_bytes")
