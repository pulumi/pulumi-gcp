...
class ActiveDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kdc_ip: IP address of the Active Directory server used as Kerberos Key Distribution Center.
        ...
        :param pulumi.Input[_builtins.str] name: The resource name of the Active Directory pool. Needs to be unique per location.
        :param pulumi.Input[_builtins.bool] nfs_users_with_ldap: Local UNIX users on clients without valid user information in Active Directory are blocked from access to LDAP enabled volumes.
...
class _ActiveDirectoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] site: Specifies an Active Directory site to manage domain controller selection.
               Use when Active Directory domain controllers in multiple regions are configured. Defaults to `Default-First-Site-Name` if left empty.
        :param pulumi.Input[_builtins.str] state: The state of the Active Directory policy (not the Active Directory itself).
        :param pulumi.Input[_builtins.str] state_details: The state details of the Active Directory.
        :param pulumi.Input[_builtins.str] username: Username for the Active Directory account with permissions to create the compute account within the specified organizational unit.
        """
        if administrators is not None:
            pulumi.set(__self__, "administrators", administrators)
...
class ActiveDirectory(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="securityOperators")
    def security_operators(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Domain accounts that require elevated privileges such as `SeSecurityPrivilege` to manage security logs. Comma-separated list.
        """
        return pulumi.get(self, "security_operators")
