...
class BackupArgs:
    ...
    def source_volume(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_volume(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BackupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Create time of the backup. A timestamp in RFC3339 UTC "Zulu" format. Examples: "2023-06-22T09:13:01.617Z".
        :param pulumi.Input[builtins.str] description: A description of the backup with 2048 characters or less. Requests with longer descriptions will be rejected.
    ...
    def chain_storage_bytes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def chain_storage_bytes(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def volume_usage_bytes(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Backup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="chainStorageBytes")
    def chain_storage_bytes(self) -> pulumi.Output[builtins.str]:
        """
        Backups of a volume build incrementally on top of each other. They form a "backup chain".
        Total size of all backups in a chain in bytes = baseline backup size + sum(incremental backup size)
        """
    ...
    @property
    @pulumi.getter(name="sourceVolume")
    def source_volume(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ID of volumes this backup belongs to. Format: `projects/{{projects_id}}/locations/{{location}}/volumes/{{name}}``
        """
        return pulumi.get(self, "source_volume")
