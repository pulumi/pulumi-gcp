...
class VolumeReplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the replication. Needs to be unique per location.
    ...
    def replication_schedule(self, value: pulumi.Input[_builtins.str]):
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels as key value pairs. Example: `{ "owner": "Bob", "department": "finance", "purpose": "testing" }`
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: Name of region for this resource. The resource needs to be created in the region of the destination volume.
        :param pulumi.Input[_builtins.str] mirror_state: Indicates the state of the mirror between source and destination volumes. Depending on the amount of data
        ...
        :param pulumi.Input[_builtins.str] replication_schedule: Specifies the replication interval.
               Possible values are: `EVERY_10_MINUTES`, `HOURLY`, `DAILY`.
        :param pulumi.Input[_builtins.str] role: Reverting a replication can swap source and destination volume roles. This field indicates if the `location` hosts
