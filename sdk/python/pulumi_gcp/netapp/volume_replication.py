...
class VolumeReplicationArgs:
    def __init__(__self__, *,
                 ...
                 replication_schedule: pulumi.Input[builtins.str],
                 volume_name: pulumi.Input[builtins.str],
                 delete_destination_volume: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 replication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 wait_for_mirror: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] replication_schedule: Specifies the replication interval.
               Possible values are: `EVERY_10_MINUTES`, `HOURLY`, `DAILY`.
        :param pulumi.Input[builtins.str] volume_name: The name of the existing source volume.
        :param pulumi.Input[builtins.str] description: An description of this resource.
        ...
        :param pulumi.Input[builtins.bool] force_stopping: Only replications with mirror_state=MIRRORED can be stopped. A replication in mirror_state=TRANSFERRING
    ...
    def replication_schedule(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replication_schedule(self, value: pulumi.Input[builtins.str]):
    ...
    def delete_destination_volume(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "delete_destination_volume")

    @delete_destination_volume.setter
    def delete_destination_volume(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def force_stopping(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def force_stopping(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def replication_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def replication_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "replication_enabled", value)

    @property
    @pulumi.getter(name="waitForMirror")
    def wait_for_mirror(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "wait_for_mirror")

    @wait_for_mirror.setter
    def wait_for_mirror(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VolumeReplicationState:
    def __init__(__self__, *,
                 ...
                 delete_destination_volume: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 destination_volume: Optional[pulumi.Input[builtins.str]] = None,
                 destination_volume_parameters: Optional[pulumi.Input['VolumeReplicationDestinationVolumeParametersArgs']] = None,
                 ...
                 replication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 replication_schedule: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: An description of this resource.
        :param pulumi.Input[builtins.str] destination_volume: Full resource name of destination volume with format: `projects/{{project}}/locations/{{location}}/volumes/{{volumeId}}`
        :param pulumi.Input['VolumeReplicationDestinationVolumeParametersArgs'] destination_volume_parameters: Destination volume parameters.
               Structure is documented below.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels as key value pairs. Example: `{ "owner": "Bob", "department": "finance", "purpose": "testing" }`
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] location: Name of region for this resource. The resource needs to be created in the region of the destination volume.
        :param pulumi.Input[builtins.str] mirror_state: Indicates the state of the mirror between source and destination volumes. Depending on the amount of data
        ...
        :param pulumi.Input[builtins.str] replication_schedule: Specifies the replication interval.
               Possible values are: `EVERY_10_MINUTES`, `HOURLY`, `DAILY`.
        :param pulumi.Input[builtins.str] role: Reverting a replication can swap source and destination volume roles. This field indicates if the `location` hosts
        ...
        :param pulumi.Input[builtins.str] source_volume: Full resource name of source volume with format: `projects/{{project}}/locations/{{location}}/volumes/{{volumeId}}`
        :param pulumi.Input[builtins.str] state: Indicates the state of replication resource. State of the mirror itself is indicated in mirrorState.
        :param pulumi.Input[builtins.str] state_details: State details of the replication resource.
    ...
    def destination_volume(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def destination_volume(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mirror_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mirror_state.setter
    def mirror_state(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="replicationSchedule")
    def replication_schedule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the replication interval.
        Possible values are: `EVERY_10_MINUTES`, `HOURLY`, `DAILY`.
        """
    ...
    @replication_schedule.setter
    def replication_schedule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_schedule", value)
...
class VolumeReplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_name: Optional[pulumi.Input[builtins.str]] = None,
            wait_for_mirror: Optional[pulumi.Input[builtins.bool]] = None) -> 'VolumeReplication':
        """
    ...
    @property
    @pulumi.getter(name="deleteDestinationVolume")
    def delete_destination_volume(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "delete_destination_volume")
    ...
    @property
    @pulumi.getter(name="destinationVolume")
    def destination_volume(self) -> pulumi.Output[builtins.str]:
        """
        Full resource name of destination volume with format: `projects/{{project}}/locations/{{location}}/volumes/{{volumeId}}`
        """
        return pulumi.get(self, "destination_volume")
    ...
    @property
    @pulumi.getter(name="forceStopping")
    def force_stopping(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Only replications with mirror_state=MIRRORED can be stopped. A replication in mirror_state=TRANSFERRING
        currently receives an update and stopping the update might be undesirable. Set this parameter to true
        to stop anyway. All data transferred to the destination will be discarded and content of destination
    ...
    @property
    @pulumi.getter(name="mirrorState")
    def mirror_state(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the state of the mirror between source and destination volumes. Depending on the amount of data
        in your source volume, PREPARING phase can take hours or days. mirrorState = MIRRORED indicates your baseline
        transfer ended and destination volume became accessible read-only. TRANSFERRING means a MIRRORED volume
    ...
    @property
    @pulumi.getter(name="replicationEnabled")
    def replication_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to false to stop/break the mirror. Stopping the mirror makes the destination volume read-write
        and act independently from the source volume.
        Set to true to enable/resume the mirror. WARNING: Resuming a mirror overwrites any changes
    ...
    @property
    @pulumi.getter(name="replicationSchedule")
    def replication_schedule(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the replication interval.
        Possible values are: `EVERY_10_MINUTES`, `HOURLY`, `DAILY`.
        """
    ...
    @property
    @pulumi.getter(name="sourceVolume")
    def source_volume(self) -> pulumi.Output[builtins.str]:
        """
        Full resource name of source volume with format: `projects/{{project}}/locations/{{location}}/volumes/{{volumeId}}`
        """
        return pulumi.get(self, "source_volume")
    ...
    @property
    @pulumi.getter(name="waitForMirror")
    def wait_for_mirror(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "wait_for_mirror")
