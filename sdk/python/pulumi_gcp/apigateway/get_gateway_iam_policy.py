...
@pulumi.output_type
calass GetGatewayIamPolicyResult:
    """
...
calass AwaitableGetGatewayIamPolicyResult(GetGatewayIamPolicyResult):
...
def get_gateway_iam_policy(gateway: Optional[str] = None,
    ...
    :param str region: The region of the gateway for the API.
