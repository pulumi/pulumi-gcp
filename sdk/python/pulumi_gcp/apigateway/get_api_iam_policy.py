...
def get_api_iam_policy(api: Optional[_builtins.str] = None,
    ...
    :param _builtins.str api: Used to find the parent resource to bind the IAM policy to
...
def get_api_iam_policy_output(api: Optional[pulumi.Input[_builtins.str]] = None,
