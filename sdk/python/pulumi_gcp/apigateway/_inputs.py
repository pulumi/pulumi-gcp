...
class ApiConfigGatewayConfigBackendConfigArgs:
    def __init__(__self__, *,
                 google_service_account: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] google_service_account: Google Cloud IAM service account used to sign OIDC tokens for backends that have authentication configured
               (https://cloud.google.com/service-infrastructure/docs/service-management/reference/rest/v1/services.configs#backend).
        """
...
class ApiConfigGrpcServiceArgs:
    def __init__(__self__, *,
                 ...
                 sources: pulumi.Input[Optional[Sequence[pulumi.Input['ApiConfigGrpcServiceSourceArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sources(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ApiConfigGrpcServiceSourceArgs']]]]:
        """
        Uncompiled proto files associated with the descriptor set, used for display purposes (server-side compilation is not supported). These should match the inputs to 'protoc' command used to generate fileDescriptorSet.
        Structure is documented below.
        """
    ...
    @sources.setter
    def sources(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ApiConfigGrpcServiceSourceArgs']]]]):
...
class ApiConfigGrpcServiceFileDescriptorSetArgs:
    def __init__(__self__, *,
                 ...
                 path: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] contents: Base64 encoded content of the file.
        :param pulumi.Input[_builtins.str] path: The file path (full or relative path). This is typically the path of the file when it is uploaded.
        """
