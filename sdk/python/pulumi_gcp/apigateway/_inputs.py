...
if not MYPY:
    class ApiConfigGatewayConfigBackendConfigArgsDict(TypedDict):
        google_service_account: pulumi.Input[builtins.str]
        """
...
class ApiConfigGatewayConfigBackendConfigArgs:
    def __init__(__self__, *,
                 google_service_account: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] google_service_account: Google Cloud IAM service account used to sign OIDC tokens for backends that have authentication configured
               (https://cloud.google.com/service-infrastructure/docs/service-management/reference/rest/v1/services.configs#backend).
        """
    ...
    def google_service_account(self) -> pulumi.Input[builtins.str]:
        """
        Google Cloud IAM service account used to sign OIDC tokens for backends that have authentication configured
        (https://cloud.google.com/service-infrastructure/docs/service-management/reference/rest/v1/services.configs#backend).
        """
    ...
    def google_service_account(self, value: pulumi.Input[builtins.str]):
...
class ApiConfigGrpcServiceFileDescriptorSetArgs:
    def __init__(__self__, *,
                 ...
                 path: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] contents: Base64 encoded content of the file.
        :param pulumi.Input[builtins.str] path: The file path (full or relative path). This is typically the path of the file when it is uploaded.
        """
