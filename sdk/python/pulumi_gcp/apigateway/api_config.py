...
class ApiConfigArgs:
    def __init__(__self__, *,
                 ...
                 api_config_id: Optional[pulumi.Input[builtins.str]] = None,
                 api_config_id_prefix: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def api_config_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_config_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_config_id", value)

    @property
    @pulumi.getter(name="apiConfigIdPrefix")
    def api_config_id_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_config_id_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ApiConfigState:
    def __init__(__self__, *,
                 ...
                 service_config_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ApiConfigManagedServiceConfigArgs']]] managed_service_configs: Optional. Service Configuration files. At least one must be included when using gRPC service definitions. See https://cloud.google.com/endpoints/docs/grpc/grpc-service-config#service_configuration_overview for the expected file contents.
               If multiple files are specified, the files are merged with the following rules: * All singular scalar fields are merged using "last one wins" semantics in the order of the files uploaded. * Repeated fields are concatenated. * Singular embedded messages are merged using these rules for nested fields.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: The resource name of the API Config.
        :param pulumi.Input[Sequence[pulumi.Input['ApiConfigOpenapiDocumentArgs']]] openapi_documents: OpenAPI specification documents. If specified, grpcServices and managedServiceConfigs must not be included.
               Structure is documented below.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        ...
        :param pulumi.Input[builtins.str] service_config_id: The ID of the associated Service Config (https://cloud.google.com/service-infrastructure/docs/glossary#config).
        """
        if api is not None:
            pulumi.set(__self__, "api", api)
        if api_config_id is not None:
    ...
    def service_config_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_config_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApiConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `{{api}}/{{api_config_id}}`
        ...
        :param pulumi.Input[Union['ApiConfigGatewayConfigArgs', 'ApiConfigGatewayConfigArgsDict']] gateway_config: Immutable. Gateway specific configuration.
               If not specified, backend authentication will be set to use OIDC authentication using the default compute service account
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApiConfigGrpcServiceArgs', 'ApiConfigGrpcServiceArgsDict']]]] grpc_services: gRPC service definition files. If specified, openapiDocuments must not be included.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Resource labels to represent user-provided metadata.
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            service_config_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ApiConfig':
        """
    ...
    @property
    @pulumi.getter(name="apiConfigId")
    def api_config_id(self) -> pulumi.Output[builtins.str]:
        """
        Identifier to assign to the API Config. Must be unique within scope of the parent resource(api).
        """
        return pulumi.get(self, "api_config_id")
    ...
    @property
    @pulumi.getter(name="apiConfigIdPrefix")
    def api_config_id_prefix(self) -> pulumi.Output[builtins.str]:
        """
        Creates a unique name beginning with the
        specified prefix. If this and api_config_id are unspecified, a random value is chosen for the name.
        """
    ...
    @property
    @pulumi.getter(name="serviceConfigId")
    def service_config_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the associated Service Config (https://cloud.google.com/service-infrastructure/docs/glossary#config).
        """
        return pulumi.get(self, "service_config_id")
