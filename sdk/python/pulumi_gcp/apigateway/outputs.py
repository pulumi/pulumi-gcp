...
class ApiConfigGatewayConfigBackendConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str google_service_account: Google Cloud IAM service account used to sign OIDC tokens for backends that have authentication configured
...
class ApiConfigGrpcServiceFileDescriptorSet(dict):
    def __init__(__self__, *,
                 ...
                 path: builtins.str):
        """
        :param builtins.str contents: Base64 encoded content of the file.
        :param builtins.str path: The file path (full or relative path). This is typically the path of the file when it is uploaded.
        """
