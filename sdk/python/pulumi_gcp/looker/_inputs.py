...
class InstanceControlledEgressConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] egress_fqdns: List of fully qualified domain names to be added to the allowlist for
               outbound traffic.
        :param pulumi.Input[_builtins.bool] marketplace_enabled: Whether the Looker Marketplace is enabled.
        """
...
class InstanceMaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] day_of_week: Required. Day of the week for this MaintenanceWindow (in UTC).
               - MONDAY: Monday
               - TUESDAY: Tuesday
               - WEDNESDAY: Wednesday
               - THURSDAY: Thursday
...
class InstanceOauthConfigArgs:
    def __init__(__self__, *,
                 ...
                 client_secret: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] client_id: The client ID for the Oauth config.
        :param pulumi.Input[_builtins.str] client_secret: The client secret for the Oauth config.
        """
...
class InstancePscConfigServiceAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection_status: (Output)
               Status of the service attachment connection.
        :param pulumi.Input[_builtins.str] local_fqdn: Fully qualified domain name that will be used in the private DNS record created for the service attachment.
        :param pulumi.Input[_builtins.str] target_service_attachment_uri: URI of the service attachment to connect to.
        """
...
class InstanceUserMetadataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] additional_viewer_user_count: Number of additional Viewer Users to allocate to the Looker Instance.
        """
