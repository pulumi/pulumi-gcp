...
if not MYPY:
    class InstanceAdminSettingsArgsDict(TypedDict):
        allowed_email_domains: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
elif False:
...
class InstanceDenyMaintenancePeriodEndDateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] day: Day of a month. Must be from 1 to 31 and valid for the year and month, or 0
               to specify a year by itself or a year and month where the day isn't significant.
        :param pulumi.Input[builtins.int] month: Month of a year. Must be from 1 to 12, or 0 to specify a year without a
               month and day.
        :param pulumi.Input[builtins.int] year: Year of the date. Must be from 1 to 9999, or 0 to specify a date without
               a year.
        """
        if day is not None:
...
if not MYPY:
    class InstanceEncryptionConfigArgsDict(TypedDict):
        ...
        """
        kms_key_name_version: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class InstanceEncryptionConfigArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_name_version: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] kms_key_name: Name of the customer managed encryption key (CMEK) in KMS.
        :param pulumi.Input[builtins.str] kms_key_name_version: (Output)
               Full name and version of the CMEK key currently in use to encrypt Looker data.
    ...
    def kms_key_name_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Full name and version of the CMEK key currently in use to encrypt Looker data.
        """
    ...
    def kms_key_name_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceMaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] day_of_week: Required. Day of the week for this MaintenanceWindow (in UTC).
               - MONDAY: Monday
               - TUESDAY: Tuesday
               - WEDNESDAY: Wednesday
               - THURSDAY: Thursday
...
class InstanceOauthConfigArgs:
    def __init__(__self__, *,
                 ...
                 client_secret: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] client_id: The client ID for the Oauth config.
        :param pulumi.Input[builtins.str] client_secret: The client secret for the Oauth config.
...
if not MYPY:
    class InstancePscConfigArgsDict(TypedDict):
        allowed_vpcs: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of VPCs that are allowed ingress into the Looker instance.
        """
        looker_service_attachment_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class InstancePscConfigArgs:
    def __init__(__self__, *,
                 allowed_vpcs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 looker_service_attachment_uri: Optional[pulumi.Input[builtins.str]] = None,
                 service_attachments: Optional[pulumi.Input[Sequence[pulumi.Input['InstancePscConfigServiceAttachmentArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_vpcs: List of VPCs that are allowed ingress into the Looker instance.
        :param pulumi.Input[builtins.str] looker_service_attachment_uri: (Output)
               URI of the Looker service attachment.
    ...
    def allowed_vpcs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of VPCs that are allowed ingress into the Looker instance.
        """
    ...
    @allowed_vpcs.setter
    def allowed_vpcs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_vpcs", value)

    @property
    @pulumi.getter(name="lookerServiceAttachmentUri")
    def looker_service_attachment_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        URI of the Looker service attachment.
        """
    ...
    def looker_service_attachment_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstancePscConfigServiceAttachmentArgsDict(TypedDict):
        connection_status: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Status of the service attachment connection.
        """
        local_fqdn: NotRequired[pulumi.Input[builtins.str]]
        """
        Fully qualified domain name that will be used in the private DNS record created for the service attachment.
        """
        target_service_attachment_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstancePscConfigServiceAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 local_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 target_service_attachment_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] connection_status: (Output)
               Status of the service attachment connection.
        :param pulumi.Input[builtins.str] local_fqdn: Fully qualified domain name that will be used in the private DNS record created for the service attachment.
        :param pulumi.Input[builtins.str] target_service_attachment_uri: URI of the service attachment to connect to.
        """
    ...
    def local_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Fully qualified domain name that will be used in the private DNS record created for the service attachment.
        """
    ...
    @local_fqdn.setter
    def local_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_fqdn", value)

    @property
    @pulumi.getter(name="targetServiceAttachmentUri")
    def target_service_attachment_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        URI of the service attachment to connect to.
        """
    ...
    def target_service_attachment_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_service_attachment_uri", value)


if not MYPY:
    class InstanceUserMetadataArgsDict(TypedDict):
        additional_developer_user_count: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of additional Developer Users to allocate to the Looker Instance.
        """
        additional_standard_user_count: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of additional Standard Users to allocate to the Looker Instance.
        """
        additional_viewer_user_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class InstanceUserMetadataArgs:
    def __init__(__self__, *,
                 additional_developer_user_count: Optional[pulumi.Input[builtins.int]] = None,
                 additional_standard_user_count: Optional[pulumi.Input[builtins.int]] = None,
                 additional_viewer_user_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] additional_developer_user_count: Number of additional Developer Users to allocate to the Looker Instance.
        :param pulumi.Input[builtins.int] additional_standard_user_count: Number of additional Standard Users to allocate to the Looker Instance.
        :param pulumi.Input[builtins.int] additional_viewer_user_count: Number of additional Viewer Users to allocate to the Looker Instance.
        """
    ...
    def additional_developer_user_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of additional Developer Users to allocate to the Looker Instance.
        """
    ...
    def additional_developer_user_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "additional_developer_user_count", value)

    @property
    @pulumi.getter(name="additionalStandardUserCount")
    def additional_standard_user_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of additional Standard Users to allocate to the Looker Instance.
        """
    ...
    def additional_standard_user_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "additional_standard_user_count", value)

    @property
    @pulumi.getter(name="additionalViewerUserCount")
    def additional_viewer_user_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of additional Viewer Users to allocate to the Looker Instance.
        """
    ...
    def additional_viewer_user_count(self, value: Optional[pulumi.Input[builtins.int]]):
