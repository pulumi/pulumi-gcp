...
class InstanceAdminSettings(dict):
    ...
    def __init__(__self__, *,
                 allowed_email_domains: Optional[Sequence[builtins.str]] = None):
    ...
    def allowed_email_domains(self) -> Optional[Sequence[builtins.str]]:
...
class InstanceDenyMaintenancePeriodEndDate(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int day: Day of a month. Must be from 1 to 31 and valid for the year and month, or 0
               to specify a year by itself or a year and month where the day isn't significant.
        :param builtins.int month: Month of a year. Must be from 1 to 12, or 0 to specify a year without a
               month and day.
        :param builtins.int year: Year of the date. Must be from 1 to 9999, or 0 to specify a date without
               a year.
        """
        if day is not None:
...
class InstanceEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_name_version: Optional[builtins.str] = None,
                 kms_key_state: Optional[builtins.str] = None):
        """
        :param builtins.str kms_key_name: Name of the customer managed encryption key (CMEK) in KMS.
        :param builtins.str kms_key_name_version: (Output)
    ...
    def kms_key_name_version(self) -> Optional[builtins.str]:
        """
        (Output)
        Full name and version of the CMEK key currently in use to encrypt Looker data.
        """
...
class InstanceMaintenanceWindow(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day_of_week: Required. Day of the week for this MaintenanceWindow (in UTC).
               - MONDAY: Monday
               - TUESDAY: Tuesday
               - WEDNESDAY: Wednesday
               - THURSDAY: Thursday
...
class InstancePscConfig(dict):
    ...
    def __init__(__self__, *,
                 allowed_vpcs: Optional[Sequence[builtins.str]] = None,
                 looker_service_attachment_uri: Optional[builtins.str] = None,
                 service_attachments: Optional[Sequence['outputs.InstancePscConfigServiceAttachment']] = None):
        """
        :param Sequence[builtins.str] allowed_vpcs: List of VPCs that are allowed ingress into the Looker instance.
        :param builtins.str looker_service_attachment_uri: (Output)
    ...
    def allowed_vpcs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def looker_service_attachment_uri(self) -> Optional[builtins.str]:
        """
        (Output)
        URI of the Looker service attachment.
        """
...
class InstancePscConfigServiceAttachment(dict):
    ...
    def __init__(__self__, *,
                 ...
                 local_fqdn: Optional[builtins.str] = None,
                 target_service_attachment_uri: Optional[builtins.str] = None):
        """
        :param builtins.str connection_status: (Output)
               Status of the service attachment connection.
        :param builtins.str local_fqdn: Fully qualified domain name that will be used in the private DNS record created for the service attachment.
        :param builtins.str target_service_attachment_uri: URI of the service attachment to connect to.
        """
    ...
    def local_fqdn(self) -> Optional[builtins.str]:
        """
    ...
    def target_service_attachment_uri(self) -> Optional[builtins.str]:
        """
...
class InstanceUserMetadata(dict):
    ...
    def __init__(__self__, *,
                 additional_developer_user_count: Optional[builtins.int] = None,
                 additional_standard_user_count: Optional[builtins.int] = None,
                 additional_viewer_user_count: Optional[builtins.int] = None):
        """
        :param builtins.int additional_developer_user_count: Number of additional Developer Users to allocate to the Looker Instance.
        :param builtins.int additional_standard_user_count: Number of additional Standard Users to allocate to the Looker Instance.
        :param builtins.int additional_viewer_user_count: Number of additional Viewer Users to allocate to the Looker Instance.
        """
    ...
    def additional_developer_user_count(self) -> Optional[builtins.int]:
        """
    ...
    def additional_standard_user_count(self) -> Optional[builtins.int]:
        """
    ...
    def additional_viewer_user_count(self) -> Optional[builtins.int]:
        """
