...
class AiSemanticGovernancePolicyEngineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AiSemanticGovernancePolicyEngineGatewayConfigArgs']]] gateway_configs: Configurations for gateways, keyed by a user-defined gateway name. At most
    ...
    def __init__(__self__,
        ...
        * `{{region}}`
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AiSemanticGovernancePolicyEngineGatewayConfigArgs', 'AiSemanticGovernancePolicyEngineGatewayConfigArgsDict', 'outputs.AiSemanticGovernancePolicyEngineGatewayConfig']]]] gateway_configs: Configurations for gateways, keyed by a user-defined gateway name. At most
               5 gateway configurations are allowed. Each gateway name must be 1-63
               characters, start with a lowercase letter, contain only lowercase letters,
               numbers and hyphens, and not end with a hyphen.
               Structure is documented below.
