...
def get_ai_featurestore_entitytype_iam_policy(entitytype: Optional[_builtins.str] = None,
                                              featurestore: Optional[_builtins.str] = None,
    ...
    :param _builtins.str entitytype: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str featurestore: The name of the Featurestore to use, in the format projects/{project}/locations/{location}/featurestores/{featurestore}. Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
