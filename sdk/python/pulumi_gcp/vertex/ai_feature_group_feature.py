...
class AiFeatureGroupFeatureArgs:
    def __init__(__self__, *,
                 ...
                 version_column_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: The resource name of the Feature Group Feature.
    ...
    def version_column_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def version_column_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AiFeatureGroupFeatureState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The timestamp of when the FeatureGroup was created in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        :param pulumi.Input[builtins.str] description: The description of the FeatureGroup.
...
class AiFeatureGroupFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            version_column_name: Optional[pulumi.Input[builtins.str]] = None) -> 'AiFeatureGroupFeature':
        """
    ...
    @property
    @pulumi.getter(name="versionColumnName")
    def version_column_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the BigQuery Table/View column hosting data for this version. If no value is provided, will use featureId.
        """
        return pulumi.get(self, "version_column_name")
