...
class AiFeatureStoreEntityTypeArgs:
    def __init__(__self__, *,
                 ...
                 offline_storage_ttl_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: The name of the EntityType. This value may be up to 60 characters, and valid characters are [a-z0-9_]. The first character cannot be a number.
        :param pulumi.Input[builtins.int] offline_storage_ttl_days: Config for data retention policy in offline storage. TTL in days for feature values that will be stored in offline storage. The Feature Store offline storage periodically removes obsolete feature values older than offlineStorageTtlDays since the feature generation time. If unset (or explicitly set to 0), default to 4000 days TTL.
        """
    ...
    def offline_storage_ttl_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def offline_storage_ttl_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _AiFeatureStoreEntityTypeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The region of the EntityType.
...
@pulumi.type_token("gcp:vertex/aiFeatureStoreEntityType:AiFeatureStoreEntityType")
class AiFeatureStoreEntityType(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'AiFeatureStoreEntityType':
        """
    ...
    @property
    @pulumi.getter(name="offlineStorageTtlDays")
    def offline_storage_ttl_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Config for data retention policy in offline storage. TTL in days for feature values that will be stored in offline storage. The Feature Store offline storage periodically removes obsolete feature values older than offlineStorageTtlDays since the feature generation time. If unset (or explicitly set to 0), default to 4000 days TTL.
        """
        return pulumi.get(self, "offline_storage_ttl_days")
