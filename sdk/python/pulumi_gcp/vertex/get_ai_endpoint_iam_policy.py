...
def get_ai_endpoint_iam_policy(endpoint: Optional[_builtins.str] = None,
    ...
    :param _builtins.str endpoint: Used to find the parent resource to bind the IAM policy to
...
def get_ai_endpoint_iam_policy_output(endpoint: Optional[pulumi.Input[_builtins.str]] = None,
