...
def get_ai_endpoint_iam_policy(endpoint: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint: Used to find the parent resource to bind the IAM policy to
...
def get_ai_endpoint_iam_policy_output(endpoint: Optional[pulumi.Input[builtins.str]] = None,
