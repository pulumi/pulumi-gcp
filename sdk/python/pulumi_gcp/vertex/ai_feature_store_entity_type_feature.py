...
class AiFeatureStoreEntityTypeFeatureArgs:
    def __init__(__self__, *,
                 entitytype: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] entitytype: The name of the Featurestore to use, in the format projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entitytype}.
               
               
               - - -
        :param pulumi.Input[builtins.str] value_type: Type of Feature value. Immutable. https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.featurestores.entityTypes.features#ValueType
        :param pulumi.Input[builtins.str] description: Description of the feature.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs to assign to the feature.
               
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] name: The name of the feature. The feature can be up to 64 characters long and can consist only of ASCII Latin letters A-Z and a-z, underscore(_), and ASCII digits 0-9 starting with a letter. The value will be unique given an entity type.
        """
    ...
    @property
    @pulumi.getter
    def entitytype(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @entitytype.setter
    def entitytype(self, value: pulumi.Input[builtins.str]):
...
class _AiFeatureStoreEntityTypeFeatureState:
    def __init__(__self__, *,
                 ...
                 entitytype: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The timestamp of when the entity type was created in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        :param pulumi.Input[builtins.str] description: Description of the feature.
        ...
        :param pulumi.Input[builtins.str] region: The region of the feature
        :param pulumi.Input[builtins.str] update_time: The timestamp when the entity type was most recently updated in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        :param pulumi.Input[builtins.str] value_type: Type of Feature value. Immutable. https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.featurestores.entityTypes.features#ValueType
        """
    ...
    @property
    @pulumi.getter
    def entitytype(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Featurestore to use, in the format projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entitytype}.
    ...
    @entitytype.setter
    def entitytype(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "entitytype", value)
...
class AiFeatureStoreEntityTypeFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            value_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AiFeatureStoreEntityTypeFeature':
        """
    ...
    @property
    @pulumi.getter
    def entitytype(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Featurestore to use, in the format projects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entitytype}.
