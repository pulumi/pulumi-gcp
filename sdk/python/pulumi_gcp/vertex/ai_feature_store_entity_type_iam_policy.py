...
class AiFeatureStoreEntityTypeIamPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        AiFeatureStoreEntityTypeIamPolicyArgs._configure(
...
class _AiFeatureStoreEntityTypeIamPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] policy_data: The policy data generated by
               a `organizations_get_iam_policy` data source.
        """
        _AiFeatureStoreEntityTypeIamPolicyState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            entitytype=entitytype,
            etag=etag,
            featurestore=featurestore,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AiFeatureStoreEntityTypeIamPolicyArgs._configure(_setter, **kwargs)
