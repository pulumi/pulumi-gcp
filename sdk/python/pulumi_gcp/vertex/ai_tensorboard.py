...
class AiTensorboardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The region of the tensorboard. eg us-central1
        """
...
class _AiTensorboardState:
    def __init__(__self__, *,
                 blob_storage_path_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 run_count: Optional[pulumi.Input[builtins.str]] = None,
                 update_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering AiTensorboard resources.
        :param pulumi.Input[builtins.str] blob_storage_path_prefix: Consumer project Cloud Storage path prefix used to store blob data, which can either be a bucket or directory. Does not end with a '/'.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The labels with user-defined metadata to organize your Tensorboards.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] name: Name of the Tensorboard.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
               and default labels configured on the provider.
        :param pulumi.Input[builtins.str] region: The region of the tensorboard. eg us-central1
        :param pulumi.Input[builtins.str] run_count: The number of Runs stored in this Tensorboard.
        :param pulumi.Input[builtins.str] update_time: The timestamp of when the Tensorboard was last updated in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        """
    ...
    def blob_storage_path_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blob_storage_path_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def run_count(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @run_count.setter
    def run_count(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AiTensorboard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            run_count: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'AiTensorboard':
        """
    ...
    @property
    @pulumi.getter(name="blobStoragePathPrefix")
    def blob_storage_path_prefix(self) -> pulumi.Output[builtins.str]:
        """
        Consumer project Cloud Storage path prefix used to store blob data, which can either be a bucket or directory. Does not end with a '/'.
        """
        return pulumi.get(self, "blob_storage_path_prefix")
    ...
    @property
    @pulumi.getter(name="runCount")
    def run_count(self) -> pulumi.Output[builtins.str]:
        """
        The number of Runs stored in this Tensorboard.
        """
        return pulumi.get(self, "run_count")
