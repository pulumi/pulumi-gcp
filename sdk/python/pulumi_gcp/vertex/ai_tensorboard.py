...
class AiTensorboardArgs:
    def __init__(__self__, *,
                 ...
                 encryption_spec: pulumi.Input[Optional['AiTensorboardEncryptionSpecArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels with user-defined metadata to organize your Tensorboards.
               
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] region: The region of the tensorboard. eg us-central1
        """
    ...
    def encryption_spec(self) -> pulumi.Input[Optional['AiTensorboardEncryptionSpecArgs']]:
        """
    ...
    def encryption_spec(self, value: pulumi.Input[Optional['AiTensorboardEncryptionSpecArgs']]):
...
class _AiTensorboardState:
    def __init__(__self__, *,
                 blob_storage_path_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 run_count: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels with user-defined metadata to organize your Tensorboards.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] name: Name of the Tensorboard.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
                and default labels configured on the provider.
        :param pulumi.Input[_builtins.str] region: The region of the tensorboard. eg us-central1
        :param pulumi.Input[_builtins.str] run_count: The number of Runs stored in this Tensorboard.
        :param pulumi.Input[_builtins.str] update_time: The timestamp of when the Tensorboard was last updated in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        """
    ...
    def blob_storage_path_prefix(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def blob_storage_path_prefix(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def run_count(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @run_count.setter
    def run_count(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class AiTensorboard(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 encryption_spec: pulumi.Input[Optional[Union['AiTensorboardEncryptionSpecArgs', 'AiTensorboardEncryptionSpecArgsDict', 'outputs.AiTensorboardEncryptionSpec']]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        * `{{name}}`
        ...
        :param pulumi.Input[_builtins.str] description: Description of this Tensorboard.
        :param pulumi.Input[_builtins.str] display_name: User provided name of this Tensorboard.
        :param pulumi.Input[Union['AiTensorboardEncryptionSpecArgs', 'AiTensorboardEncryptionSpecArgsDict', 'outputs.AiTensorboardEncryptionSpec']] encryption_spec: Customer-managed encryption key spec for a Tensorboard. If set, this Tensorboard and all sub-resources of this Tensorboard will be secured by this key.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels with user-defined metadata to organize your Tensorboards.
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            run_count: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'AiTensorboard':
        """
