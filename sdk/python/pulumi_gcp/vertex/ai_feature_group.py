...
class AiFeatureGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The resource name of the Feature Group.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] region: The region of feature group. eg us-central1
        """
...
class AiFeatureGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'AiFeatureGroup':
        """
