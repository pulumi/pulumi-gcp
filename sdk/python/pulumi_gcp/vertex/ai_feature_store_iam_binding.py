...
class AiFeatureStoreIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] featurestore: Used to find the parent resource to bind the IAM policy to
        ...
        :param pulumi.Input[builtins.str] region: The region of the dataset. eg us-central1 Used to find the parent resource to bind the IAM policy to. If not specified,
...
class AiFeatureStoreIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: Optional[pulumi.Input[Union['AiFeatureStoreIamBindingConditionArgs', 'AiFeatureStoreIamBindingConditionArgsDict']]] = None,
                 featurestore: Optional[pulumi.Input[builtins.str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'AiFeatureStoreIamBinding':
        """
