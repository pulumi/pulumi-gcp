...
class AiDatasetEncryptionSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_name: Required. The Cloud KMS resource identifier of the customer managed encryption key used to protect a resource.
               Has the form: projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key. The key needs to be in the same region as where the resource is created.
        """
...
if not MYPY:
    class AiDeploymentResourcePoolDedicatedResourcesArgsDict(TypedDict):
        ...
        """
        min_replica_count: pulumi.Input[builtins.int]
        """
...
class AiDeploymentResourcePoolDedicatedResourcesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AiDeploymentResourcePoolDedicatedResourcesMachineSpecArgs'] machine_spec: The specification of a single machine used by the prediction
               Structure is documented below.
        :param pulumi.Input[builtins.int] min_replica_count: The minimum number of machine replicas this DeployedModel will be always deployed on. This value must be greater than or equal to 1. If traffic against the DeployedModel increases, it may dynamically be deployed onto more replicas, and as traffic decreases, some of these extra replicas may be freed.
        :param pulumi.Input[Sequence[pulumi.Input['AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecArgs']]] autoscaling_metric_specs: A list of the metric specifications that overrides a resource utilization metric.
               Structure is documented below.
        :param pulumi.Input[builtins.int] max_replica_count: The maximum number of replicas this DeployedModel may be deployed on when the traffic against it increases. If the requested value is too large, the deployment will error, but if deployment succeeds then the ability to scale the model to that many replicas is guaranteed (barring service outages). If traffic against the DeployedModel increases beyond what its replicas at maximum may handle, a portion of the traffic will be dropped. If this value is not provided, will use min_replica_count as the default value. The value of this field impacts the charge against Vertex CPU and GPU quotas. Specifically, you will be charged for max_replica_count * number of cores in the selected machine type) and (max_replica_count * number of GPUs per replica in the selected machine type).
        """
    ...
    def min_replica_count(self) -> pulumi.Input[builtins.int]:
        """
        The minimum number of machine replicas this DeployedModel will be always deployed on. This value must be greater than or equal to 1. If traffic against the DeployedModel increases, it may dynamically be deployed onto more replicas, and as traffic decreases, some of these extra replicas may be freed.
        """
    ...
    def min_replica_count(self, value: pulumi.Input[builtins.int]):
...
class AiDeploymentResourcePoolDedicatedResourcesAutoscalingMetricSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] metric_name: The resource metric name. Supported metrics: For Online Prediction: * `aiplatform.googleapis.com/prediction/online/accelerator/duty_cycle` * `aiplatform.googleapis.com/prediction/online/cpu/utilization`
        :param pulumi.Input[builtins.int] target: The target resource utilization in percentage (1% - 100%) for the given metric; once the real usage deviates from the target by a certain percentage, the machine replicas change. The default value is 60 (representing 60%) if not provided.
        """
...
class AiDeploymentResourcePoolDedicatedResourcesMachineSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] accelerator_count: The number of accelerators to attach to the machine.
        :param pulumi.Input[builtins.str] accelerator_type: The type of accelerator(s) that may be attached to the machine as per accelerator_count. See possible values [here](https://cloud.google.com/vertex-ai/docs/reference/rest/v1/MachineSpec#AcceleratorType).
        :param pulumi.Input[builtins.str] machine_type: The type of the machine. See the [list of machine types supported for prediction](https://cloud.google.com/vertex-ai/docs/predictions/configure-compute#machine-types).
        """
...
if not MYPY:
    class AiEndpointDeployedModelArgsDict(TypedDict):
        ...
        """
        enable_access_logging: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Output)
        These logs are like standard server access logs, containing information like timestamp and latency for each prediction request. Note that Stackdriver logs may incur a cost, especially if your project receives prediction requests at a high queries per second rate (QPS). Estimate your costs before enabling this option.
        """
        enable_container_logging: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Output)
        ...
        """
        model_version_id: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        ...
        """
        shared_resources: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiEndpointDeployedModelArgs:
    def __init__(__self__, *,
                 ...
                 enable_container_logging: Optional[pulumi.Input[builtins.bool]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 model: Optional[pulumi.Input[builtins.str]] = None,
                 model_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 shared_resources: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] enable_access_logging: (Output)
               These logs are like standard server access logs, containing information like timestamp and latency for each prediction request. Note that Stackdriver logs may incur a cost, especially if your project receives prediction requests at a high queries per second rate (QPS). Estimate your costs before enabling this option.
        :param pulumi.Input[builtins.bool] enable_container_logging: (Output)
               If true, the container of the DeployedModel instances will send `stderr` and `stdout` streams to Stackdriver Logging. Only supported for custom-trained Models and AutoML Tabular Models.
        :param pulumi.Input[builtins.str] id: (Output)
               The ID of the DeployedModel. If not provided upon deployment, Vertex AI will generate a value for this ID. This value should be 1-10 characters, and valid characters are /[0-9]/.
        :param pulumi.Input[builtins.str] model: (Output)
               The name of the Model that this is the deployment of. Note that the Model may be in a different location than the DeployedModel's Endpoint.
        :param pulumi.Input[builtins.str] model_version_id: (Output)
               Output only. The version ID of the model that is deployed.
        :param pulumi.Input[Sequence[pulumi.Input['AiEndpointDeployedModelPrivateEndpointArgs']]] private_endpoints: (Output)
               Output only. Provide paths for users to send predict/explain/health requests directly to the deployed model services running on Cloud via private services access. This field is populated if network is configured.
               Structure is documented below.
        :param pulumi.Input[builtins.str] service_account: (Output)
               The service account that the DeployedModel's container runs as. Specify the email address of the service account. If this service account is not specified, the container runs as a service account that doesn't have access to the resource project. Users deploying the Model must have the `iam.serviceAccounts.actAs` permission on this service account.
        :param pulumi.Input[builtins.str] shared_resources: (Output)
               The resource name of the shared DeploymentResourcePool to deploy on. Format: projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}
        """
    ...
    def enable_container_logging(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Output)
        If true, the container of the DeployedModel instances will send `stderr` and `stdout` streams to Stackdriver Logging. Only supported for custom-trained Models and AutoML Tabular Models.
        """
    ...
    def enable_container_logging(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def model_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Output only. The version ID of the model that is deployed.
        """
    ...
    def model_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def shared_resources(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The resource name of the shared DeploymentResourcePool to deploy on. Format: projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}
        """
    ...
    def shared_resources(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AiEndpointDeployedModelAutomaticResourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_replica_count: (Output)
               The maximum number of replicas this DeployedModel may be deployed on when the traffic against it increases. If the requested value is too large, the deployment will error, but if deployment succeeds then the ability to scale the model to that many replicas is guaranteed (barring service outages). If traffic against the DeployedModel increases beyond what its replicas at maximum may handle, a portion of the traffic will be dropped. If this value is not provided, a no upper bound for scaling under heavy traffic will be assume, though Vertex AI may be unable to scale beyond certain replica number.
        :param pulumi.Input[builtins.int] min_replica_count: (Output)
               The minimum number of replicas this DeployedModel will be always deployed on. If traffic against it increases, it may dynamically be deployed onto more replicas up to max_replica_count, and as traffic decreases, some of these extra replicas may be freed. If the requested value is too large, the deployment will error.
        """
        if max_replica_count is not None:
            pulumi.set(__self__, "max_replica_count", max_replica_count)
...
class AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpecArgs:
    def __init__(__self__, *,
                 ...
                 target: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] metric_name: (Output)
               The resource metric name. Supported metrics: * For Online Prediction: * `aiplatform.googleapis.com/prediction/online/accelerator/duty_cycle` * `aiplatform.googleapis.com/prediction/online/cpu/utilization`
        :param pulumi.Input[builtins.int] target: (Output)
               The target resource utilization in percentage (1% - 100%) for the given metric; once the real usage deviates from the target by a certain percentage, the machine replicas change. The default value is 60 (representing 60%) if not provided.
        """
...
class AiEndpointDeployedModelDedicatedResourceMachineSpecArgs:
    def __init__(__self__, *,
                 ...
                 machine_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] accelerator_count: (Output)
               The number of accelerators to attach to the machine.
        :param pulumi.Input[builtins.str] accelerator_type: (Output)
               The type of accelerator(s) that may be attached to the machine as per accelerator_count. See possible values [here](https://cloud.google.com/vertex-ai/docs/reference/rest/v1/MachineSpec#AcceleratorType).
        :param pulumi.Input[builtins.str] machine_type: (Output)
               The type of the machine. See the [list of machine types supported for prediction](https://cloud.google.com/vertex-ai/docs/predictions/configure-compute#machine-types) See the [list of machine types supported for custom training](https://cloud.google.com/vertex-ai/docs/training/configure-compute#machine-types). For DeployedModel this field is optional, and the default value is `n1-standard-2`. For BatchPredictionJob or as part of WorkerPoolSpec this field is required. TODO(rsurowka): Try to better unify the required vs optional.
        """
        if accelerator_count is not None:
            pulumi.set(__self__, "accelerator_count", accelerator_count)
...
if not MYPY:
    class AiEndpointDeployedModelPrivateEndpointArgsDict(TypedDict):
        explain_http_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Output only. Http(s) path to send explain requests.
        """
        health_http_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Output only. Http(s) path to send health check requests.
        """
        predict_http_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiEndpointDeployedModelPrivateEndpointArgs:
    def __init__(__self__, *,
                 explain_http_uri: Optional[pulumi.Input[builtins.str]] = None,
                 health_http_uri: Optional[pulumi.Input[builtins.str]] = None,
                 predict_http_uri: Optional[pulumi.Input[builtins.str]] = None,
                 service_attachment: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] explain_http_uri: (Output)
               Output only. Http(s) path to send explain requests.
        :param pulumi.Input[builtins.str] health_http_uri: (Output)
               Output only. Http(s) path to send health check requests.
        :param pulumi.Input[builtins.str] predict_http_uri: (Output)
               Output only. Http(s) path to send prediction requests.
    ...
    def explain_http_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Output only. Http(s) path to send explain requests.
        """
    ...
    def explain_http_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "explain_http_uri", value)

    @property
    @pulumi.getter(name="healthHttpUri")
    def health_http_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Output only. Http(s) path to send health check requests.
        """
    ...
    def health_http_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "health_http_uri", value)

    @property
    @pulumi.getter(name="predictHttpUri")
    def predict_http_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Output only. Http(s) path to send prediction requests.
        """
    ...
    def predict_http_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AiEndpointPredictRequestResponseLoggingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AiEndpointPredictRequestResponseLoggingConfigBigqueryDestinationArgs'] bigquery_destination: BigQuery table for logging. If only given a project, a new dataset will be created with name `logging_<endpoint-display-name>_<endpoint-id>` where will be made BigQuery-dataset-name compatible (e.g. most special characters will become underscores). If no table name is given, a new table will be created with name `request_response_logging`
               Structure is documented below.
        :param pulumi.Input[builtins.bool] enabled: If logging is enabled or not.
        :param pulumi.Input[builtins.float] sampling_rate: Percentage of requests to be logged, expressed as a fraction in range(0,1]
        """
...
class AiEndpointPredictRequestResponseLoggingConfigBigqueryDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] output_uri: BigQuery URI to a project or table, up to 2000 characters long. When only the project is specified, the Dataset and Table is created. When the full table reference is specified, the Dataset must exist and table must not exist. Accepted forms: - BigQuery path. For example: `bq://projectId` or `bq://projectId.bqDatasetId` or `bq://projectId.bqDatasetId.bqTableId`.
        """
...
if not MYPY:
    class AiEndpointPrivateServiceConnectConfigArgsDict(TypedDict):
        enable_private_service_connect: pulumi.Input[builtins.bool]
        """
        Required. If true, expose the IndexEndpoint via private service connect.
        """
        enable_secure_private_service_connect: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        project_allowlists: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AiEndpointPrivateServiceConnectConfigArgs:
    def __init__(__self__, *,
                 enable_private_service_connect: pulumi.Input[builtins.bool],
                 enable_secure_private_service_connect: Optional[pulumi.Input[builtins.bool]] = None,
                 project_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_private_service_connect: Required. If true, expose the IndexEndpoint via private service connect.
        :param pulumi.Input[builtins.bool] enable_secure_private_service_connect: If set to true, enable secure private service connect with IAM authorization. Otherwise, private service connect will be done without authorization. Note latency will be slightly increased if authorization is enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_allowlists: A list of Projects from which the forwarding rule will target the service attachment.
        """
    ...
    def enable_private_service_connect(self) -> pulumi.Input[builtins.bool]:
        """
        Required. If true, expose the IndexEndpoint via private service connect.
        """
    ...
    def enable_private_service_connect(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "enable_private_service_connect", value)

    @property
    @pulumi.getter(name="enableSecurePrivateServiceConnect")
    def enable_secure_private_service_connect(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If set to true, enable secure private service connect with IAM authorization. Otherwise, private service connect will be done without authorization. Note latency will be slightly increased if authorization is enabled.
        """
    ...
    def enable_secure_private_service_connect(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_secure_private_service_connect", value)

    @property
    @pulumi.getter(name="projectAllowlists")
    def project_allowlists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Projects from which the forwarding rule will target the service attachment.
        """
    ...
    def project_allowlists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AiFeatureGroupBigQueryArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        entity_id_columns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AiFeatureGroupBigQueryArgs:
    def __init__(__self__, *,
                 ...
                 entity_id_columns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input['AiFeatureGroupBigQueryBigQuerySourceArgs'] big_query_source: The BigQuery source URI that points to either a BigQuery Table or View.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] entity_id_columns: Columns to construct entityId / row keys. If not provided defaults to entityId.
        """
    ...
    def entity_id_columns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Columns to construct entityId / row keys. If not provided defaults to entityId.
        """
    ...
    def entity_id_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "entity_id_columns", value)


if not MYPY:
    class AiFeatureGroupBigQueryBigQuerySourceArgsDict(TypedDict):
        input_uri: pulumi.Input[builtins.str]
        """
...
class AiFeatureGroupBigQueryBigQuerySourceArgs:
    def __init__(__self__, *,
                 input_uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] input_uri: BigQuery URI to a table, up to 2000 characters long. For example: `bq://projectId.bqDatasetId.bqTableId.`
        """
        pulumi.set(__self__, "input_uri", input_uri)

    @property
    @pulumi.getter(name="inputUri")
    def input_uri(self) -> pulumi.Input[builtins.str]:
        """
        BigQuery URI to a table, up to 2000 characters long. For example: `bq://projectId.bqDatasetId.bqTableId.`
        """
    ...
    @input_uri.setter
    def input_uri(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AiFeatureOnlineStoreBigtableAutoScalingArgsDict(TypedDict):
        ...
        """
        cpu_utilization_target: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AiFeatureOnlineStoreBigtableAutoScalingArgs:
    def __init__(__self__, *,
                 max_node_count: pulumi.Input[builtins.int],
                 min_node_count: pulumi.Input[builtins.int],
                 cpu_utilization_target: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] max_node_count: The maximum number of nodes to scale up to. Must be greater than or equal to minNodeCount, and less than or equal to 10 times of 'minNodeCount'.
        :param pulumi.Input[builtins.int] min_node_count: The minimum number of nodes to scale down to. Must be greater than or equal to 1.
        :param pulumi.Input[builtins.int] cpu_utilization_target: A percentage of the cluster's CPU capacity. Can be from 10% to 80%. When a cluster's CPU utilization exceeds the target that you have set, Bigtable immediately adds nodes to the cluster. When CPU utilization is substantially lower than the target, Bigtable removes nodes. If not set will default to 50%.
        """
    ...
    def cpu_utilization_target(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        A percentage of the cluster's CPU capacity. Can be from 10% to 80%. When a cluster's CPU utilization exceeds the target that you have set, Bigtable immediately adds nodes to the cluster. When CPU utilization is substantially lower than the target, Bigtable removes nodes. If not set will default to 50%.
        """
    ...
    def cpu_utilization_target(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AiFeatureOnlineStoreDedicatedServingEndpointArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        public_endpoint_domain_name: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiFeatureOnlineStoreDedicatedServingEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfigArgs'] private_service_connect_config: Private service connect config.
               Structure is documented below.
        :param pulumi.Input[builtins.str] public_endpoint_domain_name: (Output)
               Domain name to use for this FeatureOnlineStore
        :param pulumi.Input[builtins.str] service_attachment: (Output)
               Name of the service attachment resource. Applicable only if private service connect is enabled and after FeatureViewSync is created.
        """
...
class AiFeatureOnlineStoreDedicatedServingEndpointPrivateServiceConnectConfigArgs:
    def __init__(__self__, *,
                 ...
                 project_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_private_service_connect: If set to true, customers will use private service connection to send request. Otherwise, the connection will set to public endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_allowlists: A list of Projects from which the forwarding rule will target the service attachment.
        """
        pulumi.set(__self__, "enable_private_service_connect", enable_private_service_connect)
        if project_allowlists is not None:
...
class AiFeatureOnlineStoreEmbeddingManagementArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Enable embedding management.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class AiFeatureOnlineStoreFeatureviewBigQuerySourceArgsDict(TypedDict):
        entity_id_columns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class AiFeatureOnlineStoreFeatureviewBigQuerySourceArgs:
    def __init__(__self__, *,
                 ...
                 uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] entity_id_columns: Columns to construct entityId / row keys. Start by supporting 1 only.
        :param pulumi.Input[builtins.str] uri: The BigQuery view URI that will be materialized on each sync trigger based on FeatureView.SyncConfig.
        """
        pulumi.set(__self__, "entity_id_columns", entity_id_columns)
    ...
    @property
    @pulumi.getter(name="entityIdColumns")
    def entity_id_columns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Columns to construct entityId / row keys. Start by supporting 1 only.
        """
        return pulumi.get(self, "entity_id_columns")
    ...
    @entity_id_columns.setter
    def entity_id_columns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "entity_id_columns", value)
...
class AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupArgs']]] feature_groups: List of features that need to be synced to Online Store.
               Structure is documented below.
        :param pulumi.Input[builtins.str] project_number: The project number of the parent project of the feature Groups.
        """
...
if not MYPY:
    class AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupArgsDict(TypedDict):
        feature_group_id: pulumi.Input[builtins.str]
        """
        Identifier of the feature group.
        """
        feature_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class AiFeatureOnlineStoreFeatureviewFeatureRegistrySourceFeatureGroupArgs:
    def __init__(__self__, *,
                 ...
                 feature_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] feature_group_id: Identifier of the feature group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] feature_ids: Identifiers of features under the feature group.
        """
    ...
    def feature_group_id(self) -> pulumi.Input[builtins.str]:
        """
        Identifier of the feature group.
        """
    ...
    def feature_group_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "feature_group_id", value)

    @property
    @pulumi.getter(name="featureIds")
    def feature_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Identifiers of features under the feature group.
        """
    ...
    @feature_ids.setter
    def feature_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class AiFeatureOnlineStoreFeatureviewVectorSearchConfigArgsDict(TypedDict):
        embedding_column: pulumi.Input[builtins.str]
        """
        ...
        """
        crowding_column: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        distance_measure_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        embedding_dimension: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of dimensions of the input embedding.
        """
        filter_columns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AiFeatureOnlineStoreFeatureviewVectorSearchConfigArgs:
    def __init__(__self__, *,
                 ...
                 crowding_column: Optional[pulumi.Input[builtins.str]] = None,
                 distance_measure_type: Optional[pulumi.Input[builtins.str]] = None,
                 embedding_dimension: Optional[pulumi.Input[builtins.int]] = None,
                 filter_columns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tree_ah_config: Optional[pulumi.Input['AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfigArgs']] = None):
        """
        :param pulumi.Input[builtins.str] embedding_column: Column of embedding. This column contains the source data to create index for vector search.
        ...
        :param pulumi.Input[builtins.str] crowding_column: Column of crowding. This column contains crowding attribute which is a constraint on a neighbor list produced by nearest neighbor search requiring that no more than some value k' of the k neighbors returned have the same value of crowdingAttribute.
        :param pulumi.Input[builtins.str] distance_measure_type: The distance measure used in nearest neighbor search.
               For details on allowed values, see the [API documentation](https://cloud.google.com/vertex-ai/docs/reference/rest/v1beta1/projects.locations.featureOnlineStores.featureViews#DistanceMeasureType).
               Possible values are: `SQUARED_L2_DISTANCE`, `COSINE_DISTANCE`, `DOT_PRODUCT_DISTANCE`.
        :param pulumi.Input[builtins.int] embedding_dimension: The number of dimensions of the input embedding.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] filter_columns: Columns of features that are used to filter vector search results.
    ...
    def embedding_column(self) -> pulumi.Input[builtins.str]:
        """
        Column of embedding. This column contains the source data to create index for vector search.
        """
    ...
    def embedding_column(self, value: pulumi.Input[builtins.str]):
    ...
    def crowding_column(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Column of crowding. This column contains crowding attribute which is a constraint on a neighbor list produced by nearest neighbor search requiring that no more than some value k' of the k neighbors returned have the same value of crowdingAttribute.
        """
    ...
    def crowding_column(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "crowding_column", value)

    @property
    @pulumi.getter(name="distanceMeasureType")
    def distance_measure_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The distance measure used in nearest neighbor search.
        For details on allowed values, see the [API documentation](https://cloud.google.com/vertex-ai/docs/reference/rest/v1beta1/projects.locations.featureOnlineStores.featureViews#DistanceMeasureType).
        Possible values are: `SQUARED_L2_DISTANCE`, `COSINE_DISTANCE`, `DOT_PRODUCT_DISTANCE`.
    ...
    def distance_measure_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "distance_measure_type", value)

    @property
    @pulumi.getter(name="embeddingDimension")
    def embedding_dimension(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of dimensions of the input embedding.
        """
    ...
    def embedding_dimension(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "embedding_dimension", value)

    @property
    @pulumi.getter(name="filterColumns")
    def filter_columns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Columns of features that are used to filter vector search results.
        """
    ...
    def filter_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfigArgsDict(TypedDict):
        leaf_node_embedding_count: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AiFeatureOnlineStoreFeatureviewVectorSearchConfigTreeAhConfigArgs:
    def __init__(__self__, *,
                 leaf_node_embedding_count: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] leaf_node_embedding_count: Number of embeddings on each leaf node. The default value is 1000 if not set.
        """
    ...
    def leaf_node_embedding_count(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Number of embeddings on each leaf node. The default value is 1000 if not set.
        """
...
class AiFeatureStoreEncryptionSpecArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: The Cloud KMS resource identifier of the customer managed encryption key used to protect a resource. Has the form: projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key. The key needs to be in the same region as where the compute resource is created.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
...
if not MYPY:
    class AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysisArgsDict(TypedDict):
        anomaly_detection_baseline: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AiFeatureStoreEntityTypeMonitoringConfigImportFeaturesAnalysisArgs:
    def __init__(__self__, *,
                 anomaly_detection_baseline: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] anomaly_detection_baseline: Defines the baseline to do anomaly detection for feature values imported by each [entityTypes.importFeatureValues][] operation. The value must be one of the values below:
               * LATEST_STATS: Choose the later one statistics generated by either most recent snapshot analysis or previous import features analysis. If non of them exists, skip anomaly detection and only generate a statistics.
               * MOST_RECENT_SNAPSHOT_STATS: Use the statistics generated by the most recent snapshot analysis if exists.
               * PREVIOUS_IMPORT_FEATURES_STATS: Use the statistics generated by the previous import features analysis if exists.
        :param pulumi.Input[builtins.str] state: Whether to enable / disable / inherite default hebavior for import features analysis. The value must be one of the values below:
               * DEFAULT: The default behavior of whether to enable the monitoring. EntityType-level config: disabled.
               * ENABLED: Explicitly enables import features analysis. EntityType-level config: by default enables import features analysis for all Features under it.
               * DISABLED: Explicitly disables import features analysis. EntityType-level config: by default disables import features analysis for all Features under it.
        """
    ...
    def anomaly_detection_baseline(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines the baseline to do anomaly detection for feature values imported by each [entityTypes.importFeatureValues][] operation. The value must be one of the values below:
        * LATEST_STATS: Choose the later one statistics generated by either most recent snapshot analysis or previous import features analysis. If non of them exists, skip anomaly detection and only generate a statistics.
        * MOST_RECENT_SNAPSHOT_STATS: Use the statistics generated by the most recent snapshot analysis if exists.
    ...
    def anomaly_detection_baseline(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AiFeatureStoreEntityTypeMonitoringConfigSnapshotAnalysisArgsDict(TypedDict):
        ...
        """
        monitoring_interval: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        monitoring_interval_days: NotRequired[pulumi.Input[builtins.int]]
        """
        Configuration of the snapshot analysis based monitoring pipeline running interval. The value indicates number of days. The default value is 1.
        If both FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days and [FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval][] are set when creating/updating EntityTypes/Features, FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days will be used.
        """
        staleness_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AiFeatureStoreEntityTypeMonitoringConfigSnapshotAnalysisArgs:
    def __init__(__self__, *,
                 ...
                 monitoring_interval: Optional[pulumi.Input[builtins.str]] = None,
                 monitoring_interval_days: Optional[pulumi.Input[builtins.int]] = None,
                 staleness_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] disabled: The monitoring schedule for snapshot analysis. For EntityType-level config: unset / disabled = true indicates disabled by default for Features under it; otherwise by default enable snapshot analysis monitoring with monitoringInterval for Features under it.
        :param pulumi.Input[builtins.str] monitoring_interval: Configuration of the snapshot analysis based monitoring pipeline running interval. The value is rolled up to full day.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
               
               > **Warning:** `monitoring_interval` is deprecated and will be removed in a future release.
        :param pulumi.Input[builtins.int] monitoring_interval_days: Configuration of the snapshot analysis based monitoring pipeline running interval. The value indicates number of days. The default value is 1.
               If both FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days and [FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval][] are set when creating/updating EntityTypes/Features, FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days will be used.
        :param pulumi.Input[builtins.int] staleness_days: Customized export features time window for snapshot analysis. Unit is one day. The default value is 21 days. Minimum value is 1 day. Maximum value is 4000 days.
        """
    ...
    def monitoring_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Configuration of the snapshot analysis based monitoring pipeline running interval. The value is rolled up to full day.
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
    ...
    def monitoring_interval(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitoring_interval", value)

    @property
    @pulumi.getter(name="monitoringIntervalDays")
    def monitoring_interval_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Configuration of the snapshot analysis based monitoring pipeline running interval. The value indicates number of days. The default value is 1.
        If both FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days and [FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval][] are set when creating/updating EntityTypes/Features, FeaturestoreMonitoringConfig.SnapshotAnalysis.monitoring_interval_days will be used.
        """
    ...
    def monitoring_interval_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "monitoring_interval_days", value)

    @property
    @pulumi.getter(name="stalenessDays")
    def staleness_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Customized export features time window for snapshot analysis. Unit is one day. The default value is 21 days. Minimum value is 1 day. Maximum value is 4000 days.
        """
    ...
    def staleness_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AiFeatureStoreOnlineServingConfigArgsDict(TypedDict):
        fixed_node_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AiFeatureStoreOnlineServingConfigArgs:
    def __init__(__self__, *,
                 fixed_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 scaling: Optional[pulumi.Input['AiFeatureStoreOnlineServingConfigScalingArgs']] = None):
        """
        :param pulumi.Input[builtins.int] fixed_node_count: The number of nodes for each cluster. The number of nodes will not scale automatically but can be scaled manually by providing different values when updating.
    ...
    def fixed_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of nodes for each cluster. The number of nodes will not scale automatically but can be scaled manually by providing different values when updating.
        """
    ...
    def fixed_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AiFeatureStoreOnlineServingConfigScalingArgs:
    def __init__(__self__, *,
                 ...
                 min_node_count: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_node_count: The maximum number of nodes to scale up to. Must be greater than minNodeCount, and less than or equal to 10 times of 'minNodeCount'.
        :param pulumi.Input[builtins.int] min_node_count: The minimum number of nodes to scale down to. Must be greater than or equal to 1.
        """
        pulumi.set(__self__, "max_node_count", max_node_count)
        pulumi.set(__self__, "min_node_count", min_node_count)
...
if not MYPY:
    class AiIndexDeployedIndexArgsDict(TypedDict):
        deployed_index_id: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        The ID of the DeployedIndex in the above IndexEndpoint.
        """
        index_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiIndexDeployedIndexArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] deployed_index_id: (Output)
               The ID of the DeployedIndex in the above IndexEndpoint.
        :param pulumi.Input[builtins.str] index_endpoint: (Output)
               A resource name of the IndexEndpoint.
        """
...
class AiIndexEndpointDeployedIndexAutomaticResourcesArgs:
    def __init__(__self__, *,
                 ...
                 min_replica_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] max_replica_count: The maximum number of replicas this DeployedModel may be deployed on when the traffic against it increases. If maxReplicaCount is not set, the default value is minReplicaCount. The max allowed replica count is 1000.
               The maximum number of replicas this DeployedModel may be deployed on when the traffic against it increases. If the requested value is too large, the deployment will error, but if deployment succeeds then the ability to scale the model to that many replicas is guaranteed (barring service outages). If traffic against the DeployedModel increases beyond what its replicas at maximum may handle, a portion of the traffic will be dropped. If this value is not provided, a no upper bound for scaling under heavy traffic will be assume, though Vertex AI may be unable to scale beyond certain replica number.
        :param pulumi.Input[builtins.int] min_replica_count: The minimum number of replicas this DeployedModel will be always deployed on. If minReplicaCount is not set, the default value is 2 (we don't provide SLA when minReplicaCount=1).
               If traffic against it increases, it may dynamically be deployed onto more replicas up to [maxReplicaCount](https://cloud.google.com/vertex-ai/docs/reference/rest/v1/AutomaticResources#FIELDS.max_replica_count), and as traffic decreases, some of these extra replicas may be freed. If the requested value is too large, the deployment will error.
        """
        if max_replica_count is not None:
            pulumi.set(__self__, "max_replica_count", max_replica_count)
...
class AiIndexEndpointDeployedIndexDedicatedResourcesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpecArgs'] machine_spec: The minimum number of replicas this DeployedModel will be always deployed on.
               Structure is documented below.
        :param pulumi.Input[builtins.int] min_replica_count: The minimum number of machine replicas this DeployedModel will be always deployed on. This value must be greater than or equal to 1.
        :param pulumi.Input[builtins.int] max_replica_count: The maximum number of replicas this DeployedModel may be deployed on when the traffic against it increases. If maxReplicaCount is not set, the default value is minReplicaCount
        """
        pulumi.set(__self__, "machine_spec", machine_spec)
        pulumi.set(__self__, "min_replica_count", min_replica_count)
        if max_replica_count is not None:
...
class AiIndexEndpointDeployedIndexDedicatedResourcesMachineSpecArgs:
    def __init__(__self__, *,
                 machine_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] machine_type: The type of the machine.
               See the [list of machine types supported for prediction](https://cloud.google.com/vertex-ai/docs/predictions/configure-compute#machine-types)
               See the [list of machine types supported for custom training](https://cloud.google.com/vertex-ai/docs/training/configure-compute#machine-types).
               For [DeployedModel](https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.endpoints#DeployedModel) this field is optional, and the default value is n1-standard-2. For [BatchPredictionJob](https://cloud.google.com/vertex-ai/docs/reference/rest/v1/projects.locations.batchPredictionJobs#BatchPredictionJob) or as part of [WorkerPoolSpec](https://cloud.google.com/vertex-ai/docs/reference/rest/v1/CustomJobSpec#WorkerPoolSpec) this field is required.
        """
...
if not MYPY:
    class AiIndexEndpointDeployedIndexDeployedIndexAuthConfigAuthProviderArgsDict(TypedDict):
        allowed_issuers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AiIndexEndpointDeployedIndexDeployedIndexAuthConfigAuthProviderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_issuers: A list of allowed JWT issuers. Each entry must be a valid Google service account, in the following format: service-account-name@project-id.iam.gserviceaccount.com
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: The list of JWT audiences. that are allowed to access. A JWT containing any of these audiences will be accepted.
        """
...
if not MYPY:
    class AiIndexEndpointDeployedIndexPrivateEndpointArgsDict(TypedDict):
        match_grpc_address: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiIndexEndpointDeployedIndexPrivateEndpointArgs:
    def __init__(__self__, *,
                 match_grpc_address: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_attachment: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] match_grpc_address: (Output)
               The ip address used to send match gRPC requests.
    ...
    def match_grpc_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The ip address used to send match gRPC requests.
        """
    ...
    def match_grpc_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpointArgsDict(TypedDict):
        match_address: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpointArgs:
    def __init__(__self__, *,
                 match_address: Optional[pulumi.Input[builtins.str]] = None,
                 network: Optional[pulumi.Input[builtins.str]] = None,
                 project_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] match_address: (Output)
               ip Address created by the automated forwarding rule.
    ...
    def match_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        ip Address created by the automated forwarding rule.
        """
    ...
    def match_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AiIndexEndpointPrivateServiceConnectConfigArgs:
    def __init__(__self__, *,
                 ...
                 project_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_private_service_connect: If set to true, the IndexEndpoint is created without private service access.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_allowlists: A list of Projects from which the forwarding rule will target the service attachment.
        """
        pulumi.set(__self__, "enable_private_service_connect", enable_private_service_connect)
        if project_allowlists is not None:
...
if not MYPY:
    class AiIndexIndexStatArgsDict(TypedDict):
        shards_count: NotRequired[pulumi.Input[builtins.int]]
        """
        (Output)
        The number of shards in the Index.
        """
        vectors_count: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiIndexIndexStatArgs:
    def __init__(__self__, *,
                 shards_count: Optional[pulumi.Input[builtins.int]] = None,
                 vectors_count: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] shards_count: (Output)
               The number of shards in the Index.
        :param pulumi.Input[builtins.str] vectors_count: (Output)
               The number of vectors in the Index.
        """
    ...
    def shards_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Output)
        The number of shards in the Index.
        """
    ...
    @shards_count.setter
    def shards_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "shards_count", value)

    @property
    @pulumi.getter(name="vectorsCount")
    def vectors_count(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The number of vectors in the Index.
        """
    ...
    def vectors_count(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AiIndexMetadataArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        contents_delta_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        is_complete_overwrite: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AiIndexMetadataArgs:
    def __init__(__self__, *,
                 ...
                 contents_delta_uri: Optional[pulumi.Input[builtins.str]] = None,
                 is_complete_overwrite: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input['AiIndexMetadataConfigArgs'] config: The configuration of the Matching Engine Index.
               Structure is documented below.
        :param pulumi.Input[builtins.str] contents_delta_uri: Allows inserting, updating  or deleting the contents of the Matching Engine Index.
               The string must be a valid Cloud Storage directory path. If this
               field is set when calling IndexService.UpdateIndex, then no other
               Index field can be also updated as part of the same call.
               The expected structure and format of the files this URI points to is
               described at https://cloud.google.com/vertex-ai/docs/matching-engine/using-matching-engine#input-data-format
        :param pulumi.Input[builtins.bool] is_complete_overwrite: If this field is set together with contentsDeltaUri when calling IndexService.UpdateIndex,
               then existing content of the Index will be replaced by the data from the contentsDeltaUri.
        """
    ...
    def contents_delta_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Allows inserting, updating  or deleting the contents of the Matching Engine Index.
        The string must be a valid Cloud Storage directory path. If this
        field is set when calling IndexService.UpdateIndex, then no other
    ...
    def contents_delta_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "contents_delta_uri", value)

    @property
    @pulumi.getter(name="isCompleteOverwrite")
    def is_complete_overwrite(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If this field is set together with contentsDeltaUri when calling IndexService.UpdateIndex,
        then existing content of the Index will be replaced by the data from the contentsDeltaUri.
        """
    ...
    def is_complete_overwrite(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class AiIndexMetadataConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        approximate_neighbors_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        * DOT_PRODUCT_DISTANCE: Dot Product Distance. Defined as a negative of the dot product
        """
        feature_norm_type: NotRequired[pulumi.Input[builtins.str]]
        """
        Type of normalization to be carried out on each vector. The value must be one of the followings:
        * UNIT_L2_NORM: Unit L2 normalization type
        * NONE: No normalization type is specified.
        """
        shard_size: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AiIndexMetadataConfigArgs:
    def __init__(__self__, *,
                 ...
                 approximate_neighbors_count: Optional[pulumi.Input[builtins.int]] = None,
                 distance_measure_type: Optional[pulumi.Input[builtins.str]] = None,
                 feature_norm_type: Optional[pulumi.Input[builtins.str]] = None,
                 shard_size: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] dimensions: The number of dimensions of the input vectors.
        :param pulumi.Input['AiIndexMetadataConfigAlgorithmConfigArgs'] algorithm_config: The configuration with regard to the algorithms used for efficient search.
               Structure is documented below.
        :param pulumi.Input[builtins.int] approximate_neighbors_count: The default number of neighbors to find via approximate search before exact reordering is
               performed. Exact reordering is a procedure where results returned by an
               approximate search algorithm are reordered via a more expensive distance computation.
               Required if tree-AH algorithm is used.
        :param pulumi.Input[builtins.str] distance_measure_type: The distance measure used in nearest neighbor search. The value must be one of the followings:
               * SQUARED_L2_DISTANCE: Euclidean (L_2) Distance
               * L1_DISTANCE: Manhattan (L_1) Distance
               * COSINE_DISTANCE: Cosine Distance. Defined as 1 - cosine similarity.
               * DOT_PRODUCT_DISTANCE: Dot Product Distance. Defined as a negative of the dot product
        :param pulumi.Input[builtins.str] feature_norm_type: Type of normalization to be carried out on each vector. The value must be one of the followings:
               * UNIT_L2_NORM: Unit L2 normalization type
               * NONE: No normalization type is specified.
        :param pulumi.Input[builtins.str] shard_size: Index data is split into equal parts to be processed. These are called "shards".
               The shard size must be specified when creating an index. The value must be one of the followings:
               * SHARD_SIZE_SMALL: Small (2GB)
               * SHARD_SIZE_MEDIUM: Medium (20GB)
               * SHARD_SIZE_LARGE: Large (50GB)
    ...
    def approximate_neighbors_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The default number of neighbors to find via approximate search before exact reordering is
        performed. Exact reordering is a procedure where results returned by an
        approximate search algorithm are reordered via a more expensive distance computation.
    ...
    def approximate_neighbors_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def feature_norm_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Type of normalization to be carried out on each vector. The value must be one of the followings:
        * UNIT_L2_NORM: Unit L2 normalization type
        * NONE: No normalization type is specified.
    ...
    def feature_norm_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "feature_norm_type", value)

    @property
    @pulumi.getter(name="shardSize")
    def shard_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Index data is split into equal parts to be processed. These are called "shards".
        The shard size must be specified when creating an index. The value must be one of the followings:
        * SHARD_SIZE_SMALL: Small (2GB)
    ...
    @shard_size.setter
    def shard_size(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AiIndexMetadataConfigAlgorithmConfigTreeAhConfigArgsDict(TypedDict):
        leaf_node_embedding_count: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of embeddings on each leaf node. The default value is 1000 if not set.
        """
        leaf_nodes_to_search_percent: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AiIndexMetadataConfigAlgorithmConfigTreeAhConfigArgs:
    def __init__(__self__, *,
                 leaf_node_embedding_count: Optional[pulumi.Input[builtins.int]] = None,
                 leaf_nodes_to_search_percent: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] leaf_node_embedding_count: Number of embeddings on each leaf node. The default value is 1000 if not set.
        :param pulumi.Input[builtins.int] leaf_nodes_to_search_percent: The default percentage of leaf nodes that any query may be searched. Must be in
               range 1-100, inclusive. The default value is 10 (means 10%) if not set.
        """
        if leaf_node_embedding_count is not None:
            pulumi.set(__self__, "leaf_node_embedding_count", leaf_node_embedding_count)
    ...
    @property
    @pulumi.getter(name="leafNodeEmbeddingCount")
    def leaf_node_embedding_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of embeddings on each leaf node. The default value is 1000 if not set.
        """
        return pulumi.get(self, "leaf_node_embedding_count")
    ...
    @leaf_node_embedding_count.setter
    def leaf_node_embedding_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "leaf_node_embedding_count", value)

    @property
    @pulumi.getter(name="leafNodesToSearchPercent")
    def leaf_nodes_to_search_percent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The default percentage of leaf nodes that any query may be searched. Must be in
        range 1-100, inclusive. The default value is 10 (means 10%) if not set.
        """
    ...
    def leaf_nodes_to_search_percent(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AiMetadataStoreStateArgsDict(TypedDict):
        disk_utilization_bytes: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AiMetadataStoreStateArgs:
    def __init__(__self__, *,
                 disk_utilization_bytes: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] disk_utilization_bytes: (Output)
               The disk utilization of the MetadataStore in bytes.
        """
    ...
    def disk_utilization_bytes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The disk utilization of the MetadataStore in bytes.
        """
    ...
    def disk_utilization_bytes(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AiTensorboardEncryptionSpecArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: The Cloud KMS resource identifier of the customer managed encryption key used to protect a resource.
               Has the form: projects/my-project/locations/my-region/keyRings/my-kr/cryptoKeys/my-key. The key needs to be in the same region as where the resource is created.
        """
        pulumi.set(__self__, "kms_key_name", kms_key_name)
