...
class AiDatasetArgs:
    def __init__(__self__, *,
                 ...
                 metadata_schema_uri: pulumi.Input[_builtins.str],
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 encryption_spec: pulumi.Input[Optional['AiDatasetEncryptionSpecArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: The user-defined name of the Dataset. The name can be up to 128 characters long and can be consist of any UTF-8 characters.
        :param pulumi.Input[_builtins.str] metadata_schema_uri: Points to a YAML file stored on Google Cloud Storage describing additional information about the Dataset. The schema is defined as an OpenAPI 3.0.2 Schema Object. The schema files that can be used here are found in gs://google-cloud-aiplatform/schema/dataset/metadata/.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A set of key/value label pairs to assign to this Workflow.
    ...
    def metadata_schema_uri(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def metadata_schema_uri(self, value: pulumi.Input[_builtins.str]):
    ...
    def encryption_spec(self) -> pulumi.Input[Optional['AiDatasetEncryptionSpecArgs']]:
        """
    ...
    def encryption_spec(self, value: pulumi.Input[Optional['AiDatasetEncryptionSpecArgs']]):
...
class _AiDatasetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] create_time: The timestamp of when the dataset was created in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
               When set to "ABANDON", the command will remove the resource from Terraform
        ...
        :param pulumi.Input[_builtins.str] region: The region of the dataset. eg us-central1
        :param pulumi.Input[_builtins.str] update_time: The timestamp of when the dataset was last updated in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
        """
...
class AiDataset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 encryption_spec: pulumi.Input[Optional[Union['AiDatasetEncryptionSpecArgs', 'AiDatasetEncryptionSpecArgsDict', 'outputs.AiDatasetEncryptionSpec']]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 metadata_schema_uri: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * How-to Guides
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] display_name: The user-defined name of the Dataset. The name can be up to 128 characters long and can be consist of any UTF-8 characters.
        :param pulumi.Input[Union['AiDatasetEncryptionSpecArgs', 'AiDatasetEncryptionSpecArgsDict', 'outputs.AiDatasetEncryptionSpec']] encryption_spec: Customer-managed encryption key spec for a Dataset. If set, this Dataset and all sub-resources of this Dataset will be secured by this key.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: A set of key/value label pairs to assign to this Workflow.
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'AiDataset':
        """
