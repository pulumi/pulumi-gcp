...
def get_ai_featurestore_iam_policy(featurestore: Optional[builtins.str] = None,
    ...
    :param builtins.str featurestore: Used to find the parent resource to bind the IAM policy to
    :param builtins.str project: The ID of the project in which the resource belongs.
           If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
    :param builtins.str region: The region of the dataset. eg us-central1 Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_ai_featurestore_iam_policy_output(featurestore: Optional[pulumi.Input[builtins.str]] = None,
