...
class AiFeatureOnlineStoreFeatureviewIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['AiFeatureOnlineStoreFeatureviewIamBindingConditionArgs', 'AiFeatureOnlineStoreFeatureviewIamBindingConditionArgsDict']]] = None,
                 feature_online_store: pulumi.Input[Optional[_builtins.str]] = None,
                 feature_view: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
