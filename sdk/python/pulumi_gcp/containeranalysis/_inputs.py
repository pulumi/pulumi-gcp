...
class NoteAttestationAuthorityArgs:
    def __init__(__self__, *,
        ...
        """
        NoteAttestationAuthorityArgs._configure(
    ...
    def _configure(
             ...
             hint: Optional[pulumi.Input['NoteAttestationAuthorityHintArgs']] = None,
...
class NoteAttestationAuthorityHintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] human_readable_name: The human readable name of this Attestation Authority, for
               ...
               - - -
        """
        NoteAttestationAuthorityHintArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class NoteIamBindingConditionArgs:
    def __init__(__self__, *,
        ...
        NoteIamBindingConditionArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class NoteIamMemberConditionArgs:
    def __init__(__self__, *,
                 ...
                 title: pulumi.Input[str],
                 description: Optional[pulumi.Input[str]] = None):
        NoteIamMemberConditionArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            expression=expression,
            title=title,
            description=description,
...
class OccurenceAttestationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OccurenceAttestationSignatureArgs']]] signatures: One or more signatures over serializedPayload.
               ...
               Structure is documented below.
        """
        OccurenceAttestationArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             ...
             signatures: Optional[pulumi.Input[Sequence[pulumi.Input['OccurenceAttestationSignatureArgs']]]] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class OccurenceAttestationSignatureArgs:
    def __init__(__self__, *,
        ...
        """
        OccurenceAttestationSignatureArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
