...
class NoteAttestationAuthorityHintArgs:
    def __init__(__self__, *,
                 human_readable_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] human_readable_name: The human readable name of this Attestation Authority, for
               example "qa".
        """
...
class OccurenceAttestationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] serialized_payload: The serialized payload that is verified by one or
               more signatures. A base64-encoded string.
...
class OccurenceAttestationSignatureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_key_id: The identifier for the public key that verifies this
               ...
               * RFC6920 digest-named SubjectPublicKeyInfo (digest of the DER serialization):
               * "ni:///sha-256;cD9o9Cq6LG3jD0iKXqEi_vdjJGecm_iXkbqVoScViaU"
        :param pulumi.Input[_builtins.str] signature: The content of the signature, an opaque bytestring.
               The payload that this signature verifies MUST be
               unambiguously provided with the Signature during
               verification. A wrapper message might provide the
               payload explicitly. Alternatively, a message might
