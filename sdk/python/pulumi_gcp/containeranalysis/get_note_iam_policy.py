...
class GetNoteIamPolicyResult:
    ...
    """
    def __init__(__self__, etag=None, id=None, note=None, policy_data=None, project=None):
...
def get_note_iam_policy(note: Optional[builtins.str] = None,
    ...
    :param builtins.str note: Used to find the parent resource to bind the IAM policy to
...
def get_note_iam_policy_output(note: Optional[pulumi.Input[builtins.str]] = None,
