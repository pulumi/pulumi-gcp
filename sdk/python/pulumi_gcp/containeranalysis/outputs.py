...
class NoteAttestationAuthorityHint(dict):
    ...
    def __init__(__self__, *,
                 human_readable_name: _builtins.str):
        """
        :param _builtins.str human_readable_name: The human readable name of this Attestation Authority, for
               example "qa".
        """
...
class NoteRelatedUrl(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str url: Specific URL associated with the resource.
        :param _builtins.str label: Label to describe usage of the URL
        """
...
class OccurenceAttestation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str serialized_payload: The serialized payload that is verified by one or
...
class OccurenceAttestationSignature(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str public_key_id: The identifier for the public key that verifies this
        ...
        :param _builtins.str signature: The content of the signature, an opaque bytestring.
