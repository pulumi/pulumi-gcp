...
class RegionalEndpointArgs:
    def __init__(__self__, *,
                 ...
                 target_google_api: pulumi.Input[builtins.str],
    ...
    def target_google_api(self, value: pulumi.Input[builtins.str]):
...
class _RegionalEndpointState:
    def __init__(__self__, *,
                 ...
                 network: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 psc_forwarding_rule: Optional[pulumi.Input[builtins.str]] = None,
                 pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 subnetwork: Optional[pulumi.Input[builtins.str]] = None,
                 target_google_api: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] address: The IP Address of the Regional Endpoint. When no address is provided, an IP from the subnetwork is allocated. Use one of the following formats: * IPv4 address as in `10.0.0.1` * Address resource URI as in `projects/{project}/regions/{region}/addresses/{address_name}`
               > **Note:** This field accepts both a reference to a Compute Address resource, which is the resource name of which format is given in the description, and IP literal value. If the user chooses to input a reserved address value; they need to make sure that the reserved address is in IPv4 version, its purpose is GCE_ENDPOINT, its type is INTERNAL and its status is RESERVED. If the user chooses to input an IP literal, they need to make sure that it's a valid IPv4 address (x.x.x.x) within the subnetwork.
        :param pulumi.Input[builtins.str] create_time: Time when the RegionalEndpoint was created.
        :param pulumi.Input[builtins.str] description: A description of this resource.
        ...
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] psc_forwarding_rule: The resource reference of the PSC Forwarding Rule created on behalf of the customer. Format: `//compute.googleapis.com/projects/{project}/regions/{region}/forwardingRules/{forwarding_rule_name}`
    ...
    def psc_forwarding_rule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def psc_forwarding_rule(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @target_google_api.setter
    def target_google_api(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_google_api", value)
...
class RegionalEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnetwork: Optional[pulumi.Input[builtins.str]] = None,
            target_google_api: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionalEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="pscForwardingRule")
    def psc_forwarding_rule(self) -> pulumi.Output[builtins.str]:
        """
        The resource reference of the PSC Forwarding Rule created on behalf of the customer. Format: `//compute.googleapis.com/projects/{project}/regions/{region}/forwardingRules/{forwarding_rule_name}`
        """
        return pulumi.get(self, "psc_forwarding_rule")
