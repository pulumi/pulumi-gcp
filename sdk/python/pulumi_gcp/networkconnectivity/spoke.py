...
class _SpokeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] update_time: Output only. The time the spoke was last updated.
        """
...
class Spoke(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * How-to Guides
        ...
        network = gcp.compute.Network("network",
            name="tf-test-network_94690",
            auto_create_subnetworks=False)
        subnetwork = gcp.compute.Subnetwork("subnetwork",
            name="tf-test-subnet_29947",
            ip_cidr_range="10.0.0.0/28",
            region="us-central1",
            network=network.self_link)
        instance = gcp.compute.Instance("instance",
            name="tf-test-instance_28257",
        ...
        basic_hub = gcp.networkconnectivity.Hub("basic_hub",
            name="tf-test-hub_49175",
            description="A sample hub",
            labels={
                "label-two": "value-one",
            })
        primary = gcp.networkconnectivity.Spoke("primary",
            name="tf-test-name_79411",
