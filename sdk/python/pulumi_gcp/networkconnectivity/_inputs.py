...
if not MYPY:
    class GroupAutoAcceptArgsDict(TypedDict):
        auto_accept_projects: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class GroupAutoAcceptArgs:
    def __init__(__self__, *,
                 auto_accept_projects: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] auto_accept_projects: A list of project ids or project numbers for which you want to enable auto-accept. The auto-accept setting is applied to spokes being created or updated in these projects.
        """
        pulumi.set(__self__, "auto_accept_projects", auto_accept_projects)

    @property
    @pulumi.getter(name="autoAcceptProjects")
    def auto_accept_projects(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of project ids or project numbers for which you want to enable auto-accept. The auto-accept setting is applied to spokes being created or updated in these projects.
        """
    ...
    def auto_accept_projects(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class HubRoutingVpcArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] uri: The URI of the VPC network.
        """
        if uri is not None:
...
class InternalRangeMigrationArgs:
    def __init__(__self__, *,
                 ...
                 target: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] source: Resource path as an URI of the source resource, for example a subnet.
               The project for the source resource should match the project for the
               InternalRange.
               An example /projects/{project}/regions/{region}/subnetworks/{subnet}
        :param pulumi.Input[builtins.str] target: Resource path of the target resource. The target project can be
               different, as in the cases when migrating to peer networks. The resource
               may not exist yet.
               For example /projects/{project}/regions/{region}/subnetworks/{subnet}
        """
...
if not MYPY:
    class PolicyBasedRouteFilterArgsDict(TypedDict):
        ...
        - - -
        """
        ip_protocol: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicyBasedRouteFilterArgs:
    ...
    def protocol_version(self, value: pulumi.Input[builtins.str]):
    ...
    @src_range.setter
    def src_range(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyBasedRouteInterconnectAttachmentArgs:
    def __init__(__self__, *,
                 region: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] region: Cloud region to install this policy-based route on for Interconnect attachments. Use `all` to install it on all Interconnect attachments.
        """
...
class PolicyBasedRouteVirtualMachineArgs:
    def __init__(__self__, *,
                 tags: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of VM instance tags that this policy-based route applies to. VM instances that have ANY of tags specified here will install this PBR.
        """
...
if not MYPY:
    class PolicyBasedRouteWarningArgsDict(TypedDict):
        ...
        """
        warning_message: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class PolicyBasedRouteWarningArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] code: (Output)
               A warning code, if applicable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] data: (Output)
               Metadata about this warning in key: value format. The key should provides more detail on the warning being returned. For example, for warnings where there are no results in a list request for a particular zone, this key might be scope and the key value might be the zone name. Other examples might be a key indicating a deprecated resource and a suggested replacement.
        :param pulumi.Input[builtins.str] warning_message: (Output)
               A human-readable description of the warning code.
        """
        if code is not None:
...
class ServiceConnectionPolicyPscConfigArgs:
    ...
    @property
    @pulumi.getter
    def subnetworks(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        IDs of the subnetworks or fully qualified identifiers for the subnetworks
        """
...
if not MYPY:
    class ServiceConnectionPolicyPscConnectionArgsDict(TypedDict):
        consumer_address: NotRequired[pulumi.Input[builtins.str]]
        """
        The resource reference of the consumer address.
        """
        consumer_forwarding_rule: NotRequired[pulumi.Input[builtins.str]]
        """
        The resource reference of the PSC Forwarding Rule within the consumer VPC.
        """
        consumer_target_project: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        error_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        gce_operation: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceConnectionPolicyPscConnectionArgs:
    def __init__(__self__, *,
                 consumer_address: Optional[pulumi.Input[builtins.str]] = None,
                 consumer_forwarding_rule: Optional[pulumi.Input[builtins.str]] = None,
                 consumer_target_project: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 error_type: Optional[pulumi.Input[builtins.str]] = None,
                 gce_operation: Optional[pulumi.Input[builtins.str]] = None,
                 psc_connection_id: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] consumer_address: The resource reference of the consumer address.
        :param pulumi.Input[builtins.str] consumer_forwarding_rule: The resource reference of the PSC Forwarding Rule within the consumer VPC.
        :param pulumi.Input[builtins.str] consumer_target_project: The project where the PSC connection is created.
        ...
        :param pulumi.Input['ServiceConnectionPolicyPscConnectionErrorInfoArgs'] error_info: The error info for the latest error during operating this connection.
               Structure is documented below.
        :param pulumi.Input[builtins.str] error_type: The error type indicates whether the error is consumer facing, producer
               facing or system internal.
               Possible values are: `CONNECTION_ERROR_TYPE_UNSPECIFIED`, `ERROR_INTERNAL`, `ERROR_CONSUMER_SIDE`, `ERROR_PRODUCER_SIDE`.
        :param pulumi.Input[builtins.str] gce_operation: The last Compute Engine operation to setup PSC connection.
        :param pulumi.Input[builtins.str] psc_connection_id: The PSC connection id of the PSC forwarding rule.
        :param pulumi.Input[builtins.str] state: The state of the PSC connection.
               Possible values are: `STATE_UNSPECIFIED`, `ACTIVE`, `CREATING`, `DELETING`, `FAILED`.
        """
    ...
    def consumer_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource reference of the consumer address.
        """
    ...
    def consumer_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "consumer_address", value)

    @property
    @pulumi.getter(name="consumerForwardingRule")
    def consumer_forwarding_rule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource reference of the PSC Forwarding Rule within the consumer VPC.
        """
    ...
    def consumer_forwarding_rule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "consumer_forwarding_rule", value)

    @property
    @pulumi.getter(name="consumerTargetProject")
    def consumer_target_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The project where the PSC connection is created.
        """
    ...
    def consumer_target_project(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def error_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The error type indicates whether the error is consumer facing, producer
        facing or system internal.
        Possible values are: `CONNECTION_ERROR_TYPE_UNSPECIFIED`, `ERROR_INTERNAL`, `ERROR_CONSUMER_SIDE`, `ERROR_PRODUCER_SIDE`.
    ...
    @error_type.setter
    def error_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "error_type", value)

    @property
    @pulumi.getter(name="gceOperation")
    def gce_operation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The last Compute Engine operation to setup PSC connection.
        """
    ...
    def gce_operation(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceConnectionPolicyPscConnectionErrorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]] details: (Output)
               A list of messages that carry the error details.
        :param pulumi.Input[builtins.str] message: A developer-facing error message.
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
...
class ServiceConnectionPolicyPscConnectionErrorInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain: The logical grouping to which the "reason" belongs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Additional structured details about this error.
        :param pulumi.Input[builtins.str] reason: The reason of the error.
        """
...
if not MYPY:
    class SpokeLinkedInterconnectAttachmentsArgsDict(TypedDict):
        site_to_site_data_transfer: pulumi.Input[builtins.bool]
        """
        ...
        """
        include_import_ranges: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SpokeLinkedInterconnectAttachmentsArgs:
    def __init__(__self__, *,
                 site_to_site_data_transfer: pulumi.Input[builtins.bool],
                 uris: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 include_import_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] site_to_site_data_transfer: A value that controls whether site-to-site data transfer is enabled for these resources. Note that data transfer is available only in supported locations.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] uris: The URIs of linked interconnect attachment resources
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_import_ranges: IP ranges allowed to be included during import from hub (does not control transit connectivity).
               The only allowed value for now is "ALL_IPV4_RANGES".
        """
    ...
    def site_to_site_data_transfer(self) -> pulumi.Input[builtins.bool]:
        """
        A value that controls whether site-to-site data transfer is enabled for these resources. Note that data transfer is available only in supported locations.
        """
    ...
    def site_to_site_data_transfer(self, value: pulumi.Input[builtins.bool]):
    ...
    def include_import_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        IP ranges allowed to be included during import from hub (does not control transit connectivity).
        The only allowed value for now is "ALL_IPV4_RANGES".
        """
...
if not MYPY:
    class SpokeLinkedProducerVpcNetworkArgsDict(TypedDict):
        ...
        """
        exclude_export_ranges: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        IP ranges encompassing the subnets to be excluded from peering.
        """
        include_export_ranges: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        IP ranges allowed to be included from peering.
        """
        producer_network: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class SpokeLinkedProducerVpcNetworkArgs:
    def __init__(__self__, *,
                 network: pulumi.Input[builtins.str],
                 peering: pulumi.Input[builtins.str],
                 exclude_export_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_export_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 producer_network: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] network: The URI of the Service Consumer VPC that the Producer VPC is peered with.
        :param pulumi.Input[builtins.str] peering: The name of the VPC peering between the Service Consumer VPC and the Producer VPC (defined in the Tenant project) which is added to the NCC hub. This peering must be in ACTIVE state.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_export_ranges: IP ranges encompassing the subnets to be excluded from peering.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_export_ranges: IP ranges allowed to be included from peering.
        :param pulumi.Input[builtins.str] producer_network: (Output)
               The URI of the Producer VPC.
        """
    ...
    @property
    @pulumi.getter
    def peering(self) -> pulumi.Input[builtins.str]:
        """
        The name of the VPC peering between the Service Consumer VPC and the Producer VPC (defined in the Tenant project) which is added to the NCC hub. This peering must be in ACTIVE state.
        """
    ...
    @peering.setter
    def peering(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "peering", value)

    @property
    @pulumi.getter(name="excludeExportRanges")
    def exclude_export_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        IP ranges encompassing the subnets to be excluded from peering.
        """
    ...
    def exclude_export_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclude_export_ranges", value)

    @property
    @pulumi.getter(name="includeExportRanges")
    def include_export_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        IP ranges allowed to be included from peering.
        """
    ...
    def include_export_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "include_export_ranges", value)

    @property
    @pulumi.getter(name="producerNetwork")
    def producer_network(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The URI of the Producer VPC.
        """
    ...
    def producer_network(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SpokeLinkedRouterApplianceInstancesInstanceArgsDict(TypedDict):
        ...
        """
        virtual_machine: pulumi.Input[builtins.str]
        """
...
class SpokeLinkedRouterApplianceInstancesInstanceArgs:
    def __init__(__self__, *,
                 ...
                 virtual_machine: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] ip_address: The IP address on the VM to use for peering.
        :param pulumi.Input[builtins.str] virtual_machine: The URI of the virtual machine resource
        """
    ...
    def virtual_machine(self) -> pulumi.Input[builtins.str]:
        """
        The URI of the virtual machine resource
        """
    ...
    def virtual_machine(self, value: pulumi.Input[builtins.str]):
...
class SpokeLinkedVpcNetworkArgs:
    def __init__(__self__, *,
                 ...
                 include_export_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] uri: The URI of the VPC network resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_export_ranges: IP ranges encompassing the subnets to be excluded from peering.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_export_ranges: IP ranges allowed to be included from peering.
        """
        pulumi.set(__self__, "uri", uri)
...
class SpokeLinkedVpnTunnelsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] site_to_site_data_transfer: A value that controls whether site-to-site data transfer is enabled for these resources. Note that data transfer is available only in supported locations.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] uris: The URIs of linked VPN tunnel resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_import_ranges: IP ranges allowed to be included during import from hub (does not control transit connectivity).
               The only allowed value for now is "ALL_IPV4_RANGES".
        """
        pulumi.set(__self__, "site_to_site_data_transfer", site_to_site_data_transfer)
