...
class InternalRangeArgs:
    def __init__(__self__, *,
                 ...
                 overlaps: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 prefix_length: Optional[pulumi.Input[builtins.int]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 target_cidr_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] overlaps: Optional. Types of resources that are allowed to overlap with the current internal range.
    ...
    @property
    @pulumi.getter
    def overlaps(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @overlaps.setter
    def overlaps(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def target_cidr_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def target_cidr_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _InternalRangeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] usage: The type of usage set for this InternalRange.
               Possible values are: `FOR_VPC`, `EXTERNAL_TO_VPC`, `FOR_MIGRATION`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] users: Output only. The list of resources that refer to this internal range.
...
class InternalRange(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_cidr_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            usage: Optional[pulumi.Input[builtins.str]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'InternalRange':
        """
    ...
    @property
    @pulumi.getter
    def overlaps(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Optional. Types of resources that are allowed to overlap with the current internal range.
        Each value may be one of: `OVERLAP_ROUTE_RANGE`, `OVERLAP_EXISTING_SUBNET_RANGE`.
        """
    ...
    @property
    @pulumi.getter(name="targetCidrRanges")
    def target_cidr_ranges(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Optional. Can be set to narrow down or pick a different address space while searching for a free range.
        If not set, defaults to the "10.0.0.0/8" address space. This can be used to search in other rfc-1918 address spaces like "172.16.0.0/12" and "192.168.0.0/16" or non-rfc-1918 address spaces used in the VPC.
        """
