...
class HubArgs:
    def __init__(__self__, *,
                 ...
                 export_psc: Optional[pulumi.Input[builtins.bool]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 policy_mode: Optional[pulumi.Input[builtins.str]] = None,
                 preset_topology: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Hub resource.
        :param pulumi.Input[builtins.str] description: An optional description of the hub.
        :param pulumi.Input[builtins.bool] export_psc: Whether Private Service Connect transitivity is enabled for the hub. If true, Private Service Connect endpoints in VPC spokes attached to the hub are made accessible to other VPC spokes attached to the hub. The default value is false.
        ...
        :param pulumi.Input[builtins.str] name: Immutable. The name of the hub. Hub names must be unique. They use the following form: `projects/{project_number}/locations/global/hubs/{hub_id}`
               
               
               - - -
        :param pulumi.Input[builtins.str] policy_mode: Optional. The policy mode of this hub. This field can be either PRESET or CUSTOM. If unspecified, the policyMode defaults to PRESET.
               Possible values are: `CUSTOM`, `PRESET`.
        :param pulumi.Input[builtins.str] preset_topology: Optional. The topology implemented in this hub. Currently, this field is only used when policyMode = PRESET. The available preset topologies are MESH and STAR. If presetTopology is unspecified and policyMode = PRESET, the presetTopology defaults to MESH. When policyMode = CUSTOM, the presetTopology is set to PRESET_TOPOLOGY_UNSPECIFIED.
    ...
    def export_psc(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @export_psc.setter
    def export_psc(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def policy_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @policy_mode.setter
    def policy_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policy_mode", value)

    @property
    @pulumi.getter(name="presetTopology")
    def preset_topology(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def preset_topology(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _HubState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] unique_id: Output only. The Google-generated UUID for the hub. This value is unique across all hub resources. If a hub is deleted and another with the same name is created, the new hub is assigned a different unique_id.
...
class Hub(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            unique_id: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Hub':
        """
    ...
    @property
    @pulumi.getter(name="exportPsc")
    def export_psc(self) -> pulumi.Output[builtins.bool]:
        """
        Whether Private Service Connect transitivity is enabled for the hub. If true, Private Service Connect endpoints in VPC spokes attached to the hub are made accessible to other VPC spokes attached to the hub. The default value is false.
        """
        return pulumi.get(self, "export_psc")
    ...
    @property
    @pulumi.getter(name="policyMode")
    def policy_mode(self) -> pulumi.Output[builtins.str]:
        """
        Optional. The policy mode of this hub. This field can be either PRESET or CUSTOM. If unspecified, the policyMode defaults to PRESET.
        Possible values are: `CUSTOM`, `PRESET`.
        """
    ...
    @property
    @pulumi.getter(name="presetTopology")
    def preset_topology(self) -> pulumi.Output[builtins.str]:
        """
        Optional. The topology implemented in this hub. Currently, this field is only used when policyMode = PRESET. The available preset topologies are MESH and STAR. If presetTopology is unspecified and policyMode = PRESET, the presetTopology defaults to MESH. When policyMode = CUSTOM, the presetTopology is set to PRESET_TOPOLOGY_UNSPECIFIED.
        Possible values are: `MESH`, `STAR`.
        """
