    ...
    def __init__(__self__,
        ...
        * `* `$ terraform import google_folder_organization_policy.default {{folder_id}}/``serviceuser.services
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to "DELETE".
               ...
               ***
        :param pulumi.Input[_builtins.str] folder: The resource name of the folder to set the policy for. Its format is folders/{folder_id}.
        :param pulumi.Input[Union['OrganizationPolicyListPolicyArgs', 'OrganizationPolicyListPolicyArgsDict', 'outputs.OrganizationPolicyListPolicy']] list_policy: A policy that can define specific values that are allowed or denied for the given constraint. It
               can also be used to allow or deny all values. Structure is documented below.
