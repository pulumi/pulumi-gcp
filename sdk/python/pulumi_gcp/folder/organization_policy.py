...
class OrganizationPolicyArgs:
    def __init__(__self__, *,
                 constraint: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] constraint: The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
               
               - - -
        :param pulumi.Input[builtins.str] folder: The resource name of the folder to set the policy for. Its format is folders/{folder_id}.
        ...
        :param pulumi.Input['OrganizationPolicyRestorePolicyArgs'] restore_policy: A restore policy is a constraint to restore the default policy. Structure is documented below.
               ...
               - - -
        :param pulumi.Input[builtins.int] version: Version of the Policy. Default version is 0.
        """
    ...
    @property
    @pulumi.getter
    def constraint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @constraint.setter
    def constraint(self, value: pulumi.Input[builtins.str]):
...
class _OrganizationPolicyState:
    def __init__(__self__, *,
                 boolean_policy: Optional[pulumi.Input['OrganizationPolicyBooleanPolicyArgs']] = None,
                 constraint: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] constraint: The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
               ...
               - - -
        :param pulumi.Input[builtins.str] etag: (Computed) The etag of the organization policy. `etag` is used for optimistic concurrency control as a way to help prevent simultaneous updates of a policy from overwriting each other.
        :param pulumi.Input[builtins.str] folder: The resource name of the folder to set the policy for. Its format is folders/{folder_id}.
        :param pulumi.Input['OrganizationPolicyListPolicyArgs'] list_policy: A policy that can define specific values that are allowed or denied for the given constraint. It
               can also be used to allow or deny all values. Structure is documented below.
        :param pulumi.Input['OrganizationPolicyRestorePolicyArgs'] restore_policy: A restore policy is a constraint to restore the default policy. Structure is documented below.
               ...
               - - -
        :param pulumi.Input[builtins.str] update_time: (Computed) The timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds, representing when the variable was last updated. Example: "2016-10-09T12:33:37.578138407Z".
        :param pulumi.Input[builtins.int] version: Version of the Policy. Default version is 0.
        """
        if boolean_policy is not None:
            pulumi.set(__self__, "boolean_policy", boolean_policy)
    ...
    @property
    @pulumi.getter
    def constraint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
    ...
    @constraint.setter
    def constraint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "constraint", value)
...
class OrganizationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `{{folder_id}}/serviceuser.services`
        ...
        :param pulumi.Input[builtins.str] constraint: The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
               ...
               - - -
        :param pulumi.Input[builtins.str] folder: The resource name of the folder to set the policy for. Its format is folders/{folder_id}.
        :param pulumi.Input[Union['OrganizationPolicyListPolicyArgs', 'OrganizationPolicyListPolicyArgsDict']] list_policy: A policy that can define specific values that are allowed or denied for the given constraint. It
               can also be used to allow or deny all values. Structure is documented below.
    ...
    def get(resource_name: str,
            ...
            restore_policy: Optional[pulumi.Input[Union['OrganizationPolicyRestorePolicyArgs', 'OrganizationPolicyRestorePolicyArgsDict']]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'OrganizationPolicy':
        """
    ...
    @property
    @pulumi.getter
    def constraint(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
