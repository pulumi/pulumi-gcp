...
class GetOrganizationPolicyResult:
    ...
    """
    def __init__(__self__, boolean_policies=None, constraint=None, deletion_policy=None, etag=None, folder=None, id=None, list_policies=None, restore_policies=None, update_time=None, version=None):
