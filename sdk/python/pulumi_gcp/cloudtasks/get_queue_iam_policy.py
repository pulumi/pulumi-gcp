...
def get_queue_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location of the queue Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_queue_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                name: Optional[pulumi.Input[_builtins.str]] = None,
                                project: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetQueueIamPolicyResult]:
    """
    Retrieves the current IAM policy data for queue
