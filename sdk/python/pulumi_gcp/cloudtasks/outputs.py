...
class QueueHttpTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str http_method: The HTTP method to use for the request.
...
class QueueHttpTargetHeaderOverrideHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str key: The Key of the header.
...
class QueueHttpTargetOauthToken(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str scope: OAuth scope to be used for generating OAuth access token.
...
class QueueHttpTargetOidcToken(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str service_account_email: Service account email to be used for generating OIDC token.
               The service account must be within the same project as the queue.
               The caller must have iam.serviceAccounts.actAs permission for the service account.
        :param _builtins.str audience: Audience to be used when generating OIDC token. If not specified, the URI specified in target will be used.
        """
        pulumi.set(__self__, "service_account_email", service_account_email)
...
class QueueHttpTargetUriOverride(dict):
    ...
    def __init__(__self__, *,
                 ...
                 uri_override_enforce_mode: Optional[_builtins.str] = None):
        """
        :param _builtins.str host: Host override.
        ...
        :param 'QueueHttpTargetUriOverridePathOverrideArgs' path_override: URI path.
               ...
               Structure is documented below.
        :param _builtins.str port: Port override.
        ...
        :param 'QueueHttpTargetUriOverrideQueryOverrideArgs' query_override: URI query.
               ...
               Structure is documented below.
        :param _builtins.str scheme: Scheme override.
               When specified, the task URI scheme is replaced by the provided value (HTTP or HTTPS).
               Possible values are: `HTTP`, `HTTPS`.
        :param _builtins.str uri_override_enforce_mode: URI Override Enforce Mode
...
class QueueHttpTargetUriOverridePathOverride(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str path: The URI path (e.g., /users/1234). Default is an empty string.
        """
        if path is not None:
...
class QueueHttpTargetUriOverrideQueryOverride(dict):
    ...
    def __init__(__self__, *,
                 query_params: Optional[_builtins.str] = None):
        """
        :param _builtins.str query_params: The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty string.
        """
...
class QueueRateLimits(dict):
    ...
    def __init__(__self__, *,
                 max_burst_size: Optional[_builtins.int] = None,
                 max_concurrent_dispatches: Optional[_builtins.int] = None,
                 max_dispatches_per_second: Optional[_builtins.float] = None):
        """
        :param _builtins.int max_burst_size: (Output)
               The max burst size.
               Max burst size limits how fast tasks in queue are processed when many tasks are
               in the queue and the rate is high. This field allows the queue to have a high
               rate so processing starts shortly after a task is enqueued, but still limits
               resource usage when many tasks are enqueued in a short period of time.
        :param _builtins.int max_concurrent_dispatches: The maximum number of concurrent tasks that Cloud Tasks allows to
               be dispatched for this queue. After this threshold has been
               reached, Cloud Tasks stops dispatching tasks until the number of
               concurrent requests decreases.
        :param _builtins.float max_dispatches_per_second: The maximum rate at which tasks are dispatched from this queue.
...
class QueueRetryConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_backoff: Optional[_builtins.str] = None,
                 max_doublings: Optional[_builtins.int] = None,
                 max_retry_duration: Optional[_builtins.str] = None,
                 min_backoff: Optional[_builtins.str] = None):
        """
        :param _builtins.int max_attempts: Number of attempts per task.
        ...
        :param _builtins.str max_backoff: A task will be scheduled for retry between minBackoff and
        ...
        :param _builtins.str max_retry_duration: If positive, maxRetryDuration specifies the time limit for
               retrying a failed task, measured from when the task was first
               attempted. Once maxRetryDuration time has passed and the task has
               been attempted maxAttempts times, no further attempts will be
               made and the task will be deleted.
               If zero, then the task age is unlimited.
        :param _builtins.str min_backoff: A task will be scheduled for retry between minBackoff and
               maxBackoff duration after it fails, if the queue's RetryConfig
               specifies that the task should be retried.
        """
...
class QueueStackdriverLoggingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.float sampling_ratio: Specifies the fraction of operations to write to Stackdriver Logging.
