...
class WorkloadEkmProvisioningResponseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ekm_provisioning_state: Indicates Ekm enrollment Provisioning of a given workload. Possible values: EKM_PROVISIONING_STATE_UNSPECIFIED, EKM_PROVISIONING_STATE_PENDING, EKM_PROVISIONING_STATE_FAILED, EKM_PROVISIONING_STATE_COMPLETED
        """
...
class WorkloadKmsSettingsArgs:
    def __init__(__self__, *,
                 ...
                 rotation_period: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] next_rotation_time: Required. Input only. Immutable. The time at which the Key Management Service will automatically create a new version of the crypto key and mark it as the primary.
        :param pulumi.Input[_builtins.str] rotation_period: Required. Input only. Immutable. will be advanced by this period when the Key Management Service automatically rotates a key. Must be at least 24 hours and at most 876,000 hours.
        """
...
class WorkloadPartnerPermissionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] service_access_approver: Optional. Allow partner to view access approval logs.
        """
