...
class WorkloadComplianceStatus(dict):
    ...
    def __init__(__self__, *,
                 acknowledged_violation_counts: Optional[Sequence[builtins.int]] = None,
                 active_violation_counts: Optional[Sequence[builtins.int]] = None):
        """
        :param Sequence[builtins.int] acknowledged_violation_counts: Number of current orgPolicy violations which are acknowledged.
        :param Sequence[builtins.int] active_violation_counts: Number of current orgPolicy violations which are not acknowledged.
        """
    ...
    def acknowledged_violation_counts(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    def active_violation_counts(self) -> Optional[Sequence[builtins.int]]:
        """
...
class WorkloadEkmProvisioningResponse(dict):
    ...
    def __init__(__self__, *,
                 ekm_provisioning_error_domain: Optional[builtins.str] = None,
                 ekm_provisioning_error_mapping: Optional[builtins.str] = None,
                 ekm_provisioning_state: Optional[builtins.str] = None):
        """
        :param builtins.str ekm_provisioning_error_domain: Indicates Ekm provisioning error if any. Possible values: EKM_PROVISIONING_ERROR_DOMAIN_UNSPECIFIED, UNSPECIFIED_ERROR, GOOGLE_SERVER_ERROR, EXTERNAL_USER_ERROR, EXTERNAL_PARTNER_ERROR, TIMEOUT_ERROR
        :param builtins.str ekm_provisioning_error_mapping: Detailed error message if Ekm provisioning fails Possible values: EKM_PROVISIONING_ERROR_MAPPING_UNSPECIFIED, INVALID_SERVICE_ACCOUNT, MISSING_METRICS_SCOPE_ADMIN_PERMISSION, MISSING_EKM_CONNECTION_ADMIN_PERMISSION
        :param builtins.str ekm_provisioning_state: Indicates Ekm enrollment Provisioning of a given workload. Possible values: EKM_PROVISIONING_STATE_UNSPECIFIED, EKM_PROVISIONING_STATE_PENDING, EKM_PROVISIONING_STATE_FAILED, EKM_PROVISIONING_STATE_COMPLETED
        """
    ...
    def ekm_provisioning_error_domain(self) -> Optional[builtins.str]:
        """
    ...
    def ekm_provisioning_error_mapping(self) -> Optional[builtins.str]:
        """
    ...
    def ekm_provisioning_state(self) -> Optional[builtins.str]:
        """
...
class WorkloadKmsSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str next_rotation_time: Required. Input only. Immutable. The time at which the Key Management Service will automatically create a new version of the crypto key and mark it as the primary.
        :param builtins.str rotation_period: Required. Input only. Immutable. will be advanced by this period when the Key Management Service automatically rotates a key. Must be at least 24 hours and at most 876,000 hours.
        """
...
class WorkloadPartnerPermissions(dict):
    ...
    def __init__(__self__, *,
                 assured_workloads_monitoring: Optional[builtins.bool] = None,
                 data_logs_viewer: Optional[builtins.bool] = None,
                 service_access_approver: Optional[builtins.bool] = None):
        """
        :param builtins.bool assured_workloads_monitoring: Optional. Allow partner to view violation alerts.
        :param builtins.bool data_logs_viewer: Allow the partner to view inspectability logs and monitoring violations.
        :param builtins.bool service_access_approver: Optional. Allow partner to view access approval logs.
        """
    ...
    def assured_workloads_monitoring(self) -> Optional[builtins.bool]:
        """
    ...
    def data_logs_viewer(self) -> Optional[builtins.bool]:
        """
    ...
    def service_access_approver(self) -> Optional[builtins.bool]:
        """
...
class WorkloadResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int resource_id: Resource identifier. For a project this represents project_number.
        :param builtins.str resource_type: Indicates the type of resource. Possible values: RESOURCE_TYPE_UNSPECIFIED, CONSUMER_PROJECT, ENCRYPTION_KEYS_PROJECT, KEYRING, CONSUMER_FOLDER
        """
...
class WorkloadResourceSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_type: Optional[builtins.str] = None):
        """
        :param builtins.str display_name: User-assigned resource display name. If not empty it will be used to create a resource with the specified name.
        :param builtins.str resource_id: Resource identifier. For a project this represents projectId. If the project is already taken, the workload creation will fail. For KeyRing, this represents the keyring_id. For a folder, don't set this value as folder_id is assigned by Google.
        :param builtins.str resource_type: Indicates the type of resource. This field should be specified to correspond the id to the right project type (CONSUMER_PROJECT or ENCRYPTION_KEYS_PROJECT) Possible values: RESOURCE_TYPE_UNSPECIFIED, CONSUMER_PROJECT, ENCRYPTION_KEYS_PROJECT, KEYRING, CONSUMER_FOLDER
        """
...
class WorkloadSaaEnrollmentResponse(dict):
    ...
    def __init__(__self__, *,
                 setup_errors: Optional[Sequence[builtins.str]] = None,
                 setup_status: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] setup_errors: Indicates SAA enrollment setup error if any.
        :param builtins.str setup_status: Indicates SAA enrollment status of a given workload. Possible values: SETUP_STATE_UNSPECIFIED, STATUS_PENDING, STATUS_COMPLETE
        """
    ...
    def setup_errors(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def setup_status(self) -> Optional[builtins.str]:
        """
...
class WorkloadWorkloadOptions(dict):
    ...
    def kaj_enrollment_type(self) -> Optional[builtins.str]:
        """
