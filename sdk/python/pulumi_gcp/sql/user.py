...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] deletion_policy: The deletion policy for the user.
               Setting `ABANDON` allows the resource to be abandoned rather than deleted. This is useful
               for Postgres, where users cannot be deleted from the API if they have been granted SQL roles.
               
               Possible values are: `ABANDON`.
        :param pulumi.Input[builtins.str] host: The host the user can connect from. This is only supported
               for BUILT_IN users in MySQL instances. Don't set this field for PostgreSQL and SQL Server instances.
               Can be an IP address. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the user. Changing this forces a new resource
               to be created.
        :param pulumi.Input[builtins.str] password: The password for the user. Can be updated. For Postgres
        ...
        :param pulumi.Input[builtins.str] type: The user type. It determines the method to authenticate the
