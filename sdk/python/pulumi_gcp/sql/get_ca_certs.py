...
def get_ca_certs(instance: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance: The name or self link of the instance.
    :param _builtins.str project: The ID of the project in which the resource belongs. If `project` is not provided, the provider project is used.
    """
    __args__ = dict()
