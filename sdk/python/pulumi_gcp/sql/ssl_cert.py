...
class SslCertArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] common_name: The common name to be used in the certificate to identify the
               client. Constrained to [a-zA-Z.-_ ]+. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] instance: The name of the Cloud SQL instance. Changing this
...
class _SslCertState:
    def __init__(__self__, *,
                 ...
                 cert_serial_number: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 server_ca_cert: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cert: The actual certificate data for this client certificate.
        :param pulumi.Input[builtins.str] cert_serial_number: The serial number extracted from the certificate data.
        :param pulumi.Input[builtins.str] common_name: The common name to be used in the certificate to identify the
               client. Constrained to [a-zA-Z.-_ ]+. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] create_time: The time when the certificate was created in RFC 3339 format,
               for example 2012-11-15T16:19:00.094Z.
        :param pulumi.Input[builtins.str] expiration_time: The time when the certificate expires in RFC 3339 format,
               for example 2012-11-15T16:19:00.094Z.
        :param pulumi.Input[builtins.str] instance: The name of the Cloud SQL instance. Changing this
               forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_key: The private key associated with the client certificate.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs. If it
               is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] server_ca_cert: The CA cert of the server this client cert was generated from.
        :param pulumi.Input[builtins.str] sha1_fingerprint: The SHA1 Fingerprint of the certificate.
        """
        if cert is not None:
    ...
    def cert_serial_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cert_serial_number(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def server_ca_cert(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_ca_cert(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SslCert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            server_ca_cert: Optional[pulumi.Input[builtins.str]] = None,
            sha1_fingerprint: Optional[pulumi.Input[builtins.str]] = None) -> 'SslCert':
        """
    ...
    @property
    @pulumi.getter(name="certSerialNumber")
    def cert_serial_number(self) -> pulumi.Output[builtins.str]:
        """
        The serial number extracted from the certificate data.
        """
        return pulumi.get(self, "cert_serial_number")
    ...
    @property
    @pulumi.getter(name="serverCaCert")
    def server_ca_cert(self) -> pulumi.Output[builtins.str]:
        """
        The CA cert of the server this client cert was generated from.
        """
        return pulumi.get(self, "server_ca_cert")
