...
def get_tiers(project: Optional[builtins.str] = None,
    ...
    :param builtins.str project: The Project ID for which to list tiers. If `project` is not provided, the project defined within the default provider configuration is used.
    """
    __args__ = dict()
...
def get_tiers_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
