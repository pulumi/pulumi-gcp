...
def get_database_instances(database_version: Optional[builtins.str] = None,
    ...
    :param builtins.str state: To filter out the Cloud SQL instances based on the current serving state of the database instance. Supported values include `SQL_INSTANCE_STATE_UNSPECIFIED`, `RUNNABLE`, `SUSPENDED`, `PENDING_DELETE`, `PENDING_CREATE`, `MAINTENANCE`, `FAILED`.
...
def get_database_instances_output(database_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
