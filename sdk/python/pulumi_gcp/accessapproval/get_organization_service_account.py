...
def get_organization_service_account(organization_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str organization_id: The organization ID the service account was created for.
    """
    __args__ = dict()
...
def get_organization_service_account_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
