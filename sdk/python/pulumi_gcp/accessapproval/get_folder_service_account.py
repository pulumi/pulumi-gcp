...
def get_folder_service_account(folder_id: Optional[builtins.str] = None,
    ...
    :param builtins.str folder_id: The folder ID the service account was created for.
    """
    __args__ = dict()
...
def get_folder_service_account_output(folder_id: Optional[pulumi.Input[builtins.str]] = None,
