...
def get_project_service_account(project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: The project ID the service account was created for.
    """
    __args__ = dict()
...
def get_project_service_account_output(project_id: Optional[pulumi.Input[_builtins.str]] = None,
