...
if not MYPY:
    class BlockchainNodesConnectionInfoEndpointInfoArgsDict(TypedDict):
        json_rpc_api_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        The assigned URL for the node JSON-RPC API endpoint.
        """
        websockets_api_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class BlockchainNodesConnectionInfoEndpointInfoArgs:
    def __init__(__self__, *,
                 json_rpc_api_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 websockets_api_endpoint: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] json_rpc_api_endpoint: (Output)
               The assigned URL for the node JSON-RPC API endpoint.
        :param pulumi.Input[builtins.str] websockets_api_endpoint: (Output)
               The assigned URL for the node WebSockets API endpoint.
        """
    ...
    def json_rpc_api_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The assigned URL for the node JSON-RPC API endpoint.
        """
    ...
    def json_rpc_api_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "json_rpc_api_endpoint", value)

    @property
    @pulumi.getter(name="websocketsApiEndpoint")
    def websockets_api_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The assigned URL for the node WebSockets API endpoint.
        """
    ...
    def websockets_api_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BlockchainNodesEthereumDetailsArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        api_enable_admin: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables JSON-RPC access to functions in the admin namespace. Defaults to false.
        """
        api_enable_debug: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables JSON-RPC access to functions in the debug namespace. Defaults to false.
        """
        consensus_client: NotRequired[pulumi.Input[builtins.str]]
        """
        The consensus client
        Possible values are: `CONSENSUS_CLIENT_UNSPECIFIED`, `LIGHTHOUSE`.
        """
        execution_client: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BlockchainNodesEthereumDetailsArgs:
    def __init__(__self__, *,
                 ...
                 api_enable_admin: Optional[pulumi.Input[builtins.bool]] = None,
                 api_enable_debug: Optional[pulumi.Input[builtins.bool]] = None,
                 consensus_client: Optional[pulumi.Input[builtins.str]] = None,
                 execution_client: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BlockchainNodesEthereumDetailsAdditionalEndpointArgs']]] additional_endpoints: (Output)
               User-provided key-value pairs
               Structure is documented below.
        :param pulumi.Input[builtins.bool] api_enable_admin: Enables JSON-RPC access to functions in the admin namespace. Defaults to false.
        :param pulumi.Input[builtins.bool] api_enable_debug: Enables JSON-RPC access to functions in the debug namespace. Defaults to false.
        :param pulumi.Input[builtins.str] consensus_client: The consensus client
               Possible values are: `CONSENSUS_CLIENT_UNSPECIFIED`, `LIGHTHOUSE`.
        :param pulumi.Input[builtins.str] execution_client: The execution client
               Possible values are: `EXECUTION_CLIENT_UNSPECIFIED`, `GETH`, `ERIGON`.
        :param pulumi.Input['BlockchainNodesEthereumDetailsGethDetailsArgs'] geth_details: User-provided key-value pairs
               Structure is documented below.
        :param pulumi.Input[builtins.str] network: The Ethereum environment being accessed.
               Possible values are: `MAINNET`, `TESTNET_GOERLI_PRATER`, `TESTNET_SEPOLIA`.
        :param pulumi.Input[builtins.str] node_type: The type of Ethereum node.
               Possible values are: `LIGHT`, `FULL`, `ARCHIVE`.
    ...
    def api_enable_admin(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables JSON-RPC access to functions in the admin namespace. Defaults to false.
        """
    ...
    def api_enable_admin(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "api_enable_admin", value)

    @property
    @pulumi.getter(name="apiEnableDebug")
    def api_enable_debug(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables JSON-RPC access to functions in the debug namespace. Defaults to false.
        """
    ...
    def api_enable_debug(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "api_enable_debug", value)

    @property
    @pulumi.getter(name="consensusClient")
    def consensus_client(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The consensus client
        Possible values are: `CONSENSUS_CLIENT_UNSPECIFIED`, `LIGHTHOUSE`.
        """
    ...
    def consensus_client(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "consensus_client", value)

    @property
    @pulumi.getter(name="executionClient")
    def execution_client(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The execution client
        Possible values are: `EXECUTION_CLIENT_UNSPECIFIED`, `GETH`, `ERIGON`.
        """
    ...
    def execution_client(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BlockchainNodesEthereumDetailsAdditionalEndpointArgsDict(TypedDict):
        beacon_api_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        The assigned URL for the node's Beacon API endpoint.
        """
        beacon_prometheus_metrics_api_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
        The assigned URL for the node's Beacon Prometheus metrics endpoint.
        """
        execution_client_prometheus_metrics_api_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BlockchainNodesEthereumDetailsAdditionalEndpointArgs:
    def __init__(__self__, *,
                 beacon_api_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 beacon_prometheus_metrics_api_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 execution_client_prometheus_metrics_api_endpoint: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] beacon_api_endpoint: The assigned URL for the node's Beacon API endpoint.
        :param pulumi.Input[builtins.str] beacon_prometheus_metrics_api_endpoint: The assigned URL for the node's Beacon Prometheus metrics endpoint.
        :param pulumi.Input[builtins.str] execution_client_prometheus_metrics_api_endpoint: The assigned URL for the node's execution client's Prometheus metrics endpoint.
        """
    ...
    def beacon_api_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The assigned URL for the node's Beacon API endpoint.
        """
    ...
    def beacon_api_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "beacon_api_endpoint", value)

    @property
    @pulumi.getter(name="beaconPrometheusMetricsApiEndpoint")
    def beacon_prometheus_metrics_api_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The assigned URL for the node's Beacon Prometheus metrics endpoint.
        """
    ...
    def beacon_prometheus_metrics_api_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def execution_client_prometheus_metrics_api_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The assigned URL for the node's execution client's Prometheus metrics endpoint.
        """
    ...
    def execution_client_prometheus_metrics_api_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BlockchainNodesEthereumDetailsGethDetailsArgsDict(TypedDict):
        garbage_collection_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BlockchainNodesEthereumDetailsGethDetailsArgs:
    def __init__(__self__, *,
                 garbage_collection_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] garbage_collection_mode: Blockchain garbage collection modes. Only applicable when NodeType is FULL or ARCHIVE.
               Possible values are: `FULL`, `ARCHIVE`.
    ...
    def garbage_collection_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Blockchain garbage collection modes. Only applicable when NodeType is FULL or ARCHIVE.
        Possible values are: `FULL`, `ARCHIVE`.
    ...
    def garbage_collection_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "garbage_collection_mode", value)


if not MYPY:
    class BlockchainNodesEthereumDetailsValidatorConfigArgsDict(TypedDict):
        mev_relay_urls: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BlockchainNodesEthereumDetailsValidatorConfigArgs:
    def __init__(__self__, *,
                 mev_relay_urls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] mev_relay_urls: URLs for MEV-relay services to use for block building. When set, a managed MEV-boost service is configured on the beacon client.
        """
    ...
    def mev_relay_urls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        URLs for MEV-relay services to use for block building. When set, a managed MEV-boost service is configured on the beacon client.
        """
    ...
    def mev_relay_urls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
