...
def get_docker_image(image_name: Optional[builtins.str] = None,
    ...
    :param builtins.str image_name: The image name to fetch. If no digest or tag is provided, then the latest modified image will be used.
    :param builtins.str location: The location of the artifact registry.
    :param builtins.str project: The project ID in which the resource belongs. If it is not provided, the provider project is used.
    :param builtins.str repository_id: The last part of the repository name to fetch from.
    """
    __args__ = dict()
...
def get_docker_image_output(image_name: Optional[pulumi.Input[builtins.str]] = None,
