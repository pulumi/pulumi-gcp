...
def get_repository_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The name of the repository's location. In addition to specific regions,
    ...
    :param _builtins.str repository: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
