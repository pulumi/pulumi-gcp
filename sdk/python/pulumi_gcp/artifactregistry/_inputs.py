...
class RepositoryCleanupPolicyConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tag_prefixes: Match versions by tag prefix. Applied on any prefix match.
        :param pulumi.Input[_builtins.str] tag_state: Match versions by tag status.
               Default value is `ANY`.
               Possible values are: `TAGGED`, `UNTAGGED`, `ANY`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] version_name_prefixes: Match versions by version name prefix. Applied on any prefix match.
        """
...
class RepositoryMavenConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] allow_snapshot_overwrites: The repository with this flag will allow publishing the same
               snapshot versions.
        :param pulumi.Input[_builtins.str] version_policy: Version policy defines the versions that the registry will accept.
               Default value is `VERSION_POLICY_UNSPECIFIED`.
               Possible values are: `VERSION_POLICY_UNSPECIFIED`, `RELEASE`, `SNAPSHOT`.
        """
...
class RepositoryRemoteRepositoryConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RepositoryRemoteRepositoryConfigCommonRepositoryArgs'] common_repository: Specific settings for an Artifact Registory remote repository.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] description: The description of the remote source.
        :param pulumi.Input[_builtins.bool] disable_upstream_validation: If true, the remote repository upstream and upstream credentials will
               not be validated.
...
class RepositoryRemoteRepositoryConfigAptRepositoryPublicRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 repository_path: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] repository_base: A common public repository base for Yum.
               Possible values are: `CENTOS`, `CENTOS_DEBUG`, `CENTOS_VAULT`, `CENTOS_STREAM`, `ROCKY`, `EPEL`.
        :param pulumi.Input[_builtins.str] repository_path: Specific repository from the base, e.g. `"pub/rocky/9/BaseOS/x86_64/os"`
        """
...
class RepositoryRemoteRepositoryConfigCommonRepositoryArgs:
    def __init__(__self__, *,
                 uri: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] uri: One of:
               a. Artifact Registry Repository resource, e.g. `projects/UPSTREAM_PROJECT_ID/locations/REGION/repositories/UPSTREAM_REPOSITORY`
               b. URI to the registry, e.g. `"https://registry-1.docker.io"`
               c. URI to Artifact Registry Repository, e.g. `"https://REGION-docker.pkg.dev/UPSTREAM_PROJECT_ID/UPSTREAM_REPOSITORY"`
        """
...
class RepositoryRemoteRepositoryConfigUpstreamCredentialsUsernamePasswordCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] password_secret_version: The Secret Manager key version that holds the password to access the
               remote repository. Must be in the format of
               `projects/{project}/secrets/{secret}/versions/{version}`.
        :param pulumi.Input[_builtins.str] username: The username to access the remote repository.
        """
...
class RepositoryVirtualRepositoryConfigUpstreamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] repository: A reference to the repository resource, for example:
               "projects/p1/locations/us-central1/repository/repo1".
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class RepositoryVulnerabilityScanningConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enablement_config: This configures whether vulnerability scanning is automatically performed for artifacts pushed to this repository.
               Possible values are: `INHERITED`, `DISABLED`.
        :param pulumi.Input[_builtins.str] enablement_state: (Output)
               This field returns whether scanning is active for this repository.
        :param pulumi.Input[_builtins.str] enablement_state_reason: (Output)
               This provides an explanation for the state of scanning on this repository.
        """
