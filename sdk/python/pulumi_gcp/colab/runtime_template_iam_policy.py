...
class RuntimeTemplateIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] runtime_template: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[_builtins.str] location: The location for the resource: https://cloud.google.com/colab/docs/locations Used to find the parent resource to bind the IAM policy to. If not specified,
...
class _RuntimeTemplateIamPolicyState:
    def __init__(__self__, *,
                 ...
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 runtime_template: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="runtimeTemplate")
    def runtime_template(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "runtime_template")
    ...
    @runtime_template.setter
    def runtime_template(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "runtime_template", value)
...
class RuntimeTemplateIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `colab.RuntimeTemplateIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the runtimetemplate are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `colab.RuntimeTemplateIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the runtimetemplate are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            policy_data: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            runtime_template: pulumi.Input[Optional[_builtins.str]] = None) -> 'RuntimeTemplateIamPolicy':
        """
