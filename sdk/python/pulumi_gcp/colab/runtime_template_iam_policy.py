...
class RuntimeTemplateIamPolicyArgs:
    def __init__(__self__, *,
                 ...
                 runtime_template: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] runtime_template: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[builtins.str] location: The location for the resource: https://cloud.google.com/colab/docs/locations Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    def runtime_template(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def runtime_template(self, value: pulumi.Input[builtins.str]):
...
class _RuntimeTemplateIamPolicyState:
    ...
    @property
    @pulumi.getter(name="runtimeTemplate")
    def runtime_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "runtime_template")
    ...
    @runtime_template.setter
    def runtime_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "runtime_template", value)
...
class RuntimeTemplateIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_data: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            runtime_template: Optional[pulumi.Input[builtins.str]] = None) -> 'RuntimeTemplateIamPolicy':
        """
    ...
    @property
    @pulumi.getter(name="runtimeTemplate")
    def runtime_template(self) -> pulumi.Output[builtins.str]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "runtime_template")
