...
if not MYPY:
    class NotebookExecutionDataformRepositorySourceArgsDict(TypedDict):
        dataform_repository_resource_name: pulumi.Input[builtins.str]
        """
...
class NotebookExecutionDataformRepositorySourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dataform_repository_resource_name: The resource name of the Dataform Repository.
        :param pulumi.Input[builtins.str] commit_sha: The commit SHA to read repository with. If unset, the file will be read at HEAD.
        """
    ...
    def dataform_repository_resource_name(self) -> pulumi.Input[builtins.str]:
        """
        The resource name of the Dataform Repository.
        """
    ...
    def dataform_repository_resource_name(self, value: pulumi.Input[builtins.str]):
...
class NotebookExecutionDirectNotebookSourceArgs:
    def __init__(__self__, *,
                 content: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] content: The base64-encoded contents of the input notebook file.
        """
...
class NotebookExecutionGcsNotebookSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] uri: The Cloud Storage uri pointing to the ipynb file.
        :param pulumi.Input[builtins.str] generation: The version of the Cloud Storage object to read. If unset, the current version of the object is read. See https://cloud.google.com/storage/docs/metadata#generation-number.
        """
...
if not MYPY:
    class RuntimeNotebookRuntimeTemplateRefArgsDict(TypedDict):
        notebook_runtime_template: pulumi.Input[builtins.str]
        """
...
class RuntimeNotebookRuntimeTemplateRefArgs:
    def __init__(__self__, *,
                 notebook_runtime_template: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] notebook_runtime_template: The resource name of the NotebookRuntimeTemplate based on which a NotebookRuntime will be created.
        """
        pulumi.set(__self__, "notebook_runtime_template", notebook_runtime_template)

    @property
    @pulumi.getter(name="notebookRuntimeTemplate")
    def notebook_runtime_template(self) -> pulumi.Input[builtins.str]:
        """
        The resource name of the NotebookRuntimeTemplate based on which a NotebookRuntime will be created.
        """
    ...
    def notebook_runtime_template(self, value: pulumi.Input[builtins.str]):
...
class RuntimeTemplateDataPersistentDiskSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] disk_size_gb: The disk size of the runtime in GB. If specified, the diskType must also be specified. The minimum size is 10GB and the maximum is 65536GB.
        :param pulumi.Input[builtins.str] disk_type: The type of the persistent disk.
        """
...
class RuntimeTemplateEncryptionSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_name: The Cloud KMS encryption key (customer-managed encryption key) used to protect the runtime.
        """
...
if not MYPY:
    class RuntimeTemplateEucConfigArgsDict(TypedDict):
        euc_disabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class RuntimeTemplateEucConfigArgs:
    def __init__(__self__, *,
                 euc_disabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] euc_disabled: Disable end user credential access for the runtime.
        """
    ...
    def euc_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Disable end user credential access for the runtime.
        """
    ...
    @euc_disabled.setter
    def euc_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RuntimeTemplateIdleShutdownConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] idle_timeout: The duration after which the runtime is automatically shut down. An input of 0s disables the idle shutdown feature, and a valid range is [10m, 24h].
        """
...
class RuntimeTemplateMachineSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] accelerator_count: The number of accelerators used by the runtime.
        :param pulumi.Input[builtins.str] accelerator_type: The type of hardware accelerator used by the runtime. If specified, acceleratorCount must also be specified.
        :param pulumi.Input[builtins.str] machine_type: The Compute Engine machine type selected for the runtime.
        """
...
class RuntimeTemplateNetworkSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_internet_access: Enable public internet access for the runtime.
        :param pulumi.Input[builtins.str] network: The name of the VPC that this runtime is in.
        :param pulumi.Input[builtins.str] subnetwork: The name of the subnetwork that this runtime is in.
        """
...
class RuntimeTemplateShieldedVmConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_secure_boot: Enables secure boot for the runtime.
        """
...
class RuntimeTemplateSoftwareConfigEnvArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of the environment variable. Must be a valid C identifier.
        :param pulumi.Input[builtins.str] value: Variables that reference a $(VAR_NAME) are expanded using the previous defined environment variables in the container and any service environment variables. If a variable cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded, regardless of whether the variable exists or not.
        """
        if name is not None:
...
if not MYPY:
    class RuntimeTemplateSoftwareConfigPostStartupScriptConfigArgsDict(TypedDict):
        post_startup_script: NotRequired[pulumi.Input[builtins.str]]
        """
        Post startup script to run after runtime is started.
        """
        post_startup_script_behavior: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        post_startup_script_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RuntimeTemplateSoftwareConfigPostStartupScriptConfigArgs:
    def __init__(__self__, *,
                 ...
                 post_startup_script_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 post_startup_script_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] post_startup_script: Post startup script to run after runtime is started.
        :param pulumi.Input[builtins.str] post_startup_script_behavior: Post startup script behavior that defines download and execution behavior.
               Possible values are: `RUN_ONCE`, `RUN_EVERY_START`, `DOWNLOAD_AND_RUN_EVERY_START`.
        :param pulumi.Input[builtins.str] post_startup_script_url: Post startup script url to download. Example: https://bucket/script.sh.
        """
    ...
    def post_startup_script_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Post startup script behavior that defines download and execution behavior.
        Possible values are: `RUN_ONCE`, `RUN_EVERY_START`, `DOWNLOAD_AND_RUN_EVERY_START`.
        """
    ...
    def post_startup_script_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "post_startup_script_behavior", value)

    @property
    @pulumi.getter(name="postStartupScriptUrl")
    def post_startup_script_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Post startup script url to download. Example: https://bucket/script.sh.
        """
    ...
    def post_startup_script_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobArgsDict(TypedDict):
        ...
        """
        notebook_runtime_template_resource_name: pulumi.Input[builtins.str]
        """
        ...
        """
        execution_user: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobDataformRepositorySourceArgs'] dataform_repository_source: The Dataform Repository containing the input notebook.
               Structure is documented below.
        :param pulumi.Input[builtins.str] execution_timeout: Max running time of the execution job in seconds (default 86400s / 24 hrs). A duration in seconds with up to nine fractional digits, ending with "s". Example: "3.5s".
    ...
    def notebook_runtime_template_resource_name(self) -> pulumi.Input[builtins.str]:
        """
        The NotebookRuntimeTemplate to source compute configuration from.
        """
    ...
    def notebook_runtime_template_resource_name(self, value: pulumi.Input[builtins.str]):
...
class ScheduleCreateNotebookExecutionJobRequestNotebookExecutionJobGcsNotebookSourceArgs:
    def __init__(__self__, *,
                 ...
                 generation: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] uri: The Cloud Storage uri pointing to the ipynb file. Format: gs://bucket/notebook_file.ipynb
        :param pulumi.Input[builtins.str] generation: The version of the Cloud Storage object to read. If unset, the current version of the object is read. See https://cloud.google.com/storage/docs/metadata#generation-number.
