...
def get_config_iam_policy(config: Optional[builtins.str] = None,
    ...
    :param builtins.str config: Used to find the parent resource to bind the IAM policy to
...
def get_config_iam_policy_output(config: Optional[pulumi.Input[builtins.str]] = None,
