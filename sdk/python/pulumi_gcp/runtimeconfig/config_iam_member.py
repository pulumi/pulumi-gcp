...
class ConfigIamMember(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, config=None, member=None, project=None, role=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a ConfigIamMember resource with the given unique name, props, and options.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, config=None, etag=None, member=None, project=None, role=None):
        """
