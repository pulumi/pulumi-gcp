...
class VariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] parent: The name of the RuntimeConfig resource containing this
               variable.
        :param pulumi.Input[builtins.str] name: The name of the variable to manage. Note that variable
               names can be hierarchical using slashes (e.g. "prod-variables/hostname").
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs. If it
               is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] text: or `value` - (Required) The content to associate with the variable.
...
class _VariableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] text: or `value` - (Required) The content to associate with the variable.
               ...
               - - -
        :param pulumi.Input[builtins.str] update_time: (Computed) The timestamp in RFC3339 UTC "Zulu" format,
