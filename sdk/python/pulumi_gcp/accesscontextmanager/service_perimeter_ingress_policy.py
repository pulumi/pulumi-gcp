...
class ServicePerimeterIngressPolicyArgs:
    ...
    def ingress_from(self) -> pulumi.Input[Optional['ServicePerimeterIngressPolicyIngressFromArgs']]:
        """
    ...
    @ingress_from.setter
    def ingress_from(self, value: pulumi.Input[Optional['ServicePerimeterIngressPolicyIngressFromArgs']]):
        pulumi.set(self, "ingress_from", value)

    @_builtins.property
    @pulumi.getter(name="ingressTo")
    def ingress_to(self) -> pulumi.Input[Optional['ServicePerimeterIngressPolicyIngressToArgs']]:
        """
    ...
    @ingress_to.setter
    def ingress_to(self, value: pulumi.Input[Optional['ServicePerimeterIngressPolicyIngressToArgs']]):
