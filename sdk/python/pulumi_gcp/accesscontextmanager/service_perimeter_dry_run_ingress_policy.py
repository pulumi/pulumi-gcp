...
class ServicePerimeterDryRunIngressPolicyArgs:
    def __init__(__self__, *,
                 ...
                 ingress_from: pulumi.Input[Optional['ServicePerimeterDryRunIngressPolicyIngressFromArgs']] = None,
                 ingress_to: pulumi.Input[Optional['ServicePerimeterDryRunIngressPolicyIngressToArgs']] = None,
    ...
    def ingress_from(self) -> pulumi.Input[Optional['ServicePerimeterDryRunIngressPolicyIngressFromArgs']]:
        """
    ...
    @ingress_from.setter
    def ingress_from(self, value: pulumi.Input[Optional['ServicePerimeterDryRunIngressPolicyIngressFromArgs']]):
        pulumi.set(self, "ingress_from", value)

    @_builtins.property
    @pulumi.getter(name="ingressTo")
    def ingress_to(self) -> pulumi.Input[Optional['ServicePerimeterDryRunIngressPolicyIngressToArgs']]:
        """
    ...
    @ingress_to.setter
    def ingress_to(self, value: pulumi.Input[Optional['ServicePerimeterDryRunIngressPolicyIngressToArgs']]):
...
@pulumi.type_token("gcp:accesscontextmanager/servicePerimeterDryRunIngressPolicy:ServicePerimeterDryRunIngressPolicy")
class ServicePerimeterDryRunIngressPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 ingress_from: pulumi.Input[Optional[Union['ServicePerimeterDryRunIngressPolicyIngressFromArgs', 'ServicePerimeterDryRunIngressPolicyIngressFromArgsDict', 'outputs.ServicePerimeterDryRunIngressPolicyIngressFrom']]] = None,
                 ingress_to: pulumi.Input[Optional[Union['ServicePerimeterDryRunIngressPolicyIngressToArgs', 'ServicePerimeterDryRunIngressPolicyIngressToArgsDict', 'outputs.ServicePerimeterDryRunIngressPolicyIngressTo']]] = None,
                 perimeter: pulumi.Input[Optional[_builtins.str]] = None,
                 title: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[Union['ServicePerimeterDryRunIngressPolicyIngressFromArgs', 'ServicePerimeterDryRunIngressPolicyIngressFromArgsDict', 'outputs.ServicePerimeterDryRunIngressPolicyIngressFrom']] ingress_from: Defines the conditions on the source of a request causing this `IngressPolicy`
               to apply.
               Structure is documented below.
        :param pulumi.Input[Union['ServicePerimeterDryRunIngressPolicyIngressToArgs', 'ServicePerimeterDryRunIngressPolicyIngressToArgsDict', 'outputs.ServicePerimeterDryRunIngressPolicyIngressTo']] ingress_to: Defines the conditions on the `ApiOperation` and request destination that cause
               this `IngressPolicy` to apply.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] perimeter: The name of the Service Perimeter to add this resource to.
        :param pulumi.Input[_builtins.str] title: Human readable title. Must be unique within the perimeter. Does not affect behavior.
    ...
    def get(resource_name: str,
            ...
            ingress_to: pulumi.Input[Optional[Union['ServicePerimeterDryRunIngressPolicyIngressToArgs', 'ServicePerimeterDryRunIngressPolicyIngressToArgsDict', 'outputs.ServicePerimeterDryRunIngressPolicyIngressTo']]] = None,
            perimeter: pulumi.Input[Optional[_builtins.str]] = None,
            title: pulumi.Input[Optional[_builtins.str]] = None) -> 'ServicePerimeterDryRunIngressPolicy':
        """
