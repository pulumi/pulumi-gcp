...
class ServicePerimeterEgressPolicyArgs:
    def __init__(__self__, *,
                 ...
                 egress_from: pulumi.Input[Optional['ServicePerimeterEgressPolicyEgressFromArgs']] = None,
                 egress_to: pulumi.Input[Optional['ServicePerimeterEgressPolicyEgressToArgs']] = None,
    ...
    def egress_from(self) -> pulumi.Input[Optional['ServicePerimeterEgressPolicyEgressFromArgs']]:
        """
    ...
    @egress_from.setter
    def egress_from(self, value: pulumi.Input[Optional['ServicePerimeterEgressPolicyEgressFromArgs']]):
        pulumi.set(self, "egress_from", value)

    @_builtins.property
    @pulumi.getter(name="egressTo")
    def egress_to(self) -> pulumi.Input[Optional['ServicePerimeterEgressPolicyEgressToArgs']]:
        """
    ...
    @egress_to.setter
    def egress_to(self, value: pulumi.Input[Optional['ServicePerimeterEgressPolicyEgressToArgs']]):
...
class ServicePerimeterEgressPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 egress_from: pulumi.Input[Optional[Union['ServicePerimeterEgressPolicyEgressFromArgs', 'ServicePerimeterEgressPolicyEgressFromArgsDict', 'outputs.ServicePerimeterEgressPolicyEgressFrom']]] = None,
                 egress_to: pulumi.Input[Optional[Union['ServicePerimeterEgressPolicyEgressToArgs', 'ServicePerimeterEgressPolicyEgressToArgsDict', 'outputs.ServicePerimeterEgressPolicyEgressTo']]] = None,
                 perimeter: pulumi.Input[Optional[_builtins.str]] = None,
                 title: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * How-to Guides
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[Union['ServicePerimeterEgressPolicyEgressFromArgs', 'ServicePerimeterEgressPolicyEgressFromArgsDict', 'outputs.ServicePerimeterEgressPolicyEgressFrom']] egress_from: Defines conditions on the source of a request causing this `EgressPolicy` to apply.
               Structure is documented below.
        :param pulumi.Input[Union['ServicePerimeterEgressPolicyEgressToArgs', 'ServicePerimeterEgressPolicyEgressToArgsDict', 'outputs.ServicePerimeterEgressPolicyEgressTo']] egress_to: Defines the conditions on the `ApiOperation` and destination resources that
               cause this `EgressPolicy` to apply.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] perimeter: The name of the Service Perimeter to add this resource to.
        :param pulumi.Input[_builtins.str] title: Human readable title. Must be unique within the perimeter. Does not affect behavior.
    ...
    def get(resource_name: str,
            ...
            etag: pulumi.Input[Optional[_builtins.str]] = None,
            perimeter: pulumi.Input[Optional[_builtins.str]] = None,
            title: pulumi.Input[Optional[_builtins.str]] = None) -> 'ServicePerimeterEgressPolicy':
        """
