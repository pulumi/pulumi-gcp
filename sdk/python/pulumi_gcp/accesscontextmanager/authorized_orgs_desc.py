...
class AuthorizedOrgsDescArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] authorization_direction: The direction of the authorization relationship between this organization
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] orgs: The list of organization ids in this AuthorizedOrgsDesc.
...
class _AuthorizedOrgsDescState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] orgs: The list of organization ids in this AuthorizedOrgsDesc.
               ...
               Example: `organizations/123456`
        :param pulumi.Input[_builtins.str] parent: Required. Resource name for the access policy which owns this `AuthorizedOrgsDesc`.
        :param pulumi.Input[_builtins.str] update_time: Time the AuthorizedOrgsDesc was updated in UTC.
        """
        if asset_type is not None:
            pulumi.set(__self__, "asset_type", asset_type)
        if authorization_direction is not None:
