...
class IngressPolicyArgs:
    def __init__(__self__, *,
                 ingress_policy_name: pulumi.Input[builtins.str],
                 resource: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a IngressPolicy resource.
        :param pulumi.Input[builtins.str] ingress_policy_name: The name of the Service Perimeter to add this resource to.
    ...
    def ingress_policy_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ingress_policy_name(self, value: pulumi.Input[builtins.str]):
...
class _IngressPolicyState:
    def __init__(__self__, *,
                 ...
                 ingress_policy_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ingressPolicyName")
    def ingress_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Service Perimeter to add this resource to.
    ...
    @ingress_policy_name.setter
    def ingress_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingress_policy_name", value)
...
class IngressPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            access_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            ingress_policy_name: Optional[pulumi.Input[builtins.str]] = None,
            resource: Optional[pulumi.Input[builtins.str]] = None) -> 'IngressPolicy':
        """
    ...
    @property
    @pulumi.getter(name="ingressPolicyName")
    def ingress_policy_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Service Perimeter to add this resource to.
