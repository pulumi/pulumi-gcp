...
if not MYPY:
    class AccessLevelBasicArgsDict(TypedDict):
        ...
        """
        combining_function: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AccessLevelBasicArgs:
    def __init__(__self__, *,
                 ...
                 combining_function: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['AccessLevelBasicConditionArgs']]] conditions: A set of requirements for the AccessLevel to be granted.
               Structure is documented below.
        :param pulumi.Input[builtins.str] combining_function: How the conditions list should be combined to determine if a request
               is granted this AccessLevel. If AND is used, each Condition in
               conditions must be satisfied for the AccessLevel to be applied. If
               OR is used, at least one Condition in conditions must be satisfied
               for the AccessLevel to be applied.
    ...
    def combining_function(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        How the conditions list should be combined to determine if a request
        is granted this AccessLevel. If AND is used, each Condition in
        conditions must be satisfied for the AccessLevel to be applied. If
    ...
    def combining_function(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AccessLevelBasicConditionArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        ip_subnetworks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        required_access_levels: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AccessLevelBasicConditionArgs:
    def __init__(__self__, *,
                 ...
                 ip_subnetworks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 required_access_levels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input['AccessLevelBasicConditionDevicePolicyArgs'] device_policy: Device specific restrictions, all restrictions must hold for
               ...
               allowed.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_subnetworks: A list of CIDR block IP subnetwork specification. May be IPv4
               or IPv6.
               Note that for a CIDR IP address block, the specified IP address
               portion must be properly truncated (i.e. all the host bits must
               be zero) or the input is considered malformed. For example,
               ...
               listed subnets in order for this Condition to be true.
               If empty, all IP addresses are allowed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: An allowed list of members (users, service accounts).
               Using groups is not supported yet.
               The signed-in user originating the request must be a part of one
               of the provided members. If not specified, a request may come
               from any user (logged in/not logged in, not present in any
               groups, etc.).
               Formats: `user:{emailid}`, `serviceAccount:{emailid}`
        :param pulumi.Input[builtins.bool] negate: Whether to negate the Condition. If true, the Condition becomes
               a NAND over its non-empty fields, each field must be false for
               the Condition overall to be satisfied. Defaults to false.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: The request must originate from one of the provided
               countries/regions.
               Format: A valid ISO 3166-1 alpha-2 code.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] required_access_levels: A list of other access levels defined in the same Policy,
               referenced by resource name. Referencing an AccessLevel which
               does not exist is an error. All access levels listed must be
               granted for the Condition to be true.
               Format: accessPolicies/{policy_id}/accessLevels/{short_name}
    ...
    def ip_subnetworks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of CIDR block IP subnetwork specification. May be IPv4
        or IPv6.
        Note that for a CIDR IP address block, the specified IP address
    ...
    def ip_subnetworks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def required_access_levels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of other access levels defined in the same Policy,
        referenced by resource name. Referencing an AccessLevel which
        does not exist is an error. All access levels listed must be
    ...
    def required_access_levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AccessLevelBasicConditionDevicePolicyArgsDict(TypedDict):
        allowed_device_management_levels: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of allowed device management levels.
        An empty list allows all management levels.
        Each value may be one of: `MANAGEMENT_UNSPECIFIED`, `NONE`, `BASIC`, `COMPLETE`.
        """
        allowed_encryption_statuses: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        Structure is documented below.
        """
        require_admin_approval: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the device needs to be approved by the customer admin.
        """
        require_corp_owned: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the device needs to be corp owned.
        """
        require_screen_lock: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AccessLevelBasicConditionDevicePolicyArgs:
    def __init__(__self__, *,
                 allowed_device_management_levels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 allowed_encryption_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 os_constraints: Optional[pulumi.Input[Sequence[pulumi.Input['AccessLevelBasicConditionDevicePolicyOsConstraintArgs']]]] = None,
                 require_admin_approval: Optional[pulumi.Input[builtins.bool]] = None,
                 require_corp_owned: Optional[pulumi.Input[builtins.bool]] = None,
                 require_screen_lock: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_device_management_levels: A list of allowed device management levels.
               An empty list allows all management levels.
               Each value may be one of: `MANAGEMENT_UNSPECIFIED`, `NONE`, `BASIC`, `COMPLETE`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_encryption_statuses: A list of allowed encryptions statuses.
               An empty list allows all statuses.
               Each value may be one of: `ENCRYPTION_UNSPECIFIED`, `ENCRYPTION_UNSUPPORTED`, `UNENCRYPTED`, `ENCRYPTED`.
        :param pulumi.Input[Sequence[pulumi.Input['AccessLevelBasicConditionDevicePolicyOsConstraintArgs']]] os_constraints: A list of allowed OS versions.
               An empty list allows all types and all versions.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] require_admin_approval: Whether the device needs to be approved by the customer admin.
        :param pulumi.Input[builtins.bool] require_corp_owned: Whether the device needs to be corp owned.
        :param pulumi.Input[builtins.bool] require_screen_lock: Whether or not screenlock is required for the DevicePolicy
               to be true. Defaults to false.
        """
    ...
    def allowed_device_management_levels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of allowed device management levels.
        An empty list allows all management levels.
        Each value may be one of: `MANAGEMENT_UNSPECIFIED`, `NONE`, `BASIC`, `COMPLETE`.
    ...
    def allowed_device_management_levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_device_management_levels", value)

    @property
    @pulumi.getter(name="allowedEncryptionStatuses")
    def allowed_encryption_statuses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of allowed encryptions statuses.
        An empty list allows all statuses.
        Each value may be one of: `ENCRYPTION_UNSPECIFIED`, `ENCRYPTION_UNSUPPORTED`, `UNENCRYPTED`, `ENCRYPTED`.
    ...
    def allowed_encryption_statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def require_admin_approval(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the device needs to be approved by the customer admin.
        """
    ...
    def require_admin_approval(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_admin_approval", value)

    @property
    @pulumi.getter(name="requireCorpOwned")
    def require_corp_owned(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the device needs to be corp owned.
        """
    ...
    def require_corp_owned(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "require_corp_owned", value)

    @property
    @pulumi.getter(name="requireScreenLock")
    def require_screen_lock(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether or not screenlock is required for the DevicePolicy
        to be true. Defaults to false.
        """
    ...
    def require_screen_lock(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class AccessLevelBasicConditionDevicePolicyOsConstraintArgsDict(TypedDict):
        ...
        """
        minimum_version: NotRequired[pulumi.Input[builtins.str]]
        """
        The minimum allowed OS version. If not set, any version
        of this OS satisfies the constraint.
        Format: "major.minor.patch" such as "10.5.301", "9.2.1".
        """
        require_verified_chrome_os: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AccessLevelBasicConditionDevicePolicyOsConstraintArgs:
    def __init__(__self__, *,
                 os_type: pulumi.Input[builtins.str],
                 minimum_version: Optional[pulumi.Input[builtins.str]] = None,
                 require_verified_chrome_os: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] os_type: The operating system type of the device.
               Possible values are: `OS_UNSPECIFIED`, `DESKTOP_MAC`, `DESKTOP_WINDOWS`, `DESKTOP_LINUX`, `DESKTOP_CHROME_OS`, `ANDROID`, `IOS`.
        :param pulumi.Input[builtins.str] minimum_version: The minimum allowed OS version. If not set, any version
               of this OS satisfies the constraint.
               Format: "major.minor.patch" such as "10.5.301", "9.2.1".
        :param pulumi.Input[builtins.bool] require_verified_chrome_os: If you specify DESKTOP_CHROME_OS for osType, you can optionally include requireVerifiedChromeOs to require Chrome Verified Access.
        """
    ...
    def minimum_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The minimum allowed OS version. If not set, any version
        of this OS satisfies the constraint.
        Format: "major.minor.patch" such as "10.5.301", "9.2.1".
    ...
    def minimum_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "minimum_version", value)

    @property
    @pulumi.getter(name="requireVerifiedChromeOs")
    def require_verified_chrome_os(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If you specify DESKTOP_CHROME_OS for osType, you can optionally include requireVerifiedChromeOs to require Chrome Verified Access.
        """
    ...
    def require_verified_chrome_os(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class AccessLevelBasicConditionVpcNetworkSourceVpcSubnetworkArgsDict(TypedDict):
        ...
        """
        vpc_ip_subnetworks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AccessLevelBasicConditionVpcNetworkSourceVpcSubnetworkArgs:
    def __init__(__self__, *,
                 network: pulumi.Input[builtins.str],
                 vpc_ip_subnetworks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] network: Required. Network name to be allowed by this Access Level. Networks of foreign organizations requires `compute.network.get` permission to be granted to caller.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_ip_subnetworks: A list of CIDR block IP subnetwork specification. Must be IPv4.
        """
    ...
    def vpc_ip_subnetworks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of CIDR block IP subnetwork specification. Must be IPv4.
        """
    ...
    def vpc_ip_subnetworks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AccessLevelConditionVpcNetworkSourceVpcSubnetworkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] network: Required. Network name to be allowed by this Access Level. Networks of foreign organizations requires `compute.network.get` permission to be granted to caller.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_ip_subnetworks: CIDR block IP subnetwork specification. Must be IPv4.
        """
        pulumi.set(__self__, "network", network)
        if vpc_ip_subnetworks is not None:
            pulumi.set(__self__, "vpc_ip_subnetworks", vpc_ip_subnetworks)
...
if not MYPY:
    class ServicePerimeterDryRunEgressPolicyEgressFromArgsDict(TypedDict):
        ...
        """
        source_restriction: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServicePerimeterDryRunEgressPolicyEgressFromArgs:
    def __init__(__self__, *,
                 ...
                 source_restriction: Optional[pulumi.Input[builtins.str]] = None,
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input['ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identities: Identities can be an individual user, service account, Google group,
               or third-party identity. For third-party identity, only single identities
               are supported and other identity types are not supported.The v1 identities
               that have the prefix user, group and serviceAccount in
               https://cloud.google.com/iam/docs/principal-identifiers#v1 are supported.
        :param pulumi.Input[builtins.str] identity_type: Specifies the type of identities that are allowed access to outside the
               perimeter. If left unspecified, then members of `identities` field will
               be allowed access.
               Possible values are: `ANY_IDENTITY`, `ANY_USER_ACCOUNT`, `ANY_SERVICE_ACCOUNT`.
        :param pulumi.Input[builtins.str] source_restriction: Whether to enforce traffic restrictions based on `sources` field. If the `sources` field is non-empty, then this field must be set to `SOURCE_RESTRICTION_ENABLED`.
               Possible values are: `SOURCE_RESTRICTION_ENABLED`, `SOURCE_RESTRICTION_DISABLED`.
    ...
    def source_restriction(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to enforce traffic restrictions based on `sources` field. If the `sources` field is non-empty, then this field must be set to `SOURCE_RESTRICTION_ENABLED`.
        Possible values are: `SOURCE_RESTRICTION_ENABLED`, `SOURCE_RESTRICTION_DISABLED`.
        """
    ...
    def source_restriction(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServicePerimeterDryRunEgressPolicyEgressFromSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] access_level: An AccessLevel resource name that allows resources outside the ServicePerimeter to be accessed from the inside.
        :param pulumi.Input[builtins.str] resource: A Google Cloud resource that is allowed to egress the perimeter.
               Requests from these resources are allowed to access data outside the perimeter.
               Currently only projects are allowed. Project format: `projects/{project_number}`.
               The resource may be in any Google Cloud organization, not just the
               organization that the perimeter is defined in. `*` is not allowed, the
...
if not MYPY:
    class ServicePerimeterDryRunEgressPolicyEgressToArgsDict(TypedDict):
        external_resources: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ServicePerimeterDryRunEgressPolicyEgressToArgs:
    def __init__(__self__, *,
                 external_resources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_resources: A list of external resources that are allowed to be accessed. A request
               matches if it contains an external resource in this list (Example:
               s3://bucket/path). Currently '*' is not allowed.
        :param pulumi.Input[Sequence[pulumi.Input['ServicePerimeterDryRunEgressPolicyEgressToOperationArgs']]] operations: A list of `ApiOperations` that this egress rule applies to. A request matches
               if it contains an operation/service in this list.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: A list of resources, currently only projects in the form
               `projects/<projectnumber>`, that match this to stanza. A request matches
               if it contains a resource in this list. If * is specified for resources,
               then this `EgressTo` rule will authorize access to all resources outside
               the perimeter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: A list of IAM roles that represent the set of operations that the sources
               specified in the corresponding `EgressFrom`
               are allowed to perform.
        """
    ...
    def external_resources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of external resources that are allowed to be accessed. A request
        matches if it contains an external resource in this list (Example:
        s3://bucket/path). Currently '*' is not allowed.
    ...
    def external_resources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ServicePerimeterDryRunEgressPolicyEgressToOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServicePerimeterDryRunEgressPolicyEgressToOperationMethodSelectorArgs']]] method_selectors: API methods or permissions to allow. Method or permission must belong
               ...
               AND permissions for the service specified in `serviceName`.
               Structure is documented below.
        :param pulumi.Input[builtins.str] service_name: The name of the API whose methods or permissions the `IngressPolicy` or
               `EgressPolicy` want to allow. A single `ApiOperation` with serviceName
               field set to `*` will allow all methods AND permissions for all services.
        """
...
class ServicePerimeterDryRunEgressPolicyEgressToOperationMethodSelectorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] method: Value for `method` should be a valid method name for the corresponding
               `serviceName` in `ApiOperation`. If `*` used as value for method,
               then ALL methods and permissions are allowed.
        :param pulumi.Input[builtins.str] permission: Value for permission should be a valid Cloud IAM permission for the
               corresponding `serviceName` in `ApiOperation`.
        """
...
class ServicePerimeterDryRunIngressPolicyIngressFromArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identities: Identities can be an individual user, service account, Google group,
               ...
               that have the prefix user, group and serviceAccount in
               https://cloud.google.com/iam/docs/principal-identifiers#v1 are supported.
        :param pulumi.Input[builtins.str] identity_type: Specifies the type of identities that are allowed access from outside the
               perimeter. If left unspecified, then members of `identities` field will be
               allowed access.
               Possible values are: `ANY_IDENTITY`, `ANY_USER_ACCOUNT`, `ANY_SERVICE_ACCOUNT`.
...
class ServicePerimeterDryRunIngressPolicyIngressFromSourceArgs:
    def __init__(__self__, *,
                 ...
                 resource: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] access_level: An `AccessLevel` resource name that allow resources within the
               `ServicePerimeters` to be accessed from the internet. `AccessLevels` listed
               must be in the same policy as this `ServicePerimeter`. Referencing a nonexistent
               `AccessLevel` will cause an error. If no `AccessLevel` names are listed,
               resources within the perimeter can only be accessed via Google Cloud calls
               ...
               Example `accessPolicies/MY_POLICY/accessLevels/MY_LEVEL.`
               If * is specified, then all IngressSources will be allowed.
        :param pulumi.Input[builtins.str] resource: A Google Cloud resource that is allowed to ingress the perimeter.
               Requests from these resources will be allowed to access perimeter data.
               Currently only projects are allowed. Format `projects/{project_number}`
               The project may be in any Google Cloud organization, not just the
               organization that the perimeter is defined in. `*` is not allowed, the case
...
if not MYPY:
    class ServicePerimeterSpecArgsDict(TypedDict):
        ...
        """
        restricted_services: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ServicePerimeterSpecArgs:
    def __init__(__self__, *,
                 ...
                 resources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 restricted_services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 vpc_accessible_services: Optional[pulumi.Input['ServicePerimeterSpecVpcAccessibleServicesArgs']] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] access_levels: A list of AccessLevel resource names that allow resources within
               the ServicePerimeter to be accessed from the internet.
               AccessLevels listed must be in the same policy as this
               ServicePerimeter. Referencing a nonexistent AccessLevel is a
               syntax error. If no AccessLevel names are listed, resources within
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServicePerimeterSpecIngressPolicyArgs']]] ingress_policies: List of `IngressPolicies` to apply to the perimeter. A perimeter may
               ...
               Must be empty for a perimeter bridge.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: A list of GCP resources that are inside of the service perimeter.
               Currently only projects are allowed.
               Format: projects/{project_number}
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] restricted_services: GCP services that are subject to the Service Perimeter
               restrictions. Must contain a list of services. For example, if
               `storage.googleapis.com` is specified, access to the storage
               buckets inside the perimeter must meet the perimeter's access
               restrictions.
    ...
    def restricted_services(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        GCP services that are subject to the Service Perimeter
        restrictions. Must contain a list of services. For example, if
        `storage.googleapis.com` is specified, access to the storage
    ...
    def restricted_services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ServicePerimeterSpecEgressPolicyEgressFromArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identities: A list of identities that are allowed access through this `EgressPolicy`.
               Should be in the format of email address. The email address should
               represent individual user or service account only.
        :param pulumi.Input[builtins.str] identity_type: Specifies the type of identities that are allowed access to outside the
               perimeter. If left unspecified, then members of `identities` field will
...
class ServicePerimeterSpecIngressPolicyIngressFromArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identities: A list of identities that are allowed access through this ingress policy.
               Should be in the format of email address. The email address should represent
               individual user or service account only.
        :param pulumi.Input[builtins.str] identity_type: Specifies the type of identities that are allowed access from outside the
               perimeter. If left unspecified, then members of `identities` field will be
...
if not MYPY:
    class ServicePerimeterSpecVpcAccessibleServicesArgsDict(TypedDict):
        ...
        """
        enable_restriction: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServicePerimeterSpecVpcAccessibleServicesArgs:
    def __init__(__self__, *,
                 ...
                 enable_restriction: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_services: The list of APIs usable within the Service Perimeter.
               Must be empty unless `enableRestriction` is True.
        :param pulumi.Input[builtins.bool] enable_restriction: Whether to restrict API calls within the Service Perimeter to the
               list of APIs specified in 'allowedServices'.
        """
    ...
    def enable_restriction(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to restrict API calls within the Service Perimeter to the
        list of APIs specified in 'allowedServices'.
        """
    ...
    def enable_restriction(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ServicePerimetersServicePerimeterArgsDict(TypedDict):
        ...
        behavior.
        """
        perimeter_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        use_explicit_dry_run_spec: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServicePerimetersServicePerimeterArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 perimeter_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 use_explicit_dry_run_spec: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] create_time: (Output)
               Time the AccessPolicy was created in UTC.
        :param pulumi.Input[builtins.str] description: Description of the ServicePerimeter and its use. Does not affect
               behavior.
        ...
        :param pulumi.Input[builtins.str] update_time: (Output)
               Time the AccessPolicy was updated in UTC.
        :param pulumi.Input[builtins.bool] use_explicit_dry_run_spec: Use explicit dry run spec flag. Ordinarily, a dry-run spec implicitly exists
               for all Service Perimeters, and that spec is identical to the status for those
               Service Perimeters. When this flag is set, it inhibits the generation of the
               implicit spec, thereby allowing the user to explicitly provide a
               configuration ("spec") to use in a dry-run version of the Service Perimeter.
    ...
    def perimeter_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the type of the Perimeter. There are two types: regular and
        bridge. Regular Service Perimeter contains resources, access levels,
        and restricted services. Every resource can be in at most
    ...
    def perimeter_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_explicit_dry_run_spec(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Use explicit dry run spec flag. Ordinarily, a dry-run spec implicitly exists
        for all Service Perimeters, and that spec is identical to the status for those
        Service Perimeters. When this flag is set, it inhibits the generation of the
    ...
    def use_explicit_dry_run_spec(self, value: Optional[pulumi.Input[builtins.bool]]):
