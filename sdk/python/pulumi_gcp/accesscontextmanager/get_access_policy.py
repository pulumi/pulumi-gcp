...
def get_access_policy(parent: Optional[_builtins.str] = None,
    ...
    :param _builtins.str parent: The parent of this AccessPolicy in the Cloud Resource Hierarchy. Format: `organizations/{{organization_id}}`
    :param Sequence[_builtins.str] scopes: Folder or project on which this policy is applicable. Format: `folders/{{folder_id}}` or `projects/{{project_number}}`
    """
    __args__ = dict()
...
def get_access_policy_output(parent: Optional[pulumi.Input[_builtins.str]] = None,
