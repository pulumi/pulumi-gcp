...
class AccessLevelConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_level: The name of the Access Level to add this condition to.
...
class AccessLevelCondition(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ipSubnetworks")
    def ip_subnetworks(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of CIDR block IP subnetwork specification. May be IPv4
        or IPv6.
        Note that for a CIDR IP address block, the specified IP address
    ...
    @property
    @pulumi.getter(name="requiredAccessLevels")
    def required_access_levels(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of other access levels defined in the same Policy,
        referenced by resource name. Referencing an AccessLevel which
        does not exist is an error. All access levels listed must be
