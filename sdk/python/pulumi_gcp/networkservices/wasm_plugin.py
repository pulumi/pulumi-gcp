...
class WasmPluginArgs:
    def __init__(__self__, *,
                 ...
                 log_config: pulumi.Input[Optional['WasmPluginLogConfigArgs']] = None,
    ...
    def log_config(self) -> pulumi.Input[Optional['WasmPluginLogConfigArgs']]:
        """
    ...
    @log_config.setter
    def log_config(self, value: pulumi.Input[Optional['WasmPluginLogConfigArgs']]):
...
class _WasmPluginState:
    def __init__(__self__, *,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 log_config: pulumi.Input[Optional['WasmPluginLogConfigArgs']] = None,
                 main_version_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 update_time: pulumi.Input[Optional[_builtins.str]] = None,
                 used_bies: pulumi.Input[Optional[Sequence[pulumi.Input['WasmPluginUsedByArgs']]]] = None,
                 versions: pulumi.Input[Optional[Sequence[pulumi.Input['WasmPluginVersionArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="mainVersionId")
    def main_version_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ID of the WasmPluginVersion resource that is the currently serving one. The version referred to must be a child of this WasmPlugin resource and should be listed in the "versions" field.
        """
        return pulumi.get(self, "main_version_id")
    ...
    @main_version_id.setter
    def main_version_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "main_version_id", value)
    ...
    def used_bies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WasmPluginUsedByArgs']]]]:
        """
    ...
    @used_bies.setter
    def used_bies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WasmPluginUsedByArgs']]]]):
        pulumi.set(self, "used_bies", value)

    @_builtins.property
    @pulumi.getter
    def versions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WasmPluginVersionArgs']]]]:
        """
        All versions of this WasmPlugin resource in the key-value format. The key is the resource ID, and the value is the VersionDetails object.
        Structure is documented below.
        """
    ...
    @versions.setter
    def versions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WasmPluginVersionArgs']]]]):
        pulumi.set(self, "versions", value)
...
class WasmPlugin(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 log_config: pulumi.Input[Optional[Union['WasmPluginLogConfigArgs', 'WasmPluginLogConfigArgsDict', 'outputs.WasmPluginLogConfig']]] = None,
                 main_version_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 versions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WasmPluginVersionArgs', 'WasmPluginVersionArgsDict', 'outputs.WasmPluginVersion']]]]] = None,
                 __props__=None):
        """
        ...
        * `{{location}}/{{name}}`
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Optional. Set of labels associated with the WasmPlugin resource.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location of the traffic extension
        :param pulumi.Input[Union['WasmPluginLogConfigArgs', 'WasmPluginLogConfigArgsDict', 'outputs.WasmPluginLogConfig']] log_config: Optional. Specifies the logging options for the activity performed by this plugin. If logging is enabled, plugin logs are exported to Cloud Logging.
               Note that the settings relate to the logs generated by using logging statements in your Wasm code.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] main_version_id: The ID of the WasmPluginVersion resource that is the currently serving one. The version referred to must be a child of this WasmPlugin resource and should be listed in the "versions" field.
        :param pulumi.Input[_builtins.str] name: Identifier. Name of the WasmPlugin resource.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WasmPluginVersionArgs', 'WasmPluginVersionArgsDict', 'outputs.WasmPluginVersion']]]] versions: All versions of this WasmPlugin resource in the key-value format. The key is the resource ID, and the value is the VersionDetails object.
               Structure is documented below.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None,
            used_bies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WasmPluginUsedByArgs', 'WasmPluginUsedByArgsDict', 'outputs.WasmPluginUsedBy']]]]] = None,
            versions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WasmPluginVersionArgs', 'WasmPluginVersionArgsDict', 'outputs.WasmPluginVersion']]]]] = None) -> 'WasmPlugin':
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
                and default labels configured on the provider.
        :param pulumi.Input[_builtins.str] update_time: Output only. The timestamp when the resource was updated.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WasmPluginUsedByArgs', 'WasmPluginUsedByArgsDict', 'outputs.WasmPluginUsedBy']]]] used_bies: Output only. List of all extensions that use this WasmPlugin resource.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WasmPluginVersionArgs', 'WasmPluginVersionArgsDict', 'outputs.WasmPluginVersion']]]] versions: All versions of this WasmPlugin resource in the key-value format. The key is the resource ID, and the value is the VersionDetails object.
               Structure is documented below.
        """
