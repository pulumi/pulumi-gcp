...
class EdgeCacheServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] disable_http2: Disables HTTP/2.
        ...
        :param pulumi.Input[builtins.str] edge_security_policy: Resource URL that points at the Cloud Armor edge security policy that is applied on each request against the EdgeCacheService.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] edge_ssl_certificates: URLs to sslCertificate resources that are used to authenticate connections between users and the EdgeCacheService.
        ...
        :param pulumi.Input[builtins.bool] require_tls: Require TLS (HTTPS) for all clients connecting to this service.
               Clients who connect over HTTP (port 80) will receive a HTTP 301 to the same URL over HTTPS (port 443).
               You must have at least one (1) edgeSslCertificate specified to enable this.
        :param pulumi.Input[builtins.str] ssl_policy: URL of the SslPolicy resource that will be associated with the EdgeCacheService.
