...
class LbRouteExtensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The location of the route extension
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Set of labels associated with the LbRouteExtension resource.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] name: Name of the LbRouteExtension resource in the following format: projects/{project}/locations/{location}/lbRouteExtensions/{lbRouteExtension}
...
class _LbRouteExtensionState:
    def __init__(__self__, *,
                 ...
                 extension_chains: pulumi.Input[Optional[Sequence[pulumi.Input['LbRouteExtensionExtensionChainArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="extensionChains")
    def extension_chains(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LbRouteExtensionExtensionChainArgs']]]]:
        """
        A set of ordered extension chains that contain the match conditions and extensions to execute.
        Match conditions for each extension chain are evaluated in sequence for a given request.
        The first extension chain that has a condition that matches the request is executed.
    ...
    @extension_chains.setter
    def extension_chains(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LbRouteExtensionExtensionChainArgs']]]]):
        pulumi.set(self, "extension_chains", value)
...
class LbRouteExtension(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 extension_chains: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LbRouteExtensionExtensionChainArgs', 'LbRouteExtensionExtensionChainArgsDict', 'outputs.LbRouteExtensionExtensionChain']]]]] = None,
                 forwarding_rules: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 load_balancing_scheme: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{location}}/{{name}}`
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] description: A human-readable description of the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LbRouteExtensionExtensionChainArgs', 'LbRouteExtensionExtensionChainArgsDict', 'outputs.LbRouteExtensionExtensionChain']]]] extension_chains: A set of ordered extension chains that contain the match conditions and extensions to execute.
               Match conditions for each extension chain are evaluated in sequence for a given request.
               The first extension chain that has a condition that matches the request is executed.
               Any subsequent extension chains do not execute. Limited to 5 extension chains per resource.
               Further information can be found at https://cloud.google.com/service-extensions/docs/reference/rest/v1/ExtensionChain
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'LbRouteExtension':
        """
