...
class LbTrafficExtensionArgs:
    def __init__(__self__, *,
                 ...
                 forwarding_rules: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] location: The location of the traffic extension
        :param pulumi.Input[builtins.str] description: A human-readable description of the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Set of labels associated with the LbTrafficExtension resource. **Note**: This field is non-authoritative, and will only
               manage the labels present in your configuration. Please refer to the field 'effective_labels' for all of the labels
               present on the resource.
        :param pulumi.Input[builtins.str] load_balancing_scheme: All backend services and forwarding rules referenced by this extension must share the same load balancing scheme. For
        ...
        :param pulumi.Input[builtins.str] name: Name of the LbTrafficExtension resource in the following format: projects/{project}/locations/{location}/lbTrafficExtensions/{lbTrafficExtension}.
        """
    ...
    def forwarding_rules(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def forwarding_rules(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _LbTrafficExtensionState:
    def __init__(__self__, *,
                 ...
                 forwarding_rules: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 load_balancing_scheme: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="forwardingRules")
    def forwarding_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of references to the forwarding rules to which this service extension is attached to.
        At least one forwarding rule is required. There can be only one LBTrafficExtension resource per forwarding rule.
        """
    ...
    @forwarding_rules.setter
    def forwarding_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "forwarding_rules", value)
...
class LbTrafficExtension(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:networkservices/lbTrafficExtension:LbTrafficExtension"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'LbTrafficExtension':
        """
    ...
    @property
    @pulumi.getter(name="forwardingRules")
    def forwarding_rules(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of references to the forwarding rules to which this service extension is attached to.
        At least one forwarding rule is required. There can be only one LBTrafficExtension resource per forwarding rule.
        """
