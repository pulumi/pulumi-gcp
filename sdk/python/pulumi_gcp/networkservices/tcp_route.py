...
class TcpRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] gateways: Gateways defines a list of gateways this TcpRoute is attached to, as one of the routing rules to route the requests served by the gateway.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] meshes: Meshes defines a list of meshes this TcpRoute is attached to, as one of the routing rules to route the requests served by the mesh.
...
class _TcpRouteState:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['TcpRouteRuleArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] update_time: Time the TcpRoute was updated in UTC.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['TcpRouteRuleArgs']]]]:
        """
        Rules that define how traffic is routed and handled. At least one RouteRule must be supplied.
        If there are multiple rules then the action taken will be the first rule to match.
        Structure is documented below.
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['TcpRouteRuleArgs']]]]):
        pulumi.set(self, "rules", value)
