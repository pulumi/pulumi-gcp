...
class EdgeCacheKeysetPublicKey(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: The ID of the public key. The ID must be 1-63 characters long, and comply with RFC1035.
               The name must be 1-64 characters long, and match the regular expression [a-zA-Z][a-zA-Z0-9_-]*
               which means the first character must be a letter, and all following characters must be a dash, underscore, letter or digit.
        :param _builtins.bool managed: Set to true to have the CDN automatically manage this public key value.
        :param _builtins.str value: The base64-encoded value of the Ed25519 public key. The base64 encoding can be padded (44 bytes) or unpadded (43 bytes).
...
class EdgeCacheKeysetValidationSharedKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str secret_version: The name of the secret version in Secret Manager.
...
class EdgeCacheOriginAwsV4Authentication(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str access_key_id: The access key ID your origin uses to identify the key.
        :param _builtins.str origin_region: The name of the AWS region that your origin is in.
        :param _builtins.str secret_access_key_version: The Secret Manager secret version of the secret access key used by your origin.
...
class EdgeCacheOriginFlexShielding(dict):
    ...
    def __init__(__self__, *,
                 flex_shielding_regions: Optional[_builtins.str] = None):
        """
        :param _builtins.str flex_shielding_regions: Whenever possible, content will be fetched from origin and cached in or
...
class EdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAdd(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool replace: Whether to replace all existing headers with the same name.
...
class EdgeCacheOriginOriginOverrideActionUrlRewrite(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str host_rewrite: Prior to forwarding the request to the selected
...
class EdgeCacheOriginOriginRedirect(dict):
    ...
    def __init__(__self__, *,
                 redirect_conditions: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] redirect_conditions: The set of redirect response codes that the CDN
               follows. Values of
...
class EdgeCacheOriginTimeout(dict):
    ...
    def __init__(__self__, *,
                 connect_timeout: Optional[_builtins.str] = None,
                 max_attempts_timeout: Optional[_builtins.str] = None,
                 read_timeout: Optional[_builtins.str] = None,
                 response_timeout: Optional[_builtins.str] = None):
        """
        :param _builtins.str connect_timeout: The maximum duration to wait for a single origin connection to be established, including DNS lookup, TLS handshake and TCP/QUIC connection establishment.
               Defaults to 5 seconds. The timeout must be a value between 1s and 15s.
               The connectTimeout capped by the deadline set by the request's maxAttemptsTimeout.  The last connection attempt may have a smaller connectTimeout in order to adhere to the overall maxAttemptsTimeout.
        :param _builtins.str max_attempts_timeout: The maximum time across all connection attempts to the origin, including failover origins, before returning an error to the client. A HTTP 504 will be returned if the timeout is reached before a response is returned.
               Defaults to 15 seconds. The timeout must be a value between 1s and 30s.
               If a failoverOrigin is specified, the maxAttemptsTimeout of the first configured origin sets the deadline for all connection attempts across all failoverOrigins.
        :param _builtins.str read_timeout: The maximum duration to wait between reads of a single HTTP connection/stream.
               Defaults to 15 seconds.  The timeout must be a value between 1s and 30s.
        ...
        :param _builtins.str response_timeout: The maximum duration to wait for the last byte of a response to arrive when reading from the HTTP connection/stream.
...
class EdgeCacheServiceLogConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enable: Specifies whether to enable logging for traffic served by this service.
        :param _builtins.float sample_rate: Configures the sampling rate of requests, where 1.0 means all logged requests are reported and 0.0 means no logged requests are reported. The default value is 1.0, and the value of the field must be in [0, 1].
...
class EdgeCacheServiceRoutingHostRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] hosts: The list of host patterns to match.
        ...
        :param _builtins.str path_matcher: The name of the pathMatcher associated with this hostRule.
        :param _builtins.str description: A human-readable description of the hostRule.
        """
...
class EdgeCacheServiceRoutingPathMatcherRouteRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleArgs'] match_rules: The list of criteria for matching attributes of a request to this routeRule. This list has OR semantics: the request matches this routeRule when any of the matchRules are satisfied. However predicates
               ...
               Structure is documented below.
        :param _builtins.str priority: The priority of this route rule, where 1 is the highest priority.
               You cannot configure two or more routeRules with the same priority. Priority for each rule must be set to a number between 1 and 999 inclusive.
               Priority numbers can have gaps, which enable you to add or remove rules in the future without affecting the rest of the rules. For example, 1, 2, 3, 4, 5, 9, 12, 16 is a valid series of priority numbers
               to which you could add rules numbered from 6 to 8, 10 to 11, and 13 to 15 in the future without any impact on existing rules.
        :param _builtins.str description: A human-readable description of the routeRule.
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToRemove(dict):
    ...
    def __init__(__self__, *,
                 header_name: _builtins.str):
        """
        :param _builtins.str header_name: The name of the header to remove.
        """
        pulumi.set(__self__, "header_name", header_name)
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionResponseHeaderToRemove(dict):
    ...
    def __init__(__self__, *,
                 header_name: _builtins.str):
        """
        :param _builtins.str header_name: Headers to remove from the response prior to sending it back to the client.
               Response headers are only sent to the client, and do not have an effect on the cache serving the response.
        """
        pulumi.set(__self__, "header_name", header_name)
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str full_path_match: For satisfying the matchRule condition, the path of the request must exactly match the value specified in fullPathMatch after removing any query parameters and anchor that may be part of the original URL.
        ...
        :param _builtins.str path_template_match: For satisfying the matchRule condition, the path of the request
               ...
               captures in total.
        :param _builtins.str prefix_match: For satisfying the matchRule condition, the request's path must begin with the specified prefixMatch. prefixMatch must begin with a /.
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleHeaderMatch(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str header_name: The header name to match on.
        :param _builtins.str exact_match: The value of the header should exactly match contents of exactMatch.
        :param _builtins.bool invert_match: If set to false (default), the headerMatch is considered a match if the match criteria above are met.
               If set to true, the headerMatch is considered a match if the match criteria above are NOT met.
        :param _builtins.str prefix_match: The value of the header must start with the contents of prefixMatch.
        :param _builtins.bool present_match: A header with the contents of headerName must exist. The match takes place whether or not the request's header has a value.
        :param _builtins.str suffix_match: The value of the header must end with the contents of suffixMatch.
        """
        pulumi.set(__self__, "header_name", header_name)
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleMatchRuleQueryParameterMatch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 present_match: Optional[_builtins.bool] = None):
        """
        :param _builtins.str name: The name of the query parameter to match. The query parameter must exist in the request, in the absence of which the request match fails.
        :param _builtins.str exact_match: The queryParameterMatch matches if the value of the parameter exactly matches the contents of exactMatch.
        :param _builtins.bool present_match: Specifies that the queryParameterMatch matches if the request contains the query parameter, irrespective of whether the parameter has a value or not.
        """
        pulumi.set(__self__, "name", name)
        if exact_match is not None:
            pulumi.set(__self__, "exact_match", exact_match)
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 compression_mode: Optional[_builtins.str] = None,
        ...
        :param 'EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyArgs' cdn_policy: The policy to use for defining caching and signed request behaviour for requests that match this route.
               Structure is documented below.
        :param _builtins.str compression_mode: Setting the compression mode to automatic enables dynamic compression for every eligible response.
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_ttl: Optional[_builtins.str] = None,
                 default_ttl: Optional[_builtins.str] = None,
                 max_ttl: Optional[_builtins.str] = None,
                 negative_caching: Optional[_builtins.bool] = None,
                 negative_caching_policy: Optional[Mapping[str, _builtins.str]] = None,
                 signed_request_keyset: Optional[_builtins.str] = None,
                 signed_request_maximum_expiration_ttl: Optional[_builtins.str] = None,
                 signed_request_mode: Optional[_builtins.str] = None,
        ...
        :param 'EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicyArgs' cache_key_policy: Defines the request parameters that contribute to the cache key.
               Structure is documented below.
        :param _builtins.str cache_mode: Cache modes allow users to control the behaviour of the cache, what content it should cache automatically, whether to respect origin headers, or whether to unconditionally cache all responses.
        ...
        :param _builtins.str client_ttl: Specifies a separate client (e.g. browser client) TTL, separate from the TTL used by the edge caches. Leaving this empty will use the same cache TTL for both the CDN and the client-facing response.
        ...
        :param _builtins.str default_ttl: Specifies the default TTL for cached content served by this origin for responses that do not have an existing valid TTL (max-age or s-max-age).
               ...
               When the cache mode is set to "USE_ORIGIN_HEADERS" or "BYPASS_CACHE", you must omit this field.
               A duration in seconds terminated by 's'. Example: "3s".
        :param _builtins.str max_ttl: Specifies the maximum allowed TTL for cached content served by this origin.
               ...
               A duration in seconds terminated by 's'. Example: "3s".
        :param _builtins.bool negative_caching: Negative caching allows per-status code TTLs to be set, in order to apply fine-grained caching for common errors or redirects. This can reduce the load on your origin and improve end-user experience by reducing response latency.
               By default, the CDNPolicy will apply the following default TTLs to these status codes:
               - HTTP 300 (Multiple Choice), 301, 308 (Permanent Redirects): 10m
               - HTTP 404 (Not Found), 410 (Gone), 451 (Unavailable For Legal Reasons): 120s
               - HTTP 405 (Method Not Found), 414 (URI Too Long), 501 (Not Implemented): 60s
               These defaults can be overridden in negativeCachingPolicy
        :param Mapping[str, _builtins.str] negative_caching_policy: Sets a cache TTL for the specified HTTP status code. negativeCaching must be enabled to configure negativeCachingPolicy.
               - Omitting the policy and leaving negativeCaching enabled will use the default TTLs for each status code, defined in negativeCaching.
               - TTLs must be >= 0 (where 0 is "always revalidate") and <= 86400s (1 day)
               Note that when specifying an explicit negativeCachingPolicy, you should take care to specify a cache TTL for all response codes that you wish to cache. The CDNPolicy will not apply any default negative caching when a policy exists.
        :param _builtins.str signed_request_keyset: The EdgeCacheKeyset containing the set of public keys used to validate signed requests at the edge.
        :param _builtins.str signed_request_maximum_expiration_ttl: Limit how far into the future the expiration time of a signed request may be.
               When set, a signed request is rejected if its expiration time is later than now + signedRequestMaximumExpirationTtl, where now is the time at which the signed request is first handled by the CDN.
               - The TTL must be > 0.
               - Fractions of a second are not allowed.
               By default, signedRequestMaximumExpirationTtl is not set and the expiration time of a signed request may be arbitrarily far into future.
        :param _builtins.str signed_request_mode: Whether to enforce signed requests. The default value is DISABLED, which means all content is public, and does not authorize access.
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyAddSignatures(dict):
    ...
    def __init__(__self__, *,
                 ...
                 copied_parameters: Optional[Sequence[_builtins.str]] = None,
                 keyset: Optional[_builtins.str] = None,
                 token_query_parameter: Optional[_builtins.str] = None,
                 token_ttl: Optional[_builtins.str] = None):
        """
        :param _builtins.str actions: The actions to take to add signatures to responses.
               Each value may be one of: `GENERATE_COOKIE`, `GENERATE_TOKEN_HLS_COOKIELESS`, `PROPAGATE_TOKEN_HLS_COOKIELESS`.
        :param Sequence[_builtins.str] copied_parameters: The parameters to copy from the verified token to the generated token.
               Only the following parameters may be copied:
               * `PathGlobs`
        :param _builtins.str keyset: The keyset to use for signature generation.
               The following are both valid paths to an EdgeCacheKeyset resource:
               * `projects/project/locations/global/edgeCacheKeysets/yourKeyset`
               * `yourKeyset`
               This must be specified when the GENERATE_COOKIE or GENERATE_TOKEN_HLS_COOKIELESS actions are specified.  This field may not be specified otherwise.
        :param _builtins.str token_query_parameter: The query parameter in which to put the generated token.
        ...
        :param _builtins.str token_ttl: The duration the token is valid starting from the moment the token is first generated.
               Defaults to `86400s` (1 day).
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicyCacheKeyPolicy(dict):
    ...
    def __init__(__self__, *,
                 exclude_host: Optional[_builtins.bool] = None,
                 exclude_query_string: Optional[_builtins.bool] = None,
                 excluded_query_parameters: Optional[Sequence[_builtins.str]] = None,
                 include_protocol: Optional[_builtins.bool] = None,
                 included_cookie_names: Optional[Sequence[_builtins.str]] = None,
                 included_header_names: Optional[Sequence[_builtins.str]] = None,
                 included_query_parameters: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.bool exclude_host: If true, requests to different hosts will be cached separately.
               Note: this should only be enabled if hosts share the same origin and content. Removing the host from the cache key may inadvertently result in different objects being cached than intended, depending on which route the first user matched.
        :param _builtins.bool exclude_query_string: If true, exclude query string parameters from the cache key
               If false (the default), include the query string parameters in
               the cache key according to includeQueryParameters and
               excludeQueryParameters. If neither includeQueryParameters nor
               excludeQueryParameters is set, the entire query string will be
               included.
        :param Sequence[_builtins.str] excluded_query_parameters: Names of query string parameters to exclude from cache keys. All other parameters will be included.
        ...
        :param Sequence[_builtins.str] included_cookie_names: Names of Cookies to include in cache keys.  The cookie name and cookie value of each cookie named will be used as part of the cache key.
               Cookie names:
        ...
        :param Sequence[_builtins.str] included_header_names: Names of HTTP request headers to include in cache keys. The value of the header field will be used as part of the cache key.
               - Header names must be valid HTTP RFC 7230 header field values.
               - Header field names are case insensitive
               - To include the HTTP method, use ":method"
               Note that specifying several headers, and/or headers that have a large range of values (e.g. per-user) will dramatically impact the cache hit rate, and may result in a higher eviction rate and reduced performance.
        :param Sequence[_builtins.str] included_query_parameters: Names of query string parameters to include in cache keys. All other parameters will be excluded.
               Either specify includedQueryParameters or excludedQueryParameters, not both. '&' and '=' will be percent encoded and not treated as delimiters.
        """
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicySignedTokenOptions(dict):
    ...
    def __init__(__self__, *,
                 allowed_signature_algorithms: Optional[Sequence[_builtins.str]] = None,
                 token_query_parameter: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] allowed_signature_algorithms: The allowed signature algorithms to use.
               Defaults to using only ED25519.
               You may specify up to 3 signature algorithms to use.
               Each value may be one of: `ED25519`, `HMAC_SHA_256`, `HMAC_SHA1`.
        :param _builtins.str token_query_parameter: The query parameter in which to find the token.
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCorsPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str max_age: Specifies how long results of a preflight request can be cached by a client in seconds. Note that many browser clients enforce a maximum TTL of 600s (10 minutes).
        ...
        :param Sequence[_builtins.str] allow_headers: Specifies the content for the Access-Control-Allow-Headers response header.
        :param Sequence[_builtins.str] allow_methods: Specifies the content for the Access-Control-Allow-Methods response header.
        ...
        :param Sequence[_builtins.str] expose_headers: Specifies the content for the Access-Control-Allow-Headers response header.
        """
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionUrlRewrite(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str host_rewrite: Prior to forwarding the request to the selected origin, the request's host header is replaced with contents of hostRewrite.
        :param _builtins.str path_prefix_rewrite: Prior to forwarding the request to the selected origin, the matching portion of the request's path is replaced by pathPrefixRewrite.
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleRouteMethods(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] allowed_methods: The non-empty set of HTTP methods that are allowed for this route.
...
class EdgeCacheServiceRoutingPathMatcherRouteRuleUrlRedirect(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str host_redirect: The host that will be used in the redirect response instead of the one that was supplied in the request.
        :param _builtins.bool https_redirect: If set to true, the URL scheme in the redirected request is set to https. If set to false, the URL scheme of the redirected request will remain the same as that of the request.
               This can only be set if there is at least one (1) edgeSslCertificate set on the service.
        :param _builtins.str path_redirect: The path that will be used in the redirect response instead of the one that was supplied in the request.
               pathRedirect cannot be supplied together with prefixRedirect. Supply one alone or neither. If neither is supplied, the path of the original request will be used for the redirect.
               The path value must be between 1 and 1024 characters.
        :param _builtins.str prefix_redirect: The prefix that replaces the prefixMatch specified in the routeRule, retaining the remaining portion of the URL before redirecting the request.
               prefixRedirect cannot be supplied together with pathRedirect. Supply one alone or neither. If neither is supplied, the path of the original request will be used for the redirect.
        :param _builtins.str redirect_response_code: The HTTP Status code to use for this RedirectAction.
        ...
        :param _builtins.bool strip_query: If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained.
        """
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcher(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str metadata_label_match_criteria: Specifies how matching should be done.
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabel(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str label_name: Required. Label name presented as key in xDS Node Metadata.
        :param _builtins.str label_value: Required. Label value presented as value corresponding to the above key, in xDS Node Metadata.
        """
...
class EndpointPolicyTrafficPortSelector(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] ports: List of ports. Can be port numbers or port range (example, [80-90] specifies all ports from 80 to 90, including 80 and 90) or named ports or * to specify all ports. If the list is empty, all ports are selected.
        """
...
class GrpcRouteRuleAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GrpcRouteRuleActionRetryPolicyArgs' retry_policy: Specifies the retry policy associated with this route.
               Structure is documented below.
        :param _builtins.str timeout: Specifies the timeout for selected route.
        """
...
class GrpcRouteRuleActionDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str service_name: The URL of a BackendService to route traffic to.
        :param _builtins.int weight: Specifies the proportion of requests forwarded to the backend referenced by the serviceName field.
        """
...
class GrpcRouteRuleActionFaultInjectionPolicyAbort(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int percentage: The percentage of traffic which will be aborted.
        """
...
class GrpcRouteRuleActionFaultInjectionPolicyDelay(dict):
    ...
    def __init__(__self__, *,
                 fixed_delay: Optional[_builtins.str] = None,
                 percentage: Optional[_builtins.int] = None):
        """
        :param _builtins.str fixed_delay: Specify a fixed delay before forwarding the request.
        :param _builtins.int percentage: The percentage of traffic on which delay will be injected.
        """
...
class GrpcRouteRuleActionRetryPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int num_retries: Specifies the allowed number of retries.
...
class GrpcRouteRuleMatchHeader(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key: Required. The key of the header.
        :param _builtins.str value: Required. The value of the header.
        :param _builtins.str type: The type of match.
...
class GrpcRouteRuleMatchMethod(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str grpc_method: Required. Name of the method to match against.
        :param _builtins.str grpc_service: Required. Name of the service to match against.
        :param _builtins.bool case_sensitive: Specifies that matches are case sensitive. The default value is true.
        """
...
class HttpRouteRuleActionCorsPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_credentials: In response to a preflight request, setting this to true indicates that the actual request can include user credentials.
        :param Sequence[_builtins.str] allow_headers: Specifies the content for Access-Control-Allow-Headers header.
        :param Sequence[_builtins.str] allow_methods: Specifies the content for Access-Control-Allow-Methods header.
        :param Sequence[_builtins.str] allow_origin_regexes: Specifies the regular expression patterns that match allowed origins.
        :param Sequence[_builtins.str] allow_origins: Specifies the list of origins that will be allowed to do CORS requests.
        :param _builtins.bool disabled: If true, the CORS policy is disabled. The default value is false, which indicates that the CORS policy is in effect.
        :param Sequence[_builtins.str] expose_headers: Specifies the content for Access-Control-Expose-Headers header.
        :param _builtins.str max_age: Specifies how long result of a preflight request can be cached in seconds.
        """
        if allow_credentials is not None:
            pulumi.set(__self__, "allow_credentials", allow_credentials)
        if allow_headers is not None:
...
class HttpRouteRuleActionDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str service_name: The URL of a BackendService to route traffic to.
        :param _builtins.int weight: Specifies the proportion of requests forwarded to the backend referenced by the serviceName field. This is computed as: weight/Sum(weights in this destination list). For non-zero values, there may be some epsilon from the exact proportion defined here depending on the precision an implementation supports.
...
class HttpRouteRuleActionRedirect(dict):
    ...
    def __init__(__self__, *,
                 ...
                 https_redirect: Optional[_builtins.bool] = None,
                 path_redirect: Optional[_builtins.str] = None,
                 port_redirect: Optional[_builtins.int] = None,
        ...
        :param _builtins.int port_redirect: The port that will be used in the redirected request instead of the one that was supplied in the request.
        :param _builtins.str prefix_rewrite: Indicates that during redirection, the matched prefix (or path) should be swapped with this value.
        :param _builtins.str response_code: The HTTP Status code to use for the redirect.
        :param _builtins.bool strip_query: If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request.
        """
        if host_redirect is not None:
            pulumi.set(__self__, "host_redirect", host_redirect)
        if https_redirect is not None:
...
class HttpRouteRuleActionRequestHeaderModifier(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, _builtins.str] add: Add the headers with given map where key is the name of the header, value is the value of the header.
        :param Sequence[_builtins.str] removes: Remove headers (matching by header names) specified in the list.
        :param Mapping[str, _builtins.str] set: Completely overwrite/replace the headers with given map where key is the name of the header, value is the value of the header.
        """
        if add is not None:
...
class HttpRouteRuleActionRetryPolicy(dict):
    ...
    def __init__(__self__, *,
                 num_retries: Optional[_builtins.int] = None,
                 per_try_timeout: Optional[_builtins.str] = None,
                 retry_conditions: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.int num_retries: Specifies the allowed number of retries.
        :param _builtins.str per_try_timeout: Specifies a non-zero timeout per retry attempt. A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        :param Sequence[_builtins.str] retry_conditions: Specifies one or more conditions when this retry policy applies.
        """
        if num_retries is not None:
            pulumi.set(__self__, "num_retries", num_retries)
...
class HttpRouteRuleActionUrlRewrite(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path_prefix_rewrite: Optional[_builtins.str] = None):
        """
        :param _builtins.str host_rewrite: Prior to forwarding the request to the selected destination, the requests host header is replaced by this value.
        :param _builtins.str path_prefix_rewrite: Prior to forwarding the request to the selected destination, the matching portion of the requests path is replaced by this value.
        """
        if host_rewrite is not None:
            pulumi.set(__self__, "host_rewrite", host_rewrite)
        if path_prefix_rewrite is not None:
...
class HttpRouteRuleMatch(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str full_path_match: The HTTP request path value should exactly match this value.
        :param Sequence['HttpRouteRuleMatchHeaderArgs'] headers: Specifies a list of HTTP request headers to match against.
               Structure is documented below.
        :param _builtins.bool ignore_case: Specifies if prefixMatch and fullPathMatch matches are case sensitive. The default value is false.
        :param _builtins.str prefix_match: The HTTP request path value must begin with specified prefixMatch. prefixMatch must begin with a /.
        :param Sequence['HttpRouteRuleMatchQueryParameterArgs'] query_parameters: Specifies a list of query parameters to match against.
               Structure is documented below.
        :param _builtins.str regex_match: The HTTP request path value must satisfy the regular expression specified by regexMatch after removing any query parameters and anchor supplied with the original URL. For regular expression grammar, please see https://github.com/google/re2/wiki/Syntax
        """
        if full_path_match is not None:
            pulumi.set(__self__, "full_path_match", full_path_match)
        if headers is not None:
...
class HttpRouteRuleMatchHeader(dict):
    ...
    def __init__(__self__, *,
                 ...
                 suffix_match: Optional[_builtins.str] = None):
        """
        :param _builtins.str exact_match: The value of the header should match exactly the content of exactMatch.
        :param _builtins.str header: The name of the HTTP header to match against.
        :param _builtins.bool invert_match: If specified, the match result will be inverted before checking. Default value is set to false.
        :param _builtins.str prefix_match: The value of the header must start with the contents of prefixMatch.
        :param _builtins.bool present_match: A header with headerName must exist. The match takes place whether or not the header has a value.
        :param 'HttpRouteRuleMatchHeaderRangeMatchArgs' range_match: If specified, the rule will match if the request header value is within the range.
               Structure is documented below.
        :param _builtins.str regex_match: The value of the header must match the regular expression specified in regexMatch.
        :param _builtins.str suffix_match: The value of the header must end with the contents of suffixMatch.
        """
        if exact_match is not None:
            pulumi.set(__self__, "exact_match", exact_match)
...
class HttpRouteRuleMatchHeaderRangeMatch(dict):
    def __init__(__self__, *,
                 ...
                 start: _builtins.int):
        """
        :param _builtins.int end: End of the range (exclusive).
        :param _builtins.int start: Start of the range (inclusive).
        """
...
class HttpRouteRuleMatchQueryParameter(dict):
    ...
    def __init__(__self__, *,
                 exact_match: Optional[_builtins.str] = None,
                 present_match: Optional[_builtins.bool] = None,
                 query_parameter: Optional[_builtins.str] = None,
                 regex_match: Optional[_builtins.str] = None):
        """
        :param _builtins.str exact_match: The value of the query parameter must exactly match the contents of exactMatch.
        :param _builtins.bool present_match: Specifies that the QueryParameterMatcher matches if request contains query parameter, irrespective of whether the parameter has a value or not.
        :param _builtins.str query_parameter: The name of the query parameter to match.
        :param _builtins.str regex_match: The value of the query parameter must match the regular expression specified by regexMatch.For regular expression grammar, please see https://github.com/google/re2/wiki/Syntax
        """
        if exact_match is not None:
            pulumi.set(__self__, "exact_match", exact_match)
        if present_match is not None:
...
class LbRouteExtensionExtensionChainExtension(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str service: The reference to the service that runs the extension. Must be a reference to a backend service
...
class ServiceLbPoliciesAutoCapacityDrain(dict):
    def __init__(__self__, *,
                 enable: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool enable: Optional. If set to 'True', an unhealthy MIG/NEG will be set as drained. - An MIG/NEG is considered unhealthy if less than 25% of the instances/endpoints in the MIG/NEG are healthy. - This option will never result in draining more than 50% of the configured IGs/NEGs for the Backend Service.
        """
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
...
class ServiceLbPoliciesFailoverConfig(dict):
    ...
    def __init__(__self__, *,
                 failover_health_threshold: _builtins.int):
        """
        :param _builtins.int failover_health_threshold: Optional. The percentage threshold that a load balancer will begin to send traffic to failover backends. If the percentage of endpoints in a MIG/NEG is smaller than this value, traffic would be sent to failover backends if possible. This field should be set to a value between 1 and 99. The default value is 50 for Global external HTTP(S) load balancer (classic) and Proxyless service mesh, and 70 for others.
        """
...
class TcpRouteRuleAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 original_destination: Optional[_builtins.bool] = None):
        """
        :param Sequence['TcpRouteRuleActionDestinationArgs'] destinations: The destination services to which traffic should be forwarded. At least one destination service is required.
               Structure is documented below.
        :param _builtins.str idle_timeout: Specifies the idle timeout for the selected route. The idle timeout is defined as the period in which there are no bytes sent or received on either the upstream or downstream connection. If not set, the default idle timeout is 30 seconds. If set to 0s, the timeout will be disabled.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        :param _builtins.bool original_destination: If true, Router will use the destination IP and port of the original connection as the destination of the request.
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
...
class TcpRouteRuleMatch(dict):
    def __init__(__self__, *,
                 ...
                 port: _builtins.str):
        """
        :param _builtins.str address: Must be specified in the CIDR range format. A CIDR range consists of an IP Address and a prefix length to construct the subnet mask.
               By default, the prefix length is 32 (i.e. matches a single IP address). Only IPV4 addresses are supported. Examples: "10.0.0.1" - matches against this exact IP address. "10.0.0.0/8" - matches against any IP address within the 10.0.0.0 subnet and 255.255.255.0 mask. "0.0.0.0/0" - matches against any IP address'.
        :param _builtins.str port: Specifies the destination port to match against.
        """
...
class TlsRouteRuleMatch(dict):
    ...
    def __init__(__self__, *,
                 alpns: Optional[Sequence[_builtins.str]] = None,
                 sni_hosts: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] alpns: ALPN (Application-Layer Protocol Negotiation) to match against. Examples: "http/1.1", "h2". At least one of sniHost and alpn is required. Up to 5 alpns across all matches can be set.
        :param Sequence[_builtins.str] sni_hosts: SNI (server name indicator) to match against. SNI will be matched against all wildcard domains, i.e. www.example.com will be first matched against www.example.com, then *.example.com, then *.com.
