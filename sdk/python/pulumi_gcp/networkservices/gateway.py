...
class GatewayArgs:
    def __init__(__self__, *,
                 ...
                 envoy_headers: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] envoy_headers: Determines if envoy will insert internal debug headers into upstream requests.
        ...
        :param pulumi.Input[_builtins.str] gateway_security_policy: A fully-qualified GatewaySecurityPolicy URL reference. Defines how a server should apply security policy to inbound (VM to Proxy) initiated connections.
               For example: 'projects/*/locations/*/gatewaySecurityPolicies/swg-policy'.
               This policy is specific to gateways of type 'SECURE_WEB_GATEWAY'.
        :param pulumi.Input[_builtins.str] ip_version: The IP Version that will be used by this gateway.
               Possible values are: `IPV4`, `IPV6`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Set of label tags associated with the Gateway resource.
               
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location of the gateway.
               The default value is `global`.
        :param pulumi.Input[_builtins.str] name: Name of the Gateway resource.
        ...
        :param pulumi.Input[_builtins.str] server_tls_policy: A fully-qualified ServerTLSPolicy URL reference. Specifies how TLS traffic is terminated. If empty, TLS termination is disabled.
        :param pulumi.Input[_builtins.str] subnetwork: The relative resource name identifying the subnetwork in which this SWG is allocated.
    ...
    def all_ports(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def certificate_urls(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def certificate_urls(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "certificate_urls", value)

    @_builtins.property
    @pulumi.getter(name="deleteSwgAutogenRouterOnDestroy")
    def delete_swg_autogen_router_on_destroy(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def delete_swg_autogen_router_on_destroy(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def envoy_headers(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def envoy_headers(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Gateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnetwork: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'Gateway':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="deleteSwgAutogenRouterOnDestroy")
    def delete_swg_autogen_router_on_destroy(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When deleting a gateway of type 'SECURE_WEB_GATEWAY', this boolean option will also delete auto generated router by the gateway creation.
        If there is no other gateway of type 'SECURE_WEB_GATEWAY' remaining for that region and network it will be deleted.
        """
