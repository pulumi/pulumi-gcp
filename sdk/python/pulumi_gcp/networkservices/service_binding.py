...
class ServiceBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service: The full Service Directory Service name of the format
               projects/*/locations/*/namespaces/*/services/*
        :param pulumi.Input[builtins.str] description: A free-text description of the resource. Max length 1024 characters.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Set of label tags associated with the ServiceBinding resource.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] name: Name of the ServiceBinding resource.
...
class _ServiceBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Time the ServiceBinding was created in UTC.
        :param pulumi.Input[builtins.str] description: A free-text description of the resource. Max length 1024 characters.
        ...
        :param pulumi.Input[builtins.str] service: The full Service Directory Service name of the format
               projects/*/locations/*/namespaces/*/services/*
        :param pulumi.Input[builtins.str] update_time: Time the ServiceBinding was updated in UTC.
        """
...
class ServiceBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceBinding':
        """
