...
class MulticastGroupConsumerActivationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] multicast_group_consumer_activation_id: A unique name for the multicast group consumer activation.
               The name is restricted to letters, numbers, and hyphen, with the first
               character a letter, and the last a letter or a number. The name must not
               exceed 48 characters.
        :param pulumi.Input[_builtins.str] multicast_group_range_activation: The resource name of the multicast group range activation created by the
        ...
        :param pulumi.Input['MulticastGroupConsumerActivationLogConfigArgs'] log_config: The logging configuration.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        """
        pulumi.set(__self__, "location", location)
        pulumi.set(__self__, "multicast_consumer_association", multicast_consumer_association)
        pulumi.set(__self__, "multicast_group_consumer_activation_id", multicast_group_consumer_activation_id)
    ...
    def multicast_group_consumer_activation_id(self, value: pulumi.Input[_builtins.str]):
...
class _MulticastGroupConsumerActivationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] multicast_group_range_activation: The resource name of the multicast group range activation created by the
               ...
               following format:
               // `projects/*/locations/*/multicastGroupRangeActivations/*`.
        :param pulumi.Input[_builtins.str] name: Identifier. The resource name of the multicast group consumer activation.
               Use the following format:
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MulticastGroupConsumerActivationStateArgs']]] states: (Output)
        ...
        :param pulumi.Input[_builtins.str] update_time: The timestamp when the multicast group consumer activation
        ...
        if log_config is not None:
            pulumi.set(__self__, "log_config", log_config)
        if multicast_consumer_association is not None:
            pulumi.set(__self__, "multicast_consumer_association", multicast_consumer_association)
        if multicast_group_consumer_activation_id is not None:
            pulumi.set(__self__, "multicast_group_consumer_activation_id", multicast_group_consumer_activation_id)
...
@pulumi.type_token("gcp:networkservices/multicastGroupConsumerActivation:MulticastGroupConsumerActivation")
class MulticastGroupConsumerActivation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MulticastGroupConsumerActivationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MulticastGroupConsumerActivationArgs.__new__(MulticastGroupConsumerActivationArgs)
            ...
            if multicast_consumer_association is None and not opts.urn:
                raise TypeError("Missing required property 'multicast_consumer_association'")
            __props__.__dict__["multicast_consumer_association"] = multicast_consumer_association
            if multicast_group_consumer_activation_id is None and not opts.urn:
                raise TypeError("Missing required property 'multicast_group_consumer_activation_id'")
            __props__.__dict__["multicast_group_consumer_activation_id"] = multicast_group_consumer_activation_id
        ...
        super(MulticastGroupConsumerActivation, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _MulticastGroupConsumerActivationState.__new__(_MulticastGroupConsumerActivationState)
        ...
        return MulticastGroupConsumerActivation(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="logConfig")
    def log_config(self) -> pulumi.Output[Optional['outputs.MulticastGroupConsumerActivationLogConfig']]:
        """
        The logging configuration.
        Structure is documented below.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="multicastGroupConsumerActivationId")
    def multicast_group_consumer_activation_id(self) -> pulumi.Output[_builtins.str]:
        """
        A unique name for the multicast group consumer activation.
        The name is restricted to letters, numbers, and hyphen, with the first
        character a letter, and the last a letter or a number. The name must not
    ...
    @_builtins.property
    @pulumi.getter
    def states(self) -> pulumi.Output[Sequence['outputs.MulticastGroupConsumerActivationState']]:
        """
        (Output)
        The state of the multicast resource.
        Possible values:
