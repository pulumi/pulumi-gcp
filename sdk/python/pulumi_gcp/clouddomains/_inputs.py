...
class RegistrationContactSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RegistrationContactSettingsAdminContactArgs'] admin_contact: Caution: Anyone with access to this email address, phone number, and/or postal address can take control of the domain.
               ...
               avoid domain suspension.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] privacy: Required. Privacy setting for the contacts associated with the Registration.
               Values are PUBLIC_CONTACT_DATA, PRIVATE_CONTACT_DATA, and REDACTED_CONTACT_DATA
...
class RegistrationContactSettingsAdminContactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RegistrationContactSettingsAdminContactPostalAddressArgs'] postal_address: Required. Postal address of the contact.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] fax_number: Fax number of the contact in international format. For example, "+1-800-555-0123".
        """
...
class RegistrationContactSettingsAdminContactPostalAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region_code: Required. CLDR region code of the country/region of the address. This is never inferred and it is up to the user to
               ...
               https://www.unicode.org/cldr/charts/30/supplemental/territory_information.html for details. Example: "CH" for Switzerland.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] address_lines: Unstructured address lines describing the lower levels of an address.
               Because values in addressLines do not have type information and may sometimes contain multiple values in a single
               field (e.g. "Austin, TX"), it is important that the line order is clear. The order of address lines should be
               "envelope order" for the country/region of the address. In places where this can vary (e.g. Japan), address_language
               is used to make it explicit (e.g. "ja" for large-to-small ordering and "ja-Latn" or "en" for small-to-large). This way,
               the most specific line of an address can be selected based on the language.
        :param pulumi.Input[_builtins.str] administrative_area: Highest administrative subdivision which is used for postal addresses of a country or region. For example, this can be a state,
               a province, an oblast, or a prefecture. Specifically, for Spain this is the province and not the autonomous community
               (e.g. "Barcelona" and not "Catalonia"). Many countries don't use an administrative area in postal addresses. E.g. in Switzerland
               this should be left unpopulated.
        :param pulumi.Input[_builtins.str] locality: Generally refers to the city/town portion of the address. Examples: US city, IT comune, UK post town. In regions of the world
               where localities are not well defined or do not fit into this structure well, leave locality empty and use addressLines.
        :param pulumi.Input[_builtins.str] organization: The name of the organization at the address.
        :param pulumi.Input[_builtins.str] postal_code: Postal code of the address. Not all countries use or require postal codes to be present, but where they are used,
               they may trigger additional validation with other parts of the address (e.g. state/zip validation in the U.S.A.).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] recipients: The recipient at the address. This field may, under certain circumstances, contain multiline information. For example,
               it might contain "care of" information.
        """
...
class RegistrationDnsSettingsCustomDnsDsRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] digest_type: The hash function used to generate the digest of the referenced DNSKEY.
        :param pulumi.Input[_builtins.int] key_tag: The key tag of the record. Must be set in range 0 -- 65535.
        """
...
class RegistrationDnsSettingsGlueRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ipv4_addresses: List of IPv4 addresses corresponding to this host in the standard decimal format (e.g. 198.51.100.1).
               At least one of ipv4_address and ipv6_address must be set.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ipv6_addresses: List of IPv4 addresses corresponding to this host in the standard decimal format (e.g. 198.51.100.1).
               At least one of ipv4_address and ipv6_address must be set.
        """
...
class RegistrationManagementSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] preferred_renewal_method: The desired renewal method for this Registration. The actual renewalMethod is automatically updated to reflect this choice.
               ...
               problems with the billing account or reported domain abuse. In such cases, check the issues field on the Registration. After
               the problem is resolved, the renewalMethod is automatically updated to preferredRenewalMethod in a few hours.
        :param pulumi.Input[_builtins.str] renewal_method: (Output)
               Output only. The actual renewal method for this Registration. When preferredRenewalMethod is set to AUTOMATIC_RENEWAL,
               the actual renewalMethod can be equal to RENEWAL_DISABLED—for example, when there are problems with the billing account
               or reported domain abuse. In such cases, check the issues field on the Registration. After the problem is resolved, the
               renewalMethod is automatically updated to preferredRenewalMethod in a few hours.
        :param pulumi.Input[_builtins.str] transfer_lock_state: Controls whether the domain can be transferred to another registrar. Values are UNLOCKED or LOCKED.
        """
