...
class RegistrationContactSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str privacy: Required. Privacy setting for the contacts associated with the Registration.
...
class RegistrationContactSettingsAdminContact(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email: Required. Email address of the contact.
        :param builtins.str phone_number: Required. Phone number of the contact in international format. For example, "+1-800-555-0123".
        :param 'RegistrationContactSettingsAdminContactPostalAddressArgs' postal_address: Required. Postal address of the contact.
               Structure is documented below.
        :param builtins.str fax_number: Fax number of the contact in international format. For example, "+1-800-555-0123".
        """
...
class RegistrationContactSettingsAdminContactPostalAddress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 address_lines: Optional[Sequence[builtins.str]] = None,
                 administrative_area: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str region_code: Required. CLDR region code of the country/region of the address. This is never inferred and it is up to the user to
               ensure the value is correct. See https://cldr.unicode.org/ and
               https://www.unicode.org/cldr/charts/30/supplemental/territory_information.html for details. Example: "CH" for Switzerland.
        :param Sequence[builtins.str] address_lines: Unstructured address lines describing the lower levels of an address.
               Because values in addressLines do not have type information and may sometimes contain multiple values in a single
               field (e.g. "Austin, TX"), it is important that the line order is clear. The order of address lines should be
               "envelope order" for the country/region of the address. In places where this can vary (e.g. Japan), address_language
               is used to make it explicit (e.g. "ja" for large-to-small ordering and "ja-Latn" or "en" for small-to-large). This way,
               the most specific line of an address can be selected based on the language.
        :param builtins.str administrative_area: Highest administrative subdivision which is used for postal addresses of a country or region. For example, this can be a state,
               a province, an oblast, or a prefecture. Specifically, for Spain this is the province and not the autonomous community
               (e.g. "Barcelona" and not "Catalonia"). Many countries don't use an administrative area in postal addresses. E.g. in Switzerland
               this should be left unpopulated.
        :param builtins.str locality: Generally refers to the city/town portion of the address. Examples: US city, IT comune, UK post town. In regions of the world
               where localities are not well defined or do not fit into this structure well, leave locality empty and use addressLines.
        :param builtins.str organization: The name of the organization at the address.
        :param builtins.str postal_code: Postal code of the address. Not all countries use or require postal codes to be present, but where they are used,
    ...
    def address_lines(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def administrative_area(self) -> Optional[builtins.str]:
        """
...
class RegistrationDnsSettingsCustomDns(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] name_servers: Required. A list of name servers that store the DNS zone for this domain. Each name server is a domain
...
class RegistrationDnsSettingsCustomDnsDsRecord(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str algorithm: The algorithm used to generate the referenced DNSKEY.
        :param builtins.str digest: The digest generated from the referenced DNSKEY.
        :param builtins.str digest_type: The hash function used to generate the digest of the referenced DNSKEY.
        :param builtins.int key_tag: The key tag of the record. Must be set in range 0 -- 65535.
        """
...
class RegistrationDnsSettingsGlueRecord(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host_name: Required. Domain name of the host in Punycode format.
        :param Sequence[builtins.str] ipv4_addresses: List of IPv4 addresses corresponding to this host in the standard decimal format (e.g. 198.51.100.1).
               At least one of ipv4_address and ipv6_address must be set.
        :param Sequence[builtins.str] ipv6_addresses: List of IPv4 addresses corresponding to this host in the standard decimal format (e.g. 198.51.100.1).
               At least one of ipv4_address and ipv6_address must be set.
        """
...
class RegistrationManagementSettings(dict):
    ...
    def __init__(__self__, *,
                 preferred_renewal_method: Optional[builtins.str] = None,
                 renewal_method: Optional[builtins.str] = None,
                 transfer_lock_state: Optional[builtins.str] = None):
        """
        :param builtins.str preferred_renewal_method: The desired renewal method for this Registration. The actual renewalMethod is automatically updated to reflect this choice.
        ...
        :param builtins.str renewal_method: (Output)
        ...
        :param builtins.str transfer_lock_state: Controls whether the domain can be transferred to another registrar. Values are UNLOCKED or LOCKED.
        """
    ...
    def preferred_renewal_method(self) -> Optional[builtins.str]:
        """
    ...
    def renewal_method(self) -> Optional[builtins.str]:
        """
        (Output)
        Output only. The actual renewal method for this Registration. When preferredRenewalMethod is set to AUTOMATIC_RENEWAL,
        the actual renewalMethod can be equal to RENEWAL_DISABLED—for example, when there are problems with the billing account
    ...
    def transfer_lock_state(self) -> Optional[builtins.str]:
        """
...
class RegistrationYearlyPrice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str currency_code: The three-letter currency code defined in ISO 4217.
        :param builtins.str units: The whole units of the amount. For example if currencyCode is "USD", then 1 unit is one US dollar.
        """
