...
class RegistrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Set of labels associated with the Registration.
...
class _RegistrationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] expire_time: Output only. Time at which the automation was updated.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] issues: Output only. The set of issues with the Registration that require attention.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Set of labels associated with the Registration.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location for the resource
