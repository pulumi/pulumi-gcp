...
class InterconnectAttachmentArgs:
    def __init__(__self__, *,
                 interconnect: pulumi.Input[builtins.str],
                 interconnect_attachment_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] vlan_id: VLAN ID provided by user. Must be site-wise unique.
        ...
        :param pulumi.Input[builtins.int] mtu: IP (L3) MTU value of the virtual edge cloud. Default value is `1500`. Possible values are: `1500`, `9000`.
    ...
    @property
    @pulumi.getter
    def interconnect(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @interconnect.setter
    def interconnect(self, value: pulumi.Input[builtins.str]):
    ...
    def interconnect_attachment_id(self, value: pulumi.Input[builtins.str]):
...
class _InterconnectAttachmentState:
    def __init__(__self__, *,
                 ...
                 interconnect_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: The time when the resource was created.
        ...
        :param pulumi.Input[builtins.str] update_time: The time when the resource was last updated.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine
               fractional digits. Examples: `2014-10-02T15:01:23Z` and `2014-10-02T15:01:23.045123456Z`.
        :param pulumi.Input[builtins.int] vlan_id: VLAN ID provided by user. Must be site-wise unique.
        :param pulumi.Input[builtins.str] zone: The name of the target Distributed Cloud Edge zone.
    ...
    @interconnect_attachment_id.setter
    def interconnect_attachment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "interconnect_attachment_id", value)
...
class InterconnectAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            vlan_id: Optional[pulumi.Input[builtins.int]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InterconnectAttachment':
        """
    ...
    @property
    @pulumi.getter
    def interconnect(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the underlying interconnect that this attachment's traffic will traverse through.
        """
        return pulumi.get(self, "interconnect")
