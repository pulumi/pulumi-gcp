...
def region_from_id(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke_single('gcp:index/regionFromId:regionFromId', __args__, opts=opts).value
...
def region_from_id_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output_single('gcp:index/regionFromId:regionFromId', __args__, opts=opts)
    return __ret__
