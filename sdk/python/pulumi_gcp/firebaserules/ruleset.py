...
class _RulesetState:
    def __init__(__self__, *,
                 ...
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 metadatas: pulumi.Input[Optional[Sequence[pulumi.Input['RulesetMetadataArgs']]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 source: pulumi.Input[Optional['RulesetSourceArgs']] = None):
        """
        Input properties used for looking up and filtering Ruleset resources.

        :param pulumi.Input[_builtins.str] create_time: Output only. Time the `Ruleset` was created.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the instance. Defaults to "DELETE".
               When a 'terraform destroy' or 'terraform apply' would delete the instance,
               the command will fail if this field is set to "PREVENT" in Terraform state.
               When set to "ABANDON", the command will remove the resource from Terraform
        ...
        :param pulumi.Input[_builtins.str] name: Output only. Name of the `Ruleset`. The ruleset_id is auto generated by the service. Format: `projects/{project_id}/rulesets/{ruleset_id}`
        :param pulumi.Input[_builtins.str] project: The project for the resource
        :param pulumi.Input['RulesetSourceArgs'] source: `Source` for the `Ruleset`.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def metadatas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RulesetMetadataArgs']]]]:
        """
    ...
    @metadatas.setter
    def metadatas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RulesetMetadataArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def source(self) -> pulumi.Input[Optional['RulesetSourceArgs']]:
        """
        `Source` for the `Ruleset`.
        """
        return pulumi.get(self, "source")
    ...
    @source.setter
    def source(self, value: pulumi.Input[Optional['RulesetSourceArgs']]):
        pulumi.set(self, "source", value)
...
class Ruleset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 source: pulumi.Input[Optional[Union['RulesetSourceArgs', 'RulesetSourceArgsDict', 'outputs.RulesetSource']]] = None,
                 __props__=None):
        """
        ...
        * `{{name}}`
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the instance. Defaults to "DELETE".
               ...
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] project: The project for the resource
        :param pulumi.Input[Union['RulesetSourceArgs', 'RulesetSourceArgsDict', 'outputs.RulesetSource']] source: `Source` for the `Ruleset`.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            create_time: pulumi.Input[Optional[_builtins.str]] = None,
            deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
            metadatas: pulumi.Input[Optional[Sequence[pulumi.Input[Union['RulesetMetadataArgs', 'RulesetMetadataArgsDict', 'outputs.RulesetMetadata']]]]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            source: pulumi.Input[Optional[Union['RulesetSourceArgs', 'RulesetSourceArgsDict', 'outputs.RulesetSource']]] = None) -> 'Ruleset':
        """
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the instance. Defaults to "DELETE".
               ...
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RulesetMetadataArgs', 'RulesetMetadataArgsDict', 'outputs.RulesetMetadata']]]] metadatas: Output only. The metadata for this ruleset.
        :param pulumi.Input[_builtins.str] name: Output only. Name of the `Ruleset`. The ruleset_id is auto generated by the service. Format: `projects/{project_id}/rulesets/{ruleset_id}`
        :param pulumi.Input[_builtins.str] project: The project for the resource
        :param pulumi.Input[Union['RulesetSourceArgs', 'RulesetSourceArgsDict', 'outputs.RulesetSource']] source: `Source` for the `Ruleset`.
        """
