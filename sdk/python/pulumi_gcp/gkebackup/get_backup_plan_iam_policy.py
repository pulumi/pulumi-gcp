...
def get_backup_plan_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The region of the Backup Plan.
...
def get_backup_plan_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
