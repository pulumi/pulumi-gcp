...
@pulumi.output_type
calass GetBackupPlanIamPolicyResult:
    """
...
calass AwaitableGetBackupPlanIamPolicyResult(GetBackupPlanIamPolicyResult):
...
def get_backup_plan_iam_policy(location: Optional[str] = None,
    ...
    policy = gcp.gkebackup.get_backup_plan_iam_policy(project=google_gke_backup_backup_plan["basic"]["project"],
