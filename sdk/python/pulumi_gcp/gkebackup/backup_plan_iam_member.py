...
class BackupPlanIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['BackupPlanIamMemberConditionArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['BackupPlanIamMemberConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['BackupPlanIamMemberConditionArgs']]):
...
@pulumi.type_token("gcp:gkebackup/backupPlanIamMember:BackupPlanIamMember")
class BackupPlanIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['BackupPlanIamMemberConditionArgs', 'BackupPlanIamMemberConditionArgsDict', 'outputs.BackupPlanIamMemberCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `gkebackup.BackupPlanIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the backupplan are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `gkebackup.BackupPlanIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the backupplan are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'BackupPlanIamMember':
        """
