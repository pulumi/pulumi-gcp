...
class BackupPlanBackupConfig(dict):
    ...
    def __init__(__self__, *,
                 all_namespaces: Optional[builtins.bool] = None,
                 encryption_key: Optional['outputs.BackupPlanBackupConfigEncryptionKey'] = None,
                 include_secrets: Optional[builtins.bool] = None,
                 include_volume_data: Optional[builtins.bool] = None,
                 permissive_mode: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.bool all_namespaces: If True, include all namespaced resources.
        ...
        :param builtins.bool include_secrets: This flag specifies whether Kubernetes Secret resources should be included
               when they fall into the scope of Backups.
        :param builtins.bool include_volume_data: This flag specifies whether volume data should be backed up when PVCs are
               included in the scope of a Backup.
        :param builtins.bool permissive_mode: This flag specifies whether Backups will not fail when
    ...
    def all_namespaces(self) -> Optional[builtins.bool]:
        """
    ...
    def include_secrets(self) -> Optional[builtins.bool]:
        """
    ...
    def include_volume_data(self) -> Optional[builtins.bool]:
        """
    ...
    def permissive_mode(self) -> Optional[builtins.bool]:
        """
...
class BackupPlanBackupConfigEncryptionKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str gcp_kms_encryption_key: Google Cloud KMS encryption key. Format: projects/*/locations/*/keyRings/*/cryptoKeys/*
        """
...
class BackupPlanBackupConfigSelectedApplicationsNamespacedName(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of a Kubernetes Resource.
        :param builtins.str namespace: The namespace of a Kubernetes Resource.
        """
...
class BackupPlanBackupConfigSelectedNamespaces(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] namespaces: A list of Kubernetes Namespaces.
        """
...
class BackupPlanBackupSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cron_schedule: A standard cron string that defines a repeating schedule for
               creating Backups via this BackupPlan.
               This is mutually exclusive with the rpoConfig field since at most one
               schedule can be defined for a BackupPlan.
               If this is defined, then backupRetainDays must also be defined.
        :param builtins.bool paused: This flag denotes whether automatic Backup creation is paused for this BackupPlan.
...
class BackupPlanBackupScheduleRpoConfig(dict):
    ...
    def __init__(__self__, *,
                 target_rpo_minutes: builtins.int,
                 exclusion_windows: Optional[Sequence['outputs.BackupPlanBackupScheduleRpoConfigExclusionWindow']] = None):
        """
        :param builtins.int target_rpo_minutes: Defines the target RPO for the BackupPlan in minutes, which means the target
    ...
    def target_rpo_minutes(self) -> builtins.int:
        """
...
class BackupPlanBackupScheduleRpoConfigExclusionWindow(dict):
    ...
    def __init__(__self__, *,
                 ...
                 daily: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.str duration: Specifies duration of the window in seconds with up to nine fractional digits,
        ...
        :param 'BackupPlanBackupScheduleRpoConfigExclusionWindowStartTimeArgs' start_time: Specifies the start time of the window using time of the day in UTC.
               Structure is documented below.
        :param builtins.bool daily: The exclusion window occurs every day if set to "True".
    ...
    @property
    @pulumi.getter
    def daily(self) -> Optional[builtins.bool]:
        """
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowDaysOfWeek(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] days_of_weeks: A list of days of week.
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDate(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int day: Day of a month.
        :param builtins.int month: Month of a year.
        :param builtins.int year: Year of the date.
        """
        if day is not None:
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowStartTime(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int hours: Hours of day in 24 hour format.
        :param builtins.int minutes: Minutes of hour of day.
        :param builtins.int nanos: Fractions of seconds in nanoseconds.
        :param builtins.int seconds: Seconds of minutes of the time.
        """
...
class BackupPlanRetentionPolicy(dict):
    ...
    def __init__(__self__, *,
                 backup_delete_lock_days: Optional[builtins.int] = None,
                 backup_retain_days: Optional[builtins.int] = None,
                 locked: Optional[builtins.bool] = None):
        """
        :param builtins.int backup_delete_lock_days: Minimum age for a Backup created via this BackupPlan (in days).
               Must be an integer value between 0-90 (inclusive).
               A Backup created under this BackupPlan will not be deletable
               until it reaches Backup's (create time + backup_delete_lock_days).
               Updating this field of a BackupPlan does not affect existing Backups.
               Backups created after a successful update will inherit this new value.
        :param builtins.int backup_retain_days: The default maximum age of a Backup created via this BackupPlan.
        ...
        :param builtins.bool locked: This flag denotes whether the retention policy of this BackupPlan is locked.
    ...
    def backup_delete_lock_days(self) -> Optional[builtins.int]:
        """
    ...
    def backup_retain_days(self) -> Optional[builtins.int]:
        """
...
class RestorePlanRestoreConfig(dict):
    ...
    def __init__(__self__, *,
                 all_namespaces: Optional[builtins.bool] = None,
                 cluster_resource_conflict_policy: Optional[builtins.str] = None,
                 ...
                 namespaced_resource_restore_mode: Optional[builtins.str] = None,
                 no_namespaces: Optional[builtins.bool] = None,
                 ...
                 volume_data_restore_policy: Optional[builtins.str] = None,
        ...
        """
        :param builtins.bool all_namespaces: If True, restore all namespaced resources in the Backup.
               Setting this field to False will result in an error.
        :param builtins.str cluster_resource_conflict_policy: Defines the behavior for handling the situation where cluster-scoped resources
        ...
        :param 'RestorePlanRestoreConfigExcludedNamespacesArgs' excluded_namespaces: A list of selected namespaces excluded from restoration.
               ...
               Structure is documented below.
        :param builtins.str namespaced_resource_restore_mode: Defines the behavior for handling the situation where sets of namespaced resources
               being restored already exist in the target cluster.
        ...
        :param builtins.bool no_namespaces: Do not restore any namespaced resources if set to "True".
        ...
        :param Sequence['RestorePlanRestoreConfigTransformationRuleArgs'] transformation_rules: A list of transformation rules to be applied against Kubernetes
               ...
               Structure is documented below.
        :param builtins.str volume_data_restore_policy: Specifies the mechanism to be used to restore volume data.
    ...
    def cluster_resource_conflict_policy(self) -> Optional[builtins.str]:
        """
    ...
    def namespaced_resource_restore_mode(self) -> Optional[builtins.str]:
        """
    ...
    def no_namespaces(self) -> Optional[builtins.bool]:
        """
    ...
    def volume_data_restore_policy(self) -> Optional[builtins.str]:
        """
...
class RestorePlanRestoreConfigClusterResourceRestoreScope(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindArgs'] excluded_group_kinds: A list of cluster-scoped resource group kinds to NOT restore from the backup.
               ...
               Mutually exclusive to any other field in `clusterResourceRestoreScope`.
               Structure is documented below.
        :param builtins.bool no_group_kinds: If True, no cluster-scoped resources will be restored.
               Mutually exclusive to any other field in `clusterResourceRestoreScope`.
    ...
    def all_group_kinds(self) -> Optional[builtins.bool]:
        """
    ...
    def no_group_kinds(self) -> Optional[builtins.bool]:
        """
...
class RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKind(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_group: API Group string of a Kubernetes resource, e.g.
...
class RestorePlanRestoreConfigRestoreOrderGroupKindDependencyRequiring(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_kind: Optional[builtins.str] = None):
        """
        :param builtins.str resource_group: API Group of a Kubernetes resource, e.g.
               "apiextensions.k8s.io", "storage.k8s.io", etc.
               Use empty string for core group.
        :param builtins.str resource_kind: Kind of a Kubernetes resource, e.g.
               "CustomResourceDefinition", "StorageClass", etc.
...
class RestorePlanRestoreConfigTransformationRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['RestorePlanRestoreConfigTransformationRuleFieldActionArgs'] field_actions: A list of transformation rule actions to take against candidate
               ...
               Structure is documented below.
        :param builtins.str description: The description is a user specified string description
...
class RestorePlanRestoreConfigTransformationRuleFieldAction(dict):
    ...
    def __init__(__self__, *,
                 op: builtins.str,
                 from_path: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str op: Specifies the operation to perform.
               Possible values are: `REMOVE`, `MOVE`, `COPY`, `ADD`, `TEST`, `REPLACE`.
        :param builtins.str from_path: A string containing a JSON Pointer value that references the
               location in the target document to move the value from.
        :param builtins.str path: A string containing a JSON-Pointer value that references a
               location within the target document where the operation is performed.
        :param builtins.str value: A string that specifies the desired value in string format
    ...
    def from_path(self) -> Optional[builtins.str]:
        """
...
class RestorePlanRestoreConfigTransformationRuleResourceFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['RestorePlanRestoreConfigTransformationRuleResourceFilterGroupKindArgs'] group_kinds: (Filtering parameter) Any resource subject to transformation must
               ...
               Structure is documented below.
        :param builtins.str json_path: This is a JSONPath expression that matches specific fields of
        ...
        :param Sequence[builtins.str] namespaces: (Filtering parameter) Any resource subject to transformation must
...
class RestorePlanRestoreConfigVolumeDataRestorePolicyBinding(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy: Specifies the mechanism to be used to restore this volume data.
               See https://cloud.google.com/kubernetes-engine/docs/add-on/backup-for-gke/reference/rest/v1/RestoreConfig#VolumeDataRestorePolicy
               for more information on each policy option.
               Possible values are: `RESTORE_VOLUME_DATA_FROM_BACKUP`, `REUSE_VOLUME_HANDLE_FROM_BACKUP`, `NO_VOLUME_DATA_RESTORATION`.
        :param builtins.str volume_type: The volume type, as determined by the PVC's
