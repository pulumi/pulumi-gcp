...
@pulumi.output_type
calass GetRestorePlanIamPolicyResult:
    """
...
calass AwaitableGetRestorePlanIamPolicyResult(GetRestorePlanIamPolicyResult):
...
def get_restore_plan_iam_policy(location: Optional[str] = None,
