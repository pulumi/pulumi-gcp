...
def get_restore_plan_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The region of the Restore Plan.
...
def get_restore_plan_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
