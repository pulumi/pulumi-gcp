...
if not MYPY:
    class BackupPlanBackupConfigArgsDict(TypedDict):
        all_namespaces: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        include_secrets: NotRequired[pulumi.Input[builtins.bool]]
        """
        This flag specifies whether Kubernetes Secret resources should be included
        when they fall into the scope of Backups.
        """
        include_volume_data: NotRequired[pulumi.Input[builtins.bool]]
        """
        This flag specifies whether volume data should be backed up when PVCs are
        included in the scope of a Backup.
        """
        permissive_mode: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BackupPlanBackupConfigArgs:
    def __init__(__self__, *,
                 all_namespaces: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption_key: Optional[pulumi.Input['BackupPlanBackupConfigEncryptionKeyArgs']] = None,
                 include_secrets: Optional[pulumi.Input[builtins.bool]] = None,
                 include_volume_data: Optional[pulumi.Input[builtins.bool]] = None,
                 permissive_mode: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] all_namespaces: If True, include all namespaced resources.
        :param pulumi.Input['BackupPlanBackupConfigEncryptionKeyArgs'] encryption_key: This defines a customer managed encryption key that will be used to encrypt the "config"
               portion (the Kubernetes resources) of Backups created via this plan.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] include_secrets: This flag specifies whether Kubernetes Secret resources should be included
               when they fall into the scope of Backups.
        :param pulumi.Input[builtins.bool] include_volume_data: This flag specifies whether volume data should be backed up when PVCs are
               included in the scope of a Backup.
        :param pulumi.Input[builtins.bool] permissive_mode: This flag specifies whether Backups will not fail when
               Backup for GKE detects Kubernetes configuration that is
               non-standard or requires additional setup to restore.
    ...
    def all_namespaces(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If True, include all namespaced resources.
        """
    ...
    def all_namespaces(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def include_secrets(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This flag specifies whether Kubernetes Secret resources should be included
        when they fall into the scope of Backups.
        """
    ...
    def include_secrets(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_secrets", value)

    @property
    @pulumi.getter(name="includeVolumeData")
    def include_volume_data(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This flag specifies whether volume data should be backed up when PVCs are
        included in the scope of a Backup.
        """
    ...
    def include_volume_data(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_volume_data", value)

    @property
    @pulumi.getter(name="permissiveMode")
    def permissive_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This flag specifies whether Backups will not fail when
        Backup for GKE detects Kubernetes configuration that is
        non-standard or requires additional setup to restore.
    ...
    def permissive_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BackupPlanBackupConfigEncryptionKeyArgsDict(TypedDict):
        gcp_kms_encryption_key: pulumi.Input[builtins.str]
        """
...
class BackupPlanBackupConfigEncryptionKeyArgs:
    def __init__(__self__, *,
                 gcp_kms_encryption_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] gcp_kms_encryption_key: Google Cloud KMS encryption key. Format: projects/*/locations/*/keyRings/*/cryptoKeys/*
        """
        pulumi.set(__self__, "gcp_kms_encryption_key", gcp_kms_encryption_key)

    @property
    @pulumi.getter(name="gcpKmsEncryptionKey")
    def gcp_kms_encryption_key(self) -> pulumi.Input[builtins.str]:
        """
        Google Cloud KMS encryption key. Format: projects/*/locations/*/keyRings/*/cryptoKeys/*
        """
    ...
    def gcp_kms_encryption_key(self, value: pulumi.Input[builtins.str]):
...
class BackupPlanBackupConfigSelectedApplicationsNamespacedNameArgs:
    def __init__(__self__, *,
                 ...
                 namespace: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of a Kubernetes Resource.
        :param pulumi.Input[builtins.str] namespace: The namespace of a Kubernetes Resource.
        """
...
class BackupPlanBackupConfigSelectedNamespacesArgs:
    def __init__(__self__, *,
                 namespaces: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] namespaces: A list of Kubernetes Namespaces.
        """
...
class BackupPlanBackupScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cron_schedule: A standard cron string that defines a repeating schedule for
               creating Backups via this BackupPlan.
               This is mutually exclusive with the rpoConfig field since at most one
               schedule can be defined for a BackupPlan.
               If this is defined, then backupRetainDays must also be defined.
        :param pulumi.Input[builtins.bool] paused: This flag denotes whether automatic Backup creation is paused for this BackupPlan.
...
if not MYPY:
    class BackupPlanBackupScheduleRpoConfigArgsDict(TypedDict):
        target_rpo_minutes: pulumi.Input[builtins.int]
        """
...
class BackupPlanBackupScheduleRpoConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] target_rpo_minutes: Defines the target RPO for the BackupPlan in minutes, which means the target
               maximum data loss in time that is acceptable for this BackupPlan. This must be
               at least 60, i.e., 1 hour, and at most 86400, i.e., 60 days.
    ...
    def target_rpo_minutes(self) -> pulumi.Input[builtins.int]:
        """
        Defines the target RPO for the BackupPlan in minutes, which means the target
        maximum data loss in time that is acceptable for this BackupPlan. This must be
        at least 60, i.e., 1 hour, and at most 86400, i.e., 60 days.
    ...
    def target_rpo_minutes(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class BackupPlanBackupScheduleRpoConfigExclusionWindowArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        daily: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowArgs:
    def __init__(__self__, *,
                 ...
                 daily: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] duration: Specifies duration of the window in seconds with up to nine fractional digits,
               terminated by 's'. Example: "3.5s". Restrictions for duration based on the
               recurrence type to allow some time for backup to happen:
               - single_occurrence_date:  no restriction
               - daily window: duration < 24 hours
        ...
        :param pulumi.Input['BackupPlanBackupScheduleRpoConfigExclusionWindowStartTimeArgs'] start_time: Specifies the start time of the window using time of the day in UTC.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] daily: The exclusion window occurs every day if set to "True".
               Specifying this field to "False" is an error.
               Only one of singleOccurrenceDate, daily and daysOfWeek may be set.
    ...
    @property
    @pulumi.getter
    def daily(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The exclusion window occurs every day if set to "True".
        Specifying this field to "False" is an error.
        Only one of singleOccurrenceDate, daily and daysOfWeek may be set.
    ...
    @daily.setter
    def daily(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowDaysOfWeekArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days_of_weeks: A list of days of week.
               Each value may be one of: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        """
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowSingleOccurrenceDateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] day: Day of a month.
        :param pulumi.Input[builtins.int] month: Month of a year.
        :param pulumi.Input[builtins.int] year: Year of the date.
        """
        if day is not None:
...
class BackupPlanBackupScheduleRpoConfigExclusionWindowStartTimeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] hours: Hours of day in 24 hour format.
        :param pulumi.Input[builtins.int] minutes: Minutes of hour of day.
        :param pulumi.Input[builtins.int] nanos: Fractions of seconds in nanoseconds.
        :param pulumi.Input[builtins.int] seconds: Seconds of minutes of the time.
        """
...
if not MYPY:
    class BackupPlanRetentionPolicyArgsDict(TypedDict):
        backup_delete_lock_days: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        backup_retain_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class BackupPlanRetentionPolicyArgs:
    def __init__(__self__, *,
                 backup_delete_lock_days: Optional[pulumi.Input[builtins.int]] = None,
                 backup_retain_days: Optional[pulumi.Input[builtins.int]] = None,
                 locked: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] backup_delete_lock_days: Minimum age for a Backup created via this BackupPlan (in days).
               Must be an integer value between 0-90 (inclusive).
               A Backup created under this BackupPlan will not be deletable
               until it reaches Backup's (create time + backup_delete_lock_days).
               Updating this field of a BackupPlan does not affect existing Backups.
               Backups created after a successful update will inherit this new value.
        :param pulumi.Input[builtins.int] backup_retain_days: The default maximum age of a Backup created via this BackupPlan.
               This field MUST be an integer value >= 0 and <= 365. If specified,
               a Backup created under this BackupPlan will be automatically deleted
               after its age reaches (createTime + backupRetainDays).
               If not specified, Backups created under this BackupPlan will NOT be
               ...
               If rpo_config is defined, then this must be
               <= 360 * targetRpoMinutes/(1440minutes/day)
        :param pulumi.Input[builtins.bool] locked: This flag denotes whether the retention policy of this BackupPlan is locked.
               If set to True, no further update is allowed on this policy, including
               the locked field itself.
        """
    ...
    def backup_delete_lock_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Minimum age for a Backup created via this BackupPlan (in days).
        Must be an integer value between 0-90 (inclusive).
        A Backup created under this BackupPlan will not be deletable
    ...
    def backup_delete_lock_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "backup_delete_lock_days", value)

    @property
    @pulumi.getter(name="backupRetainDays")
    def backup_retain_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The default maximum age of a Backup created via this BackupPlan.
        This field MUST be an integer value >= 0 and <= 365. If specified,
        a Backup created under this BackupPlan will be automatically deleted
    ...
    def backup_retain_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class RestorePlanRestoreConfigArgsDict(TypedDict):
        ...
        """
        cluster_resource_conflict_policy: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        namespaced_resource_restore_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        no_namespaces: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        Structure is documented below.
        """
        volume_data_restore_policy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RestorePlanRestoreConfigArgs:
    def __init__(__self__, *,
                 all_namespaces: Optional[pulumi.Input[builtins.bool]] = None,
                 cluster_resource_conflict_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 namespaced_resource_restore_mode: Optional[pulumi.Input[builtins.str]] = None,
                 no_namespaces: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 volume_data_restore_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] all_namespaces: If True, restore all namespaced resources in the Backup.
               Setting this field to False will result in an error.
        :param pulumi.Input[builtins.str] cluster_resource_conflict_policy: Defines the behavior for handling the situation where cluster-scoped resources
               being restored already exist in the target cluster.
               This MUST be set to a value other than `CLUSTER_RESOURCE_CONFLICT_POLICY_UNSPECIFIED`
               if `clusterResourceRestoreScope` is anyting other than `noGroupKinds`.
               See https://cloud.google.com/kubernetes-engine/docs/add-on/backup-for-gke/reference/rest/v1/RestoreConfig#clusterresourceconflictpolicy
        ...
        :param pulumi.Input['RestorePlanRestoreConfigExcludedNamespacesArgs'] excluded_namespaces: A list of selected namespaces excluded from restoration.
               All namespaces except those in this list will be restored.
               Structure is documented below.
        :param pulumi.Input[builtins.str] namespaced_resource_restore_mode: Defines the behavior for handling the situation where sets of namespaced resources
               being restored already exist in the target cluster.
               This MUST be set to a value other than `NAMESPACED_RESOURCE_RESTORE_MODE_UNSPECIFIED`
               if the `namespacedResourceRestoreScope` is anything other than `noNamespaces`.
               See https://cloud.google.com/kubernetes-engine/docs/add-on/backup-for-gke/reference/rest/v1/RestoreConfig#namespacedresourcerestoremode
               for more information on each mode.
               Possible values are: `DELETE_AND_RESTORE`, `FAIL_ON_CONFLICT`, `MERGE_SKIP_ON_CONFLICT`, `MERGE_REPLACE_VOLUME_ON_CONFLICT`, `MERGE_REPLACE_ON_CONFLICT`.
        :param pulumi.Input[builtins.bool] no_namespaces: Do not restore any namespaced resources if set to "True".
               Specifying this field to "False" is not allowed.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RestorePlanRestoreConfigTransformationRuleArgs']]] transformation_rules: A list of transformation rules to be applied against Kubernetes
               ...
               rules. An empty list means no transformation will occur.
               Structure is documented below.
        :param pulumi.Input[builtins.str] volume_data_restore_policy: Specifies the mechanism to be used to restore volume data.
               This should be set to a value other than `NAMESPACED_RESOURCE_RESTORE_MODE_UNSPECIFIED`
               if the `namespacedResourceRestoreScope` is anything other than `noNamespaces`.
               If not specified, it will be treated as `NO_VOLUME_DATA_RESTORATION`.
               See https://cloud.google.com/kubernetes-engine/docs/add-on/backup-for-gke/reference/rest/v1/RestoreConfig#VolumeDataRestorePolicy
    ...
    def cluster_resource_conflict_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines the behavior for handling the situation where cluster-scoped resources
        being restored already exist in the target cluster.
        This MUST be set to a value other than `CLUSTER_RESOURCE_CONFLICT_POLICY_UNSPECIFIED`
    ...
    def cluster_resource_conflict_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def namespaced_resource_restore_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines the behavior for handling the situation where sets of namespaced resources
        being restored already exist in the target cluster.
        This MUST be set to a value other than `NAMESPACED_RESOURCE_RESTORE_MODE_UNSPECIFIED`
    ...
    def namespaced_resource_restore_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "namespaced_resource_restore_mode", value)

    @property
    @pulumi.getter(name="noNamespaces")
    def no_namespaces(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Do not restore any namespaced resources if set to "True".
        Specifying this field to "False" is not allowed.
        """
    ...
    def no_namespaces(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def volume_data_restore_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the mechanism to be used to restore volume data.
        This should be set to a value other than `NAMESPACED_RESOURCE_RESTORE_MODE_UNSPECIFIED`
        if the `namespacedResourceRestoreScope` is anything other than `noNamespaces`.
    ...
    def volume_data_restore_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RestorePlanRestoreConfigClusterResourceRestoreScopeArgsDict(TypedDict):
        all_group_kinds: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        Structure is documented below.
        """
        no_group_kinds: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class RestorePlanRestoreConfigClusterResourceRestoreScopeArgs:
    def __init__(__self__, *,
                 all_group_kinds: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 no_group_kinds: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] all_group_kinds: If True, all valid cluster-scoped resources will be restored.
               Mutually exclusive to any other field in `clusterResourceRestoreScope`.
        :param pulumi.Input[Sequence[pulumi.Input['RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindArgs']]] excluded_group_kinds: A list of cluster-scoped resource group kinds to NOT restore from the backup.
               ...
               Mutually exclusive to any other field in `clusterResourceRestoreScope`.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] no_group_kinds: If True, no cluster-scoped resources will be restored.
               Mutually exclusive to any other field in `clusterResourceRestoreScope`.
    ...
    def all_group_kinds(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If True, all valid cluster-scoped resources will be restored.
        Mutually exclusive to any other field in `clusterResourceRestoreScope`.
        """
    ...
    def all_group_kinds(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def no_group_kinds(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If True, no cluster-scoped resources will be restored.
        Mutually exclusive to any other field in `clusterResourceRestoreScope`.
        """
    ...
    def no_group_kinds(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RestorePlanRestoreConfigClusterResourceRestoreScopeExcludedGroupKindArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] resource_group: API Group string of a Kubernetes resource, e.g.
               "apiextensions.k8s.io", "storage.k8s.io", etc.
               Use empty string for core group.
...
class RestorePlanRestoreConfigRestoreOrderGroupKindDependencyRequiringArgs:
    def __init__(__self__, *,
                 ...
                 resource_kind: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] resource_group: API Group of a Kubernetes resource, e.g.
               "apiextensions.k8s.io", "storage.k8s.io", etc.
               Use empty string for core group.
        :param pulumi.Input[builtins.str] resource_kind: Kind of a Kubernetes resource, e.g.
               "CustomResourceDefinition", "StorageClass", etc.
...
class RestorePlanRestoreConfigTransformationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RestorePlanRestoreConfigTransformationRuleFieldActionArgs']]] field_actions: A list of transformation rule actions to take against candidate
               ...
               the first operation could affect the outcome of the second operation.
               Structure is documented below.
        :param pulumi.Input[builtins.str] description: The description is a user specified string description
               of the transformation rule.
...
if not MYPY:
    class RestorePlanRestoreConfigTransformationRuleFieldActionArgsDict(TypedDict):
        ...
        """
        from_path: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RestorePlanRestoreConfigTransformationRuleFieldActionArgs:
    def __init__(__self__, *,
                 op: pulumi.Input[builtins.str],
                 from_path: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] op: Specifies the operation to perform.
               Possible values are: `REMOVE`, `MOVE`, `COPY`, `ADD`, `TEST`, `REPLACE`.
        :param pulumi.Input[builtins.str] from_path: A string containing a JSON Pointer value that references the
               location in the target document to move the value from.
        :param pulumi.Input[builtins.str] path: A string containing a JSON-Pointer value that references a
               location within the target document where the operation is performed.
        :param pulumi.Input[builtins.str] value: A string that specifies the desired value in string format
               to use for transformation.
        """
    ...
    def from_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A string containing a JSON Pointer value that references the
        location in the target document to move the value from.
        """
    ...
    @from_path.setter
    def from_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RestorePlanRestoreConfigTransformationRuleResourceFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RestorePlanRestoreConfigTransformationRuleResourceFilterGroupKindArgs']]] group_kinds: (Filtering parameter) Any resource subject to transformation must
               ...
               will be candidates for transformation).
               Structure is documented below.
        :param pulumi.Input[builtins.str] json_path: This is a JSONPath expression that matches specific fields of
               candidate resources and it operates as a filtering parameter
               (resources that are not matched with this expression will not
               be candidates for transformation).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] namespaces: (Filtering parameter) Any resource subject to transformation must
               be contained within one of the listed Kubernetes Namespace in the
               Backup. If this field is not provided, no namespace filtering will
               be performed (all resources in all Namespaces, including all
               cluster-scoped resources, will be candidates for transformation).
...
class RestorePlanRestoreConfigVolumeDataRestorePolicyBindingArgs:
    def __init__(__self__, *,
                 ...
                 volume_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] policy: Specifies the mechanism to be used to restore this volume data.
               See https://cloud.google.com/kubernetes-engine/docs/add-on/backup-for-gke/reference/rest/v1/RestoreConfig#VolumeDataRestorePolicy
               for more information on each policy option.
               Possible values are: `RESTORE_VOLUME_DATA_FROM_BACKUP`, `REUSE_VOLUME_HANDLE_FROM_BACKUP`, `NO_VOLUME_DATA_RESTORATION`.
        :param pulumi.Input[builtins.str] volume_type: The volume type, as determined by the PVC's
               bound PV, to apply the policy to.
               Possible values are: `GCE_PERSISTENT_DISK`.
        """
