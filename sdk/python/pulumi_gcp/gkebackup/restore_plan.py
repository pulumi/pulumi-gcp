...
class RestorePlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] backup_plan: A reference to the BackupPlan from which Backups may be used
...
class _RestorePlanState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RestorePlanRestoreConfigArgs'] restore_config: Defines the configuration of Restores created via this RestorePlan.
               Structure is documented below.
        :param pulumi.Input[builtins.str] state: The State of the RestorePlan.
        :param pulumi.Input[builtins.str] state_reason: Detailed description of why RestorePlan is in its current state.
...
class RestorePlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            state_reason: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None) -> 'RestorePlan':
        """
