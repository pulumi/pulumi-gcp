...
class GetWorkloadIdentityPoolProviderResult:
    ...
    def attribute_mapping(self) -> Mapping[str, builtins.str]:
...
def get_workload_identity_pool_provider(project: Optional[builtins.str] = None,
                                        workload_identity_pool_id: Optional[builtins.str] = None,
                                        workload_identity_pool_provider_id: Optional[builtins.str] = None,
    ...
    :param builtins.str workload_identity_pool_provider_id: The id of the provider which is the
...
def get_workload_identity_pool_provider_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
