...
def get_workload_identity_pool_iam_policy(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workload_identity_pool_id: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
