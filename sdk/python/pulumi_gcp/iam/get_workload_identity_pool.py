...
def get_workload_identity_pool(project: Optional[_builtins.str] = None,
...
def get_workload_identity_pool_output(project: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
