...
class WorkloadIdentityPoolManagedIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] workload_identity_pool_managed_identity_id: The ID to use for the managed identity. This value must:
    ...
    def workload_identity_pool_managed_identity_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def workload_identity_pool_managed_identity_id(self, value: pulumi.Input[_builtins.str]):
...
class _WorkloadIdentityPoolManagedIdentityState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] disabled: Whether the managed identity is disabled. If disabled, credentials may no longer be issued for
               the identity, however existing credentials will still be accepted until they expire.
        :param pulumi.Input[_builtins.str] name: The resource name of the managed identity as
...
class WorkloadIdentityPoolManagedIdentity(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="workloadIdentityPoolManagedIdentityId")
    def workload_identity_pool_managed_identity_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID to use for the managed identity. This value must:
        * contain at most 63 characters
        * contain only lowercase alphanumeric characters or `-`
