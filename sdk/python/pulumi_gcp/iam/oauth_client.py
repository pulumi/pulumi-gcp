...
class OauthClientArgs:
    def __init__(__self__, *,
                 allowed_grant_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 allowed_redirect_uris: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_scopes: Required. The list of scopes that the OauthClient is allowed to request during
               OAuth flows.
        ...
        :param pulumi.Input[_builtins.str] description: A user-specified description of the OauthClient.
               Cannot exceed 256 characters.
        :param pulumi.Input[_builtins.bool] disabled: Whether the OauthClient is disabled. You cannot use a disabled OAuth
               client.
        :param pulumi.Input[_builtins.str] display_name: A user-specified display name of the OauthClient.
    ...
    def allowed_grant_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    def allowed_redirect_uris(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class _OauthClientState:
    def __init__(__self__, *,
                 allowed_grant_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: A user-specified display name of the OauthClient.
               Cannot exceed 32 characters.
        :param pulumi.Input[_builtins.str] expire_time: Time after which the OauthClient will be permanently purged and cannot
               be recovered.
        :param pulumi.Input[_builtins.str] location: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
        :param pulumi.Input[_builtins.str] name: Immutable. Identifier. The resource name of the OauthClient.
        ...
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] state: The state of the OauthClient.
               Possible values:
               STATE_UNSPECIFIED
               ACTIVE
               DELETED
    ...
    @_builtins.property
    @pulumi.getter(name="allowedGrantTypes")
    def allowed_grant_types(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Required. The list of OAuth grant types is allowed for the OauthClient.
        """
        return pulumi.get(self, "allowed_grant_types")
    ...
    @allowed_grant_types.setter
    def allowed_grant_types(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "allowed_grant_types", value)
...
class OauthClient(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            oauth_client_id: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None) -> 'OauthClient':
        """
