...
class WorkloadIdentityPoolProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] attribute_mapping: Maps attributes from authentication credentials issued by an external identity provider
    ...
    def workload_identity_pool_provider_id(self, value: pulumi.Input[_builtins.str]):
