...
class ProjectsPolicyBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotations: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 condition: pulumi.Input[Optional[Union['ProjectsPolicyBindingConditionArgs', 'ProjectsPolicyBindingConditionArgsDict']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 policy: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 policy_kind: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 target: pulumi.Input[Optional[Union['ProjectsPolicyBindingTargetArgs', 'ProjectsPolicyBindingTargetArgsDict']]] = None,
                 __props__=None):
        """
        ...
        * `{{location}}/{{policy_binding_id}}`
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] annotations: Optional. User defined annotations. See https://google.aip.dev/148#annotations for more details such as format and size limitations
               ...
               **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration.
               Please refer to the field `effective_annotations` for all of the annotations present on the resource.
        :param pulumi.Input[Union['ProjectsPolicyBindingConditionArgs', 'ProjectsPolicyBindingConditionArgsDict']] condition: Represents a textual expression in the Common Expression Language
               (CEL) syntax. CEL is a C-like expression language. The syntax and semantics of
               CEL are documented at https://github.com/google/cel-spec.
               Example (Comparison):
               title: \\"Summary size limit\\"
