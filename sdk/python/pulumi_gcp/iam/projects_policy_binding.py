...
class ProjectsPolicyBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['ProjectsPolicyBindingConditionArgs']] = None,
        ...
        :param pulumi.Input['ProjectsPolicyBindingConditionArgs'] condition: Represents a textual expression in the Common Expression Language
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['ProjectsPolicyBindingConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['ProjectsPolicyBindingConditionArgs']]):
...
class _ProjectsPolicyBindingState:
    def __init__(__self__, *,
                 ...
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 target: pulumi.Input[Optional['ProjectsPolicyBindingTargetArgs']] = None,
    ...
    @target.setter
    def target(self, value: pulumi.Input[Optional['ProjectsPolicyBindingTargetArgs']]):
        pulumi.set(self, "target", value)
...
class ProjectsPolicyBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 annotations: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 condition: pulumi.Input[Optional[Union['ProjectsPolicyBindingConditionArgs', 'ProjectsPolicyBindingConditionArgsDict', 'outputs.ProjectsPolicyBindingCondition']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 policy: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 policy_kind: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 target: pulumi.Input[Optional[Union['ProjectsPolicyBindingTargetArgs', 'ProjectsPolicyBindingTargetArgsDict', 'outputs.ProjectsPolicyBindingTarget']]] = None,
                 __props__=None):
        """
        ...
        * `{{location}}/{{policy_binding_id}}`
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] annotations: Optional. User defined annotations. See https://google.aip.dev/148#annotations for more details such as format and size limitations
               ...
               **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration.
               Please refer to the field `effective_annotations` for all of the annotations present on the resource.
        :param pulumi.Input[Union['ProjectsPolicyBindingConditionArgs', 'ProjectsPolicyBindingConditionArgsDict', 'outputs.ProjectsPolicyBindingCondition']] condition: Represents a textual expression in the Common Expression Language
               (CEL) syntax. CEL is a C-like expression language. The syntax and semantics of
               CEL are documented at https://github.com/google/cel-spec.
               Example (Comparison):
               title: \\"Summary size limit\\"
    ...
    def get(resource_name: str,
            ...
            target: pulumi.Input[Optional[Union['ProjectsPolicyBindingTargetArgs', 'ProjectsPolicyBindingTargetArgsDict', 'outputs.ProjectsPolicyBindingTarget']]] = None,
            uid: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'ProjectsPolicyBinding':
        """
