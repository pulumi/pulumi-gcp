...
class WorkforcePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A user-specified description of the pool. Cannot exceed 256 characters.
        :param pulumi.Input[builtins.bool] disabled: Whether the pool is disabled. You cannot use a disabled pool to exchange tokens,
...
class _WorkforcePoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] session_duration: Duration that the Google Cloud access tokens, console sign-in sessions,
               ...
               If `sessionDuration` is not configured, minted credentials have a default duration of one hour (3600s).
               A duration in seconds with up to nine fractional digits, ending with '`s`'. Example: "`3.5s`".
        :param pulumi.Input[builtins.str] state: Output only. The state of the pool.
...
class WorkforcePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            session_duration: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            workforce_pool_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkforcePool':
        """
