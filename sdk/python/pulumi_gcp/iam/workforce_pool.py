...
class WorkforcePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: A user-specified display name of the pool in Google Cloud Console. Cannot exceed 32 characters.
        :param pulumi.Input[_builtins.str] session_duration: Duration that the Google Cloud access tokens, console sign-in sessions,
...
class _WorkforcePoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: A user-specified display name of the pool in Google Cloud Console. Cannot exceed 32 characters.
        :param pulumi.Input[_builtins.str] location: The location for the resource.
        :param pulumi.Input[_builtins.str] name: Output only. The resource name of the pool.
        ...
        :param pulumi.Input[_builtins.str] session_duration: Duration that the Google Cloud access tokens, console sign-in sessions,
               ...
               If `sessionDuration` is not configured, minted credentials have a default duration of one hour (3600s).
               A duration in seconds with up to nine fractional digits, ending with '`s`'. Example: "`3.5s`".
        :param pulumi.Input[_builtins.str] state: Output only. The state of the pool.
