...
class _AccessBoundaryPolicyState:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['AccessBoundaryPolicyRuleArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccessBoundaryPolicyRuleArgs']]]]:
        """
        Rules to be applied.
        Structure is documented below.
        """
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccessBoundaryPolicyRuleArgs']]]]):
        pulumi.set(self, "rules", value)


@pulumi.type_token("gcp:iam/accessBoundaryPolicy:AccessBoundaryPolicy")
