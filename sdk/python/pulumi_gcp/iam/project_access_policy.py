...
__all__ = ['ProjectAccessPolicyArgs', 'ProjectAccessPolicy']
...
class ProjectAccessPolicyArgs:
    def __init__(__self__, *,
                 ...
                 details: pulumi.Input[Optional['ProjectAccessPolicyDetailsArgs']] = None,
        ...
        :param pulumi.Input['ProjectAccessPolicyDetailsArgs'] details: Access policy details.
    ...
    @_builtins.property
    @pulumi.getter
    def details(self) -> pulumi.Input[Optional['ProjectAccessPolicyDetailsArgs']]:
        """
    ...
    @details.setter
    def details(self, value: pulumi.Input[Optional['ProjectAccessPolicyDetailsArgs']]):
...
@pulumi.input_type
class _ProjectAccessPolicyState:
    def __init__(__self__, *,
...
@pulumi.type_token("gcp:iam/projectAccessPolicy:ProjectAccessPolicy")
class ProjectAccessPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 annotations: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 details: pulumi.Input[Optional[Union['ProjectAccessPolicyDetailsArgs', 'ProjectAccessPolicyDetailsArgsDict', 'outputs.ProjectAccessPolicyDetails']]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        * `{{location}}/{{access_policy_id}}`
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[Union['ProjectAccessPolicyDetailsArgs', 'ProjectAccessPolicyDetailsArgsDict', 'outputs.ProjectAccessPolicyDetails']] details: Access policy details.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] display_name: The description of the access policy. Must be less than
               or equal to 63 characters.
        :param pulumi.Input[_builtins.str] location: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
    ...
    def __init__(__self__,
        ...
        * `{{location}}/{{access_policy_id}}`
        ...
        :param str resource_name: The name of the resource.
        :param ProjectAccessPolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProjectAccessPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProjectAccessPolicyArgs.__new__(ProjectAccessPolicyArgs)
        ...
        super(ProjectAccessPolicy, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            uid: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'ProjectAccessPolicy':
        """
        ...
        __props__ = _ProjectAccessPolicyState.__new__(_ProjectAccessPolicyState)
        ...
        return ProjectAccessPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def details(self) -> pulumi.Output[Optional['outputs.ProjectAccessPolicyDetails']]:
        """
        Access policy details.
        Structure is documented below.
        """
