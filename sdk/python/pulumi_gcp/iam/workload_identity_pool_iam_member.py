...
__all__ = ['WorkloadIdentityPoolIamMemberArgs', 'WorkloadIdentityPoolIamMember']

@pulumi.input_type
class WorkloadIdentityPoolIamMemberArgs:
    def __init__(__self__, *,
                 member: pulumi.Input[_builtins.str],
                 role: pulumi.Input[_builtins.str],
                 workload_identity_pool_id: pulumi.Input[_builtins.str],
                 condition: pulumi.Input[Optional['WorkloadIdentityPoolIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `iam.WorkloadIdentityPoolIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        :param pulumi.Input[_builtins.str] workload_identity_pool_id: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input['WorkloadIdentityPoolIamMemberConditionArgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['WorkloadIdentityPoolIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['WorkloadIdentityPoolIamMemberConditionArgs']]):
...
@pulumi.input_type
class _WorkloadIdentityPoolIamMemberState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['WorkloadIdentityPoolIamMemberConditionArgs']] = None,
...
@pulumi.type_token("gcp:iam/workloadIdentityPoolIamMember:WorkloadIdentityPoolIamMember")
class WorkloadIdentityPoolIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['WorkloadIdentityPoolIamMemberConditionArgs', 'WorkloadIdentityPoolIamMemberConditionArgsDict', 'outputs.WorkloadIdentityPoolIamMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 workload_identity_pool_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `iam.WorkloadIdentityPoolIamBinding`: Authoritative for a given role and condition combination (the condition can be omitted). Updates the IAM policy to grant a role to a list of members. Other role and condition combinations within the IAM policy for the workloadidentitypool are preserved. Members added outside of Terraform for the same role and condition combination will be detected as drift and removed on the next `pulumi up`.
        * `iam.WorkloadIdentityPoolIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the workloadidentitypool are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `iam.WorkloadIdentityPoolIamPolicy`: Retrieves the IAM policy for the workloadidentitypool
        ...
        > **Note:** `iam.WorkloadIdentityPoolIamBinding` resources **can be** used in conjunction with `iam.WorkloadIdentityPoolIamMember` resources **only if** they do not grant privilege to the same role and condition combination.
        ...
        * {{workload_identity_pool_id}}
        ...
        :param pulumi.Input[Union['WorkloadIdentityPoolIamMemberConditionArgs', 'WorkloadIdentityPoolIamMemberConditionArgsDict', 'outputs.WorkloadIdentityPoolIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
    ...
    def __init__(__self__,
        ...
        * {{workload_identity_pool_id}}
        ...
        :param str resource_name: The name of the resource.
        :param WorkloadIdentityPoolIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkloadIdentityPoolIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkloadIdentityPoolIamMemberArgs.__new__(WorkloadIdentityPoolIamMemberArgs)
        ...
        super(WorkloadIdentityPoolIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            workload_identity_pool_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'WorkloadIdentityPoolIamMember':
        """
        ...
        __props__ = _WorkloadIdentityPoolIamMemberState.__new__(_WorkloadIdentityPoolIamMemberState)
        ...
        __props__.__dict__["role"] = role
        __props__.__dict__["workload_identity_pool_id"] = workload_identity_pool_id
        return WorkloadIdentityPoolIamMember(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.WorkloadIdentityPoolIamMemberCondition']]:
        """
        An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        Structure is documented below.
        """
