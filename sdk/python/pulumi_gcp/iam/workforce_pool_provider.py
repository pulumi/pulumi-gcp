...
class WorkforcePoolProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] attribute_mapping: Maps attributes from the authentication credentials issued by an external identity provider
        ...
        :param pulumi.Input[builtins.str] description: A user-specified description of the provider. Cannot exceed 256 characters.
        ...
        :param pulumi.Input[builtins.str] display_name: A user-specified display name for the provider. Cannot exceed 32 characters.
...
class _WorkforcePoolProviderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['WorkforcePoolProviderExtraAttributesOauth2ClientArgs'] extra_attributes_oauth2_client: The configuration for OAuth 2.0 client used to get the additional user
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] location: The location for the resource.
        :param pulumi.Input[builtins.str] name: Output only. The resource name of the provider.
...
class WorkforcePoolProvider(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:iam/workforcePoolProvider:WorkforcePoolProvider"
    ...
    def get(resource_name: str,
            ...
            saml: Optional[pulumi.Input[Union['WorkforcePoolProviderSamlArgs', 'WorkforcePoolProviderSamlArgsDict']]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            workforce_pool_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkforcePoolProvider':
        """
