...
class GetTestablePermissionsResult:
    ...
    def custom_support_level(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def stages(self) -> Optional[Sequence[builtins.str]]:
...
def get_testable_permissions(custom_support_level: Optional[builtins.str] = None,
                             full_resource_name: Optional[builtins.str] = None,
                             stages: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str full_resource_name: See [full resource name documentation](https://cloud.google.com/apis/design/resource_names#full_resource_name) for more detail.
    :param Sequence[builtins.str] stages: The acceptable release stages of the permission in the output. Note that `BETA` does not include permissions in `GA`, but you can specify both with `["GA", "BETA"]` for example. Can be a list of `"ALPHA"`, `"BETA"`, `"GA"`, `"DEPRECATED"`. Default is `["GA"]`.
    """
    __args__ = dict()
...
def get_testable_permissions_output(custom_support_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    full_resource_name: Optional[pulumi.Input[builtins.str]] = None,
                                    stages: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
