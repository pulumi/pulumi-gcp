...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] deployment_type: Parallelstore Instance deployment type.
               ...
               SCRATCH
               PERSISTENT
        :param pulumi.Input[_builtins.str] description: The description of the instance. 2048 characters or less.
        :param pulumi.Input[_builtins.str] directory_stripe_level: Stripe level for directories.
        ...
        :param pulumi.Input[_builtins.str] file_stripe_level: Stripe level for files.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Cloud Labels are a flexible and lightweight mechanism for
        ...
        :param pulumi.Input[_builtins.str] network: Immutable. The name of the Google Compute Engine [VPC network](https://cloud.google.com/vpc/docs/vpc)
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] effective_reserved_ip_range: Immutable. Contains the id of the allocated IP address
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Cloud Labels are a flexible and lightweight mechanism for
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: Part of `parent`. See documentation of `projectsId`.
        :param pulumi.Input[_builtins.str] name: Identifier. The resource name of the instance, in the format
        ...
        :param pulumi.Input[_builtins.str] reserved_ip_range: Immutable. Contains the id of the allocated IP address range
               ...
               associated with IP range 10.0.0.0/29. If no range id is provided all ranges will
               be considered.
        :param pulumi.Input[_builtins.str] state: The instance state.
               Possible values:
               STATE_UNSPECIFIED
               CREATING
               ACTIVE
...
class Instance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="accessPoints")
    def access_points(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Output only. List of access_points.
        Contains a list of IPv4 addresses used for client side configuration.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="daosVersion")
    def daos_version(self) -> pulumi.Output[_builtins.str]:
        """
        The version of DAOS software running in the instance.
        """
        return pulumi.get(self, "daos_version")
    ...
    @_builtins.property
    @pulumi.getter(name="directoryStripeLevel")
    def directory_stripe_level(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Stripe level for directories.
        MIN when directory has a small number of files.
        MAX when directory has a large number of files.
    ...
    @_builtins.property
    @pulumi.getter(name="fileStripeLevel")
    def file_stripe_level(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Stripe level for files.
        MIN better suited for small size files.
        MAX higher throughput performance for larger files.
    ...
    @_builtins.property
    @pulumi.getter(name="reservedIpRange")
    def reserved_ip_range(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Immutable. Contains the id of the allocated IP address range
        associated with the private service access connection for example, \\"test-default\\"
        associated with IP range 10.0.0.0/29. If no range id is provided all ranges will
