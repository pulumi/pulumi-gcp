...
def get_supported_database_flags(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The canonical id of the location. For example: `us-east1`.
...
def get_supported_database_flags_output(location: Optional[pulumi.Input[builtins.str]] = None,
