...
def get_supported_database_flags(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The canonical id of the location. For example: `us-east1`.
