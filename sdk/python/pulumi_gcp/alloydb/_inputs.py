...
class BackupEncryptionInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] encryption_type: (Output)
               Output only. Type of encryption.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] kms_key_versions: (Output)
               Output only. Cloud KMS key versions that are being used to protect the database or the backup.
        """
...
class BackupExpiryQuantityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] retention_count: (Output)
               Output only. The backup's position among its backups with the same source cluster and type, by descending chronological order create time (i.e. newest first).
        :param pulumi.Input[_builtins.int] total_retention_count: (Output)
               Output only. The length of the quantity-based queue, specified by the backup's retention policy.
        """
...
class ClusterAutomatedBackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] backup_window: The length of the time window during which a backup can be taken. If a backup does not succeed within this time window, it will be canceled and considered failed.
               The backup window must be at least 5 minutes long. There is no upper bound on the window. If not set, it will default to 1 hour.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        :param pulumi.Input[_builtins.bool] enabled: Whether automated backups are enabled.
        :param pulumi.Input['ClusterAutomatedBackupPolicyEncryptionConfigArgs'] encryption_config: EncryptionConfig describes the encryption config of a cluster or a backup that is encrypted with a CMEK (customer-managed encryption key).
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels to apply to backups created using this configuration.
        :param pulumi.Input[_builtins.str] location: The location where the backup will be stored. Currently, the only supported option is to store the backup in the same region as the cluster.
...
class ClusterAutomatedBackupPolicyWeeklyScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterAutomatedBackupPolicyWeeklyScheduleStartTimeArgs']]] start_times: The times during the day to start a backup. At least one start time must be provided. The start times are assumed to be in UTC and to be an exact hour (e.g., 04:00:00).
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] days_of_weeks: The days of the week to perform a backup. At least one day of the week must be provided.
               Each value may be one of: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        """
...
class ClusterAutomatedBackupPolicyWeeklyScheduleStartTimeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] nanos: Fractions of seconds in nanoseconds. Currently, only the value 0 is supported.
        :param pulumi.Input[_builtins.int] seconds: Seconds of minutes of the time. Currently, only the value 0 is supported.
        """
...
class ClusterContinuousBackupConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterContinuousBackupConfigEncryptionConfigArgs'] encryption_config: EncryptionConfig describes the encryption config of a cluster or a backup that is encrypted with a CMEK (customer-managed encryption key).
               Structure is documented below.
        :param pulumi.Input[_builtins.int] recovery_window_days: The numbers of days that are eligible to restore from using PITR. To support the entire recovery window, backups and logs are retained for one day more than the recovery window.
               If not set, defaults to 14 days.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class ClusterContinuousBackupInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] earliest_restorable_time: (Output)
               The earliest restorable time that can be restored to. Output only field.
        :param pulumi.Input[_builtins.str] enabled_time: (Output)
               When ContinuousBackup was most recently enabled. Set to null if ContinuousBackup is not enabled.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterContinuousBackupInfoEncryptionInfoArgs']]] encryption_infos: (Output)
               Output only. The encryption information for the WALs and backups required for ContinuousBackup.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] schedules: (Output)
               Days of the week on which a continuous backup is taken. Output only field. Ignored if passed into the request.
        """
...
class ClusterMaintenanceUpdatePolicyMaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] day: Preferred day of the week for maintenance, e.g. MONDAY, TUESDAY, etc.
               Possible values are: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
...
class ClusterMigrationSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_type: Type of migration source.
        """
...
class ClusterNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] allocated_ip_range: The name of the allocated IP range for the private IP AlloyDB cluster. For example: "google-managed-services-default".
               If set, the instance IPs for this cluster will be created in the allocated range.
        :param pulumi.Input[_builtins.str] network: The resource link for the VPC network in which cluster resources are created and from which they are accessible via Private IP. The network must belong to the same project as the cluster.
               It is specified in the form: "projects/{projectNumber}/global/networks/{network_id}".
        """
...
class ClusterRestoreBackupSourceArgs:
    def __init__(__self__, *,
                 backup_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] backup_name: The name of the backup that this cluster is restored from.
        """
        pulumi.set(__self__, "backup_name", backup_name)
...
class ClusterRestoreContinuousBackupSourceArgs:
    def __init__(__self__, *,
                 ...
                 point_in_time: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] cluster: The name of the source cluster that this cluster is restored from.
        :param pulumi.Input[_builtins.str] point_in_time: The point in time that this cluster is restored to, in RFC 3339 format.
        """
...
class ClusterSecondaryConfigArgs:
    def __init__(__self__, *,
                 primary_cluster_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] primary_cluster_name: Name of the primary cluster must be in the format
               'projects/{project}/locations/{location}/clusters/{cluster_id}'
        """
...
class ClusterTrialMetadataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] start_time: Start time of the trial cluster.
        :param pulumi.Input[_builtins.str] upgrade_time: Upgrade time of the trial cluster to standard cluster.
        """
...
class InstanceNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceNetworkConfigAuthorizedExternalNetworkArgs']]] authorized_external_networks: A list of external networks authorized to access this instance. This
               ...
               true.
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] enable_outbound_public_ip: Enabling outbound public ip for the instance.
        :param pulumi.Input[_builtins.bool] enable_public_ip: Enabling public ip for the instance. If a user wishes to disable this,
               please also clear the list of the authorized external networks set on
               the same instance.
        """
...
class InstanceObservabilityConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_query_string_length: Query string length. The default value is 10240. Any integer between 1024 and 100000 is considered valid.
        :param pulumi.Input[_builtins.bool] preserve_comments: Preserve comments in the query string.
        :param pulumi.Input[_builtins.int] query_plans_per_minute: Number of query execution plans captured by Insights per minute for all queries combined. The default value is 5. Any integer between 0 and 200 is considered valid.
        :param pulumi.Input[_builtins.bool] record_application_tags: Record application tags for an instance. This flag is turned "on" by default.
        :param pulumi.Input[_builtins.bool] track_active_queries: Track actively running queries. If not set, default value is "off".
        :param pulumi.Input[_builtins.bool] track_client_address: Track client address for an instance. If not set, default value is "off".
        :param pulumi.Input[_builtins.bool] track_wait_event_types: Record wait event types during query execution for an instance.
        :param pulumi.Input[_builtins.bool] track_wait_events: Record wait events during query execution for an instance.
        """
...
class InstancePscInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstancePscInstanceConfigPscAutoConnectionArgs']]] psc_auto_connections: Configurations for setting up PSC service automation.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] psc_dns_name: (Output)
               The DNS name of the instance for PSC connectivity.
               Name convention: <uid>.<uid>.<region>.alloydb-psc.goog
        :param pulumi.Input[Sequence[pulumi.Input['InstancePscInstanceConfigPscInterfaceConfigArgs']]] psc_interface_configs: Configurations for setting up PSC interfaces attached to the instance
               which are used for outbound connectivity. Currently, AlloyDB supports only 0 or 1 PSC interface.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] service_attachment_link: (Output)
               The service attachment created when Private Service Connect (PSC) is enabled for the instance.
               The name of the resource will be in the format of
               `projects/<alloydb-tenant-project-number>/regions/<region-name>/serviceAttachments/<service-attachment-name>`
        """
...
class InstancePscInstanceConfigPscAutoConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] consumer_network: The consumer network for the PSC service automation, example:
               ...
               consumer project. The API expects the consumer project specified to be
               the project ID (and not the project number)
        :param pulumi.Input[_builtins.str] consumer_network_status: (Output)
               The status of the service connection policy.
        :param pulumi.Input[_builtins.str] consumer_project: The consumer project to which the PSC service automation endpoint will
               be created. The API expects the consumer project to be the project ID(
               and not the project number).
...
class InstanceQueryInsightsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] record_application_tags: Record application tags for an instance. This flag is turned "on" by default.
        :param pulumi.Input[_builtins.bool] record_client_address: Record client address for an instance. Client address is PII information. This flag is turned "on" by default.
        """
        if query_plans_per_minute is not None:
            pulumi.set(__self__, "query_plans_per_minute", query_plans_per_minute)
