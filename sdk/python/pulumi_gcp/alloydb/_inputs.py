...
class BackupEncryptionConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_name: The fully-qualified resource name of the KMS key. Each Cloud KMS key is regionalized and has the following format: projects/[PROJECT]/locations/[REGION]/keyRings/[RING]/cryptoKeys/[KEY_NAME].
        """
...
if not MYPY:
    class BackupEncryptionInfoArgsDict(TypedDict):
        ...
        """
        kms_key_versions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        (Output)
...
class BackupEncryptionInfoArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_versions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] encryption_type: (Output)
               Output only. Type of encryption.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] kms_key_versions: (Output)
               Output only. Cloud KMS key versions that are being used to protect the database or the backup.
        """
    ...
    def kms_key_versions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Output)
        Output only. Cloud KMS key versions that are being used to protect the database or the backup.
        """
    ...
    def kms_key_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "kms_key_versions", value)


if not MYPY:
    class BackupExpiryQuantityArgsDict(TypedDict):
        retention_count: NotRequired[pulumi.Input[builtins.int]]
        """
        (Output)
        Output only. The backup's position among its backups with the same source cluster and type, by descending chronological order create time (i.e. newest first).
        """
        total_retention_count: NotRequired[pulumi.Input[builtins.int]]
        """
        (Output)
...
class BackupExpiryQuantityArgs:
    def __init__(__self__, *,
                 retention_count: Optional[pulumi.Input[builtins.int]] = None,
                 total_retention_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] retention_count: (Output)
               Output only. The backup's position among its backups with the same source cluster and type, by descending chronological order create time (i.e. newest first).
        :param pulumi.Input[builtins.int] total_retention_count: (Output)
               Output only. The length of the quantity-based queue, specified by the backup's retention policy.
        """
    ...
    def retention_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Output)
        Output only. The backup's position among its backups with the same source cluster and type, by descending chronological order create time (i.e. newest first).
        """
    ...
    def retention_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retention_count", value)

    @property
    @pulumi.getter(name="totalRetentionCount")
    def total_retention_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Output)
        Output only. The length of the quantity-based queue, specified by the backup's retention policy.
        """
    ...
    def total_retention_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_retention_count", value)


if not MYPY:
    class ClusterAutomatedBackupPolicyArgsDict(TypedDict):
        backup_window: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterAutomatedBackupPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] backup_window: The length of the time window during which a backup can be taken. If a backup does not succeed within this time window, it will be canceled and considered failed.
               The backup window must be at least 5 minutes long. There is no upper bound on the window. If not set, it will default to 1 hour.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        :param pulumi.Input[builtins.bool] enabled: Whether automated backups are enabled.
        :param pulumi.Input['ClusterAutomatedBackupPolicyEncryptionConfigArgs'] encryption_config: EncryptionConfig describes the encryption config of a cluster or a backup that is encrypted with a CMEK (customer-managed encryption key).
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels to apply to backups created using this configuration.
        :param pulumi.Input[builtins.str] location: The location where the backup will be stored. Currently, the only supported option is to store the backup in the same region as the cluster.
...
class ClusterAutomatedBackupPolicyQuantityBasedRetentionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] count: The number of backups to retain.
        """
...
class ClusterAutomatedBackupPolicyTimeBasedRetentionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] retention_period: The retention period.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
...
class ClusterAutomatedBackupPolicyWeeklyScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterAutomatedBackupPolicyWeeklyScheduleStartTimeArgs']]] start_times: The times during the day to start a backup. At least one start time must be provided. The start times are assumed to be in UTC and to be an exact hour (e.g., 04:00:00).
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days_of_weeks: The days of the week to perform a backup. At least one day of the week must be provided.
               Each value may be one of: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        """
...
class ClusterAutomatedBackupPolicyWeeklyScheduleStartTimeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] hours: Hours of day in 24 hour format. Should be from 0 to 23. An API may choose to allow the value "24:00:00" for scenarios like business closing time.
        :param pulumi.Input[builtins.int] minutes: Minutes of hour of day. Currently, only the value 0 is supported.
        :param pulumi.Input[builtins.int] nanos: Fractions of seconds in nanoseconds. Currently, only the value 0 is supported.
        :param pulumi.Input[builtins.int] seconds: Seconds of minutes of the time. Currently, only the value 0 is supported.
        """
...
class ClusterBackupSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] backup_name: The name of the backup resource.
        """
...
if not MYPY:
    class ClusterContinuousBackupConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        recovery_window_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ClusterContinuousBackupConfigArgs:
    def __init__(__self__, *,
                 ...
                 recovery_window_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether continuous backup recovery is enabled. If not set, defaults to true.
        :param pulumi.Input['ClusterContinuousBackupConfigEncryptionConfigArgs'] encryption_config: EncryptionConfig describes the encryption config of a cluster or a backup that is encrypted with a CMEK (customer-managed encryption key).
               Structure is documented below.
        :param pulumi.Input[builtins.int] recovery_window_days: The numbers of days that are eligible to restore from using PITR. To support the entire recovery window, backups and logs are retained for one day more than the recovery window.
               If not set, defaults to 14 days.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def recovery_window_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The numbers of days that are eligible to restore from using PITR. To support the entire recovery window, backups and logs are retained for one day more than the recovery window.
        If not set, defaults to 14 days.
        """
    ...
    def recovery_window_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ClusterContinuousBackupInfoArgsDict(TypedDict):
        earliest_restorable_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        ...
        Structure is documented below.
        """
        schedules: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        (Output)
...
class ClusterContinuousBackupInfoArgs:
    def __init__(__self__, *,
                 earliest_restorable_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] earliest_restorable_time: (Output)
               The earliest restorable time that can be restored to. Output only field.
        :param pulumi.Input[builtins.str] enabled_time: (Output)
               When ContinuousBackup was most recently enabled. Set to null if ContinuousBackup is not enabled.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterContinuousBackupInfoEncryptionInfoArgs']]] encryption_infos: (Output)
               Output only. The encryption information for the WALs and backups required for ContinuousBackup.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schedules: (Output)
               Days of the week on which a continuous backup is taken. Output only field. Ignored if passed into the request.
        """
    ...
    def earliest_restorable_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The earliest restorable time that can be restored to. Output only field.
        """
    ...
    def earliest_restorable_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterMaintenanceUpdatePolicyMaintenanceWindowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] day: Preferred day of the week for maintenance, e.g. MONDAY, TUESDAY, etc.
               Possible values are: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
...
class ClusterMigrationSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host_port: The host and port of the on-premises instance in host:port format
        :param pulumi.Input[builtins.str] reference_id: Place holder for the external source identifier(e.g DMS job name) that created the cluster.
        :param pulumi.Input[builtins.str] source_type: Type of migration source.
        """
...
class ClusterNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] allocated_ip_range: The name of the allocated IP range for the private IP AlloyDB cluster. For example: "google-managed-services-default".
               If set, the instance IPs for this cluster will be created in the allocated range.
        :param pulumi.Input[builtins.str] network: The resource link for the VPC network in which cluster resources are created and from which they are accessible via Private IP. The network must belong to the same project as the cluster.
               It is specified in the form: "projects/{projectNumber}/global/networks/{network_id}".
        """
...
if not MYPY:
    class ClusterPscConfigArgsDict(TypedDict):
        ...
        """
        service_owned_project_number: NotRequired[pulumi.Input[builtins.int]]
        """
        (Output)
...
class ClusterPscConfigArgs:
    def __init__(__self__, *,
                 ...
                 service_owned_project_number: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] psc_enabled: Create an instance that allows connections from Private Service Connect endpoints to the instance.
        :param pulumi.Input[builtins.int] service_owned_project_number: (Output)
               The project number that needs to be allowlisted on the network attachment to enable outbound connectivity, if the network attachment is configured to ACCEPT_MANUAL connections.
               In case the network attachment is configured to ACCEPT_AUTOMATIC, this project number does not need to be allowlisted explicitly.
        """
    ...
    def service_owned_project_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Output)
        The project number that needs to be allowlisted on the network attachment to enable outbound connectivity, if the network attachment is configured to ACCEPT_MANUAL connections.
        In case the network attachment is configured to ACCEPT_AUTOMATIC, this project number does not need to be allowlisted explicitly.
    ...
    def service_owned_project_number(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "service_owned_project_number", value)


if not MYPY:
    class ClusterRestoreBackupSourceArgsDict(TypedDict):
        backup_name: pulumi.Input[builtins.str]
        """
...
class ClusterRestoreBackupSourceArgs:
    def __init__(__self__, *,
                 backup_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] backup_name: The name of the backup that this cluster is restored from.
        """
        pulumi.set(__self__, "backup_name", backup_name)

    @property
    @pulumi.getter(name="backupName")
    def backup_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the backup that this cluster is restored from.
        """
        return pulumi.get(self, "backup_name")
    ...
    @backup_name.setter
    def backup_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "backup_name", value)
...
if not MYPY:
    class ClusterRestoreContinuousBackupSourceArgsDict(TypedDict):
        ...
        """
        point_in_time: pulumi.Input[builtins.str]
        """
...
class ClusterRestoreContinuousBackupSourceArgs:
    def __init__(__self__, *,
                 ...
                 point_in_time: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] cluster: The name of the source cluster that this cluster is restored from.
        :param pulumi.Input[builtins.str] point_in_time: The point in time that this cluster is restored to, in RFC 3339 format.
        """
    ...
    def point_in_time(self) -> pulumi.Input[builtins.str]:
        """
        The point in time that this cluster is restored to, in RFC 3339 format.
        """
    ...
    def point_in_time(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "point_in_time", value)


if not MYPY:
    class ClusterSecondaryConfigArgsDict(TypedDict):
        primary_cluster_name: pulumi.Input[builtins.str]
        """
...
class ClusterSecondaryConfigArgs:
    def __init__(__self__, *,
                 primary_cluster_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] primary_cluster_name: Name of the primary cluster must be in the format
               'projects/{project}/locations/{location}/clusters/{cluster_id}'
        """
    ...
    def primary_cluster_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of the primary cluster must be in the format
        'projects/{project}/locations/{location}/clusters/{cluster_id}'
        """
    ...
    def primary_cluster_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ClusterTrialMetadataArgsDict(TypedDict):
        ...
        """
        grace_end_time: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        upgrade_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterTrialMetadataArgs:
    def __init__(__self__, *,
                 ...
                 grace_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 start_time: Optional[pulumi.Input[builtins.str]] = None,
                 upgrade_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] end_time: End time of the trial cluster.
        :param pulumi.Input[builtins.str] grace_end_time: Grace end time of the trial cluster.
        :param pulumi.Input[builtins.str] start_time: Start time of the trial cluster.
        :param pulumi.Input[builtins.str] upgrade_time: Upgrade time of the trial cluster to standard cluster.
        """
    ...
    def grace_end_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Grace end time of the trial cluster.
        """
    ...
    def grace_end_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstanceClientConnectionConfigArgsDict(TypedDict):
        require_connectors: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class InstanceClientConnectionConfigArgs:
    def __init__(__self__, *,
                 require_connectors: Optional[pulumi.Input[builtins.bool]] = None,
                 ssl_config: Optional[pulumi.Input['InstanceClientConnectionConfigSslConfigArgs']] = None):
        """
        :param pulumi.Input[builtins.bool] require_connectors: Configuration to enforce connectors only (ex: AuthProxy) connections to the database.
    ...
    def require_connectors(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Configuration to enforce connectors only (ex: AuthProxy) connections to the database.
        """
    ...
    def require_connectors(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class InstanceClientConnectionConfigSslConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] ssl_mode: SSL mode. Specifies client-server SSL/TLS connection behavior.
               Possible values are: `ENCRYPTED_ONLY`, `ALLOW_UNENCRYPTED_AND_ENCRYPTED`.
        """
...
if not MYPY:
    class InstanceNetworkConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        enable_outbound_public_ip: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enabling outbound public ip for the instance.
        """
        enable_public_ip: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class InstanceNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceNetworkConfigAuthorizedExternalNetworkArgs']]] authorized_external_networks: A list of external networks authorized to access this instance. This
               ...
               true.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] enable_outbound_public_ip: Enabling outbound public ip for the instance.
        :param pulumi.Input[builtins.bool] enable_public_ip: Enabling public ip for the instance. If a user wishes to disable this,
               please also clear the list of the authorized external networks set on
               the same instance.
        """
    ...
    def enable_outbound_public_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enabling outbound public ip for the instance.
        """
    ...
    def enable_outbound_public_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class InstanceNetworkConfigAuthorizedExternalNetworkArgsDict(TypedDict):
        cidr_range: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceNetworkConfigAuthorizedExternalNetworkArgs:
    def __init__(__self__, *,
                 cidr_range: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cidr_range: CIDR range for one authorized network of the instance.
        """
    ...
    def cidr_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        CIDR range for one authorized network of the instance.
        """
    ...
    @cidr_range.setter
    def cidr_range(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstanceObservabilityConfigArgsDict(TypedDict):
        ...
        """
        max_query_string_length: NotRequired[pulumi.Input[builtins.int]]
        """
        Query string length. The default value is 10240. Any integer between 1024 and 100000 is considered valid.
        """
        preserve_comments: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        track_active_queries: NotRequired[pulumi.Input[builtins.bool]]
        """
        Track actively running queries. If not set, default value is "off".
        """
        track_wait_event_types: NotRequired[pulumi.Input[builtins.bool]]
        """
        Record wait event types during query execution for an instance.
        """
        track_wait_events: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class InstanceObservabilityConfigArgs:
    def __init__(__self__, *,
                 ...
                 track_active_queries: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] query_plans_per_minute: Number of query execution plans captured by Insights per minute for all queries combined. The default value is 5. Any integer between 0 and 200 is considered valid.
        :param pulumi.Input[builtins.bool] record_application_tags: Record application tags for an instance. This flag is turned "on" by default.
        :param pulumi.Input[builtins.bool] track_active_queries: Track actively running queries. If not set, default value is "off".
    ...
    def max_query_string_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Query string length. The default value is 10240. Any integer between 1024 and 100000 is considered valid.
        """
    ...
    def max_query_string_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_query_string_length", value)

    @property
    @pulumi.getter(name="preserveComments")
    def preserve_comments(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Preserve comments in the query string.
        """
    ...
    def preserve_comments(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def track_active_queries(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Track actively running queries. If not set, default value is "off".
        """
    ...
    def track_active_queries(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "track_active_queries", value)

    @property
    @pulumi.getter(name="trackWaitEventTypes")
    def track_wait_event_types(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Record wait event types during query execution for an instance.
        """
    ...
    def track_wait_event_types(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "track_wait_event_types", value)

    @property
    @pulumi.getter(name="trackWaitEvents")
    def track_wait_events(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Record wait events during query execution for an instance.
        """
    ...
    def track_wait_events(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class InstancePscInstanceConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        service_attachment_link: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class InstancePscInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstancePscInstanceConfigPscInterfaceConfigArgs']]] psc_interface_configs: Configurations for setting up PSC interfaces attached to the instance
               which are used for outbound connectivity. Currently, AlloyDB supports only 0 or 1 PSC interface.
               Structure is documented below.
        :param pulumi.Input[builtins.str] service_attachment_link: (Output)
               The service attachment created when Private Service Connect (PSC) is enabled for the instance.
               The name of the resource will be in the format of
               `projects/<alloydb-tenant-project-number>/regions/<region-name>/serviceAttachments/<service-attachment-name>`
        """
    ...
    @psc_dns_name.setter
    def psc_dns_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_attachment_link(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The service attachment created when Private Service Connect (PSC) is enabled for the instance.
        The name of the resource will be in the format of
...
class InstancePscInstanceConfigPscInterfaceConfigArgs:
    def __init__(__self__, *,
                 network_attachment_resource: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] network_attachment_resource: The network attachment resource created in the consumer project to which the PSC interface will be linked.
               This is of the format: "projects/${CONSUMER_PROJECT}/regions/${REGION}/networkAttachments/${NETWORK_ATTACHMENT_NAME}".
               The network attachment must be in the same region as the instance.
        """
    ...
    def network_attachment_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The network attachment resource created in the consumer project to which the PSC interface will be linked.
        This is of the format: "projects/${CONSUMER_PROJECT}/regions/${REGION}/networkAttachments/${NETWORK_ATTACHMENT_NAME}".
        The network attachment must be in the same region as the instance.
    ...
    def network_attachment_resource(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceQueryInsightsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] query_plans_per_minute: Number of query execution plans captured by Insights per minute for all queries combined. The default value is 5. Any integer between 0 and 20 is considered valid.
        :param pulumi.Input[builtins.int] query_string_length: Query string length. The default value is 1024. Any integer between 256 and 4500 is considered valid.
        :param pulumi.Input[builtins.bool] record_application_tags: Record application tags for an instance. This flag is turned "on" by default.
        :param pulumi.Input[builtins.bool] record_client_address: Record client address for an instance. Client address is PII information. This flag is turned "on" by default.
        """
        if query_plans_per_minute is not None:
            pulumi.set(__self__, "query_plans_per_minute", query_plans_per_minute)
...
class InstanceReadPoolConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] node_count: Read capacity, i.e. number of nodes in a read pool instance.
        """
