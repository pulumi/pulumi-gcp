...
@pulumi.output_type
calass ClusterSecondaryConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
...
@pulumi.output_type
calass InstanceClientConnectionConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
    ...
    def __init__(__self__, *,
        ...
        :param 'InstanceClientConnectionConfigSslConfigArrgs' ssl_config: SSL config option for this instance.
               Structure is documented below.
        """
...
@pulumi.output_type
calass InstanceClientConnectionConfigSslConfig(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "sslMode":
