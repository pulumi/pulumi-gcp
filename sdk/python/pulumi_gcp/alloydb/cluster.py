...
class ClusterArgs:
    ...
    def skip_await_major_version_upgrade(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def skip_await_major_version_upgrade(self, value: Optional[pulumi.Input[_builtins.bool]]):
