...
class _BackupState:
    ...
    def _configure(
        ...
        if cluster_name is None and 'clusterName' in kwargs:
            cluster_name = kwargs['clusterName']
        if cluster_uid is None and 'clusterUid' in kwargs:
            cluster_uid = kwargs['clusterUid']
        ...
        if expiry_quantities is None and 'expiryQuantities' in kwargs:
            expiry_quantities = kwargs['expiryQuantities']
        ...
        if cluster_uid is not None:
            _setter("cluster_uid", cluster_uid)
        ...
        if expiry_quantities is not None:
            _setter("expiry_quantities", expiry_quantities)
