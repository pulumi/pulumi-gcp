...
class BackupArgs:
    def __init__(__self__, *,
                 ...
                 encryption_config: pulumi.Input[Optional['BackupEncryptionConfigArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] type: The backup type, which suggests the trigger for the backup.
    ...
    def encryption_config(self) -> pulumi.Input[Optional['BackupEncryptionConfigArgs']]:
        """
    ...
    def encryption_config(self, value: pulumi.Input[Optional['BackupEncryptionConfigArgs']]):
...
class _BackupState:
    def __init__(__self__, *,
                 ...
                 cluster_uid: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 encryption_config: pulumi.Input[Optional['BackupEncryptionConfigArgs']] = None,
                 encryption_infos: pulumi.Input[Optional[Sequence[pulumi.Input['BackupEncryptionInfoArgs']]]] = None,
                 etag: pulumi.Input[Optional[_builtins.str]] = None,
                 expiry_quantities: pulumi.Input[Optional[Sequence[pulumi.Input['BackupExpiryQuantityArgs']]]] = None,
                 ...
                 size_bytes: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] backup_id: The ID of the alloydb backup.
        :param pulumi.Input[_builtins.str] cluster_name: The full resource name of the backup source cluster (e.g., projects/{project}/locations/{location}/clusters/{clusterId}).
        :param pulumi.Input[_builtins.str] cluster_uid: Output only. The system-generated UID of the cluster which was used to create this resource.
        ...
        :param pulumi.Input[_builtins.str] delete_time: Output only. Delete time stamp. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
               Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: User-defined labels for the alloydb backup. An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location where the alloydb backup should reside.
        :param pulumi.Input[_builtins.str] name: Output only. The name of the backup resource with the format: * projects/{project}/locations/{region}/backups/{backupId}
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        ...
        :param pulumi.Input[_builtins.str] state: Output only. The current state of the backup.
        :param pulumi.Input[_builtins.str] type: The backup type, which suggests the trigger for the backup.
               Possible values are: `TYPE_UNSPECIFIED`, `ON_DEMAND`, `AUTOMATED`, `CONTINUOUS`.
        :param pulumi.Input[_builtins.str] uid: Output only. The system-generated UID of the resource. The UID is assigned when the resource is created, and it is retained until it is deleted.
    ...
    def cluster_uid(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @cluster_uid.setter
    def cluster_uid(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def encryption_infos(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BackupEncryptionInfoArgs']]]]:
        """
    ...
    def encryption_infos(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BackupEncryptionInfoArgs']]]]):
    ...
    def expiry_quantities(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BackupExpiryQuantityArgs']]]]:
        """
    ...
    def expiry_quantities(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BackupExpiryQuantityArgs']]]]):
    ...
    def size_bytes(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @size_bytes.setter
    def size_bytes(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Backup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: pulumi.Input[Optional[_builtins.str]] = None,
            uid: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'Backup':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="clusterUid")
    def cluster_uid(self) -> pulumi.Output[_builtins.str]:
        """
        Output only. The system-generated UID of the cluster which was used to create this resource.
        """
        return pulumi.get(self, "cluster_uid")
    ...
    @_builtins.property
    @pulumi.getter(name="sizeBytes")
    def size_bytes(self) -> pulumi.Output[_builtins.str]:
        """
        Output only. The size of the backup in bytes.
        """
        return pulumi.get(self, "size_bytes")
