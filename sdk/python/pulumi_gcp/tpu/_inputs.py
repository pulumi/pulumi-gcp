...
class V2QueuedResourceTpuNodeSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['V2QueuedResourceTpuNodeSpecNodeArgs'] node: The node.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] parent: The parent resource name.
        :param pulumi.Input[_builtins.str] node_id: Unqualified node identifier used to identify the node in the project once provisioned.
        """
...
class V2QueuedResourceTpuNodeSpecNodeNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] can_ip_forward: Allows the TPU node to send and receive packets with non-matching destination or source
               IPs. This is required if you plan to use the TPU workers to forward routes.
        :param pulumi.Input[_builtins.bool] enable_external_ips: Indicates that external IP addresses would be associated with the TPU workers. If set to
               false, the specified subnetwork or network should have Private Google Access enabled.
        :param pulumi.Input[_builtins.str] network: The name of the network for the TPU node. It must be a preexisting Google Compute Engine
               network. If none is provided, "default" will be used.
        :param pulumi.Input[_builtins.int] queue_count: Specifies networking queue count for TPU VM instance's network interface.
        :param pulumi.Input[_builtins.str] subnetwork: The name of the subnetwork for the TPU node. It must be a preexisting Google Compute
               Engine subnetwork. If none is provided, "default" will be used.
        """
...
class V2VmAcceleratorConfigArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] topology: Topology of TPU in chips.
        :param pulumi.Input[_builtins.str] type: Type of TPU. Please select one of the allowed types: https://cloud.google.com/tpu/docs/reference/rest/v2/AcceleratorConfig#Type
        """
    ...
    @topology.setter
    def topology(self, value: pulumi.Input[_builtins.str]):
...
class V2VmDataDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] source_disk: Specifies the full path to an existing disk. For example:
               "projects/my-project/zones/us-central1-c/disks/my-disk".
        :param pulumi.Input[_builtins.str] mode: The mode in which to attach this disk. If not specified, the default is READ_WRITE
               mode. Only applicable to dataDisks.
               Default value is `READ_WRITE`.
               Possible values are: `READ_WRITE`, `READ_ONLY`.
        """
...
class V2VmSchedulingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] spot: Optional. Defines whether the node is Spot VM.
        """
...
class V2VmShieldedInstanceConfigArgs:
    def __init__(__self__, *,
                 enable_secure_boot: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enable_secure_boot: Defines whether the instance has Secure Boot enabled.
        """
    ...
    def enable_secure_boot(self, value: pulumi.Input[_builtins.bool]):
...
class V2VmSymptomArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] details: (Output)
               Detailed information of the current Symptom.
        :param pulumi.Input[_builtins.str] symptom_type: (Output)
               Type of the Symptom.
        :param pulumi.Input[_builtins.str] worker_id: (Output)
               A string used to uniquely distinguish a worker within a TPU node.
        """
