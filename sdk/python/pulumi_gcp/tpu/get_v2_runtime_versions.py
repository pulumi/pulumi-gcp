...
def get_v2_runtime_versions(project: Optional[builtins.str] = None,
...
def get_v2_runtime_versions_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
