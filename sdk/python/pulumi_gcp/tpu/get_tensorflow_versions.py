...
def get_tensorflow_versions(project: Optional[builtins.str] = None,
    ...
    :param builtins.str project: The project to list versions for. If it
           is not provided, the provider project is used.
    :param builtins.str zone: The zone to list versions for. If it
...
def get_tensorflow_versions_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
