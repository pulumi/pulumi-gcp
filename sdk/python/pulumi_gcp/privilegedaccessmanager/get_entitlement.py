...
def get_entitlement(entitlement_id: Optional[_builtins.str] = None,
    ...
    * How-to guides
    ...
    :param _builtins.str entitlement_id: ID of the Entitlement resource. This is the last part of the Entitlement's full name which is of the format `{parent}/locations/{location}/entitlements/{entitlement_id}`.
    :param _builtins.str location: The region of the Entitlement resource.
    :param _builtins.str parent: The project or folder or organization that contains the resource. Format: projects/{project-id|project-number} or folders/{folder-number}  or organizations/{organization-number}
    """
    __args__ = dict()
