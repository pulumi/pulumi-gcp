...
class GetEntitlementResult:
    ...
    def entitlement_id(self) -> Optional[builtins.str]:
...
def get_entitlement(entitlement_id: Optional[builtins.str] = None,
    ...
    * How-to guides
    ...
    :param builtins.str entitlement_id: ID of the Entitlement resource. This is the last part of the Entitlement's full name which is of the format `{parent}/locations/{location}/entitlements/{entitlement_id}`.
    :param builtins.str location: The region of the Entitlement resource.
    :param builtins.str parent: The project or folder or organization that contains the resource. Format: projects/{project-id|project-number} or folders/{folder-number}  or organizations/{organization-number}
    """
    __args__ = dict()
...
def get_entitlement_output(entitlement_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
