...
class AssetDiscoverySpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Required. Whether discovery is enabled.
        :param pulumi.Input['AssetDiscoverySpecCsvOptionsArgs'] csv_options: Optional. Configuration for CSV data.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_patterns: Optional. The list of patterns to apply for selecting data to exclude during discovery. For Cloud Storage bucket assets, these are interpreted as glob patterns used to match object names. For BigQuery dataset assets, these are interpreted as patterns to match table names.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_patterns: Optional. The list of patterns to apply for selecting data to include during discovery if only a subset of the data should considered. For Cloud Storage bucket assets, these are interpreted as glob patterns used to match object names. For BigQuery dataset assets, these are interpreted as patterns to match table names.
        :param pulumi.Input['AssetDiscoverySpecJsonOptionsArgs'] json_options: Optional. Configuration for Json data.
        :param pulumi.Input[builtins.str] schedule: Optional. Cron schedule (https://en.wikipedia.org/wiki/Cron) for running discovery periodically. Successive discovery runs must be scheduled at least 60 minutes apart. The default value is to run discovery every 60 minutes. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: "CRON_TZ=${IANA_TIME_ZONE}" or TZ=${IANA_TIME_ZONE}". The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, "CRON_TZ=America/New_York 1 * * * *", or "TZ=America/New_York 1 * * * *".
        """
...
if not MYPY:
    class AssetDiscoverySpecCsvOptionsArgsDict(TypedDict):
        ...
        """
        disable_type_inference: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AssetDiscoverySpecCsvOptionsArgs:
    def __init__(__self__, *,
                 ...
                 disable_type_inference: Optional[pulumi.Input[builtins.bool]] = None,
                 encoding: Optional[pulumi.Input[builtins.str]] = None,
                 header_rows: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] delimiter: Optional. The delimiter being used to separate values. This defaults to ','.
        :param pulumi.Input[builtins.bool] disable_type_inference: Optional. Whether to disable the inference of data type for CSV data. If true, all columns will be registered as strings.
        :param pulumi.Input[builtins.str] encoding: Optional. The character encoding of the data. The default is UTF-8.
        :param pulumi.Input[builtins.int] header_rows: Optional. The number of rows to interpret as header rows that should be skipped when reading data rows.
        """
    ...
    def disable_type_inference(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Optional. Whether to disable the inference of data type for CSV data. If true, all columns will be registered as strings.
        """
    ...
    def disable_type_inference(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AssetDiscoverySpecJsonOptionsArgs:
    def __init__(__self__, *,
                 ...
                 encoding: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] disable_type_inference: Optional. Whether to disable the inference of data type for Json data. If true, all columns will be registered as their primitive types (strings, number or boolean).
        :param pulumi.Input[builtins.str] encoding: Optional. The character encoding of the data. The default is UTF-8.
        """
        if disable_type_inference is not None:
            pulumi.set(__self__, "disable_type_inference", disable_type_inference)
...
if not MYPY:
    class AssetDiscoveryStatusArgsDict(TypedDict):
        last_run_duration: NotRequired[pulumi.Input[builtins.str]]
        """
        The duration of the last discovery run.
        """
        last_run_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AssetDiscoveryStatusArgs:
    def __init__(__self__, *,
                 last_run_duration: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] last_run_duration: The duration of the last discovery run.
        :param pulumi.Input[builtins.str] last_run_time: The start time of the last discovery run.
        :param pulumi.Input[builtins.str] message: Additional information about the current state.
        :param pulumi.Input[builtins.str] state: Output only. Current state of the asset. Possible values: STATE_UNSPECIFIED, ACTIVE, CREATING, DELETING, ACTION_REQUIRED
        ...
        :param pulumi.Input[builtins.str] update_time: Output only. The time when the asset was last updated.
        """
    ...
    def last_run_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The duration of the last discovery run.
        """
    ...
    def last_run_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AssetDiscoveryStatusStatArgsDict(TypedDict):
        data_items: NotRequired[pulumi.Input[builtins.int]]
        """
        The count of data items within the referenced resource.
        """
        data_size: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of stored data bytes within the referenced resource.
        """
        filesets: NotRequired[pulumi.Input[builtins.int]]
        """
        The count of fileset entities within the referenced resource.
        """
        tables: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AssetDiscoveryStatusStatArgs:
    def __init__(__self__, *,
                 data_items: Optional[pulumi.Input[builtins.int]] = None,
                 data_size: Optional[pulumi.Input[builtins.int]] = None,
                 filesets: Optional[pulumi.Input[builtins.int]] = None,
                 tables: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] data_items: The count of data items within the referenced resource.
        :param pulumi.Input[builtins.int] data_size: The number of stored data bytes within the referenced resource.
        :param pulumi.Input[builtins.int] filesets: The count of fileset entities within the referenced resource.
        :param pulumi.Input[builtins.int] tables: The count of table entities within the referenced resource.
        """
    ...
    def data_items(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The count of data items within the referenced resource.
        """
    ...
    @data_items.setter
    def data_items(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def filesets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The count of fileset entities within the referenced resource.
        """
    ...
    @filesets.setter
    def filesets(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "filesets", value)

    @property
    @pulumi.getter
    def tables(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The count of table entities within the referenced resource.
        """
    ...
    @tables.setter
    def tables(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AssetResourceSpecArgsDict(TypedDict):
        ...
        """
        read_access_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AssetResourceSpecArgs:
    def __init__(__self__, *,
                 ...
                 read_access_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Required. Immutable. Type of resource. Possible values: STORAGE_BUCKET, BIGQUERY_DATASET
               
               - - -
        :param pulumi.Input[builtins.str] name: Immutable. Relative name of the cloud resource that contains the data that is being managed within a lake. For example: `projects/{project_number}/buckets/{bucket_id}` `projects/{project_number}/datasets/{dataset_id}`
        :param pulumi.Input[builtins.str] read_access_mode: Optional. Determines how read permissions are handled for each asset and their associated tables. Only available to storage buckets assets. Possible values: DIRECT, MANAGED
        """
    ...
    def read_access_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Optional. Determines how read permissions are handled for each asset and their associated tables. Only available to storage buckets assets. Possible values: DIRECT, MANAGED
        """
    ...
    def read_access_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DatascanDataArgsDict(TypedDict):
        entity: NotRequired[pulumi.Input[builtins.str]]
        """
...
if not MYPY:
    class DatascanDataProfileSpecArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        row_filter: NotRequired[pulumi.Input[builtins.str]]
        """
        A filter applied to all rows in a single DataScan job. The filter needs to be a valid SQL expression for a WHERE clause in BigQuery standard SQL syntax. Example: col1 >= 0 AND col2 < 10
        """
        sampling_percent: NotRequired[pulumi.Input[builtins.float]]
        """
...
class DatascanDataProfileSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] sampling_percent: The percentage of the records to be selected from the dataset for DataScan.
               Value can range between 0.0 and 100.0 with up to 3 significant decimal digits.
               Sampling is not applied if `sampling_percent` is not specified, 0 or 100.
        """
    ...
    def row_filter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A filter applied to all rows in a single DataScan job. The filter needs to be a valid SQL expression for a WHERE clause in BigQuery standard SQL syntax. Example: col1 >= 0 AND col2 < 10
        """
    ...
    @row_filter.setter
    def row_filter(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "row_filter", value)

    @property
    @pulumi.getter(name="samplingPercent")
    def sampling_percent(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The percentage of the records to be selected from the dataset for DataScan.
        Value can range between 0.0 and 100.0 with up to 3 significant decimal digits.
        Sampling is not applied if `sampling_percent` is not specified, 0 or 100.
    ...
    def sampling_percent(self, value: Optional[pulumi.Input[builtins.float]]):
...
class DatascanDataProfileSpecExcludeFieldsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] field_names: Expected input is a list of fully qualified names of fields as in the schema.
               Only top-level field names for nested fields are supported.
               For instance, if 'x' is of nested field type, listing 'x' is supported but 'x.y.z' is not supported. Here 'y' and 'y.z' are nested fields of 'x'.
        """
...
if not MYPY:
    class DatascanDataProfileSpecPostScanActionsBigqueryExportArgsDict(TypedDict):
        results_table: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatascanDataProfileSpecPostScanActionsBigqueryExportArgs:
    def __init__(__self__, *,
                 results_table: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] results_table: The BigQuery table to export DataProfileScan results to.
               Format://bigquery.googleapis.com/projects/PROJECT_ID/datasets/DATASET_ID/tables/TABLE_ID
        """
    ...
    def results_table(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The BigQuery table to export DataProfileScan results to.
        Format://bigquery.googleapis.com/projects/PROJECT_ID/datasets/DATASET_ID/tables/TABLE_ID
        """
...
if not MYPY:
    class DatascanDataQualitySpecRuleArgsDict(TypedDict):
        ...
        """
        ignore_null: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DatascanDataQualitySpecRuleArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_null: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Description of the rule.
               The maximum length is 1,024 characters.
        :param pulumi.Input[builtins.bool] ignore_null: Rows with null values will automatically fail a rule, unless ignoreNull is true. In that case, such null rows are trivially considered passing. Only applicable to ColumnMap rules.
        :param pulumi.Input[builtins.str] name: A mutable name for the rule.
               The name must contain only letters (a-z, A-Z), numbers (0-9), or hyphens (-).
               The maximum length is 63 characters.
               Must start with a letter.
               Must end with a number or a letter.
    ...
    @dimension.setter
    def dimension(self, value: pulumi.Input[builtins.str]):
    ...
    def ignore_null(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Rows with null values will automatically fail a rule, unless ignoreNull is true. In that case, such null rows are trivially considered passing. Only applicable to ColumnMap rules.
        """
    ...
    @ignore_null.setter
    def ignore_null(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DatascanDataQualitySpecRuleRangeExpectationArgsDict(TypedDict):
        ...
        """
        strict_max_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether each value needs to be strictly lesser than ('<') the maximum, or if equality is allowed.
        Only relevant if a maxValue has been defined. Default = false.
        """
        strict_min_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DatascanDataQualitySpecRuleRangeExpectationArgs:
    def __init__(__self__, *,
                 ...
                 strict_max_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 strict_min_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] max_value: The maximum column value allowed for a row to pass this validation. At least one of minValue and maxValue need to be provided.
        :param pulumi.Input[builtins.str] min_value: The minimum column value allowed for a row to pass this validation. At least one of minValue and maxValue need to be provided.
        :param pulumi.Input[builtins.bool] strict_max_enabled: Whether each value needs to be strictly lesser than ('<') the maximum, or if equality is allowed.
               Only relevant if a maxValue has been defined. Default = false.
        :param pulumi.Input[builtins.bool] strict_min_enabled: Whether each value needs to be strictly greater than ('>') the minimum, or if equality is allowed.
               Only relevant if a minValue has been defined. Default = false.
        """
    ...
    def strict_max_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether each value needs to be strictly lesser than ('<') the maximum, or if equality is allowed.
        Only relevant if a maxValue has been defined. Default = false.
        """
    ...
    def strict_max_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "strict_max_enabled", value)

    @property
    @pulumi.getter(name="strictMinEnabled")
    def strict_min_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether each value needs to be strictly greater than ('>') the minimum, or if equality is allowed.
        Only relevant if a minValue has been defined. Default = false.
        """
    ...
    def strict_min_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DatascanDataQualitySpecRuleRegexExpectationArgs:
    def __init__(__self__, *,
                 regex: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] regex: A regular expression the column value is expected to match.
        """
...
if not MYPY:
    class DatascanDataQualitySpecRuleRowConditionExpectationArgsDict(TypedDict):
        sql_expression: pulumi.Input[builtins.str]
        """
        The SQL expression.
        """
elif False:
...
class DatascanDataQualitySpecRuleRowConditionExpectationArgs:
    def __init__(__self__, *,
                 sql_expression: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] sql_expression: The SQL expression.
        """
        pulumi.set(__self__, "sql_expression", sql_expression)

    @property
    @pulumi.getter(name="sqlExpression")
    def sql_expression(self) -> pulumi.Input[builtins.str]:
        """
        The SQL expression.
        """
    ...
    def sql_expression(self, value: pulumi.Input[builtins.str]):
...
class DatascanDataQualitySpecRuleSetExpectationArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Expected values for the column value.
        """
...
if not MYPY:
    class DatascanDataQualitySpecRuleSqlAssertionArgsDict(TypedDict):
        sql_statement: pulumi.Input[builtins.str]
        """
        The SQL statement.
        """
elif False:
...
class DatascanDataQualitySpecRuleSqlAssertionArgs:
    def __init__(__self__, *,
                 sql_statement: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] sql_statement: The SQL statement.
        """
...
class DatascanDataQualitySpecRuleStatisticRangeExpectationArgs:
    def __init__(__self__, *,
                 ...
                 strict_min_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] statistic: column statistics.
               Possible values are: `STATISTIC_UNDEFINED`, `MEAN`, `MIN`, `MAX`.
        :param pulumi.Input[builtins.str] max_value: The maximum column statistic value allowed for a row to pass this validation.
               At least one of minValue and maxValue need to be provided.
        :param pulumi.Input[builtins.str] min_value: The minimum column statistic value allowed for a row to pass this validation.
               At least one of minValue and maxValue need to be provided.
        :param pulumi.Input[builtins.bool] strict_max_enabled: Whether column statistic needs to be strictly lesser than ('<') the maximum, or if equality is allowed.
               Only relevant if a maxValue has been defined. Default = false.
        :param pulumi.Input[builtins.bool] strict_min_enabled: Whether column statistic needs to be strictly greater than ('>') the minimum, or if equality is allowed.
               Only relevant if a minValue has been defined. Default = false.
        """
...
class DatascanExecutionSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DatascanExecutionSpecTriggerArgs'] trigger: Spec related to how often and when a scan should be triggered.
               Structure is documented below.
        :param pulumi.Input[builtins.str] field: The unnested field (of type Date or Timestamp) that contains values which monotonically increase over time. If not specified, a data scan will run for all data in the table.
        """
...
if not MYPY:
    class DatascanExecutionStatusArgsDict(TypedDict):
        latest_job_end_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        The time when the latest DataScanJob started.
        """
        latest_job_start_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class DatascanExecutionStatusArgs:
    def __init__(__self__, *,
                 latest_job_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 latest_job_start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] latest_job_end_time: (Output)
               The time when the latest DataScanJob started.
        :param pulumi.Input[builtins.str] latest_job_start_time: (Output)
               The time when the latest DataScanJob ended.
        """
    ...
    def latest_job_end_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The time when the latest DataScanJob started.
        """
    ...
    def latest_job_end_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "latest_job_end_time", value)

    @property
    @pulumi.getter(name="latestJobStartTime")
    def latest_job_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The time when the latest DataScanJob ended.
        """
    ...
    def latest_job_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EntryTypeRequiredAspectArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Required aspect type for the entry type.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
if not MYPY:
    class LakeAssetStatusArgsDict(TypedDict):
        ...
        """
        security_policy_applying_assets: NotRequired[pulumi.Input[builtins.int]]
        """
...
class LakeAssetStatusArgs:
    def __init__(__self__, *,
                 active_assets: Optional[pulumi.Input[builtins.int]] = None,
                 security_policy_applying_assets: Optional[pulumi.Input[builtins.int]] = None,
                 update_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] active_assets: Number of active assets.
        :param pulumi.Input[builtins.int] security_policy_applying_assets: Number of assets that are in process of updating the security policy on attached resources.
        :param pulumi.Input[builtins.str] update_time: Output only. The time when the lake was last updated.
        """
    ...
    def active_assets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of active assets.
        """
    ...
    def active_assets(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "active_assets", value)

    @property
    @pulumi.getter(name="securityPolicyApplyingAssets")
    def security_policy_applying_assets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of assets that are in process of updating the security policy on attached resources.
        """
    ...
    def security_policy_applying_assets(self, value: Optional[pulumi.Input[builtins.int]]):
...
class LakeMetastoreArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] service: Optional. A relative reference to the Dataproc Metastore (https://cloud.google.com/dataproc-metastore/docs) service associated with the lake: `projects/{project_id}/locations/{location_id}/services/{service_id}`
        """
...
class LakeMetastoreStatusArgs:
    def __init__(__self__, *,
                 ...
                 update_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] endpoint: The URI of the endpoint used to access the Metastore service.
        :param pulumi.Input[builtins.str] message: Additional information about the current status.
        :param pulumi.Input[builtins.str] state: Output only. Current state of the lake. Possible values: STATE_UNSPECIFIED, ACTIVE, CREATING, DELETING, ACTION_REQUIRED
        :param pulumi.Input[builtins.str] update_time: Output only. The time when the lake was last updated.
        """
...
class TaskExecutionSpecArgs:
    def __init__(__self__, *,
                 ...
                 max_job_execution_lifetime: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def max_job_execution_lifetime(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum duration after which the job execution is expired. A duration in seconds with up to nine fractional digits, ending with 's'. Example: '3.5s'.
        """
    ...
    def max_job_execution_lifetime(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TaskExecutionStatusLatestJobArgsDict(TypedDict):
        ...
        """
        service_job: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class TaskExecutionStatusLatestJobArgs:
    def __init__(__self__, *,
                 ...
                 service: Optional[pulumi.Input[builtins.str]] = None,
                 service_job: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: (Output)
               The relative resource name of the job, of the form: projects/{project_number}/locations/{locationId}/lakes/{lakeId}/tasks/{taskId}/jobs/{jobId}.
        :param pulumi.Input[builtins.int] retry_count: (Output)
               The number of times the job has been retried (excluding the initial attempt).
        :param pulumi.Input[builtins.str] service: (Output)
               The underlying service running a job.
        :param pulumi.Input[builtins.str] service_job: (Output)
               The full resource name for the job run under a particular service.
    ...
    def service_job(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The full resource name for the job run under a particular service.
        """
    ...
    @service_job.setter
    def service_job(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TaskNotebookArgsDict(TypedDict):
        notebook: pulumi.Input[builtins.str]
        """
...
class TaskNotebookArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] notebook: Path to input notebook. This can be the Cloud Storage URI of the notebook file or the path to a Notebook Content. The execution args are accessible as environment variables (TASK_key=value).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: Cloud Storage URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: Cloud Storage URIs of files to be placed in the working directory of each executor.
    ...
    @property
    @pulumi.getter
    def notebook(self) -> pulumi.Input[builtins.str]:
        """
        Path to input notebook. This can be the Cloud Storage URI of the notebook file or the path to a Notebook Content. The execution args are accessible as environment variables (TASK_key=value).
        """
    ...
    @notebook.setter
    def notebook(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class TaskNotebookInfrastructureSpecBatchArgsDict(TypedDict):
        executors_count: NotRequired[pulumi.Input[builtins.int]]
        """
        Total number of job executors. Executor Count should be between 2 and 100. [Default=2]
        """
        max_executors_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class TaskNotebookInfrastructureSpecBatchArgs:
    def __init__(__self__, *,
                 executors_count: Optional[pulumi.Input[builtins.int]] = None,
                 max_executors_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] executors_count: Total number of job executors. Executor Count should be between 2 and 100. [Default=2]
        :param pulumi.Input[builtins.int] max_executors_count: Max configurable executors. If maxExecutorsCount > executorsCount, then auto-scaling is enabled. Max Executor Count should be between 2 and 1000. [Default=1000]
        """
    ...
    def executors_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Total number of job executors. Executor Count should be between 2 and 100. [Default=2]
        """
    ...
    def executors_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "executors_count", value)

    @property
    @pulumi.getter(name="maxExecutorsCount")
    def max_executors_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Max configurable executors. If maxExecutorsCount > executorsCount, then auto-scaling is enabled. Max Executor Count should be between 2 and 1000. [Default=1000]
        """
    ...
    def max_executors_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class TaskNotebookInfrastructureSpecContainerImageArgsDict(TypedDict):
        ...
        """
        java_jars: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        python_packages: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class TaskNotebookInfrastructureSpecContainerImageArgs:
    def __init__(__self__, *,
                 ...
                 java_jars: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 python_packages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] image: Container image to use.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] java_jars: A list of Java JARS to add to the classpath. Valid input includes Cloud Storage URIs to Jar binaries. For example, gs://bucket-name/my/path/to/file.jar
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: Override to common configuration of open source components installed on the Dataproc cluster. The properties to set on daemon config files. Property keys are specified in prefix:property format, for example core:hadoop.tmp.dir. For more information, see Cluster properties.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] python_packages: A list of python packages to be installed. Valid formats include Cloud Storage URI to a PIP installable library. For example, gs://bucket-name/my/path/to/lib.tar.gz
        """
    ...
    def java_jars(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Java JARS to add to the classpath. Valid input includes Cloud Storage URIs to Jar binaries. For example, gs://bucket-name/my/path/to/file.jar
        """
    ...
    @java_jars.setter
    def java_jars(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def python_packages(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of python packages to be installed. Valid formats include Cloud Storage URI to a PIP installable library. For example, gs://bucket-name/my/path/to/lib.tar.gz
        """
    ...
    def python_packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class TaskNotebookInfrastructureSpecVpcNetworkArgsDict(TypedDict):
        ...
        """
        sub_network: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TaskNotebookInfrastructureSpecVpcNetworkArgs:
    def __init__(__self__, *,
                 ...
                 sub_network: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] network: The Cloud VPC network in which the job is run. By default, the Cloud VPC network named Default within the project is used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_tags: List of network tags to apply to the job.
        :param pulumi.Input[builtins.str] sub_network: The Cloud VPC sub-network in which the job is run.
        """
    ...
    def sub_network(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud VPC sub-network in which the job is run.
        """
    ...
    @sub_network.setter
    def sub_network(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TaskSparkArgsDict(TypedDict):
        ...
        """
        python_script_file: NotRequired[pulumi.Input[builtins.str]]
        """
        The Gcloud Storage URI of the main Python file to use as the driver. Must be a .py file. The execution args are passed in as a sequence of named process arguments (--key=value).
        """
        sql_script: NotRequired[pulumi.Input[builtins.str]]
        """
        The query text. The execution args are used to declare a set of script variables (set key='value';).
        """
        sql_script_file: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TaskSparkArgs:
    def __init__(__self__, *,
                 ...
                 python_script_file: Optional[pulumi.Input[builtins.str]] = None,
                 sql_script: Optional[pulumi.Input[builtins.str]] = None,
                 sql_script_file: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: Cloud Storage URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: Cloud Storage URIs of files to be placed in the working directory of each executor.
        :param pulumi.Input['TaskSparkInfrastructureSpecArgs'] infrastructure_spec: Infrastructure specification for the execution.
               Structure is documented below.
        :param pulumi.Input[builtins.str] main_class: The name of the driver's main class. The jar file that contains the class must be in the default CLASSPATH or specified in jar_file_uris. The execution args are passed in as a sequence of named process arguments (--key=value).
        :param pulumi.Input[builtins.str] main_jar_file_uri: The Cloud Storage URI of the jar file that contains the main class. The execution args are passed in as a sequence of named process arguments (--key=value).
        :param pulumi.Input[builtins.str] python_script_file: The Gcloud Storage URI of the main Python file to use as the driver. Must be a .py file. The execution args are passed in as a sequence of named process arguments (--key=value).
        :param pulumi.Input[builtins.str] sql_script: The query text. The execution args are used to declare a set of script variables (set key='value';).
        :param pulumi.Input[builtins.str] sql_script_file: A reference to a query file. This can be the Cloud Storage URI of the query file or it can the path to a SqlScript Content. The execution args are used to declare a set of script variables (set key='value';).
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if file_uris is not None:
    ...
    def python_script_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Gcloud Storage URI of the main Python file to use as the driver. Must be a .py file. The execution args are passed in as a sequence of named process arguments (--key=value).
        """
    ...
    def python_script_file(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sql_script_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A reference to a query file. This can be the Cloud Storage URI of the query file or it can the path to a SqlScript Content. The execution args are used to declare a set of script variables (set key='value';).
        """
    ...
    def sql_script_file(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TaskTriggerSpecArgs:
    def __init__(__self__, *,
                 ...
                 start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Trigger type of the user-specified Task
               Possible values are: `ON_DEMAND`, `RECURRING`.
        :param pulumi.Input[builtins.bool] disabled: Prevent the task from executing. This does not cancel already running tasks. It is intended to temporarily disable RECURRING tasks.
        :param pulumi.Input[builtins.int] max_retries: Number of retry attempts before aborting. Set to zero to never attempt to retry a failed task.
        :param pulumi.Input[builtins.str] schedule: Cron schedule (https://en.wikipedia.org/wiki/Cron) for running tasks periodically. To explicitly set a timezone to the cron tab, apply a prefix in the cron tab: 'CRON_TZ=${IANA_TIME_ZONE}' or 'TZ=${IANA_TIME_ZONE}'. The ${IANA_TIME_ZONE} may only be a valid string from IANA time zone database. For example, CRON_TZ=America/New_York 1 * * * *, or TZ=America/New_York 1 * * * *. This field is required for RECURRING tasks.
        :param pulumi.Input[builtins.str] start_time: The first run of the task will be after this time. If not specified, the task will run shortly after being submitted if ON_DEMAND and based on the schedule if RECURRING.
        """
        pulumi.set(__self__, "type", type)
...
class ZoneResourceSpecArgs:
    def __init__(__self__, *,
                 location_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] location_type: Required. Immutable. The location type of the resources that are allowed to be attached to the assets within this zone. Possible values: LOCATION_TYPE_UNSPECIFIED, SINGLE_REGION, MULTI_REGION
