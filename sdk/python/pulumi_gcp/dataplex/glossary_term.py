...
class GlossaryTermArgs:
    def __init__(__self__, *,
                 ...
                 glossary_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: User-defined labels for the GlossaryTerm.
    ...
    def glossary_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @glossary_id.setter
    def glossary_id(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: User-defined labels for the GlossaryTerm.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location where the glossary term should reside.
        :param pulumi.Input[_builtins.str] name: The resource name of the GlossaryTerm. Format: projects/{projectId}/locations/{locationId}/glossaries/{glossaryId}/categories/{termId}
        :param pulumi.Input[_builtins.str] parent: The immediate parent of the GlossaryTerm in the resource-hierarchy. It can either be a Glossary or a Term. Format: projects/{projectId}/locations/{locationId}/glossaries/{glossaryId} OR projects/{projectId}/locations/{locationId}/glossaries/{glossaryId}/terms/{termId}
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
...
class GlossaryTerm(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        term_test_id = gcp.dataplex.Glossary("term_test_id",
            glossary_id="tf-test-glossary_20665",
        ...
        ,
            glossary_id=term_test_id.glossary_id,
            location="us-central1",
            term_id="tf-test-term-basic_85160")
        ```
        ...
        term_test_id_full = gcp.dataplex.Glossary("term_test_id_full",
            glossary_id="tf-test-glossary_92130",
            location="us-central1")
        ...
        ,
            glossary_id=term_test_id_full.glossary_id,
            location="us-central1",
            term_id="tf-test-term-full_16199",
            labels={
                "tag": "test-tf",
            },
    ...
    def get(resource_name: str,
            ...
            term_id: Optional[pulumi.Input[_builtins.str]] = None,
            uid: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'GlossaryTerm':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="glossaryId")
    def glossary_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The glossary id for creation.
        """
        return pulumi.get(self, "glossary_id")
    ...
    @_builtins.property
    @pulumi.getter(name="termId")
    def term_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The term id for creation.
        """
        return pulumi.get(self, "term_id")
