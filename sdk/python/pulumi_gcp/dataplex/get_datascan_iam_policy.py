...
@pulumi.output_type
calass GetDatascanIamPolicyResult:
    """
...
calass AwaitableGetDatascanIamPolicyResult(GetDatascanIamPolicyResult):
...
def get_datascan_iam_policy(data_scan_id: Optional[str] = None,
