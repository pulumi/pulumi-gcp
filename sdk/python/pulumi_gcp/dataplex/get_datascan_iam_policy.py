...
class GetDatascanIamPolicyResult:
    ...
    """
    def __init__(__self__, data_scan_id=None, etag=None, id=None, location=None, policy_data=None, project=None):
...
def get_datascan_iam_policy(data_scan_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_scan_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location where the data scan should reside.
...
def get_datascan_iam_policy_output(data_scan_id: Optional[pulumi.Input[_builtins.str]] = None,
