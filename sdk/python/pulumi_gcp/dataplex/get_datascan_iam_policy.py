...
def get_datascan_iam_policy(data_scan_id: Optional[builtins.str] = None,
...
def get_datascan_iam_policy_output(data_scan_id: Optional[pulumi.Input[builtins.str]] = None,
