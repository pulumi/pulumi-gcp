...
def get_lake_iam_policy(lake: Optional[_builtins.str] = None,
    ...
    :param _builtins.str lake: Used to find the parent resource to bind the IAM policy to
...
def get_lake_iam_policy_output(lake: Optional[pulumi.Input[_builtins.str]] = None,
