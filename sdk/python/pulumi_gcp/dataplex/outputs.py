...
__all__ = [
    ...
    'DatascanDataQualitySpecRuleTemplateReference',
    'DatascanDataQualitySpecRuleTemplateReferenceValue',
    'DatascanDataQualitySpecRuleUniquenessExpectation',
    'DatascanExecutionIdentity',
    'DatascanExecutionIdentityDataplexServiceAgent',
    'DatascanExecutionIdentityServiceAccount',
    'DatascanExecutionIdentityUserCredential',
...
class DataProductDataAssetAccessGroupConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DataProductDataAssetAccessGroupConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DataProductDataAssetAccessGroupConfig.__key_warning(key)
        return super().__getitem__(key)
...
class DatascanDataQualitySpec(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "catalogPublishingEnabled":
            suggest = "catalog_publishing_enabled"
        elif key == "enableCatalogBasedRules":
            suggest = "enable_catalog_based_rules"
        elif key == "postScanActions":
            suggest = "post_scan_actions"
        elif key == "rowFilter":
            suggest = "row_filter"
    ...
    def __init__(__self__, *,
                 catalog_publishing_enabled: Optional[_builtins.bool] = None,
                 enable_catalog_based_rules: Optional[_builtins.bool] = None,
        ...
        """
        :param _builtins.bool catalog_publishing_enabled: If set, the latest DataScan job result will be published to Dataplex Catalog.
        :param _builtins.bool enable_catalog_based_rules: If set to true, the scan will retrieve rules defined in Data Catalog for the resource.
        :param _builtins.str filter: A filter to selectively run a subset of rules.
    ...
    def enable_catalog_based_rules(self) -> Optional[_builtins.bool]:
        """
...
class DatascanDataQualitySpecRule(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "templateReference":
            suggest = "template_reference"
    ...
    def __init__(__self__, *,
                 ...
                 template_reference: Optional['outputs.DatascanDataQualitySpecRuleTemplateReference'] = None,
        ...
        :param Mapping[str, _builtins.str] attributes: Map of attribute name and value linked to the rule.
        ...
        :param 'DatascanDataQualitySpecRuleTableConditionExpectationArgs' table_condition_expectation: Table rule which evaluates whether the provided expression is true.
               Structure is documented below.
        :param 'DatascanDataQualitySpecRuleTemplateReferenceArgs' template_reference: Aggregate rule which references a rule template and provides the parameters to be substituted in the template.
               Structure is documented below.
    ...
    def template_reference(self) -> Optional['outputs.DatascanDataQualitySpecRuleTemplateReference']:
        """
...
@pulumi.output_type
class DatascanDataQualitySpecRuleTemplateReference(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 values: Optional[Sequence['outputs.DatascanDataQualitySpecRuleTemplateReferenceValue']] = None):
        """
        :param _builtins.str name: The resource name of the template entry.
        :param Sequence['DatascanDataQualitySpecRuleTemplateReferenceValueArgs'] values: The map of parameter name and value.
               Structure is documented below.
        """
        pulumi.set(__self__, "name", name)
    ...
    @_builtins.property
    @pulumi.getter
    def values(self) -> Optional[Sequence['outputs.DatascanDataQualitySpecRuleTemplateReferenceValue']]:
        """
...
@pulumi.output_type
class DatascanDataQualitySpecRuleTemplateReferenceValue(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 value: _builtins.str):
        """
        :param _builtins.str name: The identifier for this object. Format specified above.
        :param _builtins.str value: The string representation of the parameter value.
        """
        pulumi.set(__self__, "name", name)
...
@pulumi.output_type
class DatascanExecutionIdentity(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "dataplexServiceAgent":
            suggest = "dataplex_service_agent"
        elif key == "serviceAccount":
            suggest = "service_account"
        elif key == "userCredential":
            suggest = "user_credential"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DatascanExecutionIdentity. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        DatascanExecutionIdentity.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 dataplex_service_agent: Optional['outputs.DatascanExecutionIdentityDataplexServiceAgent'] = None,
                 service_account: Optional['outputs.DatascanExecutionIdentityServiceAccount'] = None,
                 user_credential: Optional['outputs.DatascanExecutionIdentityUserCredential'] = None):
        """
        :param 'DatascanExecutionIdentityDataplexServiceAgentArgs' dataplex_service_agent: The Dataplex service agent associated with the user's project.
        :param 'DatascanExecutionIdentityServiceAccountArgs' service_account: Service account to use to execute a datascan.
               Structure is documented below.
        :param 'DatascanExecutionIdentityUserCredentialArgs' user_credential: The credential of the calling user. Supports only ONE_TIME trigger type.
        """
    ...
    def dataplex_service_agent(self) -> Optional['outputs.DatascanExecutionIdentityDataplexServiceAgent']:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="serviceAccount")
    def service_account(self) -> Optional['outputs.DatascanExecutionIdentityServiceAccount']:
        """
    ...
    def user_credential(self) -> Optional['outputs.DatascanExecutionIdentityUserCredential']:
        """
...
@pulumi.output_type
class DatascanExecutionIdentityDataplexServiceAgent(dict):
    def __init__(__self__):
        pass


@pulumi.output_type
class DatascanExecutionIdentityServiceAccount(dict):
    def __init__(__self__, *,
                 email: _builtins.str):
        """
        :param _builtins.str email: Service account email.
        """
...
@pulumi.output_type
class DatascanExecutionIdentityUserCredential(dict):
    def __init__(__self__):
        pass
...
class EntryLinkAspect(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EntryLinkAspect. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EntryLinkAspect.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 aspect: 'outputs.EntryLinkAspectAspect',
                 aspect_key: _builtins.str):
        """
        :param 'EntryLinkAspectAspectArgs' aspect: A nested object resource.
               Structure is documented below.
        :param _builtins.str aspect_key: The map keys of the Aspects which the service should modify.
    ...
    @_builtins.property
    @pulumi.getter
    def aspect(self) -> 'outputs.EntryLinkAspectAspect':
        """
        A nested object resource.
        Structure is documented below.
        """
...
@pulumi.output_type
class EntryLinkAspectAspect(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "aspectType":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in EntryLinkAspectAspect. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        EntryLinkAspectAspect.__key_warning(key)
        return super().__getitem__(key)
