...
class ZoneArgs:
    def __init__(__self__, *,
                 ...
                 lake: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] lake: The lake for the resource
        ...
        :param pulumi.Input[builtins.str] type: Required. Immutable. The type of the zone. Possible values: TYPE_UNSPECIFIED, RAW, CURATED
        :param pulumi.Input[builtins.str] description: Optional. Description of the zone.
        :param pulumi.Input[builtins.str] display_name: Optional. User friendly display name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Optional. User defined labels for the zone. **Note**: This field is non-authoritative, and will only manage the labels
    ...
    @lake.setter
    def lake(self, value: pulumi.Input[builtins.str]):
...
class _ZoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Output only. The time when the zone was created.
        :param pulumi.Input[builtins.str] description: Optional. Description of the zone.
        :param pulumi.Input['ZoneDiscoverySpecArgs'] discovery_spec: Required. Specification of the discovery feature applied to data in this zone.
        :param pulumi.Input[builtins.str] display_name: Optional. User friendly display name.
        ...
        :param pulumi.Input['ZoneResourceSpecArgs'] resource_spec: Required. Immutable. Specification of the resources that are referenced by the assets within this zone.
        :param pulumi.Input[builtins.str] state: Output only. Current state of the zone. Possible values: STATE_UNSPECIFIED, ACTIVE, CREATING, DELETING, ACTION_REQUIRED
        :param pulumi.Input[builtins.str] type: Required. Immutable. The type of the zone. Possible values: TYPE_UNSPECIFIED, RAW, CURATED
        :param pulumi.Input[builtins.str] uid: Output only. System generated globally unique ID for the zone. This ID will be different if the zone is deleted and re-created with the same name.
        :param pulumi.Input[builtins.str] update_time: Output only. The time when the zone was last updated.
        """
...
class Zone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            asset_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ZoneAssetStatusArgs', 'ZoneAssetStatusArgsDict']]]]] = None,
            create_time: Optional[pulumi.Input[builtins.str]] = None,
            description: Optional[pulumi.Input[builtins.str]] = None,
            discovery_spec: Optional[pulumi.Input[Union['ZoneDiscoverySpecArgs', 'ZoneDiscoverySpecArgsDict']]] = None,
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Zone':
        """
