    ...
    def __init__(__self__,
        ...
        * How-to Guides
        ...
        example = gcp.dataplex.Lake("example",
            name="tf-test-lake_3684",
            location="us-central1",
            project="my-project-name")
        example_task = gcp.dataplex.Task("example",
            task_id="tf-test-task_10719",
            location="us-central1",
            lake=example.name,
