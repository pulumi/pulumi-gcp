...
class GlossaryIamPolicyArgs:
    def __init__(__self__, *,
                 glossary_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] glossary_id: Used to find the parent resource to bind the IAM policy to
    ...
    def glossary_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @glossary_id.setter
    def glossary_id(self, value: pulumi.Input[_builtins.str]):
...
class _GlossaryIamPolicyState:
    ...
    @_builtins.property
    @pulumi.getter(name="glossaryId")
    def glossary_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "glossary_id")
    ...
    @glossary_id.setter
    def glossary_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "glossary_id", value)
...
class GlossaryIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `dataplex.GlossaryIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the glossary are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `dataplex.GlossaryIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the glossary are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            location: pulumi.Input[Optional[_builtins.str]] = None,
            policy_data: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None) -> 'GlossaryIamPolicy':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="glossaryId")
    def glossary_id(self) -> pulumi.Output[_builtins.str]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "glossary_id")
