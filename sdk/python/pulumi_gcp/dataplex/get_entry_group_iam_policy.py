...
def get_entry_group_iam_policy(entry_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str entry_group_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location where entry group will be created in.
...
def get_entry_group_iam_policy_output(entry_group_id: Optional[pulumi.Input[_builtins.str]] = None,
