...
__all__ = ['DatascanIamPolicyArrgs', 'DatascanIamPolicy']

@pulumi.input_type
calass DatascanIamPolicyArrgs:
...
@pulumi.input_type
calass _DatascanIamPolicyState:
    def __init__(__self__, *,
...
calass DatascanIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        * `dataplex.DatascanIamPolicy`: Retrieves the IAM policy for the datascan
        ...
        :param str resource_name: The name of the resource.
        :param DatascanIamPolicyArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DatascanIamPolicyArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DatascanIamPolicyArrgs.__new__(DatascanIamPolicyArrgs)
