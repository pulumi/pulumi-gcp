...
def get_task_iam_policy(lake: Optional[_builtins.str] = None,
    ...
    :param _builtins.str lake: The lake in which the task will be created in.
           Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location in which the task will be created in.
    ...
    :param _builtins.str task_id: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
    __args__['lake'] = lake
