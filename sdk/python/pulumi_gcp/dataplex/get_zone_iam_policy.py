...
def get_zone_iam_policy(dataplex_zone: Optional[_builtins.str] = None,
                        lake: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dataplex_zone: Used to find the parent resource to bind the IAM policy to
...
def get_zone_iam_policy_output(dataplex_zone: Optional[pulumi.Input[_builtins.str]] = None,
