...
def get_entry_type_iam_policy(entry_type_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str entry_type_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location where entry type will be created in.
