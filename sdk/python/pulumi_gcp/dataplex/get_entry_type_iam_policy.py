...
def get_entry_type_iam_policy(entry_type_id: Optional[builtins.str] = None,
...
def get_entry_type_iam_policy_output(entry_type_id: Optional[pulumi.Input[builtins.str]] = None,
