...
def get_aspect_type_iam_policy(aspect_type_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str aspect_type_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location where aspect type will be created in.
...
def get_aspect_type_iam_policy_output(aspect_type_id: Optional[pulumi.Input[_builtins.str]] = None,
