...
class AssetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dataplex_zone: The zone for the resource
        ...
        :param pulumi.Input[builtins.str] description: Optional. Description of the asset.
        :param pulumi.Input[builtins.str] display_name: Optional. User friendly display name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Optional. User defined labels for the asset. **Note**: This field is non-authoritative, and will only manage the labels
               present in your configuration. Please refer to the field `effective_labels` for all of the labels present on the
               resource.
        :param pulumi.Input[builtins.str] name: The name of the asset.
...
class _AssetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Output only. The time when the asset was created.
        :param pulumi.Input[builtins.str] dataplex_zone: The zone for the resource
        :param pulumi.Input[builtins.str] description: Optional. Description of the asset.
        :param pulumi.Input['AssetDiscoverySpecArgs'] discovery_spec: Required. Specification of the discovery feature applied to data referenced by this asset. When this spec is left unset, the asset will use the spec set on the parent zone.
        ...
        :param pulumi.Input[builtins.str] uid: Output only. System generated globally unique ID for the asset. This ID will be different if the asset is deleted and re-created with the same name.
...
class Asset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Asset':
        """
