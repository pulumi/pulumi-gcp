...
def get_asset_iam_policy(asset: Optional[builtins.str] = None,
                         dataplex_zone: Optional[builtins.str] = None,
...
def get_asset_iam_policy_output(asset: Optional[pulumi.Input[builtins.str]] = None,
