...
def get_asset_iam_policy(asset: Optional[_builtins.str] = None,
                         dataplex_zone: Optional[_builtins.str] = None,
    ...
    :param _builtins.str asset: Used to find the parent resource to bind the IAM policy to
...
def get_asset_iam_policy_output(asset: Optional[pulumi.Input[_builtins.str]] = None,
