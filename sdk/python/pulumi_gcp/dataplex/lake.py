...
class LakeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Optional. Description of the lake.
        :param pulumi.Input[builtins.str] display_name: Optional. User friendly display name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Optional. User-defined labels for the lake.
        ...
        :param pulumi.Input[builtins.str] name: The name of the lake.
...
class _LakeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Output only. The time when the lake was created.
        :param pulumi.Input[builtins.str] description: Optional. Description of the lake.
        :param pulumi.Input[builtins.str] display_name: Optional. User friendly display name.
        ...
        :param pulumi.Input[builtins.str] service_account: Output only. Service account associated with this lake. This service account must be authorized to access or operate on resources managed by the lake.
        ...
        :param pulumi.Input[builtins.str] uid: Output only. System generated globally unique ID for the lake. This ID will be different if the lake is deleted and re-created with the same name.
...
class Lake(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Lake':
        """
