...
class _TaskIamPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               ...
               * **projectViewer:projectid**: Viewers of the given project. For example, "projectViewer:my-example-project"
        """
        _TaskIamPolicyState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            etag=etag,
            lake=lake,
            location=location,
...
class TaskIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            TaskIamPolicyArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            policy_data: Optional[pulumi.Input[str]] = None,
            project: Optional[pulumi.Input[str]] = None,
            task_id: Optional[pulumi.Input[str]] = None) -> 'TaskIamPolicy':
        """
        ...
        __props__ = _TaskIamPolicyState.__new__(_TaskIamPolicyState)
