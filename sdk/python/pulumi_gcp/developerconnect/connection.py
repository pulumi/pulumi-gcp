...
class ConnectionArgs:
    def __init__(__self__, *,
                 ...
                 gitlab_enterprise_config: pulumi.Input[Optional['ConnectionGitlabEnterpriseConfigArgs']] = None,
                 http_config: pulumi.Input[Optional['ConnectionHttpConfigArgs']] = None,
    ...
    def crypto_key_config(self) -> pulumi.Input[Optional['ConnectionCryptoKeyConfigArgs']]:
        """
    ...
    def gitlab_enterprise_config(self) -> pulumi.Input[Optional['ConnectionGitlabEnterpriseConfigArgs']]:
        """
    ...
    def gitlab_enterprise_config(self, value: pulumi.Input[Optional['ConnectionGitlabEnterpriseConfigArgs']]):
        pulumi.set(self, "gitlab_enterprise_config", value)

    @_builtins.property
    @pulumi.getter(name="httpConfig")
    def http_config(self) -> pulumi.Input[Optional['ConnectionHttpConfigArgs']]:
        """
    ...
    @http_config.setter
    def http_config(self, value: pulumi.Input[Optional['ConnectionHttpConfigArgs']]):
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Optional. Labels as key value pairs
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
        :param pulumi.Input[_builtins.str] name: Identifier. The resource name of the connection, in the format
