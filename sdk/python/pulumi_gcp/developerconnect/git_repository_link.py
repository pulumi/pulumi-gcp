...
class GitRepositoryLinkArgs:
    def __init__(__self__, *,
                 clone_uri: pulumi.Input[builtins.str],
                 git_repository_link_id: pulumi.Input[builtins.str],
                 location: pulumi.Input[builtins.str],
                 parent_connection: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] clone_uri: Required. Git Clone URI.
    ...
    def clone_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @clone_uri.setter
    def clone_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "clone_uri", value)

    @property
    @pulumi.getter(name="gitRepositoryLinkId")
    def git_repository_link_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def git_repository_link_id(self, value: pulumi.Input[builtins.str]):
    ...
    def parent_connection(self, value: pulumi.Input[builtins.str]):
...
class _GitRepositoryLinkState:
    def __init__(__self__, *,
                 annotations: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 clone_uri: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 etag: Optional[pulumi.Input[builtins.str]] = None,
                 git_repository_link_id: Optional[pulumi.Input[builtins.str]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_connection: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Optional. Labels as key value pairs
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] location: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122. See documentation for resource type `developerconnect.googleapis.com/GitRepositoryLink`.
        :param pulumi.Input[builtins.str] name: Identifier. Resource name of the repository, in the format
    ...
    @property
    @pulumi.getter(name="cloneUri")
    def clone_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required. Git Clone URI.
        """
        return pulumi.get(self, "clone_uri")
    ...
    @clone_uri.setter
    def clone_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "clone_uri", value)
    ...
    @property
    @pulumi.getter(name="gitRepositoryLinkId")
    def git_repository_link_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required. The ID to use for the repository, which will become the final component of
        the repository's resource name. This ID should be unique in the connection.
        Allows alphanumeric characters and any of -._~%!$&'()*+,;=@.
    ...
    @git_repository_link_id.setter
    def git_repository_link_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "git_repository_link_id", value)
    ...
    @parent_connection.setter
    def parent_connection(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_connection", value)
...
class GitRepositoryLink(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reconciling: Optional[pulumi.Input[builtins.bool]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'GitRepositoryLink':
        """
    ...
    @property
    @pulumi.getter(name="cloneUri")
    def clone_uri(self) -> pulumi.Output[builtins.str]:
        """
        Required. Git Clone URI.
        """
        return pulumi.get(self, "clone_uri")
    ...
    @property
    @pulumi.getter(name="gitRepositoryLinkId")
    def git_repository_link_id(self) -> pulumi.Output[builtins.str]:
        """
        Required. The ID to use for the repository, which will become the final component of
        the repository's resource name. This ID should be unique in the connection.
        Allows alphanumeric characters and any of -._~%!$&'()*+,;=@.
