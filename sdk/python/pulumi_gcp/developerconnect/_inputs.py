...
class ConnectionBitbucketCloudConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConnectionBitbucketCloudConfigReadAuthorizerCredentialArgs'] read_authorizer_credential: Represents a personal access token that authorized the Connection,
               and associated metadata.
               Structure is documented below.
        :param pulumi.Input[builtins.str] webhook_secret_secret_version: Required. Immutable. SecretManager resource containing the webhook secret used to verify webhook
               events, formatted as `projects/*/secrets/*/versions/*`. This is used to
               validate and create webhooks.
        :param pulumi.Input[builtins.str] workspace: Required. The Bitbucket Cloud Workspace ID to be connected to Google Cloud Platform.
        """
...
class ConnectionBitbucketCloudConfigAuthorizerCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] user_token_secret_version: Required. A SecretManager resource containing the user token that authorizes
               the Developer Connect connection. Format:
               `projects/*/secrets/*/versions/*`.
...
if not MYPY:
    class ConnectionBitbucketDataCenterConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        ssl_ca_certificate: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionBitbucketDataCenterConfigArgs:
    def __init__(__self__, *,
                 ...
                 ssl_ca_certificate: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input['ConnectionBitbucketDataCenterConfigAuthorizerCredentialArgs'] authorizer_credential: Represents a personal access token that authorized the Connection,
               and associated metadata.
               Structure is documented below.
        :param pulumi.Input[builtins.str] host_uri: Required. The URI of the Bitbucket Data Center host this connection is for.
        ...
        :param pulumi.Input['ConnectionBitbucketDataCenterConfigServiceDirectoryConfigArgs'] service_directory_config: ServiceDirectoryConfig represents Service Directory configuration for a
               connection.
               Structure is documented below.
        :param pulumi.Input[builtins.str] ssl_ca_certificate: Optional. SSL certificate authority to trust when making requests to Bitbucket Data
               Center.
        """
        pulumi.set(__self__, "authorizer_credential", authorizer_credential)
    ...
    def ssl_ca_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Optional. SSL certificate authority to trust when making requests to Bitbucket Data
        Center.
        """
    ...
    def ssl_ca_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectionBitbucketDataCenterConfigServiceDirectoryConfigArgs:
    def __init__(__self__, *,
                 service: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] service: Required. The Service Directory service name.
               Format:
               projects/{project}/locations/{location}/namespaces/{namespace}/services/{service}.
        """
...
if not MYPY:
    class ConnectionCryptoKeyConfigArgsDict(TypedDict):
        key_reference: pulumi.Input[builtins.str]
        """
...
class ConnectionCryptoKeyConfigArgs:
    def __init__(__self__, *,
                 key_reference: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_reference: Required. The name of the key which is used to encrypt/decrypt customer data. For key
               in Cloud KMS, the key should be in the format of
               `projects/*/locations/*/keyRings/*/cryptoKeys/*`.
        """
    ...
    def key_reference(self) -> pulumi.Input[builtins.str]:
        """
        Required. The name of the key which is used to encrypt/decrypt customer data. For key
        in Cloud KMS, the key should be in the format of
        `projects/*/locations/*/keyRings/*/cryptoKeys/*`.
    ...
    def key_reference(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "key_reference", value)


if not MYPY:
    class ConnectionGithubConfigArgsDict(TypedDict):
        github_app: pulumi.Input[builtins.str]
        """
        ...
        Structure is documented below.
        """
        installation_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class ConnectionGithubConfigArgs:
    def __init__(__self__, *,
                 ...
                 installation_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] github_app: Required. Immutable. The GitHub Application that was installed to the GitHub user or
               organization.
               Possible values:
               GIT_HUB_APP_UNSPECIFIED
               DEVELOPER_CONNECT
               FIREBASE
        :param pulumi.Input[builtins.str] app_installation_id: Optional. GitHub App installation id.
        :param pulumi.Input['ConnectionGithubConfigAuthorizerCredentialArgs'] authorizer_credential: Represents an OAuth token of the account that authorized the Connection,
               and associated metadata.
               Structure is documented below.
        :param pulumi.Input[builtins.str] installation_uri: (Output)
               Output only. The URI to navigate to in order to manage the installation associated
               with this GitHubConfig.
        """
    ...
    def github_app(self) -> pulumi.Input[builtins.str]:
        """
        Required. Immutable. The GitHub Application that was installed to the GitHub user or
        organization.
        Possible values:
    ...
    @github_app.setter
    def github_app(self, value: pulumi.Input[builtins.str]):
    ...
    def installation_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Output only. The URI to navigate to in order to manage the installation associated
        with this GitHubConfig.
    ...
    def installation_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "installation_uri", value)


if not MYPY:
    class ConnectionGithubConfigAuthorizerCredentialArgsDict(TypedDict):
        oauth_token_secret_version: pulumi.Input[builtins.str]
        """
...
class ConnectionGithubConfigAuthorizerCredentialArgs:
    def __init__(__self__, *,
                 ...
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] oauth_token_secret_version: Required. A SecretManager resource containing the OAuth token that authorizes
               the connection. Format: `projects/*/secrets/*/versions/*`.
        :param pulumi.Input[builtins.str] username: (Output)
               Output only. The username associated with this token.
        """
    ...
    def oauth_token_secret_version(self) -> pulumi.Input[builtins.str]:
        """
        Required. A SecretManager resource containing the OAuth token that authorizes
        the connection. Format: `projects/*/secrets/*/versions/*`.
        """
    ...
    def oauth_token_secret_version(self, value: pulumi.Input[builtins.str]):
...
class ConnectionGithubEnterpriseConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_id: Optional. ID of the GitHub App created from the manifest.
        :param pulumi.Input[builtins.str] app_installation_id: Optional. ID of the installation of the GitHub App.
        :param pulumi.Input[builtins.str] app_slug: (Output)
               Output only. The URL-friendly name of the GitHub App.
        :param pulumi.Input[builtins.str] installation_uri: (Output)
               Output only. The URI to navigate to in order to manage the installation associated
               with this GitHubEnterpriseConfig.
        :param pulumi.Input[builtins.str] private_key_secret_version: Optional. SecretManager resource containing the private key of the GitHub App,
               formatted as `projects/*/secrets/*/versions/*`.
        :param pulumi.Input[builtins.str] server_version: (Output)
               Output only. GitHub Enterprise version installed at the host_uri.
        :param pulumi.Input['ConnectionGithubEnterpriseConfigServiceDirectoryConfigArgs'] service_directory_config: ServiceDirectoryConfig represents Service Directory configuration for a
               connection.
               Structure is documented below.
        :param pulumi.Input[builtins.str] ssl_ca_certificate: Optional. SSL certificate to use for requests to GitHub Enterprise.
        :param pulumi.Input[builtins.str] webhook_secret_secret_version: Optional. SecretManager resource containing the webhook secret of the GitHub App,
               formatted as `projects/*/secrets/*/versions/*`.
        """
        pulumi.set(__self__, "host_uri", host_uri)
...
class ConnectionGitlabConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConnectionGitlabConfigReadAuthorizerCredentialArgs'] read_authorizer_credential: Represents a personal access token that authorized the Connection,
               and associated metadata.
               Structure is documented below.
        :param pulumi.Input[builtins.str] webhook_secret_secret_version: Required. Immutable. SecretManager resource containing the webhook secret of a GitLab project,
               formatted as `projects/*/secrets/*/versions/*`. This is used to validate
               webhooks.
        """
        pulumi.set(__self__, "authorizer_credential", authorizer_credential)
...
class ConnectionGitlabEnterpriseConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ConnectionGitlabEnterpriseConfigAuthorizerCredentialArgs'] authorizer_credential: Represents a personal access token that authorized the Connection,
               and associated metadata.
               Structure is documented below.
        :param pulumi.Input[builtins.str] host_uri: Required. The URI of the GitLab Enterprise host this connection is for.
        ...
        :param pulumi.Input['ConnectionGitlabEnterpriseConfigServiceDirectoryConfigArgs'] service_directory_config: ServiceDirectoryConfig represents Service Directory configuration for a
               connection.
               Structure is documented below.
        :param pulumi.Input[builtins.str] ssl_ca_certificate: Optional. SSL Certificate Authority certificate to use for requests to GitLab
               Enterprise instance.
        """
        pulumi.set(__self__, "authorizer_credential", authorizer_credential)
        pulumi.set(__self__, "host_uri", host_uri)
...
class ConnectionInstallationStateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action_uri: Output only. Link to follow for next action. Empty string if the installation is already
               complete.
        :param pulumi.Input[builtins.str] message: Output only. Message of what the user should do next to continue the installation.
               Empty string if the installation is already complete.
