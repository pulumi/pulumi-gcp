...
def get_runtime_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: A reference to the zone where the machine resides. Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    :param _builtins.str runtime_name: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
