...
class EnvironmentVmImage(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str image_family: Use this VM image family to find the image; the newest image in this family will be used.
        :param _builtins.str image_name: Use VM image name to find the image.
        """
...
class InstanceAcceleratorConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.int core_count: Count of cores of this accelerator.
        :param _builtins.str type: Type of this accelerator.
...
class InstanceReservationAffinity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str consume_reservation_type: The type of Compute Reservation.
...
class InstanceShieldedInstanceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enable_integrity_monitoring: Defines whether the instance has integrity monitoring enabled. Enables monitoring and attestation of the
               boot integrity of the instance. The attestation is performed against the integrity policy baseline.
               This baseline is initially derived from the implicitly trusted boot image when the instance is created.
               Enabled by default.
        :param _builtins.bool enable_secure_boot: Defines whether the instance has Secure Boot enabled. Secure Boot helps ensure that the system only runs
               authentic software by verifying the digital signature of all boot components, and halting the boot process
               if signature verification fails.
               Disabled by default.
        :param _builtins.bool enable_vtpm: Defines whether the instance has the vTPM enabled.
               Enabled by default.
        """
...
class RuntimeAccessConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 proxy_uri: Optional[_builtins.str] = None,
                 runtime_owner: Optional[_builtins.str] = None):
        """
        :param _builtins.str access_type: The type of access mode this instance. For valid values, see
               `https://cloud.google.com/vertex-ai/docs/workbench/reference/
               rest/v1/projects.locations.runtimes#RuntimeAccessType`.
        :param _builtins.str proxy_uri: (Output)
               The proxy endpoint that is used to access the runtime.
        :param _builtins.str runtime_owner: The owner of this runtime after creation. Format: `alias@example.com`.
...
class RuntimeMetric(dict):
    ...
    def __init__(__self__, *,
                 system_metrics: Optional[Mapping[str, _builtins.str]] = None):
        """
        :param Mapping[str, _builtins.str] system_metrics: (Output)
...
class RuntimeSoftwareConfig(dict):
    ...
    def __init__(__self__, *,
                 custom_gpu_driver_path: Optional[_builtins.str] = None,
                 enable_health_monitoring: Optional[_builtins.bool] = None,
                 idle_shutdown: Optional[_builtins.bool] = None,
                 idle_shutdown_timeout: Optional[_builtins.int] = None,
                 install_gpu_driver: Optional[_builtins.bool] = None,
                 kernels: Optional[Sequence['outputs.RuntimeSoftwareConfigKernel']] = None,
                 notebook_upgrade_schedule: Optional[_builtins.str] = None,
                 post_startup_script: Optional[_builtins.str] = None,
                 post_startup_script_behavior: Optional[_builtins.str] = None,
                 upgradeable: Optional[_builtins.bool] = None):
        """
        :param _builtins.str custom_gpu_driver_path: Specify a custom Cloud Storage path where the GPU driver is stored.
               If not specified, we'll automatically choose from official GPU drivers.
        :param _builtins.bool enable_health_monitoring: Verifies core internal services are running. Default: True.
        :param _builtins.bool idle_shutdown: Runtime will automatically shutdown after idle_shutdown_time.
               Default: True
        :param _builtins.int idle_shutdown_timeout: Time in minutes to wait before shuting down runtime.
               Default: 180 minutes
        :param _builtins.bool install_gpu_driver: Install Nvidia Driver automatically.
        ...
        :param _builtins.str notebook_upgrade_schedule: Cron expression in UTC timezone for schedule instance auto upgrade.
               Please follow the [cron format](https://en.wikipedia.org/wiki/Cron).
        :param _builtins.str post_startup_script: Path to a Bash script that automatically runs after a notebook instance
               fully boots up. The path must be a URL or
               Cloud Storage path (gs://path-to-file/file-name).
        :param _builtins.str post_startup_script_behavior: Behavior for the post startup script.
               Possible values are: `POST_STARTUP_SCRIPT_BEHAVIOR_UNSPECIFIED`, `RUN_EVERY_START`, `DOWNLOAD_AND_RUN_EVERY_START`.
        :param _builtins.bool upgradeable: (Output)
...
class RuntimeVirtualMachine(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str instance_id: (Output)
               The unique identifier of the Managed Compute Engine instance.
        :param _builtins.str instance_name: (Output)
...
class RuntimeVirtualMachineVirtualMachineConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 guest_attributes: Optional[Mapping[str, _builtins.str]] = None,
        ...
        :param 'RuntimeVirtualMachineVirtualMachineConfigDataDiskArgs' data_disk: Data disk option configuration settings.
               Structure is documented below.
        :param _builtins.str machine_type: The Compute Engine machine type used for runtimes.
        ...
        :param 'RuntimeVirtualMachineVirtualMachineConfigEncryptionConfigArgs' encryption_config: Encryption settings for virtual machine data disk.
               Structure is documented below.
        :param Mapping[str, _builtins.str] guest_attributes: (Output)
               The Compute Engine guest attributes. (see [Project and instance
               guest attributes](https://cloud.google.com/compute/docs/
               storing-retrieving-metadata#guest_attributes)).
        :param _builtins.bool internal_ip_only: If true, runtime will only have internal IP addresses. By default,
        ...
        :param Mapping[str, _builtins.str] metadata: The Compute Engine metadata entries to add to virtual machine.
               (see [Project and instance metadata](https://cloud.google.com
               /compute/docs/storing-retrieving-metadata#project_and_instance
               _metadata)).
        :param _builtins.str network: The Compute Engine network to be used for machine communications.
               ...
               * Shared VPC (network & subnet are required). Requires
               configuring Private Service Access.
        :param _builtins.str nic_type: The type of vNIC to be used on this interface. This may be gVNIC
               or VirtioNet.
               Possible values are: `UNSPECIFIED_NIC_TYPE`, `VIRTIO_NET`, `GVNIC`.
        :param _builtins.str reserved_ip_range: Reserved IP Range name is used for VPC Peering. The
        ...
        :param 'RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfigArgs' shielded_instance_config: Shielded VM Instance configuration settings.
               Structure is documented below.
        :param _builtins.str subnet: The Compute Engine subnetwork to be used for machine
               communications. Cannot be specified with network. A full URL or
               partial URI are valid. Examples:
               * `https://www.googleapis.com/compute/v1/projects/[project_id]/
               regions/us-east1/subnetworks/sub0`
               * `projects/[project_id]/regions/us-east1/subnetworks/sub0`
        :param Sequence[_builtins.str] tags: The Compute Engine tags to add to runtime (see [Tagging instances]
...
class RuntimeVirtualMachineVirtualMachineConfigAcceleratorConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int core_count: Count of cores of this accelerator.
        :param _builtins.str type: Accelerator model. For valid values, see
               `https://cloud.google.com/vertex-ai/docs/workbench/reference/
...
class RuntimeVirtualMachineVirtualMachineConfigDataDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[_builtins.str] = None):
        """
        :param _builtins.bool auto_delete: (Output)
               Optional. Specifies whether the disk will be auto-deleted
               when the instance is deleted (but not when the disk is
               detached from the instance).
        :param _builtins.bool boot: (Output)
               Optional. Indicates that this is a boot disk. The virtual
               machine will use the first partition of the disk for its
               root filesystem.
        :param _builtins.str device_name: (Output)
        ...
        :param Sequence[_builtins.str] guest_os_features: (Output)
               Indicates a list of features to enable on the guest operating
               system. Applicable only for bootable images. To see a list of
               available features, read `https://cloud.google.com/compute/docs/
               images/create-delete-deprecate-private-images#guest-os-features`
               options. ``
        :param _builtins.int index: (Output)
        ...
        :param _builtins.str kind: (Output)
               Type of the resource. Always compute#attachedDisk for attached
               disks.
        :param Sequence[_builtins.str] licenses: (Output)
               Output only. Any valid publicly visible licenses.
        :param _builtins.str mode: The mode in which to attach this disk, either READ_WRITE
               or READ_ONLY. If not specified, the default is to attach
               the disk in READ_WRITE mode.
        :param _builtins.str source: Specifies a valid partial or full URL to an existing
               Persistent Disk resource.
        :param _builtins.str type: Specifies the type of the disk, either SCRATCH or PERSISTENT.
...
class RuntimeVirtualMachineVirtualMachineConfigDataDiskInitializeParams(dict):
    ...
    def __init__(__self__, *,
                 ...
                 labels: Optional[Mapping[str, _builtins.str]] = None):
        """
        :param _builtins.str description: Provide this property when creating the disk.
        :param _builtins.str disk_name: Specifies the disk name. If not specified, the default is
               to use the name of the instance. If the disk with the
               instance name exists already in the given zone/region, a
               new name will be automatically generated.
        :param _builtins.int disk_size_gb: Specifies the size of the disk in base-2 GB. If not
               specified, the disk will be the same size as the image
               (usually 10GB). If specified, the size must be equal to
               or larger than 10GB. Default 100 GB.
        :param _builtins.str disk_type: The type of the boot disk attached to this runtime,
               defaults to standard persistent disk. For valid values,
               see `https://cloud.google.com/vertex-ai/docs/workbench/
               reference/rest/v1/projects.locations.runtimes#disktype`
        :param Mapping[str, _builtins.str] labels: Labels to apply to this disk. These can be later modified
...
class RuntimeVirtualMachineVirtualMachineConfigEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str kms_key: The Cloud KMS resource identifier of the customer-managed
...
class RuntimeVirtualMachineVirtualMachineConfigShieldedInstanceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool enable_secure_boot: Defines whether the instance has Secure Boot enabled.Secure
               Boot helps ensure that the system only runs authentic software
               by verifying the digital signature of all boot components, and
               halting the boot process if signature verification fails.
               Disabled by default.
        :param _builtins.bool enable_vtpm: Defines whether the instance has the vTPM enabled. Enabled by
               default.
        """
        if enable_integrity_monitoring is not None:
            pulumi.set(__self__, "enable_integrity_monitoring", enable_integrity_monitoring)
