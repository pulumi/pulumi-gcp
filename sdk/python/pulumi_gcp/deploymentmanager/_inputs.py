...
class DeploymentLabelArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: Key for label.
        :param pulumi.Input[builtins.str] value: Value of label.
        """
        if key is not None:
...
class DeploymentTargetConfigArgs:
    def __init__(__self__, *,
                 content: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] content: The full YAML contents of your configuration file.
        """
...
class DeploymentTargetImportArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content: The full contents of the template that you want to import.
        :param pulumi.Input[builtins.str] name: The name of the template to import, as declared in the YAML
               configuration.
