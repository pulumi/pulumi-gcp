...
class DatabaseIAMBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['DatabaseIAMBindingConditionArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['DatabaseIAMBindingConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['DatabaseIAMBindingConditionArgs']]):
...
class DatabaseIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['DatabaseIAMBindingConditionArgs', 'DatabaseIAMBindingConditionArgsDict', 'outputs.DatabaseIAMBindingCondition']]] = None,
                 database: pulumi.Input[Optional[_builtins.str]] = None,
                 instance: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * {{instance}}/{{database}} (project is taken from provider project)
        ...
        :param pulumi.Input[Union['DatabaseIAMBindingConditionArgs', 'DatabaseIAMBindingConditionArgsDict', 'outputs.DatabaseIAMBindingCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] database: The name of the Spanner database.
        :param pulumi.Input[_builtins.str] instance: The name of the Spanner instance the database belongs to.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] members: Identities that will be granted the privilege in `role`.
    ...
    def get(resource_name: str,
            ...
            members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'DatabaseIAMBinding':
        """
