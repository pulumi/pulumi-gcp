...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_type: The type of this instance. The type can be used to distinguish product variants, that can affect aspects like:
        ...
        :param pulumi.Input[_builtins.str] name: A unique identifier for the instance, which cannot be changed after
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] state: Instance status: `CREATING` or `READY`.
        """
        if autoscaling_config is not None:
            pulumi.set(__self__, "autoscaling_config", autoscaling_config)
