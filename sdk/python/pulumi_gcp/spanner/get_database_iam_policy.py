...
def get_database_iam_policy(database: Optional[builtins.str] = None,
    ...
    :param builtins.str database: The name of the Spanner database.
    :param builtins.str instance: The name of the Spanner instance the database belongs to.
...
def get_database_iam_policy_output(database: Optional[pulumi.Input[builtins.str]] = None,
