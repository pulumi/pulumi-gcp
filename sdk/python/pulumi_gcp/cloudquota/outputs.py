...
class SQuotaPreferenceQuotaConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 granted_value: Optional[builtins.str] = None,
                 request_origin: Optional[builtins.str] = None,
                 state_detail: Optional[builtins.str] = None,
                 trace_id: Optional[builtins.str] = None):
        """
        :param builtins.str preferred_value: The preferred value. Must be greater than or equal to -1. If set to -1, it means the value is "unlimited".
        :param Mapping[str, builtins.str] annotations: The annotations map for clients to store small amounts of arbitrary data. Do not put PII or other sensitive information here. See https://google.aip.dev/128#annotations.
               An object containing a list of "key: value" pairs. Example: `{ "name": "wrench", "mass": "1.3kg", "count": "3" }`.
        :param builtins.str granted_value: (Output)
               Granted quota value.
    ...
    def granted_value(self) -> Optional[builtins.str]:
        """
        (Output)
        Granted quota value.
        """
    ...
    def request_origin(self) -> Optional[builtins.str]:
        """
        (Output)
        The origin of the quota preference request.
    ...
    def state_detail(self) -> Optional[builtins.str]:
        """
        (Output)
        Optional details about the state of this quota preference.
        """
...
class GetSQuotaInfoDimensionsInfoResult(dict):
    def __init__(__self__, *,
                 applicable_locations: Sequence[builtins.str],
                 details: Sequence['outputs.GetSQuotaInfoDimensionsInfoDetailResult'],
                 dimensions: Mapping[str, builtins.str]):
        """
        :param Sequence[builtins.str] applicable_locations: The applicable regions or zones of this dimensions info. The field will be set to `['global']` for quotas that are not per region or per zone. Otherwise, it will be set to the list of locations this dimension info is applicable to.
        :param Sequence['GetSQuotaInfoDimensionsInfoDetailArgs'] details: The quota details for a map of dimensions.
        :param Mapping[str, builtins.str] dimensions: The map of dimensions for this dimensions info. The key of a map entry is "region", "zone" or the name of a service specific dimension, and the value of a map entry is the value of the dimension. If a dimension does not appear in the map of dimensions, the dimensions info applies to all the dimension values except for those that have another DimenisonInfo instance configured for the specific value. Example: {"provider" : "Foo Inc"} where "provider" is a service specific dimension of a quota.
        """
    ...
    def applicable_locations(self) -> Sequence[builtins.str]:
        """
...
class GetSQuotaInfoDimensionsInfoDetailResult(dict):
    def __init__(__self__, *,
                 value: builtins.str):
        """
        :param builtins.str value: The value currently in effect and being enforced.
        """
...
class GetSQuotaInfoQuotaIncreaseEligibilityResult(dict):
    def __init__(__self__, *,
                 ineligibility_reason: builtins.str,
                 is_eligible: builtins.bool):
        """
        :param builtins.str ineligibility_reason: The enumeration of reasons when it is ineligible to request increase adjustment.
        :param builtins.bool is_eligible: Whether a higher quota value can be requested for the quota.
        """
    ...
    def is_eligible(self) -> builtins.bool:
        """
...
class GetSQuotaInfosQuotaInfoResult(dict):
    def __init__(__self__, *,
                 ...
                 is_concurrent: builtins.bool,
                 is_fixed: builtins.bool,
                 is_precise: builtins.bool,
                 metric: builtins.str,
                 metric_display_name: builtins.str,
                 metric_unit: builtins.str,
                 name: builtins.str,
                 quota_display_name: builtins.str,
                 quota_id: builtins.str,
                 quota_increase_eligibilities: Sequence['outputs.GetSQuotaInfosQuotaInfoQuotaIncreaseEligibilityResult'],
                 refresh_interval: builtins.str,
                 service: builtins.str,
                 service_request_quota_uri: builtins.str):
        """
        :param builtins.str container_type: (Output) The container type of the QuotaInfo.
        :param Sequence[builtins.str] dimensions: The map of dimensions for this dimensions info. The key of a map entry is "region", "zone" or the name of a service specific dimension, and the value of a map entry is the value of the dimension. If a dimension does not appear in the map of dimensions, the dimensions info applies to all the dimension values except for those that have another DimenisonInfo instance configured for the specific value. Example: {"provider" : "Foo Inc"} where "provider" is a service specific dimension of a quota.
        ...
        :param builtins.bool is_concurrent: (Output) Whether the quota is a concurrent quota. Concurrent quotas are enforced on the total number of concurrent operations in flight at any given time.
        :param builtins.bool is_fixed: (Output) Whether the quota value is fixed or adjustable.
        :param builtins.bool is_precise: (Output) Whether this is a precise quota. A precise quota is tracked with absolute precision. In contrast, an imprecise quota is not tracked with precision.
        :param builtins.str metric: (Output) The metric of the quota. It specifies the resources consumption the quota is defined for, for example: `compute.googleapis.com/cpus`.
        :param builtins.str metric_display_name: (Output) The display name of the quota metric.
        :param builtins.str metric_unit: (Output) The unit in which the metric value is reported, e.g., `MByte`.
        :param builtins.str name: (Output) Resource name of this QuotaInfo, for example: `projects/123/locations/global/services/compute.googleapis.com/quotaInfos/CpusPerProjectPerRegion`.
        :param builtins.str quota_display_name: (Output) The display name of the quota.
        ...
        :param builtins.str refresh_interval: (Output) The reset time interval for the quota. Refresh interval applies to rate quota only. Example: "minute" for per minute, "day" for per day, or "10 seconds" for every 10 seconds.
        :param builtins.str service: The name of the service in which the quotas are defined.
        :param builtins.str service_request_quota_uri: (Output) URI to the page where users can request more quota for the cloud service, for example: `https://console.cloud.google.com/iam-admin/quotas`.
        """
