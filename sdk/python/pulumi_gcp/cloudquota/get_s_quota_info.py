...
class GetSQuotaInfoResult:
    ...
    def is_concurrent(self) -> builtins.bool:
        """
    ...
    def is_fixed(self) -> builtins.bool:
        """
    ...
    def is_precise(self) -> builtins.bool:
        """
...
def get_s_quota_info(parent: Optional[builtins.str] = None,
    ...
    :param builtins.str parent: The parent of the quota info. Allowed parents are "projects/[project-id / number]" or "folders/[folder-id / number]" or "organizations/[org-id / number].
    :param builtins.str quota_id: The id of the quota, which is unique within the service.
    :param builtins.str service: The name of the service in which the quota is defined.
    """
    __args__ = dict()
...
def get_s_quota_info_output(parent: Optional[pulumi.Input[builtins.str]] = None,
