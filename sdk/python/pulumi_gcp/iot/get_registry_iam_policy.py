...
def get_registry_iam_policy(name: Optional[str] = None,
    ...
    :param str region: The region in which the created registry should reside.
...
def get_registry_iam_policy_output(name: Optional[pulumi.Input[str]] = None,
