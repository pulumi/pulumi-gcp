...
class GuestPoliciesAssignment(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_name_prefixes: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] instance_name_prefixes: Targets VM instances whose name starts with one of these prefixes.
               Like labels, this is another way to group VM instances when targeting configs,
               for example prefix="prod-".
               Only supported for project-level policies.
        :param Sequence[_builtins.str] instances: Targets any of the instances specified. Instances are specified by their URI in the form
        ...
        :param Sequence['GuestPoliciesAssignmentOsTypeArgs'] os_types: Targets VM instances matching at least one of the following OS types.
               ...
               Structure is documented below.
        :param Sequence[_builtins.str] zones: Targets instances in any of these zones. Leave empty to target instances in any zone.
...
class GuestPoliciesAssignmentGroupLabel(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, _builtins.str] labels: Google Compute Engine instance labels that must be present for an instance to be included in this assignment group.
        """
...
class GuestPoliciesAssignmentOsType(dict):
    ...
    def __init__(__self__, *,
                 ...
                 os_short_name: Optional[_builtins.str] = None,
                 os_version: Optional[_builtins.str] = None):
        """
        :param _builtins.str os_architecture: Targets VM instances with OS Inventory enabled and having the following OS architecture.
        :param _builtins.str os_short_name: Targets VM instances with OS Inventory enabled and having the following OS short name, for example "debian" or "windows".
        :param _builtins.str os_version: Targets VM instances with OS Inventory enabled and having the following following OS version.
        """
...
class GuestPoliciesPackage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the package. A package is uniquely identified for conflict validation
               by checking the package name and the manager(s) that the package targets.
        :param _builtins.str desired_state: The desiredState the agent should maintain for this package. The default is to ensure the package is installed.
               Possible values are: `INSTALLED`, `UPDATED`, `REMOVED`.
        :param _builtins.str manager: Type of package manager that can be used to install this package. If a system does not have the package manager,
...
class GuestPoliciesPackageRepositoryApt(dict):
    ...
    def __init__(__self__, *,
                 ...
                 uri: _builtins.str,
                 archive_type: Optional[_builtins.str] = None,
                 gpg_key: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] components: List of components for this repository. Must contain at least one item.
        :param _builtins.str distribution: Distribution of this repository.
        :param _builtins.str uri: URI for this repository.
        :param _builtins.str archive_type: Type of archive files in this repository. The default behavior is DEB.
               Default value is `DEB`.
               Possible values are: `DEB`, `DEB_SRC`.
        :param _builtins.str gpg_key: URI of the key file for this repository. The agent maintains a keyring at
...
class GuestPoliciesPackageRepositoryGoo(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str url: The url of the repository.
        """
        pulumi.set(__self__, "name", name)
...
class GuestPoliciesPackageRepositoryYum(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gpg_keys: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str base_url: The location of the repository directory.
        :param _builtins.str id: A one word, unique name for this repository. This is the repo id in the Yum config file and also the displayName
               if displayName is omitted. This id is also used as the unique identifier when checking for guest policy conflicts.
        :param _builtins.str display_name: The display name of the repository.
        :param Sequence[_builtins.str] gpg_keys: URIs of GPG keys.
        """
...
class GuestPoliciesPackageRepositoryZypper(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str base_url: The location of the repository directory.
        :param _builtins.str id: A one word, unique name for this repository. This is the repo id in the zypper config file and also the displayName
               if displayName is omitted. This id is also used as the unique identifier when checking for guest policy conflicts.
        :param _builtins.str display_name: The display name of the repository.
        :param Sequence[_builtins.str] gpg_keys: URIs of GPG keys.
        """
...
class GuestPoliciesRecipe(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Unique identifier for the recipe. Only one recipe with a given name is installed on an instance.
        ...
        :param Sequence['GuestPoliciesRecipeArtifactArgs'] artifacts: Resources available to be used in the steps in the recipe.
               Structure is documented below.
        :param _builtins.str desired_state: Default is INSTALLED. The desired state the agent should maintain for this recipe.
        ...
        :param Sequence['GuestPoliciesRecipeUpdateStepArgs'] update_steps: Actions to be taken for updating this recipe. On failure it stops executing steps and does not attempt another update for this recipe.
               Any steps taken (including partially completed steps) are not rolled back.
               Structure is documented below.
        :param _builtins.str version: The version of this software recipe. Version can be up to 4 period separated numbers (e.g. 12.34.56.78).
        """
        pulumi.set(__self__, "name", name)
...
class GuestPoliciesRecipeArtifact(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: Id of the artifact, which the installation and update steps of this recipe can reference.
               Artifacts in a recipe cannot have the same id.
        :param _builtins.bool allow_insecure: Defaults to false. When false, recipes are subject to validations based on the artifact type:
...
class GuestPoliciesRecipeArtifactGcs(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str bucket: Bucket of the Google Cloud Storage object. Given an example URL: https://storage.googleapis.com/my-bucket/foo/bar#1234567
               this value would be my-bucket.
        :param _builtins.int generation: Must be provided if allowInsecure is false. Generation number of the Google Cloud Storage object.
               https://storage.googleapis.com/my-bucket/foo/bar#1234567 this value would be 1234567.
        :param _builtins.str object: Name of the Google Cloud Storage object. Given an example URL: https://storage.googleapis.com/my-bucket/foo/bar#1234567
...
class GuestPoliciesRecipeArtifactRemote(dict):
    ...
    def __init__(__self__, *,
                 check_sum: Optional[_builtins.str] = None,
                 uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str check_sum: Must be provided if allowInsecure is false. SHA256 checksum in hex format, to compare to the checksum of the artifact.
               If the checksum is not empty and it doesn't match the artifact then the recipe installation fails before running any
               of the steps.
        :param _builtins.str uri: URI from which to fetch the object. It should contain both the protocol and path following the format {protocol}://{location}.
        """
...
class GuestPoliciesRecipeInstallStepArchiveExtraction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str artifact_id: The id of the relevant artifact in the recipe.
        :param _builtins.str type: The type of the archive to extract.
               Possible values are: `TAR`, `TAR_GZIP`, `TAR_BZIP`, `TAR_LZMA`, `TAR_XZ`, `ZIP`.
        :param _builtins.str destination: Directory to extract archive to. Defaults to / on Linux or C:\\ on Windows.
        """
...
class GuestPoliciesRecipeInstallStepFileCopy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str artifact_id: The id of the relevant artifact in the recipe.
        :param _builtins.str destination: The absolute path on the instance to put the file.
        :param _builtins.bool overwrite: Whether to allow this step to overwrite existing files.If this is false and the file already exists the file
               is not overwritten and the step is considered a success. Defaults to false.
        :param _builtins.str permissions: Consists of three octal digits which represent, in order, the permissions of the owner, group, and other users
...
class GuestPoliciesRecipeInstallStepFileExec(dict):
    ...
    def __init__(__self__, *,
                 allowed_exit_codes: Optional[_builtins.str] = None,
                 args: Optional[Sequence[_builtins.str]] = None,
                 artifact_id: Optional[_builtins.str] = None,
                 local_path: Optional[_builtins.str] = None):
        """
        :param _builtins.str allowed_exit_codes: A list of possible return values that the program can return to indicate a success. Defaults to [0].
        :param Sequence[_builtins.str] args: Arguments to be passed to the provided executable.
        :param _builtins.str artifact_id: The id of the relevant artifact in the recipe.
        :param _builtins.str local_path: The absolute path of the file on the local filesystem.
        """
...
class GuestPoliciesRecipeInstallStepMsiInstallation(dict):
    ...
    def __init__(__self__, *,
                 artifact_id: _builtins.str,
                 allowed_exit_codes: Optional[Sequence[_builtins.int]] = None,
                 flags: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str artifact_id: The id of the relevant artifact in the recipe.
        :param Sequence[_builtins.int] allowed_exit_codes: Return codes that indicate that the software installed or updated successfully. Behaviour defaults to [0]
        :param Sequence[_builtins.str] flags: The flags to use when installing the MSI. Defaults to the install flag.
        """
        pulumi.set(__self__, "artifact_id", artifact_id)
        if allowed_exit_codes is not None:
            pulumi.set(__self__, "allowed_exit_codes", allowed_exit_codes)
...
class GuestPoliciesRecipeInstallStepScriptRun(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allowed_exit_codes: Optional[Sequence[_builtins.int]] = None,
                 interpreter: Optional[_builtins.str] = None):
        """
        :param _builtins.str script: The shell script to be executed.
        :param Sequence[_builtins.int] allowed_exit_codes: Return codes that indicate that the software installed or updated successfully. Behaviour defaults to [0]
        :param _builtins.str interpreter: The script interpreter to use to run the script. If no interpreter is specified the script is executed directly,
...
class GuestPoliciesRecipeUpdateStepFileExec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 local_path: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.int] allowed_exit_codes: A list of possible return values that the program can return to indicate a success. Defaults to [0].
        :param Sequence[_builtins.str] args: Arguments to be passed to the provided executable.
        :param _builtins.str artifact_id: The id of the relevant artifact in the recipe.
        :param _builtins.str local_path: The absolute path of the file on the local filesystem.
        """
...
class OsPolicyAssignmentInstanceFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool all: Target all VMs in the project. If true, no other criteria
               is permitted.
...
class OsPolicyAssignmentInstanceFilterExclusionLabel(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, _builtins.str] labels: Labels are identified by key/value pairs in this map.
...
class OsPolicyAssignmentInstanceFilterInventory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 os_version: Optional[_builtins.str] = None):
        """
        :param _builtins.str os_short_name: The OS short name
        :param _builtins.str os_version: The OS version Prefix matches are supported if
...
class OsPolicyAssignmentOsPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_no_resource_group_match: Optional[_builtins.bool] = None,
                 description: Optional[_builtins.str] = None):
        """
        :param _builtins.str id: The id of the OS policy with the following restrictions:
        ...
        :param _builtins.str mode: Policy mode Possible values are: `MODE_UNSPECIFIED`,
        ...
        :param Sequence['OsPolicyAssignmentOsPolicyResourceGroupArgs'] resource_groups: List of resource groups for the policy. For a
               ...
               documented below.
        :param _builtins.bool allow_no_resource_group_match: This flag determines the OS
        ...
        :param _builtins.str description: Policy description. Length of the description is
...
class OsPolicyAssignmentOsPolicyResourceGroupResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: The id of the resource with the following restrictions:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforce(dict):
    ...
    def __init__(__self__, *,
                 ...
                 output_file_path: Optional[_builtins.str] = None,
                 script: Optional[_builtins.str] = None):
        """
        :param _builtins.str interpreter: The script interpreter to use. Possible values
               are: `INTERPRETER_UNSPECIFIED`, `NONE`, `SHELL`, `POWERSHELL`.
        :param Sequence[_builtins.str] args: Optional arguments to pass to the source during
               execution.
        :param 'OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileArgs' file: A remote or local file. Structure is
               documented below.
        :param _builtins.str output_file_path: Only recorded for enforce Exec. Path to an
        ...
        :param _builtins.str script: An inline script. The size of the script is limited to
               1024 characters.
        """
        pulumi.set(__self__, "interpreter", interpreter)
        if args is not None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_insecure: Defaults to false. When false, files are
        ...
        :param 'OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcsArgs' gcs: A Cloud Storage object. Structure is
               documented below.
        :param _builtins.str local_path: A local path within the VM to use.
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileGcs(dict):
    def __init__(__self__, *,
                 ...
                 generation: Optional[_builtins.int] = None):
        """
        :param _builtins.str bucket: Bucket of the Cloud Storage object.
        :param _builtins.str object: Name of the Cloud Storage object.
        :param _builtins.int generation: Generation number of the Cloud Storage object.
        """
        pulumi.set(__self__, "bucket", bucket)
        pulumi.set(__self__, "object", object)
        if generation is not None:
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceExecEnforceFileRemote(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str uri: URI from which to fetch the object. It should contain
               both the protocol and path following the format `{protocol}://{location}`.
        :param _builtins.str sha256_checksum: SHA256 checksum of the remote file.
        """
        pulumi.set(__self__, "uri", uri)
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceFile(dict):
    def __init__(__self__, *,
                 ...
                 permissions: Optional[_builtins.str] = None):
        """
        :param _builtins.str path: The absolute path of the file within the VM.
        :param _builtins.str state: Desired state of the file. Possible values are:
               `DESIRED_STATE_UNSPECIFIED`, `PRESENT`, `ABSENT`, `CONTENTS_MATCH`.
        :param _builtins.str content: A a file with this content. The size of the content
               is limited to 1024 characters.
        :param 'OsPolicyAssignmentOsPolicyResourceGroupResourceFileFileArgs' file: A remote or local source. Structure is
               documented below.
        :param _builtins.str permissions: Consists of three octal digits which represent, in
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkg(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str desired_state: The desired state the agent should maintain for
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgApt(dict):
    def __init__(__self__, *,
                 name: _builtins.str):
        """
        :param _builtins.str name: Package name.
        """
        pulumi.set(__self__, "name", name)
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDeb(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pull_deps: Optional[_builtins.bool] = None):
        """
        :param 'OsPolicyAssignmentOsPolicyResourceGroupResourcePkgDebSourceArgs' source: A deb package. Structure is
               documented below.
        :param _builtins.bool pull_deps: Whether dependencies should also be installed. -
...
class OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsi(dict):
    def __init__(__self__, *,
        ...
        :param 'OsPolicyAssignmentOsPolicyResourceGroupResourcePkgMsiSourceArgs' source: The MSI package. Structure is
               documented below.
        :param Sequence[_builtins.str] properties: Additional properties to use during installation.
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryApt(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gpg_key: Optional[_builtins.str] = None):
        """
        :param _builtins.str archive_type: Type of archive files in this repository.
               Possible values are: `ARCHIVE_TYPE_UNSPECIFIED`, `DEB`, `DEB_SRC`.
        :param Sequence[_builtins.str] components: List of components for this repository. Must
               contain at least one item.
        :param _builtins.str distribution: Distribution of this repository.
        :param _builtins.str uri: URI for this repository.
        :param _builtins.str gpg_key: URI of the key file for this repository. The agent
...
class OsPolicyAssignmentOsPolicyResourceGroupResourceRepositoryYum(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str base_url: The location of the repository directory.
        :param _builtins.str id: A one word, unique name for this repository. This is the
...
class OsPolicyAssignmentRollout(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'OsPolicyAssignmentRolloutDisruptionBudgetArgs' disruption_budget: The maximum number (or percentage) of VMs
               ...
               documented below.
        :param _builtins.str min_wait_duration: This determines the minimum duration of
...
class OsPolicyAssignmentRolloutDisruptionBudget(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int fixed: Specifies a fixed value.
        :param _builtins.int percent: Specifies the relative value defined as a percentage,
...
class PatchDeploymentInstanceFilter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 zones: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.bool all: Target all VM instances in the project. If true, no other criteria is permitted.
        :param Sequence['PatchDeploymentInstanceFilterGroupLabelArgs'] group_labels: Targets VM instances matching ANY of these GroupLabels. This allows targeting of disparate groups of VM instances.
               Structure is documented below.
        :param Sequence[_builtins.str] instance_name_prefixes: Targets VMs whose name starts with one of these prefixes. Similar to labels, this is another way to group
               VMs when targeting configs, for example prefix="prod-".
        :param Sequence[_builtins.str] instances: Targets any of the VM instances specified. Instances are specified by their URI in the `form zones/{{zone}}/instances/{{instance_name}}`,
               `projects/{{project_id}}/zones/{{zone}}/instances/{{instance_name}}`, or
               `https://www.googleapis.com/compute/v1/projects/{{project_id}}/zones/{{zone}}/instances/{{instance_name}}`
        :param Sequence[_builtins.str] zones: Targets VM instances in ANY of these zones. Leave empty to target VM instances in any zone.
        """
        if all is not None:
            pulumi.set(__self__, "all", all)
        if group_labels is not None:
...
class PatchDeploymentInstanceFilterGroupLabel(dict):
    def __init__(__self__, *,
                 labels: Mapping[str, _builtins.str]):
        """
        :param Mapping[str, _builtins.str] labels: Compute Engine instance labels that must be present for a VM instance to be targeted by this filter
        """
        pulumi.set(__self__, "labels", labels)
...
class PatchDeploymentOneTimeSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str execute_time: The desired patch job execution time. A timestamp in RFC3339 UTC "Zulu" format,
...
class PatchDeploymentPatchConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mig_instances_allowed: Optional[_builtins.bool] = None,
        ...
        :param 'PatchDeploymentPatchConfigGooArgs' goo: goo update settings. Use this setting to override the default goo patch rules.
               Structure is documented below.
        :param _builtins.bool mig_instances_allowed: Allows the patch job to run on Managed instance groups (MIGs).
...
class PatchDeploymentPatchConfigApt(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exclusive_packages: Optional[Sequence[_builtins.str]] = None,
                 type: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] excludes: List of packages to exclude from update. These packages will be excluded.
        :param Sequence[_builtins.str] exclusive_packages: An exclusive list of packages to be updated. These are the only packages that will be updated.
               If these packages are not installed, they will be ignored. This field cannot be specified with
               any other patch configuration fields.
        :param _builtins.str type: By changing the type to DIST, the patching is performed using apt-get dist-upgrade instead.
...
class PatchDeploymentPatchConfigGoo(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: goo update settings. Use this setting to override the default goo patch rules.
        """
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfig(dict):
    ...
    def __init__(__self__, *,
                 allowed_success_codes: Optional[Sequence[_builtins.int]] = None,
                 gcs_object: Optional['outputs.PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject'] = None,
                 interpreter: Optional[_builtins.str] = None,
                 local_path: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.int] allowed_success_codes: Defaults to [0]. A list of possible return values that the execution can return to indicate a success.
        :param 'PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObjectArgs' gcs_object: A Cloud Storage object containing the executable.
               Structure is documented below.
        :param _builtins.str interpreter: The script interpreter to use to run the script. If no interpreter is specified the script will
               be executed directly, which will likely only succeed for scripts with shebang lines.
               Possible values are: `SHELL`, `POWERSHELL`.
        :param _builtins.str local_path: An absolute path to the executable on the VM.
        """
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str bucket: Bucket of the Cloud Storage object.
        :param _builtins.str generation_number: Generation number of the Cloud Storage object. This is used to ensure that the ExecStep specified by this PatchJob does not change.
        :param _builtins.str object: Name of the Cloud Storage object.
        """
        pulumi.set(__self__, "bucket", bucket)
...
class PatchDeploymentPatchConfigWindowsUpdate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 excludes: Optional[Sequence[_builtins.str]] = None,
                 exclusive_patches: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] classifications: Only apply updates of these windows update classifications. If empty, all updates are applied.
               Each value may be one of: `CRITICAL`, `SECURITY`, `DEFINITION`, `DRIVER`, `FEATURE_PACK`, `SERVICE_PACK`, `TOOL`, `UPDATE_ROLLUP`, `UPDATE`.
        :param Sequence[_builtins.str] excludes: List of KBs to exclude from update.
        :param Sequence[_builtins.str] exclusive_patches: An exclusive list of kbs to be updated. These are the only patches that will be updated.
...
class PatchDeploymentPatchConfigYum(dict):
    ...
    def __init__(__self__, *,
                 excludes: Optional[Sequence[_builtins.str]] = None,
                 exclusive_packages: Optional[Sequence[_builtins.str]] = None,
                 minimal: Optional[_builtins.bool] = None,
                 security: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] excludes: List of packages to exclude from update. These packages will be excluded.
        :param Sequence[_builtins.str] exclusive_packages: An exclusive list of packages to be updated. These are the only packages that will be updated.
               If these packages are not installed, they will be ignored. This field cannot be specified with
               any other patch configuration fields.
        :param _builtins.bool minimal: Will cause patch to run yum update-minimal instead.
        :param _builtins.bool security: Adds the --security flag to yum update. Not supported on all platforms.
        """
        if excludes is not None:
            pulumi.set(__self__, "excludes", excludes)
        if exclusive_packages is not None:
...
class PatchDeploymentPatchConfigZypper(dict):
    ...
    def __init__(__self__, *,
                 ...
                 with_optional: Optional[_builtins.bool] = None,
                 with_update: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] categories: Install only patches with these categories. Common categories include security, recommended, and feature.
        :param Sequence[_builtins.str] excludes: List of packages to exclude from update.
        :param Sequence[_builtins.str] exclusive_patches: An exclusive list of patches to be updated. These are the only patches that will be installed using 'zypper patch patch:' command.
               This field must not be used with any other patch configuration fields.
        :param Sequence[_builtins.str] severities: Install only patches with these severities. Common severities include critical, important, moderate, and low.
        :param _builtins.bool with_optional: Adds the --with-optional flag to zypper patch.
        :param _builtins.bool with_update: Adds the --with-update flag, to zypper patch.
        """
...
class PatchDeploymentRecurringSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_execute_time: Optional[_builtins.str] = None,
                 monthly: Optional['outputs.PatchDeploymentRecurringScheduleMonthly'] = None,
                 next_execute_time: Optional[_builtins.str] = None,
        ...
        :param 'PatchDeploymentRecurringScheduleTimeZoneArgs' time_zone: Defines the time zone that timeOfDay is relative to. The rules for daylight saving time are
               ...
               Structure is documented below.
        :param _builtins.str end_time: The end time at which a recurring patch deployment schedule is no longer active.
               A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
        :param _builtins.str last_execute_time: (Output)
               The time the last patch job ran successfully.
               A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
        :param 'PatchDeploymentRecurringScheduleMonthlyArgs' monthly: Schedule with monthly executions.
               Structure is documented below.
        :param _builtins.str next_execute_time: (Output)
               The time the next patch job is scheduled to run.
               A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
        :param _builtins.str start_time: The time that the recurring schedule becomes effective. Defaults to createTime of the patch deployment.
               A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds. Example: "2014-10-02T15:01:23.045123456Z".
...
class PatchDeploymentRecurringScheduleMonthly(dict):
    ...
    def __init__(__self__, *,
                 month_day: Optional[_builtins.int] = None,
                 week_day_of_month: Optional['outputs.PatchDeploymentRecurringScheduleMonthlyWeekDayOfMonth'] = None):
        """
        :param _builtins.int month_day: One day of the month. 1-31 indicates the 1st to the 31st day. -1 indicates the last day of the month.
...
class PatchDeploymentRecurringScheduleMonthlyWeekDayOfMonth(dict):
    ...
    def __init__(__self__, *,
                 ...
                 day_offset: Optional[_builtins.int] = None):
        """
        :param _builtins.str day_of_week: A day of the week.
               Possible values are: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        :param _builtins.int week_ordinal: Week number in a month. 1-4 indicates the 1st to 4th week of the month. -1 indicates the last week of the month.
        :param _builtins.int day_offset: Represents the number of days before or after the given week day of month that the patch deployment is scheduled for.
        """
...
class PatchDeploymentRecurringScheduleTimeOfDay(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.int seconds: Seconds of minutes of the time. Must normally be from 0 to 59. An API may allow the value 60 if it allows leap-seconds.
        """
...
class PatchDeploymentRecurringScheduleWeekly(dict):
    ...
    def __init__(__self__, *,
                 day_of_week: _builtins.str):
        """
        :param _builtins.str day_of_week: IANA Time Zone Database time zone, e.g. "America/New_York".
               Possible values are: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        """
        pulumi.set(__self__, "day_of_week", day_of_week)
...
class PatchDeploymentRollout(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PatchDeploymentRolloutDisruptionBudgetArgs' disruption_budget: The maximum number (or percentage) of VMs per zone to disrupt at any given moment. The number of VMs calculated from multiplying the percentage by the total number of VMs in a zone is rounded up.
               ...
               Structure is documented below.
        :param _builtins.str mode: Mode of the patch rollout.
...
class PatchDeploymentRolloutDisruptionBudget(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int fixed: Specifies a fixed value.
        :param _builtins.int percentage: Specifies the relative value defined as a percentage, which will be multiplied by a reference value.
        """
        if fixed is not None:
            pulumi.set(__self__, "fixed", fixed)
...
class V2PolicyOrchestratorForFolderOrchestratedResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: ID of the resource to be used while generating set of affected resources.
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1Payload(dict):
    ...
    def __init__(__self__, *,
                 ...
                 revision_create_time: Optional[_builtins.str] = None,
                 revision_id: Optional[_builtins.str] = None,
                 rollout_state: Optional[_builtins.str] = None,
        ...
        :param 'V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutArgs' rollout: Message to configure the rollout at the zonal level for the OS policy
               assignment.
        :param _builtins.bool baseline: Indicates that this revision has been successfully rolled out in this zone
               and new VMs will be assigned OS policies from this revision.
               
               For a given OS policy assignment, there is only one revision with a value
               of 'true' for this field.
        :param _builtins.bool deleted: Indicates that this revision deletes the OS policy assignment.
        :param _builtins.str description: Freeform text describing the purpose of the resource.
        :param _builtins.str etag: This checksum is computed by the server based on the value of other
               fields, and may be sent on update and delete requests to ensure the
               client has an up-to-date value before proceeding.
        :param _builtins.str name: Identifier. In form of
               * `organizations/{organization_id}/locations/global/policyOrchestrators/{orchestrator_id}`
               * `folders/{folder_id}/locations/global/policyOrchestrators/{orchestrator_id}`
               * `projects/{project_id_or_number}/locations/global/policyOrchestrators/{orchestrator_id}`
        :param _builtins.bool reconciling: Set to true, if the there are ongoing changes being applied by the
               orchestrator.
        :param _builtins.str revision_create_time: The timestamp that the revision was created.
        :param _builtins.str revision_id: The assignment revision ID
               A new revision is committed whenever a rollout is triggered for a OS policy
               assignment
        :param _builtins.str rollout_state: OS policy assignment rollout state
               Possible values:
               IN_PROGRESS
               CANCELLING
               CANCELLED
               SUCCEEDED
        :param _builtins.str uid: Server generated unique id for the OS policy assignment resource.
        """
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool all: Target all VMs in the project. If true, no other criteria is
               permitted.
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str id: The id of the OS policy with the following restrictions:
               ...
               * Must end with a number or a letter.
               * Must be unique within the assignment.
        :param _builtins.str mode: Policy mode
        ...
        :param Sequence['V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupArgs'] resource_groups: List of resource groups for the policy.
               ...
               Structure is documented below.
        :param _builtins.bool allow_no_resource_group_match: This flag determines the OS policy compliance status when none of the
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce(dict):
    ...
    def __init__(__self__, *,
                 ...
                 script: Optional[_builtins.str] = None):
        """
        :param _builtins.str interpreter: The script interpreter to use.
               Possible values are: `NONE`, `SHELL`, `POWERSHELL`.
        :param Sequence[_builtins.str] args: Optional arguments to pass to the source during execution.
        :param 'V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileArgs' file: A remote or local file.
               Structure is documented below.
        :param _builtins.str output_file_path: Only recorded for enforce Exec.
               Path to an output file (that is created by this Exec) whose
               content will be recorded in OSPolicyResourceCompliance after a
               successful run. Absence or failure to read this file will result in
               this ExecResource being non-compliant. Output file size is limited to
               500K bytes.
        :param _builtins.str script: An inline script.
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_insecure: Defaults to false. When false, files are subject to validations
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileGcs(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str bucket: Bucket of the Cloud Storage object.
        :param _builtins.str object: Name of the Cloud Storage object.
        :param _builtins.str generation: Generation number of the Cloud Storage object.
        """
        pulumi.set(__self__, "bucket", bucket)
        pulumi.set(__self__, "object", object)
        if generation is not None:
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileRemote(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sha256_checksum: Optional[_builtins.str] = None):
        """
        :param _builtins.str uri: URI from which to fetch the object. It should contain both the
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str path: The absolute path of the file within the VM.
        :param _builtins.str state: Desired state of the file.
               Possible values are: `PRESENT`, `ABSENT`, `CONTENTS_MATCH`.
        :param _builtins.str content: A a file with this content.
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str desired_state: The desired state the agent should maintain for this package.
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryApt(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str archive_type: Type of archive files in this repository.
               Possible values are: `DEB`, `DEB_SRC`.
        :param Sequence[_builtins.str] components: List of components for this repository. Must contain at least one
               item.
        :param _builtins.str distribution: Distribution of this repository.
        :param _builtins.str uri: URI for this repository.
        :param _builtins.str gpg_key: URI of the key file for this repository. The agent maintains a
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryYum(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str base_url: The location of the repository directory.
        :param _builtins.str id: A one word, unique name for this repository. This is  the `repo
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadRollout(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutDisruptionBudgetArgs' disruption_budget: Message encapsulating a value that can be either absolute ("fixed") or
               ...
               Structure is documented below.
        :param _builtins.str min_wait_duration: This determines the minimum duration of time to wait after the
...
class V2PolicyOrchestratorForFolderOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutDisruptionBudget(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int fixed: Specifies a fixed value.
        :param _builtins.int percent: Specifies the relative value defined as a percentage, which will be
...
class V2PolicyOrchestratorForFolderOrchestrationScopeSelectorLocationSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] included_locations: Names of the locations in scope.
...
class V2PolicyOrchestratorForFolderOrchestrationScopeSelectorResourceHierarchySelector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] included_folders: Names of the folders in scope.
               Format: `folders/{folder_id}`
        :param Sequence[_builtins.str] included_projects: Names of the projects in scope.
...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationState(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failed_actions: Optional[_builtins.str] = None,
                 finish_time: Optional[_builtins.str] = None,
                 performed_actions: Optional[_builtins.str] = None,
                 progress: Optional[_builtins.float] = None,
                 rollout_resource: Optional[_builtins.str] = None,
                 start_time: Optional[_builtins.str] = None,
        ...
        :param _builtins.str state: State of the orchestrator. Can be updated to change orchestrator behaviour.
               Allowed values:
...
class V2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateErrorDetail(dict):
    ...
    def __init__(__self__, *,
                 type_url: Optional[_builtins.str] = None,
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str type_url: (Output)
...
class V2PolicyOrchestratorForOrganizationOrchestratedResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: Optional. ID of the resource to be used while generating set of affected resources.
               For UPSERT action the value is auto-generated during PolicyOrchestrator
               creation when not set. When the value is set it should following next
               restrictions:
               * Must contain only lowercase letters, numbers, and hyphens.
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1Payload(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutArgs' rollout: Message to configure the rollout at the zonal level for the OS policy
               assignment.
        :param _builtins.bool baseline: Output only. Indicates that this revision has been successfully rolled out in this zone
               and new VMs will be assigned OS policies from this revision.
               
               For a given OS policy assignment, there is only one revision with a value
               of 'true' for this field.
        :param _builtins.bool deleted: Output only. Indicates that this revision deletes the OS policy assignment.
        :param _builtins.str description: Optional. Freeform text describing the purpose of the resource.
        :param _builtins.str etag: Output only. This checksum is computed by the server based on the value of other
               fields, and may be sent on update and delete requests to ensure the
               client has an up-to-date value before proceeding.
        :param _builtins.str name: Immutable. Identifier. In form of
               * `organizations/{organization_id}/locations/global/policyOrchestrators/{orchestrator_id}`
               * `folders/{folder_id}/locations/global/policyOrchestrators/{orchestrator_id}`
               * `projects/{project_id_or_number}/locations/global/policyOrchestrators/{orchestrator_id}`
        :param _builtins.bool reconciling: Output only. Set to true, if the there are ongoing changes being applied by the
               orchestrator.
        :param _builtins.str revision_create_time: Output only. The timestamp that the revision was created.
        :param _builtins.str revision_id: Output only. The assignment revision ID
               A new revision is committed whenever a rollout is triggered for a OS policy
               assignment
        :param _builtins.str rollout_state: Output only. OS policy assignment rollout state
               Possible values:
               ...
               CANCELLED
               SUCCEEDED
        :param _builtins.str uid: Output only. Server generated unique id for the OS policy assignment resource.
        """
        pulumi.set(__self__, "instance_filter", instance_filter)
        pulumi.set(__self__, "os_policies", os_policies)
        pulumi.set(__self__, "rollout", rollout)
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadInstanceFilterInventory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 os_version: Optional[_builtins.str] = None):
        """
        :param _builtins.str os_short_name: Required. The OS short name
        :param _builtins.str os_version: The OS version
               Prefix matches are supported if asterisk(*) is provided as the
               last character. For example, to match all versions with a major
               version of `7`, specify the following value for this field `7.*`
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[_builtins.str] = None):
        """
        :param _builtins.str id: Required. The id of the OS policy with the following restrictions:
               * Must contain only lowercase letters, numbers, and hyphens.
               * Must start with a letter.
               * Must be between 1-63 characters.
               * Must end with a number or a letter.
               * Must be unique within the assignment.
        :param _builtins.str mode: Required. Policy mode
               Possible values:
               MODE_UNSPECIFIED
               VALIDATION
               ENFORCEMENT
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: Required. The id of the resource with the following restrictions:
               * Must contain only lowercase letters, numbers, and hyphens.
               * Must start with a letter.
               * Must be between 1-63 characters.
               * Must end with a number or a letter.
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforce(dict):
    ...
    def __init__(__self__, *,
                 ...
                 script: Optional[_builtins.str] = None):
        """
        :param _builtins.str interpreter: Required. The script interpreter to use.
               Possible values:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileGcs(dict):
    def __init__(__self__, *,
                 ...
                 generation: Optional[_builtins.str] = None):
        """
        :param _builtins.str bucket: Required. Bucket of the Cloud Storage object.
        :param _builtins.str object: Required. Name of the Cloud Storage object.
        :param _builtins.str generation: Generation number of the Cloud Storage object.
        """
        pulumi.set(__self__, "bucket", bucket)
        pulumi.set(__self__, "object", object)
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceExecEnforceFileRemote(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sha256_checksum: Optional[_builtins.str] = None):
        """
        :param _builtins.str uri: Required. URI from which to fetch the object. It should contain both the
               protocol and path following the format `{protocol}://{location}`.
        :param _builtins.str sha256_checksum: SHA256 checksum of the remote file.
        """
        pulumi.set(__self__, "uri", uri)
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceFile(dict):
    def __init__(__self__, *,
                 ...
                 permissions: Optional[_builtins.str] = None):
        """
        :param _builtins.str path: Required. The absolute path of the file within the VM.
        :param _builtins.str state: Required. Desired state of the file.
               Possible values:
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkg(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str desired_state: Required. The desired state the agent should maintain for this package.
               Possible values:
               DESIRED_STATE_UNSPECIFIED
               INSTALLED
               REMOVED
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourcePkgApt(dict):
    def __init__(__self__, *,
                 name: _builtins.str):
        """
        :param _builtins.str name: Required. Package name.
        """
        pulumi.set(__self__, "name", name)
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryApt(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gpg_key: Optional[_builtins.str] = None):
        """
        :param _builtins.str archive_type: Required. Type of archive files in this repository.
               Possible values:
               ARCHIVE_TYPE_UNSPECIFIED
               DEB
               DEB_SRC
        :param Sequence[_builtins.str] components: Required. List of components for this repository. Must contain at least one
               item.
        :param _builtins.str distribution: Required. Distribution of this repository.
        :param _builtins.str uri: Required. URI for this repository.
        :param _builtins.str gpg_key: URI of the key file for this repository. The agent maintains a
               keyring at `/etc/apt/trusted.gpg.d/osconfig_agent_managed.gpg`.
        """
        pulumi.set(__self__, "archive_type", archive_type)
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryGoo(dict):
    def __init__(__self__, *,
                 ...
                 url: _builtins.str):
        """
        :param _builtins.str name: Required. The name of the repository.
        :param _builtins.str url: Required. The url of the repository.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "url", url)
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadOsPolicyResourceGroupResourceRepositoryYum(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gpg_keys: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str base_url: Required. The location of the repository directory.
        :param _builtins.str id: Required. A one word, unique name for this repository. This is  the `repo
               id` in the yum config file and also the `display_name` if
               `display_name` is omitted. This id is also used as the unique
               identifier when checking for resource conflicts.
        :param _builtins.str display_name: The display name of the repository.
...
class V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadRollout(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'V2PolicyOrchestratorForOrganizationOrchestratedResourceOsPolicyAssignmentV1PayloadRolloutDisruptionBudgetArgs' disruption_budget: Message encapsulating a value that can be either absolute ("fixed") or
               relative ("percent") to a value.
               Structure is documented below.
        :param _builtins.str min_wait_duration: Required. This determines the minimum duration of time to wait after the
               configuration changes are applied through the current rollout. A
               VM continues to count towards the `disruption_budget` at least
               until this duration of time has passed after configuration changes are
               applied.
...
class V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorLocationSelector(dict):
    ...
    def __init__(__self__, *,
                 included_locations: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] included_locations: Optional. Names of the locations in scope.
               Format: `us-central1-a`
        """
        if included_locations is not None:
            pulumi.set(__self__, "included_locations", included_locations)
...
class V2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorResourceHierarchySelector(dict):
    ...
    def __init__(__self__, *,
                 ...
                 included_projects: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] included_folders: Optional. Names of the folders in scope.
               Format: `folders/{folder_id}`
        :param Sequence[_builtins.str] included_projects: Optional. Names of the projects in scope.
               Format: `projects/{project_number}`
        """
        if included_folders is not None:
            pulumi.set(__self__, "included_folders", included_folders)
...
class V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationState(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str state: Optional. State of the orchestrator. Can be updated to change orchestrator behaviour.
               Allowed values:
               - `ACTIVE` - orchestrator is actively looking for actions to be taken.
               - `STOPPED` - orchestrator won't make any changes.
               Note: There might be more states added in the future. We use string here
...
class V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateError(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateErrorDetailArgs'] details: A list of messages that carry the error details.  There is a common set of
               message types for APIs to use.
               Structure is documented below.
        :param _builtins.str message: A developer-facing error message, which should be in English. Any
               user-facing error message should be localized and sent in the
               google.rpc.Status.details field, or localized by the client.
        """
        if code is not None:
...
class V2PolicyOrchestratorForOrganizationOrchestrationStateCurrentIterationStateErrorDetail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str type_url: A URL/resource name that uniquely identifies the type of the serialized protocol buffer message
