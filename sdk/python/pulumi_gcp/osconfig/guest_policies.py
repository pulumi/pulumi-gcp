...
class GuestPoliciesArgs:
    def __init__(__self__, *,
                 ...
                 guest_policy_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] guest_policy_id: The logical name of the guest policy in the project with the following restrictions:
    ...
    def guest_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def guest_policy_id(self, value: pulumi.Input[builtins.str]):
...
class _GuestPoliciesState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 etag: Optional[pulumi.Input[builtins.str]] = None,
                 guest_policy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['GuestPoliciesAssignmentArgs'] assignment: Specifies the VM instances that are assigned to this policy. This allows you to target sets
               ...
               [handles assignment conflicts](https://cloud.google.com/compute/docs/os-config-management/create-guest-policy#handle-conflicts).
               Structure is documented below.
        :param pulumi.Input[builtins.str] create_time: Time this guest policy was created. A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds.
    ...
    @property
    @pulumi.getter(name="guestPolicyId")
    def guest_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The logical name of the guest policy in the project with the following restrictions:
        * Must contain only lowercase letters, numbers, and hyphens.
        * Must start with a letter.
    ...
    @guest_policy_id.setter
    def guest_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "guest_policy_id", value)
...
class GuestPolicies(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            recipes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['GuestPoliciesRecipeArgs', 'GuestPoliciesRecipeArgsDict']]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'GuestPolicies':
        """
    ...
    @property
    @pulumi.getter(name="guestPolicyId")
    def guest_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The logical name of the guest policy in the project with the following restrictions:
        * Must contain only lowercase letters, numbers, and hyphens.
        * Must start with a letter.
