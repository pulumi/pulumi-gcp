...
class OsPolicyAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 skip_await_rollout: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: OS policy assignment description. Length of the description is limited to 1024 characters.
        :param pulumi.Input[builtins.str] name: Resource name.
        :param pulumi.Input[builtins.str] project: The project for the resource
        :param pulumi.Input[builtins.bool] skip_await_rollout: Set to true to skip awaiting rollout during resource creation and update.
        """
    ...
    def skip_await_rollout(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_await_rollout(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _OsPolicyAssignmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] baseline: Output only. Indicates that this revision has been successfully
        ...
        :param pulumi.Input[builtins.bool] deleted: Output only. Indicates that this revision deletes the OS policy
               assignment.
        :param pulumi.Input[builtins.str] description: OS policy assignment description. Length of the description is limited to 1024 characters.
        :param pulumi.Input[builtins.str] etag: The etag for this OS policy assignment. If this is provided on
        ...
        :param pulumi.Input[Sequence[pulumi.Input['OsPolicyAssignmentOsPolicyArgs']]] os_policies: List of OS policies to be applied to the VMs.
               Structure is documented below.
        :param pulumi.Input[builtins.str] project: The project for the resource
        :param pulumi.Input[builtins.bool] reconciling: Output only. Indicates that reconciliation is in progress
               for the revision. This value is `true` when the `rollout_state` is one of:
        :param pulumi.Input[builtins.str] revision_create_time: Output only. The timestamp that the revision was
               created.
        :param pulumi.Input[builtins.str] revision_id: Output only. The assignment revision ID A new revision is
        ...
        :param pulumi.Input[builtins.bool] skip_await_rollout: Set to true to skip awaiting rollout during resource creation and update.
        :param pulumi.Input[builtins.str] uid: Output only. Server generated unique id for the OS policy assignment
               resource.
        """
...
class OsPolicyAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rollout_state: Optional[pulumi.Input[builtins.str]] = None,
            skip_await_rollout: Optional[pulumi.Input[builtins.bool]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None) -> 'OsPolicyAssignment':
        """
    ...
    @property
    @pulumi.getter
    def baseline(self) -> pulumi.Output[builtins.bool]:
        """
        Output only. Indicates that this revision has been successfully
        rolled out in this zone and new VMs will be assigned OS policies from this
        revision. For a given OS policy assignment, there is only one revision with
    ...
    @property
    @pulumi.getter(name="rolloutState")
    def rollout_state(self) -> pulumi.Output[builtins.str]:
        """
        Output only. OS policy assignment rollout state
        """
        return pulumi.get(self, "rollout_state")
    ...
    @property
    @pulumi.getter(name="skipAwaitRollout")
    def skip_await_rollout(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to true to skip awaiting rollout during resource creation and update.
        """
        return pulumi.get(self, "skip_await_rollout")
