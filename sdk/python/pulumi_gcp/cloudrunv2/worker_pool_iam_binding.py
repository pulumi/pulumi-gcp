...
class WorkerPoolIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The location of the cloud run worker pool Used to find the parent resource to bind the IAM policy to. If not specified,
...
class WorkerPoolIamBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkerPoolIamBinding':
        """
