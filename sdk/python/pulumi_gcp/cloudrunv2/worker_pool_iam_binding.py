...
__all__ = ['WorkerPoolIamBindingArgs', 'WorkerPoolIamBinding']
...
class WorkerPoolIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['WorkerPoolIamBindingConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The location of the cloud run worker pool Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['WorkerPoolIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['WorkerPoolIamBindingConditionArgs']]):
...
@pulumi.input_type
class _WorkerPoolIamBindingState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['WorkerPoolIamBindingConditionArgs']] = None,
...
@pulumi.type_token("gcp:cloudrunv2/workerPoolIamBinding:WorkerPoolIamBinding")
class WorkerPoolIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['WorkerPoolIamBindingConditionArgs', 'WorkerPoolIamBindingConditionArgsDict', 'outputs.WorkerPoolIamBindingCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `cloudrunv2.WorkerPoolIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the workerpool are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `cloudrunv2.WorkerPoolIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the workerpool are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def __init__(__self__,
        ...
        * {{name}}
        ...
        :param str resource_name: The name of the resource.
        :param WorkerPoolIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkerPoolIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkerPoolIamBindingArgs.__new__(WorkerPoolIamBindingArgs)
        ...
        super(WorkerPoolIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'WorkerPoolIamBinding':
        """
        ...
        __props__ = _WorkerPoolIamBindingState.__new__(_WorkerPoolIamBindingState)
        ...
        __props__.__dict__["project"] = project
        __props__.__dict__["role"] = role
        return WorkerPoolIamBinding(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.WorkerPoolIamBindingCondition']]:
        return pulumi.get(self, "condition")
