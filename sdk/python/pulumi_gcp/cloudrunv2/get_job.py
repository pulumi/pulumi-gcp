...
class GetJobResult:
    ...
    def execution_count(self) -> builtins.int:
...
def get_job(location: Optional[builtins.str] = None,
...
def get_job_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
