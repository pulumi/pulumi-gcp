...
def get_service_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location of the cloud run service Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:cloudrunv2/getServiceIamPolicy:getServiceIamPolicy', __args__, opts=opts, typ=GetServiceIamPolicyResult).value
...
def get_service_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
