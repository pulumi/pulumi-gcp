...
class GetServiceResult:
    ...
    def default_uri_disabled(self) -> builtins.bool:
    ...
    def invoker_iam_disabled(self) -> builtins.bool:
...
def get_service_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
