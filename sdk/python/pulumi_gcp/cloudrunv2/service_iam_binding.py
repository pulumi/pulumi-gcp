...
@pulumi.type_token("gcp:cloudrunv2/serviceIamBinding:ServiceIamBinding")
class ServiceIamBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ServiceIamBinding, __self__).__init__(
            'gcp:cloudrunv2/serviceIamBinding:ServiceIamBinding',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceIamBinding':
        """
