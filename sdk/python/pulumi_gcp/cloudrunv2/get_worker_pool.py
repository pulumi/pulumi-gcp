...
class GetWorkerPoolResult:
    ...
    def __init__(__self__, annotations=None, binary_authorizations=None, client=None, client_version=None, conditions=None, create_time=None, creator=None, custom_audiences=None, delete_time=None, deletion_protection=None, description=None, effective_annotations=None, effective_labels=None, etag=None, expire_time=None, generation=None, id=None, instance_split_statuses=None, instance_splits=None, labels=None, last_modifier=None, latest_created_revision=None, latest_ready_revision=None, launch_stage=None, location=None, name=None, observed_generation=None, project=None, pulumi_labels=None, reconciling=None, scalings=None, templates=None, terminal_conditions=None, uid=None, update_time=None):
        ...
        if instance_split_statuses and not isinstance(instance_split_statuses, list):
            raise TypeError("Expected argument 'instance_split_statuses' to be a list")
        pulumi.set(__self__, "instance_split_statuses", instance_split_statuses)
        if instance_splits and not isinstance(instance_splits, list):
            raise TypeError("Expected argument 'instance_splits' to be a list")
    ...
    def custom_audiences(self) -> Sequence[builtins.str]:
...
class AwaitableGetWorkerPoolResult(GetWorkerPoolResult):
    ...
    def __await__(self):
        ...
        return GetWorkerPoolResult(
            ...
            id=self.id,
            instance_split_statuses=self.instance_split_statuses,
            instance_splits=self.instance_splits,
            labels=self.labels,
...
def get_worker_pool(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The location of the instance. eg us-central1
    ...
    __ret__ = pulumi.runtime.invoke('gcp:cloudrunv2/getWorkerPool:getWorkerPool', __args__, opts=opts, typ=GetWorkerPoolResult).value
    ...
    return AwaitableGetWorkerPoolResult(
        ...
        instance_split_statuses=pulumi.get(__ret__, 'instance_split_statuses'),
        instance_splits=pulumi.get(__ret__, 'instance_splits'),
...
def get_worker_pool_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           name: Optional[pulumi.Input[builtins.str]] = None,
                           project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWorkerPoolResult]:
    """
    Get information about a Google Cloud Run v2 Worker Pool. For more information see
    the [official documentation](https://cloud.google.com/run/docs/)
    and [API](https://cloud.google.com/run/docs/apis).
    ...
    __ret__ = pulumi.runtime.invoke_output('gcp:cloudrunv2/getWorkerPool:getWorkerPool', __args__, opts=opts, typ=GetWorkerPoolResult)
    return __ret__.apply(lambda __response__: GetWorkerPoolResult(
        ...
        instance_split_statuses=pulumi.get(__response__, 'instance_split_statuses'),
        instance_splits=pulumi.get(__response__, 'instance_splits'),
