...
class JobIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['JobIamBindingConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The location of the cloud run job Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['JobIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['JobIamBindingConditionArgs']]):
...
class JobIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['JobIamBindingConditionArgs', 'JobIamBindingConditionArgsDict', 'outputs.JobIamBindingCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `cloudrunv2.JobIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the job are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `cloudrunv2.JobIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the job are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'JobIamBinding':
        """
