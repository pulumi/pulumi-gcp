...
class DocumentAiProcessorDefaultVersionArgs:
    def __init__(__self__, *,
                 processor: pulumi.Input[builtins.str],
                 version: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DocumentAiProcessorDefaultVersion resource.
        :param pulumi.Input[builtins.str] processor: The processor to set the version on.
               
               
               - - -
        :param pulumi.Input[builtins.str] version: The version to set. Using `stable` or `rc` will cause the API to return the latest version in that release channel.
    ...
    @property
    @pulumi.getter
    def processor(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @processor.setter
    def processor(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("gcp:essentialcontacts/documentAiProcessorDefaultVersion:DocumentAiProcessorDefaultVersion")
class DocumentAiProcessorDefaultVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            processor: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'DocumentAiProcessorDefaultVersion':
        """
    ...
    @property
    @pulumi.getter
    def processor(self) -> pulumi.Output[builtins.str]:
        """
        The processor to set the version on.
