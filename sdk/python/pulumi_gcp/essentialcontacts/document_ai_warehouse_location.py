...
class DocumentAiWarehouseLocationArgs:
    def __init__(__self__, *,
                 access_control_mode: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] location: The location in which the instance is to be provisioned. It takes the form projects/{projectNumber}/locations/{location}.
        :param pulumi.Input[_builtins.str] project_number: The unique identifier of the project.
        :param pulumi.Input[_builtins.str] document_creator_default_role: The default role for the person who create a document.
               Possible values are: `DOCUMENT_ADMIN`, `DOCUMENT_EDITOR`, `DOCUMENT_VIEWER`.
        :param pulumi.Input[_builtins.str] kms_key: The KMS key used for CMEK encryption. It is required that
    ...
    def access_control_mode(self, value: pulumi.Input[_builtins.str]):
