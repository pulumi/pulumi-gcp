...
class DocumentAiWarehouseDocumentSchemaArgs:
    def __init__(__self__, *,
                 ...
                 document_is_folder: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a DocumentAiWarehouseDocumentSchema resource.
        :param pulumi.Input[builtins.str] display_name: Name of the schema given by the user.
        ...
        :param pulumi.Input[builtins.bool] document_is_folder: Tells whether the document is a folder or a typical document.
        """
    ...
    def document_is_folder(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def document_is_folder(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DocumentAiWarehouseDocumentSchemaState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] document_is_folder: Tells whether the document is a folder or a typical document.
        :param pulumi.Input[builtins.str] location: The location of the resource.
        :param pulumi.Input[builtins.str] name: The resource name of the document schema.
        :param pulumi.Input[builtins.str] project_number: The unique identifier of the project.
        :param pulumi.Input[Sequence[pulumi.Input['DocumentAiWarehouseDocumentSchemaPropertyDefinitionArgs']]] property_definitions: Defines the metadata for a schema property.
               Structure is documented below.
        """
...
class DocumentAiWarehouseDocumentSchema(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="documentIsFolder")
    def document_is_folder(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Tells whether the document is a folder or a typical document.
        """
        return pulumi.get(self, "document_is_folder")
    ...
    @property
    @pulumi.getter(name="projectNumber")
    def project_number(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the project.
        """
        return pulumi.get(self, "project_number")
