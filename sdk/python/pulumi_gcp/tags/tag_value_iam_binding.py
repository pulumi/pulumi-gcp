...
class TagValueIamBindingArgs:
    def __init__(__self__, *,
        ...
        """
        TagValueIamBindingArgs._configure(
...
class _TagValueIamBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tag_value: Used to find the parent resource to bind the IAM policy to
               ...
               * **projectViewer:projectid**: Viewers of the given project. For example, "projectViewer:my-example-project"
        """
        _TagValueIamBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            etag=etag,
            members=members,
...
class TagValueIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            TagValueIamBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, TagValueIamBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                TagValueIamBindingConditionArgs._configure(_setter, **condition)
