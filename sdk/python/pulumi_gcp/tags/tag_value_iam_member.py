...
class TagValueIamMemberArgs:
    def __init__(__self__, *,
        ...
        """
        TagValueIamMemberArgs._configure(
...
class _TagValueIamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tag_value: Used to find the parent resource to bind the IAM policy to
               ...
               * **projectViewer:projectid**: Viewers of the given project. For example, "projectViewer:my-example-project"
        """
        _TagValueIamMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            etag=etag,
            member=member,
...
class TagValueIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            TagValueIamMemberArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, TagValueIamMemberConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                TagValueIamMemberConditionArgs._configure(_setter, **condition)
