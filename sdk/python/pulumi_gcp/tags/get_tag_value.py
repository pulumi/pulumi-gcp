...
def get_tag_value(parent: Optional[builtins.str] = None,
    ...
    :param builtins.str short_name: The tag value's short_name.
    """
    __args__ = dict()
    __args__['parent'] = parent
    __args__['shortName'] = short_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('gcp:tags/getTagValue:getTagValue', __args__, opts=opts, typ=GetTagValueResult).value
...
def get_tag_value_output(parent: Optional[pulumi.Input[builtins.str]] = None,
