...
def get_tag_key_iam_policy(tag_key: Optional[builtins.str] = None,
    ...
    :param builtins.str tag_key: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_tag_key_iam_policy_output(tag_key: Optional[pulumi.Input[builtins.str]] = None,
