...
class _TagValueState:
    def __init__(__self__, *,
                 ...
                 namespaced_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] create_time: Output only. Creation time.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] description: User-assigned description of the TagValue. Must not exceed 256 characters.
        :param pulumi.Input[builtins.str] name: The generated numeric id for the TagValue.
        :param pulumi.Input[builtins.str] namespaced_name: Output only. Namespaced name of the TagValue. Will be in the format {parentNamespace}/{tagKeyShortName}/{shortName}.
        :param pulumi.Input[builtins.str] parent: Input only. The resource name of the new TagValue's parent. Must be of the form tagKeys/{tag_key_id}.
        :param pulumi.Input[builtins.str] short_name: Input only. User-assigned short name for TagValue. The short name should be unique for TagValues within the same parent TagKey.
               The short name can have a maximum length of 256 characters. The permitted character set for the shortName includes all UTF-8 encoded Unicode characters except single quotes ('), double quotes ("), backslashes (\\\\), and forward slashes (/).
    ...
    def namespaced_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def namespaced_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TagValue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent: Optional[pulumi.Input[builtins.str]] = None,
            short_name: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'TagValue':
        """
    ...
    @property
    @pulumi.getter(name="namespacedName")
    def namespaced_name(self) -> pulumi.Output[builtins.str]:
        """
        Output only. Namespaced name of the TagValue. Will be in the format {parentNamespace}/{tagKeyShortName}/{shortName}.
        """
        return pulumi.get(self, "namespaced_name")
