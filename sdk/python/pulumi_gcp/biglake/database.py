...
class _DatabaseState:
    def __init__(__self__, *,
                 ...
                 hive_options: pulumi.Input[Optional['DatabaseHiveOptionsArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] delete_time: Output only. The deletion time of the database. Only set after the
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] expire_time: Output only. The time when this database is considered expired. Only set
        ...
        :param pulumi.Input[_builtins.str] name: The name of the database.
        :param pulumi.Input[_builtins.str] type: The database type.
        :param pulumi.Input[_builtins.str] update_time: Output only. The last modification time of the database. A timestamp in
    ...
    @_builtins.property
    @pulumi.getter(name="hiveOptions")
    def hive_options(self) -> pulumi.Input[Optional['DatabaseHiveOptionsArgs']]:
        """
        Options of a Hive database.
        Structure is documented below.
        """
    ...
    @hive_options.setter
    def hive_options(self, value: pulumi.Input[Optional['DatabaseHiveOptionsArgs']]):
        pulumi.set(self, "hive_options", value)
...
class Database(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 catalog: pulumi.Input[Optional[_builtins.str]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 hive_options: pulumi.Input[Optional[Union['DatabaseHiveOptionsArgs', 'DatabaseHiveOptionsArgsDict', 'outputs.DatabaseHiveOptions']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * `{{catalog}}/databases/{{name}}`
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[Union['DatabaseHiveOptionsArgs', 'DatabaseHiveOptionsArgsDict', 'outputs.DatabaseHiveOptions']] hive_options: Options of a Hive database.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] name: The name of the database.
        :param pulumi.Input[_builtins.str] type: The database type.
        """
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'Database':
        """
