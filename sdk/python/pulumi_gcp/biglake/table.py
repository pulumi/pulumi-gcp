...
class TableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database: The id of the parent database.
        :param pulumi.Input['TableHiveOptionsArgs'] hive_options: Options of a Hive table.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: Output only. The name of the Table. Format:
...
class _TableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Output only. The creation time of the table. A timestamp in RFC3339 UTC
               "Zulu" format, with nanosecond resolution and up to nine fractional
               digits. Examples: "2014-10-02T15:01:23Z" and
               "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] database: The id of the parent database.
        :param pulumi.Input[builtins.str] delete_time: Output only. The deletion time of the table. Only set after the
               table is deleted. A timestamp in RFC3339 UTC "Zulu" format, with
               nanosecond resolution and up to nine fractional digits. Examples:
               "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] etag: The checksum of a table object computed by the server based on the value
               ...
               table operations.
        :param pulumi.Input[builtins.str] expire_time: Output only. The time when this table is considered expired. Only set
        ...
        :param pulumi.Input[builtins.str] type: The database type.
               Possible values are: `HIVE`.
        :param pulumi.Input[builtins.str] update_time: Output only. The last modification time of the table. A timestamp in
...
class Table(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Table':
        """
