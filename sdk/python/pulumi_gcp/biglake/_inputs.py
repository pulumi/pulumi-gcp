...
class DatabaseHiveOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] location_uri: Cloud Storage folder URI where the database data is stored, starting with "gs://".
...
class TableHiveOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Stores user supplied Hive table parameters. An object containing a
               list of "key": value pairs.
               Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input['TableHiveOptionsStorageDescriptorArgs'] storage_descriptor: Stores physical storage information on the data.
               Structure is documented below.
        :param pulumi.Input[builtins.str] table_type: Hive table type. For example, MANAGED_TABLE, EXTERNAL_TABLE.
        """
        if parameters is not None:
            pulumi.set(__self__, "parameters", parameters)
...
class TableHiveOptionsStorageDescriptorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] input_format: The fully qualified Java class name of the input format.
        :param pulumi.Input[builtins.str] location_uri: Cloud Storage folder URI where the table data is stored, starting with "gs://".
        :param pulumi.Input[builtins.str] output_format: The fully qualified Java class name of the output format.
        """
