...
class InstanceArgs:
    def __init__(__self__, *,
                 memory_size_gb: pulumi.Input[builtins.int],
                 alternative_location_id: Optional[pulumi.Input[builtins.str]] = None,
                 auth_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 authorized_network: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 read_replicas_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alternative_location_id: Only applicable to STANDARD_HA tier which protects the instance
               ...
               [locationId].
        :param pulumi.Input[builtins.bool] auth_enabled: Optional. Indicates whether OSS Redis AUTH is enabled for the
               instance. If set to "true" AUTH is enabled on the instance.
               Default value is "false" meaning AUTH is disabled.
        :param pulumi.Input[builtins.str] authorized_network: The full name of the Google Compute Engine network to which the
               instance is connected. If left unspecified, the default network
               will be used.
        :param pulumi.Input[builtins.str] connect_mode: The connection mode of the Redis instance.
               Default value is `DIRECT_PEERING`.
               Possible values are: `DIRECT_PEERING`, `PRIVATE_SERVICE_ACCESS`.
        :param pulumi.Input[builtins.str] customer_managed_key: Optional. The KMS key reference that you want to use to encrypt the data at rest for this Redis
        ...
        :param pulumi.Input[builtins.str] location_id: The zone where the instance will be provisioned. If not provided,
        ...
        :param pulumi.Input[builtins.str] read_replicas_mode: Optional. Read replica mode. Can only be specified when trying to create the instance.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] redis_configs: Redis configuration parameters, according to http://redis.io/topics/config.
               Please check Memorystore documentation for the list of supported parameters:
               https://cloud.google.com/memorystore/docs/redis/reference/rest/v1/projects.locations.instances#Instance.FIELDS.redis_configs
        :param pulumi.Input[builtins.str] redis_version: The version of Redis software. If not provided, latest supported
               version will be used. Please check the API documentation linked
               at the top for the latest valid values.
        :param pulumi.Input[builtins.str] region: The name of the Redis region of the instance.
        :param pulumi.Input[builtins.int] replica_count: Optional. The number of replica nodes. The valid range for the Standard Tier with
               read replicas enabled is [1-5] and defaults to 2. If read replicas are not enabled
               for a Standard Tier instance, the only valid value is 1 and the default is 1.
               The valid value for basic tier is 0 and the default is also 0.
        :param pulumi.Input[builtins.str] reserved_ip_range: The CIDR range of internal addresses that are reserved for this
               instance. If not provided, the service will choose an unused /29
               block, for example, 10.0.0.0/29 or 192.168.0.0/29. Ranges must be
               unique and non-overlapping with existing subnets in an authorized
               network.
        :param pulumi.Input[builtins.str] secondary_ip_range: Optional. Additional IP range for node placement. Required when enabling read replicas on
        ...
        :param pulumi.Input[builtins.str] transit_encryption_mode: The TLS mode of the Redis instance, If not provided, TLS is disabled for the instance.
    ...
    def memory_size_gb(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "memory_size_gb", value)

    @property
    @pulumi.getter(name="alternativeLocationId")
    def alternative_location_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alternative_location_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alternative_location_id", value)

    @property
    @pulumi.getter(name="authEnabled")
    def auth_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @auth_enabled.setter
    def auth_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def authorized_network(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def read_replicas_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def read_replicas_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secondary_ip_range(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class _InstanceState:
    def __init__(__self__, *,
                 alternative_location_id: Optional[pulumi.Input[builtins.str]] = None,
                 auth_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 auth_string: Optional[pulumi.Input[builtins.str]] = None,
                 authorized_network: Optional[pulumi.Input[builtins.str]] = None,
                 connect_mode: Optional[pulumi.Input[builtins.str]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 current_location_id: Optional[pulumi.Input[builtins.str]] = None,
                 customer_managed_key: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 maintenance_version: Optional[pulumi.Input[builtins.str]] = None,
                 memory_size_gb: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 nodes: Optional[pulumi.Input[Sequence[pulumi.Input['InstanceNodeArgs']]]] = None,
                 persistence_config: Optional[pulumi.Input['InstancePersistenceConfigArgs']] = None,
                 persistence_iam_identity: Optional[pulumi.Input[builtins.str]] = None,
                 port: Optional[pulumi.Input[builtins.int]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 read_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 read_endpoint_port: Optional[pulumi.Input[builtins.int]] = None,
                 read_replicas_mode: Optional[pulumi.Input[builtins.str]] = None,
                 redis_configs: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 redis_version: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] auth_enabled: Optional. Indicates whether OSS Redis AUTH is enabled for the
               instance. If set to "true" AUTH is enabled on the instance.
               Default value is "false" meaning AUTH is disabled.
        :param pulumi.Input[builtins.str] auth_string: AUTH String set on the instance. This field will only be populated if auth_enabled is true.
        :param pulumi.Input[builtins.str] authorized_network: The full name of the Google Compute Engine network to which the
               instance is connected. If left unspecified, the default network
               will be used.
        :param pulumi.Input[builtins.str] connect_mode: The connection mode of the Redis instance.
        ...
        :param pulumi.Input[builtins.str] current_location_id: The current zone where the Redis endpoint is placed.
        ...
        :param pulumi.Input['InstancePersistenceConfigArgs'] persistence_config: Persistence configuration for an instance.
               Structure is documented below.
        :param pulumi.Input[builtins.str] persistence_iam_identity: Output only. Cloud IAM identity used by import / export operations
               to transfer data to/from Cloud Storage. Format is "serviceAccount:".
               The value may change over time for a given instance so should be
               checked before each import/export operation.
        :param pulumi.Input[builtins.int] port: The port number of the exposed Redis endpoint.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
               and default labels configured on the provider.
        :param pulumi.Input[builtins.str] read_endpoint: Output only. Hostname or IP address of the exposed readonly Redis endpoint. Standard tier only.
               Targets all healthy replica nodes in instance. Replication is asynchronous and replica nodes
               will exhibit some lag behind the primary. Write requests must target 'host'.
        :param pulumi.Input[builtins.int] read_endpoint_port: Output only. The port number of the exposed readonly redis endpoint. Standard tier only.
    ...
    def auth_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @auth_string.setter
    def auth_string(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def current_location_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_location_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @memory_size_gb.setter
    def memory_size_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "memory_size_gb", value)
    ...
    def persistence_iam_identity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def persistence_iam_identity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def read_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def read_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "read_endpoint", value)

    @property
    @pulumi.getter(name="readEndpointPort")
    def read_endpoint_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def read_endpoint_port(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Instance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="alternativeLocationId")
    def alternative_location_id(self) -> pulumi.Output[builtins.str]:
        """
        Only applicable to STANDARD_HA tier which protects the instance
        against zonal failures by provisioning it across two zones.
        If provided, it must be a different zone from the one provided in
    ...
    @property
    @pulumi.getter(name="authEnabled")
    def auth_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Optional. Indicates whether OSS Redis AUTH is enabled for the
        instance. If set to "true" AUTH is enabled on the instance.
        Default value is "false" meaning AUTH is disabled.
    ...
    @property
    @pulumi.getter(name="authString")
    def auth_string(self) -> pulumi.Output[builtins.str]:
        """
        AUTH String set on the instance. This field will only be populated if auth_enabled is true.
        """
        return pulumi.get(self, "auth_string")
    ...
    @property
    @pulumi.getter(name="connectMode")
    def connect_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The connection mode of the Redis instance.
        Default value is `DIRECT_PEERING`.
        Possible values are: `DIRECT_PEERING`, `PRIVATE_SERVICE_ACCESS`.
    ...
    @property
    @pulumi.getter(name="currentLocationId")
    def current_location_id(self) -> pulumi.Output[builtins.str]:
        """
        The current zone where the Redis endpoint is placed.
        For Basic Tier instances, this will always be the same as the
        [locationId] provided by the user at creation time. For Standard Tier
    ...
    @property
    @pulumi.getter(name="persistenceIamIdentity")
    def persistence_iam_identity(self) -> pulumi.Output[builtins.str]:
        """
        Output only. Cloud IAM identity used by import / export operations
        to transfer data to/from Cloud Storage. Format is "serviceAccount:".
        The value may change over time for a given instance so should be
    ...
    @property
    @pulumi.getter(name="readEndpoint")
    def read_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        Output only. Hostname or IP address of the exposed readonly Redis endpoint. Standard tier only.
        Targets all healthy replica nodes in instance. Replication is asynchronous and replica nodes
        will exhibit some lag behind the primary. Write requests must target 'host'.
    ...
    @property
    @pulumi.getter(name="readEndpointPort")
    def read_endpoint_port(self) -> pulumi.Output[builtins.int]:
        """
        Output only. The port number of the exposed readonly redis endpoint. Standard tier only.
        Write requests should target 'port'.
        """
    ...
    @property
    @pulumi.getter(name="readReplicasMode")
    def read_replicas_mode(self) -> pulumi.Output[builtins.str]:
        """
        Optional. Read replica mode. Can only be specified when trying to create the instance.
        If not set, Memorystore Redis backend will default to READ_REPLICAS_DISABLED.
        - READ_REPLICAS_DISABLED: If disabled, read endpoint will not be provided and the
    ...
    @property
    @pulumi.getter(name="redisVersion")
    def redis_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of Redis software. If not provided, latest supported
        version will be used. Please check the API documentation linked
        at the top for the latest valid values.
    ...
    @property
    @pulumi.getter(name="reservedIpRange")
    def reserved_ip_range(self) -> pulumi.Output[builtins.str]:
        """
        The CIDR range of internal addresses that are reserved for this
        instance. If not provided, the service will choose an unused /29
        block, for example, 10.0.0.0/29 or 192.168.0.0/29. Ranges must be
    ...
    @property
    @pulumi.getter(name="secondaryIpRange")
    def secondary_ip_range(self) -> pulumi.Output[builtins.str]:
        """
        Optional. Additional IP range for node placement. Required when enabling read replicas on
        an existing instance. For DIRECT_PEERING mode value must be a CIDR range of size /28, or
        "auto". For PRIVATE_SERVICE_ACCESS mode value must be the name of an allocated address
