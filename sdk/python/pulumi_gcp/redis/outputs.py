...
class ClusterCrossClusterReplicationConfig(dict):
    ...
    def __init__(__self__, *,
                 cluster_role: Optional[_builtins.str] = None,
        ...
        """
        :param _builtins.str cluster_role: The role of the cluster in cross cluster replication. Supported values are:
...
class ClusterCrossClusterReplicationConfigMembershipPrimaryCluster(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cluster: The full resource path of the primary cluster in the format: projects/{project}/locations/{region}/clusters/{cluster-id}
...
class ClusterCrossClusterReplicationConfigMembershipSecondaryCluster(dict):
    def __init__(__self__, *,
                 ...
                 uid: Optional[_builtins.str] = None):
        """
        :param _builtins.str cluster: (Output)
...
class ClusterDiscoveryEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: Output only. The IP allocated on the consumer network for the PSC forwarding rule.
        :param _builtins.int port: Output only. The port number of the exposed Redis endpoint.
...
class ClusterDiscoveryEndpointPscConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str network: The consumer network where the IP address resides, in the form of projects/{projectId}/global/networks/{network_id}.
        """
...
class ClusterGcsSource(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] uris: URIs of the GCS objects to import. Example: gs://bucket1/object1, gs://bucket2/folder2/object2
        """
...
class ClusterPersistenceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ClusterPersistenceConfigAofConfigArgs' aof_config: AOF configuration. This field will be ignored if mode is not AOF.
               Structure is documented below.
        :param _builtins.str mode: Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
...
class ClusterPersistenceConfigAofConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str append_fsync: Optional. Available fsync modes.
...
class ClusterPersistenceConfigRdbConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str rdb_snapshot_period: Optional. Available snapshot periods for scheduling.
        ...
        :param _builtins.str rdb_snapshot_start_time: The time that the first snapshot was/will be attempted, and to which
...
class ClusterPscConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str network: Required. The consumer network where the network address of
...
class ClusterPscConnection(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: Output only. The IP allocated on the consumer network for the PSC forwarding rule.
        :param _builtins.str forwarding_rule: Output only. The URI of the consumer side forwarding rule. Example: projects/{projectNumOrId}/regions/us-east1/forwardingRules/{resourceId}.
        :param _builtins.str network: The consumer network where the IP address resides, in the form of projects/{projectId}/global/networks/{network_id}.
        :param _builtins.str project_id: Output only. The consumer projectId where the forwarding rule is created from.
        :param _builtins.str psc_connection_id: Output only. The PSC connection id of the forwarding rule connected to the service attachment.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class ClusterStateInfoUpdateInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int target_replica_count: Target number of replica nodes per shard.
        :param _builtins.int target_shard_count: Target number of shards for redis cluster.
        """
...
class ClusterUserCreatedConnectionsClusterEndpointConnectionPscConnection(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: The IP allocated on the consumer network for the PSC forwarding rule.
...
class ClusterZoneDistributionConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str mode: Immutable. The mode for zone distribution for Memorystore Redis cluster.
               If not provided, MULTI_ZONE will be used as default
               Possible values are: `MULTI_ZONE`, `SINGLE_ZONE`.
        :param _builtins.str zone: Immutable. The zone for single zone Memorystore Redis cluster.
        """
        if mode is not None:
            pulumi.set(__self__, "mode", mode)
        if zone is not None:
...
class InstancePersistenceConfig(dict):
    ...
    def __init__(__self__, *,
                 persistence_mode: Optional[_builtins.str] = None,
                 rdb_next_snapshot_time: Optional[_builtins.str] = None,
                 rdb_snapshot_period: Optional[_builtins.str] = None,
                 rdb_snapshot_start_time: Optional[_builtins.str] = None):
        """
        :param _builtins.str persistence_mode: Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
               - DISABLED: 	Persistence is disabled for the instance, and any existing snapshots are deleted.
               - RDB: RDB based Persistence is enabled.
               Possible values are: `DISABLED`, `RDB`.
        :param _builtins.str rdb_next_snapshot_time: (Output)
        ...
        :param _builtins.str rdb_snapshot_start_time: Optional. Date and time that the first snapshot was/will be attempted,
...
class InstanceServerCaCert(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str sha1_fingerprint: (Output)
...
class GetClusterCrossClusterReplicationConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str update_time: The last time cross cluster replication config was updated.
        """
        pulumi.set(__self__, "cluster_role", cluster_role)
        pulumi.set(__self__, "memberships", memberships)
        pulumi.set(__self__, "primary_clusters", primary_clusters)
...
class GetClusterCrossClusterReplicationConfigMembershipPrimaryClusterResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cluster: The full resource path of the primary cluster in the format: projects/{project}/locations/{region}/clusters/{cluster-id}
        :param _builtins.str uid: The unique id of the primary cluster.
        """
        pulumi.set(__self__, "cluster", cluster)
        pulumi.set(__self__, "uid", uid)
...
class GetClusterCrossClusterReplicationConfigMembershipSecondaryClusterResult(dict):
    def __init__(__self__, *,
                 ...
                 uid: _builtins.str):
        """
        :param _builtins.str cluster: The full resource path of the secondary cluster in the format: projects/{project}/locations/{region}/clusters/{cluster-id}
        :param _builtins.str uid: The unique id of the secondary cluster.
        """
        pulumi.set(__self__, "cluster", cluster)
        pulumi.set(__self__, "uid", uid)
...
class GetClusterDiscoveryEndpointResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: Output only. Network address of the exposed Redis endpoint used by clients to connect to the service.
        :param _builtins.int port: Output only. The port number of the exposed Redis endpoint.
...
class GetClusterDiscoveryEndpointPscConfigResult(dict):
    def __init__(__self__, *,
                 network: _builtins.str):
        """
        :param _builtins.str network: The consumer network where the network address of the discovery
...
class GetClusterMaintenancePolicyResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str create_time: Output only. The time when the policy was created.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits.
        :param _builtins.str update_time: Output only. The time when the policy was last updated.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits.
...
class GetClusterMaintenancePolicyWeeklyMaintenanceWindowResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str duration: Output only. Duration of the maintenance window.
               The current window is fixed at 1 hour.
               A duration in seconds with up to nine fractional digits,
               terminated by 's'. Example: "3.5s".
...
class GetClusterMaintenanceScheduleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str end_time: Output only. The end time of any upcoming scheduled maintenance for this cluster.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits.
        :param _builtins.str schedule_deadline_time: Output only. The deadline that the maintenance schedule start time
               ...
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits.
        :param _builtins.str start_time: Output only. The start time of any upcoming scheduled maintenance for this cluster.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond
               resolution and up to nine fractional digits.
        """
        pulumi.set(__self__, "end_time", end_time)
...
class GetClusterPscServiceAttachmentResult(dict):
    def __init__(__self__, *,
                 ...
                 service_attachment: _builtins.str):
        """
        :param _builtins.str connection_type: Type of a PSC connection targeting this service attachment.
        :param _builtins.str service_attachment: Service attachment URI which your self-created PscConnection should use as
        """
        pulumi.set(__self__, "connection_type", connection_type)
        pulumi.set(__self__, "service_attachment", service_attachment)
...
class GetInstanceNodeResult(dict):
    def __init__(__self__, *,
                 ...
                 zone: _builtins.str):
        """
        :param _builtins.str id: Node identifying string. e.g. 'node-0', 'node-1'
        :param _builtins.str zone: Location of the node.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "zone", zone)
...
class GetInstancePersistenceConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str rdb_next_snapshot_time: Output only. The next time that a snapshot attempt is scheduled to occur.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up
               to nine fractional digits.
               Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param _builtins.str rdb_snapshot_period: Optional. Available snapshot periods for scheduling.
...
class GetInstanceServerCaCertResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cert: The certificate data in PEM format.
        :param _builtins.str create_time: The time when the certificate was created.
        :param _builtins.str expire_time: The time when the certificate expires.
        :param _builtins.str serial_number: Serial number, as extracted from the certificate.
        :param _builtins.str sha1_fingerprint: Sha1 Fingerprint of the certificate.
        """
        pulumi.set(__self__, "cert", cert)
        pulumi.set(__self__, "create_time", create_time)
        pulumi.set(__self__, "expire_time", expire_time)
