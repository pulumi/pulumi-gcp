...
class ClusterUserCreatedConnections(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cluster_endpoints: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ClusterUserCreatedConnectionsClusterEndpointArgs', 'ClusterUserCreatedConnectionsClusterEndpointArgsDict', 'outputs.ClusterUserCreatedConnectionsClusterEndpoint']]]]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{name}}`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterUserCreatedConnectionsClusterEndpointArgs', 'ClusterUserCreatedConnectionsClusterEndpointArgsDict', 'outputs.ClusterUserCreatedConnectionsClusterEndpoint']]]] cluster_endpoints: A list of cluster endpoints
               Structure is documented below.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
