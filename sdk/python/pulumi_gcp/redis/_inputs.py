...
if not MYPY:
    class ClusterCrossClusterReplicationConfigArgsDict(TypedDict):
        cluster_role: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterCrossClusterReplicationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cluster_role: The role of the cluster in cross cluster replication. Supported values are:
               1. `CLUSTER_ROLE_UNSPECIFIED`: This is an independent cluster that has never participated in cross cluster replication. It allows both reads and writes.
               1. `NONE`: This is an independent cluster that previously participated in cross cluster replication(either as a `PRIMARY` or `SECONDARY` cluster). It allows both reads and writes.
               1. `PRIMARY`: This cluster serves as the replication source for secondary clusters that are replicating from it. Any data written to it is automatically replicated to its secondary clusters. It allows both reads and writes.
               1. `SECONDARY`: This cluster replicates data from the primary cluster. It allows only reads.
...
class ClusterCrossClusterReplicationConfigMembershipPrimaryClusterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cluster: The full resource path of the primary cluster in the format: projects/{project}/locations/{region}/clusters/{cluster-id}
...
class ClusterCrossClusterReplicationConfigMembershipSecondaryClusterArgs:
    def __init__(__self__, *,
                 ...
                 uid: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cluster: (Output)
               The full resource path of the secondary cluster in the format: projects/{project}/locations/{region}/clusters/{cluster-id}
        :param pulumi.Input[builtins.str] uid: (Output)
               The unique id of the secondary cluster.
        """
...
class ClusterDiscoveryEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] address: Output only. The IP allocated on the consumer network for the PSC forwarding rule.
        :param pulumi.Input[builtins.int] port: Output only. The port number of the exposed Redis endpoint.
...
class ClusterDiscoveryEndpointPscConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] network: The consumer network where the IP address resides, in the form of projects/{projectId}/global/networks/{network_id}.
        """
...
class ClusterPersistenceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterPersistenceConfigAofConfigArgs'] aof_config: AOF configuration. This field will be ignored if mode is not AOF.
               Structure is documented below.
        :param pulumi.Input[builtins.str] mode: Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
               - DISABLED: 	Persistence (both backup and restore) is disabled for the cluster.
               - RDB: RDB based Persistence is enabled.
               - AOF: AOF based Persistence is enabled.
               Possible values are: `PERSISTENCE_MODE_UNSPECIFIED`, `DISABLED`, `RDB`, `AOF`.
...
class ClusterPersistenceConfigAofConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] append_fsync: Optional. Available fsync modes.
               - NO - Do not explicitly call fsync(). Rely on OS defaults.
               - EVERYSEC - Call fsync() once per second in a background thread. A balance between performance and durability.
               - ALWAYS - Call fsync() for earch write command.
               Possible values are: `APPEND_FSYNC_UNSPECIFIED`, `NO`, `EVERYSEC`, `ALWAYS`.
...
class ClusterPersistenceConfigRdbConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] rdb_snapshot_period: Optional. Available snapshot periods for scheduling.
               - ONE_HOUR:	Snapshot every 1 hour.
               - SIX_HOURS:	Snapshot every 6 hours.
               - TWELVE_HOURS:	Snapshot every 12 hours.
               - TWENTY_FOUR_HOURS:	Snapshot every 24 hours.
               Possible values are: `SNAPSHOT_PERIOD_UNSPECIFIED`, `ONE_HOUR`, `SIX_HOURS`, `TWELVE_HOURS`, `TWENTY_FOUR_HOURS`.
        :param pulumi.Input[builtins.str] rdb_snapshot_start_time: The time that the first snapshot was/will be attempted, and to which
               future snapshots will be aligned.
               If not provided, the current time will be used.
        """
...
class ClusterPscConfigArgs:
    def __init__(__self__, *,
                 network: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] network: Required. The consumer network where the network address of
               the discovery endpoint will be reserved, in the form of
               projects/{network_project_id_or_number}/global/networks/{network_id}.
        """
        pulumi.set(__self__, "network", network)
...
class ClusterPscConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] address: Output only. The IP allocated on the consumer network for the PSC forwarding rule.
        :param pulumi.Input[builtins.str] forwarding_rule: Output only. The URI of the consumer side forwarding rule. Example: projects/{projectNumOrId}/regions/us-east1/forwardingRules/{resourceId}.
        :param pulumi.Input[builtins.str] network: The consumer network where the IP address resides, in the form of projects/{projectId}/global/networks/{network_id}.
        :param pulumi.Input[builtins.str] project_id: Output only. The consumer projectId where the forwarding rule is created from.
        :param pulumi.Input[builtins.str] psc_connection_id: Output only. The PSC connection id of the forwarding rule connected to the service attachment.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class ClusterStateInfoUpdateInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] target_replica_count: Target number of replica nodes per shard.
        :param pulumi.Input[builtins.int] target_shard_count: Target number of shards for redis cluster.
        """
...
class ClusterUserCreatedConnectionsClusterEndpointConnectionPscConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] address: The IP allocated on the consumer network for the PSC forwarding rule.
...
class ClusterZoneDistributionConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] mode: Immutable. The mode for zone distribution for Memorystore Redis cluster.
               If not provided, MULTI_ZONE will be used as default
               Possible values are: `MULTI_ZONE`, `SINGLE_ZONE`.
        :param pulumi.Input[builtins.str] zone: Immutable. The zone for single zone Memorystore Redis cluster.
        """
        if mode is not None:
            pulumi.set(__self__, "mode", mode)
        if zone is not None:
...
if not MYPY:
    class InstancePersistenceConfigArgsDict(TypedDict):
        persistence_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
        ...
        """
        rdb_next_snapshot_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class InstancePersistenceConfigArgs:
    def __init__(__self__, *,
                 ...
                 rdb_next_snapshot_time: Optional[pulumi.Input[builtins.str]] = None,
                 rdb_snapshot_period: Optional[pulumi.Input[builtins.str]] = None,
                 rdb_snapshot_start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] persistence_mode: Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
               - DISABLED: 	Persistence is disabled for the instance, and any existing snapshots are deleted.
               - RDB: RDB based Persistence is enabled.
               Possible values are: `DISABLED`, `RDB`.
        :param pulumi.Input[builtins.str] rdb_next_snapshot_time: (Output)
               Output only. The next time that a snapshot attempt is scheduled to occur.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up
               to nine fractional digits.
               Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] rdb_snapshot_period: Optional. Available snapshot periods for scheduling.
               ...
               - TWENTY_FOUR_HOURS:	Snapshot every 24 hours.
               Possible values are: `ONE_HOUR`, `SIX_HOURS`, `TWELVE_HOURS`, `TWENTY_FOUR_HOURS`.
        :param pulumi.Input[builtins.str] rdb_snapshot_start_time: Optional. Date and time that the first snapshot was/will be attempted,
               and to which future snapshots will be aligned. If not provided,
               the current time will be used.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution
               and up to nine fractional digits.
    ...
    def rdb_next_snapshot_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Output only. The next time that a snapshot attempt is scheduled to occur.
        A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up
    ...
    def rdb_next_snapshot_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceServerCaCertArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cert: (Output)
               The certificate data in PEM format.
        :param pulumi.Input[builtins.str] create_time: (Output)
               The time when the certificate was created.
        ...
        :param pulumi.Input[builtins.str] serial_number: (Output)
               Serial number, as extracted from the certificate.
        :param pulumi.Input[builtins.str] sha1_fingerprint: (Output)
               Sha1 Fingerprint of the certificate.
        """
        if cert is not None:
