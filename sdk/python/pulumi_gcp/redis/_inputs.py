...
class ClusterAclPolicyRuleArgsDict(TypedDict):
...
@pulumi.input_type
class ClusterAclPolicyRuleArgs:
    def __init__(__self__, *,
                 rule: pulumi.Input[_builtins.str],
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] rule: The rule to be applied to the username. Ex: "on >password123 ~* +@all"
               The format of the rule is defined by Redis OSS:
               https://redis.io/docs/latest/operate/oss_and_stack/management/security/acl/
        :param pulumi.Input[_builtins.str] username: Specifies the IAM user or service account to be added to the ACL policy.
               This username will be directly set on the Redis OSS.
        """
...
class ClusterAutomatedBackupConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterAutomatedBackupConfigFixedFrequencyScheduleArgs'] fixed_frequency_schedule: Trigger automated backups at a fixed frequency.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] retention: How long to keep automated backups before the backups are deleted.
               The value should be between 1 day and 365 days. If not specified, the default value is 35 days.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        """
...
class ClusterGcsSourceArgs:
    def __init__(__self__, *,
                 uris: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] uris: URIs of the GCS objects to import. Example: gs://bucket1/object1, gs://bucket2/folder2/object2
        """
...
class ClusterManagedBackupSourceArgs:
    def __init__(__self__, *,
                 backup: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] backup: Example: `projects/{project}/locations/{location}/backupCollections/{collection}/backups/{backup}`.
        """
...
class ClusterPersistenceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterPersistenceConfigAofConfigArgs'] aof_config: AOF configuration. This field will be ignored if mode is not AOF.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] mode: Optional. Controls whether Persistence features are enabled. If not provided, the existing value will be used.
               - DISABLED: 	Persistence (both backup and restore) is disabled for the cluster.
               - RDB: RDB based Persistence is enabled.
               - AOF: AOF based Persistence is enabled.
                 Possible values are: `PERSISTENCE_MODE_UNSPECIFIED`, `DISABLED`, `RDB`, `AOF`.
...
class ClusterPscConfigArgs:
    def __init__(__self__, *,
                 network: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] network: Required. The consumer network where the network address of
               the discovery endpoint will be reserved, in the form of
               projects/{network_project_id_or_number}/global/networks/{network_id}.
        """
        pulumi.set(__self__, "network", network)
...
class ClusterPscConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] network: The consumer network where the IP address resides, in the form of projects/{projectId}/global/networks/{network_id}.
        :param pulumi.Input[_builtins.str] project_id: Output only. The consumer projectId where the forwarding rule is created from.
        :param pulumi.Input[_builtins.str] psc_connection_id: Output only. The PSC connection id of the forwarding rule connected to the service attachment.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class ClusterUserCreatedConnectionsClusterEndpointConnectionPscConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] forwarding_rule: The URI of the consumer side forwarding rule.
               Format:
               projects/{project}/regions/{region}/forwardingRules/{forwarding_rule}
        :param pulumi.Input[_builtins.str] network: The consumer network where the IP address resides, in the form of
               projects/{project_id}/global/networks/{network_id}.
        :param pulumi.Input[_builtins.str] psc_connection_id: The PSC connection id of the forwarding rule connected to the
               service attachment.
        :param pulumi.Input[_builtins.str] service_attachment: The service attachment which is the target of the PSC connection, in the form of projects/{project-id}/regions/{region}/serviceAttachments/{service-attachment-id}.
        :param pulumi.Input[_builtins.str] connection_type: (Output)
               Output Only. Type of a PSC Connection.
               Possible values:
               CONNECTION_TYPE_DISCOVERY
               CONNECTION_TYPE_PRIMARY
               CONNECTION_TYPE_READER
        :param pulumi.Input[_builtins.str] project_id: The consumer project_id where the forwarding rule is created from.
        :param pulumi.Input[_builtins.str] psc_connection_status: (Output)
               Output Only. The status of the PSC connection: whether a connection exists and ACTIVE or it no longer exists.
               Possible values:
               ACTIVE
               NOT_FOUND
...
class ClusterZoneDistributionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] mode: Immutable. The mode for zone distribution for Memorystore Redis cluster.
               If not provided, MULTI_ZONE will be used as default
               Possible values are: `MULTI_ZONE`, `SINGLE_ZONE`.
        :param pulumi.Input[_builtins.str] zone: Immutable. The zone for single zone Memorystore Redis cluster.
        """
        if mode is not None:
            pulumi.set(__self__, "mode", mode)
        if zone is not None:
...
class InstanceServerCaCertArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] serial_number: (Output)
               Serial number, as extracted from the certificate.
        :param pulumi.Input[_builtins.str] sha1_fingerprint: (Output)
               Sha1 Fingerprint of the certificate.
        """
        if cert is not None:
