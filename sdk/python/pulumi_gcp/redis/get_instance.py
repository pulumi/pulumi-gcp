...
class GetInstanceResult:
    ...
    def auth_enabled(self) -> builtins.bool:
    ...
    def read_endpoint_port(self) -> builtins.int:
    ...
    def redis_configs(self) -> Mapping[str, builtins.str]:
...
def get_instance(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of a Redis instance.
