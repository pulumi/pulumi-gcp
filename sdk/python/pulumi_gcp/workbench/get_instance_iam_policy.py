...
def get_instance_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: Part of `parent`. See documentation of `projectsId`. Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_instance_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
