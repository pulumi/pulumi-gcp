...
def get_instance_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: Part of `parent`. See documentation of `projectsId`. Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:workbench/getInstanceIamPolicy:getInstanceIamPolicy', __args__, opts=opts, typ=GetInstanceIamPolicyResult).value
...
def get_instance_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
