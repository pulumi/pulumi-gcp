...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 disable_proxy_access: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_third_party_identity: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_id: Required. User-defined unique ID of this instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_owners: 'Optional. Input only. The owner of this instance after creation. Format:
               `alias@example.com` Currently supports one owner only. If not specified, all of
               the service account users of your VM instance''s service account can use the instance.
               If specified, sets the access mode to `Single user`. For more details, see
               https://cloud.google.com/vertex-ai/docs/workbench/instances/manage-access-jupyterlab'
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Optional. Labels to apply to this instance. These can be later modified
    ...
    def disable_proxy_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_proxy_access(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_proxy_access", value)

    @property
    @pulumi.getter(name="enableThirdPartyIdentity")
    def enable_third_party_identity(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_third_party_identity(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] creator: Output only. Email address of entity that sent original CreateInstance request.
        :param pulumi.Input[builtins.str] desired_state: Desired state of the Workbench Instance. Set this field to `ACTIVE` to start the Instance, and `STOPPED` to stop the Instance.
        :param pulumi.Input[builtins.bool] disable_proxy_access: Optional. If true, the workbench instance will not register with the proxy.
        ...
        :param pulumi.Input[builtins.str] health_state: Output only. Instance health_state.
        :param pulumi.Input[builtins.str] instance_id: Required. User-defined unique ID of this instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_owners: 'Optional. Input only. The owner of this instance after creation. Format:
               `alias@example.com` Currently supports one owner only. If not specified, all of
               the service account users of your VM instance''s service account can use the instance.
        ...
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] proxy_uri: Output only. The proxy endpoint that is used to access the Jupyter notebook.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] pulumi_labels: The combination of labels configured directly on the resource
               and default labels configured on the provider.
        :param pulumi.Input[builtins.str] state: (Output)
               Output only. The state of this instance upgrade history entry.
        :param pulumi.Input[builtins.str] update_time: An RFC3339 timestamp in UTC time. This in the format of yyyy-MM-ddTHH:mm:ss.SSSZ.
               The milliseconds portion (".SSS") is optional.
...
class Instance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="disableProxyAccess")
    def disable_proxy_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Optional. If true, the workbench instance will not register with the proxy.
        """
        return pulumi.get(self, "disable_proxy_access")
    ...
    @property
    @pulumi.getter(name="enableThirdPartyIdentity")
    def enable_third_party_identity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that specifies that a notebook can be accessed with third party
        identity provider.
        """
