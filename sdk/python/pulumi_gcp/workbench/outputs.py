...
class InstanceGceSetup(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'InstanceGceSetupDataDisksArgs' data_disks: Data disks attached to the VM instance. Currently supports only one data disk.
               Structure is documented below.
        :param builtins.bool disable_public_ip: Optional. If true, no external IP will be assigned to this VM instance.
        :param builtins.bool enable_ip_forwarding: Optional. Flag to enable ip forwarding or not, default false/off.
               https://cloud.google.com/vpc/docs/using-routes#canipforward
        :param builtins.str machine_type: Optional. The machine type of the VM instance. https://cloud.google.com/compute/docs/machine-resource
        :param Mapping[str, builtins.str] metadata: Optional. Custom metadata to apply to this instance.
        ...
        :param 'InstanceGceSetupShieldedInstanceConfigArgs' shielded_instance_config: A set of Shielded Instance options. See [Images using supported Shielded
               ...
               Structure is documented below.
        :param Sequence[builtins.str] tags: Optional. The Compute Engine tags to add to instance (see [Tagging
    ...
    def disable_public_ip(self) -> Optional[builtins.bool]:
        """
...
class InstanceGceSetupAcceleratorConfig(dict):
    ...
    def __init__(__self__, *,
                 core_count: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str core_count: Optional. Count of cores of this accelerator.
        :param builtins.str type: Optional. Type of this accelerator.
    ...
    def core_count(self) -> Optional[builtins.str]:
        """
...
class InstanceGceSetupBootDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str disk_encryption: Optional. Input only. Disk encryption method used on the boot and
               data disks, defaults to GMEK.
               Possible values are: `GMEK`, `CMEK`.
        :param builtins.str disk_size_gb: Optional. The size of the boot disk in GB attached to this instance,
               up to a maximum of 64000 GB (64 TB). If not specified, this defaults to the
               recommended value of 150GB.
        :param builtins.str disk_type: Optional. Indicates the type of the disk.
               Possible values are: `PD_STANDARD`, `PD_SSD`, `PD_BALANCED`, `PD_EXTREME`.
        :param builtins.str kms_key: 'Optional. The KMS key used to encrypt the disks, only
...
class InstanceGceSetupDataDisks(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key: Optional[builtins.str] = None):
        """
        :param builtins.str disk_encryption: Optional. Input only. Disk encryption method used on the boot
               and data disks, defaults to GMEK.
               Possible values are: `GMEK`, `CMEK`.
        :param builtins.str disk_size_gb: Optional. The size of the disk in GB attached to this VM instance,
               up to a maximum of 64000 GB (64 TB). If not specified, this defaults to
               100.
        :param builtins.str disk_type: Optional. Input only. Indicates the type of the disk.
               Possible values are: `PD_STANDARD`, `PD_SSD`, `PD_BALANCED`, `PD_EXTREME`.
        :param builtins.str kms_key: 'Optional. The KMS key used to encrypt the disks,
...
class InstanceGceSetupNetworkInterface(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['InstanceGceSetupNetworkInterfaceAccessConfigArgs'] access_configs: Optional. An array of configurations for this interface. Currently, only one access
               ...
               external IP address.
               Structure is documented below.
        :param builtins.str network: Optional. The name of the VPC that this VM instance is in.
        :param builtins.str nic_type: Optional. The type of vNIC to be used on this interface. This
               may be gVNIC or VirtioNet.
               Possible values are: `VIRTIO_NET`, `GVNIC`.
        :param builtins.str subnet: Optional. The name of the subnet that this VM instance is in.
        """
...
class InstanceGceSetupNetworkInterfaceAccessConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str external_ip: An external IP address associated with this instance. Specify an unused
...
class InstanceGceSetupServiceAccount(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email: Optional. Email address of the service account.
        :param Sequence[builtins.str] scopes: (Output)
...
class InstanceGceSetupShieldedInstanceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_integrity_monitoring: Optional. Defines whether the VM instance has integrity monitoring
               enabled. Enables monitoring and attestation of the boot integrity of the VM
               instance. The attestation is performed against the integrity policy baseline.
               This baseline is initially derived from the implicitly trusted boot image
               when the VM instance is created. Enabled by default.
        :param builtins.bool enable_secure_boot: Optional. Defines whether the VM instance has Secure Boot enabled.
               Secure Boot helps ensure that the system only runs authentic software by verifying
               the digital signature of all boot components, and halting the boot process
               if signature verification fails. Disabled by default.
        :param builtins.bool enable_vtpm: Optional. Defines whether the VM instance has the vTPM enabled.
               Enabled by default.
        """
...
class InstanceGceSetupVmImage(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str family: Optional. Use this VM image family to find the image; the newest
               image in this family will be used.
        :param builtins.str name: Optional. Use VM image name to find the image.
...
class InstanceUpgradeHistory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vm_image: Optional[builtins.str] = None):
        """
        :param builtins.str action: Optional. Action. Rolloback or Upgrade.
        :param builtins.str container_image: Optional. The container image before this instance upgrade.
        :param builtins.str create_time: An RFC3339 timestamp in UTC time. This in the format of yyyy-MM-ddTHH:mm:ss.SSSZ.
               The milliseconds portion (".SSS") is optional.
        :param builtins.str framework: Optional. The framework of this workbench instance.
        :param builtins.str snapshot: Optional. The snapshot of the boot disk of this workbench instance before upgrade.
        :param builtins.str state: (Output)
               Output only. The state of this instance upgrade history entry.
        :param builtins.str target_version: Optional. Target VM Version, like m63.
        :param builtins.str version: Optional. The version of the workbench instance before this upgrade.
        :param builtins.str vm_image: Optional. The VM image before this instance upgrade.
        """
    ...
    @property
    @pulumi.getter(name="vmImage")
    def vm_image(self) -> Optional[builtins.str]:
        """
