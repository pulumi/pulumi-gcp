...
class PeeringArgs:
    def __init__(__self__, *,
                 authorized_network: pulumi.Input[builtins.str],
                 domain_resource: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] status_message: Additional information about the current status of this peering, if available.
        """
    ...
    def authorized_network(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authorized_network(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "authorized_network", value)

    @property
    @pulumi.getter(name="domainResource")
    def domain_resource(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def domain_resource(self, value: pulumi.Input[builtins.str]):
...
class _PeeringState:
    def __init__(__self__, *,
                 ...
                 domain_resource: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="domainResource")
    def domain_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Full domain resource path for the Managed AD Domain involved in peering. The resource path should be in the form projects/{projectId}/locations/global/domains/{domainName}
        """
        return pulumi.get(self, "domain_resource")
    ...
    @domain_resource.setter
    def domain_resource(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_resource", value)
...
class Peering(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            status_message: Optional[pulumi.Input[builtins.str]] = None) -> 'Peering':
        """
    ...
    @property
    @pulumi.getter(name="domainResource")
    def domain_resource(self) -> pulumi.Output[builtins.str]:
        """
        Full domain resource path for the Managed AD Domain involved in peering. The resource path should be in the form projects/{projectId}/locations/global/domains/{domainName}
        """
        return pulumi.get(self, "domain_resource")
    ...
    @property
    @pulumi.getter(name="statusMessage")
    def status_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Additional information about the current status of this peering, if available.
        """
        return pulumi.get(self, "status_message")
