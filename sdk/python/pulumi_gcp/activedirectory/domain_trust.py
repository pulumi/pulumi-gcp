...
class DomainTrustArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_domain_name: The fully qualified target domain name which will be in trust with the current domain.
        :param pulumi.Input[_builtins.str] trust_direction: The trust direction, which decides if the current domain is trusted, trusting, or both.
               Possible values are: `INBOUND`, `OUTBOUND`, `BIDIRECTIONAL`.
        :param pulumi.Input[_builtins.str] trust_handshake_secret: The trust secret used for the handshake with the target domain. This will not be stored.
    ...
    def target_dns_ip_addresses(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def target_dns_ip_addresses(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
