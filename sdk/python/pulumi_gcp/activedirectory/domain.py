...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 admin: Optional[pulumi.Input[_builtins.str]] = None,
                 authorized_networks: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] reserved_ip_range: The CIDR range of internal addresses that are reserved for this domain. Reserved networks must be /24 or larger.
    ...
    def reserved_ip_range(self, value: pulumi.Input[_builtins.str]):
    ...
    def authorized_networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class _DomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fqdn: The fully-qualified domain name of the exposed domain used by clients to connect to the service.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] locations: Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/]
               e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block.
        :param pulumi.Input[_builtins.str] name: The unique name of the domain using the format: `projects/{project}/locations/global/domains/{domainName}`.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
...
class Domain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            reserved_ip_range: Optional[pulumi.Input[_builtins.str]] = None) -> 'Domain':
        """
