...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 reserved_ip_range: pulumi.Input[builtins.str],
                 admin: Optional[pulumi.Input[builtins.str]] = None,
                 authorized_networks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 deletion_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Domain resource.
        :param pulumi.Input[builtins.str] domain_name: The fully qualified domain name. e.g. mydomain.myorganization.com, with the restrictions
               of https://cloud.google.com/managed-microsoft-ad/reference/rest/v1/projects.locations.global.domains.
               
               
               - - -
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/]
               e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block.
        :param pulumi.Input[builtins.str] reserved_ip_range: The CIDR range of internal addresses that are reserved for this domain. Reserved networks must be /24 or larger.
               Ranges must be unique and non-overlapping with existing subnets in authorizedNetworks
        :param pulumi.Input[builtins.str] admin: The name of delegated administrator account used to perform Active Directory operations.
               If not specified, setupadmin will be used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] authorized_networks: The full names of the Google Compute Engine networks the domain instance is connected to. The domain is only available on networks listed in authorizedNetworks.
    ...
    def reserved_ip_range(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def reserved_ip_range(self, value: pulumi.Input[builtins.str]):
    ...
    def authorized_networks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def authorized_networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _DomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: The fully-qualified domain name of the exposed domain used by clients to connect to the service.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: Locations where domain needs to be provisioned. [regions][compute/docs/regions-zones/]
               e.g. us-west1 or us-east4 Service supports up to 4 locations at once. Each location will use a /26 block.
        :param pulumi.Input[builtins.str] name: The unique name of the domain using the format: `projects/{project}/locations/global/domains/{domainName}`.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
...
class Domain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            reserved_ip_range: Optional[pulumi.Input[builtins.str]] = None) -> 'Domain':
        """
    ...
    @property
    @pulumi.getter
    def admin(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of delegated administrator account used to perform Active Directory operations.
        If not specified, setupadmin will be used.
        """
    ...
    @property
    @pulumi.getter(name="authorizedNetworks")
    def authorized_networks(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The full names of the Google Compute Engine networks the domain instance is connected to. The domain is only available on networks listed in authorizedNetworks.
        If CIDR subnets overlap between networks, domain creation will fail.
        """
