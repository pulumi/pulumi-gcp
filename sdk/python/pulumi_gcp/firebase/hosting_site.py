...
class _HostingSiteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_id: Optional. The [ID of a Web App](https://firebase.google.com/docs/reference/firebase-management/rest/v1beta1/projects.webApps#WebApp.FIELDS.app_id)
               associated with the Hosting site.
        :param pulumi.Input[builtins.str] default_url: The default URL for the site in the form of https://{name}.web.app
        :param pulumi.Input[builtins.str] name: Output only. The fully-qualified resource name of the Hosting site, in
    ...
    def default_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @default_url.setter
    def default_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HostingSite(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultUrl")
    def default_url(self) -> pulumi.Output[builtins.str]:
        """
        The default URL for the site in the form of https://{name}.web.app
        """
        return pulumi.get(self, "default_url")
