...
class AppHostingBackendCodebaseArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] repository: The resource name for the Developer Connect
               [`gitRepositoryLink`](https://cloud.google.com/developer-connect/docs/api/reference/rest/v1/projects.locations.connections.gitRepositoryLinks)
               connected to this backend, in the format:
               projects/{project}/locations/{location}/connections/{connection}/gitRepositoryLinks/{repositoryLink}
        :param pulumi.Input[builtins.str] root_directory: If `repository` is provided, the directory relative to the root of the
               repository to use as the root for the deployed web app.
        """
...
if not MYPY:
    class AppHostingBuildSourceCodebaseArgsDict(TypedDict):
        ...
        """
        commit_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AppHostingBuildSourceCodebaseArgs:
    def __init__(__self__, *,
                 ...
                 commit_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['AppHostingBuildSourceCodebaseAuthorArgs']]] authors: (Output)
               ...
               Currently assumes a Git user.
               Structure is documented below.
        :param pulumi.Input[builtins.str] branch: The branch in the codebase to build from, using the latest commit.
        :param pulumi.Input[builtins.str] commit: The commit in the codebase to build from.
               
               
               <a name="nested_source_codebase_author"></a>The `author` block contains:
        :param pulumi.Input[builtins.str] commit_message: (Output)
               The message of a codebase change.
    ...
    def commit_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The time the change was made.
        """
    ...
    @commit_time.setter
    def commit_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AppHostingBuildSourceContainerArgs:
    def __init__(__self__, *,
                 image: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] image: A URI representing a container for the backend to use.
        """
...
if not MYPY:
    class ExtensionsInstanceConfigArgsDict(TypedDict):
        ...
        """
        allowed_event_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        eventarc_channel: NotRequired[pulumi.Input[builtins.str]]
        """
        Fully qualified Eventarc resource name that consumers should use for event triggers.
        """
        extension_version: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        populated_postinstall_content: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class ExtensionsInstanceConfigArgs:
    def __init__(__self__, *,
                 extension_ref: pulumi.Input[builtins.str],
                 params: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]],
                 allowed_event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 create_time: Optional[pulumi.Input[builtins.str]] = None,
                 eventarc_channel: Optional[pulumi.Input[builtins.str]] = None,
                 extension_version: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 populated_postinstall_content: Optional[pulumi.Input[builtins.str]] = None,
                 system_params: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] extension_ref: The ref of the Extension from the Registry (e.g. publisher-id/awesome-extension)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] params: Environment variables that may be configured for the Extension
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_event_types: List of extension events selected by consumer that extension is allowed to
               emit, identified by their types.
        :param pulumi.Input[builtins.str] create_time: (Output)
               The time at which the Extension Instance Config was created.
        :param pulumi.Input[builtins.str] eventarc_channel: Fully qualified Eventarc resource name that consumers should use for event triggers.
        :param pulumi.Input[builtins.str] extension_version: The version of the Extension from the Registry (e.g. 1.0.3). If left blank, latest is assumed.
        :param pulumi.Input[builtins.str] name: (Output)
               The unique identifier for this configuration.
        :param pulumi.Input[builtins.str] populated_postinstall_content: (Output)
               Postinstall instructions to be shown for this Extension, with
               template strings representing function and parameter values substituted
               with actual values. These strings include: ${param:FOO},
               ${function:myFunc.url},
    ...
    def extension_ref(self) -> pulumi.Input[builtins.str]:
        """
        The ref of the Extension from the Registry (e.g. publisher-id/awesome-extension)
        """
    ...
    def extension_ref(self, value: pulumi.Input[builtins.str]):
    ...
    def allowed_event_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of extension events selected by consumer that extension is allowed to
        emit, identified by their types.
        """
    ...
    def allowed_event_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def eventarc_channel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Fully qualified Eventarc resource name that consumers should use for event triggers.
        """
    ...
    def eventarc_channel(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def populated_postinstall_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Postinstall instructions to be shown for this Extension, with
        template strings representing function and parameter values substituted
    ...
    def populated_postinstall_content(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "populated_postinstall_content", value)

    @property
    @pulumi.getter(name="systemParams")
    def system_params(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Params whose values are only available at deployment time.
        Unlike other params, these will not be set as environment variables on
        functions. See a full list of system parameters at
    ...
    def system_params(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class ExtensionsInstanceErrorStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]] details: A list of messages that carry the error details.
        :param pulumi.Input[builtins.str] message: A developer-facing error message, which should be in English.
        """
        if code is not None:
            pulumi.set(__self__, "code", code)
        if details is not None:
...
if not MYPY:
    class ExtensionsInstanceRuntimeDataArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        state_update_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExtensionsInstanceRuntimeDataArgs:
    def __init__(__self__, *,
                 ...
                 state_update_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input['ExtensionsInstanceRuntimeDataProcessingStateArgs'] processing_state: The processing state for the extension instance
               Structure is documented below.
        :param pulumi.Input[builtins.str] state_update_time: The time of the last state update.
        """
    ...
    def state_update_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time of the last state update.
        """
    ...
    def state_update_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExtensionsInstanceRuntimeDataFatalErrorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] error_message: The error message. This is set by the extension developer to give
               more detail on why the extension is unusable and must be re-installed
               or reconfigured.
        """
...
if not MYPY:
    class ExtensionsInstanceRuntimeDataProcessingStateArgsDict(TypedDict):
        detail_message: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExtensionsInstanceRuntimeDataProcessingStateArgs:
    def __init__(__self__, *,
                 detail_message: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] detail_message: Details about the processing. e.g. This could include the type of
               processing in progress or it could list errors or failures.
               This information will be shown in the console on the detail page
               for the extension instance.
    ...
    def detail_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Details about the processing. e.g. This could include the type of
        processing in progress or it could list errors or failures.
        This information will be shown in the console on the detail page
    ...
    def detail_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HostingCustomDomainCertArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] state: The state of the certificate. Only the `CERT_ACTIVE` and
               `CERT_EXPIRING_SOON` states provide SSL coverage for a domain name. If the
               state is `PROPAGATING` and Hosting had an active cert for the domain name
               before, that formerly-active cert provides SSL coverage for the domain name
               until the current cert propagates.
        :param pulumi.Input[builtins.str] type: The record's type, which determines what data the record contains.
...
class HostingCustomDomainCertVerificationDnsDesiredArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain_name: The domain name the record pertains to, e.g. `foo.bar.com.`.
...
class HostingCustomDomainCertVerificationDnsDesiredRecordArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain_name: The domain name the record pertains to, e.g. `foo.bar.com.`.
        :param pulumi.Input[builtins.str] rdata: The data of the record. The meaning of the value depends on record type:
               - A and AAAA: IP addresses for the domain name.
               - CNAME: Another domain to check for records.
               - TXT: Arbitrary text strings associated with the domain name. Hosting
               uses TXT records to determine a which Firebase Projects have
               permission to act on the domain name's behalf.
               - CAA: The record's flags, tag, and value, e.g. `0 issue "pki.goog"`.
        :param pulumi.Input[builtins.str] required_action: Indicates the a required action for this record.
        :param pulumi.Input[builtins.str] type: The record's type, which determines what data the record contains.
        """
        if domain_name is not None:
            pulumi.set(__self__, "domain_name", domain_name)
...
if not MYPY:
    class HostingCustomDomainCertVerificationHttpArgsDict(TypedDict):
        ...
        A text string to serve at the path.
        """
        discovered: NotRequired[pulumi.Input[builtins.str]]
        """
        Whether Hosting was able to find the required file contents on the
        specified path during its last check.
        """
        last_check_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class HostingCustomDomainCertVerificationHttpArgs:
    def __init__(__self__, *,
                 ...
                 discovered: Optional[pulumi.Input[builtins.str]] = None,
                 last_check_time: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] desired: A text string to serve at the path.
        :param pulumi.Input[builtins.str] discovered: Whether Hosting was able to find the required file contents on the
               specified path during its last check.
        :param pulumi.Input[builtins.str] last_check_time: (Output)
               The last time Hosting systems checked for the file contents.
        :param pulumi.Input[builtins.str] path: The path to the file.
        """
    ...
    @property
    @pulumi.getter
    def discovered(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether Hosting was able to find the required file contents on the
        specified path during its last check.
        """
    ...
    @discovered.setter
    def discovered(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "discovered", value)

    @property
    @pulumi.getter(name="lastCheckTime")
    def last_check_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The last time Hosting systems checked for the file contents.
        """
    ...
    def last_check_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HostingCustomDomainIssueArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] code: The status code, which should be an enum value of `google.rpc.Code`
        :param pulumi.Input[builtins.str] details: A list of messages that carry the error details.
...
if not MYPY:
    class HostingVersionConfigHeaderArgsDict(TypedDict):
        ...
        """
        glob: NotRequired[pulumi.Input[builtins.str]]
        """
...
class HostingVersionConfigHeaderArgs:
    def __init__(__self__, *,
                 headers: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]],
                 glob: Optional[pulumi.Input[builtins.str]] = None,
                 regex: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: The additional headers to add to the response. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[builtins.str] glob: The user-supplied glob to match against the request URL path.
        :param pulumi.Input[builtins.str] regex: The user-supplied RE2 regular expression to match against the request URL path.
        """
        pulumi.set(__self__, "headers", headers)
        if glob is not None:
    ...
    @property
    @pulumi.getter
    def glob(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The user-supplied glob to match against the request URL path.
        """
    ...
    @glob.setter
    def glob(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HostingVersionConfigRedirectArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] location: The value to put in the HTTP location header of the response.
               The location can contain capture group values from the pattern using a : prefix to identify
               the segment and an optional * to capture the rest of the URL. For example:
        :param pulumi.Input[builtins.int] status_code: The status HTTP code to return in the response. It must be a valid 3xx status code.
        :param pulumi.Input[builtins.str] glob: The user-supplied glob to match against the request URL path.
        :param pulumi.Input[builtins.str] regex: The user-supplied RE2 regular expression to match against the request URL path.
        """
...
class HostingVersionConfigRewriteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] function: The function to proxy requests to. Must match the exported function name exactly.
        :param pulumi.Input[builtins.str] glob: The user-supplied glob to match against the request URL path.
        :param pulumi.Input[builtins.str] path: The URL path to rewrite the request to.
        :param pulumi.Input[builtins.str] regex: The user-supplied RE2 regular expression to match against the request URL path.
...
class HostingVersionConfigRewriteRunArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] service_id: User-defined ID of the Cloud Run service.
        :param pulumi.Input[builtins.str] region: Optional. User-provided region where the Cloud Run service is hosted. Defaults to `us-central1` if not supplied.
        """
