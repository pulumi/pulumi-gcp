...
class HostingReleaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The type of the release; indicates what happened to the content of the site. There is no need to specify
        ...
        :param pulumi.Input[_builtins.str] version_name: The unique identifier for a version, in the format: sites/SITE_ID/versions/VERSION_ID.
...
class _HostingReleaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] channel_id: The ID of the channel to which the release belongs. If not provided, the release will
               belong to the default "live" channel
        :param pulumi.Input[_builtins.str] message: The deploy description when the release was created. The value can be up to 512 characters.
        :param pulumi.Input[_builtins.str] name: The unique identifier for the release, in either of the following formats:
               sites/SITE_ID/releases/RELEASE_ID
               sites/SITE_ID/channels/CHANNEL_ID/releases/RELEASE_ID
        :param pulumi.Input[_builtins.str] release_id: The unique identifier for the Release.
        :param pulumi.Input[_builtins.str] site_id: Required. The ID of the site to which the release belongs.
        :param pulumi.Input[_builtins.str] type: The type of the release; indicates what happened to the content of the site. There is no need to specify
               `DEPLOY` or `ROLLBACK` type if a `version_name` is provided.
               DEPLOY: A version was uploaded to Firebase Hosting and released. Output only.
...
class HostingRelease(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            site_id: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            version_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'HostingRelease':
        """
