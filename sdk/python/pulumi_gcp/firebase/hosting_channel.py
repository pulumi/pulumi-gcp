...
class HostingChannelArgs:
    def __init__(__self__, *,
                 ...
                 retained_release_count: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Text labels used for extra metadata and/or filtering
        ...
        :param pulumi.Input[_builtins.str] ttl: Input only. A time-to-live for this channel. Sets `expire_time` to the provided
    ...
    def retained_release_count(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def retained_release_count(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class HostingChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retained_release_count: pulumi.Input[Optional[_builtins.int]] = None,
            site_id: pulumi.Input[Optional[_builtins.str]] = None,
            ttl: pulumi.Input[Optional[_builtins.str]] = None) -> 'HostingChannel':
        """
