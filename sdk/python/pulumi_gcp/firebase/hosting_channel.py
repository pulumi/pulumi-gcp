...
class HostingChannelArgs:
    def __init__(__self__, *,
                 ...
                 retained_release_count: Optional[pulumi.Input[builtins.int]] = None,
                 ttl: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HostingChannel resource.
        :param pulumi.Input[builtins.str] channel_id: Required. Immutable. A unique ID within the site that identifies the channel.
               
               
               - - -
        :param pulumi.Input[builtins.str] site_id: Required. The ID of the site in which to create this channel.
        :param pulumi.Input[builtins.str] expire_time: The time at which the channel will be automatically deleted. If null, the channel
               will not be automatically deleted. This field is present in the output whether it's
               set directly or via the `ttl` field.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Text labels used for extra metadata and/or filtering
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.int] retained_release_count: The number of previous releases to retain on the channel for rollback or other
               purposes. Must be a number between 1-100. Defaults to 10 for new channels.
        :param pulumi.Input[builtins.str] ttl: Input only. A time-to-live for this channel. Sets `expire_time` to the provided
    ...
    def retained_release_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def retained_release_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _HostingChannelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Text labels used for extra metadata and/or filtering
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] name: The fully-qualified resource name for the channel, in the format:
...
class HostingChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retained_release_count: Optional[pulumi.Input[builtins.int]] = None,
            site_id: Optional[pulumi.Input[builtins.str]] = None,
            ttl: Optional[pulumi.Input[builtins.str]] = None) -> 'HostingChannel':
        """
    ...
    @property
    @pulumi.getter(name="retainedReleaseCount")
    def retained_release_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of previous releases to retain on the channel for rollback or other
        purposes. Must be a number between 1-100. Defaults to 10 for new channels.
        """
