...
class GetAndroidAppResult:
    ...
    def sha1_hashes(self) -> Sequence[builtins.str]:
        """
    ...
    def sha256_hashes(self) -> Sequence[builtins.str]:
        """
...
def get_android_app(app_id: Optional[builtins.str] = None,
                    project: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAndroidAppResult:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str app_id: The app_id of name of the Firebase androidApp.
...
def get_android_app_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
