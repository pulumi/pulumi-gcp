...
def get_apple_app_config(app_id: Optional[builtins.str] = None,
                         project: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppleAppConfigResult:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str app_id: The id of the Firebase iOS App.
...
def get_apple_app_config_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
