...
class AppCheckRecaptchaEnterpriseConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] token_ttl: Specifies the duration for which App Check tokens exchanged from reCAPTCHA Enterprise artifacts will be valid.
