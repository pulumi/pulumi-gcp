...
def get_web_app_config(project: Optional[builtins.str] = None,
                       web_app_id: Optional[builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param builtins.str web_app_id: the id of the firebase web app
...
def get_web_app_config_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              web_app_id: Optional[pulumi.Input[builtins.str]] = None,
