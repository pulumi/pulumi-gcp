...
class AppCheckRecaptchaV3ConfigArgs:
    def __init__(__self__, *,
                 ...
                 site_secret: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] token_ttl: Specifies the duration for which App Check tokens exchanged from reCAPTCHA V3 artifacts will be valid.
    ...
    @site_secret.setter
    def site_secret(self, value: pulumi.Input[_builtins.str]):
...
class _AppCheckRecaptchaV3ConfigState:
    def __init__(__self__, *,
                 ...
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 site_secret: pulumi.Input[Optional[_builtins.str]] = None,
                 site_secret_set: pulumi.Input[Optional[_builtins.bool]] = None,
                 token_ttl: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] site_secret: The site secret used to identify your service for reCAPTCHA v3 verification.
               For security reasons, this field will never be populated in any response.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[_builtins.bool] site_secret_set: Whether the siteSecret was previously set. Since we will never return the siteSecret field, this field is the only way to find out whether it was previously set.
        :param pulumi.Input[_builtins.str] token_ttl: Specifies the duration for which App Check tokens exchanged from reCAPTCHA V3 artifacts will be valid.
               If unset, a default value of 1 hour is assumed. Must be between 30 minutes and 7 days, inclusive.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        """
    ...
    @_builtins.property
    @pulumi.getter(name="siteSecret")
    def site_secret(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The site secret used to identify your service for reCAPTCHA v3 verification.
        For security reasons, this field will never be populated in any response.
        **Note**: This property is sensitive and will not be displayed in the plan.
    ...
    @site_secret.setter
    def site_secret(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "site_secret", value)

    @_builtins.property
    @pulumi.getter(name="siteSecretSet")
    def site_secret_set(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def site_secret_set(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class AppCheckRecaptchaV3Config(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            site_secret: pulumi.Input[Optional[_builtins.str]] = None,
            site_secret_set: pulumi.Input[Optional[_builtins.bool]] = None,
            token_ttl: pulumi.Input[Optional[_builtins.str]] = None) -> 'AppCheckRecaptchaV3Config':
        """
