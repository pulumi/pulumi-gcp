...
class AppCheckDeviceCheckConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] token_ttl: Specifies the duration for which App Check tokens exchanged from DeviceCheck artifacts will be valid.
...
class _AppCheckDeviceCheckConfigState:
    def __init__(__self__, *,
                 ...
                 private_key_set: Optional[pulumi.Input[builtins.bool]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 token_ttl: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] private_key: The contents of the private key (.p8) file associated with the key specified by keyId.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.bool] private_key_set: Whether the privateKey field was previously set. Since App Check will never return the
    ...
    def private_key_set(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def private_key_set(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AppCheckDeviceCheckConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            private_key_set: Optional[pulumi.Input[builtins.bool]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            token_ttl: Optional[pulumi.Input[builtins.str]] = None) -> 'AppCheckDeviceCheckConfig':
        """
    ...
    @property
    @pulumi.getter(name="privateKeySet")
    def private_key_set(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the privateKey field was previously set. Since App Check will never return the
        privateKey field, this field is the only way to find out whether it was previously set.
        """
