...
class _AppHostingDefaultDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The location of the Backend that this Domain is associated with
        :param pulumi.Input[_builtins.str] name: Identifier. The resource name of the domain, e.g.
               `projects/{project}/locations/{locationId}/backends/{backendId}/domains/{domainId}`
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] uid: System-assigned, unique identifier.
        :param pulumi.Input[_builtins.str] update_time: Time at which the domain was last updated.
        """
...
class AppHostingDefaultDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            uid: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'AppHostingDefaultDomain':
        """
