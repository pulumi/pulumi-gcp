...
class AppCheckPlayIntegrityConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] token_ttl: Specifies the duration for which App Check tokens exchanged from Play Integrity artifacts will be valid.
...
class AppCheckPlayIntegrityConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None,
            token_ttl: Optional[pulumi.Input[_builtins.str]] = None) -> 'AppCheckPlayIntegrityConfig':
        """
