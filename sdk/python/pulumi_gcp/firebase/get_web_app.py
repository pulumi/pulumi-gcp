...
class GetWebAppResult:
    ...
    def app_urls(self) -> Sequence[builtins.str]:
...
def get_web_app(app_id: Optional[builtins.str] = None,
    ...
    :param builtins.str app_id: The app_ip of name of the Firebase webApp.
...
def get_web_app_output(app_id: Optional[pulumi.Input[builtins.str]] = None,
