...
class WorkstationClusterDomainConfig(dict):
    def __init__(__self__, *,
                 domain: builtins.str):
        """
        :param builtins.str domain: Domain used by Workstations for HTTP ingress.
        """
...
class WorkstationClusterPrivateClusterConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allowed_projects: Optional[Sequence[builtins.str]] = None,
                 cluster_hostname: Optional[builtins.str] = None,
                 service_attachment_uri: Optional[builtins.str] = None):
        """
        :param builtins.bool enable_private_endpoint: Whether Workstations endpoint is private.
        :param Sequence[builtins.str] allowed_projects: Additional project IDs that are allowed to attach to the workstation cluster's service attachment.
               By default, the workstation cluster's project and the VPC host project (if different) are allowed.
        :param builtins.str cluster_hostname: (Output)
               Hostname for the workstation cluster.
               This field will be populated only when private endpoint is enabled.
               To access workstations in the cluster, create a new DNS zone mapping this domain name to an internal IP address and a forwarding rule mapping that address to the service attachment.
        :param builtins.str service_attachment_uri: (Output)
    ...
    def enable_private_endpoint(self) -> builtins.bool:
        """
    ...
    def allowed_projects(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def cluster_hostname(self) -> Optional[builtins.str]:
        """
        (Output)
        Hostname for the workstation cluster.
        This field will be populated only when private endpoint is enabled.
    ...
    def service_attachment_uri(self) -> Optional[builtins.str]:
        """
        (Output)
        Service attachment URI for the workstation cluster.
        The service attachment is created when private endpoint is enabled.
...
class WorkstationConfigAllowedPort(dict):
    def __init__(__self__, *,
                 first: Optional[builtins.int] = None,
                 last: Optional[builtins.int] = None):
        """
        :param builtins.int first: Starting port number for the current range of ports. Valid ports are 22, 80, and ports within the range 1024-65535.
        :param builtins.int last: Ending port number for the current range of ports. Valid ports are 22, 80, and ports within the range 1024-65535.
        """
    ...
    @property
    @pulumi.getter
    def first(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def last(self) -> Optional[builtins.int]:
        """
...
class WorkstationConfigContainer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] args: Arguments passed to the entrypoint.
        :param Sequence[builtins.str] commands: If set, overrides the default ENTRYPOINT specified by the image.
        :param Mapping[str, builtins.str] env: Environment variables passed to the container.
               The elements are of the form "KEY=VALUE" for the environment variable "KEY" being given the value "VALUE".
        :param builtins.str image: Docker image defining the container. This image must be accessible by the config's service account.
        :param builtins.int run_as_user: If set, overrides the USER specified in the image with the given uid.
        :param builtins.str working_dir: If set, overrides the default DIR specified by the image.
        """
        if args is not None:
...
class WorkstationConfigEncryptionKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key: The name of the Google Cloud KMS encryption key.
        :param builtins.str kms_key_service_account: The service account to use with the specified KMS key.
        """
...
class WorkstationConfigEphemeralDirectory(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str mount_path: Location of this directory in the running workstation.
        """
...
class WorkstationConfigEphemeralDirectoryGcePd(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_image: Optional[builtins.str] = None,
                 source_snapshot: Optional[builtins.str] = None):
        """
        :param builtins.str disk_type: Type of the disk to use. Defaults to `"pd-standard"`.
        :param builtins.bool read_only: Whether the disk is read only. If true, the disk may be shared by multiple VMs and `sourceSnapshot` must be set.
        :param builtins.str source_image: Name of the disk image to use as the source for the disk.
        ...
        :param builtins.str source_snapshot: Name of the snapshot to use as the source for the disk.
    ...
    def source_image(self) -> Optional[builtins.str]:
        """
...
class WorkstationConfigHostGceInstance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_public_ip_addresses: Optional[builtins.bool] = None,
                 disable_ssh: Optional[builtins.bool] = None,
        ...
        :param Sequence['WorkstationConfigHostGceInstanceBoostConfigArgs'] boost_configs: A list of the boost configurations that workstations created using this workstation configuration are allowed to use.
               Structure is documented below.
        :param builtins.int boot_disk_size_gb: Size of the boot disk in GB.
        :param 'WorkstationConfigHostGceInstanceConfidentialInstanceConfigArgs' confidential_instance_config: A set of Compute Engine Confidential VM instance options.
               Structure is documented below.
        :param builtins.bool disable_public_ip_addresses: Whether instances have no public IP address.
        :param builtins.bool disable_ssh: Whether to disable SSH access to the VM.
        :param builtins.bool enable_nested_virtualization: Whether to enable nested virtualization on the Compute Engine VMs backing the Workstations.
               See https://cloud.google.com/workstations/docs/reference/rest/v1beta/projects.locations.workstationClusters.workstationConfigs#GceInstance.FIELDS.enable_nested_virtualization
        :param builtins.str machine_type: The name of a Compute Engine machine type.
        :param builtins.int pool_size: Number of instances to pool for faster workstation startup.
        :param builtins.str service_account: Email address of the service account that will be used on VM instances used to support this config. This service account must have permission to pull the specified container image. If not set, VMs will run without a service account, in which case the image must be publicly accessible.
        :param Sequence[builtins.str] service_account_scopes: Scopes to grant to the service_account. Various scopes are automatically added based on feature usage. When specified, users of workstations under this configuration must have `iam.serviceAccounts.actAs` on the service account.
        :param 'WorkstationConfigHostGceInstanceShieldedInstanceConfigArgs' shielded_instance_config: A set of Compute Engine Shielded instance options.
               Structure is documented below.
        :param Sequence[builtins.str] tags: Network tags to add to the Compute Engine machines backing the Workstations.
        :param Mapping[str, builtins.str] vm_tags: Resource manager tags to be bound to the VM instances backing the Workstations.
    ...
    def disable_public_ip_addresses(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_ssh(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_nested_virtualization(self) -> Optional[builtins.bool]:
        """
    ...
    def service_account_scopes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def vm_tags(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class WorkstationConfigHostGceInstanceAccelerator(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.int count: Number of accelerator cards exposed to the instance.
        :param builtins.str type: Type of accelerator resource to attach to the instance, for example, "nvidia-tesla-p100".
        """
...
class WorkstationConfigHostGceInstanceBoostConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pool_size: Optional[builtins.int] = None):
        """
        :param builtins.str id: The id to be used for the boost config.
        :param Sequence['WorkstationConfigHostGceInstanceBoostConfigAcceleratorArgs'] accelerators: An accelerator card attached to the boost instance.
               Structure is documented below.
        :param builtins.int boot_disk_size_gb: Size of the boot disk in GB. The minimum boot disk size is `30` GB. Defaults to `50` GB.
        :param builtins.bool enable_nested_virtualization: Whether to enable nested virtualization on the Compute Engine VMs backing boosted Workstations.
               See https://cloud.google.com/workstations/docs/reference/rest/v1beta/projects.locations.workstationClusters.workstationConfigs#GceInstance.FIELDS.enable_nested_virtualization
        :param builtins.str machine_type: The type of machine that boosted VM instances will use—for example, e2-standard-4. For more information about machine types that Cloud Workstations supports, see the list of available machine types https://cloud.google.com/workstations/docs/available-machine-types. Defaults to e2-standard-4.
        :param builtins.int pool_size: Number of instances to pool for faster workstation boosting.
        """
...
class WorkstationConfigHostGceInstanceConfidentialInstanceConfig(dict):
    ...
    def __init__(__self__, *,
                 enable_confidential_compute: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_confidential_compute: Whether the instance has confidential compute enabled.
        """
    ...
    def enable_confidential_compute(self) -> Optional[builtins.bool]:
        """
...
class WorkstationConfigHostGceInstanceShieldedInstanceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_integrity_monitoring: Whether the instance has integrity monitoring enabled.
        :param builtins.bool enable_secure_boot: Whether the instance has Secure Boot enabled.
        :param builtins.bool enable_vtpm: Whether the instance has the vTPM enabled.
        """
...
class WorkstationConfigPersistentDirectoryGcePd(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str disk_type: Type of the disk to use. Defaults to `"pd-standard"`.
        :param builtins.str fs_type: Type of file system that the disk should be formatted with. The workstation image must support this file system type. Must be empty if `sourceSnapshot` is set. Defaults to `ext4`.
        :param builtins.str reclaim_policy: Whether the persistent disk should be deleted when the workstation is deleted. Valid values are `DELETE` and `RETAIN`. Defaults to `DELETE`.
               Possible values are: `DELETE`, `RETAIN`.
        :param builtins.int size_gb: The GB capacity of a persistent home directory for each workstation created with this configuration. Must be empty if `sourceSnapshot` is set.
...
class WorkstationConfigReadinessCheck(dict):
    def __init__(__self__, *,
                 ...
                 port: builtins.int):
        """
        :param builtins.str path: Path to which the request should be sent.
        :param builtins.int port: Port to which the request should be sent.
        """
