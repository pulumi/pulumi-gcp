...
class WorkstationConfigIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['WorkstationConfigIamBindingConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] workstation_config_id: Used to find the parent resource to bind the IAM policy to
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['WorkstationConfigIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['WorkstationConfigIamBindingConditionArgs']]):
...
class WorkstationConfigIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['WorkstationConfigIamBindingConditionArgs', 'WorkstationConfigIamBindingConditionArgsDict', 'outputs.WorkstationConfigIamBindingCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `workstations.WorkstationConfigIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the workstationconfig are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `workstations.WorkstationConfigIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the workstationconfig are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            role: pulumi.Input[Optional[_builtins.str]] = None,
            workstation_cluster_id: pulumi.Input[Optional[_builtins.str]] = None,
            workstation_config_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'WorkstationConfigIamBinding':
        """
