...
def get_workstation_config_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location where the workstation cluster config should reside.
    ...
    :param _builtins.str workstation_config_id: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_workstation_config_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
