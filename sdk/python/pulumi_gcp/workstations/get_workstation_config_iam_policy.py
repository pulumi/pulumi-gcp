...
def get_workstation_config_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The location where the workstation cluster config should reside.
...
def get_workstation_config_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
