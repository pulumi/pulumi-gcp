...
class WorkstationClusterDomainConfigArgs:
    def __init__(__self__, *,
                 domain: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] domain: Domain used by Workstations for HTTP ingress.
        """
...
if not MYPY:
    class WorkstationClusterPrivateClusterConfigArgsDict(TypedDict):
        enable_private_endpoint: pulumi.Input[builtins.bool]
        """
        Whether Workstations endpoint is private.
        """
        allowed_projects: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Additional project IDs that are allowed to attach to the workstation cluster's service attachment.
        By default, the workstation cluster's project and the VPC host project (if different) are allowed.
        """
        cluster_hostname: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        ...
        """
        service_attachment_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class WorkstationClusterPrivateClusterConfigArgs:
    def __init__(__self__, *,
                 ...
                 cluster_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 service_attachment_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_private_endpoint: Whether Workstations endpoint is private.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_projects: Additional project IDs that are allowed to attach to the workstation cluster's service attachment.
               By default, the workstation cluster's project and the VPC host project (if different) are allowed.
        :param pulumi.Input[builtins.str] cluster_hostname: (Output)
               Hostname for the workstation cluster.
               This field will be populated only when private endpoint is enabled.
               To access workstations in the cluster, create a new DNS zone mapping this domain name to an internal IP address and a forwarding rule mapping that address to the service attachment.
        :param pulumi.Input[builtins.str] service_attachment_uri: (Output)
               Service attachment URI for the workstation cluster.
               The service attachment is created when private endpoint is enabled.
               To access workstations in the cluster, configure access to the managed service using (Private Service Connect)[https://cloud.google.com/vpc/docs/configure-private-service-connect-services].
        """
    ...
    def enable_private_endpoint(self) -> pulumi.Input[builtins.bool]:
        """
        Whether Workstations endpoint is private.
        """
    ...
    def enable_private_endpoint(self, value: pulumi.Input[builtins.bool]):
    ...
    def cluster_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Hostname for the workstation cluster.
        This field will be populated only when private endpoint is enabled.
    ...
    def cluster_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_hostname", value)

    @property
    @pulumi.getter(name="serviceAttachmentUri")
    def service_attachment_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Service attachment URI for the workstation cluster.
        The service attachment is created when private endpoint is enabled.
...
class WorkstationConfigAllowedPortArgs:
    def __init__(__self__, *,
                 first: Optional[pulumi.Input[builtins.int]] = None,
                 last: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] first: Starting port number for the current range of ports. Valid ports are 22, 80, and ports within the range 1024-65535.
        :param pulumi.Input[builtins.int] last: Ending port number for the current range of ports. Valid ports are 22, 80, and ports within the range 1024-65535.
        """
    ...
    @property
    @pulumi.getter
    def first(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Starting port number for the current range of ports. Valid ports are 22, 80, and ports within the range 1024-65535.
        """
    ...
    @first.setter
    def first(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "first", value)

    @property
    @pulumi.getter
    def last(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Ending port number for the current range of ports. Valid ports are 22, 80, and ports within the range 1024-65535.
        """
    ...
    @last.setter
    def last(self, value: Optional[pulumi.Input[builtins.int]]):
...
class WorkstationConfigContainerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: Arguments passed to the entrypoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commands: If set, overrides the default ENTRYPOINT specified by the image.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] env: Environment variables passed to the container.
               The elements are of the form "KEY=VALUE" for the environment variable "KEY" being given the value "VALUE".
        :param pulumi.Input[builtins.str] image: Docker image defining the container. This image must be accessible by the config's service account.
        :param pulumi.Input[builtins.int] run_as_user: If set, overrides the USER specified in the image with the given uid.
        :param pulumi.Input[builtins.str] working_dir: If set, overrides the default DIR specified by the image.
        """
        if args is not None:
...
if not MYPY:
    class WorkstationConfigEncryptionKeyArgsDict(TypedDict):
        ...
        """
        kms_key_service_account: pulumi.Input[builtins.str]
        """
...
class WorkstationConfigEncryptionKeyArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_service_account: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key: The name of the Google Cloud KMS encryption key.
        :param pulumi.Input[builtins.str] kms_key_service_account: The service account to use with the specified KMS key.
        """
    ...
    def kms_key_service_account(self) -> pulumi.Input[builtins.str]:
        """
        The service account to use with the specified KMS key.
        """
    ...
    def kms_key_service_account(self, value: pulumi.Input[builtins.str]):
...
class WorkstationConfigEphemeralDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['WorkstationConfigEphemeralDirectoryGcePdArgs'] gce_pd: An EphemeralDirectory backed by a Compute Engine persistent disk.
               Structure is documented below.
        :param pulumi.Input[builtins.str] mount_path: Location of this directory in the running workstation.
        """
...
class WorkstationConfigEphemeralDirectoryGcePdArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] disk_type: Type of the disk to use. Defaults to `"pd-standard"`.
        :param pulumi.Input[builtins.bool] read_only: Whether the disk is read only. If true, the disk may be shared by multiple VMs and `sourceSnapshot` must be set.
        :param pulumi.Input[builtins.str] source_image: Name of the disk image to use as the source for the disk.
               Must be empty `sourceSnapshot` is set.
               Updating `sourceImage` will update content in the ephemeral directory after the workstation is restarted.
        :param pulumi.Input[builtins.str] source_snapshot: Name of the snapshot to use as the source for the disk.
               Must be empty if `sourceImage` is set.
               Must be empty if `read_only` is false.
               Updating `source_snapshot` will update content in the ephemeral directory after the workstation is restarted.
        """
...
if not MYPY:
    class WorkstationConfigHostGceInstanceArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        disable_public_ip_addresses: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether instances have no public IP address.
        """
        disable_ssh: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        pool_size: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        vm_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class WorkstationConfigHostGceInstanceArgs:
    def __init__(__self__, *,
                 ...
                 disable_public_ip_addresses: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_ssh: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 vm_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['WorkstationConfigHostGceInstanceBoostConfigArgs']]] boost_configs: A list of the boost configurations that workstations created using this workstation configuration are allowed to use.
               Structure is documented below.
        :param pulumi.Input[builtins.int] boot_disk_size_gb: Size of the boot disk in GB.
        :param pulumi.Input['WorkstationConfigHostGceInstanceConfidentialInstanceConfigArgs'] confidential_instance_config: A set of Compute Engine Confidential VM instance options.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] disable_public_ip_addresses: Whether instances have no public IP address.
        :param pulumi.Input[builtins.bool] disable_ssh: Whether to disable SSH access to the VM.
        :param pulumi.Input[builtins.bool] enable_nested_virtualization: Whether to enable nested virtualization on the Compute Engine VMs backing the Workstations.
               See https://cloud.google.com/workstations/docs/reference/rest/v1beta/projects.locations.workstationClusters.workstationConfigs#GceInstance.FIELDS.enable_nested_virtualization
        :param pulumi.Input[builtins.str] machine_type: The name of a Compute Engine machine type.
        :param pulumi.Input[builtins.int] pool_size: Number of instances to pool for faster workstation startup.
        :param pulumi.Input[builtins.str] service_account: Email address of the service account that will be used on VM instances used to support this config. This service account must have permission to pull the specified container image. If not set, VMs will run without a service account, in which case the image must be publicly accessible.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_account_scopes: Scopes to grant to the service_account. Various scopes are automatically added based on feature usage. When specified, users of workstations under this configuration must have `iam.serviceAccounts.actAs` on the service account.
        :param pulumi.Input['WorkstationConfigHostGceInstanceShieldedInstanceConfigArgs'] shielded_instance_config: A set of Compute Engine Shielded instance options.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Network tags to add to the Compute Engine machines backing the Workstations.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] vm_tags: Resource manager tags to be bound to the VM instances backing the Workstations.
               Tag keys and values have the same definition as
               https://cloud.google.com/resource-manager/docs/tags/tags-overview
               Keys must be in the format `tagKeys/{tag_key_id}`, and
               values are in the format `tagValues/456`.
    ...
    def disable_public_ip_addresses(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether instances have no public IP address.
        """
    ...
    def disable_public_ip_addresses(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_public_ip_addresses", value)

    @property
    @pulumi.getter(name="disableSsh")
    def disable_ssh(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to disable SSH access to the VM.
        """
    ...
    @disable_ssh.setter
    def disable_ssh(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vm_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Resource manager tags to be bound to the VM instances backing the Workstations.
        Tag keys and values have the same definition as
        https://cloud.google.com/resource-manager/docs/tags/tags-overview
    ...
    @vm_tags.setter
    def vm_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class WorkstationConfigHostGceInstanceAcceleratorArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] count: Number of accelerator cards exposed to the instance.
        :param pulumi.Input[builtins.str] type: Type of accelerator resource to attach to the instance, for example, "nvidia-tesla-p100".
        """
...
class WorkstationConfigHostGceInstanceBoostConfigArgs:
    def __init__(__self__, *,
                 ...
                 pool_size: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] id: The id to be used for the boost config.
        :param pulumi.Input[Sequence[pulumi.Input['WorkstationConfigHostGceInstanceBoostConfigAcceleratorArgs']]] accelerators: An accelerator card attached to the boost instance.
               Structure is documented below.
        :param pulumi.Input[builtins.int] boot_disk_size_gb: Size of the boot disk in GB. The minimum boot disk size is `30` GB. Defaults to `50` GB.
        :param pulumi.Input[builtins.bool] enable_nested_virtualization: Whether to enable nested virtualization on the Compute Engine VMs backing boosted Workstations.
               See https://cloud.google.com/workstations/docs/reference/rest/v1beta/projects.locations.workstationClusters.workstationConfigs#GceInstance.FIELDS.enable_nested_virtualization
        :param pulumi.Input[builtins.str] machine_type: The type of machine that boosted VM instances will use—for example, e2-standard-4. For more information about machine types that Cloud Workstations supports, see the list of available machine types https://cloud.google.com/workstations/docs/available-machine-types. Defaults to e2-standard-4.
        :param pulumi.Input[builtins.int] pool_size: Number of instances to pool for faster workstation boosting.
        """
...
class WorkstationConfigHostGceInstanceConfidentialInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_confidential_compute: Whether the instance has confidential compute enabled.
        """
...
class WorkstationConfigHostGceInstanceShieldedInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_integrity_monitoring: Whether the instance has integrity monitoring enabled.
        :param pulumi.Input[builtins.bool] enable_secure_boot: Whether the instance has Secure Boot enabled.
        :param pulumi.Input[builtins.bool] enable_vtpm: Whether the instance has the vTPM enabled.
        """
...
class WorkstationConfigPersistentDirectoryGcePdArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] disk_type: Type of the disk to use. Defaults to `"pd-standard"`.
        :param pulumi.Input[builtins.str] fs_type: Type of file system that the disk should be formatted with. The workstation image must support this file system type. Must be empty if `sourceSnapshot` is set. Defaults to `ext4`.
        :param pulumi.Input[builtins.str] reclaim_policy: Whether the persistent disk should be deleted when the workstation is deleted. Valid values are `DELETE` and `RETAIN`. Defaults to `DELETE`.
               Possible values are: `DELETE`, `RETAIN`.
        :param pulumi.Input[builtins.int] size_gb: The GB capacity of a persistent home directory for each workstation created with this configuration. Must be empty if `sourceSnapshot` is set.
               Valid values are `10`, `50`, `100`, `200`, `500`, or `1000`. Defaults to `200`. If less than `200` GB, the `diskType` must be `pd-balanced` or `pd-ssd`.
        :param pulumi.Input[builtins.str] source_snapshot: Name of the snapshot to use as the source for the disk.
               Must be empty if `sourceImage` is set.
               Must be empty if `read_only` is false.
...
class WorkstationConfigReadinessCheckArgs:
    def __init__(__self__, *,
                 ...
                 port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] path: Path to which the request should be sent.
        :param pulumi.Input[builtins.int] port: Port to which the request should be sent.
        """
