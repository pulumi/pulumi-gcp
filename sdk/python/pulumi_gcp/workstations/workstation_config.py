...
class WorkstationConfigArgs:
    ...
    def _configure(
        ...
        if enable_audit_agent is None and 'enableAuditAgent' in kwargs:
            enable_audit_agent = kwargs['enableAuditAgent']
        ...
        if enable_audit_agent is not None:
            _setter("enable_audit_agent", enable_audit_agent)
...
class WorkstationConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            container = _utilities.configure(container, WorkstationConfigContainerArgs, True)
            __props__.__dict__["container"] = container
            __props__.__dict__["display_name"] = display_name
            __props__.__dict__["enable_audit_agent"] = enable_audit_agent
            encryption_key = _utilities.configure(encryption_key, WorkstationConfigEncryptionKeyArgs, True)
            __props__.__dict__["encryption_key"] = encryption_key
            host = _utilities.configure(host, WorkstationConfigHostArgs, True)
