...
__all__ = ['WorkstationIamBindingArgs', 'WorkstationIamBinding']

@pulumi.input_type
class WorkstationIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['WorkstationIamBindingConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] workstation_config_id: The ID of the parent workstation cluster config.
               Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[_builtins.str] workstation_id: Used to find the parent resource to bind the IAM policy to
    ...
    def workstation_id(self) -> pulumi.Input[_builtins.str]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
    ...
    def workstation_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "workstation_id", value)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['WorkstationIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['WorkstationIamBindingConditionArgs']]):
...
@pulumi.input_type
class _WorkstationIamBindingState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['WorkstationIamBindingConditionArgs']] = None,
...
@pulumi.type_token("gcp:workstations/workstationIamBinding:WorkstationIamBinding")
class WorkstationIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['WorkstationIamBindingConditionArgs', 'WorkstationIamBindingConditionArgsDict', 'outputs.WorkstationIamBindingCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `workstations.WorkstationIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the workstation are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `workstations.WorkstationIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the workstation are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def __init__(__self__,
        ...
        * {{workstation_id}}
        ...
        :param str resource_name: The name of the resource.
        :param WorkstationIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkstationIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WorkstationIamBindingArgs.__new__(WorkstationIamBindingArgs)
        ...
        super(WorkstationIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            workstation_cluster_id: pulumi.Input[Optional[_builtins.str]] = None,
            workstation_config_id: pulumi.Input[Optional[_builtins.str]] = None,
            workstation_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'WorkstationIamBinding':
        """
        ...
        __props__ = _WorkstationIamBindingState.__new__(_WorkstationIamBindingState)
        ...
        __props__.__dict__["workstation_config_id"] = workstation_config_id
        __props__.__dict__["workstation_id"] = workstation_id
        return WorkstationIamBinding(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.WorkstationIamBindingCondition']]:
        return pulumi.get(self, "condition")
    ...
    @_builtins.property
    @pulumi.getter(name="workstationId")
    def workstation_id(self) -> pulumi.Output[_builtins.str]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "workstation_id")
