...
class AclPolicyRuleArgsDict(TypedDict):
...
class InstanceDesiredUserCreatedEndpointsDesiredUserCreatedEndpointConnectionPscConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] forwarding_rule: The URI of the consumer side forwarding rule.
               Format:
               projects/{project}/regions/{region}/forwardingRules/{forwarding_rule}
        :param pulumi.Input[_builtins.str] ip_address: The IP allocated on the consumer network for the PSC forwarding rule.
...
class InstanceGcsSourceArgs:
    def __init__(__self__, *,
                 uris: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] uris: URIs of the GCS objects to import.
               Example: gs://bucket1/object1, gs://bucket2/folder2/object2
        """
...
class InstancePersistenceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InstancePersistenceConfigAofConfigArgs'] aof_config: Configuration for AOF based persistence.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] mode: Optional. Current persistence mode.
               Possible values:
               DISABLED
               RDB
               AOF
...
class InstancePersistenceConfigRdbConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] rdb_snapshot_period: Optional. Period between RDB snapshots.
               ...
               TWELVE_HOURS
               TWENTY_FOUR_HOURS
        :param pulumi.Input[_builtins.str] rdb_snapshot_start_time: Optional. Time that the first snapshot was/will be attempted, and to which future
               snapshots will be aligned. If not provided, the current time will be
               used.
        """
...
class InstanceStateInfoUpdateInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_engine_version: (Output)
               Output only. Target engine version for the instance.
        :param pulumi.Input[_builtins.str] target_node_type: (Output)
               Output only. Target node type for the instance.
        :param pulumi.Input[_builtins.int] target_replica_count: (Output)
               Output only. Target number of replica nodes per shard for the instance.
        :param pulumi.Input[_builtins.int] target_shard_count: (Output)
               Output only. Target number of shards for the instance.
        """
...
class InstanceZoneDistributionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] mode: Optional. Current zone distribution mode. Defaults to MULTI_ZONE.
               ...
               SINGLE_ZONE
               Possible values are: `MULTI_ZONE`, `SINGLE_ZONE`.
        :param pulumi.Input[_builtins.str] zone: Optional. Defines zone where all resources will be allocated with SINGLE_ZONE mode.
               Ignored for MULTI_ZONE mode.
        """
        if mode is not None:
            pulumi.set(__self__, "mode", mode)
