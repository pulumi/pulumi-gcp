...
class JobArgs:
    def __init__(__self__, *,
                 ...
                 attempt_deadline: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] attempt_deadline: The deadline for job attempts. If the request handler does not respond by this deadline then the request is
        ...
        :param pulumi.Input[builtins.str] description: A human-readable description for the job.
        ...
        :param pulumi.Input['JobPubsubTargetArgs'] pubsub_target: Pub/Sub target
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] region: Region where the scheduler job resides. If it is not provided, this provider will use the provider default.
        :param pulumi.Input['JobRetryConfigArgs'] retry_config: By default, if a job does not complete successfully,
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] schedule: Describes the schedule on which the job will be executed.
        :param pulumi.Input[builtins.str] time_zone: Specifies the time zone to be used in interpreting schedule.
    ...
    def attempt_deadline(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def attempt_deadline(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Job(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schedule: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Job':
        """
    ...
    @property
    @pulumi.getter(name="attemptDeadline")
    def attempt_deadline(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The deadline for job attempts. If the request handler does not respond by this deadline then the request is
        cancelled and the attempt is marked as a DEADLINE_EXCEEDED failure. The failed attempt can be viewed in
        execution logs. Cloud Scheduler will retry the job according to the RetryConfig.
