...
if not MYPY:
    class JobAppEngineHttpTargetArgsDict(TypedDict):
        relative_uri: pulumi.Input[builtins.str]
        """
        The relative URI.
...
class JobAppEngineHttpTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] relative_uri: The relative URI.
               The relative URL must begin with "/" and must be a valid HTTP relative URL.
               It can contain a path, query string arguments, and \\# fragments.
               If the relative URL is empty, then the root path "/" will be used.
               No spaces are allowed, and the maximum length allowed is 2083 characters
        :param pulumi.Input['JobAppEngineHttpTargetAppEngineRoutingArgs'] app_engine_routing: App Engine Routing setting for the job.
               Structure is documented below.
        :param pulumi.Input[builtins.str] body: HTTP request body.
               A request body is allowed only if the HTTP method is POST or PUT.
               It will result in invalid argument error to set a body on a job with an incompatible HttpMethod.
               A base64-encoded string.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: HTTP request headers.
               This map contains the header field names and values.
               Headers can be set when the job is created.
        :param pulumi.Input[builtins.str] http_method: Which HTTP method to use for the request.
        """
    ...
    def relative_uri(self) -> pulumi.Input[builtins.str]:
        """
        The relative URI.
        The relative URL must begin with "/" and must be a valid HTTP relative URL.
        It can contain a path, query string arguments, and \\# fragments.
    ...
    @relative_uri.setter
    def relative_uri(self, value: pulumi.Input[builtins.str]):
...
class JobHttpTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] uri: The full URI path that the request will be sent to.
        :param pulumi.Input[builtins.str] body: HTTP request body.
               A request body is allowed only if the HTTP method is POST, PUT, or PATCH.
               It is an error to set body on a job with an incompatible HttpMethod.
               A base64-encoded string.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: This map contains the header field names and values.
               Repeated headers are not supported, but a header value can contain commas.
        :param pulumi.Input[builtins.str] http_method: Which HTTP method to use for the request.
...
class JobHttpTargetOauthTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_account_email: Service account email to be used for generating OAuth token.
               The service account must be within the same project as the job.
        :param pulumi.Input[builtins.str] scope: OAuth scope to be used for generating OAuth access token. If not specified,
               "https://www.googleapis.com/auth/cloud-platform" will be used.
        """
...
class JobHttpTargetOidcTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_account_email: Service account email to be used for generating OAuth token.
               The service account must be within the same project as the job.
        :param pulumi.Input[builtins.str] audience: Audience to be used when generating OIDC token. If not specified,
               the URI specified in target will be used.
        """
        pulumi.set(__self__, "service_account_email", service_account_email)
...
class JobPubsubTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] topic_name: The full resource name for the Cloud Pub/Sub topic to which
               messages will be published when a job is delivered. ~>**NOTE:**
               The topic name must be in the same format as required by PubSub's
               PublishRequest.name, e.g. `projects/my-project/topics/my-topic`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] attributes: Attributes for PubsubMessage.
               Pubsub message must contain either non-empty data, or at least one attribute.
        :param pulumi.Input[builtins.str] data: The message payload for PubsubMessage.
               Pubsub message must contain either non-empty data, or at least one attribute.
               A base64-encoded string.
        """
...
if not MYPY:
    class JobRetryConfigArgsDict(TypedDict):
        ...
        A duration in seconds with up to nine fractional digits, terminated by 's'.
        """
        min_backoff_duration: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobRetryConfigArgs:
    def __init__(__self__, *,
                 ...
                 min_backoff_duration: Optional[pulumi.Input[builtins.str]] = None,
                 retry_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] max_backoff_duration: The maximum amount of time to wait before retrying a job after it fails.
               A duration in seconds with up to nine fractional digits, terminated by 's'.
        :param pulumi.Input[builtins.int] max_doublings: The time between retries will double maxDoublings times.
               A job's retry interval starts at minBackoffDuration,
               then doubles maxDoublings times, then increases linearly,
               and finally retries retries at intervals of maxBackoffDuration up to retryCount times.
        :param pulumi.Input[builtins.str] max_retry_duration: The time limit for retrying a failed job, measured from time when an execution was first attempted.
               If specified with retryCount, the job will be retried until both limits are reached.
               A duration in seconds with up to nine fractional digits, terminated by 's'.
        :param pulumi.Input[builtins.str] min_backoff_duration: The minimum amount of time to wait before retrying a job after it fails.
               A duration in seconds with up to nine fractional digits, terminated by 's'.
        :param pulumi.Input[builtins.int] retry_count: The number of attempts that the system will make to run a
               job using the exponential backoff procedure described by maxDoublings.
               Values greater than 5 and negative values are not allowed.
        """
    ...
    def min_backoff_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The minimum amount of time to wait before retrying a job after it fails.
        A duration in seconds with up to nine fractional digits, terminated by 's'.
        """
    ...
    def min_backoff_duration(self, value: Optional[pulumi.Input[builtins.str]]):
