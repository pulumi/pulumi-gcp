...
class JobAppEngineHttpTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str relative_uri: The relative URI.
        ...
        :param builtins.str body: HTTP request body.
               A request body is allowed only if the HTTP method is POST or PUT.
               It will result in invalid argument error to set a body on a job with an incompatible HttpMethod.
               A base64-encoded string.
        :param Mapping[str, builtins.str] headers: HTTP request headers.
               This map contains the header field names and values.
               Headers can be set when the job is created.
        :param builtins.str http_method: Which HTTP method to use for the request.
        """
...
class JobHttpTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str uri: The full URI path that the request will be sent to.
        :param builtins.str body: HTTP request body.
               A request body is allowed only if the HTTP method is POST, PUT, or PATCH.
               It is an error to set body on a job with an incompatible HttpMethod.
               A base64-encoded string.
        :param Mapping[str, builtins.str] headers: This map contains the header field names and values.
...
class JobHttpTargetOauthToken(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str scope: OAuth scope to be used for generating OAuth access token. If not specified,
...
class JobHttpTargetOidcToken(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str service_account_email: Service account email to be used for generating OAuth token.
               The service account must be within the same project as the job.
        :param builtins.str audience: Audience to be used when generating OIDC token. If not specified,
...
class JobPubsubTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str topic_name: The full resource name for the Cloud Pub/Sub topic to which
               messages will be published when a job is delivered. ~>**NOTE:**
               The topic name must be in the same format as required by PubSub's
               PublishRequest.name, e.g. `projects/my-project/topics/my-topic`.
        :param Mapping[str, builtins.str] attributes: Attributes for PubsubMessage.
               Pubsub message must contain either non-empty data, or at least one attribute.
        :param builtins.str data: The message payload for PubsubMessage.
               Pubsub message must contain either non-empty data, or at least one attribute.
               A base64-encoded string.
        """
...
class JobRetryConfig(dict):
    ...
    def __init__(__self__, *,
                 max_backoff_duration: Optional[builtins.str] = None,
                 max_doublings: Optional[builtins.int] = None,
                 max_retry_duration: Optional[builtins.str] = None,
                 min_backoff_duration: Optional[builtins.str] = None,
                 retry_count: Optional[builtins.int] = None):
        """
        :param builtins.str max_backoff_duration: The maximum amount of time to wait before retrying a job after it fails.
        ...
        :param builtins.str max_retry_duration: The time limit for retrying a failed job, measured from time when an execution was first attempted.
               If specified with retryCount, the job will be retried until both limits are reached.
               A duration in seconds with up to nine fractional digits, terminated by 's'.
        :param builtins.str min_backoff_duration: The minimum amount of time to wait before retrying a job after it fails.
               A duration in seconds with up to nine fractional digits, terminated by 's'.
        :param builtins.int retry_count: The number of attempts that the system will make to run a
    ...
    def max_backoff_duration(self) -> Optional[builtins.str]:
        """
    ...
    def min_backoff_duration(self) -> Optional[builtins.str]:
        """
