...
class _RepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RepositoryPubsubConfigArgs']]] pubsub_configs: How this repository publishes a change in the repository through Cloud Pub/Sub.
               Keyed by the topic names.
               Structure is documented below.
        :param pulumi.Input[builtins.int] size: The disk usage of the repo, in bytes.
        :param pulumi.Input[builtins.str] url: URL to clone the repository from Google Cloud Source Repositories.
        """
        if create_ignore_already_exists is not None:
            pulumi.set(__self__, "create_ignore_already_exists", create_ignore_already_exists)
        if name is not None:
...
class Repository(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:sourcerepo/repository:Repository"
    ...
    def get(resource_name: str,
            ...
            pubsub_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RepositoryPubsubConfigArgs', 'RepositoryPubsubConfigArgsDict']]]]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'Repository':
        """
