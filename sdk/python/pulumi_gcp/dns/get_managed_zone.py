...
def get_managed_zone(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A unique name for the resource.
    :param builtins.str project: The ID of the project for the Google Cloud DNS zone.  If this is not provided the default project will be used.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_managed_zone_output(name: Optional[pulumi.Input[builtins.str]] = None,
