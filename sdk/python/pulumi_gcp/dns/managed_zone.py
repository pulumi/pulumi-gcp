...
class ManagedZoneArgs:
    def __init__(__self__, *,
                 ...
                 reverse_lookup: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dns_name: The DNS name of this managed zone, for instance "example.com.".
        ...
        :param pulumi.Input['ManagedZoneDnssecConfigArgs'] dnssec_config: DNSSEC configuration
               Structure is documented below.
        :param pulumi.Input[builtins.bool] force_destroy: Set this true to delete all records in the zone.
        :param pulumi.Input['ManagedZoneForwardingConfigArgs'] forwarding_config: The presence for this field indicates that outbound forwarding is enabled
               ...
               to forward to.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs to assign to this ManagedZone.
               
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] name: User assigned name for this resource.
        ...
        :param pulumi.Input[builtins.bool] reverse_lookup: Specifies if this is a managed reverse lookup zone. If true, Cloud DNS will resolve reverse
        ...
        :param pulumi.Input['ManagedZoneServiceDirectoryConfigArgs'] service_directory_config: The presence of this field indicates that this zone is backed by Service Directory. The value of this field contains information related to the namespace associated with the zone.
               Structure is documented below.
        :param pulumi.Input[builtins.str] visibility: The zone's visibility: public zones are exposed to the Internet,
    ...
    def reverse_lookup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reverse_lookup(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ManagedZoneState:
    def __init__(__self__, *,
                 ...
                 forwarding_config: Optional[pulumi.Input['ManagedZoneForwardingConfigArgs']] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 managed_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['ManagedZoneCloudLoggingConfigArgs'] cloud_logging_config: Cloud logging configuration
               Structure is documented below.
        :param pulumi.Input[builtins.str] creation_time: The time that this resource was created on the server.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs to assign to this ManagedZone.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] managed_zone_id: Unique identifier for the resource; defined by the server.
        :param pulumi.Input[builtins.str] name: User assigned name for this resource.
               Must be unique within the project.
               
               - - -
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] name_servers: Delegate your managed_zone to these virtual name servers;
    ...
    def managed_zone_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_zone_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedZone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reverse_lookup: Optional[pulumi.Input[builtins.bool]] = None,
            service_directory_config: Optional[pulumi.Input[Union['ManagedZoneServiceDirectoryConfigArgs', 'ManagedZoneServiceDirectoryConfigArgsDict']]] = None,
            visibility: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedZone':
        """
    ...
    @property
    @pulumi.getter(name="managedZoneId")
    def managed_zone_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier for the resource; defined by the server.
        """
        return pulumi.get(self, "managed_zone_id")
    ...
    @property
    @pulumi.getter(name="reverseLookup")
    def reverse_lookup(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if this is a managed reverse lookup zone. If true, Cloud DNS will resolve reverse
        lookup queries using automatically configured records for VPC resources. This only applies
        to networks listed under `private_visibility_config`.
