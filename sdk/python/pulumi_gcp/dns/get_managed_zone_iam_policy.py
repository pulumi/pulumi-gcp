...
def get_managed_zone_iam_policy(managed_zone: Optional[_builtins.str] = None,
    ...
    :param _builtins.str managed_zone: Used to find the parent resource to bind the IAM policy to
...
def get_managed_zone_iam_policy_output(managed_zone: Optional[pulumi.Input[_builtins.str]] = None,
