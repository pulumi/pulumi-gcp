...
if not MYPY:
    class ManagedZoneCloudLoggingConfigArgsDict(TypedDict):
        enable_logging: pulumi.Input[builtins.bool]
        """
...
class ManagedZoneCloudLoggingConfigArgs:
    def __init__(__self__, *,
                 enable_logging: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enable_logging: If set, enable query logging for this ManagedZone. False by default, making logging opt-in.
        """
        pulumi.set(__self__, "enable_logging", enable_logging)

    @property
    @pulumi.getter(name="enableLogging")
    def enable_logging(self) -> pulumi.Input[builtins.bool]:
        """
        If set, enable query logging for this ManagedZone. False by default, making logging opt-in.
        """
    ...
    def enable_logging(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class ManagedZoneDnssecConfigArgsDict(TypedDict):
        ...
        """
        non_existence: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ManagedZoneDnssecConfigArgs:
    def __init__(__self__, *,
                 ...
                 non_existence: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ManagedZoneDnssecConfigDefaultKeySpecArgs']]] default_key_specs: Specifies parameters that will be used for generating initial DnsKeys
               ...
               default_key_specs can only be updated when the state is `off`.
               Structure is documented below.
        :param pulumi.Input[builtins.str] kind: Identifies what kind of resource this is
        :param pulumi.Input[builtins.str] non_existence: Specifies the mechanism used to provide authenticated denial-of-existence responses.
               non_existence can only be updated when the state is `off`.
               Possible values are: `nsec`, `nsec3`.
        :param pulumi.Input[builtins.str] state: Specifies whether DNSSEC is enabled, and what mode it is in
               Possible values are: `off`, `on`, `transfer`.
        """
    ...
    def non_existence(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the mechanism used to provide authenticated denial-of-existence responses.
        non_existence can only be updated when the state is `off`.
        Possible values are: `nsec`, `nsec3`.
    ...
    def non_existence(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ManagedZoneDnssecConfigDefaultKeySpecArgsDict(TypedDict):
        ...
        """
        key_length: NotRequired[pulumi.Input[builtins.int]]
        """
        Length of the keys in bits
        """
        key_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ManagedZoneDnssecConfigDefaultKeySpecArgs:
    def __init__(__self__, *,
                 ...
                 kind: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] algorithm: String mnemonic specifying the DNSSEC algorithm of this key
               Possible values are: `ecdsap256sha256`, `ecdsap384sha384`, `rsasha1`, `rsasha256`, `rsasha512`.
        :param pulumi.Input[builtins.int] key_length: Length of the keys in bits
        :param pulumi.Input[builtins.str] key_type: Specifies whether this is a key signing key (KSK) or a zone
               signing key (ZSK). Key signing keys have the Secure Entry
               Point flag set and, when active, will only be used to sign
               resource record sets of type DNSKEY. Zone signing keys do
               not have the Secure Entry Point flag set and will be used
...
class ManagedZoneForwardingConfigTargetNameServerArgs:
    ...
    def forwarding_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Forwarding path for this TargetNameServer. If unset or `default` Cloud DNS will make forwarding
        decision based on address ranges, i.e. RFC1918 addresses go to the VPC, Non-RFC1918 addresses go
        to the Internet. When set to `private`, Cloud DNS will always send queries through VPC for this target
...
class ManagedZonePeeringConfigTargetNetworkArgs:
    def __init__(__self__, *,
                 network_url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] network_url: The id or fully qualified URL of the VPC network to forward queries to.
               This should be formatted like `projects/{project}/global/networks/{network}` or
               `https://www.googleapis.com/compute/v1/projects/{project}/global/networks/{network}`
        """
    ...
    def network_url(self) -> pulumi.Input[builtins.str]:
        """
        The id or fully qualified URL of the VPC network to forward queries to.
        This should be formatted like `projects/{project}/global/networks/{network}` or
        `https://www.googleapis.com/compute/v1/projects/{project}/global/networks/{network}`
    ...
    @network_url.setter
    def network_url(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ManagedZonePrivateVisibilityConfigGkeClusterArgsDict(TypedDict):
        gke_cluster_name: pulumi.Input[builtins.str]
        """
...
class ManagedZonePrivateVisibilityConfigGkeClusterArgs:
    def __init__(__self__, *,
                 gke_cluster_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] gke_cluster_name: The resource name of the cluster to bind this ManagedZone to.
               This should be specified in the format like
               `projects/*/locations/*/clusters/*`
        """
    ...
    def gke_cluster_name(self) -> pulumi.Input[builtins.str]:
        """
        The resource name of the cluster to bind this ManagedZone to.
        This should be specified in the format like
        `projects/*/locations/*/clusters/*`
    ...
    def gke_cluster_name(self, value: pulumi.Input[builtins.str]):
...
class ManagedZonePrivateVisibilityConfigNetworkArgs:
    def __init__(__self__, *,
                 network_url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] network_url: The id or fully qualified URL of the VPC network to bind to.
               This should be formatted like `projects/{project}/global/networks/{network}` or
               `https://www.googleapis.com/compute/v1/projects/{project}/global/networks/{network}`
        """
        pulumi.set(__self__, "network_url", network_url)
...
if not MYPY:
    class ManagedZoneServiceDirectoryConfigNamespaceArgsDict(TypedDict):
        namespace_url: pulumi.Input[builtins.str]
        """
...
class ManagedZoneServiceDirectoryConfigNamespaceArgs:
    def __init__(__self__, *,
                 namespace_url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] namespace_url: The fully qualified or partial URL of the service directory namespace that should be
               associated with the zone. This should be formatted like
               `https://servicedirectory.googleapis.com/v1/projects/{project}/locations/{location}/namespaces/{namespace_id}`
               or simply `projects/{project}/locations/{location}/namespaces/{namespace_id}`
               Ignored for `public` visibility zones.
    ...
    def namespace_url(self) -> pulumi.Input[builtins.str]:
        """
        The fully qualified or partial URL of the service directory namespace that should be
        associated with the zone. This should be formatted like
        `https://servicedirectory.googleapis.com/v1/projects/{project}/locations/{location}/namespaces/{namespace_id}`
    ...
    def namespace_url(self, value: pulumi.Input[builtins.str]):
...
class PolicyAlternativeNameServerConfigTargetNameServerArgs:
    def __init__(__self__, *,
                 ...
                 forwarding_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ipv4_address: IPv4 address to forward to.
        :param pulumi.Input[builtins.str] forwarding_path: Forwarding path for this TargetNameServer. If unset or `default` Cloud DNS will make forwarding
               decision based on address ranges, i.e. RFC1918 addresses go to the VPC, Non-RFC1918 addresses go
               to the Internet. When set to `private`, Cloud DNS will always send queries through VPC for this target
               Possible values are: `default`, `private`.
...
if not MYPY:
    class RecordSetRoutingPolicyArgsDict(TypedDict):
        enable_geo_fencing: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        Structure is documented below.
        """
        health_check: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RecordSetRoutingPolicyArgs:
    def __init__(__self__, *,
                 enable_geo_fencing: Optional[pulumi.Input[builtins.bool]] = None,
                 geos: Optional[pulumi.Input[Sequence[pulumi.Input['RecordSetRoutingPolicyGeoArgs']]]] = None,
                 health_check: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_geo_fencing: Specifies whether to enable fencing for geo queries.
        :param pulumi.Input[Sequence[pulumi.Input['RecordSetRoutingPolicyGeoArgs']]] geos: The configuration for Geolocation based routing policy.
               Structure is documented below.
        :param pulumi.Input[builtins.str] health_check: Specifies the health check (used with external endpoints).
    ...
    def enable_geo_fencing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable fencing for geo queries.
        """
    ...
    def enable_geo_fencing(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def health_check(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the health check (used with external endpoints).
        """
    ...
    @health_check.setter
    def health_check(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RecordSetRoutingPolicyGeoArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        rrdatas: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RecordSetRoutingPolicyGeoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] location: The location name defined in Google Cloud.
        :param pulumi.Input['RecordSetRoutingPolicyGeoHealthCheckedTargetsArgs'] health_checked_targets: For A and AAAA types only. The list of targets to be health checked. These can be specified along with `rrdatas` within this item.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rrdatas: Same as `rrdatas` above.
        """
...
if not MYPY:
    class RecordSetRoutingPolicyGeoHealthCheckedTargetsArgsDict(TypedDict):
        external_endpoints: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RecordSetRoutingPolicyGeoHealthCheckedTargetsArgs:
    def __init__(__self__, *,
                 external_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_endpoints: The list of external endpoint addresses to health check.
    ...
    def external_endpoints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of external endpoint addresses to health check.
        """
    ...
    def external_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class RecordSetRoutingPolicyGeoHealthCheckedTargetsInternalLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] ip_address: The frontend IP address of the load balancer.
        :param pulumi.Input[builtins.str] ip_protocol: The configured IP protocol of the load balancer. This value is case-sensitive. Possible values: ["tcp", "udp"]
        :param pulumi.Input[builtins.str] network_url: The fully qualified url of the network in which the load balancer belongs. This should be formatted like `projects/{project}/global/networks/{network}` or `https://www.googleapis.com/compute/v1/projects/{project}/global/networks/{network}`.
        :param pulumi.Input[builtins.str] port: The configured port of the load balancer.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the load balancer belongs.
        :param pulumi.Input[builtins.str] load_balancer_type: The type of load balancer. This value is case-sensitive. Possible values: ["regionalL4ilb", "regionalL7ilb", "globalL7ilb"]
        :param pulumi.Input[builtins.str] region: The region of the load balancer. Only needed for regional load balancers.
        """
...
if not MYPY:
    class RecordSetRoutingPolicyPrimaryBackupArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        enable_geo_fencing_for_backups: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether to enable fencing for backup geo queries.
        """
        trickle_ratio: NotRequired[pulumi.Input[builtins.float]]
        """
...
class RecordSetRoutingPolicyPrimaryBackupArgs:
    def __init__(__self__, *,
                 ...
                 enable_geo_fencing_for_backups: Optional[pulumi.Input[builtins.bool]] = None,
                 trickle_ratio: Optional[pulumi.Input[builtins.float]] = None):
        """
        ...
        :param pulumi.Input['RecordSetRoutingPolicyPrimaryBackupPrimaryArgs'] primary: The list of global primary targets to be health checked.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] enable_geo_fencing_for_backups: Specifies whether to enable fencing for backup geo queries.
        :param pulumi.Input[builtins.float] trickle_ratio: Specifies the percentage of traffic to send to the backup targets even when the primary targets are healthy.
        """
    ...
    def enable_geo_fencing_for_backups(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable fencing for backup geo queries.
        """
    ...
    def enable_geo_fencing_for_backups(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_geo_fencing_for_backups", value)

    @property
    @pulumi.getter(name="trickleRatio")
    def trickle_ratio(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Specifies the percentage of traffic to send to the backup targets even when the primary targets are healthy.
        """
    ...
    def trickle_ratio(self, value: Optional[pulumi.Input[builtins.float]]):
...
class RecordSetRoutingPolicyPrimaryBackupPrimaryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_endpoints: The Internet IP addresses to be health checked.
...
class RecordSetRoutingPolicyWrrArgs:
    def __init__(__self__, *,
                 ...
                 rrdatas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.float] weight: The ratio of traffic routed to the target.
...
class ResponsePolicyNetworkArgs:
    def __init__(__self__, *,
                 network_url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] network_url: The fully qualified URL of the VPC network to bind to.
               This should be formatted like
               `https://www.googleapis.com/compute/v1/projects/{project}/global/networks/{network}`
        """
        pulumi.set(__self__, "network_url", network_url)
...
class ResponsePolicyRuleLocalDataLocalDataArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: For example, www.example.com.
        :param pulumi.Input[builtins.str] type: One of valid DNS resource types.
               Possible values are: `A`, `AAAA`, `CAA`, `CNAME`, `DNSKEY`, `DS`, `HTTPS`, `IPSECVPNKEY`, `MX`, `NAPTR`, `NS`, `PTR`, `SOA`, `SPF`, `SRV`, `SSHFP`, `SVCB`, `TLSA`, `TXT`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rrdatas: As defined in RFC 1035 (section 5) and RFC 1034 (section 3.6.1)
        :param pulumi.Input[builtins.int] ttl: Number of seconds that this ResourceRecordSet can be cached by
               resolvers.
        """
