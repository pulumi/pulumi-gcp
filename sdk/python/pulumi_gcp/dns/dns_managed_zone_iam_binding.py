...
__all__ = ['DnsManagedZoneIamBindingArgs', 'DnsManagedZoneIamBinding']
...
class DnsManagedZoneIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['DnsManagedZoneIamBindingConditionArgs']] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a DnsManagedZoneIamBinding resource.

        :param pulumi.Input[_builtins.str] managed_zone: Used to find the parent resource to bind the IAM policy to
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `dns.DnsManagedZoneIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        :param pulumi.Input['DnsManagedZoneIamBindingConditionArgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['DnsManagedZoneIamBindingConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['DnsManagedZoneIamBindingConditionArgs']]):
...
@pulumi.input_type
class _DnsManagedZoneIamBindingState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['DnsManagedZoneIamBindingConditionArgs']] = None,
...
class DnsManagedZoneIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['DnsManagedZoneIamBindingConditionArgs', 'DnsManagedZoneIamBindingConditionArgsDict', 'outputs.DnsManagedZoneIamBindingCondition']]] = None,
                 managed_zone: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `dns.DnsManagedZoneIamBinding`: Authoritative for a given role and condition combination (the condition can be omitted). Updates the IAM policy to grant a role to a list of members. Other role and condition combinations within the IAM policy for the managedzone are preserved. Members added outside of Terraform for the same role and condition combination will be detected as drift and removed on the next `pulumi up`.
        * `dns.DnsManagedZoneIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the managedzone are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `dns.DnsManagedZoneIamPolicy`: Retrieves the IAM policy for the managedzone
        ...
        > **Note:** `dns.DnsManagedZoneIamBinding` resources **can be** used in conjunction with `dns.DnsManagedZoneIamMember` resources **only if** they do not grant privilege to the same role and condition combination.
        ...
        * {{managed_zone}}
        ...
        :param pulumi.Input[Union['DnsManagedZoneIamBindingConditionArgs', 'DnsManagedZoneIamBindingConditionArgsDict', 'outputs.DnsManagedZoneIamBindingCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] managed_zone: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] members: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
    ...
    def __init__(__self__,
        ...
        * {{managed_zone}}
        ...
        :param str resource_name: The name of the resource.
        :param DnsManagedZoneIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnsManagedZoneIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(DnsManagedZoneIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'DnsManagedZoneIamBinding':
        """
        ...
        __props__ = _DnsManagedZoneIamBindingState.__new__(_DnsManagedZoneIamBindingState)
        ...
        __props__.__dict__["project"] = project
        __props__.__dict__["role"] = role
        return DnsManagedZoneIamBinding(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.DnsManagedZoneIamBindingCondition']]:
        """
        An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        Structure is documented below.
        """
