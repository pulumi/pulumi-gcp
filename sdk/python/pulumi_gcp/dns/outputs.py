...
class ManagedZoneCloudLoggingConfig(dict):
    ...
    def __init__(__self__, *,
                 enable_logging: _builtins.bool):
        """
        :param _builtins.bool enable_logging: If set, enable query logging for this ManagedZone. False by default, making logging opt-in.
        """
...
class ManagedZoneDnssecConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 non_existence: Optional[_builtins.str] = None,
        ...
        :param _builtins.str kind: Identifies what kind of resource this is
        :param _builtins.str non_existence: Specifies the mechanism used to provide authenticated denial-of-existence responses.
               non_existence can only be updated when the state is `off`.
               Possible values are: `nsec`, `nsec3`.
        :param _builtins.str state: Specifies whether DNSSEC is enabled, and what mode it is in
...
class ManagedZoneDnssecConfigDefaultKeySpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kind: Optional[_builtins.str] = None):
        """
        :param _builtins.str algorithm: String mnemonic specifying the DNSSEC algorithm of this key
               Possible values are: `ecdsap256sha256`, `ecdsap384sha384`, `rsasha1`, `rsasha256`, `rsasha512`.
        :param _builtins.int key_length: Length of the keys in bits
        :param _builtins.str key_type: Specifies whether this is a key signing key (KSK) or a zone
...
class ManagedZonePeeringConfigTargetNetwork(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str network_url: The id or fully qualified URL of the VPC network to forward queries to.
...
class ManagedZonePrivateVisibilityConfigGkeCluster(dict):
    ...
    def __init__(__self__, *,
                 gke_cluster_name: _builtins.str):
        """
        :param _builtins.str gke_cluster_name: The resource name of the cluster to bind this ManagedZone to.
...
class ManagedZonePrivateVisibilityConfigNetwork(dict):
    ...
    def __init__(__self__, *,
                 network_url: _builtins.str):
        """
        :param _builtins.str network_url: The id or fully qualified URL of the VPC network to bind to.
               This should be formatted like `projects/{project}/global/networks/{network}` or
               `https://www.googleapis.com/compute/v1/projects/{project}/global/networks/{network}`
        """
        pulumi.set(__self__, "network_url", network_url)
...
class ManagedZoneServiceDirectoryConfigNamespace(dict):
    ...
    def __init__(__self__, *,
                 namespace_url: _builtins.str):
        """
        :param _builtins.str namespace_url: The fully qualified or partial URL of the service directory namespace that should be
...
class PolicyAlternativeNameServerConfigTargetNameServer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 forwarding_path: Optional[_builtins.str] = None):
        """
        :param _builtins.str ipv4_address: IPv4 address to forward to.
...
class PolicyDns64ConfigScope(dict):
    ...
    def __init__(__self__, *,
                 all_queries: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool all_queries: Controls whether DNS64 is enabled globally at the network level.
        """
...
class RecordSetRoutingPolicy(dict):
    ...
    def __init__(__self__, *,
                 enable_geo_fencing: Optional[_builtins.bool] = None,
        ...
        """
        :param _builtins.bool enable_geo_fencing: Specifies whether to enable fencing for geo queries.
        :param Sequence['RecordSetRoutingPolicyGeoArgs'] geos: The configuration for Geolocation based routing policy.
               Structure is documented below.
        :param _builtins.str health_check: Specifies the health check (used with external endpoints).
...
class RecordSetRoutingPolicyGeo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rrdatas: Optional[Sequence[_builtins.str]] = None):
        """
        ...
        :param 'RecordSetRoutingPolicyGeoHealthCheckedTargetsArgs' health_checked_targets: For A and AAAA types only. The list of targets to be health checked. These can be specified along with `rrdatas` within this item.
               Structure is documented below.
        :param Sequence[_builtins.str] rrdatas: Same as `rrdatas` above.
        """
...
class RecordSetRoutingPolicyGeoHealthCheckedTargets(dict):
    ...
    def __init__(__self__, *,
                 external_endpoints: Optional[Sequence[_builtins.str]] = None,
                 internal_load_balancers: Optional[Sequence['outputs.RecordSetRoutingPolicyGeoHealthCheckedTargetsInternalLoadBalancer']] = None):
        """
        :param Sequence[_builtins.str] external_endpoints: The list of external endpoint addresses to health check.
...
class RecordSetRoutingPolicyGeoHealthCheckedTargetsInternalLoadBalancer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ip_address: The frontend IP address of the load balancer.
        :param _builtins.str ip_protocol: The configured IP protocol of the load balancer. This value is case-sensitive. Possible values: ["tcp", "udp"]
        :param _builtins.str network_url: The fully qualified url of the network in which the load balancer belongs. This should be formatted like `projects/{project}/global/networks/{network}` or `https://www.googleapis.com/compute/v1/projects/{project}/global/networks/{network}`.
        :param _builtins.str port: The configured port of the load balancer.
        :param _builtins.str project: The ID of the project in which the load balancer belongs.
        :param _builtins.str load_balancer_type: The type of load balancer. This value is case-sensitive. Possible values: ["regionalL4ilb", "regionalL7ilb", "globalL7ilb"]
        :param _builtins.str region: The region of the load balancer. Only needed for regional load balancers.
        """
...
class RecordSetRoutingPolicyPrimaryBackup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_geo_fencing_for_backups: Optional[_builtins.bool] = None,
                 trickle_ratio: Optional[_builtins.float] = None):
        """
        ...
        :param 'RecordSetRoutingPolicyPrimaryBackupPrimaryArgs' primary: The list of global primary targets to be health checked.
               Structure is documented below.
        :param _builtins.bool enable_geo_fencing_for_backups: Specifies whether to enable fencing for backup geo queries.
        :param _builtins.float trickle_ratio: Specifies the percentage of traffic to send to the backup targets even when the primary targets are healthy.
        """
...
class RecordSetRoutingPolicyPrimaryBackupPrimary(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] external_endpoints: The Internet IP addresses to be health checked.
...
class RecordSetRoutingPolicyWrr(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rrdatas: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.float weight: The ratio of traffic routed to the target.
...
class ResponsePolicyNetwork(dict):
    ...
    def __init__(__self__, *,
                 network_url: _builtins.str):
        """
        :param _builtins.str network_url: The fully qualified URL of the VPC network to bind to.
...
class ResponsePolicyRuleLocalDataLocalData(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: For example, www.example.com.
        :param _builtins.str type: One of valid DNS resource types.
               Possible values are: `A`, `AAAA`, `CAA`, `CNAME`, `DNSKEY`, `DS`, `HTTPS`, `IPSECVPNKEY`, `MX`, `NAPTR`, `NS`, `PTR`, `SOA`, `SPF`, `SRV`, `SSHFP`, `SVCB`, `TLSA`, `TXT`.
        :param Sequence[_builtins.str] rrdatas: As defined in RFC 1035 (section 5) and RFC 1034 (section 3.6.1)
        :param _builtins.int ttl: Number of seconds that this ResourceRecordSet can be cached by
               resolvers.
        """
...
class GetKeysKeySigningKeyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str algorithm: String mnemonic specifying the DNSSEC algorithm of this key. Immutable after creation time. Possible values are `ecdsap256sha256`, `ecdsap384sha384`, `rsasha1`, `rsasha256`, and `rsasha512`.
        :param _builtins.str creation_time: The time that this resource was created in the control plane. This is in RFC3339 text format.
        :param _builtins.str description: A mutable string of at most 1024 characters associated with this resource for the user's convenience.
        ...
        :param _builtins.str ds_record: The DS record based on the KSK record. This is used when [delegating](https://cloud.google.com/dns/docs/dnssec-advanced#subdelegation) DNSSEC-signed subdomains.
        :param _builtins.str id: Unique identifier for the resource; defined by the server.
        :param _builtins.bool is_active: Active keys will be used to sign subsequent changes to the ManagedZone. Inactive keys will still be present as DNSKEY Resource Records for the use of resolvers validating existing signatures.
        :param _builtins.int key_length: Length of the key in bits. Specified at creation time then immutable.
        :param _builtins.int key_tag: The key tag is a non-cryptographic hash of the a DNSKEY resource record associated with this DnsKey. The key tag can be used to identify a DNSKEY more quickly (but it is not a unique identifier). In particular, the key tag is used in a parent zone's DS record to point at the DNSKEY in this child ManagedZone. The key tag is a number in the range [0, 65535] and the algorithm to calculate it is specified in RFC4034 Appendix B.
        :param _builtins.str public_key: Base64 encoded public half of this key.
        """
        pulumi.set(__self__, "algorithm", algorithm)
...
class GetKeysKeySigningKeyDigestResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str digest: The base-16 encoded bytes of this digest. Suitable for use in a DS resource record.
        :param _builtins.str type: Specifies the algorithm used to calculate this digest. Possible values are `sha1`, `sha256` and `sha384`
        """
