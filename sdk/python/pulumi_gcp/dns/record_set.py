...
class RecordSetArgs:
    def __init__(__self__, *,
                 managed_zone: pulumi.Input[builtins.str],
                 name: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 routing_policy: Optional[pulumi.Input['RecordSetRoutingPolicyArgs']] = None,
                 rrdatas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a RecordSet resource.
        :param pulumi.Input[builtins.str] managed_zone: The name of the zone in which this record set will
               reside.
    ...
    def managed_zone(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @managed_zone.setter
    def managed_zone(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def rrdatas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "rrdatas")

    @rrdatas.setter
    def rrdatas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _RecordSetState:
    def __init__(__self__, *,
                 managed_zone: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="managedZone")
    def managed_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the zone in which this record set will
        reside.
        """
    ...
    @managed_zone.setter
    def managed_zone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_zone", value)
...
class RecordSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rrdatas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'RecordSet':
        """
    ...
    @property
    @pulumi.getter(name="managedZone")
    def managed_zone(self) -> pulumi.Output[builtins.str]:
        """
        The name of the zone in which this record set will
        reside.
        """
    ...
    @property
    @pulumi.getter
    def rrdatas(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "rrdatas")
