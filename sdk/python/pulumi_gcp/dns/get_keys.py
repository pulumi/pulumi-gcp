...
def get_keys(managed_zone: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_zone: The name or id of the Cloud DNS managed zone.
...
def get_keys_output(managed_zone: Optional[pulumi.Input[builtins.str]] = None,
