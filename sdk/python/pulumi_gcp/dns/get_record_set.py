...
class GetRecordSetResult:
    ...
    @property
    @pulumi.getter
    def rrdatas(self) -> Sequence[builtins.str]:
        """
...
def get_record_set(managed_zone: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_zone: The Name of the zone.
    :param builtins.str name: The DNS name for the resource.
    :param builtins.str project: The ID of the project for the Google Cloud.
    :param builtins.str type: The RRSet type. [See this table for supported types](https://cloud.google.com/dns/docs/records#record_type).
    """
    __args__ = dict()
...
def get_record_set_output(managed_zone: Optional[pulumi.Input[builtins.str]] = None,
