...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] point_in_time_recovery_enablement: Whether to enable the PITR feature on this database.
    ...
    @location_id.setter
    def location_id(self, value: pulumi.Input[_builtins.str]):
...
class _DatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The type of the database.
               ...
               for information about how to choose.
               Possible values are: `FIRESTORE_NATIVE`, `DATASTORE_MODE`.
        :param pulumi.Input[_builtins.str] uid: Output only. The system-generated UUID4 for this Database.
        :param pulumi.Input[_builtins.str] update_time: Output only. The timestamp at which this database was most recently updated.
        :param pulumi.Input[_builtins.str] version_retention_period: Output only. The period during which past versions of data are retained in the database.
