...
calass FieldArrgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FieldTtlConfigArrgs'] ttl_config: The TTL configuration for this Field. If set to an empty block (i.e. `ttl_config {}`), a TTL policy is configured based on the field. If unset, a TTL policy is not configured (or will be disabled upon updating the resource).
               Structure is documented below.
        """
...
calass Field(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * How-to Guides
        ...
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[pulumi.InputType['FieldTtlConfigArrgs']] ttl_config: The TTL configuration for this Field. If set to an empty block (i.e. `ttl_config {}`), a TTL policy is configured based on the field. If unset, a TTL policy is not configured (or will be disabled upon updating the resource).
               Structure is documented below.
        """
        ...
    @overload
