...
def get_token(identifier: Optional[_builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param _builtins.str type: The type of resource to be verified, either a domain or a web site.
           Possible values are: `INET_DOMAIN`, `SITE`.
    :param _builtins.str verification_method: The verification method for the Site Verification system to use to verify
           this site or domain.
