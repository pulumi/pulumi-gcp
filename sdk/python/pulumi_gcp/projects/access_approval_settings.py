...
class AccessApprovalSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_id: ID of the project of the access approval settings.
        ...
        :param pulumi.Input[_builtins.str] project: (Optional, Deprecated)
               Project id.
...
class _AccessApprovalSettingsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The resource name of the settings. Format is "projects/{project_id}/accessApprovalSettings"
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] notification_emails: A list of email addresses to which notifications relating to approval requests should be sent.
               Notifications relating to a resource will be sent to all emails in the settings of ancestor
               resources of that resource. A maximum of 50 email addresses are allowed.
        :param pulumi.Input[_builtins.str] project: (Optional, Deprecated)
