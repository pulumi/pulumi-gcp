...
class UsageExportBucketArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket_name: The bucket to store reports in.
               
               - - -
        :param pulumi.Input[builtins.str] prefix: A prefix for the reports, for instance, the project name.
        :param pulumi.Input[builtins.str] project: The project to set the export bucket on. If it is not provided, the provider project is used.
        """
...
class UsageExportBucket(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bucket_name: Optional[pulumi.Input[builtins.str]] = None,
            prefix: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'UsageExportBucket':
        """
