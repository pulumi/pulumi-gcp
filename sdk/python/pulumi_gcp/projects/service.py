...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 check_if_service_has_usage_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_dependent_services: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Service resource.
        :param pulumi.Input[builtins.str] service: The service to enable.
        :param pulumi.Input[builtins.bool] check_if_service_has_usage_on_destroy: Beta
               If `true`, the usage of the service to be disabled will be checked and an error
               will be returned if the service to be disabled has usage in last 30 days.
               Defaults to `false`.
        :param pulumi.Input[builtins.bool] disable_dependent_services: If `true`, services that are enabled
               and which depend on this service should also be disabled when this service is
               destroyed. If `false` or unset, an error will be generated if any enabled
               services depend on this service when destroying it.
        :param pulumi.Input[builtins.str] project: The project ID. If not provided, the provider project
               is used.
        """
    ...
    def check_if_service_has_usage_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Beta
        If `true`, the usage of the service to be disabled will be checked and an error
        will be returned if the service to be disabled has usage in last 30 days.
    ...
    def check_if_service_has_usage_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "check_if_service_has_usage_on_destroy", value)

    @property
    @pulumi.getter(name="disableDependentServices")
    def disable_dependent_services(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_dependent_services(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_dependent_services", value)

    @property
    @pulumi.getter(name="disableOnDestroy")
    def disable_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "disable_on_destroy")

    @disable_on_destroy.setter
    def disable_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            disable_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None) -> 'Service':
        """
    ...
    @property
    @pulumi.getter(name="checkIfServiceHasUsageOnDestroy")
    def check_if_service_has_usage_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Beta
        If `true`, the usage of the service to be disabled will be checked and an error
        will be returned if the service to be disabled has usage in last 30 days.
    ...
    @property
    @pulumi.getter(name="disableDependentServices")
    def disable_dependent_services(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true`, services that are enabled
        and which depend on this service should also be disabled when this service is
        destroyed. If `false` or unset, an error will be generated if any enabled
    ...
    @property
    @pulumi.getter(name="disableOnDestroy")
    def disable_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "disable_on_destroy")
