...
def get_project_service(project: Optional[builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param builtins.str service: The name of the Google Platform project service.
...
def get_project_service_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
