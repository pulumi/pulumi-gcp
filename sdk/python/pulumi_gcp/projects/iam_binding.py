...
class IAMBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] members: Identities that will be granted the privilege in `role`. projects.IAMBinding expects `members` field while projects.IAMMember expects `member` field.
...
@pulumi.type_token("gcp:projects/iAMBinding:IAMBinding")
class IAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `projects.IAMAuditConfig`: Authoritative for a given service. Updates the IAM policy to enable audit logging for the given service.
        ...
        :param pulumi.Input[Union['IAMBindingConditionArgs', 'IAMBindingConditionArgsDict', 'outputs.IAMBindingCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] members: Identities that will be granted the privilege in `role`. projects.IAMBinding expects `members` field while projects.IAMMember expects `member` field.
               Each entry can have one of the following values:
               * **user:{emailid}**: An email address that represents a specific Google account. For example, alice@gmail.com or joe@example.com.
    ...
    def get(resource_name: str,
            ...
            members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'IAMBinding':
        """
