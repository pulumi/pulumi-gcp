...
def get_iam_policy(project: Optional[builtins.str] = None,
    ...
    :param builtins.str project: The project id of the target project. This is not
...
def get_iam_policy_output(project: Optional[pulumi.Input[builtins.str]] = None,
