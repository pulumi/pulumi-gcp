...
if not MYPY:
    class AccessApprovalSettingsEnrolledServiceArgsDict(TypedDict):
        cloud_product: pulumi.Input[builtins.str]
        """
        ...
        """
        enrollment_level: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AccessApprovalSettingsEnrolledServiceArgs:
    def __init__(__self__, *,
                 cloud_product: pulumi.Input[builtins.str],
                 enrollment_level: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cloud_product: The product for which Access Approval will be enrolled. Allowed values are listed (case-sensitive):
               all
               appengine.googleapis.com
               bigquery.googleapis.com
               bigtable.googleapis.com
    ...
    def cloud_product(self) -> pulumi.Input[builtins.str]:
        """
        The product for which Access Approval will be enrolled. Allowed values are listed (case-sensitive):
        all
        appengine.googleapis.com
    ...
    def cloud_product(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cloud_product", value)

    @property
    @pulumi.getter(name="enrollmentLevel")
    def enrollment_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The enrollment level of the service.
        Default value is `BLOCK_ALL`.
        Possible values are: `BLOCK_ALL`.
    ...
    def enrollment_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApiKeyRestrictionsAndroidKeyRestrictionsAllowedApplicationArgs:
    ...
    def sha1_fingerprint(self, value: pulumi.Input[builtins.str]):
...
class ApiKeyRestrictionsApiTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] service: The service for this restriction. It should be the canonical service name, for example: `translate.googleapis.com`. You can use `gcloud services list` to get a list of services that are enabled in the project.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] methods: Optional. List of one or more methods that can be called. If empty, all methods for the service are allowed. A wildcard (*) can be used as the last symbol. Valid examples: `google.cloud.translate.v2.TranslateService.GetSupportedLanguage` `TranslateText` `Get*` `translate.googleapis.com.Get*`
        """
...
if not MYPY:
    class ApiKeyRestrictionsBrowserKeyRestrictionsArgsDict(TypedDict):
        allowed_referrers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ApiKeyRestrictionsBrowserKeyRestrictionsArgs:
    def __init__(__self__, *,
                 allowed_referrers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_referrers: A list of regular expressions for the referrer URLs that are allowed to make API calls with this key.
        """
        pulumi.set(__self__, "allowed_referrers", allowed_referrers)

    @property
    @pulumi.getter(name="allowedReferrers")
    def allowed_referrers(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of regular expressions for the referrer URLs that are allowed to make API calls with this key.
        """
    ...
    def allowed_referrers(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "allowed_referrers", value)


if not MYPY:
    class ApiKeyRestrictionsIosKeyRestrictionsArgsDict(TypedDict):
        allowed_bundle_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ApiKeyRestrictionsIosKeyRestrictionsArgs:
    def __init__(__self__, *,
                 allowed_bundle_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_bundle_ids: A list of bundle IDs that are allowed when making API calls with this key.
        """
        pulumi.set(__self__, "allowed_bundle_ids", allowed_bundle_ids)

    @property
    @pulumi.getter(name="allowedBundleIds")
    def allowed_bundle_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of bundle IDs that are allowed when making API calls with this key.
        """
    ...
    def allowed_bundle_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "allowed_bundle_ids", value)


if not MYPY:
    class ApiKeyRestrictionsServerKeyRestrictionsArgsDict(TypedDict):
        allowed_ips: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ApiKeyRestrictionsServerKeyRestrictionsArgs:
    def __init__(__self__, *,
                 allowed_ips: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_ips: A list of the caller IP addresses that are allowed to make API calls with this key.
        """
        pulumi.set(__self__, "allowed_ips", allowed_ips)

    @property
    @pulumi.getter(name="allowedIps")
    def allowed_ips(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of the caller IP addresses that are allowed to make API calls with this key.
        """
    ...
    @allowed_ips.setter
    def allowed_ips(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class IAMAuditConfigAuditLogConfigArgsDict(TypedDict):
        ...
        """
        exempted_members: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class IAMAuditConfigAuditLogConfigArgs:
    def __init__(__self__, *,
                 log_type: pulumi.Input[builtins.str],
                 exempted_members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] log_type: Permission type for which logging is to be configured.  Must be one of `DATA_READ`, `DATA_WRITE`, or `ADMIN_READ`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exempted_members: Identities that do not cause logging for this type of permission.  The format is the same as that for `members`.
        """
    ...
    def exempted_members(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Identities that do not cause logging for this type of permission.  The format is the same as that for `members`.
        """
    ...
    def exempted_members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class OrganizationPolicyBooleanPolicyArgsDict(TypedDict):
        enforced: pulumi.Input[builtins.bool]
        """
...
class OrganizationPolicyBooleanPolicyArgs:
    def __init__(__self__, *,
                 enforced: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enforced: If true, then the Policy is enforced. If false, then any configuration is acceptable.
        """
        pulumi.set(__self__, "enforced", enforced)

    @property
    @pulumi.getter
    def enforced(self) -> pulumi.Input[builtins.bool]:
        """
        If true, then the Policy is enforced. If false, then any configuration is acceptable.
        """
    ...
    @enforced.setter
    def enforced(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class OrganizationPolicyListPolicyArgsDict(TypedDict):
        ...
        """
        inherit_from_parent: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        suggested_value: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OrganizationPolicyListPolicyArgs:
    def __init__(__self__, *,
                 ...
                 suggested_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] inherit_from_parent: If set to true, the values from the effective Policy of the parent resource
               are inherited, meaning the values set in this Policy are added to the values inherited up the hierarchy.
               
               The `allow` or `deny` blocks support:
        :param pulumi.Input[builtins.str] suggested_value: The Google Cloud Console will try to default to a configuration that matches the value specified in this field.
        """
    ...
    def suggested_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Google Cloud Console will try to default to a configuration that matches the value specified in this field.
        """
    ...
    def suggested_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OrganizationPolicyListPolicyAllowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] all: The policy allows or denies all values.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The policy can define specific values that are allowed or denied.
        """
        if all is not None:
...
if not MYPY:
    class OrganizationPolicyRestorePolicyArgsDict(TypedDict):
        default: pulumi.Input[builtins.bool]
        """
...
class OrganizationPolicyRestorePolicyArgs:
    def __init__(__self__, *,
                 default: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] default: May only be set to true. If set, then the default Policy is restored.
        """
        pulumi.set(__self__, "default", default)

    @property
    @pulumi.getter
    def default(self) -> pulumi.Input[builtins.bool]:
        """
        May only be set to true. If set, then the default Policy is restored.
        """
    ...
    @default.setter
    def default(self, value: pulumi.Input[builtins.bool]):
