...
class AccessApprovalSettingsEnrolledService(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enrollment_level: Optional[_builtins.str] = None):
        """
        :param _builtins.str cloud_product: The product for which Access Approval will be enrolled. Allowed values are listed (case-sensitive):
               all
        ...
        :param _builtins.str enrollment_level: The enrollment level of the service.
...
class ApiKeyRestrictionsAndroidKeyRestrictionsAllowedApplication(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str package_name: The package name of the application.
        :param _builtins.str sha1_fingerprint: The SHA1 fingerprint of the application. For example, both sha1 formats are acceptable : DA:39:A3:EE:5E:6B:4B:0D:32:55:BF:EF:95:60:18:90:AF:D8:07:09 or DA39A3EE5E6B4B0D3255BFEF95601890AFD80709. Output format is the latter.
        """
...
class ApiKeyRestrictionsApiTarget(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str service: The service for this restriction. It should be the canonical service name, for example: `translate.googleapis.com`. You can use `gcloud services list` to get a list of services that are enabled in the project.
        :param Sequence[_builtins.str] methods: Optional. List of one or more methods that can be called. If empty, all methods for the service are allowed. A wildcard (*) can be used as the last symbol. Valid examples: `google.cloud.translate.v2.TranslateService.GetSupportedLanguage` `TranslateText` `Get*` `translate.googleapis.com.Get*`
        """
...
class ApiKeyRestrictionsBrowserKeyRestrictions(dict):
    ...
    def __init__(__self__, *,
                 allowed_referrers: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] allowed_referrers: A list of regular expressions for the referrer URLs that are allowed to make API calls with this key.
        """
...
class ApiKeyRestrictionsIosKeyRestrictions(dict):
    ...
    def __init__(__self__, *,
                 allowed_bundle_ids: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] allowed_bundle_ids: A list of bundle IDs that are allowed when making API calls with this key.
        """
...
class ApiKeyRestrictionsServerKeyRestrictions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] allowed_ips: A list of the caller IP addresses that are allowed to make API calls with this key.
        """
...
class OrganizationPolicyBooleanPolicy(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enforced: If true, then the Policy is enforced. If false, then any configuration is acceptable.
        """
...
class OrganizationPolicyListPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 inherit_from_parent: Optional[_builtins.bool] = None,
                 suggested_value: Optional[_builtins.str] = None):
        """
        ...
        :param _builtins.bool inherit_from_parent: If set to true, the values from the effective Policy of the parent resource
               are inherited, meaning the values set in this Policy are added to the values inherited up the hierarchy.
               
               The `allow` or `deny` blocks support:
        :param _builtins.str suggested_value: The Google Cloud Console will try to default to a configuration that matches the value specified in this field.
        """
...
class OrganizationPolicyListPolicyAllow(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool all: The policy allows or denies all values.
        :param Sequence[_builtins.str] values: The policy can define specific values that are allowed or denied.
        """
        if all is not None:
...
class OrganizationPolicyRestorePolicy(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool default: May only be set to true. If set, then the default Policy is restored.
        """
...
class GetAncestryAncestorResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.str id: If it's a project, the `project_id` is exported, else the numeric folder id or organization id.
        :param _builtins.str type: One of `"project"`, `"folder"` or `"organization"`.
        """
...
class GetIamCustomRolesRoleResult(dict):
    def __init__(__self__, *,
                 ...
                 title: _builtins.str):
        """
        :param _builtins.bool deleted: The current deleted state of the role.
        :param _builtins.str description: A human-readable description for the role.
        :param _builtins.str id: an identifier for the resource with the format `projects/{{project}}/roles/{{role_id}}`.
        :param _builtins.str name: The name of the role in the format `projects/{{project}}/roles/{{role_id}}`. Like `id`, this field can be used as a reference in other resources such as IAM role bindings.
        :param Sequence[_builtins.str] permissions: The names of the permissions this role grants when bound in an IAM policy.
        :param _builtins.str role_id: The camel case role id used for this role.
        :param _builtins.str stage: The current launch stage of the role. List of possible stages is [here](https://cloud.google.com/iam/reference/rest/v1/organizations.roles#Role.RoleLaunchStage).
        :param _builtins.str title: A human-readable title for the role.
        """
...
class GetOrganizationPolicyListPolicyResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.bool inherit_from_parent: If set to true, the values from the effective Policy of the parent resource are inherited, meaning the values set in this Policy are added to the values inherited up the hierarchy.
        :param _builtins.str suggested_value: The Google Cloud Console will try to default to a configuration that matches the value specified in this field.
        """
...
class GetProjectProjectResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str create_time: Creation time in RFC3339 UTC "Zulu" format.
        :param Mapping[str, _builtins.str] labels: A set of key/value label pairs assigned on a project.
        :param _builtins.str lifecycle_state: The Project lifecycle state.
        :param _builtins.str name: The optional user-assigned display name of the project.
        :param _builtins.str number: The numeric identifier of the project.
        :param Mapping[str, _builtins.str] parent: An optional reference to a parent resource.
        :param _builtins.str project_id: The project id of the project.
        """
