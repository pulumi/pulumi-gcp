...
class OrganizationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 boolean_policy: pulumi.Input[Optional[Union['OrganizationPolicyBooleanPolicyArgs', 'OrganizationPolicyBooleanPolicyArgsDict', 'outputs.OrganizationPolicyBooleanPolicy']]] = None,
                 constraint: pulumi.Input[Optional[_builtins.str]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 list_policy: pulumi.Input[Optional[Union['OrganizationPolicyListPolicyArgs', 'OrganizationPolicyListPolicyArgsDict', 'outputs.OrganizationPolicyListPolicy']]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 restore_policy: pulumi.Input[Optional[Union['OrganizationPolicyRestorePolicyArgs', 'OrganizationPolicyRestorePolicyArgsDict', 'outputs.OrganizationPolicyRestorePolicy']]] = None,
                 version: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        """
        ...
        * `{{project_id}}:{{constraint}}`
        ...
        :param pulumi.Input[Union['OrganizationPolicyBooleanPolicyArgs', 'OrganizationPolicyBooleanPolicyArgsDict', 'outputs.OrganizationPolicyBooleanPolicy']] boolean_policy: A boolean policy is a constraint that is either enforced or not. Structure is documented below.
        :param pulumi.Input[_builtins.str] constraint: The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://docs.cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to "DELETE".
               ...
               ***
        :param pulumi.Input[Union['OrganizationPolicyListPolicyArgs', 'OrganizationPolicyListPolicyArgsDict', 'outputs.OrganizationPolicyListPolicy']] list_policy: A policy that can define specific values that are allowed or denied for the given constraint. It can also be used to allow or deny all values. Structure is documented below.
        :param pulumi.Input[_builtins.str] project: The project id of the project to set the policy for.
        :param pulumi.Input[Union['OrganizationPolicyRestorePolicyArgs', 'OrganizationPolicyRestorePolicyArgsDict', 'outputs.OrganizationPolicyRestorePolicy']] restore_policy: A restore policy is a constraint to restore the default policy. Structure is documented below.
