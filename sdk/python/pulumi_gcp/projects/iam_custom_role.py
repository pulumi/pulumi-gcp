...
class IAMCustomRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permissions: The names of the permissions this role grants when bound in an IAM policy. At least one permission must be specified.
        :param pulumi.Input[builtins.str] title: A human-readable title for the role.
        :param pulumi.Input[builtins.str] description: A human-readable description for the role.
        :param pulumi.Input[builtins.str] project: The project that the custom role will be created in.
               Defaults to the provider project configuration.
        :param pulumi.Input[builtins.str] role_id: The camel case role id to use for this role. Cannot contain `-` characters.
        :param pulumi.Input[builtins.str] stage: The current launch stage of the role.
               Defaults to `GA`.
...
class _IAMCustomRoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] deleted: (Optional) The current deleted state of the role.
        :param pulumi.Input[builtins.str] description: A human-readable description for the role.
        :param pulumi.Input[builtins.str] name: The name of the role in the format `projects/{{project}}/roles/{{role_id}}`. Like `id`, this field can be used as a reference in other resources such as IAM role bindings.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permissions: The names of the permissions this role grants when bound in an IAM policy. At least one permission must be specified.
        :param pulumi.Input[builtins.str] project: The project that the custom role will be created in.
               Defaults to the provider project configuration.
        :param pulumi.Input[builtins.str] role_id: The camel case role id to use for this role. Cannot contain `-` characters.
...
class IAMCustomRole(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:projects/iAMCustomRole:IAMCustomRole"
    ...
    def get(resource_name: str,
            ...
            role_id: Optional[pulumi.Input[builtins.str]] = None,
            stage: Optional[pulumi.Input[builtins.str]] = None,
            title: Optional[pulumi.Input[builtins.str]] = None) -> 'IAMCustomRole':
        """
