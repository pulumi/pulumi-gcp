...
def get_iam_custom_roles(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project: The project were the custom role has been created in. Defaults to the provider project configuration.
    :param _builtins.bool show_deleted: Include Roles that have been deleted. Defaults to `false`.
    :param _builtins.str view: When `"FULL"` is specified, the `permissions` field is returned, which includes a list of all permissions in the role. The default value is `"BASIC"`, which does not return the `permissions`.
    """
    __args__ = dict()
...
def get_iam_custom_roles_output(project: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
