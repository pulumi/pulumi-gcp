...
class GetIamCustomRoleResult:
    ...
    """
    def __init__(__self__, deleted=None, deletion_policy=None, description=None, id=None, name=None, permissions=None, project=None, role_id=None, stage=None, title=None):
...
def get_iam_custom_role(project: Optional[_builtins.str] = None,
