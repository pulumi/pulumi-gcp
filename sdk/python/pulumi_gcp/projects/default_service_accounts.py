...
class _DefaultServiceAccountsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] restore_policy: The action to be performed in the default service accounts on the resource destroy.
               ...
               If set to REVERT it attempts to restore all default SAs but the DEPRIVILEGE action.
               If set to REVERT_AND_IGNORE_FAILURE it is the same behavior as REVERT but ignores errors returned by the API.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] service_accounts: The Service Accounts changed by this resource. It is used for `REVERT` the `action` on the destroy.
        """
