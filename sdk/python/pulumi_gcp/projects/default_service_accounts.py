...
class DefaultServiceAccountsArgs:
    def __init__(__self__, *,
                 ...
                 restore_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DefaultServiceAccounts resource.
        :param pulumi.Input[builtins.str] action: The action to be performed in the default service accounts. Valid values are: `DEPRIVILEGE`, `DELETE`, `DISABLE`. Note that `DEPRIVILEGE` action will ignore the REVERT configuration in the restore_policy
        :param pulumi.Input[builtins.str] project: The project ID where service accounts are created.
        :param pulumi.Input[builtins.str] restore_policy: The action to be performed in the default service accounts on the resource destroy.
    ...
    def restore_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DefaultServiceAccountsState:
    def __init__(__self__, *,
                 ...
                 restore_policy: Optional[pulumi.Input[builtins.str]] = None,
                 service_accounts: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] restore_policy: The action to be performed in the default service accounts on the resource destroy.
               ...
               If set to REVERT it attempts to restore all default SAs but the DEPRIVILEGE action.
               If set to REVERT_AND_IGNORE_FAILURE it is the same behavior as REVERT but ignores errors returned by the API.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] service_accounts: The Service Accounts changed by this resource. It is used for `REVERT` the `action` on the destroy.
        """
    ...
    def service_accounts(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def service_accounts(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class DefaultServiceAccounts(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            restore_policy: Optional[pulumi.Input[builtins.str]] = None,
            service_accounts: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DefaultServiceAccounts':
        """
    ...
    @property
    @pulumi.getter(name="restorePolicy")
    def restore_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The action to be performed in the default service accounts on the resource destroy.
        Valid values are NONE, REVERT and REVERT_AND_IGNORE_FAILURE. It is applied for any action but in the DEPRIVILEGE.
        If set to REVERT it attempts to restore all default SAs but the DEPRIVILEGE action.
    ...
    @property
    @pulumi.getter(name="serviceAccounts")
    def service_accounts(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        The Service Accounts changed by this resource. It is used for `REVERT` the `action` on the destroy.
        """
        return pulumi.get(self, "service_accounts")
