...
class AccessApprovalSettingsArgs:
    def __init__(__self__, *,
                 ...
                 active_key_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] organization_id: ID of the organization of the access approval settings.
    ...
    def active_key_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AccessApprovalSettingsState:
    def __init__(__self__, *,
                 active_key_version: Optional[pulumi.Input[builtins.str]] = None,
                 ancestor_has_active_key_version: Optional[pulumi.Input[builtins.bool]] = None,
                 enrolled_ancestor: Optional[pulumi.Input[builtins.bool]] = None,
                 enrolled_services: Optional[pulumi.Input[Sequence[pulumi.Input['AccessApprovalSettingsEnrolledServiceArgs']]]] = None,
                 invalid_key_version: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] active_key_version: The asymmetric crypto key version to use for signing approval requests. Empty active_key_version indicates that a
               Google-managed key should be used for signing.
        :param pulumi.Input[builtins.bool] ancestor_has_active_key_version: This field will always be unset for the organization since organizations do not have ancestors.
        :param pulumi.Input[builtins.bool] enrolled_ancestor: This field will always be unset for the organization since organizations do not have ancestors.
        :param pulumi.Input[Sequence[pulumi.Input['AccessApprovalSettingsEnrolledServiceArgs']]] enrolled_services: A list of Google Cloud Services for which the given resource has Access Approval enrolled.
               Access requests for the resource given by name against any of these services contained here will be required
               to have explicit approval. Enrollment can be done for individual services.
               A maximum of 10 enrolled services will be enforced, to be expanded as the set of supported services is expanded.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] invalid_key_version: If the field is true, that indicates that there is some configuration issue with the active_key_version
        ...
        :param pulumi.Input[builtins.str] name: The resource name of the settings. Format is "organizations/{organization_id}/accessApprovalSettings"
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_emails: A list of email addresses to which notifications relating to approval requests should be sent. Notifications relating to
               a resource will be sent to all emails in the settings of ancestor resources of that resource. A maximum of 50 email
               addresses are allowed.
        :param pulumi.Input[builtins.str] organization_id: ID of the organization of the access approval settings.
    ...
    def ancestor_has_active_key_version(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ancestor_has_active_key_version(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ancestor_has_active_key_version", value)

    @property
    @pulumi.getter(name="enrolledAncestor")
    def enrolled_ancestor(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This field will always be unset for the organization since organizations do not have ancestors.
        """
    ...
    def enrolled_ancestor(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def invalid_key_version(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def invalid_key_version(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("gcp:organizations/accessApprovalSettings:AccessApprovalSettings")
class AccessApprovalSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            notification_emails: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            organization_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessApprovalSettings':
        """
    ...
    @property
    @pulumi.getter(name="ancestorHasActiveKeyVersion")
    def ancestor_has_active_key_version(self) -> pulumi.Output[builtins.bool]:
        """
        This field will always be unset for the organization since organizations do not have ancestors.
        """
        return pulumi.get(self, "ancestor_has_active_key_version")
    ...
    @property
    @pulumi.getter(name="enrolledAncestor")
    def enrolled_ancestor(self) -> pulumi.Output[builtins.bool]:
        """
        This field will always be unset for the organization since organizations do not have ancestors.
        """
        return pulumi.get(self, "enrolled_ancestor")
    ...
    @property
    @pulumi.getter(name="invalidKeyVersion")
    def invalid_key_version(self) -> pulumi.Output[builtins.bool]:
        """
        If the field is true, that indicates that there is some configuration issue with the active_key_version
        configured on this Organization (e.g. it doesn't exist or the Access Approval service account doesn't have the
        correct permissions on it, etc.).
