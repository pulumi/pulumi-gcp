...
class PolicyBooleanPolicy(dict):
    def __init__(__self__, *,
        ...
        """
        PolicyBooleanPolicy._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            enforced=enforced,
        )
    @staticmethod
...
class PolicyListPolicyAllow(dict):
    def __init__(__self__, *,
        ...
        """
        PolicyListPolicyAllow._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            all=all,
            values=values,
        )
...
class PolicyListPolicyDeny(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[str] values: The policy can define specific values that are allowed or denied.
        """
        PolicyListPolicyDeny._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            all=all,
            values=values,
        )
...
class PolicyRestorePolicy(dict):
    def __init__(__self__, *,
        ...
        """
        PolicyRestorePolicy._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            default=default,
        )
    @staticmethod
...
class GetFoldersFolderResult(dict):
    ...
    def _configure(
        ...
        if delete_time is None:
            raise TypeError("Missing 'delete_time' argument")
...
class GetIAMPolicyAuditConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        GetIAMPolicyAuditConfigResult._configure(
            lambda key, value: pulumi.set(__self__, key, value),
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             audit_log_configs: Optional[Sequence['outputs.GetIAMPolicyAuditConfigAuditLogConfigResult']] = None,
...
class GetIAMPolicyAuditConfigAuditLogConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        GetIAMPolicyAuditConfigAuditLogConfigResult._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            log_type=log_type,
            exempted_members=exempted_members,
        )
...
class GetIAMPolicyBindingResult(dict):
    def __init__(__self__, *,
        ...
        """
        GetIAMPolicyBindingResult._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            members=members,
            role=role,
            condition=condition,
...
class GetIAMPolicyBindingConditionResult(dict):
    def __init__(__self__, *,
        ...
        :param str description: An optional description of the expression. This is a longer text which describes the expression, e.g. when hovered over it in a UI.
        """
        GetIAMPolicyBindingConditionResult._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            expression=expression,
            title=title,
            description=description,
