...
class GetFoldersFolderResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str create_time: The timestamp of when the folder was created
        :param _builtins.str delete_time: The timestamp of when the folder was requested to be deleted (if applicable)
        :param _builtins.str display_name: The display name of the folder
        :param _builtins.str etag: Entity tag identifier of the folder
        :param _builtins.str name: The id of the folder
        :param _builtins.str parent: The parent id of the folder
        :param _builtins.str state: The lifecycle state of the folder
        :param _builtins.str update_time: The timestamp of when the folder was last modified
        """
...
class GetIamCustomRolesRoleResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str id: an identifier for the resource with the format `organizations/{{org_id}}/roles/{{role_id}}`.
        :param _builtins.str name: The name of the role in the format `organizations/{{org_id}}/roles/{{role_id}}`. Like `id`, this field can be used as a reference in other resources such as IAM role bindings.
...
class GetSOrganizationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str directory_customer_id: The Google for Work customer ID of the Organization.
        :param _builtins.str display_name: A human-readable string that refers to the Organization in the Google Cloud console. The string will be set to the primary domain (for example, `"google.com"`) of the G Suite customer that owns the organization.
        :param _builtins.str lifecycle_state: The Organization's current lifecycle state.
        :param _builtins.str name: The resource name of the Organization in the form `organizations/{organization_id}`.
