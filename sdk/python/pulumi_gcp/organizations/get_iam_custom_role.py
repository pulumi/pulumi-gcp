...
def get_iam_custom_role(org_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str org_id: The numeric ID of the organization in which you want to create a custom role.
    :param _builtins.str role_id: The role id that has been used for this role.
    """
    __args__ = dict()
...
def get_iam_custom_role_output(org_id: Optional[pulumi.Input[_builtins.str]] = None,
