...
class PolicyListPolicyArgs:
    def __init__(__self__, *,
                 allow: pulumi.Input[Optional['PolicyListPolicyAllowArgs']] = None,
                 deny: pulumi.Input[Optional['PolicyListPolicyDenyArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def allow(self) -> pulumi.Input[Optional['PolicyListPolicyAllowArgs']]:
        """
        or `deny` - (Optional) One or the other must be set.
        """
    ...
    @allow.setter
    def allow(self, value: pulumi.Input[Optional['PolicyListPolicyAllowArgs']]):
        pulumi.set(self, "allow", value)

    @_builtins.property
    @pulumi.getter
    def deny(self) -> pulumi.Input[Optional['PolicyListPolicyDenyArgs']]:
        """
        One or the other must be set.
        """
    ...
    @deny.setter
    def deny(self, value: pulumi.Input[Optional['PolicyListPolicyDenyArgs']]):
...
class GetIAMPolicyAuditConfigArgs:
    def __init__(__self__, *,
        ...
        :param _builtins.str service: Defines a service that will be enabled for audit logging. For example, `storage.googleapis.com`, `cloudsql.googleapis.com`. `allServices` is a special value that covers all services.
        """
...
class GetIAMPolicyBindingArgs:
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] members: An array of identities that will be granted the privilege in the `role`. For more details on format and restrictions see https://cloud.google.com/billing/reference/rest/v1/Policy#Binding
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account. Some resources **don't** support this identity.
               * **allAuthenticatedUsers**: A special identifier that represents anyone who is authenticated with a Google account or a service account. Some resources **don't** support this identity.
               * **user:{emailid}**: An email address that represents a specific Google account. For example, alice@gmail.com.
               ...
               * **group:{emailid}**: An email address that represents a Google group. For example, admins@example.com.
               * **domain:{domain}**: A G Suite domain (primary, instead of alias) name that represents all the users of that domain. For example, google.com or example.com.
        :param _builtins.str role: The role/permission that will be granted to the members.
               See the [IAM Roles](https://cloud.google.com/compute/docs/access/iam) documentation for a complete list of roles.
               Note that custom roles must be of the format `[projects|organizations]/{parent-name}/roles/{role-name}`.
