...
class IamAuditConfigAuditLogConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exempted_members: Identities that do not cause logging for this type of permission.
               Each entry can have one of the following values:
               * **user:{emailid}**: An email address that represents a specific Google account. For example, alice@gmail.com or joe@example.com.
               * **serviceAccount:{emailid}**: An email address that represents a service account. For example, my-other-app@appspot.gserviceaccount.com.
               * **group:{emailid}**: An email address that represents a Google group. For example, admins@example.com.
...
if not MYPY:
    class GetIAMPolicyAuditConfigAuditLogConfigArgsDict(TypedDict):
        ...
        """
        exempted_members: NotRequired[Sequence[builtins.str]]
        """
...
class GetIAMPolicyAuditConfigAuditLogConfigArgs:
    ...
    @log_type.setter
    def log_type(self, value: builtins.str):
        pulumi.set(self, "log_type", value)
    ...
    @exempted_members.setter
    def exempted_members(self, value: Optional[Sequence[builtins.str]]):
        pulumi.set(self, "exempted_members", value)
...
class GetIAMPolicyBindingArgs:
    ...
    @members.setter
    def members(self, value: Sequence[builtins.str]):
