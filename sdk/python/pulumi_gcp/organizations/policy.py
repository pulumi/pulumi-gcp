...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] constraint: The name of the Constraint the Policy is configuring, for example, `serviceuser.services`. Check out the [complete list of available constraints](https://cloud.google.com/resource-manager/docs/organization-policy/understanding-constraints#available_constraints).
               ...
               - - -
        :param pulumi.Input[builtins.str] org_id: The numeric ID of the organization to set the policy for.
...
class Policy(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:organizations/policy:Policy"
    ...
    def get(resource_name: str,
            ...
            restore_policy: Optional[pulumi.Input[Union['PolicyRestorePolicyArgs', 'PolicyRestorePolicyArgsDict']]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Policy':
        """
