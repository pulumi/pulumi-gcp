...
class GetBillingAccountResult:
    ...
    def lookup_projects(self) -> Optional[builtins.bool]:
    ...
    def project_ids(self) -> Sequence[builtins.str]:
        """
...
def get_billing_account(billing_account: Optional[builtins.str] = None,
                        display_name: Optional[builtins.str] = None,
                        lookup_projects: Optional[builtins.bool] = None,
    ...
    :param builtins.str billing_account: The name of the billing account in the form `{billing_account_id}` or `billingAccounts/{billing_account_id}`.
    :param builtins.str display_name: The display name of the billing account.
    :param builtins.bool lookup_projects: `true` if projects associated with the billing account should be read, `false` if this step
    ...
    :param builtins.bool open: `true` if the billing account is open, `false` if the billing account is closed.
    """
    __args__ = dict()
...
def get_billing_account_output(billing_account: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               lookup_projects: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               open: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
