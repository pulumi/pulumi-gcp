...
def get_organization(domain: Optional[builtins.str] = None,
    ...
    :param builtins.str domain: The domain name of the Organization.
           
           > **NOTE:** One of `organization` or `domain` must be specified.
    :param builtins.str organization: The Organization's numeric ID, including an optional `organizations/` prefix.
    """
    __args__ = dict()
...
def get_organization_output(domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            organization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
