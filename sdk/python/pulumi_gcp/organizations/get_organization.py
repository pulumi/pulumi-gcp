...
def get_organization(domain: Optional[_builtins.str] = None,
    ...
    :param _builtins.str domain: The domain name of the Organization.
           
           > **NOTE:** One of `organization` or `domain` must be specified.
    :param _builtins.str organization: The Organization's numeric ID, including an optional `organizations/` prefix.
    """
    __args__ = dict()
...
def get_organization_output(domain: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            organization: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
