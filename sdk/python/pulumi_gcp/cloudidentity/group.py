...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 initial_group_config: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] parent: The resource name of the entity under which this Group resides in the
    ...
    def initial_group_config(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: One or more label entries that apply to the Group. Currently supported labels contain a key with an empty value.
               ...
               Dynamic groups have a label with a key of cloudidentity.googleapis.com/groups.dynamic.
               Identity-mapped groups for Cloud Search have a label with a key of system/groups/external and an empty value.
        :param pulumi.Input[builtins.str] name: Resource name of the Group in the format: groups/{group_id}, where group_id
               is the unique ID assigned to the Group.
        :param pulumi.Input[builtins.str] parent: The resource name of the entity under which this Group resides in the
               Cloud Identity resource hierarchy.
               Must be of the form identitysources/{identity_source_id} for external-identity-mapped
               groups or customers/{customer_id} for Google Groups.
        :param pulumi.Input[builtins.str] update_time: The time when the Group was last updated.
        """
