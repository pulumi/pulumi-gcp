...
def get_group_transitive_memberships(group: Optional[_builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param _builtins.str group: The parent Group resource to search transitive memberships in. Must be of the form groups/{group_id}.
    """
    __args__ = dict()
