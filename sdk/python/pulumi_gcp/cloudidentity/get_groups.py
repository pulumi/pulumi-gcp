...
def get_groups(parent: Optional[builtins.str] = None,
    ...
    :param builtins.str parent: The parent resource under which to list all Groups. Must be of the form identitysources/{identity_source_id} for external- identity-mapped groups or customers/{customer_id} for Google Groups.
    """
    __args__ = dict()
...
def get_groups_output(parent: Optional[pulumi.Input[builtins.str]] = None,
