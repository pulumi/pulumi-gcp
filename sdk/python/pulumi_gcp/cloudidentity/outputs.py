...
class GroupAdditionalGroupKey(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str namespace: (Output)
...
class GroupGroupKey(dict):
    def __init__(__self__, *,
                 ...
                 namespace: Optional[builtins.str] = None):
        """
        :param builtins.str id: The ID of the entity.
               For Google-managed entities, the id must be the email address of an existing
               group or user.
               For external-identity-mapped entities, the id must be a string conforming
               to the Identity Source's requirements.
               Must be unique within a namespace.
        :param builtins.str namespace: The namespace in which the entity exists.
               If not specified, the EntityKey represents a Google-managed entity
               such as a Google user or a Google Group.
               If specified, the EntityKey represents an external-identity-mapped group.
               The namespace must correspond to an identity source created in Admin Console
...
class GroupMembershipRole(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the MembershipRole. Must be one of OWNER, MANAGER, MEMBER.
...
class GroupMembershipRoleExpiryDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expire_time: The time at which the MembershipRole will expire.
...
class GetGroupMembershipsMembershipResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the MembershipRole. One of OWNER, MANAGER, MEMBER.
...
class GetGroupMembershipsMembershipMemberKeyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of the entity. For Google-managed entities, the id is the email address of an existing
...
class GetGroupTransitiveMembershipsMembershipResult(dict):
    def __init__(__self__, *,
                 ...
                 relation_type: builtins.str,
                 roles: Sequence['outputs.GetGroupTransitiveMembershipsMembershipRoleResult']):
        """
        :param builtins.str member: EntityKey of the member.  This value will be either a userKey in the format `users/000000000000000000000` with a numerical id or a groupKey in the format `groups/000ab0000ab0000` with a hexadecimal id.
        ...
        :param builtins.str relation_type: The relation between the group and the transitive member. The value can be DIRECT, INDIRECT, or DIRECT_AND_INDIRECT.
...
class GetGroupTransitiveMembershipsMembershipRoleResult(dict):
    def __init__(__self__, *,
                 role: builtins.str):
        """
        :param builtins.str role: The name of the TransitiveMembershipRole. One of OWNER, MANAGER, MEMBER.
        """
...
class GetGroupsGroupResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str create_time: The time when the Group was created.
        :param builtins.str description: An extended description to help users determine the purpose of a Group.
        :param builtins.str display_name: The display name of the Group.
        :param Sequence['GetGroupsGroupGroupKeyArgs'] group_keys: EntityKey of the Group.  Structure is documented below.
        :param builtins.str initial_group_config: The initial configuration options for creating a Group.
               
               See the
               [API reference](https://cloud.google.com/identity/docs/reference/rest/v1beta1/groups/create#initialgroupconfig)
               for possible values. Default value: "EMPTY" Possible values: ["INITIAL_GROUP_CONFIG_UNSPECIFIED", "WITH_INITIAL_OWNER", "EMPTY"]
        :param Mapping[str, builtins.str] labels: The labels that apply to the Group.
               Contains 'cloudidentity.googleapis.com/groups.discussion_forum': '' if the Group is a Google Group or
               'system/groups/external': '' if the Group is an external-identity-mapped group.
        :param builtins.str name: Resource name of the Group in the format: groups/{group_id}, where `group_id` is the unique ID assigned to the Group.
        ...
        :param builtins.str update_time: The time when the Group was last updated.
        """
