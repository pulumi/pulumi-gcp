...
class RegionBackendServiceIamPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        RegionBackendServiceIamPolicyArgs._configure(
...
class _RegionBackendServiceIamPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] region: The Region in which the created backend service should reside.
               ...
               region is specified, it is taken from the provider configuration.
        """
        _RegionBackendServiceIamPolicyState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            etag=etag,
            name=name,
            policy_data=policy_data,
...
class RegionBackendServiceIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RegionBackendServiceIamPolicyArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            policy_data: Optional[pulumi.Input[str]] = None,
            project: Optional[pulumi.Input[str]] = None,
            region: Optional[pulumi.Input[str]] = None) -> 'RegionBackendServiceIamPolicy':
        """
