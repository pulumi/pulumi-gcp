...
class GetInstanceResult:
    ...
    def allow_stopping_for_update(self) -> builtins.bool:
...
def get_instance(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the instance. One of `name` or `self_link` must be provided.
    :param builtins.str project: The ID of the project in which the resource belongs.
           If `self_link` is provided, this value is ignored.  If neither `self_link`
           nor `project` are provided, the provider project is used.
    :param builtins.str self_link: The self link of the instance. One of `name` or `self_link` must be provided.
...
def get_instance_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
