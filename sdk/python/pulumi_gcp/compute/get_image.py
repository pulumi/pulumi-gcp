...
class GetImageResult:
    ...
    def archive_size_bytes(self) -> builtins.int:
        """
...
def get_image(family: Optional[builtins.str] = None,
    ...
    :param builtins.str family: The family name of the image.
    :param builtins.bool most_recent: A boolean to indicate either to take to most recent image if your filter
           returns more than one image.
    :param builtins.str name: , `family` or `filter` - (Required) The name of a specific image or a family.
...
def get_image_output(family: Optional[pulumi.Input[Optional[builtins.str]]] = None,
