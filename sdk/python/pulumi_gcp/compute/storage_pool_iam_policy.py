...
class StoragePoolIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] zone: A reference to the zone where the storage pool resides. Used to find the parent resource to bind the IAM policy to. If not specified,
...
class StoragePoolIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `compute.StoragePoolIamBinding`: Authoritative for a given role and condition combination (the condition can be omitted). Updates the IAM policy to grant a role to a list of members. Other role and condition combinations within the IAM policy for the storagepool are preserved. Members added outside of Terraform for the same role and condition combination will be detected as drift and removed on the next `pulumi up`.
        * `compute.StoragePoolIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the storagepool are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `compute.StoragePoolIamPolicy`: Retrieves the IAM policy for the storagepool
        ...
        > **Note:** `compute.StoragePoolIamBinding` resources **can be** used in conjunction with `compute.StoragePoolIamMember` resources **only if** they do not grant privilege to the same role and condition combination.
    ...
    def get(resource_name: str,
            ...
            policy_data: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            zone: pulumi.Input[Optional[_builtins.str]] = None) -> 'StoragePoolIamPolicy':
        """
