...
def get_snapshot(filter: Optional[_builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param _builtins.str filter: A filter to retrieve the compute snapshot.
...
def get_snapshot_output(filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    * How-to Guides
    ...
    return __ret__.apply(lambda __response__: GetSnapshotResult(
        ...
        guest_flush=pulumi.get(__response__, 'guest_flush'),
