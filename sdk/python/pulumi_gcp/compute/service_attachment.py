...
class ServiceAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: URL of the region where the resource resides.
        :param pulumi.Input[_builtins.bool] send_propagated_connection_limit_if_zero: Controls the behavior of propagated_connection_limit.
    ...
    def enable_proxy_protocol(self, value: pulumi.Input[_builtins.bool]):
    ...
    @nat_subnets.setter
    def nat_subnets(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
