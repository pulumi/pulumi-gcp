...
class SubnetworkIAMMemberArgs:
    def __init__(__self__, *,
        ...
        """
        SubnetworkIAMMemberArgs._configure(
...
class _SubnetworkIAMMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] subnetwork: Used to find the parent resource to bind the IAM policy to
        """
        _SubnetworkIAMMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            etag=etag,
            member=member,
...
class SubnetworkIAMMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SubnetworkIAMMemberArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, SubnetworkIAMMemberConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                SubnetworkIAMMemberConditionArgs._configure(_setter, **condition)
