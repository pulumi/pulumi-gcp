...
class RouterPeerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterPeerCustomLearnedIpRangeArgs']]] custom_learned_ip_ranges: The custom learned route IP address range. Must be a valid CIDR-formatted prefix.
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.int] custom_learned_route_priority: The user-defined custom learned route priority for a BGP session.
        ...
        :param pulumi.Input[_builtins.str] ipv4_nexthop_address: IPv4 address of the interface inside Google Cloud Platform.
        :param pulumi.Input[_builtins.str] ipv6_nexthop_address: IPv6 address of the interface inside Google Cloud Platform.
        ...
        :param pulumi.Input[_builtins.str] peer_ip_address: IP address of the BGP interface outside Google Cloud Platform.
               Only IPv4 is supported. Required if `ip_address` is set.
        :param pulumi.Input[_builtins.str] peer_ipv4_nexthop_address: IPv4 address of the BGP interface outside Google Cloud Platform.
        :param pulumi.Input[_builtins.str] peer_ipv6_nexthop_address: IPv6 address of the BGP interface outside Google Cloud Platform.
               The address must be in the range 2600:2d00:0:2::/64 or 2600:2d00:0:3::/64.
               If you do not specify the next hop addresses, Google Cloud automatically
               assigns unused addresses from the 2600:2d00:0:2::/64 or 2600:2d00:0:3::/64 range for you.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] region: Region where the router and BgpPeer reside.
        ...
        :param pulumi.Input[_builtins.bool] zero_advertised_route_priority: The user-defined zero-advertised-route-priority for a advertised-route-priority in BGP session.
               This value has to be set true to force the advertised_route_priority to be 0.
        :param pulumi.Input[_builtins.bool] zero_custom_learned_route_priority: The user-defined zero-custom-learned-route-priority for a custom-learned-route-priority in BGP session.
...
class _RouterPeerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ipv6_nexthop_address: IPv6 address of the interface inside Google Cloud Platform.
               ...
               If you do not specify the next hop addresses, Google Cloud automatically
               assigns unused addresses from the 2600:2d00:0:2::/64 or 2600:2d00:0:3::/64 range for you.
        :param pulumi.Input[_builtins.bool] is_advertised_route_priority_set: An internal boolean field for provider use for zero_advertised_route_priority.
