...
def get_region_instance_template(filter: Optional[builtins.str] = None,
    ...
    :param builtins.bool most_recent: If `filter` is provided, ensures the most recent template is returned when multiple instance templates match. One of `name` or `filter` must be provided.
    :param builtins.str name: The name of the instance template. One of `name` or `filter` must be provided.
    :param builtins.str project: The ID of the project in which the resource belongs.
           If `project` is not provided, the provider project is used.
    :param builtins.str region: The Region in which the resource belongs.
...
def get_region_instance_template_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
