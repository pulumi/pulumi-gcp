...
class GetRegionInstanceTemplateResult:
    ...
    def advanced_machine_features(self) -> Sequence['outputs.GetRegionInstanceTemplateAdvancedMachineFeatureResult']:
    ...
    def confidential_instance_configs(self) -> Sequence['outputs.GetRegionInstanceTemplateConfidentialInstanceConfigResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def disks(self) -> Sequence['outputs.GetRegionInstanceTemplateDiskResult']:
        """
    ...
    def guest_accelerators(self) -> Sequence['outputs.GetRegionInstanceTemplateGuestAcceleratorResult']:
        """
    ...
    def network_interfaces(self) -> Sequence['outputs.GetRegionInstanceTemplateNetworkInterfaceResult']:
        """
    ...
    def network_performance_configs(self) -> Sequence['outputs.GetRegionInstanceTemplateNetworkPerformanceConfigResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def schedulings(self) -> Sequence['outputs.GetRegionInstanceTemplateSchedulingResult']:
        """
    ...
    def service_accounts(self) -> Sequence['outputs.GetRegionInstanceTemplateServiceAccountResult']:
        """
    ...
    def shielded_instance_configs(self) -> Sequence['outputs.GetRegionInstanceTemplateShieldedInstanceConfigResult']:
        """
    ...
    def workload_identity_configs(self) -> Sequence['outputs.GetRegionInstanceTemplateWorkloadIdentityConfigResult']:
...
def get_region_instance_template(filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.str filter: A filter to retrieve the instance templates.
    ...
    :param _builtins.bool most_recent: If `filter` is provided, ensures the most recent template is returned when multiple instance templates match. One of `name` or `filter` must be provided.
    ...
    __ret__ = pulumi.runtime.invoke('gcp:compute/getRegionInstanceTemplate:getRegionInstanceTemplate', __args__, opts=opts, typ=GetRegionInstanceTemplateResult).value
