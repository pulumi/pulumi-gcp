...
class NetworkFirewallPolicyAssociationArgs:
    def __init__(__self__, *,
                 attachment_target: pulumi.Input[builtins.str],
    ...
    def attachment_target(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def attachment_target(self, value: pulumi.Input[builtins.str]):
...
class _NetworkFirewallPolicyAssociationState:
    def __init__(__self__, *,
                 attachment_target: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="attachmentTarget")
    def attachment_target(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The target that the firewall policy is attached to.
        """
        return pulumi.get(self, "attachment_target")
    ...
    @attachment_target.setter
    def attachment_target(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "attachment_target", value)
...
@pulumi.type_token("gcp:compute/networkFirewallPolicyAssociation:NetworkFirewallPolicyAssociation")
class NetworkFirewallPolicyAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            short_name: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewallPolicyAssociation':
        """
    ...
    @property
    @pulumi.getter(name="attachmentTarget")
    def attachment_target(self) -> pulumi.Output[builtins.str]:
        """
        The target that the firewall policy is attached to.
        """
        return pulumi.get(self, "attachment_target")
