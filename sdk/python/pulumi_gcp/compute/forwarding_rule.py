...
class ForwardingRuleArgs:
    def __init__(__self__, *,
                 ...
                 is_mirroring_collector: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 service_directory_registrations: pulumi.Input[Optional['ForwardingRuleServiceDirectoryRegistrationsArgs']] = None,
        ...
        :param pulumi.Input[_builtins.bool] all_ports: The `ports`, `portRange`, and `allPorts` fields are mutually exclusive.
               ...
               * Set this field to true to allow packets addressed to any port or packets
               ...
               true.
        :param pulumi.Input[_builtins.bool] allow_global_access: This field is used along with the `backend_service` field for
        ...
        :param pulumi.Input[_builtins.str] ip_version: The IP address version that will be used by this forwarding rule.
               Valid options are IPV4 and IPV6.
               If not set, the IPv4 address will be used by default.
               Possible values are: `IPV4`, `IPV6`.
        :param pulumi.Input[_builtins.bool] is_mirroring_collector: Indicates whether or not this load balancer can be used as a collector for
        ...
        :param pulumi.Input[_builtins.str] port_range: The `ports`, `portRange`, and `allPorts` fields are mutually exclusive.
               Only packets addressed to ports in the specified range will be forwarded
               to the backends configured with this forwarding rule.
               ...
               * Some products have restrictions on what ports can be used. See
               ...
               @pattern: \\d+(?:-\\d+)?
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ports: The `ports`, `portRange`, and `allPorts` fields are mutually exclusive.
               Only packets addressed to ports in the specified range will be forwarded
               to the backends configured with this forwarding rule.
    ...
    def is_mirroring_collector(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_mirroring_collector(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def recreate_closed_psc(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def recreate_closed_psc(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def service_directory_registrations(self) -> pulumi.Input[Optional['ForwardingRuleServiceDirectoryRegistrationsArgs']]:
        """
    ...
    def service_directory_registrations(self, value: pulumi.Input[Optional['ForwardingRuleServiceDirectoryRegistrationsArgs']]):
        pulumi.set(self, "service_directory_registrations", value)

    @_builtins.property
    @pulumi.getter(name="serviceLabel")
    def service_label(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def service_label(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _ForwardingRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_label: An optional prefix to the service name for this Forwarding Rule.
               ...
               character, which cannot be a dash.
               This field is only used for INTERNAL load balancing.
        :param pulumi.Input[_builtins.str] service_name: The internal fully qualified service name for this Forwarding Rule.
               This field is only used for INTERNAL load balancing.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_ip_ranges: If not empty, this Forwarding Rule will only forward the traffic when the source IP address matches one of the IP addresses or CIDR ranges set here. Note that a Forwarding Rule can only have up to 64 source IP ranges, and this field can only be used with a regional Forwarding Rule whose scheme is EXTERNAL. Each sourceIpRange entry should be either an IP address (for example, 1.2.3.4) or a CIDR range (for example, 1.2.3.0/24).
        :param pulumi.Input[_builtins.str] subnetwork: This field identifies the subnetwork that the load balanced IP should
               belong to for this Forwarding Rule, used in internal load balancing and
...
class ForwardingRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_ip_ranges: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            subnetwork: pulumi.Input[Optional[_builtins.str]] = None,
            target: pulumi.Input[Optional[_builtins.str]] = None) -> 'ForwardingRule':
        """
