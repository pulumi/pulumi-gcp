...
def get_resource_policy(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: Region where the Resource Policy resides.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_resource_policy_output(name: Optional[pulumi.Input[_builtins.str]] = None,
