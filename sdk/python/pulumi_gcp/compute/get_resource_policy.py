...
def get_resource_policy(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Resource Policy.
    :param builtins.str project: Project from which to list the Resource Policy. Defaults to project declared in the provider.
    :param builtins.str region: Region where the Resource Policy resides.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_resource_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
