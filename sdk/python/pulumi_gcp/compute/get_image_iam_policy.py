...
def get_image_iam_policy(image: Optional[builtins.str] = None,
    ...
    :param builtins.str image: Used to find the parent resource to bind the IAM policy to
...
def get_image_iam_policy_output(image: Optional[pulumi.Input[builtins.str]] = None,
