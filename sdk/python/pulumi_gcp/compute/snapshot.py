...
class SnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source_disk: A reference to the disk used to create this snapshot.
               
               
               - - -
        :param pulumi.Input[builtins.str] chain_name: Creates the new snapshot in the snapshot chain labeled with the
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels to apply to this Snapshot.
        ...
        :param pulumi.Input['SnapshotSourceDiskEncryptionKeyArgs'] source_disk_encryption_key: The customer-supplied encryption key of the source snapshot. Required
               ...
               key.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] storage_locations: Cloud Storage bucket storage location of the snapshot (regional or multi-regional).
        :param pulumi.Input[builtins.str] zone: A reference to the zone where the disk is hosted.
        """
...
class _SnapshotState:
    def __init__(__self__, *,
                 ...
                 snapshot_encryption_key: Optional[pulumi.Input['SnapshotSnapshotEncryptionKeyArgs']] = None,
                 snapshot_id: Optional[pulumi.Input[builtins.int]] = None,
                 source_disk: Optional[pulumi.Input[builtins.str]] = None,
                 source_disk_encryption_key: Optional[pulumi.Input['SnapshotSourceDiskEncryptionKeyArgs']] = None,
                 storage_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 storage_locations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels to apply to this Snapshot.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] licenses: A list of public visible licenses that apply to this snapshot. This
        ...
        :param pulumi.Input['SnapshotSnapshotEncryptionKeyArgs'] snapshot_encryption_key: Encrypts the snapshot using a customer-supplied encryption key.
               ...
               key and you do not need to provide a key to use the snapshot later.
               Structure is documented below.
        :param pulumi.Input[builtins.int] snapshot_id: The unique identifier for the resource.
        :param pulumi.Input[builtins.str] source_disk: A reference to the disk used to create this snapshot.
        ...
        :param pulumi.Input['SnapshotSourceDiskEncryptionKeyArgs'] source_disk_encryption_key: The customer-supplied encryption key of the source snapshot. Required
               ...
               key.
               Structure is documented below.
        :param pulumi.Input[builtins.int] storage_bytes: A size of the storage used by the snapshot. As snapshots share
    ...
    def snapshot_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @snapshot_id.setter
    def snapshot_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def storage_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def storage_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Snapshot(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="chainName")
    def chain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Creates the new snapshot in the snapshot chain labeled with the
        specified name. The chain name must be 1-63 characters long and
        comply with RFC1035. This is an uncommon option only for advanced
    ...
    @property
    @pulumi.getter(name="snapshotId")
    def snapshot_id(self) -> pulumi.Output[builtins.int]:
        """
        The unique identifier for the resource.
        """
        return pulumi.get(self, "snapshot_id")
    ...
    @property
    @pulumi.getter(name="storageBytes")
    def storage_bytes(self) -> pulumi.Output[builtins.int]:
        """
        A size of the storage used by the snapshot. As snapshots share
        storage, this number is expected to change with snapshot
        creation/deletion.
