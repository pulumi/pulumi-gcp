...
class DiskArgs:
    def __init__(__self__, *,
                 ...
                 multi_writer: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 resource_policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 source_instant_snapshot: Optional[pulumi.Input[builtins.str]] = None,
                 source_snapshot_encryption_key: Optional[pulumi.Input['DiskSourceSnapshotEncryptionKeyArgs']] = None,
                 source_storage_object: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_mode: The accessMode of the disk.
               ...
               * READ_WRITE_MANY
               * READ_ONLY_SINGLE
        :param pulumi.Input[builtins.str] architecture: (Optional)
        ...
        :param pulumi.Input[builtins.str] create_snapshot_before_destroy_prefix: This will set a custom name prefix for the snapshot that's created when the disk is deleted.
        ...
        :param pulumi.Input['DiskDiskEncryptionKeyArgs'] disk_encryption_key: Encrypts the disk using a customer-supplied encryption key.
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.bool] enable_confidential_compute: Whether this disk is using confidential compute mode.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DiskGuestOsFeatureArgs']]] guest_os_features: A list of features to enable on the guest operating system.
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] image: The image from which to initialize this disk. This can be
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels to apply to this disk.  A list of key->value pairs.
        ...
        :param pulumi.Input[builtins.bool] multi_writer: Indicates whether or not the disk can be read/write attached to more than one instance.
        ...
        :param pulumi.Input[builtins.int] provisioned_iops: Indicates how many IOPS must be provisioned for the disk.
               Note: Updating currently is only supported by hyperdisk skus without the need to delete and recreate the disk, hyperdisk
               allows for an update of IOPS every 4 hours. To update your hyperdisk more frequently, you'll need to manually delete and recreate it
        :param pulumi.Input[builtins.int] provisioned_throughput: Indicates how much Throughput must be provisioned for the disk.
               Note: Updating currently is only supported by hyperdisk skus without the need to delete and recreate the disk, hyperdisk
               allows for an update of Throughput every 4 hours. To update your hyperdisk more frequently, you'll need to manually delete and recreate it
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_policies: Resource policies applied to this disk for automatic snapshot creations.
        ...
        :param pulumi.Input[builtins.int] size: Size of the persistent disk, specified in GB. You can specify this
               ...
               and recreating.
        :param pulumi.Input[builtins.str] snapshot: The source snapshot used to create this disk. You can provide this as
        ...
        :param pulumi.Input[builtins.str] source_disk: The source disk used to create this disk. You can provide this as a partial or full URL to the resource.
        ...
        :param pulumi.Input['DiskSourceImageEncryptionKeyArgs'] source_image_encryption_key: The customer-supplied encryption key of the source image. Required if
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] source_instant_snapshot: The source instant snapshot used to create this disk. You can provide this as a partial or full URL to the resource.
               For example, the following are valid values:
        ...
        :param pulumi.Input['DiskSourceSnapshotEncryptionKeyArgs'] source_snapshot_encryption_key: The customer-supplied encryption key of the source snapshot. Required
               ...
               key.
               Structure is documented below.
        :param pulumi.Input[builtins.str] source_storage_object: The full Google Cloud Storage URI where the disk image is stored.
        ...
        :param pulumi.Input[builtins.str] storage_pool: The URL or the name of the storage pool in which the new disk is created.
               For example:
               * https://www.googleapis.com/compute/v1/projects/{project}/zones/{zone}/storagePools/{storagePool}
               * /projects/{project}/zones/{zone}/storagePools/{storagePool}
               * /zones/{zone}/storagePools/{storagePool}
               * /{storagePool}
        :param pulumi.Input[builtins.str] type: URL of the disk type resource describing which disk type to use to
               create the disk. Provide this when creating the disk.
        :param pulumi.Input[builtins.str] zone: A reference to the zone where the disk resides.
        """
    ...
    def create_snapshot_before_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def create_snapshot_before_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "create_snapshot_before_destroy", value)

    @property
    @pulumi.getter(name="createSnapshotBeforeDestroyPrefix")
    def create_snapshot_before_destroy_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def create_snapshot_before_destroy_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def multi_writer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @multi_writer.setter
    def multi_writer(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def physical_block_size_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def physical_block_size_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def resource_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def resource_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def source_instant_snapshot(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_instant_snapshot(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_storage_object(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_storage_object(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DiskState:
    def __init__(__self__, *,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 last_attach_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 last_detach_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 licenses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 multi_writer: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 params: Optional[pulumi.Input['DiskParamsArgs']] = None,
                 ...
                 source_instant_snapshot: Optional[pulumi.Input[builtins.str]] = None,
                 source_instant_snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_snapshot_encryption_key: Optional[pulumi.Input['DiskSourceSnapshotEncryptionKeyArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels to apply to this disk.  A list of key->value pairs.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] last_attach_timestamp: Last attach timestamp in RFC3339 text format.
        :param pulumi.Input[builtins.str] last_detach_timestamp: Last detach timestamp in RFC3339 text format.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] licenses: Any applicable license URI.
        :param pulumi.Input[builtins.bool] multi_writer: Indicates whether or not the disk can be read/write attached to more than one instance.
        :param pulumi.Input[builtins.str] name: Name of the resource. Provided by the client when the resource is
               created. The name must be 1-63 characters long, and comply with
        ...
        :param pulumi.Input[builtins.str] source_disk: The source disk used to create this disk. You can provide this as a partial or full URL to the resource.
               ...
               * zones/{zone}/disks/{disk}
               * regions/{region}/disks/{disk}
        :param pulumi.Input[builtins.str] source_disk_id: The ID value of the disk used to create this image. This value may
               be used to determine whether the image was taken from the current
               or a previous instance of a given disk name.
        :param pulumi.Input['DiskSourceImageEncryptionKeyArgs'] source_image_encryption_key: The customer-supplied encryption key of the source image. Required if
               the source image is protected by a customer-supplied encryption key.
               Structure is documented below.
        :param pulumi.Input[builtins.str] source_image_id: The ID value of the image used to create this disk. This value
        ...
        :param pulumi.Input[builtins.str] source_instant_snapshot: The source instant snapshot used to create this disk. You can provide this as a partial or full URL to the resource.
               ...
               * `projects/project/zones/zone/instantSnapshots/instantSnapshot`
               * `zones/zone/instantSnapshots/instantSnapshot`
        :param pulumi.Input[builtins.str] source_instant_snapshot_id: The unique ID of the instant snapshot used to create this disk. This value identifies
        ...
        :param pulumi.Input['DiskSourceSnapshotEncryptionKeyArgs'] source_snapshot_encryption_key: The customer-supplied encryption key of the source snapshot. Required
               ...
               key.
               Structure is documented below.
        :param pulumi.Input[builtins.str] source_snapshot_id: The unique ID of the snapshot used to create this disk. This value
    ...
    def last_attach_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_attach_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_attach_timestamp", value)

    @property
    @pulumi.getter(name="lastDetachTimestamp")
    def last_detach_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_detach_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_instant_snapshot_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_instant_snapshot_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Disk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Disk':
        """
    ...
    @property
    @pulumi.getter(name="createSnapshotBeforeDestroy")
    def create_snapshot_before_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to true, a snapshot of the disk will be created before it is destroyed.
        If your disk is encrypted with customer managed encryption keys these will be reused for the snapshot creation.
        The name of the snapshot by default will be `{{disk-name}}-YYYYMMDD-HHmm`
    ...
    @property
    @pulumi.getter(name="createSnapshotBeforeDestroyPrefix")
    def create_snapshot_before_destroy_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This will set a custom name prefix for the snapshot that's created when the disk is deleted.
        """
        return pulumi.get(self, "create_snapshot_before_destroy_prefix")
    ...
    @property
    @pulumi.getter(name="enableConfidentialCompute")
    def enable_confidential_compute(self) -> pulumi.Output[builtins.bool]:
        """
        Whether this disk is using confidential compute mode.
        Note: Only supported on hyperdisk skus, disk_encryption_key is required when setting to true
        """
    ...
    @property
    @pulumi.getter(name="lastAttachTimestamp")
    def last_attach_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Last attach timestamp in RFC3339 text format.
        """
        return pulumi.get(self, "last_attach_timestamp")
    ...
    @property
    @pulumi.getter(name="lastDetachTimestamp")
    def last_detach_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Last detach timestamp in RFC3339 text format.
        """
        return pulumi.get(self, "last_detach_timestamp")
    ...
    @property
    @pulumi.getter(name="multiWriter")
    def multi_writer(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether or not the disk can be read/write attached to more than one instance.
        """
        return pulumi.get(self, "multi_writer")
    ...
    @property
    @pulumi.getter(name="physicalBlockSizeBytes")
    def physical_block_size_bytes(self) -> pulumi.Output[builtins.int]:
        """
        Physical block size of the persistent disk, in bytes. If not present
        in a request, a default value is used. Currently supported sizes
        are 4096 and 16384, other sizes may be added in the future.
    ...
    @property
    @pulumi.getter(name="resourcePolicies")
    def resource_policies(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Resource policies applied to this disk for automatic snapshot creations.
        ~>**NOTE** This value does not support updating the
        resource policy, as resource policies can not be updated more than
    ...
    @property
    @pulumi.getter
    def snapshot(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source snapshot used to create this disk. You can provide this as
        a partial or full URL to the resource. If the snapshot is in another
        project than this disk, you must supply a full URL. For example, the
    ...
    @property
    @pulumi.getter(name="sourceInstantSnapshot")
    def source_instant_snapshot(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source instant snapshot used to create this disk. You can provide this as a partial or full URL to the resource.
        For example, the following are valid values:
        * `https://www.googleapis.com/compute/v1/projects/project/zones/zone/instantSnapshots/instantSnapshot`
    ...
    @property
    @pulumi.getter(name="sourceInstantSnapshotId")
    def source_instant_snapshot_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique ID of the instant snapshot used to create this disk. This value identifies
        the exact instant snapshot that was used to create this persistent disk.
        For example, if you created the persistent disk from an instant snapshot that was later
    ...
    @property
    @pulumi.getter(name="sourceStorageObject")
    def source_storage_object(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The full Google Cloud Storage URI where the disk image is stored.
        This file must be a gzip-compressed tarball whose name ends in .tar.gz or virtual machine disk whose name ends in vmdk.
        Valid URIs may start with gs:// or https://storage.googleapis.com/.
    ...
    @property
    @pulumi.getter(name="storagePool")
    def storage_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL or the name of the storage pool in which the new disk is created.
        For example:
        * https://www.googleapis.com/compute/v1/projects/{project}/zones/{zone}/storagePools/{storagePool}
