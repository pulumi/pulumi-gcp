...
class TargetGrpcProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] url_map: URL to the UrlMap resource that defines the mapping from URL to
               the BackendService. The protocol field in the BackendService
               must be set to GRPC.
        :param pulumi.Input[_builtins.bool] validate_for_proxyless: If true, indicates that the BackendServices referenced by
