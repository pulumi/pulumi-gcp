...
class TargetGrpcProxyArgs:
    def __init__(__self__, *,
                 ...
                 validate_for_proxyless: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: Name of the resource. Provided by the client when the resource
        ...
        :param pulumi.Input[builtins.str] url_map: URL to the UrlMap resource that defines the mapping from URL to
               the BackendService. The protocol field in the BackendService
               must be set to GRPC.
        :param pulumi.Input[builtins.bool] validate_for_proxyless: If true, indicates that the BackendServices referenced by
    ...
    def validate_for_proxyless(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def validate_for_proxyless(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _TargetGrpcProxyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: An optional description of this resource.
        :param pulumi.Input[builtins.str] fingerprint: Fingerprint of this resource. A hash of the contents stored in
        ...
        :param pulumi.Input[builtins.str] self_link_with_id: Server-defined URL with id for the resource.
        :param pulumi.Input[builtins.str] url_map: URL to the UrlMap resource that defines the mapping from URL to
               the BackendService. The protocol field in the BackendService
               must be set to GRPC.
        :param pulumi.Input[builtins.bool] validate_for_proxyless: If true, indicates that the BackendServices referenced by
...
class TargetGrpcProxy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            self_link_with_id: Optional[pulumi.Input[builtins.str]] = None,
            url_map: Optional[pulumi.Input[builtins.str]] = None,
            validate_for_proxyless: Optional[pulumi.Input[builtins.bool]] = None) -> 'TargetGrpcProxy':
        """
    ...
    @property
    @pulumi.getter(name="urlMap")
    def url_map(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL to the UrlMap resource that defines the mapping from URL to
        the BackendService. The protocol field in the BackendService
        must be set to GRPC.
    ...
    @property
    @pulumi.getter(name="validateForProxyless")
    def validate_for_proxyless(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, indicates that the BackendServices referenced by
        the urlMap may be accessed by gRPC applications without using
        a sidecar proxy. This will enable configuration checks on urlMap
