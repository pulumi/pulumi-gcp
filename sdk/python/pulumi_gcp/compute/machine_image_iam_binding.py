...
class MachineImageIamBinding(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, MachineImageIamBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                MachineImageIamBindingConditionArgs._configure(_setter, **condition)
