...
class InterconnectAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] candidate_customer_router_ip_address: Single IPv4 address + prefix length to be configured on the customer router interface for this
               interconnect attachment. Example: 203.0.113.2/29
        :param pulumi.Input[_builtins.str] candidate_customer_router_ipv6_address: Single IPv6 address + prefix length to be configured on the customer router interface for this
               interconnect attachment. Example: 2001:db8::2/125
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] candidate_subnets: Up to 16 candidate prefixes that can be used to restrict the allocation
        ...
        :param pulumi.Input[_builtins.str] encryption: Indicates the user-supplied encryption option of this interconnect
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ipsec_internal_addresses: URL of addresses that have been reserved for the interconnect attachment,
        ...
        :param pulumi.Input[_builtins.str] mtu: Maximum Transmission Unit (MTU), in bytes, of packets passing through this interconnect attachment.
        ...
        :param pulumi.Input[_builtins.int] subnet_length: Length of the IPv4 subnet mask. Allowed values: 29 (default), 30. The default value is 29,
...
class _InterconnectAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] candidate_subnets: Up to 16 candidate prefixes that can be used to restrict the allocation
               ...
               fail if all possible /29s are in use on Google's edge. If not supplied,
               Google will randomly select an unused /29 from all of link-local space.
        :param pulumi.Input[_builtins.str] cloud_router_ip_address: IPv4 address + prefix length to be configured on Cloud Router
               Interface for this interconnect attachment.
        :param pulumi.Input[_builtins.str] cloud_router_ipv6_address: IPv6 address + prefix length to be configured on Cloud Router
               Interface for this interconnect attachment.
        :param pulumi.Input[_builtins.str] creation_timestamp: Creation timestamp in RFC3339 text format.
        :param pulumi.Input[_builtins.str] customer_router_ip_address: IPv4 address + prefix length to be configured on the customer
        ...
        :param pulumi.Input[_builtins.str] stack_type: The stack type for this interconnect attachment to identify whether the IPv6
               ...
               interconnect attachment operations.
               Possible values are: `IPV4_IPV6`, `IPV4_ONLY`.
        :param pulumi.Input[_builtins.str] state: [Output Only] The current state of this attachment's functionality.
        :param pulumi.Input[_builtins.int] subnet_length: Length of the IPv4 subnet mask. Allowed values: 29 (default), 30. The default value is 29,
               except for Cross-Cloud Interconnect connections that use an InterconnectRemoteLocation with a
               constraints.subnetLengthRange.min equal to 30. For example, connections that use an Azure
               remote location fall into this category. In these cases, the default value is 30, and
