...
class ManagedSslCertificateArgs:
    def __init__(__self__, *,
        ...
        """
        ManagedSslCertificateArgs._configure(
...
class _ManagedSslCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: Enum field whose value is always `MANAGED` - used to signal to the API
               ...
               Possible values are: `MANAGED`.
        """
        _ManagedSslCertificateState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            certificate_id=certificate_id,
...
class ManagedSslCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ManagedSslCertificateArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if managed is not None and not isinstance(managed, ManagedSslCertificateManagedArgs):
                managed = managed or {}
                def _setter(key, value):
                    managed[key] = value
                ManagedSslCertificateManagedArgs._configure(_setter, **managed)
