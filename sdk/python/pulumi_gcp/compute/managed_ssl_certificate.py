...
class ManagedSslCertificateArgs:
    def __init__(__self__, *,
                 ...
                 managed: pulumi.Input[Optional['ManagedSslCertificateManagedArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] type: Enum field whose value is always `MANAGED` - used to signal to the API
               which type this is.
    ...
    @_builtins.property
    @pulumi.getter
    def managed(self) -> pulumi.Input[Optional['ManagedSslCertificateManagedArgs']]:
        """
    ...
    @managed.setter
    def managed(self, value: pulumi.Input[Optional['ManagedSslCertificateManagedArgs']]):
...
class _ManagedSslCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subject_alternative_names: Domains associated with the certificate via Subject Alternative Name.
        :param pulumi.Input[_builtins.str] type: Enum field whose value is always `MANAGED` - used to signal to the API
               which type this is.
               Default value is `MANAGED`.
               Possible values are: `MANAGED`.
...
class ManagedSslCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 managed: pulumi.Input[Optional[Union['ManagedSslCertificateManagedArgs', 'ManagedSslCertificateManagedArgsDict', 'outputs.ManagedSslCertificateManaged']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        * `{{name}}`
        ...
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               ...
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] description: An optional description of this resource.
        :param pulumi.Input[Union['ManagedSslCertificateManagedArgs', 'ManagedSslCertificateManagedArgsDict', 'outputs.ManagedSslCertificateManaged']] managed: Properties relevant to a managed certificate.  These will be used if the
               certificate is managed (as indicated by a value of `MANAGED` in `type`).
               Structure is documented below.
        :param pulumi.Input[_builtins.str] name: Name of the resource. Provided by the client when the resource is
               created. The name must be 1-63 characters long, and comply with
    ...
    def get(resource_name: str,
            ...
            self_link: pulumi.Input[Optional[_builtins.str]] = None,
            subject_alternative_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'ManagedSslCertificate':
        """
