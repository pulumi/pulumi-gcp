...
class NetworkEndpointGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network: The network to which all network endpoints in the NEG belong.
        ...
        :param pulumi.Input[builtins.str] subnetwork: Optional subnetwork to which all network endpoints in the NEG belong.
        :param pulumi.Input[builtins.str] zone: Zone where the network endpoint group is located.
        """
...
class _NetworkEndpointGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] size: Number of network endpoints in the network endpoint group.
        :param pulumi.Input[builtins.str] subnetwork: Optional subnetwork to which all network endpoints in the NEG belong.
        :param pulumi.Input[builtins.str] zone: Zone where the network endpoint group is located.
        """
        if default_port is not None:
...
class NetworkEndpointGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[builtins.int]] = None,
            subnetwork: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkEndpointGroup':
        """
    ...
    @property
    @pulumi.getter(name="networkEndpointType")
    def network_endpoint_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of network endpoints in this network endpoint group.
        NON_GCP_PRIVATE_IP_PORT is used for hybrid connectivity network
        endpoint groups (see https://cloud.google.com/load-balancing/docs/hybrid).
