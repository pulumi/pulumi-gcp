...
class SecurityPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: An optional description of this security policy. Max size is 2048.
        ...
        :param pulumi.Input[builtins.str] type: The type indicates the intended use of the security policy. This field can be set only at resource creation time.
...
class _SecurityPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SecurityPolicyAdvancedOptionsConfigArgs'] advanced_options_config: [Advanced Configuration Options](https://cloud.google.com/armor/docs/security-policy-overview#json-parsing).
               Structure is documented below.
        :param pulumi.Input[builtins.str] description: An optional description of this security policy. Max size is 2048.
        :param pulumi.Input[builtins.str] fingerprint: Fingerprint of this resource.
        :param pulumi.Input[builtins.str] name: The name of the security policy.
...
class SecurityPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:compute/securityPolicy:SecurityPolicy"
    ...
    def get(resource_name: str,
            ...
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SecurityPolicyRuleArgs', 'SecurityPolicyRuleArgsDict']]]]] = None,
            self_link: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'SecurityPolicy':
        """
