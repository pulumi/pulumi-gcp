...
class RouterNatArgs:
    def __init__(__self__, *,
                 ...
                 source_subnetwork_ip_ranges_to_nat: pulumi.Input[builtins.str],
                 auto_network_tier: Optional[pulumi.Input[builtins.str]] = None,
                 drain_nat_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 enable_dynamic_port_allocation: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_endpoint_independent_mapping: Optional[pulumi.Input[builtins.bool]] = None,
                 endpoint_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 icmp_idle_timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
                 initial_nat_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 log_config: Optional[pulumi.Input['RouterNatLogConfigArgs']] = None,
                 max_ports_per_vm: Optional[pulumi.Input[builtins.int]] = None,
                 min_ports_per_vm: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 nat64_subnetworks: Optional[pulumi.Input[Sequence[pulumi.Input['RouterNatNat64SubnetworkArgs']]]] = None,
                 nat_ip_allocate_option: Optional[pulumi.Input[builtins.str]] = None,
                 nat_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['RouterNatRuleArgs']]]] = None,
                 source_subnetwork_ip_ranges_to_nat64: Optional[pulumi.Input[builtins.str]] = None,
                 subnetworks: Optional[pulumi.Input[Sequence[pulumi.Input['RouterNatSubnetworkArgs']]]] = None,
                 tcp_established_idle_timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
                 tcp_time_wait_timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
                 tcp_transitory_idle_timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 udp_idle_timeout_sec: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a RouterNat resource.
        :param pulumi.Input[builtins.str] router: The name of the Cloud Router in which this NAT will be configured.
        :param pulumi.Input[builtins.str] source_subnetwork_ip_ranges_to_nat: How NAT should be configured per Subnetwork.
        ...
        :param pulumi.Input[builtins.str] auto_network_tier: The network tier to use when automatically reserving NAT IP addresses.
        ...
        :param pulumi.Input[builtins.bool] enable_dynamic_port_allocation: Enable Dynamic Port Allocation.
               If minPortsPerVm is set, minPortsPerVm must be set to a power of two greater than or equal to 32.
               If minPortsPerVm is not set, a minimum of 32 ports will be allocated to a VM from this NAT config.
               If maxPortsPerVm is set, maxPortsPerVm must be set to a power of two greater than minPortsPerVm.
               If maxPortsPerVm is not set, a maximum of 65536 ports will be allocated to a VM from this NAT config.
               Mutually exclusive with enableEndpointIndependentMapping.
        :param pulumi.Input[builtins.bool] enable_endpoint_independent_mapping: Enable endpoint independent mapping.
               For more information see the [official documentation](https://cloud.google.com/nat/docs/overview#specs-rfcs).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_types: Specifies the endpoint Types supported by the NAT Gateway.
               Supported values include:
               `ENDPOINT_TYPE_VM`, `ENDPOINT_TYPE_SWG`,
               `ENDPOINT_TYPE_MANAGED_PROXY_LB`.
        :param pulumi.Input[builtins.int] icmp_idle_timeout_sec: Timeout (in seconds) for ICMP connections. Defaults to 30s if not set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] initial_nat_ips: Self-links of NAT IPs to be used as initial value for creation alongside a RouterNatAddress resource.
               Conflicts with natIps and drainNatIps. Only valid if natIpAllocateOption is set to MANUAL_ONLY.
        :param pulumi.Input['RouterNatLogConfigArgs'] log_config: Configuration for logging on NAT
               Structure is documented below.
        :param pulumi.Input[builtins.int] max_ports_per_vm: Maximum number of ports allocated to a VM from this NAT.
               This field can only be set when enableDynamicPortAllocation is enabled.
        :param pulumi.Input[builtins.int] min_ports_per_vm: Minimum number of ports allocated to a VM from this NAT. Defaults to 64 for static port allocation and 32 dynamic port allocation if not set.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterNatNat64SubnetworkArgs']]] nat64_subnetworks: One or more subnetwork NAT configurations whose traffic should be translated by NAT64 Gateway.
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] nat_ip_allocate_option: How external IPs should be allocated for this NAT. Valid values are
               `AUTO_ONLY` for only allowing NAT IPs allocated by Google Cloud
               Platform, or `MANUAL_ONLY` for only user-allocated NAT IP addresses.
               Possible values are: `MANUAL_ONLY`, `AUTO_ONLY`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nat_ips: Self-links of NAT IPs. Only valid if natIpAllocateOption
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterNatRuleArgs']]] rules: A list of rules associated with this NAT.
               Structure is documented below.
        :param pulumi.Input[builtins.str] source_subnetwork_ip_ranges_to_nat64: Specify the Nat option for NAT64, which can take one of the following values:
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RouterNatSubnetworkArgs']]] subnetworks: One or more subnetwork NAT configurations. Only used if
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.int] tcp_established_idle_timeout_sec: Timeout (in seconds) for TCP established connections.
               Defaults to 1200s if not set.
        :param pulumi.Input[builtins.int] tcp_time_wait_timeout_sec: Timeout (in seconds) for TCP connections that are in TIME_WAIT state.
               Defaults to 120s if not set.
        :param pulumi.Input[builtins.int] tcp_transitory_idle_timeout_sec: Timeout (in seconds) for TCP transitory connections.
               Defaults to 30s if not set.
        :param pulumi.Input[builtins.str] type: Indicates whether this NAT is used for public or private IP translation.
               If unspecified, it defaults to PUBLIC.
               If `PUBLIC` NAT used for public IP translation.
               If `PRIVATE` NAT used for private IP translation.
               Default value is `PUBLIC`.
               Possible values are: `PUBLIC`, `PRIVATE`.
        :param pulumi.Input[builtins.int] udp_idle_timeout_sec: Timeout (in seconds) for UDP connections. Defaults to 30s if not set.
        """
    ...
    def source_subnetwork_ip_ranges_to_nat(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_subnetwork_ip_ranges_to_nat(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_subnetwork_ip_ranges_to_nat", value)

    @property
    @pulumi.getter(name="autoNetworkTier")
    def auto_network_tier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_network_tier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_network_tier", value)

    @property
    @pulumi.getter(name="drainNatIps")
    def drain_nat_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def drain_nat_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "drain_nat_ips", value)

    @property
    @pulumi.getter(name="enableDynamicPortAllocation")
    def enable_dynamic_port_allocation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_dynamic_port_allocation(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_dynamic_port_allocation", value)

    @property
    @pulumi.getter(name="enableEndpointIndependentMapping")
    def enable_endpoint_independent_mapping(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_endpoint_independent_mapping(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_endpoint_independent_mapping", value)

    @property
    @pulumi.getter(name="endpointTypes")
    def endpoint_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def endpoint_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "endpoint_types", value)

    @property
    @pulumi.getter(name="icmpIdleTimeoutSec")
    def icmp_idle_timeout_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def icmp_idle_timeout_sec(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "icmp_idle_timeout_sec", value)

    @property
    @pulumi.getter(name="initialNatIps")
    def initial_nat_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def initial_nat_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def max_ports_per_vm(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_ports_per_vm(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_ports_per_vm", value)

    @property
    @pulumi.getter(name="minPortsPerVm")
    def min_ports_per_vm(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_ports_per_vm(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def nat_ip_allocate_option(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nat_ip_allocate_option(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nat_ip_allocate_option", value)

    @property
    @pulumi.getter(name="natIps")
    def nat_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @nat_ips.setter
    def nat_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def source_subnetwork_ip_ranges_to_nat64(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_subnetwork_ip_ranges_to_nat64(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tcp_established_idle_timeout_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def tcp_established_idle_timeout_sec(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "tcp_established_idle_timeout_sec", value)

    @property
    @pulumi.getter(name="tcpTimeWaitTimeoutSec")
    def tcp_time_wait_timeout_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def tcp_time_wait_timeout_sec(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "tcp_time_wait_timeout_sec", value)

    @property
    @pulumi.getter(name="tcpTransitoryIdleTimeoutSec")
    def tcp_transitory_idle_timeout_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def tcp_transitory_idle_timeout_sec(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def udp_idle_timeout_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def udp_idle_timeout_sec(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _RouterNatState:
    def __init__(__self__, *,
                 ...
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['RouterNatRuleArgs']]]] = None,
                 source_subnetwork_ip_ranges_to_nat: Optional[pulumi.Input[builtins.str]] = None,
                 source_subnetwork_ip_ranges_to_nat64: Optional[pulumi.Input[builtins.str]] = None,
                 subnetworks: Optional[pulumi.Input[Sequence[pulumi.Input['RouterNatSubnetworkArgs']]]] = None,
                 tcp_established_idle_timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
                 tcp_time_wait_timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="sourceSubnetworkIpRangesToNat")
    def source_subnetwork_ip_ranges_to_nat(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        How NAT should be configured per Subnetwork.
        If `ALL_SUBNETWORKS_ALL_IP_RANGES`, all of the
        IP ranges in every Subnetwork are allowed to Nat.
    ...
    @source_subnetwork_ip_ranges_to_nat.setter
    def source_subnetwork_ip_ranges_to_nat(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_subnetwork_ip_ranges_to_nat", value)
...
class RouterNat(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tcp_transitory_idle_timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            udp_idle_timeout_sec: Optional[pulumi.Input[builtins.int]] = None) -> 'RouterNat':
        """
    ...
    @property
    @pulumi.getter(name="autoNetworkTier")
    def auto_network_tier(self) -> pulumi.Output[builtins.str]:
        """
        The network tier to use when automatically reserving NAT IP addresses.
        Must be one of: PREMIUM, STANDARD. If not specified, then the current
        project-level default tier is used.
    ...
    @property
    @pulumi.getter(name="drainNatIps")
    def drain_nat_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of URLs of the IP resources to be drained. These IPs must be
        valid static external IPs that have been assigned to the NAT.
        """
    ...
    @property
    @pulumi.getter(name="enableDynamicPortAllocation")
    def enable_dynamic_port_allocation(self) -> pulumi.Output[builtins.bool]:
        """
        Enable Dynamic Port Allocation.
        If minPortsPerVm is set, minPortsPerVm must be set to a power of two greater than or equal to 32.
        If minPortsPerVm is not set, a minimum of 32 ports will be allocated to a VM from this NAT config.
    ...
    @property
    @pulumi.getter(name="enableEndpointIndependentMapping")
    def enable_endpoint_independent_mapping(self) -> pulumi.Output[builtins.bool]:
        """
        Enable endpoint independent mapping.
        For more information see the [official documentation](https://cloud.google.com/nat/docs/overview#specs-rfcs).
        """
    ...
    @property
    @pulumi.getter(name="endpointTypes")
    def endpoint_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies the endpoint Types supported by the NAT Gateway.
        Supported values include:
        `ENDPOINT_TYPE_VM`, `ENDPOINT_TYPE_SWG`,
    ...
    @property
    @pulumi.getter(name="icmpIdleTimeoutSec")
    def icmp_idle_timeout_sec(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout (in seconds) for ICMP connections. Defaults to 30s if not set.
        """
        return pulumi.get(self, "icmp_idle_timeout_sec")
    ...
    @property
    @pulumi.getter(name="initialNatIps")
    def initial_nat_ips(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Self-links of NAT IPs to be used as initial value for creation alongside a RouterNatAddress resource.
        Conflicts with natIps and drainNatIps. Only valid if natIpAllocateOption is set to MANUAL_ONLY.
        """
    ...
    @property
    @pulumi.getter(name="maxPortsPerVm")
    def max_ports_per_vm(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum number of ports allocated to a VM from this NAT.
        This field can only be set when enableDynamicPortAllocation is enabled.
        """
    ...
    @property
    @pulumi.getter(name="minPortsPerVm")
    def min_ports_per_vm(self) -> pulumi.Output[builtins.int]:
        """
        Minimum number of ports allocated to a VM from this NAT. Defaults to 64 for static port allocation and 32 dynamic port allocation if not set.
        """
        return pulumi.get(self, "min_ports_per_vm")
    ...
    @property
    @pulumi.getter(name="natIpAllocateOption")
    def nat_ip_allocate_option(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        How external IPs should be allocated for this NAT. Valid values are
        `AUTO_ONLY` for only allowing NAT IPs allocated by Google Cloud
        Platform, or `MANUAL_ONLY` for only user-allocated NAT IP addresses.
    ...
    @property
    @pulumi.getter(name="natIps")
    def nat_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Self-links of NAT IPs. Only valid if natIpAllocateOption
        is set to MANUAL_ONLY.
        If this field is used alongside with a count created list of address resources `google_compute_address.foobar.*.self_link`,
    ...
    @property
    @pulumi.getter(name="sourceSubnetworkIpRangesToNat")
    def source_subnetwork_ip_ranges_to_nat(self) -> pulumi.Output[builtins.str]:
        """
        How NAT should be configured per Subnetwork.
        If `ALL_SUBNETWORKS_ALL_IP_RANGES`, all of the
        IP ranges in every Subnetwork are allowed to Nat.
    ...
    @property
    @pulumi.getter(name="sourceSubnetworkIpRangesToNat64")
    def source_subnetwork_ip_ranges_to_nat64(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the Nat option for NAT64, which can take one of the following values:
        ALL_IPV6_SUBNETWORKS: All of the IP ranges in every Subnetwork are allowed to Nat.
        LIST_OF_IPV6_SUBNETWORKS: A list of Subnetworks are allowed to Nat (specified in the field nat64Subnetwork below).
    ...
    @property
    @pulumi.getter(name="tcpEstablishedIdleTimeoutSec")
    def tcp_established_idle_timeout_sec(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout (in seconds) for TCP established connections.
        Defaults to 1200s if not set.
        """
    ...
    @property
    @pulumi.getter(name="tcpTimeWaitTimeoutSec")
    def tcp_time_wait_timeout_sec(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout (in seconds) for TCP connections that are in TIME_WAIT state.
        Defaults to 120s if not set.
        """
    ...
    @property
    @pulumi.getter(name="tcpTransitoryIdleTimeoutSec")
    def tcp_transitory_idle_timeout_sec(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout (in seconds) for TCP transitory connections.
        Defaults to 30s if not set.
        """
    ...
    @property
    @pulumi.getter(name="udpIdleTimeoutSec")
    def udp_idle_timeout_sec(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Timeout (in seconds) for UDP connections. Defaults to 30s if not set.
        """
        return pulumi.get(self, "udp_idle_timeout_sec")
