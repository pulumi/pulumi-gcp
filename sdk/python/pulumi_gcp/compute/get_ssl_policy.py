...
def get_ssl_policy(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the SSL Policy.
...
def get_ssl_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
