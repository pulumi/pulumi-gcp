...
class ImageIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['ImageIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `compute.ImageIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['ImageIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['ImageIamMemberConditionArgs']]):
...
@pulumi.type_token("gcp:compute/imageIamMember:ImageIamMember")
class ImageIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['ImageIamMemberConditionArgs', 'ImageIamMemberConditionArgsDict', 'outputs.ImageIamMemberCondition']]] = None,
                 image: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * {{name}}
        ...
        :param pulumi.Input[Union['ImageIamMemberConditionArgs', 'ImageIamMemberConditionArgsDict', 'outputs.ImageIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] image: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
    ...
    def get(resource_name: str,
            ...
            member: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'ImageIamMember':
        """
