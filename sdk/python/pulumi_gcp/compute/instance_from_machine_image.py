...
class InstanceFromMachineImageArgs:
    def __init__(__self__, *,
                 source_machine_image: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] source_machine_image: Name or self link of a machine
        ...
        :param pulumi.Input[builtins.bool] can_ip_forward: Whether sending and receiving of packets with non-matching source or destination IPs is allowed.
        :param pulumi.Input['InstanceFromMachineImageConfidentialInstanceConfigArgs'] confidential_instance_config: The Confidential VM config being used by the instance. on_host_maintenance has to be set to TERMINATE or this will fail
               to create.
        :param pulumi.Input[builtins.bool] deletion_protection: Whether deletion protection is enabled on this instance.
        :param pulumi.Input[builtins.str] description: A brief description of the resource.
        :param pulumi.Input[builtins.str] desired_status: Desired status of the instance. Either "RUNNING", "SUSPENDED" or "TERMINATED".
        :param pulumi.Input[builtins.bool] enable_display: Whether the instance has virtual displays enabled.
        ...
        :param pulumi.Input[builtins.str] hostname: A custom hostname for the instance. Must be a fully qualified DNS name and RFC-1035-valid. Valid format is a series of
        ...
        :param pulumi.Input[builtins.str] key_revocation_action_type: Action to be taken when a customer's encryption key is revoked. Supports "STOP" and "NONE", with "NONE" being the
               default.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs assigned to the instance. **Note**: This field is non-authoritative, and will only manage
               the labels present in your configuration. Please refer to the field 'effective_labels' for all of the labels present on
               the resource.
        :param pulumi.Input[builtins.str] machine_type: The machine type to create.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata key/value pairs made available within the instance.
        :param pulumi.Input[builtins.str] metadata_startup_script: Metadata startup scripts made available within the instance.
        :param pulumi.Input[builtins.str] min_cpu_platform: The minimum CPU platform specified for the VM instance.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] partner_metadata: Partner Metadata Map made available within the instance.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs. If self_link is provided, this value is ignored. If neither
        ...
        :param pulumi.Input[builtins.str] resource_policies: A list of self_links of resource policies to attach to the instance. Currently a max of 1 resource policy is supported.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The list of tags attached to the instance.
        :param pulumi.Input[builtins.str] zone: The zone that the machine should be created in. If not
    ...
    def source_machine_image(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_machine_image(self, value: pulumi.Input[builtins.str]):
...
class _InstanceFromMachineImageState:
    def __init__(__self__, *,
                 ...
                 service_account: Optional[pulumi.Input['InstanceFromMachineImageServiceAccountArgs']] = None,
                 shielded_instance_config: Optional[pulumi.Input['InstanceFromMachineImageShieldedInstanceConfigArgs']] = None,
                 source_machine_image: Optional[pulumi.Input[builtins.str]] = None,
                 source_machine_image_encryption_key: Optional[pulumi.Input['InstanceFromMachineImageSourceMachineImageEncryptionKeyArgs']] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] current_status: Current status of the instance. This could be one of the following values: PROVISIONING, STAGING, RUNNING, STOPPING,
    ...
    @property
    @pulumi.getter(name="sourceMachineImage")
    def source_machine_image(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name or self link of a machine
        image to create the instance based on.
    ...
    @source_machine_image.setter
    def source_machine_image(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_machine_image", value)
...
class InstanceFromMachineImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags_fingerprint: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceFromMachineImage':
        """
    ...
    @property
    @pulumi.getter(name="allowStoppingForUpdate")
    def allow_stopping_for_update(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "allow_stopping_for_update")
    ...
    @property
    @pulumi.getter(name="canIpForward")
    def can_ip_forward(self) -> pulumi.Output[builtins.bool]:
        """
        Whether sending and receiving of packets with non-matching source or destination IPs is allowed.
        """
        return pulumi.get(self, "can_ip_forward")
    ...
    @property
    @pulumi.getter(name="enableDisplay")
    def enable_display(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the instance has virtual displays enabled.
        """
        return pulumi.get(self, "enable_display")
    ...
    @property
    @pulumi.getter(name="keyRevocationActionType")
    def key_revocation_action_type(self) -> pulumi.Output[builtins.str]:
        """
        Action to be taken when a customer's encryption key is revoked. Supports "STOP" and "NONE", with "NONE" being the
        default.
        """
    ...
    @property
    @pulumi.getter(name="metadataStartupScript")
    def metadata_startup_script(self) -> pulumi.Output[builtins.str]:
        """
        Metadata startup scripts made available within the instance.
        """
        return pulumi.get(self, "metadata_startup_script")
    ...
    @property
    @pulumi.getter(name="partnerMetadata")
    def partner_metadata(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Partner Metadata Map made available within the instance.
        """
        return pulumi.get(self, "partner_metadata")
    ...
    @property
    @pulumi.getter(name="resourcePolicies")
    def resource_policies(self) -> pulumi.Output[builtins.str]:
        """
        A list of self_links of resource policies to attach to the instance. Currently a max of 1 resource policy is supported.
        """
        return pulumi.get(self, "resource_policies")
    ...
    @property
    @pulumi.getter(name="sourceMachineImage")
    def source_machine_image(self) -> pulumi.Output[builtins.str]:
        """
        Name or self link of a machine
        image to create the instance based on.
