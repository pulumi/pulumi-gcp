...
class RegionBackendServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RegionBackendServiceFailoverPolicyArgs'] failover_policy: Policy for failovers.
               Structure is documented below.
        :param pulumi.Input[builtins.str] health_checks: The set of URLs to HealthCheck resources for health checking
        ...
        :param pulumi.Input[builtins.str] load_balancing_scheme: Indicates what kind of load balancing this regional backend service
        ...
        :param pulumi.Input[builtins.str] name: Name of the resource. Provided by the client when the resource is
               ...
               - - -
        :param pulumi.Input[builtins.str] network: The URL of the network to which this backend service belongs.
...
class RegionBackendService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            strong_session_affinity_cookie: Optional[pulumi.Input[Union['RegionBackendServiceStrongSessionAffinityCookieArgs', 'RegionBackendServiceStrongSessionAffinityCookieArgsDict']]] = None,
            subsetting: Optional[pulumi.Input[Union['RegionBackendServiceSubsettingArgs', 'RegionBackendServiceSubsettingArgsDict']]] = None,
            timeout_sec: Optional[pulumi.Input[builtins.int]] = None) -> 'RegionBackendService':
        """
