...
def get_machine_types(filter: Optional[builtins.str] = None,
    ...
    * [Comparison Guide](https://cloud.google.com/compute/docs/machine-resource)
    ...
    :param builtins.str filter: A filter expression that filters machine types listed in the response.
    :param builtins.str project: Project from which to list available zones. Defaults to project declared in the provider.
    :param builtins.str zone: Zone from which to list machine types.
    """
    __args__ = dict()
...
def get_machine_types_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
