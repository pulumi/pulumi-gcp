...
def get_instance_serial_port(instance: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance: The name of the Compute Instance to read output from.
    :param _builtins.int port: The number of the serial port to read output from. Possible values are 1-4.
           
           ***
    :param _builtins.str project: The project in which the Compute Instance exists. If it
           is not provided, the provider project is used.
    :param _builtins.str zone: The zone in which the Compute Instance exists.
