...
def get_instance_serial_port(instance: Optional[builtins.str] = None,
    ...
    :param builtins.str instance: The name of the Compute Instance to read output from.
    :param builtins.int port: The number of the serial port to read output from. Possible values are 1-4.
           
           - - -
    :param builtins.str project: The project in which the Compute Instance exists. If it
           is not provided, the provider project is used.
    :param builtins.str zone: The zone in which the Compute Instance exists.
...
def get_instance_serial_port_output(instance: Optional[pulumi.Input[builtins.str]] = None,
