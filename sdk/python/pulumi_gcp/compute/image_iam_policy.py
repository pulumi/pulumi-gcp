...
class ImageIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] image: Used to find the parent resource to bind the IAM policy to
...
class ImageIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            image: pulumi.Input[Optional[_builtins.str]] = None,
            policy_data: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None) -> 'ImageIamPolicy':
        """
