...
class ImageIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image: Used to find the parent resource to bind the IAM policy to
...
class ImageIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            image: Optional[pulumi.Input[builtins.str]] = None,
            policy_data: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'ImageIamPolicy':
        """
