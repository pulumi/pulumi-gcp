...
def get_regions(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project: Project from which to list available regions. Defaults to project declared in the provider.
    :param _builtins.str status: Allows to filter list of regions based on their current status. Status can be either `UP` or `DOWN`.
