...
__all__ = ['ProjectDefaultNetworkTierArrgs', 'ProjectDefaultNetworkTier']

@pulumi.input_type
calass ProjectDefaultNetworkTierArrgs:
...
@pulumi.input_type
calass _ProjectDefaultNetworkTierState:
    def __init__(__self__, *,
...
calass ProjectDefaultNetworkTier(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ProjectDefaultNetworkTierArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Configures the Google Compute Engine
        [Default Network Tier](https://cloud.google.com/network-tiers/docs/using-network-service-tiers#setting_the_tier_for_all_resources_in_a_project)
        ...
        :param str resource_name: The name of the resource.
        :param ProjectDefaultNetworkTierArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProjectDefaultNetworkTierArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProjectDefaultNetworkTierArrgs.__new__(ProjectDefaultNetworkTierArrgs)
