...
def get_storage_pool_iam_policy(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str zone: A reference to the zone where the storage pool resides. Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_storage_pool_iam_policy_output(name: Optional[pulumi.Input[_builtins.str]] = None,
