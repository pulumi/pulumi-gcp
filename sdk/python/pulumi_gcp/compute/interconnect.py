...
class InterconnectArgs:
    def __init__(__self__, *,
                 interconnect_type: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] noc_contact_email: Email address to contact the customer NOC for operations and maintenance notifications
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] requested_features: interconnects.list of features requested for this Interconnect connection. Options: IF_MACSEC (
    ...
    def interconnect_type(self, value: pulumi.Input[_builtins.str]):
    ...
    def requested_link_count(self, value: pulumi.Input[_builtins.int]):
...
class _InterconnectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InterconnectApplicationAwareInterconnectArgs'] application_aware_interconnect: Configuration that enables Media Access Control security (MACsec) on the Cloud
               Interconnect connection between Google and your on-premises router.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] available_features: interconnects.list of features available for this Interconnect connection. Can take the value:
        ...
        :param pulumi.Input[_builtins.str] google_reference_id: Google reference ID to be used when raising support tickets with Google or otherwise to debug
               backend connectivity issues.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] interconnect_attachments: A list of the URLs of all InterconnectAttachments configured to use this Interconnect.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] interconnect_groups: URLs of InterconnectGroups that include this Interconnect.
