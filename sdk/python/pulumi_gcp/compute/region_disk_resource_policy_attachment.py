...
class RegionDiskResourcePolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] disk: The name of the regional disk in which the resource policies are attached to.
               
               
               - - -
        :param pulumi.Input[builtins.str] name: The resource policy to be attached to the disk for scheduling snapshot
...
@pulumi.type_token("gcp:compute/regionDiskResourcePolicyAttachment:RegionDiskResourcePolicyAttachment")
class RegionDiskResourcePolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionDiskResourcePolicyAttachment':
        """
