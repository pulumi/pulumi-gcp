...
class PerInstanceConfigArgs:
    def __init__(__self__, *,
                 ...
                 minimal_action: Optional[pulumi.Input[builtins.str]] = None,
                 most_disruptive_allowed_action: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 preserved_state: Optional[pulumi.Input['PerInstanceConfigPreservedStateArgs']] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 remove_instance_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 remove_instance_state_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] minimal_action: The minimal action to perform on the instance during an update.
               ...
               * REFRESH
               * NONE
        :param pulumi.Input[builtins.str] most_disruptive_allowed_action: The most disruptive action to perform on the instance during an update.
               Default is `REPLACE`. Possible values are:
               * REPLACE
               * RESTART
               * REFRESH
               * NONE
        :param pulumi.Input[builtins.str] name: The name for this per-instance config and its corresponding instance.
        ...
        :param pulumi.Input[builtins.bool] remove_instance_on_destroy: When true, deleting this config will immediately remove the underlying instance.
               When false, deleting this config will use the behavior as determined by remove_instance_on_destroy.
        :param pulumi.Input[builtins.bool] remove_instance_state_on_destroy: When true, deleting this config will immediately remove any specified state from the underlying instance.
               When false, deleting this config will *not* immediately remove any state from the underlying instance.
               State will be removed on the next instance recreation or update.
        :param pulumi.Input[builtins.str] zone: Zone where the containing instance group manager is located
        """
    ...
    def minimal_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def minimal_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "minimal_action", value)

    @property
    @pulumi.getter(name="mostDisruptiveAllowedAction")
    def most_disruptive_allowed_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def most_disruptive_allowed_action(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def remove_instance_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def remove_instance_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "remove_instance_on_destroy", value)

    @property
    @pulumi.getter(name="removeInstanceStateOnDestroy")
    def remove_instance_state_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def remove_instance_state_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PerInstanceConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remove_instance_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
            remove_instance_state_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'PerInstanceConfig':
        """
    ...
    @property
    @pulumi.getter(name="minimalAction")
    def minimal_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The minimal action to perform on the instance during an update.
        Default is `NONE`. Possible values are:
        * REPLACE
    ...
    @property
    @pulumi.getter(name="mostDisruptiveAllowedAction")
    def most_disruptive_allowed_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The most disruptive action to perform on the instance during an update.
        Default is `REPLACE`. Possible values are:
        * REPLACE
    ...
    @property
    @pulumi.getter(name="removeInstanceOnDestroy")
    def remove_instance_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, deleting this config will immediately remove the underlying instance.
        When false, deleting this config will use the behavior as determined by remove_instance_on_destroy.
        """
    ...
    @property
    @pulumi.getter(name="removeInstanceStateOnDestroy")
    def remove_instance_state_on_destroy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, deleting this config will immediately remove any specified state from the underlying instance.
        When false, deleting this config will *not* immediately remove any state from the underlying instance.
        State will be removed on the next instance recreation or update.
