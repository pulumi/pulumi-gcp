...
class PerInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] minimal_action: The minimal action to perform on the instance during an update.
               ...
               * REFRESH
               * NONE
        :param pulumi.Input[_builtins.str] most_disruptive_allowed_action: The most disruptive action to perform on the instance during an update.
        ...
        :param pulumi.Input[_builtins.bool] remove_instance_on_destroy: When true, deleting this config will immediately remove the underlying instance.
               When false, deleting this config will use the behavior as determined by remove_instance_on_destroy.
        :param pulumi.Input[_builtins.bool] remove_instance_state_on_destroy: When true, deleting this config will immediately remove any specified state from the underlying instance.
