...
__all__ = ['AutoscalarArgs', 'Autoscalar']

@pulumi.input_type
class AutoscalarArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AutoscalarAutoscalingPolicyArgs'] autoscaling_policy: The configuration parameters for the autoscaling algorithm. You can
    ...
    def autoscaling_policy(self) -> pulumi.Input['AutoscalarAutoscalingPolicyArgs']:
        """
    ...
    def autoscaling_policy(self, value: pulumi.Input['AutoscalarAutoscalingPolicyArgs']):
...
class _AutoscalarState:
    ...
    @property
    @pulumi.getter(name="autoscalingPolicy")
    def autoscaling_policy(self) -> Optional[pulumi.Input['AutoscalarAutoscalingPolicyArgs']]:
        """
        The configuration parameters for the autoscaling algorithm. You can
        define one or more of the policies for an autoscaler: cpuUtilization,
        customMetricUtilizations, and loadBalancingUtilization.
    ...
    @autoscaling_policy.setter
    def autoscaling_policy(self, value: Optional[pulumi.Input['AutoscalarAutoscalingPolicyArgs']]):
        pulumi.set(self, "autoscaling_policy", value)
...
class Autoscalar(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * How-to Guides
        ...
        Autoscaler can be imported using any of these accepted formats* `projects/{{project}}/zones/{{zone}}/autoscalers/{{name}}` * `{{project}}/{{zone}}/{{name}}` * `{{zone}}/{{name}}` * `{{name}}` In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import Autoscaler using one of the formats above. For exampletf import {
        ...
        ```sh
         $ pulumi import gcp:compute/autoscalar:Autoscalar When using the [`terraform import` command](https://developer.hashicorp.com/terraform/cli/commands/import), Autoscaler can be imported using one of the formats above. For example
        ```
    ...
    def get(resource_name: str,
        ...
        __props__ = _AutoscalarState.__new__(_AutoscalarState)
