...
class RegionNetworkEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Region where the containing network endpoint group is located.
        """
    ...
    def region_network_endpoint_group(self, value: pulumi.Input[_builtins.str]):
...
class _RegionNetworkEndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip_address: IPv4 address external endpoint.
               This can only be specified when network_endpoint_type of the NEG is INTERNET_IP_PORT.
        :param pulumi.Input[_builtins.int] network_endpoint_id: The unique identifier number for the resource. This identifier is defined by the server.
        :param pulumi.Input[_builtins.int] port: Port number of network endpoint.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] region: Region where the containing network endpoint group is located.
