...
class TargetPoolArgs:
    def __init__(__self__, *,
                 backup_pool: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 failover_ratio: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] backup_pool: URL to the backup target pool. Must also set
               failover_ratio.
        :param pulumi.Input[builtins.str] description: Textual description field.
        :param pulumi.Input[builtins.float] failover_ratio: Ratio (0 to 1) of failed nodes before using the
               backup pool (which must also be set).
        :param pulumi.Input[builtins.str] health_checks: List of zero or one health check name or self_link. Only
               legacy `compute.HttpHealthCheck` is supported.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: List of instances in the pool. They can be given as
               URLs, or in the form of "zone/name". Note that the instances need not exist
               at the time of target pool creation, so there is no need to use the
               interpolation to create a dependency on the instances from the
               target pool.
        :param pulumi.Input[builtins.str] name: A unique name for the resource, required by GCE. Changing
               this forces a new resource to be created.
               
               - - -
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs. If it
               is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] region: Where the target pool resides. Defaults to project
               region.
        :param pulumi.Input[builtins.str] security_policy: The resource URL for the security policy associated with this target pool.
        :param pulumi.Input[builtins.str] session_affinity: How to distribute load. Options are "NONE" (no
    ...
    def backup_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @backup_pool.setter
    def backup_pool(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def failover_ratio(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def failover_ratio(self, value: Optional[pulumi.Input[builtins.float]]):
...
class TargetPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            security_policy: Optional[pulumi.Input[builtins.str]] = None,
            self_link: Optional[pulumi.Input[builtins.str]] = None,
            session_affinity: Optional[pulumi.Input[builtins.str]] = None) -> 'TargetPool':
        """
    ...
    @property
    @pulumi.getter(name="backupPool")
    def backup_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL to the backup target pool. Must also set
        failover_ratio.
        """
    ...
    @property
    @pulumi.getter(name="failoverRatio")
    def failover_ratio(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Ratio (0 to 1) of failed nodes before using the
        backup pool (which must also be set).
        """
    ...
    @property
    @pulumi.getter(name="sessionAffinity")
    def session_affinity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        How to distribute load. Options are "NONE" (no
        affinity). "CLIENT_IP" (hash of the source/dest addresses / ports), and
        "CLIENT_IP_PROTO" also includes the protocol (default "NONE").
