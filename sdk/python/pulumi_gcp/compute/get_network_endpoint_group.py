...
def get_network_endpoint_group(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The Network Endpoint Group name.
    ...
    :param _builtins.str zone: The Network Endpoint Group availability zone.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_network_endpoint_group_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
