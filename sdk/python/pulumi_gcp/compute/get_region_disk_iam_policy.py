...
def get_region_disk_iam_policy(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: A reference to the region where the disk resides. Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_region_disk_iam_policy_output(name: pulumi.Input[Optional[_builtins.str]] = None,
