...
class NodeGroupArgs:
    def __init__(__self__, *,
                 node_template: pulumi.Input[builtins.str],
                 autoscaling_policy: Optional[pulumi.Input['NodeGroupAutoscalingPolicyArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 initial_size: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] description: An optional textual description of the resource.
        :param pulumi.Input[builtins.int] initial_size: The initial number of nodes in the node group. One of `initial_size` or `autoscaling_policy` must be configured on resource creation.
        :param pulumi.Input[builtins.str] maintenance_interval: Specifies the frequency of planned maintenance events. Set to one of the following:
               - AS_NEEDED: Hosts are eligible to receive infrastructure and hypervisor updates as they become available.
               - RECURRENT: Hosts receive planned infrastructure and hypervisor updates on a periodic basis, but not more frequently than every 28 days. This minimizes the number of planned maintenance operations on individual hosts and reduces the frequency of disruptions, both live migrations and terminations, on individual VMs.
               Possible values are: `AS_NEEDED`, `RECURRENT`.
        :param pulumi.Input[builtins.str] maintenance_policy: Specifies how to handle instances when a node in the group undergoes maintenance. Set to one of: DEFAULT, RESTART_IN_PLACE, or MIGRATE_WITHIN_NODE_GROUP. The default value is DEFAULT.
        ...
        :param pulumi.Input['NodeGroupShareSettingsArgs'] share_settings: Share settings for the node group.
               Structure is documented below.
        :param pulumi.Input[builtins.str] zone: Zone where this node group is located
        """
    ...
    def node_template(self, value: pulumi.Input[builtins.str]):
    ...
    def initial_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @initial_size.setter
    def initial_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _NodeGroupState:
    def __init__(__self__, *,
                 ...
                 maintenance_window: Optional[pulumi.Input['NodeGroupMaintenanceWindowArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 node_template: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['NodeGroupShareSettingsArgs'] share_settings: Share settings for the node group.
               Structure is documented below.
        :param pulumi.Input[builtins.int] size: The total number of nodes in the node group.
        :param pulumi.Input[builtins.str] zone: Zone where this node group is located
        """
        if autoscaling_policy is not None:
            pulumi.set(__self__, "autoscaling_policy", autoscaling_policy)
    ...
    @node_template.setter
    def node_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_template", value)
...
class NodeGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            share_settings: Optional[pulumi.Input[Union['NodeGroupShareSettingsArgs', 'NodeGroupShareSettingsArgsDict']]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'NodeGroup':
        """
    ...
    @property
    @pulumi.getter(name="initialSize")
    def initial_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The initial number of nodes in the node group. One of `initial_size` or `autoscaling_policy` must be configured on resource creation.
        """
        return pulumi.get(self, "initial_size")
    ...
    @property
    @pulumi.getter(name="maintenanceInterval")
    def maintenance_interval(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the frequency of planned maintenance events. Set to one of the following:
        - AS_NEEDED: Hosts are eligible to receive infrastructure and hypervisor updates as they become available.
        - RECURRENT: Hosts receive planned infrastructure and hypervisor updates on a periodic basis, but not more frequently than every 28 days. This minimizes the number of planned maintenance operations on individual hosts and reduces the frequency of disruptions, both live migrations and terminations, on individual VMs.
    ...
    @property
    @pulumi.getter(name="maintenancePolicy")
    def maintenance_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies how to handle instances when a node in the group undergoes maintenance. Set to one of: DEFAULT, RESTART_IN_PLACE, or MIGRATE_WITHIN_NODE_GROUP. The default value is DEFAULT.
        """
        return pulumi.get(self, "maintenance_policy")
