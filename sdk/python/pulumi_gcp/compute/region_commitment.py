...
class RegionCommitmentArgs:
    def __init__(__self__, *,
                 ...
                 existing_reservations: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] plan: The plan for this commitment, which determines duration and discount rate.
               The currently supported plans are TWELVE_MONTH (1 year), and THIRTY_SIX_MONTH (3 years).
               Possible values are: `TWELVE_MONTH`, `THIRTY_SIX_MONTH`.
               
               
               - - -
        :param pulumi.Input[builtins.bool] auto_renew: Specifies whether to enable automatic renewal for the commitment.
               The default value is false if not specified.
               If the field is set to true, the commitment will be automatically renewed for either
               one or three years according to the terms of the existing commitment.
        :param pulumi.Input[builtins.str] category: The category of the commitment. Category MACHINE specifies commitments composed of
        ...
        :param pulumi.Input[builtins.str] existing_reservations: Specifies the already existing reservations to attach to the Commitment.
        ...
        :param pulumi.Input[builtins.str] region: URL of the region where this commitment may be used.
        :param pulumi.Input[Sequence[pulumi.Input['RegionCommitmentResourceArgs']]] resources: A list of commitment amounts for particular resources.
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] type: The type of commitment, which affects the discount rate and the eligible resources.
    ...
    def existing_reservations(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def existing_reservations(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RegionCommitmentState:
    def __init__(__self__, *,
                 auto_renew: Optional[pulumi.Input[builtins.bool]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 commitment_id: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] category: The category of the commitment. Category MACHINE specifies commitments composed of
               ...
               Note that only MACHINE commitments should have a Type specified.
               Possible values are: `LICENSE`, `MACHINE`.
        :param pulumi.Input[builtins.int] commitment_id: Unique identifier for the resource.
        :param pulumi.Input[builtins.str] creation_timestamp: Creation timestamp in RFC3339 text format.
        :param pulumi.Input[builtins.str] description: An optional description of this resource.
        :param pulumi.Input[builtins.str] end_timestamp: Commitment end time in RFC3339 text format.
        :param pulumi.Input[builtins.str] existing_reservations: Specifies the already existing reservations to attach to the Commitment.
        :param pulumi.Input['RegionCommitmentLicenseResourceArgs'] license_resource: The license specification required as part of a license commitment.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: Name of the resource. The name must be 1-63 characters long and match
        ...
        :param pulumi.Input[builtins.str] start_timestamp: Commitment start time in RFC3339 text format.
        :param pulumi.Input[builtins.str] status: Status of the commitment with regards to eventual expiration
               (each commitment has an end date defined).
        :param pulumi.Input[builtins.str] status_message: A human-readable explanation of the status.
        :param pulumi.Input[builtins.str] type: The type of commitment, which affects the discount rate and the eligible resources.
               The type could be one of the following value: `MEMORY_OPTIMIZED`, `ACCELERATOR_OPTIMIZED`,
               `GENERAL_PURPOSE_N1`, `GENERAL_PURPOSE_N2`, `GENERAL_PURPOSE_N2D`, `GENERAL_PURPOSE_E2`,
               `GENERAL_PURPOSE_T2D`, `GENERAL_PURPOSE_C3`, `COMPUTE_OPTIMIZED_C2`, `COMPUTE_OPTIMIZED_C2D` and
    ...
    def commitment_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def commitment_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RegionCommitment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            status_message: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionCommitment':
        """
    ...
    @property
    @pulumi.getter(name="commitmentId")
    def commitment_id(self) -> pulumi.Output[builtins.int]:
        """
        Unique identifier for the resource.
        """
        return pulumi.get(self, "commitment_id")
    ...
    @property
    @pulumi.getter(name="endTimestamp")
    def end_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Commitment end time in RFC3339 text format.
        """
        return pulumi.get(self, "end_timestamp")
    ...
    @property
    @pulumi.getter(name="existingReservations")
    def existing_reservations(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the already existing reservations to attach to the Commitment.
        """
        return pulumi.get(self, "existing_reservations")
    ...
    @property
    @pulumi.getter(name="startTimestamp")
    def start_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Commitment start time in RFC3339 text format.
        """
        return pulumi.get(self, "start_timestamp")
