...
class RegionCommitmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] category: The category of the commitment. Category MACHINE specifies commitments composed of
...
class _RegionCommitmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] category: The category of the commitment. Category MACHINE specifies commitments composed of
               ...
               Note that only MACHINE commitments should have a Type specified.
               Possible values are: `LICENSE`, `MACHINE`.
        :param pulumi.Input[_builtins.int] commitment_id: Unique identifier for the resource.
        ...
        :param pulumi.Input[_builtins.str] start_timestamp: Commitment start time in RFC3339 text format.
        :param pulumi.Input[_builtins.str] status: Status of the commitment with regards to eventual expiration
               (each commitment has an end date defined).
        :param pulumi.Input[_builtins.str] status_message: A human-readable explanation of the status.
        :param pulumi.Input[_builtins.str] type: The type of commitment, which affects the discount rate and the eligible resources.
               The type could be one of the following value: `MEMORY_OPTIMIZED`, `ACCELERATOR_OPTIMIZED`,
               `GENERAL_PURPOSE`, `GENERAL_PURPOSE_N2`, `GENERAL_PURPOSE_N2D`, `GENERAL_PURPOSE_E2`,
               `GENERAL_PURPOSE_T2D`, `GENERAL_PURPOSE_C3`, `COMPUTE_OPTIMIZED_C2`, `COMPUTE_OPTIMIZED_C2D` and
