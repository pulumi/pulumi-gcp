...
class RegionPerInstanceConfigArgs:
    def __init__(__self__, *,
                 region_instance_group_manager: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] region_instance_group_manager: The region instance group manager this instance config is part of.
        ...
        :param pulumi.Input[builtins.str] region: Region where the containing instance group manager is located
    ...
    def region_instance_group_manager(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def region_instance_group_manager(self, value: pulumi.Input[builtins.str]):
...
class _RegionPerInstanceConfigState:
    def __init__(__self__, *,
                 ...
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 region_instance_group_manager: Optional[pulumi.Input[builtins.str]] = None,
                 remove_instance_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 remove_instance_state_on_destroy: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    @property
    @pulumi.getter(name="regionInstanceGroupManager")
    def region_instance_group_manager(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The region instance group manager this instance config is part of.
    ...
    @region_instance_group_manager.setter
    def region_instance_group_manager(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "region_instance_group_manager", value)
...
class RegionPerInstanceConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region_instance_group_manager: Optional[pulumi.Input[builtins.str]] = None,
            remove_instance_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
            remove_instance_state_on_destroy: Optional[pulumi.Input[builtins.bool]] = None) -> 'RegionPerInstanceConfig':
        """
    ...
    @property
    @pulumi.getter(name="regionInstanceGroupManager")
    def region_instance_group_manager(self) -> pulumi.Output[builtins.str]:
        """
        The region instance group manager this instance config is part of.
