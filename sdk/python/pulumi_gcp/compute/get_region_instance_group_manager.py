...
class GetRegionInstanceGroupManagerResult:
    ...
    def distribution_policy_zones(self) -> Sequence[builtins.str]:
    ...
    def instance_group_manager_id(self) -> builtins.int:
    ...
    def wait_for_instances(self) -> builtins.bool:
...
def get_region_instance_group_manager(name: Optional[builtins.str] = None,
...
def get_region_instance_group_manager_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
