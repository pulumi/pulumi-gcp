...
class GetRegionInstanceGroupManagerResult:
    ...
    def target_size_policies(self) -> Sequence['outputs.GetRegionInstanceGroupManagerTargetSizePolicyResult']:
...
def get_region_instance_group_manager(name: Optional[_builtins.str] = None,
