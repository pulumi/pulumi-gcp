...
def get_subnetworks(filter: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: A string filter as defined in the [REST API](https://cloud.google.com/compute/docs/reference/rest/v1/subnetworks/list#query-parameters).
...
def get_subnetworks_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
