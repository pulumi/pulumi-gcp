...
class RegionDiskIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: A reference to the region where the disk resides. Used to find the parent resource to bind the IAM policy to. If not specified,
...
class RegionDiskIamBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionDiskIamBinding':
        """
