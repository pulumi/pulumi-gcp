...
class InstanceIAMPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] zone: A reference to the zone where the machine resides. Used to find the parent resource to bind the IAM policy to. If not specified,
...
@pulumi.type_token("gcp:compute/instanceIAMPolicy:InstanceIAMPolicy")
class InstanceIAMPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `compute.InstanceIAMBinding`: Authoritative for a given role and condition combination (the condition can be omitted). Updates the IAM policy to grant a role to a list of members. Other role and condition combinations within the IAM policy for the instance are preserved. Members added outside of Terraform for the same role and condition combination will be detected as drift and removed on the next `pulumi up`.
        * `compute.InstanceIAMMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the instance are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `compute.InstanceIAMPolicy`: Retrieves the IAM policy for the instance
        ...
        > **Note:** `compute.InstanceIAMBinding` resources **can be** used in conjunction with `compute.InstanceIAMMember` resources **only if** they do not grant privilege to the same role and condition combination.
    ...
    def get(resource_name: str,
            ...
            policy_data: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            zone: pulumi.Input[Optional[_builtins.str]] = None) -> 'InstanceIAMPolicy':
        """
