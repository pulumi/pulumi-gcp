...
class GetGlobalForwardingRuleResult:
    ...
    def allow_psc_global_access(self) -> builtins.bool:
    ...
    def no_automate_dns_zone(self) -> builtins.bool:
    ...
    def source_ip_ranges(self) -> Sequence[builtins.str]:
...
def get_global_forwarding_rule(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the global forwarding rule.
...
def get_global_forwarding_rule_output(name: Optional[pulumi.Input[builtins.str]] = None,
