...
def get_region_instance_group(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: The region in which the resource belongs.  If `self_link`
...
def get_region_instance_group_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
