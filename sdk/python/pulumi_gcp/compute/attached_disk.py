...
class AttachedDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] disk: `name` or `self_link` of the disk that will be attached.
               ...
               - - -
        :param pulumi.Input[_builtins.str] instance: `name` or `self_link` of the compute instance that the disk will be attached to.
        ...
        :param pulumi.Input[_builtins.str] interface: The disk interface used for attaching this disk.
               ...
               "SCSI"
               "NVME"
        :param pulumi.Input[_builtins.str] mode: The mode in which to attach this disk, either READ_WRITE or
               ...
               "READ_ONLY"
               "READ_WRITE"
        :param pulumi.Input[_builtins.str] project: The project that the referenced compute instance is a part of. If `instance` is referenced by its
...
class AttachedDisk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mode: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'AttachedDisk':
        """
