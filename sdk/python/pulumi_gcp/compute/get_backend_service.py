...
class GetBackendServiceResult:
    ...
    def custom_request_headers(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "custom_request_headers")

    @property
    @pulumi.getter(name="customResponseHeaders")
    def custom_response_headers(self) -> Sequence[builtins.str]:
...
def get_backend_service(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Backend Service.
           
           - - -
    :param builtins.str project: The project in which the resource belongs. If it is not provided, the provider project is used.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_backend_service_output(name: Optional[pulumi.Input[builtins.str]] = None,
