...
class GetRegionDiskResult:
    ...
    def replica_zones(self) -> Sequence[builtins.str]:
...
def get_region_disk(name: Optional[builtins.str] = None,
    ...
    :param builtins.str region: A reference to the region where the disk resides.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_region_disk_output(name: Optional[pulumi.Input[builtins.str]] = None,
