...
def get_region_backend_service_iam_policy(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: The Region in which the created backend service should reside.
...
def get_region_backend_service_iam_policy_output(name: Optional[pulumi.Input[_builtins.str]] = None,
