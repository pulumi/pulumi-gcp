...
def get_region_backend_service_iam_policy(name: Optional[builtins.str] = None,
    ...
    :param builtins.str region: The Region in which the created backend service should reside.
...
def get_region_backend_service_iam_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
