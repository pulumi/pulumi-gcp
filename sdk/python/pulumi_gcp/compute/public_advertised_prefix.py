...
class PublicAdvertisedPrefixArgs:
    def __init__(__self__, *,
                 dns_verification_ip: pulumi.Input[builtins.str],
                 ip_cidr_range: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 pdp_scope: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] pdp_scope: Specifies how child public delegated prefix will be scoped. pdpScope
    ...
    def dns_verification_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dns_verification_ip(self, value: pulumi.Input[builtins.str]):
    ...
    def pdp_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pdp_scope.setter
    def pdp_scope(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PublicAdvertisedPrefixState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 dns_verification_ip: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] shared_secret: Output Only. The shared secret to be used for reverse DNS verification.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter(name="dnsVerificationIp")
    def dns_verification_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IPv4 address to be used for reverse DNS verification.
        """
        return pulumi.get(self, "dns_verification_ip")
    ...
    @dns_verification_ip.setter
    def dns_verification_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_verification_ip", value)
...
class PublicAdvertisedPrefix(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            self_link: Optional[pulumi.Input[builtins.str]] = None,
            shared_secret: Optional[pulumi.Input[builtins.str]] = None) -> 'PublicAdvertisedPrefix':
        """
    ...
    @property
    @pulumi.getter(name="dnsVerificationIp")
    def dns_verification_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IPv4 address to be used for reverse DNS verification.
        """
        return pulumi.get(self, "dns_verification_ip")
    ...
    @property
    @pulumi.getter(name="pdpScope")
    def pdp_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies how child public delegated prefix will be scoped. pdpScope
        must be one of: GLOBAL, REGIONAL
        * REGIONAL: The public delegated prefix is regional only. The
