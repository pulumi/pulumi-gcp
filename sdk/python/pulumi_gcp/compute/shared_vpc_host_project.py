...
__all__ = ['SharedVPCHostProjectArrgs', 'SharedVPCHostProject']

@pulumi.input_type
calass SharedVPCHostProjectArrgs:
...
@pulumi.input_type
calass _SharedVPCHostProjectState:
    def __init__(__self__, *,
...
calass SharedVPCHostProject(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SharedVPCHostProjectArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Enables the Google Compute Engine
        [Shared VPC](https://cloud.google.com/compute/docs/shared-vpc)
        ...
        :param str resource_name: The name of the resource.
        :param SharedVPCHostProjectArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SharedVPCHostProjectArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SharedVPCHostProjectArrgs.__new__(SharedVPCHostProjectArrgs)
