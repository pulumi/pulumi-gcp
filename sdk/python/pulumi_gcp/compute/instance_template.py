...
class InstanceTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceTemplateDiskArgs']]] disks: Disks to attach to instances created from this template.
               ...
               documented below.
        :param pulumi.Input[builtins.str] machine_type: The machine type to create. To create a machine with a custom type (such as extended memory), format the value like
        ...
        :param pulumi.Input[builtins.str] instance_description: A brief description to use for instances
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs to assign to instances
               created from this template.
        ...
        :param pulumi.Input[builtins.str] min_cpu_platform: Specifies a minimum CPU platform. Applicable values are the friendly names of CPU platforms, such as
               `Intel Haswell` or `Intel Skylake`. See the complete list [here](https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform).
        :param pulumi.Input[builtins.str] name: The name of the instance template. If you leave
        ...
        :param pulumi.Input[builtins.str] region: An instance template is a global resource that is not
        ...
        :param pulumi.Input['InstanceTemplateReservationAffinityArgs'] reservation_affinity: Specifies the reservations that this instance can consume from.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] resource_manager_tags: A set of key/value resource manager tag pairs to bind to the instances. Keys must be in the format tagKeys/{tag_key_id}, and values are in the format tagValues/456.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags to attach to the instance.
        """
...
class _InstanceTemplateState:
    def __init__(__self__, *,
                 ...
                 self_link_unique: Optional[pulumi.Input[builtins.str]] = None,
                 service_account: Optional[pulumi.Input['InstanceTemplateServiceAccountArgs']] = None,
                 shielded_instance_config: Optional[pulumi.Input['InstanceTemplateShieldedInstanceConfigArgs']] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] self_link_unique: A special URI of the created resource that uniquely identifies this instance template with the following format: `projects/{{project}}/global/instanceTemplates/{{name}}?uniqueId={{uniqueId}}`
    ...
    def self_link_unique(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def self_link_unique(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_affinity: Optional[pulumi.Input[Union['InstanceTemplateReservationAffinityArgs', 'InstanceTemplateReservationAffinityArgsDict']]] = None,
                 resource_manager_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 resource_policies: Optional[pulumi.Input[builtins.str]] = None,
                 scheduling: Optional[pulumi.Input[Union['InstanceTemplateSchedulingArgs', 'InstanceTemplateSchedulingArgsDict']]] = None,
                 service_account: Optional[pulumi.Input[Union['InstanceTemplateServiceAccountArgs', 'InstanceTemplateServiceAccountArgsDict']]] = None,
                 shielded_instance_config: Optional[pulumi.Input[Union['InstanceTemplateShieldedInstanceConfigArgs', 'InstanceTemplateShieldedInstanceConfigArgsDict']]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            shielded_instance_config: Optional[pulumi.Input[Union['InstanceTemplateShieldedInstanceConfigArgs', 'InstanceTemplateShieldedInstanceConfigArgsDict']]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags_fingerprint: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceTemplate':
        """
    ...
    @property
    @pulumi.getter(name="instanceDescription")
    def instance_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A brief description to use for instances
        created from this template.
        """
    ...
    @property
    @pulumi.getter(name="resourceManagerTags")
    def resource_manager_tags(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        A set of key/value resource manager tag pairs to bind to the instances. Keys must be in the format tagKeys/{tag_key_id}, and values are in the format tagValues/456.
        """
        return pulumi.get(self, "resource_manager_tags")
    ...
    @property
    @pulumi.getter(name="selfLinkUnique")
    def self_link_unique(self) -> pulumi.Output[builtins.str]:
        """
        A special URI of the created resource that uniquely identifies this instance template with the following format: `projects/{{project}}/global/instanceTemplates/{{name}}?uniqueId={{uniqueId}}`
        Referencing an instance template via this attribute prevents Time of Check to Time of Use attacks when the instance template resides in a shared/untrusted environment.
        """
