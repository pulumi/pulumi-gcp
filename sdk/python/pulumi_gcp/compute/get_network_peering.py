...
class GetNetworkPeeringResult:
    ...
    def export_custom_routes(self) -> builtins.bool:
        return pulumi.get(self, "export_custom_routes")

    @property
    @pulumi.getter(name="exportSubnetRoutesWithPublicIp")
    def export_subnet_routes_with_public_ip(self) -> builtins.bool:
    ...
    def import_custom_routes(self) -> builtins.bool:
        return pulumi.get(self, "import_custom_routes")

    @property
    @pulumi.getter(name="importSubnetRoutesWithPublicIp")
    def import_subnet_routes_with_public_ip(self) -> builtins.bool:
...
def get_network_peering(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the peering.
    :param builtins.str network: The primary network of the peering.
    """
    __args__ = dict()
    __args__['name'] = name
