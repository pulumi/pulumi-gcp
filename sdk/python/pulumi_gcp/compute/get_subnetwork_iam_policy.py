...
def get_subnetwork_iam_policy(project: Optional[builtins.str] = None,
    ...
    :param builtins.str region: The GCP region for this subnetwork.
           Used to find the parent resource to bind the IAM policy to. If not specified,
           the value will be parsed from the identifier of the parent resource. If no region is provided in the parent identifier and no
           region is specified, it is taken from the provider configuration.
    :param builtins.str subnetwork: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_subnetwork_iam_policy_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
