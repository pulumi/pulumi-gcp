...
class FirewallPolicyRuleArgs:
    def __init__(__self__, *,
                 ...
                 target_secure_tags: pulumi.Input[Optional[Sequence[pulumi.Input['FirewallPolicyRuleTargetSecureTagArgs']]]] = None,
    ...
    def target_secure_tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FirewallPolicyRuleTargetSecureTagArgs']]]]:
        """
    ...
    def target_secure_tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FirewallPolicyRuleTargetSecureTagArgs']]]]):
...
class _FirewallPolicyRuleState:
    def __init__(__self__, *,
                 ...
                 match: pulumi.Input[Optional['FirewallPolicyRuleMatchArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def match(self) -> pulumi.Input[Optional['FirewallPolicyRuleMatchArgs']]:
        """
        A match condition that incoming traffic is evaluated against. If it evaluates to true, the corresponding 'action' is enforced.
        Structure is documented below.
        """
    ...
    @match.setter
    def match(self, value: pulumi.Input[Optional['FirewallPolicyRuleMatchArgs']]):
        pulumi.set(self, "match", value)
