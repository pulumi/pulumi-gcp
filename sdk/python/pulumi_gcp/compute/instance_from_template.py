...
class InstanceFromTemplateArgs:
    def __init__(__self__, *,
                 source_instance_template: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] source_instance_template: Name or self link of an instance
    ...
    def source_instance_template(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_instance_template(self, value: pulumi.Input[builtins.str]):
...
class InstanceFromTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags_fingerprint: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstanceFromTemplate':
        """
    ...
    @property
    @pulumi.getter(name="sourceInstanceTemplate")
    def source_instance_template(self) -> pulumi.Output[builtins.str]:
        """
        Name or self link of an instance
        template to create the instance based on. It is recommended to reference
        instance templates through their unique id (`self_link_unique` attribute).
