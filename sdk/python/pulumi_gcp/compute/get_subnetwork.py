...
def get_subnetwork(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the subnetwork. One of `name` or `self_link`
           must be specified.
    ...
    :param _builtins.str self_link: The self link of the subnetwork. If `self_link` is
...
def get_subnetwork_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
