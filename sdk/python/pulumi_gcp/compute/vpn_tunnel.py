...
class VPNTunnelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] ike_version: IKE protocol version to use when establishing the VPN tunnel with
               peer VPN gateway.
               Acceptable IKE versions are 1 or 2. Default version is 2.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels to apply to this VpnTunnel.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] local_traffic_selectors: Local traffic selector to use when establishing the VPN tunnel with
        ...
        :param pulumi.Input[_builtins.str] peer_ip: IP address of the peer VPN gateway. Only IPv4 is supported.
        ...
        :param pulumi.Input[_builtins.str] shared_secret_wo_version: Triggers update of `shared_secret_wo` write-only. Increment this value when an update to `shared_secret_wo` is needed. For more info see [updating write-only arguments](https://www.terraform.io/docs/providers/google/guides/using_write_only_arguments.html#updating-write-only-arguments)
...
class _VPNTunnelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: An optional description of this resource.
        :param pulumi.Input[_builtins.str] detailed_status: Detailed status message for the VPN tunnel.
...
class VPNTunnel(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="peerExternalGatewayInterface")
    def peer_external_gateway_interface(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The interface ID of the external VPN gateway to which this VPN tunnel is connected.
        """
        return pulumi.get(self, "peer_external_gateway_interface")
