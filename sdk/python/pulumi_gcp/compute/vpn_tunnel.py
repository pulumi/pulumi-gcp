...
class VPNTunnelArgs:
    def __init__(__self__, *,
                 ...
                 local_traffic_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 peer_external_gateway: Optional[pulumi.Input[builtins.str]] = None,
                 peer_external_gateway_interface: Optional[pulumi.Input[builtins.int]] = None,
                 peer_gcp_gateway: Optional[pulumi.Input[builtins.str]] = None,
                 peer_ip: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 remote_traffic_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 router: Optional[pulumi.Input[builtins.str]] = None,
                 target_vpn_gateway: Optional[pulumi.Input[builtins.str]] = None,
                 vpn_gateway: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels to apply to this VpnTunnel.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_traffic_selectors: Local traffic selector to use when establishing the VPN tunnel with
        ...
        :param pulumi.Input[builtins.str] peer_external_gateway: URL of the peer side external VPN gateway to which this VPN tunnel is connected.
        :param pulumi.Input[builtins.int] peer_external_gateway_interface: The interface ID of the external VPN gateway to which this VPN tunnel is connected.
        :param pulumi.Input[builtins.str] peer_gcp_gateway: URL of the peer side HA GCP VPN gateway to which this VPN tunnel is connected.
               If provided, the VPN tunnel will automatically use the same vpn_gateway_interface
               ID in the peer GCP VPN gateway.
               This field must reference a `compute.HaVpnGateway` resource.
        :param pulumi.Input[builtins.str] peer_ip: IP address of the peer VPN gateway. Only IPv4 is supported.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] region: The region where the tunnel is located. If unset, is set to the region of `target_vpn_gateway`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] remote_traffic_selectors: Remote traffic selector to use when establishing the VPN tunnel with
               peer VPN gateway. The value should be a CIDR formatted string,
               for example `192.168.0.0/16`. The ranges should be disjoint.
               Only IPv4 is supported.
        :param pulumi.Input[builtins.str] router: URL of router resource to be used for dynamic routing.
    ...
    def local_traffic_selectors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def local_traffic_selectors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def peer_external_gateway(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_external_gateway(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peer_external_gateway", value)

    @property
    @pulumi.getter(name="peerExternalGatewayInterface")
    def peer_external_gateway_interface(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def peer_external_gateway_interface(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "peer_external_gateway_interface", value)

    @property
    @pulumi.getter(name="peerGcpGateway")
    def peer_gcp_gateway(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_gcp_gateway(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def remote_traffic_selectors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def remote_traffic_selectors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def target_vpn_gateway(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_vpn_gateway(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_vpn_gateway", value)

    @property
    @pulumi.getter(name="vpnGateway")
    def vpn_gateway(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vpn_gateway.setter
    def vpn_gateway(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpn_gateway", value)

    @property
    @pulumi.getter(name="vpnGatewayInterface")
    def vpn_gateway_interface(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def vpn_gateway_interface(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VPNTunnelState:
    def __init__(__self__, *,
                 ...
                 shared_secret_hash: Optional[pulumi.Input[builtins.str]] = None,
                 target_vpn_gateway: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] target_vpn_gateway: URL of the Target VPN gateway with which this VPN tunnel is
               associated.
        :param pulumi.Input[builtins.str] tunnel_id: The unique identifier for the resource. This identifier is defined by the server.
        :param pulumi.Input[builtins.str] vpn_gateway: URL of the VPN gateway with which this VPN tunnel is associated.
               This must be used if a High Availability VPN gateway resource is created.
               This field must reference a `compute.HaVpnGateway` resource.
        :param pulumi.Input[builtins.int] vpn_gateway_interface: The interface ID of the VPN gateway with which this VPN tunnel is associated.
    ...
    def shared_secret_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_secret_hash(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VPNTunnel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tunnel_id: Optional[pulumi.Input[builtins.str]] = None,
            vpn_gateway: Optional[pulumi.Input[builtins.str]] = None,
            vpn_gateway_interface: Optional[pulumi.Input[builtins.int]] = None) -> 'VPNTunnel':
        """
    ...
    @property
    @pulumi.getter(name="localTrafficSelectors")
    def local_traffic_selectors(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Local traffic selector to use when establishing the VPN tunnel with
        peer VPN gateway. The value should be a CIDR formatted string,
        for example `192.168.0.0/16`. The ranges should be disjoint.
    ...
    @property
    @pulumi.getter(name="peerExternalGateway")
    def peer_external_gateway(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL of the peer side external VPN gateway to which this VPN tunnel is connected.
        """
        return pulumi.get(self, "peer_external_gateway")
    ...
    @property
    @pulumi.getter(name="peerExternalGatewayInterface")
    def peer_external_gateway_interface(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The interface ID of the external VPN gateway to which this VPN tunnel is connected.
        """
        return pulumi.get(self, "peer_external_gateway_interface")
    ...
    @property
    @pulumi.getter(name="peerGcpGateway")
    def peer_gcp_gateway(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL of the peer side HA GCP VPN gateway to which this VPN tunnel is connected.
        If provided, the VPN tunnel will automatically use the same vpn_gateway_interface
        ID in the peer GCP VPN gateway.
    ...
    @property
    @pulumi.getter(name="remoteTrafficSelectors")
    def remote_traffic_selectors(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Remote traffic selector to use when establishing the VPN tunnel with
        peer VPN gateway. The value should be a CIDR formatted string,
        for example `192.168.0.0/16`. The ranges should be disjoint.
    ...
    @property
    @pulumi.getter(name="sharedSecretHash")
    def shared_secret_hash(self) -> pulumi.Output[builtins.str]:
        """
        Hash of the shared secret.
        """
        return pulumi.get(self, "shared_secret_hash")
    ...
    @property
    @pulumi.getter(name="targetVpnGateway")
    def target_vpn_gateway(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL of the Target VPN gateway with which this VPN tunnel is
        associated.
        """
    ...
    @property
    @pulumi.getter(name="vpnGateway")
    def vpn_gateway(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        URL of the VPN gateway with which this VPN tunnel is associated.
        This must be used if a High Availability VPN gateway resource is created.
        This field must reference a `compute.HaVpnGateway` resource.
    ...
    @property
    @pulumi.getter(name="vpnGatewayInterface")
    def vpn_gateway_interface(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The interface ID of the VPN gateway with which this VPN tunnel is associated.
        """
        return pulumi.get(self, "vpn_gateway_interface")
