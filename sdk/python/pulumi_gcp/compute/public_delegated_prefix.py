...
class PublicDelegatedPrefixArgs:
    def __init__(__self__, *,
                 ...
                 parent_prefix: pulumi.Input[builtins.str],
                 region: pulumi.Input[builtins.str],
                 allocatable_prefix_length: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 is_live_migration: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def parent_prefix(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def parent_prefix(self, value: pulumi.Input[builtins.str]):
    ...
    def allocatable_prefix_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def allocatable_prefix_length(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def is_live_migration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_live_migration(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PublicDelegatedPrefixState:
    def __init__(__self__, *,
                 ...
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="parentPrefix")
    def parent_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URL of parent prefix. Either PublicAdvertisedPrefix or PublicDelegatedPrefix.
        """
        return pulumi.get(self, "parent_prefix")
    ...
    @parent_prefix.setter
    def parent_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_prefix", value)
...
class PublicDelegatedPrefix(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            self_link: Optional[pulumi.Input[builtins.str]] = None) -> 'PublicDelegatedPrefix':
        """
    ...
    @property
    @pulumi.getter(name="allocatablePrefixLength")
    def allocatable_prefix_length(self) -> pulumi.Output[builtins.int]:
        """
        The allocatable prefix length supported by this public delegated prefix. This field is optional and cannot be set for prefixes in DELEGATION mode. It cannot be set for IPv4 prefixes either, and it always defaults to 32.
        """
        return pulumi.get(self, "allocatable_prefix_length")
    ...
    @property
    @pulumi.getter(name="isLiveMigration")
    def is_live_migration(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, the prefix will be live migrated.
        """
        return pulumi.get(self, "is_live_migration")
    ...
    @property
    @pulumi.getter(name="parentPrefix")
    def parent_prefix(self) -> pulumi.Output[builtins.str]:
        """
        The URL of parent prefix. Either PublicAdvertisedPrefix or PublicDelegatedPrefix.
        """
        return pulumi.get(self, "parent_prefix")
