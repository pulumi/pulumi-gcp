...
def get_instance_guest_attributes(name: Optional[_builtins.str] = None,
                                  project: Optional[_builtins.str] = None,
                                  query_path: Optional[_builtins.str] = None,
                                  region: Optional[_builtins.str] = None,
                                  variable_key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name or self_link of the instance.
    :param _builtins.str project: The ID of the project in which the resource belongs.
           If `self_link` is provided, this value is ignored.  If neither `self_link`
           nor `project` are provided, the provider project is used.
    :param _builtins.str query_path: Path to query for the guest attributes. Consists of
           `namespace` name for the attributes followed with a `/`.
    :param _builtins.str variable_key: Key of a variable to get the value of. Consists of
