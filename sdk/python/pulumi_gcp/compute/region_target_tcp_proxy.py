...
class RegionTargetTcpProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The Region in which the created target TCP proxy should reside.
...
class RegionTargetTcpProxy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            proxy_id: Optional[pulumi.Input[builtins.int]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            self_link: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionTargetTcpProxy':
        """
