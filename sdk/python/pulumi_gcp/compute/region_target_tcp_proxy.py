...
class RegionTargetTcpProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] proxy_bind: This field only applies when the forwarding rule that references
               this target proxy has a loadBalancingScheme set to INTERNAL_SELF_MANAGED.
        :param pulumi.Input[_builtins.str] proxy_header: Specifies the type of proxy header to append before sending data to
               the backend.
               Default value is `NONE`.
               Possible values are: `NONE`, `PROXY_V1`.
        :param pulumi.Input[_builtins.str] region: The Region in which the created target TCP proxy should reside.
...
class _RegionTargetTcpProxyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] proxy_header: Specifies the type of proxy header to append before sending data to
               ...
               Default value is `NONE`.
               Possible values are: `NONE`, `PROXY_V1`.
        :param pulumi.Input[_builtins.int] proxy_id: The unique identifier for the resource.
        :param pulumi.Input[_builtins.str] region: The Region in which the created target TCP proxy should reside.
               If it is not provided, the provider region is used.
...
@pulumi.type_token("gcp:compute/regionTargetTcpProxy:RegionTargetTcpProxy")
class RegionTargetTcpProxy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[RegionTargetTcpProxyArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Represents a RegionTargetTcpProxy resource, which is used by one or more
        forwarding rules to route incoming TCP requests to a regional TCP proxy load
