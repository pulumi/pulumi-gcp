...
def get_zones(project: Optional[builtins.str] = None,
    ...
    :param builtins.str project: Project from which to list available zones. Defaults to project declared in the provider.
    :param builtins.str region: Region from which to list available zones. Defaults to region declared in the provider.
    :param builtins.str status: Allows to filter list of zones based on their current status. Status can be either `UP` or `DOWN`.
...
def get_zones_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
