...
def get_zones(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str status: Allows to filter list of zones based on their current status. Status can be either `UP` or `DOWN`.
