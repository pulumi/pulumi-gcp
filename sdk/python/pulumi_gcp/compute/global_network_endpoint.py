...
class GlobalNetworkEndpointArgs:
    def __init__(__self__, *,
                 global_network_endpoint_group: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] global_network_endpoint_group: The global network endpoint group this endpoint is part of.
               
               
               - - -
        :param pulumi.Input[builtins.int] port: Port number of the external endpoint.
    ...
    def global_network_endpoint_group(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def global_network_endpoint_group(self, value: pulumi.Input[builtins.str]):
...
class _GlobalNetworkEndpointState:
    def __init__(__self__, *,
                 fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 global_network_endpoint_group: Optional[pulumi.Input[builtins.str]] = None,
                 ip_address: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="globalNetworkEndpointGroup")
    def global_network_endpoint_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The global network endpoint group this endpoint is part of.
    ...
    @global_network_endpoint_group.setter
    def global_network_endpoint_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "global_network_endpoint_group", value)
...
class GlobalNetworkEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            port: Optional[pulumi.Input[builtins.int]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'GlobalNetworkEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="globalNetworkEndpointGroup")
    def global_network_endpoint_group(self) -> pulumi.Output[builtins.str]:
        """
        The global network endpoint group this endpoint is part of.
