...
class RegionInstanceGroupManagerArgs:
    def __init__(__self__, *,
                 base_instance_name: pulumi.Input[builtins.str],
                 ...
                 distribution_policy_target_shape: Optional[pulumi.Input[builtins.str]] = None,
                 distribution_policy_zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 list_managed_instances_results: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 target_pools: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 target_size: Optional[pulumi.Input[builtins.int]] = None,
                 target_stopped_size: Optional[pulumi.Input[builtins.int]] = None,
                 target_suspended_size: Optional[pulumi.Input[builtins.int]] = None,
                 update_policy: Optional[pulumi.Input['RegionInstanceGroupManagerUpdatePolicyArgs']] = None,
                 wait_for_instances: Optional[pulumi.Input[builtins.bool]] = None,
                 wait_for_instances_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RegionInstanceGroupManager resource.
        :param pulumi.Input[builtins.str] base_instance_name: The base instance name to use for
        ...
        :param pulumi.Input[builtins.str] description: An optional textual description of the instance
               group manager.
        :param pulumi.Input[builtins.str] distribution_policy_target_shape: The shape to which the group converges either proactively or on resize events (depending on the value set in update_policy.0.instance_redistribution_type). For more information see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/regional-mig-distribution-shape).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] distribution_policy_zones: The distribution policy for this managed instance
        ...
        :param pulumi.Input[builtins.str] list_managed_instances_results: Pagination behavior of the `listManagedInstances` API
               method for this managed instance group. Valid values are: `PAGELESS`, `PAGINATED`.
               If `PAGELESS` (default), Pagination is disabled for the group's `listManagedInstances` API method.
               `maxResults` and `pageToken` query parameters are ignored and all instances are returned in a single
               response. If `PAGINATED`, pagination is enabled, `maxResults` and `pageToken` query parameters are
               respected.
        :param pulumi.Input[builtins.str] name: The name of the instance group manager. Must be 1-63
        ...
        :param pulumi.Input[builtins.str] region: The region where the managed instance group resides. If not provided, the provider region is used.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_pools: The full URL of all target pools to which new
               instances in the group are added. Updating the target pools attribute does
               not affect existing instances.
        :param pulumi.Input[builtins.int] target_size: The target number of running instances for this managed instance group. This value should always be explicitly set
               unless this resource is attached to an autoscaler, in which case it should never be set. Defaults to 0.
        :param pulumi.Input[builtins.int] target_stopped_size: The target number of stopped instances for this managed instance group.
        :param pulumi.Input[builtins.int] target_suspended_size: The target number of suspended instances for this managed instance group.
        ...
        :param pulumi.Input[builtins.bool] wait_for_instances: Whether to wait for all instances to be created/updated before
               returning. Note that if this is set to true and the operation does not succeed, the provider will
               continue trying until it times out.
        :param pulumi.Input[builtins.str] wait_for_instances_status: When used with `wait_for_instances` it specifies the status to wait for.
    ...
    def base_instance_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def base_instance_name(self, value: pulumi.Input[builtins.str]):
    ...
    def distribution_policy_target_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def distribution_policy_target_shape(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "distribution_policy_target_shape", value)

    @property
    @pulumi.getter(name="distributionPolicyZones")
    def distribution_policy_zones(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def distribution_policy_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def list_managed_instances_results(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def list_managed_instances_results(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_pools(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @target_pools.setter
    def target_pools(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "target_pools", value)

    @property
    @pulumi.getter(name="targetSize")
    def target_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @target_size.setter
    def target_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "target_size", value)

    @property
    @pulumi.getter(name="targetStoppedSize")
    def target_stopped_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def target_stopped_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "target_stopped_size", value)

    @property
    @pulumi.getter(name="targetSuspendedSize")
    def target_suspended_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def target_suspended_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def wait_for_instances(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def wait_for_instances(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "wait_for_instances", value)

    @property
    @pulumi.getter(name="waitForInstancesStatus")
    def wait_for_instances_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def wait_for_instances_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RegionInstanceGroupManagerState:
    def __init__(__self__, *,
                 all_instances_config: Optional[pulumi.Input['RegionInstanceGroupManagerAllInstancesConfigArgs']] = None,
                 auto_healing_policies: Optional[pulumi.Input['RegionInstanceGroupManagerAutoHealingPoliciesArgs']] = None,
                 base_instance_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 instance_group_manager_id: Optional[pulumi.Input[builtins.int]] = None,
                 instance_lifecycle_policy: Optional[pulumi.Input['RegionInstanceGroupManagerInstanceLifecyclePolicyArgs']] = None,
                 list_managed_instances_results: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 named_ports: Optional[pulumi.Input[Sequence[pulumi.Input['RegionInstanceGroupManagerNamedPortArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] distribution_policy_zones: The distribution policy for this managed instance
               group. You can specify one or more values. For more information, see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/distributing-instances-with-regional-instance-groups#selectingzones).
        :param pulumi.Input[builtins.str] fingerprint: The fingerprint of the instance group manager.
        :param pulumi.Input['RegionInstanceGroupManagerInstanceFlexibilityPolicyArgs'] instance_flexibility_policy: The flexibility policy for managed instance group. Instance flexibility allows managed instance group to create VMs from multiple types of machines. Instance flexibility configuration on managed instance group overrides instance template configuration. Structure is documented below.
               - - -
        :param pulumi.Input[builtins.str] instance_group: The full URL of the instance group created by the manager.
        :param pulumi.Input[builtins.int] instance_group_manager_id: The unique identifier number for the resource. This identifier is defined by the server.
        :param pulumi.Input['RegionInstanceGroupManagerInstanceLifecyclePolicyArgs'] instance_lifecycle_policy: The instance lifecycle policy for this managed instance group.
        :param pulumi.Input[builtins.str] list_managed_instances_results: Pagination behavior of the `listManagedInstances` API
               method for this managed instance group. Valid values are: `PAGELESS`, `PAGINATED`.
               If `PAGELESS` (default), Pagination is disabled for the group's `listManagedInstances` API method.
    ...
    @property
    @pulumi.getter(name="baseInstanceName")
    def base_instance_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The base instance name to use for
        instances in this group. The value must be a valid
        [RFC1035](https://www.ietf.org/rfc/rfc1035.txt) name. Supported characters
    ...
    @base_instance_name.setter
    def base_instance_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base_instance_name", value)
    ...
    def instance_group_manager_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def instance_group_manager_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RegionInstanceGroupManager(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            versions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RegionInstanceGroupManagerVersionArgs', 'RegionInstanceGroupManagerVersionArgsDict']]]]] = None,
            wait_for_instances: Optional[pulumi.Input[builtins.bool]] = None,
            wait_for_instances_status: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionInstanceGroupManager':
        """
    ...
    @property
    @pulumi.getter(name="baseInstanceName")
    def base_instance_name(self) -> pulumi.Output[builtins.str]:
        """
        The base instance name to use for
        instances in this group. The value must be a valid
        [RFC1035](https://www.ietf.org/rfc/rfc1035.txt) name. Supported characters
    ...
    @property
    @pulumi.getter(name="distributionPolicyTargetShape")
    def distribution_policy_target_shape(self) -> pulumi.Output[builtins.str]:
        """
        The shape to which the group converges either proactively or on resize events (depending on the value set in update_policy.0.instance_redistribution_type). For more information see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/regional-mig-distribution-shape).
        """
        return pulumi.get(self, "distribution_policy_target_shape")
    ...
    @property
    @pulumi.getter(name="distributionPolicyZones")
    def distribution_policy_zones(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The distribution policy for this managed instance
        group. You can specify one or more values. For more information, see the [official documentation](https://cloud.google.com/compute/docs/instance-groups/distributing-instances-with-regional-instance-groups#selectingzones).
        """
    ...
    @property
    @pulumi.getter(name="instanceGroupManagerId")
    def instance_group_manager_id(self) -> pulumi.Output[builtins.int]:
        """
        The unique identifier number for the resource. This identifier is defined by the server.
        """
        return pulumi.get(self, "instance_group_manager_id")
    ...
    @property
    @pulumi.getter(name="listManagedInstancesResults")
    def list_managed_instances_results(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Pagination behavior of the `listManagedInstances` API
        method for this managed instance group. Valid values are: `PAGELESS`, `PAGINATED`.
        If `PAGELESS` (default), Pagination is disabled for the group's `listManagedInstances` API method.
    ...
    @property
    @pulumi.getter(name="targetPools")
    def target_pools(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The full URL of all target pools to which new
        instances in the group are added. Updating the target pools attribute does
        not affect existing instances.
    ...
    @property
    @pulumi.getter(name="targetSize")
    def target_size(self) -> pulumi.Output[builtins.int]:
        """
        The target number of running instances for this managed instance group. This value should always be explicitly set
        unless this resource is attached to an autoscaler, in which case it should never be set. Defaults to 0.
        """
    ...
    @property
    @pulumi.getter(name="targetStoppedSize")
    def target_stopped_size(self) -> pulumi.Output[builtins.int]:
        """
        The target number of stopped instances for this managed instance group.
        """
        return pulumi.get(self, "target_stopped_size")
    ...
    @property
    @pulumi.getter(name="targetSuspendedSize")
    def target_suspended_size(self) -> pulumi.Output[builtins.int]:
        """
        The target number of suspended instances for this managed instance group.
        """
        return pulumi.get(self, "target_suspended_size")
    ...
    @property
    @pulumi.getter(name="waitForInstances")
    def wait_for_instances(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to wait for all instances to be created/updated before
        returning. Note that if this is set to true and the operation does not succeed, the provider will
        continue trying until it times out.
    ...
    @property
    @pulumi.getter(name="waitForInstancesStatus")
    def wait_for_instances_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When used with `wait_for_instances` it specifies the status to wait for.
        When `STABLE` is specified this resource will wait until the instances are stable before returning. When `UPDATED` is
        set, it will wait for the version target to be reached and any per instance configs to be effective as well as all
