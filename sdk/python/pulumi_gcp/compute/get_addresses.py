...
def get_addresses(filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.str filter: A filter expression that
    ...
    :param _builtins.str project: The google project in which addresses are listed.
