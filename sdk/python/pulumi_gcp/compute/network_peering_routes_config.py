...
class NetworkPeeringRoutesConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] peering: Name of the peering.
        ...
        :param pulumi.Input[_builtins.bool] import_subnet_routes_with_public_ip: Whether subnet routes with public IP range are imported.
...
class NetworkPeeringRoutesConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network: Optional[pulumi.Input[_builtins.str]] = None,
            peering: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None) -> 'NetworkPeeringRoutesConfig':
        """
