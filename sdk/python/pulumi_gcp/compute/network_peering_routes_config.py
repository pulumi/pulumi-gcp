...
class NetworkPeeringRoutesConfigArgs:
    def __init__(__self__, *,
                 export_custom_routes: pulumi.Input[builtins.bool],
                 import_custom_routes: pulumi.Input[builtins.bool],
                 network: pulumi.Input[builtins.str],
                 peering: pulumi.Input[builtins.str],
                 export_subnet_routes_with_public_ip: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] import_subnet_routes_with_public_ip: Whether subnet routes with public IP range are imported.
    ...
    def export_custom_routes(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def export_custom_routes(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "export_custom_routes", value)

    @property
    @pulumi.getter(name="importCustomRoutes")
    def import_custom_routes(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def import_custom_routes(self, value: pulumi.Input[builtins.bool]):
    ...
    def export_subnet_routes_with_public_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def export_subnet_routes_with_public_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "export_subnet_routes_with_public_ip", value)

    @property
    @pulumi.getter(name="importSubnetRoutesWithPublicIp")
    def import_subnet_routes_with_public_ip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def import_subnet_routes_with_public_ip(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NetworkPeeringRoutesConfigState:
    def __init__(__self__, *,
                 ...
                 peering: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter
    def peering(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the peering.
        """
        return pulumi.get(self, "peering")
    ...
    @peering.setter
    def peering(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peering", value)
...
class NetworkPeeringRoutesConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network: Optional[pulumi.Input[builtins.str]] = None,
            peering: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkPeeringRoutesConfig':
        """
    ...
    @property
    @pulumi.getter(name="exportCustomRoutes")
    def export_custom_routes(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to export the custom routes to the peer network.
        """
        return pulumi.get(self, "export_custom_routes")
    ...
    @property
    @pulumi.getter(name="exportSubnetRoutesWithPublicIp")
    def export_subnet_routes_with_public_ip(self) -> pulumi.Output[builtins.bool]:
        """
        Whether subnet routes with public IP range are exported.
        IPv4 special-use ranges are always exported to peers and
        are not controlled by this field.
    ...
    @property
    @pulumi.getter(name="importCustomRoutes")
    def import_custom_routes(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to import the custom routes to the peer network.
        """
        return pulumi.get(self, "import_custom_routes")
    ...
    @property
    @pulumi.getter(name="importSubnetRoutesWithPublicIp")
    def import_subnet_routes_with_public_ip(self) -> pulumi.Output[builtins.bool]:
        """
        Whether subnet routes with public IP range are imported.
        IPv4 special-use ranges are always imported from peers and
        are not controlled by this field.
    ...
    @property
    @pulumi.getter
    def peering(self) -> pulumi.Output[builtins.str]:
        """
        Name of the peering.
        """
        return pulumi.get(self, "peering")
