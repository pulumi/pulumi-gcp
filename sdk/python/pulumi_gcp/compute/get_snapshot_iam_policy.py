...
@pulumi.output_type
calass GetSnapshotIamPolicyResult:
    """
...
calass AwaitableGetSnapshotIamPolicyResult(GetSnapshotIamPolicyResult):
...
def get_snapshot_iam_policy(name: Optional[str] = None,
