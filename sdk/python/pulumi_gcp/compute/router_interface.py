...
class RouterInterfaceArgs:
    def __init__(__self__, *,
                 ...
                 redundant_interface: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] router: The name of the router this interface will be attached to.
               ...
               - - -
        :param pulumi.Input[builtins.str] interconnect_attachment: The name or resource link to the
               VLAN interconnect for this interface. Changing this forces a new interface to
               be created. Only one of `vpn_tunnel`, `interconnect_attachment` or `subnetwork` can be specified.
        :param pulumi.Input[builtins.str] ip_range: IP address and range of the interface. The IP range must be
               in the RFC3927 link-local IP space. Changing this forces a new interface to be created.
        :param pulumi.Input[builtins.str] ip_version: IP version of this interface. Can be either IPV4 or IPV6.
        :param pulumi.Input[builtins.str] name: A unique name for the interface, required by GCE. Changing
               this forces a new interface to be created.
        :param pulumi.Input[builtins.str] private_ip_address: The regional private internal IP address that is used
        ...
        :param pulumi.Input[builtins.str] project: The ID of the project in which this interface's routerbelongs.
               If it is not provided, the provider project is used. Changing this forces a new interface to be created.
        :param pulumi.Input[builtins.str] redundant_interface: The name of the interface that is redundant to
               this interface. Changing this forces a new interface to be created.
        :param pulumi.Input[builtins.str] region: The region this interface's router sits in.
               If not specified, the project region will be used. Changing this forces a new interface to be created.
        :param pulumi.Input[builtins.str] subnetwork: The URI of the subnetwork resource that this interface
        ...
        :param pulumi.Input[builtins.str] vpn_tunnel: The name or resource link to the VPN tunnel this
    ...
    def redundant_interface(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def redundant_interface(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RouterInterface(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            router: Optional[pulumi.Input[builtins.str]] = None,
            subnetwork: Optional[pulumi.Input[builtins.str]] = None,
            vpn_tunnel: Optional[pulumi.Input[builtins.str]] = None) -> 'RouterInterface':
        """
    ...
    @property
    @pulumi.getter(name="redundantInterface")
    def redundant_interface(self) -> pulumi.Output[builtins.str]:
        """
        The name of the interface that is redundant to
        this interface. Changing this forces a new interface to be created.
        """
