...
class RouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] next_hop_gateway: URL to a gateway that should handle matching packets.
        ...
        :param pulumi.Input[_builtins.str] next_hop_ilb: The IP address or URL to a forwarding rule of type
        ...
        :param pulumi.Input[_builtins.str] next_hop_instance_zone: (Optional when `next_hop_instance` is
...
class _RouteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] next_hop_gateway: URL to a gateway that should handle matching packets.
               ...
               * `global/gateways/default-internet-gateway`
               * The string `default-internet-gateway`.
        :param pulumi.Input[_builtins.str] next_hop_hub: The hub network that should handle matching packets, which should conform to RFC1035.
        :param pulumi.Input[_builtins.str] next_hop_ilb: The IP address or URL to a forwarding rule of type
               loadBalancingScheme=INTERNAL that should handle matching
               packets.
               With the GA provider you can only specify the forwarding
        ...
        :param pulumi.Input[_builtins.str] next_hop_instance_zone: (Optional when `next_hop_instance` is
               ...
               `next_hop_instance`.  Omit if `next_hop_instance` is specified as
               a URL.
        :param pulumi.Input[_builtins.str] next_hop_inter_region_cost: Internal fixed region-to-region cost that Google Cloud calculates based on factors such as network performance, distance, and available bandwidth between regions.
        :param pulumi.Input[_builtins.str] next_hop_ip: Network IP address of an instance that should handle matching packets.
        :param pulumi.Input[_builtins.str] next_hop_med: Multi-Exit Discriminator, a BGP route metric that indicates the desirability of a particular route in a network.
        :param pulumi.Input[_builtins.str] next_hop_network: URL to a Network that should handle matching packets.
        ...
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] route_status: The status of the route, which can be one of the following values:
               - 'ACTIVE' for an active route
               - 'INACTIVE' for an inactive route
        :param pulumi.Input[_builtins.str] route_type: The type of this route, which can be one of the following values:
