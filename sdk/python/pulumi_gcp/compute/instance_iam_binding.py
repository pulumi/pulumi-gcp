...
calass InstanceIAMBindingArrgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InstanceIAMBindingConditionArrgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
...
calass InstanceIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `compute.InstanceIAMPolicy`: Retrieves the IAM policy for the instance
        ...
        :param pulumi.Input[pulumi.InputType['InstanceIAMBindingConditionArrgs']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[str] instance_name: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
