...
class RegionNetworkEndpointGroupArgs:
    def __init__(__self__, *,
                 ...
                 psc_target_service: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] region: A reference to the region where the regional NEGs reside.
        ...
        :param pulumi.Input[builtins.str] network: This field is only used for PSC and INTERNET NEGs.
               The URL of the network to which all network endpoints in the NEG belong. Uses
               "default" project network if unspecified.
        :param pulumi.Input[builtins.str] network_endpoint_type: Type of network endpoints in this network endpoint group. Defaults to SERVERLESS.
        ...
        :param pulumi.Input['RegionNetworkEndpointGroupPscDataArgs'] psc_data: This field is only used for PSC NEGs.
               Structure is documented below.
        :param pulumi.Input[builtins.str] psc_target_service: This field is only used for PSC and INTERNET NEGs.
        ...
        :param pulumi.Input['RegionNetworkEndpointGroupServerlessDeploymentArgs'] serverless_deployment: This field is only used for SERVERLESS NEGs.
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] subnetwork: This field is only used for PSC NEGs.
    ...
    def psc_target_service(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This field is only used for PSC and INTERNET NEGs.
        The target service url used to set up private service connection to
        a Google API or a PSC Producer Service Attachment.
    ...
    def psc_target_service(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RegionNetworkEndpointGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            self_link: Optional[pulumi.Input[builtins.str]] = None,
            serverless_deployment: Optional[pulumi.Input[Union['RegionNetworkEndpointGroupServerlessDeploymentArgs', 'RegionNetworkEndpointGroupServerlessDeploymentArgsDict']]] = None,
            subnetwork: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionNetworkEndpointGroup':
        """
    ...
    @property
    @pulumi.getter(name="pscTargetService")
    def psc_target_service(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This field is only used for PSC and INTERNET NEGs.
        The target service url used to set up private service connection to
        a Google API or a PSC Producer Service Attachment.
