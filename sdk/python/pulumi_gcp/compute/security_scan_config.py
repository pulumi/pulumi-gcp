...
class SecurityScanConfigArgs:
    ...
    def starting_urls(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class SecurityScanConfig(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="blacklistPatterns")
    def blacklist_patterns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The blacklist URL patterns as described in
        https://cloud.google.com/security-scanner/docs/excluded-urls
        """
    ...
    @_builtins.property
    @pulumi.getter(name="exportToSecurityCommandCenter")
    def export_to_security_command_center(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Controls export of scan configurations and results to Cloud Security Command Center.
        Default value is `ENABLED`.
        Possible values are: `ENABLED`, `DISABLED`.
