...
def get_instance_group(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str self_link: The self link of the instance group. Either `name` or `self_link` must be provided.
    :param _builtins.str zone: The zone of the instance group. If referencing the instance group by name
...
def get_instance_group_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
