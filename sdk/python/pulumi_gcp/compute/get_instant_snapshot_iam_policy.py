...
def get_instant_snapshot_iam_policy(name: Optional[builtins.str] = None,
    ...
    :param builtins.str zone: A reference to the zone where the disk is located. Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_instant_snapshot_iam_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
