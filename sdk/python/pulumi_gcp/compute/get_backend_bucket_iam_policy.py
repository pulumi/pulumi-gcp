...
def get_backend_bucket_iam_policy(name: Optional[_builtins.str] = None,
...
def get_backend_bucket_iam_policy_output(name: Optional[pulumi.Input[_builtins.str]] = None,
