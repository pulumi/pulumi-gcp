...
class RegionTargetHttpsProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ssl_policy: A reference to the Region SslPolicy resource that will be associated with
...
class RegionTargetHttpsProxy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            ssl_policy: Optional[pulumi.Input[builtins.str]] = None,
            url_map: Optional[pulumi.Input[builtins.str]] = None) -> 'RegionTargetHttpsProxy':
        """
