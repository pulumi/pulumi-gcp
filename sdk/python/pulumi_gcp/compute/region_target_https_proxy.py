...
class RegionTargetHttpsProxyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The Region in which the created target https proxy should reside.
               If it is not provided, the provider region is used.
        :param pulumi.Input[_builtins.str] server_tls_policy: A URL referring to a networksecurity.ServerTlsPolicy
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ssl_certificates: URLs to SslCertificate resources that are used to authenticate connections between users and the load balancer.
               At least one SSL certificate must be specified. Currently, you may specify up to 15 SSL certificates.
               sslCertificates do not apply when the load balancing scheme is set to INTERNAL_SELF_MANAGED.
        :param pulumi.Input[_builtins.str] ssl_policy: A reference to the Region SslPolicy resource that will be associated with
...
@pulumi.type_token("gcp:compute/regionTargetHttpsProxy:RegionTargetHttpsProxy")
