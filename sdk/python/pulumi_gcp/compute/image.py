...
class ImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] family: The name of the image family to which this image belongs. You can
        ...
        :param pulumi.Input['ImageImageEncryptionKeyArgs'] image_encryption_key: Encrypts the image using a customer-supplied encryption key.
               ...
               disk from the image)
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels to apply to this Image.
