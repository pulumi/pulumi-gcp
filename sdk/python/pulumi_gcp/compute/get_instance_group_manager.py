...
def get_instance_group_manager(name: Optional[builtins.str] = None,
    ...
    :param builtins.str zone: The zone of the instance group. If referencing the instance group by name and `zone` is not provided, the provider zone is used.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_instance_group_manager_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
