...
def get_instance_group_manager(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str zone: The zone of the instance group. If referencing the instance group by name and `zone` is not provided, the provider zone is used.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_instance_group_manager_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
