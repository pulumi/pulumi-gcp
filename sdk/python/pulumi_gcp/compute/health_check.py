...
class HealthCheckArgs:
    def __init__(__self__, *,
                 ...
                 source_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_regions: The list of cloud regions from which health checks are performed. If
    ...
    def source_regions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def source_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _HealthCheckState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] timeout_sec: How long (in seconds) to wait before claiming failure.
               The default value is 5 seconds.  It is invalid for timeoutSec to have
               greater value than checkIntervalSec.
        :param pulumi.Input[builtins.str] type: The type of the health check. One of HTTP, HTTPS, TCP, or SSL.
        :param pulumi.Input[builtins.int] unhealthy_threshold: A so-far healthy instance will be marked unhealthy after this many
               consecutive failures. The default value is 2.
        """
        if check_interval_sec is not None:
...
class HealthCheck(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timeout_sec: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            unhealthy_threshold: Optional[pulumi.Input[builtins.int]] = None) -> 'HealthCheck':
        """
    ...
    @property
    @pulumi.getter(name="sourceRegions")
    def source_regions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of cloud regions from which health checks are performed. If
        any regions are specified, then exactly 3 regions should be specified.
        The region names must be valid names of Google Cloud regions. This can
