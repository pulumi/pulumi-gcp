...
class RouterNatAddressArgs:
    def __init__(__self__, *,
                 nat_ips: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 router: pulumi.Input[builtins.str],
                 router_nat: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nat_ips: Self-links of NAT IPs to be used in a Nat service. Only valid if the referenced RouterNat
    ...
    def nat_ips(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @nat_ips.setter
    def nat_ips(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    @router_nat.setter
    def router_nat(self, value: pulumi.Input[builtins.str]):
...
class _RouterNatAddressState:
    def __init__(__self__, *,
                 ...
                 router_nat: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @router_nat.setter
    def router_nat(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "router_nat", value)
...
class RouterNatAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            router: Optional[pulumi.Input[builtins.str]] = None,
            router_nat: Optional[pulumi.Input[builtins.str]] = None) -> 'RouterNatAddress':
        """
    ...
    @property
    @pulumi.getter(name="drainNatIps")
    def drain_nat_ips(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of URLs of the IP resources to be drained. These IPs must be
        valid static external IPs that have been assigned to the NAT.
        """
