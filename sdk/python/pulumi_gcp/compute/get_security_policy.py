...
def get_security_policy(name: Optional[builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param builtins.str name: The name of the security policy. Provide either this or a `self_link`.
    :param builtins.str project: The project in which the resource belongs. If it is not provided, the provider project is used.
    :param builtins.str self_link: The self_link of the security policy. Provide either this or a `name`
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_security_policy_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
