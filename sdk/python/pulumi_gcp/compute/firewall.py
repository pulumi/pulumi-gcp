...
class FirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] destination_ranges: If destination ranges are specified, the firewall will apply only to
               traffic that has destination IP address in these ranges. These ranges
               must be expressed in CIDR format. IPv4 or IPv6 ranges are supported.
        :param pulumi.Input[_builtins.str] direction: Direction of traffic to which this firewall applies; default is
               INGRESS. Note: For INGRESS traffic, one of `source_ranges`,
               `source_tags` or `source_service_accounts` is required.
               Possible values are: `INGRESS`, `EGRESS`.
        :param pulumi.Input[_builtins.bool] disabled: Denotes whether the firewall rule is disabled, i.e not applied to the
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_ranges: If source ranges are specified, the firewall will apply only to
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_service_accounts: If source service accounts are specified, the firewall will apply only
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_tags: If source tags are specified, the firewall will apply only to traffic
               ...
               one of `source_ranges`, `source_tags` or `source_service_accounts` is required.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] target_service_accounts: A list of service accounts indicating sets of instances located in the
               network that may make network connections as specified in allowed[].
               targetServiceAccounts cannot be used at the same time as targetTags or
               sourceTags. If neither targetServiceAccounts nor targetTags are
               specified, the firewall rule applies to all instances on the specified
               network.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] target_tags: A list of instance tags indicating sets of instances located in the
               network that may make network connections as specified in allowed[].
