...
def get_global_address(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A unique name for the resource, required by GCE.
...
def get_global_address_output(name: Optional[pulumi.Input[builtins.str]] = None,
