...
class RegionSslPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] post_quantum_key_exchange: One of `DEFAULT`, `ENABLED`, or `DEFERRED`. Controls whether the load balancer negotiates
    ...
    def custom_features(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
...
class RegionSslPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            self_link: pulumi.Input[Optional[_builtins.str]] = None) -> 'RegionSslPolicy':
        """
