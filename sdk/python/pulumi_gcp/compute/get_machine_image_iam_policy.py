...
def get_machine_image_iam_policy(machine_image: Optional[builtins.str] = None,
    ...
    :param builtins.str machine_image: Used to find the parent resource to bind the IAM policy to
...
def get_machine_image_iam_policy_output(machine_image: Optional[pulumi.Input[builtins.str]] = None,
