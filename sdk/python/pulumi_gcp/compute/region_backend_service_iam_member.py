...
class RegionBackendServiceIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['RegionBackendServiceIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `compute.RegionBackendServiceIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['RegionBackendServiceIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['RegionBackendServiceIamMemberConditionArgs']]):
...
@pulumi.type_token("gcp:compute/regionBackendServiceIamMember:RegionBackendServiceIamMember")
class RegionBackendServiceIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['RegionBackendServiceIamMemberConditionArgs', 'RegionBackendServiceIamMemberConditionArgsDict', 'outputs.RegionBackendServiceIamMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * {{name}}
        ...
        :param pulumi.Input[Union['RegionBackendServiceIamMemberConditionArgs', 'RegionBackendServiceIamMemberConditionArgsDict', 'outputs.RegionBackendServiceIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'RegionBackendServiceIamMember':
        """
