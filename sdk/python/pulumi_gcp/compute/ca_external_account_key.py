...
class CaExternalAccountKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Location for the externalAccountKey. Currently only `global` is supported.
...
class _CaExternalAccountKeyState:
    def __init__(__self__, *,
                 b64_mac_key: pulumi.Input[Optional[_builtins.str]] = None,
                 b64url_mac_key: pulumi.Input[Optional[_builtins.str]] = None,
                 key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 mac_key: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering CaExternalAccountKey resources.

        :param pulumi.Input[_builtins.str] b64_mac_key: (Deprecated)
        ...
        :param pulumi.Input[_builtins.str] b64url_mac_key: (Deprecated)
               Doubly Base64-URL-encoded HS256 key ('base64(base64(binary key))'). It is generated by the PublicCertificateAuthorityService
               when the ExternalAccountKey is created.'
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[_builtins.str] key_id: It is generated by the PublicCertificateAuthorityService when the ExternalAccountKey is created.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[_builtins.str] location: Location for the externalAccountKey. Currently only `global` is supported.
        :param pulumi.Input[_builtins.str] mac_key: Base64-URL-encoded HS256 key. It is generated by the PublicCertificateAuthorityService
               when the ExternalAccountKey is created.'
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[_builtins.str] name: Resource name. projects/{project}/locations/{location}/externalAccountKeys/{keyId}.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        """
        if b64_mac_key is not None:
            warnings.warn("""`b64_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.""", DeprecationWarning)
            pulumi.log.warn("""b64_mac_key is deprecated: `b64_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.""")
        if b64_mac_key is not None:
            pulumi.set(__self__, "b64_mac_key", b64_mac_key)
        if b64url_mac_key is not None:
            warnings.warn("""`b64url_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.""", DeprecationWarning)
            pulumi.log.warn("""b64url_mac_key is deprecated: `b64url_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.""")
        if b64url_mac_key is not None:
        ...
        if mac_key is not None:
            pulumi.set(__self__, "mac_key", mac_key)
        if name is not None:
    ...
    @_utilities.deprecated("""`b64_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.""")
    def b64_mac_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Deprecated)
        Doubly Base64-URL-encoded HS256 key ('base64(base64(binary key))'). It is generated by the PublicCertificateAuthorityService
        when the ExternalAccountKey is created.
    ...
    @b64_mac_key.setter
    def b64_mac_key(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "b64_mac_key", value)

    @_builtins.property
    @pulumi.getter(name="b64urlMacKey")
    @_utilities.deprecated("""`b64url_mac_key` is deprecated and will be removed in a future major release. Use `mac_key` instead.""")
    def b64url_mac_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Deprecated)
        Doubly Base64-URL-encoded HS256 key ('base64(base64(binary key))'). It is generated by the PublicCertificateAuthorityService
        when the ExternalAccountKey is created.'
    ...
    def b64url_mac_key(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def mac_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Base64-URL-encoded HS256 key. It is generated by the PublicCertificateAuthorityService
        when the ExternalAccountKey is created.'
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
        return pulumi.get(self, "mac_key")

    @mac_key.setter
    def mac_key(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "mac_key", value)
...
class CaExternalAccountKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["mac_key"] = None
            __props__.__dict__["name"] = None
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["b64MacKey", "b64urlMacKey", "keyId", "macKey"])
    ...
    def get(resource_name: str,
            ...
            mac_key: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None) -> 'CaExternalAccountKey':
        """
        ...
        __props__.__dict__["location"] = location
        __props__.__dict__["mac_key"] = mac_key
