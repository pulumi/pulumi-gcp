...
class GetHealthCheckResult:
    ...
    def check_interval_sec(self) -> builtins.int:
...
def get_health_check(name: Optional[builtins.str] = None,
...
def get_health_check_output(name: Optional[pulumi.Input[builtins.str]] = None,
