...
class InstantSnapshotIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] zone: A reference to the zone where the disk is located. Used to find the parent resource to bind the IAM policy to. If not specified,
...
@pulumi.type_token("gcp:compute/instantSnapshotIamPolicy:InstantSnapshotIamPolicy")
class InstantSnapshotIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_data: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'InstantSnapshotIamPolicy':
        """
