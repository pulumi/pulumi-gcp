...
class ConnectionArgs:
    def __init__(__self__, *,
                 connector_version: pulumi.Input[builtins.str],
                 ...
                 eventing_enablement_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connector_version: connectorVersion of the Connector.
        :param pulumi.Input[builtins.str] location: Location in which Connection needs to be created.
        ...
        :param pulumi.Input['ConnectionEventingConfigArgs'] eventing_config: Eventing Configuration of a connection
               Structure is documented below.
        :param pulumi.Input[builtins.str] eventing_enablement_type: Eventing enablement type. Will be nil if eventing is not enabled.
        ...
        :param pulumi.Input['ConnectionLogConfigArgs'] log_config: Log configuration for the connection.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: Name of Connection needs to be created.
        ...
        :param pulumi.Input[builtins.str] service_account: Service account needed for runtime plane to access Google Cloud resources.
        :param pulumi.Input['ConnectionSslConfigArgs'] ssl_config: SSL Configuration of a connection
               Structure is documented below.
        :param pulumi.Input[builtins.bool] suspended: Suspended indicates if a user has suspended a connection or not.
        """
    ...
    def connector_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connector_version(self, value: pulumi.Input[builtins.str]):
    ...
    def eventing_enablement_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def eventing_enablement_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ConnectionState:
    def __init__(__self__, *,
                 auth_config: Optional[pulumi.Input['ConnectionAuthConfigArgs']] = None,
                 config_variables: Optional[pulumi.Input[Sequence[pulumi.Input['ConnectionConfigVariableArgs']]]] = None,
                 connection_revision: Optional[pulumi.Input[builtins.str]] = None,
                 connector_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 connector_version_launch_stage: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_account: Optional[pulumi.Input[builtins.str]] = None,
                 service_directory: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_config: Optional[pulumi.Input['ConnectionSslConfigArgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ConnectionConfigVariableArgs']]] config_variables: Config Variables for the connection.
               Structure is documented below.
        :param pulumi.Input[builtins.str] connection_revision: Connection revision. This field is only updated when the connection is created or updated by User.
        :param pulumi.Input[builtins.str] connector_version: connectorVersion of the Connector.
        :param pulumi.Input[Sequence[pulumi.Input['ConnectionConnectorVersionInfraConfigArgs']]] connector_version_infra_configs: This configuration provides infra configs like rate limit threshold which need to be configurable for every connector version.
               Structure is documented below.
        :param pulumi.Input[builtins.str] connector_version_launch_stage: Flag to mark the version indicating the launch stage.
        ...
        :param pulumi.Input[builtins.str] service_account: Service account needed for runtime plane to access Google Cloud resources.
        :param pulumi.Input[builtins.str] service_directory: The name of the Service Directory service name. Used for Private Harpoon to resolve the ILB address.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ConnectionStatusArgs']]] statuses: (Output)
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] subscription_type: This subscription type enum states the subscription type of the project.
        :param pulumi.Input[builtins.bool] suspended: Suspended indicates if a user has suspended a connection or not.
    ...
    def connection_revision(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_revision(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connection_revision", value)

    @property
    @pulumi.getter(name="connectorVersion")
    def connector_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        connectorVersion of the Connector.
        """
        return pulumi.get(self, "connector_version")
    ...
    @connector_version.setter
    def connector_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connector_version", value)
    ...
    def connector_version_launch_stage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connector_version_launch_stage(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_directory(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_directory(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Connection(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:integrationconnectors/connection:Connection"
    ...
    @property
    @pulumi.getter(name="connectionRevision")
    def connection_revision(self) -> pulumi.Output[builtins.str]:
        """
        Connection revision. This field is only updated when the connection is created or updated by User.
        """
        return pulumi.get(self, "connection_revision")
    ...
    @property
    @pulumi.getter(name="connectorVersion")
    def connector_version(self) -> pulumi.Output[builtins.str]:
        """
        connectorVersion of the Connector.
        """
        return pulumi.get(self, "connector_version")
    ...
    @property
    @pulumi.getter(name="connectorVersionLaunchStage")
    def connector_version_launch_stage(self) -> pulumi.Output[builtins.str]:
        """
        Flag to mark the version indicating the launch stage.
        """
        return pulumi.get(self, "connector_version_launch_stage")
    ...
    @property
    @pulumi.getter(name="eventingEnablementType")
    def eventing_enablement_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Eventing enablement type. Will be nil if eventing is not enabled.
        Possible values are: `EVENTING_AND_CONNECTION`, `ONLY_EVENTING`.
        """
    ...
    @property
    @pulumi.getter(name="serviceDirectory")
    def service_directory(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Service Directory service name. Used for Private Harpoon to resolve the ILB address.
        e.g. "projects/cloud-connectors-e2e-testing/locations/us-central1/namespaces/istio-system/services/istio-ingressgateway-connectors"
        """
