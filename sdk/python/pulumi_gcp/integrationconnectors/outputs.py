...
class ConnectionAuthConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str auth_type: authType of the Connection
        ...
        :param builtins.str auth_key: The type of authentication configured.
...
class ConnectionAuthConfigAdditionalVariable(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: Key for the configVariable
        :param builtins.bool boolean_value: Boolean Value of configVariable.
        :param 'ConnectionAuthConfigAdditionalVariableEncryptionKeyValueArgs' encryption_key_value: Encryption key value of configVariable.
               Structure is documented below.
        :param builtins.int integer_value: Integer Value of configVariable.
        :param 'ConnectionAuthConfigAdditionalVariableSecretValueArgs' secret_value: Secret value of configVariable
               Structure is documented below.
        :param builtins.str string_value: String Value of configVariabley.
        """
...
class ConnectionAuthConfigAdditionalVariableEncryptionKeyValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Type of Encryption Key
               Possible values are: `GOOGLE_MANAGED`, `CUSTOMER_MANAGED`.
        :param builtins.str kms_key_name: The [KMS key name] with which the content of the Operation is encrypted. The
...
class ConnectionAuthConfigAdditionalVariableSecretValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str secret_version: Secret version of Secret Value for Config variable.
        """
...
class ConnectionAuthConfigOauth2AuthCodeFlow(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_pkce: Optional[builtins.bool] = None,
                 scopes: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str auth_uri: Auth URL for Authorization Code Flow.
        :param builtins.str client_id: Client ID for user-provided OAuth app.
        :param 'ConnectionAuthConfigOauth2AuthCodeFlowClientSecretArgs' client_secret: Client secret for user-provided OAuth app.
        :param builtins.bool enable_pkce: Whether to enable PKCE when the user performs the auth code flow.
        :param Sequence[builtins.str] scopes: Scopes the connection will request when the user performs the auth code flow.
        """
    ...
    def enable_pkce(self) -> Optional[builtins.bool]:
        """
...
class ConnectionAuthConfigOauth2ClientCredentials(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_id: Secret version of Password for Authentication.
...
class ConnectionAuthConfigOauth2JwtBearerJwtClaims(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str audience: Value for the "aud" claim.
               
               <a name="nested_auth_config_oauth2_client_credentials"></a>The `oauth2_client_credentials` block supports:
        :param builtins.str issuer: Value for the "iss" claim.
        :param builtins.str subject: Value for the "sub" claim.
        """
...
class ConnectionAuthConfigSshPublicKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str username: The user account used to authenticate.
        :param builtins.str cert_type: Format of SSH Client cert.
...
class ConnectionConnectorVersionInfraConfig(dict):
    ...
    def __init__(__self__, *,
                 ratelimit_threshold: Optional[builtins.str] = None):
        """
        :param builtins.str ratelimit_threshold: (Output)
    ...
    def ratelimit_threshold(self) -> Optional[builtins.str]:
        """
        (Output)
        Max QPS supported by the connector version before throttling of requests.
        """
...
class ConnectionDestinationConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The key is the destination identifier that is supported by the Connector.
...
class ConnectionDestinationConfigDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: Host
        :param builtins.int port: port number
        :param builtins.str service_attachment: Service Attachment
        """
        if host is not None:
...
class ConnectionEventingConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enrichment_enabled: Optional[builtins.bool] = None):
        """
        ...
        :param 'ConnectionEventingConfigAuthConfigArgs' auth_config: authConfig for Eventing Configuration.
               Structure is documented below.
        :param builtins.bool enrichment_enabled: Enrichment Enabled.
        """
    ...
    def enrichment_enabled(self) -> Optional[builtins.bool]:
        """
        Enrichment Enabled.
        """
...
class ConnectionEventingConfigRegistrationDestinationConfig(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['ConnectionEventingConfigRegistrationDestinationConfigDestinationArgs'] destinations: destinations for the connection
               Structure is documented below.
        :param builtins.str key: Key for the connection
        """
        if destinations is not None:
            pulumi.set(__self__, "destinations", destinations)
        if key is not None:
...
class ConnectionEventingRuntimeData(dict):
    ...
    def __init__(__self__, *,
                 events_listener_endpoint: Optional[builtins.str] = None,
                 statuses: Optional[Sequence['outputs.ConnectionEventingRuntimeDataStatus']] = None):
        """
        :param builtins.str events_listener_endpoint: Events listener endpoint. The value will populated after provisioning the events listener.
    ...
    def events_listener_endpoint(self) -> Optional[builtins.str]:
        """
...
class ConnectionEventingRuntimeDataStatus(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: An arbitrary description for the Connection.
...
class ConnectionLockConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool locked: Indicates whether or not the connection is locked.
        :param builtins.str reason: Describes why a connection is locked.
        """
...
class ConnectionNodeConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_node_count: Minimum number of nodes in the runtime nodes.
        :param builtins.int min_node_count: Minimum number of nodes in the runtime nodes.
        """
...
class ConnectionSslConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_cert_type: Optional[builtins.str] = None,
                 ...
                 server_cert_type: Optional[builtins.str] = None,
                 trust_model: Optional[builtins.str] = None,
                 use_ssl: Optional[builtins.bool] = None):
        """
        :param builtins.str type: Enum for controlling the SSL Type (TLS/MTLS)
        ...
        :param Sequence['ConnectionSslConfigAdditionalVariableArgs'] additional_variables: Additional SSL related field values.
               Structure is documented below.
        :param builtins.str client_cert_type: Type of Client Cert (PEM/JKS/.. etc.)
        ...
        :param 'ConnectionSslConfigPrivateServerCertificateArgs' private_server_certificate: Private Server Certificate. Needs to be specified if trust model is PRIVATE.
               Structure is documented below.
        :param builtins.str server_cert_type: Type of Server Cert (PEM/JKS/.. etc.)
               Possible values are: `PEM`.
        :param builtins.str trust_model: Enum for Trust Model
               Possible values are: `PUBLIC`, `PRIVATE`, `INSECURE`.
        :param builtins.bool use_ssl: Bool for enabling SSL
        """
        pulumi.set(__self__, "type", type)
        if additional_variables is not None:
            pulumi.set(__self__, "additional_variables", additional_variables)
    ...
    def client_cert_type(self) -> Optional[builtins.str]:
        """
    ...
    def server_cert_type(self) -> Optional[builtins.str]:
        """
