...
class EngineModelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The description specified for the model when it was created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: One or more labels that you can add, to organize your models.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] name: The name specified for the model.
        :param pulumi.Input[_builtins.bool] online_prediction_console_logging: If true, online prediction nodes send stderr and stdout streams to Stackdriver Logging
        :param pulumi.Input[_builtins.bool] online_prediction_logging: If true, online prediction access logs are sent to StackDriver Logging.
...
class EngineModel(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="onlinePredictionConsoleLogging")
    def online_prediction_console_logging(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If true, online prediction nodes send stderr and stdout streams to Stackdriver Logging
        """
        return pulumi.get(self, "online_prediction_console_logging")
