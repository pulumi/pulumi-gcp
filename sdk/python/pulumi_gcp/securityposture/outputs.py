...
class PosturePolicySet(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str policy_set_id: ID of the policy set.
        :param _builtins.str description: Description of the policy set.
        """
...
class PosturePolicySetPolicyComplianceStandard(dict):
    def __init__(__self__, *,
                 control: Optional[_builtins.str] = None,
                 standard: Optional[_builtins.str] = None):
        """
        :param _builtins.str control: Mapping of security controls for the policy.
        :param _builtins.str standard: Mapping of compliance standards for the policy.
        """
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str canned_constraint_id: Organization policy canned constraint Id
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomCustomConstraint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action_type: The action to take if the condition is met.
               Possible values are: `ALLOW`, `DENY`.
        :param _builtins.str condition: A CEL condition that refers to a supported service resource, for example `resource.management.autoUpgrade == false`. For details about CEL usage, see [Common Expression Language](https://cloud.google.com/resource-manager/docs/organization-policy/creating-managing-custom-constraints#common_expression_language).
        :param Sequence[_builtins.str] method_types: A list of RESTful methods for which to enforce the constraint. Can be `CREATE`, `UPDATE`, or both. Not all Google Cloud services support both methods. To see supported methods for each service, find the service in [Supported services](https://cloud.google.com/resource-manager/docs/organization-policy/custom-constraint-supported-services).
        :param _builtins.str name: Immutable. The name of the custom constraint. This is unique within the organization.
        :param Sequence[_builtins.str] resource_types: Immutable. The fully qualified name of the Google Cloud REST resource containing the object and field you want to restrict. For example, `container.googleapis.com/NodePool`.
        :param _builtins.str description: A human-friendly description of the constraint to display as an error message when the policy is violated.
        :param _builtins.str display_name: A human-friendly name for the constraint.
        """
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool allow_all: Setting this to true means that all values are allowed. This field can be set only in policies for list constraints.
        :param 'PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleConditionArgs' condition: Represents a textual expression in the Common Expression Language (CEL) syntax. CEL is a C-like expression language.
               ...
               Structure is documented below.
        :param _builtins.bool deny_all: Setting this to true means that all values are denied. This field can be set only in policies for list constraints.
        :param _builtins.bool enforce: If `true`, then the policy is enforced. If `false`, then any configuration is acceptable.
...
class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 module_enablement_state: Optional[_builtins.str] = None):
        """
        :param 'PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModuleConfigArgs' config: Custom module details.
               Structure is documented below.
        :param _builtins.str display_name: The display name of the Security Health Analytics custom module. This
               display name becomes the finding category for all findings that are
               returned by this custom module.
        :param _builtins.str id: (Output)
               A server generated id of custom module.
        :param _builtins.str module_enablement_state: The state of enablement for the module at its level of the resource hierarchy.
...
class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModuleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str description: Text that describes the vulnerability or misconfiguration that the custom
               module detects.
        :param _builtins.str recommendation: An explanation of the recommended steps that security teams can take to
...
class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsModule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 module_enablement_state: Optional[_builtins.str] = None):
        """
        :param _builtins.str module_name: The name of the module eg: BIGQUERY_TABLE_CMEK_DISABLED.
        :param _builtins.str module_enablement_state: The state of enablement for the module at its level of the resource hierarchy.
               Possible values are: `ENABLEMENT_STATE_UNSPECIFIED`, `ENABLED`, `DISABLED`.
        """
