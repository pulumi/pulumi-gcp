...
class PosturePolicySetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PosturePolicySetPolicyArgs']]] policies: List of security policy
               Structure is documented below.
        :param pulumi.Input[builtins.str] policy_set_id: ID of the policy set.
        :param pulumi.Input[builtins.str] description: Description of the policy set.
        """
...
if not MYPY:
    class PosturePolicySetPolicyComplianceStandardArgsDict(TypedDict):
        control: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PosturePolicySetPolicyComplianceStandardArgs:
    def __init__(__self__, *,
                 control: Optional[pulumi.Input[builtins.str]] = None,
                 standard: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] control: Mapping of security controls for the policy.
        :param pulumi.Input[builtins.str] standard: Mapping of compliance standards for the policy.
        """
    ...
    @property
    @pulumi.getter
    def control(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Mapping of security controls for the policy.
        """
    ...
    @control.setter
    def control(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PosturePolicySetPolicyConstraintOrgPolicyConstraintArgsDict(TypedDict):
        canned_constraint_id: pulumi.Input[builtins.str]
        """
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] canned_constraint_id: Organization policy canned constraint Id
    ...
    def canned_constraint_id(self) -> pulumi.Input[builtins.str]:
        """
        Organization policy canned constraint Id
        """
    ...
    def canned_constraint_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleArgsDict(TypedDict):
        allow_all: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        Structure is documented below.
        """
        deny_all: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleArgs:
    def __init__(__self__, *,
                 ...
                 deny_all: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] allow_all: Setting this to true means that all values are allowed. This field can be set only in policies for list constraints.
        :param pulumi.Input['PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleConditionArgs'] condition: Represents a textual expression in the Common Expression Language (CEL) syntax. CEL is a C-like expression language.
               ...
               custom access levels - https://cloud.google.com/access-context-manager/docs/custom-access-level-spec.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] deny_all: Setting this to true means that all values are denied. This field can be set only in policies for list constraints.
        :param pulumi.Input[builtins.bool] enforce: If `true`, then the policy is enforced. If `false`, then any configuration is acceptable.
               This field can be set only in policies for boolean constraints.
    ...
    def deny_all(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Setting this to true means that all values are denied. This field can be set only in policies for list constraints.
        """
    ...
    @deny_all.setter
    def deny_all(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: String indicating the location of the expression for error reporting, e.g. a file name and a position in the file
...
if not MYPY:
    class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModuleArgsDict(TypedDict):
        ...
        """
        module_enablement_state: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModuleArgs:
    def __init__(__self__, *,
                 ...
                 module_enablement_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] id: (Output)
               A server generated id of custom module.
        :param pulumi.Input[builtins.str] module_enablement_state: The state of enablement for the module at its level of the resource hierarchy.
               Possible values are: `ENABLEMENT_STATE_UNSPECIFIED`, `ENABLED`, `DISABLED`.
        """
    ...
    def module_enablement_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The state of enablement for the module at its level of the resource hierarchy.
        Possible values are: `ENABLEMENT_STATE_UNSPECIFIED`, `ENABLED`, `DISABLED`.
        """
    ...
    def module_enablement_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModuleConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Text that describes the vulnerability or misconfiguration that the custom
               module detects.
        :param pulumi.Input[builtins.str] recommendation: An explanation of the recommended steps that security teams can take to
               resolve the detected issue
        """
...
class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsModuleArgs:
    def __init__(__self__, *,
                 ...
                 module_enablement_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] module_name: The name of the module eg: BIGQUERY_TABLE_CMEK_DISABLED.
        :param pulumi.Input[builtins.str] module_enablement_state: The state of enablement for the module at its level of the resource hierarchy.
               Possible values are: `ENABLEMENT_STATE_UNSPECIFIED`, `ENABLED`, `DISABLED`.
        """
