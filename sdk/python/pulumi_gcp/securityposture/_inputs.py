...
class PosturePolicySetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PosturePolicySetPolicyArgs']]] policies: List of security policy
               Structure is documented below.
        :param pulumi.Input[_builtins.str] policy_set_id: ID of the policy set.
        :param pulumi.Input[_builtins.str] description: Description of the policy set.
        """
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] canned_constraint_id: Organization policy canned constraint Id
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleConditionArgs'] condition: Represents a textual expression in the Common Expression Language (CEL) syntax. CEL is a C-like expression language.
               ...
               custom access levels - https://cloud.google.com/access-context-manager/docs/custom-access-level-spec.
               Structure is documented below.
        :param pulumi.Input[_builtins.bool] deny_all: Setting this to true means that all values are denied. This field can be set only in policies for list constraints.
        :param pulumi.Input[_builtins.bool] enforce: If `true`, then the policy is enforced. If `false`, then any configuration is acceptable.
               This field can be set only in policies for boolean constraints.
...
class PosturePolicySetPolicyConstraintOrgPolicyConstraintCustomPolicyRuleConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: String indicating the location of the expression for error reporting, e.g. a file name and a position in the file
...
class PosturePolicySetPolicyConstraintSecurityHealthAnalyticsCustomModuleConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Text that describes the vulnerability or misconfiguration that the custom
               module detects.
        :param pulumi.Input[_builtins.str] recommendation: An explanation of the recommended steps that security teams can take to
               resolve the detected issue
        """
