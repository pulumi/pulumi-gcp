...
class PipelineScheduleInfo(dict):
    ...
    def __init__(__self__, *,
                 next_job_time: Optional[builtins.str] = None,
                 schedule: Optional[builtins.str] = None,
                 time_zone: Optional[builtins.str] = None):
        """
        :param builtins.str next_job_time: (Output)
               When the next Scheduler job is going to run.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param builtins.str schedule: Unix-cron format of the schedule. This information is retrieved from the linked Cloud Scheduler.
        :param builtins.str time_zone: Timezone ID. This matches the timezone IDs used by the Cloud Scheduler API. If empty, UTC time is assumed.
        """
    ...
    def next_job_time(self) -> Optional[builtins.str]:
        """
        (Output)
        When the next Scheduler job is going to run.
        A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
...
class PipelineWorkloadDataflowFlexTemplateRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 validate_only: Optional[builtins.bool] = None):
        """
        :param 'PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgs' launch_parameter: Parameter to launch a job from a Flex Template.
               ...
               Structure is documented below.
        :param builtins.str location: The regional endpoint to which to direct the request. For example, us-central1, us-west1.
        :param builtins.str project_id: The ID of the Cloud Platform project that the job belongs to.
        :param builtins.bool validate_only: If true, the request is validated but not actually executed. Defaults to false.
        """
    ...
    def validate_only(self) -> Optional[builtins.bool]:
        """
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 container_spec_gcs_path: Optional[builtins.str] = None,
                 environment: Optional['outputs.PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironment'] = None,
                 launch_options: Optional[Mapping[str, builtins.str]] = None,
                 parameters: Optional[Mapping[str, builtins.str]] = None,
                 transform_name_mappings: Optional[Mapping[str, builtins.str]] = None,
                 update: Optional[builtins.bool] = None):
        """
        :param builtins.str job_name: The job name to use for the created job. For an update job request, the job name should be the same as the existing running job.
        :param builtins.str container_spec_gcs_path: Cloud Storage path to a file with a JSON-serialized ContainerSpec as content.
        :param 'PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs' environment: The runtime environment for the Flex Template job.
               ...
               Structure is documented below.
        :param Mapping[str, builtins.str] launch_options: Launch options for this Flex Template job. This is a common set of options across languages and templates. This should not be used to pass job parameters.
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param Mapping[str, builtins.str] parameters: 'The parameters for the Flex Template. Example: {"numWorkers":"5"}'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param Mapping[str, builtins.str] transform_name_mappings: 'Use this to pass transform name mappings for streaming update jobs. Example: {"oldTransformName":"newTransformName",...}'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param builtins.bool update: Set this to true if you are sending a request to update a running streaming job. When set, the job name should be the same as the running job.
        """
    ...
    def container_spec_gcs_path(self) -> Optional[builtins.str]:
        """
    ...
    def launch_options(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def transform_name_mappings(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironment(dict):
    ...
    def __init__(__self__, *,
                 additional_experiments: Optional[Sequence[builtins.str]] = None,
                 additional_user_labels: Optional[Mapping[str, builtins.str]] = None,
                 enable_streaming_engine: Optional[builtins.bool] = None,
                 flexrs_goal: Optional[builtins.str] = None,
                 ip_configuration: Optional[builtins.str] = None,
                 kms_key_name: Optional[builtins.str] = None,
                 machine_type: Optional[builtins.str] = None,
                 max_workers: Optional[builtins.int] = None,
                 ...
                 temp_location: Optional[builtins.str] = None,
                 worker_region: Optional[builtins.str] = None,
                 worker_zone: Optional[builtins.str] = None,
                 zone: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] additional_experiments: Additional experiment flags for the job.
        :param Mapping[str, builtins.str] additional_user_labels: Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the labeling restrictions page. An object containing a list of key/value pairs.
               'Example: { "name": "wrench", "mass": "1kg", "count": "3" }.'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param builtins.bool enable_streaming_engine: Whether to enable Streaming Engine for the job.
        :param builtins.str flexrs_goal: Set FlexRS goal for the job. https://cloud.google.com/dataflow/docs/guides/flexrs
        ...
        :param builtins.str ip_configuration: Configuration for VM IPs.
        ...
        :param builtins.str kms_key_name: 'Name for the Cloud KMS key for the job. The key format is: projects//locations//keyRings//cryptoKeys/'
        :param builtins.str machine_type: The machine type to use for the job. Defaults to the value from the template if not specified.
        :param builtins.int max_workers: The maximum number of Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000.
        :param builtins.str network: Network to which VMs will be assigned. If empty or unspecified, the service will use the network "default".
        :param builtins.int num_workers: The initial number of Compute Engine instances for the job.
        :param builtins.str service_account_email: The email address of the service account to run the job as.
        :param builtins.str subnetwork: Subnetwork to which VMs will be assigned, if desired. You can specify a subnetwork using either a complete URL or an abbreviated path. Expected to be of the form "https://www.googleapis.com/compute/v1/projects/HOST_PROJECT_ID/regions/REGION/subnetworks/SUBNETWORK" or "regions/REGION/subnetworks/SUBNETWORK". If the subnetwork is located in a Shared VPC network, you must use the complete URL.
        :param builtins.str temp_location: The Cloud Storage path to use for temporary files. Must be a valid Cloud Storage URL, beginning with gs://.
        :param builtins.str worker_region: The Compute Engine region (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. "us-west1". Mutually exclusive with workerZone. If neither workerRegion nor workerZone is specified, default to the control plane's region.
        :param builtins.str worker_zone: The Compute Engine zone (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. "us-west1-a". Mutually exclusive with workerRegion. If neither workerRegion nor workerZone is specified, a zone in the control plane's region is chosen based on available capacity. If both workerZone and zone are set, workerZone takes precedence.
        :param builtins.str zone: The Compute Engine availability zone for launching worker instances to run your pipeline. In the future, workerZone will take precedence.
        """
    ...
    def additional_experiments(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def additional_user_labels(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def enable_streaming_engine(self) -> Optional[builtins.bool]:
        """
    ...
    def flexrs_goal(self) -> Optional[builtins.str]:
        """
    ...
    def ip_configuration(self) -> Optional[builtins.str]:
        """
    ...
    def max_workers(self) -> Optional[builtins.int]:
        """
    ...
    def num_workers(self) -> Optional[builtins.int]:
        """
    ...
    def temp_location(self) -> Optional[builtins.str]:
        """
    ...
    def worker_region(self) -> Optional[builtins.str]:
        """
    ...
    def worker_zone(self) -> Optional[builtins.str]:
        """
...
class PipelineWorkloadDataflowLaunchTemplateRequest(dict):
    ...
    def __init__(__self__, *,
                 project_id: builtins.str,
                 gcs_path: Optional[builtins.str] = None,
                 launch_parameters: Optional['outputs.PipelineWorkloadDataflowLaunchTemplateRequestLaunchParameters'] = None,
                 location: Optional[builtins.str] = None,
                 validate_only: Optional[builtins.bool] = None):
        """
        :param builtins.str project_id: The ID of the Cloud Platform project that the job belongs to.
        :param builtins.str gcs_path: A Cloud Storage path to the template from which to create the job. Must be a valid Cloud Storage URL, beginning with 'gs://'.
        :param 'PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs' launch_parameters: The parameters of the template to launch. This should be part of the body of the POST request.
               ...
               Structure is documented below.
        :param builtins.str location: The regional endpoint to which to direct the request.
        :param builtins.bool validate_only: (Optional)
        """
        pulumi.set(__self__, "project_id", project_id)
    ...
    def gcs_path(self) -> Optional[builtins.str]:
        """
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParameters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parameters: Optional[Mapping[str, builtins.str]] = None,
                 transform_name_mapping: Optional[Mapping[str, builtins.str]] = None,
                 update: Optional[builtins.bool] = None):
        """
        :param builtins.str job_name: The job name to use for the created job.
        :param 'PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs' environment: The runtime environment for the job.
               ...
               Structure is documented below.
        :param Mapping[str, builtins.str] parameters: The runtime parameters to pass to the job.
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param Mapping[str, builtins.str] transform_name_mapping: Map of transform name prefixes of the job to be replaced to the corresponding name prefixes of the new job. Only applicable when updating a pipeline.
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param builtins.bool update: If set, replace the existing pipeline with the name specified by jobName with this pipeline, preserving state.
        """
        pulumi.set(__self__, "job_name", job_name)
        if environment is not None:
            pulumi.set(__self__, "environment", environment)
    ...
    def transform_name_mapping(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironment(dict):
    ...
    def __init__(__self__, *,
                 additional_experiments: Optional[Sequence[builtins.str]] = None,
                 additional_user_labels: Optional[Mapping[str, builtins.str]] = None,
                 bypass_temp_dir_validation: Optional[builtins.bool] = None,
                 enable_streaming_engine: Optional[builtins.bool] = None,
                 ip_configuration: Optional[builtins.str] = None,
                 kms_key_name: Optional[builtins.str] = None,
                 machine_type: Optional[builtins.str] = None,
        ...
        :param Mapping[str, builtins.str] additional_user_labels: Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the labeling restrictions page. An object containing a list of key/value pairs.
               'Example: { "name": "wrench", "mass": "1kg", "count": "3" }.'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param builtins.bool bypass_temp_dir_validation: Whether to bypass the safety checks for the job's temporary directory. Use with caution.
        :param builtins.bool enable_streaming_engine: Whether to enable Streaming Engine for the job.
        :param builtins.str ip_configuration: Configuration for VM IPs.
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#WorkerIPAddressConfiguration
               Possible values are: `WORKER_IP_UNSPECIFIED`, `WORKER_IP_PUBLIC`, `WORKER_IP_PRIVATE`.
    ...
    def bypass_temp_dir_validation(self) -> Optional[builtins.bool]:
        """
