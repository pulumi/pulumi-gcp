...
class JobArgs:
    def __init__(__self__, *,
                 temp_gcs_location: pulumi.Input[builtins.str],
                 template_gcs_path: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] temp_gcs_location: A writeable location on GCS for the Dataflow job to dump its temporary data.
               
               - - -
        :param pulumi.Input[builtins.str] template_gcs_path: The GCS path to the Dataflow job template.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User labels to be specified for the job. Keys and values should follow the restrictions
        ...
        :param pulumi.Input[builtins.int] max_workers: The number of workers permitted to work on the job.  More workers may improve processing speed at additional cost.
        :param pulumi.Input[builtins.str] name: A unique name for the resource, required by Dataflow.
        ...
        :param pulumi.Input[builtins.str] on_delete: One of "drain" or "cancel".  Specifies behavior of deletion during `pulumi destroy`.  See above note.
        ...
        :param pulumi.Input[builtins.str] project: The project in which the resource belongs. If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] region: The region in which the created job should run.
        :param pulumi.Input[builtins.str] service_account_email: The Service Account email used to create the job. This should be just an email e.g. `myserviceaccount@myproject.iam.gserviceaccount.com`. Do not include any `serviceAccount:` or other prefix.
        :param pulumi.Input[builtins.bool] skip_wait_on_job_termination: If set to `true`, Pulumi will treat `DRAINING` and `CANCELLING` as terminal states when deleting the resource, and will remove the resource from Pulumi state and move on.  See above note.
        :param pulumi.Input[builtins.str] subnetwork: The subnetwork to which VMs will be assigned. Should be of the form "regions/REGION/subnetworks/SUBNETWORK". If the [subnetwork is located in a Shared VPC network](https://cloud.google.com/dataflow/docs/guides/specifying-networks#shared), you must use the complete URL. For example `"googleapis.com/compute/v1/projects/PROJECT_ID/regions/REGION/subnetworks/SUBNET_NAME"`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] transform_name_mapping: Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job. This field is not used outside of update.
        :param pulumi.Input[builtins.str] zone: The zone in which the created job should run. If it is not provided, the provider zone is used.
        """
    ...
    def temp_gcs_location(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def temp_gcs_location(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "temp_gcs_location", value)

    @property
    @pulumi.getter(name="templateGcsPath")
    def template_gcs_path(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def template_gcs_path(self, value: pulumi.Input[builtins.str]):
...
class _JobState:
    def __init__(__self__, *,
                 ...
                 subnetwork: Optional[pulumi.Input[builtins.str]] = None,
                 temp_gcs_location: Optional[pulumi.Input[builtins.str]] = None,
                 template_gcs_path: Optional[pulumi.Input[builtins.str]] = None,
                 transform_name_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] template_gcs_path: The GCS path to the Dataflow job template.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] transform_name_mapping: Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job. This field is not used outside of update.
        :param pulumi.Input[builtins.str] type: The type of this job, selected from the [JobType enum](https://cloud.google.com/dataflow/docs/reference/rest/v1b3/projects.jobs#Job.JobType)
        :param pulumi.Input[builtins.str] zone: The zone in which the created job should run. If it is not provided, the provider zone is used.
        """
        if additional_experiments is not None:
            pulumi.set(__self__, "additional_experiments", additional_experiments)
    ...
    @property
    @pulumi.getter(name="tempGcsLocation")
    def temp_gcs_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A writeable location on GCS for the Dataflow job to dump its temporary data.
    ...
    @temp_gcs_location.setter
    def temp_gcs_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "temp_gcs_location", value)

    @property
    @pulumi.getter(name="templateGcsPath")
    def template_gcs_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The GCS path to the Dataflow job template.
        """
        return pulumi.get(self, "template_gcs_path")
    ...
    @template_gcs_path.setter
    def template_gcs_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "template_gcs_path", value)
...
class Job(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transform_name_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Job':
        """
    ...
    @property
    @pulumi.getter(name="machineType")
    def machine_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The machine type to use for the job.
        """
        return pulumi.get(self, "machine_type")
    ...
    @property
    @pulumi.getter(name="tempGcsLocation")
    def temp_gcs_location(self) -> pulumi.Output[builtins.str]:
        """
        A writeable location on GCS for the Dataflow job to dump its temporary data.
    ...
    @property
    @pulumi.getter(name="templateGcsPath")
    def template_gcs_path(self) -> pulumi.Output[builtins.str]:
        """
        The GCS path to the Dataflow job template.
        """
        return pulumi.get(self, "template_gcs_path")
