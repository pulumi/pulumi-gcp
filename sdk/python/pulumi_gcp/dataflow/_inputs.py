...
class PipelineScheduleInfoArgs:
    def __init__(__self__, *,
                 next_job_time: Optional[pulumi.Input[_builtins.str]] = None,
...
class PipelineWorkloadDataflowFlexTemplateRequestArgs:
    def __init__(__self__, *,
                 ...
                 location: pulumi.Input[_builtins.str],
                 project_id: pulumi.Input[_builtins.str],
                 validate_only: Optional[pulumi.Input[_builtins.bool]] = None):
        """
...
if not MYPY:
    class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgsDict(TypedDict):
        ...
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        """
        transform_name_mappings: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]
        """
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgs:
    def __init__(__self__, *,
                 ...
                 launch_options: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 transform_name_mappings: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    def launch_options(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Launch options for this Flex Template job. This is a common set of options across languages and templates. This should not be used to pass job parameters.
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        """
    ...
    def launch_options(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]):
    ...
    def transform_name_mappings(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        'Use this to pass transform name mappings for streaming update jobs. Example: {"oldTransformName":"newTransformName",...}'
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        """
    ...
    def transform_name_mappings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
if not MYPY:
    class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgsDict(TypedDict):
        additional_experiments: NotRequired[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]
        """
        Additional experiment flags for the job.
        """
        additional_user_labels: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]
        """
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 additional_user_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 enable_streaming_engine: Optional[pulumi.Input[_builtins.bool]] = None,
                 flexrs_goal: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 worker_region: Optional[pulumi.Input[_builtins.str]] = None,
                 worker_zone: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def additional_user_labels(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the labeling restrictions page. An object containing a list of key/value pairs.
        'Example: { "name": "wrench", "mass": "1kg", "count": "3" }.'
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
    ...
    def additional_user_labels(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class PipelineWorkloadDataflowLaunchTemplateRequestArgs:
    def __init__(__self__, *,
                 project_id: pulumi.Input[_builtins.str],
                 gcs_path: Optional[pulumi.Input[_builtins.str]] = None,
...
if not MYPY:
    class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgsDict(TypedDict):
        ...
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        """
        transform_name_mapping: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]
        """
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs:
    def __init__(__self__, *,
                 additional_experiments: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 additional_user_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 bypass_temp_dir_validation: Optional[pulumi.Input[_builtins.bool]] = None,
                 enable_streaming_engine: Optional[pulumi.Input[_builtins.bool]] = None,
                 ip_configuration: Optional[pulumi.Input[_builtins.str]] = None,
                 kms_key_name: Optional[pulumi.Input[_builtins.str]] = None,
                 machine_type: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def bypass_temp_dir_validation(self, value: Optional[pulumi.Input[_builtins.bool]]):
