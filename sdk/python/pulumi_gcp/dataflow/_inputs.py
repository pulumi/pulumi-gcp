...
class PipelineScheduleInfoArgsDict(TypedDict):
    next_job_time: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
...
class PipelineScheduleInfoArgs:
    def __init__(__self__, *,
                 next_job_time: pulumi.Input[Optional[_builtins.str]] = None,
                 schedule: pulumi.Input[Optional[_builtins.str]] = None,
                 time_zone: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] next_job_time: (Output)
               When the next Scheduler job is going to run.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[_builtins.str] schedule: Unix-cron format of the schedule. This information is retrieved from the linked Cloud Scheduler.
        :param pulumi.Input[_builtins.str] time_zone: Timezone ID. This matches the timezone IDs used by the Cloud Scheduler API. If empty, UTC time is assumed.
        """
    ...
    def next_job_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        When the next Scheduler job is going to run.
        A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
    ...
    def next_job_time(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class PipelineWorkloadArgs:
    def __init__(__self__, *,
                 dataflow_flex_template_request: pulumi.Input[Optional['PipelineWorkloadDataflowFlexTemplateRequestArgs']] = None,
                 dataflow_launch_template_request: pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestArgs']] = None):
        """
    ...
    def dataflow_flex_template_request(self) -> pulumi.Input[Optional['PipelineWorkloadDataflowFlexTemplateRequestArgs']]:
        """
        Template information and additional parameters needed to launch a Dataflow job using the flex launch API.
        https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#launchflextemplaterequest
        Structure is documented below.
    ...
    def dataflow_flex_template_request(self, value: pulumi.Input[Optional['PipelineWorkloadDataflowFlexTemplateRequestArgs']]):
        pulumi.set(self, "dataflow_flex_template_request", value)

    @_builtins.property
    @pulumi.getter(name="dataflowLaunchTemplateRequest")
    def dataflow_launch_template_request(self) -> pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestArgs']]:
        """
        Template information and additional parameters needed to launch a Dataflow job using the standard launch API.
        https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#launchtemplaterequest
        Structure is documented below.
    ...
    def dataflow_launch_template_request(self, value: pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestArgs']]):
...
class PipelineWorkloadDataflowFlexTemplateRequestArgsDict(TypedDict):
    ...
    """
    validate_only: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class PipelineWorkloadDataflowFlexTemplateRequestArgs:
    def __init__(__self__, *,
                 ...
                 location: pulumi.Input[_builtins.str],
                 project_id: pulumi.Input[_builtins.str],
                 validate_only: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input['PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgs'] launch_parameter: Parameter to launch a job from a Flex Template.
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#launchflextemplateparameter
               Structure is documented below.
        :param pulumi.Input[_builtins.str] location: The regional endpoint to which to direct the request. For example, us-central1, us-west1.
        :param pulumi.Input[_builtins.str] project_id: The ID of the Cloud Platform project that the job belongs to.
        :param pulumi.Input[_builtins.bool] validate_only: If true, the request is validated but not actually executed. Defaults to false.
        """
    ...
    def validate_only(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true, the request is validated but not actually executed. Defaults to false.
        """
    ...
    def validate_only(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgsDict(TypedDict):
    ...
    """
    container_spec_gcs_path: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    Structure is documented below.
    """
    launch_options: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
    ...
    'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
    """
    transform_name_mappings: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterArgs:
    def __init__(__self__, *,
                 ...
                 environment: pulumi.Input[Optional['PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs']] = None,
                 launch_options: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 transform_name_mappings: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 update: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] job_name: The job name to use for the created job. For an update job request, the job name should be the same as the existing running job.
        :param pulumi.Input[_builtins.str] container_spec_gcs_path: Cloud Storage path to a file with a JSON-serialized ContainerSpec as content.
        :param pulumi.Input['PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs'] environment: The runtime environment for the Flex Template job.
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#FlexTemplateRuntimeEnvironment
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] launch_options: Launch options for this Flex Template job. This is a common set of options across languages and templates. This should not be used to pass job parameters.
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: 'The parameters for the Flex Template. Example: {"numWorkers":"5"}'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] transform_name_mappings: 'Use this to pass transform name mappings for streaming update jobs. Example: {"oldTransformName":"newTransformName",...}'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param pulumi.Input[_builtins.bool] update: Set this to true if you are sending a request to update a running streaming job. When set, the job name should be the same as the running job.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def environment(self) -> pulumi.Input[Optional['PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs']]:
        """
        The runtime environment for the Flex Template job.
        https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#FlexTemplateRuntimeEnvironment
        Structure is documented below.
    ...
    @environment.setter
    def environment(self, value: pulumi.Input[Optional['PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs']]):
        pulumi.set(self, "environment", value)

    @_builtins.property
    @pulumi.getter(name="launchOptions")
    def launch_options(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Launch options for this Flex Template job. This is a common set of options across languages and templates. This should not be used to pass job parameters.
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        """
    ...
    def launch_options(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
    ...
    def transform_name_mappings(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        'Use this to pass transform name mappings for streaming update jobs. Example: {"oldTransformName":"newTransformName",...}'
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        """
    ...
    def transform_name_mappings(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgsDict(TypedDict):
    additional_experiments: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    Additional experiment flags for the job.
    """
    additional_user_labels: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
    ...
    'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
    """
    enable_streaming_engine: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to enable Streaming Engine for the job.
    """
    flexrs_goal: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    ip_configuration: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    temp_location: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The Cloud Storage path to use for temporary files. Must be a valid Cloud Storage URL, beginning with gs://.
    """
    worker_region: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The Compute Engine region (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. "us-west1". Mutually exclusive with workerZone. If neither workerRegion nor workerZone is specified, default to the control plane's region.
    """
    worker_zone: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class PipelineWorkloadDataflowFlexTemplateRequestLaunchParameterEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 additional_user_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 enable_streaming_engine: pulumi.Input[Optional[_builtins.bool]] = None,
                 flexrs_goal: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 worker_region: pulumi.Input[Optional[_builtins.str]] = None,
                 worker_zone: pulumi.Input[Optional[_builtins.str]] = None,
                 zone: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] additional_experiments: Additional experiment flags for the job.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] additional_user_labels: Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the labeling restrictions page. An object containing a list of key/value pairs.
               'Example: { "name": "wrench", "mass": "1kg", "count": "3" }.'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param pulumi.Input[_builtins.bool] enable_streaming_engine: Whether to enable Streaming Engine for the job.
        :param pulumi.Input[_builtins.str] flexrs_goal: Set FlexRS goal for the job. https://cloud.google.com/dataflow/docs/guides/flexrs
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#FlexResourceSchedulingGoal
               Possible values are: `FLEXRS_UNSPECIFIED`, `FLEXRS_SPEED_OPTIMIZED`, `FLEXRS_COST_OPTIMIZED`.
        :param pulumi.Input[_builtins.str] ip_configuration: Configuration for VM IPs.
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#WorkerIPAddressConfiguration
               Possible values are: `WORKER_IP_UNSPECIFIED`, `WORKER_IP_PUBLIC`, `WORKER_IP_PRIVATE`.
        :param pulumi.Input[_builtins.str] kms_key_name: 'Name for the Cloud KMS key for the job. The key format is: projects//locations//keyRings//cryptoKeys/'
        :param pulumi.Input[_builtins.str] machine_type: The machine type to use for the job. Defaults to the value from the template if not specified.
        :param pulumi.Input[_builtins.int] max_workers: The maximum number of Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000.
        :param pulumi.Input[_builtins.str] network: Network to which VMs will be assigned. If empty or unspecified, the service will use the network "default".
        :param pulumi.Input[_builtins.int] num_workers: The initial number of Compute Engine instances for the job.
        :param pulumi.Input[_builtins.str] service_account_email: The email address of the service account to run the job as.
        :param pulumi.Input[_builtins.str] subnetwork: Subnetwork to which VMs will be assigned, if desired. You can specify a subnetwork using either a complete URL or an abbreviated path. Expected to be of the form "https://www.googleapis.com/compute/v1/projects/HOST_PROJECT_ID/regions/REGION/subnetworks/SUBNETWORK" or "regions/REGION/subnetworks/SUBNETWORK". If the subnetwork is located in a Shared VPC network, you must use the complete URL.
        ...
        :param pulumi.Input[_builtins.str] worker_region: The Compute Engine region (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. "us-west1". Mutually exclusive with workerZone. If neither workerRegion nor workerZone is specified, default to the control plane's region.
        :param pulumi.Input[_builtins.str] worker_zone: The Compute Engine zone (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. "us-west1-a". Mutually exclusive with workerRegion. If neither workerRegion nor workerZone is specified, a zone in the control plane's region is chosen based on available capacity. If both workerZone and zone are set, workerZone takes precedence.
        :param pulumi.Input[_builtins.str] zone: The Compute Engine availability zone for launching worker instances to run your pipeline. In the future, workerZone will take precedence.
        """
    ...
    def additional_user_labels(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the labeling restrictions page. An object containing a list of key/value pairs.
        'Example: { "name": "wrench", "mass": "1kg", "count": "3" }.'
        'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
    ...
    def additional_user_labels(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
    ...
    def flexrs_goal(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Set FlexRS goal for the job. https://cloud.google.com/dataflow/docs/guides/flexrs
        https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#FlexResourceSchedulingGoal
        Possible values are: `FLEXRS_UNSPECIFIED`, `FLEXRS_SPEED_OPTIMIZED`, `FLEXRS_COST_OPTIMIZED`.
    ...
    @flexrs_goal.setter
    def flexrs_goal(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def worker_region(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The Compute Engine region (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. "us-west1". Mutually exclusive with workerZone. If neither workerRegion nor workerZone is specified, default to the control plane's region.
        """
    ...
    def worker_region(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "worker_region", value)

    @_builtins.property
    @pulumi.getter(name="workerZone")
    def worker_zone(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The Compute Engine zone (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. "us-west1-a". Mutually exclusive with workerRegion. If neither workerRegion nor workerZone is specified, a zone in the control plane's region is chosen based on available capacity. If both workerZone and zone are set, workerZone takes precedence.
        """
    ...
    @worker_zone.setter
    def worker_zone(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class PipelineWorkloadDataflowLaunchTemplateRequestArgsDict(TypedDict):
    ...
    The ID of the Cloud Platform project that the job belongs to.
    """
    gcs_path: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class PipelineWorkloadDataflowLaunchTemplateRequestArgs:
    def __init__(__self__, *,
                 project_id: pulumi.Input[_builtins.str],
                 gcs_path: pulumi.Input[Optional[_builtins.str]] = None,
                 launch_parameters: pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs']] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 validate_only: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] project_id: The ID of the Cloud Platform project that the job belongs to.
        :param pulumi.Input[_builtins.str] gcs_path: A Cloud Storage path to the template from which to create the job. Must be a valid Cloud Storage URL, beginning with 'gs://'.
        :param pulumi.Input['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs'] launch_parameters: The parameters of the template to launch. This should be part of the body of the POST request.
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#launchtemplateparameters
               Structure is documented below.
        :param pulumi.Input[_builtins.str] location: The regional endpoint to which to direct the request.
        :param pulumi.Input[_builtins.bool] validate_only: (Optional)
        """
        pulumi.set(__self__, "project_id", project_id)
    ...
    def gcs_path(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        A Cloud Storage path to the template from which to create the job. Must be a valid Cloud Storage URL, beginning with 'gs://'.
        """
    ...
    @gcs_path.setter
    def gcs_path(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "gcs_path", value)

    @_builtins.property
    @pulumi.getter(name="launchParameters")
    def launch_parameters(self) -> pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs']]:
        """
        The parameters of the template to launch. This should be part of the body of the POST request.
        https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#launchtemplateparameters
        Structure is documented below.
    ...
    def launch_parameters(self, value: pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs']]):
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgsDict(TypedDict):
    ...
    'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
    """
    transform_name_mapping: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersArgs:
    def __init__(__self__, *,
                 job_name: pulumi.Input[_builtins.str],
                 environment: pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs']] = None,
                 parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 transform_name_mapping: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 update: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.str] job_name: The job name to use for the created job.
        :param pulumi.Input['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs'] environment: The runtime environment for the job.
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#RuntimeEnvironment
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: The runtime parameters to pass to the job.
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] transform_name_mapping: Map of transform name prefixes of the job to be replaced to the corresponding name prefixes of the new job. Only applicable when updating a pipeline.
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param pulumi.Input[_builtins.bool] update: If set, replace the existing pipeline with the name specified by jobName with this pipeline, preserving state.
        """
        pulumi.set(__self__, "job_name", job_name)
        if environment is not None:
            pulumi.set(__self__, "environment", environment)
    ...
    @_builtins.property
    @pulumi.getter
    def environment(self) -> pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs']]:
        """
        The runtime environment for the job.
        https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#RuntimeEnvironment
        Structure is documented below.
    ...
    @environment.setter
    def environment(self, value: pulumi.Input[Optional['PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs']]):
        pulumi.set(self, "environment", value)
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgsDict(TypedDict):
    ...
    'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
    """
    bypass_temp_dir_validation: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class PipelineWorkloadDataflowLaunchTemplateRequestLaunchParametersEnvironmentArgs:
    def __init__(__self__, *,
                 additional_experiments: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 additional_user_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 bypass_temp_dir_validation: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_streaming_engine: pulumi.Input[Optional[_builtins.bool]] = None,
                 ip_configuration: pulumi.Input[Optional[_builtins.str]] = None,
                 kms_key_name: pulumi.Input[Optional[_builtins.str]] = None,
                 machine_type: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] additional_user_labels: Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the labeling restrictions page. An object containing a list of key/value pairs.
               'Example: { "name": "wrench", "mass": "1kg", "count": "3" }.'
               'An object containing a list of "key": value pairs. Example: { "name": "wrench", "mass": "1.3kg", "count": "3" }.'
        :param pulumi.Input[_builtins.bool] bypass_temp_dir_validation: Whether to bypass the safety checks for the job's temporary directory. Use with caution.
        :param pulumi.Input[_builtins.bool] enable_streaming_engine: Whether to enable Streaming Engine for the job.
        :param pulumi.Input[_builtins.str] ip_configuration: Configuration for VM IPs.
               https://cloud.google.com/dataflow/docs/reference/data-pipelines/rest/v1/projects.locations.pipelines#WorkerIPAddressConfiguration
               Possible values are: `WORKER_IP_UNSPECIFIED`, `WORKER_IP_PUBLIC`, `WORKER_IP_PRIVATE`.
    ...
    def bypass_temp_dir_validation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to bypass the safety checks for the job's temporary directory. Use with caution.
        """
    ...
    def bypass_temp_dir_validation(self, value: pulumi.Input[Optional[_builtins.bool]]):
