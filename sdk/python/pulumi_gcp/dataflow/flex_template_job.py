...
class FlexTemplateJob(pulumi.CustomResource):
    container_spec_gcs_path: pulumi.Output[str]
    """
    ...
    """
    def __init__(__self__, resource_name, opts=None, container_spec_gcs_path=None, labels=None, name=None, on_delete=None, parameters=None, project=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[str] container_spec_gcs_path: The GCS path to the Dataflow job Flex
               Template.
        :param pulumi.Input[dict] labels: User labels to be specified for the job. Keys and values
               should follow the restrictions specified in the [labeling restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions)
               page. **NOTE**: Google-provided Dataflow templates often provide default labels
               that begin with `goog-dataflow-provided`. Unless explicitly set in config, these
               labels will be ignored to prevent diffs on re-apply.
        :param pulumi.Input[str] name: A unique name for the resource, required by Dataflow.
        :param pulumi.Input[dict] parameters: Key/Value pairs to be passed to the Dataflow job (as
               used in the template).
    ...
    @staticmethod
    def get(resource_name, id, opts=None, container_spec_gcs_path=None, job_id=None, labels=None, name=None, on_delete=None, parameters=None, project=None, state=None):
        """
