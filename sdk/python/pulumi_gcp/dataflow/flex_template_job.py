...
class FlexTemplateJobArgs:
    def __init__(__self__, *,
                 ...
                 launcher_machine_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 on_delete: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 sdk_container_image: Optional[pulumi.Input[builtins.str]] = None,
                 service_account_email: Optional[pulumi.Input[builtins.str]] = None,
                 skip_wait_on_job_termination: Optional[pulumi.Input[builtins.bool]] = None,
                 staging_location: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kms_key_name: The name for the Cloud KMS key for the job. Key format is: `projects/PROJECT_ID/locations/LOCATION/keyRings/KEY_RING/cryptoKeys/KEY`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User labels to be specified for the job. Keys and values
        ...
        :param pulumi.Input[builtins.str] launcher_machine_type: The machine type to use for launching the job. The default is n1-standard-1.
        :param pulumi.Input[builtins.str] machine_type: The machine type to use for the job.
        :param pulumi.Input[builtins.int] max_workers: Immutable. The maximum number of Google Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000.
        :param pulumi.Input[builtins.str] name: Immutable. A unique name for the resource, required by Dataflow.
        :param pulumi.Input[builtins.str] network: The network to which VMs will be assigned. If it is not provided, "default" will be used.
        :param pulumi.Input[builtins.int] num_workers: Immutable. The initial number of Google Compute Engine instances for the job.
        :param pulumi.Input[builtins.str] on_delete: One of "drain" or "cancel". Specifies behavior of
               deletion during `pulumi destroy`.  See above note.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: **Template specific** Key/Value pairs to be forwarded to the pipeline's options; keys are
               case-sensitive based on the language on which the pipeline is coded, mostly Java.
               **Note**: do not configure Dataflow options here in parameters.
        :param pulumi.Input[builtins.str] project: The project in which the resource belongs. If it is not
               provided, the provider project is used.
        :param pulumi.Input[builtins.str] region: Immutable. The region in which the created job should run.
        :param pulumi.Input[builtins.str] sdk_container_image: Docker registry location of container image to use for the 'worker harness. Default is the container for the version of the SDK. Note this field is only valid for portable pipelines.
        :param pulumi.Input[builtins.str] service_account_email: Service account email to run the workers as. This should be just an email e.g. `myserviceaccount@myproject.iam.gserviceaccount.com`. Do not include any `serviceAccount:` or other prefix.
        :param pulumi.Input[builtins.str] staging_location: The Cloud Storage path to use for staging files. Must be a valid Cloud Storage URL, beginning with gs://.
        :param pulumi.Input[builtins.str] subnetwork: The subnetwork to which VMs will be assigned. Should be of the form "regions/REGION/subnetworks/SUBNETWORK".
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] transform_name_mapping: Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job.Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job.
        """
    ...
    def container_spec_gcs_path(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def container_spec_gcs_path(self, value: pulumi.Input[builtins.str]):
    ...
    def autoscaling_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def autoscaling_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def launcher_machine_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def launcher_machine_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @on_delete.setter
    def on_delete(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sdk_container_image(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sdk_container_image(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def skip_wait_on_job_termination(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "skip_wait_on_job_termination")

    @skip_wait_on_job_termination.setter
    def skip_wait_on_job_termination(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "skip_wait_on_job_termination", value)

    @property
    @pulumi.getter(name="stagingLocation")
    def staging_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def staging_location(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FlexTemplateJobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable_streaming_engine: Immutable. Indicates if the job should use the streaming engine feature.
        :param pulumi.Input[builtins.str] ip_configuration: The configuration for VM IPs.  Options are `"WORKER_IP_PUBLIC"` or `"WORKER_IP_PRIVATE"`.
        :param pulumi.Input[builtins.str] job_id: The unique ID of this job.
        :param pulumi.Input[builtins.str] kms_key_name: The name for the Cloud KMS key for the job. Key format is: `projects/PROJECT_ID/locations/LOCATION/keyRings/KEY_RING/cryptoKeys/KEY`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User labels to be specified for the job. Keys and values
               should follow the restrictions specified in the [labeling restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions)
               page. **Note**: This field is marked as deprecated as the API does not currently
        ...
        :param pulumi.Input[builtins.str] service_account_email: Service account email to run the workers as. This should be just an email e.g. `myserviceaccount@myproject.iam.gserviceaccount.com`. Do not include any `serviceAccount:` or other prefix.
        :param pulumi.Input[builtins.str] staging_location: The Cloud Storage path to use for staging files. Must be a valid Cloud Storage URL, beginning with gs://.
        :param pulumi.Input[builtins.str] state: The current state of the resource, selected from the [JobState enum](https://cloud.google.com/dataflow/docs/reference/rest/v1b3/projects.jobs#Job.JobState)
        :param pulumi.Input[builtins.str] subnetwork: The subnetwork to which VMs will be assigned. Should be of the form "regions/REGION/subnetworks/SUBNETWORK".
        :param pulumi.Input[builtins.str] temp_location: The Cloud Storage path to use for temporary files. Must be a valid Cloud Storage URL, beginning with gs://.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] transform_name_mapping: Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job.Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job.
        :param pulumi.Input[builtins.str] type: The type of this job, selected from the JobType enum.
        """
        if additional_experiments is not None:
            pulumi.set(__self__, "additional_experiments", additional_experiments)
        if additional_pipeline_options is not None:
...
class FlexTemplateJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            temp_location: Optional[pulumi.Input[builtins.str]] = None,
            transform_name_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'FlexTemplateJob':
        """
    ...
    @property
    @pulumi.getter(name="additionalExperiments")
    def additional_experiments(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of experiments that should be used by the job. An example value is `["enable_stackdriver_agent_metrics"]`.
        """
        return pulumi.get(self, "additional_experiments")
    ...
    @property
    @pulumi.getter(name="autoscalingAlgorithm")
    def autoscaling_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        The algorithm to use for autoscaling.
        """
        return pulumi.get(self, "autoscaling_algorithm")
    ...
    @property
    @pulumi.getter(name="containerSpecGcsPath")
    def container_spec_gcs_path(self) -> pulumi.Output[builtins.str]:
        """
        The GCS path to the Dataflow job Flex
        Template.
    ...
    @property
    @pulumi.getter(name="enableStreamingEngine")
    def enable_streaming_engine(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Immutable. Indicates if the job should use the streaming engine feature.
        """
        return pulumi.get(self, "enable_streaming_engine")
    ...
    @property
    @pulumi.getter(name="ipConfiguration")
    def ip_configuration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The configuration for VM IPs.  Options are `"WORKER_IP_PUBLIC"` or `"WORKER_IP_PRIVATE"`.
        """
        return pulumi.get(self, "ip_configuration")
    ...
    @property
    @pulumi.getter(name="launcherMachineType")
    def launcher_machine_type(self) -> pulumi.Output[builtins.str]:
        """
        The machine type to use for launching the job. The default is n1-standard-1.
        """
        return pulumi.get(self, "launcher_machine_type")
    ...
    @property
    @pulumi.getter(name="numWorkers")
    def num_workers(self) -> pulumi.Output[builtins.int]:
        """
        Immutable. The initial number of Google Compute Engine instances for the job.
        """
        return pulumi.get(self, "num_workers")
    ...
    @property
    @pulumi.getter(name="onDelete")
    def on_delete(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        One of "drain" or "cancel". Specifies behavior of
        deletion during `pulumi destroy`.  See above note.
        """
    ...
    @property
    @pulumi.getter(name="sdkContainerImage")
    def sdk_container_image(self) -> pulumi.Output[builtins.str]:
        """
        Docker registry location of container image to use for the 'worker harness. Default is the container for the version of the SDK. Note this field is only valid for portable pipelines.
        """
        return pulumi.get(self, "sdk_container_image")
    ...
    @property
    @pulumi.getter(name="skipWaitOnJobTermination")
    def skip_wait_on_job_termination(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "skip_wait_on_job_termination")

    @property
    @pulumi.getter(name="stagingLocation")
    def staging_location(self) -> pulumi.Output[builtins.str]:
        """
        The Cloud Storage path to use for staging files. Must be a valid Cloud Storage URL, beginning with gs://.
        """
        return pulumi.get(self, "staging_location")
    ...
    @property
    @pulumi.getter(name="tempLocation")
    def temp_location(self) -> pulumi.Output[builtins.str]:
        """
        The Cloud Storage path to use for temporary files. Must be a valid Cloud Storage URL, beginning with gs://.
        """
        return pulumi.get(self, "temp_location")
    ...
    @property
    @pulumi.getter(name="transformNameMapping")
    def transform_name_mapping(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job.Only applicable when updating a pipeline. Map of transform name prefixes of the job to be replaced with the corresponding name prefixes of the new job.
        """
        return pulumi.get(self, "transform_name_mapping")
