...
def get_tunnel_dest_group_iam_policy(dest_group: Optional[builtins.str] = None,
...
def get_tunnel_dest_group_iam_policy_output(dest_group: Optional[pulumi.Input[builtins.str]] = None,
