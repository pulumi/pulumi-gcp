...
def get_tunnel_dest_group_iam_policy(dest_group: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dest_group: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str project: The ID of the project in which the resource belongs.
           If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
    :param _builtins.str region: The region of the tunnel group. Must be the same as the network resources in the group.
...
def get_tunnel_dest_group_iam_policy_output(dest_group: Optional[pulumi.Input[_builtins.str]] = None,
