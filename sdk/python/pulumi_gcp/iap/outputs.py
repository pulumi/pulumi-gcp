...
class SettingsAccessSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 identity_sources: Optional[Sequence[builtins.str]] = None,
        ...
        :param 'SettingsAccessSettingsGcipSettingsArgs' gcip_settings: GCIP claims and endpoint configurations for 3p identity providers.
               * Enabling gcipSetting significantly changes the way IAP authenticates users. Identity Platform does not support IAM, so IAP will not enforce any IAM policies for requests to your application.
               Structure is documented below.
        :param Sequence[builtins.str] identity_sources: Identity sources that IAP can use to authenticate the end user. Only one identity source
    ...
    def identity_sources(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SettingsAccessSettingsAllowedDomainsSettings(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] domains: List of trusted domains.
        :param builtins.bool enable: Configuration for customers to opt in for the feature.
        """
...
class SettingsAccessSettingsCorsSettings(dict):
    ...
    def __init__(__self__, *,
                 allow_http_options: Optional[builtins.bool] = None):
        """
        :param builtins.bool allow_http_options: Configuration to allow HTTP OPTIONS calls to skip authorization.
    ...
    def allow_http_options(self) -> Optional[builtins.bool]:
        """
...
class SettingsAccessSettingsGcipSettings(dict):
    ...
    def __init__(__self__, *,
                 login_page_uri: Optional[builtins.str] = None,
                 tenant_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str login_page_uri: Login page URI associated with the GCIP tenants. Typically, all resources within
               the same project share the same login page, though it could be overridden at the
               sub resource level.
        :param Sequence[builtins.str] tenant_ids: GCIP tenant ids that are linked to the IAP resource. tenantIds could be a string
    ...
    def login_page_uri(self) -> Optional[builtins.str]:
        """
    ...
    def tenant_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SettingsAccessSettingsOauthSettings(dict):
    ...
    def __init__(__self__, *,
                 login_hint: Optional[builtins.str] = None,
                 programmatic_clients: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str login_hint: Domain hint to send as hd=? parameter in OAuth request flow.
        ...
        :param Sequence[builtins.str] programmatic_clients: List of client ids allowed to use IAP programmatically.
        """
    ...
    def login_hint(self) -> Optional[builtins.str]:
        """
    ...
    def programmatic_clients(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SettingsAccessSettingsReauthSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str max_age: Reauth session lifetime, how long before a user has to reauthenticate again.
               A duration in seconds with up to nine fractional digits, ending with 's'.
               Example: "3.5s".
        :param builtins.str method: Reauth method requested. The possible values are:
        ...
        :param builtins.str policy_type: How IAP determines the effective policy in cases of hierarchical policies.
...
class SettingsAccessSettingsWorkforceIdentitySettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 workforce_pools: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str workforce_pools: The workforce pool resources. Only one workforce pool is accepted.
        """
    ...
    def workforce_pools(self) -> Optional[builtins.str]:
        """
...
class SettingsAccessSettingsWorkforceIdentitySettingsOauth2(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_secret_sha256: Optional[builtins.str] = None):
        """
        :param builtins.str client_id: The OAuth 2.0 client ID registered in the workforce identity
               federation OAuth 2.0 Server.
        :param builtins.str client_secret: Input only. The OAuth 2.0 client secret created while registering
               the client ID.
        :param builtins.str client_secret_sha256: Output only. SHA256 hash value for the client secret. This field
    ...
    def client_secret_sha256(self) -> Optional[builtins.str]:
        """
...
class SettingsApplicationSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'SettingsApplicationSettingsAttributePropagationSettingsArgs' attribute_propagation_settings: Settings to configure attribute propagation.
               Structure is documented below.
        :param builtins.str cookie_domain: The Domain value to set for cookies generated by IAP. This value is not validated by the API,
...
class SettingsApplicationSettingsAccessDeniedPageSettings(dict):
    ...
    def __init__(__self__, *,
                 access_denied_page_uri: Optional[builtins.str] = None,
                 generate_troubleshooting_uri: Optional[builtins.bool] = None,
                 remediation_token_generation_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str access_denied_page_uri: The URI to be redirected to when access is denied.
        :param builtins.bool generate_troubleshooting_uri: Whether to generate a troubleshooting URL on access denied events to this application.
        :param builtins.bool remediation_token_generation_enabled: Whether to generate remediation token on access denied events to this application.
        """
    ...
    def access_denied_page_uri(self) -> Optional[builtins.str]:
        """
    ...
    def generate_troubleshooting_uri(self) -> Optional[builtins.bool]:
        """
    ...
    def remediation_token_generation_enabled(self) -> Optional[builtins.bool]:
        """
...
class SettingsApplicationSettingsAttributePropagationSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 output_credentials: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool enable: Whether the provided attribute propagation settings should be evaluated on user requests.
               If set to true, attributes returned from the expression will be propagated in the set output credentials.
        :param builtins.str expression: Raw string CEL expression. Must return a list of attributes. A maximum of 45 attributes can
        ...
        :param Sequence[builtins.str] output_credentials: Which output credentials attributes selected by the CEL expression should be propagated in.
    ...
    def output_credentials(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SettingsApplicationSettingsCsmSettings(dict):
    ...
    def __init__(__self__, *,
                 rctoken_aud: Optional[builtins.str] = None):
        """
        :param builtins.str rctoken_aud: Audience claim set in the generated RCToken. This value is not validated by IAP.
        """
    ...
    def rctoken_aud(self) -> Optional[builtins.str]:
        """
