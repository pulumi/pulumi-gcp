...
__all__ = [
    ...
    'LocationWebIamBindingCondition',
    'LocationWebIamMemberCondition',
...
@pulumi.output_type
class LocationWebIamBindingCondition(dict):
    def __init__(__self__, *,
                 expression: _builtins.str,
                 title: _builtins.str,
                 description: Optional[_builtins.str] = None):
...
@pulumi.output_type
class LocationWebIamMemberCondition(dict):
    def __init__(__self__, *,
                 expression: _builtins.str,
                 title: _builtins.str,
                 description: Optional[_builtins.str] = None):
...
class SettingsAccessSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 identity_sources: Optional[Sequence[_builtins.str]] = None,
...
class SettingsAccessSettingsAllowedDomainsSettings(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] domains: List of trusted domains.
        :param _builtins.bool enable: Configuration for customers to opt in for the feature.
        """
...
class SettingsAccessSettingsCorsSettings(dict):
    ...
    def __init__(__self__, *,
                 allow_http_options: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool allow_http_options: Configuration to allow HTTP OPTIONS calls to skip authorization.
...
class SettingsAccessSettingsGcipSettings(dict):
    ...
    def __init__(__self__, *,
                 login_page_uri: Optional[_builtins.str] = None,
                 tenant_ids: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str login_page_uri: Login page URI associated with the GCIP tenants. Typically, all resources within
               the same project share the same login page, though it could be overridden at the
               sub resource level.
        :param Sequence[_builtins.str] tenant_ids: GCIP tenant ids that are linked to the IAP resource. tenantIds could be a string
...
class SettingsAccessSettingsReauthSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str max_age: Reauth session lifetime, how long before a user has to reauthenticate again.
               A duration in seconds with up to nine fractional digits, ending with 's'.
               Example: "3.5s".
        :param _builtins.str method: Reauth method requested. The possible values are:
...
class SettingsAccessSettingsWorkforceIdentitySettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 workforce_pools: Optional[_builtins.str] = None):
        """
...
class SettingsAccessSettingsWorkforceIdentitySettingsOauth2(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_secret_sha256: Optional[_builtins.str] = None):
        """
        :param _builtins.str client_id: The OAuth 2.0 client ID registered in the workforce identity
               federation OAuth 2.0 Server.
        :param _builtins.str client_secret: Input only. The OAuth 2.0 client secret created while registering
               the client ID.
        :param _builtins.str client_secret_sha256: Output only. SHA256 hash value for the client secret. This field
...
class SettingsApplicationSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cookie_domain: Optional[_builtins.str] = None,
        ...
        :param 'SettingsApplicationSettingsAttributePropagationSettingsArgs' attribute_propagation_settings: Settings to configure attribute propagation.
               Structure is documented below.
        :param _builtins.str cookie_domain: The Domain value to set for cookies generated by IAP. This value is not validated by the API,
...
class SettingsApplicationSettingsAccessDeniedPageSettings(dict):
    ...
    def __init__(__self__, *,
                 access_denied_page_uri: Optional[_builtins.str] = None,
                 generate_troubleshooting_uri: Optional[_builtins.bool] = None,
                 remediation_token_generation_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.str access_denied_page_uri: The URI to be redirected to when access is denied.
        :param _builtins.bool generate_troubleshooting_uri: Whether to generate a troubleshooting URL on access denied events to this application.
        :param _builtins.bool remediation_token_generation_enabled: Whether to generate remediation token on access denied events to this application.
        """
...
class SettingsApplicationSettingsAttributePropagationSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 output_credentials: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.bool enable: Whether the provided attribute propagation settings should be evaluated on user requests.
               If set to true, attributes returned from the expression will be propagated in the set output credentials.
        :param _builtins.str expression: Raw string CEL expression. Must return a list of attributes. A maximum of 45 attributes can
        ...
        :param Sequence[_builtins.str] output_credentials: Which output credentials attributes selected by the CEL expression should be propagated in.
...
class SettingsApplicationSettingsCsmSettings(dict):
    ...
    def __init__(__self__, *,
                 rctoken_aud: Optional[_builtins.str] = None):
        """
        :param _builtins.str rctoken_aud: Audience claim set in the generated RCToken. This value is not validated by IAP.
        """
