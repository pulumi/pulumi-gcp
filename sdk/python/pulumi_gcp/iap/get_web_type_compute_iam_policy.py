...
def get_web_type_compute_iam_policy(project: Optional[builtins.str] = None,
...
def get_web_type_compute_iam_policy_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
