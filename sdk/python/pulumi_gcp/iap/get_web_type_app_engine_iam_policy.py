...
def get_web_type_app_engine_iam_policy(app_id: Optional[_builtins.str] = None,
...
def get_web_type_app_engine_iam_policy_output(app_id: Optional[pulumi.Input[_builtins.str]] = None,
