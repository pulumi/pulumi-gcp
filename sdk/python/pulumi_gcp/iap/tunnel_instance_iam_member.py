...
class TunnelInstanceIAMMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance: Used to find the parent resource to bind the IAM policy to
...
class TunnelInstanceIAMMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'TunnelInstanceIAMMember':
        """
