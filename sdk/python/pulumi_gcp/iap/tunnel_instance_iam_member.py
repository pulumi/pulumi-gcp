...
class TunnelInstanceIAMMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['TunnelInstanceIAMMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `iap.TunnelInstanceIAMBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
        ...
        :param pulumi.Input[_builtins.str] zone: Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['TunnelInstanceIAMMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['TunnelInstanceIAMMemberConditionArgs']]):
...
class TunnelInstanceIAMMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `iap.TunnelInstanceIAMBinding`: Authoritative for a given role and condition combination (the condition can be omitted). Updates the IAM policy to grant a role to a list of members. Other role and condition combinations within the IAM policy for the tunnelinstance are preserved. Members added outside of Terraform for the same role and condition combination will be detected as drift and removed on the next `pulumi up`.
        * `iap.TunnelInstanceIAMMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the tunnelinstance are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `iap.TunnelInstanceIAMPolicy`: Retrieves the IAM policy for the tunnelinstance
        ...
        > **Note:** `iap.TunnelInstanceIAMBinding` resources **can be** used in conjunction with `iap.TunnelInstanceIAMMember` resources **only if** they do not grant privilege to the same role and condition combination.
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            zone: pulumi.Input[Optional[_builtins.str]] = None) -> 'TunnelInstanceIAMMember':
        """
        ...
        __props__ = _TunnelInstanceIAMMemberState.__new__(_TunnelInstanceIAMMemberState)
