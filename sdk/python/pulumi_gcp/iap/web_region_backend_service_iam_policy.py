...
class WebRegionBackendServiceIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] web_region_backend_service: Used to find the parent resource to bind the IAM policy to
...
class _WebRegionBackendServiceIamPolicyState:
    def __init__(__self__, *,
                 ...
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 web_region_backend_service: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="webRegionBackendService")
    def web_region_backend_service(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "web_region_backend_service")
    ...
    @web_region_backend_service.setter
    def web_region_backend_service(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "web_region_backend_service", value)


@pulumi.type_token("gcp:iap/webRegionBackendServiceIamPolicy:WebRegionBackendServiceIamPolicy")
class WebRegionBackendServiceIamPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `iap.WebRegionBackendServiceIamBinding`: Authoritative for a given role and condition combination (the condition can be omitted). Updates the IAM policy to grant a role to a list of members. Other role and condition combinations within the IAM policy for the webregionbackendservice are preserved. Members added outside of Terraform for the same role and condition combination will be detected as drift and removed on the next `pulumi up`.
        * `iap.WebRegionBackendServiceIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the webregionbackendservice are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `iap.WebRegionBackendServiceIamPolicy`: Retrieves the IAM policy for the webregionbackendservice
        ...
        > **Note:** `iap.WebRegionBackendServiceIamBinding` resources **can be** used in conjunction with `iap.WebRegionBackendServiceIamMember` resources **only if** they do not grant privilege to the same role and condition combination.
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            web_region_backend_service: pulumi.Input[Optional[_builtins.str]] = None) -> 'WebRegionBackendServiceIamPolicy':
        """
