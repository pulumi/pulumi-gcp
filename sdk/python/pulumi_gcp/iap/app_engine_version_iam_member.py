...
__all__ = ['AppEngineVersionIamMemberArrgs', 'AppEngineVersionIamMember']

@pulumi.input_type
calass AppEngineVersionIamMemberArrgs:
    def __init__(__self__, *,
                 ...
                 condition: Optional[pulumi.Input['AppEngineVersionIamMemberConditionArrgs']] = None,
        ...
        :param pulumi.Input['AppEngineVersionIamMemberConditionArrgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @property
    @pulumi.getter
    def condition(self) -> Optional[pulumi.Input['AppEngineVersionIamMemberConditionArrgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input['AppEngineVersionIamMemberConditionArrgs']]):
...
@pulumi.input_type
calass _AppEngineVersionIamMemberState:
    def __init__(__self__, *,
...
calass AppEngineVersionIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 app_id: Optional[pulumi.Input[str]] = None,
                 condition: Optional[pulumi.Input[pulumi.InputType['AppEngineVersionIamMemberConditionArrgs']]] = None,
                 member: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 role: Optional[pulumi.Input[str]] = None,
                 service: Optional[pulumi.Input[str]] = None,
        ...
        * `iap.AppEngineVersionIamPolicy`: Retrieves the IAM policy for the appengineversion
        ...
        binding = gcp.iap.AppEngineVersionIamBinding("binding",
            app_id=google_app_engine_standard_app_version["version"]["project"],
            condition=gcp.iap.AppEngineVersionIamBindingConditionArrgs(
                description="Expiring at midnight of 2019-12-31",
                expression="request.time < timestamp(\\"2020-01-01T00:00:00Z\\")",
                title="expires_after_2019_12_31",
            ),
        ...
        member = gcp.iap.AppEngineVersionIamMember("member",
            app_id=google_app_engine_standard_app_version["version"]["project"],
            condition=gcp.iap.AppEngineVersionIamMemberConditionArrgs(
                description="Expiring at midnight of 2019-12-31",
                expression="request.time < timestamp(\\"2020-01-01T00:00:00Z\\")",
                title="expires_after_2019_12_31",
            ),
        ...
        :param pulumi.Input[str] app_id: Id of the App Engine application. Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[pulumi.InputType['AppEngineVersionIamMemberConditionArrgs']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AppEngineVersionIamMemberArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Three different resources help you manage your IAM policy for Identity-Aware Proxy AppEngineVersion. Each of these resources serves a different use case:
        ...
        * `iap.AppEngineVersionIamPolicy`: Retrieves the IAM policy for the appengineversion
        ...
        :param str resource_name: The name of the resource.
        :param AppEngineVersionIamMemberArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AppEngineVersionIamMemberArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AppEngineVersionIamMemberArrgs.__new__(AppEngineVersionIamMemberArrgs)
