...
class AppEngineVersionIamBindingArgs:
    def __init__(__self__, *,
        ...
        """
        AppEngineVersionIamBindingArgs._configure(
...
class _AppEngineVersionIamBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] version_id: Version id of the App Engine application Used to find the parent resource to bind the IAM policy to
        """
        _AppEngineVersionIamBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            app_id=app_id,
            condition=condition,
            etag=etag,
...
class AppEngineVersionIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AppEngineVersionIamBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, AppEngineVersionIamBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                AppEngineVersionIamBindingConditionArgs._configure(_setter, **condition)
