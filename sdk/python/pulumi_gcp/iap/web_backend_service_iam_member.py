...
__all__ = ['WebBackendServiceIamMemberArrgs', 'WebBackendServiceIamMember']

@pulumi.input_type
calass WebBackendServiceIamMemberArrgs:
    def __init__(__self__, *,
                 member: pulumi.Input[str],
                 role: pulumi.Input[str],
                 web_backend_service: pulumi.Input[str],
                 condition: Optional[pulumi.Input['WebBackendServiceIamMemberConditionArrgs']] = None,
        ...
        :param pulumi.Input['WebBackendServiceIamMemberConditionArrgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @property
    @pulumi.getter
    def condition(self) -> Optional[pulumi.Input['WebBackendServiceIamMemberConditionArrgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input['WebBackendServiceIamMemberConditionArrgs']]):
...
@pulumi.input_type
calass _WebBackendServiceIamMemberState:
    def __init__(__self__, *,
                 condition: Optional[pulumi.Input['WebBackendServiceIamMemberConditionArrgs']] = None,
...
calass WebBackendServiceIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: Optional[pulumi.Input[pulumi.InputType['WebBackendServiceIamMemberConditionArrgs']]] = None,
                 member: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 role: Optional[pulumi.Input[str]] = None,
                 web_backend_service: Optional[pulumi.Input[str]] = None,
        ...
        * `iap.WebBackendServiceIamPolicy`: Retrieves the IAM policy for the webbackendservice
        ...
        binding = gcp.iap.WebBackendServiceIamBinding("binding",
            ...
            role="roles/iap.httpsResourceAccessor",
            members=["user:jane@example.com"],
            condition=gcp.iap.WebBackendServiceIamBindingConditionArrgs(
                title="expires_after_2019_12_31",
                description="Expiring at midnight of 2019-12-31",
                expression="request.time < timestamp(\\"2020-01-01T00:00:00Z\\")",
            ))
        ...
        member = gcp.iap.WebBackendServiceIamMember("member",
            ...
            role="roles/iap.httpsResourceAccessor",
            member="user:jane@example.com",
            condition=gcp.iap.WebBackendServiceIamMemberConditionArrgs(
                title="expires_after_2019_12_31",
                description="Expiring at midnight of 2019-12-31",
                expression="request.time < timestamp(\\"2020-01-01T00:00:00Z\\")",
            ))
        ...
        :param pulumi.Input[pulumi.InputType['WebBackendServiceIamMemberConditionArrgs']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: WebBackendServiceIamMemberArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Three different resources help you manage your IAM policy for Identity-Aware Proxy WebBackendService. Each of these resources serves a different use case:
        ...
        * `iap.WebBackendServiceIamPolicy`: Retrieves the IAM policy for the webbackendservice
        ...
        :param str resource_name: The name of the resource.
        :param WebBackendServiceIamMemberArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebBackendServiceIamMemberArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WebBackendServiceIamMemberArrgs.__new__(WebBackendServiceIamMemberArrgs)
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[str]] = None,
            role: Optional[pulumi.Input[str]] = None,
            web_backend_service: Optional[pulumi.Input[str]] = None) -> 'WebBackendServiceIamMember':
        """
