...
__all__ = ['WebBackendServiceIamMemberArgs', 'WebBackendServiceIamMember']

@pulumi.input_type
class WebBackendServiceIamMemberArgs:
    def __init__(__self__, *,
                 member: pulumi.Input[_builtins.str],
                 role: pulumi.Input[_builtins.str],
                 web_backend_service: pulumi.Input[_builtins.str],
                 condition: pulumi.Input[Optional['WebBackendServiceIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `iap.WebBackendServiceIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        :param pulumi.Input[_builtins.str] web_backend_service: Used to find the parent resource to bind the IAM policy to
    ...
    def web_backend_service(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "web_backend_service", value)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['WebBackendServiceIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['WebBackendServiceIamMemberConditionArgs']]):
...
@pulumi.input_type
class _WebBackendServiceIamMemberState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['WebBackendServiceIamMemberConditionArgs']] = None,
                 ...
                 web_backend_service: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="webBackendService")
    def web_backend_service(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "web_backend_service")
    ...
    @web_backend_service.setter
    def web_backend_service(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "web_backend_service", value)


@pulumi.type_token("gcp:iap/webBackendServiceIamMember:WebBackendServiceIamMember")
class WebBackendServiceIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['WebBackendServiceIamMemberConditionArgs', 'WebBackendServiceIamMemberConditionArgsDict', 'outputs.WebBackendServiceIamMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 web_backend_service: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `iap.WebBackendServiceIamBinding`: Authoritative for a given role and condition combination (the condition can be omitted). Updates the IAM policy to grant a role to a list of members. Other role and condition combinations within the IAM policy for the webbackendservice are preserved. Members added outside of Terraform for the same role and condition combination will be detected as drift and removed on the next `pulumi up`.
        * `iap.WebBackendServiceIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the webbackendservice are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `iap.WebBackendServiceIamPolicy`: Retrieves the IAM policy for the webbackendservice
        ...
        > **Note:** `iap.WebBackendServiceIamBinding` resources **can be** used in conjunction with `iap.WebBackendServiceIamMember` resources **only if** they do not grant privilege to the same role and condition combination.
        ...
        * {{name}}
        ...
        :param pulumi.Input[Union['WebBackendServiceIamMemberConditionArgs', 'WebBackendServiceIamMemberConditionArgsDict', 'outputs.WebBackendServiceIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
    ...
    def __init__(__self__,
        ...
        * {{name}}
        ...
        :param str resource_name: The name of the resource.
        :param WebBackendServiceIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebBackendServiceIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WebBackendServiceIamMemberArgs.__new__(WebBackendServiceIamMemberArgs)
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            web_backend_service: pulumi.Input[Optional[_builtins.str]] = None) -> 'WebBackendServiceIamMember':
        """
        ...
        __props__ = _WebBackendServiceIamMemberState.__new__(_WebBackendServiceIamMemberState)
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.WebBackendServiceIamMemberCondition']]:
        """
        An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        Structure is documented below.
        """
