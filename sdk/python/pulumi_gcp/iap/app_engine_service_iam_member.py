...
class AppEngineServiceIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['AppEngineServiceIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `iap.AppEngineServiceIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        :param pulumi.Input[_builtins.str] service: Used to find the parent resource to bind the IAM policy to
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['AppEngineServiceIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['AppEngineServiceIamMemberConditionArgs']]):
...
@pulumi.type_token("gcp:iap/appEngineServiceIamMember:AppEngineServiceIamMember")
class AppEngineServiceIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 app_id: pulumi.Input[Optional[_builtins.str]] = None,
                 condition: pulumi.Input[Optional[Union['AppEngineServiceIamMemberConditionArgs', 'AppEngineServiceIamMemberConditionArgsDict', 'outputs.AppEngineServiceIamMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 service: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * {{service}}
        ...
        :param pulumi.Input[_builtins.str] app_id: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[Union['AppEngineServiceIamMemberConditionArgs', 'AppEngineServiceIamMemberConditionArgsDict', 'outputs.AppEngineServiceIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            service: pulumi.Input[Optional[_builtins.str]] = None) -> 'AppEngineServiceIamMember':
        """
