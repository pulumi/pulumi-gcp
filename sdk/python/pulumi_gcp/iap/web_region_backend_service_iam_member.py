...
__all__ = ['WebRegionBackendServiceIamMemberArrgs', 'WebRegionBackendServiceIamMember']

@pulumi.input_type
calass WebRegionBackendServiceIamMemberArrgs:
    def __init__(__self__, *,
                 member: pulumi.Input[str],
                 role: pulumi.Input[str],
                 web_region_backend_service: pulumi.Input[str],
                 condition: Optional[pulumi.Input['WebRegionBackendServiceIamMemberConditionArrgs']] = None,
        ...
        :param pulumi.Input['WebRegionBackendServiceIamMemberConditionArrgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @property
    @pulumi.getter
    def condition(self) -> Optional[pulumi.Input['WebRegionBackendServiceIamMemberConditionArrgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input['WebRegionBackendServiceIamMemberConditionArrgs']]):
...
@pulumi.input_type
calass _WebRegionBackendServiceIamMemberState:
    def __init__(__self__, *,
                 condition: Optional[pulumi.Input['WebRegionBackendServiceIamMemberConditionArrgs']] = None,
...
calass WebRegionBackendServiceIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: Optional[pulumi.Input[pulumi.InputType['WebRegionBackendServiceIamMemberConditionArrgs']]] = None,
                 member: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 region: Optional[pulumi.Input[str]] = None,
                 role: Optional[pulumi.Input[str]] = None,
        ...
        * `iap.WebRegionBackendServiceIamPolicy`: Retrieves the IAM policy for the webregionbackendservice
        ...
        :param pulumi.Input[pulumi.InputType['WebRegionBackendServiceIamMemberConditionArrgs']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: WebRegionBackendServiceIamMemberArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Three different resources help you manage your IAM policy for Identity-Aware Proxy WebRegionBackendService. Each of these resources serves a different use case:
        ...
        * `iap.WebRegionBackendServiceIamPolicy`: Retrieves the IAM policy for the webregionbackendservice
        ...
        :param str resource_name: The name of the resource.
        :param WebRegionBackendServiceIamMemberArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebRegionBackendServiceIamMemberArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WebRegionBackendServiceIamMemberArrgs.__new__(WebRegionBackendServiceIamMemberArrgs)
