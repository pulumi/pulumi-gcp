...
class WebRegionBackendServiceIamMemberArgs:
    def __init__(__self__, *,
        ...
        """
        WebRegionBackendServiceIamMemberArgs._configure(
...
class _WebRegionBackendServiceIamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] web_region_backend_service: Used to find the parent resource to bind the IAM policy to
        """
        _WebRegionBackendServiceIamMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            etag=etag,
            member=member,
...
class WebRegionBackendServiceIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebRegionBackendServiceIamMemberArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, WebRegionBackendServiceIamMemberConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                WebRegionBackendServiceIamMemberConditionArgs._configure(_setter, **condition)
