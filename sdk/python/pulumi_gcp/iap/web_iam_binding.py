...
class WebIamBinding(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, members=None, project=None, role=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a WebIamBinding resource with the given unique name, props, and options.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, etag=None, members=None, project=None, role=None):
        """
