...
__all__ = ['TunnelInstanceIAMBindingArrgs', 'TunnelInstanceIAMBinding']

@pulumi.input_type
calass TunnelInstanceIAMBindingArrgs:
    def __init__(__self__, *,
                 instance: pulumi.Input[str],
                 members: pulumi.Input[Sequence[pulumi.Input[str]]],
                 role: pulumi.Input[str],
                 condition: Optional[pulumi.Input['TunnelInstanceIAMBindingConditionArrgs']] = None,
        ...
        :param pulumi.Input['TunnelInstanceIAMBindingConditionArrgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @property
    @pulumi.getter
    def condition(self) -> Optional[pulumi.Input['TunnelInstanceIAMBindingConditionArrgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: Optional[pulumi.Input['TunnelInstanceIAMBindingConditionArrgs']]):
...
@pulumi.input_type
calass _TunnelInstanceIAMBindingState:
    def __init__(__self__, *,
                 condition: Optional[pulumi.Input['TunnelInstanceIAMBindingConditionArrgs']] = None,
...
calass TunnelInstanceIAMBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: Optional[pulumi.Input[pulumi.InputType['TunnelInstanceIAMBindingConditionArrgs']]] = None,
                 instance: Optional[pulumi.Input[str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 role: Optional[pulumi.Input[str]] = None,
        ...
        * `iap.TunnelInstanceIAMPolicy`: Retrieves the IAM policy for the tunnelinstance
        ...
        :param pulumi.Input[pulumi.InputType['TunnelInstanceIAMBindingConditionArrgs']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[str] instance: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[str] project: The ID of the project in which the resource belongs.
               If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: TunnelInstanceIAMBindingArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Three different resources help you manage your IAM policy for Identity-Aware Proxy TunnelInstance. Each of these resources serves a different use case:
        ...
        * `iap.TunnelInstanceIAMPolicy`: Retrieves the IAM policy for the tunnelinstance
        ...
        :param str resource_name: The name of the resource.
        :param TunnelInstanceIAMBindingArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TunnelInstanceIAMBindingArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TunnelInstanceIAMBindingArrgs.__new__(TunnelInstanceIAMBindingArrgs)
