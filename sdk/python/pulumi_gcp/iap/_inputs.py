...
if not MYPY:
    class SettingsAccessSettingsArgsDict(TypedDict):
        ...
        * Enabling gcipSetting significantly changes the way IAP authenticates users. Identity Platform does not support IAM, so IAP will not enforce any IAM policies for requests to your application.
        Structure is documented below.
        """
        identity_sources: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SettingsAccessSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SettingsAccessSettingsGcipSettingsArgs'] gcip_settings: GCIP claims and endpoint configurations for 3p identity providers.
               * Enabling gcipSetting significantly changes the way IAP authenticates users. Identity Platform does not support IAM, so IAP will not enforce any IAM policies for requests to your application.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_sources: Identity sources that IAP can use to authenticate the end user. Only one identity source
               can be configured. The possible values are:
               * `WORKFORCE_IDENTITY_FEDERATION`: Use external identities set up on Google Cloud Workforce
               Identity Federation.
               Each value may be one of: `WORKFORCE_IDENTITY_FEDERATION`.
...
class SettingsAccessSettingsAllowedDomainsSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: List of trusted domains.
        :param pulumi.Input[builtins.bool] enable: Configuration for customers to opt in for the feature.
        """
...
if not MYPY:
    class SettingsAccessSettingsCorsSettingsArgsDict(TypedDict):
        allow_http_options: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SettingsAccessSettingsCorsSettingsArgs:
    def __init__(__self__, *,
                 allow_http_options: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] allow_http_options: Configuration to allow HTTP OPTIONS calls to skip authorization.
               If undefined, IAP will not apply any special logic to OPTIONS requests.
        """
    ...
    def allow_http_options(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Configuration to allow HTTP OPTIONS calls to skip authorization.
        If undefined, IAP will not apply any special logic to OPTIONS requests.
        """
    ...
    def allow_http_options(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_http_options", value)


if not MYPY:
    class SettingsAccessSettingsGcipSettingsArgsDict(TypedDict):
        login_page_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        sub resource level.
        """
        tenant_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SettingsAccessSettingsGcipSettingsArgs:
    def __init__(__self__, *,
                 login_page_uri: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] login_page_uri: Login page URI associated with the GCIP tenants. Typically, all resources within
               the same project share the same login page, though it could be overridden at the
               sub resource level.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tenant_ids: GCIP tenant ids that are linked to the IAP resource. tenantIds could be a string
               beginning with a number character to indicate authenticating with GCIP tenant flow,
               or in the format of _ to indicate authenticating with GCIP agent flow. If agent flow
               is used, tenantIds should only contain one single element, while for tenant flow,
               tenantIds can contain multiple elements.
    ...
    def login_page_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Login page URI associated with the GCIP tenants. Typically, all resources within
        the same project share the same login page, though it could be overridden at the
        sub resource level.
    ...
    def login_page_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "login_page_uri", value)

    @property
    @pulumi.getter(name="tenantIds")
    def tenant_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        GCIP tenant ids that are linked to the IAP resource. tenantIds could be a string
        beginning with a number character to indicate authenticating with GCIP tenant flow,
        or in the format of _ to indicate authenticating with GCIP agent flow. If agent flow
    ...
    @tenant_ids.setter
    def tenant_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "tenant_ids", value)


if not MYPY:
    class SettingsAccessSettingsOauthSettingsArgsDict(TypedDict):
        login_hint: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        * loginHint setting is not a replacement for access control. Always enforce an appropriate access policy if you want to restrict access to users outside your domain.
        """
        programmatic_clients: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SettingsAccessSettingsOauthSettingsArgs:
    def __init__(__self__, *,
                 ...
                 programmatic_clients: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] login_hint: Domain hint to send as hd=? parameter in OAuth request flow.
               Enables redirect to primary IDP by skipping Google's login screen.
               (https://developers.google.com/identity/protocols/OpenIDConnect#hd-param)
               Note: IAP does not verify that the id token's hd claim matches this value
               since access behavior is managed by IAM policies.
               * loginHint setting is not a replacement for access control. Always enforce an appropriate access policy if you want to restrict access to users outside your domain.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] programmatic_clients: List of client ids allowed to use IAP programmatically.
        """
    ...
    def programmatic_clients(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of client ids allowed to use IAP programmatically.
        """
    ...
    def programmatic_clients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class SettingsAccessSettingsReauthSettingsArgs:
    def __init__(__self__, *,
                 ...
                 policy_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] max_age: Reauth session lifetime, how long before a user has to reauthenticate again.
               A duration in seconds with up to nine fractional digits, ending with 's'.
               Example: "3.5s".
        :param pulumi.Input[builtins.str] method: Reauth method requested. The possible values are:
               * `LOGIN`: Prompts the user to log in again.
               * `SECURE_KEY`: User must use their secure key 2nd factor device.
               * `ENROLLED_SECOND_FACTORS`: User can use any enabled 2nd factor.
               Possible values are: `LOGIN`, `SECURE_KEY`, `ENROLLED_SECOND_FACTORS`.
        :param pulumi.Input[builtins.str] policy_type: How IAP determines the effective policy in cases of hierarchical policies.
               Policies are merged from higher in the hierarchy to lower in the hierarchy.
               The possible values are:
               * `MINIMUM`: This policy acts as a minimum to other policies, lower in the hierarchy.
               Effective policy may only be the same or stricter.
...
if not MYPY:
    class SettingsAccessSettingsWorkforceIdentitySettingsArgsDict(TypedDict):
        ...
        """
        workforce_pools: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SettingsAccessSettingsWorkforceIdentitySettingsArgs:
    def __init__(__self__, *,
                 ...
                 workforce_pools: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input['SettingsAccessSettingsWorkforceIdentitySettingsOauth2Args'] oauth2: OAuth 2.0 settings for IAP to perform OIDC flow with workforce identity
               ...
               <a name="nested_access_settings_workforce_identity_settings_oauth2"></a>The `oauth2` block supports:
        :param pulumi.Input[builtins.str] workforce_pools: The workforce pool resources. Only one workforce pool is accepted.
        """
    ...
    def workforce_pools(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The workforce pool resources. Only one workforce pool is accepted.
        """
    ...
    def workforce_pools(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SettingsAccessSettingsWorkforceIdentitySettingsOauth2ArgsDict(TypedDict):
        ...
        the client ID.
        """
        client_secret_sha256: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SettingsAccessSettingsWorkforceIdentitySettingsOauth2Args:
    def __init__(__self__, *,
                 ...
                 client_secret_sha256: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] client_id: The OAuth 2.0 client ID registered in the workforce identity
               federation OAuth 2.0 Server.
        :param pulumi.Input[builtins.str] client_secret: Input only. The OAuth 2.0 client secret created while registering
               the client ID.
        :param pulumi.Input[builtins.str] client_secret_sha256: Output only. SHA256 hash value for the client secret. This field
               is returned by IAP when the settings are retrieved.
        """
    ...
    def client_secret_sha256(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Output only. SHA256 hash value for the client secret. This field
        is returned by IAP when the settings are retrieved.
        """
    ...
    def client_secret_sha256(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SettingsApplicationSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SettingsApplicationSettingsAttributePropagationSettingsArgs'] attribute_propagation_settings: Settings to configure attribute propagation.
               Structure is documented below.
        :param pulumi.Input[builtins.str] cookie_domain: The Domain value to set for cookies generated by IAP. This value is not validated by the API,
               but will be ignored at runtime if invalid.
...
if not MYPY:
    class SettingsApplicationSettingsAccessDeniedPageSettingsArgsDict(TypedDict):
        access_denied_page_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The URI to be redirected to when access is denied.
        """
        generate_troubleshooting_uri: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to generate a troubleshooting URL on access denied events to this application.
        """
        remediation_token_generation_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SettingsApplicationSettingsAccessDeniedPageSettingsArgs:
    def __init__(__self__, *,
                 access_denied_page_uri: Optional[pulumi.Input[builtins.str]] = None,
                 generate_troubleshooting_uri: Optional[pulumi.Input[builtins.bool]] = None,
                 remediation_token_generation_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] access_denied_page_uri: The URI to be redirected to when access is denied.
        :param pulumi.Input[builtins.bool] generate_troubleshooting_uri: Whether to generate a troubleshooting URL on access denied events to this application.
        :param pulumi.Input[builtins.bool] remediation_token_generation_enabled: Whether to generate remediation token on access denied events to this application.
        """
    ...
    def access_denied_page_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URI to be redirected to when access is denied.
        """
    ...
    def access_denied_page_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_denied_page_uri", value)

    @property
    @pulumi.getter(name="generateTroubleshootingUri")
    def generate_troubleshooting_uri(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to generate a troubleshooting URL on access denied events to this application.
        """
    ...
    def generate_troubleshooting_uri(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "generate_troubleshooting_uri", value)

    @property
    @pulumi.getter(name="remediationTokenGenerationEnabled")
    def remediation_token_generation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to generate remediation token on access denied events to this application.
        """
    ...
    def remediation_token_generation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class SettingsApplicationSettingsAttributePropagationSettingsArgsDict(TypedDict):
        ...
        """
        output_credentials: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SettingsApplicationSettingsAttributePropagationSettingsArgs:
    def __init__(__self__, *,
                 ...
                 output_credentials: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] enable: Whether the provided attribute propagation settings should be evaluated on user requests.
               If set to true, attributes returned from the expression will be propagated in the set output credentials.
        :param pulumi.Input[builtins.str] expression: Raw string CEL expression. Must return a list of attributes. A maximum of 45 attributes can
               be selected. Expressions can select different attribute types from attributes:
               attributes.saml_attributes, attributes.iap_attributes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] output_credentials: Which output credentials attributes selected by the CEL expression should be propagated in.
               All attributes will be fully duplicated in each selected output credential.
               Possible values are:
               * `HEADER`: Propagate attributes in the headers with "x-goog-iap-attr-" prefix.
               * `JWT`: Propagate attributes in the JWT of the form:
    ...
    def output_credentials(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Which output credentials attributes selected by the CEL expression should be propagated in.
        All attributes will be fully duplicated in each selected output credential.
        Possible values are:
    ...
    def output_credentials(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "output_credentials", value)


if not MYPY:
    class SettingsApplicationSettingsCsmSettingsArgsDict(TypedDict):
        rctoken_aud: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SettingsApplicationSettingsCsmSettingsArgs:
    def __init__(__self__, *,
                 rctoken_aud: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] rctoken_aud: Audience claim set in the generated RCToken. This value is not validated by IAP.
        """
    ...
    def rctoken_aud(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Audience claim set in the generated RCToken. This value is not validated by IAP.
        """
    ...
    @rctoken_aud.setter
    def rctoken_aud(self, value: Optional[pulumi.Input[builtins.str]]):
