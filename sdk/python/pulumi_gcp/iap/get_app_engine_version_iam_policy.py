...
def get_app_engine_version_iam_policy(app_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service: Service id of the App Engine application Used to find the parent resource to bind the IAM policy to
    :param _builtins.str version_id: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_app_engine_version_iam_policy_output(app_id: Optional[pulumi.Input[_builtins.str]] = None,
