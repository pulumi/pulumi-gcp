...
def get_tunnel_instance_iam_policy(instance: Optional[builtins.str] = None,
...
def get_tunnel_instance_iam_policy_output(instance: Optional[pulumi.Input[builtins.str]] = None,
