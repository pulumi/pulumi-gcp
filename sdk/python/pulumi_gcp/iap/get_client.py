...
def get_client(brand: Optional[builtins.str] = None,
    ...
    :param builtins.str brand: The name of the brand.
    :param builtins.str client_id: The client_id of the brand.
    """
    __args__ = dict()
...
def get_client_output(brand: Optional[pulumi.Input[builtins.str]] = None,
