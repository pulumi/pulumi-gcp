...
class WebTypeAppEngingIamMemberArgs:
    def __init__(__self__, *,
        ...
        """
        WebTypeAppEngingIamMemberArgs._configure(
...
class _WebTypeAppEngingIamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        """
        _WebTypeAppEngingIamMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            app_id=app_id,
            condition=condition,
            etag=etag,
...
class WebTypeAppEngingIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            WebTypeAppEngingIamMemberArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, WebTypeAppEngingIamMemberConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                WebTypeAppEngingIamMemberConditionArgs._configure(_setter, **condition)
