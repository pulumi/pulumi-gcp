...
__all__ = ['WebTypeComputeIamMemberArgs', 'WebTypeComputeIamMember']
...
class WebTypeComputeIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['WebTypeComputeIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] role: The role that should be applied. Only one
               `iap.WebTypeComputeIamBinding` can be used per role and condition combination. Multiple bindings for the same role are allowed if each has a different `condition` block (or one has no condition). Note that custom roles must be of the format
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        :param pulumi.Input['WebTypeComputeIamMemberConditionArgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['WebTypeComputeIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['WebTypeComputeIamMemberConditionArgs']]):
...
@pulumi.input_type
class _WebTypeComputeIamMemberState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['WebTypeComputeIamMemberConditionArgs']] = None,
...
@pulumi.type_token("gcp:iap/webTypeComputeIamMember:WebTypeComputeIamMember")
class WebTypeComputeIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['WebTypeComputeIamMemberConditionArgs', 'WebTypeComputeIamMemberConditionArgsDict', 'outputs.WebTypeComputeIamMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        * `iap.WebTypeComputeIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the same role and condition combination for the webtypecompute are preserved. Members added outside of Terraform will **not** be detected as drift.
        ...
        * `iap.WebTypeComputeIamPolicy`: Retrieves the IAM policy for the webtypecompute
        ...
        > **Note:** `iap.WebTypeComputeIamBinding` resources **can be** used in conjunction with `iap.WebTypeComputeIamMember` resources **only if** they do not grant privilege to the same role and condition combination.
        ...
        * {{project}}
        ...
        :param pulumi.Input[Union['WebTypeComputeIamMemberConditionArgs', 'WebTypeComputeIamMemberConditionArgsDict', 'outputs.WebTypeComputeIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
    ...
    def __init__(__self__,
        ...
        * {{project}}
        ...
        :param str resource_name: The name of the resource.
        :param WebTypeComputeIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebTypeComputeIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WebTypeComputeIamMemberArgs.__new__(WebTypeComputeIamMemberArgs)
        ...
        super(WebTypeComputeIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            member: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'WebTypeComputeIamMember':
        """
        ...
        __props__ = _WebTypeComputeIamMemberState.__new__(_WebTypeComputeIamMemberState)
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.WebTypeComputeIamMemberCondition']]:
        """
        An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        Structure is documented below.
        """
