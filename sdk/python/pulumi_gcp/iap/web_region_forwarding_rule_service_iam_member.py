...
class WebRegionForwardingRuleServiceIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['WebRegionForwardingRuleServiceIamMemberConditionArgs', 'WebRegionForwardingRuleServiceIamMemberConditionArgsDict']]] = None,
                 forwarding_rule_region_service_name: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
