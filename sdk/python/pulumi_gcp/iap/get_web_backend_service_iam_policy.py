...
def get_web_backend_service_iam_policy(project: Optional[_builtins.str] = None,
                                       web_backend_service: Optional[_builtins.str] = None,
    ...
    :param _builtins.str web_backend_service: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_web_backend_service_iam_policy_output(project: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
