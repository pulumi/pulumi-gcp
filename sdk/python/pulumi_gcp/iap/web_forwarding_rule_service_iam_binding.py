...
class WebForwardingRuleServiceIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['WebForwardingRuleServiceIamBindingConditionArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['WebForwardingRuleServiceIamBindingConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['WebForwardingRuleServiceIamBindingConditionArgs']]):
...
class _WebForwardingRuleServiceIamBindingState:
    def __init__(__self__, *,
                 ...
                 forwarding_rule_service_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="forwardingRuleServiceName")
    def forwarding_rule_service_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "forwarding_rule_service_name")
    ...
    @forwarding_rule_service_name.setter
    def forwarding_rule_service_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "forwarding_rule_service_name", value)
...
class WebForwardingRuleServiceIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['WebForwardingRuleServiceIamBindingConditionArgs', 'WebForwardingRuleServiceIamBindingConditionArgsDict', 'outputs.WebForwardingRuleServiceIamBindingCondition']]] = None,
                 forwarding_rule_service_name: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * {{name}}
        ...
        :param pulumi.Input[Union['WebForwardingRuleServiceIamBindingConditionArgs', 'WebForwardingRuleServiceIamBindingConditionArgsDict', 'outputs.WebForwardingRuleServiceIamBindingCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] forwarding_rule_service_name: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] members: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
    ...
    def get(resource_name: str,
            ...
            members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'WebForwardingRuleServiceIamBinding':
        """
