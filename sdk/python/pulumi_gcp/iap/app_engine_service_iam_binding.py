...
class AppEngineServiceIamBindingArgs:
    def __init__(__self__, *,
        ...
        """
        AppEngineServiceIamBindingArgs._configure(
...
class _AppEngineServiceIamBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] service: Service id of the App Engine application Used to find the parent resource to bind the IAM policy to
        """
        _AppEngineServiceIamBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            app_id=app_id,
            condition=condition,
            etag=etag,
...
class AppEngineServiceIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AppEngineServiceIamBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, AppEngineServiceIamBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                AppEngineServiceIamBindingConditionArgs._configure(_setter, **condition)
