...
class AttestorIamMemberArgs:
    def __init__(__self__, *,
        ...
        """
        AttestorIamMemberArgs._configure(
...
class _AttestorIamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        """
        _AttestorIamMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            attestor=attestor,
            condition=condition,
            etag=etag,
...
class AttestorIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AttestorIamMemberArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, AttestorIamMemberConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                AttestorIamMemberConditionArgs._configure(_setter, **condition)
