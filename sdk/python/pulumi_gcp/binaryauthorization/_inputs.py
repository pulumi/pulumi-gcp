...
class AttestorAttestationAuthorityNoteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] note_reference: The resource name of a ATTESTATION_AUTHORITY Note, created by the
               ...
               ATTESTATION_AUTHORITY Occurrence that names a container image
               and that links to this Note.
        :param pulumi.Input[_builtins.str] delegation_service_account_email: (Output)
               This field will contain the service account email address that
               this Attestor will use as the principal when querying Container
               Analysis. Attestor administrators must grant this service account
               the IAM role needed to read attestations from the noteReference in
...
class AttestorAttestationAuthorityNotePublicKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ascii_armored_pgp_public_key: ASCII-armored representation of a PGP public key, as the
               ...
               upper-case hex. If id is provided by the caller, it will
               be overwritten by the API-calculated ID.
        :param pulumi.Input[_builtins.str] comment: A descriptive comment. This field may be updated.
        :param pulumi.Input[_builtins.str] id: The ID of this public key. Signatures verified by BinAuthz
               must include the ID of the public key that can be used to
               verify them, and that ID must match the contents of this
               field exactly. Additional restrictions on this field can
               be imposed based on which public key type is encapsulated.
...
class AttestorAttestationAuthorityNotePublicKeyPkixPublicKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_key_pem: A PEM-encoded public key, as described in
               `https://tools.ietf.org/html/rfc7468#section-13`
        :param pulumi.Input[_builtins.str] signature_algorithm: The signature algorithm used to verify a message against
               a signature using this key. These signature algorithm must
               match the structure and any object identifiers encoded in
               publicKeyPem (i.e. this algorithm must match that of the
               public key).
...
class PolicyAdmissionWhitelistPatternArgs:
    def __init__(__self__, *,
                 name_pattern: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name_pattern: An image name pattern to whitelist, in the form
               `registry/path/to/image`. This supports a trailing * as a
               wildcard, but this is allowed only in text after the registry/
               part.
        """
...
class PolicyClusterAdmissionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enforcement_mode: The action when a pod creation is denied by the admission rule.
               Possible values are: `ENFORCED_BLOCK_AND_AUDIT_LOG`, `DRYRUN_AUDIT_LOG_ONLY`.
        :param pulumi.Input[_builtins.str] evaluation_mode: How this admission rule will be evaluated.
               Possible values are: `ALWAYS_ALLOW`, `REQUIRE_ATTESTATION`, `ALWAYS_DENY`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] require_attestations_bies: The resource names of the attestors that must attest to a
               container image. If the attestor is in a different project from the
               policy, it should be specified in the format `projects/*/attestors/*`.
               Each attestor must exist before a policy can reference it. To add an
               attestor to a policy the principal issuing the policy change
