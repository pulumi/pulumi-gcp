...
def get_attestor_iam_policy(attestor: Optional[builtins.str] = None,
    ...
    :param builtins.str attestor: Used to find the parent resource to bind the IAM policy to
...
def get_attestor_iam_policy_output(attestor: Optional[pulumi.Input[builtins.str]] = None,
