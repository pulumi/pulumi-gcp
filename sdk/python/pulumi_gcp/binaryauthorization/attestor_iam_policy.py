...
class _AttestorIamPolicyState:
    def __init__(__self__, *,
                 attestor: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @attestor.setter
    def attestor(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "attestor", value)
...
class AttestorIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: Optional[pulumi.Input[_builtins.str]] = None,
            policy_data: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None) -> 'AttestorIamPolicy':
        """
