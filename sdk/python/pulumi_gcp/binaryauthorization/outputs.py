...
class AttestorAttestationAuthorityNote(dict):
    ...
    def __init__(__self__, *,
                 note_reference: _builtins.str,
                 delegation_service_account_email: Optional[_builtins.str] = None,
                 public_keys: Optional[Sequence['outputs.AttestorAttestationAuthorityNotePublicKey']] = None):
        """
        :param _builtins.str note_reference: The resource name of a ATTESTATION_AUTHORITY Note, created by the
        ...
        :param _builtins.str delegation_service_account_email: (Output)
...
class AttestorAttestationAuthorityNotePublicKey(dict):
    ...
    def __init__(__self__, *,
                 ascii_armored_pgp_public_key: Optional[_builtins.str] = None,
                 comment: Optional[_builtins.str] = None,
                 id: Optional[_builtins.str] = None,
                 pkix_public_key: Optional['outputs.AttestorAttestationAuthorityNotePublicKeyPkixPublicKey'] = None):
        """
        :param _builtins.str ascii_armored_pgp_public_key: ASCII-armored representation of a PGP public key, as the
        ...
        :param _builtins.str comment: A descriptive comment. This field may be updated.
        :param _builtins.str id: The ID of this public key. Signatures verified by BinAuthz
...
class AttestorAttestationAuthorityNotePublicKeyPkixPublicKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str public_key_pem: A PEM-encoded public key, as described in
               `https://tools.ietf.org/html/rfc7468#section-13`
        :param _builtins.str signature_algorithm: The signature algorithm used to verify a message against
...
class PolicyAdmissionWhitelistPattern(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name_pattern: An image name pattern to whitelist, in the form
...
class PolicyClusterAdmissionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 require_attestations_bies: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str cluster: The identifier for this object. Format specified above.
        :param _builtins.str enforcement_mode: The action when a pod creation is denied by the admission rule.
               Possible values are: `ENFORCED_BLOCK_AND_AUDIT_LOG`, `DRYRUN_AUDIT_LOG_ONLY`.
        :param _builtins.str evaluation_mode: How this admission rule will be evaluated.
               Possible values are: `ALWAYS_ALLOW`, `REQUIRE_ATTESTATION`, `ALWAYS_DENY`.
        :param Sequence[_builtins.str] require_attestations_bies: The resource names of the attestors that must attest to a
