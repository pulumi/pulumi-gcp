...
class AttestorAttestationAuthorityNote(dict):
    ...
    def __init__(__self__, *,
                 ...
                 delegation_service_account_email: Optional[builtins.str] = None,
                 public_keys: Optional[Sequence['outputs.AttestorAttestationAuthorityNotePublicKey']] = None):
        """
        :param builtins.str note_reference: The resource name of a ATTESTATION_AUTHORITY Note, created by the
        ...
        :param builtins.str delegation_service_account_email: (Output)
    ...
    def delegation_service_account_email(self) -> Optional[builtins.str]:
        """
        (Output)
        This field will contain the service account email address that
        this Attestor will use as the principal when querying Container
...
class AttestorAttestationAuthorityNotePublicKey(dict):
    ...
    def __init__(__self__, *,
                 ascii_armored_pgp_public_key: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str ascii_armored_pgp_public_key: ASCII-armored representation of a PGP public key, as the
        ...
        :param builtins.str comment: A descriptive comment. This field may be updated.
        :param builtins.str id: The ID of this public key. Signatures verified by BinAuthz
    ...
    def ascii_armored_pgp_public_key(self) -> Optional[builtins.str]:
        """
...
class AttestorAttestationAuthorityNotePublicKeyPkixPublicKey(dict):
    ...
    def __init__(__self__, *,
                 public_key_pem: Optional[builtins.str] = None,
                 signature_algorithm: Optional[builtins.str] = None):
        """
        :param builtins.str public_key_pem: A PEM-encoded public key, as described in
               `https://tools.ietf.org/html/rfc7468#section-13`
        :param builtins.str signature_algorithm: The signature algorithm used to verify a message against
    ...
    def public_key_pem(self) -> Optional[builtins.str]:
        """
...
class PolicyAdmissionWhitelistPattern(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name_pattern: An image name pattern to whitelist, in the form
...
class PolicyClusterAdmissionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 require_attestations_bies: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str cluster: The identifier for this object. Format specified above.
    ...
    def require_attestations_bies(self) -> Optional[Sequence[builtins.str]]:
        """
