...
class FolderFeedArgs:
    def __init__(__self__, *,
                 billing_project: pulumi.Input[builtins.str],
                 ...
                 asset_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 asset_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] folder: The folder this feed should be created in.
    ...
    def billing_project(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def billing_project(self, value: pulumi.Input[builtins.str]):
    ...
    @asset_names.setter
    def asset_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @asset_types.setter
    def asset_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _FolderFeedState:
    def __init__(__self__, *,
                 asset_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 asset_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 billing_project: Optional[pulumi.Input[builtins.str]] = None,
                 condition: Optional[pulumi.Input['FolderFeedConditionArgs']] = None,
                 content_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['FolderFeedFeedOutputConfigArgs'] feed_output_config: Output configuration for asset feed destination.
               Structure is documented below.
        :param pulumi.Input[builtins.str] folder: The folder this feed should be created in.
        :param pulumi.Input[builtins.str] folder_id: The ID of the folder where this feed has been created. Both [FOLDER_NUMBER]
               and folders/[FOLDER_NUMBER] are accepted.
        :param pulumi.Input[builtins.str] name: The format will be folders/{folder_number}/feeds/{client-assigned_feed_identifier}.
        """
        if asset_names is not None:
            pulumi.set(__self__, "asset_names", asset_names)
        if asset_types is not None:
    ...
    @property
    @pulumi.getter(name="billingProject")
    def billing_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The project whose identity will be used when sending messages to the
        destination pubsub topic. It also specifies the project for API
        enablement check, quota, and billing.
    ...
    @billing_project.setter
    def billing_project(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "billing_project", value)
...
class FolderFeed(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            folder: Optional[pulumi.Input[builtins.str]] = None,
            folder_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'FolderFeed':
        """
    ...
    @property
    @pulumi.getter(name="billingProject")
    def billing_project(self) -> pulumi.Output[builtins.str]:
        """
        The project whose identity will be used when sending messages to the
        destination pubsub topic. It also specifies the project for API
        enablement check, quota, and billing.
