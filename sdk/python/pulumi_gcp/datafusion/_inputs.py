...
class InstanceAcceleratorArgs:
    def __init__(__self__, *,
                 ...
                 state: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] accelerator_type: The type of an accelator for a CDF instance.
               Possible values are: `CDC`, `HEALTHCARE`, `CCAI_INSIGHTS`.
        :param pulumi.Input[builtins.str] state: The type of an accelator for a CDF instance.
               Possible values are: `ENABLED`, `DISABLED`.
        """
...
class InstanceCryptoKeyConfigArgs:
    def __init__(__self__, *,
                 key_reference: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_reference: The name of the key which is used to encrypt/decrypt customer data. For key in Cloud KMS, the key should be in the format of projects/*/locations/*/keyRings/*/cryptoKeys/*.
        """
...
class InstanceEventPublishConfigArgs:
    def __init__(__self__, *,
                 ...
                 topic: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.bool] enabled: Option to enable Event Publishing.
        :param pulumi.Input[builtins.str] topic: The resource name of the Pub/Sub topic. Format: projects/{projectId}/topics/{topic_id}
        """
...
if not MYPY:
    class InstanceNetworkConfigArgsDict(TypedDict):
        ...
        """
        ip_allocation: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceNetworkConfigArgs:
    def __init__(__self__, *,
                 ...
                 ip_allocation: Optional[pulumi.Input[builtins.str]] = None,
                 network: Optional[pulumi.Input[builtins.str]] = None,
                 private_service_connect_config: Optional[pulumi.Input['InstanceNetworkConfigPrivateServiceConnectConfigArgs']] = None):
        """
        :param pulumi.Input[builtins.str] connection_type: Optional. Type of connection for establishing private IP connectivity between the Data Fusion customer project VPC and
               the corresponding tenant project from a predefined list of available connection modes.
               If this field is unspecified for a private instance, VPC peering is used.
               Possible values are: `VPC_PEERING`, `PRIVATE_SERVICE_CONNECT_INTERFACES`.
        :param pulumi.Input[builtins.str] ip_allocation: The IP range in CIDR notation to use for the managed Data Fusion instance
               nodes. This range must not overlap with any other ranges used in the Data Fusion instance network.
        :param pulumi.Input[builtins.str] network: Name of the network in the project with which the tenant project
               will be peered for executing pipelines. In case of shared VPC where the network resides in another host
               project the network should specified in the form of projects/{host-project-id}/global/networks/{network}
    ...
    def ip_allocation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP range in CIDR notation to use for the managed Data Fusion instance
        nodes. This range must not overlap with any other ranges used in the Data Fusion instance network.
        """
    ...
    def ip_allocation(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstanceNetworkConfigPrivateServiceConnectConfigArgsDict(TypedDict):
        effective_unreachable_cidr_block: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        ...
        This is required only when using connection type PRIVATE_SERVICE_CONNECT_INTERFACES.
        """
        unreachable_cidr_block: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InstanceNetworkConfigPrivateServiceConnectConfigArgs:
    def __init__(__self__, *,
                 effective_unreachable_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 network_attachment: Optional[pulumi.Input[builtins.str]] = None,
                 unreachable_cidr_block: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] effective_unreachable_cidr_block: (Output)
               Output only. The CIDR block to which the CDF instance can't route traffic to in the consumer project VPC.
               The size of this block is /25. The format of this field is governed by RFC 4632.
        :param pulumi.Input[builtins.str] network_attachment: Optional. The reference to the network attachment used to establish private connectivity.
               It will be of the form projects/{project-id}/regions/{region}/networkAttachments/{network-attachment-id}.
               This is required only when using connection type PRIVATE_SERVICE_CONNECT_INTERFACES.
        :param pulumi.Input[builtins.str] unreachable_cidr_block: Optional. Input only. The CIDR block to which the CDF instance can't route traffic to in the consumer project VPC.
               The size of this block should be at least /25. This range should not overlap with the primary address range of any subnetwork used by the network attachment.
               This range can be used for other purposes in the consumer VPC as long as there is no requirement for CDF to reach destinations using these addresses.
               If this value is not provided, the server chooses a non RFC 1918 address range. The format of this field is governed by RFC 4632.
        """
    ...
    def effective_unreachable_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Output only. The CIDR block to which the CDF instance can't route traffic to in the consumer project VPC.
        The size of this block is /25. The format of this field is governed by RFC 4632.
    ...
    def effective_unreachable_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def unreachable_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Optional. Input only. The CIDR block to which the CDF instance can't route traffic to in the consumer project VPC.
        The size of this block should be at least /25. This range should not overlap with the primary address range of any subnetwork used by the network attachment.
        This range can be used for other purposes in the consumer VPC as long as there is no requirement for CDF to reach destinations using these addresses.
    ...
    def unreachable_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
