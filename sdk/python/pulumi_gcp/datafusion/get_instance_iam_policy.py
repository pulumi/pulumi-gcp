...
def get_instance_iam_policy(name: Optional[builtins.str] = None,
    ...
    :param builtins.str region: The region of the Data Fusion instance.
...
def get_instance_iam_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
