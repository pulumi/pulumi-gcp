...
def get_instance_iam_policy(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: The region of the Data Fusion instance.
...
def get_instance_iam_policy_output(name: Optional[pulumi.Input[_builtins.str]] = None,
