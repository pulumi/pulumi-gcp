...
class GdcApplicationEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 application_environment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 namespace: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 spark_application_environment_config: pulumi.Input[Optional['GdcApplicationEnvironmentSparkApplicationEnvironmentConfigArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] namespace: The name of the namespace in which to create this ApplicationEnvironment. This namespace must already exist in the cluster
    ...
    def application_environment_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def application_environment_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def spark_application_environment_config(self) -> pulumi.Input[Optional['GdcApplicationEnvironmentSparkApplicationEnvironmentConfigArgs']]:
        """
    ...
    def spark_application_environment_config(self, value: pulumi.Input[Optional['GdcApplicationEnvironmentSparkApplicationEnvironmentConfigArgs']]):
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels to associate with this application environment. Labels may be used for filtering and billing tracking.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location of the application environment
        :param pulumi.Input[_builtins.str] name: Identifier. The name of the application environment. Format: projects/{project}/locations/{location}/serviceInstances/{service_instance}/applicationEnvironments/{application_environment_id}
        :param pulumi.Input[_builtins.str] namespace: The name of the namespace in which to create this ApplicationEnvironment. This namespace must already exist in the cluster
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
...
class GdcApplicationEnvironment(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="applicationEnvironmentId")
    def application_environment_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The id of the application environment
        """
        return pulumi.get(self, "application_environment_id")
