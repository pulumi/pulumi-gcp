...
class ClusterIAMBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] region: The region in which the cluster belongs. If it
               is not provided, the provider will use a default.
        """
        ClusterIAMBindingArgs._configure(
...
class _ClusterIAMBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `dataproc.ClusterIAMPolicy` only:
        """
        _ClusterIAMBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            cluster=cluster,
            condition=condition,
            etag=etag,
...
class ClusterIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ClusterIAMBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, ClusterIAMBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                ClusterIAMBindingConditionArgs._configure(_setter, **condition)
