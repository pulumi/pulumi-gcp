...
class JobIAMMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The project in which the job belongs. If it
               is not provided, the provider will use a default.
        :param pulumi.Input[builtins.str] region: The region in which the job belongs. If it
               is not provided, the provider will use a default.
        """
...
class _JobIAMMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] etag: (Computed) The etag of the jobs's IAM policy.
        :param pulumi.Input[builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
               * **allAuthenticatedUsers**: A special identifier that represents anyone who is authenticated with a Google account or a service account.
...
class JobIAMMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: Optional[pulumi.Input[Union['JobIAMMemberConditionArgs', 'JobIAMMemberConditionArgsDict']]] = None,
                 job_id: Optional[pulumi.Input[builtins.str]] = None,
                 member: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'JobIAMMember':
        """
