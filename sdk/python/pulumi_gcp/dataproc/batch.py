    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels to associate with this batch.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location in which the batch will be created in.
        :param pulumi.Input[_builtins.str] name: The resource name of the batch.
        :param pulumi.Input[_builtins.str] operation: The resource name of the operation associated with this batch.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        ...
        :param pulumi.Input[_builtins.str] state_time: Batch state details, such as a failure description if the state is FAILED.
        :param pulumi.Input[_builtins.str] uuid: A batch UUID (Unique Universal Identifier). The service generates this value when it creates the batch.
        """
        if batch_id is not None:
            pulumi.set(__self__, "batch_id", batch_id)
