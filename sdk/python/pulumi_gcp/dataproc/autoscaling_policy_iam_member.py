...
class AutoscalingPolicyIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['AutoscalingPolicyIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] policy_id: Used to find the parent resource to bind the IAM policy to
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['AutoscalingPolicyIamMemberConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['AutoscalingPolicyIamMemberConditionArgs']]):
...
@pulumi.type_token("gcp:dataproc/autoscalingPolicyIamMember:AutoscalingPolicyIamMember")
class AutoscalingPolicyIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['AutoscalingPolicyIamMemberConditionArgs', 'AutoscalingPolicyIamMemberConditionArgsDict', 'outputs.AutoscalingPolicyIamMemberCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `dataproc.AutoscalingPolicyIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the autoscalingpolicy are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `dataproc.AutoscalingPolicyIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the autoscalingpolicy are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def _internal_init(__self__,
        ...
        super(AutoscalingPolicyIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            policy_id: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'AutoscalingPolicyIamMember':
        """
        ...
        __props__ = _AutoscalingPolicyIamMemberState.__new__(_AutoscalingPolicyIamMemberState)
        ...
        __props__.__dict__["project"] = project
        __props__.__dict__["role"] = role
        return AutoscalingPolicyIamMember(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.AutoscalingPolicyIamMemberCondition']]:
        return pulumi.get(self, "condition")
