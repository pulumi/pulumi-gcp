...
class AutoscalingPolicyIamMemberArgs:
    def __init__(__self__, *,
        ...
        """
        AutoscalingPolicyIamMemberArgs._configure(
...
class _AutoscalingPolicyIamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        """
        _AutoscalingPolicyIamMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            etag=etag,
            location=location,
...
class AutoscalingPolicyIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AutoscalingPolicyIamMemberArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            policy_id: Optional[pulumi.Input[str]] = None,
            project: Optional[pulumi.Input[str]] = None,
            role: Optional[pulumi.Input[str]] = None) -> 'AutoscalingPolicyIamMember':
        """
