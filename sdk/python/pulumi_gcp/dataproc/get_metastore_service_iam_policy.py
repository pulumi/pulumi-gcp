...
def get_metastore_service_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location where the metastore service should reside.
