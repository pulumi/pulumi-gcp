...
class MetastoreTableIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['MetastoreTableIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] service_id: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[_builtins.str] table: Used to find the parent resource to bind the IAM policy to
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['MetastoreTableIamMemberConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['MetastoreTableIamMemberConditionArgs']]):
...
class MetastoreTableIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['MetastoreTableIamMemberConditionArgs', 'MetastoreTableIamMemberConditionArgsDict', 'outputs.MetastoreTableIamMemberCondition']]] = None,
                 database_id: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `dataproc.MetastoreTableIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the table are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `dataproc.MetastoreTableIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the table are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            role: pulumi.Input[Optional[_builtins.str]] = None,
            service_id: pulumi.Input[Optional[_builtins.str]] = None,
            table: pulumi.Input[Optional[_builtins.str]] = None) -> 'MetastoreTableIamMember':
        """
