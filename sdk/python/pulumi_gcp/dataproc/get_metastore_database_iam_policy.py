...
def get_metastore_database_iam_policy(database: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database: Used to find the parent resource to bind the IAM policy to
...
def get_metastore_database_iam_policy_output(database: Optional[pulumi.Input[_builtins.str]] = None,
