...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 graceful_decommission_timeout: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The list of the labels (key/value pairs) configured on the resource and to be applied to instances in the cluster.
        ...
        :param pulumi.Input[builtins.str] name: The name of the cluster, unique within the project and
               ...
               - - -
        :param pulumi.Input[builtins.str] project: The ID of the project in which the `cluster` will exist. If it
               is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] region: The region in which the cluster and associated nodes will be created in.
               Defaults to `global`.
    ...
    def graceful_decommission_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "graceful_decommission_timeout")

    @graceful_decommission_timeout.setter
    def graceful_decommission_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterClusterConfigArgs'] cluster_config: Allows you to configure various aspects of the cluster.
               Structure defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] effective_labels: The list of labels (key/value pairs) to be applied to
...
class Cluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="gracefulDecommissionTimeout")
    def graceful_decommission_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "graceful_decommission_timeout")
