...
class WorkflowTemplateArgs:
    def __init__(__self__, *,
                 ...
                 dag_timeout: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] dag_timeout: Optional. Timeout duration for the DAG of jobs, expressed in seconds (see [JSON representation of
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Optional. The labels to associate with this template. These labels will be propagated to all jobs and clusters created
        ...
        :param pulumi.Input[builtins.str] name: Output only. The resource name of the workflow template, as described in https://cloud.google.com/apis/design/resource_names. * For `projects.regions.workflowTemplates`, the resource name of the template has the following format: `projects/{project_id}/regions/{region}/workflowTemplates/{template_id}` * For `projects.locations.workflowTemplates`, the resource name of the template has the following format: `projects/{project_id}/locations/{location}/workflowTemplates/{template_id}`
        ...
        :param pulumi.Input[builtins.int] version: Output only. The current version of this workflow template.
        """
    ...
    def dag_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dag_timeout.setter
    def dag_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WorkflowTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: Output only. The time template was created.
        :param pulumi.Input[builtins.str] dag_timeout: Optional. Timeout duration for the DAG of jobs, expressed in seconds (see [JSON representation of
               duration](https://developers.google.com/protocol-buffers/docs/proto3#json)). The timeout duration must be from 10
               minutes ("600s") to 24 hours ("86400s"). The timer begins when the first job is submitted. If the workflow is running at
               the end of the timeout period, any remaining jobs are cancelled, the workflow is ended, and if the workflow was running
        ...
        :param pulumi.Input[builtins.str] update_time: Output only. The time template was last updated.
        :param pulumi.Input[builtins.int] version: Output only. The current version of this workflow template.
        """
...
class WorkflowTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'WorkflowTemplate':
        """
    ...
    @property
    @pulumi.getter(name="dagTimeout")
    def dag_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional. Timeout duration for the DAG of jobs, expressed in seconds (see [JSON representation of
        duration](https://developers.google.com/protocol-buffers/docs/proto3#json)). The timeout duration must be from 10
        minutes ("600s") to 24 hours ("86400s"). The timer begins when the first job is submitted. If the workflow is running at
