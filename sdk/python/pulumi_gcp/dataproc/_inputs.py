...
__all__ = [
    ...
    'ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArrgs',
    'ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArrgs',
    'ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArrgs',
...
calass ClusterClusterConfigPreemptibleWorkerConfigArrgs:
    def __init__(__self__, *,
                 ...
                 instance_flexibility_policy: Optional[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArrgs']] = None,
                 instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 num_instances: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArrgs'] instance_flexibility_policy: Instance flexibility Policy allowing a mixture of VM shapes and provisioning models.
    ...
    def instance_flexibility_policy(self) -> Optional[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArrgs']]:
        """
    ...
    def instance_flexibility_policy(self, value: Optional[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArrgs']]):
...
@pulumi.input_type
calass ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyArrgs:
    def __init__(__self__, *,
                 instance_selection_lists: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArrgs']]]] = None,
                 instance_selection_results: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArrgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArrgs']]] instance_selection_lists: List of instance selection options that the group will use when creating new VMs.
        """
    ...
    def instance_selection_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArrgs']]]]:
        """
    ...
    def instance_selection_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArrgs']]]]):
        pulumi.set(self, "instance_selection_lists", value)

    @property
    @pulumi.getter(name="instanceSelectionResults")
    def instance_selection_results(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArrgs']]]]:
        return pulumi.get(self, "instance_selection_results")

    @instance_selection_results.setter
    def instance_selection_results(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArrgs']]]]):
        pulumi.set(self, "instance_selection_results", value)


@pulumi.input_type
calass ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArrgs:
    def __init__(__self__, *,
...
@pulumi.input_type
calass ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArrgs:
    def __init__(__self__, *,
                 machine_type: Optional[pulumi.Input[str]] = None,
