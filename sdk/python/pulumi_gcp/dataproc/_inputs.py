...
if not MYPY:
    class AutoscalingPolicyBasicAlgorithmArgsDict(TypedDict):
        ...
        """
        cooldown_period: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AutoscalingPolicyBasicAlgorithmArgs:
    def __init__(__self__, *,
                 ...
                 cooldown_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input['AutoscalingPolicyBasicAlgorithmYarnConfigArgs'] yarn_config: YARN autoscaling configuration.
               Structure is documented below.
        :param pulumi.Input[builtins.str] cooldown_period: Duration between scaling events. A scaling period starts after the
               update operation from the previous event has completed.
               Bounds: [2m, 1d]. Default: 2m.
        """
    ...
    def cooldown_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Duration between scaling events. A scaling period starts after the
        update operation from the previous event has completed.
        Bounds: [2m, 1d]. Default: 2m.
    ...
    def cooldown_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cooldown_period", value)


if not MYPY:
    class AutoscalingPolicyBasicAlgorithmYarnConfigArgsDict(TypedDict):
        graceful_decommission_timeout: pulumi.Input[builtins.str]
        """
        ...
        Bounds: [0s, 1d].
        """
        scale_down_factor: pulumi.Input[builtins.float]
        """
        ...
        Bounds: [0.0, 1.0].
        """
        scale_up_factor: pulumi.Input[builtins.float]
        """
        Fraction of average pending memory in the last cooldown period for which to
        ...
        Bounds: [0.0, 1.0].
        """
        scale_down_min_worker_fraction: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        scale_up_min_worker_fraction: NotRequired[pulumi.Input[builtins.float]]
        """
...
class AutoscalingPolicyBasicAlgorithmYarnConfigArgs:
    def __init__(__self__, *,
                 ...
                 scale_down_factor: pulumi.Input[builtins.float],
                 scale_up_factor: pulumi.Input[builtins.float],
                 scale_down_min_worker_fraction: Optional[pulumi.Input[builtins.float]] = None,
                 scale_up_min_worker_fraction: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.str] graceful_decommission_timeout: Timeout for YARN graceful decommissioning of Node Managers. Specifies the
               duration to wait for jobs to complete before forcefully removing workers
               (and potentially interrupting jobs). Only applicable to downscaling operations.
               Bounds: [0s, 1d].
        :param pulumi.Input[builtins.float] scale_down_factor: Fraction of average pending memory in the last cooldown period for which to
               remove workers. A scale-down factor of 1 will result in scaling down so that there
               is no available memory remaining after the update (more aggressive scaling).
               A scale-down factor of 0 disables removing workers, which can be beneficial for
               autoscaling a single job.
               Bounds: [0.0, 1.0].
        :param pulumi.Input[builtins.float] scale_up_factor: Fraction of average pending memory in the last cooldown period for which to
               add workers. A scale-up factor of 1.0 will result in scaling up so that there
               is no pending memory remaining after the update (more aggressive scaling).
               A scale-up factor closer to 0 will result in a smaller magnitude of scaling up
               (less aggressive scaling).
               Bounds: [0.0, 1.0].
        :param pulumi.Input[builtins.float] scale_down_min_worker_fraction: Minimum scale-down threshold as a fraction of total cluster size before scaling occurs.
               For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler must
               recommend at least a 2 worker scale-down for the cluster to scale. A threshold of 0
               means the autoscaler will scale down on any recommended change.
               Bounds: [0.0, 1.0]. Default: 0.0.
        :param pulumi.Input[builtins.float] scale_up_min_worker_fraction: Minimum scale-up threshold as a fraction of total cluster size before scaling
               occurs. For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler
               must recommend at least a 2-worker scale-up for the cluster to scale. A threshold of
               0 means the autoscaler will scale up on any recommended change.
               Bounds: [0.0, 1.0]. Default: 0.0.
    ...
    def graceful_decommission_timeout(self) -> pulumi.Input[builtins.str]:
        """
        Timeout for YARN graceful decommissioning of Node Managers. Specifies the
        duration to wait for jobs to complete before forcefully removing workers
        (and potentially interrupting jobs). Only applicable to downscaling operations.
    ...
    def graceful_decommission_timeout(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "graceful_decommission_timeout", value)

    @property
    @pulumi.getter(name="scaleDownFactor")
    def scale_down_factor(self) -> pulumi.Input[builtins.float]:
        """
        Fraction of average pending memory in the last cooldown period for which to
        remove workers. A scale-down factor of 1 will result in scaling down so that there
        is no available memory remaining after the update (more aggressive scaling).
    ...
    def scale_down_factor(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "scale_down_factor", value)

    @property
    @pulumi.getter(name="scaleUpFactor")
    def scale_up_factor(self) -> pulumi.Input[builtins.float]:
        """
        Fraction of average pending memory in the last cooldown period for which to
        add workers. A scale-up factor of 1.0 will result in scaling up so that there
        is no pending memory remaining after the update (more aggressive scaling).
    ...
    def scale_up_factor(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "scale_up_factor", value)

    @property
    @pulumi.getter(name="scaleDownMinWorkerFraction")
    def scale_down_min_worker_fraction(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Minimum scale-down threshold as a fraction of total cluster size before scaling occurs.
        For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler must
        recommend at least a 2 worker scale-down for the cluster to scale. A threshold of 0
    ...
    def scale_down_min_worker_fraction(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "scale_down_min_worker_fraction", value)

    @property
    @pulumi.getter(name="scaleUpMinWorkerFraction")
    def scale_up_min_worker_fraction(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Minimum scale-up threshold as a fraction of total cluster size before scaling
        occurs. For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler
        must recommend at least a 2-worker scale-up for the cluster to scale. A threshold of
    ...
    def scale_up_min_worker_fraction(self, value: Optional[pulumi.Input[builtins.float]]):
...
class AutoscalingPolicySecondaryWorkerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_instances: Maximum number of instances for this group. Note that by default, clusters will not use
               secondary workers. Required for secondary workers if the minimum secondary instances is set.
               Bounds: [minInstances, ). Defaults to 0.
        :param pulumi.Input[builtins.int] min_instances: Minimum number of instances for this group. Bounds: [0, maxInstances]. Defaults to 0.
        :param pulumi.Input[builtins.int] weight: Weight for the instance group, which is used to determine the fraction of total workers
               in the cluster from this instance group. For example, if primary workers have weight 2,
               and secondary workers have weight 1, the cluster will have approximately 2 primary workers
               for each secondary worker.
               The cluster may not reach the specified balance if constrained by min/max bounds or other
...
class AutoscalingPolicyWorkerConfigArgs:
    def __init__(__self__, *,
                 ...
                 weight: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] max_instances: Maximum number of instances for this group.
        :param pulumi.Input[builtins.int] min_instances: Minimum number of instances for this group. Bounds: [2, maxInstances]. Defaults to 2.
        :param pulumi.Input[builtins.int] weight: Weight for the instance group, which is used to determine the fraction of total workers
               in the cluster from this instance group. For example, if primary workers have weight 2,
               and secondary workers have weight 1, the cluster will have approximately 2 primary workers
               for each secondary worker.
...
if not MYPY:
    class BatchEnvironmentConfigExecutionConfigArgsDict(TypedDict):
        ...
        """
        network_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BatchEnvironmentConfigExecutionConfigArgs:
    def __init__(__self__, *,
                 ...
                 network_uri: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] network_uri: Network configuration for workload execution.
    ...
    def network_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Network configuration for workload execution.
        """
    ...
    @network_uri.setter
    def network_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BatchPysparkBatchArgsDict(TypedDict):
        ...
        """
        jar_file_uris: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        """
        main_python_file_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The HCFS URI of the main Python file to use as the Spark driver. Must be a .py file.
        """
        python_file_uris: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BatchPysparkBatchArgs:
    def __init__(__self__, *,
                 ...
                 jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 main_python_file_uri: Optional[pulumi.Input[builtins.str]] = None,
                 python_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor.
               Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments that can be set as batch
               properties, such as --conf, since a collision can occur that causes an incorrect batch submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        :param pulumi.Input[builtins.str] main_python_file_uri: The HCFS URI of the main Python file to use as the Spark driver. Must be a .py file.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] python_file_uris: HCFS file URIs of Python files to pass to the PySpark framework.
               Supported file types: .py, .egg, and .zip.
        """
    ...
    def jar_file_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        """
    ...
    def jar_file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "jar_file_uris", value)

    @property
    @pulumi.getter(name="mainPythonFileUri")
    def main_python_file_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The HCFS URI of the main Python file to use as the Spark driver. Must be a .py file.
        """
    ...
    def main_python_file_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "main_python_file_uri", value)

    @property
    @pulumi.getter(name="pythonFileUris")
    def python_file_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        HCFS file URIs of Python files to pass to the PySpark framework.
        Supported file types: .py, .egg, and .zip.
        """
    ...
    def python_file_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class BatchRuntimeConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        cohort: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BatchRuntimeConfigArgs:
    def __init__(__self__, *,
                 ...
                 cohort: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['BatchRuntimeConfigAutotuningConfigArgs'] autotuning_config: Optional. Autotuning configuration of the workload.
               Structure is documented below.
        :param pulumi.Input[builtins.str] cohort: Optional. Cohort identifier. Identifies families of the workloads having the same shape, e.g. daily ETL jobs.
        ...
        :param pulumi.Input[builtins.str] version: Version of the batch runtime.
        """
    ...
    @property
    @pulumi.getter
    def cohort(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Optional. Cohort identifier. Identifies families of the workloads having the same shape, e.g. daily ETL jobs.
        """
    ...
    @cohort.setter
    def cohort(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BatchRuntimeConfigAutotuningConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scenarios: Optional. Scenarios for which tunings are applied.
               Each value may be one of: `SCALING`, `BROADCAST_HASH_JOIN`, `MEMORY`.
        """
...
if not MYPY:
    class BatchRuntimeInfoArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        diagnostic_output_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        A URI pointing to the location of the diagnostics tarball.
        """
        endpoints: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        (Output)
        Map of remote access endpoints (such as web interfaces and APIs) to their URIs.
        """
        output_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class BatchRuntimeInfoArgs:
    def __init__(__self__, *,
                 ...
                 diagnostic_output_uri: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BatchRuntimeInfoCurrentUsageArgs']]] current_usages: (Output)
               Snapshot of current workload resource usage(see [Dataproc Serverless pricing](https://cloud.google.com/dataproc-serverless/pricing))
               Structure is documented below.
        :param pulumi.Input[builtins.str] diagnostic_output_uri: (Output)
               A URI pointing to the location of the diagnostics tarball.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] endpoints: (Output)
               Map of remote access endpoints (such as web interfaces and APIs) to their URIs.
        :param pulumi.Input[builtins.str] output_uri: (Output)
               A URI pointing to the location of the stdout and stderr of the workload.
        """
    ...
    def diagnostic_output_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        A URI pointing to the location of the diagnostics tarball.
        """
    ...
    def diagnostic_output_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BatchRuntimeInfoApproximateUsageArgsDict(TypedDict):
        ...
        """
        milli_accelerator_seconds: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Accelerator usage in (milliAccelerator x seconds)
        """
        milli_dcu_seconds: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        DCU (Dataproc Compute Units) usage in (milliDCU x seconds)
        """
        shuffle_storage_gb_seconds: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class BatchRuntimeInfoApproximateUsageArgs:
    def __init__(__self__, *,
                 ...
                 milli_accelerator_seconds: Optional[pulumi.Input[builtins.str]] = None,
                 milli_dcu_seconds: Optional[pulumi.Input[builtins.str]] = None,
                 shuffle_storage_gb_seconds: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] accelerator_type: (Output)
               Accelerator type being used, if any.
        :param pulumi.Input[builtins.str] milli_accelerator_seconds: (Output)
               Accelerator usage in (milliAccelerator x seconds)
        :param pulumi.Input[builtins.str] milli_dcu_seconds: (Output)
               DCU (Dataproc Compute Units) usage in (milliDCU x seconds)
        :param pulumi.Input[builtins.str] shuffle_storage_gb_seconds: (Output)
               Shuffle storage usage in (GB x seconds)
        """
    ...
    def milli_accelerator_seconds(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Accelerator usage in (milliAccelerator x seconds)
        """
    ...
    def milli_accelerator_seconds(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "milli_accelerator_seconds", value)

    @property
    @pulumi.getter(name="milliDcuSeconds")
    def milli_dcu_seconds(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        DCU (Dataproc Compute Units) usage in (milliDCU x seconds)
        """
    ...
    def milli_dcu_seconds(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "milli_dcu_seconds", value)

    @property
    @pulumi.getter(name="shuffleStorageGbSeconds")
    def shuffle_storage_gb_seconds(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Shuffle storage usage in (GB x seconds)
        """
    ...
    def shuffle_storage_gb_seconds(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BatchRuntimeInfoCurrentUsageArgsDict(TypedDict):
        ...
        Accelerator type being used, if any.
        """
        milli_accelerator: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Milli (one-thousandth) accelerator..
        """
        milli_dcu: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Milli (one-thousandth) Dataproc Compute Units (DCUs).
        """
        milli_dcu_premium: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Milli (one-thousandth) Dataproc Compute Units (DCUs) charged at premium tier.
        """
        shuffle_storage_gb: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Shuffle Storage in gigabytes (GB).
        """
        shuffle_storage_gb_premium: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Shuffle Storage in gigabytes (GB) charged at premium tier.
        """
        snapshot_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class BatchRuntimeInfoCurrentUsageArgs:
    def __init__(__self__, *,
                 accelerator_type: Optional[pulumi.Input[builtins.str]] = None,
                 milli_accelerator: Optional[pulumi.Input[builtins.str]] = None,
                 milli_dcu: Optional[pulumi.Input[builtins.str]] = None,
                 milli_dcu_premium: Optional[pulumi.Input[builtins.str]] = None,
                 shuffle_storage_gb: Optional[pulumi.Input[builtins.str]] = None,
                 shuffle_storage_gb_premium: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] accelerator_type: (Output)
               Accelerator type being used, if any.
        :param pulumi.Input[builtins.str] milli_accelerator: (Output)
               Milli (one-thousandth) accelerator..
        :param pulumi.Input[builtins.str] milli_dcu: (Output)
               Milli (one-thousandth) Dataproc Compute Units (DCUs).
        :param pulumi.Input[builtins.str] milli_dcu_premium: (Output)
               Milli (one-thousandth) Dataproc Compute Units (DCUs) charged at premium tier.
        :param pulumi.Input[builtins.str] shuffle_storage_gb: (Output)
               Shuffle Storage in gigabytes (GB).
        :param pulumi.Input[builtins.str] shuffle_storage_gb_premium: (Output)
               Shuffle Storage in gigabytes (GB) charged at premium tier.
        :param pulumi.Input[builtins.str] snapshot_time: (Output)
               The timestamp of the usage snapshot.
        """
        if accelerator_type is not None:
            pulumi.set(__self__, "accelerator_type", accelerator_type)
    ...
    def milli_accelerator(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Milli (one-thousandth) accelerator..
        """
    ...
    def milli_accelerator(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "milli_accelerator", value)

    @property
    @pulumi.getter(name="milliDcu")
    def milli_dcu(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Milli (one-thousandth) Dataproc Compute Units (DCUs).
        """
    ...
    @milli_dcu.setter
    def milli_dcu(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "milli_dcu", value)

    @property
    @pulumi.getter(name="milliDcuPremium")
    def milli_dcu_premium(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Milli (one-thousandth) Dataproc Compute Units (DCUs) charged at premium tier.
        """
    ...
    def milli_dcu_premium(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "milli_dcu_premium", value)

    @property
    @pulumi.getter(name="shuffleStorageGb")
    def shuffle_storage_gb(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Shuffle Storage in gigabytes (GB).
        """
    ...
    def shuffle_storage_gb(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "shuffle_storage_gb", value)

    @property
    @pulumi.getter(name="shuffleStorageGbPremium")
    def shuffle_storage_gb_premium(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Shuffle Storage in gigabytes (GB) charged at premium tier.
        """
    ...
    def shuffle_storage_gb_premium(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BatchSparkBatchArgsDict(TypedDict):
        ...
        """
        main_jar_file_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BatchSparkBatchArgs:
    def __init__(__self__, *,
                 ...
                 main_jar_file_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor.
               Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments that can be set as batch
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        :param pulumi.Input[builtins.str] main_class: The name of the driver main class. The jar file that contains the class must be in the
               classpath or specified in jarFileUris.
        :param pulumi.Input[builtins.str] main_jar_file_uri: The HCFS URI of the jar file that contains the main class.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
    ...
    def main_jar_file_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The HCFS URI of the jar file that contains the main class.
        """
    ...
    def main_jar_file_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BatchSparkRBatchArgsDict(TypedDict):
        ...
        HCFS URIs of files to be placed in the working directory of each executor.
        """
        main_r_file_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BatchSparkRBatchArgs:
    def __init__(__self__, *,
                 ...
                 args: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 main_r_file_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor.
               Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments that can be set as batch
               properties, such as --conf, since a collision can occur that causes an incorrect batch submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param pulumi.Input[builtins.str] main_r_file_uri: The HCFS URI of the main R file to use as the driver. Must be a .R or .r file.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
    ...
    def main_r_file_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The HCFS URI of the main R file to use as the driver. Must be a .R or .r file.
        """
    ...
    def main_r_file_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BatchSparkSqlBatchArgsDict(TypedDict):
        ...
        """
        query_file_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The HCFS URI of the script that contains Spark SQL queries to execute.
        """
        query_variables: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class BatchSparkSqlBatchArgs:
    def __init__(__self__, *,
                 jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 query_file_uri: Optional[pulumi.Input[builtins.str]] = None,
                 query_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to be added to the Spark CLASSPATH.
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains Spark SQL queries to execute.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] query_variables: Mapping of query variable names to values (equivalent to the Spark SQL command: SET name="value";).
        """
        if jar_file_uris is not None:
            pulumi.set(__self__, "jar_file_uris", jar_file_uris)
    ...
    def query_file_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The HCFS URI of the script that contains Spark SQL queries to execute.
        """
    ...
    def query_file_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "query_file_uri", value)

    @property
    @pulumi.getter(name="queryVariables")
    def query_variables(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Mapping of query variable names to values (equivalent to the Spark SQL command: SET name="value";).
        """
    ...
    def query_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class BatchStateHistoryArgsDict(TypedDict):
        ...
        """
        state_message: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Details about the state at this point in history.
        """
        state_start_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class BatchStateHistoryArgs:
    def __init__(__self__, *,
                 ...
                 state_start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] state: (Output)
               The state of the batch at this point in history. For possible values, see the [API documentation](https://cloud.google.com/dataproc-serverless/docs/reference/rest/v1/projects.locations.batches#State).
        :param pulumi.Input[builtins.str] state_message: (Output)
               Details about the state at this point in history.
        :param pulumi.Input[builtins.str] state_start_time: (Output)
               The time when the batch entered the historical state.
        """
    ...
    def state_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The time when the batch entered the historical state.
        """
    ...
    def state_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterClusterConfigArgsDict(TypedDict):
        ...
        * **NOTE** : `preemptible_worker_config` is
        ...
        option.
        """
        temp_bucket: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterClusterConfigArgs:
    def __init__(__self__, *,
                 ...
                 staging_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 temp_bucket: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterClusterConfigAuxiliaryNodeGroupArgs']]] auxiliary_node_groups: A Dataproc NodeGroup resource is a group of Dataproc cluster nodes that execute an assigned role. 
               Structure defined below.
        :param pulumi.Input[builtins.str] bucket: The name of the cloud storage bucket ultimately used to house the staging data
               for the cluster. If `staging_bucket` is specified, it will contain this value, otherwise
               it will be the auto generated name.
        ...
        :param pulumi.Input['ClusterClusterConfigSoftwareConfigArgs'] software_config: The config settings for software inside the cluster.
               Structure defined below.
        :param pulumi.Input[builtins.str] staging_bucket: The Cloud Storage staging bucket used to stage files,
               such as Hadoop jars, between client machines and the cluster.
               Note: If you don't explicitly specify a `staging_bucket`
               then GCP will auto create / assign one for you. However, you are not guaranteed
               an auto generated bucket which is solely dedicated to your cluster; it may be shared
               with other clusters in the same region/zone also choosing to use the auto generation
               option.
        :param pulumi.Input[builtins.str] temp_bucket: The Cloud Storage temp bucket used to store ephemeral cluster
               and jobs data, such as Spark and MapReduce history files.
               Note: If you don't explicitly specify a `temp_bucket` then GCP will auto create / assign one for you.
    ...
    def temp_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage temp bucket used to store ephemeral cluster
        and jobs data, such as Spark and MapReduce history files.
        Note: If you don't explicitly specify a `temp_bucket` then GCP will auto create / assign one for you.
    ...
    @temp_bucket.setter
    def temp_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterClusterConfigAutoscalingConfigArgsDict(TypedDict):
        policy_uri: pulumi.Input[builtins.str]
        """
...
class ClusterClusterConfigAutoscalingConfigArgs:
    def __init__(__self__, *,
                 policy_uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] policy_uri: The autoscaling policy used by the cluster.
    ...
    def policy_uri(self) -> pulumi.Input[builtins.str]:
        """
        The autoscaling policy used by the cluster.
    ...
    @policy_uri.setter
    def policy_uri(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ClusterClusterConfigAuxiliaryNodeGroupArgsDict(TypedDict):
        ...
        """
        node_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] node_group_id: A node group ID. Generated if not specified. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot begin or end with underscore or hyphen. Must consist of from 3 to 33 characters.
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: Node group roles. 
               One of `"DRIVER"`.
        :param pulumi.Input[builtins.str] name: The Node group resource name.
...
if not MYPY:
    class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigArgsDict(TypedDict):
        ...
        Disk Config
        """
        instance_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigArgs:
    def __init__(__self__, *,
                 ...
                 instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_names: List of auxiliary node group instance names which have been assigned to the cluster.
        :param pulumi.Input[builtins.str] machine_type: The name of a Google Compute Engine machine type
               to create for the node group. If not specified, GCP will default to a predetermined
               computed value (currently `n1-standard-4`).
        :param pulumi.Input[builtins.str] min_cpu_platform: The name of a minimum generation of CPU family
               for the node group. If not specified, GCP will default to a predetermined computed value
               for each zone. See [the guide](https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform)
               for details about which CPU families are available (and defaulted) for each zone.
        :param pulumi.Input[builtins.int] num_instances: Specifies the number of master nodes to create.
               Please set a number greater than 0. Node Group must have at least 1 instance.
        """
    ...
    def instance_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of auxiliary node group instance names which have been assigned to the cluster.
        """
    ...
    def instance_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigAcceleratorArgsDict(TypedDict):
        accelerator_count: pulumi.Input[builtins.int]
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigAcceleratorArgs:
    def __init__(__self__, *,
                 ...
                 accelerator_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] accelerator_count: The number of the accelerator cards of this type exposed to this instance. Often restricted to one of `1`, `2`, `4`, or `8`.
               
               
               - - -
        :param pulumi.Input[builtins.str] accelerator_type: The short name of the accelerator type to expose to this instance. For example, `nvidia-tesla-k80`.
        """
    ...
    def accelerator_count(self) -> pulumi.Input[builtins.int]:
        """
        The number of the accelerator cards of this type exposed to this instance. Often restricted to one of `1`, `2`, `4`, or `8`.
    ...
    def accelerator_count(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigDiskConfigArgsDict(TypedDict):
        boot_disk_size_gb: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        boot_disk_type: NotRequired[pulumi.Input[builtins.str]]
        """
        The disk type of the primary disk attached to each node.
        One of `"pd-ssd"` or `"pd-standard"`. Defaults to `"pd-standard"`.
        """
        local_ssd_interface: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        num_local_ssds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigDiskConfigArgs:
    def __init__(__self__, *,
                 ...
                 local_ssd_interface: Optional[pulumi.Input[builtins.str]] = None,
                 num_local_ssds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] boot_disk_size_gb: Size of the primary disk attached to each node, specified
               in GB. The primary disk contains the boot volume and system libraries, and the
               smallest allowed disk size is 10GB. GCP will default to a predetermined
               computed value if not set (currently 500GB). Note: If SSDs are not
               attached, it also contains the HDFS data blocks and Hadoop working directories.
        :param pulumi.Input[builtins.str] boot_disk_type: The disk type of the primary disk attached to each node.
               One of `"pd-ssd"` or `"pd-standard"`. Defaults to `"pd-standard"`.
        :param pulumi.Input[builtins.str] local_ssd_interface: Interface type of local SSDs (default is "scsi"). Valid values: "scsi" (Small Computer System Interface), "nvme" (Non-Volatile Memory Express).
        :param pulumi.Input[builtins.int] num_local_ssds: The amount of local SSD disks that will be attached to each master cluster node. 
               Defaults to 0.
        """
    ...
    def local_ssd_interface(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Interface type of local SSDs (default is "scsi"). Valid values: "scsi" (Small Computer System Interface), "nvme" (Non-Volatile Memory Express).
        """
    ...
    def local_ssd_interface(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_ssd_interface", value)

    @property
    @pulumi.getter(name="numLocalSsds")
    def num_local_ssds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of local SSD disks that will be attached to each master cluster node. 
        Defaults to 0.
        """
    ...
    def num_local_ssds(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ClusterClusterConfigDataprocMetricConfigMetricArgsDict(TypedDict):
        metric_source: pulumi.Input[builtins.str]
        """
        ...
        """
        metric_overrides: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ClusterClusterConfigDataprocMetricConfigMetricArgs:
    def __init__(__self__, *,
                 metric_source: pulumi.Input[builtins.str],
                 metric_overrides: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] metric_source: A source for the collection of Dataproc OSS metrics (see [available OSS metrics](https://cloud.google.com//dataproc/docs/guides/monitoring#available_oss_metrics)).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] metric_overrides: One or more [available OSS metrics] (https://cloud.google.com/dataproc/docs/guides/monitoring#available_oss_metrics) to collect for the metric course.
    ...
    def metric_source(self) -> pulumi.Input[builtins.str]:
        """
        A source for the collection of Dataproc OSS metrics (see [available OSS metrics](https://cloud.google.com//dataproc/docs/guides/monitoring#available_oss_metrics)).
        """
    ...
    def metric_source(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "metric_source", value)

    @property
    @pulumi.getter(name="metricOverrides")
    def metric_overrides(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more [available OSS metrics] (https://cloud.google.com/dataproc/docs/guides/monitoring#available_oss_metrics) to collect for the metric course.
    ...
    def metric_overrides(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ClusterClusterConfigEncryptionConfigArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: The Cloud KMS key name to use for PD disk encryption for
               all instances in the cluster.
...
if not MYPY:
    class ClusterClusterConfigEndpointConfigArgsDict(TypedDict):
        enable_http_port_access: pulumi.Input[builtins.bool]
        """
        The flag to enable http access to specific ports
        on the cluster from external sources (aka Component Gateway). Defaults to false.
        """
        http_ports: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ClusterClusterConfigEndpointConfigArgs:
    def __init__(__self__, *,
                 enable_http_port_access: pulumi.Input[builtins.bool],
                 http_ports: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_http_port_access: The flag to enable http access to specific ports
               on the cluster from external sources (aka Component Gateway). Defaults to false.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] http_ports: The map of port descriptions to URLs. Will only be populated if
               `enable_http_port_access` is true.
        """
    ...
    def enable_http_port_access(self) -> pulumi.Input[builtins.bool]:
        """
        The flag to enable http access to specific ports
        on the cluster from external sources (aka Component Gateway). Defaults to false.
        """
    ...
    def enable_http_port_access(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "enable_http_port_access", value)

    @property
    @pulumi.getter(name="httpPorts")
    def http_ports(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The map of port descriptions to URLs. Will only be populated if
        `enable_http_port_access` is true.
        """
    ...
    @http_ports.setter
    def http_ports(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ClusterClusterConfigGceClusterConfigArgsDict(TypedDict):
        ...
        """
        internal_ip_only: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        service_account_scopes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ClusterClusterConfigGceClusterConfigArgs:
    def __init__(__self__, *,
                 ...
                 internal_ip_only: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] internal_ip_only: By default, clusters are not restricted to internal IP addresses,
               and will have ephemeral external IP addresses assigned to each instance. If set to true, all
               instances in the cluster will only have internal IP addresses. Note: Private Google Access
               (also known as `privateIpGoogleAccess`) must be enabled on the subnetwork that the cluster
               will be launched in.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: A map of the Compute Engine metadata entries to add to all instances
               (see [Project and instance metadata](https://cloud.google.com/compute/docs/storing-retrieving-metadata#project_and_instance_metadata)).
        ...
        :param pulumi.Input[builtins.str] service_account: The service account to be used by the Node VMs.
               If not specified, the "default" service account is used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_account_scopes: The set of Google API scopes
               to be made available on all of the node VMs under the `service_account`
               specified. Both OAuth2 URLs and gcloud
               short names are supported. To allow full access to all Cloud APIs, use the
               `cloud-platform` scope. See a complete list of scopes [here](https://cloud.google.com/sdk/gcloud/reference/alpha/compute/instances/set-scopes#--scopes).
        ...
        :param pulumi.Input[builtins.str] subnetwork: The name or self_link of the Google Compute Engine
               subnetwork the cluster will be part of. Conflicts with `network`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The list of instance tags applied to instances in the cluster.
               Tags are used to identify valid sources or targets for network firewalls.
        :param pulumi.Input[builtins.str] zone: The GCP zone where your data is stored and used (i.e. where
               the master and the worker nodes will be created in). If `region` is set to 'global' (default)
               then `zone` is mandatory, otherwise GCP is able to make use of [Auto Zone Placement](https://cloud.google.com/dataproc/docs/concepts/auto-zone)
               to determine this automatically for you.
               Note: This setting additionally determines and restricts
    ...
    def internal_ip_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        By default, clusters are not restricted to internal IP addresses,
        and will have ephemeral external IP addresses assigned to each instance. If set to true, all
        instances in the cluster will only have internal IP addresses. Note: Private Google Access
    ...
    def internal_ip_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ClusterClusterConfigGceClusterConfigConfidentialInstanceConfigArgsDict(TypedDict):
        enable_confidential_compute: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ClusterClusterConfigGceClusterConfigConfidentialInstanceConfigArgs:
    def __init__(__self__, *,
                 enable_confidential_compute: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_confidential_compute: Defines whether the instance should have confidential compute enabled.
        """
    ...
    def enable_confidential_compute(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defines whether the instance should have confidential compute enabled.
        """
    ...
    def enable_confidential_compute(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ClusterClusterConfigGceClusterConfigNodeGroupAffinityArgsDict(TypedDict):
        node_group_uri: pulumi.Input[builtins.str]
        """
...
class ClusterClusterConfigGceClusterConfigNodeGroupAffinityArgs:
    def __init__(__self__, *,
                 node_group_uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] node_group_uri: The URI of a sole-tenant node group resource that the cluster will be created on.
        """
        pulumi.set(__self__, "node_group_uri", node_group_uri)

    @property
    @pulumi.getter(name="nodeGroupUri")
    def node_group_uri(self) -> pulumi.Input[builtins.str]:
        """
        The URI of a sole-tenant node group resource that the cluster will be created on.
        """
    ...
    def node_group_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "node_group_uri", value)


if not MYPY:
    class ClusterClusterConfigGceClusterConfigReservationAffinityArgsDict(TypedDict):
        consume_reservation_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterClusterConfigGceClusterConfigReservationAffinityArgs:
    def __init__(__self__, *,
                 consume_reservation_type: Optional[pulumi.Input[builtins.str]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] consume_reservation_type: Corresponds to the type of reservation consumption.
        :param pulumi.Input[builtins.str] key: Corresponds to the label key of reservation resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Corresponds to the label values of reservation resource.
        """
    ...
    def consume_reservation_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Corresponds to the type of reservation consumption.
        """
    ...
    def consume_reservation_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterClusterConfigGceClusterConfigShieldedInstanceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_integrity_monitoring: Defines whether instances have integrity monitoring enabled.
               
               - - -
        :param pulumi.Input[builtins.bool] enable_secure_boot: Defines whether instances have Secure Boot enabled.
        :param pulumi.Input[builtins.bool] enable_vtpm: Defines whether instances have the [vTPM](https://cloud.google.com/security/shielded-cloud/shielded-vm#vtpm) enabled.
        """
...
class ClusterClusterConfigInitializationActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] script: The script to be executed during initialization of the cluster.
               The script must be a GCS file with a gs:// prefix.
        :param pulumi.Input[builtins.int] timeout_sec: The maximum duration (in seconds) which `script` is
               allowed to take to execute its action. GCP will default to a predetermined
               computed value if not set (currently 300).
...
if not MYPY:
    class ClusterClusterConfigLifecycleConfigArgsDict(TypedDict):
        auto_delete_time: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        - - -
        """
        idle_delete_ttl: NotRequired[pulumi.Input[builtins.str]]
        """
        The duration to keep the cluster alive while idling
        (no jobs running). After this TTL, the cluster will be deleted. Valid range: [10m, 14d].
        """
        idle_start_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterClusterConfigLifecycleConfigArgs:
    def __init__(__self__, *,
                 auto_delete_time: Optional[pulumi.Input[builtins.str]] = None,
                 idle_delete_ttl: Optional[pulumi.Input[builtins.str]] = None,
                 idle_start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] auto_delete_time: The time when cluster will be auto-deleted.
               A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds.
               Example: "2014-10-02T15:01:23.045123456Z".
               
               - - -
        :param pulumi.Input[builtins.str] idle_delete_ttl: The duration to keep the cluster alive while idling
               (no jobs running). After this TTL, the cluster will be deleted. Valid range: [10m, 14d].
        :param pulumi.Input[builtins.str] idle_start_time: Time when the cluster became idle
               (most recent job finished) and became eligible for deletion due to idleness.
        """
    ...
    def auto_delete_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time when cluster will be auto-deleted.
        A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds.
        Example: "2014-10-02T15:01:23.045123456Z".
    ...
    def auto_delete_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_delete_time", value)

    @property
    @pulumi.getter(name="idleDeleteTtl")
    def idle_delete_ttl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The duration to keep the cluster alive while idling
        (no jobs running). After this TTL, the cluster will be deleted. Valid range: [10m, 14d].
        """
    ...
    def idle_delete_ttl(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idle_delete_ttl", value)

    @property
    @pulumi.getter(name="idleStartTime")
    def idle_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Time when the cluster became idle
        (most recent job finished) and became eligible for deletion due to idleness.
        """
    ...
    def idle_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterClusterConfigMasterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image_uri: The URI for the image to use for this worker.  See [the guide](https://cloud.google.com/dataproc/docs/guides/dataproc-images)
               for more information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_names: List of master instance names which
               have been assigned to the cluster.
        :param pulumi.Input[builtins.str] machine_type: The name of a Google Compute Engine machine type
               to create for the master. If not specified, GCP will default to a predetermined
               computed value (currently `n1-standard-4`).
...
class ClusterClusterConfigMasterConfigDiskConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] boot_disk_type: The disk type of the primary disk attached to each node.
               One of `"pd-ssd"` or `"pd-standard"`. Defaults to `"pd-standard"`.
        :param pulumi.Input[builtins.str] local_ssd_interface: Optional. Interface type of local SSDs (default is "scsi").
               Valid values: "scsi" (Small Computer System Interface), "nvme" (Non-Volatile
               Memory Express). See
               [local SSD performance](https://cloud.google.com/compute/docs/disks/local-ssd#performance).
        :param pulumi.Input[builtins.int] num_local_ssds: The amount of local SSD disks that will be
               attached to each master cluster node. Defaults to 0.
        """
        if boot_disk_size_gb is not None:
            pulumi.set(__self__, "boot_disk_size_gb", boot_disk_size_gb)
...
if not MYPY:
    class ClusterClusterConfigMetastoreConfigArgsDict(TypedDict):
        dataproc_metastore_service: pulumi.Input[builtins.str]
        """
        Resource name of an existing Dataproc Metastore service.
...
class ClusterClusterConfigMetastoreConfigArgs:
    def __init__(__self__, *,
                 dataproc_metastore_service: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] dataproc_metastore_service: Resource name of an existing Dataproc Metastore service.
    ...
    def dataproc_metastore_service(self) -> pulumi.Input[builtins.str]:
        """
        Resource name of an existing Dataproc Metastore service.
    ...
    def dataproc_metastore_service(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ClusterClusterConfigPreemptibleWorkerConfigArgsDict(TypedDict):
        ...
        Defaults to 0.
        """
        preemptibility: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterClusterConfigPreemptibleWorkerConfigArgs:
    def __init__(__self__, *,
                 ...
                 instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 num_instances: Optional[pulumi.Input[builtins.int]] = None,
                 preemptibility: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_names: List of preemptible instance names which have been assigned
               to the cluster.
        :param pulumi.Input[builtins.int] num_instances: Specifies the number of preemptible nodes to create.
               Defaults to 0.
        :param pulumi.Input[builtins.str] preemptibility: Specifies the preemptibility of the secondary workers. The default value is `PREEMPTIBLE`
               Accepted values are:
               * PREEMPTIBILITY_UNSPECIFIED
               * NON_PREEMPTIBLE
               * PREEMPTIBLE
    ...
    @property
    @pulumi.getter
    def preemptibility(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the preemptibility of the secondary workers. The default value is `PREEMPTIBLE`
        Accepted values are:
        * PREEMPTIBILITY_UNSPECIFIED
    ...
    def preemptibility(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterClusterConfigPreemptibleWorkerConfigDiskConfigArgs:
    def __init__(__self__, *,
                 ...
                 num_local_ssds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] boot_disk_size_gb: Size of the primary disk attached to each preemptible worker node, specified
               in GB. The smallest allowed disk size is 10GB. GCP will default to a predetermined
               computed value if not set (currently 500GB). Note: If SSDs are not
               attached, it also contains the HDFS data blocks and Hadoop working directories.
        :param pulumi.Input[builtins.str] boot_disk_type: The disk type of the primary disk attached to each preemptible worker node.
               One of `"pd-ssd"` or `"pd-standard"`. Defaults to `"pd-standard"`.
        :param pulumi.Input[builtins.str] local_ssd_interface: Interface type of local SSDs (default is "scsi"). Valid values: "scsi" (Small Computer System Interface), "nvme" (Non-Volatile Memory Express).
        :param pulumi.Input[builtins.int] num_local_ssds: The amount of local SSD disks that will be
               attached to each preemptible worker node. Defaults to 0.
...
if not MYPY:
    class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArgsDict(TypedDict):
        machine_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArgs:
    def __init__(__self__, *,
                 machine_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 rank: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] machine_types: Full machine-type names, e.g. `"n1-standard-16"`.
        :param pulumi.Input[builtins.int] rank: Preference of this instance selection. A lower number means higher preference. Dataproc will first try to create a VM based on the machine-type with priority rank and fallback to next rank based on availability. Machine types and instance selections with the same priority have the same preference.
        """
    ...
    def machine_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Full machine-type names, e.g. `"n1-standard-16"`.
        """
    ...
    def machine_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] machine_type: Full machine-type names, e.g. "n1-standard-16".
        :param pulumi.Input[builtins.int] vm_count: Number of VM provisioned with the machine_type.
        """
        if machine_type is not None:
            pulumi.set(__self__, "machine_type", machine_type)
...
if not MYPY:
    class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyProvisioningModelMixArgsDict(TypedDict):
        standard_capacity_base: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        standard_capacity_percent_above_base: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyProvisioningModelMixArgs:
    def __init__(__self__, *,
                 standard_capacity_base: Optional[pulumi.Input[builtins.int]] = None,
                 standard_capacity_percent_above_base: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] standard_capacity_base: The base capacity that will always use Standard VMs to avoid risk of more preemption than the minimum capacity you need. Dataproc will create only standard VMs until it reaches standardCapacityBase, then it will start using standardCapacityPercentAboveBase to mix Spot with Standard VMs. eg. If 15 instances are requested and standardCapacityBase is 5, Dataproc will create 5 standard VMs and then start mixing spot and standard VMs for remaining 10 instances.
        :param pulumi.Input[builtins.int] standard_capacity_percent_above_base: The percentage of target capacity that should use Standard VM. The remaining percentage will use Spot VMs. The percentage applies only to the capacity above standardCapacityBase. eg. If 15 instances are requested and standardCapacityBase is 5 and standardCapacityPercentAboveBase is 30, Dataproc will create 5 standard VMs and then start mixing spot and standard VMs for remaining 10 instances. The mix will be 30% standard and 70% spot.
               - - -
        """
    ...
    def standard_capacity_base(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The base capacity that will always use Standard VMs to avoid risk of more preemption than the minimum capacity you need. Dataproc will create only standard VMs until it reaches standardCapacityBase, then it will start using standardCapacityPercentAboveBase to mix Spot with Standard VMs. eg. If 15 instances are requested and standardCapacityBase is 5, Dataproc will create 5 standard VMs and then start mixing spot and standard VMs for remaining 10 instances.
        """
    ...
    def standard_capacity_base(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "standard_capacity_base", value)

    @property
    @pulumi.getter(name="standardCapacityPercentAboveBase")
    def standard_capacity_percent_above_base(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The percentage of target capacity that should use Standard VM. The remaining percentage will use Spot VMs. The percentage applies only to the capacity above standardCapacityBase. eg. If 15 instances are requested and standardCapacityBase is 5 and standardCapacityPercentAboveBase is 30, Dataproc will create 5 standard VMs and then start mixing spot and standard VMs for remaining 10 instances. The mix will be 30% standard and 70% spot.
        - - -
        """
    ...
    def standard_capacity_percent_above_base(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ClusterClusterConfigSecurityConfigKerberosConfigArgsDict(TypedDict):
        kms_key_uri: pulumi.Input[builtins.str]
        """
        The URI of the KMS key used to encrypt various sensitive files.
        """
        root_principal_password_uri: pulumi.Input[builtins.str]
        """
        The Cloud Storage URI of a KMS encrypted file
        containing the root principal password.
        """
        cross_realm_trust_admin_server: NotRequired[pulumi.Input[builtins.str]]
        """
        The admin server (IP or hostname) for the
        remote trusted realm in a cross realm trust relationship.
        """
        cross_realm_trust_kdc: NotRequired[pulumi.Input[builtins.str]]
        """
        The KDC (IP or hostname) for the
        remote trusted realm in a cross realm trust relationship.
        """
        cross_realm_trust_realm: NotRequired[pulumi.Input[builtins.str]]
        """
        The remote realm the Dataproc on-cluster KDC will
        trust, should the user enable cross realm trust.
        """
        cross_realm_trust_shared_password_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of a KMS
        encrypted file containing the shared password between the on-cluster Kerberos realm
        and the remote trusted realm, in a cross realm trust relationship.
        """
        enable_kerberos: NotRequired[pulumi.Input[builtins.bool]]
        """
        Flag to indicate whether to Kerberize the cluster.
        """
        kdc_db_key_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the master key of the KDC database.
        """
        key_password_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the password to the user provided key. For the self-signed certificate, this password
        is generated by Dataproc.
        """
        keystore_password_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the password to the user provided keystore. For the self-signed certificated, the password
        is generated by Dataproc.
        """
        keystore_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        tgt_lifetime_hours: NotRequired[pulumi.Input[builtins.int]]
        """
        The lifetime of the ticket granting ticket, in hours.
        """
        truststore_password_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of a KMS encrypted file
...
class ClusterClusterConfigSecurityConfigKerberosConfigArgs:
    def __init__(__self__, *,
                 kms_key_uri: pulumi.Input[builtins.str],
                 root_principal_password_uri: pulumi.Input[builtins.str],
                 cross_realm_trust_admin_server: Optional[pulumi.Input[builtins.str]] = None,
                 cross_realm_trust_kdc: Optional[pulumi.Input[builtins.str]] = None,
                 cross_realm_trust_realm: Optional[pulumi.Input[builtins.str]] = None,
                 cross_realm_trust_shared_password_uri: Optional[pulumi.Input[builtins.str]] = None,
                 enable_kerberos: Optional[pulumi.Input[builtins.bool]] = None,
                 kdc_db_key_uri: Optional[pulumi.Input[builtins.str]] = None,
                 key_password_uri: Optional[pulumi.Input[builtins.str]] = None,
                 keystore_password_uri: Optional[pulumi.Input[builtins.str]] = None,
                 keystore_uri: Optional[pulumi.Input[builtins.str]] = None,
                 realm: Optional[pulumi.Input[builtins.str]] = None,
                 tgt_lifetime_hours: Optional[pulumi.Input[builtins.int]] = None,
                 truststore_password_uri: Optional[pulumi.Input[builtins.str]] = None,
                 truststore_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] kms_key_uri: The URI of the KMS key used to encrypt various sensitive files.
        :param pulumi.Input[builtins.str] root_principal_password_uri: The Cloud Storage URI of a KMS encrypted file
               containing the root principal password.
        :param pulumi.Input[builtins.str] cross_realm_trust_admin_server: The admin server (IP or hostname) for the
               remote trusted realm in a cross realm trust relationship.
        :param pulumi.Input[builtins.str] cross_realm_trust_kdc: The KDC (IP or hostname) for the
               remote trusted realm in a cross realm trust relationship.
        :param pulumi.Input[builtins.str] cross_realm_trust_realm: The remote realm the Dataproc on-cluster KDC will
               trust, should the user enable cross realm trust.
        :param pulumi.Input[builtins.str] cross_realm_trust_shared_password_uri: The Cloud Storage URI of a KMS
               encrypted file containing the shared password between the on-cluster Kerberos realm
               and the remote trusted realm, in a cross realm trust relationship.
        :param pulumi.Input[builtins.bool] enable_kerberos: Flag to indicate whether to Kerberize the cluster.
        :param pulumi.Input[builtins.str] kdc_db_key_uri: The Cloud Storage URI of a KMS encrypted file containing
               the master key of the KDC database.
        :param pulumi.Input[builtins.str] key_password_uri: The Cloud Storage URI of a KMS encrypted file containing
               the password to the user provided key. For the self-signed certificate, this password
               is generated by Dataproc.
        :param pulumi.Input[builtins.str] keystore_password_uri: The Cloud Storage URI of a KMS encrypted file containing
               the password to the user provided keystore. For the self-signed certificated, the password
               is generated by Dataproc.
        :param pulumi.Input[builtins.str] keystore_uri: The Cloud Storage URI of the keystore file used for SSL encryption.
               If not provided, Dataproc will provide a self-signed certificate.
        :param pulumi.Input[builtins.str] realm: The name of the on-cluster Kerberos realm. If not specified, the
               uppercased domain of hostnames will be the realm.
        :param pulumi.Input[builtins.int] tgt_lifetime_hours: The lifetime of the ticket granting ticket, in hours.
        :param pulumi.Input[builtins.str] truststore_password_uri: The Cloud Storage URI of a KMS encrypted file
               containing the password to the user provided truststore. For the self-signed
               certificate, this password is generated by Dataproc.
        :param pulumi.Input[builtins.str] truststore_uri: The Cloud Storage URI of the truststore file used for
               SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
    ...
    def kms_key_uri(self) -> pulumi.Input[builtins.str]:
        """
        The URI of the KMS key used to encrypt various sensitive files.
        """
    ...
    @kms_key_uri.setter
    def kms_key_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "kms_key_uri", value)

    @property
    @pulumi.getter(name="rootPrincipalPasswordUri")
    def root_principal_password_uri(self) -> pulumi.Input[builtins.str]:
        """
        The Cloud Storage URI of a KMS encrypted file
        containing the root principal password.
        """
    ...
    def root_principal_password_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "root_principal_password_uri", value)

    @property
    @pulumi.getter(name="crossRealmTrustAdminServer")
    def cross_realm_trust_admin_server(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The admin server (IP or hostname) for the
        remote trusted realm in a cross realm trust relationship.
        """
    ...
    def cross_realm_trust_admin_server(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_realm_trust_admin_server", value)

    @property
    @pulumi.getter(name="crossRealmTrustKdc")
    def cross_realm_trust_kdc(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The KDC (IP or hostname) for the
        remote trusted realm in a cross realm trust relationship.
        """
    ...
    def cross_realm_trust_kdc(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_realm_trust_kdc", value)

    @property
    @pulumi.getter(name="crossRealmTrustRealm")
    def cross_realm_trust_realm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The remote realm the Dataproc on-cluster KDC will
        trust, should the user enable cross realm trust.
        """
    ...
    def cross_realm_trust_realm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_realm_trust_realm", value)

    @property
    @pulumi.getter(name="crossRealmTrustSharedPasswordUri")
    def cross_realm_trust_shared_password_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS
        encrypted file containing the shared password between the on-cluster Kerberos realm
        and the remote trusted realm, in a cross realm trust relationship.
    ...
    def cross_realm_trust_shared_password_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cross_realm_trust_shared_password_uri", value)

    @property
    @pulumi.getter(name="enableKerberos")
    def enable_kerberos(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Flag to indicate whether to Kerberize the cluster.
        """
    ...
    def enable_kerberos(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_kerberos", value)

    @property
    @pulumi.getter(name="kdcDbKeyUri")
    def kdc_db_key_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the master key of the KDC database.
        """
    ...
    def kdc_db_key_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kdc_db_key_uri", value)

    @property
    @pulumi.getter(name="keyPasswordUri")
    def key_password_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the password to the user provided key. For the self-signed certificate, this password
        is generated by Dataproc.
    ...
    def key_password_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "key_password_uri", value)

    @property
    @pulumi.getter(name="keystorePasswordUri")
    def keystore_password_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the password to the user provided keystore. For the self-signed certificated, the password
        is generated by Dataproc.
    ...
    def keystore_password_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "keystore_password_uri", value)

    @property
    @pulumi.getter(name="keystoreUri")
    def keystore_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of the keystore file used for SSL encryption.
        If not provided, Dataproc will provide a self-signed certificate.
        """
    ...
    @keystore_uri.setter
    def keystore_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tgt_lifetime_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The lifetime of the ticket granting ticket, in hours.
        """
    ...
    def tgt_lifetime_hours(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "tgt_lifetime_hours", value)

    @property
    @pulumi.getter(name="truststorePasswordUri")
    def truststore_password_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file
        containing the password to the user provided truststore. For the self-signed
        certificate, this password is generated by Dataproc.
    ...
    def truststore_password_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterClusterConfigSoftwareConfigArgsDict(TypedDict):
        ...
        """
        optional_components: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        - - -
        """
        override_properties: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ClusterClusterConfigSoftwareConfigArgs:
    def __init__(__self__, *,
                 ...
                 optional_components: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 override_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] image_version: The Cloud Dataproc image version to use
               for the cluster - this controls the sets of software versions
               installed onto the nodes when you create clusters. If not specified, defaults to the
               latest version. For a list of valid versions see
               [Cloud Dataproc versions](https://cloud.google.com/dataproc/docs/concepts/dataproc-versions)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] optional_components: The set of optional components to activate on the cluster. See [Available Optional Components](https://cloud.google.com/dataproc/docs/concepts/components/overview#available_optional_components).
               
               - - -
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] override_properties: A list of override and additional properties (key/value pairs)
               used to modify various aspects of the common configuration files used when creating
               a cluster. For a list of valid properties please see
               [Cluster properties](https://cloud.google.com/dataproc/docs/concepts/cluster-properties)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A list of the properties used to set the daemon config files.
               This will include any values supplied by the user via `cluster_config.software_config.override_properties`
        """
    ...
    def optional_components(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The set of optional components to activate on the cluster. See [Available Optional Components](https://cloud.google.com/dataproc/docs/concepts/components/overview#available_optional_components).
    ...
    def optional_components(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "optional_components", value)

    @property
    @pulumi.getter(name="overrideProperties")
    def override_properties(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A list of override and additional properties (key/value pairs)
        used to modify various aspects of the common configuration files used when creating
        a cluster. For a list of valid properties please see
    ...
    def override_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ClusterClusterConfigWorkerConfigArgsDict(TypedDict):
        ...
        for details about which CPU families are available (and defaulted) for each zone.
        """
        min_num_instances: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ClusterClusterConfigWorkerConfigArgs:
    def __init__(__self__, *,
                 ...
                 machine_type: Optional[pulumi.Input[builtins.str]] = None,
                 min_cpu_platform: Optional[pulumi.Input[builtins.str]] = None,
                 min_num_instances: Optional[pulumi.Input[builtins.int]] = None,
                 num_instances: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] image_uri: The URI for the image to use for this worker.  See [the guide](https://cloud.google.com/dataproc/docs/guides/dataproc-images)
               for more information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_names: List of worker instance names which have been assigned
               to the cluster.
        :param pulumi.Input[builtins.str] machine_type: The name of a Google Compute Engine machine type
               to create for the worker nodes. If not specified, GCP will default to a predetermined
               computed value (currently `n1-standard-4`).
        :param pulumi.Input[builtins.str] min_cpu_platform: The name of a minimum generation of CPU family
               ...
               for each zone. See [the guide](https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform)
               for details about which CPU families are available (and defaulted) for each zone.
        :param pulumi.Input[builtins.int] min_num_instances: The minimum number of primary worker instances to create.  If `min_num_instances` is set, cluster creation will succeed if the number of primary workers created is at least equal to the `min_num_instances` number.
        :param pulumi.Input[builtins.int] num_instances: Specifies the number of worker nodes to create.
               If not specified, GCP will default to a predetermined computed value (currently 2).
               There is currently a beta feature which allows you to run a
               [Single Node Cluster](https://cloud.google.com/dataproc/docs/concepts/single-node-clusters).
               In order to take advantage of this you need to set
    ...
    def min_num_instances(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minimum number of primary worker instances to create.  If `min_num_instances` is set, cluster creation will succeed if the number of primary workers created is at least equal to the `min_num_instances` number.
        """
    ...
    def min_num_instances(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ClusterClusterConfigWorkerConfigDiskConfigArgs:
    def __init__(__self__, *,
                 ...
                 num_local_ssds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] boot_disk_size_gb: Size of the primary disk attached to each worker node, specified
               in GB. The smallest allowed disk size is 10GB. GCP will default to a predetermined
               computed value if not set (currently 500GB). Note: If SSDs are not
               attached, it also contains the HDFS data blocks and Hadoop working directories.
        :param pulumi.Input[builtins.str] boot_disk_type: The disk type of the primary disk attached to each node.
...
if not MYPY:
    class ClusterVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfigArgsDict(TypedDict):
        dataproc_metastore_service: NotRequired[pulumi.Input[builtins.str]]
        """
        Resource name of an existing Dataproc Metastore service.
        """
elif False:
...
class ClusterVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfigArgs:
    def __init__(__self__, *,
                 dataproc_metastore_service: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] dataproc_metastore_service: Resource name of an existing Dataproc Metastore service.
        """
    ...
    @property
    @pulumi.getter(name="dataprocMetastoreService")
    def dataproc_metastore_service(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource name of an existing Dataproc Metastore service.
        """
        return pulumi.get(self, "dataproc_metastore_service")
    ...
    @dataproc_metastore_service.setter
    def dataproc_metastore_service(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dataproc_metastore_service", value)
...
if not MYPY:
    class ClusterVirtualClusterConfigKubernetesClusterConfigArgsDict(TypedDict):
        ...
        """
        kubernetes_namespace: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kubernetes_namespace: A namespace within the Kubernetes cluster to deploy into. 
               If this namespace does not exist, it is created.
               If it  exists, Dataproc verifies that another Dataproc VirtualCluster is not installed into it.
               If not specified, the name of the Dataproc Cluster is used.
        """
    ...
    def kubernetes_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A namespace within the Kubernetes cluster to deploy into. 
        If this namespace does not exist, it is created.
        If it  exists, Dataproc verifies that another Dataproc VirtualCluster is not installed into it.
    ...
    def kubernetes_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigArgsDict(TypedDict):
        gke_cluster_target: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigArgs:
    def __init__(__self__, *,
                 gke_cluster_target: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] gke_cluster_target: A target GKE cluster to deploy to. It must be in the same project and region as the Dataproc cluster 
               (the GKE cluster can be zonal or regional)
    ...
    def gke_cluster_target(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A target GKE cluster to deploy to. It must be in the same project and region as the Dataproc cluster 
        (the GKE cluster can be zonal or regional)
        """
    ...
    def gke_cluster_target(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetArgsDict(TypedDict):
        node_pool: pulumi.Input[builtins.str]
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] node_pool: The target GKE node pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: The roles associated with the GKE node pool. 
               One of `"DEFAULT"`, `"CONTROLLER"`, `"SPARK_DRIVER"` or `"SPARK_EXECUTOR"`.
    ...
    def node_pool(self) -> pulumi.Input[builtins.str]:
        """
        The target GKE node pool.
        """
    ...
    @node_pool.setter
    def node_pool(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigArgsDict(TypedDict):
        locations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: The list of Compute Engine zones where node pool nodes associated 
               with a Dataproc on GKE virtual cluster will be located.
               - - -
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigAutoscalingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_node_count: The maximum number of nodes in the node pool. Must be >= minNodeCount, and must be > 0.
        :param pulumi.Input[builtins.int] min_node_count: The minimum number of nodes in the node pool. Must be >= 0 and <= maxNodeCount.
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] local_ssd_count: The number of local SSD disks to attach to the node, 
               which is limited by the maximum number of disks allowable per zone.
        :param pulumi.Input[builtins.str] machine_type: The name of a Compute Engine machine type.
        ...
        :param pulumi.Input[builtins.bool] preemptible: Whether the nodes are created as preemptible VM instances. 
               Preemptible nodes cannot be used in a node pool with the CONTROLLER role or in the DEFAULT node pool if the
               CONTROLLER role is not assigned (the DEFAULT node pool will assume the CONTROLLER role).
        :param pulumi.Input[builtins.bool] spot: Spot flag for enabling Spot VM, which is a rebrand of the existing preemptible flag.
        """
...
if not MYPY:
    class ClusterVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfigArgsDict(TypedDict):
        component_version: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfigArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] component_version: The components that should be installed in this Dataproc cluster. The key must be a string from the   
               KubernetesComponent enumeration. The value is the version of the software to be installed. At least one entry must be specified.
               * **NOTE** : `component_version[SPARK]` is mandatory to set, or the creation of the cluster will fail.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: The properties to set on daemon config files. Property keys are specified in prefix:property format, 
               for example spark:spark.kubernetes.container.image.
        """
    ...
    def component_version(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        The components that should be installed in this Dataproc cluster. The key must be a string from the   
        KubernetesComponent enumeration. The value is the version of the software to be installed. At least one entry must be specified.
        * **NOTE** : `component_version[SPARK]` is mandatory to set, or the creation of the cluster will fail.
    ...
    def component_version(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class GdcApplicationEnvironmentSparkApplicationEnvironmentConfigArgsDict(TypedDict):
        default_properties: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        default_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GdcApplicationEnvironmentSparkApplicationEnvironmentConfigArgs:
    def __init__(__self__, *,
                 default_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 default_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] default_properties: A map of default Spark properties to apply to workloads in this application environment. These defaults may be overridden by per-application properties.
        :param pulumi.Input[builtins.str] default_version: The default Dataproc version to use for applications submitted to this application environment
        """
    ...
    def default_properties(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A map of default Spark properties to apply to workloads in this application environment. These defaults may be overridden by per-application properties.
        """
    ...
    def default_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class GdcServiceInstanceGdceClusterArgsDict(TypedDict):
        gdce_cluster: pulumi.Input[builtins.str]
        """
...
class GdcServiceInstanceGdceClusterArgs:
    def __init__(__self__, *,
                 gdce_cluster: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] gdce_cluster: Gdce cluster resource id.
        """
        pulumi.set(__self__, "gdce_cluster", gdce_cluster)

    @property
    @pulumi.getter(name="gdceCluster")
    def gdce_cluster(self) -> pulumi.Input[builtins.str]:
        """
        Gdce cluster resource id.
        """
    ...
    @gdce_cluster.setter
    def gdce_cluster(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class GdcSparkApplicationPysparkApplicationConfigArgsDict(TypedDict):
        main_python_file_uri: pulumi.Input[builtins.str]
        """
...
class GdcSparkApplicationPysparkApplicationConfigArgs:
    def __init__(__self__, *,
                 ...
                 python_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] main_python_file_uri: The HCFS URI of the main Python file to use as the driver. Must be a .py file.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver.  Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Python driver and tasks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] python_file_uris: HCFS file URIs of Python files to pass to the PySpark framework. Supported file types: .py, .egg, and .zip.
        """
        pulumi.set(__self__, "main_python_file_uri", main_python_file_uri)
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
    ...
    @property
    @pulumi.getter(name="mainPythonFileUri")
    def main_python_file_uri(self) -> pulumi.Input[builtins.str]:
        """
        The HCFS URI of the main Python file to use as the driver. Must be a .py file.
        """
        return pulumi.get(self, "main_python_file_uri")
    ...
    @main_python_file_uri.setter
    def main_python_file_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "main_python_file_uri", value)
...
class GdcSparkApplicationSparkApplicationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: `.jar`, `.tar`, `.tar.gz`, `.tgz`, and `.zip`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments that can be set as application properties, such as `--conf`, since a collision can occur that causes an incorrect application submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        :param pulumi.Input[builtins.str] main_class: The name of the driver main class. The jar file that contains the class must be in the classpath or specified in `jar_file_uris`.
        :param pulumi.Input[builtins.str] main_jar_file_uri: The HCFS URI of the jar file that contains the main class.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
...
if not MYPY:
    class GdcSparkApplicationSparkRApplicationConfigArgsDict(TypedDict):
        main_r_file_uri: pulumi.Input[builtins.str]
        """
...
class GdcSparkApplicationSparkRApplicationConfigArgs:
    def __init__(__self__, *,
                 ...
                 file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] main_r_file_uri: The HCFS URI of the main R file to use as the driver. Must be a .R file.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver.  Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        """
    ...
    @property
    @pulumi.getter(name="mainRFileUri")
    def main_r_file_uri(self) -> pulumi.Input[builtins.str]:
        """
        The HCFS URI of the main R file to use as the driver. Must be a .R file.
        """
        return pulumi.get(self, "main_r_file_uri")
    ...
    @main_r_file_uri.setter
    def main_r_file_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "main_r_file_uri", value)
...
if not MYPY:
    class GdcSparkApplicationSparkSqlApplicationConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        script_variables: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        Mapping of query variable names to values (equivalent to the Spark SQL command: SET `name="value";`).
        """
elif False:
...
class GdcSparkApplicationSparkSqlApplicationConfigArgs:
    def __init__(__self__, *,
                 ...
                 script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to be added to the Spark CLASSPATH.
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains SQL queries.
        :param pulumi.Input['GdcSparkApplicationSparkSqlApplicationConfigQueryListArgs'] query_list: Represents a list of queries.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] script_variables: Mapping of query variable names to values (equivalent to the Spark SQL command: SET `name="value";`).
        """
        if jar_file_uris is not None:
            pulumi.set(__self__, "jar_file_uris", jar_file_uris)
        if query_file_uri is not None:
    ...
    def script_variables(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Mapping of query variable names to values (equivalent to the Spark SQL command: SET `name="value";`).
        """
    ...
    def script_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "script_variables", value)


if not MYPY:
    class GdcSparkApplicationSparkSqlApplicationConfigQueryListArgsDict(TypedDict):
        queries: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        The queries to run.
        """
elif False:
...
class GdcSparkApplicationSparkSqlApplicationConfigQueryListArgs:
    def __init__(__self__, *,
                 queries: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] queries: The queries to run.
        """
        pulumi.set(__self__, "queries", queries)

    @property
    @pulumi.getter
    def queries(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The queries to run.
        """
    ...
    @queries.setter
    def queries(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class JobHadoopConfigArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted in the working directory of .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments, such as -libjars or -Dfoo=bar, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be copied to the working directory of Hadoop drivers and distributed tasks. Useful for naively parallel tasks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Spark driver and tasks.
        :param pulumi.Input['JobHadoopConfigLoggingConfigArgs'] logging_config: The runtime logging config of the job
        :param pulumi.Input[builtins.str] main_class: The name of the driver's main class. The jar file containing the class must be in the default CLASSPATH or specified in `jar_file_uris`. Conflicts with `main_jar_file_uri`
        :param pulumi.Input[builtins.str] main_jar_file_uri: The HCFS URI of the jar file containing the main class. Examples: 'gs://foo-bucket/analytics-binaries/extract-useful-metrics-mr.jar' 'hdfs:/tmp/test-samples/custom-wordcount.jar' 'file:///home/usr/lib/hadoop-mapreduce/hadoop-mapreduce-examples.jar'. Conflicts with `main_class`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure Hadoop. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/hadoop/conf/*-site` and classes in user code..
...
if not MYPY:
    class JobHadoopConfigLoggingConfigArgsDict(TypedDict):
        driver_log_levels: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
...
class JobHadoopConfigLoggingConfigArgs:
    def __init__(__self__, *,
                 driver_log_levels: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] driver_log_levels: Optional. The per-package log levels for the driver. This may include 'root' package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'.
        """
        pulumi.set(__self__, "driver_log_levels", driver_log_levels)

    @property
    @pulumi.getter(name="driverLogLevels")
    def driver_log_levels(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        Optional. The per-package log levels for the driver. This may include 'root' package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'.
        """
    ...
    def driver_log_levels(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
        pulumi.set(self, "driver_log_levels", value)


if not MYPY:
    class JobHiveConfigArgsDict(TypedDict):
        continue_on_failure: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        query_lists: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class JobHiveConfigArgs:
    def __init__(__self__, *,
                 continue_on_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 jar_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 query_file_uri: Optional[pulumi.Input[builtins.str]] = None,
                 query_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] continue_on_failure: Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries. Defaults to false.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATH of the Hive server and Hadoop MapReduce (MR) tasks. Can contain Hive SerDes and UDFs.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names and values, used to configure Hive. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/hadoop/conf/*-site.xml`, `/etc/hive/conf/hive-site.xml`, and classes in user code..
        :param pulumi.Input[builtins.str] query_file_uri: HCFS URI of file containing Hive script to execute as the job.
               Conflicts with `query_list`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_lists: The list of Hive queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] script_variables: Mapping of query variable names to values (equivalent to the Hive command: `SET name="value";`).
        """
    ...
    def continue_on_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries. Defaults to false.
        """
    ...
    def continue_on_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def query_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of Hive queries or statements to execute as part of the job.
        Conflicts with `query_file_uri`
        """
    ...
    @query_lists.setter
    def query_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class JobPigConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] continue_on_failure: Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries. Defaults to false.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATH of the Pig Client and Hadoop MapReduce (MR) tasks. Can contain Pig UDFs.
               
               * `logging_config.driver_log_levels`- (Required) The per-package log levels for the driver. This may include 'root' package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'
        :param pulumi.Input['JobPigConfigLoggingConfigArgs'] logging_config: The runtime logging config of the job
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure Pig. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/hadoop/conf/*-site.xml`, `/etc/pig/conf/pig.properties`, and classes in user code.
        :param pulumi.Input[builtins.str] query_file_uri: HCFS URI of file containing Hive script to execute as the job.
               Conflicts with `query_list`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_lists: The list of Hive queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] script_variables: Mapping of query variable names to values (equivalent to the Pig command: `name=[value]`).
        """
        if continue_on_failure is not None:
            pulumi.set(__self__, "continue_on_failure", continue_on_failure)
        if jar_file_uris is not None:
...
class JobPlacementArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cluster_name: The name of the cluster where the job will be submitted
        :param pulumi.Input[builtins.str] cluster_uuid: Output-only. A cluster UUID generated by the Cloud Dataproc service when the job is submitted
        """
...
if not MYPY:
    class JobPrestoConfigArgsDict(TypedDict):
        client_tags: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class JobPrestoConfigArgs:
    def __init__(__self__, *,
                 client_tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 continue_on_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 query_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_tags: Presto client tags to attach to this query.
        :param pulumi.Input[builtins.bool] continue_on_failure: Whether to continue executing queries if a query fails. Setting to true can be useful when executing independent parallel queries. Defaults to false.
        :param pulumi.Input['JobPrestoConfigLoggingConfigArgs'] logging_config: The runtime logging config of the job
        :param pulumi.Input[builtins.str] output_format: The format in which query output will be displayed. See the Presto documentation for supported output formats.
               
               * `logging_config.driver_log_levels`- (Required) The per-package log levels for the driver. This may include 'root' package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values. Used to set Presto session properties Equivalent to using the --session flag in the Presto CLI.
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains SQL queries.
               Conflicts with `query_list`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_lists: The list of SQL queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
        """
    ...
    def client_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Presto client tags to attach to this query.
        """
    ...
    @client_tags.setter
    def client_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class JobPysparkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] main_python_file_uri: The HCFS URI of the main Python file to use as the driver. Must be a .py file.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted in the working directory of .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be copied to the working directory of Python drivers and distributed tasks. Useful for naively parallel tasks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Python driver and tasks.
        :param pulumi.Input['JobPysparkConfigLoggingConfigArgs'] logging_config: The runtime logging config of the job
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure PySpark. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/spark/conf/spark-defaults.conf` and classes in user code.
...
class JobReferenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] job_id: The job ID, which must be unique within the project. The job ID is generated by the server upon job submission or provided by the user as a means to perform retries without creating duplicate jobs
        """
...
if not MYPY:
    class JobSchedulingArgsDict(TypedDict):
        max_failures_per_hour: pulumi.Input[builtins.int]
        """
        Maximum number of times per hour a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed.
        """
        max_failures_total: pulumi.Input[builtins.int]
        """
...
class JobSchedulingArgs:
    def __init__(__self__, *,
                 ...
                 max_failures_total: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_failures_per_hour: Maximum number of times per hour a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed.
        :param pulumi.Input[builtins.int] max_failures_total: Maximum number of times in total a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed.
        """
    ...
    def max_failures_per_hour(self) -> pulumi.Input[builtins.int]:
        """
        Maximum number of times per hour a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed.
        """
    ...
    def max_failures_per_hour(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "max_failures_per_hour", value)

    @property
    @pulumi.getter(name="maxFailuresTotal")
    def max_failures_total(self) -> pulumi.Input[builtins.int]:
        """
        Maximum number of times in total a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed.
        """
    ...
    def max_failures_total(self, value: pulumi.Input[builtins.int]):
...
class JobSparkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted in the working directory of .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be copied to the working directory of Spark drivers and distributed tasks. Useful for naively parallel tasks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Spark driver and tasks.
        :param pulumi.Input['JobSparkConfigLoggingConfigArgs'] logging_config: The runtime logging config of the job
        :param pulumi.Input[builtins.str] main_class: The class containing the main method of the driver. Must be in a
               provided jar or jar that is already on the classpath. Conflicts with `main_jar_file_uri`
        :param pulumi.Input[builtins.str] main_jar_file_uri: The HCFS URI of jar file containing
               the driver jar. Conflicts with `main_class`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure Spark. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/spark/conf/spark-defaults.conf` and classes in user code.
...
class JobSparksqlConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure Spark SQL's SparkConf. Properties that conflict with values set by the Cloud Dataproc API may be overwritten.
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains SQL queries.
               Conflicts with `query_list`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_lists: The list of SQL queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
...
if not MYPY:
    class JobStatusArgsDict(TypedDict):
        ...
        """
        substate: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobStatusArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 state_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 substate: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] details: Optional job state details, such as an error description if the state is ERROR.
        :param pulumi.Input[builtins.str] state: A state message specifying the overall job state.
        :param pulumi.Input[builtins.str] state_start_time: The time when this state was entered.
        :param pulumi.Input[builtins.str] substate: Additional state information, which includes status reported by the agent.
        """
    ...
    @property
    @pulumi.getter
    def substate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Additional state information, which includes status reported by the agent.
        """
    ...
    @substate.setter
    def substate(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class MetastoreFederationBackendMetastoreArgsDict(TypedDict):
        metastore_type: pulumi.Input[builtins.str]
        """
        ...
        """
        rank: pulumi.Input[builtins.str]
        """
...
class MetastoreFederationBackendMetastoreArgs:
    ...
    def metastore_type(self) -> pulumi.Input[builtins.str]:
        """
        The type of the backend metastore.
        Possible values are: `METASTORE_TYPE_UNSPECIFIED`, `DATAPROC_METASTORE`, `BIGQUERY`.
    ...
    def metastore_type(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def rank(self) -> pulumi.Input[builtins.str]:
        """
        The identifier for this object. Format specified above.
        """
        return pulumi.get(self, "rank")
    ...
    @rank.setter
    def rank(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rank", value)
...
class MetastoreServiceEncryptionConfigArgs:
    def __init__(__self__, *,
                 kms_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key: The fully qualified customer provided Cloud KMS key name to use for customer data encryption.
               Use the following format: `projects/([^/]+)/locations/([^/]+)/keyRings/([^/]+)/cryptoKeys/([^/]+)`
        """
        pulumi.set(__self__, "kms_key", kms_key)
...
if not MYPY:
    class MetastoreServiceHiveMetastoreConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        config_overrides: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        A mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore (configured in hive-site.xml).
        The mappings override system defaults (some keys cannot be overridden)
        """
        endpoint_protocol: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MetastoreServiceHiveMetastoreConfigArgs:
    def __init__(__self__, *,
                 ...
                 config_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 endpoint_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 kerberos_config: Optional[pulumi.Input['MetastoreServiceHiveMetastoreConfigKerberosConfigArgs']] = None):
        """
        :param pulumi.Input[builtins.str] version: The Hive metastore schema version.
        :param pulumi.Input[Sequence[pulumi.Input['MetastoreServiceHiveMetastoreConfigAuxiliaryVersionArgs']]] auxiliary_versions: A mapping of Hive metastore version to the auxiliary version configuration.
               ...
               This means that the first character must be a lowercase letter, and all the following characters must be hyphens, lowercase letters, or digits, except the last character, which cannot be a hyphen.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] config_overrides: A mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore (configured in hive-site.xml).
               The mappings override system defaults (some keys cannot be overridden)
        :param pulumi.Input[builtins.str] endpoint_protocol: The protocol to use for the metastore service endpoint. If unspecified, defaults to `THRIFT`.
               Default value is `THRIFT`.
               Possible values are: `THRIFT`, `GRPC`.
    ...
    def config_overrides(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore (configured in hive-site.xml).
        The mappings override system defaults (some keys cannot be overridden)
        """
    ...
    def config_overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "config_overrides", value)

    @property
    @pulumi.getter(name="endpointProtocol")
    def endpoint_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The protocol to use for the metastore service endpoint. If unspecified, defaults to `THRIFT`.
        Default value is `THRIFT`.
        Possible values are: `THRIFT`, `GRPC`.
    ...
    def endpoint_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MetastoreServiceHiveMetastoreConfigAuxiliaryVersionArgs:
    def __init__(__self__, *,
                 ...
                 config_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] key: The identifier for this object. Format specified above.
        :param pulumi.Input[builtins.str] version: The Hive metastore version of the auxiliary service. It must be less than the primary Hive metastore service's version.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] config_overrides: A mapping of Hive metastore configuration key-value pairs to apply to the auxiliary Hive metastore (configured in hive-site.xml) in addition to the primary version's overrides.
               If keys are present in both the auxiliary version's overrides and the primary version's overrides, the value from the auxiliary version's overrides takes precedence.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "version", version)
...
if not MYPY:
    class MetastoreServiceHiveMetastoreConfigKerberosConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        krb5_config_gcs_uri: pulumi.Input[builtins.str]
        """
...
class MetastoreServiceHiveMetastoreConfigKerberosConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['MetastoreServiceHiveMetastoreConfigKerberosConfigKeytabArgs'] keytab: A Kerberos keytab file that can be used to authenticate a service principal with a Kerberos Key Distribution Center (KDC).
               Structure is documented below.
        :param pulumi.Input[builtins.str] krb5_config_gcs_uri: A Cloud Storage URI that specifies the path to a krb5.conf file. It is of the form gs://{bucket_name}/path/to/krb5.conf, although the file does not need to be named krb5.conf explicitly.
        :param pulumi.Input[builtins.str] principal: A Kerberos principal that exists in the both the keytab the KDC to authenticate as. A typical principal is of the form "primary/instance@REALM", but there is no exact format.
        """
    ...
    def krb5_config_gcs_uri(self) -> pulumi.Input[builtins.str]:
        """
        A Cloud Storage URI that specifies the path to a krb5.conf file. It is of the form gs://{bucket_name}/path/to/krb5.conf, although the file does not need to be named krb5.conf explicitly.
        """
    ...
    def krb5_config_gcs_uri(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class MetastoreServiceHiveMetastoreConfigKerberosConfigKeytabArgsDict(TypedDict):
        cloud_secret: pulumi.Input[builtins.str]
        """
...
class MetastoreServiceHiveMetastoreConfigKerberosConfigKeytabArgs:
    def __init__(__self__, *,
                 cloud_secret: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] cloud_secret: The relative resource name of a Secret Manager secret version, in the following form:
               "projects/{projectNumber}/secrets/{secret_id}/versions/{version_id}".
        """
    ...
    def cloud_secret(self) -> pulumi.Input[builtins.str]:
        """
        The relative resource name of a Secret Manager secret version, in the following form:
        "projects/{projectNumber}/secrets/{secret_id}/versions/{version_id}".
        """
    ...
    @cloud_secret.setter
    def cloud_secret(self, value: pulumi.Input[builtins.str]):
...
class MetastoreServiceMaintenanceWindowArgs:
    def __init__(__self__, *,
                 ...
                 hour_of_day: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] day_of_week: The day of week, when the window starts.
               Possible values are: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        :param pulumi.Input[builtins.int] hour_of_day: The hour of day (0-23) when the window starts.
        """
...
class MetastoreServiceMetadataIntegrationDataCatalogConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
        """
...
if not MYPY:
    class MetastoreServiceNetworkConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        custom_routes_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class MetastoreServiceNetworkConfigArgs:
    def __init__(__self__, *,
                 ...
                 custom_routes_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['MetastoreServiceNetworkConfigConsumerArgs']]] consumers: The consumer-side network configuration for the Dataproc Metastore instance.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] custom_routes_enabled: Enables custom routes to be imported and exported for the Dataproc Metastore service's peered VPC network.
        """
    ...
    def custom_routes_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables custom routes to be imported and exported for the Dataproc Metastore service's peered VPC network.
        """
    ...
    def custom_routes_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class MetastoreServiceNetworkConfigConsumerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] subnetwork: The subnetwork of the customer project from which an IP address is reserved and used as the Dataproc Metastore service's endpoint.
               It is accessible to hosts in the subnet and to all hosts in a subnet in the same region and same network.
               There must be at least one IP address available in the subnet's primary range. The subnet is specified in the following form:
               `projects/{projectNumber}/regions/{region_id}/subnetworks/{subnetwork_id}
        :param pulumi.Input[builtins.str] endpoint_uri: (Output)
               The URI of the endpoint used to access the metastore service.
        """
        pulumi.set(__self__, "subnetwork", subnetwork)
...
if not MYPY:
    class MetastoreServiceScalingConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        instance_size: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MetastoreServiceScalingConfigArgs:
    def __init__(__self__, *,
                 ...
                 instance_size: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['MetastoreServiceScalingConfigAutoscalingConfigArgs'] autoscaling_config: Represents the autoscaling configuration of a metastore service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] instance_size: Metastore instance sizes.
               Possible values are: `EXTRA_SMALL`, `SMALL`, `MEDIUM`, `LARGE`, `EXTRA_LARGE`.
        :param pulumi.Input[builtins.float] scaling_factor: Scaling factor, in increments of 0.1 for values less than 1.0, and increments of 1.0 for values greater than 1.0.
        """
        if autoscaling_config is not None:
            pulumi.set(__self__, "autoscaling_config", autoscaling_config)
    ...
    def instance_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Metastore instance sizes.
        Possible values are: `EXTRA_SMALL`, `SMALL`, `MEDIUM`, `LARGE`, `EXTRA_LARGE`.
        """
    ...
    def instance_size(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class MetastoreServiceScalingConfigAutoscalingConfigArgsDict(TypedDict):
        autoscaling_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Defines whether autoscaling is enabled. The default value is false.
        """
        autoscaling_factor: NotRequired[pulumi.Input[builtins.float]]
        """
        (Output)
...
class MetastoreServiceScalingConfigAutoscalingConfigArgs:
    def __init__(__self__, *,
                 ...
                 autoscaling_factor: Optional[pulumi.Input[builtins.float]] = None,
                 limit_config: Optional[pulumi.Input['MetastoreServiceScalingConfigAutoscalingConfigLimitConfigArgs']] = None):
        """
        :param pulumi.Input[builtins.bool] autoscaling_enabled: Defines whether autoscaling is enabled. The default value is false.
        :param pulumi.Input[builtins.float] autoscaling_factor: (Output)
               Output only. The scaling factor of a service with autoscaling enabled.
    ...
    def autoscaling_factor(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        (Output)
        Output only. The scaling factor of a service with autoscaling enabled.
        """
    ...
    def autoscaling_factor(self, value: Optional[pulumi.Input[builtins.float]]):
...
if not MYPY:
    class MetastoreServiceScalingConfigAutoscalingConfigLimitConfigArgsDict(TypedDict):
        max_scaling_factor: NotRequired[pulumi.Input[builtins.float]]
        """
        The maximum scaling factor that the service will autoscale to. The default value is 6.0.
        """
        min_scaling_factor: NotRequired[pulumi.Input[builtins.float]]
        """
...
class MetastoreServiceScalingConfigAutoscalingConfigLimitConfigArgs:
    def __init__(__self__, *,
                 max_scaling_factor: Optional[pulumi.Input[builtins.float]] = None,
                 min_scaling_factor: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.float] max_scaling_factor: The maximum scaling factor that the service will autoscale to. The default value is 6.0.
        :param pulumi.Input[builtins.float] min_scaling_factor: The minimum scaling factor that the service will autoscale to. The default value is 0.1.
        """
    ...
    def max_scaling_factor(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum scaling factor that the service will autoscale to. The default value is 6.0.
        """
    ...
    def max_scaling_factor(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "max_scaling_factor", value)

    @property
    @pulumi.getter(name="minScalingFactor")
    def min_scaling_factor(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The minimum scaling factor that the service will autoscale to. The default value is 0.1.
        """
    ...
    def min_scaling_factor(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "min_scaling_factor", value)


if not MYPY:
    class MetastoreServiceScheduledBackupArgsDict(TypedDict):
        backup_location: pulumi.Input[builtins.str]
        """
        ...
        """
        cron_schedule: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MetastoreServiceScheduledBackupArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] backup_location: A Cloud Storage URI of a folder, in the format gs://<bucket_name>/<path_inside_bucket>. A sub-folder <backup_folder> containing backup files will be stored below it.
        :param pulumi.Input[builtins.str] cron_schedule: The scheduled interval in Cron format, see https://en.wikipedia.org/wiki/Cron The default is empty: scheduled backup is not enabled. Must be specified to enable scheduled backups.
        :param pulumi.Input[builtins.bool] enabled: Defines whether the scheduled backup is enabled. The default value is false.
        :param pulumi.Input[builtins.str] time_zone: Specifies the time zone to be used when interpreting cronSchedule. Must be a time zone name from the time zone database (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones), e.g. America/Los_Angeles or Africa/Abidjan. If left unspecified, the default is UTC.
        """
    ...
    def backup_location(self) -> pulumi.Input[builtins.str]:
        """
        A Cloud Storage URI of a folder, in the format gs://<bucket_name>/<path_inside_bucket>. A sub-folder <backup_folder> containing backup files will be stored below it.
        """
    ...
    def backup_location(self, value: pulumi.Input[builtins.str]):
...
class MetastoreServiceTelemetryConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] log_format: The output format of the Dataproc Metastore service's logs.
               Default value is `JSON`.
               Possible values are: `LEGACY`, `JSON`.
        """
...
class WorkflowTemplateEncryptionConfigArgs:
    def __init__(__self__, *,
                 kms_key: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] kms_key: Optional. The Cloud KMS key name to use for encryption.
        """
        if kms_key is not None:
            pulumi.set(__self__, "kms_key", kms_key)
...
if not MYPY:
    class WorkflowTemplateJobArgsDict(TypedDict):
        step_id: pulumi.Input[builtins.str]
        """
        ...
        Job is a Pig job.
        """
        prerequisite_step_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class WorkflowTemplateJobArgs:
    def __init__(__self__, *,
                 ...
                 prerequisite_step_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] step_id: Required. The step id. The id must be unique among all jobs within the template. The step id is used as prefix for job id, as job `goog-dataproc-workflow-step-id` label, and in field from other steps. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot begin or end with underscore or hyphen. Must consist of between 3 and 50 characters.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The labels to associate with this job. Label keys must be between 1 and 63 characters long, and must conform to the following regular expression: {0,63} No more than 32 labels can be associated with a given job.
        :param pulumi.Input['WorkflowTemplateJobPigJobArgs'] pig_job: Job is a Pig job.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prerequisite_step_ids: The optional list of prerequisite job step_ids. If not specified, the job will start at the beginning of workflow.
    ...
    def step_id(self) -> pulumi.Input[builtins.str]:
        """
        Required. The step id. The id must be unique among all jobs within the template. The step id is used as prefix for job id, as job `goog-dataproc-workflow-step-id` label, and in field from other steps. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot begin or end with underscore or hyphen. Must consist of between 3 and 50 characters.
        """
    ...
    @step_id.setter
    def step_id(self, value: pulumi.Input[builtins.str]):
    ...
    def prerequisite_step_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The optional list of prerequisite job step_ids. If not specified, the job will start at the beginning of workflow.
        """
    ...
    def prerequisite_step_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class WorkflowTemplateJobHadoopJobArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted in the working directory of Hadoop drivers and tasks. Supported file types: .jar, .tar, .tar.gz, .tgz, or .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments, such as `-libjars` or `-Dfoo=bar`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS (Hadoop Compatible Filesystem) URIs of files to be copied to the working directory of Hadoop drivers and distributed tasks. Useful for naively parallel tasks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: Jar file URIs to add to the CLASSPATHs of the Hadoop driver and tasks.
        :param pulumi.Input['WorkflowTemplateJobHadoopJobLoggingConfigArgs'] logging_config: The runtime log config for job execution.
        :param pulumi.Input[builtins.str] main_class: The name of the driver's main class. The jar file containing the class must be in the default CLASSPATH or specified in `jar_file_uris`.
        :param pulumi.Input[builtins.str] main_jar_file_uri: The HCFS URI of the jar file containing the main class. Examples: 'gs://foo-bucket/analytics-binaries/extract-useful-metrics-mr.jar' 'hdfs:/tmp/test-samples/custom-wordcount.jar' 'file:///home/usr/lib/hadoop-mapreduce/hadoop-mapreduce-examples.jar'
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure Hadoop. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/hadoop/conf/*-site and classes in user code.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
...
if not MYPY:
    class WorkflowTemplateJobHadoopJobLoggingConfigArgsDict(TypedDict):
        driver_log_levels: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class WorkflowTemplateJobHadoopJobLoggingConfigArgs:
    def __init__(__self__, *,
                 driver_log_levels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] driver_log_levels: The per-package log levels for the driver. This may include "root" package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'
        """
    ...
    @property
    @pulumi.getter(name="driverLogLevels")
    def driver_log_levels(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The per-package log levels for the driver. This may include "root" package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'
        """
        return pulumi.get(self, "driver_log_levels")
    ...
    @driver_log_levels.setter
    def driver_log_levels(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "driver_log_levels", value)
...
class WorkflowTemplateJobHiveJobArgs:
    def __init__(__self__, *,
                 ...
                 script_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] continue_on_failure: Whether to continue executing queries if a query fails. The default value is `false`. Setting to `true` can be useful when executing independent parallel queries.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATH of the Hive server and Hadoop MapReduce (MR) tasks. Can contain Hive SerDes and UDFs.
        ...
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains Hive queries.
...
class WorkflowTemplateJobHiveJobQueryListArgs:
    def __init__(__self__, *,
                 queries: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] queries: Required. The queries to execute. You do not need to end a query expression with a semicolon. Multiple queries can be specified in one string by separating each with a semicolon. Here is an example of a Dataproc API snippet that uses a QueryList to specify a HiveJob: "hiveJob": { "queryList": { "queries": } }
        """
        pulumi.set(__self__, "queries", queries)
...
class WorkflowTemplateJobPigJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains the Pig queries.
        :param pulumi.Input['WorkflowTemplateJobPigJobQueryListArgs'] query_list: A list of queries.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] script_variables: Mapping of query variable names to values (equivalent to the Pig command: `name=`).
        """
        if continue_on_failure is not None:
            pulumi.set(__self__, "continue_on_failure", continue_on_failure)
        if jar_file_uris is not None:
...
class WorkflowTemplateJobPrestoJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] output_format: The format in which query output will be displayed. See the Presto documentation for supported output formats
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values. Used to set Presto (https://prestodb.io/docs/current/sql/set-session.html) Equivalent to using the --session flag in the Presto CLI
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains SQL queries.
...
class WorkflowTemplateJobPysparkJobArgs:
    def __init__(__self__, *,
                 ...
                 python_file_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] main_python_file_uri: Required. The HCFS URI of the main Python file to use as the driver. Must be a .py file.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Python driver and tasks.
...
if not MYPY:
    class WorkflowTemplateJobSchedulingArgsDict(TypedDict):
        max_failures_per_hour: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        max_failures_total: NotRequired[pulumi.Input[builtins.int]]
        """
...
class WorkflowTemplateJobSchedulingArgs:
    def __init__(__self__, *,
                 max_failures_per_hour: Optional[pulumi.Input[builtins.int]] = None,
                 max_failures_total: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] max_failures_per_hour: Maximum number of times per hour a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed. A job may be reported as thrashing if driver exits with non-zero code 4 times within 10 minute window. Maximum value is 10.
        :param pulumi.Input[builtins.int] max_failures_total: Maximum number of times in total a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed. Maximum value is 240
        """
    ...
    @property
    @pulumi.getter(name="maxFailuresPerHour")
    def max_failures_per_hour(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum number of times per hour a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed. A job may be reported as thrashing if driver exits with non-zero code 4 times within 10 minute window. Maximum value is 10.
        """
        return pulumi.get(self, "max_failures_per_hour")
    ...
    @max_failures_per_hour.setter
    def max_failures_per_hour(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_failures_per_hour", value)

    @property
    @pulumi.getter(name="maxFailuresTotal")
    def max_failures_total(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum number of times in total a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed. Maximum value is 240
        """
        return pulumi.get(self, "max_failures_total")
    ...
    @max_failures_total.setter
    def max_failures_total(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_failures_total", value)
...
class WorkflowTemplateJobSparkJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] main_class: The name of the driver's main class. The jar file that contains the class must be in the default CLASSPATH or specified in `jar_file_uris`.
        :param pulumi.Input[builtins.str] main_jar_file_uri: The HCFS URI of the jar file that contains the main class.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure Spark. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/spark/conf/spark-defaults.conf and classes in user code.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
...
class WorkflowTemplateJobSparkRJobArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] main_r_file_uri: Required. The HCFS URI of the main R file to use as the driver. Must be a .R file.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: The arguments to pass to the driver. Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        :param pulumi.Input['WorkflowTemplateJobSparkRJobLoggingConfigArgs'] logging_config: The runtime log config for job execution.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure SparkR. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/spark/conf/spark-defaults.conf and classes in user code.
        """
        pulumi.set(__self__, "main_r_file_uri", main_r_file_uri)
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
...
class WorkflowTemplateJobSparkSqlJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A mapping of property names to values, used to configure Spark SQL's SparkConf. Properties that conflict with values set by the Dataproc API may be overwritten.
        :param pulumi.Input[builtins.str] query_file_uri: The HCFS URI of the script that contains SQL queries.
...
class WorkflowTemplateParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fields: Required. Paths to all fields that the parameter replaces. A field is allowed to appear in at most one parameter's list of field paths. A field path is similar in syntax to a .sparkJob.args
        :param pulumi.Input[builtins.str] name: Required. Parameter name. The parameter name is used as the key, and paired with the parameter value, which are passed to the template when the template is instantiated. The name must contain only capital letters (A-Z), numbers (0-9), and underscores (_), and must not start with a number. The maximum length is 40 characters.
        :param pulumi.Input[builtins.str] description: Brief description of the parameter. Must not exceed 1024 characters.
...
if not MYPY:
    class WorkflowTemplateParameterValidationRegexArgsDict(TypedDict):
        regexes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class WorkflowTemplateParameterValidationRegexArgs:
    def __init__(__self__, *,
                 regexes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regexes: Required. RE2 regular expressions used to validate the parameter's value. The value must match the regex in its entirety (substring matches are not sufficient).
        """
        pulumi.set(__self__, "regexes", regexes)

    @property
    @pulumi.getter
    def regexes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Required. RE2 regular expressions used to validate the parameter's value. The value must match the regex in its entirety (substring matches are not sufficient).
        """
    ...
    @regexes.setter
    def regexes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class WorkflowTemplateParameterValidationValuesArgs:
    def __init__(__self__, *,
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Required. List of allowed values for the parameter.
        """
        pulumi.set(__self__, "values", values)
...
if not MYPY:
    class WorkflowTemplatePlacementClusterSelectorArgsDict(TypedDict):
        cluster_labels: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
...
class WorkflowTemplatePlacementClusterSelectorArgs:
    def __init__(__self__, *,
                 ...
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] cluster_labels: Required. The cluster labels. Cluster must have all labels to match.
        :param pulumi.Input[builtins.str] zone: The zone where workflow process executes. This parameter does not affect the selection of the cluster. If unspecified, the zone of the first cluster matching the selector is used.
        """
    ...
    def cluster_labels(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        Required. The cluster labels. Cluster must have all labels to match.
        """
    ...
    def cluster_labels(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
class WorkflowTemplatePlacementManagedClusterArgs:
    def __init__(__self__, *,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] cluster_name: Required. The cluster name prefix. A unique cluster name will be formed by appending a random suffix. The name must contain only lower-case letters (a-z), numbers (0-9), and hyphens (-). Must begin with a letter. Cannot begin or end with hyphen. Must consist of between 2 and 35 characters.
        :param pulumi.Input['WorkflowTemplatePlacementManagedClusterConfigArgs'] config: Required. The cluster configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: The labels to associate with this cluster. Label keys must be between 1 and 63 characters long, and must conform to the following PCRE regular expression: {0,63} No more than 32 labels can be associated with a given cluster.
        """
        pulumi.set(__self__, "cluster_name", cluster_name)
        pulumi.set(__self__, "config", config)
        if labels is not None:
...
class WorkflowTemplatePlacementManagedClusterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] staging_bucket: A Cloud Storage bucket used to stage job dependencies, config files, and job driver console output. If you do not specify a staging bucket, Cloud Dataproc will determine a Cloud Storage location (US, ASIA, or EU) for your cluster's staging bucket according to the Compute Engine zone where your cluster is deployed, and then create and manage this project-level, per-location bucket (see [Dataproc staging and temp buckets](https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/staging-bucket)).
        :param pulumi.Input[builtins.str] temp_bucket: A Cloud Storage bucket used to store ephemeral cluster and jobs data, such as Spark and MapReduce history files. If you do not specify a temp bucket, Dataproc will determine a Cloud Storage location (US, ASIA, or EU) for your cluster's temp bucket according to the Compute Engine zone where your cluster is deployed, and then create and manage this project-level, per-location bucket. The default bucket has a TTL of 90 days, but you can use any TTL (or none) if you specify a bucket.
...
class WorkflowTemplatePlacementManagedClusterConfigAutoscalingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] policy: The autoscaling policy used by the cluster. Only resource names including projectid and location (region) are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/` Note that the policy must be in the same project and Dataproc region.
        """
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigEncryptionConfigArgsDict(TypedDict):
        gce_pd_kms_key_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigEncryptionConfigArgs:
    def __init__(__self__, *,
                 gce_pd_kms_key_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] gce_pd_kms_key_name: The Cloud KMS key name to use for PD disk encryption for all instances in the cluster.
        """
    ...
    def gce_pd_kms_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud KMS key name to use for PD disk encryption for all instances in the cluster.
        """
    ...
    def gce_pd_kms_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigEndpointConfigArgsDict(TypedDict):
        enable_http_port_access: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigEndpointConfigArgs:
    def __init__(__self__, *,
                 enable_http_port_access: Optional[pulumi.Input[builtins.bool]] = None,
                 http_ports: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_http_port_access: If true, enable http access to specific ports on the cluster from external sources. Defaults to false.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] http_ports: Output only. The map of port descriptions to URLs. Will only be populated if enable_http_port_access is true.
        """
    ...
    @property
    @pulumi.getter(name="enableHttpPortAccess")
    def enable_http_port_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, enable http access to specific ports on the cluster from external sources. Defaults to false.
        """
        return pulumi.get(self, "enable_http_port_access")
    ...
    @enable_http_port_access.setter
    def enable_http_port_access(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_http_port_access", value)
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigArgsDict(TypedDict):
        ...
        Node Group Affinity for sole-tenant clusters.
        """
        private_ipv6_google_access: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigArgs:
    def __init__(__self__, *,
                 ...
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] internal_ip_only: If true, all instances in the cluster will only have internal IP addresses. By default, clusters are not restricted to internal IP addresses, and will have ephemeral external IP addresses assigned to each instance. This `internal_ip_only` restriction can only be enabled for subnetwork enabled networks, and all off-cluster dependencies must be configured to be accessible without external IP addresses.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The Compute Engine metadata entries to add to all instances (see [About VM metadata](https://cloud.google.com/compute/docs/metadata/overview)).
        :param pulumi.Input[builtins.str] network: The Compute Engine network to be used for machine communications. Cannot be specified with subnetwork_uri. If neither `network_uri` nor `subnetwork_uri` is specified, the "default" network of the project is used, if it exists. Cannot be a "Custom Subnet Network" (see /regions/global/default` * `default`
        ...
        :param pulumi.Input[builtins.str] private_ipv6_google_access: The type of IPv6 access for a cluster. Possible values: PRIVATE_IPV6_GOOGLE_ACCESS_UNSPECIFIED, INHERIT_FROM_SUBNETWORK, OUTBOUND, BIDIRECTIONAL
        ...
        :param pulumi.Input[builtins.str] service_account: The (https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_account_scopes: The URIs of service account scopes to be included in Compute Engine instances. The following base set of scopes is always included: * https://www.googleapis.com/auth/cloud.useraccounts.readonly * https://www.googleapis.com/auth/devstorage.read_write * https://www.googleapis.com/auth/logging.write If no scopes are specified, the following defaults are also provided: * https://www.googleapis.com/auth/bigquery * https://www.googleapis.com/auth/bigtable.admin.table * https://www.googleapis.com/auth/bigtable.data * https://www.googleapis.com/auth/devstorage.full_control
        ...
        :param pulumi.Input[builtins.str] subnetwork: The Compute Engine subnetwork to be used for machine communications. Cannot be specified with network_uri. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects//regions/us-east1/subnetworks/sub0` * `sub0`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The Compute Engine tags to add to all instances (see [Manage tags for resources](https://cloud.google.com/compute/docs/tag-resources)).
        :param pulumi.Input[builtins.str] zone: The zone where the Compute Engine cluster will be located. On a create request, it is required in the "global" region. If omitted in a non-global Dataproc region, the service will pick a zone in the corresponding Compute Engine region. On a get request, zone will always be present. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/` * `us-central1-f`
        """
        if internal_ip_only is not None:
            pulumi.set(__self__, "internal_ip_only", internal_ip_only)
        if metadata is not None:
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgsDict(TypedDict):
        node_group: pulumi.Input[builtins.str]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinityArgs:
    def __init__(__self__, *,
                 node_group: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] node_group: Required. The URI of a sole-tenant /zones/us-central1-a/nodeGroups/node-group-1` * `node-group-1`
        """
        pulumi.set(__self__, "node_group", node_group)

    @property
    @pulumi.getter(name="nodeGroup")
    def node_group(self) -> pulumi.Input[builtins.str]:
        """
        Required. The URI of a sole-tenant /zones/us-central1-a/nodeGroups/node-group-1` * `node-group-1`
        """
    ...
    @node_group.setter
    def node_group(self, value: pulumi.Input[builtins.str]):
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinityArgs:
    def __init__(__self__, *,
                 ...
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] consume_reservation_type: Type of reservation to consume Possible values: TYPE_UNSPECIFIED, NO_RESERVATION, ANY_RESERVATION, SPECIFIC_RESERVATION
        :param pulumi.Input[builtins.str] key: Corresponds to the label key of reservation resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Corresponds to the label values of reservation resource.
        """
        if consume_reservation_type is not None:
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigShieldedInstanceConfigArgs:
    def __init__(__self__, *,
                 ...
                 enable_vtpm: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_integrity_monitoring: Defines whether instances have [Integrity Monitoring](https://cloud.google.com/compute/shielded-vm/docs/shielded-vm#integrity-monitoring) enabled.
        :param pulumi.Input[builtins.bool] enable_secure_boot: Defines whether instances have [Secure Boot](https://cloud.google.com/compute/shielded-vm/docs/shielded-vm#secure-boot) enabled.
        :param pulumi.Input[builtins.bool] enable_vtpm: Defines whether instances have the [vTPM](https://cloud.google.com/compute/shielded-vm/docs/shielded-vm#vtpm) enabled.
        """
        if enable_integrity_monitoring is not None:
            pulumi.set(__self__, "enable_integrity_monitoring", enable_integrity_monitoring)
        if enable_secure_boot is not None:
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetArgsDict(TypedDict):
        cluster_namespace: NotRequired[pulumi.Input[builtins.str]]
        """
        A namespace within the GKE cluster to deploy into.
        """
        target_gke_cluster: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetArgs:
    def __init__(__self__, *,
                 cluster_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 target_gke_cluster: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cluster_namespace: A namespace within the GKE cluster to deploy into.
        :param pulumi.Input[builtins.str] target_gke_cluster: The target GKE cluster to deploy to. Format: 'projects/{project}/locations/{location}/clusters/{cluster_id}'
        """
    ...
    def cluster_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A namespace within the GKE cluster to deploy into.
        """
    ...
    def cluster_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_namespace", value)

    @property
    @pulumi.getter(name="targetGkeCluster")
    def target_gke_cluster(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The target GKE cluster to deploy to. Format: 'projects/{project}/locations/{location}/clusters/{cluster_id}'
        """
    ...
    def target_gke_cluster(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigInitializationActionArgsDict(TypedDict):
        executable_file: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigInitializationActionArgs:
    def __init__(__self__, *,
                 executable_file: Optional[pulumi.Input[builtins.str]] = None,
                 execution_timeout: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] executable_file: Required. Cloud Storage URI of executable file.
        :param pulumi.Input[builtins.str] execution_timeout: Amount of time executable has to complete. Default is 10 minutes (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)). Cluster creation fails with an explanatory error message (the name of the executable that caused the error and the exceeded timeout period) if the executable is not completed at end of the timeout period.
        """
    ...
    def executable_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required. Cloud Storage URI of executable file.
        """
    ...
    def executable_file(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigLifecycleConfigArgsDict(TypedDict):
        ...
        """
        auto_delete_ttl: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigLifecycleConfigArgs:
    def __init__(__self__, *,
                 auto_delete_time: Optional[pulumi.Input[builtins.str]] = None,
                 auto_delete_ttl: Optional[pulumi.Input[builtins.str]] = None,
                 idle_delete_ttl: Optional[pulumi.Input[builtins.str]] = None,
                 idle_start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] auto_delete_time: The time when cluster will be auto-deleted (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)).
        :param pulumi.Input[builtins.str] auto_delete_ttl: The lifetime duration of cluster. The cluster will be auto-deleted at the end of this period. Minimum value is 10 minutes; maximum value is 14 days (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)).
        :param pulumi.Input[builtins.str] idle_delete_ttl: The duration to keep the cluster alive while idling (when no jobs are running). Passing this threshold will cause the cluster to be deleted. Minimum value is 5 minutes; maximum value is 14 days (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json).
        :param pulumi.Input[builtins.str] idle_start_time: Output only. The time when cluster became idle (most recent job finished) and became eligible for deletion due to idleness (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)).
        """
        if auto_delete_time is not None:
            pulumi.set(__self__, "auto_delete_time", auto_delete_time)
    ...
    def auto_delete_ttl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The lifetime duration of cluster. The cluster will be auto-deleted at the end of this period. Minimum value is 10 minutes; maximum value is 14 days (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)).
        """
    ...
    def auto_delete_ttl(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigMasterConfigArgsDict(TypedDict):
        ...
        """
        is_preemptible: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigArgs:
    def __init__(__self__, *,
                 ...
                 instance_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 is_preemptible: Optional[pulumi.Input[builtins.bool]] = None,
                 machine_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] image: The Compute Engine image resource used for cluster instances. The URI can represent an image or image family. Image examples: * `https://www.googleapis.com/compute/beta/projects/` If the URI is unspecified, it will be inferred from `SoftwareConfig.image_version` or the system default.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_names: Output only. The list of instance names. Dataproc derives the names from `cluster_name`, `num_instances`, and the instance group.
        :param pulumi.Input[builtins.bool] is_preemptible: Output only. Specifies that this instance group contains preemptible instances.
        :param pulumi.Input[builtins.str] machine_type: The Compute Engine machine type used for cluster instances. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/(https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the machine type resource, for example, `n1-standard-2`.
        ...
        :param pulumi.Input[builtins.str] min_cpu_platform: Specifies the minimum cpu platform for the Instance Group. See [Minimum CPU platform](https://cloud.google.com/dataproc/docs/concepts/compute/dataproc-min-cpu).
        :param pulumi.Input[builtins.int] num_instances: The number of VM instances in the instance group. For master instance groups, must be set to 1.
        :param pulumi.Input[builtins.str] preemptibility: Specifies the preemptibility of the instance group. The default value for master and worker groups is `NON_PREEMPTIBLE`. This default cannot be changed. The default value for secondary instances is `PREEMPTIBLE`. Possible values: PREEMPTIBILITY_UNSPECIFIED, NON_PREEMPTIBLE, PREEMPTIBLE
        """
        if accelerators is not None:
            pulumi.set(__self__, "accelerators", accelerators)
        if disk_config is not None:
    ...
    def is_preemptible(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Output only. Specifies that this instance group contains preemptible instances.
        """
    ...
    def is_preemptible(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorArgs:
    def __init__(__self__, *,
                 ...
                 accelerator_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] accelerator_count: The number of the accelerator cards of this type exposed to this instance.
        :param pulumi.Input[builtins.str] accelerator_type: Full URL, partial URI, or short name of the accelerator type resource to expose to this instance. See (https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the accelerator type resource, for example, `nvidia-tesla-k80`.
        """
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfigArgs:
    def __init__(__self__, *,
                 ...
                 num_local_ssds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] boot_disk_size_gb: Size in GB of the boot disk (default is 500GB).
        :param pulumi.Input[builtins.str] boot_disk_type: Type of the boot disk (default is "pd-standard"). Valid values: "pd-ssd" (Persistent Disk Solid State Drive) or "pd-standard" (Persistent Disk Hard Disk Drive).
        :param pulumi.Input[builtins.int] num_local_ssds: Number of attached SSDs, from 0 to 4 (default is 0). If SSDs are not attached, the boot disk is used to store runtime logs and (https://hadoop.apache.org/docs/r1.2.1/hdfs_user_guide.html) data. If one or more SSDs are attached, this runtime bulk data is spread across them, and the boot disk contains only basic config and installed binaries.
        """
        if boot_disk_size_gb is not None:
            pulumi.set(__self__, "boot_disk_size_gb", boot_disk_size_gb)
        if boot_disk_type is not None:
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigArgsDict(TypedDict):
        instance_group_manager_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Output only. The name of the Instance Group Manager for this group.
        """
        instance_template_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigArgs:
    def __init__(__self__, *,
                 instance_group_manager_name: Optional[pulumi.Input[builtins.str]] = None,
                 instance_template_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] instance_group_manager_name: Output only. The name of the Instance Group Manager for this group.
        :param pulumi.Input[builtins.str] instance_template_name: Output only. The name of the Instance Template used for the Managed Instance Group.
        """
    ...
    def instance_group_manager_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Output only. The name of the Instance Group Manager for this group.
        """
    ...
    def instance_group_manager_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "instance_group_manager_name", value)

    @property
    @pulumi.getter(name="instanceTemplateName")
    def instance_template_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Output only. The name of the Instance Template used for the Managed Instance Group.
        """
    ...
    def instance_template_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkflowTemplatePlacementManagedClusterConfigMetastoreConfigArgs:
    def __init__(__self__, *,
                 dataproc_metastore_service: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] dataproc_metastore_service: Required. Resource name of an existing Dataproc Metastore service. Example: * `projects/`
        """
        pulumi.set(__self__, "dataproc_metastore_service", dataproc_metastore_service)
...
class WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image: Optional. The Compute Engine image resource used for cluster instances. The URI can represent an image or image family. Image examples: * `https://www.googleapis.com/compute/beta/projects/[project_id]/global/images/[image-id]` * `projects/[project_id]/global/images/[image-id]` * `image-id` Image family examples. Dataproc will use the most recent image from the family: * `https://www.googleapis.com/compute/beta/projects/[project_id]/global/images/family/[custom-image-family-name]` * `projects/[project_id]/global/images/family/[custom-image-family-name]` If the URI is unspecified, it will be inferred from `SoftwareConfig.image_version` or the system default.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_names: Output only. The list of instance names. Dataproc derives the names from `cluster_name`, `num_instances`, and the instance group.
        :param pulumi.Input[builtins.bool] is_preemptible: Output only. Specifies that this instance group contains preemptible instances.
        :param pulumi.Input[builtins.str] machine_type: Optional. The Compute Engine machine type used for cluster instances. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/[project_id]/zones/us-east1-a/machineTypes/n1-standard-2` * `projects/[project_id]/zones/us-east1-a/machineTypes/n1-standard-2` * `n1-standard-2` **Auto Zone Exception**: If you are using the Dataproc [Auto Zone Placement](https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the machine type resource, for example, `n1-standard-2`.
        ...
        :param pulumi.Input[builtins.str] min_cpu_platform: Optional. Specifies the minimum cpu platform for the Instance Group. See [Dataproc > Minimum CPU Platform](https://cloud.google.com/dataproc/docs/concepts/compute/dataproc-min-cpu).
        :param pulumi.Input[builtins.int] num_instances: Optional. The number of VM instances in the instance group. For [HA cluster](https://www.terraform.io/dataproc/docs/concepts/configuring-clusters/high-availability) master_config groups, **must be set to 3**. For standard cluster master_config groups, **must be set to 1**.
        :param pulumi.Input[builtins.str] preemptibility: Optional. Specifies the preemptibility of the instance group. The default value for master and worker groups is `NON_PREEMPTIBLE`. This default cannot be changed. The default value for secondary instances is `PREEMPTIBLE`. Possible values: PREEMPTIBILITY_UNSPECIFIED, NON_PREEMPTIBLE, PREEMPTIBLE
        """
        if accelerators is not None:
            pulumi.set(__self__, "accelerators", accelerators)
        if disk_config is not None:
...
if not MYPY:
    class WorkflowTemplatePlacementManagedClusterConfigSecurityConfigKerberosConfigArgsDict(TypedDict):
        ...
        """
        cross_realm_trust_shared_password: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        kdc_db_key: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of a KMS encrypted file containing the master key of the KDC database.
        """
        key_password: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of a KMS encrypted file containing the password to the user provided key. For the self-signed certificate, this password is generated by Dataproc.
        """
        keystore: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of the keystore file used for SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
        """
        keystore_password: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        root_principal_password: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        truststore: NotRequired[pulumi.Input[builtins.str]]
        """
        The Cloud Storage URI of the truststore file used for SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
        """
        truststore_password: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkflowTemplatePlacementManagedClusterConfigSecurityConfigKerberosConfigArgs:
    def __init__(__self__, *,
                 ...
                 cross_realm_trust_kdc: Optional[pulumi.Input[builtins.str]] = None,
                 cross_realm_trust_realm: Optional[pulumi.Input[builtins.str]] = None,
                 cross_realm_trust_shared_password: Optional[pulumi.Input[builtins.str]] = None,
                 enable_kerberos: Optional[pulumi.Input[builtins.bool]] = None,
                 kdc_db_key: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 kms_key: Optional[pulumi.Input[builtins.str]] = None,
                 realm: Optional[pulumi.Input[builtins.str]] = None,
                 root_principal_password: Optional[pulumi.Input[builtins.str]] = None,
                 tgt_lifetime_hours: Optional[pulumi.Input[builtins.int]] = None,
                 truststore: Optional[pulumi.Input[builtins.str]] = None,
                 truststore_password: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cross_realm_trust_admin_server: The admin server (IP or hostname) for the remote trusted realm in a cross realm trust relationship.
        :param pulumi.Input[builtins.str] cross_realm_trust_kdc: The KDC (IP or hostname) for the remote trusted realm in a cross realm trust relationship.
        :param pulumi.Input[builtins.str] cross_realm_trust_realm: The remote realm the Dataproc on-cluster KDC will trust, should the user enable cross realm trust.
        :param pulumi.Input[builtins.str] cross_realm_trust_shared_password: The Cloud Storage URI of a KMS encrypted file containing the shared password between the on-cluster Kerberos realm and the remote trusted realm, in a cross realm trust relationship.
        :param pulumi.Input[builtins.bool] enable_kerberos: Flag to indicate whether to Kerberize the cluster (default: false). Set this field to true to enable Kerberos on a cluster.
        :param pulumi.Input[builtins.str] kdc_db_key: The Cloud Storage URI of a KMS encrypted file containing the master key of the KDC database.
        :param pulumi.Input[builtins.str] key_password: The Cloud Storage URI of a KMS encrypted file containing the password to the user provided key. For the self-signed certificate, this password is generated by Dataproc.
        :param pulumi.Input[builtins.str] keystore: The Cloud Storage URI of the keystore file used for SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
        :param pulumi.Input[builtins.str] keystore_password: The Cloud Storage URI of a KMS encrypted file containing the password to the user provided keystore. For the self-signed certificate, this password is generated by Dataproc.
        :param pulumi.Input[builtins.str] kms_key: The uri of the KMS key used to encrypt various sensitive files.
        :param pulumi.Input[builtins.str] realm: The name of the on-cluster Kerberos realm. If not specified, the uppercased domain of hostnames will be the realm.
        :param pulumi.Input[builtins.str] root_principal_password: The Cloud Storage URI of a KMS encrypted file containing the root principal password.
        :param pulumi.Input[builtins.int] tgt_lifetime_hours: The lifetime of the ticket granting ticket, in hours. If not specified, or user specifies 0, then default value 10 will be used.
        :param pulumi.Input[builtins.str] truststore: The Cloud Storage URI of the truststore file used for SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
        :param pulumi.Input[builtins.str] truststore_password: The Cloud Storage URI of a KMS encrypted file containing the password to the user provided truststore. For the self-signed certificate, this password is generated by Dataproc.
        """
        if cross_realm_trust_admin_server is not None:
            pulumi.set(__self__, "cross_realm_trust_admin_server", cross_realm_trust_admin_server)
        if cross_realm_trust_kdc is not None:
    ...
    def cross_realm_trust_shared_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file containing the shared password between the on-cluster Kerberos realm and the remote trusted realm, in a cross realm trust relationship.
        """
    ...
    def cross_realm_trust_shared_password(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def kdc_db_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file containing the master key of the KDC database.
        """
    ...
    @kdc_db_key.setter
    def kdc_db_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def root_principal_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file containing the root principal password.
        """
    ...
    def root_principal_password(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def truststore(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of the truststore file used for SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
        """
    ...
    @truststore.setter
    def truststore(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "truststore", value)

    @property
    @pulumi.getter(name="truststorePassword")
    def truststore_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage URI of a KMS encrypted file containing the password to the user provided truststore. For the self-signed certificate, this password is generated by Dataproc.
        """
    ...
    def truststore_password(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkflowTemplatePlacementManagedClusterConfigSoftwareConfigArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] image_version: The version of software inside the cluster. It must be one of the supported [Dataproc Versions](https://cloud.google.com/dataproc/docs/concepts/versioning/dataproc-versions#supported_dataproc_versions), such as "1.2" (including a subminor version, such as "1.2.29"), or the ["preview" version](https://cloud.google.com/dataproc/docs/concepts/versioning/dataproc-versions#other_versions). If unspecified, it defaults to the latest Debian version.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] optional_components: The set of components to activate on the cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: The properties to set on daemon config files.
