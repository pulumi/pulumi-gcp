...
def get_metastore_service(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The location where the metastore service resides.
           
           - - -
    :param builtins.str project: The project in which the resource belongs. If it
           is not provided, the provider project is used.
    :param builtins.str service_id: The ID of the metastore service.
    """
    __args__ = dict()
...
def get_metastore_service_output(location: Optional[pulumi.Input[builtins.str]] = None,
