...
class AutoscalingPolicyBasicAlgorithm(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cooldown_period: Optional[builtins.str] = None):
        """
        :param 'AutoscalingPolicyBasicAlgorithmYarnConfigArgs' yarn_config: YARN autoscaling configuration.
               Structure is documented below.
        :param builtins.str cooldown_period: Duration between scaling events. A scaling period starts after the
    ...
    def cooldown_period(self) -> Optional[builtins.str]:
        """
...
class AutoscalingPolicyBasicAlgorithmYarnConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 scale_down_min_worker_fraction: Optional[builtins.float] = None,
                 scale_up_min_worker_fraction: Optional[builtins.float] = None):
        """
        :param builtins.str graceful_decommission_timeout: Timeout for YARN graceful decommissioning of Node Managers. Specifies the
               duration to wait for jobs to complete before forcefully removing workers
               (and potentially interrupting jobs). Only applicable to downscaling operations.
               Bounds: [0s, 1d].
        :param builtins.float scale_down_factor: Fraction of average pending memory in the last cooldown period for which to
               remove workers. A scale-down factor of 1 will result in scaling down so that there
               is no available memory remaining after the update (more aggressive scaling).
               A scale-down factor of 0 disables removing workers, which can be beneficial for
               autoscaling a single job.
               Bounds: [0.0, 1.0].
        :param builtins.float scale_up_factor: Fraction of average pending memory in the last cooldown period for which to
               add workers. A scale-up factor of 1.0 will result in scaling up so that there
               is no pending memory remaining after the update (more aggressive scaling).
               A scale-up factor closer to 0 will result in a smaller magnitude of scaling up
               (less aggressive scaling).
               Bounds: [0.0, 1.0].
        :param builtins.float scale_down_min_worker_fraction: Minimum scale-down threshold as a fraction of total cluster size before scaling occurs.
               For example, in a 20-worker cluster, a threshold of 0.1 means the autoscaler must
               recommend at least a 2 worker scale-down for the cluster to scale. A threshold of 0
               means the autoscaler will scale down on any recommended change.
               Bounds: [0.0, 1.0]. Default: 0.0.
        :param builtins.float scale_up_min_worker_fraction: Minimum scale-up threshold as a fraction of total cluster size before scaling
    ...
    def scale_down_factor(self) -> builtins.float:
        """
    ...
    def scale_up_factor(self) -> builtins.float:
        """
        Fraction of average pending memory in the last cooldown period for which to
        add workers. A scale-up factor of 1.0 will result in scaling up so that there
        is no pending memory remaining after the update (more aggressive scaling).
    ...
    def scale_down_min_worker_fraction(self) -> Optional[builtins.float]:
        """
    ...
    def scale_up_min_worker_fraction(self) -> Optional[builtins.float]:
        """
...
class AutoscalingPolicySecondaryWorkerConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_instances: Maximum number of instances for this group. Note that by default, clusters will not use
               secondary workers. Required for secondary workers if the minimum secondary instances is set.
               Bounds: [minInstances, ). Defaults to 0.
        :param builtins.int min_instances: Minimum number of instances for this group. Bounds: [0, maxInstances]. Defaults to 0.
        :param builtins.int weight: Weight for the instance group, which is used to determine the fraction of total workers
...
class AutoscalingPolicyWorkerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weight: Optional[builtins.int] = None):
        """
        :param builtins.int max_instances: Maximum number of instances for this group.
        :param builtins.int min_instances: Minimum number of instances for this group. Bounds: [2, maxInstances]. Defaults to 2.
        :param builtins.int weight: Weight for the instance group, which is used to determine the fraction of total workers
               in the cluster from this instance group. For example, if primary workers have weight 2,
               and secondary workers have weight 1, the cluster will have approximately 2 primary workers
               for each secondary worker.
...
class BatchEnvironmentConfigExecutionConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 network_uri: Optional[builtins.str] = None,
        ...
        :param builtins.str network_uri: Network configuration for workload execution.
    ...
    def network_uri(self) -> Optional[builtins.str]:
        """
...
class BatchPysparkBatch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 jar_file_uris: Optional[Sequence[builtins.str]] = None,
                 main_python_file_uri: Optional[builtins.str] = None,
                 python_file_uris: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor.
               Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver. Do not include arguments that can be set as batch
               properties, such as --conf, since a collision can occur that causes an incorrect batch submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        :param builtins.str main_python_file_uri: The HCFS URI of the main Python file to use as the Spark driver. Must be a .py file.
        :param Sequence[builtins.str] python_file_uris: HCFS file URIs of Python files to pass to the PySpark framework.
    ...
    def jar_file_uris(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def main_python_file_uri(self) -> Optional[builtins.str]:
        """
    ...
    def python_file_uris(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BatchRuntimeConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cohort: Optional[builtins.str] = None,
        ...
        :param 'BatchRuntimeConfigAutotuningConfigArgs' autotuning_config: Optional. Autotuning configuration of the workload.
               Structure is documented below.
        :param builtins.str cohort: Optional. Cohort identifier. Identifies families of the workloads having the same shape, e.g. daily ETL jobs.
        ...
        :param builtins.str version: Version of the batch runtime.
        """
    ...
    @property
    @pulumi.getter
    def cohort(self) -> Optional[builtins.str]:
        """
...
class BatchRuntimeConfigAutotuningConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] scenarios: Optional. Scenarios for which tunings are applied.
...
class BatchRuntimeInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 diagnostic_output_uri: Optional[builtins.str] = None,
                 endpoints: Optional[Mapping[str, builtins.str]] = None,
        ...
        :param Sequence['BatchRuntimeInfoCurrentUsageArgs'] current_usages: (Output)
               ...
               Structure is documented below.
        :param builtins.str diagnostic_output_uri: (Output)
               A URI pointing to the location of the diagnostics tarball.
        :param Mapping[str, builtins.str] endpoints: (Output)
               Map of remote access endpoints (such as web interfaces and APIs) to their URIs.
        :param builtins.str output_uri: (Output)
    ...
    def diagnostic_output_uri(self) -> Optional[builtins.str]:
        """
        (Output)
        A URI pointing to the location of the diagnostics tarball.
        """
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> Optional[Mapping[str, builtins.str]]:
        """
        (Output)
        Map of remote access endpoints (such as web interfaces and APIs) to their URIs.
        """
...
class BatchRuntimeInfoApproximateUsage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 milli_accelerator_seconds: Optional[builtins.str] = None,
                 milli_dcu_seconds: Optional[builtins.str] = None,
                 shuffle_storage_gb_seconds: Optional[builtins.str] = None):
        """
        :param builtins.str accelerator_type: (Output)
               Accelerator type being used, if any.
        :param builtins.str milli_accelerator_seconds: (Output)
               Accelerator usage in (milliAccelerator x seconds)
        :param builtins.str milli_dcu_seconds: (Output)
               DCU (Dataproc Compute Units) usage in (milliDCU x seconds)
        :param builtins.str shuffle_storage_gb_seconds: (Output)
    ...
    def milli_accelerator_seconds(self) -> Optional[builtins.str]:
        """
        (Output)
        Accelerator usage in (milliAccelerator x seconds)
        """
    ...
    def milli_dcu_seconds(self) -> Optional[builtins.str]:
        """
        (Output)
        DCU (Dataproc Compute Units) usage in (milliDCU x seconds)
        """
    ...
    def shuffle_storage_gb_seconds(self) -> Optional[builtins.str]:
        """
        (Output)
        Shuffle storage usage in (GB x seconds)
        """
...
class BatchRuntimeInfoCurrentUsage(dict):
    ...
    def __init__(__self__, *,
                 accelerator_type: Optional[builtins.str] = None,
                 milli_accelerator: Optional[builtins.str] = None,
                 milli_dcu: Optional[builtins.str] = None,
                 milli_dcu_premium: Optional[builtins.str] = None,
                 shuffle_storage_gb: Optional[builtins.str] = None,
                 shuffle_storage_gb_premium: Optional[builtins.str] = None,
                 snapshot_time: Optional[builtins.str] = None):
        """
        :param builtins.str accelerator_type: (Output)
               Accelerator type being used, if any.
        :param builtins.str milli_accelerator: (Output)
               Milli (one-thousandth) accelerator..
        :param builtins.str milli_dcu: (Output)
               Milli (one-thousandth) Dataproc Compute Units (DCUs).
        :param builtins.str milli_dcu_premium: (Output)
               Milli (one-thousandth) Dataproc Compute Units (DCUs) charged at premium tier.
        :param builtins.str shuffle_storage_gb: (Output)
               Shuffle Storage in gigabytes (GB).
        :param builtins.str shuffle_storage_gb_premium: (Output)
               Shuffle Storage in gigabytes (GB) charged at premium tier.
        :param builtins.str snapshot_time: (Output)
    ...
    def milli_accelerator(self) -> Optional[builtins.str]:
        """
        (Output)
        Milli (one-thousandth) accelerator..
        """
    ...
    def milli_dcu(self) -> Optional[builtins.str]:
        """
        (Output)
        Milli (one-thousandth) Dataproc Compute Units (DCUs).
        """
    ...
    def milli_dcu_premium(self) -> Optional[builtins.str]:
        """
        (Output)
        Milli (one-thousandth) Dataproc Compute Units (DCUs) charged at premium tier.
        """
    ...
    def shuffle_storage_gb(self) -> Optional[builtins.str]:
        """
        (Output)
        Shuffle Storage in gigabytes (GB).
        """
    ...
    def shuffle_storage_gb_premium(self) -> Optional[builtins.str]:
        """
        (Output)
        Shuffle Storage in gigabytes (GB) charged at premium tier.
        """
    ...
    def snapshot_time(self) -> Optional[builtins.str]:
        """
        (Output)
        The timestamp of the usage snapshot.
        """
...
class BatchSparkBatch(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        :param builtins.str main_class: The name of the driver main class. The jar file that contains the class must be in the
               classpath or specified in jarFileUris.
        :param builtins.str main_jar_file_uri: The HCFS URI of the jar file that contains the main class.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
...
class BatchSparkRBatch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 args: Optional[Sequence[builtins.str]] = None,
                 file_uris: Optional[Sequence[builtins.str]] = None,
                 main_r_file_uri: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor.
               Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver. Do not include arguments that can be set as batch
               properties, such as --conf, since a collision can occur that causes an incorrect batch submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param builtins.str main_r_file_uri: The HCFS URI of the main R file to use as the driver. Must be a .R or .r file.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
    ...
    def main_r_file_uri(self) -> Optional[builtins.str]:
        """
...
class BatchSparkSqlBatch(dict):
    ...
    def __init__(__self__, *,
                 jar_file_uris: Optional[Sequence[builtins.str]] = None,
                 query_file_uri: Optional[builtins.str] = None,
                 query_variables: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to be added to the Spark CLASSPATH.
        :param builtins.str query_file_uri: The HCFS URI of the script that contains Spark SQL queries to execute.
        :param Mapping[str, builtins.str] query_variables: Mapping of query variable names to values (equivalent to the Spark SQL command: SET name="value";).
        """
        if jar_file_uris is not None:
            pulumi.set(__self__, "jar_file_uris", jar_file_uris)
    ...
    def query_file_uri(self) -> Optional[builtins.str]:
        """
    ...
    def query_variables(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class BatchStateHistory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 state_start_time: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str state_message: (Output)
               Details about the state at this point in history.
        :param builtins.str state_start_time: (Output)
    ...
    def state_start_time(self) -> Optional[builtins.str]:
        """
        (Output)
        The time when the batch entered the historical state.
        """
...
class ClusterClusterConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 staging_bucket: Optional[builtins.str] = None,
                 temp_bucket: Optional[builtins.str] = None,
        ...
        :param Sequence['ClusterClusterConfigAuxiliaryNodeGroupArgs'] auxiliary_node_groups: A Dataproc NodeGroup resource is a group of Dataproc cluster nodes that execute an assigned role. 
               Structure defined below.
        :param builtins.str bucket: The name of the cloud storage bucket ultimately used to house the staging data
        ...
        :param 'ClusterClusterConfigSoftwareConfigArgs' software_config: The config settings for software inside the cluster.
               Structure defined below.
        :param builtins.str staging_bucket: The Cloud Storage staging bucket used to stage files,
               ...
               option.
        :param builtins.str temp_bucket: The Cloud Storage temp bucket used to store ephemeral cluster
    ...
    def temp_bucket(self) -> Optional[builtins.str]:
        """
...
class ClusterClusterConfigAutoscalingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy_uri: The autoscaling policy used by the cluster.
...
class ClusterClusterConfigAuxiliaryNodeGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str node_group_id: A node group ID. Generated if not specified. The ID must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot begin or end with underscore or hyphen. Must consist of from 3 to 33 characters.
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] roles: Node group roles. 
               One of `"DRIVER"`.
        :param builtins.str name: The Node group resource name.
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_names: Optional[Sequence[builtins.str]] = None,
                 machine_type: Optional[builtins.str] = None,
                 min_cpu_platform: Optional[builtins.str] = None,
                 num_instances: Optional[builtins.int] = None):
        """
        ...
        :param Sequence[builtins.str] instance_names: List of auxiliary node group instance names which have been assigned to the cluster.
        :param builtins.str machine_type: The name of a Google Compute Engine machine type
               to create for the node group. If not specified, GCP will default to a predetermined
               computed value (currently `n1-standard-4`).
        :param builtins.str min_cpu_platform: The name of a minimum generation of CPU family
               for the node group. If not specified, GCP will default to a predetermined computed value
               for each zone. See [the guide](https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform)
               for details about which CPU families are available (and defaulted) for each zone.
        :param builtins.int num_instances: Specifies the number of master nodes to create.
    ...
    def instance_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def num_instances(self) -> Optional[builtins.int]:
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigAccelerator(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int accelerator_count: The number of the accelerator cards of this type exposed to this instance. Often restricted to one of `1`, `2`, `4`, or `8`.
               
               
               - - -
        :param builtins.str accelerator_type: The short name of the accelerator type to expose to this instance. For example, `nvidia-tesla-k80`.
        """
    ...
    def accelerator_count(self) -> builtins.int:
        """
...
class ClusterClusterConfigAuxiliaryNodeGroupNodeGroupNodeGroupConfigDiskConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 boot_disk_type: Optional[builtins.str] = None,
                 local_ssd_interface: Optional[builtins.str] = None,
                 num_local_ssds: Optional[builtins.int] = None):
        """
        :param builtins.int boot_disk_size_gb: Size of the primary disk attached to each node, specified
               in GB. The primary disk contains the boot volume and system libraries, and the
               smallest allowed disk size is 10GB. GCP will default to a predetermined
               computed value if not set (currently 500GB). Note: If SSDs are not
               attached, it also contains the HDFS data blocks and Hadoop working directories.
        :param builtins.str boot_disk_type: The disk type of the primary disk attached to each node.
               One of `"pd-ssd"` or `"pd-standard"`. Defaults to `"pd-standard"`.
        :param builtins.str local_ssd_interface: Interface type of local SSDs (default is "scsi"). Valid values: "scsi" (Small Computer System Interface), "nvme" (Non-Volatile Memory Express).
        :param builtins.int num_local_ssds: The amount of local SSD disks that will be attached to each master cluster node. 
               Defaults to 0.
        """
    ...
    def boot_disk_type(self) -> Optional[builtins.str]:
        """
    ...
    def local_ssd_interface(self) -> Optional[builtins.str]:
        """
    ...
    def num_local_ssds(self) -> Optional[builtins.int]:
        """
...
class ClusterClusterConfigDataprocMetricConfigMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metric_overrides: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str metric_source: A source for the collection of Dataproc OSS metrics (see [available OSS metrics](https://cloud.google.com//dataproc/docs/guides/monitoring#available_oss_metrics)).
        :param Sequence[builtins.str] metric_overrides: One or more [available OSS metrics] (https://cloud.google.com/dataproc/docs/guides/monitoring#available_oss_metrics) to collect for the metric course.
    ...
    def metric_overrides(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClusterClusterConfigEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_name: The Cloud KMS key name to use for PD disk encryption for
...
class ClusterClusterConfigEndpointConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 http_ports: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.bool enable_http_port_access: The flag to enable http access to specific ports
               on the cluster from external sources (aka Component Gateway). Defaults to false.
        :param Mapping[str, builtins.str] http_ports: The map of port descriptions to URLs. Will only be populated if
    ...
    def enable_http_port_access(self) -> builtins.bool:
        """
    ...
    def http_ports(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ClusterClusterConfigGceClusterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool internal_ip_only: By default, clusters are not restricted to internal IP addresses,
               and will have ephemeral external IP addresses assigned to each instance. If set to true, all
               instances in the cluster will only have internal IP addresses. Note: Private Google Access
               (also known as `privateIpGoogleAccess`) must be enabled on the subnetwork that the cluster
               will be launched in.
        :param Mapping[str, builtins.str] metadata: A map of the Compute Engine metadata entries to add to all instances
               (see [Project and instance metadata](https://cloud.google.com/compute/docs/storing-retrieving-metadata#project_and_instance_metadata)).
        :param builtins.str network: The name or self_link of the Google Compute Engine
        ...
        :param builtins.str service_account: The service account to be used by the Node VMs.
               If not specified, the "default" service account is used.
        :param Sequence[builtins.str] service_account_scopes: The set of Google API scopes
        ...
        :param 'ClusterClusterConfigGceClusterConfigShieldedInstanceConfigArgs' shielded_instance_config: Shielded Instance Config for clusters using [Compute Engine Shielded VMs](https://cloud.google.com/security/shielded-cloud/shielded-vm).
               ...
               - - -
        :param builtins.str subnetwork: The name or self_link of the Google Compute Engine
               subnetwork the cluster will be part of. Conflicts with `network`.
        :param Sequence[builtins.str] tags: The list of instance tags applied to instances in the cluster.
               Tags are used to identify valid sources or targets for network firewalls.
        :param builtins.str zone: The GCP zone where your data is stored and used (i.e. where
...
class ClusterClusterConfigGceClusterConfigConfidentialInstanceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_confidential_compute: Defines whether the instance should have confidential compute enabled.
        """
...
class ClusterClusterConfigGceClusterConfigNodeGroupAffinity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str node_group_uri: The URI of a sole-tenant node group resource that the cluster will be created on.
        """
...
class ClusterClusterConfigGceClusterConfigReservationAffinity(dict):
    ...
    def __init__(__self__, *,
                 consume_reservation_type: Optional[builtins.str] = None,
                 key: Optional[builtins.str] = None,
                 values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str consume_reservation_type: Corresponds to the type of reservation consumption.
    ...
    def consume_reservation_type(self) -> Optional[builtins.str]:
        """
...
class ClusterClusterConfigGceClusterConfigShieldedInstanceConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_integrity_monitoring: Defines whether instances have integrity monitoring enabled.
               
               - - -
        :param builtins.bool enable_secure_boot: Defines whether instances have Secure Boot enabled.
        :param builtins.bool enable_vtpm: Defines whether instances have the [vTPM](https://cloud.google.com/security/shielded-cloud/shielded-vm#vtpm) enabled.
        """
...
class ClusterClusterConfigInitializationAction(dict):
    ...
    def __init__(__self__, *,
                 script: builtins.str,
                 timeout_sec: Optional[builtins.int] = None):
        """
        :param builtins.str script: The script to be executed during initialization of the cluster.
               The script must be a GCS file with a gs:// prefix.
        :param builtins.int timeout_sec: The maximum duration (in seconds) which `script` is
    ...
    def timeout_sec(self) -> Optional[builtins.int]:
        """
...
class ClusterClusterConfigLifecycleConfig(dict):
    ...
    def __init__(__self__, *,
                 auto_delete_time: Optional[builtins.str] = None,
                 idle_delete_ttl: Optional[builtins.str] = None,
                 idle_start_time: Optional[builtins.str] = None):
        """
        :param builtins.str auto_delete_time: The time when cluster will be auto-deleted.
               A timestamp in RFC3339 UTC "Zulu" format, accurate to nanoseconds.
               Example: "2014-10-02T15:01:23.045123456Z".
               
               - - -
        :param builtins.str idle_delete_ttl: The duration to keep the cluster alive while idling
               (no jobs running). After this TTL, the cluster will be deleted. Valid range: [10m, 14d].
        :param builtins.str idle_start_time: Time when the cluster became idle
    ...
    def auto_delete_time(self) -> Optional[builtins.str]:
        """
    ...
    def idle_delete_ttl(self) -> Optional[builtins.str]:
        """
    ...
    def idle_start_time(self) -> Optional[builtins.str]:
        """
...
class ClusterClusterConfigMasterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str image_uri: The URI for the image to use for this worker.  See [the guide](https://cloud.google.com/dataproc/docs/guides/dataproc-images)
               for more information.
        :param Sequence[builtins.str] instance_names: List of master instance names which
...
class ClusterClusterConfigMasterConfigDiskConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str boot_disk_type: The disk type of the primary disk attached to each node.
               One of `"pd-ssd"` or `"pd-standard"`. Defaults to `"pd-standard"`.
        :param builtins.str local_ssd_interface: Optional. Interface type of local SSDs (default is "scsi").
        ...
        :param builtins.int num_local_ssds: The amount of local SSD disks that will be
...
class ClusterClusterConfigMetastoreConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dataproc_metastore_service: Resource name of an existing Dataproc Metastore service.
...
class ClusterClusterConfigPreemptibleWorkerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_names: Optional[Sequence[builtins.str]] = None,
                 num_instances: Optional[builtins.int] = None,
                 preemptibility: Optional[builtins.str] = None):
        """
        ...
        :param Sequence[builtins.str] instance_names: List of preemptible instance names which have been assigned
               to the cluster.
        :param builtins.int num_instances: Specifies the number of preemptible nodes to create.
               Defaults to 0.
        :param builtins.str preemptibility: Specifies the preemptibility of the secondary workers. The default value is `PREEMPTIBLE`
               Accepted values are:
    ...
    @property
    @pulumi.getter
    def preemptibility(self) -> Optional[builtins.str]:
        """
...
class ClusterClusterConfigPreemptibleWorkerConfigDiskConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 num_local_ssds: Optional[builtins.int] = None):
        """
        :param builtins.int boot_disk_size_gb: Size of the primary disk attached to each preemptible worker node, specified
               in GB. The smallest allowed disk size is 10GB. GCP will default to a predetermined
               computed value if not set (currently 500GB). Note: If SSDs are not
               attached, it also contains the HDFS data blocks and Hadoop working directories.
        :param builtins.str boot_disk_type: The disk type of the primary disk attached to each preemptible worker node.
               One of `"pd-ssd"` or `"pd-standard"`. Defaults to `"pd-standard"`.
        :param builtins.str local_ssd_interface: Interface type of local SSDs (default is "scsi"). Valid values: "scsi" (Small Computer System Interface), "nvme" (Non-Volatile Memory Express).
        :param builtins.int num_local_ssds: The amount of local SSD disks that will be
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionList(dict):
    ...
    def __init__(__self__, *,
                 machine_types: Optional[Sequence[builtins.str]] = None,
                 rank: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] machine_types: Full machine-type names, e.g. `"n1-standard-16"`.
        :param builtins.int rank: Preference of this instance selection. A lower number means higher preference. Dataproc will first try to create a VM based on the machine-type with priority rank and fallback to next rank based on availability. Machine types and instance selections with the same priority have the same preference.
        """
    ...
    def machine_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str machine_type: Full machine-type names, e.g. "n1-standard-16".
        :param builtins.int vm_count: Number of VM provisioned with the machine_type.
        """
        if machine_type is not None:
            pulumi.set(__self__, "machine_type", machine_type)
...
class ClusterClusterConfigPreemptibleWorkerConfigInstanceFlexibilityPolicyProvisioningModelMix(dict):
    ...
    def standard_capacity_base(self) -> Optional[builtins.int]:
        """
    ...
    def standard_capacity_percent_above_base(self) -> Optional[builtins.int]:
        """
        The percentage of target capacity that should use Standard VM. The remaining percentage will use Spot VMs. The percentage applies only to the capacity above standardCapacityBase. eg. If 15 instances are requested and standardCapacityBase is 5 and standardCapacityPercentAboveBase is 30, Dataproc will create 5 standard VMs and then start mixing spot and standard VMs for remaining 10 instances. The mix will be 30% standard and 70% spot.
        - - -
        """
...
class ClusterClusterConfigSecurityConfigKerberosConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cross_realm_trust_admin_server: Optional[builtins.str] = None,
                 cross_realm_trust_kdc: Optional[builtins.str] = None,
                 cross_realm_trust_realm: Optional[builtins.str] = None,
                 cross_realm_trust_shared_password_uri: Optional[builtins.str] = None,
                 enable_kerberos: Optional[builtins.bool] = None,
                 kdc_db_key_uri: Optional[builtins.str] = None,
                 key_password_uri: Optional[builtins.str] = None,
                 keystore_password_uri: Optional[builtins.str] = None,
                 keystore_uri: Optional[builtins.str] = None,
                 realm: Optional[builtins.str] = None,
                 tgt_lifetime_hours: Optional[builtins.int] = None,
                 truststore_password_uri: Optional[builtins.str] = None,
                 truststore_uri: Optional[builtins.str] = None):
        """
        :param builtins.str kms_key_uri: The URI of the KMS key used to encrypt various sensitive files.
        :param builtins.str root_principal_password_uri: The Cloud Storage URI of a KMS encrypted file
               containing the root principal password.
        :param builtins.str cross_realm_trust_admin_server: The admin server (IP or hostname) for the
               remote trusted realm in a cross realm trust relationship.
        :param builtins.str cross_realm_trust_kdc: The KDC (IP or hostname) for the
               remote trusted realm in a cross realm trust relationship.
        :param builtins.str cross_realm_trust_realm: The remote realm the Dataproc on-cluster KDC will
               trust, should the user enable cross realm trust.
        :param builtins.str cross_realm_trust_shared_password_uri: The Cloud Storage URI of a KMS
               encrypted file containing the shared password between the on-cluster Kerberos realm
               and the remote trusted realm, in a cross realm trust relationship.
        :param builtins.bool enable_kerberos: Flag to indicate whether to Kerberize the cluster.
        :param builtins.str kdc_db_key_uri: The Cloud Storage URI of a KMS encrypted file containing
               the master key of the KDC database.
        :param builtins.str key_password_uri: The Cloud Storage URI of a KMS encrypted file containing
               the password to the user provided key. For the self-signed certificate, this password
               is generated by Dataproc.
        :param builtins.str keystore_password_uri: The Cloud Storage URI of a KMS encrypted file containing
               the password to the user provided keystore. For the self-signed certificated, the password
               is generated by Dataproc.
        :param builtins.str keystore_uri: The Cloud Storage URI of the keystore file used for SSL encryption.
               If not provided, Dataproc will provide a self-signed certificate.
        :param builtins.str realm: The name of the on-cluster Kerberos realm. If not specified, the
               uppercased domain of hostnames will be the realm.
        :param builtins.int tgt_lifetime_hours: The lifetime of the ticket granting ticket, in hours.
        :param builtins.str truststore_password_uri: The Cloud Storage URI of a KMS encrypted file
               containing the password to the user provided truststore. For the self-signed
               certificate, this password is generated by Dataproc.
        :param builtins.str truststore_uri: The Cloud Storage URI of the truststore file used for
    ...
    def cross_realm_trust_admin_server(self) -> Optional[builtins.str]:
        """
    ...
    def cross_realm_trust_kdc(self) -> Optional[builtins.str]:
        """
    ...
    def cross_realm_trust_realm(self) -> Optional[builtins.str]:
        """
    ...
    def cross_realm_trust_shared_password_uri(self) -> Optional[builtins.str]:
        """
    ...
    def kdc_db_key_uri(self) -> Optional[builtins.str]:
        """
    ...
    def key_password_uri(self) -> Optional[builtins.str]:
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the password to the user provided key. For the self-signed certificate, this password
        is generated by Dataproc.
    ...
    def keystore_password_uri(self) -> Optional[builtins.str]:
        """
        The Cloud Storage URI of a KMS encrypted file containing
        the password to the user provided keystore. For the self-signed certificated, the password
        is generated by Dataproc.
    ...
    def keystore_uri(self) -> Optional[builtins.str]:
        """
    ...
    def tgt_lifetime_hours(self) -> Optional[builtins.int]:
        """
    ...
    def truststore_password_uri(self) -> Optional[builtins.str]:
        """
        The Cloud Storage URI of a KMS encrypted file
        containing the password to the user provided truststore. For the self-signed
        certificate, this password is generated by Dataproc.
...
class ClusterClusterConfigSoftwareConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 optional_components: Optional[Sequence[builtins.str]] = None,
                 override_properties: Optional[Mapping[str, builtins.str]] = None,
                 properties: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str image_version: The Cloud Dataproc image version to use
               for the cluster - this controls the sets of software versions
               installed onto the nodes when you create clusters. If not specified, defaults to the
               latest version. For a list of valid versions see
               [Cloud Dataproc versions](https://cloud.google.com/dataproc/docs/concepts/dataproc-versions)
        :param Sequence[builtins.str] optional_components: The set of optional components to activate on the cluster. See [Available Optional Components](https://cloud.google.com/dataproc/docs/concepts/components/overview#available_optional_components).
               
               - - -
        :param Mapping[str, builtins.str] override_properties: A list of override and additional properties (key/value pairs)
               used to modify various aspects of the common configuration files used when creating
               a cluster. For a list of valid properties please see
               [Cluster properties](https://cloud.google.com/dataproc/docs/concepts/cluster-properties)
        :param Mapping[str, builtins.str] properties: A list of the properties used to set the daemon config files.
    ...
    def optional_components(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def override_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ClusterClusterConfigWorkerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 machine_type: Optional[builtins.str] = None,
                 min_cpu_platform: Optional[builtins.str] = None,
                 min_num_instances: Optional[builtins.int] = None,
                 num_instances: Optional[builtins.int] = None):
        """
        ...
        :param builtins.str image_uri: The URI for the image to use for this worker.  See [the guide](https://cloud.google.com/dataproc/docs/guides/dataproc-images)
               for more information.
        :param Sequence[builtins.str] instance_names: List of worker instance names which have been assigned
               to the cluster.
        :param builtins.str machine_type: The name of a Google Compute Engine machine type
        ...
        :param builtins.str min_cpu_platform: The name of a minimum generation of CPU family
               ...
               for each zone. See [the guide](https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform)
               for details about which CPU families are available (and defaulted) for each zone.
        :param builtins.int min_num_instances: The minimum number of primary worker instances to create.  If `min_num_instances` is set, cluster creation will succeed if the number of primary workers created is at least equal to the `min_num_instances` number.
        :param builtins.int num_instances: Specifies the number of worker nodes to create.
    ...
    def min_num_instances(self) -> Optional[builtins.int]:
        """
...
class ClusterClusterConfigWorkerConfigDiskConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 num_local_ssds: Optional[builtins.int] = None):
        """
        :param builtins.int boot_disk_size_gb: Size of the primary disk attached to each worker node, specified
               in GB. The smallest allowed disk size is 10GB. GCP will default to a predetermined
               computed value if not set (currently 500GB). Note: If SSDs are not
               attached, it also contains the HDFS data blocks and Hadoop working directories.
        :param builtins.str boot_disk_type: The disk type of the primary disk attached to each node.
...
class ClusterVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfig(dict):
    ...
    def __init__(__self__, *,
                 dataproc_metastore_service: Optional[builtins.str] = None):
        """
        :param builtins.str dataproc_metastore_service: Resource name of an existing Dataproc Metastore service.
        """
    ...
    @property
    @pulumi.getter(name="dataprocMetastoreService")
    def dataproc_metastore_service(self) -> Optional[builtins.str]:
        """
        Resource name of an existing Dataproc Metastore service.
        """
        return pulumi.get(self, "dataproc_metastore_service")
...
class ClusterVirtualClusterConfigKubernetesClusterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kubernetes_namespace: A namespace within the Kubernetes cluster to deploy into. 
    ...
    def kubernetes_namespace(self) -> Optional[builtins.str]:
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfig(dict):
    ...
    def __init__(__self__, *,
                 gke_cluster_target: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str gke_cluster_target: A target GKE cluster to deploy to. It must be in the same project and region as the Dataproc cluster 
    ...
    def gke_cluster_target(self) -> Optional[builtins.str]:
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str node_pool: The target GKE node pool.
        :param Sequence[builtins.str] roles: The roles associated with the GKE node pool. 
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] locations: The list of Compute Engine zones where node pool nodes associated 
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigAutoscaling(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_node_count: The maximum number of nodes in the node pool. Must be >= minNodeCount, and must be > 0.
        :param builtins.int min_node_count: The minimum number of nodes in the node pool. Must be >= 0 and <= maxNodeCount.
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int local_ssd_count: The number of local SSD disks to attach to the node, 
               which is limited by the maximum number of disks allowable per zone.
        :param builtins.str machine_type: The name of a Compute Engine machine type.
        :param builtins.str min_cpu_platform: Minimum CPU platform to be used by this instance. 
        ...
        :param builtins.bool spot: Spot flag for enabling Spot VM, which is a rebrand of the existing preemptible flag.
        """
...
class ClusterVirtualClusterConfigKubernetesClusterConfigKubernetesSoftwareConfig(dict):
    ...
    def __init__(__self__, *,
                 component_version: Mapping[str, builtins.str],
                 properties: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Mapping[str, builtins.str] component_version: The components that should be installed in this Dataproc cluster. The key must be a string from the   
               KubernetesComponent enumeration. The value is the version of the software to be installed. At least one entry must be specified.
               * **NOTE** : `component_version[SPARK]` is mandatory to set, or the creation of the cluster will fail.
        :param Mapping[str, builtins.str] properties: The properties to set on daemon config files. Property keys are specified in prefix:property format, 
    ...
    def component_version(self) -> Mapping[str, builtins.str]:
        """
...
class GdcApplicationEnvironmentSparkApplicationEnvironmentConfig(dict):
    ...
    def __init__(__self__, *,
                 default_properties: Optional[Mapping[str, builtins.str]] = None,
                 default_version: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] default_properties: A map of default Spark properties to apply to workloads in this application environment. These defaults may be overridden by per-application properties.
        :param builtins.str default_version: The default Dataproc version to use for applications submitted to this application environment
        """
    ...
    def default_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class GdcServiceInstanceGdceCluster(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str gdce_cluster: Gdce cluster resource id.
        """
...
class GdcSparkApplicationPysparkApplicationConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 python_file_uris: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str main_python_file_uri: The HCFS URI of the main Python file to use as the driver. Must be a .py file.
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver.  Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Python driver and tasks.
        :param Sequence[builtins.str] python_file_uris: HCFS file URIs of Python files to pass to the PySpark framework. Supported file types: .py, .egg, and .zip.
        """
        pulumi.set(__self__, "main_python_file_uri", main_python_file_uri)
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
...
class GdcSparkApplicationSparkApplicationConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: `.jar`, `.tar`, `.tar.gz`, `.tgz`, and `.zip`.
        :param Sequence[builtins.str] args: The arguments to pass to the driver. Do not include arguments that can be set as application properties, such as `--conf`, since a collision can occur that causes an incorrect application submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the classpath of the Spark driver and tasks.
        :param builtins.str main_class: The name of the driver main class. The jar file that contains the class must be in the classpath or specified in `jar_file_uris`.
        :param builtins.str main_jar_file_uri: The HCFS URI of the jar file that contains the main class.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
...
class GdcSparkApplicationSparkRApplicationConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 file_uris: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str main_r_file_uri: The HCFS URI of the main R file to use as the driver. Must be a .R file.
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver.  Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        """
...
class GdcSparkApplicationSparkSqlApplicationConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 script_variables: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to be added to the Spark CLASSPATH.
        :param builtins.str query_file_uri: The HCFS URI of the script that contains SQL queries.
        :param 'GdcSparkApplicationSparkSqlApplicationConfigQueryListArgs' query_list: Represents a list of queries.
               Structure is documented below.
        :param Mapping[str, builtins.str] script_variables: Mapping of query variable names to values (equivalent to the Spark SQL command: SET `name="value";`).
        """
        if jar_file_uris is not None:
            pulumi.set(__self__, "jar_file_uris", jar_file_uris)
        if query_file_uri is not None:
    ...
    def script_variables(self) -> Optional[Mapping[str, builtins.str]]:
        """
        Mapping of query variable names to values (equivalent to the Spark SQL command: SET `name="value";`).
        """
...
class GdcSparkApplicationSparkSqlApplicationConfigQueryList(dict):
    def __init__(__self__, *,
                 queries: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] queries: The queries to run.
        """
        pulumi.set(__self__, "queries", queries)

    @property
    @pulumi.getter
    def queries(self) -> Sequence[builtins.str]:
        """
        The queries to run.
        """
...
class JobHadoopConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 properties: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted in the working directory of .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver. Do not include arguments, such as -libjars or -Dfoo=bar, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be copied to the working directory of Hadoop drivers and distributed tasks. Useful for naively parallel tasks.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Spark driver and tasks.
        :param 'JobHadoopConfigLoggingConfigArgs' logging_config: The runtime logging config of the job
        :param builtins.str main_class: The name of the driver's main class. The jar file containing the class must be in the default CLASSPATH or specified in `jar_file_uris`. Conflicts with `main_jar_file_uri`
        :param builtins.str main_jar_file_uri: The HCFS URI of the jar file containing the main class. Examples: 'gs://foo-bucket/analytics-binaries/extract-useful-metrics-mr.jar' 'hdfs:/tmp/test-samples/custom-wordcount.jar' 'file:///home/usr/lib/hadoop-mapreduce/hadoop-mapreduce-examples.jar'. Conflicts with `main_class`
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Hadoop. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/hadoop/conf/*-site` and classes in user code..
...
class JobHadoopConfigLoggingConfig(dict):
    ...
    def __init__(__self__, *,
                 driver_log_levels: Mapping[str, builtins.str]):
        """
        :param Mapping[str, builtins.str] driver_log_levels: Optional. The per-package log levels for the driver. This may include 'root' package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'.
        """
        pulumi.set(__self__, "driver_log_levels", driver_log_levels)

    @property
    @pulumi.getter(name="driverLogLevels")
    def driver_log_levels(self) -> Mapping[str, builtins.str]:
        """
...
class JobHiveConfig(dict):
    ...
    def __init__(__self__, *,
                 continue_on_failure: Optional[builtins.bool] = None,
                 jar_file_uris: Optional[Sequence[builtins.str]] = None,
                 properties: Optional[Mapping[str, builtins.str]] = None,
                 query_file_uri: Optional[builtins.str] = None,
                 query_lists: Optional[Sequence[builtins.str]] = None,
                 script_variables: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.bool continue_on_failure: Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries. Defaults to false.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATH of the Hive server and Hadoop MapReduce (MR) tasks. Can contain Hive SerDes and UDFs.
        :param Mapping[str, builtins.str] properties: A mapping of property names and values, used to configure Hive. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/hadoop/conf/*-site.xml`, `/etc/hive/conf/hive-site.xml`, and classes in user code..
        :param builtins.str query_file_uri: HCFS URI of file containing Hive script to execute as the job.
               Conflicts with `query_list`
        :param Sequence[builtins.str] query_lists: The list of Hive queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
        :param Mapping[str, builtins.str] script_variables: Mapping of query variable names to values (equivalent to the Hive command: `SET name="value";`).
        """
    ...
    def continue_on_failure(self) -> Optional[builtins.bool]:
        """
    ...
    def query_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class JobPigConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool continue_on_failure: Whether to continue executing queries if a query fails. The default value is false. Setting to true can be useful when executing independent parallel queries. Defaults to false.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATH of the Pig Client and Hadoop MapReduce (MR) tasks. Can contain Pig UDFs.
               
               * `logging_config.driver_log_levels`- (Required) The per-package log levels for the driver. This may include 'root' package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'
        :param 'JobPigConfigLoggingConfigArgs' logging_config: The runtime logging config of the job
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Pig. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/hadoop/conf/*-site.xml`, `/etc/pig/conf/pig.properties`, and classes in user code.
        :param builtins.str query_file_uri: HCFS URI of file containing Hive script to execute as the job.
               Conflicts with `query_list`
        :param Sequence[builtins.str] query_lists: The list of Hive queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
        :param Mapping[str, builtins.str] script_variables: Mapping of query variable names to values (equivalent to the Pig command: `name=[value]`).
        """
        if continue_on_failure is not None:
            pulumi.set(__self__, "continue_on_failure", continue_on_failure)
        if jar_file_uris is not None:
...
class JobPlacement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cluster_uuid: Optional[builtins.str] = None):
        """
        :param builtins.str cluster_name: The name of the cluster where the job will be submitted
        :param builtins.str cluster_uuid: Output-only. A cluster UUID generated by the Cloud Dataproc service when the job is submitted
        """
    ...
    def cluster_uuid(self) -> Optional[builtins.str]:
        """
...
class JobPrestoConfig(dict):
    ...
    def __init__(__self__, *,
                 client_tags: Optional[Sequence[builtins.str]] = None,
                 continue_on_failure: Optional[builtins.bool] = None,
                 ...
                 query_lists: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] client_tags: Presto client tags to attach to this query.
        :param builtins.bool continue_on_failure: Whether to continue executing queries if a query fails. Setting to true can be useful when executing independent parallel queries. Defaults to false.
        :param 'JobPrestoConfigLoggingConfigArgs' logging_config: The runtime logging config of the job
        :param builtins.str output_format: The format in which query output will be displayed. See the Presto documentation for supported output formats.
               
               * `logging_config.driver_log_levels`- (Required) The per-package log levels for the driver. This may include 'root' package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'
        :param Mapping[str, builtins.str] properties: A mapping of property names to values. Used to set Presto session properties Equivalent to using the --session flag in the Presto CLI.
        :param builtins.str query_file_uri: The HCFS URI of the script that contains SQL queries.
               Conflicts with `query_list`
        :param Sequence[builtins.str] query_lists: The list of SQL queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
        """
    ...
    def client_tags(self) -> Optional[Sequence[builtins.str]]:
        """
...
class JobPysparkConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str main_python_file_uri: The HCFS URI of the main Python file to use as the driver. Must be a .py file.
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted in the working directory of .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be copied to the working directory of Python drivers and distributed tasks. Useful for naively parallel tasks.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Python driver and tasks.
        :param 'JobPysparkConfigLoggingConfigArgs' logging_config: The runtime logging config of the job
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure PySpark. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/spark/conf/spark-defaults.conf` and classes in user code.
...
class JobReference(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str job_id: The job ID, which must be unique within the project. The job ID is generated by the server upon job submission or provided by the user as a means to perform retries without creating duplicate jobs
        """
...
class JobScheduling(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_failures_per_hour: Maximum number of times per hour a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed.
        :param builtins.int max_failures_total: Maximum number of times in total a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed.
        """
    ...
    def max_failures_per_hour(self) -> builtins.int:
        """
    ...
    def max_failures_total(self) -> builtins.int:
        """
...
class JobSparkConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted in the working directory of .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be copied to the working directory of Spark drivers and distributed tasks. Useful for naively parallel tasks.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Spark driver and tasks.
        :param 'JobSparkConfigLoggingConfigArgs' logging_config: The runtime logging config of the job
        :param builtins.str main_class: The class containing the main method of the driver. Must be in a
               provided jar or jar that is already on the classpath. Conflicts with `main_jar_file_uri`
        :param builtins.str main_jar_file_uri: The HCFS URI of jar file containing
               the driver jar. Conflicts with `main_class`
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Spark. Properties that conflict with values set by the Cloud Dataproc API may be overwritten. Can include properties set in `/etc/spark/conf/spark-defaults.conf` and classes in user code.
...
class JobSparksqlConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Spark SQL's SparkConf. Properties that conflict with values set by the Cloud Dataproc API may be overwritten.
        :param builtins.str query_file_uri: The HCFS URI of the script that contains SQL queries.
               Conflicts with `query_list`
        :param Sequence[builtins.str] query_lists: The list of SQL queries or statements to execute as part of the job.
               Conflicts with `query_file_uri`
...
class JobStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str details: Optional job state details, such as an error description if the state is ERROR.
        :param builtins.str state: A state message specifying the overall job state.
        :param builtins.str state_start_time: The time when this state was entered.
        :param builtins.str substate: Additional state information, which includes status reported by the agent.
        """
...
class MetastoreFederationBackendMetastore(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rank: builtins.str):
        """
        :param builtins.str metastore_type: The type of the backend metastore.
               Possible values are: `METASTORE_TYPE_UNSPECIFIED`, `DATAPROC_METASTORE`, `BIGQUERY`.
               
               - - -
        :param builtins.str name: The relative resource name of the metastore that is being federated. The formats of the relative resource names for the currently supported metastores are listed below: Dataplex: projects/{projectId}/locations/{location}/lakes/{lake_id} BigQuery: projects/{projectId} Dataproc Metastore: projects/{projectId}/locations/{location}/services/{serviceId}
        :param builtins.str rank: The identifier for this object. Format specified above.
        """
...
class MetastoreServiceEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key: The fully qualified customer provided Cloud KMS key name to use for customer data encryption.
...
class MetastoreServiceHiveMetastoreConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 config_overrides: Optional[Mapping[str, builtins.str]] = None,
                 endpoint_protocol: Optional[builtins.str] = None,
                 kerberos_config: Optional['outputs.MetastoreServiceHiveMetastoreConfigKerberosConfig'] = None):
        """
        :param builtins.str version: The Hive metastore schema version.
        :param Sequence['MetastoreServiceHiveMetastoreConfigAuxiliaryVersionArgs'] auxiliary_versions: A mapping of Hive metastore version to the auxiliary version configuration.
               ...
               Structure is documented below.
        :param Mapping[str, builtins.str] config_overrides: A mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore (configured in hive-site.xml).
               The mappings override system defaults (some keys cannot be overridden)
        :param builtins.str endpoint_protocol: The protocol to use for the metastore service endpoint. If unspecified, defaults to `THRIFT`.
    ...
    def config_overrides(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def endpoint_protocol(self) -> Optional[builtins.str]:
        """
...
class MetastoreServiceHiveMetastoreConfigAuxiliaryVersion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 config_overrides: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str key: The identifier for this object. Format specified above.
        :param builtins.str version: The Hive metastore version of the auxiliary service. It must be less than the primary Hive metastore service's version.
        :param Mapping[str, builtins.str] config_overrides: A mapping of Hive metastore configuration key-value pairs to apply to the auxiliary Hive metastore (configured in hive-site.xml) in addition to the primary version's overrides.
...
class MetastoreServiceHiveMetastoreConfigKerberosConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'MetastoreServiceHiveMetastoreConfigKerberosConfigKeytabArgs' keytab: A Kerberos keytab file that can be used to authenticate a service principal with a Kerberos Key Distribution Center (KDC).
               Structure is documented below.
        :param builtins.str krb5_config_gcs_uri: A Cloud Storage URI that specifies the path to a krb5.conf file. It is of the form gs://{bucket_name}/path/to/krb5.conf, although the file does not need to be named krb5.conf explicitly.
        :param builtins.str principal: A Kerberos principal that exists in the both the keytab the KDC to authenticate as. A typical principal is of the form "primary/instance@REALM", but there is no exact format.
        """
...
class MetastoreServiceHiveMetastoreConfigKerberosConfigKeytab(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cloud_secret: The relative resource name of a Secret Manager secret version, in the following form:
...
class MetastoreServiceMaintenanceWindow(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day_of_week: The day of week, when the window starts.
               Possible values are: `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY`, `SATURDAY`, `SUNDAY`.
        :param builtins.int hour_of_day: The hour of day (0-23) when the window starts.
        """
...
class MetastoreServiceMetadataIntegrationDataCatalogConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Defines whether the metastore metadata should be synced to Data Catalog. The default value is to disable syncing metastore metadata to Data Catalog.
        """
...
class MetastoreServiceNetworkConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_routes_enabled: Optional[builtins.bool] = None):
        """
        :param Sequence['MetastoreServiceNetworkConfigConsumerArgs'] consumers: The consumer-side network configuration for the Dataproc Metastore instance.
               Structure is documented below.
        :param builtins.bool custom_routes_enabled: Enables custom routes to be imported and exported for the Dataproc Metastore service's peered VPC network.
        """
    ...
    def custom_routes_enabled(self) -> Optional[builtins.bool]:
        """
...
class MetastoreServiceNetworkConfigConsumer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str subnetwork: The subnetwork of the customer project from which an IP address is reserved and used as the Dataproc Metastore service's endpoint.
               It is accessible to hosts in the subnet and to all hosts in a subnet in the same region and same network.
               There must be at least one IP address available in the subnet's primary range. The subnet is specified in the following form:
               `projects/{projectNumber}/regions/{region_id}/subnetworks/{subnetwork_id}
        :param builtins.str endpoint_uri: (Output)
...
class MetastoreServiceScalingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'MetastoreServiceScalingConfigAutoscalingConfigArgs' autoscaling_config: Represents the autoscaling configuration of a metastore service.
               Structure is documented below.
        :param builtins.str instance_size: Metastore instance sizes.
               Possible values are: `EXTRA_SMALL`, `SMALL`, `MEDIUM`, `LARGE`, `EXTRA_LARGE`.
        :param builtins.float scaling_factor: Scaling factor, in increments of 0.1 for values less than 1.0, and increments of 1.0 for values greater than 1.0.
        """
        if autoscaling_config is not None:
            pulumi.set(__self__, "autoscaling_config", autoscaling_config)
...
class MetastoreServiceScalingConfigAutoscalingConfig(dict):
    ...
    def __init__(__self__, *,
                 autoscaling_enabled: Optional[builtins.bool] = None,
                 autoscaling_factor: Optional[builtins.float] = None,
                 limit_config: Optional['outputs.MetastoreServiceScalingConfigAutoscalingConfigLimitConfig'] = None):
        """
        :param builtins.bool autoscaling_enabled: Defines whether autoscaling is enabled. The default value is false.
        :param builtins.float autoscaling_factor: (Output)
    ...
    def autoscaling_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def autoscaling_factor(self) -> Optional[builtins.float]:
        """
        (Output)
        Output only. The scaling factor of a service with autoscaling enabled.
        """
...
class MetastoreServiceScalingConfigAutoscalingConfigLimitConfig(dict):
    ...
    def __init__(__self__, *,
                 max_scaling_factor: Optional[builtins.float] = None,
                 min_scaling_factor: Optional[builtins.float] = None):
        """
        :param builtins.float max_scaling_factor: The maximum scaling factor that the service will autoscale to. The default value is 6.0.
        :param builtins.float min_scaling_factor: The minimum scaling factor that the service will autoscale to. The default value is 0.1.
        """
    ...
    def max_scaling_factor(self) -> Optional[builtins.float]:
        """
    ...
    def min_scaling_factor(self) -> Optional[builtins.float]:
        """
...
class MetastoreServiceScheduledBackup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cron_schedule: Optional[builtins.str] = None,
                 enabled: Optional[builtins.bool] = None,
                 time_zone: Optional[builtins.str] = None):
        """
        :param builtins.str backup_location: A Cloud Storage URI of a folder, in the format gs://<bucket_name>/<path_inside_bucket>. A sub-folder <backup_folder> containing backup files will be stored below it.
        :param builtins.str cron_schedule: The scheduled interval in Cron format, see https://en.wikipedia.org/wiki/Cron The default is empty: scheduled backup is not enabled. Must be specified to enable scheduled backups.
        :param builtins.bool enabled: Defines whether the scheduled backup is enabled. The default value is false.
        :param builtins.str time_zone: Specifies the time zone to be used when interpreting cronSchedule. Must be a time zone name from the time zone database (https://en.wikipedia.org/wiki/List_of_tz_database_time_zones), e.g. America/Los_Angeles or Africa/Abidjan. If left unspecified, the default is UTC.
        """
    ...
    def cron_schedule(self) -> Optional[builtins.str]:
        """
...
class MetastoreServiceTelemetryConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_format: The output format of the Dataproc Metastore service's logs.
...
class WorkflowTemplateEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
                 kms_key: Optional[builtins.str] = None):
        """
        :param builtins.str kms_key: Optional. The Cloud KMS key name to use for encryption.
        """
        if kms_key is not None:
            pulumi.set(__self__, "kms_key", kms_key)
...
class WorkflowTemplateJob(dict):
    ...
    def __init__(__self__, *,
                 ...
                 prerequisite_step_ids: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param builtins.str step_id: Required. The step id. The id must be unique among all jobs within the template. The step id is used as prefix for job id, as job `goog-dataproc-workflow-step-id` label, and in field from other steps. The id must contain only letters (a-z, A-Z), numbers (0-9), underscores (_), and hyphens (-). Cannot begin or end with underscore or hyphen. Must consist of between 3 and 50 characters.
        ...
        :param Mapping[str, builtins.str] labels: The labels to associate with this job. Label keys must be between 1 and 63 characters long, and must conform to the following regular expression: {0,63} No more than 32 labels can be associated with a given job.
        :param 'WorkflowTemplateJobPigJobArgs' pig_job: Job is a Pig job.
        :param Sequence[builtins.str] prerequisite_step_ids: The optional list of prerequisite job step_ids. If not specified, the job will start at the beginning of workflow.
    ...
    def prerequisite_step_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class WorkflowTemplateJobHadoopJob(dict):
    ...
    def __init__(__self__, *,
                 ...
                 properties: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted in the working directory of Hadoop drivers and tasks. Supported file types: .jar, .tar, .tar.gz, .tgz, or .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver. Do not include arguments, such as `-libjars` or `-Dfoo=bar`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param Sequence[builtins.str] file_uris: HCFS (Hadoop Compatible Filesystem) URIs of files to be copied to the working directory of Hadoop drivers and distributed tasks. Useful for naively parallel tasks.
        :param Sequence[builtins.str] jar_file_uris: Jar file URIs to add to the CLASSPATHs of the Hadoop driver and tasks.
        :param 'WorkflowTemplateJobHadoopJobLoggingConfigArgs' logging_config: The runtime log config for job execution.
        :param builtins.str main_class: The name of the driver's main class. The jar file containing the class must be in the default CLASSPATH or specified in `jar_file_uris`.
        :param builtins.str main_jar_file_uri: The HCFS URI of the jar file containing the main class. Examples: 'gs://foo-bucket/analytics-binaries/extract-useful-metrics-mr.jar' 'hdfs:/tmp/test-samples/custom-wordcount.jar' 'file:///home/usr/lib/hadoop-mapreduce/hadoop-mapreduce-examples.jar'
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Hadoop. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/hadoop/conf/*-site and classes in user code.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
...
class WorkflowTemplateJobHadoopJobLoggingConfig(dict):
    ...
    def __init__(__self__, *,
                 driver_log_levels: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Mapping[str, builtins.str] driver_log_levels: The per-package log levels for the driver. This may include "root" package name to configure rootLogger. Examples: 'com.google = FATAL', 'root = INFO', 'org.apache = DEBUG'
        """
    ...
    @property
    @pulumi.getter(name="driverLogLevels")
    def driver_log_levels(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class WorkflowTemplateJobHiveJob(dict):
    ...
    def __init__(__self__, *,
                 ...
                 script_variables: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.bool continue_on_failure: Whether to continue executing queries if a query fails. The default value is `false`. Setting to `true` can be useful when executing independent parallel queries.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATH of the Hive server and Hadoop MapReduce (MR) tasks. Can contain Hive SerDes and UDFs.
        :param Mapping[str, builtins.str] properties: A mapping of property names and values, used to configure Hive. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/hadoop/conf/*-site.xml, /etc/hive/conf/hive-site.xml, and classes in user code.
        :param builtins.str query_file_uri: The HCFS URI of the script that contains Hive queries.
...
class WorkflowTemplateJobHiveJobQueryList(dict):
    def __init__(__self__, *,
                 queries: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] queries: Required. The queries to execute. You do not need to end a query expression with a semicolon. Multiple queries can be specified in one string by separating each with a semicolon. Here is an example of a Dataproc API snippet that uses a QueryList to specify a HiveJob: "hiveJob": { "queryList": { "queries": } }
        """
        pulumi.set(__self__, "queries", queries)
...
class WorkflowTemplateJobPigJob(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Pig. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/hadoop/conf/*-site.xml, /etc/pig/conf/pig.properties, and classes in user code.
        :param builtins.str query_file_uri: The HCFS URI of the script that contains the Pig queries.
        :param 'WorkflowTemplateJobPigJobQueryListArgs' query_list: A list of queries.
        :param Mapping[str, builtins.str] script_variables: Mapping of query variable names to values (equivalent to the Pig command: `name=`).
        """
        if continue_on_failure is not None:
            pulumi.set(__self__, "continue_on_failure", continue_on_failure)
        if jar_file_uris is not None:
...
class WorkflowTemplateJobPrestoJob(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str output_format: The format in which query output will be displayed. See the Presto documentation for supported output formats
        :param Mapping[str, builtins.str] properties: A mapping of property names to values. Used to set Presto (https://prestodb.io/docs/current/sql/set-session.html) Equivalent to using the --session flag in the Presto CLI
        :param builtins.str query_file_uri: The HCFS URI of the script that contains SQL queries.
...
class WorkflowTemplateJobPysparkJob(dict):
    ...
    def __init__(__self__, *,
                 ...
                 python_file_uris: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str main_python_file_uri: Required. The HCFS URI of the main Python file to use as the driver. Must be a .py file.
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver. Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        :param Sequence[builtins.str] jar_file_uris: HCFS URIs of jar files to add to the CLASSPATHs of the Python driver and tasks.
        :param 'WorkflowTemplateJobPysparkJobLoggingConfigArgs' logging_config: The runtime log config for job execution.
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure PySpark. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/spark/conf/spark-defaults.conf and classes in user code.
        :param Sequence[builtins.str] python_file_uris: HCFS file URIs of Python files to pass to the PySpark framework. Supported file types: .py, .egg, and .zip.
        """
        pulumi.set(__self__, "main_python_file_uri", main_python_file_uri)
        if archive_uris is not None:
...
class WorkflowTemplateJobScheduling(dict):
    ...
    def __init__(__self__, *,
                 max_failures_per_hour: Optional[builtins.int] = None,
                 max_failures_total: Optional[builtins.int] = None):
        """
        :param builtins.int max_failures_per_hour: Maximum number of times per hour a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed. A job may be reported as thrashing if driver exits with non-zero code 4 times within 10 minute window. Maximum value is 10.
        :param builtins.int max_failures_total: Maximum number of times in total a driver may be restarted as a result of driver exiting with non-zero code before job is reported failed. Maximum value is 240
        """
    ...
    @property
    @pulumi.getter(name="maxFailuresPerHour")
    def max_failures_per_hour(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter(name="maxFailuresTotal")
    def max_failures_total(self) -> Optional[builtins.int]:
        """
...
class WorkflowTemplateJobSparkJob(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str main_class: The name of the driver's main class. The jar file that contains the class must be in the default CLASSPATH or specified in `jar_file_uris`.
        :param builtins.str main_jar_file_uri: The HCFS URI of the jar file that contains the main class.
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Spark. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/spark/conf/spark-defaults.conf and classes in user code.
        """
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
        if args is not None:
...
class WorkflowTemplateJobSparkRJob(dict):
    ...
    def __init__(__self__, *,
                 ...
                 properties: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str main_r_file_uri: Required. The HCFS URI of the main R file to use as the driver. Must be a .R file.
        :param Sequence[builtins.str] archive_uris: HCFS URIs of archives to be extracted into the working directory of each executor. Supported file types: .jar, .tar, .tar.gz, .tgz, and .zip.
        :param Sequence[builtins.str] args: The arguments to pass to the driver. Do not include arguments, such as `--conf`, that can be set as job properties, since a collision may occur that causes an incorrect job submission.
        :param Sequence[builtins.str] file_uris: HCFS URIs of files to be placed in the working directory of each executor. Useful for naively parallel tasks.
        :param 'WorkflowTemplateJobSparkRJobLoggingConfigArgs' logging_config: The runtime log config for job execution.
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure SparkR. Properties that conflict with values set by the Dataproc API may be overwritten. Can include properties set in /etc/spark/conf/spark-defaults.conf and classes in user code.
        """
        pulumi.set(__self__, "main_r_file_uri", main_r_file_uri)
        if archive_uris is not None:
            pulumi.set(__self__, "archive_uris", archive_uris)
...
class WorkflowTemplateJobSparkSqlJob(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] properties: A mapping of property names to values, used to configure Spark SQL's SparkConf. Properties that conflict with values set by the Dataproc API may be overwritten.
        :param builtins.str query_file_uri: The HCFS URI of the script that contains SQL queries.
...
class WorkflowTemplateParameter(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] fields: Required. Paths to all fields that the parameter replaces. A field is allowed to appear in at most one parameter's list of field paths. A field path is similar in syntax to a .sparkJob.args
        :param builtins.str name: Required. Parameter name. The parameter name is used as the key, and paired with the parameter value, which are passed to the template when the template is instantiated. The name must contain only capital letters (A-Z), numbers (0-9), and underscores (_), and must not start with a number. The maximum length is 40 characters.
        :param builtins.str description: Brief description of the parameter. Must not exceed 1024 characters.
...
class WorkflowTemplateParameterValidationRegex(dict):
    def __init__(__self__, *,
                 regexes: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] regexes: Required. RE2 regular expressions used to validate the parameter's value. The value must match the regex in its entirety (substring matches are not sufficient).
        """
        pulumi.set(__self__, "regexes", regexes)

    @property
    @pulumi.getter
    def regexes(self) -> Sequence[builtins.str]:
        """
...
class WorkflowTemplateParameterValidationValues(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] values: Required. List of allowed values for the parameter.
        """
        pulumi.set(__self__, "values", values)
...
class WorkflowTemplatePlacementClusterSelector(dict):
    ...
    def __init__(__self__, *,
                 cluster_labels: Mapping[str, builtins.str],
                 zone: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] cluster_labels: Required. The cluster labels. Cluster must have all labels to match.
        :param builtins.str zone: The zone where workflow process executes. This parameter does not affect the selection of the cluster. If unspecified, the zone of the first cluster matching the selector is used.
        """
    ...
    def cluster_labels(self) -> Mapping[str, builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedCluster(dict):
    ...
    def __init__(__self__, *,
                 ...
                 labels: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str cluster_name: Required. The cluster name prefix. A unique cluster name will be formed by appending a random suffix. The name must contain only lower-case letters (a-z), numbers (0-9), and hyphens (-). Must begin with a letter. Cannot begin or end with hyphen. Must consist of between 2 and 35 characters.
        :param 'WorkflowTemplatePlacementManagedClusterConfigArgs' config: Required. The cluster configuration.
        :param Mapping[str, builtins.str] labels: The labels to associate with this cluster. Label keys must be between 1 and 63 characters long, and must conform to the following PCRE regular expression: {0,63} No more than 32 labels can be associated with a given cluster.
        """
        pulumi.set(__self__, "cluster_name", cluster_name)
        pulumi.set(__self__, "config", config)
        if labels is not None:
...
class WorkflowTemplatePlacementManagedClusterConfigAutoscalingConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy: The autoscaling policy used by the cluster. Only resource names including projectid and location (region) are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/` Note that the policy must be in the same project and Dataproc region.
        """
...
class WorkflowTemplatePlacementManagedClusterConfigEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
                 gce_pd_kms_key_name: Optional[builtins.str] = None):
        """
        :param builtins.str gce_pd_kms_key_name: The Cloud KMS key name to use for PD disk encryption for all instances in the cluster.
        """
    ...
    def gce_pd_kms_key_name(self) -> Optional[builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigEndpointConfig(dict):
    ...
    def __init__(__self__, *,
                 enable_http_port_access: Optional[builtins.bool] = None,
                 http_ports: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.bool enable_http_port_access: If true, enable http access to specific ports on the cluster from external sources. Defaults to false.
        :param Mapping[str, builtins.str] http_ports: Output only. The map of port descriptions to URLs. Will only be populated if enable_http_port_access is true.
        """
    ...
    @property
    @pulumi.getter(name="enableHttpPortAccess")
    def enable_http_port_access(self) -> Optional[builtins.bool]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_ipv6_google_access: Optional[builtins.str] = None,
                 ...
                 zone: Optional[builtins.str] = None):
        """
        :param builtins.bool internal_ip_only: If true, all instances in the cluster will only have internal IP addresses. By default, clusters are not restricted to internal IP addresses, and will have ephemeral external IP addresses assigned to each instance. This `internal_ip_only` restriction can only be enabled for subnetwork enabled networks, and all off-cluster dependencies must be configured to be accessible without external IP addresses.
        :param Mapping[str, builtins.str] metadata: The Compute Engine metadata entries to add to all instances (see [About VM metadata](https://cloud.google.com/compute/docs/metadata/overview)).
        :param builtins.str network: The Compute Engine network to be used for machine communications. Cannot be specified with subnetwork_uri. If neither `network_uri` nor `subnetwork_uri` is specified, the "default" network of the project is used, if it exists. Cannot be a "Custom Subnet Network" (see /regions/global/default` * `default`
        ...
        :param builtins.str private_ipv6_google_access: The type of IPv6 access for a cluster. Possible values: PRIVATE_IPV6_GOOGLE_ACCESS_UNSPECIFIED, INHERIT_FROM_SUBNETWORK, OUTBOUND, BIDIRECTIONAL
        ...
        :param builtins.str service_account: The (https://cloud.google.com/compute/docs/access/service-accounts#default_service_account) is used.
        :param Sequence[builtins.str] service_account_scopes: The URIs of service account scopes to be included in Compute Engine instances. The following base set of scopes is always included: * https://www.googleapis.com/auth/cloud.useraccounts.readonly * https://www.googleapis.com/auth/devstorage.read_write * https://www.googleapis.com/auth/logging.write If no scopes are specified, the following defaults are also provided: * https://www.googleapis.com/auth/bigquery * https://www.googleapis.com/auth/bigtable.admin.table * https://www.googleapis.com/auth/bigtable.data * https://www.googleapis.com/auth/devstorage.full_control
        ...
        :param builtins.str subnetwork: The Compute Engine subnetwork to be used for machine communications. Cannot be specified with network_uri. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects//regions/us-east1/subnetworks/sub0` * `sub0`
        :param Sequence[builtins.str] tags: The Compute Engine tags to add to all instances (see [Manage tags for resources](https://cloud.google.com/compute/docs/tag-resources)).
        :param builtins.str zone: The zone where the Compute Engine cluster will be located. On a create request, it is required in the "global" region. If omitted in a non-global Dataproc region, the service will pick a zone in the corresponding Compute Engine region. On a get request, zone will always be present. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/` * `us-central1-f`
        """
        if internal_ip_only is not None:
            pulumi.set(__self__, "internal_ip_only", internal_ip_only)
        if metadata is not None:
    ...
    def private_ipv6_google_access(self) -> Optional[builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str node_group: Required. The URI of a sole-tenant /zones/us-central1-a/nodeGroups/node-group-1` * `node-group-1`
        """
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str consume_reservation_type: Type of reservation to consume Possible values: TYPE_UNSPECIFIED, NO_RESERVATION, ANY_RESERVATION, SPECIFIC_RESERVATION
        :param builtins.str key: Corresponds to the label key of reservation resource.
        :param Sequence[builtins.str] values: Corresponds to the label values of reservation resource.
        """
        if consume_reservation_type is not None:
...
class WorkflowTemplatePlacementManagedClusterConfigGceClusterConfigShieldedInstanceConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_vtpm: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_integrity_monitoring: Defines whether instances have [Integrity Monitoring](https://cloud.google.com/compute/shielded-vm/docs/shielded-vm#integrity-monitoring) enabled.
        :param builtins.bool enable_secure_boot: Defines whether instances have [Secure Boot](https://cloud.google.com/compute/shielded-vm/docs/shielded-vm#secure-boot) enabled.
        :param builtins.bool enable_vtpm: Defines whether instances have the [vTPM](https://cloud.google.com/compute/shielded-vm/docs/shielded-vm#vtpm) enabled.
        """
        if enable_integrity_monitoring is not None:
            pulumi.set(__self__, "enable_integrity_monitoring", enable_integrity_monitoring)
        if enable_secure_boot is not None:
...
class WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(dict):
    ...
    def __init__(__self__, *,
                 cluster_namespace: Optional[builtins.str] = None,
                 target_gke_cluster: Optional[builtins.str] = None):
        """
        :param builtins.str cluster_namespace: A namespace within the GKE cluster to deploy into.
        :param builtins.str target_gke_cluster: The target GKE cluster to deploy to. Format: 'projects/{project}/locations/{location}/clusters/{cluster_id}'
        """
    ...
    def cluster_namespace(self) -> Optional[builtins.str]:
        """
    ...
    def target_gke_cluster(self) -> Optional[builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigInitializationAction(dict):
    ...
    def executable_file(self) -> Optional[builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigLifecycleConfig(dict):
    ...
    def __init__(__self__, *,
                 auto_delete_time: Optional[builtins.str] = None,
                 auto_delete_ttl: Optional[builtins.str] = None,
                 idle_delete_ttl: Optional[builtins.str] = None,
                 idle_start_time: Optional[builtins.str] = None):
        """
        :param builtins.str auto_delete_time: The time when cluster will be auto-deleted (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)).
        :param builtins.str auto_delete_ttl: The lifetime duration of cluster. The cluster will be auto-deleted at the end of this period. Minimum value is 10 minutes; maximum value is 14 days (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)).
        :param builtins.str idle_delete_ttl: The duration to keep the cluster alive while idling (when no jobs are running). Passing this threshold will cause the cluster to be deleted. Minimum value is 5 minutes; maximum value is 14 days (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json).
        :param builtins.str idle_start_time: Output only. The time when cluster became idle (most recent job finished) and became eligible for deletion due to idleness (see JSON representation of [JSON Mapping - Language Guide (proto 3)](https://developers.google.com/protocol-buffers/docs/proto3#json)).
        """
        if auto_delete_time is not None:
            pulumi.set(__self__, "auto_delete_time", auto_delete_time)
    ...
    def auto_delete_ttl(self) -> Optional[builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 instance_names: Optional[Sequence[builtins.str]] = None,
                 is_preemptible: Optional[builtins.bool] = None,
                 machine_type: Optional[builtins.str] = None,
        ...
        :param builtins.str image: The Compute Engine image resource used for cluster instances. The URI can represent an image or image family. Image examples: * `https://www.googleapis.com/compute/beta/projects/` If the URI is unspecified, it will be inferred from `SoftwareConfig.image_version` or the system default.
        :param Sequence[builtins.str] instance_names: Output only. The list of instance names. Dataproc derives the names from `cluster_name`, `num_instances`, and the instance group.
        :param builtins.bool is_preemptible: Output only. Specifies that this instance group contains preemptible instances.
        :param builtins.str machine_type: The Compute Engine machine type used for cluster instances. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/(https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the machine type resource, for example, `n1-standard-2`.
        ...
        :param builtins.str min_cpu_platform: Specifies the minimum cpu platform for the Instance Group. See [Minimum CPU platform](https://cloud.google.com/dataproc/docs/concepts/compute/dataproc-min-cpu).
        :param builtins.int num_instances: The number of VM instances in the instance group. For master instance groups, must be set to 1.
        :param builtins.str preemptibility: Specifies the preemptibility of the instance group. The default value for master and worker groups is `NON_PREEMPTIBLE`. This default cannot be changed. The default value for secondary instances is `PREEMPTIBLE`. Possible values: PREEMPTIBILITY_UNSPECIFIED, NON_PREEMPTIBLE, PREEMPTIBLE
        """
        if accelerators is not None:
            pulumi.set(__self__, "accelerators", accelerators)
        if disk_config is not None:
    ...
    def is_preemptible(self) -> Optional[builtins.bool]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerator(dict):
    ...
    def __init__(__self__, *,
                 ...
                 accelerator_type: Optional[builtins.str] = None):
        """
        :param builtins.int accelerator_count: The number of the accelerator cards of this type exposed to this instance.
        :param builtins.str accelerator_type: Full URL, partial URI, or short name of the accelerator type resource to expose to this instance. See (https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the accelerator type resource, for example, `nvidia-tesla-k80`.
        """
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 num_local_ssds: Optional[builtins.int] = None):
        """
        :param builtins.int boot_disk_size_gb: Size in GB of the boot disk (default is 500GB).
        :param builtins.str boot_disk_type: Type of the boot disk (default is "pd-standard"). Valid values: "pd-ssd" (Persistent Disk Solid State Drive) or "pd-standard" (Persistent Disk Hard Disk Drive).
        :param builtins.int num_local_ssds: Number of attached SSDs, from 0 to 4 (default is 0). If SSDs are not attached, the boot disk is used to store runtime logs and (https://hadoop.apache.org/docs/r1.2.1/hdfs_user_guide.html) data. If one or more SSDs are attached, this runtime bulk data is spread across them, and the boot disk contains only basic config and installed binaries.
        """
        if boot_disk_size_gb is not None:
            pulumi.set(__self__, "boot_disk_size_gb", boot_disk_size_gb)
        if boot_disk_type is not None:
...
class WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig(dict):
    ...
    def __init__(__self__, *,
                 instance_group_manager_name: Optional[builtins.str] = None,
                 instance_template_name: Optional[builtins.str] = None):
        """
        :param builtins.str instance_group_manager_name: Output only. The name of the Instance Group Manager for this group.
        :param builtins.str instance_template_name: Output only. The name of the Instance Template used for the Managed Instance Group.
        """
    ...
    def instance_group_manager_name(self) -> Optional[builtins.str]:
        """
    ...
    def instance_template_name(self) -> Optional[builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig(dict):
    ...
    def __init__(__self__, *,
                 dataproc_metastore_service: builtins.str):
        """
        :param builtins.str dataproc_metastore_service: Required. Resource name of an existing Dataproc Metastore service. Example: * `projects/`
        """
        pulumi.set(__self__, "dataproc_metastore_service", dataproc_metastore_service)
...
class WorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str image: Optional. The Compute Engine image resource used for cluster instances. The URI can represent an image or image family. Image examples: * `https://www.googleapis.com/compute/beta/projects/[project_id]/global/images/[image-id]` * `projects/[project_id]/global/images/[image-id]` * `image-id` Image family examples. Dataproc will use the most recent image from the family: * `https://www.googleapis.com/compute/beta/projects/[project_id]/global/images/family/[custom-image-family-name]` * `projects/[project_id]/global/images/family/[custom-image-family-name]` If the URI is unspecified, it will be inferred from `SoftwareConfig.image_version` or the system default.
        :param Sequence[builtins.str] instance_names: Output only. The list of instance names. Dataproc derives the names from `cluster_name`, `num_instances`, and the instance group.
        :param builtins.bool is_preemptible: Output only. Specifies that this instance group contains preemptible instances.
        :param builtins.str machine_type: Optional. The Compute Engine machine type used for cluster instances. A full URL, partial URI, or short name are valid. Examples: * `https://www.googleapis.com/compute/v1/projects/[project_id]/zones/us-east1-a/machineTypes/n1-standard-2` * `projects/[project_id]/zones/us-east1-a/machineTypes/n1-standard-2` * `n1-standard-2` **Auto Zone Exception**: If you are using the Dataproc [Auto Zone Placement](https://cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone#using_auto_zone_placement) feature, you must use the short name of the machine type resource, for example, `n1-standard-2`.
        ...
        :param builtins.str min_cpu_platform: Optional. Specifies the minimum cpu platform for the Instance Group. See [Dataproc > Minimum CPU Platform](https://cloud.google.com/dataproc/docs/concepts/compute/dataproc-min-cpu).
        :param builtins.int num_instances: Optional. The number of VM instances in the instance group. For [HA cluster](https://www.terraform.io/dataproc/docs/concepts/configuring-clusters/high-availability) master_config groups, **must be set to 3**. For standard cluster master_config groups, **must be set to 1**.
        :param builtins.str preemptibility: Optional. Specifies the preemptibility of the instance group. The default value for master and worker groups is `NON_PREEMPTIBLE`. This default cannot be changed. The default value for secondary instances is `PREEMPTIBLE`. Possible values: PREEMPTIBILITY_UNSPECIFIED, NON_PREEMPTIBLE, PREEMPTIBLE
        """
        if accelerators is not None:
            pulumi.set(__self__, "accelerators", accelerators)
        if disk_config is not None:
...
class WorkflowTemplatePlacementManagedClusterConfigSecurityConfigKerberosConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cross_realm_trust_kdc: Optional[builtins.str] = None,
                 cross_realm_trust_realm: Optional[builtins.str] = None,
                 cross_realm_trust_shared_password: Optional[builtins.str] = None,
                 enable_kerberos: Optional[builtins.bool] = None,
                 kdc_db_key: Optional[builtins.str] = None,
                 key_password: Optional[builtins.str] = None,
                 keystore: Optional[builtins.str] = None,
                 keystore_password: Optional[builtins.str] = None,
                 kms_key: Optional[builtins.str] = None,
                 realm: Optional[builtins.str] = None,
                 root_principal_password: Optional[builtins.str] = None,
                 tgt_lifetime_hours: Optional[builtins.int] = None,
                 truststore: Optional[builtins.str] = None,
                 truststore_password: Optional[builtins.str] = None):
        """
        :param builtins.str cross_realm_trust_admin_server: The admin server (IP or hostname) for the remote trusted realm in a cross realm trust relationship.
        :param builtins.str cross_realm_trust_kdc: The KDC (IP or hostname) for the remote trusted realm in a cross realm trust relationship.
        :param builtins.str cross_realm_trust_realm: The remote realm the Dataproc on-cluster KDC will trust, should the user enable cross realm trust.
        :param builtins.str cross_realm_trust_shared_password: The Cloud Storage URI of a KMS encrypted file containing the shared password between the on-cluster Kerberos realm and the remote trusted realm, in a cross realm trust relationship.
        :param builtins.bool enable_kerberos: Flag to indicate whether to Kerberize the cluster (default: false). Set this field to true to enable Kerberos on a cluster.
        :param builtins.str kdc_db_key: The Cloud Storage URI of a KMS encrypted file containing the master key of the KDC database.
        :param builtins.str key_password: The Cloud Storage URI of a KMS encrypted file containing the password to the user provided key. For the self-signed certificate, this password is generated by Dataproc.
        :param builtins.str keystore: The Cloud Storage URI of the keystore file used for SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
        :param builtins.str keystore_password: The Cloud Storage URI of a KMS encrypted file containing the password to the user provided keystore. For the self-signed certificate, this password is generated by Dataproc.
        :param builtins.str kms_key: The uri of the KMS key used to encrypt various sensitive files.
        :param builtins.str realm: The name of the on-cluster Kerberos realm. If not specified, the uppercased domain of hostnames will be the realm.
        :param builtins.str root_principal_password: The Cloud Storage URI of a KMS encrypted file containing the root principal password.
        :param builtins.int tgt_lifetime_hours: The lifetime of the ticket granting ticket, in hours. If not specified, or user specifies 0, then default value 10 will be used.
        :param builtins.str truststore: The Cloud Storage URI of the truststore file used for SSL encryption. If not provided, Dataproc will provide a self-signed certificate.
        :param builtins.str truststore_password: The Cloud Storage URI of a KMS encrypted file containing the password to the user provided truststore. For the self-signed certificate, this password is generated by Dataproc.
        """
        if cross_realm_trust_admin_server is not None:
            pulumi.set(__self__, "cross_realm_trust_admin_server", cross_realm_trust_admin_server)
        if cross_realm_trust_kdc is not None:
    ...
    def cross_realm_trust_shared_password(self) -> Optional[builtins.str]:
        """
    ...
    def kdc_db_key(self) -> Optional[builtins.str]:
        """
    ...
    def key_password(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def keystore(self) -> Optional[builtins.str]:
        """
    ...
    def keystore_password(self) -> Optional[builtins.str]:
        """
    ...
    def root_principal_password(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def truststore(self) -> Optional[builtins.str]:
        """
    ...
    def truststore_password(self) -> Optional[builtins.str]:
        """
...
class WorkflowTemplatePlacementManagedClusterConfigSoftwareConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 properties: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str image_version: The version of software inside the cluster. It must be one of the supported [Dataproc Versions](https://cloud.google.com/dataproc/docs/concepts/versioning/dataproc-versions#supported_dataproc_versions), such as "1.2" (including a subminor version, such as "1.2.29"), or the ["preview" version](https://cloud.google.com/dataproc/docs/concepts/versioning/dataproc-versions#other_versions). If unspecified, it defaults to the latest Debian version.
        :param Sequence[builtins.str] optional_components: The set of components to activate on the cluster.
        :param Mapping[str, builtins.str] properties: The properties to set on daemon config files.
...
class GetMetastoreServiceHiveMetastoreConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 config_overrides: Mapping[str, builtins.str],
                 endpoint_protocol: builtins.str,
        ...
        :param Mapping[str, builtins.str] config_overrides: A mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore (configured in hive-site.xml).
               The mappings override system defaults (some keys cannot be overridden)
        :param builtins.str endpoint_protocol: The protocol to use for the metastore service endpoint. If unspecified, defaults to 'THRIFT'. Default value: "THRIFT" Possible values: ["THRIFT", "GRPC"]
    ...
    @property
    @pulumi.getter(name="configOverrides")
    def config_overrides(self) -> Mapping[str, builtins.str]:
        """
        A mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore (configured in hive-site.xml).
        The mappings override system defaults (some keys cannot be overridden)
        """
...
class GetMetastoreServiceMaintenanceWindowResult(dict):
    def __init__(__self__, *,
                 ...
                 hour_of_day: builtins.int):
        """
        :param builtins.str day_of_week: The day of week, when the window starts. Possible values: ["MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY"]
        :param builtins.int hour_of_day: The hour of day (0-23) when the window starts.
        """
        pulumi.set(__self__, "day_of_week", day_of_week)
        pulumi.set(__self__, "hour_of_day", hour_of_day)
...
class GetMetastoreServiceNetworkConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 custom_routes_enabled: builtins.bool):
        """
    ...
    @property
    @pulumi.getter(name="customRoutesEnabled")
    def custom_routes_enabled(self) -> builtins.bool:
        """
        Enables custom routes to be imported and exported for the Dataproc Metastore service's peered VPC network.
        """
        return pulumi.get(self, "custom_routes_enabled")
...
class GetMetastoreServiceNetworkConfigConsumerResult(dict):
    def __init__(__self__, *,
                 ...
                 subnetwork: builtins.str):
        """
        :param builtins.str endpoint_uri: The URI of the endpoint used to access the metastore service.
        :param builtins.str subnetwork: The subnetwork of the customer project from which an IP address is reserved and used as the Dataproc Metastore service's endpoint.
               It is accessible to hosts in the subnet and to all hosts in a subnet in the same region and same network.
               There must be at least one IP address available in the subnet's primary range. The subnet is specified in the following form:
               'projects/{projectNumber}/regions/{region_id}/subnetworks/{subnetwork_id}
...
class GetMetastoreServiceScalingConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str instance_size: Metastore instance sizes. Possible values: ["EXTRA_SMALL", "SMALL", "MEDIUM", "LARGE", "EXTRA_LARGE"]
        :param builtins.float scaling_factor: Scaling factor, in increments of 0.1 for values less than 1.0, and increments of 1.0 for values greater than 1.0.
        """
...
class GetMetastoreServiceScalingConfigAutoscalingConfigResult(dict):
    def __init__(__self__, *,
                 autoscaling_enabled: builtins.bool,
                 autoscaling_factor: builtins.float,
                 limit_configs: Sequence['outputs.GetMetastoreServiceScalingConfigAutoscalingConfigLimitConfigResult']):
        """
        :param builtins.bool autoscaling_enabled: Defines whether autoscaling is enabled. The default value is false.
        :param builtins.float autoscaling_factor: Output only. The scaling factor of a service with autoscaling enabled.
    ...
    @property
    @pulumi.getter(name="autoscalingEnabled")
    def autoscaling_enabled(self) -> builtins.bool:
        """
        Defines whether autoscaling is enabled. The default value is false.
        """
        return pulumi.get(self, "autoscaling_enabled")
    ...
    @property
    @pulumi.getter(name="autoscalingFactor")
    def autoscaling_factor(self) -> builtins.float:
        """
        Output only. The scaling factor of a service with autoscaling enabled.
        """
        return pulumi.get(self, "autoscaling_factor")
...
class GetMetastoreServiceScalingConfigAutoscalingConfigLimitConfigResult(dict):
    def __init__(__self__, *,
                 max_scaling_factor: builtins.float,
                 min_scaling_factor: builtins.float):
        """
        :param builtins.float max_scaling_factor: The maximum scaling factor that the service will autoscale to. The default value is 6.0.
        :param builtins.float min_scaling_factor: The minimum scaling factor that the service will autoscale to. The default value is 0.1.
        """
    ...
    @property
    @pulumi.getter(name="maxScalingFactor")
    def max_scaling_factor(self) -> builtins.float:
        """
        The maximum scaling factor that the service will autoscale to. The default value is 6.0.
        """
        return pulumi.get(self, "max_scaling_factor")
    ...
    @property
    @pulumi.getter(name="minScalingFactor")
    def min_scaling_factor(self) -> builtins.float:
        """
        The minimum scaling factor that the service will autoscale to. The default value is 0.1.
        """
        return pulumi.get(self, "min_scaling_factor")
...
class GetMetastoreServiceTelemetryConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_format: The output format of the Dataproc Metastore service's logs. Default value: "JSON" Possible values: ["LEGACY", "JSON"]
        """
        pulumi.set(__self__, "log_format", log_format)
