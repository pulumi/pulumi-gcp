...
def get_job_iam_policy(job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str job_id: The name or relative resource id of the job to manage IAM policies for.
    """
    __args__ = dict()
...
def get_job_iam_policy_output(job_id: Optional[pulumi.Input[builtins.str]] = None,
