...
def get_metastore_federation_iam_policy(federation_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str federation_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location where the metastore federation should reside.
...
def get_metastore_federation_iam_policy_output(federation_id: Optional[pulumi.Input[_builtins.str]] = None,
