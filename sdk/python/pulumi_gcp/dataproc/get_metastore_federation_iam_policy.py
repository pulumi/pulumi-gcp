...
def get_metastore_federation_iam_policy(federation_id: Optional[builtins.str] = None,
...
def get_metastore_federation_iam_policy_output(federation_id: Optional[pulumi.Input[builtins.str]] = None,
