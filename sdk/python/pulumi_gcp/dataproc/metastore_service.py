...
class MetastoreServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database_type: The database type that the Metastore service stores its data.
               Default value is `MYSQL`.
               Possible values are: `MYSQL`, `SPANNER`.
        :param pulumi.Input[builtins.bool] deletion_protection: Indicates if the dataproc metastore should be protected against accidental deletions.
        ...
        :param pulumi.Input['MetastoreServiceHiveMetastoreConfigArgs'] hive_metastore_config: Configuration information specific to running Hive metastore software as the metastore service.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User-defined labels for the metastore service.
        ...
        :param pulumi.Input['MetastoreServiceMetadataIntegrationArgs'] metadata_integration: The setting that defines how metastore metadata should be integrated with external services and systems.
               Structure is documented below.
        :param pulumi.Input[builtins.str] network: The relative resource name of the VPC network on which the instance can be accessed. It is specified in the following form:
        ...
        :param pulumi.Input['MetastoreServiceNetworkConfigArgs'] network_config: The configuration specifying the network settings for the Dataproc Metastore service.
               Structure is documented below.
        :param pulumi.Input[builtins.int] port: The TCP port at which the metastore service is reached. Default: 9083.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] release_channel: The release channel of the service. If unspecified, defaults to `STABLE`.
...
class _MetastoreServiceState:
    def __init__(__self__, *,
                 artifact_gcs_uri: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] artifact_gcs_uri: A Cloud Storage URI (starting with gs://) that specifies where artifacts related to the metastore service are stored.
        :param pulumi.Input[builtins.str] create_time: Output only. The time when the metastore service was created.
        :param pulumi.Input[builtins.str] database_type: The database type that the Metastore service stores its data.
               Default value is `MYSQL`.
               Possible values are: `MYSQL`, `SPANNER`.
        :param pulumi.Input[builtins.bool] deletion_protection: Indicates if the dataproc metastore should be protected against accidental deletions.
        ...
        :param pulumi.Input['MetastoreServiceEncryptionConfigArgs'] encryption_config: Information used to configure the Dataproc Metastore service to encrypt
               customer data at rest.
               Structure is documented below.
        :param pulumi.Input[builtins.str] endpoint_uri: The URI of the endpoint used to access the metastore service.
        :param pulumi.Input['MetastoreServiceHiveMetastoreConfigArgs'] hive_metastore_config: Configuration information specific to running Hive metastore software as the metastore service.
               Structure is documented below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User-defined labels for the metastore service.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
        ...
        :param pulumi.Input['MetastoreServiceMetadataIntegrationArgs'] metadata_integration: The setting that defines how metastore metadata should be integrated with external services and systems.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: The relative resource name of the metastore service.
        :param pulumi.Input[builtins.str] network: The relative resource name of the VPC network on which the instance can be accessed. It is specified in the following form:
               "projects/{projectNumber}/global/networks/{network_id}".
        :param pulumi.Input['MetastoreServiceNetworkConfigArgs'] network_config: The configuration specifying the network settings for the Dataproc Metastore service.
               Structure is documented below.
        ...
        :param pulumi.Input[builtins.str] tier: The tier of the service.
               Possible values are: `DEVELOPER`, `ENTERPRISE`.
        :param pulumi.Input[builtins.str] uid: The globally unique resource identifier of the metastore service.
        :param pulumi.Input[builtins.str] update_time: Output only. The time when the metastore service was last updated.
        """
    ...
    def artifact_gcs_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def artifact_gcs_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MetastoreService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tier: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'MetastoreService':
        """
    ...
    @property
    @pulumi.getter(name="artifactGcsUri")
    def artifact_gcs_uri(self) -> pulumi.Output[builtins.str]:
        """
        A Cloud Storage URI (starting with gs://) that specifies where artifacts related to the metastore service are stored.
        """
        return pulumi.get(self, "artifact_gcs_uri")
    ...
    @property
    @pulumi.getter(name="databaseType")
    def database_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The database type that the Metastore service stores its data.
        Default value is `MYSQL`.
        Possible values are: `MYSQL`, `SPANNER`.
    ...
    @property
    @pulumi.getter(name="endpointUri")
    def endpoint_uri(self) -> pulumi.Output[builtins.str]:
        """
        The URI of the endpoint used to access the metastore service.
        """
        return pulumi.get(self, "endpoint_uri")
    ...
    @property
    @pulumi.getter(name="releaseChannel")
    def release_channel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The release channel of the service. If unspecified, defaults to `STABLE`.
        Default value is `STABLE`.
        Possible values are: `CANARY`, `STABLE`.
