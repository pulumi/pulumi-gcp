...
class EnvironmentIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['EnvironmentIamMemberConditionArgs']] = None):
        """
        The set of arguments for constructing a EnvironmentIamMember resource.

        :param pulumi.Input[_builtins.str] env_id: Used to find the parent resource to bind the IAM policy to
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['EnvironmentIamMemberConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['EnvironmentIamMemberConditionArgs']]):
...
class EnvironmentIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['EnvironmentIamMemberConditionArgs', 'EnvironmentIamMemberConditionArgsDict', 'outputs.EnvironmentIamMemberCondition']]] = None,
                 env_id: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `apigee.EnvironmentIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the environment are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `apigee.EnvironmentIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the environment are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            member: pulumi.Input[Optional[_builtins.str]] = None,
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'EnvironmentIamMember':
        """
