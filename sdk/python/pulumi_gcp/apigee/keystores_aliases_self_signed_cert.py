...
class KeystoresAliasesSelfSignedCertArgs:
    def __init__(__self__, *,
                 ...
                 sig_alg: pulumi.Input[builtins.str],
                 subject: pulumi.Input['KeystoresAliasesSelfSignedCertSubjectArgs'],
                 cert_validity_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 key_size: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] alias: Alias for the key/certificate pair. Values must match the regular expression [\\w\\s-.]{1,255}.
               This must be provided for all formats except selfsignedcert; self-signed certs may specify the alias in either
               this parameter or the JSON body.
        :param pulumi.Input[builtins.str] environment: The Apigee environment name
        :param pulumi.Input[builtins.str] keystore: The Apigee keystore name associated in an Apigee environment
        :param pulumi.Input[builtins.str] org_id: The Apigee Organization name associated with the Apigee environment
        :param pulumi.Input[builtins.str] sig_alg: Signature algorithm to generate private key. Valid values are SHA512withRSA, SHA384withRSA, and SHA256withRSA
        :param pulumi.Input['KeystoresAliasesSelfSignedCertSubjectArgs'] subject: Subject details.
               Structure is documented below.
        :param pulumi.Input[builtins.int] cert_validity_in_days: Validity duration of certificate, in days. Accepts positive non-zero value. Defaults to 365.
        :param pulumi.Input[builtins.str] key_size: Key size. Default and maximum value is 2048 bits.
    ...
    def sig_alg(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sig_alg.setter
    def sig_alg(self, value: pulumi.Input[builtins.str]):
    ...
    def cert_validity_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cert_validity_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cert_validity_in_days", value)

    @property
    @pulumi.getter(name="keySize")
    def key_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @key_size.setter
    def key_size(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KeystoresAliasesSelfSignedCertState:
    def __init__(__self__, *,
                 ...
                 sig_alg: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="sigAlg")
    def sig_alg(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Signature algorithm to generate private key. Valid values are SHA512withRSA, SHA384withRSA, and SHA256withRSA
        """
        return pulumi.get(self, "sig_alg")
    ...
    @sig_alg.setter
    def sig_alg(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sig_alg", value)
...
class KeystoresAliasesSelfSignedCert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subject: Optional[pulumi.Input[Union['KeystoresAliasesSelfSignedCertSubjectArgs', 'KeystoresAliasesSelfSignedCertSubjectArgsDict']]] = None,
            subject_alternative_dns_names: Optional[pulumi.Input[Union['KeystoresAliasesSelfSignedCertSubjectAlternativeDnsNamesArgs', 'KeystoresAliasesSelfSignedCertSubjectAlternativeDnsNamesArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'KeystoresAliasesSelfSignedCert':
        """
    ...
    @property
    @pulumi.getter(name="certValidityInDays")
    def cert_validity_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Validity duration of certificate, in days. Accepts positive non-zero value. Defaults to 365.
        """
        return pulumi.get(self, "cert_validity_in_days")
    ...
    @property
    @pulumi.getter(name="keySize")
    def key_size(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Key size. Default and maximum value is 2048 bits.
        """
        return pulumi.get(self, "key_size")
    ...
    @property
    @pulumi.getter(name="sigAlg")
    def sig_alg(self) -> pulumi.Output[builtins.str]:
        """
        Signature algorithm to generate private key. Valid values are SHA512withRSA, SHA384withRSA, and SHA256withRSA
        """
        return pulumi.get(self, "sig_alg")
