...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: Display name of the instance.
        :param pulumi.Input[_builtins.str] ip_range: IP range represents the customer-provided CIDR block of length 22 that will be used for
        ...
        :param pulumi.Input[_builtins.str] name: Resource ID of the instance.
        :param pulumi.Input[_builtins.str] peering_cidr_range: The size of the CIDR block range that will be reserved by the instance. For valid values,
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] disk_encryption_key_name: Customer Managed Encryption Key (CMEK) used for disk and volume encryption. Required for Apigee paid subscriptions only.
               Use the following format: `projects/([^/]+)/locations/([^/]+)/keyRings/([^/]+)/cryptoKeys/([^/]+)`
        :param pulumi.Input[_builtins.str] display_name: Display name of the instance.
        :param pulumi.Input[_builtins.str] host: Output only. Hostname or IP address of the exposed Apigee endpoint used by clients to connect to the service.
        :param pulumi.Input[_builtins.str] ip_range: IP range represents the customer-provided CIDR block of length 22 that will be used for
               the Apigee instance creation. This optional range, if provided, should be freely
               available as part of larger named range the customer has allocated to the Service
               Networking peering. If this is not provided, Apigee will automatically request for any
        ...
        :param pulumi.Input[_builtins.str] peering_cidr_range: The size of the CIDR block range that will be reserved by the instance. For valid values,
               see [CidrRange](https://cloud.google.com/apigee/docs/reference/apis/apigee/rest/v1/organizations.instances#CidrRange) on the documentation.
        :param pulumi.Input[_builtins.str] port: Output only. Port number of the exposed Apigee endpoint.
        :param pulumi.Input[_builtins.str] service_attachment: Output only. Resource name of the service attachment created for the instance in
