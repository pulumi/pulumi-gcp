...
class ApiArgs:
    def __init__(__self__, *,
                 config_bundle: pulumi.Input[builtins.str],
                 org_id: pulumi.Input[builtins.str],
                 detect_md5hash: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Api resource.
        :param pulumi.Input[builtins.str] config_bundle: Path to the config zip bundle.
               
               - - -
        :param pulumi.Input[builtins.str] org_id: The Apigee Organization name associated with the Apigee instance.
        :param pulumi.Input[builtins.str] name: The ID of the API proxy.
        """
    ...
    def config_bundle(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def config_bundle(self, value: pulumi.Input[builtins.str]):
...
class _ApiState:
    def __init__(__self__, *,
                 config_bundle: Optional[pulumi.Input[builtins.str]] = None,
                 detect_md5hash: Optional[pulumi.Input[builtins.str]] = None,
                 latest_revision_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] config_bundle: Path to the config zip bundle.
               ...
               - - -
        :param pulumi.Input[builtins.str] latest_revision_id: The id of the most recently created revision for this API proxy.
        :param pulumi.Input[builtins.str] md5hash: (Computed) Base 64 MD5 hash of the uploaded data. It is speculative as remote does not return hash of the bundle. Remote changes are detected using returned last_modified timestamp.
        :param pulumi.Input[Sequence[pulumi.Input['ApiMetaDataArgs']]] meta_datas: Metadata describing the API proxy.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: The ID of the API proxy.
        :param pulumi.Input[builtins.str] org_id: The Apigee Organization name associated with the Apigee instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] revisions: A list of revisions of this API proxy.
        """
    ...
    @property
    @pulumi.getter(name="configBundle")
    def config_bundle(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Path to the config zip bundle.
    ...
    @config_bundle.setter
    def config_bundle(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "config_bundle", value)
    ...
    def latest_revision_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def latest_revision_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Api(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            revisions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Api':
        """
    ...
    @property
    @pulumi.getter(name="configBundle")
    def config_bundle(self) -> pulumi.Output[builtins.str]:
        """
        Path to the config zip bundle.
    ...
    @property
    @pulumi.getter(name="latestRevisionId")
    def latest_revision_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the most recently created revision for this API proxy.
        """
        return pulumi.get(self, "latest_revision_id")
    ...
    @property
    @pulumi.getter
    def revisions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of revisions of this API proxy.
        """
        return pulumi.get(self, "revisions")
