...
class DeveloperArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def attributes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DeveloperAttributeArgs']]]]:
        """
...
class _DeveloperState:
    def __init__(__self__, *,
                 ...
                 organizatio_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] org_id: The Apigee Organization associated with the Apigee instance,
               in the format `organizations/{{org_name}}`.
        :param pulumi.Input[_builtins.str] organizatio_name: Name of the Apigee organization in which the developer resides.
        :param pulumi.Input[_builtins.str] status: Status of the developer. Valid values are active and inactive.
        :param pulumi.Input[_builtins.str] user_name: User name of the developer. Not used by Apigee hybrid.
        """
        if attributes is not None:
            pulumi.set(__self__, "attributes", attributes)
    ...
    def organizatio_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def organizatio_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Developer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organizatio_name: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None,
            user_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'Developer':
        """
