...
class OrganizationArgs:
    def __init__(__self__, *,
                 ...
                 analytics_region: Optional[pulumi.Input[builtins.str]] = None,
                 api_consumer_data_encryption_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 api_consumer_data_location: Optional[pulumi.Input[builtins.str]] = None,
                 authorized_network: Optional[pulumi.Input[builtins.str]] = None,
                 billing_type: Optional[pulumi.Input[builtins.str]] = None,
                 control_plane_encryption_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disable_vpc_peering: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 runtime_database_encryption_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 runtime_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Organization resource.
        :param pulumi.Input[builtins.str] project_id: The project ID associated with the Apigee organization.
               
               
               - - -
        :param pulumi.Input[builtins.str] analytics_region: Primary GCP region for analytics data storage. For valid values, see [Create an Apigee organization](https://cloud.google.com/apigee/docs/api-platform/get-started/create-org).
        :param pulumi.Input[builtins.str] api_consumer_data_encryption_key_name: Cloud KMS key name used for encrypting API consumer data.
        :param pulumi.Input[builtins.str] api_consumer_data_location: This field is needed only for customers using non-default data residency regions.
               Apigee stores some control plane data only in single region.
               This field determines which single region Apigee should use.
        :param pulumi.Input[builtins.str] authorized_network: Compute Engine network used for Service Networking to be peered with Apigee runtime instances.
               See [Getting started with the Service Networking API](https://cloud.google.com/service-infrastructure/docs/service-networking/getting-started).
               Valid only when `RuntimeType` is set to CLOUD. The value can be updated only when there are no runtime instances. For example: "default".
        :param pulumi.Input[builtins.str] billing_type: Billing type of the Apigee organization. See [Apigee pricing](https://cloud.google.com/apigee/pricing).
        :param pulumi.Input[builtins.str] control_plane_encryption_key_name: Cloud KMS key name used for encrypting control plane data that is stored in a multi region.
               Only used for the data residency region "US" or "EU".
        :param pulumi.Input[builtins.str] description: Description of the Apigee organization.
        :param pulumi.Input[builtins.bool] disable_vpc_peering: Flag that specifies whether the VPC Peering through Private Google Access should be
               disabled between the consumer network and Apigee. Required if an `authorizedNetwork`
               on the consumer project is not provided, in which case the flag should be set to `true`.
               Valid only when `RuntimeType` is set to CLOUD. The value must be set before the creation
               of any Apigee runtime instance and can be updated only when there are no runtime instances.
        :param pulumi.Input[builtins.str] display_name: The display name of the Apigee organization.
        :param pulumi.Input['OrganizationPropertiesArgs'] properties: Properties defined in the Apigee organization profile.
               Structure is documented below.
        :param pulumi.Input[builtins.str] retention: Optional. This setting is applicable only for organizations that are soft-deleted (i.e., BillingType
               is not EVALUATION). It controls how long Organization data will be retained after the initial delete
               operation completes. During this period, the Organization may be restored to its last known state.
               After this period, the Organization will no longer be able to be restored.
               Default value is `DELETION_RETENTION_UNSPECIFIED`.
               Possible values are: `DELETION_RETENTION_UNSPECIFIED`, `MINIMUM`.
        :param pulumi.Input[builtins.str] runtime_database_encryption_key_name: Cloud KMS key name used for encrypting the data that is stored and replicated across runtime instances.
               Update is not allowed after the organization is created.
               If not specified, a Google-Managed encryption key will be used.
               Valid only when `RuntimeType` is CLOUD. For example: `projects/foo/locations/us/keyRings/bar/cryptoKeys/baz`.
        :param pulumi.Input[builtins.str] runtime_type: Runtime type of the Apigee organization based on the Apigee subscription purchased.
    ...
    def analytics_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def analytics_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "analytics_region", value)

    @property
    @pulumi.getter(name="apiConsumerDataEncryptionKeyName")
    def api_consumer_data_encryption_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_consumer_data_encryption_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_consumer_data_encryption_key_name", value)

    @property
    @pulumi.getter(name="apiConsumerDataLocation")
    def api_consumer_data_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_consumer_data_location(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def control_plane_encryption_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def control_plane_encryption_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def disable_vpc_peering(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_vpc_peering(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def runtime_database_encryption_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def runtime_database_encryption_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OrganizationState:
    def __init__(__self__, *,
                 ...
                 api_consumer_data_encryption_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 api_consumer_data_location: Optional[pulumi.Input[builtins.str]] = None,
                 apigee_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 authorized_network: Optional[pulumi.Input[builtins.str]] = None,
                 billing_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] api_consumer_data_location: This field is needed only for customers using non-default data residency regions.
               Apigee stores some control plane data only in single region.
               This field determines which single region Apigee should use.
        :param pulumi.Input[builtins.str] apigee_project_id: Output only. Project ID of the Apigee Tenant Project.
        :param pulumi.Input[builtins.str] authorized_network: Compute Engine network used for Service Networking to be peered with Apigee runtime instances.
               See [Getting started with the Service Networking API](https://cloud.google.com/service-infrastructure/docs/service-networking/getting-started).
               Valid only when `RuntimeType` is set to CLOUD. The value can be updated only when there are no runtime instances. For example: "default".
        :param pulumi.Input[builtins.str] billing_type: Billing type of the Apigee organization. See [Apigee pricing](https://cloud.google.com/apigee/pricing).
        :param pulumi.Input[builtins.str] ca_certificate: Output only. Base64-encoded public certificate for the root CA of the Apigee organization.
        ...
        :param pulumi.Input[builtins.bool] disable_vpc_peering: Flag that specifies whether the VPC Peering through Private Google Access should be
               ...
               of any Apigee runtime instance and can be updated only when there are no runtime instances.
        :param pulumi.Input[builtins.str] display_name: The display name of the Apigee organization.
        :param pulumi.Input[builtins.str] name: Output only. Name of the Apigee organization.
        :param pulumi.Input[builtins.str] project_id: The project ID associated with the Apigee organization.
        ...
        :param pulumi.Input[builtins.str] runtime_type: Runtime type of the Apigee organization based on the Apigee subscription purchased.
               Default value is `CLOUD`.
               Possible values are: `CLOUD`, `HYBRID`.
        :param pulumi.Input[builtins.str] subscription_type: Output only. Subscription type of the Apigee organization.
    ...
    def apigee_project_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def apigee_project_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Organization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            runtime_database_encryption_key_name: Optional[pulumi.Input[builtins.str]] = None,
            runtime_type: Optional[pulumi.Input[builtins.str]] = None,
            subscription_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Organization':
        """
    ...
    @property
    @pulumi.getter(name="analyticsRegion")
    def analytics_region(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Primary GCP region for analytics data storage. For valid values, see [Create an Apigee organization](https://cloud.google.com/apigee/docs/api-platform/get-started/create-org).
        """
        return pulumi.get(self, "analytics_region")
    ...
    @property
    @pulumi.getter(name="apiConsumerDataEncryptionKeyName")
    def api_consumer_data_encryption_key_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cloud KMS key name used for encrypting API consumer data.
        """
        return pulumi.get(self, "api_consumer_data_encryption_key_name")
    ...
    @property
    @pulumi.getter(name="apiConsumerDataLocation")
    def api_consumer_data_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This field is needed only for customers using non-default data residency regions.
        Apigee stores some control plane data only in single region.
        This field determines which single region Apigee should use.
    ...
    @property
    @pulumi.getter(name="apigeeProjectId")
    def apigee_project_id(self) -> pulumi.Output[builtins.str]:
        """
        Output only. Project ID of the Apigee Tenant Project.
        """
        return pulumi.get(self, "apigee_project_id")
    ...
    @property
    @pulumi.getter(name="authorizedNetwork")
    def authorized_network(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Compute Engine network used for Service Networking to be peered with Apigee runtime instances.
        See [Getting started with the Service Networking API](https://cloud.google.com/service-infrastructure/docs/service-networking/getting-started).
        Valid only when `RuntimeType` is set to CLOUD. The value can be updated only when there are no runtime instances. For example: "default".
    ...
    @property
    @pulumi.getter(name="controlPlaneEncryptionKeyName")
    def control_plane_encryption_key_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cloud KMS key name used for encrypting control plane data that is stored in a multi region.
        Only used for the data residency region "US" or "EU".
        """
    ...
    @property
    @pulumi.getter(name="disableVpcPeering")
    def disable_vpc_peering(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that specifies whether the VPC Peering through Private Google Access should be
        disabled between the consumer network and Apigee. Required if an `authorizedNetwork`
        on the consumer project is not provided, in which case the flag should be set to `true`.
    ...
    @property
    @pulumi.getter
    def retention(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Optional. This setting is applicable only for organizations that are soft-deleted (i.e., BillingType
        is not EVALUATION). It controls how long Organization data will be retained after the initial delete
        operation completes. During this period, the Organization may be restored to its last known state.
    ...
    @property
    @pulumi.getter(name="runtimeDatabaseEncryptionKeyName")
    def runtime_database_encryption_key_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cloud KMS key name used for encrypting the data that is stored and replicated across runtime instances.
        Update is not allowed after the organization is created.
        If not specified, a Google-Managed encryption key will be used.
