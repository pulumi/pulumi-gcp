...
class OrganizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] authorized_network: Compute Engine network used for Service Networking to be peered with Apigee runtime instances.
        ...
        :param pulumi.Input[_builtins.str] runtime_database_encryption_key_name: Cloud KMS key name used for encrypting the data that is stored and replicated across runtime instances.
               Update is not allowed after the organization is created.
               If not specified, a Google-Managed encryption key will be used.
               Valid only when `RuntimeType` is CLOUD. For example: `projects/foo/locations/us/keyRings/bar/cryptoKeys/baz`.
        :param pulumi.Input[_builtins.str] runtime_type: Runtime type of the Apigee organization based on the Apigee subscription purchased.
...
class _OrganizationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] api_consumer_data_location: This field is needed only for customers using non-default data residency regions.
               Apigee stores some control plane data only in single region.
               This field determines which single region Apigee should use.
        :param pulumi.Input[_builtins.str] apigee_project_id: Output only. Project ID of the Apigee Tenant Project.
        :param pulumi.Input[_builtins.str] authorized_network: Compute Engine network used for Service Networking to be peered with Apigee runtime instances.
               See [Getting started with the Service Networking API](https://cloud.google.com/service-infrastructure/docs/service-networking/getting-started).
               Valid only when `RuntimeType` is set to CLOUD. The value can be updated only when there are no runtime instances. For example: "default".
        :param pulumi.Input[_builtins.str] billing_type: Billing type of the Apigee organization. See [Apigee pricing](https://cloud.google.com/apigee/pricing).
        :param pulumi.Input[_builtins.str] ca_certificate: Output only. Base64-encoded public certificate for the root CA of the Apigee organization.
        ...
        :param pulumi.Input[_builtins.str] runtime_type: Runtime type of the Apigee organization based on the Apigee subscription purchased.
               Default value is `CLOUD`.
               Possible values are: `CLOUD`, `HYBRID`.
        :param pulumi.Input[_builtins.str] subscription_type: Output only. Subscription type of the Apigee organization.
