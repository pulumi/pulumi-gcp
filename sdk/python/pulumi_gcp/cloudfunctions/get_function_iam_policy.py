...
def get_function_iam_policy(cloud_function: Optional[builtins.str] = None,
    ...
    :param builtins.str cloud_function: Used to find the parent resource to bind the IAM policy to
    :param builtins.str project: The ID of the project in which the resource belongs.
           If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
    :param builtins.str region: The location of this cloud function. Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_function_iam_policy_output(cloud_function: Optional[pulumi.Input[builtins.str]] = None,
