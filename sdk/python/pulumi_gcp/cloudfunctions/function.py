...
class FunctionArgs:
    def __init__(__self__, *,
                 ...
                 available_memory_mb: Optional[pulumi.Input[builtins.int]] = None,
                 build_environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 build_service_account: Optional[pulumi.Input[builtins.str]] = None,
                 build_worker_pool: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 docker_registry: Optional[pulumi.Input[builtins.str]] = None,
                 docker_repository: Optional[pulumi.Input[builtins.str]] = None,
                 entry_point: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 https_trigger_security_level: Optional[pulumi.Input[builtins.str]] = None,
                 https_trigger_url: Optional[pulumi.Input[builtins.str]] = None,
                 ingress_settings: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 source_archive_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 source_archive_object: Optional[pulumi.Input[builtins.str]] = None,
                 source_repository: Optional[pulumi.Input['FunctionSourceRepositoryArgs']] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None,
                 trigger_http: Optional[pulumi.Input[builtins.bool]] = None,
                 vpc_connector: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_connector_egress_settings: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Function resource.
        :param pulumi.Input[builtins.str] runtime: The runtime in which the function is going to run.
               ...
               - - -
        :param pulumi.Input[builtins.int] available_memory_mb: Memory (in MB), available to the function. Default value is `256`. Possible values include `128`, `256`, `512`, `1024`, etc.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] build_environment_variables: A set of key/value environment variable pairs available during build time.
        :param pulumi.Input[builtins.str] build_service_account: If provided, the self-provided service account to use to build the function. The format of this field is `projects/{project}/serviceAccounts/{serviceAccountEmail}`
        :param pulumi.Input[builtins.str] build_worker_pool: Name of the Cloud Build Custom Worker Pool that should be used to build the function.
        :param pulumi.Input[builtins.str] description: Description of the function.
        :param pulumi.Input[builtins.str] docker_registry: Docker Registry to use for storing the function's Docker images. Allowed values are ARTIFACT_REGISTRY (default) and CONTAINER_REGISTRY.
        :param pulumi.Input[builtins.str] docker_repository: User-managed repository created in Artifact Registry to which the function's Docker image will be pushed after it is built by Cloud Build. May optionally be encrypted with a customer-managed encryption key (CMEK). If unspecified and `docker_registry` is not explicitly set to `CONTAINER_REGISTRY`, GCF will create and use a default Artifact Registry repository named 'gcf-artifacts' in the region.
        :param pulumi.Input[builtins.str] entry_point: Name of the function that will be executed when the Google Cloud Function is triggered.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment_variables: A set of key/value environment variable pairs to assign to the function.
        ...
        :param pulumi.Input[builtins.str] https_trigger_security_level: The security level for the function. The following options are available:
        ...
        :param pulumi.Input[builtins.str] https_trigger_url: URL which triggers function execution. Returned only if `trigger_http` is used.
        :param pulumi.Input[builtins.str] ingress_settings: String value that controls what traffic can reach the function. Allowed values are `ALLOW_ALL`, `ALLOW_INTERNAL_AND_GCLB` and `ALLOW_INTERNAL_ONLY`. Check [ingress documentation](https://cloud.google.com/functions/docs/networking/network-settings#ingress_settings) to see the impact of each settings value. Changes to this field will recreate the cloud function.
        :param pulumi.Input[builtins.str] kms_key_name: Resource name of a KMS crypto key (managed by the user) used to encrypt/decrypt function resources. It must match the pattern `projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}`.
               If specified, you must also provide an artifact registry repository using the `docker_repository` field that was created with the same KMS crypto key. Before deploying, please complete all pre-requisites described in https://cloud.google.com/functions/docs/securing/cmek#granting_service_accounts_access_to_the_key
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs to assign to the function. Label keys must follow the requirements at https://cloud.google.com/resource-manager/docs/creating-managing-labels#requirements.
               
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field 'effective_labels' for all of the labels present on the resource.
        :param pulumi.Input[builtins.int] max_instances: The limit on the maximum number of function instances that may coexist at a given time.
        :param pulumi.Input[builtins.int] min_instances: The limit on the minimum number of function instances that may coexist at a given time.
        :param pulumi.Input[builtins.str] name: A user-defined name of the function. Function names must be unique globally.
        :param pulumi.Input[builtins.str] project: Project of the function. If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] region: Region of function. If it is not provided, the provider region is used.
        ...
        :param pulumi.Input[builtins.str] service_account_email: If provided, the self-provided service account to run the function with.
        :param pulumi.Input[builtins.str] source_archive_bucket: The GCS bucket containing the zip archive which contains the function.
        :param pulumi.Input[builtins.str] source_archive_object: The source archive object (file) in archive bucket.
        ...
        :param pulumi.Input[builtins.int] timeout: Timeout (in seconds) for the function. Default value is 60 seconds. Cannot be more than 540 seconds.
        :param pulumi.Input[builtins.bool] trigger_http: Boolean variable. Any HTTP request (of a supported type) to the endpoint will trigger function execution. Supported HTTP request types are: POST, PUT, GET, DELETE, and OPTIONS. Endpoint is returned as `https_trigger_url`. Cannot be used with `event_trigger`.
        :param pulumi.Input[builtins.str] vpc_connector: The VPC Network Connector that this cloud function can connect to. It should be set up as fully-qualified URI. The format of this field is `projects/*/locations/*/connectors/*`.
        :param pulumi.Input[builtins.str] vpc_connector_egress_settings: The egress settings for the connector, controlling what traffic is diverted through it. Allowed values are `ALL_TRAFFIC` and `PRIVATE_RANGES_ONLY`. Defaults to `PRIVATE_RANGES_ONLY`. If unset, this field preserves the previously set value.
        """
    ...
    def available_memory_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def available_memory_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "available_memory_mb", value)

    @property
    @pulumi.getter(name="buildEnvironmentVariables")
    def build_environment_variables(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def build_environment_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "build_environment_variables", value)

    @property
    @pulumi.getter(name="buildServiceAccount")
    def build_service_account(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def build_service_account(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "build_service_account", value)

    @property
    @pulumi.getter(name="buildWorkerPool")
    def build_worker_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def build_worker_pool(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def docker_repository(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def docker_repository(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "docker_repository", value)

    @property
    @pulumi.getter(name="entryPoint")
    def entry_point(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @entry_point.setter
    def entry_point(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def https_trigger_security_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def https_trigger_security_level(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "https_trigger_security_level", value)

    @property
    @pulumi.getter(name="httpsTriggerUrl")
    def https_trigger_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def https_trigger_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "https_trigger_url", value)

    @property
    @pulumi.getter(name="ingressSettings")
    def ingress_settings(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ingress_settings(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_archive_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_archive_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_archive_bucket", value)

    @property
    @pulumi.getter(name="sourceArchiveObject")
    def source_archive_object(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_archive_object(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def trigger_http(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @trigger_http.setter
    def trigger_http(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "trigger_http", value)

    @property
    @pulumi.getter(name="vpcConnector")
    def vpc_connector(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpc_connector(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpc_connector", value)

    @property
    @pulumi.getter(name="vpcConnectorEgressSettings")
    def vpc_connector_egress_settings(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpc_connector_egress_settings(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FunctionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FunctionSourceRepositoryArgs'] source_repository: Represents parameters related to source repository where a function is hosted.
               Cannot be set alongside `source_archive_bucket` or `source_archive_object`. Structure is documented below. It must match the pattern `projects/{project}/locations/{location}/repositories/{repository}`.*
        :param pulumi.Input[builtins.str] status: Describes the current stage of a deployment.
        :param pulumi.Input[builtins.int] timeout: Timeout (in seconds) for the function. Default value is 60 seconds. Cannot be more than 540 seconds.
        :param pulumi.Input[builtins.bool] trigger_http: Boolean variable. Any HTTP request (of a supported type) to the endpoint will trigger function execution. Supported HTTP request types are: POST, PUT, GET, DELETE, and OPTIONS. Endpoint is returned as `https_trigger_url`. Cannot be used with `event_trigger`.
        :param pulumi.Input[builtins.str] version_id: The version identifier of the Cloud Function. Each deployment attempt results in a new version of a function being
               created.
        :param pulumi.Input[builtins.str] vpc_connector: The VPC Network Connector that this cloud function can connect to. It should be set up as fully-qualified URI. The format of this field is `projects/*/locations/*/connectors/*`.
        :param pulumi.Input[builtins.str] vpc_connector_egress_settings: The egress settings for the connector, controlling what traffic is diverted through it. Allowed values are `ALL_TRAFFIC` and `PRIVATE_RANGES_ONLY`. Defaults to `PRIVATE_RANGES_ONLY`. If unset, this field preserves the previously set value.
        """
...
class Function(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_connector: Optional[pulumi.Input[builtins.str]] = None,
            vpc_connector_egress_settings: Optional[pulumi.Input[builtins.str]] = None) -> 'Function':
        """
    ...
    @property
    @pulumi.getter(name="availableMemoryMb")
    def available_memory_mb(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Memory (in MB), available to the function. Default value is `256`. Possible values include `128`, `256`, `512`, `1024`, etc.
        """
        return pulumi.get(self, "available_memory_mb")
    ...
    @property
    @pulumi.getter(name="buildEnvironmentVariables")
    def build_environment_variables(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        A set of key/value environment variable pairs available during build time.
        """
        return pulumi.get(self, "build_environment_variables")
    ...
    @property
    @pulumi.getter(name="buildServiceAccount")
    def build_service_account(self) -> pulumi.Output[builtins.str]:
        """
        If provided, the self-provided service account to use to build the function. The format of this field is `projects/{project}/serviceAccounts/{serviceAccountEmail}`
        """
        return pulumi.get(self, "build_service_account")
    ...
    @property
    @pulumi.getter(name="buildWorkerPool")
    def build_worker_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the Cloud Build Custom Worker Pool that should be used to build the function.
        """
        return pulumi.get(self, "build_worker_pool")
    ...
    @property
    @pulumi.getter(name="dockerRepository")
    def docker_repository(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        User-managed repository created in Artifact Registry to which the function's Docker image will be pushed after it is built by Cloud Build. May optionally be encrypted with a customer-managed encryption key (CMEK). If unspecified and `docker_registry` is not explicitly set to `CONTAINER_REGISTRY`, GCF will create and use a default Artifact Registry repository named 'gcf-artifacts' in the region.
        """
        return pulumi.get(self, "docker_repository")
    ...
    @property
    @pulumi.getter(name="entryPoint")
    def entry_point(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the function that will be executed when the Google Cloud Function is triggered.
        """
        return pulumi.get(self, "entry_point")
    ...
    @property
    @pulumi.getter(name="httpsTriggerSecurityLevel")
    def https_trigger_security_level(self) -> pulumi.Output[builtins.str]:
        """
        The security level for the function. The following options are available:
    ...
    @property
    @pulumi.getter(name="httpsTriggerUrl")
    def https_trigger_url(self) -> pulumi.Output[builtins.str]:
        """
        URL which triggers function execution. Returned only if `trigger_http` is used.
        """
        return pulumi.get(self, "https_trigger_url")
    ...
    @property
    @pulumi.getter(name="ingressSettings")
    def ingress_settings(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        String value that controls what traffic can reach the function. Allowed values are `ALLOW_ALL`, `ALLOW_INTERNAL_AND_GCLB` and `ALLOW_INTERNAL_ONLY`. Check [ingress documentation](https://cloud.google.com/functions/docs/networking/network-settings#ingress_settings) to see the impact of each settings value. Changes to this field will recreate the cloud function.
        """
        return pulumi.get(self, "ingress_settings")
    ...
    @property
    @pulumi.getter(name="maxInstances")
    def max_instances(self) -> pulumi.Output[builtins.int]:
        """
        The limit on the maximum number of function instances that may coexist at a given time.
        """
        return pulumi.get(self, "max_instances")
    ...
    @property
    @pulumi.getter(name="sourceArchiveBucket")
    def source_archive_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The GCS bucket containing the zip archive which contains the function.
        """
        return pulumi.get(self, "source_archive_bucket")
    ...
    @property
    @pulumi.getter(name="sourceArchiveObject")
    def source_archive_object(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source archive object (file) in archive bucket.
        """
        return pulumi.get(self, "source_archive_object")
    ...
    @property
    @pulumi.getter(name="triggerHttp")
    def trigger_http(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean variable. Any HTTP request (of a supported type) to the endpoint will trigger function execution. Supported HTTP request types are: POST, PUT, GET, DELETE, and OPTIONS. Endpoint is returned as `https_trigger_url`. Cannot be used with `event_trigger`.
        """
        return pulumi.get(self, "trigger_http")
    ...
    @property
    @pulumi.getter(name="vpcConnector")
    def vpc_connector(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The VPC Network Connector that this cloud function can connect to. It should be set up as fully-qualified URI. The format of this field is `projects/*/locations/*/connectors/*`.
        """
        return pulumi.get(self, "vpc_connector")
    ...
    @property
    @pulumi.getter(name="vpcConnectorEgressSettings")
    def vpc_connector_egress_settings(self) -> pulumi.Output[builtins.str]:
        """
        The egress settings for the connector, controlling what traffic is diverted through it. Allowed values are `ALL_TRAFFIC` and `PRIVATE_RANGES_ONLY`. Defaults to `PRIVATE_RANGES_ONLY`. If unset, this field preserves the previously set value.
        """
        return pulumi.get(self, "vpc_connector_egress_settings")
