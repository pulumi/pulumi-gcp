...
class FunctionEventTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] event_type: The type of event to observe. For example: `"google.storage.object.finalize"`.
               See the documentation on [calling Cloud Functions](https://cloud.google.com/functions/docs/calling/) for a
               full reference of accepted triggers.
        :param pulumi.Input[builtins.str] resource: Required. The name or partial URI of the resource from
               which to observe events. For example, `"myBucket"` or `"projects/my-project/topics/my-topic"`
...
if not MYPY:
    class FunctionEventTriggerFailurePolicyArgsDict(TypedDict):
        retry: pulumi.Input[builtins.bool]
        """
...
class FunctionEventTriggerFailurePolicyArgs:
    def __init__(__self__, *,
                 retry: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] retry: Whether the function should be retried on failure. Defaults to `false`.
        """
        pulumi.set(__self__, "retry", retry)

    @property
    @pulumi.getter
    def retry(self) -> pulumi.Input[builtins.bool]:
        """
        Whether the function should be retried on failure. Defaults to `false`.
        """
    ...
    @retry.setter
    def retry(self, value: pulumi.Input[builtins.bool]):
...
class FunctionSecretEnvironmentVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret: ID of the secret in secret manager (not the full resource name).
        :param pulumi.Input[builtins.str] version: Version of the secret (version number or the string "latest"). It is recommended to use a numeric version for secret environment variables as any updates to the secret value is not reflected until new clones start.
        :param pulumi.Input[builtins.str] project_id: Project identifier (due to a known limitation, only project number is supported by this field) of the project that contains the secret. If not set, it will be populated with the function's project, assuming that the secret exists in the same project as of the function.
        """
...
class FunctionSecretVolumeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] mount_path: The path within the container to mount the secret volume. For example, setting the mount_path as "/etc/secrets" would mount the secret value files under the "/etc/secrets" directory. This directory will also be completely shadowed and unavailable to mount any other secrets. Recommended mount paths: "/etc/secrets" Restricted mount paths: "/cloudsql", "/dev/log", "/pod", "/proc", "/var/log".
        :param pulumi.Input[builtins.str] secret: ID of the secret in secret manager (not the full resource name).
        :param pulumi.Input[builtins.str] project_id: Project identifier (due to a known limitation, only project number is supported by this field) of the project that contains the secret. If not set, it will be populated with the function's project, assuming that the secret exists in the same project as of the function.
...
class FunctionSecretVolumeVersionArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] path: Relative path of the file under the mount path where the secret value for this version will be fetched and made available. For example, setting the mount_path as "/etc/secrets" and path as "/secret_foo" would mount the secret value file at "/etc/secrets/secret_foo".
...
if not MYPY:
    class FunctionSourceRepositoryArgsDict(TypedDict):
        ...
        * To refer to a specific fixed alias (tag): `https://source.developers.google.com/projects/*/repos/*/fixed-aliases/*/paths/*`
        """
        deployed_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FunctionSourceRepositoryArgs:
    def __init__(__self__, *,
                 url: pulumi.Input[builtins.str],
                 deployed_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] url: The URL pointing to the hosted repository where the function is defined. There are supported Cloud Source Repository URLs in the following formats:
               
               * To refer to a specific commit: `https://source.developers.google.com/projects/*/repos/*/revisions/*/paths/*`
               * To refer to a moveable alias (branch): `https://source.developers.google.com/projects/*/repos/*/moveable-aliases/*/paths/*`. To refer to HEAD, use the `master` moveable alias.
               * To refer to a specific fixed alias (tag): `https://source.developers.google.com/projects/*/repos/*/fixed-aliases/*/paths/*`
        :param pulumi.Input[builtins.str] deployed_url: The URL pointing to the hosted repository where the function was defined at the time of deployment.
        """
    ...
    def deployed_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URL pointing to the hosted repository where the function was defined at the time of deployment.
        """
    ...
    @deployed_url.setter
    def deployed_url(self, value: Optional[pulumi.Input[builtins.str]]):
