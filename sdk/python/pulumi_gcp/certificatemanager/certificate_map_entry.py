...
class CertificateMapEntryArgs:
    def __init__(__self__, *,
                 certificates: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 map: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Set of labels associated with a Certificate Map Entry.
    ...
    @certificates.setter
    def certificates(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    @map.setter
    def map(self, value: pulumi.Input[_builtins.str]):
...
class _CertificateMapEntryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] certificates: A set of Certificates defines for the given hostname.
               There can be defined up to fifteen certificates in each Certificate Map Entry.
               Each certificate must match pattern projects/*/locations/*/certificates/*.
        :param pulumi.Input[_builtins.str] create_time: Creation timestamp of a Certificate Map Entry. Timestamp in RFC3339 UTC "Zulu" format,
        ...
        :param pulumi.Input[_builtins.str] state: A serving state of this Certificate Map Entry.
        :param pulumi.Input[_builtins.str] update_time: Update timestamp of a Certificate Map Entry. Timestamp in RFC3339 UTC "Zulu" format,
               with nanosecond resolution and up to nine fractional digits.
               Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
...
class CertificateMapEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None,
            update_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'CertificateMapEntry':
        """
