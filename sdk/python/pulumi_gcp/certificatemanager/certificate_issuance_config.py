...
class CertificateIssuanceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] lifetime: Lifetime of issued certificates. A duration in seconds with up to nine fractional digits, ending with 's'.
        ...
        :param pulumi.Input[_builtins.str] name: A user-defined name of the certificate issuance config.
...
class _CertificateIssuanceConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] rotation_window_percentage: It specifies the percentage of elapsed time of the certificate lifetime to wait before renewing the certificate.
               ...
               You must set the rotation window percentage in relation to the certificate lifetime so that certificate renewal occurs at least 7 days after
               the certificate has been issued and at least 7 days before it expires.
        :param pulumi.Input[_builtins.str] update_time: The last update timestamp of a CertificateIssuanceConfig. Timestamp is in RFC3339 UTC "Zulu" format,
               accurate to nanoseconds with up to nine fractional digits.
               Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
    ...
    @_builtins.property
    @pulumi.getter(name="certificateAuthorityConfig")
    def certificate_authority_config(self) -> pulumi.Input[Optional['CertificateIssuanceConfigCertificateAuthorityConfigArgs']]:
        """
        The CA that issues the workload certificate. It includes the CA address, type, authentication to CA service, etc.
        Structure is documented below.
        """
    ...
    @certificate_authority_config.setter
    def certificate_authority_config(self, value: pulumi.Input[Optional['CertificateIssuanceConfigCertificateAuthorityConfigArgs']]):
        pulumi.set(self, "certificate_authority_config", value)
...
class CertificateIssuanceConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            rotation_window_percentage: pulumi.Input[Optional[_builtins.int]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'CertificateIssuanceConfig':
        """
