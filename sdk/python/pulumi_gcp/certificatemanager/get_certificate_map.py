...
def get_certificate_map(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the certificate map.
...
def get_certificate_map_output(name: Optional[pulumi.Input[builtins.str]] = None,
