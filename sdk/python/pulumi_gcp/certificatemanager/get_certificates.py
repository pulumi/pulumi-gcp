...
def get_certificates(filter: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: Filter expression to restrict the certificates returned.
    :param builtins.str region: The region in which the resource belongs. If it is not provided, `GLOBAL` is used.
    """
    __args__ = dict()
...
def get_certificates_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
