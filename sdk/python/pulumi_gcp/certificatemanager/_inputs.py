...
if not MYPY:
    class CertificateManagedArgsDict(TypedDict):
        ...
        """
        dns_authorizations: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        issuance_config: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CertificateManagedArgs:
    def __init__(__self__, *,
                 ...
                 dns_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 issuance_config: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CertificateManagedAuthorizationAttemptInfoArgs']]] authorization_attempt_infos: (Output)
               ...
               <a name="nested_managed_provisioning_issue"></a>The `provisioning_issue` block contains:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_authorizations: Authorizations that will be used for performing domain authorization. Either issuanceConfig or dnsAuthorizations should be specificed, but not both.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domains: The domains for which a managed SSL certificate will be generated.
               Wildcard domains are only supported with DNS challenge resolution
        :param pulumi.Input[builtins.str] issuance_config: The resource name for a CertificateIssuanceConfig used to configure private PKI certificates in the format projects/*/locations/*/certificateIssuanceConfigs/*.
               If this field is not set, the certificates will instead be publicly signed as documented at https://cloud.google.com/load-balancing/docs/ssl-certificates/google-managed-certs#caa.
               Either issuanceConfig or dnsAuthorizations should be specificed, but not both.
    ...
    def dns_authorizations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Authorizations that will be used for performing domain authorization. Either issuanceConfig or dnsAuthorizations should be specificed, but not both.
        """
    ...
    def dns_authorizations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def issuance_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource name for a CertificateIssuanceConfig used to configure private PKI certificates in the format projects/*/locations/*/certificateIssuanceConfigs/*.
        If this field is not set, the certificates will instead be publicly signed as documented at https://cloud.google.com/load-balancing/docs/ssl-certificates/google-managed-certs#caa.
        Either issuanceConfig or dnsAuthorizations should be specificed, but not both.
    ...
    def issuance_config(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CertificateManagedAuthorizationAttemptInfoArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] details: Human readable explanation for reaching the state. Provided to help
               address the configuration issues.
               Not guaranteed to be stable. For programmatic access use 'failure_reason' field.
        :param pulumi.Input[builtins.str] domain: Domain name of the authorization attempt.
        :param pulumi.Input[builtins.str] failure_reason: Reason for failure of the authorization attempt for the domain.
        :param pulumi.Input[builtins.str] state: State of the domain for managed certificate issuance.
        """
...
class CertificateManagedProvisioningIssueArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] details: Human readable explanation about the issue. Provided to help address
               the configuration issues.
               Not guaranteed to be stable. For programmatic access use 'reason' field.
        :param pulumi.Input[builtins.str] reason: Reason for provisioning failures.
        """
        if details is not None:
            pulumi.set(__self__, "details", details)
...
if not MYPY:
    class CertificateMapGclbTargetArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        target_https_proxy: NotRequired[pulumi.Input[builtins.str]]
        """
        Proxy name must be in the format projects/*/locations/*/targetHttpsProxies/*.
        This field is part of a union field `target_proxy`: Only one of `targetHttpsProxy` or
        `targetSslProxy` may be set.
        """
        target_ssl_proxy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CertificateMapGclbTargetArgs:
    def __init__(__self__, *,
                 ...
                 target_https_proxy: Optional[pulumi.Input[builtins.str]] = None,
                 target_ssl_proxy: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['CertificateMapGclbTargetIpConfigArgs']]] ip_configs: An IP configuration where this Certificate Map is serving
               Structure is documented below.
        :param pulumi.Input[builtins.str] target_https_proxy: Proxy name must be in the format projects/*/locations/*/targetHttpsProxies/*.
               This field is part of a union field `target_proxy`: Only one of `targetHttpsProxy` or
               `targetSslProxy` may be set.
        :param pulumi.Input[builtins.str] target_ssl_proxy: Proxy name must be in the format projects/*/locations/*/targetSslProxies/*.
               This field is part of a union field `target_proxy`: Only one of `targetHttpsProxy` or
               `targetSslProxy` may be set.
        """
    ...
    def target_https_proxy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Proxy name must be in the format projects/*/locations/*/targetHttpsProxies/*.
        This field is part of a union field `target_proxy`: Only one of `targetHttpsProxy` or
        `targetSslProxy` may be set.
    ...
    def target_https_proxy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_https_proxy", value)

    @property
    @pulumi.getter(name="targetSslProxy")
    def target_ssl_proxy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Proxy name must be in the format projects/*/locations/*/targetSslProxies/*.
        This field is part of a union field `target_proxy`: Only one of `targetHttpsProxy` or
        `targetSslProxy` may be set.
    ...
    def target_ssl_proxy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CertificateMapGclbTargetIpConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] ip_address: An external IP address
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] ports: A list of ports
        """
...
if not MYPY:
    class CertificateSelfManagedArgsDict(TypedDict):
        certificate_pem: NotRequired[pulumi.Input[builtins.str]]
        """
        (Optional, Deprecated)
        ...
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
        pem_private_key: NotRequired[pulumi.Input[builtins.str]]
        """
        The private key of the leaf certificate in PEM-encoded form.
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
        private_key_pem: NotRequired[pulumi.Input[builtins.str]]
        """
        (Optional, Deprecated)
        The private key of the leaf certificate in PEM-encoded form.
        **Note**: This property is sensitive and will not be displayed in the plan.
...
class CertificateSelfManagedArgs:
    def __init__(__self__, *,
                 ...
                 pem_private_key: Optional[pulumi.Input[builtins.str]] = None,
                 private_key_pem: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] certificate_pem: (Optional, Deprecated)
               The certificate chain in PEM-encoded form.
               Leaf certificate comes first, followed by intermediate ones if any.
               **Note**: This property is sensitive and will not be displayed in the plan.
               
               > **Warning:** `certificate_pem` is deprecated and will be removed in a future major release. Use `pem_certificate` instead.
        :param pulumi.Input[builtins.str] pem_certificate: The certificate chain in PEM-encoded form.
               Leaf certificate comes first, followed by intermediate ones if any.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.str] pem_private_key: The private key of the leaf certificate in PEM-encoded form.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.str] private_key_pem: (Optional, Deprecated)
               The private key of the leaf certificate in PEM-encoded form.
               **Note**: This property is sensitive and will not be displayed in the plan.
    ...
    def pem_private_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The private key of the leaf certificate in PEM-encoded form.
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
    ...
    def pem_private_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DnsAuthorizationDnsResourceRecordArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] data: (Output)
               Data of the DNS Resource Record.
...
class TrustConfigAllowlistedCertificateArgs:
    def __init__(__self__, *,
                 pem_certificate: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] pem_certificate: PEM certificate that is allowlisted. The certificate can be up to 5k bytes, and must be a parseable X.509 certificate.
        """
        pulumi.set(__self__, "pem_certificate", pem_certificate)
...
class TrustConfigTrustStoreIntermediateCaArgs:
    def __init__(__self__, *,
                 pem_certificate: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] pem_certificate: PEM intermediate certificate used for building up paths for validation.
               Each certificate provided in PEM format may occupy up to 5kB.
               **Note**: This property is sensitive and will not be displayed in the plan.
        """
        if pem_certificate is not None:
...
class TrustConfigTrustStoreTrustAnchorArgs:
    def __init__(__self__, *,
                 pem_certificate: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] pem_certificate: PEM root certificate of the PKI used for validation.
               Each certificate provided in PEM format may occupy up to 5kB.
               **Note**: This property is sensitive and will not be displayed in the plan.
        """
        if pem_certificate is not None:
