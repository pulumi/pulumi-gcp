...
class CertificateIssuanceConfigCertificateAuthorityConfigCertificateAuthorityServiceConfigArgs:
    def __init__(__self__, *,
                 ca_pool: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] ca_pool: A CA pool resource used to issue a certificate.
               The CA pool string has a relative resource path following the form
               "projects/{project}/locations/{location}/caPools/{caPool}".
        """
...
class CertificateManagedArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] domains: The domains for which a managed SSL certificate will be generated.
               Wildcard domains are only supported with DNS challenge resolution
        :param pulumi.Input[_builtins.str] issuance_config: The resource name for a CertificateIssuanceConfig used to configure private PKI certificates in the format projects/*/locations/*/certificateIssuanceConfigs/*.
               If this field is not set, the certificates will instead be publicly signed as documented at https://cloud.google.com/load-balancing/docs/ssl-certificates/google-managed-certs#caa.
               Either issuanceConfig or dnsAuthorizations should be specificed, but not both.
...
class CertificateManagedAuthorizationAttemptInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] details: Human readable explanation for reaching the state. Provided to help
               address the configuration issues.
               Not guaranteed to be stable. For programmatic access use 'failure_reason' field.
        :param pulumi.Input[_builtins.str] domain: Domain name of the authorization attempt.
        :param pulumi.Input[_builtins.str] failure_reason: Reason for failure of the authorization attempt for the domain.
        :param pulumi.Input[_builtins.str] state: State of the domain for managed certificate issuance.
        """
...
class CertificateManagedProvisioningIssueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] details: Human readable explanation about the issue. Provided to help address
               the configuration issues.
               Not guaranteed to be stable. For programmatic access use 'reason' field.
        :param pulumi.Input[_builtins.str] reason: Reason for provisioning failures.
        """
        if details is not None:
            pulumi.set(__self__, "details", details)
...
class CertificateMapGclbTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CertificateMapGclbTargetIpConfigArgs']]] ip_configs: An IP configuration where this Certificate Map is serving
               Structure is documented below.
        :param pulumi.Input[_builtins.str] target_https_proxy: Proxy name must be in the format projects/*/locations/*/targetHttpsProxies/*.
               This field is part of a union field `target_proxy`: Only one of `targetHttpsProxy` or
               `targetSslProxy` may be set.
        :param pulumi.Input[_builtins.str] target_ssl_proxy: Proxy name must be in the format projects/*/locations/*/targetSslProxies/*.
               This field is part of a union field `target_proxy`: Only one of `targetHttpsProxy` or
               `targetSslProxy` may be set.
        """
...
class TrustConfigAllowlistedCertificateArgs:
    def __init__(__self__, *,
                 pem_certificate: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] pem_certificate: PEM certificate that is allowlisted. The certificate can be up to 5k bytes, and must be a parseable X.509 certificate.
        """
        pulumi.set(__self__, "pem_certificate", pem_certificate)
