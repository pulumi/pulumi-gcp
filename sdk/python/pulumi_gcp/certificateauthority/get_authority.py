...
class GetAuthorityResult:
    ...
    def ignore_active_certificates_on_deletion(self) -> builtins.bool:
    ...
    def pem_ca_certificates(self) -> Sequence[builtins.str]:
    ...
    def skip_grace_period(self) -> builtins.bool:
...
def get_authority(certificate_authority_id: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_authority_id: ID of the certificate authority.
           
           - - -
    :param builtins.str location: The location the certificate authority exists in.
    :param builtins.str pool: The name of the pool the certificate authority belongs to.
...
def get_authority_output(certificate_authority_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
