...
class AuthorityArgs:
    def __init__(__self__, *,
                 certificate_authority_id: pulumi.Input[builtins.str],
                 ...
                 ignore_active_certificates_on_deletion: Optional[pulumi.Input[builtins.bool]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 lifetime: Optional[pulumi.Input[builtins.str]] = None,
                 pem_ca_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 skip_grace_period: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def certificate_authority_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def certificate_authority_id(self, value: pulumi.Input[builtins.str]):
    ...
    def ignore_active_certificates_on_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def pem_ca_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def skip_grace_period(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AuthorityState:
    def __init__(__self__, *,
                 ...
                 pem_ca_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 pem_ca_certificates: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def pem_ca_certificates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def pem_ca_certificates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Authority(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="pemCaCertificates")
    def pem_ca_certificates(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        This CertificateAuthority's certificate chain, including the current
        CertificateAuthority's certificate. Ordered such that the root issuer is the final
        element (consistent with RFC 5246). For a self-signed CA, this will only list the current
