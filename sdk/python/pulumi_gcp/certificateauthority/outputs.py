...
class AuthorityAccessUrl(dict):
    ...
    def __init__(__self__, *,
                 ca_certificate_access_url: Optional[builtins.str] = None,
                 crl_access_urls: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str ca_certificate_access_url: (Output)
               The URL where this CertificateAuthority's CA certificate is published. This will only be
               set for CAs that have been activated.
        :param Sequence[builtins.str] crl_access_urls: (Output)
    ...
    def ca_certificate_access_url(self) -> Optional[builtins.str]:
        """
        (Output)
        The URL where this CertificateAuthority's CA certificate is published. This will only be
        set for CAs that have been activated.
    ...
    def crl_access_urls(self) -> Optional[Sequence[builtins.str]]:
        """
        (Output)
        The URL where this CertificateAuthority's CRLs are published. This will only be set for
        CAs that have been activated.
...
class AuthorityConfigSubjectConfigSubjectAltName(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] dns_names: Contains only valid, fully-qualified host names.
        :param Sequence[builtins.str] email_addresses: Contains only valid RFC 2822 E-mail addresses.
        :param Sequence[builtins.str] ip_addresses: Contains only valid 32-bit IPv4 addresses or RFC 4291 IPv6 addresses.
        :param Sequence[builtins.str] uris: Contains only valid RFC 3986 URIs.
        """
    ...
    @property
    @pulumi.getter
    def uris(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AuthorityConfigSubjectKeyId(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_id: The value of the KeyId in lowercase hexadecimal.
...
class AuthorityConfigX509Config(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aia_ocsp_servers: Optional[Sequence[builtins.str]] = None,
        ...
        :param Sequence[builtins.str] aia_ocsp_servers: Describes Online Certificate Status Protocol (OCSP) endpoint addresses that appear in the
    ...
    def aia_ocsp_servers(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AuthorityConfigX509ConfigAdditionalExtension(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.bool critical: Indicates whether or not this extension is critical (i.e., if the client does not know how to
        ...
        :param 'AuthorityConfigX509ConfigAdditionalExtensionObjectIdArgs' object_id: Describes values that are relevant in a CA certificate.
               Structure is documented below.
        :param builtins.str value: The value of this X.509 extension. A base64-encoded string.
        """
...
class AuthorityConfigX509ConfigAdditionalExtensionObjectId(dict):
    ...
    def __init__(__self__, *,
                 object_id_paths: Sequence[builtins.int]):
        """
        :param Sequence[builtins.int] object_id_paths: An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
        """
        pulumi.set(__self__, "object_id_paths", object_id_paths)

    @property
    @pulumi.getter(name="objectIdPaths")
    def object_id_paths(self) -> Sequence[builtins.int]:
        """
...
class AuthorityConfigX509ConfigCaOptions(dict):
    ...
    def __init__(__self__, *,
                 is_ca: builtins.bool,
                 max_issuer_path_length: Optional[builtins.int] = None,
                 non_ca: Optional[builtins.bool] = None,
                 zero_max_issuer_path_length: Optional[builtins.bool] = None):
        """
        :param builtins.bool is_ca: When true, the "CA" in Basic Constraints extension will be set to true.
        :param builtins.int max_issuer_path_length: Refers to the "path length constraint" in Basic Constraints extension. For a CA certificate, this value describes the depth of
               subordinate CA certificates that are allowed. If this value is less than 0, the request will fail. Setting the value to 0
               requires setting `zero_max_issuer_path_length = true`.
        :param builtins.bool non_ca: When true, the "CA" in Basic Constraints extension will be set to false.
               If both `is_ca` and `non_ca` are unset, the extension will be omitted from the CA certificate.
        :param builtins.bool zero_max_issuer_path_length: When true, the "path length constraint" in Basic Constraints extension will be set to 0.
    ...
    def max_issuer_path_length(self) -> Optional[builtins.int]:
        """
    ...
    def non_ca(self) -> Optional[builtins.bool]:
        """
    ...
    def zero_max_issuer_path_length(self) -> Optional[builtins.bool]:
        """
...
class AuthorityConfigX509ConfigKeyUsageBaseKeyUsage(dict):
    ...
    def __init__(__self__, *,
                 cert_sign: Optional[builtins.bool] = None,
                 content_commitment: Optional[builtins.bool] = None,
                 crl_sign: Optional[builtins.bool] = None,
                 data_encipherment: Optional[builtins.bool] = None,
                 decipher_only: Optional[builtins.bool] = None,
                 digital_signature: Optional[builtins.bool] = None,
                 encipher_only: Optional[builtins.bool] = None,
                 key_agreement: Optional[builtins.bool] = None,
                 key_encipherment: Optional[builtins.bool] = None):
        """
        :param builtins.bool cert_sign: The key may be used to sign certificates.
        :param builtins.bool content_commitment: The key may be used for cryptographic commitments. Note that this may also be referred to as "non-repudiation".
        :param builtins.bool crl_sign: The key may be used sign certificate revocation lists.
        :param builtins.bool data_encipherment: The key may be used to encipher data.
        :param builtins.bool decipher_only: The key may be used to decipher only.
        :param builtins.bool digital_signature: The key may be used for digital signatures.
        :param builtins.bool encipher_only: The key may be used to encipher only.
        :param builtins.bool key_agreement: The key may be used in a key agreement protocol.
        :param builtins.bool key_encipherment: The key may be used to encipher other keys.
        """
    ...
    def cert_sign(self) -> Optional[builtins.bool]:
        """
    ...
    def content_commitment(self) -> Optional[builtins.bool]:
        """
    ...
    def crl_sign(self) -> Optional[builtins.bool]:
        """
    ...
    def data_encipherment(self) -> Optional[builtins.bool]:
        """
    ...
    def decipher_only(self) -> Optional[builtins.bool]:
        """
    ...
    def digital_signature(self) -> Optional[builtins.bool]:
        """
    ...
    def encipher_only(self) -> Optional[builtins.bool]:
        """
    ...
    def key_agreement(self) -> Optional[builtins.bool]:
        """
    ...
    def key_encipherment(self) -> Optional[builtins.bool]:
        """
...
class AuthorityConfigX509ConfigKeyUsageExtendedKeyUsage(dict):
    ...
    def __init__(__self__, *,
                 client_auth: Optional[builtins.bool] = None,
                 code_signing: Optional[builtins.bool] = None,
                 email_protection: Optional[builtins.bool] = None,
                 ocsp_signing: Optional[builtins.bool] = None,
                 server_auth: Optional[builtins.bool] = None,
                 time_stamping: Optional[builtins.bool] = None):
        """
        :param builtins.bool client_auth: Corresponds to OID 1.3.6.1.5.5.7.3.2. Officially described as "TLS WWW client authentication", though regularly used for non-WWW TLS.
        :param builtins.bool code_signing: Corresponds to OID 1.3.6.1.5.5.7.3.3. Officially described as "Signing of downloadable executable code client authentication".
        :param builtins.bool email_protection: Corresponds to OID 1.3.6.1.5.5.7.3.4. Officially described as "Email protection".
        :param builtins.bool ocsp_signing: Corresponds to OID 1.3.6.1.5.5.7.3.9. Officially described as "Signing OCSP responses".
        :param builtins.bool server_auth: Corresponds to OID 1.3.6.1.5.5.7.3.1. Officially described as "TLS WWW server authentication", though regularly used for non-WWW TLS.
        :param builtins.bool time_stamping: Corresponds to OID 1.3.6.1.5.5.7.3.8. Officially described as "Binding the hash of an object to a time".
        """
    ...
    def client_auth(self) -> Optional[builtins.bool]:
        """
    ...
    def code_signing(self) -> Optional[builtins.bool]:
        """
    ...
    def email_protection(self) -> Optional[builtins.bool]:
        """
    ...
    def ocsp_signing(self) -> Optional[builtins.bool]:
        """
    ...
    def server_auth(self) -> Optional[builtins.bool]:
        """
    ...
    def time_stamping(self) -> Optional[builtins.bool]:
        """
...
class AuthorityConfigX509ConfigNameConstraints(dict):
    ...
    def __init__(__self__, *,
                 critical: builtins.bool,
                 excluded_dns_names: Optional[Sequence[builtins.str]] = None,
                 excluded_email_addresses: Optional[Sequence[builtins.str]] = None,
                 excluded_ip_ranges: Optional[Sequence[builtins.str]] = None,
                 excluded_uris: Optional[Sequence[builtins.str]] = None,
                 permitted_dns_names: Optional[Sequence[builtins.str]] = None,
                 permitted_email_addresses: Optional[Sequence[builtins.str]] = None,
                 permitted_ip_ranges: Optional[Sequence[builtins.str]] = None,
                 permitted_uris: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool critical: Indicates whether or not the name constraints are marked critical.
        :param Sequence[builtins.str] excluded_dns_names: Contains excluded DNS names. Any DNS name that can be
               constructed by simply adding zero or more labels to
               the left-hand side of the name satisfies the name constraint.
               For example, `example.com`, `www.example.com`, `www.sub.example.com`
               would satisfy `example.com` while `example1.com` does not.
        :param Sequence[builtins.str] excluded_email_addresses: Contains the excluded email addresses. The value can be a particular
               email address, a hostname to indicate all email addresses on that host or
               a domain with a leading period (e.g. `.example.com`) to indicate
               all email addresses in that domain.
        :param Sequence[builtins.str] excluded_ip_ranges: Contains the excluded IP ranges. For IPv4 addresses, the ranges
               are expressed using CIDR notation as specified in RFC 4632.
               For IPv6 addresses, the ranges are expressed in similar encoding as IPv4
               addresses.
        :param Sequence[builtins.str] excluded_uris: Contains the excluded URIs that apply to the host part of the name.
               The value can be a hostname or a domain with a
               leading period (like `.example.com`)
        :param Sequence[builtins.str] permitted_dns_names: Contains permitted DNS names. Any DNS name that can be
               constructed by simply adding zero or more labels to
               the left-hand side of the name satisfies the name constraint.
               For example, `example.com`, `www.example.com`, `www.sub.example.com`
               would satisfy `example.com` while `example1.com` does not.
        :param Sequence[builtins.str] permitted_email_addresses: Contains the permitted email addresses. The value can be a particular
               email address, a hostname to indicate all email addresses on that host or
               a domain with a leading period (e.g. `.example.com`) to indicate
               all email addresses in that domain.
        :param Sequence[builtins.str] permitted_ip_ranges: Contains the permitted IP ranges. For IPv4 addresses, the ranges
               are expressed using CIDR notation as specified in RFC 4632.
               For IPv6 addresses, the ranges are expressed in similar encoding as IPv4
               addresses.
        :param Sequence[builtins.str] permitted_uris: Contains the permitted URIs that apply to the host part of the name.
               The value can be a hostname or a domain with a
               leading period (like `.example.com`)
        """
        pulumi.set(__self__, "critical", critical)
    ...
    def excluded_dns_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def excluded_email_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def excluded_ip_ranges(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def excluded_uris(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def permitted_dns_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def permitted_email_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def permitted_ip_ranges(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def permitted_uris(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AuthorityKeySpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cloud_kms_key_version: Optional[builtins.str] = None):
        """
    ...
    def cloud_kms_key_version(self) -> Optional[builtins.str]:
        """
...
class AuthoritySubordinateConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_authority: This can refer to a CertificateAuthority that was used to create a
...
class AuthoritySubordinateConfigPemIssuerChain(dict):
    ...
    def __init__(__self__, *,
                 pem_certificates: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] pem_certificates: Expected to be in leaf-to-root order according to RFC 5246.
        """
    ...
    def pem_certificates(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AuthorityUserDefinedAccessUrls(dict):
    ...
    def __init__(__self__, *,
                 aia_issuing_certificate_urls: Optional[Sequence[builtins.str]] = None,
                 crl_access_urls: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] aia_issuing_certificate_urls: A list of URLs where this CertificateAuthority's CA certificate is published that is specified by users.
        :param Sequence[builtins.str] crl_access_urls: A list of URLs where this CertificateAuthority's CRLs are published that is specified by users.
        """
    ...
    def aia_issuing_certificate_urls(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CaPoolIssuancePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CaPoolIssuancePolicyIdentityConstraintsArgs' identity_constraints: Describes constraints on identities that may appear in Certificates issued through this CaPool.
               ...
               Structure is documented below.
        :param builtins.str maximum_lifetime: The maximum lifetime allowed for issued Certificates. Note that if the issuing CertificateAuthority
    ...
    def maximum_lifetime(self) -> Optional[builtins.str]:
        """
...
class CaPoolIssuancePolicyAllowedIssuanceModes(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allow_config_based_issuance: When true, allows callers to create Certificates by specifying a CertificateConfig.
        :param builtins.bool allow_csr_based_issuance: When true, allows callers to create Certificates by specifying a CSR.
        """
    ...
    def allow_config_based_issuance(self) -> builtins.bool:
        """
    ...
    def allow_csr_based_issuance(self) -> builtins.bool:
        """
...
class CaPoolIssuancePolicyAllowedKeyTypeEllipticCurve(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str signature_algorithm: The algorithm used.
...
class CaPoolIssuancePolicyAllowedKeyTypeRsa(dict):
    ...
    def __init__(__self__, *,
                 max_modulus_size: Optional[builtins.str] = None,
                 min_modulus_size: Optional[builtins.str] = None):
        """
        :param builtins.str max_modulus_size: The maximum allowed RSA modulus size, in bits. If this is not set, or if set to zero, the
               service will not enforce an explicit upper bound on RSA modulus sizes.
        :param builtins.str min_modulus_size: The minimum allowed RSA modulus size, in bits. If this is not set, or if set to zero, the
    ...
    def max_modulus_size(self) -> Optional[builtins.str]:
        """
    ...
    def min_modulus_size(self) -> Optional[builtins.str]:
        """
...
class CaPoolIssuancePolicyBaselineValuesCaOptions(dict):
    ...
    def __init__(__self__, *,
                 is_ca: Optional[builtins.bool] = None,
                 max_issuer_path_length: Optional[builtins.int] = None,
                 non_ca: Optional[builtins.bool] = None,
                 zero_max_issuer_path_length: Optional[builtins.bool] = None):
        """
    ...
    @property
    @pulumi.getter(name="isCa")
    def is_ca(self) -> Optional[builtins.bool]:
        """
        When true, the "CA" in Basic Constraints extension will be set to true.
        """
        return pulumi.get(self, "is_ca")
...
class CaPoolIssuancePolicyIdentityConstraints(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allow_subject_alt_names_passthrough: If this is set, the SubjectAltNames extension may be copied from a certificate request into the signed certificate.
               Otherwise, the requested SubjectAltNames will be discarded.
        :param builtins.bool allow_subject_passthrough: If this is set, the Subject field may be copied from a certificate request into the signed certificate.
    ...
    def allow_subject_alt_names_passthrough(self) -> builtins.bool:
        """
    ...
    def allow_subject_passthrough(self) -> builtins.bool:
        """
...
class CaPoolIssuancePolicyIdentityConstraintsCelExpression(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expression: Textual representation of an expression in Common Expression Language syntax.
        :param builtins.str description: Description of the expression. This is a longer text which describes the expression, e.g. when hovered over it in a UI.
        ...
        :param builtins.str title: Title for the expression, i.e. a short string describing its purpose. This can be used e.g. in UIs which allow to enter the expression.
        """
        pulumi.set(__self__, "expression", expression)
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class CaPoolPublishingOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 encoding_format: Optional[builtins.str] = None):
        """
        :param builtins.bool publish_ca_cert: When true, publishes each CertificateAuthority's CA certificate and includes its URL in the "Authority Information Access"
               X.509 extension in all issued Certificates. If this is false, the CA certificate will not be published and the corresponding
               X.509 extension will not be written in issued certificates.
        :param builtins.bool publish_crl: When true, publishes each CertificateAuthority's CRL and includes its URL in the "CRL Distribution Points" X.509 extension
               in all issued Certificates. If this is false, CRLs will not be published and the corresponding X.509 extension will not
               be written in issued certificates. CRLs will expire 7 days from their creation. However, we will rebuild daily. CRLs are
               also rebuilt shortly after a certificate is revoked.
        :param builtins.str encoding_format: Specifies the encoding format of each CertificateAuthority's CA
    ...
    def publish_ca_cert(self) -> builtins.bool:
        """
    ...
    def publish_crl(self) -> builtins.bool:
        """
    ...
    def encoding_format(self) -> Optional[builtins.str]:
        """
...
class CertificateCertificateDescription(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crl_distribution_points: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param Sequence[builtins.str] aia_issuing_certificate_urls: (Output)
        ...
        :param Sequence['CertificateCertificateDescriptionCertFingerprintArgs'] cert_fingerprints: (Output)
               ...
               Structure is documented below.
        :param Sequence[builtins.str] crl_distribution_points: (Output)
    ...
    def crl_distribution_points(self) -> Optional[Sequence[builtins.str]]:
        """
        (Output)
        Describes a list of locations to obtain CRL information, i.e. the DistributionPoint.fullName described by https://tools.ietf.org/html/rfc5280#section-4.2.1.13
        """
...
class CertificateCertificateDescriptionAuthorityKeyId(dict):
    ...
    def __init__(__self__, *,
                 key_id: Optional[builtins.str] = None):
        """
        :param builtins.str key_id: (Output)
...
class CertificateCertificateDescriptionCertFingerprint(dict):
    ...
    def __init__(__self__, *,
                 sha256_hash: Optional[builtins.str] = None):
        """
        :param builtins.str sha256_hash: (Output)
    ...
    def sha256_hash(self) -> Optional[builtins.str]:
        """
        (Output)
        The SHA 256 hash, encoded in hexadecimal, of the DER x509 certificate.
        """
...
class CertificateCertificateDescriptionPublicKey(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str format: The format of the public key. Currently, only PEM format is supported.
               Possible values are: `KEY_TYPE_UNSPECIFIED`, `PEM`.
        :param builtins.str key: Required. A public key. When this is specified in a request, the padding and encoding can be any of the options described by the respective 'KeyType' value. When this is generated by the service, it will always be an RFC 5280 SubjectPublicKeyInfo structure containing an algorithm identifier and a key. A base64-encoded string.
        """
...
class CertificateCertificateDescriptionSubjectDescription(dict):
    ...
    def __init__(__self__, *,
                 hex_serial_number: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str hex_serial_number: (Output)
               The serial number encoded in lowercase hexadecimal.
        :param builtins.str lifetime: The desired lifetime of the CA certificate. Used to create the "notBeforeTime" and
    ...
    def hex_serial_number(self) -> Optional[builtins.str]:
        """
        (Output)
        The serial number encoded in lowercase hexadecimal.
        """
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSan(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool critical: (Output)
               Indicates whether or not the name constraints are marked critical.
...
class CertificateCertificateDescriptionSubjectDescriptionSubjectAltNameCustomSanObectId(dict):
    ...
    def __init__(__self__, *,
                 object_id_paths: Optional[Sequence[builtins.int]] = None):
        """
        :param Sequence[builtins.int] object_id_paths: (Output)
               An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
        """
    ...
    @property
    @pulumi.getter(name="objectIdPaths")
    def object_id_paths(self) -> Optional[Sequence[builtins.int]]:
        """
        (Output)
        An ObjectId specifies an object identifier (OID). These provide context and describe types in ASN.1 messages.
        """
...
class CertificateCertificateDescriptionX509Description(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['CertificateCertificateDescriptionX509DescriptionAdditionalExtensionArgs'] additional_extensions: (Output)
               ...
               Structure is documented below.
        :param Sequence[builtins.str] aia_ocsp_servers: (Output)
               Describes Online Certificate Status Protocol (OCSP) endpoint addresses that appear in the
               "Authority Information Access" extension in the certificate.
...
class CertificateRevocationDetail(dict):
    ...
    def __init__(__self__, *,
                 revocation_state: Optional[builtins.str] = None,
                 revocation_time: Optional[builtins.str] = None):
        """
        :param builtins.str revocation_state: (Output)
               Indicates why a Certificate was revoked.
        :param builtins.str revocation_time: (Output)
    ...
    def revocation_state(self) -> Optional[builtins.str]:
        """
        (Output)
        Indicates why a Certificate was revoked.
        """
    ...
    def revocation_time(self) -> Optional[builtins.str]:
        """
        (Output)
        The time at which this Certificate was revoked.
        """
...
class CertificateTemplateIdentityConstraints(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allow_subject_alt_names_passthrough: Required. If this is true, the SubjectAltNames extension may be copied from a certificate request into the signed certificate. Otherwise, the requested SubjectAltNames will be discarded.
        :param builtins.bool allow_subject_passthrough: Required. If this is true, the Subject field may be copied from a certificate request into the signed certificate. Otherwise, the requested Subject will be discarded.
...
class CertificateTemplatePassthroughExtensions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 known_extensions: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence['CertificateTemplatePassthroughExtensionsAdditionalExtensionArgs'] additional_extensions: Optional. A set of ObjectIds identifying custom X.509 extensions. Will be combined with known_extensions to determine the full set of X.509 extensions.
               Structure is documented below.
        :param Sequence[builtins.str] known_extensions: Optional. A set of named X.509 extensions. Will be combined with additional_extensions to determine the full set of X.509 extensions.
        """
        if additional_extensions is not None:
            pulumi.set(__self__, "additional_extensions", additional_extensions)
    ...
    def known_extensions(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CertificateTemplatePassthroughExtensionsAdditionalExtension(dict):
    ...
    def __init__(__self__, *,
                 object_id_paths: Sequence[builtins.int]):
        """
        :param Sequence[builtins.int] object_id_paths: Required. The parts of an OID path. The most significant parts of the path come first.
        """
        pulumi.set(__self__, "object_id_paths", object_id_paths)
...
class CertificateTemplatePredefinedValues(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['CertificateTemplatePredefinedValuesAdditionalExtensionArgs'] additional_extensions: Optional. Describes custom X.509 extensions.
               Structure is documented below.
        :param Sequence[builtins.str] aia_ocsp_servers: Optional. Describes Online Certificate Status Protocol (OCSP) endpoint addresses that appear in the "Authority Information Access" extension in the certificate.
...
class CertificateTemplatePredefinedValuesAdditionalExtension(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CertificateTemplatePredefinedValuesAdditionalExtensionObjectIdArgs' object_id: Required. The OID for this X.509 extension.
               Structure is documented below.
        :param builtins.str value: Required. The value of this X.509 extension.
        :param builtins.bool critical: Optional. Indicates whether or not this extension is critical (i.e., if the client does not know how to handle this extension, the client should consider this to be an error).
        """
        pulumi.set(__self__, "object_id", object_id)
        pulumi.set(__self__, "value", value)
        if critical is not None:
...
class CertificateTemplatePredefinedValuesCaOptions(dict):
    ...
    def __init__(__self__, *,
                 is_ca: Optional[builtins.bool] = None,
                 max_issuer_path_length: Optional[builtins.int] = None,
                 null_ca: Optional[builtins.bool] = None,
                 zero_max_issuer_path_length: Optional[builtins.bool] = None):
        """
        :param builtins.bool is_ca: Optional. Refers to the "CA" X.509 extension, which is a boolean value. When this value is true, the "CA" in Basic Constraints extension will be set to true.
        :param builtins.int max_issuer_path_length: Optional. Refers to the "path length constraint" in Basic Constraints extension. For a CA certificate, this value describes the depth of
               subordinate CA certificates that are allowed. If this value is less than 0, the request will fail.
        :param builtins.bool null_ca: Optional. When true, the "CA" in Basic Constraints extension will be set to null and omitted from the CA certificate.
        ...
        :param builtins.bool zero_max_issuer_path_length: Optional. When true, the "path length constraint" in Basic Constraints extension will be set to 0.
               if both `max_issuer_path_length` and `zero_max_issuer_path_length` are unset,
               the max path length will be omitted from the CA certificate.
        """
        if is_ca is not None:
    ...
    def null_ca(self) -> Optional[builtins.bool]:
        """
...
class GetAuthorityAccessUrlResult(dict):
    def __init__(__self__, *,
                 ca_certificate_access_url: builtins.str,
                 crl_access_urls: Sequence[builtins.str]):
        """
        :param builtins.str ca_certificate_access_url: The URL where this CertificateAuthority's CA certificate is published. This will only be
               set for CAs that have been activated.
        :param Sequence[builtins.str] crl_access_urls: The URL where this CertificateAuthority's CRLs are published. This will only be set for
               CAs that have been activated.
        """
        pulumi.set(__self__, "ca_certificate_access_url", ca_certificate_access_url)
        pulumi.set(__self__, "crl_access_urls", crl_access_urls)
    ...
    @property
    @pulumi.getter(name="crlAccessUrls")
    def crl_access_urls(self) -> Sequence[builtins.str]:
        """
        The URL where this CertificateAuthority's CRLs are published. This will only be set for
        CAs that have been activated.
        """
...
class GetAuthorityConfigSubjectConfigSubjectAltNameResult(dict):
    def __init__(__self__, *,
                 ...
                 email_addresses: Sequence[builtins.str],
    ...
    @property
    @pulumi.getter(name="emailAddresses")
    def email_addresses(self) -> Sequence[builtins.str]:
        """
        Contains only valid RFC 2822 E-mail addresses.
        """
        return pulumi.get(self, "email_addresses")
...
class GetAuthorityConfigX509ConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 aia_ocsp_servers: Sequence[builtins.str],
    ...
    @property
    @pulumi.getter(name="aiaOcspServers")
    def aia_ocsp_servers(self) -> Sequence[builtins.str]:
        """
        Describes Online Certificate Status Protocol (OCSP) endpoint addresses that appear in the
        "Authority Information Access" extension in the certificate.
        """
...
class GetAuthorityConfigX509ConfigCaOptionResult(dict):
    ...
    @property
    @pulumi.getter(name="maxIssuerPathLength")
    def max_issuer_path_length(self) -> builtins.int:
        """
        Refers to the "path length constraint" in Basic Constraints extension. For a CA certificate, this value describes the depth of
        subordinate CA certificates that are allowed. If this value is less than 0, the request will fail. Setting the value to 0
        requires setting 'zero_max_issuer_path_length = true'.
    ...
    @property
    @pulumi.getter(name="zeroMaxIssuerPathLength")
    def zero_max_issuer_path_length(self) -> builtins.bool:
        """
        When true, the "path length constraint" in Basic Constraints extension will be set to 0.
        If both 'max_issuer_path_length' and 'zero_max_issuer_path_length' are unset,
        the max path length will be omitted from the CA certificate.
...
class GetAuthorityConfigX509ConfigKeyUsageBaseKeyUsageResult(dict):
    ...
    @property
    @pulumi.getter(name="certSign")
    def cert_sign(self) -> builtins.bool:
        """
        The key may be used to sign certificates.
        """
        return pulumi.get(self, "cert_sign")
    ...
    @property
    @pulumi.getter(name="contentCommitment")
    def content_commitment(self) -> builtins.bool:
        """
        The key may be used for cryptographic commitments. Note that this may also be referred to as "non-repudiation".
        """
        return pulumi.get(self, "content_commitment")
    ...
    @property
    @pulumi.getter(name="crlSign")
    def crl_sign(self) -> builtins.bool:
        """
        The key may be used sign certificate revocation lists.
        """
        return pulumi.get(self, "crl_sign")
    ...
    @property
    @pulumi.getter(name="dataEncipherment")
    def data_encipherment(self) -> builtins.bool:
        """
        The key may be used to encipher data.
        """
        return pulumi.get(self, "data_encipherment")
    ...
    @property
    @pulumi.getter(name="decipherOnly")
    def decipher_only(self) -> builtins.bool:
        """
        The key may be used to decipher only.
        """
        return pulumi.get(self, "decipher_only")
    ...
    @property
    @pulumi.getter(name="digitalSignature")
    def digital_signature(self) -> builtins.bool:
        """
        The key may be used for digital signatures.
        """
        return pulumi.get(self, "digital_signature")
    ...
    @property
    @pulumi.getter(name="encipherOnly")
    def encipher_only(self) -> builtins.bool:
        """
        The key may be used to encipher only.
        """
        return pulumi.get(self, "encipher_only")
    ...
    @property
    @pulumi.getter(name="keyAgreement")
    def key_agreement(self) -> builtins.bool:
        """
        The key may be used in a key agreement protocol.
        """
        return pulumi.get(self, "key_agreement")
    ...
    @property
    @pulumi.getter(name="keyEncipherment")
    def key_encipherment(self) -> builtins.bool:
        """
        The key may be used to encipher other keys.
        """
        return pulumi.get(self, "key_encipherment")
...
class GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsageResult(dict):
    ...
    @property
    @pulumi.getter(name="clientAuth")
    def client_auth(self) -> builtins.bool:
        """
        Corresponds to OID 1.3.6.1.5.5.7.3.2. Officially described as "TLS WWW client authentication", though regularly used for non-WWW TLS.
        """
        return pulumi.get(self, "client_auth")
    ...
    @property
    @pulumi.getter(name="codeSigning")
    def code_signing(self) -> builtins.bool:
        """
        Corresponds to OID 1.3.6.1.5.5.7.3.3. Officially described as "Signing of downloadable executable code client authentication".
        """
        return pulumi.get(self, "code_signing")
    ...
    @property
    @pulumi.getter(name="emailProtection")
    def email_protection(self) -> builtins.bool:
        """
        Corresponds to OID 1.3.6.1.5.5.7.3.4. Officially described as "Email protection".
        """
        return pulumi.get(self, "email_protection")
    ...
    @property
    @pulumi.getter(name="ocspSigning")
    def ocsp_signing(self) -> builtins.bool:
        """
        Corresponds to OID 1.3.6.1.5.5.7.3.9. Officially described as "Signing OCSP responses".
        """
        return pulumi.get(self, "ocsp_signing")
    ...
    @property
    @pulumi.getter(name="serverAuth")
    def server_auth(self) -> builtins.bool:
        """
        Corresponds to OID 1.3.6.1.5.5.7.3.1. Officially described as "TLS WWW server authentication", though regularly used for non-WWW TLS.
        """
        return pulumi.get(self, "server_auth")
    ...
    @property
    @pulumi.getter(name="timeStamping")
    def time_stamping(self) -> builtins.bool:
        """
        Corresponds to OID 1.3.6.1.5.5.7.3.8. Officially described as "Binding the hash of an object to a time".
        """
        return pulumi.get(self, "time_stamping")
...
class GetAuthorityConfigX509ConfigNameConstraintResult(dict):
    def __init__(__self__, *,
                 critical: builtins.bool,
                 excluded_dns_names: Sequence[builtins.str],
                 excluded_email_addresses: Sequence[builtins.str],
                 excluded_ip_ranges: Sequence[builtins.str],
                 excluded_uris: Sequence[builtins.str],
                 permitted_dns_names: Sequence[builtins.str],
                 permitted_email_addresses: Sequence[builtins.str],
                 permitted_ip_ranges: Sequence[builtins.str],
                 permitted_uris: Sequence[builtins.str]):
        """
        :param builtins.bool critical: Indicates whether or not the name constraints are marked critical.
        :param Sequence[builtins.str] excluded_dns_names: Contains excluded DNS names. Any DNS name that can be
               constructed by simply adding zero or more labels to
    ...
    @property
    @pulumi.getter(name="excludedDnsNames")
    def excluded_dns_names(self) -> Sequence[builtins.str]:
        """
        Contains excluded DNS names. Any DNS name that can be
        constructed by simply adding zero or more labels to
        the left-hand side of the name satisfies the name constraint.
    ...
    @property
    @pulumi.getter(name="excludedEmailAddresses")
    def excluded_email_addresses(self) -> Sequence[builtins.str]:
        """
        Contains the excluded email addresses. The value can be a particular
        email address, a hostname to indicate all email addresses on that host or
        a domain with a leading period (e.g. '.example.com') to indicate
    ...
    @property
    @pulumi.getter(name="excludedIpRanges")
    def excluded_ip_ranges(self) -> Sequence[builtins.str]:
        """
        Contains the excluded IP ranges. For IPv4 addresses, the ranges
        are expressed using CIDR notation as specified in RFC 4632.
        For IPv6 addresses, the ranges are expressed in similar encoding as IPv4
    ...
    @property
    @pulumi.getter(name="excludedUris")
    def excluded_uris(self) -> Sequence[builtins.str]:
        """
        Contains the excluded URIs that apply to the host part of the name.
        The value can be a hostname or a domain with a
        leading period (like '.example.com')
    ...
    @property
    @pulumi.getter(name="permittedDnsNames")
    def permitted_dns_names(self) -> Sequence[builtins.str]:
        """
        Contains permitted DNS names. Any DNS name that can be
        constructed by simply adding zero or more labels to
        the left-hand side of the name satisfies the name constraint.
    ...
    @property
    @pulumi.getter(name="permittedEmailAddresses")
    def permitted_email_addresses(self) -> Sequence[builtins.str]:
        """
        Contains the permitted email addresses. The value can be a particular
        email address, a hostname to indicate all email addresses on that host or
        a domain with a leading period (e.g. '.example.com') to indicate
    ...
    @property
    @pulumi.getter(name="permittedIpRanges")
    def permitted_ip_ranges(self) -> Sequence[builtins.str]:
        """
        Contains the permitted IP ranges. For IPv4 addresses, the ranges
        are expressed using CIDR notation as specified in RFC 4632.
        For IPv6 addresses, the ranges are expressed in similar encoding as IPv4
    ...
    @property
    @pulumi.getter(name="permittedUris")
    def permitted_uris(self) -> Sequence[builtins.str]:
        """
        Contains the permitted URIs that apply to the host part of the name.
        The value can be a hostname or a domain with a
        leading period (like '.example.com')
...
class GetAuthoritySubordinateConfigPemIssuerChainResult(dict):
    def __init__(__self__, *,
                 pem_certificates: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] pem_certificates: Expected to be in leaf-to-root order according to RFC 5246.
        """
        pulumi.set(__self__, "pem_certificates", pem_certificates)
    ...
    @property
    @pulumi.getter(name="pemCertificates")
    def pem_certificates(self) -> Sequence[builtins.str]:
        """
        Expected to be in leaf-to-root order according to RFC 5246.
        """
        return pulumi.get(self, "pem_certificates")
...
class GetAuthorityUserDefinedAccessUrlResult(dict):
    def __init__(__self__, *,
                 aia_issuing_certificate_urls: Sequence[builtins.str],
                 crl_access_urls: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] aia_issuing_certificate_urls: A list of URLs where this CertificateAuthority's CA certificate is published that is specified by users.
        :param Sequence[builtins.str] crl_access_urls: A list of URLs where this CertificateAuthority's CRLs are published that is specified by users.
    ...
    @property
    @pulumi.getter(name="aiaIssuingCertificateUrls")
    def aia_issuing_certificate_urls(self) -> Sequence[builtins.str]:
        """
        A list of URLs where this CertificateAuthority's CA certificate is published that is specified by users.
        """
        return pulumi.get(self, "aia_issuing_certificate_urls")
