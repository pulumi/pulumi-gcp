...
class CertificateTemplateIamMemberArgs:
    def __init__(__self__, *,
        ...
        """
        CertificateTemplateIamMemberArgs._configure(
...
class _CertificateTemplateIamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        """
        _CertificateTemplateIamMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            certificate_template=certificate_template,
            condition=condition,
            etag=etag,
...
class CertificateTemplateIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CertificateTemplateIamMemberArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, CertificateTemplateIamMemberConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                CertificateTemplateIamMemberConditionArgs._configure(_setter, **condition)
