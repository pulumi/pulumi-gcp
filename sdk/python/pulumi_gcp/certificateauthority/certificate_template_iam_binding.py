...
class CertificateTemplateIamBindingArgs:
    def __init__(__self__, *,
                 certificate_template: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] certificate_template: Used to find the parent resource to bind the IAM policy to
    ...
    def certificate_template(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def certificate_template(self, value: pulumi.Input[builtins.str]):
...
class CertificateTemplateIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 certificate_template: Optional[pulumi.Input[builtins.str]] = None,
                 condition: Optional[pulumi.Input[Union['CertificateTemplateIamBindingConditionArgs', 'CertificateTemplateIamBindingConditionArgsDict']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None,
        ...
        * {{location}}/{{name}}
        ...
        :param pulumi.Input[builtins.str] certificate_template: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[Union['CertificateTemplateIamBindingConditionArgs', 'CertificateTemplateIamBindingConditionArgsDict']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[builtins.str] location: The location for the resource Used to find the parent resource to bind the IAM policy to. If not specified,
               the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
               location is specified, it is taken from the provider configuration.
    ...
    def get(resource_name: str,
            ...
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'CertificateTemplateIamBinding':
        """
    ...
    @property
    @pulumi.getter(name="certificateTemplate")
    def certificate_template(self) -> pulumi.Output[builtins.str]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "certificate_template")
