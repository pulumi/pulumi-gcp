...
class CaPoolIamPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ca_pool: Used to find the parent resource to bind the IAM policy to
...
class CaPoolIamPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[builtins.str]] = None,
            policy_data: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None) -> 'CaPoolIamPolicy':
        """
