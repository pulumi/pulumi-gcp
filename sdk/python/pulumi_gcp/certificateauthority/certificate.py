...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels with user-defined metadata to apply to this resource.
        ...
        :param pulumi.Input[_builtins.str] name: The name for this Certificate.
        :param pulumi.Input[_builtins.str] pem_csr: Immutable. A pem-encoded X.509 certificate signing request (CSR).
...
class _CertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] issuer_certificate_authority: The resource name of the issuing CertificateAuthority in the format `projects/*/locations/*/caPools/*/certificateAuthorities/*`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Labels with user-defined metadata to apply to this resource.
        ...
        :param pulumi.Input[_builtins.str] location: Location of the Certificate. A full list of valid locations can be found by
               running `gcloud privateca locations list`.
        :param pulumi.Input[_builtins.str] name: The name for this Certificate.
        :param pulumi.Input[_builtins.str] pem_certificate: Output only. The pem-encoded, signed X.509 certificate.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] pem_certificate_chains: The chain that may be used to verify the X.509 certificate. Expected to be in issuer-to-root order according to RFC 5246.
        :param pulumi.Input[_builtins.str] pem_csr: Immutable. A pem-encoded X.509 certificate signing request (CSR).
        :param pulumi.Input[_builtins.str] pool: The name of the CaPool this Certificate belongs to.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
