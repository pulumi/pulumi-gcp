...
def get_ca_pool_iam_policy(ca_pool: Optional[builtins.str] = None,
    ...
    :param builtins.str ca_pool: Used to find the parent resource to bind the IAM policy to
    :param builtins.str location: Location of the CaPool. A full list of valid locations can be found by
...
def get_ca_pool_iam_policy_output(ca_pool: Optional[pulumi.Input[builtins.str]] = None,
