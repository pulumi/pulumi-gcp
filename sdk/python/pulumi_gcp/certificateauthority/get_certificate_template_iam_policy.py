...
def get_certificate_template_iam_policy(certificate_template: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_template: Used to find the parent resource to bind the IAM policy to
