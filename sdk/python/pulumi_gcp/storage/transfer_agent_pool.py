...
class TransferAgentPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Specifies the client-specified AgentPool description.
        :param pulumi.Input[builtins.str] name: The ID of the agent pool to create.
...
class _TransferAgentPoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] state: Specifies the state of the AgentPool.
        """
        if bandwidth_limit is not None:
            pulumi.set(__self__, "bandwidth_limit", bandwidth_limit)
        if display_name is not None:
...
@pulumi.type_token("gcp:storage/transferAgentPool:TransferAgentPool")
class TransferAgentPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'TransferAgentPool':
        """
