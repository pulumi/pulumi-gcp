...
class ManagedFolderIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['ManagedFolderIamMemberConditionArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['ManagedFolderIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['ManagedFolderIamMemberConditionArgs']]):
...
class ManagedFolderIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bucket: pulumi.Input[Optional[_builtins.str]] = None,
                 condition: pulumi.Input[Optional[Union['ManagedFolderIamMemberConditionArgs', 'ManagedFolderIamMemberConditionArgsDict', 'outputs.ManagedFolderIamMemberCondition']]] = None,
                 managed_folder: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        * {{bucket}}/{{managed_folder}}
        ...
        :param pulumi.Input[_builtins.str] bucket: The name of the bucket that contains the managed folder. Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[Union['ManagedFolderIamMemberConditionArgs', 'ManagedFolderIamMemberConditionArgsDict', 'outputs.ManagedFolderIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] managed_folder: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
    ...
    def get(resource_name: str,
            ...
            managed_folder: pulumi.Input[Optional[_builtins.str]] = None,
            member: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'ManagedFolderIamMember':
        """
