...
def get_transfer_project_servie_account(project: Optional[builtins.str] = None,
    ...
    :param builtins.str project: The project ID. If it is not provided, the provider project is used.
    """
...
def get_transfer_project_servie_account_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
