...
def get_transfer_project_servie_account(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project: The project ID. If it is not provided, the provider project is used.
    """
