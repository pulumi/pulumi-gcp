...
class TransferJobArgs:
    ...
    def _configure(
        ...
        if event_stream is None and 'eventStream' in kwargs:
            event_stream = kwargs['eventStream']
...
class TransferJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            event_stream = _utilities.configure(event_stream, TransferJobEventStreamArgs, True)
