...
class TransferJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Unique description to identify the Transfer Job.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Transfer Job. This name must start with "transferJobs/" prefix and end with a letter or a number, and should be no more than 128 characters ( `transferJobs/^(?!OPI)[A-Za-z0-9-._~]*[A-Za-z0-9]$` ). For transfers involving PosixFilesystem, this name must start with transferJobs/OPI specifically ( `transferJobs/OPI^[A-Za-z0-9-._~]*[A-Za-z0-9]$` ). For all other transfer types, this name must not start with transferJobs/OPI. Default the provider will assign a random unique name with `transferJobs/{{name}}` format, where `name` is a numeric value.
        ...
        :param pulumi.Input[builtins.str] status: Status of the job. Default: `ENABLED`. **NOTE: The effect of the new job status takes place during a subsequent job run. For example, if you change the job status from ENABLED to DISABLED, and an operation spawned by the transfer is running, the status change would not affect the current operation.**
...
class _TransferJobState:
    def __init__(__self__, *,
                 ...
                 event_stream: Optional[pulumi.Input['TransferJobEventStreamArgs']] = None,
                 last_modification_time: Optional[pulumi.Input[builtins.str]] = None,
                 logging_config: Optional[pulumi.Input['TransferJobLoggingConfigArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notification_config: Optional[pulumi.Input['TransferJobNotificationConfigArgs']] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] creation_time: When the Transfer Job was created.
        :param pulumi.Input[builtins.str] deletion_time: When the Transfer Job was deleted.
        :param pulumi.Input[builtins.str] description: Unique description to identify the Transfer Job.
        :param pulumi.Input['TransferJobEventStreamArgs'] event_stream: Specifies the Event-driven transfer options. Event-driven transfers listen to an event stream to transfer updated files. Structure documented below Either `event_stream` or `schedule` must be set.
        :param pulumi.Input[builtins.str] last_modification_time: When the Transfer Job was last modified.
        :param pulumi.Input['TransferJobLoggingConfigArgs'] logging_config: Logging configuration. Structure documented below.
        :param pulumi.Input[builtins.str] name: The name of the Transfer Job. This name must start with "transferJobs/" prefix and end with a letter or a number, and should be no more than 128 characters ( `transferJobs/^(?!OPI)[A-Za-z0-9-._~]*[A-Za-z0-9]$` ). For transfers involving PosixFilesystem, this name must start with transferJobs/OPI specifically ( `transferJobs/OPI^[A-Za-z0-9-._~]*[A-Za-z0-9]$` ). For all other transfer types, this name must not start with transferJobs/OPI. Default the provider will assign a random unique name with `transferJobs/{{name}}` format, where `name` is a numeric value.
        :param pulumi.Input['TransferJobNotificationConfigArgs'] notification_config: Notification configuration. This is not supported for transfers involving PosixFilesystem. Structure documented below.
        :param pulumi.Input[builtins.str] project: The project in which the resource belongs. If it
    ...
    def last_modification_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_modification_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TransferJob(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="lastModificationTime")
    def last_modification_time(self) -> pulumi.Output[builtins.str]:
        """
        When the Transfer Job was last modified.
        """
        return pulumi.get(self, "last_modification_time")
