...
class GetObjectSignedUrlResult:
    ...
    def extension_headers(self) -> Optional[Mapping[str, builtins.str]]:
...
def get_object_signed_url(bucket: Optional[builtins.str] = None,
                          ...
                          extension_headers: Optional[Mapping[str, builtins.str]] = None,
    ...
    :param builtins.str content_md5: The [MD5 digest](https://cloud.google.com/storage/docs/hashes-etags#_MD5) value in Base64.
    ...
    :param builtins.str content_type: If you specify this in the datasource, the client must provide the `Content-Type` HTTP header with the same value in its request.
    :param builtins.str credentials: What Google service account credentials json should be used to sign the URL.
    ...
    :param builtins.str duration: For how long shall the signed URL be valid (defaults to 1 hour - i.e. `1h`).
           See [here](https://golang.org/pkg/time/#ParseDuration) for info on valid duration formats.
    :param Mapping[str, builtins.str] extension_headers: As needed. The server checks to make sure that the client provides matching values in requests using the signed URL.
    ...
    :param builtins.str http_method: What HTTP Method will the signed URL allow (defaults to `GET`)
    :param builtins.str path: The full path to the object inside the bucket
    """
    __args__ = dict()
...
def get_object_signed_url_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
                                 content_md5: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 content_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 credentials: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 duration: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 extension_headers: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                                 http_method: Optional[pulumi.Input[Optional[builtins.str]]] = None,
