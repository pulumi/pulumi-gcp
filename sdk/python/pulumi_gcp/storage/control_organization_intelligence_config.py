...
class ControlOrganizationIntelligenceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] edition_config: Edition configuration of the Storage Intelligence resource. Valid values are INHERIT, DISABLED, TRIAL and STANDARD.
