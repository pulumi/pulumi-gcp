...
class ObjectACLArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: The name of the bucket the object is stored in.
        :param pulumi.Input[builtins.str] object: The name of the object to apply the acl to.
               
               - - -
        :param pulumi.Input[builtins.str] predefined_acl: The "canned" [predefined ACL](https://cloud.google.com/storage/docs/access-control#predefined-acl) to apply. Must be set if `role_entity` is not.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] role_entities: List of role/entity pairs in the form `ROLE:entity`. See [GCS Object ACL documentation](https://cloud.google.com/storage/docs/json_api/v1/objectAccessControls) for more details.
...
class ObjectACL(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            object: Optional[pulumi.Input[builtins.str]] = None,
            predefined_acl: Optional[pulumi.Input[builtins.str]] = None,
            role_entities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ObjectACL':
        """
