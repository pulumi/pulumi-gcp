...
__all__ = [
    ...
    'BucketEncryptionCustomerManagedEncryptionEnforcementConfigArgsDict',
    'BucketEncryptionCustomerSuppliedEncryptionEnforcementConfigArgs',
    'BucketEncryptionCustomerSuppliedEncryptionEnforcementConfigArgsDict',
    'BucketEncryptionGoogleManagedEncryptionEnforcementConfigArgs',
    'BucketEncryptionGoogleManagedEncryptionEnforcementConfigArgsDict',
...
class BucketEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] default_kms_key_name: The `id` of a Cloud KMS key that will be used to encrypt objects inserted into this bucket, if no encryption method is specified.
               ...
               state of the project.
               You should take care for race conditions when the same provider manages IAM policy on the Cloud KMS crypto key. See the data source page for more details.
        :param pulumi.Input['BucketEncryptionGoogleManagedEncryptionEnforcementConfigArgs'] google_managed_encryption_enforcement_config: If omitted, then new objects with GMEK encryption-type is allowed. If set, then new objects created in this bucket must comply with enforcement config. Changing this has no effect on existing objects; it applies to new objects only, Structure is documented below documented below.
        """
...
class BucketEncryptionCustomerManagedEncryptionEnforcementConfigArgsDict(TypedDict):
...
class BucketEncryptionCustomerSuppliedEncryptionEnforcementConfigArgsDict(TypedDict):
    restriction_mode: pulumi.Input[_builtins.str]
    """
...
class BucketEncryptionGoogleManagedEncryptionEnforcementConfigArgsDict(TypedDict):
    restriction_mode: pulumi.Input[_builtins.str]
    """
...
class BucketLifecycleRuleConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] days_since_custom_time: Days since the date set in the `customTime` metadata for the object. This condition is satisfied when the current date and time is at least the specified number of days after the `customTime`. Due to a current bug you are unable to set this value to `0` within Terraform. When set to `0` it will be ignored, and your state will treat it as though you supplied no `days_since_custom_time` condition.
        :param pulumi.Input[_builtins.int] days_since_noncurrent_time: Relevant only for versioned objects. Number of days elapsed since the noncurrent timestamp of an object. Due to a current bug you are unable to set this value to `0` within Terraform. When set to `0` it will be ignored, and your state will treat it as though you supplied no `days_since_noncurrent_time` condition.
        ...
        :param pulumi.Input[_builtins.str] noncurrent_time_before: Relevant only for versioned objects. The date in RFC 3339 (e.g. `2017-06-13`) when the object became nonconcurrent. Due to a current bug you are unable to set this value to `0` within Terraform. When set to `0` it will be ignored, and your state will treat it as though you supplied no `noncurrent_time_before` condition.
        :param pulumi.Input[_builtins.int] num_newer_versions: Relevant only for versioned objects. The number of newer versions of an object to satisfy this condition. Due to a current bug you are unable to set this value to `0` within Terraform. When set to `0` it will be ignored and your state will treat it as though you supplied no `num_newer_versions` condition.
...
class TransferJobTransferSpecAzureBlobStorageDataSourceArgsDict(TypedDict):
    ...
    Root path to transfer objects. Must be an empty string or full path name that ends with a '/'. This field is treated as an object prefix. As such, it should generally not begin with a '/'.
    """
    private_network_service: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class TransferJobTransferSpecAzureBlobStorageDataSourceArgs:
    def __init__(__self__, *,
                 ...
                 path: pulumi.Input[Optional[_builtins.str]] = None,
                 private_network_service: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] path: Root path to transfer objects. Must be an empty string or full path name that ends with a '/'. This field is treated as an object prefix. As such, it should generally not begin with a '/'.
        :param pulumi.Input[_builtins.str] private_network_service: Service Directory Service to be used as the endpoint for transfers from a customer-managed VPC. Format: `projects/{projectId}/locations/{location}/namespaces/{namespace}/services/{service}`.
        """
    ...
    def private_network_service(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Service Directory Service to be used as the endpoint for transfers from a customer-managed VPC. Format: `projects/{projectId}/locations/{location}/namespaces/{namespace}/services/{service}`.
        """
        return pulumi.get(self, "private_network_service")

    @private_network_service.setter
    def private_network_service(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "private_network_service", value)
