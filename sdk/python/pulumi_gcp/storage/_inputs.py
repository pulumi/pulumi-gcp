...
if not MYPY:
    class BucketAutoclassArgsDict(TypedDict):
        ...
        """
        terminal_storage_class: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketAutoclassArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool],
                 terminal_storage_class: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: While set to `true`, autoclass automatically transitions objects in your bucket to appropriate storage classes based on each object's access pattern.
        :param pulumi.Input[builtins.str] terminal_storage_class: The storage class that objects in the bucket eventually transition to if they are not read for a certain length of time. Supported values include: `NEARLINE`, `ARCHIVE`.
        """
    ...
    def terminal_storage_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The storage class that objects in the bucket eventually transition to if they are not read for a certain length of time. Supported values include: `NEARLINE`, `ARCHIVE`.
        """
    ...
    def terminal_storage_class(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BucketCorArgsDict(TypedDict):
        ...
        """
        response_headers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BucketCorArgs:
    def __init__(__self__, *,
                 ...
                 response_headers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.int] max_age_seconds: The value, in seconds, to return in the [Access-Control-Max-Age header](https://www.w3.org/TR/cors/#access-control-max-age-response-header) used in preflight responses.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] methods: The list of HTTP methods on which to include CORS response headers, (GET, OPTIONS, POST, etc) Note: "*" is permitted in the list of methods, and means "any method".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] origins: The list of [Origins](https://tools.ietf.org/html/rfc6454) eligible to receive CORS response headers. Note: "*" is permitted in the list of origins, and means "any Origin".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] response_headers: The list of HTTP headers other than the [simple response headers](https://www.w3.org/TR/cors/#simple-response-header) to give permission for the user-agent to share across domains.
        """
    ...
    def response_headers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of HTTP headers other than the [simple response headers](https://www.w3.org/TR/cors/#simple-response-header) to give permission for the user-agent to share across domains.
        """
    ...
    def response_headers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "response_headers", value)


if not MYPY:
    class BucketCustomPlacementConfigArgsDict(TypedDict):
        data_locations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class BucketCustomPlacementConfigArgs:
    def __init__(__self__, *,
                 data_locations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_locations: The list of individual regions that comprise a dual-region bucket. See [Cloud Storage bucket locations](https://cloud.google.com/storage/docs/dual-regions#availability) for a list of acceptable regions. **Note**: If any of the data_locations changes, it will [recreate the bucket](https://cloud.google.com/storage/docs/locations#key-concepts).
        """
        pulumi.set(__self__, "data_locations", data_locations)

    @property
    @pulumi.getter(name="dataLocations")
    def data_locations(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The list of individual regions that comprise a dual-region bucket. See [Cloud Storage bucket locations](https://cloud.google.com/storage/docs/dual-regions#availability) for a list of acceptable regions. **Note**: If any of the data_locations changes, it will [recreate the bucket](https://cloud.google.com/storage/docs/locations#key-concepts).
        """
    ...
    def data_locations(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "data_locations", value)


if not MYPY:
    class BucketEncryptionArgsDict(TypedDict):
        default_kms_key_name: pulumi.Input[builtins.str]
        """
...
class BucketEncryptionArgs:
    def __init__(__self__, *,
                 default_kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] default_kms_key_name: The `id` of a Cloud KMS key that will be used to encrypt objects inserted into this bucket, if no encryption method is specified.
               You must pay attention to whether the crypto key is available in the location that this bucket is created in.
               See [the docs](https://cloud.google.com/storage/docs/encryption/using-customer-managed-keys) for more details.
    ...
    def default_kms_key_name(self) -> pulumi.Input[builtins.str]:
        """
        The `id` of a Cloud KMS key that will be used to encrypt objects inserted into this bucket, if no encryption method is specified.
        You must pay attention to whether the crypto key is available in the location that this bucket is created in.
        See [the docs](https://cloud.google.com/storage/docs/encryption/using-customer-managed-keys) for more details.
    ...
    def default_kms_key_name(self, value: pulumi.Input[builtins.str]):
...
class BucketHierarchicalNamespaceArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Enables hierarchical namespace for the bucket.
        """
        pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class BucketIpFilterPublicNetworkSourceArgsDict(TypedDict):
        allowed_ip_cidr_ranges: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class BucketIpFilterPublicNetworkSourceArgs:
    def __init__(__self__, *,
                 allowed_ip_cidr_ranges: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_ip_cidr_ranges: The list of public IPv4 and IPv6 CIDR ranges that can access the bucket and its data.
        """
        pulumi.set(__self__, "allowed_ip_cidr_ranges", allowed_ip_cidr_ranges)

    @property
    @pulumi.getter(name="allowedIpCidrRanges")
    def allowed_ip_cidr_ranges(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The list of public IPv4 and IPv6 CIDR ranges that can access the bucket and its data.
        """
    ...
    def allowed_ip_cidr_ranges(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class BucketIpFilterVpcNetworkSourceArgs:
    def __init__(__self__, *,
                 ...
                 network: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_ip_cidr_ranges: The list of public or private IPv4 and IPv6 CIDR ranges that can access the bucket.
        :param pulumi.Input[builtins.str] network: Name of the network. Format: `projects/PROJECT_ID/global/networks/NETWORK_NAME`
        """
        pulumi.set(__self__, "allowed_ip_cidr_ranges", allowed_ip_cidr_ranges)
...
class BucketLifecycleRuleActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of the action of this Lifecycle Rule. Supported values include: `Delete`, `SetStorageClass` and `AbortIncompleteMultipartUpload`.
        :param pulumi.Input[builtins.str] storage_class: The target [Storage Class](https://cloud.google.com/storage/docs/storage-classes) of objects affected by this Lifecycle Rule. Supported values include: `STANDARD`, `MULTI_REGIONAL`, `REGIONAL`, `NEARLINE`, `COLDLINE`, `ARCHIVE`.
        """
...
if not MYPY:
    class BucketLifecycleRuleConditionArgsDict(TypedDict):
        ...
        """
        created_before: NotRequired[pulumi.Input[builtins.str]]
        """
        A date in the RFC 3339 format YYYY-MM-DD. This condition is satisfied when an object is created before midnight of the specified date in UTC.
        """
        custom_time_before: NotRequired[pulumi.Input[builtins.str]]
        """
        A date in the RFC 3339 format YYYY-MM-DD. This condition is satisfied when the customTime metadata for the object is set to an earlier date than the date used in this lifecycle condition.
        """
        days_since_custom_time: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of days elapsed since the user-specified timestamp set on an object.
        """
        days_since_noncurrent_time: NotRequired[pulumi.Input[builtins.int]]
        """
        Number of days elapsed since the noncurrent timestamp of an object. This
        										condition is relevant only for versioned objects.
        """
        matches_prefixes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        One or more matching name prefixes to satisfy this condition.
        """
        matches_storage_classes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        matches_suffixes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        One or more matching name suffixes to satisfy this condition.
        """
        noncurrent_time_before: NotRequired[pulumi.Input[builtins.str]]
        """
        Creation date of an object in RFC 3339 (e.g. 2017-06-13) to satisfy this condition.
        """
        num_newer_versions: NotRequired[pulumi.Input[builtins.int]]
        """
        Relevant only for versioned objects. The number of newer versions of an object to satisfy this condition.
        """
        send_age_if_zero: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        send_days_since_custom_time_if_zero: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        send_days_since_noncurrent_time_if_zero: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        send_num_newer_versions_if_zero: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        with_state: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketLifecycleRuleConditionArgs:
    def __init__(__self__, *,
                 ...
                 created_before: Optional[pulumi.Input[builtins.str]] = None,
                 custom_time_before: Optional[pulumi.Input[builtins.str]] = None,
                 days_since_custom_time: Optional[pulumi.Input[builtins.int]] = None,
                 days_since_noncurrent_time: Optional[pulumi.Input[builtins.int]] = None,
                 matches_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 matches_storage_classes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 matches_suffixes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 noncurrent_time_before: Optional[pulumi.Input[builtins.str]] = None,
                 num_newer_versions: Optional[pulumi.Input[builtins.int]] = None,
                 send_age_if_zero: Optional[pulumi.Input[builtins.bool]] = None,
                 send_days_since_custom_time_if_zero: Optional[pulumi.Input[builtins.bool]] = None,
                 send_days_since_noncurrent_time_if_zero: Optional[pulumi.Input[builtins.bool]] = None,
                 send_num_newer_versions_if_zero: Optional[pulumi.Input[builtins.bool]] = None,
                 with_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] age: Minimum age of an object in days to satisfy this condition. **Note** To set `0` value of `age`, `send_age_if_zero` should be set `true` otherwise `0` value of `age` field will be ignored.
        :param pulumi.Input[builtins.str] created_before: A date in the RFC 3339 format YYYY-MM-DD. This condition is satisfied when an object is created before midnight of the specified date in UTC.
        :param pulumi.Input[builtins.str] custom_time_before: A date in the RFC 3339 format YYYY-MM-DD. This condition is satisfied when the customTime metadata for the object is set to an earlier date than the date used in this lifecycle condition.
        :param pulumi.Input[builtins.int] days_since_custom_time: Number of days elapsed since the user-specified timestamp set on an object.
        :param pulumi.Input[builtins.int] days_since_noncurrent_time: Number of days elapsed since the noncurrent timestamp of an object. This
               										condition is relevant only for versioned objects.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] matches_prefixes: One or more matching name prefixes to satisfy this condition.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] matches_storage_classes: [Storage Class](https://cloud.google.com/storage/docs/storage-classes) of objects to satisfy this condition. Supported values include: `STANDARD`, `MULTI_REGIONAL`, `REGIONAL`, `NEARLINE`, `COLDLINE`, `ARCHIVE`, `DURABLE_REDUCED_AVAILABILITY`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] matches_suffixes: One or more matching name suffixes to satisfy this condition.
        :param pulumi.Input[builtins.str] noncurrent_time_before: Creation date of an object in RFC 3339 (e.g. 2017-06-13) to satisfy this condition.
        :param pulumi.Input[builtins.int] num_newer_versions: Relevant only for versioned objects. The number of newer versions of an object to satisfy this condition.
        :param pulumi.Input[builtins.bool] send_age_if_zero: While set true, `age` value will be sent in the request even for zero value of the field. This field is only useful and required for setting 0 value to the `age` field. It can be used alone or together with `age` attribute. **NOTE** `age` attibute with `0` value will be ommitted from the API request if `send_age_if_zero` field is having `false` value.
        :param pulumi.Input[builtins.bool] send_days_since_custom_time_if_zero: While set true, `days_since_custom_time` value will be sent in the request even for zero value of the field. This field is only useful for setting 0 value to the `days_since_custom_time` field. It can be used alone or together with `days_since_custom_time`.
        :param pulumi.Input[builtins.bool] send_days_since_noncurrent_time_if_zero: While set true, `days_since_noncurrent_time` value will be sent in the request even for zero value of the field. This field is only useful for setting 0 value to the `days_since_noncurrent_time` field. It can be used alone or together with `days_since_noncurrent_time`.
        :param pulumi.Input[builtins.bool] send_num_newer_versions_if_zero: While set true, `num_newer_versions` value will be sent in the request even for zero value of the field. This field is only useful for setting 0 value to the `num_newer_versions` field. It can be used alone or together with `num_newer_versions`.
        :param pulumi.Input[builtins.str] with_state: Match to live and/or archived objects. Unversioned buckets have only live objects. Supported values include: `"LIVE"`, `"ARCHIVED"`, `"ANY"`.
        """
        if age is not None:
    ...
    def created_before(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A date in the RFC 3339 format YYYY-MM-DD. This condition is satisfied when an object is created before midnight of the specified date in UTC.
        """
    ...
    def created_before(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "created_before", value)

    @property
    @pulumi.getter(name="customTimeBefore")
    def custom_time_before(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A date in the RFC 3339 format YYYY-MM-DD. This condition is satisfied when the customTime metadata for the object is set to an earlier date than the date used in this lifecycle condition.
        """
    ...
    def custom_time_before(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_time_before", value)

    @property
    @pulumi.getter(name="daysSinceCustomTime")
    def days_since_custom_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of days elapsed since the user-specified timestamp set on an object.
        """
    ...
    def days_since_custom_time(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "days_since_custom_time", value)

    @property
    @pulumi.getter(name="daysSinceNoncurrentTime")
    def days_since_noncurrent_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of days elapsed since the noncurrent timestamp of an object. This
        										condition is relevant only for versioned objects.
        """
    ...
    def days_since_noncurrent_time(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "days_since_noncurrent_time", value)

    @property
    @pulumi.getter(name="matchesPrefixes")
    def matches_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more matching name prefixes to satisfy this condition.
        """
    ...
    def matches_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "matches_prefixes", value)

    @property
    @pulumi.getter(name="matchesStorageClasses")
    def matches_storage_classes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        [Storage Class](https://cloud.google.com/storage/docs/storage-classes) of objects to satisfy this condition. Supported values include: `STANDARD`, `MULTI_REGIONAL`, `REGIONAL`, `NEARLINE`, `COLDLINE`, `ARCHIVE`, `DURABLE_REDUCED_AVAILABILITY`.
        """
    ...
    def matches_storage_classes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "matches_storage_classes", value)

    @property
    @pulumi.getter(name="matchesSuffixes")
    def matches_suffixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more matching name suffixes to satisfy this condition.
        """
    ...
    def matches_suffixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "matches_suffixes", value)

    @property
    @pulumi.getter(name="noncurrentTimeBefore")
    def noncurrent_time_before(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Creation date of an object in RFC 3339 (e.g. 2017-06-13) to satisfy this condition.
        """
    ...
    def noncurrent_time_before(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "noncurrent_time_before", value)

    @property
    @pulumi.getter(name="numNewerVersions")
    def num_newer_versions(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Relevant only for versioned objects. The number of newer versions of an object to satisfy this condition.
        """
    ...
    def num_newer_versions(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_newer_versions", value)

    @property
    @pulumi.getter(name="sendAgeIfZero")
    def send_age_if_zero(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        While set true, `age` value will be sent in the request even for zero value of the field. This field is only useful and required for setting 0 value to the `age` field. It can be used alone or together with `age` attribute. **NOTE** `age` attibute with `0` value will be ommitted from the API request if `send_age_if_zero` field is having `false` value.
        """
    ...
    def send_age_if_zero(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_age_if_zero", value)

    @property
    @pulumi.getter(name="sendDaysSinceCustomTimeIfZero")
    def send_days_since_custom_time_if_zero(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        While set true, `days_since_custom_time` value will be sent in the request even for zero value of the field. This field is only useful for setting 0 value to the `days_since_custom_time` field. It can be used alone or together with `days_since_custom_time`.
        """
    ...
    def send_days_since_custom_time_if_zero(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_days_since_custom_time_if_zero", value)

    @property
    @pulumi.getter(name="sendDaysSinceNoncurrentTimeIfZero")
    def send_days_since_noncurrent_time_if_zero(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        While set true, `days_since_noncurrent_time` value will be sent in the request even for zero value of the field. This field is only useful for setting 0 value to the `days_since_noncurrent_time` field. It can be used alone or together with `days_since_noncurrent_time`.
        """
    ...
    def send_days_since_noncurrent_time_if_zero(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_days_since_noncurrent_time_if_zero", value)

    @property
    @pulumi.getter(name="sendNumNewerVersionsIfZero")
    def send_num_newer_versions_if_zero(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        While set true, `num_newer_versions` value will be sent in the request even for zero value of the field. This field is only useful for setting 0 value to the `num_newer_versions` field. It can be used alone or together with `num_newer_versions`.
        """
    ...
    def send_num_newer_versions_if_zero(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_num_newer_versions_if_zero", value)

    @property
    @pulumi.getter(name="withState")
    def with_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Match to live and/or archived objects. Unversioned buckets have only live objects. Supported values include: `"LIVE"`, `"ARCHIVED"`, `"ANY"`.
        """
    ...
    @with_state.setter
    def with_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "with_state", value)


if not MYPY:
    class BucketLoggingArgsDict(TypedDict):
        log_bucket: pulumi.Input[builtins.str]
        """
        The bucket that will receive log objects.
        """
        log_object_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketLoggingArgs:
    def __init__(__self__, *,
                 log_bucket: pulumi.Input[builtins.str],
                 log_object_prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] log_bucket: The bucket that will receive log objects.
        :param pulumi.Input[builtins.str] log_object_prefix: The object prefix for log objects. If it's not provided,
               by default GCS sets this to this bucket's name.
        """
    ...
    def log_bucket(self) -> pulumi.Input[builtins.str]:
        """
        The bucket that will receive log objects.
        """
    ...
    @log_bucket.setter
    def log_bucket(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "log_bucket", value)

    @property
    @pulumi.getter(name="logObjectPrefix")
    def log_object_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The object prefix for log objects. If it's not provided,
        by default GCS sets this to this bucket's name.
        """
    ...
    def log_object_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketObjectCustomerEncryptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] encryption_key: Base64 encoded Customer-Supplied Encryption Key.
        :param pulumi.Input[builtins.str] encryption_algorithm: Encryption algorithm. Default: AES256
        """
...
if not MYPY:
    class BucketObjectRetentionArgsDict(TypedDict):
        ...
        """
        retain_until_time: pulumi.Input[builtins.str]
        """
...
class BucketObjectRetentionArgs:
    def __init__(__self__, *,
                 ...
                 retain_until_time: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] mode: The retention policy mode. Either `Locked` or `Unlocked`.
        :param pulumi.Input[builtins.str] retain_until_time: The time to retain the object until in RFC 3339 format, for example 2012-11-15T16:19:00.094Z.
    ...
    def retain_until_time(self) -> pulumi.Input[builtins.str]:
        """
        The time to retain the object until in RFC 3339 format, for example 2012-11-15T16:19:00.094Z.
    ...
    def retain_until_time(self, value: pulumi.Input[builtins.str]):
...
class BucketRetentionPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] retention_period: The period of time, in seconds, that objects in the bucket must be retained and cannot be deleted, overwritten, or archived. The value must be less than 2,147,483,647 seconds.
        :param pulumi.Input[builtins.bool] is_locked: If set to `true`, the bucket will be [locked](https://cloud.google.com/storage/docs/using-bucket-lock#lock-bucket) and permanently restrict edits to the bucket's retention policy.  Caution: Locking a bucket is an irreversible action.
        """
...
if not MYPY:
    class BucketSoftDeletePolicyArgsDict(TypedDict):
        effective_time: NotRequired[pulumi.Input[builtins.str]]
        """
        Server-determined value that indicates the time from which the policy, or one with a greater retention, was effective. This value is in RFC 3339 format.
        """
        retention_duration_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class BucketSoftDeletePolicyArgs:
    def __init__(__self__, *,
                 ...
                 retention_duration_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] effective_time: Server-determined value that indicates the time from which the policy, or one with a greater retention, was effective. This value is in RFC 3339 format.
        :param pulumi.Input[builtins.int] retention_duration_seconds: The duration in seconds that soft-deleted objects in the bucket will be retained and cannot be permanently deleted. Default value is 604800. The value must be in between 604800(7 days) and 7776000(90 days). **Note**: To disable the soft delete policy on a bucket, This field must be set to 0.
        """
    ...
    def retention_duration_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The duration in seconds that soft-deleted objects in the bucket will be retained and cannot be permanently deleted. Default value is 604800. The value must be in between 604800(7 days) and 7776000(90 days). **Note**: To disable the soft delete policy on a bucket, This field must be set to 0.
        """
    ...
    def retention_duration_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class BucketVersioningArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: While set to `true`, versioning is fully enabled for this bucket.
        """
        pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class BucketWebsiteArgsDict(TypedDict):
        main_page_suffix: NotRequired[pulumi.Input[builtins.str]]
        """
        Behaves as the bucket's directory index where
        missing objects are treated as potential directories.
        """
        not_found_page: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketWebsiteArgs:
    def __init__(__self__, *,
                 main_page_suffix: Optional[pulumi.Input[builtins.str]] = None,
                 not_found_page: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] main_page_suffix: Behaves as the bucket's directory index where
               missing objects are treated as potential directories.
        :param pulumi.Input[builtins.str] not_found_page: The custom object to return when a requested
               resource is not found.
        """
    ...
    def main_page_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Behaves as the bucket's directory index where
        missing objects are treated as potential directories.
        """
    ...
    def main_page_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "main_page_suffix", value)

    @property
    @pulumi.getter(name="notFoundPage")
    def not_found_page(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The custom object to return when a requested
        resource is not found.
        """
    ...
    def not_found_page(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ControlFolderIntelligenceConfigEffectiveIntelligenceConfigArgsDict(TypedDict):
        ...
        """
        intelligence_config: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class ControlFolderIntelligenceConfigEffectiveIntelligenceConfigArgs:
    def __init__(__self__, *,
                 effective_edition: Optional[pulumi.Input[builtins.str]] = None,
                 intelligence_config: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] effective_edition: (Output)
               The `StorageIntelligence` edition that is applicable for the resource.
        :param pulumi.Input[builtins.str] intelligence_config: (Output)
               The Intelligence config resource that is applied for the target resource.
        """
    ...
    def effective_edition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The `StorageIntelligence` edition that is applicable for the resource.
        """
    ...
    def effective_edition(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "effective_edition", value)

    @property
    @pulumi.getter(name="intelligenceConfig")
    def intelligence_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The Intelligence config resource that is applied for the target resource.
        """
    ...
    def intelligence_config(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ControlFolderIntelligenceConfigFilterExcludedCloudStorageBucketsArgsDict(TypedDict):
        bucket_id_regexes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ControlFolderIntelligenceConfigFilterExcludedCloudStorageBucketsArgs:
    def __init__(__self__, *,
                 bucket_id_regexes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] bucket_id_regexes: List of bucket id regexes to exclude in the storage intelligence plan.
        """
        pulumi.set(__self__, "bucket_id_regexes", bucket_id_regexes)

    @property
    @pulumi.getter(name="bucketIdRegexes")
    def bucket_id_regexes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        List of bucket id regexes to exclude in the storage intelligence plan.
        """
    ...
    def bucket_id_regexes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ControlFolderIntelligenceConfigFilterExcludedCloudStorageLocationsArgs:
    def __init__(__self__, *,
                 locations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: List of locations.
        """
...
class DefaultObjectAccessControlProjectTeamArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] project_number: The project team associated with the entity
        :param pulumi.Input[builtins.str] team: The team.
               Possible values are: `editors`, `owners`, `viewers`.
        """
...
if not MYPY:
    class InsightsReportConfigCsvOptionsArgsDict(TypedDict):
        ...
        """
        header_required: NotRequired[pulumi.Input[builtins.bool]]
        """
        The boolean that indicates whether or not headers are included in the inventory report CSV file.
        """
        record_separator: NotRequired[pulumi.Input[builtins.str]]
        """
...
class InsightsReportConfigCsvOptionsArgs:
    def __init__(__self__, *,
                 ...
                 header_required: Optional[pulumi.Input[builtins.bool]] = None,
                 record_separator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] delimiter: The delimiter used to separate the fields in the inventory report CSV file.
        :param pulumi.Input[builtins.bool] header_required: The boolean that indicates whether or not headers are included in the inventory report CSV file.
        :param pulumi.Input[builtins.str] record_separator: The character used to separate the records in the inventory report CSV file.
        """
    ...
    def header_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The boolean that indicates whether or not headers are included in the inventory report CSV file.
        """
    ...
    def header_required(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "header_required", value)

    @property
    @pulumi.getter(name="recordSeparator")
    def record_separator(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The character used to separate the records in the inventory report CSV file.
        """
    ...
    def record_separator(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InsightsReportConfigFrequencyOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InsightsReportConfigFrequencyOptionsEndDateArgs'] end_date: The date to stop generating inventory reports. For example, {"day": 15, "month": 9, "year": 2022}.
               Structure is documented below.
        :param pulumi.Input[builtins.str] frequency: The frequency in which inventory reports are generated. Values are DAILY or WEEKLY.
               Possible values are: `DAILY`, `WEEKLY`.
...
class InsightsReportConfigFrequencyOptionsEndDateArgs:
    def __init__(__self__, *,
                 ...
                 year: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] day: The day of the month to stop generating inventory reports.
        :param pulumi.Input[builtins.int] month: The month to stop generating inventory reports.
        :param pulumi.Input[builtins.int] year: The year to stop generating inventory reports
        """
...
class InsightsReportConfigFrequencyOptionsStartDateArgs:
    def __init__(__self__, *,
                 ...
                 year: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] day: The day of the month to start generating inventory reports.
        :param pulumi.Input[builtins.int] month: The month to start generating inventory reports.
        :param pulumi.Input[builtins.int] year: The year to start generating inventory reports
        """
        pulumi.set(__self__, "day", day)
        pulumi.set(__self__, "month", month)
        pulumi.set(__self__, "year", year)
...
if not MYPY:
    class InsightsReportConfigObjectMetadataReportOptionsArgsDict(TypedDict):
        metadata_fields: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class InsightsReportConfigObjectMetadataReportOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] metadata_fields: The metadata fields included in an inventory report.
    ...
    def metadata_fields(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The metadata fields included in an inventory report.
        """
    ...
    def metadata_fields(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class InsightsReportConfigObjectMetadataReportOptionsStorageDestinationOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: The destination bucket that stores the generated inventory reports.
        :param pulumi.Input[builtins.str] destination_path: The path within the destination bucket to store generated inventory reports.
        """
        pulumi.set(__self__, "bucket", bucket)
...
class InsightsReportConfigObjectMetadataReportOptionsStorageFiltersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: The filter to use when specifying which bucket to generate inventory reports for.
        """
...
if not MYPY:
    class TransferAgentPoolBandwidthLimitArgsDict(TypedDict):
        limit_mbps: pulumi.Input[builtins.str]
        """
...
class TransferAgentPoolBandwidthLimitArgs:
    def __init__(__self__, *,
                 limit_mbps: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] limit_mbps: Bandwidth rate in megabytes per second, distributed across all the agents in the pool.
        """
        pulumi.set(__self__, "limit_mbps", limit_mbps)

    @property
    @pulumi.getter(name="limitMbps")
    def limit_mbps(self) -> pulumi.Input[builtins.str]:
        """
        Bandwidth rate in megabytes per second, distributed across all the agents in the pool.
        """
    ...
    @limit_mbps.setter
    def limit_mbps(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class TransferJobEventStreamArgsDict(TypedDict):
        ...
        """
        event_stream_expiration_time: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        event_stream_start_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TransferJobEventStreamArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 event_stream_expiration_time: Optional[pulumi.Input[builtins.str]] = None,
                 event_stream_start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies a unique name of the resource such as AWS SQS ARN in the form 'arn:aws:sqs:region:account_id:queue_name', or Pub/Sub subscription resource name in the form 'projects/{project}/subscriptions/{sub}'.
        :param pulumi.Input[builtins.str] event_stream_expiration_time: Specifies the data and time at which Storage Transfer Service stops listening for events from this stream. After this time, any transfers in progress will complete, but no new transfers are initiated.A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] event_stream_start_time: Specifies the date and time that Storage Transfer Service starts listening for events from this stream. If no start time is specified or start time is in the past, Storage Transfer Service starts listening immediately. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
    ...
    def event_stream_expiration_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the data and time at which Storage Transfer Service stops listening for events from this stream. After this time, any transfers in progress will complete, but no new transfers are initiated.A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
    ...
    def event_stream_expiration_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_stream_expiration_time", value)

    @property
    @pulumi.getter(name="eventStreamStartTime")
    def event_stream_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the date and time that Storage Transfer Service starts listening for events from this stream. If no start time is specified or start time is in the past, Storage Transfer Service starts listening immediately. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
    ...
    def event_stream_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_stream_start_time", value)


if not MYPY:
    class TransferJobLoggingConfigArgsDict(TypedDict):
        enable_on_prem_gcs_transfer_logs: NotRequired[pulumi.Input[builtins.bool]]
        """
        For transfers with a PosixFilesystem source, this option enables the Cloud Storage transfer logs for this transfer.
        """
        log_action_states: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        log_actions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class TransferJobLoggingConfigArgs:
    def __init__(__self__, *,
                 enable_on_prem_gcs_transfer_logs: Optional[pulumi.Input[builtins.bool]] = None,
                 log_action_states: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 log_actions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_on_prem_gcs_transfer_logs: For transfers with a PosixFilesystem source, this option enables the Cloud Storage transfer logs for this transfer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_action_states: States in which logActions are logged. Not supported for transfers with PosifxFilesystem data sources; use enable_on_prem_gcs_transfer_logs instead.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_actions: Specifies the actions to be logged. Not supported for transfers with PosifxFilesystem data sources; use enable_on_prem_gcs_transfer_logs instead.
        """
    ...
    def enable_on_prem_gcs_transfer_logs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        For transfers with a PosixFilesystem source, this option enables the Cloud Storage transfer logs for this transfer.
        """
    ...
    def enable_on_prem_gcs_transfer_logs(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_on_prem_gcs_transfer_logs", value)

    @property
    @pulumi.getter(name="logActionStates")
    def log_action_states(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        States in which logActions are logged. Not supported for transfers with PosifxFilesystem data sources; use enable_on_prem_gcs_transfer_logs instead.
        """
    ...
    def log_action_states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "log_action_states", value)

    @property
    @pulumi.getter(name="logActions")
    def log_actions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies the actions to be logged. Not supported for transfers with PosifxFilesystem data sources; use enable_on_prem_gcs_transfer_logs instead.
        """
    ...
    @log_actions.setter
    def log_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "log_actions", value)


if not MYPY:
    class TransferJobNotificationConfigArgsDict(TypedDict):
        payload_format: pulumi.Input[builtins.str]
        """
...
class TransferJobNotificationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] payload_format: The desired format of the notification message payloads. One of "NONE" or "JSON".
        :param pulumi.Input[builtins.str] pubsub_topic: The Topic.name of the Pub/Sub topic to which to publish notifications. Must be of the format: projects/{project}/topics/{topic}. Not matching this format results in an INVALID_ARGUMENT error.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_types: Event types for which a notification is desired. If empty, send notifications for all event types. The valid types are "TRANSFER_OPERATION_SUCCESS", "TRANSFER_OPERATION_FAILED", "TRANSFER_OPERATION_ABORTED".
        """
    ...
    def payload_format(self) -> pulumi.Input[builtins.str]:
        """
        The desired format of the notification message payloads. One of "NONE" or "JSON".
        """
    ...
    def payload_format(self, value: pulumi.Input[builtins.str]):
...
class TransferJobReplicationSpecGcsDataSinkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: Google Cloud Storage bucket name.
        :param pulumi.Input[builtins.str] path: Root path to transfer objects. Must be an empty string or full path name that ends with a '/'. This field is treated as an object prefix. As such, it should generally not begin with a '/'.
        """
...
if not MYPY:
    class TransferJobReplicationSpecObjectConditionsArgsDict(TypedDict):
        exclude_prefixes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        include_prefixes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        If `include_prefixes` is specified, objects that satisfy the object conditions must have names that start with one of the `include_prefixes` and that do not start with any of the `exclude_prefixes`. If `include_prefixes` is not specified, all objects except those that have names starting with one of the `exclude_prefixes` must satisfy the object conditions. See [Requirements](https://cloud.google.com/storage-transfer/docs/reference/rest/v1/TransferSpec#ObjectConditions).
        """
        last_modified_before: NotRequired[pulumi.Input[builtins.str]]
        """
        If specified, only objects with a "last modification time" before this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
        last_modified_since: NotRequired[pulumi.Input[builtins.str]]
        """
        If specified, only objects with a "last modification time" on or after this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
        max_time_elapsed_since_last_modification: NotRequired[pulumi.Input[builtins.str]]
        """
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
        min_time_elapsed_since_last_modification: NotRequired[pulumi.Input[builtins.str]]
        """
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
elif False:
...
class TransferJobReplicationSpecObjectConditionsArgs:
    def __init__(__self__, *,
                 exclude_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 last_modified_before: Optional[pulumi.Input[builtins.str]] = None,
                 last_modified_since: Optional[pulumi.Input[builtins.str]] = None,
                 max_time_elapsed_since_last_modification: Optional[pulumi.Input[builtins.str]] = None,
                 min_time_elapsed_since_last_modification: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_prefixes: `exclude_prefixes` must follow the requirements described for `include_prefixes`. See [Requirements](https://cloud.google.com/storage-transfer/docs/reference/rest/v1/TransferSpec#ObjectConditions).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_prefixes: If `include_prefixes` is specified, objects that satisfy the object conditions must have names that start with one of the `include_prefixes` and that do not start with any of the `exclude_prefixes`. If `include_prefixes` is not specified, all objects except those that have names starting with one of the `exclude_prefixes` must satisfy the object conditions. See [Requirements](https://cloud.google.com/storage-transfer/docs/reference/rest/v1/TransferSpec#ObjectConditions).
        :param pulumi.Input[builtins.str] last_modified_before: If specified, only objects with a "last modification time" before this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] last_modified_since: If specified, only objects with a "last modification time" on or after this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] max_time_elapsed_since_last_modification: A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        :param pulumi.Input[builtins.str] min_time_elapsed_since_last_modification: A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
    ...
    def exclude_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        `exclude_prefixes` must follow the requirements described for `include_prefixes`. See [Requirements](https://cloud.google.com/storage-transfer/docs/reference/rest/v1/TransferSpec#ObjectConditions).
        """
    ...
    def exclude_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclude_prefixes", value)

    @property
    @pulumi.getter(name="includePrefixes")
    def include_prefixes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        If `include_prefixes` is specified, objects that satisfy the object conditions must have names that start with one of the `include_prefixes` and that do not start with any of the `exclude_prefixes`. If `include_prefixes` is not specified, all objects except those that have names starting with one of the `exclude_prefixes` must satisfy the object conditions. See [Requirements](https://cloud.google.com/storage-transfer/docs/reference/rest/v1/TransferSpec#ObjectConditions).
        """
    ...
    def include_prefixes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "include_prefixes", value)

    @property
    @pulumi.getter(name="lastModifiedBefore")
    def last_modified_before(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If specified, only objects with a "last modification time" before this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
    ...
    def last_modified_before(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_modified_before", value)

    @property
    @pulumi.getter(name="lastModifiedSince")
    def last_modified_since(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If specified, only objects with a "last modification time" on or after this timestamp and objects that don't have a "last modification time" are transferred. A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
    ...
    def last_modified_since(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_modified_since", value)

    @property
    @pulumi.getter(name="maxTimeElapsedSinceLastModification")
    def max_time_elapsed_since_last_modification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
    ...
    def max_time_elapsed_since_last_modification(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_time_elapsed_since_last_modification", value)

    @property
    @pulumi.getter(name="minTimeElapsedSinceLastModification")
    def min_time_elapsed_since_last_modification(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
    ...
    def min_time_elapsed_since_last_modification(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TransferJobReplicationSpecTransferOptionsArgsDict(TypedDict):
        delete_objects_from_source_after_transfer: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether objects should be deleted from the source after they are transferred to the sink. Note that this option and `delete_objects_unique_in_sink` are mutually exclusive.
        """
        delete_objects_unique_in_sink: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        overwrite_objects_already_existing_in_sink: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether overwriting objects that already exist in the sink is allowed.
        """
        overwrite_when: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TransferJobReplicationSpecTransferOptionsArgs:
    def __init__(__self__, *,
                 delete_objects_from_source_after_transfer: Optional[pulumi.Input[builtins.bool]] = None,
                 delete_objects_unique_in_sink: Optional[pulumi.Input[builtins.bool]] = None,
                 metadata_options: Optional[pulumi.Input['TransferJobReplicationSpecTransferOptionsMetadataOptionsArgs']] = None,
                 overwrite_objects_already_existing_in_sink: Optional[pulumi.Input[builtins.bool]] = None,
                 overwrite_when: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] delete_objects_from_source_after_transfer: Whether objects should be deleted from the source after they are transferred to the sink. Note that this option and `delete_objects_unique_in_sink` are mutually exclusive.
        :param pulumi.Input[builtins.bool] delete_objects_unique_in_sink: Whether objects that exist only in the sink should be deleted. Note that this option and
               `delete_objects_from_source_after_transfer` are mutually exclusive.
        ...
        :param pulumi.Input[builtins.bool] overwrite_objects_already_existing_in_sink: Whether overwriting objects that already exist in the sink is allowed.
        :param pulumi.Input[builtins.str] overwrite_when: When to overwrite objects that already exist in the sink. If not set, overwrite behavior is determined by `overwrite_objects_already_existing_in_sink`. Possible values: ALWAYS, DIFFERENT, NEVER.
        """
    ...
    def delete_objects_from_source_after_transfer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether objects should be deleted from the source after they are transferred to the sink. Note that this option and `delete_objects_unique_in_sink` are mutually exclusive.
        """
    ...
    def delete_objects_from_source_after_transfer(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "delete_objects_from_source_after_transfer", value)

    @property
    @pulumi.getter(name="deleteObjectsUniqueInSink")
    def delete_objects_unique_in_sink(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether objects that exist only in the sink should be deleted. Note that this option and
        `delete_objects_from_source_after_transfer` are mutually exclusive.
        """
    ...
    def delete_objects_unique_in_sink(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def overwrite_objects_already_existing_in_sink(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether overwriting objects that already exist in the sink is allowed.
        """
    ...
    def overwrite_objects_already_existing_in_sink(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "overwrite_objects_already_existing_in_sink", value)

    @property
    @pulumi.getter(name="overwriteWhen")
    def overwrite_when(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When to overwrite objects that already exist in the sink. If not set, overwrite behavior is determined by `overwrite_objects_already_existing_in_sink`. Possible values: ALWAYS, DIFFERENT, NEVER.
        """
    ...
    def overwrite_when(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TransferJobReplicationSpecTransferOptionsMetadataOptionsArgsDict(TypedDict):
        ...
        """
        symlink: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TransferJobReplicationSpecTransferOptionsMetadataOptionsArgs:
    def __init__(__self__, *,
                 ...
                 storage_class: Optional[pulumi.Input[builtins.str]] = None,
                 symlink: Optional[pulumi.Input[builtins.str]] = None,
                 temporary_hold: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 uid: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] acl: Specifies how each object's ACLs should be preserved for transfers between Google Cloud Storage buckets
        :param pulumi.Input[builtins.str] gid: Specifies how each file's POSIX group ID (GID) attribute should be handled by the transfer.
        :param pulumi.Input[builtins.str] kms_key: Specifies how each object's Cloud KMS customer-managed encryption key (CMEK) is preserved for transfers between Google Cloud Storage buckets
        :param pulumi.Input[builtins.str] mode: Specifies how each file's mode attribute should be handled by the transfer.
        :param pulumi.Input[builtins.str] storage_class: Specifies the storage class to set on objects being transferred to Google Cloud Storage buckets
        :param pulumi.Input[builtins.str] symlink: Specifies how symlinks should be handled by the transfer.
        :param pulumi.Input[builtins.str] temporary_hold: SSpecifies how each object's temporary hold status should be preserved for transfers between Google Cloud Storage buckets
        :param pulumi.Input[builtins.str] time_created: Specifies how each object's timeCreated metadata is preserved for transfers.
        :param pulumi.Input[builtins.str] uid: Specifies how each file's POSIX user ID (UID) attribute should be handled by the transfer.
        """
        if acl is not None:
    ...
    @property
    @pulumi.getter
    def symlink(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies how symlinks should be handled by the transfer.
        """
    ...
    @symlink.setter
    def symlink(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TransferJobScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] repeat_interval: Interval between the start of each scheduled transfer. If unspecified, the default value is 24 hours. This value may not be less than 1 hour. A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
...
class TransferJobScheduleScheduleEndDateArgs:
    def __init__(__self__, *,
                 ...
                 year: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] day: Day of month. Must be from 1 to 31 and valid for the year and month.
        :param pulumi.Input[builtins.int] month: Month of year. Must be from 1 to 12.
        :param pulumi.Input[builtins.int] year: Year of date. Must be from 1 to 9999.
        """
        pulumi.set(__self__, "day", day)
        pulumi.set(__self__, "month", month)
        pulumi.set(__self__, "year", year)
...
if not MYPY:
    class TransferJobScheduleStartTimeOfDayArgsDict(TypedDict):
        ...
        """
        nanos: pulumi.Input[builtins.int]
        """
        Fractions of seconds in nanoseconds. Must be from 0 to 999,999,999.
        """
        seconds: pulumi.Input[builtins.int]
        """
...
class TransferJobScheduleStartTimeOfDayArgs:
    ...
    @property
    @pulumi.getter
    def nanos(self) -> pulumi.Input[builtins.int]:
        """
        Fractions of seconds in nanoseconds. Must be from 0 to 999,999,999.
        """
    ...
    @nanos.setter
    def nanos(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "nanos", value)

    @property
    @pulumi.getter
    def seconds(self) -> pulumi.Input[builtins.int]:
        """
        Seconds of minutes of the time. Must normally be from 0 to 59.
        """
    ...
    @seconds.setter
    def seconds(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class TransferJobTransferSpecArgsDict(TypedDict):
        ...
        """
        sink_agent_pool_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Specifies the agent pool name associated with the posix data sink. When unspecified, the default name is used.
        """
        source_agent_pool_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TransferJobTransferSpecArgs:
    def __init__(__self__, *,
                 ...
                 sink_agent_pool_name: Optional[pulumi.Input[builtins.str]] = None,
                 source_agent_pool_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] sink_agent_pool_name: Specifies the agent pool name associated with the posix data sink. When unspecified, the default name is used.
        :param pulumi.Input[builtins.str] source_agent_pool_name: Specifies the agent pool name associated with the posix data source. When unspecified, the default name is used.
    ...
    def sink_agent_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the agent pool name associated with the posix data sink. When unspecified, the default name is used.
        """
    ...
    def sink_agent_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sink_agent_pool_name", value)

    @property
    @pulumi.getter(name="sourceAgentPoolName")
    def source_agent_pool_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the agent pool name associated with the posix data source. When unspecified, the default name is used.
        """
    ...
    def source_agent_pool_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TransferJobTransferSpecAwsS3DataSourceAwsAccessKeyArgs:
    def __init__(__self__, *,
                 ...
                 secret_access_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] access_key_id: AWS Key ID.
...
if not MYPY:
    class TransferJobTransferSpecAzureBlobStorageDataSourceArgsDict(TypedDict):
        ...
        """
        credentials_secret: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TransferJobTransferSpecAzureBlobStorageDataSourceArgs:
    def __init__(__self__, *,
                 ...
                 path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] container: The container to transfer from the Azure Storage account.`
        :param pulumi.Input[builtins.str] storage_account: The name of the Azure Storage account.
        ...
        :param pulumi.Input[builtins.str] credentials_secret: Full Resource name of a secret in Secret Manager containing [SAS Credentials in JSON form](https://cloud.google.com/storage-transfer/docs/reference/rest/v1/TransferSpec#azureblobstoragedata:~:text=begin%20with%20a%20%27/%27.-,credentialsSecret,-string). Service Agent for Storage Transfer must have permissions to access secret. If credentials_secret is specified, do not specify azure_credentials.`,
        :param pulumi.Input[builtins.str] path: Root path to transfer objects. Must be an empty string or full path name that ends with a '/'. This field is treated as an object prefix. As such, it should generally not begin with a '/'.
        """
...
class TransferJobTransferSpecAzureBlobStorageDataSourceAzureCredentialsArgs:
    def __init__(__self__, *,
                 sas_token: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] sas_token: Azure shared access signature. See [Grant limited access to Azure Storage resources using shared access signatures (SAS)](https://docs.microsoft.com/en-us/azure/storage/common/storage-sas-overview).
...
if not MYPY:
    class TransferJobTransferSpecHttpDataSourceArgsDict(TypedDict):
        list_url: pulumi.Input[builtins.str]
        """
...
class TransferJobTransferSpecHttpDataSourceArgs:
    def __init__(__self__, *,
                 list_url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] list_url: The URL that points to the file that stores the object list entries. This file must allow public access. Currently, only URLs with HTTP and HTTPS schemes are supported.
        """
        pulumi.set(__self__, "list_url", list_url)

    @property
    @pulumi.getter(name="listUrl")
    def list_url(self) -> pulumi.Input[builtins.str]:
        """
        The URL that points to the file that stores the object list entries. This file must allow public access. Currently, only URLs with HTTP and HTTPS schemes are supported.
        """
    ...
    @list_url.setter
    def list_url(self, value: pulumi.Input[builtins.str]):
...
class TransferJobTransferSpecPosixDataSinkArgs:
    def __init__(__self__, *,
                 root_directory: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] root_directory: Root directory path to the filesystem.
        """
