...
def get_project_service_account(project: Optional[_builtins.str] = None,
                                user_project: Optional[_builtins.str] = None,
    ...
    >  When you write Terraform code which uses features depending on this service account *and* your Terraform code adds the service account in IAM policy on other resources,
       ...
       See the examples here and in the [`storage.Notification`](https://www.terraform.io/docs/providers/google/r/storage_notification.html) resource.
    ...
    :param _builtins.str user_project: The project the lookup originates from. This field is used if you are making the request
