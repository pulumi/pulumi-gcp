...
class GetProjectServiceAccountResult:
    ...
    def user_project(self) -> Optional[builtins.str]:
...
def get_project_service_account(project: Optional[builtins.str] = None,
                                user_project: Optional[builtins.str] = None,
    ...
    :param builtins.str project: The project the unique service account was created for. If it is not provided, the provider project is used.
    :param builtins.str user_project: The project the lookup originates from. This field is used if you are making the request
...
def get_project_service_account_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       user_project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
