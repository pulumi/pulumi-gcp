...
class DefaultObjectAccessControlArgs:
    def __init__(__self__, *,
                 ...
                 entity: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bucket: The name of the bucket.
        :param pulumi.Input[builtins.str] entity: The entity holding the permission, in one of the following forms:
               * user-{{userId}}
        ...
        :param pulumi.Input[builtins.str] role: The access permission for the entity.
               Possible values are: `OWNER`, `READER`.
               
               
               - - -
        :param pulumi.Input[builtins.str] object: The name of the object, if applied to an object.
        """
    ...
    @property
    @pulumi.getter
    def entity(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @entity.setter
    def entity(self, value: pulumi.Input[builtins.str]):
...
class _DefaultObjectAccessControlState:
    def __init__(__self__, *,
                 ...
                 entity: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bucket: The name of the bucket.
        :param pulumi.Input[builtins.str] domain: The domain associated with the entity.
        :param pulumi.Input[builtins.str] email: The email address associated with the entity.
        :param pulumi.Input[builtins.str] entity: The entity holding the permission, in one of the following forms:
               * user-{{userId}}
               * user-{{email}} (such as "user-liz@example.com")
               * group-{{groupId}}
               ...
               * allUsers
               * allAuthenticatedUsers
        :param pulumi.Input[builtins.str] entity_id: The ID for the entity
        :param pulumi.Input[builtins.int] generation: The content generation of the object, if applied to an object.
        :param pulumi.Input[builtins.str] object: The name of the object, if applied to an object.
    ...
    @property
    @pulumi.getter
    def entity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The entity holding the permission, in one of the following forms:
        * user-{{userId}}
        * user-{{email}} (such as "user-liz@example.com")
    ...
    @entity.setter
    def entity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "entity", value)
...
class DefaultObjectAccessControl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'DefaultObjectAccessControl':
        """
    ...
    @property
    @pulumi.getter
    def entity(self) -> pulumi.Output[builtins.str]:
        """
        The entity holding the permission, in one of the following forms:
        * user-{{userId}}
        * user-{{email}} (such as "user-liz@example.com")
    ...
    @property
    @pulumi.getter
    def object(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the object, if applied to an object.
        """
        return pulumi.get(self, "object")
