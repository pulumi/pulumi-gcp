...
class BucketObjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cache_control: [Cache-Control](https://tools.ietf.org/html/rfc7234#section-5.2)
               directive to specify caching behavior of object data. If omitted and object is accessible to all anonymous users, the default will be public, max-age=3600
        :param pulumi.Input[builtins.str] content: Data as `string` to be uploaded. Must be defined if `source` is not. **Note**: The `content` field is marked as sensitive.
        :param pulumi.Input[builtins.str] content_disposition: [Content-Disposition](https://tools.ietf.org/html/rfc6266) of the object data.
        :param pulumi.Input[builtins.str] content_encoding: [Content-Encoding](https://tools.ietf.org/html/rfc7231#section-3.1.2.2) of the object data.
        :param pulumi.Input[builtins.str] content_language: [Content-Language](https://tools.ietf.org/html/rfc7231#section-3.1.3.2) of the object data.
        :param pulumi.Input[builtins.str] content_type: [Content-Type](https://tools.ietf.org/html/rfc7231#section-3.1.1.5) of the object data. Defaults to "application/octet-stream" or "text/plain; charset=utf-8".
        ...
        :param pulumi.Input[builtins.str] name: The name of the object. If you're interpolating the name of this object, see `output_name` instead.
        ...
        :param pulumi.Input[builtins.bool] temporary_hold: Whether an object is under [temporary hold](https://cloud.google.com/storage/docs/object-holds#hold-types). While this flag is set to true, the object is protected against deletion and overwrites.
        """
    ...
    def detect_md5hash(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "detect_md5hash", value)

    @property
    @pulumi.getter(name="eventBasedHold")
    def event_based_hold(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def temporary_hold(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def temporary_hold(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BucketObjectState:
    def __init__(__self__, *,
                 ...
                 content_language: Optional[pulumi.Input[builtins.str]] = None,
                 content_type: Optional[pulumi.Input[builtins.str]] = None,
                 crc32c: Optional[pulumi.Input[builtins.str]] = None,
                 customer_encryption: Optional[pulumi.Input['BucketObjectCustomerEncryptionArgs']] = None,
                 detect_md5hash: Optional[pulumi.Input[builtins.str]] = None,
                 event_based_hold: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] content_language: [Content-Language](https://tools.ietf.org/html/rfc7231#section-3.1.3.2) of the object data.
        :param pulumi.Input[builtins.str] content_type: [Content-Type](https://tools.ietf.org/html/rfc7231#section-3.1.1.5) of the object data. Defaults to "application/octet-stream" or "text/plain; charset=utf-8".
        :param pulumi.Input[builtins.str] crc32c: (Computed) Base 64 CRC32 hash of the uploaded data.
        :param pulumi.Input['BucketObjectCustomerEncryptionArgs'] customer_encryption: Enables object encryption with Customer-Supplied Encryption Key (CSEK). Google [documentation about CSEK.](https://cloud.google.com/storage/docs/encryption/customer-supplied-keys)
               Structure is documented below.
        :param pulumi.Input[builtins.bool] event_based_hold: Whether an object is under [event-based hold](https://cloud.google.com/storage/docs/object-holds#hold-types). Event-based hold is a way to retain objects until an event occurs, which is signified by the hold's release (i.e. this value is set to false). After being released (set to false), such objects will be subject to bucket-level retention (if any).
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: User-provided metadata, in key/value pairs.
               ...
               One of the following is required:
        :param pulumi.Input[builtins.str] name: The name of the object. If you're interpolating the name of this object, see `output_name` instead.
        :param pulumi.Input[builtins.str] output_name: (Computed) The name of the object. Use this field in interpolations with `storage.ObjectACL` to recreate
               `storage.ObjectACL` resources when your `storage.BucketObject` is recreated.
        :param pulumi.Input['BucketObjectRetentionArgs'] retention: The [object retention](http://cloud.google.com/storage/docs/object-lock) settings for the object. The retention settings allow an object to be retained until a provided date. Structure is documented below.
        :param pulumi.Input[builtins.str] self_link: (Computed) A url reference to this object.
        :param pulumi.Input[Union[pulumi.Asset, pulumi.Archive]] source: A path to the data you want to upload. Must be defined
               if `content` is not.
    ...
    @property
    @pulumi.getter
    def crc32c(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @crc32c.setter
    def crc32c(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @media_link.setter
    def media_link(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BucketObject(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def crc32c(self) -> pulumi.Output[builtins.str]:
        """
        (Computed) Base 64 CRC32 hash of the uploaded data.
        """
        return pulumi.get(self, "crc32c")
    ...
    @property
    @pulumi.getter(name="eventBasedHold")
    def event_based_hold(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether an object is under [event-based hold](https://cloud.google.com/storage/docs/object-holds#hold-types). Event-based hold is a way to retain objects until an event occurs, which is signified by the hold's release (i.e. this value is set to false). After being released (set to false), such objects will be subject to bucket-level retention (if any).
        """
        return pulumi.get(self, "event_based_hold")
    ...
    @property
    @pulumi.getter(name="outputName")
    def output_name(self) -> pulumi.Output[builtins.str]:
        """
        (Computed) The name of the object. Use this field in interpolations with `storage.ObjectACL` to recreate
        `storage.ObjectACL` resources when your `storage.BucketObject` is recreated.
        """
    ...
    @property
    @pulumi.getter(name="temporaryHold")
    def temporary_hold(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether an object is under [temporary hold](https://cloud.google.com/storage/docs/object-holds#hold-types). While this flag is set to true, the object is protected against deletion and overwrites.
        """
        return pulumi.get(self, "temporary_hold")
