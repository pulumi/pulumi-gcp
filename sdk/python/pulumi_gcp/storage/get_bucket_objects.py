...
def get_bucket_objects(bucket: Optional[builtins.str] = None,
    ...
    :param builtins.str match_glob: A glob pattern used to filter results (for example, `foo*bar`).
    :param builtins.str prefix: Filter results to include only objects whose names begin with this prefix.
    """
    __args__ = dict()
...
def get_bucket_objects_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
                              match_glob: Optional[pulumi.Input[Optional[builtins.str]]] = None,
