...
class BucketIAMBindingArgs:
    def __init__(__self__, *,
        ...
        """
        BucketIAMBindingArgs._configure(
...
class _BucketIAMBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        """
        _BucketIAMBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            bucket=bucket,
            condition=condition,
            etag=etag,
...
class BucketIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BucketIAMBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, BucketIAMBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                BucketIAMBindingConditionArgs._configure(_setter, **condition)
