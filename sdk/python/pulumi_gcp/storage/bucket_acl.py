...
class BucketACLArgs:
    def __init__(__self__, *,
                 ...
                 default_acl: Optional[pulumi.Input[builtins.str]] = None,
                 predefined_acl: Optional[pulumi.Input[builtins.str]] = None,
                 role_entities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a BucketACL resource.
        :param pulumi.Input[builtins.str] bucket: The name of the bucket it applies to.
               
               - - -
        :param pulumi.Input[builtins.str] default_acl: Configure this ACL to be the default ACL.
        :param pulumi.Input[builtins.str] predefined_acl: The [canned GCS ACL](https://cloud.google.com/storage/docs/access-control/lists#predefined-acl) to apply. Must be set if `role_entity` is not.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] role_entities: List of role/entity pairs in the form `ROLE:entity`. See [GCS Bucket ACL documentation](https://cloud.google.com/storage/docs/json_api/v1/bucketAccessControls)  for more details. Must be set if `predefined_acl` is not.
        """
    ...
    def default_acl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @default_acl.setter
    def default_acl(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_acl", value)

    @property
    @pulumi.getter(name="predefinedAcl")
    def predefined_acl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def predefined_acl(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "predefined_acl", value)

    @property
    @pulumi.getter(name="roleEntities")
    def role_entities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def role_entities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BucketACL(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            default_acl: Optional[pulumi.Input[builtins.str]] = None,
            predefined_acl: Optional[pulumi.Input[builtins.str]] = None,
            role_entities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'BucketACL':
        """
    ...
    @property
    @pulumi.getter(name="defaultAcl")
    def default_acl(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Configure this ACL to be the default ACL.
        """
        return pulumi.get(self, "default_acl")
    ...
    @property
    @pulumi.getter(name="predefinedAcl")
    def predefined_acl(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The [canned GCS ACL](https://cloud.google.com/storage/docs/access-control/lists#predefined-acl) to apply. Must be set if `role_entity` is not.
        """
        return pulumi.get(self, "predefined_acl")
    ...
    @property
    @pulumi.getter(name="roleEntities")
    def role_entities(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of role/entity pairs in the form `ROLE:entity`. See [GCS Bucket ACL documentation](https://cloud.google.com/storage/docs/json_api/v1/bucketAccessControls)  for more details. Must be set if `predefined_acl` is not.
        """
        return pulumi.get(self, "role_entities")
