...
class BucketArgs:
    def __init__(__self__, *,
                 ...
                 default_event_based_hold: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_object_retention: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 public_access_prevention: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 rpo: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] default_event_based_hold: Whether or not to automatically apply an eventBasedHold to new objects added to the bucket.
        :param pulumi.Input[builtins.bool] enable_object_retention: Enables [object retention](https://cloud.google.com/storage/docs/object-lock) on a storage bucket.
        :param pulumi.Input['BucketEncryptionArgs'] encryption: The bucket's encryption configuration. Structure is documented below.
        :param pulumi.Input[builtins.bool] force_destroy: When deleting a bucket, this
        ...
        :param pulumi.Input[builtins.str] public_access_prevention: Prevents public access to a bucket. Acceptable values are "inherited" or "enforced". If "inherited", the bucket uses [public access prevention](https://cloud.google.com/storage/docs/public-access-prevention) only if the bucket is subject to the public access prevention organization policy constraint. Defaults to "inherited".
        :param pulumi.Input[builtins.bool] requester_pays: Enables [Requester Pays](https://cloud.google.com/storage/docs/requester-pays) on a storage bucket.
        ...
        :param pulumi.Input[builtins.str] rpo: The recovery point objective for cross-region replication of the bucket. Applicable only for dual and multi-region buckets. `"DEFAULT"` sets default replication. `"ASYNC_TURBO"` value enables turbo replication, valid for dual-region buckets only. See [Turbo Replication](https://cloud.google.com/storage/docs/managing-turbo-replication) for more information. If rpo is not specified at bucket creation, it defaults to `"DEFAULT"` for dual and multi-region buckets. **NOTE** If used with single-region bucket, It will throw an error.
    ...
    def default_event_based_hold(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def default_event_based_hold(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "default_event_based_hold", value)

    @property
    @pulumi.getter(name="enableObjectRetention")
    def enable_object_retention(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_object_retention(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def public_access_prevention(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_access_prevention(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def requester_pays(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def rpo(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @rpo.setter
    def rpo(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BucketState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 project_number: Optional[pulumi.Input[builtins.int]] = None,
                 public_access_prevention: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs. If it
               is not provided, the provider project is used.
        :param pulumi.Input[builtins.int] project_number: The project number of the project in which the resource belongs.
        :param pulumi.Input[builtins.str] public_access_prevention: Prevents public access to a bucket. Acceptable values are "inherited" or "enforced". If "inherited", the bucket uses [public access prevention](https://cloud.google.com/storage/docs/public-access-prevention) only if the bucket is subject to the public access prevention organization policy constraint. Defaults to "inherited".
    ...
    def project_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def project_number(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Bucket(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultEventBasedHold")
    def default_event_based_hold(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not to automatically apply an eventBasedHold to new objects added to the bucket.
        """
        return pulumi.get(self, "default_event_based_hold")
    ...
    @property
    @pulumi.getter(name="enableObjectRetention")
    def enable_object_retention(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables [object retention](https://cloud.google.com/storage/docs/object-lock) on a storage bucket.
        """
        return pulumi.get(self, "enable_object_retention")
    ...
    @property
    @pulumi.getter(name="projectNumber")
    def project_number(self) -> pulumi.Output[builtins.int]:
        """
        The project number of the project in which the resource belongs.
        """
        return pulumi.get(self, "project_number")
    ...
    @property
    @pulumi.getter(name="publicAccessPrevention")
    def public_access_prevention(self) -> pulumi.Output[builtins.str]:
        """
        Prevents public access to a bucket. Acceptable values are "inherited" or "enforced". If "inherited", the bucket uses [public access prevention](https://cloud.google.com/storage/docs/public-access-prevention) only if the bucket is subject to the public access prevention organization policy constraint. Defaults to "inherited".
        """
        return pulumi.get(self, "public_access_prevention")
    ...
    @property
    @pulumi.getter
    def rpo(self) -> pulumi.Output[builtins.str]:
        """
        The recovery point objective for cross-region replication of the bucket. Applicable only for dual and multi-region buckets. `"DEFAULT"` sets default replication. `"ASYNC_TURBO"` value enables turbo replication, valid for dual-region buckets only. See [Turbo Replication](https://cloud.google.com/storage/docs/managing-turbo-replication) for more information. If rpo is not specified at bucket creation, it defaults to `"DEFAULT"` for dual and multi-region buckets. **NOTE** If used with single-region bucket, It will throw an error.
        """
        return pulumi.get(self, "rpo")
