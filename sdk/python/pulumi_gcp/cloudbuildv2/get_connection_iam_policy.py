...
@pulumi.output_type
calass GetConnectionIamPolicyResult:
    """
...
calass AwaitableGetConnectionIamPolicyResult(GetConnectionIamPolicyResult):
...
def get_connection_iam_policy(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('gcp:cloudbuildv2/getConnectionIamPolicy:getConnectionIamPolicy', __args__, opts=opts, typ=GetConnectionIamPolicyResult).value
