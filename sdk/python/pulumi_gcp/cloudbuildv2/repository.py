...
class _RepositoryState:
    def __init__(__self__, *,
                 ...
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 remote_uri: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Allows clients to store small amounts of arbitrary data.
               **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration.
               Please refer to the field `effective_annotations` for all of the annotations present on the resource.
        :param pulumi.Input[builtins.str] create_time: Output only. Server assigned timestamp for when the connection was created.
        ...
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] remote_uri: Required. Git Clone HTTPS URI.
        :param pulumi.Input[builtins.str] update_time: Output only. Server assigned timestamp for when the connection was updated.
        """
        if annotations is not None:
            pulumi.set(__self__, "annotations", annotations)
    ...
    @property
    @pulumi.getter(name="remoteUri")
    def remote_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required. Git Clone HTTPS URI.
        """
        return pulumi.get(self, "remote_uri")
    ...
    @remote_uri.setter
    def remote_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_uri", value)
...
class Repository(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="remoteUri")
    def remote_uri(self) -> pulumi.Output[builtins.str]:
        """
        Required. Git Clone HTTPS URI.
        """
        return pulumi.get(self, "remote_uri")
