...
class ConnectionIAMBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The location for the resource Used to find the parent resource to bind the IAM policy to. If not specified,
...
class ConnectionIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: Optional[pulumi.Input[Union['ConnectionIAMBindingConditionArgs', 'ConnectionIAMBindingConditionArgsDict']]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'ConnectionIAMBinding':
        """
