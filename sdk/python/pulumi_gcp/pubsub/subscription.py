...
class SubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 ack_deadline_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 enable_exactly_once_delivery: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_message_ordering: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 retain_acked_messages: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input['SubscriptionDeadLetterPolicyArgs'] dead_letter_policy: A policy that specifies the conditions for dead lettering messages in
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.bool] enable_exactly_once_delivery: If `true`, Pub/Sub provides the following guarantees for the delivery
               of a message with a given value of messageId on this Subscriptions':
               - The message sent to a subscriber is guaranteed not to be resent before the message's acknowledgement deadline expires.
               - An acknowledged message will not be resent to a subscriber.
               Note that subscribers may still receive multiple copies of a message when `enable_exactly_once_delivery`
               is true if the message was published multiple times by a publisher client. These copies are considered distinct by Pub/Sub and have distinct messageId values
        :param pulumi.Input[builtins.bool] enable_message_ordering: If `true`, messages published with the same orderingKey in PubsubMessage will be delivered to
        ...
        :param pulumi.Input['SubscriptionExpirationPolicyArgs'] expiration_policy: A policy that specifies the conditions for this subscription's expiration.
               ...
               is 1 day.
               Structure is documented below.
        :param pulumi.Input[builtins.str] filter: The subscription only delivers the messages that match the filter.
               Pub/Sub automatically acknowledges the messages that don't match the filter. You can filter messages
               by their attributes. The maximum length of a filter is 256 bytes. After creating the subscription,
               you can't modify the filter.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: A set of key/value label pairs to assign to this Subscription.
               
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] message_retention_duration: How long to retain unacknowledged messages in the subscription's
        ...
        :param pulumi.Input['SubscriptionPushConfigArgs'] push_config: If push delivery is used with this subscription, this field is used to
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.bool] retain_acked_messages: Indicates whether to retain acknowledged messages. If `true`, then
    ...
    def ack_deadline_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ack_deadline_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enable_exactly_once_delivery(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_exactly_once_delivery(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_exactly_once_delivery", value)

    @property
    @pulumi.getter(name="enableMessageOrdering")
    def enable_message_ordering(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_message_ordering(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def retain_acked_messages(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def retain_acked_messages(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Subscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retain_acked_messages: Optional[pulumi.Input[builtins.bool]] = None,
            retry_policy: Optional[pulumi.Input[Union['SubscriptionRetryPolicyArgs', 'SubscriptionRetryPolicyArgsDict']]] = None,
            topic: Optional[pulumi.Input[builtins.str]] = None) -> 'Subscription':
        """
    ...
    @property
    @pulumi.getter(name="ackDeadlineSeconds")
    def ack_deadline_seconds(self) -> pulumi.Output[builtins.int]:
        """
        This value is the maximum time after a subscriber receives a message
        before the subscriber should acknowledge the message. After message
        delivery but before the ack deadline expires and before the message is
    ...
    @property
    @pulumi.getter(name="enableExactlyOnceDelivery")
    def enable_exactly_once_delivery(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true`, Pub/Sub provides the following guarantees for the delivery
        of a message with a given value of messageId on this Subscriptions':
        - The message sent to a subscriber is guaranteed not to be resent before the message's acknowledgement deadline expires.
    ...
    @property
    @pulumi.getter(name="enableMessageOrdering")
    def enable_message_ordering(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true`, messages published with the same orderingKey in PubsubMessage will be delivered to
        the subscribers in the order in which they are received by the Pub/Sub system. Otherwise, they
        may be delivered in any order.
    ...
    @property
    @pulumi.getter(name="retainAckedMessages")
    def retain_acked_messages(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to retain acknowledged messages. If `true`, then
        messages are not expunged from the subscription's backlog, even if
        they are acknowledged, until they fall out of the
