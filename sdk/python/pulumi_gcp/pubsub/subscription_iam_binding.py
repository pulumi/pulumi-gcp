...
class SubscriptionIAMBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['SubscriptionIAMBindingConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] subscription: The subscription name or id to bind to attach IAM policy to.
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['SubscriptionIAMBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['SubscriptionIAMBindingConditionArgs']]):
...
class _SubscriptionIAMBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] etag: (Computed) The etag of the subscription's IAM policy.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] members: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
               * **allAuthenticatedUsers**: A special identifier that represents anyone who is authenticated with a Google account or a service account.
...
class SubscriptionIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['SubscriptionIAMBindingConditionArgs', 'SubscriptionIAMBindingConditionArgsDict', 'outputs.SubscriptionIAMBindingCondition']]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 subscription: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            subscription: pulumi.Input[Optional[_builtins.str]] = None) -> 'SubscriptionIAMBinding':
        """
