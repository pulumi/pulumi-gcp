...
class SubscriptionIAMBindingArgs:
    def __init__(__self__, *,
        ...
        """
        SubscriptionIAMBindingArgs._configure(
...
class _SubscriptionIAMBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] subscription: The subscription name or id to bind to attach IAM policy to.
               ...
               * **domain:{domain}**: A G Suite domain (primary, instead of alias) name that represents all the users of that domain. For example, google.com or example.com.
        """
        _SubscriptionIAMBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            etag=etag,
            members=members,
...
class SubscriptionIAMBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SubscriptionIAMBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, SubscriptionIAMBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                SubscriptionIAMBindingConditionArgs._configure(_setter, **condition)
