...
class SchemaIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] schema: Used to find the parent resource to bind the IAM policy to
...
class SchemaIamBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            schema: Optional[pulumi.Input[builtins.str]] = None) -> 'SchemaIamBinding':
        """
