...
__all__ = [
    ...
    'SubscriptionMessageTransformAiInference',
    'SubscriptionMessageTransformAiInferenceUnstructuredInference',
    ...
    'TopicMessageTransformAiInference',
    'TopicMessageTransformAiInferenceUnstructuredInference',
    ...
    'GetSubscriptionMessageTransformAiInferenceResult',
    'GetSubscriptionMessageTransformAiInferenceUnstructuredInferenceResult',
    ...
    'GetTopicMessageTransformAiInferenceResult',
    'GetTopicMessageTransformAiInferenceUnstructuredInferenceResult',
...
class LiteSubscriptionDeliveryConfig(dict):
    ...
    def __init__(__self__, *,
                 delivery_requirement: _builtins.str):
        """
        :param _builtins.str delivery_requirement: When this subscription should send messages to subscribers relative to messages persistence in storage.
...
class LiteTopicPartitionConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int count: The number of partitions in the topic. Must be at least 1.
...
class LiteTopicPartitionConfigCapacity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int publish_mib_per_sec: Subscribe throughput capacity per partition in MiB/s. Must be >= 4 and <= 16.
        :param _builtins.int subscribe_mib_per_sec: Publish throughput capacity per partition in MiB/s. Must be >= 4 and <= 16.
        """
...
class LiteTopicReservationConfig(dict):
    ...
    def __init__(__self__, *,
                 throughput_reservation: Optional[_builtins.str] = None):
        """
        :param _builtins.str throughput_reservation: The Reservation to use for this topic's throughput capacity.
        """
...
class LiteTopicRetentionConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str per_partition_bytes: The provisioned storage, in bytes, per partition. If the number of bytes stored
               in any of the topic's partitions grows beyond this value, older messages will be
               dropped to make room for newer ones, regardless of the value of period.
        :param _builtins.str period: How long a published message is retained. If unset, messages will be retained as
...
class SubscriptionBigqueryConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str table: The name of the table to which to write data, of the form {projectId}.{datasetId}.{tableId}
        :param _builtins.bool drop_unknown_fields: When true and use_topic_schema or use_table_schema is true, any fields that are a part of the topic schema or message schema that
               are not part of the BigQuery table schema are dropped when writing to BigQuery. Otherwise, the schemas must be kept in sync
               and any messages with extra fields are not written and remain in the subscription's backlog.
        :param _builtins.str service_account_email: The service account to use to write to BigQuery. If not specified, the Pub/Sub
               [service agent](https://cloud.google.com/iam/docs/service-agents),
               service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com, is used.
        :param _builtins.bool use_table_schema: When true, use the BigQuery table's schema as the columns to write to in BigQuery. Messages
               must be published in JSON format. Only one of use_topic_schema and use_table_schema can be set.
        :param _builtins.bool use_topic_schema: When true, use the topic's schema as the columns to write to in BigQuery, if it exists.
               Only one of use_topic_schema and use_table_schema can be set.
        :param _builtins.bool write_metadata: When true, write the subscription name, messageId, publishTime, attributes, and orderingKey to additional columns in the table.
...
class SubscriptionCloudStorageConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str filename_prefix: User-provided prefix for Cloud Storage filename.
        :param _builtins.str filename_suffix: User-provided suffix for Cloud Storage filename. Must not end in "/".
        :param _builtins.int max_bytes: The maximum bytes that can be written to a Cloud Storage file before a new file is created. Min 1 KB, max 10 GiB.
               The maxBytes limit may be exceeded in cases where messages are larger than the limit.
        :param _builtins.str max_duration: The maximum duration that can elapse before a new Cloud Storage file is created. Min 1 minute, max 10 minutes, default 5 minutes.
               May not exceed the subscription's acknowledgement deadline.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        :param _builtins.int max_messages: The maximum messages that can be written to a Cloud Storage file before a new file is created. Min 1000 messages.
        :param _builtins.str service_account_email: The service account to use to write to Cloud Storage. If not specified, the Pub/Sub
               [service agent](https://cloud.google.com/iam/docs/service-agents),
               service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com, is used.
...
class SubscriptionCloudStorageConfigAvroConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 write_metadata: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool use_topic_schema: When true, the output Cloud Storage file will be serialized using the topic schema, if it exists.
        :param _builtins.bool write_metadata: When true, write the subscription name, messageId, publishTime, attributes, and orderingKey as additional fields in the output.
        """
        if use_topic_schema is not None:
            pulumi.set(__self__, "use_topic_schema", use_topic_schema)
        if write_metadata is not None:
...
class SubscriptionDeadLetterPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dead_letter_topic: The name of the topic to which dead letter messages should be published.
        ...
        :param _builtins.int max_delivery_attempts: The maximum number of delivery attempts for any message. The value must be
               between 5 and 100.
...
class SubscriptionExpirationPolicy(dict):
    def __init__(__self__, *,
                 ttl: _builtins.str):
        """
        :param _builtins.str ttl: Specifies the "time-to-live" duration for an associated resource. The
...
class SubscriptionMessageTransform(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "aiInference":
            suggest = "ai_inference"
        elif key == "javascriptUdf":
    ...
    def __init__(__self__, *,
                 ai_inference: Optional['outputs.SubscriptionMessageTransformAiInference'] = None,
                 disabled: Optional[_builtins.bool] = None,
                 javascript_udf: Optional['outputs.SubscriptionMessageTransformJavascriptUdf'] = None):
        """
        :param 'SubscriptionMessageTransformAiInferenceArgs' ai_inference: AI Inference. Specifies the Vertex AI endpoint that inference
               requests built from the Pub/Sub message data and provided parameters will
               be sent to.
               Structure is documented below.
        :param _builtins.bool disabled: Controls whether or not to use this transform. If not set or `false`,
    ...
    def ai_inference(self) -> Optional['outputs.SubscriptionMessageTransformAiInference']:
        """
...
@pulumi.output_type
class SubscriptionMessageTransformAiInference(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "serviceAccountEmail":
            suggest = "service_account_email"
        elif key == "unstructuredInference":
            suggest = "unstructured_inference"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SubscriptionMessageTransformAiInference. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SubscriptionMessageTransformAiInference.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 service_account_email: Optional[_builtins.str] = None,
                 unstructured_inference: Optional['outputs.SubscriptionMessageTransformAiInferenceUnstructuredInference'] = None):
        """
        :param _builtins.str endpoint: The endpoint to a Vertex AI model of the form
               `projects/{project}/locations/{location}/endpoints/{endpoint}` or
               `projects/{project}/locations/{location}/publishers/{publisher}/models/{model}`.
               Vertex AI API requests will be sent to this endpoint.
        :param _builtins.str service_account_email: The service account to use to make prediction requests against
               endpoints.
        :param 'SubscriptionMessageTransformAiInferenceUnstructuredInferenceArgs' unstructured_inference: Configuration for making inferences using arbitrary JSON payloads.
               Structure is documented below.
        """
    ...
    def unstructured_inference(self) -> Optional['outputs.SubscriptionMessageTransformAiInferenceUnstructuredInference']:
        """
...
@pulumi.output_type
class SubscriptionMessageTransformAiInferenceUnstructuredInference(dict):
    def __init__(__self__, *,
                 parameters: Optional[Mapping[str, _builtins.str]] = None):
        """
        :param Mapping[str, _builtins.str] parameters: A parameters object to be included in each inference request.
...
class SubscriptionMessageTransformJavascriptUdf(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str code: JavaScript code that contains a function `function_name` with the
               following signature:
               ```
               /**
...
class SubscriptionPushConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, _builtins.str] attributes: Endpoint configuration attributes.
...
class SubscriptionPushConfigNoWrapper(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool write_metadata: When true, writes the Pub/Sub message metadata to
...
class SubscriptionPushConfigOidcToken(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str service_account_email: Service account email to be used for generating the OIDC token.
               The caller (for subscriptions.create, subscriptions.patch, and
               subscriptions.modifyPushConfig RPCs) must have the
               iam.serviceAccounts.actAs permission for the service account.
        :param _builtins.str audience: Audience to be used when generating OIDC token. The audience claim
...
class SubscriptionRetryPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str maximum_backoff: The maximum delay between consecutive deliveries of a given message. Value should be between 0 and 600 seconds. Defaults to 600 seconds.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        :param _builtins.str minimum_backoff: The minimum delay between consecutive deliveries of a given message. Value should be between 0 and 600 seconds. Defaults to 10 seconds.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
...
class TopicIngestionDataSourceSettingsAwsKinesis(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str aws_role_arn: AWS role ARN to be used for Federated Identity authentication with
               Kinesis. Check the Pub/Sub docs for how to set up this role and the
               required permissions that need to be attached to it.
        :param _builtins.str consumer_arn: The Kinesis consumer ARN to used for ingestion in
               Enhanced Fan-Out mode. The consumer must be already
               created and ready to be used.
        :param _builtins.str gcp_service_account: The GCP service account to be used for Federated Identity authentication
               with Kinesis (via a `AssumeRoleWithWebIdentity` call for the provided
               role). The `awsRoleArn` must be set up with `accounts.google.com:sub`
               equals to this service account number.
        :param _builtins.str stream_arn: The Kinesis stream ARN to ingest data from.
        """
...
class TopicIngestionDataSourceSettingsAwsMsk(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str aws_role_arn: AWS role ARN to be used for Federated Identity authentication with
               ...
               required permissions that need to be attached to it.
        :param _builtins.str cluster_arn: ARN that uniquely identifies the MSK cluster.
        :param _builtins.str gcp_service_account: The GCP service account to be used for Federated Identity authentication
               with MSK (via a `AssumeRoleWithWebIdentity` call for the provided
               role). The `awsRoleArn` must be set up with `accounts.google.com:sub`
               equals to this service account number.
        :param _builtins.str topic: The name of the MSK topic that Pub/Sub will import from.
        """
        pulumi.set(__self__, "aws_role_arn", aws_role_arn)
...
class TopicIngestionDataSourceSettingsAzureEventHubs(dict):
    ...
    def __init__(__self__, *,
                 ...
                 event_hub: Optional[_builtins.str] = None,
                 gcp_service_account: Optional[_builtins.str] = None,
                 namespace: Optional[_builtins.str] = None,
                 resource_group: Optional[_builtins.str] = None,
                 subscription_id: Optional[_builtins.str] = None,
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str client_id: The Azure event hub client ID to use for ingestion.
        :param _builtins.str event_hub: The Azure event hub to ingest data from.
        :param _builtins.str gcp_service_account: The GCP service account to be used for Federated Identity authentication
               with Azure (via a `AssumeRoleWithWebIdentity` call for the provided
               role).
        :param _builtins.str namespace: The Azure event hub namespace to ingest data from.
        :param _builtins.str resource_group: The name of the resource group within an Azure subscription.
        :param _builtins.str subscription_id: The Azure event hub subscription ID to use for ingestion.
        :param _builtins.str tenant_id: The Azure event hub tenant ID to use for ingestion.
        """
...
class TopicIngestionDataSourceSettingsCloudStorage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 minimum_object_create_time: Optional[_builtins.str] = None,
        ...
        """
        :param _builtins.str bucket: Cloud Storage bucket. The bucket name must be without any
        ...
        :param _builtins.str match_glob: Glob pattern used to match objects that will be ingested. If unset, all
               objects will be ingested. See the supported patterns:
               https://cloud.google.com/storage/docs/json_api/v1/objects/list#list-objects-and-prefixes-using-glob
        :param _builtins.str minimum_object_create_time: The timestamp set in RFC3339 text format. If set, only objects with a
...
class TopicIngestionDataSourceSettingsCloudStorageTextFormat(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str delimiter: The delimiter to use when using the 'text' format. Each line of text as
...
class TopicIngestionDataSourceSettingsConfluentCloud(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str bootstrap_server: The Confluent Cloud bootstrap server. The format is url:port.
        :param _builtins.str gcp_service_account: The GCP service account to be used for Federated Identity authentication
               with Confluent Cloud.
        :param _builtins.str identity_pool_id: Identity pool ID to be used for Federated Identity authentication with Confluent Cloud.
        :param _builtins.str topic: Name of the Confluent Cloud topic that Pub/Sub will import from.
        :param _builtins.str cluster_id: The Confluent Cloud cluster ID.
        """
...
class TopicIngestionDataSourceSettingsPlatformLogsSettings(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str severity: The minimum severity level of Platform Logs that will be written. If unspecified,
...
class TopicMessageStoragePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enforce_in_transit: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] allowed_persistence_regions: A list of IDs of GCP regions where messages that are published to
               the topic may be persisted in storage. Messages published by
               publishers running in non-allowed GCP regions (or running outside
               of GCP altogether) will be routed for storage in one of the
               allowed regions. An empty list means that no regions are allowed,
               and is not a valid configuration.
        :param _builtins.bool enforce_in_transit: If true, `allowedPersistenceRegions` is also used to enforce in-transit
...
class TopicMessageTransform(dict):
    ...
    def __init__(__self__, *,
                 ai_inference: Optional['outputs.TopicMessageTransformAiInference'] = None,
                 disabled: Optional[_builtins.bool] = None,
                 javascript_udf: Optional['outputs.TopicMessageTransformJavascriptUdf'] = None):
        """
        :param 'TopicMessageTransformAiInferenceArgs' ai_inference: AI Inference. Specifies the Vertex AI endpoint that inference
               requests built from the Pub/Sub message data and provided parameters will
               be sent to.
               Structure is documented below.
        :param _builtins.bool disabled: Controls whether or not to use this transform. If not set or `false`,
    ...
    @_builtins.property
    @pulumi.getter(name="aiInference")
    def ai_inference(self) -> Optional['outputs.TopicMessageTransformAiInference']:
        """
        AI Inference. Specifies the Vertex AI endpoint that inference
        requests built from the Pub/Sub message data and provided parameters will
        be sent to.
...
@pulumi.output_type
class TopicMessageTransformAiInference(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "serviceAccountEmail":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TopicMessageTransformAiInference. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TopicMessageTransformAiInference.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 endpoint: _builtins.str,
                 service_account_email: Optional[_builtins.str] = None,
                 unstructured_inference: Optional['outputs.TopicMessageTransformAiInferenceUnstructuredInference'] = None):
        """
        :param _builtins.str endpoint: The endpoint to a Vertex AI model of the form
               `projects/{project}/locations/{location}/endpoints/{endpoint}` or
               `projects/{project}/locations/{location}/publishers/{publisher}/models/{model}`.
        ...
        :param _builtins.str service_account_email: The service account to use to make prediction requests against
               endpoints.
        :param 'TopicMessageTransformAiInferenceUnstructuredInferenceArgs' unstructured_inference: Configuration for making inferences using arbitrary JSON payloads.
               Structure is documented below.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        if service_account_email is not None:
    ...
    @_builtins.property
    @pulumi.getter(name="unstructuredInference")
    def unstructured_inference(self) -> Optional['outputs.TopicMessageTransformAiInferenceUnstructuredInference']:
        """
        Configuration for making inferences using arbitrary JSON payloads.
        Structure is documented below.
        """
...
@pulumi.output_type
class TopicMessageTransformAiInferenceUnstructuredInference(dict):
    def __init__(__self__, *,
                 parameters: Optional[Mapping[str, _builtins.str]] = None):
        """
        :param Mapping[str, _builtins.str] parameters: A parameters object to be included in each inference request.
...
class GetSubscriptionMessageTransformResult(dict):
    def __init__(__self__, *,
                 ai_inferences: Sequence['outputs.GetSubscriptionMessageTransformAiInferenceResult'],
                 disabled: _builtins.bool,
                 javascript_udfs: Sequence['outputs.GetSubscriptionMessageTransformJavascriptUdfResult']):
        """
        :param Sequence['GetSubscriptionMessageTransformAiInferenceArgs'] ai_inferences: AI Inference. Specifies the Vertex AI endpoint that inference
               requests built from the Pub/Sub message data and provided parameters will
               be sent to.
        :param _builtins.bool disabled: Controls whether or not to use this transform. If not set or 'false',
               the transform will be applied to messages. Default: 'true'.
        :param Sequence['GetSubscriptionMessageTransformJavascriptUdfArgs'] javascript_udfs: Javascript User Defined Function. If multiple Javascript UDFs are specified on a resource,
               each one must have a unique 'function_name'.
        """
        pulumi.set(__self__, "ai_inferences", ai_inferences)
        pulumi.set(__self__, "disabled", disabled)
        pulumi.set(__self__, "javascript_udfs", javascript_udfs)

    @_builtins.property
    @pulumi.getter(name="aiInferences")
    def ai_inferences(self) -> Sequence['outputs.GetSubscriptionMessageTransformAiInferenceResult']:
        """
        AI Inference. Specifies the Vertex AI endpoint that inference
        requests built from the Pub/Sub message data and provided parameters will
        be sent to.
        """
        return pulumi.get(self, "ai_inferences")
...
@pulumi.output_type
class GetSubscriptionMessageTransformAiInferenceResult(dict):
    def __init__(__self__, *,
                 endpoint: _builtins.str,
                 service_account_email: _builtins.str,
                 unstructured_inferences: Sequence['outputs.GetSubscriptionMessageTransformAiInferenceUnstructuredInferenceResult']):
        """
        :param _builtins.str endpoint: The endpoint to a Vertex AI model of the form
               'projects/{project}/locations/{location}/endpoints/{endpoint}' or
               'projects/{project}/locations/{location}/publishers/{publisher}/models/{model}'.
        ...
        :param _builtins.str service_account_email: The service account to use to make prediction requests against
               endpoints.
        :param Sequence['GetSubscriptionMessageTransformAiInferenceUnstructuredInferenceArgs'] unstructured_inferences: Configuration for making inferences using arbitrary JSON payloads.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "service_account_email", service_account_email)
        pulumi.set(__self__, "unstructured_inferences", unstructured_inferences)
    ...
    @_builtins.property
    @pulumi.getter(name="unstructuredInferences")
    def unstructured_inferences(self) -> Sequence['outputs.GetSubscriptionMessageTransformAiInferenceUnstructuredInferenceResult']:
        """
        Configuration for making inferences using arbitrary JSON payloads.
        """
        return pulumi.get(self, "unstructured_inferences")


@pulumi.output_type
class GetSubscriptionMessageTransformAiInferenceUnstructuredInferenceResult(dict):
    def __init__(__self__, *,
...
class GetSubscriptionRetryPolicyResult(dict):
    def __init__(__self__, *,
                 maximum_backoff: _builtins.str,
                 minimum_backoff: _builtins.str):
        """
        :param _builtins.str maximum_backoff: The maximum delay between consecutive deliveries of a given message. Value should be between 0 and 600 seconds. Defaults to 600 seconds.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        :param _builtins.str minimum_backoff: The minimum delay between consecutive deliveries of a given message. Value should be between 0 and 600 seconds. Defaults to 10 seconds.
...
class GetTopicMessageTransformResult(dict):
    def __init__(__self__, *,
                 ai_inferences: Sequence['outputs.GetTopicMessageTransformAiInferenceResult'],
                 disabled: _builtins.bool,
                 javascript_udfs: Sequence['outputs.GetTopicMessageTransformJavascriptUdfResult']):
        """
        :param Sequence['GetTopicMessageTransformAiInferenceArgs'] ai_inferences: AI Inference. Specifies the Vertex AI endpoint that inference
               requests built from the Pub/Sub message data and provided parameters will
               be sent to.
        :param _builtins.bool disabled: Controls whether or not to use this transform. If not set or 'false',
               the transform will be applied to messages. Default: 'true'.
    ...
    @_builtins.property
    @pulumi.getter(name="aiInferences")
    def ai_inferences(self) -> Sequence['outputs.GetTopicMessageTransformAiInferenceResult']:
        """
        AI Inference. Specifies the Vertex AI endpoint that inference
        requests built from the Pub/Sub message data and provided parameters will
        be sent to.
...
@pulumi.output_type
class GetTopicMessageTransformAiInferenceResult(dict):
    def __init__(__self__, *,
                 endpoint: _builtins.str,
                 service_account_email: _builtins.str,
                 unstructured_inferences: Sequence['outputs.GetTopicMessageTransformAiInferenceUnstructuredInferenceResult']):
        """
        :param _builtins.str endpoint: The endpoint to a Vertex AI model of the form
               'projects/{project}/locations/{location}/endpoints/{endpoint}' or
               'projects/{project}/locations/{location}/publishers/{publisher}/models/{model}'.
        ...
        :param _builtins.str service_account_email: The service account to use to make prediction requests against
               endpoints.
        :param Sequence['GetTopicMessageTransformAiInferenceUnstructuredInferenceArgs'] unstructured_inferences: Configuration for making inferences using arbitrary JSON payloads.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "service_account_email", service_account_email)
        pulumi.set(__self__, "unstructured_inferences", unstructured_inferences)
    ...
    @_builtins.property
    @pulumi.getter(name="unstructuredInferences")
    def unstructured_inferences(self) -> Sequence['outputs.GetTopicMessageTransformAiInferenceUnstructuredInferenceResult']:
        """
        Configuration for making inferences using arbitrary JSON payloads.
        """
        return pulumi.get(self, "unstructured_inferences")
...
@pulumi.output_type
class GetTopicMessageTransformAiInferenceUnstructuredInferenceResult(dict):
    def __init__(__self__, *,
                 parameters: Mapping[str, _builtins.str]):
        """
        :param Mapping[str, _builtins.str] parameters: A parameters object to be included in each inference request.
