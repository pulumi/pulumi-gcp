...
def get_topic_iam_policy(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str topic: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_topic_iam_policy_output(project: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
