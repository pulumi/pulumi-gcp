...
def get_topic_iam_policy(project: Optional[builtins.str] = None,
    ...
    :param builtins.str topic: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_topic_iam_policy_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
