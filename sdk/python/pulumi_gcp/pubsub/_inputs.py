...
class LiteSubscriptionDeliveryConfigArgs:
    def __init__(__self__, *,
                 delivery_requirement: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] delivery_requirement: When this subscription should send messages to subscribers relative to messages persistence in storage.
               Possible values are: `DELIVER_IMMEDIATELY`, `DELIVER_AFTER_STORED`, `DELIVERY_REQUIREMENT_UNSPECIFIED`.
        """
...
class LiteTopicPartitionConfigCapacityArgs:
    def __init__(__self__, *,
                 ...
                 subscribe_mib_per_sec: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] publish_mib_per_sec: Subscribe throughput capacity per partition in MiB/s. Must be >= 4 and <= 16.
        :param pulumi.Input[_builtins.int] subscribe_mib_per_sec: Publish throughput capacity per partition in MiB/s. Must be >= 4 and <= 16.
        """
...
class LiteTopicRetentionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] per_partition_bytes: The provisioned storage, in bytes, per partition. If the number of bytes stored
               in any of the topic's partitions grows beyond this value, older messages will be
               dropped to make room for newer ones, regardless of the value of period.
        :param pulumi.Input[_builtins.str] period: How long a published message is retained. If unset, messages will be retained as
               long as the bytes retained for each partition is below perPartitionBytes. A
               duration in seconds with up to nine fractional digits, terminated by 's'.
               Example: "3.5s".
        """
...
class SubscriptionBigqueryConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] drop_unknown_fields: When true and use_topic_schema or use_table_schema is true, any fields that are a part of the topic schema or message schema that
               are not part of the BigQuery table schema are dropped when writing to BigQuery. Otherwise, the schemas must be kept in sync
               and any messages with extra fields are not written and remain in the subscription's backlog.
        :param pulumi.Input[_builtins.str] service_account_email: The service account to use to write to BigQuery. If not specified, the Pub/Sub
               [service agent](https://cloud.google.com/iam/docs/service-agents),
               service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com, is used.
        :param pulumi.Input[_builtins.bool] use_table_schema: When true, use the BigQuery table's schema as the columns to write to in BigQuery. Messages
               must be published in JSON format. Only one of use_topic_schema and use_table_schema can be set.
        :param pulumi.Input[_builtins.bool] use_topic_schema: When true, use the topic's schema as the columns to write to in BigQuery, if it exists.
               Only one of use_topic_schema and use_table_schema can be set.
        :param pulumi.Input[_builtins.bool] write_metadata: When true, write the subscription name, messageId, publishTime, attributes, and orderingKey to additional columns in the table.
               The subscription name, messageId, and publishTime fields are put in their own columns while all other message properties (other than data) are written to a JSON object in the attributes column.
        """
...
class SubscriptionCloudStorageConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] filename_prefix: User-provided prefix for Cloud Storage filename.
        :param pulumi.Input[_builtins.str] filename_suffix: User-provided suffix for Cloud Storage filename. Must not end in "/".
        :param pulumi.Input[_builtins.int] max_bytes: The maximum bytes that can be written to a Cloud Storage file before a new file is created. Min 1 KB, max 10 GiB.
               The maxBytes limit may be exceeded in cases where messages are larger than the limit.
        :param pulumi.Input[_builtins.str] max_duration: The maximum duration that can elapse before a new Cloud Storage file is created. Min 1 minute, max 10 minutes, default 5 minutes.
               May not exceed the subscription's acknowledgement deadline.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        :param pulumi.Input[_builtins.int] max_messages: The maximum messages that can be written to a Cloud Storage file before a new file is created. Min 1000 messages.
        :param pulumi.Input[_builtins.str] service_account_email: The service account to use to write to Cloud Storage. If not specified, the Pub/Sub
               [service agent](https://cloud.google.com/iam/docs/service-agents),
               service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com, is used.
...
class SubscriptionDeadLetterPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dead_letter_topic: The name of the topic to which dead letter messages should be published.
               ...
               Users should ensure that there is a subscription attached to this topic
               since messages published to a topic with no subscriptions are lost.
        :param pulumi.Input[_builtins.int] max_delivery_attempts: The maximum number of delivery attempts for any message. The value must be
               between 5 and 100.
               The number of delivery attempts is defined as 1 + (the sum of number of
               NACKs and number of times the acknowledgement deadline has been exceeded for the message).
               A NACK is any call to ModifyAckDeadline with a 0 deadline. Note that
...
class SubscriptionExpirationPolicyArgs:
    def __init__(__self__, *,
                 ttl: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] ttl: Specifies the "time-to-live" duration for an associated resource. The
               resource expires if it is not active for a period of ttl.
               If ttl is set to "", the associated resource never expires.
               A duration in seconds with up to nine fractional digits, terminated by 's'.
               Example - "3.5s".
...
class SubscriptionMessageTransformJavascriptUdfArgs:
    def __init__(__self__, *,
                 ...
                 function_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] code: JavaScript code that contains a function `function_name` with the
               following signature:
               ```
               /**
               * Transforms a Pub/Sub message.
               ...
               */
               ...
               ```
        :param pulumi.Input[_builtins.str] function_name: Name of the JavaScript function that should be applied to Pub/Sub messages.
        """
...
class SubscriptionPushConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] push_endpoint: A URL locating the endpoint to which messages should be pushed.
               For example, a Webhook endpoint might use
               "https://example.com/push".
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] attributes: Endpoint configuration attributes.
               Every endpoint has a set of API supported attributes that can
               be used to control different aspects of the message delivery.
               The currently supported attribute is x-goog-version, which you
               can use to change the format of the pushed message. This
...
class SubscriptionPushConfigNoWrapperArgs:
    def __init__(__self__, *,
                 write_metadata: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] write_metadata: When true, writes the Pub/Sub message metadata to
               `x-goog-pubsub-<KEY>:<VAL>` headers of the HTTP request. Writes the
               Pub/Sub message attributes to `<KEY>:<VAL>` headers of the HTTP request.
        """
        pulumi.set(__self__, "write_metadata", write_metadata)
...
class SubscriptionPushConfigOidcTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_account_email: Service account email to be used for generating the OIDC token.
               ...
               subscriptions.modifyPushConfig RPCs) must have the
               iam.serviceAccounts.actAs permission for the service account.
        :param pulumi.Input[_builtins.str] audience: Audience to be used when generating OIDC token. The audience claim
               identifies the recipients that the JWT is intended for. The audience
               value is a single case-sensitive string. Having multiple values (array)
               for the audience field is not supported. More info about the OIDC JWT
               token audience here: https://tools.ietf.org/html/rfc7519#section-4.1.3
...
class SubscriptionRetryPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] maximum_backoff: The maximum delay between consecutive deliveries of a given message. Value should be between 0 and 600 seconds. Defaults to 600 seconds.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        :param pulumi.Input[_builtins.str] minimum_backoff: The minimum delay between consecutive deliveries of a given message. Value should be between 0 and 600 seconds. Defaults to 10 seconds.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
...
class TopicIngestionDataSourceSettingsAwsKinesisArgs:
    def __init__(__self__, *,
                 ...
                 stream_arn: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] aws_role_arn: AWS role ARN to be used for Federated Identity authentication with
               Kinesis. Check the Pub/Sub docs for how to set up this role and the
               required permissions that need to be attached to it.
        :param pulumi.Input[_builtins.str] consumer_arn: The Kinesis consumer ARN to used for ingestion in
               Enhanced Fan-Out mode. The consumer must be already
               created and ready to be used.
        :param pulumi.Input[_builtins.str] gcp_service_account: The GCP service account to be used for Federated Identity authentication
               ...
               role). The `awsRoleArn` must be set up with `accounts.google.com:sub`
               equals to this service account number.
        :param pulumi.Input[_builtins.str] stream_arn: The Kinesis stream ARN to ingest data from.
        """
...
class TopicIngestionDataSourceSettingsAwsMskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] aws_role_arn: AWS role ARN to be used for Federated Identity authentication with
               MSK. Check the Pub/Sub docs for how to set up this role and the
               required permissions that need to be attached to it.
        :param pulumi.Input[_builtins.str] cluster_arn: ARN that uniquely identifies the MSK cluster.
        :param pulumi.Input[_builtins.str] gcp_service_account: The GCP service account to be used for Federated Identity authentication
               with MSK (via a `AssumeRoleWithWebIdentity` call for the provided
               role). The `awsRoleArn` must be set up with `accounts.google.com:sub`
               equals to this service account number.
        :param pulumi.Input[_builtins.str] topic: The name of the MSK topic that Pub/Sub will import from.
        """
        pulumi.set(__self__, "aws_role_arn", aws_role_arn)
...
class TopicIngestionDataSourceSettingsAzureEventHubsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] gcp_service_account: The GCP service account to be used for Federated Identity authentication
               with Azure (via a `AssumeRoleWithWebIdentity` call for the provided
               role).
        :param pulumi.Input[_builtins.str] namespace: The Azure event hub namespace to ingest data from.
        :param pulumi.Input[_builtins.str] resource_group: The name of the resource group within an Azure subscription.
        :param pulumi.Input[_builtins.str] subscription_id: The Azure event hub subscription ID to use for ingestion.
        :param pulumi.Input[_builtins.str] tenant_id: The Azure event hub tenant ID to use for ingestion.
        """
...
class TopicIngestionDataSourceSettingsCloudStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TopicIngestionDataSourceSettingsCloudStorageAvroFormatArgs'] avro_format: Configuration for reading Cloud Storage data in Avro binary format. The
               bytes of each object will be set to the `data` field of a Pub/Sub message.
        :param pulumi.Input[_builtins.str] match_glob: Glob pattern used to match objects that will be ingested. If unset, all
               objects will be ingested. See the supported patterns:
               https://cloud.google.com/storage/docs/json_api/v1/objects/list#list-objects-and-prefixes-using-glob
        :param pulumi.Input[_builtins.str] minimum_object_create_time: The timestamp set in RFC3339 text format. If set, only objects with a
               larger or equal timestamp will be ingested. Unset by default, meaning
               all objects will be ingested.
...
class TopicIngestionDataSourceSettingsConfluentCloudArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] gcp_service_account: The GCP service account to be used for Federated Identity authentication
               with Confluent Cloud.
        :param pulumi.Input[_builtins.str] identity_pool_id: Identity pool ID to be used for Federated Identity authentication with Confluent Cloud.
        :param pulumi.Input[_builtins.str] topic: Name of the Confluent Cloud topic that Pub/Sub will import from.
        :param pulumi.Input[_builtins.str] cluster_id: The Confluent Cloud cluster ID.
        """
...
class TopicMessageStoragePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_persistence_regions: A list of IDs of GCP regions where messages that are published to
               ...
               allowed regions. An empty list means that no regions are allowed,
               and is not a valid configuration.
        :param pulumi.Input[_builtins.bool] enforce_in_transit: If true, `allowedPersistenceRegions` is also used to enforce in-transit
               guarantees for messages. That is, Pub/Sub will fail topics.publish
               operations on this topic and subscribe operations on any subscription
               attached to this topic in any region that is not in `allowedPersistenceRegions`.
        """
    ...
    def allowed_persistence_regions(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of IDs of GCP regions where messages that are published to
        the topic may be persisted in storage. Messages published by
        publishers running in non-allowed GCP regions (or running outside
    ...
    def allowed_persistence_regions(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
