...
class GetSchemaIamPolicyResult:
    ...
    """
    def __init__(__self__, etag=None, id=None, policy_data=None, project=None, schema=None):
...
def get_schema_iam_policy(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str schema: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
    __args__['project'] = project
    __args__['schema'] = schema
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('gcp:pubsub/getSchemaIamPolicy:getSchemaIamPolicy', __args__, opts=opts, typ=GetSchemaIamPolicyResult).value
...
def get_schema_iam_policy_output(project: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 schema: Optional[pulumi.Input[_builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSchemaIamPolicyResult]:
    """
    Retrieves the current IAM policy data for schema
