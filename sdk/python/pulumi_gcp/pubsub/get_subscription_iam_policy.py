...
def get_subscription_iam_policy(project: Optional[builtins.str] = None,
    ...
    :param builtins.str subscription: The subscription name or id to bind to attach IAM policy to.
    """
    __args__ = dict()
...
def get_subscription_iam_policy_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
