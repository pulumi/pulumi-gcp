...
def get_subscription_iam_policy(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str subscription: The subscription name or id to bind to attach IAM policy to.
    """
    __args__ = dict()
