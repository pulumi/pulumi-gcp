...
class TopicIAMMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['TopicIAMMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] topic: Used to find the parent resource to bind the IAM policy to
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['TopicIAMMemberConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['TopicIAMMemberConditionArgs']]):
...
@pulumi.type_token("gcp:pubsub/topicIAMMember:TopicIAMMember")
class TopicIAMMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['TopicIAMMemberConditionArgs', 'TopicIAMMemberConditionArgsDict', 'outputs.TopicIAMMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 topic: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `pubsub.TopicIAMBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the topic are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `pubsub.TopicIAMMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the topic are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            topic: pulumi.Input[Optional[_builtins.str]] = None) -> 'TopicIAMMember':
        """
