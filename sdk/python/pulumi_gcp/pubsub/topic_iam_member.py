...
class _TopicIAMMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] topic: Used to find the parent resource to bind the IAM policy to
        """
        _TopicIAMMemberState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            etag=etag,
            member=member,
...
class TopicIAMMember(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            TopicIAMMemberArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, TopicIAMMemberConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                TopicIAMMemberConditionArgs._configure(_setter, **condition)
