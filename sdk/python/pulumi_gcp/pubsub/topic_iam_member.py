...
class TopicIAMMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] topic: Used to find the parent resource to bind the IAM policy to
...
class TopicIAMMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            topic: Optional[pulumi.Input[builtins.str]] = None) -> 'TopicIAMMember':
        """
