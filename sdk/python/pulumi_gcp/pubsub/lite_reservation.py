...
class LiteReservationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: The region of the pubsub lite reservation.
        """
...
class LiteReservation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None,
            throughput_capacity: Optional[pulumi.Input[_builtins.int]] = None) -> 'LiteReservation':
        """
