...
class RegionalSecretCustomerManagedEncryptionArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads.
        """
...
if not MYPY:
    class RegionalSecretRotationArgsDict(TypedDict):
        next_rotation_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RegionalSecretRotationArgs:
    def __init__(__self__, *,
                 next_rotation_time: Optional[pulumi.Input[builtins.str]] = None,
                 rotation_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] next_rotation_time: Timestamp in UTC at which the Secret is scheduled to rotate.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine
               fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] rotation_period: The Duration between rotation notifications. Must be in seconds and at least 3600s (1h)
               and at most 3153600000s (100 years). If rotationPeriod is set, `next_rotation_time` must
               be set. `next_rotation_time` will be advanced by this period when the service
               automatically sends rotation notifications.
        """
    ...
    def next_rotation_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Timestamp in UTC at which the Secret is scheduled to rotate.
        A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine
        fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
    ...
    def next_rotation_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RegionalSecretTopicArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The resource name of the Pub/Sub topic that will be published to, in the following format:
               projects/*/topics/*. For publication to succeed, the Secret Manager Service
               Agent service account must have pubsub.publisher permissions on the topic.
        """
...
class RegionalSecretVersionCustomerManagedEncryptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_version_name: (Output)
               The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads.
        """
...
class SecretReplicationAutoCustomerManagedEncryptionArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: Describes the Cloud KMS encryption key that will be used to protect destination secret.
...
class SecretReplicationUserManagedReplicaArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] location: The canonical IDs of the location to replicate data. For example: "us-east1".
...
class SecretRotationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] next_rotation_time: Timestamp in UTC at which the Secret is scheduled to rotate.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[builtins.str] rotation_period: The Duration between rotation notifications. Must be in seconds and at least 3600s (1h) and at most 3153600000s (100 years).
               If rotationPeriod is set, `next_rotation_time` must be set. `next_rotation_time` will be advanced by this period when the service automatically sends rotation notifications.
        """
        if next_rotation_time is not None:
            pulumi.set(__self__, "next_rotation_time", next_rotation_time)
...
class SecretTopicArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The resource name of the Pub/Sub topic that will be published to, in the following format: projects/*/topics/*.
               For publication to succeed, the Secret Manager Service Agent service account must have pubsub.publisher permissions on the topic.
        """
        pulumi.set(__self__, "name", name)
