...
class RegionalSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to this regional secret.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] version_aliases: Mapping from version alias to version name.
               ...
               An object containing a list of "key": value pairs. Example:
               { "name": "wrench", "mass": "1.3kg", "count": "3" }.
        :param pulumi.Input[_builtins.str] version_destroy_ttl: Secret Version TTL after destruction request.
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels assigned to this regional secret.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location of the regional secret. eg us-central1
        :param pulumi.Input[_builtins.str] name: The resource name of the regional secret. Format:
...
class RegionalSecret(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="versionAliases")
    def version_aliases(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        Mapping from version alias to version name.
        A version alias is a string with a maximum length of 63 characters and can contain
        uppercase and lowercase letters, numerals, and the hyphen (-) and underscore ('_')
