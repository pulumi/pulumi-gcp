...
def get_regional_secret_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The location of the regional secret. eg us-central1
...
def get_regional_secret_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
