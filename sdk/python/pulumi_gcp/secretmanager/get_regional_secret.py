...
def get_regional_secret(location: Optional[builtins.str] = None,
    ...
    :param builtins.str secret_id: The name of the regional secret.
    """
    __args__ = dict()
...
def get_regional_secret_output(location: Optional[pulumi.Input[builtins.str]] = None,
