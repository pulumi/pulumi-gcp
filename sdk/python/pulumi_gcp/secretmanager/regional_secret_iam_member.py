...
class RegionalSecretIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['RegionalSecretIamMemberConditionArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['RegionalSecretIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['RegionalSecretIamMemberConditionArgs']]):
...
@pulumi.type_token("gcp:secretmanager/regionalSecretIamMember:RegionalSecretIamMember")
class RegionalSecretIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['RegionalSecretIamMemberConditionArgs', 'RegionalSecretIamMemberConditionArgsDict', 'outputs.RegionalSecretIamMemberCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * {{secret_id}}
        ...
        :param pulumi.Input[Union['RegionalSecretIamMemberConditionArgs', 'RegionalSecretIamMemberConditionArgsDict', 'outputs.RegionalSecretIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] location: The location of the regional secret. eg us-central1
               Used to find the parent resource to bind the IAM policy to. If not specified,
               the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
    ...
    def __init__(__self__,
        ...
        * {{secret_id}}
        ...
        :param str resource_name: The name of the resource.
        :param RegionalSecretIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RegionalSecretIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RegionalSecretIamMemberArgs.__new__(RegionalSecretIamMemberArgs)
        ...
        super(RegionalSecretIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            secret_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'RegionalSecretIamMember':
        """
        ...
        __props__ = _RegionalSecretIamMemberState.__new__(_RegionalSecretIamMemberState)
        ...
        __props__.__dict__["role"] = role
        __props__.__dict__["secret_id"] = secret_id
        return RegionalSecretIamMember(resource_name, opts=opts, __props__=__props__)
