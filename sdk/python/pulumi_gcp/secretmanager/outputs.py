...
class RegionalSecretCustomerManagedEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_name: The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads.
        """
...
class RegionalSecretRotation(dict):
    ...
    def __init__(__self__, *,
                 next_rotation_time: Optional[builtins.str] = None,
                 rotation_period: Optional[builtins.str] = None):
        """
        :param builtins.str next_rotation_time: Timestamp in UTC at which the Secret is scheduled to rotate.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine
               fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param builtins.str rotation_period: The Duration between rotation notifications. Must be in seconds and at least 3600s (1h)
    ...
    def next_rotation_time(self) -> Optional[builtins.str]:
        """
...
class RegionalSecretTopic(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: The resource name of the Pub/Sub topic that will be published to, in the following format:
...
class RegionalSecretVersionCustomerManagedEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_version_name: (Output)
               The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads.
        """
...
class SecretReplicationUserManagedReplica(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str location: The canonical IDs of the location to replicate data. For example: "us-east1".
...
class SecretRotation(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str rotation_period: The Duration between rotation notifications. Must be in seconds and at least 3600s (1h) and at most 3153600000s (100 years).
...
class SecretTopic(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: The resource name of the Pub/Sub topic that will be published to, in the following format: projects/*/topics/*.
...
class GetRegionalSecretVersionCustomerManagedEncryptionResult(dict):
    def __init__(__self__, *,
                 kms_key_version_name: builtins.str):
        """
        :param builtins.str kms_key_version_name: The resource name of the Cloud KMS CryptoKey used to encrypt secret payloads.
        """
        pulumi.set(__self__, "kms_key_version_name", kms_key_version_name)
...
class GetRegionalSecretsSecretResult(dict):
    def __init__(__self__, *,
                 ...
                 ttl: builtins.str,
                 version_aliases: Mapping[str, builtins.str],
                 version_destroy_ttl: builtins.str):
        """
        :param Mapping[str, builtins.str] annotations: Custom metadata about the regional secret.
        :param builtins.str create_time: The time at which the regional secret was created.
        :param Sequence['GetRegionalSecretsSecretCustomerManagedEncryptionArgs'] customer_managed_encryptions: Customer Managed Encryption for the regional secret.
               Structure is documented below.
        :param builtins.str expire_time: Timestamp in UTC when the regional secret is scheduled to expire.
        :param Mapping[str, builtins.str] labels: The labels assigned to this regional secret.
        :param builtins.str location: The location of the regional secret.
        :param builtins.str name: The resource name of the Pub/Sub topic that will be published to.
        ...
        :param Sequence['GetRegionalSecretsSecretRotationArgs'] rotations: The rotation time and period for a regional secret.
               Structure is documented below.
        :param builtins.str secret_id: The unique name of the resource.
        :param Sequence['GetRegionalSecretsSecretTopicArgs'] topics: A list of up to 10 Pub/Sub topics to which messages are published when control plane operations are called on the regional secret or its versions.
               Structure is documented below.
        :param builtins.str ttl: The TTL for the regional secret. A duration in seconds with up to nine fractional digits,
               terminated by 's'. Example: "3.5s". Only one of 'ttl' or 'expire_time' can be provided.
        :param Mapping[str, builtins.str] version_aliases: Mapping from version alias to version name.
        :param builtins.str version_destroy_ttl: The version destroy ttl for the regional secret version.
        """
...
class GetRegionalSecretsSecretRotationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str next_rotation_time: Timestamp in UTC at which the secret is scheduled to rotate.
        :param builtins.str rotation_period: The Duration between rotation notifications.
        """
        pulumi.set(__self__, "next_rotation_time", next_rotation_time)
        pulumi.set(__self__, "rotation_period", rotation_period)
...
class GetSecretsSecretResult(dict):
    def __init__(__self__, *,
                 ...
                 version_destroy_ttl: builtins.str):
        """
        :param Mapping[str, builtins.str] annotations: Custom metadata about the secret.
        :param builtins.str create_time: The time at which the Secret was created.
        :param builtins.str expire_time: Timestamp in UTC when the Secret is scheduled to expire.
        :param Mapping[str, builtins.str] labels: The labels assigned to this Secret.
        :param builtins.str name: The resource name of the Pub/Sub topic that will be published to.
        :param builtins.str project: The ID of the project.
        :param Mapping[str, builtins.str] pulumi_labels: The combination of labels configured directly on the resource
                and default labels configured on the provider.
        ...
        :param Sequence['GetSecretsSecretRotationArgs'] rotations: The rotation time and period for a Secret.
               Structure is documented below.
        :param builtins.str secret_id: This must be unique within the project.
        :param Sequence['GetSecretsSecretTopicArgs'] topics: A list of up to 10 Pub/Sub topics to which messages are published when control plane operations are called on the secret or its versions.
               Structure is documented below.
        :param builtins.str ttl: The TTL for the Secret.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
               Only one of 'ttl' or 'expire_time' can be provided.
        :param Mapping[str, builtins.str] version_aliases: Mapping from version alias to version name.
        :param builtins.str version_destroy_ttl: The version destroy ttl for the secret version.
        """
        pulumi.set(__self__, "annotations", annotations)
        pulumi.set(__self__, "create_time", create_time)
        pulumi.set(__self__, "effective_annotations", effective_annotations)
...
class GetSecretsSecretReplicationUserManagedReplicaResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['GetSecretsSecretReplicationUserManagedReplicaCustomerManagedEncryptionArgs'] customer_managed_encryptions: Customer Managed Encryption for the secret.
               Structure is documented below.
        :param builtins.str location: The canonical IDs of the location to replicate data.
        """
        pulumi.set(__self__, "customer_managed_encryptions", customer_managed_encryptions)
        pulumi.set(__self__, "location", location)
