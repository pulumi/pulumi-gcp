...
def get_regional_secret_version_access(is_secret_data_base64: Optional[builtins.bool] = None,
...
def get_regional_secret_version_access_output(is_secret_data_base64: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
