...
def get_secret_version_access(is_secret_data_base64: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str secret: The secret to get the secret version for.
    :param _builtins.str version: The version of the secret to get. If it
