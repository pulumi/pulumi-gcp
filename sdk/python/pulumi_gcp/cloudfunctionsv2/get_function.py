...
def get_function(location: Optional[builtins.str] = None,
    ...
    * [API documentation](https://cloud.google.com/functions/docs/reference/rest/v2beta/projects.locations.functions).
    ...
    :param builtins.str location: The location in which the resource belongs.
           
           - - -
    :param builtins.str name: The name of a Cloud Function (2nd gen).
...
def get_function_output(location: Optional[pulumi.Input[builtins.str]] = None,
