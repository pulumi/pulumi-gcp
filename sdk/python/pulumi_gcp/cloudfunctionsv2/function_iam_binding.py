...
class FunctionIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['FunctionIamBindingConditionArgs']] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a FunctionIamBinding resource.

        :param pulumi.Input[_builtins.str] cloud_function: Used to find the parent resource to bind the IAM policy to
        ...
        :param pulumi.Input[_builtins.str] location: The location of this cloud function. Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['FunctionIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['FunctionIamBindingConditionArgs']]):
...
@pulumi.type_token("gcp:cloudfunctionsv2/functionIamBinding:FunctionIamBinding")
class FunctionIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cloud_function: pulumi.Input[Optional[_builtins.str]] = None,
                 condition: pulumi.Input[Optional[Union['FunctionIamBindingConditionArgs', 'FunctionIamBindingConditionArgsDict', 'outputs.FunctionIamBindingCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `cloudfunctionsv2.FunctionIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the function are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'FunctionIamBinding':
        """
