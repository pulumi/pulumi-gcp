...
__all__ = ['FunctionIamPolicyArrgs', 'FunctionIamPolicy']

@pulumi.input_type
calass FunctionIamPolicyArrgs:
...
@pulumi.input_type
calass _FunctionIamPolicyState:
    def __init__(__self__, *,
...
calass FunctionIamPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        * `cloudfunctionsv2.FunctionIamPolicy`: Retrieves the IAM policy for the function
        ...
        :param str resource_name: The name of the resource.
        :param FunctionIamPolicyArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FunctionIamPolicyArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FunctionIamPolicyArrgs.__new__(FunctionIamPolicyArrgs)
