...
class FunctionBuildConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FunctionBuildConfigAutomaticUpdatePolicyArgs'] automatic_update_policy: Security patches are applied automatically to the runtime without requiring
               the function to be redeployed.
        :param pulumi.Input[_builtins.str] build: (Output)
               The Cloud Build name of the latest successful
               deployment of the function.
        :param pulumi.Input[_builtins.str] docker_repository: User managed repository created in Artifact Registry optionally with a customer managed encryption key.
        :param pulumi.Input[_builtins.str] entry_point: The name of the function (as defined in source code) that will be executed.
               Defaults to the resource name suffix, if not specified. For backward
               compatibility, if function with given name is not found, then the system
               will try to use function named "function". For Node.js this is name of a
               function exported by the module specified in source_location.
        ...
        :param pulumi.Input['FunctionBuildConfigOnDeployUpdatePolicyArgs'] on_deploy_update_policy: Security patches are only applied when a function is redeployed.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] runtime: The runtime in which to run the function. Required when deploying a new
               function, optional when updating an existing function.
        :param pulumi.Input[_builtins.str] service_account: The fully-qualified name of the service account to be used for building the container.
        :param pulumi.Input['FunctionBuildConfigSourceArgs'] source: The location of the function source code.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] worker_pool: Name of the Cloud Build Custom Worker Pool that should be used to build the function.
        """
...
class FunctionBuildConfigSourceRepoSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] invert_regex: Only trigger a build if the revision regex does
               NOT match the revision regex.
        :param pulumi.Input[_builtins.str] project_id: ID of the project that owns the Cloud Source Repository. If omitted, the
               project ID requesting the build is assumed.
        :param pulumi.Input[_builtins.str] repo_name: Name of the Cloud Source Repository.
        :param pulumi.Input[_builtins.str] tag_name: Regex matching tags to build.
        """
...
class FunctionBuildConfigSourceStorageSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] generation: Google Cloud Storage generation for the object. If the generation
               is omitted, the latest generation will be used.
        :param pulumi.Input[_builtins.str] object: Google Cloud Storage object containing the source.
        """
...
class FunctionEventTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] retry_policy: Describes the retry policy in case of function's execution failure.
               Retried execution is charged as any other execution.
               Possible values are: `RETRY_POLICY_UNSPECIFIED`, `RETRY_POLICY_DO_NOT_RETRY`, `RETRY_POLICY_RETRY`.
        :param pulumi.Input[_builtins.str] service_account_email: Optional. The email of the trigger's service account. The service account
               must have permission to invoke Cloud Run services. If empty, defaults to the
               Compute Engine default service account: {project_number}-compute@developer.gserviceaccount.com.
        :param pulumi.Input[_builtins.str] trigger: (Output)
               Output only. The resource name of the Eventarc trigger.
        :param pulumi.Input[_builtins.str] trigger_region: The region that the trigger will be in. The trigger will only receive
               events originating in this region. It can be the same
               region as the function, a different region or multi-region, or the global
               region. If not provided, defaults to the same region as the function.
        """
...
class FunctionEventTriggerEventFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] attribute: 'Required. The name of a CloudEvents attribute.
               Currently, only a subset of attributes are supported for filtering. Use the `gcloud eventarc providers describe` command to learn more about events and their attributes.
               Do not filter for the 'type' attribute here, as this is already achieved by the resource's `event_type` attribute.
        :param pulumi.Input[_builtins.str] value: Required. The value for the attribute.
               If the operator field is set as `match-path-pattern`, this value can be a path pattern instead of an exact value.
        :param pulumi.Input[_builtins.str] operator: Optional. The operator used for matching the events with the value of
               the filter. If not specified, only events that have an exact key-value
               pair specified in the filter are matched.
               The only allowed value is `match-path-pattern`.
               [See documentation on path patterns here](https://cloud.google.com/eventarc/docs/path-patterns)'
...
class FunctionServiceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] gcf_uri: (Output)
               URIs of the Service deployed
        :param pulumi.Input[_builtins.str] ingress_settings: Available ingress settings. Defaults to "ALLOW_ALL" if unspecified.
               Default value is `ALLOW_ALL`.
               Possible values are: `ALLOW_ALL`, `ALLOW_INTERNAL_ONLY`, `ALLOW_INTERNAL_AND_GCLB`.
        :param pulumi.Input[_builtins.int] max_instance_count: The limit on the maximum number of function instances that may coexist at a
               given time.
        :param pulumi.Input[_builtins.int] max_instance_request_concurrency: Sets the maximum number of concurrent requests that each instance can receive. Defaults to 1.
        :param pulumi.Input[_builtins.int] min_instance_count: The limit on the minimum number of function instances that may coexist at a
               given time.
        ...
        :param pulumi.Input[_builtins.str] uri: (Output)
               URI of the Service deployed.
        :param pulumi.Input[_builtins.str] vpc_connector: The Serverless VPC Access connector that this cloud function can connect to.
        :param pulumi.Input[_builtins.str] vpc_connector_egress_settings: Available egress settings.
               Possible values are: `VPC_CONNECTOR_EGRESS_SETTINGS_UNSPECIFIED`, `PRIVATE_RANGES_ONLY`, `ALL_TRAFFIC`.
        """
...
class FunctionServiceConfigSecretEnvironmentVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] secret: Name of the secret in secret manager (not the full resource name).
        :param pulumi.Input[_builtins.str] version: Version of the secret (version number or the string 'latest'). It is recommended to use a numeric version for secret environment variables as any updates to the secret value is not reflected until new instances start.
        """
...
class FunctionServiceConfigSecretVolumeVersionArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] path: Relative path of the file under the mount path where the secret value for this version will be fetched and made available. For example, setting the mountPath as '/etc/secrets' and path as secret_foo would mount the secret value file at /etc/secrets/secret_foo.
