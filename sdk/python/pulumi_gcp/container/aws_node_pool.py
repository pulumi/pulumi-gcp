...
class AwsNodePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster: The awsCluster for the resource
        ...
        :param pulumi.Input[builtins.str] subnet_id: The subnet where the node pool node run.
        :param pulumi.Input[builtins.str] version: The Kubernetes version to run on this node pool (e.g. `1.19.10-gke.1000`). You can list all supported versions on a given Google Cloud region by calling GetAwsServerConfig.
...
class _AwsNodePoolState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of this resource.
        :param pulumi.Input[builtins.str] project: The project for the resource
        :param pulumi.Input[builtins.bool] reconciling: Output only. If set, there are currently changes in flight to the node pool.
        :param pulumi.Input[builtins.str] state: Output only. The lifecycle state of the node pool. Possible values: STATE_UNSPECIFIED, PROVISIONING, RUNNING, RECONCILING, STOPPING, ERROR, DEGRADED
        :param pulumi.Input[builtins.str] subnet_id: The subnet where the node pool node run.
...
class AwsNodePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_settings: Optional[pulumi.Input[Union['AwsNodePoolUpdateSettingsArgs', 'AwsNodePoolUpdateSettingsArgsDict']]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'AwsNodePool':
        """
