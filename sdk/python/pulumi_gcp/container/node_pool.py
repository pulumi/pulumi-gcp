...
class NodePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster: The cluster to create the node pool for. Cluster must be present in `location` provided for clusters. May be specified in the format `projects/{{project}}/locations/{{location}}/clusters/{{cluster}}` or as just the name of the cluster.
        ...
        :param pulumi.Input[builtins.int] initial_node_count: The initial number of nodes for the pool. In
        ...
        :param pulumi.Input[builtins.str] location: The location (region or zone) of the cluster.
               
               - - -
        :param pulumi.Input['NodePoolManagementArgs'] management: Node management configuration, wherein auto-repair and
               auto-upgrade is configured. Structure is documented below.
        :param pulumi.Input[builtins.int] max_pods_per_node: The maximum number of pods per node in this node pool.
               Note that this does not work on node pools which are "route-based" - that is, node
               pools belonging to clusters that do not have IP Aliasing enabled.
               See the [official documentation](https://cloud.google.com/kubernetes-engine/docs/how-to/flexible-pod-cidr)
               for more information.
        :param pulumi.Input[builtins.str] name: The name of the node pool. If left blank, the provider will
               auto-generate a unique name.
        :param pulumi.Input[builtins.str] name_prefix: Creates a unique name for the node pool beginning
        ...
        :param pulumi.Input[builtins.int] node_count: The number of nodes per instance group. This field can be used to
               update the number of nodes per instance group but should not be used alongside `autoscaling`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] node_locations: The list of zones in which the node pool's nodes should be located. Nodes must
        ...
        :param pulumi.Input['NodePoolPlacementPolicyArgs'] placement_policy: Specifies a custom placement policy for the
               nodes.
        :param pulumi.Input[builtins.str] project: The ID of the project in which to create the node pool. If blank,
...
class NodePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            queued_provisioning: Optional[pulumi.Input[Union['NodePoolQueuedProvisioningArgs', 'NodePoolQueuedProvisioningArgsDict']]] = None,
            upgrade_settings: Optional[pulumi.Input[Union['NodePoolUpgradeSettingsArgs', 'NodePoolUpgradeSettingsArgsDict']]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'NodePool':
        """
    ...
    @property
    @pulumi.getter(name="instanceGroupUrls")
    def instance_group_urls(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The resource URLs of the managed instance groups associated with this node pool.
        """
        return pulumi.get(self, "instance_group_urls")
    ...
    @property
    @pulumi.getter(name="managedInstanceGroupUrls")
    def managed_instance_group_urls(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of instance group URLs which have been assigned to this node pool.
        """
        return pulumi.get(self, "managed_instance_group_urls")
    ...
    @property
    @pulumi.getter(name="maxPodsPerNode")
    def max_pods_per_node(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of pods per node in this node pool.
        Note that this does not work on node pools which are "route-based" - that is, node
        pools belonging to clusters that do not have IP Aliasing enabled.
