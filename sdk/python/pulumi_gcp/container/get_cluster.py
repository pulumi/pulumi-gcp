...
class GetClusterResult:
    ...
    def __init__(__self__, addons_configs=None, allow_net_admin=None, anonymous_authentication_configs=None, authenticator_groups_configs=None, autopilot_cluster_policy_configs=None, autopilot_privileged_admissions=None, binary_authorizations=None, cluster_autoscalings=None, cluster_ipv4_cidr=None, cluster_telemetries=None, confidential_nodes=None, control_plane_endpoints_configs=None, cost_management_configs=None, database_encryptions=None, datapath_provider=None, dataplane_optimization_mode=None, default_max_pods_per_node=None, default_snat_statuses=None, deletion_policy=None, deletion_protection=None, description=None, disable_l4_lb_firewall_reconciliation=None, dns_configs=None, effective_labels=None, enable_autopilot=None, enable_cilium_clusterwide_network_policy=None, enable_fqdn_network_policy=None, enable_intranode_visibility=None, enable_k8s_beta_apis=None, enable_kubernetes_alpha=None, enable_l4_ilb_subsetting=None, enable_legacy_abac=None, enable_multi_networking=None, enable_shielded_nodes=None, enable_tpu=None, endpoint=None, enterprise_configs=None, fleets=None, gateway_api_configs=None, gke_auto_upgrade_configs=None, id=None, identity_service_configs=None, ignore_node_count_changes=None, in_transit_encryption_config=None, initial_node_count=None, ip_allocation_policies=None, label_fingerprint=None, location=None, logging_configs=None, logging_service=None, maintenance_policies=None, managed_machine_learning_diagnostics_configs=None, managed_opentelemetry_configs=None, master_authorized_networks_configs=None, master_auths=None, master_version=None, mesh_certificates=None, min_master_version=None, monitoring_configs=None, monitoring_service=None, name=None, network=None, network_performance_configs=None, network_policies=None, networking_mode=None, node_configs=None, node_creation_configs=None, node_locations=None, node_pool_auto_configs=None, node_pool_defaults=None, node_pools=None, node_version=None, notification_configs=None, operation=None, pod_autoscalings=None, pod_security_policy_configs=None, private_cluster_configs=None, private_ipv6_google_access=None, project=None, protect_configs=None, pulumi_labels=None, rbac_binding_configs=None, release_channels=None, remove_default_node_pool=None, resource_labels=None, resource_usage_export_configs=None, secret_manager_configs=None, secret_sync_configs=None, security_posture_configs=None, self_link=None, service_external_ips_configs=None, services_ipv4_cidr=None, skip_node_pool_refresh=None, subnetwork=None, tpu_configs=None, tpu_ipv4_cidr_block=None, user_managed_keys_configs=None, vertical_pod_autoscalings=None, workload_alts_configs=None, workload_identity_configs=None):
        ...
        if autopilot_cluster_policy_configs and not isinstance(autopilot_cluster_policy_configs, list):
            raise TypeError("Expected argument 'autopilot_cluster_policy_configs' to be a list")
        pulumi.set(__self__, "autopilot_cluster_policy_configs", autopilot_cluster_policy_configs)
        if autopilot_privileged_admissions and not isinstance(autopilot_privileged_admissions, list):
            raise TypeError("Expected argument 'autopilot_privileged_admissions' to be a list")
        ...
        if managed_machine_learning_diagnostics_configs and not isinstance(managed_machine_learning_diagnostics_configs, list):
            raise TypeError("Expected argument 'managed_machine_learning_diagnostics_configs' to be a list")
        pulumi.set(__self__, "managed_machine_learning_diagnostics_configs", managed_machine_learning_diagnostics_configs)
        ...
        if node_creation_configs and not isinstance(node_creation_configs, list):
            raise TypeError("Expected argument 'node_creation_configs' to be a list")
        pulumi.set(__self__, "node_creation_configs", node_creation_configs)
        ...
        if secret_sync_configs and not isinstance(secret_sync_configs, list):
            raise TypeError("Expected argument 'secret_sync_configs' to be a list")
        pulumi.set(__self__, "secret_sync_configs", secret_sync_configs)
    ...
    @_builtins.property
    @pulumi.getter(name="autopilotClusterPolicyConfigs")
    def autopilot_cluster_policy_configs(self) -> Sequence['outputs.GetClusterAutopilotClusterPolicyConfigResult']:
        return pulumi.get(self, "autopilot_cluster_policy_configs")

    @_builtins.property
    @pulumi.getter(name="autopilotPrivilegedAdmissions")
    def autopilot_privileged_admissions(self) -> Sequence[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter(name="managedMachineLearningDiagnosticsConfigs")
    def managed_machine_learning_diagnostics_configs(self) -> Sequence['outputs.GetClusterManagedMachineLearningDiagnosticsConfigResult']:
        return pulumi.get(self, "managed_machine_learning_diagnostics_configs")
    ...
    @_builtins.property
    @pulumi.getter(name="nodeCreationConfigs")
    def node_creation_configs(self) -> Sequence['outputs.GetClusterNodeCreationConfigResult']:
        return pulumi.get(self, "node_creation_configs")
    ...
    def secret_sync_configs(self) -> Sequence['outputs.GetClusterSecretSyncConfigResult']:
        return pulumi.get(self, "secret_sync_configs")
...
class AwaitableGetClusterResult(GetClusterResult):
    ...
    def __await__(self):
        ...
        return GetClusterResult(
            ...
            autopilot_cluster_policy_configs=self.autopilot_cluster_policy_configs,
            autopilot_privileged_admissions=self.autopilot_privileged_admissions,
            ...
            managed_machine_learning_diagnostics_configs=self.managed_machine_learning_diagnostics_configs,
            ...
            node_creation_configs=self.node_creation_configs,
...
def get_cluster(location: Optional[_builtins.str] = None,
    ...
    return AwaitableGetClusterResult(
        ...
        autopilot_cluster_policy_configs=pulumi.get(__ret__, 'autopilot_cluster_policy_configs'),
        autopilot_privileged_admissions=pulumi.get(__ret__, 'autopilot_privileged_admissions'),
        ...
        managed_machine_learning_diagnostics_configs=pulumi.get(__ret__, 'managed_machine_learning_diagnostics_configs'),
        ...
        node_creation_configs=pulumi.get(__ret__, 'node_creation_configs'),
...
def get_cluster_output(location: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetClusterResult(
        ...
        autopilot_cluster_policy_configs=pulumi.get(__response__, 'autopilot_cluster_policy_configs'),
        autopilot_privileged_admissions=pulumi.get(__response__, 'autopilot_privileged_admissions'),
        ...
        managed_machine_learning_diagnostics_configs=pulumi.get(__response__, 'managed_machine_learning_diagnostics_configs'),
        ...
        node_creation_configs=pulumi.get(__response__, 'node_creation_configs'),
