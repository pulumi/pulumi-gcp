...
def get_registry_repository(project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project: The project ID that this repository is attached to.  If not provided, provider project will be used instead.
...
def get_registry_repository_output(project: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
