...
def get_attached_install_manifest(cluster_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_id: The name that will be used when creating the attached cluster resource.
    :param _builtins.str location: The location to list versions for.
    :param _builtins.str platform_version: The platform version for the cluster. A list of valid values can be retrieved using the `container_get_attached_versions` data source.
    :param _builtins.str project: ID of the project to list available platform versions for. Should match the project the cluster will be deployed to.
