...
def get_attached_install_manifest(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: The name that will be used when creating the attached cluster resource.
    :param builtins.str location: The location to list versions for.
    :param builtins.str platform_version: The platform version for the cluster. A list of valid values can be retrieved using the `container_get_attached_versions` data source.
...
def get_attached_install_manifest_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
