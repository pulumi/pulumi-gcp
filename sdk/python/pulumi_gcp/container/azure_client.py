...
class AzureClientArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: The Azure Active Directory Application ID.
...
class _AzureClientState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: The Azure Active Directory Application ID.
        :param pulumi.Input[builtins.str] certificate: Output only. The PEM encoded x509 certificate.
        :param pulumi.Input[builtins.str] create_time: Output only. The time at which this resource was created.
        :param pulumi.Input[builtins.str] location: The location for the resource
        :param pulumi.Input[builtins.str] name: The name of this resource.
        :param pulumi.Input[builtins.str] project: The project for the resource
        :param pulumi.Input[builtins.str] tenant_id: The Azure Active Directory Tenant ID.
               ...
               - - -
        :param pulumi.Input[builtins.str] uid: Output only. A globally unique identifier for the client.
        """
...
class AzureClient(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None) -> 'AzureClient':
        """
