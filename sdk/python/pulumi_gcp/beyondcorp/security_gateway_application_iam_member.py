...
__all__ = ['SecurityGatewayApplicationIamMemberArgs', 'SecurityGatewayApplicationIamMember']
...
class SecurityGatewayApplicationIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['SecurityGatewayApplicationIamMemberConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] security_gateway_id: ID of the Security Gateway resource this belongs to. Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input['SecurityGatewayApplicationIamMemberConditionArgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['SecurityGatewayApplicationIamMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['SecurityGatewayApplicationIamMemberConditionArgs']]):
...
@pulumi.input_type
class _SecurityGatewayApplicationIamMemberState:
    def __init__(__self__, *,
...
@pulumi.type_token("gcp:beyondcorp/securityGatewayApplicationIamMember:SecurityGatewayApplicationIamMember")
class SecurityGatewayApplicationIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 application_id: pulumi.Input[Optional[_builtins.str]] = None,
                 condition: pulumi.Input[Optional[Union['SecurityGatewayApplicationIamMemberConditionArgs', 'SecurityGatewayApplicationIamMemberConditionArgsDict', 'outputs.SecurityGatewayApplicationIamMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 security_gateway_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * {{application_id}}
        ...
        :param pulumi.Input[_builtins.str] application_id: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[Union['SecurityGatewayApplicationIamMemberConditionArgs', 'SecurityGatewayApplicationIamMemberConditionArgsDict', 'outputs.SecurityGatewayApplicationIamMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **allUsers**: A special identifier that represents anyone who is on the internet; with or without a Google account.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SecurityGatewayApplicationIamMemberArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Three different resources help you manage your IAM policy for BeyondCorp SecurityGatewayApplication. Each of these resources serves a different use case:
        ...
        * {{application_id}}
        ...
        :param str resource_name: The name of the resource.
        :param SecurityGatewayApplicationIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SecurityGatewayApplicationIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SecurityGatewayApplicationIamMemberArgs.__new__(SecurityGatewayApplicationIamMemberArgs)
        ...
        super(SecurityGatewayApplicationIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            security_gateway_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'SecurityGatewayApplicationIamMember':
        """
        ...
        __props__ = _SecurityGatewayApplicationIamMemberState.__new__(_SecurityGatewayApplicationIamMemberState)
        ...
        __props__.__dict__["role"] = role
        __props__.__dict__["security_gateway_id"] = security_gateway_id
        return SecurityGatewayApplicationIamMember(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.SecurityGatewayApplicationIamMemberCondition']]:
        """
        An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        Structure is documented below.
        """
