...
def get_app_gateway(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the App Gateway.
...
def get_app_gateway_output(name: Optional[pulumi.Input[builtins.str]] = None,
