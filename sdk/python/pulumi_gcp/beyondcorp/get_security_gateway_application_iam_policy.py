...
def get_security_gateway_application_iam_policy(application_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str security_gateway_id: ID of the Security Gateway resource this belongs to. Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
