...
def get_app_connector(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the App Connector.
...
def get_app_connector_output(name: Optional[pulumi.Input[builtins.str]] = None,
