...
__all__ = ['SecurityGatewayApplicationIamBindingArgs', 'SecurityGatewayApplicationIamBinding']
...
class SecurityGatewayApplicationIamBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SecurityGatewayApplicationIamBindingConditionArgs'] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
...
@pulumi.type_token("gcp:beyondcorp/securityGatewayApplicationIamBinding:SecurityGatewayApplicationIamBinding")
class SecurityGatewayApplicationIamBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: SecurityGatewayApplicationIamBindingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Three different resources help you manage your IAM policy for BeyondCorp SecurityGatewayApplication. Each of these resources serves a different use case:
        ...
        * {{application_id}}
        ...
        :param str resource_name: The name of the resource.
        :param SecurityGatewayApplicationIamBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SecurityGatewayApplicationIamBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SecurityGatewayApplicationIamBindingArgs.__new__(SecurityGatewayApplicationIamBindingArgs)
        ...
        super(SecurityGatewayApplicationIamBinding, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            security_gateway_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SecurityGatewayApplicationIamBinding':
        """
        ...
        __props__ = _SecurityGatewayApplicationIamBindingState.__new__(_SecurityGatewayApplicationIamBindingState)
        ...
        __props__.__dict__["role"] = role
        __props__.__dict__["security_gateway_id"] = security_gateway_id
        return SecurityGatewayApplicationIamBinding(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def condition(self) -> pulumi.Output[Optional['outputs.SecurityGatewayApplicationIamBindingCondition']]:
        """
        An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        Structure is documented below.
        """
