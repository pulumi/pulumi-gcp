...
class AppGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: An arbitrary user-provided name for the AppGateway.
        :param pulumi.Input[builtins.str] host_type: The type of hosting used by the AppGateway.
        ...
        :param pulumi.Input[builtins.str] type: The type of network connectivity used by the AppGateway.
...
class _AppGatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] region: The region of the AppGateway.
        :param pulumi.Input[builtins.str] state: Represents the different states of a AppGateway.
        :param pulumi.Input[builtins.str] type: The type of network connectivity used by the AppGateway.
               Default value is `TYPE_UNSPECIFIED`.
               Possible values are: `TYPE_UNSPECIFIED`, `TCP_PROXY`.
        :param pulumi.Input[builtins.str] uri: Server-defined URI for this resource.
        """
...
class AppGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'AppGateway':
        """
