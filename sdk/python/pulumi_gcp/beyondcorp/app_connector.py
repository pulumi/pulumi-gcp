...
class _AppConnectorState:
    def __init__(__self__, *,
                 ...
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 principal_info: pulumi.Input[Optional['AppConnectorPrincipalInfoArgs']] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="principalInfo")
    def principal_info(self) -> pulumi.Input[Optional['AppConnectorPrincipalInfoArgs']]:
        """
        Principal information about the Identity of the AppConnector.
        Structure is documented below.
        """
    ...
    @principal_info.setter
    def principal_info(self, value: pulumi.Input[Optional['AppConnectorPrincipalInfoArgs']]):
        pulumi.set(self, "principal_info", value)
...
class AppConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None) -> 'AppConnector':
        """
