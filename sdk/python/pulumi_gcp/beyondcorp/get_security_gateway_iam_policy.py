...
def get_security_gateway_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122. Must be omitted or set to `global`. Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    :param _builtins.str security_gateway_id: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_security_gateway_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
