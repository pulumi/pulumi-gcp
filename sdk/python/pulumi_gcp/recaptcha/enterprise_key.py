...
class EnterpriseKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: Human-readable display name of this key. Modifiable by user.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: See [Creating and managing labels](https://cloud.google.com/recaptcha-enterprise/docs/labels).
...
class _EnterpriseKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['EnterpriseKeyAndroidSettingsArgs'] android_settings: Settings for keys that can be used by Android apps.
        :param pulumi.Input[builtins.str] create_time: The timestamp corresponding to the creation of this Key.
        :param pulumi.Input[builtins.str] display_name: Human-readable display name of this key. Modifiable by user.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: See [Creating and managing labels](https://cloud.google.com/recaptcha-enterprise/docs/labels).
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] name: The resource id for the Key, which is the same as the Site Key itself.
        :param pulumi.Input[builtins.str] project: The project for the resource
