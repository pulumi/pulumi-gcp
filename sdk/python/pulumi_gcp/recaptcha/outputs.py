...
class EnterpriseKeyAndroidSettings(dict):
    ...
    def __init__(__self__, *,
                 allow_all_package_names: Optional[builtins.bool] = None,
                 allowed_package_names: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool allow_all_package_names: If set to true, it means allowed_package_names will not be enforced.
        :param Sequence[builtins.str] allowed_package_names: Android package names of apps allowed to use the key. Example: 'com.companyname.appname'
        """
    ...
    def allow_all_package_names(self) -> Optional[builtins.bool]:
        """
    ...
    def allowed_package_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class EnterpriseKeyIosSettings(dict):
    ...
    def __init__(__self__, *,
                 allow_all_bundle_ids: Optional[builtins.bool] = None,
                 allowed_bundle_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool allow_all_bundle_ids: If set to true, it means allowed_bundle_ids will not be enforced.
        :param Sequence[builtins.str] allowed_bundle_ids: iOS bundle ids of apps allowed to use the key. Example: 'com.companyname.productname.appname'
        """
    ...
    def allow_all_bundle_ids(self) -> Optional[builtins.bool]:
        """
    ...
    def allowed_bundle_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class EnterpriseKeyTestingOptions(dict):
    ...
    def __init__(__self__, *,
                 testing_challenge: Optional[builtins.str] = None,
                 testing_score: Optional[builtins.float] = None):
        """
        :param builtins.str testing_challenge: For challenge-based keys only (CHECKBOX, INVISIBLE), all challenge requests for this site will return nocaptcha if NOCAPTCHA, or an unsolvable challenge if UNSOLVABLE_CHALLENGE. Possible values: TESTING_CHALLENGE_UNSPECIFIED, NOCAPTCHA, UNSOLVABLE_CHALLENGE
        :param builtins.float testing_score: All assessments for this Key will return this score. Must be between 0 (likely not legitimate) and 1 (likely legitimate) inclusive.
        """
    ...
    def testing_challenge(self) -> Optional[builtins.str]:
        """
    ...
    def testing_score(self) -> Optional[builtins.float]:
        """
...
class EnterpriseKeyWafSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str waf_feature: Supported WAF features. For more information, see https://cloud.google.com/recaptcha-enterprise/docs/usecase#comparison_of_features. Possible values: CHALLENGE_PAGE, SESSION_TOKEN, ACTION_TOKEN, EXPRESS
        :param builtins.str waf_service: The WAF service that uses this key. Possible values: CA, FASTLY
        """
...
class EnterpriseKeyWebSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_all_domains: Optional[builtins.bool] = None,
                 allow_amp_traffic: Optional[builtins.bool] = None,
                 allowed_domains: Optional[Sequence[builtins.str]] = None,
                 challenge_security_preference: Optional[builtins.str] = None):
        """
        :param builtins.str integration_type: Required. Describes how this key is integrated with the website. Possible values: SCORE, CHECKBOX, INVISIBLE
        :param builtins.bool allow_all_domains: If set to true, it means allowed_domains will not be enforced.
        :param builtins.bool allow_amp_traffic: If set to true, the key can be used on AMP (Accelerated Mobile Pages) websites. This is supported only for the SCORE integration type.
        :param Sequence[builtins.str] allowed_domains: Domains or subdomains of websites allowed to use the key. All subdomains of an allowed domain are automatically allowed. A valid domain requires a host and must not include any path, port, query or fragment. Examples: 'example.com' or 'subdomain.example.com'
        :param builtins.str challenge_security_preference: Settings for the frequency and difficulty at which this key triggers captcha challenges. This should only be specified for IntegrationTypes CHECKBOX and INVISIBLE. Possible values: CHALLENGE_SECURITY_PREFERENCE_UNSPECIFIED, USABILITY, BALANCE, SECURITY
        """
    ...
    def allow_all_domains(self) -> Optional[builtins.bool]:
        """
    ...
    def allow_amp_traffic(self) -> Optional[builtins.bool]:
        """
    ...
    def challenge_security_preference(self) -> Optional[builtins.str]:
        """
