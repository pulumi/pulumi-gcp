...
class ClusterAuthorizationAdminUsers(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str username: An active Google username.
        """
...
class ClusterControlPlaneEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_active_version: Optional[_builtins.str] = None,
        ...
        """
        :param _builtins.str kms_key: The Cloud KMS CryptoKey e.g.
               projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}
               to use for protecting control plane disks. If not specified, a
               Google-managed key will be used instead.
        :param _builtins.str kms_key_active_version: (Output)
               The Cloud KMS CryptoKeyVersion currently in use for protecting control
               plane disks. Only applicable if kms_key is set.
        :param _builtins.str kms_key_state: (Output)
...
class ClusterControlPlaneEncryptionKmsStatus(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str message: A developer-facing error message, which should be in English. Any user-facing error message should be localized and sent in the google.rpc.Status.details field, or localized by the client.
        """
        if code is not None:
...
class ClusterControlPlaneLocal(dict):
    ...
    def __init__(__self__, *,
                 machine_filter: Optional[_builtins.str] = None,
                 node_count: Optional[_builtins.int] = None,
                 node_location: Optional[_builtins.str] = None,
                 shared_deployment_policy: Optional[_builtins.str] = None):
        """
        :param _builtins.str machine_filter: Only machines matching this filter will be allowed to host control
               plane nodes. The filtering language accepts strings like "name=<name>",
               and is documented here: [AIP-160](https://google.aip.dev/160).
        :param _builtins.int node_count: The number of nodes to serve as replicas of the Control Plane.
               Only 1 and 3 are supported.
        :param _builtins.str node_location: Name of the Google Distributed Cloud Edge zones where this node pool
               will be created. For example: `us-central1-edge-customer-a`.
        :param _builtins.str shared_deployment_policy: Policy configuration about how user applications are deployed.
...
class ClusterMaintenanceEvent(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str operation: (Output)
               ...
               one is recorded.
        :param _builtins.str schedule: (Output)
        ...
        :param _builtins.str target_version: The target cluster version. For example: "1.5.0".
        :param _builtins.str type: (Output)
               Indicates the maintenance event type.
        :param _builtins.str update_time: (Output)
               The time when the maintenance event message was updated.
        :param _builtins.str uuid: (Output)
...
class ClusterMaintenancePolicyMaintenanceExclusion(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: A unique (per cluster) id for the window.
...
class ClusterMaintenancePolicyMaintenanceExclusionWindow(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_time: Optional[_builtins.str] = None):
        """
        :param _builtins.str end_time: The time that the window ends. The end time must take place after the
               start time.
        :param _builtins.str start_time: The time that the window first starts.
        """
        if end_time is not None:
            pulumi.set(__self__, "end_time", end_time)
        if start_time is not None:
...
class ClusterMaintenancePolicyWindowRecurringWindow(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str recurrence: An RRULE (https://tools.ietf.org/html/rfc5545#section-3.8.5.3) for how
...
class ClusterNetworking(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cluster_ipv6_cidr_blocks: Optional[Sequence[_builtins.str]] = None,
                 network_type: Optional[_builtins.str] = None,
                 services_ipv6_cidr_blocks: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] cluster_ipv4_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these
               blocks. Only a single block is supported. This field cannot be changed
               after creation.
        :param Sequence[_builtins.str] services_ipv4_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address from these
               blocks. Only a single block is supported. This field cannot be changed
               after creation.
        :param Sequence[_builtins.str] cluster_ipv6_cidr_blocks: If specified, dual stack mode is enabled and all pods in the cluster are
               assigned an IPv6 address from these blocks alongside from an IPv4
               address. Only a single block is supported. This field cannot be changed
               after creation.
        :param _builtins.str network_type: (Output)
               IP addressing type of this cluster i.e. SINGLESTACK_V4 vs DUALSTACK_V4_V6.
        :param Sequence[_builtins.str] services_ipv6_cidr_blocks: If specified, dual stack mode is enabled and all services in the cluster are
               assigned an IPv6 address from these blocks alongside from an IPv4
               address. Only a single block is supported. This field cannot be changed
               after creation.
        """
...
class ClusterSystemAddonsConfigIngress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ipv4_vip: Optional[_builtins.str] = None):
        """
        :param _builtins.bool disabled: Whether Ingress is disabled.
        :param _builtins.str ipv4_vip: Ingress VIP.
        """
...
class NodePoolLocalDiskEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_state: Optional[_builtins.str] = None):
        """
        :param _builtins.str kms_key: The Cloud KMS CryptoKey e.g. projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey} to use for protecting node local disks.
...
class NodePoolNodeConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, _builtins.str] labels: "The Kubernetes node labels"
        """
...
class VpnConnectionDetailCloudRouter(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The resource name of VPN connection
        """
        if name is not None:
...
class VpnConnectionDetailCloudVpn(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str gateway: (Output)
...
class VpnConnectionVpcProject(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str project_id: The project of the VPC to connect to. If not specified, it is the same as the cluster project.
        """
