...
class ClusterAuthorizationAdminUsersArgs:
    def __init__(__self__, *,
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] username: An active Google username.
        """
...
class ClusterControlPlaneEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key: The Cloud KMS CryptoKey e.g.
               ...
               to use for protecting control plane disks. If not specified, a
               Google-managed key will be used instead.
        :param pulumi.Input[_builtins.str] kms_key_active_version: (Output)
               The Cloud KMS CryptoKeyVersion currently in use for protecting control
               plane disks. Only applicable if kms_key is set.
        :param pulumi.Input[_builtins.str] kms_key_state: (Output)
               Availability of the Cloud KMS CryptoKey. If not `KEY_AVAILABLE`, then
               nodes may go offline as they cannot access their local data. This can be
               caused by a lack of permissions to use the key, or if the key is disabled
               or deleted.
...
class ClusterControlPlaneLocalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] machine_filter: Only machines matching this filter will be allowed to host control
               plane nodes. The filtering language accepts strings like "name=<name>",
               and is documented here: [AIP-160](https://google.aip.dev/160).
        :param pulumi.Input[_builtins.int] node_count: The number of nodes to serve as replicas of the Control Plane.
               Only 1 and 3 are supported.
        :param pulumi.Input[_builtins.str] node_location: Name of the Google Distributed Cloud Edge zones where this node pool
               will be created. For example: `us-central1-edge-customer-a`.
        :param pulumi.Input[_builtins.str] shared_deployment_policy: Policy configuration about how user applications are deployed.
               Possible values are: `SHARED_DEPLOYMENT_POLICY_UNSPECIFIED`, `ALLOWED`, `DISALLOWED`.
        """
...
class ClusterMaintenancePolicyMaintenanceExclusionWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] end_time: The time that the window ends. The end time must take place after the
               start time.
        :param pulumi.Input[_builtins.str] start_time: The time that the window first starts.
        """
        if end_time is not None:
            pulumi.set(__self__, "end_time", end_time)
        if start_time is not None:
...
class ClusterNetworkingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cluster_ipv4_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these
               blocks. Only a single block is supported. This field cannot be changed
               after creation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] services_ipv4_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address from these
               blocks. Only a single block is supported. This field cannot be changed
               after creation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cluster_ipv6_cidr_blocks: If specified, dual stack mode is enabled and all pods in the cluster are
               assigned an IPv6 address from these blocks alongside from an IPv4
               address. Only a single block is supported. This field cannot be changed
               after creation.
        :param pulumi.Input[_builtins.str] network_type: (Output)
               IP addressing type of this cluster i.e. SINGLESTACK_V4 vs DUALSTACK_V4_V6.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] services_ipv6_cidr_blocks: If specified, dual stack mode is enabled and all services in the cluster are
               assigned an IPv6 address from these blocks alongside from an IPv4
               address. Only a single block is supported. This field cannot be changed
               after creation.
        """
    ...
    def cluster_ipv4_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        All pods in the cluster are assigned an RFC1918 IPv4 address from these
        blocks. Only a single block is supported. This field cannot be changed
        after creation.
    ...
    def cluster_ipv4_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "cluster_ipv4_cidr_blocks", value)

    @_builtins.property
    @pulumi.getter(name="servicesIpv4CidrBlocks")
    def services_ipv4_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        All services in the cluster are assigned an RFC1918 IPv4 address from these
        blocks. Only a single block is supported. This field cannot be changed
        after creation.
    ...
    def services_ipv4_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class VpnConnectionDetailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VpnConnectionDetailCloudVpnArgs']]] cloud_vpns: (Output)
               Each connection has multiple Cloud VPN gateways.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] error: (Output)
               The error message. This is only populated when state=ERROR.
        :param pulumi.Input[_builtins.str] state: (Output)
               The current connection state.
        """
