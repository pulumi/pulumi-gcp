...
if not MYPY:
    class ClusterControlPlaneEncryptionArgsDict(TypedDict):
        ...
        """
        kms_key_active_version: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class ClusterControlPlaneEncryptionArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_active_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key: The Cloud KMS CryptoKey e.g.
               projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}
               to use for protecting control plane disks. If not specified, a
               Google-managed key will be used instead.
        :param pulumi.Input[builtins.str] kms_key_active_version: (Output)
               The Cloud KMS CryptoKeyVersion currently in use for protecting control
               plane disks. Only applicable if kms_key is set.
        :param pulumi.Input[builtins.str] kms_key_state: (Output)
               Availability of the Cloud KMS CryptoKey. If not `KEY_AVAILABLE`, then
               nodes may go offline as they cannot access their local data. This can be
               caused by a lack of permissions to use the key, or if the key is disabled
               or deleted.
    ...
    def kms_key_active_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The Cloud KMS CryptoKeyVersion currently in use for protecting control
        plane disks. Only applicable if kms_key is set.
    ...
    def kms_key_active_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterControlPlaneEncryptionKmsStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] message: A developer-facing error message, which should be in English. Any user-facing error message should be localized and sent in the google.rpc.Status.details field, or localized by the client.
        """
        if code is not None:
...
if not MYPY:
    class ClusterControlPlaneLocalArgsDict(TypedDict):
        machine_filter: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        node_location: NotRequired[pulumi.Input[builtins.str]]
        """
        Name of the Google Distributed Cloud Edge zones where this node pool
        will be created. For example: `us-central1-edge-customer-a`.
        """
        shared_deployment_policy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterControlPlaneLocalArgs:
    def __init__(__self__, *,
                 ...
                 shared_deployment_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] machine_filter: Only machines matching this filter will be allowed to host control
               plane nodes. The filtering language accepts strings like "name=<name>",
               and is documented here: [AIP-160](https://google.aip.dev/160).
        :param pulumi.Input[builtins.int] node_count: The number of nodes to serve as replicas of the Control Plane.
               Only 1 and 3 are supported.
        :param pulumi.Input[builtins.str] node_location: Name of the Google Distributed Cloud Edge zones where this node pool
               will be created. For example: `us-central1-edge-customer-a`.
        :param pulumi.Input[builtins.str] shared_deployment_policy: Policy configuration about how user applications are deployed.
               Possible values are: `SHARED_DEPLOYMENT_POLICY_UNSPECIFIED`, `ALLOWED`, `DISALLOWED`.
        """
    ...
    def shared_deployment_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Policy configuration about how user applications are deployed.
        Possible values are: `SHARED_DEPLOYMENT_POLICY_UNSPECIFIED`, `ALLOWED`, `DISALLOWED`.
        """
    ...
    def shared_deployment_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterMaintenanceEventArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] end_time: (Output)
               ...
               the maintenance event is split into multiple maintenance windows,
               end_time is only updated when the whole flow ends.
        :param pulumi.Input[builtins.str] operation: (Output)
               The operation for running the maintenance event. Specified in the format
               projects/*/locations/*/operations/*. If the maintenance event is split
               into multiple operations (e.g. due to maintenance windows), the latest
               one is recorded.
        :param pulumi.Input[builtins.str] schedule: (Output)
               The schedule of the maintenance event.
        ...
        :param pulumi.Input[builtins.str] update_time: (Output)
               The time when the maintenance event message was updated.
        :param pulumi.Input[builtins.str] uuid: (Output)
               UUID of the maintenance event.
        """
...
class ClusterMaintenancePolicyMaintenanceExclusionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: A unique (per cluster) id for the window.
...
class ClusterMaintenancePolicyMaintenanceExclusionWindowArgs:
    def __init__(__self__, *,
                 ...
                 start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] end_time: The time that the window ends. The end time must take place after the
               start time.
        :param pulumi.Input[builtins.str] start_time: The time that the window first starts.
        """
        if end_time is not None:
            pulumi.set(__self__, "end_time", end_time)
        if start_time is not None:
...
if not MYPY:
    class ClusterMaintenancePolicyWindowRecurringWindowArgsDict(TypedDict):
        recurrence: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterMaintenancePolicyWindowRecurringWindowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] recurrence: An RRULE (https://tools.ietf.org/html/rfc5545#section-3.8.5.3) for how
               this window recurs. They go on for the span of time between the start and
               end time.
...
if not MYPY:
    class ClusterNetworkingArgsDict(TypedDict):
        cluster_ipv4_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        All pods in the cluster are assigned an RFC1918 IPv4 address from these
        blocks. Only a single block is supported. This field cannot be changed
        after creation.
        """
        services_ipv4_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        All services in the cluster are assigned an RFC1918 IPv4 address from these
        blocks. Only a single block is supported. This field cannot be changed
        after creation.
        """
        cluster_ipv6_cidr_blocks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        services_ipv6_cidr_blocks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ClusterNetworkingArgs:
    def __init__(__self__, *,
                 cluster_ipv4_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 services_ipv4_cidr_blocks: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 cluster_ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 network_type: Optional[pulumi.Input[builtins.str]] = None,
                 services_ipv6_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cluster_ipv4_cidr_blocks: All pods in the cluster are assigned an RFC1918 IPv4 address from these
               blocks. Only a single block is supported. This field cannot be changed
               after creation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services_ipv4_cidr_blocks: All services in the cluster are assigned an RFC1918 IPv4 address from these
               blocks. Only a single block is supported. This field cannot be changed
               after creation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cluster_ipv6_cidr_blocks: If specified, dual stack mode is enabled and all pods in the cluster are
               assigned an IPv6 address from these blocks alongside from an IPv4
               address. Only a single block is supported. This field cannot be changed
               after creation.
        :param pulumi.Input[builtins.str] network_type: (Output)
               IP addressing type of this cluster i.e. SINGLESTACK_V4 vs DUALSTACK_V4_V6.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services_ipv6_cidr_blocks: If specified, dual stack mode is enabled and all services in the cluster are
               assigned an IPv6 address from these blocks alongside from an IPv4
               address. Only a single block is supported. This field cannot be changed
               after creation.
        """
    ...
    def cluster_ipv4_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        All pods in the cluster are assigned an RFC1918 IPv4 address from these
        blocks. Only a single block is supported. This field cannot be changed
        after creation.
    ...
    def cluster_ipv4_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "cluster_ipv4_cidr_blocks", value)

    @property
    @pulumi.getter(name="servicesIpv4CidrBlocks")
    def services_ipv4_cidr_blocks(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        All services in the cluster are assigned an RFC1918 IPv4 address from these
        blocks. Only a single block is supported. This field cannot be changed
        after creation.
    ...
    def services_ipv4_cidr_blocks(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "services_ipv4_cidr_blocks", value)

    @property
    @pulumi.getter(name="clusterIpv6CidrBlocks")
    def cluster_ipv6_cidr_blocks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        If specified, dual stack mode is enabled and all pods in the cluster are
        assigned an IPv6 address from these blocks alongside from an IPv4
        address. Only a single block is supported. This field cannot be changed
    ...
    def cluster_ipv6_cidr_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def services_ipv6_cidr_blocks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        If specified, dual stack mode is enabled and all services in the cluster are
        assigned an IPv6 address from these blocks alongside from an IPv4
        address. Only a single block is supported. This field cannot be changed
    ...
    def services_ipv6_cidr_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ClusterSystemAddonsConfigIngressArgsDict(TypedDict):
        ...
        """
        ipv4_vip: NotRequired[pulumi.Input[builtins.str]]
        """
        Ingress VIP.
        """
elif False:
...
class ClusterSystemAddonsConfigIngressArgs:
    def __init__(__self__, *,
                 ...
                 ipv4_vip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] disabled: Whether Ingress is disabled.
        :param pulumi.Input[builtins.str] ipv4_vip: Ingress VIP.
        """
    ...
    def ipv4_vip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Ingress VIP.
        """
    ...
    @ipv4_vip.setter
    def ipv4_vip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NodePoolLocalDiskEncryptionArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] kms_key: The Cloud KMS CryptoKey e.g. projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey} to use for protecting node local disks.
               If not specified, a Google-managed key will be used instead.
        :param pulumi.Input[builtins.str] kms_key_active_version: (Output)
               The Cloud KMS CryptoKeyVersion currently in use for protecting node local disks. Only applicable if kmsKey is set.
        :param pulumi.Input[builtins.str] kms_key_state: (Output)
...
class NodePoolNodeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: "The Kubernetes node labels"
        """
...
class VpnConnectionDetailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VpnConnectionDetailCloudVpnArgs']]] cloud_vpns: (Output)
               Each connection has multiple Cloud VPN gateways.
               Structure is documented below.
        :param pulumi.Input[builtins.str] error: (Output)
               The error message. This is only populated when state=ERROR.
        :param pulumi.Input[builtins.str] state: (Output)
               The current connection state.
        """
...
class VpnConnectionDetailCloudVpnArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] gateway: (Output)
               The created Cloud VPN gateway name.
        """
...
class VpnConnectionVpcProjectArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] project_id: The project of the VPC to connect to. If not specified, it is the same as the cluster project.
        """
