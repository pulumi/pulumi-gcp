...
__all__ = [
    ...
    'SearchEngineIamBindingConditionArgsDict',
    'SearchEngineIamMemberConditionArgs',
    'SearchEngineIamMemberConditionArgsDict',
    ...
    'SearchEngineKnowledgeGraphConfigFeatureConfigArgsDict',
...
class AclConfigIdpConfigArgsDict(TypedDict):
    ...
    """
    idp_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class AclConfigIdpConfigArgs:
    def __init__(__self__, *,
                 external_idp_config: pulumi.Input[Optional['AclConfigIdpConfigExternalIdpConfigArgs']] = None,
    ...
    def external_idp_config(self) -> pulumi.Input[Optional['AclConfigIdpConfigExternalIdpConfigArgs']]:
        """
        External third party identity provider config.
        Structure is documented below.
        """
    ...
    def external_idp_config(self, value: pulumi.Input[Optional['AclConfigIdpConfigExternalIdpConfigArgs']]):
...
class AclConfigIdpConfigExternalIdpConfigArgsDict(TypedDict):
    workforce_pool_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class AclConfigIdpConfigExternalIdpConfigArgs:
    def __init__(__self__, *,
                 workforce_pool_name: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def workforce_pool_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Workforce pool name: "locations/global/workforcePools/pool_id"
        """
    ...
    def workforce_pool_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class AssistantCustomerPolicyArgs:
    def __init__(__self__, *,
                 banned_phrases: pulumi.Input[Optional[Sequence[pulumi.Input['AssistantCustomerPolicyBannedPhraseArgs']]]] = None,
                 model_armor_config: pulumi.Input[Optional['AssistantCustomerPolicyModelArmorConfigArgs']] = None):
        """
    ...
    def banned_phrases(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AssistantCustomerPolicyBannedPhraseArgs']]]]:
        """
        List of banned phrases.
        Structure is documented below.
        """
    ...
    def banned_phrases(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AssistantCustomerPolicyBannedPhraseArgs']]]]):
        pulumi.set(self, "banned_phrases", value)

    @_builtins.property
    @pulumi.getter(name="modelArmorConfig")
    def model_armor_config(self) -> pulumi.Input[Optional['AssistantCustomerPolicyModelArmorConfigArgs']]:
        """
        Model Armor configuration to be used for sanitizing user prompts and assistant responses.
        Structure is documented below.
        """
    ...
    def model_armor_config(self, value: pulumi.Input[Optional['AssistantCustomerPolicyModelArmorConfigArgs']]):
...
class AssistantCustomerPolicyBannedPhraseArgsDict(TypedDict):
    ...
    """
    ignore_diacritics: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class AssistantCustomerPolicyBannedPhraseArgs:
    def __init__(__self__, *,
                 phrase: pulumi.Input[_builtins.str],
                 ignore_diacritics: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def ignore_diacritics(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true, diacritical marks (e.g., accents, umlauts) are ignored when
        matching banned phrases. For example, "cafe" would match "café".
        """
    ...
    def ignore_diacritics(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class AssistantCustomerPolicyModelArmorConfigArgsDict(TypedDict):
    ...
    """
    failure_mode: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class AssistantGenerationConfigArgs:
    def __init__(__self__, *,
                 ...
                 system_instruction: pulumi.Input[Optional['AssistantGenerationConfigSystemInstructionArgs']] = None):
        """
    ...
    def system_instruction(self) -> pulumi.Input[Optional['AssistantGenerationConfigSystemInstructionArgs']]:
        """
        System instruction, also known as the prompt preamble for LLM calls.
        See also https://cloud.google.com/vertex-ai/generative-ai/docs/learn/prompts/system-instructions
        Structure is documented below.
    ...
    def system_instruction(self, value: pulumi.Input[Optional['AssistantGenerationConfigSystemInstructionArgs']]):
        pulumi.set(self, "system_instruction", value)


class AssistantGenerationConfigSystemInstructionArgsDict(TypedDict):
    additional_system_instruction: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class AssistantGenerationConfigSystemInstructionArgs:
    def __init__(__self__, *,
                 additional_system_instruction: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def additional_system_instruction(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Additional system instruction that will be added to the default system instruction.
        """
    ...
    def additional_system_instruction(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ChatEngineChatEngineConfigArgsDict(TypedDict):
    ...
    Structure is documented below.
    """
    allow_cross_region: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    creation.
    """
    dialogflow_agent_to_link: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ChatEngineChatEngineConfigArgs:
    def __init__(__self__, *,
                 agent_creation_config: pulumi.Input[Optional['ChatEngineChatEngineConfigAgentCreationConfigArgs']] = None,
                 allow_cross_region: pulumi.Input[Optional[_builtins.bool]] = None,
                 dialogflow_agent_to_link: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def agent_creation_config(self) -> pulumi.Input[Optional['ChatEngineChatEngineConfigAgentCreationConfigArgs']]:
        """
        The configuration to generate the Dialogflow agent that is associated to this Engine.
        Exactly one of `agent_creation_config` or `dialogflow_agent_to_link` must be set.
        Structure is documented below.
    ...
    def agent_creation_config(self, value: pulumi.Input[Optional['ChatEngineChatEngineConfigAgentCreationConfigArgs']]):
        pulumi.set(self, "agent_creation_config", value)

    @_builtins.property
    @pulumi.getter(name="allowCrossRegion")
    def allow_cross_region(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If the flag set to true, we allow the agent and engine are in
        different locations, otherwise the agent and engine are required to be
        in the same location. The flag is set to false by default.
    ...
    def allow_cross_region(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "allow_cross_region", value)

    @_builtins.property
    @pulumi.getter(name="dialogflowAgentToLink")
    def dialogflow_agent_to_link(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The resource name of an existing Dialogflow agent to link to this Chat Engine. Format: `projects/<Project_ID>/locations/<Location_ID>/agents/<Agent_ID>`.
        Exactly one of `agent_creation_config` or `dialogflow_agent_to_link` must be set.
        """
    ...
    def dialogflow_agent_to_link(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ChatEngineChatEngineMetadataArgsDict(TypedDict):
    dialogflow_agent: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
...
class ChatEngineChatEngineMetadataArgs:
    def __init__(__self__, *,
                 dialogflow_agent: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def dialogflow_agent(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        The resource name of a Dialogflow agent, that this Chat Engine refers to.
        """
    ...
    def dialogflow_agent(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ControlBoostActionArgsDict(TypedDict):
    ...
    """
    fixed_boost: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    """
...
class ControlBoostActionArgs:
    def __init__(__self__, *,
                 data_store: pulumi.Input[_builtins.str],
                 filter: pulumi.Input[_builtins.str],
                 fixed_boost: pulumi.Input[Optional[_builtins.float]] = None,
                 interpolation_boost_spec: pulumi.Input[Optional['ControlBoostActionInterpolationBoostSpecArgs']] = None):
        """
    ...
    def fixed_boost(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        The fixed boost value to apply to the search results. Positive values will increase the relevance of the results, while negative values will decrease the relevance. The value must be between -100 and 100.
        """
    ...
    @fixed_boost.setter
    def fixed_boost(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "fixed_boost", value)

    @_builtins.property
    @pulumi.getter(name="interpolationBoostSpec")
    def interpolation_boost_spec(self) -> pulumi.Input[Optional['ControlBoostActionInterpolationBoostSpecArgs']]:
        """
        The interpolation boost specification to apply to the search results.
        Structure is documented below.
        """
    ...
    def interpolation_boost_spec(self, value: pulumi.Input[Optional['ControlBoostActionInterpolationBoostSpecArgs']]):
        pulumi.set(self, "interpolation_boost_spec", value)


class ControlBoostActionInterpolationBoostSpecArgsDict(TypedDict):
    attribute_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    interpolation_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ControlBoostActionInterpolationBoostSpecArgs:
    def __init__(__self__, *,
                 ...
                 control_point: pulumi.Input[Optional['ControlBoostActionInterpolationBoostSpecControlPointArgs']] = None,
                 field_name: pulumi.Input[Optional[_builtins.str]] = None,
                 interpolation_type: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def control_point(self) -> pulumi.Input[Optional['ControlBoostActionInterpolationBoostSpecControlPointArgs']]:
        """
        The control points used to define the curve.
        Structure is documented below.
        """
    ...
    def control_point(self, value: pulumi.Input[Optional['ControlBoostActionInterpolationBoostSpecControlPointArgs']]):
    ...
    def interpolation_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The interpolation type to be applied to connect the control points.
        Possible values are: `LINEAR`.
        """
    ...
    def interpolation_type(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ControlBoostActionInterpolationBoostSpecControlPointArgsDict(TypedDict):
    ...
    """
    boost_amount: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    """
...
class ControlBoostActionInterpolationBoostSpecControlPointArgs:
    def __init__(__self__, *,
                 ...
                 boost_amount: pulumi.Input[Optional[_builtins.float]] = None):
        """
    ...
    def boost_amount(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        The value between -1 to 1 by which to boost the score if the attributeValue
        evaluates to the value specified above.
        """
...
class ControlConditionArgsDict(TypedDict):
    ...
    Structure is documented below.
    """
    query_regex: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ControlConditionArgs:
    def __init__(__self__, *,
                 active_time_ranges: pulumi.Input[Optional[Sequence[pulumi.Input['ControlConditionActiveTimeRangeArgs']]]] = None,
                 query_regex: pulumi.Input[Optional[_builtins.str]] = None,
                 query_terms: pulumi.Input[Optional[Sequence[pulumi.Input['ControlConditionQueryTermArgs']]]] = None):
        """
    ...
    def active_time_ranges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ControlConditionActiveTimeRangeArgs']]]]:
        """
        The time range when the condition is active.
        Structure is documented below.
        """
    ...
    def active_time_ranges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ControlConditionActiveTimeRangeArgs']]]]):
        pulumi.set(self, "active_time_ranges", value)

    @_builtins.property
    @pulumi.getter(name="queryRegex")
    def query_regex(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The regular expression that the query must match for this condition to be met.
        """
    ...
    @query_regex.setter
    def query_regex(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "query_regex", value)

    @_builtins.property
    @pulumi.getter(name="queryTerms")
    def query_terms(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ControlConditionQueryTermArgs']]]]:
        """
        The query terms that must be present in the search request for this condition to be met.
        Structure is documented below.
        """
    ...
    @query_terms.setter
    def query_terms(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ControlConditionQueryTermArgs']]]]):
...
class ControlSynonymsActionArgsDict(TypedDict):
    synonyms: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
...
class ControlSynonymsActionArgs:
    def __init__(__self__, *,
                 synonyms: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def synonyms(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        The synonyms to apply to the search results.
        """
    ...
    @synonyms.setter
    def synonyms(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "synonyms", value)


class DataConnectorActionConfigArgsDict(TypedDict):
    action_params: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
    ...
    """
    create_bap_connection: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to create a BAP (Business Application Platform) connection
    for this action connector.
    """
    is_action_configured: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    (Output)
...
class DataConnectorActionConfigArgs:
    def __init__(__self__, *,
                 ...
                 create_bap_connection: pulumi.Input[Optional[_builtins.bool]] = None,
                 is_action_configured: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def create_bap_connection(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to create a BAP (Business Application Platform) connection
        for this action connector.
        """
    ...
    def create_bap_connection(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "create_bap_connection", value)

    @_builtins.property
    @pulumi.getter(name="isActionConfigured")
    def is_action_configured(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        (Output)
        Whether the action connector is fully configured. Set by the system
        after the action configuration is validated.
    ...
    def is_action_configured(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_action_configured", value)


class DataConnectorBapConfigArgsDict(TypedDict):
    enabled_actions: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    ...
    `upload_attachment`.
    """
    supported_connector_modes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
...
class DataConnectorBapConfigArgs:
    def __init__(__self__, *,
                 enabled_actions: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 supported_connector_modes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    def enabled_actions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        The list of enabled actions for this connector. Supported
        values include: `create_issue`, `update_issue`,
        `change_issue_status`, `create_comment`, `update_comment`,
    ...
    def enabled_actions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "enabled_actions", value)

    @_builtins.property
    @pulumi.getter(name="supportedConnectorModes")
    def supported_connector_modes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        The connector modes supported by the BAP configuration.
        The possible values include: `ACTIONS`.
        """
    ...
    def supported_connector_modes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class DataConnectorDestinationConfigArgs:
    def __init__(__self__, *,
                 destinations: pulumi.Input[Optional[Sequence[pulumi.Input['DataConnectorDestinationConfigDestinationArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def destinations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DataConnectorDestinationConfigDestinationArgs']]]]:
        """
        The list of destinations for this configuration.
        Structure is documented below.
        """
    ...
    @destinations.setter
    def destinations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DataConnectorDestinationConfigDestinationArgs']]]]):
...
class DataConnectorEntityArgsDict(TypedDict):
    data_store: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    (Output)
    ...
    * Confluence: `Content`, `Space`
    """
    key_property_mappings: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class DataConnectorEntityArgs:
    def __init__(__self__, *,
                 data_store: pulumi.Input[Optional[_builtins.str]] = None,
                 entity_name: pulumi.Input[Optional[_builtins.str]] = None,
                 key_property_mappings: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 params: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dataStore")
    def data_store(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Output)
        The full resource name of the associated data store for the source
        entity.
    ...
    @data_store.setter
    def data_store(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "data_store", value)
    ...
    def key_property_mappings(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Attributes for indexing.
        Key: Field name.
        Value: The key property to map a field to, such as `title`, and
    ...
    def key_property_mappings(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class DataStoreAdvancedSiteSearchConfigArgsDict(TypedDict):
    disable_automatic_refresh: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    If set true, automatic refresh is disabled for the DataStore.
    """
    disable_initial_index: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class DataStoreAdvancedSiteSearchConfigArgs:
    def __init__(__self__, *,
                 disable_automatic_refresh: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_initial_index: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def disable_automatic_refresh(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set true, automatic refresh is disabled for the DataStore.
        """
    ...
    def disable_automatic_refresh(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_automatic_refresh", value)

    @_builtins.property
    @pulumi.getter(name="disableInitialIndex")
    def disable_initial_index(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set true, initial indexing is disabled for the DataStore.
        """
    ...
    def disable_initial_index(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class DataStoreDocumentProcessingConfigArgs:
    def __init__(__self__, *,
                 chunking_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigChunkingConfigArgs']] = None,
                 default_parsing_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parsing_config_overrides: pulumi.Input[Optional[Sequence[pulumi.Input['DataStoreDocumentProcessingConfigParsingConfigOverrideArgs']]]] = None):
        """
    ...
    def chunking_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigChunkingConfigArgs']]:
        """
        Whether chunking mode is enabled.
        Structure is documented below.
        """
    ...
    def chunking_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigChunkingConfigArgs']]):
        pulumi.set(self, "chunking_config", value)

    @_builtins.property
    @pulumi.getter(name="defaultParsingConfig")
    def default_parsing_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigArgs']]:
        """
        Configurations for default Document parser. If not specified, this resource
        will be configured to use a default DigitalParsingConfig, and the default parsing
        config will be applied to all file types for Document parsing.
    ...
    def default_parsing_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigArgs']]):
    ...
    def parsing_config_overrides(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DataStoreDocumentProcessingConfigParsingConfigOverrideArgs']]]]:
        """
        Map from file type to override the default parsing configuration based on the file type. Supported keys:
        """
    ...
    def parsing_config_overrides(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DataStoreDocumentProcessingConfigParsingConfigOverrideArgs']]]]):
...
class DataStoreDocumentProcessingConfigChunkingConfigArgs:
    def __init__(__self__, *,
                 layout_based_chunking_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs']] = None):
        """
    ...
    def layout_based_chunking_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs']]:
        """
        Configuration for the layout based chunking.
        Structure is documented below.
        """
    ...
    def layout_based_chunking_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs']]):
...
class DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgsDict(TypedDict):
    chunk_size: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The token size limit for each chunk.
    Supported values: 100-500 (inclusive). Default value: 500.
    """
    include_ancestor_headings: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs:
    def __init__(__self__, *,
                 ...
                 include_ancestor_headings: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def include_ancestor_headings(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to include appending different levels of headings to chunks from the middle of the document to prevent context loss.
        Default value: False.
        """
    ...
    def include_ancestor_headings(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigArgs:
    def __init__(__self__, *,
                 digital_parsing_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigDigitalParsingConfigArgs']] = None,
                 layout_parsing_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgs']] = None,
                 ocr_parsing_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs']] = None):
        """
    ...
    def digital_parsing_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigDigitalParsingConfigArgs']]:
        """
        Configurations applied to digital parser.
        """
    ...
    def digital_parsing_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigDigitalParsingConfigArgs']]):
        pulumi.set(self, "digital_parsing_config", value)

    @_builtins.property
    @pulumi.getter(name="layoutParsingConfig")
    def layout_parsing_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgs']]:
        """
        Configurations applied to layout parser.
        Structure is documented below.
        """
    ...
    def layout_parsing_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgs']]):
        pulumi.set(self, "layout_parsing_config", value)

    @_builtins.property
    @pulumi.getter(name="ocrParsingConfig")
    def ocr_parsing_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs']]:
        """
        Configurations applied to OCR parser. Currently it only applies to PDFs.
        Structure is documented below.
        """
    ...
    def ocr_parsing_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs']]):
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgsDict(TypedDict):
    ...
    """
    exclude_html_classes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    List of HTML classes to exclude from the parsed content.
    """
    exclude_html_elements: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    List of HTML elements to exclude from the parsed content.
    """
    exclude_html_ids: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    List of HTML ids to exclude from the parsed content.
    """
    structured_content_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigArgs:
    ...
    def enable_table_annotation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true, the LLM based annotation is added to the table during parsing.
        """
    ...
    def enable_table_annotation(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_table_annotation", value)

    @_builtins.property
    @pulumi.getter(name="excludeHtmlClasses")
    def exclude_html_classes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        List of HTML classes to exclude from the parsed content.
        """
    ...
    def exclude_html_classes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "exclude_html_classes", value)

    @_builtins.property
    @pulumi.getter(name="excludeHtmlElements")
    def exclude_html_elements(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        List of HTML elements to exclude from the parsed content.
        """
    ...
    def exclude_html_elements(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "exclude_html_elements", value)

    @_builtins.property
    @pulumi.getter(name="excludeHtmlIds")
    def exclude_html_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        List of HTML ids to exclude from the parsed content.
        """
    ...
    def exclude_html_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "exclude_html_ids", value)

    @_builtins.property
    @pulumi.getter(name="structuredContentTypes")
    def structured_content_types(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Contains the required structure types to extract from the document. Supported values: `shareholder-structure`.
        """
    ...
    def structured_content_types(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgsDict(TypedDict):
    use_native_text: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs:
    def __init__(__self__, *,
                 use_native_text: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def use_native_text(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If true, will use native text instead of OCR text on pages containing native text.
        """
    ...
    def use_native_text(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class DataStoreDocumentProcessingConfigParsingConfigOverrideArgs:
    def __init__(__self__, *,
                 file_type: pulumi.Input[_builtins.str],
                 digital_parsing_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideDigitalParsingConfigArgs']] = None,
                 layout_parsing_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfigArgs']] = None,
                 ocr_parsing_config: pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideOcrParsingConfigArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="digitalParsingConfig")
    def digital_parsing_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideDigitalParsingConfigArgs']]:
        """
        Configurations applied to digital parser.
        """
        return pulumi.get(self, "digital_parsing_config")
    ...
    @digital_parsing_config.setter
    def digital_parsing_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideDigitalParsingConfigArgs']]):
        pulumi.set(self, "digital_parsing_config", value)

    @_builtins.property
    @pulumi.getter(name="layoutParsingConfig")
    def layout_parsing_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfigArgs']]:
        """
        Configurations applied to layout parser.
        Structure is documented below.
        """
    ...
    @layout_parsing_config.setter
    def layout_parsing_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideLayoutParsingConfigArgs']]):
        pulumi.set(self, "layout_parsing_config", value)

    @_builtins.property
    @pulumi.getter(name="ocrParsingConfig")
    def ocr_parsing_config(self) -> pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideOcrParsingConfigArgs']]:
        """
        Configurations applied to OCR parser. Currently it only applies to PDFs.
        Structure is documented below.
        """
    ...
    @ocr_parsing_config.setter
    def ocr_parsing_config(self, value: pulumi.Input[Optional['DataStoreDocumentProcessingConfigParsingConfigOverrideOcrParsingConfigArgs']]):
        pulumi.set(self, "ocr_parsing_config", value)
...
class RecommendationEngineMediaRecommendationEngineConfigArgsDict(TypedDict):
    ...
    Structure is documented below.
    """
    optimization_objective: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    Structure is documented below.
    """
    training_state: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class RecommendationEngineMediaRecommendationEngineConfigArgs:
    def __init__(__self__, *,
                 engine_features_config: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigArgs']] = None,
                 optimization_objective: pulumi.Input[Optional[_builtins.str]] = None,
                 optimization_objective_config: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgs']] = None,
                 training_state: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def engine_features_config(self) -> pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigArgs']]:
        """
        More feature configs of the selected engine type.
        Structure is documented below.
        """
    ...
    def engine_features_config(self, value: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigArgs']]):
        pulumi.set(self, "engine_features_config", value)

    @_builtins.property
    @pulumi.getter(name="optimizationObjective")
    def optimization_objective(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The optimization objective. e.g., `cvr`.
        This field together with MediaRecommendationEngineConfig.type describes
        engine metadata to use to control engine training and serving.
    ...
    def optimization_objective(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "optimization_objective", value)

    @_builtins.property
    @pulumi.getter(name="optimizationObjectiveConfig")
    def optimization_objective_config(self) -> pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgs']]:
        """
        Name and value of the custom threshold for cvr optimization_objective.
        For target_field `watch-time`, target_field_value must be an integer
        value indicating the media progress time in seconds between (0, 86400]
    ...
    def optimization_objective_config(self, value: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgs']]):
        pulumi.set(self, "optimization_objective_config", value)

    @_builtins.property
    @pulumi.getter(name="trainingState")
    def training_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The training state that the engine is in (e.g. `TRAINING` or `PAUSED`).
        Since part of the cost of running the service
        is frequency of training - this can be used to determine when to train
    ...
    def training_state(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigArgs:
    def __init__(__self__, *,
                 most_popular_config: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgs']] = None,
                 recommended_for_you_config: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgs']] = None):
        """
    ...
    def most_popular_config(self) -> pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgs']]:
        """
        Feature configurations that are required for creating a Most Popular engine.
        Structure is documented below.
        """
    ...
    def most_popular_config(self, value: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgs']]):
        pulumi.set(self, "most_popular_config", value)

    @_builtins.property
    @pulumi.getter(name="recommendedForYouConfig")
    def recommended_for_you_config(self) -> pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgs']]:
        """
        Additional feature configurations for creating a `recommended-for-you` engine.
        Structure is documented below.
        """
    ...
    def recommended_for_you_config(self, value: pulumi.Input[Optional['RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgs']]):
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgsDict(TypedDict):
    time_window_days: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigMostPopularConfigArgs:
    def __init__(__self__, *,
                 time_window_days: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def time_window_days(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The time window of which the engine is queried at training and
        prediction time. Positive integers only. The value translates to the
        last X days of events. Currently required for the `most-popular-items`
    ...
    def time_window_days(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgsDict(TypedDict):
    context_event_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class RecommendationEngineMediaRecommendationEngineConfigEngineFeaturesConfigRecommendedForYouConfigArgs:
    def __init__(__self__, *,
                 context_event_type: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def context_event_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The type of event with which the engine is queried at prediction time.
        If set to `generic`, only `view-item`, `media-play`,and
        `media-complete` will be used as `context-event` in engine training. If
    ...
    def context_event_type(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgsDict(TypedDict):
    target_field: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The name of the field to target. Currently supported values: `watch-percentage`, `watch-time`.
    """
    target_field_value_float: NotRequired[pulumi.Input[Optional[_builtins.float]]]
    """
...
class RecommendationEngineMediaRecommendationEngineConfigOptimizationObjectiveConfigArgs:
    def __init__(__self__, *,
                 target_field: pulumi.Input[Optional[_builtins.str]] = None,
                 target_field_value_float: pulumi.Input[Optional[_builtins.float]] = None):
        """
    ...
    def target_field(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name of the field to target. Currently supported values: `watch-percentage`, `watch-time`.
        """
    ...
    @target_field.setter
    def target_field(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "target_field", value)

    @_builtins.property
    @pulumi.getter(name="targetFieldValueFloat")
    def target_field_value_float(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        The threshold to be applied to the target (e.g., 0.5).
        """
    ...
    def target_field_value_float(self, value: pulumi.Input[Optional[_builtins.float]]):
...
class SearchEngineIamBindingConditionArgsDict(TypedDict):
    expression: pulumi.Input[_builtins.str]
    title: pulumi.Input[_builtins.str]
    description: NotRequired[pulumi.Input[Optional[_builtins.str]]]

@pulumi.input_type
class SearchEngineIamBindingConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[_builtins.str],
                 title: pulumi.Input[_builtins.str],
                 description: pulumi.Input[Optional[_builtins.str]] = None):
...
class SearchEngineIamMemberConditionArgsDict(TypedDict):
    expression: pulumi.Input[_builtins.str]
    title: pulumi.Input[_builtins.str]
    description: NotRequired[pulumi.Input[Optional[_builtins.str]]]

@pulumi.input_type
class SearchEngineIamMemberConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[_builtins.str],
                 title: pulumi.Input[_builtins.str],
                 description: pulumi.Input[Optional[_builtins.str]] = None):
...
class SearchEngineKnowledgeGraphConfigArgsDict(TypedDict):
    cloud_knowledge_graph_types: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    Specify entity types to support.
    """
    enable_cloud_knowledge_graph: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to enable the Cloud Knowledge Graph for the engine.
    """
    enable_private_knowledge_graph: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class SearchEngineKnowledgeGraphConfigArgs:
    def __init__(__self__, *,
                 cloud_knowledge_graph_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 enable_cloud_knowledge_graph: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_private_knowledge_graph: pulumi.Input[Optional[_builtins.bool]] = None,
                 feature_config: pulumi.Input[Optional['SearchEngineKnowledgeGraphConfigFeatureConfigArgs']] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cloud_knowledge_graph_types: Specify entity types to support.
        :param pulumi.Input[_builtins.bool] enable_cloud_knowledge_graph: Whether to enable the Cloud Knowledge Graph for the engine.
        :param pulumi.Input[_builtins.bool] enable_private_knowledge_graph: Whether to enable the Private Knowledge Graph for the engine.
        :param pulumi.Input['SearchEngineKnowledgeGraphConfigFeatureConfigArgs'] feature_config: Feature config for the Knowledge Graph.
               Structure is documented below.
        """
    ...
    def cloud_knowledge_graph_types(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Specify entity types to support.
        """
    ...
    def cloud_knowledge_graph_types(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "cloud_knowledge_graph_types", value)

    @_builtins.property
    @pulumi.getter(name="enableCloudKnowledgeGraph")
    def enable_cloud_knowledge_graph(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to enable the Cloud Knowledge Graph for the engine.
        """
    ...
    def enable_cloud_knowledge_graph(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_cloud_knowledge_graph", value)

    @_builtins.property
    @pulumi.getter(name="enablePrivateKnowledgeGraph")
    def enable_private_knowledge_graph(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to enable the Private Knowledge Graph for the engine.
        """
    ...
    def enable_private_knowledge_graph(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_private_knowledge_graph", value)

    @_builtins.property
    @pulumi.getter(name="featureConfig")
    def feature_config(self) -> pulumi.Input[Optional['SearchEngineKnowledgeGraphConfigFeatureConfigArgs']]:
        """
        Feature config for the Knowledge Graph.
        Structure is documented below.
        """
    ...
    def feature_config(self, value: pulumi.Input[Optional['SearchEngineKnowledgeGraphConfigFeatureConfigArgs']]):
        pulumi.set(self, "feature_config", value)


class SearchEngineKnowledgeGraphConfigFeatureConfigArgsDict(TypedDict):
    disable_private_kg_auto_complete: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to disable the private KG auto complete for the engine.
    """
    disable_private_kg_enrichment: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to disable the private KG enrichment for the engine.
    """
    disable_private_kg_query_ui_chips: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to disable the private KG for query UI chips.
    """
    disable_private_kg_query_understanding: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class SearchEngineKnowledgeGraphConfigFeatureConfigArgs:
    def __init__(__self__, *,
                 disable_private_kg_auto_complete: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_private_kg_enrichment: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_private_kg_query_ui_chips: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_private_kg_query_understanding: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.bool] disable_private_kg_auto_complete: Whether to disable the private KG auto complete for the engine.
        :param pulumi.Input[_builtins.bool] disable_private_kg_enrichment: Whether to disable the private KG enrichment for the engine.
        :param pulumi.Input[_builtins.bool] disable_private_kg_query_ui_chips: Whether to disable the private KG for query UI chips.
        :param pulumi.Input[_builtins.bool] disable_private_kg_query_understanding: Whether to disable the private KG query understanding for the engine.
        """
    ...
    def disable_private_kg_auto_complete(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to disable the private KG auto complete for the engine.
        """
    ...
    def disable_private_kg_auto_complete(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_private_kg_auto_complete", value)

    @_builtins.property
    @pulumi.getter(name="disablePrivateKgEnrichment")
    def disable_private_kg_enrichment(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to disable the private KG enrichment for the engine.
        """
    ...
    def disable_private_kg_enrichment(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_private_kg_enrichment", value)

    @_builtins.property
    @pulumi.getter(name="disablePrivateKgQueryUiChips")
    def disable_private_kg_query_ui_chips(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to disable the private KG for query UI chips.
        """
    ...
    def disable_private_kg_query_ui_chips(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_private_kg_query_ui_chips", value)

    @_builtins.property
    @pulumi.getter(name="disablePrivateKgQueryUnderstanding")
    def disable_private_kg_query_understanding(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to disable the private KG query understanding for the engine.
        """
    ...
    def disable_private_kg_query_understanding(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_private_kg_query_understanding", value)


class SearchEngineSearchEngineConfigArgsDict(TypedDict):
    required_subscription_tier: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    search_add_ons: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    The add-on that this search engine enables.
    Each value may be one of: `SEARCH_ADD_ON_LLM`.
    """
    search_tier: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class SearchEngineSearchEngineConfigArgs:
    def __init__(__self__, *,
                 required_subscription_tier: pulumi.Input[Optional[_builtins.str]] = None,
                 search_add_ons: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 search_tier: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def required_subscription_tier(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The required subscription tier of this engine.
        They cannot be modified after engine creation. If the required subscription tier is search, user with higher license tier like assist can still access the standalone app associated with this engine.
        Possible values are: `SUBSCRIPTION_TIER_UNSPECIFIED`, `SUBSCRIPTION_TIER_SEARCH`, `SUBSCRIPTION_TIER_SEARCH_AND_ASSISTANT`, `SUBSCRIPTION_TIER_FRONTLINE_WORKER`, `SUBSCRIPTION_TIER_AGENTSPACE_STARTER`, `SUBSCRIPTION_TIER_AGENTSPACE_BUSINESS`, `SUBSCRIPTION_TIER_ENTERPRISE`, `SUBSCRIPTION_TIER_ENTERPRISE_EMERGING`, `SUBSCRIPTION_TIER_EDU`, `SUBSCRIPTION_TIER_EDU_PRO`, `SUBSCRIPTION_TIER_EDU_EMERGING`, `SUBSCRIPTION_TIER_EDU_PRO_EMERGING`, `SUBSCRIPTION_TIER_FRONTLINE_STARTER`.
    ...
    def required_subscription_tier(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "required_subscription_tier", value)

    @_builtins.property
    @pulumi.getter(name="searchAddOns")
    def search_add_ons(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        The add-on that this search engine enables.
        Each value may be one of: `SEARCH_ADD_ON_LLM`.
        """
    ...
    def search_add_ons(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "search_add_ons", value)

    @_builtins.property
    @pulumi.getter(name="searchTier")
    def search_tier(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The search feature tier of this engine. Defaults to SearchTier.SEARCH_TIER_STANDARD if not specified.
        Default value is `SEARCH_TIER_STANDARD`.
        Possible values are: `SEARCH_TIER_STANDARD`, `SEARCH_TIER_ENTERPRISE`.
    ...
    @search_tier.setter
    def search_tier(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class TargetSiteFailureReasonArgs:
    def __init__(__self__, *,
                 quota_failure: pulumi.Input[Optional['TargetSiteFailureReasonQuotaFailureArgs']] = None):
        """
    ...
    def quota_failure(self) -> pulumi.Input[Optional['TargetSiteFailureReasonQuotaFailureArgs']]:
        """
        Site verification state indicating the ownership and validity.
        Structure is documented below.
        """
    ...
    def quota_failure(self, value: pulumi.Input[Optional['TargetSiteFailureReasonQuotaFailureArgs']]):
        pulumi.set(self, "quota_failure", value)


class TargetSiteFailureReasonQuotaFailureArgsDict(TypedDict):
    total_required_quota: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class TargetSiteFailureReasonQuotaFailureArgs:
    def __init__(__self__, *,
                 total_required_quota: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def total_required_quota(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        This number is an estimation on how much total quota this project
        needs to successfully complete indexing.
        """
    ...
    def total_required_quota(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "total_required_quota", value)


class TargetSiteSiteVerificationInfoArgsDict(TypedDict):
    site_verification_state: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Site verification state indicating the ownership and validity.
    Possible values are: `VERIFIED`, `UNVERIFIED`, `EXEMPTED`.
    """
    verify_time: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class TargetSiteSiteVerificationInfoArgs:
    def __init__(__self__, *,
                 site_verification_state: pulumi.Input[Optional[_builtins.str]] = None,
                 verify_time: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def site_verification_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Site verification state indicating the ownership and validity.
        Possible values are: `VERIFIED`, `UNVERIFIED`, `EXEMPTED`.
        """
    ...
    def site_verification_state(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "site_verification_state", value)

    @_builtins.property
    @pulumi.getter(name="verifyTime")
    def verify_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Latest site verification time.
        """
    ...
    @verify_time.setter
    def verify_time(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "verify_time", value)


class WidgetConfigAccessSettingsArgsDict(TypedDict):
    allow_public_access: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether public unauthenticated access is allowed.
    """
    allowlisted_domains: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    List of domains that are allowed to integrate the search widget.
    """
    enable_web_app: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    workforce_identity_pool_provider: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class WidgetConfigAccessSettingsArgs:
    def __init__(__self__, *,
                 allow_public_access: pulumi.Input[Optional[_builtins.bool]] = None,
                 allowlisted_domains: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 enable_web_app: pulumi.Input[Optional[_builtins.bool]] = None,
                 language_code: pulumi.Input[Optional[_builtins.str]] = None,
                 workforce_identity_pool_provider: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def allow_public_access(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether public unauthenticated access is allowed.
        """
    ...
    def allow_public_access(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "allow_public_access", value)

    @_builtins.property
    @pulumi.getter(name="allowlistedDomains")
    def allowlisted_domains(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        List of domains that are allowed to integrate the search widget.
        """
    ...
    def allowlisted_domains(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "allowlisted_domains", value)

    @_builtins.property
    @pulumi.getter(name="enableWebApp")
    def enable_web_app(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether web app access is enabled.
        """
    ...
    def enable_web_app(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def workforce_identity_pool_provider(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The workforce identity pool provider used to access the widget.
        """
    ...
    def workforce_identity_pool_provider(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class WidgetConfigHomepageSettingArgs:
    def __init__(__self__, *,
                 shortcuts: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigHomepageSettingShortcutArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def shortcuts(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigHomepageSettingShortcutArgs']]]]:
        """
        The shortcuts to display on the homepage.
        Structure is documented below.
        """
    ...
    @shortcuts.setter
    def shortcuts(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigHomepageSettingShortcutArgs']]]]):
        pulumi.set(self, "shortcuts", value)


class WidgetConfigHomepageSettingShortcutArgsDict(TypedDict):
    destination_uri: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class WidgetConfigHomepageSettingShortcutArgs:
    def __init__(__self__, *,
                 destination_uri: pulumi.Input[Optional[_builtins.str]] = None,
                 icon: pulumi.Input[Optional['WidgetConfigHomepageSettingShortcutIconArgs']] = None,
    ...
    def destination_uri(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Destination URL of shortcut.
        """
    ...
    def destination_uri(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "destination_uri", value)

    @_builtins.property
    @pulumi.getter
    def icon(self) -> pulumi.Input[Optional['WidgetConfigHomepageSettingShortcutIconArgs']]:
        """
        Icon URL of shortcut.
        Structure is documented below.
        """
    ...
    @icon.setter
    def icon(self, value: pulumi.Input[Optional['WidgetConfigHomepageSettingShortcutIconArgs']]):
...
class WidgetConfigUiBrandingArgs:
    def __init__(__self__, *,
                 logo: pulumi.Input[Optional['WidgetConfigUiBrandingLogoArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def logo(self) -> pulumi.Input[Optional['WidgetConfigUiBrandingLogoArgs']]:
        """
        Logo image.
        Structure is documented below.
        """
    ...
    @logo.setter
    def logo(self, value: pulumi.Input[Optional['WidgetConfigUiBrandingLogoArgs']]):
...
class WidgetConfigUiSettingsArgsDict(TypedDict):
    ...
    Structure is documented below.
    """
    default_search_request_order_by: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The default ordering for search results if specified.
    Used to set SearchRequest#orderBy on applicable requests.
    """
    disable_user_events_collection: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    If set to true, the widget will not collect user events.
    """
    enable_autocomplete: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether or not to enable autocomplete.
    """
    enable_create_agent_button: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    If set to true, the widget will enable the create agent button.
    """
    enable_people_search: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    If set to true, the widget will enable people search.
    """
    enable_quality_feedback: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Turn on or off collecting the search result quality feedback from end users.
    """
    enable_safe_search: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to enable safe search.
    """
    enable_search_as_you_type: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether to enable search-as-you-type behavior for the search widget.
    """
    enable_visual_content_summary: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    Structure is documented below.
    """
    interaction_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Describes widget (or web app) interaction type
    Possible values are: `SEARCH_ONLY`, `SEARCH_WITH_ANSWER`, `SEARCH_WITH_FOLLOW_UPS`.
    """
    result_description_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class WidgetConfigUiSettingsArgs:
    def __init__(__self__, *,
                 data_store_ui_configs: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigArgs']]]] = None,
                 default_search_request_order_by: pulumi.Input[Optional[_builtins.str]] = None,
                 disable_user_events_collection: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_autocomplete: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_create_agent_button: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_people_search: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_quality_feedback: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_safe_search: pulumi.Input[Optional[_builtins.bool]] = None,
                 enable_search_as_you_type: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def data_store_ui_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigArgs']]]]:
        """
        Per data store configuration.
        Structure is documented below.
        """
    ...
    def data_store_ui_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigArgs']]]]):
        pulumi.set(self, "data_store_ui_configs", value)

    @_builtins.property
    @pulumi.getter(name="defaultSearchRequestOrderBy")
    def default_search_request_order_by(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The default ordering for search results if specified.
        Used to set SearchRequest#orderBy on applicable requests.
        """
    ...
    def default_search_request_order_by(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "default_search_request_order_by", value)

    @_builtins.property
    @pulumi.getter(name="disableUserEventsCollection")
    def disable_user_events_collection(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set to true, the widget will not collect user events.
        """
    ...
    def disable_user_events_collection(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_user_events_collection", value)

    @_builtins.property
    @pulumi.getter(name="enableAutocomplete")
    def enable_autocomplete(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether or not to enable autocomplete.
        """
    ...
    def enable_autocomplete(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_autocomplete", value)

    @_builtins.property
    @pulumi.getter(name="enableCreateAgentButton")
    def enable_create_agent_button(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set to true, the widget will enable the create agent button.
        """
    ...
    def enable_create_agent_button(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_create_agent_button", value)

    @_builtins.property
    @pulumi.getter(name="enablePeopleSearch")
    def enable_people_search(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set to true, the widget will enable people search.
        """
    ...
    def enable_people_search(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_people_search", value)

    @_builtins.property
    @pulumi.getter(name="enableQualityFeedback")
    def enable_quality_feedback(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Turn on or off collecting the search result quality feedback from end users.
        """
    ...
    def enable_quality_feedback(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_quality_feedback", value)

    @_builtins.property
    @pulumi.getter(name="enableSafeSearch")
    def enable_safe_search(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to enable safe search.
        """
    ...
    def enable_safe_search(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_safe_search", value)

    @_builtins.property
    @pulumi.getter(name="enableSearchAsYouType")
    def enable_search_as_you_type(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to enable search-as-you-type behavior for the search widget.
        """
    ...
    def enable_search_as_you_type(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_search_as_you_type", value)

    @_builtins.property
    @pulumi.getter(name="enableVisualContentSummary")
    def enable_visual_content_summary(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set to true, the widget will enable visual content summary on applicable
        search requests. Only used by healthcare search.
        """
    ...
    def enable_visual_content_summary(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_visual_content_summary", value)

    @_builtins.property
    @pulumi.getter(name="generativeAnswerConfig")
    def generative_answer_config(self) -> pulumi.Input[Optional['WidgetConfigUiSettingsGenerativeAnswerConfigArgs']]:
        """
        Describes generative answer configuration.
        Structure is documented below.
        """
    ...
    def generative_answer_config(self, value: pulumi.Input[Optional['WidgetConfigUiSettingsGenerativeAnswerConfigArgs']]):
        pulumi.set(self, "generative_answer_config", value)

    @_builtins.property
    @pulumi.getter(name="interactionType")
    def interaction_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Describes widget (or web app) interaction type
        Possible values are: `SEARCH_ONLY`, `SEARCH_WITH_ANSWER`, `SEARCH_WITH_FOLLOW_UPS`.
        """
    ...
    def interaction_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "interaction_type", value)

    @_builtins.property
    @pulumi.getter(name="resultDescriptionType")
    def result_description_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Controls whether result extract is display and how (snippet or extractive answer).
        Default to no result if unspecified.
        Possible values are: `SNIPPET`, `EXTRACTIVE_ANSWER`.
...
class WidgetConfigUiSettingsDataStoreUiConfigArgs:
    def __init__(__self__, *,
                 facet_fields: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigFacetFieldArgs']]]] = None,
                 fields_ui_components_maps: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgs']]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def facet_fields(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigFacetFieldArgs']]]]:
        """
        Structure is documented below.
        """
    ...
    @facet_fields.setter
    def facet_fields(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigFacetFieldArgs']]]]):
        pulumi.set(self, "facet_fields", value)

    @_builtins.property
    @pulumi.getter(name="fieldsUiComponentsMaps")
    def fields_ui_components_maps(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgs']]]]:
        """
        'The key is the UI component. Currently supported `title`, `thumbnail`,
        `url`, `custom1`, `custom2`, `custom3`. The value is the name of
        the field along with its device visibility. The 3 custom fields are optional
    ...
    def fields_ui_components_maps(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgs']]]]):
...
class WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgsDict(TypedDict):
    ...
    The identifier for this object. Format specified above.
    """
    device_visibilities: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    Each value may be one of: `MOBILE`, `DESKTOP`.
    """
    display_template: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class WidgetConfigUiSettingsDataStoreUiConfigFieldsUiComponentsMapArgs:
    def __init__(__self__, *,
                 field: pulumi.Input[_builtins.str],
                 ui_component: pulumi.Input[_builtins.str],
                 device_visibilities: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 display_template: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] field: Registered field name. The format is `field.abc`.
    ...
    def device_visibilities(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Each value may be one of: `MOBILE`, `DESKTOP`.
        """
    ...
    def device_visibilities(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "device_visibilities", value)

    @_builtins.property
    @pulumi.getter(name="displayTemplate")
    def display_template(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The template to customize how the field is displayed.
        An example value would be a string that looks like: "Price: {value}".
        """
    ...
    def display_template(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "display_template", value)


class WidgetConfigUiSettingsGenerativeAnswerConfigArgsDict(TypedDict):
    disable_related_questions: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Whether generated answer contains suggested related questions.
    """
    ignore_adversarial_query: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to filter out queries that are adversarial.
    """
    ignore_low_relevant_content: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Specifies whether to filter out queries that are not relevant to the content.
    """
    ignore_non_answer_seeking_query: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    image_source: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    max_rephrase_steps: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Max rephrase steps. The max number is 5 steps. If not set or
    set to < 1, it will be set to 1 by default.
    """
    model_prompt_preamble: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    result_count: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class WidgetConfigUiSettingsGenerativeAnswerConfigArgs:
    def __init__(__self__, *,
                 disable_related_questions: pulumi.Input[Optional[_builtins.bool]] = None,
                 ignore_adversarial_query: pulumi.Input[Optional[_builtins.bool]] = None,
                 ignore_low_relevant_content: pulumi.Input[Optional[_builtins.bool]] = None,
                 ignore_non_answer_seeking_query: pulumi.Input[Optional[_builtins.bool]] = None,
                 image_source: pulumi.Input[Optional[_builtins.str]] = None,
                 language_code: pulumi.Input[Optional[_builtins.str]] = None,
                 max_rephrase_steps: pulumi.Input[Optional[_builtins.int]] = None,
                 model_prompt_preamble: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def disable_related_questions(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether generated answer contains suggested related questions.
        """
    ...
    def disable_related_questions(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "disable_related_questions", value)

    @_builtins.property
    @pulumi.getter(name="ignoreAdversarialQuery")
    def ignore_adversarial_query(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to filter out queries that are adversarial.
        """
    ...
    def ignore_adversarial_query(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "ignore_adversarial_query", value)

    @_builtins.property
    @pulumi.getter(name="ignoreLowRelevantContent")
    def ignore_low_relevant_content(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to filter out queries that are not relevant to the content.
        """
    ...
    def ignore_low_relevant_content(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "ignore_low_relevant_content", value)

    @_builtins.property
    @pulumi.getter(name="ignoreNonAnswerSeekingQuery")
    def ignore_non_answer_seeking_query(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specifies whether to filter out queries that are not answer-seeking.
        The default value is `false`. No answer is returned if the search query
        is classified as a non-answer seeking query.
    ...
    def ignore_non_answer_seeking_query(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "ignore_non_answer_seeking_query", value)

    @_builtins.property
    @pulumi.getter(name="imageSource")
    def image_source(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Source of image returned in the answer.
        Possible values are: `ALL_AVAILABLE_SOURCES`, `CORPUS_IMAGE_ONLY`, `FIGURE_GENERATION_ONLY`.
        """
    ...
    @image_source.setter
    def image_source(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def max_rephrase_steps(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Max rephrase steps. The max number is 5 steps. If not set or
        set to < 1, it will be set to 1 by default.
        """
    ...
    def max_rephrase_steps(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "max_rephrase_steps", value)

    @_builtins.property
    @pulumi.getter(name="modelPromptPreamble")
    def model_prompt_preamble(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Text at the beginning of the prompt that instructs the model that generates the answer.
        """
    ...
    def model_prompt_preamble(self, value: pulumi.Input[Optional[_builtins.str]]):
