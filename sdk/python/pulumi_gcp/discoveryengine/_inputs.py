...
class ChatEngineChatEngineConfigArgs:
    ...
    def dialogflow_agent_to_link(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dialogflow_agent_to_link", value)


if not MYPY:
    class ChatEngineChatEngineConfigAgentCreationConfigArgsDict(TypedDict):
        default_language_code: pulumi.Input[builtins.str]
        """
...
class ChatEngineChatEngineConfigAgentCreationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] default_language_code: The default language of the agent as a language tag. See [Language Support](https://cloud.google.com/dialogflow/docs/reference/language) for a list of the currently supported language codes.
    ...
    def default_language_code(self) -> pulumi.Input[builtins.str]:
        """
        The default language of the agent as a language tag. See [Language Support](https://cloud.google.com/dialogflow/docs/reference/language) for a list of the currently supported language codes.
        """
    ...
    def default_language_code(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ChatEngineChatEngineMetadataArgsDict(TypedDict):
        dialogflow_agent: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class ChatEngineChatEngineMetadataArgs:
    def __init__(__self__, *,
                 dialogflow_agent: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] dialogflow_agent: (Output)
               The resource name of a Dialogflow agent, that this Chat Engine refers to.
        """
    ...
    def dialogflow_agent(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The resource name of a Dialogflow agent, that this Chat Engine refers to.
        """
    ...
    def dialogflow_agent(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ChatEngineCommonConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] company_name: The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features.
        """
...
if not MYPY:
    class DataStoreAdvancedSiteSearchConfigArgsDict(TypedDict):
        disable_automatic_refresh: NotRequired[pulumi.Input[builtins.bool]]
        """
        If set true, automatic refresh is disabled for the DataStore.
        """
        disable_initial_index: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DataStoreAdvancedSiteSearchConfigArgs:
    def __init__(__self__, *,
                 disable_automatic_refresh: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_initial_index: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] disable_automatic_refresh: If set true, automatic refresh is disabled for the DataStore.
        :param pulumi.Input[builtins.bool] disable_initial_index: If set true, initial indexing is disabled for the DataStore.
        """
    ...
    def disable_automatic_refresh(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If set true, automatic refresh is disabled for the DataStore.
        """
    ...
    def disable_automatic_refresh(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_automatic_refresh", value)

    @property
    @pulumi.getter(name="disableInitialIndex")
    def disable_initial_index(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If set true, initial indexing is disabled for the DataStore.
        """
    ...
    def disable_initial_index(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgsDict(TypedDict):
        ...
        """
        include_ancestor_headings: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DataStoreDocumentProcessingConfigChunkingConfigLayoutBasedChunkingConfigArgs:
    def __init__(__self__, *,
                 ...
                 include_ancestor_headings: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] chunk_size: The token size limit for each chunk.
               Supported values: 100-500 (inclusive). Default value: 500.
        :param pulumi.Input[builtins.bool] include_ancestor_headings: Whether to include appending different levels of headings to chunks from the middle of the document to prevent context loss.
               Default value: False.
        """
    ...
    def include_ancestor_headings(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to include appending different levels of headings to chunks from the middle of the document to prevent context loss.
        Default value: False.
        """
    ...
    def include_ancestor_headings(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgsDict(TypedDict):
        use_native_text: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DataStoreDocumentProcessingConfigDefaultParsingConfigOcrParsingConfigArgs:
    def __init__(__self__, *,
                 use_native_text: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] use_native_text: If true, will use native text instead of OCR text on pages containing native text.
        """
    ...
    def use_native_text(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, will use native text instead of OCR text on pages containing native text.
        """
...
class DataStoreDocumentProcessingConfigParsingConfigOverrideArgs:
    ...
    def file_type(self) -> pulumi.Input[builtins.str]:
        """
        The identifier for this object. Format specified above.
        """
    ...
    @file_type.setter
    def file_type(self, value: pulumi.Input[builtins.str]):
...
class SearchEngineCommonConfigArgs:
    def __init__(__self__, *,
                 company_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] company_name: The name of the company, business or entity that is associated with the engine. Setting this may help improve LLM related features.cd
        """
        if company_name is not None:
            pulumi.set(__self__, "company_name", company_name)
...
if not MYPY:
    class SearchEngineSearchEngineConfigArgsDict(TypedDict):
        search_add_ons: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SearchEngineSearchEngineConfigArgs:
    def __init__(__self__, *,
                 search_add_ons: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 search_tier: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def search_add_ons(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The add-on that this search engine enables.
        Each value may be one of: `SEARCH_ADD_ON_LLM`.
    ...
    def search_add_ons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "search_add_ons", value)

    @property
    @pulumi.getter(name="searchTier")
    def search_tier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The search feature tier of this engine. Defaults to SearchTier.SEARCH_TIER_STANDARD if not specified.
        Default value is `SEARCH_TIER_STANDARD`.
        Possible values are: `SEARCH_TIER_STANDARD`, `SEARCH_TIER_ENTERPRISE`.
    ...
    @search_tier.setter
    def search_tier(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class TargetSiteFailureReasonQuotaFailureArgsDict(TypedDict):
        total_required_quota: NotRequired[pulumi.Input[builtins.int]]
        """
...
class TargetSiteFailureReasonQuotaFailureArgs:
    def __init__(__self__, *,
                 total_required_quota: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] total_required_quota: This number is an estimation on how much total quota this project
               needs to successfully complete indexing.
        """
    ...
    def total_required_quota(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        This number is an estimation on how much total quota this project
        needs to successfully complete indexing.
        """
    ...
    def total_required_quota(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_required_quota", value)


if not MYPY:
    class TargetSiteSiteVerificationInfoArgsDict(TypedDict):
        site_verification_state: NotRequired[pulumi.Input[builtins.str]]
        """
        Site verification state indicating the ownership and validity.
        Possible values are: `VERIFIED`, `UNVERIFIED`, `EXEMPTED`.
        """
        verify_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TargetSiteSiteVerificationInfoArgs:
    def __init__(__self__, *,
                 site_verification_state: Optional[pulumi.Input[builtins.str]] = None,
                 verify_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] site_verification_state: Site verification state indicating the ownership and validity.
               Possible values are: `VERIFIED`, `UNVERIFIED`, `EXEMPTED`.
        :param pulumi.Input[builtins.str] verify_time: Latest site verification time.
        """
    ...
    def site_verification_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Site verification state indicating the ownership and validity.
        Possible values are: `VERIFIED`, `UNVERIFIED`, `EXEMPTED`.
        """
    ...
    def site_verification_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "site_verification_state", value)

    @property
    @pulumi.getter(name="verifyTime")
    def verify_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Latest site verification time.
        """
    ...
    @verify_time.setter
    def verify_time(self, value: Optional[pulumi.Input[builtins.str]]):
