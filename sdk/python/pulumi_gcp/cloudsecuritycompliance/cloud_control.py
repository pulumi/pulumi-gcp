...
class CloudControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 organization: pulumi.Input[Optional[_builtins.str]] = None,
                 parameter_specs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudControlParameterSpecArgs', 'CloudControlParameterSpecArgsDict', 'outputs.CloudControlParameterSpec']]]]] = None,
                 parent: pulumi.Input[Optional[_builtins.str]] = None,
                 remediation_steps: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudControlRuleArgs', 'CloudControlRuleArgsDict', 'outputs.CloudControlRule']]]]] = None,
                 severity: pulumi.Input[Optional[_builtins.str]] = None,
                 supported_cloud_providers: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        * `{{parent}}/locations/{{location}}/cloudControls/{{cloud_control_id}}`
        ...
        :param pulumi.Input[_builtins.str] organization: (Optional, Deprecated)
               ...
               > **Warning:** Use `parent` instead.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CloudControlParameterSpecArgs', 'CloudControlParameterSpecArgsDict', 'outputs.CloudControlParameterSpec']]]] parameter_specs: The parameter spec of the cloud control.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] parent: The parent resource in which to create the resource.
               Must be in one of the following formats:
               * `projects/{{project}}`
        ...
        :param pulumi.Input[_builtins.str] remediation_steps: The remediation steps for the findings generated by the cloud control. The
               maximum length is 400 characters.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CloudControlRuleArgs', 'CloudControlRuleArgsDict', 'outputs.CloudControlRule']]]] rules: The Policy to be enforced to prevent/detect resource non-compliance.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] severity: Possible values:
               CRITICAL
               HIGH
