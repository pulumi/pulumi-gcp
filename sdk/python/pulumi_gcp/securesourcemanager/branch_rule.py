...
class BranchRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] require_comments_resolved: Determines if require comments resolved before merging to the branch.
        :param pulumi.Input[_builtins.bool] require_linear_history: Determines if require linear history before merging to the branch.
        :param pulumi.Input[_builtins.bool] require_pull_request: Determines if the branch rule requires a pull request or not.
        """
...
class _BranchRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] minimum_approvals_count: The minimum number of approvals required for the branch rule to be matched.
        :param pulumi.Input[_builtins.int] minimum_reviews_count: The minimum number of reviews required for the branch rule to be matched.
        :param pulumi.Input[_builtins.str] name: The resource name for the BranchRule.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] repository_id: The ID for the Repository.
        :param pulumi.Input[_builtins.bool] require_comments_resolved: Determines if require comments resolved before merging to the branch.
        :param pulumi.Input[_builtins.bool] require_linear_history: Determines if require linear history before merging to the branch.
        :param pulumi.Input[_builtins.bool] require_pull_request: Determines if the branch rule requires a pull request or not.
        :param pulumi.Input[_builtins.str] uid: Unique identifier of the BranchRule.
        :param pulumi.Input[_builtins.str] update_time: Time the BranchRule was updated in UTC.
        """
        if allow_stale_reviews is not None:
            pulumi.set(__self__, "allow_stale_reviews", allow_stale_reviews)
