...
class InstanceHostConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 git_http: Optional[builtins.str] = None,
                 git_ssh: Optional[builtins.str] = None,
                 html: Optional[builtins.str] = None):
        """
        :param builtins.str api: (Output)
               API hostname.
        :param builtins.str git_http: (Output)
               Git HTTP hostname.
        :param builtins.str git_ssh: (Output)
               Git SSH hostname.
        :param builtins.str html: (Output)
               HTML hostname.
        """
        if api is not None:
    ...
    def git_http(self) -> Optional[builtins.str]:
        """
        (Output)
        Git HTTP hostname.
        """
    ...
    def git_ssh(self) -> Optional[builtins.str]:
        """
        (Output)
        Git SSH hostname.
        """
...
class InstancePrivateConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 http_service_attachment: Optional[builtins.str] = None,
                 ssh_service_attachment: Optional[builtins.str] = None):
        """
        :param builtins.str ca_pool: CA pool resource, resource must in the format of `projects/{project}/locations/{location}/caPools/{ca_pool}`.
        :param builtins.bool is_private: 'Indicate if it's private instance.'
        :param builtins.str http_service_attachment: (Output)
               Service Attachment for HTTP, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        :param builtins.str ssh_service_attachment: (Output)
    ...
    def http_service_attachment(self) -> Optional[builtins.str]:
        """
        (Output)
        Service Attachment for HTTP, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        """
    ...
    def ssh_service_attachment(self) -> Optional[builtins.str]:
        """
        (Output)
        Service Attachment for SSH, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        """
...
class InstanceWorkforceIdentityFederationConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: 'Whether Workforce Identity Federation is enabled.'
        """
...
class RepositoryInitialConfig(dict):
    ...
    def __init__(__self__, *,
                 default_branch: Optional[builtins.str] = None,
                 gitignores: Optional[Sequence[builtins.str]] = None,
                 license: Optional[builtins.str] = None,
                 readme: Optional[builtins.str] = None):
        """
        :param builtins.str default_branch: Default branch name of the repository.
        :param Sequence[builtins.str] gitignores: List of gitignore template names user can choose from.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        :param builtins.str license: License template name user can choose from.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        :param builtins.str readme: README template name.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        """
    ...
    @property
    @pulumi.getter
    def gitignores(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def readme(self) -> Optional[builtins.str]:
        """
...
class RepositoryUri(dict):
    ...
    def __init__(__self__, *,
                 api: Optional[builtins.str] = None,
                 git_https: Optional[builtins.str] = None,
                 html: Optional[builtins.str] = None):
        """
        :param builtins.str api: (Output)
               API is the URI for API access.
        :param builtins.str git_https: (Output)
    ...
    def git_https(self) -> Optional[builtins.str]:
        """
        (Output)
        git_https is the git HTTPS URI for git operations.
        """
