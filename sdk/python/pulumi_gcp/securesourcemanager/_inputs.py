...
class InstanceHostConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] api: (Output)
               API hostname.
        :param pulumi.Input[_builtins.str] git_http: (Output)
               Git HTTP hostname.
        :param pulumi.Input[_builtins.str] git_ssh: (Output)
               Git SSH hostname.
        :param pulumi.Input[_builtins.str] html: (Output)
               HTML hostname.
        """
        if api is not None:
...
class InstancePrivateConfigArgsDict(TypedDict):
    ...
    """
    psc_allowed_projects: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
...
class InstancePrivateConfigArgs:
    def __init__(__self__, *,
                 ...
                 psc_allowed_projects: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] http_service_attachment: (Output)
               Service Attachment for HTTP, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] psc_allowed_projects: Optional. Additional allowed projects for setting up PSC connections.
               Instance host project is automatically allowed and does not need to be included in this list.
    ...
    def psc_allowed_projects(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Optional. Additional allowed projects for setting up PSC connections.
        Instance host project is automatically allowed and does not need to be included in this list.
        """
    ...
    @psc_allowed_projects.setter
    def psc_allowed_projects(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "psc_allowed_projects", value)
...
class InstanceWorkforceIdentityFederationConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: 'Whether Workforce Identity Federation is enabled.'
        """
...
class RepositoryInitialConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] gitignores: List of gitignore template names user can choose from.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        :param pulumi.Input[_builtins.str] license: License template name user can choose from.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        :param pulumi.Input[_builtins.str] readme: README template name.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        """
...
class RepositoryUriArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] api: (Output)
               API is the URI for API access.
        :param pulumi.Input[_builtins.str] git_https: (Output)
               git_https is the git HTTPS URI for git operations.
        :param pulumi.Input[_builtins.str] html: (Output)
               HTML is the URI for the user to view the repository in a browser.
        """
