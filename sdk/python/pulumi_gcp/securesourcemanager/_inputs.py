...
if not MYPY:
    class InstanceHostConfigArgsDict(TypedDict):
        ...
        API hostname.
        """
        git_http: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Git HTTP hostname.
        """
        git_ssh: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Git SSH hostname.
        """
        html: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        HTML hostname.
        """
...
class InstanceHostConfigArgs:
    def __init__(__self__, *,
                 ...
                 git_http: Optional[pulumi.Input[builtins.str]] = None,
                 git_ssh: Optional[pulumi.Input[builtins.str]] = None,
                 html: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] api: (Output)
               API hostname.
        :param pulumi.Input[builtins.str] git_http: (Output)
               Git HTTP hostname.
        :param pulumi.Input[builtins.str] git_ssh: (Output)
               Git SSH hostname.
        :param pulumi.Input[builtins.str] html: (Output)
               HTML hostname.
        """
        if api is not None:
    ...
    def git_http(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Git HTTP hostname.
        """
    ...
    @git_http.setter
    def git_http(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "git_http", value)

    @property
    @pulumi.getter(name="gitSsh")
    def git_ssh(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Git SSH hostname.
        """
    ...
    @git_ssh.setter
    def git_ssh(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class InstancePrivateConfigArgsDict(TypedDict):
        ...
        """
        is_private: pulumi.Input[builtins.bool]
        """
        'Indicate if it's private instance.'
        """
        http_service_attachment: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
        Service Attachment for HTTP, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        """
        ssh_service_attachment: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class InstancePrivateConfigArgs:
    def __init__(__self__, *,
                 ca_pool: pulumi.Input[builtins.str],
                 is_private: pulumi.Input[builtins.bool],
                 http_service_attachment: Optional[pulumi.Input[builtins.str]] = None,
                 ssh_service_attachment: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ca_pool: CA pool resource, resource must in the format of `projects/{project}/locations/{location}/caPools/{ca_pool}`.
        :param pulumi.Input[builtins.bool] is_private: 'Indicate if it's private instance.'
        :param pulumi.Input[builtins.str] http_service_attachment: (Output)
               Service Attachment for HTTP, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        :param pulumi.Input[builtins.str] ssh_service_attachment: (Output)
               Service Attachment for SSH, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        """
    ...
    def is_private(self) -> pulumi.Input[builtins.bool]:
        """
        'Indicate if it's private instance.'
        """
    ...
    @is_private.setter
    def is_private(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_private", value)

    @property
    @pulumi.getter(name="httpServiceAttachment")
    def http_service_attachment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Service Attachment for HTTP, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        """
    ...
    def http_service_attachment(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_service_attachment", value)

    @property
    @pulumi.getter(name="sshServiceAttachment")
    def ssh_service_attachment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        Service Attachment for SSH, resource is in the format of `projects/{project}/regions/{region}/serviceAttachments/{service_attachment}`.
        """
    ...
    def ssh_service_attachment(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstanceWorkforceIdentityFederationConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: 'Whether Workforce Identity Federation is enabled.'
        """
...
if not MYPY:
    class RepositoryInitialConfigArgsDict(TypedDict):
        default_branch: NotRequired[pulumi.Input[builtins.str]]
        """
        Default branch name of the repository.
        """
        gitignores: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        """
        readme: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RepositoryInitialConfigArgs:
    def __init__(__self__, *,
                 ...
                 gitignores: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 license: Optional[pulumi.Input[builtins.str]] = None,
                 readme: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] default_branch: Default branch name of the repository.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] gitignores: List of gitignore template names user can choose from.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        :param pulumi.Input[builtins.str] license: License template name user can choose from.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        :param pulumi.Input[builtins.str] readme: README template name.
               Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        """
    ...
    @property
    @pulumi.getter
    def gitignores(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of gitignore template names user can choose from.
        Valid values can be viewed at https://cloud.google.com/secure-source-manager/docs/reference/rest/v1/projects.locations.repositories#initialconfig.
        """
    ...
    @gitignores.setter
    def gitignores(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class RepositoryUriArgsDict(TypedDict):
        ...
        """
        git_https: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class RepositoryUriArgs:
    def __init__(__self__, *,
                 api: Optional[pulumi.Input[builtins.str]] = None,
                 git_https: Optional[pulumi.Input[builtins.str]] = None,
                 html: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] api: (Output)
               API is the URI for API access.
        :param pulumi.Input[builtins.str] git_https: (Output)
               git_https is the git HTTPS URI for git operations.
        :param pulumi.Input[builtins.str] html: (Output)
               HTML is the URI for the user to view the repository in a browser.
        """
    ...
    def git_https(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        git_https is the git HTTPS URI for git operations.
        """
    ...
    @git_https.setter
    def git_https(self, value: Optional[pulumi.Input[builtins.str]]):
