...
def get_instance_iam_policy(instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str location: The location for the Instance.
...
def get_instance_iam_policy_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
