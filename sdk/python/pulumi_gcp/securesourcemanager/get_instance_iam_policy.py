...
def get_instance_iam_policy(instance_id: Optional[builtins.str] = None,
...
def get_instance_iam_policy_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
