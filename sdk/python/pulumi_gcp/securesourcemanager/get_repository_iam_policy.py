...
def get_repository_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location for the Repository.
    ...
    :param _builtins.str repository_id: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
