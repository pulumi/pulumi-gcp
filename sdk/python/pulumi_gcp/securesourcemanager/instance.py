...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 state_note: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels as key value pairs.
               ...
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[builtins.str] location: The location for the Instance.
        :param pulumi.Input[builtins.str] name: The resource name for the Instance.
        :param pulumi.Input['InstancePrivateConfigArgs'] private_config: Private settings for private instance.
               Structure is documented below.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        ...
        :param pulumi.Input[builtins.str] state: The current state of the Instance.
        :param pulumi.Input[builtins.str] state_note: Provides information about the current instance state.
    ...
    def state_note(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @state_note.setter
    def state_note(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:securesourcemanager/instance:Instance"
    ...
    @property
    @pulumi.getter(name="stateNote")
    def state_note(self) -> pulumi.Output[builtins.str]:
        """
        Provides information about the current instance state.
        """
        return pulumi.get(self, "state_note")
