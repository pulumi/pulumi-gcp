...
class PeeredDnsDomainArgs:
    def __init__(__self__, *,
                 dns_suffix: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] dns_suffix: The DNS domain suffix of the peered DNS domain. Make sure to suffix with a `.` (dot).
        :param pulumi.Input[builtins.str] network: The network in the consumer project.
        :param pulumi.Input[builtins.str] name: Internal name used for the peered DNS domain.
        :param pulumi.Input[builtins.str] project: The producer project number. If not provided, the provider project is used.
        :param pulumi.Input[builtins.str] service: Private service connection between service and consumer network, defaults to `servicenetworking.googleapis.com`
        """
    ...
    def dns_suffix(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @dns_suffix.setter
    def dns_suffix(self, value: pulumi.Input[builtins.str]):
...
class _PeeredDnsDomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Internal name used for the peered DNS domain.
        :param pulumi.Input[builtins.str] network: The network in the consumer project.
        :param pulumi.Input[builtins.str] parent: an identifier for the resource with format `services/{{service}}/projects/{{project}}/global/networks/{{network}}`
        :param pulumi.Input[builtins.str] project: The producer project number. If not provided, the provider project is used.
        :param pulumi.Input[builtins.str] service: Private service connection between service and consumer network, defaults to `servicenetworking.googleapis.com`
        """
...
class PeeredDnsDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent: Optional[pulumi.Input[builtins.str]] = None,
            project: Optional[pulumi.Input[builtins.str]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None) -> 'PeeredDnsDomain':
        """
    ...
    @property
    @pulumi.getter(name="dnsSuffix")
    def dns_suffix(self) -> pulumi.Output[builtins.str]:
        """
        The DNS domain suffix of the peered DNS domain. Make sure to suffix with a `.` (dot).
        """
        return pulumi.get(self, "dns_suffix")
