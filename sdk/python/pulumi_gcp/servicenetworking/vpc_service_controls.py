...
class VpcServiceControlsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service: The service that is managing peering connectivity for a service
               producer's organization. For Google services that support this
               functionality, this value is `servicenetworking.googleapis.com`.
        :param pulumi.Input[_builtins.str] project: The id of the Google Cloud project containing the consumer network.
        """
...
class VpcServiceControls(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network: Optional[pulumi.Input[_builtins.str]] = None,
            project: Optional[pulumi.Input[_builtins.str]] = None,
            service: Optional[pulumi.Input[_builtins.str]] = None) -> 'VpcServiceControls':
        """
