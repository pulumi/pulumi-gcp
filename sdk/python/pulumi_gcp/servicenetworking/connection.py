...
class ConnectionArgs:
    def __init__(__self__, *,
                 ...
                 reserved_peering_ranges: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 service: pulumi.Input[builtins.str],
                 deletion_policy: Optional[pulumi.Input[builtins.str]] = None,
                 update_on_creation_fail: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Connection resource.
        :param pulumi.Input[builtins.str] network: Name of VPC network connected with service producers using VPC peering.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] reserved_peering_ranges: Named IP address range(s) of PEERING type reserved for
               this service provider. Note that invoking this method with a different range when connection
               is already established will not reallocate already provisioned service producer subnetworks.
        :param pulumi.Input[builtins.str] service: Provider peering service that is managing peering connectivity for a
               service provider organization. For Google services that support this functionality it is
               'servicenetworking.googleapis.com'.
        :param pulumi.Input[builtins.bool] update_on_creation_fail: When set to true, enforce an update of the reserved peering ranges on the existing service networking connection in case of a new connection creation failure.
        """
    ...
    def reserved_peering_ranges(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def reserved_peering_ranges(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def update_on_creation_fail(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def update_on_creation_fail(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ConnectionState:
    def __init__(__self__, *,
                 ...
                 reserved_peering_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 service: Optional[pulumi.Input[builtins.str]] = None,
                 update_on_creation_fail: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Input properties used for looking up and filtering Connection resources.
        :param pulumi.Input[builtins.str] network: Name of VPC network connected with service producers using VPC peering.
        :param pulumi.Input[builtins.str] peering: (Computed) The name of the VPC Network Peering connection that was created by the service producer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] reserved_peering_ranges: Named IP address range(s) of PEERING type reserved for
               this service provider. Note that invoking this method with a different range when connection
               is already established will not reallocate already provisioned service producer subnetworks.
        :param pulumi.Input[builtins.str] service: Provider peering service that is managing peering connectivity for a
    ...
    @property
    @pulumi.getter(name="reservedPeeringRanges")
    def reserved_peering_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Named IP address range(s) of PEERING type reserved for
        this service provider. Note that invoking this method with a different range when connection
        is already established will not reallocate already provisioned service producer subnetworks.
    ...
    @reserved_peering_ranges.setter
    def reserved_peering_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "reserved_peering_ranges", value)
...
class Connection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reserved_peering_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            service: Optional[pulumi.Input[builtins.str]] = None,
            update_on_creation_fail: Optional[pulumi.Input[builtins.bool]] = None) -> 'Connection':
        """
    ...
    @property
    @pulumi.getter(name="reservedPeeringRanges")
    def reserved_peering_ranges(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Named IP address range(s) of PEERING type reserved for
        this service provider. Note that invoking this method with a different range when connection
        is already established will not reallocate already provisioned service producer subnetworks.
    ...
    @property
    @pulumi.getter(name="updateOnCreationFail")
    def update_on_creation_fail(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set to true, enforce an update of the reserved peering ranges on the existing service networking connection in case of a new connection creation failure.
        """
        return pulumi.get(self, "update_on_creation_fail")
