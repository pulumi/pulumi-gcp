...
class GeminiGcpEnablementSettingArgs:
    ...
    def enable_customer_data_sharing(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class GeminiGcpEnablementSetting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'GeminiGcpEnablementSetting':
        """
    ...
    @property
    @pulumi.getter(name="enableCustomerDataSharing")
    def enable_customer_data_sharing(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether customer data sharing should be enabled.
        """
        return pulumi.get(self, "enable_customer_data_sharing")
