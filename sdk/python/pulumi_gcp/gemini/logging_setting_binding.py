...
class LoggingSettingBindingArgs:
    def __init__(__self__, *,
                 logging_setting_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] logging_setting_id: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
    ...
    def logging_setting_id(self, value: pulumi.Input[builtins.str]):
...
class _LoggingSettingBindingState:
    def __init__(__self__, *,
                 ...
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 logging_setting_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @logging_setting_id.setter
    def logging_setting_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "logging_setting_id", value)
...
class LoggingSettingBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            setting_binding_id: Optional[pulumi.Input[builtins.str]] = None,
            target: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'LoggingSettingBinding':
        """
