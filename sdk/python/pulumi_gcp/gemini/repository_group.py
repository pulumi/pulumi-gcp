...
class RepositoryGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] code_repository_index: Required. Id of the Code Repository Index.
...
class _RepositoryGroupState:
    def __init__(__self__, *,
                 ...
                 repositories: pulumi.Input[Optional[Sequence[pulumi.Input['RepositoryGroupRepositoryArgs']]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: Optional. Labels as key value pairs.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: The location of the Code Repository Index, for example `us-central1`.
        :param pulumi.Input[_builtins.str] name: Immutable. Identifier. Name of Repository Group.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
    ...
    @_builtins.property
    @pulumi.getter
    def repositories(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RepositoryGroupRepositoryArgs']]]]:
        """
        Required. List of repositories to group.
        Structure is documented below.
        """
    ...
    @repositories.setter
    def repositories(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RepositoryGroupRepositoryArgs']]]]):
        pulumi.set(self, "repositories", value)
