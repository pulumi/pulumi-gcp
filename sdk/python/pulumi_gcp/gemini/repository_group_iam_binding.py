...
class RepositoryGroupIamBindingArgs:
    def __init__(__self__, *,
                 code_repository_index: pulumi.Input[_builtins.str],
                 members: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 repository_group_id: pulumi.Input[_builtins.str],
                 role: pulumi.Input[_builtins.str],
                 condition: pulumi.Input[Optional['RepositoryGroupIamBindingConditionArgs']] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a RepositoryGroupIamBinding resource.

        :param pulumi.Input[_builtins.str] code_repository_index: Required. Id of the Code Repository Index. Used to find the parent resource to bind the IAM policy to
        ...
        :param pulumi.Input[_builtins.str] location: The location of the Code Repository Index, for example `us-central1`. Used to find the parent resource to bind the IAM policy to. If not specified,
    ...
    def code_repository_index(self, value: pulumi.Input[_builtins.str]):
    ...
    def repository_group_id(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['RepositoryGroupIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['RepositoryGroupIamBindingConditionArgs']]):
...
class _RepositoryGroupIamBindingState:
    def __init__(__self__, *,
                 code_repository_index: pulumi.Input[Optional[_builtins.str]] = None,
                 condition: pulumi.Input[Optional['RepositoryGroupIamBindingConditionArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="codeRepositoryIndex")
    def code_repository_index(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Required. Id of the Code Repository Index. Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "code_repository_index")
    ...
    @code_repository_index.setter
    def code_repository_index(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "code_repository_index", value)
    ...
    @_builtins.property
    @pulumi.getter(name="repositoryGroupId")
    def repository_group_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "repository_group_id")
    ...
    @repository_group_id.setter
    def repository_group_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "repository_group_id", value)
...
class RepositoryGroupIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 code_repository_index: pulumi.Input[Optional[_builtins.str]] = None,
                 condition: pulumi.Input[Optional[Union['RepositoryGroupIamBindingConditionArgs', 'RepositoryGroupIamBindingConditionArgsDict', 'outputs.RepositoryGroupIamBindingCondition']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 repository_group_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `gemini.RepositoryGroupIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the repositorygroup are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `gemini.RepositoryGroupIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the repositorygroup are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            project: pulumi.Input[Optional[_builtins.str]] = None,
            repository_group_id: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'RepositoryGroupIamBinding':
        """
