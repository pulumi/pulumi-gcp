...
def get_cloud_exadata_infrastructures(location: Optional[_builtins.str] = None,
...
def get_cloud_exadata_infrastructures_output(location: Optional[pulumi.Input[_builtins.str]] = None,
