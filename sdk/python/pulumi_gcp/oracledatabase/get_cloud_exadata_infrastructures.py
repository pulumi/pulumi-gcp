...
def get_cloud_exadata_infrastructures(location: Optional[builtins.str] = None,
...
def get_cloud_exadata_infrastructures_output(location: Optional[pulumi.Input[builtins.str]] = None,
