...
__all__ = ['GoldengateConnectionAssignmentArgs', 'GoldengateConnectionAssignment']

@pulumi.input_type
class GoldengateConnectionAssignmentArgs:
    def __init__(__self__, *,
                 goldengate_connection_assignment_id: pulumi.Input[_builtins.str],
                 location: pulumi.Input[_builtins.str],
                 properties: pulumi.Input['GoldengateConnectionAssignmentPropertiesArgs'],
        ...
        :param pulumi.Input[_builtins.str] goldengate_connection_assignment_id: The ID of the GoldengateConnectionAssignment to create.
        :param pulumi.Input[_builtins.str] location: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
        :param pulumi.Input['GoldengateConnectionAssignmentPropertiesArgs'] properties: The properties of a GoldengateConnectionAssignment.
        ...
        :param pulumi.Input[_builtins.str] display_name: The display name for the GoldengateConnectionAssignment.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels or tags associated with the GoldengateConnectionAssignment.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        """
        pulumi.set(__self__, "goldengate_connection_assignment_id", goldengate_connection_assignment_id)
    ...
    @_builtins.property
    @pulumi.getter(name="goldengateConnectionAssignmentId")
    def goldengate_connection_assignment_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the GoldengateConnectionAssignment to create.
        """
        return pulumi.get(self, "goldengate_connection_assignment_id")

    @goldengate_connection_assignment_id.setter
    def goldengate_connection_assignment_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "goldengate_connection_assignment_id", value)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input['GoldengateConnectionAssignmentPropertiesArgs']:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input['GoldengateConnectionAssignmentPropertiesArgs']):
...
@pulumi.input_type
class _GoldengateConnectionAssignmentState:
    def __init__(__self__, *,
                 ...
                 goldengate_connection_assignment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional['GoldengateConnectionAssignmentPropertiesArgs']] = None,
                 pulumi_labels: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering GoldengateConnectionAssignment resources.

        :param pulumi.Input[_builtins.str] create_time: The time when the connection assignment was created.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
               When set to "ABANDON", the command will remove the resource from Terraform
        ...
        :param pulumi.Input[_builtins.str] entitlement_id: The OCID of the entitlement linked to this resource.
        :param pulumi.Input[_builtins.str] goldengate_connection_assignment_id: The ID of the GoldengateConnectionAssignment to create.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: The labels or tags associated with the GoldengateConnectionAssignment.
               **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
               Please refer to the field `effective_labels` for all of the labels present on the resource.
        :param pulumi.Input[_builtins.str] location: Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
        :param pulumi.Input[_builtins.str] name: Identifier. The name of the GoldengateConnectionAssignment resource in the following
               format:
    ...
    @_builtins.property
    @pulumi.getter(name="goldengateConnectionAssignmentId")
    def goldengate_connection_assignment_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ID of the GoldengateConnectionAssignment to create.
        """
        return pulumi.get(self, "goldengate_connection_assignment_id")
    ...
    @goldengate_connection_assignment_id.setter
    def goldengate_connection_assignment_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "goldengate_connection_assignment_id", value)
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional['GoldengateConnectionAssignmentPropertiesArgs']]:
        """
        The properties of a GoldengateConnectionAssignment.
        Structure is documented below.
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional['GoldengateConnectionAssignmentPropertiesArgs']]):
        pulumi.set(self, "properties", value)
...
@pulumi.type_token("gcp:oracledatabase/goldengateConnectionAssignment:GoldengateConnectionAssignment")
class GoldengateConnectionAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        * `{{location}}/{{goldengate_connection_assignment_id}}`
        ...
        :param str resource_name: The name of the resource.
        :param GoldengateConnectionAssignmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GoldengateConnectionAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GoldengateConnectionAssignmentArgs.__new__(GoldengateConnectionAssignmentArgs)

            __props__.__dict__["deletion_policy"] = deletion_policy
            __props__.__dict__["deletion_protection"] = deletion_protection
            __props__.__dict__["display_name"] = display_name
            if goldengate_connection_assignment_id is None and not opts.urn:
                raise TypeError("Missing required property 'goldengate_connection_assignment_id'")
            __props__.__dict__["goldengate_connection_assignment_id"] = goldengate_connection_assignment_id
        ...
        super(GoldengateConnectionAssignment, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _GoldengateConnectionAssignmentState.__new__(_GoldengateConnectionAssignmentState)
        ...
        return GoldengateConnectionAssignment(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="goldengateConnectionAssignmentId")
    def goldengate_connection_assignment_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the GoldengateConnectionAssignment to create.
        """
        return pulumi.get(self, "goldengate_connection_assignment_id")
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.GoldengateConnectionAssignmentProperties']:
        """
        The properties of a GoldengateConnectionAssignment.
        Structure is documented below.
        """
