...
def get_db_nodes(cloud_vm_cluster: Optional[_builtins.str] = None,
    ...
    * `total_cpu_core_count` - The total number of CPU cores reserved on the database node.
    ...
    :param _builtins.str cloud_vm_cluster: The ID of the VM Cluster.
...
def get_db_nodes_output(cloud_vm_cluster: Optional[pulumi.Input[_builtins.str]] = None,
