...
class MessageBusArgs:
    def __init__(__self__, *,
                 ...
                 message_bus_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] crypto_key_name: Optional. Resource name of a KMS crypto key (managed by the user) used to
               encrypt/decrypt their event data.
               It must match the pattern
               `projects/*/locations/*/keyRings/*/cryptoKeys/*`.
        :param pulumi.Input[builtins.str] display_name: Optional. Resource display name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Optional. Resource labels.
    ...
    def message_bus_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def message_bus_id(self, value: pulumi.Input[builtins.str]):
...
class _MessageBusState:
    def __init__(__self__, *,
                 ...
                 logging_config: Optional[pulumi.Input['MessageBusLoggingConfigArgs']] = None,
                 message_bus_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Optional. Resource annotations.
               **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration.
               Please refer to the field `effective_annotations` for all of the annotations present on the resource.
        :param pulumi.Input[builtins.str] create_time: Output only. The creation time.
        :param pulumi.Input[builtins.str] crypto_key_name: Optional. Resource name of a KMS crypto key (managed by the user) used to
               encrypt/decrypt their event data.
               It must match the pattern
               `projects/*/locations/*/keyRings/*/cryptoKeys/*`.
        ...
        :param pulumi.Input[builtins.str] uid: Output only. Server assigned unique identifier for the channel. The value is a UUID4
    ...
    @property
    @pulumi.getter(name="messageBusId")
    def message_bus_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required. The user-provided ID to be assigned to the MessageBus. It should match the
        format `^a-z?$`.
    ...
    @message_bus_id.setter
    def message_bus_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "message_bus_id", value)
...
class MessageBus(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'MessageBus':
        """
    ...
    @property
    @pulumi.getter(name="messageBusId")
    def message_bus_id(self) -> pulumi.Output[builtins.str]:
        """
        Required. The user-provided ID to be assigned to the MessageBus. It should match the
        format `^a-z?$`.
