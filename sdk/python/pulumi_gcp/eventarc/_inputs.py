...
__all__ = [
    ...
    'PipelineIamBindingConditionArgsDict',
    'PipelineIamMemberConditionArgs',
    'PipelineIamMemberConditionArgsDict',
...
class PipelineDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['PipelineDestinationHttpEndpointArgs'] http_endpoint: Represents a HTTP endpoint destination.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] message_bus: The resource name of the Message Bus to which events should be
               published. The Message Bus resource should exist in the same project as
               the Pipeline. Format:
               `projects/{project}/locations/{location}/messageBuses/{message_bus}`
        ...
        :param pulumi.Input['PipelineDestinationOutputPayloadFormatArgs'] output_payload_format: Represents the format of message data.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] topic: The resource name of the Pub/Sub topic to which events should be
               published. Format:
               `projects/{project}/locations/{location}/topics/{topic}`
        :param pulumi.Input[_builtins.str] workflow: The resource name of the Workflow whose Executions are triggered by
               the events. The Workflow resource should be deployed in the same
               project as the Pipeline. Format:
               `projects/{project}/locations/{location}/workflows/{workflow}`
        """
...
class PipelineDestinationAuthenticationConfigGoogleOidcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_account: Service account email used to generate the OIDC Token.
               ...
               roles/roles/iam.serviceAccountTokenCreator role to allow the
               Pipeline to create OpenID tokens for authenticated requests.
        :param pulumi.Input[_builtins.str] audience: Audience to be used to generate the OIDC Token. The audience claim
               identifies the recipient that the JWT is intended for. If
               unspecified, the destination URI will be used.
        """
...
class PipelineDestinationAuthenticationConfigOauthTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_account: Service account email used to generate the [OAuth
               ...
               roles/roles/iam.serviceAccountTokenCreator role to allow Pipeline
               to create OAuth2 tokens for authenticated requests.
        :param pulumi.Input[_builtins.str] scope: OAuth scope to be used for generating OAuth access token. If not
               specified, "https://www.googleapis.com/auth/cloud-platform" will be
               used.
        """
        pulumi.set(__self__, "service_account", service_account)
...
class PipelineDestinationHttpEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] uri: The URI of the HTTP enpdoint.
               ...
               Examples: `https://svc.us-central1.p.local:8080/route`.
               Only the HTTPS protocol is supported.
        :param pulumi.Input[_builtins.str] message_binding_template: The CEL expression used to modify how the destination-bound HTTP
               request is constructed.
               If a binding expression is not specified here, the message
               is treated as a CloudEvent and is mapped to the HTTP request according
               to the CloudEvent HTTP Protocol Binding Binary Content Mode
...
class PipelineIamBindingConditionArgsDict(TypedDict):
    expression: pulumi.Input[_builtins.str]
    title: pulumi.Input[_builtins.str]
    description: NotRequired[pulumi.Input[Optional[_builtins.str]]]

@pulumi.input_type
class PipelineIamBindingConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[_builtins.str],
                 title: pulumi.Input[_builtins.str],
...
class PipelineIamMemberConditionArgsDict(TypedDict):
    expression: pulumi.Input[_builtins.str]
    title: pulumi.Input[_builtins.str]
    description: NotRequired[pulumi.Input[Optional[_builtins.str]]]

@pulumi.input_type
class PipelineIamMemberConditionArgs:
    def __init__(__self__, *,
                 expression: pulumi.Input[_builtins.str],
                 title: pulumi.Input[_builtins.str],
                 description: pulumi.Input[Optional[_builtins.str]] = None):
...
class PipelineRetryPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_attempts: The maximum number of delivery attempts for any message. The value must
               be between 1 and 100.
               The default value for this field is 5.
        :param pulumi.Input[_builtins.str] max_retry_delay: The maximum amount of seconds to wait between retry attempts. The value
               must be between 1 and 600.
               The default value for this field is 60.
        :param pulumi.Input[_builtins.str] min_retry_delay: The minimum amount of seconds to wait between retry attempts. The value
               must be between 1 and 600.
               The default value for this field is 5.
        """
...
class TriggerDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TriggerDestinationNetworkConfigArgs'] network_config: Optional. Network config is used to configure how Eventarc resolves and connect to a destination. This should only be used with HttpEndpoint destination type.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] workflow: The resource name of the Workflow whose Executions are triggered by the events. The Workflow resource should be deployed in the same project as the trigger. Format: `projects/{project}/locations/{location}/workflows/{workflow}`
        """
...
class TriggerDestinationCloudRunServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Required. The region the Cloud Run service is deployed in.
        """
...
class TriggerDestinationGkeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] namespace: Required. The namespace the GKE service is running in.
        :param pulumi.Input[_builtins.str] service: Required. Name of the GKE service.
        :param pulumi.Input[_builtins.str] path: Optional. The relative path on the GKE service the events should be sent to. The value must conform to the definition of a URI path segment (section 3.3 of RFC2396). Examples: "/route", "route", "route/subroute".
        """
...
class TriggerDestinationHttpEndpointArgs:
    def __init__(__self__, *,
                 uri: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] uri: Required. The URI of the HTTP enpdoint. The value must be a RFC2396 URI string. Examples: `http://10.10.10.8:80/route`, `http://svc.us-central1.p.local:8080/`. Only HTTP and HTTPS protocols are supported. The host can be either a static IP addressable from the VPC specified by the network config, or an internal DNS hostname of the service resolvable via Cloud DNS.
        """
        pulumi.set(__self__, "uri", uri)
...
class TriggerDestinationNetworkConfigArgs:
    def __init__(__self__, *,
                 network_attachment: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] network_attachment: Required. Name of the NetworkAttachment that allows access to the destination VPC. Format: `projects/{PROJECT_ID}/regions/{REGION}/networkAttachments/{NETWORK_ATTACHMENT_NAME}`
        """
        pulumi.set(__self__, "network_attachment", network_attachment)
...
class TriggerMatchingCriteriaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] operator: Optional. The operator used for matching the events with the value of the filter. If not specified, only events that have an exact key-value pair specified in the filter are matched. The only allowed value is `match-path-pattern`.
        """
...
class TriggerTransportPubsubArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subscription: (Output)
               Output only. The name of the Pub/Sub subscription created and managed by Eventarc system as a transport for the event delivery. Format: `projects/{PROJECT_ID}/subscriptions/{SUBSCRIPTION_NAME}`.
        :param pulumi.Input[_builtins.str] topic: Optional. The name of the Pub/Sub topic created and managed by Eventarc system as a transport for the event delivery. Format: `projects/{PROJECT_ID}/topics/{TOPIC_NAME}. You may set an existing topic for triggers of the type google.cloud.pubsub.topic.v1.messagePublished` only. The topic you provide here will not be deleted by Eventarc at trigger deletion.
        """
