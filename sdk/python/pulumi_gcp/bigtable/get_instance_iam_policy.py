...
@pulumi.output_type
calass GetInstanceIamPolicyResult:
    """
...
calass AwaitableGetInstanceIamPolicyResult(GetInstanceIamPolicyResult):
...
def get_instance_iam_policy(instance: Optional[str] = None,
    ...
    policy = gcp.bigtable.get_instance_iam_policy(instance=google_bigtable_instance["instance"]["name"])
    ```
