...
def get_instance_iam_policy(instance: Optional[builtins.str] = None,
    ...
    :param builtins.str instance: The name or relative resource id of the instance to manage IAM policies for.
    """
    __args__ = dict()
    __args__['instance'] = instance
    __args__['project'] = project
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('gcp:bigtable/getInstanceIamPolicy:getInstanceIamPolicy', __args__, opts=opts, typ=GetInstanceIamPolicyResult).value
...
def get_instance_iam_policy_output(instance: Optional[pulumi.Input[builtins.str]] = None,
