...
class TableArgs:
    def __init__(__self__, *,
                 ...
                 change_stream_retention: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] deletion_protection: A field to make the table protected against data loss i.e. when set to PROTECTED, deleting the table, the column families in the table, and the instance containing the table would be prohibited. If not provided, deletion protection will be set to UNPROTECTED.
    ...
    def change_stream_retention(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def change_stream_retention(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @split_keys.setter
    def split_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Table(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="changeStreamRetention")
    def change_stream_retention(self) -> pulumi.Output[builtins.str]:
        """
        Duration to retain change stream data for the table. Set to 0 to disable. Must be between 1 and 7 days.
        """
        return pulumi.get(self, "change_stream_retention")
