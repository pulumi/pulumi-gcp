...
class MaterializedViewArgs:
    def __init__(__self__, *,
                 materialized_view_id: pulumi.Input[_builtins.str],
    ...
    def materialized_view_id(self, value: pulumi.Input[_builtins.str]):
...
class _MaterializedViewState:
    def __init__(__self__, *,
                 ...
                 deletion_protection: pulumi.Input[Optional[_builtins.bool]] = None,
                 instance: pulumi.Input[Optional[_builtins.str]] = None,
                 materialized_view_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] instance: The name of the instance to create the materialized view within.
        :param pulumi.Input[_builtins.str] materialized_view_id: The unique name of the materialized view in the form `[_a-zA-Z0-9][-_.a-zA-Z0-9]*`.
        :param pulumi.Input[_builtins.str] name: The unique name of the requested materialized view. Values are of the form `projects/<project>/instances/<instance>/materializedViews/<materializedViewId>`.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] query: The materialized view's select query.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="materializedViewId")
    def materialized_view_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The unique name of the materialized view in the form `[_a-zA-Z0-9][-_.a-zA-Z0-9]*`.
        """
        return pulumi.get(self, "materialized_view_id")
    ...
    @materialized_view_id.setter
    def materialized_view_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "materialized_view_id", value)
...
class MaterializedView(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            query: pulumi.Input[Optional[_builtins.str]] = None) -> 'MaterializedView':
        """
