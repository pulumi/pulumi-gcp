...
class SchemaBundle(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 instance: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 proto_schema: pulumi.Input[Optional[Union['SchemaBundleProtoSchemaArgs', 'SchemaBundleProtoSchemaArgsDict', 'outputs.SchemaBundleProtoSchema']]] = None,
                 schema_bundle_id: pulumi.Input[Optional[_builtins.str]] = None,
                 table: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * `{{instance}}/{{table}}/{{schema_bundle_id}}`
        ...
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Union['SchemaBundleProtoSchemaArgs', 'SchemaBundleProtoSchemaArgsDict', 'outputs.SchemaBundleProtoSchema']] proto_schema: File descriptor set, generated by protoc.
               To generate, use protoc with imports and source info included. For an example test.proto file, the following command would put the value in a new file named out.pb.
               $ protoc --include_imports --include_source_info test.proto -o out.pb
               Structure is documented below.
        :param pulumi.Input[_builtins.str] schema_bundle_id: The unique name of the schema bundle in the form `[_a-zA-Z0-9][-_.a-zA-Z0-9]*`.
