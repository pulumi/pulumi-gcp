...
class AuthorizedViewArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_name: The name of the Bigtable instance in which the authorized view belongs.
        :param pulumi.Input[builtins.str] table_name: The name of the Bigtable table in which the authorized view belongs.
        :param pulumi.Input[builtins.str] name: The name of the authorized view. Must be 1-50 characters and must only contain hyphens, underscores, periods, letters and numbers.
...
class AuthorizedView(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            subset_view: Optional[pulumi.Input[Union['AuthorizedViewSubsetViewArgs', 'AuthorizedViewSubsetViewArgsDict']]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthorizedView':
        """
