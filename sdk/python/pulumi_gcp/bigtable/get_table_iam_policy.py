...
def get_table_iam_policy(instance: Optional[builtins.str] = None,
    ...
    :param builtins.str instance: The name or relative resource id of the instance that owns the table.
    :param builtins.str table: The name or relative resource id of the table to manage IAM policies for.
    """
    __args__ = dict()
...
def get_table_iam_policy_output(instance: Optional[pulumi.Input[builtins.str]] = None,
