...
class WorkloadArgs:
    ...
    def discovered_workload(self, value: pulumi.Input[_builtins.str]):
...
class _WorkloadState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: User-defined name for the Workload.
        :param pulumi.Input[_builtins.str] location: Part of `parent`.  Full resource name of a parent Application. Example: projects/{HOST_PROJECT_ID}/locations/{LOCATION}/applications/{APPLICATION_ID}
        :param pulumi.Input[_builtins.str] name: Identifier. The resource name of the Workload. Format:"projects/{host-project-id}/locations/{location}/applications/{application-id}/workloads/{workload-id}"
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] state: Output only. Workload state. Possible values:  STATE_UNSPECIFIED CREATING ACTIVE DELETING DETACHED
