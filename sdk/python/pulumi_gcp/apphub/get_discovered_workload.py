...
def get_discovered_workload(location: Optional[_builtins.str] = None,
                            project: Optional[_builtins.str] = None,
                            workload_uri: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project: The host project of the discovered workload.
    :param _builtins.str workload_uri: The uri of the workload (instance group managed by the Instance Group Manager). Example: "//compute.googleapis.com/projects/1/regions/us-east1/instanceGroups/id1"
    """
    __args__ = dict()
