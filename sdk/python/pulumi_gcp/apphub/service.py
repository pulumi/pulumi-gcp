...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 discovered_service: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] display_name: User-defined name for the Service.
    ...
    def discovered_service(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def discovered_service(self, value: pulumi.Input[builtins.str]):
...
class _ServiceState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 discovered_service: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: User-defined name for the Service.
        :param pulumi.Input[builtins.str] location: Part of `parent`.  Full resource name of a parent Application. Example: projects/{HOST_PROJECT_ID}/locations/{LOCATION}/applications/{APPLICATION_ID}
        :param pulumi.Input[builtins.str] name: Identifier. The resource name of a Service. Format:
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ServiceServiceReferenceArgs']]] service_references: Reference to an underlying networking resource that can comprise a Service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] state: Output only. Service state. Possible values: STATE_UNSPECIFIED CREATING ACTIVE DELETING DETACHED
        :param pulumi.Input[builtins.str] uid: Output only. A universally unique identifier (UUID) for the `Service` in the UUID4
               format.
    ...
    @property
    @pulumi.getter(name="discoveredService")
    def discovered_service(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Immutable. The resource name of the original discovered service.
        """
        return pulumi.get(self, "discovered_service")
    ...
    @discovered_service.setter
    def discovered_service(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "discovered_service", value)
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            uid: Optional[pulumi.Input[builtins.str]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Service':
        """
    ...
    @property
    @pulumi.getter(name="discoveredService")
    def discovered_service(self) -> pulumi.Output[builtins.str]:
        """
        Immutable. The resource name of the original discovered service.
        """
        return pulumi.get(self, "discovered_service")
