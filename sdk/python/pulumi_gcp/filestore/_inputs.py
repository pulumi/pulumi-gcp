...
class InstanceDirectoryServicesLdapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] groups_ou: The groups Organizational Unit (OU) is optional. This parameter is a hint
               to allow faster lookup in the LDAP namespace. In case that this parameter
               is not provided, Filestore instance will query the whole LDAP namespace.
        :param pulumi.Input[_builtins.str] users_ou: The users Organizational Unit (OU) is optional. This parameter is a hint
               to allow faster lookup in the LDAP namespace. In case that this parameter
               is not provided, Filestore instance will query the whole LDAP namespace.
        """
...
class InstanceEffectiveReplicationReplicaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] last_active_sync_time: (Output)
               ...
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits.
               Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z"
        :param pulumi.Input[_builtins.str] peer_instance: The peer instance.
        :param pulumi.Input[_builtins.str] state: (Output)
               Output only. The replica state
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] state_reasons: (Output)
               Output only. Additional information about the replication state, if available.
        """
...
class InstanceFileSharesNfsExportOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] access_mode: Either READ_ONLY, for allowing only read requests on the exported directory,
               ...
               Default value is `READ_WRITE`.
               Possible values are: `READ_ONLY`, `READ_WRITE`.
        :param pulumi.Input[_builtins.int] anon_gid: An integer representing the anonymous group id with a default value of 65534.
               Anon_gid may only be set with squashMode of ROOT_SQUASH. An error will be returned
               if this field is specified for other squashMode settings.
        :param pulumi.Input[_builtins.int] anon_uid: An integer representing the anonymous user id with a default value of 65534.
               Anon_uid may only be set with squashMode of ROOT_SQUASH. An error will be returned
               if this field is specified for other squashMode settings.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_ranges: List of either IPv4 addresses, or ranges in CIDR notation which may mount the file share.
               Overlapping IP ranges are not allowed, both within and across NfsExportOptions. An error will be returned.
               The limit is 64 IP ranges/addresses for each FileShareConfig among all NfsExportOptions.
        :param pulumi.Input[_builtins.str] network: The source VPC network for `ip_ranges`.
               Required for instances using Private Service Connect, optional otherwise.
        :param pulumi.Input[_builtins.str] squash_mode: Either NO_ROOT_SQUASH, for allowing root access on the exported directory, or ROOT_SQUASH,
               for not allowing root access. The default is NO_ROOT_SQUASH.
               Default value is `NO_ROOT_SQUASH`.
               Possible values are: `NO_ROOT_SQUASH`, `ROOT_SQUASH`.
        """
...
class InstanceInitialReplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceInitialReplicationReplicaArgs']]] replicas: The replication role.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] role: The replication role.
               Default value is `STANDBY`.
               Possible values are: `ROLE_UNSPECIFIED`, `ACTIVE`, `STANDBY`.
        """
        if replicas is not None:
...
class InstanceNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] modes: IP versions for which the instance has
               IP addresses assigned.
               Each value may be one of: `ADDRESS_MODE_UNSPECIFIED`, `MODE_IPV4`, `MODE_IPV6`.
        :param pulumi.Input[_builtins.str] network: The name of the GCE VPC network to which the
               instance is connected.
        :param pulumi.Input[_builtins.str] connect_mode: The network connect mode of the Filestore instance.
               If not provided, the connect mode defaults to
               DIRECT_PEERING.
               Default value is `DIRECT_PEERING`.
               Possible values are: `DIRECT_PEERING`, `PRIVATE_SERVICE_ACCESS`, `PRIVATE_SERVICE_CONNECT`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_addresses: (Output)
               A list of IPv4 or IPv6 addresses.
        :param pulumi.Input['InstanceNetworkPscConfigArgs'] psc_config: Private Service Connect configuration.
               Should only be set when connect_mode is PRIVATE_SERVICE_CONNECT.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] reserved_ip_range: A /29 CIDR block that identifies the range of IP
               addresses reserved for this instance.
        """
