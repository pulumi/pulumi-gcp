...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceNetworkArgs']]] networks: VPC networks to which the instance is connected. For this version,
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.str] tier: The service tier of the instance.
        ...
        :param pulumi.Input[_builtins.str] protocol: Either NFSv3, for using NFS version 3 as file sharing protocol,
        ...
        :param pulumi.Input[_builtins.str] zone: (Optional, Deprecated)
