...
class ExternalAccessRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ip_protocol: The IP protocol to which the external access rule applies.
        :param pulumi.Input[_builtins.str] parent: The resource name of the network policy.
