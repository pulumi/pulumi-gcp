...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] parent: The resource name of the private cloud to create a new cluster in.
...
class _ClusterState:
    def __init__(__self__, *,
                 autoscaling_settings: Optional[pulumi.Input['ClusterAutoscalingSettingsArgs']] = None,
                 management: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 node_type_configs: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterNodeTypeConfigArgs']]]] = None,
    ...
    @property
    @pulumi.getter
    def management(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @management.setter
    def management(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Cluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def management(self) -> pulumi.Output[builtins.bool]:
        """
        True if the cluster is a management cluster; false otherwise.
        There can only be one management cluster in a private cloud and it has to be the first one.
        """
