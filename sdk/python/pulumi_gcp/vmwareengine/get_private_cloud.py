...
class GetPrivateCloudResult:
    ...
    def deletion_delay_hours(self) -> builtins.int:
    ...
    def send_deletion_delay_hours_if_zero(self) -> builtins.bool:
...
def get_private_cloud(location: Optional[builtins.str] = None,
...
def get_private_cloud_output(location: Optional[pulumi.Input[builtins.str]] = None,
