...
class ClusterAutoscalingSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cool_down_period: The minimum duration between consecutive autoscale operations.
               ...
               Cool down period must be in whole minutes (for example, 30m, 31m, 50m).
               Mandatory for successful addition of autoscaling settings in cluster.
        :param pulumi.Input[_builtins.int] max_cluster_node_count: Maximum number of nodes of any type in a cluster.
               Mandatory for successful addition of autoscaling settings in cluster.
        :param pulumi.Input[_builtins.int] min_cluster_node_count: Minimum number of nodes of any type in a cluster.
               Mandatory for successful addition of autoscaling settings in cluster.
        """
...
class ClusterAutoscalingSettingsAutoscalingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] scale_out_size: Number of nodes to add to a cluster during a scale-out operation.
               Must be divisible by 2 for stretched clusters.
...
class ClusterAutoscalingSettingsAutoscalingPolicyConsumedMemoryThresholdsArgs:
    def __init__(__self__, *,
                 ...
                 scale_out: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] scale_in: The utilization triggering the scale-in operation in percent.
        :param pulumi.Input[_builtins.int] scale_out: The utilization triggering the scale-out operation in percent.
        """
...
class ClusterNodeTypeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] custom_core_count: Customized number of cores available to each node of the type.
               This number must always be one of `nodeType.availableCustomCoreCounts`.
               If zero is provided max value from `nodeType.availableCustomCoreCounts` will be used.
               Once the customer is created then corecount cannot be changed.
        """
...
class PrivateCloudManagementClusterStretchedClusterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] preferred_location: Zone that will remain operational when connection between the two zones is lost.
               Specify the zone in the following format: projects/{project}/locations/{location}.
        :param pulumi.Input[_builtins.str] secondary_location: Additional zone for a higher level of availability and load balancing.
               Specify the zone in the following format: projects/{project}/locations/{location}.
        """
...
class PrivateCloudNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dns_server_ip: (Output)
               DNS Server IP of the Private Cloud.
        :param pulumi.Input[_builtins.int] management_ip_address_layout_version: (Output)
               The IP address layout version of the management IP address range.
               Possible versions include:
               * managementIpAddressLayoutVersion=1: Indicates the legacy IP address layout used by some existing private clouds. This is no longer supported for new private clouds
               as it does not support all features.
        ...
        :param pulumi.Input[_builtins.str] vmware_engine_network: The relative resource name of the VMware Engine network attached to the private cloud.
               Specify the name in the following form: projects/{project}/locations/{location}/vmwareEngineNetworks/{vmwareEngineNetworkId}
               where {project} can either be a project number or a project ID.
        :param pulumi.Input[_builtins.str] vmware_engine_network_canonical: (Output)
               The canonical name of the VMware Engine network in
               the form: projects/{project_number}/locations/{location}/vmwareEngineNetworks/{vmwareEngineNetworkId}
        """
...
class SubnetDhcpAddressRangeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] first_address: (Output)
               The first IP address of the range.
        :param pulumi.Input[_builtins.str] last_address: (Output)
               The last IP address of the range.
        """
