...
def get_network_policy(location: Optional[builtins.str] = None,
    ...
    * [API documentation](https://cloud.google.com/vmware-engine/docs/reference/rest/v1/projects.locations.networkPolicies)
    ...
    :param builtins.str location: Location of the resource.
...
def get_network_policy_output(location: Optional[pulumi.Input[builtins.str]] = None,
