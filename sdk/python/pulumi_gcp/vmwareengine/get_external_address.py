...
def get_external_address(name: Optional[builtins.str] = None,
    ...
    * [API documentation](https://cloud.google.com/vmware-engine/docs/reference/rest/v1/projects.locations.privateClouds.externalAddresses)
    ...
    :param builtins.str parent: The resource name of the private cloud that this cluster belongs.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_external_address_output(name: Optional[pulumi.Input[builtins.str]] = None,
