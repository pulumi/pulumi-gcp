...
class SubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The ID of the subnet. For userDefined subnets, this name should be in the format of "service-n",
...
class _SubnetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] parent: The resource name of the private cloud to create a new subnet in.
               Resource names are schemeless URIs that follow the conventions in https://cloud.google.com/apis/design/resource_names.
               For example: projects/my-project/locations/us-west1-a/privateClouds/my-cloud
        :param pulumi.Input[_builtins.bool] standard_config: Whether the NSX-T configuration in the backend follows the standard configuration supported by Google Cloud.
               If false, the subnet cannot be modified through Google Cloud, only through NSX-T directly.
        :param pulumi.Input[_builtins.str] state: State of the subnet.
        :param pulumi.Input[_builtins.str] type: The type of the subnet.
        ...
        :param pulumi.Input[_builtins.int] vlan_id: VLAN ID of the VLAN on which the subnet is configured.
        """
