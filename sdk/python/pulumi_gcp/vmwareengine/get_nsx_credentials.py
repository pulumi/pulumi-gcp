...
def get_nsx_credentials(parent: Optional[builtins.str] = None,
    ...
    * [API documentation](https://cloud.google.com/vmware-engine/docs/reference/rest/v1/projects.locations.privateClouds/showNsxCredentials)
    ...
    :param builtins.str parent: The resource name of the private cloud which contains the NSX.
    """
    __args__ = dict()
...
def get_nsx_credentials_output(parent: Optional[pulumi.Input[builtins.str]] = None,
