...
def get_external_access_rule(name: Optional[_builtins.str] = None,
    ...
    * [API documentation](https://cloud.google.com/vmware-engine/docs/reference/rest/v1/projects.locations.networkPolicies.externalAccessRules)
    ...
    :param _builtins.str parent: The resource name of the network policy that this cluster belongs.
    """
    __args__ = dict()
    __args__['name'] = name
