...
class HostProjectRegistrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] host_project_registration_id: Required. The ID to use for the Host Project Registration, which will become the
...
class _HostProjectRegistrationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] host_project_registration_id: Required. The ID to use for the Host Project Registration, which will become the
               ...
               host_project_registration.gcp_project field.
        :param pulumi.Input[_builtins.str] location: Part of `parent`. See documentation of `projectsId`.
        :param pulumi.Input[_builtins.str] name: Identifier. The name of the host project registration.
               Format:
