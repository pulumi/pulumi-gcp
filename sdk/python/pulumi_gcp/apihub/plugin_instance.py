...
class PluginInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 actions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluginInstanceActionArgs', 'PluginInstanceActionArgsDict', 'outputs.PluginInstanceAction']]]]] = None,
                 auth_config: pulumi.Input[Optional[Union['PluginInstanceAuthConfigArgs', 'PluginInstanceAuthConfigArgsDict', 'outputs.PluginInstanceAuthConfig']]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 disable: pulumi.Input[Optional[_builtins.bool]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `{{location}}/{{plugin}}/{{plugin_instance_id}}`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluginInstanceActionArgs', 'PluginInstanceActionArgsDict', 'outputs.PluginInstanceAction']]]] actions: The action status for the plugin instance.
               Structure is documented below.
        :param pulumi.Input[Union['PluginInstanceAuthConfigArgs', 'PluginInstanceAuthConfigArgsDict', 'outputs.PluginInstanceAuthConfig']] auth_config: AuthConfig represents the authentication information.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the resource. Defaults to DELETE.
               When a 'terraform destroy' or 'pulumi up' would delete the resource,
               the command will fail if this field is set to "PREVENT" in Terraform state.
