...
class GetTriggerResult:
    ...
    def ignored_files(self) -> Sequence[builtins.str]:
    ...
    def included_files(self) -> Sequence[builtins.str]:
...
def get_trigger(location: Optional[builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param builtins.str trigger_id: The unique identifier for the trigger..
    """
    __args__ = dict()
...
def get_trigger_output(location: Optional[pulumi.Input[builtins.str]] = None,
