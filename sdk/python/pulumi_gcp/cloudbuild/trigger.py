...
class TriggerArgs:
    def __init__(__self__, *,
                 ...
                 ignored_files: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_build_logs: Optional[pulumi.Input[builtins.str]] = None,
                 included_files: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input['TriggerBuildArgs'] build: Contents of the build template. Either a filename or build template must be provided.
               Structure is documented below.
        :param pulumi.Input[builtins.str] description: Human-readable description of the trigger.
        :param pulumi.Input[builtins.bool] disabled: Whether the trigger is disabled or not. If true, the trigger will never result in a build.
        :param pulumi.Input[builtins.str] filename: Path, from the source root, to a file whose contents is used for the template.
               Either a filename or build template must be provided. Set this only when using trigger_template or github.
               When using Pub/Sub, Webhook or Manual set the file name using git_file_source instead.
        :param pulumi.Input[builtins.str] filter: A Common Expression Language string. Used only with Pub/Sub and Webhook.
        ...
        :param pulumi.Input['TriggerGithubArgs'] github: Describes the configuration of a trigger that creates a build whenever a GitHub event is received.
               ...
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ignored_files: ignoredFiles and includedFiles are file glob matches using https://golang.org/pkg/path/filepath/#Match
        ...
        :param pulumi.Input[builtins.str] include_build_logs: Build logs will be sent back to GitHub as part of the checkrun
               result.  Values can be INCLUDE_BUILD_LOGS_UNSPECIFIED or
               INCLUDE_BUILD_LOGS_WITH_STATUS
               Possible values are: `INCLUDE_BUILD_LOGS_UNSPECIFIED`, `INCLUDE_BUILD_LOGS_WITH_STATUS`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_files: ignoredFiles and includedFiles are file glob matches using https://golang.org/pkg/path/filepath/#Match
               extended with support for `**`.
               ...
               a build.
        :param pulumi.Input[builtins.str] location: The [Cloud Build location](https://cloud.google.com/build/docs/locations) for the trigger.
               If not specified, "global" is used.
        :param pulumi.Input[builtins.str] name: Name of the trigger. Must be unique within the project.
        ...
        :param pulumi.Input['TriggerRepositoryEventConfigArgs'] repository_event_config: The configuration of a trigger that creates a build whenever an event from Repo API is received.
               Structure is documented below.
        :param pulumi.Input[builtins.str] service_account: The service account used for all user-controlled operations including
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags for annotation of a BuildTrigger
    ...
    def ignored_files(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ignored_files(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "ignored_files", value)

    @property
    @pulumi.getter(name="includeBuildLogs")
    def include_build_logs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def include_build_logs(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "include_build_logs", value)

    @property
    @pulumi.getter(name="includedFiles")
    def included_files(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        ignoredFiles and includedFiles are file glob matches using https://golang.org/pkg/path/filepath/#Match
        extended with support for `**`.
        If any of the files altered in the commit pass the ignoredFiles filter
    ...
    def included_files(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _TriggerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TriggerBuildArgs'] build: Contents of the build template. Either a filename or build template must be provided.
               Structure is documented below.
        :param pulumi.Input[builtins.str] create_time: Time when the trigger was created.
        :param pulumi.Input[builtins.str] description: Human-readable description of the trigger.
        :param pulumi.Input[builtins.bool] disabled: Whether the trigger is disabled or not. If true, the trigger will never result in a build.
        :param pulumi.Input[builtins.str] filename: Path, from the source root, to a file whose contents is used for the template.
               Either a filename or build template must be provided. Set this only when using trigger_template or github.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] substitutions: Substitutions data for Build resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags for annotation of a BuildTrigger
        :param pulumi.Input[builtins.str] trigger_id: The unique identifier for the trigger.
        :param pulumi.Input['TriggerTriggerTemplateArgs'] trigger_template: Template describing the types of source changes to trigger a build.
               Branch and tag names in trigger templates are interpreted as regular
               expressions. Any branch or tag change that matches that regular
               expression will trigger a build.
...
class Trigger(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ignoredFiles")
    def ignored_files(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        ignoredFiles and includedFiles are file glob matches using https://golang.org/pkg/path/filepath/#Match
        extended with support for `**`.
        If ignoredFiles and changed files are both empty, then they are not
    ...
    @property
    @pulumi.getter(name="includeBuildLogs")
    def include_build_logs(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Build logs will be sent back to GitHub as part of the checkrun
        result.  Values can be INCLUDE_BUILD_LOGS_UNSPECIFIED or
        INCLUDE_BUILD_LOGS_WITH_STATUS
    ...
    @property
    @pulumi.getter(name="includedFiles")
    def included_files(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        ignoredFiles and includedFiles are file glob matches using https://golang.org/pkg/path/filepath/#Match
        extended with support for `**`.
        If any of the files altered in the commit pass the ignoredFiles filter
    ...
    @property
    @pulumi.getter
    def substitutions(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Substitutions data for Build resource.
        """
        return pulumi.get(self, "substitutions")
