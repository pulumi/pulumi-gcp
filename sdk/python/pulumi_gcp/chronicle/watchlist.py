...
class WatchlistArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] multiplying_factor: Optional. Weight applied to the risk score for entities
               in this watchlist.
               The default is 1.0 if it is not specified.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] watchlist_id: Optional. The ID to use for the watchlist,
...
class _WatchlistState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] multiplying_factor: Optional. Weight applied to the risk score for entities
               in this watchlist.
               The default is 1.0 if it is not specified.
        :param pulumi.Input[_builtins.str] name: Identifier. Resource name of the watchlist. This unique identifier is generated using values provided for the URL parameters.
               Format:
               projects/{project}/locations/{location}/instances/{instance}/watchlists/{watchlist}
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] update_time: Output only. Time the watchlist was last updated.
        :param pulumi.Input[_builtins.str] watchlist_id: Optional. The ID to use for the watchlist,
               which will become the final component of the watchlist's resource name.
               This value should be 4-63 characters, and valid characters
               are /a-z-/.
