...
class DataAccessScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DataAccessScopeDeniedDataAccessLabelArgs']]] denied_data_access_labels: Optional. The denied labels for the scope.
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.str] description: Optional. A description of the data access scope for a human reader.
    ...
    def data_access_scope_id(self, value: pulumi.Input[_builtins.str]):
...
class _DataAccessScopeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DataAccessScopeAllowedDataAccessLabelArgs']]] allowed_data_access_labels: The allowed labels for the scope. There has to be at
               ...
               to see data with labeled with A or B or (A and B).
               Structure is documented below.
        :param pulumi.Input[_builtins.str] author: Output only. The user who created the data access scope.
        :param pulumi.Input[_builtins.str] create_time: Output only. The time at which the data access scope was created.
        :param pulumi.Input[_builtins.str] data_access_scope_id: Required. The user provided scope id which will become the last part of the name
               of the scope resource.
               Needs to be compliant with https://google.aip.dev/122
        :param pulumi.Input[Sequence[pulumi.Input['DataAccessScopeDeniedDataAccessLabelArgs']]] denied_data_access_labels: Optional. The denied labels for the scope.
               ...
               Structure is documented below.
        :param pulumi.Input[_builtins.str] description: Optional. A description of the data access scope for a human reader.
        :param pulumi.Input[_builtins.str] display_name: Output only. The name to be used for display to customers of the data access scope.
        :param pulumi.Input[_builtins.str] instance: The unique identifier for the Chronicle instance, which is the same as the customer ID.
        :param pulumi.Input[_builtins.str] last_editor: Output only. The user who last updated the data access scope.
        :param pulumi.Input[_builtins.str] location: The location of the resource. This is the geographical region where the Chronicle instance resides, such as "us" or "europe-west2".
        :param pulumi.Input[_builtins.str] name: The unique full name of the data access scope. This unique identifier is generated using values provided for the URL parameters.
               Format:
               projects/{project}/locations/{location}/instances/{instance}/dataAccessScopes/{data_access_scope_id}
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] update_time: Output only. The time at which the data access scope was last updated.
        """
        if allow_all is not None:
            pulumi.set(__self__, "allow_all", allow_all)
        if allowed_data_access_labels is not None:
