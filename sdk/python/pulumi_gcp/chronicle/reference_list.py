...
class ReferenceListArgs:
    def __init__(__self__, *,
                 ...
                 scope_info: pulumi.Input[Optional['ReferenceListScopeInfoArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] reference_list_id: Required. The ID to use for the reference list. This is also the display name for
        ...
        :param pulumi.Input['ReferenceListScopeInfoArgs'] scope_info: ScopeInfo specifies the scope info of the reference list.
               Structure is documented below.
        """
    ...
    def reference_list_id(self, value: pulumi.Input[_builtins.str]):
    ...
    @syntax_type.setter
    def syntax_type(self, value: pulumi.Input[_builtins.str]):
    ...
    def scope_info(self) -> pulumi.Input[Optional['ReferenceListScopeInfoArgs']]:
        """
    ...
    @scope_info.setter
    def scope_info(self, value: pulumi.Input[Optional['ReferenceListScopeInfoArgs']]):
...
class _ReferenceListState:
    def __init__(__self__, *,
                 ...
                 entries: pulumi.Input[Optional[Sequence[pulumi.Input['ReferenceListEntryArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] instance: The unique identifier for the Chronicle instance, which is the same as the customer ID.
        :param pulumi.Input[_builtins.str] location: The location of the resource. This is the geographical region where the Chronicle instance resides, such as "us" or "europe-west2".
        :param pulumi.Input[_builtins.str] name: Output only. The resource name of the reference list.
               Format:
        ...
        :param pulumi.Input[_builtins.str] reference_list_id: Required. The ID to use for the reference list. This is also the display name for
               ...
               - Has length < 256.
               - Must be unique.
        :param pulumi.Input[_builtins.str] revision_create_time: Output only. The timestamp when the reference list was last updated.
        :param pulumi.Input[_builtins.int] rule_associations_count: Output only. The count of self-authored rules using the reference list.
    ...
    @_builtins.property
    @pulumi.getter
    def entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ReferenceListEntryArgs']]]]:
        """
        Required. The entries of the reference list.
        When listed, they are returned in the order that was specified at creation
        or update. The combined size of the values of the reference list may not
    ...
    @entries.setter
    def entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ReferenceListEntryArgs']]]]):
        pulumi.set(self, "entries", value)
    ...
    @_builtins.property
    @pulumi.getter(name="referenceListId")
    def reference_list_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Required. The ID to use for the reference list. This is also the display name for
        the reference list. It must satisfy the following requirements:
        - Starts with letter.
    ...
    @reference_list_id.setter
    def reference_list_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "reference_list_id", value)
    ...
    @_builtins.property
    @pulumi.getter(name="syntaxType")
    def syntax_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Possible values:
        REFERENCE_LIST_SYNTAX_TYPE_PLAIN_TEXT_STRING
        REFERENCE_LIST_SYNTAX_TYPE_REGEX
    ...
    @syntax_type.setter
    def syntax_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "syntax_type", value)
...
class ReferenceList(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 reference_list_id: pulumi.Input[Optional[_builtins.str]] = None,
                 scope_info: pulumi.Input[Optional[Union['ReferenceListScopeInfoArgs', 'ReferenceListScopeInfoArgsDict', 'outputs.ReferenceListScopeInfo']]] = None,
                 syntax_type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * `{{location}}/{{instance}}/{{reference_list_id}}`
        ...
        :param pulumi.Input[_builtins.str] reference_list_id: Required. The ID to use for the reference list. This is also the display name for
               ...
               - Has length < 256.
               - Must be unique.
        :param pulumi.Input[Union['ReferenceListScopeInfoArgs', 'ReferenceListScopeInfoArgsDict', 'outputs.ReferenceListScopeInfo']] scope_info: ScopeInfo specifies the scope info of the reference list.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] syntax_type: Possible values:
               REFERENCE_LIST_SYNTAX_TYPE_PLAIN_TEXT_STRING
               REFERENCE_LIST_SYNTAX_TYPE_REGEX
    ...
    @_builtins.property
    @pulumi.getter(name="scopeInfo")
    def scope_info(self) -> pulumi.Output[Optional['outputs.ReferenceListScopeInfo']]:
        """
        ScopeInfo specifies the scope info of the reference list.
        Structure is documented below.
        """
