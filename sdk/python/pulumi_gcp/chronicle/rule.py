...
class RuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] rule_id: Rule Id is the ID of the Rule.
        :param pulumi.Input[_builtins.str] scope: Resource name of the DataAccessScope bound to this rule.
               Populated in BASIC view and FULL view.
        ...
        :param pulumi.Input[_builtins.str] text: The YARA-L content of the rule.
...
class _RuleState:
    def __init__(__self__, *,
                 ...
                 compilation_diagnostics: pulumi.Input[Optional[Sequence[pulumi.Input['RuleCompilationDiagnosticArgs']]]] = None,
                 ...
                 near_real_time_live_rule_eligible: pulumi.Input[Optional[_builtins.bool]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 reference_lists: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 revision_create_time: pulumi.Input[Optional[_builtins.str]] = None,
                 revision_id: pulumi.Input[Optional[_builtins.str]] = None,
                 rule_id: pulumi.Input[Optional[_builtins.str]] = None,
                 scope: pulumi.Input[Optional[_builtins.str]] = None,
                 severities: pulumi.Input[Optional[Sequence[pulumi.Input['RuleSeverityArgs']]]] = None,
                 text: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] compilation_state: Output only. The current compilation state of the rule.
               Populated in FULL view.
               Possible values:
               COMPILATION_STATE_UNSPECIFIED
               SUCCEEDED
               FAILED
        :param pulumi.Input[_builtins.str] create_time: Output only. The timestamp of when the rule was created.
               Populated in FULL view.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] data_tables: Output only. Resource names of the data tables used in this rule.
        :param pulumi.Input[_builtins.str] deletion_policy: Policy to determine if the rule should be deleted forcefully.
               If deletion_policy = "FORCE", any retrohunts and any detections associated with the rule
               will also be deleted. If deletion_policy = "DEFAULT", the call will only succeed if the
               rule has no associated retrohunts, including completed retrohunts, and no
        ...
        :param pulumi.Input[_builtins.str] instance: The unique identifier for the Chronicle instance, which is the same as the customer ID.
        :param pulumi.Input[_builtins.str] location: The location of the resource. This is the geographical region where the Chronicle instance resides, such as "us" or "europe-west2".
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: Output only. Additional metadata specified in the meta section of text.
               Populated in FULL view.
        :param pulumi.Input[_builtins.str] name: Full resource name for the rule. This unique identifier is generated using values provided for the URL parameters.
               Format:
               projects/{project}/locations/{location}/instances/{instance}/rules/{rule}
        :param pulumi.Input[_builtins.bool] near_real_time_live_rule_eligible: Output only. Indicate the rule can run in near real time live rule.
               If this is true, the rule uses the near real time live rule when the run
               frequency is set to LIVE.
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] reference_lists: Output only. Resource names of the reference lists used in this rule.
               Populated in FULL view.
        :param pulumi.Input[_builtins.str] revision_create_time: Output only. The timestamp of when the rule revision was created.
               Populated in FULL, REVISION_METADATA_ONLY views.
        :param pulumi.Input[_builtins.str] revision_id: Output only. The revision ID of the rule.
        ...
        :param pulumi.Input[_builtins.str] text: The YARA-L content of the rule.
               Populated in FULL view.
        :param pulumi.Input[_builtins.str] type: Possible values:
    ...
    def allowed_run_frequencies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def allowed_run_frequencies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def compilation_diagnostics(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RuleCompilationDiagnosticArgs']]]]:
        """
    ...
    def compilation_diagnostics(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RuleCompilationDiagnosticArgs']]]]):
        pulumi.set(self, "compilation_diagnostics", value)

    @_builtins.property
    @pulumi.getter(name="compilationState")
    def compilation_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def compilation_state(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def data_tables(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @data_tables.setter
    def data_tables(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def near_real_time_live_rule_eligible(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def near_real_time_live_rule_eligible(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def reference_lists(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def reference_lists(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def severities(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RuleSeverityArgs']]]]:
        """
        (Output)
        Output only. The severity of a rule's compilation diagnostic.
        Possible values:
    ...
    @severities.setter
    def severities(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RuleSeverityArgs']]]]):
