...
def get_crypto_key_iam_policy(crypto_key_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str crypto_key_id: The crypto key ID, in the form
    """
    __args__ = dict()
...
def get_crypto_key_iam_policy_output(crypto_key_id: Optional[pulumi.Input[_builtins.str]] = None,
