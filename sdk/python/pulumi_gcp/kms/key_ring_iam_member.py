...
class KeyRingIAMMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['KeyRingIAMMemberConditionArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['KeyRingIAMMemberConditionArgs']]:
        """
    ...
    @condition.setter
    def condition(self, value: pulumi.Input[Optional['KeyRingIAMMemberConditionArgs']]):
...
class KeyRingIAMMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['KeyRingIAMMemberConditionArgs', 'KeyRingIAMMemberConditionArgsDict', 'outputs.KeyRingIAMMemberCondition']]] = None,
                 key_ring_id: pulumi.Input[Optional[_builtins.str]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        * `kms.KeyRingIAMMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the key ring are preserved.
        ...
        :param pulumi.Input[Union['KeyRingIAMMemberConditionArgs', 'KeyRingIAMMemberConditionArgsDict', 'outputs.KeyRingIAMMemberCondition']] condition: An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] key_ring_id: The key ring ID, in the form
               `{project_id}/{location_name}/{key_ring_name}` or
               `{location_name}/{key_ring_name}`. In the second form, the provider's
    ...
    def get(resource_name: str,
            ...
            key_ring_id: pulumi.Input[Optional[_builtins.str]] = None,
            member: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'KeyRingIAMMember':
        """
