...
def get_key_handle(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The Google Cloud Platform location for the KeyHandle.
           ...
           - - -
    :param builtins.str name: The KeyHandle's name.
...
def get_key_handle_output(location: Optional[pulumi.Input[builtins.str]] = None,
