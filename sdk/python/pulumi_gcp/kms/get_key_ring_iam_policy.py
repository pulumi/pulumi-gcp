...
def get_key_ring_iam_policy(key_ring_id: Optional[builtins.str] = None,
    ...
    :param builtins.str key_ring_id: The key ring ID, in the form
...
def get_key_ring_iam_policy_output(key_ring_id: Optional[pulumi.Input[builtins.str]] = None,
