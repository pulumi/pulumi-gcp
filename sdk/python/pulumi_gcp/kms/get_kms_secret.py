...
def get_kms_secret(additional_authenticated_data: Optional[_builtins.str] = None,
                   ciphertext: Optional[_builtins.str] = None,
                   crypto_key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str additional_authenticated_data: The [additional authenticated data](https://cloud.google.com/kms/docs/additional-authenticated-data) used for integrity checks during encryption and decryption.
