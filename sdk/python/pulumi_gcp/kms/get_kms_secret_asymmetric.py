...
class GetKMSSecretAsymmetricResult:
    ...
    @property
    @pulumi.getter
    def crc32(self) -> Optional[builtins.str]:
        """
...
def get_kms_secret_asymmetric(ciphertext: Optional[builtins.str] = None,
                              crc32: Optional[builtins.str] = None,
                              crypto_key_version: Optional[builtins.str] = None,
    ...
    :param builtins.str crc32: The crc32 checksum of the `ciphertext` in hexadecimal notation. If not specified, it will be computed.
    :param builtins.str crypto_key_version: The id of the CryptoKey version that will be used to
...
def get_kms_secret_asymmetric_output(ciphertext: Optional[pulumi.Input[builtins.str]] = None,
                                     crc32: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     crypto_key_version: Optional[pulumi.Input[builtins.str]] = None,
