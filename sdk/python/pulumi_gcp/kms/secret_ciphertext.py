...
class SecretCiphertextArgs:
    def __init__(__self__, *,
                 ...
                 additional_authenticated_data: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SecretCiphertext resource.
        :param pulumi.Input[builtins.str] crypto_key: The full name of the CryptoKey that will be used to encrypt the provided plaintext.
               Format: `'projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}/cryptoKeys/{{cryptoKey}}'`
               
               
               - - -
        :param pulumi.Input[builtins.str] plaintext: The plaintext to be encrypted.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.str] additional_authenticated_data: The additional authenticated data used for integrity checks during encryption and decryption.
               **Note**: This property is sensitive and will not be displayed in the plan.
        """
    ...
    def additional_authenticated_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def additional_authenticated_data(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SecretCiphertextState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] additional_authenticated_data: The additional authenticated data used for integrity checks during encryption and decryption.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.str] ciphertext: Contains the result of encrypting the provided plaintext, encoded in base64.
        :param pulumi.Input[builtins.str] crypto_key: The full name of the CryptoKey that will be used to encrypt the provided plaintext.
               Format: `'projects/{{project}}/locations/{{location}}/keyRings/{{keyRing}}/cryptoKeys/{{cryptoKey}}'`
...
class SecretCiphertext(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ciphertext: Optional[pulumi.Input[builtins.str]] = None,
            crypto_key: Optional[pulumi.Input[builtins.str]] = None,
            plaintext: Optional[pulumi.Input[builtins.str]] = None) -> 'SecretCiphertext':
        """
    ...
    @property
    @pulumi.getter(name="additionalAuthenticatedData")
    def additional_authenticated_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The additional authenticated data used for integrity checks during encryption and decryption.
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
