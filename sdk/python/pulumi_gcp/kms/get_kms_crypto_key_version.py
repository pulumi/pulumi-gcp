...
def get_kms_crypto_key_version(crypto_key: Optional[_builtins.str] = None,
...
def get_kms_crypto_key_version_output(crypto_key: Optional[pulumi.Input[_builtins.str]] = None,
