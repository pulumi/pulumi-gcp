...
class CryptoKeyKeyAccessJustificationsPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] allowed_access_reasons: The list of allowed reasons for access to this CryptoKey. Zero allowed
...
class CryptoKeyVersionAttestation(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str content: (Output)
...
class CryptoKeyVersionAttestationCertChains(dict):
    ...
    def __init__(__self__, *,
                 cavium_certs: Optional[Sequence[_builtins.str]] = None,
                 google_card_certs: Optional[Sequence[_builtins.str]] = None,
                 google_partition_certs: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] cavium_certs: Cavium certificate chain corresponding to the attestation.
        :param Sequence[_builtins.str] google_card_certs: Google card certificate chain corresponding to the attestation.
        :param Sequence[_builtins.str] google_partition_certs: Google partition certificate chain corresponding to the attestation.
        """
...
class CryptoKeyVersionAttestationExternalProtectionLevelOptions(dict):
    ...
    def __init__(__self__, *,
                 ekm_connection_key_path: Optional[_builtins.str] = None,
                 external_key_uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str ekm_connection_key_path: The path to the external key material on the EKM when using EkmConnection e.g., "v0/my/key". Set this field instead of externalKeyUri when using an EkmConnection.
        :param _builtins.str external_key_uri: The URI for an external resource that this CryptoKeyVersion represents.
        """
...
class CryptoKeyVersionTemplate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 protection_level: Optional[_builtins.str] = None):
        """
        :param _builtins.str algorithm: The algorithm to use when creating a version based on this template.
               See the [algorithm reference](https://cloud.google.com/kms/docs/reference/rest/v1/CryptoKeyVersionAlgorithm) for possible inputs.
        :param _builtins.str protection_level: The protection level to use when creating a version based on this template. Possible values include "SOFTWARE", "HSM", "EXTERNAL", "EXTERNAL_VPC". Defaults to "SOFTWARE".
        """
...
class EkmConnectionServiceResolver(dict):
    ...
    def __init__(__self__, *,
                 ...
                 endpoint_filter: Optional[_builtins.str] = None):
        """
        :param _builtins.str hostname: Required. The hostname of the EKM replica used at TLS and HTTP layers.
        :param Sequence['EkmConnectionServiceResolverServerCertificateArgs'] server_certificates: Required. A list of leaf server certificates used to authenticate HTTPS connections to the EKM replica. Currently, a maximum of 10 Certificate is supported.
               Structure is documented below.
        :param _builtins.str service_directory_service: Required. The resource name of the Service Directory service pointing to an EKM replica, in the format projects/*/locations/*/namespaces/*/services/*
        :param _builtins.str endpoint_filter: Optional. The filter applied to the endpoints of the resolved service. If no filter is specified, all endpoints will be considered. An endpoint will be chosen arbitrarily from the filtered list for each request. For endpoint filter syntax and examples, see https://cloud.google.com/service-directory/docs/reference/rpc/google.cloud.servicedirectory.v1#resolveservicerequest.
        """
...
class EkmConnectionServiceResolverServerCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parsed: Optional[_builtins.bool] = None,
                 serial_number: Optional[_builtins.str] = None,
                 sha256_fingerprint: Optional[_builtins.str] = None,
                 subject: Optional[_builtins.str] = None,
                 subject_alternative_dns_names: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str raw_der: Required. The raw certificate bytes in DER format. A base64-encoded string.
        ...
        :param _builtins.str not_before_time: (Output)
               ...
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param _builtins.bool parsed: (Output)
               Output only. True if the certificate was parsed successfully.
        :param _builtins.str serial_number: (Output)
               Output only. The certificate serial number as a hex string. Only present if parsed is true.
        :param _builtins.str sha256_fingerprint: (Output)
               Output only. The SHA-256 certificate fingerprint as a hex string. Only present if parsed is true.
        :param _builtins.str subject: (Output)
               Output only. The subject distinguished name in RFC 2253 format. Only present if parsed is true.
        :param Sequence[_builtins.str] subject_alternative_dns_names: (Output)
...
class KeyRingImportJobPublicKey(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str pem: (Output)
...
class GetCryptoKeyLatestVersionPublicKeyResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str pem: The public key, encoded in PEM format. For more information, see the RFC 7468 sections for General Considerations and Textual Encoding of Subject Public Key Info.
        """
        pulumi.set(__self__, "algorithm", algorithm)
        pulumi.set(__self__, "pem", pem)
...
class GetCryptoKeysKeyResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.bool import_only: Whether this key may contain imported versions only.
        ...
        :param _builtins.str purpose: The immutable purpose of this CryptoKey. See the
               [purpose reference](https://cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings.cryptoKeys#CryptoKeyPurpose)
               for possible inputs.
               Default value is "ENCRYPT_DECRYPT".
        :param _builtins.str rotation_period: Every time this period passes, generate a new CryptoKeyVersion and set it as the primary.
...
class GetCryptoKeysKeyKeyAccessJustificationsPolicyResult(dict):
    def __init__(__self__, *,
                 allowed_access_reasons: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] allowed_access_reasons: The list of allowed reasons for access to this CryptoKey. Zero allowed
               access reasons means all encrypt, decrypt, and sign operations for
               this CryptoKey will fail.
...
class GetCryptoKeysKeyPrimaryResult(dict):
    def __init__(__self__, *,
                 ...
                 state: _builtins.str):
        """
        :param _builtins.str name: The resource name for this CryptoKeyVersion.
        :param _builtins.str state: The current state of the CryptoKeyVersion.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "state", state)
