...
def get_kms_secret_ciphertext(crypto_key: Optional[builtins.str] = None,
    ...
    :param builtins.str plaintext: The plaintext to be encrypted
    """
    __args__ = dict()
...
def get_kms_secret_ciphertext_output(crypto_key: Optional[pulumi.Input[builtins.str]] = None,
