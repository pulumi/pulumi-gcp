...
class EkmConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] etag: Optional. Etag of the currently stored EkmConnection.
        :param pulumi.Input[_builtins.str] key_management_mode: Optional. Describes who can perform control plane operations on the EKM. If unset, this defaults to MANUAL
