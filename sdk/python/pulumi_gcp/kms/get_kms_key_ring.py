...
def get_kms_key_ring(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The Google Cloud Platform location for the KeyRing.
           A full list of valid locations can be found by running `gcloud kms locations list`.
           
           - - -
    :param builtins.str name: The KeyRing's name.
...
def get_kms_key_ring_output(location: Optional[pulumi.Input[builtins.str]] = None,
