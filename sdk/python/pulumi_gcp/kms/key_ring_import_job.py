...
class KeyRingImportJobArgs:
    def __init__(__self__, *,
                 import_job_id: pulumi.Input[builtins.str],
                 import_method: pulumi.Input[builtins.str],
                 key_ring: pulumi.Input[builtins.str],
                 protection_level: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a KeyRingImportJob resource.
        :param pulumi.Input[builtins.str] import_job_id: It must be unique within a KeyRing and match the regular expression [a-zA-Z0-9_-]{1,63}
    ...
    def import_job_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def import_job_id(self, value: pulumi.Input[builtins.str]):
    ...
    def import_method(self, value: pulumi.Input[builtins.str]):
    ...
    def protection_level(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def protection_level(self, value: pulumi.Input[builtins.str]):
...
class _KeyRingImportJobState:
    def __init__(__self__, *,
                 ...
                 import_job_id: Optional[pulumi.Input[builtins.str]] = None,
                 import_method: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] expire_time: The time at which this resource is scheduled for expiration and can no longer be used.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['KeyRingImportJobPublicKeyArgs']]] public_keys: The public key with which to wrap key material prior to import. Only returned if state is `ACTIVE`.
               Structure is documented below.
        :param pulumi.Input[builtins.str] state: The current state of the ImportJob, indicating if it can be used.
        """
    ...
    @property
    @pulumi.getter(name="importJobId")
    def import_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        It must be unique within a KeyRing and match the regular expression [a-zA-Z0-9_-]{1,63}
    ...
    @import_job_id.setter
    def import_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "import_job_id", value)
    ...
    @import_method.setter
    def import_method(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "import_method", value)
...
class KeyRingImportJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'KeyRingImportJob':
        """
    ...
    @property
    @pulumi.getter(name="importJobId")
    def import_job_id(self) -> pulumi.Output[builtins.str]:
        """
        It must be unique within a KeyRing and match the regular expression [a-zA-Z0-9_-]{1,63}
