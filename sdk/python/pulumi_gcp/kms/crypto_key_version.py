...
class CryptoKeyVersionArgs:
    def __init__(__self__, *,
                 crypto_key: pulumi.Input[builtins.str],
    ...
    def crypto_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @crypto_key.setter
    def crypto_key(self, value: pulumi.Input[builtins.str]):
...
class _CryptoKeyVersionState:
    def __init__(__self__, *,
                 ...
                 external_protection_level_options: Optional[pulumi.Input['CryptoKeyVersionExternalProtectionLevelOptionsArgs']] = None,
                 generate_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] algorithm: The CryptoKeyVersionAlgorithm that this CryptoKeyVersion supports.
        ...
        :param pulumi.Input[builtins.str] name: The resource name for this CryptoKeyVersion.
        :param pulumi.Input[builtins.str] protection_level: The ProtectionLevel describing how crypto operations are performed with this CryptoKeyVersion.
        :param pulumi.Input[builtins.str] state: The current state of the CryptoKeyVersion. Note: you can only specify this field to manually `ENABLE` or `DISABLE` the CryptoKeyVersion,
               otherwise the value of this field is always retrieved automatically.
               Possible values are: `PENDING_GENERATION`, `ENABLED`, `DISABLED`, `DESTROYED`, `DESTROY_SCHEDULED`, `PENDING_IMPORT`, `IMPORT_FAILED`.
        """
    ...
    @property
    @pulumi.getter(name="cryptoKey")
    def crypto_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the cryptoKey associated with the CryptoKeyVersions.
        Format: `'projects/{{project}}/locations/{{location}}/keyRings/{{keyring}}/cryptoKeys/{{cryptoKey}}'`
    ...
    @crypto_key.setter
    def crypto_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "crypto_key", value)
    ...
    def generate_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def generate_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CryptoKeyVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            protection_level: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'CryptoKeyVersion':
        """
    ...
    @property
    @pulumi.getter(name="cryptoKey")
    def crypto_key(self) -> pulumi.Output[builtins.str]:
        """
        The name of the cryptoKey associated with the CryptoKeyVersions.
        Format: `'projects/{{project}}/locations/{{location}}/keyRings/{{keyring}}/cryptoKeys/{{cryptoKey}}'`
    ...
    @property
    @pulumi.getter(name="generateTime")
    def generate_time(self) -> pulumi.Output[builtins.str]:
        """
        The time this CryptoKeyVersion key material was generated
        """
        return pulumi.get(self, "generate_time")
