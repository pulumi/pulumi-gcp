...
def get_ekm_connection_iam_policy(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location for the EkmConnection.
...
def get_ekm_connection_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
