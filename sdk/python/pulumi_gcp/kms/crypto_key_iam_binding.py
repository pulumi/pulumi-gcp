...
class CryptoKeyIAMBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role: The role that should be applied. Note that custom roles must be of the format
...
class CryptoKeyIAMBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: Optional[pulumi.Input[builtins.str]] = None,
            members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'CryptoKeyIAMBinding':
        """
