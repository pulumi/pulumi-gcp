...
class AutokeyConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] folder: The folder for which to retrieve config.
               ...
               - - -
        :param pulumi.Input[builtins.str] key_project: The target key project for a given folder where KMS Autokey will provision a
    ...
    def key_project(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @key_project.setter
    def key_project(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutokeyConfig(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="keyProject")
    def key_project(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target key project for a given folder where KMS Autokey will provision a
        CryptoKey for any new KeyHandle the Developer creates. Should have the form
        `projects/<project_id_or_number>`.
