...
if not MYPY:
    class AuthConfigClientCertificateArgsDict(TypedDict):
        encrypted_private_key: pulumi.Input[builtins.str]
        """
        The ssl certificate encoded in PEM format. This string must include the begin header and end footer lines.
        """
        ssl_certificate: pulumi.Input[builtins.str]
        """
        The ssl certificate encoded in PEM format. This string must include the begin header and end footer lines.
        """
...
class AuthConfigClientCertificateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] encrypted_private_key: The ssl certificate encoded in PEM format. This string must include the begin header and end footer lines.
        :param pulumi.Input[builtins.str] ssl_certificate: The ssl certificate encoded in PEM format. This string must include the begin header and end footer lines.
        :param pulumi.Input[builtins.str] passphrase: 'passphrase' should be left unset if private key is not encrypted.
               Note that 'passphrase' is not the password for web server, but an extra layer of security to protected private key.
        """
    ...
    def encrypted_private_key(self) -> pulumi.Input[builtins.str]:
        """
        The ssl certificate encoded in PEM format. This string must include the begin header and end footer lines.
        """
    ...
    def encrypted_private_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "encrypted_private_key", value)

    @property
    @pulumi.getter(name="sslCertificate")
    def ssl_certificate(self) -> pulumi.Input[builtins.str]:
        """
        The ssl certificate encoded in PEM format. This string must include the begin header and end footer lines.
        """
    ...
    def ssl_certificate(self, value: pulumi.Input[builtins.str]):
...
class AuthConfigDecryptedCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] credential_type: Credential type associated with auth configs.
...
class AuthConfigDecryptedCredentialAuthTokenArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] token: The token for the auth type.
        :param pulumi.Input[builtins.str] type: Authentication type, e.g. "Basic", "Bearer", etc.
        """
...
if not MYPY:
    class AuthConfigDecryptedCredentialJwtArgsDict(TypedDict):
        ...
        """
        jwt_payload: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AuthConfigDecryptedCredentialJwtArgs:
    def __init__(__self__, *,
                 ...
                 jwt_payload: Optional[pulumi.Input[builtins.str]] = None,
                 secret: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] jwt: (Output)
               The token calculated by the header, payload and signature.
        :param pulumi.Input[builtins.str] jwt_header: Identifies which algorithm is used to generate the signature.
        :param pulumi.Input[builtins.str] jwt_payload: Contains a set of claims. The JWT specification defines seven Registered Claim Names which are the standard fields commonly included in tokens. Custom claims are usually also included, depending on the purpose of the token.
        :param pulumi.Input[builtins.str] secret: User's pre-shared secret to sign the token.
        """
        if jwt is not None:
            pulumi.set(__self__, "jwt", jwt)
    ...
    def jwt_payload(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Contains a set of claims. The JWT specification defines seven Registered Claim Names which are the standard fields commonly included in tokens. Custom claims are usually also included, depending on the purpose of the token.
        """
    ...
    @jwt_payload.setter
    def jwt_payload(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AuthConfigDecryptedCredentialOauth2AuthorizationCodeArgsDict(TypedDict):
        auth_endpoint: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AuthConfigDecryptedCredentialOauth2AuthorizationCodeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] auth_endpoint: The auth url endpoint to send the auth code request to.
        :param pulumi.Input[builtins.str] client_id: The client's id.
        :param pulumi.Input[builtins.str] client_secret: The client's secret.
        :param pulumi.Input[builtins.str] scope: A space-delimited list of requested scope permissions.
        :param pulumi.Input[builtins.str] token_endpoint: The token url endpoint to send the token request to.
        """
...
class AuthConfigDecryptedCredentialOauth2ClientCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_id: The client's ID.
        :param pulumi.Input[builtins.str] client_secret: The client's secret.
        :param pulumi.Input[builtins.str] request_type: Represent how to pass parameters to fetch access token Possible values: ["REQUEST_TYPE_UNSPECIFIED", "REQUEST_BODY", "QUERY_PARAMETERS", "ENCODED_HEADER"]
        :param pulumi.Input[builtins.str] scope: A space-delimited list of requested scope permissions.
        :param pulumi.Input[builtins.str] token_endpoint: The token endpoint is used by the client to obtain an access token by presenting its authorization grant or refresh token.
...
class AuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntryKeyLiteralValueArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] string_value: String.
        """
...
if not MYPY:
    class AuthConfigDecryptedCredentialOidcTokenArgsDict(TypedDict):
        ...
        """
        token_expire_time: NotRequired[pulumi.Input[builtins.str]]
        """
        (Output)
...
class AuthConfigDecryptedCredentialOidcTokenArgs:
    def __init__(__self__, *,
                 ...
                 token: Optional[pulumi.Input[builtins.str]] = None,
                 token_expire_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] audience: Audience to be used when generating OIDC token. The audience claim identifies the recipients that the JWT is intended for.
        :param pulumi.Input[builtins.str] service_account_email: The service account email to be used as the identity for the token.
        :param pulumi.Input[builtins.str] token: (Output)
               ID token obtained for the service account.
        :param pulumi.Input[builtins.str] token_expire_time: (Output)
               The approximate time until the token retrieved is valid.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
    ...
    def token_expire_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Output)
        The approximate time until the token retrieved is valid.
        A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
    ...
    def token_expire_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AuthConfigDecryptedCredentialServiceAccountCredentialsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] scope: A space-delimited list of requested scope permissions.
        :param pulumi.Input[builtins.str] service_account: Name of the service account that has the permission to make the request.
        """
        if scope is not None:
            pulumi.set(__self__, "scope", scope)
...
class AuthConfigDecryptedCredentialUsernameAndPasswordArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] password: Password to be used.
               
               <a name="nested_decrypted_credential_oauth2_authorization_code"></a>The `oauth2_authorization_code` block supports:
        :param pulumi.Input[builtins.str] username: Username to be used.
        """
...
if not MYPY:
    class ClientCloudKmsConfigArgsDict(TypedDict):
        ...
        specific location.
        """
        kms_location: pulumi.Input[builtins.str]
        """
        Location name of the key ring, e.g. "us-west1".
        """
        kms_ring: pulumi.Input[builtins.str]
        """
        ...
        """
        kms_project_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClientCloudKmsConfigArgs:
    def __init__(__self__, *,
                 ...
                 kms_project_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key: A Cloud KMS key is a named object containing one or more key versions, along
               with metadata for the key. A key exists on exactly one key ring tied to a
               specific location.
        :param pulumi.Input[builtins.str] kms_location: Location name of the key ring, e.g. "us-west1".
        :param pulumi.Input[builtins.str] kms_ring: A key ring organizes keys in a specific Google Cloud location and allows you to
               manage access control on groups of keys. A key ring's name does not need to be
               unique across a Google Cloud project, but must be unique within a given location.
        :param pulumi.Input[builtins.str] key_version: Each version of a key contains key material used for encryption or signing.
               A key's version is represented by an integer, starting at 1. To decrypt data
               or verify a signature, you must use the same key version that was used to
               encrypt or sign the data.
        :param pulumi.Input[builtins.str] kms_project_id: The Google Cloud project id of the project where the kms key stored. If empty,
               the kms key is stored at the same project as customer's project and ecrypted
               with CMEK, otherwise, the kms key is stored in the tenant project and
               encrypted with GMEK.
        """
    ...
    def kms_location(self) -> pulumi.Input[builtins.str]:
        """
        Location name of the key ring, e.g. "us-west1".
        """
    ...
    @kms_location.setter
    def kms_location(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "kms_location", value)

    @property
    @pulumi.getter(name="kmsRing")
    def kms_ring(self) -> pulumi.Input[builtins.str]:
        """
        A key ring organizes keys in a specific Google Cloud location and allows you to
        manage access control on groups of keys. A key ring's name does not need to be
        unique across a Google Cloud project, but must be unique within a given location.
    ...
    @kms_ring.setter
    def kms_ring(self, value: pulumi.Input[builtins.str]):
    ...
    def kms_project_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Google Cloud project id of the project where the kms key stored. If empty,
        the kms key is stored at the same project as customer's project and ecrypted
        with CMEK, otherwise, the kms key is stored in the tenant project and
    ...
    def kms_project_id(self, value: Optional[pulumi.Input[builtins.str]]):
