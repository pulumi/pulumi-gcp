...
class AuthConfigClientCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] passphrase: 'passphrase' should be left unset if private key is not encrypted.
               Note that 'passphrase' is not the password for web server, but an extra layer of security to protected private key.
        """
...
class AuthConfigDecryptedCredentialJwtArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] jwt: (Output)
               The token calculated by the header, payload and signature.
        :param pulumi.Input[_builtins.str] jwt_header: Identifies which algorithm is used to generate the signature.
        :param pulumi.Input[_builtins.str] jwt_payload: Contains a set of claims. The JWT specification defines seven Registered Claim Names which are the standard fields commonly included in tokens. Custom claims are usually also included, depending on the purpose of the token.
        :param pulumi.Input[_builtins.str] secret: User's pre-shared secret to sign the token.
        """
        if jwt is not None:
            pulumi.set(__self__, "jwt", jwt)
...
class AuthConfigDecryptedCredentialOauth2AuthorizationCodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] token_endpoint: The token url endpoint to send the token request to.
        """
...
class AuthConfigDecryptedCredentialOauth2ClientCredentialsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] client_id: The client's ID.
        :param pulumi.Input[_builtins.str] client_secret: The client's secret.
        :param pulumi.Input[_builtins.str] request_type: Represent how to pass parameters to fetch access token Possible values: ["REQUEST_TYPE_UNSPECIFIED", "REQUEST_BODY", "QUERY_PARAMETERS", "ENCODED_HEADER"]
        :param pulumi.Input[_builtins.str] scope: A space-delimited list of requested scope permissions.
        :param pulumi.Input[_builtins.str] token_endpoint: The token endpoint is used by the client to obtain an access token by presenting its authorization grant or refresh token.
...
class AuthConfigDecryptedCredentialOidcTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] token: (Output)
               ID token obtained for the service account.
        :param pulumi.Input[_builtins.str] token_expire_time: (Output)
               The approximate time until the token retrieved is valid.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        """
...
class AuthConfigDecryptedCredentialUsernameAndPasswordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] password: Password to be used.
               ...
               <a name="nested_decrypted_credential_oauth2_authorization_code"></a>The `oauth2_authorization_code` block supports:
        :param pulumi.Input[_builtins.str] username: Username to be used.
        """
...
class ClientCloudKmsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] key: A Cloud KMS key is a named object containing one or more key versions, along
               with metadata for the key. A key exists on exactly one key ring tied to a
               specific location.
        :param pulumi.Input[_builtins.str] kms_location: Location name of the key ring, e.g. "us-west1".
        :param pulumi.Input[_builtins.str] kms_ring: A key ring organizes keys in a specific Google Cloud location and allows you to
               manage access control on groups of keys. A key ring's name does not need to be
               unique across a Google Cloud project, but must be unique within a given location.
        :param pulumi.Input[_builtins.str] key_version: Each version of a key contains key material used for encryption or signing.
               A key's version is represented by an integer, starting at 1. To decrypt data
               or verify a signature, you must use the same key version that was used to
               encrypt or sign the data.
        :param pulumi.Input[_builtins.str] kms_project_id: The Google Cloud project id of the project where the kms key stored. If empty,
               the kms key is stored at the same project as customer's project and ecrypted
               with CMEK, otherwise, the kms key is stored in the tenant project and
               encrypted with GMEK.
        """
