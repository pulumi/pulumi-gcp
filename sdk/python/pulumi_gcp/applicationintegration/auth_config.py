...
class AuthConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] override_valid_time: User provided expiry time to override. For the example of Salesforce, username/password credentials can be valid for 6 months depending on the instance settings.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] visibility: The visibility of the auth config.
...
class _AuthConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] expiry_notification_durations: User can define the time to receive notification after which the auth config becomes invalid. Support up to 30 days. Support granularity in hours.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        :param pulumi.Input[_builtins.str] last_modifier_email: The last modifier's email address. Generated based on the End User Credentials/LOAS role of the user making the call.
        :param pulumi.Input[_builtins.str] location: Location in which client needs to be provisioned.
        :param pulumi.Input[_builtins.str] name: Resource name of the auth config.
        :param pulumi.Input[_builtins.str] override_valid_time: User provided expiry time to override. For the example of Salesforce, username/password credentials can be valid for 6 months depending on the instance settings.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[_builtins.str] reason: The reason / details of the current status.
        :param pulumi.Input[_builtins.str] state: The status of the auth config.
        :param pulumi.Input[_builtins.str] update_time: The timestamp when the auth config is modified.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[_builtins.str] valid_time: The time until the auth config is valid. Empty or max value is considered the auth config won't expire.
               A timestamp in RFC3339 UTC "Zulu" format, with nanosecond resolution and up to nine fractional digits. Examples: "2014-10-02T15:01:23Z" and "2014-10-02T15:01:23.045123456Z".
        :param pulumi.Input[_builtins.str] visibility: The visibility of the auth config.
               Possible values are: `PRIVATE`, `CLIENT_VISIBLE`.
        """
...
class AuthConfig(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="expiryNotificationDurations")
    def expiry_notification_durations(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        User can define the time to receive notification after which the auth config becomes invalid. Support up to 30 days. Support granularity in hours.
        A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        """
