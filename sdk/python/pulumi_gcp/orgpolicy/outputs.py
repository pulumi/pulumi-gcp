...
calass PolicySpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['PolicySpecRuleArrgs'] rules: Up to 10 PolicyRules are allowed. In Policies for boolean constraints, the following requirements apply: - There must be one and only one PolicyRule where condition is unset. - BooleanPolicyRules with conditions must set `enforced` to the opposite of the PolicyRule without a condition. - During policy evaluation, PolicyRules with conditions that are true for a target resource take precedence.
...
calass PolicySpecRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PolicySpecRuleValuesArrgs' values: List of values to be used for this PolicyRule. This field can be set only in Policies for list constraints.
        """
...
@pulumi.output_type
calass PolicySpecRuleCondition(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
calass PolicySpecRuleValues(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
