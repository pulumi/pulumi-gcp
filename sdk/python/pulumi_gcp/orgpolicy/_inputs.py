...
class PolicyDryRunSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] etag: (Output)
               An opaque tag indicating the current version of the policy, used for concurrency control. This field is ignored if used in a `CreatePolicy` request. When the policy` is returned from either a `GetPolicy` or a `ListPolicies` request, this `etag` indicates the version of the current policy to use when executing a read-modify-write loop. When the policy is returned from a `GetEffectivePolicy` request, the `etag` will be unset.
        :param pulumi.Input[builtins.bool] inherit_from_parent: Determines the inheritance behavior for this policy. If `inherit_from_parent` is true, policy rules set higher up in the hierarchy (up to the closest root) are inherited and present in the effective policy. If it is false, then no rules are inherited, and this policy becomes the new root for evaluation. This field can be set only for policies which configure list constraints.
        :param pulumi.Input[builtins.bool] reset: Ignores policies set above this resource and restores the `constraint_default` enforcement behavior of the specific constraint at this resource. This field can be set in policies for either list or boolean constraints. If set, `rules` must be empty and `inherit_from_parent` must be set to false.
...
if not MYPY:
    class PolicyDryRunSpecRuleArgsDict(TypedDict):
        allow_all: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        deny_all: NotRequired[pulumi.Input[builtins.str]]
        """
        Setting this to `"TRUE"` means that all values are denied. This field can be set only in Policies for list constraints.
        """
        enforce: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicyDryRunSpecRuleArgs:
    def __init__(__self__, *,
                 allow_all: Optional[pulumi.Input[builtins.str]] = None,
                 condition: Optional[pulumi.Input['PolicyDryRunSpecRuleConditionArgs']] = None,
                 deny_all: Optional[pulumi.Input[builtins.str]] = None,
                 enforce: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[builtins.str]] = None,
                 values: Optional[pulumi.Input['PolicyDryRunSpecRuleValuesArgs']] = None):
        """
        :param pulumi.Input[builtins.str] allow_all: Setting this to `"TRUE"` means that all values are allowed. This field can be set only in Policies for list constraints.
        :param pulumi.Input['PolicyDryRunSpecRuleConditionArgs'] condition: A condition which determines whether this rule is used in the evaluation of the policy. When set, the `expression` field in the `Expr' must include from 1 to 10 subexpressions, joined by the "||" or "&&" operators. Each subexpression must be of the form "resource.matchTag('/tag_key_short_name, 'tag_value_short_name')". or "resource.matchTagId('tagKeys/key_id', 'tagValues/value_id')". where key_name and value_name are the resource names for Label Keys and Values. These names are available from the Tag Manager Service. An example expression is: "resource.matchTag('123456789/environment, 'prod')". or "resource.matchTagId('tagKeys/123', 'tagValues/456')".
               Structure is documented below.
        :param pulumi.Input[builtins.str] deny_all: Setting this to `"TRUE"` means that all values are denied. This field can be set only in Policies for list constraints.
        :param pulumi.Input[builtins.str] enforce: If `"TRUE"`, then the `Policy` is enforced. If `"FALSE"`, then any configuration is acceptable. This field can be set only in Policies for boolean constraints.
        :param pulumi.Input[builtins.str] parameters: Optional. Required for Managed Constraints if parameters defined in constraints. Pass parameter values when policy enforcement is enabled. Ensure that parameter value types match those defined in the constraint definition. For example: { \\"allowedLocations\\" : [\\"us-east1\\", \\"us-west1\\"], \\"allowAll\\" : true }
    ...
    def allow_all(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Setting this to `"TRUE"` means that all values are allowed. This field can be set only in Policies for list constraints.
        """
    ...
    @allow_all.setter
    def allow_all(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def deny_all(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Setting this to `"TRUE"` means that all values are denied. This field can be set only in Policies for list constraints.
        """
    ...
    @deny_all.setter
    def deny_all(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deny_all", value)

    @property
    @pulumi.getter
    def enforce(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If `"TRUE"`, then the `Policy` is enforced. If `"FALSE"`, then any configuration is acceptable. This field can be set only in Policies for boolean constraints.
        """
    ...
    @enforce.setter
    def enforce(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PolicyDryRunSpecRuleValuesArgsDict(TypedDict):
        ...
        """
        denied_values: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PolicyDryRunSpecRuleValuesArgs:
    def __init__(__self__, *,
                 ...
                 denied_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_values: List of values allowed at this resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] denied_values: List of values denied at this resource.
        """
    ...
    def denied_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of values denied at this resource.
        """
    ...
    def denied_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class PolicySpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] etag: (Output)
               An opaque tag indicating the current version of the `Policy`, used for concurrency control. This field is ignored if used in a `CreatePolicy` request. When the `Policy` is returned from either a `GetPolicy` or a `ListPolicies` request, this `etag` indicates the version of the current `Policy` to use when executing a read-modify-write loop. When the `Policy` is returned from a `GetEffectivePolicy` request, the `etag` will be unset.
        :param pulumi.Input[builtins.bool] inherit_from_parent: Determines the inheritance behavior for this `Policy`. If `inherit_from_parent` is true, PolicyRules set higher up in the hierarchy (up to the closest root) are inherited and present in the effective policy. If it is false, then no rules are inherited, and this Policy becomes the new root for evaluation. This field can be set only for Policies which configure list constraints.
        :param pulumi.Input[builtins.bool] reset: Ignores policies set above this resource and restores the `constraint_default` enforcement behavior of the specific `Constraint` at this resource. This field can be set in policies for either list or boolean constraints. If set, `rules` must be empty and `inherit_from_parent` must be set to false.
