...
class ConnectionProfileForwardSshConnectivityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] hostname: Hostname for the SSH tunnel.
        :param pulumi.Input[builtins.str] username: Username for the SSH tunnel.
        :param pulumi.Input[builtins.str] password: SSH password.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.int] port: Port for the SSH tunnel.
        :param pulumi.Input[builtins.str] private_key: SSH private key.
               **Note**: This property is sensitive and will not be displayed in the plan.
        """
...
class ConnectionProfileGcsProfileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: The Cloud Storage bucket name.
...
if not MYPY:
    class ConnectionProfileMysqlProfileArgsDict(TypedDict):
        ...
        **Note**: This property is sensitive and will not be displayed in the plan.
        ...
        """
        secret_manager_stored_password: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionProfileMysqlProfileArgs:
    def __init__(__self__, *,
                 ...
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 port: Optional[pulumi.Input[builtins.int]] = None,
                 secret_manager_stored_password: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_config: Optional[pulumi.Input['ConnectionProfileMysqlProfileSslConfigArgs']] = None):
        """
        :param pulumi.Input[builtins.str] hostname: Hostname for the MySQL connection.
        :param pulumi.Input[builtins.str] username: Username for the MySQL connection.
        :param pulumi.Input[builtins.str] password: Password for the MySQL connection.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.int] port: Port for the MySQL connection.
        :param pulumi.Input[builtins.str] secret_manager_stored_password: A reference to a Secret Manager resource name storing the user's password.
    ...
    def secret_manager_stored_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A reference to a Secret Manager resource name storing the user's password.
        """
    ...
    def secret_manager_stored_password(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ConnectionProfileMysqlProfileSslConfigArgsDict(TypedDict):
        ...
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
        ca_certificate_set: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Output)
        ...
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
        client_certificate_set: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Output)
        ...
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
        client_key_set: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Output)
        Indicates whether the clientKey field is set.
        """
...
class ConnectionProfileMysqlProfileSslConfigArgs:
    def __init__(__self__, *,
                 ...
                 ca_certificate_set: Optional[pulumi.Input[builtins.bool]] = None,
                 client_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 client_certificate_set: Optional[pulumi.Input[builtins.bool]] = None,
                 client_key: Optional[pulumi.Input[builtins.str]] = None,
                 client_key_set: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] ca_certificate: PEM-encoded certificate of the CA that signed the source database
               server's certificate.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.bool] ca_certificate_set: (Output)
               Indicates whether the clientKey field is set.
        :param pulumi.Input[builtins.str] client_certificate: PEM-encoded certificate that will be used by the replica to
               authenticate against the source database server. If this field
               is used then the 'clientKey' and the 'caCertificate' fields are
               mandatory.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.bool] client_certificate_set: (Output)
               Indicates whether the clientCertificate field is set.
        :param pulumi.Input[builtins.str] client_key: PEM-encoded private key associated with the Client Certificate.
               If this field is used then the 'client_certificate' and the
               'ca_certificate' fields are mandatory.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.bool] client_key_set: (Output)
               Indicates whether the clientKey field is set.
        """
    ...
    def ca_certificate_set(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Output)
        Indicates whether the clientKey field is set.
        """
    ...
    def ca_certificate_set(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def client_certificate_set(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Output)
        Indicates whether the clientCertificate field is set.
        """
    ...
    def client_certificate_set(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def client_key_set(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Output)
        Indicates whether the clientKey field is set.
        """
    ...
    def client_key_set(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ConnectionProfileOracleProfileArgsDict(TypedDict):
        ...
        """
        connection_attributes: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ConnectionProfileOracleProfileArgs:
    def __init__(__self__, *,
                 ...
                 hostname: pulumi.Input[builtins.str],
                 username: pulumi.Input[builtins.str],
                 connection_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 port: Optional[pulumi.Input[builtins.int]] = None,
                 secret_manager_stored_password: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] database_service: Database for the Oracle connection.
        :param pulumi.Input[builtins.str] hostname: Hostname for the Oracle connection.
        :param pulumi.Input[builtins.str] username: Username for the Oracle connection.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] connection_attributes: Connection string attributes
        :param pulumi.Input[builtins.str] password: Password for the Oracle connection.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.int] port: Port for the Oracle connection.
        :param pulumi.Input[builtins.str] secret_manager_stored_password: A reference to a Secret Manager resource name storing the user's password.
        """
    ...
    def connection_attributes(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Connection string attributes
        """
    ...
    def connection_attributes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class ConnectionProfilePostgresqlProfileArgs:
    def __init__(__self__, *,
                 ...
                 secret_manager_stored_password: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] database: Database for the PostgreSQL connection.
        :param pulumi.Input[builtins.str] hostname: Hostname for the PostgreSQL connection.
        :param pulumi.Input[builtins.str] username: Username for the PostgreSQL connection.
        :param pulumi.Input[builtins.str] password: Password for the PostgreSQL connection.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.int] port: Port for the PostgreSQL connection.
        :param pulumi.Input[builtins.str] secret_manager_stored_password: A reference to a Secret Manager resource name storing the user's password.
        """
...
class ConnectionProfilePrivateConnectivityArgs:
    def __init__(__self__, *,
                 private_connection: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] private_connection: A reference to a private connection resource. Format: `projects/{project}/locations/{location}/privateConnections/{name}`
        """
...
class ConnectionProfileSalesforceProfileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain: Domain for the Salesforce Org.
...
if not MYPY:
    class ConnectionProfileSalesforceProfileOauth2ClientCredentialsArgsDict(TypedDict):
        ...
        """
        secret_manager_stored_client_secret: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionProfileSalesforceProfileOauth2ClientCredentialsArgs:
    def __init__(__self__, *,
                 ...
                 secret_manager_stored_client_secret: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] client_id: Client ID to use for authentication.
        :param pulumi.Input[builtins.str] client_secret: Client secret to use for authentication.
        :param pulumi.Input[builtins.str] secret_manager_stored_client_secret: A reference to a Secret Manager resource name storing the client secret.
        """
    ...
    def secret_manager_stored_client_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A reference to a Secret Manager resource name storing the client secret.
        """
    ...
    def secret_manager_stored_client_secret(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ConnectionProfileSalesforceProfileUserCredentialsArgsDict(TypedDict):
        ...
        A reference to a Secret Manager resource name storing the user's password.
        """
        secret_manager_stored_security_token: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionProfileSalesforceProfileUserCredentialsArgs:
    def __init__(__self__, *,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 secret_manager_stored_password: Optional[pulumi.Input[builtins.str]] = None,
                 secret_manager_stored_security_token: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] secret_manager_stored_password: A reference to a Secret Manager resource name storing the user's password.
        :param pulumi.Input[builtins.str] secret_manager_stored_security_token: A reference to a Secret Manager resource name storing the user's security token.
               
               <a name="nested_salesforce_profile_oauth2_client_credentials"></a>The `oauth2_client_credentials` block supports:
        :param pulumi.Input[builtins.str] security_token: Security token of the user.
    ...
    def secret_manager_stored_security_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A reference to a Secret Manager resource name storing the user's security token.
    ...
    def secret_manager_stored_security_token(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectionProfileSqlServerProfileArgs:
    def __init__(__self__, *,
                 ...
                 secret_manager_stored_password: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] database: Database for the SQL Server connection.
        :param pulumi.Input[builtins.str] hostname: Hostname for the SQL Server connection.
        :param pulumi.Input[builtins.str] username: Username for the SQL Server connection.
        :param pulumi.Input[builtins.str] password: Password for the SQL Server connection.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[builtins.int] port: Port for the SQL Server connection.
        :param pulumi.Input[builtins.str] secret_manager_stored_password: A reference to a Secret Manager resource name storing the user's password.
        """
        pulumi.set(__self__, "database", database)
        pulumi.set(__self__, "hostname", hostname)
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] table: Table name.
...
if not MYPY:
    class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumnArgsDict(TypedDict):
        ...
        """
        ordinal_position: NotRequired[pulumi.Input[builtins.int]]
        """
...
class StreamBackfillAllMysqlExcludedObjectsMysqlDatabaseMysqlTableMysqlColumnArgs:
    def __init__(__self__, *,
                 ...
                 ordinal_position: Optional[pulumi.Input[builtins.int]] = None,
                 primary_key: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] collation: Column collation.
        :param pulumi.Input[builtins.str] column: Column name.
        :param pulumi.Input[builtins.str] data_type: The MySQL data type. Full data types list can be found here:
               https://dev.mysql.com/doc/refman/8.0/en/data-types.html
        :param pulumi.Input[builtins.int] length: (Output)
               Column length.
        :param pulumi.Input[builtins.bool] nullable: Whether or not the column can accept a null value.
        :param pulumi.Input[builtins.int] ordinal_position: The ordinal position of the column in the table.
        :param pulumi.Input[builtins.bool] primary_key: Whether or not the column represents a primary key.
        """
    ...
    def ordinal_position(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The ordinal position of the column in the table.
        """
    ...
    def ordinal_position(self, value: Optional[pulumi.Input[builtins.int]]):
...
class StreamBackfillAllOracleExcludedObjectsOracleSchemaArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] schema: Schema name.
...
class StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumnArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] column: Column name.
        :param pulumi.Input[builtins.str] data_type: The Oracle data type. Full data types list can be found here:
               https://docs.oracle.com/en/database/oracle/oracle-database/21/sqlrf/Data-Types.html
        :param pulumi.Input[builtins.str] encoding: (Output)
               Column encoding.
        :param pulumi.Input[builtins.int] length: (Output)
               Column length.
        :param pulumi.Input[builtins.bool] nullable: (Output)
               Whether or not the column can accept a null value.
        :param pulumi.Input[builtins.int] ordinal_position: (Output)
               The ordinal position of the column in the table.
        :param pulumi.Input[builtins.int] precision: (Output)
               Column precision.
        :param pulumi.Input[builtins.bool] primary_key: (Output)
               Whether or not the column represents a primary key.
        :param pulumi.Input[builtins.int] scale: (Output)
               Column scale.
        """
        if column is not None:
            pulumi.set(__self__, "column", column)
...
class StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] schema: Database name.
...
class StreamBackfillAllPostgresqlExcludedObjectsPostgresqlSchemaPostgresqlTablePostgresqlColumnArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] column: Column name.
        :param pulumi.Input[builtins.str] data_type: The PostgreSQL data type. Full data types list can be found here:
               https://www.postgresql.org/docs/current/datatype.html
        :param pulumi.Input[builtins.int] length: (Output)
               Column length.
        :param pulumi.Input[builtins.bool] nullable: Whether or not the column can accept a null value.
...
class StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumnArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] column: Column name.
        :param pulumi.Input[builtins.str] data_type: The SQL Server data type. Full data types list can be found here:
               https://learn.microsoft.com/en-us/sql/t-sql/data-types/data-types-transact-sql?view=sql-server-ver16
        :param pulumi.Input[builtins.int] length: (Output)
               Column length.
        :param pulumi.Input[builtins.bool] nullable: (Output)
...
if not MYPY:
    class StreamDestinationConfigArgsDict(TypedDict):
        destination_connection_profile: pulumi.Input[builtins.str]
        """
...
class StreamDestinationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination_connection_profile: Destination connection profile resource. Format: projects/{project}/locations/{location}/connectionProfiles/{name}
    ...
    def destination_connection_profile(self) -> pulumi.Input[builtins.str]:
        """
        Destination connection profile resource. Format: projects/{project}/locations/{location}/connectionProfiles/{name}
        """
    ...
    def destination_connection_profile(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class StreamDestinationConfigBigqueryDestinationConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        data_freshness: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StreamDestinationConfigBigqueryDestinationConfigArgs:
    def __init__(__self__, *,
                 ...
                 data_freshness: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['StreamDestinationConfigBigqueryDestinationConfigBlmtConfigArgs'] blmt_config: BigLake Managed Tables configuration for BigQuery streams.
               Structure is documented below.
        :param pulumi.Input[builtins.str] data_freshness: The guaranteed data freshness (in seconds) when querying tables created by the stream.
               Editing this field will only affect new tables created in the future, but existing tables
               will not be impacted. Lower values mean that queries will return fresher data, but may result in higher cost.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s". Defaults to 900s.
    ...
    def data_freshness(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The guaranteed data freshness (in seconds) when querying tables created by the stream.
        Editing this field will only affect new tables created in the future, but existing tables
        will not be impacted. Lower values mean that queries will return fresher data, but may result in higher cost.
    ...
    def data_freshness(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StreamDestinationConfigBigqueryDestinationConfigBlmtConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: The Cloud Storage bucket name.
        :param pulumi.Input[builtins.str] connection_name: The bigquery connection. Format: `{project}.{location}.{name}`
...
class StreamDestinationConfigBigqueryDestinationConfigSingleTargetDatasetArgs:
    def __init__(__self__, *,
                 dataset_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] dataset_id: Dataset ID in the format projects/{project}/datasets/{dataset_id} or
               {project}:{dataset_id}
        """
...
if not MYPY:
    class StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsDatasetTemplateArgsDict(TypedDict):
        ...
        """
        dataset_id_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StreamDestinationConfigBigqueryDestinationConfigSourceHierarchyDatasetsDatasetTemplateArgs:
    def __init__(__self__, *,
                 location: pulumi.Input[builtins.str],
                 dataset_id_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] location: The geographic location where the dataset should reside.
               See https://cloud.google.com/bigquery/docs/locations for supported locations.
        :param pulumi.Input[builtins.str] dataset_id_prefix: If supplied, every created dataset will have its name prefixed by the provided value.
               The prefix and name will be separated by an underscore. i.e. _.
        :param pulumi.Input[builtins.str] kms_key_name: Describes the Cloud KMS encryption key that will be used to protect destination BigQuery
               table. The BigQuery Service Account associated with your project requires access to this
               encryption key. i.e. projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{cryptoKey}.
               See https://cloud.google.com/bigquery/docs/customer-managed-encryption for more information.
        """
    ...
    def dataset_id_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        If supplied, every created dataset will have its name prefixed by the provided value.
        The prefix and name will be separated by an underscore. i.e. _.
        """
    ...
    def dataset_id_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class StreamDestinationConfigGcsDestinationConfigArgsDict(TypedDict):
        ...
        """
        file_rotation_interval: NotRequired[pulumi.Input[builtins.str]]
        """
        The maximum duration for which new events are added before a file is closed and a new file is created.
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s". Defaults to 900s.
        """
        file_rotation_mb: NotRequired[pulumi.Input[builtins.int]]
        """
...
class StreamDestinationConfigGcsDestinationConfigArgs:
    def __init__(__self__, *,
                 ...
                 file_rotation_interval: Optional[pulumi.Input[builtins.str]] = None,
                 file_rotation_mb: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] file_rotation_interval: The maximum duration for which new events are added before a file is closed and a new file is created.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s". Defaults to 900s.
        :param pulumi.Input[builtins.int] file_rotation_mb: The maximum file size to be saved in the bucket.
        :param pulumi.Input['StreamDestinationConfigGcsDestinationConfigJsonFileFormatArgs'] json_file_format: JSON file format configuration.
               Structure is documented below.
        :param pulumi.Input[builtins.str] path: Path inside the Cloud Storage bucket to write data to.
        """
    ...
    def file_rotation_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum duration for which new events are added before a file is closed and a new file is created.
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s". Defaults to 900s.
        """
    ...
    def file_rotation_interval(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "file_rotation_interval", value)

    @property
    @pulumi.getter(name="fileRotationMb")
    def file_rotation_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum file size to be saved in the bucket.
        """
    ...
    def file_rotation_mb(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class StreamDestinationConfigGcsDestinationConfigJsonFileFormatArgsDict(TypedDict):
        ...
        """
        schema_file_format: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StreamDestinationConfigGcsDestinationConfigJsonFileFormatArgs:
    def __init__(__self__, *,
                 ...
                 schema_file_format: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] compression: Compression of the loaded JSON file.
               Possible values are: `NO_COMPRESSION`, `GZIP`.
        :param pulumi.Input[builtins.str] schema_file_format: The schema file format along JSON data files.
               Possible values are: `NO_SCHEMA_FILE`, `AVRO_SCHEMA_FILE`.
        """
    ...
    def schema_file_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The schema file format along JSON data files.
        Possible values are: `NO_SCHEMA_FILE`, `AVRO_SCHEMA_FILE`.
        """
    ...
    def schema_file_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "schema_file_format", value)


if not MYPY:
    class StreamSourceConfigArgsDict(TypedDict):
        source_connection_profile: pulumi.Input[builtins.str]
        """
...
class StreamSourceConfigArgs:
    ...
    def source_connection_profile(self) -> pulumi.Input[builtins.str]:
        """
        Source connection profile resource. Format: projects/{project}/locations/{location}/connectionProfiles/{name}
        """
    ...
    def source_connection_profile(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class StreamSourceConfigMysqlSourceConfigArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        max_concurrent_backfill_tasks: NotRequired[pulumi.Input[builtins.int]]
        """
        Maximum number of concurrent backfill tasks. The number should be non negative.
        If not set (or set to 0), the system's default value will be used.
        """
        max_concurrent_cdc_tasks: NotRequired[pulumi.Input[builtins.int]]
        """
...
class StreamSourceConfigMysqlSourceConfigArgs:
    def __init__(__self__, *,
                 ...
                 max_concurrent_backfill_tasks: Optional[pulumi.Input[builtins.int]] = None,
                 max_concurrent_cdc_tasks: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input['StreamSourceConfigMysqlSourceConfigIncludeObjectsArgs'] include_objects: MySQL objects to retrieve from the source.
               Structure is documented below.
        :param pulumi.Input[builtins.int] max_concurrent_backfill_tasks: Maximum number of concurrent backfill tasks. The number should be non negative.
               If not set (or set to 0), the system's default value will be used.
        :param pulumi.Input[builtins.int] max_concurrent_cdc_tasks: Maximum number of concurrent CDC tasks. The number should be non negative.
               If not set (or set to 0), the system's default value will be used.
        """
    ...
    def max_concurrent_backfill_tasks(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum number of concurrent backfill tasks. The number should be non negative.
        If not set (or set to 0), the system's default value will be used.
        """
    ...
    def max_concurrent_backfill_tasks(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_concurrent_backfill_tasks", value)

    @property
    @pulumi.getter(name="maxConcurrentCdcTasks")
    def max_concurrent_cdc_tasks(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum number of concurrent CDC tasks. The number should be non negative.
        If not set (or set to 0), the system's default value will be used.
        """
    ...
    def max_concurrent_cdc_tasks(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class StreamSourceConfigPostgresqlSourceConfigArgsDict(TypedDict):
        ...
        """
        replication_slot: pulumi.Input[builtins.str]
        """
...
class StreamSourceConfigPostgresqlSourceConfigArgs:
    def __init__(__self__, *,
                 ...
                 max_concurrent_backfill_tasks: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] publication: The name of the publication that includes the set of all tables
               that are defined in the stream's include_objects.
        :param pulumi.Input[builtins.str] replication_slot: The name of the logical replication slot that's configured with
               the pgoutput plugin.
        ...
        :param pulumi.Input['StreamSourceConfigPostgresqlSourceConfigIncludeObjectsArgs'] include_objects: PostgreSQL objects to retrieve from the source.
               Structure is documented below.
        :param pulumi.Input[builtins.int] max_concurrent_backfill_tasks: Maximum number of concurrent backfill tasks. The number should be non
               negative. If not set (or set to 0), the system's default value will be used.
        """
    ...
    def replication_slot(self) -> pulumi.Input[builtins.str]:
        """
        The name of the logical replication slot that's configured with
        the pgoutput plugin.
        """
    ...
    def replication_slot(self, value: pulumi.Input[builtins.str]):
...
class StreamSourceConfigSqlServerSourceConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['StreamSourceConfigSqlServerSourceConfigIncludeObjectsArgs'] include_objects: SQL Server objects to retrieve from the source.
               Structure is documented below.
        :param pulumi.Input[builtins.int] max_concurrent_backfill_tasks: Max concurrent backfill tasks.
        :param pulumi.Input[builtins.int] max_concurrent_cdc_tasks: Max concurrent CDC tasks.
