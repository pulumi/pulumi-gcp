...
def get_static_ips(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The location to list Datastream IPs for. For example: `us-east1`.
    :param _builtins.str project: Project from which to list static IP addresses. Defaults to project declared in the provider.
    """
    __args__ = dict()
