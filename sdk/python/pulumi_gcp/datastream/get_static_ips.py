...
def get_static_ips(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The location to list Datastream IPs for. For example: `us-east1`.
    :param builtins.str project: Project from which to list static IP addresses. Defaults to project declared in the provider.
    """
    __args__ = dict()
...
def get_static_ips_output(location: Optional[pulumi.Input[builtins.str]] = None,
