...
class SubAccountArgs:
    ...
    def master_billing_account(self, value: pulumi.Input[_builtins.str]):
...
class _SubAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] master_billing_account: The name of the master billing account that the subaccount
               will be created under in the form `{billing_account_id}` or `billingAccounts/{billing_account_id}`.
        :param pulumi.Input[_builtins.str] name: The resource name of the billing account in the form `billingAccounts/{billing_account_id}`.
        :param pulumi.Input[_builtins.bool] open: `true` if the billing account is open, `false` if the billing account is closed.
        """
