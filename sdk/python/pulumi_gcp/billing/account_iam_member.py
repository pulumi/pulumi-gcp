...
class AccountIamMemberArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['AccountIamMemberConditionArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['AccountIamMemberConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['AccountIamMemberConditionArgs']]):
...
class _AccountIamMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] billing_account_id: The billing account id.
               ...
               For `billing.AccountIamMember` or `billing.AccountIamBinding`:
        :param pulumi.Input[_builtins.str] etag: (Computed) The etag of the billing account's IAM policy.
        :param pulumi.Input[_builtins.str] member: Identities that will be granted the privilege in `role`.
               Each entry can have one of the following values:
               * **user:{emailid}**: An email address that represents a specific Google account. For example, alice@gmail.com or joe@example.com.
               * **serviceAccount:{emailid}**: An email address that represents a service account. For example, my-other-app@appspot.gserviceaccount.com.
