...
class AccountIamBindingArgs:
    def __init__(__self__, *,
        ...
        """
        AccountIamBindingArgs._configure(
...
class _AccountIamBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `billing.AccountIamPolicy` only:
        """
        _AccountIamBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            billing_account_id=billing_account_id,
            condition=condition,
            etag=etag,
...
class AccountIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AccountIamBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, AccountIamBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                AccountIamBindingConditionArgs._configure(_setter, **condition)
