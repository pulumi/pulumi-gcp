...
class BudgetAllUpdatesRule(dict):
    ...
    def __init__(__self__, *,
                 disable_default_iam_recipients: Optional[builtins.bool] = None,
                 enable_project_level_recipients: Optional[builtins.bool] = None,
                 monitoring_notification_channels: Optional[Sequence[builtins.str]] = None,
                 pubsub_topic: Optional[builtins.str] = None,
                 schema_version: Optional[builtins.str] = None):
        """
        :param builtins.bool disable_default_iam_recipients: Boolean. When set to true, disables default notifications sent
               when a threshold is exceeded. Default recipients are
               those with Billing Account Administrators and Billing
               Account Users IAM roles for the target account.
        :param builtins.bool enable_project_level_recipients: When set to true, and when the budget has a single project configured,
        ...
        :param Sequence[builtins.str] monitoring_notification_channels: The full resource name of a monitoring notification
               channel in the form
               projects/{project_id}/notificationChannels/{channel_id}.
               A maximum of 5 channels are allowed.
        :param builtins.str pubsub_topic: The name of the Cloud Pub/Sub topic where budget related
               messages will be published, in the form
               projects/{project_id}/topics/{topic_id}. Updates are sent
               at regular intervals to the topic.
        :param builtins.str schema_version: The schema version of the notification. Only "1.0" is
    ...
    def disable_default_iam_recipients(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_project_level_recipients(self) -> Optional[builtins.bool]:
        """
    ...
    def monitoring_notification_channels(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BudgetAmount(dict):
    ...
    def __init__(__self__, *,
                 last_period_amount: Optional[builtins.bool] = None,
                 specified_amount: Optional['outputs.BudgetAmountSpecifiedAmount'] = None):
        """
        :param builtins.bool last_period_amount: Configures a budget amount that is automatically set to 100% of
               last period's spend.
    ...
    def last_period_amount(self) -> Optional[builtins.bool]:
        """
...
class BudgetAmountSpecifiedAmount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str currency_code: The 3-letter currency code defined in ISO 4217.
        :param builtins.int nanos: Number of nano (10^-9) units of the amount.
               ...
               - - -
        :param builtins.str units: The whole units of the amount. For example if currencyCode
...
class BudgetBudgetFilter(dict):
    ...
    def __init__(__self__, *,
                 calendar_period: Optional[builtins.str] = None,
                 credit_types: Optional[Sequence[builtins.str]] = None,
                 credit_types_treatment: Optional[builtins.str] = None,
                 custom_period: Optional['outputs.BudgetBudgetFilterCustomPeriod'] = None,
                 labels: Optional[Mapping[str, builtins.str]] = None,
                 projects: Optional[Sequence[builtins.str]] = None,
                 resource_ancestors: Optional[Sequence[builtins.str]] = None,
                 services: Optional[Sequence[builtins.str]] = None,
                 subaccounts: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str calendar_period: A CalendarPeriod represents the abstract concept of a recurring time period that has a
        ...
        :param Sequence[builtins.str] credit_types: Optional. If creditTypesTreatment is INCLUDE_SPECIFIED_CREDITS,
        ...
        :param builtins.str credit_types_treatment: Specifies how credits should be treated when determining spend
        ...
        :param 'BudgetBudgetFilterCustomPeriodArgs' custom_period: Specifies to track usage from any start date (required) to any end date (optional).
               ...
               Exactly one of `calendar_period`, `custom_period` must be provided.
               Structure is documented below.
        :param Mapping[str, builtins.str] labels: A single label and value pair specifying that usage from only
               this set of labeled resources should be included in the budget.
        :param Sequence[builtins.str] projects: A set of projects of the form projects/{project_number},
               specifying that usage from only this set of projects should be
               included in the budget. If omitted, the report will include
               all usage for the billing account, regardless of which project
               the usage occurred on.
        :param Sequence[builtins.str] resource_ancestors: A set of folder and organization names of the form folders/{folderId} or organizations/{organizationId},
        ...
        :param Sequence[builtins.str] services: A set of services of the form services/{service_id},
               specifying that usage from only this set of services should be
               included in the budget. If omitted, the report will include
               usage for all the services. The service names are available
               through the Catalog API:
               https://cloud.google.com/billing/v1/how-tos/catalog-api.
        :param Sequence[builtins.str] subaccounts: A set of subaccounts of the form billingAccounts/{account_id},
    ...
    def calendar_period(self) -> Optional[builtins.str]:
        """
    ...
    def credit_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def credit_types_treatment(self) -> Optional[builtins.str]:
        """
    ...
    def resource_ancestors(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def subaccounts(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BudgetThresholdRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 spend_basis: Optional[builtins.str] = None):
        """
        :param builtins.float threshold_percent: Send an alert when this threshold is exceeded. This is a
               1.0-based percentage, so 0.5 = 50%. Must be >= 0.
        :param builtins.str spend_basis: The type of basis used to determine if spend has passed
               the threshold.
    ...
    def spend_basis(self) -> Optional[builtins.str]:
        """
