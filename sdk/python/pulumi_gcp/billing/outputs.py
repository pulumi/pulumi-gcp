...
class BudgetAllUpdatesRule(dict):
    ...
    def __init__(__self__, *,
                 disable_default_iam_recipients: Optional[_builtins.bool] = None,
                 enable_project_level_recipients: Optional[_builtins.bool] = None,
                 monitoring_notification_channels: Optional[Sequence[_builtins.str]] = None,
                 pubsub_topic: Optional[_builtins.str] = None,
                 schema_version: Optional[_builtins.str] = None):
        """
        :param _builtins.bool disable_default_iam_recipients: Boolean. When set to true, disables default notifications sent
               when a threshold is exceeded. Default recipients are
               those with Billing Account Administrators and Billing
               Account Users IAM roles for the target account.
        :param _builtins.bool enable_project_level_recipients: When set to true, and when the budget has a single project configured,
        ...
        :param Sequence[_builtins.str] monitoring_notification_channels: The full resource name of a monitoring notification
               channel in the form
               projects/{project_id}/notificationChannels/{channel_id}.
               A maximum of 5 channels are allowed.
        :param _builtins.str pubsub_topic: The name of the Cloud Pub/Sub topic where budget related
               messages will be published, in the form
               projects/{project_id}/topics/{topic_id}. Updates are sent
               at regular intervals to the topic.
        :param _builtins.str schema_version: The schema version of the notification. Only "1.0" is
...
class BudgetAmount(dict):
    ...
    def __init__(__self__, *,
                 last_period_amount: Optional[_builtins.bool] = None,
                 specified_amount: Optional['outputs.BudgetAmountSpecifiedAmount'] = None):
        """
        :param _builtins.bool last_period_amount: Configures a budget amount that is automatically set to 100% of
               last period's spend.
...
class BudgetAmountSpecifiedAmount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str currency_code: The 3-letter currency code defined in ISO 4217.
        :param _builtins.int nanos: Number of nano (10^-9) units of the amount.
               ...
               nanos=-750,000,000.
        :param _builtins.str units: The whole units of the amount. For example if currencyCode
...
class BudgetBudgetFilter(dict):
    ...
    def __init__(__self__, *,
                 calendar_period: Optional[_builtins.str] = None,
                 credit_types: Optional[Sequence[_builtins.str]] = None,
                 credit_types_treatment: Optional[_builtins.str] = None,
                 custom_period: Optional['outputs.BudgetBudgetFilterCustomPeriod'] = None,
                 labels: Optional[Mapping[str, _builtins.str]] = None,
                 projects: Optional[Sequence[_builtins.str]] = None,
                 resource_ancestors: Optional[Sequence[_builtins.str]] = None,
                 services: Optional[Sequence[_builtins.str]] = None,
                 subaccounts: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str calendar_period: A CalendarPeriod represents the abstract concept of a recurring time period that has a
        ...
        :param 'BudgetBudgetFilterCustomPeriodArgs' custom_period: Specifies to track usage from any start date (required) to any end date (optional).
               ...
               Exactly one of `calendar_period`, `custom_period` must be provided.
               Structure is documented below.
        :param Mapping[str, _builtins.str] labels: A single label and value pair specifying that usage from only
               this set of labeled resources should be included in the budget.
        :param Sequence[_builtins.str] projects: A set of projects of the form projects/{project_number},
               specifying that usage from only this set of projects should be
               included in the budget. If omitted, the report will include
               all usage for the billing account, regardless of which project
               the usage occurred on.
        :param Sequence[_builtins.str] resource_ancestors: A set of folder and organization names of the form folders/{folderId} or organizations/{organizationId},
        ...
        :param Sequence[_builtins.str] services: A set of services of the form services/{service_id},
               specifying that usage from only this set of services should be
               included in the budget. If omitted, the report will include
               usage for all the services. The service names are available
               through the Catalog API:
               https://cloud.google.com/billing/v1/how-tos/catalog-api.
        :param Sequence[_builtins.str] subaccounts: A set of subaccounts of the form billingAccounts/{account_id},
...
class BudgetThresholdRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 spend_basis: Optional[_builtins.str] = None):
        """
        :param _builtins.float threshold_percent: Send an alert when this threshold is exceeded. This is a
               1.0-based percentage, so 0.5 = 50%. Must be >= 0.
        :param _builtins.str spend_basis: The type of basis used to determine if spend has passed
               the threshold.
