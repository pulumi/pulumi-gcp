...
def get_account_iam_policy(billing_account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str billing_account_id: The billing account id.
    """
    __args__ = dict()
...
def get_account_iam_policy_output(billing_account_id: Optional[pulumi.Input[builtins.str]] = None,
