...
class BudgetArgs:
    def __init__(__self__, *,
                 ...
                 ownership_scope: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] billing_account: ID of the billing account to set a budget on.
        ...
        :param pulumi.Input[builtins.str] display_name: User data for display name in UI. Must be <= 60 chars.
        :param pulumi.Input[builtins.str] ownership_scope: The ownership scope of the budget. The ownership scope and users' IAM permissions determine who has full access to the
    ...
    def ownership_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ownership_scope(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BudgetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BudgetBudgetFilterArgs'] budget_filter: Filters that define which resources are used to compute the actual spend against the budget.
        :param pulumi.Input[builtins.str] display_name: User data for display name in UI. Must be <= 60 chars.
        :param pulumi.Input[builtins.str] name: Resource name of the budget. The resource name
...
class Budget(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ownershipScope")
    def ownership_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ownership scope of the budget. The ownership scope and users' IAM permissions determine who has full access to the
        budget's data. Possible values: ["OWNERSHIP_SCOPE_UNSPECIFIED", "ALL_USERS", "BILLING_ACCOUNT"]
        """
