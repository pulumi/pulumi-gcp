...
def get_delivery_pipeline_iam_policy(location: Optional[_builtins.str] = None,
...
def get_delivery_pipeline_iam_policy_output(location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
