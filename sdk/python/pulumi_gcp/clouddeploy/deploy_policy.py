...
class _DeployPolicyState:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['DeployPolicyRuleArgs']]]] = None,
                 selectors: pulumi.Input[Optional[Sequence[pulumi.Input['DeployPolicySelectorArgs']]]] = None,
                 suspended: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DeployPolicyRuleArgs']]]]:
        """
        Rules to apply. At least one rule must be present.
        Structure is documented below.
        """
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DeployPolicyRuleArgs']]]]):
        pulumi.set(self, "rules", value)

    @_builtins.property
    @pulumi.getter
    def selectors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DeployPolicySelectorArgs']]]]:
        """
        Selected resources to which the policy will be applied. At least one selector is required. If one selector matches the resource the policy applies. For example, if there are two selectors and the action being attempted matches one of them, the policy will apply to that action.
        Structure is documented below.
        """
    ...
    @selectors.setter
    def selectors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DeployPolicySelectorArgs']]]]):
        pulumi.set(self, "selectors", value)
