...
def get_custom_target_type_iam_policy(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: The location of the source. Used to find the parent resource to bind the IAM policy to. If not specified,
...
def get_custom_target_type_iam_policy_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
