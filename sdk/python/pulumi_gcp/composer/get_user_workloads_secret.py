...
def get_user_workloads_secret(environment: Optional[builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param builtins.str environment: Environment where the Secret is stored.
    :param builtins.str name: Name of the Secret.
    :param builtins.str project: The ID of the project in which the resource belongs.
           If it is not provided, the provider project is used.
    :param builtins.str region: The location or Compute Engine region of the environment.
    """
    __args__ = dict()
...
def get_user_workloads_secret_output(environment: Optional[pulumi.Input[builtins.str]] = None,
