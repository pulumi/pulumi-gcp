...
if not MYPY:
    class EnvironmentConfigArgsDict(TypedDict):
        airflow_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The URI of the Apache Airflow Web UI hosted within this
        environment.
        """
        dag_gcs_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        enable_private_builds_only: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        enable_private_environment: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        environment_size: NotRequired[pulumi.Input[builtins.str]]
        """
        The size of the Cloud Composer environment. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
        """
        gke_cluster: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        resilience_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnvironmentConfigArgs:
    def __init__(__self__, *,
                 airflow_uri: Optional[pulumi.Input[builtins.str]] = None,
                 dag_gcs_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 enable_private_builds_only: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_private_environment: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption_config: Optional[pulumi.Input['EnvironmentConfigEncryptionConfigArgs']] = None,
                 environment_size: Optional[pulumi.Input[builtins.str]] = None,
                 gke_cluster: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 resilience_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] airflow_uri: The URI of the Apache Airflow Web UI hosted within this
               environment.
        :param pulumi.Input[builtins.str] dag_gcs_prefix: The Cloud Storage prefix of the DAGs for this environment.
               Although Cloud Storage objects reside in a flat namespace, a
               hierarchical file tree can be simulated using '/'-delimited
               object name prefixes. DAG objects for this environment
               reside in a simulated directory with this prefix.
        ...
        :param pulumi.Input[builtins.bool] enable_private_builds_only: Optional. If true, builds performed during operations that install Python packages have only private connectivity to Google services. If false, the builds also have access to the internet.
        :param pulumi.Input[builtins.bool] enable_private_environment: Optional. If true, a private Composer environment will be created.
        ...
        :param pulumi.Input[builtins.str] environment_size: The size of the Cloud Composer environment. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
        :param pulumi.Input[builtins.str] gke_cluster: The Kubernetes Engine cluster used to run this environment.
        ...
        :param pulumi.Input[builtins.int] node_count: The number of nodes in the Kubernetes Engine cluster that will be used to run this environment. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        ...
        :param pulumi.Input[builtins.str] resilience_mode: Whether high resilience is enabled or not. This field is supported for Cloud Composer environments in versions composer-2.1.15-airflow-*.*.* and newer.
    ...
    def airflow_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URI of the Apache Airflow Web UI hosted within this
        environment.
        """
    ...
    @airflow_uri.setter
    def airflow_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "airflow_uri", value)

    @property
    @pulumi.getter(name="dagGcsPrefix")
    def dag_gcs_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Cloud Storage prefix of the DAGs for this environment.
        Although Cloud Storage objects reside in a flat namespace, a
        hierarchical file tree can be simulated using '/'-delimited
    ...
    def dag_gcs_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_private_builds_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Optional. If true, builds performed during operations that install Python packages have only private connectivity to Google services. If false, the builds also have access to the internet.
        """
    ...
    def enable_private_builds_only(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_private_builds_only", value)

    @property
    @pulumi.getter(name="enablePrivateEnvironment")
    def enable_private_environment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Optional. If true, a private Composer environment will be created.
        """
    ...
    def enable_private_environment(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def environment_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The size of the Cloud Composer environment. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
        """
    ...
    def environment_size(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "environment_size", value)

    @property
    @pulumi.getter(name="gkeCluster")
    def gke_cluster(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Kubernetes Engine cluster used to run this environment.
        """
    ...
    @gke_cluster.setter
    def gke_cluster(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def resilience_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether high resilience is enabled or not. This field is supported for Cloud Composer environments in versions composer-2.1.15-airflow-*.*.* and newer.
        """
    ...
    def resilience_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EnvironmentConfigDataRetentionConfigAirflowMetadataRetentionConfigArgsDict(TypedDict):
        ...
        """
        retention_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnvironmentConfigDataRetentionConfigAirflowMetadataRetentionConfigArgs:
    def __init__(__self__, *,
                 ...
                 retention_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] retention_days: How many days data should be retained for. This field is supported for Cloud Composer environments in composer 3 and newer.
        :param pulumi.Input[builtins.str] retention_mode: Whether database retention is enabled or not. This field is supported for Cloud Composer environments in composer 3 and newer.
        """
    ...
    def retention_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether database retention is enabled or not. This field is supported for Cloud Composer environments in composer 3 and newer.
        """
    ...
    def retention_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnvironmentConfigDataRetentionConfigTaskLogsRetentionConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] storage_mode: Whether logs in cloud logging only is enabled or not. This field is supported for Cloud Composer environments in versions composer-2.0.32-airflow-2.1.4 and newer but not in composer-3*
        """
...
class EnvironmentConfigDatabaseConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] machine_type: Optional. Cloud SQL machine type used by Airflow database. It has to be one of: db-n1-standard-2, db-n1-standard-4, db-n1-standard-8 or db-n1-standard-16. If not specified, db-n1-standard-2 will be used.
        :param pulumi.Input[builtins.str] zone: Optional. Cloud SQL database preferred zone.
        """
...
class EnvironmentConfigEncryptionConfigArgs:
    def __init__(__self__, *,
                 kms_key_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_name: Optional. Customer-managed Encryption Key available through Google's Key Management Service. Cannot be updated.
        """
...
class EnvironmentConfigMaintenanceWindowArgs:
    def __init__(__self__, *,
                 ...
                 start_time: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] end_time: Maintenance window end time. It is used only to calculate the duration of the maintenance window. The value for end-time must be in the future, relative to 'start_time'.
        :param pulumi.Input[builtins.str] recurrence: Maintenance window recurrence. Format is a subset of RFC-5545 (https://tools.ietf.org/html/rfc5545) 'RRULE'. The only allowed values for 'FREQ' field are 'FREQ=DAILY' and 'FREQ=WEEKLY;BYDAY=...'. Example values: 'FREQ=WEEKLY;BYDAY=TU,WE', 'FREQ=DAILY'.
        :param pulumi.Input[builtins.str] start_time: Start time of the first recurrence of the maintenance window.
        """
...
class EnvironmentConfigMasterAuthorizedNetworksConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether or not master authorized networks is enabled.
...
class EnvironmentConfigMasterAuthorizedNetworksConfigCidrBlockArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cidr_block: cidr_block must be specified in CIDR notation.
        :param pulumi.Input[builtins.str] display_name: display_name is a field for users to identify CIDR blocks.
        """
...
if not MYPY:
    class EnvironmentConfigNodeConfigArgsDict(TypedDict):
        composer_internal_ipv4_cidr_block: NotRequired[pulumi.Input[builtins.str]]
        """
        IPv4 cidr range that will be used by Composer internal components.
        """
        composer_network_attachment: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        enable_ip_masq_agent: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EnvironmentConfigNodeConfigArgs:
    def __init__(__self__, *,
                 composer_internal_ipv4_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 composer_network_attachment: Optional[pulumi.Input[builtins.str]] = None,
                 disk_size_gb: Optional[pulumi.Input[builtins.int]] = None,
                 enable_ip_masq_agent: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] composer_internal_ipv4_cidr_block: IPv4 cidr range that will be used by Composer internal components.
        :param pulumi.Input[builtins.str] composer_network_attachment: PSC (Private Service Connect) Network entry point. Customers can pre-create the Network Attachment and point Cloud Composer environment to use. It is possible to share network attachment among many environments, provided enough IP addresses are available.
        :param pulumi.Input[builtins.int] disk_size_gb: The disk size in GB used for node VMs. Minimum size is 20GB. If unspecified, defaults to 100GB. Cannot be updated. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        :param pulumi.Input[builtins.bool] enable_ip_masq_agent: Deploys 'ip-masq-agent' daemon set in the GKE cluster and defines nonMasqueradeCIDRs equals to pod IP range so IP masquerading is used for all destination addresses, except between pods traffic. See: https://cloud.google.com/kubernetes-engine/docs/how-to/ip-masquerade-agent
        ...
        :param pulumi.Input[builtins.str] machine_type: The Compute Engine machine type used for cluster instances, specified as a name or relative resource name. For example: "projects/{project}/zones/{zone}/machineTypes/{machineType}". Must belong to the enclosing environment's project and region/zone. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        :param pulumi.Input[builtins.int] max_pods_per_node: The maximum pods per node in the GKE cluster allocated during environment creation. Lowering this value reduces IP address consumption by the Cloud Composer Kubernetes cluster. This value can only be set during environment creation, and only if the environment is VPC-Native. The range of possible values is 8-110, and the default is 32. Cannot be updated. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        :param pulumi.Input[builtins.str] network: The Compute Engine machine type used for cluster instances, specified as a name or relative resource name. For example: "projects/{project}/zones/{zone}/machineTypes/{machineType}". Must belong to the enclosing environment's project and region/zone. The network must belong to the environment's project. If unspecified, the "default" network ID in the environment's project is used. If a Custom Subnet Network is provided, subnetwork must also be provided.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] oauth_scopes: The set of Google API scopes to be made available on all node VMs. Cannot be updated. If empty, defaults to ["https://www.googleapis.com/auth/cloud-platform"]. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        :param pulumi.Input[builtins.str] service_account: The Google Cloud Platform Service Account to be used by the node VMs. If a service account is not specified, the "default" Compute Engine service account is used. Cannot be updated. If given, note that the service account must have roles/composer.worker for any GCP resources created under the Cloud Composer Environment.
        :param pulumi.Input[builtins.str] subnetwork: The Compute Engine subnetwork to be used for machine communications, specified as a self-link, relative resource name (e.g. "projects/{project}/regions/{region}/subnetworks/{subnetwork}"), or by name. If subnetwork is provided, network must also be provided and the subnetwork must belong to the enclosing environment's project and region.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: The list of instance tags applied to all node VMs. Tags are used to identify valid sources or targets for network firewalls. Each tag within the list must comply with RFC1035. Cannot be updated.
        :param pulumi.Input[builtins.str] zone: The Compute Engine zone in which to deploy the VMs running the Apache Airflow software, specified as the zone name or relative resource name (e.g. "projects/{project}/zones/{zone}"). Must belong to the enclosing environment's project and region. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        """
    ...
    def composer_internal_ipv4_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IPv4 cidr range that will be used by Composer internal components.
        """
    ...
    def composer_internal_ipv4_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "composer_internal_ipv4_cidr_block", value)

    @property
    @pulumi.getter(name="composerNetworkAttachment")
    def composer_network_attachment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        PSC (Private Service Connect) Network entry point. Customers can pre-create the Network Attachment and point Cloud Composer environment to use. It is possible to share network attachment among many environments, provided enough IP addresses are available.
        """
    ...
    def composer_network_attachment(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_ip_masq_agent(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Deploys 'ip-masq-agent' daemon set in the GKE cluster and defines nonMasqueradeCIDRs equals to pod IP range so IP masquerading is used for all destination addresses, except between pods traffic. See: https://cloud.google.com/kubernetes-engine/docs/how-to/ip-masquerade-agent
        """
    ...
    def enable_ip_masq_agent(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class EnvironmentConfigNodeConfigIpAllocationPolicyArgsDict(TypedDict):
        ...
        """
        use_ip_aliases: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EnvironmentConfigNodeConfigIpAllocationPolicyArgs:
    ...
    def use_ip_aliases(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether or not to enable Alias IPs in the GKE cluster. If true, a VPC-native cluster is created. Defaults to true if the ip_allocation_policy block is present in config. This field is only supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*. Environments in newer versions always use VPC-native GKE clusters.
        """
    ...
    def use_ip_aliases(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_ip_aliases", value)


if not MYPY:
    class EnvironmentConfigPrivateEnvironmentConfigArgsDict(TypedDict):
        cloud_composer_connection_subnetwork: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        cloud_composer_network_ipv4_cidr_block: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        cloud_sql_ipv4_cidr_block: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        enable_privately_used_public_ips: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        web_server_ipv4_cidr_block: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnvironmentConfigPrivateEnvironmentConfigArgs:
    def __init__(__self__, *,
                 cloud_composer_connection_subnetwork: Optional[pulumi.Input[builtins.str]] = None,
                 cloud_composer_network_ipv4_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 cloud_sql_ipv4_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 connection_type: Optional[pulumi.Input[builtins.str]] = None,
                 enable_private_endpoint: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_privately_used_public_ips: Optional[pulumi.Input[builtins.bool]] = None,
                 master_ipv4_cidr_block: Optional[pulumi.Input[builtins.str]] = None,
                 web_server_ipv4_cidr_block: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cloud_composer_connection_subnetwork: When specified, the environment will use Private Service Connect instead of VPC peerings to connect to Cloud SQL in the Tenant Project, and the PSC endpoint in the Customer Project will use an IP address from this subnetwork. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
        :param pulumi.Input[builtins.str] cloud_composer_network_ipv4_cidr_block: The CIDR block from which IP range for Cloud Composer Network in tenant project will be reserved. Needs to be disjoint from private_cluster_config.master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
        :param pulumi.Input[builtins.str] cloud_sql_ipv4_cidr_block: The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from web_server_ipv4_cidr_block.
        :param pulumi.Input[builtins.str] connection_type: Mode of internal communication within the Composer environment. Must be one of "VPC_PEERING" or "PRIVATE_SERVICE_CONNECT".
        :param pulumi.Input[builtins.bool] enable_private_endpoint: If true, access to the public endpoint of the GKE cluster is denied. If this field is set to true, ip_allocation_policy.use_ip_aliases must be set to true for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        :param pulumi.Input[builtins.bool] enable_privately_used_public_ips: When enabled, IPs from public (non-RFC1918) ranges can be used for ip_allocation_policy.cluster_ipv4_cidr_block and ip_allocation_policy.service_ipv4_cidr_block.
        :param pulumi.Input[builtins.str] master_ipv4_cidr_block: The IP range in CIDR notation to use for the hosted master network. This range is used for assigning internal IP addresses to the cluster master or set of masters and to the internal load balancer virtual IP. This range must not overlap with any other ranges in use within the cluster's network. If left blank, the default value of '172.16.0.0/28' is used.
        :param pulumi.Input[builtins.str] web_server_ipv4_cidr_block: The CIDR block from which IP range for web server will be reserved. Needs to be disjoint from master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        """
    ...
    def cloud_composer_connection_subnetwork(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When specified, the environment will use Private Service Connect instead of VPC peerings to connect to Cloud SQL in the Tenant Project, and the PSC endpoint in the Customer Project will use an IP address from this subnetwork. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
        """
    ...
    def cloud_composer_connection_subnetwork(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloud_composer_connection_subnetwork", value)

    @property
    @pulumi.getter(name="cloudComposerNetworkIpv4CidrBlock")
    def cloud_composer_network_ipv4_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CIDR block from which IP range for Cloud Composer Network in tenant project will be reserved. Needs to be disjoint from private_cluster_config.master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-2.*.*-airflow-*.*.* and newer.
        """
    ...
    def cloud_composer_network_ipv4_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloud_composer_network_ipv4_cidr_block", value)

    @property
    @pulumi.getter(name="cloudSqlIpv4CidrBlock")
    def cloud_sql_ipv4_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from web_server_ipv4_cidr_block.
        """
    ...
    def cloud_sql_ipv4_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_privately_used_public_ips(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, IPs from public (non-RFC1918) ranges can be used for ip_allocation_policy.cluster_ipv4_cidr_block and ip_allocation_policy.service_ipv4_cidr_block.
        """
    ...
    def enable_privately_used_public_ips(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def web_server_ipv4_cidr_block(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The CIDR block from which IP range for web server will be reserved. Needs to be disjoint from master_ipv4_cidr_block and cloud_sql_ipv4_cidr_block. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*.
        """
    ...
    def web_server_ipv4_cidr_block(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EnvironmentConfigRecoveryConfigScheduledSnapshotsConfigArgsDict(TypedDict):
        ...
        """
        snapshot_creation_schedule: NotRequired[pulumi.Input[builtins.str]]
        """
        Snapshot schedule, in the unix-cron format.
        """
        snapshot_location: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnvironmentConfigRecoveryConfigScheduledSnapshotsConfigArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool],
                 snapshot_creation_schedule: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_location: Optional[pulumi.Input[builtins.str]] = None,
                 time_zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: When enabled, Cloud Composer periodically saves snapshots of your environment to a Cloud Storage bucket.
        :param pulumi.Input[builtins.str] snapshot_creation_schedule: Snapshot schedule, in the unix-cron format.
        :param pulumi.Input[builtins.str] snapshot_location: the URI of a bucket folder where to save the snapshot.
        :param pulumi.Input[builtins.str] time_zone: A time zone for the schedule. This value is a time offset and does not take into account daylight saving time changes. Valid values are from UTC-12 to UTC+12. Examples: UTC, UTC-01, UTC+03.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def snapshot_creation_schedule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Snapshot schedule, in the unix-cron format.
        """
    ...
    def snapshot_creation_schedule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "snapshot_creation_schedule", value)

    @property
    @pulumi.getter(name="snapshotLocation")
    def snapshot_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        the URI of a bucket folder where to save the snapshot.
        """
    ...
    def snapshot_location(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EnvironmentConfigSoftwareConfigArgsDict(TypedDict):
        airflow_config_overrides: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        env_variables: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        pypi_packages: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        scheduler_count: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of schedulers for Airflow. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-2.*.*.
        """
        web_server_plugins_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EnvironmentConfigSoftwareConfigArgs:
    def __init__(__self__, *,
                 airflow_config_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 pypi_packages: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 python_version: Optional[pulumi.Input[builtins.str]] = None,
                 scheduler_count: Optional[pulumi.Input[builtins.int]] = None,
                 web_server_plugins_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] airflow_config_overrides: Apache Airflow configuration properties to override. Property keys contain the section and property names, separated by a hyphen, for example "core-dags_are_paused_at_creation". Section names must not contain hyphens ("-"), opening square brackets ("["), or closing square brackets ("]"). The property name must not be empty and cannot contain "=" or ";". Section and property names cannot contain characters: "." Apache Airflow configuration property names must be written in snake_case. Property values can contain any character, and can be written in any lower/upper case format. Certain Apache Airflow configuration property values are blacklisted, and cannot be overridden.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] env_variables: Additional environment variables to provide to the Apache Airflow scheduler, worker, and webserver processes. Environment variable names must match the regular expression [a-zA-Z_][a-zA-Z0-9_]*. They cannot specify Apache Airflow software configuration overrides (they cannot match the regular expression AIRFLOW__[A-Z0-9_]+__[A-Z0-9_]+), and they cannot match any of the following reserved names: AIRFLOW_HOME C_FORCE_ROOT CONTAINER_NAME DAGS_FOLDER GCP_PROJECT GCS_BUCKET GKE_CLUSTER_NAME SQL_DATABASE SQL_INSTANCE SQL_PASSWORD SQL_PROJECT SQL_REGION SQL_USER.
        :param pulumi.Input[builtins.str] image_version: The version of the software running in the environment. This encapsulates both the version of Cloud Composer functionality and the version of Apache Airflow. It must match the regular expression composer-([0-9]+(\\.[0-9]+\\.[0-9]+(-preview\\.[0-9]+)?)?|latest)-airflow-([0-9]+(\\.[0-9]+(\\.[0-9]+)?)?). The Cloud Composer portion of the image version is a full semantic version, or an alias in the form of major version number or 'latest'. The Apache Airflow portion of the image version is a full semantic version that points to one of the supported Apache Airflow versions, or an alias in the form of only major or major.minor versions specified. See documentation for more details and version list.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] pypi_packages: Custom Python Package Index (PyPI) packages to be installed in the environment. Keys refer to the lowercase package name (e.g. "numpy"). Values are the lowercase extras and version specifier (e.g. "==1.12.0", "[devel,gcp_api]", "[devel]>=1.8.2, <1.9.2"). To specify a package without pinning it to a version specifier, use the empty string as the value.
        :param pulumi.Input[builtins.str] python_version: The major version of Python used to run the Apache Airflow scheduler, worker, and webserver processes. Can be set to '2' or '3'. If not specified, the default is '2'. Cannot be updated. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*. Environments in newer versions always use Python major version 3.
        :param pulumi.Input[builtins.int] scheduler_count: The number of schedulers for Airflow. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-2.*.*.
        :param pulumi.Input[builtins.str] web_server_plugins_mode: Should be either 'ENABLED' or 'DISABLED'. Defaults to 'ENABLED'. Used in Composer 3.
        """
    ...
    def airflow_config_overrides(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Apache Airflow configuration properties to override. Property keys contain the section and property names, separated by a hyphen, for example "core-dags_are_paused_at_creation". Section names must not contain hyphens ("-"), opening square brackets ("["), or closing square brackets ("]"). The property name must not be empty and cannot contain "=" or ";". Section and property names cannot contain characters: "." Apache Airflow configuration property names must be written in snake_case. Property values can contain any character, and can be written in any lower/upper case format. Certain Apache Airflow configuration property values are blacklisted, and cannot be overridden.
        """
    ...
    def airflow_config_overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def pypi_packages(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Custom Python Package Index (PyPI) packages to be installed in the environment. Keys refer to the lowercase package name (e.g. "numpy"). Values are the lowercase extras and version specifier (e.g. "==1.12.0", "[devel,gcp_api]", "[devel]>=1.8.2, <1.9.2"). To specify a package without pinning it to a version specifier, use the empty string as the value.
        """
    ...
    def pypi_packages(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def scheduler_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of schedulers for Airflow. This field is supported for Cloud Composer environments in versions composer-1.*.*-airflow-2.*.*.
        """
    ...
    def scheduler_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "scheduler_count", value)

    @property
    @pulumi.getter(name="webServerPluginsMode")
    def web_server_plugins_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Should be either 'ENABLED' or 'DISABLED'. Defaults to 'ENABLED'. Used in Composer 3.
        """
    ...
    def web_server_plugins_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnvironmentConfigSoftwareConfigCloudDataLineageIntegrationArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether or not Cloud Data Lineage integration is enabled.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class EnvironmentConfigWebServerConfigArgs:
    def __init__(__self__, *,
                 machine_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] machine_type: Optional. Machine type on which Airflow web server is running. It has to be one of: composer-n1-webserver-2, composer-n1-webserver-4 or composer-n1-webserver-8. If not specified, composer-n1-webserver-2 will be used. Value custom is returned only in response, if Airflow web server parameters were manually changed to a non-standard values.
        """
        pulumi.set(__self__, "machine_type", machine_type)
...
class EnvironmentConfigWebServerNetworkAccessControlAllowedIpRangeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value: IP address or range, defined using CIDR notation, of requests that this rule applies to. Examples: 192.168.1.1 or 192.168.0.0/16 or 2001:db8::/32 or 2001:0db8:0000:0042:0000:8a2e:0370:7334. IP range prefixes should be properly truncated. For example, 1.2.3.4/24 should be truncated to 1.2.3.0/24. Similarly, for IPv6, 2001:db8::1/32 should be truncated to 2001:db8::/32.
        :param pulumi.Input[builtins.str] description: A description of this ip range.
        """
...
if not MYPY:
    class EnvironmentConfigWorkloadsConfigDagProcessorArgsDict(TypedDict):
        ...
        """
        storage_gb: NotRequired[pulumi.Input[builtins.float]]
        """
...
class EnvironmentConfigWorkloadsConfigDagProcessorArgs:
    def __init__(__self__, *,
                 ...
                 storage_gb: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.int] count: Number of DAG processors.
        :param pulumi.Input[builtins.float] cpu: CPU request and limit for DAG processor.
        :param pulumi.Input[builtins.float] memory_gb: Memory (GB) request and limit for DAG processor.
        :param pulumi.Input[builtins.float] storage_gb: Storage (GB) request and limit for DAG processor.
        """
    ...
    def storage_gb(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Storage (GB) request and limit for DAG processor.
        """
    ...
    @storage_gb.setter
    def storage_gb(self, value: Optional[pulumi.Input[builtins.float]]):
...
class EnvironmentConfigWorkloadsConfigSchedulerArgs:
    def __init__(__self__, *,
                 ...
                 storage_gb: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.int] count: The number of schedulers.
        :param pulumi.Input[builtins.float] cpu: CPU request and limit for a single Airflow scheduler replica
        :param pulumi.Input[builtins.float] memory_gb: Memory (GB) request and limit for a single Airflow scheduler replica.
        :param pulumi.Input[builtins.float] storage_gb: Storage (GB) request and limit for a single Airflow scheduler replica.
        """
        if count is not None:
            pulumi.set(__self__, "count", count)
        if cpu is not None:
...
if not MYPY:
    class EnvironmentConfigWorkloadsConfigTriggererArgsDict(TypedDict):
        ...
        """
        memory_gb: pulumi.Input[builtins.float]
        """
...
class EnvironmentConfigWorkloadsConfigTriggererArgs:
    def __init__(__self__, *,
                 ...
                 memory_gb: pulumi.Input[builtins.float]):
        """
        :param pulumi.Input[builtins.int] count: The number of triggerers.
        :param pulumi.Input[builtins.float] cpu: CPU request and limit for a single Airflow triggerer replica.
        :param pulumi.Input[builtins.float] memory_gb: Memory (GB) request and limit for a single Airflow triggerer replica.
        """
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "cpu", cpu)
        pulumi.set(__self__, "memory_gb", memory_gb)
    ...
    @property
    @pulumi.getter(name="memoryGb")
    def memory_gb(self) -> pulumi.Input[builtins.float]:
        """
        Memory (GB) request and limit for a single Airflow triggerer replica.
        """
        return pulumi.get(self, "memory_gb")
    ...
    @memory_gb.setter
    def memory_gb(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "memory_gb", value)
...
class EnvironmentConfigWorkloadsConfigWebServerArgs:
    def __init__(__self__, *,
                 ...
                 storage_gb: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.float] cpu: CPU request and limit for Airflow web server.
        :param pulumi.Input[builtins.float] memory_gb: Memory (GB) request and limit for Airflow web server.
        :param pulumi.Input[builtins.float] storage_gb: Storage (GB) request and limit for Airflow web server.
        """
        if cpu is not None:
            pulumi.set(__self__, "cpu", cpu)
        if memory_gb is not None:
...
class EnvironmentConfigWorkloadsConfigWorkerArgs:
    def __init__(__self__, *,
                 ...
                 storage_gb: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.float] cpu: CPU request and limit for a single Airflow worker replica.
        :param pulumi.Input[builtins.int] max_count: Maximum number of workers for autoscaling.
        :param pulumi.Input[builtins.float] memory_gb: Memory (GB) request and limit for a single Airflow worker replica.
        :param pulumi.Input[builtins.int] min_count: Minimum number of workers for autoscaling.
        :param pulumi.Input[builtins.float] storage_gb: Storage (GB) request and limit for a single Airflow worker replica.
        """
        if cpu is not None:
            pulumi.set(__self__, "cpu", cpu)
...
class EnvironmentStorageConfigArgs:
    def __init__(__self__, *,
                 bucket: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] bucket: Optional. Name of an existing Cloud Storage bucket to be used by the environment.
        """
