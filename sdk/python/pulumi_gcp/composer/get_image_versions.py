...
def get_image_versions(project: Optional[_builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param _builtins.str project: The ID of the project to list versions in.
           If it is not provided, the provider project is used.
    :param _builtins.str region: The location to list versions in.
