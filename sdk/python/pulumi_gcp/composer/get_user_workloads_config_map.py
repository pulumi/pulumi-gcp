...
def get_user_workloads_config_map(environment: Optional[builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param builtins.str environment: Environment where the ConfigMap is stored.
    :param builtins.str name: Name of the ConfigMap.
...
def get_user_workloads_config_map_output(environment: Optional[pulumi.Input[builtins.str]] = None,
