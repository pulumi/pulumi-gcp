...
def get_user_workloads_config_map(environment: Optional[_builtins.str] = None,
    ...
    * How-to Guides
    ...
    :param _builtins.str environment: Environment where the ConfigMap is stored.
    :param _builtins.str name: Name of the ConfigMap.
...
def get_user_workloads_config_map_output(environment: Optional[pulumi.Input[_builtins.str]] = None,
