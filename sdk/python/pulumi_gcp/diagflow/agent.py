...
class AgentArgs:
    def __init__(__self__, *,
                 ...
                 classification_threshold: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 supported_language_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tier: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Agent resource.
        :param pulumi.Input[builtins.str] default_language_code: The default language of the agent as a language tag. [See Language Support](https://cloud.google.com/dialogflow/docs/reference/language)
        ...
        :param pulumi.Input[builtins.str] avatar_uri: The URI of the agent's avatar, which are used throughout the Dialogflow console. When an image URL is entered
               into this field, the Dialogflow will save the image in the backend. The address of the backend image returned
               from the API will be shown in the [avatarUriBackend] field.
        :param pulumi.Input[builtins.float] classification_threshold: To filter out false positive results and still get variety in matched natural language inputs for your agent,
               you can tune the machine learning classification threshold. If the returned score value is less than the threshold
               value, then a fallback intent will be triggered or, if there are no fallback intents defined, no intent will be
               triggered. The score values range from 0.0 (completely uncertain) to 1.0 (completely certain). If set to 0.0, the
               default of 0.3 is used.
        :param pulumi.Input[builtins.str] description: The description of this agent. The maximum length is 500 characters. If exceeded, the request is rejected.
        :param pulumi.Input[builtins.bool] enable_logging: Determines whether this agent should log conversation queries.
        :param pulumi.Input[builtins.str] match_mode: Determines how intents are detected from user queries.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_language_codes: The list of all languages supported by this agent (except for the defaultLanguageCode).
        :param pulumi.Input[builtins.str] tier: The agent tier. If not specified, TIER_STANDARD is assumed.
    ...
    def avatar_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def classification_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def classification_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def supported_language_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def supported_language_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AgentState:
    def __init__(__self__, *,
                 api_version: Optional[pulumi.Input[builtins.str]] = None,
                 avatar_uri: Optional[pulumi.Input[builtins.str]] = None,
                 avatar_uri_backend: Optional[pulumi.Input[builtins.str]] = None,
                 classification_threshold: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] avatar_uri: The URI of the agent's avatar, which are used throughout the Dialogflow console. When an image URL is entered
               into this field, the Dialogflow will save the image in the backend. The address of the backend image returned
               from the API will be shown in the [avatarUriBackend] field.
        :param pulumi.Input[builtins.str] avatar_uri_backend: The URI of the agent's avatar as returned from the API. Output only. To provide an image URL for the agent avatar,
    ...
    def avatar_uri_backend(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def avatar_uri_backend(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="defaultLanguageCode")
    def default_language_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The default language of the agent as a language tag. [See Language Support](https://cloud.google.com/dialogflow/docs/reference/language)
        for a list of the currently supported language codes. This field cannot be updated after creation.
        """
...
class Agent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            supported_language_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tier: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'Agent':
        """
    ...
    @property
    @pulumi.getter(name="avatarUri")
    def avatar_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URI of the agent's avatar, which are used throughout the Dialogflow console. When an image URL is entered
        into this field, the Dialogflow will save the image in the backend. The address of the backend image returned
        from the API will be shown in the [avatarUriBackend] field.
    ...
    @property
    @pulumi.getter(name="avatarUriBackend")
    def avatar_uri_backend(self) -> pulumi.Output[builtins.str]:
        """
        The URI of the agent's avatar as returned from the API. Output only. To provide an image URL for the agent avatar,
        the [avatarUri] field can be used.
        """
    ...
    @property
    @pulumi.getter(name="classificationThreshold")
    def classification_threshold(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        To filter out false positive results and still get variety in matched natural language inputs for your agent,
        you can tune the machine learning classification threshold. If the returned score value is less than the threshold
        value, then a fallback intent will be triggered or, if there are no fallback intents defined, no intent will be
    ...
    @property
    @pulumi.getter(name="defaultLanguageCode")
    def default_language_code(self) -> pulumi.Output[builtins.str]:
        """
        The default language of the agent as a language tag. [See Language Support](https://cloud.google.com/dialogflow/docs/reference/language)
        for a list of the currently supported language codes. This field cannot be updated after creation.
        """
    ...
    @property
    @pulumi.getter(name="supportedLanguageCodes")
    def supported_language_codes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of all languages supported by this agent (except for the defaultLanguageCode).
        """
        return pulumi.get(self, "supported_language_codes")
