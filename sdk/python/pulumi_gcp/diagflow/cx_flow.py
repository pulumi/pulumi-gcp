...
class CxFlowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CxFlowEventHandlerArgs']]] event_handlers: A flow's event handlers serve two purposes:
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.bool] is_default_start_flow: Marks this as the [Default Start Flow](https://cloud.google.com/dialogflow/cx/docs/concept/flow#start) for an agent. When you create an agent, the Default Start Flow is created automatically.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transition_route_groups: A flow's transition route group serve two purposes:
    ...
    def is_default_start_flow(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
...
class _CxFlowState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] language_code: The language of the following fields in flow:
               ...
               Flow.transition_routes.trigger_fulfillment.conditional_cases
               If not specified, the agent's default language is used. Many languages are supported. Note: languages must be enabled in the agent before they can be used.
        :param pulumi.Input[builtins.str] name: The unique identifier of the flow.
...
class CxFlow(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isDefaultStartFlow")
    def is_default_start_flow(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Marks this as the [Default Start Flow](https://cloud.google.com/dialogflow/cx/docs/concept/flow#start) for an agent. When you create an agent, the Default Start Flow is created automatically.
        The Default Start Flow cannot be deleted; deleting the `diagflow.CxFlow` resource does nothing to the underlying GCP resources.
