...
class CxAgentAdvancedSettingsAudioExportGcsDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] uri: The Google Cloud Storage URI for the exported objects. Whether a full object name, or just a prefix, its usage depends on the Dialogflow operation.
               Format: gs://bucket/object-name-or-prefix
        """
        if uri is not None:
...
if not MYPY:
    class CxAgentAdvancedSettingsDtmfSettingsArgsDict(TypedDict):
        ...
        """
        finish_digit: NotRequired[pulumi.Input[builtins.str]]
        """
        The digit that terminates a DTMF digit sequence.
        """
        max_digits: NotRequired[pulumi.Input[builtins.int]]
        """
...
class CxAgentAdvancedSettingsDtmfSettingsArgs:
    def __init__(__self__, *,
                 ...
                 finish_digit: Optional[pulumi.Input[builtins.str]] = None,
                 max_digits: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: If true, incoming audio is processed for DTMF (dual tone multi frequency) events. For example, if the caller presses a button on their telephone keypad and DTMF processing is enabled, Dialogflow will detect the event (e.g. a "3" was pressed) in the incoming audio and pass the event to the bot to drive business logic (e.g. when 3 is pressed, return the account balance).
        :param pulumi.Input[builtins.str] finish_digit: The digit that terminates a DTMF digit sequence.
        :param pulumi.Input[builtins.int] max_digits: Max length of DTMF digits.
        """
    ...
    def finish_digit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The digit that terminates a DTMF digit sequence.
        """
    ...
    @finish_digit.setter
    def finish_digit(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "finish_digit", value)

    @property
    @pulumi.getter(name="maxDigits")
    def max_digits(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Max length of DTMF digits.
        """
    ...
    @max_digits.setter
    def max_digits(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_digits", value)


if not MYPY:
    class CxAgentAdvancedSettingsLoggingSettingsArgsDict(TypedDict):
        enable_consent_based_redaction: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables consent-based end-user input redaction, if true, a pre-defined session parameter **$session.params.conversation-redaction** will be used to determine if the utterance should be redacted.
        """
        enable_interaction_logging: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables DF Interaction logging.
        """
        enable_stackdriver_logging: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CxAgentAdvancedSettingsLoggingSettingsArgs:
    def __init__(__self__, *,
                 enable_consent_based_redaction: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_interaction_logging: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_stackdriver_logging: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_consent_based_redaction: Enables consent-based end-user input redaction, if true, a pre-defined session parameter **$session.params.conversation-redaction** will be used to determine if the utterance should be redacted.
        :param pulumi.Input[builtins.bool] enable_interaction_logging: Enables DF Interaction logging.
        :param pulumi.Input[builtins.bool] enable_stackdriver_logging: Enables Google Cloud Logging.
        """
    ...
    def enable_consent_based_redaction(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables consent-based end-user input redaction, if true, a pre-defined session parameter **$session.params.conversation-redaction** will be used to determine if the utterance should be redacted.
        """
    ...
    def enable_consent_based_redaction(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_consent_based_redaction", value)

    @property
    @pulumi.getter(name="enableInteractionLogging")
    def enable_interaction_logging(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables DF Interaction logging.
        """
    ...
    def enable_interaction_logging(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class CxAgentAdvancedSettingsSpeechSettingsArgsDict(TypedDict):
        endpointer_sensitivity: NotRequired[pulumi.Input[builtins.int]]
        """
        Sensitivity of the speech model that detects the end of speech. Scale from 0 to 100.
        """
        models: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        Mapping from language to Speech-to-Text model. The mapped Speech-to-Text model will be selected for requests from its corresponding language. For more information, see [Speech models](https://cloud.google.com/dialogflow/cx/docs/concept/speech-models).
        An object containing a list of **"key": value** pairs. Example: **{ "name": "wrench", "mass": "1.3kg", "count": "3" }**.
        """
        no_speech_timeout: NotRequired[pulumi.Input[builtins.str]]
        """
        Timeout before detecting no speech.
        A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        """
        use_timeout_based_endpointing: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CxAgentAdvancedSettingsSpeechSettingsArgs:
    def __init__(__self__, *,
                 endpointer_sensitivity: Optional[pulumi.Input[builtins.int]] = None,
                 models: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 no_speech_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 use_timeout_based_endpointing: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] endpointer_sensitivity: Sensitivity of the speech model that detects the end of speech. Scale from 0 to 100.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] models: Mapping from language to Speech-to-Text model. The mapped Speech-to-Text model will be selected for requests from its corresponding language. For more information, see [Speech models](https://cloud.google.com/dialogflow/cx/docs/concept/speech-models).
               An object containing a list of **"key": value** pairs. Example: **{ "name": "wrench", "mass": "1.3kg", "count": "3" }**.
        :param pulumi.Input[builtins.str] no_speech_timeout: Timeout before detecting no speech.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        :param pulumi.Input[builtins.bool] use_timeout_based_endpointing: Use timeout based endpointing, interpreting endpointer sensitivity as seconds of timeout value.
        """
    ...
    def endpointer_sensitivity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Sensitivity of the speech model that detects the end of speech. Scale from 0 to 100.
        """
    ...
    def endpointer_sensitivity(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "endpointer_sensitivity", value)

    @property
    @pulumi.getter
    def models(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Mapping from language to Speech-to-Text model. The mapped Speech-to-Text model will be selected for requests from its corresponding language. For more information, see [Speech models](https://cloud.google.com/dialogflow/cx/docs/concept/speech-models).
        An object containing a list of **"key": value** pairs. Example: **{ "name": "wrench", "mass": "1.3kg", "count": "3" }**.
        """
    ...
    @models.setter
    def models(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "models", value)

    @property
    @pulumi.getter(name="noSpeechTimeout")
    def no_speech_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Timeout before detecting no speech.
        A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        """
    ...
    def no_speech_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "no_speech_timeout", value)

    @property
    @pulumi.getter(name="useTimeoutBasedEndpointing")
    def use_timeout_based_endpointing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Use timeout based endpointing, interpreting endpointer sensitivity as seconds of timeout value.
        """
...
if not MYPY:
    class CxAgentGitIntegrationSettingsGithubSettingsArgsDict(TypedDict):
        ...
        **Note**: This property is sensitive and will not be displayed in the plan.
        """
        branches: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        repository_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        The GitHub repository URI related to the agent.
        """
        tracking_branch: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxAgentGitIntegrationSettingsGithubSettingsArgs:
    def __init__(__self__, *,
                 ...
                 branches: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 repository_uri: Optional[pulumi.Input[builtins.str]] = None,
                 tracking_branch: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] access_token: The access token used to authenticate the access to the GitHub repository.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] branches: A list of branches configured to be used from Dialogflow.
        :param pulumi.Input[builtins.str] display_name: The unique repository display name for the GitHub repository.
        :param pulumi.Input[builtins.str] repository_uri: The GitHub repository URI related to the agent.
        :param pulumi.Input[builtins.str] tracking_branch: The branch of the GitHub repository tracked for this agent.
        """
    ...
    @property
    @pulumi.getter
    def branches(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of branches configured to be used from Dialogflow.
        """
    ...
    @branches.setter
    def branches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def tracking_branch(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The branch of the GitHub repository tracked for this agent.
        """
    ...
    def tracking_branch(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tracking_branch", value)


if not MYPY:
    class CxAgentSpeechToTextSettingsArgsDict(TypedDict):
        enable_speech_adaptation: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CxAgentSpeechToTextSettingsArgs:
    def __init__(__self__, *,
                 enable_speech_adaptation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_speech_adaptation: Whether to use speech adaptation for speech recognition.
        """
    ...
    def enable_speech_adaptation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to use speech adaptation for speech recognition.
        """
    ...
    def enable_speech_adaptation(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_speech_adaptation", value)


if not MYPY:
    class CxAgentTextToSpeechSettingsArgsDict(TypedDict):
        synthesize_speech_configs: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxAgentTextToSpeechSettingsArgs:
    def __init__(__self__, *,
                 synthesize_speech_configs: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] synthesize_speech_configs: Configuration of how speech should be synthesized, mapping from [language](https://cloud.google.com/dialogflow/cx/docs/reference/language) to [SynthesizeSpeechConfig](https://cloud.google.com/dialogflow/cx/docs/reference/rest/v3/projects.locations.agents#synthesizespeechconfig).
               These settings affect:
               * The phone gateway synthesize configuration set via Agent.text_to_speech_settings.
               * How speech is synthesized when invoking session APIs. `Agent.text_to_speech_settings` only applies if `OutputAudioConfig.synthesize_speech_config` is not specified.
        """
    ...
    def synthesize_speech_configs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Configuration of how speech should be synthesized, mapping from [language](https://cloud.google.com/dialogflow/cx/docs/reference/language) to [SynthesizeSpeechConfig](https://cloud.google.com/dialogflow/cx/docs/reference/rest/v3/projects.locations.agents#synthesizespeechconfig).
        These settings affect:
        * The phone gateway synthesize configuration set via Agent.text_to_speech_settings.
    ...
    def synthesize_speech_configs(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "synthesize_speech_configs", value)


if not MYPY:
    class CxEntityTypeEntityArgsDict(TypedDict):
        synonyms: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CxEntityTypeEntityArgs:
    def __init__(__self__, *,
                 synonyms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] synonyms: A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym could be green onions.
               For KIND_LIST entity types: This collection must contain exactly one synonym equal to value.
               
               - - -
        :param pulumi.Input[builtins.str] value: The primary value associated with this entity entry. For example, if the entity type is vegetable, the value could be scallions.
               For KIND_MAP entity types: A canonical value to be used in place of synonyms.
               For KIND_LIST entity types: A string that can contain references to other entity types (with or without aliases).
        """
    ...
    @property
    @pulumi.getter
    def synonyms(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym could be green onions.
        For KIND_LIST entity types: This collection must contain exactly one synonym equal to value.
    ...
    @synonyms.setter
    def synonyms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CxEntityTypeExcludedPhraseArgs:
    def __init__(__self__, *,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] value: The word or phrase to be excluded.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class CxEnvironmentVersionConfigArgs:
    def __init__(__self__, *,
                 version: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] version: Format: projects/{{project}}/locations/{{location}}/agents/{{agent}}/flows/{{flow}}/versions/{{version}}.
...
if not MYPY:
    class CxFlowEventHandlerArgsDict(TypedDict):
        ...
        """
        target_flow: NotRequired[pulumi.Input[builtins.str]]
        """
        The target flow to transition to.
        Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
        """
        target_page: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowEventHandlerArgs:
    def __init__(__self__, *,
                 ...
                 target_page: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_fulfillment: Optional[pulumi.Input['CxFlowEventHandlerTriggerFulfillmentArgs']] = None):
        """
        :param pulumi.Input[builtins.str] event: The name of the event to handle.
        :param pulumi.Input[builtins.str] name: (Output)
               The unique identifier of this event handler.
        :param pulumi.Input[builtins.str] target_flow: The target flow to transition to.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
        :param pulumi.Input[builtins.str] target_page: The target page to transition to.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
    ...
    def target_page(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The target page to transition to.
        Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
        """
    ...
    @target_page.setter
    def target_page(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CxFlowEventHandlerTriggerFulfillmentArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        return_partial_responses: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        webhook: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowEventHandlerTriggerFulfillmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CxFlowEventHandlerTriggerFulfillmentSetParameterActionArgs']]] set_parameter_actions: Set parameter values before executing the webhook.
               Structure is documented below.
        :param pulumi.Input[builtins.str] tag: The tag used by the webhook to identify which fulfillment is being called. This field is required if webhook is specified.
        :param pulumi.Input[builtins.str] webhook: The webhook to call. Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/webhooks/<Webhook ID>.
        """
    ...
    def return_partial_responses(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether Dialogflow should return currently queued fulfillment response messages in streaming APIs. If a webhook is specified, it happens before Dialogflow invokes webhook. Warning: 1) This flag only affects streaming API. Responses are still queued and returned once in non-streaming API. 2) The flag can be enabled in any fulfillment but only the first 3 partial responses will be returned. You may only want to apply it to fulfillments that have slow webhooks.
        """
    ...
    def return_partial_responses(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class CxFlowEventHandlerTriggerFulfillmentConditionalCaseArgsDict(TypedDict):
        cases: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowEventHandlerTriggerFulfillmentConditionalCaseArgs:
    def __init__(__self__, *,
                 cases: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cases: A JSON encoded list of cascading if-else conditions. Cases are mutually exclusive. The first one with a matching condition is selected, all the rest ignored.
               See [Case](https://cloud.google.com/dialogflow/cx/docs/reference/rest/v3/Fulfillment#case) for the schema.
        """
    ...
    @property
    @pulumi.getter
    def cases(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A JSON encoded list of cascading if-else conditions. Cases are mutually exclusive. The first one with a matching condition is selected, all the rest ignored.
        See [Case](https://cloud.google.com/dialogflow/cx/docs/reference/rest/v3/Fulfillment#case) for the schema.
        """
    ...
    @cases.setter
    def cases(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CxFlowEventHandlerTriggerFulfillmentMessageArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] channel: The channel which the response is associated with. Clients can specify the channel via QueryParameters.channel, and only associated channel response will be returned.
        ...
        :param pulumi.Input['CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioTextArgs'] output_audio_text: A text or ssml response that is preferentially used for TTS output audio synthesis, as described in the comment on the ResponseMessage message.
               This field is part of a union field `message`: Only one of `text`, `payload`, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
               Structure is documented below.
        :param pulumi.Input[builtins.str] payload: Returns a response containing a custom, platform-specific payload.
               This field is part of a union field `message`: Only one of `text`, `payload`, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
...
class CxFlowEventHandlerTriggerFulfillmentMessageConversationSuccessArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] metadata: Custom metadata. Dialogflow doesn't impose any structure on this.
        """
...
if not MYPY:
    class CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioTextArgsDict(TypedDict):
        allow_playback_interruption: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Output)
        Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        """
        ssml: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioTextArgs:
    def __init__(__self__, *,
                 allow_playback_interruption: Optional[pulumi.Input[builtins.bool]] = None,
                 ssml: Optional[pulumi.Input[builtins.str]] = None,
                 text: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] allow_playback_interruption: (Output)
               Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        :param pulumi.Input[builtins.str] ssml: The SSML text to be synthesized. For more information, see SSML.
               This field is part of a union field `source`: Only one of `text` or `ssml` may be set.
        :param pulumi.Input[builtins.str] text: The raw text to be synthesized.
               This field is part of a union field `source`: Only one of `text` or `ssml` may be set.
        """
    ...
    def allow_playback_interruption(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Output)
        Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        """
    ...
    def allow_playback_interruption(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_playback_interruption", value)

    @property
    @pulumi.getter
    def ssml(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The SSML text to be synthesized. For more information, see SSML.
        This field is part of a union field `source`: Only one of `text` or `ssml` may be set.
        """
    ...
    @ssml.setter
    def ssml(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CxFlowEventHandlerTriggerFulfillmentMessagePlayAudioArgsDict(TypedDict):
        audio_uri: pulumi.Input[builtins.str]
        """
...
class CxFlowEventHandlerTriggerFulfillmentMessagePlayAudioArgs:
    def __init__(__self__, *,
                 ...
                 allow_playback_interruption: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] audio_uri: URI of the audio clip. Dialogflow does not impose any validation on this value. It is specific to the client that reads it.
        :param pulumi.Input[builtins.bool] allow_playback_interruption: (Output)
               Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
    ...
    def audio_uri(self) -> pulumi.Input[builtins.str]:
        """
        URI of the audio clip. Dialogflow does not impose any validation on this value. It is specific to the client that reads it.
        """
    ...
    @audio_uri.setter
    def audio_uri(self, value: pulumi.Input[builtins.str]):
...
class CxFlowEventHandlerTriggerFulfillmentMessageTelephonyTransferCallArgs:
    def __init__(__self__, *,
                 phone_number: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] phone_number: Transfer the call to a phone number in E.164 format.
        """
...
if not MYPY:
    class CxFlowEventHandlerTriggerFulfillmentMessageTextArgsDict(TypedDict):
        ...
        Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        """
        texts: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CxFlowEventHandlerTriggerFulfillmentMessageTextArgs:
    def __init__(__self__, *,
                 allow_playback_interruption: Optional[pulumi.Input[builtins.bool]] = None,
                 texts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] allow_playback_interruption: (Output)
               Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] texts: A collection of text response variants. If multiple variants are defined, only one text response variant is returned at runtime.
               required: true
        """
        if allow_playback_interruption is not None:
            pulumi.set(__self__, "allow_playback_interruption", allow_playback_interruption)
    ...
    @property
    @pulumi.getter
    def texts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A collection of text response variants. If multiple variants are defined, only one text response variant is returned at runtime.
        required: true
        """
    ...
    @texts.setter
    def texts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "texts", value)


if not MYPY:
    class CxFlowEventHandlerTriggerFulfillmentSetParameterActionArgsDict(TypedDict):
        parameter: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowEventHandlerTriggerFulfillmentSetParameterActionArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] parameter: Display name of the parameter.
        :param pulumi.Input[builtins.str] value: The new JSON-encoded value of the parameter. A null value clears the parameter.
        """
...
class CxFlowKnowledgeConnectorSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CxFlowKnowledgeConnectorSettingsDataStoreConnectionArgs']]] data_store_connections: Optional. List of related data store connections.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] enabled: Whether Knowledge Connector is enabled or not.
        :param pulumi.Input[builtins.str] target_flow: The target flow to transition to. Format: projects/<ProjectID>/locations/<LocationID>/agents/<AgentID>/flows/<FlowID>.
               This field is part of a union field `target`: Only one of `targetPage` or `targetFlow` may be set.
        :param pulumi.Input[builtins.str] target_page: The target page to transition to. Format: projects/<ProjectID>/locations/<LocationID>/agents/<AgentID>/flows/<FlowID>/pages/<PageID>.
               The page must be in the same host flow (the flow that owns this `KnowledgeConnectorSettings`).
               This field is part of a union field `target`: Only one of `targetPage` or `targetFlow` may be set.
...
if not MYPY:
    class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsDtmfSettingsArgsDict(TypedDict):
        ...
        If true, incoming audio is processed for DTMF (dual tone multi frequtectency) events. For example, if the caller presses a button on their telephone keypad and DTMF processing is enabled, Dialogflow will de the event (e.g. a "3" was pressed) in the incoming audio and pass the event to the bot to drive business logic (e.g. when 3 is pressed, return the account balance).
        """
        endpointing_timeout_duration: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The digit that terminates a DTMF digit sequence.
        """
        interdigit_timeout_duration: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsDtmfSettingsArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 endpointing_timeout_duration: Optional[pulumi.Input[builtins.str]] = None,
                 finish_digit: Optional[pulumi.Input[builtins.str]] = None,
                 interdigit_timeout_duration: Optional[pulumi.Input[builtins.str]] = None,
                 max_digits: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: If true, incoming audio is processed for DTMF (dual tone multi frequtectency) events. For example, if the caller presses a button on their telephone keypad and DTMF processing is enabled, Dialogflow will de the event (e.g. a "3" was pressed) in the incoming audio and pass the event to the bot to drive business logic (e.g. when 3 is pressed, return the account balance).
        :param pulumi.Input[builtins.str] endpointing_timeout_duration: Endpoint timeout setting for matching dtmf input to regex.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.500s".
        :param pulumi.Input[builtins.str] finish_digit: The digit that terminates a DTMF digit sequence.
        :param pulumi.Input[builtins.str] interdigit_timeout_duration: Interdigit timeout setting for matching dtmf input to regex.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.500s".
        :param pulumi.Input[builtins.int] max_digits: Max length of DTMF digits.
        """
        if enabled is not None:
    ...
    def endpointing_timeout_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Endpoint timeout setting for matching dtmf input to regex.
        A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.500s".
        """
    ...
    def endpointing_timeout_duration(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def interdigit_timeout_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Interdigit timeout setting for matching dtmf input to regex.
        A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.500s".
        """
    ...
    def interdigit_timeout_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgsDict(TypedDict):
        ...
        """
        audio: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegmentArgs:
    def __init__(__self__, *,
                 allow_playback_interruption: Optional[pulumi.Input[builtins.bool]] = None,
                 audio: Optional[pulumi.Input[builtins.str]] = None,
                 uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] allow_playback_interruption: (Output)
               Whether the playback of this segment can be interrupted by the end user's speech and the client should then start the next Dialogflow request.
        :param pulumi.Input[builtins.str] audio: Raw audio synthesized from the Dialogflow agent's response using the output config specified in the request.
               A base64-encoded string.
               This field is part of a union field `content`: Only one of `audio` or `uri` may be set.
        :param pulumi.Input[builtins.str] uri: Client-specific URI that points to an audio clip accessible to the client. Dialogflow does not impose any validation on it.
               This field is part of a union field `content`: Only one of `audio` or `uri` may be set.
        """
        if allow_playback_interruption is not None:
            pulumi.set(__self__, "allow_playback_interruption", allow_playback_interruption)
    ...
    @property
    @pulumi.getter
    def audio(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Raw audio synthesized from the Dialogflow agent's response using the output config specified in the request.
        A base64-encoded string.
        This field is part of a union field `content`: Only one of `audio` or `uri` may be set.
    ...
    @audio.setter
    def audio(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CxFlowNluSettingsArgsDict(TypedDict):
        ...
        """
        model_training_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowNluSettingsArgs:
    def __init__(__self__, *,
                 ...
                 model_training_mode: Optional[pulumi.Input[builtins.str]] = None,
                 model_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.float] classification_threshold: To filter out false positive results and still get variety in matched natural language inputs for your agent, you can tune the machine learning classification threshold.
               If the returned score value is less than the threshold value, then a no-match event will be triggered. The score values range from 0.0 (completely uncertain) to 1.0 (completely certain). If set to 0.0, the default of 0.3 is used.
        :param pulumi.Input[builtins.str] model_training_mode: Indicates NLU model training mode.
               * MODEL_TRAINING_MODE_AUTOMATIC: NLU model training is automatically triggered when a flow gets modified. User can also manually trigger model training in this mode.
               * MODEL_TRAINING_MODE_MANUAL: User needs to manually trigger NLU model training. Best for large flows whose models take long time to train.
               Possible values are: `MODEL_TRAINING_MODE_AUTOMATIC`, `MODEL_TRAINING_MODE_MANUAL`.
        :param pulumi.Input[builtins.str] model_type: Indicates the type of NLU model.
               * MODEL_TYPE_STANDARD: Use standard NLU model.
               * MODEL_TYPE_ADVANCED: Use advanced NLU model.
               Possible values are: `MODEL_TYPE_STANDARD`, `MODEL_TYPE_ADVANCED`.
        """
    ...
    def model_training_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Indicates NLU model training mode.
        * MODEL_TRAINING_MODE_AUTOMATIC: NLU model training is automatically triggered when a flow gets modified. User can also manually trigger model training in this mode.
        * MODEL_TRAINING_MODE_MANUAL: User needs to manually trigger NLU model training. Best for large flows whose models take long time to train.
    ...
    def model_training_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CxFlowTransitionRouteArgsDict(TypedDict):
        ...
        """
        intent: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxFlowTransitionRouteArgs:
    def __init__(__self__, *,
                 ...
                 intent: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 target_flow: Optional[pulumi.Input[builtins.str]] = None,
                 target_page: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_fulfillment: Optional[pulumi.Input['CxFlowTransitionRouteTriggerFulfillmentArgs']] = None):
        """
        :param pulumi.Input[builtins.str] condition: The condition to evaluate against form parameters or session parameters.
               At least one of intent or condition must be specified. When both intent and condition are specified, the transition can only happen when both are fulfilled.
        :param pulumi.Input[builtins.str] intent: The unique identifier of an Intent.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/intents/<Intent ID>. Indicates that the transition can only happen when the given intent is matched. At least one of intent or condition must be specified. When both intent and condition are specified, the transition can only happen when both are fulfilled.
        :param pulumi.Input[builtins.str] name: (Output)
               The unique identifier of this transition route.
        :param pulumi.Input[builtins.str] target_flow: The target flow to transition to.
    ...
    @property
    @pulumi.getter
    def intent(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier of an Intent.
        Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/intents/<Intent ID>. Indicates that the transition can only happen when the given intent is matched. At least one of intent or condition must be specified. When both intent and condition are specified, the transition can only happen when both are fulfilled.
        """
    ...
    @intent.setter
    def intent(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CxIntentParameterArgsDict(TypedDict):
        ...
        """
        is_list: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates whether the parameter represents a list of values.
        """
        redact: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CxIntentParameterArgs:
    def __init__(__self__, *,
                 entity_type: pulumi.Input[builtins.str],
                 id: pulumi.Input[builtins.str],
                 is_list: Optional[pulumi.Input[builtins.bool]] = None,
                 redact: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] entity_type: The entity type of the parameter.
               Format: projects/-/locations/-/agents/-/entityTypes/<System Entity Type ID> for system entity types (for example, projects/-/locations/-/agents/-/entityTypes/sys.date), or projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/entityTypes/<Entity Type ID> for developer entity types.
        :param pulumi.Input[builtins.str] id: The unique identifier of the parameter. This field is used by training phrases to annotate their parts.
        :param pulumi.Input[builtins.bool] is_list: Indicates whether the parameter represents a list of values.
        :param pulumi.Input[builtins.bool] redact: Indicates whether the parameter content should be redacted in log. If redaction is enabled, the parameter content will be replaced by parameter name during logging.
               Note: the parameter content is subject to redaction if either parameter level redaction or entity type level redaction is enabled.
        """
    ...
    def is_list(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether the parameter represents a list of values.
        """
    ...
    @is_list.setter
    def is_list(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_list", value)

    @property
    @pulumi.getter
    def redact(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether the parameter content should be redacted in log. If redaction is enabled, the parameter content will be replaced by parameter name during logging.
        Note: the parameter content is subject to redaction if either parameter level redaction or entity type level redaction is enabled.
        """
    ...
    @redact.setter
    def redact(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class CxIntentTrainingPhraseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] id: (Output)
               The unique identifier of the training phrase.
        :param pulumi.Input[builtins.int] repeat_count: Indicates how many times this example was added to the intent.
        """
...
if not MYPY:
    class CxIntentTrainingPhrasePartArgsDict(TypedDict):
        ...
        """
        parameter_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxIntentTrainingPhrasePartArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] text: The text for this part.
        :param pulumi.Input[builtins.str] parameter_id: The parameter used to annotate this part of the training phrase. This field is required for annotated parts of the training phrase.
        """
        pulumi.set(__self__, "text", text)
...
class CxPageFormParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CxPageFormParameterAdvancedSettingsArgs'] advanced_settings: Hierarchical advanced settings for this parameter. The settings exposed at the lower level overrides the settings exposed at the higher level.
               Hierarchy: Agent->Flow->Page->Fulfillment/Parameter.
               Structure is documented below.
        :param pulumi.Input[builtins.str] default_value: The default value of an optional parameter. If the parameter is required, the default value will be ignored.
        :param pulumi.Input[builtins.str] display_name: The human-readable name of the parameter, unique within the form.
        :param pulumi.Input[builtins.str] entity_type: The entity type of the parameter.
               Format: projects/-/locations/-/agents/-/entityTypes/<System Entity Type ID> for system entity types (for example, projects/-/locations/-/agents/-/entityTypes/sys.date), or projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/entityTypes/<Entity Type ID> for developer entity types.
        :param pulumi.Input['CxPageFormParameterFillBehaviorArgs'] fill_behavior: Defines fill behavior for the parameter.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] is_list: Indicates whether the parameter represents a list of values.
        :param pulumi.Input[builtins.bool] redact: Indicates whether the parameter content should be redacted in log.
               If redaction is enabled, the parameter content will be replaced by parameter name during logging. Note: the parameter content is subject to redaction if either parameter level redaction or entity type level redaction is enabled.
        :param pulumi.Input[builtins.bool] required: Indicates whether the parameter is required. Optional parameters will not trigger prompts; however, they are filled if the user specifies them.
               Required parameters must be filled before form filling concludes.
        """
        if advanced_settings is not None:
            pulumi.set(__self__, "advanced_settings", advanced_settings)
...
if not MYPY:
    class CxSecuritySettingsAudioExportSettingsArgsDict(TypedDict):
        audio_export_pattern: NotRequired[pulumi.Input[builtins.str]]
        """
        Filename pattern for exported audio.
        """
        audio_format: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        * OGG: OGG Vorbis.
        ...
        """
        enable_audio_redaction: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CxSecuritySettingsAudioExportSettingsArgs:
    def __init__(__self__, *,
                 audio_export_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 audio_format: Optional[pulumi.Input[builtins.str]] = None,
                 enable_audio_redaction: Optional[pulumi.Input[builtins.bool]] = None,
                 gcs_bucket: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] audio_export_pattern: Filename pattern for exported audio.
        :param pulumi.Input[builtins.str] audio_format: File format for exported audio file. Currently only in telephony recordings.
               * MULAW: G.711 mu-law PCM with 8kHz sample rate.
               * MP3: MP3 file format.
               * OGG: OGG Vorbis.
               Possible values are: `MULAW`, `MP3`, `OGG`.
        :param pulumi.Input[builtins.bool] enable_audio_redaction: Enable audio redaction if it is true.
        :param pulumi.Input[builtins.str] gcs_bucket: Cloud Storage bucket to export audio record to. Setting this field would grant the Storage Object Creator role to the Dialogflow Service Agent. API caller that tries to modify this field should have the permission of storage.buckets.setIamPolicy.
        """
    ...
    def audio_export_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Filename pattern for exported audio.
        """
    ...
    def audio_export_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "audio_export_pattern", value)

    @property
    @pulumi.getter(name="audioFormat")
    def audio_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        File format for exported audio file. Currently only in telephony recordings.
        * MULAW: G.711 mu-law PCM with 8kHz sample rate.
        * MP3: MP3 file format.
    ...
    @audio_format.setter
    def audio_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "audio_format", value)

    @property
    @pulumi.getter(name="enableAudioRedaction")
    def enable_audio_redaction(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable audio redaction if it is true.
        """
    ...
    def enable_audio_redaction(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class CxSecuritySettingsInsightsExportSettingsArgsDict(TypedDict):
        enable_insights_export: pulumi.Input[builtins.bool]
        """
...
class CxSecuritySettingsInsightsExportSettingsArgs:
    def __init__(__self__, *,
                 enable_insights_export: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enable_insights_export: If enabled, we will automatically exports conversations to Insights and Insights runs its analyzers.
        """
        pulumi.set(__self__, "enable_insights_export", enable_insights_export)

    @property
    @pulumi.getter(name="enableInsightsExport")
    def enable_insights_export(self) -> pulumi.Input[builtins.bool]:
        """
        If enabled, we will automatically exports conversations to Insights and Insights runs its analyzers.
        """
    ...
    def enable_insights_export(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class CxTestCaseLastTestResultArgsDict(TypedDict):
        ...
        Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
        """
        test_result: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        * FAILED: The test did not pass.
        ...
        """
        test_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxTestCaseLastTestResultArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 test_result: Optional[pulumi.Input[builtins.str]] = None,
                 test_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['CxTestCaseLastTestResultConversationTurnArgs']]] conversation_turns: The conversation turns uttered during the test case replay in chronological order.
               Structure is documented below.
        :param pulumi.Input[builtins.str] environment: Environment where the test was run. If not set, it indicates the draft environment.
        :param pulumi.Input[builtins.str] name: The unique identifier of the page.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
        :param pulumi.Input[builtins.str] test_result: Whether the test case passed in the agent environment.
               * PASSED: The test passed.
               * FAILED: The test did not pass.
               Possible values are: `PASSED`, `FAILED`.
        :param pulumi.Input[builtins.str] test_time: The time that the test was run. A timestamp in RFC3339 text format.
        """
    ...
    def test_result(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether the test case passed in the agent environment.
        * PASSED: The test passed.
        * FAILED: The test did not pass.
    ...
    @test_result.setter
    def test_result(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "test_result", value)

    @property
    @pulumi.getter(name="testTime")
    def test_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time that the test was run. A timestamp in RFC3339 text format.
        """
    ...
    @test_time.setter
    def test_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CxTestCaseLastTestResultConversationTurnUserInputArgsDict(TypedDict):
        enable_sentiment_analysis: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether sentiment analysis is enabled.
        """
        injected_parameters: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Structure is documented below.
        """
        is_webhook_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CxTestCaseLastTestResultConversationTurnUserInputArgs:
    def __init__(__self__, *,
                 enable_sentiment_analysis: Optional[pulumi.Input[builtins.bool]] = None,
                 injected_parameters: Optional[pulumi.Input[builtins.str]] = None,
                 input: Optional[pulumi.Input['CxTestCaseLastTestResultConversationTurnUserInputInputArgs']] = None,
                 is_webhook_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] enable_sentiment_analysis: Whether sentiment analysis is enabled.
        :param pulumi.Input[builtins.str] injected_parameters: Parameters that need to be injected into the conversation during intent detection.
        :param pulumi.Input['CxTestCaseLastTestResultConversationTurnUserInputInputArgs'] input: User input. Supports text input, event input, dtmf input in the test case.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] is_webhook_enabled: If webhooks should be allowed to trigger in response to the user utterance. Often if parameters are injected, webhooks should not be enabled.
        """
    ...
    def enable_sentiment_analysis(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether sentiment analysis is enabled.
        """
    ...
    def enable_sentiment_analysis(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_sentiment_analysis", value)

    @property
    @pulumi.getter(name="injectedParameters")
    def injected_parameters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Parameters that need to be injected into the conversation during intent detection.
        """
    ...
    def injected_parameters(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_webhook_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If webhooks should be allowed to trigger in response to the user utterance. Often if parameters are injected, webhooks should not be enabled.
        """
    ...
    def is_webhook_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class CxTestCaseLastTestResultConversationTurnUserInputInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CxTestCaseLastTestResultConversationTurnUserInputInputEventArgs'] event: The event to be triggered.
               Structure is documented below.
        :param pulumi.Input[builtins.str] language_code: The language of the input. See [Language Support](https://cloud.google.com/dialogflow/cx/docs/reference/language) for a list of the currently supported language codes.
               Note that queries in the same session do not necessarily need to specify the same language.
...
if not MYPY:
    class CxTestCaseLastTestResultConversationTurnUserInputInputDtmfArgsDict(TypedDict):
        digits: NotRequired[pulumi.Input[builtins.str]]
        """
        The dtmf digits.
        """
        finish_digit: NotRequired[pulumi.Input[builtins.str]]
...
class CxTestCaseLastTestResultConversationTurnUserInputInputDtmfArgs:
    def __init__(__self__, *,
                 digits: Optional[pulumi.Input[builtins.str]] = None,
                 finish_digit: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] digits: The dtmf digits.
        :param pulumi.Input[builtins.str] finish_digit: The finish digit (if any).
        """
    ...
    @property
    @pulumi.getter
    def digits(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The dtmf digits.
        """
    ...
    @digits.setter
    def digits(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CxTestCaseLastTestResultConversationTurnUserInputInputEventArgs:
    def __init__(__self__, *,
                 event: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] event: Name of the event.
        """
        pulumi.set(__self__, "event", event)
...
class CxTestCaseLastTestResultConversationTurnUserInputInputTextArgs:
    def __init__(__self__, *,
                 text: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] text: The natural language text to be processed. Text length must not exceed 256 characters.
        """
        pulumi.set(__self__, "text", text)
...
if not MYPY:
    class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputArgsDict(TypedDict):
        ...
        Structure is documented below.
        """
        session_parameters: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputArgs:
    def __init__(__self__, *,
                 ...
                 session_parameters: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifferenceArgs']]] differences: The list of differences between the original run and the replay for this output, if any.
               Structure is documented below.
        :param pulumi.Input[builtins.str] session_parameters: The session parameters available to the bot at this point.
    ...
    def session_parameters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The session parameters available to the bot at this point.
        """
    ...
    def session_parameters(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifferenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] description: A human readable description of the diff, showing the actual output vs expected output.
        :param pulumi.Input[builtins.str] type: The type of diff.
               * INTENT: The intent.
               * PAGE: The page.
               * PARAMETERS: The parameters.
               * UTTERANCE: The message utterance.
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputStatusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] details: A JSON encoded list of messages that carry the error details.
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponseArgs:
    def __init__(__self__, *,
                 texts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] texts: A collection of text responses.
        """
        if texts is not None:
            pulumi.set(__self__, "texts", texts)
...
if not MYPY:
    class CxTestCaseTestConfigArgsDict(TypedDict):
        flow: NotRequired[pulumi.Input[builtins.str]]
        """
        Flow name to start the test case with.
        Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
        Only one of flow and page should be set to indicate the starting point of the test case. If neither is set, the test case will start with start page on the default start flow.
        """
        page: NotRequired[pulumi.Input[builtins.str]]
        """
        The page to start the test case with.
        Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
        Only one of flow and page should be set to indicate the starting point of the test case. If neither is set, the test case will start with start page on the default start flow.
        """
        tracking_parameters: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CxTestCaseTestConfigArgs:
    def __init__(__self__, *,
                 ...
                 page: Optional[pulumi.Input[builtins.str]] = None,
                 tracking_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] flow: Flow name to start the test case with.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
               Only one of flow and page should be set to indicate the starting point of the test case. If neither is set, the test case will start with start page on the default start flow.
        :param pulumi.Input[builtins.str] page: The page to start the test case with.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
               Only one of flow and page should be set to indicate the starting point of the test case. If neither is set, the test case will start with start page on the default start flow.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tracking_parameters: Session parameters to be compared when calculating differences.
        """
        if flow is not None:
    ...
    @property
    @pulumi.getter
    def page(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The page to start the test case with.
        Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
        Only one of flow and page should be set to indicate the starting point of the test case. If neither is set, the test case will start with start page on the default start flow.
    ...
    @page.setter
    def page(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "page", value)

    @property
    @pulumi.getter(name="trackingParameters")
    def tracking_parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Session parameters to be compared when calculating differences.
        """
...
class CxVersionNluSettingArgs:
    def __init__(__self__, *,
                 ...
                 model_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.float] classification_threshold: To filter out false positive results and still get variety in matched natural language inputs for your agent, you can tune the machine learning classification threshold. If the returned score value is less than the threshold value, then a no-match event will be triggered.
               The score values range from 0.0 (completely uncertain) to 1.0 (completely certain). If set to 0.0, the default of 0.3 is used.
        :param pulumi.Input[builtins.str] model_training_mode: Indicates NLU model training mode.
               * MODEL_TRAINING_MODE_AUTOMATIC: NLU model training is automatically triggered when a flow gets modified. User can also manually trigger model training in this mode.
               * MODEL_TRAINING_MODE_MANUAL: User needs to manually trigger NLU model training. Best for large flows whose models take long time to train.
...
if not MYPY:
    class CxWebhookGenericWebServiceArgsDict(TypedDict):
        ...
        Whether to use speech adaptation for speech recognition.
        """
        allowed_ca_certs: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CxWebhookGenericWebServiceArgs:
    def __init__(__self__, *,
                 uri: pulumi.Input[builtins.str],
                 allowed_ca_certs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 request_headers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] uri: Whether to use speech adaptation for speech recognition.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_ca_certs: Specifies a list of allowed custom CA certificates (in DER format) for HTTPS verification.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] request_headers: The HTTP request headers to send together with webhook requests.
        """
        pulumi.set(__self__, "uri", uri)
    ...
    def allowed_ca_certs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of allowed custom CA certificates (in DER format) for HTTPS verification.
        """
    ...
    def allowed_ca_certs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CxWebhookServiceDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CxWebhookServiceDirectoryGenericWebServiceArgs'] generic_web_service: The name of Service Directory service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] service: The name of Service Directory service.
        """
...
class EntityTypeEntityArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] synonyms: A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym
               could be green onions.
               For KIND_LIST entity types:
               * This collection must contain exactly one synonym equal to value.
        :param pulumi.Input[builtins.str] value: The primary value associated with this entity entry. For example, if the entity type is vegetable, the value
               could be scallions.
               For KIND_MAP entity types:
               * A reference value to be used in place of synonyms.
               For KIND_LIST entity types:
    ...
    @property
    @pulumi.getter
    def synonyms(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym
        could be green onions.
        For KIND_LIST entity types:
    ...
    @synonyms.setter
    def synonyms(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "synonyms", value)
...
class FulfillmentFeatureArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: The type of the feature that enabled for fulfillment.
               * SMALLTALK: Fulfillment is enabled for SmallTalk.
               Possible values are: `SMALLTALK`.
        """
        pulumi.set(__self__, "type", type)
...
class FulfillmentGenericWebServiceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] uri: The fulfillment URI for receiving POST requests. It must use https protocol.
        :param pulumi.Input[builtins.str] password: The password for HTTP Basic authentication.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] request_headers: The HTTP request headers to send together with fulfillment requests.
        :param pulumi.Input[builtins.str] username: The user name for HTTP Basic authentication.
        """
        pulumi.set(__self__, "uri", uri)
...
if not MYPY:
    class IntentFollowupIntentInfoArgsDict(TypedDict):
        followup_intent_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The unique identifier of the followup intent.
        Format: projects/<Project ID>/agent/intents/<Intent ID>.
        """
        parent_followup_intent_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IntentFollowupIntentInfoArgs:
    def __init__(__self__, *,
                 followup_intent_name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_followup_intent_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] followup_intent_name: The unique identifier of the followup intent.
               Format: projects/<Project ID>/agent/intents/<Intent ID>.
        :param pulumi.Input[builtins.str] parent_followup_intent_name: The unique identifier of the parent intent in the chain of followup intents.
               Format: projects/<Project ID>/agent/intents/<Intent ID>.
        """
    ...
    def followup_intent_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier of the followup intent.
        Format: projects/<Project ID>/agent/intents/<Intent ID>.
        """
    ...
    def followup_intent_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "followup_intent_name", value)

    @property
    @pulumi.getter(name="parentFollowupIntentName")
    def parent_followup_intent_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier of the parent intent in the chain of followup intents.
        Format: projects/<Project ID>/agent/intents/<Intent ID>.
        """
    ...
    def parent_followup_intent_name(self, value: Optional[pulumi.Input[builtins.str]]):
