...
class CxAgentAdvancedSettingsAudioExportGcsDestination(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str uri: The Google Cloud Storage URI for the exported objects. Whether a full object name, or just a prefix, its usage depends on the Dialogflow operation.
...
class CxAgentAdvancedSettingsDtmfSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 finish_digit: Optional[builtins.str] = None,
                 max_digits: Optional[builtins.int] = None):
        """
        :param builtins.bool enabled: If true, incoming audio is processed for DTMF (dual tone multi frequency) events. For example, if the caller presses a button on their telephone keypad and DTMF processing is enabled, Dialogflow will detect the event (e.g. a "3" was pressed) in the incoming audio and pass the event to the bot to drive business logic (e.g. when 3 is pressed, return the account balance).
        :param builtins.str finish_digit: The digit that terminates a DTMF digit sequence.
        :param builtins.int max_digits: Max length of DTMF digits.
        """
    ...
    def finish_digit(self) -> Optional[builtins.str]:
        """
    ...
    def max_digits(self) -> Optional[builtins.int]:
        """
...
class CxAgentAdvancedSettingsLoggingSettings(dict):
    ...
    def __init__(__self__, *,
                 enable_consent_based_redaction: Optional[builtins.bool] = None,
                 enable_interaction_logging: Optional[builtins.bool] = None,
                 enable_stackdriver_logging: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_consent_based_redaction: Enables consent-based end-user input redaction, if true, a pre-defined session parameter **$session.params.conversation-redaction** will be used to determine if the utterance should be redacted.
        :param builtins.bool enable_interaction_logging: Enables DF Interaction logging.
        :param builtins.bool enable_stackdriver_logging: Enables Google Cloud Logging.
        """
    ...
    def enable_consent_based_redaction(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_interaction_logging(self) -> Optional[builtins.bool]:
        """
...
class CxAgentAdvancedSettingsSpeechSettings(dict):
    ...
    def __init__(__self__, *,
                 endpointer_sensitivity: Optional[builtins.int] = None,
                 models: Optional[Mapping[str, builtins.str]] = None,
                 no_speech_timeout: Optional[builtins.str] = None,
                 use_timeout_based_endpointing: Optional[builtins.bool] = None):
        """
        :param builtins.int endpointer_sensitivity: Sensitivity of the speech model that detects the end of speech. Scale from 0 to 100.
        :param Mapping[str, builtins.str] models: Mapping from language to Speech-to-Text model. The mapped Speech-to-Text model will be selected for requests from its corresponding language. For more information, see [Speech models](https://cloud.google.com/dialogflow/cx/docs/concept/speech-models).
               An object containing a list of **"key": value** pairs. Example: **{ "name": "wrench", "mass": "1.3kg", "count": "3" }**.
        :param builtins.str no_speech_timeout: Timeout before detecting no speech.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.5s".
        :param builtins.bool use_timeout_based_endpointing: Use timeout based endpointing, interpreting endpointer sensitivity as seconds of timeout value.
        """
    ...
    def endpointer_sensitivity(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def models(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def no_speech_timeout(self) -> Optional[builtins.str]:
        """
    ...
    def use_timeout_based_endpointing(self) -> Optional[builtins.bool]:
        """
...
class CxAgentGitIntegrationSettingsGithubSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 repository_uri: Optional[builtins.str] = None,
                 tracking_branch: Optional[builtins.str] = None):
        """
        :param builtins.str access_token: The access token used to authenticate the access to the GitHub repository.
               **Note**: This property is sensitive and will not be displayed in the plan.
        :param Sequence[builtins.str] branches: A list of branches configured to be used from Dialogflow.
        :param builtins.str display_name: The unique repository display name for the GitHub repository.
        :param builtins.str repository_uri: The GitHub repository URI related to the agent.
        :param builtins.str tracking_branch: The branch of the GitHub repository tracked for this agent.
        """
    ...
    def repository_uri(self) -> Optional[builtins.str]:
        """
    ...
    def tracking_branch(self) -> Optional[builtins.str]:
        """
...
class CxAgentSpeechToTextSettings(dict):
    ...
    def __init__(__self__, *,
                 enable_speech_adaptation: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_speech_adaptation: Whether to use speech adaptation for speech recognition.
        """
    ...
    def enable_speech_adaptation(self) -> Optional[builtins.bool]:
        """
...
class CxAgentTextToSpeechSettings(dict):
    ...
    def __init__(__self__, *,
                 synthesize_speech_configs: Optional[builtins.str] = None):
        """
        :param builtins.str synthesize_speech_configs: Configuration of how speech should be synthesized, mapping from [language](https://cloud.google.com/dialogflow/cx/docs/reference/language) to [SynthesizeSpeechConfig](https://cloud.google.com/dialogflow/cx/docs/reference/rest/v3/projects.locations.agents#synthesizespeechconfig).
    ...
    def synthesize_speech_configs(self) -> Optional[builtins.str]:
        """
...
class CxEntityTypeEntity(dict):
    def __init__(__self__, *,
                 synonyms: Optional[Sequence[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def synonyms(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CxEntityTypeExcludedPhrase(dict):
    def __init__(__self__, *,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str value: The word or phrase to be excluded.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class CxFlowEventHandler(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_flow: Optional[builtins.str] = None,
                 target_page: Optional[builtins.str] = None,
                 trigger_fulfillment: Optional['outputs.CxFlowEventHandlerTriggerFulfillment'] = None):
        """
        :param builtins.str event: The name of the event to handle.
        :param builtins.str name: (Output)
               The unique identifier of this event handler.
        :param builtins.str target_flow: The target flow to transition to.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
        :param builtins.str target_page: The target page to transition to.
    ...
    def target_flow(self) -> Optional[builtins.str]:
        """
    ...
    def target_page(self) -> Optional[builtins.str]:
        """
...
class CxFlowEventHandlerTriggerFulfillment(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['CxFlowEventHandlerTriggerFulfillmentSetParameterActionArgs'] set_parameter_actions: Set parameter values before executing the webhook.
               Structure is documented below.
        :param builtins.str tag: The tag used by the webhook to identify which fulfillment is being called. This field is required if webhook is specified.
        :param builtins.str webhook: The webhook to call. Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/webhooks/<Webhook ID>.
        """
    ...
    def return_partial_responses(self) -> Optional[builtins.bool]:
        """
...
class CxFlowEventHandlerTriggerFulfillmentConditionalCase(dict):
    def __init__(__self__, *,
                 cases: Optional[builtins.str] = None):
        """
        :param builtins.str cases: A JSON encoded list of cascading if-else conditions. Cases are mutually exclusive. The first one with a matching condition is selected, all the rest ignored.
    ...
    @property
    @pulumi.getter
    def cases(self) -> Optional[builtins.str]:
        """
...
class CxFlowEventHandlerTriggerFulfillmentMessage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str channel: The channel which the response is associated with. Clients can specify the channel via QueryParameters.channel, and only associated channel response will be returned.
        ...
        :param 'CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioTextArgs' output_audio_text: A text or ssml response that is preferentially used for TTS output audio synthesis, as described in the comment on the ResponseMessage message.
               This field is part of a union field `message`: Only one of `text`, `payload`, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
               Structure is documented below.
        :param builtins.str payload: Returns a response containing a custom, platform-specific payload.
               This field is part of a union field `message`: Only one of `text`, `payload`, `conversationSuccess`, `outputAudioText`, `liveAgentHandoff`, `endInteraction`, `playAudio`, `mixedAudio`, `telephonyTransferCall`, or `knowledgeInfoCard` may be set.
...
class CxFlowEventHandlerTriggerFulfillmentMessageConversationSuccess(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metadata: Custom metadata. Dialogflow doesn't impose any structure on this.
        """
...
class CxFlowEventHandlerTriggerFulfillmentMessageOutputAudioText(dict):
    ...
    def __init__(__self__, *,
                 allow_playback_interruption: Optional[builtins.bool] = None,
                 ssml: Optional[builtins.str] = None,
                 text: Optional[builtins.str] = None):
        """
        :param builtins.bool allow_playback_interruption: (Output)
               Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        :param builtins.str ssml: The SSML text to be synthesized. For more information, see SSML.
               This field is part of a union field `source`: Only one of `text` or `ssml` may be set.
        :param builtins.str text: The raw text to be synthesized.
               This field is part of a union field `source`: Only one of `text` or `ssml` may be set.
        """
    ...
    def allow_playback_interruption(self) -> Optional[builtins.bool]:
        """
        (Output)
        Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        """
    ...
    @property
    @pulumi.getter
    def ssml(self) -> Optional[builtins.str]:
        """
...
class CxFlowEventHandlerTriggerFulfillmentMessagePlayAudio(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_playback_interruption: Optional[builtins.bool] = None):
        """
        :param builtins.str audio_uri: URI of the audio clip. Dialogflow does not impose any validation on this value. It is specific to the client that reads it.
        :param builtins.bool allow_playback_interruption: (Output)
               Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
...
class CxFlowEventHandlerTriggerFulfillmentMessageTelephonyTransferCall(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str phone_number: Transfer the call to a phone number in E.164 format.
        """
...
class CxFlowEventHandlerTriggerFulfillmentMessageText(dict):
    ...
    def __init__(__self__, *,
                 allow_playback_interruption: Optional[builtins.bool] = None,
                 texts: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool allow_playback_interruption: (Output)
               Whether the playback of this message can be interrupted by the end user's speech and the client can then starts the next Dialogflow request.
        :param Sequence[builtins.str] texts: A collection of text response variants. If multiple variants are defined, only one text response variant is returned at runtime.
               required: true
        """
        if allow_playback_interruption is not None:
            pulumi.set(__self__, "allow_playback_interruption", allow_playback_interruption)
    ...
    @property
    @pulumi.getter
    def texts(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CxFlowEventHandlerTriggerFulfillmentSetParameterAction(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str parameter: Display name of the parameter.
        :param builtins.str value: The new JSON-encoded value of the parameter. A null value clears the parameter.
        """
...
class CxFlowKnowledgeConnectorSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence['CxFlowKnowledgeConnectorSettingsDataStoreConnectionArgs'] data_store_connections: Optional. List of related data store connections.
               Structure is documented below.
        :param builtins.bool enabled: Whether Knowledge Connector is enabled or not.
        :param builtins.str target_flow: The target flow to transition to. Format: projects/<ProjectID>/locations/<LocationID>/agents/<AgentID>/flows/<FlowID>.
               This field is part of a union field `target`: Only one of `targetPage` or `targetFlow` may be set.
        :param builtins.str target_page: The target page to transition to. Format: projects/<ProjectID>/locations/<LocationID>/agents/<AgentID>/flows/<FlowID>/pages/<PageID>.
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentAdvancedSettingsDtmfSettings(dict):
    ...
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None,
                 endpointing_timeout_duration: Optional[builtins.str] = None,
                 finish_digit: Optional[builtins.str] = None,
                 interdigit_timeout_duration: Optional[builtins.str] = None,
                 max_digits: Optional[builtins.int] = None):
        """
        :param builtins.bool enabled: If true, incoming audio is processed for DTMF (dual tone multi frequtectency) events. For example, if the caller presses a button on their telephone keypad and DTMF processing is enabled, Dialogflow will de the event (e.g. a "3" was pressed) in the incoming audio and pass the event to the bot to drive business logic (e.g. when 3 is pressed, return the account balance).
        :param builtins.str endpointing_timeout_duration: Endpoint timeout setting for matching dtmf input to regex.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.500s".
        :param builtins.str finish_digit: The digit that terminates a DTMF digit sequence.
        :param builtins.str interdigit_timeout_duration: Interdigit timeout setting for matching dtmf input to regex.
               A duration in seconds with up to nine fractional digits, ending with 's'. Example: "3.500s".
        :param builtins.int max_digits: Max length of DTMF digits.
        """
        if enabled is not None:
    ...
    def endpointing_timeout_duration(self) -> Optional[builtins.str]:
        """
    ...
    def interdigit_timeout_duration(self) -> Optional[builtins.str]:
        """
...
class CxFlowKnowledgeConnectorSettingsTriggerFulfillmentMessageMixedAudioSegment(dict):
    ...
    def __init__(__self__, *,
                 allow_playback_interruption: Optional[builtins.bool] = None,
                 audio: Optional[builtins.str] = None,
                 uri: Optional[builtins.str] = None):
        """
        :param builtins.bool allow_playback_interruption: (Output)
               Whether the playback of this segment can be interrupted by the end user's speech and the client should then start the next Dialogflow request.
        :param builtins.str audio: Raw audio synthesized from the Dialogflow agent's response using the output config specified in the request.
               A base64-encoded string.
               This field is part of a union field `content`: Only one of `audio` or `uri` may be set.
        :param builtins.str uri: Client-specific URI that points to an audio clip accessible to the client. Dialogflow does not impose any validation on it.
               This field is part of a union field `content`: Only one of `audio` or `uri` may be set.
        """
        if allow_playback_interruption is not None:
            pulumi.set(__self__, "allow_playback_interruption", allow_playback_interruption)
    ...
    @property
    @pulumi.getter
    def audio(self) -> Optional[builtins.str]:
        """
...
class CxFlowNluSettings(dict):
    ...
    def __init__(__self__, *,
                 classification_threshold: Optional[builtins.float] = None,
                 model_training_mode: Optional[builtins.str] = None,
                 model_type: Optional[builtins.str] = None):
        """
        :param builtins.float classification_threshold: To filter out false positive results and still get variety in matched natural language inputs for your agent, you can tune the machine learning classification threshold.
               If the returned score value is less than the threshold value, then a no-match event will be triggered. The score values range from 0.0 (completely uncertain) to 1.0 (completely certain). If set to 0.0, the default of 0.3 is used.
        :param builtins.str model_training_mode: Indicates NLU model training mode.
        ...
        :param builtins.str model_type: Indicates the type of NLU model.
    ...
    def classification_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def model_training_mode(self) -> Optional[builtins.str]:
        """
...
class CxFlowTransitionRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition: The condition to evaluate against form parameters or session parameters.
               At least one of intent or condition must be specified. When both intent and condition are specified, the transition can only happen when both are fulfilled.
        :param builtins.str intent: The unique identifier of an Intent.
...
class CxIntentParameter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 is_list: Optional[builtins.bool] = None,
                 redact: Optional[builtins.bool] = None):
        """
        :param builtins.str entity_type: The entity type of the parameter.
               Format: projects/-/locations/-/agents/-/entityTypes/<System Entity Type ID> for system entity types (for example, projects/-/locations/-/agents/-/entityTypes/sys.date), or projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/entityTypes/<Entity Type ID> for developer entity types.
        :param builtins.str id: The unique identifier of the parameter. This field is used by training phrases to annotate their parts.
        :param builtins.bool is_list: Indicates whether the parameter represents a list of values.
        :param builtins.bool redact: Indicates whether the parameter content should be redacted in log. If redaction is enabled, the parameter content will be replaced by parameter name during logging.
    ...
    def is_list(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def redact(self) -> Optional[builtins.bool]:
        """
...
class CxIntentTrainingPhrase(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int repeat_count: Indicates how many times this example was added to the intent.
        """
...
class CxIntentTrainingPhrasePart(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str text: The text for this part.
        :param builtins.str parameter_id: The parameter used to annotate this part of the training phrase. This field is required for annotated parts of the training phrase.
        """
        pulumi.set(__self__, "text", text)
    ...
    def parameter_id(self) -> Optional[builtins.str]:
        """
...
class CxPageFormParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CxPageFormParameterAdvancedSettingsArgs' advanced_settings: Hierarchical advanced settings for this parameter. The settings exposed at the lower level overrides the settings exposed at the higher level.
               Hierarchy: Agent->Flow->Page->Fulfillment/Parameter.
               Structure is documented below.
        :param builtins.str default_value: The default value of an optional parameter. If the parameter is required, the default value will be ignored.
        :param builtins.str display_name: The human-readable name of the parameter, unique within the form.
        :param builtins.str entity_type: The entity type of the parameter.
               Format: projects/-/locations/-/agents/-/entityTypes/<System Entity Type ID> for system entity types (for example, projects/-/locations/-/agents/-/entityTypes/sys.date), or projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/entityTypes/<Entity Type ID> for developer entity types.
        :param 'CxPageFormParameterFillBehaviorArgs' fill_behavior: Defines fill behavior for the parameter.
               Structure is documented below.
        :param builtins.bool is_list: Indicates whether the parameter represents a list of values.
        :param builtins.bool redact: Indicates whether the parameter content should be redacted in log.
               If redaction is enabled, the parameter content will be replaced by parameter name during logging. Note: the parameter content is subject to redaction if either parameter level redaction or entity type level redaction is enabled.
        :param builtins.bool required: Indicates whether the parameter is required. Optional parameters will not trigger prompts; however, they are filled if the user specifies them.
...
class CxSecuritySettingsAudioExportSettings(dict):
    ...
    def __init__(__self__, *,
                 audio_export_pattern: Optional[builtins.str] = None,
                 audio_format: Optional[builtins.str] = None,
                 enable_audio_redaction: Optional[builtins.bool] = None,
                 gcs_bucket: Optional[builtins.str] = None):
        """
        :param builtins.str audio_export_pattern: Filename pattern for exported audio.
        :param builtins.str audio_format: File format for exported audio file. Currently only in telephony recordings.
               * MULAW: G.711 mu-law PCM with 8kHz sample rate.
               * MP3: MP3 file format.
               * OGG: OGG Vorbis.
               Possible values are: `MULAW`, `MP3`, `OGG`.
        :param builtins.bool enable_audio_redaction: Enable audio redaction if it is true.
        :param builtins.str gcs_bucket: Cloud Storage bucket to export audio record to. Setting this field would grant the Storage Object Creator role to the Dialogflow Service Agent. API caller that tries to modify this field should have the permission of storage.buckets.setIamPolicy.
        """
    ...
    def audio_export_pattern(self) -> Optional[builtins.str]:
        """
    ...
    def audio_format(self) -> Optional[builtins.str]:
        """
    ...
    def enable_audio_redaction(self) -> Optional[builtins.bool]:
        """
...
class CxSecuritySettingsInsightsExportSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_insights_export: If enabled, we will automatically exports conversations to Insights and Insights runs its analyzers.
        """
        pulumi.set(__self__, "enable_insights_export", enable_insights_export)

    @property
    @pulumi.getter(name="enableInsightsExport")
    def enable_insights_export(self) -> builtins.bool:
        """
...
class CxTestCaseLastTestResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None,
                 test_result: Optional[builtins.str] = None,
                 test_time: Optional[builtins.str] = None):
        """
        :param Sequence['CxTestCaseLastTestResultConversationTurnArgs'] conversation_turns: The conversation turns uttered during the test case replay in chronological order.
               Structure is documented below.
        :param builtins.str environment: Environment where the test was run. If not set, it indicates the draft environment.
        :param builtins.str name: The unique identifier of the page.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
        :param builtins.str test_result: Whether the test case passed in the agent environment.
               * PASSED: The test passed.
               * FAILED: The test did not pass.
               Possible values are: `PASSED`, `FAILED`.
        :param builtins.str test_time: The time that the test was run. A timestamp in RFC3339 text format.
        """
    ...
    def test_result(self) -> Optional[builtins.str]:
        """
    ...
    def test_time(self) -> Optional[builtins.str]:
        """
...
class CxTestCaseLastTestResultConversationTurnUserInput(dict):
    ...
    def __init__(__self__, *,
                 enable_sentiment_analysis: Optional[builtins.bool] = None,
                 injected_parameters: Optional[builtins.str] = None,
                 input: Optional['outputs.CxTestCaseLastTestResultConversationTurnUserInputInput'] = None,
                 is_webhook_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enable_sentiment_analysis: Whether sentiment analysis is enabled.
        :param builtins.str injected_parameters: Parameters that need to be injected into the conversation during intent detection.
        :param 'CxTestCaseLastTestResultConversationTurnUserInputInputArgs' input: User input. Supports text input, event input, dtmf input in the test case.
               Structure is documented below.
        :param builtins.bool is_webhook_enabled: If webhooks should be allowed to trigger in response to the user utterance. Often if parameters are injected, webhooks should not be enabled.
        """
    ...
    def enable_sentiment_analysis(self) -> Optional[builtins.bool]:
        """
    ...
    def injected_parameters(self) -> Optional[builtins.str]:
        """
    ...
    def is_webhook_enabled(self) -> Optional[builtins.bool]:
        """
...
class CxTestCaseLastTestResultConversationTurnUserInputInput(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CxTestCaseLastTestResultConversationTurnUserInputInputEventArgs' event: The event to be triggered.
               Structure is documented below.
        :param builtins.str language_code: The language of the input. See [Language Support](https://cloud.google.com/dialogflow/cx/docs/reference/language) for a list of the currently supported language codes.
...
class CxTestCaseLastTestResultConversationTurnUserInputInputDtmf(dict):
    ...
    def __init__(__self__, *,
                 digits: Optional[builtins.str] = None,
                 finish_digit: Optional[builtins.str] = None):
        """
        :param builtins.str digits: The dtmf digits.
        :param builtins.str finish_digit: The finish digit (if any).
        """
    ...
    @property
    @pulumi.getter
    def digits(self) -> Optional[builtins.str]:
        """
        The dtmf digits.
        """
...
class CxTestCaseLastTestResultConversationTurnUserInputInputEvent(dict):
    def __init__(__self__, *,
                 event: builtins.str):
        """
        :param builtins.str event: Name of the event.
        """
        pulumi.set(__self__, "event", event)
...
class CxTestCaseLastTestResultConversationTurnUserInputInputText(dict):
    def __init__(__self__, *,
                 text: builtins.str):
        """
        :param builtins.str text: The natural language text to be processed. Text length must not exceed 256 characters.
        """
        pulumi.set(__self__, "text", text)
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 session_parameters: Optional[builtins.str] = None,
        ...
        :param Sequence['CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifferenceArgs'] differences: The list of differences between the original run and the replay for this output, if any.
               Structure is documented below.
        :param builtins.str session_parameters: The session parameters available to the bot at this point.
    ...
    def session_parameters(self) -> Optional[builtins.str]:
        """
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputDifference(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: A human readable description of the diff, showing the actual output vs expected output.
        :param builtins.str type: The type of diff.
               * INTENT: The intent.
               * PAGE: The page.
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputStatus(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str details: A JSON encoded list of messages that carry the error details.
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTextResponse(dict):
    def __init__(__self__, *,
                 texts: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] texts: A collection of text responses.
        """
        if texts is not None:
            pulumi.set(__self__, "texts", texts)
...
class CxTestCaseLastTestResultConversationTurnVirtualAgentOutputTriggeredIntent(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The unique identifier of the intent.
...
class CxTestCaseTestConfig(dict):
    ...
    def __init__(__self__, *,
                 flow: Optional[builtins.str] = None,
                 page: Optional[builtins.str] = None,
                 tracking_parameters: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str flow: Flow name to start the test case with.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
               Only one of flow and page should be set to indicate the starting point of the test case. If neither is set, the test case will start with start page on the default start flow.
        :param builtins.str page: The page to start the test case with.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>/pages/<Page ID>.
               Only one of flow and page should be set to indicate the starting point of the test case. If neither is set, the test case will start with start page on the default start flow.
        :param Sequence[builtins.str] tracking_parameters: Session parameters to be compared when calculating differences.
        """
        if flow is not None:
    ...
    @property
    @pulumi.getter
    def flow(self) -> Optional[builtins.str]:
        """
    ...
    def tracking_parameters(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CxVersionNluSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 model_type: Optional[builtins.str] = None):
        """
        :param builtins.float classification_threshold: To filter out false positive results and still get variety in matched natural language inputs for your agent, you can tune the machine learning classification threshold. If the returned score value is less than the threshold value, then a no-match event will be triggered.
...
class CxWebhookGenericWebService(dict):
    ...
    def __init__(__self__, *,
                 uri: builtins.str,
                 allowed_ca_certs: Optional[Sequence[builtins.str]] = None,
                 request_headers: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str uri: Whether to use speech adaptation for speech recognition.
        :param Sequence[builtins.str] allowed_ca_certs: Specifies a list of allowed custom CA certificates (in DER format) for HTTPS verification.
        :param Mapping[str, builtins.str] request_headers: The HTTP request headers to send together with webhook requests.
        """
        pulumi.set(__self__, "uri", uri)
    ...
    def allowed_ca_certs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def request_headers(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class CxWebhookServiceDirectory(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'CxWebhookServiceDirectoryGenericWebServiceArgs' generic_web_service: The name of Service Directory service.
               Structure is documented below.
        :param builtins.str service: The name of Service Directory service.
        """
...
class EntityTypeEntity(dict):
    def __init__(__self__, *,
                 synonyms: Sequence[builtins.str],
                 value: builtins.str):
        """
        :param Sequence[builtins.str] synonyms: A collection of value synonyms. For example, if the entity type is vegetable, and value is scallions, a synonym
               could be green onions.
               For KIND_LIST entity types:
               * This collection must contain exactly one synonym equal to value.
        :param builtins.str value: The primary value associated with this entity entry. For example, if the entity type is vegetable, the value
               could be scallions.
    ...
    @property
    @pulumi.getter
    def synonyms(self) -> Sequence[builtins.str]:
        """
...
class FulfillmentFeature(dict):
    def __init__(__self__, *,
                 type: builtins.str):
        """
        :param builtins.str type: The type of the feature that enabled for fulfillment.
...
class FulfillmentGenericWebService(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str uri: The fulfillment URI for receiving POST requests. It must use https protocol.
        :param builtins.str password: The password for HTTP Basic authentication.
        :param Mapping[str, builtins.str] request_headers: The HTTP request headers to send together with fulfillment requests.
        :param builtins.str username: The user name for HTTP Basic authentication.
        """
        pulumi.set(__self__, "uri", uri)
...
class IntentFollowupIntentInfo(dict):
    ...
    def __init__(__self__, *,
                 followup_intent_name: Optional[builtins.str] = None,
                 parent_followup_intent_name: Optional[builtins.str] = None):
        """
        :param builtins.str followup_intent_name: The unique identifier of the followup intent.
               Format: projects/<Project ID>/agent/intents/<Intent ID>.
        :param builtins.str parent_followup_intent_name: The unique identifier of the parent intent in the chain of followup intents.
               Format: projects/<Project ID>/agent/intents/<Intent ID>.
        """
    ...
    def followup_intent_name(self) -> Optional[builtins.str]:
        """
    ...
    def parent_followup_intent_name(self) -> Optional[builtins.str]:
        """
