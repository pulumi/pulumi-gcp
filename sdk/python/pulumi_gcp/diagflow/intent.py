...
class IntentArgs:
    def __init__(__self__, *,
                 ...
                 default_response_platforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 events: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 input_context_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 is_fallback: Optional[pulumi.Input[builtins.bool]] = None,
                 ml_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 parent_followup_intent_name: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 reset_contexts: Optional[pulumi.Input[builtins.bool]] = None,
                 webhook_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] input_context_names: The list of context names required for this intent to be triggered.
               Format: projects/<Project ID>/agent/sessions/-/contexts/<Context ID>.
        :param pulumi.Input[builtins.bool] is_fallback: Indicates whether this is a fallback intent.
        :param pulumi.Input[builtins.bool] ml_disabled: Indicates whether Machine Learning is disabled for the intent.
        ...
        :param pulumi.Input[builtins.bool] reset_contexts: Indicates whether to delete all contexts in the current session when this intent is matched.
        :param pulumi.Input[builtins.str] webhook_state: Indicates whether webhooks are enabled for the intent.
    ...
    def default_response_platforms(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def default_response_platforms(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def input_context_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def input_context_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def ml_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @ml_disabled.setter
    def ml_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def reset_contexts(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reset_contexts(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "reset_contexts", value)

    @property
    @pulumi.getter(name="webhookState")
    def webhook_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def webhook_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IntentState:
    def __init__(__self__, *,
                 ...
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 reset_contexts: Optional[pulumi.Input[builtins.bool]] = None,
                 root_followup_intent_name: Optional[pulumi.Input[builtins.str]] = None,
                 webhook_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] ml_disabled: Indicates whether Machine Learning is disabled for the intent.
               Note: If mlDisabled setting is set to true, then this intent is not taken into account during inference in ML
               ONLY match mode. Also, auto-markup in the UI is turned off.
        :param pulumi.Input[builtins.str] name: The unique identifier of this intent.
               Format: projects/<Project ID>/agent/intents/<Intent ID>.
        :param pulumi.Input[builtins.str] parent_followup_intent_name: The unique identifier of the parent intent in the chain of followup intents.
               Format: projects/<Project ID>/agent/intents/<Intent ID>.
        :param pulumi.Input[builtins.int] priority: The priority of this intent. Higher numbers represent higher priorities.
        ...
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.bool] reset_contexts: Indicates whether to delete all contexts in the current session when this intent is matched.
        :param pulumi.Input[builtins.str] root_followup_intent_name: The unique identifier of the root intent in the chain of followup intents. It identifies the correct followup
    ...
    def root_followup_intent_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def root_followup_intent_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Intent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reset_contexts: Optional[pulumi.Input[builtins.bool]] = None,
            root_followup_intent_name: Optional[pulumi.Input[builtins.str]] = None,
            webhook_state: Optional[pulumi.Input[builtins.str]] = None) -> 'Intent':
        """
    ...
    @property
    @pulumi.getter(name="defaultResponsePlatforms")
    def default_response_platforms(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of platforms for which the first responses will be copied from the messages in PLATFORM_UNSPECIFIED
        (i.e. default platform).
        Each value may be one of: `FACEBOOK`, `SLACK`, `TELEGRAM`, `KIK`, `SKYPE`, `LINE`, `VIBER`, `ACTIONS_ON_GOOGLE`, `GOOGLE_HANGOUTS`.
    ...
    @property
    @pulumi.getter(name="inputContextNames")
    def input_context_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of context names required for this intent to be triggered.
        Format: projects/<Project ID>/agent/sessions/-/contexts/<Context ID>.
        """
    ...
    @property
    @pulumi.getter(name="isFallback")
    def is_fallback(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether this is a fallback intent.
        """
        return pulumi.get(self, "is_fallback")
    ...
    @property
    @pulumi.getter(name="mlDisabled")
    def ml_disabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether Machine Learning is disabled for the intent.
        Note: If mlDisabled setting is set to true, then this intent is not taken into account during inference in ML
        ONLY match mode. Also, auto-markup in the UI is turned off.
    ...
    @property
    @pulumi.getter(name="parentFollowupIntentName")
    def parent_followup_intent_name(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the parent intent in the chain of followup intents.
        Format: projects/<Project ID>/agent/intents/<Intent ID>.
        """
    ...
    @property
    @pulumi.getter(name="resetContexts")
    def reset_contexts(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether to delete all contexts in the current session when this intent is matched.
        """
        return pulumi.get(self, "reset_contexts")
    ...
    @property
    @pulumi.getter(name="rootFollowupIntentName")
    def root_followup_intent_name(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the root intent in the chain of followup intents. It identifies the correct followup
        intents chain for this intent.
        Format: projects/<Project ID>/agent/intents/<Intent ID>.
    ...
    @property
    @pulumi.getter(name="webhookState")
    def webhook_state(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether webhooks are enabled for the intent.
        * WEBHOOK_STATE_ENABLED: Webhook is enabled in the agent and in the intent.
        * WEBHOOK_STATE_ENABLED_FOR_SLOT_FILLING: Webhook is enabled in the agent and in the intent. Also, each slot
