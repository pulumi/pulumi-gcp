...
class CxWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] parent: The agent to create a webhook for.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>.
        :param pulumi.Input[builtins.str] security_settings: Name of the SecuritySettings reference for the agent. Format: projects/<Project ID>/locations/<Location ID>/securitySettings/<Security Settings ID>.
        :param pulumi.Input['CxWebhookServiceDirectoryArgs'] service_directory: Configuration for a Service Directory service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] timeout: Webhook execution timeout.
        """
    ...
    def enable_spell_correction(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_spell_correction(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def security_settings(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_settings(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CxWebhookState:
    def __init__(__self__, *,
                 ...
                 security_settings: Optional[pulumi.Input[builtins.str]] = None,
                 service_directory: Optional[pulumi.Input['CxWebhookServiceDirectoryArgs']] = None,
                 start_flow: Optional[pulumi.Input[builtins.str]] = None,
                 timeout: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input['CxWebhookGenericWebServiceArgs'] generic_web_service: Configuration for a generic web service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: The unique identifier of the webhook.
        ...
        :param pulumi.Input['CxWebhookServiceDirectoryArgs'] service_directory: Configuration for a Service Directory service.
               Structure is documented below.
        :param pulumi.Input[builtins.str] start_flow: Name of the start flow in this agent. A start flow will be automatically created when the agent is created, and can only be deleted by deleting the agent. Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
        :param pulumi.Input[builtins.str] timeout: Webhook execution timeout.
        """
        if disabled is not None:
            pulumi.set(__self__, "disabled", disabled)
    ...
    def start_flow(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @start_flow.setter
    def start_flow(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CxWebhook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_directory: Optional[pulumi.Input[Union['CxWebhookServiceDirectoryArgs', 'CxWebhookServiceDirectoryArgsDict']]] = None,
            start_flow: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.str]] = None) -> 'CxWebhook':
        """
    ...
    @property
    @pulumi.getter(name="enableSpellCorrection")
    def enable_spell_correction(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if automatic spell correction is enabled in detect intent requests.
        """
        return pulumi.get(self, "enable_spell_correction")
    ...
    @property
    @pulumi.getter(name="securitySettings")
    def security_settings(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the SecuritySettings reference for the agent. Format: projects/<Project ID>/locations/<Location ID>/securitySettings/<Security Settings ID>.
        """
        return pulumi.get(self, "security_settings")
    ...
    @property
    @pulumi.getter(name="startFlow")
    def start_flow(self) -> pulumi.Output[builtins.str]:
        """
        Name of the start flow in this agent. A start flow will be automatically created when the agent is created, and can only be deleted by deleting the agent. Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
        """
        return pulumi.get(self, "start_flow")
