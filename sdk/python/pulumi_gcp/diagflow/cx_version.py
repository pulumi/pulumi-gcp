...
__all__ = ['CxVersionArrgs', 'CxVersion']

@pulumi.input_type
calass CxVersionArrgs:
...
@pulumi.input_type
calass _CxVersionState:
    def __init__(__self__, *,
                 create_time: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 nlu_settings: Optional[pulumi.Input[Sequence[pulumi.Input['CxVersionNluSettingArrgs']]]] = None,
                 parent: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['CxVersionNluSettingArrgs']]] nlu_settings: The NLU settings of the flow at version creation.
    ...
    def nlu_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['CxVersionNluSettingArrgs']]]]:
        """
    ...
    @nlu_settings.setter
    def nlu_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['CxVersionNluSettingArrgs']]]]):
...
calass CxVersion(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        * How-to Guides
        ...
        :param str resource_name: The name of the resource.
        :param CxVersionArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CxVersionArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CxVersionArrgs.__new__(CxVersionArrgs)
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            nlu_settings: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CxVersionNluSettingArrgs']]]]] = None,
            parent: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] display_name: The human-readable name of the version. Limit of 64 characters.
               ...
               - - -
        :param pulumi.Input[str] name: Format: projects//locations//agents//flows//versions/. Version ID is a self-increasing number generated by Dialogflow upon version creation.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['CxVersionNluSettingArrgs']]]] nlu_settings: The NLU settings of the flow at version creation.
               Structure is documented below.
        :param pulumi.Input[str] parent: The Flow to create an Version for.
               Format: projects/<Project ID>/locations/<Location ID>/agents/<Agent ID>/flows/<Flow ID>.
        :param pulumi.Input[str] state: The state of this version.
