...
class CxAgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_language_code: The default language of the agent as a language tag. [See Language Support](https://cloud.google.com/dialogflow/cx/docs/reference/language)
               for a list of the currently supported language codes. This field cannot be updated after creation.
        :param pulumi.Input[builtins.str] display_name: The human-readable name of the agent, unique within the location.
        ...
        :param pulumi.Input[builtins.str] avatar_uri: The URI of the agent's avatar. Avatars are used throughout the Dialogflow console and in the self-hosted Web Demo integration.
        ...
        :param pulumi.Input[builtins.bool] enable_stackdriver_logging: (Optional, Deprecated)
        ...
        :param pulumi.Input['CxAgentSpeechToTextSettingsArgs'] speech_to_text_settings: Settings related to speech recognition.
               Structure is documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] supported_language_codes: The list of all languages supported by this agent (except for the default_language_code).
...
class _CxAgentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location: The name of the location this agent is located in.
               ...
               This is a one time step but at the moment you can only [configure location settings](https://cloud.google.com/dialogflow/cx/docs/concept/region#location-settings) via the Dialogflow CX console.
               Another options is to use global location so you don't need to manually configure location settings.
        :param pulumi.Input[builtins.str] name: The unique identifier of the agent.
        :param pulumi.Input[builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the provider project is used.
        :param pulumi.Input[builtins.str] security_settings: Name of the SecuritySettings reference for the agent. Format: projects/<Project ID>/locations/<Location ID>/securitySettings/<Security Settings ID>.
        :param pulumi.Input['CxAgentSpeechToTextSettingsArgs'] speech_to_text_settings: Settings related to speech recognition.
...
class CxAgent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            supported_language_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            text_to_speech_settings: Optional[pulumi.Input[Union['CxAgentTextToSpeechSettingsArgs', 'CxAgentTextToSpeechSettingsArgsDict']]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'CxAgent':
        """
