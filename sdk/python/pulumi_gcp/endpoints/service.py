...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 grpc_config: pulumi.Input[Optional[_builtins.str]] = None,
                 openapi_config: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 protoc_output_base64: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a Service resource.

        :param pulumi.Input[_builtins.str] service_name: The name of the service.  Usually of the form `$apiname.endpoints.$projectid.cloud.goog`.
        ...
        :param pulumi.Input[_builtins.str] grpc_config: The full text of the Service Config YAML file (Example located [here](https://github.com/GoogleCloudPlatform/python-docs-samples/blob/main/endpoints/bookstore-grpc/api_config.yaml)).
               If provided, must also provide `protoc_output_base64`.  `open_api` config must *not* be provided.
        :param pulumi.Input[_builtins.str] openapi_config: The full text of the OpenAPI YAML configuration as described [here](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0.md).
               Either this, or *both* of `grpc_config` and `protoc_output_base64` must be specified.
        :param pulumi.Input[_builtins.str] project: The project ID that the service belongs to.  If not provided, provider project is used.
        :param pulumi.Input[_builtins.str] protoc_output_base64: The full contents of the Service Descriptor File generated by protoc.  This should be a compiled .pb file, base64-encoded.
        """
    ...
    def grpc_config(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @grpc_config.setter
    def grpc_config(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "grpc_config", value)

    @_builtins.property
    @pulumi.getter(name="openapiConfig")
    def openapi_config(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def openapi_config(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def protoc_output_base64(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def protoc_output_base64(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _ServiceState:
    def __init__(__self__, *,
                 apis: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceApiArgs']]]] = None,
                 config_id: pulumi.Input[Optional[_builtins.str]] = None,
                 deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 dns_address: pulumi.Input[Optional[_builtins.str]] = None,
                 endpoints: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceEndpointArgs']]]] = None,
                 grpc_config: pulumi.Input[Optional[_builtins.str]] = None,
                 openapi_config: pulumi.Input[Optional[_builtins.str]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 protoc_output_base64: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] config_id: The autogenerated ID for the configuration that is rolled out as part of the creation of this resource.  Must be provided to compute engine instances as a tag.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the instance. Defaults to "DELETE".
               When a 'terraform destroy' or 'terraform apply' would delete the instance,
               the command will fail if this field is set to "PREVENT" in Terraform state.
               When set to "ABANDON", the command will remove the resource from Terraform
               management without updating or deleting the resource in the API.
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] dns_address: The address at which the service can be found - usually the same as the service name.
    ...
    @_builtins.property
    @pulumi.getter
    def apis(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceApiArgs']]]]:
        """
    ...
    @apis.setter
    def apis(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceApiArgs']]]]):
    ...
    def dns_address(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @dns_address.setter
    def dns_address(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "dns_address", value)

    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceEndpointArgs']]]]:
        """
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceEndpointArgs']]]]):
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            apis: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceApiArgs', 'ServiceApiArgsDict', 'outputs.ServiceApi']]]]] = None,
            config_id: pulumi.Input[Optional[_builtins.str]] = None,
            deletion_policy: pulumi.Input[Optional[_builtins.str]] = None,
            dns_address: pulumi.Input[Optional[_builtins.str]] = None,
            endpoints: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ServiceEndpointArgs', 'ServiceEndpointArgsDict', 'outputs.ServiceEndpoint']]]]] = None,
            grpc_config: pulumi.Input[Optional[_builtins.str]] = None,
            openapi_config: pulumi.Input[Optional[_builtins.str]] = None,
            project: pulumi.Input[Optional[_builtins.str]] = None,
            protoc_output_base64: pulumi.Input[Optional[_builtins.str]] = None,
            service_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'Service':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceApiArgs', 'ServiceApiArgsDict', 'outputs.ServiceApi']]]] apis: A list of API objects; structure is documented below.
        :param pulumi.Input[_builtins.str] config_id: The autogenerated ID for the configuration that is rolled out as part of the creation of this resource.  Must be provided to compute engine instances as a tag.
        :param pulumi.Input[_builtins.str] deletion_policy: Whether Terraform will be prevented from destroying the instance. Defaults to "DELETE".
               When a 'terraform destroy' or 'terraform apply' would delete the instance,
               the command will fail if this field is set to "PREVENT" in Terraform state.
               ...
               When set to "DELETE", deleting the resource is allowed.
        :param pulumi.Input[_builtins.str] dns_address: The address at which the service can be found - usually the same as the service name.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ServiceEndpointArgs', 'ServiceEndpointArgsDict', 'outputs.ServiceEndpoint']]]] endpoints: A list of Endpoint objects; structure is documented below.
        :param pulumi.Input[_builtins.str] grpc_config: The full text of the Service Config YAML file (Example located [here](https://github.com/GoogleCloudPlatform/python-docs-samples/blob/main/endpoints/bookstore-grpc/api_config.yaml)).
               If provided, must also provide `protoc_output_base64`.  `open_api` config must *not* be provided.
        :param pulumi.Input[_builtins.str] openapi_config: The full text of the OpenAPI YAML configuration as described [here](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0.md).
               Either this, or *both* of `grpc_config` and `protoc_output_base64` must be specified.
