...
class ServiceArgs:
    ...
    def _configure(
        ...
        if openapi_config is not None:
            _setter("openapi_config", openapi_config)
        if project is not None:
            _setter("project", project)
        if protoc_output_base64 is not None:
            _setter("protoc_output_base64", protoc_output_base64)
...
class _ServiceState:
    ...
    def _configure(
        ...
        if dns_address is not None:
            _setter("dns_address", dns_address)
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServiceApiArgs']]]] apis: A list of API objects; structure is documented below.
        :param pulumi.Input[str] config_id: The autogenerated ID for the configuration that is rolled out as part of the creation of this resource.  Must be provided to compute engine instances as a tag.
        :param pulumi.Input[str] dns_address: The address at which the service can be found - usually the same as the service name.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ServiceEndpointArgs']]]] endpoints: A list of Endpoint objects; structure is documented below.
        :param pulumi.Input[str] grpc_config: The full text of the Service Config YAML file (Example located [here](https://github.com/GoogleCloudPlatform/python-docs-samples/blob/main/endpoints/bookstore-grpc/api_config.yaml)).
               If provided, must also provide `protoc_output_base64`.  `open_api` config must *not* be provided.
        :param pulumi.Input[str] openapi_config: The full text of the OpenAPI YAML configuration as described [here](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0.md).
               Either this, or *both* of `grpc_config` and `protoc_output_base64` must be specified.
