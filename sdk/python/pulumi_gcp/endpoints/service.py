...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 grpc_config: Optional[pulumi.Input[builtins.str]] = None,
                 openapi_config: Optional[pulumi.Input[builtins.str]] = None,
                 project: Optional[pulumi.Input[builtins.str]] = None,
                 protoc_output_base64: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Service resource.
        :param pulumi.Input[builtins.str] service_name: The name of the service.  Usually of the form `$apiname.endpoints.$projectid.cloud.goog`.
               
               - - -
        :param pulumi.Input[builtins.str] grpc_config: The full text of the Service Config YAML file (Example located [here](https://github.com/GoogleCloudPlatform/python-docs-samples/blob/main/endpoints/bookstore-grpc/api_config.yaml)).
               If provided, must also provide `protoc_output_base64`.  `open_api` config must *not* be provided.
        :param pulumi.Input[builtins.str] openapi_config: The full text of the OpenAPI YAML configuration as described [here](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0.md).
               Either this, or *both* of `grpc_config` and `protoc_output_base64` must be specified.
        :param pulumi.Input[builtins.str] project: The project ID that the service belongs to.  If not provided, provider project is used.
        :param pulumi.Input[builtins.str] protoc_output_base64: The full contents of the Service Descriptor File generated by protoc.  This should be a compiled .pb file, base64-encoded.
        """
    ...
    def grpc_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @grpc_config.setter
    def grpc_config(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grpc_config", value)

    @property
    @pulumi.getter(name="openapiConfig")
    def openapi_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def openapi_config(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def protoc_output_base64(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def protoc_output_base64(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServiceState:
    def __init__(__self__, *,
                 ...
                 dns_address: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] config_id: The autogenerated ID for the configuration that is rolled out as part of the creation of this resource.  Must be provided to compute engine instances as a tag.
        :param pulumi.Input[builtins.str] dns_address: The address at which the service can be found - usually the same as the service name.
    ...
    def dns_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dns_address.setter
    def dns_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Service(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:endpoints/service:Service"
    ...
    def get(resource_name: str,
            ...
            project: Optional[pulumi.Input[builtins.str]] = None,
            protoc_output_base64: Optional[pulumi.Input[builtins.str]] = None,
            service_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Service':
        """
    ...
    @property
    @pulumi.getter(name="dnsAddress")
    def dns_address(self) -> pulumi.Output[builtins.str]:
        """
        The address at which the service can be found - usually the same as the service name.
        """
        return pulumi.get(self, "dns_address")
    ...
    @property
    @pulumi.getter(name="grpcConfig")
    def grpc_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The full text of the Service Config YAML file (Example located [here](https://github.com/GoogleCloudPlatform/python-docs-samples/blob/main/endpoints/bookstore-grpc/api_config.yaml)).
        If provided, must also provide `protoc_output_base64`.  `open_api` config must *not* be provided.
        """
    ...
    @property
    @pulumi.getter(name="openapiConfig")
    def openapi_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The full text of the OpenAPI YAML configuration as described [here](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0.md).
        Either this, or *both* of `grpc_config` and `protoc_output_base64` must be specified.
        """
    ...
    @property
    @pulumi.getter(name="protocOutputBase64")
    def protoc_output_base64(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The full contents of the Service Descriptor File generated by protoc.  This should be a compiled .pb file, base64-encoded.
        """
        return pulumi.get(self, "protoc_output_base64")
