...
def get_service_iam_policy(service_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_name: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
