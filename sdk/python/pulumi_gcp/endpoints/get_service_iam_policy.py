...
def get_service_iam_policy(service_name: Optional[builtins.str] = None,
...
def get_service_iam_policy_output(service_name: Optional[pulumi.Input[builtins.str]] = None,
