...
def get_service_consumers_iam_policy(consumer_project: Optional[_builtins.str] = None,
    ...
    :param _builtins.str consumer_project: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str service_name: The name of the service. Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
