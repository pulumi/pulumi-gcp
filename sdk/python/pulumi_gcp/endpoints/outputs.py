...
class ServiceApi(dict):
    def __init__(__self__, *,
                 ...
                 syntax: Optional[builtins.str] = None,
                 version: Optional[builtins.str] = None):
        """
        :param Sequence['ServiceApiMethodArgs'] methods: A list of Method objects; structure is documented below.
        :param builtins.str name: The simple name of the endpoint as described in the config.
        :param builtins.str syntax: `SYNTAX_PROTO2` or `SYNTAX_PROTO3`.
        :param builtins.str version: A version string for this api. If specified, will have the form major-version.minor-version, e.g. `1.10`.
        """
    ...
    @property
    @pulumi.getter
    def syntax(self) -> Optional[builtins.str]:
        """
...
class ServiceApiMethod(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The simple name of the endpoint as described in the config.
        :param builtins.str request_type: The type URL for the request to this API.
        :param builtins.str response_type: The type URL for the response from this API.
        :param builtins.str syntax: `SYNTAX_PROTO2` or `SYNTAX_PROTO3`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class ServiceEndpoint(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str address: The FQDN of the endpoint as described in the config.
        :param builtins.str name: The simple name of the endpoint as described in the config.
        """
