...
class ServiceIamPolicy(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, policy_data=None, service_name=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, etag=None, policy_data=None, service_name=None):
        """
