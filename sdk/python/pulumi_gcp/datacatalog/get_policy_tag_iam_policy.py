...
def get_policy_tag_iam_policy(policy_tag: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_tag: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_policy_tag_iam_policy_output(policy_tag: Optional[pulumi.Input[builtins.str]] = None,
