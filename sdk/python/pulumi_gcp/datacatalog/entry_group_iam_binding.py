...
class EntryGroupIamBindingArgs:
    def __init__(__self__, *,
        ...
        """
        EntryGroupIamBindingArgs._configure(
...
class _EntryGroupIamBindingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: The role that should be applied. Only one
               ...
               `[projects|organizations]/{parent-name}/roles/{role-name}`.
        """
        _EntryGroupIamBindingState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            condition=condition,
            entry_group=entry_group,
            etag=etag,
...
class EntryGroupIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EntryGroupIamBindingArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if condition is not None and not isinstance(condition, EntryGroupIamBindingConditionArgs):
                condition = condition or {}
                def _setter(key, value):
                    condition[key] = value
                EntryGroupIamBindingConditionArgs._configure(_setter, **condition)
