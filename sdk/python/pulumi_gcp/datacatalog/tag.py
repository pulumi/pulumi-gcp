...
class _TagState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TagFieldArgs']]] fields: This maps the ID of a tag field to the value of and additional information about that field.
               Valid field IDs are defined by the tag's template. A tag must have at least 1 field and at most 500 fields.
               Structure is documented below.
        :param pulumi.Input[builtins.str] name: The resource name of the tag in URL format. Example:
        ...
        :param pulumi.Input[builtins.str] template: The resource name of the tag template that this tag uses. Example:
               projects/{project_id}/locations/{location}/tagTemplates/{tagTemplateId}
               This field cannot be modified after creation.
        :param pulumi.Input[builtins.str] template_displayname: The display name of the tag template.
        """
        if column is not None:
            pulumi.set(__self__, "column", column)
    ...
    def template_displayname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def template_displayname(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Tag(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent: Optional[pulumi.Input[builtins.str]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None,
            template_displayname: Optional[pulumi.Input[builtins.str]] = None) -> 'Tag':
        """
    ...
    @property
    @pulumi.getter(name="templateDisplayname")
    def template_displayname(self) -> pulumi.Output[builtins.str]:
        """
        The display name of the tag template.
        """
        return pulumi.get(self, "template_displayname")
