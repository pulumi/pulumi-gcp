...
class TagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] template: The resource name of the tag template that this tag uses. Example:
...
class _TagState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] template: The resource name of the tag template that this tag uses. Example:
               projects/{project_id}/locations/{location}/tagTemplates/{tagTemplateId}
               This field cannot be modified after creation.
        :param pulumi.Input[_builtins.str] template_displayname: The display name of the tag template.
        """
        if column is not None:
            pulumi.set(__self__, "column", column)
