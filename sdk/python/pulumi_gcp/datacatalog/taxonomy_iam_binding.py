...
class TaxonomyIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['TaxonomyIamBindingConditionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] taxonomy: Used to find the parent resource to bind the IAM policy to
        :param pulumi.Input[_builtins.str] project: The ID of the project in which the resource belongs.
               If it is not provided, the project will be parsed from the identifier of the parent resource. If no project is provided in the parent identifier and no project is specified, the provider project is used.
        :param pulumi.Input[_builtins.str] region: Taxonomy location region.
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['TaxonomyIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['TaxonomyIamBindingConditionArgs']]):
...
class TaxonomyIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['TaxonomyIamBindingConditionArgs', 'TaxonomyIamBindingConditionArgsDict', 'outputs.TaxonomyIamBindingCondition']]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `datacatalog.TaxonomyIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the taxonomy are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `datacatalog.TaxonomyIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the taxonomy are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None,
            taxonomy: pulumi.Input[Optional[_builtins.str]] = None) -> 'TaxonomyIamBinding':
        """
