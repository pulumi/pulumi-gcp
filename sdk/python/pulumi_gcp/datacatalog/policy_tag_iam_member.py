...
@pulumi.type_token("gcp:datacatalog/policyTagIamMember:PolicyTagIamMember")
class PolicyTagIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 condition: pulumi.Input[Optional[Union['PolicyTagIamMemberConditionArgs', 'PolicyTagIamMemberConditionArgsDict', 'outputs.PolicyTagIamMemberCondition']]] = None,
                 member: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_tag: pulumi.Input[Optional[_builtins.str]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
