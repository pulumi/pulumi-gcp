...
class EntryArgs:
    def __init__(__self__, *,
                 ...
                 linked_resource: Optional[pulumi.Input[builtins.str]] = None,
                 schema: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 user_specified_system: Optional[pulumi.Input[builtins.str]] = None,
                 user_specified_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] schema: Schema of the entry (e.g. BigQuery, GoogleSQL, Avro schema), as a json string. An entry might not have any schema
               attached to it. See
               https://cloud.google.com/data-catalog/docs/reference/rest/v1/projects.locations.entryGroups.entries#schema
               for what fields this schema can contain.
        :param pulumi.Input[builtins.str] type: The type of the entry. Only used for Entries with types in the EntryType enum.
               Currently, only FILESET enum value is allowed. All other entries created through Data Catalog must use userSpecifiedType.
               Possible values are: `FILESET`.
        :param pulumi.Input[builtins.str] user_specified_system: This field indicates the entry's source system that Data Catalog does not integrate with.
               userSpecifiedSystem strings must begin with a letter or underscore and can only contain letters, numbers,
               and underscores; are case insensitive; must be at least 1 character and at most 64 characters long.
        :param pulumi.Input[builtins.str] user_specified_type: Entry type if it does not fit any of the input-allowed values listed in EntryType enum above.
    ...
    def linked_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def linked_resource(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_specified_system(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_specified_system(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_specified_system", value)

    @property
    @pulumi.getter(name="userSpecifiedType")
    def user_specified_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_specified_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EntryState:
    def __init__(__self__, *,
                 ...
                 gcs_fileset_spec: Optional[pulumi.Input['EntryGcsFilesetSpecArgs']] = None,
                 integrated_system: Optional[pulumi.Input[builtins.str]] = None,
                 linked_resource: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] linked_resource: The resource this metadata entry refers to.
               ...
               Output only when Entry is of type in the EntryType enum. For entries with userSpecifiedType,
               this field is optional and defaults to an empty string.
        :param pulumi.Input[builtins.str] name: The Data Catalog resource name of the entry in URL format.
    ...
    def integrated_system(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def integrated_system(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Entry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            user_specified_system: Optional[pulumi.Input[builtins.str]] = None,
            user_specified_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Entry':
        """
    ...
    @property
    @pulumi.getter(name="integratedSystem")
    def integrated_system(self) -> pulumi.Output[builtins.str]:
        """
        This field indicates the entry's source system that Data Catalog integrates with, such as BigQuery or Pub/Sub.
        """
        return pulumi.get(self, "integrated_system")
    ...
    @property
    @pulumi.getter(name="linkedResource")
    def linked_resource(self) -> pulumi.Output[builtins.str]:
        """
        The resource this metadata entry refers to.
        For Google Cloud Platform resources, linkedResource is the full name of the resource.
        For example, the linkedResource for a table resource from BigQuery is:
    ...
    @property
    @pulumi.getter(name="userSpecifiedSystem")
    def user_specified_system(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This field indicates the entry's source system that Data Catalog does not integrate with.
        userSpecifiedSystem strings must begin with a letter or underscore and can only contain letters, numbers,
        and underscores; are case insensitive; must be at least 1 character and at most 64 characters long.
    ...
    @property
    @pulumi.getter(name="userSpecifiedType")
    def user_specified_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Entry type if it does not fit any of the input-allowed values listed in EntryType enum above.
        When creating an entry, users should check the enum values first, if nothing matches the entry
        to be created, then provide a custom value, for example "my_special_type".
