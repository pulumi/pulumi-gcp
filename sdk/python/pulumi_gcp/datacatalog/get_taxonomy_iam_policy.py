...
def get_taxonomy_iam_policy(project: Optional[_builtins.str] = None,
                            region: Optional[_builtins.str] = None,
                            taxonomy: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: Taxonomy location region.
           Used to find the parent resource to bind the IAM policy to. If not specified,
           the value will be parsed from the identifier of the parent resource. If no region is provided in the parent identifier and no
           region is specified, it is taken from the provider configuration.
    :param _builtins.str taxonomy: Used to find the parent resource to bind the IAM policy to
    """
    __args__ = dict()
...
def get_taxonomy_iam_policy_output(project: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
