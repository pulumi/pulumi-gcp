...
class EntryBigqueryDateShardedSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dataset: (Output)
               The Data Catalog resource name of the dataset entry the current table belongs to, for example,
               projects/{project_id}/locations/{location}/entrygroups/{entryGroupId}/entries/{entryId}
        :param builtins.int shard_count: (Output)
               Total number of shards.
        :param builtins.str table_prefix: (Output)
...
class EntryBigqueryTableSpec(dict):
    ...
    def __init__(__self__, *,
                 table_source_type: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str table_source_type: (Output)
    ...
    def table_source_type(self) -> Optional[builtins.str]:
        """
        (Output)
        The table source type.
        """
...
class EntryBigqueryTableSpecTableSpec(dict):
    ...
    def __init__(__self__, *,
                 grouped_entry: Optional[builtins.str] = None):
        """
        :param builtins.str grouped_entry: (Output)
    ...
    def grouped_entry(self) -> Optional[builtins.str]:
        """
        (Output)
        If the table is a dated shard, i.e., with name pattern [prefix]YYYYMMDD, groupedEntry is the
        Data Catalog resource name of the date sharded grouped entry, for example,
...
class EntryBigqueryTableSpecViewSpec(dict):
    ...
    def __init__(__self__, *,
                 view_query: Optional[builtins.str] = None):
        """
        :param builtins.str view_query: (Output)
    ...
    def view_query(self) -> Optional[builtins.str]:
        """
        (Output)
        The query that defines the table view.
        """
...
class EntryGcsFilesetSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] file_patterns: Patterns to identify a set of files in Google Cloud Storage.
...
class EntryGcsFilesetSpecSampleGcsFileSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str file_path: The full file path
        :param builtins.int size_bytes: The size of the file, in bytes.
        """
...
class TagField(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enum_value: Optional[builtins.str] = None,
                 order: Optional[builtins.int] = None,
                 string_value: Optional[builtins.str] = None,
                 timestamp_value: Optional[builtins.str] = None):
        """
        :param builtins.str field_name: The identifier for this object. Format specified above.
        :param builtins.bool bool_value: Holds the value for a tag field with boolean type.
        ...
        :param builtins.str string_value: Holds the value for a tag field with string type.
        :param builtins.str timestamp_value: Holds the value for a tag field with timestamp type.
        """
    ...
    def timestamp_value(self) -> Optional[builtins.str]:
        """
...
class TagTemplateField(dict):
    ...
    def __init__(__self__, *,
                 ...
                 order: Optional[builtins.int] = None):
        """
        :param builtins.str field_id: The identifier for this object. Format specified above.
        :param 'TagTemplateFieldTypeArgs' type: The type of value this tag field can contain.
               Structure is documented below.
        :param builtins.str description: A description for this field.
        :param builtins.str display_name: The display name for this field.
        :param builtins.bool is_required: Whether this is a required field. Defaults to false.
        :param builtins.str name: (Output)
               The resource name of the tag template field in URL format. Example: projects/{project_id}/locations/{location}/tagTemplates/{tagTemplateId}/fields/{field}
        :param builtins.int order: The order of this field with respect to other fields in this tag template.
...
class TagTemplateFieldType(dict):
    ...
    def __init__(__self__, *,
                 ...
                 primitive_type: Optional[builtins.str] = None):
        """
        :param 'TagTemplateFieldTypeEnumTypeArgs' enum_type: Represents an enum type.
               Exactly one of `primitive_type` or `enum_type` must be set
               Structure is documented below.
        :param builtins.str primitive_type: Represents primitive types - string, bool etc.
               Exactly one of `primitive_type` or `enum_type` must be set
    ...
    def primitive_type(self) -> Optional[builtins.str]:
        """
