...
class PolicyTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] parent_policy_tag: Resource name of this policy tag's parent policy tag.
...
class _PolicyTagState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: User defined name of this policy tag. It must: be unique within the parent
               taxonomy; contain only unicode letters, numbers, underscores, dashes and spaces;
               not start or end with spaces; and be at most 200 bytes long when encoded in UTF-8.
        :param pulumi.Input[_builtins.str] name: Resource name of this policy tag, whose format is:
