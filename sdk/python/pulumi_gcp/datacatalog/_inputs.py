...
class EntryBigqueryDateShardedSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dataset: (Output)
               The Data Catalog resource name of the dataset entry the current table belongs to, for example,
               projects/{project_id}/locations/{location}/entrygroups/{entryGroupId}/entries/{entryId}
        :param pulumi.Input[_builtins.int] shard_count: (Output)
               Total number of shards.
        :param pulumi.Input[_builtins.str] table_prefix: (Output)
               The table name prefix of the shards. The name of any given shard is [tablePrefix]YYYYMMDD,
               for example, for shard MyTable20180101, the tablePrefix is MyTable.
        """
...
class TagFieldArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Output)
               The display name of this field
        :param pulumi.Input[_builtins.float] double_value: Holds the value for a tag field with double type.
        :param pulumi.Input[_builtins.str] enum_value: Holds the value for a tag field with enum type. This value must be one of the allowed values in the definition of this enum.
        :param pulumi.Input[_builtins.int] order: (Output)
               The order of this field with respect to other fields in this tag. For example, a higher value can indicate
               a more important field. The value can be negative. Multiple fields can have the same order, and field orders
               within a tag do not have to be sequential.
        :param pulumi.Input[_builtins.str] string_value: Holds the value for a tag field with string type.
        :param pulumi.Input[_builtins.str] timestamp_value: Holds the value for a tag field with timestamp type.
        """
...
class TagTemplateFieldArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TagTemplateFieldTypeArgs'] type: The type of value this tag field can contain.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] description: A description for this field.
        :param pulumi.Input[_builtins.str] display_name: The display name for this field.
        :param pulumi.Input[_builtins.bool] is_required: Whether this is a required field. Defaults to false.
        :param pulumi.Input[_builtins.str] name: (Output)
               The resource name of the tag template field in URL format. Example: projects/{project_id}/locations/{location}/tagTemplates/{tagTemplateId}/fields/{field}
        :param pulumi.Input[_builtins.int] order: The order of this field with respect to other fields in this tag template.
               A higher value indicates a more important field. The value can be negative.
               Multiple fields can have the same order, and field orders within a tag do not have to be sequential.
        """
...
class TagTemplateFieldTypeEnumTypeAllowedValueArgs:
    def __init__(__self__, *,
                 display_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] display_name: The display name of the enum value.
        """
        pulumi.set(__self__, "display_name", display_name)
