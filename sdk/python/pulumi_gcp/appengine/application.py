...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] location_id: The [location](https://cloud.google.com/appengine/docs/locations)
               to serve the app from.
        :param pulumi.Input[builtins.str] auth_domain: The domain to authenticate users with when using App Engine's User API.
        :param pulumi.Input[builtins.str] database_type: The type of the Cloud Firestore or Cloud Datastore database associated with this application.
        ...
        :param pulumi.Input[builtins.str] project: The project ID to create the application under.
               ~>**NOTE:** GCP only accepts project ID, not project number. If you are using number,
               you may get a "Permission denied" error.
        :param pulumi.Input[builtins.str] serving_status: The serving status of the app.
        """
...
class _ApplicationState:
    def __init__(__self__, *,
                 ...
                 auth_domain: Optional[pulumi.Input[builtins.str]] = None,
                 code_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 database_type: Optional[pulumi.Input[builtins.str]] = None,
                 default_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 default_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 feature_settings: Optional[pulumi.Input['ApplicationFeatureSettingsArgs']] = None,
                 gcr_domain: Optional[pulumi.Input[builtins.str]] = None,
                 iap: Optional[pulumi.Input['ApplicationIapArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] app_id: Identifier of the app, usually `{PROJECT_ID}`
        :param pulumi.Input[builtins.str] auth_domain: The domain to authenticate users with when using App Engine's User API.
        :param pulumi.Input[builtins.str] code_bucket: The GCS bucket code is being stored in for this app.
        :param pulumi.Input[builtins.str] database_type: The type of the Cloud Firestore or Cloud Datastore database associated with this application.
               Can be `CLOUD_FIRESTORE` or `CLOUD_DATASTORE_COMPATIBILITY` for new
               instances.  To support old instances, the value `CLOUD_DATASTORE` is accepted by the provider, but will be rejected by the API.
               To create a Cloud Firestore database without creating an App Engine application, use the
               `firestore.Database`
               resource instead.
        :param pulumi.Input[builtins.str] default_bucket: The GCS bucket content is being stored in for this app.
        :param pulumi.Input[builtins.str] default_hostname: The default hostname for this app.
        :param pulumi.Input['ApplicationFeatureSettingsArgs'] feature_settings: A block of optional settings to configure specific App Engine features:
        :param pulumi.Input[builtins.str] gcr_domain: The GCR domain used for storing managed Docker images for this app.
        :param pulumi.Input['ApplicationIapArgs'] iap: Settings for enabling Cloud Identity Aware Proxy
        :param pulumi.Input[builtins.str] location_id: The [location](https://cloud.google.com/appengine/docs/locations)
               to serve the app from.
        :param pulumi.Input[builtins.str] name: Unique name of the app, usually `apps/{PROJECT_ID}`
        :param pulumi.Input[builtins.str] project: The project ID to create the application under.
               ~>**NOTE:** GCP only accepts project ID, not project number. If you are using number,
               you may get a "Permission denied" error.
        :param pulumi.Input[builtins.str] serving_status: The serving status of the app.
    ...
    def code_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @code_bucket.setter
    def code_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def gcr_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @gcr_domain.setter
    def gcr_domain(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Application(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `{{project-id}}`
        ...
        :param pulumi.Input[builtins.str] database_type: The type of the Cloud Firestore or Cloud Datastore database associated with this application.
               ...
               `firestore.Database`
               resource instead.
        :param pulumi.Input[Union['ApplicationFeatureSettingsArgs', 'ApplicationFeatureSettingsArgsDict']] feature_settings: A block of optional settings to configure specific App Engine features:
        :param pulumi.Input[Union['ApplicationIapArgs', 'ApplicationIapArgsDict']] iap: Settings for enabling Cloud Identity Aware Proxy
        :param pulumi.Input[builtins.str] location_id: The [location](https://cloud.google.com/appengine/docs/locations)
               to serve the app from.
        :param pulumi.Input[builtins.str] project: The project ID to create the application under.
               ~>**NOTE:** GCP only accepts project ID, not project number. If you are using number,
    ...
    @property
    @pulumi.getter(name="authDomain")
    def auth_domain(self) -> pulumi.Output[builtins.str]:
        """
        The domain to authenticate users with when using App Engine's User API.
        """
        return pulumi.get(self, "auth_domain")
    ...
    @property
    @pulumi.getter(name="codeBucket")
    def code_bucket(self) -> pulumi.Output[builtins.str]:
        """
        The GCS bucket code is being stored in for this app.
        """
        return pulumi.get(self, "code_bucket")
    ...
    @property
    @pulumi.getter(name="defaultBucket")
    def default_bucket(self) -> pulumi.Output[builtins.str]:
        """
        The GCS bucket content is being stored in for this app.
        """
        return pulumi.get(self, "default_bucket")
    ...
    @property
    @pulumi.getter(name="gcrDomain")
    def gcr_domain(self) -> pulumi.Output[builtins.str]:
        """
        The GCR domain used for storing managed Docker images for this app.
        """
        return pulumi.get(self, "gcr_domain")
    ...
    @property
    @pulumi.getter(name="servingStatus")
    def serving_status(self) -> pulumi.Output[builtins.str]:
        """
        The serving status of the app.
        """
        return pulumi.get(self, "serving_status")
