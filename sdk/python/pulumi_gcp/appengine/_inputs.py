...
__all__ = [
    ...
    'StandardAppVersionVpcAccessArgsDict',
    ...
    'StandardAppVersionVpcAccessNetworkInterfaceArgsDict',
]
...
class ApplicationFeatureSettingsArgs:
    def __init__(__self__, *,
                 split_health_checks: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] split_health_checks: Set to false to use the legacy health check instead of the readiness
               and liveness checks.
        """
...
class ApplicationUrlDispatchRulesDispatchRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] path: Pathname within the host. Must start with a "/". A single "*" can be included at the end of the path.
               The sum of the lengths of the domain and path may not exceed 100 characters.
        :param pulumi.Input[_builtins.str] service: Pathname within the host. Must start with a "/". A single "*" can be included at the end of the path.
               The sum of the lengths of the domain and path may not exceed 100 characters.
        :param pulumi.Input[_builtins.str] domain: Domain name to match against. The wildcard "*" is supported if specified before a period: "*.".
               Defaults to matching all domains: "*".
        """
        pulumi.set(__self__, "path", path)
        pulumi.set(__self__, "service", service)
...
class DomainMappingResourceRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Resource record type. Example: `AAAA`.
               Possible values are: `A`, `AAAA`, `CNAME`.
        """
        if name is not None:
...
class DomainMappingSslSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ssl_management_type: SSL management type for this domain. If `AUTOMATIC`, a managed certificate is automatically provisioned.
               If `MANUAL`, `certificateId` must be manually specified in order to configure SSL for this domain.
               Possible values are: `AUTOMATIC`, `MANUAL`.
        :param pulumi.Input[_builtins.str] certificate_id: ID of the AuthorizedCertificate resource configuring SSL for the application. Clearing this field will
               remove SSL support.
               By default, a managed certificate is automatically created for every domain mapping. To omit SSL support
               or to configure SSL manually, specify `SslManagementType.MANUAL` on a `CREATE` or `UPDATE` request. You must be
               authorized to administer the `AuthorizedCertificate` resource to manually map it to a DomainMapping resource.
               Example: 12345.
        :param pulumi.Input[_builtins.str] pending_managed_certificate_id: (Output)
               ID of the managed `AuthorizedCertificate` resource currently being provisioned, if applicable. Until the new
               managed certificate has been successfully provisioned, the previous SSL state will be preserved. Once the
               provisioning process completes, the `certificateId` field will reflect the new managed certificate and this
               field will be left empty. To remove SSL support while there is still a pending managed certificate, clear the
...
class EngineSplitTrafficSplitArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def allocations(self) -> pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]:
        """
        Mapping from version IDs within the service to fractional (0.000, 1] allocations of traffic for that version. Each version can be specified only once, but some versions in the service may not have any traffic allocation. Services that have traffic allocated cannot be deleted until either the service is deleted or their traffic allocation is removed. Allocations must sum to 1. Up to two decimal place precision is supported for IP-based splits and up to three decimal places is supported for cookie-based splits.
        """
    ...
    @allocations.setter
    def allocations(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]):
...
class FlexibleAppVersionApiConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auth_fail_action: Action to take when users access resources that require authentication.
               Default value is `AUTH_FAIL_ACTION_REDIRECT`.
               Possible values are: `AUTH_FAIL_ACTION_REDIRECT`, `AUTH_FAIL_ACTION_UNAUTHORIZED`.
        :param pulumi.Input[_builtins.str] login: Level of login required to access this resource.
               Default value is `LOGIN_OPTIONAL`.
               Possible values are: `LOGIN_OPTIONAL`, `LOGIN_ADMIN`, `LOGIN_REQUIRED`.
        :param pulumi.Input[_builtins.str] security_level: Security (HTTPS) enforcement for this URL.
               Possible values are: `SECURE_DEFAULT`, `SECURE_NEVER`, `SECURE_OPTIONAL`, `SECURE_ALWAYS`.
        :param pulumi.Input[_builtins.str] url: URL to serve the endpoint at.
        """
...
class FlexibleAppVersionAutomaticScalingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FlexibleAppVersionAutomaticScalingCpuUtilizationArgs'] cpu_utilization: Target scaling by CPU usage.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] cool_down_period: The time period that the Autoscaler should wait before it starts collecting information from a new instance.
               This prevents the autoscaler from collecting information when the instance is initializing,
               during which the collected usage would not be reliable. Default: 120s
        ...
        :param pulumi.Input[_builtins.int] max_concurrent_requests: Number of concurrent requests an automatic scaling instance can accept before the scheduler spawns a new instance.
               Defaults to a runtime-specific value.
        :param pulumi.Input[_builtins.int] max_idle_instances: Maximum number of idle instances that should be maintained for this version.
        :param pulumi.Input[_builtins.str] max_pending_latency: Maximum amount of time that a request should wait in the pending queue before starting a new instance to handle it.
        :param pulumi.Input[_builtins.int] max_total_instances: Maximum number of instances that should be started to handle requests for this version. Default: 20
        :param pulumi.Input[_builtins.int] min_idle_instances: Minimum number of idle instances that should be maintained for this version. Only applicable for the default version of a service.
        :param pulumi.Input[_builtins.str] min_pending_latency: Minimum amount of time a request should wait in the pending queue before starting a new instance to handle it.
        :param pulumi.Input[_builtins.int] min_total_instances: Minimum number of running instances that should be maintained for this version. Default: 2
...
class FlexibleAppVersionAutomaticScalingDiskUtilizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] target_write_bytes_per_second: Target bytes written per second.
        :param pulumi.Input[_builtins.int] target_write_ops_per_second: Target ops written per second.
        """
...
class FlexibleAppVersionAutomaticScalingNetworkUtilizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] target_sent_bytes_per_second: Target bytes sent per second.
        :param pulumi.Input[_builtins.int] target_sent_packets_per_second: Target packets sent per second.
        """
...
class FlexibleAppVersionDeploymentContainerArgs:
    def __init__(__self__, *,
                 image: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] image: URI to the hosted container image in Google Container Registry. The URI must be fully qualified and include a tag or digest.
               Examples: "gcr.io/my-project/image:tag" or "gcr.io/my-project/image@digest"
        """
...
class FlexibleAppVersionDeploymentFileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sha1_sum: SHA1 checksum of the file
        """
        pulumi.set(__self__, "name", name)
...
class FlexibleAppVersionEndpointsApiServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Endpoints service name which is the name of the "service" resource in the Service Management API.
               For example "myapi.endpoints.myproject.cloud.goog"
        :param pulumi.Input[_builtins.str] config_id: Endpoints service configuration ID as specified by the Service Management API. For example "2016-09-19r1".
               By default, the rollout strategy for Endpoints is "FIXED". This means that Endpoints starts up with a particular configuration ID.
               When a new configuration is rolled out, Endpoints must be given the new configuration ID. The configId field is used to give the configuration ID
               and is required in this case.
               Endpoints also has a rollout strategy called "MANAGED". When using this, Endpoints fetches the latest configuration and does not need
               the configuration ID. In this case, configId must be omitted.
        :param pulumi.Input[_builtins.bool] disable_trace_sampling: Enable or disable trace sampling. By default, this is set to false for enabled.
        :param pulumi.Input[_builtins.str] rollout_strategy: Endpoints rollout strategy. If FIXED, configId must be specified. If MANAGED, configId must be omitted.
               Default value is `FIXED`.
               Possible values are: `FIXED`, `MANAGED`.
        """
        pulumi.set(__self__, "name", name)
...
class FlexibleAppVersionEntrypointArgs:
    def __init__(__self__, *,
                 shell: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] shell: The format should be a shell command that can be fed to bash -c.
        """
...
class FlexibleAppVersionHandlerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auth_fail_action: Actions to take when the user is not logged in.
               Possible values are: `AUTH_FAIL_ACTION_REDIRECT`, `AUTH_FAIL_ACTION_UNAUTHORIZED`.
        :param pulumi.Input[_builtins.str] login: Methods to restrict access to a URL based on login status.
               Possible values are: `LOGIN_OPTIONAL`, `LOGIN_ADMIN`, `LOGIN_REQUIRED`.
        :param pulumi.Input[_builtins.str] redirect_http_response_code: 30x code to use when performing redirects for the secure field.
               Possible values are: `REDIRECT_HTTP_RESPONSE_CODE_301`, `REDIRECT_HTTP_RESPONSE_CODE_302`, `REDIRECT_HTTP_RESPONSE_CODE_303`, `REDIRECT_HTTP_RESPONSE_CODE_307`.
        ...
        :param pulumi.Input['FlexibleAppVersionHandlerStaticFilesArgs'] static_files: Files served directly to the user for a given URL, such as images, CSS stylesheets, or JavaScript source files.
               Static file handlers describe which files in the application directory are static files, and which URLs serve them.
               Structure is documented below.
        :param pulumi.Input[_builtins.str] url_regex: URL prefix. Uses regular expression syntax, which means regexp special characters must be escaped, but should not contain groupings.
               All URLs that begin with this prefix are handled by this handler, using the portion of the URL after the prefix as part of the file path.
        """
        if auth_fail_action is not None:
            pulumi.set(__self__, "auth_fail_action", auth_fail_action)
...
class FlexibleAppVersionHandlerScriptArgs:
    def __init__(__self__, *,
                 script_path: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] script_path: Path to the script from the application root directory.
        """
...
class FlexibleAppVersionHandlerStaticFilesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] application_readable: Whether files should also be uploaded as code data. By default, files declared in static file handlers are
               uploaded as static data and are only served to end users; they cannot be read by the application. If enabled,
               uploads are charged against both your code and static data storage resource quotas.
        :param pulumi.Input[_builtins.str] expiration: Time a static file served by this handler should be cached by web proxies and browsers.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example "3.5s".
               Default is '0s'
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] http_headers: HTTP headers to use for all responses from these URLs.
               An object containing a list of "key:value" value pairs.".
        :param pulumi.Input[_builtins.str] mime_type: MIME type used to serve all files served by this handler.
               Defaults to file-specific MIME types, which are derived from each file's filename extension.
        :param pulumi.Input[_builtins.str] path: Path to the static files matched by the URL pattern, from the application root directory.
               The path can refer to text matched in groupings in the URL pattern.
        :param pulumi.Input[_builtins.bool] require_matching_file: Whether this handler should match the request if the file referenced by the handler does not exist.
        :param pulumi.Input[_builtins.str] upload_path_regex: Regular expression that matches the file paths for all files that should be referenced by this handler.
        """
...
class FlexibleAppVersionLivenessCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] failure_threshold: Number of consecutive failed checks required before considering the VM unhealthy. Default: 4.
        :param pulumi.Input[_builtins.str] host: Host header to send when performing a HTTP Readiness check. Example: "myapp.appspot.com"
        :param pulumi.Input[_builtins.str] initial_delay: The initial delay before starting to execute the checks. Default: "300s"
        :param pulumi.Input[_builtins.float] success_threshold: Number of consecutive successful checks required before considering the VM healthy. Default: 2.
        :param pulumi.Input[_builtins.str] timeout: Time before the check is considered failed. Default: "4s"
        """
        pulumi.set(__self__, "path", path)
...
class FlexibleAppVersionManualScalingArgs:
    def __init__(__self__, *,
                 instances: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] instances: Number of instances to assign to the service at the start.
               **Note:** When managing the number of instances at runtime through the App Engine Admin API or the (now deprecated) Python 2
               Modules API set_num_instances() you must use `lifecycle.ignore_changes = ["manual_scaling"[0].instances]` to prevent drift detection.
        """
...
class FlexibleAppVersionNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subnetwork: Google Cloud Platform sub-network where the virtual machines are created. Specify the short name, not the resource path.
               If the network that the instance is being created in is a Legacy network, then the IP address is allocated from the IPv4Range.
               If the network that the instance is being created in is an auto Subnet Mode Network, then only network name should be specified (not the subnetworkName) and the IP address is created from the IPCidrRange of the subnetwork that exists in that zone for that network.
               If the network that the instance is being created in is a custom Subnet Mode Network, then the subnetworkName must be specified and the IP address is created from the IPCidrRange of the subnetwork.
               If specified, the subnetwork must exist in the same region as the App Engine flexible environment application.
...
class FlexibleAppVersionReadinessCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] app_start_timeout: A maximum time limit on application initialization, measured from moment the application successfully
               replies to a healthcheck until it is ready to serve traffic. Default: "300s"
        :param pulumi.Input[_builtins.str] check_interval: Interval between health checks.  Default: "5s".
        :param pulumi.Input[_builtins.float] failure_threshold: Number of consecutive failed checks required before removing traffic. Default: 2.
        :param pulumi.Input[_builtins.str] host: Host header to send when performing a HTTP Readiness check. Example: "myapp.appspot.com"
        :param pulumi.Input[_builtins.float] success_threshold: Number of consecutive successful checks required before receiving traffic. Default: 2.
        :param pulumi.Input[_builtins.str] timeout: Time before the check is considered failed. Default: "4s"
        """
        pulumi.set(__self__, "path", path)
...
class FlexibleAppVersionResourcesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] memory_gb: Memory (GB) needed.
...
class FlexibleAppVersionResourcesVolumeArgs:
    def __init__(__self__, *,
                 ...
                 volume_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: Unique name for the volume.
        :param pulumi.Input[_builtins.int] size_gb: Volume size in gigabytes.
        :param pulumi.Input[_builtins.str] volume_type: Underlying volume type, e.g. 'tmpfs'.
        """
        pulumi.set(__self__, "name", name)
...
class StandardAppVersionAutomaticScalingStandardSchedulerSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_instances: Maximum number of instances to run for this version. Set to zero to disable maxInstances configuration.
               **Note:** Starting from March 2025, App Engine sets the maxInstances default for standard environment deployments to 20. This change doesn't impact existing apps. To override the default, specify a new value between 0 and 2147483647, and deploy a new version or redeploy over an existing version. To disable the maxInstances default configuration setting, specify the maximum permitted value 2147483647.
        :param pulumi.Input[_builtins.int] min_instances: Minimum number of instances to run for this version. Set to zero to disable minInstances configuration.
        :param pulumi.Input[_builtins.float] target_cpu_utilization: Target CPU utilization ratio to maintain when scaling. Should be a value in the range [0.50, 0.95], zero, or a negative value.
        :param pulumi.Input[_builtins.float] target_throughput_utilization: Target throughput utilization ratio to maintain when scaling. Should be a value in the range [0.50, 0.95], zero, or a negative value.
        """
...
class StandardAppVersionHandlerStaticFilesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] mime_type: MIME type used to serve all files served by this handler.
               Defaults to file-specific MIME types, which are derived from each file's filename extension.
        :param pulumi.Input[_builtins.str] path: Path to the static files matched by the URL pattern, from the application root directory. The path can refer to text matched in groupings in the URL pattern.
        :param pulumi.Input[_builtins.bool] require_matching_file: Whether this handler should match the request if the file referenced by the handler does not exist.
        :param pulumi.Input[_builtins.str] upload_path_regex: Regular expression that matches the file paths for all files that should be referenced by this handler.
        """
        if application_readable is not None:
...
class StandardAppVersionVpcAccessArgsDict(TypedDict):
    ...
    """
    network_interfaces: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['StandardAppVersionVpcAccessNetworkInterfaceArgsDict']]]]]
    """
...
@pulumi.input_type
class StandardAppVersionVpcAccessArgs:
    def __init__(__self__, *,
                 egress_setting: pulumi.Input[Optional[_builtins.str]] = None,
                 network_interfaces: pulumi.Input[Optional[Sequence[pulumi.Input['StandardAppVersionVpcAccessNetworkInterfaceArgs']]]] = None):
        """
        :param pulumi.Input[_builtins.str] egress_setting: The egress setting for the VPC Access, controlling what traffic is diverted through it.
        :param pulumi.Input[Sequence[pulumi.Input['StandardAppVersionVpcAccessNetworkInterfaceArgs']]] network_interfaces: List of network interfaces for the VPC Access. Currently only a single network interface is supported.
               Structure is documented below.
        """
    ...
    def network_interfaces(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['StandardAppVersionVpcAccessNetworkInterfaceArgs']]]]:
        """
        List of network interfaces for the VPC Access. Currently only a single network interface is supported.
        Structure is documented below.
        """
    ...
    def network_interfaces(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['StandardAppVersionVpcAccessNetworkInterfaceArgs']]]]):
...
class StandardAppVersionVpcAccessNetworkInterfaceArgsDict(TypedDict):
...
@pulumi.input_type
class StandardAppVersionVpcAccessNetworkInterfaceArgs:
    def __init__(__self__, *,
                 network: pulumi.Input[Optional[_builtins.str]] = None,
                 subnetwork: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        :param pulumi.Input[_builtins.str] network: The name of the VPC network to which the version connects (e.g. `projects/my-project/global/networks/default`).
        :param pulumi.Input[_builtins.str] subnetwork: The name of the subnetwork to which the version connects (e.g. `projects/my-project/regions/us-central1/subnetworks/default`).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: Network tags applied to this App Engine version.
        """
