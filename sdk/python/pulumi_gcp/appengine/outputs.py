...
class ApplicationFeatureSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool split_health_checks: Set to false to use the legacy health check instead of the readiness
               and liveness checks.
        """
    ...
    def split_health_checks(self) -> builtins.bool:
        """
...
class ApplicationIap(dict):
    ...
    def __init__(__self__, *,
                 ...
                 oauth2_client_secret_sha256: Optional[builtins.str] = None):
        """
        :param builtins.str oauth2_client_id: OAuth2 client ID to use for the authentication flow.
        :param builtins.str oauth2_client_secret: OAuth2 client secret to use for the authentication flow.
               The SHA-256 hash of the value is returned in the oauth2ClientSecretSha256 field.
        :param builtins.bool enabled: (Optional) Whether the serving infrastructure will authenticate and authorize all incoming requests. 
               (default is false)
        :param builtins.str oauth2_client_secret_sha256: Hex-encoded SHA-256 hash of the client secret.
        """
    ...
    def oauth2_client_secret_sha256(self) -> Optional[builtins.str]:
        """
...
class ApplicationUrlDispatchRulesDispatchRule(dict):
    def __init__(__self__, *,
                 ...
                 domain: Optional[builtins.str] = None):
        """
        :param builtins.str path: Pathname within the host. Must start with a "/". A single "*" can be included at the end of the path.
...
class DomainMappingResourceRecord(dict):
    def __init__(__self__, *,
                 ...
                 rrdata: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str name: Relative name of the object affected by this record. Only applicable for CNAME records. Example: 'www'.
        :param builtins.str rrdata: Data for this record. Values vary by record type, as defined in RFC 1035 (section 5) and RFC 1034 (section 3.6.1).
        :param builtins.str type: Resource record type. Example: `AAAA`.
    ...
    @property
    @pulumi.getter
    def rrdata(self) -> Optional[builtins.str]:
        """
...
class DomainMappingSslSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pending_managed_certificate_id: Optional[builtins.str] = None):
        """
        :param builtins.str ssl_management_type: SSL management type for this domain. If `AUTOMATIC`, a managed certificate is automatically provisioned.
               If `MANUAL`, `certificateId` must be manually specified in order to configure SSL for this domain.
               Possible values are: `AUTOMATIC`, `MANUAL`.
        :param builtins.str certificate_id: ID of the AuthorizedCertificate resource configuring SSL for the application. Clearing this field will
               remove SSL support.
               By default, a managed certificate is automatically created for every domain mapping. To omit SSL support
               or to configure SSL manually, specify `SslManagementType.MANUAL` on a `CREATE` or `UPDATE` request. You must be
               authorized to administer the `AuthorizedCertificate` resource to manually map it to a DomainMapping resource.
               Example: 12345.
        :param builtins.str pending_managed_certificate_id: (Output)
    ...
    def pending_managed_certificate_id(self) -> Optional[builtins.str]:
        """
        (Output)
        ID of the managed `AuthorizedCertificate` resource currently being provisioned, if applicable. Until the new
        managed certificate has been successfully provisioned, the previous SSL state will be preserved. Once the
...
class EngineSplitTrafficSplit(dict):
    ...
    def __init__(__self__, *,
                 allocations: Mapping[str, builtins.str],
    ...
    def shard_by(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionApiConfig(dict):
    ...
    def __init__(__self__, *,
                 script: builtins.str,
                 auth_fail_action: Optional[builtins.str] = None,
                 login: Optional[builtins.str] = None,
                 security_level: Optional[builtins.str] = None,
                 url: Optional[builtins.str] = None):
        """
        :param builtins.str script: Path to the script from the application root directory.
        :param builtins.str auth_fail_action: Action to take when users access resources that require authentication.
               Default value is `AUTH_FAIL_ACTION_REDIRECT`.
               Possible values are: `AUTH_FAIL_ACTION_REDIRECT`, `AUTH_FAIL_ACTION_UNAUTHORIZED`.
        :param builtins.str login: Level of login required to access this resource.
               Default value is `LOGIN_OPTIONAL`.
               Possible values are: `LOGIN_OPTIONAL`, `LOGIN_ADMIN`, `LOGIN_REQUIRED`.
        :param builtins.str security_level: Security (HTTPS) enforcement for this URL.
               Possible values are: `SECURE_DEFAULT`, `SECURE_NEVER`, `SECURE_OPTIONAL`, `SECURE_ALWAYS`.
        :param builtins.str url: URL to serve the endpoint at.
        """
    ...
    def auth_fail_action(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionAutomaticScaling(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_idle_instances: Optional[builtins.int] = None,
                 max_pending_latency: Optional[builtins.str] = None,
                 max_total_instances: Optional[builtins.int] = None,
                 min_idle_instances: Optional[builtins.int] = None,
                 min_pending_latency: Optional[builtins.str] = None,
                 min_total_instances: Optional[builtins.int] = None,
        ...
        :param builtins.str cool_down_period: The time period that the Autoscaler should wait before it starts collecting information from a new instance.
        ...
        :param 'FlexibleAppVersionAutomaticScalingDiskUtilizationArgs' disk_utilization: Target scaling by disk usage.
               Structure is documented below.
        :param builtins.int max_concurrent_requests: Number of concurrent requests an automatic scaling instance can accept before the scheduler spawns a new instance.
               Defaults to a runtime-specific value.
        :param builtins.int max_idle_instances: Maximum number of idle instances that should be maintained for this version.
        :param builtins.str max_pending_latency: Maximum amount of time that a request should wait in the pending queue before starting a new instance to handle it.
        :param builtins.int max_total_instances: Maximum number of instances that should be started to handle requests for this version. Default: 20
        :param builtins.int min_idle_instances: Minimum number of idle instances that should be maintained for this version. Only applicable for the default version of a service.
        :param builtins.str min_pending_latency: Minimum amount of time a request should wait in the pending queue before starting a new instance to handle it.
        :param builtins.int min_total_instances: Minimum number of running instances that should be maintained for this version. Default: 2
    ...
    def max_idle_instances(self) -> Optional[builtins.int]:
        """
    ...
    def max_pending_latency(self) -> Optional[builtins.str]:
        """
    ...
    def max_total_instances(self) -> Optional[builtins.int]:
        """
    ...
    def min_idle_instances(self) -> Optional[builtins.int]:
        """
    ...
    def min_pending_latency(self) -> Optional[builtins.str]:
        """
    ...
    def min_total_instances(self) -> Optional[builtins.int]:
        """
...
class FlexibleAppVersionAutomaticScalingCpuUtilization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aggregation_window_length: Optional[builtins.str] = None):
        """
        :param builtins.float target_utilization: Target CPU utilization ratio to maintain when scaling. Must be between 0 and 1.
        :param builtins.str aggregation_window_length: Period of time over which CPU utilization is calculated.
        """
    ...
    def target_utilization(self) -> builtins.float:
        """
    ...
    def aggregation_window_length(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionAutomaticScalingDiskUtilization(dict):
    ...
    def __init__(__self__, *,
                 target_read_bytes_per_second: Optional[builtins.int] = None,
                 target_read_ops_per_second: Optional[builtins.int] = None,
                 target_write_bytes_per_second: Optional[builtins.int] = None,
                 target_write_ops_per_second: Optional[builtins.int] = None):
        """
        :param builtins.int target_read_bytes_per_second: Target bytes read per second.
        :param builtins.int target_read_ops_per_second: Target ops read per seconds.
        :param builtins.int target_write_bytes_per_second: Target bytes written per second.
        :param builtins.int target_write_ops_per_second: Target ops written per second.
        """
    ...
    def target_read_bytes_per_second(self) -> Optional[builtins.int]:
        """
    ...
    def target_read_ops_per_second(self) -> Optional[builtins.int]:
        """
    ...
    def target_write_bytes_per_second(self) -> Optional[builtins.int]:
        """
    ...
    def target_write_ops_per_second(self) -> Optional[builtins.int]:
        """
...
class FlexibleAppVersionAutomaticScalingNetworkUtilization(dict):
    ...
    def __init__(__self__, *,
                 target_received_bytes_per_second: Optional[builtins.int] = None,
                 target_received_packets_per_second: Optional[builtins.int] = None,
                 target_sent_bytes_per_second: Optional[builtins.int] = None,
                 target_sent_packets_per_second: Optional[builtins.int] = None):
        """
        :param builtins.int target_received_bytes_per_second: Target bytes received per second.
        :param builtins.int target_received_packets_per_second: Target packets received per second.
        :param builtins.int target_sent_bytes_per_second: Target bytes sent per second.
        :param builtins.int target_sent_packets_per_second: Target packets sent per second.
        """
    ...
    def target_received_bytes_per_second(self) -> Optional[builtins.int]:
        """
    ...
    def target_received_packets_per_second(self) -> Optional[builtins.int]:
        """
    ...
    def target_sent_bytes_per_second(self) -> Optional[builtins.int]:
        """
    ...
    def target_sent_packets_per_second(self) -> Optional[builtins.int]:
        """
...
class FlexibleAppVersionAutomaticScalingRequestUtilization(dict):
    ...
    def __init__(__self__, *,
                 target_concurrent_requests: Optional[builtins.float] = None,
                 target_request_count_per_second: Optional[builtins.str] = None):
        """
        :param builtins.float target_concurrent_requests: Target number of concurrent requests.
        :param builtins.str target_request_count_per_second: Target requests per second.
        """
    ...
    def target_concurrent_requests(self) -> Optional[builtins.float]:
        """
    ...
    def target_request_count_per_second(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionDeploymentCloudBuildOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cloud_build_timeout: Optional[builtins.str] = None):
        """
        :param builtins.str app_yaml_path: Path to the yaml file used in deployment, used to determine runtime configuration details.
        :param builtins.str cloud_build_timeout: The Cloud Build timeout used as part of any dependent builds performed by version creation. Defaults to 10 minutes.
    ...
    def cloud_build_timeout(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionDeploymentContainer(dict):
    def __init__(__self__, *,
                 image: builtins.str):
        """
        :param builtins.str image: URI to the hosted container image in Google Container Registry. The URI must be fully qualified and include a tag or digest.
...
class FlexibleAppVersionDeploymentFile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sha1_sum: Optional[builtins.str] = None):
        """
        :param builtins.str name: The identifier for this object. Format specified above.
        :param builtins.str source_url: Source URL
        :param builtins.str sha1_sum: SHA1 checksum of the file
        """
        pulumi.set(__self__, "name", name)
    ...
    def sha1_sum(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionDeploymentZip(dict):
    ...
    def __init__(__self__, *,
                 source_url: builtins.str,
                 files_count: Optional[builtins.int] = None):
        """
        :param builtins.str source_url: Source URL
        :param builtins.int files_count: files count
        """
        pulumi.set(__self__, "source_url", source_url)
    ...
    def files_count(self) -> Optional[builtins.int]:
        """
        files count
        """
...
class FlexibleAppVersionEndpointsApiService(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_trace_sampling: Optional[builtins.bool] = None,
                 rollout_strategy: Optional[builtins.str] = None):
        """
        :param builtins.str name: Endpoints service name which is the name of the "service" resource in the Service Management API.
               For example "myapi.endpoints.myproject.cloud.goog"
        :param builtins.str config_id: Endpoints service configuration ID as specified by the Service Management API. For example "2016-09-19r1".
               By default, the rollout strategy for Endpoints is "FIXED". This means that Endpoints starts up with a particular configuration ID.
               When a new configuration is rolled out, Endpoints must be given the new configuration ID. The configId field is used to give the configuration ID
               and is required in this case.
               Endpoints also has a rollout strategy called "MANAGED". When using this, Endpoints fetches the latest configuration and does not need
               the configuration ID. In this case, configId must be omitted.
        :param builtins.bool disable_trace_sampling: Enable or disable trace sampling. By default, this is set to false for enabled.
        :param builtins.str rollout_strategy: Endpoints rollout strategy. If FIXED, configId must be specified. If MANAGED, configId must be omitted.
    ...
    def disable_trace_sampling(self) -> Optional[builtins.bool]:
        """
    ...
    def rollout_strategy(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionFlexibleRuntimeSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operating_system: Operating System of the application runtime.
        :param builtins.str runtime_version: The runtime version of an App Engine flexible application.
        """
...
class FlexibleAppVersionHandler(dict):
    ...
    def __init__(__self__, *,
                 auth_fail_action: Optional[builtins.str] = None,
                 login: Optional[builtins.str] = None,
                 redirect_http_response_code: Optional[builtins.str] = None,
                 ...
                 url_regex: Optional[builtins.str] = None):
        """
        :param builtins.str auth_fail_action: Actions to take when the user is not logged in.
               Possible values are: `AUTH_FAIL_ACTION_REDIRECT`, `AUTH_FAIL_ACTION_UNAUTHORIZED`.
        :param builtins.str login: Methods to restrict access to a URL based on login status.
               Possible values are: `LOGIN_OPTIONAL`, `LOGIN_ADMIN`, `LOGIN_REQUIRED`.
        :param builtins.str redirect_http_response_code: 30x code to use when performing redirects for the secure field.
        ...
        :param 'FlexibleAppVersionHandlerStaticFilesArgs' static_files: Files served directly to the user for a given URL, such as images, CSS stylesheets, or JavaScript source files.
               ...
               Structure is documented below.
        :param builtins.str url_regex: URL prefix. Uses regular expression syntax, which means regexp special characters must be escaped, but should not contain groupings.
    ...
    def redirect_http_response_code(self) -> Optional[builtins.str]:
        """
    ...
    def url_regex(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionHandlerScript(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str script_path: Path to the script from the application root directory.
        """
...
class FlexibleAppVersionHandlerStaticFiles(dict):
    ...
    def __init__(__self__, *,
                 application_readable: Optional[builtins.bool] = None,
                 ...
                 path: Optional[builtins.str] = None,
                 require_matching_file: Optional[builtins.bool] = None,
                 upload_path_regex: Optional[builtins.str] = None):
        """
        :param builtins.bool application_readable: Whether files should also be uploaded as code data. By default, files declared in static file handlers are
               uploaded as static data and are only served to end users; they cannot be read by the application. If enabled,
               uploads are charged against both your code and static data storage resource quotas.
        :param builtins.str expiration: Time a static file served by this handler should be cached by web proxies and browsers.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example "3.5s".
               Default is '0s'
        :param Mapping[str, builtins.str] http_headers: HTTP headers to use for all responses from these URLs.
               An object containing a list of "key:value" value pairs.".
        :param builtins.str mime_type: MIME type used to serve all files served by this handler.
               Defaults to file-specific MIME types, which are derived from each file's filename extension.
        :param builtins.str path: Path to the static files matched by the URL pattern, from the application root directory.
               The path can refer to text matched in groupings in the URL pattern.
        :param builtins.bool require_matching_file: Whether this handler should match the request if the file referenced by the handler does not exist.
        :param builtins.str upload_path_regex: Regular expression that matches the file paths for all files that should be referenced by this handler.
        """
    ...
    def application_readable(self) -> Optional[builtins.bool]:
        """
    ...
    def require_matching_file(self) -> Optional[builtins.bool]:
        """
    ...
    def upload_path_regex(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionLivenessCheck(dict):
    ...
    def __init__(__self__, *,
                 path: builtins.str,
                 check_interval: Optional[builtins.str] = None,
                 failure_threshold: Optional[builtins.float] = None,
                 host: Optional[builtins.str] = None,
                 initial_delay: Optional[builtins.str] = None,
                 success_threshold: Optional[builtins.float] = None,
                 timeout: Optional[builtins.str] = None):
        """
        :param builtins.str path: The request path.
        :param builtins.str check_interval: Interval between health checks.
    ...
    def check_interval(self) -> Optional[builtins.str]:
        """
    ...
    def failure_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def success_threshold(self) -> Optional[builtins.float]:
        """
...
class FlexibleAppVersionManualScaling(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int instances: Number of instances to assign to the service at the start.
...
class FlexibleAppVersionNetwork(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 forwarded_ports: Optional[Sequence[builtins.str]] = None,
                 instance_ip_mode: Optional[builtins.str] = None,
                 instance_tag: Optional[builtins.str] = None,
                 session_affinity: Optional[builtins.bool] = None,
                 subnetwork: Optional[builtins.str] = None):
        """
        :param builtins.str name: Google Compute Engine network where the virtual machines are created. Specify the short name, not the resource path.
        :param Sequence[builtins.str] forwarded_ports: List of ports, or port pairs, to forward from the virtual machine to the application container.
        :param builtins.str instance_ip_mode: Prevent instances from receiving an ephemeral external IP address.
               Possible values are: `EXTERNAL`, `INTERNAL`.
        :param builtins.str instance_tag: Tag to apply to the instance during creation.
        :param builtins.bool session_affinity: Enable session affinity.
        :param builtins.str subnetwork: Google Cloud Platform sub-network where the virtual machines are created. Specify the short name, not the resource path.
    ...
    def forwarded_ports(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def instance_ip_mode(self) -> Optional[builtins.str]:
        """
    ...
    def instance_tag(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionReadinessCheck(dict):
    ...
    def __init__(__self__, *,
                 path: builtins.str,
                 app_start_timeout: Optional[builtins.str] = None,
                 check_interval: Optional[builtins.str] = None,
                 failure_threshold: Optional[builtins.float] = None,
                 host: Optional[builtins.str] = None,
                 success_threshold: Optional[builtins.float] = None,
        ...
        """
        :param builtins.str path: The request path.
        :param builtins.str app_start_timeout: A maximum time limit on application initialization, measured from moment the application successfully
               replies to a healthcheck until it is ready to serve traffic. Default: "300s"
        :param builtins.str check_interval: Interval between health checks.  Default: "5s".
        :param builtins.float failure_threshold: Number of consecutive failed checks required before removing traffic. Default: 2.
        :param builtins.str host: Host header to send when performing a HTTP Readiness check. Example: "myapp.appspot.com"
        :param builtins.float success_threshold: Number of consecutive successful checks required before receiving traffic. Default: 2.
        :param builtins.str timeout: Time before the check is considered failed. Default: "4s"
        """
        pulumi.set(__self__, "path", path)
    ...
    def app_start_timeout(self) -> Optional[builtins.str]:
        """
...
class FlexibleAppVersionResources(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disk_gb: Optional[builtins.int] = None,
                 memory_gb: Optional[builtins.float] = None,
                 volumes: Optional[Sequence['outputs.FlexibleAppVersionResourcesVolume']] = None):
        """
        :param builtins.int cpu: Number of CPU cores needed.
        :param builtins.int disk_gb: Disk size (GB) needed.
        :param builtins.float memory_gb: Memory (GB) needed.
    ...
    def disk_gb(self) -> Optional[builtins.int]:
        """
        Disk size (GB) needed.
        """
    ...
    def memory_gb(self) -> Optional[builtins.float]:
        """
        Memory (GB) needed.
        """
...
class FlexibleAppVersionResourcesVolume(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Unique name for the volume.
        :param builtins.int size_gb: Volume size in gigabytes.
        :param builtins.str volume_type: Underlying volume type, e.g. 'tmpfs'.
        """
        pulumi.set(__self__, "name", name)
...
class FlexibleAppVersionVpcAccessConnector(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: Full Serverless VPC Access Connector name e.g. /projects/my-project/locations/us-central1/connectors/c1.
        """
        pulumi.set(__self__, "name", name)
...
class ServiceNetworkSettingsNetworkSettings(dict):
    ...
    def __init__(__self__, *,
                 ingress_traffic_allowed: Optional[builtins.str] = None):
        """
    ...
    def ingress_traffic_allowed(self) -> Optional[builtins.str]:
        """
...
class StandardAppVersionAutomaticScalingStandardSchedulerSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_throughput_utilization: Optional[builtins.float] = None):
        """
        :param builtins.int max_instances: Maximum number of instances to run for this version. Set to zero to disable maxInstances configuration.
        ...
        :param builtins.int min_instances: Minimum number of instances to run for this version. Set to zero to disable minInstances configuration.
        :param builtins.float target_cpu_utilization: Target CPU utilization ratio to maintain when scaling. Should be a value in the range [0.50, 0.95], zero, or a negative value.
        :param builtins.float target_throughput_utilization: Target throughput utilization ratio to maintain when scaling. Should be a value in the range [0.50, 0.95], zero, or a negative value.
        """
    ...
    def target_throughput_utilization(self) -> Optional[builtins.float]:
        """
...
class StandardAppVersionBasicScaling(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_instances: Maximum number of instances to create for this version. Must be in the range [1.0, 200.0].
        :param builtins.str idle_timeout: Duration of time after the last request that an instance must wait before the instance is shut down.
...
class StandardAppVersionHandlerStaticFiles(dict):
    ...
    def __init__(__self__, *,
                 ...
                 upload_path_regex: Optional[builtins.str] = None):
        """
        :param builtins.bool application_readable: Whether files should also be uploaded as code data. By default, files declared in static file handlers are uploaded as
        ...
        :param builtins.str mime_type: MIME type used to serve all files served by this handler.
               Defaults to file-specific MIME types, which are derived from each file's filename extension.
        :param builtins.str path: Path to the static files matched by the URL pattern, from the application root directory. The path can refer to text matched in groupings in the URL pattern.
        :param builtins.bool require_matching_file: Whether this handler should match the request if the file referenced by the handler does not exist.
        :param builtins.str upload_path_regex: Regular expression that matches the file paths for all files that should be referenced by this handler.
        """
        if application_readable is not None:
...
class StandardAppVersionLibrary(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the library. Example "django".
        :param builtins.str version: Version of the library to select, or "latest".
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class StandardAppVersionVpcAccessConnector(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 egress_setting: Optional[builtins.str] = None):
        """
        :param builtins.str name: Full Serverless VPC Access Connector name e.g. /projects/my-project/locations/us-central1/connectors/c1.
        :param builtins.str egress_setting: The egress setting for the connector, controlling what traffic is diverted through it.
        """
        pulumi.set(__self__, "name", name)
    ...
    def egress_setting(self) -> Optional[builtins.str]:
        """
