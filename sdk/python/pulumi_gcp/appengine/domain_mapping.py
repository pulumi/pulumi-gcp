...
class DomainMappingArgs:
    def __init__(__self__, *,
                 ...
                 override_strategy: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def override_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def override_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainMapping(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="overrideStrategy")
    def override_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether the domain creation should override any existing mappings for this domain.
        By default, overrides are rejected.
        Default value is `STRICT`.
