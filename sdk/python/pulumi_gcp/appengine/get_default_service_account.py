...
def get_default_service_account(project: Optional[builtins.str] = None,
...
def get_default_service_account_output(project: Optional[pulumi.Input[Optional[builtins.str]]] = None,
