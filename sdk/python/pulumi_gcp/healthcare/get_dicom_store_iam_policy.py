...
def get_dicom_store_iam_policy(dicom_store_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dicom_store_id: The DICOM store ID, in the form
...
def get_dicom_store_iam_policy_output(dicom_store_id: Optional[pulumi.Input[builtins.str]] = None,
