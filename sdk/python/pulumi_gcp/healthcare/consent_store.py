...
class ConsentStoreArgs:
    def __init__(__self__, *,
                 ...
                 default_consent_ttl: Optional[pulumi.Input[builtins.str]] = None,
                 enable_consent_create_on_update: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dataset: Identifies the dataset addressed by this request. Must be in the format
               ...
               - - -
        :param pulumi.Input[builtins.str] default_consent_ttl: Default time to live for consents in this store. Must be at least 24 hours. Updating this field will not affect the expiration time of existing consents.
               A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        :param pulumi.Input[builtins.bool] enable_consent_create_on_update: If true, [consents.patch] [google.cloud.healthcare.v1.consent.UpdateConsent] creates the consent if it does not already exist.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User-supplied key-value pairs used to organize Consent stores.
        ...
        :param pulumi.Input[builtins.str] name: The name of this ConsentStore, for example:
               "consent1"
        """
    ...
    def default_consent_ttl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_consent_ttl(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_consent_ttl", value)

    @property
    @pulumi.getter(name="enableConsentCreateOnUpdate")
    def enable_consent_create_on_update(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_consent_create_on_update(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ConsentStore(pulumi.CustomResource):
    ...
    pulumi_type = "gcp:healthcare/consentStore:ConsentStore"
    ...
    def get(resource_name: str,
            ...
            labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ConsentStore':
        """
    ...
    @property
    @pulumi.getter(name="defaultConsentTtl")
    def default_consent_ttl(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Default time to live for consents in this store. Must be at least 24 hours. Updating this field will not affect the expiration time of existing consents.
        A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".
        """
    ...
    @property
    @pulumi.getter(name="enableConsentCreateOnUpdate")
    def enable_consent_create_on_update(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, [consents.patch] [google.cloud.healthcare.v1.consent.UpdateConsent] creates the consent if it does not already exist.
        """
        return pulumi.get(self, "enable_consent_create_on_update")
