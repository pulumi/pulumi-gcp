...
class ConsentStoreIamBindingArgs:
    def __init__(__self__, *,
                 ...
                 condition: pulumi.Input[Optional['ConsentStoreIamBindingConditionArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def condition(self) -> pulumi.Input[Optional['ConsentStoreIamBindingConditionArgs']]:
        return pulumi.get(self, "condition")

    @condition.setter
    def condition(self, value: pulumi.Input[Optional['ConsentStoreIamBindingConditionArgs']]):
...
class _ConsentStoreIamBindingState:
    def __init__(__self__, *,
                 condition: pulumi.Input[Optional['ConsentStoreIamBindingConditionArgs']] = None,
                 consent_store_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="consentStoreId")
    def consent_store_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Used to find the parent resource to bind the IAM policy to
        """
        return pulumi.get(self, "consent_store_id")
    ...
    @consent_store_id.setter
    def consent_store_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "consent_store_id", value)
...
class ConsentStoreIamBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 condition: pulumi.Input[Optional[Union['ConsentStoreIamBindingConditionArgs', 'ConsentStoreIamBindingConditionArgsDict', 'outputs.ConsentStoreIamBindingCondition']]] = None,
                 consent_store_id: pulumi.Input[Optional[_builtins.str]] = None,
                 dataset: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 role: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `healthcare.ConsentStoreIamBinding`: Authoritative for a given role. Updates the IAM policy to grant a role to a list of members. Other roles within the IAM policy for the consentstore are preserved. Members added outside of Terraform for the same role will be detected as drift and removed on the next `pulumi up`.
        * `healthcare.ConsentStoreIamMember`: Non-authoritative. Updates the IAM policy to grant a role to a new member. Other members for the role for the consentstore are preserved. Members added outside of Terraform will **not** be detected as drift.
    ...
    def get(resource_name: str,
            ...
            etag: pulumi.Input[Optional[_builtins.str]] = None,
            members: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            role: pulumi.Input[Optional[_builtins.str]] = None) -> 'ConsentStoreIamBinding':
        """
