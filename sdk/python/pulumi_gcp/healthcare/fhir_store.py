...
class FhirStoreArgs:
    def __init__(__self__, *,
                 ...
                 complex_data_type_reference_parsing: Optional[pulumi.Input[builtins.str]] = None,
                 default_search_handling_strict: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_referential_integrity: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_resource_versioning: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_history_import: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_history_modifications: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_update_create: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dataset: Identifies the dataset addressed by this request. Must be in the format
               ...
               - - -
        :param pulumi.Input[builtins.str] complex_data_type_reference_parsing: Enable parsing of references within complex FHIR data types such as Extensions. If this value is set to ENABLED, then features like referential integrity and Bundle reference rewriting apply to all references. If this flag has not been specified the behavior of the FHIR store will not change, references in complex data types will not be parsed. New stores will have this value set to ENABLED by default after a notification period. Warning: turning on this flag causes processing existing resources to fail if they contain references to non-existent resources.
               Possible values are: `COMPLEX_DATA_TYPE_REFERENCE_PARSING_UNSPECIFIED`, `DISABLED`, `ENABLED`.
        :param pulumi.Input[builtins.bool] default_search_handling_strict: If true, overrides the default search behavior for this FHIR store to handling=strict which returns an error for unrecognized search parameters.
               If false, uses the FHIR specification default handling=lenient which ignores unrecognized search parameters.
               The handling can always be changed from the default on an individual API call by setting the HTTP header Prefer: handling=strict or Prefer: handling=lenient.
        :param pulumi.Input[builtins.bool] disable_referential_integrity: Whether to disable referential integrity in this FHIR store. This field is immutable after FHIR store
               creation. The default value is false, meaning that the API will enforce referential integrity and fail the
               requests that will result in inconsistent state in the FHIR store. When this field is set to true, the API
               will skip referential integrity check. Consequently, operations that rely on references, such as
               Patient.get$everything, will not return all the results if broken references exist.
               ** Changing this property may recreate the FHIR store (removing all data) **
        :param pulumi.Input[builtins.bool] disable_resource_versioning: Whether to disable resource versioning for this FHIR store. This field can not be changed after the creation
               of FHIR store. If set to false, which is the default behavior, all write operations will cause historical
               versions to be recorded automatically. The historical versions can be fetched through the history APIs, but
               cannot be updated. If set to true, no historical versions will be kept. The server will send back errors for
               attempts to read the historical versions.
               ** Changing this property may recreate the FHIR store (removing all data) **
        :param pulumi.Input[builtins.bool] enable_history_import: Whether to allow the bulk import API to accept history bundles and directly insert historical resource
               versions into the FHIR store. Importing resource histories creates resource interactions that appear to have
               occurred in the past, which clients may not want to allow. If set to false, history bundles within an import
               will fail with an error.
               ** Changing this property may recreate the FHIR store (removing all data) **
               ** This property can be changed manually in the Google Cloud Healthcare admin console without recreating the FHIR store **
        :param pulumi.Input[builtins.bool] enable_history_modifications: Whether to allow the ExecuteBundle API to accept history bundles, and directly insert and overwrite historical
               resource versions into the FHIR store. If set to false, using history bundles fails with an error.
        :param pulumi.Input[builtins.bool] enable_update_create: Whether this FHIR store has the updateCreate capability. This determines if the client can use an Update
               operation to create a new resource with a client-specified ID. If false, all IDs are server-assigned through
               the Create operation and attempts to Update a non-existent resource will return errors. Please treat the audit
               logs with appropriate levels of care if client-specified resource IDs contain sensitive data such as patient
               identifiers, those IDs will be part of the FHIR resource path recorded in Cloud audit logs and Cloud Pub/Sub
               notifications.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User-supplied key-value pairs used to organize FHIR stores.
        ...
        :param pulumi.Input[builtins.str] name: The resource name for the FhirStore.
               ** Changing this property may recreate the FHIR store (removing all data) **
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FhirStoreStreamConfigArgs']]] stream_configs: A list of streaming configs that configure the destinations of streaming export for every resource mutation in
               ...
               Structure is documented below.
        :param pulumi.Input[builtins.str] version: The FHIR specification version.
    ...
    def complex_data_type_reference_parsing(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def complex_data_type_reference_parsing(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "complex_data_type_reference_parsing", value)

    @property
    @pulumi.getter(name="defaultSearchHandlingStrict")
    def default_search_handling_strict(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def default_search_handling_strict(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "default_search_handling_strict", value)

    @property
    @pulumi.getter(name="disableReferentialIntegrity")
    def disable_referential_integrity(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_referential_integrity(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_referential_integrity", value)

    @property
    @pulumi.getter(name="disableResourceVersioning")
    def disable_resource_versioning(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_resource_versioning(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disable_resource_versioning", value)

    @property
    @pulumi.getter(name="enableHistoryImport")
    def enable_history_import(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_history_import(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_history_import", value)

    @property
    @pulumi.getter(name="enableHistoryModifications")
    def enable_history_modifications(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_history_modifications(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_history_modifications", value)

    @property
    @pulumi.getter(name="enableUpdateCreate")
    def enable_update_create(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_update_create(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class FhirStore(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            self_link: Optional[pulumi.Input[builtins.str]] = None,
            stream_configs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FhirStoreStreamConfigArgs', 'FhirStoreStreamConfigArgsDict']]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'FhirStore':
        """
    ...
    @property
    @pulumi.getter(name="complexDataTypeReferenceParsing")
    def complex_data_type_reference_parsing(self) -> pulumi.Output[builtins.str]:
        """
        Enable parsing of references within complex FHIR data types such as Extensions. If this value is set to ENABLED, then features like referential integrity and Bundle reference rewriting apply to all references. If this flag has not been specified the behavior of the FHIR store will not change, references in complex data types will not be parsed. New stores will have this value set to ENABLED by default after a notification period. Warning: turning on this flag causes processing existing resources to fail if they contain references to non-existent resources.
        Possible values are: `COMPLEX_DATA_TYPE_REFERENCE_PARSING_UNSPECIFIED`, `DISABLED`, `ENABLED`.
        """
    ...
    @property
    @pulumi.getter(name="defaultSearchHandlingStrict")
    def default_search_handling_strict(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, overrides the default search behavior for this FHIR store to handling=strict which returns an error for unrecognized search parameters.
        If false, uses the FHIR specification default handling=lenient which ignores unrecognized search parameters.
        The handling can always be changed from the default on an individual API call by setting the HTTP header Prefer: handling=strict or Prefer: handling=lenient.
    ...
    @property
    @pulumi.getter(name="disableReferentialIntegrity")
    def disable_referential_integrity(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to disable referential integrity in this FHIR store. This field is immutable after FHIR store
        creation. The default value is false, meaning that the API will enforce referential integrity and fail the
        requests that will result in inconsistent state in the FHIR store. When this field is set to true, the API
    ...
    @property
    @pulumi.getter(name="disableResourceVersioning")
    def disable_resource_versioning(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to disable resource versioning for this FHIR store. This field can not be changed after the creation
        of FHIR store. If set to false, which is the default behavior, all write operations will cause historical
        versions to be recorded automatically. The historical versions can be fetched through the history APIs, but
    ...
    @property
    @pulumi.getter(name="enableHistoryImport")
    def enable_history_import(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to allow the bulk import API to accept history bundles and directly insert historical resource
        versions into the FHIR store. Importing resource histories creates resource interactions that appear to have
        occurred in the past, which clients may not want to allow. If set to false, history bundles within an import
    ...
    @property
    @pulumi.getter(name="enableHistoryModifications")
    def enable_history_modifications(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to allow the ExecuteBundle API to accept history bundles, and directly insert and overwrite historical
        resource versions into the FHIR store. If set to false, using history bundles fails with an error.
        """
    ...
    @property
    @pulumi.getter(name="enableUpdateCreate")
    def enable_update_create(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether this FHIR store has the updateCreate capability. This determines if the client can use an Update
        operation to create a new resource with a client-specified ID. If false, all IDs are server-assigned through
        the Create operation and attempts to Update a non-existent resource will return errors. Please treat the audit
