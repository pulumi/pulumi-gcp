...
def get_hl7_v2_store_iam_policy(hl7_v2_store_id: Optional[builtins.str] = None,
    ...
    :param builtins.str hl7_v2_store_id: The HL7v2 store ID, in the form
...
def get_hl7_v2_store_iam_policy_output(hl7_v2_store_id: Optional[pulumi.Input[builtins.str]] = None,
