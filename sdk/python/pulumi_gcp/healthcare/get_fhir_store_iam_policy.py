...
class GetFhirStoreIamPolicyResult:
    ...
    def fhir_store_id(self) -> _builtins.str:
...
def get_fhir_store_iam_policy(fhir_store_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str fhir_store_id: The FHIR store ID, in the form
...
def get_fhir_store_iam_policy_output(fhir_store_id: Optional[pulumi.Input[_builtins.str]] = None,
