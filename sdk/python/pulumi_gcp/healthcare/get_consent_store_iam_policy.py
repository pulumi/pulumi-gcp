...
def get_consent_store_iam_policy(consent_store_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str consent_store_id: Used to find the parent resource to bind the IAM policy to
    :param _builtins.str dataset: Identifies the dataset addressed by this request. Must be in the format
