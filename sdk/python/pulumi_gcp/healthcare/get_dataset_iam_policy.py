...
def get_dataset_iam_policy(dataset_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dataset_id: The dataset ID, in the form
...
def get_dataset_iam_policy_output(dataset_id: Optional[pulumi.Input[builtins.str]] = None,
