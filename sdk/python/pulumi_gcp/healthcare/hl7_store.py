...
class Hl7StoreArgs:
    def __init__(__self__, *,
                 ...
                 reject_duplicate_message: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] dataset: Identifies the dataset addressed by this request. Must be in the format
               ...
               - - -
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: User-supplied key-value pairs used to organize HL7v2 stores.
        ...
        :param pulumi.Input[builtins.str] name: The resource name for the Hl7V2Store.
        ...
        :param pulumi.Input['Hl7StoreParserConfigArgs'] parser_config: A nested object resource.
               Structure is documented below.
        :param pulumi.Input[builtins.bool] reject_duplicate_message: Determines whether duplicate messages are allowed.
        """
    ...
    def reject_duplicate_message(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reject_duplicate_message(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Hl7Store(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            pulumi_labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            reject_duplicate_message: Optional[pulumi.Input[builtins.bool]] = None,
            self_link: Optional[pulumi.Input[builtins.str]] = None) -> 'Hl7Store':
        """
    ...
    @property
    @pulumi.getter(name="rejectDuplicateMessage")
    def reject_duplicate_message(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines whether duplicate messages are allowed.
        """
        return pulumi.get(self, "reject_duplicate_message")
